...
fn generic_guids() -> winrt::Result<()> {
    ...
    type A = winrt::collections::IIterable<winrt::IStringable>;
    type B = winrt::collections::IKeyValuePair<
        winrt::HString,
        winrt::IAsyncOperationWithProgress<A, f32>,
    >;
