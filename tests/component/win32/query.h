...
extern "C"
{
    ...
    HRESULT __stdcall QueryOptional(GUID const& iid, _COM_Outptr_opt_ void** object) noexcept;
        ...
        IQueryInt32 : IUnknown
    {
        ...
        virtual HRESULT __stdcall QueryOptional(GUID const& iid, _COM_Outptr_opt_ void** object) noexcept = 0;
    };
