...
extern "C"
{
    HRESULT __stdcall QueryInterface(GUID const& riid, _COM_Outptr_ void** object) noexcept;
    HRESULT __stdcall QueryWithValue(int32_t value, GUID const& riid, _COM_Outptr_ void** object) noexcept;
