...
pub fn scrape() -> Summary {
    ...
    // The symbol -> DLL mapping the headers don't carry, resolved to absolute paths from the
    // pinned import libraries: `ntdll.lib` (`NtReadFile`, `RtlGetVersion`, ...) and `offreg.lib`
