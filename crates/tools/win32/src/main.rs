...
/// The Win32 winmd, compiled from the `metadata/win32` RDL (the committed source of
...
fn main() {
    ...
    // packages must be restored. This is what guarantees the committed metadata can be
