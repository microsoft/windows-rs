...
fn main() {
    ...
    _ = bindgen(["--etc", "crates/tools/bindings/src/animation.txt"]);

    // NOTE: Reactor bindings are now generated by tool_reactor.
    // Run `cargo run -p tool_reactor` for reactor-specific regeneration.
