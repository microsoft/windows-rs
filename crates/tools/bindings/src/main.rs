...
fn main() {
    ...
    bindgen(["--etc", "crates/tools/bindings/src/reference.txt"]);
    ...
    bindgen(["--etc", "crates/tools/bindings/src/trayicon.txt"]);
    bindgen(["--etc", "crates/tools/bindings/src/trayicon_test.txt"]);
    bindgen(["--etc", "crates/tools/bindings/src/window.txt"]);

    // NOTE: Reactor bindings are generated by tool-reactor.
    // WebView2 bindings are generated by tool-webview.
    // Package crates (windows, windows-sys) are generated by tool-package.
