...
and custom-attribute identities. `riddle validate` accepts `.winmd` files and directories. Use
`--reference <path>` for additional metadata references. The default Windows metadata is available
