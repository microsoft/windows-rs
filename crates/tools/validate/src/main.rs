...
fn main() {
    ...
    windows_bindgen::bindgen(["--out", "crates/tools/validate/src/bindings_default.rs", "--flat", "--filter", "Windows.Win32", "--rustfmt", "max_width=800,newline_style=Unix"]);

    windows_bindgen::bindgen(["--out", "crates/tools/validate/src/bindings_sys.rs", "--flat", "--sys", "--filter", "Windows.Win32", "--rustfmt", "max_width=800,newline_style=Unix"]);

    windows_bindgen::bindgen(["--out", "crates/tools/validate/src/bindings_minimal.rs", "--flat", "--minimal", "--filter", "Windows.Win32", "--rustfmt", "max_width=800,newline_style=Unix"]);
