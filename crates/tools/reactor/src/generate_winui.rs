...
pub(crate) fn generate_bindings_filter(schema: &ResolvedSchema) -> String {
    let mut entries = BTreeSet::from([
        ...
        "Microsoft::UI::Dispatching::IDispatcherQueue::CreateTimer".to_string(),
        "Microsoft::UI::Dispatching::IDispatcherQueueTimer::{put_Interval, put_IsRepeating, \
         add_Tick, remove_Tick, Start, Stop}"
            .to_string(),
        ...
        "Microsoft::UI::Xaml::IFrameworkElement::{get_ActualTheme, get_Resources, \
         put_RequestedTheme, put_Width, put_Height, put_MinWidth, put_MaxWidth, put_MinHeight, \
         put_MaxHeight, put_HorizontalAlignment, put_VerticalAlignment, put_Margin}"
            .to_string(),
        "Microsoft::UI::Xaml::IFrameworkElementStatics::{get_WidthProperty, get_HeightProperty, \
         get_MinWidthProperty, get_MaxWidthProperty, get_MinHeightProperty, \
         get_MaxHeightProperty, get_HorizontalAlignmentProperty, get_VerticalAlignmentProperty, \
         get_MarginProperty}"
            .to_string(),
        "Microsoft::UI::Xaml::IFrameworkElement::{get_IsLoaded, get_ActualWidth, \
         get_ActualHeight, add_ActualThemeChanged, \
         remove_ActualThemeChanged, add_SizeChanged, remove_SizeChanged, add_Loaded, remove_Loaded}"
            .to_string(),
        "Microsoft::UI::Xaml::ISizeChangedEventArgs::get_NewSize".to_string(),
        "Microsoft::UI::Xaml::IFrameworkElement::{get_Style, put_Style}".to_string(),
        "Microsoft::UI::Xaml::IUIElement::{CapturePointer, Focus, ReleasePointerCapture, \
         ReleasePointerCaptures, get_XamlRoot, put_XamlRoot, put_Opacity, StartBringIntoView}"
            .to_string(),
        "Microsoft::UI::Xaml::IUIElementStatics::get_OpacityProperty".to_string(),
        ...
        "Microsoft::UI::Xaml::Hosting::ElementCompositionPreview::{GetElementVisual, \
         SetElementChildVisual}"
            .to_string(),
        "Microsoft::UI::Composition::ICompositionObject::get_Compositor".to_string(),
        "Microsoft::UI::Xaml::IUIElement::{add_PointerEntered, add_PointerExited, \
         add_PointerMoved, add_PointerPressed, add_PointerReleased, remove_PointerEntered, \
         remove_PointerExited, remove_PointerMoved, remove_PointerPressed, \
         remove_PointerReleased}"
            .to_string(),
        "Microsoft::UI::Xaml::Input::IPointerRoutedEventArgs::{GetCurrentPoint, get_Pointer}"
            .to_string(),
        "Microsoft::UI::Input::IPointerPoint::{get_Position, get_Properties}".to_string(),
        "Microsoft::UI::Input::IPointerPointProperties::{get_IsLeftButtonPressed, \
         get_IsMiddleButtonPressed, get_IsRightButtonPressed}"
            .to_string(),
        ...
        "Microsoft::UI::Xaml::Controls::IContentDialog::{Hide, ShowAsync}".to_string(),
        "Microsoft::UI::Xaml::Controls::ICalendarDatePicker::{get_Date, put_Date}".to_string(),
        "Microsoft::UI::Xaml::Controls::IColorPicker::{get_Color, put_Color}".to_string(),
        "Microsoft::UI::Xaml::Controls::IDatePicker::{get_SelectedDate, put_SelectedDate}"
            .to_string(),
        "Microsoft::UI::Xaml::Controls::ITeachingTip::{get_IsOpen, put_IsOpen}".to_string(),
        "Microsoft::UI::Xaml::Controls::ITimePicker::{get_SelectedTime, put_SelectedTime}"
            .to_string(),
        "Microsoft::UI::Xaml::Controls::ITreeView::get_RootNodes".to_string(),
        "Microsoft::UI::Xaml::Controls::ISwapChainPanel::{get_CompositionScaleX, \
         get_CompositionScaleY, add_CompositionScaleChanged, remove_CompositionScaleChanged}"
            .to_string(),
        "Microsoft::UI::Xaml::Controls::IWebView2::{EnsureCoreWebView2Async, get_CoreWebView2, \
         add_CoreWebView2Initialized, remove_CoreWebView2Initialized}"
            .to_string(),
        "extras::ISwapChainPanelNative::SetSwapChain".to_string(),
        "Microsoft::UI::Xaml::Controls::TreeViewNode::CreateInstance".to_string(),
        "Microsoft::UI::Xaml::Controls::ITreeViewNode::{get_Children, get_Content, put_Content, \
         put_IsExpanded}"
            .to_string(),
        "Microsoft::UI::Xaml::Controls::Flyout::CreateInstance".to_string(),
        "Microsoft::UI::Xaml::Controls::CommandBarFlyout::CreateInstance".to_string(),
        "Microsoft::UI::Xaml::Controls::ICommandBarFlyout::{get_PrimaryCommands, \
         get_SecondaryCommands}"
            .to_string(),
        "Microsoft::UI::Xaml::Controls::MenuFlyout::CreateInstance".to_string(),
        "Microsoft::UI::Xaml::Controls::IMenuFlyout::get_Items".to_string(),
        "Microsoft::UI::Xaml::Controls::MenuFlyoutItem::CreateInstance".to_string(),
        "Microsoft::UI::Xaml::Controls::IMenuFlyoutItem::{put_Text, add_Click, remove_Click}"
            .to_string(),
        "Microsoft::UI::Xaml::Controls::MenuFlyoutSeparator::CreateInstance".to_string(),
        "Microsoft::UI::Xaml::Controls::MenuFlyoutSubItem::CreateInstance".to_string(),
        "Microsoft::UI::Xaml::Controls::IMenuFlyoutSubItem::{get_Items, put_Text}".to_string(),
        "Microsoft::UI::Xaml::Controls::IMenuBarItem::get_Items".to_string(),
        "Microsoft::UI::Xaml::Controls::IRichEditBox::{get_Document, get_IsReadOnly}".to_string(),
        "Microsoft::UI::Xaml::Controls::IRichTextBlock::get_Blocks".to_string(),
        ...
        "Microsoft::UI::Xaml::Documents::ITextElement::{put_FontStyle, put_FontWeight}".to_string(),
        ...
        "Microsoft::UI::Text::ITextDocument::{GetText, SetText}".to_string(),
        "Microsoft::UI::Text::TextGetOptions::None".to_string(),
        "Microsoft::UI::Text::TextSetOptions::None".to_string(),
        "Windows::UI::Text::FontStyle".to_string(),
        "Windows::UI::Text::FontWeight".to_string(),
        "Microsoft::UI::Xaml::Controls::Primitives::IButtonBase::{add_Click, remove_Click}"
            .to_string(),
        "Microsoft::UI::Xaml::Controls::IButton::{get_Flyout, put_Flyout}".to_string(),
        "Microsoft::UI::Xaml::Controls::ISplitButton::{get_Flyout, put_Flyout}".to_string(),
        "Microsoft::UI::Xaml::Controls::IFlyout::put_Content".to_string(),
        "Microsoft::UI::Xaml::Controls::Primitives::FlyoutPlacementMode".to_string(),
        "Microsoft::UI::Xaml::Controls::Primitives::IFlyoutBase::{get_Placement, put_Placement}"
            .to_string(),
        "Microsoft::UI::Xaml::Controls::Primitives::PlacementMode".to_string(),
        "Microsoft::UI::Xaml::Controls::ToolTipService::{GetPlacement, GetToolTip, SetPlacement, \
         SetToolTip}"
            .to_string(),
        ...
        "Microsoft::UI::Xaml::Controls::Grid::{ColumnProperty, ColumnSpanProperty, GetColumn, \
         ...
         SetRow, SetRowSpan}"
            .to_string(),
        "Microsoft::UI::Xaml::Controls::Canvas::{LeftProperty, SetLeft, SetTop, TopProperty}"
            .to_string(),
        "Microsoft::UI::Xaml::Automation::AutomationProperties::{SetAutomationId, \
         SetHeadingLevel, SetName}"
            .to_string(),
        "Microsoft::UI::Xaml::Controls::RelativePanel::{AlignBottomWithPanelProperty, \
         AlignHorizontalCenterWithPanelProperty, AlignLeftWithPanelProperty, \
         AlignRightWithPanelProperty, AlignTopWithPanelProperty, \
         AlignVerticalCenterWithPanelProperty, SetAlignBottomWithPanel, \
         SetAlignHorizontalCenterWithPanel, SetAlignLeftWithPanel, SetAlignRightWithPanel, \
         SetAlignTopWithPanel, SetAlignVerticalCenterWithPanel}"
            .to_string(),
        "Microsoft::UI::Xaml::Controls::IColumnDefinition::{get_Width, put_Width}".to_string(),
        "Microsoft::UI::Xaml::Controls::IBorder::{get_Background, get_BorderBrush}".to_string(),
        ...
        "Microsoft::UI::Windowing::IAppWindow::{get_TitleBar, get_Presenter, get_Size, SetIcon}"
            .to_string(),
        "Microsoft::UI::Windowing::IAppWindow2::{get_ClientSize, ResizeClient}".to_string(),
        "Microsoft::UI::Windowing::IOverlappedPresenter3::{put_PreferredMinimumWidth, \
         put_PreferredMinimumHeight, put_PreferredMaximumWidth, put_PreferredMaximumHeight}"
            .to_string(),
        "Microsoft::UI::Windowing::IAppWindowTitleBar2::put_PreferredHeightOption".to_string(),
        "Microsoft::UI::Windowing::IAppWindowTitleBar3::put_PreferredTheme".to_string(),
        "Microsoft::UI::Xaml::IWindow::{put_ExtendsContentIntoTitleBar, SetTitleBar}".to_string(),
        ...
        "Microsoft::UI::Xaml::Media::ISolidColorBrush::get_Color".to_string(),
...
mod tests {
    ...
    fn filter_covers_schema_controls_and_members() {
        ...
        assert!(filter.contains("IAppWindow2::{get_ClientSize, ResizeClient}"));
        assert!(filter.contains("IBorder::put_Child"));
        assert!(filter.contains("IBorder::put_Padding"));
        assert!(filter.contains("IBorder::put_Background"));
        assert!(
            filter.contains("ToolTipService::{GetPlacement, GetToolTip, SetPlacement, SetToolTip}")
        );
        assert!(filter.contains("IBorder::put_BorderBrush"));
        assert!(filter.contains("SolidColorBrush::CreateInstance"));
        assert!(filter.contains("ISolidColorBrush::put_Color"));
        assert!(filter.contains("XamlReader::Load"));
        assert!(filter.contains("IFrameworkElement::{get_Style, put_Style}"));
        assert!(filter.contains("IFrameworkElement::{get_ActualTheme, get_Resources"));
        assert!(filter.contains("put_Width, put_Height, put_MinWidth, put_MaxWidth"));
        assert!(filter.contains("IUIElementStatics::get_OpacityProperty"));
        assert!(!filter.contains("ITextBlock::put_Width"));
        assert!(filter.contains("ITextBox::put_PlaceholderText"));
        assert!(filter.contains("ITextBox::{add_TextChanged, remove_TextChanged}"));
        assert!(filter.contains("RegisterPropertyChangedCallback"));
        assert!(filter.contains("UnregisterPropertyChangedCallback"));
        assert!(filter.contains("NavigationView::IsPaneOpenProperty"));
        assert!(filter.contains("INavigationView::get_IsPaneOpen"));
        assert!(filter.contains("BitmapImage::CreateInstance"));
        assert!(filter.contains("IBitmapImage::{get_UriSource, put_UriSource}"));
        assert!(filter.contains("SvgImageSource::CreateInstance"));
        assert!(filter.contains("ISvgImageSource::put_UriSource"));
        assert!(filter.contains("IImage::put_Source"));
        assert!(filter.contains("IImage::get_Source"));
        assert!(filter.contains("Uri::CreateUri"));
        assert!(filter.contains("Control::IsEnabledProperty"));
        assert!(filter.contains("NavigationView::IsBackButtonVisibleProperty"));
        assert!(!filter.contains("NavigationView2::IsBackButtonVisibleProperty"));
        assert!(filter.contains("INavigationView2::put_PaneCustomContent"));
        assert!(filter.contains("INavigationView::{get_SelectedItem, put_SelectedItem}"));
        assert!(filter.contains("INavigationViewItemBase2::get_IsSelected"));
        assert!(filter.contains("IFrameworkElement::get_Tag"));
    ...
    fn runtime_dispatch_is_generated_from_schema() {
        ...
        assert!(generated.contains("Handle :: ToolTip"));
        assert!(generated.contains("MountedKind :: Border => Some"));
        assert!(generated.contains("\"Background\""));
        assert!(generated.contains("\"BorderBrush\""));
        ...
        assert!(generated.contains("pub fn read_property"));
        assert!(generated.contains("PropertyId :: TextBoxText"));
        assert!(generated.contains("PropertyValue :: Str"));
        assert!(generated.contains("event_source . Text"));
        assert!(generated.contains("child_collection"));
        assert!(generated.contains("SlotId :: NavigationViewPaneCustomContent"));
        assert!(generated.contains("control . SetPaneCustomContent"));
        assert!(generated.contains("SlotId :: NavigationViewMenuItems"));
        assert!(generated.contains("slot_collection"));
        assert!(generated.contains("EventId :: NavigationViewSelectionChanged"));
        assert!(generated.contains("windows_reference :: IReference"));
        assert!(generated.contains("pub fn selected_item"));
        assert!(generated.contains("pub fn set_selected_item"));
        assert!(generated.contains("pub fn selection_item_is_selected"));
        assert!(generated.contains("pub fn selection_payload"));
        assert!(generated.contains("Handle :: ListBox"));
        assert!(generated.contains("event_source . SelectedItem"));
        assert!(generated.contains("cast :: < windows_collections :: IVector"));
        assert!(generated.contains("cast :: < INavigationViewItemBase2 >"));
        assert!(generated.contains("SlotCollection :: SelectorBarItem"));
        assert!(generated.contains("cast :: < bindings :: SelectorBarItem >"));
        assert!(generated.contains("Handle :: FontIcon"));
        assert!(generated.contains("Handle :: BitmapIcon"));
        assert!(generated.contains("Handle :: PathIcon"));
        assert!(generated.contains("XamlBindingHelper :: ConvertValue"));
    }
