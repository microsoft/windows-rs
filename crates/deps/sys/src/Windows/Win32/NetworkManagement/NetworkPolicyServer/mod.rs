...
pub struct ISdo(i32);
pub struct ISdoCollection(i32);
pub struct ISdoDictionaryOld(i32);
pub struct ISdoMachine(i32);
pub struct ISdoMachine2(i32);
pub struct ISdoServiceControl(i32);
pub struct ITemplateSdo(i32);
