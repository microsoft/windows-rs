...
extern "system" {
    ...
    fn DRAWPROGRESSFLAGS();
    fn GETPROPERTYSTOREFLAGS();
    fn ICreateObject();
    fn IDelayedPropertyStoreFactory();
    fn IInitializeWithFile();
    fn IInitializeWithStream();
    fn INamedPropertyStore();
    fn IObjectWithPropertyKey();
    fn IPersistSerializedPropStorage();
    fn IPersistSerializedPropStorage2();
    fn IPropertyChange();
    fn IPropertyChangeArray();
    fn IPropertyDescription();
    fn IPropertyDescription2();
    fn IPropertyDescriptionAliasInfo();
    fn IPropertyDescriptionList();
    fn IPropertyDescriptionRelatedPropertyInfo();
    fn IPropertyDescriptionSearchInfo();
    fn IPropertyEnumType();
    fn IPropertyEnumType2();
    fn IPropertyEnumTypeList();
    fn IPropertyStore();
    fn IPropertyStoreCache();
    fn IPropertyStoreCapabilities();
    fn IPropertyStoreFactory();
    fn IPropertySystem();
    fn IPropertySystemChangeNotify();
    fn IPropertyUI();
    fn InMemoryPropertyStore();
    fn InMemoryPropertyStoreMarshalByValue();
    ...
    fn PKA_FLAGS();
    fn PKEY_PIDSTR_MAX();
    fn PLACEHOLDER_STATES();
    fn PROPDESC_AGGREGATION_TYPE();
    fn PROPDESC_COLUMNINDEX_TYPE();
    fn PROPDESC_CONDITION_TYPE();
    fn PROPDESC_DISPLAYTYPE();
    fn PROPDESC_ENUMFILTER();
    fn PROPDESC_FORMAT_FLAGS();
    fn PROPDESC_GROUPING_RANGE();
    fn PROPDESC_RELATIVEDESCRIPTION_TYPE();
    fn PROPDESC_SEARCHINFO_FLAGS();
    fn PROPDESC_SORTDESCRIPTION();
    fn PROPDESC_TYPE_FLAGS();
    fn PROPDESC_VIEW_FLAGS();
    fn PROPENUMTYPE();
    fn PROPERTYKEY();
    fn PROPERTYUI_FLAGS();
    fn PROPERTYUI_FORMAT_FLAGS();
    fn PROPERTYUI_NAME_FLAGS();
    fn PROPPRG();
    fn PROPVAR_CHANGE_FLAGS();
    fn PROPVAR_COMPARE_FLAGS();
    fn PROPVAR_COMPARE_UNIT();
    fn PSC_STATE();
    ...
    fn SYNC_ENGINE_STATE_FLAGS();
    fn SYNC_TRANSFER_STATUS();
    fn VariantCompare();
