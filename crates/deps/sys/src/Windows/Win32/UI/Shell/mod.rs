...
pub struct CIDA(i32);
pub struct CIE4ConnectionPoint(i32);
#[doc = "*Required features: `Win32_UI_Shell`*"]
...
pub struct DShellFolderViewEvents(i32);
pub struct DShellNameSpaceEvents(i32);
pub struct DShellWindowsEvents(i32);
#[doc = "*Required features: `Win32_UI_Shell`*"]
...
pub struct DWebBrowserEvents(i32);
pub struct DWebBrowserEvents2(i32);
...
pub struct Folder(i32);
pub struct Folder2(i32);
pub struct Folder3(i32);
pub struct FolderItem(i32);
pub struct FolderItem2(i32);
pub struct FolderItemVerb(i32);
pub struct FolderItemVerbs(i32);
pub struct FolderItems(i32);
pub struct FolderItems2(i32);
pub struct FolderItems3(i32);
...
pub struct IACList(i32);
pub struct IACList2(i32);
pub struct IAccessibilityDockingService(i32);
pub struct IAccessibilityDockingServiceCallback(i32);
pub struct IAccessibleObject(i32);
pub struct IActionProgress(i32);
pub struct IActionProgressDialog(i32);
pub struct IAppActivationUIInfo(i32);
pub struct IAppPublisher(i32);
pub struct IAppVisibility(i32);
pub struct IAppVisibilityEvents(i32);
pub struct IApplicationActivationManager(i32);
pub struct IApplicationAssociationRegistration(i32);
pub struct IApplicationAssociationRegistrationUI(i32);
pub struct IApplicationDesignModeSettings(i32);
pub struct IApplicationDesignModeSettings2(i32);
pub struct IApplicationDestinations(i32);
pub struct IApplicationDocumentLists(i32);
pub struct IAssocHandler(i32);
pub struct IAssocHandlerInvoker(i32);
pub struct IAttachmentExecute(i32);
pub struct IAutoComplete(i32);
pub struct IAutoComplete2(i32);
pub struct IAutoCompleteDropDown(i32);
pub struct IBandHost(i32);
pub struct IBandSite(i32);
pub struct IBannerNotificationHandler(i32);
pub struct IBanneredBar(i32);
pub struct IBrowserFrameOptions(i32);
pub struct IBrowserService(i32);
pub struct IBrowserService2(i32);
pub struct IBrowserService3(i32);
pub struct IBrowserService4(i32);
pub struct ICDBurn(i32);
pub struct ICDBurnExt(i32);
pub struct ICategorizer(i32);
pub struct ICategoryProvider(i32);
pub struct IColumnManager(i32);
pub struct IColumnProvider(i32);
pub struct ICommDlgBrowser(i32);
pub struct ICommDlgBrowser2(i32);
pub struct ICommDlgBrowser3(i32);
pub struct IComputerInfoChangeNotify(i32);
pub struct IConnectableCredentialProviderCredential(i32);
pub struct IContactManagerInterop(i32);
pub struct IContextMenu(i32);
pub struct IContextMenu2(i32);
pub struct IContextMenu3(i32);
pub struct IContextMenuCB(i32);
pub struct IContextMenuSite(i32);
pub struct ICopyHookA(i32);
pub struct ICopyHookW(i32);
pub struct ICreateProcessInputs(i32);
pub struct ICreatingProcess(i32);
pub struct ICredentialProvider(i32);
pub struct ICredentialProviderCredential(i32);
pub struct ICredentialProviderCredential2(i32);
pub struct ICredentialProviderCredentialEvents(i32);
pub struct ICredentialProviderCredentialEvents2(i32);
pub struct ICredentialProviderCredentialWithFieldOptions(i32);
pub struct ICredentialProviderEvents(i32);
pub struct ICredentialProviderFilter(i32);
pub struct ICredentialProviderSetUserArray(i32);
pub struct ICredentialProviderUser(i32);
pub struct ICredentialProviderUserArray(i32);
pub struct ICurrentItem(i32);
pub struct ICurrentWorkingDirectory(i32);
pub struct ICustomDestinationList(i32);
#[doc = "*Required features: `Win32_UI_Shell`*"]
...
pub struct IDataObjectAsyncCapability(i32);
pub struct IDataObjectProvider(i32);
pub struct IDataTransferManagerInterop(i32);
pub struct IDefaultExtractIconInit(i32);
pub struct IDefaultFolderMenuInitialize(i32);
pub struct IDelegateFolder(i32);
pub struct IDelegateItem(i32);
pub struct IDeskBand(i32);
pub struct IDeskBand2(i32);
pub struct IDeskBandInfo(i32);
pub struct IDeskBar(i32);
pub struct IDeskBarClient(i32);
pub struct IDesktopGadget(i32);
pub struct IDesktopWallpaper(i32);
pub struct IDestinationStreamFactory(i32);
pub struct IDisplayItem(i32);
pub struct IDocViewSite(i32);
pub struct IDockingWindow(i32);
pub struct IDockingWindowFrame(i32);
pub struct IDockingWindowSite(i32);
pub struct IDragSourceHelper(i32);
pub struct IDragSourceHelper2(i32);
pub struct IDropTargetHelper(i32);
pub struct IDynamicHWHandler(i32);
#[doc = "*Required features: `Win32_UI_Shell`*"]
...
pub struct IEnumACString(i32);
pub struct IEnumAssocHandlers(i32);
pub struct IEnumExplorerCommand(i32);
pub struct IEnumExtraSearch(i32);
pub struct IEnumFullIDList(i32);
pub struct IEnumHLITEM(i32);
pub struct IEnumIDList(i32);
pub struct IEnumObjects(i32);
pub struct IEnumPublishedApps(i32);
pub struct IEnumReadyCallback(i32);
pub struct IEnumResources(i32);
pub struct IEnumShellItems(i32);
pub struct IEnumSyncMgrConflict(i32);
pub struct IEnumSyncMgrEvents(i32);
pub struct IEnumSyncMgrSyncItems(i32);
pub struct IEnumTravelLogEntry(i32);
pub struct IEnumerableView(i32);
pub struct IExecuteCommand(i32);
pub struct IExecuteCommandApplicationHostEnvironment(i32);
pub struct IExecuteCommandHost(i32);
pub struct IExpDispSupport(i32);
pub struct IExpDispSupportXP(i32);
pub struct IExplorerBrowser(i32);
pub struct IExplorerBrowserEvents(i32);
pub struct IExplorerCommand(i32);
pub struct IExplorerCommandProvider(i32);
pub struct IExplorerCommandState(i32);
pub struct IExplorerPaneVisibility(i32);
pub struct IExtensionServices(i32);
pub struct IExtractIconA(i32);
pub struct IExtractIconW(i32);
pub struct IExtractImage(i32);
pub struct IExtractImage2(i32);
pub struct IFileDialog(i32);
pub struct IFileDialog2(i32);
pub struct IFileDialogControlEvents(i32);
pub struct IFileDialogCustomize(i32);
pub struct IFileDialogEvents(i32);
pub struct IFileIsInUse(i32);
pub struct IFileOpenDialog(i32);
pub struct IFileOperation(i32);
pub struct IFileOperation2(i32);
pub struct IFileOperationProgressSink(i32);
pub struct IFileSaveDialog(i32);
pub struct IFileSearchBand(i32);
pub struct IFileSyncMergeHandler(i32);
pub struct IFileSystemBindData(i32);
pub struct IFileSystemBindData2(i32);
pub struct IFolderBandPriv(i32);
pub struct IFolderFilter(i32);
pub struct IFolderFilterSite(i32);
pub struct IFolderView(i32);
pub struct IFolderView2(i32);
pub struct IFolderViewHost(i32);
pub struct IFolderViewOC(i32);
pub struct IFolderViewOptions(i32);
pub struct IFolderViewSettings(i32);
pub struct IFrameworkInputPane(i32);
pub struct IFrameworkInputPaneHandler(i32);
pub struct IGetServiceIds(i32);
pub struct IHWEventHandler(i32);
pub struct IHWEventHandler2(i32);
pub struct IHandlerActivationHost(i32);
pub struct IHandlerInfo(i32);
pub struct IHandlerInfo2(i32);
pub struct IHlink(i32);
pub struct IHlinkBrowseContext(i32);
pub struct IHlinkFrame(i32);
pub struct IHlinkSite(i32);
pub struct IHlinkTarget(i32);
pub struct IHomeGroup(i32);
pub struct IIOCancelInformation(i32);
pub struct IIdentityName(i32);
pub struct IImageRecompress(i32);
pub struct IInitializeCommand(i32);
pub struct IInitializeNetworkFolder(i32);
pub struct IInitializeObject(i32);
pub struct IInitializeWithBindCtx(i32);
pub struct IInitializeWithItem(i32);
pub struct IInitializeWithPropertyStore(i32);
pub struct IInitializeWithWindow(i32);
pub struct IInputObject(i32);
pub struct IInputObject2(i32);
pub struct IInputObjectSite(i32);
pub struct IInputPaneAnimationCoordinator(i32);
pub struct IInputPanelConfiguration(i32);
pub struct IInputPanelInvocationConfiguration(i32);
pub struct IInsertItem(i32);
pub struct IItemNameLimits(i32);
pub struct IKnownFolder(i32);
pub struct IKnownFolderManager(i32);
#[doc = "*Required features: `Win32_UI_Shell`*"]
pub const ILMM_IE4: u32 = 0u32;
pub struct ILaunchSourceAppUserModelId(i32);
pub struct ILaunchSourceViewSizePreference(i32);
pub struct ILaunchTargetMonitor(i32);
pub struct ILaunchTargetViewSizePreference(i32);
pub struct ILaunchUIContext(i32);
pub struct ILaunchUIContextProvider(i32);
#[doc = "*Required features: `Win32_UI_Shell`*"]
...
pub struct IMenuBand(i32);
pub struct IMenuPopup(i32);
pub struct IModalWindow(i32);
#[doc = "*Required features: `Win32_UI_Shell`*"]
pub const INTERNET_MAX_PATH_LENGTH: u32 = 2048u32;
#[doc = "*Required features: `Win32_UI_Shell`*"]
pub const INTERNET_MAX_SCHEME_LENGTH: u32 = 32u32;
pub struct INameSpaceTreeAccessible(i32);
pub struct INameSpaceTreeControl(i32);
pub struct INameSpaceTreeControl2(i32);
pub struct INameSpaceTreeControlCustomDraw(i32);
pub struct INameSpaceTreeControlDropHandler(i32);
pub struct INameSpaceTreeControlEvents(i32);
pub struct INameSpaceTreeControlFolderCapabilities(i32);
pub struct INamedPropertyBag(i32);
pub struct INamespaceWalk(i32);
pub struct INamespaceWalkCB(i32);
pub struct INamespaceWalkCB2(i32);
pub struct INetworkFolderInternal(i32);
pub struct INewMenuClient(i32);
pub struct INewShortcutHookA(i32);
pub struct INewShortcutHookW(i32);
pub struct INewWDEvents(i32);
pub struct INewWindowManager(i32);
pub struct INotifyReplica(i32);
pub struct IObjMgr(i32);
pub struct IObjectProvider(i32);
pub struct IObjectWithAppUserModelID(i32);
pub struct IObjectWithBackReferences(i32);
pub struct IObjectWithCancelEvent(i32);
pub struct IObjectWithFolderEnumMode(i32);
pub struct IObjectWithProgID(i32);
pub struct IObjectWithSelection(i32);
pub struct IOpenControlPanel(i32);
pub struct IOpenSearchSource(i32);
pub struct IOperationsProgressDialog(i32);
pub struct IPackageDebugSettings(i32);
pub struct IPackageDebugSettings2(i32);
pub struct IPackageExecutionStateChangeNotification(i32);
pub struct IParentAndItem(i32);
pub struct IParseAndCreateItem(i32);
pub struct IPersistFolder(i32);
pub struct IPersistFolder2(i32);
pub struct IPersistFolder3(i32);
pub struct IPersistIDList(i32);
pub struct IPreviewHandler(i32);
pub struct IPreviewHandlerFrame(i32);
pub struct IPreviewHandlerVisuals(i32);
pub struct IPreviewItem(i32);
pub struct IPreviousVersionsInfo(i32);
pub struct IProfferService(i32);
pub struct IProgressDialog(i32);
pub struct IPropertyKeyStore(i32);
pub struct IPublishedApp(i32);
pub struct IPublishedApp2(i32);
pub struct IPublishingWizard(i32);
pub struct IQueryAssociations(i32);
pub struct IQueryCancelAutoPlay(i32);
pub struct IQueryCodePage(i32);
pub struct IQueryContinue(i32);
pub struct IQueryContinueWithStatus(i32);
pub struct IQueryInfo(i32);
#[doc = "*Required features: `Win32_UI_Shell`*"]
...
pub struct IRegTreeItem(i32);
pub struct IRelatedItem(i32);
pub struct IRemoteComputer(i32);
pub struct IResolveShellLink(i32);
pub struct IResultsFolder(i32);
pub struct IRunnableTask(i32);
#[doc = "*Required features: `Win32_UI_Shell`*"]
...
pub struct IScriptErrorList(i32);
pub struct ISearchBoxInfo(i32);
pub struct ISearchContext(i32);
pub struct ISearchFolderItemFactory(i32);
pub struct ISharedBitmap(i32);
pub struct ISharingConfigurationManager(i32);
pub struct IShellApp(i32);
pub struct IShellBrowser(i32);
pub struct IShellChangeNotify(i32);
pub struct IShellDetails(i32);
pub struct IShellDispatch(i32);
pub struct IShellDispatch2(i32);
pub struct IShellDispatch3(i32);
pub struct IShellDispatch4(i32);
pub struct IShellDispatch5(i32);
pub struct IShellDispatch6(i32);
pub struct IShellExtInit(i32);
pub struct IShellFavoritesNameSpace(i32);
pub struct IShellFolder(i32);
pub struct IShellFolder2(i32);
pub struct IShellFolderBand(i32);
pub struct IShellFolderView(i32);
pub struct IShellFolderViewCB(i32);
pub struct IShellFolderViewDual(i32);
pub struct IShellFolderViewDual2(i32);
pub struct IShellFolderViewDual3(i32);
pub struct IShellIcon(i32);
pub struct IShellIconOverlay(i32);
pub struct IShellIconOverlayIdentifier(i32);
pub struct IShellIconOverlayManager(i32);
pub struct IShellImageData(i32);
pub struct IShellImageDataAbort(i32);
pub struct IShellImageDataFactory(i32);
pub struct IShellItem(i32);
pub struct IShellItem2(i32);
pub struct IShellItemArray(i32);
pub struct IShellItemFilter(i32);
pub struct IShellItemImageFactory(i32);
pub struct IShellItemResources(i32);
pub struct IShellLibrary(i32);
pub struct IShellLinkA(i32);
pub struct IShellLinkDataList(i32);
pub struct IShellLinkDual(i32);
pub struct IShellLinkDual2(i32);
pub struct IShellLinkW(i32);
pub struct IShellMenu(i32);
pub struct IShellMenuCallback(i32);
pub struct IShellNameSpace(i32);
pub struct IShellPropSheetExt(i32);
pub struct IShellRunDll(i32);
pub struct IShellService(i32);
pub struct IShellTaskScheduler(i32);
pub struct IShellUIHelper(i32);
pub struct IShellUIHelper2(i32);
pub struct IShellUIHelper3(i32);
pub struct IShellUIHelper4(i32);
pub struct IShellUIHelper5(i32);
pub struct IShellUIHelper6(i32);
pub struct IShellUIHelper7(i32);
pub struct IShellUIHelper8(i32);
pub struct IShellUIHelper9(i32);
pub struct IShellView(i32);
pub struct IShellView2(i32);
pub struct IShellView3(i32);
pub struct IShellWindows(i32);
pub struct ISortColumnArray(i32);
pub struct IStartMenuPinnedList(i32);
pub struct IStorageProviderBanners(i32);
pub struct IStorageProviderCopyHook(i32);
pub struct IStorageProviderHandler(i32);
pub struct IStorageProviderPropertyHandler(i32);
pub struct IStreamAsync(i32);
pub struct IStreamUnbufferedInfo(i32);
pub struct ISuspensionDependencyManager(i32);
pub struct ISyncMgrConflict(i32);
pub struct ISyncMgrConflictFolder(i32);
pub struct ISyncMgrConflictItems(i32);
pub struct ISyncMgrConflictPresenter(i32);
pub struct ISyncMgrConflictResolutionItems(i32);
pub struct ISyncMgrConflictResolveInfo(i32);
pub struct ISyncMgrConflictStore(i32);
pub struct ISyncMgrControl(i32);
pub struct ISyncMgrEnumItems(i32);
pub struct ISyncMgrEvent(i32);
pub struct ISyncMgrEventLinkUIOperation(i32);
pub struct ISyncMgrEventStore(i32);
pub struct ISyncMgrHandler(i32);
pub struct ISyncMgrHandlerCollection(i32);
pub struct ISyncMgrHandlerInfo(i32);
pub struct ISyncMgrRegister(i32);
pub struct ISyncMgrResolutionHandler(i32);
pub struct ISyncMgrScheduleWizardUIOperation(i32);
pub struct ISyncMgrSessionCreator(i32);
pub struct ISyncMgrSyncCallback(i32);
pub struct ISyncMgrSyncItem(i32);
pub struct ISyncMgrSyncItemContainer(i32);
pub struct ISyncMgrSyncItemInfo(i32);
pub struct ISyncMgrSyncResult(i32);
pub struct ISyncMgrSynchronize(i32);
pub struct ISyncMgrSynchronizeCallback(i32);
pub struct ISyncMgrSynchronizeInvoke(i32);
pub struct ISyncMgrUIOperation(i32);
...
pub struct ITaskbarList(i32);
pub struct ITaskbarList2(i32);
pub struct ITaskbarList3(i32);
pub struct ITaskbarList4(i32);
pub struct IThumbnailCache(i32);
pub struct IThumbnailCachePrimer(i32);
pub struct IThumbnailCapture(i32);
pub struct IThumbnailHandlerFactory(i32);
pub struct IThumbnailProvider(i32);
pub struct IThumbnailSettings(i32);
pub struct IThumbnailStreamCache(i32);
pub struct ITrackShellMenu(i32);
pub struct ITranscodeImage(i32);
pub struct ITransferAdviseSink(i32);
pub struct ITransferDestination(i32);
pub struct ITransferMediumItem(i32);
pub struct ITransferSource(i32);
pub struct ITravelEntry(i32);
pub struct ITravelLog(i32);
pub struct ITravelLogClient(i32);
pub struct ITravelLogEntry(i32);
pub struct ITravelLogStg(i32);
pub struct ITrayDeskBand(i32);
pub struct IURLSearchHook(i32);
pub struct IURLSearchHook2(i32);
pub struct IUniformResourceLocatorA(i32);
pub struct IUniformResourceLocatorW(i32);
pub struct IUpdateIDList(i32);
pub struct IUseToBrowseItem(i32);
pub struct IUserAccountChangeCallback(i32);
pub struct IUserNotification(i32);
pub struct IUserNotification2(i32);
pub struct IUserNotificationCallback(i32);
pub struct IViewStateIdentityItem(i32);
pub struct IVirtualDesktopManager(i32);
pub struct IVisualProperties(i32);
pub struct IWebBrowser(i32);
pub struct IWebBrowser2(i32);
pub struct IWebBrowserApp(i32);
pub struct IWebWizardExtension(i32);
pub struct IWebWizardHost(i32);
pub struct IWebWizardHost2(i32);
pub struct IWizardExtension(i32);
pub struct IWizardSite(i32);
