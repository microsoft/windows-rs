...
pub const SAFER_TOKEN_NULL_IF_EQUAL: u32 = 1u32;
pub const SAFER_TOKEN_COMPARE_ONLY: u32 = 2u32;
pub const SAFER_TOKEN_MAKE_INERT: u32 = 4u32;
pub const SAFER_TOKEN_WANT_FLAGS: u32 = 8u32;
...
pub const SaferIdentityDefault: i32 = 0i32;
pub const SaferIdentityTypeImageName: i32 = 1i32;
pub const SaferIdentityTypeImageHash: i32 = 2i32;
pub const SaferIdentityTypeUrlZone: i32 = 3i32;
pub const SaferIdentityTypeCertificate: i32 = 4i32;
...
pub const SaferObjectLevelId: i32 = 1i32;
pub const SaferObjectScopeId: i32 = 2i32;
pub const SaferObjectFriendlyName: i32 = 3i32;
pub const SaferObjectDescription: i32 = 4i32;
pub const SaferObjectBuiltin: i32 = 5i32;
pub const SaferObjectDisallowed: i32 = 6i32;
pub const SaferObjectDisableMaxPrivilege: i32 = 7i32;
pub const SaferObjectInvertDeletedPrivileges: i32 = 8i32;
pub const SaferObjectDeletedPrivileges: i32 = 9i32;
pub const SaferObjectDefaultOwner: i32 = 10i32;
pub const SaferObjectSidsToDisable: i32 = 11i32;
pub const SaferObjectRestrictedSidsInverted: i32 = 12i32;
pub const SaferObjectRestrictedSidsAdded: i32 = 13i32;
pub const SaferObjectAllIdentificationGuids: i32 = 14i32;
pub const SaferObjectSingleIdentification: i32 = 15i32;
pub const SaferObjectExtendedError: i32 = 16i32;
#[repr(C)]
#[cfg(feature = "Win32_Foundation")]
...
pub const SaferPolicyLevelList: i32 = 1i32;
pub const SaferPolicyEnableTransparentEnforcement: i32 = 2i32;
pub const SaferPolicyDefaultLevel: i32 = 3i32;
pub const SaferPolicyEvaluateUserScope: i32 = 4i32;
pub const SaferPolicyScopeFlags: i32 = 5i32;
pub const SaferPolicyDefaultLevelFlags: i32 = 6i32;
pub const SaferPolicyAuthenticodeEnabled: i32 = 7i32;
