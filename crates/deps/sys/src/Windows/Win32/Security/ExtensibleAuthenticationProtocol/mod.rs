...
pub struct IAccountingProviderConfig(i32);
pub struct IAuthenticationProviderConfig(i32);
pub struct IEAPProviderConfig(i32);
pub struct IEAPProviderConfig2(i32);
