...
pub struct ICertSrvSetup(i32);
pub struct ICertSrvSetupKeyInformation(i32);
pub struct ICertSrvSetupKeyInformationCollection(i32);
pub struct ICertificateEnrollmentPolicyServerSetup(i32);
pub struct ICertificateEnrollmentServerSetup(i32);
#[doc = "*Required features: `Win32_Security_Cryptography`*"]
