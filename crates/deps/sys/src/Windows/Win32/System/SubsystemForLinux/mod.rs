...
pub const WSL_DISTRIBUTION_FLAGS_NONE: u32 = 0u32;
pub const WSL_DISTRIBUTION_FLAGS_ENABLE_INTEROP: u32 = 1u32;
pub const WSL_DISTRIBUTION_FLAGS_APPEND_NT_PATH: u32 = 2u32;
pub const WSL_DISTRIBUTION_FLAGS_ENABLE_DRIVE_MOUNTING: u32 = 4u32;
