...
extern "system" {
    ...
    pub fn WslConfigureDistribution(distributionname: super::super::Foundation::PWSTR, defaultuid: u32, wsldistributionflags: WSL_DISTRIBUTION_FLAGS) -> ::windows::runtime::HRESULT;
    #[doc = "*Required features: `Win32_System_SubsystemForLinux`, `Win32_Foundation`*"]
    #[cfg(feature = "Win32_Foundation")]
    ...
    #[doc = "*Required features: `Win32_System_SubsystemForLinux`, `Win32_Foundation`*"]
    #[cfg(feature = "Win32_Foundation")]
    pub fn WslLaunchInteractive(distributionname: super::super::Foundation::PWSTR, command: super::super::Foundation::PWSTR, usecurrentworkingdirectory: super::super::Foundation::BOOL, exitcode: *mut u32) -> ::windows::runtime::HRESULT;
    #[doc = "*Required features: `Win32_System_SubsystemForLinux`, `Win32_Foundation`*"]
    #[cfg(feature = "Win32_Foundation")]
    pub fn WslRegisterDistribution(distributionname: super::super::Foundation::PWSTR, targzfilename: super::super::Foundation::PWSTR) -> ::windows::runtime::HRESULT;
    #[doc = "*Required features: `Win32_System_SubsystemForLinux`, `Win32_Foundation`*"]
    #[cfg(feature = "Win32_Foundation")]
    pub fn WslUnregisterDistribution(distributionname: super::super::Foundation::PWSTR) -> ::windows::runtime::HRESULT;
}
