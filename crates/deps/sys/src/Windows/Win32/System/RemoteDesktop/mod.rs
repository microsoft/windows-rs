...
pub struct IADsTSUserEx(i32);
pub struct IAudioDeviceEndpoint(i32);
pub struct IAudioEndpoint(i32);
pub struct IAudioEndpointControl(i32);
pub struct IAudioEndpointRT(i32);
pub struct IAudioInputEndpointRT(i32);
pub struct IAudioOutputEndpointRT(i32);
pub struct IRemoteDesktopClient(i32);
pub struct IRemoteDesktopClientActions(i32);
pub struct IRemoteDesktopClientSettings(i32);
pub struct IRemoteDesktopClientTouchPointer(i32);
pub struct IRemoteSystemAdditionalInfoProvider(i32);
pub struct ITSGAccountingEngine(i32);
pub struct ITSGAuthenticateUserSink(i32);
pub struct ITSGAuthenticationEngine(i32);
pub struct ITSGAuthorizeConnectionSink(i32);
pub struct ITSGAuthorizeResourceSink(i32);
pub struct ITSGPolicyEngine(i32);
pub struct ITsSbBaseNotifySink(i32);
pub struct ITsSbClientConnection(i32);
pub struct ITsSbClientConnectionPropertySet(i32);
pub struct ITsSbEnvironment(i32);
pub struct ITsSbEnvironmentPropertySet(i32);
pub struct ITsSbFilterPluginStore(i32);
pub struct ITsSbGenericNotifySink(i32);
pub struct ITsSbGlobalStore(i32);
pub struct ITsSbLoadBalanceResult(i32);
pub struct ITsSbLoadBalancing(i32);
pub struct ITsSbLoadBalancingNotifySink(i32);
pub struct ITsSbOrchestration(i32);
pub struct ITsSbOrchestrationNotifySink(i32);
pub struct ITsSbPlacement(i32);
pub struct ITsSbPlacementNotifySink(i32);
pub struct ITsSbPlugin(i32);
pub struct ITsSbPluginNotifySink(i32);
pub struct ITsSbPluginPropertySet(i32);
pub struct ITsSbPropertySet(i32);
pub struct ITsSbProvider(i32);
pub struct ITsSbProvisioning(i32);
pub struct ITsSbProvisioningPluginNotifySink(i32);
pub struct ITsSbResourceNotification(i32);
pub struct ITsSbResourceNotificationEx(i32);
pub struct ITsSbResourcePlugin(i32);
pub struct ITsSbResourcePluginStore(i32);
pub struct ITsSbServiceNotification(i32);
pub struct ITsSbSession(i32);
pub struct ITsSbTarget(i32);
pub struct ITsSbTargetPropertySet(i32);
pub struct ITsSbTaskInfo(i32);
pub struct ITsSbTaskPlugin(i32);
pub struct ITsSbTaskPluginNotifySink(i32);
pub struct IWRdsEnhancedFastReconnectArbitrator(i32);
pub struct IWRdsGraphicsChannel(i32);
pub struct IWRdsGraphicsChannelEvents(i32);
pub struct IWRdsGraphicsChannelManager(i32);
pub struct IWRdsProtocolConnection(i32);
pub struct IWRdsProtocolConnectionCallback(i32);
pub struct IWRdsProtocolConnectionSettings(i32);
pub struct IWRdsProtocolLicenseConnection(i32);
pub struct IWRdsProtocolListener(i32);
pub struct IWRdsProtocolListenerCallback(i32);
pub struct IWRdsProtocolLogonErrorRedirector(i32);
pub struct IWRdsProtocolManager(i32);
pub struct IWRdsProtocolSettings(i32);
pub struct IWRdsProtocolShadowCallback(i32);
pub struct IWRdsProtocolShadowConnection(i32);
pub struct IWRdsWddmIddProps(i32);
pub struct IWTSBitmapRenderService(i32);
pub struct IWTSBitmapRenderer(i32);
pub struct IWTSBitmapRendererCallback(i32);
pub struct IWTSListener(i32);
pub struct IWTSListenerCallback(i32);
pub struct IWTSPlugin(i32);
pub struct IWTSPluginServiceProvider(i32);
pub struct IWTSProtocolConnection(i32);
pub struct IWTSProtocolConnectionCallback(i32);
pub struct IWTSProtocolLicenseConnection(i32);
pub struct IWTSProtocolListener(i32);
pub struct IWTSProtocolListenerCallback(i32);
pub struct IWTSProtocolLogonErrorRedirector(i32);
pub struct IWTSProtocolManager(i32);
pub struct IWTSProtocolShadowCallback(i32);
pub struct IWTSProtocolShadowConnection(i32);
pub struct IWTSSBPlugin(i32);
pub struct IWTSVirtualChannel(i32);
pub struct IWTSVirtualChannelCallback(i32);
pub struct IWTSVirtualChannelManager(i32);
pub struct IWorkspace(i32);
pub struct IWorkspace2(i32);
pub struct IWorkspace3(i32);
pub struct IWorkspaceClientExt(i32);
pub struct IWorkspaceRegistration(i32);
pub struct IWorkspaceRegistration2(i32);
pub struct IWorkspaceReportMessage(i32);
pub struct IWorkspaceResTypeRegistry(i32);
pub struct IWorkspaceScriptable(i32);
pub struct IWorkspaceScriptable2(i32);
pub struct IWorkspaceScriptable3(i32);
pub struct ItsPubPlugin(i32);
pub struct ItsPubPlugin2(i32);
#[doc = "*Required features: `Win32_System_RemoteDesktop`*"]
