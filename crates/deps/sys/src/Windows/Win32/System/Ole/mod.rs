...
pub struct IAdviseSinkEx(i32);
pub struct ICanHandleException(i32);
pub struct IClassFactory2(i32);
pub struct IContinue(i32);
pub struct IContinueCallback(i32);
pub struct ICreateErrorInfo(i32);
pub struct ICreateTypeInfo(i32);
pub struct ICreateTypeInfo2(i32);
pub struct ICreateTypeLib(i32);
pub struct ICreateTypeLib2(i32);
#[doc = "*Required features: `Win32_System_Ole`*"]
...
pub struct IDispError(i32);
pub struct IDispatchEx(i32);
pub struct IDropSource(i32);
pub struct IDropSourceNotify(i32);
pub struct IDropTarget(i32);
pub struct IEnterpriseDropTarget(i32);
pub struct IEnumOLEVERB(i32);
pub struct IEnumOleDocumentViews(i32);
pub struct IEnumOleUndoUnits(i32);
pub struct IEnumVARIANT(i32);
pub struct IFont(i32);
pub struct IFontDisp(i32);
pub struct IFontEventsDisp(i32);
pub struct IGNOREMIME(i32);
pub struct IGetOleObject(i32);
pub struct IGetVBAObject(i32);
#[doc = "*Required features: `Win32_System_Ole`*"]
...
pub struct IObjectIdentity(i32);
pub struct IObjectWithSite(i32);
pub struct IOleAdviseHolder(i32);
pub struct IOleCache(i32);
pub struct IOleCache2(i32);
pub struct IOleCacheControl(i32);
pub struct IOleClientSite(i32);
pub struct IOleCommandTarget(i32);
pub struct IOleContainer(i32);
pub struct IOleControl(i32);
pub struct IOleControlSite(i32);
pub struct IOleDocument(i32);
pub struct IOleDocumentSite(i32);
pub struct IOleDocumentView(i32);
pub struct IOleInPlaceActiveObject(i32);
pub struct IOleInPlaceFrame(i32);
pub struct IOleInPlaceObject(i32);
pub struct IOleInPlaceObjectWindowless(i32);
pub struct IOleInPlaceSite(i32);
pub struct IOleInPlaceSiteEx(i32);
pub struct IOleInPlaceSiteWindowless(i32);
pub struct IOleInPlaceUIWindow(i32);
pub struct IOleItemContainer(i32);
pub struct IOleLink(i32);
pub struct IOleObject(i32);
pub struct IOleParentUndoUnit(i32);
pub struct IOleUILinkContainerA(i32);
pub struct IOleUILinkContainerW(i32);
pub struct IOleUILinkInfoA(i32);
pub struct IOleUILinkInfoW(i32);
pub struct IOleUIObjInfoA(i32);
pub struct IOleUIObjInfoW(i32);
pub struct IOleUndoManager(i32);
pub struct IOleUndoUnit(i32);
pub struct IOleWindow(i32);
pub struct IParseDisplayName(i32);
pub struct IPerPropertyBrowsing(i32);
pub struct IPersistPropertyBag(i32);
pub struct IPersistPropertyBag2(i32);
pub struct IPicture(i32);
pub struct IPicture2(i32);
pub struct IPictureDisp(i32);
pub struct IPointerInactive(i32);
pub struct IPrint(i32);
pub struct IPropertyNotifySink(i32);
pub struct IPropertyPage(i32);
pub struct IPropertyPage2(i32);
pub struct IPropertyPageSite(i32);
pub struct IProtectFocus(i32);
pub struct IProtectedModeMenuServices(i32);
pub struct IProvideClassInfo(i32);
pub struct IProvideClassInfo2(i32);
pub struct IProvideMultipleClassInfo(i32);
pub struct IProvideRuntimeContext(i32);
pub struct IQuickActivate(i32);
pub struct IRecordInfo(i32);
pub struct ISimpleFrameSite(i32);
pub struct ISpecifyPropertyPages(i32);
pub struct ITypeChangeEvents(i32);
pub struct ITypeFactory(i32);
pub struct ITypeMarshal(i32);
pub struct IVBFormat(i32);
pub struct IVBGetControl(i32);
pub struct IVariantChangeType(i32);
pub struct IViewObject(i32);
pub struct IViewObject2(i32);
