...
pub const BEGIN_NESTED_SYSTEM_CHANGE: u32 = 102u32;
pub const BEGIN_SYSTEM_CHANGE: u32 = 100u32;
pub const END_NESTED_SYSTEM_CHANGE: u32 = 103u32;
pub const END_SYSTEM_CHANGE: u32 = 101u32;
pub const APPLICATION_INSTALL: u32 = 0u32;
pub const APPLICATION_UNINSTALL: u32 = 1u32;
pub const DEVICE_DRIVER_INSTALL: u32 = 10u32;
pub const MODIFY_SETTINGS: u32 = 12u32;
pub const CANCELLED_OPERATION: u32 = 13u32;
#[repr(C, packed(1))]
