...
pub const WSMAN_FLAG_DEFAULT_AUTHENTICATION: i32 = 0i32;
pub const WSMAN_FLAG_NO_AUTHENTICATION: i32 = 1i32;
pub const WSMAN_FLAG_AUTH_DIGEST: i32 = 2i32;
pub const WSMAN_FLAG_AUTH_NEGOTIATE: i32 = 4i32;
pub const WSMAN_FLAG_AUTH_BASIC: i32 = 8i32;
pub const WSMAN_FLAG_AUTH_KERBEROS: i32 = 16i32;
pub const WSMAN_FLAG_AUTH_CREDSSP: i32 = 128i32;
pub const WSMAN_FLAG_AUTH_CLIENT_CERTIFICATE: i32 = 32i32;
pub const WSMAN_FLAG_CALLBACK_END_OF_OPERATION: i32 = 1i32;
pub const WSMAN_FLAG_CALLBACK_END_OF_STREAM: i32 = 8i32;
pub const WSMAN_FLAG_CALLBACK_SHELL_SUPPORTS_DISCONNECT: i32 = 32i32;
pub const WSMAN_FLAG_CALLBACK_SHELL_AUTODISCONNECTED: i32 = 64i32;
pub const WSMAN_FLAG_CALLBACK_NETWORK_FAILURE_DETECTED: i32 = 256i32;
pub const WSMAN_FLAG_CALLBACK_RETRYING_AFTER_NETWORK_FAILURE: i32 = 512i32;
pub const WSMAN_FLAG_CALLBACK_RECONNECTED_AFTER_NETWORK_FAILURE: i32 = 1024i32;
pub const WSMAN_FLAG_CALLBACK_SHELL_AUTODISCONNECTING: i32 = 2048i32;
pub const WSMAN_FLAG_CALLBACK_RETRY_ABORTED_DUE_TO_INTERNAL_ERROR: i32 = 4096i32;
pub const WSMAN_FLAG_CALLBACK_RECEIVE_DELAY_STREAM_REQUEST_PROCESSED: i32 = 8192i32;
pub const WSMAN_DATA_NONE: i32 = 0i32;
pub const WSMAN_DATA_TYPE_TEXT: i32 = 1i32;
pub const WSMAN_DATA_TYPE_BINARY: i32 = 2i32;
pub const WSMAN_DATA_TYPE_DWORD: i32 = 4i32;
pub const WSManFlagNonXmlText: i32 = 1i32;
pub const WSManFlagReturnObject: i32 = 0i32;
pub const WSManFlagReturnEPR: i32 = 2i32;
pub const WSManFlagReturnObjectAndEPR: i32 = 4i32;
pub const WSManFlagHierarchyDeep: i32 = 0i32;
pub const WSManFlagHierarchyShallow: i32 = 32i32;
pub const WSManFlagHierarchyDeepBasePropsOnly: i32 = 64i32;
pub const WSManFlagAssociatedInstance: i32 = 0i32;
pub const WSManFlagAssociationInstance: i32 = 128i32;
...
pub const WSMAN_OPTION_PROXY_IE_PROXY_CONFIG: i32 = 1i32;
pub const WSMAN_OPTION_PROXY_WINHTTP_PROXY_CONFIG: i32 = 2i32;
pub const WSMAN_OPTION_PROXY_AUTO_DETECT: i32 = 4i32;
pub const WSMAN_OPTION_PROXY_NO_PROXY_SERVER: i32 = 8i32;
pub const WSManProxyIEConfig: i32 = 1i32;
pub const WSManProxyWinHttpConfig: i32 = 2i32;
pub const WSManProxyAutoDetect: i32 = 4i32;
pub const WSManProxyNoProxyServer: i32 = 8i32;
pub const WSManFlagProxyAuthenticationUseNegotiate: i32 = 1i32;
pub const WSManFlagProxyAuthenticationUseBasic: i32 = 2i32;
pub const WSManFlagProxyAuthenticationUseDigest: i32 = 4i32;
pub const WSManFlagUTF8: i32 = 1i32;
pub const WSManFlagCredUsernamePassword: i32 = 4096i32;
pub const WSManFlagSkipCACheck: i32 = 8192i32;
pub const WSManFlagSkipCNCheck: i32 = 16384i32;
pub const WSManFlagUseNoAuthentication: i32 = 32768i32;
pub const WSManFlagUseDigest: i32 = 65536i32;
pub const WSManFlagUseNegotiate: i32 = 131072i32;
pub const WSManFlagUseBasic: i32 = 262144i32;
pub const WSManFlagUseKerberos: i32 = 524288i32;
pub const WSManFlagNoEncryption: i32 = 1048576i32;
pub const WSManFlagUseClientCertificate: i32 = 2097152i32;
pub const WSManFlagEnableSPNServerPort: i32 = 4194304i32;
pub const WSManFlagUTF16: i32 = 8388608i32;
pub const WSManFlagUseCredSsp: i32 = 16777216i32;
pub const WSManFlagSkipRevocationCheck: i32 = 33554432i32;
pub const WSManFlagAllowNegotiateImplicitCredentials: i32 = 67108864i32;
pub const WSManFlagUseSsl: i32 = 134217728i32;
pub const WSMAN_OPTION_DEFAULT_OPERATION_TIMEOUTMS: i32 = 1i32;
pub const WSMAN_OPTION_MAX_RETRY_TIME: i32 = 11i32;
pub const WSMAN_OPTION_TIMEOUTMS_CREATE_SHELL: i32 = 12i32;
pub const WSMAN_OPTION_TIMEOUTMS_RUN_SHELL_COMMAND: i32 = 13i32;
pub const WSMAN_OPTION_TIMEOUTMS_RECEIVE_SHELL_OUTPUT: i32 = 14i32;
pub const WSMAN_OPTION_TIMEOUTMS_SEND_SHELL_INPUT: i32 = 15i32;
pub const WSMAN_OPTION_TIMEOUTMS_SIGNAL_SHELL: i32 = 16i32;
pub const WSMAN_OPTION_TIMEOUTMS_CLOSE_SHELL: i32 = 17i32;
pub const WSMAN_OPTION_SKIP_CA_CHECK: i32 = 18i32;
pub const WSMAN_OPTION_SKIP_CN_CHECK: i32 = 19i32;
pub const WSMAN_OPTION_UNENCRYPTED_MESSAGES: i32 = 20i32;
pub const WSMAN_OPTION_UTF16: i32 = 21i32;
pub const WSMAN_OPTION_ENABLE_SPN_SERVER_PORT: i32 = 22i32;
pub const WSMAN_OPTION_MACHINE_ID: i32 = 23i32;
pub const WSMAN_OPTION_LOCALE: i32 = 25i32;
pub const WSMAN_OPTION_UI_LANGUAGE: i32 = 26i32;
pub const WSMAN_OPTION_MAX_ENVELOPE_SIZE_KB: i32 = 28i32;
pub const WSMAN_OPTION_SHELL_MAX_DATA_SIZE_PER_MESSAGE_KB: i32 = 29i32;
pub const WSMAN_OPTION_REDIRECT_LOCATION: i32 = 30i32;
pub const WSMAN_OPTION_SKIP_REVOCATION_CHECK: i32 = 31i32;
pub const WSMAN_OPTION_ALLOW_NEGOTIATE_IMPLICIT_CREDENTIALS: i32 = 32i32;
pub const WSMAN_OPTION_USE_SSL: i32 = 33i32;
pub const WSMAN_OPTION_USE_INTEARACTIVE_TOKEN: i32 = 34i32;
pub const WSMAN_FLAG_NO_COMPRESSION: i32 = 1i32;
pub const WSMAN_FLAG_DELETE_SERVER_SESSION: i32 = 2i32;
pub const WSMAN_FLAG_SERVER_BUFFERING_MODE_DROP: i32 = 4i32;
pub const WSMAN_FLAG_SERVER_BUFFERING_MODE_BLOCK: i32 = 8i32;
pub const WSMAN_FLAG_RECEIVE_DELAY_OUTPUT_STREAM: i32 = 16i32;
