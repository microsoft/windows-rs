...
pub struct IAutomaticUpdates(i32);
pub struct IAutomaticUpdates2(i32);
pub struct IAutomaticUpdatesResults(i32);
pub struct IAutomaticUpdatesSettings(i32);
pub struct IAutomaticUpdatesSettings2(i32);
pub struct IAutomaticUpdatesSettings3(i32);
pub struct ICategory(i32);
pub struct ICategoryCollection(i32);
pub struct IDownloadCompletedCallback(i32);
pub struct IDownloadCompletedCallbackArgs(i32);
pub struct IDownloadJob(i32);
pub struct IDownloadProgress(i32);
pub struct IDownloadProgressChangedCallback(i32);
pub struct IDownloadProgressChangedCallbackArgs(i32);
pub struct IDownloadResult(i32);
pub struct IImageInformation(i32);
pub struct IInstallationAgent(i32);
pub struct IInstallationBehavior(i32);
pub struct IInstallationCompletedCallback(i32);
pub struct IInstallationCompletedCallbackArgs(i32);
pub struct IInstallationJob(i32);
pub struct IInstallationProgress(i32);
pub struct IInstallationProgressChangedCallback(i32);
pub struct IInstallationProgressChangedCallbackArgs(i32);
pub struct IInstallationResult(i32);
pub struct IInvalidProductLicenseException(i32);
pub struct ISearchCompletedCallback(i32);
pub struct ISearchCompletedCallbackArgs(i32);
pub struct ISearchJob(i32);
pub struct ISearchResult(i32);
pub struct IStringCollection(i32);
pub struct ISystemInformation(i32);
pub struct IUpdate(i32);
pub struct IUpdate2(i32);
pub struct IUpdate3(i32);
pub struct IUpdate4(i32);
pub struct IUpdate5(i32);
pub struct IUpdateCollection(i32);
pub struct IUpdateDownloadContent(i32);
pub struct IUpdateDownloadContent2(i32);
pub struct IUpdateDownloadContentCollection(i32);
pub struct IUpdateDownloadResult(i32);
pub struct IUpdateDownloader(i32);
pub struct IUpdateException(i32);
pub struct IUpdateExceptionCollection(i32);
pub struct IUpdateHistoryEntry(i32);
pub struct IUpdateHistoryEntry2(i32);
pub struct IUpdateHistoryEntryCollection(i32);
pub struct IUpdateIdentity(i32);
pub struct IUpdateInstallationResult(i32);
pub struct IUpdateInstaller(i32);
pub struct IUpdateInstaller2(i32);
pub struct IUpdateInstaller3(i32);
pub struct IUpdateInstaller4(i32);
pub struct IUpdateLockdown(i32);
pub struct IUpdateSearcher(i32);
pub struct IUpdateSearcher2(i32);
pub struct IUpdateSearcher3(i32);
pub struct IUpdateService(i32);
pub struct IUpdateService2(i32);
pub struct IUpdateServiceCollection(i32);
pub struct IUpdateServiceManager(i32);
pub struct IUpdateServiceManager2(i32);
pub struct IUpdateServiceRegistration(i32);
pub struct IUpdateSession(i32);
pub struct IUpdateSession2(i32);
pub struct IUpdateSession3(i32);
pub struct IWebProxy(i32);
pub struct IWindowsDriverUpdate(i32);
pub struct IWindowsDriverUpdate2(i32);
pub struct IWindowsDriverUpdate3(i32);
pub struct IWindowsDriverUpdate4(i32);
pub struct IWindowsDriverUpdate5(i32);
pub struct IWindowsDriverUpdateEntry(i32);
pub struct IWindowsDriverUpdateEntryCollection(i32);
pub struct IWindowsUpdateAgentInfo(i32);
