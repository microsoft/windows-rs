...
pub struct DWebBridgeEvents(i32);
pub struct DispApplicationCache(i32);
pub struct DispCEventObj(i32);
pub struct DispCPlugins(i32);
pub struct DispCPrintManagerTemplatePrinter(i32);
pub struct DispCanvasGradient(i32);
pub struct DispCanvasImageData(i32);
pub struct DispCanvasPattern(i32);
pub struct DispCanvasRenderingContext2D(i32);
pub struct DispCanvasTextMetrics(i32);
pub struct DispDOMBeforeUnloadEvent(i32);
pub struct DispDOMChildrenCollection(i32);
pub struct DispDOMCloseEvent(i32);
pub struct DispDOMCompositionEvent(i32);
pub struct DispDOMCustomEvent(i32);
pub struct DispDOMDocumentType(i32);
pub struct DispDOMDragEvent(i32);
pub struct DispDOMEvent(i32);
pub struct DispDOMException(i32);
pub struct DispDOMFocusEvent(i32);
pub struct DispDOMKeyboardEvent(i32);
pub struct DispDOMMSAnimationEvent(i32);
pub struct DispDOMMSManipulationEvent(i32);
pub struct DispDOMMSTransitionEvent(i32);
pub struct DispDOMMessageEvent(i32);
pub struct DispDOMMouseEvent(i32);
pub struct DispDOMMouseWheelEvent(i32);
pub struct DispDOMMutationEvent(i32);
pub struct DispDOMParser(i32);
pub struct DispDOMProcessingInstruction(i32);
pub struct DispDOMProgressEvent(i32);
pub struct DispDOMSiteModeEvent(i32);
pub struct DispDOMStorageEvent(i32);
pub struct DispDOMTextEvent(i32);
pub struct DispDOMUIEvent(i32);
pub struct DispDOMWheelEvent(i32);
pub struct DispEventException(i32);
pub struct DispHTCAttachBehavior(i32);
pub struct DispHTCDefaultDispatch(i32);
pub struct DispHTCDescBehavior(i32);
pub struct DispHTCEventBehavior(i32);
pub struct DispHTCMethodBehavior(i32);
pub struct DispHTCPropertyBehavior(i32);
pub struct DispHTMLAnchorElement(i32);
pub struct DispHTMLAppBehavior(i32);
pub struct DispHTMLAreaElement(i32);
pub struct DispHTMLAreasCollection(i32);
pub struct DispHTMLAttributeCollection(i32);
pub struct DispHTMLAudioElement(i32);
pub struct DispHTMLBGsound(i32);
pub struct DispHTMLBRElement(i32);
pub struct DispHTMLBaseElement(i32);
pub struct DispHTMLBaseFontElement(i32);
pub struct DispHTMLBlockElement(i32);
pub struct DispHTMLBody(i32);
pub struct DispHTMLButtonElement(i32);
pub struct DispHTMLCSSImportRule(i32);
pub struct DispHTMLCSSMediaList(i32);
pub struct DispHTMLCSSMediaRule(i32);
pub struct DispHTMLCSSNamespaceRule(i32);
pub struct DispHTMLCSSRule(i32);
pub struct DispHTMLCSSStyleDeclaration(i32);
pub struct DispHTMLCanvasElement(i32);
pub struct DispHTMLCommentElement(i32);
pub struct DispHTMLCurrentStyle(i32);
pub struct DispHTMLDDElement(i32);
pub struct DispHTMLDListElement(i32);
pub struct DispHTMLDOMAttribute(i32);
pub struct DispHTMLDOMImplementation(i32);
pub struct DispHTMLDOMRange(i32);
pub struct DispHTMLDOMTextNode(i32);
pub struct DispHTMLDTElement(i32);
pub struct DispHTMLDefaults(i32);
pub struct DispHTMLDivElement(i32);
pub struct DispHTMLDivPosition(i32);
pub struct DispHTMLDocument(i32);
pub struct DispHTMLDocumentCompatibleInfo(i32);
pub struct DispHTMLDocumentCompatibleInfoCollection(i32);
pub struct DispHTMLElementCollection(i32);
pub struct DispHTMLEmbed(i32);
pub struct DispHTMLFieldSetElement(i32);
pub struct DispHTMLFontElement(i32);
pub struct DispHTMLFormElement(i32);
pub struct DispHTMLFrameBase(i32);
pub struct DispHTMLFrameElement(i32);
pub struct DispHTMLFrameSetSite(i32);
pub struct DispHTMLGenericElement(i32);
pub struct DispHTMLHRElement(i32);
pub struct DispHTMLHeadElement(i32);
pub struct DispHTMLHeaderElement(i32);
pub struct DispHTMLHistory(i32);
pub struct DispHTMLHtmlElement(i32);
pub struct DispHTMLIFrame(i32);
pub struct DispHTMLImg(i32);
pub struct DispHTMLInputElement(i32);
pub struct DispHTMLIsIndexElement(i32);
pub struct DispHTMLLIElement(i32);
pub struct DispHTMLLabelElement(i32);
pub struct DispHTMLLegendElement(i32);
pub struct DispHTMLLinkElement(i32);
pub struct DispHTMLListElement(i32);
pub struct DispHTMLLocation(i32);
pub struct DispHTMLMSCSSKeyframeRule(i32);
pub struct DispHTMLMSCSSKeyframesRule(i32);
pub struct DispHTMLMapElement(i32);
pub struct DispHTMLMarqueeElement(i32);
pub struct DispHTMLMediaElement(i32);
pub struct DispHTMLMediaError(i32);
pub struct DispHTMLMetaElement(i32);
pub struct DispHTMLNamespace(i32);
pub struct DispHTMLNamespaceCollection(i32);
pub struct DispHTMLNavigator(i32);
pub struct DispHTMLNextIdElement(i32);
pub struct DispHTMLNoShowElement(i32);
pub struct DispHTMLOListElement(i32);
pub struct DispHTMLObjectElement(i32);
pub struct DispHTMLOptionElement(i32);
pub struct DispHTMLParaElement(i32);
pub struct DispHTMLParamElement(i32);
pub struct DispHTMLPerformance(i32);
pub struct DispHTMLPerformanceNavigation(i32);
pub struct DispHTMLPerformanceTiming(i32);
pub struct DispHTMLPhraseElement(i32);
pub struct DispHTMLPopup(i32);
pub struct DispHTMLProgressElement(i32);
pub struct DispHTMLRenderStyle(i32);
pub struct DispHTMLRichtextElement(i32);
pub struct DispHTMLRuleStyle(i32);
pub struct DispHTMLScreen(i32);
pub struct DispHTMLScriptElement(i32);
pub struct DispHTMLSelectElement(i32);
pub struct DispHTMLSemanticElement(i32);
pub struct DispHTMLSourceElement(i32);
pub struct DispHTMLSpanElement(i32);
pub struct DispHTMLSpanFlow(i32);
pub struct DispHTMLStorage(i32);
pub struct DispHTMLStyle(i32);
pub struct DispHTMLStyleElement(i32);
pub struct DispHTMLStyleFontFace(i32);
pub struct DispHTMLStyleMedia(i32);
pub struct DispHTMLStyleSheet(i32);
pub struct DispHTMLStyleSheetPage(i32);
pub struct DispHTMLStyleSheetPagesCollection(i32);
pub struct DispHTMLStyleSheetRule(i32);
pub struct DispHTMLStyleSheetRulesAppliedCollection(i32);
pub struct DispHTMLStyleSheetRulesCollection(i32);
pub struct DispHTMLStyleSheetsCollection(i32);
pub struct DispHTMLTable(i32);
pub struct DispHTMLTableCaption(i32);
pub struct DispHTMLTableCell(i32);
pub struct DispHTMLTableCol(i32);
pub struct DispHTMLTableRow(i32);
pub struct DispHTMLTableSection(i32);
pub struct DispHTMLTextAreaElement(i32);
pub struct DispHTMLTextElement(i32);
pub struct DispHTMLTimeRanges(i32);
pub struct DispHTMLTitleElement(i32);
pub struct DispHTMLUListElement(i32);
pub struct DispHTMLUnknownElement(i32);
pub struct DispHTMLUrnCollection(i32);
pub struct DispHTMLVideoElement(i32);
pub struct DispHTMLW3CComputedStyle(i32);
pub struct DispHTMLWindow2(i32);
pub struct DispHTMLWindowProxy(i32);
pub struct DispHTMLWndOptionElement(i32);
pub struct DispHTMLWndSelectElement(i32);
pub struct DispHTMLXMLHttpRequest(i32);
pub struct DispIHTMLInputButtonElement(i32);
pub struct DispIHTMLInputFileElement(i32);
pub struct DispIHTMLInputImage(i32);
pub struct DispIHTMLInputTextElement(i32);
pub struct DispIHTMLOptionButtonElement(i32);
pub struct DispNodeIterator(i32);
pub struct DispRangeException(i32);
pub struct DispRulesApplied(i32);
pub struct DispRulesAppliedCollection(i32);
pub struct DispSVGAElement(i32);
pub struct DispSVGCircleElement(i32);
pub struct DispSVGClipPathElement(i32);
pub struct DispSVGDefsElement(i32);
pub struct DispSVGDescElement(i32);
pub struct DispSVGElement(i32);
pub struct DispSVGElementInstance(i32);
pub struct DispSVGElementInstanceList(i32);
pub struct DispSVGEllipseElement(i32);
pub struct DispSVGException(i32);
pub struct DispSVGGElement(i32);
pub struct DispSVGGradientElement(i32);
pub struct DispSVGImageElement(i32);
pub struct DispSVGLineElement(i32);
pub struct DispSVGLinearGradientElement(i32);
pub struct DispSVGMarkerElement(i32);
pub struct DispSVGMaskElement(i32);
pub struct DispSVGMetadataElement(i32);
pub struct DispSVGPathElement(i32);
pub struct DispSVGPathSegArcAbs(i32);
pub struct DispSVGPathSegArcRel(i32);
pub struct DispSVGPathSegClosePath(i32);
pub struct DispSVGPathSegCurvetoCubicAbs(i32);
pub struct DispSVGPathSegCurvetoCubicRel(i32);
pub struct DispSVGPathSegCurvetoCubicSmoothAbs(i32);
pub struct DispSVGPathSegCurvetoCubicSmoothRel(i32);
pub struct DispSVGPathSegCurvetoQuadraticAbs(i32);
pub struct DispSVGPathSegCurvetoQuadraticRel(i32);
pub struct DispSVGPathSegCurvetoQuadraticSmoothAbs(i32);
pub struct DispSVGPathSegCurvetoQuadraticSmoothRel(i32);
pub struct DispSVGPathSegLinetoAbs(i32);
pub struct DispSVGPathSegLinetoHorizontalAbs(i32);
pub struct DispSVGPathSegLinetoHorizontalRel(i32);
pub struct DispSVGPathSegLinetoRel(i32);
pub struct DispSVGPathSegLinetoVerticalAbs(i32);
pub struct DispSVGPathSegLinetoVerticalRel(i32);
pub struct DispSVGPathSegMovetoAbs(i32);
pub struct DispSVGPathSegMovetoRel(i32);
pub struct DispSVGPatternElement(i32);
pub struct DispSVGPolygonElement(i32);
pub struct DispSVGPolylineElement(i32);
pub struct DispSVGRadialGradientElement(i32);
pub struct DispSVGRectElement(i32);
pub struct DispSVGSVGElement(i32);
pub struct DispSVGScriptElement(i32);
pub struct DispSVGStopElement(i32);
pub struct DispSVGStyleElement(i32);
pub struct DispSVGSwitchElement(i32);
pub struct DispSVGSymbolElement(i32);
pub struct DispSVGTSpanElement(i32);
pub struct DispSVGTextContentElement(i32);
pub struct DispSVGTextElement(i32);
pub struct DispSVGTextPathElement(i32);
pub struct DispSVGTextPositioningElement(i32);
pub struct DispSVGTitleElement(i32);
pub struct DispSVGUseElement(i32);
pub struct DispSVGViewElement(i32);
pub struct DispSVGZoomEvent(i32);
pub struct DispStaticNodeList(i32);
pub struct DispTreeWalker(i32);
pub struct DispWebGeocoordinates(i32);
pub struct DispWebGeolocation(i32);
pub struct DispWebGeoposition(i32);
pub struct DispWebGeopositionError(i32);
pub struct DispXDomainRequest(i32);
pub struct DispXMLHttpRequestEventTarget(i32);
pub struct DispXMLSerializer(i32);
...
pub struct HTMLAnchorEvents(i32);
pub struct HTMLAnchorEvents2(i32);
pub struct HTMLAppBehavior(i32);
pub struct HTMLAppFlag(i32);
pub struct HTMLAreaElement(i32);
pub struct HTMLAreaEvents(i32);
pub struct HTMLAreaEvents2(i32);
...
pub struct HTMLButtonElementEvents(i32);
pub struct HTMLButtonElementEvents2(i32);
...
pub struct HTMLControlElementEvents(i32);
pub struct HTMLControlElementEvents2(i32);
...
pub struct HTMLDocumentEvents(i32);
pub struct HTMLDocumentEvents2(i32);
pub struct HTMLDocumentEvents3(i32);
pub struct HTMLDocumentEvents4(i32);
pub struct HTMLElementCollection(i32);
pub struct HTMLElementEvents(i32);
pub struct HTMLElementEvents2(i32);
pub struct HTMLElementEvents3(i32);
pub struct HTMLElementEvents4(i32);
pub struct HTMLEmbed(i32);
pub struct HTMLFieldSetElement(i32);
pub struct HTMLFontElement(i32);
pub struct HTMLFormElement(i32);
pub struct HTMLFormElementEvents(i32);
pub struct HTMLFormElementEvents2(i32);
pub struct HTMLFrameBase(i32);
pub struct HTMLFrameElement(i32);
pub struct HTMLFrameSetSite(i32);
pub struct HTMLFrameSiteEvents(i32);
pub struct HTMLFrameSiteEvents2(i32);
...
pub struct HTMLImgEvents(i32);
pub struct HTMLImgEvents2(i32);
pub struct HTMLInputButtonElement(i32);
pub struct HTMLInputElement(i32);
pub struct HTMLInputFileElement(i32);
pub struct HTMLInputFileElementEvents(i32);
pub struct HTMLInputFileElementEvents2(i32);
pub struct HTMLInputImage(i32);
pub struct HTMLInputImageEvents(i32);
pub struct HTMLInputImageEvents2(i32);
pub struct HTMLInputTextElement(i32);
pub struct HTMLInputTextElementEvents(i32);
pub struct HTMLInputTextElementEvents2(i32);
pub struct HTMLIsIndexElement(i32);
pub struct HTMLLIElement(i32);
pub struct HTMLLabelElement(i32);
pub struct HTMLLabelEvents(i32);
pub struct HTMLLabelEvents2(i32);
pub struct HTMLLegendElement(i32);
pub struct HTMLLinkElement(i32);
pub struct HTMLLinkElementEvents(i32);
pub struct HTMLLinkElementEvents2(i32);
...
pub struct HTMLMapEvents(i32);
pub struct HTMLMapEvents2(i32);
pub struct HTMLMarqueeElement(i32);
pub struct HTMLMarqueeElementEvents(i32);
pub struct HTMLMarqueeElementEvents2(i32);
...
pub struct HTMLNamespaceEvents(i32);
...
pub struct HTMLObjectElementEvents(i32);
pub struct HTMLObjectElementEvents2(i32);
pub struct HTMLOptionButtonElement(i32);
pub struct HTMLOptionButtonElementEvents(i32);
pub struct HTMLOptionButtonElementEvents2(i32);
...
pub struct HTMLScriptEvents(i32);
pub struct HTMLScriptEvents2(i32);
pub struct HTMLSelectElement(i32);
pub struct HTMLSelectElementEvents(i32);
pub struct HTMLSelectElementEvents2(i32);
...
pub struct HTMLStyleElementEvents(i32);
pub struct HTMLStyleElementEvents2(i32);
...
pub struct HTMLTableEvents(i32);
pub struct HTMLTableEvents2(i32);
pub struct HTMLTableRow(i32);
pub struct HTMLTableSection(i32);
pub struct HTMLTextAreaElement(i32);
pub struct HTMLTextContainerEvents(i32);
pub struct HTMLTextContainerEvents2(i32);
...
pub struct HTMLWindowEvents(i32);
pub struct HTMLWindowEvents2(i32);
pub struct HTMLWindowEvents3(i32);
...
pub struct IActiveXUIHandlerSite(i32);
pub struct IActiveXUIHandlerSite2(i32);
pub struct IActiveXUIHandlerSite3(i32);
pub struct IAnchorClick(i32);
pub struct IAudioSessionSite(i32);
pub struct IBFCacheable(i32);
pub struct IBlockFormats(i32);
pub struct ICSSFilter(i32);
pub struct ICSSFilterSite(i32);
pub struct ICanvasGradient(i32);
pub struct ICanvasImageData(i32);
pub struct ICanvasPattern(i32);
pub struct ICanvasPixelArray(i32);
pub struct ICanvasPixelArrayData(i32);
pub struct ICanvasRenderingContext2D(i32);
pub struct ICanvasTextMetrics(i32);
pub struct ICaretPositionProvider(i32);
pub struct IClassFactoryEx(i32);
pub struct IClientCaps(i32);
pub struct ICustomDoc(i32);
#[doc = "*Required features: `Win32_Web_MsHtml`*"]
...
pub struct IDOMBeforeUnloadEvent(i32);
pub struct IDOMCloseEvent(i32);
pub struct IDOMCompositionEvent(i32);
pub struct IDOMCustomEvent(i32);
pub struct IDOMDocumentType(i32);
pub struct IDOMDragEvent(i32);
pub struct IDOMEvent(i32);
pub struct IDOMEventRegistrationCallback(i32);
pub struct IDOMException(i32);
pub struct IDOMFocusEvent(i32);
pub struct IDOMKeyboardEvent(i32);
pub struct IDOMMSAnimationEvent(i32);
pub struct IDOMMSManipulationEvent(i32);
pub struct IDOMMSTransitionEvent(i32);
pub struct IDOMMessageEvent(i32);
pub struct IDOMMouseEvent(i32);
pub struct IDOMMouseWheelEvent(i32);
pub struct IDOMMutationEvent(i32);
pub struct IDOMNodeIterator(i32);
pub struct IDOMParser(i32);
pub struct IDOMParserFactory(i32);
pub struct IDOMProcessingInstruction(i32);
pub struct IDOMProgressEvent(i32);
pub struct IDOMSiteModeEvent(i32);
pub struct IDOMStorageEvent(i32);
pub struct IDOMTextEvent(i32);
pub struct IDOMTreeWalker(i32);
pub struct IDOMUIEvent(i32);
pub struct IDOMWheelEvent(i32);
pub struct IDOMXmlSerializer(i32);
pub struct IDOMXmlSerializerFactory(i32);
pub struct IDebugCallbackNotificationHandler(i32);
pub struct IDeveloperConsoleMessageReceiver(i32);
pub struct IDeviceRect(i32);
pub struct IDiagnosticsScriptEngine(i32);
pub struct IDiagnosticsScriptEngineProvider(i32);
pub struct IDiagnosticsScriptEngineSite(i32);
pub struct IDisplayPointer(i32);
pub struct IDisplayServices(i32);
pub struct IDithererImpl(i32);
pub struct IDocHostShowUI(i32);
pub struct IDocHostUIHandler(i32);
pub struct IDocHostUIHandler2(i32);
pub struct IDocObjectService(i32);
pub struct IDocumentEvent(i32);
pub struct IDocumentRange(i32);
pub struct IDocumentSelector(i32);
pub struct IDocumentTraversal(i32);
pub struct IDownloadBehavior(i32);
pub struct IDownloadManager(i32);
#[doc = "*Required features: `Win32_Web_MsHtml`*"]
...
pub struct IElementBehavior(i32);
pub struct IElementBehaviorCategory(i32);
pub struct IElementBehaviorFactory(i32);
pub struct IElementBehaviorFocus(i32);
pub struct IElementBehaviorLayout(i32);
pub struct IElementBehaviorLayout2(i32);
pub struct IElementBehaviorRender(i32);
pub struct IElementBehaviorSite(i32);
pub struct IElementBehaviorSiteCategory(i32);
pub struct IElementBehaviorSiteLayout(i32);
pub struct IElementBehaviorSiteLayout2(i32);
pub struct IElementBehaviorSiteOM(i32);
pub struct IElementBehaviorSiteOM2(i32);
pub struct IElementBehaviorSiteRender(i32);
pub struct IElementBehaviorSubmit(i32);
pub struct IElementNamespace(i32);
pub struct IElementNamespaceFactory(i32);
pub struct IElementNamespaceFactory2(i32);
pub struct IElementNamespaceFactoryCallback(i32);
pub struct IElementNamespaceTable(i32);
pub struct IElementSegment(i32);
pub struct IElementSelector(i32);
pub struct IElementTraversal(i32);
pub struct IEnumManagerFrames(i32);
pub struct IEnumOpenServiceActivity(i32);
pub struct IEnumOpenServiceActivityCategory(i32);
pub struct IEnumPrivacyRecords(i32);
pub struct IEnumSTATURL(i32);
pub struct IEventException(i32);
pub struct IEventTarget(i32);
pub struct IEventTarget2(i32);
pub struct IExtensionValidation(i32);
pub struct IFontNames(i32);
pub struct IGetSVGDocument(i32);
pub struct IHTCAttachBehavior(i32);
pub struct IHTCAttachBehavior2(i32);
pub struct IHTCDefaultDispatch(i32);
pub struct IHTCDescBehavior(i32);
pub struct IHTCEventBehavior(i32);
pub struct IHTCMethodBehavior(i32);
pub struct IHTCPropertyBehavior(i32);
pub struct IHTMLAnchorElement(i32);
pub struct IHTMLAnchorElement2(i32);
pub struct IHTMLAnchorElement3(i32);
pub struct IHTMLAppBehavior(i32);
pub struct IHTMLAppBehavior2(i32);
pub struct IHTMLAppBehavior3(i32);
pub struct IHTMLApplicationCache(i32);
pub struct IHTMLAreaElement(i32);
pub struct IHTMLAreaElement2(i32);
pub struct IHTMLAreasCollection(i32);
pub struct IHTMLAreasCollection2(i32);
pub struct IHTMLAreasCollection3(i32);
pub struct IHTMLAreasCollection4(i32);
pub struct IHTMLAttributeCollection(i32);
pub struct IHTMLAttributeCollection2(i32);
pub struct IHTMLAttributeCollection3(i32);
pub struct IHTMLAttributeCollection4(i32);
pub struct IHTMLAudioElement(i32);
pub struct IHTMLAudioElementFactory(i32);
pub struct IHTMLBGsound(i32);
pub struct IHTMLBRElement(i32);
pub struct IHTMLBaseElement(i32);
pub struct IHTMLBaseElement2(i32);
pub struct IHTMLBaseFontElement(i32);
pub struct IHTMLBlockElement(i32);
pub struct IHTMLBlockElement2(i32);
pub struct IHTMLBlockElement3(i32);
pub struct IHTMLBodyElement(i32);
pub struct IHTMLBodyElement2(i32);
pub struct IHTMLBodyElement3(i32);
pub struct IHTMLBodyElement4(i32);
pub struct IHTMLBodyElement5(i32);
pub struct IHTMLBookmarkCollection(i32);
pub struct IHTMLButtonElement(i32);
pub struct IHTMLButtonElement2(i32);
pub struct IHTMLCSSImportRule(i32);
pub struct IHTMLCSSMediaList(i32);
pub struct IHTMLCSSMediaRule(i32);
pub struct IHTMLCSSNamespaceRule(i32);
pub struct IHTMLCSSRule(i32);
pub struct IHTMLCSSStyleDeclaration(i32);
pub struct IHTMLCSSStyleDeclaration2(i32);
pub struct IHTMLCSSStyleDeclaration3(i32);
pub struct IHTMLCSSStyleDeclaration4(i32);
pub struct IHTMLCanvasElement(i32);
pub struct IHTMLCaret(i32);
pub struct IHTMLChangeLog(i32);
pub struct IHTMLChangePlayback(i32);
pub struct IHTMLChangeSink(i32);
pub struct IHTMLCommentElement(i32);
pub struct IHTMLCommentElement2(i32);
pub struct IHTMLCommentElement3(i32);
pub struct IHTMLComputedStyle(i32);
pub struct IHTMLControlElement(i32);
pub struct IHTMLControlRange(i32);
pub struct IHTMLControlRange2(i32);
pub struct IHTMLCurrentStyle(i32);
pub struct IHTMLCurrentStyle2(i32);
pub struct IHTMLCurrentStyle3(i32);
pub struct IHTMLCurrentStyle4(i32);
pub struct IHTMLCurrentStyle5(i32);
pub struct IHTMLDDElement(i32);
pub struct IHTMLDListElement(i32);
pub struct IHTMLDOMAttribute(i32);
pub struct IHTMLDOMAttribute2(i32);
pub struct IHTMLDOMAttribute3(i32);
pub struct IHTMLDOMAttribute4(i32);
pub struct IHTMLDOMChildrenCollection(i32);
pub struct IHTMLDOMChildrenCollection2(i32);
pub struct IHTMLDOMConstructor(i32);
pub struct IHTMLDOMConstructorCollection(i32);
pub struct IHTMLDOMImplementation(i32);
pub struct IHTMLDOMImplementation2(i32);
pub struct IHTMLDOMNode(i32);
pub struct IHTMLDOMNode2(i32);
pub struct IHTMLDOMNode3(i32);
pub struct IHTMLDOMRange(i32);
pub struct IHTMLDOMTextNode(i32);
pub struct IHTMLDOMTextNode2(i32);
pub struct IHTMLDOMTextNode3(i32);
pub struct IHTMLDTElement(i32);
pub struct IHTMLDataTransfer(i32);
pub struct IHTMLDatabinding(i32);
pub struct IHTMLDialog(i32);
pub struct IHTMLDialog2(i32);
pub struct IHTMLDialog3(i32);
pub struct IHTMLDivElement(i32);
pub struct IHTMLDivPosition(i32);
pub struct IHTMLDocument(i32);
pub struct IHTMLDocument2(i32);
pub struct IHTMLDocument3(i32);
pub struct IHTMLDocument4(i32);
pub struct IHTMLDocument5(i32);
pub struct IHTMLDocument6(i32);
pub struct IHTMLDocument7(i32);
pub struct IHTMLDocument8(i32);
pub struct IHTMLDocumentCompatibleInfo(i32);
pub struct IHTMLDocumentCompatibleInfoCollection(i32);
pub struct IHTMLEditDesigner(i32);
pub struct IHTMLEditHost(i32);
pub struct IHTMLEditHost2(i32);
pub struct IHTMLEditServices(i32);
pub struct IHTMLEditServices2(i32);
pub struct IHTMLElement(i32);
pub struct IHTMLElement2(i32);
pub struct IHTMLElement3(i32);
pub struct IHTMLElement4(i32);
pub struct IHTMLElement5(i32);
pub struct IHTMLElement6(i32);
pub struct IHTMLElement7(i32);
pub struct IHTMLElementAppliedStyles(i32);
pub struct IHTMLElementCollection(i32);
pub struct IHTMLElementCollection2(i32);
pub struct IHTMLElementCollection3(i32);
pub struct IHTMLElementCollection4(i32);
pub struct IHTMLElementDefaults(i32);
pub struct IHTMLElementRender(i32);
pub struct IHTMLEmbedElement(i32);
pub struct IHTMLEmbedElement2(i32);
pub struct IHTMLEventObj(i32);
pub struct IHTMLEventObj2(i32);
pub struct IHTMLEventObj3(i32);
pub struct IHTMLEventObj4(i32);
pub struct IHTMLEventObj5(i32);
pub struct IHTMLEventObj6(i32);
pub struct IHTMLFieldSetElement(i32);
pub struct IHTMLFieldSetElement2(i32);
pub struct IHTMLFiltersCollection(i32);
pub struct IHTMLFontElement(i32);
pub struct IHTMLFontNamesCollection(i32);
pub struct IHTMLFontSizesCollection(i32);
pub struct IHTMLFormElement(i32);
pub struct IHTMLFormElement2(i32);
pub struct IHTMLFormElement3(i32);
pub struct IHTMLFormElement4(i32);
pub struct IHTMLFrameBase(i32);
pub struct IHTMLFrameBase2(i32);
pub struct IHTMLFrameBase3(i32);
pub struct IHTMLFrameElement(i32);
pub struct IHTMLFrameElement2(i32);
pub struct IHTMLFrameElement3(i32);
pub struct IHTMLFrameSetElement(i32);
pub struct IHTMLFrameSetElement2(i32);
pub struct IHTMLFrameSetElement3(i32);
pub struct IHTMLFramesCollection2(i32);
pub struct IHTMLGenericElement(i32);
pub struct IHTMLHRElement(i32);
pub struct IHTMLHeadElement(i32);
pub struct IHTMLHeadElement2(i32);
pub struct IHTMLHeaderElement(i32);
pub struct IHTMLHtmlElement(i32);
pub struct IHTMLIFrameElement(i32);
pub struct IHTMLIFrameElement2(i32);
pub struct IHTMLIFrameElement3(i32);
pub struct IHTMLIPrintCollection(i32);
pub struct IHTMLImageElementFactory(i32);
pub struct IHTMLImgElement(i32);
pub struct IHTMLImgElement2(i32);
pub struct IHTMLImgElement3(i32);
pub struct IHTMLImgElement4(i32);
pub struct IHTMLInputButtonElement(i32);
pub struct IHTMLInputElement(i32);
pub struct IHTMLInputElement2(i32);
pub struct IHTMLInputElement3(i32);
pub struct IHTMLInputFileElement(i32);
pub struct IHTMLInputHiddenElement(i32);
pub struct IHTMLInputImage(i32);
pub struct IHTMLInputRangeElement(i32);
pub struct IHTMLInputTextElement(i32);
pub struct IHTMLInputTextElement2(i32);
pub struct IHTMLIsIndexElement(i32);
pub struct IHTMLIsIndexElement2(i32);
pub struct IHTMLLIElement(i32);
pub struct IHTMLLabelElement(i32);
pub struct IHTMLLabelElement2(i32);
pub struct IHTMLLegendElement(i32);
pub struct IHTMLLegendElement2(i32);
pub struct IHTMLLinkElement(i32);
pub struct IHTMLLinkElement2(i32);
pub struct IHTMLLinkElement3(i32);
pub struct IHTMLLinkElement4(i32);
pub struct IHTMLLinkElement5(i32);
pub struct IHTMLListElement(i32);
pub struct IHTMLListElement2(i32);
pub struct IHTMLLocation(i32);
pub struct IHTMLMSCSSKeyframeRule(i32);
pub struct IHTMLMSCSSKeyframesRule(i32);
pub struct IHTMLMSImgElement(i32);
pub struct IHTMLMSMediaElement(i32);
pub struct IHTMLMapElement(i32);
pub struct IHTMLMarqueeElement(i32);
pub struct IHTMLMediaElement(i32);
pub struct IHTMLMediaElement2(i32);
pub struct IHTMLMediaError(i32);
pub struct IHTMLMetaElement(i32);
pub struct IHTMLMetaElement2(i32);
pub struct IHTMLMetaElement3(i32);
pub struct IHTMLMimeTypesCollection(i32);
pub struct IHTMLModelessInit(i32);
pub struct IHTMLNamespace(i32);
pub struct IHTMLNamespaceCollection(i32);
pub struct IHTMLNextIdElement(i32);
pub struct IHTMLNoShowElement(i32);
pub struct IHTMLOListElement(i32);
pub struct IHTMLOMWindowServices(i32);
pub struct IHTMLObjectElement(i32);
pub struct IHTMLObjectElement2(i32);
pub struct IHTMLObjectElement3(i32);
pub struct IHTMLObjectElement4(i32);
pub struct IHTMLObjectElement5(i32);
pub struct IHTMLOpsProfile(i32);
pub struct IHTMLOptionButtonElement(i32);
pub struct IHTMLOptionElement(i32);
pub struct IHTMLOptionElement3(i32);
pub struct IHTMLOptionElement4(i32);
pub struct IHTMLOptionElementFactory(i32);
pub struct IHTMLOptionsHolder(i32);
pub struct IHTMLPaintSite(i32);
pub struct IHTMLPainter(i32);
pub struct IHTMLPainterEventInfo(i32);
pub struct IHTMLPainterOverlay(i32);
pub struct IHTMLParaElement(i32);
pub struct IHTMLParamElement(i32);
pub struct IHTMLParamElement2(i32);
pub struct IHTMLPerformance(i32);
pub struct IHTMLPerformanceNavigation(i32);
pub struct IHTMLPerformanceTiming(i32);
pub struct IHTMLPersistData(i32);
pub struct IHTMLPersistDataOM(i32);
pub struct IHTMLPhraseElement(i32);
pub struct IHTMLPhraseElement2(i32);
pub struct IHTMLPhraseElement3(i32);
pub struct IHTMLPluginsCollection(i32);
pub struct IHTMLPopup(i32);
pub struct IHTMLProgressElement(i32);
pub struct IHTMLRect(i32);
pub struct IHTMLRect2(i32);
pub struct IHTMLRectCollection(i32);
pub struct IHTMLRenderStyle(i32);
pub struct IHTMLRuleStyle(i32);
pub struct IHTMLRuleStyle2(i32);
pub struct IHTMLRuleStyle3(i32);
pub struct IHTMLRuleStyle4(i32);
pub struct IHTMLRuleStyle5(i32);
pub struct IHTMLRuleStyle6(i32);
pub struct IHTMLScreen(i32);
pub struct IHTMLScreen2(i32);
pub struct IHTMLScreen3(i32);
pub struct IHTMLScreen4(i32);
pub struct IHTMLScriptElement(i32);
pub struct IHTMLScriptElement2(i32);
pub struct IHTMLScriptElement3(i32);
pub struct IHTMLScriptElement4(i32);
pub struct IHTMLSelectElement(i32);
pub struct IHTMLSelectElement2(i32);
pub struct IHTMLSelectElement4(i32);
pub struct IHTMLSelectElement5(i32);
pub struct IHTMLSelectElement6(i32);
pub struct IHTMLSelectElementEx(i32);
pub struct IHTMLSelection(i32);
pub struct IHTMLSelectionObject(i32);
pub struct IHTMLSelectionObject2(i32);
pub struct IHTMLSourceElement(i32);
pub struct IHTMLSpanElement(i32);
pub struct IHTMLSpanFlow(i32);
pub struct IHTMLStorage(i32);
pub struct IHTMLStorage2(i32);
pub struct IHTMLStyle(i32);
pub struct IHTMLStyle2(i32);
pub struct IHTMLStyle3(i32);
pub struct IHTMLStyle4(i32);
pub struct IHTMLStyle5(i32);
pub struct IHTMLStyle6(i32);
pub struct IHTMLStyleElement(i32);
pub struct IHTMLStyleElement2(i32);
pub struct IHTMLStyleEnabled(i32);
pub struct IHTMLStyleFontFace(i32);
pub struct IHTMLStyleFontFace2(i32);
pub struct IHTMLStyleMedia(i32);
pub struct IHTMLStyleSheet(i32);
pub struct IHTMLStyleSheet2(i32);
pub struct IHTMLStyleSheet3(i32);
pub struct IHTMLStyleSheet4(i32);
pub struct IHTMLStyleSheetPage(i32);
pub struct IHTMLStyleSheetPage2(i32);
pub struct IHTMLStyleSheetPagesCollection(i32);
pub struct IHTMLStyleSheetRule(i32);
pub struct IHTMLStyleSheetRule2(i32);
pub struct IHTMLStyleSheetRuleApplied(i32);
pub struct IHTMLStyleSheetRulesAppliedCollection(i32);
pub struct IHTMLStyleSheetRulesCollection(i32);
pub struct IHTMLStyleSheetRulesCollection2(i32);
pub struct IHTMLStyleSheetsCollection(i32);
pub struct IHTMLStyleSheetsCollection2(i32);
pub struct IHTMLSubmitData(i32);
pub struct IHTMLTable(i32);
pub struct IHTMLTable2(i32);
pub struct IHTMLTable3(i32);
pub struct IHTMLTable4(i32);
pub struct IHTMLTableCaption(i32);
pub struct IHTMLTableCell(i32);
pub struct IHTMLTableCell2(i32);
pub struct IHTMLTableCell3(i32);
pub struct IHTMLTableCol(i32);
pub struct IHTMLTableCol2(i32);
pub struct IHTMLTableCol3(i32);
pub struct IHTMLTableRow(i32);
pub struct IHTMLTableRow2(i32);
pub struct IHTMLTableRow3(i32);
pub struct IHTMLTableRow4(i32);
pub struct IHTMLTableRowMetrics(i32);
pub struct IHTMLTableSection(i32);
pub struct IHTMLTableSection2(i32);
pub struct IHTMLTableSection3(i32);
pub struct IHTMLTableSection4(i32);
pub struct IHTMLTextAreaElement(i32);
pub struct IHTMLTextAreaElement2(i32);
pub struct IHTMLTextContainer(i32);
pub struct IHTMLTextElement(i32);
pub struct IHTMLTextRangeMetrics(i32);
pub struct IHTMLTextRangeMetrics2(i32);
pub struct IHTMLTimeRanges(i32);
pub struct IHTMLTimeRanges2(i32);
pub struct IHTMLTitleElement(i32);
pub struct IHTMLTxtRange(i32);
pub struct IHTMLTxtRangeCollection(i32);
pub struct IHTMLUListElement(i32);
pub struct IHTMLUniqueName(i32);
pub struct IHTMLUnknownElement(i32);
pub struct IHTMLUrnCollection(i32);
pub struct IHTMLUserDataOM(i32);
pub struct IHTMLVideoElement(i32);
pub struct IHTMLWindow2(i32);
pub struct IHTMLWindow3(i32);
pub struct IHTMLWindow4(i32);
pub struct IHTMLWindow5(i32);
pub struct IHTMLWindow6(i32);
pub struct IHTMLWindow7(i32);
pub struct IHTMLWindow8(i32);
pub struct IHTMLXDomainRequest(i32);
pub struct IHTMLXDomainRequestFactory(i32);
pub struct IHTMLXMLHttpRequest(i32);
pub struct IHTMLXMLHttpRequest2(i32);
pub struct IHTMLXMLHttpRequestFactory(i32);
pub struct IHeaderFooter(i32);
pub struct IHeaderFooter2(i32);
pub struct IHighlightRenderingServices(i32);
pub struct IHighlightSegment(i32);
pub struct IHomePage(i32);
pub struct IHomePageSetting(i32);
pub struct IHostBehaviorInit(i32);
pub struct IHostDialogHelper(i32);
pub struct IHtmlDlgSafeHelper(i32);
pub struct IICCSVGColor(i32);
pub struct IIE70DispatchEx(i32);
pub struct IIE80DispatchEx(i32);
pub struct IIEWebDriverManager(i32);
pub struct IIEWebDriverSite(i32);
pub struct IIMEServices(i32);
pub struct IImageDecodeEventSink(i32);
pub struct IImageDecodeEventSink2(i32);
pub struct IImageDecodeFilter(i32);
pub struct IIntelliForms(i32);
pub struct IInternetExplorerManager(i32);
pub struct IInternetExplorerManager2(i32);
pub struct ILayoutRect(i32);
pub struct ILineInfo(i32);
#[doc = "*Required features: `Win32_Web_MsHtml`*"]
...
pub struct IMapMIMEToCLSID(i32);
pub struct IMarkupContainer(i32);
pub struct IMarkupContainer2(i32);
pub struct IMarkupPointer(i32);
pub struct IMarkupPointer2(i32);
pub struct IMarkupServices(i32);
pub struct IMarkupServices2(i32);
pub struct IMarkupTextFrags(i32);
pub struct IMediaActivityNotifySite(i32);
pub struct INTERNETEXPLORERCONFIGURATION(i32);
pub struct INavigatorDoNotTrack(i32);
pub struct INavigatorGeolocation(i32);
pub struct IOmHistory(i32);
pub struct IOmNavigator(i32);
pub struct IOpenService(i32);
pub struct IOpenServiceActivity(i32);
pub struct IOpenServiceActivityCategory(i32);
pub struct IOpenServiceActivityInput(i32);
pub struct IOpenServiceActivityManager(i32);
pub struct IOpenServiceActivityOutputContext(i32);
pub struct IOpenServiceManager(i32);
pub struct IPeerFactory(i32);
pub struct IPersistHistory(i32);
pub struct IPrintManagerTemplatePrinter(i32);
pub struct IPrintManagerTemplatePrinter2(i32);
pub struct IPrintTaskRequestFactory(i32);
pub struct IPrintTaskRequestHandler(i32);
pub struct IRangeException(i32);
pub struct IRulesApplied(i32);
pub struct IRulesAppliedCollection(i32);
pub struct ISVGAElement(i32);
pub struct ISVGAngle(i32);
pub struct ISVGAnimatedAngle(i32);
pub struct ISVGAnimatedBoolean(i32);
pub struct ISVGAnimatedEnumeration(i32);
pub struct ISVGAnimatedInteger(i32);
pub struct ISVGAnimatedLength(i32);
pub struct ISVGAnimatedLengthList(i32);
pub struct ISVGAnimatedNumber(i32);
pub struct ISVGAnimatedNumberList(i32);
pub struct ISVGAnimatedPathData(i32);
pub struct ISVGAnimatedPoints(i32);
pub struct ISVGAnimatedPreserveAspectRatio(i32);
pub struct ISVGAnimatedRect(i32);
pub struct ISVGAnimatedString(i32);
pub struct ISVGAnimatedTransformList(i32);
pub struct ISVGCircleElement(i32);
pub struct ISVGClipPathElement(i32);
pub struct ISVGDefsElement(i32);
pub struct ISVGDescElement(i32);
pub struct ISVGDocument(i32);
pub struct ISVGElement(i32);
pub struct ISVGElementInstance(i32);
pub struct ISVGElementInstanceList(i32);
pub struct ISVGEllipseElement(i32);
pub struct ISVGException(i32);
pub struct ISVGExternalResourcesRequired(i32);
pub struct ISVGFitToViewBox(i32);
pub struct ISVGGElement(i32);
pub struct ISVGGradientElement(i32);
pub struct ISVGImageElement(i32);
pub struct ISVGLangSpace(i32);
pub struct ISVGLength(i32);
pub struct ISVGLengthList(i32);
pub struct ISVGLineElement(i32);
pub struct ISVGLinearGradientElement(i32);
pub struct ISVGLocatable(i32);
pub struct ISVGMarkerElement(i32);
pub struct ISVGMaskElement(i32);
pub struct ISVGMatrix(i32);
pub struct ISVGMetadataElement(i32);
pub struct ISVGNumber(i32);
pub struct ISVGNumberList(i32);
pub struct ISVGPaint(i32);
pub struct ISVGPathElement(i32);
pub struct ISVGPathSeg(i32);
pub struct ISVGPathSegArcAbs(i32);
pub struct ISVGPathSegArcRel(i32);
pub struct ISVGPathSegClosePath(i32);
pub struct ISVGPathSegCurvetoCubicAbs(i32);
pub struct ISVGPathSegCurvetoCubicRel(i32);
pub struct ISVGPathSegCurvetoCubicSmoothAbs(i32);
pub struct ISVGPathSegCurvetoCubicSmoothRel(i32);
pub struct ISVGPathSegCurvetoQuadraticAbs(i32);
pub struct ISVGPathSegCurvetoQuadraticRel(i32);
pub struct ISVGPathSegCurvetoQuadraticSmoothAbs(i32);
pub struct ISVGPathSegCurvetoQuadraticSmoothRel(i32);
pub struct ISVGPathSegLinetoAbs(i32);
pub struct ISVGPathSegLinetoHorizontalAbs(i32);
pub struct ISVGPathSegLinetoHorizontalRel(i32);
pub struct ISVGPathSegLinetoRel(i32);
pub struct ISVGPathSegLinetoVerticalAbs(i32);
pub struct ISVGPathSegLinetoVerticalRel(i32);
pub struct ISVGPathSegList(i32);
pub struct ISVGPathSegMovetoAbs(i32);
pub struct ISVGPathSegMovetoRel(i32);
pub struct ISVGPatternElement(i32);
pub struct ISVGPoint(i32);
pub struct ISVGPointList(i32);
pub struct ISVGPolygonElement(i32);
pub struct ISVGPolylineElement(i32);
pub struct ISVGPreserveAspectRatio(i32);
pub struct ISVGRadialGradientElement(i32);
pub struct ISVGRect(i32);
pub struct ISVGRectElement(i32);
pub struct ISVGSVGElement(i32);
pub struct ISVGScriptElement(i32);
pub struct ISVGStopElement(i32);
pub struct ISVGStringList(i32);
pub struct ISVGStylable(i32);
pub struct ISVGStyleElement(i32);
pub struct ISVGSwitchElement(i32);
pub struct ISVGSymbolElement(i32);
pub struct ISVGTSpanElement(i32);
pub struct ISVGTests(i32);
pub struct ISVGTextContentElement(i32);
pub struct ISVGTextElement(i32);
pub struct ISVGTextPathElement(i32);
pub struct ISVGTextPositioningElement(i32);
pub struct ISVGTitleElement(i32);
pub struct ISVGTransform(i32);
pub struct ISVGTransformList(i32);
pub struct ISVGTransformable(i32);
pub struct ISVGURIReference(i32);
pub struct ISVGUseElement(i32);
pub struct ISVGViewElement(i32);
pub struct ISVGViewSpec(i32);
pub struct ISVGZoomAndPan(i32);
pub struct ISVGZoomEvent(i32);
pub struct IScriptEventHandler(i32);
pub struct IScriptEventHandlerSourceInfo(i32);
pub struct IScrollableContextMenu(i32);
pub struct IScrollableContextMenu2(i32);
pub struct ISecureUrlHost(i32);
pub struct ISegment(i32);
pub struct ISegmentList(i32);
pub struct ISegmentListIterator(i32);
pub struct ISelectionServices(i32);
pub struct ISelectionServicesListener(i32);
pub struct ISequenceNumber(i32);
pub struct ISniffStream(i32);
pub struct ISurfacePresenter(i32);
pub struct ISurfacePresenterFlip(i32);
pub struct ISurfacePresenterFlip2(i32);
pub struct ISurfacePresenterFlipBuffer(i32);
pub struct ITargetContainer(i32);
pub struct ITargetEmbedding(i32);
pub struct ITargetFrame(i32);
pub struct ITargetFrame2(i32);
pub struct ITargetFramePriv(i32);
pub struct ITargetFramePriv2(i32);
pub struct ITargetNotify(i32);
pub struct ITargetNotify2(i32);
pub struct ITemplatePrinter(i32);
pub struct ITemplatePrinter2(i32);
pub struct ITemplatePrinter3(i32);
pub struct ITimer(i32);
pub struct ITimerEx(i32);
pub struct ITimerService(i32);
pub struct ITimerSink(i32);
pub struct ITrackingProtection(i32);
pub struct ITridentTouchInput(i32);
pub struct ITridentTouchInputSite(i32);
pub struct IUrlHistoryNotify(i32);
pub struct IUrlHistoryStg(i32);
pub struct IUrlHistoryStg2(i32);
pub struct IViewObjectPresentFlip(i32);
pub struct IViewObjectPresentFlip2(i32);
pub struct IViewObjectPresentFlipSite(i32);
pub struct IViewObjectPresentFlipSite2(i32);
pub struct IViewObjectPresentNotify(i32);
pub struct IViewObjectPresentNotifySite(i32);
pub struct IViewObjectPresentSite(i32);
pub struct IViewObjectPrint(i32);
pub struct IWBScriptControl(i32);
pub struct IWPCBlockedUrls(i32);
pub struct IWebBridge(i32);
pub struct IWebBrowserEventsService(i32);
pub struct IWebBrowserEventsUrlService(i32);
pub struct IWebGeocoordinates(i32);
pub struct IWebGeolocation(i32);
pub struct IWebGeoposition(i32);
pub struct IWebGeopositionError(i32);
pub struct IXMLGenericParse(i32);
pub struct IXMLHttpRequestEventTarget(i32);
pub struct IntelliForms(i32);
pub struct InternetExplorerManager(i32);
pub struct Iwfolders(i32);
