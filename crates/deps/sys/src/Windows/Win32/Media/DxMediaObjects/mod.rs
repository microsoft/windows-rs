...
pub struct IDMOQualityControl(i32);
pub struct IDMOVideoOutputOptimizations(i32);
pub struct IEnumDMO(i32);
pub struct IMediaBuffer(i32);
pub struct IMediaObject(i32);
pub struct IMediaObjectInPlace(i32);
