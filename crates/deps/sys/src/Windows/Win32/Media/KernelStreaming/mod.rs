...
pub struct IKsAggregateControl(i32);
pub struct IKsAllocator(i32);
pub struct IKsAllocatorEx(i32);
pub struct IKsControl(i32);
pub struct IKsFormatSupport(i32);
pub struct IKsJackContainerId(i32);
pub struct IKsJackDescription(i32);
pub struct IKsJackDescription2(i32);
pub struct IKsJackSinkInformation(i32);
pub struct IKsPin(i32);
pub struct IKsPropertySet(i32);
pub struct IKsTopology(i32);
