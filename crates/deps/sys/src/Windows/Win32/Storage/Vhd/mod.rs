...
pub const APPLY_SNAPSHOT_VHDSET_FLAG_NONE: u32 = 0u32;
pub const APPLY_SNAPSHOT_VHDSET_FLAG_WRITEABLE: u32 = 1u32;
#[repr(C)]
...
pub const APPLY_SNAPSHOT_VHDSET_VERSION_UNSPECIFIED: i32 = 0i32;
pub const APPLY_SNAPSHOT_VHDSET_VERSION_1: i32 = 1i32;
pub const ATTACH_VIRTUAL_DISK_FLAG_NONE: u32 = 0u32;
pub const ATTACH_VIRTUAL_DISK_FLAG_READ_ONLY: u32 = 1u32;
pub const ATTACH_VIRTUAL_DISK_FLAG_NO_DRIVE_LETTER: u32 = 2u32;
pub const ATTACH_VIRTUAL_DISK_FLAG_PERMANENT_LIFETIME: u32 = 4u32;
pub const ATTACH_VIRTUAL_DISK_FLAG_NO_LOCAL_HOST: u32 = 8u32;
pub const ATTACH_VIRTUAL_DISK_FLAG_NO_SECURITY_DESCRIPTOR: u32 = 16u32;
pub const ATTACH_VIRTUAL_DISK_FLAG_BYPASS_DEFAULT_ENCRYPTION_POLICY: u32 = 32u32;
pub const ATTACH_VIRTUAL_DISK_FLAG_NON_PNP: u32 = 64u32;
pub const ATTACH_VIRTUAL_DISK_FLAG_RESTRICTED_RANGE: u32 = 128u32;
pub const ATTACH_VIRTUAL_DISK_FLAG_SINGLE_PARTITION: u32 = 256u32;
pub const ATTACH_VIRTUAL_DISK_FLAG_REGISTER_VOLUME: u32 = 512u32;
#[repr(C)]
...
pub const ATTACH_VIRTUAL_DISK_VERSION_UNSPECIFIED: i32 = 0i32;
pub const ATTACH_VIRTUAL_DISK_VERSION_1: i32 = 1i32;
pub const ATTACH_VIRTUAL_DISK_VERSION_2: i32 = 2i32;
pub const COMPACT_VIRTUAL_DISK_FLAG_NONE: u32 = 0u32;
pub const COMPACT_VIRTUAL_DISK_FLAG_NO_ZERO_SCAN: u32 = 1u32;
pub const COMPACT_VIRTUAL_DISK_FLAG_NO_BLOCK_MOVES: u32 = 2u32;
#[repr(C)]
...
pub const COMPACT_VIRTUAL_DISK_VERSION_UNSPECIFIED: i32 = 0i32;
pub const COMPACT_VIRTUAL_DISK_VERSION_1: i32 = 1i32;
pub const CREATE_VIRTUAL_DISK_FLAG_NONE: u32 = 0u32;
pub const CREATE_VIRTUAL_DISK_FLAG_FULL_PHYSICAL_ALLOCATION: u32 = 1u32;
pub const CREATE_VIRTUAL_DISK_FLAG_PREVENT_WRITES_TO_SOURCE_DISK: u32 = 2u32;
pub const CREATE_VIRTUAL_DISK_FLAG_DO_NOT_COPY_METADATA_FROM_PARENT: u32 = 4u32;
pub const CREATE_VIRTUAL_DISK_FLAG_CREATE_BACKING_STORAGE: u32 = 8u32;
pub const CREATE_VIRTUAL_DISK_FLAG_USE_CHANGE_TRACKING_SOURCE_LIMIT: u32 = 16u32;
pub const CREATE_VIRTUAL_DISK_FLAG_PRESERVE_PARENT_CHANGE_TRACKING_STATE: u32 = 32u32;
pub const CREATE_VIRTUAL_DISK_FLAG_VHD_SET_USE_ORIGINAL_BACKING_STORAGE: u32 = 64u32;
pub const CREATE_VIRTUAL_DISK_FLAG_SPARSE_FILE: u32 = 128u32;
pub const CREATE_VIRTUAL_DISK_FLAG_PMEM_COMPATIBLE: u32 = 256u32;
pub const CREATE_VIRTUAL_DISK_FLAG_SUPPORT_COMPRESSED_VOLUMES: u32 = 512u32;
pub const CREATE_VIRTUAL_DISK_FLAG_SUPPORT_SPARSE_FILES_ANY_FS: u32 = 1024u32;
#[repr(C)]
#[cfg(feature = "Win32_Foundation")]
...
pub const CREATE_VIRTUAL_DISK_VERSION_UNSPECIFIED: i32 = 0i32;
pub const CREATE_VIRTUAL_DISK_VERSION_1: i32 = 1i32;
pub const CREATE_VIRTUAL_DISK_VERSION_2: i32 = 2i32;
pub const CREATE_VIRTUAL_DISK_VERSION_3: i32 = 3i32;
pub const CREATE_VIRTUAL_DISK_VERSION_4: i32 = 4i32;
pub const DELETE_SNAPSHOT_VHDSET_FLAG_NONE: u32 = 0u32;
pub const DELETE_SNAPSHOT_VHDSET_FLAG_PERSIST_RCT: u32 = 1u32;
#[repr(C)]
...
pub const DELETE_SNAPSHOT_VHDSET_VERSION_UNSPECIFIED: i32 = 0i32;
pub const DELETE_SNAPSHOT_VHDSET_VERSION_1: i32 = 1i32;
pub const DEPENDENT_DISK_FLAG_NONE: u32 = 0u32;
pub const DEPENDENT_DISK_FLAG_MULT_BACKING_FILES: u32 = 1u32;
pub const DEPENDENT_DISK_FLAG_FULLY_ALLOCATED: u32 = 2u32;
pub const DEPENDENT_DISK_FLAG_READ_ONLY: u32 = 4u32;
pub const DEPENDENT_DISK_FLAG_REMOTE: u32 = 8u32;
pub const DEPENDENT_DISK_FLAG_SYSTEM_VOLUME: u32 = 16u32;
pub const DEPENDENT_DISK_FLAG_SYSTEM_VOLUME_PARENT: u32 = 32u32;
pub const DEPENDENT_DISK_FLAG_REMOVABLE: u32 = 64u32;
pub const DEPENDENT_DISK_FLAG_NO_DRIVE_LETTER: u32 = 128u32;
pub const DEPENDENT_DISK_FLAG_PARENT: u32 = 256u32;
pub const DEPENDENT_DISK_FLAG_NO_HOST_DISK: u32 = 512u32;
pub const DEPENDENT_DISK_FLAG_PERMANENT_LIFETIME: u32 = 1024u32;
pub const DEPENDENT_DISK_FLAG_SUPPORT_COMPRESSED_VOLUMES: u32 = 2048u32;
pub const DEPENDENT_DISK_FLAG_ALWAYS_ALLOW_SPARSE: u32 = 4096u32;
pub const DEPENDENT_DISK_FLAG_SUPPORT_ENCRYPTED_FILES: u32 = 8192u32;
pub const DETACH_VIRTUAL_DISK_FLAG_NONE: u32 = 0u32;
pub const EXPAND_VIRTUAL_DISK_FLAG_NONE: u32 = 0u32;
pub const EXPAND_VIRTUAL_DISK_FLAG_NOTIFY_CHANGE: u32 = 1u32;
#[repr(C)]
...
pub const EXPAND_VIRTUAL_DISK_VERSION_UNSPECIFIED: i32 = 0i32;
pub const EXPAND_VIRTUAL_DISK_VERSION_1: i32 = 1i32;
pub const FORK_VIRTUAL_DISK_FLAG_NONE: u32 = 0u32;
pub const FORK_VIRTUAL_DISK_FLAG_EXISTING_FILE: u32 = 1u32;
#[repr(C)]
#[cfg(feature = "Win32_Foundation")]
...
pub const FORK_VIRTUAL_DISK_VERSION_UNSPECIFIED: i32 = 0i32;
pub const FORK_VIRTUAL_DISK_VERSION_1: i32 = 1i32;
pub const GET_STORAGE_DEPENDENCY_FLAG_NONE: u32 = 0u32;
pub const GET_STORAGE_DEPENDENCY_FLAG_HOST_VOLUMES: u32 = 1u32;
pub const GET_STORAGE_DEPENDENCY_FLAG_DISK_HANDLE: u32 = 2u32;
#[repr(C)]
#[cfg(feature = "Win32_Foundation")]
...
pub const GET_VIRTUAL_DISK_INFO_UNSPECIFIED: i32 = 0i32;
pub const GET_VIRTUAL_DISK_INFO_SIZE: i32 = 1i32;
pub const GET_VIRTUAL_DISK_INFO_IDENTIFIER: i32 = 2i32;
pub const GET_VIRTUAL_DISK_INFO_PARENT_LOCATION: i32 = 3i32;
pub const GET_VIRTUAL_DISK_INFO_PARENT_IDENTIFIER: i32 = 4i32;
pub const GET_VIRTUAL_DISK_INFO_PARENT_TIMESTAMP: i32 = 5i32;
pub const GET_VIRTUAL_DISK_INFO_VIRTUAL_STORAGE_TYPE: i32 = 6i32;
pub const GET_VIRTUAL_DISK_INFO_PROVIDER_SUBTYPE: i32 = 7i32;
pub const GET_VIRTUAL_DISK_INFO_IS_4K_ALIGNED: i32 = 8i32;
pub const GET_VIRTUAL_DISK_INFO_PHYSICAL_DISK: i32 = 9i32;
pub const GET_VIRTUAL_DISK_INFO_VHD_PHYSICAL_SECTOR_SIZE: i32 = 10i32;
pub const GET_VIRTUAL_DISK_INFO_SMALLEST_SAFE_VIRTUAL_SIZE: i32 = 11i32;
pub const GET_VIRTUAL_DISK_INFO_FRAGMENTATION: i32 = 12i32;
pub const GET_VIRTUAL_DISK_INFO_IS_LOADED: i32 = 13i32;
pub const GET_VIRTUAL_DISK_INFO_VIRTUAL_DISK_ID: i32 = 14i32;
pub const GET_VIRTUAL_DISK_INFO_CHANGE_TRACKING_STATE: i32 = 15i32;
pub const MERGE_VIRTUAL_DISK_DEFAULT_MERGE_DEPTH: u32 = 1u32;
pub const MERGE_VIRTUAL_DISK_FLAG_NONE: u32 = 0u32;
#[repr(C)]
...
pub const MERGE_VIRTUAL_DISK_VERSION_UNSPECIFIED: i32 = 0i32;
pub const MERGE_VIRTUAL_DISK_VERSION_1: i32 = 1i32;
pub const MERGE_VIRTUAL_DISK_VERSION_2: i32 = 2i32;
pub const MIRROR_VIRTUAL_DISK_FLAG_NONE: u32 = 0u32;
pub const MIRROR_VIRTUAL_DISK_FLAG_EXISTING_FILE: u32 = 1u32;
pub const MIRROR_VIRTUAL_DISK_FLAG_SKIP_MIRROR_ACTIVATION: u32 = 2u32;
pub const MIRROR_VIRTUAL_DISK_FLAG_ENABLE_SMB_COMPRESSION: u32 = 4u32;
pub const MIRROR_VIRTUAL_DISK_FLAG_IS_LIVE_MIGRATION: u32 = 8u32;
#[repr(C)]
#[cfg(feature = "Win32_Foundation")]
...
pub const MIRROR_VIRTUAL_DISK_VERSION_UNSPECIFIED: i32 = 0i32;
pub const MIRROR_VIRTUAL_DISK_VERSION_1: i32 = 1i32;
pub const MODIFY_VHDSET_FLAG_NONE: u32 = 0u32;
pub const MODIFY_VHDSET_FLAG_WRITEABLE_SNAPSHOT: u32 = 1u32;
#[repr(C)]
#[cfg(feature = "Win32_Foundation")]
...
pub const MODIFY_VHDSET_UNSPECIFIED: i32 = 0i32;
pub const MODIFY_VHDSET_SNAPSHOT_PATH: i32 = 1i32;
pub const MODIFY_VHDSET_REMOVE_SNAPSHOT: i32 = 2i32;
pub const MODIFY_VHDSET_DEFAULT_SNAPSHOT_PATH: i32 = 3i32;
pub const OPEN_VIRTUAL_DISK_FLAG_NONE: u32 = 0u32;
pub const OPEN_VIRTUAL_DISK_FLAG_NO_PARENTS: u32 = 1u32;
pub const OPEN_VIRTUAL_DISK_FLAG_BLANK_FILE: u32 = 2u32;
pub const OPEN_VIRTUAL_DISK_FLAG_BOOT_DRIVE: u32 = 4u32;
pub const OPEN_VIRTUAL_DISK_FLAG_CACHED_IO: u32 = 8u32;
pub const OPEN_VIRTUAL_DISK_FLAG_CUSTOM_DIFF_CHAIN: u32 = 16u32;
pub const OPEN_VIRTUAL_DISK_FLAG_PARENT_CACHED_IO: u32 = 32u32;
pub const OPEN_VIRTUAL_DISK_FLAG_VHDSET_FILE_ONLY: u32 = 64u32;
pub const OPEN_VIRTUAL_DISK_FLAG_IGNORE_RELATIVE_PARENT_LOCATOR: u32 = 128u32;
pub const OPEN_VIRTUAL_DISK_FLAG_NO_WRITE_HARDENING: u32 = 256u32;
pub const OPEN_VIRTUAL_DISK_FLAG_SUPPORT_COMPRESSED_VOLUMES: u32 = 512u32;
pub const OPEN_VIRTUAL_DISK_FLAG_SUPPORT_SPARSE_FILES_ANY_FS: u32 = 1024u32;
pub const OPEN_VIRTUAL_DISK_FLAG_SUPPORT_ENCRYPTED_FILES: u32 = 2048u32;
#[repr(C)]
#[cfg(feature = "Win32_Foundation")]
...
pub const OPEN_VIRTUAL_DISK_VERSION_UNSPECIFIED: i32 = 0i32;
pub const OPEN_VIRTUAL_DISK_VERSION_1: i32 = 1i32;
pub const OPEN_VIRTUAL_DISK_VERSION_2: i32 = 2i32;
pub const OPEN_VIRTUAL_DISK_VERSION_3: i32 = 3i32;
pub const QUERY_CHANGES_VIRTUAL_DISK_FLAG_NONE: u32 = 0u32;
#[repr(C)]
...
pub const RAW_SCSI_VIRTUAL_DISK_FLAG_NONE: u32 = 0u32;
#[repr(C)]
#[cfg(feature = "Win32_Foundation")]
...
pub const RAW_SCSI_VIRTUAL_DISK_VERSION_UNSPECIFIED: i32 = 0i32;
pub const RAW_SCSI_VIRTUAL_DISK_VERSION_1: i32 = 1i32;
pub const RESIZE_VIRTUAL_DISK_FLAG_NONE: u32 = 0u32;
pub const RESIZE_VIRTUAL_DISK_FLAG_ALLOW_UNSAFE_VIRTUAL_SIZE: u32 = 1u32;
pub const RESIZE_VIRTUAL_DISK_FLAG_RESIZE_TO_SMALLEST_SAFE_VIRTUAL_SIZE: u32 = 2u32;
#[repr(C)]
...
pub const RESIZE_VIRTUAL_DISK_VERSION_UNSPECIFIED: i32 = 0i32;
pub const RESIZE_VIRTUAL_DISK_VERSION_1: i32 = 1i32;
#[repr(C)]
#[cfg(feature = "Win32_Foundation")]
...
pub const SET_VIRTUAL_DISK_INFO_UNSPECIFIED: i32 = 0i32;
pub const SET_VIRTUAL_DISK_INFO_PARENT_PATH: i32 = 1i32;
pub const SET_VIRTUAL_DISK_INFO_IDENTIFIER: i32 = 2i32;
pub const SET_VIRTUAL_DISK_INFO_PARENT_PATH_WITH_DEPTH: i32 = 3i32;
pub const SET_VIRTUAL_DISK_INFO_PHYSICAL_SECTOR_SIZE: i32 = 4i32;
pub const SET_VIRTUAL_DISK_INFO_VIRTUAL_DISK_ID: i32 = 5i32;
pub const SET_VIRTUAL_DISK_INFO_CHANGE_TRACKING_STATE: i32 = 6i32;
pub const SET_VIRTUAL_DISK_INFO_PARENT_LOCATOR: i32 = 7i32;
#[repr(C)]
#[cfg(feature = "Win32_Foundation")]
...
pub const STORAGE_DEPENDENCY_INFO_VERSION_UNSPECIFIED: i32 = 0i32;
pub const STORAGE_DEPENDENCY_INFO_VERSION_1: i32 = 1i32;
pub const STORAGE_DEPENDENCY_INFO_VERSION_2: i32 = 2i32;
pub const TAKE_SNAPSHOT_VHDSET_FLAG_NONE: u32 = 0u32;
pub const TAKE_SNAPSHOT_VHDSET_FLAG_WRITEABLE: u32 = 1u32;
#[repr(C)]
...
pub const TAKE_SNAPSHOT_VHDSET_VERSION_UNSPECIFIED: i32 = 0i32;
pub const TAKE_SNAPSHOT_VHDSET_VERSION_1: i32 = 1i32;
pub const VIRTUAL_DISK_ACCESS_NONE: u32 = 0u32;
pub const VIRTUAL_DISK_ACCESS_ATTACH_RO: u32 = 65536u32;
pub const VIRTUAL_DISK_ACCESS_ATTACH_RW: u32 = 131072u32;
pub const VIRTUAL_DISK_ACCESS_DETACH: u32 = 262144u32;
pub const VIRTUAL_DISK_ACCESS_GET_INFO: u32 = 524288u32;
pub const VIRTUAL_DISK_ACCESS_CREATE: u32 = 1048576u32;
pub const VIRTUAL_DISK_ACCESS_METAOPS: u32 = 2097152u32;
pub const VIRTUAL_DISK_ACCESS_READ: u32 = 851968u32;
pub const VIRTUAL_DISK_ACCESS_ALL: u32 = 4128768u32;
pub const VIRTUAL_DISK_ACCESS_WRITABLE: u32 = 3276800u32;
