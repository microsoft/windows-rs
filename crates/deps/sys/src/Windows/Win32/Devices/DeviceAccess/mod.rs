...
extern "system" {
    ...
    pub fn CreateDeviceAccessInstance(deviceinterfacepath: super::super::Foundation::PWSTR, desiredaccess: u32, createasync: *mut ::core::option::Option<ICreateDeviceAccessAsync>) -> ::windows_sys::core::HRESULT;
}
