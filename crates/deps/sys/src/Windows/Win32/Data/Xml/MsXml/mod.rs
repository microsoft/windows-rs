...
pub struct IMXAttributes(i32);
pub struct IMXNamespaceManager(i32);
pub struct IMXNamespacePrefixes(i32);
pub struct IMXReaderControl(i32);
pub struct IMXSchemaDeclHandler(i32);
pub struct IMXWriter(i32);
pub struct IMXXMLFilter(i32);
pub struct ISAXAttributes(i32);
pub struct ISAXContentHandler(i32);
pub struct ISAXDTDHandler(i32);
pub struct ISAXDeclHandler(i32);
pub struct ISAXEntityResolver(i32);
pub struct ISAXErrorHandler(i32);
pub struct ISAXLexicalHandler(i32);
pub struct ISAXLocator(i32);
pub struct ISAXXMLFilter(i32);
pub struct ISAXXMLReader(i32);
pub struct ISchema(i32);
pub struct ISchemaAny(i32);
pub struct ISchemaAttribute(i32);
pub struct ISchemaAttributeGroup(i32);
pub struct ISchemaComplexType(i32);
pub struct ISchemaElement(i32);
pub struct ISchemaIdentityConstraint(i32);
pub struct ISchemaItem(i32);
pub struct ISchemaItemCollection(i32);
pub struct ISchemaModelGroup(i32);
pub struct ISchemaNotation(i32);
pub struct ISchemaParticle(i32);
pub struct ISchemaStringCollection(i32);
pub struct ISchemaType(i32);
pub struct IServerXMLHTTPRequest(i32);
pub struct IServerXMLHTTPRequest2(i32);
pub struct IVBMXNamespaceManager(i32);
pub struct IVBSAXAttributes(i32);
pub struct IVBSAXContentHandler(i32);
pub struct IVBSAXDTDHandler(i32);
pub struct IVBSAXDeclHandler(i32);
pub struct IVBSAXEntityResolver(i32);
pub struct IVBSAXErrorHandler(i32);
pub struct IVBSAXLexicalHandler(i32);
pub struct IVBSAXLocator(i32);
pub struct IVBSAXXMLFilter(i32);
pub struct IVBSAXXMLReader(i32);
pub struct IXMLAttribute(i32);
pub struct IXMLDOMAttribute(i32);
pub struct IXMLDOMCDATASection(i32);
pub struct IXMLDOMCharacterData(i32);
pub struct IXMLDOMComment(i32);
pub struct IXMLDOMDocument(i32);
pub struct IXMLDOMDocument2(i32);
pub struct IXMLDOMDocument3(i32);
pub struct IXMLDOMDocumentFragment(i32);
pub struct IXMLDOMDocumentType(i32);
pub struct IXMLDOMElement(i32);
pub struct IXMLDOMEntity(i32);
pub struct IXMLDOMEntityReference(i32);
pub struct IXMLDOMImplementation(i32);
pub struct IXMLDOMNamedNodeMap(i32);
pub struct IXMLDOMNode(i32);
pub struct IXMLDOMNodeList(i32);
pub struct IXMLDOMNotation(i32);
pub struct IXMLDOMParseError(i32);
pub struct IXMLDOMParseError2(i32);
pub struct IXMLDOMParseErrorCollection(i32);
pub struct IXMLDOMProcessingInstruction(i32);
pub struct IXMLDOMSchemaCollection(i32);
pub struct IXMLDOMSchemaCollection2(i32);
pub struct IXMLDOMSelection(i32);
pub struct IXMLDOMText(i32);
pub struct IXMLDSOControl(i32);
pub struct IXMLDocument(i32);
pub struct IXMLDocument2(i32);
pub struct IXMLElement(i32);
pub struct IXMLElement2(i32);
pub struct IXMLElementCollection(i32);
pub struct IXMLError(i32);
pub struct IXMLHTTPRequest(i32);
pub struct IXMLHTTPRequest2(i32);
pub struct IXMLHTTPRequest2Callback(i32);
pub struct IXMLHTTPRequest3(i32);
pub struct IXMLHTTPRequest3Callback(i32);
pub struct IXMLHttpRequest(i32);
pub struct IXSLProcessor(i32);
pub struct IXSLTemplate(i32);
pub struct IXTLRuntime(i32);
...
pub struct XMLDOMDocumentEvents(i32);
