...
pub const NODE_INVALID: i32 = 0i32;
pub const NODE_ELEMENT: i32 = 1i32;
pub const NODE_ATTRIBUTE: i32 = 2i32;
pub const NODE_TEXT: i32 = 3i32;
pub const NODE_CDATA_SECTION: i32 = 4i32;
pub const NODE_ENTITY_REFERENCE: i32 = 5i32;
pub const NODE_ENTITY: i32 = 6i32;
pub const NODE_PROCESSING_INSTRUCTION: i32 = 7i32;
pub const NODE_COMMENT: i32 = 8i32;
pub const NODE_DOCUMENT: i32 = 9i32;
pub const NODE_DOCUMENT_TYPE: i32 = 10i32;
pub const NODE_DOCUMENT_FRAGMENT: i32 = 11i32;
pub const NODE_NOTATION: i32 = 12i32;
...
pub const SCHEMACONTENTTYPE_EMPTY: i32 = 0i32;
pub const SCHEMACONTENTTYPE_TEXTONLY: i32 = 1i32;
pub const SCHEMACONTENTTYPE_ELEMENTONLY: i32 = 2i32;
pub const SCHEMACONTENTTYPE_MIXED: i32 = 3i32;
pub const SCHEMADERIVATIONMETHOD_EMPTY: i32 = 0i32;
pub const SCHEMADERIVATIONMETHOD_SUBSTITUTION: i32 = 1i32;
pub const SCHEMADERIVATIONMETHOD_EXTENSION: i32 = 2i32;
pub const SCHEMADERIVATIONMETHOD_RESTRICTION: i32 = 4i32;
pub const SCHEMADERIVATIONMETHOD_LIST: i32 = 8i32;
pub const SCHEMADERIVATIONMETHOD_UNION: i32 = 16i32;
pub const SCHEMADERIVATIONMETHOD_ALL: i32 = 255i32;
pub const SCHEMADERIVATIONMETHOD_NONE: i32 = 256i32;
pub const SCHEMAPROCESSCONTENTS_NONE: i32 = 0i32;
pub const SCHEMAPROCESSCONTENTS_SKIP: i32 = 1i32;
pub const SCHEMAPROCESSCONTENTS_LAX: i32 = 2i32;
pub const SCHEMAPROCESSCONTENTS_STRICT: i32 = 3i32;
pub const SCHEMATYPEVARIETY_NONE: i32 = -1i32;
pub const SCHEMATYPEVARIETY_ATOMIC: i32 = 0i32;
pub const SCHEMATYPEVARIETY_LIST: i32 = 1i32;
pub const SCHEMATYPEVARIETY_UNION: i32 = 2i32;
pub const SCHEMAUSE_OPTIONAL: i32 = 0i32;
pub const SCHEMAUSE_PROHIBITED: i32 = 1i32;
pub const SCHEMAUSE_REQUIRED: i32 = 2i32;
pub const SCHEMAWHITESPACE_NONE: i32 = -1i32;
pub const SCHEMAWHITESPACE_PRESERVE: i32 = 0i32;
pub const SCHEMAWHITESPACE_REPLACE: i32 = 1i32;
pub const SCHEMAWHITESPACE_COLLAPSE: i32 = 2i32;
pub const SXH_OPTION_URL: i32 = -1i32;
pub const SXH_OPTION_URL_CODEPAGE: i32 = 0i32;
pub const SXH_OPTION_ESCAPE_PERCENT_IN_URL: i32 = 1i32;
pub const SXH_OPTION_IGNORE_SERVER_SSL_CERT_ERROR_FLAGS: i32 = 2i32;
pub const SXH_OPTION_SELECT_CLIENT_SSL_CERT: i32 = 3i32;
pub const SOMITEM_SCHEMA: i32 = 4096i32;
pub const SOMITEM_ATTRIBUTE: i32 = 4097i32;
pub const SOMITEM_ATTRIBUTEGROUP: i32 = 4098i32;
pub const SOMITEM_NOTATION: i32 = 4099i32;
pub const SOMITEM_ANNOTATION: i32 = 4100i32;
pub const SOMITEM_IDENTITYCONSTRAINT: i32 = 4352i32;
pub const SOMITEM_KEY: i32 = 4353i32;
pub const SOMITEM_KEYREF: i32 = 4354i32;
pub const SOMITEM_UNIQUE: i32 = 4355i32;
pub const SOMITEM_ANYTYPE: i32 = 8192i32;
pub const SOMITEM_DATATYPE: i32 = 8448i32;
pub const SOMITEM_DATATYPE_ANYTYPE: i32 = 8449i32;
pub const SOMITEM_DATATYPE_ANYURI: i32 = 8450i32;
pub const SOMITEM_DATATYPE_BASE64BINARY: i32 = 8451i32;
pub const SOMITEM_DATATYPE_BOOLEAN: i32 = 8452i32;
pub const SOMITEM_DATATYPE_BYTE: i32 = 8453i32;
pub const SOMITEM_DATATYPE_DATE: i32 = 8454i32;
pub const SOMITEM_DATATYPE_DATETIME: i32 = 8455i32;
pub const SOMITEM_DATATYPE_DAY: i32 = 8456i32;
pub const SOMITEM_DATATYPE_DECIMAL: i32 = 8457i32;
pub const SOMITEM_DATATYPE_DOUBLE: i32 = 8458i32;
pub const SOMITEM_DATATYPE_DURATION: i32 = 8459i32;
pub const SOMITEM_DATATYPE_ENTITIES: i32 = 8460i32;
pub const SOMITEM_DATATYPE_ENTITY: i32 = 8461i32;
pub const SOMITEM_DATATYPE_FLOAT: i32 = 8462i32;
pub const SOMITEM_DATATYPE_HEXBINARY: i32 = 8463i32;
pub const SOMITEM_DATATYPE_ID: i32 = 8464i32;
pub const SOMITEM_DATATYPE_IDREF: i32 = 8465i32;
pub const SOMITEM_DATATYPE_IDREFS: i32 = 8466i32;
pub const SOMITEM_DATATYPE_INT: i32 = 8467i32;
pub const SOMITEM_DATATYPE_INTEGER: i32 = 8468i32;
pub const SOMITEM_DATATYPE_LANGUAGE: i32 = 8469i32;
pub const SOMITEM_DATATYPE_LONG: i32 = 8470i32;
pub const SOMITEM_DATATYPE_MONTH: i32 = 8471i32;
pub const SOMITEM_DATATYPE_MONTHDAY: i32 = 8472i32;
pub const SOMITEM_DATATYPE_NAME: i32 = 8473i32;
pub const SOMITEM_DATATYPE_NCNAME: i32 = 8474i32;
pub const SOMITEM_DATATYPE_NEGATIVEINTEGER: i32 = 8475i32;
pub const SOMITEM_DATATYPE_NMTOKEN: i32 = 8476i32;
pub const SOMITEM_DATATYPE_NMTOKENS: i32 = 8477i32;
pub const SOMITEM_DATATYPE_NONNEGATIVEINTEGER: i32 = 8478i32;
pub const SOMITEM_DATATYPE_NONPOSITIVEINTEGER: i32 = 8479i32;
pub const SOMITEM_DATATYPE_NORMALIZEDSTRING: i32 = 8480i32;
pub const SOMITEM_DATATYPE_NOTATION: i32 = 8481i32;
pub const SOMITEM_DATATYPE_POSITIVEINTEGER: i32 = 8482i32;
pub const SOMITEM_DATATYPE_QNAME: i32 = 8483i32;
pub const SOMITEM_DATATYPE_SHORT: i32 = 8484i32;
pub const SOMITEM_DATATYPE_STRING: i32 = 8485i32;
pub const SOMITEM_DATATYPE_TIME: i32 = 8486i32;
pub const SOMITEM_DATATYPE_TOKEN: i32 = 8487i32;
pub const SOMITEM_DATATYPE_UNSIGNEDBYTE: i32 = 8488i32;
pub const SOMITEM_DATATYPE_UNSIGNEDINT: i32 = 8489i32;
pub const SOMITEM_DATATYPE_UNSIGNEDLONG: i32 = 8490i32;
pub const SOMITEM_DATATYPE_UNSIGNEDSHORT: i32 = 8491i32;
pub const SOMITEM_DATATYPE_YEAR: i32 = 8492i32;
pub const SOMITEM_DATATYPE_YEARMONTH: i32 = 8493i32;
pub const SOMITEM_DATATYPE_ANYSIMPLETYPE: i32 = 8703i32;
pub const SOMITEM_SIMPLETYPE: i32 = 8704i32;
pub const SOMITEM_COMPLEXTYPE: i32 = 9216i32;
pub const SOMITEM_PARTICLE: i32 = 16384i32;
pub const SOMITEM_ANY: i32 = 16385i32;
pub const SOMITEM_ANYATTRIBUTE: i32 = 16386i32;
pub const SOMITEM_ELEMENT: i32 = 16387i32;
pub const SOMITEM_GROUP: i32 = 16640i32;
pub const SOMITEM_ALL: i32 = 16641i32;
pub const SOMITEM_CHOICE: i32 = 16642i32;
pub const SOMITEM_SEQUENCE: i32 = 16643i32;
pub const SOMITEM_EMPTYPARTICLE: i32 = 16644i32;
pub const SOMITEM_NULL: i32 = 2048i32;
pub const SOMITEM_NULL_TYPE: i32 = 10240i32;
pub const SOMITEM_NULL_ANY: i32 = 18433i32;
pub const SOMITEM_NULL_ANYATTRIBUTE: i32 = 18434i32;
pub const SOMITEM_NULL_ELEMENT: i32 = 18435i32;
pub const SXH_PROXY_SET_DEFAULT: i32 = 0i32;
pub const SXH_PROXY_SET_PRECONFIG: i32 = 0i32;
pub const SXH_PROXY_SET_DIRECT: i32 = 1i32;
pub const SXH_PROXY_SET_PROXY: i32 = 2i32;
pub const SXH_SERVER_CERT_IGNORE_UNKNOWN_CA: i32 = 256i32;
pub const SXH_SERVER_CERT_IGNORE_WRONG_USAGE: i32 = 512i32;
pub const SXH_SERVER_CERT_IGNORE_CERT_CN_INVALID: i32 = 4096i32;
pub const SXH_SERVER_CERT_IGNORE_CERT_DATE_INVALID: i32 = 8192i32;
pub const SXH_SERVER_CERT_IGNORE_ALL_SERVER_ERRORS: i32 = 13056i32;
...
pub const XHR_AUTH_ALL: i32 = 0i32;
pub const XHR_AUTH_NONE: i32 = 1i32;
pub const XHR_AUTH_PROXY: i32 = 2i32;
#[repr(C)]
pub struct XHR_CERT {
    pub cbCert: u32,
    pub pbCert: *mut u8,
...
pub const XHR_CERT_ERROR_REVOCATION_FAILED: u32 = 8388608u32;
pub const XHR_CERT_ERROR_UNKNOWN_CA: u32 = 16777216u32;
pub const XHR_CERT_ERROR_CERT_CN_INVALID: u32 = 33554432u32;
pub const XHR_CERT_ERROR_CERT_DATE_INVALID: u32 = 67108864u32;
pub const XHR_CERT_ERROR_ALL_SERVER_ERRORS: u32 = 125829120u32;
pub const XHR_CERT_IGNORE_REVOCATION_FAILED: u32 = 128u32;
pub const XHR_CERT_IGNORE_UNKNOWN_CA: u32 = 256u32;
pub const XHR_CERT_IGNORE_CERT_CN_INVALID: u32 = 4096u32;
pub const XHR_CERT_IGNORE_CERT_DATE_INVALID: u32 = 8192u32;
pub const XHR_CERT_IGNORE_ALL_SERVER_ERRORS: u32 = 12672u32;
#[repr(C)]
...
pub const XHR_COOKIE_IS_SECURE: i32 = 1i32;
pub const XHR_COOKIE_IS_SESSION: i32 = 2i32;
pub const XHR_COOKIE_THIRD_PARTY: i32 = 16i32;
pub const XHR_COOKIE_PROMPT_REQUIRED: i32 = 32i32;
pub const XHR_COOKIE_EVALUATE_P3P: i32 = 64i32;
pub const XHR_COOKIE_APPLY_P3P: i32 = 128i32;
pub const XHR_COOKIE_P3P_ENABLED: i32 = 256i32;
pub const XHR_COOKIE_IS_RESTRICTED: i32 = 512i32;
pub const XHR_COOKIE_IE6: i32 = 1024i32;
pub const XHR_COOKIE_IS_LEGACY: i32 = 2048i32;
pub const XHR_COOKIE_NON_SCRIPT: i32 = 4096i32;
pub const XHR_COOKIE_HTTPONLY: i32 = 8192i32;
pub const XHR_COOKIE_STATE_UNKNOWN: i32 = 0i32;
pub const XHR_COOKIE_STATE_ACCEPT: i32 = 1i32;
pub const XHR_COOKIE_STATE_PROMPT: i32 = 2i32;
pub const XHR_COOKIE_STATE_LEASH: i32 = 3i32;
pub const XHR_COOKIE_STATE_DOWNGRADE: i32 = 4i32;
pub const XHR_COOKIE_STATE_REJECT: i32 = 5i32;
pub const XHR_CRED_PROMPT_ALL: i32 = 0i32;
pub const XHR_CRED_PROMPT_NONE: i32 = 1i32;
pub const XHR_CRED_PROMPT_PROXY: i32 = 2i32;
pub const XHR_PROP_NO_CRED_PROMPT: i32 = 0i32;
pub const XHR_PROP_NO_AUTH: i32 = 1i32;
pub const XHR_PROP_TIMEOUT: i32 = 2i32;
pub const XHR_PROP_NO_DEFAULT_HEADERS: i32 = 3i32;
pub const XHR_PROP_REPORT_REDIRECT_STATUS: i32 = 4i32;
pub const XHR_PROP_NO_CACHE: i32 = 5i32;
pub const XHR_PROP_EXTENDED_ERROR: i32 = 6i32;
pub const XHR_PROP_QUERY_STRING_UTF8: i32 = 7i32;
pub const XHR_PROP_IGNORE_CERT_ERRORS: i32 = 8i32;
pub const XHR_PROP_ONDATA_THRESHOLD: i32 = 9i32;
pub const XHR_PROP_SET_ENTERPRISEID: i32 = 10i32;
pub const XHR_PROP_MAX_CONNECTIONS: i32 = 11i32;
...
pub const XMLELEMTYPE_ELEMENT: i32 = 0i32;
pub const XMLELEMTYPE_TEXT: i32 = 1i32;
pub const XMLELEMTYPE_COMMENT: i32 = 2i32;
pub const XMLELEMTYPE_DOCUMENT: i32 = 3i32;
pub const XMLELEMTYPE_DTD: i32 = 4i32;
pub const XMLELEMTYPE_PI: i32 = 5i32;
pub const XMLELEMTYPE_OTHER: i32 = 6i32;
