...
extern "system" {
    ...
    pub fn PTConvertDevModeToPrintTicket(hprovider: super::super::super::Storage::Xps::HPTPROVIDER, cbdevmode: u32, pdevmode: *const super::super::Gdi::DEVMODEA, scope: EPrintTicketScope, pprintticket: ::core::option::Option<super::super::super::System::Com::IStream>) -> ::windows_sys::core::HRESULT;
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_Graphics_Gdi", feature = "Win32_Storage_Xps", feature = "Win32_System_Com"))]
    pub fn PTConvertPrintTicketToDevMode(hprovider: super::super::super::Storage::Xps::HPTPROVIDER, pprintticket: ::core::option::Option<super::super::super::System::Com::IStream>, basedevmodetype: EDefaultDevmodeType, scope: EPrintTicketScope, pcbdevmode: *mut u32, ppdevmode: *mut *mut super::super::Gdi::DEVMODEA, pbstrerrormessage: *mut super::super::super::Foundation::BSTR) -> ::windows_sys::core::HRESULT;
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_Storage_Xps", feature = "Win32_System_Com"))]
    pub fn PTGetPrintCapabilities(hprovider: super::super::super::Storage::Xps::HPTPROVIDER, pprintticket: ::core::option::Option<super::super::super::System::Com::IStream>, pcapabilities: ::core::option::Option<super::super::super::System::Com::IStream>, pbstrerrormessage: *mut super::super::super::Foundation::BSTR) -> ::windows_sys::core::HRESULT;
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_Storage_Xps", feature = "Win32_System_Com"))]
    pub fn PTGetPrintDeviceCapabilities(hprovider: super::super::super::Storage::Xps::HPTPROVIDER, pprintticket: ::core::option::Option<super::super::super::System::Com::IStream>, pdevicecapabilities: ::core::option::Option<super::super::super::System::Com::IStream>, pbstrerrormessage: *mut super::super::super::Foundation::BSTR) -> ::windows_sys::core::HRESULT;
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_Storage_Xps", feature = "Win32_System_Com"))]
    pub fn PTGetPrintDeviceResources(hprovider: super::super::super::Storage::Xps::HPTPROVIDER, pszlocalename: super::super::super::Foundation::PWSTR, pprintticket: ::core::option::Option<super::super::super::System::Com::IStream>, pdeviceresources: ::core::option::Option<super::super::super::System::Com::IStream>, pbstrerrormessage: *mut super::super::super::Foundation::BSTR) -> ::windows_sys::core::HRESULT;
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_Storage_Xps", feature = "Win32_System_Com"))]
    pub fn PTMergeAndValidatePrintTicket(hprovider: super::super::super::Storage::Xps::HPTPROVIDER, pbaseticket: ::core::option::Option<super::super::super::System::Com::IStream>, pdeltaticket: ::core::option::Option<super::super::super::System::Com::IStream>, scope: EPrintTicketScope, presultticket: ::core::option::Option<super::super::super::System::Com::IStream>, pbstrerrormessage: *mut super::super::super::Foundation::BSTR) -> ::windows_sys::core::HRESULT;
