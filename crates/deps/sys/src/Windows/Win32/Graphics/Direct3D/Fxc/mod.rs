...
extern "system" {
    ...
    pub fn D3DCompile(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, psourcename: super::super::super::Foundation::PSTR, pdefines: *const super::D3D_SHADER_MACRO, pinclude: ::core::option::Option<super::ID3DInclude>, pentrypoint: super::super::super::Foundation::PSTR, ptarget: super::super::super::Foundation::PSTR, flags1: u32, flags2: u32, ppcode: *mut ::core::option::Option<super::ID3DBlob>, pperrormsgs: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn D3DCompile2(
        ...
        pinclude: ::core::option::Option<super::ID3DInclude>,
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub fn D3DCompileFromFile(pfilename: super::super::super::Foundation::PWSTR, pdefines: *const super::D3D_SHADER_MACRO, pinclude: ::core::option::Option<super::ID3DInclude>, pentrypoint: super::super::super::Foundation::PSTR, ptarget: super::super::super::Foundation::PSTR, flags1: u32, flags2: u32, ppcode: *mut ::core::option::Option<super::ID3DBlob>, pperrormsgs: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
    pub fn D3DCompressShaders(unumshaders: u32, pshaderdata: *const D3D_SHADER_DATA, uflags: u32, ppcompresseddata: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
    pub fn D3DCreateBlob(size: usize, ppblob: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
    #[cfg(feature = "Win32_Graphics_Direct3D11")]
    pub fn D3DCreateFunctionLinkingGraph(uflags: u32, ppfunctionlinkinggraph: *mut ::core::option::Option<super::super::Direct3D11::ID3D11FunctionLinkingGraph>) -> ::windows_sys::core::HRESULT;
    #[cfg(feature = "Win32_Graphics_Direct3D11")]
    pub fn D3DCreateLinker(pplinker: *mut ::core::option::Option<super::super::Direct3D11::ID3D11Linker>) -> ::windows_sys::core::HRESULT;
    pub fn D3DDecompressShaders(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, unumshaders: u32, ustartindex: u32, pindices: *const u32, uflags: u32, ppshaders: *mut ::core::option::Option<super::ID3DBlob>, ptotalshaders: *mut u32) -> ::windows_sys::core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn D3DDisassemble(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, flags: u32, szcomments: super::super::super::Foundation::PSTR, ppdisassembly: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
    #[cfg(feature = "Win32_Graphics_Direct3D10")]
    pub fn D3DDisassemble10Effect(peffect: ::core::option::Option<super::super::Direct3D10::ID3D10Effect>, flags: u32, ppdisassembly: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn D3DDisassembleRegion(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, flags: u32, szcomments: super::super::super::Foundation::PSTR, startbyteoffset: usize, numinsts: usize, pfinishbyteoffset: *mut usize, ppdisassembly: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
    pub fn D3DGetBlobPart(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, part: D3D_BLOB_PART, flags: u32, pppart: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
    pub fn D3DGetDebugInfo(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, ppdebuginfo: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
    pub fn D3DGetInputAndOutputSignatureBlob(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, ppsignatureblob: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
    pub fn D3DGetInputSignatureBlob(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, ppsignatureblob: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
    pub fn D3DGetOutputSignatureBlob(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, ppsignatureblob: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
    ...
    #[cfg(feature = "Win32_Graphics_Direct3D11")]
    pub fn D3DLoadModule(psrcdata: *const ::core::ffi::c_void, cbsrcdatasize: usize, ppmodule: *mut ::core::option::Option<super::super::Direct3D11::ID3D11Module>) -> ::windows_sys::core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn D3DPreprocess(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, psourcename: super::super::super::Foundation::PSTR, pdefines: *const super::D3D_SHADER_MACRO, pinclude: ::core::option::Option<super::ID3DInclude>, ppcodetext: *mut ::core::option::Option<super::ID3DBlob>, pperrormsgs: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn D3DReadFileToBlob(pfilename: super::super::super::Foundation::PWSTR, ppcontents: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
    ...
    pub fn D3DSetBlobPart(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, part: D3D_BLOB_PART, flags: u32, ppart: *const ::core::ffi::c_void, partsize: usize, ppnewshader: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
    pub fn D3DStripShader(pshaderbytecode: *const ::core::ffi::c_void, bytecodelength: usize, ustripflags: u32, ppstrippedblob: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn D3DWriteBlobToFile(pblob: ::core::option::Option<super::ID3DBlob>, pfilename: super::super::super::Foundation::PWSTR, boverwrite: super::super::super::Foundation::BOOL) -> ::windows_sys::core::HRESULT;
}
...
pub type pD3DCompile = unsafe extern "system" fn(
    psrcdata: *const ::core::ffi::c_void,
    srcdatasize: usize,
    pfilename: super::super::super::Foundation::PSTR,
    pdefines: *const super::D3D_SHADER_MACRO,
    pinclude: ::core::option::Option<super::ID3DInclude>,
    pentrypoint: super::super::super::Foundation::PSTR,
    ptarget: super::super::super::Foundation::PSTR,
...
#[cfg(feature = "Win32_Foundation")]
pub type pD3DDisassemble = unsafe extern "system" fn(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, flags: u32, szcomments: super::super::super::Foundation::PSTR, ppdisassembly: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type pD3DPreprocess = unsafe extern "system" fn(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, pfilename: super::super::super::Foundation::PSTR, pdefines: *const super::D3D_SHADER_MACRO, pinclude: ::core::option::Option<super::ID3DInclude>, ppcodetext: *mut ::core::option::Option<super::ID3DBlob>, pperrormsgs: *mut ::core::option::Option<super::ID3DBlob>) -> ::windows_sys::core::HRESULT;
