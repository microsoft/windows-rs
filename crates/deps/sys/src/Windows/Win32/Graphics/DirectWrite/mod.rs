...
pub struct IDWriteAsyncResult(i32);
pub struct IDWriteBitmapRenderTarget(i32);
pub struct IDWriteBitmapRenderTarget1(i32);
pub struct IDWriteColorGlyphRunEnumerator(i32);
pub struct IDWriteColorGlyphRunEnumerator1(i32);
pub struct IDWriteFactory(i32);
pub struct IDWriteFactory1(i32);
pub struct IDWriteFactory2(i32);
pub struct IDWriteFactory3(i32);
pub struct IDWriteFactory4(i32);
pub struct IDWriteFactory5(i32);
pub struct IDWriteFactory6(i32);
pub struct IDWriteFactory7(i32);
pub struct IDWriteFont(i32);
pub struct IDWriteFont1(i32);
pub struct IDWriteFont2(i32);
pub struct IDWriteFont3(i32);
pub struct IDWriteFontCollection(i32);
pub struct IDWriteFontCollection1(i32);
pub struct IDWriteFontCollection2(i32);
pub struct IDWriteFontCollection3(i32);
pub struct IDWriteFontCollectionLoader(i32);
pub struct IDWriteFontDownloadListener(i32);
pub struct IDWriteFontDownloadQueue(i32);
pub struct IDWriteFontFace(i32);
pub struct IDWriteFontFace1(i32);
pub struct IDWriteFontFace2(i32);
pub struct IDWriteFontFace3(i32);
pub struct IDWriteFontFace4(i32);
pub struct IDWriteFontFace5(i32);
pub struct IDWriteFontFace6(i32);
pub struct IDWriteFontFaceReference(i32);
pub struct IDWriteFontFaceReference1(i32);
pub struct IDWriteFontFallback(i32);
pub struct IDWriteFontFallback1(i32);
pub struct IDWriteFontFallbackBuilder(i32);
pub struct IDWriteFontFamily(i32);
pub struct IDWriteFontFamily1(i32);
pub struct IDWriteFontFamily2(i32);
pub struct IDWriteFontFile(i32);
pub struct IDWriteFontFileEnumerator(i32);
pub struct IDWriteFontFileLoader(i32);
pub struct IDWriteFontFileStream(i32);
pub struct IDWriteFontList(i32);
pub struct IDWriteFontList1(i32);
pub struct IDWriteFontList2(i32);
pub struct IDWriteFontResource(i32);
pub struct IDWriteFontSet(i32);
pub struct IDWriteFontSet1(i32);
pub struct IDWriteFontSet2(i32);
pub struct IDWriteFontSet3(i32);
pub struct IDWriteFontSetBuilder(i32);
pub struct IDWriteFontSetBuilder1(i32);
pub struct IDWriteFontSetBuilder2(i32);
pub struct IDWriteGdiInterop(i32);
pub struct IDWriteGdiInterop1(i32);
pub struct IDWriteGlyphRunAnalysis(i32);
pub struct IDWriteInMemoryFontFileLoader(i32);
pub struct IDWriteInlineObject(i32);
pub struct IDWriteLocalFontFileLoader(i32);
pub struct IDWriteLocalizedStrings(i32);
pub struct IDWriteNumberSubstitution(i32);
pub struct IDWritePixelSnapping(i32);
pub struct IDWriteRemoteFontFileLoader(i32);
pub struct IDWriteRemoteFontFileStream(i32);
pub struct IDWriteRenderingParams(i32);
pub struct IDWriteRenderingParams1(i32);
pub struct IDWriteRenderingParams2(i32);
pub struct IDWriteRenderingParams3(i32);
pub struct IDWriteStringList(i32);
pub struct IDWriteTextAnalysisSink(i32);
pub struct IDWriteTextAnalysisSink1(i32);
pub struct IDWriteTextAnalysisSource(i32);
pub struct IDWriteTextAnalysisSource1(i32);
pub struct IDWriteTextAnalyzer(i32);
pub struct IDWriteTextAnalyzer1(i32);
pub struct IDWriteTextAnalyzer2(i32);
pub struct IDWriteTextFormat(i32);
pub struct IDWriteTextFormat1(i32);
pub struct IDWriteTextFormat2(i32);
pub struct IDWriteTextFormat3(i32);
pub struct IDWriteTextLayout(i32);
pub struct IDWriteTextLayout1(i32);
pub struct IDWriteTextLayout2(i32);
pub struct IDWriteTextLayout3(i32);
pub struct IDWriteTextLayout4(i32);
pub struct IDWriteTextRenderer(i32);
pub struct IDWriteTextRenderer1(i32);
pub struct IDWriteTypography(i32);
