...
pub struct ID3D10Asynchronous(i32);
pub struct ID3D10BlendState(i32);
pub struct ID3D10BlendState1(i32);
pub struct ID3D10Buffer(i32);
pub struct ID3D10Counter(i32);
pub struct ID3D10Debug(i32);
pub struct ID3D10DepthStencilState(i32);
pub struct ID3D10DepthStencilView(i32);
pub struct ID3D10Device(i32);
pub struct ID3D10Device1(i32);
pub struct ID3D10DeviceChild(i32);
pub struct ID3D10Effect(i32);
pub struct ID3D10EffectBlendVariable(i32);
pub struct ID3D10EffectConstantBuffer(i32);
pub struct ID3D10EffectDepthStencilVariable(i32);
pub struct ID3D10EffectDepthStencilViewVariable(i32);
pub struct ID3D10EffectMatrixVariable(i32);
pub struct ID3D10EffectPass(i32);
pub struct ID3D10EffectPool(i32);
pub struct ID3D10EffectRasterizerVariable(i32);
pub struct ID3D10EffectRenderTargetViewVariable(i32);
pub struct ID3D10EffectSamplerVariable(i32);
pub struct ID3D10EffectScalarVariable(i32);
pub struct ID3D10EffectShaderResourceVariable(i32);
pub struct ID3D10EffectShaderVariable(i32);
pub struct ID3D10EffectStringVariable(i32);
pub struct ID3D10EffectTechnique(i32);
pub struct ID3D10EffectType(i32);
pub struct ID3D10EffectVariable(i32);
pub struct ID3D10EffectVectorVariable(i32);
pub struct ID3D10GeometryShader(i32);
pub struct ID3D10InfoQueue(i32);
pub struct ID3D10InputLayout(i32);
pub struct ID3D10Multithread(i32);
pub struct ID3D10PixelShader(i32);
pub struct ID3D10Predicate(i32);
pub struct ID3D10Query(i32);
pub struct ID3D10RasterizerState(i32);
pub struct ID3D10RenderTargetView(i32);
pub struct ID3D10Resource(i32);
pub struct ID3D10SamplerState(i32);
pub struct ID3D10ShaderReflection(i32);
pub struct ID3D10ShaderReflection1(i32);
pub struct ID3D10ShaderReflectionConstantBuffer(i32);
pub struct ID3D10ShaderReflectionType(i32);
pub struct ID3D10ShaderReflectionVariable(i32);
pub struct ID3D10ShaderResourceView(i32);
pub struct ID3D10ShaderResourceView1(i32);
pub struct ID3D10StateBlock(i32);
pub struct ID3D10SwitchToRef(i32);
pub struct ID3D10Texture1D(i32);
pub struct ID3D10Texture2D(i32);
pub struct ID3D10Texture3D(i32);
pub struct ID3D10VertexShader(i32);
pub struct ID3D10View(i32);
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Graphics_Dxgi"))]
