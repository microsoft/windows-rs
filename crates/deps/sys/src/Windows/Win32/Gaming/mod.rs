...
extern "system" {
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub fn CheckGamingPrivilegeSilentlyForUser(user: ::core::option::Option<::windows_sys::core::IInspectable>, privilegeid: u32, scope: ::windows_sys::core::HSTRING, policy: ::windows_sys::core::HSTRING, hasprivilege: *mut super::Foundation::BOOL) -> ::windows_sys::core::HRESULT;
    ...
    pub fn CheckGamingPrivilegeWithUIForUser(user: ::core::option::Option<::windows_sys::core::IInspectable>, privilegeid: u32, scope: ::windows_sys::core::HSTRING, policy: ::windows_sys::core::HSTRING, friendlymessage: ::windows_sys::core::HSTRING, completionroutine: ::core::option::Option<GameUICompletionRoutine>, context: *const ::core::ffi::c_void) -> ::windows_sys::core::HRESULT;
    ...
    pub fn ShowChangeFriendRelationshipUIForUser(user: ::core::option::Option<::windows_sys::core::IInspectable>, targetuserxuid: ::windows_sys::core::HSTRING, completionroutine: ::core::option::Option<GameUICompletionRoutine>, context: *const ::core::ffi::c_void) -> ::windows_sys::core::HRESULT;
    ...
    pub fn ShowCustomizeUserProfileUIForUser(user: ::core::option::Option<::windows_sys::core::IInspectable>, completionroutine: ::core::option::Option<GameUICompletionRoutine>, context: *const ::core::ffi::c_void) -> ::windows_sys::core::HRESULT;
    ...
    pub fn ShowFindFriendsUIForUser(user: ::core::option::Option<::windows_sys::core::IInspectable>, completionroutine: ::core::option::Option<GameUICompletionRoutine>, context: *const ::core::ffi::c_void) -> ::windows_sys::core::HRESULT;
    ...
    pub fn ShowGameInfoUIForUser(user: ::core::option::Option<::windows_sys::core::IInspectable>, titleid: u32, completionroutine: ::core::option::Option<GameUICompletionRoutine>, context: *const ::core::ffi::c_void) -> ::windows_sys::core::HRESULT;
    ...
    pub fn ShowGameInviteUIForUser(user: ::core::option::Option<::windows_sys::core::IInspectable>, serviceconfigurationid: ::windows_sys::core::HSTRING, sessiontemplatename: ::windows_sys::core::HSTRING, sessionid: ::windows_sys::core::HSTRING, invitationdisplaytext: ::windows_sys::core::HSTRING, completionroutine: ::core::option::Option<GameUICompletionRoutine>, context: *const ::core::ffi::c_void) -> ::windows_sys::core::HRESULT;
    ...
    pub fn ShowGameInviteUIWithContextForUser(
        user: ::core::option::Option<::windows_sys::core::IInspectable>,
        serviceconfigurationid: ::windows_sys::core::HSTRING,
        sessiontemplatename: ::windows_sys::core::HSTRING,
        sessionid: ::windows_sys::core::HSTRING,
        invitationdisplaytext: ::windows_sys::core::HSTRING,
        customactivationcontext: ::windows_sys::core::HSTRING,
    ...
    pub fn ShowPlayerPickerUIForUser(user: ::core::option::Option<::windows_sys::core::IInspectable>, promptdisplaytext: ::windows_sys::core::HSTRING, xuids: *const ::windows_sys::core::HSTRING, xuidscount: usize, preselectedxuids: *const ::windows_sys::core::HSTRING, preselectedxuidscount: usize, minselectioncount: usize, maxselectioncount: usize, completionroutine: ::core::option::Option<PlayerPickerUICompletionRoutine>, context: *const ::core::ffi::c_void) -> ::windows_sys::core::HRESULT;
    ...
    pub fn ShowProfileCardUIForUser(user: ::core::option::Option<::windows_sys::core::IInspectable>, targetuserxuid: ::windows_sys::core::HSTRING, completionroutine: ::core::option::Option<GameUICompletionRoutine>, context: *const ::core::ffi::c_void) -> ::windows_sys::core::HRESULT;
    ...
    pub fn ShowTitleAchievementsUIForUser(user: ::core::option::Option<::windows_sys::core::IInspectable>, titleid: u32, completionroutine: ::core::option::Option<GameUICompletionRoutine>, context: *const ::core::ffi::c_void) -> ::windows_sys::core::HRESULT;
    ...
    pub fn ShowUserSettingsUIForUser(user: ::core::option::Option<::windows_sys::core::IInspectable>, completionroutine: ::core::option::Option<GameUICompletionRoutine>, context: *const ::core::ffi::c_void) -> ::windows_sys::core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
