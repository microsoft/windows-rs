...
#[link(name = "windows")]
extern "system" {
    pub fn MLCreateOperatorRegistry(registry: *mut ::core::option::Option<IMLOperatorRegistry>) -> ::windows_sys::core::HRESULT;
    pub fn WinMLCreateRuntime(runtime: *mut ::core::option::Option<IWinMLRuntime>) -> ::windows_sys::core::HRESULT;
}
