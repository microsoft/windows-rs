...
pub struct IDMLBindingTable(i32);
pub struct IDMLCommandRecorder(i32);
pub struct IDMLCompiledOperator(i32);
pub struct IDMLDebugDevice(i32);
pub struct IDMLDevice(i32);
pub struct IDMLDevice1(i32);
pub struct IDMLDeviceChild(i32);
pub struct IDMLDispatchable(i32);
pub struct IDMLObject(i32);
pub struct IDMLOperator(i32);
pub struct IDMLOperatorInitializer(i32);
pub struct IDMLPageable(i32);
