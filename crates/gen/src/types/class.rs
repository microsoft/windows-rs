...
mod tests {
    ...
    fn test_class() {
        ...
        assert_eq!(
            i[0].def.gen_name(&Gen::absolute(&TypeTree::from_namespace(Default::default(), ""))).as_str(),
        ...
        assert_eq!(
            i[2].def.gen_name(&Gen::absolute(&TypeTree::from_namespace(Default::default(), ""))).as_str(),
