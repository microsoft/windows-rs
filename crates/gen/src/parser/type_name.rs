...
impl TypeName {
    ...
    pub const Guid: Self= Self::from_const("Syste", "Guid");
    pub const Type: Self= Self::from_const("Syste", "Type");
    pub const Attribute: Self= Self::from_const("Syste", "Attribute");
    ...
    pub const LARGE_INTEGER: Self = Self::from_const("Windows.Win32.System.SystemServices","LARGE_INTEGER");
    pub const ULARGE_INTEGER: Self = Self::from_const("Windows.Win32.System.SystemServices","ULARGE_INTEGER");
    ...
    pub const D2D1MakeRotateMatrix: Self = Self::from_const("Windows.Win32.Graphics.Direct2D",    "D2D1MakeRotateMatrix");
