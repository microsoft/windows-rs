...
pub unsafe trait Interface: Sized + Clone {
    ...
    /// named cast.
    #[inline(always)]
    fn cast<T: Interface>(&self) -> Result<T, windows_result::HRESULT> {
    ...
    #[inline(always)]
    fn cast_to_any<T>(&self) -> Result<&dyn Any, windows_result::HRESULT>
    where
        T: ComObjectInner,
    ...
    #[inline(always)]
    fn cast_object_ref<T>(&self) -> Result<&T::Outer, windows_result::HRESULT>
    where
        T: ComObjectInner,
        T::Outer: Any + 'static + IUnknownImpl<Impl = T>,
    {
    ...
    #[inline(always)]
    fn cast_object<T>(&self) -> Result<ComObject<T>, windows_result::HRESULT>
    where
        T: ComObjectInner,
        T::Outer: Any + 'static + IUnknownImpl<Impl = T>,
    {
    ...
    fn downgrade(&self) -> Result<Weak<Self>, windows_result::HRESULT> {
