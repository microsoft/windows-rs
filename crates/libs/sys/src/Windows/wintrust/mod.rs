...
windows_link::link!("wintrust.dll" "system" fn WintrustSetRegPolicyFlags(dwpolicyflags : u32) -> windows_sys::core::BOOL);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const CAT_MEMBERINFO2_STRUCT: windows_sys::core::PCSTR = 2223 as _;
...
pub const CAT_NAMEVALUE_STRUCT: windows_sys::core::PCSTR = 2221 as _;
...
pub struct CRYPT_PROVIDER_CERT {
    ...
    pub dwError: u32,
    pub pTrustListContext: *mut super::wincrypt::CTL_CONTEXT,
...
pub struct CRYPT_PROVIDER_DATA {
    ...
    pub dwEncoding: u32,
    pub hMsg: super::wincrypt::HCRYPTMSG,
    pub csSigners: u32,
    ...
    pub sftSystemTime: super::minwindef::FILETIME,
    pub pszCTLSignerUsageOID: *mut i8,
    pub dwProvFlags: u32,
    pub dwFinalError: u32,
    pub pRequestUsage: super::wincrypt::PCERT_USAGE_MATCH,
...
pub struct CRYPT_PROVIDER_SGNR {
    ...
    pub psSigner: *mut super::wincrypt::CMSG_SIGNER_INFO,
    pub dwError: u32,
...
pub struct CRYPT_PROVIDER_SIGSTATE {
    ...
    pub hPrimarySig: super::wincrypt::HCRYPTMSG,
...
pub struct PROVDATA_SIP {
    ...
    pub pSip: *mut super::mssip::SIP_DISPATCH_INFO,
    pub pCATSip: *mut super::mssip::SIP_DISPATCH_INFO,
    pub psSipSubjectInfo: *mut super::mssip::SIP_SUBJECTINFO,
...
pub struct SEALING_SIGNATURE_ATTRIBUTE {
    pub version: u32,
    pub signerIndex: u32,
    pub signatureAlgorithm: super::wincrypt::CRYPT_ALGORITHM_IDENTIFIER,
    pub encryptedDigest: super::wincrypt::CRYPT_DIGEST_BLOB,
}
...
pub struct SEALING_TIMESTAMP_ATTRIBUTE {
    pub version: u32,
    pub signerIndex: u32,
    pub sealTimeStampToken: super::wincrypt::CRYPT_DATA_BLOB,
}
pub const SEALING_TIMESTAMP_ATTRIBUTE_STRUCT: windows_sys::core::PCSTR = 2012 as _;
...
pub const SPC_CAB_DATA_STRUCT: windows_sys::core::PCSTR = 2008 as _;
...
pub struct SPC_IMAGE {
    ...
    pub Metafile: super::wincrypt::CRYPT_DATA_BLOB,
...
pub const SPC_INDIRECT_DATA_CONTENT_STRUCT: windows_sys::core::PCSTR = 2003 as _;
...
pub const SPC_LINK_STRUCT: windows_sys::core::PCSTR = 2005 as _;
pub const SPC_MINIMAL_CRITERIA_OBJID: windows_sys::core::PCSTR = windows_sys::core::s!("1.3.6.1.4.1.311.2.1.26");
pub const SPC_MINIMAL_CRITERIA_STRUCT: windows_sys::core::PCSTR = 2001 as _;
...
pub const SPC_PE_IMAGE_DATA_STRUCT: windows_sys::core::PCSTR = 2004 as _;
...
pub const SPC_SP_OPUS_INFO_STRUCT: windows_sys::core::PCSTR = 2007 as _;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const SPC_STATEMENT_TYPE_STRUCT: windows_sys::core::PCSTR = 2006 as _;
...
pub struct WINTRUST_CATALOG_INFO {
    ...
    pub hMemberFile: super::winnt::HANDLE,
...
pub struct WINTRUST_CERT_INFO {
    pub cbStruct: u32,
    pub pcwszDisplayName: windows_sys::core::PCWSTR,
    pub psCertContext: *mut super::wincrypt::CERT_CONTEXT,
    pub chStores: u32,
    pub pahStores: *mut super::wincrypt::HCERTSTORE,
    pub dwFlags: u32,
...
pub struct WINTRUST_SGNR_INFO {
    pub cbStruct: u32,
    pub pcwszDisplayName: windows_sys::core::PCWSTR,
    pub psSignerInfo: *mut super::wincrypt::CMSG_SIGNER_INFO,
    pub chStores: u32,
    pub pahStores: *mut super::wincrypt::HCERTSTORE,
}
#[cfg(feature = "wincrypt")]
...
pub const szOID_SIGNED_ATTRIBUTE_AUTHOR: windows_sys::core::PCSTR = windows_sys::core::s!("1.3.6.1.4.1.311.2.7.8");
pub const szOID_SIGNED_ATTRIBUTE_FILE_DESCRIPTION: windows_sys::core::PCSTR = windows_sys::core::s!("1.3.6.1.4.1.311.2.7.3");
pub const szOID_SIGNED_ATTRIBUTE_FILE_VERSION: windows_sys::core::PCSTR = windows_sys::core::s!("1.3.6.1.4.1.311.2.7.2");
pub const szOID_SIGNED_ATTRIBUTE_INTERNAL_NAME: windows_sys::core::PCSTR = windows_sys::core::s!("1.3.6.1.4.1.311.2.7.1");
pub const szOID_SIGNED_ATTRIBUTE_LANGUAGE: windows_sys::core::PCSTR = windows_sys::core::s!("1.3.6.1.4.1.311.2.7.7");
pub const szOID_SIGNED_ATTRIBUTE_ORIGINAL_FILENAME: windows_sys::core::PCSTR = windows_sys::core::s!("1.3.6.1.4.1.311.2.7.6");
pub const szOID_SIGNED_ATTRIBUTE_PRODUCT: windows_sys::core::PCSTR = windows_sys::core::s!("1.3.6.1.4.1.311.2.7.4");
pub const szOID_SIGNED_ATTRIBUTE_PRODUCT_VERSION: windows_sys::core::PCSTR = windows_sys::core::s!("1.3.6.1.4.1.311.2.7.5");
pub const szOID_SIGNED_ATTRIBUTE_PUBLISH_TIME: windows_sys::core::PCSTR = windows_sys::core::s!("1.3.6.1.4.1.311.2.7.9");
pub const szOID_SIGNED_ATTRIBUTE_SOURCE_URL: windows_sys::core::PCSTR = windows_sys::core::s!("1.3.6.1.4.1.311.2.7.10");
