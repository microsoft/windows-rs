...
windows_link::link!("ntdll.dll" "system" fn NtAdjustGroupsToken(tokenhandle : super::winnt::HANDLE, resettodefault : bool, newstate : *const super::winnt::TOKEN_GROUPS, bufferlength : u32, previousstate : *mut super::winnt::TOKEN_GROUPS, returnlength : *mut u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtAdjustPrivilegesToken(tokenhandle : super::winnt::HANDLE, disableallprivileges : bool, newstate : *const super::winnt::TOKEN_PRIVILEGES, bufferlength : u32, previousstate : *mut super::winnt::TOKEN_PRIVILEGES, returnlength : *mut u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtAllocateVirtualMemory(processhandle : super::winnt::HANDLE, baseaddress : *mut *mut core::ffi::c_void, zerobits : usize, regionsize : *mut usize, allocationtype : u32, protect : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi"))]
windows_link::link!("ntdll.dll" "system" fn NtCloseObjectAuditAlarm(subsystemname : *const super::ntsecapi::UNICODE_STRING, handleid : *const core::ffi::c_void, generateonclose : bool) -> super::bcrypt::NTSTATUS);
...
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi"))]
windows_link::link!("ntdll.dll" "system" fn NtDeleteObjectAuditAlarm(subsystemname : *const super::ntsecapi::UNICODE_STRING, handleid : *const core::ffi::c_void, generateonclose : bool) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "d3dkmthk", feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtDuplicateToken(existingtokenhandle : super::winnt::HANDLE, desiredaccess : super::winnt::ACCESS_MASK, objectattributes : *const super::d3dkmthk::OBJECT_ATTRIBUTES, effectiveonly : bool, tokentype : super::winnt::TOKEN_TYPE, newtokenhandle : *mut super::winnt::HANDLE) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
...
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn NtFlushBuffersFileEx(filehandle : super::winnt::HANDLE, flags : u32, parameters : *const core::ffi::c_void, parameterssize : u32, iostatusblock : *mut super::winternl::IO_STATUS_BLOCK) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtFreeVirtualMemory(processhandle : super::winnt::HANDLE, baseaddress : *mut *mut core::ffi::c_void, regionsize : *mut usize, freetype : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
...
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtImpersonateAnonymousToken(threadhandle : super::winnt::HANDLE) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
...
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtOpenProcessToken(processhandle : super::winnt::HANDLE, desiredaccess : super::winnt::ACCESS_MASK, tokenhandle : *mut super::winnt::HANDLE) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtOpenProcessTokenEx(processhandle : super::winnt::HANDLE, desiredaccess : super::winnt::ACCESS_MASK, handleattributes : u32, tokenhandle : *mut super::winnt::HANDLE) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtOpenThreadToken(threadhandle : super::winnt::HANDLE, desiredaccess : super::winnt::ACCESS_MASK, openasself : bool, tokenhandle : *mut super::winnt::HANDLE) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtOpenThreadTokenEx(threadhandle : super::winnt::HANDLE, desiredaccess : super::winnt::ACCESS_MASK, openasself : bool, handleattributes : u32, tokenhandle : *mut super::winnt::HANDLE) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtPrivilegeCheck(clienttoken : super::winnt::HANDLE, requiredprivileges : *mut super::winnt::PRIVILEGE_SET, result : *mut bool) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtPrivilegeObjectAuditAlarm(subsystemname : *const super::ntsecapi::UNICODE_STRING, handleid : *const core::ffi::c_void, clienttoken : super::winnt::HANDLE, desiredaccess : super::winnt::ACCESS_MASK, privileges : *const super::winnt::PRIVILEGE_SET, accessgranted : bool) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtPrivilegedServiceAuditAlarm(subsystemname : *const super::ntsecapi::UNICODE_STRING, servicename : *const super::ntsecapi::UNICODE_STRING, clienttoken : super::winnt::HANDLE, privileges : *const super::winnt::PRIVILEGE_SET, accessgranted : bool) -> super::bcrypt::NTSTATUS);
...
windows_link::link!("ntdll.dll" "system" fn NtQueryInformationByName(objectattributes : *const super::d3dkmthk::OBJECT_ATTRIBUTES, iostatusblock : *mut super::winternl::IO_STATUS_BLOCK, fileinformation : *mut core::ffi::c_void, length : u32, fileinformationclass : super::winternl::FILE_INFORMATION_CLASS) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn NtQueryInformationFile(filehandle : super::winnt::HANDLE, iostatusblock : *mut super::winternl::IO_STATUS_BLOCK, fileinformation : *mut core::ffi::c_void, length : u32, fileinformationclass : super::winternl::FILE_INFORMATION_CLASS) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtQueryInformationToken(tokenhandle : super::winnt::HANDLE, tokeninformationclass : super::winnt::TOKEN_INFORMATION_CLASS, tokeninformation : *mut core::ffi::c_void, tokeninformationlength : u32, returnlength : *mut u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
...
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtQuerySecurityObject(handle : super::winnt::HANDLE, securityinformation : super::winnt::SECURITY_INFORMATION, securitydescriptor : super::winnt::PSECURITY_DESCRIPTOR, length : u32, lengthneeded : *mut u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtQueryVirtualMemory(processhandle : super::winnt::HANDLE, baseaddress : *const core::ffi::c_void, memoryinformationclass : MEMORY_INFORMATION_CLASS, memoryinformation : *mut core::ffi::c_void, memoryinformationlength : usize, returnlength : *mut usize) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "wdm", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn NtQueryVolumeInformationFile(filehandle : super::winnt::HANDLE, iostatusblock : *mut super::winternl::IO_STATUS_BLOCK, fsinformation : *mut core::ffi::c_void, length : u32, fsinformationclass : super::wdm::FS_INFORMATION_CLASS) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
...
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn NtSetInformationFile(filehandle : super::winnt::HANDLE, iostatusblock : *mut super::winternl::IO_STATUS_BLOCK, fileinformation : *const core::ffi::c_void, length : u32, fileinformationclass : super::winternl::FILE_INFORMATION_CLASS) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtSetInformationToken(tokenhandle : super::winnt::HANDLE, tokeninformationclass : super::winnt::TOKEN_INFORMATION_CLASS, tokeninformation : *const core::ffi::c_void, tokeninformationlength : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtSetInformationVirtualMemory(processhandle : super::winnt::HANDLE, vminformationclass : VIRTUAL_MEMORY_INFORMATION_CLASS, numberofentries : usize, virtualaddresses : *const MEMORY_RANGE_ENTRY, vminformation : *const core::ffi::c_void, vminformationlength : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn NtSetQuotaInformationFile(filehandle : super::winnt::HANDLE, iostatusblock : *mut super::winternl::IO_STATUS_BLOCK, buffer : *const core::ffi::c_void, length : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn NtSetSecurityObject(handle : super::winnt::HANDLE, securityinformation : super::winnt::SECURITY_INFORMATION, securitydescriptor : super::winnt::PSECURITY_DESCRIPTOR) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "wdm", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn NtSetVolumeInformationFile(filehandle : super::winnt::HANDLE, iostatusblock : *mut super::winternl::IO_STATUS_BLOCK, fsinformation : *const core::ffi::c_void, length : u32, fsinformationclass : super::wdm::FS_INFORMATION_CLASS) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn NtUnlockFile(filehandle : super::winnt::HANDLE, iostatusblock : *mut super::winternl::IO_STATUS_BLOCK, byteoffset : *const i64, length : *const i64, key : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
...
windows_link::link!("ntdll.dll" "system" fn PfxFindPrefix(prefixtable : *const PREFIX_TABLE, fullname : *const super::ntsecapi::STRING) -> PPREFIX_TABLE_ENTRY);
#[cfg(all(feature = "lsalookup", feature = "ntddk", feature = "ntdef", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn PfxInitialize(prefixtable : *mut PREFIX_TABLE));
#[cfg(all(feature = "lsalookup", feature = "ntddk", feature = "ntdef", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn PfxInsertPrefix(prefixtable : *const PREFIX_TABLE, prefix : *const super::ntsecapi::STRING, prefixtableentry : *mut PREFIX_TABLE_ENTRY) -> bool);
#[cfg(all(feature = "lsalookup", feature = "ntddk", feature = "ntdef", feature = "ntsecapi", feature = "winnt"))]
...
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlAbsoluteToSelfRelativeSD(absolutesecuritydescriptor : super::winnt::PSECURITY_DESCRIPTOR, selfrelativesecuritydescriptor : super::winnt::PSECURITY_DESCRIPTOR, bufferlength : *mut u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlAddAccessAllowedAce(acl : *mut super::winnt::ACL, acerevision : u32, accessmask : super::winnt::ACCESS_MASK, sid : super::winnt::PSID) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlAddAccessAllowedAceEx(acl : *mut super::winnt::ACL, acerevision : u32, aceflags : u32, accessmask : super::winnt::ACCESS_MASK, sid : super::winnt::PSID) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlAddAce(acl : *mut super::winnt::ACL, acerevision : u32, startingaceindex : u32, acelist : *const core::ffi::c_void, acelistlength : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
...
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlAllocateAndInitializeSidEx(identifierauthority : *const super::winnt::SID_IDENTIFIER_AUTHORITY, subauthoritycount : u8, subauthorities : *const u32, sid : *mut super::winnt::PSID) -> super::bcrypt::NTSTATUS);
...
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlAppendStringToString(destination : *mut super::ntsecapi::STRING, source : *const super::ntsecapi::STRING) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "lsalookup", feature = "ntsecapi"))]
windows_link::link!("ntdll.dll" "system" fn RtlCompareAltitudes(altitude1 : *const super::ntsecapi::UNICODE_STRING, altitude2 : *const super::ntsecapi::UNICODE_STRING) -> i32);
windows_link::link!("ntdll.dll" "system" fn RtlCompareMemoryUlong(source : *const core::ffi::c_void, length : usize, pattern : u32) -> usize);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlCompressBuffer(compressionformatandengine : u16, uncompressedbuffer : *const u8, uncompressedbuffersize : u32, compressedbuffer : *mut u8, compressedbuffersize : u32, uncompressedchunksize : u32, finalcompressedsize : *mut u32, workspace : *const core::ffi::c_void) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "winnt")]
windows_link::link!("ntdll.dll" "system" fn RtlCopyLuid(destinationluid : *mut super::winnt::LUID, sourceluid : *const super::winnt::LUID));
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlCopySid(destinationsidlength : u32, destinationsid : super::winnt::PSID, sourcesid : super::winnt::PSID) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlCreateAcl(acl : *mut super::winnt::ACL, acllength : u32, aclrevision : u32) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "bcrypt")]
...
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlCreateServiceSid(servicename : *const super::ntsecapi::UNICODE_STRING, servicesid : super::winnt::PSID, servicesidlength : *mut u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi"))]
windows_link::link!("ntdll.dll" "system" fn RtlCreateSystemVolumeInformationFolder(volumerootpath : *const super::ntsecapi::UNICODE_STRING) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "lsalookup", feature = "ntsecapi"))]
windows_link::link!("ntdll.dll" "system" fn RtlCreateUnicodeString(destinationstring : *mut super::ntsecapi::UNICODE_STRING, sourcestring : windows_sys::core::PCWSTR) -> bool);
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlCreateVirtualAccountSid(name : *const super::ntsecapi::UNICODE_STRING, basesubauthority : u32, sid : super::winnt::PSID, sidlength : *mut u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "minwindef", feature = "ntnls"))]
windows_link::link!("ntdll.dll" "system" fn RtlCustomCPToUnicodeN(customcp : *const super::ntnls::CPTABLEINFO, unicodestring : *mut u16, maxbytesinunicodestring : u32, bytesinunicodestring : *mut u32, customcpstring : *const i8, bytesincustomcpstring : u32) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlDecompressBuffer(compressionformat : u16, uncompressedbuffer : *mut u8, uncompressedbuffersize : u32, compressedbuffer : *const u8, compressedbuffersize : u32, finaluncompressedsize : *mut u32) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlDecompressBufferEx(compressionformat : u16, uncompressedbuffer : *mut u8, uncompressedbuffersize : u32, compressedbuffer : *const u8, compressedbuffersize : u32, finaluncompressedsize : *mut u32, workspace : *const core::ffi::c_void) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlDecompressFragment(compressionformat : u16, uncompressedfragment : *mut u8, uncompressedfragmentsize : u32, compressedbuffer : *const u8, compressedbuffersize : u32, fragmentoffset : u32, finaluncompressedsize : *mut u32, workspace : *const core::ffi::c_void) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlDeleteAce(acl : *mut super::winnt::ACL, aceindex : u32) -> super::bcrypt::NTSTATUS);
windows_link::link!("ntdll.dll" "system" fn RtlDestroyHeap(heaphandle : *const core::ffi::c_void) -> *mut core::ffi::c_void);
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi"))]
windows_link::link!("ntdll.dll" "system" fn RtlDowncaseUnicodeString(destinationstring : *mut super::ntsecapi::UNICODE_STRING, sourcestring : *const super::ntsecapi::UNICODE_STRING, allocatedestinationstring : bool) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi"))]
windows_link::link!("ntdll.dll" "system" fn RtlDuplicateUnicodeString(flags : u32, stringin : *const super::ntsecapi::UNICODE_STRING, stringout : *mut super::ntsecapi::UNICODE_STRING) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "winnt")]
windows_link::link!("ntdll.dll" "system" fn RtlEqualPrefixSid(sid1 : super::winnt::PSID, sid2 : super::winnt::PSID) -> bool);
#[cfg(feature = "winnt")]
windows_link::link!("ntdll.dll" "system" fn RtlEqualSid(sid1 : super::winnt::PSID, sid2 : super::winnt::PSID) -> bool);
#[cfg(feature = "ntdef")]
windows_link::link!("ntdll.dll" "system" fn RtlFreeHeap(heaphandle : *const core::ffi::c_void, flags : u32, baseaddress : *mut core::ffi::c_void) -> super::ntdef::LOGICAL);
#[cfg(feature = "winnt")]
windows_link::link!("ntdll.dll" "system" fn RtlFreeSid(sid : super::winnt::PSID) -> *mut core::ffi::c_void);
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi"))]
windows_link::link!("ntdll.dll" "system" fn RtlGenerate8dot3Name(name : *const super::ntsecapi::UNICODE_STRING, allowextendedcharacters : bool, context : *mut GENERATE_NAME_CONTEXT, name8dot3 : *mut super::ntsecapi::UNICODE_STRING) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlGetAce(acl : *const super::winnt::ACL, aceindex : u32, ace : *mut *mut core::ffi::c_void) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlGetAcesBufferSize(acl : *const super::winnt::ACL, acesbuffersize : *mut u32) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlGetCompressionWorkSpaceSize(compressionformatandengine : u16, compressbufferworkspacesize : *mut u32, compressfragmentworkspacesize : *mut u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlGetDaclSecurityDescriptor(securitydescriptor : super::winnt::PSECURITY_DESCRIPTOR, daclpresent : *mut bool, dacl : *mut super::winnt::PACL, dacldefaulted : *mut bool) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlGetGroupSecurityDescriptor(securitydescriptor : super::winnt::PSECURITY_DESCRIPTOR, group : *mut super::winnt::PSID, groupdefaulted : *mut bool) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlGetOwnerSecurityDescriptor(securitydescriptor : super::winnt::PSECURITY_DESCRIPTOR, owner : *mut super::winnt::PSID, ownerdefaulted : *mut bool) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlGetSaclSecurityDescriptor(securitydescriptor : super::winnt::PSECURITY_DESCRIPTOR, saclpresent : *mut bool, sacl : *mut super::winnt::PACL, sacldefaulted : *mut bool) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "winnt")]
windows_link::link!("ntdll.dll" "system" fn RtlIdentifierAuthoritySid(sid : super::winnt::PSID) -> super::winnt::PSID_IDENTIFIER_AUTHORITY);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlIdnToAscii(flags : u32, sourcestring : windows_sys::core::PCWSTR, sourcestringlength : i32, destinationstring : windows_sys::core::PWSTR, destinationstringlength : *mut i32) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlIdnToNameprepUnicode(flags : u32, sourcestring : windows_sys::core::PCWSTR, sourcestringlength : i32, destinationstring : windows_sys::core::PWSTR, destinationstringlength : *mut i32) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlIdnToUnicode(flags : u32, sourcestring : windows_sys::core::PCWSTR, sourcestringlength : i32, destinationstring : windows_sys::core::PWSTR, destinationstringlength : *mut i32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "minwindef", feature = "ntnls"))]
windows_link::link!("ntdll.dll" "system" fn RtlInitCodePageTable(tablebase : *const u16, codepagetable : *mut super::ntnls::CPTABLEINFO));
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi"))]
windows_link::link!("ntdll.dll" "system" fn RtlInitUnicodeStringEx(destinationstring : *mut super::ntsecapi::UNICODE_STRING, sourcestring : windows_sys::core::PCWSTR) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlInitializeSid(sid : super::winnt::PSID, identifierauthority : *const super::winnt::SID_IDENTIFIER_AUTHORITY, subauthoritycount : u8) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "C" fn RtlInitializeSidEx(sid : super::winnt::PSID, identifierauthority : *const super::winnt::SID_IDENTIFIER_AUTHORITY, subauthoritycount : u8, ...) -> super::bcrypt::NTSTATUS);
...
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlIsNormalizedString(normform : u32, sourcestring : windows_sys::core::PCWSTR, sourcestringlength : i32, normalized : *mut bool) -> super::bcrypt::NTSTATUS);
windows_link::link!("ntdll.dll" "system" fn RtlIsPartialPlaceholder(fileattributes : u32, reparsetag : u32) -> bool);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlIsPartialPlaceholderFileHandle(filehandle : super::winnt::HANDLE, ispartialplaceholder : *mut bool) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn RtlIsPartialPlaceholderFileInfo(infobuffer : *const core::ffi::c_void, infoclass : super::winternl::FILE_INFORMATION_CLASS, ispartialplaceholder : *mut bool) -> super::bcrypt::NTSTATUS);
windows_link::link!("ntdll.dll" "system" fn RtlLengthRequiredSid(subauthoritycount : u32) -> u32);
#[cfg(feature = "winnt")]
windows_link::link!("ntdll.dll" "system" fn RtlLengthSid(sid : super::winnt::PSID) -> u32);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlMultiByteToUnicodeN(unicodestring : *mut u16, maxbytesinunicodestring : u32, bytesinunicodestring : *mut u32, multibytestring : *const i8, bytesinmultibytestring : u32) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlMultiByteToUnicodeSize(bytesinunicodestring : *mut u32, multibytestring : *const i8, bytesinmultibytestring : u32) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlNormalizeString(normform : u32, sourcestring : windows_sys::core::PCWSTR, sourcestringlength : i32, destinationstring : windows_sys::core::PWSTR, destinationstringlength : *mut i32) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlNtStatusToDosErrorNoTeb(status : super::bcrypt::NTSTATUS) -> u32);
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlOemStringToUnicodeString(destinationstring : *mut super::ntsecapi::UNICODE_STRING, sourcestring : *const super::ntsecapi::STRING, allocatedestinationstring : bool) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlOemToUnicodeN(unicodestring : *mut u16, maxbytesinunicodestring : u32, bytesinunicodestring : *mut u32, oemstring : *const i8, bytesinoemstring : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlPrefixString(string1 : *const super::ntsecapi::STRING, string2 : *const super::ntsecapi::STRING, caseinsensitive : bool) -> bool);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlQueryPackageIdentity(tokenobject : *const core::ffi::c_void, packagefullname : windows_sys::core::PWSTR, packagesize : *mut usize, appid : windows_sys::core::PWSTR, appidsize : *mut usize, packaged : *mut bool) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlQueryPackageIdentityEx(tokenobject : *const core::ffi::c_void, packagefullname : windows_sys::core::PWSTR, packagesize : *mut usize, appid : windows_sys::core::PWSTR, appidsize : *mut usize, dynamicid : *mut windows_sys::core::GUID, flags : *mut u64) -> super::bcrypt::NTSTATUS);
...
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlReplaceSidInSd(securitydescriptor : super::winnt::PSECURITY_DESCRIPTOR, oldsid : super::winnt::PSID, newsid : super::winnt::PSID, numchanges : *mut u32) -> super::bcrypt::NTSTATUS);
...
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlSetGroupSecurityDescriptor(securitydescriptor : super::winnt::PSECURITY_DESCRIPTOR, group : super::winnt::PSID, groupdefaulted : bool) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlSetOwnerSecurityDescriptor(securitydescriptor : super::winnt::PSECURITY_DESCRIPTOR, owner : super::winnt::PSID, ownerdefaulted : bool) -> super::bcrypt::NTSTATUS);
...
windows_link::link!("ntdll.dll" "system" fn RtlSubAuthorityCountSid(sid : super::winnt::PSID) -> super::minwindef::PUCHAR);
#[cfg(all(feature = "minwindef", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlSubAuthoritySid(sid : super::winnt::PSID, subauthority : u32) -> super::minwindef::PULONG);
windows_link::link!("ntdll.dll" "system" fn RtlTimeToSecondsSince1980(time : *const i64, elapsedseconds : *mut u32) -> bool);
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn RtlUnicodeStringToCountedOemString(destinationstring : super::winternl::POEM_STRING, sourcestring : *const super::ntsecapi::UNICODE_STRING, allocatedestinationstring : bool) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "minwindef", feature = "ntnls"))]
windows_link::link!("ntdll.dll" "system" fn RtlUnicodeToCustomCPN(customcp : *const super::ntnls::CPTABLEINFO, customcpstring : *mut i8, maxbytesincustomcpstring : u32, bytesincustomcpstring : *mut u32, unicodestring : *const u16, bytesinunicodestring : u32) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlUnicodeToMultiByteN(multibytestring : *mut i8, maxbytesinmultibytestring : u32, bytesinmultibytestring : *mut u32, unicodestring : *const u16, bytesinunicodestring : u32) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlUnicodeToOemN(oemstring : *mut i8, maxbytesinoemstring : u32, bytesinoemstring : *mut u32, unicodestring : *const u16, bytesinunicodestring : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn RtlUpcaseUnicodeStringToCountedOemString(destinationstring : super::winternl::POEM_STRING, sourcestring : *const super::ntsecapi::UNICODE_STRING, allocatedestinationstring : bool) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn RtlUpcaseUnicodeStringToOemString(destinationstring : super::winternl::POEM_STRING, sourcestring : *const super::ntsecapi::UNICODE_STRING, allocatedestinationstring : bool) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "minwindef", feature = "ntnls"))]
windows_link::link!("ntdll.dll" "system" fn RtlUpcaseUnicodeToCustomCPN(customcp : *const super::ntnls::CPTABLEINFO, customcpstring : *mut i8, maxbytesincustomcpstring : u32, bytesincustomcpstring : *mut u32, unicodestring : *const u16, bytesinunicodestring : u32) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlUpcaseUnicodeToMultiByteN(multibytestring : *mut i8, maxbytesinmultibytestring : u32, bytesinmultibytestring : *mut u32, unicodestring : *const u16, bytesinunicodestring : u32) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlUpcaseUnicodeToOemN(oemstring : *mut i8, maxbytesinoemstring : u32, bytesinoemstring : *mut u32, unicodestring : *const u16, bytesinunicodestring : u32) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "winnt")]
windows_link::link!("ntdll.dll" "system" fn RtlValidSid(sid : super::winnt::PSID) -> bool);
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi"))]
windows_link::link!("ntdll.dll" "system" fn RtlValidateUnicodeString(flags : u32, string : *const super::ntsecapi::UNICODE_STRING) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlxOemStringToUnicodeSize(oemstring : *const super::ntsecapi::STRING) -> u32);
#[cfg(all(feature = "lsalookup", feature = "ntsecapi"))]
windows_link::link!("ntdll.dll" "system" fn RtlxUnicodeStringToOemSize(unicodestring : *const super::ntsecapi::UNICODE_STRING) -> u32);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwAllocateVirtualMemory(processhandle : super::winnt::HANDLE, baseaddress : *mut *mut core::ffi::c_void, zerobits : usize, regionsize : *mut usize, allocationtype : u32, protect : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwAllocateVirtualMemoryEx(processhandle : super::winnt::HANDLE, baseaddress : *mut *mut core::ffi::c_void, regionsize : *mut usize, allocationtype : u32, pageprotection : u32, extendedparameters : *mut super::winnt::MEM_EXTENDED_PARAMETER, extendedparametercount : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "d3dkmthk", feature = "lsalookup", feature = "ntdef", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwCreateEvent(eventhandle : *mut super::winnt::HANDLE, desiredaccess : super::winnt::ACCESS_MASK, objectattributes : *const super::d3dkmthk::OBJECT_ATTRIBUTES, eventtype : super::ntdef::EVENT_TYPE, initialstate : bool) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "d3dkmthk", feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwDeleteFile(objectattributes : *const super::d3dkmthk::OBJECT_ATTRIBUTES) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwDuplicateObject(sourceprocesshandle : super::winnt::HANDLE, sourcehandle : super::winnt::HANDLE, targetprocesshandle : super::winnt::HANDLE, targethandle : *mut super::winnt::HANDLE, desiredaccess : super::winnt::ACCESS_MASK, handleattributes : u32, options : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "d3dkmthk", feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwDuplicateToken(existingtokenhandle : super::winnt::HANDLE, desiredaccess : super::winnt::ACCESS_MASK, objectattributes : *const super::d3dkmthk::OBJECT_ATTRIBUTES, effectiveonly : bool, tokentype : super::winnt::TOKEN_TYPE, newtokenhandle : *mut super::winnt::HANDLE) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "C" fn ZwFlushBuffersFile(filehandle : super::winnt::HANDLE, iostatusblock : *mut super::winternl::IO_STATUS_BLOCK) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "C" fn ZwFlushBuffersFileEx(filehandle : super::winnt::HANDLE, flags : u32, parameters : *const core::ffi::c_void, parameterssize : u32, iostatusblock : *mut super::winternl::IO_STATUS_BLOCK) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn ZwFlushVirtualMemory(processhandle : super::winnt::HANDLE, baseaddress : *mut *mut core::ffi::c_void, regionsize : *mut usize, iostatus : *mut super::winternl::IO_STATUS_BLOCK) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwFreeVirtualMemory(processhandle : super::winnt::HANDLE, baseaddress : *mut *mut core::ffi::c_void, regionsize : *mut usize, freetype : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
...
#[cfg(all(feature = "bcrypt", feature = "d3dkmthk", feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwOpenDirectoryObject(directoryhandle : *mut super::winnt::HANDLE, desiredaccess : super::winnt::ACCESS_MASK, objectattributes : *const super::d3dkmthk::OBJECT_ATTRIBUTES) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwOpenProcessTokenEx(processhandle : super::winnt::HANDLE, desiredaccess : super::winnt::ACCESS_MASK, handleattributes : u32, tokenhandle : *mut super::winnt::HANDLE) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwOpenThreadTokenEx(threadhandle : super::winnt::HANDLE, desiredaccess : super::winnt::ACCESS_MASK, openasself : bool, handleattributes : u32, tokenhandle : *mut super::winnt::HANDLE) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi", feature = "winnt", feature = "winternl"))]
...
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "C" fn ZwQueryEaFile(filehandle : super::winnt::HANDLE, iostatusblock : *mut super::winternl::IO_STATUS_BLOCK, buffer : *mut core::ffi::c_void, length : u32, returnsingleentry : bool, ealist : *const core::ffi::c_void, ealistlength : u32, eaindex : *const u32, restartscan : bool) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwQueryInformationToken(tokenhandle : super::winnt::HANDLE, tokeninformationclass : super::winnt::TOKEN_INFORMATION_CLASS, tokeninformation : *mut core::ffi::c_void, tokeninformationlength : u32, returnlength : *mut u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn ZwQueryObject(handle : super::winnt::HANDLE, objectinformationclass : super::winternl::OBJECT_INFORMATION_CLASS, objectinformation : *mut core::ffi::c_void, objectinformationlength : u32, returnlength : *mut u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn ZwQueryQuotaInformationFile(filehandle : super::winnt::HANDLE, iostatusblock : *mut super::winternl::IO_STATUS_BLOCK, buffer : *mut core::ffi::c_void, length : u32, returnsingleentry : bool, sidlist : *const core::ffi::c_void, sidlistlength : u32, startsid : super::winnt::PSID, restartscan : bool) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwQuerySecurityObject(handle : super::winnt::HANDLE, securityinformation : super::winnt::SECURITY_INFORMATION, securitydescriptor : super::winnt::PSECURITY_DESCRIPTOR, length : u32, lengthneeded : *mut u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwQueryVirtualMemory(processhandle : super::winnt::HANDLE, baseaddress : *const core::ffi::c_void, memoryinformationclass : MEMORY_INFORMATION_CLASS, memoryinformation : *mut core::ffi::c_void, memoryinformationlength : usize, returnlength : *mut usize) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "C" fn ZwSetEaFile(filehandle : super::winnt::HANDLE, iostatusblock : *mut super::winternl::IO_STATUS_BLOCK, buffer : *const core::ffi::c_void, length : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwSetEvent(eventhandle : super::winnt::HANDLE, previousstate : *mut i32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwSetInformationToken(tokenhandle : super::winnt::HANDLE, tokeninformationclass : super::winnt::TOKEN_INFORMATION_CLASS, tokeninformation : *const core::ffi::c_void, tokeninformationlength : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwSetInformationVirtualMemory(processhandle : super::winnt::HANDLE, vminformationclass : VIRTUAL_MEMORY_INFORMATION_CLASS, numberofentries : usize, virtualaddresses : *const MEMORY_RANGE_ENTRY, vminformation : *const core::ffi::c_void, vminformationlength : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn ZwSetQuotaInformationFile(filehandle : super::winnt::HANDLE, iostatusblock : *mut super::winternl::IO_STATUS_BLOCK, buffer : *const core::ffi::c_void, length : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwSetSecurityObject(handle : super::winnt::HANDLE, securityinformation : super::winnt::SECURITY_INFORMATION, securitydescriptor : super::winnt::PSECURITY_DESCRIPTOR) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "wdm", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn ZwSetVolumeInformationFile(filehandle : super::winnt::HANDLE, iostatusblock : *mut super::winternl::IO_STATUS_BLOCK, fsinformation : *const core::ffi::c_void, length : u32, fsinformationclass : super::wdm::FS_INFORMATION_CLASS) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn ZwUnlockFile(filehandle : super::winnt::HANDLE, iostatusblock : *mut super::winternl::IO_STATUS_BLOCK, byteoffset : *const i64, length : *const i64, key : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwWaitForSingleObject(handle : super::winnt::HANDLE, alertable : bool, timeout : *const i64) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
