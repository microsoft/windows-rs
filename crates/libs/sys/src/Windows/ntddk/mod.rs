...
windows_link::link!("ntdll.dll" "system" fn NtOpenProcess(processhandle : *mut super::winnt::HANDLE, desiredaccess : super::winnt::ACCESS_MASK, objectattributes : *const super::d3dkmthk::OBJECT_ATTRIBUTES, clientid : *const super::winternl::CLIENT_ID) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlCompareString(string1 : *const super::ntsecapi::STRING, string2 : *const super::ntsecapi::STRING, caseinsensitive : bool) -> i32);
windows_link::link!("ntdll.dll" "system" fn RtlContractHashTable(hashtable : *const RTL_DYNAMIC_HASH_TABLE) -> bool);
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlCopyString(destinationstring : *mut super::ntsecapi::STRING, sourcestring : *const super::ntsecapi::STRING));
...
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlEqualString(string1 : *const super::ntsecapi::STRING, string2 : *const super::ntsecapi::STRING, caseinsensitive : bool) -> bool);
...
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlGetPersistedStateLocation(sourceid : windows_sys::core::PCWSTR, customvalue : windows_sys::core::PCWSTR, defaultpath : windows_sys::core::PCWSTR, statelocationtype : STATE_LOCATION_TYPE, targetpath : *mut u16, bufferlengthin : u32, bufferlengthout : *mut u32) -> super::bcrypt::NTSTATUS);
...
#[cfg(feature = "bcrypt")]
windows_link::link!("ntdll.dll" "system" fn RtlIsApiSetImplemented(apisetname : windows_sys::core::PCSTR) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "ntdef", feature = "winnt"))]
...
#[cfg(feature = "winnt")]
windows_link::link!("ntdll.dll" "system" fn RtlMapGenericMask(accessmask : *mut super::winnt::ACCESS_MASK, genericmapping : *const super::winnt::GENERIC_MAPPING));
#[cfg(all(feature = "ntdef", feature = "winnt"))]
...
windows_link::link!("ntdll.dll" "system" fn RtlPrefixUnicodeString(string1 : *const super::ntsecapi::UNICODE_STRING, string2 : *const super::ntsecapi::UNICODE_STRING, caseinsensitive : bool) -> bool);
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlQueryRegistryValueWithFallback(primaryhandle : super::winnt::HANDLE, fallbackhandle : super::winnt::HANDLE, valuename : *const super::ntsecapi::UNICODE_STRING, valuelength : u32, valuetype : *mut u32, valuedata : *mut core::ffi::c_void, resultlength : *mut u32) -> super::bcrypt::NTSTATUS);
...
windows_link::link!("ntdll.dll" "system" fn RtlRunOnceBeginInitialize(runonce : *mut super::winnt::RTL_RUN_ONCE, flags : u32, context : *mut *mut core::ffi::c_void) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlRunOnceComplete(runonce : *mut super::winnt::RTL_RUN_ONCE, flags : u32, context : *const core::ffi::c_void) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlRunOnceExecuteOnce(runonce : *mut super::winnt::RTL_RUN_ONCE, initfn : PRTL_RUN_ONCE_INIT_FN, parameter : *mut core::ffi::c_void, context : *mut *mut core::ffi::c_void) -> super::bcrypt::NTSTATUS);
#[cfg(feature = "winnt")]
windows_link::link!("ntdll.dll" "system" fn RtlRunOnceInitialize(runonce : *mut super::winnt::RTL_RUN_ONCE));
...
windows_link::link!("ntdll.dll" "system" fn RtlUpcaseUnicodeString(destinationstring : *mut super::ntsecapi::UNICODE_STRING, sourcestring : *const super::ntsecapi::UNICODE_STRING, allocatedestinationstring : bool) -> super::bcrypt::NTSTATUS);
windows_link::link!("ntdll.dll" "system" fn RtlUpperChar(character : i8) -> i8);
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn RtlUpperString(destinationstring : *mut super::ntsecapi::STRING, sourcestring : *const super::ntsecapi::STRING));
...
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwAllocateLocallyUniqueId(luid : *mut super::winnt::LUID) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "C" fn ZwCancelTimer(timerhandle : super::winnt::HANDLE, currentstate : *mut bool) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "d3dkmthk", feature = "lsalookup", feature = "ntdef", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "C" fn ZwCreateTimer(timerhandle : *mut super::winnt::HANDLE, desiredaccess : super::winnt::ACCESS_MASK, objectattributes : *const super::d3dkmthk::OBJECT_ATTRIBUTES, timertype : super::ntdef::TIMER_TYPE) -> super::bcrypt::NTSTATUS);
...
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "ntsecapi"))]
windows_link::link!("ntdll.dll" "system" fn ZwDisplayString(string : *const super::ntsecapi::UNICODE_STRING) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "d3dkmthk", feature = "lsalookup", feature = "ntsecapi", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn ZwOpenProcess(processhandle : *mut super::winnt::HANDLE, desiredaccess : super::winnt::ACCESS_MASK, objectattributes : *const super::d3dkmthk::OBJECT_ATTRIBUTES, clientid : *const super::winternl::CLIENT_ID) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "d3dkmthk", feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
windows_link::link!("ntdll.dll" "C" fn ZwOpenTimer(timerhandle : *mut super::winnt::HANDLE, desiredaccess : super::winnt::ACCESS_MASK, objectattributes : *const super::d3dkmthk::OBJECT_ATTRIBUTES) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwPowerInformation(informationlevel : super::winnt::POWER_INFORMATION_LEVEL, inputbuffer : *const core::ffi::c_void, inputbufferlength : u32, outputbuffer : *mut core::ffi::c_void, outputbufferlength : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "wdm", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn ZwQueryVolumeInformationFile(filehandle : super::winnt::HANDLE, iostatusblock : *mut super::winternl::IO_STATUS_BLOCK, fsinformation : *mut core::ffi::c_void, length : u32, fsinformationclass : super::wdm::FS_INFORMATION_CLASS) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt", feature = "winternl"))]
windows_link::link!("ntdll.dll" "system" fn ZwSetInformationThread(threadhandle : super::winnt::HANDLE, threadinformationclass : super::winternl::THREADINFOCLASS, threadinformation : *const core::ffi::c_void, threadinformationlength : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "C" fn ZwSetTimer(timerhandle : super::winnt::HANDLE, duetime : *const i64, timerapcroutine : PTIMER_APC_ROUTINE, timercontext : *const core::ffi::c_void, resumetimer : bool, period : i32, previousstate : *mut bool) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "C" fn ZwSetTimerEx(timerhandle : super::winnt::HANDLE, timersetinformationclass : TIMER_SET_INFORMATION_CLASS, timersetinformation : *mut core::ffi::c_void, timersetinformationlength : u32) -> super::bcrypt::NTSTATUS);
#[cfg(all(feature = "bcrypt", feature = "winnt"))]
windows_link::link!("ntdll.dll" "system" fn ZwTerminateProcess(processhandle : super::winnt::HANDLE, exitstatus : super::bcrypt::NTSTATUS) -> super::bcrypt::NTSTATUS);
#[repr(C)]
#[derive(Clone, Copy)]
...
#[cfg(feature = "bcrypt")]
pub type pHalInvokePrmFwHandler = Option<unsafe extern "system" fn(handlerguid: *const windows_sys::core::GUID, parameterbuffer: *const core::ffi::c_void, contextbuffer: *const core::ffi::c_void) -> super::bcrypt::NTSTATUS>;
#[cfg(all(feature = "basetsd", feature = "bcrypt", feature = "lsalookup", feature = "ntdef", feature = "ntifs", feature = "ntsecapi", feature = "usb", feature = "wdm", feature = "winnt", feature = "winternl"))]
