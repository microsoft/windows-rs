...
#[cfg(all(feature = "Win32_winnt", feature = "Win32_wlantypes"))]
windows_link::link!("wlanapi.dll" "system" fn WlanScan(hclienthandle : super::winnt::HANDLE, pinterfaceguid : *const windows_sys::core::GUID, pdot11ssid : *const super::wlantypes::DOT11_SSID, piedata : *const WLAN_RAW_DATA, preserved : *const core::ffi::c_void) -> u32);
#[cfg(feature = "Win32_winnt")]
