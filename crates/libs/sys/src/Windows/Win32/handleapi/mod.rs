...
windows_link::link!("kernel32.dll" "system" fn DuplicateHandle(hsourceprocesshandle : super::HANDLE, hsourcehandle : super::HANDLE, htargetprocesshandle : super::HANDLE, lptargethandle : super::LPHANDLE, dwdesiredaccess : u32, binherithandle : windows_sys::core::BOOL, dwoptions : u32) -> windows_sys::core::BOOL);
#[cfg(all(feature = "minwindef", feature = "winnt"))]
windows_link::link!("kernel32.dll" "system" fn GetHandleInformation(hobject : super::HANDLE, lpdwflags : super::LPDWORD) -> windows_sys::core::BOOL);
#[cfg(feature = "winnt")]
