...
windows_link::link!("kernel32.dll" "system" fn CompareStringEx(lplocalename : windows_sys::core::PCWSTR, dwcmpflags : u32, lpstring1 : *const u16, cchcount1 : i32, lpstring2 : *const u16, cchcount2 : i32, lpversioninformation : *const super::winnls::NLSVERSIONINFO, lpreserved : *const core::ffi::c_void, lparam : super::minwindef::LPARAM) -> i32);
...
windows_link::link!("kernel32.dll" "system" fn CompareStringW(locale : super::winnt::LCID, dwcmpflags : u32, lpstring1 : *const u16, cchcount1 : i32, lpstring2 : *const u16, cchcount2 : i32) -> i32);
...
#[cfg(feature = "Win32_winnt")]
windows_link::link!("kernel32.dll" "system" fn GetStringTypeExW(locale : super::winnt::LCID, dwinfotype : u32, lpsrcstr : *const u16, cchsrc : i32, lpchartype : *mut u16) -> windows_sys::core::BOOL);
