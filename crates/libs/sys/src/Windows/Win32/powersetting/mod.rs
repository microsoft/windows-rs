...
#[cfg(feature = "minwindef")]
windows_link::link!("powrprof.dll" "system" fn PowerReadACValue(rootpowerkey : super::HKEY, schemeguid : *const windows_sys::core::GUID, subgroupofpowersettingsguid : *const windows_sys::core::GUID, powersettingguid : *const windows_sys::core::GUID, r#type : super::PULONG, buffer : super::LPBYTE, buffersize : super::LPDWORD) -> u32);
#[cfg(feature = "minwindef")]
windows_link::link!("powrprof.dll" "system" fn PowerReadDCValue(rootpowerkey : super::HKEY, schemeguid : *const windows_sys::core::GUID, subgroupofpowersettingsguid : *const windows_sys::core::GUID, powersettingguid : *const windows_sys::core::GUID, r#type : super::PULONG, buffer : super::PUCHAR, buffersize : super::LPDWORD) -> u32);
...
#[cfg(all(feature = "guiddef", feature = "winnt", feature = "winuser"))]
windows_link::link!("powrprof.dll" "system" fn PowerSettingRegisterNotification(settingguid : super::LPCGUID, flags : u32, recipient : super::HANDLE, registrationhandle : super::PHPOWERNOTIFY) -> u32);
#[cfg(feature = "winuser")]
