::windows_sys::core::windows_link ! ( "api-ms-win-devices-query-l1-1-0.dll" ,"system" fn DevCloseObjectQuery ( hdevquery : *const HDEVQUERY__ ) -> ( ) );
...
#[cfg(feature = "Win32_Devices_Properties")]
::windows_sys::core::windows_link ! ( "api-ms-win-devices-query-l1-1-0.dll" ,"system" fn DevFindProperty ( pkey : *const super::Properties:: DEVPROPKEY , store : super::Properties:: DEVPROPSTORE , pszlocalename : :: windows_sys::core::PCWSTR , cproperties : u32 , pproperties : *const super::Properties:: DEVPROPERTY ) -> *mut super::Properties:: DEVPROPERTY );
#[cfg(feature = "Win32_Devices_Properties")]
::windows_sys::core::windows_link ! ( "api-ms-win-devices-query-l1-1-0.dll" ,"system" fn DevFreeObjectProperties ( cpropertycount : u32 , pproperties : *const super::Properties:: DEVPROPERTY ) -> ( ) );
#[cfg(feature = "Win32_Devices_Properties")]
::windows_sys::core::windows_link ! ( "api-ms-win-devices-query-l1-1-0.dll" ,"system" fn DevFreeObjects ( cobjectcount : u32 , pobjects : *const DEV_OBJECT ) -> ( ) );
#[cfg(feature = "Win32_Devices_Properties")]
