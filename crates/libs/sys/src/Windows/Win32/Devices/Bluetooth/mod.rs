pub type BluetoothAuthenticateDevice = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, hradio: super::super::Foundation::HANDLE, pbtbi: *mut BLUETOOTH_DEVICE_INFO, pszpasskey: windows_sys::core::PCWSTR, ulpasskeylength: u32) -> u32;
...
pub type BluetoothAuthenticateDeviceEx = unsafe extern "system" fn(hwndparentin: super::super::Foundation::HWND, hradioin: super::super::Foundation::HANDLE, pbtdiinout: *mut BLUETOOTH_DEVICE_INFO, pbtoobdata: *const BLUETOOTH_OOB_DATA_INFO, authenticationrequirement: AUTHENTICATION_REQUIREMENTS) -> u32;
...
pub type BluetoothAuthenticateMultipleDevices = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, hradio: super::super::Foundation::HANDLE, cdevices: u32, rgbtdi: *mut BLUETOOTH_DEVICE_INFO) -> u32;
...
pub type BluetoothDisplayDeviceProperties = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, pbtdi: *mut BLUETOOTH_DEVICE_INFO) -> windows_sys::core::BOOL;
...
pub type BluetoothEnableDiscovery = unsafe extern "system" fn(hradio: super::super::Foundation::HANDLE, fenabled: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type BluetoothEnableIncomingConnections = unsafe extern "system" fn(hradio: super::super::Foundation::HANDLE, fenabled: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type BluetoothEnumerateInstalledServices = unsafe extern "system" fn(hradio: super::super::Foundation::HANDLE, pbtdi: *const BLUETOOTH_DEVICE_INFO, pcserviceinout: *mut u32, pguidservices: *mut windows_sys::core::GUID) -> u32;
...
pub type BluetoothFindDeviceClose = unsafe extern "system" fn(hfind: HBLUETOOTH_DEVICE_FIND) -> windows_sys::core::BOOL;
...
pub type BluetoothFindFirstDevice = unsafe extern "system" fn(pbtsp: *const BLUETOOTH_DEVICE_SEARCH_PARAMS, pbtdi: *mut BLUETOOTH_DEVICE_INFO) -> HBLUETOOTH_DEVICE_FIND;
...
pub type BluetoothFindFirstRadio = unsafe extern "system" fn(pbtfrp: *const BLUETOOTH_FIND_RADIO_PARAMS, phradio: *mut super::super::Foundation::HANDLE) -> HBLUETOOTH_RADIO_FIND;
...
pub type BluetoothFindNextDevice = unsafe extern "system" fn(hfind: HBLUETOOTH_DEVICE_FIND, pbtdi: *mut BLUETOOTH_DEVICE_INFO) -> windows_sys::core::BOOL;
...
pub type BluetoothFindNextRadio = unsafe extern "system" fn(hfind: HBLUETOOTH_RADIO_FIND, phradio: *mut super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
...
pub type BluetoothFindRadioClose = unsafe extern "system" fn(hfind: HBLUETOOTH_RADIO_FIND) -> windows_sys::core::BOOL;
windows_link::link!("bluetoothapis.dll" "system" fn BluetoothFindRadioClose(hfind : HBLUETOOTH_RADIO_FIND) -> windows_sys::core::BOOL);
pub type BluetoothGATTAbortReliableWrite = unsafe extern "system" fn(hdevice: super::super::Foundation::HANDLE, reliablewritecontext: u64, flags: u32) -> windows_sys::core::HRESULT;
...
pub type BluetoothGATTBeginReliableWrite = unsafe extern "system" fn(hdevice: super::super::Foundation::HANDLE, reliablewritecontext: *mut u64, flags: u32) -> windows_sys::core::HRESULT;
...
pub type BluetoothGATTEndReliableWrite = unsafe extern "system" fn(hdevice: super::super::Foundation::HANDLE, reliablewritecontext: u64, flags: u32) -> windows_sys::core::HRESULT;
...
pub type BluetoothGATTGetCharacteristics = unsafe extern "system" fn(hdevice: super::super::Foundation::HANDLE, service: *const BTH_LE_GATT_SERVICE, characteristicsbuffercount: u16, characteristicsbuffer: *mut BTH_LE_GATT_CHARACTERISTIC, characteristicsbufferactual: *mut u16, flags: u32) -> windows_sys::core::HRESULT;
...
pub type BluetoothGATTGetDescriptorValue = unsafe extern "system" fn(hdevice: super::super::Foundation::HANDLE, descriptor: *const BTH_LE_GATT_DESCRIPTOR, descriptorvaluedatasize: u32, descriptorvalue: *mut BTH_LE_GATT_DESCRIPTOR_VALUE, descriptorvaluesizerequired: *mut u16, flags: u32) -> windows_sys::core::HRESULT;
...
pub type BluetoothGATTGetDescriptors = unsafe extern "system" fn(hdevice: super::super::Foundation::HANDLE, characteristic: *const BTH_LE_GATT_CHARACTERISTIC, descriptorsbuffercount: u16, descriptorsbuffer: *mut BTH_LE_GATT_DESCRIPTOR, descriptorsbufferactual: *mut u16, flags: u32) -> windows_sys::core::HRESULT;
...
pub type BluetoothGATTGetIncludedServices = unsafe extern "system" fn(hdevice: super::super::Foundation::HANDLE, parentservice: *const BTH_LE_GATT_SERVICE, includedservicesbuffercount: u16, includedservicesbuffer: *mut BTH_LE_GATT_SERVICE, includedservicesbufferactual: *mut u16, flags: u32) -> windows_sys::core::HRESULT;
...
pub type BluetoothGATTGetServices = unsafe extern "system" fn(hdevice: super::super::Foundation::HANDLE, servicesbuffercount: u16, servicesbuffer: *mut BTH_LE_GATT_SERVICE, servicesbufferactual: *mut u16, flags: u32) -> windows_sys::core::HRESULT;
...
pub type BluetoothGATTRegisterEvent = unsafe extern "system" fn(hservice: super::super::Foundation::HANDLE, eventtype: BTH_LE_GATT_EVENT_TYPE, eventparameterin: *const core::ffi::c_void, callback: PFNBLUETOOTH_GATT_EVENT_CALLBACK, callbackcontext: *const core::ffi::c_void, peventhandle: *mut isize, flags: u32) -> windows_sys::core::HRESULT;
...
pub type BluetoothGATTSetCharacteristicValue = unsafe extern "system" fn(hdevice: super::super::Foundation::HANDLE, characteristic: *const BTH_LE_GATT_CHARACTERISTIC, characteristicvalue: *const BTH_LE_GATT_CHARACTERISTIC_VALUE, reliablewritecontext: u64, flags: u32) -> windows_sys::core::HRESULT;
...
pub type BluetoothGATTSetDescriptorValue = unsafe extern "system" fn(hdevice: super::super::Foundation::HANDLE, descriptor: *const BTH_LE_GATT_DESCRIPTOR, descriptorvalue: *const BTH_LE_GATT_DESCRIPTOR_VALUE, flags: u32) -> windows_sys::core::HRESULT;
...
pub type BluetoothGATTUnregisterEvent = unsafe extern "system" fn(eventhandle: isize, flags: u32) -> windows_sys::core::HRESULT;
...
pub type BluetoothGetDeviceInfo = unsafe extern "system" fn(hradio: super::super::Foundation::HANDLE, pbtdi: *mut BLUETOOTH_DEVICE_INFO) -> u32;
...
pub type BluetoothGetRadioInfo = unsafe extern "system" fn(hradio: super::super::Foundation::HANDLE, pradioinfo: *mut BLUETOOTH_RADIO_INFO) -> u32;
...
pub type BluetoothIsConnectable = unsafe extern "system" fn(hradio: super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
...
pub type BluetoothIsDiscoverable = unsafe extern "system" fn(hradio: super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
...
pub type BluetoothIsVersionAvailable = unsafe extern "system" fn(majorversion: u8, minorversion: u8) -> windows_sys::core::BOOL;
...
pub type BluetoothRegisterForAuthentication = unsafe extern "system" fn(pbtdi: *const BLUETOOTH_DEVICE_INFO, phreghandle: *mut isize, pfncallback: PFN_AUTHENTICATION_CALLBACK, pvparam: *const core::ffi::c_void) -> u32;
...
pub type BluetoothRegisterForAuthenticationEx = unsafe extern "system" fn(pbtdiin: *const BLUETOOTH_DEVICE_INFO, phreghandleout: *mut isize, pfncallbackin: PFN_AUTHENTICATION_CALLBACK_EX, pvparam: *const core::ffi::c_void) -> u32;
...
pub type BluetoothRemoveDevice = unsafe extern "system" fn(paddress: *const BLUETOOTH_ADDRESS) -> u32;
windows_link::link!("bluetoothapis.dll" "system" fn BluetoothRemoveDevice(paddress : *const BLUETOOTH_ADDRESS) -> u32);
pub type BluetoothSdpEnumAttributes = unsafe extern "system" fn(psdpstream: *const u8, cbstreamsize: u32, pfncallback: PFN_BLUETOOTH_ENUM_ATTRIBUTES_CALLBACK, pvparam: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type BluetoothSdpGetAttributeValue = unsafe extern "system" fn(precordstream: *const u8, cbrecordlength: u32, usattributeid: u16, pattributedata: *mut SDP_ELEMENT_DATA) -> u32;
...
pub type BluetoothSdpGetContainerElementData = unsafe extern "system" fn(pcontainerstream: *const u8, cbcontainerlength: u32, pelement: *mut isize, pdata: *mut SDP_ELEMENT_DATA) -> u32;
...
pub type BluetoothSdpGetElementData = unsafe extern "system" fn(psdpstream: *const u8, cbsdpstreamlength: u32, pdata: *mut SDP_ELEMENT_DATA) -> u32;
...
pub type BluetoothSdpGetString = unsafe extern "system" fn(precordstream: *const u8, cbrecordlength: u32, pstringdata: *const SDP_STRING_TYPE_DATA, usstringoffset: u16, pszstring: windows_sys::core::PWSTR, pcchstringlength: *mut u32) -> u32;
...
pub type BluetoothSelectDevices = unsafe extern "system" fn(pbtsdp: *mut BLUETOOTH_SELECT_DEVICE_PARAMS) -> windows_sys::core::BOOL;
...
pub type BluetoothSelectDevicesFree = unsafe extern "system" fn(pbtsdp: *mut BLUETOOTH_SELECT_DEVICE_PARAMS) -> windows_sys::core::BOOL;
...
pub type BluetoothSendAuthenticationResponse = unsafe extern "system" fn(hradio: super::super::Foundation::HANDLE, pbtdi: *const BLUETOOTH_DEVICE_INFO, pszpasskey: windows_sys::core::PCWSTR) -> u32;
...
pub type BluetoothSendAuthenticationResponseEx = unsafe extern "system" fn(hradioin: super::super::Foundation::HANDLE, pauthresponse: *const BLUETOOTH_AUTHENTICATE_RESPONSE) -> u32;
...
pub type BluetoothSetLocalServiceInfo = unsafe extern "system" fn(hradioin: super::super::Foundation::HANDLE, pclassguid: *const windows_sys::core::GUID, ulinstance: u32, pserviceinfoin: *const BLUETOOTH_LOCAL_SERVICE_INFO) -> u32;
...
pub type BluetoothSetServiceState = unsafe extern "system" fn(hradio: super::super::Foundation::HANDLE, pbtdi: *const BLUETOOTH_DEVICE_INFO, pguidservice: *const windows_sys::core::GUID, dwserviceflags: u32) -> u32;
...
pub type BluetoothUnregisterAuthentication = unsafe extern "system" fn(hreghandle: isize) -> windows_sys::core::BOOL;
windows_link::link!("bluetoothapis.dll" "system" fn BluetoothUnregisterAuthentication(hreghandle : isize) -> windows_sys::core::BOOL);
pub type BluetoothUpdateDeviceRecord = unsafe extern "system" fn(pbtdi: *const BLUETOOTH_DEVICE_INFO) -> u32;
