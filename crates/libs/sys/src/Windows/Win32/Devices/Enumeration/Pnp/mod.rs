...
windows_link::link!("cfgmgr32.dll" "system" fn SwDeviceCreate(pszenumeratorname : windows_sys::core::PCWSTR, pszparentdeviceinstance : windows_sys::core::PCWSTR, pcreateinfo : *mut SW_DEVICE_CREATE_INFO, cpropertycount : u32, pproperties : *mut super::super::Properties:: DEVPROPERTY, pcallback : SW_DEVICE_CREATE_CALLBACK, pcontext : *mut core::ffi::c_void, phswdevice : *mut HSWDEVICE) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("cfgmgr32.dll" "system" fn SwDeviceInterfaceRegister(hswdevice : HSWDEVICE, pinterfaceclassguid : *mut windows_sys::core::GUID, pszreferencestring : windows_sys::core::PCWSTR, cpropertycount : u32, pproperties : *mut super::super::Properties:: DEVPROPERTY, fenabled : windows_sys::core::BOOL, ppszdeviceinterfaceid : *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT);
...
windows_link::link!("cfgmgr32.dll" "system" fn SwMemFree(pmem : *mut core::ffi::c_void));
