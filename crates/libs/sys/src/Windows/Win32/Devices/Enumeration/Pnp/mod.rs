...
pub const UPNP_E_ACTION_REQUEST_FAILED: ::windows_sys::core::HRESULT = 0x80040210u32 as _;
pub const UPNP_E_ACTION_SPECIFIC_BASE: ::windows_sys::core::HRESULT = 0x80040300u32 as _;
pub const UPNP_E_DEVICE_ELEMENT_EXPECTED: ::windows_sys::core::HRESULT = 0x80040201u32 as _;
pub const UPNP_E_DEVICE_ERROR: ::windows_sys::core::HRESULT = 0x80040214u32 as _;
pub const UPNP_E_DEVICE_NODE_INCOMPLETE: ::windows_sys::core::HRESULT = 0x80040204u32 as _;
pub const UPNP_E_DEVICE_NOTREGISTERED: ::windows_sys::core::HRESULT = 0x8004A032u32 as _;
pub const UPNP_E_DEVICE_RUNNING: ::windows_sys::core::HRESULT = 0x8004A031u32 as _;
pub const UPNP_E_DEVICE_TIMEOUT: ::windows_sys::core::HRESULT = 0x80040217u32 as _;
pub const UPNP_E_DUPLICATE_NOT_ALLOWED: ::windows_sys::core::HRESULT = 0x8004A021u32 as _;
pub const UPNP_E_DUPLICATE_SERVICE_ID: ::windows_sys::core::HRESULT = 0x8004A022u32 as _;
pub const UPNP_E_ERROR_PROCESSING_RESPONSE: ::windows_sys::core::HRESULT = 0x80040216u32 as _;
pub const UPNP_E_EVENT_SUBSCRIPTION_FAILED: ::windows_sys::core::HRESULT = 0x80040501u32 as _;
pub const UPNP_E_ICON_ELEMENT_EXPECTED: ::windows_sys::core::HRESULT = 0x80040205u32 as _;
pub const UPNP_E_ICON_NODE_INCOMPLETE: ::windows_sys::core::HRESULT = 0x80040206u32 as _;
pub const UPNP_E_INVALID_ACTION: ::windows_sys::core::HRESULT = 0x80040207u32 as _;
pub const UPNP_E_INVALID_ARGUMENTS: ::windows_sys::core::HRESULT = 0x80040208u32 as _;
pub const UPNP_E_INVALID_DESCRIPTION: ::windows_sys::core::HRESULT = 0x8004A023u32 as _;
pub const UPNP_E_INVALID_DOCUMENT: ::windows_sys::core::HRESULT = 0x80040500u32 as _;
pub const UPNP_E_INVALID_ICON: ::windows_sys::core::HRESULT = 0x8004A025u32 as _;
pub const UPNP_E_INVALID_ROOT_NAMESPACE: ::windows_sys::core::HRESULT = 0x8004A027u32 as _;
pub const UPNP_E_INVALID_SERVICE: ::windows_sys::core::HRESULT = 0x8004A024u32 as _;
pub const UPNP_E_INVALID_VARIABLE: ::windows_sys::core::HRESULT = 0x80040213u32 as _;
pub const UPNP_E_INVALID_XML: ::windows_sys::core::HRESULT = 0x8004A026u32 as _;
pub const UPNP_E_OUT_OF_SYNC: ::windows_sys::core::HRESULT = 0x80040209u32 as _;
pub const UPNP_E_PROTOCOL_ERROR: ::windows_sys::core::HRESULT = 0x80040215u32 as _;
pub const UPNP_E_REQUIRED_ELEMENT_ERROR: ::windows_sys::core::HRESULT = 0x8004A020u32 as _;
pub const UPNP_E_ROOT_ELEMENT_EXPECTED: ::windows_sys::core::HRESULT = 0x80040200u32 as _;
pub const UPNP_E_SERVICE_ELEMENT_EXPECTED: ::windows_sys::core::HRESULT = 0x80040202u32 as _;
pub const UPNP_E_SERVICE_NODE_INCOMPLETE: ::windows_sys::core::HRESULT = 0x80040203u32 as _;
pub const UPNP_E_SUFFIX_TOO_LONG: ::windows_sys::core::HRESULT = 0x8004A028u32 as _;
pub const UPNP_E_TRANSPORT_ERROR: ::windows_sys::core::HRESULT = 0x80040211u32 as _;
pub const UPNP_E_URLBASE_PRESENT: ::windows_sys::core::HRESULT = 0x8004A029u32 as _;
pub const UPNP_E_VALUE_TOO_LONG: ::windows_sys::core::HRESULT = 0x8004A030u32 as _;
pub const UPNP_E_VARIABLE_VALUE_UNKNOWN: ::windows_sys::core::HRESULT = 0x80040212u32 as _;
