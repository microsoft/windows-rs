pub type SwDeviceClose = unsafe extern "system" fn(hswdevice: HSWDEVICE);
...
pub type SwDeviceCreate = unsafe extern "system" fn(pszenumeratorname: windows_sys::core::PCWSTR, pszparentdeviceinstance: windows_sys::core::PCWSTR, pcreateinfo: *const SW_DEVICE_CREATE_INFO, cpropertycount: u32, pproperties: *const super::super::Properties::DEVPROPERTY, pcallback: SW_DEVICE_CREATE_CALLBACK, pcontext: *const core::ffi::c_void, phswdevice: *mut HSWDEVICE) -> windows_sys::core::HRESULT;
#[cfg(all(feature = "Win32_Devices_Properties", feature = "Win32_Security"))]
windows_link::link!("cfgmgr32.dll" "system" fn SwDeviceCreate(pszenumeratorname : windows_sys::core::PCWSTR, pszparentdeviceinstance : windows_sys::core::PCWSTR, pcreateinfo : *const SW_DEVICE_CREATE_INFO, cpropertycount : u32, pproperties : *const super::super::Properties::DEVPROPERTY, pcallback : SW_DEVICE_CREATE_CALLBACK, pcontext : *const core::ffi::c_void, phswdevice : *mut HSWDEVICE) -> windows_sys::core::HRESULT);
pub type SwDeviceGetLifetime = unsafe extern "system" fn(hswdevice: HSWDEVICE, plifetime: *mut SW_DEVICE_LIFETIME) -> windows_sys::core::HRESULT;
windows_link::link!("cfgmgr32.dll" "system" fn SwDeviceGetLifetime(hswdevice : HSWDEVICE, plifetime : *mut SW_DEVICE_LIFETIME) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Devices_Properties")]
pub type SwDeviceInterfacePropertySet = unsafe extern "system" fn(hswdevice: HSWDEVICE, pszdeviceinterfaceid: windows_sys::core::PCWSTR, cpropertycount: u32, pproperties: *const super::super::Properties::DEVPROPERTY) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("cfgmgr32.dll" "system" fn SwDeviceInterfacePropertySet(hswdevice : HSWDEVICE, pszdeviceinterfaceid : windows_sys::core::PCWSTR, cpropertycount : u32, pproperties : *const super::super::Properties::DEVPROPERTY) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Devices_Properties")]
pub type SwDeviceInterfaceRegister = unsafe extern "system" fn(hswdevice: HSWDEVICE, pinterfaceclassguid: *const windows_sys::core::GUID, pszreferencestring: windows_sys::core::PCWSTR, cpropertycount: u32, pproperties: *const super::super::Properties::DEVPROPERTY, fenabled: windows_sys::core::BOOL, ppszdeviceinterfaceid: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("cfgmgr32.dll" "system" fn SwDeviceInterfaceRegister(hswdevice : HSWDEVICE, pinterfaceclassguid : *const windows_sys::core::GUID, pszreferencestring : windows_sys::core::PCWSTR, cpropertycount : u32, pproperties : *const super::super::Properties::DEVPROPERTY, fenabled : windows_sys::core::BOOL, ppszdeviceinterfaceid : *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT);
pub type SwDeviceInterfaceSetState = unsafe extern "system" fn(hswdevice: HSWDEVICE, pszdeviceinterfaceid: windows_sys::core::PCWSTR, fenabled: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
windows_link::link!("cfgmgr32.dll" "system" fn SwDeviceInterfaceSetState(hswdevice : HSWDEVICE, pszdeviceinterfaceid : windows_sys::core::PCWSTR, fenabled : windows_sys::core::BOOL) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Devices_Properties")]
pub type SwDevicePropertySet = unsafe extern "system" fn(hswdevice: HSWDEVICE, cpropertycount: u32, pproperties: *const super::super::Properties::DEVPROPERTY) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("cfgmgr32.dll" "system" fn SwDevicePropertySet(hswdevice : HSWDEVICE, cpropertycount : u32, pproperties : *const super::super::Properties::DEVPROPERTY) -> windows_sys::core::HRESULT);
pub type SwDeviceSetLifetime = unsafe extern "system" fn(hswdevice: HSWDEVICE, lifetime: SW_DEVICE_LIFETIME) -> windows_sys::core::HRESULT;
...
pub type SwMemFree = unsafe extern "system" fn(pmem: *const core::ffi::c_void);
