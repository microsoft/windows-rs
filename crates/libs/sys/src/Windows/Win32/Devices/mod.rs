...
pub const IEEE1394API_ACCESS_EXCLUSIVE: u32 = 64;
pub const IEEE1394API_ACCESS_SHARED_READ: u32 = 16;
pub const IEEE1394API_ACCESS_SHARED_WRITE: u32 = 32;
pub const IEEE1394API_BUS_RESET_LOCAL_NODE_INITIATED: u32 = 4;
pub const IEEE1394API_BUS_RESET_LOCAL_NODE_IS_IRM: u32 = 2;
pub const IEEE1394API_BUS_RESET_LOCAL_NODE_IS_ROOT: u32 = 1;
pub const IEEE1394API_DEVICE_OWNERSHIP_LOCAL_NODE: u32 = 1;
pub const IEEE1394API_DEVICE_OWNERSHIP_REMOTE_NODE: u32 = 4;
pub const IEEE1394API_NOTIFICATION_BUS_RESET: u32 = 2;
pub const IEEE1394API_NOTIFICATION_DEVICE_ACCESS: u32 = 1;
pub const IEEE1394API_REMOTE_ACCESS_TRANSFER_REQUEST: u32 = 1;
pub const IEEE1394API_RESOURCE_OWNERSHIP_LOCAL_NODE: u32 = 2;
pub const IEEE1394API_RESOURCE_OWNERSHIP_REMOTE_NODE: u32 = 8;
pub const IEEE1394_API_ADD_VIRTUAL_DEVICE: u32 = 1;
pub const IEEE1394_API_DEVICE_ACCESS_TRANSFER: u32 = 3;
pub const IEEE1394_API_REMOVE_VIRTUAL_DEVICE: u32 = 2;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const IEEE1394_API_SET_LOCAL_NODE_PROPERTIES: u32 = 4;
pub const IEEE1394_REQUEST_FLAG_PERSISTENT: u32 = 2;
...
pub const IOCTL_IEEE1394_API_REQUEST: u32 = 2229248;
