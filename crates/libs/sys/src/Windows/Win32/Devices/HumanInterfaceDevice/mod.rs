pub type DirectInput8Create = unsafe extern "system" fn(hinst: super::super::Foundation::HINSTANCE, dwversion: u32, riidltf: *const windows_sys::core::GUID, ppvout: *mut *mut core::ffi::c_void, punkouter: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type HidD_FlushQueue = unsafe extern "system" fn(hiddeviceobject: super::super::Foundation::HANDLE) -> bool;
windows_link::link!("hid.dll" "system" fn HidD_FlushQueue(hiddeviceobject : super::super::Foundation::HANDLE) -> bool);
pub type HidD_FreePreparsedData = unsafe extern "system" fn(preparseddata: PHIDP_PREPARSED_DATA) -> bool;
windows_link::link!("hid.dll" "system" fn HidD_FreePreparsedData(preparseddata : PHIDP_PREPARSED_DATA) -> bool);
pub type HidD_GetAttributes = unsafe extern "system" fn(hiddeviceobject: super::super::Foundation::HANDLE, attributes: *mut HIDD_ATTRIBUTES) -> bool;
...
pub type HidD_GetConfiguration = unsafe extern "system" fn(hiddeviceobject: super::super::Foundation::HANDLE, configuration: *mut HIDD_CONFIGURATION, configurationlength: u32) -> bool;
...
pub type HidD_GetFeature = unsafe extern "system" fn(hiddeviceobject: super::super::Foundation::HANDLE, reportbuffer: *mut core::ffi::c_void, reportbufferlength: u32) -> bool;
...
pub type HidD_GetIndexedString = unsafe extern "system" fn(hiddeviceobject: super::super::Foundation::HANDLE, stringindex: u32, buffer: *mut core::ffi::c_void, bufferlength: u32) -> bool;
...
pub type HidD_GetInputReport = unsafe extern "system" fn(hiddeviceobject: super::super::Foundation::HANDLE, reportbuffer: *mut core::ffi::c_void, reportbufferlength: u32) -> bool;
...
pub type HidD_GetManufacturerString = unsafe extern "system" fn(hiddeviceobject: super::super::Foundation::HANDLE, buffer: *mut core::ffi::c_void, bufferlength: u32) -> bool;
...
pub type HidD_GetMsGenreDescriptor = unsafe extern "system" fn(hiddeviceobject: super::super::Foundation::HANDLE, buffer: *mut core::ffi::c_void, bufferlength: u32) -> bool;
...
pub type HidD_GetNumInputBuffers = unsafe extern "system" fn(hiddeviceobject: super::super::Foundation::HANDLE, numberbuffers: *mut u32) -> bool;
...
pub type HidD_GetPhysicalDescriptor = unsafe extern "system" fn(hiddeviceobject: super::super::Foundation::HANDLE, buffer: *mut core::ffi::c_void, bufferlength: u32) -> bool;
...
pub type HidD_GetPreparsedData = unsafe extern "system" fn(hiddeviceobject: super::super::Foundation::HANDLE, preparseddata: *mut PHIDP_PREPARSED_DATA) -> bool;
...
pub type HidD_GetProductString = unsafe extern "system" fn(hiddeviceobject: super::super::Foundation::HANDLE, buffer: *mut core::ffi::c_void, bufferlength: u32) -> bool;
...
pub type HidD_GetSerialNumberString = unsafe extern "system" fn(hiddeviceobject: super::super::Foundation::HANDLE, buffer: *mut core::ffi::c_void, bufferlength: u32) -> bool;
...
pub type HidD_SetConfiguration = unsafe extern "system" fn(hiddeviceobject: super::super::Foundation::HANDLE, configuration: *const HIDD_CONFIGURATION, configurationlength: u32) -> bool;
...
pub type HidD_SetFeature = unsafe extern "system" fn(hiddeviceobject: super::super::Foundation::HANDLE, reportbuffer: *const core::ffi::c_void, reportbufferlength: u32) -> bool;
...
pub type HidD_SetNumInputBuffers = unsafe extern "system" fn(hiddeviceobject: super::super::Foundation::HANDLE, numberbuffers: u32) -> bool;
...
pub type HidD_SetOutputReport = unsafe extern "system" fn(hiddeviceobject: super::super::Foundation::HANDLE, reportbuffer: *const core::ffi::c_void, reportbufferlength: u32) -> bool;
...
pub type HidP_GetButtonArray = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, usagepage: u16, linkcollection: u16, usage: u16, buttondata: *mut HIDP_BUTTON_ARRAY_DATA, buttondatalength: *mut u16, preparseddata: PHIDP_PREPARSED_DATA, report: windows_sys::core::PCSTR, reportlength: u32) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_GetButtonCaps = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, buttoncaps: *mut HIDP_BUTTON_CAPS, buttoncapslength: *mut u16, preparseddata: PHIDP_PREPARSED_DATA) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_GetCaps = unsafe extern "system" fn(preparseddata: PHIDP_PREPARSED_DATA, capabilities: *mut HIDP_CAPS) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_GetData = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, datalist: *mut HIDP_DATA, datalength: *mut u32, preparseddata: PHIDP_PREPARSED_DATA, report: windows_sys::core::PSTR, reportlength: u32) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_GetExtendedAttributes = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, dataindex: u16, preparseddata: PHIDP_PREPARSED_DATA, attributes: *mut HIDP_EXTENDED_ATTRIBUTES, lengthattributes: *mut u32) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_GetLinkCollectionNodes = unsafe extern "system" fn(linkcollectionnodes: *mut HIDP_LINK_COLLECTION_NODE, linkcollectionnodeslength: *mut u32, preparseddata: PHIDP_PREPARSED_DATA) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_GetScaledUsageValue = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, usagepage: u16, linkcollection: u16, usage: u16, usagevalue: *mut i32, preparseddata: PHIDP_PREPARSED_DATA, report: windows_sys::core::PCSTR, reportlength: u32) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_GetSpecificButtonCaps = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, usagepage: u16, linkcollection: u16, usage: u16, buttoncaps: *mut HIDP_BUTTON_CAPS, buttoncapslength: *mut u16, preparseddata: PHIDP_PREPARSED_DATA) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_GetSpecificValueCaps = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, usagepage: u16, linkcollection: u16, usage: u16, valuecaps: *mut HIDP_VALUE_CAPS, valuecapslength: *mut u16, preparseddata: PHIDP_PREPARSED_DATA) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_GetUsageValue = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, usagepage: u16, linkcollection: u16, usage: u16, usagevalue: *mut u32, preparseddata: PHIDP_PREPARSED_DATA, report: windows_sys::core::PCSTR, reportlength: u32) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_GetUsageValueArray = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, usagepage: u16, linkcollection: u16, usage: u16, usagevalue: windows_sys::core::PSTR, usagevaluebytelength: u16, preparseddata: PHIDP_PREPARSED_DATA, report: windows_sys::core::PCSTR, reportlength: u32) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_GetUsages = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, usagepage: u16, linkcollection: u16, usagelist: *mut u16, usagelength: *mut u32, preparseddata: PHIDP_PREPARSED_DATA, report: windows_sys::core::PSTR, reportlength: u32) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_GetUsagesEx = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, linkcollection: u16, buttonlist: *mut USAGE_AND_PAGE, usagelength: *mut u32, preparseddata: PHIDP_PREPARSED_DATA, report: windows_sys::core::PCSTR, reportlength: u32) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_GetValueCaps = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, valuecaps: *mut HIDP_VALUE_CAPS, valuecapslength: *mut u16, preparseddata: PHIDP_PREPARSED_DATA) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_InitializeReportForID = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, reportid: u8, preparseddata: PHIDP_PREPARSED_DATA, report: windows_sys::core::PSTR, reportlength: u32) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_MaxDataListLength = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, preparseddata: PHIDP_PREPARSED_DATA) -> u32;
...
pub type HidP_MaxUsageListLength = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, usagepage: u16, preparseddata: PHIDP_PREPARSED_DATA) -> u32;
...
pub type HidP_SetButtonArray = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, usagepage: u16, linkcollection: u16, usage: u16, buttondata: *const HIDP_BUTTON_ARRAY_DATA, buttondatalength: u16, preparseddata: PHIDP_PREPARSED_DATA, report: windows_sys::core::PSTR, reportlength: u32) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_SetData = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, datalist: *mut HIDP_DATA, datalength: *mut u32, preparseddata: PHIDP_PREPARSED_DATA, report: windows_sys::core::PCSTR, reportlength: u32) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_SetScaledUsageValue = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, usagepage: u16, linkcollection: u16, usage: u16, usagevalue: i32, preparseddata: PHIDP_PREPARSED_DATA, report: windows_sys::core::PSTR, reportlength: u32) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_SetUsageValue = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, usagepage: u16, linkcollection: u16, usage: u16, usagevalue: u32, preparseddata: PHIDP_PREPARSED_DATA, report: windows_sys::core::PSTR, reportlength: u32) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_SetUsageValueArray = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, usagepage: u16, linkcollection: u16, usage: u16, usagevalue: windows_sys::core::PCSTR, usagevaluebytelength: u16, preparseddata: PHIDP_PREPARSED_DATA, report: windows_sys::core::PSTR, reportlength: u32) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_SetUsages = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, usagepage: u16, linkcollection: u16, usagelist: *mut u16, usagelength: *mut u32, preparseddata: PHIDP_PREPARSED_DATA, report: windows_sys::core::PCSTR, reportlength: u32) -> super::super::Foundation::NTSTATUS;
...
pub type HidP_UnsetUsages = unsafe extern "system" fn(reporttype: HIDP_REPORT_TYPE, usagepage: u16, linkcollection: u16, usagelist: *mut u16, usagelength: *mut u32, preparseddata: PHIDP_PREPARSED_DATA, report: windows_sys::core::PCSTR, reportlength: u32) -> super::super::Foundation::NTSTATUS;
