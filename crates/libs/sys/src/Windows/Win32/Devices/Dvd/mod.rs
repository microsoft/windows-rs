...
pub const DiscControlBlockList: DISC_CONTROL_BLOCK_TYPE = -1;
pub const DvdAsf: DVD_KEY_TYPE = 5;
pub const DvdBCADescriptor: DVD_STRUCTURE_FORMAT = 3;
pub const DvdBusKey1: DVD_KEY_TYPE = 2;
pub const DvdBusKey2: DVD_KEY_TYPE = 3;
pub const DvdChallengeKey: DVD_KEY_TYPE = 1;
pub const DvdCopyrightDescriptor: DVD_STRUCTURE_FORMAT = 1;
pub const DvdDiskKey: DVD_KEY_TYPE = 128;
pub const DvdDiskKeyDescriptor: DVD_STRUCTURE_FORMAT = 2;
pub const DvdGetRpcKey: DVD_KEY_TYPE = 8;
pub const DvdInvalidateAGID: DVD_KEY_TYPE = 63;
pub const DvdManufacturerDescriptor: DVD_STRUCTURE_FORMAT = 4;
pub const DvdMaxDescriptor: DVD_STRUCTURE_FORMAT = 5;
pub const DvdPhysicalDescriptor: DVD_STRUCTURE_FORMAT = 0;
pub const DvdSetRpcKey: DVD_KEY_TYPE = 6;
...
pub const SessionInfoDiscControlBlock: DISC_CONTROL_BLOCK_TYPE = 1396982528;
pub const WriteInhibitDiscControlBlock: DISC_CONTROL_BLOCK_TYPE = 1464091392;
