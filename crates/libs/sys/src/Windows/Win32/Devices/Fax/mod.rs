pub type CanSendToFaxRecipient = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("fxsutility.dll" "system" fn CanSendToFaxRecipient() -> windows_sys::core::BOOL);
pub type FaxAbort = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, jobid: u32) -> windows_sys::core::BOOL;
windows_link::link!("winfax.dll" "system" fn FaxAbort(faxhandle : super::super::Foundation::HANDLE, jobid : u32) -> windows_sys::core::BOOL);
pub type FaxAccessCheck = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, accessmask: u32) -> windows_sys::core::BOOL;
...
pub type FaxClose = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("winfax.dll" "system" fn FaxClose(faxhandle : super::super::Foundation::HANDLE) -> windows_sys::core::BOOL);
pub type FaxCompleteJobParamsA = unsafe extern "system" fn(jobparams: *mut *mut FAX_JOB_PARAMA, coverpageinfo: *mut *mut FAX_COVERPAGE_INFOA) -> windows_sys::core::BOOL;
...
pub type FaxCompleteJobParamsW = unsafe extern "system" fn(jobparams: *mut *mut FAX_JOB_PARAMW, coverpageinfo: *mut *mut FAX_COVERPAGE_INFOW) -> windows_sys::core::BOOL;
...
pub type FaxConnectFaxServerA = unsafe extern "system" fn(machinename: windows_sys::core::PCSTR, faxhandle: *mut super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
...
pub type FaxConnectFaxServerW = unsafe extern "system" fn(machinename: windows_sys::core::PCWSTR, faxhandle: *mut super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
...
pub type FaxEnableRoutingMethodA = unsafe extern "system" fn(faxporthandle: super::super::Foundation::HANDLE, routingguid: windows_sys::core::PCSTR, enabled: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type FaxEnableRoutingMethodW = unsafe extern "system" fn(faxporthandle: super::super::Foundation::HANDLE, routingguid: windows_sys::core::PCWSTR, enabled: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type FaxEnumGlobalRoutingInfoA = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, routinginfo: *mut *mut FAX_GLOBAL_ROUTING_INFOA, methodsreturned: *mut u32) -> windows_sys::core::BOOL;
...
pub type FaxEnumGlobalRoutingInfoW = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, routinginfo: *mut *mut FAX_GLOBAL_ROUTING_INFOW, methodsreturned: *mut u32) -> windows_sys::core::BOOL;
...
pub type FaxEnumJobsA = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, jobentry: *mut *mut FAX_JOB_ENTRYA, jobsreturned: *mut u32) -> windows_sys::core::BOOL;
...
pub type FaxEnumJobsW = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, jobentry: *mut *mut FAX_JOB_ENTRYW, jobsreturned: *mut u32) -> windows_sys::core::BOOL;
...
pub type FaxEnumPortsA = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, portinfo: *mut *mut FAX_PORT_INFOA, portsreturned: *mut u32) -> windows_sys::core::BOOL;
...
pub type FaxEnumPortsW = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, portinfo: *mut *mut FAX_PORT_INFOW, portsreturned: *mut u32) -> windows_sys::core::BOOL;
...
pub type FaxEnumRoutingMethodsA = unsafe extern "system" fn(faxporthandle: super::super::Foundation::HANDLE, routingmethod: *mut *mut FAX_ROUTING_METHODA, methodsreturned: *mut u32) -> windows_sys::core::BOOL;
...
pub type FaxEnumRoutingMethodsW = unsafe extern "system" fn(faxporthandle: super::super::Foundation::HANDLE, routingmethod: *mut *mut FAX_ROUTING_METHODW, methodsreturned: *mut u32) -> windows_sys::core::BOOL;
...
pub type FaxFreeBuffer = unsafe extern "system" fn(buffer: *mut core::ffi::c_void);
windows_link::link!("winfax.dll" "system" fn FaxFreeBuffer(buffer : *mut core::ffi::c_void));
pub type FaxGetConfigurationA = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, faxconfig: *mut *mut FAX_CONFIGURATIONA) -> windows_sys::core::BOOL;
...
pub type FaxGetConfigurationW = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, faxconfig: *mut *mut FAX_CONFIGURATIONW) -> windows_sys::core::BOOL;
...
pub type FaxGetDeviceStatusA = unsafe extern "system" fn(faxporthandle: super::super::Foundation::HANDLE, devicestatus: *mut *mut FAX_DEVICE_STATUSA) -> windows_sys::core::BOOL;
...
pub type FaxGetDeviceStatusW = unsafe extern "system" fn(faxporthandle: super::super::Foundation::HANDLE, devicestatus: *mut *mut FAX_DEVICE_STATUSW) -> windows_sys::core::BOOL;
...
pub type FaxGetJobA = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, jobid: u32, jobentry: *mut *mut FAX_JOB_ENTRYA) -> windows_sys::core::BOOL;
...
pub type FaxGetJobW = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, jobid: u32, jobentry: *mut *mut FAX_JOB_ENTRYW) -> windows_sys::core::BOOL;
...
pub type FaxGetLoggingCategoriesA = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, categories: *mut *mut FAX_LOG_CATEGORYA, numbercategories: *mut u32) -> windows_sys::core::BOOL;
...
pub type FaxGetLoggingCategoriesW = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, categories: *mut *mut FAX_LOG_CATEGORYW, numbercategories: *mut u32) -> windows_sys::core::BOOL;
...
pub type FaxGetPageData = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, jobid: u32, buffer: *mut *mut u8, buffersize: *mut u32, imagewidth: *mut u32, imageheight: *mut u32) -> windows_sys::core::BOOL;
...
pub type FaxGetPortA = unsafe extern "system" fn(faxporthandle: super::super::Foundation::HANDLE, portinfo: *mut *mut FAX_PORT_INFOA) -> windows_sys::core::BOOL;
...
pub type FaxGetPortW = unsafe extern "system" fn(faxporthandle: super::super::Foundation::HANDLE, portinfo: *mut *mut FAX_PORT_INFOW) -> windows_sys::core::BOOL;
...
pub type FaxGetRoutingInfoA = unsafe extern "system" fn(faxporthandle: super::super::Foundation::HANDLE, routingguid: windows_sys::core::PCSTR, routinginfobuffer: *mut *mut u8, routinginfobuffersize: *mut u32) -> windows_sys::core::BOOL;
...
pub type FaxGetRoutingInfoW = unsafe extern "system" fn(faxporthandle: super::super::Foundation::HANDLE, routingguid: windows_sys::core::PCWSTR, routinginfobuffer: *mut *mut u8, routinginfobuffersize: *mut u32) -> windows_sys::core::BOOL;
...
pub type FaxInitializeEventQueue = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, completionport: super::super::Foundation::HANDLE, completionkey: usize, hwnd: super::super::Foundation::HWND, messagestart: u32) -> windows_sys::core::BOOL;
...
pub type FaxOpenPort = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, deviceid: u32, flags: u32, faxporthandle: *mut super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
...
pub type FaxPrintCoverPageA = unsafe extern "system" fn(faxcontextinfo: *const FAX_CONTEXT_INFOA, coverpageinfo: *const FAX_COVERPAGE_INFOA) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type FaxPrintCoverPageW = unsafe extern "system" fn(faxcontextinfo: *const FAX_CONTEXT_INFOW, coverpageinfo: *const FAX_COVERPAGE_INFOW) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type FaxRegisterRoutingExtensionW = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, extensionname: windows_sys::core::PCWSTR, friendlyname: windows_sys::core::PCWSTR, imagename: windows_sys::core::PCWSTR, callback: PFAX_ROUTING_INSTALLATION_CALLBACKW, context: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type FaxRegisterServiceProviderW = unsafe extern "system" fn(deviceprovider: windows_sys::core::PCWSTR, friendlyname: windows_sys::core::PCWSTR, imagename: windows_sys::core::PCWSTR, tspname: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type FaxSendDocumentA = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, filename: windows_sys::core::PCSTR, jobparams: *const FAX_JOB_PARAMA, coverpageinfo: *const FAX_COVERPAGE_INFOA, faxjobid: *mut u32) -> windows_sys::core::BOOL;
...
pub type FaxSendDocumentForBroadcastA = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, filename: windows_sys::core::PCSTR, faxjobid: *mut u32, faxrecipientcallback: PFAX_RECIPIENT_CALLBACKA, context: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type FaxSendDocumentForBroadcastW = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, filename: windows_sys::core::PCWSTR, faxjobid: *mut u32, faxrecipientcallback: PFAX_RECIPIENT_CALLBACKW, context: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type FaxSendDocumentW = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, filename: windows_sys::core::PCWSTR, jobparams: *const FAX_JOB_PARAMW, coverpageinfo: *const FAX_COVERPAGE_INFOW, faxjobid: *mut u32) -> windows_sys::core::BOOL;
...
pub type FaxSetConfigurationA = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, faxconfig: *const FAX_CONFIGURATIONA) -> windows_sys::core::BOOL;
...
pub type FaxSetConfigurationW = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, faxconfig: *const FAX_CONFIGURATIONW) -> windows_sys::core::BOOL;
...
pub type FaxSetGlobalRoutingInfoA = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, routinginfo: *const FAX_GLOBAL_ROUTING_INFOA) -> windows_sys::core::BOOL;
...
pub type FaxSetGlobalRoutingInfoW = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, routinginfo: *const FAX_GLOBAL_ROUTING_INFOW) -> windows_sys::core::BOOL;
...
pub type FaxSetJobA = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, jobid: u32, command: u32, jobentry: *const FAX_JOB_ENTRYA) -> windows_sys::core::BOOL;
...
pub type FaxSetJobW = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, jobid: u32, command: u32, jobentry: *const FAX_JOB_ENTRYW) -> windows_sys::core::BOOL;
...
pub type FaxSetLoggingCategoriesA = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, categories: *const FAX_LOG_CATEGORYA, numbercategories: u32) -> windows_sys::core::BOOL;
...
pub type FaxSetLoggingCategoriesW = unsafe extern "system" fn(faxhandle: super::super::Foundation::HANDLE, categories: *const FAX_LOG_CATEGORYW, numbercategories: u32) -> windows_sys::core::BOOL;
...
pub type FaxSetPortA = unsafe extern "system" fn(faxporthandle: super::super::Foundation::HANDLE, portinfo: *const FAX_PORT_INFOA) -> windows_sys::core::BOOL;
...
pub type FaxSetPortW = unsafe extern "system" fn(faxporthandle: super::super::Foundation::HANDLE, portinfo: *const FAX_PORT_INFOW) -> windows_sys::core::BOOL;
...
pub type FaxSetRoutingInfoA = unsafe extern "system" fn(faxporthandle: super::super::Foundation::HANDLE, routingguid: windows_sys::core::PCSTR, routinginfobuffer: *const u8, routinginfobuffersize: u32) -> windows_sys::core::BOOL;
...
pub type FaxSetRoutingInfoW = unsafe extern "system" fn(faxporthandle: super::super::Foundation::HANDLE, routingguid: windows_sys::core::PCWSTR, routinginfobuffer: *const u8, routinginfobuffersize: u32) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type FaxStartPrintJobA = unsafe extern "system" fn(printername: windows_sys::core::PCSTR, printinfo: *const FAX_PRINT_INFOA, faxjobid: *mut u32, faxcontextinfo: *mut FAX_CONTEXT_INFOA) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type FaxStartPrintJobW = unsafe extern "system" fn(printername: windows_sys::core::PCWSTR, printinfo: *const FAX_PRINT_INFOW, faxjobid: *mut u32, faxcontextinfo: *mut FAX_CONTEXT_INFOW) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type FaxUnregisterServiceProviderW = unsafe extern "system" fn(deviceprovider: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SendToFaxRecipient = unsafe extern "system" fn(sndmode: SendToMode, lpfilename: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("fxsutility.dll" "system" fn SendToFaxRecipient(sndmode : SendToMode, lpfilename : windows_sys::core::PCWSTR) -> u32);
pub type StiCreateInstanceW = unsafe extern "system" fn(hinst: super::super::Foundation::HINSTANCE, dwver: u32, ppsti: *mut *mut core::ffi::c_void, punkouter: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
