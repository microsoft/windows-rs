...
pub const DEV_ID_SRC_FAX: FAX_ENUM_DEVICE_ID_SOURCE = 0;
pub const DEV_ID_SRC_TAPI: FAX_ENUM_DEVICE_ID_SOURCE = 1;
pub const DRT_EMAIL: FAX_ENUM_DELIVERY_REPORT_TYPES = 1;
pub const DRT_INBOX: FAX_ENUM_DELIVERY_REPORT_TYPES = 2;
pub const DRT_NONE: FAX_ENUM_DELIVERY_REPORT_TYPES = 0;
pub const FAXDEVRECEIVE_SIZE: u32 = 4096;
pub const FAXDEVREPORTSTATUS_SIZE: u32 = 4096;
pub const FAXLOG_CATEGORY_INBOUND: FAX_ENUM_LOG_CATEGORIES = 3;
pub const FAXLOG_CATEGORY_INIT: FAX_ENUM_LOG_CATEGORIES = 1;
pub const FAXLOG_CATEGORY_OUTBOUND: FAX_ENUM_LOG_CATEGORIES = 2;
pub const FAXLOG_CATEGORY_UNKNOWN: FAX_ENUM_LOG_CATEGORIES = 4;
pub const FAXLOG_LEVEL_MAX: FAX_ENUM_LOG_LEVELS = 3;
pub const FAXLOG_LEVEL_MED: FAX_ENUM_LOG_LEVELS = 2;
pub const FAXLOG_LEVEL_MIN: FAX_ENUM_LOG_LEVELS = 1;
pub const FAXLOG_LEVEL_NONE: FAX_ENUM_LOG_LEVELS = 0;
...
pub const JC_DELETE: FAX_ENUM_JOB_COMMANDS = 1;
pub const JC_PAUSE: FAX_ENUM_JOB_COMMANDS = 2;
pub const JC_RESUME: FAX_ENUM_JOB_COMMANDS = 3;
pub const JC_UNKNOWN: FAX_ENUM_JOB_COMMANDS = 0;
pub const JSA_DISCOUNT_PERIOD: FAX_ENUM_JOB_SEND_ATTRIBUTES = 2;
pub const JSA_NOW: FAX_ENUM_JOB_SEND_ATTRIBUTES = 0;
pub const JSA_SPECIFIC_TIME: FAX_ENUM_JOB_SEND_ATTRIBUTES = 1;
...
pub const PORT_OPEN_MODIFY: FAX_ENUM_PORT_OPEN_TYPE = 2;
pub const PORT_OPEN_QUERY: FAX_ENUM_PORT_OPEN_TYPE = 1;
pub const QUERY_STATUS: FAXROUTE_ENABLE = -1;
...
pub const SEND_TO_FAX_RECIPIENT_ATTACHMENT: SendToMode = 0;
pub const STATUS_DISABLE: FAXROUTE_ENABLE = 0;
pub const STATUS_ENABLE: FAXROUTE_ENABLE = 1;
...
pub const faetFXSSVC_ENDED: FAX_ACCOUNT_EVENTS_TYPE_ENUM = 16;
pub const faetIN_ARCHIVE: FAX_ACCOUNT_EVENTS_TYPE_ENUM = 4;
pub const faetIN_QUEUE: FAX_ACCOUNT_EVENTS_TYPE_ENUM = 1;
pub const faetNONE: FAX_ACCOUNT_EVENTS_TYPE_ENUM = 0;
pub const faetOUT_ARCHIVE: FAX_ACCOUNT_EVENTS_TYPE_ENUM = 8;
pub const faetOUT_QUEUE: FAX_ACCOUNT_EVENTS_TYPE_ENUM = 2;
pub const far2MANAGE_ARCHIVES: FAX_ACCESS_RIGHTS_ENUM_2 = 256;
pub const far2MANAGE_CONFIG: FAX_ACCESS_RIGHTS_ENUM_2 = 64;
pub const far2MANAGE_OUT_JOBS: FAX_ACCESS_RIGHTS_ENUM_2 = 16;
pub const far2MANAGE_RECEIVE_FOLDER: FAX_ACCESS_RIGHTS_ENUM_2 = 512;
pub const far2QUERY_ARCHIVES: FAX_ACCESS_RIGHTS_ENUM_2 = 128;
pub const far2QUERY_CONFIG: FAX_ACCESS_RIGHTS_ENUM_2 = 32;
pub const far2QUERY_OUT_JOBS: FAX_ACCESS_RIGHTS_ENUM_2 = 8;
pub const far2SUBMIT_HIGH: FAX_ACCESS_RIGHTS_ENUM_2 = 4;
pub const far2SUBMIT_LOW: FAX_ACCESS_RIGHTS_ENUM_2 = 1;
pub const far2SUBMIT_NORMAL: FAX_ACCESS_RIGHTS_ENUM_2 = 2;
pub const farMANAGE_CONFIG: FAX_ACCESS_RIGHTS_ENUM = 64;
pub const farMANAGE_IN_ARCHIVE: FAX_ACCESS_RIGHTS_ENUM = 256;
pub const farMANAGE_JOBS: FAX_ACCESS_RIGHTS_ENUM = 16;
pub const farMANAGE_OUT_ARCHIVE: FAX_ACCESS_RIGHTS_ENUM = 1024;
pub const farQUERY_CONFIG: FAX_ACCESS_RIGHTS_ENUM = 32;
pub const farQUERY_IN_ARCHIVE: FAX_ACCESS_RIGHTS_ENUM = 128;
pub const farQUERY_JOBS: FAX_ACCESS_RIGHTS_ENUM = 8;
pub const farQUERY_OUT_ARCHIVE: FAX_ACCESS_RIGHTS_ENUM = 512;
pub const farSUBMIT_HIGH: FAX_ACCESS_RIGHTS_ENUM = 4;
pub const farSUBMIT_LOW: FAX_ACCESS_RIGHTS_ENUM = 1;
pub const farSUBMIT_NORMAL: FAX_ACCESS_RIGHTS_ENUM = 2;
pub const fcptLOCAL: FAX_COVERPAGE_TYPE_ENUM = 1;
pub const fcptNONE: FAX_COVERPAGE_TYPE_ENUM = 0;
pub const fcptSERVER: FAX_COVERPAGE_TYPE_ENUM = 2;
pub const fdrmAUTO_ANSWER: FAX_DEVICE_RECEIVE_MODE_ENUM = 1;
pub const fdrmMANUAL_ANSWER: FAX_DEVICE_RECEIVE_MODE_ENUM = 2;
pub const fdrmNO_ANSWER: FAX_DEVICE_RECEIVE_MODE_ENUM = 0;
pub const fgsALL_DEV_NOT_VALID: FAX_GROUP_STATUS_ENUM = 2;
pub const fgsALL_DEV_VALID: FAX_GROUP_STATUS_ENUM = 0;
pub const fgsEMPTY: FAX_GROUP_STATUS_ENUM = 1;
pub const fgsSOME_DEV_NOT_VALID: FAX_GROUP_STATUS_ENUM = 3;
pub const fjesANSWERED: FAX_JOB_EXTENDED_STATUS_ENUM = 5;
pub const fjesBAD_ADDRESS: FAX_JOB_EXTENDED_STATUS_ENUM = 10;
pub const fjesBUSY: FAX_JOB_EXTENDED_STATUS_ENUM = 8;
pub const fjesCALL_ABORTED: FAX_JOB_EXTENDED_STATUS_ENUM = 19;
pub const fjesCALL_BLACKLISTED: FAX_JOB_EXTENDED_STATUS_ENUM = 14;
pub const fjesCALL_COMPLETED: FAX_JOB_EXTENDED_STATUS_ENUM = 18;
pub const fjesCALL_DELAYED: FAX_JOB_EXTENDED_STATUS_ENUM = 13;
pub const fjesDIALING: FAX_JOB_EXTENDED_STATUS_ENUM = 3;
pub const fjesDISCONNECTED: FAX_JOB_EXTENDED_STATUS_ENUM = 1;
pub const fjesFATAL_ERROR: FAX_JOB_EXTENDED_STATUS_ENUM = 12;
pub const fjesHANDLED: FAX_JOB_EXTENDED_STATUS_ENUM = 17;
pub const fjesINITIALIZING: FAX_JOB_EXTENDED_STATUS_ENUM = 2;
pub const fjesLINE_UNAVAILABLE: FAX_JOB_EXTENDED_STATUS_ENUM = 7;
pub const fjesNONE: FAX_JOB_EXTENDED_STATUS_ENUM = 0;
pub const fjesNOT_FAX_CALL: FAX_JOB_EXTENDED_STATUS_ENUM = 15;
pub const fjesNO_ANSWER: FAX_JOB_EXTENDED_STATUS_ENUM = 9;
pub const fjesNO_DIAL_TONE: FAX_JOB_EXTENDED_STATUS_ENUM = 11;
pub const fjesPARTIALLY_RECEIVED: FAX_JOB_EXTENDED_STATUS_ENUM = 16;
pub const fjesPROPRIETARY: FAX_JOB_EXTENDED_STATUS_ENUM = 16777216;
pub const fjesRECEIVING: FAX_JOB_EXTENDED_STATUS_ENUM = 6;
pub const fjesTRANSMITTING: FAX_JOB_EXTENDED_STATUS_ENUM = 4;
pub const fjoDELETE: FAX_JOB_OPERATIONS_ENUM = 16;
pub const fjoPAUSE: FAX_JOB_OPERATIONS_ENUM = 2;
pub const fjoRECIPIENT_INFO: FAX_JOB_OPERATIONS_ENUM = 32;
pub const fjoRESTART: FAX_JOB_OPERATIONS_ENUM = 8;
pub const fjoRESUME: FAX_JOB_OPERATIONS_ENUM = 4;
pub const fjoSENDER_INFO: FAX_JOB_OPERATIONS_ENUM = 64;
pub const fjoVIEW: FAX_JOB_OPERATIONS_ENUM = 1;
pub const fjsCANCELED: FAX_JOB_STATUS_ENUM = 512;
pub const fjsCANCELING: FAX_JOB_STATUS_ENUM = 1024;
pub const fjsCOMPLETED: FAX_JOB_STATUS_ENUM = 256;
pub const fjsFAILED: FAX_JOB_STATUS_ENUM = 8;
pub const fjsINPROGRESS: FAX_JOB_STATUS_ENUM = 2;
pub const fjsNOLINE: FAX_JOB_STATUS_ENUM = 32;
pub const fjsPAUSED: FAX_JOB_STATUS_ENUM = 16;
pub const fjsPENDING: FAX_JOB_STATUS_ENUM = 1;
pub const fjsRETRIES_EXCEEDED: FAX_JOB_STATUS_ENUM = 128;
pub const fjsRETRYING: FAX_JOB_STATUS_ENUM = 64;
pub const fjsROUTING: FAX_JOB_STATUS_ENUM = 2048;
pub const fjtRECEIVE: FAX_JOB_TYPE_ENUM = 1;
pub const fjtROUTING: FAX_JOB_TYPE_ENUM = 2;
pub const fjtSEND: FAX_JOB_TYPE_ENUM = 0;
pub const fllMAX: FAX_LOG_LEVEL_ENUM = 3;
pub const fllMED: FAX_LOG_LEVEL_ENUM = 2;
pub const fllMIN: FAX_LOG_LEVEL_ENUM = 1;
pub const fllNONE: FAX_LOG_LEVEL_ENUM = 0;
pub const fpsBAD_GUID: FAX_PROVIDER_STATUS_ENUM = 2;
pub const fpsBAD_VERSION: FAX_PROVIDER_STATUS_ENUM = 3;
pub const fpsCANT_INIT: FAX_PROVIDER_STATUS_ENUM = 6;
pub const fpsCANT_LINK: FAX_PROVIDER_STATUS_ENUM = 5;
pub const fpsCANT_LOAD: FAX_PROVIDER_STATUS_ENUM = 4;
pub const fpsSERVER_ERROR: FAX_PROVIDER_STATUS_ENUM = 1;
pub const fpsSUCCESS: FAX_PROVIDER_STATUS_ENUM = 0;
pub const fptHIGH: FAX_PRIORITY_TYPE_ENUM = 2;
pub const fptLOW: FAX_PRIORITY_TYPE_ENUM = 0;
pub const fptNORMAL: FAX_PRIORITY_TYPE_ENUM = 1;
pub const frrcANY_CODE: FAX_ROUTING_RULE_CODE_ENUM = 0;
pub const frsALL_GROUP_DEV_NOT_VALID: FAX_RULE_STATUS_ENUM = 2;
pub const frsBAD_DEVICE: FAX_RULE_STATUS_ENUM = 4;
pub const frsEMPTY_GROUP: FAX_RULE_STATUS_ENUM = 1;
pub const frsSOME_GROUP_DEV_NOT_VALID: FAX_RULE_STATUS_ENUM = 3;
pub const frsVALID: FAX_RULE_STATUS_ENUM = 0;
pub const frtMAIL: FAX_RECEIPT_TYPE_ENUM = 1;
pub const frtMSGBOX: FAX_RECEIPT_TYPE_ENUM = 4;
pub const frtNONE: FAX_RECEIPT_TYPE_ENUM = 0;
pub const fsAPI_VERSION_0: FAX_SERVER_APIVERSION_ENUM = 0;
pub const fsAPI_VERSION_1: FAX_SERVER_APIVERSION_ENUM = 65536;
pub const fsAPI_VERSION_2: FAX_SERVER_APIVERSION_ENUM = 131072;
pub const fsAPI_VERSION_3: FAX_SERVER_APIVERSION_ENUM = 196608;
pub const fsatANONYMOUS: FAX_SMTP_AUTHENTICATION_TYPE_ENUM = 0;
pub const fsatBASIC: FAX_SMTP_AUTHENTICATION_TYPE_ENUM = 1;
pub const fsatNTLM: FAX_SMTP_AUTHENTICATION_TYPE_ENUM = 2;
pub const fsetACTIVITY: FAX_SERVER_EVENTS_TYPE_ENUM = 8;
pub const fsetCONFIG: FAX_SERVER_EVENTS_TYPE_ENUM = 4;
pub const fsetDEVICE_STATUS: FAX_SERVER_EVENTS_TYPE_ENUM = 256;
pub const fsetFXSSVC_ENDED: FAX_SERVER_EVENTS_TYPE_ENUM = 128;
pub const fsetINCOMING_CALL: FAX_SERVER_EVENTS_TYPE_ENUM = 512;
pub const fsetIN_ARCHIVE: FAX_SERVER_EVENTS_TYPE_ENUM = 32;
pub const fsetIN_QUEUE: FAX_SERVER_EVENTS_TYPE_ENUM = 1;
pub const fsetNONE: FAX_SERVER_EVENTS_TYPE_ENUM = 0;
pub const fsetOUT_ARCHIVE: FAX_SERVER_EVENTS_TYPE_ENUM = 64;
pub const fsetOUT_QUEUE: FAX_SERVER_EVENTS_TYPE_ENUM = 2;
pub const fsetQUEUE_STATE: FAX_SERVER_EVENTS_TYPE_ENUM = 16;
pub const fstDISCOUNT_PERIOD: FAX_SCHEDULE_TYPE_ENUM = 2;
pub const fstNOW: FAX_SCHEDULE_TYPE_ENUM = 0;
pub const fstSPECIFIC_TIME: FAX_SCHEDULE_TYPE_ENUM = 1;
