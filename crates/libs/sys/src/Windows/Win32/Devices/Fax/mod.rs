...
::windows_targets::link!("winfax.dll" "system" fn FaxSendDocumentA(faxhandle : super::super::Foundation:: HANDLE, filename : ::windows_sys::core::PCSTR, jobparams : *mut FAX_JOB_PARAMA, coverpageinfo : *const FAX_COVERPAGE_INFOA, faxjobid : *mut u32) -> super::super::Foundation:: BOOL);
::windows_targets::link!("winfax.dll" "system" fn FaxSendDocumentForBroadcastA(faxhandle : super::super::Foundation:: HANDLE, filename : ::windows_sys::core::PCSTR, faxjobid : *mut u32, faxrecipientcallback : PFAX_RECIPIENT_CALLBACKA, context : *mut ::core::ffi::c_void) -> super::super::Foundation:: BOOL);
::windows_targets::link!("winfax.dll" "system" fn FaxSendDocumentForBroadcastW(faxhandle : super::super::Foundation:: HANDLE, filename : ::windows_sys::core::PCWSTR, faxjobid : *mut u32, faxrecipientcallback : PFAX_RECIPIENT_CALLBACKW, context : *mut ::core::ffi::c_void) -> super::super::Foundation:: BOOL);
::windows_targets::link!("winfax.dll" "system" fn FaxSendDocumentW(faxhandle : super::super::Foundation:: HANDLE, filename : ::windows_sys::core::PCWSTR, jobparams : *mut FAX_JOB_PARAMW, coverpageinfo : *const FAX_COVERPAGE_INFOW, faxjobid : *mut u32) -> super::super::Foundation:: BOOL);
...
pub const FAX_E_BAD_GROUP_CONFIGURATION: ::windows_sys::core::HRESULT = 0x80041B5Bu32 as _;
pub const FAX_E_DEVICE_NUM_LIMIT_EXCEEDED: ::windows_sys::core::HRESULT = 0x80041B62u32 as _;
pub const FAX_E_DIRECTORY_IN_USE: ::windows_sys::core::HRESULT = 0x80041B5Fu32 as _;
pub const FAX_E_FILE_ACCESS_DENIED: ::windows_sys::core::HRESULT = 0x80041B60u32 as _;
pub const FAX_E_GROUP_IN_USE: ::windows_sys::core::HRESULT = 0x80041B5Cu32 as _;
pub const FAX_E_GROUP_NOT_FOUND: ::windows_sys::core::HRESULT = 0x80041B5Au32 as _;
pub const FAX_E_MESSAGE_NOT_FOUND: ::windows_sys::core::HRESULT = 0x80041B61u32 as _;
pub const FAX_E_NOT_NTFS: ::windows_sys::core::HRESULT = 0x80041B5Eu32 as _;
pub const FAX_E_NOT_SUPPORTED_ON_THIS_SKU: ::windows_sys::core::HRESULT = 0x80041B63u32 as _;
pub const FAX_E_RECIPIENTS_LIMIT: ::windows_sys::core::HRESULT = 0x80041B65u32 as _;
pub const FAX_E_RULE_NOT_FOUND: ::windows_sys::core::HRESULT = 0x80041B5Du32 as _;
pub const FAX_E_SRV_OUTOFMEMORY: ::windows_sys::core::HRESULT = 0x80041B59u32 as _;
pub const FAX_E_VERSION_MISMATCH: ::windows_sys::core::HRESULT = 0x80041B64u32 as _;
...
pub const STIERR_ALREADY_INITIALIZED: ::windows_sys::core::HRESULT = 0x800704DFu32 as _;
pub const STIERR_BADDRIVER: ::windows_sys::core::HRESULT = 0x80070077u32 as _;
pub const STIERR_BETA_VERSION: ::windows_sys::core::HRESULT = 0x80070481u32 as _;
pub const STIERR_DEVICENOTREG: i32 = -2147221164i32;
pub const STIERR_DEVICE_LOCKED: ::windows_sys::core::HRESULT = 0x80070021u32 as _;
pub const STIERR_DEVICE_NOTREADY: ::windows_sys::core::HRESULT = 0x80070015u32 as _;
pub const STIERR_GENERIC: i32 = -2147467259i32;
pub const STIERR_HANDLEEXISTS: ::windows_sys::core::HRESULT = 0x800700B7u32 as _;
pub const STIERR_INVALID_DEVICE_NAME: ::windows_sys::core::HRESULT = 0x8007007Bu32 as _;
pub const STIERR_INVALID_HW_TYPE: ::windows_sys::core::HRESULT = 0x8007000Du32 as _;
pub const STIERR_INVALID_PARAM: i32 = -2147024809i32;
pub const STIERR_NEEDS_LOCK: ::windows_sys::core::HRESULT = 0x8007009Eu32 as _;
pub const STIERR_NOEVENTS: ::windows_sys::core::HRESULT = 0x80070103u32 as _;
pub const STIERR_NOINTERFACE: i32 = -2147467262i32;
pub const STIERR_NOTINITIALIZED: i32 = -2147024891i32;
pub const STIERR_NOT_INITIALIZED: ::windows_sys::core::HRESULT = 0x80070015u32 as _;
pub const STIERR_OBJECTNOTFOUND: ::windows_sys::core::HRESULT = 0x80070002u32 as _;
pub const STIERR_OLD_VERSION: ::windows_sys::core::HRESULT = 0x8007047Eu32 as _;
pub const STIERR_OUTOFMEMORY: i32 = -2147024882i32;
pub const STIERR_READONLY: i32 = -2147024891i32;
pub const STIERR_SHARING_VIOLATION: ::windows_sys::core::HRESULT = 0x80070020u32 as _;
