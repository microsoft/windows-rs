pub const ApplicationSelected: SECURE_ELEMENT_EVENT_TYPE = 2;
pub const ConnectionOriented: NFC_LLCP_SOCKET_TYPE = 0;
pub const Connectionless: NFC_LLCP_SOCKET_TYPE = 1;
pub const DefaultSnepServer: NFC_SNEP_SERVER_TYPE = 0;
pub const DeviceHost: SECURE_ELEMENT_TYPE = 2;
pub const Discovery: NFC_RELEASE_TYPE = 2;
pub const EVT_TRANSACTION_PARAMETER_MAX_LEN: u32 = 255;
pub const EVT_TRANSACTION_TAG_AID: u32 = 129;
pub const EVT_TRANSACTION_TAG_PARAMETERS: u32 = 130;
pub const EmulationDisabled: NFC_SE_EMULATION_MODE = 0;
pub const EmulationEnabled: NFC_SE_EMULATION_MODE = 1;
pub const EmulationOff: SECURE_ELEMENT_CARD_EMULATION_MODE = 0;
pub const EmulationOnPowerDependent: SECURE_ELEMENT_CARD_EMULATION_MODE = 2;
pub const EmulationOnPowerIndependent: SECURE_ELEMENT_CARD_EMULATION_MODE = 1;
pub const EmulationStealthListen: SECURE_ELEMENT_CARD_EMULATION_MODE = 3;
pub const ExtendedSnepServer: NFC_SNEP_SERVER_TYPE = 1;
pub const External: SECURE_ELEMENT_TYPE = 1;
pub const ExternalFieldEnter: SECURE_ELEMENT_EVENT_TYPE = 6;
pub const ExternalFieldExit: SECURE_ELEMENT_EVENT_TYPE = 7;
pub const ExternalReaderArrival: SECURE_ELEMENT_EVENT_TYPE = 0;
pub const ExternalReaderDeparture: SECURE_ELEMENT_EVENT_TYPE = 1;
...
pub const HceActivated: SECURE_ELEMENT_EVENT_TYPE = 4;
pub const HceDeactivated: SECURE_ELEMENT_EVENT_TYPE = 5;
pub const IOCTL_NFCDTA_CONFIG_P2P_PARAM: u32 = 2233376;
pub const IOCTL_NFCDTA_CONFIG_RF_DISCOVERY: u32 = 2233344;
pub const IOCTL_NFCDTA_LLCP_ACTIVATE: u32 = 2233476;
pub const IOCTL_NFCDTA_LLCP_CONFIG: u32 = 2233472;
pub const IOCTL_NFCDTA_LLCP_DEACTIVATE: u32 = 2233480;
pub const IOCTL_NFCDTA_LLCP_DISCOVER_SERVICES: u32 = 2233484;
pub const IOCTL_NFCDTA_LLCP_GET_NEXT_LINK_STATUS: u32 = 2233492;
pub const IOCTL_NFCDTA_LLCP_LINK_STATUS_CHECK: u32 = 2233488;
pub const IOCTL_NFCDTA_LLCP_SOCKET_ACCEPT: u32 = 2233512;
pub const IOCTL_NFCDTA_LLCP_SOCKET_BIND: u32 = 2233504;
pub const IOCTL_NFCDTA_LLCP_SOCKET_CLOSE: u32 = 2233500;
pub const IOCTL_NFCDTA_LLCP_SOCKET_CONNECT: u32 = 2233516;
pub const IOCTL_NFCDTA_LLCP_SOCKET_CREATE: u32 = 2233496;
pub const IOCTL_NFCDTA_LLCP_SOCKET_DISCONNECT: u32 = 2233520;
pub const IOCTL_NFCDTA_LLCP_SOCKET_GET_NEXT_ERROR: u32 = 2233540;
pub const IOCTL_NFCDTA_LLCP_SOCKET_LISTEN: u32 = 2233508;
pub const IOCTL_NFCDTA_LLCP_SOCKET_RECV: u32 = 2233524;
pub const IOCTL_NFCDTA_LLCP_SOCKET_RECV_FROM: u32 = 2233528;
pub const IOCTL_NFCDTA_LLCP_SOCKET_SEND: u32 = 2233532;
pub const IOCTL_NFCDTA_LLCP_SOCKET_SNED_TO: u32 = 2233536;
pub const IOCTL_NFCDTA_REMOTE_DEV_CHECK_PRESENCE: u32 = 2233372;
pub const IOCTL_NFCDTA_REMOTE_DEV_CONNECT: u32 = 2233352;
pub const IOCTL_NFCDTA_REMOTE_DEV_DISCONNECT: u32 = 2233356;
pub const IOCTL_NFCDTA_REMOTE_DEV_GET_NEXT: u32 = 2233348;
pub const IOCTL_NFCDTA_REMOTE_DEV_NDEF_CHECK: u32 = 2233420;
pub const IOCTL_NFCDTA_REMOTE_DEV_NDEF_CONVERT_READ_ONLY: u32 = 2233416;
pub const IOCTL_NFCDTA_REMOTE_DEV_NDEF_READ: u32 = 2233412;
pub const IOCTL_NFCDTA_REMOTE_DEV_NDEF_WRITE: u32 = 2233408;
pub const IOCTL_NFCDTA_REMOTE_DEV_RECV: u32 = 2233364;
pub const IOCTL_NFCDTA_REMOTE_DEV_SEND: u32 = 2233368;
pub const IOCTL_NFCDTA_REMOTE_DEV_TRANSCEIVE: u32 = 2233360;
pub const IOCTL_NFCDTA_SET_RF_CONFIG: u32 = 2233380;
pub const IOCTL_NFCDTA_SE_ENUMERATE: u32 = 2233728;
pub const IOCTL_NFCDTA_SE_GET_NEXT_EVENT: u32 = 2233740;
pub const IOCTL_NFCDTA_SE_SET_EMULATION_MODE: u32 = 2233732;
pub const IOCTL_NFCDTA_SE_SET_ROUTING_TABLE: u32 = 2233736;
pub const IOCTL_NFCDTA_SNEP_CLIENT_GET: u32 = 2233676;
pub const IOCTL_NFCDTA_SNEP_CLIENT_PUT: u32 = 2233672;
pub const IOCTL_NFCDTA_SNEP_DEINIT_CLIENT: u32 = 2233668;
pub const IOCTL_NFCDTA_SNEP_DEINIT_SERVER: u32 = 2233604;
pub const IOCTL_NFCDTA_SNEP_INIT_CLIENT: u32 = 2233664;
pub const IOCTL_NFCDTA_SNEP_INIT_SERVER: u32 = 2233600;
pub const IOCTL_NFCDTA_SNEP_SERVER_ACCEPT: u32 = 2233612;
pub const IOCTL_NFCDTA_SNEP_SERVER_GET_NEXT_CONNECTION: u32 = 2233608;
pub const IOCTL_NFCDTA_SNEP_SERVER_GET_NEXT_REQUEST: u32 = 2233616;
pub const IOCTL_NFCDTA_SNEP_SERVER_SEND_RESPONSE: u32 = 2233620;
pub const IOCTL_NFCRM_QUERY_RADIO_STATE: u32 = 5308808;
pub const IOCTL_NFCRM_SET_RADIO_STATE: u32 = 5308804;
pub const IOCTL_NFCSERM_QUERY_RADIO_STATE: u32 = 5308816;
pub const IOCTL_NFCSERM_SET_RADIO_STATE: u32 = 5308812;
pub const IOCTL_NFCSE_ENUM_ENDPOINTS: u32 = 2230272;
pub const IOCTL_NFCSE_GET_NEXT_EVENT: u32 = 2230280;
pub const IOCTL_NFCSE_GET_NFCC_CAPABILITIES: u32 = 2230288;
pub const IOCTL_NFCSE_GET_ROUTING_TABLE: u32 = 2230292;
pub const IOCTL_NFCSE_HCE_REMOTE_RECV: u32 = 2230592;
pub const IOCTL_NFCSE_HCE_REMOTE_SEND: u32 = 2230596;
pub const IOCTL_NFCSE_SET_CARD_EMULATION_MODE: u32 = 2230284;
pub const IOCTL_NFCSE_SET_POWER_MODE: u32 = 2230600;
pub const IOCTL_NFCSE_SET_ROUTING_TABLE: u32 = 2230296;
pub const IOCTL_NFCSE_SUBSCRIBE_FOR_EVENT: u32 = 2230276;
pub const ISO_7816_MAXIMUM_AID_LENGTH: u32 = 16;
pub const ISO_7816_MINIMUM_AID_LENGTH: u32 = 5;
pub const IdleMode: NFC_RELEASE_TYPE = 0;
pub const Integrated: SECURE_ELEMENT_TYPE = 0;
pub const LinkActivated: NFC_LLCP_LINK_STATUS = 0;
pub const LinkDeactivated: NFC_LLCP_LINK_STATUS = 1;
pub const MAX_ATR_LENGTH: u32 = 48;
pub const MAX_LLCP_SERVICE_NAME_SIZE: u32 = 256;
pub const MAX_SNEP_SERVER_NAME_SIZE: u32 = 256;
pub const MAX_UID_SIZE: u32 = 16;
pub const NFCRMDDI_IOCTL_BASE: u32 = 80;
#[repr(C)]
...
pub const NfcConnectBySap: NFC_LLCP_SOCKET_CONNECT_TYPE = 0;
pub const NfcConnectByUri: NFC_LLCP_SOCKET_CONNECT_TYPE = 1;
pub const NfcDepDefault: NFC_P2P_MODE = 0;
pub const NfcDepListen: NFC_P2P_MODE = 2;
pub const NfcDepPoll: NFC_P2P_MODE = 1;
pub const NfcIP1Initiator: NFC_DEVICE_TYPE = 5;
pub const NfcIP1Target: NFC_DEVICE_TYPE = 4;
pub const NfcLlcpErrorBusyCondition: NFC_LLCP_SOCKET_ERROR = 2;
pub const NfcLlcpErrorDisconnected: NFC_LLCP_SOCKET_ERROR = 0;
pub const NfcLlcpErrorFrameRejected: NFC_LLCP_SOCKET_ERROR = 1;
pub const NfcLlcpErrorNotBusyCondition: NFC_LLCP_SOCKET_ERROR = 3;
pub const NfcReader: NFC_DEVICE_TYPE = 6;
pub const NfcType1Tag: NFC_DEVICE_TYPE = 0;
pub const NfcType2Tag: NFC_DEVICE_TYPE = 1;
pub const NfcType3Tag: NFC_DEVICE_TYPE = 2;
pub const NfcType4Tag: NFC_DEVICE_TYPE = 3;
pub const RFDiscoveryResume: NFC_RF_DISCOVERY_MODE = 2;
pub const RfDiscoveryConfig: NFC_RF_DISCOVERY_MODE = 0;
pub const RfDiscoveryStart: NFC_RF_DISCOVERY_MODE = 1;
pub const RoutingTypeAid: SECURE_ELEMENT_ROUTING_TYPE = 2;
pub const RoutingTypeProtocol: SECURE_ELEMENT_ROUTING_TYPE = 1;
pub const RoutingTypeTech: SECURE_ELEMENT_ROUTING_TYPE = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const SEPowerMode_AllowOff: SECURE_ELEMENT_POWER_MODE = 1;
pub const SEPowerMode_ForceOn: SECURE_ELEMENT_POWER_MODE = 0;
pub const SleepMode: NFC_RELEASE_TYPE = 1;
pub const SnepRequestGet: NFC_SNEP_REQUEST_TYPE = 0;
pub const SnepRequestPut: NFC_SNEP_REQUEST_TYPE = 1;
pub const Transaction: SECURE_ELEMENT_EVENT_TYPE = 3;
