...
pub const AUTO_CLEAR_STALL: WINUSB_PIPE_POLICY = 2;
pub const AUTO_FLUSH: WINUSB_PIPE_POLICY = 6;
pub const AUTO_SUSPEND: WINUSB_POWER_POLICY = 129;
...
pub const AsymLink: USB4_STATUS = 39;
...
pub const DpBw: USB4_STATUS = 32;
pub const DpConChange: USB4_STATUS = 36;
pub const DpTxDiscovery: USB4_STATUS = 37;
...
pub const EVENT_PIPE: PIPE_TYPE = 0;
pub const EnumerationFailure: USB_NOTIFICATION_TYPE = 0;
pub const ErrAddr: USB4_STATUS = 2;
pub const ErrAdp: USB4_STATUS = 4;
pub const ErrConn: USB4_STATUS = 0;
pub const ErrEnum: USB4_STATUS = 8;
pub const ErrFc: USB4_STATUS = 13;
pub const ErrHec: USB4_STATUS = 12;
pub const ErrLen: USB4_STATUS = 11;
pub const ErrLink: USB4_STATUS = 1;
pub const ErrLock: USB4_STATUS = 15;
pub const ErrNua: USB4_STATUS = 9;
pub const ErrPlug: USB4_STATUS = 14;
...
pub const IGNORE_SHORT_PACKETS: WINUSB_PIPE_POLICY = 4;
...
pub const LinkRecovery: USB4_STATUS = 38;
pub const LowSpeed: u32 = 1;
pub const MAXIMUM_TRANSFER_SIZE: WINUSB_PIPE_POLICY = 8;
...
pub const PIPE_TRANSFER_TIMEOUT: WINUSB_PIPE_POLICY = 3;
...
pub const PcieWake: USB4_STATUS = 35;
pub const PollingSkipped: USB4_STATUS = 252;
pub const PollingTimeout: USB4_STATUS = 253;
pub const PopCmplt: USB4_STATUS = 34;
pub const RAW_IO: WINUSB_PIPE_POLICY = 7;
...
pub const READ_DATA_PIPE: PIPE_TYPE = 1;
pub const RESET_PIPE_ON_RESUME: WINUSB_PIPE_POLICY = 9;
pub const ResetOvercurrent: USB_NOTIFICATION_TYPE = 4;
pub const RopCmplt: USB4_STATUS = 33;
pub const SHORT_PACKET_TERMINATE: WINUSB_PIPE_POLICY = 1;
pub const SUSPEND_DELAY: WINUSB_POWER_POLICY = 131;
pub const StatusSuccess: USB4_STATUS = 254;
pub const StatusUnknown: USB4_STATUS = 255;
...
pub const USB4AdapterConfigurationSpace: USB4_CONFIG_SPACE_TYPE = 1;
pub const USB4CounterConfigurationSpace: USB4_CONFIG_SPACE_TYPE = 3;
pub const USB4PathConfigurationSpace: USB4_CONFIG_SPACE_TYPE = 0;
pub const USB4RouterConfigurationSpace: USB4_CONFIG_SPACE_TYPE = 2;
...
pub const UsbUserBufferTooSmall: USB_USER_ERROR_CODE = 7;
pub const UsbUserDeviceNotStarted: USB_USER_ERROR_CODE = 9;
pub const UsbUserErrorNotMapped: USB_USER_ERROR_CODE = 8;
pub const UsbUserFeatureDisabled: USB_USER_ERROR_CODE = 3;
pub const UsbUserInvalidHeaderParameter: USB_USER_ERROR_CODE = 4;
pub const UsbUserInvalidParameter: USB_USER_ERROR_CODE = 5;
pub const UsbUserInvalidRequestCode: USB_USER_ERROR_CODE = 2;
pub const UsbUserMiniportError: USB_USER_ERROR_CODE = 6;
pub const UsbUserNoDeviceConnected: USB_USER_ERROR_CODE = 10;
pub const UsbUserNotSupported: USB_USER_ERROR_CODE = 1;
pub const UsbUserSuccess: USB_USER_ERROR_CODE = 0;
...
pub const UsbfnBusSpeedFull: USBFN_BUS_SPEED = 1;
pub const UsbfnBusSpeedHigh: USBFN_BUS_SPEED = 2;
pub const UsbfnBusSpeedLow: USBFN_BUS_SPEED = 0;
pub const UsbfnBusSpeedMaximum: USBFN_BUS_SPEED = 4;
pub const UsbfnBusSpeedSuper: USBFN_BUS_SPEED = 3;
pub const UsbfnChargingDownstreamPort: USBFN_PORT_TYPE = 2;
pub const UsbfnDedicatedChargingPort: USBFN_PORT_TYPE = 3;
pub const UsbfnDeviceStateAddressed: USBFN_DEVICE_STATE = 4;
pub const UsbfnDeviceStateAttached: USBFN_DEVICE_STATE = 1;
pub const UsbfnDeviceStateConfigured: USBFN_DEVICE_STATE = 5;
pub const UsbfnDeviceStateDefault: USBFN_DEVICE_STATE = 2;
pub const UsbfnDeviceStateDetached: USBFN_DEVICE_STATE = 3;
pub const UsbfnDeviceStateMinimum: USBFN_DEVICE_STATE = 0;
pub const UsbfnDeviceStateStateMaximum: USBFN_DEVICE_STATE = 7;
pub const UsbfnDeviceStateSuspended: USBFN_DEVICE_STATE = 6;
pub const UsbfnDirectionIn: USBFN_DIRECTION = 1;
pub const UsbfnDirectionMaximum: USBFN_DIRECTION = 3;
pub const UsbfnDirectionMinimum: USBFN_DIRECTION = 0;
pub const UsbfnDirectionOut: USBFN_DIRECTION = 2;
pub const UsbfnDirectionRx: USBFN_DIRECTION = 2;
pub const UsbfnDirectionTx: USBFN_DIRECTION = 1;
pub const UsbfnEventAttach: USBFN_EVENT = 1;
pub const UsbfnEventBusTearDown: USBFN_EVENT = 10;
pub const UsbfnEventConfigured: USBFN_EVENT = 7;
pub const UsbfnEventDetach: USBFN_EVENT = 3;
pub const UsbfnEventMaximum: USBFN_EVENT = 12;
pub const UsbfnEventMinimum: USBFN_EVENT = 0;
pub const UsbfnEventPortType: USBFN_EVENT = 9;
pub const UsbfnEventReset: USBFN_EVENT = 2;
pub const UsbfnEventResume: USBFN_EVENT = 5;
pub const UsbfnEventSetInterface: USBFN_EVENT = 11;
pub const UsbfnEventSetupPacket: USBFN_EVENT = 6;
pub const UsbfnEventSuspend: USBFN_EVENT = 4;
pub const UsbfnEventUnConfigured: USBFN_EVENT = 8;
pub const UsbfnInvalidDedicatedChargingPort: USBFN_PORT_TYPE = 4;
pub const UsbfnPortTypeMaximum: USBFN_PORT_TYPE = 6;
pub const UsbfnProprietaryDedicatedChargingPort: USBFN_PORT_TYPE = 5;
pub const UsbfnStandardDownstreamPort: USBFN_PORT_TYPE = 1;
pub const UsbfnUnknownPort: USBFN_PORT_TYPE = 0;
...
pub const WRITE_DATA_PIPE: PIPE_TYPE = 2;
pub const WdmUsbPowerDeviceD0: WDMUSB_POWER_STATE = 201;
pub const WdmUsbPowerDeviceD1: WDMUSB_POWER_STATE = 202;
pub const WdmUsbPowerDeviceD2: WDMUSB_POWER_STATE = 203;
pub const WdmUsbPowerDeviceD3: WDMUSB_POWER_STATE = 204;
pub const WdmUsbPowerDeviceUnspecified: WDMUSB_POWER_STATE = 200;
pub const WdmUsbPowerNotMapped: WDMUSB_POWER_STATE = 0;
pub const WdmUsbPowerSystemHibernate: WDMUSB_POWER_STATE = 105;
pub const WdmUsbPowerSystemShutdown: WDMUSB_POWER_STATE = 106;
pub const WdmUsbPowerSystemSleeping1: WDMUSB_POWER_STATE = 102;
pub const WdmUsbPowerSystemSleeping2: WDMUSB_POWER_STATE = 103;
pub const WdmUsbPowerSystemSleeping3: WDMUSB_POWER_STATE = 104;
pub const WdmUsbPowerSystemUnspecified: WDMUSB_POWER_STATE = 100;
