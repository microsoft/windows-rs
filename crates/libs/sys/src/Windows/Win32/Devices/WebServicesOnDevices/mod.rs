...
pub type WSDCreateDeviceHost = unsafe extern "system" fn(pszlocalid: windows_sys::core::PCWSTR, pcontext: *mut core::ffi::c_void, ppdevicehost: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WSDCreateDeviceHost2 = unsafe extern "system" fn(pszlocalid: windows_sys::core::PCWSTR, pcontext: *mut core::ffi::c_void, pconfigparams: *const WSD_CONFIG_PARAM, dwconfigparamcount: u32, ppdevicehost: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WSDCreateDeviceHostAdvanced = unsafe extern "system" fn(pszlocalid: windows_sys::core::PCWSTR, pcontext: *mut core::ffi::c_void, pphostaddresses: *const *mut core::ffi::c_void, dwhostaddresscount: u32, ppdevicehost: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WSDCreateDeviceProxy = unsafe extern "system" fn(pszdeviceid: windows_sys::core::PCWSTR, pszlocalid: windows_sys::core::PCWSTR, pcontext: *mut core::ffi::c_void, ppdeviceproxy: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WSDCreateDeviceProxy2 = unsafe extern "system" fn(pszdeviceid: windows_sys::core::PCWSTR, pszlocalid: windows_sys::core::PCWSTR, pcontext: *mut core::ffi::c_void, pconfigparams: *const WSD_CONFIG_PARAM, dwconfigparamcount: u32, ppdeviceproxy: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WSDCreateDeviceProxyAdvanced = unsafe extern "system" fn(pszdeviceid: windows_sys::core::PCWSTR, pdeviceaddress: *mut core::ffi::c_void, pszlocalid: windows_sys::core::PCWSTR, pcontext: *mut core::ffi::c_void, ppdeviceproxy: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WSDCreateDiscoveryProvider = unsafe extern "system" fn(pcontext: *mut core::ffi::c_void, ppprovider: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WSDCreateDiscoveryProvider2 = unsafe extern "system" fn(pcontext: *mut core::ffi::c_void, pconfigparams: *const WSD_CONFIG_PARAM, dwconfigparamcount: u32, ppprovider: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WSDCreateDiscoveryPublisher = unsafe extern "system" fn(pcontext: *mut core::ffi::c_void, pppublisher: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WSDCreateDiscoveryPublisher2 = unsafe extern "system" fn(pcontext: *mut core::ffi::c_void, pconfigparams: *const WSD_CONFIG_PARAM, dwconfigparamcount: u32, pppublisher: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WSDCreateHttpAddress = unsafe extern "system" fn(ppaddress: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("wsdapi.dll" "system" fn WSDCreateHttpAddress(ppaddress : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type WSDCreateHttpMessageParameters = unsafe extern "system" fn(pptxparams: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WSDCreateOutboundAttachment = unsafe extern "system" fn(ppattachment: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WSDCreateUdpAddress = unsafe extern "system" fn(ppaddress: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("wsdapi.dll" "system" fn WSDCreateUdpAddress(ppaddress : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type WSDCreateUdpMessageParameters = unsafe extern "system" fn(pptxparams: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WSDGenerateFault = unsafe extern "system" fn(pszcode: windows_sys::core::PCWSTR, pszsubcode: windows_sys::core::PCWSTR, pszreason: windows_sys::core::PCWSTR, pszdetail: windows_sys::core::PCWSTR, pcontext: *mut core::ffi::c_void, ppfault: *mut *mut WSD_SOAP_FAULT) -> windows_sys::core::HRESULT;
...
pub type WSDGenerateFaultEx = unsafe extern "system" fn(pcode: *const WSDXML_NAME, psubcode: *const WSDXML_NAME, preasons: *const WSD_LOCALIZED_STRING_LIST, pszdetail: windows_sys::core::PCWSTR, ppfault: *mut *mut WSD_SOAP_FAULT) -> windows_sys::core::HRESULT;
...
pub type WSDUriDecode = unsafe extern "system" fn(source: windows_sys::core::PCWSTR, cchsource: u32, destout: *mut windows_sys::core::PWSTR, cchdestout: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WSDUriEncode = unsafe extern "system" fn(source: windows_sys::core::PCWSTR, cchsource: u32, destout: *mut windows_sys::core::PWSTR, cchdestout: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WSDXMLBuildAnyForSingleElement = unsafe extern "system" fn(pelementname: *mut WSDXML_NAME, psztext: windows_sys::core::PCWSTR, ppany: *mut *mut WSDXML_ELEMENT) -> windows_sys::core::HRESULT;
...
pub type WSDXMLCreateContext = unsafe extern "system" fn(ppcontext: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("wsdapi.dll" "system" fn WSDXMLCreateContext(ppcontext : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type WSDXMLGetNameFromBuiltinNamespace = unsafe extern "system" fn(psznamespace: windows_sys::core::PCWSTR, pszname: windows_sys::core::PCWSTR, ppname: *mut *mut WSDXML_NAME) -> windows_sys::core::HRESULT;
...
pub type WSDXMLGetValueFromAny = unsafe extern "system" fn(psznamespace: windows_sys::core::PCWSTR, pszname: windows_sys::core::PCWSTR, pany: *mut WSDXML_ELEMENT, ppszvalue: *mut windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
