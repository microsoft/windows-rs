...
pub const OpAnyElement: WSDXML_OP = 6;
pub const OpAnyElements: WSDXML_OP = 7;
pub const OpAnyNumber: WSDXML_OP = 17;
pub const OpAnyText: WSDXML_OP = 8;
pub const OpAnything: WSDXML_OP = 16;
pub const OpAttribute_: WSDXML_OP = 9;
pub const OpBeginAll: WSDXML_OP = 14;
pub const OpBeginAnyElement: WSDXML_OP = 3;
pub const OpBeginChoice: WSDXML_OP = 10;
pub const OpBeginElement_: WSDXML_OP = 2;
pub const OpBeginSequence: WSDXML_OP = 12;
pub const OpElement_: WSDXML_OP = 5;
pub const OpEndAll: WSDXML_OP = 15;
pub const OpEndChoice: WSDXML_OP = 11;
pub const OpEndElement: WSDXML_OP = 4;
pub const OpEndOfTable: WSDXML_OP = 1;
pub const OpEndSequence: WSDXML_OP = 13;
pub const OpFormatBool_: WSDXML_OP = 20;
pub const OpFormatDateTime_: WSDXML_OP = 40;
pub const OpFormatDom_: WSDXML_OP = 30;
pub const OpFormatDouble_: WSDXML_OP = 42;
pub const OpFormatDuration_: WSDXML_OP = 39;
pub const OpFormatDynamicType_: WSDXML_OP = 37;
pub const OpFormatFloat_: WSDXML_OP = 41;
pub const OpFormatInt16_: WSDXML_OP = 22;
pub const OpFormatInt32_: WSDXML_OP = 23;
pub const OpFormatInt64_: WSDXML_OP = 24;
pub const OpFormatInt8_: WSDXML_OP = 21;
pub const OpFormatListInsertTail_: WSDXML_OP = 35;
pub const OpFormatLookupType_: WSDXML_OP = 38;
pub const OpFormatMax: WSDXML_OP = 46;
pub const OpFormatName_: WSDXML_OP = 34;
pub const OpFormatStruct_: WSDXML_OP = 31;
pub const OpFormatType_: WSDXML_OP = 36;
pub const OpFormatUInt16_: WSDXML_OP = 26;
pub const OpFormatUInt32_: WSDXML_OP = 27;
pub const OpFormatUInt64_: WSDXML_OP = 28;
pub const OpFormatUInt8_: WSDXML_OP = 25;
pub const OpFormatUnicodeString_: WSDXML_OP = 29;
pub const OpFormatUri_: WSDXML_OP = 32;
pub const OpFormatUuidUri_: WSDXML_OP = 33;
pub const OpFormatXMLDeclaration_: WSDXML_OP = 45;
pub const OpNone: WSDXML_OP = 0;
pub const OpOneOrMore: WSDXML_OP = 18;
pub const OpOptional: WSDXML_OP = 19;
pub const OpProcess_: WSDXML_OP = 43;
pub const OpQualifiedAttribute_: WSDXML_OP = 44;
...
pub struct WSD_EVENT {
    ...
    pub MessageParameters: core::mem::ManuallyDrop<*mut core::ffi::c_void>,
}
...
pub struct WSD_HANDLER_CONTEXT {
    ...
    pub Unknown: core::mem::ManuallyDrop<*mut core::ffi::c_void>,
}
