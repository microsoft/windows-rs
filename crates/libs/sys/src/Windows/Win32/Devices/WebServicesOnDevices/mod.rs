::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDAllocateLinkedMemory ( pparent : *mut ::core::ffi::c_void , cbsize : usize ) -> *mut ::core::ffi::c_void );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDAttachLinkedMemory ( pparent : *mut ::core::ffi::c_void , pchild : *mut ::core::ffi::c_void ) -> ( ) );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDCreateDeviceHost ( pszlocalid : :: windows_sys::core::PCWSTR , pcontext : IWSDXMLContext , ppdevicehost : *mut IWSDDeviceHost ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDCreateDeviceHost2 ( pszlocalid : :: windows_sys::core::PCWSTR , pcontext : IWSDXMLContext , pconfigparams : *const WSD_CONFIG_PARAM , dwconfigparamcount : u32 , ppdevicehost : *mut IWSDDeviceHost ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDCreateDeviceHostAdvanced ( pszlocalid : :: windows_sys::core::PCWSTR , pcontext : IWSDXMLContext , pphostaddresses : *const IWSDAddress , dwhostaddresscount : u32 , ppdevicehost : *mut IWSDDeviceHost ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDCreateDeviceProxy ( pszdeviceid : :: windows_sys::core::PCWSTR , pszlocalid : :: windows_sys::core::PCWSTR , pcontext : IWSDXMLContext , ppdeviceproxy : *mut IWSDDeviceProxy ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDCreateDeviceProxy2 ( pszdeviceid : :: windows_sys::core::PCWSTR , pszlocalid : :: windows_sys::core::PCWSTR , pcontext : IWSDXMLContext , pconfigparams : *const WSD_CONFIG_PARAM , dwconfigparamcount : u32 , ppdeviceproxy : *mut IWSDDeviceProxy ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDCreateDeviceProxyAdvanced ( pszdeviceid : :: windows_sys::core::PCWSTR , pdeviceaddress : IWSDAddress , pszlocalid : :: windows_sys::core::PCWSTR , pcontext : IWSDXMLContext , ppdeviceproxy : *mut IWSDDeviceProxy ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDCreateDiscoveryProvider ( pcontext : IWSDXMLContext , ppprovider : *mut IWSDiscoveryProvider ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDCreateDiscoveryProvider2 ( pcontext : IWSDXMLContext , pconfigparams : *const WSD_CONFIG_PARAM , dwconfigparamcount : u32 , ppprovider : *mut IWSDiscoveryProvider ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDCreateDiscoveryPublisher ( pcontext : IWSDXMLContext , pppublisher : *mut IWSDiscoveryPublisher ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDCreateDiscoveryPublisher2 ( pcontext : IWSDXMLContext , pconfigparams : *const WSD_CONFIG_PARAM , dwconfigparamcount : u32 , pppublisher : *mut IWSDiscoveryPublisher ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDCreateHttpAddress ( ppaddress : *mut IWSDHttpAddress ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDCreateHttpMessageParameters ( pptxparams : *mut IWSDHttpMessageParameters ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDCreateOutboundAttachment ( ppattachment : *mut IWSDOutboundAttachment ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDCreateUdpAddress ( ppaddress : *mut IWSDUdpAddress ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDCreateUdpMessageParameters ( pptxparams : *mut IWSDUdpMessageParameters ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDDetachLinkedMemory ( pvoid : *mut ::core::ffi::c_void ) -> ( ) );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDFreeLinkedMemory ( pvoid : *mut ::core::ffi::c_void ) -> ( ) );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDGenerateFault ( pszcode : :: windows_sys::core::PCWSTR , pszsubcode : :: windows_sys::core::PCWSTR , pszreason : :: windows_sys::core::PCWSTR , pszdetail : :: windows_sys::core::PCWSTR , pcontext : IWSDXMLContext , ppfault : *mut *mut WSD_SOAP_FAULT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDGenerateFaultEx ( pcode : *const WSDXML_NAME , psubcode : *const WSDXML_NAME , preasons : *const WSD_LOCALIZED_STRING_LIST , pszdetail : :: windows_sys::core::PCWSTR , ppfault : *mut *mut WSD_SOAP_FAULT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDGetConfigurationOption ( dwoption : u32 , pvoid : *mut ::core::ffi::c_void , cboutbuffer : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDSetConfigurationOption ( dwoption : u32 , pvoid : *const ::core::ffi::c_void , cbinbuffer : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDUriDecode ( source : :: windows_sys::core::PCWSTR , cchsource : u32 , destout : *mut :: windows_sys::core::PWSTR , cchdestout : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDUriEncode ( source : :: windows_sys::core::PCWSTR , cchsource : u32 , destout : *mut :: windows_sys::core::PWSTR , cchdestout : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDXMLAddChild ( pparent : *mut WSDXML_ELEMENT , pchild : *mut WSDXML_ELEMENT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDXMLAddSibling ( pfirst : *mut WSDXML_ELEMENT , psecond : *mut WSDXML_ELEMENT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDXMLBuildAnyForSingleElement ( pelementname : *mut WSDXML_NAME , psztext : :: windows_sys::core::PCWSTR , ppany : *mut *mut WSDXML_ELEMENT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDXMLCleanupElement ( pany : *mut WSDXML_ELEMENT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDXMLCreateContext ( ppcontext : *mut IWSDXMLContext ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDXMLGetNameFromBuiltinNamespace ( psznamespace : :: windows_sys::core::PCWSTR , pszname : :: windows_sys::core::PCWSTR , ppname : *mut *mut WSDXML_NAME ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "wsdapi.dll" ,"system" fn WSDXMLGetValueFromAny ( psznamespace : :: windows_sys::core::PCWSTR , pszname : :: windows_sys::core::PCWSTR , pany : *mut WSDXML_ELEMENT , ppszvalue : *mut :: windows_sys::core::PWSTR ) -> :: windows_sys::core::HRESULT );
