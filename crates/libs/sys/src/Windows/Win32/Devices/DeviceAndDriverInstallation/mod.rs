...
pub type CM_Add_IDA = unsafe extern "system" fn(dndevinst: u32, pszid: windows_sys::core::PCSTR, ulflags: u32) -> CONFIGRET;
windows_link::link!("cfgmgr32.dll" "system" fn CM_Add_IDA(dndevinst : u32, pszid : windows_sys::core::PCSTR, ulflags : u32) -> CONFIGRET);
pub type CM_Add_IDW = unsafe extern "system" fn(dndevinst: u32, pszid: windows_sys::core::PCWSTR, ulflags: u32) -> CONFIGRET;
windows_link::link!("cfgmgr32.dll" "system" fn CM_Add_IDW(dndevinst : u32, pszid : windows_sys::core::PCWSTR, ulflags : u32) -> CONFIGRET);
pub type CM_Add_ID_ExA = unsafe extern "system" fn(dndevinst: u32, pszid: windows_sys::core::PCSTR, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Add_ID_ExW = unsafe extern "system" fn(dndevinst: u32, pszid: windows_sys::core::PCWSTR, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Connect_MachineA = unsafe extern "system" fn(uncservername: windows_sys::core::PCSTR, phmachine: *mut isize) -> CONFIGRET;
...
pub type CM_Connect_MachineW = unsafe extern "system" fn(uncservername: windows_sys::core::PCWSTR, phmachine: *mut isize) -> CONFIGRET;
...
pub type CM_Create_DevNodeA = unsafe extern "system" fn(pdndevinst: *mut u32, pdeviceid: windows_sys::core::PCSTR, dnparent: u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Create_DevNodeW = unsafe extern "system" fn(pdndevinst: *mut u32, pdeviceid: windows_sys::core::PCWSTR, dnparent: u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Create_DevNode_ExA = unsafe extern "system" fn(pdndevinst: *mut u32, pdeviceid: windows_sys::core::PCSTR, dnparent: u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Create_DevNode_ExW = unsafe extern "system" fn(pdndevinst: *mut u32, pdeviceid: windows_sys::core::PCWSTR, dnparent: u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Delete_Device_Interface_KeyA = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCSTR, ulflags: u32) -> CONFIGRET;
...
pub type CM_Delete_Device_Interface_KeyW = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCWSTR, ulflags: u32) -> CONFIGRET;
...
pub type CM_Delete_Device_Interface_Key_ExA = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCSTR, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Delete_Device_Interface_Key_ExW = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCWSTR, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Detect_Resource_Conflict = unsafe extern "system" fn(dndevinst: u32, resourceid: u32, resourcedata: *const core::ffi::c_void, resourcelen: u32, pbconflictdetected: *mut windows_sys::core::BOOL, ulflags: u32) -> CONFIGRET;
...
pub type CM_Detect_Resource_Conflict_Ex = unsafe extern "system" fn(dndevinst: u32, resourceid: u32, resourcedata: *const core::ffi::c_void, resourcelen: u32, pbconflictdetected: *mut windows_sys::core::BOOL, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Enumerate_Classes = unsafe extern "system" fn(ulclassindex: u32, classguid: *mut windows_sys::core::GUID, ulflags: CM_ENUMERATE_FLAGS) -> CONFIGRET;
...
pub type CM_Enumerate_Classes_Ex = unsafe extern "system" fn(ulclassindex: u32, classguid: *mut windows_sys::core::GUID, ulflags: CM_ENUMERATE_FLAGS, hmachine: isize) -> CONFIGRET;
...
pub type CM_Enumerate_EnumeratorsA = unsafe extern "system" fn(ulenumindex: u32, buffer: windows_sys::core::PSTR, pullength: *mut u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Enumerate_EnumeratorsW = unsafe extern "system" fn(ulenumindex: u32, buffer: windows_sys::core::PWSTR, pullength: *mut u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Enumerate_Enumerators_ExA = unsafe extern "system" fn(ulenumindex: u32, buffer: windows_sys::core::PSTR, pullength: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Enumerate_Enumerators_ExW = unsafe extern "system" fn(ulenumindex: u32, buffer: windows_sys::core::PWSTR, pullength: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Class_Key_NameA = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, pszkeyname: windows_sys::core::PSTR, pullength: *mut u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_Class_Key_NameW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, pszkeyname: windows_sys::core::PWSTR, pullength: *mut u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_Class_Key_Name_ExA = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, pszkeyname: windows_sys::core::PSTR, pullength: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Class_Key_Name_ExW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, pszkeyname: windows_sys::core::PWSTR, pullength: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Class_NameA = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, buffer: windows_sys::core::PSTR, pullength: *mut u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_Class_NameW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, buffer: windows_sys::core::PWSTR, pullength: *mut u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_Class_Name_ExA = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, buffer: windows_sys::core::PSTR, pullength: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Class_Name_ExW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, buffer: windows_sys::core::PWSTR, pullength: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Class_PropertyW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: *mut super::Properties::DEVPROPTYPE, propertybuffer: *mut u8, propertybuffersize: *mut u32, ulflags: u32) -> CONFIGRET;
#[cfg(feature = "Win32_Devices_Properties")]
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type CM_Get_Class_Property_ExW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: *mut super::Properties::DEVPROPTYPE, propertybuffer: *mut u8, propertybuffersize: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
#[cfg(feature = "Win32_Devices_Properties")]
...
pub type CM_Get_Class_Property_Keys = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, propertykeyarray: *mut super::super::Foundation::DEVPROPKEY, propertykeycount: *mut u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_Class_Property_Keys_Ex = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, propertykeyarray: *mut super::super::Foundation::DEVPROPKEY, propertykeycount: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_DevNode_Custom_PropertyA = unsafe extern "system" fn(dndevinst: u32, pszcustompropertyname: windows_sys::core::PCSTR, pulregdatatype: *mut u32, buffer: *mut core::ffi::c_void, pullength: *mut u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_DevNode_Custom_PropertyW = unsafe extern "system" fn(dndevinst: u32, pszcustompropertyname: windows_sys::core::PCWSTR, pulregdatatype: *mut u32, buffer: *mut core::ffi::c_void, pullength: *mut u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_DevNode_Custom_Property_ExA = unsafe extern "system" fn(dndevinst: u32, pszcustompropertyname: windows_sys::core::PCSTR, pulregdatatype: *mut u32, buffer: *mut core::ffi::c_void, pullength: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_DevNode_Custom_Property_ExW = unsafe extern "system" fn(dndevinst: u32, pszcustompropertyname: windows_sys::core::PCWSTR, pulregdatatype: *mut u32, buffer: *mut core::ffi::c_void, pullength: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type CM_Get_DevNode_PropertyW = unsafe extern "system" fn(dndevinst: u32, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: *mut super::Properties::DEVPROPTYPE, propertybuffer: *mut u8, propertybuffersize: *mut u32, ulflags: u32) -> CONFIGRET;
#[cfg(feature = "Win32_Devices_Properties")]
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type CM_Get_DevNode_Property_ExW = unsafe extern "system" fn(dndevinst: u32, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: *mut super::Properties::DEVPROPTYPE, propertybuffer: *mut u8, propertybuffersize: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
#[cfg(feature = "Win32_Devices_Properties")]
...
pub type CM_Get_DevNode_Property_Keys = unsafe extern "system" fn(dndevinst: u32, propertykeyarray: *mut super::super::Foundation::DEVPROPKEY, propertykeycount: *mut u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_DevNode_Property_Keys_Ex = unsafe extern "system" fn(dndevinst: u32, propertykeyarray: *mut super::super::Foundation::DEVPROPKEY, propertykeycount: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_DevNode_Status = unsafe extern "system" fn(pulstatus: *mut CM_DEVNODE_STATUS_FLAGS, pulproblemnumber: *mut CM_PROB, dndevinst: u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_DevNode_Status_Ex = unsafe extern "system" fn(pulstatus: *mut CM_DEVNODE_STATUS_FLAGS, pulproblemnumber: *mut CM_PROB, dndevinst: u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Device_IDA = unsafe extern "system" fn(dndevinst: u32, buffer: windows_sys::core::PSTR, bufferlen: u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_Device_IDW = unsafe extern "system" fn(dndevinst: u32, buffer: windows_sys::core::PWSTR, bufferlen: u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_Device_ID_ExA = unsafe extern "system" fn(dndevinst: u32, buffer: windows_sys::core::PSTR, bufferlen: u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Device_ID_ExW = unsafe extern "system" fn(dndevinst: u32, buffer: windows_sys::core::PWSTR, bufferlen: u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Device_ID_ListA = unsafe extern "system" fn(pszfilter: windows_sys::core::PCSTR, buffer: windows_sys::core::PSTR, bufferlen: u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_Device_ID_ListW = unsafe extern "system" fn(pszfilter: windows_sys::core::PCWSTR, buffer: windows_sys::core::PWSTR, bufferlen: u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_Device_ID_List_ExA = unsafe extern "system" fn(pszfilter: windows_sys::core::PCSTR, buffer: windows_sys::core::PSTR, bufferlen: u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Device_ID_List_ExW = unsafe extern "system" fn(pszfilter: windows_sys::core::PCWSTR, buffer: windows_sys::core::PWSTR, bufferlen: u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Device_ID_List_SizeA = unsafe extern "system" fn(pullen: *mut u32, pszfilter: windows_sys::core::PCSTR, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_Device_ID_List_SizeW = unsafe extern "system" fn(pullen: *mut u32, pszfilter: windows_sys::core::PCWSTR, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_Device_ID_List_Size_ExA = unsafe extern "system" fn(pullen: *mut u32, pszfilter: windows_sys::core::PCSTR, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Device_ID_List_Size_ExW = unsafe extern "system" fn(pullen: *mut u32, pszfilter: windows_sys::core::PCWSTR, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Device_Interface_AliasA = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCSTR, aliasinterfaceguid: *const windows_sys::core::GUID, pszaliasdeviceinterface: windows_sys::core::PSTR, pullength: *mut u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_Device_Interface_AliasW = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCWSTR, aliasinterfaceguid: *const windows_sys::core::GUID, pszaliasdeviceinterface: windows_sys::core::PWSTR, pullength: *mut u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_Device_Interface_Alias_ExA = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCSTR, aliasinterfaceguid: *const windows_sys::core::GUID, pszaliasdeviceinterface: windows_sys::core::PSTR, pullength: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Device_Interface_Alias_ExW = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCWSTR, aliasinterfaceguid: *const windows_sys::core::GUID, pszaliasdeviceinterface: windows_sys::core::PWSTR, pullength: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Device_Interface_ListA = unsafe extern "system" fn(interfaceclassguid: *const windows_sys::core::GUID, pdeviceid: windows_sys::core::PCSTR, buffer: windows_sys::core::PSTR, bufferlen: u32, ulflags: CM_GET_DEVICE_INTERFACE_LIST_FLAGS) -> CONFIGRET;
...
pub type CM_Get_Device_Interface_ListW = unsafe extern "system" fn(interfaceclassguid: *const windows_sys::core::GUID, pdeviceid: windows_sys::core::PCWSTR, buffer: windows_sys::core::PWSTR, bufferlen: u32, ulflags: CM_GET_DEVICE_INTERFACE_LIST_FLAGS) -> CONFIGRET;
...
pub type CM_Get_Device_Interface_List_ExA = unsafe extern "system" fn(interfaceclassguid: *const windows_sys::core::GUID, pdeviceid: windows_sys::core::PCSTR, buffer: windows_sys::core::PSTR, bufferlen: u32, ulflags: CM_GET_DEVICE_INTERFACE_LIST_FLAGS, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Device_Interface_List_ExW = unsafe extern "system" fn(interfaceclassguid: *const windows_sys::core::GUID, pdeviceid: windows_sys::core::PCWSTR, buffer: windows_sys::core::PWSTR, bufferlen: u32, ulflags: CM_GET_DEVICE_INTERFACE_LIST_FLAGS, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Device_Interface_List_SizeA = unsafe extern "system" fn(pullen: *mut u32, interfaceclassguid: *const windows_sys::core::GUID, pdeviceid: windows_sys::core::PCSTR, ulflags: CM_GET_DEVICE_INTERFACE_LIST_FLAGS) -> CONFIGRET;
...
pub type CM_Get_Device_Interface_List_SizeW = unsafe extern "system" fn(pullen: *mut u32, interfaceclassguid: *const windows_sys::core::GUID, pdeviceid: windows_sys::core::PCWSTR, ulflags: CM_GET_DEVICE_INTERFACE_LIST_FLAGS) -> CONFIGRET;
...
pub type CM_Get_Device_Interface_List_Size_ExA = unsafe extern "system" fn(pullen: *mut u32, interfaceclassguid: *const windows_sys::core::GUID, pdeviceid: windows_sys::core::PCSTR, ulflags: CM_GET_DEVICE_INTERFACE_LIST_FLAGS, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Device_Interface_List_Size_ExW = unsafe extern "system" fn(pullen: *mut u32, interfaceclassguid: *const windows_sys::core::GUID, pdeviceid: windows_sys::core::PCWSTR, ulflags: CM_GET_DEVICE_INTERFACE_LIST_FLAGS, hmachine: isize) -> CONFIGRET;
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type CM_Get_Device_Interface_PropertyW = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCWSTR, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: *mut super::Properties::DEVPROPTYPE, propertybuffer: *mut u8, propertybuffersize: *mut u32, ulflags: u32) -> CONFIGRET;
#[cfg(feature = "Win32_Devices_Properties")]
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type CM_Get_Device_Interface_Property_ExW = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCWSTR, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: *mut super::Properties::DEVPROPTYPE, propertybuffer: *mut u8, propertybuffersize: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
#[cfg(feature = "Win32_Devices_Properties")]
...
pub type CM_Get_Device_Interface_Property_KeysW = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCWSTR, propertykeyarray: *mut super::super::Foundation::DEVPROPKEY, propertykeycount: *mut u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_Device_Interface_Property_Keys_ExW = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCWSTR, propertykeyarray: *mut super::super::Foundation::DEVPROPKEY, propertykeycount: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_First_Log_Conf = unsafe extern "system" fn(plclogconf: *mut usize, dndevinst: u32, ulflags: CM_LOG_CONF) -> CONFIGRET;
...
pub type CM_Get_First_Log_Conf_Ex = unsafe extern "system" fn(plclogconf: *mut usize, dndevinst: u32, ulflags: CM_LOG_CONF, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_HW_Prof_FlagsA = unsafe extern "system" fn(pdeviceid: windows_sys::core::PCSTR, ulhardwareprofile: u32, pulvalue: *mut u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_HW_Prof_FlagsW = unsafe extern "system" fn(pdeviceid: windows_sys::core::PCWSTR, ulhardwareprofile: u32, pulvalue: *mut u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_HW_Prof_Flags_ExA = unsafe extern "system" fn(pdeviceid: windows_sys::core::PCSTR, ulhardwareprofile: u32, pulvalue: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_HW_Prof_Flags_ExW = unsafe extern "system" fn(pdeviceid: windows_sys::core::PCWSTR, ulhardwareprofile: u32, pulvalue: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Hardware_Profile_InfoA = unsafe extern "system" fn(ulindex: u32, phwprofileinfo: *mut HWPROFILEINFO_A, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_Hardware_Profile_InfoW = unsafe extern "system" fn(ulindex: u32, phwprofileinfo: *mut HWPROFILEINFO_W, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_Hardware_Profile_Info_ExA = unsafe extern "system" fn(ulindex: u32, phwprofileinfo: *mut HWPROFILEINFO_A, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Hardware_Profile_Info_ExW = unsafe extern "system" fn(ulindex: u32, phwprofileinfo: *mut HWPROFILEINFO_W, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Get_Next_Res_Des = unsafe extern "system" fn(prdresdes: *mut usize, rdresdes: usize, forresource: CM_RESTYPE, presourceid: *mut CM_RESTYPE, ulflags: u32) -> CONFIGRET;
...
pub type CM_Get_Next_Res_Des_Ex = unsafe extern "system" fn(prdresdes: *mut usize, rdresdes: usize, forresource: CM_RESTYPE, presourceid: *mut CM_RESTYPE, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Is_Dock_Station_Present = unsafe extern "system" fn(pbpresent: *mut windows_sys::core::BOOL) -> CONFIGRET;
windows_link::link!("cfgmgr32.dll" "system" fn CM_Is_Dock_Station_Present(pbpresent : *mut windows_sys::core::BOOL) -> CONFIGRET);
pub type CM_Is_Dock_Station_Present_Ex = unsafe extern "system" fn(pbpresent: *mut windows_sys::core::BOOL, hmachine: isize) -> CONFIGRET;
...
pub type CM_Is_Version_Available = unsafe extern "system" fn(wversion: u16) -> windows_sys::core::BOOL;
windows_link::link!("cfgmgr32.dll" "system" fn CM_Is_Version_Available(wversion : u16) -> windows_sys::core::BOOL);
pub type CM_Is_Version_Available_Ex = unsafe extern "system" fn(wversion: u16, hmachine: isize) -> windows_sys::core::BOOL;
windows_link::link!("cfgmgr32.dll" "system" fn CM_Is_Version_Available_Ex(wversion : u16, hmachine : isize) -> windows_sys::core::BOOL);
pub type CM_Locate_DevNodeA = unsafe extern "system" fn(pdndevinst: *mut u32, pdeviceid: windows_sys::core::PCSTR, ulflags: CM_LOCATE_DEVNODE_FLAGS) -> CONFIGRET;
...
pub type CM_Locate_DevNodeW = unsafe extern "system" fn(pdndevinst: *mut u32, pdeviceid: windows_sys::core::PCWSTR, ulflags: CM_LOCATE_DEVNODE_FLAGS) -> CONFIGRET;
...
pub type CM_Locate_DevNode_ExA = unsafe extern "system" fn(pdndevinst: *mut u32, pdeviceid: windows_sys::core::PCSTR, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Locate_DevNode_ExW = unsafe extern "system" fn(pdndevinst: *mut u32, pdeviceid: windows_sys::core::PCWSTR, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Open_Class_KeyA = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, pszclassname: windows_sys::core::PCSTR, samdesired: u32, disposition: u32, phkclass: *mut super::super::System::Registry::HKEY, ulflags: u32) -> CONFIGRET;
#[cfg(feature = "Win32_System_Registry")]
...
#[cfg(feature = "Win32_System_Registry")]
pub type CM_Open_Class_KeyW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, pszclassname: windows_sys::core::PCWSTR, samdesired: u32, disposition: u32, phkclass: *mut super::super::System::Registry::HKEY, ulflags: u32) -> CONFIGRET;
#[cfg(feature = "Win32_System_Registry")]
...
#[cfg(feature = "Win32_System_Registry")]
pub type CM_Open_Class_Key_ExA = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, pszclassname: windows_sys::core::PCSTR, samdesired: u32, disposition: u32, phkclass: *mut super::super::System::Registry::HKEY, ulflags: u32, hmachine: isize) -> CONFIGRET;
#[cfg(feature = "Win32_System_Registry")]
...
#[cfg(feature = "Win32_System_Registry")]
pub type CM_Open_Class_Key_ExW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, pszclassname: windows_sys::core::PCWSTR, samdesired: u32, disposition: u32, phkclass: *mut super::super::System::Registry::HKEY, ulflags: u32, hmachine: isize) -> CONFIGRET;
#[cfg(feature = "Win32_System_Registry")]
...
#[cfg(feature = "Win32_System_Registry")]
pub type CM_Open_Device_Interface_KeyA = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCSTR, samdesired: u32, disposition: u32, phkdeviceinterface: *mut super::super::System::Registry::HKEY, ulflags: u32) -> CONFIGRET;
#[cfg(feature = "Win32_System_Registry")]
...
#[cfg(feature = "Win32_System_Registry")]
pub type CM_Open_Device_Interface_KeyW = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCWSTR, samdesired: u32, disposition: u32, phkdeviceinterface: *mut super::super::System::Registry::HKEY, ulflags: u32) -> CONFIGRET;
#[cfg(feature = "Win32_System_Registry")]
...
#[cfg(feature = "Win32_System_Registry")]
pub type CM_Open_Device_Interface_Key_ExA = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCSTR, samdesired: u32, disposition: u32, phkdeviceinterface: *mut super::super::System::Registry::HKEY, ulflags: u32, hmachine: isize) -> CONFIGRET;
#[cfg(feature = "Win32_System_Registry")]
...
#[cfg(feature = "Win32_System_Registry")]
pub type CM_Open_Device_Interface_Key_ExW = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCWSTR, samdesired: u32, disposition: u32, phkdeviceinterface: *mut super::super::System::Registry::HKEY, ulflags: u32, hmachine: isize) -> CONFIGRET;
#[cfg(feature = "Win32_System_Registry")]
...
pub type CM_Query_And_Remove_SubTreeA = unsafe extern "system" fn(dnancestor: u32, pvetotype: *mut PNP_VETO_TYPE, pszvetoname: windows_sys::core::PSTR, ulnamelength: u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Query_And_Remove_SubTreeW = unsafe extern "system" fn(dnancestor: u32, pvetotype: *mut PNP_VETO_TYPE, pszvetoname: windows_sys::core::PWSTR, ulnamelength: u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Query_And_Remove_SubTree_ExA = unsafe extern "system" fn(dnancestor: u32, pvetotype: *mut PNP_VETO_TYPE, pszvetoname: windows_sys::core::PSTR, ulnamelength: u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Query_And_Remove_SubTree_ExW = unsafe extern "system" fn(dnancestor: u32, pvetotype: *mut PNP_VETO_TYPE, pszvetoname: windows_sys::core::PWSTR, ulnamelength: u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Query_Resource_Conflict_List = unsafe extern "system" fn(pclconflictlist: *mut usize, dndevinst: u32, resourceid: CM_RESTYPE, resourcedata: *const core::ffi::c_void, resourcelen: u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Reenumerate_DevNode = unsafe extern "system" fn(dndevinst: u32, ulflags: CM_REENUMERATE_FLAGS) -> CONFIGRET;
...
pub type CM_Register_Device_InterfaceA = unsafe extern "system" fn(dndevinst: u32, interfaceclassguid: *const windows_sys::core::GUID, pszreference: windows_sys::core::PCSTR, pszdeviceinterface: windows_sys::core::PSTR, pullength: *mut u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Register_Device_InterfaceW = unsafe extern "system" fn(dndevinst: u32, interfaceclassguid: *const windows_sys::core::GUID, pszreference: windows_sys::core::PCWSTR, pszdeviceinterface: windows_sys::core::PWSTR, pullength: *mut u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Register_Device_Interface_ExA = unsafe extern "system" fn(dndevinst: u32, interfaceclassguid: *const windows_sys::core::GUID, pszreference: windows_sys::core::PCSTR, pszdeviceinterface: windows_sys::core::PSTR, pullength: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Register_Device_Interface_ExW = unsafe extern "system" fn(dndevinst: u32, interfaceclassguid: *const windows_sys::core::GUID, pszreference: windows_sys::core::PCWSTR, pszdeviceinterface: windows_sys::core::PWSTR, pullength: *mut u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Register_Notification = unsafe extern "system" fn(pfilter: *const CM_NOTIFY_FILTER, pcontext: *const core::ffi::c_void, pcallback: PCM_NOTIFY_CALLBACK, pnotifycontext: *mut HCMNOTIFICATION) -> CONFIGRET;
...
pub type CM_Request_Device_EjectA = unsafe extern "system" fn(dndevinst: u32, pvetotype: *mut PNP_VETO_TYPE, pszvetoname: windows_sys::core::PSTR, ulnamelength: u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Request_Device_EjectW = unsafe extern "system" fn(dndevinst: u32, pvetotype: *mut PNP_VETO_TYPE, pszvetoname: windows_sys::core::PWSTR, ulnamelength: u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Request_Device_Eject_ExA = unsafe extern "system" fn(dndevinst: u32, pvetotype: *mut PNP_VETO_TYPE, pszvetoname: windows_sys::core::PSTR, ulnamelength: u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Request_Device_Eject_ExW = unsafe extern "system" fn(dndevinst: u32, pvetotype: *mut PNP_VETO_TYPE, pszvetoname: windows_sys::core::PWSTR, ulnamelength: u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type CM_Set_Class_PropertyW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: super::Properties::DEVPROPTYPE, propertybuffer: *const u8, propertybuffersize: u32, ulflags: u32) -> CONFIGRET;
#[cfg(feature = "Win32_Devices_Properties")]
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type CM_Set_Class_Property_ExW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: super::Properties::DEVPROPTYPE, propertybuffer: *const u8, propertybuffersize: u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
#[cfg(feature = "Win32_Devices_Properties")]
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type CM_Set_DevNode_PropertyW = unsafe extern "system" fn(dndevinst: u32, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: super::Properties::DEVPROPTYPE, propertybuffer: *const u8, propertybuffersize: u32, ulflags: u32) -> CONFIGRET;
#[cfg(feature = "Win32_Devices_Properties")]
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type CM_Set_DevNode_Property_ExW = unsafe extern "system" fn(dndevinst: u32, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: super::Properties::DEVPROPTYPE, propertybuffer: *const u8, propertybuffersize: u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
#[cfg(feature = "Win32_Devices_Properties")]
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type CM_Set_Device_Interface_PropertyW = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCWSTR, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: super::Properties::DEVPROPTYPE, propertybuffer: *const u8, propertybuffersize: u32, ulflags: u32) -> CONFIGRET;
#[cfg(feature = "Win32_Devices_Properties")]
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type CM_Set_Device_Interface_Property_ExW = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCWSTR, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: super::Properties::DEVPROPTYPE, propertybuffer: *const u8, propertybuffersize: u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
#[cfg(feature = "Win32_Devices_Properties")]
...
pub type CM_Set_HW_Prof_FlagsA = unsafe extern "system" fn(pdeviceid: windows_sys::core::PCSTR, ulconfig: u32, ulvalue: u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Set_HW_Prof_FlagsW = unsafe extern "system" fn(pdeviceid: windows_sys::core::PCWSTR, ulconfig: u32, ulvalue: u32, ulflags: u32) -> CONFIGRET;
...
pub type CM_Set_HW_Prof_Flags_ExA = unsafe extern "system" fn(pdeviceid: windows_sys::core::PCSTR, ulconfig: u32, ulvalue: u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Set_HW_Prof_Flags_ExW = unsafe extern "system" fn(pdeviceid: windows_sys::core::PCWSTR, ulconfig: u32, ulvalue: u32, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Unregister_Device_InterfaceA = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCSTR, ulflags: u32) -> CONFIGRET;
...
pub type CM_Unregister_Device_InterfaceW = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCWSTR, ulflags: u32) -> CONFIGRET;
...
pub type CM_Unregister_Device_Interface_ExA = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCSTR, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type CM_Unregister_Device_Interface_ExW = unsafe extern "system" fn(pszdeviceinterface: windows_sys::core::PCWSTR, ulflags: u32, hmachine: isize) -> CONFIGRET;
...
pub type DiInstallDevice = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, driverinfodata: *const SP_DRVINFO_DATA_V2_W, flags: DIINSTALLDEVICE_FLAGS, needreboot: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type DiInstallDriverA = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, infpath: windows_sys::core::PCSTR, flags: DIINSTALLDRIVER_FLAGS, needreboot: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type DiInstallDriverW = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, infpath: windows_sys::core::PCWSTR, flags: DIINSTALLDRIVER_FLAGS, needreboot: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type DiRollbackDriver = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, hwndparent: super::super::Foundation::HWND, flags: DIROLLBACKDRIVER_FLAGS, needreboot: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type DiShowUpdateDevice = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, flags: u32, needreboot: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type DiShowUpdateDriver = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, filepath: windows_sys::core::PCWSTR, flags: u32, needreboot: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type DiUninstallDevice = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, flags: u32, needreboot: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type DiUninstallDriverA = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, infpath: windows_sys::core::PCSTR, flags: DIUNINSTALLDRIVER_FLAGS, needreboot: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type DiUninstallDriverW = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, infpath: windows_sys::core::PCWSTR, flags: DIUNINSTALLDRIVER_FLAGS, needreboot: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type InstallHinfSectionA = unsafe extern "system" fn(window: super::super::Foundation::HWND, modulehandle: super::super::Foundation::HINSTANCE, commandline: windows_sys::core::PCSTR, showcommand: i32);
...
pub type InstallHinfSectionW = unsafe extern "system" fn(window: super::super::Foundation::HWND, modulehandle: super::super::Foundation::HINSTANCE, commandline: windows_sys::core::PCWSTR, showcommand: i32);
...
pub type SetupAddInstallSectionToDiskSpaceListA = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, infhandle: *const core::ffi::c_void, layoutinfhandle: *const core::ffi::c_void, sectionname: windows_sys::core::PCSTR, reserved1: *const core::ffi::c_void, reserved2: u32) -> windows_sys::core::BOOL;
...
pub type SetupAddInstallSectionToDiskSpaceListW = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, infhandle: *const core::ffi::c_void, layoutinfhandle: *const core::ffi::c_void, sectionname: windows_sys::core::PCWSTR, reserved1: *const core::ffi::c_void, reserved2: u32) -> windows_sys::core::BOOL;
...
pub type SetupAddSectionToDiskSpaceListA = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, infhandle: *const core::ffi::c_void, listinfhandle: *const core::ffi::c_void, sectionname: windows_sys::core::PCSTR, operation: SETUP_FILE_OPERATION, reserved1: *const core::ffi::c_void, reserved2: u32) -> windows_sys::core::BOOL;
...
pub type SetupAddSectionToDiskSpaceListW = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, infhandle: *const core::ffi::c_void, listinfhandle: *const core::ffi::c_void, sectionname: windows_sys::core::PCWSTR, operation: SETUP_FILE_OPERATION, reserved1: *const core::ffi::c_void, reserved2: u32) -> windows_sys::core::BOOL;
...
pub type SetupAddToDiskSpaceListA = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, targetfilespec: windows_sys::core::PCSTR, filesize: i64, operation: SETUP_FILE_OPERATION, reserved1: *const core::ffi::c_void, reserved2: u32) -> windows_sys::core::BOOL;
...
pub type SetupAddToDiskSpaceListW = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, targetfilespec: windows_sys::core::PCWSTR, filesize: i64, operation: SETUP_FILE_OPERATION, reserved1: *const core::ffi::c_void, reserved2: u32) -> windows_sys::core::BOOL;
...
pub type SetupAddToSourceListA = unsafe extern "system" fn(flags: u32, source: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type SetupAddToSourceListW = unsafe extern "system" fn(flags: u32, source: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SetupAdjustDiskSpaceListA = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, driveroot: windows_sys::core::PCSTR, amount: i64, reserved1: *const core::ffi::c_void, reserved2: u32) -> windows_sys::core::BOOL;
...
pub type SetupAdjustDiskSpaceListW = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, driveroot: windows_sys::core::PCWSTR, amount: i64, reserved1: *const core::ffi::c_void, reserved2: u32) -> windows_sys::core::BOOL;
...
pub type SetupBackupErrorA = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, dialogtitle: windows_sys::core::PCSTR, sourcefile: windows_sys::core::PCSTR, targetfile: windows_sys::core::PCSTR, win32errorcode: u32, style: u32) -> u32;
...
pub type SetupBackupErrorW = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, dialogtitle: windows_sys::core::PCWSTR, sourcefile: windows_sys::core::PCWSTR, targetfile: windows_sys::core::PCWSTR, win32errorcode: u32, style: u32) -> u32;
...
pub type SetupCancelTemporarySourceList = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("setupapi.dll" "system" fn SetupCancelTemporarySourceList() -> windows_sys::core::BOOL);
pub type SetupCloseFileQueue = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupCommitFileQueueA = unsafe extern "system" fn(owner: super::super::Foundation::HWND, queuehandle: *const core::ffi::c_void, msghandler: PSP_FILE_CALLBACK_A, context: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupCommitFileQueueW = unsafe extern "system" fn(owner: super::super::Foundation::HWND, queuehandle: *const core::ffi::c_void, msghandler: PSP_FILE_CALLBACK_W, context: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupConfigureWmiFromInfSectionA = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, sectionname: windows_sys::core::PCSTR, flags: u32) -> windows_sys::core::BOOL;
...
pub type SetupConfigureWmiFromInfSectionW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, sectionname: windows_sys::core::PCWSTR, flags: u32) -> windows_sys::core::BOOL;
...
pub type SetupCopyOEMInfA = unsafe extern "system" fn(sourceinffilename: windows_sys::core::PCSTR, oemsourcemedialocation: windows_sys::core::PCSTR, oemsourcemediatype: OEM_SOURCE_MEDIA_TYPE, copystyle: SP_COPY_STYLE, destinationinffilename: windows_sys::core::PSTR, destinationinffilenamesize: u32, requiredsize: *mut u32, destinationinffilenamecomponent: *mut windows_sys::core::PSTR) -> windows_sys::core::BOOL;
...
pub type SetupCopyOEMInfW = unsafe extern "system" fn(sourceinffilename: windows_sys::core::PCWSTR, oemsourcemedialocation: windows_sys::core::PCWSTR, oemsourcemediatype: OEM_SOURCE_MEDIA_TYPE, copystyle: SP_COPY_STYLE, destinationinffilename: windows_sys::core::PWSTR, destinationinffilenamesize: u32, requiredsize: *mut u32, destinationinffilenamecomponent: *mut windows_sys::core::PWSTR) -> windows_sys::core::BOOL;
...
pub type SetupCreateDiskSpaceListA = unsafe extern "system" fn(reserved1: *const core::ffi::c_void, reserved2: u32, flags: u32) -> *mut core::ffi::c_void;
...
pub type SetupCreateDiskSpaceListW = unsafe extern "system" fn(reserved1: *const core::ffi::c_void, reserved2: u32, flags: u32) -> *mut core::ffi::c_void;
...
pub type SetupDecompressOrCopyFileA = unsafe extern "system" fn(sourcefilename: windows_sys::core::PCSTR, targetfilename: windows_sys::core::PCSTR, compressiontype: *const FILE_COMPRESSION_TYPE) -> u32;
...
pub type SetupDecompressOrCopyFileW = unsafe extern "system" fn(sourcefilename: windows_sys::core::PCWSTR, targetfilename: windows_sys::core::PCWSTR, compressiontype: *const FILE_COMPRESSION_TYPE) -> u32;
...
pub type SetupDeleteErrorA = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, dialogtitle: windows_sys::core::PCSTR, file: windows_sys::core::PCSTR, win32errorcode: u32, style: u32) -> u32;
...
pub type SetupDeleteErrorW = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, dialogtitle: windows_sys::core::PCWSTR, file: windows_sys::core::PCWSTR, win32errorcode: u32, style: u32) -> u32;
...
pub type SetupDestroyDiskSpaceList = unsafe extern "system" fn(diskspace: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("setupapi.dll" "system" fn SetupDestroyDiskSpaceList(diskspace : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
pub type SetupDiAskForOEMDisk = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiBuildClassInfoList = unsafe extern "system" fn(flags: u32, classguidlist: *mut windows_sys::core::GUID, classguidlistsize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiBuildClassInfoListExA = unsafe extern "system" fn(flags: u32, classguidlist: *mut windows_sys::core::GUID, classguidlistsize: u32, requiredsize: *mut u32, machinename: windows_sys::core::PCSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiBuildClassInfoListExW = unsafe extern "system" fn(flags: u32, classguidlist: *mut windows_sys::core::GUID, classguidlistsize: u32, requiredsize: *mut u32, machinename: windows_sys::core::PCWSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiBuildDriverInfoList = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *mut SP_DEVINFO_DATA, drivertype: SETUP_DI_DRIVER_TYPE) -> windows_sys::core::BOOL;
...
pub type SetupDiCallClassInstaller = unsafe extern "system" fn(installfunction: DI_FUNCTION, deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiCancelDriverInfoSearch = unsafe extern "system" fn(deviceinfoset: HDEVINFO) -> windows_sys::core::BOOL;
windows_link::link!("setupapi.dll" "system" fn SetupDiCancelDriverInfoSearch(deviceinfoset : HDEVINFO) -> windows_sys::core::BOOL);
pub type SetupDiChangeState = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiClassGuidsFromNameA = unsafe extern "system" fn(classname: windows_sys::core::PCSTR, classguidlist: *mut windows_sys::core::GUID, classguidlistsize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiClassGuidsFromNameExA = unsafe extern "system" fn(classname: windows_sys::core::PCSTR, classguidlist: *mut windows_sys::core::GUID, classguidlistsize: u32, requiredsize: *mut u32, machinename: windows_sys::core::PCSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiClassGuidsFromNameExW = unsafe extern "system" fn(classname: windows_sys::core::PCWSTR, classguidlist: *mut windows_sys::core::GUID, classguidlistsize: u32, requiredsize: *mut u32, machinename: windows_sys::core::PCWSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiClassGuidsFromNameW = unsafe extern "system" fn(classname: windows_sys::core::PCWSTR, classguidlist: *mut windows_sys::core::GUID, classguidlistsize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiClassNameFromGuidA = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, classname: windows_sys::core::PSTR, classnamesize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiClassNameFromGuidExA = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, classname: windows_sys::core::PSTR, classnamesize: u32, requiredsize: *mut u32, machinename: windows_sys::core::PCSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiClassNameFromGuidExW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, classname: windows_sys::core::PWSTR, classnamesize: u32, requiredsize: *mut u32, machinename: windows_sys::core::PCWSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiClassNameFromGuidW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, classname: windows_sys::core::PWSTR, classnamesize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_System_Registry")]
pub type SetupDiCreateDevRegKeyA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, scope: u32, hwprofile: u32, keytype: u32, infhandle: *const core::ffi::c_void, infsectionname: windows_sys::core::PCSTR) -> super::super::System::Registry::HKEY;
#[cfg(feature = "Win32_System_Registry")]
...
#[cfg(feature = "Win32_System_Registry")]
pub type SetupDiCreateDevRegKeyW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, scope: u32, hwprofile: u32, keytype: u32, infhandle: *const core::ffi::c_void, infsectionname: windows_sys::core::PCWSTR) -> super::super::System::Registry::HKEY;
#[cfg(feature = "Win32_System_Registry")]
...
pub type SetupDiCreateDeviceInfoList = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, hwndparent: super::super::Foundation::HWND) -> HDEVINFO;
...
pub type SetupDiCreateDeviceInfoListExA = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, hwndparent: super::super::Foundation::HWND, machinename: windows_sys::core::PCSTR, reserved: *const core::ffi::c_void) -> HDEVINFO;
...
pub type SetupDiCreateDeviceInfoListExW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, hwndparent: super::super::Foundation::HWND, machinename: windows_sys::core::PCWSTR, reserved: *const core::ffi::c_void) -> HDEVINFO;
...
pub type SetupDiCreateDeviceInfoW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, devicename: windows_sys::core::PCWSTR, classguid: *const windows_sys::core::GUID, devicedescription: windows_sys::core::PCWSTR, hwndparent: super::super::Foundation::HWND, creationflags: SETUP_DI_DEVICE_CREATION_FLAGS, deviceinfodata: *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiCreateDeviceInterfaceA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, interfaceclassguid: *const windows_sys::core::GUID, referencestring: windows_sys::core::PCSTR, creationflags: u32, deviceinterfacedata: *mut SP_DEVICE_INTERFACE_DATA) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_System_Registry")]
pub type SetupDiCreateDeviceInterfaceRegKeyA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinterfacedata: *const SP_DEVICE_INTERFACE_DATA, reserved: u32, samdesired: u32, infhandle: *const core::ffi::c_void, infsectionname: windows_sys::core::PCSTR) -> super::super::System::Registry::HKEY;
#[cfg(feature = "Win32_System_Registry")]
...
#[cfg(feature = "Win32_System_Registry")]
pub type SetupDiCreateDeviceInterfaceRegKeyW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinterfacedata: *const SP_DEVICE_INTERFACE_DATA, reserved: u32, samdesired: u32, infhandle: *const core::ffi::c_void, infsectionname: windows_sys::core::PCWSTR) -> super::super::System::Registry::HKEY;
#[cfg(feature = "Win32_System_Registry")]
...
pub type SetupDiCreateDeviceInterfaceW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, interfaceclassguid: *const windows_sys::core::GUID, referencestring: windows_sys::core::PCWSTR, creationflags: u32, deviceinterfacedata: *mut SP_DEVICE_INTERFACE_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiDeleteDevRegKey = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, scope: u32, hwprofile: u32, keytype: u32) -> windows_sys::core::BOOL;
...
pub type SetupDiDeleteDeviceInfo = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiDeleteDeviceInterfaceData = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinterfacedata: *const SP_DEVICE_INTERFACE_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiDeleteDeviceInterfaceRegKey = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinterfacedata: *const SP_DEVICE_INTERFACE_DATA, reserved: u32) -> windows_sys::core::BOOL;
...
pub type SetupDiDestroyClassImageList = unsafe extern "system" fn(classimagelistdata: *const SP_CLASSIMAGELIST_DATA) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_UI_Controls")]
...
pub type SetupDiDestroyDeviceInfoList = unsafe extern "system" fn(deviceinfoset: HDEVINFO) -> windows_sys::core::BOOL;
windows_link::link!("setupapi.dll" "system" fn SetupDiDestroyDeviceInfoList(deviceinfoset : HDEVINFO) -> windows_sys::core::BOOL);
pub type SetupDiDestroyDriverInfoList = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, drivertype: SETUP_DI_DRIVER_TYPE) -> windows_sys::core::BOOL;
...
pub type SetupDiEnumDeviceInfo = unsafe extern "system" fn(deviceinfoset: HDEVINFO, memberindex: u32, deviceinfodata: *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiEnumDeviceInterfaces = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, interfaceclassguid: *const windows_sys::core::GUID, memberindex: u32, deviceinterfacedata: *mut SP_DEVICE_INTERFACE_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiEnumDriverInfoA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, drivertype: SETUP_DI_DRIVER_TYPE, memberindex: u32, driverinfodata: *mut SP_DRVINFO_DATA_V2_A) -> windows_sys::core::BOOL;
...
pub type SetupDiEnumDriverInfoW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, drivertype: SETUP_DI_DRIVER_TYPE, memberindex: u32, driverinfodata: *mut SP_DRVINFO_DATA_V2_W) -> windows_sys::core::BOOL;
...
pub type SetupDiGetActualModelsSectionA = unsafe extern "system" fn(context: *const INFCONTEXT, alternateplatforminfo: *const SP_ALTPLATFORM_INFO_V2, infsectionwithext: windows_sys::core::PSTR, infsectionwithextsize: u32, requiredsize: *mut u32, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
...
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
pub type SetupDiGetActualModelsSectionW = unsafe extern "system" fn(context: *const INFCONTEXT, alternateplatforminfo: *const SP_ALTPLATFORM_INFO_V2, infsectionwithext: windows_sys::core::PWSTR, infsectionwithextsize: u32, requiredsize: *mut u32, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
...
pub type SetupDiGetActualSectionToInstallA = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, infsectionname: windows_sys::core::PCSTR, infsectionwithext: windows_sys::core::PSTR, infsectionwithextsize: u32, requiredsize: *mut u32, extension: *mut windows_sys::core::PSTR) -> windows_sys::core::BOOL;
...
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
pub type SetupDiGetActualSectionToInstallExW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, infsectionname: windows_sys::core::PCWSTR, alternateplatforminfo: *const SP_ALTPLATFORM_INFO_V2, infsectionwithext: windows_sys::core::PWSTR, infsectionwithextsize: u32, requiredsize: *mut u32, extension: *mut windows_sys::core::PWSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
...
pub type SetupDiGetActualSectionToInstallW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, infsectionname: windows_sys::core::PCWSTR, infsectionwithext: windows_sys::core::PWSTR, infsectionwithextsize: u32, requiredsize: *mut u32, extension: *mut windows_sys::core::PWSTR) -> windows_sys::core::BOOL;
...
pub type SetupDiGetClassBitmapIndex = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, miniiconindex: *mut i32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetClassDescriptionA = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, classdescription: windows_sys::core::PSTR, classdescriptionsize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetClassDescriptionExA = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, classdescription: windows_sys::core::PSTR, classdescriptionsize: u32, requiredsize: *mut u32, machinename: windows_sys::core::PCSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiGetClassDescriptionExW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, classdescription: windows_sys::core::PWSTR, classdescriptionsize: u32, requiredsize: *mut u32, machinename: windows_sys::core::PCWSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiGetClassDescriptionW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, classdescription: windows_sys::core::PWSTR, classdescriptionsize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetClassDevPropertySheetsA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, propertysheetheader: *const super::super::UI::Controls::PROPSHEETHEADERA_V2, propertysheetheaderpagelistsize: u32, requiredsize: *mut u32, propertysheettype: u32) -> windows_sys::core::BOOL;
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_UI_Controls", feature = "Win32_UI_WindowsAndMessaging"))]
...
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_UI_Controls", feature = "Win32_UI_WindowsAndMessaging"))]
pub type SetupDiGetClassDevPropertySheetsW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, propertysheetheader: *const super::super::UI::Controls::PROPSHEETHEADERW_V2, propertysheetheaderpagelistsize: u32, requiredsize: *mut u32, propertysheettype: u32) -> windows_sys::core::BOOL;
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_UI_Controls", feature = "Win32_UI_WindowsAndMessaging"))]
...
pub type SetupDiGetClassDevsA = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, enumerator: windows_sys::core::PCSTR, hwndparent: super::super::Foundation::HWND, flags: SETUP_DI_GET_CLASS_DEVS_FLAGS) -> HDEVINFO;
...
pub type SetupDiGetClassDevsExA = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, enumerator: windows_sys::core::PCSTR, hwndparent: super::super::Foundation::HWND, flags: SETUP_DI_GET_CLASS_DEVS_FLAGS, deviceinfoset: HDEVINFO, machinename: windows_sys::core::PCSTR, reserved: *const core::ffi::c_void) -> HDEVINFO;
...
pub type SetupDiGetClassDevsW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, enumerator: windows_sys::core::PCWSTR, hwndparent: super::super::Foundation::HWND, flags: SETUP_DI_GET_CLASS_DEVS_FLAGS) -> HDEVINFO;
...
#[cfg(feature = "Win32_UI_Controls")]
pub type SetupDiGetClassImageIndex = unsafe extern "system" fn(classimagelistdata: *const SP_CLASSIMAGELIST_DATA, classguid: *const windows_sys::core::GUID, imageindex: *mut i32) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_UI_Controls")]
...
#[cfg(feature = "Win32_UI_Controls")]
pub type SetupDiGetClassImageList = unsafe extern "system" fn(classimagelistdata: *mut SP_CLASSIMAGELIST_DATA) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_UI_Controls")]
...
#[cfg(feature = "Win32_UI_Controls")]
pub type SetupDiGetClassImageListExA = unsafe extern "system" fn(classimagelistdata: *mut SP_CLASSIMAGELIST_DATA, machinename: windows_sys::core::PCSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_UI_Controls")]
...
#[cfg(feature = "Win32_UI_Controls")]
pub type SetupDiGetClassImageListExW = unsafe extern "system" fn(classimagelistdata: *mut SP_CLASSIMAGELIST_DATA, machinename: windows_sys::core::PCWSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_UI_Controls")]
...
pub type SetupDiGetClassInstallParamsA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, classinstallparams: *mut SP_CLASSINSTALL_HEADER, classinstallparamssize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetClassInstallParamsW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, classinstallparams: *mut SP_CLASSINSTALL_HEADER, classinstallparamssize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetClassPropertyKeys = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, propertykeyarray: *mut super::super::Foundation::DEVPROPKEY, propertykeycount: u32, requiredpropertykeycount: *mut u32, flags: u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetClassPropertyKeysExW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, propertykeyarray: *mut super::super::Foundation::DEVPROPKEY, propertykeycount: u32, requiredpropertykeycount: *mut u32, flags: u32, machinename: windows_sys::core::PCWSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type SetupDiGetClassPropertyW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: *mut super::Properties::DEVPROPTYPE, propertybuffer: *mut u8, propertybuffersize: u32, requiredsize: *mut u32, flags: u32) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Devices_Properties")]
...
pub type SetupDiGetClassRegistryPropertyA = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, property: u32, propertyregdatatype: *mut u32, propertybuffer: *mut u8, propertybuffersize: u32, requiredsize: *mut u32, machinename: windows_sys::core::PCSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiGetClassRegistryPropertyW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, property: u32, propertyregdatatype: *mut u32, propertybuffer: *mut u8, propertybuffersize: u32, requiredsize: *mut u32, machinename: windows_sys::core::PCWSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiGetCustomDevicePropertyA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, custompropertyname: windows_sys::core::PCSTR, flags: u32, propertyregdatatype: *mut u32, propertybuffer: *mut u8, propertybuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetCustomDevicePropertyW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, custompropertyname: windows_sys::core::PCWSTR, flags: u32, propertyregdatatype: *mut u32, propertybuffer: *mut u8, propertybuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetDeviceInfoListClass = unsafe extern "system" fn(deviceinfoset: HDEVINFO, classguid: *mut windows_sys::core::GUID) -> windows_sys::core::BOOL;
...
pub type SetupDiGetDeviceInfoListDetailA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfosetdetaildata: *mut SP_DEVINFO_LIST_DETAIL_DATA_A) -> windows_sys::core::BOOL;
...
pub type SetupDiGetDeviceInfoListDetailW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfosetdetaildata: *mut SP_DEVINFO_LIST_DETAIL_DATA_W) -> windows_sys::core::BOOL;
...
pub type SetupDiGetDeviceInstallParamsA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, deviceinstallparams: *mut SP_DEVINSTALL_PARAMS_A) -> windows_sys::core::BOOL;
...
pub type SetupDiGetDeviceInstallParamsW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, deviceinstallparams: *mut SP_DEVINSTALL_PARAMS_W) -> windows_sys::core::BOOL;
...
pub type SetupDiGetDeviceInstanceIdA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, deviceinstanceid: windows_sys::core::PSTR, deviceinstanceidsize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetDeviceInstanceIdW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, deviceinstanceid: windows_sys::core::PWSTR, deviceinstanceidsize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetDeviceInterfaceAlias = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinterfacedata: *const SP_DEVICE_INTERFACE_DATA, aliasinterfaceclassguid: *const windows_sys::core::GUID, aliasdeviceinterfacedata: *mut SP_DEVICE_INTERFACE_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiGetDeviceInterfacePropertyKeys = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinterfacedata: *const SP_DEVICE_INTERFACE_DATA, propertykeyarray: *mut super::super::Foundation::DEVPROPKEY, propertykeycount: u32, requiredpropertykeycount: *mut u32, flags: u32) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type SetupDiGetDeviceInterfacePropertyW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinterfacedata: *const SP_DEVICE_INTERFACE_DATA, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: *mut super::Properties::DEVPROPTYPE, propertybuffer: *mut u8, propertybuffersize: u32, requiredsize: *mut u32, flags: u32) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Devices_Properties")]
...
pub type SetupDiGetDevicePropertyKeys = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, propertykeyarray: *mut super::super::Foundation::DEVPROPKEY, propertykeycount: u32, requiredpropertykeycount: *mut u32, flags: u32) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type SetupDiGetDevicePropertyW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: *mut super::Properties::DEVPROPTYPE, propertybuffer: *mut u8, propertybuffersize: u32, requiredsize: *mut u32, flags: u32) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Devices_Properties")]
...
pub type SetupDiGetDeviceRegistryPropertyA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, property: SETUP_DI_REGISTRY_PROPERTY, propertyregdatatype: *mut u32, propertybuffer: *mut u8, propertybuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetDeviceRegistryPropertyW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, property: SETUP_DI_REGISTRY_PROPERTY, propertyregdatatype: *mut u32, propertybuffer: *mut u8, propertybuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetDriverInfoDetailA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, driverinfodata: *const SP_DRVINFO_DATA_V2_A, driverinfodetaildata: *mut SP_DRVINFO_DETAIL_DATA_A, driverinfodetaildatasize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetDriverInfoDetailW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, driverinfodata: *const SP_DRVINFO_DATA_V2_W, driverinfodetaildata: *mut SP_DRVINFO_DETAIL_DATA_W, driverinfodetaildatasize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetDriverInstallParamsA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, driverinfodata: *const SP_DRVINFO_DATA_V2_A, driverinstallparams: *mut SP_DRVINSTALL_PARAMS) -> windows_sys::core::BOOL;
...
pub type SetupDiGetDriverInstallParamsW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, driverinfodata: *const SP_DRVINFO_DATA_V2_W, driverinstallparams: *mut SP_DRVINSTALL_PARAMS) -> windows_sys::core::BOOL;
...
pub type SetupDiGetHwProfileFriendlyNameA = unsafe extern "system" fn(hwprofile: u32, friendlyname: windows_sys::core::PSTR, friendlynamesize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetHwProfileFriendlyNameExA = unsafe extern "system" fn(hwprofile: u32, friendlyname: windows_sys::core::PSTR, friendlynamesize: u32, requiredsize: *mut u32, machinename: windows_sys::core::PCSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiGetHwProfileFriendlyNameExW = unsafe extern "system" fn(hwprofile: u32, friendlyname: windows_sys::core::PWSTR, friendlynamesize: u32, requiredsize: *mut u32, machinename: windows_sys::core::PCWSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiGetHwProfileFriendlyNameW = unsafe extern "system" fn(hwprofile: u32, friendlyname: windows_sys::core::PWSTR, friendlynamesize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetHwProfileList = unsafe extern "system" fn(hwprofilelist: *mut u32, hwprofilelistsize: u32, requiredsize: *mut u32, currentlyactiveindex: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetHwProfileListExA = unsafe extern "system" fn(hwprofilelist: *mut u32, hwprofilelistsize: u32, requiredsize: *mut u32, currentlyactiveindex: *mut u32, machinename: windows_sys::core::PCSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiGetHwProfileListExW = unsafe extern "system" fn(hwprofilelist: *mut u32, hwprofilelistsize: u32, requiredsize: *mut u32, currentlyactiveindex: *mut u32, machinename: windows_sys::core::PCWSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiGetINFClassA = unsafe extern "system" fn(infname: windows_sys::core::PCSTR, classguid: *mut windows_sys::core::GUID, classname: windows_sys::core::PSTR, classnamesize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetINFClassW = unsafe extern "system" fn(infname: windows_sys::core::PCWSTR, classguid: *mut windows_sys::core::GUID, classname: windows_sys::core::PWSTR, classnamesize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupDiGetSelectedDevice = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiGetSelectedDriverA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, driverinfodata: *mut SP_DRVINFO_DATA_V2_A) -> windows_sys::core::BOOL;
...
pub type SetupDiGetSelectedDriverW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, driverinfodata: *mut SP_DRVINFO_DATA_V2_W) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_UI_Controls")]
pub type SetupDiGetWizardPage = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, installwizarddata: *const SP_INSTALLWIZARD_DATA, pagetype: u32, flags: u32) -> super::super::UI::Controls::HPROPSHEETPAGE;
#[cfg(feature = "Win32_UI_Controls")]
...
pub type SetupDiInstallClassA = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, inffilename: windows_sys::core::PCSTR, flags: u32, filequeue: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiInstallClassExW = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, inffilename: windows_sys::core::PCWSTR, flags: u32, filequeue: *const core::ffi::c_void, interfaceclassguid: *const windows_sys::core::GUID, reserved1: *const core::ffi::c_void, reserved2: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiInstallClassW = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, inffilename: windows_sys::core::PCWSTR, flags: u32, filequeue: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiInstallDevice = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiInstallDeviceInterfaces = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiInstallDriverFiles = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiLoadClassIcon = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, largeicon: *mut super::super::UI::WindowsAndMessaging::HICON, miniiconindex: *mut i32) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type SetupDiLoadDeviceIcon = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, cxicon: u32, cyicon: u32, flags: u32, hicon: *mut super::super::UI::WindowsAndMessaging::HICON) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
#[cfg(feature = "Win32_System_Registry")]
pub type SetupDiOpenClassRegKeyExA = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, samdesired: u32, flags: u32, machinename: windows_sys::core::PCSTR, reserved: *const core::ffi::c_void) -> super::super::System::Registry::HKEY;
#[cfg(feature = "Win32_System_Registry")]
...
#[cfg(feature = "Win32_System_Registry")]
pub type SetupDiOpenClassRegKeyExW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, samdesired: u32, flags: u32, machinename: windows_sys::core::PCWSTR, reserved: *const core::ffi::c_void) -> super::super::System::Registry::HKEY;
#[cfg(feature = "Win32_System_Registry")]
...
#[cfg(feature = "Win32_System_Registry")]
pub type SetupDiOpenDevRegKey = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, scope: u32, hwprofile: u32, keytype: u32, samdesired: u32) -> super::super::System::Registry::HKEY;
#[cfg(feature = "Win32_System_Registry")]
...
pub type SetupDiOpenDeviceInfoA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinstanceid: windows_sys::core::PCSTR, hwndparent: super::super::Foundation::HWND, openflags: u32, deviceinfodata: *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiOpenDeviceInfoW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinstanceid: windows_sys::core::PCWSTR, hwndparent: super::super::Foundation::HWND, openflags: u32, deviceinfodata: *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiOpenDeviceInterfaceA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, devicepath: windows_sys::core::PCSTR, openflags: u32, deviceinterfacedata: *mut SP_DEVICE_INTERFACE_DATA) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_System_Registry")]
pub type SetupDiOpenDeviceInterfaceRegKey = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinterfacedata: *const SP_DEVICE_INTERFACE_DATA, reserved: u32, samdesired: u32) -> super::super::System::Registry::HKEY;
#[cfg(feature = "Win32_System_Registry")]
...
pub type SetupDiOpenDeviceInterfaceW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, devicepath: windows_sys::core::PCWSTR, openflags: u32, deviceinterfacedata: *mut SP_DEVICE_INTERFACE_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiRegisterCoDeviceInstallers = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiRegisterDeviceInfo = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *mut SP_DEVINFO_DATA, flags: u32, compareproc: PSP_DETSIG_CMPPROC, comparecontext: *const core::ffi::c_void, dupdeviceinfodata: *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiRemoveDevice = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiRemoveDeviceInterface = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinterfacedata: *mut SP_DEVICE_INTERFACE_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiRestartDevices = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiSelectBestCompatDrv = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiSelectDevice = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiSelectOEMDrv = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, deviceinfoset: HDEVINFO, deviceinfodata: *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiSetClassInstallParamsA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, classinstallparams: *const SP_CLASSINSTALL_HEADER, classinstallparamssize: u32) -> windows_sys::core::BOOL;
...
pub type SetupDiSetClassInstallParamsW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, classinstallparams: *const SP_CLASSINSTALL_HEADER, classinstallparamssize: u32) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type SetupDiSetClassPropertyExW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: super::Properties::DEVPROPTYPE, propertybuffer: *const u8, propertybuffersize: u32, flags: u32, machinename: windows_sys::core::PCWSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Devices_Properties")]
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type SetupDiSetClassPropertyW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: super::Properties::DEVPROPTYPE, propertybuffer: *const u8, propertybuffersize: u32, flags: u32) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Devices_Properties")]
...
pub type SetupDiSetClassRegistryPropertyA = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, property: u32, propertybuffer: *const u8, propertybuffersize: u32, machinename: windows_sys::core::PCSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiSetClassRegistryPropertyW = unsafe extern "system" fn(classguid: *const windows_sys::core::GUID, property: u32, propertybuffer: *const u8, propertybuffersize: u32, machinename: windows_sys::core::PCWSTR, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupDiSetDeviceInstallParamsA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, deviceinstallparams: *const SP_DEVINSTALL_PARAMS_A) -> windows_sys::core::BOOL;
...
pub type SetupDiSetDeviceInstallParamsW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, deviceinstallparams: *const SP_DEVINSTALL_PARAMS_W) -> windows_sys::core::BOOL;
...
pub type SetupDiSetDeviceInterfaceDefault = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinterfacedata: *mut SP_DEVICE_INTERFACE_DATA, flags: u32, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Devices_Properties")]
pub type SetupDiSetDevicePropertyW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: super::Properties::DEVPROPTYPE, propertybuffer: *const u8, propertybuffersize: u32, flags: u32) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Devices_Properties")]
...
pub type SetupDiSetDeviceRegistryPropertyA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *mut SP_DEVINFO_DATA, property: SETUP_DI_REGISTRY_PROPERTY, propertybuffer: *const u8, propertybuffersize: u32) -> windows_sys::core::BOOL;
...
pub type SetupDiSetDeviceRegistryPropertyW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *mut SP_DEVINFO_DATA, property: SETUP_DI_REGISTRY_PROPERTY, propertybuffer: *const u8, propertybuffersize: u32) -> windows_sys::core::BOOL;
...
pub type SetupDiSetDriverInstallParamsA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, driverinfodata: *const SP_DRVINFO_DATA_V2_A, driverinstallparams: *const SP_DRVINSTALL_PARAMS) -> windows_sys::core::BOOL;
...
pub type SetupDiSetDriverInstallParamsW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, driverinfodata: *const SP_DRVINFO_DATA_V2_W, driverinstallparams: *const SP_DRVINSTALL_PARAMS) -> windows_sys::core::BOOL;
...
pub type SetupDiSetSelectedDevice = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDiSetSelectedDriverA = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *mut SP_DEVINFO_DATA, driverinfodata: *mut SP_DRVINFO_DATA_V2_A) -> windows_sys::core::BOOL;
...
pub type SetupDiSetSelectedDriverW = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *mut SP_DEVINFO_DATA, driverinfodata: *mut SP_DRVINFO_DATA_V2_W) -> windows_sys::core::BOOL;
...
pub type SetupDiUnremoveDevice = unsafe extern "system" fn(deviceinfoset: HDEVINFO, deviceinfodata: *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL;
...
pub type SetupDuplicateDiskSpaceListA = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, reserved1: *const core::ffi::c_void, reserved2: u32, flags: u32) -> *mut core::ffi::c_void;
...
pub type SetupDuplicateDiskSpaceListW = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, reserved1: *const core::ffi::c_void, reserved2: u32, flags: u32) -> *mut core::ffi::c_void;
...
pub type SetupEnumInfSectionsA = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, index: u32, buffer: windows_sys::core::PSTR, size: u32, sizeneeded: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupEnumInfSectionsW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, index: u32, buffer: windows_sys::core::PWSTR, size: u32, sizeneeded: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupFindFirstLineA = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, section: windows_sys::core::PCSTR, key: windows_sys::core::PCSTR, context: *mut INFCONTEXT) -> windows_sys::core::BOOL;
...
pub type SetupFindFirstLineW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, section: windows_sys::core::PCWSTR, key: windows_sys::core::PCWSTR, context: *mut INFCONTEXT) -> windows_sys::core::BOOL;
...
pub type SetupFindNextLine = unsafe extern "system" fn(contextin: *const INFCONTEXT, contextout: *mut INFCONTEXT) -> windows_sys::core::BOOL;
...
pub type SetupFindNextMatchLineA = unsafe extern "system" fn(contextin: *const INFCONTEXT, key: windows_sys::core::PCSTR, contextout: *mut INFCONTEXT) -> windows_sys::core::BOOL;
...
pub type SetupFindNextMatchLineW = unsafe extern "system" fn(contextin: *const INFCONTEXT, key: windows_sys::core::PCWSTR, contextout: *mut INFCONTEXT) -> windows_sys::core::BOOL;
...
pub type SetupFreeSourceListA = unsafe extern "system" fn(list: *mut *mut windows_sys::core::PCSTR, count: u32) -> windows_sys::core::BOOL;
...
pub type SetupFreeSourceListW = unsafe extern "system" fn(list: *mut *mut windows_sys::core::PCWSTR, count: u32) -> windows_sys::core::BOOL;
...
pub type SetupGetBackupInformationA = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, backupparams: *mut SP_BACKUP_QUEUE_PARAMS_V2_A) -> windows_sys::core::BOOL;
...
pub type SetupGetBackupInformationW = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, backupparams: *mut SP_BACKUP_QUEUE_PARAMS_V2_W) -> windows_sys::core::BOOL;
...
pub type SetupGetBinaryField = unsafe extern "system" fn(context: *const INFCONTEXT, fieldindex: u32, returnbuffer: *mut u8, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetFileCompressionInfoA = unsafe extern "system" fn(sourcefilename: windows_sys::core::PCSTR, actualsourcefilename: *mut windows_sys::core::PSTR, sourcefilesize: *mut u32, targetfilesize: *mut u32, compressiontype: *mut FILE_COMPRESSION_TYPE) -> u32;
...
pub type SetupGetFileCompressionInfoExA = unsafe extern "system" fn(sourcefilename: windows_sys::core::PCSTR, actualsourcefilenamebuffer: windows_sys::core::PCSTR, actualsourcefilenamebufferlen: u32, requiredbufferlen: *mut u32, sourcefilesize: *mut u32, targetfilesize: *mut u32, compressiontype: *mut FILE_COMPRESSION_TYPE) -> windows_sys::core::BOOL;
...
pub type SetupGetFileCompressionInfoW = unsafe extern "system" fn(sourcefilename: windows_sys::core::PCWSTR, actualsourcefilename: *mut windows_sys::core::PWSTR, sourcefilesize: *mut u32, targetfilesize: *mut u32, compressiontype: *mut FILE_COMPRESSION_TYPE) -> u32;
...
pub type SetupGetFileQueueCount = unsafe extern "system" fn(filequeue: *const core::ffi::c_void, subqueuefileop: u32, numoperations: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetFileQueueFlags = unsafe extern "system" fn(filequeue: *const core::ffi::c_void, flags: *mut u32) -> windows_sys::core::BOOL;
...
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
pub type SetupGetInfDriverStoreLocationA = unsafe extern "system" fn(filename: windows_sys::core::PCSTR, alternateplatforminfo: *const SP_ALTPLATFORM_INFO_V2, localename: windows_sys::core::PCSTR, returnbuffer: windows_sys::core::PSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
...
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
pub type SetupGetInfDriverStoreLocationW = unsafe extern "system" fn(filename: windows_sys::core::PCWSTR, alternateplatforminfo: *const SP_ALTPLATFORM_INFO_V2, localename: windows_sys::core::PCWSTR, returnbuffer: windows_sys::core::PWSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
...
pub type SetupGetInfFileListA = unsafe extern "system" fn(directorypath: windows_sys::core::PCSTR, infstyle: INF_STYLE, returnbuffer: windows_sys::core::PSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetInfFileListW = unsafe extern "system" fn(directorypath: windows_sys::core::PCWSTR, infstyle: INF_STYLE, returnbuffer: windows_sys::core::PWSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetInfInformationA = unsafe extern "system" fn(infspec: *const core::ffi::c_void, searchcontrol: u32, returnbuffer: *mut SP_INF_INFORMATION, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetInfInformationW = unsafe extern "system" fn(infspec: *const core::ffi::c_void, searchcontrol: u32, returnbuffer: *mut SP_INF_INFORMATION, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetInfPublishedNameA = unsafe extern "system" fn(driverstorelocation: windows_sys::core::PCSTR, returnbuffer: windows_sys::core::PSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetInfPublishedNameW = unsafe extern "system" fn(driverstorelocation: windows_sys::core::PCWSTR, returnbuffer: windows_sys::core::PWSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetIntField = unsafe extern "system" fn(context: *const INFCONTEXT, fieldindex: u32, integervalue: *mut i32) -> windows_sys::core::BOOL;
...
pub type SetupGetLineByIndexA = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, section: windows_sys::core::PCSTR, index: u32, context: *mut INFCONTEXT) -> windows_sys::core::BOOL;
...
pub type SetupGetLineByIndexW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, section: windows_sys::core::PCWSTR, index: u32, context: *mut INFCONTEXT) -> windows_sys::core::BOOL;
...
pub type SetupGetLineCountA = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, section: windows_sys::core::PCSTR) -> i32;
...
pub type SetupGetLineCountW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, section: windows_sys::core::PCWSTR) -> i32;
...
pub type SetupGetLineTextA = unsafe extern "system" fn(context: *const INFCONTEXT, infhandle: *const core::ffi::c_void, section: windows_sys::core::PCSTR, key: windows_sys::core::PCSTR, returnbuffer: windows_sys::core::PSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetLineTextW = unsafe extern "system" fn(context: *const INFCONTEXT, infhandle: *const core::ffi::c_void, section: windows_sys::core::PCWSTR, key: windows_sys::core::PCWSTR, returnbuffer: windows_sys::core::PWSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetMultiSzFieldA = unsafe extern "system" fn(context: *const INFCONTEXT, fieldindex: u32, returnbuffer: windows_sys::core::PSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetMultiSzFieldW = unsafe extern "system" fn(context: *const INFCONTEXT, fieldindex: u32, returnbuffer: windows_sys::core::PWSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetNonInteractiveMode = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("setupapi.dll" "system" fn SetupGetNonInteractiveMode() -> windows_sys::core::BOOL);
pub type SetupGetSourceFileLocationA = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, infcontext: *const INFCONTEXT, filename: windows_sys::core::PCSTR, sourceid: *mut u32, returnbuffer: windows_sys::core::PSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetSourceFileLocationW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, infcontext: *const INFCONTEXT, filename: windows_sys::core::PCWSTR, sourceid: *mut u32, returnbuffer: windows_sys::core::PWSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetSourceFileSizeA = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, infcontext: *const INFCONTEXT, filename: windows_sys::core::PCSTR, section: windows_sys::core::PCSTR, filesize: *mut u32, roundingfactor: u32) -> windows_sys::core::BOOL;
...
pub type SetupGetSourceFileSizeW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, infcontext: *const INFCONTEXT, filename: windows_sys::core::PCWSTR, section: windows_sys::core::PCWSTR, filesize: *mut u32, roundingfactor: u32) -> windows_sys::core::BOOL;
...
pub type SetupGetSourceInfoA = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, sourceid: u32, infodesired: u32, returnbuffer: windows_sys::core::PSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetSourceInfoW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, sourceid: u32, infodesired: u32, returnbuffer: windows_sys::core::PWSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetStringFieldA = unsafe extern "system" fn(context: *const INFCONTEXT, fieldindex: u32, returnbuffer: windows_sys::core::PSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetStringFieldW = unsafe extern "system" fn(context: *const INFCONTEXT, fieldindex: u32, returnbuffer: windows_sys::core::PWSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetTargetPathA = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, infcontext: *const INFCONTEXT, section: windows_sys::core::PCSTR, returnbuffer: windows_sys::core::PSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupGetTargetPathW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, infcontext: *const INFCONTEXT, section: windows_sys::core::PCWSTR, returnbuffer: windows_sys::core::PWSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupInitDefaultQueueCallbackEx = unsafe extern "system" fn(ownerwindow: super::super::Foundation::HWND, alternateprogresswindow: super::super::Foundation::HWND, progressmessage: u32, reserved1: u32, reserved2: *const core::ffi::c_void) -> *mut core::ffi::c_void;
...
pub type SetupInitializeFileLogA = unsafe extern "system" fn(logfilename: windows_sys::core::PCSTR, flags: u32) -> *mut core::ffi::c_void;
...
pub type SetupInitializeFileLogW = unsafe extern "system" fn(logfilename: windows_sys::core::PCWSTR, flags: u32) -> *mut core::ffi::c_void;
...
pub type SetupInstallFileExW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, infcontext: *const INFCONTEXT, sourcefile: windows_sys::core::PCWSTR, sourcepathroot: windows_sys::core::PCWSTR, destinationname: windows_sys::core::PCWSTR, copystyle: SP_COPY_STYLE, copymsghandler: PSP_FILE_CALLBACK_W, context: *const core::ffi::c_void, filewasinuse: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type SetupInstallFileW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, infcontext: *const INFCONTEXT, sourcefile: windows_sys::core::PCWSTR, sourcepathroot: windows_sys::core::PCWSTR, destinationname: windows_sys::core::PCWSTR, copystyle: SP_COPY_STYLE, copymsghandler: PSP_FILE_CALLBACK_W, context: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupInstallFilesFromInfSectionA = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, layoutinfhandle: *const core::ffi::c_void, filequeue: *const core::ffi::c_void, sectionname: windows_sys::core::PCSTR, sourcerootpath: windows_sys::core::PCSTR, copyflags: u32) -> windows_sys::core::BOOL;
...
pub type SetupInstallFilesFromInfSectionW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, layoutinfhandle: *const core::ffi::c_void, filequeue: *const core::ffi::c_void, sectionname: windows_sys::core::PCWSTR, sourcerootpath: windows_sys::core::PCWSTR, copyflags: u32) -> windows_sys::core::BOOL;
...
pub type SetupInstallServicesFromInfSectionA = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, sectionname: windows_sys::core::PCSTR, flags: SPSVCINST_FLAGS) -> windows_sys::core::BOOL;
...
pub type SetupInstallServicesFromInfSectionExW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, sectionname: windows_sys::core::PCWSTR, flags: SPSVCINST_FLAGS, deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, reserved1: *const core::ffi::c_void, reserved2: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupInstallServicesFromInfSectionW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, sectionname: windows_sys::core::PCWSTR, flags: SPSVCINST_FLAGS) -> windows_sys::core::BOOL;
...
pub type SetupIterateCabinetA = unsafe extern "system" fn(cabinetfile: windows_sys::core::PCSTR, reserved: u32, msghandler: PSP_FILE_CALLBACK_A, context: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupIterateCabinetW = unsafe extern "system" fn(cabinetfile: windows_sys::core::PCWSTR, reserved: u32, msghandler: PSP_FILE_CALLBACK_W, context: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupLogErrorA = unsafe extern "system" fn(messagestring: windows_sys::core::PCSTR, severity: u32) -> windows_sys::core::BOOL;
...
pub type SetupLogErrorW = unsafe extern "system" fn(messagestring: windows_sys::core::PCWSTR, severity: u32) -> windows_sys::core::BOOL;
...
pub type SetupLogFileW = unsafe extern "system" fn(fileloghandle: *const core::ffi::c_void, logsectionname: windows_sys::core::PCWSTR, sourcefilename: windows_sys::core::PCWSTR, targetfilename: windows_sys::core::PCWSTR, checksum: u32, disktagfile: windows_sys::core::PCWSTR, diskdescription: windows_sys::core::PCWSTR, otherinfo: windows_sys::core::PCWSTR, flags: u32) -> windows_sys::core::BOOL;
...
pub type SetupOpenAppendInfFileA = unsafe extern "system" fn(filename: windows_sys::core::PCSTR, infhandle: *const core::ffi::c_void, errorline: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupOpenAppendInfFileW = unsafe extern "system" fn(filename: windows_sys::core::PCWSTR, infhandle: *const core::ffi::c_void, errorline: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupOpenInfFileA = unsafe extern "system" fn(filename: windows_sys::core::PCSTR, infclass: windows_sys::core::PCSTR, infstyle: INF_STYLE, errorline: *mut u32) -> *mut core::ffi::c_void;
...
pub type SetupOpenInfFileW = unsafe extern "system" fn(filename: windows_sys::core::PCWSTR, infclass: windows_sys::core::PCWSTR, infstyle: INF_STYLE, errorline: *mut u32) -> *mut core::ffi::c_void;
...
pub type SetupOpenLog = unsafe extern "system" fn(erase: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type SetupPrepareQueueForRestoreA = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, backuppath: windows_sys::core::PCSTR, restoreflags: u32) -> windows_sys::core::BOOL;
...
pub type SetupPrepareQueueForRestoreW = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, backuppath: windows_sys::core::PCWSTR, restoreflags: u32) -> windows_sys::core::BOOL;
...
pub type SetupPromptReboot = unsafe extern "system" fn(filequeue: *const core::ffi::c_void, owner: super::super::Foundation::HWND, scanonly: windows_sys::core::BOOL) -> i32;
...
pub type SetupQueryDrivesInDiskSpaceListA = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, returnbuffer: windows_sys::core::PSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupQueryDrivesInDiskSpaceListW = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, returnbuffer: windows_sys::core::PWSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupQueryFileLogA = unsafe extern "system" fn(fileloghandle: *const core::ffi::c_void, logsectionname: windows_sys::core::PCSTR, targetfilename: windows_sys::core::PCSTR, desiredinfo: SetupFileLogInfo, dataout: windows_sys::core::PSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupQueryFileLogW = unsafe extern "system" fn(fileloghandle: *const core::ffi::c_void, logsectionname: windows_sys::core::PCWSTR, targetfilename: windows_sys::core::PCWSTR, desiredinfo: SetupFileLogInfo, dataout: windows_sys::core::PWSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupQueryInfFileInformationA = unsafe extern "system" fn(infinformation: *const SP_INF_INFORMATION, infindex: u32, returnbuffer: windows_sys::core::PSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupQueryInfFileInformationW = unsafe extern "system" fn(infinformation: *const SP_INF_INFORMATION, infindex: u32, returnbuffer: windows_sys::core::PWSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
pub type SetupQueryInfOriginalFileInformationA = unsafe extern "system" fn(infinformation: *const SP_INF_INFORMATION, infindex: u32, alternateplatforminfo: *const SP_ALTPLATFORM_INFO_V2, originalfileinfo: *mut SP_ORIGINAL_FILE_INFO_A) -> windows_sys::core::BOOL;
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
...
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
pub type SetupQueryInfOriginalFileInformationW = unsafe extern "system" fn(infinformation: *const SP_INF_INFORMATION, infindex: u32, alternateplatforminfo: *const SP_ALTPLATFORM_INFO_V2, originalfileinfo: *mut SP_ORIGINAL_FILE_INFO_W) -> windows_sys::core::BOOL;
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
...
pub type SetupQueryInfVersionInformationA = unsafe extern "system" fn(infinformation: *const SP_INF_INFORMATION, infindex: u32, key: windows_sys::core::PCSTR, returnbuffer: windows_sys::core::PSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupQueryInfVersionInformationW = unsafe extern "system" fn(infinformation: *const SP_INF_INFORMATION, infindex: u32, key: windows_sys::core::PCWSTR, returnbuffer: windows_sys::core::PWSTR, returnbuffersize: u32, requiredsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupQuerySourceListA = unsafe extern "system" fn(flags: u32, list: *mut *mut windows_sys::core::PCSTR, count: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupQuerySourceListW = unsafe extern "system" fn(flags: u32, list: *mut *mut windows_sys::core::PCWSTR, count: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupQuerySpaceRequiredOnDriveA = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, drivespec: windows_sys::core::PCSTR, spacerequired: *mut i64, reserved1: *const core::ffi::c_void, reserved2: u32) -> windows_sys::core::BOOL;
...
pub type SetupQuerySpaceRequiredOnDriveW = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, drivespec: windows_sys::core::PCWSTR, spacerequired: *mut i64, reserved1: *const core::ffi::c_void, reserved2: u32) -> windows_sys::core::BOOL;
...
pub type SetupQueueCopyIndirectA = unsafe extern "system" fn(copyparams: *const SP_FILE_COPY_PARAMS_A) -> windows_sys::core::BOOL;
...
pub type SetupQueueCopyIndirectW = unsafe extern "system" fn(copyparams: *const SP_FILE_COPY_PARAMS_W) -> windows_sys::core::BOOL;
...
pub type SetupQueueCopySectionA = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, sourcerootpath: windows_sys::core::PCSTR, infhandle: *const core::ffi::c_void, listinfhandle: *const core::ffi::c_void, section: windows_sys::core::PCSTR, copystyle: u32) -> windows_sys::core::BOOL;
...
pub type SetupQueueCopySectionW = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, sourcerootpath: windows_sys::core::PCWSTR, infhandle: *const core::ffi::c_void, listinfhandle: *const core::ffi::c_void, section: windows_sys::core::PCWSTR, copystyle: u32) -> windows_sys::core::BOOL;
...
pub type SetupQueueCopyW = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, sourcerootpath: windows_sys::core::PCWSTR, sourcepath: windows_sys::core::PCWSTR, sourcefilename: windows_sys::core::PCWSTR, sourcedescription: windows_sys::core::PCWSTR, sourcetagfile: windows_sys::core::PCWSTR, targetdirectory: windows_sys::core::PCWSTR, targetfilename: windows_sys::core::PCWSTR, copystyle: u32) -> windows_sys::core::BOOL;
...
pub type SetupQueueDefaultCopyA = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, infhandle: *const core::ffi::c_void, sourcerootpath: windows_sys::core::PCSTR, sourcefilename: windows_sys::core::PCSTR, targetfilename: windows_sys::core::PCSTR, copystyle: u32) -> windows_sys::core::BOOL;
...
pub type SetupQueueDefaultCopyW = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, infhandle: *const core::ffi::c_void, sourcerootpath: windows_sys::core::PCWSTR, sourcefilename: windows_sys::core::PCWSTR, targetfilename: windows_sys::core::PCWSTR, copystyle: u32) -> windows_sys::core::BOOL;
...
pub type SetupQueueDeleteA = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, pathpart1: windows_sys::core::PCSTR, pathpart2: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type SetupQueueDeleteSectionA = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, infhandle: *const core::ffi::c_void, listinfhandle: *const core::ffi::c_void, section: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type SetupQueueDeleteSectionW = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, infhandle: *const core::ffi::c_void, listinfhandle: *const core::ffi::c_void, section: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SetupQueueDeleteW = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, pathpart1: windows_sys::core::PCWSTR, pathpart2: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SetupQueueRenameA = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, sourcepath: windows_sys::core::PCSTR, sourcefilename: windows_sys::core::PCSTR, targetpath: windows_sys::core::PCSTR, targetfilename: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type SetupQueueRenameSectionA = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, infhandle: *const core::ffi::c_void, listinfhandle: *const core::ffi::c_void, section: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type SetupQueueRenameSectionW = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, infhandle: *const core::ffi::c_void, listinfhandle: *const core::ffi::c_void, section: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SetupQueueRenameW = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, sourcepath: windows_sys::core::PCWSTR, sourcefilename: windows_sys::core::PCWSTR, targetpath: windows_sys::core::PCWSTR, targetfilename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SetupRemoveFileLogEntryA = unsafe extern "system" fn(fileloghandle: *const core::ffi::c_void, logsectionname: windows_sys::core::PCSTR, targetfilename: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type SetupRemoveFileLogEntryW = unsafe extern "system" fn(fileloghandle: *const core::ffi::c_void, logsectionname: windows_sys::core::PCWSTR, targetfilename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SetupRemoveFromDiskSpaceListA = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, targetfilespec: windows_sys::core::PCSTR, operation: SETUP_FILE_OPERATION, reserved1: *const core::ffi::c_void, reserved2: u32) -> windows_sys::core::BOOL;
...
pub type SetupRemoveFromDiskSpaceListW = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, targetfilespec: windows_sys::core::PCWSTR, operation: SETUP_FILE_OPERATION, reserved1: *const core::ffi::c_void, reserved2: u32) -> windows_sys::core::BOOL;
...
pub type SetupRemoveFromSourceListA = unsafe extern "system" fn(flags: u32, source: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type SetupRemoveFromSourceListW = unsafe extern "system" fn(flags: u32, source: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SetupRemoveInstallSectionFromDiskSpaceListA = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, infhandle: *const core::ffi::c_void, layoutinfhandle: *const core::ffi::c_void, sectionname: windows_sys::core::PCSTR, reserved1: *const core::ffi::c_void, reserved2: u32) -> windows_sys::core::BOOL;
...
pub type SetupRemoveInstallSectionFromDiskSpaceListW = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, infhandle: *const core::ffi::c_void, layoutinfhandle: *const core::ffi::c_void, sectionname: windows_sys::core::PCWSTR, reserved1: *const core::ffi::c_void, reserved2: u32) -> windows_sys::core::BOOL;
...
pub type SetupRemoveSectionFromDiskSpaceListA = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, infhandle: *const core::ffi::c_void, listinfhandle: *const core::ffi::c_void, sectionname: windows_sys::core::PCSTR, operation: SETUP_FILE_OPERATION, reserved1: *const core::ffi::c_void, reserved2: u32) -> windows_sys::core::BOOL;
...
pub type SetupRemoveSectionFromDiskSpaceListW = unsafe extern "system" fn(diskspace: *const core::ffi::c_void, infhandle: *const core::ffi::c_void, listinfhandle: *const core::ffi::c_void, sectionname: windows_sys::core::PCWSTR, operation: SETUP_FILE_OPERATION, reserved1: *const core::ffi::c_void, reserved2: u32) -> windows_sys::core::BOOL;
...
pub type SetupRenameErrorA = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, dialogtitle: windows_sys::core::PCSTR, sourcefile: windows_sys::core::PCSTR, targetfile: windows_sys::core::PCSTR, win32errorcode: u32, style: u32) -> u32;
...
pub type SetupRenameErrorW = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, dialogtitle: windows_sys::core::PCWSTR, sourcefile: windows_sys::core::PCWSTR, targetfile: windows_sys::core::PCWSTR, win32errorcode: u32, style: u32) -> u32;
...
pub type SetupScanFileQueueA = unsafe extern "system" fn(filequeue: *const core::ffi::c_void, flags: SETUPSCANFILEQUEUE_FLAGS, window: super::super::Foundation::HWND, callbackroutine: PSP_FILE_CALLBACK_A, callbackcontext: *const core::ffi::c_void, result: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupScanFileQueueW = unsafe extern "system" fn(filequeue: *const core::ffi::c_void, flags: SETUPSCANFILEQUEUE_FLAGS, window: super::super::Foundation::HWND, callbackroutine: PSP_FILE_CALLBACK_W, callbackcontext: *const core::ffi::c_void, result: *mut u32) -> windows_sys::core::BOOL;
...
pub type SetupSetDirectoryIdA = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, id: u32, directory: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type SetupSetDirectoryIdExA = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, id: u32, directory: windows_sys::core::PCSTR, flags: u32, reserved1: u32, reserved2: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupSetDirectoryIdExW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, id: u32, directory: windows_sys::core::PCWSTR, flags: u32, reserved1: u32, reserved2: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupSetDirectoryIdW = unsafe extern "system" fn(infhandle: *const core::ffi::c_void, id: u32, directory: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
pub type SetupSetFileQueueAlternatePlatformA = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, alternateplatforminfo: *const SP_ALTPLATFORM_INFO_V2, alternatedefaultcatalogfile: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
...
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
pub type SetupSetFileQueueAlternatePlatformW = unsafe extern "system" fn(queuehandle: *const core::ffi::c_void, alternateplatforminfo: *const SP_ALTPLATFORM_INFO_V2, alternatedefaultcatalogfile: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
...
pub type SetupSetFileQueueFlags = unsafe extern "system" fn(filequeue: *const core::ffi::c_void, flagmask: u32, flags: u32) -> windows_sys::core::BOOL;
...
pub type SetupSetNonInteractiveMode = unsafe extern "system" fn(noninteractiveflag: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type SetupSetPlatformPathOverrideA = unsafe extern "system" fn(r#override: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type SetupSetPlatformPathOverrideW = unsafe extern "system" fn(r#override: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SetupSetSourceListA = unsafe extern "system" fn(flags: u32, sourcelist: *const windows_sys::core::PCSTR, sourcecount: u32) -> windows_sys::core::BOOL;
...
pub type SetupSetSourceListW = unsafe extern "system" fn(flags: u32, sourcelist: *const windows_sys::core::PCWSTR, sourcecount: u32) -> windows_sys::core::BOOL;
...
pub type SetupTerminateFileLog = unsafe extern "system" fn(fileloghandle: *const core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("setupapi.dll" "system" fn SetupTerminateFileLog(fileloghandle : *const core::ffi::c_void) -> windows_sys::core::BOOL);
pub type SetupUninstallNewlyCopiedInfs = unsafe extern "system" fn(filequeue: *const core::ffi::c_void, flags: u32, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupUninstallOEMInfA = unsafe extern "system" fn(inffilename: windows_sys::core::PCSTR, flags: u32, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetupUninstallOEMInfW = unsafe extern "system" fn(inffilename: windows_sys::core::PCWSTR, flags: u32, reserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
pub type SetupVerifyInfFileA = unsafe extern "system" fn(infname: windows_sys::core::PCSTR, altplatforminfo: *const SP_ALTPLATFORM_INFO_V2, infsignerinfo: *mut SP_INF_SIGNER_INFO_V2_A) -> windows_sys::core::BOOL;
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
...
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
pub type SetupVerifyInfFileW = unsafe extern "system" fn(infname: windows_sys::core::PCWSTR, altplatforminfo: *const SP_ALTPLATFORM_INFO_V2, infsignerinfo: *mut SP_INF_SIGNER_INFO_V2_W) -> windows_sys::core::BOOL;
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
...
pub type SetupWriteTextLog = unsafe extern "C" fn(logtoken: u64, category: u32, flags: u32, messagestr: windows_sys::core::PCSTR, ...);
...
pub type SetupWriteTextLogError = unsafe extern "C" fn(logtoken: u64, category: u32, logflags: u32, error: u32, messagestr: windows_sys::core::PCSTR, ...);
...
pub type UpdateDriverForPlugAndPlayDevicesA = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, hardwareid: windows_sys::core::PCSTR, fullinfpath: windows_sys::core::PCSTR, installflags: UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS, brebootrequired: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type UpdateDriverForPlugAndPlayDevicesW = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, hardwareid: windows_sys::core::PCWSTR, fullinfpath: windows_sys::core::PCWSTR, installflags: UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS, brebootrequired: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
