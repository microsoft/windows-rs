...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Add_Res_Des(prdresdes : *mut usize, lclogconf : usize, resourceid : u32, resourcedata : *mut core::ffi::c_void, resourcelen : u32, ulflags : u32) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Add_Res_Des_Ex(prdresdes : *mut usize, lclogconf : usize, resourceid : u32, resourcedata : *mut core::ffi::c_void, resourcelen : u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Delete_Class_Key_Ex(classguid : *mut windows_sys::core::GUID, ulflags : u32, hmachine : isize) -> CONFIGRET);
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Detect_Resource_Conflict(dndevinst : u32, resourceid : u32, resourcedata : *mut core::ffi::c_void, resourcelen : u32, pbconflictdetected : *mut windows_sys::core::BOOL, ulflags : u32) -> CONFIGRET);
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Enumerate_EnumeratorsA(ulenumindex : u32, buffer : windows_sys::core::PCSTR, pullength : *mut u32, ulflags : u32) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Enumerate_EnumeratorsW(ulenumindex : u32, buffer : windows_sys::core::PCWSTR, pullength : *mut u32, ulflags : u32) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Enumerate_Enumerators_ExA(ulenumindex : u32, buffer : windows_sys::core::PCSTR, pullength : *mut u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Class_Key_NameA(classguid : *mut windows_sys::core::GUID, pszkeyname : windows_sys::core::PCSTR, pullength : *mut u32, ulflags : u32) -> CONFIGRET);
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Class_Key_Name_ExA(classguid : *mut windows_sys::core::GUID, pszkeyname : windows_sys::core::PCSTR, pullength : *mut u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Class_Key_Name_ExW(classguid : *mut windows_sys::core::GUID, pszkeyname : windows_sys::core::PCWSTR, pullength : *mut u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Class_NameW(classguid : *mut windows_sys::core::GUID, buffer : windows_sys::core::PCWSTR, pullength : *mut u32, ulflags : u32) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Class_Name_ExA(classguid : *mut windows_sys::core::GUID, buffer : windows_sys::core::PCSTR, pullength : *mut u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Class_Name_ExW(classguid : *mut windows_sys::core::GUID, buffer : windows_sys::core::PCWSTR, pullength : *mut u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Class_PropertyW(classguid : *mut windows_sys::core::GUID, propertykey : *mut super::super::Foundation:: DEVPROPKEY, propertytype : *mut super::Properties:: DEVPROPTYPE, propertybuffer : *mut u8, propertybuffersize : *mut u32, ulflags : u32) -> CONFIGRET);
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Class_Property_ExW(classguid : *mut windows_sys::core::GUID, propertykey : *mut super::super::Foundation:: DEVPROPKEY, propertytype : *mut super::Properties:: DEVPROPTYPE, propertybuffer : *mut u8, propertybuffersize : *mut u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Class_Property_Keys(classguid : *mut windows_sys::core::GUID, propertykeyarray : *mut super::super::Foundation:: DEVPROPKEY, propertykeycount : *mut u32, ulflags : u32) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Class_Property_Keys_Ex(classguid : *mut windows_sys::core::GUID, propertykeyarray : *mut super::super::Foundation:: DEVPROPKEY, propertykeycount : *mut u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Class_Registry_PropertyA(classguid : *mut windows_sys::core::GUID, ulproperty : u32, pulregdatatype : *mut u32, buffer : *mut core::ffi::c_void, pullength : *mut u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Class_Registry_PropertyW(classguid : *mut windows_sys::core::GUID, ulproperty : u32, pulregdatatype : *mut u32, buffer : *mut core::ffi::c_void, pullength : *mut u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
...
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_DevNode_PropertyW(dndevinst : u32, propertykey : *mut super::super::Foundation:: DEVPROPKEY, propertytype : *mut super::Properties:: DEVPROPTYPE, propertybuffer : *mut u8, propertybuffersize : *mut u32, ulflags : u32) -> CONFIGRET);
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_DevNode_Property_ExW(dndevinst : u32, propertykey : *mut super::super::Foundation:: DEVPROPKEY, propertytype : *mut super::Properties:: DEVPROPTYPE, propertybuffer : *mut u8, propertybuffersize : *mut u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Device_IDA(dndevinst : u32, buffer : windows_sys::core::PCSTR, bufferlen : u32, ulflags : u32) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Device_IDW(dndevinst : u32, buffer : windows_sys::core::PCWSTR, bufferlen : u32, ulflags : u32) -> CONFIGRET);
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Device_ID_ExW(dndevinst : u32, buffer : windows_sys::core::PCWSTR, bufferlen : u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Device_ID_ListA(pszfilter : windows_sys::core::PCSTR, buffer : windows_sys::core::PCSTR, bufferlen : u32, ulflags : u32) -> CONFIGRET);
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Device_ID_List_ExA(pszfilter : windows_sys::core::PCSTR, buffer : windows_sys::core::PCSTR, bufferlen : u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Device_Interface_AliasA(pszdeviceinterface : windows_sys::core::PCSTR, aliasinterfaceguid : *mut windows_sys::core::GUID, pszaliasdeviceinterface : windows_sys::core::PCSTR, pullength : *mut u32, ulflags : u32) -> CONFIGRET);
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Device_Interface_Alias_ExW(pszdeviceinterface : windows_sys::core::PCWSTR, aliasinterfaceguid : *mut windows_sys::core::GUID, pszaliasdeviceinterface : windows_sys::core::PCWSTR, pullength : *mut u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Device_Interface_ListA(interfaceclassguid : *mut windows_sys::core::GUID, pdeviceid : windows_sys::core::PCSTR, buffer : windows_sys::core::PCSTR, bufferlen : u32, ulflags : CM_GET_DEVICE_INTERFACE_LIST_FLAGS) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Device_Interface_ListW(interfaceclassguid : *mut windows_sys::core::GUID, pdeviceid : windows_sys::core::PCWSTR, buffer : windows_sys::core::PCWSTR, bufferlen : u32, ulflags : CM_GET_DEVICE_INTERFACE_LIST_FLAGS) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Device_Interface_List_ExA(interfaceclassguid : *mut windows_sys::core::GUID, pdeviceid : windows_sys::core::PCSTR, buffer : windows_sys::core::PCSTR, bufferlen : u32, ulflags : CM_GET_DEVICE_INTERFACE_LIST_FLAGS, hmachine : isize) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Device_Interface_List_ExW(interfaceclassguid : *mut windows_sys::core::GUID, pdeviceid : windows_sys::core::PCWSTR, buffer : windows_sys::core::PCWSTR, bufferlen : u32, ulflags : CM_GET_DEVICE_INTERFACE_LIST_FLAGS, hmachine : isize) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Device_Interface_List_SizeA(pullen : *mut u32, interfaceclassguid : *mut windows_sys::core::GUID, pdeviceid : windows_sys::core::PCSTR, ulflags : CM_GET_DEVICE_INTERFACE_LIST_FLAGS) -> CONFIGRET);
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Device_Interface_List_Size_ExW(pullen : *mut u32, interfaceclassguid : *mut windows_sys::core::GUID, pdeviceid : windows_sys::core::PCWSTR, ulflags : CM_GET_DEVICE_INTERFACE_LIST_FLAGS, hmachine : isize) -> CONFIGRET);
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Device_Interface_PropertyW(pszdeviceinterface : windows_sys::core::PCWSTR, propertykey : *mut super::super::Foundation:: DEVPROPKEY, propertytype : *mut super::Properties:: DEVPROPTYPE, propertybuffer : *mut u8, propertybuffersize : *mut u32, ulflags : u32) -> CONFIGRET);
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("cfgmgr32.dll" "system" fn CM_Get_Device_Interface_Property_ExW(pszdeviceinterface : windows_sys::core::PCWSTR, propertykey : *mut super::super::Foundation:: DEVPROPKEY, propertytype : *mut super::Properties:: DEVPROPTYPE, propertybuffer : *mut u8, propertybuffersize : *mut u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Modify_Res_Des(prdresdes : *mut usize, rdresdes : usize, resourceid : u32, resourcedata : *mut core::ffi::c_void, resourcelen : u32, ulflags : u32) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Modify_Res_Des_Ex(prdresdes : *mut usize, rdresdes : usize, resourceid : u32, resourcedata : *mut core::ffi::c_void, resourcelen : u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
...
#[cfg(feature = "Win32_System_Registry")]
windows_link::link!("cfgmgr32.dll" "system" fn CM_Open_Class_KeyW(classguid : *mut windows_sys::core::GUID, pszclassname : windows_sys::core::PCWSTR, samdesired : u32, disposition : u32, phkclass : *mut super::super::System::Registry:: HKEY, ulflags : u32) -> CONFIGRET);
#[cfg(feature = "Win32_System_Registry")]
...
#[cfg(feature = "Win32_System_Registry")]
windows_link::link!("cfgmgr32.dll" "system" fn CM_Open_Class_Key_ExW(classguid : *mut windows_sys::core::GUID, pszclassname : windows_sys::core::PCWSTR, samdesired : u32, disposition : u32, phkclass : *mut super::super::System::Registry:: HKEY, ulflags : u32, hmachine : isize) -> CONFIGRET);
#[cfg(feature = "Win32_System_Registry")]
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Query_And_Remove_SubTreeW(dnancestor : u32, pvetotype : *mut PNP_VETO_TYPE, pszvetoname : windows_sys::core::PCWSTR, ulnamelength : u32, ulflags : u32) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Query_And_Remove_SubTree_ExA(dnancestor : u32, pvetotype : *mut PNP_VETO_TYPE, pszvetoname : windows_sys::core::PCSTR, ulnamelength : u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Register_Device_InterfaceW(dndevinst : u32, interfaceclassguid : *mut windows_sys::core::GUID, pszreference : windows_sys::core::PCWSTR, pszdeviceinterface : windows_sys::core::PCWSTR, pullength : *mut u32, ulflags : u32) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Register_Device_Interface_ExA(dndevinst : u32, interfaceclassguid : *mut windows_sys::core::GUID, pszreference : windows_sys::core::PCSTR, pszdeviceinterface : windows_sys::core::PCSTR, pullength : *mut u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Register_Device_Interface_ExW(dndevinst : u32, interfaceclassguid : *mut windows_sys::core::GUID, pszreference : windows_sys::core::PCWSTR, pszdeviceinterface : windows_sys::core::PCWSTR, pullength : *mut u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Request_Device_EjectW(dndevinst : u32, pvetotype : *mut PNP_VETO_TYPE, pszvetoname : windows_sys::core::PCWSTR, ulnamelength : u32, ulflags : u32) -> CONFIGRET);
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Request_Device_Eject_ExW(dndevinst : u32, pvetotype : *mut PNP_VETO_TYPE, pszvetoname : windows_sys::core::PCWSTR, ulnamelength : u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
...
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("cfgmgr32.dll" "system" fn CM_Set_Class_PropertyW(classguid : *mut windows_sys::core::GUID, propertykey : *mut super::super::Foundation:: DEVPROPKEY, propertytype : super::Properties:: DEVPROPTYPE, propertybuffer : *mut u8, propertybuffersize : u32, ulflags : u32) -> CONFIGRET);
#[cfg(feature = "Win32_Devices_Properties")]
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Set_Class_Registry_PropertyA(classguid : *mut windows_sys::core::GUID, ulproperty : u32, buffer : *mut core::ffi::c_void, ullength : u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Set_Class_Registry_PropertyW(classguid : *mut windows_sys::core::GUID, ulproperty : u32, buffer : *mut core::ffi::c_void, ullength : u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
...
windows_link::link!("cfgmgr32.dll" "system" fn CM_Set_DevNode_Registry_PropertyW(dndevinst : u32, ulproperty : u32, buffer : *mut core::ffi::c_void, ullength : u32, ulflags : u32) -> CONFIGRET);
windows_link::link!("cfgmgr32.dll" "system" fn CM_Set_DevNode_Registry_Property_ExA(dndevinst : u32, ulproperty : u32, buffer : *mut core::ffi::c_void, ullength : u32, ulflags : u32, hmachine : isize) -> CONFIGRET);
...
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("cfgmgr32.dll" "system" fn CM_Set_Device_Interface_PropertyW(pszdeviceinterface : windows_sys::core::PCWSTR, propertykey : *mut super::super::Foundation:: DEVPROPKEY, propertytype : super::Properties:: DEVPROPTYPE, propertybuffer : *mut u8, propertybuffersize : u32, ulflags : u32) -> CONFIGRET);
#[cfg(feature = "Win32_Devices_Properties")]
...
windows_link::link!("newdev.dll" "system" fn DiInstallDevice(hwndparent : super::super::Foundation:: HWND, deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, driverinfodata : *mut SP_DRVINFO_DATA_V2_W, flags : DIINSTALLDEVICE_FLAGS, needreboot : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
...
windows_link::link!("newdev.dll" "system" fn DiShowUpdateDevice(hwndparent : super::super::Foundation:: HWND, deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, flags : u32, needreboot : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
...
windows_link::link!("newdev.dll" "system" fn DiUninstallDevice(hwndparent : super::super::Foundation:: HWND, deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, flags : u32, needreboot : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupAddInstallSectionToDiskSpaceListW(diskspace : *mut core::ffi::c_void, infhandle : *mut core::ffi::c_void, layoutinfhandle : *mut core::ffi::c_void, sectionname : windows_sys::core::PCWSTR, reserved1 : *mut core::ffi::c_void, reserved2 : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupAddSectionToDiskSpaceListA(diskspace : *mut core::ffi::c_void, infhandle : *mut core::ffi::c_void, listinfhandle : *mut core::ffi::c_void, sectionname : windows_sys::core::PCSTR, operation : SETUP_FILE_OPERATION, reserved1 : *mut core::ffi::c_void, reserved2 : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupAddSectionToDiskSpaceListW(diskspace : *mut core::ffi::c_void, infhandle : *mut core::ffi::c_void, listinfhandle : *mut core::ffi::c_void, sectionname : windows_sys::core::PCWSTR, operation : SETUP_FILE_OPERATION, reserved1 : *mut core::ffi::c_void, reserved2 : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupAddToDiskSpaceListW(diskspace : *mut core::ffi::c_void, targetfilespec : windows_sys::core::PCWSTR, filesize : i64, operation : SETUP_FILE_OPERATION, reserved1 : *mut core::ffi::c_void, reserved2 : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupAdjustDiskSpaceListA(diskspace : *mut core::ffi::c_void, driveroot : windows_sys::core::PCSTR, amount : i64, reserved1 : *mut core::ffi::c_void, reserved2 : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupAdjustDiskSpaceListW(diskspace : *mut core::ffi::c_void, driveroot : windows_sys::core::PCWSTR, amount : i64, reserved1 : *mut core::ffi::c_void, reserved2 : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupCloseFileQueue(queuehandle : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupCloseInfFile(infhandle : *mut core::ffi::c_void));
...
windows_link::link!("setupapi.dll" "system" fn SetupCommitFileQueueW(owner : super::super::Foundation:: HWND, queuehandle : *mut core::ffi::c_void, msghandler : PSP_FILE_CALLBACK_W, context : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupConfigureWmiFromInfSectionA(infhandle : *mut core::ffi::c_void, sectionname : windows_sys::core::PCSTR, flags : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupCopyOEMInfA(sourceinffilename : windows_sys::core::PCSTR, oemsourcemedialocation : windows_sys::core::PCSTR, oemsourcemediatype : OEM_SOURCE_MEDIA_TYPE, copystyle : SP_COPY_STYLE, destinationinffilename : windows_sys::core::PCSTR, destinationinffilenamesize : u32, requiredsize : *mut u32, destinationinffilenamecomponent : *mut windows_sys::core::PSTR) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupCreateDiskSpaceListW(reserved1 : *mut core::ffi::c_void, reserved2 : u32, flags : u32) -> *mut core::ffi::c_void);
windows_link::link!("setupapi.dll" "system" fn SetupDecompressOrCopyFileA(sourcefilename : windows_sys::core::PCSTR, targetfilename : windows_sys::core::PCSTR, compressiontype : *mut FILE_COMPRESSION_TYPE) -> u32);
windows_link::link!("setupapi.dll" "system" fn SetupDecompressOrCopyFileW(sourcefilename : windows_sys::core::PCWSTR, targetfilename : windows_sys::core::PCWSTR, compressiontype : *mut FILE_COMPRESSION_TYPE) -> u32);
...
windows_link::link!("setupapi.dll" "system" fn SetupDefaultQueueCallbackW(context : *mut core::ffi::c_void, notification : u32, param1 : usize, param2 : usize) -> u32);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiAskForOEMDisk(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiBuildClassInfoListExA(flags : u32, classguidlist : *mut windows_sys::core::GUID, classguidlistsize : u32, requiredsize : *mut u32, machinename : windows_sys::core::PCSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiClassGuidsFromNameExA(classname : windows_sys::core::PCSTR, classguidlist : *mut windows_sys::core::GUID, classguidlistsize : u32, requiredsize : *mut u32, machinename : windows_sys::core::PCSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiClassNameFromGuidA(classguid : *mut windows_sys::core::GUID, classname : windows_sys::core::PCSTR, classnamesize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiClassNameFromGuidExA(classguid : *mut windows_sys::core::GUID, classname : windows_sys::core::PCSTR, classnamesize : u32, requiredsize : *mut u32, machinename : windows_sys::core::PCSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiClassNameFromGuidExW(classguid : *mut windows_sys::core::GUID, classname : windows_sys::core::PCWSTR, classnamesize : u32, requiredsize : *mut u32, machinename : windows_sys::core::PCWSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
#[cfg(feature = "Win32_System_Registry")]
windows_link::link!("setupapi.dll" "system" fn SetupDiCreateDevRegKeyA(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, scope : u32, hwprofile : u32, keytype : u32, infhandle : *mut core::ffi::c_void, infsectionname : windows_sys::core::PCSTR) -> super::super::System::Registry:: HKEY);
#[cfg(feature = "Win32_System_Registry")]
windows_link::link!("setupapi.dll" "system" fn SetupDiCreateDevRegKeyW(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, scope : u32, hwprofile : u32, keytype : u32, infhandle : *mut core::ffi::c_void, infsectionname : windows_sys::core::PCWSTR) -> super::super::System::Registry:: HKEY);
windows_link::link!("setupapi.dll" "system" fn SetupDiCreateDeviceInfoA(deviceinfoset : HDEVINFO, devicename : windows_sys::core::PCSTR, classguid : *mut windows_sys::core::GUID, devicedescription : windows_sys::core::PCSTR, hwndparent : super::super::Foundation:: HWND, creationflags : SETUP_DI_DEVICE_CREATION_FLAGS, deviceinfodata : *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiCreateDeviceInfoListExA(classguid : *mut windows_sys::core::GUID, hwndparent : super::super::Foundation:: HWND, machinename : windows_sys::core::PCSTR, reserved : *mut core::ffi::c_void) -> HDEVINFO);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiCreateDeviceInfoW(deviceinfoset : HDEVINFO, devicename : windows_sys::core::PCWSTR, classguid : *mut windows_sys::core::GUID, devicedescription : windows_sys::core::PCWSTR, hwndparent : super::super::Foundation:: HWND, creationflags : SETUP_DI_DEVICE_CREATION_FLAGS, deviceinfodata : *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiCreateDeviceInterfaceA(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, interfaceclassguid : *mut windows_sys::core::GUID, referencestring : windows_sys::core::PCSTR, creationflags : u32, deviceinterfacedata : *mut SP_DEVICE_INTERFACE_DATA) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_System_Registry")]
windows_link::link!("setupapi.dll" "system" fn SetupDiCreateDeviceInterfaceRegKeyA(deviceinfoset : HDEVINFO, deviceinterfacedata : *mut SP_DEVICE_INTERFACE_DATA, reserved : u32, samdesired : u32, infhandle : *mut core::ffi::c_void, infsectionname : windows_sys::core::PCSTR) -> super::super::System::Registry:: HKEY);
#[cfg(feature = "Win32_System_Registry")]
windows_link::link!("setupapi.dll" "system" fn SetupDiCreateDeviceInterfaceRegKeyW(deviceinfoset : HDEVINFO, deviceinterfacedata : *mut SP_DEVICE_INTERFACE_DATA, reserved : u32, samdesired : u32, infhandle : *mut core::ffi::c_void, infsectionname : windows_sys::core::PCWSTR) -> super::super::System::Registry:: HKEY);
windows_link::link!("setupapi.dll" "system" fn SetupDiCreateDeviceInterfaceW(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, interfaceclassguid : *mut windows_sys::core::GUID, referencestring : windows_sys::core::PCWSTR, creationflags : u32, deviceinterfacedata : *mut SP_DEVICE_INTERFACE_DATA) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiDeleteDevRegKey(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, scope : u32, hwprofile : u32, keytype : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiDeleteDeviceInfo(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiDeleteDeviceInterfaceData(deviceinfoset : HDEVINFO, deviceinterfacedata : *mut SP_DEVICE_INTERFACE_DATA) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiDestroyClassImageList(classimagelistdata : *mut SP_CLASSIMAGELIST_DATA) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiDestroyDeviceInfoList(deviceinfoset : HDEVINFO) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiDestroyDriverInfoList(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, drivertype : SETUP_DI_DRIVER_TYPE) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiEnumDriverInfoW(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, drivertype : SETUP_DI_DRIVER_TYPE, memberindex : u32, driverinfodata : *mut SP_DRVINFO_DATA_V2_W) -> windows_sys::core::BOOL);
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
windows_link::link!("setupapi.dll" "system" fn SetupDiGetActualModelsSectionA(context : *mut INFCONTEXT, alternateplatforminfo : *mut SP_ALTPLATFORM_INFO_V2, infsectionwithext : windows_sys::core::PCSTR, infsectionwithextsize : u32, requiredsize : *mut u32, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
windows_link::link!("setupapi.dll" "system" fn SetupDiGetActualModelsSectionW(context : *mut INFCONTEXT, alternateplatforminfo : *mut SP_ALTPLATFORM_INFO_V2, infsectionwithext : windows_sys::core::PCWSTR, infsectionwithextsize : u32, requiredsize : *mut u32, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetActualSectionToInstallA(infhandle : *mut core::ffi::c_void, infsectionname : windows_sys::core::PCSTR, infsectionwithext : windows_sys::core::PCSTR, infsectionwithextsize : u32, requiredsize : *mut u32, extension : *mut windows_sys::core::PSTR) -> windows_sys::core::BOOL);
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
...
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
windows_link::link!("setupapi.dll" "system" fn SetupDiGetActualSectionToInstallExW(infhandle : *mut core::ffi::c_void, infsectionname : windows_sys::core::PCWSTR, alternateplatforminfo : *mut SP_ALTPLATFORM_INFO_V2, infsectionwithext : windows_sys::core::PCWSTR, infsectionwithextsize : u32, requiredsize : *mut u32, extension : *mut windows_sys::core::PWSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassBitmapIndex(classguid : *mut windows_sys::core::GUID, miniiconindex : *mut i32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassDescriptionA(classguid : *mut windows_sys::core::GUID, classdescription : windows_sys::core::PCSTR, classdescriptionsize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassDescriptionExA(classguid : *mut windows_sys::core::GUID, classdescription : windows_sys::core::PCSTR, classdescriptionsize : u32, requiredsize : *mut u32, machinename : windows_sys::core::PCSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassDescriptionExW(classguid : *mut windows_sys::core::GUID, classdescription : windows_sys::core::PCWSTR, classdescriptionsize : u32, requiredsize : *mut u32, machinename : windows_sys::core::PCWSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassDescriptionW(classguid : *mut windows_sys::core::GUID, classdescription : windows_sys::core::PCWSTR, classdescriptionsize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_UI_Controls", feature = "Win32_UI_WindowsAndMessaging"))]
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassDevPropertySheetsA(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, propertysheetheader : *mut super::super::UI::Controls:: PROPSHEETHEADERA_V2, propertysheetheaderpagelistsize : u32, requiredsize : *mut u32, propertysheettype : u32) -> windows_sys::core::BOOL);
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_UI_Controls", feature = "Win32_UI_WindowsAndMessaging"))]
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassDevPropertySheetsW(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, propertysheetheader : *mut super::super::UI::Controls:: PROPSHEETHEADERW_V2, propertysheetheaderpagelistsize : u32, requiredsize : *mut u32, propertysheettype : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassDevsA(classguid : *mut windows_sys::core::GUID, enumerator : windows_sys::core::PCSTR, hwndparent : super::super::Foundation:: HWND, flags : SETUP_DI_GET_CLASS_DEVS_FLAGS) -> HDEVINFO);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassDevsExW(classguid : *mut windows_sys::core::GUID, enumerator : windows_sys::core::PCWSTR, hwndparent : super::super::Foundation:: HWND, flags : SETUP_DI_GET_CLASS_DEVS_FLAGS, deviceinfoset : HDEVINFO, machinename : windows_sys::core::PCWSTR, reserved : *mut core::ffi::c_void) -> HDEVINFO);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassDevsW(classguid : *mut windows_sys::core::GUID, enumerator : windows_sys::core::PCWSTR, hwndparent : super::super::Foundation:: HWND, flags : SETUP_DI_GET_CLASS_DEVS_FLAGS) -> HDEVINFO);
#[cfg(feature = "Win32_UI_Controls")]
...
#[cfg(feature = "Win32_UI_Controls")]
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassImageListExA(classimagelistdata : *mut SP_CLASSIMAGELIST_DATA, machinename : windows_sys::core::PCSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_UI_Controls")]
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassImageListExW(classimagelistdata : *mut SP_CLASSIMAGELIST_DATA, machinename : windows_sys::core::PCWSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassInstallParamsA(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, classinstallparams : *mut SP_CLASSINSTALL_HEADER, classinstallparamssize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
...
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassPropertyExW(classguid : *mut windows_sys::core::GUID, propertykey : *mut super::super::Foundation:: DEVPROPKEY, propertytype : *mut super::Properties:: DEVPROPTYPE, propertybuffer : *mut u8, propertybuffersize : u32, requiredsize : *mut u32, flags : u32, machinename : windows_sys::core::PCWSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassPropertyKeys(classguid : *mut windows_sys::core::GUID, propertykeyarray : *mut super::super::Foundation:: DEVPROPKEY, propertykeycount : u32, requiredpropertykeycount : *mut u32, flags : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassPropertyKeysExW(classguid : *mut windows_sys::core::GUID, propertykeyarray : *mut super::super::Foundation:: DEVPROPKEY, propertykeycount : u32, requiredpropertykeycount : *mut u32, flags : u32, machinename : windows_sys::core::PCWSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassPropertyW(classguid : *mut windows_sys::core::GUID, propertykey : *mut super::super::Foundation:: DEVPROPKEY, propertytype : *mut super::Properties:: DEVPROPTYPE, propertybuffer : *mut u8, propertybuffersize : u32, requiredsize : *mut u32, flags : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetClassRegistryPropertyA(classguid : *mut windows_sys::core::GUID, property : u32, propertyregdatatype : *mut u32, propertybuffer : *mut u8, propertybuffersize : u32, requiredsize : *mut u32, machinename : windows_sys::core::PCSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiGetCustomDevicePropertyA(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, custompropertyname : windows_sys::core::PCSTR, flags : u32, propertyregdatatype : *mut u32, propertybuffer : *mut u8, propertybuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiGetDeviceInstallParamsA(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, deviceinstallparams : *mut SP_DEVINSTALL_PARAMS_A) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetDeviceInstallParamsW(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, deviceinstallparams : *mut SP_DEVINSTALL_PARAMS_W) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetDeviceInstanceIdA(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, deviceinstanceid : windows_sys::core::PCSTR, deviceinstanceidsize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetDeviceInstanceIdW(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, deviceinstanceid : windows_sys::core::PCWSTR, deviceinstanceidsize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetDeviceInterfaceAlias(deviceinfoset : HDEVINFO, deviceinterfacedata : *mut SP_DEVICE_INTERFACE_DATA, aliasinterfaceclassguid : *mut windows_sys::core::GUID, aliasdeviceinterfacedata : *mut SP_DEVICE_INTERFACE_DATA) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetDeviceInterfaceDetailA(deviceinfoset : HDEVINFO, deviceinterfacedata : *mut SP_DEVICE_INTERFACE_DATA, deviceinterfacedetaildata : *mut SP_DEVICE_INTERFACE_DETAIL_DATA_A, deviceinterfacedetaildatasize : u32, requiredsize : *mut u32, deviceinfodata : *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiGetDeviceInterfacePropertyKeys(deviceinfoset : HDEVINFO, deviceinterfacedata : *mut SP_DEVICE_INTERFACE_DATA, propertykeyarray : *mut super::super::Foundation:: DEVPROPKEY, propertykeycount : u32, requiredpropertykeycount : *mut u32, flags : u32) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("setupapi.dll" "system" fn SetupDiGetDeviceInterfacePropertyW(deviceinfoset : HDEVINFO, deviceinterfacedata : *mut SP_DEVICE_INTERFACE_DATA, propertykey : *mut super::super::Foundation:: DEVPROPKEY, propertytype : *mut super::Properties:: DEVPROPTYPE, propertybuffer : *mut u8, propertybuffersize : u32, requiredsize : *mut u32, flags : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetDevicePropertyKeys(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, propertykeyarray : *mut super::super::Foundation:: DEVPROPKEY, propertykeycount : u32, requiredpropertykeycount : *mut u32, flags : u32) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("setupapi.dll" "system" fn SetupDiGetDevicePropertyW(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, propertykey : *mut super::super::Foundation:: DEVPROPKEY, propertytype : *mut super::Properties:: DEVPROPTYPE, propertybuffer : *mut u8, propertybuffersize : u32, requiredsize : *mut u32, flags : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiGetDriverInfoDetailW(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, driverinfodata : *mut SP_DRVINFO_DATA_V2_W, driverinfodetaildata : *mut SP_DRVINFO_DETAIL_DATA_W, driverinfodetaildatasize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiGetDriverInstallParamsW(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, driverinfodata : *mut SP_DRVINFO_DATA_V2_W, driverinstallparams : *mut SP_DRVINSTALL_PARAMS) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetHwProfileFriendlyNameA(hwprofile : u32, friendlyname : windows_sys::core::PCSTR, friendlynamesize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetHwProfileFriendlyNameExA(hwprofile : u32, friendlyname : windows_sys::core::PCSTR, friendlynamesize : u32, requiredsize : *mut u32, machinename : windows_sys::core::PCSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetHwProfileFriendlyNameExW(hwprofile : u32, friendlyname : windows_sys::core::PCWSTR, friendlynamesize : u32, requiredsize : *mut u32, machinename : windows_sys::core::PCWSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiGetHwProfileListExA(hwprofilelist : *mut u32, hwprofilelistsize : u32, requiredsize : *mut u32, currentlyactiveindex : *mut u32, machinename : windows_sys::core::PCSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetHwProfileListExW(hwprofilelist : *mut u32, hwprofilelistsize : u32, requiredsize : *mut u32, currentlyactiveindex : *mut u32, machinename : windows_sys::core::PCWSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetINFClassA(infname : windows_sys::core::PCSTR, classguid : *mut windows_sys::core::GUID, classname : windows_sys::core::PCSTR, classnamesize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiGetINFClassW(infname : windows_sys::core::PCWSTR, classguid : *mut windows_sys::core::GUID, classname : windows_sys::core::PCWSTR, classnamesize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiGetSelectedDriverW(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, driverinfodata : *mut SP_DRVINFO_DATA_V2_W) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_UI_Controls")]
windows_link::link!("setupapi.dll" "system" fn SetupDiGetWizardPage(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, installwizarddata : *mut SP_INSTALLWIZARD_DATA, pagetype : u32, flags : u32) -> super::super::UI::Controls:: HPROPSHEETPAGE);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiInstallClassExA(hwndparent : super::super::Foundation:: HWND, inffilename : windows_sys::core::PCSTR, flags : u32, filequeue : *mut core::ffi::c_void, interfaceclassguid : *mut windows_sys::core::GUID, reserved1 : *mut core::ffi::c_void, reserved2 : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiInstallClassW(hwndparent : super::super::Foundation:: HWND, inffilename : windows_sys::core::PCWSTR, flags : u32, filequeue : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiLoadClassIcon(classguid : *mut windows_sys::core::GUID, largeicon : *mut super::super::UI::WindowsAndMessaging:: HICON, miniiconindex : *mut i32) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
windows_link::link!("setupapi.dll" "system" fn SetupDiLoadDeviceIcon(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, cxicon : u32, cyicon : u32, flags : u32, hicon : *mut super::super::UI::WindowsAndMessaging:: HICON) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_System_Registry")]
...
#[cfg(feature = "Win32_System_Registry")]
windows_link::link!("setupapi.dll" "system" fn SetupDiOpenClassRegKeyExA(classguid : *mut windows_sys::core::GUID, samdesired : u32, flags : u32, machinename : windows_sys::core::PCSTR, reserved : *mut core::ffi::c_void) -> super::super::System::Registry:: HKEY);
#[cfg(feature = "Win32_System_Registry")]
windows_link::link!("setupapi.dll" "system" fn SetupDiOpenClassRegKeyExW(classguid : *mut windows_sys::core::GUID, samdesired : u32, flags : u32, machinename : windows_sys::core::PCWSTR, reserved : *mut core::ffi::c_void) -> super::super::System::Registry:: HKEY);
#[cfg(feature = "Win32_System_Registry")]
...
windows_link::link!("setupapi.dll" "system" fn SetupDiRegisterCoDeviceInstallers(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiRegisterDeviceInfo(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, flags : u32, compareproc : PSP_DETSIG_CMPPROC, comparecontext : *mut core::ffi::c_void, dupdeviceinfodata : *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiSetClassInstallParamsW(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, classinstallparams : *mut SP_CLASSINSTALL_HEADER, classinstallparamssize : u32) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("setupapi.dll" "system" fn SetupDiSetClassPropertyExW(classguid : *mut windows_sys::core::GUID, propertykey : *mut super::super::Foundation:: DEVPROPKEY, propertytype : super::Properties:: DEVPROPTYPE, propertybuffer : *mut u8, propertybuffersize : u32, flags : u32, machinename : windows_sys::core::PCWSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Devices_Properties")]
...
windows_link::link!("setupapi.dll" "system" fn SetupDiSetClassRegistryPropertyA(classguid : *mut windows_sys::core::GUID, property : u32, propertybuffer : *mut u8, propertybuffersize : u32, machinename : windows_sys::core::PCSTR, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiSetDeviceInstallParamsA(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, deviceinstallparams : *mut SP_DEVINSTALL_PARAMS_A) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiSetDeviceInstallParamsW(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, deviceinstallparams : *mut SP_DEVINSTALL_PARAMS_W) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiSetDeviceInterfaceDefault(deviceinfoset : HDEVINFO, deviceinterfacedata : *mut SP_DEVICE_INTERFACE_DATA, flags : u32, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Devices_Properties")]
...
#[cfg(feature = "Win32_Devices_Properties")]
windows_link::link!("setupapi.dll" "system" fn SetupDiSetDevicePropertyW(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, propertykey : *mut super::super::Foundation:: DEVPROPKEY, propertytype : super::Properties:: DEVPROPTYPE, propertybuffer : *mut u8, propertybuffersize : u32, flags : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupDiSetDeviceRegistryPropertyA(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, property : SETUP_DI_REGISTRY_PROPERTY, propertybuffer : *mut u8, propertybuffersize : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupDiSetDriverInstallParamsA(deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, driverinfodata : *mut SP_DRVINFO_DATA_V2_A, driverinstallparams : *mut SP_DRVINSTALL_PARAMS) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupEnumInfSectionsW(infhandle : *mut core::ffi::c_void, index : u32, buffer : windows_sys::core::PCWSTR, size : u32, sizeneeded : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupFindFirstLineW(infhandle : *mut core::ffi::c_void, section : windows_sys::core::PCWSTR, key : windows_sys::core::PCWSTR, context : *mut INFCONTEXT) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupFindNextMatchLineA(contextin : *mut INFCONTEXT, key : windows_sys::core::PCSTR, contextout : *mut INFCONTEXT) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupFindNextMatchLineW(contextin : *mut INFCONTEXT, key : windows_sys::core::PCWSTR, contextout : *mut INFCONTEXT) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupFreeSourceListA(list : *mut *mut windows_sys::core::PSTR, count : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupFreeSourceListW(list : *mut *mut windows_sys::core::PWSTR, count : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupGetBackupInformationA(queuehandle : *mut core::ffi::c_void, backupparams : *mut SP_BACKUP_QUEUE_PARAMS_V2_A) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupGetFileQueueCount(filequeue : *mut core::ffi::c_void, subqueuefileop : u32, numoperations : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupGetFileQueueFlags(filequeue : *mut core::ffi::c_void, flags : *mut u32) -> windows_sys::core::BOOL);
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
windows_link::link!("setupapi.dll" "system" fn SetupGetInfDriverStoreLocationA(filename : windows_sys::core::PCSTR, alternateplatforminfo : *mut SP_ALTPLATFORM_INFO_V2, localename : windows_sys::core::PCSTR, returnbuffer : windows_sys::core::PCSTR, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
windows_link::link!("setupapi.dll" "system" fn SetupGetInfDriverStoreLocationW(filename : windows_sys::core::PCWSTR, alternateplatforminfo : *mut SP_ALTPLATFORM_INFO_V2, localename : windows_sys::core::PCWSTR, returnbuffer : windows_sys::core::PCWSTR, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupGetInfFileListA(directorypath : windows_sys::core::PCSTR, infstyle : INF_STYLE, returnbuffer : windows_sys::core::PCSTR, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupGetInfFileListW(directorypath : windows_sys::core::PCWSTR, infstyle : INF_STYLE, returnbuffer : windows_sys::core::PCWSTR, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupGetInfInformationW(infspec : *mut core::ffi::c_void, searchcontrol : u32, returnbuffer : *mut SP_INF_INFORMATION, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupGetInfPublishedNameW(driverstorelocation : windows_sys::core::PCWSTR, returnbuffer : windows_sys::core::PCWSTR, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupGetIntField(context : *mut INFCONTEXT, fieldindex : u32, integervalue : *mut i32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupGetLineByIndexW(infhandle : *mut core::ffi::c_void, section : windows_sys::core::PCWSTR, index : u32, context : *mut INFCONTEXT) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupGetLineCountA(infhandle : *mut core::ffi::c_void, section : windows_sys::core::PCSTR) -> i32);
windows_link::link!("setupapi.dll" "system" fn SetupGetLineCountW(infhandle : *mut core::ffi::c_void, section : windows_sys::core::PCWSTR) -> i32);
windows_link::link!("setupapi.dll" "system" fn SetupGetLineTextA(context : *mut INFCONTEXT, infhandle : *mut core::ffi::c_void, section : windows_sys::core::PCSTR, key : windows_sys::core::PCSTR, returnbuffer : windows_sys::core::PCSTR, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupGetMultiSzFieldW(context : *mut INFCONTEXT, fieldindex : u32, returnbuffer : windows_sys::core::PCWSTR, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupGetSourceFileSizeA(infhandle : *mut core::ffi::c_void, infcontext : *mut INFCONTEXT, filename : windows_sys::core::PCSTR, section : windows_sys::core::PCSTR, filesize : *mut u32, roundingfactor : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupGetSourceFileSizeW(infhandle : *mut core::ffi::c_void, infcontext : *mut INFCONTEXT, filename : windows_sys::core::PCWSTR, section : windows_sys::core::PCWSTR, filesize : *mut u32, roundingfactor : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupGetSourceInfoW(infhandle : *mut core::ffi::c_void, sourceid : u32, infodesired : u32, returnbuffer : windows_sys::core::PCWSTR, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupGetStringFieldA(context : *mut INFCONTEXT, fieldindex : u32, returnbuffer : windows_sys::core::PCSTR, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupGetStringFieldW(context : *mut INFCONTEXT, fieldindex : u32, returnbuffer : windows_sys::core::PCWSTR, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupGetTargetPathW(infhandle : *mut core::ffi::c_void, infcontext : *mut INFCONTEXT, section : windows_sys::core::PCWSTR, returnbuffer : windows_sys::core::PCWSTR, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupInstallFileA(infhandle : *mut core::ffi::c_void, infcontext : *mut INFCONTEXT, sourcefile : windows_sys::core::PCSTR, sourcepathroot : windows_sys::core::PCSTR, destinationname : windows_sys::core::PCSTR, copystyle : SP_COPY_STYLE, copymsghandler : PSP_FILE_CALLBACK_A, context : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupInstallFileExA(infhandle : *mut core::ffi::c_void, infcontext : *mut INFCONTEXT, sourcefile : windows_sys::core::PCSTR, sourcepathroot : windows_sys::core::PCSTR, destinationname : windows_sys::core::PCSTR, copystyle : SP_COPY_STYLE, copymsghandler : PSP_FILE_CALLBACK_A, context : *mut core::ffi::c_void, filewasinuse : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupInstallFileExW(infhandle : *mut core::ffi::c_void, infcontext : *mut INFCONTEXT, sourcefile : windows_sys::core::PCWSTR, sourcepathroot : windows_sys::core::PCWSTR, destinationname : windows_sys::core::PCWSTR, copystyle : SP_COPY_STYLE, copymsghandler : PSP_FILE_CALLBACK_W, context : *mut core::ffi::c_void, filewasinuse : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupInstallFileW(infhandle : *mut core::ffi::c_void, infcontext : *mut INFCONTEXT, sourcefile : windows_sys::core::PCWSTR, sourcepathroot : windows_sys::core::PCWSTR, destinationname : windows_sys::core::PCWSTR, copystyle : SP_COPY_STYLE, copymsghandler : PSP_FILE_CALLBACK_W, context : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupInstallFilesFromInfSectionA(infhandle : *mut core::ffi::c_void, layoutinfhandle : *mut core::ffi::c_void, filequeue : *mut core::ffi::c_void, sectionname : windows_sys::core::PCSTR, sourcerootpath : windows_sys::core::PCSTR, copyflags : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupInstallFilesFromInfSectionW(infhandle : *mut core::ffi::c_void, layoutinfhandle : *mut core::ffi::c_void, filequeue : *mut core::ffi::c_void, sectionname : windows_sys::core::PCWSTR, sourcerootpath : windows_sys::core::PCWSTR, copyflags : u32) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_System_Registry")]
windows_link::link!("setupapi.dll" "system" fn SetupInstallFromInfSectionA(owner : super::super::Foundation:: HWND, infhandle : *mut core::ffi::c_void, sectionname : windows_sys::core::PCSTR, flags : u32, relativekeyroot : super::super::System::Registry:: HKEY, sourcerootpath : windows_sys::core::PCSTR, copyflags : u32, msghandler : PSP_FILE_CALLBACK_A, context : *mut core::ffi::c_void, deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_System_Registry")]
windows_link::link!("setupapi.dll" "system" fn SetupInstallFromInfSectionW(owner : super::super::Foundation:: HWND, infhandle : *mut core::ffi::c_void, sectionname : windows_sys::core::PCWSTR, flags : u32, relativekeyroot : super::super::System::Registry:: HKEY, sourcerootpath : windows_sys::core::PCWSTR, copyflags : u32, msghandler : PSP_FILE_CALLBACK_W, context : *mut core::ffi::c_void, deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupInstallServicesFromInfSectionA(infhandle : *mut core::ffi::c_void, sectionname : windows_sys::core::PCSTR, flags : SPSVCINST_FLAGS) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupInstallServicesFromInfSectionExW(infhandle : *mut core::ffi::c_void, sectionname : windows_sys::core::PCWSTR, flags : SPSVCINST_FLAGS, deviceinfoset : HDEVINFO, deviceinfodata : *mut SP_DEVINFO_DATA, reserved1 : *mut core::ffi::c_void, reserved2 : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupIterateCabinetA(cabinetfile : windows_sys::core::PCSTR, reserved : u32, msghandler : PSP_FILE_CALLBACK_A, context : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupIterateCabinetW(cabinetfile : windows_sys::core::PCWSTR, reserved : u32, msghandler : PSP_FILE_CALLBACK_W, context : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupLogFileA(fileloghandle : *mut core::ffi::c_void, logsectionname : windows_sys::core::PCSTR, sourcefilename : windows_sys::core::PCSTR, targetfilename : windows_sys::core::PCSTR, checksum : u32, disktagfile : windows_sys::core::PCSTR, diskdescription : windows_sys::core::PCSTR, otherinfo : windows_sys::core::PCSTR, flags : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupLogFileW(fileloghandle : *mut core::ffi::c_void, logsectionname : windows_sys::core::PCWSTR, sourcefilename : windows_sys::core::PCWSTR, targetfilename : windows_sys::core::PCWSTR, checksum : u32, disktagfile : windows_sys::core::PCWSTR, diskdescription : windows_sys::core::PCWSTR, otherinfo : windows_sys::core::PCWSTR, flags : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupOpenAppendInfFileA(filename : windows_sys::core::PCSTR, infhandle : *mut core::ffi::c_void, errorline : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupOpenAppendInfFileW(filename : windows_sys::core::PCWSTR, infhandle : *mut core::ffi::c_void, errorline : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupPromptForDiskA(hwndparent : super::super::Foundation:: HWND, dialogtitle : windows_sys::core::PCSTR, diskname : windows_sys::core::PCSTR, pathtosource : windows_sys::core::PCSTR, filesought : windows_sys::core::PCSTR, tagfile : windows_sys::core::PCSTR, diskpromptstyle : u32, pathbuffer : windows_sys::core::PCSTR, pathbuffersize : u32, pathrequiredsize : *mut u32) -> u32);
windows_link::link!("setupapi.dll" "system" fn SetupPromptForDiskW(hwndparent : super::super::Foundation:: HWND, dialogtitle : windows_sys::core::PCWSTR, diskname : windows_sys::core::PCWSTR, pathtosource : windows_sys::core::PCWSTR, filesought : windows_sys::core::PCWSTR, tagfile : windows_sys::core::PCWSTR, diskpromptstyle : u32, pathbuffer : windows_sys::core::PCWSTR, pathbuffersize : u32, pathrequiredsize : *mut u32) -> u32);
windows_link::link!("setupapi.dll" "system" fn SetupPromptReboot(filequeue : *mut core::ffi::c_void, owner : super::super::Foundation:: HWND, scanonly : windows_sys::core::BOOL) -> i32);
windows_link::link!("setupapi.dll" "system" fn SetupQueryDrivesInDiskSpaceListA(diskspace : *mut core::ffi::c_void, returnbuffer : windows_sys::core::PCSTR, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupQueryFileLogA(fileloghandle : *mut core::ffi::c_void, logsectionname : windows_sys::core::PCSTR, targetfilename : windows_sys::core::PCSTR, desiredinfo : SetupFileLogInfo, dataout : windows_sys::core::PCSTR, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupQueryFileLogW(fileloghandle : *mut core::ffi::c_void, logsectionname : windows_sys::core::PCWSTR, targetfilename : windows_sys::core::PCWSTR, desiredinfo : SetupFileLogInfo, dataout : windows_sys::core::PCWSTR, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupQueryInfFileInformationA(infinformation : *mut SP_INF_INFORMATION, infindex : u32, returnbuffer : windows_sys::core::PCSTR, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupQueryInfFileInformationW(infinformation : *mut SP_INF_INFORMATION, infindex : u32, returnbuffer : windows_sys::core::PCWSTR, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
windows_link::link!("setupapi.dll" "system" fn SetupQueryInfOriginalFileInformationA(infinformation : *mut SP_INF_INFORMATION, infindex : u32, alternateplatforminfo : *mut SP_ALTPLATFORM_INFO_V2, originalfileinfo : *mut SP_ORIGINAL_FILE_INFO_A) -> windows_sys::core::BOOL);
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
windows_link::link!("setupapi.dll" "system" fn SetupQueryInfOriginalFileInformationW(infinformation : *mut SP_INF_INFORMATION, infindex : u32, alternateplatforminfo : *mut SP_ALTPLATFORM_INFO_V2, originalfileinfo : *mut SP_ORIGINAL_FILE_INFO_W) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupQueryInfVersionInformationA(infinformation : *mut SP_INF_INFORMATION, infindex : u32, key : windows_sys::core::PCSTR, returnbuffer : windows_sys::core::PCSTR, returnbuffersize : u32, requiredsize : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupQuerySourceListA(flags : u32, list : *mut *mut windows_sys::core::PSTR, count : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupQuerySourceListW(flags : u32, list : *mut *mut windows_sys::core::PWSTR, count : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupQueueCopySectionA(queuehandle : *mut core::ffi::c_void, sourcerootpath : windows_sys::core::PCSTR, infhandle : *mut core::ffi::c_void, listinfhandle : *mut core::ffi::c_void, section : windows_sys::core::PCSTR, copystyle : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupQueueCopySectionW(queuehandle : *mut core::ffi::c_void, sourcerootpath : windows_sys::core::PCWSTR, infhandle : *mut core::ffi::c_void, listinfhandle : *mut core::ffi::c_void, section : windows_sys::core::PCWSTR, copystyle : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupQueueCopyW(queuehandle : *mut core::ffi::c_void, sourcerootpath : windows_sys::core::PCWSTR, sourcepath : windows_sys::core::PCWSTR, sourcefilename : windows_sys::core::PCWSTR, sourcedescription : windows_sys::core::PCWSTR, sourcetagfile : windows_sys::core::PCWSTR, targetdirectory : windows_sys::core::PCWSTR, targetfilename : windows_sys::core::PCWSTR, copystyle : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupQueueDefaultCopyA(queuehandle : *mut core::ffi::c_void, infhandle : *mut core::ffi::c_void, sourcerootpath : windows_sys::core::PCSTR, sourcefilename : windows_sys::core::PCSTR, targetfilename : windows_sys::core::PCSTR, copystyle : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupQueueDeleteA(queuehandle : *mut core::ffi::c_void, pathpart1 : windows_sys::core::PCSTR, pathpart2 : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupQueueDeleteSectionA(queuehandle : *mut core::ffi::c_void, infhandle : *mut core::ffi::c_void, listinfhandle : *mut core::ffi::c_void, section : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupQueueDeleteSectionW(queuehandle : *mut core::ffi::c_void, infhandle : *mut core::ffi::c_void, listinfhandle : *mut core::ffi::c_void, section : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupQueueRenameSectionW(queuehandle : *mut core::ffi::c_void, infhandle : *mut core::ffi::c_void, listinfhandle : *mut core::ffi::c_void, section : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupRemoveFileLogEntryA(fileloghandle : *mut core::ffi::c_void, logsectionname : windows_sys::core::PCSTR, targetfilename : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupRemoveFromDiskSpaceListA(diskspace : *mut core::ffi::c_void, targetfilespec : windows_sys::core::PCSTR, operation : SETUP_FILE_OPERATION, reserved1 : *mut core::ffi::c_void, reserved2 : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupRemoveInstallSectionFromDiskSpaceListW(diskspace : *mut core::ffi::c_void, infhandle : *mut core::ffi::c_void, layoutinfhandle : *mut core::ffi::c_void, sectionname : windows_sys::core::PCWSTR, reserved1 : *mut core::ffi::c_void, reserved2 : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupRemoveSectionFromDiskSpaceListA(diskspace : *mut core::ffi::c_void, infhandle : *mut core::ffi::c_void, listinfhandle : *mut core::ffi::c_void, sectionname : windows_sys::core::PCSTR, operation : SETUP_FILE_OPERATION, reserved1 : *mut core::ffi::c_void, reserved2 : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupRemoveSectionFromDiskSpaceListW(diskspace : *mut core::ffi::c_void, infhandle : *mut core::ffi::c_void, listinfhandle : *mut core::ffi::c_void, sectionname : windows_sys::core::PCWSTR, operation : SETUP_FILE_OPERATION, reserved1 : *mut core::ffi::c_void, reserved2 : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupSetDirectoryIdExA(infhandle : *mut core::ffi::c_void, id : u32, directory : windows_sys::core::PCSTR, flags : u32, reserved1 : u32, reserved2 : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupSetDirectoryIdExW(infhandle : *mut core::ffi::c_void, id : u32, directory : windows_sys::core::PCWSTR, flags : u32, reserved1 : u32, reserved2 : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupSetDirectoryIdW(infhandle : *mut core::ffi::c_void, id : u32, directory : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
...
windows_link::link!("setupapi.dll" "system" fn SetupSetFileQueueFlags(filequeue : *mut core::ffi::c_void, flagmask : u32, flags : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupSetSourceListA(flags : u32, sourcelist : *mut windows_sys::core::PSTR, sourcecount : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupSetSourceListW(flags : u32, sourcelist : *mut windows_sys::core::PWSTR, sourcecount : u32) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupSetThreadLogToken(logtoken : u64));
windows_link::link!("setupapi.dll" "system" fn SetupTermDefaultQueueCallback(context : *mut core::ffi::c_void));
windows_link::link!("setupapi.dll" "system" fn SetupTerminateFileLog(fileloghandle : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("setupapi.dll" "system" fn SetupUninstallNewlyCopiedInfs(filequeue : *mut core::ffi::c_void, flags : u32, reserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_SystemInformation"))]
windows_link::link!("setupapi.dll" "system" fn SetupVerifyInfFileW(infname : windows_sys::core::PCWSTR, altplatforminfo : *mut SP_ALTPLATFORM_INFO_V2, infsignerinfo : *mut SP_INF_SIGNER_INFO_V2_W) -> windows_sys::core::BOOL);
...
windows_link::link!("setupapi.dll" "system" fn SetupWriteTextLogInfLine(logtoken : u64, flags : u32, infhandle : *mut core::ffi::c_void, context : *mut INFCONTEXT));
...
pub type PDETECT_PROGRESS_NOTIFY = Option<unsafe extern "system" fn(progressnotifyparam: *mut core::ffi::c_void, detectcomplete: u32) -> windows_sys::core::BOOL>;
...
pub type PSP_DETSIG_CMPPROC = Option<unsafe extern "system" fn(deviceinfoset: HDEVINFO, newdevicedata: *mut SP_DEVINFO_DATA, existingdevicedata: *mut SP_DEVINFO_DATA, comparecontext: *mut core::ffi::c_void) -> u32>;
pub type PSP_FILE_CALLBACK_A = Option<unsafe extern "system" fn(context: *mut core::ffi::c_void, notification: u32, param1: usize, param2: usize) -> u32>;
pub type PSP_FILE_CALLBACK_W = Option<unsafe extern "system" fn(context: *mut core::ffi::c_void, notification: u32, param1: usize, param2: usize) -> u32>;
