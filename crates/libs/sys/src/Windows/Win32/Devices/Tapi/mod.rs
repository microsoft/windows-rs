...
pub type GetTnefStreamCodepage = unsafe extern "system" fn(lpstream: *mut core::ffi::c_void, lpulcodepage: *mut u32, lpulsubcodepage: *mut u32) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_System_Com")]
...
pub type OpenTnefStream = unsafe extern "system" fn(lpvsupport: *mut core::ffi::c_void, lpstream: *mut core::ffi::c_void, lpszstreamname: *const i8, ulflags: u32, lpmessage: *mut core::ffi::c_void, wkeyval: u16, lpptnef: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
#[cfg(all(feature = "Win32_System_AddressBook", feature = "Win32_System_Com"))]
...
#[cfg(all(feature = "Win32_System_AddressBook", feature = "Win32_System_Com"))]
pub type OpenTnefStreamEx = unsafe extern "system" fn(lpvsupport: *mut core::ffi::c_void, lpstream: *mut core::ffi::c_void, lpszstreamname: *const i8, ulflags: u32, lpmessage: *mut core::ffi::c_void, wkeyval: u16, lpadressbook: *mut core::ffi::c_void, lpptnef: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
#[cfg(all(feature = "Win32_System_AddressBook", feature = "Win32_System_Com"))]
...
pub type lineAccept = unsafe extern "system" fn(hcall: u32, lpsuseruserinfo: windows_sys::core::PCSTR, dwsize: u32) -> i32;
windows_link::link!("tapi32.dll" "system" fn lineAccept(hcall : u32, lpsuseruserinfo : windows_sys::core::PCSTR, dwsize : u32) -> i32);
pub type lineAddProvider = unsafe extern "system" fn(lpszproviderfilename: windows_sys::core::PCSTR, hwndowner: super::super::Foundation::HWND, lpdwpermanentproviderid: *mut u32) -> i32;
...
pub type lineAddProviderA = unsafe extern "system" fn(lpszproviderfilename: windows_sys::core::PCSTR, hwndowner: super::super::Foundation::HWND, lpdwpermanentproviderid: *mut u32) -> i32;
...
pub type lineAddProviderW = unsafe extern "system" fn(lpszproviderfilename: windows_sys::core::PCWSTR, hwndowner: super::super::Foundation::HWND, lpdwpermanentproviderid: *mut u32) -> i32;
...
pub type lineAnswer = unsafe extern "system" fn(hcall: u32, lpsuseruserinfo: windows_sys::core::PCSTR, dwsize: u32) -> i32;
windows_link::link!("tapi32.dll" "system" fn lineAnswer(hcall : u32, lpsuseruserinfo : windows_sys::core::PCSTR, dwsize : u32) -> i32);
pub type lineBlindTransfer = unsafe extern "system" fn(hcall: u32, lpszdestaddress: windows_sys::core::PCSTR, dwcountrycode: u32) -> i32;
...
pub type lineBlindTransferA = unsafe extern "system" fn(hcall: u32, lpszdestaddress: windows_sys::core::PCSTR, dwcountrycode: u32) -> i32;
...
pub type lineBlindTransferW = unsafe extern "system" fn(hcall: u32, lpszdestaddressw: windows_sys::core::PCWSTR, dwcountrycode: u32) -> i32;
...
pub type lineConfigDialog = unsafe extern "system" fn(dwdeviceid: u32, hwndowner: super::super::Foundation::HWND, lpszdeviceclass: windows_sys::core::PCSTR) -> i32;
...
pub type lineConfigDialogA = unsafe extern "system" fn(dwdeviceid: u32, hwndowner: super::super::Foundation::HWND, lpszdeviceclass: windows_sys::core::PCSTR) -> i32;
...
pub type lineConfigDialogEdit = unsafe extern "system" fn(dwdeviceid: u32, hwndowner: super::super::Foundation::HWND, lpszdeviceclass: windows_sys::core::PCSTR, lpdeviceconfigin: *const core::ffi::c_void, dwsize: u32, lpdeviceconfigout: *mut VARSTRING) -> i32;
...
pub type lineConfigDialogEditA = unsafe extern "system" fn(dwdeviceid: u32, hwndowner: super::super::Foundation::HWND, lpszdeviceclass: windows_sys::core::PCSTR, lpdeviceconfigin: *const core::ffi::c_void, dwsize: u32, lpdeviceconfigout: *mut VARSTRING) -> i32;
...
pub type lineConfigDialogEditW = unsafe extern "system" fn(dwdeviceid: u32, hwndowner: super::super::Foundation::HWND, lpszdeviceclass: windows_sys::core::PCWSTR, lpdeviceconfigin: *const core::ffi::c_void, dwsize: u32, lpdeviceconfigout: *mut VARSTRING) -> i32;
...
pub type lineConfigDialogW = unsafe extern "system" fn(dwdeviceid: u32, hwndowner: super::super::Foundation::HWND, lpszdeviceclass: windows_sys::core::PCWSTR) -> i32;
...
pub type lineCreateAgentA = unsafe extern "system" fn(hline: u32, lpszagentid: windows_sys::core::PCSTR, lpszagentpin: windows_sys::core::PCSTR, lphagent: *mut u32) -> i32;
...
pub type lineCreateAgentSessionA = unsafe extern "system" fn(hline: u32, hagent: u32, lpszagentpin: windows_sys::core::PCSTR, dwworkingaddressid: u32, lpgroupid: *mut windows_sys::core::GUID, lphagentsession: *mut u32) -> i32;
...
pub type lineCreateAgentSessionW = unsafe extern "system" fn(hline: u32, hagent: u32, lpszagentpin: windows_sys::core::PCWSTR, dwworkingaddressid: u32, lpgroupid: *mut windows_sys::core::GUID, lphagentsession: *mut u32) -> i32;
...
pub type lineCreateAgentW = unsafe extern "system" fn(hline: u32, lpszagentid: windows_sys::core::PCWSTR, lpszagentpin: windows_sys::core::PCWSTR, lphagent: *mut u32) -> i32;
...
pub type lineDial = unsafe extern "system" fn(hcall: u32, lpszdestaddress: windows_sys::core::PCSTR, dwcountrycode: u32) -> i32;
windows_link::link!("tapi32.dll" "system" fn lineDial(hcall : u32, lpszdestaddress : windows_sys::core::PCSTR, dwcountrycode : u32) -> i32);
pub type lineDialA = unsafe extern "system" fn(hcall: u32, lpszdestaddress: windows_sys::core::PCSTR, dwcountrycode: u32) -> i32;
windows_link::link!("tapi32.dll" "system" fn lineDialA(hcall : u32, lpszdestaddress : windows_sys::core::PCSTR, dwcountrycode : u32) -> i32);
pub type lineDialW = unsafe extern "system" fn(hcall: u32, lpszdestaddress: windows_sys::core::PCWSTR, dwcountrycode: u32) -> i32;
windows_link::link!("tapi32.dll" "system" fn lineDialW(hcall : u32, lpszdestaddress : windows_sys::core::PCWSTR, dwcountrycode : u32) -> i32);
pub type lineDrop = unsafe extern "system" fn(hcall: u32, lpsuseruserinfo: windows_sys::core::PCSTR, dwsize: u32) -> i32;
...
pub type lineGatherDigits = unsafe extern "system" fn(hcall: u32, dwdigitmodes: u32, lpsdigits: windows_sys::core::PSTR, dwnumdigits: u32, lpszterminationdigits: windows_sys::core::PCSTR, dwfirstdigittimeout: u32, dwinterdigittimeout: u32) -> i32;
...
pub type lineGatherDigitsA = unsafe extern "system" fn(hcall: u32, dwdigitmodes: u32, lpsdigits: windows_sys::core::PSTR, dwnumdigits: u32, lpszterminationdigits: windows_sys::core::PCSTR, dwfirstdigittimeout: u32, dwinterdigittimeout: u32) -> i32;
...
pub type lineGatherDigitsW = unsafe extern "system" fn(hcall: u32, dwdigitmodes: u32, lpsdigits: windows_sys::core::PWSTR, dwnumdigits: u32, lpszterminationdigits: windows_sys::core::PCWSTR, dwfirstdigittimeout: u32, dwinterdigittimeout: u32) -> i32;
...
pub type lineGenerateDigits = unsafe extern "system" fn(hcall: u32, dwdigitmode: u32, lpszdigits: windows_sys::core::PCSTR, dwduration: u32) -> i32;
...
pub type lineGenerateDigitsA = unsafe extern "system" fn(hcall: u32, dwdigitmode: u32, lpszdigits: windows_sys::core::PCSTR, dwduration: u32) -> i32;
...
pub type lineGenerateDigitsW = unsafe extern "system" fn(hcall: u32, dwdigitmode: u32, lpszdigits: windows_sys::core::PCWSTR, dwduration: u32) -> i32;
...
pub type lineGetAddressID = unsafe extern "system" fn(hline: u32, lpdwaddressid: *mut u32, dwaddressmode: u32, lpsaddress: windows_sys::core::PCSTR, dwsize: u32) -> i32;
...
pub type lineGetAddressIDA = unsafe extern "system" fn(hline: u32, lpdwaddressid: *mut u32, dwaddressmode: u32, lpsaddress: windows_sys::core::PCSTR, dwsize: u32) -> i32;
...
pub type lineGetAddressIDW = unsafe extern "system" fn(hline: u32, lpdwaddressid: *mut u32, dwaddressmode: u32, lpsaddress: windows_sys::core::PCWSTR, dwsize: u32) -> i32;
...
pub type lineGetAppPriority = unsafe extern "system" fn(lpszappfilename: windows_sys::core::PCSTR, dwmediamode: u32, lpextensionid: *mut LINEEXTENSIONID, dwrequestmode: u32, lpextensionname: *mut VARSTRING, lpdwpriority: *mut u32) -> i32;
...
pub type lineGetAppPriorityA = unsafe extern "system" fn(lpszappfilename: windows_sys::core::PCSTR, dwmediamode: u32, lpextensionid: *mut LINEEXTENSIONID, dwrequestmode: u32, lpextensionname: *mut VARSTRING, lpdwpriority: *mut u32) -> i32;
...
pub type lineGetAppPriorityW = unsafe extern "system" fn(lpszappfilename: windows_sys::core::PCWSTR, dwmediamode: u32, lpextensionid: *mut LINEEXTENSIONID, dwrequestmode: u32, lpextensionname: *mut VARSTRING, lpdwpriority: *mut u32) -> i32;
...
pub type lineGetDevConfig = unsafe extern "system" fn(dwdeviceid: u32, lpdeviceconfig: *mut VARSTRING, lpszdeviceclass: windows_sys::core::PCSTR) -> i32;
...
pub type lineGetDevConfigA = unsafe extern "system" fn(dwdeviceid: u32, lpdeviceconfig: *mut VARSTRING, lpszdeviceclass: windows_sys::core::PCSTR) -> i32;
...
pub type lineGetDevConfigW = unsafe extern "system" fn(dwdeviceid: u32, lpdeviceconfig: *mut VARSTRING, lpszdeviceclass: windows_sys::core::PCWSTR) -> i32;
...
pub type lineGetID = unsafe extern "system" fn(hline: u32, dwaddressid: u32, hcall: u32, dwselect: u32, lpdeviceid: *mut VARSTRING, lpszdeviceclass: windows_sys::core::PCSTR) -> i32;
...
pub type lineGetIDA = unsafe extern "system" fn(hline: u32, dwaddressid: u32, hcall: u32, dwselect: u32, lpdeviceid: *mut VARSTRING, lpszdeviceclass: windows_sys::core::PCSTR) -> i32;
...
pub type lineGetIDW = unsafe extern "system" fn(hline: u32, dwaddressid: u32, hcall: u32, dwselect: u32, lpdeviceid: *mut VARSTRING, lpszdeviceclass: windows_sys::core::PCWSTR) -> i32;
...
pub type lineGetIcon = unsafe extern "system" fn(dwdeviceid: u32, lpszdeviceclass: windows_sys::core::PCSTR, lphicon: *mut super::super::UI::WindowsAndMessaging::HICON) -> i32;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type lineGetIconA = unsafe extern "system" fn(dwdeviceid: u32, lpszdeviceclass: windows_sys::core::PCSTR, lphicon: *mut super::super::UI::WindowsAndMessaging::HICON) -> i32;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type lineGetIconW = unsafe extern "system" fn(dwdeviceid: u32, lpszdeviceclass: windows_sys::core::PCWSTR, lphicon: *mut super::super::UI::WindowsAndMessaging::HICON) -> i32;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
pub type lineHandoff = unsafe extern "system" fn(hcall: u32, lpszfilename: windows_sys::core::PCSTR, dwmediamode: u32) -> i32;
windows_link::link!("tapi32.dll" "system" fn lineHandoff(hcall : u32, lpszfilename : windows_sys::core::PCSTR, dwmediamode : u32) -> i32);
pub type lineHandoffA = unsafe extern "system" fn(hcall: u32, lpszfilename: windows_sys::core::PCSTR, dwmediamode: u32) -> i32;
windows_link::link!("tapi32.dll" "system" fn lineHandoffA(hcall : u32, lpszfilename : windows_sys::core::PCSTR, dwmediamode : u32) -> i32);
pub type lineHandoffW = unsafe extern "system" fn(hcall: u32, lpszfilename: windows_sys::core::PCWSTR, dwmediamode: u32) -> i32;
...
pub type lineInitialize = unsafe extern "system" fn(lphlineapp: *mut u32, hinstance: super::super::Foundation::HINSTANCE, lpfncallback: LINECALLBACK, lpszappname: windows_sys::core::PCSTR, lpdwnumdevs: *mut u32) -> i32;
...
pub type lineInitializeExA = unsafe extern "system" fn(lphlineapp: *mut u32, hinstance: super::super::Foundation::HINSTANCE, lpfncallback: LINECALLBACK, lpszfriendlyappname: windows_sys::core::PCSTR, lpdwnumdevs: *mut u32, lpdwapiversion: *mut u32, lplineinitializeexparams: *mut LINEINITIALIZEEXPARAMS) -> i32;
...
pub type lineInitializeExW = unsafe extern "system" fn(lphlineapp: *mut u32, hinstance: super::super::Foundation::HINSTANCE, lpfncallback: LINECALLBACK, lpszfriendlyappname: windows_sys::core::PCWSTR, lpdwnumdevs: *mut u32, lpdwapiversion: *mut u32, lplineinitializeexparams: *mut LINEINITIALIZEEXPARAMS) -> i32;
...
pub type lineMakeCall = unsafe extern "system" fn(hline: u32, lphcall: *mut u32, lpszdestaddress: windows_sys::core::PCSTR, dwcountrycode: u32, lpcallparams: *const LINECALLPARAMS) -> i32;
...
pub type lineMakeCallA = unsafe extern "system" fn(hline: u32, lphcall: *mut u32, lpszdestaddress: windows_sys::core::PCSTR, dwcountrycode: u32, lpcallparams: *const LINECALLPARAMS) -> i32;
...
pub type lineMakeCallW = unsafe extern "system" fn(hline: u32, lphcall: *mut u32, lpszdestaddress: windows_sys::core::PCWSTR, dwcountrycode: u32, lpcallparams: *const LINECALLPARAMS) -> i32;
...
pub type linePark = unsafe extern "system" fn(hcall: u32, dwparkmode: u32, lpszdiraddress: windows_sys::core::PCSTR, lpnondiraddress: *mut VARSTRING) -> i32;
...
pub type lineParkA = unsafe extern "system" fn(hcall: u32, dwparkmode: u32, lpszdiraddress: windows_sys::core::PCSTR, lpnondiraddress: *mut VARSTRING) -> i32;
...
pub type lineParkW = unsafe extern "system" fn(hcall: u32, dwparkmode: u32, lpszdiraddress: windows_sys::core::PCWSTR, lpnondiraddress: *mut VARSTRING) -> i32;
...
pub type linePickup = unsafe extern "system" fn(hline: u32, dwaddressid: u32, lphcall: *mut u32, lpszdestaddress: windows_sys::core::PCSTR, lpszgroupid: windows_sys::core::PCSTR) -> i32;
...
pub type linePickupA = unsafe extern "system" fn(hline: u32, dwaddressid: u32, lphcall: *mut u32, lpszdestaddress: windows_sys::core::PCSTR, lpszgroupid: windows_sys::core::PCSTR) -> i32;
...
pub type linePickupW = unsafe extern "system" fn(hline: u32, dwaddressid: u32, lphcall: *mut u32, lpszdestaddress: windows_sys::core::PCWSTR, lpszgroupid: windows_sys::core::PCWSTR) -> i32;
...
pub type lineRedirect = unsafe extern "system" fn(hcall: u32, lpszdestaddress: windows_sys::core::PCSTR, dwcountrycode: u32) -> i32;
...
pub type lineRedirectA = unsafe extern "system" fn(hcall: u32, lpszdestaddress: windows_sys::core::PCSTR, dwcountrycode: u32) -> i32;
...
pub type lineRedirectW = unsafe extern "system" fn(hcall: u32, lpszdestaddress: windows_sys::core::PCWSTR, dwcountrycode: u32) -> i32;
...
pub type lineSendUserUserInfo = unsafe extern "system" fn(hcall: u32, lpsuseruserinfo: windows_sys::core::PCSTR, dwsize: u32) -> i32;
...
pub type lineSetAppPriority = unsafe extern "system" fn(lpszappfilename: windows_sys::core::PCSTR, dwmediamode: u32, lpextensionid: *mut LINEEXTENSIONID, dwrequestmode: u32, lpszextensionname: windows_sys::core::PCSTR, dwpriority: u32) -> i32;
...
pub type lineSetAppPriorityA = unsafe extern "system" fn(lpszappfilename: windows_sys::core::PCSTR, dwmediamode: u32, lpextensionid: *mut LINEEXTENSIONID, dwrequestmode: u32, lpszextensionname: windows_sys::core::PCSTR, dwpriority: u32) -> i32;
...
pub type lineSetAppPriorityW = unsafe extern "system" fn(lpszappfilename: windows_sys::core::PCWSTR, dwmediamode: u32, lpextensionid: *mut LINEEXTENSIONID, dwrequestmode: u32, lpszextensionname: windows_sys::core::PCWSTR, dwpriority: u32) -> i32;
...
pub type lineSetDevConfig = unsafe extern "system" fn(dwdeviceid: u32, lpdeviceconfig: *const core::ffi::c_void, dwsize: u32, lpszdeviceclass: windows_sys::core::PCSTR) -> i32;
...
pub type lineSetDevConfigA = unsafe extern "system" fn(dwdeviceid: u32, lpdeviceconfig: *const core::ffi::c_void, dwsize: u32, lpszdeviceclass: windows_sys::core::PCSTR) -> i32;
...
pub type lineSetDevConfigW = unsafe extern "system" fn(dwdeviceid: u32, lpdeviceconfig: *const core::ffi::c_void, dwsize: u32, lpszdeviceclass: windows_sys::core::PCWSTR) -> i32;
...
pub type lineSetTollList = unsafe extern "system" fn(hlineapp: u32, dwdeviceid: u32, lpszaddressin: windows_sys::core::PCSTR, dwtolllistoption: u32) -> i32;
...
pub type lineSetTollListA = unsafe extern "system" fn(hlineapp: u32, dwdeviceid: u32, lpszaddressin: windows_sys::core::PCSTR, dwtolllistoption: u32) -> i32;
...
pub type lineSetTollListW = unsafe extern "system" fn(hlineapp: u32, dwdeviceid: u32, lpszaddressinw: windows_sys::core::PCWSTR, dwtolllistoption: u32) -> i32;
...
pub type lineTranslateAddress = unsafe extern "system" fn(hlineapp: u32, dwdeviceid: u32, dwapiversion: u32, lpszaddressin: windows_sys::core::PCSTR, dwcard: u32, dwtranslateoptions: u32, lptranslateoutput: *mut LINETRANSLATEOUTPUT) -> i32;
...
pub type lineTranslateAddressA = unsafe extern "system" fn(hlineapp: u32, dwdeviceid: u32, dwapiversion: u32, lpszaddressin: windows_sys::core::PCSTR, dwcard: u32, dwtranslateoptions: u32, lptranslateoutput: *mut LINETRANSLATEOUTPUT) -> i32;
...
pub type lineTranslateAddressW = unsafe extern "system" fn(hlineapp: u32, dwdeviceid: u32, dwapiversion: u32, lpszaddressin: windows_sys::core::PCWSTR, dwcard: u32, dwtranslateoptions: u32, lptranslateoutput: *mut LINETRANSLATEOUTPUT) -> i32;
...
pub type lineTranslateDialog = unsafe extern "system" fn(hlineapp: u32, dwdeviceid: u32, dwapiversion: u32, hwndowner: super::super::Foundation::HWND, lpszaddressin: windows_sys::core::PCSTR) -> i32;
...
pub type lineTranslateDialogA = unsafe extern "system" fn(hlineapp: u32, dwdeviceid: u32, dwapiversion: u32, hwndowner: super::super::Foundation::HWND, lpszaddressin: windows_sys::core::PCSTR) -> i32;
...
pub type lineTranslateDialogW = unsafe extern "system" fn(hlineapp: u32, dwdeviceid: u32, dwapiversion: u32, hwndowner: super::super::Foundation::HWND, lpszaddressin: windows_sys::core::PCWSTR) -> i32;
...
pub type lineUnpark = unsafe extern "system" fn(hline: u32, dwaddressid: u32, lphcall: *mut u32, lpszdestaddress: windows_sys::core::PCSTR) -> i32;
...
pub type lineUnparkA = unsafe extern "system" fn(hline: u32, dwaddressid: u32, lphcall: *mut u32, lpszdestaddress: windows_sys::core::PCSTR) -> i32;
...
pub type lineUnparkW = unsafe extern "system" fn(hline: u32, dwaddressid: u32, lphcall: *mut u32, lpszdestaddress: windows_sys::core::PCWSTR) -> i32;
...
pub type phoneConfigDialog = unsafe extern "system" fn(dwdeviceid: u32, hwndowner: super::super::Foundation::HWND, lpszdeviceclass: windows_sys::core::PCSTR) -> i32;
...
pub type phoneConfigDialogA = unsafe extern "system" fn(dwdeviceid: u32, hwndowner: super::super::Foundation::HWND, lpszdeviceclass: windows_sys::core::PCSTR) -> i32;
...
pub type phoneConfigDialogW = unsafe extern "system" fn(dwdeviceid: u32, hwndowner: super::super::Foundation::HWND, lpszdeviceclass: windows_sys::core::PCWSTR) -> i32;
...
pub type phoneGetID = unsafe extern "system" fn(hphone: u32, lpdeviceid: *mut VARSTRING, lpszdeviceclass: windows_sys::core::PCSTR) -> i32;
...
pub type phoneGetIDA = unsafe extern "system" fn(hphone: u32, lpdeviceid: *mut VARSTRING, lpszdeviceclass: windows_sys::core::PCSTR) -> i32;
...
pub type phoneGetIDW = unsafe extern "system" fn(hphone: u32, lpdeviceid: *mut VARSTRING, lpszdeviceclass: windows_sys::core::PCWSTR) -> i32;
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type phoneGetIcon = unsafe extern "system" fn(dwdeviceid: u32, lpszdeviceclass: windows_sys::core::PCSTR, lphicon: *mut super::super::UI::WindowsAndMessaging::HICON) -> i32;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type phoneGetIconA = unsafe extern "system" fn(dwdeviceid: u32, lpszdeviceclass: windows_sys::core::PCSTR, lphicon: *mut super::super::UI::WindowsAndMessaging::HICON) -> i32;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type phoneGetIconW = unsafe extern "system" fn(dwdeviceid: u32, lpszdeviceclass: windows_sys::core::PCWSTR, lphicon: *mut super::super::UI::WindowsAndMessaging::HICON) -> i32;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
pub type phoneInitialize = unsafe extern "system" fn(lphphoneapp: *mut u32, hinstance: super::super::Foundation::HINSTANCE, lpfncallback: PHONECALLBACK, lpszappname: windows_sys::core::PCSTR, lpdwnumdevs: *mut u32) -> i32;
...
pub type phoneInitializeExA = unsafe extern "system" fn(lphphoneapp: *mut u32, hinstance: super::super::Foundation::HINSTANCE, lpfncallback: PHONECALLBACK, lpszfriendlyappname: windows_sys::core::PCSTR, lpdwnumdevs: *mut u32, lpdwapiversion: *mut u32, lpphoneinitializeexparams: *mut PHONEINITIALIZEEXPARAMS) -> i32;
...
pub type phoneInitializeExW = unsafe extern "system" fn(lphphoneapp: *mut u32, hinstance: super::super::Foundation::HINSTANCE, lpfncallback: PHONECALLBACK, lpszfriendlyappname: windows_sys::core::PCWSTR, lpdwnumdevs: *mut u32, lpdwapiversion: *mut u32, lpphoneinitializeexparams: *mut PHONEINITIALIZEEXPARAMS) -> i32;
...
pub type phoneSetDisplay = unsafe extern "system" fn(hphone: u32, dwrow: u32, dwcolumn: u32, lpsdisplay: windows_sys::core::PCSTR, dwsize: u32) -> i32;
...
pub type tapiGetLocationInfo = unsafe extern "system" fn(lpszcountrycode: windows_sys::core::PSTR, lpszcitycode: windows_sys::core::PSTR) -> i32;
...
pub type tapiGetLocationInfoA = unsafe extern "system" fn(lpszcountrycode: windows_sys::core::PSTR, lpszcitycode: windows_sys::core::PSTR) -> i32;
...
pub type tapiGetLocationInfoW = unsafe extern "system" fn(lpszcountrycodew: windows_sys::core::PWSTR, lpszcitycodew: windows_sys::core::PWSTR) -> i32;
...
pub type tapiRequestMakeCall = unsafe extern "system" fn(lpszdestaddress: windows_sys::core::PCSTR, lpszappname: windows_sys::core::PCSTR, lpszcalledparty: windows_sys::core::PCSTR, lpszcomment: windows_sys::core::PCSTR) -> i32;
...
pub type tapiRequestMakeCallA = unsafe extern "system" fn(lpszdestaddress: windows_sys::core::PCSTR, lpszappname: windows_sys::core::PCSTR, lpszcalledparty: windows_sys::core::PCSTR, lpszcomment: windows_sys::core::PCSTR) -> i32;
...
pub type tapiRequestMakeCallW = unsafe extern "system" fn(lpszdestaddress: windows_sys::core::PCWSTR, lpszappname: windows_sys::core::PCWSTR, lpszcalledparty: windows_sys::core::PCWSTR, lpszcomment: windows_sys::core::PCWSTR) -> i32;
...
pub type tapiRequestMediaCall = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, wrequestid: super::super::Foundation::WPARAM, lpszdeviceclass: windows_sys::core::PCSTR, lpdeviceid: windows_sys::core::PCSTR, dwsize: u32, dwsecure: u32, lpszdestaddress: windows_sys::core::PCSTR, lpszappname: windows_sys::core::PCSTR, lpszcalledparty: windows_sys::core::PCSTR, lpszcomment: windows_sys::core::PCSTR) -> i32;
