pub type BuildCommDCBA = unsafe extern "system" fn(lpdef: windows_sys::core::PCSTR, lpdcb: *mut DCB) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn BuildCommDCBA(lpdef : windows_sys::core::PCSTR, lpdcb : *mut DCB) -> windows_sys::core::BOOL);
pub type BuildCommDCBAndTimeoutsA = unsafe extern "system" fn(lpdef: windows_sys::core::PCSTR, lpdcb: *mut DCB, lpcommtimeouts: *mut COMMTIMEOUTS) -> windows_sys::core::BOOL;
...
pub type BuildCommDCBAndTimeoutsW = unsafe extern "system" fn(lpdef: windows_sys::core::PCWSTR, lpdcb: *mut DCB, lpcommtimeouts: *mut COMMTIMEOUTS) -> windows_sys::core::BOOL;
...
pub type BuildCommDCBW = unsafe extern "system" fn(lpdef: windows_sys::core::PCWSTR, lpdcb: *mut DCB) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn BuildCommDCBW(lpdef : windows_sys::core::PCWSTR, lpdcb : *mut DCB) -> windows_sys::core::BOOL);
pub type ClearCommBreak = unsafe extern "system" fn(hfile: super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn ClearCommBreak(hfile : super::super::Foundation::HANDLE) -> windows_sys::core::BOOL);
pub type ClearCommError = unsafe extern "system" fn(hfile: super::super::Foundation::HANDLE, lperrors: *mut CLEAR_COMM_ERROR_FLAGS, lpstat: *mut COMSTAT) -> windows_sys::core::BOOL;
...
pub type CommConfigDialogA = unsafe extern "system" fn(lpszname: windows_sys::core::PCSTR, hwnd: super::super::Foundation::HWND, lpcc: *mut COMMCONFIG) -> windows_sys::core::BOOL;
...
pub type CommConfigDialogW = unsafe extern "system" fn(lpszname: windows_sys::core::PCWSTR, hwnd: super::super::Foundation::HWND, lpcc: *mut COMMCONFIG) -> windows_sys::core::BOOL;
...
pub type EscapeCommFunction = unsafe extern "system" fn(hfile: super::super::Foundation::HANDLE, dwfunc: ESCAPE_COMM_FUNCTION) -> windows_sys::core::BOOL;
...
pub type GetCommConfig = unsafe extern "system" fn(hcommdev: super::super::Foundation::HANDLE, lpcc: *mut COMMCONFIG, lpdwsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetCommMask = unsafe extern "system" fn(hfile: super::super::Foundation::HANDLE, lpevtmask: *mut COMM_EVENT_MASK) -> windows_sys::core::BOOL;
...
pub type GetCommModemStatus = unsafe extern "system" fn(hfile: super::super::Foundation::HANDLE, lpmodemstat: *mut MODEM_STATUS_FLAGS) -> windows_sys::core::BOOL;
...
pub type GetCommProperties = unsafe extern "system" fn(hfile: super::super::Foundation::HANDLE, lpcommprop: *mut COMMPROP) -> windows_sys::core::BOOL;
...
pub type GetCommState = unsafe extern "system" fn(hfile: super::super::Foundation::HANDLE, lpdcb: *mut DCB) -> windows_sys::core::BOOL;
...
pub type GetCommTimeouts = unsafe extern "system" fn(hfile: super::super::Foundation::HANDLE, lpcommtimeouts: *mut COMMTIMEOUTS) -> windows_sys::core::BOOL;
...
pub type GetDefaultCommConfigA = unsafe extern "system" fn(lpszname: windows_sys::core::PCSTR, lpcc: *mut COMMCONFIG, lpdwsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetDefaultCommConfigW = unsafe extern "system" fn(lpszname: windows_sys::core::PCWSTR, lpcc: *mut COMMCONFIG, lpdwsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type PurgeComm = unsafe extern "system" fn(hfile: super::super::Foundation::HANDLE, dwflags: PURGE_COMM_FLAGS) -> windows_sys::core::BOOL;
...
pub type SetCommBreak = unsafe extern "system" fn(hfile: super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn SetCommBreak(hfile : super::super::Foundation::HANDLE) -> windows_sys::core::BOOL);
pub type SetCommConfig = unsafe extern "system" fn(hcommdev: super::super::Foundation::HANDLE, lpcc: *const COMMCONFIG, dwsize: u32) -> windows_sys::core::BOOL;
...
pub type SetCommMask = unsafe extern "system" fn(hfile: super::super::Foundation::HANDLE, dwevtmask: COMM_EVENT_MASK) -> windows_sys::core::BOOL;
...
pub type SetCommState = unsafe extern "system" fn(hfile: super::super::Foundation::HANDLE, lpdcb: *const DCB) -> windows_sys::core::BOOL;
...
pub type SetCommTimeouts = unsafe extern "system" fn(hfile: super::super::Foundation::HANDLE, lpcommtimeouts: *const COMMTIMEOUTS) -> windows_sys::core::BOOL;
...
pub type SetDefaultCommConfigA = unsafe extern "system" fn(lpszname: windows_sys::core::PCSTR, lpcc: *const COMMCONFIG, dwsize: u32) -> windows_sys::core::BOOL;
...
pub type SetDefaultCommConfigW = unsafe extern "system" fn(lpszname: windows_sys::core::PCWSTR, lpcc: *const COMMCONFIG, dwsize: u32) -> windows_sys::core::BOOL;
...
pub type SetupComm = unsafe extern "system" fn(hfile: super::super::Foundation::HANDLE, dwinqueue: u32, dwoutqueue: u32) -> windows_sys::core::BOOL;
...
pub type TransmitCommChar = unsafe extern "system" fn(hfile: super::super::Foundation::HANDLE, cchar: i8) -> windows_sys::core::BOOL;
...
pub type WaitCommEvent = unsafe extern "system" fn(hfile: super::super::Foundation::HANDLE, lpevtmask: *mut COMM_EVENT_MASK, lpoverlapped: *mut super::super::System::IO::OVERLAPPED) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_System_IO")]
