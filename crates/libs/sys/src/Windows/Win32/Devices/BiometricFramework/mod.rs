::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioAcquireFocus ( ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioAsyncEnumBiometricUnits ( frameworkhandle : u32 , factor : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioAsyncEnumDatabases ( frameworkhandle : u32 , factor : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioAsyncEnumServiceProviders ( frameworkhandle : u32 , factor : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioAsyncMonitorFrameworkChanges ( frameworkhandle : u32 , changetypes : u32 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioAsyncOpenFramework ( notificationmethod : WINBIO_ASYNC_NOTIFICATION_METHOD , targetwindow : super::super::Foundation:: HWND , messagecode : u32 , callbackroutine : PWINBIO_ASYNC_COMPLETION_CALLBACK , userdata : *const ::core::ffi::c_void , asynchronousopen : super::super::Foundation:: BOOL , frameworkhandle : *mut u32 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioAsyncOpenSession ( factor : u32 , pooltype : WINBIO_POOL , flags : u32 , unitarray : *const u32 , unitcount : usize , databaseid : *const :: windows_sys::core::GUID , notificationmethod : WINBIO_ASYNC_NOTIFICATION_METHOD , targetwindow : super::super::Foundation:: HWND , messagecode : u32 , callbackroutine : PWINBIO_ASYNC_COMPLETION_CALLBACK , userdata : *const ::core::ffi::c_void , asynchronousopen : super::super::Foundation:: BOOL , sessionhandle : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioCancel ( sessionhandle : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioCaptureSample ( sessionhandle : u32 , purpose : u8 , flags : u8 , unitid : *mut u32 , sample : *mut *mut WINBIO_BIR , samplesize : *mut usize , rejectdetail : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioCaptureSampleWithCallback ( sessionhandle : u32 , purpose : u8 , flags : u8 , capturecallback : PWINBIO_CAPTURE_CALLBACK , capturecallbackcontext : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioCloseFramework ( frameworkhandle : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioCloseSession ( sessionhandle : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioControlUnit ( sessionhandle : u32 , unitid : u32 , component : WINBIO_COMPONENT , controlcode : u32 , sendbuffer : *const u8 , sendbuffersize : usize , receivebuffer : *mut u8 , receivebuffersize : usize , receivedatasize : *mut usize , operationstatus : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioControlUnitPrivileged ( sessionhandle : u32 , unitid : u32 , component : WINBIO_COMPONENT , controlcode : u32 , sendbuffer : *const u8 , sendbuffersize : usize , receivebuffer : *mut u8 , receivebuffersize : usize , receivedatasize : *mut usize , operationstatus : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioDeleteTemplate ( sessionhandle : u32 , unitid : u32 , identity : *const WINBIO_IDENTITY , subfactor : u8 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioEnrollBegin ( sessionhandle : u32 , subfactor : u8 , unitid : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioEnrollCapture ( sessionhandle : u32 , rejectdetail : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioEnrollCaptureWithCallback ( sessionhandle : u32 , enrollcallback : PWINBIO_ENROLL_CAPTURE_CALLBACK , enrollcallbackcontext : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioEnrollCommit ( sessionhandle : u32 , identity : *mut WINBIO_IDENTITY , isnewtemplate : *mut u8 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioEnrollDiscard ( sessionhandle : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioEnrollSelect ( sessionhandle : u32 , selectorvalue : u64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioEnumBiometricUnits ( factor : u32 , unitschemaarray : *mut *mut WINBIO_UNIT_SCHEMA , unitcount : *mut usize ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioEnumDatabases ( factor : u32 , storageschemaarray : *mut *mut WINBIO_STORAGE_SCHEMA , storagecount : *mut usize ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioEnumEnrollments ( sessionhandle : u32 , unitid : u32 , identity : *const WINBIO_IDENTITY , subfactorarray : *mut *mut u8 , subfactorcount : *mut usize ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioEnumServiceProviders ( factor : u32 , bspschemaarray : *mut *mut WINBIO_BSP_SCHEMA , bspcount : *mut usize ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioFree ( address : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioGetCredentialState ( identity : WINBIO_IDENTITY , r#type : WINBIO_CREDENTIAL_TYPE , credentialstate : *mut WINBIO_CREDENTIAL_STATE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioGetDomainLogonSetting ( value : *mut u8 , source : *mut WINBIO_SETTING_SOURCE ) -> ( ) );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioGetEnabledSetting ( value : *mut u8 , source : *mut WINBIO_SETTING_SOURCE ) -> ( ) );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioGetEnrolledFactors ( accountowner : *const WINBIO_IDENTITY , enrolledfactors : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioGetLogonSetting ( value : *mut u8 , source : *mut WINBIO_SETTING_SOURCE ) -> ( ) );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioGetProperty ( sessionhandle : u32 , propertytype : u32 , propertyid : u32 , unitid : u32 , identity : *const WINBIO_IDENTITY , subfactor : u8 , propertybuffer : *mut *mut ::core::ffi::c_void , propertybuffersize : *mut usize ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioIdentify ( sessionhandle : u32 , unitid : *mut u32 , identity : *mut WINBIO_IDENTITY , subfactor : *mut u8 , rejectdetail : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioIdentifyWithCallback ( sessionhandle : u32 , identifycallback : PWINBIO_IDENTIFY_CALLBACK , identifycallbackcontext : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioImproveBegin ( sessionhandle : u32 , unitid : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioImproveEnd ( sessionhandle : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioLocateSensor ( sessionhandle : u32 , unitid : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioLocateSensorWithCallback ( sessionhandle : u32 , locatecallback : PWINBIO_LOCATE_SENSOR_CALLBACK , locatecallbackcontext : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioLockUnit ( sessionhandle : u32 , unitid : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioLogonIdentifiedUser ( sessionhandle : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioMonitorPresence ( sessionhandle : u32 , unitid : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioOpenSession ( factor : u32 , pooltype : WINBIO_POOL , flags : u32 , unitarray : *const u32 , unitcount : usize , databaseid : *const :: windows_sys::core::GUID , sessionhandle : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioRegisterEventMonitor ( sessionhandle : u32 , eventmask : u32 , eventcallback : PWINBIO_EVENT_CALLBACK , eventcallbackcontext : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioReleaseFocus ( ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioRemoveAllCredentials ( ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioRemoveAllDomainCredentials ( ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioRemoveCredential ( identity : WINBIO_IDENTITY , r#type : WINBIO_CREDENTIAL_TYPE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioSetCredential ( r#type : WINBIO_CREDENTIAL_TYPE , credential : *const u8 , credentialsize : usize , format : WINBIO_CREDENTIAL_FORMAT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioSetProperty ( sessionhandle : u32 , propertytype : u32 , propertyid : u32 , unitid : u32 , identity : *const WINBIO_IDENTITY , subfactor : u8 , propertybuffer : *const ::core::ffi::c_void , propertybuffersize : usize ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioUnlockUnit ( sessionhandle : u32 , unitid : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioUnregisterEventMonitor ( sessionhandle : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioVerify ( sessionhandle : u32 , identity : *const WINBIO_IDENTITY , subfactor : u8 , unitid : *mut u32 , r#match : *mut u8 , rejectdetail : *mut u32 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioVerifyWithCallback ( sessionhandle : u32 , identity : *const WINBIO_IDENTITY , subfactor : u8 , verifycallback : PWINBIO_VERIFY_CALLBACK , verifycallbackcontext : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "winbio.dll" ,"system" fn WinBioWait ( sessionhandle : u32 ) -> :: windows_sys::core::HRESULT );
