...
pub const WINBIO_POOL_PRIVATE: WINBIO_POOL = 2;
pub const WINBIO_POOL_SYSTEM: WINBIO_POOL = 1;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const WINBIO_SETTING_SOURCE_DEFAULT: WINBIO_SETTING_SOURCE = 1;
pub const WINBIO_SETTING_SOURCE_INVALID: WINBIO_SETTING_SOURCE = 0;
pub const WINBIO_SETTING_SOURCE_LOCAL: WINBIO_SETTING_SOURCE = 3;
pub const WINBIO_SETTING_SOURCE_POLICY: WINBIO_SETTING_SOURCE = 2;
#[repr(C)]
#[derive(Clone, Copy, Default)]
