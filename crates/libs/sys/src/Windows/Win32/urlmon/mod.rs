...
windows_link::link!("urlmon.dll" "system" fn CompatFlagsFromClsid(pclsid : *const windows_sys::core::GUID, pdwcompatflags : super::LPDWORD, pdwmiscstatusflags : super::LPDWORD) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "objidl")]
windows_link::link!("urlmon.dll" "system" fn CreateURLMoniker(pmkctx : super::LPMONIKER, szurl : windows_sys::core::PCWSTR, ppmk : *mut super::LPMONIKER) -> windows_sys::core::HRESULT);
#[cfg(feature = "objidl")]
windows_link::link!("urlmon.dll" "system" fn CreateURLMonikerEx(pmkctx : super::LPMONIKER, szurl : windows_sys::core::PCWSTR, ppmk : *mut super::LPMONIKER, dwflags : u32) -> windows_sys::core::HRESULT);
#[cfg(feature = "objidl")]
windows_link::link!("urlmon.dll" "system" fn CreateURLMonikerEx2(pmkctx : super::LPMONIKER, puri : *mut core::ffi::c_void, ppmk : *mut super::LPMONIKER, dwflags : u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("urlmon.dll" "system" fn FaultInIEFeature(hwnd : super::HWND, pclassspec : *const super::uCLSSPEC, pquery : *mut super::QUERYCONTEXT, dwflags : u32) -> windows_sys::core::HRESULT);
#[cfg(feature = "wtypes")]
windows_link::link!("urlmon.dll" "system" fn FindMediaType(rgsztypes : windows_sys::core::PCSTR, rgcftypes : *mut super::CLIPFORMAT) -> windows_sys::core::HRESULT);
#[cfg(feature = "objidl")]
windows_link::link!("urlmon.dll" "system" fn FindMediaTypeClass(pbc : super::LPBC, sztype : windows_sys::core::PCSTR, pclsid : *mut windows_sys::core::GUID, reserved : u32) -> windows_sys::core::HRESULT);
#[cfg(feature = "objidl")]
windows_link::link!("urlmon.dll" "system" fn FindMimeFromData(pbc : super::LPBC, pwzurl : windows_sys::core::PCWSTR, pbuffer : *const core::ffi::c_void, cbsize : u32, pwzmimeproposed : windows_sys::core::PCWSTR, dwmimeflags : u32, ppwzmimeout : *mut windows_sys::core::PWSTR, dwreserved : u32) -> windows_sys::core::HRESULT);
#[cfg(feature = "objidl")]
windows_link::link!("urlmon.dll" "system" fn GetClassFileOrMime(pbc : super::LPBC, szfilename : windows_sys::core::PCWSTR, pbuffer : *const core::ffi::c_void, cbsize : u32, szmime : windows_sys::core::PCWSTR, dwreserved : u32, pclsid : *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT);
...
windows_link::link!("urlmon.dll" "system" fn GetSoftwareUpdateInfo(szdistunit : windows_sys::core::PCWSTR, psdi : LPSOFTDISTINFO) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "minwindef")]
windows_link::link!("urlmon.dll" "system" fn IEInstallScope(pdwscope : super::LPDWORD) -> windows_sys::core::HRESULT);
#[cfg(feature = "objidl")]
...
#[cfg(feature = "objidl")]
windows_link::link!("urlmon.dll" "system" fn IsValidURL(pbc : super::LPBC, szurl : windows_sys::core::PCWSTR, dwreserved : u32) -> windows_sys::core::HRESULT);
#[cfg(feature = "objidl")]
windows_link::link!("urlmon.dll" "system" fn MkParseDisplayNameEx(pbc : *mut core::ffi::c_void, szdisplayname : windows_sys::core::PCWSTR, pcheaten : *mut u32, ppmk : *mut super::LPMONIKER) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "objidl")]
windows_link::link!("urlmon.dll" "system" fn RegisterBindStatusCallback(pbc : super::LPBC, pbscb : *mut core::ffi::c_void, ppbscbprev : *mut *mut core::ffi::c_void, dwreserved : u32) -> windows_sys::core::HRESULT);
#[cfg(feature = "objidl")]
windows_link::link!("urlmon.dll" "system" fn RegisterFormatEnumerator(pbc : super::LPBC, pefetc : *mut core::ffi::c_void, reserved : u32) -> windows_sys::core::HRESULT);
#[cfg(feature = "objidl")]
windows_link::link!("urlmon.dll" "system" fn RegisterMediaTypeClass(pbc : super::LPBC, ctypes : u32, rgsztypes : *const windows_sys::core::PCSTR, rgclsid : *const windows_sys::core::GUID, reserved : u32) -> windows_sys::core::HRESULT);
#[cfg(feature = "wtypes")]
windows_link::link!("urlmon.dll" "system" fn RegisterMediaTypes(ctypes : u32, rgsztypes : *const windows_sys::core::PCSTR, rgcftypes : *mut super::CLIPFORMAT) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "minwinbase", feature = "minwindef", feature = "objidl", feature = "objidlbase", feature = "windef", feature = "winnt", feature = "wtypes", feature = "wtypesbase"))]
windows_link::link!("urlmon.dll" "system" fn ReleaseBindInfo(pbindinfo : *mut BINDINFO));
#[cfg(feature = "objidl")]
windows_link::link!("urlmon.dll" "system" fn RevokeBindStatusCallback(pbc : super::LPBC, pbscb : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
#[cfg(feature = "objidl")]
windows_link::link!("urlmon.dll" "system" fn RevokeFormatEnumerator(pbc : super::LPBC, pefetc : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
#[cfg(feature = "winnt")]
windows_link::link!("urlmon.dll" "system" fn SetAccessForIEAppContainer(hobject : super::HANDLE, ieobjecttype : IEObjectType, dwaccessmask : u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("urlmon.dll" "system" fn URLDownloadToCacheFileA(param0 : *mut core::ffi::c_void, param1 : windows_sys::core::PCSTR, param2 : windows_sys::core::PSTR, cchfilename : u32, param4 : u32, param5 : LPBINDSTATUSCALLBACK) -> windows_sys::core::HRESULT);
windows_link::link!("urlmon.dll" "system" fn URLDownloadToCacheFileW(param0 : *mut core::ffi::c_void, param1 : windows_sys::core::PCWSTR, param2 : windows_sys::core::PWSTR, cchfilename : u32, param4 : u32, param5 : LPBINDSTATUSCALLBACK) -> windows_sys::core::HRESULT);
windows_link::link!("urlmon.dll" "system" fn URLDownloadToFileA(param0 : *mut core::ffi::c_void, param1 : windows_sys::core::PCSTR, param2 : windows_sys::core::PCSTR, param3 : u32, param4 : LPBINDSTATUSCALLBACK) -> windows_sys::core::HRESULT);
windows_link::link!("urlmon.dll" "system" fn URLDownloadToFileW(param0 : *mut core::ffi::c_void, param1 : windows_sys::core::PCWSTR, param2 : windows_sys::core::PCWSTR, param3 : u32, param4 : LPBINDSTATUSCALLBACK) -> windows_sys::core::HRESULT);
#[cfg(feature = "objidlbase")]
windows_link::link!("urlmon.dll" "system" fn URLOpenBlockingStreamA(param0 : *mut core::ffi::c_void, param1 : windows_sys::core::PCSTR, param2 : *mut super::LPSTREAM, param3 : u32, param4 : LPBINDSTATUSCALLBACK) -> windows_sys::core::HRESULT);
#[cfg(feature = "objidlbase")]
windows_link::link!("urlmon.dll" "system" fn URLOpenBlockingStreamW(param0 : *mut core::ffi::c_void, param1 : windows_sys::core::PCWSTR, param2 : *mut super::LPSTREAM, param3 : u32, param4 : LPBINDSTATUSCALLBACK) -> windows_sys::core::HRESULT);
windows_link::link!("urlmon.dll" "system" fn URLOpenPullStreamA(param0 : *mut core::ffi::c_void, param1 : windows_sys::core::PCSTR, param2 : u32, param3 : LPBINDSTATUSCALLBACK) -> windows_sys::core::HRESULT);
windows_link::link!("urlmon.dll" "system" fn URLOpenPullStreamW(param0 : *mut core::ffi::c_void, param1 : windows_sys::core::PCWSTR, param2 : u32, param3 : LPBINDSTATUSCALLBACK) -> windows_sys::core::HRESULT);
windows_link::link!("urlmon.dll" "system" fn URLOpenStreamA(param0 : *mut core::ffi::c_void, param1 : windows_sys::core::PCSTR, param2 : u32, param3 : LPBINDSTATUSCALLBACK) -> windows_sys::core::HRESULT);
windows_link::link!("urlmon.dll" "system" fn URLOpenStreamW(param0 : *mut core::ffi::c_void, param1 : windows_sys::core::PCWSTR, param2 : u32, param3 : LPBINDSTATUSCALLBACK) -> windows_sys::core::HRESULT);
...
windows_link::link!("urlmon.dll" "system" fn WriteHitLogging(lplogginginfo : LPHIT_LOGGING_INFO) -> windows_sys::core::BOOL);
...
pub struct BINDINFO {
    ...
    pub stgmedData: super::STGMEDIUM,
    ...
    pub dwCodePage: u32,
    pub securityAttributes: super::SECURITY_ATTRIBUTES,
...
pub const CFSTR_MIME_NULL: i32 = 0;
pub const CF_NULL: i32 = 0;
...
pub const FIEF_FLAG_FORCE_JITUI: i32 = 1;
pub const FIEF_FLAG_PEEK: i32 = 2;
pub const FIEF_FLAG_RESERVED_0: i32 = 8;
pub const FIEF_FLAG_SKIP_INSTALLED_VERSION_CHECK: i32 = 4;
pub const FMFD_DEFAULT: i32 = 0;
pub const FMFD_ENABLEMIMESNIFFING: i32 = 2;
pub const FMFD_IGNOREMIMETEXTPLAIN: i32 = 4;
pub const FMFD_RESERVED_1: i32 = 64;
pub const FMFD_RESERVED_2: i32 = 128;
pub const FMFD_RESPECTTEXTPLAIN: i32 = 16;
pub const FMFD_RETURNUPDATEDIMGMIMES: i32 = 32;
pub const FMFD_SERVERMIME: i32 = 8;
pub const FMFD_URLASFILENAME: i32 = 1;
pub const GET_FEATURE_FROM_PROCESS: i32 = 2;
pub const GET_FEATURE_FROM_REGISTRY: i32 = 4;
pub const GET_FEATURE_FROM_THREAD: i32 = 1;
pub const GET_FEATURE_FROM_THREAD_INTERNET: i32 = 64;
pub const GET_FEATURE_FROM_THREAD_INTRANET: i32 = 16;
pub const GET_FEATURE_FROM_THREAD_LOCALMACHINE: i32 = 8;
pub const GET_FEATURE_FROM_THREAD_RESTRICTED: i32 = 128;
...
pub const INET_E_DEFAULT_ACTION: windows_sys::core::HRESULT = 0x800C0011_u32 as _;
...
pub const INET_E_ERROR_LAST: windows_sys::core::HRESULT = 0x800C0508_u32 as _;
...
pub type LPAUTHENTICATION = *mut core::ffi::c_void;
pub type LPAUTHENTICATIONEX = *mut core::ffi::c_void;
pub type LPBINDCALLBACKREDIRECT = *mut core::ffi::c_void;
pub type LPBINDHOST = *mut core::ffi::c_void;
pub type LPBINDING = *mut core::ffi::c_void;
pub type LPBINDPROTOCOL = *mut core::ffi::c_void;
pub type LPBINDSTATUSCALLBACK = *mut core::ffi::c_void;
pub type LPBINDSTATUSCALLBACKEX = *mut core::ffi::c_void;
pub type LPCATALOGFILEINFO = *mut core::ffi::c_void;
pub type LPCODEBASEHOLD = *mut CODEBASEHOLD;
pub type LPCODEINSTALL = *mut core::ffi::c_void;
pub type LPDATAFILTER = *mut core::ffi::c_void;
pub type LPENCODINGFILTERFACTORY = *mut core::ffi::c_void;
pub type LPGETBINDHANDLE = *mut core::ffi::c_void;
#[cfg(feature = "minwinbase")]
pub type LPHIT_LOGGING_INFO = *mut HIT_LOGGING_INFO;
pub type LPHTTPNEGOTIATE = *mut core::ffi::c_void;
pub type LPHTTPNEGOTIATE2 = *mut core::ffi::c_void;
pub type LPHTTPNEGOTIATE3 = *mut core::ffi::c_void;
pub type LPHTTPSECURITY = *mut core::ffi::c_void;
pub type LPIINTERNET = *mut core::ffi::c_void;
pub type LPIINTERNETBINDINFO = *mut core::ffi::c_void;
pub type LPIINTERNETBINDINFOEX = *mut core::ffi::c_void;
pub type LPIINTERNETPRIORITY = *mut core::ffi::c_void;
pub type LPIINTERNETPROTOCOL = *mut core::ffi::c_void;
pub type LPIINTERNETPROTOCOLINFO = *mut core::ffi::c_void;
pub type LPIINTERNETPROTOCOLROOT = *mut core::ffi::c_void;
pub type LPIINTERNETPROTOCOLSINK = *mut core::ffi::c_void;
pub type LPIINTERNETPROTOCOLSINKStackable = *mut core::ffi::c_void;
pub type LPIINTERNETSESSION = *mut core::ffi::c_void;
pub type LPIINTERNETTHREADSWITCH = *mut core::ffi::c_void;
pub type LPIWRAPPEDPROTOCOL = *mut core::ffi::c_void;
pub type LPMONIKERPROP = *mut core::ffi::c_void;
pub type LPPERSISTMONIKER = *mut core::ffi::c_void;
...
pub type LPURLZONEMANAGER = *mut core::ffi::c_void;
pub type LPWINDOWFORBINDINGUI = *mut core::ffi::c_void;
pub type LPWININETCACHEHINTS = *mut core::ffi::c_void;
pub type LPWININETCACHEHINTS2 = *mut core::ffi::c_void;
pub type LPWININETFILESTREAM = *mut core::ffi::c_void;
pub type LPWININETHTTPINFO = *mut core::ffi::c_void;
pub type LPWININETINFO = *mut core::ffi::c_void;
...
pub const MUTZ_ACCEPT_WILDCARD_SCHEME: i32 = 128;
pub const MUTZ_DONT_UNESCAPE: i32 = 2048;
pub const MUTZ_DONT_USE_CACHE: i32 = 4096;
pub const MUTZ_ENFORCERESTRICTED: i32 = 256;
pub const MUTZ_FORCE_INTRANET_FLAGS: i32 = 8192;
pub const MUTZ_IGNORE_ZONE_MAPPINGS: i32 = 16384;
pub const MUTZ_ISFILE: i32 = 2;
pub const MUTZ_NOSAVEDFILECHECK: i32 = 1;
pub const MUTZ_REQUIRESAVEDFILECHECK: i32 = 1024;
pub const MUTZ_RESERVED: i32 = 512;
...
pub const SECURITY_IE_STATE_GREEN: i32 = 0;
pub const SECURITY_IE_STATE_RED: i32 = 1;
pub const SET_FEATURE_IN_REGISTRY: i32 = 4;
pub const SET_FEATURE_ON_PROCESS: i32 = 2;
pub const SET_FEATURE_ON_THREAD: i32 = 1;
pub const SET_FEATURE_ON_THREAD_INTERNET: i32 = 64;
pub const SET_FEATURE_ON_THREAD_INTRANET: i32 = 16;
pub const SET_FEATURE_ON_THREAD_LOCALMACHINE: i32 = 8;
...
pub const SOFTDIST_ADSTATE_NONE: i32 = 0;
pub const SOFTDIST_FLAG_DELETE_SUBSCRIPTION: i32 = 8;
pub const SOFTDIST_FLAG_USAGE_AUTOINSTALL: i32 = 4;
pub const SOFTDIST_FLAG_USAGE_EMAIL: i32 = 1;
pub const SOFTDIST_FLAG_USAGE_PRECACHE: i32 = 2;
pub const SZM_CREATE: SZM_FLAGS = 0;
pub const SZM_DELETE: SZM_FLAGS = 1;
pub type SZM_FLAGS = i32;
pub const S_ASYNCHRONOUS: windows_sys::core::HRESULT = 0x401E8_u32 as _;
#[repr(C)]
#[cfg(feature = "objidl")]
#[derive(Clone, Copy, Default)]
...
pub const URLACTION_ACTIVEX_ALLOW_TDC: i32 = 4620;
pub const URLACTION_ACTIVEX_CONFIRM_NOOBJECTSAFETY: i32 = 4612;
pub const URLACTION_ACTIVEX_CURR_MAX: i32 = 4620;
pub const URLACTION_ACTIVEX_DYNSRC_VIDEO_AND_ANIMATION: i32 = 4618;
pub const URLACTION_ACTIVEX_MAX: i32 = 5119;
pub const URLACTION_ACTIVEX_MIN: i32 = 4608;
pub const URLACTION_ACTIVEX_NO_WEBOC_SCRIPT: i32 = 4614;
pub const URLACTION_ACTIVEX_OVERRIDE_DATA_SAFETY: i32 = 4610;
pub const URLACTION_ACTIVEX_OVERRIDE_DOMAINLIST: i32 = 4619;
pub const URLACTION_ACTIVEX_OVERRIDE_OBJECT_SAFETY: i32 = 4609;
pub const URLACTION_ACTIVEX_OVERRIDE_OPTIN: i32 = 4616;
pub const URLACTION_ACTIVEX_OVERRIDE_REPURPOSEDETECTION: i32 = 4615;
pub const URLACTION_ACTIVEX_OVERRIDE_SCRIPT_SAFETY: i32 = 4611;
pub const URLACTION_ACTIVEX_RUN: i32 = 4608;
pub const URLACTION_ACTIVEX_SCRIPTLET_RUN: i32 = 4617;
pub const URLACTION_ACTIVEX_TREATASUNTRUSTED: i32 = 4613;
pub const URLACTION_ALLOW_ACTIVEX_FILTERING: i32 = 9986;
pub const URLACTION_ALLOW_ANTIMALWARE_SCANNING_OF_ACTIVEX: i32 = 9996;
pub const URLACTION_ALLOW_APEVALUATION: i32 = 8961;
pub const URLACTION_ALLOW_AUDIO_VIDEO: i32 = 9985;
pub const URLACTION_ALLOW_AUDIO_VIDEO_PLUGINS: i32 = 9988;
pub const URLACTION_ALLOW_CROSSDOMAIN_APPCACHE_MANIFEST: i32 = 9994;
pub const URLACTION_ALLOW_CROSSDOMAIN_DROP_ACROSS_WINDOWS: i32 = 9993;
pub const URLACTION_ALLOW_CROSSDOMAIN_DROP_WITHIN_WINDOW: i32 = 9992;
pub const URLACTION_ALLOW_CSS_EXPRESSIONS: i32 = 9997;
pub const URLACTION_ALLOW_JSCRIPT_IE: i32 = 5133;
pub const URLACTION_ALLOW_RENDER_LEGACY_DXTFILTERS: i32 = 9995;
pub const URLACTION_ALLOW_RESTRICTEDPROTOCOLS: i32 = 8960;
pub const URLACTION_ALLOW_STRUCTURED_STORAGE_SNIFFING: i32 = 9987;
pub const URLACTION_ALLOW_VBSCRIPT_IE: i32 = 5132;
pub const URLACTION_ALLOW_XDOMAIN_SUBFRAME_RESIZE: i32 = 5128;
pub const URLACTION_ALLOW_XHR_EVALUATION: i32 = 8962;
pub const URLACTION_ALLOW_ZONE_ELEVATION_OPT_OUT_ADDITION: i32 = 9990;
pub const URLACTION_ALLOW_ZONE_ELEVATION_VIA_OPT_OUT: i32 = 9989;
pub const URLACTION_AUTHENTICATE_CLIENT: i32 = 6657;
pub const URLACTION_AUTOMATIC_ACTIVEX_UI: i32 = 8705;
pub const URLACTION_AUTOMATIC_DOWNLOAD_UI: i32 = 8704;
pub const URLACTION_AUTOMATIC_DOWNLOAD_UI_MIN: i32 = 8704;
pub const URLACTION_BEHAVIOR_MIN: i32 = 8192;
pub const URLACTION_BEHAVIOR_RUN: i32 = 8192;
pub const URLACTION_CHANNEL_SOFTDIST_MAX: i32 = 7935;
pub const URLACTION_CHANNEL_SOFTDIST_MIN: i32 = 7680;
pub const URLACTION_CHANNEL_SOFTDIST_PERMISSIONS: i32 = 7685;
pub const URLACTION_CLIENT_CERT_PROMPT: i32 = 6660;
pub const URLACTION_COOKIES: i32 = 6658;
pub const URLACTION_COOKIES_ENABLED: i32 = 6672;
pub const URLACTION_COOKIES_SESSION: i32 = 6659;
pub const URLACTION_COOKIES_SESSION_THIRD_PARTY: i32 = 6662;
pub const URLACTION_COOKIES_THIRD_PARTY: i32 = 6661;
pub const URLACTION_CREDENTIALS_USE: i32 = 6656;
pub const URLACTION_CROSS_DOMAIN_DATA: i32 = 5126;
pub const URLACTION_DOTNET_USERCONTROLS: i32 = 8197;
pub const URLACTION_DOWNLOAD_CURR_MAX: i32 = 4100;
pub const URLACTION_DOWNLOAD_MAX: i32 = 4607;
pub const URLACTION_DOWNLOAD_MIN: i32 = 4096;
pub const URLACTION_DOWNLOAD_SIGNED_ACTIVEX: i32 = 4097;
pub const URLACTION_DOWNLOAD_UNSIGNED_ACTIVEX: i32 = 4100;
pub const URLACTION_FEATURE_BLOCK_INPUT_PROMPTS: i32 = 8453;
pub const URLACTION_FEATURE_CROSSDOMAIN_FOCUS_CHANGE: i32 = 8455;
pub const URLACTION_FEATURE_DATA_BINDING: i32 = 8454;
pub const URLACTION_FEATURE_FORCE_ADDR_AND_STATUS: i32 = 8452;
pub const URLACTION_FEATURE_MIME_SNIFFING: i32 = 8448;
pub const URLACTION_FEATURE_MIN: i32 = 8448;
pub const URLACTION_FEATURE_SCRIPT_STATUS_BAR: i32 = 8451;
pub const URLACTION_FEATURE_WINDOW_RESTRICTIONS: i32 = 8450;
pub const URLACTION_FEATURE_ZONE_ELEVATION: i32 = 8449;
pub const URLACTION_HTML_ALLOW_CROSS_DOMAIN_CANVAS: i32 = 5645;
pub const URLACTION_HTML_ALLOW_CROSS_DOMAIN_TEXTTRACK: i32 = 5648;
pub const URLACTION_HTML_ALLOW_CROSS_DOMAIN_WEBWORKER: i32 = 5647;
pub const URLACTION_HTML_ALLOW_INDEXEDDB: i32 = 5649;
pub const URLACTION_HTML_ALLOW_INJECTED_DYNAMIC_HTML: i32 = 5643;
pub const URLACTION_HTML_ALLOW_WINDOW_CLOSE: i32 = 5646;
pub const URLACTION_HTML_FONT_DOWNLOAD: i32 = 5636;
pub const URLACTION_HTML_INCLUDE_FILE_PATH: i32 = 5642;
pub const URLACTION_HTML_JAVA_RUN: i32 = 5637;
pub const URLACTION_HTML_MAX: i32 = 6143;
pub const URLACTION_HTML_META_REFRESH: i32 = 5640;
pub const URLACTION_HTML_MIN: i32 = 5632;
pub const URLACTION_HTML_MIXED_CONTENT: i32 = 5641;
pub const URLACTION_HTML_REQUIRE_UTF8_DOCUMENT_CODEPAGE: i32 = 5644;
pub const URLACTION_HTML_SUBFRAME_NAVIGATE: i32 = 5639;
pub const URLACTION_HTML_SUBMIT_FORMS: i32 = 5633;
pub const URLACTION_HTML_SUBMIT_FORMS_FROM: i32 = 5634;
pub const URLACTION_HTML_SUBMIT_FORMS_TO: i32 = 5635;
pub const URLACTION_HTML_USERDATA_SAVE: i32 = 5638;
pub const URLACTION_INFODELIVERY_CURR_MAX: i32 = 7430;
pub const URLACTION_INFODELIVERY_MAX: i32 = 7679;
pub const URLACTION_INFODELIVERY_MIN: i32 = 7424;
pub const URLACTION_INFODELIVERY_NO_ADDING_CHANNELS: i32 = 7424;
pub const URLACTION_INFODELIVERY_NO_ADDING_SUBSCRIPTIONS: i32 = 7427;
pub const URLACTION_INFODELIVERY_NO_CHANNEL_LOGGING: i32 = 7430;
pub const URLACTION_INFODELIVERY_NO_EDITING_CHANNELS: i32 = 7425;
pub const URLACTION_INFODELIVERY_NO_EDITING_SUBSCRIPTIONS: i32 = 7428;
pub const URLACTION_INFODELIVERY_NO_REMOVING_CHANNELS: i32 = 7426;
pub const URLACTION_INFODELIVERY_NO_REMOVING_SUBSCRIPTIONS: i32 = 7429;
pub const URLACTION_INPRIVATE_BLOCKING: i32 = 9984;
pub const URLACTION_JAVA_CURR_MAX: i32 = 7168;
pub const URLACTION_JAVA_MAX: i32 = 7423;
pub const URLACTION_JAVA_MIN: i32 = 7168;
pub const URLACTION_JAVA_PERMISSIONS: i32 = 7168;
pub const URLACTION_LOOSE_XAML: i32 = 9218;
pub const URLACTION_LOWRIGHTS: i32 = 9472;
pub const URLACTION_MIN: i32 = 4096;
pub const URLACTION_NETWORK_CURR_MAX: i32 = 6672;
pub const URLACTION_NETWORK_MAX: i32 = 7167;
pub const URLACTION_NETWORK_MIN: i32 = 6656;
pub const URLACTION_PLUGGABLE_PROTOCOL_XHR: i32 = 5131;
pub const URLACTION_SCRIPT_CURR_MAX: i32 = 5133;
pub const URLACTION_SCRIPT_JAVA_USE: i32 = 5122;
pub const URLACTION_SCRIPT_MAX: i32 = 5631;
pub const URLACTION_SCRIPT_MIN: i32 = 5120;
pub const URLACTION_SCRIPT_NAVIGATE: i32 = 5130;
pub const URLACTION_SCRIPT_OVERRIDE_SAFETY: i32 = 5121;
pub const URLACTION_SCRIPT_PASTE: i32 = 5127;
pub const URLACTION_SCRIPT_RUN: i32 = 5120;
pub const URLACTION_SCRIPT_SAFE_ACTIVEX: i32 = 5125;
pub const URLACTION_SCRIPT_XSSFILTER: i32 = 5129;
pub const URLACTION_SHELL_ALLOW_CROSS_SITE_SHARE: i32 = 6161;
pub const URLACTION_SHELL_CURR_MAX: i32 = 6162;
pub const URLACTION_SHELL_ENHANCED_DRAGDROP_SECURITY: i32 = 6155;
pub const URLACTION_SHELL_EXECUTE_HIGHRISK: i32 = 6150;
pub const URLACTION_SHELL_EXECUTE_LOWRISK: i32 = 6152;
pub const URLACTION_SHELL_EXECUTE_MODRISK: i32 = 6151;
pub const URLACTION_SHELL_EXTENSIONSECURITY: i32 = 6156;
pub const URLACTION_SHELL_FILE_DOWNLOAD: i32 = 6147;
pub const URLACTION_SHELL_INSTALL_DTITEMS: i32 = 6144;
pub const URLACTION_SHELL_MAX: i32 = 6655;
pub const URLACTION_SHELL_MIN: i32 = 6144;
pub const URLACTION_SHELL_MOVE_OR_COPY: i32 = 6146;
pub const URLACTION_SHELL_POPUPMGR: i32 = 6153;
pub const URLACTION_SHELL_PREVIEW: i32 = 6159;
pub const URLACTION_SHELL_REMOTEQUERY: i32 = 6158;
pub const URLACTION_SHELL_RTF_OBJECTS_LOAD: i32 = 6154;
pub const URLACTION_SHELL_SECURE_DRAGSOURCE: i32 = 6157;
pub const URLACTION_SHELL_SHARE: i32 = 6160;
pub const URLACTION_SHELL_SHELLEXECUTE: i32 = 6150;
pub const URLACTION_SHELL_TOCTOU_RISK: i32 = 6162;
pub const URLACTION_SHELL_VERB: i32 = 6148;
pub const URLACTION_SHELL_WEBVIEW_VERB: i32 = 6149;
pub const URLACTION_WINDOWS_BROWSER_APPLICATIONS: i32 = 9216;
pub const URLACTION_WINFX_SETUP: i32 = 9728;
pub const URLACTION_XPS_DOCUMENTS: i32 = 9217;
pub const URLMON_OPTION_URL_ENCODING: i32 = 268435460;
pub const URLMON_OPTION_USERAGENT: i32 = 268435457;
pub const URLMON_OPTION_USERAGENT_REFRESH: i32 = 268435458;
pub const URLMON_OPTION_USE_BINDSTRINGCREDS: i32 = 268435464;
pub const URLMON_OPTION_USE_BROWSERAPPSDOCUMENTS: i32 = 268435472;
pub const URLOSTRM_GETNEWESTVERSION: i32 = 3;
pub const URLOSTRM_USECACHEDCOPY: i32 = 2;
pub const URLOSTRM_USECACHEDCOPY_ONLY: i32 = 1;
pub const URLPOLICY_ACTIVEX_CHECK_LIST: i32 = 65536;
pub const URLPOLICY_ALLOW: i32 = 0;
pub const URLPOLICY_AUTHENTICATE_CHALLENGE_RESPONSE: i32 = 65536;
pub const URLPOLICY_AUTHENTICATE_CLEARTEXT_OK: i32 = 0;
pub const URLPOLICY_AUTHENTICATE_MUTUAL_ONLY: i32 = 196608;
pub const URLPOLICY_BEHAVIOR_CHECK_LIST: i32 = 65536;
pub const URLPOLICY_CHANNEL_SOFTDIST_AUTOINSTALL: i32 = 196608;
pub const URLPOLICY_CHANNEL_SOFTDIST_PRECACHE: i32 = 131072;
pub const URLPOLICY_CHANNEL_SOFTDIST_PROHIBIT: i32 = 65536;
pub const URLPOLICY_CREDENTIALS_ANONYMOUS_ONLY: i32 = 196608;
pub const URLPOLICY_CREDENTIALS_CONDITIONAL_PROMPT: i32 = 131072;
pub const URLPOLICY_CREDENTIALS_MUST_PROMPT_USER: i32 = 65536;
pub const URLPOLICY_CREDENTIALS_SILENT_LOGON_OK: i32 = 0;
pub const URLPOLICY_DISALLOW: i32 = 3;
pub const URLPOLICY_DONTCHECKDLGBOX: i32 = 256;
pub const URLPOLICY_JAVA_CUSTOM: i32 = 8388608;
pub const URLPOLICY_JAVA_HIGH: i32 = 65536;
pub const URLPOLICY_JAVA_LOW: i32 = 196608;
pub const URLPOLICY_JAVA_MEDIUM: i32 = 131072;
pub const URLPOLICY_JAVA_PROHIBIT: i32 = 0;
pub const URLPOLICY_LOG_ON_ALLOW: i32 = 64;
pub const URLPOLICY_LOG_ON_DISALLOW: i32 = 128;
pub const URLPOLICY_MASK_PERMISSIONS: i32 = 15;
pub const URLPOLICY_NOTIFY_ON_ALLOW: i32 = 16;
pub const URLPOLICY_NOTIFY_ON_DISALLOW: i32 = 32;
pub const URLPOLICY_QUERY: i32 = 1;
...
pub const URLZONE_ESC_FLAG: i32 = 256;
...
pub const URL_MK_LEGACY: i32 = 0;
pub const URL_MK_NO_CANONICALIZE: i32 = 2;
pub const URL_MK_UNIFORM: i32 = 1;
pub const USE_SRC_URL: MONIKERPROPERTY = 1;
pub const UriBuilder_USE_ORIGINAL_FLAGS: i32 = 1;
pub const Uri_CREATE_ALLOW_IMPLICIT_FILE_SCHEME: i32 = 4;
pub const Uri_CREATE_ALLOW_IMPLICIT_WILDCARD_SCHEME: i32 = 2;
pub const Uri_CREATE_ALLOW_RELATIVE: i32 = 1;
pub const Uri_CREATE_CANONICALIZE: i32 = 256;
pub const Uri_CREATE_CANONICALIZE_ABSOLUTE: i32 = 131072;
pub const Uri_CREATE_CRACK_UNKNOWN_SCHEMES: i32 = 512;
pub const Uri_CREATE_DECODE_EXTRA_INFO: i32 = 64;
pub const Uri_CREATE_FILE_USE_DOS_PATH: i32 = 32;
pub const Uri_CREATE_IE_SETTINGS: i32 = 8192;
pub const Uri_CREATE_NOFRAG: i32 = 8;
pub const Uri_CREATE_NORMALIZE_INTL_CHARACTERS: i32 = 65536;
pub const Uri_CREATE_NO_CANONICALIZE: i32 = 16;
pub const Uri_CREATE_NO_CRACK_UNKNOWN_SCHEMES: i32 = 1024;
pub const Uri_CREATE_NO_DECODE_EXTRA_INFO: i32 = 128;
pub const Uri_CREATE_NO_ENCODE_FORBIDDEN_CHARACTERS: i32 = 32768;
pub const Uri_CREATE_NO_IE_SETTINGS: i32 = 16384;
pub const Uri_CREATE_NO_PRE_PROCESS_HTML_URI: i32 = 4096;
pub const Uri_CREATE_PRE_PROCESS_HTML_URI: i32 = 2048;
pub const Uri_DISPLAY_IDN_HOST: i32 = 4;
pub const Uri_DISPLAY_NO_FRAGMENT: i32 = 1;
pub const Uri_DISPLAY_NO_PUNYCODE: i32 = 8;
pub const Uri_ENCODING_HOST_IS_IDN: i32 = 4;
pub const Uri_ENCODING_HOST_IS_PERCENT_ENCODED_CP: i32 = 16;
pub const Uri_ENCODING_HOST_IS_PERCENT_ENCODED_UTF8: i32 = 8;
pub const Uri_ENCODING_QUERY_AND_FRAGMENT_IS_CP: i32 = 64;
pub const Uri_ENCODING_QUERY_AND_FRAGMENT_IS_PERCENT_ENCODED_UTF8: i32 = 32;
pub const Uri_ENCODING_RFC: i32 = 41;
pub const Uri_ENCODING_USER_INFO_AND_PATH_IS_CP: i32 = 2;
pub const Uri_ENCODING_USER_INFO_AND_PATH_IS_PERCENT_ENCODED_UTF8: i32 = 1;
pub const Uri_HAS_ABSOLUTE_URI: i32 = 1;
pub const Uri_HAS_AUTHORITY: i32 = 2;
pub const Uri_HAS_DISPLAY_URI: i32 = 4;
pub const Uri_HAS_DOMAIN: i32 = 8;
pub const Uri_HAS_EXTENSION: i32 = 16;
pub const Uri_HAS_FRAGMENT: i32 = 32;
pub const Uri_HAS_HOST: i32 = 64;
pub const Uri_HAS_HOST_TYPE: i32 = 32768;
pub const Uri_HAS_PASSWORD: i32 = 128;
pub const Uri_HAS_PATH: i32 = 256;
pub const Uri_HAS_PATH_AND_QUERY: i32 = 512;
pub const Uri_HAS_PORT: i32 = 65536;
pub const Uri_HAS_QUERY: i32 = 1024;
pub const Uri_HAS_RAW_URI: i32 = 2048;
pub const Uri_HAS_SCHEME: i32 = 131072;
pub const Uri_HAS_SCHEME_NAME: i32 = 4096;
pub const Uri_HAS_USER_INFO: i32 = 8192;
pub const Uri_HAS_USER_NAME: i32 = 16384;
pub const Uri_HAS_ZONE: i32 = 262144;
...
pub const Uri_PUNYCODE_IDN_HOST: i32 = 2;
pub const WININETINFO_OPTION_LOCK_HANDLE: i32 = 65534;
