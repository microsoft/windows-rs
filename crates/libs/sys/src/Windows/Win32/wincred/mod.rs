...
#[cfg(feature = "bcrypt")]
pub const STATUS_ACCESS_DENIED: super::NTSTATUS = 0xC0000022_u32 as _;
#[cfg(feature = "bcrypt")]
pub const STATUS_ACCOUNT_DISABLED: super::NTSTATUS = 0xC0000072_u32 as _;
#[cfg(feature = "bcrypt")]
pub const STATUS_ACCOUNT_EXPIRED: super::NTSTATUS = 0xC0000193_u32 as _;
#[cfg(feature = "bcrypt")]
pub const STATUS_ACCOUNT_LOCKED_OUT: super::NTSTATUS = 0xC0000234_u32 as _;
#[cfg(feature = "bcrypt")]
pub const STATUS_ACCOUNT_RESTRICTION: super::NTSTATUS = 0xC000006E_u32 as _;
#[cfg(feature = "bcrypt")]
pub const STATUS_AUTHENTICATION_FIREWALL_FAILED: super::NTSTATUS = 0xC0000413_u32 as _;
#[cfg(feature = "bcrypt")]
pub const STATUS_DOWNGRADE_DETECTED: super::NTSTATUS = 0xC0000388_u32 as _;
#[cfg(feature = "bcrypt")]
pub const STATUS_LOGON_FAILURE: super::NTSTATUS = 0xC000006D_u32 as _;
#[cfg(feature = "bcrypt")]
pub const STATUS_LOGON_TYPE_NOT_GRANTED: super::NTSTATUS = 0xC000015B_u32 as _;
#[cfg(feature = "bcrypt")]
pub const STATUS_NO_SUCH_LOGON_SESSION: super::NTSTATUS = 0xC000005F_u32 as _;
#[cfg(feature = "bcrypt")]
pub const STATUS_NO_SUCH_USER: super::NTSTATUS = 0xC0000064_u32 as _;
#[cfg(feature = "bcrypt")]
pub const STATUS_PASSWORD_EXPIRED: super::NTSTATUS = 0xC0000071_u32 as _;
#[cfg(feature = "bcrypt")]
pub const STATUS_PASSWORD_MUST_CHANGE: super::NTSTATUS = 0xC0000224_u32 as _;
#[cfg(feature = "bcrypt")]
pub const STATUS_WRONG_PASSWORD: super::NTSTATUS = 0xC000006A_u32 as _;
#[repr(C)]
#[derive(Clone, Copy)]
