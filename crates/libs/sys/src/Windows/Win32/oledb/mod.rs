...
pub const BMK_DURABILITY_INTRANSACTION: i32 = 1;
pub const BMK_DURABILITY_REORGANIZATION: i32 = 3;
pub const BMK_DURABILITY_ROWSET: i32 = 0;
pub const BMK_DURABILITY_XTRANSACTION: i32 = 2;
pub const CRESTRICTIONS_DBSCHEMA_ASSERTIONS: i32 = 3;
pub const CRESTRICTIONS_DBSCHEMA_CATALOGS: i32 = 1;
pub const CRESTRICTIONS_DBSCHEMA_CHARACTER_SETS: i32 = 3;
pub const CRESTRICTIONS_DBSCHEMA_CHECK_CONSTRAINTS: i32 = 3;
pub const CRESTRICTIONS_DBSCHEMA_CHECK_CONSTRAINTS_BY_TABLE: i32 = 6;
pub const CRESTRICTIONS_DBSCHEMA_COLLATIONS: i32 = 3;
pub const CRESTRICTIONS_DBSCHEMA_COLUMNS: i32 = 4;
pub const CRESTRICTIONS_DBSCHEMA_COLUMN_DOMAIN_USAGE: i32 = 4;
pub const CRESTRICTIONS_DBSCHEMA_COLUMN_PRIVILEGES: i32 = 6;
pub const CRESTRICTIONS_DBSCHEMA_CONSTRAINT_COLUMN_USAGE: i32 = 4;
pub const CRESTRICTIONS_DBSCHEMA_CONSTRAINT_TABLE_USAGE: i32 = 3;
pub const CRESTRICTIONS_DBSCHEMA_FOREIGN_KEYS: i32 = 6;
pub const CRESTRICTIONS_DBSCHEMA_INDEXES: i32 = 5;
pub const CRESTRICTIONS_DBSCHEMA_KEY_COLUMN_USAGE: i32 = 7;
pub const CRESTRICTIONS_DBSCHEMA_OBJECTS: i32 = 1;
pub const CRESTRICTIONS_DBSCHEMA_OBJECT_ACTIONS: i32 = 1;
pub const CRESTRICTIONS_DBSCHEMA_PRIMARY_KEYS: i32 = 3;
pub const CRESTRICTIONS_DBSCHEMA_PROCEDURES: i32 = 4;
pub const CRESTRICTIONS_DBSCHEMA_PROCEDURE_COLUMNS: i32 = 4;
pub const CRESTRICTIONS_DBSCHEMA_PROCEDURE_PARAMETERS: i32 = 4;
pub const CRESTRICTIONS_DBSCHEMA_PROVIDER_TYPES: i32 = 2;
pub const CRESTRICTIONS_DBSCHEMA_REFERENTIAL_CONSTRAINTS: i32 = 3;
pub const CRESTRICTIONS_DBSCHEMA_SCHEMATA: i32 = 3;
pub const CRESTRICTIONS_DBSCHEMA_SQL_LANGUAGES: i32 = 0;
pub const CRESTRICTIONS_DBSCHEMA_STATISTICS: i32 = 3;
pub const CRESTRICTIONS_DBSCHEMA_TABLES: i32 = 4;
pub const CRESTRICTIONS_DBSCHEMA_TABLES_INFO: i32 = 4;
pub const CRESTRICTIONS_DBSCHEMA_TABLE_CONSTRAINTS: i32 = 7;
pub const CRESTRICTIONS_DBSCHEMA_TABLE_PRIVILEGES: i32 = 5;
pub const CRESTRICTIONS_DBSCHEMA_TABLE_STATISTICS: i32 = 7;
pub const CRESTRICTIONS_DBSCHEMA_TRANSLATIONS: i32 = 3;
pub const CRESTRICTIONS_DBSCHEMA_TRUSTEE: i32 = 4;
pub const CRESTRICTIONS_DBSCHEMA_USAGE_PRIVILEGES: i32 = 6;
pub const CRESTRICTIONS_DBSCHEMA_VIEWS: i32 = 3;
pub const CRESTRICTIONS_DBSCHEMA_VIEW_COLUMN_USAGE: i32 = 3;
pub const CRESTRICTIONS_DBSCHEMA_VIEW_TABLE_USAGE: i32 = 3;
pub const CRESTRICTIONS_MDSCHEMA_ACTIONS: i32 = 8;
pub const CRESTRICTIONS_MDSCHEMA_COMMANDS: i32 = 5;
pub const CRESTRICTIONS_MDSCHEMA_CUBES: i32 = 3;
pub const CRESTRICTIONS_MDSCHEMA_DIMENSIONS: i32 = 5;
pub const CRESTRICTIONS_MDSCHEMA_FUNCTIONS: i32 = 4;
pub const CRESTRICTIONS_MDSCHEMA_HIERARCHIES: i32 = 6;
pub const CRESTRICTIONS_MDSCHEMA_LEVELS: i32 = 7;
pub const CRESTRICTIONS_MDSCHEMA_MEASURES: i32 = 5;
pub const CRESTRICTIONS_MDSCHEMA_MEMBERS: i32 = 12;
pub const CRESTRICTIONS_MDSCHEMA_PROPERTIES: i32 = 9;
pub const CRESTRICTIONS_MDSCHEMA_SETS: i32 = 5;
...
pub struct DBCOLUMNDESC {
    pub pwszTypeName: super::LPOLESTR,
    pub pTypeInfo: *mut core::ffi::c_void,
...
pub const DBCOMPUTEMODE_COMPUTED: i32 = 1;
pub const DBCOMPUTEMODE_DYNAMIC: i32 = 2;
pub const DBCOMPUTEMODE_NOTCOMPUTED: i32 = 3;
#[repr(C, packed(2))]
#[cfg(target_arch = "x86")]
#[cfg(all(feature = "minwindef", feature = "oaidl", feature = "wtypes", feature = "wtypesbase"))]
#[derive(Clone, Copy, Default)]
...
pub struct DBLITERALINFO {
    pub pwszLiteralValue: super::LPOLESTR,
    pub pwszInvalidChars: super::LPOLESTR,
    pub pwszInvalidStartingChars: super::LPOLESTR,
    pub lt: DBLITERAL,
...
pub const DBLITERAL_ESCAPE_PERCENT_PREFIX: DBLITERALENUM = 9;
pub const DBLITERAL_ESCAPE_PERCENT_SUFFIX: DBLITERALENUM21 = 29;
pub const DBLITERAL_ESCAPE_UNDERSCORE: DBLITERALENUM = 10;
pub const DBLITERAL_ESCAPE_UNDERSCORE_PREFIX: DBLITERALENUM = 10;
...
pub const DBLITERAL_QUOTE_PREFIX: DBLITERALENUM = 15;
...
pub struct DBPARAMBINDINFO {
    pub pwszDataSourceType: super::LPOLESTR,
    pub pwszName: super::LPOLESTR,
...
pub const DBPARAMTYPE_OUTPUT: i32 = 3;
pub const DBPARAMTYPE_RETURNVALUE: i32 = 4;
pub type DBPART = u32;
...
pub const DBPROMPT_COMPLETE: i32 = 2;
pub const DBPROMPT_COMPLETEREQUIRED: i32 = 3;
pub const DBPROMPT_NOPROMPT: i32 = 4;
pub const DBPROMPT_PROMPT: i32 = 1;
#[repr(C, packed(2))]
#[cfg(target_arch = "x86")]
#[cfg(all(feature = "minwindef", feature = "oaidl", feature = "wtypes", feature = "wtypesbase"))]
#[derive(Clone, Copy)]
...
pub struct DBPROPINFO {
    pub pwszDescription: super::LPOLESTR,
    pub dwPropertyID: DBPROPID,
...
pub const DBPROPVAL_AO_RANDOM: i32 = 2;
pub const DBPROPVAL_AO_SEQUENTIAL: i32 = 0;
pub const DBPROPVAL_AO_SEQUENTIALSTORAGEOBJECTS: i32 = 1;
pub const DBPROPVAL_ASYNCH_BACKGROUNDPOPULATION: i32 = 8;
pub const DBPROPVAL_ASYNCH_INITIALIZE: i32 = 1;
pub const DBPROPVAL_ASYNCH_POPULATEONDEMAND: i32 = 32;
pub const DBPROPVAL_ASYNCH_PREPOPULATE: i32 = 16;
pub const DBPROPVAL_ASYNCH_RANDOMPOPULATION: i32 = 4;
pub const DBPROPVAL_ASYNCH_SEQUENTIALPOPULATION: i32 = 2;
pub const DBPROPVAL_BD_INTRANSACTION: i32 = 1;
pub const DBPROPVAL_BD_REORGANIZATION: i32 = 3;
pub const DBPROPVAL_BD_ROWSET: i32 = 0;
pub const DBPROPVAL_BD_XTRANSACTION: i32 = 2;
pub const DBPROPVAL_BI_CROSSROWSET: i32 = 1;
pub const DBPROPVAL_BMK_KEY: i32 = 2;
pub const DBPROPVAL_BMK_NUMERIC: i32 = 1;
pub const DBPROPVAL_BO_NOINDEXUPDATE: i32 = 1;
pub const DBPROPVAL_BO_NOLOG: i32 = 0;
pub const DBPROPVAL_BO_REFINTEGRITY: i32 = 2;
pub const DBPROPVAL_CB_DELETE: i32 = 1;
pub const DBPROPVAL_CB_NON_NULL: i32 = 2;
pub const DBPROPVAL_CB_NULL: i32 = 1;
pub const DBPROPVAL_CB_PRESERVE: i32 = 2;
pub const DBPROPVAL_CD_NOTNULL: i32 = 1;
pub const DBPROPVAL_CL_END: i32 = 2;
pub const DBPROPVAL_CL_START: i32 = 1;
pub const DBPROPVAL_CM_TRANSACTIONS: i32 = 1;
pub const DBPROPVAL_CO_BEGINSWITH: i32 = 32;
pub const DBPROPVAL_CO_CASEINSENSITIVE: i32 = 8;
pub const DBPROPVAL_CO_CASESENSITIVE: i32 = 4;
pub const DBPROPVAL_CO_CONTAINS: i32 = 16;
pub const DBPROPVAL_CO_EQUALITY: i32 = 1;
pub const DBPROPVAL_CO_STRING: i32 = 2;
pub const DBPROPVAL_CS_COMMUNICATIONFAILURE: i32 = 2;
pub const DBPROPVAL_CS_INITIALIZED: i32 = 1;
pub const DBPROPVAL_CS_UNINITIALIZED: i32 = 0;
pub const DBPROPVAL_CU_DML_STATEMENTS: i32 = 1;
pub const DBPROPVAL_CU_INDEX_DEFINITION: i32 = 4;
pub const DBPROPVAL_CU_PRIVILEGE_DEFINITION: i32 = 8;
pub const DBPROPVAL_CU_TABLE_DEFINITION: i32 = 2;
pub const DBPROPVAL_DF_INITIALLY_DEFERRED: i32 = 1;
pub const DBPROPVAL_DF_INITIALLY_IMMEDIATE: i32 = 2;
pub const DBPROPVAL_DF_NOT_DEFERRABLE: i32 = 3;
pub const DBPROPVAL_DST_DOCSOURCE: i32 = 4;
pub const DBPROPVAL_DST_MDP: i32 = 2;
pub const DBPROPVAL_DST_TDP: i32 = 1;
pub const DBPROPVAL_DST_TDPANDMDP: i32 = 3;
pub const DBPROPVAL_FU_CATALOG: i32 = 8;
pub const DBPROPVAL_FU_COLUMN: i32 = 2;
pub const DBPROPVAL_FU_NOT_SUPPORTED: i32 = 1;
pub const DBPROPVAL_FU_TABLE: i32 = 4;
pub const DBPROPVAL_GB_COLLATE: i32 = 16;
pub const DBPROPVAL_GB_CONTAINS_SELECT: i32 = 4;
pub const DBPROPVAL_GB_EQUALS_SELECT: i32 = 2;
pub const DBPROPVAL_GB_NOT_SUPPORTED: i32 = 1;
pub const DBPROPVAL_GB_NO_RELATION: i32 = 8;
pub const DBPROPVAL_GU_NOTSUPPORTED: i32 = 1;
pub const DBPROPVAL_GU_SUFFIX: i32 = 2;
pub const DBPROPVAL_HT_DIFFERENT_CATALOGS: i32 = 1;
pub const DBPROPVAL_HT_DIFFERENT_PROVIDERS: i32 = 2;
pub const DBPROPVAL_IC_LOWER: i32 = 2;
pub const DBPROPVAL_IC_MIXED: i32 = 8;
pub const DBPROPVAL_IC_SENSITIVE: i32 = 4;
pub const DBPROPVAL_IC_UPPER: i32 = 1;
pub const DBPROPVAL_IN_ALLOWNULL: i32 = 0;
pub const DBPROPVAL_IN_DISALLOWNULL: i32 = 1;
pub const DBPROPVAL_IN_IGNOREANYNULL: i32 = 4;
pub const DBPROPVAL_IN_IGNORENULL: i32 = 2;
pub const DBPROPVAL_IT_BTREE: i32 = 1;
pub const DBPROPVAL_IT_CONTENT: i32 = 3;
pub const DBPROPVAL_IT_HASH: i32 = 2;
pub const DBPROPVAL_IT_OTHER: i32 = 4;
pub const DBPROPVAL_LM_NONE: i32 = 1;
pub const DBPROPVAL_LM_SINGLEROW: i32 = 2;
pub const DBPROPVAL_MR_CONCURRENT: i32 = 2;
pub const DBPROPVAL_MR_NOTSUPPORTED: i32 = 0;
pub const DBPROPVAL_MR_SUPPORTED: i32 = 1;
pub const DBPROPVAL_NC_END: i32 = 1;
pub const DBPROPVAL_NC_HIGH: i32 = 2;
pub const DBPROPVAL_NC_LOW: i32 = 4;
pub const DBPROPVAL_NC_START: i32 = 8;
pub const DBPROPVAL_NP_ABOUTTODO: i32 = 2;
pub const DBPROPVAL_NP_DIDEVENT: i32 = 16;
pub const DBPROPVAL_NP_FAILEDTODO: i32 = 8;
pub const DBPROPVAL_NP_OKTODO: i32 = 1;
pub const DBPROPVAL_NP_SYNCHAFTER: i32 = 4;
pub const DBPROPVAL_NT_MULTIPLEROWS: i32 = 2;
pub const DBPROPVAL_NT_SINGLEROW: i32 = 1;
pub const DBPROPVAL_OA_ATEXECUTE: i32 = 2;
pub const DBPROPVAL_OA_ATROWRELEASE: i32 = 4;
pub const DBPROPVAL_OA_NOTSUPPORTED: i32 = 1;
pub const DBPROPVAL_OO_BLOB: i32 = 1;
pub const DBPROPVAL_OO_DIRECTBIND: i32 = 16;
pub const DBPROPVAL_OO_IPERSIST: i32 = 2;
pub const DBPROPVAL_OO_ROWOBJECT: i32 = 4;
pub const DBPROPVAL_OO_SCOPED: i32 = 8;
pub const DBPROPVAL_OO_SINGLETON: i32 = 32;
pub const DBPROPVAL_OP_EQUAL: i32 = 1;
pub const DBPROPVAL_OP_RELATIVE: i32 = 2;
pub const DBPROPVAL_OP_STRING: i32 = 4;
pub const DBPROPVAL_ORS_HISTOGRAM: i32 = 8;
pub const DBPROPVAL_ORS_INDEX: i32 = 1;
pub const DBPROPVAL_ORS_INTEGRATEDINDEX: i32 = 2;
pub const DBPROPVAL_ORS_STOREDPROC: i32 = 4;
pub const DBPROPVAL_ORS_TABLE: i32 = 0;
pub const DBPROPVAL_OS_AGR_AFTERSESSION: i32 = 8;
pub const DBPROPVAL_OS_CLIENTCURSOR: i32 = 4;
pub const DBPROPVAL_OS_DISABLEALL: i32 = 0;
pub const DBPROPVAL_OS_ENABLEALL: u32 = 4294967295;
pub const DBPROPVAL_OS_RESOURCEPOOLING: i32 = 1;
pub const DBPROPVAL_OS_TXNENLISTMENT: i32 = 2;
pub const DBPROPVAL_PT_GUID: i32 = 8;
pub const DBPROPVAL_PT_GUID_NAME: i32 = 1;
pub const DBPROPVAL_PT_GUID_PROPID: i32 = 2;
pub const DBPROPVAL_PT_NAME: i32 = 4;
pub const DBPROPVAL_PT_PGUID_NAME: i32 = 32;
pub const DBPROPVAL_PT_PGUID_PROPID: i32 = 64;
pub const DBPROPVAL_PT_PROPID: i32 = 16;
pub const DBPROPVAL_RD_RESETALL: u32 = 4294967295;
pub const DBPROPVAL_RT_APTMTTHREAD: i32 = 2;
pub const DBPROPVAL_RT_FREETHREAD: i32 = 1;
pub const DBPROPVAL_RT_SINGLETHREAD: i32 = 4;
pub const DBPROPVAL_SQL_ANSI89_IEF: i32 = 8;
pub const DBPROPVAL_SQL_ANSI92_ENTRY: i32 = 16;
pub const DBPROPVAL_SQL_ANSI92_FULL: i32 = 128;
pub const DBPROPVAL_SQL_ANSI92_INTERMEDIATE: i32 = 64;
pub const DBPROPVAL_SQL_ESCAPECLAUSES: i32 = 256;
pub const DBPROPVAL_SQL_FIPS_TRANSITIONAL: i32 = 32;
pub const DBPROPVAL_SQL_NONE: i32 = 0;
pub const DBPROPVAL_SQL_ODBC_CORE: i32 = 2;
pub const DBPROPVAL_SQL_ODBC_EXTENDED: i32 = 4;
pub const DBPROPVAL_SQL_ODBC_MINIMUM: i32 = 1;
pub const DBPROPVAL_SQL_SUBMINIMUM: i32 = 512;
pub const DBPROPVAL_SQ_COMPARISON: i32 = 2;
pub const DBPROPVAL_SQ_CORRELATEDSUBQUERIES: i32 = 1;
pub const DBPROPVAL_SQ_EXISTS: i32 = 4;
pub const DBPROPVAL_SQ_IN: i32 = 8;
pub const DBPROPVAL_SQ_QUANTIFIED: i32 = 16;
pub const DBPROPVAL_SQ_TABLE: i32 = 32;
pub const DBPROPVAL_SS_ILOCKBYTES: i32 = 8;
pub const DBPROPVAL_SS_ISEQUENTIALSTREAM: i32 = 1;
pub const DBPROPVAL_SS_ISTORAGE: i32 = 4;
pub const DBPROPVAL_SS_ISTREAM: i32 = 2;
pub const DBPROPVAL_STGM_CONVERT: i32 = 262144;
pub const DBPROPVAL_STGM_CREATE: i32 = 4096;
pub const DBPROPVAL_STGM_DELETEONRELEASE: i32 = 2097152;
pub const DBPROPVAL_STGM_DIRECT: i32 = 65536;
pub const DBPROPVAL_STGM_FAILIFTHERE: i32 = 524288;
pub const DBPROPVAL_STGM_PRIORITY: i32 = 1048576;
pub const DBPROPVAL_STGM_READ: i32 = 0;
pub const DBPROPVAL_STGM_READWRITE: i32 = 2;
pub const DBPROPVAL_STGM_SHARE_DENY_NONE: i32 = 64;
pub const DBPROPVAL_STGM_SHARE_DENY_READ: i32 = 48;
pub const DBPROPVAL_STGM_SHARE_DENY_WRITE: i32 = 32;
pub const DBPROPVAL_STGM_SHARE_EXCLUSIVE: i32 = 16;
pub const DBPROPVAL_STGM_TRANSACTED: i32 = 131072;
pub const DBPROPVAL_STGM_WRITE: i32 = 1;
pub const DBPROPVAL_SU_DML_STATEMENTS: i32 = 1;
pub const DBPROPVAL_SU_INDEX_DEFINITION: i32 = 4;
pub const DBPROPVAL_SU_PRIVILEGE_DEFINITION: i32 = 8;
pub const DBPROPVAL_SU_TABLE_DEFINITION: i32 = 2;
pub const DBPROPVAL_TC_ALL: i32 = 8;
pub const DBPROPVAL_TC_DDL_COMMIT: i32 = 2;
pub const DBPROPVAL_TC_DDL_IGNORE: i32 = 4;
pub const DBPROPVAL_TC_DDL_LOCK: i32 = 16;
pub const DBPROPVAL_TC_DML: i32 = 1;
pub const DBPROPVAL_TC_NONE: i32 = 0;
pub const DBPROPVAL_TI_BROWSE: i32 = 256;
pub const DBPROPVAL_TI_CHAOS: i32 = 16;
pub const DBPROPVAL_TI_CURSORSTABILITY: i32 = 4096;
pub const DBPROPVAL_TI_ISOLATED: i32 = 1048576;
pub const DBPROPVAL_TI_READCOMMITTED: i32 = 4096;
pub const DBPROPVAL_TI_READUNCOMMITTED: i32 = 256;
pub const DBPROPVAL_TI_REPEATABLEREAD: i32 = 65536;
pub const DBPROPVAL_TI_SERIALIZABLE: i32 = 1048576;
pub const DBPROPVAL_TR_ABORT: i32 = 16;
pub const DBPROPVAL_TR_ABORT_DC: i32 = 8;
pub const DBPROPVAL_TR_ABORT_NO: i32 = 32;
pub const DBPROPVAL_TR_BOTH: i32 = 128;
pub const DBPROPVAL_TR_COMMIT: i32 = 2;
pub const DBPROPVAL_TR_COMMIT_DC: i32 = 1;
pub const DBPROPVAL_TR_COMMIT_NO: i32 = 4;
pub const DBPROPVAL_TR_DONTCARE: i32 = 64;
pub const DBPROPVAL_TR_NONE: i32 = 256;
pub const DBPROPVAL_TR_OPTIMISTIC: i32 = 512;
pub const DBPROPVAL_TS_CARDINALITY: i32 = 1;
pub const DBPROPVAL_TS_HISTOGRAM: i32 = 2;
pub const DBPROPVAL_UP_CHANGE: i32 = 1;
pub const DBPROPVAL_UP_DELETE: i32 = 2;
pub const DBPROPVAL_UP_INSERT: i32 = 4;
...
pub const DBPROP_PROVIDERFILENAME: DBPROPENUM = 96;
...
pub const DBPROP_SERVER_NAME: DBPROPENUM20 = 250;
...
pub const DBSEEK_GE: DBSEEKENUM = 4;
pub const DBSEEK_GT: DBSEEKENUM = 8;
pub const DBSEEK_INVALID: DBSEEKENUM = 0;
pub const DBSEEK_LASTEQ: DBSEEKENUM = 2;
pub const DBSEEK_LE: DBSEEKENUM = 16;
pub const DBSEEK_LT: DBSEEKENUM = 32;
pub type DBSORT = u32;
...
#[cfg(target_arch = "x86")]
pub const DBTYPEFOR_DBLENGTH: DBTYPEENUM = 19;
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
pub const DBTYPEFOR_DBLENGTH: DBTYPEENUM = 21;
#[cfg(target_arch = "x86")]
pub const DBTYPEFOR_DBORDINAL: DBTYPEENUM = 19;
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
pub const DBTYPEFOR_DBORDINAL: DBTYPEENUM = 21;
#[cfg(target_arch = "x86")]
pub const DBTYPEFOR_DBROWCOUNT: DBTYPEENUM = 3;
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
pub const DBTYPEFOR_DBROWCOUNT: DBTYPEENUM = 20;
...
pub const DB_BINDFLAGS_COLLECTION: i32 = 16;
pub const DB_BINDFLAGS_DELAYFETCHCOLUMNS: i32 = 1;
pub const DB_BINDFLAGS_DELAYFETCHSTREAM: i32 = 2;
pub const DB_BINDFLAGS_ISSTRUCTUREDDOCUMENT: i32 = 128;
pub const DB_BINDFLAGS_OPENIFEXISTS: i32 = 32;
pub const DB_BINDFLAGS_OUTPUT: i32 = 8;
pub const DB_BINDFLAGS_OVERWRITE: i32 = 64;
pub const DB_BINDFLAGS_RECURSIVE: i32 = 4;
pub const DB_COLLATION_ASC: i32 = 1;
pub const DB_COLLATION_DESC: i32 = 2;
...
pub const DB_IMP_LEVEL_ANONYMOUS: i32 = 0;
pub const DB_IMP_LEVEL_DELEGATE: i32 = 3;
pub const DB_IMP_LEVEL_IDENTIFY: i32 = 1;
pub const DB_IMP_LEVEL_IMPERSONATE: i32 = 2;
#[cfg(target_arch = "x86")]
pub const DB_INVALIDCOLUMN: u32 = 4294967295;
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
pub const DB_INVALIDCOLUMN: u64 = 18446744073709551615;
pub const DB_INVALID_HACCESSOR: i32 = 0;
pub const DB_INVALID_HCHAPTER: i32 = 0;
pub const DB_LIKE_ONLY: i32 = 2;
pub const DB_LOCAL_EXCLUSIVE: i32 = 3;
pub const DB_LOCAL_SHARED: i32 = 2;
#[cfg(target_arch = "x86")]
...
pub const DB_MODE_READ: i32 = 1;
pub const DB_MODE_READWRITE: i32 = 3;
pub const DB_MODE_SHARE_DENY_NONE: i32 = 16;
pub const DB_MODE_SHARE_DENY_READ: i32 = 4;
pub const DB_MODE_SHARE_DENY_WRITE: i32 = 8;
pub const DB_MODE_SHARE_EXCLUSIVE: i32 = 12;
pub const DB_MODE_WRITE: i32 = 2;
pub const DB_NULL_HACCESSOR: i32 = 0;
pub const DB_NULL_HCHAPTER: i32 = 0;
pub const DB_NULL_HROW: i32 = 0;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const DB_PROT_LEVEL_CALL: i32 = 2;
pub const DB_PROT_LEVEL_CONNECT: i32 = 1;
pub const DB_PROT_LEVEL_NONE: i32 = 0;
pub const DB_PROT_LEVEL_PKT: i32 = 3;
pub const DB_PROT_LEVEL_PKT_INTEGRITY: i32 = 4;
pub const DB_PROT_LEVEL_PKT_PRIVACY: i32 = 5;
pub const DB_PT_FUNCTION: i32 = 3;
pub const DB_PT_PROCEDURE: i32 = 2;
pub const DB_PT_UNKNOWN: i32 = 1;
pub const DB_REMOTE: i32 = 1;
pub const DB_SEARCHABLE: i32 = 4;
pub const DB_UNSEARCHABLE: i32 = 1;
#[cfg(target_arch = "x86")]
...
pub const IDENTIFIER_SDK_ERROR: i32 = 268435456;
...
pub struct MDAXISINFO {
    ...
    pub rgpwszDimensionNames: *mut super::LPOLESTR,
}
#[repr(C)]
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
#[cfg(feature = "wtypesbase")]
...
pub const MDAXIS_PAGES: i32 = 2;
pub const MDAXIS_ROWS: i32 = 1;
pub const MDAXIS_SECTIONS: i32 = 3;
pub const MDAXIS_SLICERS: u32 = 4294967295;
pub const MDDISPINFO_DRILLED_DOWN: i32 = 65536;
pub const MDDISPINFO_PARENT_SAME_AS_PREV: i32 = 131072;
pub const MDFF_BOLD: i32 = 1;
pub const MDFF_ITALIC: i32 = 2;
pub const MDFF_STRIKEOUT: i32 = 8;
pub const MDFF_UNDERLINE: i32 = 4;
pub const MDLEVEL_TYPE_ALL: i32 = 1;
pub const MDLEVEL_TYPE_CALCULATED: i32 = 2;
pub const MDLEVEL_TYPE_REGULAR: i32 = 0;
pub const MDLEVEL_TYPE_RESERVED1: i32 = 8;
pub const MDLEVEL_TYPE_TIME: i32 = 4;
pub const MDLEVEL_TYPE_TIME_DAYS: i32 = 516;
pub const MDLEVEL_TYPE_TIME_HALF_YEAR: i32 = 36;
pub const MDLEVEL_TYPE_TIME_HOURS: i32 = 772;
pub const MDLEVEL_TYPE_TIME_MINUTES: i32 = 1028;
pub const MDLEVEL_TYPE_TIME_MONTHS: i32 = 132;
pub const MDLEVEL_TYPE_TIME_QUARTERS: i32 = 68;
pub const MDLEVEL_TYPE_TIME_SECONDS: i32 = 2052;
pub const MDLEVEL_TYPE_TIME_UNDEFINED: i32 = 4100;
pub const MDLEVEL_TYPE_TIME_WEEKS: i32 = 260;
pub const MDLEVEL_TYPE_TIME_YEARS: i32 = 20;
pub const MDLEVEL_TYPE_UNKNOWN: i32 = 0;
pub const MDMEASURE_AGGR_AVG: i32 = 5;
pub const MDMEASURE_AGGR_CALCULATED: i32 = 127;
pub const MDMEASURE_AGGR_COUNT: i32 = 2;
pub const MDMEASURE_AGGR_MAX: i32 = 4;
pub const MDMEASURE_AGGR_MIN: i32 = 3;
pub const MDMEASURE_AGGR_STD: i32 = 7;
pub const MDMEASURE_AGGR_SUM: i32 = 1;
pub const MDMEASURE_AGGR_UNKNOWN: i32 = 0;
pub const MDMEASURE_AGGR_VAR: i32 = 6;
pub const MDMEMBER_TYPE_ALL: i32 = 2;
pub const MDMEMBER_TYPE_FORMULA: i32 = 4;
pub const MDMEMBER_TYPE_MEASURE: i32 = 3;
pub const MDMEMBER_TYPE_REGULAR: i32 = 1;
pub const MDMEMBER_TYPE_RESERVE1: i32 = 5;
pub const MDMEMBER_TYPE_RESERVE2: i32 = 6;
pub const MDMEMBER_TYPE_RESERVE3: i32 = 7;
pub const MDMEMBER_TYPE_RESERVE4: i32 = 8;
pub const MDMEMBER_TYPE_UNKNOWN: i32 = 0;
pub const MDPROPVAL_AU_UNCHANGED: i32 = 1;
pub const MDPROPVAL_AU_UNKNOWN: i32 = 2;
pub const MDPROPVAL_AU_UNSUPPORTED: i32 = 0;
pub const MDPROPVAL_FS_FULL_SUPPORT: i32 = 1;
pub const MDPROPVAL_FS_GENERATED_COLUMN: i32 = 2;
pub const MDPROPVAL_FS_GENERATED_DIMENSION: i32 = 3;
pub const MDPROPVAL_FS_NO_SUPPORT: i32 = 4;
pub const MDPROPVAL_MC_SEARCHEDCASE: i32 = 2;
pub const MDPROPVAL_MC_SINGLECASE: i32 = 1;
pub const MDPROPVAL_MD_AFTER: i32 = 4;
pub const MDPROPVAL_MD_BEFORE: i32 = 2;
pub const MDPROPVAL_MD_SELF: i32 = 1;
pub const MDPROPVAL_MF_CREATE_CALCMEMBERS: i32 = 4;
pub const MDPROPVAL_MF_CREATE_NAMEDSETS: i32 = 8;
pub const MDPROPVAL_MF_SCOPE_GLOBAL: i32 = 32;
pub const MDPROPVAL_MF_SCOPE_SESSION: i32 = 16;
pub const MDPROPVAL_MF_WITH_CALCMEMBERS: i32 = 1;
pub const MDPROPVAL_MF_WITH_NAMEDSETS: i32 = 2;
pub const MDPROPVAL_MJC_IMPLICITCUBE: i32 = 4;
pub const MDPROPVAL_MJC_MULTICUBES: i32 = 2;
pub const MDPROPVAL_MJC_SINGLECUBE: i32 = 1;
pub const MDPROPVAL_MMF_CLOSINGPERIOD: i32 = 8;
pub const MDPROPVAL_MMF_COUSIN: i32 = 1;
pub const MDPROPVAL_MMF_OPENINGPERIOD: i32 = 4;
pub const MDPROPVAL_MMF_PARALLELPERIOD: i32 = 2;
pub const MDPROPVAL_MNF_AGGREGATE: i32 = 16;
pub const MDPROPVAL_MNF_CORRELATION: i32 = 64;
pub const MDPROPVAL_MNF_COVARIANCE: i32 = 32;
pub const MDPROPVAL_MNF_DRILLDOWNLEVEL: i32 = 2048;
pub const MDPROPVAL_MNF_DRILLDOWNLEVELBOTTOM: i32 = 32768;
pub const MDPROPVAL_MNF_DRILLDOWNLEVELTOP: i32 = 16384;
pub const MDPROPVAL_MNF_DRILLDOWNMEMBERBOTTOM: i32 = 8192;
pub const MDPROPVAL_MNF_DRILLDOWNMEMBERTOP: i32 = 4096;
pub const MDPROPVAL_MNF_DRILLUPLEVEL: i32 = 131072;
pub const MDPROPVAL_MNF_DRILLUPMEMBER: i32 = 65536;
pub const MDPROPVAL_MNF_LINREG2: i32 = 512;
pub const MDPROPVAL_MNF_LINREGPOINT: i32 = 1024;
pub const MDPROPVAL_MNF_LINREGSLOPE: i32 = 128;
pub const MDPROPVAL_MNF_LINREGVARIANCE: i32 = 256;
pub const MDPROPVAL_MNF_MEDIAN: i32 = 1;
pub const MDPROPVAL_MNF_RANK: i32 = 8;
pub const MDPROPVAL_MNF_STDDEV: i32 = 4;
pub const MDPROPVAL_MNF_VAR: i32 = 2;
pub const MDPROPVAL_MOQ_CATALOG_CUBE: i32 = 2;
pub const MDPROPVAL_MOQ_CUBE_DIM: i32 = 8;
pub const MDPROPVAL_MOQ_DATASOURCE_CUBE: i32 = 1;
pub const MDPROPVAL_MOQ_DIMHIER_LEVEL: i32 = 32;
pub const MDPROPVAL_MOQ_DIMHIER_MEMBER: i32 = 256;
pub const MDPROPVAL_MOQ_DIM_HIER: i32 = 16;
pub const MDPROPVAL_MOQ_LEVEL_MEMBER: i32 = 64;
pub const MDPROPVAL_MOQ_MEMBER_MEMBER: i32 = 128;
pub const MDPROPVAL_MOQ_OUTERREFERENCE: i32 = 1;
pub const MDPROPVAL_MOQ_SCHEMA_CUBE: i32 = 4;
pub const MDPROPVAL_MSC_GREATERTHAN: i32 = 2;
pub const MDPROPVAL_MSC_GREATERTHANEQUAL: i32 = 8;
pub const MDPROPVAL_MSC_LESSTHAN: i32 = 1;
pub const MDPROPVAL_MSC_LESSTHANEQUAL: i32 = 4;
pub const MDPROPVAL_MSF_BOTTOMPERCENT: i32 = 2;
pub const MDPROPVAL_MSF_BOTTOMSUM: i32 = 8;
pub const MDPROPVAL_MSF_DRILLDOWNLEVEL: i32 = 2048;
pub const MDPROPVAL_MSF_DRILLDOWNLEVELBOTTOM: i32 = 32768;
pub const MDPROPVAL_MSF_DRILLDOWNLEVELTOP: i32 = 16384;
pub const MDPROPVAL_MSF_DRILLDOWNMEMBBER: i32 = 1024;
pub const MDPROPVAL_MSF_DRILLDOWNMEMBERBOTTOM: i32 = 8192;
pub const MDPROPVAL_MSF_DRILLDOWNMEMBERTOP: i32 = 4096;
pub const MDPROPVAL_MSF_DRILLUPLEVEL: i32 = 131072;
pub const MDPROPVAL_MSF_DRILLUPMEMBER: i32 = 65536;
pub const MDPROPVAL_MSF_LASTPERIODS: i32 = 32;
pub const MDPROPVAL_MSF_MTD: i32 = 256;
pub const MDPROPVAL_MSF_PERIODSTODATE: i32 = 16;
pub const MDPROPVAL_MSF_QTD: i32 = 128;
pub const MDPROPVAL_MSF_TOGGLEDRILLSTATE: i32 = 262144;
pub const MDPROPVAL_MSF_TOPPERCENT: i32 = 1;
pub const MDPROPVAL_MSF_TOPSUM: i32 = 4;
pub const MDPROPVAL_MSF_WTD: i32 = 512;
pub const MDPROPVAL_MSF_YTD: i32 = 64;
pub const MDPROPVAL_MS_MULTIPLETUPLES: i32 = 1;
pub const MDPROPVAL_MS_SINGLETUPLE: i32 = 2;
pub const MDPROPVAL_NL_NAMEDLEVELS: i32 = 1;
pub const MDPROPVAL_NL_NUMBEREDLEVELS: i32 = 2;
pub const MDPROPVAL_NL_SCHEMAONLY: i32 = 4;
pub const MDPROPVAL_NME_ALLDIMENSIONS: i32 = 0;
pub const MDPROPVAL_NME_MEASURESONLY: i32 = 1;
pub const MDPROPVAL_RR_NORANGEROWSET: i32 = 1;
pub const MDPROPVAL_RR_READONLY: i32 = 2;
pub const MDPROPVAL_RR_UPDATE: i32 = 4;
pub const MDPROPVAL_VISUAL_MODE_DEFAULT: i32 = 0;
pub const MDPROPVAL_VISUAL_MODE_VISUAL: i32 = 1;
pub const MDPROPVAL_VISUAL_MODE_VISUAL_OFF: i32 = 2;
pub const MDPROP_AGGREGATECELL_UPDATE: DBPROPENUM20 = 230;
pub const MDPROP_AXES: DBPROPENUM20 = 252;
pub const MDPROP_CELL: i32 = 2;
...
pub const MDTREEOP_ANCESTORS: i32 = 32;
pub const MDTREEOP_CHILDREN: i32 = 1;
pub const MDTREEOP_DESCENDANTS: i32 = 16;
pub const MDTREEOP_PARENT: i32 = 4;
pub const MDTREEOP_SELF: i32 = 8;
pub const MDTREEOP_SIBLINGS: i32 = 2;
pub const MD_DIMTYPE_MEASURE: i32 = 2;
pub const MD_DIMTYPE_OTHER: i32 = 3;
pub const MD_DIMTYPE_TIME: i32 = 1;
pub const MD_DIMTYPE_UNKNOWN: i32 = 0;
pub const OLEDBVER: i32 = 624;
#[cfg(all(feature = "minwindef", feature = "oaidl", feature = "wtypes", feature = "wtypesbase"))]
...
pub const PERM_DESIGN: ACCESS_MASKENUM = 2048;
...
pub const STD_BOOKMARKLENGTH: i32 = 1;
