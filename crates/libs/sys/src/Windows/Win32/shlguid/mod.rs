...
pub const CLSID_FolderItem: windows_sys::core::GUID = windows_sys::core::GUID::from_u128(0xfef10fa2_355e_4e06_9381_9b24d7f7cc88);
...
pub const IID_CDefView: windows_sys::core::GUID = windows_sys::core::GUID::from_u128(0x4434ff80_ef4c_11ce_ae65_08002b2e1262);
pub const IID_IBriefcaseStg: windows_sys::core::GUID = windows_sys::core::GUID::from_u128(0x8bce1fa1_0921_101b_b1ff_00dd010ccc48);
pub const IID_IDefViewFrame: windows_sys::core::GUID = windows_sys::core::GUID::from_u128(0x710eb7a0_45ed_11d0_924a_0020afc7ac4d);
pub const IID_IDefViewID: windows_sys::core::GUID = windows_sys::core::GUID::from_u128(0x985f64f0_d410_4e02_be22_da07f2b5c5e1);
pub const IID_IDiscardableBrowserProperty: windows_sys::core::GUID = windows_sys::core::GUID::from_u128(0x49c3de7c_d329_11d0_ab73_00c04fc33e80);
pub const IID_IFileViewerA: windows_sys::core::GUID = windows_sys::core::GUID::from_u128(0x000214f0_0000_0000_c000_000000000046);
pub const IID_IFileViewerSite: windows_sys::core::GUID = windows_sys::core::GUID::from_u128(0x000214f3_0000_0000_c000_000000000046);
pub const IID_IFileViewerW: windows_sys::core::GUID = windows_sys::core::GUID::from_u128(0x000214f8_0000_0000_c000_000000000046);
pub const IID_IPropSheetPage: windows_sys::core::GUID = windows_sys::core::GUID::from_u128(0x000214f6_0000_0000_c000_000000000046);
pub const IID_IShellImageStore: windows_sys::core::GUID = windows_sys::core::GUID::from_u128(0x48c8118c_b924_11d1_98d5_00c04fb687da);
pub const IID_ISynchronizedCallBack: windows_sys::core::GUID = windows_sys::core::GUID::from_u128(0x74c26041_70d1_11d1_b75a_00a0c90564fe);
...
pub const PIDASI_AVG_DATA_RATE: i32 = 4;
pub const PIDASI_CHANNEL_COUNT: i32 = 7;
pub const PIDASI_COMPRESSION: i32 = 10;
pub const PIDASI_FORMAT: i32 = 2;
pub const PIDASI_SAMPLE_RATE: i32 = 5;
pub const PIDASI_SAMPLE_SIZE: i32 = 6;
pub const PIDASI_STREAM_NAME: i32 = 9;
pub const PIDASI_STREAM_NUMBER: i32 = 8;
pub const PIDASI_TIMELENGTH: i32 = 3;
pub const PIDDRSI_DESCRIPTION: i32 = 3;
pub const PIDDRSI_PLAYCOUNT: i32 = 4;
pub const PIDDRSI_PLAYEXPIRES: i32 = 6;
pub const PIDDRSI_PLAYSTARTS: i32 = 5;
pub const PIDDRSI_PROTECTED: i32 = 2;
pub const PIDSI_ALBUM: i32 = 4;
pub const PIDSI_ARTIST: i32 = 2;
pub const PIDSI_COMMENT: i32 = 6;
pub const PIDSI_GENRE: i32 = 11;
pub const PIDSI_LYRICS: i32 = 12;
pub const PIDSI_SONGTITLE: i32 = 3;
pub const PIDSI_TRACK: i32 = 7;
pub const PIDSI_YEAR: i32 = 5;
pub const PIDVSI_COMPRESSION: i32 = 10;
pub const PIDVSI_DATA_RATE: i32 = 8;
pub const PIDVSI_FRAME_COUNT: i32 = 5;
pub const PIDVSI_FRAME_HEIGHT: i32 = 4;
pub const PIDVSI_FRAME_RATE: i32 = 6;
pub const PIDVSI_FRAME_WIDTH: i32 = 3;
pub const PIDVSI_SAMPLE_SIZE: i32 = 9;
pub const PIDVSI_STREAM_NAME: i32 = 2;
pub const PIDVSI_STREAM_NUMBER: i32 = 11;
pub const PIDVSI_TIMELENGTH: i32 = 7;
pub const PID_COMPUTERNAME: i32 = 5;
pub const PID_CONTROLPANEL_CATEGORY: i32 = 2;
pub const PID_DESCRIPTIONID: i32 = 2;
pub const PID_DISPLACED_DATE: i32 = 3;
pub const PID_DISPLACED_FROM: i32 = 2;
pub const PID_DISPLAY_PROPERTIES: i32 = 0;
pub const PID_FINDDATA: i32 = 0;
pub const PID_HTMLINFOTIPFILE: i32 = 5;
pub const PID_INTROTEXT: i32 = 1;
pub const PID_LINK_TARGET: i32 = 2;
pub const PID_LINK_TARGET_TYPE: i32 = 3;
pub const PID_MISC_ACCESSCOUNT: i32 = 3;
pub const PID_MISC_OWNER: i32 = 4;
pub const PID_MISC_PICS: i32 = 6;
pub const PID_MISC_STATUS: i32 = 2;
pub const PID_NETRESOURCE: i32 = 1;
pub const PID_NETWORKLOCATION: i32 = 4;
pub const PID_QUERY_RANK: i32 = 2;
pub const PID_SHARE_CSC_STATUS: i32 = 2;
pub const PID_SYNC_COPY_IN: i32 = 2;
pub const PID_VOLUME_CAPACITY: i32 = 3;
pub const PID_VOLUME_FILESYSTEM: i32 = 4;
pub const PID_VOLUME_FREE: i32 = 2;
pub const PID_WHICHFOLDER: i32 = 3;
