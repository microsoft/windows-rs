pub const ADR_ENCODES_CURRENT_POSITION: i32 = 1;
pub const ADR_ENCODES_ISRC: i32 = 3;
pub const ADR_ENCODES_MEDIA_CATALOG: i32 = 2;
pub const ADR_NO_MODE_INFORMATION: i32 = 0;
pub const AUDIO_DATA_TRACK: i32 = 4;
pub const AUDIO_STATUS_IN_PROGRESS: i32 = 17;
pub const AUDIO_STATUS_NOT_SUPPORTED: i32 = 0;
pub const AUDIO_STATUS_NO_STATUS: i32 = 21;
pub const AUDIO_STATUS_PAUSED: i32 = 18;
pub const AUDIO_STATUS_PLAY_COMPLETE: i32 = 19;
pub const AUDIO_STATUS_PLAY_ERROR: i32 = 20;
pub const AUDIO_WITH_PREEMPHASIS: i32 = 1;
pub const CDDA: TRACK_MODE_TYPE = 2;
pub const CDROM_CD_TEXT_PACK_ALBUM_NAME: i32 = 128;
pub const CDROM_CD_TEXT_PACK_ARRANGER: i32 = 132;
pub const CDROM_CD_TEXT_PACK_COMPOSER: i32 = 131;
pub const CDROM_CD_TEXT_PACK_DISC_ID: i32 = 134;
pub const CDROM_CD_TEXT_PACK_GENRE: i32 = 135;
pub const CDROM_CD_TEXT_PACK_MESSAGES: i32 = 133;
pub const CDROM_CD_TEXT_PACK_PERFORMER: i32 = 129;
pub const CDROM_CD_TEXT_PACK_SIZE_INFO: i32 = 143;
pub const CDROM_CD_TEXT_PACK_SONGWRITER: i32 = 130;
pub const CDROM_CD_TEXT_PACK_TOC_INFO: i32 = 136;
pub const CDROM_CD_TEXT_PACK_TOC_INFO2: i32 = 137;
pub const CDROM_CD_TEXT_PACK_UPC_EAN: i32 = 142;
pub const CDROM_DISK_AUDIO_TRACK: i32 = 1;
#[repr(C)]
#[derive(Clone, Copy, Default)]
pub struct CDROM_DISK_DATA {
    pub DiskData: u32,
}
pub const CDROM_DISK_DATA_TRACK: i32 = 2;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const CDROM_EXCLUSIVE_CALLER_LENGTH: i32 = 64;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const CDROM_IN_EXCLUSIVE_MODE: i32 = 1;
pub const CDROM_LOCK_IGNORE_VOLUME: i32 = 1;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const CDROM_NOT_IN_EXCLUSIVE_MODE: i32 = 0;
pub const CDROM_NO_MEDIA_NOTIFICATIONS: i32 = 2;
...
pub const CDROM_READ_TOC_EX_FORMAT_ATIP: i32 = 4;
pub const CDROM_READ_TOC_EX_FORMAT_CDTEXT: i32 = 5;
pub const CDROM_READ_TOC_EX_FORMAT_FULL_TOC: i32 = 2;
pub const CDROM_READ_TOC_EX_FORMAT_PMA: i32 = 3;
pub const CDROM_READ_TOC_EX_FORMAT_SESSION: i32 = 1;
pub const CDROM_READ_TOC_EX_FORMAT_TOC: i32 = 0;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const CD_RAW_READ_C2_SIZE: i32 = 296;
pub const CD_RAW_READ_SUBCODE_SIZE: i32 = 96;
pub const CD_RAW_SECTOR_WITH_C2_AND_SUBCODE_SIZE: i32 = 2744;
pub const CD_RAW_SECTOR_WITH_C2_SIZE: i32 = 2648;
pub const CD_RAW_SECTOR_WITH_SUBCODE_SIZE: i32 = 2448;
...
pub const DIGITAL_COPY_PERMITTED: i32 = 2;
...
pub const IOCTL_CDROM_BASE: i32 = 2;
pub const IOCTL_CDROM_CHECK_VERIFY: i32 = 149504;
pub const IOCTL_CDROM_CURRENT_POSITION: i32 = 1;
pub const IOCTL_CDROM_DISK_TYPE: i32 = 131136;
pub const IOCTL_CDROM_EJECT_MEDIA: i32 = 149512;
pub const IOCTL_CDROM_ENABLE_STREAMING: i32 = 147560;
pub const IOCTL_CDROM_EXCLUSIVE_ACCESS: i32 = 180316;
pub const IOCTL_CDROM_FIND_NEW_DEVICES: i32 = 149528;
pub const IOCTL_CDROM_GET_CONFIGURATION: i32 = 147544;
pub const IOCTL_CDROM_GET_DRIVE_GEOMETRY: i32 = 147532;
pub const IOCTL_CDROM_GET_DRIVE_GEOMETRY_EX: i32 = 147536;
pub const IOCTL_CDROM_GET_INQUIRY_DATA: i32 = 147556;
pub const IOCTL_CDROM_GET_LAST_SESSION: i32 = 147512;
pub const IOCTL_CDROM_GET_PERFORMANCE: i32 = 147568;
pub const IOCTL_CDROM_GET_VOLUME: i32 = 147476;
pub const IOCTL_CDROM_LOAD_MEDIA: i32 = 149516;
pub const IOCTL_CDROM_MEDIA_CATALOG: i32 = 2;
pub const IOCTL_CDROM_MEDIA_REMOVAL: i32 = 149508;
pub const IOCTL_CDROM_PAUSE_AUDIO: i32 = 147468;
pub const IOCTL_CDROM_PLAY_AUDIO_MSF: i32 = 147480;
pub const IOCTL_CDROM_RAW_READ: i32 = 147518;
pub const IOCTL_CDROM_READ_Q_CHANNEL: i32 = 147500;
pub const IOCTL_CDROM_READ_TOC: i32 = 147456;
pub const IOCTL_CDROM_READ_TOC_EX: i32 = 147540;
pub const IOCTL_CDROM_RELEASE: i32 = 149524;
pub const IOCTL_CDROM_RESERVE: i32 = 149520;
pub const IOCTL_CDROM_RESUME_AUDIO: i32 = 147472;
pub const IOCTL_CDROM_SEEK_AUDIO_MSF: i32 = 147460;
pub const IOCTL_CDROM_SEND_OPC_INFORMATION: i32 = 180332;
pub const IOCTL_CDROM_SET_SPEED: i32 = 147552;
pub const IOCTL_CDROM_SET_VOLUME: i32 = 147496;
pub const IOCTL_CDROM_SIMBAD: i32 = 147468;
pub const IOCTL_CDROM_STOP_AUDIO: i32 = 147464;
pub const IOCTL_CDROM_SUB_Q_CHANNEL: i32 = 0;
pub const IOCTL_CDROM_TRACK_ISRC: i32 = 3;
pub const IOCTL_CDROM_UNLOAD_DRIVER: i32 = 151560;
pub const MAXIMUM_CDROM_INQUIRY_SIZE: i32 = 260;
pub const MAXIMUM_CDROM_SIZE: i32 = 804;
pub const MAXIMUM_NUMBER_TRACKS: i32 = 100;
pub type MEDIA_BLANK_TYPE = i32;
pub const MINIMUM_CDROM_INQUIRY_SIZE: i32 = 36;
pub const MINIMUM_CDROM_READ_TOC_EX_SIZE: i32 = 2;
...
pub const OBSOLETE_IOCTL_CDROM_GET_CONTROL: i32 = 147508;
...
pub const TWO_FOUR_CHANNEL_AUDIO: i32 = 8;
#[repr(C)]
#[derive(Clone, Copy)]
