...
windows_link::link!("kernel32.dll" "system" fn CreateEnclave(hprocess : super::HANDLE, lpaddress : *const core::ffi::c_void, dwsize : usize, dwinitialcommitment : usize, flenclavetype : u32, lpenclaveinformation : super::LPCVOID, dwinfolength : u32, lpenclaveerror : super::LPDWORD) -> *mut core::ffi::c_void);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
windows_link::link!("kernel32.dll" "system" fn InitializeEnclave(hprocess : super::HANDLE, lpaddress : *const core::ffi::c_void, lpenclaveinformation : super::LPCVOID, dwinfolength : u32, lpenclaveerror : super::LPDWORD) -> windows_sys::core::BOOL);
...
windows_link::link!("kernel32.dll" "system" fn LoadEnclaveData(hprocess : super::HANDLE, lpaddress : *const core::ffi::c_void, lpbuffer : super::LPCVOID, nsize : usize, flprotect : u32, lppageinformation : super::LPCVOID, dwinfolength : u32, lpnumberofbyteswritten : super::PSIZE_T, lpenclaveerror : super::LPDWORD) -> windows_sys::core::BOOL);
