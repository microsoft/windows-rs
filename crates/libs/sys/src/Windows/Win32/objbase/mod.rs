...
windows_link::link!("ole32.dll" "system" fn CoDosDateTimeToFileTime(ndosdate : u16, ndostime : u16, lpfiletime : *mut super::minwindef::FILETIME) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_minwindef")]
windows_link::link!("ole32.dll" "system" fn CoFileTimeToDosDateTime(lpfiletime : *const super::minwindef::FILETIME, lpdosdate : *mut u16, lpdostime : *mut u16) -> windows_sys::core::BOOL);
windows_link::link!("ole32.dll" "system" fn CoFreeAllLibraries());
#[cfg(feature = "Win32_minwindef")]
windows_link::link!("ole32.dll" "system" fn CoFreeLibrary(hinst : super::minwindef::HINSTANCE));
#[cfg(all(feature = "Win32_objidlbase", feature = "Win32_wtypesbase"))]
windows_link::link!("ole32.dll" "system" fn CoGetInstanceFromFile(pserverinfo : *const super::objidlbase::COSERVERINFO, pclsid : *const windows_sys::core::GUID, punkouter : *mut core::ffi::c_void, dwclsctx : u32, grfmode : u32, pwszname : *const super::wtypesbase::OLECHAR, dwcount : u32, presults : *mut super::objidlbase::MULTI_QI) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "Win32_objidl", feature = "Win32_objidlbase", feature = "Win32_wtypesbase"))]
windows_link::link!("ole32.dll" "system" fn CoGetInstanceFromIStorage(pserverinfo : *const super::objidlbase::COSERVERINFO, pclsid : *const windows_sys::core::GUID, punkouter : *mut core::ffi::c_void, dwclsctx : u32, pstg : *mut core::ffi::c_void, dwcount : u32, presults : *mut super::objidlbase::MULTI_QI) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_objidl")]
windows_link::link!("ole32.dll" "system" fn CoGetObject(pszname : windows_sys::core::PCWSTR, pbindoptions : *const super::objidl::BIND_OPTS, riid : *const windows_sys::core::GUID, ppv : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_winnt")]
windows_link::link!("ole32.dll" "system" fn CoGetSystemSecurityPermissions(comsdtype : COMSD, ppsd : *mut super::winnt::PSECURITY_DESCRIPTOR) -> windows_sys::core::HRESULT);
windows_link::link!("ole32.dll" "system" fn CoInitialize(pvreserved : *const core::ffi::c_void) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "Win32_objidl", feature = "Win32_winnt", feature = "Win32_wtypes"))]
windows_link::link!("ole32.dll" "system" fn CoInstall(pbc : *mut core::ffi::c_void, dwflags : u32, pclassspec : *const super::wtypes::uCLSSPEC, pquery : *const super::wtypes::QUERYCONTEXT, pszcodebase : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
windows_link::link!("ole32.dll" "system" fn CoIsOle1Class(rclsid : *const windows_sys::core::GUID) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_minwindef")]
windows_link::link!("ole32.dll" "system" fn CoLoadLibrary(lpszlibname : windows_sys::core::PCWSTR, bautofree : windows_sys::core::BOOL) -> super::minwindef::HINSTANCE);
...
windows_link::link!("ole32.dll" "system" fn CreateStdProgressIndicator(hwndparent : super::windef::HWND, psztitle : windows_sys::core::PCWSTR, pibsccaller : *mut core::ffi::c_void, ppibsc : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
#[cfg(all(feature = "Win32_objidl", feature = "Win32_wtypesbase"))]
windows_link::link!("ole32.dll" "system" fn StgGetIFillLockBytesOnFile(pwcsname : *const super::wtypesbase::OLECHAR, ppflb : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_objidl")]
...
#[cfg(all(feature = "Win32_objidl", feature = "Win32_wtypesbase"))]
windows_link::link!("dflayout.dll" "system" fn StgOpenLayoutDocfile(pwcsdfname : *const super::wtypesbase::OLECHAR, grfmode : u32, reserved : u32, ppstgopen : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
