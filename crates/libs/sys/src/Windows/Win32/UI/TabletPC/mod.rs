...
pub type AddStroke = unsafe extern "system" fn(hrc: HRECOCONTEXT, ppacketdesc: *const PACKET_DESCRIPTION, cbpacket: u32, ppacket: *const u8, pxform: *const super::super::Graphics::Gdi::XFORM) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type AddWordsToWordList = unsafe extern "system" fn(hwl: HRECOWORDLIST, pwcwords: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type AdviseInkChange = unsafe extern "system" fn(hrc: HRECOCONTEXT, bnewstroke: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type CloneContext = unsafe extern "system" fn(hrc: HRECOCONTEXT, pclonehrc: *mut HRECOCONTEXT) -> windows_sys::core::HRESULT;
...
pub type CreateContext = unsafe extern "system" fn(hrec: HRECOGNIZER, phrc: *mut HRECOCONTEXT) -> windows_sys::core::HRESULT;
windows_link::link!("inkobjcore.dll" "system" fn CreateContext(hrec : HRECOGNIZER, phrc : *mut HRECOCONTEXT) -> windows_sys::core::HRESULT);
pub type CreateRecognizer = unsafe extern "system" fn(pclsid: *mut windows_sys::core::GUID, phrec: *mut HRECOGNIZER) -> windows_sys::core::HRESULT;
...
pub type DestroyAlternate = unsafe extern "system" fn(hrcalt: HRECOALT) -> windows_sys::core::HRESULT;
windows_link::link!("inkobjcore.dll" "system" fn DestroyAlternate(hrcalt : HRECOALT) -> windows_sys::core::HRESULT);
pub type DestroyContext = unsafe extern "system" fn(hrc: HRECOCONTEXT) -> windows_sys::core::HRESULT;
windows_link::link!("inkobjcore.dll" "system" fn DestroyContext(hrc : HRECOCONTEXT) -> windows_sys::core::HRESULT);
pub type DestroyRecognizer = unsafe extern "system" fn(hrec: HRECOGNIZER) -> windows_sys::core::HRESULT;
windows_link::link!("inkobjcore.dll" "system" fn DestroyRecognizer(hrec : HRECOGNIZER) -> windows_sys::core::HRESULT);
pub type DestroyWordList = unsafe extern "system" fn(hwl: HRECOWORDLIST) -> windows_sys::core::HRESULT;
windows_link::link!("inkobjcore.dll" "system" fn DestroyWordList(hwl : HRECOWORDLIST) -> windows_sys::core::HRESULT);
pub type EndInkInput = unsafe extern "system" fn(hrc: HRECOCONTEXT) -> windows_sys::core::HRESULT;
windows_link::link!("inkobjcore.dll" "system" fn EndInkInput(hrc : HRECOCONTEXT) -> windows_sys::core::HRESULT);
pub type GetAllRecognizers = unsafe extern "system" fn(recognizerclsids: *mut *mut windows_sys::core::GUID, count: *mut u32) -> windows_sys::core::HRESULT;
...
pub type GetBestResultString = unsafe extern "system" fn(hrc: HRECOCONTEXT, pcsize: *mut u32, pwcbestresult: windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type GetContextPreferenceFlags = unsafe extern "system" fn(hrc: HRECOCONTEXT, pdwcontextpreferenceflags: *mut u32) -> windows_sys::core::HRESULT;
...
pub type GetContextPropertyList = unsafe extern "system" fn(hrc: HRECOCONTEXT, pcproperties: *mut u32, ppropertyguids: *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type GetContextPropertyValue = unsafe extern "system" fn(hrc: HRECOCONTEXT, pguid: *mut windows_sys::core::GUID, pcbsize: *mut u32, pproperty: *mut u8) -> windows_sys::core::HRESULT;
...
pub type GetEnabledUnicodeRanges = unsafe extern "system" fn(hrc: HRECOCONTEXT, pcranges: *mut u32, pcr: *mut CHARACTER_RANGE) -> windows_sys::core::HRESULT;
...
pub type GetGuide = unsafe extern "system" fn(hrc: HRECOCONTEXT, pguide: *mut RECO_GUIDE, piindex: *mut u32) -> windows_sys::core::HRESULT;
...
pub type GetLatticePtr = unsafe extern "system" fn(hrc: HRECOCONTEXT, pplattice: *mut *mut RECO_LATTICE) -> windows_sys::core::HRESULT;
...
pub type GetLeftSeparator = unsafe extern "system" fn(hrc: HRECOCONTEXT, pcsize: *mut u32, pwcleftseparator: windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type GetPreferredPacketDescription = unsafe extern "system" fn(hrec: HRECOGNIZER, ppacketdescription: *mut PACKET_DESCRIPTION) -> windows_sys::core::HRESULT;
...
pub type GetRecoAttributes = unsafe extern "system" fn(hrec: HRECOGNIZER, precoattrs: *mut RECO_ATTRS) -> windows_sys::core::HRESULT;
...
pub type GetResultPropertyList = unsafe extern "system" fn(hrec: HRECOGNIZER, ppropertycount: *mut u32, ppropertyguid: *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type GetRightSeparator = unsafe extern "system" fn(hrc: HRECOCONTEXT, pcsize: *mut u32, pwcrightseparator: windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type GetUnicodeRanges = unsafe extern "system" fn(hrec: HRECOGNIZER, pcranges: *mut u32, pcr: *mut CHARACTER_RANGE) -> windows_sys::core::HRESULT;
...
pub type IsStringSupported = unsafe extern "system" fn(hrc: HRECOCONTEXT, wcstring: u32, pwcstring: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type LoadCachedAttributes = unsafe extern "system" fn(clsid: windows_sys::core::GUID, precoattributes: *mut RECO_ATTRS) -> windows_sys::core::HRESULT;
...
pub type MakeWordList = unsafe extern "system" fn(hrec: HRECOGNIZER, pbuffer: windows_sys::core::PCWSTR, phwl: *mut HRECOWORDLIST) -> windows_sys::core::HRESULT;
...
pub type Process = unsafe extern "system" fn(hrc: HRECOCONTEXT, pbpartialprocessing: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type ResetContext = unsafe extern "system" fn(hrc: HRECOCONTEXT) -> windows_sys::core::HRESULT;
windows_link::link!("inkobjcore.dll" "system" fn ResetContext(hrc : HRECOCONTEXT) -> windows_sys::core::HRESULT);
pub type SetCACMode = unsafe extern "system" fn(hrc: HRECOCONTEXT, imode: i32) -> windows_sys::core::HRESULT;
windows_link::link!("inkobjcore.dll" "system" fn SetCACMode(hrc : HRECOCONTEXT, imode : i32) -> windows_sys::core::HRESULT);
pub type SetContextPropertyValue = unsafe extern "system" fn(hrc: HRECOCONTEXT, pguid: *mut windows_sys::core::GUID, cbsize: u32, pproperty: *mut u8) -> windows_sys::core::HRESULT;
...
pub type SetEnabledUnicodeRanges = unsafe extern "system" fn(hrc: HRECOCONTEXT, cranges: u32, pcr: *mut CHARACTER_RANGE) -> windows_sys::core::HRESULT;
...
pub type SetFactoid = unsafe extern "system" fn(hrc: HRECOCONTEXT, cwcfactoid: u32, pwcfactoid: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type SetFlags = unsafe extern "system" fn(hrc: HRECOCONTEXT, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("inkobjcore.dll" "system" fn SetFlags(hrc : HRECOCONTEXT, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SetGuide = unsafe extern "system" fn(hrc: HRECOCONTEXT, pguide: *const RECO_GUIDE, iindex: u32) -> windows_sys::core::HRESULT;
...
pub type SetTextContext = unsafe extern "system" fn(hrc: HRECOCONTEXT, cwcbefore: u32, pwcbefore: windows_sys::core::PCWSTR, cwcafter: u32, pwcafter: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type SetWordList = unsafe extern "system" fn(hrc: HRECOCONTEXT, hwl: HRECOWORDLIST) -> windows_sys::core::HRESULT;
