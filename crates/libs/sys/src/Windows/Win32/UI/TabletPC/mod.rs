...
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn AddStroke ( hrc : HRECOCONTEXT , ppacketdesc : *const PACKET_DESCRIPTION , cbpacket : u32 , ppacket : *const u8 , pxform : *const super::super::Graphics::Gdi:: XFORM ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn AddWordsToWordList ( hwl : HRECOWORDLIST , pwcwords : :: windows_sys::core::PCWSTR ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn AdviseInkChange ( hrc : HRECOCONTEXT , bnewstroke : super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn CreateContext ( hrec : HRECOGNIZER , phrc : *mut HRECOCONTEXT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn CreateRecognizer ( pclsid : *mut :: windows_sys::core::GUID , phrec : *mut HRECOGNIZER ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn DestroyContext ( hrc : HRECOCONTEXT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn DestroyRecognizer ( hrec : HRECOGNIZER ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn DestroyWordList ( hwl : HRECOWORDLIST ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn EndInkInput ( hrc : HRECOCONTEXT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn GetAllRecognizers ( recognizerclsids : *mut *mut :: windows_sys::core::GUID , count : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn GetBestResultString ( hrc : HRECOCONTEXT , pcsize : *mut u32 , pwcbestresult : :: windows_sys::core::PWSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn GetLatticePtr ( hrc : HRECOCONTEXT , pplattice : *mut *mut RECO_LATTICE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn GetLeftSeparator ( hrc : HRECOCONTEXT , pcsize : *mut u32 , pwcleftseparator : :: windows_sys::core::PWSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn GetRecoAttributes ( hrec : HRECOGNIZER , precoattrs : *mut RECO_ATTRS ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn GetResultPropertyList ( hrec : HRECOGNIZER , ppropertycount : *mut u32 , ppropertyguid : *mut :: windows_sys::core::GUID ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn GetRightSeparator ( hrc : HRECOCONTEXT , pcsize : *mut u32 , pwcrightseparator : :: windows_sys::core::PWSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn GetUnicodeRanges ( hrec : HRECOGNIZER , pcranges : *mut u32 , pcr : *mut CHARACTER_RANGE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn IsStringSupported ( hrc : HRECOCONTEXT , wcstring : u32 , pwcstring : :: windows_sys::core::PCWSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn LoadCachedAttributes ( clsid : :: windows_sys::core::GUID , precoattributes : *mut RECO_ATTRS ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn MakeWordList ( hrec : HRECOGNIZER , pbuffer : :: windows_sys::core::PCWSTR , phwl : *mut HRECOWORDLIST ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn Process ( hrc : HRECOCONTEXT , pbpartialprocessing : *mut super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn SetEnabledUnicodeRanges ( hrc : HRECOCONTEXT , cranges : u32 , pcr : *mut CHARACTER_RANGE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn SetFactoid ( hrc : HRECOCONTEXT , cwcfactoid : u32 , pwcfactoid : :: windows_sys::core::PCWSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn SetFlags ( hrc : HRECOCONTEXT , dwflags : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn SetGuide ( hrc : HRECOCONTEXT , pguide : *const RECO_GUIDE , iindex : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn SetTextContext ( hrc : HRECOCONTEXT , cwcbefore : u32 , pwcbefore : :: windows_sys::core::PCWSTR , cwcafter : u32 , pwcafter : :: windows_sys::core::PCWSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "inkobjcore.dll" ,"system" fn SetWordList ( hrc : HRECOCONTEXT , hwl : HRECOWORDLIST ) -> :: windows_sys::core::HRESULT );
