...
pub const ANRUS_ON_SCREEN_KEYBOARD_ACTIVE: ACC_UTILITY_STATE_FLAGS = 1;
pub const ANRUS_PRIORITY_AUDIO_ACTIVE: ACC_UTILITY_STATE_FLAGS = 4;
pub const ANRUS_PRIORITY_AUDIO_ACTIVE_NODUCK: ACC_UTILITY_STATE_FLAGS = 8;
pub const ANRUS_PRIORITY_AUDIO_DYNAMIC_DUCK: u32 = 16;
pub const ANRUS_TOUCH_MODIFICATION_ACTIVE: ACC_UTILITY_STATE_FLAGS = 2;
...
pub const AnnotationType_AdvancedProofingIssue: UIA_ANNOTATIONTYPE = 60020;
pub const AnnotationType_Author: UIA_ANNOTATIONTYPE = 60019;
pub const AnnotationType_CircularReferenceError: UIA_ANNOTATIONTYPE = 60022;
pub const AnnotationType_Comment: UIA_ANNOTATIONTYPE = 60003;
pub const AnnotationType_ConflictingChange: UIA_ANNOTATIONTYPE = 60018;
pub const AnnotationType_DataValidationError: UIA_ANNOTATIONTYPE = 60021;
pub const AnnotationType_DeletionChange: UIA_ANNOTATIONTYPE = 60012;
pub const AnnotationType_EditingLockedChange: UIA_ANNOTATIONTYPE = 60016;
pub const AnnotationType_Endnote: UIA_ANNOTATIONTYPE = 60009;
pub const AnnotationType_ExternalChange: UIA_ANNOTATIONTYPE = 60017;
pub const AnnotationType_Footer: UIA_ANNOTATIONTYPE = 60007;
pub const AnnotationType_Footnote: UIA_ANNOTATIONTYPE = 60010;
pub const AnnotationType_FormatChange: UIA_ANNOTATIONTYPE = 60014;
pub const AnnotationType_FormulaError: UIA_ANNOTATIONTYPE = 60004;
pub const AnnotationType_GrammarError: UIA_ANNOTATIONTYPE = 60002;
pub const AnnotationType_Header: UIA_ANNOTATIONTYPE = 60006;
pub const AnnotationType_Highlighted: UIA_ANNOTATIONTYPE = 60008;
pub const AnnotationType_InsertionChange: UIA_ANNOTATIONTYPE = 60011;
pub const AnnotationType_Mathematics: UIA_ANNOTATIONTYPE = 60023;
pub const AnnotationType_MoveChange: UIA_ANNOTATIONTYPE = 60013;
pub const AnnotationType_Sensitive: UIA_ANNOTATIONTYPE = 60024;
pub const AnnotationType_SpellingError: UIA_ANNOTATIONTYPE = 60001;
pub const AnnotationType_TrackChanges: UIA_ANNOTATIONTYPE = 60005;
pub const AnnotationType_Unknown: UIA_ANNOTATIONTYPE = 60000;
pub const AnnotationType_UnsyncedChange: UIA_ANNOTATIONTYPE = 60015;
...
pub const HCF_AVAILABLE: HIGHCONTRASTW_FLAGS = 2;
pub const HCF_CONFIRMHOTKEY: HIGHCONTRASTW_FLAGS = 8;
pub const HCF_HIGHCONTRASTON: HIGHCONTRASTW_FLAGS = 1;
pub const HCF_HOTKEYACTIVE: HIGHCONTRASTW_FLAGS = 4;
pub const HCF_HOTKEYAVAILABLE: HIGHCONTRASTW_FLAGS = 64;
pub const HCF_HOTKEYSOUND: HIGHCONTRASTW_FLAGS = 16;
...
pub const HeadingLevel1: UIA_HEADINGLEVEL_ID = 80051;
pub const HeadingLevel2: UIA_HEADINGLEVEL_ID = 80052;
pub const HeadingLevel3: UIA_HEADINGLEVEL_ID = 80053;
pub const HeadingLevel4: UIA_HEADINGLEVEL_ID = 80054;
pub const HeadingLevel5: UIA_HEADINGLEVEL_ID = 80055;
pub const HeadingLevel6: UIA_HEADINGLEVEL_ID = 80056;
pub const HeadingLevel7: UIA_HEADINGLEVEL_ID = 80057;
pub const HeadingLevel8: UIA_HEADINGLEVEL_ID = 80058;
pub const HeadingLevel9: UIA_HEADINGLEVEL_ID = 80059;
pub const HeadingLevel_None: UIA_HEADINGLEVEL_ID = 80050;
...
pub const SERKF_AVAILABLE: SERIALKEYS_FLAGS = 2;
pub const SERKF_INDICATOR: SERIALKEYS_FLAGS = 4;
pub const SERKF_SERIALKEYSON: SERIALKEYS_FLAGS = 1;
...
pub const SKF_AUDIBLEFEEDBACK: STICKYKEYS_FLAGS = 64;
pub const SKF_AVAILABLE: STICKYKEYS_FLAGS = 2;
pub const SKF_CONFIRMHOTKEY: STICKYKEYS_FLAGS = 8;
pub const SKF_HOTKEYACTIVE: STICKYKEYS_FLAGS = 4;
pub const SKF_HOTKEYSOUND: STICKYKEYS_FLAGS = 16;
pub const SKF_INDICATOR: STICKYKEYS_FLAGS = 32;
pub const SKF_LALTLATCHED: STICKYKEYS_FLAGS = 268435456;
pub const SKF_LALTLOCKED: STICKYKEYS_FLAGS = 1048576;
pub const SKF_LCTLLATCHED: STICKYKEYS_FLAGS = 67108864;
pub const SKF_LCTLLOCKED: STICKYKEYS_FLAGS = 262144;
pub const SKF_LSHIFTLATCHED: STICKYKEYS_FLAGS = 16777216;
pub const SKF_LSHIFTLOCKED: STICKYKEYS_FLAGS = 65536;
pub const SKF_LWINLATCHED: STICKYKEYS_FLAGS = 1073741824;
pub const SKF_LWINLOCKED: STICKYKEYS_FLAGS = 4194304;
pub const SKF_RALTLATCHED: STICKYKEYS_FLAGS = 536870912;
pub const SKF_RALTLOCKED: STICKYKEYS_FLAGS = 2097152;
pub const SKF_RCTLLATCHED: STICKYKEYS_FLAGS = 134217728;
pub const SKF_RCTLLOCKED: STICKYKEYS_FLAGS = 524288;
pub const SKF_RSHIFTLATCHED: STICKYKEYS_FLAGS = 33554432;
pub const SKF_RSHIFTLOCKED: STICKYKEYS_FLAGS = 131072;
pub const SKF_RWINLATCHED: STICKYKEYS_FLAGS = 2147483648;
pub const SKF_RWINLOCKED: STICKYKEYS_FLAGS = 8388608;
pub const SKF_STICKYKEYSON: STICKYKEYS_FLAGS = 1;
...
pub const SSF_AVAILABLE: SOUNDSENTRY_FLAGS = 2;
pub const SSF_INDICATOR: SOUNDSENTRY_FLAGS = 4;
pub const SSF_SOUNDSENTRYON: SOUNDSENTRY_FLAGS = 1;
pub const SSGF_DISPLAY: SOUND_SENTRY_GRAPHICS_EFFECT = 3;
pub const SSGF_NONE: SOUND_SENTRY_GRAPHICS_EFFECT = 0;
pub const SSTF_BORDER: SOUNDSENTRY_TEXT_EFFECT = 2;
pub const SSTF_CHARS: SOUNDSENTRY_TEXT_EFFECT = 1;
pub const SSTF_DISPLAY: SOUNDSENTRY_TEXT_EFFECT = 3;
pub const SSTF_NONE: SOUNDSENTRY_TEXT_EFFECT = 0;
pub const SSWF_CUSTOM: SOUNDSENTRY_WINDOWS_EFFECT = 4;
pub const SSWF_DISPLAY: SOUNDSENTRY_WINDOWS_EFFECT = 3;
pub const SSWF_NONE: SOUNDSENTRY_WINDOWS_EFFECT = 0;
pub const SSWF_TITLE: SOUNDSENTRY_WINDOWS_EFFECT = 1;
pub const SSWF_WINDOW: SOUNDSENTRY_WINDOWS_EFFECT = 2;
...
pub const StyleId_BulletedList: UIA_STYLE_ID = 70015;
...
pub const StyleId_Custom: UIA_STYLE_ID = 70000;
...
pub const StyleId_Emphasis: UIA_STYLE_ID = 70013;
...
pub const StyleId_Heading1: UIA_STYLE_ID = 70001;
...
pub const StyleId_Heading2: UIA_STYLE_ID = 70002;
...
pub const StyleId_Heading3: UIA_STYLE_ID = 70003;
...
pub const StyleId_Heading4: UIA_STYLE_ID = 70004;
...
pub const StyleId_Heading5: UIA_STYLE_ID = 70005;
...
pub const StyleId_Heading6: UIA_STYLE_ID = 70006;
...
pub const StyleId_Heading7: UIA_STYLE_ID = 70007;
...
pub const StyleId_Heading8: UIA_STYLE_ID = 70008;
...
pub const StyleId_Heading9: UIA_STYLE_ID = 70009;
...
pub const StyleId_Normal: UIA_STYLE_ID = 70012;
...
pub const StyleId_NumberedList: UIA_STYLE_ID = 70016;
...
pub const StyleId_Quote: UIA_STYLE_ID = 70014;
...
pub const StyleId_Subtitle: UIA_STYLE_ID = 70011;
...
pub const StyleId_Title: UIA_STYLE_ID = 70010;
...
pub const UIA_AcceleratorKeyPropertyId: UIA_PROPERTY_ID = 30006;
pub const UIA_AccessKeyPropertyId: UIA_PROPERTY_ID = 30007;
pub const UIA_ActiveTextPositionChangedEventId: UIA_EVENT_ID = 20036;
pub const UIA_AfterParagraphSpacingAttributeId: UIA_TEXTATTRIBUTE_ID = 40042;
pub const UIA_AnimationStyleAttributeId: UIA_TEXTATTRIBUTE_ID = 40000;
pub const UIA_AnnotationAnnotationTypeIdPropertyId: UIA_PROPERTY_ID = 30113;
pub const UIA_AnnotationAnnotationTypeNamePropertyId: UIA_PROPERTY_ID = 30114;
pub const UIA_AnnotationAuthorPropertyId: UIA_PROPERTY_ID = 30115;
pub const UIA_AnnotationDateTimePropertyId: UIA_PROPERTY_ID = 30116;
pub const UIA_AnnotationObjectsAttributeId: UIA_TEXTATTRIBUTE_ID = 40032;
pub const UIA_AnnotationObjectsPropertyId: UIA_PROPERTY_ID = 30156;
pub const UIA_AnnotationPatternId: UIA_PATTERN_ID = 10023;
pub const UIA_AnnotationTargetPropertyId: UIA_PROPERTY_ID = 30117;
pub const UIA_AnnotationTypesAttributeId: UIA_TEXTATTRIBUTE_ID = 40031;
pub const UIA_AnnotationTypesPropertyId: UIA_PROPERTY_ID = 30155;
pub const UIA_AppBarControlTypeId: UIA_CONTROLTYPE_ID = 50040;
pub const UIA_AriaPropertiesPropertyId: UIA_PROPERTY_ID = 30102;
pub const UIA_AriaRolePropertyId: UIA_PROPERTY_ID = 30101;
pub const UIA_AsyncContentLoadedEventId: UIA_EVENT_ID = 20006;
...
pub const UIA_BackgroundColorAttributeId: UIA_TEXTATTRIBUTE_ID = 40001;
pub const UIA_BeforeParagraphSpacingAttributeId: UIA_TEXTATTRIBUTE_ID = 40041;
pub const UIA_BoundingRectanglePropertyId: UIA_PROPERTY_ID = 30001;
pub const UIA_BulletStyleAttributeId: UIA_TEXTATTRIBUTE_ID = 40002;
pub const UIA_ButtonControlTypeId: UIA_CONTROLTYPE_ID = 50000;
pub type UIA_CHANGE_ID = i32;
pub type UIA_CONTROLTYPE_ID = i32;
pub const UIA_CalendarControlTypeId: UIA_CONTROLTYPE_ID = 50001;
pub const UIA_CapStyleAttributeId: UIA_TEXTATTRIBUTE_ID = 40003;
pub const UIA_CaretBidiModeAttributeId: UIA_TEXTATTRIBUTE_ID = 40039;
pub const UIA_CaretPositionAttributeId: UIA_TEXTATTRIBUTE_ID = 40038;
pub const UIA_CenterPointPropertyId: UIA_PROPERTY_ID = 30165;
pub const UIA_ChangesEventId: UIA_EVENT_ID = 20034;
pub const UIA_CheckBoxControlTypeId: UIA_CONTROLTYPE_ID = 50002;
pub const UIA_ClassNamePropertyId: UIA_PROPERTY_ID = 30012;
pub const UIA_ClickablePointPropertyId: UIA_PROPERTY_ID = 30014;
pub const UIA_ComboBoxControlTypeId: UIA_CONTROLTYPE_ID = 50003;
pub const UIA_ControlTypePropertyId: UIA_PROPERTY_ID = 30003;
pub const UIA_ControllerForPropertyId: UIA_PROPERTY_ID = 30104;
pub const UIA_CultureAttributeId: UIA_TEXTATTRIBUTE_ID = 40004;
pub const UIA_CulturePropertyId: UIA_PROPERTY_ID = 30015;
pub const UIA_CustomControlTypeId: UIA_CONTROLTYPE_ID = 50025;
pub const UIA_CustomLandmarkTypeId: UIA_LANDMARKTYPE_ID = 80000;
pub const UIA_CustomNavigationPatternId: UIA_PATTERN_ID = 10033;
pub const UIA_DataGridControlTypeId: UIA_CONTROLTYPE_ID = 50028;
pub const UIA_DataItemControlTypeId: UIA_CONTROLTYPE_ID = 50029;
pub const UIA_DescribedByPropertyId: UIA_PROPERTY_ID = 30105;
pub const UIA_DockDockPositionPropertyId: UIA_PROPERTY_ID = 30069;
pub const UIA_DockPatternId: UIA_PATTERN_ID = 10011;
pub const UIA_DocumentControlTypeId: UIA_CONTROLTYPE_ID = 50030;
pub const UIA_DragDropEffectPropertyId: UIA_PROPERTY_ID = 30139;
pub const UIA_DragDropEffectsPropertyId: UIA_PROPERTY_ID = 30140;
pub const UIA_DragGrabbedItemsPropertyId: UIA_PROPERTY_ID = 30144;
pub const UIA_DragIsGrabbedPropertyId: UIA_PROPERTY_ID = 30138;
pub const UIA_DragPatternId: UIA_PATTERN_ID = 10030;
pub const UIA_Drag_DragCancelEventId: UIA_EVENT_ID = 20027;
pub const UIA_Drag_DragCompleteEventId: UIA_EVENT_ID = 20028;
pub const UIA_Drag_DragStartEventId: UIA_EVENT_ID = 20026;
pub const UIA_DropTargetDropTargetEffectPropertyId: UIA_PROPERTY_ID = 30142;
pub const UIA_DropTargetDropTargetEffectsPropertyId: UIA_PROPERTY_ID = 30143;
pub const UIA_DropTargetPatternId: UIA_PATTERN_ID = 10031;
pub const UIA_DropTarget_DragEnterEventId: UIA_EVENT_ID = 20029;
pub const UIA_DropTarget_DragLeaveEventId: UIA_EVENT_ID = 20030;
pub const UIA_DropTarget_DroppedEventId: UIA_EVENT_ID = 20031;
...
pub const UIA_FillColorPropertyId: UIA_PROPERTY_ID = 30160;
pub const UIA_FillTypePropertyId: UIA_PROPERTY_ID = 30162;
pub const UIA_FlowsFromPropertyId: UIA_PROPERTY_ID = 30148;
pub const UIA_FlowsToPropertyId: UIA_PROPERTY_ID = 30106;
pub const UIA_FontNameAttributeId: UIA_TEXTATTRIBUTE_ID = 40005;
pub const UIA_FontSizeAttributeId: UIA_TEXTATTRIBUTE_ID = 40006;
pub const UIA_FontWeightAttributeId: UIA_TEXTATTRIBUTE_ID = 40007;
pub const UIA_ForegroundColorAttributeId: UIA_TEXTATTRIBUTE_ID = 40008;
pub const UIA_FormLandmarkTypeId: UIA_LANDMARKTYPE_ID = 80001;
pub const UIA_FrameworkIdPropertyId: UIA_PROPERTY_ID = 30024;
pub const UIA_FullDescriptionPropertyId: UIA_PROPERTY_ID = 30159;
pub const UIA_GridColumnCountPropertyId: UIA_PROPERTY_ID = 30063;
pub const UIA_GridItemColumnPropertyId: UIA_PROPERTY_ID = 30065;
pub const UIA_GridItemColumnSpanPropertyId: UIA_PROPERTY_ID = 30067;
pub const UIA_GridItemContainingGridPropertyId: UIA_PROPERTY_ID = 30068;
pub const UIA_GridItemPatternId: UIA_PATTERN_ID = 10007;
pub const UIA_GridItemRowPropertyId: UIA_PROPERTY_ID = 30064;
pub const UIA_GridItemRowSpanPropertyId: UIA_PROPERTY_ID = 30066;
pub const UIA_GridPatternId: UIA_PATTERN_ID = 10006;
pub const UIA_GridRowCountPropertyId: UIA_PROPERTY_ID = 30062;
...
pub const UIA_HeaderControlTypeId: UIA_CONTROLTYPE_ID = 50034;
pub const UIA_HeaderItemControlTypeId: UIA_CONTROLTYPE_ID = 50035;
pub const UIA_HeadingLevelPropertyId: UIA_PROPERTY_ID = 30173;
pub const UIA_HelpTextPropertyId: UIA_PROPERTY_ID = 30013;
pub const UIA_HorizontalTextAlignmentAttributeId: UIA_TEXTATTRIBUTE_ID = 40009;
pub const UIA_HostedFragmentRootsInvalidatedEventId: UIA_EVENT_ID = 20025;
...
pub const UIA_IndentationFirstLineAttributeId: UIA_TEXTATTRIBUTE_ID = 40010;
pub const UIA_IndentationLeadingAttributeId: UIA_TEXTATTRIBUTE_ID = 40011;
pub const UIA_IndentationTrailingAttributeId: UIA_TEXTATTRIBUTE_ID = 40012;
pub const UIA_InputDiscardedEventId: UIA_EVENT_ID = 20022;
pub const UIA_InputReachedOtherElementEventId: UIA_EVENT_ID = 20021;
pub const UIA_InputReachedTargetEventId: UIA_EVENT_ID = 20020;
pub const UIA_InvokePatternId: UIA_PATTERN_ID = 10000;
pub const UIA_Invoke_InvokedEventId: UIA_EVENT_ID = 20009;
pub const UIA_IsActiveAttributeId: UIA_TEXTATTRIBUTE_ID = 40036;
pub const UIA_IsAnnotationPatternAvailablePropertyId: UIA_PROPERTY_ID = 30118;
...
pub const UIA_IsCustomNavigationPatternAvailablePropertyId: UIA_PROPERTY_ID = 30151;
pub const UIA_IsDataValidForFormPropertyId: UIA_PROPERTY_ID = 30103;
pub const UIA_IsDialogPropertyId: UIA_PROPERTY_ID = 30174;
pub const UIA_IsDockPatternAvailablePropertyId: UIA_PROPERTY_ID = 30027;
pub const UIA_IsDragPatternAvailablePropertyId: UIA_PROPERTY_ID = 30137;
pub const UIA_IsDropTargetPatternAvailablePropertyId: UIA_PROPERTY_ID = 30141;
pub const UIA_IsEnabledPropertyId: UIA_PROPERTY_ID = 30010;
pub const UIA_IsExpandCollapsePatternAvailablePropertyId: UIA_PROPERTY_ID = 30028;
pub const UIA_IsGridItemPatternAvailablePropertyId: UIA_PROPERTY_ID = 30029;
pub const UIA_IsGridPatternAvailablePropertyId: UIA_PROPERTY_ID = 30030;
pub const UIA_IsHiddenAttributeId: UIA_TEXTATTRIBUTE_ID = 40013;
pub const UIA_IsInvokePatternAvailablePropertyId: UIA_PROPERTY_ID = 30031;
pub const UIA_IsItalicAttributeId: UIA_TEXTATTRIBUTE_ID = 40014;
pub const UIA_IsItemContainerPatternAvailablePropertyId: UIA_PROPERTY_ID = 30108;
pub const UIA_IsKeyboardFocusablePropertyId: UIA_PROPERTY_ID = 30009;
pub const UIA_IsLegacyIAccessiblePatternAvailablePropertyId: UIA_PROPERTY_ID = 30090;
pub const UIA_IsMultipleViewPatternAvailablePropertyId: UIA_PROPERTY_ID = 30032;
pub const UIA_IsObjectModelPatternAvailablePropertyId: UIA_PROPERTY_ID = 30112;
pub const UIA_IsOffscreenPropertyId: UIA_PROPERTY_ID = 30022;
pub const UIA_IsPasswordPropertyId: UIA_PROPERTY_ID = 30019;
pub const UIA_IsPeripheralPropertyId: UIA_PROPERTY_ID = 30150;
pub const UIA_IsRangeValuePatternAvailablePropertyId: UIA_PROPERTY_ID = 30033;
pub const UIA_IsReadOnlyAttributeId: UIA_TEXTATTRIBUTE_ID = 40015;
pub const UIA_IsRequiredForFormPropertyId: UIA_PROPERTY_ID = 30025;
pub const UIA_IsScrollItemPatternAvailablePropertyId: UIA_PROPERTY_ID = 30035;
pub const UIA_IsScrollPatternAvailablePropertyId: UIA_PROPERTY_ID = 30034;
pub const UIA_IsSelectionItemPatternAvailablePropertyId: UIA_PROPERTY_ID = 30036;
pub const UIA_IsSelectionPattern2AvailablePropertyId: UIA_PROPERTY_ID = 30168;
pub const UIA_IsSelectionPatternAvailablePropertyId: UIA_PROPERTY_ID = 30037;
pub const UIA_IsSpreadsheetItemPatternAvailablePropertyId: UIA_PROPERTY_ID = 30132;
pub const UIA_IsSpreadsheetPatternAvailablePropertyId: UIA_PROPERTY_ID = 30128;
pub const UIA_IsStylesPatternAvailablePropertyId: UIA_PROPERTY_ID = 30127;
pub const UIA_IsSubscriptAttributeId: UIA_TEXTATTRIBUTE_ID = 40016;
pub const UIA_IsSuperscriptAttributeId: UIA_TEXTATTRIBUTE_ID = 40017;
pub const UIA_IsSynchronizedInputPatternAvailablePropertyId: UIA_PROPERTY_ID = 30110;
pub const UIA_IsTableItemPatternAvailablePropertyId: UIA_PROPERTY_ID = 30039;
pub const UIA_IsTablePatternAvailablePropertyId: UIA_PROPERTY_ID = 30038;
pub const UIA_IsTextChildPatternAvailablePropertyId: UIA_PROPERTY_ID = 30136;
pub const UIA_IsTextEditPatternAvailablePropertyId: UIA_PROPERTY_ID = 30149;
pub const UIA_IsTextPattern2AvailablePropertyId: UIA_PROPERTY_ID = 30119;
pub const UIA_IsTextPatternAvailablePropertyId: UIA_PROPERTY_ID = 30040;
pub const UIA_IsTogglePatternAvailablePropertyId: UIA_PROPERTY_ID = 30041;
pub const UIA_IsTransformPattern2AvailablePropertyId: UIA_PROPERTY_ID = 30134;
pub const UIA_IsTransformPatternAvailablePropertyId: UIA_PROPERTY_ID = 30042;
pub const UIA_IsValuePatternAvailablePropertyId: UIA_PROPERTY_ID = 30043;
pub const UIA_IsVirtualizedItemPatternAvailablePropertyId: UIA_PROPERTY_ID = 30109;
pub const UIA_IsWindowPatternAvailablePropertyId: UIA_PROPERTY_ID = 30044;
pub const UIA_ItemContainerPatternId: UIA_PATTERN_ID = 10019;
pub const UIA_ItemStatusPropertyId: UIA_PROPERTY_ID = 30026;
pub const UIA_ItemTypePropertyId: UIA_PROPERTY_ID = 30021;
pub type UIA_LANDMARKTYPE_ID = i32;
pub const UIA_LabeledByPropertyId: UIA_PROPERTY_ID = 30018;
pub const UIA_LandmarkTypePropertyId: UIA_PROPERTY_ID = 30157;
pub const UIA_LayoutInvalidatedEventId: UIA_EVENT_ID = 20008;
pub const UIA_LegacyIAccessibleChildIdPropertyId: UIA_PROPERTY_ID = 30091;
pub const UIA_LegacyIAccessibleDefaultActionPropertyId: UIA_PROPERTY_ID = 30100;
pub const UIA_LegacyIAccessibleDescriptionPropertyId: UIA_PROPERTY_ID = 30094;
pub const UIA_LegacyIAccessibleHelpPropertyId: UIA_PROPERTY_ID = 30097;
pub const UIA_LegacyIAccessibleKeyboardShortcutPropertyId: UIA_PROPERTY_ID = 30098;
pub const UIA_LegacyIAccessibleNamePropertyId: UIA_PROPERTY_ID = 30092;
pub const UIA_LegacyIAccessiblePatternId: UIA_PATTERN_ID = 10018;
pub const UIA_LegacyIAccessibleRolePropertyId: UIA_PROPERTY_ID = 30095;
pub const UIA_LegacyIAccessibleSelectionPropertyId: UIA_PROPERTY_ID = 30099;
pub const UIA_LegacyIAccessibleStatePropertyId: UIA_PROPERTY_ID = 30096;
pub const UIA_LegacyIAccessibleValuePropertyId: UIA_PROPERTY_ID = 30093;
pub const UIA_LevelPropertyId: UIA_PROPERTY_ID = 30154;
pub const UIA_LineSpacingAttributeId: UIA_TEXTATTRIBUTE_ID = 40040;
pub const UIA_LinkAttributeId: UIA_TEXTATTRIBUTE_ID = 40035;
...
pub const UIA_LiveSettingPropertyId: UIA_PROPERTY_ID = 30135;
pub const UIA_LocalizedControlTypePropertyId: UIA_PROPERTY_ID = 30004;
pub const UIA_LocalizedLandmarkTypePropertyId: UIA_PROPERTY_ID = 30158;
pub type UIA_METADATA_ID = i32;
pub const UIA_MainLandmarkTypeId: UIA_LANDMARKTYPE_ID = 80002;
pub const UIA_MarginBottomAttributeId: UIA_TEXTATTRIBUTE_ID = 40018;
pub const UIA_MarginLeadingAttributeId: UIA_TEXTATTRIBUTE_ID = 40019;
pub const UIA_MarginTopAttributeId: UIA_TEXTATTRIBUTE_ID = 40020;
pub const UIA_MarginTrailingAttributeId: UIA_TEXTATTRIBUTE_ID = 40021;
pub const UIA_MenuBarControlTypeId: UIA_CONTROLTYPE_ID = 50010;
pub const UIA_MenuClosedEventId: UIA_EVENT_ID = 20007;
pub const UIA_MenuControlTypeId: UIA_CONTROLTYPE_ID = 50009;
pub const UIA_MenuItemControlTypeId: UIA_CONTROLTYPE_ID = 50011;
pub const UIA_MenuModeEndEventId: UIA_EVENT_ID = 20019;
pub const UIA_MenuModeStartEventId: UIA_EVENT_ID = 20018;
pub const UIA_MenuOpenedEventId: UIA_EVENT_ID = 20003;
pub const UIA_MultipleViewCurrentViewPropertyId: UIA_PROPERTY_ID = 30071;
pub const UIA_MultipleViewPatternId: UIA_PATTERN_ID = 10008;
pub const UIA_MultipleViewSupportedViewsPropertyId: UIA_PROPERTY_ID = 30072;
pub const UIA_NamePropertyId: UIA_PROPERTY_ID = 30005;
pub const UIA_NativeWindowHandlePropertyId: UIA_PROPERTY_ID = 30020;
pub const UIA_NavigationLandmarkTypeId: UIA_LANDMARKTYPE_ID = 80003;
pub const UIA_NotificationEventId: UIA_EVENT_ID = 20035;
pub const UIA_ObjectModelPatternId: UIA_PATTERN_ID = 10022;
pub const UIA_OptimizeForVisualContentPropertyId: UIA_PROPERTY_ID = 30111;
pub const UIA_OrientationPropertyId: UIA_PROPERTY_ID = 30023;
pub const UIA_OutlineColorPropertyId: UIA_PROPERTY_ID = 30161;
pub const UIA_OutlineStylesAttributeId: UIA_TEXTATTRIBUTE_ID = 40022;
pub const UIA_OutlineThicknessPropertyId: UIA_PROPERTY_ID = 30164;
pub const UIA_OverlineColorAttributeId: UIA_TEXTATTRIBUTE_ID = 40023;
pub const UIA_OverlineStyleAttributeId: UIA_TEXTATTRIBUTE_ID = 40024;
...
pub const UIA_PositionInSetPropertyId: UIA_PROPERTY_ID = 30152;
pub const UIA_ProcessIdPropertyId: UIA_PROPERTY_ID = 30002;
pub const UIA_ProgressBarControlTypeId: UIA_CONTROLTYPE_ID = 50012;
pub const UIA_ProviderDescriptionPropertyId: UIA_PROPERTY_ID = 30107;
pub const UIA_RadioButtonControlTypeId: UIA_CONTROLTYPE_ID = 50013;
pub const UIA_RangeValueIsReadOnlyPropertyId: UIA_PROPERTY_ID = 30048;
pub const UIA_RangeValueLargeChangePropertyId: UIA_PROPERTY_ID = 30051;
pub const UIA_RangeValueMaximumPropertyId: UIA_PROPERTY_ID = 30050;
pub const UIA_RangeValueMinimumPropertyId: UIA_PROPERTY_ID = 30049;
pub const UIA_RangeValuePatternId: UIA_PATTERN_ID = 10003;
pub const UIA_RangeValueSmallChangePropertyId: UIA_PROPERTY_ID = 30052;
pub const UIA_RangeValueValuePropertyId: UIA_PROPERTY_ID = 30047;
pub const UIA_RotationPropertyId: UIA_PROPERTY_ID = 30166;
pub const UIA_RuntimeIdPropertyId: UIA_PROPERTY_ID = 30000;
pub type UIA_STYLE_ID = i32;
pub const UIA_SayAsInterpretAsAttributeId: UIA_TEXTATTRIBUTE_ID = 40043;
pub const UIA_SayAsInterpretAsMetadataId: UIA_METADATA_ID = 100000;
pub const UIA_ScrollBarControlTypeId: UIA_CONTROLTYPE_ID = 50014;
pub const UIA_ScrollHorizontalScrollPercentPropertyId: UIA_PROPERTY_ID = 30053;
pub const UIA_ScrollHorizontalViewSizePropertyId: UIA_PROPERTY_ID = 30054;
pub const UIA_ScrollHorizontallyScrollablePropertyId: UIA_PROPERTY_ID = 30057;
...
pub const UIA_ScrollVerticalScrollPercentPropertyId: UIA_PROPERTY_ID = 30055;
pub const UIA_ScrollVerticalViewSizePropertyId: UIA_PROPERTY_ID = 30056;
pub const UIA_ScrollVerticallyScrollablePropertyId: UIA_PROPERTY_ID = 30058;
pub const UIA_SearchLandmarkTypeId: UIA_LANDMARKTYPE_ID = 80004;
pub const UIA_Selection2CurrentSelectedItemPropertyId: UIA_PROPERTY_ID = 30171;
pub const UIA_Selection2FirstSelectedItemPropertyId: UIA_PROPERTY_ID = 30169;
pub const UIA_Selection2ItemCountPropertyId: UIA_PROPERTY_ID = 30172;
pub const UIA_Selection2LastSelectedItemPropertyId: UIA_PROPERTY_ID = 30170;
pub const UIA_SelectionActiveEndAttributeId: UIA_TEXTATTRIBUTE_ID = 40037;
pub const UIA_SelectionCanSelectMultiplePropertyId: UIA_PROPERTY_ID = 30060;
pub const UIA_SelectionIsSelectionRequiredPropertyId: UIA_PROPERTY_ID = 30061;
pub const UIA_SelectionItemIsSelectedPropertyId: UIA_PROPERTY_ID = 30079;
pub const UIA_SelectionItemPatternId: UIA_PATTERN_ID = 10010;
pub const UIA_SelectionItemSelectionContainerPropertyId: UIA_PROPERTY_ID = 30080;
pub const UIA_SelectionItem_ElementAddedToSelectionEventId: UIA_EVENT_ID = 20010;
pub const UIA_SelectionItem_ElementRemovedFromSelectionEventId: UIA_EVENT_ID = 20011;
pub const UIA_SelectionItem_ElementSelectedEventId: UIA_EVENT_ID = 20012;
pub const UIA_SelectionPattern2Id: UIA_PATTERN_ID = 10034;
pub const UIA_SelectionPatternId: UIA_PATTERN_ID = 10001;
pub const UIA_SelectionSelectionPropertyId: UIA_PROPERTY_ID = 30059;
pub const UIA_Selection_InvalidatedEventId: UIA_EVENT_ID = 20013;
pub const UIA_SemanticZoomControlTypeId: UIA_CONTROLTYPE_ID = 50039;
pub const UIA_SeparatorControlTypeId: UIA_CONTROLTYPE_ID = 50038;
pub const UIA_SizeOfSetPropertyId: UIA_PROPERTY_ID = 30153;
pub const UIA_SizePropertyId: UIA_PROPERTY_ID = 30167;
pub const UIA_SliderControlTypeId: UIA_CONTROLTYPE_ID = 50015;
pub const UIA_SpinnerControlTypeId: UIA_CONTROLTYPE_ID = 50016;
pub const UIA_SplitButtonControlTypeId: UIA_CONTROLTYPE_ID = 50031;
pub const UIA_SpreadsheetItemAnnotationObjectsPropertyId: UIA_PROPERTY_ID = 30130;
pub const UIA_SpreadsheetItemAnnotationTypesPropertyId: UIA_PROPERTY_ID = 30131;
pub const UIA_SpreadsheetItemFormulaPropertyId: UIA_PROPERTY_ID = 30129;
pub const UIA_SpreadsheetItemPatternId: UIA_PATTERN_ID = 10027;
pub const UIA_SpreadsheetPatternId: UIA_PATTERN_ID = 10026;
pub const UIA_StatusBarControlTypeId: UIA_CONTROLTYPE_ID = 50017;
pub const UIA_StrikethroughColorAttributeId: UIA_TEXTATTRIBUTE_ID = 40025;
pub const UIA_StrikethroughStyleAttributeId: UIA_TEXTATTRIBUTE_ID = 40026;
pub const UIA_StructureChangedEventId: UIA_EVENT_ID = 20002;
pub const UIA_StyleIdAttributeId: UIA_TEXTATTRIBUTE_ID = 40034;
pub const UIA_StyleNameAttributeId: UIA_TEXTATTRIBUTE_ID = 40033;
pub const UIA_StylesExtendedPropertiesPropertyId: UIA_PROPERTY_ID = 30126;
pub const UIA_StylesFillColorPropertyId: UIA_PROPERTY_ID = 30122;
pub const UIA_StylesFillPatternColorPropertyId: UIA_PROPERTY_ID = 30125;
pub const UIA_StylesFillPatternStylePropertyId: UIA_PROPERTY_ID = 30123;
pub const UIA_StylesPatternId: UIA_PATTERN_ID = 10025;
pub const UIA_StylesShapePropertyId: UIA_PROPERTY_ID = 30124;
pub const UIA_StylesStyleIdPropertyId: UIA_PROPERTY_ID = 30120;
pub const UIA_StylesStyleNamePropertyId: UIA_PROPERTY_ID = 30121;
pub const UIA_SummaryChangeId: UIA_CHANGE_ID = 90000;
pub const UIA_SynchronizedInputPatternId: UIA_PATTERN_ID = 10021;
pub const UIA_SystemAlertEventId: UIA_EVENT_ID = 20023;
...
pub const UIA_TableColumnHeadersPropertyId: UIA_PROPERTY_ID = 30082;
pub const UIA_TableControlTypeId: UIA_CONTROLTYPE_ID = 50036;
pub const UIA_TableItemColumnHeaderItemsPropertyId: UIA_PROPERTY_ID = 30085;
pub const UIA_TableItemPatternId: UIA_PATTERN_ID = 10013;
pub const UIA_TableItemRowHeaderItemsPropertyId: UIA_PROPERTY_ID = 30084;
pub const UIA_TablePatternId: UIA_PATTERN_ID = 10012;
pub const UIA_TableRowHeadersPropertyId: UIA_PROPERTY_ID = 30081;
pub const UIA_TableRowOrColumnMajorPropertyId: UIA_PROPERTY_ID = 30083;
pub const UIA_TabsAttributeId: UIA_TEXTATTRIBUTE_ID = 40027;
pub const UIA_TextChildPatternId: UIA_PATTERN_ID = 10029;
pub const UIA_TextControlTypeId: UIA_CONTROLTYPE_ID = 50020;
pub const UIA_TextEditPatternId: UIA_PATTERN_ID = 10032;
pub const UIA_TextEdit_ConversionTargetChangedEventId: UIA_EVENT_ID = 20033;
pub const UIA_TextEdit_TextChangedEventId: UIA_EVENT_ID = 20032;
pub const UIA_TextFlowDirectionsAttributeId: UIA_TEXTATTRIBUTE_ID = 40028;
pub const UIA_TextPattern2Id: UIA_PATTERN_ID = 10024;
pub const UIA_TextPatternId: UIA_PATTERN_ID = 10014;
pub const UIA_Text_TextChangedEventId: UIA_EVENT_ID = 20015;
pub const UIA_Text_TextSelectionChangedEventId: UIA_EVENT_ID = 20014;
pub const UIA_ThumbControlTypeId: UIA_CONTROLTYPE_ID = 50027;
...
pub const UIA_ToolBarControlTypeId: UIA_CONTROLTYPE_ID = 50021;
pub const UIA_ToolTipClosedEventId: UIA_EVENT_ID = 20001;
pub const UIA_ToolTipControlTypeId: UIA_CONTROLTYPE_ID = 50022;
pub const UIA_ToolTipOpenedEventId: UIA_EVENT_ID = 20000;
pub const UIA_Transform2CanZoomPropertyId: UIA_PROPERTY_ID = 30133;
pub const UIA_Transform2ZoomLevelPropertyId: UIA_PROPERTY_ID = 30145;
pub const UIA_Transform2ZoomMaximumPropertyId: UIA_PROPERTY_ID = 30147;
pub const UIA_Transform2ZoomMinimumPropertyId: UIA_PROPERTY_ID = 30146;
pub const UIA_TransformCanMovePropertyId: UIA_PROPERTY_ID = 30087;
pub const UIA_TransformCanResizePropertyId: UIA_PROPERTY_ID = 30088;
pub const UIA_TransformCanRotatePropertyId: UIA_PROPERTY_ID = 30089;
pub const UIA_TransformPattern2Id: UIA_PATTERN_ID = 10028;
pub const UIA_TransformPatternId: UIA_PATTERN_ID = 10016;
pub const UIA_TreeControlTypeId: UIA_CONTROLTYPE_ID = 50023;
pub const UIA_TreeItemControlTypeId: UIA_CONTROLTYPE_ID = 50024;
pub const UIA_UnderlineColorAttributeId: UIA_TEXTATTRIBUTE_ID = 40029;
pub const UIA_UnderlineStyleAttributeId: UIA_TEXTATTRIBUTE_ID = 40030;
pub const UIA_ValueIsReadOnlyPropertyId: UIA_PROPERTY_ID = 30046;
pub const UIA_ValuePatternId: UIA_PATTERN_ID = 10002;
pub const UIA_ValueValuePropertyId: UIA_PROPERTY_ID = 30045;
pub const UIA_VirtualizedItemPatternId: UIA_PATTERN_ID = 10020;
pub const UIA_VisualEffectsPropertyId: UIA_PROPERTY_ID = 30163;
pub const UIA_WindowCanMaximizePropertyId: UIA_PROPERTY_ID = 30073;
pub const UIA_WindowCanMinimizePropertyId: UIA_PROPERTY_ID = 30074;
pub const UIA_WindowControlTypeId: UIA_CONTROLTYPE_ID = 50032;
pub const UIA_WindowIsModalPropertyId: UIA_PROPERTY_ID = 30077;
pub const UIA_WindowIsTopmostPropertyId: UIA_PROPERTY_ID = 30078;
pub const UIA_WindowPatternId: UIA_PATTERN_ID = 10009;
pub const UIA_WindowWindowInteractionStatePropertyId: UIA_PROPERTY_ID = 30076;
pub const UIA_WindowWindowVisualStatePropertyId: UIA_PROPERTY_ID = 30075;
