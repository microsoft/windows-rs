...
::windows_sys::core::windows_link ! ( "oleacc.dll" ,"system" fn AccNotifyTouchInteraction ( hwndapp : super::super::Foundation:: HWND , hwndtarget : super::super::Foundation:: HWND , pttarget : super::super::Foundation:: POINT ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "oleacc.dll" ,"system" fn AccSetRunningUtilityState ( hwndapp : super::super::Foundation:: HWND , dwutilitystatemask : u32 , dwutilitystate : ACC_UTILITY_STATE_FLAGS ) -> :: windows_sys::core::HRESULT );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
::windows_sys::core::windows_link ! ( "oleacc.dll" ,"system" fn AccessibleChildren ( pacccontainer : IAccessible , ichildstart : i32 , cchildren : i32 , rgvarchildren : *mut super::super::System::Com:: VARIANT , pcobtained : *mut i32 ) -> :: windows_sys::core::HRESULT );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
::windows_sys::core::windows_link ! ( "oleacc.dll" ,"system" fn AccessibleObjectFromEvent ( hwnd : super::super::Foundation:: HWND , dwid : u32 , dwchildid : u32 , ppacc : *mut IAccessible , pvarchild : *mut super::super::System::Com:: VARIANT ) -> :: windows_sys::core::HRESULT );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
::windows_sys::core::windows_link ! ( "oleacc.dll" ,"system" fn AccessibleObjectFromPoint ( ptscreen : super::super::Foundation:: POINT , ppacc : *mut IAccessible , pvarchild : *mut super::super::System::Com:: VARIANT ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "oleacc.dll" ,"system" fn AccessibleObjectFromWindow ( hwnd : super::super::Foundation:: HWND , dwid : u32 , riid : *const :: windows_sys::core::GUID , ppvobject : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "oleacc.dll" ,"system" fn CreateStdAccessibleObject ( hwnd : super::super::Foundation:: HWND , idobject : i32 , riid : *const :: windows_sys::core::GUID , ppvobject : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "oleacc.dll" ,"system" fn CreateStdAccessibleProxyA ( hwnd : super::super::Foundation:: HWND , pclassname : :: windows_sys::core::PCSTR , idobject : i32 , riid : *const :: windows_sys::core::GUID , ppvobject : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "oleacc.dll" ,"system" fn CreateStdAccessibleProxyW ( hwnd : super::super::Foundation:: HWND , pclassname : :: windows_sys::core::PCWSTR , idobject : i32 , riid : *const :: windows_sys::core::GUID , ppvobject : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn DockPattern_SetDockPosition ( hobj : HUIAPATTERNOBJECT , dockposition : DockPosition ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn ExpandCollapsePattern_Collapse ( hobj : HUIAPATTERNOBJECT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn ExpandCollapsePattern_Expand ( hobj : HUIAPATTERNOBJECT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "oleacc.dll" ,"system" fn GetOleaccVersionInfo ( pver : *mut u32 , pbuild : *mut u32 ) -> ( ) );
::windows_sys::core::windows_link ! ( "oleacc.dll" ,"system" fn GetRoleTextA ( lrole : u32 , lpszrole : :: windows_sys::core::PSTR , cchrolemax : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "oleacc.dll" ,"system" fn GetRoleTextW ( lrole : u32 , lpszrole : :: windows_sys::core::PWSTR , cchrolemax : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "oleacc.dll" ,"system" fn GetStateTextA ( lstatebit : u32 , lpszstate : :: windows_sys::core::PSTR , cchstate : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "oleacc.dll" ,"system" fn GetStateTextW ( lstatebit : u32 , lpszstate : :: windows_sys::core::PWSTR , cchstate : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn GridPattern_GetItem ( hobj : HUIAPATTERNOBJECT , row : i32 , column : i32 , presult : *mut HUIANODE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn InvokePattern_Invoke ( hobj : HUIAPATTERNOBJECT ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "user32.dll" ,"system" fn IsWinEventHookInstalled ( event : u32 ) -> super::super::Foundation:: BOOL );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn ItemContainerPattern_FindItemByProperty ( hobj : HUIAPATTERNOBJECT , hnodestartafter : HUIANODE , propertyid : i32 , value : super::super::System::Com:: VARIANT , pfound : *mut HUIANODE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn LegacyIAccessiblePattern_DoDefaultAction ( hobj : HUIAPATTERNOBJECT ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn LegacyIAccessiblePattern_GetIAccessible ( hobj : HUIAPATTERNOBJECT , paccessible : *mut IAccessible ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn LegacyIAccessiblePattern_Select ( hobj : HUIAPATTERNOBJECT , flagsselect : i32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn LegacyIAccessiblePattern_SetValue ( hobj : HUIAPATTERNOBJECT , szvalue : :: windows_sys::core::PCWSTR ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "oleacc.dll" ,"system" fn LresultFromObject ( riid : *const :: windows_sys::core::GUID , wparam : super::super::Foundation:: WPARAM , punk : :: windows_sys::core::IUnknown ) -> super::super::Foundation:: LRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn MultipleViewPattern_GetViewName ( hobj : HUIAPATTERNOBJECT , viewid : i32 , ppstr : *mut :: windows_sys::core::BSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn MultipleViewPattern_SetCurrentView ( hobj : HUIAPATTERNOBJECT , viewid : i32 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "user32.dll" ,"system" fn NotifyWinEvent ( event : u32 , hwnd : super::super::Foundation:: HWND , idobject : i32 , idchild : i32 ) -> ( ) );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "oleacc.dll" ,"system" fn ObjectFromLresult ( lresult : super::super::Foundation:: LRESULT , riid : *const :: windows_sys::core::GUID , wparam : super::super::Foundation:: WPARAM , ppvobject : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn RangeValuePattern_SetValue ( hobj : HUIAPATTERNOBJECT , val : f64 ) -> :: windows_sys::core::HRESULT );
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_UI_WindowsAndMessaging"))]
::windows_sys::core::windows_link ! ( "user32.dll" ,"system" fn RegisterPointerInputTargetEx ( hwnd : super::super::Foundation:: HWND , pointertype : super::WindowsAndMessaging:: POINTER_INPUT_TYPE , fobserve : super::super::Foundation:: BOOL ) -> super::super::Foundation:: BOOL );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn ScrollItemPattern_ScrollIntoView ( hobj : HUIAPATTERNOBJECT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn ScrollPattern_Scroll ( hobj : HUIAPATTERNOBJECT , horizontalamount : ScrollAmount , verticalamount : ScrollAmount ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn ScrollPattern_SetScrollPercent ( hobj : HUIAPATTERNOBJECT , horizontalpercent : f64 , verticalpercent : f64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn SelectionItemPattern_AddToSelection ( hobj : HUIAPATTERNOBJECT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn SelectionItemPattern_RemoveFromSelection ( hobj : HUIAPATTERNOBJECT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn SelectionItemPattern_Select ( hobj : HUIAPATTERNOBJECT ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "user32.dll" ,"system" fn SetWinEventHook ( eventmin : u32 , eventmax : u32 , hmodwineventproc : super::super::Foundation:: HINSTANCE , pfnwineventproc : WINEVENTPROC , idprocess : u32 , idthread : u32 , dwflags : u32 ) -> HWINEVENTHOOK );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn SynchronizedInputPattern_Cancel ( hobj : HUIAPATTERNOBJECT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn SynchronizedInputPattern_StartListening ( hobj : HUIAPATTERNOBJECT , inputtype : SynchronizedInputType ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextPattern_GetSelection ( hobj : HUIAPATTERNOBJECT , pretval : *mut *mut super::super::System::Com:: SAFEARRAY ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextPattern_GetVisibleRanges ( hobj : HUIAPATTERNOBJECT , pretval : *mut *mut super::super::System::Com:: SAFEARRAY ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextPattern_RangeFromChild ( hobj : HUIAPATTERNOBJECT , hnodechild : HUIANODE , pretval : *mut HUIATEXTRANGE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextPattern_RangeFromPoint ( hobj : HUIAPATTERNOBJECT , point : UiaPoint , pretval : *mut HUIATEXTRANGE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextPattern_get_DocumentRange ( hobj : HUIAPATTERNOBJECT , pretval : *mut HUIATEXTRANGE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextPattern_get_SupportedTextSelection ( hobj : HUIAPATTERNOBJECT , pretval : *mut SupportedTextSelection ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_AddToSelection ( hobj : HUIATEXTRANGE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_Clone ( hobj : HUIATEXTRANGE , pretval : *mut HUIATEXTRANGE ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_Compare ( hobj : HUIATEXTRANGE , range : HUIATEXTRANGE , pretval : *mut super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_CompareEndpoints ( hobj : HUIATEXTRANGE , endpoint : TextPatternRangeEndpoint , targetrange : HUIATEXTRANGE , targetendpoint : TextPatternRangeEndpoint , pretval : *mut i32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_ExpandToEnclosingUnit ( hobj : HUIATEXTRANGE , unit : TextUnit ) -> :: windows_sys::core::HRESULT );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_FindAttribute ( hobj : HUIATEXTRANGE , attributeid : i32 , val : super::super::System::Com:: VARIANT , backward : super::super::Foundation:: BOOL , pretval : *mut HUIATEXTRANGE ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_FindText ( hobj : HUIATEXTRANGE , text : :: windows_sys::core::BSTR , backward : super::super::Foundation:: BOOL , ignorecase : super::super::Foundation:: BOOL , pretval : *mut HUIATEXTRANGE ) -> :: windows_sys::core::HRESULT );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_GetAttributeValue ( hobj : HUIATEXTRANGE , attributeid : i32 , pretval : *mut super::super::System::Com:: VARIANT ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_GetBoundingRectangles ( hobj : HUIATEXTRANGE , pretval : *mut *mut super::super::System::Com:: SAFEARRAY ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_GetChildren ( hobj : HUIATEXTRANGE , pretval : *mut *mut super::super::System::Com:: SAFEARRAY ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_GetEnclosingElement ( hobj : HUIATEXTRANGE , pretval : *mut HUIANODE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_GetText ( hobj : HUIATEXTRANGE , maxlength : i32 , pretval : *mut :: windows_sys::core::BSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_Move ( hobj : HUIATEXTRANGE , unit : TextUnit , count : i32 , pretval : *mut i32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_MoveEndpointByRange ( hobj : HUIATEXTRANGE , endpoint : TextPatternRangeEndpoint , targetrange : HUIATEXTRANGE , targetendpoint : TextPatternRangeEndpoint ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_MoveEndpointByUnit ( hobj : HUIATEXTRANGE , endpoint : TextPatternRangeEndpoint , unit : TextUnit , count : i32 , pretval : *mut i32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_RemoveFromSelection ( hobj : HUIATEXTRANGE ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_ScrollIntoView ( hobj : HUIATEXTRANGE , aligntotop : super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TextRange_Select ( hobj : HUIATEXTRANGE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TogglePattern_Toggle ( hobj : HUIAPATTERNOBJECT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TransformPattern_Move ( hobj : HUIAPATTERNOBJECT , x : f64 , y : f64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TransformPattern_Resize ( hobj : HUIAPATTERNOBJECT , width : f64 , height : f64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn TransformPattern_Rotate ( hobj : HUIAPATTERNOBJECT , degrees : f64 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaAddEvent ( hnode : HUIANODE , eventid : i32 , pcallback : *mut UiaEventCallback , scope : TreeScope , pproperties : *mut i32 , cproperties : i32 , prequest : *mut UiaCacheRequest , phevent : *mut HUIAEVENT ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaClientsAreListening ( ) -> super::super::Foundation:: BOOL );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaDisconnectAllProviders ( ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaDisconnectProvider ( pprovider : IRawElementProviderSimple ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaEventAddWindow ( hevent : HUIAEVENT , hwnd : super::super::Foundation:: HWND ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaEventRemoveWindow ( hevent : HUIAEVENT , hwnd : super::super::Foundation:: HWND ) -> :: windows_sys::core::HRESULT );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com"))]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaFind ( hnode : HUIANODE , pparams : *mut UiaFindParams , prequest : *mut UiaCacheRequest , pprequesteddata : *mut *mut super::super::System::Com:: SAFEARRAY , ppoffsets : *mut *mut super::super::System::Com:: SAFEARRAY , pptreestructures : *mut *mut super::super::System::Com:: SAFEARRAY ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaGetErrorDescription ( pdescription : *mut :: windows_sys::core::BSTR ) -> super::super::Foundation:: BOOL );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaGetPatternProvider ( hnode : HUIANODE , patternid : i32 , phobj : *mut HUIAPATTERNOBJECT ) -> :: windows_sys::core::HRESULT );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaGetPropertyValue ( hnode : HUIANODE , propertyid : i32 , pvalue : *mut super::super::System::Com:: VARIANT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaGetReservedMixedAttributeValue ( punkmixedattributevalue : *mut :: windows_sys::core::IUnknown ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaGetReservedNotSupportedValue ( punknotsupportedvalue : *mut :: windows_sys::core::IUnknown ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaGetRootNode ( phnode : *mut HUIANODE ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaGetRuntimeId ( hnode : HUIANODE , pruntimeid : *mut *mut super::super::System::Com:: SAFEARRAY ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Com")]
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaHPatternObjectFromVariant ( pvar : *mut super::super::System::Com:: VARIANT , phobj : *mut HUIAPATTERNOBJECT ) -> :: windows_sys::core::HRESULT );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaHTextRangeFromVariant ( pvar : *mut super::super::System::Com:: VARIANT , phtextrange : *mut HUIATEXTRANGE ) -> :: windows_sys::core::HRESULT );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaHUiaNodeFromVariant ( pvar : *mut super::super::System::Com:: VARIANT , phnode : *mut HUIANODE ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaHasServerSideProvider ( hwnd : super::super::Foundation:: HWND ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaHostProviderFromHwnd ( hwnd : super::super::Foundation:: HWND , ppprovider : *mut IRawElementProviderSimple ) -> :: windows_sys::core::HRESULT );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaIAccessibleFromProvider ( pprovider : IRawElementProviderSimple , dwflags : u32 , ppaccessible : *mut IAccessible , pvarchild : *mut super::super::System::Com:: VARIANT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaLookupId ( r#type : AutomationIdentifierType , pguid : *const :: windows_sys::core::GUID ) -> i32 );
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaNavigate ( hnode : HUIANODE , direction : NavigateDirection , pcondition : *mut UiaCondition , prequest : *mut UiaCacheRequest , pprequesteddata : *mut *mut super::super::System::Com:: SAFEARRAY , pptreestructure : *mut :: windows_sys::core::BSTR ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaNodeFromFocus ( prequest : *mut UiaCacheRequest , pprequesteddata : *mut *mut super::super::System::Com:: SAFEARRAY , pptreestructure : *mut :: windows_sys::core::BSTR ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaNodeFromHandle ( hwnd : super::super::Foundation:: HWND , phnode : *mut HUIANODE ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaNodeFromPoint ( x : f64 , y : f64 , prequest : *mut UiaCacheRequest , pprequesteddata : *mut *mut super::super::System::Com:: SAFEARRAY , pptreestructure : *mut :: windows_sys::core::BSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaNodeFromProvider ( pprovider : IRawElementProviderSimple , phnode : *mut HUIANODE ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaNodeRelease ( hnode : HUIANODE ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaPatternRelease ( hobj : HUIAPATTERNOBJECT ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaProviderForNonClient ( hwnd : super::super::Foundation:: HWND , idobject : i32 , idchild : i32 , ppprovider : *mut IRawElementProviderSimple ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaProviderFromIAccessible ( paccessible : IAccessible , idchild : i32 , dwflags : u32 , ppprovider : *mut IRawElementProviderSimple ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaRaiseActiveTextPositionChangedEvent ( provider : IRawElementProviderSimple , textrange : ITextRangeProvider ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaRaiseAsyncContentLoadedEvent ( pprovider : IRawElementProviderSimple , asynccontentloadedstate : AsyncContentLoadedState , percentcomplete : f64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaRaiseAutomationEvent ( pprovider : IRawElementProviderSimple , id : UIA_EVENT_ID ) -> :: windows_sys::core::HRESULT );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaRaiseAutomationPropertyChangedEvent ( pprovider : IRawElementProviderSimple , id : UIA_PROPERTY_ID , oldvalue : super::super::System::Com:: VARIANT , newvalue : super::super::System::Com:: VARIANT ) -> :: windows_sys::core::HRESULT );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaRaiseChangesEvent ( pprovider : IRawElementProviderSimple , eventidcount : i32 , puiachanges : *mut UiaChangeInfo ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaRaiseNotificationEvent ( provider : IRawElementProviderSimple , notificationkind : NotificationKind , notificationprocessing : NotificationProcessing , displaystring : :: windows_sys::core::BSTR , activityid : :: windows_sys::core::BSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaRaiseStructureChangedEvent ( pprovider : IRawElementProviderSimple , structurechangetype : StructureChangeType , pruntimeid : *mut i32 , cruntimeidlen : i32 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaRaiseTextEditTextChangedEvent ( pprovider : IRawElementProviderSimple , texteditchangetype : TextEditChangeType , pchangeddata : *mut super::super::System::Com:: SAFEARRAY ) -> :: windows_sys::core::HRESULT );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com"))]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaRegisterProviderCallback ( pcallback : *mut UiaProviderCallback ) -> ( ) );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaRemoveEvent ( hevent : HUIAEVENT ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaReturnRawElementProvider ( hwnd : super::super::Foundation:: HWND , wparam : super::super::Foundation:: WPARAM , lparam : super::super::Foundation:: LPARAM , el : IRawElementProviderSimple ) -> super::super::Foundation:: LRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaSetFocus ( hnode : HUIANODE ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn UiaTextRangeRelease ( hobj : HUIATEXTRANGE ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "user32.dll" ,"system" fn UnhookWinEvent ( hwineventhook : HWINEVENTHOOK ) -> super::super::Foundation:: BOOL );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_UI_WindowsAndMessaging"))]
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_UI_WindowsAndMessaging"))]
::windows_sys::core::windows_link ! ( "user32.dll" ,"system" fn UnregisterPointerInputTargetEx ( hwnd : super::super::Foundation:: HWND , pointertype : super::WindowsAndMessaging:: POINTER_INPUT_TYPE ) -> super::super::Foundation:: BOOL );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn ValuePattern_SetValue ( hobj : HUIAPATTERNOBJECT , pval : :: windows_sys::core::PCWSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn VirtualizedItemPattern_Realize ( hobj : HUIAPATTERNOBJECT ) -> :: windows_sys::core::HRESULT );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com"))]
::windows_sys::core::windows_link ! ( "oleacc.dll" ,"system" fn WindowFromAccessibleObject ( param0 : IAccessible , phwnd : *mut super::super::Foundation:: HWND ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn WindowPattern_Close ( hobj : HUIAPATTERNOBJECT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn WindowPattern_SetWindowVisualState ( hobj : HUIAPATTERNOBJECT , state : WindowVisualState ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "uiautomationcore.dll" ,"system" fn WindowPattern_WaitForInputIdle ( hobj : HUIAPATTERNOBJECT , milliseconds : i32 , presult : *mut super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
