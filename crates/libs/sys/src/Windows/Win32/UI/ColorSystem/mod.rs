...
windows_link::link!("icm32.dll" "system" fn CMCheckColorsInGamut(hcmtransform : isize, lpargbtriple : *mut super::super::Graphics::Gdi:: RGBTRIPLE, lparesult : *mut u8, ncount : u32) -> windows_sys::core::BOOL);
windows_link::link!("icm32.dll" "system" fn CMCheckRGBs(hcmtransform : isize, lpsrcbits : *mut core::ffi::c_void, bminput : BMFORMAT, dwwidth : u32, dwheight : u32, dwstride : u32, lparesult : *mut u8, pfncallback : LPBMCALLBACKFN, ulcallbackdata : super::super::Foundation:: LPARAM) -> windows_sys::core::BOOL);
windows_link::link!("icm32.dll" "system" fn CMConvertColorNameToIndex(hprofile : isize, pacolorname : *mut *mut i8, paindex : *mut u32, dwcount : u32) -> windows_sys::core::BOOL);
windows_link::link!("icm32.dll" "system" fn CMConvertIndexToColorName(hprofile : isize, paindex : *mut u32, pacolorname : *mut *mut i8, dwcount : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("icm32.dll" "system" fn CMCreateMultiProfileTransform(pahprofiles : *mut isize, nprofiles : u32, padwintents : *mut u32, nintents : u32, dwflags : u32) -> isize);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("icm32.dll" "system" fn CMCreateTransformExt(lpcolorspace : *mut LOGCOLORSPACEA, lpdevcharacter : *mut core::ffi::c_void, lptargetdevcharacter : *mut core::ffi::c_void, dwflags : u32) -> isize);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("icm32.dll" "system" fn CMCreateTransformExtW(lpcolorspace : *mut LOGCOLORSPACEW, lpdevcharacter : *mut core::ffi::c_void, lptargetdevcharacter : *mut core::ffi::c_void, dwflags : u32) -> isize);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("icm32.dll" "system" fn CMCreateTransformW(lpcolorspace : *mut LOGCOLORSPACEW, lpdevcharacter : *mut core::ffi::c_void, lptargetdevcharacter : *mut core::ffi::c_void) -> isize);
...
windows_link::link!("icm32.dll" "system" fn CMTranslateColors(hcmtransform : isize, lpainputcolors : *mut COLOR, ncolors : u32, ctinput : COLORTYPE, lpaoutputcolors : *mut COLOR, ctoutput : COLORTYPE) -> windows_sys::core::BOOL);
...
windows_link::link!("mscms.dll" "system" fn CheckColors(hcolortransform : isize, painputcolors : *mut COLOR, ncolors : u32, ctinput : COLORTYPE, paresult : *mut u8) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdi32.dll" "system" fn CheckColorsInGamut(hdc : super::super::Graphics::Gdi:: HDC, lprgbtriple : *mut super::super::Graphics::Gdi:: RGBTRIPLE, dlpbuffer : *mut core::ffi::c_void, ncount : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("mscms.dll" "system" fn ConvertColorNameToIndex(hprofile : isize, pacolorname : *mut *mut i8, paindex : *mut u32, dwcount : u32) -> windows_sys::core::BOOL);
...
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdi32.dll" "system" fn CreateColorSpaceW(lplcs : *mut LOGCOLORSPACEW) -> HCOLORSPACE);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("mscms.dll" "system" fn CreateColorTransformA(plogcolorspace : *mut LOGCOLORSPACEA, hdestprofile : isize, htargetprofile : isize, dwflags : u32) -> isize);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("mscms.dll" "system" fn CreateColorTransformW(plogcolorspace : *mut LOGCOLORSPACEW, hdestprofile : isize, htargetprofile : isize, dwflags : u32) -> isize);
...
windows_link::link!("mscms.dll" "system" fn CreateMultiProfileTransform(pahprofiles : *mut isize, nprofiles : u32, padwintent : *mut u32, nintents : u32, dwflags : u32, indexpreferredcmm : u32) -> isize);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("mscms.dll" "system" fn CreateProfileFromLogColorSpaceA(plogcolorspace : *mut LOGCOLORSPACEA, pprofile : *mut *mut u8) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("mscms.dll" "system" fn CreateProfileFromLogColorSpaceW(plogcolorspace : *mut LOGCOLORSPACEW, pprofile : *mut *mut u8) -> windows_sys::core::BOOL);
...
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdi32.dll" "system" fn GetICMProfileA(hdc : super::super::Graphics::Gdi:: HDC, pbufsize : *mut u32, pszfilename : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
windows_link::link!("mscms.dll" "system" fn GetStandardColorSpaceProfileA(pmachinename : windows_sys::core::PCSTR, dwscs : u32, pbuffer : windows_sys::core::PCSTR, pcbsize : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("mscms.dll" "system" fn OpenColorProfileA(pprofile : *mut PROFILE, dwdesiredaccess : u32, dwsharemode : u32, dwcreationmode : u32) -> isize);
...
windows_link::link!("mscms.dll" "system" fn SetColorProfileElement(hprofile : isize, tag : u32, dwoffset : u32, pcbelement : *mut u32, pelement : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("mscms.dll" "system" fn SetColorProfileHeader(hprofile : isize, pheader : *mut PROFILEHEADER) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdi32.dll" "system" fn SetColorSpace(hdc : super::super::Graphics::Gdi:: HDC, hcs : HCOLORSPACE) -> HCOLORSPACE);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdi32.dll" "system" fn SetDeviceGammaRamp(hdc : super::super::Graphics::Gdi:: HDC, lpramp : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
windows_link::link!("mscms.dll" "system" fn TranslateColors(hcolortransform : isize, painputcolors : *mut COLOR, ncolors : u32, ctinput : COLORTYPE, paoutputcolors : *mut COLOR, ctoutput : COLORTYPE) -> windows_sys::core::BOOL);
...
windows_link::link!("mscms.dll" "system" fn WcsCheckColors(hcolortransform : isize, ncolors : u32, ninputchannels : u32, cdtinput : COLORDATATYPE, cbinput : u32, pinputdata : *mut core::ffi::c_void, paresult : *mut u8) -> windows_sys::core::BOOL);
...
windows_link::link!("mscms.dll" "system" fn WcsEnumColorProfiles(scope : WCS_PROFILE_MANAGEMENT_SCOPE, penumrecord : *mut ENUMTYPEW, pbuffer : *mut u8, dwsize : u32, pnprofiles : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("mscms.dll" "system" fn WcsEnumColorProfilesSize(scope : WCS_PROFILE_MANAGEMENT_SCOPE, penumrecord : *mut ENUMTYPEW, pdwsize : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("mscms.dll" "system" fn WcsGetDefaultColorProfile(scope : WCS_PROFILE_MANAGEMENT_SCOPE, pdevicename : windows_sys::core::PCWSTR, cptcolorprofiletype : COLORPROFILETYPE, cpstcolorprofilesubtype : COLORPROFILESUBTYPE, dwprofileid : u32, cbprofilename : u32, pprofilename : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
...
windows_link::link!("mscms.dll" "system" fn WcsOpenColorProfileW(pcdmpprofile : *mut PROFILE, pcampprofile : *mut PROFILE, pgmmpprofile : *mut PROFILE, dwdesireaccess : u32, dwsharemode : u32, dwcreationmode : u32, dwflags : u32) -> isize);
...
windows_link::link!("mscms.dll" "system" fn WcsTranslateColors(hcolortransform : isize, ncolors : u32, ninputchannels : u32, cdtinput : COLORDATATYPE, cbinput : u32, pinputdata : *mut core::ffi::c_void, noutputchannels : u32, cdtoutput : COLORDATATYPE, cboutput : u32, poutputdata : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
