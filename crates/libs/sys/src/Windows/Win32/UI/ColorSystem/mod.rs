pub type AssociateColorProfileWithDeviceA = unsafe extern "system" fn(pmachinename: windows_sys::core::PCSTR, pprofilename: windows_sys::core::PCSTR, pdevicename: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type AssociateColorProfileWithDeviceW = unsafe extern "system" fn(pmachinename: windows_sys::core::PCWSTR, pprofilename: windows_sys::core::PCWSTR, pdevicename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type CMCheckColors = unsafe extern "system" fn(hcmtransform: isize, lpainputcolors: *const COLOR, ncolors: u32, ctinput: COLORTYPE, lparesult: *mut u8) -> windows_sys::core::BOOL;
...
pub type CMCheckColorsInGamut = unsafe extern "system" fn(hcmtransform: isize, lpargbtriple: *const super::super::Graphics::Gdi::RGBTRIPLE, lparesult: *mut u8, ncount: u32) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type CMCheckRGBs = unsafe extern "system" fn(hcmtransform: isize, lpsrcbits: *const core::ffi::c_void, bminput: BMFORMAT, dwwidth: u32, dwheight: u32, dwstride: u32, lparesult: *mut u8, pfncallback: LPBMCALLBACKFN, ulcallbackdata: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
pub type CMConvertColorNameToIndex = unsafe extern "system" fn(hprofile: isize, pacolorname: *const *const i8, paindex: *mut u32, dwcount: u32) -> windows_sys::core::BOOL;
...
pub type CMConvertIndexToColorName = unsafe extern "system" fn(hprofile: isize, paindex: *const u32, pacolorname: *mut *mut i8, dwcount: u32) -> windows_sys::core::BOOL;
...
pub type CMCreateDeviceLinkProfile = unsafe extern "system" fn(pahprofiles: *const isize, nprofiles: u32, padwintents: *const u32, nintents: u32, dwflags: u32, lpprofiledata: *mut *mut u8) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type CMCreateProfile = unsafe extern "system" fn(lpcolorspace: *mut LOGCOLORSPACEA, lpprofiledata: *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type CMCreateProfileW = unsafe extern "system" fn(lpcolorspace: *mut LOGCOLORSPACEW, lpprofiledata: *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type CMDeleteTransform = unsafe extern "system" fn(hcmtransform: isize) -> windows_sys::core::BOOL;
...
pub type CMGetNamedProfileInfo = unsafe extern "system" fn(hprofile: isize, pnamedprofileinfo: *mut NAMED_PROFILE_INFO) -> windows_sys::core::BOOL;
...
pub type CMIsProfileValid = unsafe extern "system" fn(hprofile: isize, lpbvalid: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type CMTranslateColors = unsafe extern "system" fn(hcmtransform: isize, lpainputcolors: *const COLOR, ncolors: u32, ctinput: COLORTYPE, lpaoutputcolors: *mut COLOR, ctoutput: COLORTYPE) -> windows_sys::core::BOOL;
...
pub type CMTranslateRGB = unsafe extern "system" fn(hcmtransform: isize, colorref: super::super::Foundation::COLORREF, lpcolorref: *mut u32, dwflags: u32) -> windows_sys::core::BOOL;
...
pub type CMTranslateRGBs = unsafe extern "system" fn(hcmtransform: isize, lpsrcbits: *const core::ffi::c_void, bminput: BMFORMAT, dwwidth: u32, dwheight: u32, dwstride: u32, lpdestbits: *mut core::ffi::c_void, bmoutput: BMFORMAT, dwtranslatedirection: u32) -> windows_sys::core::BOOL;
...
pub type CheckBitmapBits = unsafe extern "system" fn(hcolortransform: isize, psrcbits: *const core::ffi::c_void, bminput: BMFORMAT, dwwidth: u32, dwheight: u32, dwstride: u32, paresult: *mut u8, pfncallback: LPBMCALLBACKFN, lpcallbackdata: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
pub type CheckColors = unsafe extern "system" fn(hcolortransform: isize, painputcolors: *const COLOR, ncolors: u32, ctinput: COLORTYPE, paresult: *mut u8) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type CheckColorsInGamut = unsafe extern "system" fn(hdc: super::super::Graphics::Gdi::HDC, lprgbtriple: *const super::super::Graphics::Gdi::RGBTRIPLE, dlpbuffer: *mut core::ffi::c_void, ncount: u32) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type CloseColorProfile = unsafe extern "system" fn(hprofile: isize) -> windows_sys::core::BOOL;
windows_link::link!("mscms.dll" "system" fn CloseColorProfile(hprofile : isize) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type ColorCorrectPalette = unsafe extern "system" fn(hdc: super::super::Graphics::Gdi::HDC, hpal: super::super::Graphics::Gdi::HPALETTE, defirst: u32, num: u32) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type ColorMatchToTarget = unsafe extern "system" fn(hdc: super::super::Graphics::Gdi::HDC, hdctarget: super::super::Graphics::Gdi::HDC, action: COLOR_MATCH_TO_TARGET_ACTION) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type ColorProfileGetDeviceCapabilities = unsafe extern "system" fn(scope: WCS_PROFILE_MANAGEMENT_SCOPE, targetadapterid: super::super::Foundation::LUID, sourceid: u32, capstype: WCS_DEVICE_CAPABILITIES_TYPE, outputcapabilities: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("mscms.dll" "system" fn ColorProfileGetDeviceCapabilities(scope : WCS_PROFILE_MANAGEMENT_SCOPE, targetadapterid : super::super::Foundation::LUID, sourceid : u32, capstype : WCS_DEVICE_CAPABILITIES_TYPE, outputcapabilities : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type ColorProfileGetDisplayDefault = unsafe extern "system" fn(scope: WCS_PROFILE_MANAGEMENT_SCOPE, targetadapterid: super::super::Foundation::LUID, sourceid: u32, profiletype: COLORPROFILETYPE, profilesubtype: COLORPROFILESUBTYPE, profilename: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type ColorProfileGetDisplayList = unsafe extern "system" fn(scope: WCS_PROFILE_MANAGEMENT_SCOPE, targetadapterid: super::super::Foundation::LUID, sourceid: u32, profilelist: *mut *mut windows_sys::core::PWSTR, profilecount: *mut u32) -> windows_sys::core::HRESULT;
...
pub type ColorProfileRemoveDisplayAssociation = unsafe extern "system" fn(scope: WCS_PROFILE_MANAGEMENT_SCOPE, profilename: windows_sys::core::PCWSTR, targetadapterid: super::super::Foundation::LUID, sourceid: u32, dissociateadvancedcolor: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type ColorProfileSetDisplayDefaultAssociation = unsafe extern "system" fn(scope: WCS_PROFILE_MANAGEMENT_SCOPE, profilename: windows_sys::core::PCWSTR, profiletype: COLORPROFILETYPE, profilesubtype: COLORPROFILESUBTYPE, targetadapterid: super::super::Foundation::LUID, sourceid: u32) -> windows_sys::core::HRESULT;
...
pub type ConvertColorNameToIndex = unsafe extern "system" fn(hprofile: isize, pacolorname: *const *const i8, paindex: *mut u32, dwcount: u32) -> windows_sys::core::BOOL;
...
pub type ConvertIndexToColorName = unsafe extern "system" fn(hprofile: isize, paindex: *const u32, pacolorname: *mut *mut i8, dwcount: u32) -> windows_sys::core::BOOL;
...
pub type CreateDeviceLinkProfile = unsafe extern "system" fn(hprofile: *const isize, nprofiles: u32, padwintent: *const u32, nintents: u32, dwflags: u32, pprofiledata: *mut *mut u8, indexpreferredcmm: u32) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type CreateProfileFromLogColorSpaceA = unsafe extern "system" fn(plogcolorspace: *const LOGCOLORSPACEA, pprofile: *mut *mut u8) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type CreateProfileFromLogColorSpaceW = unsafe extern "system" fn(plogcolorspace: *const LOGCOLORSPACEW, pprofile: *mut *mut u8) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type DeleteColorSpace = unsafe extern "system" fn(hcs: HCOLORSPACE) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn DeleteColorSpace(hcs : HCOLORSPACE) -> windows_sys::core::BOOL);
pub type DeleteColorTransform = unsafe extern "system" fn(hxform: isize) -> windows_sys::core::BOOL;
windows_link::link!("mscms.dll" "system" fn DeleteColorTransform(hxform : isize) -> windows_sys::core::BOOL);
pub type DisassociateColorProfileFromDeviceA = unsafe extern "system" fn(pmachinename: windows_sys::core::PCSTR, pprofilename: windows_sys::core::PCSTR, pdevicename: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type DisassociateColorProfileFromDeviceW = unsafe extern "system" fn(pmachinename: windows_sys::core::PCWSTR, pprofilename: windows_sys::core::PCWSTR, pdevicename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type EnumColorProfilesA = unsafe extern "system" fn(pmachinename: windows_sys::core::PCSTR, penumrecord: *const ENUMTYPEA, penumerationbuffer: *mut u8, pdwsizeofenumerationbuffer: *mut u32, pnprofiles: *mut u32) -> windows_sys::core::BOOL;
...
pub type EnumColorProfilesW = unsafe extern "system" fn(pmachinename: windows_sys::core::PCWSTR, penumrecord: *const ENUMTYPEW, penumerationbuffer: *mut u8, pdwsizeofenumerationbuffer: *mut u32, pnprofiles: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetColorDirectoryA = unsafe extern "system" fn(pmachinename: windows_sys::core::PCSTR, pbuffer: windows_sys::core::PSTR, pdwsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetColorDirectoryW = unsafe extern "system" fn(pmachinename: windows_sys::core::PCWSTR, pbuffer: windows_sys::core::PWSTR, pdwsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetColorProfileElement = unsafe extern "system" fn(hprofile: isize, tag: u32, dwoffset: u32, pcbelement: *mut u32, pelement: *mut core::ffi::c_void, pbreference: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type GetColorProfileElementTag = unsafe extern "system" fn(hprofile: isize, dwindex: u32, ptag: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetColorProfileFromHandle = unsafe extern "system" fn(hprofile: isize, pprofile: *mut u8, pcbprofile: *mut u32) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetColorProfileHeader = unsafe extern "system" fn(hprofile: isize, pheader: *mut PROFILEHEADER) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GetCountColorProfileElements = unsafe extern "system" fn(hprofile: isize, pnelementcount: *mut u32) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetDeviceGammaRamp = unsafe extern "system" fn(hdc: super::super::Graphics::Gdi::HDC, lpramp: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetICMProfileA = unsafe extern "system" fn(hdc: super::super::Graphics::Gdi::HDC, pbufsize: *mut u32, pszfilename: windows_sys::core::PSTR) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetICMProfileW = unsafe extern "system" fn(hdc: super::super::Graphics::Gdi::HDC, pbufsize: *mut u32, pszfilename: windows_sys::core::PWSTR) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetLogColorSpaceA = unsafe extern "system" fn(hcolorspace: HCOLORSPACE, lpbuffer: *mut LOGCOLORSPACEA, nsize: u32) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetLogColorSpaceW = unsafe extern "system" fn(hcolorspace: HCOLORSPACE, lpbuffer: *mut LOGCOLORSPACEW, nsize: u32) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GetNamedProfileInfo = unsafe extern "system" fn(hprofile: isize, pnamedprofileinfo: *mut NAMED_PROFILE_INFO) -> windows_sys::core::BOOL;
...
pub type GetPS2ColorRenderingDictionary = unsafe extern "system" fn(hprofile: isize, dwintent: u32, pps2colorrenderingdictionary: *mut u8, pcbps2colorrenderingdictionary: *mut u32, pbbinary: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type GetPS2ColorRenderingIntent = unsafe extern "system" fn(hprofile: isize, dwintent: u32, pbuffer: *mut u8, pcbps2colorrenderingintent: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetPS2ColorSpaceArray = unsafe extern "system" fn(hprofile: isize, dwintent: u32, dwcsatype: u32, pps2colorspacearray: *mut u8, pcbps2colorspacearray: *mut u32, pbbinary: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type GetStandardColorSpaceProfileA = unsafe extern "system" fn(pmachinename: windows_sys::core::PCSTR, dwscs: u32, pbuffer: windows_sys::core::PSTR, pcbsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetStandardColorSpaceProfileW = unsafe extern "system" fn(pmachinename: windows_sys::core::PCWSTR, dwscs: u32, pbuffer: windows_sys::core::PWSTR, pcbsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type InstallColorProfileA = unsafe extern "system" fn(pmachinename: windows_sys::core::PCSTR, pprofilename: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type InstallColorProfileW = unsafe extern "system" fn(pmachinename: windows_sys::core::PCWSTR, pprofilename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type IsColorProfileTagPresent = unsafe extern "system" fn(hprofile: isize, tag: u32, pbpresent: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type IsColorProfileValid = unsafe extern "system" fn(hprofile: isize, pbvalid: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type RegisterCMMA = unsafe extern "system" fn(pmachinename: windows_sys::core::PCSTR, cmmid: u32, pcmmdll: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type RegisterCMMW = unsafe extern "system" fn(pmachinename: windows_sys::core::PCWSTR, cmmid: u32, pcmmdll: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SelectCMM = unsafe extern "system" fn(dwcmmtype: u32) -> windows_sys::core::BOOL;
windows_link::link!("mscms.dll" "system" fn SelectCMM(dwcmmtype : u32) -> windows_sys::core::BOOL);
pub type SetColorProfileElement = unsafe extern "system" fn(hprofile: isize, tag: u32, dwoffset: u32, pcbelement: *const u32, pelement: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetColorProfileElementReference = unsafe extern "system" fn(hprofile: isize, newtag: u32, reftag: u32) -> windows_sys::core::BOOL;
...
pub type SetColorProfileElementSize = unsafe extern "system" fn(hprofile: isize, tagtype: u32, pcbelement: u32) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type SetColorProfileHeader = unsafe extern "system" fn(hprofile: isize, pheader: *const PROFILEHEADER) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type SetDeviceGammaRamp = unsafe extern "system" fn(hdc: super::super::Graphics::Gdi::HDC, lpramp: *const core::ffi::c_void) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type SetICMMode = unsafe extern "system" fn(hdc: super::super::Graphics::Gdi::HDC, mode: ICM_MODE) -> i32;
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdi32.dll" "system" fn SetICMMode(hdc : super::super::Graphics::Gdi::HDC, mode : ICM_MODE) -> i32);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type SetICMProfileA = unsafe extern "system" fn(hdc: super::super::Graphics::Gdi::HDC, lpfilename: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type SetICMProfileW = unsafe extern "system" fn(hdc: super::super::Graphics::Gdi::HDC, lpfilename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type SetStandardColorSpaceProfileA = unsafe extern "system" fn(pmachinename: windows_sys::core::PCSTR, dwprofileid: u32, pprofilename: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type SetStandardColorSpaceProfileW = unsafe extern "system" fn(pmachinename: windows_sys::core::PCWSTR, dwprofileid: u32, pprofilename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SetupColorMatchingA = unsafe extern "system" fn(pcms: *mut COLORMATCHSETUPA) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
windows_link::link!("icmui.dll" "system" fn SetupColorMatchingA(pcms : *mut COLORMATCHSETUPA) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type SetupColorMatchingW = unsafe extern "system" fn(pcms: *mut COLORMATCHSETUPW) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
windows_link::link!("icmui.dll" "system" fn SetupColorMatchingW(pcms : *mut COLORMATCHSETUPW) -> windows_sys::core::BOOL);
pub type TranslateBitmapBits = unsafe extern "system" fn(hcolortransform: isize, psrcbits: *const core::ffi::c_void, bminput: BMFORMAT, dwwidth: u32, dwheight: u32, dwinputstride: u32, pdestbits: *mut core::ffi::c_void, bmoutput: BMFORMAT, dwoutputstride: u32, pfncallback: LPBMCALLBACKFN, ulcallbackdata: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
pub type TranslateColors = unsafe extern "system" fn(hcolortransform: isize, painputcolors: *const COLOR, ncolors: u32, ctinput: COLORTYPE, paoutputcolors: *mut COLOR, ctoutput: COLORTYPE) -> windows_sys::core::BOOL;
...
pub type UninstallColorProfileA = unsafe extern "system" fn(pmachinename: windows_sys::core::PCSTR, pprofilename: windows_sys::core::PCSTR, bdelete: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type UninstallColorProfileW = unsafe extern "system" fn(pmachinename: windows_sys::core::PCWSTR, pprofilename: windows_sys::core::PCWSTR, bdelete: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type UnregisterCMMA = unsafe extern "system" fn(pmachinename: windows_sys::core::PCSTR, cmmid: u32) -> windows_sys::core::BOOL;
windows_link::link!("mscms.dll" "system" fn UnregisterCMMA(pmachinename : windows_sys::core::PCSTR, cmmid : u32) -> windows_sys::core::BOOL);
pub type UnregisterCMMW = unsafe extern "system" fn(pmachinename: windows_sys::core::PCWSTR, cmmid: u32) -> windows_sys::core::BOOL;
...
pub type UpdateICMRegKeyA = unsafe extern "system" fn(reserved: u32, lpszcmid: windows_sys::core::PCSTR, lpszfilename: windows_sys::core::PCSTR, command: ICM_COMMAND) -> windows_sys::core::BOOL;
...
pub type UpdateICMRegKeyW = unsafe extern "system" fn(reserved: u32, lpszcmid: windows_sys::core::PCWSTR, lpszfilename: windows_sys::core::PCWSTR, command: ICM_COMMAND) -> windows_sys::core::BOOL;
...
pub type WcsAssociateColorProfileWithDevice = unsafe extern "system" fn(scope: WCS_PROFILE_MANAGEMENT_SCOPE, pprofilename: windows_sys::core::PCWSTR, pdevicename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type WcsCheckColors = unsafe extern "system" fn(hcolortransform: isize, ncolors: u32, ninputchannels: u32, cdtinput: COLORDATATYPE, cbinput: u32, pinputdata: *const core::ffi::c_void, paresult: *mut u8) -> windows_sys::core::BOOL;
...
pub type WcsDisassociateColorProfileFromDevice = unsafe extern "system" fn(scope: WCS_PROFILE_MANAGEMENT_SCOPE, pprofilename: windows_sys::core::PCWSTR, pdevicename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type WcsEnumColorProfiles = unsafe extern "system" fn(scope: WCS_PROFILE_MANAGEMENT_SCOPE, penumrecord: *const ENUMTYPEW, pbuffer: *mut u8, dwsize: u32, pnprofiles: *mut u32) -> windows_sys::core::BOOL;
...
pub type WcsEnumColorProfilesSize = unsafe extern "system" fn(scope: WCS_PROFILE_MANAGEMENT_SCOPE, penumrecord: *const ENUMTYPEW, pdwsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type WcsGetCalibrationManagementState = unsafe extern "system" fn(pbisenabled: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type WcsGetDefaultColorProfileSize = unsafe extern "system" fn(scope: WCS_PROFILE_MANAGEMENT_SCOPE, pdevicename: windows_sys::core::PCWSTR, cptcolorprofiletype: COLORPROFILETYPE, cpstcolorprofilesubtype: COLORPROFILESUBTYPE, dwprofileid: u32, pcbprofilename: *mut u32) -> windows_sys::core::BOOL;
...
pub type WcsGetDefaultRenderingIntent = unsafe extern "system" fn(scope: WCS_PROFILE_MANAGEMENT_SCOPE, pdwrenderingintent: *mut u32) -> windows_sys::core::BOOL;
...
pub type WcsGetUsePerUserProfiles = unsafe extern "system" fn(pdevicename: windows_sys::core::PCWSTR, dwdeviceclass: u32, puseperuserprofiles: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type WcsSetCalibrationManagementState = unsafe extern "system" fn(bisenabled: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type WcsSetDefaultColorProfile = unsafe extern "system" fn(scope: WCS_PROFILE_MANAGEMENT_SCOPE, pdevicename: windows_sys::core::PCWSTR, cptcolorprofiletype: COLORPROFILETYPE, cpstcolorprofilesubtype: COLORPROFILESUBTYPE, dwprofileid: u32, pprofilename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type WcsSetDefaultRenderingIntent = unsafe extern "system" fn(scope: WCS_PROFILE_MANAGEMENT_SCOPE, dwrenderingintent: u32) -> windows_sys::core::BOOL;
...
pub type WcsSetUsePerUserProfiles = unsafe extern "system" fn(pdevicename: windows_sys::core::PCWSTR, dwdeviceclass: u32, useperuserprofiles: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type WcsTranslateColors = unsafe extern "system" fn(hcolortransform: isize, ncolors: u32, ninputchannels: u32, cdtinput: COLORDATATYPE, cbinput: u32, pinputdata: *const core::ffi::c_void, noutputchannels: u32, cdtoutput: COLORDATATYPE, cboutput: u32, poutputdata: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
