...
pub const CS_DELETE_TRANSFORM: COLOR_MATCH_TO_TARGET_ACTION = 3;
pub const CS_DISABLE: COLOR_MATCH_TO_TARGET_ACTION = 2;
pub const CS_ENABLE: COLOR_MATCH_TO_TARGET_ACTION = 1;
...
pub const ICM_ADDPROFILE: ICM_COMMAND = 1;
pub type ICM_COMMAND = u32;
pub const ICM_DELETEPROFILE: ICM_COMMAND = 2;
pub const ICM_DONE_OUTSIDEDC: ICM_MODE = 4;
pub type ICM_MODE = i32;
pub const ICM_OFF: ICM_MODE = 1;
pub const ICM_ON: ICM_MODE = 2;
pub const ICM_QUERY: ICM_MODE = 3;
pub const ICM_QUERYMATCH: ICM_COMMAND = 7;
pub const ICM_QUERYPROFILE: ICM_COMMAND = 3;
pub const ICM_REGISTERICMATCHER: ICM_COMMAND = 5;
pub const ICM_SETDEFAULTPROFILE: ICM_COMMAND = 4;
pub const ICM_UNREGISTERICMATCHER: ICM_COMMAND = 6;
...
pub const LCS_CALIBRATED_RGB: LCSCSTYPE = 0;
pub const LCS_WINDOWS_COLOR_SPACE: LCSCSTYPE = 1466527264;
pub const LCS_sRGB: LCSCSTYPE = 1934772034;
#[repr(C)]
#[cfg(feature = "Win32_Graphics_Gdi")]
#[derive(Clone, Copy)]
