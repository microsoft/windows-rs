...
pub const MOUSE_ATTRIBUTES_CHANGED: MOUSE_STATE = 4;
pub const MOUSE_MOVE_ABSOLUTE: MOUSE_STATE = 1;
pub const MOUSE_MOVE_NOCOALESCE: MOUSE_STATE = 8;
pub const MOUSE_MOVE_RELATIVE: MOUSE_STATE = 0;
...
pub const RIDEV_APPKEYS: RAWINPUTDEVICE_FLAGS = 1024;
pub const RIDEV_CAPTUREMOUSE: RAWINPUTDEVICE_FLAGS = 512;
pub const RIDEV_DEVNOTIFY: RAWINPUTDEVICE_FLAGS = 8192;
pub const RIDEV_EXCLUDE: RAWINPUTDEVICE_FLAGS = 16;
pub const RIDEV_EXINPUTSINK: RAWINPUTDEVICE_FLAGS = 4096;
pub const RIDEV_INPUTSINK: RAWINPUTDEVICE_FLAGS = 256;
pub const RIDEV_NOHOTKEYS: RAWINPUTDEVICE_FLAGS = 512;
pub const RIDEV_NOLEGACY: RAWINPUTDEVICE_FLAGS = 48;
pub const RIDEV_PAGEONLY: RAWINPUTDEVICE_FLAGS = 32;
...
pub const RIDI_PREPARSEDDATA: RAW_INPUT_DEVICE_INFO_COMMAND = 536870917;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const RID_HEADER: RAW_INPUT_DATA_COMMAND_FLAGS = 268435461;
