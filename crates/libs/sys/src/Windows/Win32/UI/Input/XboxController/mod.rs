...
windows_link::link!("xinput1_4.dll" "system" fn XInputGetAudioDeviceIds(dwuserindex : u32, prenderdeviceid : windows_sys::core::PCWSTR, prendercount : *mut u32, pcapturedeviceid : windows_sys::core::PCWSTR, pcapturecount : *mut u32) -> u32);
...
windows_link::link!("xinput1_4.dll" "system" fn XInputSetState(dwuserindex : u32, pvibration : *mut XINPUT_VIBRATION) -> u32);
