...
pub const GID_BEGIN: GESTURECONFIG_ID = 1;
pub const GID_END: GESTURECONFIG_ID = 2;
pub const GID_PAN: GESTURECONFIG_ID = 4;
pub const GID_PRESSANDTAP: GESTURECONFIG_ID = 7;
pub const GID_ROLLOVER: GESTURECONFIG_ID = 7;
pub const GID_ROTATE: GESTURECONFIG_ID = 5;
pub const GID_TWOFINGERTAP: GESTURECONFIG_ID = 6;
pub const GID_ZOOM: GESTURECONFIG_ID = 3;
...
pub const TOUCHEVENTF_INRANGE: TOUCHEVENTF_FLAGS = 8;
pub const TOUCHEVENTF_MOVE: TOUCHEVENTF_FLAGS = 1;
pub const TOUCHEVENTF_NOCOALESCE: TOUCHEVENTF_FLAGS = 32;
pub const TOUCHEVENTF_PALM: TOUCHEVENTF_FLAGS = 128;
pub const TOUCHEVENTF_PEN: TOUCHEVENTF_FLAGS = 64;
...
pub const TOUCHINPUTMASKF_CONTACTAREA: TOUCHINPUTMASKF_MASK = 4;
pub const TOUCHINPUTMASKF_EXTRAINFO: TOUCHINPUTMASKF_MASK = 2;
pub type TOUCHINPUTMASKF_MASK = u32;
pub const TOUCHINPUTMASKF_TIMEFROMSYSTEM: TOUCHINPUTMASKF_MASK = 1;
pub const TWF_FINETOUCH: REGISTER_TOUCH_WINDOW_FLAGS = 1;
