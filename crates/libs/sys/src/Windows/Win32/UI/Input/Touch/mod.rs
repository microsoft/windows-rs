pub type CloseGestureInfoHandle = unsafe extern "system" fn(hgestureinfo: HGESTUREINFO) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn CloseGestureInfoHandle(hgestureinfo : HGESTUREINFO) -> windows_sys::core::BOOL);
pub type CloseTouchInputHandle = unsafe extern "system" fn(htouchinput: HTOUCHINPUT) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn CloseTouchInputHandle(htouchinput : HTOUCHINPUT) -> windows_sys::core::BOOL);
pub type GetGestureConfig = unsafe extern "system" fn(hwnd: super::super::super::Foundation::HWND, dwreserved: u32, dwflags: u32, pcids: *const u32, pgestureconfig: *mut GESTURECONFIG, cbsize: u32) -> windows_sys::core::BOOL;
...
pub type GetGestureExtraArgs = unsafe extern "system" fn(hgestureinfo: HGESTUREINFO, cbextraargs: u32, pextraargs: *mut u8) -> windows_sys::core::BOOL;
...
pub type GetGestureInfo = unsafe extern "system" fn(hgestureinfo: HGESTUREINFO, pgestureinfo: *mut GESTUREINFO) -> windows_sys::core::BOOL;
...
pub type GetTouchInputInfo = unsafe extern "system" fn(htouchinput: HTOUCHINPUT, cinputs: u32, pinputs: *mut TOUCHINPUT, cbsize: i32) -> windows_sys::core::BOOL;
...
pub type IsTouchWindow = unsafe extern "system" fn(hwnd: super::super::super::Foundation::HWND, pulflags: *mut u32) -> windows_sys::core::BOOL;
...
pub type RegisterTouchWindow = unsafe extern "system" fn(hwnd: super::super::super::Foundation::HWND, ulflags: REGISTER_TOUCH_WINDOW_FLAGS) -> windows_sys::core::BOOL;
...
pub type SetGestureConfig = unsafe extern "system" fn(hwnd: super::super::super::Foundation::HWND, dwreserved: u32, cids: u32, pgestureconfig: *const GESTURECONFIG, cbsize: u32) -> windows_sys::core::BOOL;
...
pub type UnregisterTouchWindow = unsafe extern "system" fn(hwnd: super::super::super::Foundation::HWND) -> windows_sys::core::BOOL;
