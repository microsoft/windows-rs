...
pub const POINTER_FLAG_CANCELED: POINTER_FLAGS = 32768;
pub const POINTER_FLAG_CAPTURECHANGED: POINTER_FLAGS = 2097152;
pub const POINTER_FLAG_CONFIDENCE: POINTER_FLAGS = 16384;
pub const POINTER_FLAG_DOWN: POINTER_FLAGS = 65536;
pub const POINTER_FLAG_FIFTHBUTTON: POINTER_FLAGS = 256;
pub const POINTER_FLAG_FIRSTBUTTON: POINTER_FLAGS = 16;
pub const POINTER_FLAG_FOURTHBUTTON: POINTER_FLAGS = 128;
pub const POINTER_FLAG_HASTRANSFORM: POINTER_FLAGS = 4194304;
pub const POINTER_FLAG_HWHEEL: POINTER_FLAGS = 1048576;
pub const POINTER_FLAG_INCONTACT: POINTER_FLAGS = 4;
pub const POINTER_FLAG_INRANGE: POINTER_FLAGS = 2;
pub const POINTER_FLAG_NEW: POINTER_FLAGS = 1;
pub const POINTER_FLAG_NONE: POINTER_FLAGS = 0;
pub const POINTER_FLAG_PRIMARY: POINTER_FLAGS = 8192;
pub const POINTER_FLAG_SECONDBUTTON: POINTER_FLAGS = 32;
pub const POINTER_FLAG_THIRDBUTTON: POINTER_FLAGS = 64;
pub const POINTER_FLAG_UP: POINTER_FLAGS = 262144;
pub const POINTER_FLAG_UPDATE: POINTER_FLAGS = 131072;
pub const POINTER_FLAG_WHEEL: POINTER_FLAGS = 524288;
#[repr(C)]
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const TOUCH_FEEDBACK_DEFAULT: TOUCH_FEEDBACK_MODE = 1;
pub const TOUCH_FEEDBACK_INDIRECT: TOUCH_FEEDBACK_MODE = 2;
pub type TOUCH_FEEDBACK_MODE = u32;
pub const TOUCH_FEEDBACK_NONE: TOUCH_FEEDBACK_MODE = 3;
