...
::windows_sys::core::link ! ( "user32.dll""system" #[doc = "*Required features: `\"Win32_UI_Input_KeyboardAndMouse\"`*"] fn MapVirtualKeyA ( ucode : u32 , umaptype : u32 ) -> u32 );
#[cfg(feature = "Win32_UI_TextServices")]
::windows_sys::core::link ! ( "user32.dll""system" #[doc = "*Required features: `\"Win32_UI_Input_KeyboardAndMouse\"`, `\"Win32_UI_TextServices\"`*"] fn MapVirtualKeyExA ( ucode : u32 , umaptype : u32 , dwhkl : super::super::TextServices:: HKL ) -> u32 );
#[cfg(feature = "Win32_UI_TextServices")]
::windows_sys::core::link ! ( "user32.dll""system" #[doc = "*Required features: `\"Win32_UI_Input_KeyboardAndMouse\"`, `\"Win32_UI_TextServices\"`*"] fn MapVirtualKeyExW ( ucode : u32 , umaptype : u32 , dwhkl : super::super::TextServices:: HKL ) -> u32 );
::windows_sys::core::link ! ( "user32.dll""system" #[doc = "*Required features: `\"Win32_UI_Input_KeyboardAndMouse\"`*"] fn MapVirtualKeyW ( ucode : u32 , umaptype : u32 ) -> u32 );
