pub type ActivateKeyboardLayout = unsafe extern "system" fn(hkl: HKL, flags: ACTIVATE_KEYBOARD_LAYOUT_FLAGS) -> HKL;
windows_link::link!("user32.dll" "system" fn ActivateKeyboardLayout(hkl : HKL, flags : ACTIVATE_KEYBOARD_LAYOUT_FLAGS) -> HKL);
pub type BlockInput = unsafe extern "system" fn(fblockit: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn BlockInput(fblockit : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type DragDetect = unsafe extern "system" fn(hwnd: super::super::super::Foundation::HWND, pt: super::super::super::Foundation::POINT) -> windows_sys::core::BOOL;
...
pub type EnableWindow = unsafe extern "system" fn(hwnd: super::super::super::Foundation::HWND, benable: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type GetKeyNameTextA = unsafe extern "system" fn(lparam: i32, lpstring: windows_sys::core::PSTR, cchsize: i32) -> i32;
windows_link::link!("user32.dll" "system" fn GetKeyNameTextA(lparam : i32, lpstring : windows_sys::core::PSTR, cchsize : i32) -> i32);
pub type GetKeyNameTextW = unsafe extern "system" fn(lparam: i32, lpstring: windows_sys::core::PWSTR, cchsize: i32) -> i32;
...
pub type GetKeyboardLayout = unsafe extern "system" fn(idthread: u32) -> HKL;
windows_link::link!("user32.dll" "system" fn GetKeyboardLayout(idthread : u32) -> HKL);
pub type GetKeyboardLayoutList = unsafe extern "system" fn(nbuff: i32, lplist: *mut HKL) -> i32;
windows_link::link!("user32.dll" "system" fn GetKeyboardLayoutList(nbuff : i32, lplist : *mut HKL) -> i32);
pub type GetKeyboardLayoutNameA = unsafe extern "system" fn(pwszklid: windows_sys::core::PSTR) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn GetKeyboardLayoutNameA(pwszklid : windows_sys::core::PSTR) -> windows_sys::core::BOOL);
pub type GetKeyboardLayoutNameW = unsafe extern "system" fn(pwszklid: windows_sys::core::PWSTR) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn GetKeyboardLayoutNameW(pwszklid : windows_sys::core::PWSTR) -> windows_sys::core::BOOL);
pub type GetKeyboardState = unsafe extern "system" fn(lpkeystate: *mut u8) -> windows_sys::core::BOOL;
...
pub type GetLastInputInfo = unsafe extern "system" fn(plii: *mut LASTINPUTINFO) -> windows_sys::core::BOOL;
...
pub type IsWindowEnabled = unsafe extern "system" fn(hwnd: super::super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsWindowEnabled(hwnd : super::super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type LoadKeyboardLayoutA = unsafe extern "system" fn(pwszklid: windows_sys::core::PCSTR, flags: ACTIVATE_KEYBOARD_LAYOUT_FLAGS) -> HKL;
...
pub type LoadKeyboardLayoutW = unsafe extern "system" fn(pwszklid: windows_sys::core::PCWSTR, flags: ACTIVATE_KEYBOARD_LAYOUT_FLAGS) -> HKL;
...
pub type MapVirtualKeyA = unsafe extern "system" fn(ucode: u32, umaptype: MAP_VIRTUAL_KEY_TYPE) -> u32;
windows_link::link!("user32.dll" "system" fn MapVirtualKeyA(ucode : u32, umaptype : MAP_VIRTUAL_KEY_TYPE) -> u32);
pub type MapVirtualKeyExA = unsafe extern "system" fn(ucode: u32, umaptype: MAP_VIRTUAL_KEY_TYPE, dwhkl: HKL) -> u32;
windows_link::link!("user32.dll" "system" fn MapVirtualKeyExA(ucode : u32, umaptype : MAP_VIRTUAL_KEY_TYPE, dwhkl : HKL) -> u32);
pub type MapVirtualKeyExW = unsafe extern "system" fn(ucode: u32, umaptype: MAP_VIRTUAL_KEY_TYPE, dwhkl: HKL) -> u32;
windows_link::link!("user32.dll" "system" fn MapVirtualKeyExW(ucode : u32, umaptype : MAP_VIRTUAL_KEY_TYPE, dwhkl : HKL) -> u32);
pub type MapVirtualKeyW = unsafe extern "system" fn(ucode: u32, umaptype: MAP_VIRTUAL_KEY_TYPE) -> u32;
...
pub type RegisterHotKey = unsafe extern "system" fn(hwnd: super::super::super::Foundation::HWND, id: i32, fsmodifiers: HOT_KEY_MODIFIERS, vk: u32) -> windows_sys::core::BOOL;
...
pub type ReleaseCapture = unsafe extern "system" fn() -> windows_sys::core::BOOL;
...
pub type SetDoubleClickTime = unsafe extern "system" fn(param0: u32) -> windows_sys::core::BOOL;
...
pub type SetKeyboardState = unsafe extern "system" fn(lpkeystate: *const u8) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn SetKeyboardState(lpkeystate : *const u8) -> windows_sys::core::BOOL);
pub type SwapMouseButton = unsafe extern "system" fn(fswap: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type ToAsciiEx = unsafe extern "system" fn(uvirtkey: u32, uscancode: u32, lpkeystate: *const u8, lpchar: *mut u16, uflags: u32, dwhkl: HKL) -> i32;
...
pub type ToUnicode = unsafe extern "system" fn(wvirtkey: u32, wscancode: u32, lpkeystate: *const u8, pwszbuff: windows_sys::core::PWSTR, cchbuff: i32, wflags: u32) -> i32;
...
pub type ToUnicodeEx = unsafe extern "system" fn(wvirtkey: u32, wscancode: u32, lpkeystate: *const u8, pwszbuff: windows_sys::core::PWSTR, cchbuff: i32, wflags: u32, dwhkl: HKL) -> i32;
...
pub type TrackMouseEvent = unsafe extern "system" fn(lpeventtrack: *mut TRACKMOUSEEVENT) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn TrackMouseEvent(lpeventtrack : *mut TRACKMOUSEEVENT) -> windows_sys::core::BOOL);
pub type UnloadKeyboardLayout = unsafe extern "system" fn(hkl: HKL) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn UnloadKeyboardLayout(hkl : HKL) -> windows_sys::core::BOOL);
pub type UnregisterHotKey = unsafe extern "system" fn(hwnd: super::super::super::Foundation::HWND, id: i32) -> windows_sys::core::BOOL;
...
pub type VkKeyScanA = unsafe extern "system" fn(ch: i8) -> i16;
windows_link::link!("user32.dll" "system" fn VkKeyScanA(ch : i8) -> i16);
pub type VkKeyScanExA = unsafe extern "system" fn(ch: i8, dwhkl: HKL) -> i16;
windows_link::link!("user32.dll" "system" fn VkKeyScanExA(ch : i8, dwhkl : HKL) -> i16);
pub type VkKeyScanExW = unsafe extern "system" fn(ch: u16, dwhkl: HKL) -> i16;
...
pub type _TrackMouseEvent = unsafe extern "system" fn(lpeventtrack: *mut TRACKMOUSEEVENT) -> windows_sys::core::BOOL;
...
pub type mouse_event = unsafe extern "system" fn(dwflags: MOUSE_EVENT_FLAGS, dx: i32, dy: i32, dwdata: i32, dwextrainfo: usize);
