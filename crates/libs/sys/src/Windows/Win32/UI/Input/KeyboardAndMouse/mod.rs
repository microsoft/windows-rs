...
windows_link::link!("user32.dll" "system" fn GetKeyNameTextA(lparam : i32, lpstring : windows_sys::core::PCSTR, cchsize : i32) -> i32);
windows_link::link!("user32.dll" "system" fn GetKeyNameTextW(lparam : i32, lpstring : windows_sys::core::PCWSTR, cchsize : i32) -> i32);
...
windows_link::link!("user32.dll" "system" fn GetKeyboardLayoutNameA(pwszklid : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
...
windows_link::link!("user32.dll" "system" fn GetMouseMovePointsEx(cbsize : u32, lppt : *mut MOUSEMOVEPOINT, lpptbuf : *mut MOUSEMOVEPOINT, nbufpoints : i32, resolution : GET_MOUSE_MOVE_POINTS_EX_RESOLUTION) -> i32);
...
windows_link::link!("user32.dll" "system" fn SendInput(cinputs : u32, pinputs : *mut INPUT, cbsize : i32) -> u32);
...
windows_link::link!("user32.dll" "system" fn SetKeyboardState(lpkeystate : *mut u8) -> windows_sys::core::BOOL);
windows_link::link!("user32.dll" "system" fn SwapMouseButton(fswap : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
windows_link::link!("user32.dll" "system" fn ToAscii(uvirtkey : u32, uscancode : u32, lpkeystate : *mut u8, lpchar : *mut u16, uflags : u32) -> i32);
windows_link::link!("user32.dll" "system" fn ToAsciiEx(uvirtkey : u32, uscancode : u32, lpkeystate : *mut u8, lpchar : *mut u16, uflags : u32, dwhkl : HKL) -> i32);
...
windows_link::link!("user32.dll" "system" fn ToUnicodeEx(wvirtkey : u32, wscancode : u32, lpkeystate : *mut u8, pwszbuff : windows_sys::core::PCWSTR, cchbuff : i32, wflags : u32, dwhkl : HKL) -> i32);
