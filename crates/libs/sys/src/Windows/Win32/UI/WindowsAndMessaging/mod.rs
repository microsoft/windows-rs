pub type AdjustWindowRect = unsafe extern "system" fn(lprect: *mut super::super::Foundation::RECT, dwstyle: WINDOW_STYLE, bmenu: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type AdjustWindowRectEx = unsafe extern "system" fn(lprect: *mut super::super::Foundation::RECT, dwstyle: WINDOW_STYLE, bmenu: windows_sys::core::BOOL, dwexstyle: WINDOW_EX_STYLE) -> windows_sys::core::BOOL;
...
pub type AllowSetForegroundWindow = unsafe extern "system" fn(dwprocessid: u32) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn AllowSetForegroundWindow(dwprocessid : u32) -> windows_sys::core::BOOL);
pub type AnimateWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, dwtime: u32, dwflags: ANIMATE_WINDOW_FLAGS) -> windows_sys::core::BOOL;
...
pub type AnyPopup = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn AnyPopup() -> windows_sys::core::BOOL);
pub type AppendMenuA = unsafe extern "system" fn(hmenu: HMENU, uflags: MENU_ITEM_FLAGS, uidnewitem: usize, lpnewitem: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type AppendMenuW = unsafe extern "system" fn(hmenu: HMENU, uflags: MENU_ITEM_FLAGS, uidnewitem: usize, lpnewitem: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type ApplyWindowAction = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, paction: *mut WINDOW_ACTION) -> windows_sys::core::BOOL;
...
pub type ArrangeIconicWindows = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> u32;
windows_link::link!("user32.dll" "system" fn ArrangeIconicWindows(hwnd : super::super::Foundation::HWND) -> u32);
pub type BeginDeferWindowPos = unsafe extern "system" fn(nnumwindows: i32) -> HDWP;
windows_link::link!("user32.dll" "system" fn BeginDeferWindowPos(nnumwindows : i32) -> HDWP);
pub type BringWindowToTop = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn BringWindowToTop(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type CalculatePopupWindowPosition = unsafe extern "system" fn(anchorpoint: *const super::super::Foundation::POINT, windowsize: *const super::super::Foundation::SIZE, flags: u32, excluderect: *const super::super::Foundation::RECT, popupwindowposition: *mut super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
pub type CallMsgFilterA = unsafe extern "system" fn(lpmsg: *const MSG, ncode: i32) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn CallMsgFilterA(lpmsg : *const MSG, ncode : i32) -> windows_sys::core::BOOL);
pub type CallMsgFilterW = unsafe extern "system" fn(lpmsg: *const MSG, ncode: i32) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn CallMsgFilterW(lpmsg : *const MSG, ncode : i32) -> windows_sys::core::BOOL);
pub type CallNextHookEx = unsafe extern "system" fn(hhk: HHOOK, ncode: i32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> super::super::Foundation::LRESULT;
...
pub type CallWindowProcA = unsafe extern "system" fn(lpprevwndfunc: WNDPROC, hwnd: super::super::Foundation::HWND, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> super::super::Foundation::LRESULT;
...
pub type CallWindowProcW = unsafe extern "system" fn(lpprevwndfunc: WNDPROC, hwnd: super::super::Foundation::HWND, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> super::super::Foundation::LRESULT;
...
pub type CancelShutdown = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn CancelShutdown() -> windows_sys::core::BOOL);
pub type CascadeWindows = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, whow: CASCADE_WINDOWS_HOW, lprect: *const super::super::Foundation::RECT, ckids: u32, lpkids: *const super::super::Foundation::HWND) -> u16;
...
pub type ChangeMenuA = unsafe extern "system" fn(hmenu: HMENU, cmd: u32, lpsznewitem: windows_sys::core::PCSTR, cmdinsert: u32, flags: u32) -> windows_sys::core::BOOL;
...
pub type ChangeMenuW = unsafe extern "system" fn(hmenu: HMENU, cmd: u32, lpsznewitem: windows_sys::core::PCWSTR, cmdinsert: u32, flags: u32) -> windows_sys::core::BOOL;
...
pub type ChangeWindowMessageFilter = unsafe extern "system" fn(message: u32, dwflag: CHANGE_WINDOW_MESSAGE_FILTER_FLAGS) -> windows_sys::core::BOOL;
...
pub type ChangeWindowMessageFilterEx = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, message: u32, action: WINDOW_MESSAGE_FILTER_ACTION, pchangefilterstruct: *mut CHANGEFILTERSTRUCT) -> windows_sys::core::BOOL;
...
pub type CharLowerA = unsafe extern "system" fn(lpsz: windows_sys::core::PSTR) -> windows_sys::core::PSTR;
windows_link::link!("user32.dll" "system" fn CharLowerA(lpsz : windows_sys::core::PSTR) -> windows_sys::core::PSTR);
pub type CharLowerBuffA = unsafe extern "system" fn(lpsz: windows_sys::core::PSTR, cchlength: u32) -> u32;
windows_link::link!("user32.dll" "system" fn CharLowerBuffA(lpsz : windows_sys::core::PSTR, cchlength : u32) -> u32);
pub type CharLowerBuffW = unsafe extern "system" fn(lpsz: windows_sys::core::PWSTR, cchlength: u32) -> u32;
windows_link::link!("user32.dll" "system" fn CharLowerBuffW(lpsz : windows_sys::core::PWSTR, cchlength : u32) -> u32);
pub type CharLowerW = unsafe extern "system" fn(lpsz: windows_sys::core::PWSTR) -> windows_sys::core::PWSTR;
windows_link::link!("user32.dll" "system" fn CharLowerW(lpsz : windows_sys::core::PWSTR) -> windows_sys::core::PWSTR);
pub type CharNextA = unsafe extern "system" fn(lpsz: windows_sys::core::PCSTR) -> windows_sys::core::PSTR;
windows_link::link!("user32.dll" "system" fn CharNextA(lpsz : windows_sys::core::PCSTR) -> windows_sys::core::PSTR);
pub type CharNextExA = unsafe extern "system" fn(codepage: u16, lpcurrentchar: windows_sys::core::PCSTR, dwflags: u32) -> windows_sys::core::PSTR;
...
pub type CharNextW = unsafe extern "system" fn(lpsz: windows_sys::core::PCWSTR) -> windows_sys::core::PWSTR;
windows_link::link!("user32.dll" "system" fn CharNextW(lpsz : windows_sys::core::PCWSTR) -> windows_sys::core::PWSTR);
pub type CharPrevA = unsafe extern "system" fn(lpszstart: windows_sys::core::PCSTR, lpszcurrent: windows_sys::core::PCSTR) -> windows_sys::core::PSTR;
...
pub type CharPrevExA = unsafe extern "system" fn(codepage: u16, lpstart: windows_sys::core::PCSTR, lpcurrentchar: windows_sys::core::PCSTR, dwflags: u32) -> windows_sys::core::PSTR;
...
pub type CharPrevW = unsafe extern "system" fn(lpszstart: windows_sys::core::PCWSTR, lpszcurrent: windows_sys::core::PCWSTR) -> windows_sys::core::PWSTR;
...
pub type CharToOemA = unsafe extern "system" fn(psrc: windows_sys::core::PCSTR, pdst: windows_sys::core::PSTR) -> windows_sys::core::BOOL;
...
pub type CharToOemBuffA = unsafe extern "system" fn(lpszsrc: windows_sys::core::PCSTR, lpszdst: windows_sys::core::PSTR, cchdstlength: u32) -> windows_sys::core::BOOL;
...
pub type CharToOemBuffW = unsafe extern "system" fn(lpszsrc: windows_sys::core::PCWSTR, lpszdst: windows_sys::core::PSTR, cchdstlength: u32) -> windows_sys::core::BOOL;
...
pub type CharToOemW = unsafe extern "system" fn(psrc: windows_sys::core::PCWSTR, pdst: windows_sys::core::PSTR) -> windows_sys::core::BOOL;
...
pub type CharUpperA = unsafe extern "system" fn(lpsz: windows_sys::core::PSTR) -> windows_sys::core::PSTR;
windows_link::link!("user32.dll" "system" fn CharUpperA(lpsz : windows_sys::core::PSTR) -> windows_sys::core::PSTR);
pub type CharUpperBuffA = unsafe extern "system" fn(lpsz: windows_sys::core::PSTR, cchlength: u32) -> u32;
windows_link::link!("user32.dll" "system" fn CharUpperBuffA(lpsz : windows_sys::core::PSTR, cchlength : u32) -> u32);
pub type CharUpperBuffW = unsafe extern "system" fn(lpsz: windows_sys::core::PWSTR, cchlength: u32) -> u32;
windows_link::link!("user32.dll" "system" fn CharUpperBuffW(lpsz : windows_sys::core::PWSTR, cchlength : u32) -> u32);
pub type CharUpperW = unsafe extern "system" fn(lpsz: windows_sys::core::PWSTR) -> windows_sys::core::PWSTR;
windows_link::link!("user32.dll" "system" fn CharUpperW(lpsz : windows_sys::core::PWSTR) -> windows_sys::core::PWSTR);
pub type CheckMenuItem = unsafe extern "system" fn(hmenu: HMENU, uidcheckitem: u32, ucheck: u32) -> u32;
windows_link::link!("user32.dll" "system" fn CheckMenuItem(hmenu : HMENU, uidcheckitem : u32, ucheck : u32) -> u32);
pub type CheckMenuRadioItem = unsafe extern "system" fn(hmenu: HMENU, first: u32, last: u32, check: u32, flags: u32) -> windows_sys::core::BOOL;
...
pub type ChildWindowFromPoint = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, point: super::super::Foundation::POINT) -> super::super::Foundation::HWND;
...
pub type ChildWindowFromPointEx = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, pt: super::super::Foundation::POINT, flags: CWP_FLAGS) -> super::super::Foundation::HWND;
...
pub type ClipCursor = unsafe extern "system" fn(lprect: *const super::super::Foundation::RECT) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn ClipCursor(lprect : *const super::super::Foundation::RECT) -> windows_sys::core::BOOL);
pub type CloseWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn CloseWindow(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type ConvertPrimaryPointerToMouseDrag = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn ConvertPrimaryPointerToMouseDrag() -> windows_sys::core::BOOL);
pub type ConvertToInterceptWindow = unsafe extern "system" fn(toplevelwindow: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
...
pub type CopyAcceleratorTableA = unsafe extern "system" fn(haccelsrc: HACCEL, lpacceldst: *mut ACCEL, caccelentries: i32) -> i32;
windows_link::link!("user32.dll" "system" fn CopyAcceleratorTableA(haccelsrc : HACCEL, lpacceldst : *mut ACCEL, caccelentries : i32) -> i32);
pub type CopyAcceleratorTableW = unsafe extern "system" fn(haccelsrc: HACCEL, lpacceldst: *mut ACCEL, caccelentries: i32) -> i32;
windows_link::link!("user32.dll" "system" fn CopyAcceleratorTableW(haccelsrc : HACCEL, lpacceldst : *mut ACCEL, caccelentries : i32) -> i32);
pub type CopyIcon = unsafe extern "system" fn(hicon: HICON) -> HICON;
windows_link::link!("user32.dll" "system" fn CopyIcon(hicon : HICON) -> HICON);
pub type CopyImage = unsafe extern "system" fn(h: super::super::Foundation::HANDLE, r#type: GDI_IMAGE_TYPE, cx: i32, cy: i32, flags: IMAGE_FLAGS) -> super::super::Foundation::HANDLE;
...
pub type CreateAcceleratorTableA = unsafe extern "system" fn(paccel: *const ACCEL, caccel: i32) -> HACCEL;
windows_link::link!("user32.dll" "system" fn CreateAcceleratorTableA(paccel : *const ACCEL, caccel : i32) -> HACCEL);
pub type CreateAcceleratorTableW = unsafe extern "system" fn(paccel: *const ACCEL, caccel: i32) -> HACCEL;
windows_link::link!("user32.dll" "system" fn CreateAcceleratorTableW(paccel : *const ACCEL, caccel : i32) -> HACCEL);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type CreateCaret = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hbitmap: super::super::Graphics::Gdi::HBITMAP, nwidth: i32, nheight: i32) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type CreateCursor = unsafe extern "system" fn(hinst: super::super::Foundation::HINSTANCE, xhotspot: i32, yhotspot: i32, nwidth: i32, nheight: i32, pvandplane: *const core::ffi::c_void, pvxorplane: *const core::ffi::c_void) -> HCURSOR;
...
pub type CreateDialogIndirectParamA = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lptemplate: *const DLGTEMPLATE, hwndparent: super::super::Foundation::HWND, lpdialogfunc: DLGPROC, dwinitparam: super::super::Foundation::LPARAM) -> super::super::Foundation::HWND;
...
pub type CreateDialogIndirectParamW = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lptemplate: *const DLGTEMPLATE, hwndparent: super::super::Foundation::HWND, lpdialogfunc: DLGPROC, dwinitparam: super::super::Foundation::LPARAM) -> super::super::Foundation::HWND;
...
pub type CreateDialogParamA = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lptemplatename: windows_sys::core::PCSTR, hwndparent: super::super::Foundation::HWND, lpdialogfunc: DLGPROC, dwinitparam: super::super::Foundation::LPARAM) -> super::super::Foundation::HWND;
...
pub type CreateDialogParamW = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lptemplatename: windows_sys::core::PCWSTR, hwndparent: super::super::Foundation::HWND, lpdialogfunc: DLGPROC, dwinitparam: super::super::Foundation::LPARAM) -> super::super::Foundation::HWND;
...
pub type CreateIcon = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, nwidth: i32, nheight: i32, cplanes: u8, cbitspixel: u8, lpbandbits: *const u8, lpbxorbits: *const u8) -> HICON;
...
pub type CreateIconFromResource = unsafe extern "system" fn(presbits: *const u8, dwressize: u32, ficon: windows_sys::core::BOOL, dwver: u32) -> HICON;
...
pub type CreateIconFromResourceEx = unsafe extern "system" fn(presbits: *const u8, dwressize: u32, ficon: windows_sys::core::BOOL, dwver: u32, cxdesired: i32, cydesired: i32, flags: IMAGE_FLAGS) -> HICON;
...
pub type CreateWindowExW = unsafe extern "system" fn(dwexstyle: WINDOW_EX_STYLE, lpclassname: windows_sys::core::PCWSTR, lpwindowname: windows_sys::core::PCWSTR, dwstyle: WINDOW_STYLE, x: i32, y: i32, nwidth: i32, nheight: i32, hwndparent: super::super::Foundation::HWND, hmenu: HMENU, hinstance: super::super::Foundation::HINSTANCE, lpparam: *const core::ffi::c_void) -> super::super::Foundation::HWND;
...
pub type DefDlgProcA = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> super::super::Foundation::LRESULT;
...
pub type DefDlgProcW = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> super::super::Foundation::LRESULT;
...
pub type DefFrameProcA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hwndmdiclient: super::super::Foundation::HWND, umsg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> super::super::Foundation::LRESULT;
...
pub type DefFrameProcW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hwndmdiclient: super::super::Foundation::HWND, umsg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> super::super::Foundation::LRESULT;
...
pub type DefMDIChildProcA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, umsg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> super::super::Foundation::LRESULT;
...
pub type DefMDIChildProcW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, umsg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> super::super::Foundation::LRESULT;
...
pub type DefWindowProcA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> super::super::Foundation::LRESULT;
...
pub type DefWindowProcW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> super::super::Foundation::LRESULT;
...
pub type DeferWindowPos = unsafe extern "system" fn(hwinposinfo: HDWP, hwnd: super::super::Foundation::HWND, hwndinsertafter: super::super::Foundation::HWND, x: i32, y: i32, cx: i32, cy: i32, uflags: SET_WINDOW_POS_FLAGS) -> HDWP;
...
pub type DeleteMenu = unsafe extern "system" fn(hmenu: HMENU, uposition: u32, uflags: MENU_ITEM_FLAGS) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn DeleteMenu(hmenu : HMENU, uposition : u32, uflags : MENU_ITEM_FLAGS) -> windows_sys::core::BOOL);
pub type DeregisterShellHookWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn DeregisterShellHookWindow(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type DestroyAcceleratorTable = unsafe extern "system" fn(haccel: HACCEL) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn DestroyAcceleratorTable(haccel : HACCEL) -> windows_sys::core::BOOL);
pub type DestroyCaret = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn DestroyCaret() -> windows_sys::core::BOOL);
pub type DestroyCursor = unsafe extern "system" fn(hcursor: HCURSOR) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn DestroyCursor(hcursor : HCURSOR) -> windows_sys::core::BOOL);
pub type DestroyIcon = unsafe extern "system" fn(hicon: HICON) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn DestroyIcon(hicon : HICON) -> windows_sys::core::BOOL);
pub type DestroyIndexedResults = unsafe extern "system" fn(resourceuri: windows_sys::core::PCWSTR, qualifiercount: u32, qualifiers: *const IndexedResourceQualifier);
...
pub type DestroyMenu = unsafe extern "system" fn(hmenu: HMENU) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn DestroyMenu(hmenu : HMENU) -> windows_sys::core::BOOL);
pub type DestroyResourceIndexer = unsafe extern "system" fn(resourceindexer: *const core::ffi::c_void);
windows_link::link!("mrmsupport.dll" "system" fn DestroyResourceIndexer(resourceindexer : *const core::ffi::c_void));
pub type DestroyWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn DestroyWindow(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type DialogBoxIndirectParamA = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, hdialogtemplate: *const DLGTEMPLATE, hwndparent: super::super::Foundation::HWND, lpdialogfunc: DLGPROC, dwinitparam: super::super::Foundation::LPARAM) -> isize;
...
pub type DialogBoxIndirectParamW = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, hdialogtemplate: *const DLGTEMPLATE, hwndparent: super::super::Foundation::HWND, lpdialogfunc: DLGPROC, dwinitparam: super::super::Foundation::LPARAM) -> isize;
...
pub type DialogBoxParamA = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lptemplatename: windows_sys::core::PCSTR, hwndparent: super::super::Foundation::HWND, lpdialogfunc: DLGPROC, dwinitparam: super::super::Foundation::LPARAM) -> isize;
...
pub type DialogBoxParamW = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lptemplatename: windows_sys::core::PCWSTR, hwndparent: super::super::Foundation::HWND, lpdialogfunc: DLGPROC, dwinitparam: super::super::Foundation::LPARAM) -> isize;
...
pub type DisableProcessWindowsGhosting = unsafe extern "system" fn();
windows_link::link!("user32.dll" "system" fn DisableProcessWindowsGhosting());
pub type DispatchMessageA = unsafe extern "system" fn(lpmsg: *const MSG) -> super::super::Foundation::LRESULT;
windows_link::link!("user32.dll" "system" fn DispatchMessageA(lpmsg : *const MSG) -> super::super::Foundation::LRESULT);
pub type DispatchMessageW = unsafe extern "system" fn(lpmsg: *const MSG) -> super::super::Foundation::LRESULT;
windows_link::link!("user32.dll" "system" fn DispatchMessageW(lpmsg : *const MSG) -> super::super::Foundation::LRESULT);
pub type DragObject = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, hwndfrom: super::super::Foundation::HWND, fmt: u32, data: usize, hcur: HCURSOR) -> u32;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type DrawIcon = unsafe extern "system" fn(hdc: super::super::Graphics::Gdi::HDC, x: i32, y: i32, hicon: HICON) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type DrawIconEx = unsafe extern "system" fn(hdc: super::super::Graphics::Gdi::HDC, xleft: i32, ytop: i32, hicon: HICON, cxwidth: i32, cywidth: i32, istepifanicur: u32, hbrflickerfreedraw: super::super::Graphics::Gdi::HBRUSH, diflags: DI_FLAGS) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type DrawMenuBar = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn DrawMenuBar(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type EnableMenuItem = unsafe extern "system" fn(hmenu: HMENU, uidenableitem: u32, uenable: MENU_ITEM_FLAGS) -> windows_sys::core::BOOL;
...
pub type EndDeferWindowPos = unsafe extern "system" fn(hwinposinfo: HDWP) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn EndDeferWindowPos(hwinposinfo : HDWP) -> windows_sys::core::BOOL);
pub type EndDialog = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, nresult: isize) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn EndDialog(hdlg : super::super::Foundation::HWND, nresult : isize) -> windows_sys::core::BOOL);
pub type EndMenu = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn EndMenu() -> windows_sys::core::BOOL);
pub type EnterMoveSizeLoop = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, ptcursor: super::super::Foundation::POINT, movesizecode: MOVESIZE_OPERATION) -> windows_sys::core::BOOL;
...
pub type EnumChildWindows = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, lpenumfunc: WNDENUMPROC, lparam: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
pub type EnumPropsA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpenumfunc: PROPENUMPROCA) -> i32;
windows_link::link!("user32.dll" "system" fn EnumPropsA(hwnd : super::super::Foundation::HWND, lpenumfunc : PROPENUMPROCA) -> i32);
pub type EnumPropsExA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpenumfunc: PROPENUMPROCEXA, lparam: super::super::Foundation::LPARAM) -> i32;
...
pub type EnumPropsExW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpenumfunc: PROPENUMPROCEXW, lparam: super::super::Foundation::LPARAM) -> i32;
...
pub type EnumPropsW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpenumfunc: PROPENUMPROCW) -> i32;
windows_link::link!("user32.dll" "system" fn EnumPropsW(hwnd : super::super::Foundation::HWND, lpenumfunc : PROPENUMPROCW) -> i32);
pub type EnumThreadWindows = unsafe extern "system" fn(dwthreadid: u32, lpfn: WNDENUMPROC, lparam: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
pub type EnumWindows = unsafe extern "system" fn(lpenumfunc: WNDENUMPROC, lparam: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
pub type FindWindowA = unsafe extern "system" fn(lpclassname: windows_sys::core::PCSTR, lpwindowname: windows_sys::core::PCSTR) -> super::super::Foundation::HWND;
...
pub type FindWindowExA = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, hwndchildafter: super::super::Foundation::HWND, lpszclass: windows_sys::core::PCSTR, lpszwindow: windows_sys::core::PCSTR) -> super::super::Foundation::HWND;
...
pub type FindWindowExW = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, hwndchildafter: super::super::Foundation::HWND, lpszclass: windows_sys::core::PCWSTR, lpszwindow: windows_sys::core::PCWSTR) -> super::super::Foundation::HWND;
...
pub type FindWindowW = unsafe extern "system" fn(lpclassname: windows_sys::core::PCWSTR, lpwindowname: windows_sys::core::PCWSTR) -> super::super::Foundation::HWND;
...
pub type FlashWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, binvert: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type FlashWindowEx = unsafe extern "system" fn(pfwi: *const FLASHWINFO) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn FlashWindowEx(pfwi : *const FLASHWINFO) -> windows_sys::core::BOOL);
pub type GetAltTabInfoA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, iitem: i32, pati: *mut ALTTABINFO, pszitemtext: windows_sys::core::PSTR, cchitemtext: u32) -> windows_sys::core::BOOL;
...
pub type GetAltTabInfoW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, iitem: i32, pati: *mut ALTTABINFO, pszitemtext: windows_sys::core::PWSTR, cchitemtext: u32) -> windows_sys::core::BOOL;
...
pub type GetAncestor = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, gaflags: GET_ANCESTOR_FLAGS) -> super::super::Foundation::HWND;
...
pub type GetCaretBlinkTime = unsafe extern "system" fn() -> u32;
windows_link::link!("user32.dll" "system" fn GetCaretBlinkTime() -> u32);
pub type GetCaretPos = unsafe extern "system" fn(lppoint: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn GetCaretPos(lppoint : *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetClassInfoA = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lpclassname: windows_sys::core::PCSTR, lpwndclass: *mut WNDCLASSA) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetClassInfoExA = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lpszclass: windows_sys::core::PCSTR, lpwcx: *mut WNDCLASSEXA) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetClassInfoExW = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lpszclass: windows_sys::core::PCWSTR, lpwcx: *mut WNDCLASSEXW) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetClassInfoW = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lpclassname: windows_sys::core::PCWSTR, lpwndclass: *mut WNDCLASSW) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GetClassLongA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: GET_CLASS_LONG_INDEX) -> u32;
...
pub type GetClassLongPtrA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: GET_CLASS_LONG_INDEX) -> usize;
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
...
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
pub type GetClassLongPtrW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: GET_CLASS_LONG_INDEX) -> usize;
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
...
pub type GetClassLongW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: GET_CLASS_LONG_INDEX) -> u32;
windows_link::link!("user32.dll" "system" fn GetClassLongW(hwnd : super::super::Foundation::HWND, nindex : GET_CLASS_LONG_INDEX) -> u32);
pub type GetClassNameA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpclassname: windows_sys::core::PSTR, nmaxcount: i32) -> i32;
...
pub type GetClassNameW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpclassname: windows_sys::core::PWSTR, nmaxcount: i32) -> i32;
...
pub type GetClassWord = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: i32) -> u16;
windows_link::link!("user32.dll" "system" fn GetClassWord(hwnd : super::super::Foundation::HWND, nindex : i32) -> u16);
pub type GetClientRect = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lprect: *mut super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
pub type GetClipCursor = unsafe extern "system" fn(lprect: *mut super::super::Foundation::RECT) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn GetClipCursor(lprect : *mut super::super::Foundation::RECT) -> windows_sys::core::BOOL);
pub type GetCurrentMonitorTopologyId = unsafe extern "system" fn() -> u32;
windows_link::link!("user32.dll" "system" fn GetCurrentMonitorTopologyId() -> u32);
pub type GetCursor = unsafe extern "system" fn() -> HCURSOR;
windows_link::link!("user32.dll" "system" fn GetCursor() -> HCURSOR);
pub type GetCursorInfo = unsafe extern "system" fn(pci: *mut CURSORINFO) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn GetCursorInfo(pci : *mut CURSORINFO) -> windows_sys::core::BOOL);
pub type GetCursorPos = unsafe extern "system" fn(lppoint: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn GetCursorPos(lppoint : *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL);
pub type GetDesktopWindow = unsafe extern "system" fn() -> super::super::Foundation::HWND;
windows_link::link!("user32.dll" "system" fn GetDesktopWindow() -> super::super::Foundation::HWND);
pub type GetDialogBaseUnits = unsafe extern "system" fn() -> i32;
windows_link::link!("user32.dll" "system" fn GetDialogBaseUnits() -> i32);
pub type GetDlgCtrlID = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> i32;
windows_link::link!("user32.dll" "system" fn GetDlgCtrlID(hwnd : super::super::Foundation::HWND) -> i32);
pub type GetDlgItem = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, niddlgitem: i32) -> super::super::Foundation::HWND;
...
pub type GetDlgItemInt = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, niddlgitem: i32, lptranslated: *mut windows_sys::core::BOOL, bsigned: windows_sys::core::BOOL) -> u32;
...
pub type GetDlgItemTextA = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, niddlgitem: i32, lpstring: windows_sys::core::PSTR, cchmax: i32) -> u32;
...
pub type GetDlgItemTextW = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, niddlgitem: i32, lpstring: windows_sys::core::PWSTR, cchmax: i32) -> u32;
...
pub type GetForegroundWindow = unsafe extern "system" fn() -> super::super::Foundation::HWND;
windows_link::link!("user32.dll" "system" fn GetForegroundWindow() -> super::super::Foundation::HWND);
pub type GetGUIThreadInfo = unsafe extern "system" fn(idthread: u32, pgui: *mut GUITHREADINFO) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn GetGUIThreadInfo(idthread : u32, pgui : *mut GUITHREADINFO) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetIconInfo = unsafe extern "system" fn(hicon: HICON, piconinfo: *mut ICONINFO) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("user32.dll" "system" fn GetIconInfo(hicon : HICON, piconinfo : *mut ICONINFO) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetIconInfoExA = unsafe extern "system" fn(hicon: HICON, piconinfo: *mut ICONINFOEXA) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("user32.dll" "system" fn GetIconInfoExA(hicon : HICON, piconinfo : *mut ICONINFOEXA) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetIconInfoExW = unsafe extern "system" fn(hicon: HICON, piconinfo: *mut ICONINFOEXW) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("user32.dll" "system" fn GetIconInfoExW(hicon : HICON, piconinfo : *mut ICONINFOEXW) -> windows_sys::core::BOOL);
pub type GetInputState = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn GetInputState() -> windows_sys::core::BOOL);
pub type GetLastActivePopup = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> super::super::Foundation::HWND;
windows_link::link!("user32.dll" "system" fn GetLastActivePopup(hwnd : super::super::Foundation::HWND) -> super::super::Foundation::HWND);
pub type GetLayeredWindowAttributes = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, pcrkey: *mut super::super::Foundation::COLORREF, pbalpha: *mut u8, pdwflags: *mut LAYERED_WINDOW_ATTRIBUTES_FLAGS) -> windows_sys::core::BOOL;
...
pub type GetMenu = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> HMENU;
windows_link::link!("user32.dll" "system" fn GetMenu(hwnd : super::super::Foundation::HWND) -> HMENU);
pub type GetMenuBarInfo = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, idobject: OBJECT_IDENTIFIER, iditem: i32, pmbi: *mut MENUBARINFO) -> windows_sys::core::BOOL;
...
pub type GetMenuCheckMarkDimensions = unsafe extern "system" fn() -> i32;
windows_link::link!("user32.dll" "system" fn GetMenuCheckMarkDimensions() -> i32);
pub type GetMenuDefaultItem = unsafe extern "system" fn(hmenu: HMENU, fbypos: u32, gmdiflags: GET_MENU_DEFAULT_ITEM_FLAGS) -> u32;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetMenuInfo = unsafe extern "system" fn(param0: HMENU, param1: *mut MENUINFO) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("user32.dll" "system" fn GetMenuInfo(param0 : HMENU, param1 : *mut MENUINFO) -> windows_sys::core::BOOL);
pub type GetMenuItemCount = unsafe extern "system" fn(hmenu: HMENU) -> i32;
windows_link::link!("user32.dll" "system" fn GetMenuItemCount(hmenu : HMENU) -> i32);
pub type GetMenuItemID = unsafe extern "system" fn(hmenu: HMENU, npos: i32) -> u32;
windows_link::link!("user32.dll" "system" fn GetMenuItemID(hmenu : HMENU, npos : i32) -> u32);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetMenuItemInfoA = unsafe extern "system" fn(hmenu: HMENU, item: u32, fbyposition: windows_sys::core::BOOL, lpmii: *mut MENUITEMINFOA) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetMenuItemInfoW = unsafe extern "system" fn(hmenu: HMENU, item: u32, fbyposition: windows_sys::core::BOOL, lpmii: *mut MENUITEMINFOW) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GetMenuItemRect = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hmenu: HMENU, uitem: u32, lprcitem: *mut super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
pub type GetMenuState = unsafe extern "system" fn(hmenu: HMENU, uid: u32, uflags: MENU_ITEM_FLAGS) -> u32;
windows_link::link!("user32.dll" "system" fn GetMenuState(hmenu : HMENU, uid : u32, uflags : MENU_ITEM_FLAGS) -> u32);
pub type GetMenuStringA = unsafe extern "system" fn(hmenu: HMENU, uiditem: u32, lpstring: windows_sys::core::PSTR, cchmax: i32, flags: MENU_ITEM_FLAGS) -> i32;
...
pub type GetMenuStringW = unsafe extern "system" fn(hmenu: HMENU, uiditem: u32, lpstring: windows_sys::core::PWSTR, cchmax: i32, flags: MENU_ITEM_FLAGS) -> i32;
...
pub type GetMessageA = unsafe extern "system" fn(lpmsg: *mut MSG, hwnd: super::super::Foundation::HWND, wmsgfiltermin: u32, wmsgfiltermax: u32) -> windows_sys::core::BOOL;
...
pub type GetMessageExtraInfo = unsafe extern "system" fn() -> super::super::Foundation::LPARAM;
windows_link::link!("user32.dll" "system" fn GetMessageExtraInfo() -> super::super::Foundation::LPARAM);
pub type GetMessagePos = unsafe extern "system" fn() -> u32;
windows_link::link!("user32.dll" "system" fn GetMessagePos() -> u32);
pub type GetMessageTime = unsafe extern "system" fn() -> i32;
windows_link::link!("user32.dll" "system" fn GetMessageTime() -> i32);
pub type GetMessageW = unsafe extern "system" fn(lpmsg: *mut MSG, hwnd: super::super::Foundation::HWND, wmsgfiltermin: u32, wmsgfiltermax: u32) -> windows_sys::core::BOOL;
...
pub type GetNextDlgGroupItem = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, hctl: super::super::Foundation::HWND, bprevious: windows_sys::core::BOOL) -> super::super::Foundation::HWND;
...
pub type GetNextDlgTabItem = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, hctl: super::super::Foundation::HWND, bprevious: windows_sys::core::BOOL) -> super::super::Foundation::HWND;
...
pub type GetParent = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> super::super::Foundation::HWND;
windows_link::link!("user32.dll" "system" fn GetParent(hwnd : super::super::Foundation::HWND) -> super::super::Foundation::HWND);
pub type GetPhysicalCursorPos = unsafe extern "system" fn(lppoint: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
...
pub type GetProcessDefaultLayout = unsafe extern "system" fn(pdwdefaultlayout: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn GetProcessDefaultLayout(pdwdefaultlayout : *mut u32) -> windows_sys::core::BOOL);
pub type GetPropA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpstring: windows_sys::core::PCSTR) -> super::super::Foundation::HANDLE;
...
pub type GetPropW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpstring: windows_sys::core::PCWSTR) -> super::super::Foundation::HANDLE;
...
pub type GetQueueStatus = unsafe extern "system" fn(flags: QUEUE_STATUS_FLAGS) -> u32;
windows_link::link!("user32.dll" "system" fn GetQueueStatus(flags : QUEUE_STATUS_FLAGS) -> u32);
pub type GetScrollBarInfo = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, idobject: OBJECT_IDENTIFIER, psbi: *mut SCROLLBARINFO) -> windows_sys::core::BOOL;
...
pub type GetScrollInfo = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nbar: SCROLLBAR_CONSTANTS, lpsi: *mut SCROLLINFO) -> windows_sys::core::BOOL;
...
pub type GetScrollPos = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nbar: SCROLLBAR_CONSTANTS) -> i32;
windows_link::link!("user32.dll" "system" fn GetScrollPos(hwnd : super::super::Foundation::HWND, nbar : SCROLLBAR_CONSTANTS) -> i32);
pub type GetScrollRange = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nbar: SCROLLBAR_CONSTANTS, lpminpos: *mut i32, lpmaxpos: *mut i32) -> windows_sys::core::BOOL;
...
pub type GetShellWindow = unsafe extern "system" fn() -> super::super::Foundation::HWND;
windows_link::link!("user32.dll" "system" fn GetShellWindow() -> super::super::Foundation::HWND);
pub type GetSubMenu = unsafe extern "system" fn(hmenu: HMENU, npos: i32) -> HMENU;
windows_link::link!("user32.dll" "system" fn GetSubMenu(hmenu : HMENU, npos : i32) -> HMENU);
pub type GetSystemMenu = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, brevert: windows_sys::core::BOOL) -> HMENU;
...
pub type GetSystemMetrics = unsafe extern "system" fn(nindex: SYSTEM_METRICS_INDEX) -> i32;
windows_link::link!("user32.dll" "system" fn GetSystemMetrics(nindex : SYSTEM_METRICS_INDEX) -> i32);
pub type GetTitleBarInfo = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, pti: *mut TITLEBARINFO) -> windows_sys::core::BOOL;
...
pub type GetTopWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> super::super::Foundation::HWND;
windows_link::link!("user32.dll" "system" fn GetTopWindow(hwnd : super::super::Foundation::HWND) -> super::super::Foundation::HWND);
pub type GetWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, ucmd: GET_WINDOW_CMD) -> super::super::Foundation::HWND;
...
pub type GetWindowDisplayAffinity = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, pdwaffinity: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetWindowInfo = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, pwi: *mut WINDOWINFO) -> windows_sys::core::BOOL;
...
pub type GetWindowLongA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: WINDOW_LONG_PTR_INDEX) -> i32;
windows_link::link!("user32.dll" "system" fn GetWindowLongA(hwnd : super::super::Foundation::HWND, nindex : WINDOW_LONG_PTR_INDEX) -> i32);
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
pub type GetWindowLongPtrA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: WINDOW_LONG_PTR_INDEX) -> isize;
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
...
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
pub type GetWindowLongPtrW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: WINDOW_LONG_PTR_INDEX) -> isize;
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
...
pub type GetWindowLongW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: WINDOW_LONG_PTR_INDEX) -> i32;
windows_link::link!("user32.dll" "system" fn GetWindowLongW(hwnd : super::super::Foundation::HWND, nindex : WINDOW_LONG_PTR_INDEX) -> i32);
pub type GetWindowModuleFileNameA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, pszfilename: windows_sys::core::PSTR, cchfilenamemax: u32) -> u32;
...
pub type GetWindowModuleFileNameW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, pszfilename: windows_sys::core::PWSTR, cchfilenamemax: u32) -> u32;
...
pub type GetWindowPlacement = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpwndpl: *mut WINDOWPLACEMENT) -> windows_sys::core::BOOL;
...
pub type GetWindowRect = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lprect: *mut super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
pub type GetWindowTextA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpstring: windows_sys::core::PSTR, nmaxcount: i32) -> i32;
...
pub type GetWindowTextLengthA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> i32;
windows_link::link!("user32.dll" "system" fn GetWindowTextLengthA(hwnd : super::super::Foundation::HWND) -> i32);
pub type GetWindowTextLengthW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> i32;
windows_link::link!("user32.dll" "system" fn GetWindowTextLengthW(hwnd : super::super::Foundation::HWND) -> i32);
pub type GetWindowTextW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpstring: windows_sys::core::PWSTR, nmaxcount: i32) -> i32;
...
pub type GetWindowThreadProcessId = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpdwprocessid: *mut u32) -> u32;
...
pub type GetWindowWord = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: i32) -> u16;
windows_link::link!("user32.dll" "system" fn GetWindowWord(hwnd : super::super::Foundation::HWND, nindex : i32) -> u16);
pub type HideCaret = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn HideCaret(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type HiliteMenuItem = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hmenu: HMENU, uidhiliteitem: u32, uhilite: u32) -> windows_sys::core::BOOL;
...
pub type InSendMessage = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn InSendMessage() -> windows_sys::core::BOOL);
pub type InSendMessageEx = unsafe extern "system" fn(lpreserved: *const core::ffi::c_void) -> u32;
windows_link::link!("user32.dll" "system" fn InSendMessageEx(lpreserved : *const core::ffi::c_void) -> u32);
pub type IndexFilePath = unsafe extern "system" fn(resourceindexer: *const core::ffi::c_void, filepath: windows_sys::core::PCWSTR, ppresourceuri: *mut windows_sys::core::PWSTR, pqualifiercount: *mut u32, ppqualifiers: *mut *mut IndexedResourceQualifier) -> windows_sys::core::HRESULT;
...
pub type InheritWindowMonitor = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hwndinherit: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
...
pub type InsertMenuA = unsafe extern "system" fn(hmenu: HMENU, uposition: u32, uflags: MENU_ITEM_FLAGS, uidnewitem: usize, lpnewitem: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type InsertMenuItemA = unsafe extern "system" fn(hmenu: HMENU, item: u32, fbyposition: windows_sys::core::BOOL, lpmi: *const MENUITEMINFOA) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type InsertMenuItemW = unsafe extern "system" fn(hmenu: HMENU, item: u32, fbyposition: windows_sys::core::BOOL, lpmi: *const MENUITEMINFOW) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type InsertMenuW = unsafe extern "system" fn(hmenu: HMENU, uposition: u32, uflags: MENU_ITEM_FLAGS, uidnewitem: usize, lpnewitem: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type InternalGetWindowText = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, pstring: windows_sys::core::PWSTR, cchmaxcount: i32) -> i32;
...
pub type IsCharAlphaA = unsafe extern "system" fn(ch: i8) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsCharAlphaA(ch : i8) -> windows_sys::core::BOOL);
pub type IsCharAlphaNumericA = unsafe extern "system" fn(ch: i8) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsCharAlphaNumericA(ch : i8) -> windows_sys::core::BOOL);
pub type IsCharAlphaNumericW = unsafe extern "system" fn(ch: u16) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsCharAlphaNumericW(ch : u16) -> windows_sys::core::BOOL);
pub type IsCharAlphaW = unsafe extern "system" fn(ch: u16) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsCharAlphaW(ch : u16) -> windows_sys::core::BOOL);
pub type IsCharLowerA = unsafe extern "system" fn(ch: i8) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsCharLowerA(ch : i8) -> windows_sys::core::BOOL);
pub type IsCharLowerW = unsafe extern "system" fn(ch: u16) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsCharLowerW(ch : u16) -> windows_sys::core::BOOL);
pub type IsCharUpperA = unsafe extern "system" fn(ch: i8) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsCharUpperA(ch : i8) -> windows_sys::core::BOOL);
pub type IsCharUpperW = unsafe extern "system" fn(ch: u16) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsCharUpperW(ch : u16) -> windows_sys::core::BOOL);
pub type IsChild = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
...
pub type IsDialogMessageA = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, lpmsg: *const MSG) -> windows_sys::core::BOOL;
...
pub type IsDialogMessageW = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, lpmsg: *const MSG) -> windows_sys::core::BOOL;
...
pub type IsGUIThread = unsafe extern "system" fn(bconvert: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsGUIThread(bconvert : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type IsHungAppWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsHungAppWindow(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type IsIconic = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsIconic(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type IsInterceptWindow = unsafe extern "system" fn(toplevelwindow: super::super::Foundation::HWND, isintercept: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type IsMenu = unsafe extern "system" fn(hmenu: HMENU) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsMenu(hmenu : HMENU) -> windows_sys::core::BOOL);
pub type IsProcessDPIAware = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsProcessDPIAware() -> windows_sys::core::BOOL);
pub type IsWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsWindow(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type IsWindowArranged = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsWindowArranged(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type IsWindowUnicode = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsWindowUnicode(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type IsWindowVisible = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsWindowVisible(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type IsWow64Message = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsWow64Message() -> windows_sys::core::BOOL);
pub type IsZoomed = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsZoomed(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type KillTimer = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, uidevent: usize) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn KillTimer(hwnd : super::super::Foundation::HWND, uidevent : usize) -> windows_sys::core::BOOL);
pub type LoadAcceleratorsA = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lptablename: windows_sys::core::PCSTR) -> HACCEL;
...
pub type LoadAcceleratorsW = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lptablename: windows_sys::core::PCWSTR) -> HACCEL;
...
pub type LoadCursorA = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lpcursorname: windows_sys::core::PCSTR) -> HCURSOR;
...
pub type LoadCursorFromFileA = unsafe extern "system" fn(lpfilename: windows_sys::core::PCSTR) -> HCURSOR;
windows_link::link!("user32.dll" "system" fn LoadCursorFromFileA(lpfilename : windows_sys::core::PCSTR) -> HCURSOR);
pub type LoadCursorFromFileW = unsafe extern "system" fn(lpfilename: windows_sys::core::PCWSTR) -> HCURSOR;
windows_link::link!("user32.dll" "system" fn LoadCursorFromFileW(lpfilename : windows_sys::core::PCWSTR) -> HCURSOR);
pub type LoadCursorW = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lpcursorname: windows_sys::core::PCWSTR) -> HCURSOR;
...
pub type LoadIconA = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lpiconname: windows_sys::core::PCSTR) -> HICON;
...
pub type LoadIconW = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lpiconname: windows_sys::core::PCWSTR) -> HICON;
...
pub type LoadImageA = unsafe extern "system" fn(hinst: super::super::Foundation::HINSTANCE, name: windows_sys::core::PCSTR, r#type: GDI_IMAGE_TYPE, cx: i32, cy: i32, fuload: IMAGE_FLAGS) -> super::super::Foundation::HANDLE;
...
pub type LoadImageW = unsafe extern "system" fn(hinst: super::super::Foundation::HINSTANCE, name: windows_sys::core::PCWSTR, r#type: GDI_IMAGE_TYPE, cx: i32, cy: i32, fuload: IMAGE_FLAGS) -> super::super::Foundation::HANDLE;
...
pub type LoadMenuA = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lpmenuname: windows_sys::core::PCSTR) -> HMENU;
...
pub type LoadMenuIndirectA = unsafe extern "system" fn(lpmenutemplate: *const core::ffi::c_void) -> HMENU;
windows_link::link!("user32.dll" "system" fn LoadMenuIndirectA(lpmenutemplate : *const core::ffi::c_void) -> HMENU);
pub type LoadMenuIndirectW = unsafe extern "system" fn(lpmenutemplate: *const core::ffi::c_void) -> HMENU;
windows_link::link!("user32.dll" "system" fn LoadMenuIndirectW(lpmenutemplate : *const core::ffi::c_void) -> HMENU);
pub type LoadMenuW = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lpmenuname: windows_sys::core::PCWSTR) -> HMENU;
...
pub type LoadStringA = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, uid: u32, lpbuffer: windows_sys::core::PSTR, cchbuffermax: i32) -> i32;
...
pub type LoadStringW = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, uid: u32, lpbuffer: windows_sys::core::PWSTR, cchbuffermax: i32) -> i32;
...
pub type LockSetForegroundWindow = unsafe extern "system" fn(ulockcode: FOREGROUND_WINDOW_LOCK_CODE) -> windows_sys::core::BOOL;
...
pub type LogicalToPhysicalPoint = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lppoint: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
...
pub type LookupIconIdFromDirectory = unsafe extern "system" fn(presbits: *const u8, ficon: windows_sys::core::BOOL) -> i32;
windows_link::link!("user32.dll" "system" fn LookupIconIdFromDirectory(presbits : *const u8, ficon : windows_sys::core::BOOL) -> i32);
pub type LookupIconIdFromDirectoryEx = unsafe extern "system" fn(presbits: *const u8, ficon: windows_sys::core::BOOL, cxdesired: i32, cydesired: i32, flags: IMAGE_FLAGS) -> i32;
...
pub type MapDialogRect = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, lprect: *mut super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
pub type MenuItemFromPoint = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hmenu: HMENU, ptscreen: super::super::Foundation::POINT) -> i32;
...
pub type MessageBoxA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lptext: windows_sys::core::PCSTR, lpcaption: windows_sys::core::PCSTR, utype: MESSAGEBOX_STYLE) -> MESSAGEBOX_RESULT;
...
pub type MessageBoxExA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lptext: windows_sys::core::PCSTR, lpcaption: windows_sys::core::PCSTR, utype: MESSAGEBOX_STYLE, wlanguageid: u16) -> MESSAGEBOX_RESULT;
...
pub type MessageBoxExW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lptext: windows_sys::core::PCWSTR, lpcaption: windows_sys::core::PCWSTR, utype: MESSAGEBOX_STYLE, wlanguageid: u16) -> MESSAGEBOX_RESULT;
...
pub type MessageBoxIndirectA = unsafe extern "system" fn(lpmbp: *const MSGBOXPARAMSA) -> MESSAGEBOX_RESULT;
#[cfg(feature = "Win32_UI_Shell")]
windows_link::link!("user32.dll" "system" fn MessageBoxIndirectA(lpmbp : *const MSGBOXPARAMSA) -> MESSAGEBOX_RESULT);
#[cfg(feature = "Win32_UI_Shell")]
pub type MessageBoxIndirectW = unsafe extern "system" fn(lpmbp: *const MSGBOXPARAMSW) -> MESSAGEBOX_RESULT;
#[cfg(feature = "Win32_UI_Shell")]
windows_link::link!("user32.dll" "system" fn MessageBoxIndirectW(lpmbp : *const MSGBOXPARAMSW) -> MESSAGEBOX_RESULT);
pub type MessageBoxW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lptext: windows_sys::core::PCWSTR, lpcaption: windows_sys::core::PCWSTR, utype: MESSAGEBOX_STYLE) -> MESSAGEBOX_RESULT;
...
pub type ModifyMenuA = unsafe extern "system" fn(hmnu: HMENU, uposition: u32, uflags: MENU_ITEM_FLAGS, uidnewitem: usize, lpnewitem: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type ModifyMenuW = unsafe extern "system" fn(hmnu: HMENU, uposition: u32, uflags: MENU_ITEM_FLAGS, uidnewitem: usize, lpnewitem: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type MoveWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, x: i32, y: i32, nwidth: i32, nheight: i32, brepaint: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type MrmCreateConfig = unsafe extern "system" fn(platformversion: MrmPlatformVersion, defaultqualifiers: windows_sys::core::PCWSTR, outputxmlfile: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type MrmCreateConfigInMemory = unsafe extern "system" fn(platformversion: MrmPlatformVersion, defaultqualifiers: windows_sys::core::PCWSTR, outputxmldata: *mut *mut u8, outputxmlsize: *mut u32) -> windows_sys::core::HRESULT;
...
pub type MrmCreateResourceFile = unsafe extern "system" fn(indexer: MrmResourceIndexerHandle, packagingmode: MrmPackagingMode, packagingoptions: MrmPackagingOptions, outputdirectory: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type MrmCreateResourceFileInMemory = unsafe extern "system" fn(indexer: MrmResourceIndexerHandle, packagingmode: MrmPackagingMode, packagingoptions: MrmPackagingOptions, outputpridata: *mut *mut u8, outputprisize: *mut u32) -> windows_sys::core::HRESULT;
...
pub type MrmCreateResourceFileWithChecksum = unsafe extern "system" fn(indexer: MrmResourceIndexerHandle, packagingmode: MrmPackagingMode, packagingoptions: MrmPackagingOptions, checksum: u32, outputdirectory: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type MrmCreateResourceIndexer = unsafe extern "system" fn(packagefamilyname: windows_sys::core::PCWSTR, projectroot: windows_sys::core::PCWSTR, platformversion: MrmPlatformVersion, defaultqualifiers: windows_sys::core::PCWSTR, indexer: *mut MrmResourceIndexerHandle) -> windows_sys::core::HRESULT;
...
pub type MrmCreateResourceIndexerFromPreviousPriData = unsafe extern "system" fn(projectroot: windows_sys::core::PCWSTR, platformversion: MrmPlatformVersion, defaultqualifiers: windows_sys::core::PCWSTR, pridata: *const u8, prisize: u32, indexer: *mut MrmResourceIndexerHandle) -> windows_sys::core::HRESULT;
...
pub type MrmCreateResourceIndexerFromPreviousPriFile = unsafe extern "system" fn(projectroot: windows_sys::core::PCWSTR, platformversion: MrmPlatformVersion, defaultqualifiers: windows_sys::core::PCWSTR, prifile: windows_sys::core::PCWSTR, indexer: *mut MrmResourceIndexerHandle) -> windows_sys::core::HRESULT;
...
pub type MrmCreateResourceIndexerFromPreviousSchemaData = unsafe extern "system" fn(projectroot: windows_sys::core::PCWSTR, platformversion: MrmPlatformVersion, defaultqualifiers: windows_sys::core::PCWSTR, schemaxmldata: *const u8, schemaxmlsize: u32, indexer: *mut MrmResourceIndexerHandle) -> windows_sys::core::HRESULT;
...
pub type MrmCreateResourceIndexerFromPreviousSchemaFile = unsafe extern "system" fn(projectroot: windows_sys::core::PCWSTR, platformversion: MrmPlatformVersion, defaultqualifiers: windows_sys::core::PCWSTR, schemafile: windows_sys::core::PCWSTR, indexer: *mut MrmResourceIndexerHandle) -> windows_sys::core::HRESULT;
...
pub type MrmCreateResourceIndexerWithFlags = unsafe extern "system" fn(packagefamilyname: windows_sys::core::PCWSTR, projectroot: windows_sys::core::PCWSTR, platformversion: MrmPlatformVersion, defaultqualifiers: windows_sys::core::PCWSTR, flags: MrmIndexerFlags, indexer: *mut MrmResourceIndexerHandle) -> windows_sys::core::HRESULT;
...
pub type MrmDestroyIndexerAndMessages = unsafe extern "system" fn(indexer: MrmResourceIndexerHandle) -> windows_sys::core::HRESULT;
...
pub type MrmDumpPriDataInMemory = unsafe extern "system" fn(inputpridata: *const u8, inputprisize: u32, schemapridata: *const u8, schemaprisize: u32, dumptype: MrmDumpType, outputxmldata: *mut *mut u8, outputxmlsize: *mut u32) -> windows_sys::core::HRESULT;
...
pub type MrmDumpPriFile = unsafe extern "system" fn(indexfilename: windows_sys::core::PCWSTR, schemaprifile: windows_sys::core::PCWSTR, dumptype: MrmDumpType, outputxmlfile: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type MrmDumpPriFileInMemory = unsafe extern "system" fn(indexfilename: windows_sys::core::PCWSTR, schemaprifile: windows_sys::core::PCWSTR, dumptype: MrmDumpType, outputxmldata: *mut *mut u8, outputxmlsize: *mut u32) -> windows_sys::core::HRESULT;
...
pub type MrmFreeMemory = unsafe extern "system" fn(data: *const u8) -> windows_sys::core::HRESULT;
windows_link::link!("mrmsupport.dll" "system" fn MrmFreeMemory(data : *const u8) -> windows_sys::core::HRESULT);
pub type MrmGetPriFileContentChecksum = unsafe extern "system" fn(prifile: windows_sys::core::PCWSTR, checksum: *mut u32) -> windows_sys::core::HRESULT;
...
pub type MrmIndexEmbeddedData = unsafe extern "system" fn(indexer: MrmResourceIndexerHandle, resourceuri: windows_sys::core::PCWSTR, embeddeddata: *const u8, embeddeddatasize: u32, qualifiers: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type MrmIndexFile = unsafe extern "system" fn(indexer: MrmResourceIndexerHandle, resourceuri: windows_sys::core::PCWSTR, filepath: windows_sys::core::PCWSTR, qualifiers: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type MrmIndexFileAutoQualifiers = unsafe extern "system" fn(indexer: MrmResourceIndexerHandle, filepath: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type MrmIndexResourceContainerAutoQualifiers = unsafe extern "system" fn(indexer: MrmResourceIndexerHandle, containerpath: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type MrmIndexString = unsafe extern "system" fn(indexer: MrmResourceIndexerHandle, resourceuri: windows_sys::core::PCWSTR, resourcestring: windows_sys::core::PCWSTR, qualifiers: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type MrmPeekResourceIndexerMessages = unsafe extern "system" fn(handle: MrmResourceIndexerHandle, messages: *mut *mut MrmResourceIndexerMessage, nummsgs: *mut u32) -> windows_sys::core::HRESULT;
...
pub type MsgWaitForMultipleObjects = unsafe extern "system" fn(ncount: u32, phandles: *const super::super::Foundation::HANDLE, fwaitall: windows_sys::core::BOOL, dwmilliseconds: u32, dwwakemask: QUEUE_STATUS_FLAGS) -> super::super::Foundation::WAIT_EVENT;
...
pub type MsgWaitForMultipleObjectsEx = unsafe extern "system" fn(ncount: u32, phandles: *const super::super::Foundation::HANDLE, dwmilliseconds: u32, dwwakemask: QUEUE_STATUS_FLAGS, dwflags: MSG_WAIT_FOR_MULTIPLE_OBJECTS_EX_FLAGS) -> super::super::Foundation::WAIT_EVENT;
...
pub type OemToCharA = unsafe extern "system" fn(psrc: windows_sys::core::PCSTR, pdst: windows_sys::core::PSTR) -> windows_sys::core::BOOL;
...
pub type OemToCharBuffA = unsafe extern "system" fn(lpszsrc: windows_sys::core::PCSTR, lpszdst: windows_sys::core::PSTR, cchdstlength: u32) -> windows_sys::core::BOOL;
...
pub type OemToCharBuffW = unsafe extern "system" fn(lpszsrc: windows_sys::core::PCSTR, lpszdst: windows_sys::core::PWSTR, cchdstlength: u32) -> windows_sys::core::BOOL;
...
pub type OemToCharW = unsafe extern "system" fn(psrc: windows_sys::core::PCSTR, pdst: windows_sys::core::PWSTR) -> windows_sys::core::BOOL;
...
pub type OpenIcon = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn OpenIcon(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type PeekMessageA = unsafe extern "system" fn(lpmsg: *mut MSG, hwnd: super::super::Foundation::HWND, wmsgfiltermin: u32, wmsgfiltermax: u32, wremovemsg: PEEK_MESSAGE_REMOVE_TYPE) -> windows_sys::core::BOOL;
...
pub type PeekMessageW = unsafe extern "system" fn(lpmsg: *mut MSG, hwnd: super::super::Foundation::HWND, wmsgfiltermin: u32, wmsgfiltermax: u32, wremovemsg: PEEK_MESSAGE_REMOVE_TYPE) -> windows_sys::core::BOOL;
...
pub type PhysicalToLogicalPoint = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lppoint: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
...
pub type PostMessageA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
pub type PostMessageW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
pub type PostQuitMessage = unsafe extern "system" fn(nexitcode: i32);
windows_link::link!("user32.dll" "system" fn PostQuitMessage(nexitcode : i32));
pub type PostThreadMessageA = unsafe extern "system" fn(idthread: u32, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
pub type PostThreadMessageW = unsafe extern "system" fn(idthread: u32, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
pub type PrivateExtractIconsA = unsafe extern "system" fn(szfilename: windows_sys::core::PCSTR, niconindex: i32, cxicon: i32, cyicon: i32, phicon: *mut HICON, piconid: *mut u32, nicons: u32, flags: u32) -> u32;
...
pub type PrivateExtractIconsW = unsafe extern "system" fn(szfilename: windows_sys::core::PCWSTR, niconindex: i32, cxicon: i32, cyicon: i32, phicon: *mut HICON, piconid: *mut u32, nicons: u32, flags: u32) -> u32;
...
pub type RealChildWindowFromPoint = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, ptparentclientcoords: super::super::Foundation::POINT) -> super::super::Foundation::HWND;
...
pub type RealGetWindowClassA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, ptszclassname: windows_sys::core::PSTR, cchclassnamemax: u32) -> u32;
...
pub type RealGetWindowClassW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, ptszclassname: windows_sys::core::PWSTR, cchclassnamemax: u32) -> u32;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type RegisterClassA = unsafe extern "system" fn(lpwndclass: *const WNDCLASSA) -> u16;
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("user32.dll" "system" fn RegisterClassA(lpwndclass : *const WNDCLASSA) -> u16);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type RegisterClassExA = unsafe extern "system" fn(param0: *const WNDCLASSEXA) -> u16;
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("user32.dll" "system" fn RegisterClassExA(param0 : *const WNDCLASSEXA) -> u16);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type RegisterClassExW = unsafe extern "system" fn(param0: *const WNDCLASSEXW) -> u16;
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("user32.dll" "system" fn RegisterClassExW(param0 : *const WNDCLASSEXW) -> u16);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type RegisterClassW = unsafe extern "system" fn(lpwndclass: *const WNDCLASSW) -> u16;
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("user32.dll" "system" fn RegisterClassW(lpwndclass : *const WNDCLASSW) -> u16);
pub type RegisterCloakedNotification = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, fregister: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type RegisterDeviceNotificationA = unsafe extern "system" fn(hrecipient: super::super::Foundation::HANDLE, notificationfilter: *const core::ffi::c_void, flags: REGISTER_NOTIFICATION_FLAGS) -> HDEVNOTIFY;
...
pub type RegisterDeviceNotificationW = unsafe extern "system" fn(hrecipient: super::super::Foundation::HANDLE, notificationfilter: *const core::ffi::c_void, flags: REGISTER_NOTIFICATION_FLAGS) -> HDEVNOTIFY;
...
pub type RegisterForTooltipDismissNotification = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, tdflags: TOOLTIP_DISMISS_FLAGS) -> windows_sys::core::BOOL;
...
pub type RegisterShellHookWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn RegisterShellHookWindow(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type RegisterWindowMessageA = unsafe extern "system" fn(lpstring: windows_sys::core::PCSTR) -> u32;
windows_link::link!("user32.dll" "system" fn RegisterWindowMessageA(lpstring : windows_sys::core::PCSTR) -> u32);
pub type RegisterWindowMessageW = unsafe extern "system" fn(lpstring: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("user32.dll" "system" fn RegisterWindowMessageW(lpstring : windows_sys::core::PCWSTR) -> u32);
pub type RemoveMenu = unsafe extern "system" fn(hmenu: HMENU, uposition: u32, uflags: MENU_ITEM_FLAGS) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn RemoveMenu(hmenu : HMENU, uposition : u32, uflags : MENU_ITEM_FLAGS) -> windows_sys::core::BOOL);
pub type RemovePropA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpstring: windows_sys::core::PCSTR) -> super::super::Foundation::HANDLE;
...
pub type RemovePropW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpstring: windows_sys::core::PCWSTR) -> super::super::Foundation::HANDLE;
...
pub type ReplyMessage = unsafe extern "system" fn(lresult: super::super::Foundation::LRESULT) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn ReplyMessage(lresult : super::super::Foundation::LRESULT) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type ScrollDC = unsafe extern "system" fn(hdc: super::super::Graphics::Gdi::HDC, dx: i32, dy: i32, lprcscroll: *const super::super::Foundation::RECT, lprcclip: *const super::super::Foundation::RECT, hrgnupdate: super::super::Graphics::Gdi::HRGN, lprcupdate: *mut super::super::Foundation::RECT) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type ScrollWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, xamount: i32, yamount: i32, lprect: *const super::super::Foundation::RECT, lpcliprect: *const super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type ScrollWindowEx = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, dx: i32, dy: i32, prcscroll: *const super::super::Foundation::RECT, prcclip: *const super::super::Foundation::RECT, hrgnupdate: super::super::Graphics::Gdi::HRGN, prcupdate: *mut super::super::Foundation::RECT, flags: SCROLL_WINDOW_FLAGS) -> i32;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type SendDlgItemMessageA = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, niddlgitem: i32, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> super::super::Foundation::LRESULT;
...
pub type SendDlgItemMessageW = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, niddlgitem: i32, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> super::super::Foundation::LRESULT;
...
pub type SendMessageA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> super::super::Foundation::LRESULT;
...
pub type SendMessageCallbackA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM, lpresultcallback: SENDASYNCPROC, dwdata: usize) -> windows_sys::core::BOOL;
...
pub type SendMessageCallbackW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM, lpresultcallback: SENDASYNCPROC, dwdata: usize) -> windows_sys::core::BOOL;
...
pub type SendMessageTimeoutA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM, fuflags: SEND_MESSAGE_TIMEOUT_FLAGS, utimeout: u32, lpdwresult: *mut usize) -> super::super::Foundation::LRESULT;
...
pub type SendMessageTimeoutW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM, fuflags: SEND_MESSAGE_TIMEOUT_FLAGS, utimeout: u32, lpdwresult: *mut usize) -> super::super::Foundation::LRESULT;
...
pub type SendMessageW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> super::super::Foundation::LRESULT;
...
pub type SendNotifyMessageA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
pub type SendNotifyMessageW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
pub type SetAdditionalForegroundBoostProcesses = unsafe extern "system" fn(toplevelwindow: super::super::Foundation::HWND, processhandlecount: u32, processhandlearray: *const super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
...
pub type SetCaretBlinkTime = unsafe extern "system" fn(umseconds: u32) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn SetCaretBlinkTime(umseconds : u32) -> windows_sys::core::BOOL);
pub type SetCaretPos = unsafe extern "system" fn(x: i32, y: i32) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn SetCaretPos(x : i32, y : i32) -> windows_sys::core::BOOL);
pub type SetClassLongA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: GET_CLASS_LONG_INDEX, dwnewlong: i32) -> u32;
...
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
pub type SetClassLongPtrA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: GET_CLASS_LONG_INDEX, dwnewlong: isize) -> usize;
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
...
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
pub type SetClassLongPtrW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: GET_CLASS_LONG_INDEX, dwnewlong: isize) -> usize;
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
...
pub type SetClassLongW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: GET_CLASS_LONG_INDEX, dwnewlong: i32) -> u32;
...
pub type SetClassWord = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: i32, wnewword: u16) -> u16;
windows_link::link!("user32.dll" "system" fn SetClassWord(hwnd : super::super::Foundation::HWND, nindex : i32, wnewword : u16) -> u16);
pub type SetCoalescableTimer = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nidevent: usize, uelapse: u32, lptimerfunc: TIMERPROC, utolerancedelay: u32) -> usize;
...
pub type SetCursor = unsafe extern "system" fn(hcursor: HCURSOR) -> HCURSOR;
windows_link::link!("user32.dll" "system" fn SetCursor(hcursor : HCURSOR) -> HCURSOR);
pub type SetCursorPos = unsafe extern "system" fn(x: i32, y: i32) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn SetCursorPos(x : i32, y : i32) -> windows_sys::core::BOOL);
pub type SetDebugErrorLevel = unsafe extern "system" fn(dwlevel: u32);
windows_link::link!("user32.dll" "system" fn SetDebugErrorLevel(dwlevel : u32));
pub type SetDlgItemInt = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, niddlgitem: i32, uvalue: u32, bsigned: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type SetDlgItemTextA = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, niddlgitem: i32, lpstring: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type SetDlgItemTextW = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, niddlgitem: i32, lpstring: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SetForegroundWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn SetForegroundWindow(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type SetLayeredWindowAttributes = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, crkey: super::super::Foundation::COLORREF, balpha: u8, dwflags: LAYERED_WINDOW_ATTRIBUTES_FLAGS) -> windows_sys::core::BOOL;
...
pub type SetMenu = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hmenu: HMENU) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn SetMenu(hwnd : super::super::Foundation::HWND, hmenu : HMENU) -> windows_sys::core::BOOL);
pub type SetMenuDefaultItem = unsafe extern "system" fn(hmenu: HMENU, uitem: u32, fbypos: u32) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn SetMenuDefaultItem(hmenu : HMENU, uitem : u32, fbypos : u32) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type SetMenuInfo = unsafe extern "system" fn(param0: HMENU, param1: *const MENUINFO) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("user32.dll" "system" fn SetMenuInfo(param0 : HMENU, param1 : *const MENUINFO) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type SetMenuItemBitmaps = unsafe extern "system" fn(hmenu: HMENU, uposition: u32, uflags: MENU_ITEM_FLAGS, hbitmapunchecked: super::super::Graphics::Gdi::HBITMAP, hbitmapchecked: super::super::Graphics::Gdi::HBITMAP) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type SetMenuItemInfoA = unsafe extern "system" fn(hmenu: HMENU, item: u32, fbypositon: windows_sys::core::BOOL, lpmii: *const MENUITEMINFOA) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type SetMenuItemInfoW = unsafe extern "system" fn(hmenu: HMENU, item: u32, fbypositon: windows_sys::core::BOOL, lpmii: *const MENUITEMINFOW) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type SetMessageExtraInfo = unsafe extern "system" fn(lparam: super::super::Foundation::LPARAM) -> super::super::Foundation::LPARAM;
...
pub type SetMessageQueue = unsafe extern "system" fn(cmessagesmax: i32) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn SetMessageQueue(cmessagesmax : i32) -> windows_sys::core::BOOL);
pub type SetParent = unsafe extern "system" fn(hwndchild: super::super::Foundation::HWND, hwndnewparent: super::super::Foundation::HWND) -> super::super::Foundation::HWND;
...
pub type SetPhysicalCursorPos = unsafe extern "system" fn(x: i32, y: i32) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn SetPhysicalCursorPos(x : i32, y : i32) -> windows_sys::core::BOOL);
pub type SetProcessDPIAware = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn SetProcessDPIAware() -> windows_sys::core::BOOL);
pub type SetProcessDefaultLayout = unsafe extern "system" fn(dwdefaultlayout: u32) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn SetProcessDefaultLayout(dwdefaultlayout : u32) -> windows_sys::core::BOOL);
pub type SetPropA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpstring: windows_sys::core::PCSTR, hdata: super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
...
pub type SetPropW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpstring: windows_sys::core::PCWSTR, hdata: super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
...
pub type SetSystemCursor = unsafe extern "system" fn(hcur: HCURSOR, id: SYSTEM_CURSOR_ID) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn SetSystemCursor(hcur : HCURSOR, id : SYSTEM_CURSOR_ID) -> windows_sys::core::BOOL);
pub type SetTimer = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nidevent: usize, uelapse: u32, lptimerfunc: TIMERPROC) -> usize;
...
pub type SetWindowDisplayAffinity = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, dwaffinity: WINDOW_DISPLAY_AFFINITY) -> windows_sys::core::BOOL;
...
pub type SetWindowLongA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: WINDOW_LONG_PTR_INDEX, dwnewlong: i32) -> i32;
...
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
pub type SetWindowLongPtrA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: WINDOW_LONG_PTR_INDEX, dwnewlong: isize) -> isize;
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
...
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
pub type SetWindowLongPtrW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: WINDOW_LONG_PTR_INDEX, dwnewlong: isize) -> isize;
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
...
pub type SetWindowLongW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: WINDOW_LONG_PTR_INDEX, dwnewlong: i32) -> i32;
...
pub type SetWindowPlacement = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpwndpl: *const WINDOWPLACEMENT) -> windows_sys::core::BOOL;
...
pub type SetWindowPos = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hwndinsertafter: super::super::Foundation::HWND, x: i32, y: i32, cx: i32, cy: i32, uflags: SET_WINDOW_POS_FLAGS) -> windows_sys::core::BOOL;
...
pub type SetWindowTextA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpstring: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type SetWindowTextW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lpstring: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SetWindowWord = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nindex: i32, wnewword: u16) -> u16;
windows_link::link!("user32.dll" "system" fn SetWindowWord(hwnd : super::super::Foundation::HWND, nindex : i32, wnewword : u16) -> u16);
pub type SetWindowsHookA = unsafe extern "system" fn(nfiltertype: i32, pfnfilterproc: HOOKPROC) -> HHOOK;
windows_link::link!("user32.dll" "system" fn SetWindowsHookA(nfiltertype : i32, pfnfilterproc : HOOKPROC) -> HHOOK);
pub type SetWindowsHookExA = unsafe extern "system" fn(idhook: WINDOWS_HOOK_ID, lpfn: HOOKPROC, hmod: super::super::Foundation::HINSTANCE, dwthreadid: u32) -> HHOOK;
...
pub type SetWindowsHookExW = unsafe extern "system" fn(idhook: WINDOWS_HOOK_ID, lpfn: HOOKPROC, hmod: super::super::Foundation::HINSTANCE, dwthreadid: u32) -> HHOOK;
...
pub type SetWindowsHookW = unsafe extern "system" fn(nfiltertype: i32, pfnfilterproc: HOOKPROC) -> HHOOK;
windows_link::link!("user32.dll" "system" fn SetWindowsHookW(nfiltertype : i32, pfnfilterproc : HOOKPROC) -> HHOOK);
pub type ShowCaret = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn ShowCaret(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type ShowCursor = unsafe extern "system" fn(bshow: windows_sys::core::BOOL) -> i32;
windows_link::link!("user32.dll" "system" fn ShowCursor(bshow : windows_sys::core::BOOL) -> i32);
pub type ShowOwnedPopups = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, fshow: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type ShowWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, ncmdshow: SHOW_WINDOW_CMD) -> windows_sys::core::BOOL;
...
pub type ShowWindowAsync = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, ncmdshow: SHOW_WINDOW_CMD) -> windows_sys::core::BOOL;
...
pub type SoundSentry = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn SoundSentry() -> windows_sys::core::BOOL);
pub type SwitchToThisWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, funknown: windows_sys::core::BOOL);
...
pub type SystemParametersInfoA = unsafe extern "system" fn(uiaction: SYSTEM_PARAMETERS_INFO_ACTION, uiparam: u32, pvparam: *mut core::ffi::c_void, fwinini: SYSTEM_PARAMETERS_INFO_UPDATE_FLAGS) -> windows_sys::core::BOOL;
...
pub type SystemParametersInfoW = unsafe extern "system" fn(uiaction: SYSTEM_PARAMETERS_INFO_ACTION, uiparam: u32, pvparam: *mut core::ffi::c_void, fwinini: SYSTEM_PARAMETERS_INFO_UPDATE_FLAGS) -> windows_sys::core::BOOL;
...
pub type TileWindows = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, whow: TILE_WINDOWS_HOW, lprect: *const super::super::Foundation::RECT, ckids: u32, lpkids: *const super::super::Foundation::HWND) -> u16;
...
pub type TrackPopupMenu = unsafe extern "system" fn(hmenu: HMENU, uflags: TRACK_POPUP_MENU_FLAGS, x: i32, y: i32, nreserved: i32, hwnd: super::super::Foundation::HWND, prcrect: *const super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
pub type TrackPopupMenuEx = unsafe extern "system" fn(hmenu: HMENU, uflags: u32, x: i32, y: i32, hwnd: super::super::Foundation::HWND, lptpm: *const TPMPARAMS) -> windows_sys::core::BOOL;
...
pub type TranslateAcceleratorA = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hacctable: HACCEL, lpmsg: *const MSG) -> i32;
...
pub type TranslateAcceleratorW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hacctable: HACCEL, lpmsg: *const MSG) -> i32;
...
pub type TranslateMDISysAccel = unsafe extern "system" fn(hwndclient: super::super::Foundation::HWND, lpmsg: *const MSG) -> windows_sys::core::BOOL;
...
pub type TranslateMessage = unsafe extern "system" fn(lpmsg: *const MSG) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn TranslateMessage(lpmsg : *const MSG) -> windows_sys::core::BOOL);
pub type UnhookWindowsHook = unsafe extern "system" fn(ncode: i32, pfnfilterproc: HOOKPROC) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn UnhookWindowsHook(ncode : i32, pfnfilterproc : HOOKPROC) -> windows_sys::core::BOOL);
pub type UnhookWindowsHookEx = unsafe extern "system" fn(hhk: HHOOK) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn UnhookWindowsHookEx(hhk : HHOOK) -> windows_sys::core::BOOL);
pub type UnregisterClassA = unsafe extern "system" fn(lpclassname: windows_sys::core::PCSTR, hinstance: super::super::Foundation::HINSTANCE) -> windows_sys::core::BOOL;
...
pub type UnregisterClassW = unsafe extern "system" fn(lpclassname: windows_sys::core::PCWSTR, hinstance: super::super::Foundation::HINSTANCE) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type UpdateLayeredWindowIndirect = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, pulwinfo: *const UPDATELAYEREDWINDOWINFO) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type WaitMessage = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn WaitMessage() -> windows_sys::core::BOOL);
pub type WindowFromPhysicalPoint = unsafe extern "system" fn(point: super::super::Foundation::POINT) -> super::super::Foundation::HWND;
...
pub type WindowFromPoint = unsafe extern "system" fn(point: super::super::Foundation::POINT) -> super::super::Foundation::HWND;
windows_link::link!("user32.dll" "system" fn WindowFromPoint(point : super::super::Foundation::POINT) -> super::super::Foundation::HWND);
pub type wsprintfA = unsafe extern "C" fn(param0: windows_sys::core::PSTR, param1: windows_sys::core::PCSTR, ...) -> i32;
windows_link::link!("user32.dll" "C" fn wsprintfA(param0 : windows_sys::core::PSTR, param1 : windows_sys::core::PCSTR, ...) -> i32);
pub type wsprintfW = unsafe extern "C" fn(param0: windows_sys::core::PWSTR, param1: windows_sys::core::PCWSTR, ...) -> i32;
windows_link::link!("user32.dll" "C" fn wsprintfW(param0 : windows_sys::core::PWSTR, param1 : windows_sys::core::PCWSTR, ...) -> i32);
pub type wvsprintfA = unsafe extern "system" fn(param0: windows_sys::core::PSTR, param1: windows_sys::core::PCSTR, arglist: *const i8) -> i32;
...
pub type wvsprintfW = unsafe extern "system" fn(param0: windows_sys::core::PWSTR, param1: windows_sys::core::PCWSTR, arglist: *const i8) -> i32;
