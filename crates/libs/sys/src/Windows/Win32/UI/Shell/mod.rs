...
pub const AIM_COMMENTS: APPINFODATAFLAGS = 32768;
pub const AIM_CONTACT: APPINFODATAFLAGS = 16384;
pub const AIM_DISPLAYNAME: APPINFODATAFLAGS = 1;
pub const AIM_HELPLINK: APPINFODATAFLAGS = 512;
pub const AIM_IMAGE: APPINFODATAFLAGS = 131072;
pub const AIM_INSTALLDATE: APPINFODATAFLAGS = 4096;
pub const AIM_INSTALLLOCATION: APPINFODATAFLAGS = 1024;
pub const AIM_INSTALLSOURCE: APPINFODATAFLAGS = 2048;
pub const AIM_LANGUAGE: APPINFODATAFLAGS = 64;
pub const AIM_PRODUCTID: APPINFODATAFLAGS = 8;
pub const AIM_PUBLISHER: APPINFODATAFLAGS = 4;
pub const AIM_READMEURL: APPINFODATAFLAGS = 262144;
pub const AIM_REGISTEREDCOMPANY: APPINFODATAFLAGS = 32;
pub const AIM_REGISTEREDOWNER: APPINFODATAFLAGS = 16;
pub const AIM_SUPPORTTELEPHONE: APPINFODATAFLAGS = 256;
pub const AIM_SUPPORTURL: APPINFODATAFLAGS = 128;
pub const AIM_UPDATEINFOURL: APPINFODATAFLAGS = 524288;
pub const AIM_VERSION: APPINFODATAFLAGS = 2;
...
pub const APPACTION_ADDLATER: APPACTIONFLAGS = 256;
pub const APPACTION_CANGETSIZE: APPACTIONFLAGS = 32;
pub const APPACTION_INSTALL: APPACTIONFLAGS = 1;
pub const APPACTION_MODIFY: APPACTIONFLAGS = 4;
pub const APPACTION_MODIFYREMOVE: APPACTIONFLAGS = 128;
pub const APPACTION_REPAIR: APPACTIONFLAGS = 8;
pub const APPACTION_UNINSTALL: APPACTIONFLAGS = 2;
pub const APPACTION_UNSCHEDULE: APPACTIONFLAGS = 512;
pub const APPACTION_UPGRADE: APPACTIONFLAGS = 16;
#[repr(C, packed(1))]
#[cfg(target_arch = "x86")]
#[derive(Clone, Copy)]
...
pub type ASSOCF = u32;
pub const ASSOCF_APP_TO_APP: ASSOCF = 65536;
pub const ASSOCF_IGNOREBASECLASS: ASSOCF = 512;
pub const ASSOCF_INIT_BYEXENAME: ASSOCF = 2;
pub const ASSOCF_INIT_DEFAULTTOFOLDER: ASSOCF = 8;
pub const ASSOCF_INIT_DEFAULTTOSTAR: ASSOCF = 4;
pub const ASSOCF_INIT_FIXED_PROGID: ASSOCF = 2048;
pub const ASSOCF_INIT_FOR_FILE: ASSOCF = 8192;
pub const ASSOCF_INIT_IGNOREUNKNOWN: ASSOCF = 1024;
pub const ASSOCF_INIT_NOREMAPCLSID: ASSOCF = 1;
pub const ASSOCF_IS_FULL_URI: ASSOCF = 16384;
pub const ASSOCF_IS_PROTOCOL: ASSOCF = 4096;
pub const ASSOCF_NOFIXUPS: ASSOCF = 256;
pub const ASSOCF_NONE: ASSOCF = 0;
pub const ASSOCF_NOTRUNCATE: ASSOCF = 32;
pub const ASSOCF_NOUSERSETTINGS: ASSOCF = 16;
pub const ASSOCF_OPEN_BYEXENAME: ASSOCF = 2;
pub const ASSOCF_PER_MACHINE_ONLY: ASSOCF = 32768;
pub const ASSOCF_REMAPRUNDLL: ASSOCF = 128;
pub const ASSOCF_VERIFY: ASSOCF = 64;
#[repr(C, packed(1))]
#[cfg(target_arch = "x86")]
#[cfg(feature = "Win32_System_Registry")]
#[derive(Clone, Copy)]
...
pub const AllowSmallerSize: ThumbnailStreamCacheOptions = 4;
...
pub const BSID_BANDADDED: BANDSITECID = 0;
pub const BSID_BANDREMOVED: BANDSITECID = 1;
...
pub const CDBE_RET_DEFAULT: CDBURNINGEXTENSIONRET = 0;
pub const CDBE_RET_DONTRUNOTHEREXTS: CDBURNINGEXTENSIONRET = 1;
pub const CDBE_RET_STOPWIZARD: CDBURNINGEXTENSIONRET = 2;
...
pub const CPLPAGE_DISPLAY_BACKGROUND: u32 = 1;
pub const CPLPAGE_KEYBOARD_SPEED: u32 = 1;
pub const CPLPAGE_MOUSE_BUTTONS: u32 = 1;
pub const CPLPAGE_MOUSE_PTRMOTION: u32 = 2;
pub const CPLPAGE_MOUSE_WHEEL: u32 = 3;
...
pub const CPL_STARTWPARMS: u32 = 10;
...
pub const DBID_BANDINFOCHANGED: DESKBANDCID = 0;
pub const DBID_DELAYINIT: DESKBANDCID = 4;
pub const DBID_FINISHINIT: DESKBANDCID = 5;
pub const DBID_MAXIMIZEBAND: DESKBANDCID = 2;
pub const DBID_PERMITAUTOHIDE: DESKBANDCID = 7;
pub const DBID_PUSHCHEVRON: DESKBANDCID = 3;
pub const DBID_SETWINDOWTHEME: DESKBANDCID = 6;
pub const DBID_SHOWONLY: DESKBANDCID = 1;
...
pub const DFM_CMD_COPY: DFM_CMD = -3;
pub const DFM_CMD_DELETE: DFM_CMD = -1;
pub const DFM_CMD_LINK: DFM_CMD = -4;
pub const DFM_CMD_MODALPROP: DFM_CMD = -12;
pub const DFM_CMD_MOVE: DFM_CMD = -2;
pub const DFM_CMD_NEWFOLDER: DFM_CMD = -6;
pub const DFM_CMD_PASTE: DFM_CMD = -7;
pub const DFM_CMD_PASTELINK: DFM_CMD = -10;
pub const DFM_CMD_PASTESPECIAL: DFM_CMD = -11;
pub const DFM_CMD_PROPERTIES: DFM_CMD = -5;
pub const DFM_CMD_RENAME: DFM_CMD = -13;
pub const DFM_CMD_VIEWDETAILS: DFM_CMD = -9;
pub const DFM_CMD_VIEWLIST: DFM_CMD = -8;
pub const DFM_GETDEFSTATICID: DFM_MESSAGE_ID = 14;
pub const DFM_GETHELPTEXT: DFM_MESSAGE_ID = 5;
pub const DFM_GETHELPTEXTW: DFM_MESSAGE_ID = 11;
pub const DFM_GETVERBA: DFM_MESSAGE_ID = 16;
pub const DFM_GETVERBW: DFM_MESSAGE_ID = 15;
pub const DFM_INVOKECOMMAND: DFM_MESSAGE_ID = 2;
pub const DFM_INVOKECOMMANDEX: DFM_MESSAGE_ID = 12;
pub const DFM_MAPCOMMANDNAME: DFM_MESSAGE_ID = 13;
pub const DFM_MERGECONTEXTMENU: DFM_MESSAGE_ID = 1;
pub const DFM_MERGECONTEXTMENU_BOTTOM: DFM_MESSAGE_ID = 17;
pub const DFM_MERGECONTEXTMENU_TOP: DFM_MESSAGE_ID = 10;
pub type DFM_MESSAGE_ID = i32;
pub const DFM_MODIFYQCMFLAGS: DFM_MESSAGE_ID = 18;
pub const DFM_VALIDATECMD: DFM_MESSAGE_ID = 9;
pub const DFM_WM_DRAWITEM: DFM_MESSAGE_ID = 7;
pub const DFM_WM_INITMENUPOPUP: DFM_MESSAGE_ID = 8;
pub const DFM_WM_MEASUREITEM: DFM_MESSAGE_ID = 6;
...
pub const ExtractIfNotCached: ThumbnailStreamCacheOptions = 0;
...
pub const FOFX_ADDUNDORECORD: FILEOPERATION_FLAGS = 536870912;
pub const FOFX_COPYASDOWNLOAD: FILEOPERATION_FLAGS = 1073741824;
pub const FOFX_DONTDISPLAYDESTPATH: FILEOPERATION_FLAGS = 134217728;
pub const FOFX_DONTDISPLAYLOCATIONS: FILEOPERATION_FLAGS = 2147483648;
pub const FOFX_DONTDISPLAYSOURCEPATH: FILEOPERATION_FLAGS = 67108864;
pub const FOFX_EARLYFAILURE: FILEOPERATION_FLAGS = 1048576;
pub const FOFX_KEEPNEWERFILE: FILEOPERATION_FLAGS = 4194304;
pub const FOFX_MOVEACLSACROSSVOLUMES: FILEOPERATION_FLAGS = 33554432;
pub const FOFX_NOCOPYHOOKS: FILEOPERATION_FLAGS = 8388608;
pub const FOFX_NOMINIMIZEBOX: FILEOPERATION_FLAGS = 16777216;
pub const FOFX_NOSKIPJUNCTIONS: FILEOPERATION_FLAGS = 65536;
pub const FOFX_PREFERHARDLINK: FILEOPERATION_FLAGS = 131072;
pub const FOFX_PRESERVEFILEEXTENSIONS: FILEOPERATION_FLAGS = 2097152;
pub const FOFX_RECYCLEONDELETE: FILEOPERATION_FLAGS = 524288;
pub const FOFX_REQUIREELEVATION: FILEOPERATION_FLAGS = 268435456;
pub const FOFX_SHOWELEVATIONPROMPT: FILEOPERATION_FLAGS = 262144;
pub const FOF_ALLOWUNDO: FILEOPERATION_FLAGS = 64;
pub const FOF_CONFIRMMOUSE: FILEOPERATION_FLAGS = 2;
pub const FOF_FILESONLY: FILEOPERATION_FLAGS = 128;
pub const FOF_MULTIDESTFILES: FILEOPERATION_FLAGS = 1;
pub const FOF_NOCONFIRMATION: FILEOPERATION_FLAGS = 16;
pub const FOF_NOCONFIRMMKDIR: FILEOPERATION_FLAGS = 512;
pub const FOF_NOCOPYSECURITYATTRIBS: FILEOPERATION_FLAGS = 2048;
pub const FOF_NOERRORUI: FILEOPERATION_FLAGS = 1024;
pub const FOF_NORECURSEREPARSE: FILEOPERATION_FLAGS = 32768;
pub const FOF_NORECURSION: FILEOPERATION_FLAGS = 4096;
pub const FOF_NO_CONNECTED_ELEMENTS: FILEOPERATION_FLAGS = 8192;
pub const FOF_NO_UI: FILEOPERATION_FLAGS = 1556;
pub const FOF_RENAMEONCOLLISION: FILEOPERATION_FLAGS = 8;
pub const FOF_SILENT: FILEOPERATION_FLAGS = 4;
pub const FOF_SIMPLEPROGRESS: FILEOPERATION_FLAGS = 256;
pub const FOF_WANTMAPPINGHANDLE: FILEOPERATION_FLAGS = 32;
pub const FOF_WANTNUKEWARNING: FILEOPERATION_FLAGS = 16384;
...
pub const GPFIDL_ALTNAME: GPFIDL_FLAGS = 1;
pub const GPFIDL_DEFAULT: GPFIDL_FLAGS = 0;
pub type GPFIDL_FLAGS = u32;
pub const GPFIDL_UNCPRINTER: GPFIDL_FLAGS = 2;
...
pub const HLBWIF_DOCWNDMAXIMIZED: HLBWIF_FLAGS = 8;
pub type HLBWIF_FLAGS = i32;
pub const HLBWIF_FRAMEWNDMAXIMIZED: HLBWIF_FLAGS = 4;
pub const HLBWIF_HASDOCWNDINFO: HLBWIF_FLAGS = 2;
pub const HLBWIF_HASFRAMEWNDINFO: HLBWIF_FLAGS = 1;
...
pub const HLID_CURRENT: HLID_INFO = 4294967293;
pub type HLID_INFO = u32;
pub const HLID_INVALID: HLID_INFO = 0;
pub const HLID_NEXT: HLID_INFO = 4294967294;
pub const HLID_PREVIOUS: HLID_INFO = 4294967295;
pub const HLID_STACKBOTTOM: HLID_INFO = 4294967292;
pub const HLID_STACKTOP: HLID_INFO = 4294967291;
...
pub const HLQF_ISCURRENT: HLQF_INFO = 2;
pub const HLQF_ISVALID: HLQF_INFO = 1;
...
pub const HLTB_DOCKEDBOTTOM: HLTB_INFO = 3;
pub const HLTB_DOCKEDLEFT: HLTB_INFO = 0;
pub const HLTB_DOCKEDRIGHT: HLTB_INFO = 2;
pub const HLTB_DOCKEDTOP: HLTB_INFO = 1;
pub const HLTB_FLOATING: HLTB_INFO = 4;
...
pub const ITSS_THREAD_TIMEOUT_NO_CHANGE: u32 = 4294967294;
...
pub const MBHANDCID_PIDLSELECT: MENUBANDHANDLERCID = 0;
...
pub const MM_ADDSEPARATOR: MM_FLAGS = 1;
pub const MM_DONTREMOVESEPS: MM_FLAGS = 4;
pub type MM_FLAGS = u32;
pub const MM_SUBMENUSHAVEIDS: MM_FLAGS = 2;
pub type MONITOR_APP_VISIBILITY = i32;
pub const MPOS_CANCELLEVEL: MENUPOPUPSELECT = 2;
pub const MPOS_CHILDTRACKING: MENUPOPUPSELECT = 5;
pub const MPOS_EXECUTE: MENUPOPUPSELECT = 0;
pub const MPOS_FULLCANCEL: MENUPOPUPSELECT = 1;
pub const MPOS_SELECTLEFT: MENUPOPUPSELECT = 3;
pub const MPOS_SELECTRIGHT: MENUPOPUPSELECT = 4;
pub const MPPF_ALIGN_LEFT: MENUPOPUPPOPUPFLAGS = 33554432;
pub const MPPF_ALIGN_RIGHT: MENUPOPUPPOPUPFLAGS = 67108864;
pub const MPPF_BOTTOM: MENUPOPUPPOPUPFLAGS = -2147483648;
pub const MPPF_FINALSELECT: MENUPOPUPPOPUPFLAGS = 128;
pub const MPPF_FORCEZORDER: MENUPOPUPPOPUPFLAGS = 64;
pub const MPPF_INITIALSELECT: MENUPOPUPPOPUPFLAGS = 2;
pub const MPPF_KEYBOARD: MENUPOPUPPOPUPFLAGS = 16;
pub const MPPF_LEFT: MENUPOPUPPOPUPFLAGS = 1073741824;
pub const MPPF_NOANIMATE: MENUPOPUPPOPUPFLAGS = 4;
pub const MPPF_POS_MASK: MENUPOPUPPOPUPFLAGS = -536870912;
pub const MPPF_REPOSITION: MENUPOPUPPOPUPFLAGS = 32;
pub const MPPF_RIGHT: MENUPOPUPPOPUPFLAGS = 1610612736;
...
pub const NIF_GUID: NOTIFY_ICON_DATA_FLAGS = 32;
pub const NIF_ICON: NOTIFY_ICON_DATA_FLAGS = 2;
pub const NIF_INFO: NOTIFY_ICON_DATA_FLAGS = 16;
pub const NIF_MESSAGE: NOTIFY_ICON_DATA_FLAGS = 1;
pub const NIF_REALTIME: NOTIFY_ICON_DATA_FLAGS = 64;
pub const NIF_SHOWTIP: NOTIFY_ICON_DATA_FLAGS = 128;
pub const NIF_STATE: NOTIFY_ICON_DATA_FLAGS = 8;
pub const NIF_TIP: NOTIFY_ICON_DATA_FLAGS = 4;
pub const NIIF_ERROR: NOTIFY_ICON_INFOTIP_FLAGS = 3;
pub const NIIF_ICON_MASK: NOTIFY_ICON_INFOTIP_FLAGS = 15;
pub const NIIF_INFO: NOTIFY_ICON_INFOTIP_FLAGS = 1;
pub const NIIF_LARGE_ICON: NOTIFY_ICON_INFOTIP_FLAGS = 32;
pub const NIIF_NONE: NOTIFY_ICON_INFOTIP_FLAGS = 0;
pub const NIIF_NOSOUND: NOTIFY_ICON_INFOTIP_FLAGS = 16;
pub const NIIF_RESPECT_QUIET_TIME: NOTIFY_ICON_INFOTIP_FLAGS = 128;
pub const NIIF_USER: NOTIFY_ICON_INFOTIP_FLAGS = 4;
pub const NIIF_WARNING: NOTIFY_ICON_INFOTIP_FLAGS = 2;
pub const NIM_ADD: NOTIFY_ICON_MESSAGE = 0;
pub const NIM_DELETE: NOTIFY_ICON_MESSAGE = 2;
pub const NIM_MODIFY: NOTIFY_ICON_MESSAGE = 1;
pub const NIM_SETFOCUS: NOTIFY_ICON_MESSAGE = 3;
pub const NIM_SETVERSION: NOTIFY_ICON_MESSAGE = 4;
...
pub const NIS_HIDDEN: NOTIFY_ICON_STATE = 1;
pub const NIS_SHAREDICON: NOTIFY_ICON_STATE = 2;
...
pub const OAIF_ALLOW_REGISTRATION: OPEN_AS_INFO_FLAGS = 1;
pub const OAIF_EXEC: OPEN_AS_INFO_FLAGS = 4;
pub const OAIF_FILE_IS_URI: OPEN_AS_INFO_FLAGS = 128;
pub const OAIF_FORCE_REGISTRATION: OPEN_AS_INFO_FLAGS = 8;
pub const OAIF_HIDE_REGISTRATION: OPEN_AS_INFO_FLAGS = 32;
pub const OAIF_REGISTER_EXT: OPEN_AS_INFO_FLAGS = 2;
pub const OAIF_URL_PROTOCOL: OPEN_AS_INFO_FLAGS = 64;
...
pub type OS = u32;
pub const OS_ADVSERVER: OS = 22;
pub const OS_ANYSERVER: OS = 29;
pub const OS_APPLIANCE: OS = 36;
pub const OS_DATACENTER: OS = 21;
pub const OS_DOMAINMEMBER: OS = 28;
pub const OS_EMBEDDED: OS = 13;
pub const OS_FASTUSERSWITCHING: OS = 26;
pub const OS_HOME: OS = 19;
pub const OS_MEDIACENTER: OS = 35;
pub const OS_MEORGREATER: OS = 17;
pub const OS_NT: OS = 1;
pub const OS_NT4ORGREATER: OS = 3;
pub const OS_PERSONALTERMINALSERVER: OS = 25;
pub const OS_PROFESSIONAL: OS = 20;
pub const OS_SERVER: OS = 23;
pub const OS_SERVERADMINUI: OS = 34;
pub const OS_SMALLBUSINESSSERVER: OS = 32;
pub const OS_TABLETPC: OS = 33;
pub const OS_TERMINALCLIENT: OS = 14;
pub const OS_TERMINALREMOTEADMIN: OS = 15;
pub const OS_TERMINALSERVER: OS = 24;
pub const OS_WEBSERVER: OS = 31;
pub const OS_WELCOMELOGONUI: OS = 27;
pub const OS_WIN2000ADVSERVER: OS = 10;
pub const OS_WIN2000DATACENTER: OS = 11;
pub const OS_WIN2000ORGREATER: OS = 7;
pub const OS_WIN2000PRO: OS = 8;
pub const OS_WIN2000SERVER: OS = 9;
pub const OS_WIN2000TERMINAL: OS = 12;
pub const OS_WIN95ORGREATER: OS = 2;
pub const OS_WIN95_GOLD: OS = 16;
pub const OS_WIN98ORGREATER: OS = 5;
pub const OS_WIN98_GOLD: OS = 6;
pub const OS_WINDOWS: OS = 0;
pub const OS_WOW6432: OS = 30;
pub const OS_XPORGREATER: OS = 18;
...
pub const PAI_ASSIGNEDTIME: PUBAPPINFOFLAGS = 2;
pub const PAI_EXPIRETIME: PUBAPPINFOFLAGS = 16;
pub const PAI_PUBLISHEDTIME: PUBAPPINFOFLAGS = 4;
pub const PAI_SCHEDULEDTIME: PUBAPPINFOFLAGS = 8;
pub const PAI_SOURCE: PUBAPPINFOFLAGS = 1;
...
pub const PCS_FATAL: PCS_RET = 2147483648;
pub const PCS_PATHTOOLONG: PCS_RET = 8;
pub const PCS_REMOVEDCHAR: PCS_RET = 2;
pub const PCS_REPLACEDCHAR: PCS_RET = 1;
pub type PCS_RET = u32;
pub const PCS_TRUNCATED: PCS_RET = 4;
...
pub const PIDISF_CACHEDSTICKY: PIDISF_FLAGS = 2;
pub const PIDISF_CACHEIMAGES: PIDISF_FLAGS = 16;
pub type PIDISF_FLAGS = i32;
pub const PIDISF_FOLLOWALLLINKS: PIDISF_FLAGS = 32;
pub const PIDISF_RECENTLYCHANGED: PIDISF_FLAGS = 1;
pub const PIDISM_DONTWATCH: PIDISM_OPTIONS = 2;
pub const PIDISM_GLOBAL: PIDISM_OPTIONS = 0;
pub type PIDISM_OPTIONS = i32;
pub const PIDISM_WATCH: PIDISM_OPTIONS = 1;
pub type PIDISR_INFO = i32;
pub const PIDISR_NEEDS_ADD: PIDISR_INFO = 1;
pub const PIDISR_NEEDS_DELETE: PIDISR_INFO = 3;
pub const PIDISR_NEEDS_UPDATE: PIDISR_INFO = 2;
pub const PIDISR_UP_TO_DATE: PIDISR_INFO = 0;
...
pub const PID_INTSITE_AUTHOR: PID_INTSITE = 3;
pub const PID_INTSITE_CODEPAGE: PID_INTSITE = 18;
pub const PID_INTSITE_COMMENT: PID_INTSITE = 8;
pub const PID_INTSITE_CONTENTCODE: PID_INTSITE = 11;
pub const PID_INTSITE_CONTENTLEN: PID_INTSITE = 10;
pub const PID_INTSITE_DESCRIPTION: PID_INTSITE = 7;
pub const PID_INTSITE_FLAGS: PID_INTSITE = 9;
pub const PID_INTSITE_ICONFILE: PID_INTSITE = 21;
pub const PID_INTSITE_ICONINDEX: PID_INTSITE = 20;
pub const PID_INTSITE_LASTMOD: PID_INTSITE = 5;
pub const PID_INTSITE_LASTVISIT: PID_INTSITE = 4;
pub const PID_INTSITE_RECURSE: PID_INTSITE = 12;
pub const PID_INTSITE_ROAMED: PID_INTSITE = 34;
pub const PID_INTSITE_SUBSCRIPTION: PID_INTSITE = 14;
pub const PID_INTSITE_TITLE: PID_INTSITE = 16;
pub const PID_INTSITE_TRACKING: PID_INTSITE = 19;
pub const PID_INTSITE_URL: PID_INTSITE = 15;
pub const PID_INTSITE_VISITCOUNT: PID_INTSITE = 6;
pub const PID_INTSITE_WATCH: PID_INTSITE = 13;
pub const PID_INTSITE_WHATSNEW: PID_INTSITE = 2;
pub type PID_IS = i32;
pub const PID_IS_AUTHOR: PID_IS = 11;
pub const PID_IS_COMMENT: PID_IS = 13;
pub const PID_IS_DESCRIPTION: PID_IS = 12;
pub const PID_IS_HOTKEY: PID_IS = 6;
pub const PID_IS_ICONFILE: PID_IS = 9;
pub const PID_IS_ICONINDEX: PID_IS = 8;
pub const PID_IS_NAME: PID_IS = 4;
pub const PID_IS_ROAMED: PID_IS = 15;
pub const PID_IS_SHOWCMD: PID_IS = 7;
pub const PID_IS_URL: PID_IS = 2;
pub const PID_IS_WHATSNEW: PID_IS = 10;
pub const PID_IS_WORKINGDIR: PID_IS = 5;
...
pub const PRF_DONTFINDLNK: PRF_FLAGS = 8;
pub const PRF_FIRSTDIRDEF: PRF_FLAGS = 4;
pub type PRF_FLAGS = i32;
pub const PRF_REQUIREABSOLUTE: PRF_FLAGS = 16;
pub const PRF_TRYPROGRAMEXTENSIONS: PRF_FLAGS = 3;
pub const PRF_VERIFYEXISTS: PRF_FLAGS = 1;
...
pub const QITIPF_DEFAULT: QITIPF_FLAGS = 0;
pub type QITIPF_FLAGS = i32;
pub const QITIPF_LINKNOTARGET: QITIPF_FLAGS = 2;
pub const QITIPF_LINKUSETARGET: QITIPF_FLAGS = 4;
pub const QITIPF_SINGLELINE: QITIPF_FLAGS = 16;
pub const QITIPF_USENAME: QITIPF_FLAGS = 1;
pub const QITIPF_USESLOWTIP: QITIPF_FLAGS = 8;
...
pub const ResizeThumbnail: ThumbnailStreamCacheOptions = 2;
pub const ReturnOnlyIfCached: ThumbnailStreamCacheOptions = 1;
...
pub const SCRM_VERIFYPW: u32 = 32768;
...
pub const SFBS_FLAGS_ROUND_TO_NEAREST_DISPLAYED_DIGIT: SFBS_FLAGS = 1;
pub const SFBS_FLAGS_TRUNCATE_UNDISPLAYED_DECIMAL_DIGITS: SFBS_FLAGS = 2;
pub const SFVM_ADDOBJECT: u32 = 3;
pub const SFVM_ADDPROPERTYPAGES: SFVM_MESSAGE_ID = 47;
pub const SFVM_BACKGROUNDENUM: SFVM_MESSAGE_ID = 32;
pub const SFVM_BACKGROUNDENUMDONE: SFVM_MESSAGE_ID = 48;
pub const SFVM_COLUMNCLICK: SFVM_MESSAGE_ID = 24;
pub const SFVM_DEFITEMCOUNT: SFVM_MESSAGE_ID = 26;
pub const SFVM_DEFVIEWMODE: SFVM_MESSAGE_ID = 27;
pub const SFVM_DIDDRAGDROP: SFVM_MESSAGE_ID = 36;
pub const SFVM_FSNOTIFY: SFVM_MESSAGE_ID = 14;
pub const SFVM_GETANIMATION: SFVM_MESSAGE_ID = 68;
pub const SFVM_GETBUTTONINFO: SFVM_MESSAGE_ID = 5;
pub const SFVM_GETBUTTONS: SFVM_MESSAGE_ID = 6;
pub const SFVM_GETDETAILSOF: SFVM_MESSAGE_ID = 23;
pub const SFVM_GETHELPTEXT: SFVM_MESSAGE_ID = 3;
pub const SFVM_GETHELPTOPIC: SFVM_MESSAGE_ID = 63;
pub const SFVM_GETNOTIFY: SFVM_MESSAGE_ID = 49;
pub const SFVM_GETPANE: SFVM_MESSAGE_ID = 59;
pub const SFVM_GETSELECTEDOBJECTS: u32 = 9;
pub const SFVM_GETSORTDEFAULTS: SFVM_MESSAGE_ID = 53;
...
pub const SFVM_INITMENUPOPUP: SFVM_MESSAGE_ID = 7;
pub const SFVM_INVOKECOMMAND: SFVM_MESSAGE_ID = 2;
pub const SFVM_MERGEMENU: SFVM_MESSAGE_ID = 1;
...
pub const SFVM_QUERYFSNOTIFY: SFVM_MESSAGE_ID = 25;
pub const SFVM_REARRANGE: u32 = 1;
pub const SFVM_REMOVEOBJECT: u32 = 6;
pub const SFVM_SETCLIPBOARD: u32 = 16;
pub const SFVM_SETISFV: SFVM_MESSAGE_ID = 39;
pub const SFVM_SETITEMPOS: u32 = 14;
pub const SFVM_SETPOINTS: u32 = 23;
pub const SFVM_SIZE: SFVM_MESSAGE_ID = 57;
pub const SFVM_THISIDLIST: SFVM_MESSAGE_ID = 41;
pub const SFVM_UNMERGEMENU: SFVM_MESSAGE_ID = 28;
pub const SFVM_UPDATEOBJECT: u32 = 7;
pub const SFVM_UPDATESTATUSBAR: SFVM_MESSAGE_ID = 31;
pub const SFVM_WINDOWCREATED: SFVM_MESSAGE_ID = 15;
pub const SFVSOC_INVALIDATE_ALL: u32 = 1;
pub const SFVSOC_NOSCROLL: u32 = 2;
pub type SFVS_SELECT = i32;
pub const SFVS_SELECT_ALLITEMS: SFVS_SELECT = 1;
pub const SFVS_SELECT_INVERT: SFVS_SELECT = 2;
pub const SFVS_SELECT_NONE: SFVS_SELECT = 0;
...
pub const SHACF_AUTOAPPEND_FORCE_OFF: SHELL_AUTOCOMPLETE_FLAGS = 2147483648;
pub const SHACF_AUTOAPPEND_FORCE_ON: SHELL_AUTOCOMPLETE_FLAGS = 1073741824;
pub const SHACF_AUTOSUGGEST_FORCE_OFF: SHELL_AUTOCOMPLETE_FLAGS = 536870912;
pub const SHACF_AUTOSUGGEST_FORCE_ON: SHELL_AUTOCOMPLETE_FLAGS = 268435456;
pub const SHACF_DEFAULT: SHELL_AUTOCOMPLETE_FLAGS = 0;
pub const SHACF_FILESYSTEM: SHELL_AUTOCOMPLETE_FLAGS = 1;
pub const SHACF_FILESYS_DIRS: SHELL_AUTOCOMPLETE_FLAGS = 32;
pub const SHACF_FILESYS_ONLY: SHELL_AUTOCOMPLETE_FLAGS = 16;
pub const SHACF_URLALL: SHELL_AUTOCOMPLETE_FLAGS = 6;
pub const SHACF_URLHISTORY: SHELL_AUTOCOMPLETE_FLAGS = 2;
pub const SHACF_URLMRU: SHELL_AUTOCOMPLETE_FLAGS = 4;
pub const SHACF_USETAB: SHELL_AUTOCOMPLETE_FLAGS = 8;
...
pub const SHCNE_ALLEVENTS: SHCNE_ID = 2147483647;
pub const SHCNE_ASSOCCHANGED: SHCNE_ID = 134217728;
pub const SHCNE_ATTRIBUTES: SHCNE_ID = 2048;
pub const SHCNE_CREATE: SHCNE_ID = 2;
pub const SHCNE_DELETE: SHCNE_ID = 4;
pub const SHCNE_DISKEVENTS: SHCNE_ID = 145439;
pub const SHCNE_DRIVEADD: SHCNE_ID = 256;
pub const SHCNE_DRIVEADDGUI: SHCNE_ID = 65536;
pub const SHCNE_DRIVEREMOVED: SHCNE_ID = 128;
pub const SHCNE_EXTENDED_EVENT: SHCNE_ID = 67108864;
pub const SHCNE_FREESPACE: SHCNE_ID = 262144;
pub const SHCNE_GLOBALEVENTS: SHCNE_ID = 201687520;
pub type SHCNE_ID = u32;
pub const SHCNE_INTERRUPT: SHCNE_ID = 2147483648;
pub const SHCNE_MEDIAINSERTED: SHCNE_ID = 32;
pub const SHCNE_MEDIAREMOVED: SHCNE_ID = 64;
pub const SHCNE_MKDIR: SHCNE_ID = 8;
pub const SHCNE_NETSHARE: SHCNE_ID = 512;
pub const SHCNE_NETUNSHARE: SHCNE_ID = 1024;
pub const SHCNE_RENAMEFOLDER: SHCNE_ID = 131072;
pub const SHCNE_RENAMEITEM: SHCNE_ID = 1;
pub const SHCNE_RMDIR: SHCNE_ID = 16;
pub const SHCNE_SERVERDISCONNECT: SHCNE_ID = 16384;
pub const SHCNE_UPDATEDIR: SHCNE_ID = 4096;
pub const SHCNE_UPDATEIMAGE: SHCNE_ID = 32768;
pub const SHCNE_UPDATEITEM: SHCNE_ID = 8192;
pub const SHCNF_DWORD: SHCNF_FLAGS = 3;
pub type SHCNF_FLAGS = u32;
pub const SHCNF_FLUSH: SHCNF_FLAGS = 4096;
pub const SHCNF_FLUSHNOWAIT: SHCNF_FLAGS = 12288;
pub const SHCNF_IDLIST: SHCNF_FLAGS = 0;
pub const SHCNF_NOTIFYRECURSIVE: SHCNF_FLAGS = 65536;
pub const SHCNF_PATH: SHCNF_FLAGS = 5;
pub const SHCNF_PATHA: SHCNF_FLAGS = 1;
pub const SHCNF_PATHW: SHCNF_FLAGS = 5;
pub const SHCNF_PRINTER: SHCNF_FLAGS = 6;
pub const SHCNF_PRINTERA: SHCNF_FLAGS = 2;
pub const SHCNF_PRINTERW: SHCNF_FLAGS = 6;
pub const SHCNF_TYPE: SHCNF_FLAGS = 255;
pub const SHCNRF_InterruptLevel: SHCNRF_SOURCE = 1;
pub const SHCNRF_NewDelivery: SHCNRF_SOURCE = 32768;
pub const SHCNRF_RecursiveInterrupt: SHCNRF_SOURCE = 4096;
...
pub const SHDID_COMPUTER_AUDIO: SHDID_ID = 19;
pub const SHDID_COMPUTER_CDROM: SHDID_ID = 10;
pub const SHDID_COMPUTER_DRIVE35: SHDID_ID = 5;
pub const SHDID_COMPUTER_DRIVE525: SHDID_ID = 6;
pub const SHDID_COMPUTER_FIXED: SHDID_ID = 8;
pub const SHDID_COMPUTER_IMAGING: SHDID_ID = 18;
pub const SHDID_COMPUTER_NETDRIVE: SHDID_ID = 9;
pub const SHDID_COMPUTER_OTHER: SHDID_ID = 12;
pub const SHDID_COMPUTER_RAMDISK: SHDID_ID = 11;
pub const SHDID_COMPUTER_REMOVABLE: SHDID_ID = 7;
pub const SHDID_COMPUTER_SHAREDDOCS: SHDID_ID = 20;
pub const SHDID_FS_DIRECTORY: SHDID_ID = 3;
pub const SHDID_FS_FILE: SHDID_ID = 2;
pub const SHDID_FS_OTHER: SHDID_ID = 4;
pub type SHDID_ID = i32;
pub const SHDID_MOBILE_DEVICE: SHDID_ID = 21;
pub const SHDID_NET_DOMAIN: SHDID_ID = 13;
pub const SHDID_NET_OTHER: SHDID_ID = 17;
pub const SHDID_NET_RESTOFNET: SHDID_ID = 16;
pub const SHDID_NET_SERVER: SHDID_ID = 14;
pub const SHDID_NET_SHARE: SHDID_ID = 15;
pub const SHDID_REMOTE_DESKTOP_DRIVE: SHDID_ID = 22;
...
pub const SHFMT_CANCEL: SHFMT_RET = 4294967294;
pub const SHFMT_ERROR: SHFMT_RET = 4294967295;
pub type SHFMT_ID = u32;
pub const SHFMT_ID_DEFAULT: SHFMT_ID = 65535;
pub const SHFMT_NOFORMAT: SHFMT_RET = 4294967293;
pub type SHFMT_OPT = i32;
pub const SHFMT_OPT_FULL: SHFMT_OPT = 1;
pub const SHFMT_OPT_NONE: SHFMT_OPT = 0;
...
pub const SHGDFIL_DESCRIPTIONID: SHGDFIL_FORMAT = 3;
pub const SHGDFIL_FINDDATA: SHGDFIL_FORMAT = 1;
pub type SHGDFIL_FORMAT = i32;
pub const SHGDFIL_NETRESOURCE: SHGDFIL_FORMAT = 2;
pub type SHGDNF = u32;
...
pub const SHGFI_ADDOVERLAYS: SHGFI_FLAGS = 32;
pub const SHGFI_ATTRIBUTES: SHGFI_FLAGS = 2048;
pub const SHGFI_ATTR_SPECIFIED: SHGFI_FLAGS = 131072;
pub const SHGFI_DISPLAYNAME: SHGFI_FLAGS = 512;
pub const SHGFI_EXETYPE: SHGFI_FLAGS = 8192;
pub type SHGFI_FLAGS = u32;
pub const SHGFI_ICON: SHGFI_FLAGS = 256;
pub const SHGFI_ICONLOCATION: SHGFI_FLAGS = 4096;
pub const SHGFI_LARGEICON: SHGFI_FLAGS = 0;
pub const SHGFI_LINKOVERLAY: SHGFI_FLAGS = 32768;
pub const SHGFI_OPENICON: SHGFI_FLAGS = 2;
pub const SHGFI_OVERLAYINDEX: SHGFI_FLAGS = 64;
pub const SHGFI_PIDL: SHGFI_FLAGS = 8;
pub const SHGFI_SELECTED: SHGFI_FLAGS = 65536;
pub const SHGFI_SHELLICONSIZE: SHGFI_FLAGS = 4;
pub const SHGFI_SMALLICON: SHGFI_FLAGS = 1;
pub const SHGFI_SYSICONINDEX: SHGFI_FLAGS = 16384;
pub const SHGFI_TYPENAME: SHGFI_FLAGS = 1024;
pub const SHGFI_USEFILEATTRIBUTES: SHGFI_FLAGS = 16;
...
pub const SHGSI_ICON: SHGSI_FLAGS = 256;
pub const SHGSI_ICONLOCATION: SHGSI_FLAGS = 0;
pub const SHGSI_LARGEICON: SHGSI_FLAGS = 0;
pub const SHGSI_LINKOVERLAY: SHGSI_FLAGS = 32768;
pub const SHGSI_SELECTED: SHGSI_FLAGS = 65536;
pub const SHGSI_SHELLICONSIZE: SHGSI_FLAGS = 4;
pub const SHGSI_SMALLICON: SHGSI_FLAGS = 1;
pub const SHGSI_SYSICONINDEX: SHGSI_FLAGS = 16384;
...
pub const SHOP_FILEPATH: SHOP_TYPE = 2;
pub const SHOP_PRINTERNAME: SHOP_TYPE = 1;
pub type SHOP_TYPE = i32;
pub const SHOP_VOLUMEGUID: SHOP_TYPE = 4;
...
pub const SMIF_ACCELERATOR: SMINFOFLAGS = 2;
pub const SMIF_ALTSTATE: SMINFOFLAGS = 2048;
pub const SMIF_CHECKED: SMINFOFLAGS = 32;
pub const SMIF_DEMOTED: SMINFOFLAGS = 1024;
pub const SMIF_DISABLED: SMINFOFLAGS = 256;
pub const SMIF_DRAGNDROP: SMINFOFLAGS = 4096;
pub const SMIF_DROPCASCADE: SMINFOFLAGS = 64;
pub const SMIF_DROPTARGET: SMINFOFLAGS = 4;
pub const SMIF_HIDDEN: SMINFOFLAGS = 128;
pub const SMIF_ICON: SMINFOFLAGS = 1;
pub const SMIF_NEW: SMINFOFLAGS = 8192;
pub const SMIF_SUBMENU: SMINFOFLAGS = 8;
pub const SMIF_TRACKPOPUP: SMINFOFLAGS = 512;
pub const SMIM_FLAGS: SMINFOMASK = 2;
...
pub const SMIT_SEPARATOR: SMINFOTYPE = 1;
pub const SMIT_STRING: SMINFOTYPE = 2;
...
pub const SORT_ASCENDING: SORTDIRECTION = 1;
pub const SORT_DESCENDING: SORTDIRECTION = -1;
...
pub const SSF_AUTOCHECKSELECT: SSF_MASK = 8388608;
pub const SSF_DESKTOPHTML: SSF_MASK = 512;
pub const SSF_DONTPRETTYPATH: SSF_MASK = 2048;
pub const SSF_DOUBLECLICKINWEBVIEW: SSF_MASK = 128;
pub const SSF_FILTER: SSF_MASK = 65536;
pub const SSF_HIDDENFILEEXTS: SSF_MASK = 4;
pub const SSF_HIDEICONS: SSF_MASK = 16384;
pub const SSF_ICONSONLY: SSF_MASK = 16777216;
pub const SSF_MAPNETDRVBUTTON: SSF_MASK = 4096;
pub type SSF_MASK = u32;
pub const SSF_NOCONFIRMRECYCLE: SSF_MASK = 32768;
pub const SSF_NONETCRAWLING: SSF_MASK = 1048576;
pub const SSF_SEPPROCESS: SSF_MASK = 524288;
pub const SSF_SERVERADMINUI: SSF_MASK = 4;
pub const SSF_SHOWALLOBJECTS: SSF_MASK = 1;
pub const SSF_SHOWATTRIBCOL: SSF_MASK = 256;
pub const SSF_SHOWCOMPCOLOR: SSF_MASK = 8;
pub const SSF_SHOWEXTENSIONS: SSF_MASK = 2;
pub const SSF_SHOWINFOTIP: SSF_MASK = 8192;
pub const SSF_SHOWSTARTPAGE: SSF_MASK = 4194304;
pub const SSF_SHOWSTATUSBAR: SSF_MASK = 67108864;
pub const SSF_SHOWSUPERHIDDEN: SSF_MASK = 262144;
pub const SSF_SHOWSYSFILES: SSF_MASK = 32;
pub const SSF_SHOWTYPEOVERLAY: SSF_MASK = 33554432;
pub const SSF_SORTCOLUMNS: SSF_MASK = 16;
pub const SSF_STARTPANELON: SSF_MASK = 2097152;
pub const SSF_WEBVIEW: SSF_MASK = 131072;
pub const SSF_WIN95CLASSIC: SSF_MASK = 1024;
...
pub const SYNCMGRERRORFLAG_ENABLEJUMPTEXT: SYNCMGRERRORFLAGS = 1;
pub type SYNCMGRFLAG = i32;
pub const SYNCMGRFLAG_CONNECT: SYNCMGRFLAG = 1;
pub const SYNCMGRFLAG_EVENTMASK: SYNCMGRFLAG = 255;
pub const SYNCMGRFLAG_IDLE: SYNCMGRFLAG = 4;
pub const SYNCMGRFLAG_INVOKE: SYNCMGRFLAG = 5;
pub const SYNCMGRFLAG_MANUAL: SYNCMGRFLAG = 3;
pub const SYNCMGRFLAG_MAYBOTHERUSER: SYNCMGRFLAG = 512;
pub const SYNCMGRFLAG_PENDINGDISCONNECT: SYNCMGRFLAG = 2;
pub const SYNCMGRFLAG_SCHEDULED: SYNCMGRFLAG = 6;
pub const SYNCMGRFLAG_SETTINGS: SYNCMGRFLAG = 256;
...
pub const SYNCMGRHANDLER_ALWAYSLISTHANDLER: SYNCMGRHANDLERFLAGS = 4;
pub const SYNCMGRHANDLER_HASPROPERTIES: SYNCMGRHANDLERFLAGS = 1;
pub const SYNCMGRHANDLER_HIDDEN: SYNCMGRHANDLERFLAGS = 8;
pub const SYNCMGRHANDLER_MAYESTABLISHCONNECTION: SYNCMGRHANDLERFLAGS = 2;
pub type SYNCMGRINVOKEFLAGS = i32;
pub const SYNCMGRINVOKE_MINIMIZED: SYNCMGRINVOKEFLAGS = 4;
...
pub const SYNCMGRITEMSTATE_CHECKED: SYNCMGRITEMSTATE = 1;
pub const SYNCMGRITEMSTATE_UNCHECKED: SYNCMGRITEMSTATE = 0;
pub const SYNCMGRITEM_HASPROPERTIES: SYNCMGRITEMFLAGS = 1;
pub const SYNCMGRITEM_HIDDEN: SYNCMGRITEMFLAGS = 32;
pub const SYNCMGRITEM_ITEMFLAGMASK: u32 = 127;
pub const SYNCMGRITEM_LASTUPDATETIME: SYNCMGRITEMFLAGS = 8;
pub const SYNCMGRITEM_MAYDELETEITEM: SYNCMGRITEMFLAGS = 16;
...
pub const SYNCMGRLOGLEVEL_ERROR: SYNCMGRLOGLEVEL = 3;
pub const SYNCMGRLOGLEVEL_INFORMATION: SYNCMGRLOGLEVEL = 1;
...
pub const SYNCMGRREGISTERFLAG_CONNECT: SYNCMGRREGISTERFLAGS = 1;
pub const SYNCMGRREGISTERFLAG_IDLE: SYNCMGRREGISTERFLAGS = 4;
pub const SYNCMGRREGISTERFLAG_PENDINGDISCONNECT: SYNCMGRREGISTERFLAGS = 2;
pub type SYNCMGRSTATUS = i32;
pub const SYNCMGRSTATUS_DELETED: SYNCMGRSTATUS = 256;
pub const SYNCMGRSTATUS_FAILED: SYNCMGRSTATUS = 5;
pub const SYNCMGRSTATUS_PAUSED: SYNCMGRSTATUS = 6;
pub const SYNCMGRSTATUS_PENDING: SYNCMGRSTATUS = 2;
pub const SYNCMGRSTATUS_RESUMING: SYNCMGRSTATUS = 7;
pub const SYNCMGRSTATUS_SKIPPED: SYNCMGRSTATUS = 1;
pub const SYNCMGRSTATUS_STOPPED: SYNCMGRSTATUS = 0;
pub const SYNCMGRSTATUS_SUCCEEDED: SYNCMGRSTATUS = 4;
pub const SYNCMGRSTATUS_UPDATING: SYNCMGRSTATUS = 3;
pub const SYNCMGRSTATUS_UPDATING_INDETERMINATE: SYNCMGRSTATUS = 8;
pub type SYNCMGR_CANCEL_REQUEST = i32;
pub const SYNCMGR_CF_NONE: SYNCMGR_CONTROL_FLAGS = 0;
pub const SYNCMGR_CF_NOUI: SYNCMGR_CONTROL_FLAGS = 2;
pub const SYNCMGR_CF_NOWAIT: SYNCMGR_CONTROL_FLAGS = 0;
pub const SYNCMGR_CF_VALID: SYNCMGR_CONTROL_FLAGS = 3;
pub const SYNCMGR_CF_WAIT: SYNCMGR_CONTROL_FLAGS = 1;
pub const SYNCMGR_CIT_DELETED: SYNCMGR_CONFLICT_ITEM_TYPE = 2;
...
pub const SYNCMGR_CR_CANCEL_ALL: SYNCMGR_CANCEL_REQUEST = 2;
pub const SYNCMGR_CR_CANCEL_ITEM: SYNCMGR_CANCEL_REQUEST = 1;
pub const SYNCMGR_CR_MAX: SYNCMGR_CANCEL_REQUEST = 2;
pub const SYNCMGR_CR_NONE: SYNCMGR_CANCEL_REQUEST = 0;
pub const SYNCMGR_EF_NONE: SYNCMGR_EVENT_FLAGS = 0;
pub const SYNCMGR_EF_VALID: SYNCMGR_EVENT_FLAGS = 0;
pub const SYNCMGR_EL_ERROR: SYNCMGR_EVENT_LEVEL = 3;
pub const SYNCMGR_EL_INFORMATION: SYNCMGR_EVENT_LEVEL = 1;
pub const SYNCMGR_EL_MAX: SYNCMGR_EVENT_LEVEL = 3;
pub const SYNCMGR_EL_WARNING: SYNCMGR_EVENT_LEVEL = 2;
...
pub const SYNCMGR_HCM_CAN_BROWSE_CONTENT: SYNCMGR_HANDLER_CAPABILITIES = 65536;
pub const SYNCMGR_HCM_CAN_SHOW_SCHEDULE: SYNCMGR_HANDLER_CAPABILITIES = 131072;
pub const SYNCMGR_HCM_CONFLICT_STORE: SYNCMGR_HANDLER_CAPABILITIES = 4;
pub const SYNCMGR_HCM_EVENT_STORE: SYNCMGR_HANDLER_CAPABILITIES = 2;
pub const SYNCMGR_HCM_NONE: SYNCMGR_HANDLER_CAPABILITIES = 0;
pub const SYNCMGR_HCM_PROVIDES_ICON: SYNCMGR_HANDLER_CAPABILITIES = 1;
pub const SYNCMGR_HCM_QUERY_BEFORE_ACTIVATE: SYNCMGR_HANDLER_CAPABILITIES = 1048576;
pub const SYNCMGR_HCM_QUERY_BEFORE_DEACTIVATE: SYNCMGR_HANDLER_CAPABILITIES = 2097152;
pub const SYNCMGR_HCM_QUERY_BEFORE_DISABLE: SYNCMGR_HANDLER_CAPABILITIES = 8388608;
pub const SYNCMGR_HCM_QUERY_BEFORE_ENABLE: SYNCMGR_HANDLER_CAPABILITIES = 4194304;
pub const SYNCMGR_HCM_SUPPORTS_CONCURRENT_SESSIONS: SYNCMGR_HANDLER_CAPABILITIES = 16;
pub const SYNCMGR_HCM_VALID_MASK: SYNCMGR_HANDLER_CAPABILITIES = 15925271;
pub const SYNCMGR_HPM_BACKGROUND_SYNC_ONLY: SYNCMGR_HANDLER_POLICIES = 48;
pub const SYNCMGR_HPM_DISABLE_BROWSE: SYNCMGR_HANDLER_POLICIES = 4096;
pub const SYNCMGR_HPM_DISABLE_DISABLE: SYNCMGR_HANDLER_POLICIES = 512;
pub const SYNCMGR_HPM_DISABLE_ENABLE: SYNCMGR_HANDLER_POLICIES = 256;
pub const SYNCMGR_HPM_DISABLE_SCHEDULE: SYNCMGR_HANDLER_POLICIES = 8192;
pub const SYNCMGR_HPM_DISABLE_START_SYNC: SYNCMGR_HANDLER_POLICIES = 1024;
pub const SYNCMGR_HPM_DISABLE_STOP_SYNC: SYNCMGR_HANDLER_POLICIES = 2048;
pub const SYNCMGR_HPM_HIDDEN_BY_DEFAULT: SYNCMGR_HANDLER_POLICIES = 65536;
pub const SYNCMGR_HPM_NONE: SYNCMGR_HANDLER_POLICIES = 0;
pub const SYNCMGR_HPM_PREVENT_ACTIVATE: SYNCMGR_HANDLER_POLICIES = 1;
pub const SYNCMGR_HPM_PREVENT_DEACTIVATE: SYNCMGR_HANDLER_POLICIES = 2;
pub const SYNCMGR_HPM_PREVENT_DISABLE: SYNCMGR_HANDLER_POLICIES = 8;
pub const SYNCMGR_HPM_PREVENT_ENABLE: SYNCMGR_HANDLER_POLICIES = 4;
pub const SYNCMGR_HPM_PREVENT_START_SYNC: SYNCMGR_HANDLER_POLICIES = 16;
pub const SYNCMGR_HPM_PREVENT_STOP_SYNC: SYNCMGR_HANDLER_POLICIES = 32;
pub const SYNCMGR_HPM_VALID_MASK: SYNCMGR_HANDLER_POLICIES = 77631;
pub const SYNCMGR_HT_APPLICATION: SYNCMGR_HANDLER_TYPE = 1;
pub const SYNCMGR_HT_COMPUTER: SYNCMGR_HANDLER_TYPE = 5;
pub const SYNCMGR_HT_DEVICE: SYNCMGR_HANDLER_TYPE = 2;
pub const SYNCMGR_HT_FOLDER: SYNCMGR_HANDLER_TYPE = 3;
pub const SYNCMGR_HT_MAX: SYNCMGR_HANDLER_TYPE = 5;
pub const SYNCMGR_HT_MIN: SYNCMGR_HANDLER_TYPE = 0;
pub const SYNCMGR_HT_SERVICE: SYNCMGR_HANDLER_TYPE = 4;
pub const SYNCMGR_HT_UNSPECIFIED: SYNCMGR_HANDLER_TYPE = 0;
pub const SYNCMGR_ICM_CAN_BROWSE_CONTENT: SYNCMGR_ITEM_CAPABILITIES = 65536;
pub const SYNCMGR_ICM_CAN_DELETE: SYNCMGR_ITEM_CAPABILITIES = 16;
pub const SYNCMGR_ICM_CONFLICT_STORE: SYNCMGR_ITEM_CAPABILITIES = 4;
pub const SYNCMGR_ICM_EVENT_STORE: SYNCMGR_ITEM_CAPABILITIES = 2;
pub const SYNCMGR_ICM_NONE: SYNCMGR_ITEM_CAPABILITIES = 0;
pub const SYNCMGR_ICM_PROVIDES_ICON: SYNCMGR_ITEM_CAPABILITIES = 1;
pub const SYNCMGR_ICM_QUERY_BEFORE_DELETE: SYNCMGR_ITEM_CAPABILITIES = 4194304;
pub const SYNCMGR_ICM_QUERY_BEFORE_DISABLE: SYNCMGR_ITEM_CAPABILITIES = 2097152;
pub const SYNCMGR_ICM_QUERY_BEFORE_ENABLE: SYNCMGR_ITEM_CAPABILITIES = 1048576;
pub const SYNCMGR_ICM_VALID_MASK: SYNCMGR_ITEM_CAPABILITIES = 7405591;
pub const SYNCMGR_IPM_DISABLE_BROWSE: SYNCMGR_ITEM_POLICIES = 256;
pub const SYNCMGR_IPM_DISABLE_DELETE: SYNCMGR_ITEM_POLICIES = 512;
pub const SYNCMGR_IPM_DISABLE_DISABLE: SYNCMGR_ITEM_POLICIES = 32;
pub const SYNCMGR_IPM_DISABLE_ENABLE: SYNCMGR_ITEM_POLICIES = 16;
pub const SYNCMGR_IPM_DISABLE_START_SYNC: SYNCMGR_ITEM_POLICIES = 64;
pub const SYNCMGR_IPM_DISABLE_STOP_SYNC: SYNCMGR_ITEM_POLICIES = 128;
pub const SYNCMGR_IPM_HIDDEN_BY_DEFAULT: SYNCMGR_ITEM_POLICIES = 65536;
pub const SYNCMGR_IPM_NONE: SYNCMGR_ITEM_POLICIES = 0;
pub const SYNCMGR_IPM_PREVENT_DISABLE: SYNCMGR_ITEM_POLICIES = 2;
pub const SYNCMGR_IPM_PREVENT_ENABLE: SYNCMGR_ITEM_POLICIES = 1;
pub const SYNCMGR_IPM_PREVENT_START_SYNC: SYNCMGR_ITEM_POLICIES = 4;
pub const SYNCMGR_IPM_PREVENT_STOP_SYNC: SYNCMGR_ITEM_POLICIES = 8;
pub const SYNCMGR_IPM_VALID_MASK: SYNCMGR_ITEM_POLICIES = 66303;
...
pub const SYNCMGR_PC_KEEP_MULTIPLE: SYNCMGR_PRESENTER_CHOICE = 2;
pub const SYNCMGR_PC_KEEP_ONE: SYNCMGR_PRESENTER_CHOICE = 1;
pub const SYNCMGR_PC_KEEP_RECENT: SYNCMGR_PRESENTER_CHOICE = 3;
pub const SYNCMGR_PC_NO_CHOICE: SYNCMGR_PRESENTER_CHOICE = 0;
pub const SYNCMGR_PC_REMOVE_FROM_SYNC_SET: SYNCMGR_PRESENTER_CHOICE = 4;
pub const SYNCMGR_PC_SKIP: SYNCMGR_PRESENTER_CHOICE = 5;
pub const SYNCMGR_PNS_CANCEL: SYNCMGR_PRESENTER_NEXT_STEP = 2;
pub const SYNCMGR_PNS_CONTINUE: SYNCMGR_PRESENTER_NEXT_STEP = 0;
pub const SYNCMGR_PNS_DEFAULT: SYNCMGR_PRESENTER_NEXT_STEP = 1;
pub type SYNCMGR_PRESENTER_CHOICE = i32;
pub type SYNCMGR_PRESENTER_NEXT_STEP = i32;
pub type SYNCMGR_PROGRESS_STATUS = i32;
pub const SYNCMGR_PS_CANCELED: SYNCMGR_PROGRESS_STATUS = 5;
pub const SYNCMGR_PS_DISCONNECTED: SYNCMGR_PROGRESS_STATUS = 6;
pub const SYNCMGR_PS_FAILED: SYNCMGR_PROGRESS_STATUS = 4;
pub const SYNCMGR_PS_MAX: SYNCMGR_PROGRESS_STATUS = 6;
pub const SYNCMGR_PS_SUCCEEDED: SYNCMGR_PROGRESS_STATUS = 3;
pub const SYNCMGR_PS_UPDATING: SYNCMGR_PROGRESS_STATUS = 1;
pub const SYNCMGR_PS_UPDATING_INDETERMINATE: SYNCMGR_PROGRESS_STATUS = 2;
pub const SYNCMGR_RA_KEEPOTHER: SYNCMGR_RESOLUTION_ABILITIES = 1;
pub const SYNCMGR_RA_KEEPRECENT: SYNCMGR_RESOLUTION_ABILITIES = 2;
pub const SYNCMGR_RA_KEEP_MULTIPLE: SYNCMGR_RESOLUTION_ABILITIES = 16;
pub const SYNCMGR_RA_KEEP_SINGLE: SYNCMGR_RESOLUTION_ABILITIES = 8;
pub const SYNCMGR_RA_REMOVEFROMSYNCSET: SYNCMGR_RESOLUTION_ABILITIES = 4;
pub const SYNCMGR_RA_VALID: SYNCMGR_RESOLUTION_ABILITIES = 31;
pub type SYNCMGR_RESOLUTION_ABILITIES = i32;
pub type SYNCMGR_RESOLUTION_FEEDBACK = i32;
pub const SYNCMGR_RF_CANCEL: SYNCMGR_RESOLUTION_FEEDBACK = 2;
pub const SYNCMGR_RF_CONTINUE: SYNCMGR_RESOLUTION_FEEDBACK = 0;
pub const SYNCMGR_RF_REFRESH: SYNCMGR_RESOLUTION_FEEDBACK = 1;
pub const SYNCMGR_SCF_IGNORE_IF_ALREADY_SYNCING: SYNCMGR_SYNC_CONTROL_FLAGS = 1;
pub const SYNCMGR_SCF_NONE: SYNCMGR_SYNC_CONTROL_FLAGS = 0;
pub const SYNCMGR_SCF_VALID: SYNCMGR_SYNC_CONTROL_FLAGS = 1;
pub type SYNCMGR_SYNC_CONTROL_FLAGS = i32;
pub type SYNCMGR_UPDATE_REASON = i32;
pub const SYNCMGR_UR_ADDED: SYNCMGR_UPDATE_REASON = 0;
pub const SYNCMGR_UR_CHANGED: SYNCMGR_UPDATE_REASON = 1;
pub const SYNCMGR_UR_MAX: SYNCMGR_UPDATE_REASON = 2;
pub const SYNCMGR_UR_REMOVED: SYNCMGR_UPDATE_REASON = 2;
...
pub const TI_BITMAP: TI_FLAGS = 1;
pub type TI_FLAGS = i32;
pub const TI_JPEG: TI_FLAGS = 2;
pub const TLEF_ABSOLUTE: TLENUMF = 49;
pub const TLEF_EXCLUDE_ABOUT_PAGES: TLENUMF = 256;
pub const TLEF_EXCLUDE_SUBFRAME_ENTRIES: TLENUMF = 128;
pub const TLEF_INCLUDE_UNINVOKEABLE: TLENUMF = 64;
pub const TLEF_RELATIVE_BACK: TLENUMF = 16;
pub const TLEF_RELATIVE_FORE: TLENUMF = 32;
pub const TLEF_RELATIVE_INCLUDE_CURRENT: TLENUMF = 1;
...
pub const VALIDATEUNC_CONNECT: VALIDATEUNC_OPTION = 1;
pub const VALIDATEUNC_NOUI: VALIDATEUNC_OPTION = 2;
pub type VALIDATEUNC_OPTION = i32;
pub const VALIDATEUNC_PERSIST: VALIDATEUNC_OPTION = 8;
pub const VALIDATEUNC_PRINT: VALIDATEUNC_OPTION = 4;
pub const VALIDATEUNC_VALID: VALIDATEUNC_OPTION = 15;
...
pub const WM_CPL_LAUNCH: u32 = 2024;
pub const WM_CPL_LAUNCHED: u32 = 2025;
...
pub const WTSAT_ARGB: WTS_ALPHATYPE = 2;
pub const WTSAT_RGB: WTS_ALPHATYPE = 1;
pub const WTSAT_UNKNOWN: WTS_ALPHATYPE = 0;
pub const WTSCF_APPSTYLE: WTS_CONTEXTFLAGS = 1;
pub const WTSCF_DEFAULT: WTS_CONTEXTFLAGS = 0;
pub const WTSCF_FAST: WTS_CONTEXTFLAGS = 8;
pub const WTSCF_SQUARE: WTS_CONTEXTFLAGS = 2;
pub const WTSCF_WIDE: WTS_CONTEXTFLAGS = 4;
pub type WTS_ALPHATYPE = i32;
pub const WTS_APPSTYLE: WTS_FLAGS = 8192;
pub const WTS_CACHED: WTS_CACHEFLAGS = 2;
pub type WTS_CACHEFLAGS = i32;
pub type WTS_CONTEXTFLAGS = i32;
pub const WTS_CROPTOSQUARE: WTS_FLAGS = 512;
pub const WTS_DEFAULT: WTS_CACHEFLAGS = 0;
pub const WTS_EXTRACT: WTS_FLAGS = 0;
pub const WTS_EXTRACTDONOTCACHE: WTS_FLAGS = 32;
pub const WTS_EXTRACTINPROC: WTS_FLAGS = 256;
...
pub const WTS_FASTEXTRACT: WTS_FLAGS = 2;
pub type WTS_FLAGS = i32;
pub const WTS_FORCEEXTRACTION: WTS_FLAGS = 4;
pub const WTS_IDEALCACHESIZEONLY: WTS_FLAGS = 32768;
pub const WTS_INCACHEONLY: WTS_FLAGS = 1;
pub const WTS_INSTANCESURROGATE: WTS_FLAGS = 1024;
pub const WTS_LOWQUALITY: WTS_CACHEFLAGS = 1;
pub const WTS_NONE: WTS_FLAGS = 0;
pub const WTS_REQUIRESURROGATE: WTS_FLAGS = 2048;
pub const WTS_SCALETOREQUESTEDSIZE: WTS_FLAGS = 64;
pub const WTS_SCALEUP: WTS_FLAGS = 65536;
...
pub const WTS_WIDETHUMBNAILS: WTS_FLAGS = 16384;
...
pub const idsAppName: u32 = 1007;
pub const idsBadOldPW: u32 = 1006;
pub const idsChangePW: u32 = 1005;
pub const idsDefKeyword: u32 = 1010;
pub const idsDifferentPW: u32 = 1004;
pub const idsHelpFile: u32 = 1009;
pub const idsIniFile: u32 = 1001;
pub const idsIsPassword: u32 = 1000;
pub const idsNoHelpMemory: u32 = 1008;
pub const idsPassword: u32 = 1003;
pub const idsScreenSaver: u32 = 1002;
