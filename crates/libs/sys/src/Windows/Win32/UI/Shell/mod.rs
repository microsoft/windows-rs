...
#[cfg(feature = "Win32_UI_Shell_Common")]
::windows_targets::link!("shell32.dll" "system" fn SHGetIDListFromObject(punk : ::windows_sys::core::IUnknown, ppidl : *mut *mut Common:: ITEMIDLIST) -> ::windows_sys::core::HRESULT);
