...
windows_link::link!("comctl32.dll" "system" fn FlatSB_SetScrollProp(param0 : super::super::Foundation::HWND, index : WSB_PROP, newvalue : isize, param3 : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("uxtheme.dll" "system" fn GetThemeBitmap(htheme : HTHEME, ipartid : i32, istateid : i32, ipropid : THEME_PROPERTY_SYMBOL_ID, dwflags : GET_THEME_BITMAP_FLAGS, phbitmap : *mut super::super::Graphics::Gdi::HBITMAP) -> windows_sys::core::HRESULT);
windows_link::link!("uxtheme.dll" "system" fn GetThemeBool(htheme : HTHEME, ipartid : i32, istateid : i32, ipropid : THEME_PROPERTY_SYMBOL_ID, pfval : *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT);
windows_link::link!("uxtheme.dll" "system" fn GetThemeColor(htheme : HTHEME, ipartid : i32, istateid : i32, ipropid : THEME_PROPERTY_SYMBOL_ID, pcolor : *mut super::super::Foundation::COLORREF) -> windows_sys::core::HRESULT);
...
windows_link::link!("uxtheme.dll" "system" fn GetThemeEnumValue(htheme : HTHEME, ipartid : i32, istateid : i32, ipropid : THEME_PROPERTY_SYMBOL_ID, pival : *mut i32) -> windows_sys::core::HRESULT);
windows_link::link!("uxtheme.dll" "system" fn GetThemeFilename(htheme : HTHEME, ipartid : i32, istateid : i32, ipropid : THEME_PROPERTY_SYMBOL_ID, pszthemefilename : windows_sys::core::PWSTR, cchmaxbuffchars : i32) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
windows_link::link!("uxtheme.dll" "system" fn GetThemeInt(htheme : HTHEME, ipartid : i32, istateid : i32, ipropid : THEME_PROPERTY_SYMBOL_ID, pival : *mut i32) -> windows_sys::core::HRESULT);
windows_link::link!("uxtheme.dll" "system" fn GetThemeIntList(htheme : HTHEME, ipartid : i32, istateid : i32, ipropid : THEME_PROPERTY_SYMBOL_ID, pintlist : *mut INTLIST) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("uxtheme.dll" "system" fn GetThemeMargins(htheme : HTHEME, hdc : super::super::Graphics::Gdi::HDC, ipartid : i32, istateid : i32, ipropid : THEME_PROPERTY_SYMBOL_ID, prc : *const super::super::Foundation::RECT, pmargins : *mut MARGINS) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("uxtheme.dll" "system" fn GetThemeMetric(htheme : HTHEME, hdc : super::super::Graphics::Gdi::HDC, ipartid : i32, istateid : i32, ipropid : THEME_PROPERTY_SYMBOL_ID, pival : *mut i32) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
windows_link::link!("uxtheme.dll" "system" fn GetThemePosition(htheme : HTHEME, ipartid : i32, istateid : i32, ipropid : THEME_PROPERTY_SYMBOL_ID, ppoint : *mut super::super::Foundation::POINT) -> windows_sys::core::HRESULT);
...
windows_link::link!("uxtheme.dll" "system" fn GetThemeSysBool(htheme : HTHEME, iboolid : THEME_PROPERTY_SYMBOL_ID) -> windows_sys::core::BOOL);
windows_link::link!("uxtheme.dll" "system" fn GetThemeSysColor(htheme : HTHEME, icolorid : i32) -> super::super::Foundation::COLORREF);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("uxtheme.dll" "system" fn GetThemeSysColorBrush(htheme : HTHEME, icolorid : THEME_PROPERTY_SYMBOL_ID) -> super::super::Graphics::Gdi::HBRUSH);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("uxtheme.dll" "system" fn GetThemeSysFont(htheme : HTHEME, ifontid : THEME_PROPERTY_SYMBOL_ID, plf : *mut super::super::Graphics::Gdi::LOGFONTW) -> windows_sys::core::HRESULT);
windows_link::link!("uxtheme.dll" "system" fn GetThemeSysInt(htheme : HTHEME, iintid : THEME_PROPERTY_SYMBOL_ID, pivalue : *mut i32) -> windows_sys::core::HRESULT);
windows_link::link!("uxtheme.dll" "system" fn GetThemeSysSize(htheme : HTHEME, isizeid : i32) -> i32);
windows_link::link!("uxtheme.dll" "system" fn GetThemeSysString(htheme : HTHEME, istringid : THEME_PROPERTY_SYMBOL_ID, pszstringbuff : windows_sys::core::PWSTR, cchmaxstringchars : i32) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub const ABS_DOWNDISABLED: ARROWBTNSTATES = 8;
pub const ABS_DOWNHOT: ARROWBTNSTATES = 6;
pub const ABS_DOWNHOVER: ARROWBTNSTATES = 18;
pub const ABS_DOWNNORMAL: ARROWBTNSTATES = 5;
pub const ABS_DOWNPRESSED: ARROWBTNSTATES = 7;
pub const ABS_LEFTDISABLED: ARROWBTNSTATES = 12;
pub const ABS_LEFTHOT: ARROWBTNSTATES = 10;
pub const ABS_LEFTHOVER: ARROWBTNSTATES = 19;
pub const ABS_LEFTNORMAL: ARROWBTNSTATES = 9;
pub const ABS_LEFTPRESSED: ARROWBTNSTATES = 11;
pub const ABS_RIGHTDISABLED: ARROWBTNSTATES = 16;
pub const ABS_RIGHTHOT: ARROWBTNSTATES = 14;
pub const ABS_RIGHTHOVER: ARROWBTNSTATES = 20;
pub const ABS_RIGHTNORMAL: ARROWBTNSTATES = 13;
pub const ABS_RIGHTPRESSED: ARROWBTNSTATES = 15;
pub const ABS_UPDISABLED: ARROWBTNSTATES = 4;
pub const ABS_UPHOT: ARROWBTNSTATES = 2;
pub const ABS_UPHOVER: ARROWBTNSTATES = 17;
pub const ABS_UPNORMAL: ARROWBTNSTATES = 1;
pub const ABS_UPPRESSED: ARROWBTNSTATES = 3;
...
pub const ALLOW_CONTROLS: SET_THEME_APP_PROPERTIES_FLAGS = 2;
pub const ALLOW_NONCLIENT: SET_THEME_APP_PROPERTIES_FLAGS = 1;
pub const ALLOW_WEBCONTENT: SET_THEME_APP_PROPERTIES_FLAGS = 4;
...
pub const AW_BUTTON: AEROWIZARDPARTS = 5;
pub const AW_COMMANDAREA: AEROWIZARDPARTS = 4;
pub const AW_CONTENTAREA: AEROWIZARDPARTS = 3;
pub const AW_HEADERAREA: AEROWIZARDPARTS = 2;
pub const AW_S_CONTENTAREA_NOMARGIN: CONTENTAREASTATES = 1;
pub const AW_S_HEADERAREA_NOMARGIN: HEADERAREASTATES = 1;
pub const AW_S_TITLEBAR_ACTIVE: TITLEBARSTATES = 1;
pub const AW_S_TITLEBAR_INACTIVE: TITLEBARSTATES = 2;
pub const AW_TITLEBAR: AEROWIZARDPARTS = 1;
...
pub const BPPF_ERASE: BP_PAINTPARAMS_FLAGS = 1;
pub const BPPF_NOCLIP: BP_PAINTPARAMS_FLAGS = 2;
pub const BPPF_NONCLIENT: BP_PAINTPARAMS_FLAGS = 4;
#[repr(C)]
...
pub const BP_CHECKBOX: BUTTONPARTS = 3;
pub const BP_CHECKBOX_HCDISABLED: BUTTONPARTS = 9;
pub const BP_COMMANDLINK: BUTTONPARTS = 6;
pub const BP_COMMANDLINKGLYPH: BUTTONPARTS = 7;
pub const BP_GROUPBOX: BUTTONPARTS = 4;
pub const BP_GROUPBOX_HCDISABLED: BUTTONPARTS = 10;
#[repr(C)]
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub const BP_PUSHBUTTON: BUTTONPARTS = 1;
pub const BP_PUSHBUTTONDROPDOWN: BUTTONPARTS = 11;
pub const BP_RADIOBUTTON: BUTTONPARTS = 2;
pub const BP_RADIOBUTTON_HCDISABLED: BUTTONPARTS = 8;
pub const BP_USERBUTTON: BUTTONPARTS = 5;
pub const BST_CHECKED: DLG_BUTTON_CHECK_STATE = 1;
pub const BST_DROPDOWNPUSHED: u32 = 1024;
pub const BST_HOT: u32 = 512;
pub const BST_INDETERMINATE: DLG_BUTTON_CHECK_STATE = 2;
pub const BST_UNCHECKED: DLG_BUTTON_CHECK_STATE = 0;
...
pub const BT_BORDERFILL: BGTYPE = 1;
pub const BT_ELLIPSE: BORDERTYPE = 2;
pub const BT_IMAGEFILE: BGTYPE = 0;
pub const BT_NONE: BGTYPE = 2;
pub const BT_RECT: BORDERTYPE = 0;
pub const BT_ROUNDRECT: BORDERTYPE = 1;
...
pub const BUTTON_IMAGELIST_ALIGN_BOTTOM: BUTTON_IMAGELIST_ALIGN = 3;
pub const BUTTON_IMAGELIST_ALIGN_CENTER: BUTTON_IMAGELIST_ALIGN = 4;
pub const BUTTON_IMAGELIST_ALIGN_LEFT: BUTTON_IMAGELIST_ALIGN = 0;
pub const BUTTON_IMAGELIST_ALIGN_RIGHT: BUTTON_IMAGELIST_ALIGN = 1;
pub const BUTTON_IMAGELIST_ALIGN_TOP: BUTTON_IMAGELIST_ALIGN = 2;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const CA_CENTER: CONTENTALIGNMENT = 1;
pub const CA_LEFT: CONTENTALIGNMENT = 0;
pub const CA_RIGHT: CONTENTALIGNMENT = 2;
pub const CBB_DISABLED: BORDERSTATES = 4;
pub const CBB_FOCUSED: BORDERSTATES = 3;
pub const CBB_HOT: BORDERSTATES = 2;
pub const CBB_NORMAL: BORDERSTATES = 1;
pub const CBCB_DISABLED: CUEBANNERSTATES = 4;
pub const CBCB_HOT: CUEBANNERSTATES = 2;
pub const CBCB_NORMAL: CUEBANNERSTATES = 1;
pub const CBCB_PRESSED: CUEBANNERSTATES = 3;
pub const CBDI_HIGHLIGHTED: DROPDOWNITEMSTATES = 2;
pub const CBDI_NORMAL: DROPDOWNITEMSTATES = 1;
pub const CBEIF_DI_SETITEM: COMBOBOX_EX_ITEM_FLAGS = 268435456;
pub const CBEIF_IMAGE: COMBOBOX_EX_ITEM_FLAGS = 2;
pub const CBEIF_INDENT: COMBOBOX_EX_ITEM_FLAGS = 16;
pub const CBEIF_LPARAM: COMBOBOX_EX_ITEM_FLAGS = 32;
pub const CBEIF_OVERLAY: COMBOBOX_EX_ITEM_FLAGS = 8;
pub const CBEIF_SELECTEDIMAGE: COMBOBOX_EX_ITEM_FLAGS = 4;
pub const CBEIF_TEXT: COMBOBOX_EX_ITEM_FLAGS = 1;
...
pub const CBRO_DISABLED: READONLYSTATES = 4;
pub const CBRO_HOT: READONLYSTATES = 2;
pub const CBRO_NORMAL: READONLYSTATES = 1;
pub const CBRO_PRESSED: READONLYSTATES = 3;
pub const CBS_CHECKEDDISABLED: CHECKBOXSTATES = 8;
pub const CBS_CHECKEDHOT: CHECKBOXSTATES = 6;
pub const CBS_CHECKEDNORMAL: CHECKBOXSTATES = 5;
pub const CBS_CHECKEDPRESSED: CHECKBOXSTATES = 7;
pub const CBS_DISABLED: CLOSEBUTTONSTATES = 4;
pub const CBS_EXCLUDEDDISABLED: CHECKBOXSTATES = 20;
pub const CBS_EXCLUDEDHOT: CHECKBOXSTATES = 18;
pub const CBS_EXCLUDEDNORMAL: CHECKBOXSTATES = 17;
pub const CBS_EXCLUDEDPRESSED: CHECKBOXSTATES = 19;
pub const CBS_HOT: CLOSEBUTTONSTATES = 2;
pub const CBS_IMPLICITDISABLED: CHECKBOXSTATES = 16;
pub const CBS_IMPLICITHOT: CHECKBOXSTATES = 14;
pub const CBS_IMPLICITNORMAL: CHECKBOXSTATES = 13;
pub const CBS_IMPLICITPRESSED: CHECKBOXSTATES = 15;
pub const CBS_MIXEDDISABLED: CHECKBOXSTATES = 12;
pub const CBS_MIXEDHOT: CHECKBOXSTATES = 10;
pub const CBS_MIXEDNORMAL: CHECKBOXSTATES = 9;
pub const CBS_MIXEDPRESSED: CHECKBOXSTATES = 11;
pub const CBS_NORMAL: CLOSEBUTTONSTATES = 1;
pub const CBS_PUSHED: CLOSEBUTTONSTATES = 3;
pub const CBS_UNCHECKEDDISABLED: CHECKBOXSTATES = 4;
pub const CBS_UNCHECKEDHOT: CHECKBOXSTATES = 2;
pub const CBS_UNCHECKEDNORMAL: CHECKBOXSTATES = 1;
pub const CBS_UNCHECKEDPRESSED: CHECKBOXSTATES = 3;
pub const CBTBS_DISABLED: TRANSPARENTBACKGROUNDSTATES = 3;
pub const CBTBS_FOCUSED: TRANSPARENTBACKGROUNDSTATES = 4;
pub const CBTBS_HOT: TRANSPARENTBACKGROUNDSTATES = 2;
pub const CBTBS_NORMAL: TRANSPARENTBACKGROUNDSTATES = 1;
pub const CBXSL_DISABLED: DROPDOWNBUTTONLEFTSTATES = 4;
pub const CBXSL_HOT: DROPDOWNBUTTONLEFTSTATES = 2;
pub const CBXSL_NORMAL: DROPDOWNBUTTONLEFTSTATES = 1;
pub const CBXSL_PRESSED: DROPDOWNBUTTONLEFTSTATES = 3;
pub const CBXSR_DISABLED: DROPDOWNBUTTONRIGHTSTATES = 4;
pub const CBXSR_HOT: DROPDOWNBUTTONRIGHTSTATES = 2;
pub const CBXSR_NORMAL: DROPDOWNBUTTONRIGHTSTATES = 1;
pub const CBXSR_PRESSED: DROPDOWNBUTTONRIGHTSTATES = 3;
pub const CBXS_DISABLED: COMBOBOXSTYLESTATES = 4;
pub const CBXS_HOT: COMBOBOXSTYLESTATES = 2;
pub const CBXS_NORMAL: COMBOBOXSTYLESTATES = 1;
pub const CBXS_PRESSED: COMBOBOXSTYLESTATES = 3;
...
pub const CDDS_ITEMPOSTERASE: NMCUSTOMDRAW_DRAW_STAGE = 65540;
pub const CDDS_ITEMPOSTPAINT: NMCUSTOMDRAW_DRAW_STAGE = 65538;
pub const CDDS_ITEMPREERASE: NMCUSTOMDRAW_DRAW_STAGE = 65539;
pub const CDDS_ITEMPREPAINT: NMCUSTOMDRAW_DRAW_STAGE = 65537;
pub const CDDS_POSTERASE: u32 = 4;
pub const CDDS_POSTPAINT: NMCUSTOMDRAW_DRAW_STAGE = 2;
pub const CDDS_PREERASE: NMCUSTOMDRAW_DRAW_STAGE = 3;
pub const CDDS_PREPAINT: NMCUSTOMDRAW_DRAW_STAGE = 1;
pub const CDDS_SUBITEM: NMCUSTOMDRAW_DRAW_STAGE = 131072;
pub const CDIS_CHECKED: NMCUSTOMDRAW_DRAW_STATE_FLAGS = 8;
pub const CDIS_DEFAULT: NMCUSTOMDRAW_DRAW_STATE_FLAGS = 32;
pub const CDIS_DISABLED: NMCUSTOMDRAW_DRAW_STATE_FLAGS = 4;
pub const CDIS_DROPHILITED: NMCUSTOMDRAW_DRAW_STATE_FLAGS = 4096;
pub const CDIS_FOCUS: NMCUSTOMDRAW_DRAW_STATE_FLAGS = 16;
pub const CDIS_GRAYED: NMCUSTOMDRAW_DRAW_STATE_FLAGS = 2;
pub const CDIS_HOT: NMCUSTOMDRAW_DRAW_STATE_FLAGS = 64;
pub const CDIS_INDETERMINATE: NMCUSTOMDRAW_DRAW_STATE_FLAGS = 256;
pub const CDIS_MARKED: NMCUSTOMDRAW_DRAW_STATE_FLAGS = 128;
pub const CDIS_NEARHOT: NMCUSTOMDRAW_DRAW_STATE_FLAGS = 1024;
pub const CDIS_OTHERSIDEHOT: NMCUSTOMDRAW_DRAW_STATE_FLAGS = 2048;
pub const CDIS_SELECTED: NMCUSTOMDRAW_DRAW_STATE_FLAGS = 1;
pub const CDIS_SHOWKEYBOARDCUES: NMCUSTOMDRAW_DRAW_STATE_FLAGS = 512;
...
pub const CHEVSV_HOT: CHEVRONVERTSTATES = 2;
pub const CHEVSV_NORMAL: CHEVRONVERTSTATES = 1;
pub const CHEVSV_PRESSED: CHEVRONVERTSTATES = 3;
pub const CHEVS_HOT: CHEVRONSTATES = 2;
pub const CHEVS_NORMAL: CHEVRONSTATES = 1;
pub const CHEVS_PRESSED: CHEVRONSTATES = 3;
pub type CLOCKPARTS = i32;
pub type CLOCKSTATES = i32;
pub type CLOSEBUTTONSTATES = i32;
pub type CLOSESTATES = i32;
pub const CLP_TIME: CLOCKPARTS = 1;
pub const CLR_DEFAULT: i32 = -16777216;
pub const CLR_HILIGHT: i32 = -16777216;
pub const CLR_NONE: i32 = -1;
pub const CLS_HOT: CLOCKSTATES = 2;
pub const CLS_NORMAL: CLOCKSTATES = 1;
pub const CLS_PRESSED: CLOCKSTATES = 3;
pub const CMB_MASKED: u32 = 2;
pub const CMDLGS_DEFAULTED: COMMANDLINKGLYPHSTATES = 5;
pub const CMDLGS_DISABLED: COMMANDLINKGLYPHSTATES = 4;
pub const CMDLGS_HOT: COMMANDLINKGLYPHSTATES = 2;
pub const CMDLGS_NORMAL: COMMANDLINKGLYPHSTATES = 1;
pub const CMDLGS_PRESSED: COMMANDLINKGLYPHSTATES = 3;
pub const CMDLS_DEFAULTED: COMMANDLINKSTATES = 5;
pub const CMDLS_DEFAULTED_ANIMATING: COMMANDLINKSTATES = 6;
pub const CMDLS_DISABLED: COMMANDLINKSTATES = 4;
pub const CMDLS_HOT: COMMANDLINKSTATES = 2;
pub const CMDLS_NORMAL: COMMANDLINKSTATES = 1;
pub const CMDLS_PRESSED: COMMANDLINKSTATES = 3;
...
pub const CPANEL_BANNERAREA: CONTROLPANELPARTS = 18;
pub const CPANEL_BODYTEXT: CONTROLPANELPARTS = 6;
pub const CPANEL_BODYTITLE: CONTROLPANELPARTS = 19;
pub const CPANEL_BUTTON: CONTROLPANELPARTS = 14;
pub const CPANEL_CONTENTLINK: CONTROLPANELPARTS = 10;
pub const CPANEL_CONTENTPANE: CONTROLPANELPARTS = 2;
pub const CPANEL_CONTENTPANELABEL: CONTROLPANELPARTS = 4;
pub const CPANEL_CONTENTPANELINE: CONTROLPANELPARTS = 17;
pub const CPANEL_GROUPTEXT: CONTROLPANELPARTS = 9;
pub const CPANEL_HELPLINK: CONTROLPANELPARTS = 7;
pub const CPANEL_LARGECOMMANDAREA: CONTROLPANELPARTS = 12;
pub const CPANEL_MESSAGETEXT: CONTROLPANELPARTS = 15;
pub const CPANEL_NAVIGATIONPANE: CONTROLPANELPARTS = 1;
pub const CPANEL_NAVIGATIONPANELABEL: CONTROLPANELPARTS = 3;
pub const CPANEL_NAVIGATIONPANELINE: CONTROLPANELPARTS = 16;
pub const CPANEL_SECTIONTITLELINK: CONTROLPANELPARTS = 11;
pub const CPANEL_SMALLCOMMANDAREA: CONTROLPANELPARTS = 13;
pub const CPANEL_TASKLINK: CONTROLPANELPARTS = 8;
pub const CPANEL_TITLE: CONTROLPANELPARTS = 5;
pub const CPCL_DISABLED: CONTENTLINKSTATES = 4;
pub const CPCL_HOT: CONTENTLINKSTATES = 2;
pub const CPCL_NORMAL: CONTENTLINKSTATES = 1;
pub const CPCL_PRESSED: CONTENTLINKSTATES = 3;
pub const CPHL_DISABLED: HELPLINKSTATES = 4;
pub const CPHL_HOT: HELPLINKSTATES = 2;
pub const CPHL_NORMAL: HELPLINKSTATES = 1;
pub const CPHL_PRESSED: HELPLINKSTATES = 3;
pub const CPSTL_HOT: SECTIONTITLELINKSTATES = 2;
pub const CPSTL_NORMAL: SECTIONTITLELINKSTATES = 1;
pub const CPTL_DISABLED: TASKLINKSTATES = 4;
pub const CPTL_HOT: TASKLINKSTATES = 2;
pub const CPTL_NORMAL: TASKLINKSTATES = 1;
pub const CPTL_PAGE: TASKLINKSTATES = 5;
pub const CPTL_PRESSED: TASKLINKSTATES = 3;
pub const CP_BACKGROUND: COMBOBOXPARTS = 2;
pub const CP_BORDER: COMBOBOXPARTS = 4;
pub const CP_CUEBANNER: COMBOBOXPARTS = 8;
pub const CP_DROPDOWNBUTTON: COMBOBOXPARTS = 1;
pub const CP_DROPDOWNBUTTONLEFT: COMBOBOXPARTS = 7;
pub const CP_DROPDOWNBUTTONRIGHT: COMBOBOXPARTS = 6;
pub const CP_DROPDOWNITEM: COMBOBOXPARTS = 9;
pub const CP_READONLY: COMBOBOXPARTS = 5;
pub const CP_TRANSPARENTBACKGROUND: COMBOBOXPARTS = 3;
pub type CREATELINKSTATES = i32;
pub const CSST_TAB: COMMUNICATIONSPARTS = 1;
pub const CSTB_HOT: TABSTATES = 2;
pub const CSTB_NORMAL: TABSTATES = 1;
pub const CSTB_SELECTED: TABSTATES = 3;
pub const CS_ACTIVE: CAPTIONSTATES = 1;
pub const CS_DISABLED: CAPTIONSTATES = 3;
pub const CS_INACTIVE: CAPTIONSTATES = 2;
...
pub const DDCOPY_HIGHLIGHT: COPYSTATES = 1;
pub const DDCOPY_NOHIGHLIGHT: COPYSTATES = 2;
pub const DDCREATELINK_HIGHLIGHT: CREATELINKSTATES = 1;
pub const DDCREATELINK_NOHIGHLIGHT: CREATELINKSTATES = 2;
pub const DDL_ARCHIVE: DLG_DIR_LIST_FILE_TYPE = 32;
pub const DDL_DIRECTORY: DLG_DIR_LIST_FILE_TYPE = 16;
pub const DDL_DRIVES: DLG_DIR_LIST_FILE_TYPE = 16384;
pub const DDL_EXCLUSIVE: DLG_DIR_LIST_FILE_TYPE = 32768;
pub const DDL_HIDDEN: DLG_DIR_LIST_FILE_TYPE = 2;
pub const DDL_POSTMSGS: DLG_DIR_LIST_FILE_TYPE = 8192;
pub const DDL_READONLY: DLG_DIR_LIST_FILE_TYPE = 1;
pub const DDL_READWRITE: DLG_DIR_LIST_FILE_TYPE = 0;
pub const DDL_SYSTEM: DLG_DIR_LIST_FILE_TYPE = 4;
pub const DDMOVE_HIGHLIGHT: MOVESTATES = 1;
pub const DDMOVE_NOHIGHLIGHT: MOVESTATES = 2;
pub const DDNONE_HIGHLIGHT: NONESTATES = 1;
pub const DDNONE_NOHIGHLIGHT: NONESTATES = 2;
pub const DDUPDATEMETADATA_HIGHLIGHT: UPDATEMETADATASTATES = 1;
pub const DDUPDATEMETADATA_NOHIGHLIGHT: UPDATEMETADATASTATES = 2;
pub const DDWARNING_HIGHLIGHT: WARNINGSTATES = 1;
pub const DDWARNING_NOHIGHLIGHT: WARNINGSTATES = 2;
pub const DD_COPY: DRAGDROPPARTS = 1;
pub const DD_CREATELINK: DRAGDROPPARTS = 4;
pub const DD_IMAGEBG: DRAGDROPPARTS = 7;
pub const DD_MOVE: DRAGDROPPARTS = 2;
pub const DD_NONE: DRAGDROPPARTS = 6;
pub const DD_TEXTBG: DRAGDROPPARTS = 8;
pub const DD_UPDATEMETADATA: DRAGDROPPARTS = 3;
pub const DD_WARNING: DRAGDROPPARTS = 5;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const DL_BEGINDRAG: DRAGLISTINFO_NOTIFICATION_FLAGS = 1157;
pub const DL_CANCELDRAG: DRAGLISTINFO_NOTIFICATION_FLAGS = 1160;
pub const DL_COPYCURSOR: u32 = 2;
pub const DL_CURSORSET: u32 = 0;
pub const DL_DRAGGING: DRAGLISTINFO_NOTIFICATION_FLAGS = 1158;
pub const DL_DROPPED: DRAGLISTINFO_NOTIFICATION_FLAGS = 1159;
pub const DL_MOVECURSOR: u32 = 3;
pub const DL_STOPCURSOR: u32 = 1;
pub const DNHZS_DISABLED: DOWNHORZSTATES = 4;
pub const DNHZS_HOT: DOWNHORZSTATES = 2;
pub const DNHZS_NORMAL: DOWNHORZSTATES = 1;
pub const DNHZS_PRESSED: DOWNHORZSTATES = 3;
pub const DNS_DISABLED: DOWNSTATES = 4;
pub const DNS_HOT: DOWNSTATES = 2;
pub const DNS_NORMAL: DOWNSTATES = 1;
pub const DNS_PRESSED: DOWNSTATES = 3;
pub type DOWNHORZSTATES = i32;
pub type DOWNSTATES = i32;
pub const DPAMM_DELETE: DPAMM_MESSAGE = 2;
pub const DPAMM_INSERT: DPAMM_MESSAGE = 3;
pub const DPAMM_MERGE: DPAMM_MESSAGE = 1;
...
pub const DPDB_DISABLED: DATEBORDERSTATES = 4;
pub const DPDB_FOCUSED: DATEBORDERSTATES = 3;
pub const DPDB_HOT: DATEBORDERSTATES = 2;
pub const DPDB_NORMAL: DATEBORDERSTATES = 1;
pub const DPDT_DISABLED: DATETEXTSTATES = 2;
pub const DPDT_NORMAL: DATETEXTSTATES = 1;
pub const DPDT_SELECTED: DATETEXTSTATES = 3;
pub const DPSCBR_DISABLED: SHOWCALENDARBUTTONRIGHTSTATES = 4;
pub const DPSCBR_HOT: SHOWCALENDARBUTTONRIGHTSTATES = 2;
pub const DPSCBR_NORMAL: SHOWCALENDARBUTTONRIGHTSTATES = 1;
pub const DPSCBR_PRESSED: SHOWCALENDARBUTTONRIGHTSTATES = 3;
pub const DP_DATEBORDER: DATEPICKERPARTS = 2;
pub const DP_DATETEXT: DATEPICKERPARTS = 1;
pub const DP_SHOWCALENDARBUTTONRIGHT: DATEPICKERPARTS = 3;
...
pub const DTPB_USECTLCOLORSTATIC: DRAW_THEME_PARENT_BACKGROUND_FLAGS = 2;
pub const DTPB_USEERASEBKGND: DRAW_THEME_PARENT_BACKGROUND_FLAGS = 4;
pub const DTPB_WINDOWDC: DRAW_THEME_PARENT_BACKGROUND_FLAGS = 1;
...
pub const DTT_APPLYOVERLAY: DTTOPTS_FLAGS = 1024;
pub const DTT_BORDERCOLOR: DTTOPTS_FLAGS = 2;
pub const DTT_BORDERSIZE: DTTOPTS_FLAGS = 32;
pub const DTT_CALCRECT: DTTOPTS_FLAGS = 512;
pub const DTT_CALLBACK: DTTOPTS_FLAGS = 4096;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub const DTT_COLORPROP: DTTOPTS_FLAGS = 128;
pub const DTT_COMPOSITED: DTTOPTS_FLAGS = 8192;
pub const DTT_FLAGS2VALIDBITS: u32 = 1;
pub const DTT_FONTPROP: DTTOPTS_FLAGS = 64;
pub const DTT_GLOWSIZE: DTTOPTS_FLAGS = 2048;
pub const DTT_GRAYED: u32 = 1;
pub const DTT_SHADOWCOLOR: DTTOPTS_FLAGS = 4;
pub const DTT_SHADOWOFFSET: DTTOPTS_FLAGS = 16;
pub const DTT_SHADOWTYPE: DTTOPTS_FLAGS = 8;
pub const DTT_STATEID: DTTOPTS_FLAGS = 256;
pub const DTT_TEXTCOLOR: DTTOPTS_FLAGS = 1;
pub const DTT_VALIDBITS: DTTOPTS_FLAGS = 12287;
pub const EBHC_HOT: HEADERCLOSESTATES = 2;
pub const EBHC_NORMAL: HEADERCLOSESTATES = 1;
pub const EBHC_PRESSED: HEADERCLOSESTATES = 3;
pub const EBHP_HOT: HEADERPINSTATES = 2;
pub const EBHP_NORMAL: HEADERPINSTATES = 1;
pub const EBHP_PRESSED: HEADERPINSTATES = 3;
pub const EBHP_SELECTEDHOT: HEADERPINSTATES = 5;
pub const EBHP_SELECTEDNORMAL: HEADERPINSTATES = 4;
pub const EBHP_SELECTEDPRESSED: HEADERPINSTATES = 6;
pub const EBM_HOT: IEBARMENUSTATES = 2;
pub const EBM_NORMAL: IEBARMENUSTATES = 1;
pub const EBM_PRESSED: IEBARMENUSTATES = 3;
pub const EBNGC_HOT: NORMALGROUPCOLLAPSESTATES = 2;
pub const EBNGC_NORMAL: NORMALGROUPCOLLAPSESTATES = 1;
pub const EBNGC_PRESSED: NORMALGROUPCOLLAPSESTATES = 3;
pub const EBNGE_HOT: NORMALGROUPEXPANDSTATES = 2;
pub const EBNGE_NORMAL: NORMALGROUPEXPANDSTATES = 1;
pub const EBNGE_PRESSED: NORMALGROUPEXPANDSTATES = 3;
pub const EBP_HEADERBACKGROUND: EXPLORERBARPARTS = 1;
pub const EBP_HEADERCLOSE: EXPLORERBARPARTS = 2;
pub const EBP_HEADERPIN: EXPLORERBARPARTS = 3;
pub const EBP_IEBARMENU: EXPLORERBARPARTS = 4;
pub const EBP_NORMALGROUPBACKGROUND: EXPLORERBARPARTS = 5;
pub const EBP_NORMALGROUPCOLLAPSE: EXPLORERBARPARTS = 6;
pub const EBP_NORMALGROUPEXPAND: EXPLORERBARPARTS = 7;
pub const EBP_NORMALGROUPHEAD: EXPLORERBARPARTS = 8;
pub const EBP_SPECIALGROUPBACKGROUND: EXPLORERBARPARTS = 9;
pub const EBP_SPECIALGROUPCOLLAPSE: EXPLORERBARPARTS = 10;
pub const EBP_SPECIALGROUPEXPAND: EXPLORERBARPARTS = 11;
pub const EBP_SPECIALGROUPHEAD: EXPLORERBARPARTS = 12;
pub const EBSGC_HOT: SPECIALGROUPCOLLAPSESTATES = 2;
pub const EBSGC_NORMAL: SPECIALGROUPCOLLAPSESTATES = 1;
pub const EBSGC_PRESSED: SPECIALGROUPCOLLAPSESTATES = 3;
pub const EBSGE_HOT: SPECIALGROUPEXPANDSTATES = 2;
pub const EBSGE_NORMAL: SPECIALGROUPEXPANDSTATES = 1;
pub const EBSGE_PRESSED: SPECIALGROUPEXPANDSTATES = 3;
pub const EBS_ASSIST: BACKGROUNDSTATES = 6;
pub const EBS_DISABLED: BACKGROUNDSTATES = 3;
pub const EBS_FOCUSED: BACKGROUNDSTATES = 4;
pub const EBS_HOT: BACKGROUNDSTATES = 2;
pub const EBS_NORMAL: BACKGROUNDSTATES = 1;
pub const EBS_READONLY: BACKGROUNDSTATES = 5;
pub const EBWBS_DISABLED: BACKGROUNDWITHBORDERSTATES = 3;
pub const EBWBS_FOCUSED: BACKGROUNDWITHBORDERSTATES = 4;
pub const EBWBS_HOT: BACKGROUNDWITHBORDERSTATES = 2;
pub const EBWBS_NORMAL: BACKGROUNDWITHBORDERSTATES = 1;
...
pub const EMF_CENTERED: NMLVEMPTYMARKUP_FLAGS = 1;
pub type EMPTYMARKUPPARTS = i32;
pub const EMP_MARKUPTEXT: EMPTYMARKUPPARTS = 1;
pub const EMT_LINKTEXT: MARKUPTEXTSTATES = 2;
pub const EMT_NORMALTEXT: MARKUPTEXTSTATES = 1;
...
pub const EPSHV_DISABLED: EDITBORDER_HVSCROLLSTATES = 4;
pub const EPSHV_FOCUSED: EDITBORDER_HVSCROLLSTATES = 3;
pub const EPSHV_HOT: EDITBORDER_HVSCROLLSTATES = 2;
pub const EPSHV_NORMAL: EDITBORDER_HVSCROLLSTATES = 1;
pub const EPSH_DISABLED: EDITBORDER_HSCROLLSTATES = 4;
pub const EPSH_FOCUSED: EDITBORDER_HSCROLLSTATES = 3;
pub const EPSH_HOT: EDITBORDER_HSCROLLSTATES = 2;
pub const EPSH_NORMAL: EDITBORDER_HSCROLLSTATES = 1;
pub const EPSN_DISABLED: EDITBORDER_NOSCROLLSTATES = 4;
pub const EPSN_FOCUSED: EDITBORDER_NOSCROLLSTATES = 3;
pub const EPSN_HOT: EDITBORDER_NOSCROLLSTATES = 2;
pub const EPSN_NORMAL: EDITBORDER_NOSCROLLSTATES = 1;
pub const EPSV_DISABLED: EDITBORDER_VSCROLLSTATES = 4;
pub const EPSV_FOCUSED: EDITBORDER_VSCROLLSTATES = 3;
pub const EPSV_HOT: EDITBORDER_VSCROLLSTATES = 2;
pub const EPSV_NORMAL: EDITBORDER_VSCROLLSTATES = 1;
pub const EP_BACKGROUND: EDITPARTS = 3;
pub const EP_BACKGROUNDWITHBORDER: EDITPARTS = 5;
pub const EP_CARET: EDITPARTS = 2;
pub const EP_EDITBORDER_HSCROLL: EDITPARTS = 7;
pub const EP_EDITBORDER_HVSCROLL: EDITPARTS = 9;
pub const EP_EDITBORDER_NOSCROLL: EDITPARTS = 6;
pub const EP_EDITBORDER_VSCROLL: EDITPARTS = 8;
pub const EP_EDITTEXT: EDITPARTS = 1;
pub const EP_PASSWORD: EDITPARTS = 4;
pub const ESB_DISABLE_BOTH: ENABLE_SCROLL_BAR_ARROWS = 3;
pub const ESB_DISABLE_DOWN: ENABLE_SCROLL_BAR_ARROWS = 2;
pub const ESB_DISABLE_LEFT: ENABLE_SCROLL_BAR_ARROWS = 1;
pub const ESB_DISABLE_LTUP: ENABLE_SCROLL_BAR_ARROWS = 1;
pub const ESB_DISABLE_RIGHT: ENABLE_SCROLL_BAR_ARROWS = 2;
pub const ESB_DISABLE_RTDN: ENABLE_SCROLL_BAR_ARROWS = 2;
pub const ESB_DISABLE_UP: ENABLE_SCROLL_BAR_ARROWS = 1;
pub const ESB_ENABLE_BOTH: ENABLE_SCROLL_BAR_ARROWS = 0;
...
pub const ETS_ASSIST: EDITTEXTSTATES = 7;
pub const ETS_CUEBANNER: EDITTEXTSTATES = 8;
pub const ETS_DISABLED: EDITTEXTSTATES = 4;
pub const ETS_FOCUSED: EDITTEXTSTATES = 5;
pub const ETS_HOT: EDITTEXTSTATES = 2;
pub const ETS_NORMAL: EDITTEXTSTATES = 1;
pub const ETS_READONLY: EDITTEXTSTATES = 6;
pub const ETS_SELECTED: EDITTEXTSTATES = 3;
pub type EXPANDBUTTONSTATES = i32;
pub type EXPANDOBUTTONSTATES = i32;
pub type EXPLORERBARPARTS = i32;
pub const FBS_EMPHASIZED: BODYSTATES = 2;
pub const FBS_NORMAL: BODYSTATES = 1;
...
pub const FLH_HOVER: LINKHEADERSTATES = 2;
pub const FLH_NORMAL: LINKHEADERSTATES = 1;
pub const FLS_DISABLED: LABELSTATES = 4;
pub const FLS_EMPHASIZED: LABELSTATES = 3;
pub const FLS_NORMAL: LABELSTATES = 1;
pub const FLS_SELECTED: LABELSTATES = 2;
pub const FLYOUTLINK_HOVER: LINKSTATES = 2;
pub const FLYOUTLINK_NORMAL: LINKSTATES = 1;
pub type FLYOUTPARTS = i32;
pub const FLYOUT_BODY: FLYOUTPARTS = 2;
pub const FLYOUT_DIVIDER: FLYOUTPARTS = 5;
pub const FLYOUT_HEADER: FLYOUTPARTS = 1;
pub const FLYOUT_LABEL: FLYOUTPARTS = 3;
pub const FLYOUT_LINK: FLYOUTPARTS = 4;
pub const FLYOUT_LINKAREA: FLYOUTPARTS = 7;
pub const FLYOUT_LINKHEADER: FLYOUTPARTS = 8;
pub const FLYOUT_WINDOW: FLYOUTPARTS = 6;
...
pub const FRB_ACTIVE: FRAMEBOTTOMSTATES = 1;
pub const FRB_INACTIVE: FRAMEBOTTOMSTATES = 2;
pub const FRL_ACTIVE: FRAMELEFTSTATES = 1;
pub const FRL_INACTIVE: FRAMELEFTSTATES = 2;
pub const FRR_ACTIVE: FRAMERIGHTSTATES = 1;
pub const FRR_INACTIVE: FRAMERIGHTSTATES = 2;
pub const FSB_ENCARTA_MODE: u32 = 1;
pub const FSB_FLAT_MODE: u32 = 2;
pub const FSB_REGULAR_MODE: u32 = 0;
pub const FS_ACTIVE: FRAMESTATES = 1;
pub const FS_INACTIVE: FRAMESTATES = 2;
pub const FT_HORZGRADIENT: FILLTYPE = 2;
pub const FT_RADIALGRADIENT: FILLTYPE = 3;
pub const FT_SOLID: FILLTYPE = 0;
pub const FT_TILEIMAGE: FILLTYPE = 4;
pub const FT_VERTGRADIENT: FILLTYPE = 1;
pub const GBF_COPY: GET_THEME_BITMAP_FLAGS = 2;
pub const GBF_DIRECT: GET_THEME_BITMAP_FLAGS = 1;
pub const GBF_VALIDBITS: GET_THEME_BITMAP_FLAGS = 3;
pub const GBS_DISABLED: GROUPBOXSTATES = 2;
pub const GBS_NORMAL: GROUPBOXSTATES = 1;
pub const GDTR_MAX: u32 = 2;
pub const GDTR_MIN: u32 = 1;
pub const GDT_ERROR: i32 = -1;
pub const GDT_NONE: NMDATETIMECHANGE_FLAGS = 1;
pub const GDT_VALID: NMDATETIMECHANGE_FLAGS = 0;
pub type GET_THEME_BITMAP_FLAGS = u32;
pub const GFST_DPI: GLYPHFONTSIZINGTYPE = 2;
pub const GFST_NONE: GLYPHFONTSIZINGTYPE = 0;
pub const GFST_SIZE: GLYPHFONTSIZINGTYPE = 1;
pub const GLPS_CLOSED: GLYPHSTATES = 1;
pub const GLPS_OPENED: GLYPHSTATES = 2;
...
pub const GT_FONTGLYPH: GLYPHTYPE = 2;
pub const GT_IMAGEGLYPH: GLYPHTYPE = 1;
pub const GT_NONE: GLYPHTYPE = 0;
pub type HALIGN = i32;
pub const HA_CENTER: HALIGN = 1;
pub const HA_LEFT: HALIGN = 0;
pub const HA_RIGHT: HALIGN = 2;
pub const HBG_DETAILS: HEADERSTYLESTATES = 1;
pub const HBG_ICON: HEADERSTYLESTATES = 2;
pub const HBS_DISABLED: HELPBUTTONSTATES = 4;
pub const HBS_HOT: HELPBUTTONSTATES = 2;
pub const HBS_NORMAL: HELPBUTTONSTATES = 1;
pub const HBS_PUSHED: HELPBUTTONSTATES = 3;
pub const HDDFS_HOT: HEADERDROPDOWNFILTERSTATES = 3;
pub const HDDFS_NORMAL: HEADERDROPDOWNFILTERSTATES = 1;
pub const HDDFS_SOFTHOT: HEADERDROPDOWNFILTERSTATES = 2;
pub const HDDS_HOT: HEADERDROPDOWNSTATES = 3;
pub const HDDS_NORMAL: HEADERDROPDOWNSTATES = 1;
pub const HDDS_SOFTHOT: HEADERDROPDOWNSTATES = 2;
pub const HDFT_HASNOVALUE: HEADER_CONTROL_FORMAT_TYPE = 32768;
pub const HDFT_ISDATE: HEADER_CONTROL_FORMAT_TYPE = 2;
pub const HDFT_ISNUMBER: HEADER_CONTROL_FORMAT_TYPE = 1;
pub const HDFT_ISSTRING: HEADER_CONTROL_FORMAT_TYPE = 0;
pub const HDF_BITMAP: HEADER_CONTROL_FORMAT_FLAGS = 8192;
pub const HDF_BITMAP_ON_RIGHT: HEADER_CONTROL_FORMAT_FLAGS = 4096;
pub const HDF_CENTER: HEADER_CONTROL_FORMAT_FLAGS = 2;
pub const HDF_CHECKBOX: HEADER_CONTROL_FORMAT_FLAGS = 64;
pub const HDF_CHECKED: HEADER_CONTROL_FORMAT_FLAGS = 128;
pub const HDF_FIXEDWIDTH: HEADER_CONTROL_FORMAT_FLAGS = 256;
pub const HDF_IMAGE: HEADER_CONTROL_FORMAT_FLAGS = 2048;
pub const HDF_JUSTIFYMASK: HEADER_CONTROL_FORMAT_FLAGS = 3;
pub const HDF_LEFT: HEADER_CONTROL_FORMAT_FLAGS = 0;
pub const HDF_OWNERDRAW: HEADER_CONTROL_FORMAT_FLAGS = 32768;
pub const HDF_RIGHT: HEADER_CONTROL_FORMAT_FLAGS = 1;
pub const HDF_RTLREADING: HEADER_CONTROL_FORMAT_FLAGS = 4;
pub const HDF_SORTDOWN: HEADER_CONTROL_FORMAT_FLAGS = 512;
pub const HDF_SORTUP: HEADER_CONTROL_FORMAT_FLAGS = 1024;
pub const HDF_SPLITBUTTON: HEADER_CONTROL_FORMAT_FLAGS = 16777216;
pub const HDF_STRING: HEADER_CONTROL_FORMAT_FLAGS = 16384;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const HDIS_FOCUSED: HEADER_CONTROL_FORMAT_STATE = 1;
#[repr(C)]
#[cfg(feature = "Win32_Graphics_Gdi")]
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct HDITEMA {
...
pub const HDI_BITMAP: HDI_MASK = 16;
pub const HDI_DI_SETITEM: HDI_MASK = 64;
pub const HDI_FILTER: HDI_MASK = 256;
pub const HDI_FORMAT: HDI_MASK = 4;
pub const HDI_HEIGHT: HDI_MASK = 1;
pub const HDI_IMAGE: HDI_MASK = 32;
pub const HDI_LPARAM: HDI_MASK = 8;
pub type HDI_MASK = u32;
pub const HDI_ORDER: HDI_MASK = 128;
pub const HDI_STATE: HDI_MASK = 512;
pub const HDI_TEXT: HDI_MASK = 2;
pub const HDI_WIDTH: HDI_MASK = 1;
#[repr(C)]
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct HDLAYOUT {
...
pub const HEADER_CONTROL_NOTIFICATION_BUTTON_LEFT: HEADER_CONTROL_NOTIFICATION_BUTTON = 0;
pub const HEADER_CONTROL_NOTIFICATION_BUTTON_MIDDLE: HEADER_CONTROL_NOTIFICATION_BUTTON = 2;
pub const HEADER_CONTROL_NOTIFICATION_BUTTON_RIGHT: HEADER_CONTROL_NOTIFICATION_BUTTON = 1;
pub type HEADER_HITTEST_INFO_FLAGS = u32;
pub type HELPBUTTONSTATES = i32;
pub type HELPLINKSTATES = i32;
pub const HGLPS_CLOSED: HOTGLYPHSTATES = 1;
pub const HGLPS_OPENED: HOTGLYPHSTATES = 2;
pub const HHT_ABOVE: HEADER_HITTEST_INFO_FLAGS = 256;
pub const HHT_BELOW: HEADER_HITTEST_INFO_FLAGS = 512;
pub const HHT_NOWHERE: HEADER_HITTEST_INFO_FLAGS = 1;
pub const HHT_ONDIVIDER: HEADER_HITTEST_INFO_FLAGS = 4;
pub const HHT_ONDIVOPEN: HEADER_HITTEST_INFO_FLAGS = 8;
pub const HHT_ONDROPDOWN: HEADER_HITTEST_INFO_FLAGS = 8192;
pub const HHT_ONFILTER: HEADER_HITTEST_INFO_FLAGS = 16;
pub const HHT_ONFILTERBUTTON: HEADER_HITTEST_INFO_FLAGS = 32;
pub const HHT_ONHEADER: HEADER_HITTEST_INFO_FLAGS = 2;
pub const HHT_ONITEMSTATEICON: HEADER_HITTEST_INFO_FLAGS = 4096;
pub const HHT_ONOVERFLOW: HEADER_HITTEST_INFO_FLAGS = 16384;
pub const HHT_TOLEFT: HEADER_HITTEST_INFO_FLAGS = 2048;
pub const HHT_TORIGHT: HEADER_HITTEST_INFO_FLAGS = 1024;
pub const HICF_ACCELERATOR: NMTBHOTITEM_FLAGS = 4;
pub const HICF_ARROWKEYS: NMTBHOTITEM_FLAGS = 2;
pub const HICF_DUPACCEL: NMTBHOTITEM_FLAGS = 8;
pub const HICF_ENTERING: NMTBHOTITEM_FLAGS = 16;
pub const HICF_LEAVING: NMTBHOTITEM_FLAGS = 32;
pub const HICF_LMOUSE: NMTBHOTITEM_FLAGS = 128;
pub const HICF_MOUSE: NMTBHOTITEM_FLAGS = 1;
pub const HICF_OTHER: NMTBHOTITEM_FLAGS = 0;
pub const HICF_RESELECT: NMTBHOTITEM_FLAGS = 64;
pub const HICF_TOGGLEDROPDOWN: NMTBHOTITEM_FLAGS = 256;
pub const HILS_HOT: HEADERITEMLEFTSTATES = 2;
pub const HILS_NORMAL: HEADERITEMLEFTSTATES = 1;
pub const HILS_PRESSED: HEADERITEMLEFTSTATES = 3;
pub type HIMAGELIST = isize;
pub const HIRS_HOT: HEADERITEMRIGHTSTATES = 2;
pub const HIRS_NORMAL: HEADERITEMRIGHTSTATES = 1;
pub const HIRS_PRESSED: HEADERITEMRIGHTSTATES = 3;
...
pub const HIS_HOT: HEADERITEMSTATES = 2;
pub const HIS_ICONHOT: HEADERITEMSTATES = 8;
pub const HIS_ICONNORMAL: HEADERITEMSTATES = 7;
pub const HIS_ICONPRESSED: HEADERITEMSTATES = 9;
pub const HIS_ICONSORTEDHOT: HEADERITEMSTATES = 11;
pub const HIS_ICONSORTEDNORMAL: HEADERITEMSTATES = 10;
pub const HIS_ICONSORTEDPRESSED: HEADERITEMSTATES = 12;
pub const HIS_NORMAL: HEADERITEMSTATES = 1;
pub const HIS_PRESSED: HEADERITEMSTATES = 3;
pub const HIS_SORTEDHOT: HEADERITEMSTATES = 5;
pub const HIS_SORTEDNORMAL: HEADERITEMSTATES = 4;
pub const HIS_SORTEDPRESSED: HEADERITEMSTATES = 6;
...
pub const HLS_LINKTEXT: HYPERLINKSTATES = 2;
pub const HLS_NORMALTEXT: HYPERLINKSTATES = 1;
pub const HOFS_HOT: HEADEROVERFLOWSTATES = 2;
pub const HOFS_NORMAL: HEADEROVERFLOWSTATES = 1;
...
pub const HP_HEADERDROPDOWN: HEADERPARTS = 5;
pub const HP_HEADERDROPDOWNFILTER: HEADERPARTS = 6;
pub const HP_HEADERITEM: HEADERPARTS = 1;
pub const HP_HEADERITEMLEFT: HEADERPARTS = 2;
pub const HP_HEADERITEMRIGHT: HEADERPARTS = 3;
pub const HP_HEADEROVERFLOW: HEADERPARTS = 7;
pub const HP_HEADERSORTARROW: HEADERPARTS = 4;
pub const HSAS_SORTEDDOWN: HEADERSORTARROWSTATES = 2;
pub const HSAS_SORTEDUP: HEADERSORTARROWSTATES = 1;
pub const HSS_DISABLED: HORZSCROLLSTATES = 4;
pub const HSS_HOT: HORZSCROLLSTATES = 2;
pub const HSS_NORMAL: HORZSCROLLSTATES = 1;
pub const HSS_PUSHED: HORZSCROLLSTATES = 3;
pub type HTHEME = isize;
pub type HTREEITEM = isize;
pub const HTS_DISABLED: HORZTHUMBSTATES = 4;
pub const HTS_HOT: HORZTHUMBSTATES = 2;
pub const HTS_NORMAL: HORZTHUMBSTATES = 1;
pub const HTS_PUSHED: HORZTHUMBSTATES = 3;
pub const HTTB_BACKGROUNDSEG: HIT_TEST_BACKGROUND_OPTIONS = 0;
pub const HTTB_CAPTION: HIT_TEST_BACKGROUND_OPTIONS = 4;
pub const HTTB_FIXEDBORDER: HIT_TEST_BACKGROUND_OPTIONS = 2;
pub const HTTB_RESIZINGBORDER: HIT_TEST_BACKGROUND_OPTIONS = 240;
pub const HTTB_RESIZINGBORDER_BOTTOM: HIT_TEST_BACKGROUND_OPTIONS = 128;
pub const HTTB_RESIZINGBORDER_LEFT: HIT_TEST_BACKGROUND_OPTIONS = 16;
pub const HTTB_RESIZINGBORDER_RIGHT: HIT_TEST_BACKGROUND_OPTIONS = 64;
pub const HTTB_RESIZINGBORDER_TOP: HIT_TEST_BACKGROUND_OPTIONS = 32;
pub const HTTB_SIZINGTEMPLATE: HIT_TEST_BACKGROUND_OPTIONS = 256;
pub const HTTB_SYSTEMSIZINGMARGINS: HIT_TEST_BACKGROUND_OPTIONS = 512;
pub type HYPERLINKSTATES = i32;
pub type HYPERLINKTEXTSTATES = i32;
pub const ICC_ANIMATE_CLASS: INITCOMMONCONTROLSEX_ICC = 128;
pub const ICC_BAR_CLASSES: INITCOMMONCONTROLSEX_ICC = 4;
pub const ICC_COOL_CLASSES: INITCOMMONCONTROLSEX_ICC = 1024;
pub const ICC_DATE_CLASSES: INITCOMMONCONTROLSEX_ICC = 256;
pub const ICC_HOTKEY_CLASS: INITCOMMONCONTROLSEX_ICC = 64;
pub const ICC_INTERNET_CLASSES: INITCOMMONCONTROLSEX_ICC = 2048;
pub const ICC_LINK_CLASS: INITCOMMONCONTROLSEX_ICC = 32768;
pub const ICC_LISTVIEW_CLASSES: INITCOMMONCONTROLSEX_ICC = 1;
pub const ICC_NATIVEFNTCTL_CLASS: INITCOMMONCONTROLSEX_ICC = 8192;
pub const ICC_PAGESCROLLER_CLASS: INITCOMMONCONTROLSEX_ICC = 4096;
pub const ICC_PROGRESS_CLASS: INITCOMMONCONTROLSEX_ICC = 32;
pub const ICC_STANDARD_CLASSES: INITCOMMONCONTROLSEX_ICC = 16384;
pub const ICC_TAB_CLASSES: INITCOMMONCONTROLSEX_ICC = 8;
pub const ICC_TREEVIEW_CLASSES: INITCOMMONCONTROLSEX_ICC = 2;
pub const ICC_UPDOWN_CLASS: INITCOMMONCONTROLSEX_ICC = 16;
pub const ICC_USEREX_CLASSES: INITCOMMONCONTROLSEX_ICC = 512;
pub const ICC_WIN95_CLASSES: INITCOMMONCONTROLSEX_ICC = 255;
pub const ICE_ALPHA: ICONEFFECT = 4;
pub const ICE_GLOW: ICONEFFECT = 1;
pub const ICE_NONE: ICONEFFECT = 0;
pub const ICE_PULSE: ICONEFFECT = 3;
pub const ICE_SHADOW: ICONEFFECT = 2;
...
pub const ILCF_MOVE: IMAGE_LIST_COPY_FLAGS = 0;
pub const ILCF_SWAP: IMAGE_LIST_COPY_FLAGS = 1;
pub const ILC_COLOR: IMAGELIST_CREATION_FLAGS = 0;
pub const ILC_COLOR16: IMAGELIST_CREATION_FLAGS = 16;
pub const ILC_COLOR24: IMAGELIST_CREATION_FLAGS = 24;
pub const ILC_COLOR32: IMAGELIST_CREATION_FLAGS = 32;
pub const ILC_COLOR4: IMAGELIST_CREATION_FLAGS = 4;
pub const ILC_COLOR8: IMAGELIST_CREATION_FLAGS = 8;
pub const ILC_COLORDDB: IMAGELIST_CREATION_FLAGS = 254;
pub const ILC_HIGHQUALITYSCALE: IMAGELIST_CREATION_FLAGS = 131072;
pub const ILC_MASK: IMAGELIST_CREATION_FLAGS = 1;
pub const ILC_MIRROR: IMAGELIST_CREATION_FLAGS = 8192;
pub const ILC_ORIGINALSIZE: IMAGELIST_CREATION_FLAGS = 65536;
pub const ILC_PALETTE: IMAGELIST_CREATION_FLAGS = 2048;
pub const ILC_PERITEMMIRROR: IMAGELIST_CREATION_FLAGS = 32768;
...
pub const ILD_ASYNC: IMAGE_LIST_DRAW_STYLE = 32768;
pub const ILD_BLEND: IMAGE_LIST_DRAW_STYLE = 4;
pub const ILD_BLEND25: IMAGE_LIST_DRAW_STYLE = 2;
pub const ILD_BLEND50: IMAGE_LIST_DRAW_STYLE = 4;
pub const ILD_DPISCALE: IMAGE_LIST_DRAW_STYLE = 16384;
pub const ILD_FOCUS: IMAGE_LIST_DRAW_STYLE = 2;
pub const ILD_IMAGE: IMAGE_LIST_DRAW_STYLE = 32;
pub const ILD_MASK: IMAGE_LIST_DRAW_STYLE = 16;
pub const ILD_NORMAL: IMAGE_LIST_DRAW_STYLE = 0;
pub const ILD_OVERLAYMASK: IMAGE_LIST_DRAW_STYLE = 3840;
pub const ILD_PRESERVEALPHA: IMAGE_LIST_DRAW_STYLE = 4096;
pub const ILD_ROP: IMAGE_LIST_DRAW_STYLE = 64;
pub const ILD_SCALE: IMAGE_LIST_DRAW_STYLE = 8192;
pub const ILD_SELECTED: IMAGE_LIST_DRAW_STYLE = 4;
pub const ILD_TRANSPARENT: IMAGE_LIST_DRAW_STYLE = 1;
...
pub const ILIF_ALPHA: IMAGE_LIST_ITEM_FLAGS = 1;
pub const ILIF_LOWQUALITY: IMAGE_LIST_ITEM_FLAGS = 2;
pub const ILP_DOWNLEVEL: IMAGE_LIST_WRITE_STREAM_FLAGS = 1;
pub const ILP_NORMAL: IMAGE_LIST_WRITE_STREAM_FLAGS = 0;
...
pub const IL_HORIZONTAL: IMAGELAYOUT = 1;
pub const IL_VERTICAL: IMAGELAYOUT = 0;
#[repr(C)]
#[cfg(feature = "Win32_Graphics_Gdi")]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const IST_DPI: IMAGESELECTTYPE = 2;
pub const IST_NONE: IMAGESELECTTYPE = 0;
pub const IST_SIZE: IMAGESELECTTYPE = 1;
pub type ITEMSTATES = i32;
pub const I_CHILDRENAUTO: TVITEMEXW_CHILDREN = -2;
pub const I_CHILDRENCALLBACK: TVITEMEXW_CHILDREN = -1;
pub const I_GROUPIDCALLBACK: LVITEMA_GROUP_ID = -1;
pub const I_GROUPIDNONE: LVITEMA_GROUP_ID = -2;
pub const I_IMAGECALLBACK: i32 = -1;
pub const I_IMAGENONE: i32 = -2;
pub const I_INDENTCALLBACK: i32 = -1;
pub const I_ONE_OR_MORE: TVITEMEXW_CHILDREN = 1;
pub const I_ZERO: TVITEMEXW_CHILDREN = 0;
...
pub const LBCP_BORDER_HSCROLL: LISTBOXPARTS = 1;
pub const LBCP_BORDER_HVSCROLL: LISTBOXPARTS = 2;
pub const LBCP_BORDER_NOSCROLL: LISTBOXPARTS = 3;
pub const LBCP_BORDER_VSCROLL: LISTBOXPARTS = 4;
pub const LBCP_ITEM: LISTBOXPARTS = 5;
pub const LBPSHV_DISABLED: BORDER_HVSCROLLSTATES = 4;
pub const LBPSHV_FOCUSED: BORDER_HVSCROLLSTATES = 2;
pub const LBPSHV_HOT: BORDER_HVSCROLLSTATES = 3;
pub const LBPSHV_NORMAL: BORDER_HVSCROLLSTATES = 1;
pub const LBPSH_DISABLED: BORDER_HSCROLLSTATES = 4;
pub const LBPSH_FOCUSED: BORDER_HSCROLLSTATES = 2;
pub const LBPSH_HOT: BORDER_HSCROLLSTATES = 3;
pub const LBPSH_NORMAL: BORDER_HSCROLLSTATES = 1;
pub const LBPSI_HOT: ITEMSTATES = 1;
pub const LBPSI_HOTSELECTED: ITEMSTATES = 2;
pub const LBPSI_SELECTED: ITEMSTATES = 3;
pub const LBPSI_SELECTEDNOTFOCUS: ITEMSTATES = 4;
pub const LBPSN_DISABLED: BORDER_NOSCROLLSTATES = 4;
pub const LBPSN_FOCUSED: BORDER_NOSCROLLSTATES = 2;
pub const LBPSN_HOT: BORDER_NOSCROLLSTATES = 3;
pub const LBPSN_NORMAL: BORDER_NOSCROLLSTATES = 1;
pub const LBPSV_DISABLED: BORDER_VSCROLLSTATES = 4;
pub const LBPSV_FOCUSED: BORDER_VSCROLLSTATES = 2;
pub const LBPSV_HOT: BORDER_VSCROLLSTATES = 3;
pub const LBPSV_NORMAL: BORDER_VSCROLLSTATES = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const LIF_ITEMID: LIST_ITEM_FLAGS = 4;
pub const LIF_ITEMINDEX: LIST_ITEM_FLAGS = 1;
pub const LIF_STATE: LIST_ITEM_FLAGS = 2;
pub const LIF_URL: LIST_ITEM_FLAGS = 8;
...
pub const LISS_DISABLED: LISTITEMSTATES = 4;
pub const LISS_HOT: LISTITEMSTATES = 2;
pub const LISS_HOTSELECTED: LISTITEMSTATES = 6;
pub const LISS_NORMAL: LISTITEMSTATES = 1;
pub const LISS_SELECTED: LISTITEMSTATES = 3;
pub const LISS_SELECTEDNOTFOCUS: LISTITEMSTATES = 5;
...
pub const LIS_DEFAULTCOLORS: LIST_ITEM_STATE_FLAGS = 16;
pub const LIS_ENABLED: LIST_ITEM_STATE_FLAGS = 2;
pub const LIS_FOCUSED: LIST_ITEM_STATE_FLAGS = 1;
pub const LIS_HOTTRACK: LIST_ITEM_STATE_FLAGS = 8;
pub const LIS_VISITED: LIST_ITEM_STATE_FLAGS = 4;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct LITEM {
...
pub const LP_HYPERLINK: LINKPARTS = 1;
pub const LVA_ALIGNLEFT: u32 = 1;
pub const LVA_ALIGNTOP: u32 = 2;
pub const LVA_DEFAULT: u32 = 0;
pub const LVA_SNAPTOGRID: u32 = 5;
pub const LVBKIF_FLAG_ALPHABLEND: LIST_VIEW_BACKGROUND_IMAGE_FLAGS = 536870912;
pub const LVBKIF_FLAG_TILEOFFSET: LIST_VIEW_BACKGROUND_IMAGE_FLAGS = 256;
pub const LVBKIF_SOURCE_HBITMAP: LIST_VIEW_BACKGROUND_IMAGE_FLAGS = 1;
pub const LVBKIF_SOURCE_MASK: LIST_VIEW_BACKGROUND_IMAGE_FLAGS = 3;
pub const LVBKIF_SOURCE_NONE: LIST_VIEW_BACKGROUND_IMAGE_FLAGS = 0;
pub const LVBKIF_SOURCE_URL: LIST_VIEW_BACKGROUND_IMAGE_FLAGS = 2;
pub const LVBKIF_STYLE_MASK: LIST_VIEW_BACKGROUND_IMAGE_FLAGS = 16;
pub const LVBKIF_STYLE_NORMAL: LIST_VIEW_BACKGROUND_IMAGE_FLAGS = 0;
pub const LVBKIF_STYLE_TILE: LIST_VIEW_BACKGROUND_IMAGE_FLAGS = 16;
pub const LVBKIF_TYPE_WATERMARK: LIST_VIEW_BACKGROUND_IMAGE_FLAGS = 268435456;
#[repr(C)]
#[cfg(feature = "Win32_Graphics_Gdi")]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const LVCB_HOVER: COLLAPSEBUTTONSTATES = 2;
pub const LVCB_NORMAL: COLLAPSEBUTTONSTATES = 1;
pub const LVCB_PUSHED: COLLAPSEBUTTONSTATES = 3;
pub const LVCDI_GROUP: NMLVCUSTOMDRAW_ITEM_TYPE = 1;
pub const LVCDI_ITEM: NMLVCUSTOMDRAW_ITEM_TYPE = 0;
pub const LVCDI_ITEMSLIST: NMLVCUSTOMDRAW_ITEM_TYPE = 2;
pub const LVCDRF_NOGROUPFRAME: u32 = 131072;
pub const LVCDRF_NOSELECT: u32 = 65536;
pub const LVCFMT_BITMAP_ON_RIGHT: LVCOLUMNW_FORMAT = 4096;
pub const LVCFMT_CENTER: LVCOLUMNW_FORMAT = 2;
pub const LVCFMT_COL_HAS_IMAGES: LVCOLUMNW_FORMAT = 32768;
pub const LVCFMT_FILL: LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS = 2097152;
pub const LVCFMT_FIXED_RATIO: LVCOLUMNW_FORMAT = 524288;
pub const LVCFMT_FIXED_WIDTH: LVCOLUMNW_FORMAT = 256;
pub const LVCFMT_IMAGE: LVCOLUMNW_FORMAT = 2048;
pub const LVCFMT_JUSTIFYMASK: LVCOLUMNW_FORMAT = 3;
pub const LVCFMT_LEFT: LVCOLUMNW_FORMAT = 0;
pub const LVCFMT_LINE_BREAK: LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS = 1048576;
pub const LVCFMT_NO_DPI_SCALE: LVCOLUMNW_FORMAT = 262144;
pub const LVCFMT_NO_TITLE: LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS = 8388608;
pub const LVCFMT_RIGHT: LVCOLUMNW_FORMAT = 1;
pub const LVCFMT_SPLITBUTTON: LVCOLUMNW_FORMAT = 16777216;
pub const LVCFMT_TILE_PLACEMENTMASK: LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS = 3145728;
pub const LVCFMT_WRAP: LIST_VIEW_ITEM_COLUMN_FORMAT_FLAGS = 4194304;
pub const LVCF_DEFAULTWIDTH: LVCOLUMNW_MASK = 128;
pub const LVCF_FMT: LVCOLUMNW_MASK = 1;
pub const LVCF_IDEALWIDTH: LVCOLUMNW_MASK = 256;
pub const LVCF_IMAGE: LVCOLUMNW_MASK = 16;
pub const LVCF_MINWIDTH: LVCOLUMNW_MASK = 64;
pub const LVCF_ORDER: LVCOLUMNW_MASK = 32;
pub const LVCF_SUBITEM: LVCOLUMNW_MASK = 8;
pub const LVCF_TEXT: LVCOLUMNW_MASK = 4;
pub const LVCF_WIDTH: LVCOLUMNW_MASK = 2;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const LVEB_HOVER: EXPANDBUTTONSTATES = 2;
pub const LVEB_NORMAL: EXPANDBUTTONSTATES = 1;
pub const LVEB_PUSHED: EXPANDBUTTONSTATES = 3;
pub const LVFF_ITEMCOUNT: u32 = 1;
pub const LVFIF_STATE: LVFOOTERITEM_MASK = 2;
pub const LVFIF_TEXT: LVFOOTERITEM_MASK = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const LVFI_NEARESTXY: LVFINDINFOW_FLAGS = 64;
pub const LVFI_PARAM: LVFINDINFOW_FLAGS = 1;
pub const LVFI_PARTIAL: LVFINDINFOW_FLAGS = 8;
pub const LVFI_STRING: LVFINDINFOW_FLAGS = 2;
pub const LVFI_SUBSTRING: LVFINDINFOW_FLAGS = 4;
pub const LVFI_WRAP: LVFINDINFOW_FLAGS = 32;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const LVGA_FOOTER_CENTER: LIST_VIEW_GROUP_ALIGN_FLAGS = 16;
pub const LVGA_FOOTER_LEFT: LIST_VIEW_GROUP_ALIGN_FLAGS = 8;
pub const LVGA_FOOTER_RIGHT: LIST_VIEW_GROUP_ALIGN_FLAGS = 32;
pub const LVGA_HEADER_CENTER: LIST_VIEW_GROUP_ALIGN_FLAGS = 2;
pub const LVGA_HEADER_LEFT: LIST_VIEW_GROUP_ALIGN_FLAGS = 1;
pub const LVGA_HEADER_RIGHT: LIST_VIEW_GROUP_ALIGN_FLAGS = 4;
pub const LVGF_ALIGN: LVGROUP_MASK = 8;
pub const LVGF_DESCRIPTIONBOTTOM: LVGROUP_MASK = 2048;
pub const LVGF_DESCRIPTIONTOP: LVGROUP_MASK = 1024;
pub const LVGF_EXTENDEDIMAGE: LVGROUP_MASK = 8192;
pub const LVGF_FOOTER: LVGROUP_MASK = 2;
pub const LVGF_GROUPID: LVGROUP_MASK = 16;
pub const LVGF_HEADER: LVGROUP_MASK = 1;
pub const LVGF_ITEMS: LVGROUP_MASK = 16384;
pub const LVGF_NONE: LVGROUP_MASK = 0;
pub const LVGF_STATE: LVGROUP_MASK = 4;
pub const LVGF_SUBSET: LVGROUP_MASK = 32768;
pub const LVGF_SUBSETITEMS: LVGROUP_MASK = 65536;
pub const LVGF_SUBTITLE: LVGROUP_MASK = 256;
pub const LVGF_TASK: LVGROUP_MASK = 512;
pub const LVGF_TITLEIMAGE: LVGROUP_MASK = 4096;
pub const LVGGR_GROUP: u32 = 0;
pub const LVGGR_HEADER: u32 = 1;
pub const LVGGR_LABEL: u32 = 2;
pub const LVGGR_SUBSETLINK: u32 = 3;
pub const LVGHL_CLOSE: GROUPHEADERLINESTATES = 9;
pub const LVGHL_CLOSEHOT: GROUPHEADERLINESTATES = 10;
pub const LVGHL_CLOSEMIXEDSELECTION: GROUPHEADERLINESTATES = 15;
pub const LVGHL_CLOSEMIXEDSELECTIONHOT: GROUPHEADERLINESTATES = 16;
pub const LVGHL_CLOSESELECTED: GROUPHEADERLINESTATES = 11;
pub const LVGHL_CLOSESELECTEDHOT: GROUPHEADERLINESTATES = 12;
pub const LVGHL_CLOSESELECTEDNOTFOCUSED: GROUPHEADERLINESTATES = 13;
pub const LVGHL_CLOSESELECTEDNOTFOCUSEDHOT: GROUPHEADERLINESTATES = 14;
pub const LVGHL_OPEN: GROUPHEADERLINESTATES = 1;
pub const LVGHL_OPENHOT: GROUPHEADERLINESTATES = 2;
pub const LVGHL_OPENMIXEDSELECTION: GROUPHEADERLINESTATES = 7;
pub const LVGHL_OPENMIXEDSELECTIONHOT: GROUPHEADERLINESTATES = 8;
pub const LVGHL_OPENSELECTED: GROUPHEADERLINESTATES = 3;
pub const LVGHL_OPENSELECTEDHOT: GROUPHEADERLINESTATES = 4;
pub const LVGHL_OPENSELECTEDNOTFOCUSED: GROUPHEADERLINESTATES = 5;
pub const LVGHL_OPENSELECTEDNOTFOCUSEDHOT: GROUPHEADERLINESTATES = 6;
pub const LVGH_CLOSE: GROUPHEADERSTATES = 9;
pub const LVGH_CLOSEHOT: GROUPHEADERSTATES = 10;
pub const LVGH_CLOSEMIXEDSELECTION: GROUPHEADERSTATES = 15;
pub const LVGH_CLOSEMIXEDSELECTIONHOT: GROUPHEADERSTATES = 16;
pub const LVGH_CLOSESELECTED: GROUPHEADERSTATES = 11;
pub const LVGH_CLOSESELECTEDHOT: GROUPHEADERSTATES = 12;
pub const LVGH_CLOSESELECTEDNOTFOCUSED: GROUPHEADERSTATES = 13;
pub const LVGH_CLOSESELECTEDNOTFOCUSEDHOT: GROUPHEADERSTATES = 14;
pub const LVGH_OPEN: GROUPHEADERSTATES = 1;
pub const LVGH_OPENHOT: GROUPHEADERSTATES = 2;
pub const LVGH_OPENMIXEDSELECTION: GROUPHEADERSTATES = 7;
pub const LVGH_OPENMIXEDSELECTIONHOT: GROUPHEADERSTATES = 8;
pub const LVGH_OPENSELECTED: GROUPHEADERSTATES = 3;
pub const LVGH_OPENSELECTEDHOT: GROUPHEADERSTATES = 4;
pub const LVGH_OPENSELECTEDNOTFOCUSED: GROUPHEADERSTATES = 5;
pub const LVGH_OPENSELECTEDNOTFOCUSEDHOT: GROUPHEADERSTATES = 6;
pub const LVGIT_UNFOLDED: NMLVGETINFOTIP_FLAGS = 1;
pub const LVGIT_ZERO: NMLVGETINFOTIP_FLAGS = 0;
...
pub const LVGS_COLLAPSED: LIST_VIEW_GROUP_STATE_FLAGS = 1;
pub const LVGS_COLLAPSIBLE: LIST_VIEW_GROUP_STATE_FLAGS = 8;
pub const LVGS_FOCUSED: LIST_VIEW_GROUP_STATE_FLAGS = 16;
pub const LVGS_HIDDEN: LIST_VIEW_GROUP_STATE_FLAGS = 2;
pub const LVGS_NOHEADER: LIST_VIEW_GROUP_STATE_FLAGS = 4;
pub const LVGS_NORMAL: LIST_VIEW_GROUP_STATE_FLAGS = 0;
pub const LVGS_SELECTED: LIST_VIEW_GROUP_STATE_FLAGS = 32;
pub const LVGS_SUBSETED: LIST_VIEW_GROUP_STATE_FLAGS = 64;
pub const LVGS_SUBSETLINKFOCUSED: LIST_VIEW_GROUP_STATE_FLAGS = 128;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const LVHT_ABOVE: LVHITTESTINFO_FLAGS = 8;
pub const LVHT_BELOW: LVHITTESTINFO_FLAGS = 16;
pub const LVHT_EX_FOOTER: LVHITTESTINFO_FLAGS = 134217728;
pub const LVHT_EX_GROUP: LVHITTESTINFO_FLAGS = 4076863488;
pub const LVHT_EX_GROUP_BACKGROUND: LVHITTESTINFO_FLAGS = 2147483648;
pub const LVHT_EX_GROUP_COLLAPSE: LVHITTESTINFO_FLAGS = 1073741824;
pub const LVHT_EX_GROUP_FOOTER: LVHITTESTINFO_FLAGS = 536870912;
pub const LVHT_EX_GROUP_HEADER: LVHITTESTINFO_FLAGS = 268435456;
pub const LVHT_EX_GROUP_STATEICON: LVHITTESTINFO_FLAGS = 16777216;
pub const LVHT_EX_GROUP_SUBSETLINK: LVHITTESTINFO_FLAGS = 33554432;
pub const LVHT_EX_ONCONTENTS: LVHITTESTINFO_FLAGS = 67108864;
pub const LVHT_NOWHERE: LVHITTESTINFO_FLAGS = 1;
pub const LVHT_ONITEMICON: LVHITTESTINFO_FLAGS = 2;
pub const LVHT_ONITEMLABEL: LVHITTESTINFO_FLAGS = 4;
pub const LVHT_ONITEMSTATEICON: LVHITTESTINFO_FLAGS = 8;
pub const LVHT_TOLEFT: LVHITTESTINFO_FLAGS = 64;
pub const LVHT_TORIGHT: LVHITTESTINFO_FLAGS = 32;
pub const LVIF_COLFMT: LIST_VIEW_ITEM_FLAGS = 65536;
pub const LVIF_COLUMNS: LIST_VIEW_ITEM_FLAGS = 512;
pub const LVIF_DI_SETITEM: LIST_VIEW_ITEM_FLAGS = 4096;
pub const LVIF_GROUPID: LIST_VIEW_ITEM_FLAGS = 256;
pub const LVIF_IMAGE: LIST_VIEW_ITEM_FLAGS = 2;
pub const LVIF_INDENT: LIST_VIEW_ITEM_FLAGS = 16;
pub const LVIF_NORECOMPUTE: LIST_VIEW_ITEM_FLAGS = 2048;
pub const LVIF_PARAM: LIST_VIEW_ITEM_FLAGS = 4;
pub const LVIF_STATE: LIST_VIEW_ITEM_FLAGS = 8;
pub const LVIF_TEXT: LIST_VIEW_ITEM_FLAGS = 1;
...
pub const LVIS_ACTIVATING: LIST_VIEW_ITEM_STATE_FLAGS = 32;
pub const LVIS_CUT: LIST_VIEW_ITEM_STATE_FLAGS = 4;
pub const LVIS_DROPHILITED: LIST_VIEW_ITEM_STATE_FLAGS = 8;
pub const LVIS_FOCUSED: LIST_VIEW_ITEM_STATE_FLAGS = 1;
pub const LVIS_GLOW: LIST_VIEW_ITEM_STATE_FLAGS = 16;
pub const LVIS_OVERLAYMASK: LIST_VIEW_ITEM_STATE_FLAGS = 3840;
pub const LVIS_SELECTED: LIST_VIEW_ITEM_STATE_FLAGS = 2;
pub const LVIS_STATEIMAGEMASK: LIST_VIEW_ITEM_STATE_FLAGS = 61440;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct LVITEMA {
...
pub const LVP_COLLAPSEBUTTON: LISTVIEWPARTS = 9;
pub const LVP_COLUMNDETAIL: LISTVIEWPARTS = 10;
pub const LVP_EMPTYTEXT: LISTVIEWPARTS = 5;
pub const LVP_EXPANDBUTTON: LISTVIEWPARTS = 8;
pub const LVP_GROUPHEADER: LISTVIEWPARTS = 6;
pub const LVP_GROUPHEADERLINE: LISTVIEWPARTS = 7;
pub const LVP_LISTDETAIL: LISTVIEWPARTS = 3;
pub const LVP_LISTGROUP: LISTVIEWPARTS = 2;
pub const LVP_LISTITEM: LISTVIEWPARTS = 1;
pub const LVP_LISTSORTEDDETAIL: LISTVIEWPARTS = 4;
...
pub const LVTVIF_AUTOSIZE: LVTILEVIEWINFO_FLAGS = 0;
pub const LVTVIF_EXTENDED: u32 = 4;
pub const LVTVIF_FIXEDHEIGHT: LVTILEVIEWINFO_FLAGS = 2;
pub const LVTVIF_FIXEDSIZE: LVTILEVIEWINFO_FLAGS = 3;
pub const LVTVIF_FIXEDWIDTH: LVTILEVIEWINFO_FLAGS = 1;
pub const LVTVIM_COLUMNS: LVTILEVIEWINFO_MASK = 2;
pub const LVTVIM_LABELMARGIN: LVTILEVIEWINFO_MASK = 4;
pub const LVTVIM_TILESIZE: LVTILEVIEWINFO_MASK = 1;
...
pub const MAXBS_DISABLED: MAXBUTTONSTATES = 4;
pub const MAXBS_HOT: MAXBUTTONSTATES = 2;
pub const MAXBS_NORMAL: MAXBUTTONSTATES = 1;
pub const MAXBS_PUSHED: MAXBUTTONSTATES = 3;
...
pub const MBI_DISABLED: BARITEMSTATES = 4;
pub const MBI_DISABLEDHOT: BARITEMSTATES = 5;
pub const MBI_DISABLEDPUSHED: BARITEMSTATES = 6;
pub const MBI_HOT: BARITEMSTATES = 2;
pub const MBI_NORMAL: BARITEMSTATES = 1;
pub const MBI_PUSHED: BARITEMSTATES = 3;
pub const MB_ACTIVE: BARBACKGROUNDSTATES = 1;
pub const MB_INACTIVE: BARBACKGROUNDSTATES = 2;
pub const MCB_BITMAP: POPUPCHECKBACKGROUNDSTATES = 3;
pub const MCB_DISABLED: POPUPCHECKBACKGROUNDSTATES = 1;
pub const MCB_NORMAL: POPUPCHECKBACKGROUNDSTATES = 2;
pub const MCGCB_HOT: GRIDCELLBACKGROUNDSTATES = 2;
pub const MCGCB_SELECTED: GRIDCELLBACKGROUNDSTATES = 1;
pub const MCGCB_SELECTEDHOT: GRIDCELLBACKGROUNDSTATES = 3;
pub const MCGCB_SELECTEDNOTFOCUSED: GRIDCELLBACKGROUNDSTATES = 4;
pub const MCGCB_TODAY: GRIDCELLBACKGROUNDSTATES = 5;
pub const MCGCB_TODAYSELECTED: GRIDCELLBACKGROUNDSTATES = 6;
pub const MCGCU_HASSTATE: GRIDCELLUPPERSTATES = 2;
pub const MCGCU_HASSTATEHOT: GRIDCELLUPPERSTATES = 3;
pub const MCGCU_HOT: GRIDCELLUPPERSTATES = 1;
pub const MCGCU_SELECTED: GRIDCELLUPPERSTATES = 4;
pub const MCGCU_SELECTEDHOT: GRIDCELLUPPERSTATES = 5;
pub const MCGC_HASSTATE: GRIDCELLSTATES = 2;
pub const MCGC_HASSTATEHOT: GRIDCELLSTATES = 3;
pub const MCGC_HOT: GRIDCELLSTATES = 1;
pub const MCGC_SELECTED: GRIDCELLSTATES = 6;
pub const MCGC_SELECTEDHOT: GRIDCELLSTATES = 7;
pub const MCGC_TODAY: GRIDCELLSTATES = 4;
pub const MCGC_TODAYSELECTED: GRIDCELLSTATES = 5;
pub const MCGIF_DATE: MCGRIDINFO_FLAGS = 1;
pub const MCGIF_NAME: MCGRIDINFO_FLAGS = 4;
pub const MCGIF_RECT: MCGRIDINFO_FLAGS = 2;
pub const MCGIP_CALENDAR: MCGRIDINFO_PART = 4;
pub const MCGIP_CALENDARBODY: MCGRIDINFO_PART = 6;
pub const MCGIP_CALENDARCELL: MCGRIDINFO_PART = 8;
pub const MCGIP_CALENDARCONTROL: MCGRIDINFO_PART = 0;
pub const MCGIP_CALENDARHEADER: MCGRIDINFO_PART = 5;
pub const MCGIP_CALENDARROW: MCGRIDINFO_PART = 7;
pub const MCGIP_FOOTER: MCGRIDINFO_PART = 3;
pub const MCGIP_NEXT: MCGRIDINFO_PART = 1;
pub const MCGIP_PREV: MCGRIDINFO_PART = 2;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const MCHT_CALENDAR: MCHITTESTINFO_HIT_FLAGS = 131072;
pub const MCHT_CALENDARBK: MCHITTESTINFO_HIT_FLAGS = 131072;
pub const MCHT_CALENDARCONTROL: MCHITTESTINFO_HIT_FLAGS = 1048576;
pub const MCHT_CALENDARDATE: MCHITTESTINFO_HIT_FLAGS = 131073;
pub const MCHT_CALENDARDATEMAX: MCHITTESTINFO_HIT_FLAGS = 131077;
pub const MCHT_CALENDARDATEMIN: MCHITTESTINFO_HIT_FLAGS = 131076;
pub const MCHT_CALENDARDATENEXT: MCHITTESTINFO_HIT_FLAGS = 16908289;
pub const MCHT_CALENDARDATEPREV: MCHITTESTINFO_HIT_FLAGS = 33685505;
pub const MCHT_CALENDARDAY: MCHITTESTINFO_HIT_FLAGS = 131074;
pub const MCHT_CALENDARWEEKNUM: MCHITTESTINFO_HIT_FLAGS = 131075;
pub const MCHT_NEXT: MCHITTESTINFO_HIT_FLAGS = 16777216;
pub const MCHT_NOWHERE: MCHITTESTINFO_HIT_FLAGS = 0;
pub const MCHT_PREV: MCHITTESTINFO_HIT_FLAGS = 33554432;
pub const MCHT_TITLE: MCHITTESTINFO_HIT_FLAGS = 65536;
pub const MCHT_TITLEBK: MCHITTESTINFO_HIT_FLAGS = 65536;
pub const MCHT_TITLEBTNNEXT: MCHITTESTINFO_HIT_FLAGS = 16842755;
pub const MCHT_TITLEBTNPREV: MCHITTESTINFO_HIT_FLAGS = 33619971;
pub const MCHT_TITLEMONTH: MCHITTESTINFO_HIT_FLAGS = 65537;
pub const MCHT_TITLEYEAR: MCHITTESTINFO_HIT_FLAGS = 65538;
pub const MCHT_TODAYLINK: MCHITTESTINFO_HIT_FLAGS = 196608;
pub const MCMV_CENTURY: MONTH_CALDENDAR_MESSAGES_VIEW = 3;
pub const MCMV_DECADE: MONTH_CALDENDAR_MESSAGES_VIEW = 2;
pub const MCMV_MAX: MONTH_CALDENDAR_MESSAGES_VIEW = 3;
pub const MCMV_MONTH: MONTH_CALDENDAR_MESSAGES_VIEW = 0;
pub const MCMV_YEAR: MONTH_CALDENDAR_MESSAGES_VIEW = 1;
...
pub const MCNN_DISABLED: NAVNEXTSTATES = 4;
pub const MCNN_HOT: NAVNEXTSTATES = 2;
pub const MCNN_NORMAL: NAVNEXTSTATES = 1;
pub const MCNN_PRESSED: NAVNEXTSTATES = 3;
pub const MCNP_DISABLED: NAVPREVSTATES = 4;
pub const MCNP_HOT: NAVPREVSTATES = 2;
pub const MCNP_NORMAL: NAVPREVSTATES = 1;
pub const MCNP_PRESSED: NAVPREVSTATES = 3;
...
pub const MCTGCU_HASSTATE: TRAILINGGRIDCELLUPPERSTATES = 2;
pub const MCTGCU_HASSTATEHOT: TRAILINGGRIDCELLUPPERSTATES = 3;
pub const MCTGCU_HOT: TRAILINGGRIDCELLUPPERSTATES = 1;
pub const MCTGCU_SELECTED: TRAILINGGRIDCELLUPPERSTATES = 4;
pub const MCTGCU_SELECTEDHOT: TRAILINGGRIDCELLUPPERSTATES = 5;
pub const MCTGC_HASSTATE: TRAILINGGRIDCELLSTATES = 2;
pub const MCTGC_HASSTATEHOT: TRAILINGGRIDCELLSTATES = 3;
pub const MCTGC_HOT: TRAILINGGRIDCELLSTATES = 1;
pub const MCTGC_SELECTED: TRAILINGGRIDCELLSTATES = 6;
pub const MCTGC_SELECTEDHOT: TRAILINGGRIDCELLSTATES = 7;
pub const MCTGC_TODAY: TRAILINGGRIDCELLSTATES = 4;
pub const MCTGC_TODAYSELECTED: TRAILINGGRIDCELLSTATES = 5;
pub const MC_BACKGROUND: MONTHCALPARTS = 1;
pub const MC_BORDERS: MONTHCALPARTS = 2;
pub const MC_BULLETDISABLED: POPUPCHECKSTATES = 4;
pub const MC_BULLETNORMAL: POPUPCHECKSTATES = 3;
pub const MC_CHECKMARKDISABLED: POPUPCHECKSTATES = 2;
pub const MC_CHECKMARKNORMAL: POPUPCHECKSTATES = 1;
pub const MC_COLHEADERSPLITTER: MONTHCALPARTS = 4;
pub const MC_GRIDBACKGROUND: MONTHCALPARTS = 3;
pub const MC_GRIDCELL: MONTHCALPARTS = 6;
pub const MC_GRIDCELLBACKGROUND: MONTHCALPARTS = 5;
pub const MC_GRIDCELLUPPER: MONTHCALPARTS = 7;
pub const MC_NAVNEXT: MONTHCALPARTS = 10;
pub const MC_NAVPREV: MONTHCALPARTS = 11;
pub const MC_TRAILINGGRIDCELL: MONTHCALPARTS = 8;
pub const MC_TRAILINGGRIDCELLUPPER: MONTHCALPARTS = 9;
pub const MDCL_DISABLED: MDICLOSEBUTTONSTATES = 4;
pub const MDCL_HOT: MDICLOSEBUTTONSTATES = 2;
pub const MDCL_NORMAL: MDICLOSEBUTTONSTATES = 1;
pub const MDCL_PUSHED: MDICLOSEBUTTONSTATES = 3;
pub type MDICLOSEBUTTONSTATES = i32;
pub type MDIMINBUTTONSTATES = i32;
pub type MDIRESTOREBUTTONSTATES = i32;
pub const MDMI_DISABLED: MDIMINBUTTONSTATES = 4;
pub const MDMI_HOT: MDIMINBUTTONSTATES = 2;
pub const MDMI_NORMAL: MDIMINBUTTONSTATES = 1;
pub const MDMI_PUSHED: MDIMINBUTTONSTATES = 3;
pub const MDP_NEWAPPBUTTON: MENUBANDPARTS = 1;
pub const MDP_SEPERATOR: MENUBANDPARTS = 2;
pub const MDRE_DISABLED: MDIRESTOREBUTTONSTATES = 4;
pub const MDRE_HOT: MDIRESTOREBUTTONSTATES = 2;
pub const MDRE_NORMAL: MDIRESTOREBUTTONSTATES = 1;
pub const MDRE_PUSHED: MDIRESTOREBUTTONSTATES = 3;
pub const MDS_CHECKED: MENUBANDSTATES = 5;
pub const MDS_DISABLED: MENUBANDSTATES = 4;
pub const MDS_HOT: MENUBANDSTATES = 2;
pub const MDS_HOTCHECKED: MENUBANDSTATES = 6;
pub const MDS_NORMAL: MENUBANDSTATES = 1;
pub const MDS_PRESSED: MENUBANDSTATES = 3;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const MENU_BARBACKGROUND: MENUPARTS = 7;
pub const MENU_BARITEM: MENUPARTS = 8;
pub const MENU_CHEVRON_TMSCHEMA: MENUPARTS = 5;
pub const MENU_MENUBARDROPDOWN_TMSCHEMA: MENUPARTS = 4;
pub const MENU_MENUBARITEM_TMSCHEMA: MENUPARTS = 3;
pub const MENU_MENUDROPDOWN_TMSCHEMA: MENUPARTS = 2;
pub const MENU_MENUITEM_TMSCHEMA: MENUPARTS = 1;
pub const MENU_POPUPBACKGROUND: MENUPARTS = 9;
pub const MENU_POPUPBORDERS: MENUPARTS = 10;
pub const MENU_POPUPCHECK: MENUPARTS = 11;
pub const MENU_POPUPCHECKBACKGROUND: MENUPARTS = 12;
pub const MENU_POPUPGUTTER: MENUPARTS = 13;
pub const MENU_POPUPITEM: MENUPARTS = 14;
pub const MENU_POPUPITEMFOCUSABLE: MENUPARTS = 27;
pub const MENU_POPUPITEMKBFOCUS: MENUPARTS = 26;
pub const MENU_POPUPSEPARATOR: MENUPARTS = 15;
pub const MENU_POPUPSUBMENU: MENUPARTS = 16;
pub const MENU_POPUPSUBMENUHCHOT: MENUPARTS = 21;
pub const MENU_POPUPSUBMENU_HCHOT: MENUPARTS = 21;
pub const MENU_SEPARATOR_TMSCHEMA: MENUPARTS = 6;
pub const MENU_SYSTEMCLOSE: MENUPARTS = 17;
pub const MENU_SYSTEMCLOSEHCHOT: MENUPARTS = 22;
pub const MENU_SYSTEMMAXIMIZE: MENUPARTS = 18;
pub const MENU_SYSTEMMAXIMIZEHCHOT: MENUPARTS = 23;
pub const MENU_SYSTEMMINIMIZE: MENUPARTS = 19;
pub const MENU_SYSTEMMINIMIZEHCHOT: MENUPARTS = 24;
pub const MENU_SYSTEMRESTORE: MENUPARTS = 20;
pub const MENU_SYSTEMRESTOREHCHOT: MENUPARTS = 25;
pub const MINBS_DISABLED: MINBUTTONSTATES = 4;
pub const MINBS_HOT: MINBUTTONSTATES = 2;
pub const MINBS_NORMAL: MINBUTTONSTATES = 1;
pub const MINBS_PUSHED: MINBUTTONSTATES = 3;
pub type MINBUTTONSTATES = i32;
pub type MINCAPTIONSTATES = i32;
pub const MNCS_ACTIVE: MINCAPTIONSTATES = 1;
pub const MNCS_DISABLED: MINCAPTIONSTATES = 3;
pub const MNCS_INACTIVE: MINCAPTIONSTATES = 2;
...
pub const MPIF_DISABLED: POPUPITEMFOCUSABLESTATES = 3;
pub const MPIF_DISABLEDHOT: POPUPITEMFOCUSABLESTATES = 4;
pub const MPIF_HOT: POPUPITEMFOCUSABLESTATES = 2;
pub const MPIF_NORMAL: POPUPITEMFOCUSABLESTATES = 1;
pub const MPIKBFOCUS_NORMAL: POPUPITEMKBFOCUSSTATES = 1;
pub const MPI_DISABLED: POPUPITEMSTATES = 3;
pub const MPI_DISABLEDHOT: POPUPITEMSTATES = 4;
pub const MPI_HOT: POPUPITEMSTATES = 2;
pub const MPI_NORMAL: POPUPITEMSTATES = 1;
...
pub const MSMHC_HOT: POPUPSUBMENUHCHOTSTATES = 1;
pub const MSM_DISABLED: POPUPSUBMENUSTATES = 2;
pub const MSM_NORMAL: POPUPSUBMENUSTATES = 1;
pub const MSYSCHC_HOT: SYSTEMCLOSEHCHOTSTATES = 1;
pub const MSYSC_DISABLED: SYSTEMCLOSESTATES = 2;
pub const MSYSC_NORMAL: SYSTEMCLOSESTATES = 1;
pub const MSYSMNHC_HOT: SYSTEMMINIMIZEHCHOTSTATES = 1;
pub const MSYSMN_DISABLED: SYSTEMMINIMIZESTATES = 2;
pub const MSYSMN_NORMAL: SYSTEMMINIMIZESTATES = 1;
pub const MSYSMXHC_HOT: SYSTEMMAXIMIZEHCHOTSTATES = 1;
pub const MSYSMX_DISABLED: SYSTEMMAXIMIZESTATES = 2;
pub const MSYSMX_NORMAL: SYSTEMMAXIMIZESTATES = 1;
pub const MSYSRHC_HOT: SYSTEMRESTOREHCHOTSTATES = 1;
pub const MSYSR_DISABLED: SYSTEMRESTORESTATES = 2;
pub const MSYSR_NORMAL: SYSTEMRESTORESTATES = 1;
pub const MULTIFILEOPENORD: u32 = 1537;
pub const MXCS_ACTIVE: MAXCAPTIONSTATES = 1;
pub const MXCS_DISABLED: MAXCAPTIONSTATES = 3;
pub const MXCS_INACTIVE: MAXCAPTIONSTATES = 2;
pub type NAVIGATIONPARTS = i32;
pub type NAVNEXTSTATES = i32;
pub type NAVPREVSTATES = i32;
pub const NAV_BACKBUTTON: NAVIGATIONPARTS = 1;
pub type NAV_BACKBUTTONSTATES = i32;
pub const NAV_BB_DISABLED: NAV_BACKBUTTONSTATES = 4;
pub const NAV_BB_HOT: NAV_BACKBUTTONSTATES = 2;
pub const NAV_BB_NORMAL: NAV_BACKBUTTONSTATES = 1;
pub const NAV_BB_PRESSED: NAV_BACKBUTTONSTATES = 3;
pub const NAV_FB_DISABLED: NAV_FORWARDBUTTONSTATES = 4;
pub const NAV_FB_HOT: NAV_FORWARDBUTTONSTATES = 2;
pub const NAV_FB_NORMAL: NAV_FORWARDBUTTONSTATES = 1;
pub const NAV_FB_PRESSED: NAV_FORWARDBUTTONSTATES = 3;
pub const NAV_FORWARDBUTTON: NAVIGATIONPARTS = 2;
pub type NAV_FORWARDBUTTONSTATES = i32;
pub const NAV_MB_DISABLED: NAV_MENUBUTTONSTATES = 4;
pub const NAV_MB_HOT: NAV_MENUBUTTONSTATES = 2;
pub const NAV_MB_NORMAL: NAV_MENUBUTTONSTATES = 1;
pub const NAV_MB_PRESSED: NAV_MENUBUTTONSTATES = 3;
pub const NAV_MENUBUTTON: NAVIGATIONPARTS = 3;
...
pub const ODA_DRAWENTIRE: ODA_FLAGS = 1;
pub type ODA_FLAGS = u32;
pub const ODA_FOCUS: ODA_FLAGS = 4;
pub const ODA_SELECT: ODA_FLAGS = 2;
pub const ODS_CHECKED: ODS_FLAGS = 8;
pub const ODS_COMBOBOXEDIT: ODS_FLAGS = 4096;
pub const ODS_DEFAULT: ODS_FLAGS = 32;
pub const ODS_DISABLED: ODS_FLAGS = 4;
pub type ODS_FLAGS = u32;
pub const ODS_FOCUS: ODS_FLAGS = 16;
pub const ODS_GRAYED: ODS_FLAGS = 2;
pub const ODS_HOTLIGHT: ODS_FLAGS = 64;
pub const ODS_INACTIVE: ODS_FLAGS = 128;
pub const ODS_NOACCEL: ODS_FLAGS = 256;
pub const ODS_NOFOCUSRECT: ODS_FLAGS = 512;
pub const ODS_SELECTED: ODS_FLAGS = 1;
pub const ODT_BUTTON: DRAWITEMSTRUCT_CTL_TYPE = 4;
pub const ODT_COMBOBOX: DRAWITEMSTRUCT_CTL_TYPE = 3;
pub const ODT_HEADER: u32 = 100;
pub const ODT_LISTBOX: DRAWITEMSTRUCT_CTL_TYPE = 2;
pub const ODT_LISTVIEW: DRAWITEMSTRUCT_CTL_TYPE = 102;
pub const ODT_MENU: DRAWITEMSTRUCT_CTL_TYPE = 1;
pub const ODT_STATIC: DRAWITEMSTRUCT_CTL_TYPE = 5;
pub const ODT_TAB: DRAWITEMSTRUCT_CTL_TYPE = 101;
pub type OFFSETTYPE = i32;
pub type OPENBOXSTATES = i32;
pub type OPEN_THEME_DATA_FLAGS = u32;
pub const OTD_FORCE_RECT_SIZING: OPEN_THEME_DATA_FLAGS = 1;
pub const OTD_NONCLIENT: OPEN_THEME_DATA_FLAGS = 2;
pub const OT_ABOVELASTBUTTON: OFFSETTYPE = 12;
pub const OT_BELOWLASTBUTTON: OFFSETTYPE = 13;
pub const OT_BOTTOMLEFT: OFFSETTYPE = 3;
pub const OT_BOTTOMMIDDLE: OFFSETTYPE = 5;
pub const OT_BOTTOMRIGHT: OFFSETTYPE = 4;
pub const OT_LEFTOFCAPTION: OFFSETTYPE = 8;
pub const OT_LEFTOFLASTBUTTON: OFFSETTYPE = 10;
pub const OT_MIDDLELEFT: OFFSETTYPE = 6;
pub const OT_MIDDLERIGHT: OFFSETTYPE = 7;
pub const OT_RIGHTOFCAPTION: OFFSETTYPE = 9;
pub const OT_RIGHTOFLASTBUTTON: OFFSETTYPE = 11;
pub const OT_TOPLEFT: OFFSETTYPE = 0;
pub const OT_TOPMIDDLE: OFFSETTYPE = 2;
pub const OT_TOPRIGHT: OFFSETTYPE = 1;
pub type PAGEPARTS = i32;
pub const PAGESETUPDLGORD: u32 = 1546;
pub const PAGESETUPDLGORDMOTIF: u32 = 1550;
pub const PBBS_NORMAL: TRANSPARENTBARSTATES = 1;
pub const PBBS_PARTIAL: TRANSPARENTBARSTATES = 2;
pub const PBBVS_NORMAL: TRANSPARENTBARVERTSTATES = 1;
pub const PBBVS_PARTIAL: TRANSPARENTBARVERTSTATES = 2;
pub const PBDDS_DISABLED: PUSHBUTTONDROPDOWNSTATES = 2;
pub const PBDDS_NORMAL: PUSHBUTTONDROPDOWNSTATES = 1;
pub const PBFS_ERROR: FILLSTATES = 2;
pub const PBFS_NORMAL: FILLSTATES = 1;
pub const PBFS_PARTIAL: FILLSTATES = 4;
pub const PBFS_PAUSED: FILLSTATES = 3;
pub const PBFVS_ERROR: FILLVERTSTATES = 2;
pub const PBFVS_NORMAL: FILLVERTSTATES = 1;
pub const PBFVS_PARTIAL: FILLVERTSTATES = 4;
pub const PBFVS_PAUSED: FILLVERTSTATES = 3;
...
pub const PBS_DEFAULTED: PUSHBUTTONSTATES = 5;
pub const PBS_DEFAULTED_ANIMATING: PUSHBUTTONSTATES = 6;
pub const PBS_DISABLED: PUSHBUTTONSTATES = 4;
pub const PBS_HOT: PUSHBUTTONSTATES = 2;
pub const PBS_MARQUEE: u32 = 8;
pub const PBS_NORMAL: PUSHBUTTONSTATES = 1;
pub const PBS_PRESSED: PUSHBUTTONSTATES = 3;
...
pub const PGF_CALCHEIGHT: NMPGCALCSIZE_FLAGS = 2;
pub const PGF_CALCWIDTH: NMPGCALCSIZE_FLAGS = 1;
...
pub const PGF_SCROLLDOWN: NMPGSCROLL_DIR = 2;
pub const PGF_SCROLLLEFT: NMPGSCROLL_DIR = 4;
pub const PGF_SCROLLRIGHT: NMPGSCROLL_DIR = 8;
pub const PGF_SCROLLUP: NMPGSCROLL_DIR = 1;
pub const PGK_CONTROL: NMPGSCROLL_KEYS = 2;
pub const PGK_MENU: NMPGSCROLL_KEYS = 4;
pub const PGK_NONE: NMPGSCROLL_KEYS = 0;
pub const PGK_SHIFT: NMPGSCROLL_KEYS = 1;
...
pub const PGRP_DOWN: PAGEPARTS = 2;
pub const PGRP_DOWNHORZ: PAGEPARTS = 4;
pub const PGRP_UP: PAGEPARTS = 1;
pub const PGRP_UPHORZ: PAGEPARTS = 3;
...
pub const PP_BAR: PROGRESSPARTS = 1;
pub const PP_BARVERT: PROGRESSPARTS = 2;
pub const PP_CHUNK: PROGRESSPARTS = 3;
pub const PP_CHUNKVERT: PROGRESSPARTS = 4;
pub const PP_FILL: PROGRESSPARTS = 5;
pub const PP_FILLVERT: PROGRESSPARTS = 6;
pub const PP_MOVEOVERLAY: PROGRESSPARTS = 8;
pub const PP_MOVEOVERLAYVERT: PROGRESSPARTS = 10;
pub const PP_PULSEOVERLAY: PROGRESSPARTS = 7;
pub const PP_PULSEOVERLAYVERT: PROGRESSPARTS = 9;
pub const PP_TRANSPARENTBAR: PROGRESSPARTS = 11;
pub const PP_TRANSPARENTBARVERT: PROGRESSPARTS = 12;
...
pub const PSPCB_ADDREF: PSPCB_MESSAGE = 0;
pub const PSPCB_CREATE: PSPCB_MESSAGE = 2;
pub type PSPCB_MESSAGE = u32;
pub const PSPCB_RELEASE: PSPCB_MESSAGE = 1;
pub const PSPCB_SI_INITDIALOG: PSPCB_MESSAGE = 1025;
...
pub const RBNM_ID: NMREBAR_MASK_FLAGS = 1;
pub const RBNM_LPARAM: NMREBAR_MASK_FLAGS = 4;
pub const RBNM_STYLE: NMREBAR_MASK_FLAGS = 2;
...
pub const RBS_CHECKEDDISABLED: RADIOBUTTONSTATES = 8;
pub const RBS_CHECKEDHOT: RADIOBUTTONSTATES = 6;
pub const RBS_CHECKEDNORMAL: RADIOBUTTONSTATES = 5;
pub const RBS_CHECKEDPRESSED: RADIOBUTTONSTATES = 7;
pub const RBS_DBLCLKTOGGLE: u32 = 32768;
pub const RBS_DISABLED: RESTOREBUTTONSTATES = 4;
pub const RBS_FIXEDORDER: u32 = 2048;
pub const RBS_HOT: RESTOREBUTTONSTATES = 2;
pub const RBS_NORMAL: RESTOREBUTTONSTATES = 1;
pub const RBS_PUSHED: RESTOREBUTTONSTATES = 3;
pub const RBS_REGISTERDROP: u32 = 4096;
pub const RBS_TOOLTIPS: u32 = 256;
pub const RBS_UNCHECKEDDISABLED: RADIOBUTTONSTATES = 4;
pub const RBS_UNCHECKEDHOT: RADIOBUTTONSTATES = 2;
pub const RBS_UNCHECKEDNORMAL: RADIOBUTTONSTATES = 1;
pub const RBS_UNCHECKEDPRESSED: RADIOBUTTONSTATES = 3;
...
pub const RP_BACKGROUND: REBARPARTS = 6;
pub const RP_BAND: REBARPARTS = 3;
pub const RP_CHEVRON: REBARPARTS = 4;
pub const RP_CHEVRONVERT: REBARPARTS = 5;
pub const RP_GRIPPER: REBARPARTS = 1;
pub const RP_GRIPPERVERT: REBARPARTS = 2;
pub const RP_SPLITTER: REBARPARTS = 7;
pub const RP_SPLITTERVERT: REBARPARTS = 8;
...
pub const SBP_ARROWBTN: SCROLLBARPARTS = 1;
pub const SBP_GRIPPERHORZ: SCROLLBARPARTS = 8;
pub const SBP_GRIPPERVERT: SCROLLBARPARTS = 9;
pub const SBP_LOWERTRACKHORZ: SCROLLBARPARTS = 4;
pub const SBP_LOWERTRACKVERT: SCROLLBARPARTS = 6;
pub const SBP_SIZEBOX: SCROLLBARPARTS = 10;
pub const SBP_SIZEBOXBKGND: SCROLLBARPARTS = 11;
pub const SBP_THUMBBTNHORZ: SCROLLBARPARTS = 2;
pub const SBP_THUMBBTNVERT: SCROLLBARPARTS = 3;
pub const SBP_UPPERTRACKHORZ: SCROLLBARPARTS = 5;
pub const SBP_UPPERTRACKVERT: SCROLLBARPARTS = 7;
pub const SBS_DISABLED: SYSBUTTONSTATES = 4;
pub const SBS_HOT: SYSBUTTONSTATES = 2;
pub const SBS_NORMAL: SYSBUTTONSTATES = 1;
pub const SBS_PUSHED: SYSBUTTONSTATES = 3;
...
pub const SCBS_DISABLED: SMALLCLOSEBUTTONSTATES = 4;
pub const SCBS_HOT: SMALLCLOSEBUTTONSTATES = 2;
pub const SCBS_NORMAL: SMALLCLOSEBUTTONSTATES = 1;
pub const SCBS_PUSHED: SMALLCLOSEBUTTONSTATES = 3;
pub const SCRBS_DISABLED: SCROLLBARSTYLESTATES = 4;
pub const SCRBS_HOT: SCROLLBARSTYLESTATES = 2;
pub const SCRBS_HOVER: SCROLLBARSTYLESTATES = 5;
pub const SCRBS_NORMAL: SCROLLBARSTYLESTATES = 1;
pub const SCRBS_PRESSED: SCROLLBARSTYLESTATES = 3;
pub type SCROLLBARPARTS = i32;
pub type SCROLLBARSTYLESTATES = i32;
pub const SCS_ACTIVE: SMALLCAPTIONSTATES = 1;
pub const SCS_DISABLED: SMALLCAPTIONSTATES = 3;
pub const SCS_INACTIVE: SMALLCAPTIONSTATES = 2;
pub type SECTIONTITLELINKSTATES = i32;
pub type SET_THEME_APP_PROPERTIES_FLAGS = u32;
pub const SFRB_ACTIVE: SMALLFRAMEBOTTOMSTATES = 1;
pub const SFRB_INACTIVE: SMALLFRAMEBOTTOMSTATES = 2;
pub const SFRL_ACTIVE: SMALLFRAMELEFTSTATES = 1;
pub const SFRL_INACTIVE: SMALLFRAMELEFTSTATES = 2;
pub const SFRR_ACTIVE: SMALLFRAMERIGHTSTATES = 1;
pub const SFRR_INACTIVE: SMALLFRAMERIGHTSTATES = 2;
...
pub const SPLITSV_HOT: SPLITTERVERTSTATES = 2;
pub const SPLITSV_NORMAL: SPLITTERVERTSTATES = 1;
pub const SPLITSV_PRESSED: SPLITTERVERTSTATES = 3;
pub const SPLITS_HOT: SPLITTERSTATES = 2;
pub const SPLITS_NORMAL: SPLITTERSTATES = 1;
pub const SPLITS_PRESSED: SPLITTERSTATES = 3;
pub type SPLITTERSTATES = i32;
pub type SPLITTERVERTSTATES = i32;
pub const SPLS_HOT: LOGOFFBUTTONSSTATES = 2;
pub const SPLS_NORMAL: LOGOFFBUTTONSSTATES = 1;
pub const SPLS_PRESSED: LOGOFFBUTTONSSTATES = 3;
pub const SPMPT_DISABLED: MOREPROGRAMSTABSTATES = 4;
pub const SPMPT_FOCUSED: MOREPROGRAMSTABSTATES = 5;
pub const SPMPT_HOT: MOREPROGRAMSTABSTATES = 2;
pub const SPMPT_NORMAL: MOREPROGRAMSTABSTATES = 1;
pub const SPMPT_SELECTED: MOREPROGRAMSTABSTATES = 3;
pub const SPNP_DOWN: SPINPARTS = 2;
pub const SPNP_DOWNHORZ: SPINPARTS = 4;
pub const SPNP_UP: SPINPARTS = 1;
pub const SPNP_UPHORZ: SPINPARTS = 3;
pub const SPOB_DISABLED: OPENBOXSTATES = 4;
pub const SPOB_FOCUSED: OPENBOXSTATES = 5;
pub const SPOB_HOT: OPENBOXSTATES = 2;
pub const SPOB_NORMAL: OPENBOXSTATES = 1;
pub const SPOB_SELECTED: OPENBOXSTATES = 3;
pub const SPP_LOGOFF: STARTPANELPARTS = 8;
pub const SPP_LOGOFFBUTTONS: STARTPANELPARTS = 9;
pub const SPP_LOGOFFSPLITBUTTONDROPDOWN: STARTPANELPARTS = 19;
pub const SPP_MOREPROGRAMS: STARTPANELPARTS = 2;
pub const SPP_MOREPROGRAMSARROW: STARTPANELPARTS = 3;
pub const SPP_MOREPROGRAMSARROWBACK: STARTPANELPARTS = 17;
pub const SPP_MOREPROGRAMSTAB: STARTPANELPARTS = 12;
pub const SPP_NSCHOST: STARTPANELPARTS = 13;
pub const SPP_OPENBOX: STARTPANELPARTS = 15;
pub const SPP_PLACESLIST: STARTPANELPARTS = 6;
pub const SPP_PLACESLISTSEPARATOR: STARTPANELPARTS = 7;
pub const SPP_PREVIEW: STARTPANELPARTS = 11;
pub const SPP_PROGLIST: STARTPANELPARTS = 4;
pub const SPP_PROGLISTSEPARATOR: STARTPANELPARTS = 5;
pub const SPP_SEARCHVIEW: STARTPANELPARTS = 16;
pub const SPP_SOFTWAREEXPLORER: STARTPANELPARTS = 14;
pub const SPP_TOPMATCH: STARTPANELPARTS = 18;
pub const SPP_USERPANE: STARTPANELPARTS = 1;
pub const SPP_USERPICTURE: STARTPANELPARTS = 10;
pub const SPSB_HOT: MOREPROGRAMSARROWBACKSTATES = 2;
pub const SPSB_NORMAL: MOREPROGRAMSARROWBACKSTATES = 1;
pub const SPSB_PRESSED: MOREPROGRAMSARROWBACKSTATES = 3;
pub const SPSE_DISABLED: SOFTWAREEXPLORERSTATES = 4;
pub const SPSE_FOCUSED: SOFTWAREEXPLORERSTATES = 5;
pub const SPSE_HOT: SOFTWAREEXPLORERSTATES = 2;
pub const SPSE_NORMAL: SOFTWAREEXPLORERSTATES = 1;
pub const SPSE_SELECTED: SOFTWAREEXPLORERSTATES = 3;
pub const SPS_HOT: MOREPROGRAMSARROWSTATES = 2;
pub const SPS_NORMAL: MOREPROGRAMSARROWSTATES = 1;
pub const SPS_PRESSED: MOREPROGRAMSARROWSTATES = 3;
pub const SP_GRIPPER: STATUSPARTS = 3;
pub const SP_GRIPPERPANE: STATUSPARTS = 2;
pub const SP_PANE: STATUSPARTS = 1;
pub type STANDARDSTATES = i32;
pub type STARTPANELPARTS = i32;
pub const STATE_SYSTEM_FOCUSABLE: COMBOBOXINFO_BUTTON_STATE = 1048576;
pub const STATE_SYSTEM_INVISIBLE: COMBOBOXINFO_BUTTON_STATE = 32768;
pub const STATE_SYSTEM_OFFSCREEN: COMBOBOXINFO_BUTTON_STATE = 65536;
pub const STATE_SYSTEM_PRESSED: COMBOBOXINFO_BUTTON_STATE = 8;
pub const STATE_SYSTEM_UNAVAILABLE: COMBOBOXINFO_BUTTON_STATE = 1;
...
pub const STAT_TEXT: STATICPARTS = 1;
...
pub const ST_STRETCH: SIZINGTYPE = 1;
pub const ST_TILE: SIZINGTYPE = 2;
pub const ST_TRUESIZE: SIZINGTYPE = 0;
...
pub const SZB_HALFBOTTOMLEFTALIGN: SIZEBOXSTATES = 6;
pub const SZB_HALFBOTTOMRIGHTALIGN: SIZEBOXSTATES = 5;
pub const SZB_HALFTOPLEFTALIGN: SIZEBOXSTATES = 8;
pub const SZB_HALFTOPRIGHTALIGN: SIZEBOXSTATES = 7;
pub const SZB_LEFTALIGN: SIZEBOXSTATES = 2;
pub const SZB_RIGHTALIGN: SIZEBOXSTATES = 1;
pub const SZB_TOPLEFTALIGN: SIZEBOXSTATES = 4;
pub const SZB_TOPRIGHTALIGN: SIZEBOXSTATES = 3;
...
pub const TABP_AEROWIZARDBODY: TABPARTS = 11;
pub const TABP_BODY: TABPARTS = 10;
pub const TABP_PANE: TABPARTS = 9;
pub const TABP_TABITEM: TABPARTS = 1;
pub const TABP_TABITEMBOTHEDGE: TABPARTS = 4;
pub const TABP_TABITEMLEFTEDGE: TABPARTS = 2;
pub const TABP_TABITEMRIGHTEDGE: TABPARTS = 3;
pub const TABP_TOPTABITEM: TABPARTS = 5;
pub const TABP_TOPTABITEMBOTHEDGE: TABPARTS = 8;
pub const TABP_TOPTABITEMLEFTEDGE: TABPARTS = 6;
pub const TABP_TOPTABITEMRIGHTEDGE: TABPARTS = 7;
...
pub const TBIF_BYINDEX: TBBUTTONINFOW_MASK = 2147483648;
pub const TBIF_COMMAND: TBBUTTONINFOW_MASK = 32;
pub const TBIF_IMAGE: TBBUTTONINFOW_MASK = 1;
pub const TBIF_LPARAM: TBBUTTONINFOW_MASK = 16;
pub const TBIF_SIZE: TBBUTTONINFOW_MASK = 64;
pub const TBIF_STATE: TBBUTTONINFOW_MASK = 4;
pub const TBIF_STYLE: TBBUTTONINFOW_MASK = 8;
pub const TBIF_TEXT: TBBUTTONINFOW_MASK = 2;
pub const TBIMHT_AFTER: TBINSERTMARK_FLAGS = 1;
pub const TBIMHT_BACKGROUND: TBINSERTMARK_FLAGS = 2;
pub const TBIMHT_NONE: TBINSERTMARK_FLAGS = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const TBNF_DI_SETITEM: NMTBDISPINFOW_MASK = 268435456;
pub const TBNF_IMAGE: NMTBDISPINFOW_MASK = 1;
pub const TBNF_TEXT: NMTBDISPINFOW_MASK = 2;
...
pub const TBP_BACKGROUNDBOTTOM: TASKBARPARTS = 1;
pub const TBP_BACKGROUNDLEFT: TASKBARPARTS = 4;
pub const TBP_BACKGROUNDRIGHT: TASKBARPARTS = 2;
pub const TBP_BACKGROUNDTOP: TASKBARPARTS = 3;
pub const TBP_SIZINGBARBOTTOM: TASKBARPARTS = 5;
pub const TBP_SIZINGBARLEFT: TASKBARPARTS = 8;
pub const TBP_SIZINGBARRIGHT: TASKBARPARTS = 6;
pub const TBP_SIZINGBARTOP: TASKBARPARTS = 7;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const TCHT_NOWHERE: TCHITTESTINFO_FLAGS = 1;
pub const TCHT_ONITEM: TCHITTESTINFO_FLAGS = 6;
pub const TCHT_ONITEMICON: TCHITTESTINFO_FLAGS = 2;
pub const TCHT_ONITEMLABEL: TCHITTESTINFO_FLAGS = 4;
pub const TCIF_IMAGE: TCITEMHEADERA_MASK = 2;
pub const TCIF_PARAM: TCITEMHEADERA_MASK = 8;
pub const TCIF_RTLREADING: TCITEMHEADERA_MASK = 4;
pub const TCIF_STATE: TCITEMHEADERA_MASK = 16;
pub const TCIF_TEXT: TCITEMHEADERA_MASK = 1;
pub const TCIS_BUTTONPRESSED: TAB_CONTROL_ITEM_STATE = 1;
pub const TCIS_HIGHLIGHTED: TAB_CONTROL_ITEM_STATE = 2;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct TCITEMA {
...
pub const TDCBF_ABORT_BUTTON: TASKDIALOG_COMMON_BUTTON_FLAGS = 65536;
...
pub const TDCBF_CONTINUE_BUTTON: TASKDIALOG_COMMON_BUTTON_FLAGS = 524288;
pub const TDCBF_HELP_BUTTON: TASKDIALOG_COMMON_BUTTON_FLAGS = 1048576;
pub const TDCBF_IGNORE_BUTTON: TASKDIALOG_COMMON_BUTTON_FLAGS = 131072;
...
pub const TDCBF_TRYAGAIN_BUTTON: TASKDIALOG_COMMON_BUTTON_FLAGS = 262144;
...
pub const TDLGCPS_STANDALONE: CONTENTPANESTATES = 1;
pub const TDLGEBS_EXPANDEDDISABLED: EXPANDOBUTTONSTATES = 8;
pub const TDLGEBS_EXPANDEDHOVER: EXPANDOBUTTONSTATES = 5;
pub const TDLGEBS_EXPANDEDNORMAL: EXPANDOBUTTONSTATES = 4;
pub const TDLGEBS_EXPANDEDPRESSED: EXPANDOBUTTONSTATES = 6;
pub const TDLGEBS_HOVER: EXPANDOBUTTONSTATES = 2;
pub const TDLGEBS_NORMAL: EXPANDOBUTTONSTATES = 1;
pub const TDLGEBS_NORMALDISABLED: EXPANDOBUTTONSTATES = 7;
pub const TDLGEBS_PRESSED: EXPANDOBUTTONSTATES = 3;
pub const TDLG_BUTTONSECTION: TASKDIALOGPARTS = 10;
pub const TDLG_BUTTONWRAPPER: TASKDIALOGPARTS = 11;
pub const TDLG_COMMANDLINKPANE: TASKDIALOGPARTS = 7;
pub const TDLG_CONTENTICON: TASKDIALOGPARTS = 5;
pub const TDLG_CONTENTPANE: TASKDIALOGPARTS = 4;
pub const TDLG_CONTROLPANE: TASKDIALOGPARTS = 9;
pub const TDLG_EXPANDEDCONTENT: TASKDIALOGPARTS = 6;
pub const TDLG_EXPANDEDFOOTERAREA: TASKDIALOGPARTS = 18;
pub const TDLG_EXPANDOBUTTON: TASKDIALOGPARTS = 13;
pub const TDLG_EXPANDOTEXT: TASKDIALOGPARTS = 12;
pub const TDLG_FOOTNOTEAREA: TASKDIALOGPARTS = 16;
pub const TDLG_FOOTNOTEPANE: TASKDIALOGPARTS = 15;
pub const TDLG_FOOTNOTESEPARATOR: TASKDIALOGPARTS = 17;
pub const TDLG_IMAGEALIGNMENT: TASKDIALOGPARTS = 20;
pub const TDLG_MAINICON: TASKDIALOGPARTS = 3;
pub const TDLG_MAININSTRUCTIONPANE: TASKDIALOGPARTS = 2;
pub const TDLG_PRIMARYPANEL: TASKDIALOGPARTS = 1;
pub const TDLG_PROGRESSBAR: TASKDIALOGPARTS = 19;
pub const TDLG_RADIOBUTTONPANE: TASKDIALOGPARTS = 21;
pub const TDLG_SECONDARYPANEL: TASKDIALOGPARTS = 8;
pub const TDLG_VERIFICATIONTEXT: TASKDIALOGPARTS = 14;
...
pub const TDP_FLASHBUTTON: TASKBANDPARTS = 2;
pub const TDP_FLASHBUTTONGROUPMENU: TASKBANDPARTS = 3;
pub const TDP_GROUPCOUNT: TASKBANDPARTS = 1;
...
pub const TEXT_BODYTEXT: TEXTSTYLEPARTS = 4;
pub const TEXT_BODYTITLE: TEXTSTYLEPARTS = 3;
pub const TEXT_CONTROLLABEL: TEXTSTYLEPARTS = 9;
pub const TEXT_EXPANDED: TEXTSTYLEPARTS = 7;
pub const TEXT_HYPERLINKTEXT: TEXTSTYLEPARTS = 6;
pub const TEXT_INSTRUCTION: TEXTSTYLEPARTS = 2;
pub const TEXT_LABEL: TEXTSTYLEPARTS = 8;
pub const TEXT_MAININSTRUCTION: TEXTSTYLEPARTS = 1;
pub const TEXT_SECONDARYTEXT: TEXTSTYLEPARTS = 5;
...
pub const TIBES_DISABLED: TABITEMBOTHEDGESTATES = 4;
pub const TIBES_FOCUSED: TABITEMBOTHEDGESTATES = 5;
pub const TIBES_HOT: TABITEMBOTHEDGESTATES = 2;
pub const TIBES_NORMAL: TABITEMBOTHEDGESTATES = 1;
pub const TIBES_SELECTED: TABITEMBOTHEDGESTATES = 3;
pub type TICSSTATES = i32;
pub type TICSVERTSTATES = i32;
pub const TILES_DISABLED: TABITEMLEFTEDGESTATES = 4;
pub const TILES_FOCUSED: TABITEMLEFTEDGESTATES = 5;
pub const TILES_HOT: TABITEMLEFTEDGESTATES = 2;
pub const TILES_NORMAL: TABITEMLEFTEDGESTATES = 1;
pub const TILES_SELECTED: TABITEMLEFTEDGESTATES = 3;
pub const TIRES_DISABLED: TABITEMRIGHTEDGESTATES = 4;
pub const TIRES_FOCUSED: TABITEMRIGHTEDGESTATES = 5;
pub const TIRES_HOT: TABITEMRIGHTEDGESTATES = 2;
pub const TIRES_NORMAL: TABITEMRIGHTEDGESTATES = 1;
pub const TIRES_SELECTED: TABITEMRIGHTEDGESTATES = 3;
pub const TIS_DISABLED: TABITEMSTATES = 4;
pub const TIS_FOCUSED: TABITEMSTATES = 5;
pub const TIS_HOT: TABITEMSTATES = 2;
pub const TIS_NORMAL: TABITEMSTATES = 1;
pub const TIS_SELECTED: TABITEMSTATES = 3;
pub type TITLEBARSTATES = i32;
pub const TKP_THUMB: TRACKBARPARTS = 3;
pub const TKP_THUMBBOTTOM: TRACKBARPARTS = 4;
pub const TKP_THUMBLEFT: TRACKBARPARTS = 7;
pub const TKP_THUMBRIGHT: TRACKBARPARTS = 8;
pub const TKP_THUMBTOP: TRACKBARPARTS = 5;
pub const TKP_THUMBVERT: TRACKBARPARTS = 6;
pub const TKP_TICS: TRACKBARPARTS = 9;
pub const TKP_TICSVERT: TRACKBARPARTS = 10;
pub const TKP_TRACK: TRACKBARPARTS = 1;
pub const TKP_TRACKVERT: TRACKBARPARTS = 2;
pub const TKS_NORMAL: TRACKBARSTYLESTATES = 1;
pub const TMTVS_RESERVEDHIGH: u32 = 19999;
pub const TMTVS_RESERVEDLOW: u32 = 100000;
pub const TMT_ACCENTCOLORHINT: THEME_PROPERTY_SYMBOL_ID = 3823;
pub const TMT_ACTIVEBORDER: THEME_PROPERTY_SYMBOL_ID = 1611;
pub const TMT_ACTIVECAPTION: THEME_PROPERTY_SYMBOL_ID = 1603;
pub const TMT_ALIAS: THEME_PROPERTY_SYMBOL_ID = 1404;
pub const TMT_ALPHALEVEL: THEME_PROPERTY_SYMBOL_ID = 2402;
pub const TMT_ALPHATHRESHOLD: THEME_PROPERTY_SYMBOL_ID = 2415;
pub const TMT_ALWAYSSHOWSIZINGBAR: THEME_PROPERTY_SYMBOL_ID = 2208;
pub const TMT_ANIMATIONBUTTONRECT: THEME_PROPERTY_SYMBOL_ID = 5005;
pub const TMT_ANIMATIONDELAY: THEME_PROPERTY_SYMBOL_ID = 2428;
pub const TMT_ANIMATIONDURATION: THEME_PROPERTY_SYMBOL_ID = 5006;
pub const TMT_APPWORKSPACE: THEME_PROPERTY_SYMBOL_ID = 1613;
pub const TMT_ATLASIMAGE: THEME_PROPERTY_SYMBOL_ID = 8000;
pub const TMT_ATLASINPUTIMAGE: THEME_PROPERTY_SYMBOL_ID = 8001;
pub const TMT_ATLASRECT: THEME_PROPERTY_SYMBOL_ID = 8002;
pub const TMT_AUTHOR: THEME_PROPERTY_SYMBOL_ID = 604;
pub const TMT_AUTOSIZE: THEME_PROPERTY_SYMBOL_ID = 2202;
pub const TMT_BACKGROUND: THEME_PROPERTY_SYMBOL_ID = 1602;
pub const TMT_BGFILL: THEME_PROPERTY_SYMBOL_ID = 2205;
pub const TMT_BGTYPE: THEME_PROPERTY_SYMBOL_ID = 4001;
pub const TMT_BITMAPREF: THEME_PROPERTY_SYMBOL_ID = 215;
pub const TMT_BLENDCOLOR: THEME_PROPERTY_SYMBOL_ID = 5003;
pub const TMT_BODYFONT: THEME_PROPERTY_SYMBOL_ID = 809;
pub const TMT_BODYTEXTCOLOR: THEME_PROPERTY_SYMBOL_ID = 3827;
pub const TMT_BOOL: THEME_PROPERTY_SYMBOL_ID = 203;
pub const TMT_BORDERCOLOR: THEME_PROPERTY_SYMBOL_ID = 3801;
pub const TMT_BORDERCOLORHINT: THEME_PROPERTY_SYMBOL_ID = 3822;
pub const TMT_BORDERONLY: THEME_PROPERTY_SYMBOL_ID = 2203;
pub const TMT_BORDERSIZE: THEME_PROPERTY_SYMBOL_ID = 2403;
pub const TMT_BORDERTYPE: THEME_PROPERTY_SYMBOL_ID = 4002;
pub const TMT_BTNFACE: THEME_PROPERTY_SYMBOL_ID = 1616;
pub const TMT_BTNHIGHLIGHT: THEME_PROPERTY_SYMBOL_ID = 1621;
pub const TMT_BTNSHADOW: THEME_PROPERTY_SYMBOL_ID = 1617;
pub const TMT_BTNTEXT: THEME_PROPERTY_SYMBOL_ID = 1619;
pub const TMT_BUTTONALTERNATEFACE: THEME_PROPERTY_SYMBOL_ID = 1626;
pub const TMT_CAPTIONBARHEIGHT: THEME_PROPERTY_SYMBOL_ID = 1205;
pub const TMT_CAPTIONBARWIDTH: THEME_PROPERTY_SYMBOL_ID = 1204;
pub const TMT_CAPTIONFONT: THEME_PROPERTY_SYMBOL_ID = 801;
pub const TMT_CAPTIONMARGINS: THEME_PROPERTY_SYMBOL_ID = 3603;
pub const TMT_CAPTIONTEXT: THEME_PROPERTY_SYMBOL_ID = 1610;
pub const TMT_CHARSET: THEME_PROPERTY_SYMBOL_ID = 403;
pub const TMT_CLASSICVALUE: THEME_PROPERTY_SYMBOL_ID = 3202;
pub const TMT_COLOR: THEME_PROPERTY_SYMBOL_ID = 204;
pub const TMT_COLORIZATIONCOLOR: THEME_PROPERTY_SYMBOL_ID = 2431;
pub const TMT_COLORIZATIONOPACITY: THEME_PROPERTY_SYMBOL_ID = 2432;
pub const TMT_COLORSCHEMES: THEME_PROPERTY_SYMBOL_ID = 401;
pub const TMT_COMPANY: THEME_PROPERTY_SYMBOL_ID = 603;
pub const TMT_COMPOSITED: THEME_PROPERTY_SYMBOL_ID = 2204;
pub const TMT_COMPOSITEDOPAQUE: THEME_PROPERTY_SYMBOL_ID = 2219;
pub const TMT_CONTENTALIGNMENT: THEME_PROPERTY_SYMBOL_ID = 4006;
pub const TMT_CONTENTMARGINS: THEME_PROPERTY_SYMBOL_ID = 3602;
pub const TMT_COPYRIGHT: THEME_PROPERTY_SYMBOL_ID = 605;
pub const TMT_CSSNAME: THEME_PROPERTY_SYMBOL_ID = 1401;
pub const TMT_CUSTOMSPLITRECT: THEME_PROPERTY_SYMBOL_ID = 5004;
pub const TMT_DEFAULTPANESIZE: THEME_PROPERTY_SYMBOL_ID = 5002;
pub const TMT_DESCRIPTION: THEME_PROPERTY_SYMBOL_ID = 608;
pub const TMT_DIBDATA: THEME_PROPERTY_SYMBOL_ID = 2;
pub const TMT_DISKSTREAM: THEME_PROPERTY_SYMBOL_ID = 213;
pub const TMT_DISPLAYNAME: THEME_PROPERTY_SYMBOL_ID = 601;
pub const TMT_DKSHADOW3D: THEME_PROPERTY_SYMBOL_ID = 1622;
pub const TMT_DRAWBORDERS: THEME_PROPERTY_SYMBOL_ID = 2214;
pub const TMT_EDGEDKSHADOWCOLOR: THEME_PROPERTY_SYMBOL_ID = 3807;
pub const TMT_EDGEFILLCOLOR: THEME_PROPERTY_SYMBOL_ID = 3808;
pub const TMT_EDGEHIGHLIGHTCOLOR: THEME_PROPERTY_SYMBOL_ID = 3805;
pub const TMT_EDGELIGHTCOLOR: THEME_PROPERTY_SYMBOL_ID = 3804;
pub const TMT_EDGESHADOWCOLOR: THEME_PROPERTY_SYMBOL_ID = 3806;
pub const TMT_ENUM: THEME_PROPERTY_SYMBOL_ID = 200;
pub const TMT_FILENAME: THEME_PROPERTY_SYMBOL_ID = 206;
pub const TMT_FILLCOLOR: THEME_PROPERTY_SYMBOL_ID = 3802;
pub const TMT_FILLCOLORHINT: THEME_PROPERTY_SYMBOL_ID = 3821;
pub const TMT_FILLTYPE: THEME_PROPERTY_SYMBOL_ID = 4003;
pub const TMT_FIRSTBOOL: THEME_PROPERTY_SYMBOL_ID = 1001;
pub const TMT_FIRSTCOLOR: THEME_PROPERTY_SYMBOL_ID = 1601;
pub const TMT_FIRSTFONT: THEME_PROPERTY_SYMBOL_ID = 801;
pub const TMT_FIRSTINT: THEME_PROPERTY_SYMBOL_ID = 1301;
pub const TMT_FIRSTSIZE: THEME_PROPERTY_SYMBOL_ID = 1201;
pub const TMT_FIRSTSTRING: THEME_PROPERTY_SYMBOL_ID = 1401;
pub const TMT_FIRST_RCSTRING_NAME: THEME_PROPERTY_SYMBOL_ID = 601;
pub const TMT_FLATMENUS: THEME_PROPERTY_SYMBOL_ID = 1001;
pub const TMT_FLOAT: THEME_PROPERTY_SYMBOL_ID = 216;
pub const TMT_FLOATLIST: THEME_PROPERTY_SYMBOL_ID = 217;
pub const TMT_FONT: THEME_PROPERTY_SYMBOL_ID = 210;
pub const TMT_FRAMESPERSECOND: THEME_PROPERTY_SYMBOL_ID = 2426;
pub const TMT_FROMCOLOR1: THEME_PROPERTY_SYMBOL_ID = 2001;
pub const TMT_FROMCOLOR2: THEME_PROPERTY_SYMBOL_ID = 2002;
pub const TMT_FROMCOLOR3: THEME_PROPERTY_SYMBOL_ID = 2003;
pub const TMT_FROMCOLOR4: THEME_PROPERTY_SYMBOL_ID = 2004;
pub const TMT_FROMCOLOR5: THEME_PROPERTY_SYMBOL_ID = 2005;
pub const TMT_FROMHUE1: THEME_PROPERTY_SYMBOL_ID = 1801;
pub const TMT_FROMHUE2: THEME_PROPERTY_SYMBOL_ID = 1802;
pub const TMT_FROMHUE3: THEME_PROPERTY_SYMBOL_ID = 1803;
pub const TMT_FROMHUE4: THEME_PROPERTY_SYMBOL_ID = 1804;
pub const TMT_FROMHUE5: THEME_PROPERTY_SYMBOL_ID = 1805;
pub const TMT_GLOWCOLOR: THEME_PROPERTY_SYMBOL_ID = 3816;
pub const TMT_GLOWINTENSITY: THEME_PROPERTY_SYMBOL_ID = 2429;
pub const TMT_GLYPHDIBDATA: THEME_PROPERTY_SYMBOL_ID = 8;
pub const TMT_GLYPHFONT: THEME_PROPERTY_SYMBOL_ID = 2601;
pub const TMT_GLYPHFONTSIZINGTYPE: THEME_PROPERTY_SYMBOL_ID = 4014;
pub const TMT_GLYPHIMAGEFILE: THEME_PROPERTY_SYMBOL_ID = 3008;
pub const TMT_GLYPHINDEX: THEME_PROPERTY_SYMBOL_ID = 2418;
pub const TMT_GLYPHONLY: THEME_PROPERTY_SYMBOL_ID = 2207;
pub const TMT_GLYPHTEXTCOLOR: THEME_PROPERTY_SYMBOL_ID = 3819;
pub const TMT_GLYPHTRANSPARENT: THEME_PROPERTY_SYMBOL_ID = 2206;
pub const TMT_GLYPHTRANSPARENTCOLOR: THEME_PROPERTY_SYMBOL_ID = 3820;
pub const TMT_GLYPHTYPE: THEME_PROPERTY_SYMBOL_ID = 4012;
pub const TMT_GRADIENTACTIVECAPTION: THEME_PROPERTY_SYMBOL_ID = 1628;
pub const TMT_GRADIENTCOLOR1: THEME_PROPERTY_SYMBOL_ID = 3810;
pub const TMT_GRADIENTCOLOR2: THEME_PROPERTY_SYMBOL_ID = 3811;
pub const TMT_GRADIENTCOLOR3: THEME_PROPERTY_SYMBOL_ID = 3812;
pub const TMT_GRADIENTCOLOR4: THEME_PROPERTY_SYMBOL_ID = 3813;
pub const TMT_GRADIENTCOLOR5: THEME_PROPERTY_SYMBOL_ID = 3814;
pub const TMT_GRADIENTINACTIVECAPTION: THEME_PROPERTY_SYMBOL_ID = 1629;
pub const TMT_GRADIENTRATIO1: THEME_PROPERTY_SYMBOL_ID = 2406;
pub const TMT_GRADIENTRATIO2: THEME_PROPERTY_SYMBOL_ID = 2407;
pub const TMT_GRADIENTRATIO3: THEME_PROPERTY_SYMBOL_ID = 2408;
pub const TMT_GRADIENTRATIO4: THEME_PROPERTY_SYMBOL_ID = 2409;
pub const TMT_GRADIENTRATIO5: THEME_PROPERTY_SYMBOL_ID = 2410;
pub const TMT_GRAYTEXT: THEME_PROPERTY_SYMBOL_ID = 1618;
pub const TMT_HALIGN: THEME_PROPERTY_SYMBOL_ID = 4005;
pub const TMT_HBITMAP: THEME_PROPERTY_SYMBOL_ID = 212;
pub const TMT_HEADING1FONT: THEME_PROPERTY_SYMBOL_ID = 807;
pub const TMT_HEADING1TEXTCOLOR: THEME_PROPERTY_SYMBOL_ID = 3825;
pub const TMT_HEADING2FONT: THEME_PROPERTY_SYMBOL_ID = 808;
pub const TMT_HEADING2TEXTCOLOR: THEME_PROPERTY_SYMBOL_ID = 3826;
pub const TMT_HEIGHT: THEME_PROPERTY_SYMBOL_ID = 2417;
pub const TMT_HIGHLIGHT: THEME_PROPERTY_SYMBOL_ID = 1614;
pub const TMT_HIGHLIGHTTEXT: THEME_PROPERTY_SYMBOL_ID = 1615;
pub const TMT_HOTTRACKING: THEME_PROPERTY_SYMBOL_ID = 1627;
pub const TMT_ICONEFFECT: THEME_PROPERTY_SYMBOL_ID = 4009;
pub const TMT_ICONTITLEFONT: THEME_PROPERTY_SYMBOL_ID = 806;
pub const TMT_IMAGECOUNT: THEME_PROPERTY_SYMBOL_ID = 2401;
pub const TMT_IMAGEFILE: THEME_PROPERTY_SYMBOL_ID = 3001;
pub const TMT_IMAGEFILE1: THEME_PROPERTY_SYMBOL_ID = 3002;
pub const TMT_IMAGEFILE2: THEME_PROPERTY_SYMBOL_ID = 3003;
pub const TMT_IMAGEFILE3: THEME_PROPERTY_SYMBOL_ID = 3004;
pub const TMT_IMAGEFILE4: THEME_PROPERTY_SYMBOL_ID = 3005;
pub const TMT_IMAGEFILE5: THEME_PROPERTY_SYMBOL_ID = 3006;
pub const TMT_IMAGEFILE6: THEME_PROPERTY_SYMBOL_ID = 3009;
pub const TMT_IMAGEFILE7: THEME_PROPERTY_SYMBOL_ID = 3010;
pub const TMT_IMAGELAYOUT: THEME_PROPERTY_SYMBOL_ID = 4011;
pub const TMT_IMAGESELECTTYPE: THEME_PROPERTY_SYMBOL_ID = 4013;
pub const TMT_INACTIVEBORDER: THEME_PROPERTY_SYMBOL_ID = 1612;
pub const TMT_INACTIVECAPTION: THEME_PROPERTY_SYMBOL_ID = 1604;
pub const TMT_INACTIVECAPTIONTEXT: THEME_PROPERTY_SYMBOL_ID = 1620;
pub const TMT_INFOBK: THEME_PROPERTY_SYMBOL_ID = 1625;
pub const TMT_INFOTEXT: THEME_PROPERTY_SYMBOL_ID = 1624;
pub const TMT_INT: THEME_PROPERTY_SYMBOL_ID = 202;
pub const TMT_INTEGRALSIZING: THEME_PROPERTY_SYMBOL_ID = 2211;
pub const TMT_INTLIST: THEME_PROPERTY_SYMBOL_ID = 211;
pub const TMT_LASTBOOL: THEME_PROPERTY_SYMBOL_ID = 1001;
pub const TMT_LASTCOLOR: THEME_PROPERTY_SYMBOL_ID = 1631;
pub const TMT_LASTFONT: THEME_PROPERTY_SYMBOL_ID = 809;
pub const TMT_LASTINT: THEME_PROPERTY_SYMBOL_ID = 1301;
pub const TMT_LASTSIZE: THEME_PROPERTY_SYMBOL_ID = 1210;
pub const TMT_LASTSTRING: THEME_PROPERTY_SYMBOL_ID = 1404;
pub const TMT_LASTUPDATED: THEME_PROPERTY_SYMBOL_ID = 1403;
pub const TMT_LAST_RCSTRING_NAME: THEME_PROPERTY_SYMBOL_ID = 608;
pub const TMT_LIGHT3D: THEME_PROPERTY_SYMBOL_ID = 1623;
pub const TMT_LOCALIZEDMIRRORIMAGE: THEME_PROPERTY_SYMBOL_ID = 2220;
pub const TMT_MARGINS: THEME_PROPERTY_SYMBOL_ID = 205;
pub const TMT_MENU: THEME_PROPERTY_SYMBOL_ID = 1605;
pub const TMT_MENUBAR: THEME_PROPERTY_SYMBOL_ID = 1631;
pub const TMT_MENUBARHEIGHT: THEME_PROPERTY_SYMBOL_ID = 1209;
pub const TMT_MENUBARWIDTH: THEME_PROPERTY_SYMBOL_ID = 1208;
pub const TMT_MENUFONT: THEME_PROPERTY_SYMBOL_ID = 803;
pub const TMT_MENUHILIGHT: THEME_PROPERTY_SYMBOL_ID = 1630;
pub const TMT_MENUTEXT: THEME_PROPERTY_SYMBOL_ID = 1608;
pub const TMT_MINCOLORDEPTH: THEME_PROPERTY_SYMBOL_ID = 1301;
pub const TMT_MINDPI1: THEME_PROPERTY_SYMBOL_ID = 2420;
pub const TMT_MINDPI2: THEME_PROPERTY_SYMBOL_ID = 2421;
pub const TMT_MINDPI3: THEME_PROPERTY_SYMBOL_ID = 2422;
pub const TMT_MINDPI4: THEME_PROPERTY_SYMBOL_ID = 2423;
pub const TMT_MINDPI5: THEME_PROPERTY_SYMBOL_ID = 2424;
pub const TMT_MINDPI6: THEME_PROPERTY_SYMBOL_ID = 2433;
pub const TMT_MINDPI7: THEME_PROPERTY_SYMBOL_ID = 2434;
pub const TMT_MINSIZE: THEME_PROPERTY_SYMBOL_ID = 3403;
pub const TMT_MINSIZE1: THEME_PROPERTY_SYMBOL_ID = 3404;
pub const TMT_MINSIZE2: THEME_PROPERTY_SYMBOL_ID = 3405;
pub const TMT_MINSIZE3: THEME_PROPERTY_SYMBOL_ID = 3406;
pub const TMT_MINSIZE4: THEME_PROPERTY_SYMBOL_ID = 3407;
pub const TMT_MINSIZE5: THEME_PROPERTY_SYMBOL_ID = 3408;
pub const TMT_MINSIZE6: THEME_PROPERTY_SYMBOL_ID = 3410;
pub const TMT_MINSIZE7: THEME_PROPERTY_SYMBOL_ID = 3411;
pub const TMT_MIRRORIMAGE: THEME_PROPERTY_SYMBOL_ID = 2209;
pub const TMT_MSGBOXFONT: THEME_PROPERTY_SYMBOL_ID = 805;
pub const TMT_NAME: THEME_PROPERTY_SYMBOL_ID = 600;
pub const TMT_NOETCHEDEFFECT: THEME_PROPERTY_SYMBOL_ID = 2215;
pub const TMT_NORMALSIZE: THEME_PROPERTY_SYMBOL_ID = 3409;
pub const TMT_OFFSET: THEME_PROPERTY_SYMBOL_ID = 3401;
pub const TMT_OFFSETTYPE: THEME_PROPERTY_SYMBOL_ID = 4008;
pub const TMT_OPACITY: THEME_PROPERTY_SYMBOL_ID = 2430;
pub const TMT_PADDEDBORDERWIDTH: THEME_PROPERTY_SYMBOL_ID = 1210;
pub const TMT_PIXELSPERFRAME: THEME_PROPERTY_SYMBOL_ID = 2427;
pub const TMT_POSITION: THEME_PROPERTY_SYMBOL_ID = 208;
pub const TMT_PROGRESSCHUNKSIZE: THEME_PROPERTY_SYMBOL_ID = 2411;
pub const TMT_PROGRESSSPACESIZE: THEME_PROPERTY_SYMBOL_ID = 2412;
pub const TMT_RECT: THEME_PROPERTY_SYMBOL_ID = 209;
pub const TMT_RESERVEDHIGH: THEME_PROPERTY_SYMBOL_ID = 7999;
pub const TMT_RESERVEDLOW: THEME_PROPERTY_SYMBOL_ID = 0;
pub const TMT_ROUNDCORNERHEIGHT: THEME_PROPERTY_SYMBOL_ID = 2405;
pub const TMT_ROUNDCORNERWIDTH: THEME_PROPERTY_SYMBOL_ID = 2404;
pub const TMT_SATURATION: THEME_PROPERTY_SYMBOL_ID = 2413;
pub const TMT_SCALEDBACKGROUND: THEME_PROPERTY_SYMBOL_ID = 7001;
pub const TMT_SCROLLBAR: THEME_PROPERTY_SYMBOL_ID = 1601;
pub const TMT_SCROLLBARHEIGHT: THEME_PROPERTY_SYMBOL_ID = 1203;
pub const TMT_SCROLLBARWIDTH: THEME_PROPERTY_SYMBOL_ID = 1202;
pub const TMT_SHADOWCOLOR: THEME_PROPERTY_SYMBOL_ID = 3815;
pub const TMT_SIZE: THEME_PROPERTY_SYMBOL_ID = 207;
pub const TMT_SIZES: THEME_PROPERTY_SYMBOL_ID = 402;
pub const TMT_SIZINGBORDERWIDTH: THEME_PROPERTY_SYMBOL_ID = 1201;
pub const TMT_SIZINGMARGINS: THEME_PROPERTY_SYMBOL_ID = 3601;
pub const TMT_SIZINGTYPE: THEME_PROPERTY_SYMBOL_ID = 4004;
pub const TMT_SMALLCAPTIONFONT: THEME_PROPERTY_SYMBOL_ID = 802;
pub const TMT_SMCAPTIONBARHEIGHT: THEME_PROPERTY_SYMBOL_ID = 1207;
pub const TMT_SMCAPTIONBARWIDTH: THEME_PROPERTY_SYMBOL_ID = 1206;
pub const TMT_SOURCEGROW: THEME_PROPERTY_SYMBOL_ID = 2212;
pub const TMT_SOURCESHRINK: THEME_PROPERTY_SYMBOL_ID = 2213;
pub const TMT_STATUSFONT: THEME_PROPERTY_SYMBOL_ID = 804;
pub const TMT_STREAM: THEME_PROPERTY_SYMBOL_ID = 214;
pub const TMT_STRING: THEME_PROPERTY_SYMBOL_ID = 201;
pub const TMT_TEXT: THEME_PROPERTY_SYMBOL_ID = 3201;
pub const TMT_TEXTAPPLYOVERLAY: THEME_PROPERTY_SYMBOL_ID = 2216;
pub const TMT_TEXTBORDERCOLOR: THEME_PROPERTY_SYMBOL_ID = 3817;
pub const TMT_TEXTBORDERSIZE: THEME_PROPERTY_SYMBOL_ID = 2414;
pub const TMT_TEXTCOLOR: THEME_PROPERTY_SYMBOL_ID = 3803;
pub const TMT_TEXTCOLORHINT: THEME_PROPERTY_SYMBOL_ID = 3824;
pub const TMT_TEXTGLOW: THEME_PROPERTY_SYMBOL_ID = 2217;
pub const TMT_TEXTGLOWSIZE: THEME_PROPERTY_SYMBOL_ID = 2425;
pub const TMT_TEXTITALIC: THEME_PROPERTY_SYMBOL_ID = 2218;
pub const TMT_TEXTSHADOWCOLOR: THEME_PROPERTY_SYMBOL_ID = 3818;
pub const TMT_TEXTSHADOWOFFSET: THEME_PROPERTY_SYMBOL_ID = 3402;
pub const TMT_TEXTSHADOWTYPE: THEME_PROPERTY_SYMBOL_ID = 4010;
pub const TMT_TOCOLOR1: THEME_PROPERTY_SYMBOL_ID = 2006;
pub const TMT_TOCOLOR2: THEME_PROPERTY_SYMBOL_ID = 2007;
pub const TMT_TOCOLOR3: THEME_PROPERTY_SYMBOL_ID = 2008;
pub const TMT_TOCOLOR4: THEME_PROPERTY_SYMBOL_ID = 2009;
pub const TMT_TOCOLOR5: THEME_PROPERTY_SYMBOL_ID = 2010;
pub const TMT_TOHUE1: THEME_PROPERTY_SYMBOL_ID = 1806;
pub const TMT_TOHUE2: THEME_PROPERTY_SYMBOL_ID = 1807;
pub const TMT_TOHUE3: THEME_PROPERTY_SYMBOL_ID = 1808;
pub const TMT_TOHUE4: THEME_PROPERTY_SYMBOL_ID = 1809;
pub const TMT_TOHUE5: THEME_PROPERTY_SYMBOL_ID = 1810;
pub const TMT_TOOLTIP: THEME_PROPERTY_SYMBOL_ID = 602;
pub const TMT_TRANSITIONDURATIONS: THEME_PROPERTY_SYMBOL_ID = 6000;
pub const TMT_TRANSPARENT: THEME_PROPERTY_SYMBOL_ID = 2201;
pub const TMT_TRANSPARENTCOLOR: THEME_PROPERTY_SYMBOL_ID = 3809;
pub const TMT_TRUESIZESCALINGTYPE: THEME_PROPERTY_SYMBOL_ID = 4015;
pub const TMT_TRUESIZESTRETCHMARK: THEME_PROPERTY_SYMBOL_ID = 2419;
pub const TMT_UNIFORMSIZING: THEME_PROPERTY_SYMBOL_ID = 2210;
pub const TMT_URL: THEME_PROPERTY_SYMBOL_ID = 606;
pub const TMT_USERPICTURE: THEME_PROPERTY_SYMBOL_ID = 5001;
pub const TMT_VALIGN: THEME_PROPERTY_SYMBOL_ID = 4007;
pub const TMT_VERSION: THEME_PROPERTY_SYMBOL_ID = 607;
pub const TMT_WIDTH: THEME_PROPERTY_SYMBOL_ID = 2416;
pub const TMT_WINDOW: THEME_PROPERTY_SYMBOL_ID = 1606;
pub const TMT_WINDOWFRAME: THEME_PROPERTY_SYMBOL_ID = 1607;
pub const TMT_WINDOWTEXT: THEME_PROPERTY_SYMBOL_ID = 1609;
pub const TMT_XMLNAME: THEME_PROPERTY_SYMBOL_ID = 1402;
pub const TNP_ANIMBACKGROUND: TRAYNOTIFYPARTS = 2;
pub const TNP_BACKGROUND: TRAYNOTIFYPARTS = 1;
...
pub const TP_BUTTON: TOOLBARPARTS = 1;
pub const TP_DROPDOWNBUTTON: TOOLBARPARTS = 2;
pub const TP_DROPDOWNBUTTONGLYPH: TOOLBARPARTS = 7;
pub const TP_SEPARATOR: TOOLBARPARTS = 5;
pub const TP_SEPARATORVERT: TOOLBARPARTS = 6;
pub const TP_SPLITBUTTON: TOOLBARPARTS = 3;
pub const TP_SPLITBUTTONDROPDOWN: TOOLBARPARTS = 4;
...
pub const TREIS_DISABLED: TREEITEMSTATES = 4;
pub const TREIS_HOT: TREEITEMSTATES = 2;
pub const TREIS_HOTSELECTED: TREEITEMSTATES = 6;
pub const TREIS_NORMAL: TREEITEMSTATES = 1;
pub const TREIS_SELECTED: TREEITEMSTATES = 3;
pub const TREIS_SELECTEDNOTFOCUS: TREEITEMSTATES = 5;
pub const TRS_NORMAL: TRACKSTATES = 1;
pub type TRUESIZESCALINGTYPE = i32;
pub const TRVS_NORMAL: TRACKVERTSTATES = 1;
pub const TSGP_GRIPPER: TEXTSELECTIONGRIPPERPARTS = 1;
pub const TSGS_CENTERED: GRIPPERSTATES = 2;
pub const TSGS_NORMAL: GRIPPERSTATES = 1;
pub const TSST_DPI: TRUESIZESCALINGTYPE = 2;
pub const TSST_NONE: TRUESIZESCALINGTYPE = 0;
pub const TSST_SIZE: TRUESIZESCALINGTYPE = 1;
pub const TSS_NORMAL: TICSSTATES = 1;
pub const TST_CONTINUOUS: TEXTSHADOWTYPE = 2;
pub const TST_NONE: TEXTSHADOWTYPE = 0;
pub const TST_SINGLE: TEXTSHADOWTYPE = 1;
pub const TSVS_NORMAL: TICSVERTSTATES = 1;
pub const TS_CHECKED: TOOLBARSTYLESTATES = 5;
pub const TS_CONTROLLABEL_DISABLED: CONTROLLABELSTATES = 2;
pub const TS_CONTROLLABEL_NORMAL: CONTROLLABELSTATES = 1;
pub const TS_DISABLED: TOOLBARSTYLESTATES = 4;
pub const TS_DRAW: THEMESIZE = 2;
pub const TS_HOT: TOOLBARSTYLESTATES = 2;
pub const TS_HOTCHECKED: TOOLBARSTYLESTATES = 6;
pub const TS_HYPERLINK_DISABLED: HYPERLINKTEXTSTATES = 4;
pub const TS_HYPERLINK_HOT: HYPERLINKTEXTSTATES = 2;
pub const TS_HYPERLINK_NORMAL: HYPERLINKTEXTSTATES = 1;
pub const TS_HYPERLINK_PRESSED: HYPERLINKTEXTSTATES = 3;
pub const TS_MIN: THEMESIZE = 0;
pub const TS_NEARHOT: TOOLBARSTYLESTATES = 7;
pub const TS_NORMAL: TOOLBARSTYLESTATES = 1;
pub const TS_OTHERSIDEHOT: TOOLBARSTYLESTATES = 8;
pub const TS_PRESSED: TOOLBARSTYLESTATES = 3;
pub const TS_TRUE: THEMESIZE = 1;
pub const TTBSS_POINTINGDOWNCENTERED: BALLOONSTEMSTATES = 5;
pub const TTBSS_POINTINGDOWNLEFTWALL: BALLOONSTEMSTATES = 6;
pub const TTBSS_POINTINGDOWNRIGHTWALL: BALLOONSTEMSTATES = 4;
pub const TTBSS_POINTINGUPCENTERED: BALLOONSTEMSTATES = 2;
pub const TTBSS_POINTINGUPLEFTWALL: BALLOONSTEMSTATES = 1;
pub const TTBSS_POINTINGUPRIGHTWALL: BALLOONSTEMSTATES = 3;
pub const TTBS_LINK: BALLOONSTATES = 2;
pub const TTBS_NORMAL: BALLOONSTATES = 1;
pub const TTCS_HOT: CLOSESTATES = 2;
pub const TTCS_NORMAL: CLOSESTATES = 1;
pub const TTCS_PRESSED: CLOSESTATES = 3;
...
pub const TTF_ABSOLUTE: TOOLTIP_FLAGS = 128;
pub const TTF_CENTERTIP: TOOLTIP_FLAGS = 2;
pub const TTF_DI_SETITEM: TOOLTIP_FLAGS = 32768;
pub const TTF_IDISHWND: TOOLTIP_FLAGS = 1;
pub const TTF_PARSELINKS: TOOLTIP_FLAGS = 4096;
pub const TTF_RTLREADING: TOOLTIP_FLAGS = 4;
pub const TTF_SUBCLASS: TOOLTIP_FLAGS = 16;
pub const TTF_TRACK: TOOLTIP_FLAGS = 32;
pub const TTF_TRANSPARENT: TOOLTIP_FLAGS = 256;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const TTIBES_DISABLED: TOPTABITEMBOTHEDGESTATES = 4;
pub const TTIBES_FOCUSED: TOPTABITEMBOTHEDGESTATES = 5;
pub const TTIBES_HOT: TOPTABITEMBOTHEDGESTATES = 2;
pub const TTIBES_NORMAL: TOPTABITEMBOTHEDGESTATES = 1;
pub const TTIBES_SELECTED: TOPTABITEMBOTHEDGESTATES = 3;
pub const TTILES_DISABLED: TOPTABITEMLEFTEDGESTATES = 4;
pub const TTILES_FOCUSED: TOPTABITEMLEFTEDGESTATES = 5;
pub const TTILES_HOT: TOPTABITEMLEFTEDGESTATES = 2;
pub const TTILES_NORMAL: TOPTABITEMLEFTEDGESTATES = 1;
pub const TTILES_SELECTED: TOPTABITEMLEFTEDGESTATES = 3;
pub const TTIRES_DISABLED: TOPTABITEMRIGHTEDGESTATES = 4;
pub const TTIRES_FOCUSED: TOPTABITEMRIGHTEDGESTATES = 5;
pub const TTIRES_HOT: TOPTABITEMRIGHTEDGESTATES = 2;
pub const TTIRES_NORMAL: TOPTABITEMRIGHTEDGESTATES = 1;
pub const TTIRES_SELECTED: TOPTABITEMRIGHTEDGESTATES = 3;
pub const TTIS_DISABLED: TOPTABITEMSTATES = 4;
pub const TTIS_FOCUSED: TOPTABITEMSTATES = 5;
pub const TTIS_HOT: TOPTABITEMSTATES = 2;
pub const TTIS_NORMAL: TOPTABITEMSTATES = 1;
pub const TTIS_SELECTED: TOPTABITEMSTATES = 3;
pub const TTI_ERROR: EDITBALLOONTIP_ICON = 3;
pub const TTI_ERROR_LARGE: EDITBALLOONTIP_ICON = 6;
pub const TTI_INFO: EDITBALLOONTIP_ICON = 1;
pub const TTI_INFO_LARGE: EDITBALLOONTIP_ICON = 4;
pub const TTI_NONE: EDITBALLOONTIP_ICON = 0;
pub const TTI_WARNING: EDITBALLOONTIP_ICON = 2;
pub const TTI_WARNING_LARGE: EDITBALLOONTIP_ICON = 5;
...
pub const TTP_BALLOON: TOOLTIPPARTS = 3;
pub const TTP_BALLOONSTEM: TOOLTIPPARTS = 6;
pub const TTP_BALLOONTITLE: TOOLTIPPARTS = 4;
pub const TTP_CLOSE: TOOLTIPPARTS = 5;
pub const TTP_STANDARD: TOOLTIPPARTS = 1;
pub const TTP_STANDARDTITLE: TOOLTIPPARTS = 2;
pub const TTP_WRENCH: TOOLTIPPARTS = 7;
pub const TTSS_LINK: STANDARDSTATES = 2;
pub const TTSS_NORMAL: STANDARDSTATES = 1;
...
pub const TTWS_HOT: WRENCHSTATES = 2;
pub const TTWS_NORMAL: WRENCHSTATES = 1;
pub const TTWS_PRESSED: WRENCHSTATES = 3;
pub const TUBS_DISABLED: THUMBBOTTOMSTATES = 5;
pub const TUBS_FOCUSED: THUMBBOTTOMSTATES = 4;
pub const TUBS_HOT: THUMBBOTTOMSTATES = 2;
pub const TUBS_NORMAL: THUMBBOTTOMSTATES = 1;
pub const TUBS_PRESSED: THUMBBOTTOMSTATES = 3;
pub const TUS_DISABLED: THUMBSTATES = 5;
pub const TUS_FOCUSED: THUMBSTATES = 4;
pub const TUS_HOT: THUMBSTATES = 2;
pub const TUS_NORMAL: THUMBSTATES = 1;
pub const TUS_PRESSED: THUMBSTATES = 3;
pub const TUTS_DISABLED: THUMBTOPSTATES = 5;
pub const TUTS_FOCUSED: THUMBTOPSTATES = 4;
pub const TUTS_HOT: THUMBTOPSTATES = 2;
pub const TUTS_NORMAL: THUMBTOPSTATES = 1;
pub const TUTS_PRESSED: THUMBTOPSTATES = 3;
pub const TUVLS_DISABLED: THUMBLEFTSTATES = 5;
pub const TUVLS_FOCUSED: THUMBLEFTSTATES = 4;
pub const TUVLS_HOT: THUMBLEFTSTATES = 2;
pub const TUVLS_NORMAL: THUMBLEFTSTATES = 1;
pub const TUVLS_PRESSED: THUMBLEFTSTATES = 3;
pub const TUVRS_DISABLED: THUMBRIGHTSTATES = 5;
pub const TUVRS_FOCUSED: THUMBRIGHTSTATES = 4;
pub const TUVRS_HOT: THUMBRIGHTSTATES = 2;
pub const TUVRS_NORMAL: THUMBRIGHTSTATES = 1;
pub const TUVRS_PRESSED: THUMBRIGHTSTATES = 3;
pub const TUVS_DISABLED: THUMBVERTSTATES = 5;
pub const TUVS_FOCUSED: THUMBVERTSTATES = 4;
pub const TUVS_HOT: THUMBVERTSTATES = 2;
pub const TUVS_NORMAL: THUMBVERTSTATES = 1;
pub const TUVS_PRESSED: THUMBVERTSTATES = 3;
pub const TVCDRF_NOIMAGES: u32 = 65536;
pub const TVC_BYKEYBOARD: NM_TREEVIEW_ACTION = 2;
pub const TVC_BYMOUSE: NM_TREEVIEW_ACTION = 1;
pub const TVC_UNKNOWN: NM_TREEVIEW_ACTION = 0;
pub const TVE_COLLAPSE: NM_TREEVIEW_ACTION = 1;
pub const TVE_COLLAPSERESET: NM_TREEVIEW_ACTION = 32768;
pub const TVE_EXPAND: NM_TREEVIEW_ACTION = 2;
pub const TVE_EXPANDPARTIAL: NM_TREEVIEW_ACTION = 16384;
pub const TVE_TOGGLE: NM_TREEVIEW_ACTION = 3;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const TVHT_ABOVE: TVHITTESTINFO_FLAGS = 256;
pub const TVHT_BELOW: TVHITTESTINFO_FLAGS = 512;
pub const TVHT_NOWHERE: TVHITTESTINFO_FLAGS = 1;
pub const TVHT_ONITEM: TVHITTESTINFO_FLAGS = 70;
pub const TVHT_ONITEMBUTTON: TVHITTESTINFO_FLAGS = 16;
pub const TVHT_ONITEMICON: TVHITTESTINFO_FLAGS = 2;
pub const TVHT_ONITEMINDENT: TVHITTESTINFO_FLAGS = 8;
pub const TVHT_ONITEMLABEL: TVHITTESTINFO_FLAGS = 4;
pub const TVHT_ONITEMRIGHT: TVHITTESTINFO_FLAGS = 32;
pub const TVHT_ONITEMSTATEICON: TVHITTESTINFO_FLAGS = 64;
pub const TVHT_TOLEFT: TVHITTESTINFO_FLAGS = 2048;
pub const TVHT_TORIGHT: TVHITTESTINFO_FLAGS = 1024;
pub const TVIF_CHILDREN: TVITEM_MASK = 64;
pub const TVIF_DI_SETITEM: TVITEM_MASK = 4096;
pub const TVIF_EXPANDEDIMAGE: TVITEM_MASK = 512;
pub const TVIF_HANDLE: TVITEM_MASK = 16;
pub const TVIF_IMAGE: TVITEM_MASK = 2;
pub const TVIF_INTEGRAL: TVITEM_MASK = 128;
pub const TVIF_PARAM: TVITEM_MASK = 4;
pub const TVIF_SELECTEDIMAGE: TVITEM_MASK = 32;
pub const TVIF_STATE: TVITEM_MASK = 8;
pub const TVIF_STATEEX: TVITEM_MASK = 256;
pub const TVIF_TEXT: TVITEM_MASK = 1;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const TVIS_BOLD: TREE_VIEW_ITEM_STATE_FLAGS = 16;
pub const TVIS_CUT: TREE_VIEW_ITEM_STATE_FLAGS = 4;
pub const TVIS_DROPHILITED: TREE_VIEW_ITEM_STATE_FLAGS = 8;
pub const TVIS_EXPANDED: TREE_VIEW_ITEM_STATE_FLAGS = 32;
pub const TVIS_EXPANDEDONCE: TREE_VIEW_ITEM_STATE_FLAGS = 64;
pub const TVIS_EXPANDPARTIAL: TREE_VIEW_ITEM_STATE_FLAGS = 128;
pub const TVIS_EX_ALL: TREE_VIEW_ITEM_STATE_FLAGS = 2;
pub const TVIS_EX_DISABLED: TREE_VIEW_ITEM_STATE_FLAGS = 2;
pub const TVIS_EX_FLAT: TREE_VIEW_ITEM_STATE_FLAGS = 1;
pub const TVIS_OVERLAYMASK: TREE_VIEW_ITEM_STATE_FLAGS = 3840;
pub const TVIS_SELECTED: TREE_VIEW_ITEM_STATE_FLAGS = 2;
pub const TVIS_STATEIMAGEMASK: TREE_VIEW_ITEM_STATE_FLAGS = 61440;
pub const TVIS_USERMASK: TREE_VIEW_ITEM_STATE_FLAGS = 61440;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct TVITEMA {
...
pub const TVP_BRANCH: TREEVIEWPARTS = 3;
pub const TVP_GLYPH: TREEVIEWPARTS = 2;
pub const TVP_HOTGLYPH: TREEVIEWPARTS = 4;
pub const TVP_TREEITEM: TREEVIEWPARTS = 1;
...
pub const UPHZS_DISABLED: UPHORZSTATES = 4;
pub const UPHZS_HOT: UPHORZSTATES = 2;
pub const UPHZS_NORMAL: UPHORZSTATES = 1;
pub const UPHZS_PRESSED: UPHORZSTATES = 3;
pub type UPSTATES = i32;
pub const UPS_DISABLED: UPSTATES = 4;
pub const UPS_HOT: UPSTATES = 2;
pub const UPS_NORMAL: UPSTATES = 1;
pub const UPS_PRESSED: UPSTATES = 3;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const UTP_HOVERBACKGROUND: USERTILEPARTS = 2;
pub const UTP_STROKEBACKGROUND: USERTILEPARTS = 1;
pub const UTS_HOT: HOVERBACKGROUNDSTATES = 2;
pub const UTS_NORMAL: HOVERBACKGROUNDSTATES = 1;
pub const UTS_PRESSED: HOVERBACKGROUNDSTATES = 3;
pub const VALIDBITS: SET_THEME_APP_PROPERTIES_FLAGS = 7;
pub type VALIGN = i32;
pub const VA_BOTTOM: VALIGN = 2;
pub const VA_CENTER: VALIGN = 1;
pub const VA_TOP: VALIGN = 0;
...
pub const VSS_DISABLED: VERTSCROLLSTATES = 4;
pub const VSS_HOT: VERTSCROLLSTATES = 2;
pub const VSS_NORMAL: VERTSCROLLSTATES = 1;
pub const VSS_PUSHED: VERTSCROLLSTATES = 3;
pub const VTS_DISABLED: VERTTHUMBSTATES = 4;
pub const VTS_HOT: VERTTHUMBSTATES = 2;
pub const VTS_NORMAL: VERTTHUMBSTATES = 1;
pub const VTS_PUSHED: VERTTHUMBSTATES = 3;
pub type WARNINGSTATES = i32;
pub const WB_CLASSIFY: WORD_BREAK_ACTION = 3;
pub const WB_ISDELIMITER: WORD_BREAK_ACTION = 2;
pub const WB_LEFT: WORD_BREAK_ACTION = 0;
pub const WB_LEFTBREAK: WORD_BREAK_ACTION = 6;
pub const WB_MOVEWORDLEFT: WORD_BREAK_ACTION = 4;
pub const WB_MOVEWORDRIGHT: WORD_BREAK_ACTION = 5;
pub const WB_RIGHT: WORD_BREAK_ACTION = 1;
pub const WB_RIGHTBREAK: WORD_BREAK_ACTION = 7;
...
pub const WP_BORDER: WINDOWPARTS = 39;
pub const WP_CAPTION: WINDOWPARTS = 1;
pub const WP_CAPTIONSIZINGTEMPLATE: WINDOWPARTS = 30;
pub const WP_CLOSEBUTTON: WINDOWPARTS = 18;
pub const WP_DIALOG: WINDOWPARTS = 29;
pub const WP_FRAME: WINDOWPARTS = 38;
pub const WP_FRAMEBOTTOM: WINDOWPARTS = 9;
pub const WP_FRAMEBOTTOMSIZINGTEMPLATE: WINDOWPARTS = 36;
pub const WP_FRAMELEFT: WINDOWPARTS = 7;
pub const WP_FRAMELEFTSIZINGTEMPLATE: WINDOWPARTS = 32;
pub const WP_FRAMERIGHT: WINDOWPARTS = 8;
pub const WP_FRAMERIGHTSIZINGTEMPLATE: WINDOWPARTS = 34;
pub const WP_HELPBUTTON: WINDOWPARTS = 23;
pub const WP_HORZSCROLL: WINDOWPARTS = 25;
pub const WP_HORZTHUMB: WINDOWPARTS = 26;
pub const WP_MAXBUTTON: WINDOWPARTS = 17;
pub const WP_MAXCAPTION: WINDOWPARTS = 5;
pub const WP_MDICLOSEBUTTON: WINDOWPARTS = 20;
pub const WP_MDIHELPBUTTON: WINDOWPARTS = 24;
pub const WP_MDIMINBUTTON: WINDOWPARTS = 16;
pub const WP_MDIRESTOREBUTTON: WINDOWPARTS = 22;
pub const WP_MDISYSBUTTON: WINDOWPARTS = 14;
pub const WP_MINBUTTON: WINDOWPARTS = 15;
pub const WP_MINCAPTION: WINDOWPARTS = 3;
pub const WP_RESTOREBUTTON: WINDOWPARTS = 21;
pub const WP_SMALLCAPTION: WINDOWPARTS = 2;
pub const WP_SMALLCAPTIONSIZINGTEMPLATE: WINDOWPARTS = 31;
pub const WP_SMALLCLOSEBUTTON: WINDOWPARTS = 19;
pub const WP_SMALLFRAMEBOTTOM: WINDOWPARTS = 12;
pub const WP_SMALLFRAMEBOTTOMSIZINGTEMPLATE: WINDOWPARTS = 37;
pub const WP_SMALLFRAMELEFT: WINDOWPARTS = 10;
pub const WP_SMALLFRAMELEFTSIZINGTEMPLATE: WINDOWPARTS = 33;
pub const WP_SMALLFRAMERIGHT: WINDOWPARTS = 11;
pub const WP_SMALLFRAMERIGHTSIZINGTEMPLATE: WINDOWPARTS = 35;
pub const WP_SMALLMAXCAPTION: WINDOWPARTS = 6;
pub const WP_SMALLMINCAPTION: WINDOWPARTS = 4;
pub const WP_SYSBUTTON: WINDOWPARTS = 13;
pub const WP_VERTSCROLL: WINDOWPARTS = 27;
pub const WP_VERTTHUMB: WINDOWPARTS = 28;
pub type WRENCHSTATES = i32;
pub type WSB_PROP = i32;
pub const WSB_PROP_CXHSCROLL: WSB_PROP = 2;
pub const WSB_PROP_CXHTHUMB: WSB_PROP = 16;
pub const WSB_PROP_CXVSCROLL: WSB_PROP = 8;
pub const WSB_PROP_CYHSCROLL: WSB_PROP = 4;
pub const WSB_PROP_CYVSCROLL: WSB_PROP = 1;
pub const WSB_PROP_CYVTHUMB: WSB_PROP = 32;
pub const WSB_PROP_HBKGCOLOR: WSB_PROP = 128;
pub const WSB_PROP_HSTYLE: WSB_PROP = 512;
pub const WSB_PROP_MASK: i32 = 4095;
pub const WSB_PROP_PALETTE: WSB_PROP = 2048;
pub const WSB_PROP_VBKGCOLOR: WSB_PROP = 64;
pub const WSB_PROP_VSTYLE: WSB_PROP = 256;
pub const WSB_PROP_WINSTYLE: WSB_PROP = 1024;
