...
pub type BeginPanningFeedback = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type BufferedPaintRenderAnimation = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hdctarget: super::super::Graphics::Gdi::HDC) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type CheckDlgButton = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, nidbutton: i32, ucheck: DLG_BUTTON_CHECK_STATE) -> windows_sys::core::BOOL;
...
pub type CheckRadioButton = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, nidfirstbutton: i32, nidlastbutton: i32, nidcheckbutton: i32) -> windows_sys::core::BOOL;
...
pub type CloseThemeData = unsafe extern "system" fn(htheme: HTHEME) -> windows_sys::core::HRESULT;
...
pub type CreateStatusWindowA = unsafe extern "system" fn(style: i32, lpsztext: windows_sys::core::PCSTR, hwndparent: super::super::Foundation::HWND, wid: u32) -> super::super::Foundation::HWND;
...
pub type CreateStatusWindowW = unsafe extern "system" fn(style: i32, lpsztext: windows_sys::core::PCWSTR, hwndparent: super::super::Foundation::HWND, wid: u32) -> super::super::Foundation::HWND;
...
pub type CreateSyntheticPointerDevice = unsafe extern "system" fn(pointertype: super::WindowsAndMessaging::POINTER_INPUT_TYPE, maxcount: u32, mode: super::Input::Pointer::POINTER_FEEDBACK_MODE) -> super::Input::Pointer::HSYNTHETICPOINTERDEVICE;
#[cfg(all(feature = "Win32_UI_Input_Pointer", feature = "Win32_UI_WindowsAndMessaging"))]
...
pub type DPA_DeleteAllPtrs = unsafe extern "system" fn(hdpa: HDPA) -> windows_sys::core::BOOL;
...
pub type DPA_Destroy = unsafe extern "system" fn(hdpa: HDPA) -> windows_sys::core::BOOL;
...
pub type DPA_Grow = unsafe extern "system" fn(pdpa: HDPA, cp: i32) -> windows_sys::core::BOOL;
...
pub type DPA_LoadStream = unsafe extern "system" fn(phdpa: *mut HDPA, pfn: PFNDPASTREAM, pstream: *mut core::ffi::c_void, pvinstdata: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_System_Com")]
...
pub type DPA_Merge = unsafe extern "system" fn(hdpadest: HDPA, hdpasrc: HDPA, dwflags: u32, pfncompare: PFNDACOMPARE, pfnmerge: PFNDPAMERGE, lparam: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_System_Com")]
pub type DPA_SaveStream = unsafe extern "system" fn(hdpa: HDPA, pfn: PFNDPASTREAM, pstream: *mut core::ffi::c_void, pvinstdata: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_System_Com")]
...
pub type DPA_SetPtr = unsafe extern "system" fn(hdpa: HDPA, i: i32, p: *const core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("comctl32.dll" "system" fn DPA_SetPtr(hdpa : HDPA, i : i32, p : *const core::ffi::c_void) -> windows_sys::core::BOOL);
pub type DPA_Sort = unsafe extern "system" fn(hdpa: HDPA, pfncompare: PFNDACOMPARE, lparam: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
pub type DSA_DeleteAllItems = unsafe extern "system" fn(hdsa: HDSA) -> windows_sys::core::BOOL;
windows_link::link!("comctl32.dll" "system" fn DSA_DeleteAllItems(hdsa : HDSA) -> windows_sys::core::BOOL);
pub type DSA_DeleteItem = unsafe extern "system" fn(hdsa: HDSA, i: i32) -> windows_sys::core::BOOL;
windows_link::link!("comctl32.dll" "system" fn DSA_DeleteItem(hdsa : HDSA, i : i32) -> windows_sys::core::BOOL);
pub type DSA_Destroy = unsafe extern "system" fn(hdsa: HDSA) -> windows_sys::core::BOOL;
...
pub type DSA_GetItem = unsafe extern "system" fn(hdsa: HDSA, i: i32, pitem: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type DSA_SetItem = unsafe extern "system" fn(hdsa: HDSA, i: i32, pitem: *const core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("comctl32.dll" "system" fn DSA_SetItem(hdsa : HDSA, i : i32, pitem : *const core::ffi::c_void) -> windows_sys::core::BOOL);
pub type DSA_Sort = unsafe extern "system" fn(pdsa: HDSA, pfncompare: PFNDACOMPARE, lparam: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
pub type DestroyPropertySheetPage = unsafe extern "system" fn(param0: HPROPSHEETPAGE) -> windows_sys::core::BOOL;
windows_link::link!("comctl32.dll" "system" fn DestroyPropertySheetPage(param0 : HPROPSHEETPAGE) -> windows_sys::core::BOOL);
pub type DlgDirListA = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, lppathspec: windows_sys::core::PSTR, nidlistbox: i32, nidstaticpath: i32, ufiletype: DLG_DIR_LIST_FILE_TYPE) -> i32;
...
pub type DlgDirListComboBoxA = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, lppathspec: windows_sys::core::PSTR, nidcombobox: i32, nidstaticpath: i32, ufiletype: DLG_DIR_LIST_FILE_TYPE) -> i32;
...
pub type DlgDirListComboBoxW = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, lppathspec: windows_sys::core::PWSTR, nidcombobox: i32, nidstaticpath: i32, ufiletype: DLG_DIR_LIST_FILE_TYPE) -> i32;
...
pub type DlgDirListW = unsafe extern "system" fn(hdlg: super::super::Foundation::HWND, lppathspec: windows_sys::core::PWSTR, nidlistbox: i32, nidstaticpath: i32, ufiletype: DLG_DIR_LIST_FILE_TYPE) -> i32;
...
pub type DlgDirSelectComboBoxExA = unsafe extern "system" fn(hwnddlg: super::super::Foundation::HWND, lpstring: windows_sys::core::PSTR, cchout: i32, idcombobox: i32) -> windows_sys::core::BOOL;
...
pub type DlgDirSelectComboBoxExW = unsafe extern "system" fn(hwnddlg: super::super::Foundation::HWND, lpstring: windows_sys::core::PWSTR, cchout: i32, idcombobox: i32) -> windows_sys::core::BOOL;
...
pub type DlgDirSelectExA = unsafe extern "system" fn(hwnddlg: super::super::Foundation::HWND, lpstring: windows_sys::core::PSTR, chcount: i32, idlistbox: i32) -> windows_sys::core::BOOL;
...
pub type DlgDirSelectExW = unsafe extern "system" fn(hwnddlg: super::super::Foundation::HWND, lpstring: windows_sys::core::PWSTR, chcount: i32, idlistbox: i32) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type DrawShadowText = unsafe extern "system" fn(hdc: super::super::Graphics::Gdi::HDC, psztext: windows_sys::core::PCWSTR, cch: u32, prc: *const super::super::Foundation::RECT, dwflags: u32, crtext: super::super::Foundation::COLORREF, crshadow: super::super::Foundation::COLORREF, ixoffset: i32, iyoffset: i32) -> i32;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type DrawStatusTextA = unsafe extern "system" fn(hdc: super::super::Graphics::Gdi::HDC, lprc: *mut super::super::Foundation::RECT, psztext: windows_sys::core::PCSTR, uflags: u32);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type DrawStatusTextW = unsafe extern "system" fn(hdc: super::super::Graphics::Gdi::HDC, lprc: *mut super::super::Foundation::RECT, psztext: windows_sys::core::PCWSTR, uflags: u32);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type DrawThemeBackground = unsafe extern "system" fn(htheme: HTHEME, hdc: super::super::Graphics::Gdi::HDC, ipartid: i32, istateid: i32, prect: *const super::super::Foundation::RECT, pcliprect: *const super::super::Foundation::RECT) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type DrawThemeBackgroundEx = unsafe extern "system" fn(htheme: HTHEME, hdc: super::super::Graphics::Gdi::HDC, ipartid: i32, istateid: i32, prect: *const super::super::Foundation::RECT, poptions: *const DTBGOPTS) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type DrawThemeEdge = unsafe extern "system" fn(htheme: HTHEME, hdc: super::super::Graphics::Gdi::HDC, ipartid: i32, istateid: i32, pdestrect: *const super::super::Foundation::RECT, uedge: super::super::Graphics::Gdi::DRAWEDGE_FLAGS, uflags: super::super::Graphics::Gdi::DRAW_EDGE_FLAGS, pcontentrect: *mut super::super::Foundation::RECT) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type DrawThemeIcon = unsafe extern "system" fn(htheme: HTHEME, hdc: super::super::Graphics::Gdi::HDC, ipartid: i32, istateid: i32, prect: *const super::super::Foundation::RECT, himl: HIMAGELIST, iimageindex: i32) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type DrawThemeText = unsafe extern "system" fn(htheme: HTHEME, hdc: super::super::Graphics::Gdi::HDC, ipartid: i32, istateid: i32, psztext: windows_sys::core::PCWSTR, cchtext: i32, dwtextflags: super::super::Graphics::Gdi::DRAW_TEXT_FORMAT, dwtextflags2: u32, prect: *const super::super::Foundation::RECT) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type DrawThemeTextEx = unsafe extern "system" fn(htheme: HTHEME, hdc: super::super::Graphics::Gdi::HDC, ipartid: i32, istateid: i32, psztext: windows_sys::core::PCWSTR, cchtext: i32, dwtextflags: super::super::Graphics::Gdi::DRAW_TEXT_FORMAT, prect: *mut super::super::Foundation::RECT, poptions: *const DTTOPTS) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type EnableScrollBar = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, wsbflags: u32, warrows: ENABLE_SCROLL_BAR_ARROWS) -> windows_sys::core::BOOL;
...
pub type EnableTheming = unsafe extern "system" fn(fenable: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
windows_link::link!("uxtheme.dll" "system" fn EnableTheming(fenable : windows_sys::core::BOOL) -> windows_sys::core::HRESULT);
pub type EndBufferedAnimation = unsafe extern "system" fn(hbpanimation: isize, fupdatetarget: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type EndBufferedPaint = unsafe extern "system" fn(hbufferedpaint: isize, fupdatetarget: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type EndPanningFeedback = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, fanimateback: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type EvaluateProximityToPolygon = unsafe extern "system" fn(numvertices: u32, controlpolygon: *const super::super::Foundation::POINT, phittestinginput: *const TOUCH_HIT_TESTING_INPUT, pproximityeval: *mut TOUCH_HIT_TESTING_PROXIMITY_EVALUATION) -> windows_sys::core::BOOL;
...
pub type EvaluateProximityToRect = unsafe extern "system" fn(controlboundingbox: *const super::super::Foundation::RECT, phittestinginput: *const TOUCH_HIT_TESTING_INPUT, pproximityeval: *mut TOUCH_HIT_TESTING_PROXIMITY_EVALUATION) -> windows_sys::core::BOOL;
...
pub type FlatSB_EnableScrollBar = unsafe extern "system" fn(param0: super::super::Foundation::HWND, param1: i32, param2: u32) -> windows_sys::core::BOOL;
...
pub type FlatSB_GetScrollInfo = unsafe extern "system" fn(param0: super::super::Foundation::HWND, code: super::WindowsAndMessaging::SCROLLBAR_CONSTANTS, param2: *mut super::WindowsAndMessaging::SCROLLINFO) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
pub type FlatSB_GetScrollProp = unsafe extern "system" fn(param0: super::super::Foundation::HWND, propindex: WSB_PROP, param2: *mut i32) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type FlatSB_GetScrollRange = unsafe extern "system" fn(param0: super::super::Foundation::HWND, code: super::WindowsAndMessaging::SCROLLBAR_CONSTANTS, param2: *mut i32, param3: *mut i32) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type FlatSB_SetScrollInfo = unsafe extern "system" fn(param0: super::super::Foundation::HWND, code: super::WindowsAndMessaging::SCROLLBAR_CONSTANTS, psi: *mut super::WindowsAndMessaging::SCROLLINFO, fredraw: windows_sys::core::BOOL) -> i32;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type FlatSB_SetScrollPos = unsafe extern "system" fn(param0: super::super::Foundation::HWND, code: super::WindowsAndMessaging::SCROLLBAR_CONSTANTS, pos: i32, fredraw: windows_sys::core::BOOL) -> i32;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
pub type FlatSB_SetScrollProp = unsafe extern "system" fn(param0: super::super::Foundation::HWND, index: u32, newvalue: isize, param3: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type FlatSB_SetScrollRange = unsafe extern "system" fn(param0: super::super::Foundation::HWND, code: super::WindowsAndMessaging::SCROLLBAR_CONSTANTS, min: i32, max: i32, fredraw: windows_sys::core::BOOL) -> i32;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type FlatSB_ShowScrollBar = unsafe extern "system" fn(param0: super::super::Foundation::HWND, code: super::WindowsAndMessaging::SCROLLBAR_CONSTANTS, param2: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
pub type GetComboBoxInfo = unsafe extern "system" fn(hwndcombo: super::super::Foundation::HWND, pcbi: *mut COMBOBOXINFO) -> windows_sys::core::BOOL;
...
pub type GetCurrentThemeName = unsafe extern "system" fn(pszthemefilename: windows_sys::core::PWSTR, cchmaxnamechars: i32, pszcolorbuff: windows_sys::core::PWSTR, cchmaxcolorchars: i32, pszsizebuff: windows_sys::core::PWSTR, cchmaxsizechars: i32) -> windows_sys::core::HRESULT;
...
pub type GetThemeAnimationProperty = unsafe extern "system" fn(htheme: HTHEME, istoryboardid: i32, itargetid: i32, eproperty: TA_PROPERTY, pvproperty: *mut core::ffi::c_void, cbsize: u32, pcbsizeout: *mut u32) -> windows_sys::core::HRESULT;
...
pub type GetThemeAnimationTransform = unsafe extern "system" fn(htheme: HTHEME, istoryboardid: i32, itargetid: i32, dwtransformindex: u32, ptransform: *mut TA_TRANSFORM, cbsize: u32, pcbsizeout: *mut u32) -> windows_sys::core::HRESULT;
...
pub type GetThemeAppProperties = unsafe extern "system" fn() -> SET_THEME_APP_PROPERTIES_FLAGS;
windows_link::link!("uxtheme.dll" "system" fn GetThemeAppProperties() -> SET_THEME_APP_PROPERTIES_FLAGS);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetThemeBackgroundContentRect = unsafe extern "system" fn(htheme: HTHEME, hdc: super::super::Graphics::Gdi::HDC, ipartid: i32, istateid: i32, pboundingrect: *const super::super::Foundation::RECT, pcontentrect: *mut super::super::Foundation::RECT) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetThemeBackgroundExtent = unsafe extern "system" fn(htheme: HTHEME, hdc: super::super::Graphics::Gdi::HDC, ipartid: i32, istateid: i32, pcontentrect: *const super::super::Foundation::RECT, pextentrect: *mut super::super::Foundation::RECT) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetThemeBackgroundRegion = unsafe extern "system" fn(htheme: HTHEME, hdc: super::super::Graphics::Gdi::HDC, ipartid: i32, istateid: i32, prect: *const super::super::Foundation::RECT, pregion: *mut super::super::Graphics::Gdi::HRGN) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetThemeBitmap = unsafe extern "system" fn(htheme: HTHEME, ipartid: i32, istateid: i32, ipropid: i32, dwflags: GET_THEME_BITMAP_FLAGS, phbitmap: *mut super::super::Graphics::Gdi::HBITMAP) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GetThemeBool = unsafe extern "system" fn(htheme: HTHEME, ipartid: i32, istateid: i32, ipropid: i32, pfval: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type GetThemeColor = unsafe extern "system" fn(htheme: HTHEME, ipartid: i32, istateid: i32, ipropid: i32, pcolor: *mut super::super::Foundation::COLORREF) -> windows_sys::core::HRESULT;
...
pub type GetThemeDocumentationProperty = unsafe extern "system" fn(pszthemename: windows_sys::core::PCWSTR, pszpropertyname: windows_sys::core::PCWSTR, pszvaluebuff: windows_sys::core::PWSTR, cchmaxvalchars: i32) -> windows_sys::core::HRESULT;
...
pub type GetThemeEnumValue = unsafe extern "system" fn(htheme: HTHEME, ipartid: i32, istateid: i32, ipropid: i32, pival: *mut i32) -> windows_sys::core::HRESULT;
...
pub type GetThemeFilename = unsafe extern "system" fn(htheme: HTHEME, ipartid: i32, istateid: i32, ipropid: i32, pszthemefilename: windows_sys::core::PWSTR, cchmaxbuffchars: i32) -> windows_sys::core::HRESULT;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetThemeFont = unsafe extern "system" fn(htheme: HTHEME, hdc: super::super::Graphics::Gdi::HDC, ipartid: i32, istateid: i32, ipropid: i32, pfont: *mut super::super::Graphics::Gdi::LOGFONTW) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GetThemeInt = unsafe extern "system" fn(htheme: HTHEME, ipartid: i32, istateid: i32, ipropid: i32, pival: *mut i32) -> windows_sys::core::HRESULT;
...
pub type GetThemeIntList = unsafe extern "system" fn(htheme: HTHEME, ipartid: i32, istateid: i32, ipropid: i32, pintlist: *mut INTLIST) -> windows_sys::core::HRESULT;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetThemeMargins = unsafe extern "system" fn(htheme: HTHEME, hdc: super::super::Graphics::Gdi::HDC, ipartid: i32, istateid: i32, ipropid: i32, prc: *const super::super::Foundation::RECT, pmargins: *mut MARGINS) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetThemeMetric = unsafe extern "system" fn(htheme: HTHEME, hdc: super::super::Graphics::Gdi::HDC, ipartid: i32, istateid: i32, ipropid: i32, pival: *mut i32) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetThemePartSize = unsafe extern "system" fn(htheme: HTHEME, hdc: super::super::Graphics::Gdi::HDC, ipartid: i32, istateid: i32, prc: *const super::super::Foundation::RECT, esize: THEMESIZE, psz: *mut super::super::Foundation::SIZE) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GetThemePosition = unsafe extern "system" fn(htheme: HTHEME, ipartid: i32, istateid: i32, ipropid: i32, ppoint: *mut super::super::Foundation::POINT) -> windows_sys::core::HRESULT;
...
pub type GetThemePropertyOrigin = unsafe extern "system" fn(htheme: HTHEME, ipartid: i32, istateid: i32, ipropid: i32, porigin: *mut PROPERTYORIGIN) -> windows_sys::core::HRESULT;
...
pub type GetThemeRect = unsafe extern "system" fn(htheme: HTHEME, ipartid: i32, istateid: i32, ipropid: i32, prect: *mut super::super::Foundation::RECT) -> windows_sys::core::HRESULT;
...
pub type GetThemeStream = unsafe extern "system" fn(htheme: HTHEME, ipartid: i32, istateid: i32, ipropid: i32, ppvstream: *mut *mut core::ffi::c_void, pcbstream: *mut u32, hinst: super::super::Foundation::HINSTANCE) -> windows_sys::core::HRESULT;
...
pub type GetThemeString = unsafe extern "system" fn(htheme: HTHEME, ipartid: i32, istateid: i32, ipropid: i32, pszbuff: windows_sys::core::PWSTR, cchmaxbuffchars: i32) -> windows_sys::core::HRESULT;
...
pub type GetThemeSysBool = unsafe extern "system" fn(htheme: HTHEME, iboolid: i32) -> windows_sys::core::BOOL;
windows_link::link!("uxtheme.dll" "system" fn GetThemeSysBool(htheme : HTHEME, iboolid : i32) -> windows_sys::core::BOOL);
pub type GetThemeSysColor = unsafe extern "system" fn(htheme: HTHEME, icolorid: i32) -> super::super::Foundation::COLORREF;
windows_link::link!("uxtheme.dll" "system" fn GetThemeSysColor(htheme : HTHEME, icolorid : i32) -> super::super::Foundation::COLORREF);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetThemeSysColorBrush = unsafe extern "system" fn(htheme: HTHEME, icolorid: i32) -> super::super::Graphics::Gdi::HBRUSH;
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("uxtheme.dll" "system" fn GetThemeSysColorBrush(htheme : HTHEME, icolorid : i32) -> super::super::Graphics::Gdi::HBRUSH);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetThemeSysFont = unsafe extern "system" fn(htheme: HTHEME, ifontid: i32, plf: *mut super::super::Graphics::Gdi::LOGFONTW) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GetThemeSysInt = unsafe extern "system" fn(htheme: HTHEME, iintid: i32, pivalue: *mut i32) -> windows_sys::core::HRESULT;
windows_link::link!("uxtheme.dll" "system" fn GetThemeSysInt(htheme : HTHEME, iintid : i32, pivalue : *mut i32) -> windows_sys::core::HRESULT);
pub type GetThemeSysSize = unsafe extern "system" fn(htheme: HTHEME, isizeid: i32) -> i32;
windows_link::link!("uxtheme.dll" "system" fn GetThemeSysSize(htheme : HTHEME, isizeid : i32) -> i32);
pub type GetThemeSysString = unsafe extern "system" fn(htheme: HTHEME, istringid: i32, pszstringbuff: windows_sys::core::PWSTR, cchmaxstringchars: i32) -> windows_sys::core::HRESULT;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetThemeTextExtent = unsafe extern "system" fn(htheme: HTHEME, hdc: super::super::Graphics::Gdi::HDC, ipartid: i32, istateid: i32, psztext: windows_sys::core::PCWSTR, cchcharcount: i32, dwtextflags: super::super::Graphics::Gdi::DRAW_TEXT_FORMAT, pboundingrect: *const super::super::Foundation::RECT, pextentrect: *mut super::super::Foundation::RECT) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GetThemeTextMetrics = unsafe extern "system" fn(htheme: HTHEME, hdc: super::super::Graphics::Gdi::HDC, ipartid: i32, istateid: i32, ptm: *mut super::super::Graphics::Gdi::TEXTMETRICW) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GetThemeTimingFunction = unsafe extern "system" fn(htheme: HTHEME, itimingfunctionid: i32, ptimingfunction: *mut TA_TIMINGFUNCTION, cbsize: u32, pcbsizeout: *mut u32) -> windows_sys::core::HRESULT;
...
pub type GetThemeTransitionDuration = unsafe extern "system" fn(htheme: HTHEME, ipartid: i32, istateidfrom: i32, istateidto: i32, ipropid: i32, pdwduration: *mut u32) -> windows_sys::core::HRESULT;
...
pub type GetWindowFeedbackSetting = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, feedback: FEEDBACK_TYPE, dwflags: u32, psize: *mut u32, config: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type GetWindowTheme = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> HTHEME;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type HitTestThemeBackground = unsafe extern "system" fn(htheme: HTHEME, hdc: super::super::Graphics::Gdi::HDC, ipartid: i32, istateid: i32, dwoptions: HIT_TEST_BACKGROUND_OPTIONS, prect: *const super::super::Foundation::RECT, hrgn: super::super::Graphics::Gdi::HRGN, pttest: super::super::Foundation::POINT, pwhittestcode: *mut u16) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type ImageList_AddMasked = unsafe extern "system" fn(himl: HIMAGELIST, hbmimage: super::super::Graphics::Gdi::HBITMAP, crmask: super::super::Foundation::COLORREF) -> i32;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type ImageList_BeginDrag = unsafe extern "system" fn(himltrack: HIMAGELIST, itrack: i32, dxhotspot: i32, dyhotspot: i32) -> windows_sys::core::BOOL;
...
pub type ImageList_CoCreateInstance = unsafe extern "system" fn(rclsid: *const windows_sys::core::GUID, punkouter: *mut core::ffi::c_void, riid: *const windows_sys::core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type ImageList_Copy = unsafe extern "system" fn(himldst: HIMAGELIST, idst: i32, himlsrc: HIMAGELIST, isrc: i32, uflags: IMAGE_LIST_COPY_FLAGS) -> windows_sys::core::BOOL;
...
pub type ImageList_Destroy = unsafe extern "system" fn(himl: HIMAGELIST) -> windows_sys::core::BOOL;
windows_link::link!("comctl32.dll" "system" fn ImageList_Destroy(himl : HIMAGELIST) -> windows_sys::core::BOOL);
pub type ImageList_DragEnter = unsafe extern "system" fn(hwndlock: super::super::Foundation::HWND, x: i32, y: i32) -> windows_sys::core::BOOL;
...
pub type ImageList_DragLeave = unsafe extern "system" fn(hwndlock: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("comctl32.dll" "system" fn ImageList_DragLeave(hwndlock : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type ImageList_DragMove = unsafe extern "system" fn(x: i32, y: i32) -> windows_sys::core::BOOL;
windows_link::link!("comctl32.dll" "system" fn ImageList_DragMove(x : i32, y : i32) -> windows_sys::core::BOOL);
pub type ImageList_DragShowNolock = unsafe extern "system" fn(fshow: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("comctl32.dll" "system" fn ImageList_DragShowNolock(fshow : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type ImageList_Draw = unsafe extern "system" fn(himl: HIMAGELIST, i: i32, hdcdst: super::super::Graphics::Gdi::HDC, x: i32, y: i32, fstyle: IMAGE_LIST_DRAW_STYLE) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type ImageList_DrawEx = unsafe extern "system" fn(himl: HIMAGELIST, i: i32, hdcdst: super::super::Graphics::Gdi::HDC, x: i32, y: i32, dx: i32, dy: i32, rgbbk: super::super::Foundation::COLORREF, rgbfg: super::super::Foundation::COLORREF, fstyle: IMAGE_LIST_DRAW_STYLE) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type ImageList_DrawIndirect = unsafe extern "system" fn(pimldp: *const IMAGELISTDRAWPARAMS) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type ImageList_GetBkColor = unsafe extern "system" fn(himl: HIMAGELIST) -> super::super::Foundation::COLORREF;
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type ImageList_GetIcon = unsafe extern "system" fn(himl: HIMAGELIST, i: i32, flags: IMAGE_LIST_DRAW_STYLE) -> super::WindowsAndMessaging::HICON;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
pub type ImageList_GetIconSize = unsafe extern "system" fn(himl: HIMAGELIST, cx: *mut i32, cy: *mut i32) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type ImageList_GetImageInfo = unsafe extern "system" fn(himl: HIMAGELIST, i: i32, pimageinfo: *mut IMAGEINFO) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type ImageList_LoadImageA = unsafe extern "system" fn(hi: super::super::Foundation::HINSTANCE, lpbmp: windows_sys::core::PCSTR, cx: i32, cgrow: i32, crmask: super::super::Foundation::COLORREF, utype: u32, uflags: super::WindowsAndMessaging::IMAGE_FLAGS) -> HIMAGELIST;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type ImageList_LoadImageW = unsafe extern "system" fn(hi: super::super::Foundation::HINSTANCE, lpbmp: windows_sys::core::PCWSTR, cx: i32, cgrow: i32, crmask: super::super::Foundation::COLORREF, utype: u32, uflags: super::WindowsAndMessaging::IMAGE_FLAGS) -> HIMAGELIST;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
#[cfg(feature = "Win32_System_Com")]
pub type ImageList_Read = unsafe extern "system" fn(pstm: *mut core::ffi::c_void) -> HIMAGELIST;
#[cfg(feature = "Win32_System_Com")]
windows_link::link!("comctl32.dll" "system" fn ImageList_Read(pstm : *mut core::ffi::c_void) -> HIMAGELIST);
#[cfg(feature = "Win32_System_Com")]
pub type ImageList_ReadEx = unsafe extern "system" fn(dwflags: u32, pstm: *mut core::ffi::c_void, riid: *const windows_sys::core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_System_Com")]
...
pub type ImageList_Remove = unsafe extern "system" fn(himl: HIMAGELIST, i: i32) -> windows_sys::core::BOOL;
windows_link::link!("comctl32.dll" "system" fn ImageList_Remove(himl : HIMAGELIST, i : i32) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type ImageList_Replace = unsafe extern "system" fn(himl: HIMAGELIST, i: i32, hbmimage: super::super::Graphics::Gdi::HBITMAP, hbmmask: super::super::Graphics::Gdi::HBITMAP) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type ImageList_SetBkColor = unsafe extern "system" fn(himl: HIMAGELIST, clrbk: super::super::Foundation::COLORREF) -> super::super::Foundation::COLORREF;
...
pub type ImageList_SetDragCursorImage = unsafe extern "system" fn(himldrag: HIMAGELIST, idrag: i32, dxhotspot: i32, dyhotspot: i32) -> windows_sys::core::BOOL;
...
pub type ImageList_SetIconSize = unsafe extern "system" fn(himl: HIMAGELIST, cx: i32, cy: i32) -> windows_sys::core::BOOL;
windows_link::link!("comctl32.dll" "system" fn ImageList_SetIconSize(himl : HIMAGELIST, cx : i32, cy : i32) -> windows_sys::core::BOOL);
pub type ImageList_SetImageCount = unsafe extern "system" fn(himl: HIMAGELIST, unewcount: u32) -> windows_sys::core::BOOL;
windows_link::link!("comctl32.dll" "system" fn ImageList_SetImageCount(himl : HIMAGELIST, unewcount : u32) -> windows_sys::core::BOOL);
pub type ImageList_SetOverlayImage = unsafe extern "system" fn(himl: HIMAGELIST, iimage: i32, ioverlay: i32) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_System_Com")]
pub type ImageList_Write = unsafe extern "system" fn(himl: HIMAGELIST, pstm: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_System_Com")]
windows_link::link!("comctl32.dll" "system" fn ImageList_Write(himl : HIMAGELIST, pstm : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_System_Com")]
pub type ImageList_WriteEx = unsafe extern "system" fn(himl: HIMAGELIST, dwflags: IMAGE_LIST_WRITE_STREAM_FLAGS, pstm: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_System_Com")]
...
pub type InitCommonControlsEx = unsafe extern "system" fn(picce: *const INITCOMMONCONTROLSEX) -> windows_sys::core::BOOL;
...
pub type InitializeFlatSB = unsafe extern "system" fn(param0: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("comctl32.dll" "system" fn InitializeFlatSB(param0 : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type IsAppThemed = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("uxtheme.dll" "system" fn IsAppThemed() -> windows_sys::core::BOOL);
pub type IsCompositionActive = unsafe extern "system" fn() -> windows_sys::core::BOOL;
...
pub type IsThemeActive = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("uxtheme.dll" "system" fn IsThemeActive() -> windows_sys::core::BOOL);
pub type IsThemeBackgroundPartiallyTransparent = unsafe extern "system" fn(htheme: HTHEME, ipartid: i32, istateid: i32) -> windows_sys::core::BOOL;
...
pub type IsThemeDialogTextureEnabled = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
...
pub type IsThemePartDefined = unsafe extern "system" fn(htheme: HTHEME, ipartid: i32, istateid: i32) -> windows_sys::core::BOOL;
windows_link::link!("uxtheme.dll" "system" fn IsThemePartDefined(htheme : HTHEME, ipartid : i32, istateid : i32) -> windows_sys::core::BOOL);
pub type LBItemFromPt = unsafe extern "system" fn(hlb: super::super::Foundation::HWND, pt: super::super::Foundation::POINT, bautoscroll: windows_sys::core::BOOL) -> i32;
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type LoadIconMetric = unsafe extern "system" fn(hinst: super::super::Foundation::HINSTANCE, pszname: windows_sys::core::PCWSTR, lims: _LI_METRIC, phico: *mut super::WindowsAndMessaging::HICON) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type LoadIconWithScaleDown = unsafe extern "system" fn(hinst: super::super::Foundation::HINSTANCE, pszname: windows_sys::core::PCWSTR, cx: i32, cy: i32, phico: *mut super::WindowsAndMessaging::HICON) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
pub type MakeDragList = unsafe extern "system" fn(hlb: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
...
pub type OpenThemeData = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, pszclasslist: windows_sys::core::PCWSTR) -> HTHEME;
...
pub type OpenThemeDataEx = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, pszclasslist: windows_sys::core::PCWSTR, dwflags: OPEN_THEME_DATA_FLAGS) -> HTHEME;
...
pub type RegisterPointerDeviceNotifications = unsafe extern "system" fn(window: super::super::Foundation::HWND, notifyrange: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type RegisterTouchHitTestingWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, value: u32) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type SetScrollInfo = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nbar: super::WindowsAndMessaging::SCROLLBAR_CONSTANTS, lpsi: *const super::WindowsAndMessaging::SCROLLINFO, redraw: windows_sys::core::BOOL) -> i32;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type SetScrollPos = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nbar: super::WindowsAndMessaging::SCROLLBAR_CONSTANTS, npos: i32, bredraw: windows_sys::core::BOOL) -> i32;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type SetScrollRange = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, nbar: super::WindowsAndMessaging::SCROLLBAR_CONSTANTS, nminpos: i32, nmaxpos: i32, bredraw: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
pub type SetThemeAppProperties = unsafe extern "system" fn(dwflags: SET_THEME_APP_PROPERTIES_FLAGS);
windows_link::link!("uxtheme.dll" "system" fn SetThemeAppProperties(dwflags : SET_THEME_APP_PROPERTIES_FLAGS));
pub type SetWindowFeedbackSetting = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, feedback: FEEDBACK_TYPE, dwflags: u32, size: u32, configuration: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type SetWindowTheme = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, pszsubappname: windows_sys::core::PCWSTR, pszsubidlist: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type ShowHideMenuCtl = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, uflags: usize, lpinfo: *const i32) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type ShowScrollBar = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, wbar: super::WindowsAndMessaging::SCROLLBAR_CONSTANTS, bshow: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
pub type Str_SetPtrW = unsafe extern "system" fn(ppsz: *mut windows_sys::core::PWSTR, psz: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type TaskDialog = unsafe extern "system" fn(hwndowner: super::super::Foundation::HWND, hinstance: super::super::Foundation::HINSTANCE, pszwindowtitle: windows_sys::core::PCWSTR, pszmaininstruction: windows_sys::core::PCWSTR, pszcontent: windows_sys::core::PCWSTR, dwcommonbuttons: TASKDIALOG_COMMON_BUTTON_FLAGS, pszicon: windows_sys::core::PCWSTR, pnbutton: *mut i32) -> windows_sys::core::HRESULT;
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type TaskDialogIndirect = unsafe extern "system" fn(ptaskconfig: *const TASKDIALOGCONFIG, pnbutton: *mut i32, pnradiobutton: *mut i32, pfverificationflagchecked: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
pub type UpdatePanningFeedback = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, ltotaloverpanoffsetx: i32, ltotaloverpanoffsety: i32, fininertia: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
