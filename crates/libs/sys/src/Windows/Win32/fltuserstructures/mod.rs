...
pub const FLTFL_AGGREGATE_INFO_IS_LEGACYFILTER: i32 = 2;
pub const FLTFL_AGGREGATE_INFO_IS_MINIFILTER: i32 = 1;
pub const FLTFL_ASI_IS_LEGACYFILTER: i32 = 2;
pub const FLTFL_ASI_IS_MINIFILTER: i32 = 1;
pub const FLTFL_IASIL_DETACHED_VOLUME: i32 = 1;
pub const FLTFL_IASIM_DETACHED_VOLUME: i32 = 1;
pub const FLTFL_IASI_IS_LEGACYFILTER: i32 = 2;
pub const FLTFL_IASI_IS_MINIFILTER: i32 = 1;
pub const FLTFL_VSI_DETACHED_VOLUME: i32 = 1;
...
#[cfg(feature = "winnt")]
pub type HFILTER = super::HANDLE;
#[cfg(feature = "winnt")]
pub type HFILTER_INSTANCE = super::HANDLE;
#[cfg(feature = "winnt")]
pub type HFILTER_VOLUME = super::HANDLE;
#[repr(C)]
#[derive(Clone, Copy)]
