...
#[cfg(all(feature = "Win32_in6addr", feature = "Win32_ipexport", feature = "Win32_minwindef", feature = "Win32_winnt", feature = "Win32_ws2def", feature = "Win32_ws2ipdef"))]
windows_link::link!("iphlpapi.dll" "system" fn Icmp6SendEcho2(icmphandle : super::winnt::HANDLE, event : super::winnt::HANDLE, apcroutine : super::minwindef::FARPROC, apccontext : *const core::ffi::c_void, sourceaddress : *const super::ws2ipdef::SOCKADDR_IN6_LH, destinationaddress : *const super::ws2ipdef::SOCKADDR_IN6_LH, requestdata : *const core::ffi::c_void, requestsize : u16, requestoptions : *const super::ipexport::IP_OPTION_INFORMATION, replybuffer : *mut core::ffi::c_void, replysize : u32, timeout : u32) -> u32);
#[cfg(feature = "Win32_winnt")]
