...
pub type ELEMENTID = windows_sys::core::GUID;
pub type FOLDERTYPEID = windows_sys::core::GUID;
#[repr(C)]
...
pub const PERCEIVEDFLAG_SOFTCODED: i32 = 1;
pub const PERCEIVEDFLAG_UNDEFINED: i32 = 0;
pub const PERCEIVEDFLAG_WMSDK: i32 = 32;
pub const PERCEIVEDFLAG_ZIPFOLDER: i32 = 64;
...
#[cfg(feature = "wtypes")]
pub type SHCOLUMNID = super::PROPERTYKEY;
#[repr(C, packed(1))]
#[derive(Clone, Copy)]
...
pub type wirePIDL = *mut super::BYTE_BLOB;
