...
windows_link::link!("kernel32.dll" "system" fn CheckRemoteDebuggerPresent(hprocess : super::HANDLE, pbdebuggerpresent : super::PBOOL) -> windows_sys::core::BOOL);
...
windows_link::link!("kernel32.dll" "system" fn WaitForDebugEvent(lpdebugevent : super::LPDEBUG_EVENT, dwmilliseconds : u32) -> windows_sys::core::BOOL);
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
windows_link::link!("kernel32.dll" "system" fn WaitForDebugEventEx(lpdebugevent : super::LPDEBUG_EVENT, dwmilliseconds : u32) -> windows_sys::core::BOOL);
