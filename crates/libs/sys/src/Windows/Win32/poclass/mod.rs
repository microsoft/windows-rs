...
pub type BATTERY_CHARGER_ID = windows_sys::core::GUID;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const PROCESSOR_NUMBER_PKEY: super::DEVPROPKEY = super::DEVPROPKEY { fmtid: windows_sys::core::GUID::from_u128(0x5724c81d_d5af_4c1f_a103_a06e28f204c6), pid: 1 };
#[repr(C)]
#[derive(Clone, Copy, Default)]
