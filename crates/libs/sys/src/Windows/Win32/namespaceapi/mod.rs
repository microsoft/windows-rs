...
#[cfg(feature = "winnt")]
windows_link::link!("kernel32.dll" "system" fn ClosePrivateNamespace(handle : super::HANDLE, flags : u32) -> super::BOOLEAN);
#[cfg(feature = "winnt")]
...
windows_link::link!("kernel32.dll" "system" fn CreatePrivateNamespaceW(lpprivatenamespaceattributes : super::LPSECURITY_ATTRIBUTES, lpboundarydescriptor : *const core::ffi::c_void, lpaliasprefix : windows_sys::core::PCWSTR) -> super::HANDLE);
#[cfg(feature = "winnt")]
