...
#[cfg(feature = "winnt")]
windows_link::link!("api-ms-win-core-memory-l1-1-6.dll" "system" fn MapViewOfFile3FromApp(filemapping : super::HANDLE, process : super::HANDLE, baseaddress : *const core::ffi::c_void, offset : u64, viewsize : usize, allocationtype : u32, pageprotection : u32, extendedparameters : *mut super::MEM_EXTENDED_PARAMETER, parametercount : u32) -> *mut core::ffi::c_void);
#[cfg(feature = "winnt")]
windows_link::link!("kernel32.dll" "system" fn MapViewOfFileEx(hfilemappingobject : super::HANDLE, dwdesiredaccess : u32, dwfileoffsethigh : u32, dwfileoffsetlow : u32, dwnumberofbytestomap : usize, lpbaseaddress : *const core::ffi::c_void) -> *mut core::ffi::c_void);
#[cfg(feature = "winnt")]
windows_link::link!("kernel32.dll" "system" fn MapViewOfFileFromApp(hfilemappingobject : super::HANDLE, desiredaccess : u32, fileoffset : u64, numberofbytestomap : usize) -> *mut core::ffi::c_void);
#[cfg(feature = "winnt")]
windows_link::link!("api-ms-win-core-memory-l1-1-5.dll" "system" fn MapViewOfFileNuma2(filemappinghandle : super::HANDLE, processhandle : super::HANDLE, offset : u64, baseaddress : *const core::ffi::c_void, viewsize : usize, allocationtype : u32, pageprotection : u32, preferrednode : u32) -> *mut core::ffi::c_void);
...
#[cfg(feature = "winnt")]
windows_link::link!("api-ms-win-core-memory-l1-1-8.dll" "system" fn OpenDedicatedMemoryPartition(partition : super::HANDLE, dedicatedmemorytypeid : u64, desiredaccess : super::ACCESS_MASK, inherithandle : windows_sys::core::BOOL) -> super::HANDLE);
#[cfg(feature = "winnt")]
windows_link::link!("api-ms-win-core-memory-l1-1-3.dll" "system" fn OpenFileMappingFromApp(desiredaccess : u32, inherithandle : windows_sys::core::BOOL, name : windows_sys::core::PCWSTR) -> super::HANDLE);
#[cfg(feature = "winnt")]
...
#[cfg(feature = "winnt")]
windows_link::link!("api-ms-win-core-memory-l1-1-6.dll" "system" fn VirtualAlloc2(process : super::HANDLE, baseaddress : *const core::ffi::c_void, size : usize, allocationtype : u32, pageprotection : u32, extendedparameters : *mut super::MEM_EXTENDED_PARAMETER, parametercount : u32) -> *mut core::ffi::c_void);
#[cfg(feature = "winnt")]
windows_link::link!("api-ms-win-core-memory-l1-1-6.dll" "system" fn VirtualAlloc2FromApp(process : super::HANDLE, baseaddress : *const core::ffi::c_void, size : usize, allocationtype : u32, pageprotection : u32, extendedparameters : *mut super::MEM_EXTENDED_PARAMETER, parametercount : u32) -> *mut core::ffi::c_void);
#[cfg(feature = "winnt")]
windows_link::link!("kernel32.dll" "system" fn VirtualAllocEx(hprocess : super::HANDLE, lpaddress : *const core::ffi::c_void, dwsize : usize, flallocationtype : u32, flprotect : u32) -> *mut core::ffi::c_void);
#[cfg(feature = "winnt")]
windows_link::link!("kernel32.dll" "system" fn VirtualAllocExNuma(hprocess : super::HANDLE, lpaddress : *const core::ffi::c_void, dwsize : usize, flallocationtype : u32, flprotect : u32, nndpreferred : u32) -> *mut core::ffi::c_void);
