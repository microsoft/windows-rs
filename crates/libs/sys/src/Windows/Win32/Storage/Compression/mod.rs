pub type CloseCompressor = unsafe extern "system" fn(compressorhandle: COMPRESSOR_HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("cabinet.dll" "system" fn CloseCompressor(compressorhandle : COMPRESSOR_HANDLE) -> windows_sys::core::BOOL);
pub type CloseDecompressor = unsafe extern "system" fn(decompressorhandle: DECOMPRESSOR_HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("cabinet.dll" "system" fn CloseDecompressor(decompressorhandle : DECOMPRESSOR_HANDLE) -> windows_sys::core::BOOL);
pub type Compress = unsafe extern "system" fn(compressorhandle: COMPRESSOR_HANDLE, uncompresseddata: *const core::ffi::c_void, uncompresseddatasize: usize, compressedbuffer: *mut core::ffi::c_void, compressedbuffersize: usize, compresseddatasize: *mut usize) -> windows_sys::core::BOOL;
...
pub type CreateCompressor = unsafe extern "system" fn(algorithm: COMPRESS_ALGORITHM, allocationroutines: *const COMPRESS_ALLOCATION_ROUTINES, compressorhandle: *mut COMPRESSOR_HANDLE) -> windows_sys::core::BOOL;
...
pub type CreateDecompressor = unsafe extern "system" fn(algorithm: COMPRESS_ALGORITHM, allocationroutines: *const COMPRESS_ALLOCATION_ROUTINES, decompressorhandle: *mut DECOMPRESSOR_HANDLE) -> windows_sys::core::BOOL;
...
pub type Decompress = unsafe extern "system" fn(decompressorhandle: DECOMPRESSOR_HANDLE, compresseddata: *const core::ffi::c_void, compresseddatasize: usize, uncompressedbuffer: *mut core::ffi::c_void, uncompressedbuffersize: usize, uncompresseddatasize: *mut usize) -> windows_sys::core::BOOL;
...
pub type QueryCompressorInformation = unsafe extern "system" fn(compressorhandle: COMPRESSOR_HANDLE, compressinformationclass: COMPRESS_INFORMATION_CLASS, compressinformation: *mut core::ffi::c_void, compressinformationsize: usize) -> windows_sys::core::BOOL;
...
pub type QueryDecompressorInformation = unsafe extern "system" fn(decompressorhandle: DECOMPRESSOR_HANDLE, compressinformationclass: COMPRESS_INFORMATION_CLASS, compressinformation: *mut core::ffi::c_void, compressinformationsize: usize) -> windows_sys::core::BOOL;
...
pub type ResetCompressor = unsafe extern "system" fn(compressorhandle: COMPRESSOR_HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("cabinet.dll" "system" fn ResetCompressor(compressorhandle : COMPRESSOR_HANDLE) -> windows_sys::core::BOOL);
pub type ResetDecompressor = unsafe extern "system" fn(decompressorhandle: DECOMPRESSOR_HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("cabinet.dll" "system" fn ResetDecompressor(decompressorhandle : DECOMPRESSOR_HANDLE) -> windows_sys::core::BOOL);
pub type SetCompressorInformation = unsafe extern "system" fn(compressorhandle: COMPRESSOR_HANDLE, compressinformationclass: COMPRESS_INFORMATION_CLASS, compressinformation: *const core::ffi::c_void, compressinformationsize: usize) -> windows_sys::core::BOOL;
...
pub type SetDecompressorInformation = unsafe extern "system" fn(decompressorhandle: DECOMPRESSOR_HANDLE, compressinformationclass: COMPRESS_INFORMATION_CLASS, compressinformation: *const core::ffi::c_void, compressinformationsize: usize) -> windows_sys::core::BOOL;
