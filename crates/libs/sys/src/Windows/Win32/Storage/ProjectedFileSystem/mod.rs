pub type PrjAllocateAlignedBuffer = unsafe extern "system" fn(namespacevirtualizationcontext: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT, size: usize) -> *mut core::ffi::c_void;
...
pub type PrjClearNegativePathCache = unsafe extern "system" fn(namespacevirtualizationcontext: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT, totalentrynumber: *mut u32) -> windows_sys::core::HRESULT;
...
pub type PrjCompleteCommand = unsafe extern "system" fn(namespacevirtualizationcontext: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT, commandid: i32, completionresult: windows_sys::core::HRESULT, extendedparameters: *const PRJ_COMPLETE_COMMAND_EXTENDED_PARAMETERS) -> windows_sys::core::HRESULT;
...
pub type PrjDeleteFile = unsafe extern "system" fn(namespacevirtualizationcontext: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT, destinationfilename: windows_sys::core::PCWSTR, updateflags: PRJ_UPDATE_TYPES, failurereason: *mut PRJ_UPDATE_FAILURE_CAUSES) -> windows_sys::core::HRESULT;
...
pub type PrjDoesNameContainWildCards = unsafe extern "system" fn(filename: windows_sys::core::PCWSTR) -> bool;
windows_link::link!("projectedfslib.dll" "system" fn PrjDoesNameContainWildCards(filename : windows_sys::core::PCWSTR) -> bool);
pub type PrjFileNameCompare = unsafe extern "system" fn(filename1: windows_sys::core::PCWSTR, filename2: windows_sys::core::PCWSTR) -> i32;
...
pub type PrjFileNameMatch = unsafe extern "system" fn(filenametocheck: windows_sys::core::PCWSTR, pattern: windows_sys::core::PCWSTR) -> bool;
...
pub type PrjFillDirEntryBuffer = unsafe extern "system" fn(filename: windows_sys::core::PCWSTR, filebasicinfo: *const PRJ_FILE_BASIC_INFO, direntrybufferhandle: PRJ_DIR_ENTRY_BUFFER_HANDLE) -> windows_sys::core::HRESULT;
...
pub type PrjFillDirEntryBuffer2 = unsafe extern "system" fn(direntrybufferhandle: PRJ_DIR_ENTRY_BUFFER_HANDLE, filename: windows_sys::core::PCWSTR, filebasicinfo: *const PRJ_FILE_BASIC_INFO, extendedinfo: *const PRJ_EXTENDED_INFO) -> windows_sys::core::HRESULT;
...
pub type PrjFreeAlignedBuffer = unsafe extern "system" fn(buffer: *const core::ffi::c_void);
windows_link::link!("projectedfslib.dll" "system" fn PrjFreeAlignedBuffer(buffer : *const core::ffi::c_void));
pub type PrjGetOnDiskFileState = unsafe extern "system" fn(destinationfilename: windows_sys::core::PCWSTR, filestate: *mut PRJ_FILE_STATE) -> windows_sys::core::HRESULT;
...
pub type PrjGetVirtualizationInstanceInfo = unsafe extern "system" fn(namespacevirtualizationcontext: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT, virtualizationinstanceinfo: *mut PRJ_VIRTUALIZATION_INSTANCE_INFO) -> windows_sys::core::HRESULT;
...
pub type PrjMarkDirectoryAsPlaceholder = unsafe extern "system" fn(rootpathname: windows_sys::core::PCWSTR, targetpathname: windows_sys::core::PCWSTR, versioninfo: *const PRJ_PLACEHOLDER_VERSION_INFO, virtualizationinstanceid: *const windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type PrjStartVirtualizing = unsafe extern "system" fn(virtualizationrootpath: windows_sys::core::PCWSTR, callbacks: *const PRJ_CALLBACKS, instancecontext: *const core::ffi::c_void, options: *const PRJ_STARTVIRTUALIZING_OPTIONS, namespacevirtualizationcontext: *mut PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT) -> windows_sys::core::HRESULT;
...
pub type PrjStopVirtualizing = unsafe extern "system" fn(namespacevirtualizationcontext: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT);
...
pub type PrjUpdateFileIfNeeded = unsafe extern "system" fn(namespacevirtualizationcontext: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT, destinationfilename: windows_sys::core::PCWSTR, placeholderinfo: *const PRJ_PLACEHOLDER_INFO, placeholderinfosize: u32, updateflags: PRJ_UPDATE_TYPES, failurereason: *mut PRJ_UPDATE_FAILURE_CAUSES) -> windows_sys::core::HRESULT;
...
pub type PrjWriteFileData = unsafe extern "system" fn(namespacevirtualizationcontext: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT, datastreamid: *const windows_sys::core::GUID, buffer: *const core::ffi::c_void, byteoffset: u64, length: u32) -> windows_sys::core::HRESULT;
...
pub type PrjWritePlaceholderInfo = unsafe extern "system" fn(namespacevirtualizationcontext: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT, destinationfilename: windows_sys::core::PCWSTR, placeholderinfo: *const PRJ_PLACEHOLDER_INFO, placeholderinfosize: u32) -> windows_sys::core::HRESULT;
...
pub type PrjWritePlaceholderInfo2 = unsafe extern "system" fn(namespacevirtualizationcontext: PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT, destinationfilename: windows_sys::core::PCWSTR, placeholderinfo: *const PRJ_PLACEHOLDER_INFO, placeholderinfosize: u32, extendedinfo: *const PRJ_EXTENDED_INFO) -> windows_sys::core::HRESULT;
