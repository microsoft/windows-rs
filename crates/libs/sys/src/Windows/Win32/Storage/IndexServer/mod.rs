...
pub const WORDREP_BREAK_EOC: WORDREP_BREAK_TYPE = 3;
pub const WORDREP_BREAK_EOP: WORDREP_BREAK_TYPE = 2;
pub const WORDREP_BREAK_EOS: WORDREP_BREAK_TYPE = 1;
pub const WORDREP_BREAK_EOW: WORDREP_BREAK_TYPE = 0;
