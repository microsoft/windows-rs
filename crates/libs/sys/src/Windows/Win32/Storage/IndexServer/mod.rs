...
::windows_sys::core::link ! ( "query.dll" ,"system" fn BindIFilterFromStorage ( pstg : super::super::System::Com::StructuredStorage:: IStorage , punkouter : :: windows_sys::core::IUnknown , ppiunk : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::link ! ( "query.dll" ,"system" fn BindIFilterFromStream ( pstm : super::super::System::Com:: IStream , punkouter : :: windows_sys::core::IUnknown , ppiunk : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "query.dll" ,"system" fn LoadIFilter ( pwcspath : :: windows_sys::core::PCWSTR , punkouter : :: windows_sys::core::IUnknown , ppiunk : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "query.dll" ,"system" fn LoadIFilterEx ( pwcspath : :: windows_sys::core::PCWSTR , dwflags : u32 , riid : *const :: windows_sys::core::GUID , ppiunk : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
