pub type FilterAttach = unsafe extern "system" fn(lpfiltername: windows_sys::core::PCWSTR, lpvolumename: windows_sys::core::PCWSTR, lpinstancename: windows_sys::core::PCWSTR, dwcreatedinstancenamelength: u32, lpcreatedinstancename: windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type FilterClose = unsafe extern "system" fn(hfilter: HFILTER) -> windows_sys::core::HRESULT;
windows_link::link!("fltlib.dll" "system" fn FilterClose(hfilter : HFILTER) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security")]
pub type FilterConnectCommunicationPort = unsafe extern "system" fn(lpportname: windows_sys::core::PCWSTR, dwoptions: u32, lpcontext: *const core::ffi::c_void, wsizeofcontext: u16, lpsecurityattributes: *const super::super::Security::SECURITY_ATTRIBUTES, hport: *mut super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Security")]
...
pub type FilterCreate = unsafe extern "system" fn(lpfiltername: windows_sys::core::PCWSTR, hfilter: *mut HFILTER) -> windows_sys::core::HRESULT;
...
pub type FilterDetach = unsafe extern "system" fn(lpfiltername: windows_sys::core::PCWSTR, lpvolumename: windows_sys::core::PCWSTR, lpinstancename: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type FilterFindClose = unsafe extern "system" fn(hfilterfind: super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type FilterFindFirst = unsafe extern "system" fn(dwinformationclass: FILTER_INFORMATION_CLASS, lpbuffer: *mut core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32, lpfilterfind: *mut super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type FilterFindNext = unsafe extern "system" fn(hfilterfind: super::super::Foundation::HANDLE, dwinformationclass: FILTER_INFORMATION_CLASS, lpbuffer: *mut core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32) -> windows_sys::core::HRESULT;
...
pub type FilterGetDosName = unsafe extern "system" fn(lpvolumename: windows_sys::core::PCWSTR, lpdosname: windows_sys::core::PWSTR, dwdosnamebuffersize: u32) -> windows_sys::core::HRESULT;
...
pub type FilterGetInformation = unsafe extern "system" fn(hfilter: HFILTER, dwinformationclass: FILTER_INFORMATION_CLASS, lpbuffer: *mut core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32) -> windows_sys::core::HRESULT;
...
pub type FilterGetMessage = unsafe extern "system" fn(hport: super::super::Foundation::HANDLE, lpmessagebuffer: *mut FILTER_MESSAGE_HEADER, dwmessagebuffersize: u32, lpoverlapped: *mut super::super::System::IO::OVERLAPPED) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_System_IO")]
...
pub type FilterInstanceClose = unsafe extern "system" fn(hinstance: HFILTER_INSTANCE) -> windows_sys::core::HRESULT;
windows_link::link!("fltlib.dll" "system" fn FilterInstanceClose(hinstance : HFILTER_INSTANCE) -> windows_sys::core::HRESULT);
pub type FilterInstanceCreate = unsafe extern "system" fn(lpfiltername: windows_sys::core::PCWSTR, lpvolumename: windows_sys::core::PCWSTR, lpinstancename: windows_sys::core::PCWSTR, hinstance: *mut HFILTER_INSTANCE) -> windows_sys::core::HRESULT;
...
pub type FilterInstanceFindClose = unsafe extern "system" fn(hfilterinstancefind: super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type FilterInstanceFindFirst = unsafe extern "system" fn(lpfiltername: windows_sys::core::PCWSTR, dwinformationclass: INSTANCE_INFORMATION_CLASS, lpbuffer: *mut core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32, lpfilterinstancefind: *mut super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type FilterInstanceFindNext = unsafe extern "system" fn(hfilterinstancefind: super::super::Foundation::HANDLE, dwinformationclass: INSTANCE_INFORMATION_CLASS, lpbuffer: *mut core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32) -> windows_sys::core::HRESULT;
...
pub type FilterInstanceGetInformation = unsafe extern "system" fn(hinstance: HFILTER_INSTANCE, dwinformationclass: INSTANCE_INFORMATION_CLASS, lpbuffer: *mut core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32) -> windows_sys::core::HRESULT;
...
pub type FilterLoad = unsafe extern "system" fn(lpfiltername: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
windows_link::link!("fltlib.dll" "system" fn FilterLoad(lpfiltername : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
pub type FilterReplyMessage = unsafe extern "system" fn(hport: super::super::Foundation::HANDLE, lpreplybuffer: *const FILTER_REPLY_HEADER, dwreplybuffersize: u32) -> windows_sys::core::HRESULT;
...
pub type FilterSendMessage = unsafe extern "system" fn(hport: super::super::Foundation::HANDLE, lpinbuffer: *const core::ffi::c_void, dwinbuffersize: u32, lpoutbuffer: *mut core::ffi::c_void, dwoutbuffersize: u32, lpbytesreturned: *mut u32) -> windows_sys::core::HRESULT;
...
pub type FilterUnload = unsafe extern "system" fn(lpfiltername: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
windows_link::link!("fltlib.dll" "system" fn FilterUnload(lpfiltername : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
pub type FilterVolumeFindClose = unsafe extern "system" fn(hvolumefind: super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type FilterVolumeFindFirst = unsafe extern "system" fn(dwinformationclass: FILTER_VOLUME_INFORMATION_CLASS, lpbuffer: *mut core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32, lpvolumefind: *mut super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type FilterVolumeFindNext = unsafe extern "system" fn(hvolumefind: super::super::Foundation::HANDLE, dwinformationclass: FILTER_VOLUME_INFORMATION_CLASS, lpbuffer: *mut core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32) -> windows_sys::core::HRESULT;
...
pub type FilterVolumeInstanceFindClose = unsafe extern "system" fn(hvolumeinstancefind: super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type FilterVolumeInstanceFindFirst = unsafe extern "system" fn(lpvolumename: windows_sys::core::PCWSTR, dwinformationclass: INSTANCE_INFORMATION_CLASS, lpbuffer: *mut core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32, lpvolumeinstancefind: *mut super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type FilterVolumeInstanceFindNext = unsafe extern "system" fn(hvolumeinstancefind: super::super::Foundation::HANDLE, dwinformationclass: INSTANCE_INFORMATION_CLASS, lpbuffer: *mut core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32) -> windows_sys::core::HRESULT;
