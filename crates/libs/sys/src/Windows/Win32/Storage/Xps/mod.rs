...
pub const XPS_E_ABSOLUTE_REFERENCE: ::windows_sys::core::HRESULT = 0x80520601u32 as _;
pub const XPS_E_ALREADY_OWNED: ::windows_sys::core::HRESULT = 0x80520503u32 as _;
pub const XPS_E_BLEED_BOX_PAGE_DIMENSIONS_NOT_IN_SYNC: ::windows_sys::core::HRESULT = 0x80520509u32 as _;
pub const XPS_E_BOTH_PATHFIGURE_AND_ABBR_SYNTAX_PRESENT: ::windows_sys::core::HRESULT = 0x80520507u32 as _;
pub const XPS_E_BOTH_RESOURCE_AND_SOURCEATTR_PRESENT: ::windows_sys::core::HRESULT = 0x80520508u32 as _;
pub const XPS_E_CARET_OUTSIDE_STRING: ::windows_sys::core::HRESULT = 0x80520305u32 as _;
pub const XPS_E_CARET_OUT_OF_ORDER: ::windows_sys::core::HRESULT = 0x80520306u32 as _;
pub const XPS_E_COLOR_COMPONENT_OUT_OF_RANGE: ::windows_sys::core::HRESULT = 0x80520506u32 as _;
pub const XPS_E_DICTIONARY_ITEM_NAMED: ::windows_sys::core::HRESULT = 0x80520401u32 as _;
pub const XPS_E_DUPLICATE_NAMES: ::windows_sys::core::HRESULT = 0x80520209u32 as _;
pub const XPS_E_DUPLICATE_RESOURCE_KEYS: ::windows_sys::core::HRESULT = 0x80520200u32 as _;
pub const XPS_E_INDEX_OUT_OF_RANGE: ::windows_sys::core::HRESULT = 0x80520500u32 as _;
pub const XPS_E_INVALID_BLEED_BOX: ::windows_sys::core::HRESULT = 0x80520004u32 as _;
pub const XPS_E_INVALID_CONTENT_BOX: ::windows_sys::core::HRESULT = 0x8052000Bu32 as _;
pub const XPS_E_INVALID_CONTENT_TYPE: ::windows_sys::core::HRESULT = 0x8052000Eu32 as _;
pub const XPS_E_INVALID_FLOAT: ::windows_sys::core::HRESULT = 0x80520007u32 as _;
pub const XPS_E_INVALID_FONT_URI: ::windows_sys::core::HRESULT = 0x8052000Au32 as _;
pub const XPS_E_INVALID_LANGUAGE: ::windows_sys::core::HRESULT = 0x80520000u32 as _;
pub const XPS_E_INVALID_LOOKUP_TYPE: ::windows_sys::core::HRESULT = 0x80520006u32 as _;
pub const XPS_E_INVALID_MARKUP: ::windows_sys::core::HRESULT = 0x8052000Cu32 as _;
pub const XPS_E_INVALID_NAME: ::windows_sys::core::HRESULT = 0x80520001u32 as _;
pub const XPS_E_INVALID_NUMBER_OF_COLOR_CHANNELS: ::windows_sys::core::HRESULT = 0x80520602u32 as _;
pub const XPS_E_INVALID_NUMBER_OF_POINTS_IN_CURVE_SEGMENTS: ::windows_sys::core::HRESULT = 0x80520600u32 as _;
pub const XPS_E_INVALID_OBFUSCATED_FONT_URI: ::windows_sys::core::HRESULT = 0x8052000Fu32 as _;
pub const XPS_E_INVALID_PAGE_SIZE: ::windows_sys::core::HRESULT = 0x80520003u32 as _;
pub const XPS_E_INVALID_RESOURCE_KEY: ::windows_sys::core::HRESULT = 0x80520002u32 as _;
pub const XPS_E_INVALID_SIGNATUREBLOCK_MARKUP: ::windows_sys::core::HRESULT = 0x8052038Bu32 as _;
pub const XPS_E_INVALID_THUMBNAIL_IMAGE_TYPE: ::windows_sys::core::HRESULT = 0x80520005u32 as _;
pub const XPS_E_INVALID_XML_ENCODING: ::windows_sys::core::HRESULT = 0x8052000Du32 as _;
pub const XPS_E_MAPPING_OUTSIDE_INDICES: ::windows_sys::core::HRESULT = 0x80520304u32 as _;
pub const XPS_E_MAPPING_OUTSIDE_STRING: ::windows_sys::core::HRESULT = 0x80520303u32 as _;
pub const XPS_E_MAPPING_OUT_OF_ORDER: ::windows_sys::core::HRESULT = 0x80520302u32 as _;
pub const XPS_E_MARKUP_COMPATIBILITY_ELEMENTS: ::windows_sys::core::HRESULT = 0x80520389u32 as _;
pub const XPS_E_MISSING_COLORPROFILE: ::windows_sys::core::HRESULT = 0x80520104u32 as _;
pub const XPS_E_MISSING_DISCARDCONTROL: ::windows_sys::core::HRESULT = 0x80520112u32 as _;
pub const XPS_E_MISSING_DOCUMENT: ::windows_sys::core::HRESULT = 0x80520109u32 as _;
pub const XPS_E_MISSING_DOCUMENTSEQUENCE_RELATIONSHIP: ::windows_sys::core::HRESULT = 0x80520108u32 as _;
pub const XPS_E_MISSING_FONTURI: ::windows_sys::core::HRESULT = 0x80520107u32 as _;
pub const XPS_E_MISSING_GLYPHS: ::windows_sys::core::HRESULT = 0x80520102u32 as _;
pub const XPS_E_MISSING_IMAGE_IN_IMAGEBRUSH: ::windows_sys::core::HRESULT = 0x8052010Eu32 as _;
pub const XPS_E_MISSING_LOOKUP: ::windows_sys::core::HRESULT = 0x80520101u32 as _;
pub const XPS_E_MISSING_NAME: ::windows_sys::core::HRESULT = 0x80520100u32 as _;
pub const XPS_E_MISSING_PAGE_IN_DOCUMENT: ::windows_sys::core::HRESULT = 0x8052010Cu32 as _;
pub const XPS_E_MISSING_PAGE_IN_PAGEREFERENCE: ::windows_sys::core::HRESULT = 0x8052010Du32 as _;
pub const XPS_E_MISSING_PART_REFERENCE: ::windows_sys::core::HRESULT = 0x80520110u32 as _;
pub const XPS_E_MISSING_PART_STREAM: ::windows_sys::core::HRESULT = 0x80520113u32 as _;
pub const XPS_E_MISSING_REFERRED_DOCUMENT: ::windows_sys::core::HRESULT = 0x8052010Au32 as _;
pub const XPS_E_MISSING_REFERRED_PAGE: ::windows_sys::core::HRESULT = 0x8052010Bu32 as _;
pub const XPS_E_MISSING_RELATIONSHIP_TARGET: ::windows_sys::core::HRESULT = 0x80520105u32 as _;
pub const XPS_E_MISSING_RESOURCE_KEY: ::windows_sys::core::HRESULT = 0x8052010Fu32 as _;
pub const XPS_E_MISSING_RESOURCE_RELATIONSHIP: ::windows_sys::core::HRESULT = 0x80520106u32 as _;
pub const XPS_E_MISSING_RESTRICTED_FONT_RELATIONSHIP: ::windows_sys::core::HRESULT = 0x80520111u32 as _;
pub const XPS_E_MISSING_SEGMENT_DATA: ::windows_sys::core::HRESULT = 0x80520103u32 as _;
pub const XPS_E_MULTIPLE_DOCUMENTSEQUENCE_RELATIONSHIPS: ::windows_sys::core::HRESULT = 0x80520202u32 as _;
pub const XPS_E_MULTIPLE_PRINTTICKETS_ON_DOCUMENT: ::windows_sys::core::HRESULT = 0x80520206u32 as _;
pub const XPS_E_MULTIPLE_PRINTTICKETS_ON_DOCUMENTSEQUENCE: ::windows_sys::core::HRESULT = 0x80520207u32 as _;
pub const XPS_E_MULTIPLE_PRINTTICKETS_ON_PAGE: ::windows_sys::core::HRESULT = 0x80520205u32 as _;
pub const XPS_E_MULTIPLE_REFERENCES_TO_PART: ::windows_sys::core::HRESULT = 0x80520208u32 as _;
pub const XPS_E_MULTIPLE_RESOURCES: ::windows_sys::core::HRESULT = 0x80520201u32 as _;
pub const XPS_E_MULTIPLE_THUMBNAILS_ON_PACKAGE: ::windows_sys::core::HRESULT = 0x80520204u32 as _;
pub const XPS_E_MULTIPLE_THUMBNAILS_ON_PAGE: ::windows_sys::core::HRESULT = 0x80520203u32 as _;
pub const XPS_E_NEGATIVE_FLOAT: ::windows_sys::core::HRESULT = 0x8052030Au32 as _;
pub const XPS_E_NESTED_REMOTE_DICTIONARY: ::windows_sys::core::HRESULT = 0x80520402u32 as _;
pub const XPS_E_NOT_ENOUGH_GRADIENT_STOPS: ::windows_sys::core::HRESULT = 0x8052050Bu32 as _;
pub const XPS_E_NO_CUSTOM_OBJECTS: ::windows_sys::core::HRESULT = 0x80520502u32 as _;
pub const XPS_E_OBJECT_DETACHED: ::windows_sys::core::HRESULT = 0x8052038Au32 as _;
pub const XPS_E_ODD_BIDILEVEL: ::windows_sys::core::HRESULT = 0x80520307u32 as _;
pub const XPS_E_ONE_TO_ONE_MAPPING_EXPECTED: ::windows_sys::core::HRESULT = 0x80520308u32 as _;
pub const XPS_E_PACKAGE_ALREADY_OPENED: ::windows_sys::core::HRESULT = 0x80520387u32 as _;
pub const XPS_E_PACKAGE_NOT_OPENED: ::windows_sys::core::HRESULT = 0x80520386u32 as _;
pub const XPS_E_PACKAGE_WRITER_NOT_CLOSED: ::windows_sys::core::HRESULT = 0x8052050Cu32 as _;
pub const XPS_E_RELATIONSHIP_EXTERNAL: ::windows_sys::core::HRESULT = 0x8052050Au32 as _;
pub const XPS_E_RESOURCE_NOT_OWNED: ::windows_sys::core::HRESULT = 0x80520504u32 as _;
pub const XPS_E_RESTRICTED_FONT_NOT_OBFUSCATED: ::windows_sys::core::HRESULT = 0x80520309u32 as _;
pub const XPS_E_SIGNATUREID_DUP: ::windows_sys::core::HRESULT = 0x80520388u32 as _;
pub const XPS_E_SIGREQUESTID_DUP: ::windows_sys::core::HRESULT = 0x80520385u32 as _;
pub const XPS_E_STRING_TOO_LONG: ::windows_sys::core::HRESULT = 0x80520300u32 as _;
pub const XPS_E_TOO_MANY_INDICES: ::windows_sys::core::HRESULT = 0x80520301u32 as _;
pub const XPS_E_UNAVAILABLE_PACKAGE: ::windows_sys::core::HRESULT = 0x80520114u32 as _;
pub const XPS_E_UNEXPECTED_COLORPROFILE: ::windows_sys::core::HRESULT = 0x80520505u32 as _;
pub const XPS_E_UNEXPECTED_CONTENT_TYPE: ::windows_sys::core::HRESULT = 0x80520008u32 as _;
pub const XPS_E_UNEXPECTED_RELATIONSHIP_TYPE: ::windows_sys::core::HRESULT = 0x80520010u32 as _;
pub const XPS_E_UNEXPECTED_RESTRICTED_FONT_RELATIONSHIP: ::windows_sys::core::HRESULT = 0x80520011u32 as _;
pub const XPS_E_VISUAL_CIRCULAR_REF: ::windows_sys::core::HRESULT = 0x80520501u32 as _;
pub const XPS_E_XKEY_ATTR_PRESENT_OUTSIDE_RES_DICT: ::windows_sys::core::HRESULT = 0x80520400u32 as _;
