...
pub const DC_BINNAMES: PRINTER_DEVICE_CAPABILITIES = 12;
pub const DC_BINS: PRINTER_DEVICE_CAPABILITIES = 6;
pub const DC_COLLATE: PRINTER_DEVICE_CAPABILITIES = 22;
pub const DC_COLORDEVICE: PRINTER_DEVICE_CAPABILITIES = 32;
pub const DC_COPIES: PRINTER_DEVICE_CAPABILITIES = 18;
pub const DC_DRIVER: PRINTER_DEVICE_CAPABILITIES = 11;
pub const DC_DUPLEX: PRINTER_DEVICE_CAPABILITIES = 7;
pub const DC_ENUMRESOLUTIONS: PRINTER_DEVICE_CAPABILITIES = 13;
pub const DC_EXTRA: PRINTER_DEVICE_CAPABILITIES = 9;
pub const DC_FIELDS: PRINTER_DEVICE_CAPABILITIES = 1;
pub const DC_FILEDEPENDENCIES: PRINTER_DEVICE_CAPABILITIES = 14;
pub const DC_MAXEXTENT: PRINTER_DEVICE_CAPABILITIES = 5;
pub const DC_MEDIAREADY: PRINTER_DEVICE_CAPABILITIES = 29;
pub const DC_MEDIATYPENAMES: PRINTER_DEVICE_CAPABILITIES = 34;
pub const DC_MEDIATYPES: PRINTER_DEVICE_CAPABILITIES = 35;
pub const DC_MINEXTENT: PRINTER_DEVICE_CAPABILITIES = 4;
pub const DC_NUP: PRINTER_DEVICE_CAPABILITIES = 33;
pub const DC_ORIENTATION: PRINTER_DEVICE_CAPABILITIES = 17;
pub const DC_PAPERNAMES: PRINTER_DEVICE_CAPABILITIES = 16;
pub const DC_PAPERS: PRINTER_DEVICE_CAPABILITIES = 2;
pub const DC_PAPERSIZE: PRINTER_DEVICE_CAPABILITIES = 3;
pub const DC_PERSONALITY: PRINTER_DEVICE_CAPABILITIES = 25;
pub const DC_PRINTERMEM: PRINTER_DEVICE_CAPABILITIES = 28;
pub const DC_PRINTRATE: PRINTER_DEVICE_CAPABILITIES = 26;
pub const DC_PRINTRATEPPM: PRINTER_DEVICE_CAPABILITIES = 31;
pub const DC_PRINTRATEUNIT: PRINTER_DEVICE_CAPABILITIES = 27;
pub const DC_SIZE: PRINTER_DEVICE_CAPABILITIES = 8;
pub const DC_STAPLE: PRINTER_DEVICE_CAPABILITIES = 30;
pub const DC_TRUETYPE: PRINTER_DEVICE_CAPABILITIES = 15;
pub const DC_VERSION: PRINTER_DEVICE_CAPABILITIES = 10;
#[repr(C)]
...
pub const PSINJECT_BEGINDEFAULTS: PSINJECT_POINT = 12;
pub const PSINJECT_BEGINPAGESETUP: PSINJECT_POINT = 101;
pub const PSINJECT_BEGINPROLOG: PSINJECT_POINT = 14;
pub const PSINJECT_BEGINSETUP: PSINJECT_POINT = 16;
pub const PSINJECT_BEGINSTREAM: PSINJECT_POINT = 1;
pub const PSINJECT_BOUNDINGBOX: PSINJECT_POINT = 9;
pub const PSINJECT_COMMENTS: PSINJECT_POINT = 11;
pub const PSINJECT_DOCNEEDEDRES: PSINJECT_POINT = 5;
pub const PSINJECT_DOCSUPPLIEDRES: PSINJECT_POINT = 6;
pub const PSINJECT_DOCUMENTPROCESSCOLORS: PSINJECT_POINT = 10;
pub const PSINJECT_DOCUMENTPROCESSCOLORSATEND: PSINJECT_POINT = 21;
pub const PSINJECT_ENDDEFAULTS: PSINJECT_POINT = 13;
pub const PSINJECT_ENDPAGECOMMENTS: PSINJECT_POINT = 107;
pub const PSINJECT_ENDPAGESETUP: PSINJECT_POINT = 102;
pub const PSINJECT_ENDPROLOG: PSINJECT_POINT = 15;
pub const PSINJECT_ENDSETUP: PSINJECT_POINT = 17;
pub const PSINJECT_ENDSTREAM: PSINJECT_POINT = 20;
pub const PSINJECT_EOF: PSINJECT_POINT = 19;
pub const PSINJECT_ORIENTATION: PSINJECT_POINT = 8;
pub const PSINJECT_PAGEBBOX: PSINJECT_POINT = 106;
pub const PSINJECT_PAGENUMBER: PSINJECT_POINT = 100;
pub const PSINJECT_PAGEORDER: PSINJECT_POINT = 7;
pub const PSINJECT_PAGES: PSINJECT_POINT = 4;
pub const PSINJECT_PAGESATEND: PSINJECT_POINT = 3;
pub const PSINJECT_PAGETRAILER: PSINJECT_POINT = 103;
pub const PSINJECT_PLATECOLOR: PSINJECT_POINT = 104;
pub type PSINJECT_POINT = u16;
pub const PSINJECT_PSADOBE: PSINJECT_POINT = 2;
pub const PSINJECT_SHOWPAGE: PSINJECT_POINT = 105;
pub const PSINJECT_TRAILER: PSINJECT_POINT = 18;
pub const PSINJECT_VMRESTORE: PSINJECT_POINT = 201;
pub const PSINJECT_VMSAVE: PSINJECT_POINT = 200;
pub const PW_CLIENTONLY: PRINT_WINDOW_FLAGS = 1;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const XPS_DOCUMENT_TYPE_OPENXPS: XPS_DOCUMENT_TYPE = 3;
pub const XPS_DOCUMENT_TYPE_UNSPECIFIED: XPS_DOCUMENT_TYPE = 1;
pub const XPS_DOCUMENT_TYPE_XPS: XPS_DOCUMENT_TYPE = 2;
...
pub const XPS_SIGNATURE_STATUS_BROKEN: XPS_SIGNATURE_STATUS = 3;
pub const XPS_SIGNATURE_STATUS_INCOMPLETE: XPS_SIGNATURE_STATUS = 2;
pub const XPS_SIGNATURE_STATUS_INCOMPLIANT: XPS_SIGNATURE_STATUS = 1;
pub const XPS_SIGNATURE_STATUS_QUESTIONABLE: XPS_SIGNATURE_STATUS = 4;
pub const XPS_SIGNATURE_STATUS_VALID: XPS_SIGNATURE_STATUS = 5;
pub type XPS_SIGN_FLAGS = i32;
pub const XPS_SIGN_FLAGS_IGNORE_MARKUP_COMPATIBILITY: XPS_SIGN_FLAGS = 1;
pub const XPS_SIGN_FLAGS_NONE: XPS_SIGN_FLAGS = 0;
pub type XPS_SIGN_POLICY = i32;
pub const XPS_SIGN_POLICY_ALL: XPS_SIGN_POLICY = 15;
pub const XPS_SIGN_POLICY_CORE_PROPERTIES: XPS_SIGN_POLICY = 1;
pub const XPS_SIGN_POLICY_DISCARD_CONTROL: XPS_SIGN_POLICY = 8;
pub const XPS_SIGN_POLICY_NONE: XPS_SIGN_POLICY = 0;
pub const XPS_SIGN_POLICY_PRINT_TICKET: XPS_SIGN_POLICY = 4;
pub const XPS_SIGN_POLICY_SIGNATURE_RELATIONSHIPS: XPS_SIGN_POLICY = 2;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
pub struct XPS_SIZE {
    pub width: f32,
