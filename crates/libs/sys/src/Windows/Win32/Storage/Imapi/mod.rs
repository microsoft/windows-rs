...
::windows_targets::link!("mapi32.dll" "system" #[doc = "*Required features: `\"Win32_Storage_Imapi\"`*"] fn CloseIMsgSession(lpmsgsess : LPMSGSESS) -> ());
...
::windows_targets::link!("mapi32.dll" "system" #[doc = "*Required features: `\"Win32_Storage_Imapi\"`, `\"Win32_System_AddressBook\"`, `\"Win32_System_Com_StructuredStorage\"`*"] fn OpenIMsgOnIStg(lpmsgsess : LPMSGSESS, lpallocatebuffer : super::super::System::AddressBook:: LPALLOCATEBUFFER, lpallocatemore : super::super::System::AddressBook:: LPALLOCATEMORE, lpfreebuffer : super::super::System::AddressBook:: LPFREEBUFFER, lpmalloc : super::super::System::Com:: IMalloc, lpmapisup : *mut ::core::ffi::c_void, lpstg : super::super::System::Com::StructuredStorage:: IStorage, lpfmsgcallrelease : *mut MSGCALLRELEASE, ulcallerdata : u32, ulflags : u32, lppmsg : *mut super::super::System::AddressBook:: IMessage) -> i32);
#[cfg(feature = "Win32_System_Com")]
::windows_targets::link!("mapi32.dll" "system" #[doc = "*Required features: `\"Win32_Storage_Imapi\"`, `\"Win32_System_Com\"`*"] fn OpenIMsgSession(lpmalloc : super::super::System::Com:: IMalloc, ulflags : u32, lppmsgsess : *mut LPMSGSESS) -> i32);
#[cfg(feature = "Win32_System_AddressBook")]
