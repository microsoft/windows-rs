...
pub const IMAPI_E_ALREADYOPEN: ::windows_sys::core::HRESULT = 0x80040222u32 as _;
pub const IMAPI_E_BADJOLIETNAME: ::windows_sys::core::HRESULT = 0x8004021Du32 as _;
pub const IMAPI_E_BOOTIMAGE_AND_NONBLANK_DISC: ::windows_sys::core::HRESULT = 0x8004022Eu32 as _;
pub const IMAPI_E_CANNOT_WRITE_TO_MEDIA: ::windows_sys::core::HRESULT = 0x8004022Cu32 as _;
pub const IMAPI_E_COMPRESSEDSTASH: ::windows_sys::core::HRESULT = 0x80040228u32 as _;
pub const IMAPI_E_DEVICE_INVALIDTYPE: ::windows_sys::core::HRESULT = 0x80040214u32 as _;
pub const IMAPI_E_DEVICE_NOPROPERTIES: ::windows_sys::core::HRESULT = 0x80040211u32 as _;
pub const IMAPI_E_DEVICE_NOTACCESSIBLE: ::windows_sys::core::HRESULT = 0x80040212u32 as _;
pub const IMAPI_E_DEVICE_NOTPRESENT: ::windows_sys::core::HRESULT = 0x80040213u32 as _;
pub const IMAPI_E_DEVICE_STILL_IN_USE: ::windows_sys::core::HRESULT = 0x80040226u32 as _;
pub const IMAPI_E_DISCFULL: ::windows_sys::core::HRESULT = 0x8004021Cu32 as _;
pub const IMAPI_E_DISCINFO: ::windows_sys::core::HRESULT = 0x80040219u32 as _;
pub const IMAPI_E_ENCRYPTEDSTASH: ::windows_sys::core::HRESULT = 0x80040229u32 as _;
pub const IMAPI_E_FILEACCESS: ::windows_sys::core::HRESULT = 0x80040218u32 as _;
pub const IMAPI_E_FILEEXISTS: ::windows_sys::core::HRESULT = 0x80040224u32 as _;
pub const IMAPI_E_FILESYSTEM: ::windows_sys::core::HRESULT = 0x80040217u32 as _;
pub const IMAPI_E_GENERIC: ::windows_sys::core::HRESULT = 0x8004020Eu32 as _;
pub const IMAPI_E_INITIALIZE_ENDWRITE: ::windows_sys::core::HRESULT = 0x80040216u32 as _;
pub const IMAPI_E_INITIALIZE_WRITE: ::windows_sys::core::HRESULT = 0x80040215u32 as _;
pub const IMAPI_E_INVALIDIMAGE: ::windows_sys::core::HRESULT = 0x8004021Eu32 as _;
pub const IMAPI_E_LOSS_OF_STREAMING: ::windows_sys::core::HRESULT = 0x80040227u32 as _;
pub const IMAPI_E_MEDIUM_INVALIDTYPE: ::windows_sys::core::HRESULT = 0x80040210u32 as _;
pub const IMAPI_E_MEDIUM_NOTPRESENT: ::windows_sys::core::HRESULT = 0x8004020Fu32 as _;
pub const IMAPI_E_NOACTIVEFORMAT: ::windows_sys::core::HRESULT = 0x8004021Fu32 as _;
pub const IMAPI_E_NOACTIVERECORDER: ::windows_sys::core::HRESULT = 0x80040220u32 as _;
pub const IMAPI_E_NOTENOUGHDISKFORSTASH: ::windows_sys::core::HRESULT = 0x8004022Au32 as _;
pub const IMAPI_E_NOTINITIALIZED: ::windows_sys::core::HRESULT = 0x8004020Cu32 as _;
pub const IMAPI_E_NOTOPENED: ::windows_sys::core::HRESULT = 0x8004020Bu32 as _;
pub const IMAPI_E_REMOVABLESTASH: ::windows_sys::core::HRESULT = 0x8004022Bu32 as _;
pub const IMAPI_E_STASHINUSE: ::windows_sys::core::HRESULT = 0x80040225u32 as _;
pub const IMAPI_E_TRACKNOTOPEN: ::windows_sys::core::HRESULT = 0x8004021Au32 as _;
pub const IMAPI_E_TRACKOPEN: ::windows_sys::core::HRESULT = 0x8004021Bu32 as _;
pub const IMAPI_E_TRACK_NOT_BIG_ENOUGH: ::windows_sys::core::HRESULT = 0x8004022Du32 as _;
pub const IMAPI_E_USERABORT: ::windows_sys::core::HRESULT = 0x8004020Du32 as _;
pub const IMAPI_E_WRONGDISC: ::windows_sys::core::HRESULT = 0x80040223u32 as _;
pub const IMAPI_E_WRONGFORMAT: ::windows_sys::core::HRESULT = 0x80040221u32 as _;
...
pub const IMAPI_S_BUFFER_TO_SMALL: ::windows_sys::core::HRESULT = 0x40201u32 as _;
pub const IMAPI_S_PROPERTIESIGNORED: ::windows_sys::core::HRESULT = 0x40200u32 as _;
