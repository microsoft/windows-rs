pub type ActivatePackageVirtualizationContext = unsafe extern "system" fn(context: PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE, cookie: *mut usize) -> windows_sys::core::HRESULT;
...
pub type AddPackageDependency = unsafe extern "system" fn(packagedependencyid: windows_sys::core::PCWSTR, rank: i32, options: AddPackageDependencyOptions, packagedependencycontext: *mut PACKAGEDEPENDENCY_CONTEXT, packagefullname: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type AddPackageDependency2 = unsafe extern "system" fn(packagedependencyid: windows_sys::core::PCWSTR, rank: i32, options: AddPackageDependencyOptions2, packagedependencycontext: *mut PACKAGEDEPENDENCY_CONTEXT, packagefullname: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type AppPolicyGetClrCompat = unsafe extern "system" fn(processtoken: super::super::super::Foundation::HANDLE, policy: *mut AppPolicyClrCompat) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type AppPolicyGetCreateFileAccess = unsafe extern "system" fn(processtoken: super::super::super::Foundation::HANDLE, policy: *mut AppPolicyCreateFileAccess) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type AppPolicyGetLifecycleManagement = unsafe extern "system" fn(processtoken: super::super::super::Foundation::HANDLE, policy: *mut AppPolicyLifecycleManagement) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type AppPolicyGetMediaFoundationCodecLoading = unsafe extern "system" fn(processtoken: super::super::super::Foundation::HANDLE, policy: *mut AppPolicyMediaFoundationCodecLoading) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn AppPolicyGetMediaFoundationCodecLoading(processtoken : super::super::super::Foundation::HANDLE, policy : *mut AppPolicyMediaFoundationCodecLoading) -> super::super::super::Foundation::WIN32_ERROR);
pub type AppPolicyGetProcessTerminationMethod = unsafe extern "system" fn(processtoken: super::super::super::Foundation::HANDLE, policy: *mut AppPolicyProcessTerminationMethod) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn AppPolicyGetProcessTerminationMethod(processtoken : super::super::super::Foundation::HANDLE, policy : *mut AppPolicyProcessTerminationMethod) -> super::super::super::Foundation::WIN32_ERROR);
pub type AppPolicyGetShowDeveloperDiagnostic = unsafe extern "system" fn(processtoken: super::super::super::Foundation::HANDLE, policy: *mut AppPolicyShowDeveloperDiagnostic) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn AppPolicyGetShowDeveloperDiagnostic(processtoken : super::super::super::Foundation::HANDLE, policy : *mut AppPolicyShowDeveloperDiagnostic) -> super::super::super::Foundation::WIN32_ERROR);
pub type AppPolicyGetThreadInitializationType = unsafe extern "system" fn(processtoken: super::super::super::Foundation::HANDLE, policy: *mut AppPolicyThreadInitializationType) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn AppPolicyGetThreadInitializationType(processtoken : super::super::super::Foundation::HANDLE, policy : *mut AppPolicyThreadInitializationType) -> super::super::super::Foundation::WIN32_ERROR);
pub type AppPolicyGetWindowingModel = unsafe extern "system" fn(processtoken: super::super::super::Foundation::HANDLE, policy: *mut AppPolicyWindowingModel) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn AppPolicyGetWindowingModel(processtoken : super::super::super::Foundation::HANDLE, policy : *mut AppPolicyWindowingModel) -> super::super::super::Foundation::WIN32_ERROR);
pub type CheckIsMSIXPackage = unsafe extern "system" fn(packagefullname: windows_sys::core::PCWSTR, ismsixpackage: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
windows_link::link!("kernel32.dll" "system" fn CheckIsMSIXPackage(packagefullname : windows_sys::core::PCWSTR, ismsixpackage : *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT);
pub type ClosePackageInfo = unsafe extern "system" fn(packageinforeference: *const _PACKAGE_INFO_REFERENCE) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn ClosePackageInfo(packageinforeference : *const _PACKAGE_INFO_REFERENCE) -> super::super::super::Foundation::WIN32_ERROR);
pub type CreatePackageVirtualizationContext = unsafe extern "system" fn(packagefamilyname: windows_sys::core::PCWSTR, context: *mut PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("kernel32.dll" "system" fn CreatePackageVirtualizationContext(packagefamilyname : windows_sys::core::PCWSTR, context : *mut PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE) -> windows_sys::core::HRESULT);
...
pub type DeletePackageDependency = unsafe extern "system" fn(packagedependencyid: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type DuplicatePackageVirtualizationContext = unsafe extern "system" fn(sourcecontext: PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE, destcontext: *mut PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE) -> windows_sys::core::HRESULT;
...
pub type FindPackageDependency = unsafe extern "system" fn(findpackagedependencycriteria: *const FindPackageDependencyCriteria, packagedependencyidscount: *mut u32, packagedependencyids: *mut *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Security")]
...
pub type FindPackagesByPackageFamily = unsafe extern "system" fn(packagefamilyname: windows_sys::core::PCWSTR, packagefilters: u32, count: *mut u32, packagefullnames: *mut windows_sys::core::PWSTR, bufferlength: *mut u32, buffer: windows_sys::core::PWSTR, packageproperties: *mut u32) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type FormatApplicationUserModelId = unsafe extern "system" fn(packagefamilyname: windows_sys::core::PCWSTR, packagerelativeapplicationid: windows_sys::core::PCWSTR, applicationusermodelidlength: *mut u32, applicationusermodelid: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type GetApplicationUserModelId = unsafe extern "system" fn(hprocess: super::super::super::Foundation::HANDLE, applicationusermodelidlength: *mut u32, applicationusermodelid: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type GetApplicationUserModelIdFromToken = unsafe extern "system" fn(token: super::super::super::Foundation::HANDLE, applicationusermodelidlength: *mut u32, applicationusermodelid: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("api-ms-win-appmodel-runtime-l1-1-1.dll" "system" fn GetApplicationUserModelIdFromToken(token : super::super::super::Foundation::HANDLE, applicationusermodelidlength : *mut u32, applicationusermodelid : windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR);
pub type GetCurrentApplicationUserModelId = unsafe extern "system" fn(applicationusermodelidlength: *mut u32, applicationusermodelid: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn GetCurrentApplicationUserModelId(applicationusermodelidlength : *mut u32, applicationusermodelid : windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR);
pub type GetCurrentPackageFamilyName = unsafe extern "system" fn(packagefamilynamelength: *mut u32, packagefamilyname: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn GetCurrentPackageFamilyName(packagefamilynamelength : *mut u32, packagefamilyname : windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR);
pub type GetCurrentPackageFullName = unsafe extern "system" fn(packagefullnamelength: *mut u32, packagefullname: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn GetCurrentPackageFullName(packagefullnamelength : *mut u32, packagefullname : windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR);
pub type GetCurrentPackageId = unsafe extern "system" fn(bufferlength: *mut u32, buffer: *mut u8) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn GetCurrentPackageId(bufferlength : *mut u32, buffer : *mut u8) -> super::super::super::Foundation::WIN32_ERROR);
pub type GetCurrentPackageInfo = unsafe extern "system" fn(flags: u32, bufferlength: *mut u32, buffer: *mut u8, count: *mut u32) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn GetCurrentPackageInfo(flags : u32, bufferlength : *mut u32, buffer : *mut u8, count : *mut u32) -> super::super::super::Foundation::WIN32_ERROR);
pub type GetCurrentPackageInfo2 = unsafe extern "system" fn(flags: u32, packagepathtype: PackagePathType, bufferlength: *mut u32, buffer: *mut u8, count: *mut u32) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("api-ms-win-appmodel-runtime-l1-1-3.dll" "system" fn GetCurrentPackageInfo2(flags : u32, packagepathtype : PackagePathType, bufferlength : *mut u32, buffer : *mut u8, count : *mut u32) -> super::super::super::Foundation::WIN32_ERROR);
pub type GetCurrentPackageInfo3 = unsafe extern "system" fn(flags: u32, packageinfotype: PackageInfo3Type, bufferlength: *mut u32, buffer: *mut core::ffi::c_void, count: *mut u32) -> windows_sys::core::HRESULT;
windows_link::link!("kernel32.dll" "system" fn GetCurrentPackageInfo3(flags : u32, packageinfotype : PackageInfo3Type, bufferlength : *mut u32, buffer : *mut core::ffi::c_void, count : *mut u32) -> windows_sys::core::HRESULT);
pub type GetCurrentPackagePath = unsafe extern "system" fn(pathlength: *mut u32, path: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn GetCurrentPackagePath(pathlength : *mut u32, path : windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR);
pub type GetCurrentPackagePath2 = unsafe extern "system" fn(packagepathtype: PackagePathType, pathlength: *mut u32, path: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("api-ms-win-appmodel-runtime-l1-1-3.dll" "system" fn GetCurrentPackagePath2(packagepathtype : PackagePathType, pathlength : *mut u32, path : windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR);
pub type GetCurrentPackageVirtualizationContext = unsafe extern "system" fn() -> PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE;
windows_link::link!("kernel32.dll" "system" fn GetCurrentPackageVirtualizationContext() -> PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE);
pub type GetIdForPackageDependencyContext = unsafe extern "system" fn(packagedependencycontext: PACKAGEDEPENDENCY_CONTEXT, packagedependencyid: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type GetPackageApplicationIds = unsafe extern "system" fn(packageinforeference: *const _PACKAGE_INFO_REFERENCE, bufferlength: *mut u32, buffer: *mut u8, count: *mut u32) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type GetPackageFamilyName = unsafe extern "system" fn(hprocess: super::super::super::Foundation::HANDLE, packagefamilynamelength: *mut u32, packagefamilyname: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type GetPackageFamilyNameFromToken = unsafe extern "system" fn(token: super::super::super::Foundation::HANDLE, packagefamilynamelength: *mut u32, packagefamilyname: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type GetPackageFullName = unsafe extern "system" fn(hprocess: super::super::super::Foundation::HANDLE, packagefullnamelength: *mut u32, packagefullname: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type GetPackageFullNameFromToken = unsafe extern "system" fn(token: super::super::super::Foundation::HANDLE, packagefullnamelength: *mut u32, packagefullname: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("api-ms-win-appmodel-runtime-l1-1-1.dll" "system" fn GetPackageFullNameFromToken(token : super::super::super::Foundation::HANDLE, packagefullnamelength : *mut u32, packagefullname : windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR);
pub type GetPackageGraphRevisionId = unsafe extern "system" fn() -> u32;
windows_link::link!("api-ms-win-appmodel-runtime-l1-1-6.dll" "system" fn GetPackageGraphRevisionId() -> u32);
pub type GetPackageId = unsafe extern "system" fn(hprocess: super::super::super::Foundation::HANDLE, bufferlength: *mut u32, buffer: *mut u8) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn GetPackageId(hprocess : super::super::super::Foundation::HANDLE, bufferlength : *mut u32, buffer : *mut u8) -> super::super::super::Foundation::WIN32_ERROR);
pub type GetPackageInfo = unsafe extern "system" fn(packageinforeference: *const _PACKAGE_INFO_REFERENCE, flags: u32, bufferlength: *mut u32, buffer: *mut u8, count: *mut u32) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn GetPackageInfo(packageinforeference : *const _PACKAGE_INFO_REFERENCE, flags : u32, bufferlength : *mut u32, buffer : *mut u8, count : *mut u32) -> super::super::super::Foundation::WIN32_ERROR);
pub type GetPackageInfo2 = unsafe extern "system" fn(packageinforeference: *const _PACKAGE_INFO_REFERENCE, flags: u32, packagepathtype: PackagePathType, bufferlength: *mut u32, buffer: *mut u8, count: *mut u32) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("api-ms-win-appmodel-runtime-l1-1-3.dll" "system" fn GetPackageInfo2(packageinforeference : *const _PACKAGE_INFO_REFERENCE, flags : u32, packagepathtype : PackagePathType, bufferlength : *mut u32, buffer : *mut u8, count : *mut u32) -> super::super::super::Foundation::WIN32_ERROR);
pub type GetPackagePath = unsafe extern "system" fn(packageid: *const PACKAGE_ID, reserved: u32, pathlength: *mut u32, path: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn GetPackagePath(packageid : *const PACKAGE_ID, reserved : u32, pathlength : *mut u32, path : windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR);
pub type GetPackagePathByFullName = unsafe extern "system" fn(packagefullname: windows_sys::core::PCWSTR, pathlength: *mut u32, path: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn GetPackagePathByFullName(packagefullname : windows_sys::core::PCWSTR, pathlength : *mut u32, path : windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR);
pub type GetPackagePathByFullName2 = unsafe extern "system" fn(packagefullname: windows_sys::core::PCWSTR, packagepathtype: PackagePathType, pathlength: *mut u32, path: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type GetPackagesByPackageFamily = unsafe extern "system" fn(packagefamilyname: windows_sys::core::PCWSTR, count: *mut u32, packagefullnames: *mut windows_sys::core::PWSTR, bufferlength: *mut u32, buffer: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type GetProcessesInVirtualizationContext = unsafe extern "system" fn(packagefamilyname: windows_sys::core::PCWSTR, count: *mut u32, processes: *mut *mut super::super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
#[cfg(feature = "Win32_Security")]
pub type GetProcessesUsingPackageDependency = unsafe extern "system" fn(packagedependencyid: windows_sys::core::PCWSTR, user: super::super::super::Security::PSID, scopeissystem: windows_sys::core::BOOL, processidscount: *mut u32, processids: *mut *mut u32) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Security")]
...
pub type GetResolvedPackageFullNameForPackageDependency = unsafe extern "system" fn(packagedependencyid: windows_sys::core::PCWSTR, packagefullname: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type GetResolvedPackageFullNameForPackageDependency2 = unsafe extern "system" fn(packagedependencyid: windows_sys::core::PCWSTR, packagefullname: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type GetStagedPackageOrigin = unsafe extern "system" fn(packagefullname: windows_sys::core::PCWSTR, origin: *mut PackageOrigin) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type GetStagedPackagePathByFullName = unsafe extern "system" fn(packagefullname: windows_sys::core::PCWSTR, pathlength: *mut u32, path: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type GetStagedPackagePathByFullName2 = unsafe extern "system" fn(packagefullname: windows_sys::core::PCWSTR, packagepathtype: PackagePathType, pathlength: *mut u32, path: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type OpenPackageInfoByFullName = unsafe extern "system" fn(packagefullname: windows_sys::core::PCWSTR, reserved: u32, packageinforeference: *mut *mut _PACKAGE_INFO_REFERENCE) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn OpenPackageInfoByFullName(packagefullname : windows_sys::core::PCWSTR, reserved : u32, packageinforeference : *mut *mut _PACKAGE_INFO_REFERENCE) -> super::super::super::Foundation::WIN32_ERROR);
#[cfg(feature = "Win32_Security")]
pub type OpenPackageInfoByFullNameForUser = unsafe extern "system" fn(usersid: super::super::super::Security::PSID, packagefullname: windows_sys::core::PCWSTR, reserved: u32, packageinforeference: *mut *mut _PACKAGE_INFO_REFERENCE) -> super::super::super::Foundation::WIN32_ERROR;
#[cfg(feature = "Win32_Security")]
windows_link::link!("api-ms-win-appmodel-runtime-l1-1-1.dll" "system" fn OpenPackageInfoByFullNameForUser(usersid : super::super::super::Security::PSID, packagefullname : windows_sys::core::PCWSTR, reserved : u32, packageinforeference : *mut *mut _PACKAGE_INFO_REFERENCE) -> super::super::super::Foundation::WIN32_ERROR);
pub type PackageFamilyNameFromFullName = unsafe extern "system" fn(packagefullname: windows_sys::core::PCWSTR, packagefamilynamelength: *mut u32, packagefamilyname: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn PackageFamilyNameFromFullName(packagefullname : windows_sys::core::PCWSTR, packagefamilynamelength : *mut u32, packagefamilyname : windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR);
pub type PackageFamilyNameFromId = unsafe extern "system" fn(packageid: *const PACKAGE_ID, packagefamilynamelength: *mut u32, packagefamilyname: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn PackageFamilyNameFromId(packageid : *const PACKAGE_ID, packagefamilynamelength : *mut u32, packagefamilyname : windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR);
pub type PackageFullNameFromId = unsafe extern "system" fn(packageid: *const PACKAGE_ID, packagefullnamelength: *mut u32, packagefullname: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn PackageFullNameFromId(packageid : *const PACKAGE_ID, packagefullnamelength : *mut u32, packagefullname : windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR);
pub type PackageIdFromFullName = unsafe extern "system" fn(packagefullname: windows_sys::core::PCWSTR, flags: u32, bufferlength: *mut u32, buffer: *mut u8) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn PackageIdFromFullName(packagefullname : windows_sys::core::PCWSTR, flags : u32, bufferlength : *mut u32, buffer : *mut u8) -> super::super::super::Foundation::WIN32_ERROR);
pub type PackageNameAndPublisherIdFromFamilyName = unsafe extern "system" fn(packagefamilyname: windows_sys::core::PCWSTR, packagenamelength: *mut u32, packagename: windows_sys::core::PWSTR, packagepublisheridlength: *mut u32, packagepublisherid: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn PackageNameAndPublisherIdFromFamilyName(packagefamilyname : windows_sys::core::PCWSTR, packagenamelength : *mut u32, packagename : windows_sys::core::PWSTR, packagepublisheridlength : *mut u32, packagepublisherid : windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR);
pub type ParseApplicationUserModelId = unsafe extern "system" fn(applicationusermodelid: windows_sys::core::PCWSTR, packagefamilynamelength: *mut u32, packagefamilyname: windows_sys::core::PWSTR, packagerelativeapplicationidlength: *mut u32, packagerelativeapplicationid: windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("kernel32.dll" "system" fn ParseApplicationUserModelId(applicationusermodelid : windows_sys::core::PCWSTR, packagefamilynamelength : *mut u32, packagefamilyname : windows_sys::core::PWSTR, packagerelativeapplicationidlength : *mut u32, packagerelativeapplicationid : windows_sys::core::PWSTR) -> super::super::super::Foundation::WIN32_ERROR);
pub type ReleasePackageVirtualizationContext = unsafe extern "system" fn(context: PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE);
windows_link::link!("kernel32.dll" "system" fn ReleasePackageVirtualizationContext(context : PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE));
pub type RemovePackageDependency = unsafe extern "system" fn(packagedependencycontext: PACKAGEDEPENDENCY_CONTEXT) -> windows_sys::core::HRESULT;
...
pub type VerifyApplicationUserModelId = unsafe extern "system" fn(applicationusermodelid: windows_sys::core::PCWSTR) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type VerifyPackageFamilyName = unsafe extern "system" fn(packagefamilyname: windows_sys::core::PCWSTR) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type VerifyPackageFullName = unsafe extern "system" fn(packagefullname: windows_sys::core::PCWSTR) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type VerifyPackageId = unsafe extern "system" fn(packageid: *const PACKAGE_ID) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("api-ms-win-appmodel-runtime-l1-1-1.dll" "system" fn VerifyPackageId(packageid : *const PACKAGE_ID) -> super::super::super::Foundation::WIN32_ERROR);
pub type VerifyPackageRelativeApplicationId = unsafe extern "system" fn(packagerelativeapplicationid: windows_sys::core::PCWSTR) -> super::super::super::Foundation::WIN32_ERROR;
windows_link::link!("api-ms-win-appmodel-runtime-l1-1-1.dll" "system" fn VerifyPackageRelativeApplicationId(packagerelativeapplicationid : windows_sys::core::PCWSTR) -> super::super::super::Foundation::WIN32_ERROR);
