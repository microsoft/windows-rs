pub type FCIAddFile = unsafe extern "C" fn(hfci: *const core::ffi::c_void, pszsourcefile: windows_sys::core::PCSTR, pszfilename: windows_sys::core::PCSTR, fexecute: windows_sys::core::BOOL, pfnfcignc: PFNFCIGETNEXTCABINET, pfnfcis: PFNFCISTATUS, pfnfcigoi: PFNFCIGETOPENINFO, typecompress: u16) -> windows_sys::core::BOOL;
...
pub type FCICreate = unsafe extern "C" fn(perf: *const ERF, pfnfcifp: PFNFCIFILEPLACED, pfna: PFNFCIALLOC, pfnf: PFNFCIFREE, pfnopen: PFNFCIOPEN, pfnread: PFNFCIREAD, pfnwrite: PFNFCIWRITE, pfnclose: PFNFCICLOSE, pfnseek: PFNFCISEEK, pfndelete: PFNFCIDELETE, pfnfcigtf: PFNFCIGETTEMPFILE, pccab: *const CCAB, pv: *const core::ffi::c_void) -> *mut core::ffi::c_void;
...
pub type FCIDestroy = unsafe extern "C" fn(hfci: *const core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("cabinet.dll" "C" fn FCIDestroy(hfci : *const core::ffi::c_void) -> windows_sys::core::BOOL);
pub type FCIFlushCabinet = unsafe extern "C" fn(hfci: *const core::ffi::c_void, fgetnextcab: windows_sys::core::BOOL, pfnfcignc: PFNFCIGETNEXTCABINET, pfnfcis: PFNFCISTATUS) -> windows_sys::core::BOOL;
...
pub type FCIFlushFolder = unsafe extern "C" fn(hfci: *const core::ffi::c_void, pfnfcignc: PFNFCIGETNEXTCABINET, pfnfcis: PFNFCISTATUS) -> windows_sys::core::BOOL;
...
pub type FDICopy = unsafe extern "C" fn(hfdi: *const core::ffi::c_void, pszcabinet: windows_sys::core::PCSTR, pszcabpath: windows_sys::core::PCSTR, flags: i32, pfnfdin: PFNFDINOTIFY, pfnfdid: PFNFDIDECRYPT, pvuser: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type FDICreate = unsafe extern "C" fn(pfnalloc: PFNALLOC, pfnfree: PFNFREE, pfnopen: PFNOPEN, pfnread: PFNREAD, pfnwrite: PFNWRITE, pfnclose: PFNCLOSE, pfnseek: PFNSEEK, cputype: FDICREATE_CPU_TYPE, perf: *mut ERF) -> *mut core::ffi::c_void;
...
pub type FDIDestroy = unsafe extern "C" fn(hfdi: *const core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("cabinet.dll" "C" fn FDIDestroy(hfdi : *const core::ffi::c_void) -> windows_sys::core::BOOL);
pub type FDIIsCabinet = unsafe extern "C" fn(hfdi: *const core::ffi::c_void, hf: isize, pfdici: *mut FDICABINETINFO) -> windows_sys::core::BOOL;
...
pub type FDITruncateCabinet = unsafe extern "C" fn(hfdi: *const core::ffi::c_void, pszcabinetname: windows_sys::core::PCSTR, ifoldertodelete: u16) -> windows_sys::core::BOOL;
...
pub type PFNFCICLOSE = Option<unsafe extern "C" fn(hf: isize, err: *mut i32, pv: *mut core::ffi::c_void) -> i32>;
pub type PFNFCIDELETE = Option<unsafe extern "C" fn(pszfile: windows_sys::core::PCSTR, err: *mut i32, pv: *mut core::ffi::c_void) -> i32>;
pub type PFNFCIFILEPLACED = Option<unsafe extern "C" fn(pccab: *mut CCAB, pszfile: windows_sys::core::PCSTR, cbfile: i32, fcontinuation: windows_sys::core::BOOL, pv: *mut core::ffi::c_void) -> i32>;
...
pub type PFNFCISTATUS = Option<unsafe extern "C" fn(typestatus: u32, cb1: u32, cb2: u32, pv: *mut core::ffi::c_void) -> i32>;
