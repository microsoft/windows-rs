...
pub const FCIERR_ALLOC_FAIL: FCIERROR = 3;
pub const FCIERR_BAD_COMPR_TYPE: FCIERROR = 5;
pub const FCIERR_CAB_FILE: FCIERROR = 6;
pub const FCIERR_CAB_FORMAT_LIMIT: FCIERROR = 9;
pub const FCIERR_MCI_FAIL: FCIERROR = 8;
pub const FCIERR_NONE: FCIERROR = 0;
pub const FCIERR_OPEN_SRC: FCIERROR = 1;
pub const FCIERR_READ_SRC: FCIERROR = 2;
...
pub const FDIERROR_ALLOC_FAIL: FDIERROR = 5;
pub const FDIERROR_BAD_COMPR_TYPE: FDIERROR = 6;
pub const FDIERROR_CABINET_NOT_FOUND: FDIERROR = 1;
pub const FDIERROR_CORRUPT_CABINET: FDIERROR = 4;
pub const FDIERROR_EOF: FDIERROR = 12;
pub const FDIERROR_MDI_FAIL: FDIERROR = 7;
pub const FDIERROR_NONE: FDIERROR = 0;
pub const FDIERROR_NOT_A_CABINET: FDIERROR = 2;
pub const FDIERROR_RESERVE_MISMATCH: FDIERROR = 9;
pub const FDIERROR_TARGET_FILE: FDIERROR = 8;
pub const FDIERROR_UNKNOWN_CABINET_VERSION: FDIERROR = 3;
...
pub const cpu80286: FDICREATE_CPU_TYPE = 0;
pub const cpu80386: FDICREATE_CPU_TYPE = 1;
pub const cpuUNKNOWN: FDICREATE_CPU_TYPE = -1;
pub const fdidtDECRYPT: FDIDECRYPTTYPE = 2;
pub const fdidtNEW_CABINET: FDIDECRYPTTYPE = 0;
pub const fdidtNEW_FOLDER: FDIDECRYPTTYPE = 1;
pub const fdintCABINET_INFO: FDINOTIFICATIONTYPE = 0;
pub const fdintCLOSE_FILE_INFO: FDINOTIFICATIONTYPE = 3;
pub const fdintCOPY_FILE: FDINOTIFICATIONTYPE = 2;
pub const fdintENUMERATE: FDINOTIFICATIONTYPE = 5;
pub const fdintNEXT_CABINET: FDINOTIFICATIONTYPE = 4;
pub const fdintPARTIAL_FILE: FDINOTIFICATIONTYPE = 1;
