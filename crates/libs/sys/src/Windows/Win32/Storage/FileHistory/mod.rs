pub type FhServiceBlockBackup = unsafe extern "system" fn(pipe: FH_SERVICE_PIPE_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("fhsvcctl.dll" "system" fn FhServiceBlockBackup(pipe : FH_SERVICE_PIPE_HANDLE) -> windows_sys::core::HRESULT);
pub type FhServiceClosePipe = unsafe extern "system" fn(pipe: FH_SERVICE_PIPE_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("fhsvcctl.dll" "system" fn FhServiceClosePipe(pipe : FH_SERVICE_PIPE_HANDLE) -> windows_sys::core::HRESULT);
pub type FhServiceOpenPipe = unsafe extern "system" fn(startserviceifstopped: windows_sys::core::BOOL, pipe: *mut FH_SERVICE_PIPE_HANDLE) -> windows_sys::core::HRESULT;
...
pub type FhServiceReloadConfiguration = unsafe extern "system" fn(pipe: FH_SERVICE_PIPE_HANDLE) -> windows_sys::core::HRESULT;
...
pub type FhServiceStartBackup = unsafe extern "system" fn(pipe: FH_SERVICE_PIPE_HANDLE, lowpriorityio: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type FhServiceStopBackup = unsafe extern "system" fn(pipe: FH_SERVICE_PIPE_HANDLE, stoptracking: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type FhServiceUnblockBackup = unsafe extern "system" fn(pipe: FH_SERVICE_PIPE_HANDLE) -> windows_sys::core::HRESULT;
