pub type AddISNSServerA = unsafe extern "system" fn(address: windows_sys::core::PCSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn AddISNSServerA(address : windows_sys::core::PCSTR) -> u32);
pub type AddISNSServerW = unsafe extern "system" fn(address: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn AddISNSServerW(address : windows_sys::core::PCWSTR) -> u32);
pub type AddIScsiConnectionA = unsafe extern "system" fn(uniquesessionid: *mut ISCSI_UNIQUE_SESSION_ID, reserved: *mut core::ffi::c_void, initiatorportnumber: u32, targetportal: *mut ISCSI_TARGET_PORTALA, securityflags: u64, loginoptions: *mut ISCSI_LOGIN_OPTIONS, keysize: u32, key: windows_sys::core::PCSTR, connectionid: *mut ISCSI_UNIQUE_SESSION_ID) -> u32;
...
pub type AddIScsiConnectionW = unsafe extern "system" fn(uniquesessionid: *mut ISCSI_UNIQUE_SESSION_ID, reserved: *mut core::ffi::c_void, initiatorportnumber: u32, targetportal: *mut ISCSI_TARGET_PORTALW, securityflags: u64, loginoptions: *mut ISCSI_LOGIN_OPTIONS, keysize: u32, key: windows_sys::core::PCSTR, connectionid: *mut ISCSI_UNIQUE_SESSION_ID) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn AddIScsiConnectionW(uniquesessionid : *mut ISCSI_UNIQUE_SESSION_ID, reserved : *mut core::ffi::c_void, initiatorportnumber : u32, targetportal : *mut ISCSI_TARGET_PORTALW, securityflags : u64, loginoptions : *mut ISCSI_LOGIN_OPTIONS, keysize : u32, key : windows_sys::core::PCSTR, connectionid : *mut ISCSI_UNIQUE_SESSION_ID) -> u32);
pub type AddIScsiSendTargetPortalA = unsafe extern "system" fn(initiatorinstance: windows_sys::core::PCSTR, initiatorportnumber: u32, loginoptions: *mut ISCSI_LOGIN_OPTIONS, securityflags: u64, portal: *mut ISCSI_TARGET_PORTALA) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn AddIScsiSendTargetPortalA(initiatorinstance : windows_sys::core::PCSTR, initiatorportnumber : u32, loginoptions : *mut ISCSI_LOGIN_OPTIONS, securityflags : u64, portal : *mut ISCSI_TARGET_PORTALA) -> u32);
pub type AddIScsiSendTargetPortalW = unsafe extern "system" fn(initiatorinstance: windows_sys::core::PCWSTR, initiatorportnumber: u32, loginoptions: *mut ISCSI_LOGIN_OPTIONS, securityflags: u64, portal: *mut ISCSI_TARGET_PORTALW) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn AddIScsiSendTargetPortalW(initiatorinstance : windows_sys::core::PCWSTR, initiatorportnumber : u32, loginoptions : *mut ISCSI_LOGIN_OPTIONS, securityflags : u64, portal : *mut ISCSI_TARGET_PORTALW) -> u32);
pub type AddIScsiStaticTargetA = unsafe extern "system" fn(targetname: windows_sys::core::PCSTR, targetalias: windows_sys::core::PCSTR, targetflags: u32, persist: bool, mappings: *mut ISCSI_TARGET_MAPPINGA, loginoptions: *mut ISCSI_LOGIN_OPTIONS, portalgroup: *mut ISCSI_TARGET_PORTAL_GROUPA) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn AddIScsiStaticTargetA(targetname : windows_sys::core::PCSTR, targetalias : windows_sys::core::PCSTR, targetflags : u32, persist : bool, mappings : *mut ISCSI_TARGET_MAPPINGA, loginoptions : *mut ISCSI_LOGIN_OPTIONS, portalgroup : *mut ISCSI_TARGET_PORTAL_GROUPA) -> u32);
pub type AddIScsiStaticTargetW = unsafe extern "system" fn(targetname: windows_sys::core::PCWSTR, targetalias: windows_sys::core::PCWSTR, targetflags: u32, persist: bool, mappings: *mut ISCSI_TARGET_MAPPINGW, loginoptions: *mut ISCSI_LOGIN_OPTIONS, portalgroup: *mut ISCSI_TARGET_PORTAL_GROUPW) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn AddIScsiStaticTargetW(targetname : windows_sys::core::PCWSTR, targetalias : windows_sys::core::PCWSTR, targetflags : u32, persist : bool, mappings : *mut ISCSI_TARGET_MAPPINGW, loginoptions : *mut ISCSI_LOGIN_OPTIONS, portalgroup : *mut ISCSI_TARGET_PORTAL_GROUPW) -> u32);
pub type AddPersistentIScsiDeviceA = unsafe extern "system" fn(devicepath: windows_sys::core::PCSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn AddPersistentIScsiDeviceA(devicepath : windows_sys::core::PCSTR) -> u32);
pub type AddPersistentIScsiDeviceW = unsafe extern "system" fn(devicepath: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn AddPersistentIScsiDeviceW(devicepath : windows_sys::core::PCWSTR) -> u32);
pub type AddRadiusServerA = unsafe extern "system" fn(address: windows_sys::core::PCSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn AddRadiusServerA(address : windows_sys::core::PCSTR) -> u32);
pub type AddRadiusServerW = unsafe extern "system" fn(address: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn AddRadiusServerW(address : windows_sys::core::PCWSTR) -> u32);
pub type ClearPersistentIScsiDevices = unsafe extern "system" fn() -> u32;
windows_link::link!("iscsidsc.dll" "system" fn ClearPersistentIScsiDevices() -> u32);
#[cfg(feature = "Win32_System_Ioctl")]
pub type GetDevicesForIScsiSessionA = unsafe extern "system" fn(uniquesessionid: *mut ISCSI_UNIQUE_SESSION_ID, devicecount: *mut u32, devices: *mut ISCSI_DEVICE_ON_SESSIONA) -> u32;
#[cfg(feature = "Win32_System_Ioctl")]
...
#[cfg(feature = "Win32_System_Ioctl")]
pub type GetDevicesForIScsiSessionW = unsafe extern "system" fn(uniquesessionid: *mut ISCSI_UNIQUE_SESSION_ID, devicecount: *mut u32, devices: *mut ISCSI_DEVICE_ON_SESSIONW) -> u32;
#[cfg(feature = "Win32_System_Ioctl")]
...
pub type GetIScsiIKEInfoA = unsafe extern "system" fn(initiatorname: windows_sys::core::PCSTR, initiatorportnumber: u32, reserved: *mut u32, authinfo: *mut IKE_AUTHENTICATION_INFORMATION) -> u32;
...
pub type GetIScsiIKEInfoW = unsafe extern "system" fn(initiatorname: windows_sys::core::PCWSTR, initiatorportnumber: u32, reserved: *mut u32, authinfo: *mut IKE_AUTHENTICATION_INFORMATION) -> u32;
...
pub type GetIScsiInitiatorNodeNameA = unsafe extern "system" fn(initiatornodename: windows_sys::core::PSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn GetIScsiInitiatorNodeNameA(initiatornodename : windows_sys::core::PSTR) -> u32);
pub type GetIScsiInitiatorNodeNameW = unsafe extern "system" fn(initiatornodename: windows_sys::core::PWSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn GetIScsiInitiatorNodeNameW(initiatornodename : windows_sys::core::PWSTR) -> u32);
pub type GetIScsiSessionListA = unsafe extern "system" fn(buffersize: *mut u32, sessioncount: *mut u32, sessioninfo: *mut ISCSI_SESSION_INFOA) -> u32;
...
pub type GetIScsiSessionListEx = unsafe extern "system" fn(buffersize: *mut u32, sessioncountptr: *mut u32, sessioninfo: *mut ISCSI_SESSION_INFO_EX) -> u32;
...
pub type GetIScsiSessionListW = unsafe extern "system" fn(buffersize: *mut u32, sessioncount: *mut u32, sessioninfo: *mut ISCSI_SESSION_INFOW) -> u32;
...
pub type GetIScsiTargetInformationA = unsafe extern "system" fn(targetname: windows_sys::core::PCSTR, discoverymechanism: windows_sys::core::PCSTR, infoclass: TARGET_INFORMATION_CLASS, buffersize: *mut u32, buffer: *mut core::ffi::c_void) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn GetIScsiTargetInformationA(targetname : windows_sys::core::PCSTR, discoverymechanism : windows_sys::core::PCSTR, infoclass : TARGET_INFORMATION_CLASS, buffersize : *mut u32, buffer : *mut core::ffi::c_void) -> u32);
pub type GetIScsiTargetInformationW = unsafe extern "system" fn(targetname: windows_sys::core::PCWSTR, discoverymechanism: windows_sys::core::PCWSTR, infoclass: TARGET_INFORMATION_CLASS, buffersize: *mut u32, buffer: *mut core::ffi::c_void) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn GetIScsiTargetInformationW(targetname : windows_sys::core::PCWSTR, discoverymechanism : windows_sys::core::PCWSTR, infoclass : TARGET_INFORMATION_CLASS, buffersize : *mut u32, buffer : *mut core::ffi::c_void) -> u32);
pub type GetIScsiVersionInformation = unsafe extern "system" fn(versioninfo: *mut ISCSI_VERSION_INFO) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn GetIScsiVersionInformation(versioninfo : *mut ISCSI_VERSION_INFO) -> u32);
pub type LoginIScsiTargetA = unsafe extern "system" fn(targetname: windows_sys::core::PCSTR, isinformationalsession: bool, initiatorinstance: windows_sys::core::PCSTR, initiatorportnumber: u32, targetportal: *mut ISCSI_TARGET_PORTALA, securityflags: u64, mappings: *mut ISCSI_TARGET_MAPPINGA, loginoptions: *mut ISCSI_LOGIN_OPTIONS, keysize: u32, key: windows_sys::core::PCSTR, ispersistent: bool, uniquesessionid: *mut ISCSI_UNIQUE_SESSION_ID, uniqueconnectionid: *mut ISCSI_UNIQUE_SESSION_ID) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn LoginIScsiTargetA(targetname : windows_sys::core::PCSTR, isinformationalsession : bool, initiatorinstance : windows_sys::core::PCSTR, initiatorportnumber : u32, targetportal : *mut ISCSI_TARGET_PORTALA, securityflags : u64, mappings : *mut ISCSI_TARGET_MAPPINGA, loginoptions : *mut ISCSI_LOGIN_OPTIONS, keysize : u32, key : windows_sys::core::PCSTR, ispersistent : bool, uniquesessionid : *mut ISCSI_UNIQUE_SESSION_ID, uniqueconnectionid : *mut ISCSI_UNIQUE_SESSION_ID) -> u32);
pub type LoginIScsiTargetW = unsafe extern "system" fn(targetname: windows_sys::core::PCWSTR, isinformationalsession: bool, initiatorinstance: windows_sys::core::PCWSTR, initiatorportnumber: u32, targetportal: *mut ISCSI_TARGET_PORTALW, securityflags: u64, mappings: *mut ISCSI_TARGET_MAPPINGW, loginoptions: *mut ISCSI_LOGIN_OPTIONS, keysize: u32, key: windows_sys::core::PCSTR, ispersistent: bool, uniquesessionid: *mut ISCSI_UNIQUE_SESSION_ID, uniqueconnectionid: *mut ISCSI_UNIQUE_SESSION_ID) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn LoginIScsiTargetW(targetname : windows_sys::core::PCWSTR, isinformationalsession : bool, initiatorinstance : windows_sys::core::PCWSTR, initiatorportnumber : u32, targetportal : *mut ISCSI_TARGET_PORTALW, securityflags : u64, mappings : *mut ISCSI_TARGET_MAPPINGW, loginoptions : *mut ISCSI_LOGIN_OPTIONS, keysize : u32, key : windows_sys::core::PCSTR, ispersistent : bool, uniquesessionid : *mut ISCSI_UNIQUE_SESSION_ID, uniqueconnectionid : *mut ISCSI_UNIQUE_SESSION_ID) -> u32);
pub type LogoutIScsiTarget = unsafe extern "system" fn(uniquesessionid: *mut ISCSI_UNIQUE_SESSION_ID) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn LogoutIScsiTarget(uniquesessionid : *mut ISCSI_UNIQUE_SESSION_ID) -> u32);
pub type RefreshISNSServerA = unsafe extern "system" fn(address: windows_sys::core::PCSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn RefreshISNSServerA(address : windows_sys::core::PCSTR) -> u32);
pub type RefreshISNSServerW = unsafe extern "system" fn(address: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn RefreshISNSServerW(address : windows_sys::core::PCWSTR) -> u32);
pub type RefreshIScsiSendTargetPortalA = unsafe extern "system" fn(initiatorinstance: windows_sys::core::PCSTR, initiatorportnumber: u32, portal: *mut ISCSI_TARGET_PORTALA) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn RefreshIScsiSendTargetPortalA(initiatorinstance : windows_sys::core::PCSTR, initiatorportnumber : u32, portal : *mut ISCSI_TARGET_PORTALA) -> u32);
pub type RefreshIScsiSendTargetPortalW = unsafe extern "system" fn(initiatorinstance: windows_sys::core::PCWSTR, initiatorportnumber: u32, portal: *mut ISCSI_TARGET_PORTALW) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn RefreshIScsiSendTargetPortalW(initiatorinstance : windows_sys::core::PCWSTR, initiatorportnumber : u32, portal : *mut ISCSI_TARGET_PORTALW) -> u32);
pub type RemoveISNSServerA = unsafe extern "system" fn(address: windows_sys::core::PCSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn RemoveISNSServerA(address : windows_sys::core::PCSTR) -> u32);
pub type RemoveISNSServerW = unsafe extern "system" fn(address: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn RemoveISNSServerW(address : windows_sys::core::PCWSTR) -> u32);
pub type RemoveIScsiConnection = unsafe extern "system" fn(uniquesessionid: *mut ISCSI_UNIQUE_SESSION_ID, connectionid: *mut ISCSI_UNIQUE_SESSION_ID) -> u32;
...
pub type RemoveIScsiPersistentTargetA = unsafe extern "system" fn(initiatorinstance: windows_sys::core::PCSTR, initiatorportnumber: u32, targetname: windows_sys::core::PCSTR, portal: *mut ISCSI_TARGET_PORTALA) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn RemoveIScsiPersistentTargetA(initiatorinstance : windows_sys::core::PCSTR, initiatorportnumber : u32, targetname : windows_sys::core::PCSTR, portal : *mut ISCSI_TARGET_PORTALA) -> u32);
pub type RemoveIScsiPersistentTargetW = unsafe extern "system" fn(initiatorinstance: windows_sys::core::PCWSTR, initiatorportnumber: u32, targetname: windows_sys::core::PCWSTR, portal: *mut ISCSI_TARGET_PORTALW) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn RemoveIScsiPersistentTargetW(initiatorinstance : windows_sys::core::PCWSTR, initiatorportnumber : u32, targetname : windows_sys::core::PCWSTR, portal : *mut ISCSI_TARGET_PORTALW) -> u32);
pub type RemoveIScsiSendTargetPortalA = unsafe extern "system" fn(initiatorinstance: windows_sys::core::PCSTR, initiatorportnumber: u32, portal: *mut ISCSI_TARGET_PORTALA) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn RemoveIScsiSendTargetPortalA(initiatorinstance : windows_sys::core::PCSTR, initiatorportnumber : u32, portal : *mut ISCSI_TARGET_PORTALA) -> u32);
pub type RemoveIScsiSendTargetPortalW = unsafe extern "system" fn(initiatorinstance: windows_sys::core::PCWSTR, initiatorportnumber: u32, portal: *mut ISCSI_TARGET_PORTALW) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn RemoveIScsiSendTargetPortalW(initiatorinstance : windows_sys::core::PCWSTR, initiatorportnumber : u32, portal : *mut ISCSI_TARGET_PORTALW) -> u32);
pub type RemoveIScsiStaticTargetA = unsafe extern "system" fn(targetname: windows_sys::core::PCSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn RemoveIScsiStaticTargetA(targetname : windows_sys::core::PCSTR) -> u32);
pub type RemoveIScsiStaticTargetW = unsafe extern "system" fn(targetname: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn RemoveIScsiStaticTargetW(targetname : windows_sys::core::PCWSTR) -> u32);
pub type RemovePersistentIScsiDeviceA = unsafe extern "system" fn(devicepath: windows_sys::core::PCSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn RemovePersistentIScsiDeviceA(devicepath : windows_sys::core::PCSTR) -> u32);
pub type RemovePersistentIScsiDeviceW = unsafe extern "system" fn(devicepath: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn RemovePersistentIScsiDeviceW(devicepath : windows_sys::core::PCWSTR) -> u32);
pub type RemoveRadiusServerA = unsafe extern "system" fn(address: windows_sys::core::PCSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn RemoveRadiusServerA(address : windows_sys::core::PCSTR) -> u32);
pub type RemoveRadiusServerW = unsafe extern "system" fn(address: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn RemoveRadiusServerW(address : windows_sys::core::PCWSTR) -> u32);
pub type ReportActiveIScsiTargetMappingsA = unsafe extern "system" fn(buffersize: *mut u32, mappingcount: *mut u32, mappings: *mut ISCSI_TARGET_MAPPINGA) -> u32;
...
pub type ReportActiveIScsiTargetMappingsW = unsafe extern "system" fn(buffersize: *mut u32, mappingcount: *mut u32, mappings: *mut ISCSI_TARGET_MAPPINGW) -> u32;
...
pub type ReportISNSServerListA = unsafe extern "system" fn(buffersizeinchar: *mut u32, buffer: windows_sys::core::PSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn ReportISNSServerListA(buffersizeinchar : *mut u32, buffer : windows_sys::core::PSTR) -> u32);
pub type ReportISNSServerListW = unsafe extern "system" fn(buffersizeinchar: *mut u32, buffer: windows_sys::core::PWSTR) -> u32;
...
pub type ReportIScsiInitiatorListA = unsafe extern "system" fn(buffersize: *mut u32, buffer: windows_sys::core::PSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn ReportIScsiInitiatorListA(buffersize : *mut u32, buffer : windows_sys::core::PSTR) -> u32);
pub type ReportIScsiInitiatorListW = unsafe extern "system" fn(buffersize: *mut u32, buffer: windows_sys::core::PWSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn ReportIScsiInitiatorListW(buffersize : *mut u32, buffer : windows_sys::core::PWSTR) -> u32);
pub type ReportIScsiPersistentLoginsA = unsafe extern "system" fn(count: *mut u32, persistentlogininfo: *mut PERSISTENT_ISCSI_LOGIN_INFOA, buffersizeinbytes: *mut u32) -> u32;
...
pub type ReportIScsiPersistentLoginsW = unsafe extern "system" fn(count: *mut u32, persistentlogininfo: *mut PERSISTENT_ISCSI_LOGIN_INFOW, buffersizeinbytes: *mut u32) -> u32;
...
pub type ReportIScsiSendTargetPortalsA = unsafe extern "system" fn(portalcount: *mut u32, portalinfo: *mut ISCSI_TARGET_PORTAL_INFOA) -> u32;
...
pub type ReportIScsiSendTargetPortalsExA = unsafe extern "system" fn(portalcount: *mut u32, portalinfosize: *mut u32, portalinfo: *mut ISCSI_TARGET_PORTAL_INFO_EXA) -> u32;
...
pub type ReportIScsiSendTargetPortalsExW = unsafe extern "system" fn(portalcount: *mut u32, portalinfosize: *mut u32, portalinfo: *mut ISCSI_TARGET_PORTAL_INFO_EXW) -> u32;
...
pub type ReportIScsiSendTargetPortalsW = unsafe extern "system" fn(portalcount: *mut u32, portalinfo: *mut ISCSI_TARGET_PORTAL_INFOW) -> u32;
...
pub type ReportIScsiTargetPortalsA = unsafe extern "system" fn(initiatorname: windows_sys::core::PCSTR, targetname: windows_sys::core::PCSTR, targetportaltag: *mut u16, elementcount: *mut u32, portals: *mut ISCSI_TARGET_PORTALA) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn ReportIScsiTargetPortalsA(initiatorname : windows_sys::core::PCSTR, targetname : windows_sys::core::PCSTR, targetportaltag : *mut u16, elementcount : *mut u32, portals : *mut ISCSI_TARGET_PORTALA) -> u32);
pub type ReportIScsiTargetPortalsW = unsafe extern "system" fn(initiatorname: windows_sys::core::PCWSTR, targetname: windows_sys::core::PCWSTR, targetportaltag: *mut u16, elementcount: *mut u32, portals: *mut ISCSI_TARGET_PORTALW) -> u32;
...
pub type ReportIScsiTargetsA = unsafe extern "system" fn(forceupdate: bool, buffersize: *mut u32, buffer: windows_sys::core::PSTR) -> u32;
...
pub type ReportIScsiTargetsW = unsafe extern "system" fn(forceupdate: bool, buffersize: *mut u32, buffer: windows_sys::core::PWSTR) -> u32;
...
pub type ReportPersistentIScsiDevicesA = unsafe extern "system" fn(buffersizeinchar: *mut u32, buffer: windows_sys::core::PSTR) -> u32;
...
pub type ReportPersistentIScsiDevicesW = unsafe extern "system" fn(buffersizeinchar: *mut u32, buffer: windows_sys::core::PWSTR) -> u32;
...
pub type ReportRadiusServerListA = unsafe extern "system" fn(buffersizeinchar: *mut u32, buffer: windows_sys::core::PSTR) -> u32;
...
pub type ReportRadiusServerListW = unsafe extern "system" fn(buffersizeinchar: *mut u32, buffer: windows_sys::core::PWSTR) -> u32;
...
pub type SendScsiInquiry = unsafe extern "system" fn(uniquesessionid: *mut ISCSI_UNIQUE_SESSION_ID, lun: u64, evpdcmddt: u8, pagecode: u8, scsistatus: *mut u8, responsesize: *mut u32, responsebuffer: *mut u8, sensesize: *mut u32, sensebuffer: *mut u8) -> u32;
...
pub type SendScsiReadCapacity = unsafe extern "system" fn(uniquesessionid: *mut ISCSI_UNIQUE_SESSION_ID, lun: u64, scsistatus: *mut u8, responsesize: *mut u32, responsebuffer: *mut u8, sensesize: *mut u32, sensebuffer: *mut u8) -> u32;
...
pub type SendScsiReportLuns = unsafe extern "system" fn(uniquesessionid: *mut ISCSI_UNIQUE_SESSION_ID, scsistatus: *mut u8, responsesize: *mut u32, responsebuffer: *mut u8, sensesize: *mut u32, sensebuffer: *mut u8) -> u32;
...
pub type SetIScsiGroupPresharedKey = unsafe extern "system" fn(keylength: u32, key: *mut u8, persist: bool) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn SetIScsiGroupPresharedKey(keylength : u32, key : *mut u8, persist : bool) -> u32);
pub type SetIScsiIKEInfoA = unsafe extern "system" fn(initiatorname: windows_sys::core::PCSTR, initiatorportnumber: u32, authinfo: *mut IKE_AUTHENTICATION_INFORMATION, persist: bool) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn SetIScsiIKEInfoA(initiatorname : windows_sys::core::PCSTR, initiatorportnumber : u32, authinfo : *mut IKE_AUTHENTICATION_INFORMATION, persist : bool) -> u32);
pub type SetIScsiIKEInfoW = unsafe extern "system" fn(initiatorname: windows_sys::core::PCWSTR, initiatorportnumber: u32, authinfo: *mut IKE_AUTHENTICATION_INFORMATION, persist: bool) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn SetIScsiIKEInfoW(initiatorname : windows_sys::core::PCWSTR, initiatorportnumber : u32, authinfo : *mut IKE_AUTHENTICATION_INFORMATION, persist : bool) -> u32);
pub type SetIScsiInitiatorCHAPSharedSecret = unsafe extern "system" fn(sharedsecretlength: u32, sharedsecret: *mut u8) -> u32;
...
pub type SetIScsiInitiatorNodeNameA = unsafe extern "system" fn(initiatornodename: windows_sys::core::PCSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn SetIScsiInitiatorNodeNameA(initiatornodename : windows_sys::core::PCSTR) -> u32);
pub type SetIScsiInitiatorNodeNameW = unsafe extern "system" fn(initiatornodename: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn SetIScsiInitiatorNodeNameW(initiatornodename : windows_sys::core::PCWSTR) -> u32);
pub type SetIScsiInitiatorRADIUSSharedSecret = unsafe extern "system" fn(sharedsecretlength: u32, sharedsecret: *mut u8) -> u32;
...
pub type SetIScsiTunnelModeOuterAddressA = unsafe extern "system" fn(initiatorname: windows_sys::core::PCSTR, initiatorportnumber: u32, destinationaddress: windows_sys::core::PCSTR, outermodeaddress: windows_sys::core::PCSTR, persist: bool) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn SetIScsiTunnelModeOuterAddressA(initiatorname : windows_sys::core::PCSTR, initiatorportnumber : u32, destinationaddress : windows_sys::core::PCSTR, outermodeaddress : windows_sys::core::PCSTR, persist : bool) -> u32);
pub type SetIScsiTunnelModeOuterAddressW = unsafe extern "system" fn(initiatorname: windows_sys::core::PCWSTR, initiatorportnumber: u32, destinationaddress: windows_sys::core::PCWSTR, outermodeaddress: windows_sys::core::PCWSTR, persist: bool) -> u32;
windows_link::link!("iscsidsc.dll" "system" fn SetIScsiTunnelModeOuterAddressW(initiatorname : windows_sys::core::PCWSTR, initiatorportnumber : u32, destinationaddress : windows_sys::core::PCWSTR, outermodeaddress : windows_sys::core::PCWSTR, persist : bool) -> u32);
pub type SetupPersistentIScsiDevices = unsafe extern "system" fn() -> u32;
windows_link::link!("iscsidsc.dll" "system" fn SetupPersistentIScsiDevices() -> u32);
pub type SetupPersistentIScsiVolumes = unsafe extern "system" fn() -> u32;
...
pub const FIRMWARE_REQUEST_FLAG_REPLACE_AND_SWITCH_UPON_RESET: u32 = 536870912u32;
...
pub const FIRMWARE_REQUEST_FLAG_SWITCH_TO_FIRMWARE_WITHOUT_RESET: u32 = 268435456u32;
