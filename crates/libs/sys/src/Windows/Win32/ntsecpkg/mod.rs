...
#[cfg(feature = "winnt")]
pub type KSEC_REFERENCE_LIST_ENTRY = Option<unsafe extern "system" fn(entry: PKSEC_LIST_ENTRY, signature: u32, removenoref: super::BOOLEAN) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type KSEC_SERIALIZE_SCHANNEL_AUTH_DATA = Option<unsafe extern "system" fn(pvauthdata: *const core::ffi::c_void, size: super::PULONG, serializeddata: *mut *mut core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type KSEC_SERIALIZE_WINNT_AUTH_DATA = Option<unsafe extern "system" fn(pvauthdata: *const core::ffi::c_void, size: super::PULONG, serializeddata: *mut *mut core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
pub const KSecNonPaged: KSEC_CONTEXT_TYPE = 1;
pub const KSecPaged: KSEC_CONTEXT_TYPE = 0;
#[cfg(feature = "sspi")]
pub type KspCompleteTokenFn = Option<unsafe extern "system" fn(contextid: LSA_SEC_HANDLE, token: super::PSecBufferDesc) -> windows_sys::core::NTSTATUS>;
pub type KspDeleteContextFn = Option<unsafe extern "system" fn(contextid: LSA_SEC_HANDLE, lsacontextid: PLSA_SEC_HANDLE) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
pub type KspGetTokenFn = Option<unsafe extern "system" fn(contextid: LSA_SEC_HANDLE, impersonationtoken: super::PHANDLE, rawtoken: *mut super::PACCESS_TOKEN) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "sspi")]
pub type KspInitContextFn = Option<unsafe extern "system" fn(contextid: LSA_SEC_HANDLE, contextdata: super::PSecBuffer, newcontextid: PLSA_SEC_HANDLE) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type KspInitPackageFn = Option<unsafe extern "system" fn(functiontable: PSECPKG_KERNEL_FUNCTIONS) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "sspi")]
pub type KspMakeSignatureFn = Option<unsafe extern "system" fn(contextid: LSA_SEC_HANDLE, fqop: u32, message: super::PSecBufferDesc, messageseqno: u32) -> windows_sys::core::NTSTATUS>;
pub type KspMapHandleFn = Option<unsafe extern "system" fn(contextid: LSA_SEC_HANDLE, lsacontextid: PLSA_SEC_HANDLE) -> windows_sys::core::NTSTATUS>;
...
#[cfg(feature = "sspi")]
pub type KspSealMessageFn = Option<unsafe extern "system" fn(contextid: LSA_SEC_HANDLE, fqop: u32, message: super::PSecBufferDesc, messageseqno: u32) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type KspSerializeAuthDataFn = Option<unsafe extern "system" fn(pvauthdata: *const core::ffi::c_void, size: super::PULONG, serializeddata: *mut *mut core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
pub type KspSetPagingModeFn = Option<unsafe extern "system" fn(pagingmode: super::BOOLEAN) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "sspi"))]
pub type KspUnsealMessageFn = Option<unsafe extern "system" fn(contextid: LSA_SEC_HANDLE, message: super::PSecBufferDesc, messageseqno: u32, pfqop: super::PULONG) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "sspi"))]
pub type KspVerifySignatureFn = Option<unsafe extern "system" fn(contextid: LSA_SEC_HANDLE, message: super::PSecBufferDesc, messageseqno: u32, pfqop: super::PULONG) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "lsalookup", feature = "winnt"))]
pub type LSA_ADD_CREDENTIAL = Option<unsafe extern "system" fn(logonid: super::PLUID, authenticationpackage: u32, primarykeyvalue: super::PLSA_STRING, credentials: super::PLSA_STRING) -> windows_sys::core::NTSTATUS>;
pub type LSA_ALLOCATE_CLIENT_BUFFER = Option<unsafe extern "system" fn(clientrequest: PLSA_CLIENT_REQUEST, lengthrequired: u32, clientbaseaddress: *mut *mut core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
...
pub type LSA_AP_INITIALIZE_PACKAGE = Option<unsafe extern "system" fn(authenticationpackageid: u32, lsadispatchtable: PLSA_DISPATCH_TABLE, database: super::PLSA_STRING, confidentiality: super::PLSA_STRING, authenticationpackagename: *mut super::PLSA_STRING) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
...
#[cfg(feature = "winnt")]
pub type LSA_AP_POST_LOGON_USER = Option<unsafe extern "system" fn(postlogonuserinfo: PSECPKG_POST_LOGON_USER_INFO) -> windows_sys::core::NTSTATUS>;
...
pub type LSA_AUDIT_ACCOUNT_LOGON = Option<unsafe extern "system" fn(auditid: u32, success: super::BOOLEAN, source: super::PUNICODE_STRING, clientname: super::PUNICODE_STRING, mappedname: super::PUNICODE_STRING, status: windows_sys::core::NTSTATUS) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
pub type LSA_AUDIT_LOGON = Option<unsafe extern "system" fn(status: windows_sys::core::NTSTATUS, substatus: windows_sys::core::NTSTATUS, accountname: super::PUNICODE_STRING, authenticatingauthority: super::PUNICODE_STRING, workstationname: super::PUNICODE_STRING, usersid: super::PSID, logontype: super::SECURITY_LOGON_TYPE, tokensource: super::PTOKEN_SOURCE, logonid: super::PLUID)>;
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
pub type LSA_AUDIT_LOGON_EX = Option<unsafe extern "system" fn(status: windows_sys::core::NTSTATUS, substatus: windows_sys::core::NTSTATUS, accountname: super::PUNICODE_STRING, authenticatingauthority: super::PUNICODE_STRING, workstationname: super::PUNICODE_STRING, usersid: super::PSID, logontype: super::SECURITY_LOGON_TYPE, impersonationlevel: super::SECURITY_IMPERSONATION_LEVEL, tokensource: super::PTOKEN_SOURCE, logonid: super::PLUID)>;
#[cfg(feature = "sspi")]
pub type LSA_CALLBACK_FUNCTION = Option<unsafe extern "system" fn(argument1: usize, argument2: usize, inputbuffer: super::PSecBuffer, outputbuffer: super::PSecBuffer) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "minwindef", feature = "ntsecapi"))]
pub type LSA_CALL_PACKAGE = Option<unsafe extern "system" fn(authenticationpackage: super::PUNICODE_STRING, protocolsubmitbuffer: *const core::ffi::c_void, submitbufferlength: u32, protocolreturnbuffer: *mut *mut core::ffi::c_void, returnbufferlength: super::PULONG, protocolstatus: super::PNTSTATUS) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "minwindef", feature = "ntsecapi"))]
...
#[cfg(feature = "winnt")]
pub type LSA_CHECK_PROTECTED_USER_BY_TOKEN = Option<unsafe extern "system" fn(usertoken: super::HANDLE, protecteduser: super::PBOOLEAN) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "sspi", feature = "winnt"))]
pub type LSA_CLIENT_CALLBACK = Option<unsafe extern "system" fn(callback: super::PCHAR, argument1: usize, argument2: usize, input: super::PSecBuffer, output: super::PSecBuffer) -> windows_sys::core::NTSTATUS>;
...
pub type LSA_COPY_FROM_CLIENT_BUFFER = Option<unsafe extern "system" fn(clientrequest: PLSA_CLIENT_REQUEST, length: u32, buffertocopy: *mut core::ffi::c_void, clientbaseaddress: *const core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
pub type LSA_COPY_TO_CLIENT_BUFFER = Option<unsafe extern "system" fn(clientrequest: PLSA_CLIENT_REQUEST, length: u32, clientbaseaddress: *mut core::ffi::c_void, buffertocopy: *const core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "lsalookup", feature = "minwindef", feature = "ntsecapi", feature = "winnt"))]
pub type LSA_CRACK_SINGLE_NAME = Option<unsafe extern "system" fn(formatoffered: u32, performatgc: super::BOOLEAN, nameinput: super::PUNICODE_STRING, prefix: super::PUNICODE_STRING, requestedformat: u32, crackedname: super::PUNICODE_STRING, dnsdomainname: super::PUNICODE_STRING, substatus: super::PULONG) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
pub type LSA_CREATE_LOGON_SESSION = Option<unsafe extern "system" fn(logonid: super::PLUID) -> windows_sys::core::NTSTATUS>;
...
#[cfg(all(feature = "lsalookup", feature = "winnt"))]
pub type LSA_DELETE_CREDENTIAL = Option<unsafe extern "system" fn(logonid: super::PLUID, authenticationpackage: u32, primarykeyvalue: super::PLSA_STRING) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
pub type LSA_DELETE_LOGON_SESSION = Option<unsafe extern "system" fn(logonid: super::PLUID) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
...
#[cfg(feature = "winnt")]
pub type LSA_DUPLICATE_HANDLE = Option<unsafe extern "system" fn(sourcehandle: super::HANDLE, destionationhandle: super::PHANDLE) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type LSA_EXPAND_AUTH_DATA_FOR_DOMAIN = Option<unsafe extern "system" fn(userauthdata: super::PUCHAR, userauthdatasize: u32, reserved: *const core::ffi::c_void, expandedauthdata: *mut super::PUCHAR, expandedauthdatasize: super::PULONG) -> windows_sys::core::NTSTATUS>;
pub type LSA_FREE_CLIENT_BUFFER = Option<unsafe extern "system" fn(clientrequest: PLSA_CLIENT_REQUEST, clientbaseaddress: *const core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
...
pub type LSA_GET_APP_MODE_INFO = Option<unsafe extern "system" fn(userfunction: super::PULONG, argument1: super::PULONG_PTR, argument2: super::PULONG_PTR, userdata: super::PSecBuffer, returntolsa: super::PBOOLEAN) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "lsalookup", feature = "minwindef", feature = "ntsecapi", feature = "sspi"))]
pub type LSA_GET_AUTH_DATA_FOR_USER = Option<unsafe extern "system" fn(name: super::PSECURITY_STRING, nametype: SECPKG_NAME_TYPE, prefix: super::PSECURITY_STRING, userauthdata: *mut super::PUCHAR, userauthdatasize: super::PULONG, userflatname: super::PUNICODE_STRING) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
pub type LSA_GET_CALL_INFO = Option<unsafe extern "system" fn(info: PSECPKG_CALL_INFO) -> super::BOOLEAN>;
#[cfg(feature = "winnt")]
pub type LSA_GET_CLIENT_INFO = Option<unsafe extern "system" fn(clientinfo: PSECPKG_CLIENT_INFO) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
pub type LSA_GET_CLIENT_INFO_EX = Option<unsafe extern "system" fn(clientinfo: PSECPKG_CLIENT_INFO_EX, structsize: u32) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "lsalookup", feature = "minwindef", feature = "winnt"))]
pub type LSA_GET_CREDENTIALS = Option<unsafe extern "system" fn(logonid: super::PLUID, authenticationpackage: u32, querycontext: super::PULONG, retrieveallcredentials: super::BOOLEAN, primarykeyvalue: super::PLSA_STRING, primarykeylength: super::PULONG, credentials: super::PLSA_STRING) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type LSA_GET_EXTENDED_CALL_FLAGS = Option<unsafe extern "system" fn(flags: super::PULONG) -> windows_sys::core::NTSTATUS>;
...
pub type LSA_GET_SERVICE_ACCOUNT_PASSWORD = Option<unsafe extern "system" fn(accountname: super::PUNICODE_STRING, domainname: super::PUNICODE_STRING, credfetch: CRED_FETCH, filetimeexpiry: *mut super::FILETIME, currentpassword: super::PUNICODE_STRING, previouspassword: super::PUNICODE_STRING, filetimecurrpwdvalidforoutbound: *mut super::FILETIME) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type LSA_GET_USER_AUTH_DATA = Option<unsafe extern "system" fn(userhandle: *const core::ffi::c_void, userauthdata: *mut super::PUCHAR, userauthdatasize: super::PULONG) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type LSA_GET_USER_CREDENTIALS = Option<unsafe extern "system" fn(userhandle: *const core::ffi::c_void, primarycreds: *mut *mut core::ffi::c_void, primarycredssize: super::PULONG, supplementalcreds: *mut *mut core::ffi::c_void, supplementalcredssize: super::PULONG) -> windows_sys::core::NTSTATUS>;
...
#[cfg(feature = "sspi")]
pub type LSA_MAP_BUFFER = Option<unsafe extern "system" fn(inputbuffer: super::PSecBuffer, outputbuffer: super::PSecBuffer) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "sspi", feature = "winnt"))]
pub type LSA_OPEN_SAM_USER = Option<unsafe extern "system" fn(name: super::PSECURITY_STRING, nametype: SECPKG_NAME_TYPE, prefix: super::PSECURITY_STRING, allowguest: super::BOOLEAN, reserved: u32, userhandle: *mut *mut core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
pub type LSA_OPEN_TOKEN_BY_LOGON_ID = Option<unsafe extern "system" fn(logonid: super::PLUID, rettokenhandle: *mut super::HANDLE) -> windows_sys::core::NTSTATUS>;
...
pub type LSA_QUERY_CLIENT_REQUEST = Option<unsafe extern "system" fn(clientrequest: PLSA_CLIENT_REQUEST, querytype: u32, replybuffer: *mut *mut core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type LSA_REDIRECTED_LOGON_GET_LOGON_CREDS = Option<unsafe extern "system" fn(redirectedlogonhandle: super::HANDLE, logonbuffer: *mut super::PBYTE, logonbufferlength: super::PULONG) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
...
#[cfg(feature = "winnt")]
pub type LSA_SAVE_SUPPLEMENTAL_CREDENTIALS = Option<unsafe extern "system" fn(logonid: super::PLUID, supplementalcredsize: u32, supplementalcreds: *const core::ffi::c_void, synchronous: super::BOOLEAN) -> windows_sys::core::NTSTATUS>;
#[repr(C)]
...
#[cfg(all(feature = "sspi", feature = "winnt"))]
pub type LSA_SET_APP_MODE_INFO = Option<unsafe extern "system" fn(userfunction: u32, argument1: usize, argument2: usize, userdata: super::PSecBuffer, returntolsa: super::BOOLEAN) -> windows_sys::core::NTSTATUS>;
...
#[cfg(all(feature = "minwindef", feature = "winnt", feature = "winternl"))]
pub type LSA_UPDATE_PRIMARY_CREDENTIALS = Option<unsafe extern "system" fn(primarycredentials: PSECPKG_PRIMARY_CRED, credentials: PSECPKG_SUPPLEMENTAL_CRED_ARRAY) -> windows_sys::core::NTSTATUS>;
...
#[cfg(feature = "winnt")]
pub type PKSEC_REFERENCE_LIST_ENTRY = Option<unsafe extern "system" fn(entry: PKSEC_LIST_ENTRY, signature: u32, removenoref: super::BOOLEAN) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type PKSEC_SERIALIZE_SCHANNEL_AUTH_DATA = Option<unsafe extern "system" fn(pvauthdata: *const core::ffi::c_void, size: super::PULONG, serializeddata: *mut *mut core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type PKSEC_SERIALIZE_WINNT_AUTH_DATA = Option<unsafe extern "system" fn(pvauthdata: *const core::ffi::c_void, size: super::PULONG, serializeddata: *mut *mut core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "lsalookup", feature = "winnt"))]
pub type PLSA_ADD_CREDENTIAL = Option<unsafe extern "system" fn(logonid: super::PLUID, authenticationpackage: u32, primarykeyvalue: super::PLSA_STRING, credentials: super::PLSA_STRING) -> windows_sys::core::NTSTATUS>;
pub type PLSA_ALLOCATE_CLIENT_BUFFER = Option<unsafe extern "system" fn(clientrequest: PLSA_CLIENT_REQUEST, lengthrequired: u32, clientbaseaddress: *mut *mut core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
...
#[cfg(all(feature = "bcrypt", feature = "minwindef"))]
pub type PLSA_AP_CALL_PACKAGE_UNTRUSTED = Option<unsafe extern "C" fn(param0: PLSA_CLIENT_REQUEST, param1: *mut core::ffi::c_void, param2: *mut core::ffi::c_void, param3: u32, param4: *mut *mut core::ffi::c_void, param5: super::PULONG, param6: super::PNTSTATUS) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "lsalookup", feature = "minwindef", feature = "winnt"))]
pub type PLSA_AP_INITIALIZE_PACKAGE = Option<unsafe extern "system" fn(authenticationpackageid: u32, lsadispatchtable: PLSA_DISPATCH_TABLE, database: super::PLSA_STRING, confidentiality: super::PLSA_STRING, authenticationpackagename: *mut super::PLSA_STRING) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
...
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
pub type PLSA_AUDIT_ACCOUNT_LOGON = Option<unsafe extern "system" fn(auditid: u32, success: super::BOOLEAN, source: super::PUNICODE_STRING, clientname: super::PUNICODE_STRING, mappedname: super::PUNICODE_STRING, status: windows_sys::core::NTSTATUS) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
pub type PLSA_AUDIT_LOGON = Option<unsafe extern "system" fn(status: windows_sys::core::NTSTATUS, substatus: windows_sys::core::NTSTATUS, accountname: super::PUNICODE_STRING, authenticatingauthority: super::PUNICODE_STRING, workstationname: super::PUNICODE_STRING, usersid: super::PSID, logontype: super::SECURITY_LOGON_TYPE, tokensource: super::PTOKEN_SOURCE, logonid: super::PLUID)>;
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
pub type PLSA_AUDIT_LOGON_EX = Option<unsafe extern "system" fn(status: windows_sys::core::NTSTATUS, substatus: windows_sys::core::NTSTATUS, accountname: super::PUNICODE_STRING, authenticatingauthority: super::PUNICODE_STRING, workstationname: super::PUNICODE_STRING, usersid: super::PSID, logontype: super::SECURITY_LOGON_TYPE, impersonationlevel: super::SECURITY_IMPERSONATION_LEVEL, tokensource: super::PTOKEN_SOURCE, logonid: super::PLUID)>;
#[cfg(feature = "sspi")]
pub type PLSA_CALLBACK_FUNCTION = Option<unsafe extern "system" fn(argument1: usize, argument2: usize, inputbuffer: super::PSecBuffer, outputbuffer: super::PSecBuffer) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "minwindef", feature = "ntsecapi"))]
pub type PLSA_CALL_PACKAGE = Option<unsafe extern "system" fn(authenticationpackage: super::PUNICODE_STRING, protocolsubmitbuffer: *const core::ffi::c_void, submitbufferlength: u32, protocolreturnbuffer: *mut *mut core::ffi::c_void, returnbufferlength: super::PULONG, protocolstatus: super::PNTSTATUS) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "bcrypt", feature = "lsalookup", feature = "minwindef", feature = "ntsecapi"))]
...
#[cfg(feature = "winnt")]
pub type PLSA_CHECK_PROTECTED_USER_BY_TOKEN = Option<unsafe extern "system" fn(usertoken: super::HANDLE, protecteduser: super::PBOOLEAN) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "sspi", feature = "winnt"))]
pub type PLSA_CLIENT_CALLBACK = Option<unsafe extern "system" fn(callback: super::PCHAR, argument1: usize, argument2: usize, input: super::PSecBuffer, output: super::PSecBuffer) -> windows_sys::core::NTSTATUS>;
...
pub type PLSA_COPY_FROM_CLIENT_BUFFER = Option<unsafe extern "system" fn(clientrequest: PLSA_CLIENT_REQUEST, length: u32, buffertocopy: *mut core::ffi::c_void, clientbaseaddress: *const core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
pub type PLSA_COPY_TO_CLIENT_BUFFER = Option<unsafe extern "system" fn(clientrequest: PLSA_CLIENT_REQUEST, length: u32, clientbaseaddress: *mut core::ffi::c_void, buffertocopy: *const core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "lsalookup", feature = "minwindef", feature = "ntsecapi", feature = "winnt"))]
pub type PLSA_CRACK_SINGLE_NAME = Option<unsafe extern "system" fn(formatoffered: u32, performatgc: super::BOOLEAN, nameinput: super::PUNICODE_STRING, prefix: super::PUNICODE_STRING, requestedformat: u32, crackedname: super::PUNICODE_STRING, dnsdomainname: super::PUNICODE_STRING, substatus: super::PULONG) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
pub type PLSA_CREATE_LOGON_SESSION = Option<unsafe extern "system" fn(logonid: super::PLUID) -> windows_sys::core::NTSTATUS>;
...
#[cfg(all(feature = "lsalookup", feature = "winnt"))]
pub type PLSA_DELETE_CREDENTIAL = Option<unsafe extern "system" fn(logonid: super::PLUID, authenticationpackage: u32, primarykeyvalue: super::PLSA_STRING) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
pub type PLSA_DELETE_LOGON_SESSION = Option<unsafe extern "system" fn(logonid: super::PLUID) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
...
#[cfg(feature = "winnt")]
pub type PLSA_DUPLICATE_HANDLE = Option<unsafe extern "system" fn(sourcehandle: super::HANDLE, destionationhandle: super::PHANDLE) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type PLSA_EXPAND_AUTH_DATA_FOR_DOMAIN = Option<unsafe extern "system" fn(userauthdata: super::PUCHAR, userauthdatasize: u32, reserved: *const core::ffi::c_void, expandedauthdata: *mut super::PUCHAR, expandedauthdatasize: super::PULONG) -> windows_sys::core::NTSTATUS>;
pub type PLSA_FREE_CLIENT_BUFFER = Option<unsafe extern "system" fn(clientrequest: PLSA_CLIENT_REQUEST, clientbaseaddress: *const core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
...
#[cfg(all(feature = "basetsd", feature = "minwindef", feature = "sspi", feature = "winnt"))]
pub type PLSA_GET_APP_MODE_INFO = Option<unsafe extern "system" fn(userfunction: super::PULONG, argument1: super::PULONG_PTR, argument2: super::PULONG_PTR, userdata: super::PSecBuffer, returntolsa: super::PBOOLEAN) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "lsalookup", feature = "minwindef", feature = "ntsecapi", feature = "sspi"))]
pub type PLSA_GET_AUTH_DATA_FOR_USER = Option<unsafe extern "system" fn(name: super::PSECURITY_STRING, nametype: SECPKG_NAME_TYPE, prefix: super::PSECURITY_STRING, userauthdata: *mut super::PUCHAR, userauthdatasize: super::PULONG, userflatname: super::PUNICODE_STRING) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
pub type PLSA_GET_CALL_INFO = Option<unsafe extern "system" fn(info: PSECPKG_CALL_INFO) -> super::BOOLEAN>;
#[cfg(feature = "winnt")]
pub type PLSA_GET_CLIENT_INFO = Option<unsafe extern "system" fn(clientinfo: PSECPKG_CLIENT_INFO) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
pub type PLSA_GET_CLIENT_INFO_EX = Option<unsafe extern "system" fn(clientinfo: PSECPKG_CLIENT_INFO_EX, structsize: u32) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "lsalookup", feature = "minwindef", feature = "winnt"))]
pub type PLSA_GET_CREDENTIALS = Option<unsafe extern "system" fn(logonid: super::PLUID, authenticationpackage: u32, querycontext: super::PULONG, retrieveallcredentials: super::BOOLEAN, primarykeyvalue: super::PLSA_STRING, primarykeylength: super::PULONG, credentials: super::PLSA_STRING) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type PLSA_GET_EXTENDED_CALL_FLAGS = Option<unsafe extern "system" fn(flags: super::PULONG) -> windows_sys::core::NTSTATUS>;
...
#[cfg(feature = "minwindef")]
pub type PLSA_GET_USER_AUTH_DATA = Option<unsafe extern "system" fn(userhandle: *const core::ffi::c_void, userauthdata: *mut super::PUCHAR, userauthdatasize: super::PULONG) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type PLSA_GET_USER_CREDENTIALS = Option<unsafe extern "system" fn(userhandle: *const core::ffi::c_void, primarycreds: *mut *mut core::ffi::c_void, primarycredssize: super::PULONG, supplementalcreds: *mut *mut core::ffi::c_void, supplementalcredssize: super::PULONG) -> windows_sys::core::NTSTATUS>;
...
#[cfg(feature = "sspi")]
pub type PLSA_MAP_BUFFER = Option<unsafe extern "system" fn(inputbuffer: super::PSecBuffer, outputbuffer: super::PSecBuffer) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "sspi", feature = "winnt"))]
pub type PLSA_OPEN_SAM_USER = Option<unsafe extern "system" fn(name: super::PSECURITY_STRING, nametype: SECPKG_NAME_TYPE, prefix: super::PSECURITY_STRING, allowguest: super::BOOLEAN, reserved: u32, userhandle: *mut *mut core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
pub type PLSA_OPEN_TOKEN_BY_LOGON_ID = Option<unsafe extern "system" fn(logonid: super::PLUID, rettokenhandle: *mut super::HANDLE) -> windows_sys::core::NTSTATUS>;
pub type PLSA_PROTECT_MEMORY = Option<unsafe extern "system" fn(buffer: *mut core::ffi::c_void, buffersize: u32)>;
pub type PLSA_QUERY_CLIENT_REQUEST = Option<unsafe extern "system" fn(clientrequest: PLSA_CLIENT_REQUEST, querytype: u32, replybuffer: *mut *mut core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type PLSA_REDIRECTED_LOGON_GET_LOGON_CREDS = Option<unsafe extern "system" fn(redirectedlogonhandle: super::HANDLE, logonbuffer: *mut super::PBYTE, logonbufferlength: super::PULONG) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
...
#[cfg(feature = "winnt")]
pub type PLSA_SAVE_SUPPLEMENTAL_CREDENTIALS = Option<unsafe extern "system" fn(logonid: super::PLUID, supplementalcredsize: u32, supplementalcreds: *const core::ffi::c_void, synchronous: super::BOOLEAN) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "basetsd", feature = "bcrypt", feature = "lsalookup", feature = "minwinbase", feature = "minwindef", feature = "ntsecapi", feature = "sspi", feature = "winnt", feature = "winternl"))]
pub type PLSA_SECPKG_FUNCTION_TABLE = *mut LSA_SECPKG_FUNCTION_TABLE;
pub type PLSA_SEC_HANDLE = *mut LSA_SEC_HANDLE;
#[cfg(all(feature = "sspi", feature = "winnt"))]
pub type PLSA_SET_APP_MODE_INFO = Option<unsafe extern "system" fn(userfunction: u32, argument1: usize, argument2: usize, userdata: super::PSecBuffer, returntolsa: super::BOOLEAN) -> windows_sys::core::NTSTATUS>;
...
#[cfg(all(feature = "minwindef", feature = "winnt", feature = "winternl"))]
pub type PLSA_UPDATE_PRIMARY_CREDENTIALS = Option<unsafe extern "system" fn(primarycredentials: PSECPKG_PRIMARY_CRED, credentials: PSECPKG_SUPPLEMENTAL_CRED_ARRAY) -> windows_sys::core::NTSTATUS>;
...
pub type PSAM_CREDENTIAL_UPDATE_NOTIFY_ROUTINE = Option<unsafe extern "C" fn(clearpassword: super::PUNICODE_STRING, oldcredentials: *const core::ffi::c_void, oldcredentialsize: u32, useraccountcontrol: u32, upn: super::PUNICODE_STRING, username: super::PUNICODE_STRING, netbiosdomainname: super::PUNICODE_STRING, dnsdomainname: super::PUNICODE_STRING, newcredentials: *mut *mut core::ffi::c_void, newcredentialsize: *mut u32) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
pub type PSAM_CREDENTIAL_UPDATE_REGISTER_MAPPED_ENTRYPOINTS_ROUTINE = Option<unsafe extern "C" fn(table: *mut SAM_REGISTER_MAPPING_TABLE) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
...
#[cfg(all(feature = "lsalookup", feature = "minwindef", feature = "ntsecapi", feature = "winnt", feature = "winternl"))]
pub type SpAcceptCredentialsFn = Option<unsafe extern "system" fn(logontype: super::SECURITY_LOGON_TYPE, accountname: super::PUNICODE_STRING, primarycredentials: PSECPKG_PRIMARY_CRED, supplementalcredentials: PSECPKG_SUPPLEMENTAL_CRED) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "sspi", feature = "winnt"))]
pub type SpAcceptLsaModeContextFn = Option<unsafe extern "system" fn(credentialhandle: LSA_SEC_HANDLE, contexthandle: LSA_SEC_HANDLE, inputbuffer: super::PSecBufferDesc, contextrequirements: u32, targetdatarep: u32, newcontexthandle: PLSA_SEC_HANDLE, outputbuffer: super::PSecBufferDesc, contextattributes: super::PULONG, expirationtime: super::PTimeStamp, mappedcontext: super::PBOOLEAN, contextdata: super::PSecBuffer) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "sspi", feature = "winnt"))]
pub type SpAcquireCredentialsHandleFn = Option<unsafe extern "system" fn(principalname: super::PUNICODE_STRING, credentialuseflags: u32, logonid: super::PLUID, authorizationdata: *const core::ffi::c_void, getkeyfunciton: *const core::ffi::c_void, getkeyargument: *const core::ffi::c_void, credentialhandle: PLSA_SEC_HANDLE, expirationtime: super::PTimeStamp) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "sspi", feature = "winnt"))]
pub type SpAddCredentialsFn = Option<unsafe extern "system" fn(credentialhandle: LSA_SEC_HANDLE, principalname: super::PUNICODE_STRING, package: super::PUNICODE_STRING, credentialuseflags: u32, authorizationdata: *const core::ffi::c_void, getkeyfunciton: *const core::ffi::c_void, getkeyargument: *const core::ffi::c_void, expirationtime: super::PTimeStamp) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "sspi")]
pub type SpApplyControlTokenFn = Option<unsafe extern "system" fn(contexthandle: LSA_SEC_HANDLE, controltoken: super::PSecBufferDesc) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "sspi", feature = "winnt"))]
pub type SpChangeAccountPasswordFn = Option<unsafe extern "system" fn(pdomainname: super::PUNICODE_STRING, paccountname: super::PUNICODE_STRING, poldpassword: super::PUNICODE_STRING, pnewpassword: super::PUNICODE_STRING, impersonating: super::BOOLEAN, poutput: super::PSecBufferDesc) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "sspi")]
pub type SpCompleteAuthTokenFn = Option<unsafe extern "system" fn(contexthandle: LSA_SEC_HANDLE, inputbuffer: super::PSecBufferDesc) -> windows_sys::core::NTSTATUS>;
pub type SpDeleteContextFn = Option<unsafe extern "system" fn(contexthandle: LSA_SEC_HANDLE) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "sspi")]
pub type SpDeleteCredentialsFn = Option<unsafe extern "system" fn(credentialhandle: LSA_SEC_HANDLE, key: super::PSecBuffer) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "lsalookup", feature = "minwindef", feature = "ntsecapi"))]
pub type SpExchangeMetaDataFn = Option<unsafe extern "system" fn(credentialhandle: LSA_SEC_HANDLE, targetname: super::PUNICODE_STRING, contextrequirements: u32, metadatalength: u32, metadata: super::PUCHAR, contexthandle: PLSA_SEC_HANDLE) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "sspi", feature = "winnt"))]
pub type SpExportSecurityContextFn = Option<unsafe extern "system" fn(phcontext: LSA_SEC_HANDLE, fflags: u32, ppackedcontext: super::PSecBuffer, ptoken: super::PHANDLE) -> windows_sys::core::NTSTATUS>;
pub type SpExtractTargetInfoFn = Option<unsafe extern "system" fn(clientrequest: PLSA_CLIENT_REQUEST, protocolsubmitbuffer: *const core::ffi::c_void, clientbufferbase: *const core::ffi::c_void, submitbufferlength: u32, ppvtargetinfo: *mut *mut core::ffi::c_void, pcbtargetinfo: *mut u32) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "sspi")]
pub type SpFormatCredentialsFn = Option<unsafe extern "system" fn(credentials: super::PSecBuffer, formattedcredentials: super::PSecBuffer) -> windows_sys::core::NTSTATUS>;
...
#[cfg(feature = "winnt")]
pub type SpGetContextTokenFn = Option<unsafe extern "system" fn(contexthandle: LSA_SEC_HANDLE, impersonationtoken: super::PHANDLE) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type SpGetCredUIContextFn = Option<unsafe extern "system" fn(contexthandle: LSA_SEC_HANDLE, credtype: *const windows_sys::core::GUID, flatcreduicontextlength: super::PULONG, flatcreduicontext: *mut super::PUCHAR) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "sspi")]
pub type SpGetCredentialsFn = Option<unsafe extern "system" fn(credentialhandle: LSA_SEC_HANDLE, credentials: super::PSecBuffer) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "sspi")]
...
#[cfg(feature = "sspi")]
pub type SpGetInfoFn = Option<unsafe extern "system" fn(packageinfo: super::PSecPkgInfoA) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "winnt", feature = "winternl"))]
...
#[cfg(all(feature = "minwindef", feature = "winnt", feature = "winternl"))]
pub type SpGetRemoteCredGuardSupplementalCredsFn = Option<unsafe extern "system" fn(credhandle: LSA_SEC_HANDLE, targetname: *const super::UNICODE_STRING, redirectedlogonhandle: super::PHANDLE, callback: *mut PLSA_REDIRECTED_LOGON_CALLBACK, cleanupcallback: *mut PLSA_REDIRECTED_LOGON_CLEANUP_CALLBACK, supplementalcredssize: super::PULONG, supplementalcreds: *mut *mut core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type SpGetTbalSupplementalCredsFn = Option<unsafe extern "system" fn(logonid: super::LUID, supplementalcredssize: super::PULONG, supplementalcreds: *mut *mut core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "sspi", feature = "winnt"))]
pub type SpGetUserInfoFn = Option<unsafe extern "system" fn(logonid: super::PLUID, flags: u32, userdata: *mut PSecurityUserData) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "sspi", feature = "winnt"))]
pub type SpImportSecurityContextFn = Option<unsafe extern "system" fn(ppackedcontext: super::PSecBuffer, token: super::HANDLE, phcontext: PLSA_SEC_HANDLE) -> windows_sys::core::NTSTATUS>;
...
#[cfg(feature = "sspi")]
pub type SpInitUserModeContextFn = Option<unsafe extern "system" fn(contexthandle: LSA_SEC_HANDLE, packedcontext: super::PSecBuffer) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "basetsd", feature = "bcrypt", feature = "lsalookup", feature = "minwinbase", feature = "minwindef", feature = "ntsecapi", feature = "sspi", feature = "winnt", feature = "winternl"))]
pub type SpInitializeFn = Option<unsafe extern "system" fn(packageid: usize, parameters: PSECPKG_PARAMETERS, functiontable: PLSA_SECPKG_FUNCTION_TABLE) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "sspi")]
pub type SpInstanceInitFn = Option<unsafe extern "system" fn(version: u32, functiontable: PSECPKG_DLL_FUNCTIONS, userfunctions: *mut *mut core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "basetsd", feature = "bcrypt", feature = "lsalookup", feature = "minwinbase", feature = "minwindef", feature = "ntsecapi", feature = "sspi", feature = "winnt", feature = "winternl"))]
pub type SpLsaModeInitializeFn = Option<unsafe extern "system" fn(lsaversion: u32, packageversion: super::PULONG, pptables: *mut PSECPKG_FUNCTION_TABLE, pctables: super::PULONG) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "sspi")]
pub type SpMakeSignatureFn = Option<unsafe extern "system" fn(contexthandle: LSA_SEC_HANDLE, qualityofprotection: u32, messagebuffers: super::PSecBufferDesc, messagesequencenumber: u32) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type SpMarshalAttributeDataFn = Option<unsafe extern "system" fn(attributeinfo: u32, attribute: u32, attributedatasize: u32, attributedata: super::PBYTE, marshaledattributedatasize: super::PULONG, marshaledattributedata: *mut super::PBYTE) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type SpMarshallSupplementalCredsFn = Option<unsafe extern "system" fn(credentialsize: u32, credentials: super::PUCHAR, marshalledcredsize: super::PULONG, marshalledcreds: *mut *mut core::ffi::c_void) -> windows_sys::core::NTSTATUS>;
...
#[cfg(all(feature = "lsalookup", feature = "minwindef", feature = "ntsecapi"))]
pub type SpQueryMetaDataFn = Option<unsafe extern "system" fn(credentialhandle: LSA_SEC_HANDLE, targetname: super::PUNICODE_STRING, contextrequirements: u32, metadatalength: super::PULONG, metadata: *mut super::PUCHAR, contexthandle: PLSA_SEC_HANDLE) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "sspi")]
pub type SpSaveCredentialsFn = Option<unsafe extern "system" fn(credentialhandle: LSA_SEC_HANDLE, credentials: super::PSecBuffer) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "sspi")]
pub type SpSealMessageFn = Option<unsafe extern "system" fn(contexthandle: LSA_SEC_HANDLE, qualityofprotection: u32, messagebuffers: super::PSecBufferDesc, messagesequencenumber: u32) -> windows_sys::core::NTSTATUS>;
...
#[cfg(feature = "sspi")]
pub type SpSetExtendedInformationFn = Option<unsafe extern "system" fn(class: SECPKG_EXTENDED_INFORMATION_CLASS, info: PSECPKG_EXTENDED_INFORMATION) -> windows_sys::core::NTSTATUS>;
pub type SpShutdownFn = Option<unsafe extern "system" fn() -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "sspi"))]
pub type SpUnsealMessageFn = Option<unsafe extern "system" fn(contexthandle: LSA_SEC_HANDLE, messagebuffers: super::PSecBufferDesc, messagesequencenumber: u32, qualityofprotection: super::PULONG) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type SpUpdateCredentialsFn = Option<unsafe extern "system" fn(contexthandle: LSA_SEC_HANDLE, credtype: *const windows_sys::core::GUID, flatcreduicontextlength: u32, flatcreduicontext: super::PUCHAR) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "sspi", feature = "winnt"))]
pub type SpUserModeInitializeFn = Option<unsafe extern "system" fn(lsaversion: u32, packageversion: super::PULONG, pptables: *mut PSECPKG_USER_FUNCTION_TABLE, pctables: super::PULONG) -> windows_sys::core::NTSTATUS>;
#[cfg(feature = "winnt")]
pub type SpValidateTargetInfoFn = Option<unsafe extern "system" fn(clientrequest: PLSA_CLIENT_REQUEST, protocolsubmitbuffer: *const core::ffi::c_void, clientbufferbase: *const core::ffi::c_void, submitbufferlength: u32, targetinfo: PSECPKG_TARGETINFO) -> windows_sys::core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "sspi"))]
pub type SpVerifySignatureFn = Option<unsafe extern "system" fn(contexthandle: LSA_SEC_HANDLE, messagebuffers: super::PSecBufferDesc, messagesequencenumber: u32, qualityofprotection: super::PULONG) -> windows_sys::core::NTSTATUS>;
