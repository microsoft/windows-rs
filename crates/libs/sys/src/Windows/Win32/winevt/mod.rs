...
#[cfg(feature = "winnt")]
windows_link::link!("wevtapi.dll" "system" fn EvtNext(resultset : EVT_HANDLE, eventssize : u32, events : *mut super::HANDLE, timeout : u32, flags : u32, returned : *mut u32) -> windows_sys::core::BOOL);
#[cfg(feature = "winnt")]
