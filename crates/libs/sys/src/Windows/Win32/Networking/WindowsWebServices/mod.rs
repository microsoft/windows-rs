pub type WsAbandonCall = unsafe extern "system" fn(serviceproxy: *const WS_SERVICE_PROXY, callid: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsAbandonMessage = unsafe extern "system" fn(channel: *const WS_CHANNEL, message: *const WS_MESSAGE, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsAbortChannel = unsafe extern "system" fn(channel: *const WS_CHANNEL, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsAbortListener = unsafe extern "system" fn(listener: *const WS_LISTENER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsAbortServiceHost = unsafe extern "system" fn(servicehost: *const WS_SERVICE_HOST, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsAbortServiceProxy = unsafe extern "system" fn(serviceproxy: *const WS_SERVICE_PROXY, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsAcceptChannel = unsafe extern "system" fn(listener: *const WS_LISTENER, channel: *const WS_CHANNEL, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsAddCustomHeader = unsafe extern "system" fn(message: *const WS_MESSAGE, headerdescription: *const WS_ELEMENT_DESCRIPTION, writeoption: WS_WRITE_OPTION, value: *const core::ffi::c_void, valuesize: u32, headerattributes: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsAddErrorString = unsafe extern "system" fn(error: *const WS_ERROR, string: *const WS_STRING) -> windows_sys::core::HRESULT;
...
pub type WsAddMappedHeader = unsafe extern "system" fn(message: *const WS_MESSAGE, headername: *const WS_XML_STRING, valuetype: WS_TYPE, writeoption: WS_WRITE_OPTION, value: *const core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsAddressMessage = unsafe extern "system" fn(message: *const WS_MESSAGE, address: *const WS_ENDPOINT_ADDRESS, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsAlloc = unsafe extern "system" fn(heap: *const WS_HEAP, size: usize, ptr: *mut *mut core::ffi::c_void, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsAsyncExecute = unsafe extern "system" fn(asyncstate: *const WS_ASYNC_STATE, operation: WS_ASYNC_FUNCTION, callbackmodel: WS_CALLBACK_MODEL, callbackstate: *const core::ffi::c_void, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCheckMustUnderstandHeaders = unsafe extern "system" fn(message: *const WS_MESSAGE, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCloseChannel = unsafe extern "system" fn(channel: *const WS_CHANNEL, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCloseListener = unsafe extern "system" fn(listener: *const WS_LISTENER, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCloseServiceHost = unsafe extern "system" fn(servicehost: *const WS_SERVICE_HOST, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCloseServiceProxy = unsafe extern "system" fn(serviceproxy: *const WS_SERVICE_PROXY, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCombineUrl = unsafe extern "system" fn(baseurl: *const WS_STRING, referenceurl: *const WS_STRING, flags: u32, heap: *const WS_HEAP, resulturl: *mut WS_STRING, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCopyError = unsafe extern "system" fn(source: *const WS_ERROR, destination: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCopyNode = unsafe extern "system" fn(writer: *const WS_XML_WRITER, reader: *const WS_XML_READER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCreateChannel = unsafe extern "system" fn(channeltype: WS_CHANNEL_TYPE, channelbinding: WS_CHANNEL_BINDING, properties: *const WS_CHANNEL_PROPERTY, propertycount: u32, securitydescription: *const WS_SECURITY_DESCRIPTION, channel: *mut *mut WS_CHANNEL, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCreateChannelForListener = unsafe extern "system" fn(listener: *const WS_LISTENER, properties: *const WS_CHANNEL_PROPERTY, propertycount: u32, channel: *mut *mut WS_CHANNEL, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCreateError = unsafe extern "system" fn(properties: *const WS_ERROR_PROPERTY, propertycount: u32, error: *mut *mut WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCreateFaultFromError = unsafe extern "system" fn(error: *const WS_ERROR, faulterrorcode: windows_sys::core::HRESULT, faultdisclosure: WS_FAULT_DISCLOSURE, heap: *const WS_HEAP, fault: *mut WS_FAULT) -> windows_sys::core::HRESULT;
...
pub type WsCreateHeap = unsafe extern "system" fn(maxsize: usize, trimsize: usize, properties: *const WS_HEAP_PROPERTY, propertycount: u32, heap: *mut *mut WS_HEAP, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCreateListener = unsafe extern "system" fn(channeltype: WS_CHANNEL_TYPE, channelbinding: WS_CHANNEL_BINDING, properties: *const WS_LISTENER_PROPERTY, propertycount: u32, securitydescription: *const WS_SECURITY_DESCRIPTION, listener: *mut *mut WS_LISTENER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCreateMessage = unsafe extern "system" fn(envelopeversion: WS_ENVELOPE_VERSION, addressingversion: WS_ADDRESSING_VERSION, properties: *const WS_MESSAGE_PROPERTY, propertycount: u32, message: *mut *mut WS_MESSAGE, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCreateMessageForChannel = unsafe extern "system" fn(channel: *const WS_CHANNEL, properties: *const WS_MESSAGE_PROPERTY, propertycount: u32, message: *mut *mut WS_MESSAGE, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCreateMetadata = unsafe extern "system" fn(properties: *const WS_METADATA_PROPERTY, propertycount: u32, metadata: *mut *mut WS_METADATA, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCreateReader = unsafe extern "system" fn(properties: *const WS_XML_READER_PROPERTY, propertycount: u32, reader: *mut *mut WS_XML_READER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCreateServiceHost = unsafe extern "system" fn(endpoints: *const *const WS_SERVICE_ENDPOINT, endpointcount: u16, serviceproperties: *const WS_SERVICE_PROPERTY, servicepropertycount: u32, servicehost: *mut *mut WS_SERVICE_HOST, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCreateServiceProxyFromTemplate = unsafe extern "system" fn(channeltype: WS_CHANNEL_TYPE, properties: *const WS_PROXY_PROPERTY, propertycount: u32, templatetype: WS_BINDING_TEMPLATE_TYPE, templatevalue: *const core::ffi::c_void, templatesize: u32, templatedescription: *const core::ffi::c_void, templatedescriptionsize: u32, serviceproxy: *mut *mut WS_SERVICE_PROXY, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCreateWriter = unsafe extern "system" fn(properties: *const WS_XML_WRITER_PROPERTY, propertycount: u32, writer: *mut *mut WS_XML_WRITER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCreateXmlBuffer = unsafe extern "system" fn(heap: *const WS_HEAP, properties: *const WS_XML_BUFFER_PROPERTY, propertycount: u32, buffer: *mut *mut WS_XML_BUFFER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsCreateXmlSecurityToken = unsafe extern "system" fn(tokenxml: *const WS_XML_BUFFER, tokenkey: *const WS_SECURITY_KEY_HANDLE, properties: *const WS_XML_SECURITY_TOKEN_PROPERTY, propertycount: u32, token: *mut *mut WS_SECURITY_TOKEN, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsDateTimeToFileTime = unsafe extern "system" fn(datetime: *const WS_DATETIME, filetime: *mut super::super::Foundation::FILETIME, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsDecodeUrl = unsafe extern "system" fn(url: *const WS_STRING, flags: u32, heap: *const WS_HEAP, outurl: *mut *mut WS_URL, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsEncodeUrl = unsafe extern "system" fn(url: *const WS_URL, flags: u32, heap: *const WS_HEAP, outurl: *mut WS_STRING, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsEndReaderCanonicalization = unsafe extern "system" fn(reader: *const WS_XML_READER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsEndWriterCanonicalization = unsafe extern "system" fn(writer: *const WS_XML_WRITER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsFileTimeToDateTime = unsafe extern "system" fn(filetime: *const super::super::Foundation::FILETIME, datetime: *mut WS_DATETIME, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsFillBody = unsafe extern "system" fn(message: *const WS_MESSAGE, minsize: u32, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsFillReader = unsafe extern "system" fn(reader: *const WS_XML_READER, minsize: u32, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsFindAttribute = unsafe extern "system" fn(reader: *const WS_XML_READER, localname: *const WS_XML_STRING, ns: *const WS_XML_STRING, required: windows_sys::core::BOOL, attributeindex: *mut u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsFlushBody = unsafe extern "system" fn(message: *const WS_MESSAGE, minsize: u32, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsFlushWriter = unsafe extern "system" fn(writer: *const WS_XML_WRITER, minsize: u32, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsFreeChannel = unsafe extern "system" fn(channel: *const WS_CHANNEL);
windows_link::link!("webservices.dll" "system" fn WsFreeChannel(channel : *const WS_CHANNEL));
pub type WsFreeError = unsafe extern "system" fn(error: *const WS_ERROR);
windows_link::link!("webservices.dll" "system" fn WsFreeError(error : *const WS_ERROR));
pub type WsFreeHeap = unsafe extern "system" fn(heap: *const WS_HEAP);
windows_link::link!("webservices.dll" "system" fn WsFreeHeap(heap : *const WS_HEAP));
pub type WsFreeListener = unsafe extern "system" fn(listener: *const WS_LISTENER);
windows_link::link!("webservices.dll" "system" fn WsFreeListener(listener : *const WS_LISTENER));
pub type WsFreeMessage = unsafe extern "system" fn(message: *const WS_MESSAGE);
windows_link::link!("webservices.dll" "system" fn WsFreeMessage(message : *const WS_MESSAGE));
pub type WsFreeMetadata = unsafe extern "system" fn(metadata: *const WS_METADATA);
windows_link::link!("webservices.dll" "system" fn WsFreeMetadata(metadata : *const WS_METADATA));
pub type WsFreeReader = unsafe extern "system" fn(reader: *const WS_XML_READER);
windows_link::link!("webservices.dll" "system" fn WsFreeReader(reader : *const WS_XML_READER));
pub type WsFreeSecurityToken = unsafe extern "system" fn(token: *const WS_SECURITY_TOKEN);
windows_link::link!("webservices.dll" "system" fn WsFreeSecurityToken(token : *const WS_SECURITY_TOKEN));
pub type WsFreeServiceHost = unsafe extern "system" fn(servicehost: *const WS_SERVICE_HOST);
windows_link::link!("webservices.dll" "system" fn WsFreeServiceHost(servicehost : *const WS_SERVICE_HOST));
pub type WsFreeServiceProxy = unsafe extern "system" fn(serviceproxy: *const WS_SERVICE_PROXY);
windows_link::link!("webservices.dll" "system" fn WsFreeServiceProxy(serviceproxy : *const WS_SERVICE_PROXY));
pub type WsFreeWriter = unsafe extern "system" fn(writer: *const WS_XML_WRITER);
windows_link::link!("webservices.dll" "system" fn WsFreeWriter(writer : *const WS_XML_WRITER));
pub type WsGetChannelProperty = unsafe extern "system" fn(channel: *const WS_CHANNEL, id: WS_CHANNEL_PROPERTY_ID, value: *mut core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetDictionary = unsafe extern "system" fn(encoding: WS_ENCODING, dictionary: *mut *mut WS_XML_DICTIONARY, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetErrorProperty = unsafe extern "system" fn(error: *const WS_ERROR, id: WS_ERROR_PROPERTY_ID, buffer: *mut core::ffi::c_void, buffersize: u32) -> windows_sys::core::HRESULT;
...
pub type WsGetErrorString = unsafe extern "system" fn(error: *const WS_ERROR, index: u32, string: *mut WS_STRING) -> windows_sys::core::HRESULT;
...
pub type WsGetFaultErrorDetail = unsafe extern "system" fn(error: *const WS_ERROR, faultdetaildescription: *const WS_FAULT_DETAIL_DESCRIPTION, readoption: WS_READ_OPTION, heap: *const WS_HEAP, value: *mut core::ffi::c_void, valuesize: u32) -> windows_sys::core::HRESULT;
...
pub type WsGetFaultErrorProperty = unsafe extern "system" fn(error: *const WS_ERROR, id: WS_FAULT_ERROR_PROPERTY_ID, buffer: *mut core::ffi::c_void, buffersize: u32) -> windows_sys::core::HRESULT;
...
pub type WsGetHeader = unsafe extern "system" fn(message: *const WS_MESSAGE, headertype: WS_HEADER_TYPE, valuetype: WS_TYPE, readoption: WS_READ_OPTION, heap: *const WS_HEAP, value: *mut core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetHeaderAttributes = unsafe extern "system" fn(message: *const WS_MESSAGE, reader: *const WS_XML_READER, headerattributes: *mut u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetHeapProperty = unsafe extern "system" fn(heap: *const WS_HEAP, id: WS_HEAP_PROPERTY_ID, value: *mut core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetListenerProperty = unsafe extern "system" fn(listener: *const WS_LISTENER, id: WS_LISTENER_PROPERTY_ID, value: *mut core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetMetadataEndpoints = unsafe extern "system" fn(metadata: *const WS_METADATA, endpoints: *mut WS_METADATA_ENDPOINTS, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetMetadataProperty = unsafe extern "system" fn(metadata: *const WS_METADATA, id: WS_METADATA_PROPERTY_ID, value: *mut core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetMissingMetadataDocumentAddress = unsafe extern "system" fn(metadata: *const WS_METADATA, address: *mut *mut WS_ENDPOINT_ADDRESS, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetNamespaceFromPrefix = unsafe extern "system" fn(reader: *const WS_XML_READER, prefix: *const WS_XML_STRING, required: windows_sys::core::BOOL, ns: *mut *mut WS_XML_STRING, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetOperationContextProperty = unsafe extern "system" fn(context: *const WS_OPERATION_CONTEXT, id: WS_OPERATION_CONTEXT_PROPERTY_ID, value: *mut core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetPolicyAlternativeCount = unsafe extern "system" fn(policy: *const WS_POLICY, count: *mut u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetPolicyProperty = unsafe extern "system" fn(policy: *const WS_POLICY, id: WS_POLICY_PROPERTY_ID, value: *mut core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetPrefixFromNamespace = unsafe extern "system" fn(writer: *const WS_XML_WRITER, ns: *const WS_XML_STRING, required: windows_sys::core::BOOL, prefix: *mut *mut WS_XML_STRING, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetReaderNode = unsafe extern "system" fn(xmlreader: *const WS_XML_READER, node: *mut *mut WS_XML_NODE, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetReaderPosition = unsafe extern "system" fn(reader: *const WS_XML_READER, nodeposition: *mut WS_XML_NODE_POSITION, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetReaderProperty = unsafe extern "system" fn(reader: *const WS_XML_READER, id: WS_XML_READER_PROPERTY_ID, value: *mut core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetSecurityContextProperty = unsafe extern "system" fn(securitycontext: *const WS_SECURITY_CONTEXT, id: WS_SECURITY_CONTEXT_PROPERTY_ID, value: *mut core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetSecurityTokenProperty = unsafe extern "system" fn(securitytoken: *const WS_SECURITY_TOKEN, id: WS_SECURITY_TOKEN_PROPERTY_ID, value: *mut core::ffi::c_void, valuesize: u32, heap: *const WS_HEAP, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetServiceHostProperty = unsafe extern "system" fn(servicehost: *const WS_SERVICE_HOST, id: WS_SERVICE_PROPERTY_ID, value: *mut core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetServiceProxyProperty = unsafe extern "system" fn(serviceproxy: *const WS_SERVICE_PROXY, id: WS_PROXY_PROPERTY_ID, value: *mut core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetWriterPosition = unsafe extern "system" fn(writer: *const WS_XML_WRITER, nodeposition: *mut WS_XML_NODE_POSITION, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetWriterProperty = unsafe extern "system" fn(writer: *const WS_XML_WRITER, id: WS_XML_WRITER_PROPERTY_ID, value: *mut core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsGetXmlAttribute = unsafe extern "system" fn(reader: *const WS_XML_READER, localname: *const WS_XML_STRING, heap: *const WS_HEAP, valuechars: *mut *mut u16, valuecharcount: *mut u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsInitializeMessage = unsafe extern "system" fn(message: *const WS_MESSAGE, initialization: WS_MESSAGE_INITIALIZATION, sourcemessage: *const WS_MESSAGE, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsMarkHeaderAsUnderstood = unsafe extern "system" fn(message: *const WS_MESSAGE, headerposition: *const WS_XML_NODE_POSITION, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsMatchPolicyAlternative = unsafe extern "system" fn(policy: *const WS_POLICY, alternativeindex: u32, policyconstraints: *const WS_POLICY_CONSTRAINTS, matchrequired: windows_sys::core::BOOL, heap: *const WS_HEAP, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsMoveReader = unsafe extern "system" fn(reader: *const WS_XML_READER, moveto: WS_MOVE_TO, found: *mut windows_sys::core::BOOL, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsMoveWriter = unsafe extern "system" fn(writer: *const WS_XML_WRITER, moveto: WS_MOVE_TO, found: *mut windows_sys::core::BOOL, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsOpenChannel = unsafe extern "system" fn(channel: *const WS_CHANNEL, endpointaddress: *const WS_ENDPOINT_ADDRESS, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsOpenListener = unsafe extern "system" fn(listener: *const WS_LISTENER, url: *const WS_STRING, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsOpenServiceHost = unsafe extern "system" fn(servicehost: *const WS_SERVICE_HOST, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsOpenServiceProxy = unsafe extern "system" fn(serviceproxy: *const WS_SERVICE_PROXY, address: *const WS_ENDPOINT_ADDRESS, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsPullBytes = unsafe extern "system" fn(writer: *const WS_XML_WRITER, callback: WS_PULL_BYTES_CALLBACK, callbackstate: *const core::ffi::c_void, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsPushBytes = unsafe extern "system" fn(writer: *const WS_XML_WRITER, callback: WS_PUSH_BYTES_CALLBACK, callbackstate: *const core::ffi::c_void, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadArray = unsafe extern "system" fn(reader: *const WS_XML_READER, localname: *const WS_XML_STRING, ns: *const WS_XML_STRING, valuetype: WS_VALUE_TYPE, array: *mut core::ffi::c_void, arraysize: u32, itemoffset: u32, itemcount: u32, actualitemcount: *mut u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadAttribute = unsafe extern "system" fn(reader: *const WS_XML_READER, attributedescription: *const WS_ATTRIBUTE_DESCRIPTION, readoption: WS_READ_OPTION, heap: *const WS_HEAP, value: *mut core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadBody = unsafe extern "system" fn(message: *const WS_MESSAGE, bodydescription: *const WS_ELEMENT_DESCRIPTION, readoption: WS_READ_OPTION, heap: *const WS_HEAP, value: *mut core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadBytes = unsafe extern "system" fn(reader: *const WS_XML_READER, bytes: *mut core::ffi::c_void, maxbytecount: u32, actualbytecount: *mut u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadChars = unsafe extern "system" fn(reader: *const WS_XML_READER, chars: windows_sys::core::PWSTR, maxcharcount: u32, actualcharcount: *mut u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadCharsUtf8 = unsafe extern "system" fn(reader: *const WS_XML_READER, bytes: *mut u8, maxbytecount: u32, actualbytecount: *mut u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadElement = unsafe extern "system" fn(reader: *const WS_XML_READER, elementdescription: *const WS_ELEMENT_DESCRIPTION, readoption: WS_READ_OPTION, heap: *const WS_HEAP, value: *mut core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadEndAttribute = unsafe extern "system" fn(reader: *const WS_XML_READER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadEndElement = unsafe extern "system" fn(reader: *const WS_XML_READER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadEnvelopeStart = unsafe extern "system" fn(message: *const WS_MESSAGE, reader: *const WS_XML_READER, donecallback: WS_MESSAGE_DONE_CALLBACK, donecallbackstate: *const core::ffi::c_void, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadMessageEnd = unsafe extern "system" fn(channel: *const WS_CHANNEL, message: *const WS_MESSAGE, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadMessageStart = unsafe extern "system" fn(channel: *const WS_CHANNEL, message: *const WS_MESSAGE, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadMetadata = unsafe extern "system" fn(metadata: *const WS_METADATA, reader: *const WS_XML_READER, url: *const WS_STRING, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadNode = unsafe extern "system" fn(reader: *const WS_XML_READER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadQualifiedName = unsafe extern "system" fn(reader: *const WS_XML_READER, heap: *const WS_HEAP, prefix: *mut WS_XML_STRING, localname: *mut WS_XML_STRING, ns: *mut WS_XML_STRING, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadStartAttribute = unsafe extern "system" fn(reader: *const WS_XML_READER, attributeindex: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadStartElement = unsafe extern "system" fn(reader: *const WS_XML_READER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadToStartElement = unsafe extern "system" fn(reader: *const WS_XML_READER, localname: *const WS_XML_STRING, ns: *const WS_XML_STRING, found: *mut windows_sys::core::BOOL, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadType = unsafe extern "system" fn(reader: *const WS_XML_READER, typemapping: WS_TYPE_MAPPING, r#type: WS_TYPE, typedescription: *const core::ffi::c_void, readoption: WS_READ_OPTION, heap: *const WS_HEAP, value: *mut core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadValue = unsafe extern "system" fn(reader: *const WS_XML_READER, valuetype: WS_VALUE_TYPE, value: *mut core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadXmlBuffer = unsafe extern "system" fn(reader: *const WS_XML_READER, heap: *const WS_HEAP, xmlbuffer: *mut *mut WS_XML_BUFFER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReadXmlBufferFromBytes = unsafe extern "system" fn(reader: *const WS_XML_READER, encoding: *const WS_XML_READER_ENCODING, properties: *const WS_XML_READER_PROPERTY, propertycount: u32, bytes: *const core::ffi::c_void, bytecount: u32, heap: *const WS_HEAP, xmlbuffer: *mut *mut WS_XML_BUFFER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsReceiveMessage = unsafe extern "system" fn(channel: *const WS_CHANNEL, message: *const WS_MESSAGE, messagedescriptions: *const *const WS_MESSAGE_DESCRIPTION, messagedescriptioncount: u32, receiveoption: WS_RECEIVE_OPTION, readbodyoption: WS_READ_OPTION, heap: *const WS_HEAP, value: *mut core::ffi::c_void, valuesize: u32, index: *mut u32, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsRegisterOperationForCancel = unsafe extern "system" fn(context: *const WS_OPERATION_CONTEXT, cancelcallback: WS_OPERATION_CANCEL_CALLBACK, freestatecallback: WS_OPERATION_FREE_STATE_CALLBACK, userstate: *const core::ffi::c_void, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsRemoveCustomHeader = unsafe extern "system" fn(message: *const WS_MESSAGE, headername: *const WS_XML_STRING, headerns: *const WS_XML_STRING, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsRemoveHeader = unsafe extern "system" fn(message: *const WS_MESSAGE, headertype: WS_HEADER_TYPE, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsRemoveMappedHeader = unsafe extern "system" fn(message: *const WS_MESSAGE, headername: *const WS_XML_STRING, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsRemoveNode = unsafe extern "system" fn(nodeposition: *const WS_XML_NODE_POSITION, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsRequestReply = unsafe extern "system" fn(channel: *const WS_CHANNEL, requestmessage: *const WS_MESSAGE, requestmessagedescription: *const WS_MESSAGE_DESCRIPTION, writeoption: WS_WRITE_OPTION, requestbodyvalue: *const core::ffi::c_void, requestbodyvaluesize: u32, replymessage: *const WS_MESSAGE, replymessagedescription: *const WS_MESSAGE_DESCRIPTION, readoption: WS_READ_OPTION, heap: *const WS_HEAP, value: *mut core::ffi::c_void, valuesize: u32, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsRequestSecurityToken = unsafe extern "system" fn(channel: *const WS_CHANNEL, properties: *const WS_REQUEST_SECURITY_TOKEN_PROPERTY, propertycount: u32, token: *mut *mut WS_SECURITY_TOKEN, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsResetChannel = unsafe extern "system" fn(channel: *const WS_CHANNEL, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsResetError = unsafe extern "system" fn(error: *const WS_ERROR) -> windows_sys::core::HRESULT;
windows_link::link!("webservices.dll" "system" fn WsResetError(error : *const WS_ERROR) -> windows_sys::core::HRESULT);
pub type WsResetHeap = unsafe extern "system" fn(heap: *const WS_HEAP, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
windows_link::link!("webservices.dll" "system" fn WsResetHeap(heap : *const WS_HEAP, error : *const WS_ERROR) -> windows_sys::core::HRESULT);
pub type WsResetListener = unsafe extern "system" fn(listener: *const WS_LISTENER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsResetMessage = unsafe extern "system" fn(message: *const WS_MESSAGE, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsResetMetadata = unsafe extern "system" fn(metadata: *const WS_METADATA, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsResetServiceHost = unsafe extern "system" fn(servicehost: *const WS_SERVICE_HOST, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsResetServiceProxy = unsafe extern "system" fn(serviceproxy: *const WS_SERVICE_PROXY, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsRevokeSecurityContext = unsafe extern "system" fn(securitycontext: *const WS_SECURITY_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsSendFaultMessageForError = unsafe extern "system" fn(channel: *const WS_CHANNEL, replymessage: *const WS_MESSAGE, faulterror: *const WS_ERROR, faulterrorcode: windows_sys::core::HRESULT, faultdisclosure: WS_FAULT_DISCLOSURE, requestmessage: *const WS_MESSAGE, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsSendMessage = unsafe extern "system" fn(channel: *const WS_CHANNEL, message: *const WS_MESSAGE, messagedescription: *const WS_MESSAGE_DESCRIPTION, writeoption: WS_WRITE_OPTION, bodyvalue: *const core::ffi::c_void, bodyvaluesize: u32, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsSendReplyMessage = unsafe extern "system" fn(channel: *const WS_CHANNEL, replymessage: *const WS_MESSAGE, replymessagedescription: *const WS_MESSAGE_DESCRIPTION, writeoption: WS_WRITE_OPTION, replybodyvalue: *const core::ffi::c_void, replybodyvaluesize: u32, requestmessage: *const WS_MESSAGE, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsSetChannelProperty = unsafe extern "system" fn(channel: *const WS_CHANNEL, id: WS_CHANNEL_PROPERTY_ID, value: *const core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsSetErrorProperty = unsafe extern "system" fn(error: *const WS_ERROR, id: WS_ERROR_PROPERTY_ID, value: *const core::ffi::c_void, valuesize: u32) -> windows_sys::core::HRESULT;
...
pub type WsSetFaultErrorDetail = unsafe extern "system" fn(error: *const WS_ERROR, faultdetaildescription: *const WS_FAULT_DETAIL_DESCRIPTION, writeoption: WS_WRITE_OPTION, value: *const core::ffi::c_void, valuesize: u32) -> windows_sys::core::HRESULT;
...
pub type WsSetFaultErrorProperty = unsafe extern "system" fn(error: *const WS_ERROR, id: WS_FAULT_ERROR_PROPERTY_ID, value: *const core::ffi::c_void, valuesize: u32) -> windows_sys::core::HRESULT;
...
pub type WsSetHeader = unsafe extern "system" fn(message: *const WS_MESSAGE, headertype: WS_HEADER_TYPE, valuetype: WS_TYPE, writeoption: WS_WRITE_OPTION, value: *const core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsSetInput = unsafe extern "system" fn(reader: *const WS_XML_READER, encoding: *const WS_XML_READER_ENCODING, input: *const WS_XML_READER_INPUT, properties: *const WS_XML_READER_PROPERTY, propertycount: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsSetInputToBuffer = unsafe extern "system" fn(reader: *const WS_XML_READER, buffer: *const WS_XML_BUFFER, properties: *const WS_XML_READER_PROPERTY, propertycount: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsSetListenerProperty = unsafe extern "system" fn(listener: *const WS_LISTENER, id: WS_LISTENER_PROPERTY_ID, value: *const core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsSetMessageProperty = unsafe extern "system" fn(message: *const WS_MESSAGE, id: WS_MESSAGE_PROPERTY_ID, value: *const core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsSetOutput = unsafe extern "system" fn(writer: *const WS_XML_WRITER, encoding: *const WS_XML_WRITER_ENCODING, output: *const WS_XML_WRITER_OUTPUT, properties: *const WS_XML_WRITER_PROPERTY, propertycount: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsSetOutputToBuffer = unsafe extern "system" fn(writer: *const WS_XML_WRITER, buffer: *const WS_XML_BUFFER, properties: *const WS_XML_WRITER_PROPERTY, propertycount: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsSetReaderPosition = unsafe extern "system" fn(reader: *const WS_XML_READER, nodeposition: *const WS_XML_NODE_POSITION, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsSetWriterPosition = unsafe extern "system" fn(writer: *const WS_XML_WRITER, nodeposition: *const WS_XML_NODE_POSITION, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsShutdownSessionChannel = unsafe extern "system" fn(channel: *const WS_CHANNEL, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsSkipNode = unsafe extern "system" fn(reader: *const WS_XML_READER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsStartReaderCanonicalization = unsafe extern "system" fn(reader: *const WS_XML_READER, writecallback: WS_WRITE_CALLBACK, writecallbackstate: *const core::ffi::c_void, properties: *const WS_XML_CANONICALIZATION_PROPERTY, propertycount: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsStartWriterCanonicalization = unsafe extern "system" fn(writer: *const WS_XML_WRITER, writecallback: WS_WRITE_CALLBACK, writecallbackstate: *const core::ffi::c_void, properties: *const WS_XML_CANONICALIZATION_PROPERTY, propertycount: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsTrimXmlWhitespace = unsafe extern "system" fn(chars: windows_sys::core::PCWSTR, charcount: u32, trimmedchars: *mut *mut u16, trimmedcount: *mut u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsVerifyXmlNCName = unsafe extern "system" fn(ncnamechars: windows_sys::core::PCWSTR, ncnamecharcount: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteArray = unsafe extern "system" fn(writer: *const WS_XML_WRITER, localname: *const WS_XML_STRING, ns: *const WS_XML_STRING, valuetype: WS_VALUE_TYPE, array: *const core::ffi::c_void, arraysize: u32, itemoffset: u32, itemcount: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteAttribute = unsafe extern "system" fn(writer: *const WS_XML_WRITER, attributedescription: *const WS_ATTRIBUTE_DESCRIPTION, writeoption: WS_WRITE_OPTION, value: *const core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteBody = unsafe extern "system" fn(message: *const WS_MESSAGE, bodydescription: *const WS_ELEMENT_DESCRIPTION, writeoption: WS_WRITE_OPTION, value: *const core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteBytes = unsafe extern "system" fn(writer: *const WS_XML_WRITER, bytes: *const core::ffi::c_void, bytecount: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteChars = unsafe extern "system" fn(writer: *const WS_XML_WRITER, chars: windows_sys::core::PCWSTR, charcount: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteCharsUtf8 = unsafe extern "system" fn(writer: *const WS_XML_WRITER, bytes: *const u8, bytecount: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteElement = unsafe extern "system" fn(writer: *const WS_XML_WRITER, elementdescription: *const WS_ELEMENT_DESCRIPTION, writeoption: WS_WRITE_OPTION, value: *const core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteEndAttribute = unsafe extern "system" fn(writer: *const WS_XML_WRITER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteEndCData = unsafe extern "system" fn(writer: *const WS_XML_WRITER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteEndElement = unsafe extern "system" fn(writer: *const WS_XML_WRITER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteEndStartElement = unsafe extern "system" fn(writer: *const WS_XML_WRITER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteEnvelopeEnd = unsafe extern "system" fn(message: *const WS_MESSAGE, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteEnvelopeStart = unsafe extern "system" fn(message: *const WS_MESSAGE, writer: *const WS_XML_WRITER, donecallback: WS_MESSAGE_DONE_CALLBACK, donecallbackstate: *const core::ffi::c_void, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteMessageEnd = unsafe extern "system" fn(channel: *const WS_CHANNEL, message: *const WS_MESSAGE, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteMessageStart = unsafe extern "system" fn(channel: *const WS_CHANNEL, message: *const WS_MESSAGE, asynccontext: *const WS_ASYNC_CONTEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteNode = unsafe extern "system" fn(writer: *const WS_XML_WRITER, node: *const WS_XML_NODE, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteQualifiedName = unsafe extern "system" fn(writer: *const WS_XML_WRITER, prefix: *const WS_XML_STRING, localname: *const WS_XML_STRING, ns: *const WS_XML_STRING, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteStartAttribute = unsafe extern "system" fn(writer: *const WS_XML_WRITER, prefix: *const WS_XML_STRING, localname: *const WS_XML_STRING, ns: *const WS_XML_STRING, singlequote: windows_sys::core::BOOL, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteStartCData = unsafe extern "system" fn(writer: *const WS_XML_WRITER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteStartElement = unsafe extern "system" fn(writer: *const WS_XML_WRITER, prefix: *const WS_XML_STRING, localname: *const WS_XML_STRING, ns: *const WS_XML_STRING, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteText = unsafe extern "system" fn(writer: *const WS_XML_WRITER, text: *const WS_XML_TEXT, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteType = unsafe extern "system" fn(writer: *const WS_XML_WRITER, typemapping: WS_TYPE_MAPPING, r#type: WS_TYPE, typedescription: *const core::ffi::c_void, writeoption: WS_WRITE_OPTION, value: *const core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteValue = unsafe extern "system" fn(writer: *const WS_XML_WRITER, valuetype: WS_VALUE_TYPE, value: *const core::ffi::c_void, valuesize: u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteXmlBuffer = unsafe extern "system" fn(writer: *const WS_XML_WRITER, xmlbuffer: *const WS_XML_BUFFER, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteXmlBufferToBytes = unsafe extern "system" fn(writer: *const WS_XML_WRITER, xmlbuffer: *const WS_XML_BUFFER, encoding: *const WS_XML_WRITER_ENCODING, properties: *const WS_XML_WRITER_PROPERTY, propertycount: u32, heap: *const WS_HEAP, bytes: *mut *mut core::ffi::c_void, bytecount: *mut u32, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsWriteXmlnsAttribute = unsafe extern "system" fn(writer: *const WS_XML_WRITER, prefix: *const WS_XML_STRING, ns: *const WS_XML_STRING, singlequote: windows_sys::core::BOOL, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub type WsXmlStringEquals = unsafe extern "system" fn(string1: *const WS_XML_STRING, string2: *const WS_XML_STRING, error: *const WS_ERROR) -> windows_sys::core::HRESULT;
...
pub const WS_SERVICE_ENDPOINT_PROPERTY_MAX_CHANNELS_PER_IP: WS_SERVICE_ENDPOINT_PROPERTY_ID = 15i32;
