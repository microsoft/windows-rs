pub type WinHttpAddRequestHeaders = unsafe extern "system" fn(hrequest: *mut core::ffi::c_void, lpszheaders: windows_sys::core::PCWSTR, dwheaderslength: u32, dwmodifiers: u32) -> windows_sys::core::BOOL;
...
pub type WinHttpAddRequestHeadersEx = unsafe extern "system" fn(hrequest: *mut core::ffi::c_void, dwmodifiers: u32, ullflags: u64, ullextra: u64, cheaders: u32, pheaders: *const WINHTTP_EXTENDED_HEADER) -> u32;
...
pub type WinHttpCheckPlatform = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("winhttp.dll" "system" fn WinHttpCheckPlatform() -> windows_sys::core::BOOL);
pub type WinHttpCloseHandle = unsafe extern "system" fn(hinternet: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("winhttp.dll" "system" fn WinHttpCloseHandle(hinternet : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
pub type WinHttpConnect = unsafe extern "system" fn(hsession: *mut core::ffi::c_void, pswzservername: windows_sys::core::PCWSTR, nserverport: u16, dwreserved: u32) -> *mut core::ffi::c_void;
...
pub type WinHttpCrackUrl = unsafe extern "system" fn(pwszurl: windows_sys::core::PCWSTR, dwurllength: u32, dwflags: u32, lpurlcomponents: *mut URL_COMPONENTS) -> windows_sys::core::BOOL;
...
pub type WinHttpCreateProxyResolver = unsafe extern "system" fn(hsession: *const core::ffi::c_void, phresolver: *mut *mut core::ffi::c_void) -> u32;
...
pub type WinHttpCreateUrl = unsafe extern "system" fn(lpurlcomponents: *const URL_COMPONENTS, dwflags: WIN_HTTP_CREATE_URL_FLAGS, pwszurl: windows_sys::core::PWSTR, pdwurllength: *mut u32) -> windows_sys::core::BOOL;
...
pub type WinHttpDetectAutoProxyConfigUrl = unsafe extern "system" fn(dwautodetectflags: u32, ppwstrautoconfigurl: *mut windows_sys::core::PWSTR) -> windows_sys::core::BOOL;
...
pub type WinHttpFreeProxyResult = unsafe extern "system" fn(pproxyresult: *mut WINHTTP_PROXY_RESULT);
windows_link::link!("winhttp.dll" "system" fn WinHttpFreeProxyResult(pproxyresult : *mut WINHTTP_PROXY_RESULT));
pub type WinHttpFreeProxyResultEx = unsafe extern "system" fn(pproxyresultex: *mut WINHTTP_PROXY_RESULT_EX);
windows_link::link!("winhttp.dll" "system" fn WinHttpFreeProxyResultEx(pproxyresultex : *mut WINHTTP_PROXY_RESULT_EX));
pub type WinHttpFreeProxySettings = unsafe extern "system" fn(pwinhttpproxysettings: *const WINHTTP_PROXY_SETTINGS);
windows_link::link!("winhttp.dll" "system" fn WinHttpFreeProxySettings(pwinhttpproxysettings : *const WINHTTP_PROXY_SETTINGS));
pub type WinHttpFreeProxySettingsEx = unsafe extern "system" fn(proxysettingstype: WINHTTP_PROXY_SETTINGS_TYPE, pproxysettingsex: *const core::ffi::c_void) -> u32;
...
pub type WinHttpFreeQueryConnectionGroupResult = unsafe extern "system" fn(presult: *mut WINHTTP_QUERY_CONNECTION_GROUP_RESULT);
...
pub type WinHttpGetDefaultProxyConfiguration = unsafe extern "system" fn(pproxyinfo: *mut WINHTTP_PROXY_INFO) -> windows_sys::core::BOOL;
...
pub type WinHttpGetIEProxyConfigForCurrentUser = unsafe extern "system" fn(pproxyconfig: *mut WINHTTP_CURRENT_USER_IE_PROXY_CONFIG) -> windows_sys::core::BOOL;
...
pub type WinHttpGetProxyForUrl = unsafe extern "system" fn(hsession: *mut core::ffi::c_void, lpcwszurl: windows_sys::core::PCWSTR, pautoproxyoptions: *mut WINHTTP_AUTOPROXY_OPTIONS, pproxyinfo: *mut WINHTTP_PROXY_INFO) -> windows_sys::core::BOOL;
...
pub type WinHttpGetProxyForUrlEx = unsafe extern "system" fn(hresolver: *const core::ffi::c_void, pcwszurl: windows_sys::core::PCWSTR, pautoproxyoptions: *const WINHTTP_AUTOPROXY_OPTIONS, pcontext: usize) -> u32;
...
pub type WinHttpGetProxyForUrlEx2 = unsafe extern "system" fn(hresolver: *const core::ffi::c_void, pcwszurl: windows_sys::core::PCWSTR, pautoproxyoptions: *const WINHTTP_AUTOPROXY_OPTIONS, cbinterfaceselectioncontext: u32, pinterfaceselectioncontext: *const u8, pcontext: usize) -> u32;
...
pub type WinHttpGetProxyResult = unsafe extern "system" fn(hresolver: *const core::ffi::c_void, pproxyresult: *mut WINHTTP_PROXY_RESULT) -> u32;
...
pub type WinHttpGetProxyResultEx = unsafe extern "system" fn(hresolver: *const core::ffi::c_void, pproxyresultex: *mut WINHTTP_PROXY_RESULT_EX) -> u32;
...
pub type WinHttpGetProxySettingsEx = unsafe extern "system" fn(hresolver: *const core::ffi::c_void, proxysettingstype: WINHTTP_PROXY_SETTINGS_TYPE, pproxysettingsparam: *const WINHTTP_PROXY_SETTINGS_PARAM, pcontext: usize) -> u32;
...
pub type WinHttpGetProxySettingsResultEx = unsafe extern "system" fn(hresolver: *const core::ffi::c_void, pproxysettingsex: *mut core::ffi::c_void) -> u32;
...
pub type WinHttpGetProxySettingsVersion = unsafe extern "system" fn(hsession: *const core::ffi::c_void, pdwproxysettingsversion: *mut u32) -> u32;
...
pub type WinHttpOpen = unsafe extern "system" fn(pszagentw: windows_sys::core::PCWSTR, dwaccesstype: WINHTTP_ACCESS_TYPE, pszproxyw: windows_sys::core::PCWSTR, pszproxybypassw: windows_sys::core::PCWSTR, dwflags: u32) -> *mut core::ffi::c_void;
...
pub type WinHttpOpenRequest = unsafe extern "system" fn(hconnect: *mut core::ffi::c_void, pwszverb: windows_sys::core::PCWSTR, pwszobjectname: windows_sys::core::PCWSTR, pwszversion: windows_sys::core::PCWSTR, pwszreferrer: windows_sys::core::PCWSTR, ppwszaccepttypes: *const windows_sys::core::PCWSTR, dwflags: WINHTTP_OPEN_REQUEST_FLAGS) -> *mut core::ffi::c_void;
...
pub type WinHttpProtocolCompleteUpgrade = unsafe extern "system" fn(hrequest: *const core::ffi::c_void, dwcontext: usize) -> *mut core::ffi::c_void;
...
pub type WinHttpProtocolReceive = unsafe extern "system" fn(protocolhandle: *const core::ffi::c_void, flags: u64, pvbuffer: *mut core::ffi::c_void, dwbufferlength: u32, pdwbytesread: *mut u32) -> u32;
...
pub type WinHttpProtocolSend = unsafe extern "system" fn(protocolhandle: *const core::ffi::c_void, flags: u64, pvbuffer: *const core::ffi::c_void, dwbufferlength: u32) -> u32;
...
pub type WinHttpQueryAuthSchemes = unsafe extern "system" fn(hrequest: *mut core::ffi::c_void, lpdwsupportedschemes: *mut u32, lpdwfirstscheme: *mut u32, pdwauthtarget: *mut u32) -> windows_sys::core::BOOL;
...
pub type WinHttpQueryConnectionGroup = unsafe extern "system" fn(hinternet: *const core::ffi::c_void, pguidconnection: *const windows_sys::core::GUID, ullflags: u64, ppresult: *mut *mut WINHTTP_QUERY_CONNECTION_GROUP_RESULT) -> u32;
...
pub type WinHttpQueryDataAvailable = unsafe extern "system" fn(hrequest: *mut core::ffi::c_void, lpdwnumberofbytesavailable: *mut u32) -> windows_sys::core::BOOL;
...
pub type WinHttpQueryHeaders = unsafe extern "system" fn(hrequest: *mut core::ffi::c_void, dwinfolevel: u32, pwszname: windows_sys::core::PCWSTR, lpbuffer: *mut core::ffi::c_void, lpdwbufferlength: *mut u32, lpdwindex: *mut u32) -> windows_sys::core::BOOL;
...
pub type WinHttpReadData = unsafe extern "system" fn(hrequest: *mut core::ffi::c_void, lpbuffer: *mut core::ffi::c_void, dwnumberofbytestoread: u32, lpdwnumberofbytesread: *mut u32) -> windows_sys::core::BOOL;
...
pub type WinHttpReadDataEx = unsafe extern "system" fn(hrequest: *mut core::ffi::c_void, lpbuffer: *mut core::ffi::c_void, dwnumberofbytestoread: u32, lpdwnumberofbytesread: *mut u32, ullflags: u64, cbproperty: u32, pvproperty: *const core::ffi::c_void) -> u32;
...
pub type WinHttpReadProxySettings = unsafe extern "system" fn(hsession: *const core::ffi::c_void, pcwszconnectionname: windows_sys::core::PCWSTR, ffallbacktodefaultsettings: windows_sys::core::BOOL, fsetautodiscoverfordefaultsettings: windows_sys::core::BOOL, pdwsettingsversion: *mut u32, pfdefaultsettingsarereturned: *mut windows_sys::core::BOOL, pwinhttpproxysettings: *mut WINHTTP_PROXY_SETTINGS) -> u32;
...
pub type WinHttpReceiveResponse = unsafe extern "system" fn(hrequest: *mut core::ffi::c_void, lpreserved: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type WinHttpRegisterProxyChangeNotification = unsafe extern "system" fn(ullflags: u64, pfncallback: WINHTTP_PROXY_CHANGE_CALLBACK, pvcontext: *const core::ffi::c_void, hregistration: *mut *mut core::ffi::c_void) -> u32;
...
pub type WinHttpResetAutoProxy = unsafe extern "system" fn(hsession: *const core::ffi::c_void, dwflags: u32) -> u32;
windows_link::link!("winhttp.dll" "system" fn WinHttpResetAutoProxy(hsession : *const core::ffi::c_void, dwflags : u32) -> u32);
pub type WinHttpSendRequest = unsafe extern "system" fn(hrequest: *mut core::ffi::c_void, lpszheaders: windows_sys::core::PCWSTR, dwheaderslength: u32, lpoptional: *const core::ffi::c_void, dwoptionallength: u32, dwtotallength: u32, dwcontext: usize) -> windows_sys::core::BOOL;
...
pub type WinHttpSetCredentials = unsafe extern "system" fn(hrequest: *mut core::ffi::c_void, authtargets: u32, authscheme: u32, pwszusername: windows_sys::core::PCWSTR, pwszpassword: windows_sys::core::PCWSTR, pauthparams: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type WinHttpSetDefaultProxyConfiguration = unsafe extern "system" fn(pproxyinfo: *mut WINHTTP_PROXY_INFO) -> windows_sys::core::BOOL;
...
pub type WinHttpSetOption = unsafe extern "system" fn(hinternet: *const core::ffi::c_void, dwoption: u32, lpbuffer: *const core::ffi::c_void, dwbufferlength: u32) -> windows_sys::core::BOOL;
...
pub type WinHttpSetProxySettingsPerUser = unsafe extern "system" fn(fproxysettingsperuser: windows_sys::core::BOOL) -> u32;
windows_link::link!("winhttp.dll" "system" fn WinHttpSetProxySettingsPerUser(fproxysettingsperuser : windows_sys::core::BOOL) -> u32);
pub type WinHttpSetStatusCallback = unsafe extern "system" fn(hinternet: *mut core::ffi::c_void, lpfninternetcallback: WINHTTP_STATUS_CALLBACK, dwnotificationflags: u32, dwreserved: usize) -> WINHTTP_STATUS_CALLBACK;
...
pub type WinHttpSetTimeouts = unsafe extern "system" fn(hinternet: *mut core::ffi::c_void, nresolvetimeout: i32, nconnecttimeout: i32, nsendtimeout: i32, nreceivetimeout: i32) -> windows_sys::core::BOOL;
...
pub type WinHttpTimeFromSystemTime = unsafe extern "system" fn(pst: *const super::super::Foundation::SYSTEMTIME, pwsztime: windows_sys::core::PWSTR) -> windows_sys::core::BOOL;
...
pub type WinHttpTimeToSystemTime = unsafe extern "system" fn(pwsztime: windows_sys::core::PCWSTR, pst: *mut super::super::Foundation::SYSTEMTIME) -> windows_sys::core::BOOL;
...
pub type WinHttpUnregisterProxyChangeNotification = unsafe extern "system" fn(hregistration: *const core::ffi::c_void) -> u32;
windows_link::link!("winhttp.dll" "system" fn WinHttpUnregisterProxyChangeNotification(hregistration : *const core::ffi::c_void) -> u32);
pub type WinHttpWebSocketClose = unsafe extern "system" fn(hwebsocket: *const core::ffi::c_void, usstatus: u16, pvreason: *const core::ffi::c_void, dwreasonlength: u32) -> u32;
...
pub type WinHttpWebSocketCompleteUpgrade = unsafe extern "system" fn(hrequest: *const core::ffi::c_void, pcontext: usize) -> *mut core::ffi::c_void;
...
pub type WinHttpWebSocketQueryCloseStatus = unsafe extern "system" fn(hwebsocket: *const core::ffi::c_void, pusstatus: *mut u16, pvreason: *mut core::ffi::c_void, dwreasonlength: u32, pdwreasonlengthconsumed: *mut u32) -> u32;
...
pub type WinHttpWebSocketReceive = unsafe extern "system" fn(hwebsocket: *const core::ffi::c_void, pvbuffer: *mut core::ffi::c_void, dwbufferlength: u32, pdwbytesread: *mut u32, pebuffertype: *mut WINHTTP_WEB_SOCKET_BUFFER_TYPE) -> u32;
...
pub type WinHttpWebSocketSend = unsafe extern "system" fn(hwebsocket: *const core::ffi::c_void, ebuffertype: WINHTTP_WEB_SOCKET_BUFFER_TYPE, pvbuffer: *const core::ffi::c_void, dwbufferlength: u32) -> u32;
...
pub type WinHttpWebSocketShutdown = unsafe extern "system" fn(hwebsocket: *const core::ffi::c_void, usstatus: u16, pvreason: *const core::ffi::c_void, dwreasonlength: u32) -> u32;
...
pub type WinHttpWriteData = unsafe extern "system" fn(hrequest: *mut core::ffi::c_void, lpbuffer: *const core::ffi::c_void, dwnumberofbytestowrite: u32, lpdwnumberofbyteswritten: *mut u32) -> windows_sys::core::BOOL;
...
pub type WinHttpWriteProxySettings = unsafe extern "system" fn(hsession: *const core::ffi::c_void, fforceupdate: windows_sys::core::BOOL, pwinhttpproxysettings: *const WINHTTP_PROXY_SETTINGS) -> u32;
