...
pub const CLUADMEX_OT_CLUSTER: CLUADMEX_OBJECT_TYPE = 1;
pub const CLUADMEX_OT_GROUP: CLUADMEX_OBJECT_TYPE = 3;
pub const CLUADMEX_OT_NETINTERFACE: CLUADMEX_OBJECT_TYPE = 7;
pub const CLUADMEX_OT_NETWORK: CLUADMEX_OBJECT_TYPE = 6;
pub const CLUADMEX_OT_NODE: CLUADMEX_OBJECT_TYPE = 2;
pub const CLUADMEX_OT_NONE: CLUADMEX_OBJECT_TYPE = 0;
pub const CLUADMEX_OT_RESOURCE: CLUADMEX_OBJECT_TYPE = 4;
pub const CLUADMEX_OT_RESOURCETYPE: CLUADMEX_OBJECT_TYPE = 5;
...
pub const ClusterGroupAllowFailback: CLUSTER_GROUP_AUTOFAILBACK_TYPE = 1;
pub const ClusterGroupFailbackTypeCount: CLUSTER_GROUP_AUTOFAILBACK_TYPE = 2;
...
pub const ClusterGroupPreventFailback: CLUSTER_GROUP_AUTOFAILBACK_TYPE = 0;
...
pub const ClusterResourceApplicationOSHeartBeat: CLUSTER_RESOURCE_APPLICATION_STATE = 2;
pub const ClusterResourceApplicationReady: CLUSTER_RESOURCE_APPLICATION_STATE = 3;
pub const ClusterResourceApplicationStateUnknown: CLUSTER_RESOURCE_APPLICATION_STATE = 1;
pub const ClusterResourceDontRestart: CLUSTER_RESOURCE_RESTART_ACTION = 0;
...
pub const ClusterResourceRestartActionCount: CLUSTER_RESOURCE_RESTART_ACTION = 3;
pub const ClusterResourceRestartNoNotify: CLUSTER_RESOURCE_RESTART_ACTION = 1;
pub const ClusterResourceRestartNotify: CLUSTER_RESOURCE_RESTART_ACTION = 2;
pub const ClusterResourceStateUnknown: CLUSTER_RESOURCE_STATE = -1;
pub const ClusterRoleClustered: CLUSTER_ROLE_STATE = 0;
pub const ClusterRoleDFSReplicatedFolder: CLUSTER_ROLE = 15;
pub const ClusterRoleDHCP: CLUSTER_ROLE = 0;
pub const ClusterRoleDTC: CLUSTER_ROLE = 1;
pub const ClusterRoleDistributedFileSystem: CLUSTER_ROLE = 16;
pub const ClusterRoleDistributedNetworkName: CLUSTER_ROLE = 17;
pub const ClusterRoleFileServer: CLUSTER_ROLE = 2;
pub const ClusterRoleFileShare: CLUSTER_ROLE = 18;
pub const ClusterRoleFileShareWitness: CLUSTER_ROLE = 19;
pub const ClusterRoleGenericApplication: CLUSTER_ROLE = 3;
pub const ClusterRoleGenericScript: CLUSTER_ROLE = 4;
pub const ClusterRoleGenericService: CLUSTER_ROLE = 5;
pub const ClusterRoleHardDisk: CLUSTER_ROLE = 20;
pub const ClusterRoleIPAddress: CLUSTER_ROLE = 21;
pub const ClusterRoleIPV6Address: CLUSTER_ROLE = 22;
pub const ClusterRoleIPV6TunnelAddress: CLUSTER_ROLE = 23;
pub const ClusterRoleISCSINameServer: CLUSTER_ROLE = 6;
pub const ClusterRoleISCSITargetServer: CLUSTER_ROLE = 24;
pub const ClusterRoleKeyValueStore: CLUSTER_ROLE = 32;
pub const ClusterRoleMSMQ: CLUSTER_ROLE = 7;
pub const ClusterRoleNFS: CLUSTER_ROLE = 8;
pub const ClusterRoleNetworkFileSystem: CLUSTER_ROLE = 14;
pub const ClusterRoleNetworkName: CLUSTER_ROLE = 25;
pub const ClusterRolePhysicalDisk: CLUSTER_ROLE = 26;
pub const ClusterRolePrintServer: CLUSTER_ROLE = 9;
pub const ClusterRoleSODAFileServer: CLUSTER_ROLE = 27;
pub const ClusterRoleStandAloneNamespaceServer: CLUSTER_ROLE = 10;
pub const ClusterRoleStoragePool: CLUSTER_ROLE = 28;
pub const ClusterRoleTaskScheduler: CLUSTER_ROLE = 13;
pub const ClusterRoleUnclustered: CLUSTER_ROLE_STATE = 1;
pub const ClusterRoleUnknown: CLUSTER_ROLE_STATE = -1;
pub const ClusterRoleVirtualMachine: CLUSTER_ROLE = 29;
pub const ClusterRoleVirtualMachineConfiguration: CLUSTER_ROLE = 30;
pub const ClusterRoleVirtualMachineReplicaBroker: CLUSTER_ROLE = 31;
pub const ClusterRoleVolumeShadowCopyServiceTask: CLUSTER_ROLE = 11;
pub const ClusterRoleWINS: CLUSTER_ROLE = 12;
...
pub const FAILURE_TYPE_EMBEDDED: FAILURE_TYPE = 1;
pub const FAILURE_TYPE_GENERAL: FAILURE_TYPE = 0;
pub const FAILURE_TYPE_NETWORK_LOSS: FAILURE_TYPE = 2;
...
pub const LOG_ERROR: LOG_LEVEL = 2;
pub const LOG_INFORMATION: LOG_LEVEL = 0;
pub type LOG_LEVEL = i32;
pub const LOG_SEVERE: LOG_LEVEL = 3;
pub const LOG_WARNING: LOG_LEVEL = 1;
...
pub const ResdllContextOperationTypeDrain: RESDLL_CONTEXT_OPERATION_TYPE = 1;
pub const ResdllContextOperationTypeDrainFailure: RESDLL_CONTEXT_OPERATION_TYPE = 2;
pub const ResdllContextOperationTypeEmbeddedFailure: RESDLL_CONTEXT_OPERATION_TYPE = 3;
pub const ResdllContextOperationTypeFailback: RESDLL_CONTEXT_OPERATION_TYPE = 0;
pub const ResdllContextOperationTypeNetworkDisconnect: RESDLL_CONTEXT_OPERATION_TYPE = 5;
pub const ResdllContextOperationTypeNetworkDisconnectMoveRetry: RESDLL_CONTEXT_OPERATION_TYPE = 6;
pub const ResdllContextOperationTypePreemption: RESDLL_CONTEXT_OPERATION_TYPE = 4;
pub const ResourceExitStateContinue: RESOURCE_EXIT_STATE = 0;
...
pub const RmonArbitrateResource: RESOURCE_MONITOR_STATE = 10;
pub const RmonDeadlocked: RESOURCE_MONITOR_STATE = 15;
pub const RmonDeletingResource: RESOURCE_MONITOR_STATE = 7;
pub const RmonIdle: RESOURCE_MONITOR_STATE = 1;
pub const RmonInitializing: RESOURCE_MONITOR_STATE = 0;
pub const RmonInitializingResource: RESOURCE_MONITOR_STATE = 3;
pub const RmonIsAlivePoll: RESOURCE_MONITOR_STATE = 8;
pub const RmonLooksAlivePoll: RESOURCE_MONITOR_STATE = 9;
pub const RmonOfflineResource: RESOURCE_MONITOR_STATE = 5;
pub const RmonOnlineResource: RESOURCE_MONITOR_STATE = 4;
pub const RmonReleaseResource: RESOURCE_MONITOR_STATE = 11;
pub const RmonResourceControl: RESOURCE_MONITOR_STATE = 12;
pub const RmonResourceTypeControl: RESOURCE_MONITOR_STATE = 13;
pub const RmonShutdownResource: RESOURCE_MONITOR_STATE = 6;
pub const RmonStartingResource: RESOURCE_MONITOR_STATE = 2;
pub const RmonTerminateResource: RESOURCE_MONITOR_STATE = 14;
...
pub const VmResdllContextLiveMigration: VM_RESDLL_CONTEXT = 4;
pub const VmResdllContextSave: VM_RESDLL_CONTEXT = 1;
pub const VmResdllContextShutdown: VM_RESDLL_CONTEXT = 2;
pub const VmResdllContextShutdownForce: VM_RESDLL_CONTEXT = 3;
pub const VmResdllContextTurnOff: VM_RESDLL_CONTEXT = 0;
