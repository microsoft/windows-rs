::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn AddClusterGroupDependency ( hdependentgroup : *const _HGROUP , hprovidergroup : *const _HGROUP ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn AddClusterGroupSetDependency ( hdependentgroupset : *const _HGROUPSET , hprovidergroupset : *const _HGROUPSET ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn AddClusterGroupToGroupSetDependency ( hdependentgroup : *const _HGROUP , hprovidergroupset : *const _HGROUPSET ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn AddClusterNode ( hcluster : *const _HCLUSTER , lpsznodename : :: windows_sys::core::PCWSTR , pfnprogresscallback : PCLUSTER_SETUP_PROGRESS_CALLBACK , pvcallbackarg : *const ::core::ffi::c_void ) -> *mut _HNODE );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn AddClusterNodeEx ( hcluster : *const _HCLUSTER , lpsznodename : :: windows_sys::core::PCWSTR , dwflags : u32 , pfnprogresscallback : PCLUSTER_SETUP_PROGRESS_CALLBACK , pvcallbackarg : *const ::core::ffi::c_void ) -> *mut _HNODE );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn AddClusterResourceDependency ( hresource : *const _HRESOURCE , hdependson : *const _HRESOURCE ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn AddClusterResourceNode ( hresource : *const _HRESOURCE , hnode : *const _HNODE ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn AddClusterStorageNode ( hcluster : *const _HCLUSTER , lpsznodename : :: windows_sys::core::PCWSTR , pfnprogresscallback : PCLUSTER_SETUP_PROGRESS_CALLBACK , pvcallbackarg : *const ::core::ffi::c_void , lpszclusterstoragenodedescription : :: windows_sys::core::PCWSTR , lpszclusterstoragenodelocation : :: windows_sys::core::PCWSTR ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn AddCrossClusterGroupSetDependency ( hdependentgroupset : *const _HGROUPSET , lpremoteclustername : :: windows_sys::core::PCWSTR , lpremotegroupsetname : :: windows_sys::core::PCWSTR ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn AddResourceToClusterSharedVolumes ( hresource : *const _HRESOURCE ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn BackupClusterDatabase ( hcluster : *const _HCLUSTER , lpszpathname : :: windows_sys::core::PCWSTR ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CanResourceBeDependent ( hresource : *const _HRESOURCE , hresourcedependent : *const _HRESOURCE ) -> super::super::Foundation:: BOOL );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CancelClusterGroupOperation ( hgroup : *const _HGROUP , dwcancelflags_reserved : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ChangeClusterResourceGroup ( hresource : *const _HRESOURCE , hgroup : *const _HGROUP ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ChangeClusterResourceGroupEx ( hresource : *const _HRESOURCE , hgroup : *const _HGROUP , flags : u64 ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CloseCluster ( hcluster : *const _HCLUSTER ) -> super::super::Foundation:: BOOL );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn CloseClusterCryptProvider ( hcluscryptprovider : *const _HCLUSCRYPTPROVIDER ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CloseClusterGroup ( hgroup : *const _HGROUP ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CloseClusterGroupSet ( hgroupset : *const _HGROUPSET ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CloseClusterNetInterface ( hnetinterface : *const _HNETINTERFACE ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CloseClusterNetwork ( hnetwork : *const _HNETWORK ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CloseClusterNode ( hnode : *const _HNODE ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CloseClusterNotifyPort ( hchange : *const _HCHANGE ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CloseClusterResource ( hresource : *const _HRESOURCE ) -> super::super::Foundation:: BOOL );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ClusAddClusterHealthFault ( hcluster : *const _HCLUSTER , failure : *const CLUSTER_HEALTH_FAULT , param2 : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ClusGetClusterHealthFaults ( hcluster : *const _HCLUSTER , objects : *mut CLUSTER_HEALTH_FAULT_ARRAY , flags : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ClusRemoveClusterHealthFault ( hcluster : *const _HCLUSTER , id : :: windows_sys::core::PCWSTR , flags : u32 ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ClusWorkerCheckTerminate ( lpworker : *mut CLUS_WORKER ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ClusWorkerCreate ( lpworker : *mut CLUS_WORKER , lpstartaddress : PWORKER_START_ROUTINE , lpparameter : *mut ::core::ffi::c_void ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ClusWorkerTerminate ( lpworker : *const CLUS_WORKER ) -> ( ) );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ClusWorkerTerminateEx ( clusworker : *mut CLUS_WORKER , timeoutinmilliseconds : u32 , waitonly : super::super::Foundation:: BOOL ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ClusWorkersTerminate ( clusworkers : *mut *mut CLUS_WORKER , clusworkerscount : usize , timeoutinmilliseconds : u32 , waitonly : super::super::Foundation:: BOOL ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterAddGroupToAffinityRule ( hcluster : *const _HCLUSTER , rulename : :: windows_sys::core::PCWSTR , hgroup : *const _HGROUP ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterAddGroupToGroupSet ( hgroupset : *const _HGROUPSET , hgroup : *const _HGROUP ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterAddGroupToGroupSetWithDomains ( hgroupset : *const _HGROUPSET , hgroup : *const _HGROUP , faultdomain : u32 , updatedomain : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterAffinityRuleControl ( hcluster : *const _HCLUSTER , affinityrulename : :: windows_sys::core::PCWSTR , hhostnode : *const _HNODE , dwcontrolcode : u32 , lpinbuffer : *const ::core::ffi::c_void , cbinbuffersize : u32 , lpoutbuffer : *mut ::core::ffi::c_void , cboutbuffersize : u32 , lpbytesreturned : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ClusterClearBackupStateForSharedVolume ( lpszvolumepathname : :: windows_sys::core::PCWSTR ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterCloseEnum ( henum : *const _HCLUSENUM ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterCloseEnumEx ( hclusterenum : *const _HCLUSENUMEX ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterControl ( hcluster : *const _HCLUSTER , hhostnode : *const _HNODE , dwcontrolcode : u32 , lpinbuffer : *const ::core::ffi::c_void , ninbuffersize : u32 , lpoutbuffer : *mut ::core::ffi::c_void , noutbuffersize : u32 , lpbytesreturned : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterCreateAffinityRule ( hcluster : *const _HCLUSTER , rulename : :: windows_sys::core::PCWSTR , ruletype : CLUS_AFFINITY_RULE_TYPE ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ClusterDecrypt ( hcluscryptprovider : *const _HCLUSCRYPTPROVIDER , pcryptinput : *const u8 , cbcryptinput : u32 , ppcryptoutput : *mut *mut u8 , pcbcryptoutput : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ClusterEncrypt ( hcluscryptprovider : *const _HCLUSCRYPTPROVIDER , pdata : *const u8 , cbdata : u32 , ppdata : *mut *mut u8 , pcbdata : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterEnum ( henum : *const _HCLUSENUM , dwindex : u32 , lpdwtype : *mut u32 , lpszname : :: windows_sys::core::PWSTR , lpcchname : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterEnumEx ( hclusterenum : *const _HCLUSENUMEX , dwindex : u32 , pitem : *mut CLUSTER_ENUM_ITEM , cbitem : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterGetEnumCount ( henum : *const _HCLUSENUM ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterGetEnumCountEx ( hclusterenum : *const _HCLUSENUMEX ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ClusterGetVolumeNameForVolumeMountPoint ( lpszvolumemountpoint : :: windows_sys::core::PCWSTR , lpszvolumename : :: windows_sys::core::PWSTR , cchbufferlength : u32 ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ClusterGetVolumePathName ( lpszfilename : :: windows_sys::core::PCWSTR , lpszvolumepathname : :: windows_sys::core::PWSTR , cchbufferlength : u32 ) -> super::super::Foundation:: BOOL );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterGroupCloseEnum ( hgroupenum : *const _HGROUPENUM ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterGroupCloseEnumEx ( hgroupenumex : *const _HGROUPENUMEX ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterGroupControl ( hgroup : *const _HGROUP , hhostnode : *const _HNODE , dwcontrolcode : u32 , lpinbuffer : *const ::core::ffi::c_void , ninbuffersize : u32 , lpoutbuffer : *mut ::core::ffi::c_void , noutbuffersize : u32 , lpbytesreturned : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterGroupEnum ( hgroupenum : *const _HGROUPENUM , dwindex : u32 , lpdwtype : *mut u32 , lpszresourcename : :: windows_sys::core::PWSTR , lpcchname : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterGroupEnumEx ( hgroupenumex : *const _HGROUPENUMEX , dwindex : u32 , pitem : *mut CLUSTER_GROUP_ENUM_ITEM , cbitem : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterGroupGetEnumCount ( hgroupenum : *const _HGROUPENUM ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterGroupGetEnumCountEx ( hgroupenumex : *const _HGROUPENUMEX ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterGroupOpenEnum ( hgroup : *const _HGROUP , dwtype : u32 ) -> *mut _HGROUPENUM );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterGroupOpenEnumEx ( hcluster : *const _HCLUSTER , lpszproperties : :: windows_sys::core::PCWSTR , cbproperties : u32 , lpszroproperties : :: windows_sys::core::PCWSTR , cbroproperties : u32 , dwflags : u32 ) -> *mut _HGROUPENUMEX );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterGroupSetCloseEnum ( hgroupsetenum : *mut _HGROUPSETENUM ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterGroupSetControl ( hgroupset : *const _HGROUPSET , hhostnode : *const _HNODE , dwcontrolcode : u32 , lpinbuffer : *const ::core::ffi::c_void , cbinbuffersize : u32 , lpoutbuffer : *mut ::core::ffi::c_void , cboutbuffersize : u32 , lpbytesreturned : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterGroupSetEnum ( hgroupsetenum : *const _HGROUPSETENUM , dwindex : u32 , lpszname : :: windows_sys::core::PWSTR , lpcchname : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterGroupSetGetEnumCount ( hgroupsetenum : *mut _HGROUPSETENUM ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterGroupSetOpenEnum ( hcluster : *mut _HCLUSTER ) -> *mut _HGROUPSETENUM );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ClusterIsPathOnSharedVolume ( lpszpathname : :: windows_sys::core::PCWSTR ) -> super::super::Foundation:: BOOL );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNetInterfaceCloseEnum ( hnetinterfaceenum : *const _HNETINTERFACEENUM ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNetInterfaceControl ( hnetinterface : *const _HNETINTERFACE , hhostnode : *const _HNODE , dwcontrolcode : u32 , lpinbuffer : *const ::core::ffi::c_void , ninbuffersize : u32 , lpoutbuffer : *mut ::core::ffi::c_void , noutbuffersize : u32 , lpbytesreturned : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNetInterfaceEnum ( hnetinterfaceenum : *const _HNETINTERFACEENUM , dwindex : u32 , lpszname : :: windows_sys::core::PWSTR , lpcchname : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNetInterfaceOpenEnum ( hcluster : *const _HCLUSTER , lpsznodename : :: windows_sys::core::PCWSTR , lpsznetworkname : :: windows_sys::core::PCWSTR ) -> *mut _HNETINTERFACEENUM );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNetworkCloseEnum ( hnetworkenum : *const _HNETWORKENUM ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNetworkControl ( hnetwork : *const _HNETWORK , hhostnode : *const _HNODE , dwcontrolcode : u32 , lpinbuffer : *const ::core::ffi::c_void , ninbuffersize : u32 , lpoutbuffer : *mut ::core::ffi::c_void , noutbuffersize : u32 , lpbytesreturned : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNetworkEnum ( hnetworkenum : *const _HNETWORKENUM , dwindex : u32 , lpdwtype : *mut u32 , lpszname : :: windows_sys::core::PWSTR , lpcchname : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNetworkGetEnumCount ( hnetworkenum : *const _HNETWORKENUM ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNetworkOpenEnum ( hnetwork : *const _HNETWORK , dwtype : u32 ) -> *mut _HNETWORKENUM );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNodeCloseEnum ( hnodeenum : *const _HNODEENUM ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNodeCloseEnumEx ( hnodeenum : *const _HNODEENUMEX ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNodeControl ( hnode : *const _HNODE , hhostnode : *const _HNODE , dwcontrolcode : u32 , lpinbuffer : *const ::core::ffi::c_void , ninbuffersize : u32 , lpoutbuffer : *mut ::core::ffi::c_void , noutbuffersize : u32 , lpbytesreturned : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNodeEnum ( hnodeenum : *const _HNODEENUM , dwindex : u32 , lpdwtype : *mut u32 , lpszname : :: windows_sys::core::PWSTR , lpcchname : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNodeEnumEx ( hnodeenum : *const _HNODEENUMEX , dwindex : u32 , pitem : *mut CLUSTER_ENUM_ITEM , cbitem : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNodeGetEnumCount ( hnodeenum : *const _HNODEENUM ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNodeGetEnumCountEx ( hnodeenum : *const _HNODEENUMEX ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNodeOpenEnum ( hnode : *const _HNODE , dwtype : u32 ) -> *mut _HNODEENUM );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNodeOpenEnumEx ( hnode : *const _HNODE , dwtype : u32 , poptions : *const ::core::ffi::c_void ) -> *mut _HNODEENUMEX );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterNodeReplacement ( hcluster : *const _HCLUSTER , lpsznodenamecurrent : :: windows_sys::core::PCWSTR , lpsznodenamenew : :: windows_sys::core::PCWSTR ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterOpenEnum ( hcluster : *const _HCLUSTER , dwtype : u32 ) -> *mut _HCLUSENUM );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterOpenEnumEx ( hcluster : *const _HCLUSTER , dwtype : u32 , poptions : *const ::core::ffi::c_void ) -> *mut _HCLUSENUMEX );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ClusterPrepareSharedVolumeForBackup ( lpszfilename : :: windows_sys::core::PCWSTR , lpszvolumepathname : :: windows_sys::core::PWSTR , lpcchvolumepathname : *mut u32 , lpszvolumename : :: windows_sys::core::PWSTR , lpcchvolumename : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegBatchAddCommand ( hregbatch : *const _HREGBATCH , dwcommand : CLUSTER_REG_COMMAND , wzname : :: windows_sys::core::PCWSTR , dwoptions : u32 , lpdata : *const ::core::ffi::c_void , cbdata : u32 ) -> i32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegBatchCloseNotification ( hbatchnotification : *const _HREGBATCHNOTIFICATION ) -> i32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegBatchReadCommand ( hbatchnotification : *const _HREGBATCHNOTIFICATION , pbatchcommand : *mut CLUSTER_BATCH_COMMAND ) -> i32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegCloseBatch ( hregbatch : *const _HREGBATCH , bcommit : super::super::Foundation:: BOOL , failedcommandnumber : *mut i32 ) -> i32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegCloseBatchEx ( hregbatch : *const _HREGBATCH , flags : u32 , failedcommandnumber : *mut i32 ) -> i32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegCloseBatchNotifyPort ( hbatchnotifyport : *const _HREGBATCHPORT ) -> i32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegCloseKey ( hkey : super::super::System::Registry:: HKEY ) -> i32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegCloseReadBatch ( hregreadbatch : *const _HREGREADBATCH , phregreadbatchreply : *mut *mut _HREGREADBATCHREPLY ) -> i32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegCloseReadBatchEx ( hregreadbatch : *const _HREGREADBATCH , flags : u32 , phregreadbatchreply : *mut *mut _HREGREADBATCHREPLY ) -> i32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegCloseReadBatchReply ( hregreadbatchreply : *const _HREGREADBATCHREPLY ) -> i32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegCreateBatch ( hkey : super::super::System::Registry:: HKEY , phregbatch : *mut *mut _HREGBATCH ) -> i32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegCreateBatchNotifyPort ( hkey : super::super::System::Registry:: HKEY , phbatchnotifyport : *mut *mut _HREGBATCHPORT ) -> i32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security", feature = "Win32_System_Registry"))]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegCreateKey ( hkey : super::super::System::Registry:: HKEY , lpszsubkey : :: windows_sys::core::PCWSTR , dwoptions : u32 , samdesired : u32 , lpsecurityattributes : *const super::super::Security:: SECURITY_ATTRIBUTES , phkresult : *mut super::super::System::Registry:: HKEY , lpdwdisposition : *mut u32 ) -> i32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegCreateReadBatch ( hkey : super::super::System::Registry:: HKEY , phregreadbatch : *mut *mut _HREGREADBATCH ) -> i32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegDeleteKey ( hkey : super::super::System::Registry:: HKEY , lpszsubkey : :: windows_sys::core::PCWSTR ) -> i32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegDeleteValue ( hkey : super::super::System::Registry:: HKEY , lpszvaluename : :: windows_sys::core::PCWSTR ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Registry"))]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegEnumKey ( hkey : super::super::System::Registry:: HKEY , dwindex : u32 , lpszname : :: windows_sys::core::PWSTR , lpcchname : *mut u32 , lpftlastwritetime : *mut super::super::Foundation:: FILETIME ) -> i32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegEnumValue ( hkey : super::super::System::Registry:: HKEY , dwindex : u32 , lpszvaluename : :: windows_sys::core::PWSTR , lpcchvaluename : *mut u32 , lpdwtype : *mut u32 , lpdata : *mut u8 , lpcbdata : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegGetBatchNotification ( hbatchnotify : *const _HREGBATCHPORT , phbatchnotification : *mut *mut _HREGBATCHNOTIFICATION ) -> i32 );
#[cfg(all(feature = "Win32_Security", feature = "Win32_System_Registry"))]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegGetKeySecurity ( hkey : super::super::System::Registry:: HKEY , requestedinformation : u32 , psecuritydescriptor : super::super::Security:: PSECURITY_DESCRIPTOR , lpcbsecuritydescriptor : *mut u32 ) -> i32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegOpenKey ( hkey : super::super::System::Registry:: HKEY , lpszsubkey : :: windows_sys::core::PCWSTR , samdesired : u32 , phkresult : *mut super::super::System::Registry:: HKEY ) -> i32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Registry"))]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegQueryInfoKey ( hkey : super::super::System::Registry:: HKEY , lpcsubkeys : *const u32 , lpcchmaxsubkeylen : *const u32 , lpcvalues : *const u32 , lpcchmaxvaluenamelen : *const u32 , lpcbmaxvaluelen : *const u32 , lpcbsecuritydescriptor : *const u32 , lpftlastwritetime : *const super::super::Foundation:: FILETIME ) -> i32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegQueryValue ( hkey : super::super::System::Registry:: HKEY , lpszvaluename : :: windows_sys::core::PCWSTR , lpdwvaluetype : *mut u32 , lpdata : *mut u8 , lpcbdata : *mut u32 ) -> i32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegReadBatchAddCommand ( hregreadbatch : *const _HREGREADBATCH , wzsubkeyname : :: windows_sys::core::PCWSTR , wzvaluename : :: windows_sys::core::PCWSTR ) -> i32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegReadBatchReplyNextCommand ( hregreadbatchreply : *const _HREGREADBATCHREPLY , pbatchcommand : *mut CLUSTER_READ_BATCH_COMMAND ) -> i32 );
#[cfg(all(feature = "Win32_Security", feature = "Win32_System_Registry"))]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegSetKeySecurity ( hkey : super::super::System::Registry:: HKEY , securityinformation : u32 , psecuritydescriptor : super::super::Security:: PSECURITY_DESCRIPTOR ) -> i32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegSetValue ( hkey : super::super::System::Registry:: HKEY , lpszvaluename : :: windows_sys::core::PCWSTR , dwtype : u32 , lpdata : *const u8 , cbdata : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRegSyncDatabase ( hcluster : *const _HCLUSTER , flags : u32 ) -> i32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRemoveAffinityRule ( hcluster : *const _HCLUSTER , rulename : :: windows_sys::core::PCWSTR ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRemoveGroupFromAffinityRule ( hcluster : *const _HCLUSTER , rulename : :: windows_sys::core::PCWSTR , hgroup : *const _HGROUP ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterRemoveGroupFromGroupSet ( hgroup : *const _HGROUP ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterResourceCloseEnum ( hresenum : *const _HRESENUM ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterResourceCloseEnumEx ( hresourceenumex : *const _HRESENUMEX ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterResourceControl ( hresource : *const _HRESOURCE , hhostnode : *const _HNODE , dwcontrolcode : u32 , lpinbuffer : *const ::core::ffi::c_void , cbinbuffersize : u32 , lpoutbuffer : *mut ::core::ffi::c_void , cboutbuffersize : u32 , lpbytesreturned : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterResourceControlAsUser ( hresource : *const _HRESOURCE , hhostnode : *const _HNODE , dwcontrolcode : u32 , lpinbuffer : *const ::core::ffi::c_void , cbinbuffersize : u32 , lpoutbuffer : *mut ::core::ffi::c_void , cboutbuffersize : u32 , lpbytesreturned : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterResourceEnum ( hresenum : *const _HRESENUM , dwindex : u32 , lpdwtype : *mut u32 , lpszname : :: windows_sys::core::PWSTR , lpcchname : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterResourceEnumEx ( hresourceenumex : *const _HRESENUMEX , dwindex : u32 , pitem : *mut CLUSTER_RESOURCE_ENUM_ITEM , cbitem : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterResourceGetEnumCount ( hresenum : *const _HRESENUM ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterResourceGetEnumCountEx ( hresourceenumex : *const _HRESENUMEX ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterResourceOpenEnum ( hresource : *const _HRESOURCE , dwtype : u32 ) -> *mut _HRESENUM );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterResourceOpenEnumEx ( hcluster : *const _HCLUSTER , lpszproperties : :: windows_sys::core::PCWSTR , cbproperties : u32 , lpszroproperties : :: windows_sys::core::PCWSTR , cbroproperties : u32 , dwflags : u32 ) -> *mut _HRESENUMEX );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterResourceTypeCloseEnum ( hrestypeenum : *const _HRESTYPEENUM ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterResourceTypeControl ( hcluster : *const _HCLUSTER , lpszresourcetypename : :: windows_sys::core::PCWSTR , hhostnode : *const _HNODE , dwcontrolcode : u32 , lpinbuffer : *const ::core::ffi::c_void , ninbuffersize : u32 , lpoutbuffer : *mut ::core::ffi::c_void , noutbuffersize : u32 , lpbytesreturned : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterResourceTypeControlAsUser ( hcluster : *const _HCLUSTER , lpszresourcetypename : :: windows_sys::core::PCWSTR , hhostnode : *const _HNODE , dwcontrolcode : u32 , lpinbuffer : *const ::core::ffi::c_void , ninbuffersize : u32 , lpoutbuffer : *mut ::core::ffi::c_void , noutbuffersize : u32 , lpbytesreturned : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterResourceTypeEnum ( hrestypeenum : *const _HRESTYPEENUM , dwindex : u32 , lpdwtype : *mut u32 , lpszname : :: windows_sys::core::PWSTR , lpcchname : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterResourceTypeGetEnumCount ( hrestypeenum : *const _HRESTYPEENUM ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterResourceTypeOpenEnum ( hcluster : *const _HCLUSTER , lpszresourcetypename : :: windows_sys::core::PCWSTR , dwtype : u32 ) -> *mut _HRESTYPEENUM );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterSetAccountAccess ( hcluster : *const _HCLUSTER , szaccountsid : :: windows_sys::core::PCWSTR , dwaccess : u32 , dwcontroltype : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterSharedVolumeSetSnapshotState ( guidsnapshotset : :: windows_sys::core::GUID , lpszvolumename : :: windows_sys::core::PCWSTR , state : CLUSTER_SHARED_VOLUME_SNAPSHOT_STATE ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ClusterUpgradeFunctionalLevel ( hcluster : *const _HCLUSTER , perform : super::super::Foundation:: BOOL , pfnprogresscallback : PCLUSTER_UPGRADE_PROGRESS_CALLBACK , pvcallbackarg : *const ::core::ffi::c_void ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CreateCluster ( pconfig : *const CREATE_CLUSTER_CONFIG , pfnprogresscallback : PCLUSTER_SETUP_PROGRESS_CALLBACK , pvcallbackarg : *const ::core::ffi::c_void ) -> *mut _HCLUSTER );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CreateClusterAvailabilitySet ( hcluster : *const _HCLUSTER , lpavailabilitysetname : :: windows_sys::core::PCWSTR , pavailabilitysetconfig : *const CLUSTER_AVAILABILITY_SET_CONFIG ) -> *mut _HGROUPSET );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CreateClusterGroup ( hcluster : *const _HCLUSTER , lpszgroupname : :: windows_sys::core::PCWSTR ) -> *mut _HGROUP );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CreateClusterGroupEx ( hcluster : *const _HCLUSTER , lpszgroupname : :: windows_sys::core::PCWSTR , pgroupinfo : *const CLUSTER_CREATE_GROUP_INFO ) -> *mut _HGROUP );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CreateClusterGroupSet ( hcluster : *const _HCLUSTER , groupsetname : :: windows_sys::core::PCWSTR ) -> *mut _HGROUPSET );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CreateClusterNameAccount ( hcluster : *const _HCLUSTER , pconfig : *const CREATE_CLUSTER_NAME_ACCOUNT , pfnprogresscallback : PCLUSTER_SETUP_PROGRESS_CALLBACK , pvcallbackarg : *const ::core::ffi::c_void ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CreateClusterNotifyPort ( hchange : *const _HCHANGE , hcluster : *const _HCLUSTER , dwfilter : u32 , dwnotifykey : usize ) -> *mut _HCHANGE );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CreateClusterNotifyPortV2 ( hchange : *const _HCHANGE , hcluster : *const _HCLUSTER , filters : *const NOTIFY_FILTER_AND_TYPE , dwfiltercount : u32 , dwnotifykey : usize ) -> *mut _HCHANGE );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CreateClusterResource ( hgroup : *const _HGROUP , lpszresourcename : :: windows_sys::core::PCWSTR , lpszresourcetype : :: windows_sys::core::PCWSTR , dwflags : u32 ) -> *mut _HRESOURCE );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn CreateClusterResourceType ( hcluster : *const _HCLUSTER , lpszresourcetypename : :: windows_sys::core::PCWSTR , lpszdisplayname : :: windows_sys::core::PCWSTR , lpszresourcetypedll : :: windows_sys::core::PCWSTR , dwlooksalivepollinterval : u32 , dwisalivepollinterval : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn DeleteClusterGroup ( hgroup : *const _HGROUP ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn DeleteClusterGroupSet ( hgroupset : *const _HGROUPSET ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn DeleteClusterResource ( hresource : *const _HRESOURCE ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn DeleteClusterResourceType ( hcluster : *const _HCLUSTER , lpszresourcetypename : :: windows_sys::core::PCWSTR ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn DestroyCluster ( hcluster : *const _HCLUSTER , pfnprogresscallback : PCLUSTER_SETUP_PROGRESS_CALLBACK , pvcallbackarg : *const ::core::ffi::c_void , fdeletevirtualcomputerobjects : super::super::Foundation:: BOOL ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn DestroyClusterGroup ( hgroup : *const _HGROUP ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn DetermineCNOResTypeFromCluster ( hcluster : *const _HCLUSTER , pcnorestype : *mut CLUSTER_MGMT_POINT_RESTYPE ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn DetermineCNOResTypeFromNodelist ( cnodes : u32 , ppsznodenames : *const :: windows_sys::core::PWSTR , pcnorestype : *mut CLUSTER_MGMT_POINT_RESTYPE ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn DetermineClusterCloudTypeFromCluster ( hcluster : *const _HCLUSTER , pcloudtype : *mut CLUSTER_CLOUD_TYPE ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn DetermineClusterCloudTypeFromNodelist ( cnodes : u32 , ppsznodenames : *const :: windows_sys::core::PWSTR , pcloudtype : *mut CLUSTER_CLOUD_TYPE ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn EvictClusterNode ( hnode : *const _HNODE ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn EvictClusterNodeEx ( hnode : *const _HNODE , dwtimeout : u32 , phrcleanupstatus : *mut :: windows_sys::core::HRESULT ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn FailClusterResource ( hresource : *const _HRESOURCE ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn FreeClusterCrypt ( pcryptinfo : *const ::core::ffi::c_void ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn FreeClusterHealthFault ( clusterhealthfault : *mut CLUSTER_HEALTH_FAULT ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn FreeClusterHealthFaultArray ( clusterhealthfaultarray : *mut CLUSTER_HEALTH_FAULT_ARRAY ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterFromGroup ( hgroup : *const _HGROUP ) -> *mut _HCLUSTER );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterFromNetInterface ( hnetinterface : *const _HNETINTERFACE ) -> *mut _HCLUSTER );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterFromNetwork ( hnetwork : *const _HNETWORK ) -> *mut _HCLUSTER );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterFromNode ( hnode : *const _HNODE ) -> *mut _HCLUSTER );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterFromResource ( hresource : *const _HRESOURCE ) -> *mut _HCLUSTER );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterGroupKey ( hgroup : *const _HGROUP , samdesired : u32 ) -> super::super::System::Registry:: HKEY );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterGroupState ( hgroup : *const _HGROUP , lpsznodename : :: windows_sys::core::PWSTR , lpcchnodename : *mut u32 ) -> CLUSTER_GROUP_STATE );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterInformation ( hcluster : *const _HCLUSTER , lpszclustername : :: windows_sys::core::PWSTR , lpcchclustername : *mut u32 , lpclusterinfo : *mut CLUSTERVERSIONINFO ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterKey ( hcluster : *const _HCLUSTER , samdesired : u32 ) -> super::super::System::Registry:: HKEY );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterNetInterface ( hcluster : *const _HCLUSTER , lpsznodename : :: windows_sys::core::PCWSTR , lpsznetworkname : :: windows_sys::core::PCWSTR , lpszinterfacename : :: windows_sys::core::PWSTR , lpcchinterfacename : *mut u32 ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterNetInterfaceKey ( hnetinterface : *const _HNETINTERFACE , samdesired : u32 ) -> super::super::System::Registry:: HKEY );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterNetInterfaceState ( hnetinterface : *const _HNETINTERFACE ) -> CLUSTER_NETINTERFACE_STATE );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterNetworkId ( hnetwork : *const _HNETWORK , lpsznetworkid : :: windows_sys::core::PWSTR , lpcchname : *mut u32 ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterNetworkKey ( hnetwork : *const _HNETWORK , samdesired : u32 ) -> super::super::System::Registry:: HKEY );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterNetworkState ( hnetwork : *const _HNETWORK ) -> CLUSTER_NETWORK_STATE );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterNodeId ( hnode : *const _HNODE , lpsznodeid : :: windows_sys::core::PWSTR , lpcchname : *mut u32 ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterNodeKey ( hnode : *const _HNODE , samdesired : u32 ) -> super::super::System::Registry:: HKEY );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterNodeState ( hnode : *const _HNODE ) -> CLUSTER_NODE_STATE );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterNotify ( hchange : *const _HCHANGE , lpdwnotifykey : *mut usize , lpdwfiltertype : *mut u32 , lpszname : :: windows_sys::core::PWSTR , lpcchname : *mut u32 , dwmilliseconds : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterNotifyV2 ( hchange : *const _HCHANGE , lpdwnotifykey : *mut usize , pfilterandtype : *mut NOTIFY_FILTER_AND_TYPE , buffer : *mut u8 , lpbbuffersize : *mut u32 , lpszobjectid : :: windows_sys::core::PWSTR , lpcchobjectid : *mut u32 , lpszparentid : :: windows_sys::core::PWSTR , lpcchparentid : *mut u32 , lpszname : :: windows_sys::core::PWSTR , lpcchname : *mut u32 , lpsztype : :: windows_sys::core::PWSTR , lpcchtype : *mut u32 , dwmilliseconds : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterQuorumResource ( hcluster : *const _HCLUSTER , lpszresourcename : :: windows_sys::core::PWSTR , lpcchresourcename : *mut u32 , lpszdevicename : :: windows_sys::core::PWSTR , lpcchdevicename : *mut u32 , lpdwmaxquorumlogsize : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterResourceDependencyExpression ( hresource : *const _HRESOURCE , lpszdependencyexpression : :: windows_sys::core::PWSTR , lpcchdependencyexpression : *mut u32 ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterResourceKey ( hresource : *const _HRESOURCE , samdesired : u32 ) -> super::super::System::Registry:: HKEY );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterResourceNetworkName ( hresource : *const _HRESOURCE , lpbuffer : :: windows_sys::core::PWSTR , nsize : *mut u32 ) -> super::super::Foundation:: BOOL );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterResourceState ( hresource : *const _HRESOURCE , lpsznodename : :: windows_sys::core::PWSTR , lpcchnodename : *mut u32 , lpszgroupname : :: windows_sys::core::PWSTR , lpcchgroupname : *mut u32 ) -> CLUSTER_RESOURCE_STATE );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetClusterResourceTypeKey ( hcluster : *const _HCLUSTER , lpsztypename : :: windows_sys::core::PCWSTR , samdesired : u32 ) -> super::super::System::Registry:: HKEY );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetNodeCloudTypeDW ( ppsznodename : :: windows_sys::core::PCWSTR , nodecloudtype : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetNodeClusterState ( lpsznodename : :: windows_sys::core::PCWSTR , pdwclusterstate : *mut u32 ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn GetNotifyEventHandle ( hchange : *const _HCHANGE , lphtargetevent : *mut super::super::Foundation:: HANDLE ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn InitializeClusterHealthFault ( clusterhealthfault : *mut CLUSTER_HEALTH_FAULT ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn InitializeClusterHealthFaultArray ( clusterhealthfaultarray : *mut CLUSTER_HEALTH_FAULT_ARRAY ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn IsFileOnClusterSharedVolume ( lpszpathname : :: windows_sys::core::PCWSTR , pbfileisonsharedvolume : *mut super::super::Foundation:: BOOL ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn MoveClusterGroup ( hgroup : *const _HGROUP , hdestinationnode : *const _HNODE ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn MoveClusterGroupEx ( hgroup : *const _HGROUP , hdestinationnode : *const _HNODE , dwmoveflags : u32 , lpinbuffer : *const u8 , cbinbuffersize : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OfflineClusterGroup ( hgroup : *const _HGROUP ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OfflineClusterGroupEx ( hgroup : *const _HGROUP , dwofflineflags : u32 , lpinbuffer : *const u8 , cbinbuffersize : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OfflineClusterResource ( hresource : *const _HRESOURCE ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OfflineClusterResourceEx ( hresource : *const _HRESOURCE , dwofflineflags : u32 , lpinbuffer : *const u8 , cbinbuffersize : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OnlineClusterGroup ( hgroup : *const _HGROUP , hdestinationnode : *const _HNODE ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OnlineClusterGroupEx ( hgroup : *const _HGROUP , hdestinationnode : *const _HNODE , dwonlineflags : u32 , lpinbuffer : *const u8 , cbinbuffersize : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OnlineClusterResource ( hresource : *const _HRESOURCE ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OnlineClusterResourceEx ( hresource : *const _HRESOURCE , dwonlineflags : u32 , lpinbuffer : *const u8 , cbinbuffersize : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OpenCluster ( lpszclustername : :: windows_sys::core::PCWSTR ) -> *mut _HCLUSTER );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn OpenClusterCryptProvider ( lpszresource : :: windows_sys::core::PCWSTR , lpszprovider : *const i8 , dwtype : u32 , dwflags : u32 ) -> *mut _HCLUSCRYPTPROVIDER );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn OpenClusterCryptProviderEx ( lpszresource : :: windows_sys::core::PCWSTR , lpszkeyname : :: windows_sys::core::PCWSTR , lpszprovider : *const i8 , dwtype : u32 , dwflags : u32 ) -> *mut _HCLUSCRYPTPROVIDER );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OpenClusterEx ( lpszclustername : :: windows_sys::core::PCWSTR , desiredaccess : u32 , grantedaccess : *mut u32 ) -> *mut _HCLUSTER );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OpenClusterGroup ( hcluster : *const _HCLUSTER , lpszgroupname : :: windows_sys::core::PCWSTR ) -> *mut _HGROUP );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OpenClusterGroupEx ( hcluster : *const _HCLUSTER , lpszgroupname : :: windows_sys::core::PCWSTR , dwdesiredaccess : u32 , lpdwgrantedaccess : *mut u32 ) -> *mut _HGROUP );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OpenClusterGroupSet ( hcluster : *const _HCLUSTER , lpszgroupsetname : :: windows_sys::core::PCWSTR ) -> *mut _HGROUPSET );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OpenClusterNetInterface ( hcluster : *const _HCLUSTER , lpszinterfacename : :: windows_sys::core::PCWSTR ) -> *mut _HNETINTERFACE );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OpenClusterNetInterfaceEx ( hcluster : *const _HCLUSTER , lpszinterfacename : :: windows_sys::core::PCWSTR , dwdesiredaccess : u32 , lpdwgrantedaccess : *mut u32 ) -> *mut _HNETINTERFACE );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OpenClusterNetwork ( hcluster : *const _HCLUSTER , lpsznetworkname : :: windows_sys::core::PCWSTR ) -> *mut _HNETWORK );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OpenClusterNetworkEx ( hcluster : *const _HCLUSTER , lpsznetworkname : :: windows_sys::core::PCWSTR , dwdesiredaccess : u32 , lpdwgrantedaccess : *mut u32 ) -> *mut _HNETWORK );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OpenClusterNode ( hcluster : *const _HCLUSTER , lpsznodename : :: windows_sys::core::PCWSTR ) -> *mut _HNODE );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OpenClusterNodeById ( hcluster : *const _HCLUSTER , nodeid : u32 ) -> *mut _HNODE );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OpenClusterNodeEx ( hcluster : *const _HCLUSTER , lpsznodename : :: windows_sys::core::PCWSTR , dwdesiredaccess : u32 , lpdwgrantedaccess : *mut u32 ) -> *mut _HNODE );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OpenClusterResource ( hcluster : *const _HCLUSTER , lpszresourcename : :: windows_sys::core::PCWSTR ) -> *mut _HRESOURCE );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn OpenClusterResourceEx ( hcluster : *const _HCLUSTER , lpszresourcename : :: windows_sys::core::PCWSTR , dwdesiredaccess : u32 , lpdwgrantedaccess : *mut u32 ) -> *mut _HRESOURCE );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn PauseClusterNode ( hnode : *const _HNODE ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn PauseClusterNodeEx ( hnode : *const _HNODE , bdrainnode : super::super::Foundation:: BOOL , dwpauseflags : u32 , hnodedraintarget : *const _HNODE ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "ntlanman.dll" ,"system" fn QueryAppInstanceVersion ( appinstanceid : *const :: windows_sys::core::GUID , instanceversionhigh : *mut u64 , instanceversionlow : *mut u64 , versionstatus : *mut super::super::Foundation:: NTSTATUS ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "ntlanman.dll" ,"system" fn RegisterAppInstance ( processhandle : super::super::Foundation:: HANDLE , appinstanceid : *const :: windows_sys::core::GUID , childreninheritappinstance : super::super::Foundation:: BOOL ) -> u32 );
::windows_sys::core::windows_link ! ( "ntlanman.dll" ,"system" fn RegisterAppInstanceVersion ( appinstanceid : *const :: windows_sys::core::GUID , instanceversionhigh : u64 , instanceversionlow : u64 ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn RegisterClusterNotify ( hchange : *const _HCHANGE , dwfiltertype : u32 , hobject : super::super::Foundation:: HANDLE , dwnotifykey : usize ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn RegisterClusterNotifyV2 ( hchange : *const _HCHANGE , filter : NOTIFY_FILTER_AND_TYPE , hobject : super::super::Foundation:: HANDLE , dwnotifykey : usize ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn RegisterClusterResourceTypeNotifyV2 ( hchange : *const _HCHANGE , hcluster : *const _HCLUSTER , flags : i64 , restypename : :: windows_sys::core::PCWSTR , dwnotifykey : usize ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn RemoveClusterGroupDependency ( hgroup : *const _HGROUP , hdependson : *const _HGROUP ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn RemoveClusterGroupSetDependency ( hgroupset : *const _HGROUPSET , hdependson : *const _HGROUPSET ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn RemoveClusterGroupToGroupSetDependency ( hgroup : *const _HGROUP , hdependson : *const _HGROUPSET ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn RemoveClusterNameAccount ( hcluster : *const _HCLUSTER , bdeletecomputerobjects : super::super::Foundation:: BOOL ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn RemoveClusterResourceDependency ( hresource : *const _HRESOURCE , hdependson : *const _HRESOURCE ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn RemoveClusterResourceNode ( hresource : *const _HRESOURCE , hnode : *const _HNODE ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn RemoveClusterStorageNode ( hcluster : *const _HCLUSTER , lpszclusterstorageenclosurename : :: windows_sys::core::PCWSTR , dwtimeout : u32 , dwflags : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn RemoveCrossClusterGroupSetDependency ( hdependentgroupset : *const _HGROUPSET , lpremoteclustername : :: windows_sys::core::PCWSTR , lpremotegroupsetname : :: windows_sys::core::PCWSTR ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn RemoveResourceFromClusterSharedVolumes ( hresource : *const _HRESOURCE ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Registry"))]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilAddUnknownProperties ( hkeyclusterkey : super::super::System::Registry:: HKEY , ppropertytable : *const RESUTIL_PROPERTY_ITEM , poutpropertylist : *mut ::core::ffi::c_void , pcboutpropertylistsize : u32 , pcbbytesreturned : *mut u32 , pcbrequired : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilCreateDirectoryTree ( pszpath : :: windows_sys::core::PCWSTR ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilDupGroup ( group : *mut _HGROUP , copy : *mut *mut _HGROUP ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilDupParameterBlock ( poutparams : *mut u8 , pinparams : *const u8 , ppropertytable : *const RESUTIL_PROPERTY_ITEM ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilDupResource ( group : *mut _HRESOURCE , copy : *mut *mut _HRESOURCE ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilDupString ( pszinstring : :: windows_sys::core::PCWSTR ) -> :: windows_sys::core::PWSTR );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilEnumGroups ( hcluster : *mut _HCLUSTER , hself : *mut _HGROUP , prescallback : LPGROUP_CALLBACK_EX , pparameter : *mut ::core::ffi::c_void ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilEnumGroupsEx ( hcluster : *mut _HCLUSTER , hself : *mut _HGROUP , grouptype : CLUSGROUP_TYPE , prescallback : LPGROUP_CALLBACK_EX , pparameter : *mut ::core::ffi::c_void ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilEnumPrivateProperties ( hkeyclusterkey : super::super::System::Registry:: HKEY , pszoutproperties : :: windows_sys::core::PWSTR , cboutpropertiessize : u32 , pcbbytesreturned : *mut u32 , pcbrequired : *mut u32 ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilEnumProperties ( ppropertytable : *const RESUTIL_PROPERTY_ITEM , pszoutproperties : :: windows_sys::core::PWSTR , cboutpropertiessize : u32 , pcbbytesreturned : *mut u32 , pcbrequired : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilEnumResources ( hself : *mut _HRESOURCE , lpszrestypename : :: windows_sys::core::PCWSTR , prescallback : LPRESOURCE_CALLBACK , pparameter : *mut ::core::ffi::c_void ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilEnumResourcesEx ( hcluster : *mut _HCLUSTER , hself : *mut _HRESOURCE , lpszrestypename : :: windows_sys::core::PCWSTR , prescallback : LPRESOURCE_CALLBACK_EX , pparameter : *mut ::core::ffi::c_void ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilEnumResourcesEx2 ( hcluster : *mut _HCLUSTER , hself : *mut _HRESOURCE , lpszrestypename : :: windows_sys::core::PCWSTR , prescallback : LPRESOURCE_CALLBACK_EX , pparameter : *mut ::core::ffi::c_void , dwdesiredaccess : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilExpandEnvironmentStrings ( pszsrc : :: windows_sys::core::PCWSTR ) -> :: windows_sys::core::PWSTR );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilFindBinaryProperty ( ppropertylist : *const ::core::ffi::c_void , cbpropertylistsize : u32 , pszpropertyname : :: windows_sys::core::PCWSTR , pbpropertyvalue : *mut *mut u8 , pcbpropertyvaluesize : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilFindDependentDiskResourceDriveLetter ( hcluster : *const _HCLUSTER , hresource : *const _HRESOURCE , pszdriveletter : :: windows_sys::core::PWSTR , pcchdriveletter : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilFindDwordProperty ( ppropertylist : *const ::core::ffi::c_void , cbpropertylistsize : u32 , pszpropertyname : :: windows_sys::core::PCWSTR , pdwpropertyvalue : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilFindExpandSzProperty ( ppropertylist : *const ::core::ffi::c_void , cbpropertylistsize : u32 , pszpropertyname : :: windows_sys::core::PCWSTR , pszpropertyvalue : *mut :: windows_sys::core::PWSTR ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilFindExpandedSzProperty ( ppropertylist : *const ::core::ffi::c_void , cbpropertylistsize : u32 , pszpropertyname : :: windows_sys::core::PCWSTR , pszpropertyvalue : *mut :: windows_sys::core::PWSTR ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilFindFileTimeProperty ( ppropertylist : *const ::core::ffi::c_void , cbpropertylistsize : u32 , pszpropertyname : :: windows_sys::core::PCWSTR , pftpropertyvalue : *mut super::super::Foundation:: FILETIME ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilFindLongProperty ( ppropertylist : *const ::core::ffi::c_void , cbpropertylistsize : u32 , pszpropertyname : :: windows_sys::core::PCWSTR , plpropertyvalue : *mut i32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilFindMultiSzProperty ( ppropertylist : *const ::core::ffi::c_void , cbpropertylistsize : u32 , pszpropertyname : :: windows_sys::core::PCWSTR , pszpropertyvalue : *mut :: windows_sys::core::PWSTR , pcbpropertyvaluesize : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilFindSzProperty ( ppropertylist : *const ::core::ffi::c_void , cbpropertylistsize : u32 , pszpropertyname : :: windows_sys::core::PCWSTR , pszpropertyvalue : *mut :: windows_sys::core::PWSTR ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilFindULargeIntegerProperty ( ppropertylist : *const ::core::ffi::c_void , cbpropertylistsize : u32 , pszpropertyname : :: windows_sys::core::PCWSTR , plpropertyvalue : *mut u64 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilFreeEnvironment ( lpenvironment : *mut ::core::ffi::c_void ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilFreeParameterBlock ( poutparams : *mut u8 , pinparams : *const u8 , ppropertytable : *const RESUTIL_PROPERTY_ITEM ) -> ( ) );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Registry"))]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetAllProperties ( hkeyclusterkey : super::super::System::Registry:: HKEY , ppropertytable : *const RESUTIL_PROPERTY_ITEM , poutpropertylist : *mut ::core::ffi::c_void , cboutpropertylistsize : u32 , pcbbytesreturned : *mut u32 , pcbrequired : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetBinaryProperty ( ppboutvalue : *mut *mut u8 , pcboutvaluesize : *mut u32 , pvaluestruct : *const CLUSPROP_BINARY , pboldvalue : *const u8 , cboldvaluesize : u32 , pppropertylist : *mut *mut u8 , pcbpropertylistsize : *mut u32 ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetBinaryValue ( hkeyclusterkey : super::super::System::Registry:: HKEY , pszvaluename : :: windows_sys::core::PCWSTR , ppboutvalue : *mut *mut u8 , pcboutvaluesize : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetClusterGroupType ( hgroup : *mut _HGROUP , grouptype : *mut CLUSGROUP_TYPE ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetClusterId ( hcluster : *mut _HCLUSTER , guid : *mut :: windows_sys::core::GUID ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetClusterRoleState ( hcluster : *const _HCLUSTER , eclusterrole : CLUSTER_ROLE ) -> CLUSTER_ROLE_STATE );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetCoreClusterResources ( hcluster : *const _HCLUSTER , phclusternameresource : *mut *mut _HRESOURCE , phclusteripaddressresource : *mut *mut _HRESOURCE , phclusterquorumresource : *mut *mut _HRESOURCE ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetCoreClusterResourcesEx ( hclusterin : *const _HCLUSTER , phclusternameresourceout : *mut *mut _HRESOURCE , phclusterquorumresourceout : *mut *mut _HRESOURCE , dwdesiredaccess : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetCoreGroup ( hcluster : *mut _HCLUSTER ) -> *mut _HGROUP );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetDwordProperty ( pdwoutvalue : *mut u32 , pvaluestruct : *const CLUSPROP_DWORD , dwoldvalue : u32 , dwminimum : u32 , dwmaximum : u32 , pppropertylist : *mut *mut u8 , pcbpropertylistsize : *mut u32 ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetDwordValue ( hkeyclusterkey : super::super::System::Registry:: HKEY , pszvaluename : :: windows_sys::core::PCWSTR , pdwoutvalue : *mut u32 , dwdefaultvalue : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetEnvironmentWithNetName ( hresource : *const _HRESOURCE ) -> *mut ::core::ffi::c_void );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetFileTimeProperty ( pftoutvalue : *mut super::super::Foundation:: FILETIME , pvaluestruct : *const CLUSPROP_FILETIME , ftoldvalue : super::super::Foundation:: FILETIME , ftminimum : super::super::Foundation:: FILETIME , ftmaximum : super::super::Foundation:: FILETIME , pppropertylist : *mut *mut u8 , pcbpropertylistsize : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetLongProperty ( ploutvalue : *mut i32 , pvaluestruct : *const CLUSPROP_LONG , loldvalue : i32 , lminimum : i32 , lmaximum : i32 , pppropertylist : *mut *mut u8 , pcbpropertylistsize : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetMultiSzProperty ( ppszoutvalue : *mut :: windows_sys::core::PWSTR , pcboutvaluesize : *mut u32 , pvaluestruct : *const CLUSPROP_SZ , pszoldvalue : :: windows_sys::core::PCWSTR , cboldvaluesize : u32 , pppropertylist : *mut *mut u8 , pcbpropertylistsize : *mut u32 ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetPrivateProperties ( hkeyclusterkey : super::super::System::Registry:: HKEY , poutpropertylist : *mut ::core::ffi::c_void , cboutpropertylistsize : u32 , pcbbytesreturned : *mut u32 , pcbrequired : *mut u32 ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Registry"))]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetProperties ( hkeyclusterkey : super::super::System::Registry:: HKEY , ppropertytable : *const RESUTIL_PROPERTY_ITEM , poutpropertylist : *mut ::core::ffi::c_void , cboutpropertylistsize : u32 , pcbbytesreturned : *mut u32 , pcbrequired : *mut u32 ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Registry"))]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetPropertiesToParameterBlock ( hkeyclusterkey : super::super::System::Registry:: HKEY , ppropertytable : *const RESUTIL_PROPERTY_ITEM , poutparams : *mut u8 , bcheckforrequiredproperties : super::super::Foundation:: BOOL , psznameofpropinerror : *mut :: windows_sys::core::PWSTR ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Registry"))]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetProperty ( hkeyclusterkey : super::super::System::Registry:: HKEY , ppropertytableitem : *const RESUTIL_PROPERTY_ITEM , poutpropertyitem : *mut *mut ::core::ffi::c_void , pcboutpropertyitemsize : *mut u32 ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetPropertyFormats ( ppropertytable : *const RESUTIL_PROPERTY_ITEM , poutpropertyformatlist : *mut ::core::ffi::c_void , cbpropertyformatlistsize : u32 , pcbbytesreturned : *mut u32 , pcbrequired : *mut u32 ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Registry"))]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetPropertySize ( hkeyclusterkey : super::super::System::Registry:: HKEY , ppropertytableitem : *const RESUTIL_PROPERTY_ITEM , pcboutpropertylistsize : *mut u32 , pnpropertycount : *mut u32 ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetQwordValue ( hkeyclusterkey : super::super::System::Registry:: HKEY , pszvaluename : :: windows_sys::core::PCWSTR , pqwoutvalue : *mut u64 , qwdefaultvalue : u64 ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetResourceDependency ( hself : super::super::Foundation:: HANDLE , lpszresourcetype : :: windows_sys::core::PCWSTR ) -> *mut _HRESOURCE );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetResourceDependencyByClass ( hcluster : *mut _HCLUSTER , hself : super::super::Foundation:: HANDLE , prci : *mut CLUS_RESOURCE_CLASS_INFO , brecurse : super::super::Foundation:: BOOL ) -> *mut _HRESOURCE );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetResourceDependencyByClassEx ( hcluster : *mut _HCLUSTER , hself : super::super::Foundation:: HANDLE , prci : *mut CLUS_RESOURCE_CLASS_INFO , brecurse : super::super::Foundation:: BOOL , dwdesiredaccess : u32 ) -> *mut _HRESOURCE );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetResourceDependencyByName ( hcluster : *mut _HCLUSTER , hself : super::super::Foundation:: HANDLE , lpszresourcetype : :: windows_sys::core::PCWSTR , brecurse : super::super::Foundation:: BOOL ) -> *mut _HRESOURCE );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetResourceDependencyByNameEx ( hcluster : *mut _HCLUSTER , hself : super::super::Foundation:: HANDLE , lpszresourcetype : :: windows_sys::core::PCWSTR , brecurse : super::super::Foundation:: BOOL , dwdesiredaccess : u32 ) -> *mut _HRESOURCE );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetResourceDependencyEx ( hself : super::super::Foundation:: HANDLE , lpszresourcetype : :: windows_sys::core::PCWSTR , dwdesiredaccess : u32 ) -> *mut _HRESOURCE );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetResourceDependentIPAddressProps ( hresource : *const _HRESOURCE , pszaddress : :: windows_sys::core::PWSTR , pcchaddress : *mut u32 , pszsubnetmask : :: windows_sys::core::PWSTR , pcchsubnetmask : *mut u32 , psznetwork : :: windows_sys::core::PWSTR , pcchnetwork : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetResourceName ( hresource : *const _HRESOURCE , pszresourcename : :: windows_sys::core::PWSTR , pcchresourcenameinout : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetResourceNameDependency ( lpszresourcename : :: windows_sys::core::PCWSTR , lpszresourcetype : :: windows_sys::core::PCWSTR ) -> *mut _HRESOURCE );
...
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetSzProperty ( ppszoutvalue : *mut :: windows_sys::core::PWSTR , pvaluestruct : *const CLUSPROP_SZ , pszoldvalue : :: windows_sys::core::PCWSTR , pppropertylist : *mut *mut u8 , pcbpropertylistsize : *mut u32 ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGetSzValue ( hkeyclusterkey : super::super::System::Registry:: HKEY , pszvaluename : :: windows_sys::core::PCWSTR ) -> :: windows_sys::core::PWSTR );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilGroupsEqual ( hself : *mut _HGROUP , hgroup : *mut _HGROUP , pequal : *mut super::super::Foundation:: BOOL ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilIsPathValid ( pszpath : :: windows_sys::core::PCWSTR ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilIsResourceClassEqual ( prci : *mut CLUS_RESOURCE_CLASS_INFO , hresource : *mut _HRESOURCE ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilLeftPaxosIsLessThanRight ( left : *const PaxosTagCStruct , right : *const PaxosTagCStruct ) -> super::super::Foundation:: BOOL );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilNodeEnum ( hcluster : *mut _HCLUSTER , pnodecallback : LPNODE_CALLBACK , pparameter : *mut ::core::ffi::c_void ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilPaxosComparer ( left : *const PaxosTagCStruct , right : *const PaxosTagCStruct ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilPropertyListFromParameterBlock ( ppropertytable : *const RESUTIL_PROPERTY_ITEM , poutpropertylist : *mut ::core::ffi::c_void , pcboutpropertylistsize : *mut u32 , pinparams : *const u8 , pcbbytesreturned : *mut u32 , pcbrequired : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilRemoveResourceServiceEnvironment ( pszservicename : :: windows_sys::core::PCWSTR , pfnlogevent : PLOG_EVENT_ROUTINE , hresourcehandle : isize ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilResourceDepEnum ( hself : *mut _HRESOURCE , enumtype : u32 , prescallback : LPRESOURCE_CALLBACK_EX , pparameter : *mut ::core::ffi::c_void ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilResourceTypesEqual ( lpszresourcetypename : :: windows_sys::core::PCWSTR , hresource : *mut _HRESOURCE ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilResourcesEqual ( hself : *mut _HRESOURCE , hresource : *mut _HRESOURCE ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilSetBinaryValue ( hkeyclusterkey : super::super::System::Registry:: HKEY , pszvaluename : :: windows_sys::core::PCWSTR , pbnewvalue : *const u8 , cbnewvaluesize : u32 , ppboutvalue : *mut *mut u8 , pcboutvaluesize : *mut u32 ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilSetDwordValue ( hkeyclusterkey : super::super::System::Registry:: HKEY , pszvaluename : :: windows_sys::core::PCWSTR , dwnewvalue : u32 , pdwoutvalue : *mut u32 ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilSetExpandSzValue ( hkeyclusterkey : super::super::System::Registry:: HKEY , pszvaluename : :: windows_sys::core::PCWSTR , psznewvalue : :: windows_sys::core::PCWSTR , ppszoutstring : *mut :: windows_sys::core::PWSTR ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilSetMultiSzValue ( hkeyclusterkey : super::super::System::Registry:: HKEY , pszvaluename : :: windows_sys::core::PCWSTR , psznewvalue : :: windows_sys::core::PCWSTR , cbnewvaluesize : u32 , ppszoutvalue : *mut :: windows_sys::core::PWSTR , pcboutvaluesize : *mut u32 ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilSetPrivatePropertyList ( hkeyclusterkey : super::super::System::Registry:: HKEY , pinpropertylist : *const ::core::ffi::c_void , cbinpropertylistsize : u32 ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Registry"))]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilSetPropertyParameterBlock ( hkeyclusterkey : super::super::System::Registry:: HKEY , ppropertytable : *const RESUTIL_PROPERTY_ITEM , reserved : *mut ::core::ffi::c_void , pinparams : *const u8 , pinpropertylist : *const ::core::ffi::c_void , cbinpropertylistsize : u32 , poutparams : *mut u8 ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Registry"))]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilSetPropertyParameterBlockEx ( hkeyclusterkey : super::super::System::Registry:: HKEY , ppropertytable : *const RESUTIL_PROPERTY_ITEM , reserved : *mut ::core::ffi::c_void , pinparams : *const u8 , pinpropertylist : *const ::core::ffi::c_void , cbinpropertylistsize : u32 , bforcewrite : super::super::Foundation:: BOOL , poutparams : *mut u8 ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Registry"))]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilSetPropertyTable ( hkeyclusterkey : super::super::System::Registry:: HKEY , ppropertytable : *const RESUTIL_PROPERTY_ITEM , reserved : *mut ::core::ffi::c_void , ballowunknownproperties : super::super::Foundation:: BOOL , pinpropertylist : *const ::core::ffi::c_void , cbinpropertylistsize : u32 , poutparams : *mut u8 ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Registry"))]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilSetPropertyTableEx ( hkeyclusterkey : super::super::System::Registry:: HKEY , ppropertytable : *const RESUTIL_PROPERTY_ITEM , reserved : *mut ::core::ffi::c_void , ballowunknownproperties : super::super::Foundation:: BOOL , pinpropertylist : *const ::core::ffi::c_void , cbinpropertylistsize : u32 , bforcewrite : super::super::Foundation:: BOOL , poutparams : *mut u8 ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilSetQwordValue ( hkeyclusterkey : super::super::System::Registry:: HKEY , pszvaluename : :: windows_sys::core::PCWSTR , qwnewvalue : u64 , pqwoutvalue : *mut u64 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilSetResourceServiceEnvironment ( pszservicename : :: windows_sys::core::PCWSTR , hresource : *mut _HRESOURCE , pfnlogevent : PLOG_EVENT_ROUTINE , hresourcehandle : isize ) -> u32 );
#[cfg(feature = "Win32_Security")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilSetResourceServiceStartParameters ( pszservicename : :: windows_sys::core::PCWSTR , schscmhandle : super::super::Security:: SC_HANDLE , phservice : *mut isize , pfnlogevent : PLOG_EVENT_ROUTINE , hresourcehandle : isize ) -> u32 );
#[cfg(feature = "Win32_Security")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilSetResourceServiceStartParametersEx ( pszservicename : :: windows_sys::core::PCWSTR , schscmhandle : super::super::Security:: SC_HANDLE , phservice : *mut isize , dwdesiredaccess : u32 , pfnlogevent : PLOG_EVENT_ROUTINE , hresourcehandle : isize ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilSetSzValue ( hkeyclusterkey : super::super::System::Registry:: HKEY , pszvaluename : :: windows_sys::core::PCWSTR , psznewvalue : :: windows_sys::core::PCWSTR , ppszoutstring : *mut :: windows_sys::core::PWSTR ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Registry"))]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilSetUnknownProperties ( hkeyclusterkey : super::super::System::Registry:: HKEY , ppropertytable : *const RESUTIL_PROPERTY_ITEM , pinpropertylist : *const ::core::ffi::c_void , cbinpropertylistsize : u32 ) -> u32 );
#[cfg(feature = "Win32_System_Registry")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilSetValueEx ( hkeyclusterkey : super::super::System::Registry:: HKEY , valuename : :: windows_sys::core::PCWSTR , valuetype : u32 , valuedata : *const u8 , valuesize : u32 , flags : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilStartResourceService ( pszservicename : :: windows_sys::core::PCWSTR , phservicehandle : *mut isize ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilStopResourceService ( pszservicename : :: windows_sys::core::PCWSTR ) -> u32 );
#[cfg(feature = "Win32_Security")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilStopService ( hservicehandle : super::super::Security:: SC_HANDLE ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilTerminateServiceProcessFromResDll ( dwservicepid : u32 , boffline : super::super::Foundation:: BOOL , pdwresourcestate : *mut u32 , pfnlogevent : PLOG_EVENT_ROUTINE , hresourcehandle : isize ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilVerifyPrivatePropertyList ( pinpropertylist : *const ::core::ffi::c_void , cbinpropertylistsize : u32 ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilVerifyPropertyTable ( ppropertytable : *const RESUTIL_PROPERTY_ITEM , reserved : *mut ::core::ffi::c_void , ballowunknownproperties : super::super::Foundation:: BOOL , pinpropertylist : *const ::core::ffi::c_void , cbinpropertylistsize : u32 , poutparams : *mut u8 ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilVerifyResourceService ( pszservicename : :: windows_sys::core::PCWSTR ) -> u32 );
#[cfg(feature = "Win32_Security")]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilVerifyService ( hservicehandle : super::super::Security:: SC_HANDLE ) -> u32 );
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilVerifyShutdownSafe ( flags : u32 , reason : u32 , presult : *mut u32 ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Registry"))]
::windows_sys::core::windows_link ! ( "resutils.dll" ,"system" fn ResUtilsDeleteKeyTree ( key : super::super::System::Registry:: HKEY , keyname : :: windows_sys::core::PCWSTR , treatnokeyaserror : super::super::Foundation:: BOOL ) -> u32 );
::windows_sys::core::windows_link ! ( "ntlanman.dll" ,"system" fn ResetAllAppInstanceVersions ( ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn RestartClusterResource ( hresource : *const _HRESOURCE , dwflags : u32 ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn RestoreClusterDatabase ( lpszpathname : :: windows_sys::core::PCWSTR , bforce : super::super::Foundation:: BOOL , lpszquorumdriveletter : :: windows_sys::core::PCWSTR ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ResumeClusterNode ( hnode : *const _HNODE ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn ResumeClusterNodeEx ( hnode : *const _HNODE , eresumefailbacktype : CLUSTER_NODE_RESUME_FAILBACK_TYPE , dwresumeflagsreserved : u32 ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "ntlanman.dll" ,"system" fn SetAppInstanceCsvFlags ( processhandle : super::super::Foundation:: HANDLE , mask : u32 , flags : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn SetClusterGroupName ( hgroup : *const _HGROUP , lpszgroupname : :: windows_sys::core::PCWSTR ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn SetClusterGroupNodeList ( hgroup : *const _HGROUP , nodecount : u32 , nodelist : *const *const _HNODE ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn SetClusterGroupSetDependencyExpression ( hgroupset : *const _HGROUPSET , lpszdependencyexprssion : :: windows_sys::core::PCWSTR ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn SetClusterName ( hcluster : *const _HCLUSTER , lpsznewclustername : :: windows_sys::core::PCWSTR ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn SetClusterNetworkName ( hnetwork : *const _HNETWORK , lpszname : :: windows_sys::core::PCWSTR ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn SetClusterNetworkPriorityOrder ( hcluster : *const _HCLUSTER , networkcount : u32 , networklist : *const *const _HNETWORK ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn SetClusterQuorumResource ( hresource : *const _HRESOURCE , lpszdevicename : :: windows_sys::core::PCWSTR , dwmaxquologsize : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn SetClusterResourceDependencyExpression ( hresource : *const _HRESOURCE , lpszdependencyexpression : :: windows_sys::core::PCWSTR ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn SetClusterResourceName ( hresource : *const _HRESOURCE , lpszresourcename : :: windows_sys::core::PCWSTR ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn SetClusterServiceAccountPassword ( lpszclustername : :: windows_sys::core::PCWSTR , lpsznewpassword : :: windows_sys::core::PCWSTR , dwflags : u32 , lpreturnstatusbuffer : *mut CLUSTER_SET_PASSWORD_STATUS , lpcbreturnstatusbuffersize : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "clusapi.dll" ,"system" fn SetGroupDependencyExpression ( hgroup : *const _HGROUP , lpszdependencyexpression : :: windows_sys::core::PCWSTR ) -> u32 );
