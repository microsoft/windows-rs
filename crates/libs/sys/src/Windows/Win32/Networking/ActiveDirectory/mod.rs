...
#[doc = "*Required features: 'Win32_Networking_ActiveDirectory'*"]
pub const GUID_PRIVILEGED_ACCESS_MANAGEMENT_OPTIONAL_FEATURE_BYTE: &'static str = "s\u{e8}C\u{ec}\u{e8}\u{cc}@F\u{b4}\u{ab}\u{7}\u{ff}\u{e4}\u{ab}[\u{cd}";
#[doc = "*Required features: 'Win32_Networking_ActiveDirectory'*"]
...
#[doc = "*Required features: 'Win32_Networking_ActiveDirectory'*"]
pub const GUID_RECYCLE_BIN_OPTIONAL_FEATURE_BYTE: &'static str = "\u{d8}\u{dc}mv\u{d0}\u{ac}^D\u{f3}\u{b9}\u{a7}\u{f9}\u{b6}tO*";
#[doc = "*Required features: 'Win32_Networking_ActiveDirectory'*"]
