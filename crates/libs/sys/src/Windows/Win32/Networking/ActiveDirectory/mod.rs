...
pub struct ADSPROPINITPARAMS {
    ...
    pub dwFlags: u32,
    pub hr: windows_sys::core::HRESULT,
    pub pDsObj: core::mem::ManuallyDrop<*mut core::ffi::c_void>,
...
pub const ADSTYPE_BACKLINK: ADSTYPE = 18;
pub const ADSTYPE_BOOLEAN: ADSTYPE = 6;
pub const ADSTYPE_CASEIGNORE_LIST: ADSTYPE = 13;
pub const ADSTYPE_CASE_EXACT_STRING: ADSTYPE = 2;
pub const ADSTYPE_CASE_IGNORE_STRING: ADSTYPE = 3;
pub const ADSTYPE_DN_STRING: ADSTYPE = 1;
pub const ADSTYPE_DN_WITH_BINARY: ADSTYPE = 27;
pub const ADSTYPE_DN_WITH_STRING: ADSTYPE = 28;
pub const ADSTYPE_EMAIL: ADSTYPE = 24;
pub const ADSTYPE_FAXNUMBER: ADSTYPE = 23;
pub const ADSTYPE_HOLD: ADSTYPE = 20;
pub const ADSTYPE_INTEGER: ADSTYPE = 7;
pub const ADSTYPE_INVALID: ADSTYPE = 0;
pub const ADSTYPE_LARGE_INTEGER: ADSTYPE = 10;
pub const ADSTYPE_NETADDRESS: ADSTYPE = 21;
pub const ADSTYPE_NT_SECURITY_DESCRIPTOR: ADSTYPE = 25;
pub const ADSTYPE_NUMERIC_STRING: ADSTYPE = 5;
pub const ADSTYPE_OBJECT_CLASS: ADSTYPE = 12;
pub const ADSTYPE_OCTET_LIST: ADSTYPE = 14;
pub const ADSTYPE_OCTET_STRING: ADSTYPE = 8;
pub const ADSTYPE_PATH: ADSTYPE = 15;
pub const ADSTYPE_POSTALADDRESS: ADSTYPE = 16;
pub const ADSTYPE_PRINTABLE_STRING: ADSTYPE = 4;
pub const ADSTYPE_PROV_SPECIFIC: ADSTYPE = 11;
pub const ADSTYPE_REPLICAPOINTER: ADSTYPE = 22;
pub const ADSTYPE_TIMESTAMP: ADSTYPE = 17;
pub const ADSTYPE_TYPEDNAME: ADSTYPE = 19;
pub const ADSTYPE_UNKNOWN: ADSTYPE = 26;
pub const ADSTYPE_UTC_TIME: ADSTYPE = 9;
#[repr(C)]
#[derive(Clone, Copy)]
pub struct ADSVALUE {
    pub dwType: ADSTYPE,
...
pub const DSBM_QUERYINSERT: u32 = 100;
...
pub const DSQPM_GETCLASSLIST: u32 = 268435456;
pub const DSQPM_HELPTOPICS: u32 = 268435457;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const FACILITY_BACKUP: u32 = 2047;
pub const FACILITY_NTDSB: u32 = 2048;
pub const FACILITY_SYSTEM: u32 = 0;
...
pub struct OPENQUERYWINDOW {
    ...
    pub pPersistQuery: core::mem::ManuallyDrop<*mut core::ffi::c_void>,
...
pub union OPENQUERYWINDOW_0 {
    ...
    pub ppbFormParameters: core::mem::ManuallyDrop<*mut core::ffi::c_void>,
}
#[cfg(feature = "Win32_System_Com_StructuredStorage")]
...
pub const WM_ADSPROP_NOTIFY_APPLY: u32 = 2128;
pub const WM_ADSPROP_NOTIFY_CHANGE: u32 = 2127;
pub const WM_ADSPROP_NOTIFY_ERROR: u32 = 2134;
pub const WM_ADSPROP_NOTIFY_EXIT: u32 = 2131;
pub const WM_ADSPROP_NOTIFY_FOREGROUND: u32 = 2130;
pub const WM_ADSPROP_NOTIFY_PAGEHWND: u32 = 2126;
pub const WM_ADSPROP_NOTIFY_PAGEINIT: u32 = 2125;
pub const WM_ADSPROP_NOTIFY_SETFOCUS: u32 = 2129;
