windows_link::link!("wininet.dll" "system" fn AppCacheCheckManifest(pwszmasterurl : windows_sys::core::PCWSTR, pwszmanifesturl : windows_sys::core::PCWSTR, pbmanifestdata : *mut u8, dwmanifestdatasize : u32, pbmanifestresponseheaders : *mut u8, dwmanifestresponseheaderssize : u32, pestate : *mut APP_CACHE_STATE, phnewappcache : *mut *mut core::ffi::c_void) -> u32);
windows_link::link!("wininet.dll" "system" fn AppCacheCloseHandle(happcache : *const core::ffi::c_void));
windows_link::link!("wininet.dll" "system" fn AppCacheCreateAndCommitFile(happcache : *mut core::ffi::c_void, pwszsourcefilepath : windows_sys::core::PCWSTR, pwszurl : windows_sys::core::PCWSTR, pbresponseheaders : *mut u8, dwresponseheaderssize : u32) -> u32);
...
windows_link::link!("wininet.dll" "system" fn AppCacheFinalize(happcache : *mut core::ffi::c_void, pbmanifestdata : *mut u8, dwmanifestdatasize : u32, pestate : *mut APP_CACHE_FINALIZE_STATE) -> u32);
...
windows_link::link!("wininet.dll" "system" fn AppCacheGetDownloadList(happcache : *mut core::ffi::c_void, pdownloadlist : *mut APP_CACHE_DOWNLOAD_LIST) -> u32);
...
windows_link::link!("wininet.dll" "system" fn CreateUrlCacheContainerW(name : windows_sys::core::PCWSTR, lpcacheprefix : windows_sys::core::PCWSTR, lpszcachepath : windows_sys::core::PCWSTR, kbcachelimit : u32, dwcontainertype : u32, dwoptions : u32, pvbuffer : *mut core::ffi::c_void, cbbuffer : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn CreateUrlCacheEntryExW(lpszurlname : windows_sys::core::PCWSTR, dwexpectedfilesize : u32, lpszfileextension : windows_sys::core::PCWSTR, lpszfilename : windows_sys::core::PCWSTR, dwreserved : u32, fpreserveincomingfilename : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn CreateUrlCacheEntryW(lpszurlname : windows_sys::core::PCWSTR, dwexpectedfilesize : u32, lpszfileextension : windows_sys::core::PCWSTR, lpszfilename : windows_sys::core::PCWSTR, dwreserved : u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn CreateUrlCacheGroup(dwflags : u32, lpreserved : *mut core::ffi::c_void) -> i64);
...
windows_link::link!("wininet.dll" "system" fn DeleteUrlCacheGroup(groupid : i64, dwflags : u32, lpreserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn FtpCommandA(hconnect : *mut core::ffi::c_void, fexpectresponse : windows_sys::core::BOOL, dwflags : FTP_FLAGS, lpszcommand : windows_sys::core::PCSTR, dwcontext : usize, phftpcommand : *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn FtpCreateDirectoryW(hconnect : *mut core::ffi::c_void, lpszdirectory : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn FtpGetCurrentDirectoryW(hconnect : *mut core::ffi::c_void, lpszcurrentdirectory : windows_sys::core::PCWSTR, lpdwcurrentdirectory : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn FtpGetFileA(hconnect : *mut core::ffi::c_void, lpszremotefile : windows_sys::core::PCSTR, lpsznewfile : windows_sys::core::PCSTR, ffailifexists : windows_sys::core::BOOL, dwflagsandattributes : u32, dwflags : u32, dwcontext : usize) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn FtpGetFileW(hconnect : *mut core::ffi::c_void, lpszremotefile : windows_sys::core::PCWSTR, lpsznewfile : windows_sys::core::PCWSTR, ffailifexists : windows_sys::core::BOOL, dwflagsandattributes : u32, dwflags : u32, dwcontext : usize) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn FtpOpenFileA(hconnect : *mut core::ffi::c_void, lpszfilename : windows_sys::core::PCSTR, dwaccess : u32, dwflags : FTP_FLAGS, dwcontext : usize) -> *mut core::ffi::c_void);
...
windows_link::link!("wininet.dll" "system" fn FtpPutFileA(hconnect : *mut core::ffi::c_void, lpszlocalfile : windows_sys::core::PCSTR, lpsznewremotefile : windows_sys::core::PCSTR, dwflags : FTP_FLAGS, dwcontext : usize) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn FtpPutFileEx(hftpsession : *mut core::ffi::c_void, lpszlocalfile : windows_sys::core::PCWSTR, lpsznewremotefile : windows_sys::core::PCSTR, dwflags : u32, dwcontext : usize) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn FtpPutFileW(hconnect : *mut core::ffi::c_void, lpszlocalfile : windows_sys::core::PCWSTR, lpsznewremotefile : windows_sys::core::PCWSTR, dwflags : FTP_FLAGS, dwcontext : usize) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn FtpRemoveDirectoryA(hconnect : *mut core::ffi::c_void, lpszdirectory : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn FtpRemoveDirectoryW(hconnect : *mut core::ffi::c_void, lpszdirectory : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn FtpRenameFileW(hconnect : *mut core::ffi::c_void, lpszexisting : windows_sys::core::PCWSTR, lpsznew : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn FtpSetCurrentDirectoryA(hconnect : *mut core::ffi::c_void, lpszdirectory : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn FtpSetCurrentDirectoryW(hconnect : *mut core::ffi::c_void, lpszdirectory : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn GetUrlCacheEntryInfoExA(lpszurl : windows_sys::core::PCSTR, lpcacheentryinfo : *mut INTERNET_CACHE_ENTRY_INFOA, lpcbcacheentryinfo : *mut u32, lpszredirecturl : windows_sys::core::PCSTR, lpcbredirecturl : *mut u32, lpreserved : *mut core::ffi::c_void, dwflags : u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn GetUrlCacheEntryInfoExW(lpszurl : windows_sys::core::PCWSTR, lpcacheentryinfo : *mut INTERNET_CACHE_ENTRY_INFOW, lpcbcacheentryinfo : *mut u32, lpszredirecturl : windows_sys::core::PCWSTR, lpcbredirecturl : *mut u32, lpreserved : *mut core::ffi::c_void, dwflags : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn GetUrlCacheGroupAttributeA(gid : i64, dwflags : u32, dwattributes : u32, lpgroupinfo : *mut INTERNET_CACHE_GROUP_INFOA, lpcbgroupinfo : *mut u32, lpreserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn GetUrlCacheGroupAttributeW(gid : i64, dwflags : u32, dwattributes : u32, lpgroupinfo : *mut INTERNET_CACHE_GROUP_INFOW, lpcbgroupinfo : *mut u32, lpreserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn GetUrlCacheHeaderData(nidx : u32, lpdwdata : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn GopherCreateLocatorA(lpszhost : windows_sys::core::PCSTR, nserverport : u16, lpszdisplaystring : windows_sys::core::PCSTR, lpszselectorstring : windows_sys::core::PCSTR, dwgophertype : u32, lpszlocator : windows_sys::core::PCSTR, lpdwbufferlength : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn GopherCreateLocatorW(lpszhost : windows_sys::core::PCWSTR, nserverport : u16, lpszdisplaystring : windows_sys::core::PCWSTR, lpszselectorstring : windows_sys::core::PCWSTR, dwgophertype : u32, lpszlocator : windows_sys::core::PCWSTR, lpdwbufferlength : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn GopherGetAttributeA(hconnect : *mut core::ffi::c_void, lpszlocator : windows_sys::core::PCSTR, lpszattributename : windows_sys::core::PCSTR, lpbuffer : *mut u8, dwbufferlength : u32, lpdwcharactersreturned : *mut u32, lpfnenumerator : GOPHER_ATTRIBUTE_ENUMERATOR, dwcontext : usize) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn GopherGetAttributeW(hconnect : *mut core::ffi::c_void, lpszlocator : windows_sys::core::PCWSTR, lpszattributename : windows_sys::core::PCWSTR, lpbuffer : *mut u8, dwbufferlength : u32, lpdwcharactersreturned : *mut u32, lpfnenumerator : GOPHER_ATTRIBUTE_ENUMERATOR, dwcontext : usize) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn GopherOpenFileA(hconnect : *mut core::ffi::c_void, lpszlocator : windows_sys::core::PCSTR, lpszview : windows_sys::core::PCSTR, dwflags : u32, dwcontext : usize) -> *mut core::ffi::c_void);
...
windows_link::link!("wininet.dll" "system" fn HttpAddRequestHeadersA(hrequest : *mut core::ffi::c_void, lpszheaders : windows_sys::core::PCSTR, dwheaderslength : u32, dwmodifiers : HTTP_ADDREQ_FLAG) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn HttpCheckDavComplianceW(lpszurl : windows_sys::core::PCWSTR, lpszcompliancetoken : windows_sys::core::PCWSTR, lpffound : *mut windows_sys::core::BOOL, hwnd : super::super::Foundation:: HWND, lpvreserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn HttpCloseDependencyHandle(hdependencyhandle : *mut core::ffi::c_void));
windows_link::link!("wininet.dll" "system" fn HttpDuplicateDependencyHandle(hdependencyhandle : *mut core::ffi::c_void, phduplicateddependencyhandle : *mut *mut core::ffi::c_void) -> u32);
windows_link::link!("wininet.dll" "system" fn HttpEndRequestA(hrequest : *mut core::ffi::c_void, lpbuffersout : *mut INTERNET_BUFFERSA, dwflags : u32, dwcontext : usize) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn HttpIndicatePageLoadComplete(hdependencyhandle : *mut core::ffi::c_void) -> u32);
...
windows_link::link!("wininet.dll" "system" fn HttpPushEnable(hrequest : *mut core::ffi::c_void, ptransportsetting : *mut HTTP_PUSH_TRANSPORT_SETTING, phwait : *mut HTTP_PUSH_WAIT_HANDLE) -> u32);
...
windows_link::link!("wininet.dll" "system" fn HttpQueryInfoW(hrequest : *mut core::ffi::c_void, dwinfolevel : u32, lpbuffer : *mut core::ffi::c_void, lpdwbufferlength : *mut u32, lpdwindex : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn HttpSendRequestA(hrequest : *mut core::ffi::c_void, lpszheaders : windows_sys::core::PCSTR, dwheaderslength : u32, lpoptional : *mut core::ffi::c_void, dwoptionallength : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn HttpSendRequestExW(hrequest : *mut core::ffi::c_void, lpbuffersin : *mut INTERNET_BUFFERSW, lpbuffersout : *mut INTERNET_BUFFERSW, dwflags : u32, dwcontext : usize) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn HttpSendRequestW(hrequest : *mut core::ffi::c_void, lpszheaders : windows_sys::core::PCWSTR, dwheaderslength : u32, lpoptional : *mut core::ffi::c_void, dwoptionallength : u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn HttpWebSocketClose(hwebsocket : *mut core::ffi::c_void, usstatus : u16, pvreason : *mut core::ffi::c_void, dwreasonlength : u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn HttpWebSocketCompleteUpgrade(hrequest : *mut core::ffi::c_void, dwcontext : usize) -> *mut core::ffi::c_void);
windows_link::link!("wininet.dll" "system" fn HttpWebSocketQueryCloseStatus(hwebsocket : *mut core::ffi::c_void, pusstatus : *mut u16, pvreason : *mut core::ffi::c_void, dwreasonlength : u32, pdwreasonlengthconsumed : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn HttpWebSocketReceive(hwebsocket : *mut core::ffi::c_void, pvbuffer : *mut core::ffi::c_void, dwbufferlength : u32, pdwbytesread : *mut u32, pbuffertype : *mut HTTP_WEB_SOCKET_BUFFER_TYPE) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn HttpWebSocketSend(hwebsocket : *mut core::ffi::c_void, buffertype : HTTP_WEB_SOCKET_BUFFER_TYPE, pvbuffer : *mut core::ffi::c_void, dwbufferlength : u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn HttpWebSocketShutdown(hwebsocket : *mut core::ffi::c_void, usstatus : u16, pvreason : *mut core::ffi::c_void, dwreasonlength : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn InternalInternetGetCookie(lpszurl : windows_sys::core::PCSTR, lpszcookiedata : windows_sys::core::PCSTR, lpdwdatasize : *mut u32) -> u32);
#[cfg(feature = "Win32_Security_Cryptography")]
windows_link::link!("wininet.dll" "system" fn InternetAlgIdToStringA(ai : super::super::Security::Cryptography:: ALG_ID, lpstr : windows_sys::core::PCSTR, lpdwstrlength : *mut u32, dwreserved : u32) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Security_Cryptography")]
...
windows_link::link!("wininet.dll" "system" fn InternetCanonicalizeUrlA(lpszurl : windows_sys::core::PCSTR, lpszbuffer : windows_sys::core::PCSTR, lpdwbufferlength : *mut u32, dwflags : u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn InternetCanonicalizeUrlW(lpszurl : windows_sys::core::PCWSTR, lpszbuffer : windows_sys::core::PCWSTR, lpdwbufferlength : *mut u32, dwflags : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn InternetCloseHandle(hinternet : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn InternetConnectA(hinternet : *mut core::ffi::c_void, lpszservername : windows_sys::core::PCSTR, nserverport : u16, lpszusername : windows_sys::core::PCSTR, lpszpassword : windows_sys::core::PCSTR, dwservice : u32, dwflags : u32, dwcontext : usize) -> *mut core::ffi::c_void);
...
windows_link::link!("wininet.dll" "system" fn InternetCreateUrlA(lpurlcomponents : *mut URL_COMPONENTSA, dwflags : u32, lpszurl : windows_sys::core::PCSTR, lpdwurllength : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn InternetCreateUrlW(lpurlcomponents : *mut URL_COMPONENTSW, dwflags : u32, lpszurl : windows_sys::core::PCWSTR, lpdwurllength : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn InternetEnumPerSiteCookieDecisionA(pszsitename : windows_sys::core::PCSTR, pcsitenamesize : *mut u32, pdwdecision : *mut u32, dwindex : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn InternetFindNextFileA(hfind : *mut core::ffi::c_void, lpvfinddata : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn InternetFindNextFileW(hfind : *mut core::ffi::c_void, lpvfinddata : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn InternetGetConnectedStateExW(lpdwflags : *mut INTERNET_CONNECTION, lpszconnectionname : windows_sys::core::PCWSTR, cchnamelen : u32, dwreserved : u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn InternetGetCookieA(lpszurl : windows_sys::core::PCSTR, lpszcookiename : windows_sys::core::PCSTR, lpszcookiedata : windows_sys::core::PCSTR, lpdwsize : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn InternetGetCookieExA(lpszurl : windows_sys::core::PCSTR, lpszcookiename : windows_sys::core::PCSTR, lpszcookiedata : windows_sys::core::PCSTR, lpdwsize : *mut u32, dwflags : INTERNET_COOKIE_FLAGS, lpreserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn InternetGetLastResponseInfoA(lpdwerror : *mut u32, lpszbuffer : windows_sys::core::PCSTR, lpdwbufferlength : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn InternetGetLastResponseInfoW(lpdwerror : *mut u32, lpszbuffer : windows_sys::core::PCWSTR, lpdwbufferlength : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn InternetOpenUrlA(hinternet : *mut core::ffi::c_void, lpszurl : windows_sys::core::PCSTR, lpszheaders : windows_sys::core::PCSTR, dwheaderslength : u32, dwflags : u32, dwcontext : usize) -> *mut core::ffi::c_void);
windows_link::link!("wininet.dll" "system" fn InternetOpenUrlW(hinternet : *mut core::ffi::c_void, lpszurl : windows_sys::core::PCWSTR, lpszheaders : windows_sys::core::PCWSTR, dwheaderslength : u32, dwflags : u32, dwcontext : usize) -> *mut core::ffi::c_void);
...
windows_link::link!("wininet.dll" "system" fn InternetQueryDataAvailable(hfile : *mut core::ffi::c_void, lpdwnumberofbytesavailable : *mut u32, dwflags : u32, dwcontext : usize) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn InternetQueryOptionA(hinternet : *mut core::ffi::c_void, dwoption : u32, lpbuffer : *mut core::ffi::c_void, lpdwbufferlength : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn InternetReadFile(hfile : *mut core::ffi::c_void, lpbuffer : *mut core::ffi::c_void, dwnumberofbytestoread : u32, lpdwnumberofbytesread : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn InternetSecurityProtocolToStringA(dwprotocol : u32, lpstr : windows_sys::core::PCSTR, lpdwstrlength : *mut u32, dwreserved : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn InternetSetOptionA(hinternet : *mut core::ffi::c_void, dwoption : u32, lpbuffer : *mut core::ffi::c_void, dwbufferlength : u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn InternetSetOptionExA(hinternet : *mut core::ffi::c_void, dwoption : u32, lpbuffer : *mut core::ffi::c_void, dwbufferlength : u32, dwflags : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn InternetSetOptionW(hinternet : *mut core::ffi::c_void, dwoption : u32, lpbuffer : *mut core::ffi::c_void, dwbufferlength : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn InternetSetStatusCallback(hinternet : *mut core::ffi::c_void, lpfninternetcallback : LPINTERNET_STATUS_CALLBACK) -> LPINTERNET_STATUS_CALLBACK);
...
windows_link::link!("wininet.dll" "system" fn InternetTimeFromSystemTime(pst : *mut super::super::Foundation:: SYSTEMTIME, dwrfc : u32, lpsztime : windows_sys::core::PCSTR, cbtime : u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn InternetTimeFromSystemTimeA(pst : *mut super::super::Foundation:: SYSTEMTIME, dwrfc : u32, lpsztime : windows_sys::core::PCSTR, cbtime : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn InternetWriteFile(hfile : *mut core::ffi::c_void, lpbuffer : *mut core::ffi::c_void, dwnumberofbytestowrite : u32, lpdwnumberofbyteswritten : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn InternetWriteFileExA(hfile : *mut core::ffi::c_void, lpbuffersin : *mut INTERNET_BUFFERSA, dwflags : u32, dwcontext : usize) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn InternetWriteFileExW(hfile : *mut core::ffi::c_void, lpbuffersin : *mut INTERNET_BUFFERSW, dwflags : u32, dwcontext : usize) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn ParseX509EncodedCertificateForListBoxEntry(lpcert : *mut u8, cbcert : u32, lpszlistboxentry : windows_sys::core::PCSTR, lpdwlistboxentry : *mut u32) -> u32);
windows_link::link!("wininet.dll" "system" fn PerformOperationOverUrlCacheA(pszurlsearchpattern : windows_sys::core::PCSTR, dwflags : u32, dwfilter : u32, groupid : i64, preserved1 : *mut core::ffi::c_void, pdwreserved2 : *mut u32, preserved3 : *mut core::ffi::c_void, op : CACHE_OPERATOR, poperatordata : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn PrivacyGetZonePreferenceW(dwzone : u32, dwtype : u32, pdwtemplate : *mut u32, pszbuffer : windows_sys::core::PCWSTR, pdwbufferlength : *mut u32) -> u32);
...
windows_link::link!("wininet.dll" "system" fn ResumeSuspendedDownload(hrequest : *mut core::ffi::c_void, dwresultcode : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn SetUrlCacheConfigInfoW(lpcacheconfiginfo : *mut INTERNET_CACHE_CONFIG_INFOW, dwfieldcontrol : u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn SetUrlCacheEntryGroup(lpszurlname : windows_sys::core::PCSTR, dwflags : u32, groupid : i64, pbgroupattributes : *mut u8, cbgroupattributes : u32, lpreserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn SetUrlCacheEntryGroupA(lpszurlname : windows_sys::core::PCSTR, dwflags : u32, groupid : i64, pbgroupattributes : *mut u8, cbgroupattributes : u32, lpreserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn SetUrlCacheEntryGroupW(lpszurlname : windows_sys::core::PCWSTR, dwflags : u32, groupid : i64, pbgroupattributes : *mut u8, cbgroupattributes : u32, lpreserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn SetUrlCacheEntryInfoA(lpszurlname : windows_sys::core::PCSTR, lpcacheentryinfo : *mut INTERNET_CACHE_ENTRY_INFOA, dwfieldcontrol : u32) -> windows_sys::core::BOOL);
windows_link::link!("wininet.dll" "system" fn SetUrlCacheEntryInfoW(lpszurlname : windows_sys::core::PCWSTR, lpcacheentryinfo : *mut INTERNET_CACHE_ENTRY_INFOW, dwfieldcontrol : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("wininet.dll" "system" fn UrlCacheCheckEntriesExist(rgpwszurls : *mut windows_sys::core::PWSTR, centries : u32, rgfexist : *mut windows_sys::core::BOOL) -> u32);
windows_link::link!("wininet.dll" "system" fn UrlCacheCloseEntryHandle(hentryfile : *mut core::ffi::c_void));
...
windows_link::link!("wininet.dll" "system" fn UrlCacheGetEntryInfo(happcache : *mut core::ffi::c_void, pcwszurl : windows_sys::core::PCWSTR, pcacheentryinfo : *mut URLCACHE_ENTRY_INFO) -> u32);
...
windows_link::link!("wininet.dll" "system" fn UrlCacheReadEntryStream(hurlcachestream : *mut core::ffi::c_void, ulllocation : u64, pbuffer : *mut core::ffi::c_void, dwbufferlen : u32, pdwbufferlen : *mut u32) -> u32);
windows_link::link!("wininet.dll" "system" fn UrlCacheReloadSettings() -> u32);
windows_link::link!("wininet.dll" "system" fn UrlCacheRetrieveEntryFile(happcache : *mut core::ffi::c_void, pcwszurl : windows_sys::core::PCWSTR, pcacheentryinfo : *mut URLCACHE_ENTRY_INFO, phentryfile : *mut *mut core::ffi::c_void) -> u32);
...
windows_link::link!("wininet.dll" "system" fn UrlCacheUpdateEntryExtraData(happcache : *mut core::ffi::c_void, pcwszurl : windows_sys::core::PCWSTR, pbextradata : *mut u8, cbextradata : u32) -> u32);
...
pub type GOPHER_ATTRIBUTE_ENUMERATOR = Option<unsafe extern "system" fn(lpattributeinfo: *mut GOPHER_ATTRIBUTE_TYPE, dwerror: u32) -> windows_sys::core::BOOL>;
...
pub type LPINTERNET_STATUS_CALLBACK = Option<unsafe extern "system" fn(hinternet: *mut core::ffi::c_void, dwcontext: usize, dwinternetstatus: u32, lpvstatusinformation: *mut core::ffi::c_void, dwstatusinformationlength: u32)>;
