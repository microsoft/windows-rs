...
pub const AppCacheFinalizeStateComplete: APP_CACHE_FINALIZE_STATE = 2;
pub const AppCacheFinalizeStateIncomplete: APP_CACHE_FINALIZE_STATE = 0;
pub const AppCacheFinalizeStateManifestChange: APP_CACHE_FINALIZE_STATE = 1;
pub const AppCacheStateNoUpdateNeeded: APP_CACHE_STATE = 0;
pub const AppCacheStateUpdateNeeded: APP_CACHE_STATE = 1;
...
pub const CACHE_CONFIG_CONTENT_PATHS_FC: CACHE_CONFIG = 256;
pub const CACHE_CONFIG_CONTENT_QUOTA_FC: u32 = 32768;
pub const CACHE_CONFIG_CONTENT_USAGE_FC: CACHE_CONFIG = 8192;
pub const CACHE_CONFIG_COOKIES_PATHS_FC: CACHE_CONFIG = 512;
pub const CACHE_CONFIG_DISK_CACHE_PATHS_FC: CACHE_CONFIG = 64;
pub const CACHE_CONFIG_FORCE_CLEANUP_FC: CACHE_CONFIG = 32;
pub const CACHE_CONFIG_HISTORY_PATHS_FC: CACHE_CONFIG = 1024;
pub const CACHE_CONFIG_QUOTA_FC: CACHE_CONFIG = 2048;
pub const CACHE_CONFIG_STICKY_CONTENT_USAGE_FC: CACHE_CONFIG = 16384;
pub const CACHE_CONFIG_SYNC_MODE_FC: CACHE_CONFIG = 128;
pub const CACHE_CONFIG_TOTAL_CONTENT_QUOTA_FC: u32 = 65536;
pub const CACHE_CONFIG_USER_MODE_FC: CACHE_CONFIG = 4096;
...
pub const FORTCMD_CHG_PERSONALITY: FORTCMD = 3;
pub const FORTCMD_LOGOFF: FORTCMD = 2;
pub const FORTCMD_LOGON: FORTCMD = 1;
pub type FORTSTAT = i32;
pub const FORTSTAT_INSTALLED: FORTSTAT = 1;
pub const FORTSTAT_LOGGEDON: FORTSTAT = 2;
pub type FTP_FLAGS = u32;
pub const FTP_TRANSFER_TYPE_ASCII: FTP_FLAGS = 1;
pub const FTP_TRANSFER_TYPE_BINARY: FTP_FLAGS = 2;
...
pub const GOPHER_TYPE_ASK: GOPHER_TYPE = 1073741824;
pub const GOPHER_TYPE_BINARY: GOPHER_TYPE = 512;
pub const GOPHER_TYPE_BITMAP: GOPHER_TYPE = 16384;
pub const GOPHER_TYPE_CALENDAR: GOPHER_TYPE = 524288;
pub const GOPHER_TYPE_CSO: GOPHER_TYPE = 4;
pub const GOPHER_TYPE_DIRECTORY: GOPHER_TYPE = 2;
pub const GOPHER_TYPE_DOS_ARCHIVE: GOPHER_TYPE = 32;
pub const GOPHER_TYPE_ERROR: GOPHER_TYPE = 8;
pub const GOPHER_TYPE_GIF: GOPHER_TYPE = 4096;
pub const GOPHER_TYPE_GOPHER_PLUS: GOPHER_TYPE = 2147483648;
pub const GOPHER_TYPE_HTML: GOPHER_TYPE = 131072;
pub const GOPHER_TYPE_IMAGE: GOPHER_TYPE = 8192;
pub const GOPHER_TYPE_INDEX_SERVER: GOPHER_TYPE = 128;
pub const GOPHER_TYPE_INLINE: GOPHER_TYPE = 1048576;
pub const GOPHER_TYPE_MAC_BINHEX: GOPHER_TYPE = 16;
pub const GOPHER_TYPE_MOVIE: GOPHER_TYPE = 32768;
pub const GOPHER_TYPE_PDF: GOPHER_TYPE = 262144;
pub const GOPHER_TYPE_REDUNDANT: GOPHER_TYPE = 1024;
pub const GOPHER_TYPE_SOUND: GOPHER_TYPE = 65536;
pub const GOPHER_TYPE_TELNET: GOPHER_TYPE = 256;
pub const GOPHER_TYPE_TEXT_FILE: GOPHER_TYPE = 1;
pub const GOPHER_TYPE_TN3270: GOPHER_TYPE = 2048;
...
pub const HTTP_ADDREQ_FLAG_ADD: HTTP_ADDREQ_FLAG = 536870912;
pub const HTTP_ADDREQ_FLAG_ADD_IF_NEW: HTTP_ADDREQ_FLAG = 268435456;
pub const HTTP_ADDREQ_FLAG_ALLOW_EMPTY_VALUES: u32 = 67108864;
pub const HTTP_ADDREQ_FLAG_COALESCE: HTTP_ADDREQ_FLAG = 1073741824;
pub const HTTP_ADDREQ_FLAG_COALESCE_WITH_COMMA: HTTP_ADDREQ_FLAG = 1073741824;
pub const HTTP_ADDREQ_FLAG_COALESCE_WITH_SEMICOLON: HTTP_ADDREQ_FLAG = 16777216;
pub const HTTP_ADDREQ_FLAG_REPLACE: HTTP_ADDREQ_FLAG = 2147483648;
...
pub const HTTP_WEB_SOCKET_BINARY_FRAGMENT_TYPE: HTTP_WEB_SOCKET_BUFFER_TYPE = 1;
pub const HTTP_WEB_SOCKET_BINARY_MESSAGE_TYPE: HTTP_WEB_SOCKET_BUFFER_TYPE = 0;
pub type HTTP_WEB_SOCKET_BUFFER_TYPE = i32;
pub const HTTP_WEB_SOCKET_CLOSE_OPERATION: HTTP_WEB_SOCKET_OPERATION = 2;
pub type HTTP_WEB_SOCKET_CLOSE_STATUS = i32;
pub const HTTP_WEB_SOCKET_CLOSE_TYPE: HTTP_WEB_SOCKET_BUFFER_TYPE = 4;
pub const HTTP_WEB_SOCKET_EMPTY_CLOSE_STATUS: HTTP_WEB_SOCKET_CLOSE_STATUS = 1005;
pub const HTTP_WEB_SOCKET_ENDPOINT_TERMINATED_CLOSE_STATUS: HTTP_WEB_SOCKET_CLOSE_STATUS = 1001;
pub const HTTP_WEB_SOCKET_INVALID_DATA_TYPE_CLOSE_STATUS: HTTP_WEB_SOCKET_CLOSE_STATUS = 1003;
pub const HTTP_WEB_SOCKET_INVALID_PAYLOAD_CLOSE_STATUS: HTTP_WEB_SOCKET_CLOSE_STATUS = 1007;
pub const HTTP_WEB_SOCKET_MAX_CLOSE_REASON_LENGTH: u32 = 123;
pub const HTTP_WEB_SOCKET_MESSAGE_TOO_BIG_CLOSE_STATUS: HTTP_WEB_SOCKET_CLOSE_STATUS = 1009;
pub const HTTP_WEB_SOCKET_MIN_KEEPALIVE_VALUE: u32 = 10000;
pub type HTTP_WEB_SOCKET_OPERATION = i32;
pub const HTTP_WEB_SOCKET_PING_TYPE: HTTP_WEB_SOCKET_BUFFER_TYPE = 5;
pub const HTTP_WEB_SOCKET_POLICY_VIOLATION_CLOSE_STATUS: HTTP_WEB_SOCKET_CLOSE_STATUS = 1008;
pub const HTTP_WEB_SOCKET_PROTOCOL_ERROR_CLOSE_STATUS: HTTP_WEB_SOCKET_CLOSE_STATUS = 1002;
pub const HTTP_WEB_SOCKET_RECEIVE_OPERATION: HTTP_WEB_SOCKET_OPERATION = 1;
pub const HTTP_WEB_SOCKET_SECURE_HANDSHAKE_ERROR_CLOSE_STATUS: HTTP_WEB_SOCKET_CLOSE_STATUS = 1015;
pub const HTTP_WEB_SOCKET_SEND_OPERATION: HTTP_WEB_SOCKET_OPERATION = 0;
pub const HTTP_WEB_SOCKET_SERVER_ERROR_CLOSE_STATUS: HTTP_WEB_SOCKET_CLOSE_STATUS = 1011;
pub const HTTP_WEB_SOCKET_SHUTDOWN_OPERATION: HTTP_WEB_SOCKET_OPERATION = 3;
pub const HTTP_WEB_SOCKET_SUCCESS_CLOSE_STATUS: HTTP_WEB_SOCKET_CLOSE_STATUS = 1000;
pub const HTTP_WEB_SOCKET_UNSUPPORTED_EXTENSIONS_CLOSE_STATUS: HTTP_WEB_SOCKET_CLOSE_STATUS = 1010;
pub const HTTP_WEB_SOCKET_UTF8_FRAGMENT_TYPE: HTTP_WEB_SOCKET_BUFFER_TYPE = 3;
pub const HTTP_WEB_SOCKET_UTF8_MESSAGE_TYPE: HTTP_WEB_SOCKET_BUFFER_TYPE = 2;
pub const HttpPushWaitEnableComplete: HTTP_PUSH_WAIT_TYPE = 0;
pub const HttpPushWaitReceiveComplete: HTTP_PUSH_WAIT_TYPE = 1;
pub const HttpPushWaitSendComplete: HTTP_PUSH_WAIT_TYPE = 2;
pub const HttpRequestTimeMax: REQUEST_TIMES = 32;
...
pub const INTERNET_AUTODIAL_FAILIFSECURITYCHECK: INTERNET_AUTODIAL = 4;
pub const INTERNET_AUTODIAL_FORCE_ONLINE: INTERNET_AUTODIAL = 1;
pub const INTERNET_AUTODIAL_FORCE_UNATTENDED: INTERNET_AUTODIAL = 2;
pub const INTERNET_AUTODIAL_OVERRIDE_NET_PRESENT: INTERNET_AUTODIAL = 8;
...
pub const INTERNET_CONNECTION_CONFIGURED: INTERNET_CONNECTION = 64;
pub const INTERNET_CONNECTION_LAN: INTERNET_CONNECTION = 2;
pub const INTERNET_CONNECTION_MODEM: INTERNET_CONNECTION = 1;
pub const INTERNET_CONNECTION_MODEM_BUSY: INTERNET_CONNECTION = 8;
...
pub const INTERNET_COOKIE_HTTPONLY: INTERNET_COOKIE_FLAGS = 8192;
...
pub const INTERNET_COOKIE_THIRD_PARTY: INTERNET_COOKIE_FLAGS = 16;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const INTERNET_FLAG_RESTRICTED_ZONE: INTERNET_COOKIE_FLAGS = 131072;
pub const INTERNET_FLAG_RESYNCHRONIZE: u32 = 2048;
pub const INTERNET_FLAG_SECURE: u32 = 8388608;
pub const INTERNET_FLAG_TRANSFER_ASCII: FTP_FLAGS = 1;
pub const INTERNET_FLAG_TRANSFER_BINARY: FTP_FLAGS = 2;
...
pub const INTERNET_OPEN_TYPE_DIRECT: INTERNET_ACCESS_TYPE = 1;
pub const INTERNET_OPEN_TYPE_PRECONFIG: INTERNET_ACCESS_TYPE = 0;
pub const INTERNET_OPEN_TYPE_PRECONFIG_WITH_NO_AUTOPROXY: u32 = 4;
pub const INTERNET_OPEN_TYPE_PROXY: INTERNET_ACCESS_TYPE = 3;
...
pub const INTERNET_PER_CONN_AUTOCONFIG_LAST_DETECT_TIME: INTERNET_PER_CONN = 8;
pub const INTERNET_PER_CONN_AUTOCONFIG_LAST_DETECT_URL: INTERNET_PER_CONN = 9;
pub const INTERNET_PER_CONN_AUTOCONFIG_RELOAD_DELAY_MINS: INTERNET_PER_CONN = 7;
pub const INTERNET_PER_CONN_AUTOCONFIG_SECONDARY_URL: INTERNET_PER_CONN = 6;
pub const INTERNET_PER_CONN_AUTOCONFIG_URL: INTERNET_PER_CONN = 4;
pub const INTERNET_PER_CONN_AUTODISCOVERY_FLAGS: INTERNET_PER_CONN = 5;
pub const INTERNET_PER_CONN_FLAGS: INTERNET_PER_CONN = 1;
...
pub const INTERNET_PER_CONN_PROXY_BYPASS: INTERNET_PER_CONN = 3;
pub const INTERNET_PER_CONN_PROXY_SERVER: INTERNET_PER_CONN = 2;
...
pub const INTERNET_RAS_INSTALLED: INTERNET_CONNECTION = 16;
...
pub const INTERNET_SCHEME_DEFAULT: INTERNET_SCHEME = 0;
pub const INTERNET_SCHEME_FILE: INTERNET_SCHEME = 5;
pub const INTERNET_SCHEME_FIRST: INTERNET_SCHEME = 1;
pub const INTERNET_SCHEME_FTP: INTERNET_SCHEME = 1;
pub const INTERNET_SCHEME_GOPHER: INTERNET_SCHEME = 2;
pub const INTERNET_SCHEME_HTTP: INTERNET_SCHEME = 3;
pub const INTERNET_SCHEME_HTTPS: INTERNET_SCHEME = 4;
pub const INTERNET_SCHEME_JAVASCRIPT: INTERNET_SCHEME = 9;
pub const INTERNET_SCHEME_LAST: INTERNET_SCHEME = 11;
pub const INTERNET_SCHEME_MAILTO: INTERNET_SCHEME = 7;
pub const INTERNET_SCHEME_NEWS: INTERNET_SCHEME = 6;
pub const INTERNET_SCHEME_PARTIAL: INTERNET_SCHEME = -2;
pub const INTERNET_SCHEME_RES: INTERNET_SCHEME = 11;
pub const INTERNET_SCHEME_SOCKS: INTERNET_SCHEME = 8;
pub const INTERNET_SCHEME_UNKNOWN: INTERNET_SCHEME = -1;
...
pub const INTERNET_STATE_BUSY: INTERNET_STATE = 512;
pub const INTERNET_STATE_CONNECTED: INTERNET_STATE = 1;
pub const INTERNET_STATE_DISCONNECTED: INTERNET_STATE = 2;
pub const INTERNET_STATE_DISCONNECTED_BY_USER: INTERNET_STATE = 16;
pub const INTERNET_STATE_IDLE: INTERNET_STATE = 256;
...
pub const NameResolutionEnd: REQUEST_TIMES = 1;
...
pub const POLICY_EXTENSION_TYPE_NONE: HTTP_POLICY_EXTENSION_TYPE = 0;
pub const POLICY_EXTENSION_TYPE_WINHTTP: HTTP_POLICY_EXTENSION_TYPE = 1;
pub const POLICY_EXTENSION_TYPE_WININET: HTTP_POLICY_EXTENSION_TYPE = 2;
...
pub const PROOF_OF_POSSESSION_ALLOW_SILENT_REQUESTS: PROOF_OF_POSSESSION_FLAGS = 1;
pub const PROOF_OF_POSSESSION_DEFAULT: PROOF_OF_POSSESSION_FLAGS = 0;
pub type PROOF_OF_POSSESSION_FLAGS = u32;
pub type PROXY_AUTO_DETECT_TYPE = u32;
pub const PROXY_AUTO_DETECT_TYPE_DHCP: PROXY_AUTO_DETECT_TYPE = 1;
pub const PROXY_AUTO_DETECT_TYPE_DNS_A: PROXY_AUTO_DETECT_TYPE = 2;
...
pub const TLSHandshakeEnd: REQUEST_TIMES = 5;
pub const TLSHandshakeStart: REQUEST_TIMES = 4;
...
pub const UrlCacheLimitTypeAppContainer: URL_CACHE_LIMIT_TYPE = 2;
pub const UrlCacheLimitTypeAppContainerTotal: URL_CACHE_LIMIT_TYPE = 3;
pub const UrlCacheLimitTypeIE: URL_CACHE_LIMIT_TYPE = 0;
pub const UrlCacheLimitTypeIETotal: URL_CACHE_LIMIT_TYPE = 1;
pub const UrlCacheLimitTypeNum: URL_CACHE_LIMIT_TYPE = 4;
...
pub const WININET_SYNC_MODE_ALWAYS: WININET_SYNC_MODE = 3;
pub const WININET_SYNC_MODE_AUTOMATIC: WININET_SYNC_MODE = 4;
pub const WININET_SYNC_MODE_DEFAULT: WININET_SYNC_MODE = 4;
pub const WININET_SYNC_MODE_NEVER: WININET_SYNC_MODE = 0;
pub const WININET_SYNC_MODE_ONCE_PER_SESSION: WININET_SYNC_MODE = 2;
pub const WININET_SYNC_MODE_ON_EXPIRY: WININET_SYNC_MODE = 1;
