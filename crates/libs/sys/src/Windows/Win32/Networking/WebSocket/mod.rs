pub type WebSocketAbortHandle = unsafe extern "system" fn(hwebsocket: WEB_SOCKET_HANDLE);
windows_link::link!("websocket.dll" "system" fn WebSocketAbortHandle(hwebsocket : WEB_SOCKET_HANDLE));
pub type WebSocketBeginClientHandshake = unsafe extern "system" fn(hwebsocket: WEB_SOCKET_HANDLE, pszsubprotocols: *const windows_sys::core::PCSTR, ulsubprotocolcount: u32, pszextensions: *const windows_sys::core::PCSTR, ulextensioncount: u32, pinitialheaders: *const WEB_SOCKET_HTTP_HEADER, ulinitialheadercount: u32, padditionalheaders: *mut *mut WEB_SOCKET_HTTP_HEADER, puladditionalheadercount: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WebSocketBeginServerHandshake = unsafe extern "system" fn(hwebsocket: WEB_SOCKET_HANDLE, pszsubprotocolselected: windows_sys::core::PCSTR, pszextensionselected: *const windows_sys::core::PCSTR, ulextensionselectedcount: u32, prequestheaders: *const WEB_SOCKET_HTTP_HEADER, ulrequestheadercount: u32, presponseheaders: *mut *mut WEB_SOCKET_HTTP_HEADER, pulresponseheadercount: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WebSocketCompleteAction = unsafe extern "system" fn(hwebsocket: WEB_SOCKET_HANDLE, pvactioncontext: *const core::ffi::c_void, ulbytestransferred: u32);
...
pub type WebSocketCreateClientHandle = unsafe extern "system" fn(pproperties: *const WEB_SOCKET_PROPERTY, ulpropertycount: u32, phwebsocket: *mut WEB_SOCKET_HANDLE) -> windows_sys::core::HRESULT;
...
pub type WebSocketCreateServerHandle = unsafe extern "system" fn(pproperties: *const WEB_SOCKET_PROPERTY, ulpropertycount: u32, phwebsocket: *mut WEB_SOCKET_HANDLE) -> windows_sys::core::HRESULT;
...
pub type WebSocketDeleteHandle = unsafe extern "system" fn(hwebsocket: WEB_SOCKET_HANDLE);
windows_link::link!("websocket.dll" "system" fn WebSocketDeleteHandle(hwebsocket : WEB_SOCKET_HANDLE));
pub type WebSocketEndClientHandshake = unsafe extern "system" fn(hwebsocket: WEB_SOCKET_HANDLE, presponseheaders: *const WEB_SOCKET_HTTP_HEADER, ulreponseheadercount: u32, pulselectedextensions: *mut u32, pulselectedextensioncount: *mut u32, pulselectedsubprotocol: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WebSocketEndServerHandshake = unsafe extern "system" fn(hwebsocket: WEB_SOCKET_HANDLE) -> windows_sys::core::HRESULT;
...
pub type WebSocketGetAction = unsafe extern "system" fn(hwebsocket: WEB_SOCKET_HANDLE, eactionqueue: WEB_SOCKET_ACTION_QUEUE, pdatabuffers: *mut WEB_SOCKET_BUFFER, puldatabuffercount: *mut u32, paction: *mut WEB_SOCKET_ACTION, pbuffertype: *mut WEB_SOCKET_BUFFER_TYPE, pvapplicationcontext: *mut *mut core::ffi::c_void, pvactioncontext: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WebSocketGetGlobalProperty = unsafe extern "system" fn(etype: WEB_SOCKET_PROPERTY_TYPE, pvvalue: *mut core::ffi::c_void, ulsize: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WebSocketReceive = unsafe extern "system" fn(hwebsocket: WEB_SOCKET_HANDLE, pbuffer: *const WEB_SOCKET_BUFFER, pvcontext: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WebSocketSend = unsafe extern "system" fn(hwebsocket: WEB_SOCKET_HANDLE, buffertype: WEB_SOCKET_BUFFER_TYPE, pbuffer: *const WEB_SOCKET_BUFFER, context: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
