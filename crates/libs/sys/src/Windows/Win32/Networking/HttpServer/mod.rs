...
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpAddFragmentToCache ( requestqueuehandle : super::super::Foundation:: HANDLE , urlprefix : :: windows_sys::core::PCWSTR , datachunk : *const HTTP_DATA_CHUNK , cachepolicy : *const HTTP_CACHE_POLICY , overlapped : *const super::super::System::IO:: OVERLAPPED ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpAddUrl ( requestqueuehandle : super::super::Foundation:: HANDLE , fullyqualifiedurl : :: windows_sys::core::PCWSTR , reserved : *mut ::core::ffi::c_void ) -> u32 );
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpAddUrlToUrlGroup ( urlgroupid : u64 , pfullyqualifiedurl : :: windows_sys::core::PCWSTR , urlcontext : u64 , reserved : u32 ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpCancelHttpRequest ( requestqueuehandle : super::super::Foundation:: HANDLE , requestid : u64 , overlapped : *const super::super::System::IO:: OVERLAPPED ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpCloseRequestQueue ( requestqueuehandle : super::super::Foundation:: HANDLE ) -> u32 );
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpCloseServerSession ( serversessionid : u64 ) -> u32 );
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpCloseUrlGroup ( urlgroupid : u64 ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpCreateHttpHandle ( requestqueuehandle : *mut super::super::Foundation:: HANDLE , reserved : u32 ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpCreateRequestQueue ( version : HTTPAPI_VERSION , name : :: windows_sys::core::PCWSTR , securityattributes : *const super::super::Security:: SECURITY_ATTRIBUTES , flags : u32 , requestqueuehandle : *mut super::super::Foundation:: HANDLE ) -> u32 );
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpCreateServerSession ( version : HTTPAPI_VERSION , serversessionid : *mut u64 , reserved : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpCreateUrlGroup ( serversessionid : u64 , purlgroupid : *mut u64 , reserved : u32 ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpDeclarePush ( requestqueuehandle : super::super::Foundation:: HANDLE , requestid : u64 , verb : HTTP_VERB , path : :: windows_sys::core::PCWSTR , query : :: windows_sys::core::PCSTR , headers : *const HTTP_REQUEST_HEADERS ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpDelegateRequestEx ( requestqueuehandle : super::super::Foundation:: HANDLE , delegatequeuehandle : super::super::Foundation:: HANDLE , requestid : u64 , delegateurlgroupid : u64 , propertyinfosetsize : u32 , propertyinfoset : *const HTTP_DELEGATE_REQUEST_PROPERTY_INFO ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpDeleteServiceConfiguration ( servicehandle : super::super::Foundation:: HANDLE , configid : HTTP_SERVICE_CONFIG_ID , pconfiginformation : *const ::core::ffi::c_void , configinformationlength : u32 , poverlapped : *mut super::super::System::IO:: OVERLAPPED ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpFindUrlGroupId ( fullyqualifiedurl : :: windows_sys::core::PCWSTR , requestqueuehandle : super::super::Foundation:: HANDLE , urlgroupid : *mut u64 ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpFlushResponseCache ( requestqueuehandle : super::super::Foundation:: HANDLE , urlprefix : :: windows_sys::core::PCWSTR , flags : u32 , overlapped : *const super::super::System::IO:: OVERLAPPED ) -> u32 );
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpGetExtension ( version : HTTPAPI_VERSION , extension : u32 , buffer : *mut ::core::ffi::c_void , buffersize : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpInitialize ( version : HTTPAPI_VERSION , flags : HTTP_INITIALIZE , preserved : *mut ::core::ffi::c_void ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpIsFeatureSupported ( featureid : HTTP_FEATURE_ID ) -> super::super::Foundation:: BOOL );
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpPrepareUrl ( reserved : *mut ::core::ffi::c_void , flags : u32 , url : :: windows_sys::core::PCWSTR , preparedurl : *mut :: windows_sys::core::PWSTR ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpQueryRequestQueueProperty ( requestqueuehandle : super::super::Foundation:: HANDLE , property : HTTP_SERVER_PROPERTY , propertyinformation : *mut ::core::ffi::c_void , propertyinformationlength : u32 , reserved1 : u32 , returnlength : *mut u32 , reserved2 : *mut ::core::ffi::c_void ) -> u32 );
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpQueryServerSessionProperty ( serversessionid : u64 , property : HTTP_SERVER_PROPERTY , propertyinformation : *mut ::core::ffi::c_void , propertyinformationlength : u32 , returnlength : *mut u32 ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpQueryServiceConfiguration ( servicehandle : super::super::Foundation:: HANDLE , configid : HTTP_SERVICE_CONFIG_ID , pinput : *const ::core::ffi::c_void , inputlength : u32 , poutput : *mut ::core::ffi::c_void , outputlength : u32 , preturnlength : *mut u32 , poverlapped : *mut super::super::System::IO:: OVERLAPPED ) -> u32 );
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpQueryUrlGroupProperty ( urlgroupid : u64 , property : HTTP_SERVER_PROPERTY , propertyinformation : *mut ::core::ffi::c_void , propertyinformationlength : u32 , returnlength : *mut u32 ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpReadFragmentFromCache ( requestqueuehandle : super::super::Foundation:: HANDLE , urlprefix : :: windows_sys::core::PCWSTR , byterange : *const HTTP_BYTE_RANGE , buffer : *mut ::core::ffi::c_void , bufferlength : u32 , bytesread : *mut u32 , overlapped : *const super::super::System::IO:: OVERLAPPED ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpReceiveClientCertificate ( requestqueuehandle : super::super::Foundation:: HANDLE , connectionid : u64 , flags : u32 , sslclientcertinfo : *mut HTTP_SSL_CLIENT_CERT_INFO , sslclientcertinfosize : u32 , bytesreceived : *mut u32 , overlapped : *const super::super::System::IO:: OVERLAPPED ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Networking_WinSock", feature = "Win32_System_IO"))]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpReceiveHttpRequest ( requestqueuehandle : super::super::Foundation:: HANDLE , requestid : u64 , flags : HTTP_RECEIVE_HTTP_REQUEST_FLAGS , requestbuffer : *mut HTTP_REQUEST_V2 , requestbufferlength : u32 , bytesreturned : *mut u32 , overlapped : *const super::super::System::IO:: OVERLAPPED ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpReceiveRequestEntityBody ( requestqueuehandle : super::super::Foundation:: HANDLE , requestid : u64 , flags : u32 , entitybuffer : *mut ::core::ffi::c_void , entitybufferlength : u32 , bytesreturned : *mut u32 , overlapped : *const super::super::System::IO:: OVERLAPPED ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpRemoveUrl ( requestqueuehandle : super::super::Foundation:: HANDLE , fullyqualifiedurl : :: windows_sys::core::PCWSTR ) -> u32 );
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpRemoveUrlFromUrlGroup ( urlgroupid : u64 , pfullyqualifiedurl : :: windows_sys::core::PCWSTR , flags : u32 ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpSendHttpResponse ( requestqueuehandle : super::super::Foundation:: HANDLE , requestid : u64 , flags : u32 , httpresponse : *const HTTP_RESPONSE_V2 , cachepolicy : *const HTTP_CACHE_POLICY , bytessent : *mut u32 , reserved1 : *mut ::core::ffi::c_void , reserved2 : u32 , overlapped : *const super::super::System::IO:: OVERLAPPED , logdata : *const HTTP_LOG_DATA ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpSendResponseEntityBody ( requestqueuehandle : super::super::Foundation:: HANDLE , requestid : u64 , flags : u32 , entitychunkcount : u16 , entitychunks : *const HTTP_DATA_CHUNK , bytessent : *mut u32 , reserved1 : *const ::core::ffi::c_void , reserved2 : u32 , overlapped : *const super::super::System::IO:: OVERLAPPED , logdata : *const HTTP_LOG_DATA ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpSetRequestProperty ( requestqueuehandle : super::super::Foundation:: HANDLE , id : u64 , propertyid : HTTP_REQUEST_PROPERTY , input : *const ::core::ffi::c_void , inputpropertysize : u32 , overlapped : *const super::super::System::IO:: OVERLAPPED ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpSetRequestQueueProperty ( requestqueuehandle : super::super::Foundation:: HANDLE , property : HTTP_SERVER_PROPERTY , propertyinformation : *const ::core::ffi::c_void , propertyinformationlength : u32 , reserved1 : u32 , reserved2 : *mut ::core::ffi::c_void ) -> u32 );
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpSetServerSessionProperty ( serversessionid : u64 , property : HTTP_SERVER_PROPERTY , propertyinformation : *const ::core::ffi::c_void , propertyinformationlength : u32 ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpSetServiceConfiguration ( servicehandle : super::super::Foundation:: HANDLE , configid : HTTP_SERVICE_CONFIG_ID , pconfiginformation : *const ::core::ffi::c_void , configinformationlength : u32 , poverlapped : *mut super::super::System::IO:: OVERLAPPED ) -> u32 );
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpSetUrlGroupProperty ( urlgroupid : u64 , property : HTTP_SERVER_PROPERTY , propertyinformation : *const ::core::ffi::c_void , propertyinformationlength : u32 ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpShutdownRequestQueue ( requestqueuehandle : super::super::Foundation:: HANDLE ) -> u32 );
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpTerminate ( flags : HTTP_INITIALIZE , preserved : *mut ::core::ffi::c_void ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpUpdateServiceConfiguration ( handle : super::super::Foundation:: HANDLE , configid : HTTP_SERVICE_CONFIG_ID , configinfo : *const ::core::ffi::c_void , configinfolength : u32 , overlapped : *mut super::super::System::IO:: OVERLAPPED ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpWaitForDemandStart ( requestqueuehandle : super::super::Foundation:: HANDLE , overlapped : *const super::super::System::IO:: OVERLAPPED ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpWaitForDisconnect ( requestqueuehandle : super::super::Foundation:: HANDLE , connectionid : u64 , overlapped : *const super::super::System::IO:: OVERLAPPED ) -> u32 );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
::windows_sys::core::windows_link ! ( "httpapi.dll" ,"system" fn HttpWaitForDisconnectEx ( requestqueuehandle : super::super::Foundation:: HANDLE , connectionid : u64 , reserved : u32 , overlapped : *const super::super::System::IO:: OVERLAPPED ) -> u32 );
