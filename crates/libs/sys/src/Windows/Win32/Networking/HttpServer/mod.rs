...
pub const HTTP_INITIALIZE_CONFIG: HTTP_INITIALIZE = 2;
pub const HTTP_INITIALIZE_SERVER: HTTP_INITIALIZE = 1;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const HTTP_RECEIVE_REQUEST_FLAG_COPY_BODY: HTTP_RECEIVE_HTTP_REQUEST_FLAGS = 1;
pub const HTTP_RECEIVE_REQUEST_FLAG_FLUSH_BODY: HTTP_RECEIVE_HTTP_REQUEST_FLAGS = 2;
