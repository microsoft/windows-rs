...
pub type HttpAddFragmentToCache = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, urlprefix: windows_sys::core::PCWSTR, datachunk: *const HTTP_DATA_CHUNK, cachepolicy: *const HTTP_CACHE_POLICY, overlapped: *mut super::super::System::IO::OVERLAPPED) -> u32;
#[cfg(feature = "Win32_System_IO")]
...
pub type HttpAddUrl = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, fullyqualifiedurl: windows_sys::core::PCWSTR, reserved: *const core::ffi::c_void) -> u32;
...
pub type HttpAddUrlToUrlGroup = unsafe extern "system" fn(urlgroupid: u64, pfullyqualifiedurl: windows_sys::core::PCWSTR, urlcontext: u64, reserved: u32) -> u32;
...
#[cfg(feature = "Win32_System_IO")]
pub type HttpCancelHttpRequest = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, requestid: u64, overlapped: *mut super::super::System::IO::OVERLAPPED) -> u32;
#[cfg(feature = "Win32_System_IO")]
...
pub type HttpCloseRequestQueue = unsafe extern "system" fn(requestqueuehandle: HTTP_REQUEST_QUEUE_HANDLE) -> u32;
windows_link::link!("httpapi.dll" "system" fn HttpCloseRequestQueue(requestqueuehandle : HTTP_REQUEST_QUEUE_HANDLE) -> u32);
pub type HttpCloseServerSession = unsafe extern "system" fn(serversessionid: u64) -> u32;
windows_link::link!("httpapi.dll" "system" fn HttpCloseServerSession(serversessionid : u64) -> u32);
pub type HttpCloseUrlGroup = unsafe extern "system" fn(urlgroupid: u64) -> u32;
windows_link::link!("httpapi.dll" "system" fn HttpCloseUrlGroup(urlgroupid : u64) -> u32);
pub type HttpCreateHttpHandle = unsafe extern "system" fn(requestqueuehandle: *mut super::super::Foundation::HANDLE, reserved: u32) -> u32;
...
pub type HttpCreateRequestQueue = unsafe extern "system" fn(version: HTTPAPI_VERSION, name: windows_sys::core::PCWSTR, securityattributes: *const super::super::Security::SECURITY_ATTRIBUTES, flags: u32, requestqueuehandle: *mut HTTP_REQUEST_QUEUE_HANDLE) -> u32;
#[cfg(feature = "Win32_Security")]
...
pub type HttpCreateServerSession = unsafe extern "system" fn(version: HTTPAPI_VERSION, serversessionid: *mut u64, reserved: u32) -> u32;
...
pub type HttpCreateUrlGroup = unsafe extern "system" fn(serversessionid: u64, purlgroupid: *mut u64, reserved: u32) -> u32;
windows_link::link!("httpapi.dll" "system" fn HttpCreateUrlGroup(serversessionid : u64, purlgroupid : *mut u64, reserved : u32) -> u32);
pub type HttpDeclarePush = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, requestid: u64, verb: HTTP_VERB, path: windows_sys::core::PCWSTR, query: windows_sys::core::PCSTR, headers: *const HTTP_REQUEST_HEADERS) -> u32;
...
pub type HttpDelegateRequestEx = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, delegatequeuehandle: super::super::Foundation::HANDLE, requestid: u64, delegateurlgroupid: u64, propertyinfosetsize: u32, propertyinfoset: *const HTTP_DELEGATE_REQUEST_PROPERTY_INFO) -> u32;
...
#[cfg(feature = "Win32_System_IO")]
pub type HttpDeleteServiceConfiguration = unsafe extern "system" fn(servicehandle: super::super::Foundation::HANDLE, configid: HTTP_SERVICE_CONFIG_ID, pconfiginformation: *const core::ffi::c_void, configinformationlength: u32, poverlapped: *const super::super::System::IO::OVERLAPPED) -> u32;
#[cfg(feature = "Win32_System_IO")]
...
pub type HttpFindUrlGroupId = unsafe extern "system" fn(fullyqualifiedurl: windows_sys::core::PCWSTR, requestqueuehandle: super::super::Foundation::HANDLE, urlgroupid: *mut u64) -> u32;
...
#[cfg(feature = "Win32_System_IO")]
pub type HttpFlushResponseCache = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, urlprefix: windows_sys::core::PCWSTR, flags: u32, overlapped: *mut super::super::System::IO::OVERLAPPED) -> u32;
#[cfg(feature = "Win32_System_IO")]
...
pub type HttpGetExtension = unsafe extern "system" fn(version: HTTPAPI_VERSION, extension: u32, buffer: *mut core::ffi::c_void, buffersize: u32) -> u32;
...
pub type HttpInitialize = unsafe extern "system" fn(version: HTTPAPI_VERSION, flags: HTTP_INITIALIZE, preserved: *mut core::ffi::c_void) -> u32;
...
pub type HttpIsFeatureSupported = unsafe extern "system" fn(featureid: HTTP_FEATURE_ID) -> windows_sys::core::BOOL;
windows_link::link!("httpapi.dll" "system" fn HttpIsFeatureSupported(featureid : HTTP_FEATURE_ID) -> windows_sys::core::BOOL);
pub type HttpPrepareUrl = unsafe extern "system" fn(reserved: *const core::ffi::c_void, flags: u32, url: windows_sys::core::PCWSTR, preparedurl: *mut windows_sys::core::PWSTR) -> u32;
...
#[cfg(feature = "Win32_System_IO")]
pub type HttpQueryRequestProperty = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, id: u64, propertyid: HTTP_REQUEST_PROPERTY, qualifier: *const core::ffi::c_void, qualifiersize: u32, output: *mut core::ffi::c_void, outputbuffersize: u32, bytesreturned: *mut u32, overlapped: *const super::super::System::IO::OVERLAPPED) -> u32;
#[cfg(feature = "Win32_System_IO")]
...
pub type HttpQueryRequestQueueProperty = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, property: HTTP_SERVER_PROPERTY, propertyinformation: *mut core::ffi::c_void, propertyinformationlength: u32, reserved1: u32, returnlength: *mut u32, reserved2: *const core::ffi::c_void) -> u32;
...
pub type HttpQueryServerSessionProperty = unsafe extern "system" fn(serversessionid: u64, property: HTTP_SERVER_PROPERTY, propertyinformation: *mut core::ffi::c_void, propertyinformationlength: u32, returnlength: *mut u32) -> u32;
...
#[cfg(feature = "Win32_System_IO")]
pub type HttpQueryServiceConfiguration = unsafe extern "system" fn(servicehandle: super::super::Foundation::HANDLE, configid: HTTP_SERVICE_CONFIG_ID, pinput: *const core::ffi::c_void, inputlength: u32, poutput: *mut core::ffi::c_void, outputlength: u32, preturnlength: *mut u32, poverlapped: *const super::super::System::IO::OVERLAPPED) -> u32;
#[cfg(feature = "Win32_System_IO")]
...
pub type HttpQueryUrlGroupProperty = unsafe extern "system" fn(urlgroupid: u64, property: HTTP_SERVER_PROPERTY, propertyinformation: *mut core::ffi::c_void, propertyinformationlength: u32, returnlength: *mut u32) -> u32;
...
#[cfg(feature = "Win32_System_IO")]
pub type HttpReadFragmentFromCache = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, urlprefix: windows_sys::core::PCWSTR, byterange: *const HTTP_BYTE_RANGE, buffer: *mut core::ffi::c_void, bufferlength: u32, bytesread: *mut u32, overlapped: *mut super::super::System::IO::OVERLAPPED) -> u32;
#[cfg(feature = "Win32_System_IO")]
...
#[cfg(feature = "Win32_System_IO")]
pub type HttpReceiveClientCertificate = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, connectionid: u64, flags: u32, sslclientcertinfo: *mut HTTP_SSL_CLIENT_CERT_INFO, sslclientcertinfosize: u32, bytesreceived: *mut u32, overlapped: *mut super::super::System::IO::OVERLAPPED) -> u32;
#[cfg(feature = "Win32_System_IO")]
...
pub type HttpReceiveHttpRequest = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, requestid: u64, flags: HTTP_RECEIVE_HTTP_REQUEST_FLAGS, requestbuffer: *mut HTTP_REQUEST_V2, requestbufferlength: u32, bytesreturned: *mut u32, overlapped: *mut super::super::System::IO::OVERLAPPED) -> u32;
#[cfg(all(feature = "Win32_Networking_WinSock", feature = "Win32_System_IO"))]
...
#[cfg(feature = "Win32_System_IO")]
pub type HttpReceiveRequestEntityBody = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, requestid: u64, flags: u32, entitybuffer: *mut core::ffi::c_void, entitybufferlength: u32, bytesreturned: *mut u32, overlapped: *mut super::super::System::IO::OVERLAPPED) -> u32;
#[cfg(feature = "Win32_System_IO")]
...
pub type HttpRemoveUrl = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, fullyqualifiedurl: windows_sys::core::PCWSTR) -> u32;
...
pub type HttpRemoveUrlFromUrlGroup = unsafe extern "system" fn(urlgroupid: u64, pfullyqualifiedurl: windows_sys::core::PCWSTR, flags: u32) -> u32;
...
#[cfg(feature = "Win32_System_IO")]
pub type HttpSetRequestProperty = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, id: u64, propertyid: HTTP_REQUEST_PROPERTY, input: *const core::ffi::c_void, inputpropertysize: u32, overlapped: *const super::super::System::IO::OVERLAPPED) -> u32;
#[cfg(feature = "Win32_System_IO")]
...
pub type HttpSetRequestQueueProperty = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, property: HTTP_SERVER_PROPERTY, propertyinformation: *const core::ffi::c_void, propertyinformationlength: u32, reserved1: u32, reserved2: *const core::ffi::c_void) -> u32;
...
pub type HttpSetServerSessionProperty = unsafe extern "system" fn(serversessionid: u64, property: HTTP_SERVER_PROPERTY, propertyinformation: *const core::ffi::c_void, propertyinformationlength: u32) -> u32;
...
#[cfg(feature = "Win32_System_IO")]
pub type HttpSetServiceConfiguration = unsafe extern "system" fn(servicehandle: super::super::Foundation::HANDLE, configid: HTTP_SERVICE_CONFIG_ID, pconfiginformation: *const core::ffi::c_void, configinformationlength: u32, poverlapped: *const super::super::System::IO::OVERLAPPED) -> u32;
#[cfg(feature = "Win32_System_IO")]
...
pub type HttpSetUrlGroupProperty = unsafe extern "system" fn(urlgroupid: u64, property: HTTP_SERVER_PROPERTY, propertyinformation: *const core::ffi::c_void, propertyinformationlength: u32) -> u32;
...
pub type HttpShutdownRequestQueue = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE) -> u32;
windows_link::link!("httpapi.dll" "system" fn HttpShutdownRequestQueue(requestqueuehandle : super::super::Foundation::HANDLE) -> u32);
pub type HttpTerminate = unsafe extern "system" fn(flags: HTTP_INITIALIZE, preserved: *mut core::ffi::c_void) -> u32;
windows_link::link!("httpapi.dll" "system" fn HttpTerminate(flags : HTTP_INITIALIZE, preserved : *mut core::ffi::c_void) -> u32);
#[cfg(feature = "Win32_System_IO")]
pub type HttpUpdateServiceConfiguration = unsafe extern "system" fn(handle: super::super::Foundation::HANDLE, configid: HTTP_SERVICE_CONFIG_ID, configinfo: *const core::ffi::c_void, configinfolength: u32, overlapped: *const super::super::System::IO::OVERLAPPED) -> u32;
#[cfg(feature = "Win32_System_IO")]
...
#[cfg(feature = "Win32_System_IO")]
pub type HttpWaitForDemandStart = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, overlapped: *mut super::super::System::IO::OVERLAPPED) -> u32;
#[cfg(feature = "Win32_System_IO")]
...
#[cfg(feature = "Win32_System_IO")]
pub type HttpWaitForDisconnect = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, connectionid: u64, overlapped: *mut super::super::System::IO::OVERLAPPED) -> u32;
#[cfg(feature = "Win32_System_IO")]
...
#[cfg(feature = "Win32_System_IO")]
pub type HttpWaitForDisconnectEx = unsafe extern "system" fn(requestqueuehandle: super::super::Foundation::HANDLE, connectionid: u64, reserved: u32, overlapped: *mut super::super::System::IO::OVERLAPPED) -> u32;
#[cfg(feature = "Win32_System_IO")]
