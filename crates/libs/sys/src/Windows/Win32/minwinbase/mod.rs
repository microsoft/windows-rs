pub const CONTROL_C_EXIT: windows_sys::core::NTSTATUS = 0xC000013A_u32 as _;
...
pub const EXCEPTION_ACCESS_VIOLATION: windows_sys::core::NTSTATUS = 0xC0000005_u32 as _;
pub const EXCEPTION_ARRAY_BOUNDS_EXCEEDED: windows_sys::core::NTSTATUS = 0xC000008C_u32 as _;
pub const EXCEPTION_BREAKPOINT: windows_sys::core::NTSTATUS = 0x80000003_u32 as _;
pub const EXCEPTION_DATATYPE_MISALIGNMENT: windows_sys::core::NTSTATUS = 0x80000002_u32 as _;
...
pub const EXCEPTION_FLT_DENORMAL_OPERAND: windows_sys::core::NTSTATUS = 0xC000008D_u32 as _;
pub const EXCEPTION_FLT_DIVIDE_BY_ZERO: windows_sys::core::NTSTATUS = 0xC000008E_u32 as _;
pub const EXCEPTION_FLT_INEXACT_RESULT: windows_sys::core::NTSTATUS = 0xC000008F_u32 as _;
pub const EXCEPTION_FLT_INVALID_OPERATION: windows_sys::core::NTSTATUS = 0xC0000090_u32 as _;
pub const EXCEPTION_FLT_OVERFLOW: windows_sys::core::NTSTATUS = 0xC0000091_u32 as _;
pub const EXCEPTION_FLT_STACK_CHECK: windows_sys::core::NTSTATUS = 0xC0000092_u32 as _;
pub const EXCEPTION_FLT_UNDERFLOW: windows_sys::core::NTSTATUS = 0xC0000093_u32 as _;
pub const EXCEPTION_GUARD_PAGE: windows_sys::core::NTSTATUS = 0x80000001_u32 as _;
pub const EXCEPTION_ILLEGAL_INSTRUCTION: windows_sys::core::NTSTATUS = 0xC000001D_u32 as _;
pub const EXCEPTION_INT_DIVIDE_BY_ZERO: windows_sys::core::NTSTATUS = 0xC0000094_u32 as _;
pub const EXCEPTION_INT_OVERFLOW: windows_sys::core::NTSTATUS = 0xC0000095_u32 as _;
pub const EXCEPTION_INVALID_DISPOSITION: windows_sys::core::NTSTATUS = 0xC0000026_u32 as _;
pub const EXCEPTION_INVALID_HANDLE: windows_sys::core::NTSTATUS = 0xC0000008_u32 as _;
pub const EXCEPTION_IN_PAGE_ERROR: windows_sys::core::NTSTATUS = 0xC0000006_u32 as _;
pub const EXCEPTION_NONCONTINUABLE_EXCEPTION: windows_sys::core::NTSTATUS = 0xC0000025_u32 as _;
pub const EXCEPTION_POSSIBLE_DEADLOCK: windows_sys::core::NTSTATUS = 0xC0000194_u32 as _;
pub const EXCEPTION_PRIV_INSTRUCTION: windows_sys::core::NTSTATUS = 0xC0000096_u32 as _;
pub const EXCEPTION_SINGLE_STEP: windows_sys::core::NTSTATUS = 0x80000004_u32 as _;
pub const EXCEPTION_STACK_OVERFLOW: windows_sys::core::NTSTATUS = 0xC00000FD_u32 as _;
...
pub const STILL_ACTIVE: windows_sys::core::NTSTATUS = 0x103_u32 as _;
#[repr(C)]
#[derive(Clone, Copy, Default)]
