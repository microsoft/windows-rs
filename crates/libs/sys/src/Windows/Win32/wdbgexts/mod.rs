...
pub struct FIELD_INFO {
    pub fName: super::PUCHAR,
    pub printName: super::PUCHAR,
    pub size: u32,
    pub fOptions: u32,
    pub address: u64,
...
#[cfg(feature = "winnt")]
pub type PWINDBG_EXTENSION_ROUTINE32 = Option<unsafe extern "system" fn(hcurrentprocess: super::HANDLE, hcurrentthread: super::HANDLE, dwcurrentpc: u32, dwprocessor: u32, lpargumentstring: windows_sys::core::PCSTR)>;
#[cfg(feature = "winnt")]
pub type PWINDBG_EXTENSION_ROUTINE64 = Option<unsafe extern "system" fn(hcurrentprocess: super::HANDLE, hcurrentthread: super::HANDLE, dwcurrentpc: u64, dwprocessor: u32, lpargumentstring: windows_sys::core::PCSTR)>;
