pub type CheckGamingPrivilegeSilently = unsafe extern "system" fn(privilegeid: u32, scope: windows_sys::core::HSTRING, policy: windows_sys::core::HSTRING, hasprivilege: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type CheckGamingPrivilegeSilentlyForUser = unsafe extern "system" fn(user: *mut core::ffi::c_void, privilegeid: u32, scope: windows_sys::core::HSTRING, policy: windows_sys::core::HSTRING, hasprivilege: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type CheckGamingPrivilegeWithUIForUser = unsafe extern "system" fn(user: *mut core::ffi::c_void, privilegeid: u32, scope: windows_sys::core::HSTRING, policy: windows_sys::core::HSTRING, friendlymessage: windows_sys::core::HSTRING, completionroutine: GameUICompletionRoutine, context: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type HasExpandedResources = unsafe extern "system" fn(hasexpandedresources: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type ProcessPendingGameUI = unsafe extern "system" fn(waitforcompletion: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type ShowChangeFriendRelationshipUIForUser = unsafe extern "system" fn(user: *mut core::ffi::c_void, targetuserxuid: windows_sys::core::HSTRING, completionroutine: GameUICompletionRoutine, context: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type ShowCustomizeUserProfileUIForUser = unsafe extern "system" fn(user: *mut core::ffi::c_void, completionroutine: GameUICompletionRoutine, context: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type ShowFindFriendsUIForUser = unsafe extern "system" fn(user: *mut core::ffi::c_void, completionroutine: GameUICompletionRoutine, context: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type ShowGameInfoUIForUser = unsafe extern "system" fn(user: *mut core::ffi::c_void, titleid: u32, completionroutine: GameUICompletionRoutine, context: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type ShowGameInviteUIForUser = unsafe extern "system" fn(user: *mut core::ffi::c_void, serviceconfigurationid: windows_sys::core::HSTRING, sessiontemplatename: windows_sys::core::HSTRING, sessionid: windows_sys::core::HSTRING, invitationdisplaytext: windows_sys::core::HSTRING, completionroutine: GameUICompletionRoutine, context: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type ShowGameInviteUIWithContextForUser = unsafe extern "system" fn(user: *mut core::ffi::c_void, serviceconfigurationid: windows_sys::core::HSTRING, sessiontemplatename: windows_sys::core::HSTRING, sessionid: windows_sys::core::HSTRING, invitationdisplaytext: windows_sys::core::HSTRING, customactivationcontext: windows_sys::core::HSTRING, completionroutine: GameUICompletionRoutine, context: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type ShowPlayerPickerUIForUser = unsafe extern "system" fn(user: *mut core::ffi::c_void, promptdisplaytext: windows_sys::core::HSTRING, xuids: *const windows_sys::core::HSTRING, xuidscount: usize, preselectedxuids: *const windows_sys::core::HSTRING, preselectedxuidscount: usize, minselectioncount: usize, maxselectioncount: usize, completionroutine: PlayerPickerUICompletionRoutine, context: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type ShowProfileCardUIForUser = unsafe extern "system" fn(user: *mut core::ffi::c_void, targetuserxuid: windows_sys::core::HSTRING, completionroutine: GameUICompletionRoutine, context: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type ShowTitleAchievementsUIForUser = unsafe extern "system" fn(user: *mut core::ffi::c_void, titleid: u32, completionroutine: GameUICompletionRoutine, context: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type ShowUserSettingsUIForUser = unsafe extern "system" fn(user: *mut core::ffi::c_void, completionroutine: GameUICompletionRoutine, context: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type TryCancelPendingGameUI = unsafe extern "system" fn() -> windows_sys::core::BOOL;
