...
#[cfg(feature = "winnt")]
windows_link::link!("kernel32.dll" "system" fn GetProcessHeaps(numberofheaps : u32, processheaps : super::PHANDLE) -> u32);
#[cfg(feature = "winnt")]
...
windows_link::link!("kernel32.dll" "system" fn HeapQueryInformation(heaphandle : super::HANDLE, heapinformationclass : super::HEAP_INFORMATION_CLASS, heapinformation : *mut core::ffi::c_void, heapinformationlength : usize, returnlength : super::PSIZE_T) -> windows_sys::core::BOOL);
#[cfg(feature = "winnt")]
...
windows_link::link!("kernel32.dll" "system" fn HeapSize(hheap : super::HANDLE, dwflags : u32, lpmem : super::LPCVOID) -> usize);
#[cfg(feature = "winnt")]
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
windows_link::link!("kernel32.dll" "system" fn HeapValidate(hheap : super::HANDLE, dwflags : u32, lpmem : super::LPCVOID) -> windows_sys::core::BOOL);
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
windows_link::link!("kernel32.dll" "system" fn HeapWalk(hheap : super::HANDLE, lpentry : super::LPPROCESS_HEAP_ENTRY) -> windows_sys::core::BOOL);
#[repr(C)]
