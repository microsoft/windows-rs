...
windows_link::link!("clfsw32.dll" "system" fn AdvanceLogBase(pvmarshal : *mut core::ffi::c_void, plsnbase : *const super::CLFS_LSN, fflags : u32, poverlapped : *mut super::OVERLAPPED) -> windows_sys::core::BOOL);
windows_link::link!("clfsw32.dll" "system" fn AlignReservedLog(pvmarshal : *mut core::ffi::c_void, creservedrecords : u32, rgcbreservation : *const i64, pcbalignreservation : *mut i64) -> windows_sys::core::BOOL);
...
windows_link::link!("clfsw32.dll" "system" fn CreateLogFile(pszlogfilename : windows_sys::core::PCWSTR, fdesiredaccess : super::ACCESS_MASK, dwsharemode : u32, psalogfile : *const super::SECURITY_ATTRIBUTES, fcreatedisposition : u32, fflagsandattributes : u32) -> super::HANDLE);
...
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
windows_link::link!("clfsw32.dll" "system" fn FlushLogBuffers(pvmarshal : *const core::ffi::c_void, poverlapped : *mut super::OVERLAPPED) -> windows_sys::core::BOOL);
#[cfg(all(feature = "clfs", feature = "minwinbase", feature = "winnt"))]
windows_link::link!("clfsw32.dll" "system" fn FlushLogToLsn(pvmarshalcontext : *const core::ffi::c_void, plsnflush : *const super::CLFS_LSN, plsnlastflushed : *mut super::CLFS_LSN, poverlapped : *mut super::OVERLAPPED) -> windows_sys::core::BOOL);
...
#[cfg(all(feature = "clfs", feature = "winnt"))]
windows_link::link!("clfsw32.dll" "system" fn GetLogContainerName(hlog : super::HANDLE, cidlogicalcontainer : super::CLFS_CONTAINER_ID, pwstrcontainername : windows_sys::core::PWSTR, clencontainername : u32, pcactuallencontainername : *mut u32) -> windows_sys::core::BOOL);
#[cfg(all(feature = "clfs", feature = "winnt"))]
...
#[cfg(all(feature = "clfs", feature = "minwinbase", feature = "winnt"))]
windows_link::link!("clfsw32.dll" "system" fn ReadLogRecord(pvmarshal : *const core::ffi::c_void, plsnfirst : *const super::CLFS_LSN, econtextmode : super::CLFS_CONTEXT_MODE, ppvreadbuffer : *mut *mut core::ffi::c_void, pcbreadbuffer : *mut u32, perecordtype : *mut super::CLS_RECORD_TYPE, plsnundonext : *mut super::CLFS_LSN, plsnprevious : *mut super::CLFS_LSN, ppvreadcontext : *mut *mut core::ffi::c_void, poverlapped : *mut super::OVERLAPPED) -> windows_sys::core::BOOL);
#[cfg(all(feature = "clfs", feature = "minwinbase", feature = "winnt"))]
windows_link::link!("clfsw32.dll" "system" fn ReadLogRestartArea(pvmarshal : *const core::ffi::c_void, ppvrestartbuffer : *mut *mut core::ffi::c_void, pcbrestartbuffer : *mut u32, plsn : *mut super::CLFS_LSN, ppvcontext : *mut *mut core::ffi::c_void, poverlapped : *mut super::OVERLAPPED) -> windows_sys::core::BOOL);
#[cfg(all(feature = "clfs", feature = "minwinbase", feature = "winnt"))]
windows_link::link!("clfsw32.dll" "system" fn ReadNextLogRecord(pvreadcontext : *mut core::ffi::c_void, ppvbuffer : *mut *mut core::ffi::c_void, pcbbuffer : *mut u32, perecordtype : *mut super::CLS_RECORD_TYPE, plsnuser : *const super::CLFS_LSN, plsnundonext : *mut super::CLFS_LSN, plsnprevious : *mut super::CLFS_LSN, plsnrecord : *mut super::CLFS_LSN, poverlapped : *mut super::OVERLAPPED) -> windows_sys::core::BOOL);
#[cfg(all(feature = "clfs", feature = "minwinbase", feature = "winnt"))]
windows_link::link!("clfsw32.dll" "system" fn ReadPreviousLogRestartArea(pvreadcontext : *const core::ffi::c_void, ppvrestartbuffer : *mut *mut core::ffi::c_void, pcbrestartbuffer : *mut u32, plsnrestart : *mut super::CLFS_LSN, poverlapped : *mut super::OVERLAPPED) -> windows_sys::core::BOOL);
#[cfg(feature = "winnt")]
...
#[cfg(all(feature = "clfs", feature = "minwinbase", feature = "winnt"))]
windows_link::link!("clfsw32.dll" "system" fn ReserveAndAppendLog(pvmarshal : *const core::ffi::c_void, rgwriteentries : *const super::CLFS_WRITE_ENTRY, cwriteentries : u32, plsnundonext : *const super::CLFS_LSN, plsnprevious : *const super::CLFS_LSN, creserverecords : u32, rgcbreservation : *mut i64, fflags : u32, plsn : *mut super::CLFS_LSN, poverlapped : *mut super::OVERLAPPED) -> windows_sys::core::BOOL);
#[cfg(all(feature = "clfs", feature = "minwinbase", feature = "winnt"))]
windows_link::link!("clfsw32.dll" "system" fn ReserveAndAppendLogAligned(pvmarshal : *const core::ffi::c_void, rgwriteentries : *const super::CLFS_WRITE_ENTRY, cwriteentries : u32, cbentryalignment : u32, plsnundonext : *const super::CLFS_LSN, plsnprevious : *const super::CLFS_LSN, creserverecords : u32, rgcbreservation : *mut i64, fflags : u32, plsn : *mut super::CLFS_LSN, poverlapped : *mut super::OVERLAPPED) -> windows_sys::core::BOOL);
#[cfg(all(feature = "clfs", feature = "winnt"))]
...
#[cfg(all(feature = "clfs", feature = "minwinbase", feature = "winnt"))]
windows_link::link!("clfsw32.dll" "system" fn SetEndOfLog(hlog : super::HANDLE, plsnend : *const super::CLFS_LSN, lpoverlapped : *mut super::OVERLAPPED) -> windows_sys::core::BOOL);
#[cfg(all(feature = "clfs", feature = "winnt"))]
...
#[cfg(all(feature = "clfs", feature = "winnt"))]
windows_link::link!("clfsw32.dll" "system" fn SetLogArchiveTail(hlog : super::HANDLE, plsnarchivetail : *const super::CLFS_LSN, preserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("clfsw32.dll" "system" fn ValidateLog(pszlogfilename : windows_sys::core::PCWSTR, psalogfile : *const super::SECURITY_ATTRIBUTES, pinfobuffer : *mut super::CLFS_INFORMATION, pcbbuffer : *mut u32) -> windows_sys::core::BOOL);
#[cfg(all(feature = "clfs", feature = "minwinbase", feature = "winnt"))]
windows_link::link!("clfsw32.dll" "system" fn WriteLogRestartArea(pvmarshal : *mut core::ffi::c_void, pvrestartbuffer : *const core::ffi::c_void, cbrestartbuffer : u32, plsnbase : *const super::CLFS_LSN, fflags : u32, pcbwritten : *mut u32, plsnnext : *mut super::CLFS_LSN, poverlapped : *mut super::OVERLAPPED) -> windows_sys::core::BOOL);
