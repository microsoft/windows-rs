...
pub const EVENTLOG_AUDIT_FAILURE: REPORT_EVENT_TYPE = 16;
pub const EVENTLOG_AUDIT_SUCCESS: REPORT_EVENT_TYPE = 8;
pub const EVENTLOG_BACKWARDS_READ: READ_EVENT_LOG_READ_FLAGS = 8;
...
pub const EVENTLOG_INFORMATION_TYPE: REPORT_EVENT_TYPE = 4;
pub const EVENTLOG_SEEK_READ: READ_EVENT_LOG_READ_FLAGS = 2;
pub const EVENTLOG_SEQUENTIAL_READ: READ_EVENT_LOG_READ_FLAGS = 1;
