...
pub const E_IMAPI_BURN_VERIFICATION_FAILED: ::windows_sys::core::HRESULT = 0xC0AA0007u32 as _;
pub const E_IMAPI_DF2DATA_CLIENT_NAME_IS_NOT_VALID: ::windows_sys::core::HRESULT = 0xC0AA0408u32 as _;
pub const E_IMAPI_DF2DATA_INVALID_MEDIA_STATE: ::windows_sys::core::HRESULT = 0xC0AA0402u32 as _;
pub const E_IMAPI_DF2DATA_MEDIA_IS_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC0AA0406u32 as _;
pub const E_IMAPI_DF2DATA_MEDIA_NOT_BLANK: ::windows_sys::core::HRESULT = 0xC0AA0405u32 as _;
pub const E_IMAPI_DF2DATA_RECORDER_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC0AA0407u32 as _;
pub const E_IMAPI_DF2DATA_STREAM_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC0AA0403u32 as _;
pub const E_IMAPI_DF2DATA_STREAM_TOO_LARGE_FOR_CURRENT_MEDIA: ::windows_sys::core::HRESULT = 0xC0AA0404u32 as _;
pub const E_IMAPI_DF2DATA_WRITE_IN_PROGRESS: ::windows_sys::core::HRESULT = 0xC0AA0400u32 as _;
pub const E_IMAPI_DF2DATA_WRITE_NOT_IN_PROGRESS: ::windows_sys::core::HRESULT = 0xC0AA0401u32 as _;
pub const E_IMAPI_DF2RAW_CLIENT_NAME_IS_NOT_VALID: ::windows_sys::core::HRESULT = 0xC0AA0604u32 as _;
pub const E_IMAPI_DF2RAW_DATA_BLOCK_TYPE_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC0AA060Eu32 as _;
pub const E_IMAPI_DF2RAW_MEDIA_IS_NOT_BLANK: ::windows_sys::core::HRESULT = 0xC0AA0606u32 as _;
pub const E_IMAPI_DF2RAW_MEDIA_IS_NOT_PREPARED: ::windows_sys::core::HRESULT = 0xC0AA0602u32 as _;
pub const E_IMAPI_DF2RAW_MEDIA_IS_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC0AA0607u32 as _;
pub const E_IMAPI_DF2RAW_MEDIA_IS_PREPARED: ::windows_sys::core::HRESULT = 0xC0AA0603u32 as _;
pub const E_IMAPI_DF2RAW_NOT_ENOUGH_SPACE: ::windows_sys::core::HRESULT = 0xC0AA0609u32 as _;
pub const E_IMAPI_DF2RAW_NO_RECORDER_SPECIFIED: ::windows_sys::core::HRESULT = 0xC0AA060Au32 as _;
pub const E_IMAPI_DF2RAW_RECORDER_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC0AA0610u32 as _;
pub const E_IMAPI_DF2RAW_STREAM_LEADIN_TOO_SHORT: ::windows_sys::core::HRESULT = 0xC0AA060Fu32 as _;
pub const E_IMAPI_DF2RAW_STREAM_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC0AA060Du32 as _;
pub const E_IMAPI_DF2RAW_WRITE_IN_PROGRESS: ::windows_sys::core::HRESULT = 0xC0AA0600u32 as _;
pub const E_IMAPI_DF2RAW_WRITE_NOT_IN_PROGRESS: ::windows_sys::core::HRESULT = 0xC0AA0601u32 as _;
pub const E_IMAPI_DF2TAO_CLIENT_NAME_IS_NOT_VALID: ::windows_sys::core::HRESULT = 0xC0AA050Fu32 as _;
pub const E_IMAPI_DF2TAO_INVALID_ISRC: ::windows_sys::core::HRESULT = 0xC0AA050Bu32 as _;
pub const E_IMAPI_DF2TAO_INVALID_MCN: ::windows_sys::core::HRESULT = 0xC0AA050Cu32 as _;
pub const E_IMAPI_DF2TAO_MEDIA_IS_NOT_BLANK: ::windows_sys::core::HRESULT = 0xC0AA0506u32 as _;
pub const E_IMAPI_DF2TAO_MEDIA_IS_NOT_PREPARED: ::windows_sys::core::HRESULT = 0xC0AA0502u32 as _;
pub const E_IMAPI_DF2TAO_MEDIA_IS_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC0AA0507u32 as _;
pub const E_IMAPI_DF2TAO_MEDIA_IS_PREPARED: ::windows_sys::core::HRESULT = 0xC0AA0503u32 as _;
pub const E_IMAPI_DF2TAO_NOT_ENOUGH_SPACE: ::windows_sys::core::HRESULT = 0xC0AA0509u32 as _;
pub const E_IMAPI_DF2TAO_NO_RECORDER_SPECIFIED: ::windows_sys::core::HRESULT = 0xC0AA050Au32 as _;
pub const E_IMAPI_DF2TAO_PROPERTY_FOR_BLANK_MEDIA_ONLY: ::windows_sys::core::HRESULT = 0xC0AA0504u32 as _;
pub const E_IMAPI_DF2TAO_RECORDER_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC0AA050Eu32 as _;
pub const E_IMAPI_DF2TAO_STREAM_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC0AA050Du32 as _;
pub const E_IMAPI_DF2TAO_TABLE_OF_CONTENTS_EMPTY_DISC: ::windows_sys::core::HRESULT = 0xC0AA0505u32 as _;
pub const E_IMAPI_DF2TAO_TRACK_LIMIT_REACHED: ::windows_sys::core::HRESULT = 0xC0AA0508u32 as _;
pub const E_IMAPI_DF2TAO_WRITE_IN_PROGRESS: ::windows_sys::core::HRESULT = 0xC0AA0500u32 as _;
pub const E_IMAPI_DF2TAO_WRITE_NOT_IN_PROGRESS: ::windows_sys::core::HRESULT = 0xC0AA0501u32 as _;
pub const E_IMAPI_ERASE_CLIENT_NAME_IS_NOT_VALID: ::windows_sys::core::HRESULT = 0xC0AA090Bu32 as _;
pub const E_IMAPI_ERASE_DISC_INFORMATION_TOO_SMALL: ::windows_sys::core::HRESULT = 0x80AA0902u32 as _;
pub const E_IMAPI_ERASE_DRIVE_FAILED_ERASE_COMMAND: ::windows_sys::core::HRESULT = 0x80AA0905u32 as _;
pub const E_IMAPI_ERASE_DRIVE_FAILED_SPINUP_COMMAND: ::windows_sys::core::HRESULT = 0x80AA0908u32 as _;
pub const E_IMAPI_ERASE_MEDIA_IS_NOT_ERASABLE: ::windows_sys::core::HRESULT = 0x80AA0904u32 as _;
pub const E_IMAPI_ERASE_MEDIA_IS_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC0AA0909u32 as _;
pub const E_IMAPI_ERASE_MODE_PAGE_2A_TOO_SMALL: ::windows_sys::core::HRESULT = 0x80AA0903u32 as _;
pub const E_IMAPI_ERASE_ONLY_ONE_RECORDER_SUPPORTED: ::windows_sys::core::HRESULT = 0x80AA0901u32 as _;
pub const E_IMAPI_ERASE_RECORDER_IN_USE: ::windows_sys::core::HRESULT = 0x80AA0900u32 as _;
pub const E_IMAPI_ERASE_RECORDER_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC0AA090Au32 as _;
pub const E_IMAPI_ERASE_TOOK_LONGER_THAN_ONE_HOUR: ::windows_sys::core::HRESULT = 0x80AA0906u32 as _;
pub const E_IMAPI_ERASE_UNEXPECTED_DRIVE_RESPONSE_DURING_ERASE: ::windows_sys::core::HRESULT = 0x80AA0907u32 as _;
pub const E_IMAPI_LOSS_OF_STREAMING: ::windows_sys::core::HRESULT = 0xC0AA0300u32 as _;
pub const E_IMAPI_RAW_IMAGE_INSUFFICIENT_SPACE: ::windows_sys::core::HRESULT = 0x80AA0A05u32 as _;
pub const E_IMAPI_RAW_IMAGE_IS_READ_ONLY: ::windows_sys::core::HRESULT = 0x80AA0A00u32 as _;
pub const E_IMAPI_RAW_IMAGE_NO_TRACKS: ::windows_sys::core::HRESULT = 0x80AA0A03u32 as _;
pub const E_IMAPI_RAW_IMAGE_SECTOR_TYPE_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0x80AA0A02u32 as _;
pub const E_IMAPI_RAW_IMAGE_TOO_MANY_TRACKS: ::windows_sys::core::HRESULT = 0x80AA0A01u32 as _;
pub const E_IMAPI_RAW_IMAGE_TOO_MANY_TRACK_INDEXES: ::windows_sys::core::HRESULT = 0x80AA0A06u32 as _;
pub const E_IMAPI_RAW_IMAGE_TRACKS_ALREADY_ADDED: ::windows_sys::core::HRESULT = 0x80AA0A04u32 as _;
pub const E_IMAPI_RAW_IMAGE_TRACK_INDEX_NOT_FOUND: ::windows_sys::core::HRESULT = 0x80AA0A07u32 as _;
pub const E_IMAPI_RAW_IMAGE_TRACK_INDEX_OFFSET_ZERO_CANNOT_BE_CLEARED: ::windows_sys::core::HRESULT = 0x80AA0A09u32 as _;
pub const E_IMAPI_RAW_IMAGE_TRACK_INDEX_TOO_CLOSE_TO_OTHER_INDEX: ::windows_sys::core::HRESULT = 0x80AA0A0Au32 as _;
pub const E_IMAPI_RECORDER_CLIENT_NAME_IS_NOT_VALID: ::windows_sys::core::HRESULT = 0xC0AA0211u32 as _;
pub const E_IMAPI_RECORDER_COMMAND_TIMEOUT: ::windows_sys::core::HRESULT = 0xC0AA020Du32 as _;
pub const E_IMAPI_RECORDER_DVD_STRUCTURE_NOT_PRESENT: ::windows_sys::core::HRESULT = 0xC0AA020Eu32 as _;
pub const E_IMAPI_RECORDER_FEATURE_IS_NOT_CURRENT: ::windows_sys::core::HRESULT = 0xC0AA020Bu32 as _;
pub const E_IMAPI_RECORDER_GET_CONFIGURATION_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC0AA020Cu32 as _;
pub const E_IMAPI_RECORDER_INVALID_MODE_PARAMETERS: ::windows_sys::core::HRESULT = 0xC0AA0208u32 as _;
pub const E_IMAPI_RECORDER_INVALID_RESPONSE_FROM_DEVICE: ::windows_sys::core::HRESULT = 0xC0AA02FFu32 as _;
pub const E_IMAPI_RECORDER_LOCKED: ::windows_sys::core::HRESULT = 0xC0AA0210u32 as _;
pub const E_IMAPI_RECORDER_MEDIA_BECOMING_READY: ::windows_sys::core::HRESULT = 0xC0AA0205u32 as _;
pub const E_IMAPI_RECORDER_MEDIA_BUSY: ::windows_sys::core::HRESULT = 0xC0AA0207u32 as _;
pub const E_IMAPI_RECORDER_MEDIA_FORMAT_IN_PROGRESS: ::windows_sys::core::HRESULT = 0xC0AA0206u32 as _;
pub const E_IMAPI_RECORDER_MEDIA_INCOMPATIBLE: ::windows_sys::core::HRESULT = 0xC0AA0203u32 as _;
pub const E_IMAPI_RECORDER_MEDIA_NOT_FORMATTED: ::windows_sys::core::HRESULT = 0xC0AA0212u32 as _;
pub const E_IMAPI_RECORDER_MEDIA_NO_MEDIA: ::windows_sys::core::HRESULT = 0xC0AA0202u32 as _;
pub const E_IMAPI_RECORDER_MEDIA_SPEED_MISMATCH: ::windows_sys::core::HRESULT = 0xC0AA020Fu32 as _;
pub const E_IMAPI_RECORDER_MEDIA_UPSIDE_DOWN: ::windows_sys::core::HRESULT = 0xC0AA0204u32 as _;
pub const E_IMAPI_RECORDER_MEDIA_WRITE_PROTECTED: ::windows_sys::core::HRESULT = 0xC0AA0209u32 as _;
pub const E_IMAPI_RECORDER_NO_SUCH_FEATURE: ::windows_sys::core::HRESULT = 0xC0AA020Au32 as _;
pub const E_IMAPI_RECORDER_NO_SUCH_MODE_PAGE: ::windows_sys::core::HRESULT = 0xC0AA0201u32 as _;
pub const E_IMAPI_RECORDER_REQUIRED: ::windows_sys::core::HRESULT = 0xC0AA0003u32 as _;
pub const E_IMAPI_REQUEST_CANCELLED: ::windows_sys::core::HRESULT = 0xC0AA0002u32 as _;
pub const E_IMAPI_UNEXPECTED_RESPONSE_FROM_DEVICE: ::windows_sys::core::HRESULT = 0xC0AA0301u32 as _;
pub const FACILITY_IMAPI2: u32 = 170u32;
pub const IMAPI_E_BAD_MULTISESSION_PARAMETER: ::windows_sys::core::HRESULT = 0xC0AAB162u32 as _;
pub const IMAPI_E_BOOT_EMULATION_IMAGE_SIZE_MISMATCH: ::windows_sys::core::HRESULT = 0xC0AAB14Au32 as _;
pub const IMAPI_E_BOOT_IMAGE_DATA: ::windows_sys::core::HRESULT = 0xC0AAB148u32 as _;
pub const IMAPI_E_BOOT_OBJECT_CONFLICT: ::windows_sys::core::HRESULT = 0xC0AAB149u32 as _;
pub const IMAPI_E_DATA_STREAM_CREATE_FAILURE: ::windows_sys::core::HRESULT = 0xC0AAB12Au32 as _;
pub const IMAPI_E_DATA_STREAM_INCONSISTENCY: ::windows_sys::core::HRESULT = 0xC0AAB128u32 as _;
pub const IMAPI_E_DATA_STREAM_READ_FAILURE: ::windows_sys::core::HRESULT = 0xC0AAB129u32 as _;
pub const IMAPI_E_DATA_TOO_BIG: ::windows_sys::core::HRESULT = 0xC0AAB132u32 as _;
pub const IMAPI_E_DIRECTORY_READ_FAILURE: ::windows_sys::core::HRESULT = 0xC0AAB12Bu32 as _;
pub const IMAPI_E_DIR_NOT_EMPTY: ::windows_sys::core::HRESULT = 0xC0AAB10Au32 as _;
pub const IMAPI_E_DIR_NOT_FOUND: ::windows_sys::core::HRESULT = 0xC0AAB11Au32 as _;
pub const IMAPI_E_DISC_MISMATCH: ::windows_sys::core::HRESULT = 0xC0AAB158u32 as _;
pub const IMAPI_E_DUP_NAME: ::windows_sys::core::HRESULT = 0xC0AAB112u32 as _;
pub const IMAPI_E_EMPTY_DISC: ::windows_sys::core::HRESULT = 0xC0AAB150u32 as _;
pub const IMAPI_E_FILE_NOT_FOUND: ::windows_sys::core::HRESULT = 0xC0AAB119u32 as _;
pub const IMAPI_E_FILE_SYSTEM_CHANGE_NOT_ALLOWED: ::windows_sys::core::HRESULT = 0xC0AAB163u32 as _;
pub const IMAPI_E_FILE_SYSTEM_FEATURE_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC0AAB154u32 as _;
pub const IMAPI_E_FILE_SYSTEM_NOT_EMPTY: ::windows_sys::core::HRESULT = 0xC0AAB106u32 as _;
pub const IMAPI_E_FILE_SYSTEM_NOT_FOUND: ::windows_sys::core::HRESULT = 0xC0AAB152u32 as _;
pub const IMAPI_E_FILE_SYSTEM_READ_CONSISTENCY_ERROR: ::windows_sys::core::HRESULT = 0xC0AAB153u32 as _;
pub const IMAPI_E_FSI_INTERNAL_ERROR: ::windows_sys::core::HRESULT = 0xC0AAB100u32 as _;
pub const IMAPI_E_IMAGEMANAGER_IMAGE_NOT_ALIGNED: ::windows_sys::core::HRESULT = 0xC0AAB200u32 as _;
pub const IMAPI_E_IMAGEMANAGER_IMAGE_TOO_BIG: ::windows_sys::core::HRESULT = 0xC0AAB203u32 as _;
pub const IMAPI_E_IMAGEMANAGER_NO_IMAGE: ::windows_sys::core::HRESULT = 0xC0AAB202u32 as _;
pub const IMAPI_E_IMAGEMANAGER_NO_VALID_VD_FOUND: ::windows_sys::core::HRESULT = 0xC0AAB201u32 as _;
pub const IMAPI_E_IMAGE_SIZE_LIMIT: ::windows_sys::core::HRESULT = 0xC0AAB120u32 as _;
pub const IMAPI_E_IMAGE_TOO_BIG: ::windows_sys::core::HRESULT = 0xC0AAB121u32 as _;
pub const IMAPI_E_IMPORT_MEDIA_NOT_ALLOWED: ::windows_sys::core::HRESULT = 0xC0AAB159u32 as _;
pub const IMAPI_E_IMPORT_READ_FAILURE: ::windows_sys::core::HRESULT = 0xC0AAB157u32 as _;
pub const IMAPI_E_IMPORT_SEEK_FAILURE: ::windows_sys::core::HRESULT = 0xC0AAB156u32 as _;
pub const IMAPI_E_IMPORT_TYPE_COLLISION_DIRECTORY_EXISTS_AS_FILE: ::windows_sys::core::HRESULT = 0xC0AAB15Eu32 as _;
pub const IMAPI_E_IMPORT_TYPE_COLLISION_FILE_EXISTS_AS_DIRECTORY: ::windows_sys::core::HRESULT = 0xC0AAB155u32 as _;
pub const IMAPI_E_INCOMPATIBLE_MULTISESSION_TYPE: ::windows_sys::core::HRESULT = 0xC0AAB15Bu32 as _;
pub const IMAPI_E_INCOMPATIBLE_PREVIOUS_SESSION: ::windows_sys::core::HRESULT = 0xC0AAB133u32 as _;
pub const IMAPI_E_INVALID_DATE: ::windows_sys::core::HRESULT = 0xC0AAB105u32 as _;
pub const IMAPI_E_INVALID_PARAM: ::windows_sys::core::HRESULT = 0xC0AAB101u32 as _;
pub const IMAPI_E_INVALID_PATH: ::windows_sys::core::HRESULT = 0xC0AAB110u32 as _;
pub const IMAPI_E_INVALID_VOLUME_NAME: ::windows_sys::core::HRESULT = 0xC0AAB104u32 as _;
pub const IMAPI_E_INVALID_WORKING_DIRECTORY: ::windows_sys::core::HRESULT = 0xC0AAB140u32 as _;
pub const IMAPI_E_ISO9660_LEVELS: ::windows_sys::core::HRESULT = 0xC0AAB131u32 as _;
pub const IMAPI_E_ITEM_NOT_FOUND: ::windows_sys::core::HRESULT = 0xC0AAB118u32 as _;
pub const IMAPI_E_MULTISESSION_NOT_SET: ::windows_sys::core::HRESULT = 0xC0AAB15Du32 as _;
pub const IMAPI_E_NOT_DIR: ::windows_sys::core::HRESULT = 0xC0AAB109u32 as _;
pub const IMAPI_E_NOT_FILE: ::windows_sys::core::HRESULT = 0xC0AAB108u32 as _;
pub const IMAPI_E_NOT_IN_FILE_SYSTEM: ::windows_sys::core::HRESULT = 0xC0AAB10Bu32 as _;
pub const IMAPI_E_NO_COMPATIBLE_MULTISESSION_TYPE: ::windows_sys::core::HRESULT = 0xC0AAB15Cu32 as _;
pub const IMAPI_E_NO_OUTPUT: ::windows_sys::core::HRESULT = 0xC0AAB103u32 as _;
pub const IMAPI_E_NO_SUPPORTED_FILE_SYSTEM: ::windows_sys::core::HRESULT = 0xC0AAB151u32 as _;
pub const IMAPI_E_NO_UNIQUE_NAME: ::windows_sys::core::HRESULT = 0xC0AAB113u32 as _;
pub const IMAPI_E_PROPERTY_NOT_ACCESSIBLE: ::windows_sys::core::HRESULT = 0xC0AAB160u32 as _;
pub const IMAPI_E_READONLY: ::windows_sys::core::HRESULT = 0xC0AAB102u32 as _;
pub const IMAPI_E_RESTRICTED_NAME_VIOLATION: ::windows_sys::core::HRESULT = 0xC0AAB111u32 as _;
pub const IMAPI_E_STASHFILE_MOVE: ::windows_sys::core::HRESULT = 0xC0AAB142u32 as _;
pub const IMAPI_E_STASHFILE_OPEN_FAILURE: ::windows_sys::core::HRESULT = 0xC0AAB138u32 as _;
pub const IMAPI_E_STASHFILE_READ_FAILURE: ::windows_sys::core::HRESULT = 0xC0AAB13Bu32 as _;
pub const IMAPI_E_STASHFILE_SEEK_FAILURE: ::windows_sys::core::HRESULT = 0xC0AAB139u32 as _;
pub const IMAPI_E_STASHFILE_WRITE_FAILURE: ::windows_sys::core::HRESULT = 0xC0AAB13Au32 as _;
pub const IMAPI_E_TOO_MANY_DIRS: ::windows_sys::core::HRESULT = 0xC0AAB130u32 as _;
pub const IMAPI_E_UDF_NOT_WRITE_COMPATIBLE: ::windows_sys::core::HRESULT = 0xC0AAB15Au32 as _;
pub const IMAPI_E_UDF_REVISION_CHANGE_NOT_ALLOWED: ::windows_sys::core::HRESULT = 0xC0AAB161u32 as _;
pub const IMAPI_E_WORKING_DIRECTORY_SPACE: ::windows_sys::core::HRESULT = 0xC0AAB141u32 as _;
pub const IMAPI_S_IMAGE_FEATURE_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xAAB15Fu32 as _;
...
pub const S_IMAPI_BOTHADJUSTED: ::windows_sys::core::HRESULT = 0xAA0006u32 as _;
pub const S_IMAPI_COMMAND_HAS_SENSE_DATA: ::windows_sys::core::HRESULT = 0xAA0200u32 as _;
pub const S_IMAPI_RAW_IMAGE_TRACK_INDEX_ALREADY_EXISTS: ::windows_sys::core::HRESULT = 0xAA0A08u32 as _;
pub const S_IMAPI_ROTATIONADJUSTED: ::windows_sys::core::HRESULT = 0xAA0005u32 as _;
pub const S_IMAPI_SPEEDADJUSTED: ::windows_sys::core::HRESULT = 0xAA0004u32 as _;
pub const S_IMAPI_WRITE_NOT_IN_PROGRESS: ::windows_sys::core::HRESULT = 0xAA0302u32 as _;
