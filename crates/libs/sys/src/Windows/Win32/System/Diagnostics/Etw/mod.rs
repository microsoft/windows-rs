...
windows_link::link!("advapi32.dll" "system" fn EnableTrace(enable : u32, enableflag : u32, enablelevel : u32, controlguid : *mut windows_sys::core::GUID, tracehandle : CONTROLTRACE_HANDLE) -> super::super::super::Foundation:: WIN32_ERROR);
windows_link::link!("advapi32.dll" "system" fn EnableTraceEx(providerid : *mut windows_sys::core::GUID, sourceid : *mut windows_sys::core::GUID, tracehandle : CONTROLTRACE_HANDLE, isenabled : u32, level : u8, matchanykeyword : u64, matchallkeyword : u64, enableproperty : u32, enablefilterdesc : *mut EVENT_FILTER_DESCRIPTOR) -> super::super::super::Foundation:: WIN32_ERROR);
...
windows_link::link!("advapi32.dll" "system" fn EnumerateTraceGuidsEx(tracequeryinfoclass : TRACE_QUERY_INFO_CLASS, inbuffer : *mut core::ffi::c_void, inbuffersize : u32, outbuffer : *mut core::ffi::c_void, outbuffersize : u32, returnlength : *mut u32) -> super::super::super::Foundation:: WIN32_ERROR);
...
windows_link::link!("advapi32.dll" "system" fn EventAccessRemove(guid : *mut windows_sys::core::GUID) -> u32);
...
windows_link::link!("advapi32.dll" "system" fn EventRegister(providerid : *mut windows_sys::core::GUID, enablecallback : PENABLECALLBACK, callbackcontext : *mut core::ffi::c_void, reghandle : *mut REGHANDLE) -> u32);
windows_link::link!("advapi32.dll" "system" fn EventSetInformation(reghandle : REGHANDLE, informationclass : EVENT_INFO_CLASS, eventinformation : *mut core::ffi::c_void, informationlength : u32) -> u32);
windows_link::link!("advapi32.dll" "system" fn EventUnregister(reghandle : REGHANDLE) -> u32);
windows_link::link!("advapi32.dll" "system" fn EventWrite(reghandle : REGHANDLE, eventdescriptor : *mut EVENT_DESCRIPTOR, userdatacount : u32, userdata : *mut EVENT_DATA_DESCRIPTOR) -> u32);
windows_link::link!("advapi32.dll" "system" fn EventWriteEx(reghandle : REGHANDLE, eventdescriptor : *mut EVENT_DESCRIPTOR, filter : u64, flags : u32, activityid : *mut windows_sys::core::GUID, relatedactivityid : *mut windows_sys::core::GUID, userdatacount : u32, userdata : *mut EVENT_DATA_DESCRIPTOR) -> u32);
...
windows_link::link!("advapi32.dll" "system" fn EventWriteTransfer(reghandle : REGHANDLE, eventdescriptor : *mut EVENT_DESCRIPTOR, activityid : *mut windows_sys::core::GUID, relatedactivityid : *mut windows_sys::core::GUID, userdatacount : u32, userdata : *mut EVENT_DATA_DESCRIPTOR) -> u32);
...
windows_link::link!("advapi32.dll" "system" fn GetTraceLoggerHandle(buffer : *mut core::ffi::c_void) -> u64);
...
#[cfg(feature = "Win32_System_Time")]
windows_link::link!("advapi32.dll" "system" fn OpenTraceFromBufferStream(options : *mut ETW_OPEN_TRACE_OPTIONS, buffercompletioncallback : PETW_BUFFER_COMPLETION_CALLBACK, buffercompletioncontext : *mut core::ffi::c_void) -> u64);
#[cfg(feature = "Win32_System_Time")]
...
#[cfg(feature = "Win32_System_Time")]
windows_link::link!("advapi32.dll" "system" fn OpenTraceFromRealTimeLogger(loggername : windows_sys::core::PCWSTR, options : *mut ETW_OPEN_TRACE_OPTIONS, logfileheader : *mut TRACE_LOGFILE_HEADER) -> u64);
#[cfg(feature = "Win32_System_Time")]
windows_link::link!("advapi32.dll" "system" fn OpenTraceFromRealTimeLoggerWithAllocationOptions(loggername : windows_sys::core::PCWSTR, options : *mut ETW_OPEN_TRACE_OPTIONS, allocationsize : usize, memorypartitionhandle : super::super::super::Foundation:: HANDLE, logfileheader : *mut TRACE_LOGFILE_HEADER) -> u64);
#[cfg(feature = "Win32_System_Time")]
...
windows_link::link!("advapi32.dll" "system" fn RegisterTraceGuidsA(requestaddress : WMIDPREQUEST, requestcontext : *mut core::ffi::c_void, controlguid : *mut windows_sys::core::GUID, guidcount : u32, traceguidreg : *mut TRACE_GUID_REGISTRATION, mofimagepath : windows_sys::core::PCSTR, mofresourcename : windows_sys::core::PCSTR, registrationhandle : *mut u64) -> u32);
windows_link::link!("advapi32.dll" "system" fn RegisterTraceGuidsW(requestaddress : WMIDPREQUEST, requestcontext : *mut core::ffi::c_void, controlguid : *mut windows_sys::core::GUID, guidcount : u32, traceguidreg : *mut TRACE_GUID_REGISTRATION, mofimagepath : windows_sys::core::PCWSTR, mofresourcename : windows_sys::core::PCWSTR, registrationhandle : *mut u64) -> u32);
windows_link::link!("advapi32.dll" "system" fn RemoveTraceCallback(pguid : *mut windows_sys::core::GUID) -> super::super::super::Foundation:: WIN32_ERROR);
windows_link::link!("advapi32.dll" "system" fn SetTraceCallback(pguid : *mut windows_sys::core::GUID, eventcallback : PEVENT_CALLBACK) -> super::super::super::Foundation:: WIN32_ERROR);
...
windows_link::link!("tdh.dll" "system" fn TdhEnumerateManifestProviderEvents(providerguid : *mut windows_sys::core::GUID, buffer : *mut PROVIDER_EVENT_INFO, buffersize : *mut u32) -> u32);
...
windows_link::link!("tdh.dll" "system" fn TdhGetEventInformation(event : *mut EVENT_RECORD, tdhcontextcount : u32, tdhcontext : *mut TDH_CONTEXT, buffer : *mut TRACE_EVENT_INFO, buffersize : *mut u32) -> u32);
windows_link::link!("tdh.dll" "system" fn TdhGetEventMapInformation(pevent : *mut EVENT_RECORD, pmapname : windows_sys::core::PCWSTR, pbuffer : *mut EVENT_MAP_INFO, pbuffersize : *mut u32) -> u32);
windows_link::link!("tdh.dll" "system" fn TdhGetManifestEventInformation(providerguid : *mut windows_sys::core::GUID, eventdescriptor : *mut EVENT_DESCRIPTOR, buffer : *mut TRACE_EVENT_INFO, buffersize : *mut u32) -> u32);
windows_link::link!("tdh.dll" "system" fn TdhGetProperty(pevent : *mut EVENT_RECORD, tdhcontextcount : u32, ptdhcontext : *mut TDH_CONTEXT, propertydatacount : u32, ppropertydata : *mut PROPERTY_DATA_DESCRIPTOR, buffersize : u32, pbuffer : *mut u8) -> u32);
...
windows_link::link!("tdh.dll" "system" fn TdhGetWppMessage(handle : TDH_HANDLE, eventrecord : *mut EVENT_RECORD, buffersize : *mut u32, buffer : *mut u8) -> u32);
windows_link::link!("tdh.dll" "system" fn TdhGetWppProperty(handle : TDH_HANDLE, eventrecord : *mut EVENT_RECORD, propertyname : windows_sys::core::PCWSTR, buffersize : *mut u32, buffer : *mut u8) -> u32);
...
windows_link::link!("tdh.dll" "system" fn TdhUnloadManifestFromMemory(pdata : *mut core::ffi::c_void, cbdata : u32) -> u32);
...
windows_link::link!("advapi32.dll" "system" fn TraceEventInstance(tracehandle : u64, eventtrace : *mut EVENT_INSTANCE_HEADER, instinfo : *mut EVENT_INSTANCE_INFO, parentinstinfo : *mut EVENT_INSTANCE_INFO) -> u32);
...
pub type PENABLECALLBACK = Option<unsafe extern "system" fn(sourceid: *mut windows_sys::core::GUID, isenabled: ENABLECALLBACK_ENABLED_STATE, level: u8, matchanykeyword: u64, matchallkeyword: u64, filterdata: *mut EVENT_FILTER_DESCRIPTOR, callbackcontext: *mut core::ffi::c_void)>;
#[cfg(feature = "Win32_System_Time")]
