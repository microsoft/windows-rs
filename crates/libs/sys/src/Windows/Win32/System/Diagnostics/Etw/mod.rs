...
pub const EVENT_CONTROL_CODE_CAPTURE_STATE: ENABLECALLBACK_ENABLED_STATE = 2;
pub const EVENT_CONTROL_CODE_DISABLE_PROVIDER: ENABLECALLBACK_ENABLED_STATE = 0;
pub const EVENT_CONTROL_CODE_ENABLE_PROVIDER: ENABLECALLBACK_ENABLED_STATE = 1;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const EVENT_TRACE_CONTROL_FLUSH: EVENT_TRACE_CONTROL = 3;
pub const EVENT_TRACE_CONTROL_INCREMENT_FILE: u32 = 4;
pub const EVENT_TRACE_CONTROL_QUERY: EVENT_TRACE_CONTROL = 0;
pub const EVENT_TRACE_CONTROL_STOP: EVENT_TRACE_CONTROL = 1;
pub const EVENT_TRACE_CONTROL_UPDATE: EVENT_TRACE_CONTROL = 2;
...
pub const EVENT_TRACE_FLAG_ALPC: EVENT_TRACE_FLAG = 1048576;
pub const EVENT_TRACE_FLAG_CSWITCH: EVENT_TRACE_FLAG = 16;
pub const EVENT_TRACE_FLAG_DBGPRINT: EVENT_TRACE_FLAG = 262144;
pub const EVENT_TRACE_FLAG_DEBUG_EVENTS: u32 = 4194304;
pub const EVENT_TRACE_FLAG_DISK_FILE_IO: EVENT_TRACE_FLAG = 512;
pub const EVENT_TRACE_FLAG_DISK_IO: EVENT_TRACE_FLAG = 256;
pub const EVENT_TRACE_FLAG_DISK_IO_INIT: EVENT_TRACE_FLAG = 1024;
pub const EVENT_TRACE_FLAG_DISPATCHER: EVENT_TRACE_FLAG = 2048;
pub const EVENT_TRACE_FLAG_DPC: EVENT_TRACE_FLAG = 32;
pub const EVENT_TRACE_FLAG_DRIVER: EVENT_TRACE_FLAG = 8388608;
pub const EVENT_TRACE_FLAG_ENABLE_RESERVE: u32 = 536870912;
pub const EVENT_TRACE_FLAG_EXTENSION: u32 = 2147483648;
pub const EVENT_TRACE_FLAG_FILE_IO: EVENT_TRACE_FLAG = 33554432;
pub const EVENT_TRACE_FLAG_FILE_IO_INIT: EVENT_TRACE_FLAG = 67108864;
pub const EVENT_TRACE_FLAG_FORWARD_WMI: u32 = 1073741824;
pub const EVENT_TRACE_FLAG_IMAGE_LOAD: EVENT_TRACE_FLAG = 4;
pub const EVENT_TRACE_FLAG_INTERRUPT: EVENT_TRACE_FLAG = 64;
pub const EVENT_TRACE_FLAG_JOB: EVENT_TRACE_FLAG = 524288;
pub const EVENT_TRACE_FLAG_MEMORY_HARD_FAULTS: EVENT_TRACE_FLAG = 8192;
pub const EVENT_TRACE_FLAG_MEMORY_PAGE_FAULTS: EVENT_TRACE_FLAG = 4096;
pub const EVENT_TRACE_FLAG_NETWORK_TCPIP: EVENT_TRACE_FLAG = 65536;
pub const EVENT_TRACE_FLAG_NO_SYSCONFIG: EVENT_TRACE_FLAG = 268435456;
pub const EVENT_TRACE_FLAG_PROCESS: EVENT_TRACE_FLAG = 1;
pub const EVENT_TRACE_FLAG_PROCESS_COUNTERS: EVENT_TRACE_FLAG = 8;
pub const EVENT_TRACE_FLAG_PROFILE: EVENT_TRACE_FLAG = 16777216;
pub const EVENT_TRACE_FLAG_REGISTRY: EVENT_TRACE_FLAG = 131072;
pub const EVENT_TRACE_FLAG_SPLIT_IO: EVENT_TRACE_FLAG = 2097152;
pub const EVENT_TRACE_FLAG_SYSTEMCALL: EVENT_TRACE_FLAG = 128;
pub const EVENT_TRACE_FLAG_THREAD: EVENT_TRACE_FLAG = 2;
pub const EVENT_TRACE_FLAG_VAMAP: EVENT_TRACE_FLAG = 32768;
pub const EVENT_TRACE_FLAG_VIRTUAL_ALLOC: EVENT_TRACE_FLAG = 16384;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const SYSTEM_ALPC_KW_GENERAL: u64 = 1;
pub const SYSTEM_CONFIG_KW_GRAPHICS: u64 = 2;
pub const SYSTEM_CONFIG_KW_NETWORK: u64 = 8;
pub const SYSTEM_CONFIG_KW_OPTICAL: u64 = 64;
pub const SYSTEM_CONFIG_KW_PNP: u64 = 32;
pub const SYSTEM_CONFIG_KW_SERVICES: u64 = 16;
pub const SYSTEM_CONFIG_KW_STORAGE: u64 = 4;
pub const SYSTEM_CONFIG_KW_SYSTEM: u64 = 1;
pub const SYSTEM_CPU_KW_CACHE_FLUSH: u64 = 2;
pub const SYSTEM_CPU_KW_CONFIG: u64 = 1;
pub const SYSTEM_CPU_KW_DOMAIN_CHANGE: u64 = 8;
pub const SYSTEM_CPU_KW_SPEC_CONTROL: u64 = 4;
pub const SYSTEM_EVENT_TYPE: u32 = 1;
pub const SYSTEM_HYPERVISOR_KW_CALLOUTS: u64 = 2;
pub const SYSTEM_HYPERVISOR_KW_PROFILE: u64 = 1;
pub const SYSTEM_HYPERVISOR_KW_VTL_CHANGE: u64 = 4;
pub const SYSTEM_INTERRUPT_KW_CLOCK_INTERRUPT: u64 = 2;
pub const SYSTEM_INTERRUPT_KW_DPC: u64 = 4;
pub const SYSTEM_INTERRUPT_KW_DPC_QUEUE: u64 = 8;
pub const SYSTEM_INTERRUPT_KW_GENERAL: u64 = 1;
pub const SYSTEM_INTERRUPT_KW_IPI: u64 = 64;
pub const SYSTEM_INTERRUPT_KW_WDF_DPC: u64 = 16;
pub const SYSTEM_INTERRUPT_KW_WDF_INTERRUPT: u64 = 32;
pub const SYSTEM_IOFILTER_KW_FAILURE: u64 = 8;
pub const SYSTEM_IOFILTER_KW_FASTIO: u64 = 4;
pub const SYSTEM_IOFILTER_KW_GENERAL: u64 = 1;
pub const SYSTEM_IOFILTER_KW_INIT: u64 = 2;
pub const SYSTEM_IO_KW_CC: u64 = 256;
pub const SYSTEM_IO_KW_DISK: u64 = 1;
pub const SYSTEM_IO_KW_DISK_INIT: u64 = 2;
pub const SYSTEM_IO_KW_DRIVERS: u64 = 128;
pub const SYSTEM_IO_KW_FILE: u64 = 16;
pub const SYSTEM_IO_KW_FILENAME: u64 = 4;
pub const SYSTEM_IO_KW_FILE_INIT: u64 = 1024;
pub const SYSTEM_IO_KW_NETWORK: u64 = 512;
pub const SYSTEM_IO_KW_OPTICAL: u64 = 32;
pub const SYSTEM_IO_KW_OPTICAL_INIT: u64 = 64;
pub const SYSTEM_IO_KW_SPLIT: u64 = 8;
pub const SYSTEM_IO_KW_TIMER: u64 = 2048;
pub const SYSTEM_LOCK_KW_SPINLOCK: u64 = 1;
pub const SYSTEM_LOCK_KW_SPINLOCK_COUNTERS: u64 = 2;
pub const SYSTEM_LOCK_KW_SYNC_OBJECTS: u64 = 4;
pub const SYSTEM_MEMORY_KW_ALL_FAULTS: u64 = 4;
pub const SYSTEM_MEMORY_KW_CONTMEM_GEN: u64 = 512;
pub const SYSTEM_MEMORY_KW_FOOTPRINT: u64 = 2048;
pub const SYSTEM_MEMORY_KW_GENERAL: u64 = 1;
pub const SYSTEM_MEMORY_KW_HARD_FAULTS: u64 = 2;
pub const SYSTEM_MEMORY_KW_HEAP: u64 = 128;
pub const SYSTEM_MEMORY_KW_MEMINFO: u64 = 16;
pub const SYSTEM_MEMORY_KW_MEMINFO_WS: u64 = 64;
pub const SYSTEM_MEMORY_KW_NONTRADEABLE: u64 = 32768;
pub const SYSTEM_MEMORY_KW_PFSECTION: u64 = 32;
pub const SYSTEM_MEMORY_KW_POOL: u64 = 8;
pub const SYSTEM_MEMORY_KW_REFSET: u64 = 8192;
pub const SYSTEM_MEMORY_KW_SESSION: u64 = 4096;
pub const SYSTEM_MEMORY_KW_VAMAP: u64 = 16384;
pub const SYSTEM_MEMORY_KW_VIRTUAL_ALLOC: u64 = 1024;
pub const SYSTEM_MEMORY_KW_WS: u64 = 256;
pub const SYSTEM_MEMORY_POOL_FILTER_ID: u32 = 1;
pub const SYSTEM_OBJECT_KW_GENERAL: u64 = 1;
pub const SYSTEM_OBJECT_KW_HANDLE: u64 = 2;
pub const SYSTEM_POWER_KW_GENERAL: u64 = 1;
pub const SYSTEM_POWER_KW_HIBER_RUNDOWN: u64 = 2;
pub const SYSTEM_POWER_KW_IDLE_SELECTION: u64 = 8;
pub const SYSTEM_POWER_KW_PPM_EXIT_LATENCY: u64 = 16;
pub const SYSTEM_POWER_KW_PROCESSOR_IDLE: u64 = 4;
pub const SYSTEM_PROCESS_KW_DBGPRINT: u64 = 256;
pub const SYSTEM_PROCESS_KW_DEBUG_EVENTS: u64 = 128;
pub const SYSTEM_PROCESS_KW_FREEZE: u64 = 4;
pub const SYSTEM_PROCESS_KW_GENERAL: u64 = 1;
pub const SYSTEM_PROCESS_KW_INSWAP: u64 = 2;
pub const SYSTEM_PROCESS_KW_JOB: u64 = 512;
pub const SYSTEM_PROCESS_KW_LOADER: u64 = 4096;
pub const SYSTEM_PROCESS_KW_PERF_COUNTER: u64 = 8;
pub const SYSTEM_PROCESS_KW_THREAD: u64 = 2048;
pub const SYSTEM_PROCESS_KW_WAKE_COUNTER: u64 = 16;
pub const SYSTEM_PROCESS_KW_WAKE_DROP: u64 = 32;
pub const SYSTEM_PROCESS_KW_WAKE_EVENT: u64 = 64;
pub const SYSTEM_PROCESS_KW_WORKER_THREAD: u64 = 1024;
pub const SYSTEM_PROFILE_KW_GENERAL: u64 = 1;
pub const SYSTEM_PROFILE_KW_PMC_PROFILE: u64 = 2;
pub const SYSTEM_REGISTRY_KW_GENERAL: u64 = 1;
pub const SYSTEM_REGISTRY_KW_HIVE: u64 = 2;
pub const SYSTEM_REGISTRY_KW_NOTIFICATION: u64 = 4;
pub const SYSTEM_SCHEDULER_KW_AFFINITY: u64 = 64;
pub const SYSTEM_SCHEDULER_KW_ANTI_STARVATION: u64 = 16;
pub const SYSTEM_SCHEDULER_KW_AUTOBOOST: u64 = 65536;
pub const SYSTEM_SCHEDULER_KW_COMPACT_CSWITCH: u64 = 1024;
pub const SYSTEM_SCHEDULER_KW_CONTEXT_SWITCH: u64 = 512;
pub const SYSTEM_SCHEDULER_KW_CPU_PARTITION: u64 = 8192;
pub const SYSTEM_SCHEDULER_KW_DISPATCHER: u64 = 2;
pub const SYSTEM_SCHEDULER_KW_IDEAL_PROCESSOR: u64 = 256;
pub const SYSTEM_SCHEDULER_KW_KERNEL_QUEUE: u64 = 4;
pub const SYSTEM_SCHEDULER_KW_LOAD_BALANCER: u64 = 32;
pub const SYSTEM_SCHEDULER_KW_PRIORITY: u64 = 128;
pub const SYSTEM_SCHEDULER_KW_READY_QUEUE: u64 = 4096;
pub const SYSTEM_SCHEDULER_KW_SCHEDULE_THREAD: u64 = 2048;
pub const SYSTEM_SCHEDULER_KW_SHOULD_YIELD: u64 = 8;
pub const SYSTEM_SCHEDULER_KW_THREAD_FEEDBACK_READ: u64 = 16384;
pub const SYSTEM_SCHEDULER_KW_WORKLOAD_CLASS_UPDATE: u64 = 32768;
pub const SYSTEM_SCHEDULER_KW_XSCHEDULER: u64 = 1;
pub const SYSTEM_SYSCALL_KW_GENERAL: u64 = 1;
pub const SYSTEM_TIMER_KW_CLOCK_TIMER: u64 = 2;
pub const SYSTEM_TIMER_KW_GENERAL: u64 = 1;
...
pub const TRACE_MESSAGE_COMPONENTID: TRACE_MESSAGE_FLAGS = 4;
pub type TRACE_MESSAGE_FLAGS = u32;
pub const TRACE_MESSAGE_FLAG_MASK: u32 = 65535;
pub const TRACE_MESSAGE_GUID: TRACE_MESSAGE_FLAGS = 2;
...
pub const TRACE_MESSAGE_SEQUENCE: TRACE_MESSAGE_FLAGS = 1;
...
pub const _typedef_TRACELOGGER_HANDLE: u32 = 1;
