pub type CloseTrace = unsafe extern "system" fn(tracehandle: PROCESSTRACE_HANDLE) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type ControlTraceA = unsafe extern "system" fn(traceid: u64, instancename: windows_sys::core::PCSTR, properties: *mut EVENT_TRACE_PROPERTIES, controlcode: EVENT_TRACE_CONTROL) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type ControlTraceW = unsafe extern "system" fn(traceid: u64, instancename: windows_sys::core::PCWSTR, properties: *mut EVENT_TRACE_PROPERTIES, controlcode: EVENT_TRACE_CONTROL) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type CreateTraceInstanceId = unsafe extern "system" fn(reghandle: super::super::super::Foundation::HANDLE, instinfo: *mut EVENT_INSTANCE_INFO) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type CveEventWrite = unsafe extern "system" fn(cveid: windows_sys::core::PCWSTR, additionaldetails: windows_sys::core::PCWSTR) -> i32;
...
pub type EnableTrace = unsafe extern "system" fn(enable: u32, enableflag: u32, enablelevel: u32, controlguid: *const windows_sys::core::GUID, traceid: u64) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type EnableTraceEx = unsafe extern "system" fn(providerid: *const windows_sys::core::GUID, sourceid: *const windows_sys::core::GUID, traceid: u64, isenabled: u32, level: u8, matchanykeyword: u64, matchallkeyword: u64, enableproperty: u32, enablefilterdesc: *const EVENT_FILTER_DESCRIPTOR) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type EnableTraceEx2 = unsafe extern "system" fn(traceid: u64, providerid: *const windows_sys::core::GUID, controlcode: u32, level: u8, matchanykeyword: u64, matchallkeyword: u64, timeout: u32, enableparameters: *const ENABLE_TRACE_PARAMETERS) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type EnumerateTraceGuids = unsafe extern "system" fn(guidpropertiesarray: *mut *mut TRACE_GUID_PROPERTIES, propertyarraycount: u32, guidcount: *mut u32) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type EnumerateTraceGuidsEx = unsafe extern "system" fn(tracequeryinfoclass: TRACE_QUERY_INFO_CLASS, inbuffer: *const core::ffi::c_void, inbuffersize: u32, outbuffer: *mut core::ffi::c_void, outbuffersize: u32, returnlength: *mut u32) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type EventAccessControl = unsafe extern "system" fn(guid: *const windows_sys::core::GUID, operation: u32, sid: super::super::super::Security::PSID, rights: u32, allowordeny: bool) -> u32;
#[cfg(feature = "Win32_Security")]
...
#[cfg(feature = "Win32_Security")]
pub type EventAccessQuery = unsafe extern "system" fn(guid: *const windows_sys::core::GUID, buffer: super::super::super::Security::PSECURITY_DESCRIPTOR, buffersize: *mut u32) -> u32;
#[cfg(feature = "Win32_Security")]
...
pub type EventAccessRemove = unsafe extern "system" fn(guid: *const windows_sys::core::GUID) -> u32;
windows_link::link!("advapi32.dll" "system" fn EventAccessRemove(guid : *const windows_sys::core::GUID) -> u32);
pub type EventActivityIdControl = unsafe extern "system" fn(controlcode: u32, activityid: *mut windows_sys::core::GUID) -> u32;
windows_link::link!("advapi32.dll" "system" fn EventActivityIdControl(controlcode : u32, activityid : *mut windows_sys::core::GUID) -> u32);
pub type EventEnabled = unsafe extern "system" fn(reghandle: REGHANDLE, eventdescriptor: *const EVENT_DESCRIPTOR) -> bool;
windows_link::link!("advapi32.dll" "system" fn EventEnabled(reghandle : REGHANDLE, eventdescriptor : *const EVENT_DESCRIPTOR) -> bool);
pub type EventProviderEnabled = unsafe extern "system" fn(reghandle: REGHANDLE, level: u8, keyword: u64) -> bool;
windows_link::link!("advapi32.dll" "system" fn EventProviderEnabled(reghandle : REGHANDLE, level : u8, keyword : u64) -> bool);
pub type EventRegister = unsafe extern "system" fn(providerid: *const windows_sys::core::GUID, enablecallback: PENABLECALLBACK, callbackcontext: *const core::ffi::c_void, reghandle: *mut REGHANDLE) -> u32;
...
pub type EventSetInformation = unsafe extern "system" fn(reghandle: REGHANDLE, informationclass: EVENT_INFO_CLASS, eventinformation: *const core::ffi::c_void, informationlength: u32) -> u32;
...
pub type EventUnregister = unsafe extern "system" fn(reghandle: REGHANDLE) -> u32;
windows_link::link!("advapi32.dll" "system" fn EventUnregister(reghandle : REGHANDLE) -> u32);
pub type EventWrite = unsafe extern "system" fn(reghandle: REGHANDLE, eventdescriptor: *const EVENT_DESCRIPTOR, userdatacount: u32, userdata: *const EVENT_DATA_DESCRIPTOR) -> u32;
...
pub type EventWriteEx = unsafe extern "system" fn(reghandle: REGHANDLE, eventdescriptor: *const EVENT_DESCRIPTOR, filter: u64, flags: u32, activityid: *const windows_sys::core::GUID, relatedactivityid: *const windows_sys::core::GUID, userdatacount: u32, userdata: *const EVENT_DATA_DESCRIPTOR) -> u32;
...
pub type EventWriteString = unsafe extern "system" fn(reghandle: REGHANDLE, level: u8, keyword: u64, string: windows_sys::core::PCWSTR) -> u32;
...
pub type EventWriteTransfer = unsafe extern "system" fn(reghandle: REGHANDLE, eventdescriptor: *const EVENT_DESCRIPTOR, activityid: *const windows_sys::core::GUID, relatedactivityid: *const windows_sys::core::GUID, userdatacount: u32, userdata: *const EVENT_DATA_DESCRIPTOR) -> u32;
...
pub type FlushTraceA = unsafe extern "system" fn(traceid: u64, instancename: windows_sys::core::PCSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type FlushTraceW = unsafe extern "system" fn(traceid: u64, instancename: windows_sys::core::PCWSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type GetTraceEnableFlags = unsafe extern "system" fn(tracehandle: u64) -> u32;
windows_link::link!("advapi32.dll" "system" fn GetTraceEnableFlags(tracehandle : u64) -> u32);
pub type GetTraceEnableLevel = unsafe extern "system" fn(tracehandle: u64) -> u8;
windows_link::link!("advapi32.dll" "system" fn GetTraceEnableLevel(tracehandle : u64) -> u8);
pub type GetTraceLoggerHandle = unsafe extern "system" fn(buffer: *const core::ffi::c_void) -> u64;
...
pub type OpenTraceA = unsafe extern "system" fn(logfile: *mut EVENT_TRACE_LOGFILEA) -> PROCESSTRACE_HANDLE;
#[cfg(feature = "Win32_System_Time")]
windows_link::link!("advapi32.dll" "system" fn OpenTraceA(logfile : *mut EVENT_TRACE_LOGFILEA) -> PROCESSTRACE_HANDLE);
#[cfg(feature = "Win32_System_Time")]
pub type OpenTraceFromBufferStream = unsafe extern "system" fn(options: *const ETW_OPEN_TRACE_OPTIONS, buffercompletioncallback: PETW_BUFFER_COMPLETION_CALLBACK, buffercompletioncontext: *const core::ffi::c_void) -> PROCESSTRACE_HANDLE;
#[cfg(feature = "Win32_System_Time")]
...
#[cfg(feature = "Win32_System_Time")]
pub type OpenTraceFromFile = unsafe extern "system" fn(logfilename: windows_sys::core::PCWSTR, options: *const ETW_OPEN_TRACE_OPTIONS, logfileheader: *mut TRACE_LOGFILE_HEADER) -> PROCESSTRACE_HANDLE;
#[cfg(feature = "Win32_System_Time")]
...
#[cfg(feature = "Win32_System_Time")]
pub type OpenTraceFromRealTimeLogger = unsafe extern "system" fn(loggername: windows_sys::core::PCWSTR, options: *const ETW_OPEN_TRACE_OPTIONS, logfileheader: *mut TRACE_LOGFILE_HEADER) -> PROCESSTRACE_HANDLE;
#[cfg(feature = "Win32_System_Time")]
...
#[cfg(feature = "Win32_System_Time")]
pub type OpenTraceFromRealTimeLoggerWithAllocationOptions = unsafe extern "system" fn(loggername: windows_sys::core::PCWSTR, options: *const ETW_OPEN_TRACE_OPTIONS, allocationsize: usize, memorypartitionhandle: super::super::super::Foundation::HANDLE, logfileheader: *mut TRACE_LOGFILE_HEADER) -> PROCESSTRACE_HANDLE;
#[cfg(feature = "Win32_System_Time")]
...
#[cfg(feature = "Win32_System_Time")]
pub type OpenTraceW = unsafe extern "system" fn(logfile: *mut EVENT_TRACE_LOGFILEW) -> PROCESSTRACE_HANDLE;
#[cfg(feature = "Win32_System_Time")]
windows_link::link!("advapi32.dll" "system" fn OpenTraceW(logfile : *mut EVENT_TRACE_LOGFILEW) -> PROCESSTRACE_HANDLE);
pub type ProcessTrace = unsafe extern "system" fn(handlearray: *const PROCESSTRACE_HANDLE, handlecount: u32, starttime: *const super::super::super::Foundation::FILETIME, endtime: *const super::super::super::Foundation::FILETIME) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type ProcessTraceAddBufferToBufferStream = unsafe extern "system" fn(tracehandle: PROCESSTRACE_HANDLE, buffer: *const ETW_BUFFER_HEADER, buffersize: u32) -> u32;
...
pub type ProcessTraceBufferDecrementReference = unsafe extern "system" fn(buffer: *const ETW_BUFFER_HEADER) -> u32;
windows_link::link!("advapi32.dll" "system" fn ProcessTraceBufferDecrementReference(buffer : *const ETW_BUFFER_HEADER) -> u32);
pub type ProcessTraceBufferIncrementReference = unsafe extern "system" fn(tracehandle: PROCESSTRACE_HANDLE, buffer: *const ETW_BUFFER_HEADER) -> u32;
...
pub type QueryAllTracesA = unsafe extern "system" fn(propertyarray: *mut *mut EVENT_TRACE_PROPERTIES, propertyarraycount: u32, loggercount: *mut u32) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type QueryAllTracesW = unsafe extern "system" fn(propertyarray: *mut *mut EVENT_TRACE_PROPERTIES, propertyarraycount: u32, loggercount: *mut u32) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type QueryTraceA = unsafe extern "system" fn(traceid: u64, instancename: windows_sys::core::PCSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type QueryTraceProcessingHandle = unsafe extern "system" fn(processinghandle: PROCESSTRACE_HANDLE, informationclass: ETW_PROCESS_HANDLE_INFO_TYPE, inbuffer: *const core::ffi::c_void, inbuffersize: u32, outbuffer: *mut core::ffi::c_void, outbuffersize: u32, returnlength: *mut u32) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type QueryTraceW = unsafe extern "system" fn(traceid: u64, instancename: windows_sys::core::PCWSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type RegisterTraceGuidsA = unsafe extern "system" fn(requestaddress: WMIDPREQUEST, requestcontext: *const core::ffi::c_void, controlguid: *const windows_sys::core::GUID, guidcount: u32, traceguidreg: *const TRACE_GUID_REGISTRATION, mofimagepath: windows_sys::core::PCSTR, mofresourcename: windows_sys::core::PCSTR, registrationhandle: *mut u64) -> u32;
...
pub type RegisterTraceGuidsW = unsafe extern "system" fn(requestaddress: WMIDPREQUEST, requestcontext: *const core::ffi::c_void, controlguid: *const windows_sys::core::GUID, guidcount: u32, traceguidreg: *const TRACE_GUID_REGISTRATION, mofimagepath: windows_sys::core::PCWSTR, mofresourcename: windows_sys::core::PCWSTR, registrationhandle: *mut u64) -> u32;
...
pub type RemoveTraceCallback = unsafe extern "system" fn(pguid: *const windows_sys::core::GUID) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type SetTraceCallback = unsafe extern "system" fn(pguid: *const windows_sys::core::GUID, eventcallback: PEVENT_CALLBACK) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type StartTraceA = unsafe extern "system" fn(traceid: *mut u64, instancename: windows_sys::core::PCSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type StartTraceW = unsafe extern "system" fn(traceid: *mut u64, instancename: windows_sys::core::PCWSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type StopTraceA = unsafe extern "system" fn(traceid: u64, instancename: windows_sys::core::PCSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type StopTraceW = unsafe extern "system" fn(traceid: u64, instancename: windows_sys::core::PCWSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type TdhAggregatePayloadFilters = unsafe extern "system" fn(payloadfiltercount: u32, payloadfilterptrs: *const *const core::ffi::c_void, eventmatchallflags: *const bool, eventfilterdescriptor: *mut EVENT_FILTER_DESCRIPTOR) -> u32;
...
pub type TdhCleanupPayloadEventFilterDescriptor = unsafe extern "system" fn(eventfilterdescriptor: *mut EVENT_FILTER_DESCRIPTOR) -> u32;
...
pub type TdhCloseDecodingHandle = unsafe extern "system" fn(handle: TDH_HANDLE) -> u32;
windows_link::link!("tdh.dll" "system" fn TdhCloseDecodingHandle(handle : TDH_HANDLE) -> u32);
pub type TdhCreatePayloadFilter = unsafe extern "system" fn(providerguid: *const windows_sys::core::GUID, eventdescriptor: *const EVENT_DESCRIPTOR, eventmatchany: bool, payloadpredicatecount: u32, payloadpredicates: *const PAYLOAD_FILTER_PREDICATE, payloadfilter: *mut *mut core::ffi::c_void) -> u32;
...
pub type TdhDeletePayloadFilter = unsafe extern "system" fn(payloadfilter: *mut *mut core::ffi::c_void) -> u32;
windows_link::link!("tdh.dll" "system" fn TdhDeletePayloadFilter(payloadfilter : *mut *mut core::ffi::c_void) -> u32);
pub type TdhEnumerateManifestProviderEvents = unsafe extern "system" fn(providerguid: *const windows_sys::core::GUID, buffer: *mut PROVIDER_EVENT_INFO, buffersize: *mut u32) -> u32;
...
pub type TdhEnumerateProviderFieldInformation = unsafe extern "system" fn(pguid: *const windows_sys::core::GUID, eventfieldtype: EVENT_FIELD_TYPE, pbuffer: *mut PROVIDER_FIELD_INFOARRAY, pbuffersize: *mut u32) -> u32;
...
pub type TdhEnumerateProviderFilters = unsafe extern "system" fn(guid: *const windows_sys::core::GUID, tdhcontextcount: u32, tdhcontext: *const TDH_CONTEXT, filtercount: *mut u32, buffer: *mut *mut PROVIDER_FILTER_INFO, buffersize: *mut u32) -> u32;
...
pub type TdhEnumerateProviders = unsafe extern "system" fn(pbuffer: *mut PROVIDER_ENUMERATION_INFO, pbuffersize: *mut u32) -> u32;
windows_link::link!("tdh.dll" "system" fn TdhEnumerateProviders(pbuffer : *mut PROVIDER_ENUMERATION_INFO, pbuffersize : *mut u32) -> u32);
pub type TdhEnumerateProvidersForDecodingSource = unsafe extern "system" fn(filter: DECODING_SOURCE, buffer: *mut PROVIDER_ENUMERATION_INFO, buffersize: u32, bufferrequired: *mut u32) -> u32;
...
pub type TdhFormatProperty = unsafe extern "system" fn(eventinfo: *const TRACE_EVENT_INFO, mapinfo: *const EVENT_MAP_INFO, pointersize: u32, propertyintype: u16, propertyouttype: u16, propertylength: u16, userdatalength: u16, userdata: *const u8, buffersize: *mut u32, buffer: windows_sys::core::PWSTR, userdataconsumed: *mut u16) -> u32;
...
pub type TdhGetDecodingParameter = unsafe extern "system" fn(handle: TDH_HANDLE, tdhcontext: *mut TDH_CONTEXT) -> u32;
windows_link::link!("tdh.dll" "system" fn TdhGetDecodingParameter(handle : TDH_HANDLE, tdhcontext : *mut TDH_CONTEXT) -> u32);
pub type TdhGetEventInformation = unsafe extern "system" fn(event: *const EVENT_RECORD, tdhcontextcount: u32, tdhcontext: *const TDH_CONTEXT, buffer: *mut TRACE_EVENT_INFO, buffersize: *mut u32) -> u32;
...
pub type TdhGetEventMapInformation = unsafe extern "system" fn(pevent: *const EVENT_RECORD, pmapname: windows_sys::core::PCWSTR, pbuffer: *mut EVENT_MAP_INFO, pbuffersize: *mut u32) -> u32;
...
pub type TdhGetManifestEventInformation = unsafe extern "system" fn(providerguid: *const windows_sys::core::GUID, eventdescriptor: *const EVENT_DESCRIPTOR, buffer: *mut TRACE_EVENT_INFO, buffersize: *mut u32) -> u32;
...
pub type TdhGetProperty = unsafe extern "system" fn(pevent: *const EVENT_RECORD, tdhcontextcount: u32, ptdhcontext: *const TDH_CONTEXT, propertydatacount: u32, ppropertydata: *const PROPERTY_DATA_DESCRIPTOR, buffersize: u32, pbuffer: *mut u8) -> u32;
...
pub type TdhGetPropertySize = unsafe extern "system" fn(pevent: *const EVENT_RECORD, tdhcontextcount: u32, ptdhcontext: *const TDH_CONTEXT, propertydatacount: u32, ppropertydata: *const PROPERTY_DATA_DESCRIPTOR, ppropertysize: *mut u32) -> u32;
...
pub type TdhGetWppMessage = unsafe extern "system" fn(handle: TDH_HANDLE, eventrecord: *const EVENT_RECORD, buffersize: *mut u32, buffer: *mut u8) -> u32;
...
pub type TdhGetWppProperty = unsafe extern "system" fn(handle: TDH_HANDLE, eventrecord: *const EVENT_RECORD, propertyname: windows_sys::core::PCWSTR, buffersize: *mut u32, buffer: *mut u8) -> u32;
...
pub type TdhLoadManifest = unsafe extern "system" fn(manifest: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("tdh.dll" "system" fn TdhLoadManifest(manifest : windows_sys::core::PCWSTR) -> u32);
pub type TdhLoadManifestFromBinary = unsafe extern "system" fn(binarypath: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("tdh.dll" "system" fn TdhLoadManifestFromBinary(binarypath : windows_sys::core::PCWSTR) -> u32);
pub type TdhLoadManifestFromMemory = unsafe extern "system" fn(pdata: *const core::ffi::c_void, cbdata: u32) -> u32;
windows_link::link!("tdh.dll" "system" fn TdhLoadManifestFromMemory(pdata : *const core::ffi::c_void, cbdata : u32) -> u32);
pub type TdhOpenDecodingHandle = unsafe extern "system" fn(handle: *mut TDH_HANDLE) -> u32;
windows_link::link!("tdh.dll" "system" fn TdhOpenDecodingHandle(handle : *mut TDH_HANDLE) -> u32);
pub type TdhQueryProviderFieldInformation = unsafe extern "system" fn(pguid: *const windows_sys::core::GUID, eventfieldvalue: u64, eventfieldtype: EVENT_FIELD_TYPE, pbuffer: *mut PROVIDER_FIELD_INFOARRAY, pbuffersize: *mut u32) -> u32;
...
pub type TdhSetDecodingParameter = unsafe extern "system" fn(handle: TDH_HANDLE, tdhcontext: *const TDH_CONTEXT) -> u32;
windows_link::link!("tdh.dll" "system" fn TdhSetDecodingParameter(handle : TDH_HANDLE, tdhcontext : *const TDH_CONTEXT) -> u32);
pub type TdhUnloadManifest = unsafe extern "system" fn(manifest: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("tdh.dll" "system" fn TdhUnloadManifest(manifest : windows_sys::core::PCWSTR) -> u32);
pub type TdhUnloadManifestFromMemory = unsafe extern "system" fn(pdata: *const core::ffi::c_void, cbdata: u32) -> u32;
windows_link::link!("tdh.dll" "system" fn TdhUnloadManifestFromMemory(pdata : *const core::ffi::c_void, cbdata : u32) -> u32);
pub type TraceConfigureLastBranchRecord = unsafe extern "system" fn(traceid: u64, lbrconfiguration: TRACE_LBR_CONFIGURATION, events: *const CLASSIC_EVENT_ID, eventcount: u32) -> u32;
...
pub type TraceEvent = unsafe extern "system" fn(tracehandle: u64, eventtrace: *const EVENT_TRACE_HEADER) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type TraceEventInstance = unsafe extern "system" fn(tracehandle: u64, eventtrace: *const EVENT_INSTANCE_HEADER, instinfo: *const EVENT_INSTANCE_INFO, parentinstinfo: *const EVENT_INSTANCE_INFO) -> u32;
...
pub type TraceMessage = unsafe extern "C" fn(loggerhandle: u64, messageflags: TRACE_MESSAGE_FLAGS, messageguid: *const windows_sys::core::GUID, messagenumber: u16, ...) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type TraceMessageVa = unsafe extern "system" fn(loggerhandle: u64, messageflags: TRACE_MESSAGE_FLAGS, messageguid: *const windows_sys::core::GUID, messagenumber: u16, messagearglist: *const i8) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type TraceQueryInformation = unsafe extern "system" fn(traceid: u64, informationclass: TRACE_QUERY_INFO_CLASS, traceinformation: *mut core::ffi::c_void, informationlength: u32, returnlength: *mut u32) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type TraceSetInformation = unsafe extern "system" fn(traceid: u64, informationclass: TRACE_QUERY_INFO_CLASS, traceinformation: *const core::ffi::c_void, informationlength: u32) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type UnregisterTraceGuids = unsafe extern "system" fn(registrationhandle: u64) -> u32;
windows_link::link!("advapi32.dll" "system" fn UnregisterTraceGuids(registrationhandle : u64) -> u32);
pub type UpdateTraceA = unsafe extern "system" fn(traceid: u64, instancename: windows_sys::core::PCSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> super::super::super::Foundation::WIN32_ERROR;
...
pub type UpdateTraceW = unsafe extern "system" fn(traceid: u64, instancename: windows_sys::core::PCWSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> super::super::super::Foundation::WIN32_ERROR;
