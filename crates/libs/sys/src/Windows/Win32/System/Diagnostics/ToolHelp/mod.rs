pub type CreateToolhelp32Snapshot = unsafe extern "system" fn(dwflags: CREATE_TOOLHELP_SNAPSHOT_FLAGS, th32processid: u32) -> super::super::super::Foundation::HANDLE;
...
pub type Heap32First = unsafe extern "system" fn(lphe: *mut HEAPENTRY32, th32processid: u32, th32heapid: usize) -> windows_sys::core::BOOL;
...
pub type Heap32ListFirst = unsafe extern "system" fn(hsnapshot: super::super::super::Foundation::HANDLE, lphl: *mut HEAPLIST32) -> windows_sys::core::BOOL;
...
pub type Heap32ListNext = unsafe extern "system" fn(hsnapshot: super::super::super::Foundation::HANDLE, lphl: *mut HEAPLIST32) -> windows_sys::core::BOOL;
...
pub type Heap32Next = unsafe extern "system" fn(lphe: *mut HEAPENTRY32) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn Heap32Next(lphe : *mut HEAPENTRY32) -> windows_sys::core::BOOL);
pub type Module32First = unsafe extern "system" fn(hsnapshot: super::super::super::Foundation::HANDLE, lpme: *mut MODULEENTRY32) -> windows_sys::core::BOOL;
...
pub type Module32FirstW = unsafe extern "system" fn(hsnapshot: super::super::super::Foundation::HANDLE, lpme: *mut MODULEENTRY32W) -> windows_sys::core::BOOL;
...
pub type Module32Next = unsafe extern "system" fn(hsnapshot: super::super::super::Foundation::HANDLE, lpme: *mut MODULEENTRY32) -> windows_sys::core::BOOL;
...
pub type Module32NextW = unsafe extern "system" fn(hsnapshot: super::super::super::Foundation::HANDLE, lpme: *mut MODULEENTRY32W) -> windows_sys::core::BOOL;
...
pub type Process32First = unsafe extern "system" fn(hsnapshot: super::super::super::Foundation::HANDLE, lppe: *mut PROCESSENTRY32) -> windows_sys::core::BOOL;
...
pub type Process32FirstW = unsafe extern "system" fn(hsnapshot: super::super::super::Foundation::HANDLE, lppe: *mut PROCESSENTRY32W) -> windows_sys::core::BOOL;
...
pub type Process32Next = unsafe extern "system" fn(hsnapshot: super::super::super::Foundation::HANDLE, lppe: *mut PROCESSENTRY32) -> windows_sys::core::BOOL;
...
pub type Process32NextW = unsafe extern "system" fn(hsnapshot: super::super::super::Foundation::HANDLE, lppe: *mut PROCESSENTRY32W) -> windows_sys::core::BOOL;
...
pub type Thread32First = unsafe extern "system" fn(hsnapshot: super::super::super::Foundation::HANDLE, lpte: *mut THREADENTRY32) -> windows_sys::core::BOOL;
...
pub type Thread32Next = unsafe extern "system" fn(hsnapshot: super::super::super::Foundation::HANDLE, lpte: *mut THREADENTRY32) -> windows_sys::core::BOOL;
...
pub type Toolhelp32ReadProcessMemory = unsafe extern "system" fn(th32processid: u32, lpbaseaddress: *const core::ffi::c_void, lpbuffer: *mut core::ffi::c_void, cbread: usize, lpnumberofbytesread: *mut usize) -> windows_sys::core::BOOL;
