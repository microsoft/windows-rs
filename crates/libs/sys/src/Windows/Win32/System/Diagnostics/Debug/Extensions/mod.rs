::windows_sys::core::link ! ( "dbgmodel.dll""system" #[doc = "*Required features: `\"Win32_System_Diagnostics_Debug_Extensions\"`*"] fn CreateDataModelManager ( debughost : IDebugHost , manager : *mut IDataModelManager ) -> ::windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "dbgeng.dll""system" #[doc = "*Required features: `\"Win32_System_Diagnostics_Debug_Extensions\"`*"] fn DebugConnect ( remoteoptions : ::windows_sys::core::PCSTR , interfaceid : *const ::windows_sys::core::GUID , interface : *mut *mut ::core::ffi::c_void ) -> ::windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "dbgeng.dll""system" #[doc = "*Required features: `\"Win32_System_Diagnostics_Debug_Extensions\"`*"] fn DebugConnectWide ( remoteoptions : ::windows_sys::core::PCWSTR , interfaceid : *const ::windows_sys::core::GUID , interface : *mut *mut ::core::ffi::c_void ) -> ::windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "dbgeng.dll""system" #[doc = "*Required features: `\"Win32_System_Diagnostics_Debug_Extensions\"`*"] fn DebugCreate ( interfaceid : *const ::windows_sys::core::GUID , interface : *mut *mut ::core::ffi::c_void ) -> ::windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "dbgeng.dll""system" #[doc = "*Required features: `\"Win32_System_Diagnostics_Debug_Extensions\"`*"] fn DebugCreateEx ( interfaceid : *const ::windows_sys::core::GUID , dbgengoptions : u32 , interface : *mut *mut ::core::ffi::c_void ) -> ::windows_sys::core::HRESULT );
