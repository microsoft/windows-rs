...
windows_link::link!("imagehlp.dll" "system" fn BindImage(imagename : windows_sys::core::PCSTR, dllpath : windows_sys::core::PCSTR, symbolpath : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
windows_link::link!("imagehlp.dll" "system" fn BindImageEx(flags : u32, imagename : windows_sys::core::PCSTR, dllpath : windows_sys::core::PCSTR, symbolpath : windows_sys::core::PCSTR, statusroutine : PIMAGEHLP_STATUS_ROUTINE) -> windows_sys::core::BOOL);
windows_link::link!("kernel32.dll" "system" fn CheckRemoteDebuggerPresent(hprocess : super::super::super::Foundation::HANDLE, pbdebuggerpresent : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
...
windows_link::link!("kernel32.dll" "system" fn ContinueDebugEvent(dwprocessid : u32, dwthreadid : u32, dwcontinuestatus : super::super::super::Foundation::NTSTATUS) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_System_Kernel")]
windows_link::link!("kernel32.dll" "system" fn CopyContext(destination : *mut CONTEXT, contextflags : CONTEXT_FLAGS, source : *const CONTEXT) -> windows_sys::core::BOOL);
...
windows_link::link!("kernel32.dll" "system" fn DebugBreakProcess(process : super::super::super::Foundation::HANDLE) -> windows_sys::core::BOOL);
...
windows_link::link!("api-ms-win-core-util-l1-1-1.dll" "system" fn DecodeRemotePointer(processhandle : super::super::super::Foundation::HANDLE, ptr : *const core::ffi::c_void, decodedptr : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("api-ms-win-core-util-l1-1-1.dll" "system" fn EncodeRemotePointer(processhandle : super::super::super::Foundation::HANDLE, ptr : *const core::ffi::c_void, encodedptr : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("kernel32.dll" "system" fn EncodeSystemPointer(ptr : *const core::ffi::c_void) -> *mut core::ffi::c_void);
windows_link::link!("dbghelp.dll" "system" fn EnumDirTree(hprocess : super::super::super::Foundation::HANDLE, rootpath : windows_sys::core::PCSTR, inputpathname : windows_sys::core::PCSTR, outputpathbuffer : windows_sys::core::PSTR, cb : PENUMDIRTREE_CALLBACK, data : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn EnumDirTreeW(hprocess : super::super::super::Foundation::HANDLE, rootpath : windows_sys::core::PCWSTR, inputpathname : windows_sys::core::PCWSTR, outputpathbuffer : windows_sys::core::PWSTR, cb : PENUMDIRTREE_CALLBACKW, data : *const core::ffi::c_void) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
windows_link::link!("dbghelp.dll" "system" fn EnumerateLoadedModules(hprocess : super::super::super::Foundation::HANDLE, enumloadedmodulescallback : PENUMLOADED_MODULES_CALLBACK, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn EnumerateLoadedModules64(hprocess : super::super::super::Foundation::HANDLE, enumloadedmodulescallback : PENUMLOADED_MODULES_CALLBACK64, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn EnumerateLoadedModulesEx(hprocess : super::super::super::Foundation::HANDLE, enumloadedmodulescallback : PENUMLOADED_MODULES_CALLBACK64, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn EnumerateLoadedModulesExW(hprocess : super::super::super::Foundation::HANDLE, enumloadedmodulescallback : PENUMLOADED_MODULES_CALLBACKW64, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn EnumerateLoadedModulesW64(hprocess : super::super::super::Foundation::HANDLE, enumloadedmodulescallback : PENUMLOADED_MODULES_CALLBACKW64, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("dbghelp.dll" "system" fn FindDebugInfoFile(filename : windows_sys::core::PCSTR, symbolpath : windows_sys::core::PCSTR, debugfilepath : windows_sys::core::PSTR) -> super::super::super::Foundation::HANDLE);
windows_link::link!("dbghelp.dll" "system" fn FindDebugInfoFileEx(filename : windows_sys::core::PCSTR, symbolpath : windows_sys::core::PCSTR, debugfilepath : windows_sys::core::PSTR, callback : PFIND_DEBUG_FILE_CALLBACK, callerdata : *const core::ffi::c_void) -> super::super::super::Foundation::HANDLE);
windows_link::link!("dbghelp.dll" "system" fn FindDebugInfoFileExW(filename : windows_sys::core::PCWSTR, symbolpath : windows_sys::core::PCWSTR, debugfilepath : windows_sys::core::PWSTR, callback : PFIND_DEBUG_FILE_CALLBACKW, callerdata : *const core::ffi::c_void) -> super::super::super::Foundation::HANDLE);
windows_link::link!("dbghelp.dll" "system" fn FindExecutableImage(filename : windows_sys::core::PCSTR, symbolpath : windows_sys::core::PCSTR, imagefilepath : windows_sys::core::PSTR) -> super::super::super::Foundation::HANDLE);
windows_link::link!("dbghelp.dll" "system" fn FindExecutableImageEx(filename : windows_sys::core::PCSTR, symbolpath : windows_sys::core::PCSTR, imagefilepath : windows_sys::core::PSTR, callback : PFIND_EXE_FILE_CALLBACK, callerdata : *const core::ffi::c_void) -> super::super::super::Foundation::HANDLE);
windows_link::link!("dbghelp.dll" "system" fn FindExecutableImageExW(filename : windows_sys::core::PCWSTR, symbolpath : windows_sys::core::PCWSTR, imagefilepath : windows_sys::core::PWSTR, callback : PFIND_EXE_FILE_CALLBACKW, callerdata : *const core::ffi::c_void) -> super::super::super::Foundation::HANDLE);
windows_link::link!("dbghelp.dll" "system" fn FindFileInPath(hprocess : super::super::super::Foundation::HANDLE, searchpatha : windows_sys::core::PCSTR, filename : windows_sys::core::PCSTR, id : *const core::ffi::c_void, two : u32, three : u32, flags : u32, filepath : windows_sys::core::PSTR) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn FindFileInSearchPath(hprocess : super::super::super::Foundation::HANDLE, searchpatha : windows_sys::core::PCSTR, filename : windows_sys::core::PCSTR, one : u32, two : u32, three : u32, filepath : windows_sys::core::PSTR) -> windows_sys::core::BOOL);
...
windows_link::link!("imagehlp.dll" "system" fn GetImageConfigInformation(loadedimage : *const LOADED_IMAGE, imageconfiginformation : *mut IMAGE_LOAD_CONFIG_DIRECTORY32) -> windows_sys::core::BOOL);
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
#[cfg(all(feature = "Win32_System_Kernel", feature = "Win32_System_SystemInformation"))]
windows_link::link!("imagehlp.dll" "system" fn GetImageConfigInformation(loadedimage : *const LOADED_IMAGE, imageconfiginformation : *mut IMAGE_LOAD_CONFIG_DIRECTORY64) -> windows_sys::core::BOOL);
#[cfg(all(feature = "Win32_System_Kernel", feature = "Win32_System_SystemInformation"))]
...
#[cfg(feature = "Win32_System_Kernel")]
windows_link::link!("kernel32.dll" "system" fn GetThreadContext(hthread : super::super::super::Foundation::HANDLE, lpcontext : *mut CONTEXT) -> windows_sys::core::BOOL);
...
windows_link::link!("imagehlp.dll" "system" fn ImageAddCertificate(filehandle : super::super::super::Foundation::HANDLE, certificate : *const super::super::super::Security::WinTrust::WIN_CERTIFICATE, index : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("imagehlp.dll" "system" fn ImageEnumerateCertificates(filehandle : super::super::super::Foundation::HANDLE, typefilter : u16, certificatecount : *mut u32, indices : *mut u32, indexcount : u32) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Security_WinTrust")]
windows_link::link!("imagehlp.dll" "system" fn ImageGetCertificateData(filehandle : super::super::super::Foundation::HANDLE, certificateindex : u32, certificate : *mut super::super::super::Security::WinTrust::WIN_CERTIFICATE, requiredlength : *mut u32) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Security_WinTrust")]
windows_link::link!("imagehlp.dll" "system" fn ImageGetCertificateHeader(filehandle : super::super::super::Foundation::HANDLE, certificateindex : u32, certificateheader : *mut super::super::super::Security::WinTrust::WIN_CERTIFICATE) -> windows_sys::core::BOOL);
windows_link::link!("imagehlp.dll" "system" fn ImageGetDigestStream(filehandle : super::super::super::Foundation::HANDLE, digestlevel : u32, digestfunction : DIGEST_FUNCTION, digesthandle : *const core::ffi::c_void) -> windows_sys::core::BOOL);
#[cfg(all(feature = "Win32_System_Kernel", feature = "Win32_System_SystemInformation"))]
windows_link::link!("imagehlp.dll" "system" fn ImageLoad(dllname : windows_sys::core::PCSTR, dllpath : windows_sys::core::PCSTR) -> *mut LOADED_IMAGE);
#[cfg(target_arch = "x86")]
#[cfg(feature = "Win32_System_SystemInformation")]
...
windows_link::link!("imagehlp.dll" "system" fn ImageRemoveCertificate(filehandle : super::super::super::Foundation::HANDLE, index : u32) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
#[cfg(feature = "Win32_System_SystemInformation")]
...
#[cfg(all(feature = "Win32_System_Kernel", feature = "Win32_System_SystemInformation"))]
windows_link::link!("imagehlp.dll" "system" fn ImageUnload(loadedimage : *mut LOADED_IMAGE) -> windows_sys::core::BOOL);
...
#[cfg(feature = "Win32_System_Kernel")]
windows_link::link!("kernel32.dll" "system" fn InitializeContext(buffer : *mut core::ffi::c_void, contextflags : CONTEXT_FLAGS, context : *mut *mut CONTEXT, contextlength : *mut u32) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_System_Kernel")]
...
#[cfg(all(feature = "Win32_System_Kernel", feature = "Win32_System_SystemInformation"))]
windows_link::link!("imagehlp.dll" "system" fn MapAndLoad(imagename : windows_sys::core::PCSTR, dllpath : windows_sys::core::PCSTR, loadedimage : *mut LOADED_IMAGE, dotdll : windows_sys::core::BOOL, readonly : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
windows_link::link!("imagehlp.dll" "system" fn MapFileAndCheckSumA(filename : windows_sys::core::PCSTR, headersum : *mut u32, checksum : *mut u32) -> u32);
windows_link::link!("imagehlp.dll" "system" fn MapFileAndCheckSumW(filename : windows_sys::core::PCWSTR, headersum : *mut u32, checksum : *mut u32) -> u32);
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
windows_link::link!("user32.dll" "system" fn MessageBeep(utype : super::super::super::UI::WindowsAndMessaging::MESSAGEBOX_STYLE) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn MiniDumpReadDumpStream(baseofdump : *const core::ffi::c_void, streamnumber : u32, dir : *mut *mut MINIDUMP_DIRECTORY, streampointer : *mut *mut core::ffi::c_void, streamsize : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("dbghelp.dll" "system" fn ReportSymbolLoadSummary(hprocess : super::super::super::Foundation::HANDLE, ploadmodule : windows_sys::core::PCWSTR, psymboldata : *const DBGHELP_DATA_REPORT_STRUCT) -> windows_sys::core::BOOL);
...
#[cfg(any(target_arch = "arm64ec", target_arch = "x86_64"))]
windows_link::link!("kernel32.dll" "system" fn RtlInstallFunctionTableCallback(tableidentifier : u64, baseaddress : u64, length : u32, callback : PGET_RUNTIME_FUNCTION_CALLBACK, context : *const core::ffi::c_void, outofprocesscallbackdll : windows_sys::core::PCWSTR) -> bool);
#[cfg(target_arch = "aarch64")]
windows_link::link!("kernel32.dll" "system" fn RtlInstallFunctionTableCallback(tableidentifier : u64, baseaddress : u64, length : u32, callback : PGET_RUNTIME_FUNCTION_CALLBACK, context : *const core::ffi::c_void, outofprocesscallbackdll : windows_sys::core::PCWSTR) -> bool);
#[cfg(any(target_arch = "arm64ec", target_arch = "x86_64"))]
...
#[cfg(target_arch = "x86")]
#[cfg(all(feature = "Win32_System_Kernel", feature = "Win32_System_SystemInformation"))]
windows_link::link!("imagehlp.dll" "system" fn SetImageConfigInformation(loadedimage : *mut LOADED_IMAGE, imageconfiginformation : *const IMAGE_LOAD_CONFIG_DIRECTORY32) -> windows_sys::core::BOOL);
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
#[cfg(all(feature = "Win32_System_Kernel", feature = "Win32_System_SystemInformation"))]
windows_link::link!("imagehlp.dll" "system" fn SetImageConfigInformation(loadedimage : *mut LOADED_IMAGE, imageconfiginformation : *const IMAGE_LOAD_CONFIG_DIRECTORY64) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SetSymLoadError(error : u32));
#[cfg(feature = "Win32_System_Kernel")]
windows_link::link!("kernel32.dll" "system" fn SetThreadContext(hthread : super::super::super::Foundation::HANDLE, lpcontext : *const CONTEXT) -> windows_sys::core::BOOL);
...
windows_link::link!("dbghelp.dll" "system" fn SymAddSourceStream(hprocess : super::super::super::Foundation::HANDLE, base : u64, streamfile : windows_sys::core::PCSTR, buffer : *const u8, size : usize) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymAddSourceStreamA(hprocess : super::super::super::Foundation::HANDLE, base : u64, streamfile : windows_sys::core::PCSTR, buffer : *const u8, size : usize) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymAddSourceStreamW(hprocess : super::super::super::Foundation::HANDLE, base : u64, filespec : windows_sys::core::PCWSTR, buffer : *const u8, size : usize) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymAddSymbol(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, name : windows_sys::core::PCSTR, address : u64, size : u32, flags : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymAddSymbolW(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, name : windows_sys::core::PCWSTR, address : u64, size : u32, flags : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("dbghelp.dll" "system" fn SymCleanup(hprocess : super::super::super::Foundation::HANDLE) -> windows_sys::core::BOOL);
...
windows_link::link!("dbghelp.dll" "system" fn SymDeleteSymbol(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, name : windows_sys::core::PCSTR, address : u64, flags : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymDeleteSymbolW(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, name : windows_sys::core::PCWSTR, address : u64, flags : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumLines(hprocess : super::super::super::Foundation::HANDLE, base : u64, obj : windows_sys::core::PCSTR, file : windows_sys::core::PCSTR, enumlinescallback : PSYM_ENUMLINES_CALLBACK, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumLinesW(hprocess : super::super::super::Foundation::HANDLE, base : u64, obj : windows_sys::core::PCWSTR, file : windows_sys::core::PCWSTR, enumlinescallback : PSYM_ENUMLINES_CALLBACKW, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("dbghelp.dll" "system" fn SymEnumSourceFileTokens(hprocess : super::super::super::Foundation::HANDLE, base : u64, callback : PENUMSOURCEFILETOKENSCALLBACK) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumSourceFiles(hprocess : super::super::super::Foundation::HANDLE, modbase : u64, mask : windows_sys::core::PCSTR, cbsrcfiles : PSYM_ENUMSOURCEFILES_CALLBACK, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumSourceFilesW(hprocess : super::super::super::Foundation::HANDLE, modbase : u64, mask : windows_sys::core::PCWSTR, cbsrcfiles : PSYM_ENUMSOURCEFILES_CALLBACKW, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumSourceLines(hprocess : super::super::super::Foundation::HANDLE, base : u64, obj : windows_sys::core::PCSTR, file : windows_sys::core::PCSTR, line : u32, flags : u32, enumlinescallback : PSYM_ENUMLINES_CALLBACK, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumSourceLinesW(hprocess : super::super::super::Foundation::HANDLE, base : u64, obj : windows_sys::core::PCWSTR, file : windows_sys::core::PCWSTR, line : u32, flags : u32, enumlinescallback : PSYM_ENUMLINES_CALLBACKW, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumSym(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, enumsymbolscallback : PSYM_ENUMERATESYMBOLS_CALLBACK, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumSymbols(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, mask : windows_sys::core::PCSTR, enumsymbolscallback : PSYM_ENUMERATESYMBOLS_CALLBACK, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumSymbolsEx(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, mask : windows_sys::core::PCSTR, enumsymbolscallback : PSYM_ENUMERATESYMBOLS_CALLBACK, usercontext : *const core::ffi::c_void, options : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumSymbolsExW(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, mask : windows_sys::core::PCWSTR, enumsymbolscallback : PSYM_ENUMERATESYMBOLS_CALLBACKW, usercontext : *const core::ffi::c_void, options : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumSymbolsForAddr(hprocess : super::super::super::Foundation::HANDLE, address : u64, enumsymbolscallback : PSYM_ENUMERATESYMBOLS_CALLBACK, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumSymbolsForAddrW(hprocess : super::super::super::Foundation::HANDLE, address : u64, enumsymbolscallback : PSYM_ENUMERATESYMBOLS_CALLBACKW, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumSymbolsW(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, mask : windows_sys::core::PCWSTR, enumsymbolscallback : PSYM_ENUMERATESYMBOLS_CALLBACKW, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumTypes(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, enumsymbolscallback : PSYM_ENUMERATESYMBOLS_CALLBACK, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumTypesByName(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, mask : windows_sys::core::PCSTR, enumsymbolscallback : PSYM_ENUMERATESYMBOLS_CALLBACK, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumTypesByNameW(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, mask : windows_sys::core::PCWSTR, enumsymbolscallback : PSYM_ENUMERATESYMBOLS_CALLBACKW, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumTypesW(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, enumsymbolscallback : PSYM_ENUMERATESYMBOLS_CALLBACKW, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
windows_link::link!("dbghelp.dll" "system" fn SymEnumerateModules(hprocess : super::super::super::Foundation::HANDLE, enummodulescallback : PSYM_ENUMMODULES_CALLBACK, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumerateModules64(hprocess : super::super::super::Foundation::HANDLE, enummodulescallback : PSYM_ENUMMODULES_CALLBACK64, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumerateModulesW64(hprocess : super::super::super::Foundation::HANDLE, enummodulescallback : PSYM_ENUMMODULES_CALLBACKW64, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
windows_link::link!("dbghelp.dll" "system" fn SymEnumerateSymbols(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u32, enumsymbolscallback : PSYM_ENUMSYMBOLS_CALLBACK, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumerateSymbols64(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, enumsymbolscallback : PSYM_ENUMSYMBOLS_CALLBACK64, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
windows_link::link!("dbghelp.dll" "system" fn SymEnumerateSymbolsW(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u32, enumsymbolscallback : PSYM_ENUMSYMBOLS_CALLBACKW, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymEnumerateSymbolsW64(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, enumsymbolscallback : PSYM_ENUMSYMBOLS_CALLBACK64W, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymFindDebugInfoFile(hprocess : super::super::super::Foundation::HANDLE, filename : windows_sys::core::PCSTR, debugfilepath : windows_sys::core::PSTR, callback : PFIND_DEBUG_FILE_CALLBACK, callerdata : *const core::ffi::c_void) -> super::super::super::Foundation::HANDLE);
windows_link::link!("dbghelp.dll" "system" fn SymFindDebugInfoFileW(hprocess : super::super::super::Foundation::HANDLE, filename : windows_sys::core::PCWSTR, debugfilepath : windows_sys::core::PWSTR, callback : PFIND_DEBUG_FILE_CALLBACKW, callerdata : *const core::ffi::c_void) -> super::super::super::Foundation::HANDLE);
windows_link::link!("dbghelp.dll" "system" fn SymFindExecutableImage(hprocess : super::super::super::Foundation::HANDLE, filename : windows_sys::core::PCSTR, imagefilepath : windows_sys::core::PSTR, callback : PFIND_EXE_FILE_CALLBACK, callerdata : *const core::ffi::c_void) -> super::super::super::Foundation::HANDLE);
windows_link::link!("dbghelp.dll" "system" fn SymFindExecutableImageW(hprocess : super::super::super::Foundation::HANDLE, filename : windows_sys::core::PCWSTR, imagefilepath : windows_sys::core::PWSTR, callback : PFIND_EXE_FILE_CALLBACKW, callerdata : *const core::ffi::c_void) -> super::super::super::Foundation::HANDLE);
...
windows_link::link!("dbghelp.dll" "system" fn SymFromAddr(hprocess : super::super::super::Foundation::HANDLE, address : u64, displacement : *mut u64, symbol : *mut SYMBOL_INFO) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymFromAddrW(hprocess : super::super::super::Foundation::HANDLE, address : u64, displacement : *mut u64, symbol : *mut SYMBOL_INFOW) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymFromIndex(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, index : u32, symbol : *mut SYMBOL_INFO) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymFromIndexW(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, index : u32, symbol : *mut SYMBOL_INFOW) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymFromInlineContext(hprocess : super::super::super::Foundation::HANDLE, address : u64, inlinecontext : u32, displacement : *mut u64, symbol : *mut SYMBOL_INFO) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymFromInlineContextW(hprocess : super::super::super::Foundation::HANDLE, address : u64, inlinecontext : u32, displacement : *mut u64, symbol : *mut SYMBOL_INFOW) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymFromName(hprocess : super::super::super::Foundation::HANDLE, name : windows_sys::core::PCSTR, symbol : *mut SYMBOL_INFO) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymFromNameW(hprocess : super::super::super::Foundation::HANDLE, name : windows_sys::core::PCWSTR, symbol : *mut SYMBOL_INFOW) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymFromToken(hprocess : super::super::super::Foundation::HANDLE, base : u64, token : u32, symbol : *mut SYMBOL_INFO) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymFromTokenW(hprocess : super::super::super::Foundation::HANDLE, base : u64, token : u32, symbol : *mut SYMBOL_INFOW) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
...
windows_link::link!("dbghelp.dll" "system" fn SymGetLineFromAddrW64(hprocess : super::super::super::Foundation::HANDLE, dwaddr : u64, pdwdisplacement : *mut u32, line : *mut IMAGEHLP_LINEW64) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetLineFromInlineContext(hprocess : super::super::super::Foundation::HANDLE, qwaddr : u64, inlinecontext : u32, qwmodulebaseaddress : u64, pdwdisplacement : *mut u32, line64 : *mut IMAGEHLP_LINE64) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetLineFromInlineContextW(hprocess : super::super::super::Foundation::HANDLE, dwaddr : u64, inlinecontext : u32, qwmodulebaseaddress : u64, pdwdisplacement : *mut u32, line : *mut IMAGEHLP_LINEW64) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
windows_link::link!("dbghelp.dll" "system" fn SymGetLineFromName(hprocess : super::super::super::Foundation::HANDLE, modulename : windows_sys::core::PCSTR, filename : windows_sys::core::PCSTR, dwlinenumber : u32, pldisplacement : *mut i32, line : *mut IMAGEHLP_LINE) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetLineFromName64(hprocess : super::super::super::Foundation::HANDLE, modulename : windows_sys::core::PCSTR, filename : windows_sys::core::PCSTR, dwlinenumber : u32, pldisplacement : *mut i32, line : *mut IMAGEHLP_LINE64) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetLineFromNameW64(hprocess : super::super::super::Foundation::HANDLE, modulename : windows_sys::core::PCWSTR, filename : windows_sys::core::PCWSTR, dwlinenumber : u32, pldisplacement : *mut i32, line : *mut IMAGEHLP_LINEW64) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
windows_link::link!("dbghelp.dll" "system" fn SymGetLineNext(hprocess : super::super::super::Foundation::HANDLE, line : *mut IMAGEHLP_LINE) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetLineNext64(hprocess : super::super::super::Foundation::HANDLE, line : *mut IMAGEHLP_LINE64) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetLineNextW64(hprocess : super::super::super::Foundation::HANDLE, line : *mut IMAGEHLP_LINEW64) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
windows_link::link!("dbghelp.dll" "system" fn SymGetLinePrev(hprocess : super::super::super::Foundation::HANDLE, line : *mut IMAGEHLP_LINE) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetLinePrev64(hprocess : super::super::super::Foundation::HANDLE, line : *mut IMAGEHLP_LINE64) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetLinePrevW64(hprocess : super::super::super::Foundation::HANDLE, line : *mut IMAGEHLP_LINEW64) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
...
#[cfg(target_arch = "x86")]
windows_link::link!("dbghelp.dll" "system" fn SymGetModuleInfo(hprocess : super::super::super::Foundation::HANDLE, dwaddr : u32, moduleinfo : *mut IMAGEHLP_MODULE) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetModuleInfo64(hprocess : super::super::super::Foundation::HANDLE, qwaddr : u64, moduleinfo : *mut IMAGEHLP_MODULE64) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
windows_link::link!("dbghelp.dll" "system" fn SymGetModuleInfoW(hprocess : super::super::super::Foundation::HANDLE, dwaddr : u32, moduleinfo : *mut IMAGEHLP_MODULEW) -> windows_sys::core::BOOL);
...
windows_link::link!("dbghelp.dll" "system" fn SymGetSearchPathW(hprocess : super::super::super::Foundation::HANDLE, searchpatha : windows_sys::core::PWSTR, searchpathlength : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetSourceFile(hprocess : super::super::super::Foundation::HANDLE, base : u64, params : windows_sys::core::PCSTR, filespec : windows_sys::core::PCSTR, filepath : windows_sys::core::PSTR, size : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetSourceFileChecksum(hprocess : super::super::super::Foundation::HANDLE, base : u64, filespec : windows_sys::core::PCSTR, pchecksumtype : *mut u32, pchecksum : *mut u8, checksumsize : u32, pactualbyteswritten : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetSourceFileChecksumW(hprocess : super::super::super::Foundation::HANDLE, base : u64, filespec : windows_sys::core::PCWSTR, pchecksumtype : *mut u32, pchecksum : *mut u8, checksumsize : u32, pactualbyteswritten : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetSourceFileFromToken(hprocess : super::super::super::Foundation::HANDLE, token : *const core::ffi::c_void, params : windows_sys::core::PCSTR, filepath : windows_sys::core::PSTR, size : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetSourceFileFromTokenByTokenName(hprocess : super::super::super::Foundation::HANDLE, token : *const core::ffi::c_void, tokenname : windows_sys::core::PCSTR, params : windows_sys::core::PCSTR, filepath : windows_sys::core::PSTR, size : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetSourceFileFromTokenByTokenNameW(hprocess : super::super::super::Foundation::HANDLE, token : *const core::ffi::c_void, tokenname : windows_sys::core::PCWSTR, params : windows_sys::core::PCWSTR, filepath : windows_sys::core::PWSTR, size : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetSourceFileFromTokenW(hprocess : super::super::super::Foundation::HANDLE, token : *const core::ffi::c_void, params : windows_sys::core::PCWSTR, filepath : windows_sys::core::PWSTR, size : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetSourceFileToken(hprocess : super::super::super::Foundation::HANDLE, base : u64, filespec : windows_sys::core::PCSTR, token : *mut *mut core::ffi::c_void, size : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetSourceFileTokenByTokenName(hprocess : super::super::super::Foundation::HANDLE, base : u64, filespec : windows_sys::core::PCSTR, tokenname : windows_sys::core::PCSTR, tokenparameters : windows_sys::core::PCSTR, token : *mut *mut core::ffi::c_void, size : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetSourceFileTokenByTokenNameW(hprocess : super::super::super::Foundation::HANDLE, base : u64, filespec : windows_sys::core::PCWSTR, tokenname : windows_sys::core::PCWSTR, tokenparameters : windows_sys::core::PCWSTR, token : *mut *mut core::ffi::c_void, size : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetSourceFileTokenW(hprocess : super::super::super::Foundation::HANDLE, base : u64, filespec : windows_sys::core::PCWSTR, token : *mut *mut core::ffi::c_void, size : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetSourceFileW(hprocess : super::super::super::Foundation::HANDLE, base : u64, params : windows_sys::core::PCWSTR, filespec : windows_sys::core::PCWSTR, filepath : windows_sys::core::PWSTR, size : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetSourceVarFromToken(hprocess : super::super::super::Foundation::HANDLE, token : *const core::ffi::c_void, params : windows_sys::core::PCSTR, varname : windows_sys::core::PCSTR, value : windows_sys::core::PSTR, size : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetSourceVarFromTokenW(hprocess : super::super::super::Foundation::HANDLE, token : *const core::ffi::c_void, params : windows_sys::core::PCWSTR, varname : windows_sys::core::PCWSTR, value : windows_sys::core::PWSTR, size : u32) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
windows_link::link!("dbghelp.dll" "system" fn SymGetSymFromAddr(hprocess : super::super::super::Foundation::HANDLE, dwaddr : u32, pdwdisplacement : *mut u32, symbol : *mut IMAGEHLP_SYMBOL) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetSymFromAddr64(hprocess : super::super::super::Foundation::HANDLE, qwaddr : u64, pdwdisplacement : *mut u64, symbol : *mut IMAGEHLP_SYMBOL64) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
windows_link::link!("dbghelp.dll" "system" fn SymGetSymFromName(hprocess : super::super::super::Foundation::HANDLE, name : windows_sys::core::PCSTR, symbol : *mut IMAGEHLP_SYMBOL) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetSymFromName64(hprocess : super::super::super::Foundation::HANDLE, name : windows_sys::core::PCSTR, symbol : *mut IMAGEHLP_SYMBOL64) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
windows_link::link!("dbghelp.dll" "system" fn SymGetSymNext(hprocess : super::super::super::Foundation::HANDLE, symbol : *mut IMAGEHLP_SYMBOL) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetSymNext64(hprocess : super::super::super::Foundation::HANDLE, symbol : *mut IMAGEHLP_SYMBOL64) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
...
windows_link::link!("dbghelp.dll" "system" fn SymGetTypeInfoEx(hprocess : super::super::super::Foundation::HANDLE, modbase : u64, params : *mut IMAGEHLP_GET_TYPE_INFO_PARAMS) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymGetUnwindInfo(hprocess : super::super::super::Foundation::HANDLE, address : u64, buffer : *mut core::ffi::c_void, size : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymInitialize(hprocess : super::super::super::Foundation::HANDLE, usersearchpath : windows_sys::core::PCSTR, finvadeprocess : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymInitializeW(hprocess : super::super::super::Foundation::HANDLE, usersearchpath : windows_sys::core::PCWSTR, finvadeprocess : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
windows_link::link!("dbghelp.dll" "system" fn SymLoadModule(hprocess : super::super::super::Foundation::HANDLE, hfile : super::super::super::Foundation::HANDLE, imagename : windows_sys::core::PCSTR, modulename : windows_sys::core::PCSTR, baseofdll : u32, sizeofdll : u32) -> u32);
windows_link::link!("dbghelp.dll" "system" fn SymLoadModule64(hprocess : super::super::super::Foundation::HANDLE, hfile : super::super::super::Foundation::HANDLE, imagename : windows_sys::core::PCSTR, modulename : windows_sys::core::PCSTR, baseofdll : u64, sizeofdll : u32) -> u64);
windows_link::link!("dbghelp.dll" "system" fn SymLoadModuleEx(hprocess : super::super::super::Foundation::HANDLE, hfile : super::super::super::Foundation::HANDLE, imagename : windows_sys::core::PCSTR, modulename : windows_sys::core::PCSTR, baseofdll : u64, dllsize : u32, data : *const MODLOAD_DATA, flags : SYM_LOAD_FLAGS) -> u64);
windows_link::link!("dbghelp.dll" "system" fn SymLoadModuleExW(hprocess : super::super::super::Foundation::HANDLE, hfile : super::super::super::Foundation::HANDLE, imagename : windows_sys::core::PCWSTR, modulename : windows_sys::core::PCWSTR, baseofdll : u64, dllsize : u32, data : *const MODLOAD_DATA, flags : SYM_LOAD_FLAGS) -> u64);
...
windows_link::link!("dbghelp.dll" "system" fn SymNext(hprocess : super::super::super::Foundation::HANDLE, si : *mut SYMBOL_INFO) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymNextW(hprocess : super::super::super::Foundation::HANDLE, siw : *mut SYMBOL_INFOW) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymPrev(hprocess : super::super::super::Foundation::HANDLE, si : *mut SYMBOL_INFO) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymPrevW(hprocess : super::super::super::Foundation::HANDLE, siw : *mut SYMBOL_INFOW) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymQueryInlineTrace(hprocess : super::super::super::Foundation::HANDLE, startaddress : u64, startcontext : u32, startretaddress : u64, curaddress : u64, curcontext : *mut u32, curframeindex : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymRefreshModuleList(hprocess : super::super::super::Foundation::HANDLE) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
windows_link::link!("dbghelp.dll" "system" fn SymRegisterCallback(hprocess : super::super::super::Foundation::HANDLE, callbackfunction : PSYMBOL_REGISTERED_CALLBACK, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymRegisterCallback64(hprocess : super::super::super::Foundation::HANDLE, callbackfunction : PSYMBOL_REGISTERED_CALLBACK64, usercontext : u64) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymRegisterCallbackW64(hprocess : super::super::super::Foundation::HANDLE, callbackfunction : PSYMBOL_REGISTERED_CALLBACK64, usercontext : u64) -> windows_sys::core::BOOL);
#[cfg(target_arch = "x86")]
windows_link::link!("dbghelp.dll" "system" fn SymRegisterFunctionEntryCallback(hprocess : super::super::super::Foundation::HANDLE, callbackfunction : PSYMBOL_FUNCENTRY_CALLBACK, usercontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymRegisterFunctionEntryCallback64(hprocess : super::super::super::Foundation::HANDLE, callbackfunction : PSYMBOL_FUNCENTRY_CALLBACK64, usercontext : u64) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymSearch(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, index : u32, symtag : u32, mask : windows_sys::core::PCSTR, address : u64, enumsymbolscallback : PSYM_ENUMERATESYMBOLS_CALLBACK, usercontext : *const core::ffi::c_void, options : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymSearchW(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, index : u32, symtag : u32, mask : windows_sys::core::PCWSTR, address : u64, enumsymbolscallback : PSYM_ENUMERATESYMBOLS_CALLBACKW, usercontext : *const core::ffi::c_void, options : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymSetContext(hprocess : super::super::super::Foundation::HANDLE, stackframe : *const IMAGEHLP_STACK_FRAME, context : *const core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("dbghelp.dll" "system" fn SymSetHomeDirectory(hprocess : super::super::super::Foundation::HANDLE, dir : windows_sys::core::PCSTR) -> windows_sys::core::PSTR);
windows_link::link!("dbghelp.dll" "system" fn SymSetHomeDirectoryW(hprocess : super::super::super::Foundation::HANDLE, dir : windows_sys::core::PCWSTR) -> windows_sys::core::PWSTR);
windows_link::link!("dbghelp.dll" "system" fn SymSetOptions(symoptions : u32) -> u32);
windows_link::link!("dbghelp.dll" "system" fn SymSetParentWindow(hwnd : super::super::super::Foundation::HWND) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymSetScopeFromAddr(hprocess : super::super::super::Foundation::HANDLE, address : u64) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymSetScopeFromIndex(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64, index : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymSetScopeFromInlineContext(hprocess : super::super::super::Foundation::HANDLE, address : u64, inlinecontext : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymSetSearchPath(hprocess : super::super::super::Foundation::HANDLE, searchpatha : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymSetSearchPathW(hprocess : super::super::super::Foundation::HANDLE, searchpatha : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymSrvDeltaName(hprocess : super::super::super::Foundation::HANDLE, sympath : windows_sys::core::PCSTR, r#type : windows_sys::core::PCSTR, file1 : windows_sys::core::PCSTR, file2 : windows_sys::core::PCSTR) -> windows_sys::core::PCSTR);
windows_link::link!("dbghelp.dll" "system" fn SymSrvDeltaNameW(hprocess : super::super::super::Foundation::HANDLE, sympath : windows_sys::core::PCWSTR, r#type : windows_sys::core::PCWSTR, file1 : windows_sys::core::PCWSTR, file2 : windows_sys::core::PCWSTR) -> windows_sys::core::PCWSTR);
...
windows_link::link!("dbghelp.dll" "system" fn SymSrvGetFileIndexString(hprocess : super::super::super::Foundation::HANDLE, srvpath : windows_sys::core::PCSTR, file : windows_sys::core::PCSTR, index : windows_sys::core::PSTR, size : usize, flags : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymSrvGetFileIndexStringW(hprocess : super::super::super::Foundation::HANDLE, srvpath : windows_sys::core::PCWSTR, file : windows_sys::core::PCWSTR, index : windows_sys::core::PWSTR, size : usize, flags : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("dbghelp.dll" "system" fn SymSrvGetSupplement(hprocess : super::super::super::Foundation::HANDLE, sympath : windows_sys::core::PCSTR, node : windows_sys::core::PCSTR, file : windows_sys::core::PCSTR) -> windows_sys::core::PCSTR);
windows_link::link!("dbghelp.dll" "system" fn SymSrvGetSupplementW(hprocess : super::super::super::Foundation::HANDLE, sympath : windows_sys::core::PCWSTR, node : windows_sys::core::PCWSTR, file : windows_sys::core::PCWSTR) -> windows_sys::core::PCWSTR);
windows_link::link!("dbghelp.dll" "system" fn SymSrvIsStore(hprocess : super::super::super::Foundation::HANDLE, path : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymSrvIsStoreW(hprocess : super::super::super::Foundation::HANDLE, path : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymSrvStoreFile(hprocess : super::super::super::Foundation::HANDLE, srvpath : windows_sys::core::PCSTR, file : windows_sys::core::PCSTR, flags : SYM_SRV_STORE_FILE_FLAGS) -> windows_sys::core::PCSTR);
windows_link::link!("dbghelp.dll" "system" fn SymSrvStoreFileW(hprocess : super::super::super::Foundation::HANDLE, srvpath : windows_sys::core::PCWSTR, file : windows_sys::core::PCWSTR, flags : SYM_SRV_STORE_FILE_FLAGS) -> windows_sys::core::PCWSTR);
windows_link::link!("dbghelp.dll" "system" fn SymSrvStoreSupplement(hprocess : super::super::super::Foundation::HANDLE, srvpath : windows_sys::core::PCSTR, node : windows_sys::core::PCSTR, file : windows_sys::core::PCSTR, flags : u32) -> windows_sys::core::PCSTR);
windows_link::link!("dbghelp.dll" "system" fn SymSrvStoreSupplementW(hprocess : super::super::super::Foundation::HANDLE, sympath : windows_sys::core::PCWSTR, node : windows_sys::core::PCWSTR, file : windows_sys::core::PCWSTR, flags : u32) -> windows_sys::core::PCWSTR);
#[cfg(target_arch = "x86")]
...
#[cfg(target_arch = "x86")]
windows_link::link!("dbghelp.dll" "system" fn SymUnloadModule(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u32) -> windows_sys::core::BOOL);
windows_link::link!("dbghelp.dll" "system" fn SymUnloadModule64(hprocess : super::super::super::Foundation::HANDLE, baseofdll : u64) -> windows_sys::core::BOOL);
...
windows_link::link!("imagehlp.dll" "system" fn TouchFileTimes(filehandle : super::super::super::Foundation::HANDLE, psystemtime : *const super::super::super::Foundation::SYSTEMTIME) -> windows_sys::core::BOOL);
...
#[cfg(all(feature = "Win32_System_Kernel", feature = "Win32_System_SystemInformation"))]
windows_link::link!("imagehlp.dll" "system" fn UnMapAndLoad(loadedimage : *mut LOADED_IMAGE) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_System_Kernel")]
windows_link::link!("kernel32.dll" "system" fn UnhandledExceptionFilter(exceptioninfo : *const EXCEPTION_POINTERS) -> i32);
#[cfg(feature = "Win32_System_SystemInformation")]
windows_link::link!("imagehlp.dll" "system" fn UpdateDebugInfoFile(imagefilename : windows_sys::core::PCSTR, symbolpath : windows_sys::core::PCSTR, debugfilepath : windows_sys::core::PSTR, ntheaders : *const IMAGE_NT_HEADERS32) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_System_SystemInformation")]
windows_link::link!("imagehlp.dll" "system" fn UpdateDebugInfoFileEx(imagefilename : windows_sys::core::PCSTR, symbolpath : windows_sys::core::PCSTR, debugfilepath : windows_sys::core::PSTR, ntheaders : *const IMAGE_NT_HEADERS32, oldchecksum : u32) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_System_Threading")]
windows_link::link!("kernel32.dll" "system" fn WaitForDebugEvent(lpdebugevent : *mut DEBUG_EVENT, dwmilliseconds : u32) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_System_Threading")]
windows_link::link!("kernel32.dll" "system" fn WaitForDebugEventEx(lpdebugevent : *mut DEBUG_EVENT, dwmilliseconds : u32) -> windows_sys::core::BOOL);
windows_link::link!("kernel32.dll" "system" fn Wow64GetThreadContext(hthread : super::super::super::Foundation::HANDLE, lpcontext : *mut WOW64_CONTEXT) -> windows_sys::core::BOOL);
windows_link::link!("kernel32.dll" "system" fn Wow64GetThreadSelectorEntry(hthread : super::super::super::Foundation::HANDLE, dwselector : u32, lpselectorentry : *mut WOW64_LDT_ENTRY) -> windows_sys::core::BOOL);
windows_link::link!("kernel32.dll" "system" fn Wow64SetThreadContext(hthread : super::super::super::Foundation::HANDLE, lpcontext : *const WOW64_CONTEXT) -> windows_sys::core::BOOL);
windows_link::link!("kernel32.dll" "system" fn WriteProcessMemory(hprocess : super::super::super::Foundation::HANDLE, lpbaseaddress : *const core::ffi::c_void, lpbuffer : *const core::ffi::c_void, nsize : usize, lpnumberofbyteswritten : *mut usize) -> windows_sys::core::BOOL);
pub const ABNORMAL_RESET_DETECTED: BUGCHECK_ERROR = 327;
pub const ACPI_BIOS_ERROR: BUGCHECK_ERROR = 165;
pub const ACPI_BIOS_FATAL_ERROR: BUGCHECK_ERROR = 224;
pub const ACPI_DRIVER_INTERNAL: BUGCHECK_ERROR = 163;
pub const ACPI_FIRMWARE_WATCHDOG_TIMEOUT: BUGCHECK_ERROR = 464;
...
pub const AGP_GART_CORRUPTION: BUGCHECK_ERROR = 261;
pub const AGP_ILLEGALLY_REPROGRAMMED: BUGCHECK_ERROR = 262;
pub const AGP_INTERNAL: BUGCHECK_ERROR = 277;
...
pub const APPLICATION_HANG_KERNEL_LIVEDUMP: BUGCHECK_ERROR = 501;
pub const APP_TAGGING_INITIALIZATION_FAILED: BUGCHECK_ERROR = 266;
#[repr(C)]
...
pub const ASSIGN_DRIVE_LETTERS_FAILED: BUGCHECK_ERROR = 114;
pub const ATDISK_DRIVER_INTERNAL: BUGCHECK_ERROR = 66;
pub const ATTEMPTED_EXECUTE_OF_NOEXECUTE_MEMORY: BUGCHECK_ERROR = 252;
pub const ATTEMPTED_SWITCH_FROM_DPC: BUGCHECK_ERROR = 184;
pub const ATTEMPTED_WRITE_TO_CM_PROTECTED_STORAGE: BUGCHECK_ERROR = 284;
pub const ATTEMPTED_WRITE_TO_READONLY_MEMORY: BUGCHECK_ERROR = 190;
pub const AUDIT_FAILURE: BUGCHECK_ERROR = 134;
pub const AZURE_DEVICE_FW_DUMP: BUGCHECK_ERROR = 482;
...
pub const BAD_EXHANDLE: BUGCHECK_ERROR = 167;
pub const BAD_OBJECT_HEADER: BUGCHECK_ERROR = 393;
pub const BAD_POOL_CALLER: BUGCHECK_ERROR = 194;
pub const BAD_POOL_HEADER: BUGCHECK_ERROR = 25;
pub const BAD_SYSTEM_CONFIG_INFO: BUGCHECK_ERROR = 116;
pub const BC_BLUETOOTH_VERIFIER_FAULT: BUGCHECK_ERROR = 3070;
pub const BC_BTHMINI_VERIFIER_FAULT: BUGCHECK_ERROR = 3071;
pub const BGI_DETECTED_VIOLATION: BUGCHECK_ERROR = 177;
...
pub const BITLOCKER_FATAL_ERROR: BUGCHECK_ERROR = 288;
pub const BLUETOOTH_ERROR_RECOVERY_LIVEDUMP: BUGCHECK_ERROR = 422;
pub const BOOTING_IN_SAFEMODE_DSREPAIR: BUGCHECK_ERROR = 170;
pub const BOOTING_IN_SAFEMODE_MINIMAL: BUGCHECK_ERROR = 168;
pub const BOOTING_IN_SAFEMODE_NETWORK: BUGCHECK_ERROR = 169;
pub const BOOTLOG_ENABLED: BUGCHECK_ERROR = 183;
pub const BOOTLOG_LOADED: BUGCHECK_ERROR = 181;
pub const BOOTLOG_NOT_LOADED: BUGCHECK_ERROR = 182;
pub const BOOTPROC_INITIALIZATION_FAILED: BUGCHECK_ERROR = 110;
pub const BOUND_IMAGE_UNSUPPORTED: BUGCHECK_ERROR = 151;
pub const BREAKAWAY_CABLE_TRANSITION: BUGCHECK_ERROR = 483;
pub const BUGCHECK_CONTEXT_MODIFIER: BUGCHECK_ERROR = 2147483648;
pub type BUGCHECK_ERROR = u32;
pub const BUGCODE_ID_DRIVER: BUGCHECK_ERROR = 210;
pub const BUGCODE_MBBADAPTER_DRIVER: BUGCHECK_ERROR = 477;
pub const BUGCODE_NDIS_DRIVER: BUGCHECK_ERROR = 124;
pub const BUGCODE_NDIS_DRIVER_LIVE_DUMP: BUGCHECK_ERROR = 350;
pub const BUGCODE_NETADAPTER_DRIVER: BUGCHECK_ERROR = 414;
pub const BUGCODE_USB3_DRIVER: BUGCHECK_ERROR = 324;
pub const BUGCODE_USB_DRIVER: BUGCHECK_ERROR = 254;
pub const BUGCODE_WIFIADAPTER_DRIVER: BUGCHECK_ERROR = 478;
pub const BindExpandFileHeaders: IMAGEHLP_STATUS_REASON = 10;
pub const BindForwarder: IMAGEHLP_STATUS_REASON = 7;
pub const BindForwarder32: IMAGEHLP_STATUS_REASON = 16;
pub const BindForwarder64: IMAGEHLP_STATUS_REASON = 17;
pub const BindForwarderNOT: IMAGEHLP_STATUS_REASON = 8;
pub const BindForwarderNOT32: IMAGEHLP_STATUS_REASON = 18;
pub const BindForwarderNOT64: IMAGEHLP_STATUS_REASON = 19;
pub const BindImageComplete: IMAGEHLP_STATUS_REASON = 11;
pub const BindImageModified: IMAGEHLP_STATUS_REASON = 9;
pub const BindImportModule: IMAGEHLP_STATUS_REASON = 5;
pub const BindImportModuleFailed: IMAGEHLP_STATUS_REASON = 3;
pub const BindImportProcedure: IMAGEHLP_STATUS_REASON = 6;
pub const BindImportProcedure32: IMAGEHLP_STATUS_REASON = 14;
pub const BindImportProcedure64: IMAGEHLP_STATUS_REASON = 15;
pub const BindImportProcedureFailed: IMAGEHLP_STATUS_REASON = 4;
pub const BindMismatchedSymbols: IMAGEHLP_STATUS_REASON = 12;
pub const BindNoRoomInImage: IMAGEHLP_STATUS_REASON = 2;
pub const BindOutOfMemory: IMAGEHLP_STATUS_REASON = 0;
pub const BindRvaToVaFailed: IMAGEHLP_STATUS_REASON = 1;
pub const BindSymbolsNotUpdated: IMAGEHLP_STATUS_REASON = 13;
pub const BitErrorDdr4: PAGE_OFFLINE_ERROR_TYPES = 0;
pub const BitErrorDdr5: PAGE_OFFLINE_ERROR_TYPES = 2;
pub const CACHE_INITIALIZATION_FAILED: BUGCHECK_ERROR = 102;
pub const CACHE_MANAGER: BUGCHECK_ERROR = 52;
pub const CALL_HAS_NOT_RETURNED_WATCHDOG_TIMEOUT_LIVEDUMP: BUGCHECK_ERROR = 419;
pub const CANCEL_STATE_IN_COMPLETED_IRP: BUGCHECK_ERROR = 72;
pub const CANNOT_WRITE_CONFIGURATION: BUGCHECK_ERROR = 117;
...
pub const CDFS_FILE_SYSTEM: BUGCHECK_ERROR = 38;
...
pub const CHIPSET_DETECTED_ERROR: BUGCHECK_ERROR = 185;
pub const CID_HANDLE_CREATION: BUGCHECK_ERROR = 22;
pub const CID_HANDLE_DELETION: BUGCHECK_ERROR = 23;
pub const CLOCK_WATCHDOG_TIMEOUT: BUGCHECK_ERROR = 257;
pub const CLUSTER_CLUSPORT_STATUS_IO_TIMEOUT_LIVEDUMP: BUGCHECK_ERROR = 377;
pub const CLUSTER_CSVFS_LIVEDUMP: BUGCHECK_ERROR = 392;
pub const CLUSTER_CSV_CLUSSVC_DISCONNECT_WATCHDOG: BUGCHECK_ERROR = 368;
pub const CLUSTER_CSV_CLUSTER_WATCHDOG_LIVEDUMP: BUGCHECK_ERROR = 363;
pub const CLUSTER_CSV_SNAPSHOT_DEVICE_INFO_TIMEOUT_LIVEDUMP: BUGCHECK_ERROR = 359;
pub const CLUSTER_CSV_STATE_TRANSITION_INTERVAL_TIMEOUT_LIVEDUMP: BUGCHECK_ERROR = 367;
pub const CLUSTER_CSV_STATE_TRANSITION_TIMEOUT_LIVEDUMP: BUGCHECK_ERROR = 360;
pub const CLUSTER_CSV_STATUS_IO_TIMEOUT_LIVEDUMP: BUGCHECK_ERROR = 357;
pub const CLUSTER_CSV_VOLUME_ARRIVAL_LIVEDUMP: BUGCHECK_ERROR = 361;
pub const CLUSTER_CSV_VOLUME_REMOVAL_LIVEDUMP: BUGCHECK_ERROR = 362;
pub const CLUSTER_RESOURCE_CALL_TIMEOUT_LIVEDUMP: BUGCHECK_ERROR = 358;
pub const CLUSTER_SVHDX_LIVEDUMP: BUGCHECK_ERROR = 413;
pub const CNSS_FILE_SYSTEM_FILTER: BUGCHECK_ERROR = 164;
pub const CONFIG_INITIALIZATION_FAILED: BUGCHECK_ERROR = 103;
pub const CONFIG_LIST_FAILED: BUGCHECK_ERROR = 115;
pub const CONNECTED_STANDBY_WATCHDOG_TIMEOUT_LIVEDUMP: BUGCHECK_ERROR = 351;
#[repr(C)]
#[cfg(target_arch = "x86")]
#[cfg(feature = "Win32_System_Kernel")]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const CONTEXT_ALL_AMD64: CONTEXT_FLAGS = 1048607;
pub const CONTEXT_ALL_ARM: CONTEXT_FLAGS = 2097167;
pub const CONTEXT_ALL_ARM64: CONTEXT_FLAGS = 4194335;
pub const CONTEXT_ALL_X86: CONTEXT_FLAGS = 65599;
pub const CONTEXT_AMD64: CONTEXT_FLAGS = 1048576;
pub const CONTEXT_ARM: CONTEXT_FLAGS = 2097152;
pub const CONTEXT_ARM64: CONTEXT_FLAGS = 4194304;
pub const CONTEXT_CONTROL_AMD64: CONTEXT_FLAGS = 1048577;
pub const CONTEXT_CONTROL_ARM: CONTEXT_FLAGS = 2097153;
pub const CONTEXT_CONTROL_ARM64: CONTEXT_FLAGS = 4194305;
pub const CONTEXT_CONTROL_X86: CONTEXT_FLAGS = 65537;
pub const CONTEXT_DEBUG_REGISTERS_AMD64: CONTEXT_FLAGS = 1048592;
pub const CONTEXT_DEBUG_REGISTERS_ARM: CONTEXT_FLAGS = 2097160;
pub const CONTEXT_DEBUG_REGISTERS_ARM64: CONTEXT_FLAGS = 4194312;
pub const CONTEXT_DEBUG_REGISTERS_X86: CONTEXT_FLAGS = 65552;
pub const CONTEXT_EXCEPTION_ACTIVE_AMD64: CONTEXT_FLAGS = 134217728;
pub const CONTEXT_EXCEPTION_ACTIVE_ARM: CONTEXT_FLAGS = 134217728;
pub const CONTEXT_EXCEPTION_ACTIVE_ARM64: CONTEXT_FLAGS = 134217728;
pub const CONTEXT_EXCEPTION_ACTIVE_X86: CONTEXT_FLAGS = 134217728;
pub const CONTEXT_EXCEPTION_REPORTING_AMD64: CONTEXT_FLAGS = 2147483648;
pub const CONTEXT_EXCEPTION_REPORTING_ARM: CONTEXT_FLAGS = 2147483648;
pub const CONTEXT_EXCEPTION_REPORTING_ARM64: CONTEXT_FLAGS = 2147483648;
pub const CONTEXT_EXCEPTION_REPORTING_X86: CONTEXT_FLAGS = 2147483648;
pub const CONTEXT_EXCEPTION_REQUEST_AMD64: CONTEXT_FLAGS = 1073741824;
pub const CONTEXT_EXCEPTION_REQUEST_ARM: CONTEXT_FLAGS = 1073741824;
pub const CONTEXT_EXCEPTION_REQUEST_ARM64: CONTEXT_FLAGS = 1073741824;
pub const CONTEXT_EXCEPTION_REQUEST_X86: CONTEXT_FLAGS = 1073741824;
pub const CONTEXT_EXTENDED_REGISTERS_X86: CONTEXT_FLAGS = 65568;
pub type CONTEXT_FLAGS = u32;
pub const CONTEXT_FLOATING_POINT_AMD64: CONTEXT_FLAGS = 1048584;
pub const CONTEXT_FLOATING_POINT_ARM: CONTEXT_FLAGS = 2097156;
pub const CONTEXT_FLOATING_POINT_ARM64: CONTEXT_FLAGS = 4194308;
pub const CONTEXT_FLOATING_POINT_X86: CONTEXT_FLAGS = 65544;
pub const CONTEXT_FULL_AMD64: CONTEXT_FLAGS = 1048587;
pub const CONTEXT_FULL_ARM: CONTEXT_FLAGS = 2097159;
pub const CONTEXT_FULL_ARM64: CONTEXT_FLAGS = 4194311;
pub const CONTEXT_FULL_X86: CONTEXT_FLAGS = 65543;
pub const CONTEXT_INTEGER_AMD64: CONTEXT_FLAGS = 1048578;
pub const CONTEXT_INTEGER_ARM: CONTEXT_FLAGS = 2097154;
pub const CONTEXT_INTEGER_ARM64: CONTEXT_FLAGS = 4194306;
pub const CONTEXT_INTEGER_X86: CONTEXT_FLAGS = 65538;
pub const CONTEXT_KERNEL_CET_AMD64: CONTEXT_FLAGS = 1048704;
pub const CONTEXT_KERNEL_DEBUGGER_AMD64: CONTEXT_FLAGS = 67108864;
pub const CONTEXT_RET_TO_GUEST_ARM64: CONTEXT_FLAGS = 1073741824;
pub const CONTEXT_SEGMENTS_AMD64: CONTEXT_FLAGS = 1048580;
pub const CONTEXT_SEGMENTS_X86: CONTEXT_FLAGS = 65540;
pub const CONTEXT_SERVICE_ACTIVE_AMD64: CONTEXT_FLAGS = 268435456;
pub const CONTEXT_SERVICE_ACTIVE_ARM: CONTEXT_FLAGS = 268435456;
pub const CONTEXT_SERVICE_ACTIVE_ARM64: CONTEXT_FLAGS = 268435456;
pub const CONTEXT_SERVICE_ACTIVE_X86: CONTEXT_FLAGS = 268435456;
pub const CONTEXT_UNWOUND_TO_CALL_AMD64: CONTEXT_FLAGS = 536870912;
pub const CONTEXT_UNWOUND_TO_CALL_ARM: CONTEXT_FLAGS = 536870912;
pub const CONTEXT_UNWOUND_TO_CALL_ARM64: CONTEXT_FLAGS = 536870912;
pub const CONTEXT_X18_ARM64: CONTEXT_FLAGS = 4194320;
pub const CONTEXT_X86: CONTEXT_FLAGS = 65536;
pub const CONTEXT_XSTATE_AMD64: CONTEXT_FLAGS = 1048640;
pub const CONTEXT_XSTATE_X86: CONTEXT_FLAGS = 65600;
pub const COREMSGCALL_INTERNAL_ERROR: BUGCHECK_ERROR = 371;
pub const COREMSG_INTERNAL_ERROR: BUGCHECK_ERROR = 372;
pub const CORRUPT_ACCESS_TOKEN: BUGCHECK_ERROR = 40;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const CPU_SCHEDULER_INTERNAL_ERROR: BUGCHECK_ERROR = 512;
pub const CRASHDUMP_WATCHDOG_TIMEOUT: BUGCHECK_ERROR = 486;
pub const CREATE_DELETE_LOCK_NOT_LOCKED: BUGCHECK_ERROR = 20;
...
pub const CRITICAL_INITIALIZATION_FAILURE: BUGCHECK_ERROR = 317;
pub const CRITICAL_OBJECT_TERMINATION: BUGCHECK_ERROR = 244;
pub const CRITICAL_PROCESS_DIED: BUGCHECK_ERROR = 239;
pub const CRITICAL_SERVICE_FAILED: BUGCHECK_ERROR = 90;
pub const CRITICAL_STRUCTURE_CORRUPTION: BUGCHECK_ERROR = 265;
pub const CRYPTO_LIBRARY_INTERNAL_ERROR: BUGCHECK_ERROR = 369;
pub const CRYPTO_SELF_TEST_FAILURE: BUGCHECK_ERROR = 291;
...
pub const DAM_WATCHDOG_TIMEOUT: BUGCHECK_ERROR = 491;
...
pub const DBGPROP_INFO_ATTRIBUTES: DBGPROP_INFO = 8;
pub const DBGPROP_INFO_AUTOEXPAND: DBGPROP_INFO = 134217728;
pub const DBGPROP_INFO_BEAUTIFY: DBGPROP_INFO = 33554432;
pub const DBGPROP_INFO_CALLTOSTRING: DBGPROP_INFO = 67108864;
pub const DBGPROP_INFO_DEBUGPROP: DBGPROP_INFO = 16;
pub const DBGPROP_INFO_FULLNAME: DBGPROP_INFO = 32;
pub const DBGPROP_INFO_NAME: DBGPROP_INFO = 1;
pub const DBGPROP_INFO_TYPE: DBGPROP_INFO = 2;
pub const DBGPROP_INFO_VALUE: DBGPROP_INFO = 4;
pub const DBHHEADER_CVMISC: MODLOAD_DATA_TYPE = 2;
pub const DBHHEADER_DEBUGDIRS: MODLOAD_DATA_TYPE = 1;
...
pub const DEREF_UNKNOWN_LOGON_SESSION: BUGCHECK_ERROR = 70;
pub const DEVICE_DIAGNOSTIC_LOG_LIVEDUMP: BUGCHECK_ERROR = 481;
pub const DEVICE_QUEUE_NOT_BUSY: BUGCHECK_ERROR = 2;
pub const DEVICE_REFERENCE_COUNT_NOT_ZERO: BUGCHECK_ERROR = 54;
pub const DFSC_FILE_SYSTEM: BUGCHECK_ERROR = 267;
pub const DFS_FILE_SYSTEM: BUGCHECK_ERROR = 130;
...
pub const DIRECTED_FX_TRANSITION_LIVEDUMP: BUGCHECK_ERROR = 425;
...
pub const DISORDERLY_SHUTDOWN: BUGCHECK_ERROR = 243;
#[repr(C)]
#[cfg(any(target_arch = "arm64ec", target_arch = "x86_64"))]
#[cfg(feature = "Win32_System_Kernel")]
#[derive(Clone, Copy, Debug)]
...
pub const DMA_COMMON_BUFFER_VECTOR_ERROR: BUGCHECK_ERROR = 476;
...
pub const DPC_WATCHDOG_TIMEOUT: BUGCHECK_ERROR = 258;
pub const DPC_WATCHDOG_VIOLATION: BUGCHECK_ERROR = 307;
pub const DRIPS_SW_HW_DIVERGENCE_LIVEDUMP: BUGCHECK_ERROR = 420;
pub const DRIVER_CAUGHT_MODIFYING_FREED_POOL: BUGCHECK_ERROR = 198;
pub const DRIVER_CORRUPTED_EXPOOL: BUGCHECK_ERROR = 197;
pub const DRIVER_CORRUPTED_MMPOOL: BUGCHECK_ERROR = 208;
pub const DRIVER_CORRUPTED_SYSPTES: BUGCHECK_ERROR = 219;
pub const DRIVER_INVALID_CRUNTIME_PARAMETER: BUGCHECK_ERROR = 272;
pub const DRIVER_INVALID_STACK_ACCESS: BUGCHECK_ERROR = 220;
pub const DRIVER_IRQL_NOT_LESS_OR_EQUAL: BUGCHECK_ERROR = 209;
pub const DRIVER_LEFT_LOCKED_PAGES_IN_PROCESS: BUGCHECK_ERROR = 203;
pub const DRIVER_OVERRAN_STACK_BUFFER: BUGCHECK_ERROR = 247;
pub const DRIVER_PAGE_FAULT_BEYOND_END_OF_ALLOCATION: BUGCHECK_ERROR = 214;
pub const DRIVER_PAGE_FAULT_BEYOND_END_OF_ALLOCATION_M: BUGCHECK_ERROR = 268435670;
pub const DRIVER_PAGE_FAULT_IN_FREED_SPECIAL_POOL: BUGCHECK_ERROR = 213;
pub const DRIVER_PNP_WATCHDOG: BUGCHECK_ERROR = 469;
pub const DRIVER_PORTION_MUST_BE_NONPAGED: BUGCHECK_ERROR = 211;
pub const DRIVER_POWER_STATE_FAILURE: BUGCHECK_ERROR = 159;
pub const DRIVER_RETURNED_HOLDING_CANCEL_LOCK: BUGCHECK_ERROR = 283;
pub const DRIVER_RETURNED_STATUS_REPARSE_FOR_VOLUME_OPEN: BUGCHECK_ERROR = 249;
pub const DRIVER_UNLOADED_WITHOUT_CANCELLING_PENDING_OPERATIONS: BUGCHECK_ERROR = 206;
pub const DRIVER_UNMAPPING_INVALID_VIEW: BUGCHECK_ERROR = 215;
pub const DRIVER_USED_EXCESSIVE_PTES: BUGCHECK_ERROR = 216;
pub const DRIVER_VERIFIER_DETECTED_VIOLATION: BUGCHECK_ERROR = 196;
pub const DRIVER_VERIFIER_DETECTED_VIOLATION_LIVEDUMP: BUGCHECK_ERROR = 452;
pub const DRIVER_VERIFIER_DMA_VIOLATION: BUGCHECK_ERROR = 230;
pub const DRIVER_VERIFIER_IOMANAGER_VIOLATION: BUGCHECK_ERROR = 201;
pub const DRIVER_VERIFIER_TRACKING_LIVE_DUMP: BUGCHECK_ERROR = 485;
pub const DRIVER_VIOLATION: BUGCHECK_ERROR = 289;
pub const DRIVE_EXTENDER: BUGCHECK_ERROR = 308;
...
pub const DUMP_TYPE_AUTOMATIC: DUMP_TYPE = 7;
pub const DUMP_TYPE_BITMAP_FULL: DUMP_TYPE = 5;
pub const DUMP_TYPE_BITMAP_KERNEL: DUMP_TYPE = 6;
pub const DUMP_TYPE_FULL: DUMP_TYPE = 1;
pub const DUMP_TYPE_HEADER: DUMP_TYPE = 3;
pub const DUMP_TYPE_INVALID: DUMP_TYPE = -1;
pub const DUMP_TYPE_SUMMARY: DUMP_TYPE = 2;
pub const DUMP_TYPE_TRIAGE: DUMP_TYPE = 4;
...
pub const EFS_FATAL_ERROR: BUGCHECK_ERROR = 471;
pub const ELAM_DRIVER_DETECTED_FATAL_ERROR: BUGCHECK_ERROR = 376;
pub const EMPTY_THREAD_REAPER_LIST: BUGCHECK_ERROR = 19;
pub const EM_INITIALIZATION_ERROR: BUGCHECK_ERROR = 282;
pub const END_OF_NT_EVALUATION_PERIOD: BUGCHECK_ERROR = 152;
pub const ERESOURCE_INVALID_RELEASE: BUGCHECK_ERROR = 366;
pub const ERRATA_WORKAROUND_UNSUCCESSFUL: BUGCHECK_ERROR = 318;
...
pub const EVENT_TRACING_FATAL_ERROR: BUGCHECK_ERROR = 285;
...
pub const EXCEPTION_SCOPE_INVALID: BUGCHECK_ERROR = 333;
...
pub const EXRESOURCE_TIMEOUT_LIVEDUMP: BUGCHECK_ERROR = 460;
...
pub const FACILITY_AAF: FACILITY_CODE = 18;
pub const FACILITY_ACCELERATOR: FACILITY_CODE = 1536;
pub const FACILITY_ACS: FACILITY_CODE = 20;
pub const FACILITY_ACTION_QUEUE: FACILITY_CODE = 44;
pub const FACILITY_AUDCLNT: FACILITY_CODE = 2185;
pub const FACILITY_AUDIO: FACILITY_CODE = 102;
pub const FACILITY_AUDIOSTREAMING: FACILITY_CODE = 1094;
pub const FACILITY_BACKGROUNDCOPY: FACILITY_CODE = 32;
pub const FACILITY_BCD: FACILITY_CODE = 57;
pub const FACILITY_BLB: FACILITY_CODE = 120;
pub const FACILITY_BLBUI: FACILITY_CODE = 128;
pub const FACILITY_BLB_CLI: FACILITY_CODE = 121;
pub const FACILITY_BLUETOOTH_ATT: FACILITY_CODE = 101;
pub const FACILITY_CERT: FACILITY_CODE = 11;
pub const FACILITY_CMI: FACILITY_CODE = 54;
pub type FACILITY_CODE = u32;
pub const FACILITY_COMPLUS: FACILITY_CODE = 17;
pub const FACILITY_CONFIGURATION: FACILITY_CODE = 33;
pub const FACILITY_CONTROL: FACILITY_CODE = 10;
pub const FACILITY_DAF: FACILITY_CODE = 100;
pub const FACILITY_DEBUGGERS: FACILITY_CODE = 176;
pub const FACILITY_DEFRAG: FACILITY_CODE = 2304;
pub const FACILITY_DELIVERY_OPTIMIZATION: FACILITY_CODE = 208;
pub const FACILITY_DEPLOYMENT_SERVICES_BINLSVC: FACILITY_CODE = 261;
pub const FACILITY_DEPLOYMENT_SERVICES_CONTENT_PROVIDER: FACILITY_CODE = 293;
pub const FACILITY_DEPLOYMENT_SERVICES_DRIVER_PROVISIONING: FACILITY_CODE = 278;
pub const FACILITY_DEPLOYMENT_SERVICES_IMAGING: FACILITY_CODE = 258;
pub const FACILITY_DEPLOYMENT_SERVICES_MANAGEMENT: FACILITY_CODE = 259;
pub const FACILITY_DEPLOYMENT_SERVICES_MULTICAST_CLIENT: FACILITY_CODE = 290;
pub const FACILITY_DEPLOYMENT_SERVICES_MULTICAST_SERVER: FACILITY_CODE = 289;
pub const FACILITY_DEPLOYMENT_SERVICES_PXE: FACILITY_CODE = 263;
pub const FACILITY_DEPLOYMENT_SERVICES_SERVER: FACILITY_CODE = 257;
pub const FACILITY_DEPLOYMENT_SERVICES_TFTP: FACILITY_CODE = 264;
pub const FACILITY_DEPLOYMENT_SERVICES_TRANSPORT_MANAGEMENT: FACILITY_CODE = 272;
pub const FACILITY_DEPLOYMENT_SERVICES_UTIL: FACILITY_CODE = 260;
pub const FACILITY_DEVICE_UPDATE_AGENT: FACILITY_CODE = 135;
pub const FACILITY_DIRECT2D: FACILITY_CODE = 2201;
pub const FACILITY_DIRECT3D10: FACILITY_CODE = 2169;
pub const FACILITY_DIRECT3D11: FACILITY_CODE = 2172;
pub const FACILITY_DIRECT3D11_DEBUG: FACILITY_CODE = 2173;
pub const FACILITY_DIRECT3D12: FACILITY_CODE = 2174;
pub const FACILITY_DIRECT3D12_DEBUG: FACILITY_CODE = 2175;
pub const FACILITY_DIRECTMUSIC: FACILITY_CODE = 2168;
pub const FACILITY_DIRECTORYSERVICE: FACILITY_CODE = 37;
pub const FACILITY_DISPATCH: FACILITY_CODE = 2;
pub const FACILITY_DLS: FACILITY_CODE = 153;
pub const FACILITY_DMSERVER: FACILITY_CODE = 256;
pub const FACILITY_DPLAY: FACILITY_CODE = 21;
pub const FACILITY_DRVSERVICING: FACILITY_CODE = 136;
pub const FACILITY_DXCORE: FACILITY_CODE = 2176;
pub const FACILITY_DXGI: FACILITY_CODE = 2170;
pub const FACILITY_DXGI_DDI: FACILITY_CODE = 2171;
pub const FACILITY_EAP: FACILITY_CODE = 66;
pub const FACILITY_EAS: FACILITY_CODE = 85;
pub const FACILITY_FVE: FACILITY_CODE = 49;
pub const FACILITY_FWP: FACILITY_CODE = 50;
pub const FACILITY_GAME: FACILITY_CODE = 2340;
pub const FACILITY_GRAPHICS: FACILITY_CODE = 38;
pub const FACILITY_HSP_SERVICES: FACILITY_CODE = 296;
pub const FACILITY_HSP_SOFTWARE: FACILITY_CODE = 297;
pub const FACILITY_HTTP: FACILITY_CODE = 25;
pub const FACILITY_INPUT: FACILITY_CODE = 64;
pub const FACILITY_INTERNET: FACILITY_CODE = 12;
pub const FACILITY_IORING: FACILITY_CODE = 70;
pub const FACILITY_ITF: FACILITY_CODE = 4;
pub const FACILITY_JSCRIPT: FACILITY_CODE = 2306;
pub const FACILITY_LEAP: FACILITY_CODE = 2184;
pub const FACILITY_LINGUISTIC_SERVICES: FACILITY_CODE = 305;
pub const FACILITY_MBN: FACILITY_CODE = 84;
pub const FACILITY_MEDIASERVER: FACILITY_CODE = 13;
pub const FACILITY_METADIRECTORY: FACILITY_CODE = 35;
pub const FACILITY_MOBILE: FACILITY_CODE = 1793;
pub const FACILITY_MSMQ: FACILITY_CODE = 14;
pub const FACILITY_NAP: FACILITY_CODE = 39;
pub const FACILITY_NDIS: FACILITY_CODE = 52;
pub const FACILITY_NT_BIT: FACILITY_CODE = 268435456;
pub const FACILITY_NULL: FACILITY_CODE = 0;
pub const FACILITY_OCP_UPDATE_AGENT: FACILITY_CODE = 173;
pub const FACILITY_ONLINE_ID: FACILITY_CODE = 134;
pub const FACILITY_OPC: FACILITY_CODE = 81;
pub const FACILITY_P2P: FACILITY_CODE = 99;
pub const FACILITY_P2P_INT: FACILITY_CODE = 98;
pub const FACILITY_PARSE: FACILITY_CODE = 113;
pub const FACILITY_PIDGENX: FACILITY_CODE = 2561;
pub const FACILITY_PIX: FACILITY_CODE = 2748;
pub const FACILITY_PLA: FACILITY_CODE = 48;
pub const FACILITY_POWERSHELL: FACILITY_CODE = 84;
pub const FACILITY_PPF: FACILITY_CODE = 2344;
pub const FACILITY_PRESENTATION: FACILITY_CODE = 2177;
pub const FACILITY_QUIC: FACILITY_CODE = 65;
pub const FACILITY_RAS: FACILITY_CODE = 83;
pub const FACILITY_RESTORE: FACILITY_CODE = 256;
pub const FACILITY_RPC: FACILITY_CODE = 1;
pub const FACILITY_SCARD: FACILITY_CODE = 16;
pub const FACILITY_SCRIPT: FACILITY_CODE = 112;
pub const FACILITY_SDIAG: FACILITY_CODE = 60;
pub const FACILITY_SECURITY: FACILITY_CODE = 9;
pub const FACILITY_SERVICE_FABRIC: FACILITY_CODE = 1968;
pub const FACILITY_SETUPAPI: FACILITY_CODE = 15;
pub const FACILITY_SHELL: FACILITY_CODE = 39;
pub const FACILITY_SOS: FACILITY_CODE = 160;
pub const FACILITY_SPP: FACILITY_CODE = 256;
pub const FACILITY_SQLITE: FACILITY_CODE = 1967;
pub const FACILITY_SSPI: FACILITY_CODE = 9;
pub const FACILITY_STATEREPOSITORY: FACILITY_CODE = 103;
pub const FACILITY_STATE_MANAGEMENT: FACILITY_CODE = 34;
pub const FACILITY_STORAGE: FACILITY_CODE = 3;
pub const FACILITY_SXS: FACILITY_CODE = 23;
pub const FACILITY_SYNCENGINE: FACILITY_CODE = 2050;
pub const FACILITY_TIERING: FACILITY_CODE = 131;
pub const FACILITY_TPM_SERVICES: FACILITY_CODE = 40;
pub const FACILITY_TPM_SOFTWARE: FACILITY_CODE = 41;
pub const FACILITY_TTD: FACILITY_CODE = 1490;
pub const FACILITY_UI: FACILITY_CODE = 42;
pub const FACILITY_UMI: FACILITY_CODE = 22;
pub const FACILITY_URT: FACILITY_CODE = 19;
pub const FACILITY_USERMODE_COMMONLOG: FACILITY_CODE = 26;
pub const FACILITY_USERMODE_FILTER_MANAGER: FACILITY_CODE = 31;
pub const FACILITY_USERMODE_HNS: FACILITY_CODE = 59;
pub const FACILITY_USERMODE_HYPERVISOR: FACILITY_CODE = 53;
pub const FACILITY_USERMODE_LICENSING: FACILITY_CODE = 234;
pub const FACILITY_USERMODE_PRM: FACILITY_CODE = 2342;
pub const FACILITY_USERMODE_SDBUS: FACILITY_CODE = 2305;
pub const FACILITY_USERMODE_SPACES: FACILITY_CODE = 231;
pub const FACILITY_USERMODE_UNIONFS: FACILITY_CODE = 2341;
pub const FACILITY_USERMODE_VHD: FACILITY_CODE = 58;
pub const FACILITY_USERMODE_VIRTUALIZATION: FACILITY_CODE = 55;
pub const FACILITY_USERMODE_VOLMGR: FACILITY_CODE = 56;
pub const FACILITY_USERMODE_VOLSNAP: FACILITY_CODE = 130;
pub const FACILITY_USERMODE_WIN_ACCEL: FACILITY_CODE = 2343;
pub const FACILITY_USER_MODE_SECURITY_CORE: FACILITY_CODE = 232;
pub const FACILITY_USN: FACILITY_CODE = 129;
pub const FACILITY_UTC: FACILITY_CODE = 1989;
pub const FACILITY_VISUALCPP: FACILITY_CODE = 109;
pub const FACILITY_WEB: FACILITY_CODE = 885;
pub const FACILITY_WEBSERVICES: FACILITY_CODE = 61;
pub const FACILITY_WEB_SOCKET: FACILITY_CODE = 886;
pub const FACILITY_WEP: FACILITY_CODE = 2049;
pub const FACILITY_WER: FACILITY_CODE = 27;
pub const FACILITY_WIA: FACILITY_CODE = 33;
pub const FACILITY_WIN32: FACILITY_CODE = 7;
pub const FACILITY_WINCODEC_DWRITE_DWM: FACILITY_CODE = 2200;
pub const FACILITY_WINDOWS: FACILITY_CODE = 8;
pub const FACILITY_WINDOWSUPDATE: FACILITY_CODE = 36;
pub const FACILITY_WINDOWS_CE: FACILITY_CODE = 24;
pub const FACILITY_WINDOWS_DEFENDER: FACILITY_CODE = 80;
pub const FACILITY_WINDOWS_SETUP: FACILITY_CODE = 48;
pub const FACILITY_WINDOWS_STORE: FACILITY_CODE = 63;
pub const FACILITY_WINML: FACILITY_CODE = 2192;
pub const FACILITY_WINPE: FACILITY_CODE = 61;
pub const FACILITY_WINRM: FACILITY_CODE = 51;
pub const FACILITY_WMAAECMA: FACILITY_CODE = 1996;
pub const FACILITY_WPN: FACILITY_CODE = 62;
pub const FACILITY_WSBAPP: FACILITY_CODE = 122;
pub const FACILITY_WSB_ONLINE: FACILITY_CODE = 133;
pub const FACILITY_XAML: FACILITY_CODE = 43;
pub const FACILITY_XBOX: FACILITY_CODE = 2339;
pub const FACILITY_XPS: FACILITY_CODE = 82;
pub const FAST_ERESOURCE_PRECONDITION_VIOLATION: BUGCHECK_ERROR = 454;
pub const FATAL_ABNORMAL_RESET_ERROR: BUGCHECK_ERROR = 332;
pub const FATAL_UNHANDLED_HARD_ERROR: BUGCHECK_ERROR = 76;
pub const FAT_FILE_SYSTEM: BUGCHECK_ERROR = 35;
pub const FAULTY_HARDWARE_CORRUPTED_PAGE: BUGCHECK_ERROR = 299;
pub const FILE_INITIALIZATION_FAILED: BUGCHECK_ERROR = 104;
pub const FILE_SYSTEM: BUGCHECK_ERROR = 34;
...
pub const FLOPPY_INTERNAL_ERROR: BUGCHECK_ERROR = 55;
pub const FLTMGR_FILE_SYSTEM: BUGCHECK_ERROR = 245;
pub const FORMAT_MESSAGE_ALLOCATE_BUFFER: FORMAT_MESSAGE_OPTIONS = 256;
pub const FORMAT_MESSAGE_ARGUMENT_ARRAY: FORMAT_MESSAGE_OPTIONS = 8192;
pub const FORMAT_MESSAGE_FROM_HMODULE: FORMAT_MESSAGE_OPTIONS = 2048;
pub const FORMAT_MESSAGE_FROM_STRING: FORMAT_MESSAGE_OPTIONS = 1024;
...
pub const FP_EMULATION_ERROR: BUGCHECK_ERROR = 166;
pub const FSRTL_EXTRA_CREATE_PARAMETER_VIOLATION: BUGCHECK_ERROR = 268;
pub const FunctionTableStream: MINIDUMP_STREAM_TYPE = 13;
pub const GPIO_CONTROLLER_DRIVER_ERROR: BUGCHECK_ERROR = 312;
pub const HAL1_INITIALIZATION_FAILED: BUGCHECK_ERROR = 97;
pub const HAL_BLOCKED_PROCESSOR_INTERNAL_ERROR: BUGCHECK_ERROR = 474;
pub const HAL_ILLEGAL_IOMMU_PAGE_FAULT: BUGCHECK_ERROR = 345;
pub const HAL_INITIALIZATION_FAILED: BUGCHECK_ERROR = 92;
pub const HAL_IOMMU_INTERNAL_ERROR: BUGCHECK_ERROR = 473;
pub const HAL_MEMORY_ALLOCATION: BUGCHECK_ERROR = 172;
pub const HAL_SPE_INTERNAL_ERROR: BUGCHECK_ERROR = 509;
pub const HANDLE_ERROR_ON_CRITICAL_THREAD: BUGCHECK_ERROR = 493;
pub const HANDLE_LIVE_DUMP: BUGCHECK_ERROR = 492;
pub const HARDWARE_INTERRUPT_STORM: BUGCHECK_ERROR = 242;
pub const HARDWARE_PROFILE_DOCKED_STRING: BUGCHECK_ERROR = 1073807362;
pub const HARDWARE_PROFILE_UNDOCKED_STRING: BUGCHECK_ERROR = 1073807361;
pub const HARDWARE_PROFILE_UNKNOWN_STRING: BUGCHECK_ERROR = 1073807363;
pub const HARDWARE_WATCHDOG_TIMEOUT: BUGCHECK_ERROR = 463;
pub const HTTP_DRIVER_CORRUPTED: BUGCHECK_ERROR = 250;
pub const HYPERGUARD_INITIALIZATION_FAILURE: BUGCHECK_ERROR = 383;
pub const HYPERGUARD_VIOLATION: BUGCHECK_ERROR = 396;
pub const HYPERVISOR_ERROR: BUGCHECK_ERROR = 131073;
...
pub const IMAGE_DEBUG_TYPE_BORLAND: IMAGE_DEBUG_TYPE = 9;
pub const IMAGE_DEBUG_TYPE_CODEVIEW: IMAGE_DEBUG_TYPE = 2;
pub const IMAGE_DEBUG_TYPE_COFF: IMAGE_DEBUG_TYPE = 1;
pub const IMAGE_DEBUG_TYPE_EXCEPTION: IMAGE_DEBUG_TYPE = 5;
pub const IMAGE_DEBUG_TYPE_FIXUP: IMAGE_DEBUG_TYPE = 6;
pub const IMAGE_DEBUG_TYPE_FPO: IMAGE_DEBUG_TYPE = 3;
pub const IMAGE_DEBUG_TYPE_MISC: IMAGE_DEBUG_TYPE = 4;
pub const IMAGE_DEBUG_TYPE_UNKNOWN: IMAGE_DEBUG_TYPE = 0;
pub type IMAGE_DIRECTORY_ENTRY = u16;
pub const IMAGE_DIRECTORY_ENTRY_ARCHITECTURE: IMAGE_DIRECTORY_ENTRY = 7;
pub const IMAGE_DIRECTORY_ENTRY_BASERELOC: IMAGE_DIRECTORY_ENTRY = 5;
pub const IMAGE_DIRECTORY_ENTRY_BOUND_IMPORT: IMAGE_DIRECTORY_ENTRY = 11;
pub const IMAGE_DIRECTORY_ENTRY_COM_DESCRIPTOR: IMAGE_DIRECTORY_ENTRY = 14;
pub const IMAGE_DIRECTORY_ENTRY_DEBUG: IMAGE_DIRECTORY_ENTRY = 6;
pub const IMAGE_DIRECTORY_ENTRY_DELAY_IMPORT: IMAGE_DIRECTORY_ENTRY = 13;
pub const IMAGE_DIRECTORY_ENTRY_EXCEPTION: IMAGE_DIRECTORY_ENTRY = 3;
pub const IMAGE_DIRECTORY_ENTRY_EXPORT: IMAGE_DIRECTORY_ENTRY = 0;
pub const IMAGE_DIRECTORY_ENTRY_GLOBALPTR: IMAGE_DIRECTORY_ENTRY = 8;
pub const IMAGE_DIRECTORY_ENTRY_IAT: IMAGE_DIRECTORY_ENTRY = 12;
pub const IMAGE_DIRECTORY_ENTRY_IMPORT: IMAGE_DIRECTORY_ENTRY = 1;
pub const IMAGE_DIRECTORY_ENTRY_LOAD_CONFIG: IMAGE_DIRECTORY_ENTRY = 10;
pub const IMAGE_DIRECTORY_ENTRY_RESOURCE: IMAGE_DIRECTORY_ENTRY = 2;
pub const IMAGE_DIRECTORY_ENTRY_SECURITY: IMAGE_DIRECTORY_ENTRY = 4;
pub const IMAGE_DIRECTORY_ENTRY_TLS: IMAGE_DIRECTORY_ENTRY = 9;
pub const IMAGE_DLLCHARACTERISTICS_APPCONTAINER: IMAGE_DLL_CHARACTERISTICS = 4096;
pub const IMAGE_DLLCHARACTERISTICS_DYNAMIC_BASE: IMAGE_DLL_CHARACTERISTICS = 64;
pub const IMAGE_DLLCHARACTERISTICS_EX_CET_COMPAT: IMAGE_DLL_CHARACTERISTICS = 1;
pub const IMAGE_DLLCHARACTERISTICS_EX_CET_COMPAT_STRICT_MODE: IMAGE_DLL_CHARACTERISTICS = 2;
pub const IMAGE_DLLCHARACTERISTICS_EX_CET_DYNAMIC_APIS_ALLOW_IN_PROC: IMAGE_DLL_CHARACTERISTICS = 8;
pub const IMAGE_DLLCHARACTERISTICS_EX_CET_RESERVED_1: IMAGE_DLL_CHARACTERISTICS = 16;
pub const IMAGE_DLLCHARACTERISTICS_EX_CET_RESERVED_2: IMAGE_DLL_CHARACTERISTICS = 32;
pub const IMAGE_DLLCHARACTERISTICS_EX_CET_SET_CONTEXT_IP_VALIDATION_RELAXED_MODE: IMAGE_DLL_CHARACTERISTICS = 4;
pub const IMAGE_DLLCHARACTERISTICS_EX_FORWARD_CFI_COMPAT: IMAGE_DLL_CHARACTERISTICS = 64;
pub const IMAGE_DLLCHARACTERISTICS_EX_HOTPATCH_COMPATIBLE: IMAGE_DLL_CHARACTERISTICS = 128;
pub const IMAGE_DLLCHARACTERISTICS_FORCE_INTEGRITY: IMAGE_DLL_CHARACTERISTICS = 128;
pub const IMAGE_DLLCHARACTERISTICS_GUARD_CF: IMAGE_DLL_CHARACTERISTICS = 16384;
pub const IMAGE_DLLCHARACTERISTICS_HIGH_ENTROPY_VA: IMAGE_DLL_CHARACTERISTICS = 32;
pub const IMAGE_DLLCHARACTERISTICS_NO_BIND: IMAGE_DLL_CHARACTERISTICS = 2048;
pub const IMAGE_DLLCHARACTERISTICS_NO_ISOLATION: IMAGE_DLL_CHARACTERISTICS = 512;
...
pub const IMAGE_DLLCHARACTERISTICS_TERMINAL_SERVER_AWARE: IMAGE_DLL_CHARACTERISTICS = 32768;
pub const IMAGE_DLLCHARACTERISTICS_WDM_DRIVER: IMAGE_DLL_CHARACTERISTICS = 8192;
pub type IMAGE_DLL_CHARACTERISTICS = u16;
pub const IMAGE_FILE_32BIT_MACHINE: IMAGE_FILE_CHARACTERISTICS = 256;
pub const IMAGE_FILE_32BIT_MACHINE2: IMAGE_FILE_CHARACTERISTICS2 = 256;
pub const IMAGE_FILE_AGGRESIVE_WS_TRIM: IMAGE_FILE_CHARACTERISTICS = 16;
pub const IMAGE_FILE_AGGRESIVE_WS_TRIM2: IMAGE_FILE_CHARACTERISTICS2 = 16;
pub const IMAGE_FILE_BYTES_REVERSED_HI: IMAGE_FILE_CHARACTERISTICS = 32768;
pub const IMAGE_FILE_BYTES_REVERSED_HI_2: IMAGE_FILE_CHARACTERISTICS2 = 32768;
pub const IMAGE_FILE_BYTES_REVERSED_LO: IMAGE_FILE_CHARACTERISTICS = 128;
pub const IMAGE_FILE_BYTES_REVERSED_LO2: IMAGE_FILE_CHARACTERISTICS2 = 128;
pub type IMAGE_FILE_CHARACTERISTICS = u16;
pub type IMAGE_FILE_CHARACTERISTICS2 = u32;
pub const IMAGE_FILE_DEBUG_STRIPPED: IMAGE_FILE_CHARACTERISTICS = 512;
pub const IMAGE_FILE_DEBUG_STRIPPED2: IMAGE_FILE_CHARACTERISTICS2 = 512;
pub const IMAGE_FILE_DLL: IMAGE_FILE_CHARACTERISTICS = 8192;
pub const IMAGE_FILE_DLL_2: IMAGE_FILE_CHARACTERISTICS2 = 8192;
...
pub const IMAGE_FILE_LARGE_ADDRESS_AWARE: IMAGE_FILE_CHARACTERISTICS = 32;
pub const IMAGE_FILE_LARGE_ADDRESS_AWARE2: IMAGE_FILE_CHARACTERISTICS2 = 32;
pub const IMAGE_FILE_LINE_NUMS_STRIPPED: IMAGE_FILE_CHARACTERISTICS = 4;
pub const IMAGE_FILE_LINE_NUMS_STRIPPED2: IMAGE_FILE_CHARACTERISTICS2 = 4;
pub const IMAGE_FILE_LOCAL_SYMS_STRIPPED: IMAGE_FILE_CHARACTERISTICS = 8;
pub const IMAGE_FILE_LOCAL_SYMS_STRIPPED2: IMAGE_FILE_CHARACTERISTICS2 = 8;
pub const IMAGE_FILE_NET_RUN_FROM_SWAP: IMAGE_FILE_CHARACTERISTICS = 2048;
pub const IMAGE_FILE_NET_RUN_FROM_SWAP2: IMAGE_FILE_CHARACTERISTICS2 = 2048;
pub const IMAGE_FILE_RELOCS_STRIPPED: IMAGE_FILE_CHARACTERISTICS = 1;
pub const IMAGE_FILE_RELOCS_STRIPPED2: IMAGE_FILE_CHARACTERISTICS2 = 1;
pub const IMAGE_FILE_REMOVABLE_RUN_FROM_SWAP: IMAGE_FILE_CHARACTERISTICS = 1024;
pub const IMAGE_FILE_REMOVABLE_RUN_FROM_SWAP2: IMAGE_FILE_CHARACTERISTICS2 = 1024;
pub const IMAGE_FILE_SYSTEM: IMAGE_FILE_CHARACTERISTICS = 4096;
pub const IMAGE_FILE_SYSTEM_2: IMAGE_FILE_CHARACTERISTICS2 = 4096;
...
pub const IMAGE_SCN_ALIGN_1024BYTES: IMAGE_SECTION_CHARACTERISTICS = 11534336;
pub const IMAGE_SCN_ALIGN_128BYTES: IMAGE_SECTION_CHARACTERISTICS = 8388608;
pub const IMAGE_SCN_ALIGN_16BYTES: IMAGE_SECTION_CHARACTERISTICS = 5242880;
pub const IMAGE_SCN_ALIGN_1BYTES: IMAGE_SECTION_CHARACTERISTICS = 1048576;
pub const IMAGE_SCN_ALIGN_2048BYTES: IMAGE_SECTION_CHARACTERISTICS = 12582912;
pub const IMAGE_SCN_ALIGN_256BYTES: IMAGE_SECTION_CHARACTERISTICS = 9437184;
pub const IMAGE_SCN_ALIGN_2BYTES: IMAGE_SECTION_CHARACTERISTICS = 2097152;
pub const IMAGE_SCN_ALIGN_32BYTES: IMAGE_SECTION_CHARACTERISTICS = 6291456;
pub const IMAGE_SCN_ALIGN_4096BYTES: IMAGE_SECTION_CHARACTERISTICS = 13631488;
pub const IMAGE_SCN_ALIGN_4BYTES: IMAGE_SECTION_CHARACTERISTICS = 3145728;
pub const IMAGE_SCN_ALIGN_512BYTES: IMAGE_SECTION_CHARACTERISTICS = 10485760;
pub const IMAGE_SCN_ALIGN_64BYTES: IMAGE_SECTION_CHARACTERISTICS = 7340032;
pub const IMAGE_SCN_ALIGN_8192BYTES: IMAGE_SECTION_CHARACTERISTICS = 14680064;
pub const IMAGE_SCN_ALIGN_8BYTES: IMAGE_SECTION_CHARACTERISTICS = 4194304;
pub const IMAGE_SCN_ALIGN_MASK: IMAGE_SECTION_CHARACTERISTICS = 15728640;
pub const IMAGE_SCN_CNT_CODE: IMAGE_SECTION_CHARACTERISTICS = 32;
pub const IMAGE_SCN_CNT_INITIALIZED_DATA: IMAGE_SECTION_CHARACTERISTICS = 64;
pub const IMAGE_SCN_CNT_UNINITIALIZED_DATA: IMAGE_SECTION_CHARACTERISTICS = 128;
pub const IMAGE_SCN_GPREL: IMAGE_SECTION_CHARACTERISTICS = 32768;
pub const IMAGE_SCN_LNK_COMDAT: IMAGE_SECTION_CHARACTERISTICS = 4096;
pub const IMAGE_SCN_LNK_INFO: IMAGE_SECTION_CHARACTERISTICS = 512;
pub const IMAGE_SCN_LNK_NRELOC_OVFL: IMAGE_SECTION_CHARACTERISTICS = 16777216;
pub const IMAGE_SCN_LNK_OTHER: IMAGE_SECTION_CHARACTERISTICS = 256;
pub const IMAGE_SCN_LNK_REMOVE: IMAGE_SECTION_CHARACTERISTICS = 2048;
pub const IMAGE_SCN_MEM_16BIT: IMAGE_SECTION_CHARACTERISTICS = 131072;
pub const IMAGE_SCN_MEM_DISCARDABLE: IMAGE_SECTION_CHARACTERISTICS = 33554432;
pub const IMAGE_SCN_MEM_EXECUTE: IMAGE_SECTION_CHARACTERISTICS = 536870912;
pub const IMAGE_SCN_MEM_FARDATA: IMAGE_SECTION_CHARACTERISTICS = 32768;
pub const IMAGE_SCN_MEM_LOCKED: IMAGE_SECTION_CHARACTERISTICS = 262144;
pub const IMAGE_SCN_MEM_NOT_CACHED: IMAGE_SECTION_CHARACTERISTICS = 67108864;
pub const IMAGE_SCN_MEM_NOT_PAGED: IMAGE_SECTION_CHARACTERISTICS = 134217728;
pub const IMAGE_SCN_MEM_PRELOAD: IMAGE_SECTION_CHARACTERISTICS = 524288;
pub const IMAGE_SCN_MEM_PURGEABLE: IMAGE_SECTION_CHARACTERISTICS = 131072;
pub const IMAGE_SCN_MEM_READ: IMAGE_SECTION_CHARACTERISTICS = 1073741824;
pub const IMAGE_SCN_MEM_SHARED: IMAGE_SECTION_CHARACTERISTICS = 268435456;
pub const IMAGE_SCN_MEM_WRITE: IMAGE_SECTION_CHARACTERISTICS = 2147483648;
pub const IMAGE_SCN_NO_DEFER_SPEC_EXC: IMAGE_SECTION_CHARACTERISTICS = 16384;
pub const IMAGE_SCN_SCALE_INDEX: IMAGE_SECTION_CHARACTERISTICS = 1;
pub const IMAGE_SCN_TYPE_NO_PAD: IMAGE_SECTION_CHARACTERISTICS = 8;
...
pub const IMAGE_SUBSYSTEM_EFI_APPLICATION: IMAGE_SUBSYSTEM = 10;
pub const IMAGE_SUBSYSTEM_EFI_BOOT_SERVICE_DRIVER: IMAGE_SUBSYSTEM = 11;
pub const IMAGE_SUBSYSTEM_EFI_ROM: IMAGE_SUBSYSTEM = 13;
pub const IMAGE_SUBSYSTEM_EFI_RUNTIME_DRIVER: IMAGE_SUBSYSTEM = 12;
pub const IMAGE_SUBSYSTEM_NATIVE: IMAGE_SUBSYSTEM = 1;
pub const IMAGE_SUBSYSTEM_NATIVE_WINDOWS: IMAGE_SUBSYSTEM = 8;
pub const IMAGE_SUBSYSTEM_OS2_CUI: IMAGE_SUBSYSTEM = 5;
pub const IMAGE_SUBSYSTEM_POSIX_CUI: IMAGE_SUBSYSTEM = 7;
pub const IMAGE_SUBSYSTEM_UNKNOWN: IMAGE_SUBSYSTEM = 0;
pub const IMAGE_SUBSYSTEM_WINDOWS_BOOT_APPLICATION: IMAGE_SUBSYSTEM = 16;
pub const IMAGE_SUBSYSTEM_WINDOWS_CE_GUI: IMAGE_SUBSYSTEM = 9;
pub const IMAGE_SUBSYSTEM_WINDOWS_CUI: IMAGE_SUBSYSTEM = 3;
pub const IMAGE_SUBSYSTEM_WINDOWS_GUI: IMAGE_SUBSYSTEM = 2;
pub const IMAGE_SUBSYSTEM_XBOX: IMAGE_SUBSYSTEM = 14;
pub const IMAGE_SUBSYSTEM_XBOX_CODE_CATALOG: IMAGE_SUBSYSTEM = 17;
pub const IMPERSONATING_WORKER_THREAD: BUGCHECK_ERROR = 223;
pub const INACCESSIBLE_BOOT_DEVICE: BUGCHECK_ERROR = 123;
pub const INCONSISTENT_IRP: BUGCHECK_ERROR = 42;
pub const INLINE_FRAME_CONTEXT_IGNORE: u32 = 4294967295;
pub const INLINE_FRAME_CONTEXT_INIT: u32 = 0;
pub const INSTALL_MORE_MEMORY: BUGCHECK_ERROR = 125;
pub const INSTRUCTION_BUS_ERROR: BUGCHECK_ERROR = 47;
pub const INSTRUCTION_COHERENCY_EXCEPTION: BUGCHECK_ERROR = 86;
pub const INSUFFICIENT_SYSTEM_MAP_REGS: BUGCHECK_ERROR = 69;
...
pub const INTERNAL_POWER_ERROR: BUGCHECK_ERROR = 160;
pub const INTERRUPT_EXCEPTION_NOT_HANDLED: BUGCHECK_ERROR = 61;
pub const INTERRUPT_UNWIND_ATTEMPTED: BUGCHECK_ERROR = 60;
pub const INVALID_AFFINITY_SET: BUGCHECK_ERROR = 3;
pub const INVALID_ALTERNATE_SYSTEM_CALL_HANDLER_REGISTRATION: BUGCHECK_ERROR = 480;
pub const INVALID_CALLBACK_STACK_ADDRESS: BUGCHECK_ERROR = 461;
pub const INVALID_CANCEL_OF_FILE_OPEN: BUGCHECK_ERROR = 232;
pub const INVALID_DATA_ACCESS_TRAP: BUGCHECK_ERROR = 4;
pub const INVALID_DRIVER_HANDLE: BUGCHECK_ERROR = 287;
pub const INVALID_EXTENDED_PROCESSOR_STATE: BUGCHECK_ERROR = 305;
pub const INVALID_EXTENSION_STATE: BUGCHECK_ERROR = 515;
pub const INVALID_FLOATING_POINT_STATE: BUGCHECK_ERROR = 231;
pub const INVALID_HIBERNATED_STATE: BUGCHECK_ERROR = 189;
pub const INVALID_IO_BOOST_STATE: BUGCHECK_ERROR = 316;
pub const INVALID_KERNEL_HANDLE: BUGCHECK_ERROR = 147;
pub const INVALID_KERNEL_STACK_ADDRESS: BUGCHECK_ERROR = 462;
pub const INVALID_MDL_RANGE: BUGCHECK_ERROR = 302;
pub const INVALID_MINIMAL_PROCESS_STATE: BUGCHECK_ERROR = 504;
pub const INVALID_PROCESS_ATTACH_ATTEMPT: BUGCHECK_ERROR = 5;
pub const INVALID_PROCESS_DETACH_ATTEMPT: BUGCHECK_ERROR = 6;
pub const INVALID_PUSH_LOCK_FLAGS: BUGCHECK_ERROR = 338;
pub const INVALID_REGION_OR_SEGMENT: BUGCHECK_ERROR = 153;
pub const INVALID_RUNDOWN_PROTECTION_FLAGS: BUGCHECK_ERROR = 364;
pub const INVALID_SILO_DETACH: BUGCHECK_ERROR = 459;
pub const INVALID_SLOT_ALLOCATOR_FLAGS: BUGCHECK_ERROR = 365;
pub const INVALID_SOFTWARE_INTERRUPT: BUGCHECK_ERROR = 7;
pub const INVALID_THREAD_AFFINITY_STATE: BUGCHECK_ERROR = 488;
pub const INVALID_WORK_QUEUE_ITEM: BUGCHECK_ERROR = 150;
pub const IO1_INITIALIZATION_FAILED: BUGCHECK_ERROR = 105;
pub const IOCTL_IPMI_INTERNAL_RECORD_SEL_EVENT: u32 = 2232320;
pub const IOMMU_INTERRUPT_REMAPPING_FAULT: BUGCHECK_ERROR = 507;
pub const IORING: BUGCHECK_ERROR = 499;
pub const IO_OBJECT_INVALID: BUGCHECK_ERROR = 328;
pub const IO_THREADPOOL_DEADLOCK_LIVEDUMP: BUGCHECK_ERROR = 453;
pub const IPI_WATCHDOG_TIMEOUT: BUGCHECK_ERROR = 475;
...
pub const IRQL_GT_ZERO_AT_SYSTEM_SERVICE: BUGCHECK_ERROR = 74;
pub const IRQL_NOT_DISPATCH_LEVEL: BUGCHECK_ERROR = 8;
pub const IRQL_NOT_GREATER_OR_EQUAL: BUGCHECK_ERROR = 9;
pub const IRQL_NOT_LESS_OR_EQUAL: BUGCHECK_ERROR = 10;
pub const IRQL_UNEXPECTED_VALUE: BUGCHECK_ERROR = 200;
...
pub const KASAN_ENLIGHTENMENT_VIOLATION: BUGCHECK_ERROR = 497;
...
pub const KERNEL_APC_PENDING_DURING_EXIT: BUGCHECK_ERROR = 32;
pub const KERNEL_AUTO_BOOST_INVALID_LOCK_RELEASE: BUGCHECK_ERROR = 354;
pub const KERNEL_AUTO_BOOST_LOCK_ACQUISITION_WITH_RAISED_IRQL: BUGCHECK_ERROR = 402;
pub const KERNEL_CFG_INIT_FAILURE: BUGCHECK_ERROR = 1058;
pub const KERNEL_DATA_INPAGE_ERROR: BUGCHECK_ERROR = 122;
pub const KERNEL_EXPAND_STACK_ACTIVE: BUGCHECK_ERROR = 263;
pub const KERNEL_LOCK_ENTRY_LEAKED_ON_THREAD_TERMINATION: BUGCHECK_ERROR = 339;
pub const KERNEL_MODE_EXCEPTION_NOT_HANDLED: BUGCHECK_ERROR = 142;
pub const KERNEL_MODE_EXCEPTION_NOT_HANDLED_M: BUGCHECK_ERROR = 268435598;
pub const KERNEL_MODE_HEAP_CORRUPTION: BUGCHECK_ERROR = 314;
pub const KERNEL_PARTITION_REFERENCE_VIOLATION: BUGCHECK_ERROR = 398;
pub const KERNEL_SECURITY_CHECK_FAILURE: BUGCHECK_ERROR = 313;
pub const KERNEL_STACK_INPAGE_ERROR: BUGCHECK_ERROR = 119;
pub const KERNEL_STACK_LOCKED_AT_EXIT: BUGCHECK_ERROR = 148;
pub const KERNEL_STORAGE_SLOT_IN_USE: BUGCHECK_ERROR = 409;
pub const KERNEL_THREAD_PRIORITY_FLOOR_VIOLATION: BUGCHECK_ERROR = 343;
pub const KERNEL_WMI_INTERNAL: BUGCHECK_ERROR = 330;
...
pub const LAST_CHANCE_CALLED_FROM_KMODE: BUGCHECK_ERROR = 21;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const LIVE_SYSTEM_DUMP: BUGCHECK_ERROR = 353;
pub const LM_SERVER_INTERNAL_ERROR: BUGCHECK_ERROR = 84;
#[repr(C)]
#[cfg(target_arch = "x86")]
#[cfg(all(feature = "Win32_System_Kernel", feature = "Win32_System_SystemInformation"))]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const LOADER_BLOCK_MISMATCH: BUGCHECK_ERROR = 256;
...
pub const LOCKED_PAGES_TRACKER_CORRUPTION: BUGCHECK_ERROR = 217;
pub type LPCALL_BACK_USER_INTERRUPT_ROUTINE = Option<unsafe extern "system" fn() -> u32>;
pub const LPC_INITIALIZATION_FAILED: BUGCHECK_ERROR = 106;
#[cfg(feature = "Win32_System_Kernel")]
...
pub const MACHINE_CHECK_EXCEPTION: BUGCHECK_ERROR = 156;
pub const MAILSLOT_FILE_SYSTEM: BUGCHECK_ERROR = 82;
pub const MANUALLY_INITIATED_BLACKSCREEN_HOTKEY_LIVE_DUMP: BUGCHECK_ERROR = 8648;
pub const MANUALLY_INITIATED_CRASH: BUGCHECK_ERROR = 226;
pub const MANUALLY_INITIATED_CRASH1: BUGCHECK_ERROR = 3735936685;
pub const MANUALLY_INITIATED_POWER_BUTTON_HOLD: BUGCHECK_ERROR = 456;
pub const MANUALLY_INITIATED_POWER_BUTTON_HOLD_LIVE_DUMP: BUGCHECK_ERROR = 4552;
pub const MAXIMUM_WAIT_OBJECTS_EXCEEDED: BUGCHECK_ERROR = 12;
pub const MAX_SYM_NAME: u32 = 2000;
pub const MBR_CHECKSUM_MISMATCH: BUGCHECK_ERROR = 139;
pub const MDL_CACHE: BUGCHECK_ERROR = 500;
pub const MEMORY1_INITIALIZATION_FAILED: BUGCHECK_ERROR = 101;
#[repr(C, packed(1))]
#[derive(Clone, Copy)]
...
pub const MEMORY_IMAGE_CORRUPT: BUGCHECK_ERROR = 162;
pub const MEMORY_MANAGEMENT: BUGCHECK_ERROR = 26;
pub const MICROCODE_REVISION_MISMATCH: BUGCHECK_ERROR = 382;
#[repr(C)]
#[cfg(target_arch = "x86")]
#[cfg(all(feature = "Win32_Storage_FileSystem", feature = "Win32_System_Kernel", feature = "Win32_System_Memory"))]
#[derive(Clone, Copy, Debug)]
...
pub const MINIDUMP_MISC1_PROCESS_ID: MINIDUMP_MISC_INFO_FLAGS = 1;
pub const MINIDUMP_MISC1_PROCESS_TIMES: MINIDUMP_MISC_INFO_FLAGS = 2;
...
pub const MINIDUMP_THREAD_INFO_ERROR_THREAD: MINIDUMP_THREAD_INFO_DUMP_FLAGS = 1;
pub const MINIDUMP_THREAD_INFO_EXITED_THREAD: MINIDUMP_THREAD_INFO_DUMP_FLAGS = 4;
pub const MINIDUMP_THREAD_INFO_INVALID_CONTEXT: MINIDUMP_THREAD_INFO_DUMP_FLAGS = 16;
pub const MINIDUMP_THREAD_INFO_INVALID_INFO: MINIDUMP_THREAD_INFO_DUMP_FLAGS = 8;
pub const MINIDUMP_THREAD_INFO_INVALID_TEB: MINIDUMP_THREAD_INFO_DUMP_FLAGS = 32;
#[repr(C, packed(4))]
#[derive(Clone, Copy, Default)]
...
pub const MINIDUMP_THREAD_INFO_WRITING_THREAD: MINIDUMP_THREAD_INFO_DUMP_FLAGS = 2;
#[repr(C, packed(4))]
#[derive(Clone, Copy)]
...
pub const MPSDRV_QUERY_USER: BUGCHECK_ERROR = 1073742318;
pub const MSRPC_STATE_VIOLATION: BUGCHECK_ERROR = 274;
pub const MSSECCORE_ASSERTION_FAILURE: BUGCHECK_ERROR = 503;
pub const MUI_NO_VALID_SYSTEM_LANGUAGE: BUGCHECK_ERROR = 298;
pub const MULTIPLE_IRP_COMPLETE_REQUESTS: BUGCHECK_ERROR = 68;
pub const MULTIPROCESSOR_CONFIGURATION_NOT_SUPPORTED: BUGCHECK_ERROR = 62;
pub const MUP_FILE_SYSTEM: BUGCHECK_ERROR = 259;
pub const MUST_SUCCEED_POOL_EMPTY: BUGCHECK_ERROR = 65;
pub const MUTEX_ALREADY_OWNED: BUGCHECK_ERROR = 191;
pub const MUTEX_LEVEL_NUMBER_VIOLATION: BUGCHECK_ERROR = 13;
...
pub const MiniDumpValidTypeFlags: MINIDUMP_TYPE = 33554431;
pub const MiniDumpValidTypeFlagsEx: MINIDUMP_TYPE = 67108863;
...
pub const NDIS_INTERNAL_ERROR: BUGCHECK_ERROR = 79;
pub const NDIS_NET_BUFFER_LIST_INFO_ILLEGALLY_TRANSFERRED: BUGCHECK_ERROR = 326;
pub const NETIO_INVALID_POOL_CALLER: BUGCHECK_ERROR = 294;
pub const NETWORK_BOOT_DUPLICATE_ADDRESS: BUGCHECK_ERROR = 188;
pub const NETWORK_BOOT_INITIALIZATION_FAILED: BUGCHECK_ERROR = 187;
pub const NMI_HARDWARE_FAILURE: BUGCHECK_ERROR = 128;
pub const NMR_INVALID_STATE: BUGCHECK_ERROR = 293;
pub const NO_BOOT_DEVICE: BUGCHECK_ERROR = 83;
pub const NO_EXCEPTION_HANDLING_SUPPORT: BUGCHECK_ERROR = 11;
pub const NO_MORE_IRP_STACK_LOCATIONS: BUGCHECK_ERROR = 53;
pub const NO_MORE_SYSTEM_PTES: BUGCHECK_ERROR = 63;
pub const NO_PAGES_AVAILABLE: BUGCHECK_ERROR = 77;
pub const NO_SPIN_LOCK_AVAILABLE: BUGCHECK_ERROR = 29;
pub const NO_SUCH_PARTITION: BUGCHECK_ERROR = 67;
pub const NO_USER_MODE_CONTEXT: BUGCHECK_ERROR = 14;
pub const NPFS_FILE_SYSTEM: BUGCHECK_ERROR = 37;
pub const NTFS_FILE_SYSTEM: BUGCHECK_ERROR = 36;
pub const NTHV_GUEST_ERROR: BUGCHECK_ERROR = 280;
pub const NUM_SSRVOPTS: u32 = 32;
pub const NumSymTypes: SYM_TYPE = 9;
pub const OBJECT1_INITIALIZATION_FAILED: BUGCHECK_ERROR = 98;
...
pub const PAGE_FAULT_BEYOND_END_OF_ALLOCATION: BUGCHECK_ERROR = 205;
pub const PAGE_FAULT_IN_FREED_SPECIAL_POOL: BUGCHECK_ERROR = 204;
pub const PAGE_FAULT_IN_NONPAGED_AREA: BUGCHECK_ERROR = 80;
pub const PAGE_FAULT_IN_NONPAGED_AREA_M: BUGCHECK_ERROR = 268435536;
pub const PAGE_FAULT_WITH_INTERRUPTS_OFF: BUGCHECK_ERROR = 73;
pub const PAGE_NOT_ZERO: BUGCHECK_ERROR = 295;
...
pub const PANIC_STACK_SWITCH: BUGCHECK_ERROR = 43;
pub const PASSIVE_INTERRUPT_ERROR: BUGCHECK_ERROR = 315;
pub const PCI_BUS_DRIVER_INTERNAL: BUGCHECK_ERROR = 161;
pub const PCI_CONFIG_SPACE_ACCESS_FAILURE: BUGCHECK_ERROR = 192;
pub const PCI_VERIFIER_DETECTED_VIOLATION: BUGCHECK_ERROR = 246;
...
pub const PDC_LOCK_WATCHDOG_LIVEDUMP: BUGCHECK_ERROR = 380;
pub const PDC_PRIVILEGE_CHECK_LIVEDUMP: BUGCHECK_ERROR = 415;
pub const PDC_UNEXPECTED_REVOCATION_LIVEDUMP: BUGCHECK_ERROR = 381;
pub const PDC_WATCHDOG_TIMEOUT: BUGCHECK_ERROR = 335;
pub const PDC_WATCHDOG_TIMEOUT_LIVEDUMP: BUGCHECK_ERROR = 348;
...
pub const PFN_LIST_CORRUPT: BUGCHECK_ERROR = 78;
pub const PFN_REFERENCE_COUNT: BUGCHECK_ERROR = 28;
pub const PFN_SHARE_COUNT: BUGCHECK_ERROR = 27;
#[cfg(target_arch = "x86")]
...
pub const PF_DETECTED_CORRUPTION: BUGCHECK_ERROR = 401;
#[cfg(target_arch = "x86")]
...
pub const PHASE0_EXCEPTION: BUGCHECK_ERROR = 120;
...
pub const PINBALL_FILE_SYSTEM: BUGCHECK_ERROR = 89;
pub const PNP_DETECTED_FATAL_ERROR: BUGCHECK_ERROR = 202;
pub const PNP_INTERNAL_ERROR: BUGCHECK_ERROR = 149;
pub const POOL_CORRUPTION_IN_FILE_AREA: BUGCHECK_ERROR = 222;
pub const PORT_DRIVER_INTERNAL: BUGCHECK_ERROR = 44;
pub const POWER_FAILURE_SIMULATE: BUGCHECK_ERROR = 229;
pub const PP0_INITIALIZATION_FAILED: BUGCHECK_ERROR = 143;
pub const PP1_INITIALIZATION_FAILED: BUGCHECK_ERROR = 144;
#[cfg(target_arch = "x86")]
...
pub const PREVIOUS_FATAL_ABNORMAL_RESET_ERROR: BUGCHECK_ERROR = 373;
pub const PREVIOUS_MODE_MISMATCH: BUGCHECK_ERROR = 505;
pub const PROCESS1_INITIALIZATION_FAILED: BUGCHECK_ERROR = 107;
pub const PROCESSOR_DRIVER_INTERNAL: BUGCHECK_ERROR = 323;
pub const PROCESSOR_START_TIMEOUT: BUGCHECK_ERROR = 479;
pub const PROCESS_HAS_LOCKED_PAGES: BUGCHECK_ERROR = 118;
pub const PROCESS_INITIALIZATION_FAILED: BUGCHECK_ERROR = 96;
pub const PROCESS_TERMINATE_LIKELY_DEADLOCK: BUGCHECK_ERROR = 513;
pub const PROFILER_CONFIGURATION_ILLEGAL: BUGCHECK_ERROR = 379;
...
pub const QUOTA_UNDERFLOW: BUGCHECK_ERROR = 33;
pub const RAMDISK_BOOT_INITIALIZATION_FAILED: BUGCHECK_ERROR = 248;
pub const RDR_FILE_SYSTEM: BUGCHECK_ERROR = 39;
pub const RECOM_DRIVER: BUGCHECK_ERROR = 132;
pub const RECURSIVE_MACHINE_CHECK: BUGCHECK_ERROR = 251;
pub const RECURSIVE_NMI: BUGCHECK_ERROR = 273;
pub const REFERENCE_BY_POINTER: BUGCHECK_ERROR = 24;
pub const REFMON_INITIALIZATION_FAILED: BUGCHECK_ERROR = 108;
pub const REFS_FILE_SYSTEM: BUGCHECK_ERROR = 329;
pub const REF_UNKNOWN_LOGON_SESSION: BUGCHECK_ERROR = 71;
pub const REGISTRY_CALLBACK_DRIVER_EXCEPTION: BUGCHECK_ERROR = 319;
pub const REGISTRY_ERROR: BUGCHECK_ERROR = 81;
pub const REGISTRY_FILTER_DRIVER_EXCEPTION: BUGCHECK_ERROR = 309;
pub const REGISTRY_LIVE_DUMP: BUGCHECK_ERROR = 487;
pub const RESERVE_QUEUE_OVERFLOW: BUGCHECK_ERROR = 255;
pub const RESOURCE_NOT_OWNED: BUGCHECK_ERROR = 227;
pub const RESOURCE_OWNER_POINTER_INVALID: BUGCHECK_ERROR = 306;
...
pub const SAVER_ACCOUNTPROVSVCINITFAILURE: BUGCHECK_ERROR = 61461;
pub const SAVER_APPBARDISMISSAL: BUGCHECK_ERROR = 61454;
pub const SAVER_APPLISTUNREACHABLE: BUGCHECK_ERROR = 61456;
pub const SAVER_AUDIODRIVERHANG: BUGCHECK_ERROR = 62464;
pub const SAVER_AUXILIARYFULLDUMP: BUGCHECK_ERROR = 61460;
pub const SAVER_BATTERYPULLOUT: BUGCHECK_ERROR = 62720;
pub const SAVER_BLANKSCREEN: BUGCHECK_ERROR = 61442;
pub const SAVER_CALLDISMISSAL: BUGCHECK_ERROR = 61453;
pub const SAVER_CAPTURESERVICE: BUGCHECK_ERROR = 63488;
pub const SAVER_CHROMEPROCESSCRASH: BUGCHECK_ERROR = 61450;
pub const SAVER_DEVICEUPDATEUNSPECIFIED: BUGCHECK_ERROR = 62208;
pub const SAVER_GRAPHICS: BUGCHECK_ERROR = 61448;
pub const SAVER_INPUT: BUGCHECK_ERROR = 61443;
pub const SAVER_MEDIACORETESTHANG: BUGCHECK_ERROR = 62976;
pub const SAVER_MTBFCOMMANDHANG: BUGCHECK_ERROR = 61697;
pub const SAVER_MTBFCOMMANDTIMEOUT: BUGCHECK_ERROR = 789;
pub const SAVER_MTBFIOERROR: BUGCHECK_ERROR = 61699;
pub const SAVER_MTBFPASSBUGCHECK: BUGCHECK_ERROR = 61698;
pub const SAVER_NAVIGATIONMODEL: BUGCHECK_ERROR = 61446;
pub const SAVER_NAVSERVERTIMEOUT: BUGCHECK_ERROR = 61449;
pub const SAVER_NONRESPONSIVEPROCESS: BUGCHECK_ERROR = 404;
pub const SAVER_NOTIFICATIONDISMISSAL: BUGCHECK_ERROR = 61451;
pub const SAVER_OUTOFMEMORY: BUGCHECK_ERROR = 61447;
pub const SAVER_RENDERMOBILEUIOOM: BUGCHECK_ERROR = 61953;
pub const SAVER_RENDERTHREADHANG: BUGCHECK_ERROR = 61952;
pub const SAVER_REPORTNOTIFICATIONFAILURE: BUGCHECK_ERROR = 61457;
pub const SAVER_RESOURCEMANAGEMENT: BUGCHECK_ERROR = 63232;
pub const SAVER_RILADAPTATIONCRASH: BUGCHECK_ERROR = 61455;
pub const SAVER_RPCFAILURE: BUGCHECK_ERROR = 61459;
pub const SAVER_SICKAPPLICATION: BUGCHECK_ERROR = 34918;
pub const SAVER_SPEECHDISMISSAL: BUGCHECK_ERROR = 61452;
pub const SAVER_STARTNOTVISIBLE: BUGCHECK_ERROR = 61445;
pub const SAVER_UNEXPECTEDSHUTDOWN: BUGCHECK_ERROR = 61458;
pub const SAVER_UNSPECIFIED: BUGCHECK_ERROR = 61440;
pub const SAVER_WAITFORSHELLREADY: BUGCHECK_ERROR = 63744;
pub const SAVER_WATCHDOG: BUGCHECK_ERROR = 61444;
pub const SCSI_DISK_DRIVER_INTERNAL: BUGCHECK_ERROR = 45;
pub const SCSI_VERIFIER_DETECTED_VIOLATION: BUGCHECK_ERROR = 241;
pub const SDBUS_INTERNAL_ERROR: BUGCHECK_ERROR = 346;
pub const SECURE_BOOT_VIOLATION: BUGCHECK_ERROR = 325;
pub const SECURE_FAULT_UNHANDLED: BUGCHECK_ERROR = 397;
pub const SECURE_KERNEL_ERROR: BUGCHECK_ERROR = 395;
pub const SECURE_KERNEL_HIBERNATE_ERROR: BUGCHECK_ERROR = 370;
pub const SECURE_PCI_CONFIG_SPACE_ACCESS_VIOLATION: BUGCHECK_ERROR = 490;
pub const SECURITY1_INITIALIZATION_FAILED: BUGCHECK_ERROR = 99;
pub const SECURITY_INITIALIZATION_FAILED: BUGCHECK_ERROR = 95;
pub const SECURITY_SYSTEM: BUGCHECK_ERROR = 41;
pub const SEM_ALL_ERRORS: THREAD_ERROR_MODE = 0;
pub const SEM_FAILCRITICALERRORS: THREAD_ERROR_MODE = 1;
pub const SEM_NOALIGNMENTFAULTEXCEPT: THREAD_ERROR_MODE = 4;
pub const SEM_NOGPFAULTERRORBOX: THREAD_ERROR_MODE = 2;
pub const SEM_NOOPENFILEERRORBOX: THREAD_ERROR_MODE = 32768;
pub const SERIAL_DRIVER_INTERNAL: BUGCHECK_ERROR = 56;
pub const SESSION1_INITIALIZATION_FAILED: BUGCHECK_ERROR = 109;
pub const SESSION_HAS_VALID_POOL_ON_EXIT: BUGCHECK_ERROR = 171;
pub const SESSION_HAS_VALID_SPECIAL_POOL_ON_EXIT: BUGCHECK_ERROR = 236;
pub const SESSION_HAS_VALID_VIEWS_ON_EXIT: BUGCHECK_ERROR = 186;
pub const SETUP_FAILURE: BUGCHECK_ERROR = 133;
pub const SET_ENV_VAR_FAILED: BUGCHECK_ERROR = 91;
pub const SET_OF_INVALID_CONTEXT: BUGCHECK_ERROR = 48;
pub const SHARED_RESOURCE_CONV_ERROR: BUGCHECK_ERROR = 31;
pub const SILO_CORRUPT: BUGCHECK_ERROR = 394;
pub const SLE_ERROR: RIP_INFO_TYPE = 1;
pub const SLE_MINORERROR: RIP_INFO_TYPE = 2;
pub const SLE_WARNING: RIP_INFO_TYPE = 3;
pub const SLMFLAG_ALT_INDEX: SYM_LOAD_FLAGS = 2;
pub const SLMFLAG_NONE: SYM_LOAD_FLAGS = 0;
pub const SLMFLAG_NO_SYMBOLS: SYM_LOAD_FLAGS = 4;
pub const SLMFLAG_VIRTUAL: SYM_LOAD_FLAGS = 1;
pub const SMB_CLIENT_REQUEST_VALIDATION_FAILURE: BUGCHECK_ERROR = 510;
pub const SMB_REDIRECTOR_LIVEDUMP: BUGCHECK_ERROR = 423;
pub const SMB_SERVER_LIVEDUMP: BUGCHECK_ERROR = 405;
pub const SMB_SRV_REQUEST_VALIDATION_FAILURE: BUGCHECK_ERROR = 506;
pub const SOC_CRITICAL_DEVICE_REMOVED: BUGCHECK_ERROR = 334;
pub const SOC_SUBSYSTEM_FAILURE: BUGCHECK_ERROR = 331;
...
pub const SPECIAL_POOL_DETECTED_MEMORY_CORRUPTION: BUGCHECK_ERROR = 193;
pub const SPIN_LOCK_ALREADY_OWNED: BUGCHECK_ERROR = 15;
pub const SPIN_LOCK_INIT_FAILURE: BUGCHECK_ERROR = 129;
pub const SPIN_LOCK_NOT_OWNED: BUGCHECK_ERROR = 16;
...
pub const SSRVOPT_DWORD: SYM_FIND_ID_OPTION = 2;
pub const SSRVOPT_DWORDPTR: SYM_FIND_ID_OPTION = 4;
...
pub const SSRVOPT_GUIDPTR: SYM_FIND_ID_OPTION = 8;
...
pub const STORAGE_DEVICE_ABNORMALITY_DETECTED: BUGCHECK_ERROR = 320;
pub const STORAGE_DRIVER_LIVEDUMP: BUGCHECK_ERROR = 519;
pub const STORAGE_MINIPORT_ERROR: BUGCHECK_ERROR = 240;
pub const STORAGE_STACK_FATAL_ERROR: BUGCHECK_ERROR = 374;
pub const STORE_DATA_STRUCTURE_CORRUPTION: BUGCHECK_ERROR = 455;
pub const STREAMS_INTERNAL_ERROR: BUGCHECK_ERROR = 75;
...
pub const SYMFLAG_CLR_TOKEN: SYMBOL_INFO_FLAGS = 262144;
pub const SYMFLAG_COMPLEX: u32 = 67108864;
pub const SYMFLAG_CONSTANT: SYMBOL_INFO_FLAGS = 256;
pub const SYMFLAG_EXPORT: SYMBOL_INFO_FLAGS = 512;
pub const SYMFLAG_FIXUP_ARM64X: u32 = 16777216;
pub const SYMFLAG_FORWARDER: SYMBOL_INFO_FLAGS = 1024;
pub const SYMFLAG_FRAMEREL: SYMBOL_INFO_FLAGS = 32;
pub const SYMFLAG_FUNCTION: SYMBOL_INFO_FLAGS = 2048;
pub const SYMFLAG_FUNC_NO_RETURN: u32 = 1048576;
pub const SYMFLAG_GLOBAL: u32 = 33554432;
pub const SYMFLAG_ILREL: SYMBOL_INFO_FLAGS = 65536;
pub const SYMFLAG_LOCAL: SYMBOL_INFO_FLAGS = 128;
pub const SYMFLAG_METADATA: SYMBOL_INFO_FLAGS = 131072;
pub const SYMFLAG_NULL: u32 = 524288;
pub const SYMFLAG_PARAMETER: SYMBOL_INFO_FLAGS = 64;
pub const SYMFLAG_PUBLIC_CODE: u32 = 4194304;
pub const SYMFLAG_REGISTER: SYMBOL_INFO_FLAGS = 8;
pub const SYMFLAG_REGREL: SYMBOL_INFO_FLAGS = 16;
pub const SYMFLAG_REGREL_ALIASINDIR: u32 = 8388608;
pub const SYMFLAG_RESET: u32 = 2147483648;
pub const SYMFLAG_SLOT: SYMBOL_INFO_FLAGS = 32768;
pub const SYMFLAG_SYNTHETIC_ZEROBASE: u32 = 2097152;
pub const SYMFLAG_THUNK: SYMBOL_INFO_FLAGS = 8192;
pub const SYMFLAG_TLSREL: SYMBOL_INFO_FLAGS = 16384;
pub const SYMFLAG_VALUEPRESENT: SYMBOL_INFO_FLAGS = 1;
pub const SYMFLAG_VIRTUAL: SYMBOL_INFO_FLAGS = 4096;
...
pub const SYMOPT_EX_MAX: IMAGEHLP_EXTENDED_OPTIONS = 4;
...
pub const SYMSTOREOPT_COMPRESS: SYM_SRV_STORE_FILE_FLAGS = 1;
pub const SYMSTOREOPT_OVERWRITE: SYM_SRV_STORE_FILE_FLAGS = 2;
pub const SYMSTOREOPT_PASS_IF_EXISTS: SYM_SRV_STORE_FILE_FLAGS = 64;
pub const SYMSTOREOPT_POINTER: SYM_SRV_STORE_FILE_FLAGS = 8;
pub const SYMSTOREOPT_RETURNINDEX: SYM_SRV_STORE_FILE_FLAGS = 4;
...
pub const SYNTHETIC_EXCEPTION_UNHANDLED: BUGCHECK_ERROR = 399;
pub const SYNTHETIC_WATCHDOG_TIMEOUT: BUGCHECK_ERROR = 458;
pub const SYSTEM_EXIT_OWNED_MUTEX: BUGCHECK_ERROR = 57;
pub const SYSTEM_IMAGE_BAD_SIGNATURE: BUGCHECK_ERROR = 195;
pub const SYSTEM_LICENSE_VIOLATION: BUGCHECK_ERROR = 154;
pub const SYSTEM_PTE_MISUSE: BUGCHECK_ERROR = 218;
pub const SYSTEM_SCAN_AT_RAISED_IRQL_CAUGHT_IMPROPER_DRIVER_UNLOAD: BUGCHECK_ERROR = 212;
pub const SYSTEM_SERVICE_EXCEPTION: BUGCHECK_ERROR = 59;
pub const SYSTEM_THREAD_EXCEPTION_NOT_HANDLED: BUGCHECK_ERROR = 126;
pub const SYSTEM_THREAD_EXCEPTION_NOT_HANDLED_M: BUGCHECK_ERROR = 268435582;
pub const SYSTEM_UNWIND_PREVIOUS_USER: BUGCHECK_ERROR = 58;
...
pub const TARGET_MDL_TOO_SMALL: BUGCHECK_ERROR = 64;
pub const TCPIP_AOAC_NIC_ACTIVE_REFERENCE_LEAK: BUGCHECK_ERROR = 336;
pub const TELEMETRY_ASSERTS_LIVEDUMP: BUGCHECK_ERROR = 465;
pub const TERMINAL_SERVER_DRIVER_MADE_INCORRECT_MEMORY_REFERENCE: BUGCHECK_ERROR = 207;
pub const THIRD_PARTY_FILE_SYSTEM_FAILURE: BUGCHECK_ERROR = 264;
pub type THREAD_ERROR_MODE = u32;
pub const THREAD_NOT_MUTEX_OWNER: BUGCHECK_ERROR = 17;
pub const THREAD_STUCK_IN_DEVICE_DRIVER: BUGCHECK_ERROR = 234;
pub const THREAD_STUCK_IN_DEVICE_DRIVER_M: BUGCHECK_ERROR = 268435690;
pub const THREAD_TERMINATE_HELD_MUTEX: BUGCHECK_ERROR = 1073741962;
...
pub const TOO_MANY_RECURSIVE_FAULTS: BUGCHECK_ERROR = 286;
pub const TRAP_CAUSE_UNKNOWN: BUGCHECK_ERROR = 18;
pub const TTM_FATAL_ERROR: BUGCHECK_ERROR = 411;
pub const TTM_WATCHDOG_TIMEOUT: BUGCHECK_ERROR = 416;
...
pub const UCMUCSI_FAILURE: BUGCHECK_ERROR = 472;
pub const UCMUCSI_LIVEDUMP: BUGCHECK_ERROR = 468;
pub const UDFS_FILE_SYSTEM: BUGCHECK_ERROR = 155;
pub const UFX_LIVEDUMP: BUGCHECK_ERROR = 408;
...
pub const UNEXPECTED_CODEPATH: BUGCHECK_ERROR = 514;
pub const UNEXPECTED_INITIALIZATION_CALL: BUGCHECK_ERROR = 51;
pub const UNEXPECTED_KERNEL_MODE_TRAP: BUGCHECK_ERROR = 127;
pub const UNEXPECTED_KERNEL_MODE_TRAP_M: BUGCHECK_ERROR = 268435583;
...
pub const UNMOUNTABLE_BOOT_VOLUME: BUGCHECK_ERROR = 237;
pub const UNSUPPORTED_INSTRUCTION_MODE: BUGCHECK_ERROR = 337;
...
pub const UNWIND_ON_INVALID_STACK: BUGCHECK_ERROR = 427;
pub const UNW_FLAG_CHAININFO: RTL_VIRTUAL_UNWIND_HANDLER_TYPE = 4;
pub const UNW_FLAG_EHANDLER: RTL_VIRTUAL_UNWIND_HANDLER_TYPE = 1;
pub const UNW_FLAG_NHANDLER: RTL_VIRTUAL_UNWIND_HANDLER_TYPE = 0;
pub const UNW_FLAG_UHANDLER: RTL_VIRTUAL_UNWIND_HANDLER_TYPE = 2;
pub const UP_DRIVER_ON_MP_SYSTEM: BUGCHECK_ERROR = 146;
pub const USB4_HARDWARE_VIOLATION: BUGCHECK_ERROR = 496;
pub const USB_DRIPS_BLOCKER_SURPRISE_REMOVAL_LIVEDUMP: BUGCHECK_ERROR = 421;
pub const USER_MODE_HEALTH_MONITOR: BUGCHECK_ERROR = 158;
pub const USER_MODE_HEALTH_MONITOR_LIVEDUMP: BUGCHECK_ERROR = 457;
...
pub const VER_PLATFORM_WIN32_NT: VER_PLATFORM = 2;
pub const VER_PLATFORM_WIN32_WINDOWS: VER_PLATFORM = 1;
pub const VER_PLATFORM_WIN32s: VER_PLATFORM = 0;
pub const VHD_BOOT_HOST_VOLUME_NOT_ENOUGH_SPACE: BUGCHECK_ERROR = 310;
pub const VHD_BOOT_INITIALIZATION_FAILED: BUGCHECK_ERROR = 303;
pub const VIDEO_DRIVER_DEBUG_REPORT_REQUEST: BUGCHECK_ERROR = 1073741997;
pub const VIDEO_DRIVER_INIT_FAILURE: BUGCHECK_ERROR = 180;
pub const VIDEO_DWMINIT_TIMEOUT_FALLBACK_BDD: BUGCHECK_ERROR = 391;
pub const VIDEO_DXGKRNL_BLACK_SCREEN_LIVEDUMP: BUGCHECK_ERROR = 424;
pub const VIDEO_DXGKRNL_FATAL_ERROR: BUGCHECK_ERROR = 275;
pub const VIDEO_DXGKRNL_LIVEDUMP: BUGCHECK_ERROR = 403;
pub const VIDEO_DXGKRNL_SYSMM_FATAL_ERROR: BUGCHECK_ERROR = 484;
pub const VIDEO_ENGINE_TIMEOUT_DETECTED: BUGCHECK_ERROR = 321;
pub const VIDEO_MEMORY_MANAGEMENT_INTERNAL: BUGCHECK_ERROR = 270;
pub const VIDEO_MINIPORT_BLACK_SCREEN_LIVEDUMP: BUGCHECK_ERROR = 440;
pub const VIDEO_MINIPORT_FAILED_LIVEDUMP: BUGCHECK_ERROR = 432;
pub const VIDEO_SCHEDULER_INTERNAL_ERROR: BUGCHECK_ERROR = 281;
pub const VIDEO_SHADOW_DRIVER_FATAL_ERROR: BUGCHECK_ERROR = 276;
pub const VIDEO_TDR_APPLICATION_BLOCKED: BUGCHECK_ERROR = 322;
pub const VIDEO_TDR_FAILURE: BUGCHECK_ERROR = 278;
pub const VIDEO_TDR_TIMEOUT_DETECTED: BUGCHECK_ERROR = 279;
pub const VMBUS_LIVEDUMP: BUGCHECK_ERROR = 1073742319;
pub const VOLMGRX_INTERNAL_ERROR: BUGCHECK_ERROR = 88;
pub const VOLSNAP_OVERLAPPED_TABLE_ACCESS: BUGCHECK_ERROR = 301;
pub const VSL_INITIALIZATION_FAILED: BUGCHECK_ERROR = 111;
...
pub const WCT_ASYNC_OPEN_FLAG: OPEN_THREAD_WAIT_CHAIN_SESSION_FLAGS = 1;
...
pub const WCT_OUT_OF_PROC_COM_FLAG: WAIT_CHAIN_THREAD_OPTIONS = 2;
pub const WCT_OUT_OF_PROC_CS_FLAG: WAIT_CHAIN_THREAD_OPTIONS = 4;
pub const WCT_OUT_OF_PROC_FLAG: WAIT_CHAIN_THREAD_OPTIONS = 1;
pub const WDF_VIOLATION: BUGCHECK_ERROR = 269;
pub const WFP_INVALID_OPERATION: BUGCHECK_ERROR = 467;
#[repr(C, packed(1))]
#[derive(Clone, Copy)]
...
pub const WHEA_INTERNAL_ERROR: BUGCHECK_ERROR = 290;
#[repr(C, packed(1))]
#[derive(Clone, Copy, Default)]
...
pub const WHEA_UNCORRECTABLE_ERROR: BUGCHECK_ERROR = 292;
#[repr(C, packed(1))]
#[derive(Clone, Copy)]
...
pub const WIN32K_ATOMIC_CHECK_FAILURE: BUGCHECK_ERROR = 352;
pub const WIN32K_CALLOUT_UNREGISTER_FAILED: BUGCHECK_ERROR = 508;
pub const WIN32K_CALLOUT_WATCHDOG_BUGCHECK: BUGCHECK_ERROR = 418;
pub const WIN32K_CALLOUT_WATCHDOG_LIVEDUMP: BUGCHECK_ERROR = 417;
pub const WIN32K_CRITICAL_FAILURE: BUGCHECK_ERROR = 356;
pub const WIN32K_CRITICAL_FAILURE_LIVEDUMP: BUGCHECK_ERROR = 400;
pub const WIN32K_HANDLE_MANAGER: BUGCHECK_ERROR = 311;
pub const WIN32K_INIT_OR_RIT_FAILURE: BUGCHECK_ERROR = 145;
pub const WIN32K_POWER_WATCHDOG_TIMEOUT: BUGCHECK_ERROR = 412;
pub const WIN32K_SECURITY_FAILURE: BUGCHECK_ERROR = 407;
pub const WINDOWS_NT_BANNER: BUGCHECK_ERROR = 1073741950;
pub const WINDOWS_NT_CSD_STRING: BUGCHECK_ERROR = 1073741959;
pub const WINDOWS_NT_INFO_STRING: BUGCHECK_ERROR = 1073741960;
pub const WINDOWS_NT_INFO_STRING_PLURAL: BUGCHECK_ERROR = 1073741981;
pub const WINDOWS_NT_MP_STRING: BUGCHECK_ERROR = 1073741961;
pub const WINDOWS_NT_RC_STRING: BUGCHECK_ERROR = 1073741982;
pub const WINLOGON_FATAL_ERROR: BUGCHECK_ERROR = 3221226010;
pub const WINSOCK_DETECTED_HUNG_CLOSESOCKET_LIVEDUMP: BUGCHECK_ERROR = 342;
pub const WORKER_INVALID: BUGCHECK_ERROR = 228;
pub const WORKER_THREAD_INVALID_STATE: BUGCHECK_ERROR = 466;
pub const WORKER_THREAD_RETURNED_AT_BAD_IRQL: BUGCHECK_ERROR = 225;
pub const WORKER_THREAD_RETURNED_WHILE_ATTACHED_TO_SILO: BUGCHECK_ERROR = 410;
pub const WORKER_THREAD_RETURNED_WITH_BAD_IO_PRIORITY: BUGCHECK_ERROR = 296;
pub const WORKER_THREAD_RETURNED_WITH_BAD_PAGING_IO_PRIORITY: BUGCHECK_ERROR = 297;
pub const WORKER_THREAD_RETURNED_WITH_NON_DEFAULT_WORKLOAD_CLASS: BUGCHECK_ERROR = 470;
...
pub const WOW64_CONTEXT_ALL: WOW64_CONTEXT_FLAGS = 65599;
pub const WOW64_CONTEXT_CONTROL: WOW64_CONTEXT_FLAGS = 65537;
pub const WOW64_CONTEXT_DEBUG_REGISTERS: WOW64_CONTEXT_FLAGS = 65552;
pub const WOW64_CONTEXT_EXCEPTION_ACTIVE: WOW64_CONTEXT_FLAGS = 134217728;
pub const WOW64_CONTEXT_EXCEPTION_REPORTING: WOW64_CONTEXT_FLAGS = 2147483648;
pub const WOW64_CONTEXT_EXCEPTION_REQUEST: WOW64_CONTEXT_FLAGS = 1073741824;
pub const WOW64_CONTEXT_EXTENDED_REGISTERS: WOW64_CONTEXT_FLAGS = 65568;
pub type WOW64_CONTEXT_FLAGS = u32;
pub const WOW64_CONTEXT_FLOATING_POINT: WOW64_CONTEXT_FLAGS = 65544;
pub const WOW64_CONTEXT_FULL: WOW64_CONTEXT_FLAGS = 65543;
pub const WOW64_CONTEXT_INTEGER: WOW64_CONTEXT_FLAGS = 65538;
pub const WOW64_CONTEXT_SEGMENTS: WOW64_CONTEXT_FLAGS = 65540;
pub const WOW64_CONTEXT_SERVICE_ACTIVE: WOW64_CONTEXT_FLAGS = 268435456;
pub const WOW64_CONTEXT_X86: WOW64_CONTEXT_FLAGS = 65536;
pub const WOW64_CONTEXT_XSTATE: WOW64_CONTEXT_FLAGS = 65600;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const WVR_LIVEDUMP_APP_IO_TIMEOUT: BUGCHECK_ERROR = 387;
pub const WVR_LIVEDUMP_CRITICAL_ERROR: BUGCHECK_ERROR = 390;
pub const WVR_LIVEDUMP_MANUALLY_INITIATED: BUGCHECK_ERROR = 388;
pub const WVR_LIVEDUMP_RECOVERY_IOCONTEXT_TIMEOUT: BUGCHECK_ERROR = 386;
pub const WVR_LIVEDUMP_REPLICATION_IOCONTEXT_TIMEOUT: BUGCHECK_ERROR = 384;
pub const WVR_LIVEDUMP_STATE_FAILURE: BUGCHECK_ERROR = 389;
pub const WVR_LIVEDUMP_STATE_TRANSITION_TIMEOUT: BUGCHECK_ERROR = 385;
...
pub const XBOX_360_SYSTEM_CRASH: BUGCHECK_ERROR = 864;
pub const XBOX_360_SYSTEM_CRASH_RESERVED: BUGCHECK_ERROR = 1056;
pub const XBOX_CANNOT_MANAGE_PARTITION_MEMORY: BUGCHECK_ERROR = 861;
pub const XBOX_CORRUPTED_IMAGE: BUGCHECK_ERROR = 855;
pub const XBOX_CORRUPTED_IMAGE_BASE: BUGCHECK_ERROR = 857;
pub const XBOX_INVERTED_FUNCTION_TABLE_OVERFLOW: BUGCHECK_ERROR = 856;
pub const XBOX_MANUALLY_INITIATED_CRASH: BUGCHECK_ERROR = 196614;
pub const XBOX_SECURITY_FAILUE: BUGCHECK_ERROR = 1057;
pub const XBOX_SHUTDOWN_WATCHDOG_TIMEOUT: BUGCHECK_ERROR = 859;
pub const XBOX_VMCTRL_CS_TIMEOUT: BUGCHECK_ERROR = 854;
pub const XBOX_XDS_WATCHDOG_TIMEOUT: BUGCHECK_ERROR = 858;
pub const XNS_INTERNAL_ERROR: BUGCHECK_ERROR = 87;
#[repr(C, packed(1))]
#[derive(Clone, Copy)]
...
pub const sevAttn: IMAGEHLP_CBA_EVENT_SEVERITY = 2;
pub const sevFatal: IMAGEHLP_CBA_EVENT_SEVERITY = 3;
pub const sevInfo: IMAGEHLP_CBA_EVENT_SEVERITY = 0;
pub const sevMax: i32 = 4;
pub const sevProblem: IMAGEHLP_CBA_EVENT_SEVERITY = 1;
