...
windows_targets::link!("dbghelp.dll" "system" fn SymGetHomeDirectory(r#type : IMAGEHLP_HD_TYPE, dir : windows_sys::core::PSTR, size : usize) -> windows_sys::core::PSTR);
windows_targets::link!("dbghelp.dll" "system" fn SymGetHomeDirectoryW(r#type : IMAGEHLP_HD_TYPE, dir : windows_sys::core::PWSTR, size : usize) -> windows_sys::core::PWSTR);
#[cfg(target_arch = "x86")]
