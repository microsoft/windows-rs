windows_link::link!("ntdll.dll" "system" fn RtlFirstEntrySList(listhead : *mut SLIST_HEADER) -> *mut SLIST_ENTRY);
...
windows_link::link!("ntdll.dll" "system" fn RtlQueryDepthSList(listhead : *mut SLIST_HEADER) -> u16);
