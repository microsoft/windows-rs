...
windows_link::link!("ualapi.dll" "system" fn UalInstrument(data : *mut UAL_DATA_BLOB) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("ualapi.dll" "system" fn UalStart(data : *mut UAL_DATA_BLOB) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("ualapi.dll" "system" fn UalStop(data : *mut UAL_DATA_BLOB) -> windows_sys::core::HRESULT);
#[repr(C)]
#[cfg(feature = "Win32_Networking_WinSock")]
#[derive(Clone, Copy)]
