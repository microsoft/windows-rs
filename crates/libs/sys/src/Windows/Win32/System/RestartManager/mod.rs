pub type RmAddFilter = unsafe extern "system" fn(dwsessionhandle: u32, strmodulename: windows_sys::core::PCWSTR, pprocess: *const RM_UNIQUE_PROCESS, strserviceshortname: windows_sys::core::PCWSTR, filteraction: RM_FILTER_ACTION) -> super::super::Foundation::WIN32_ERROR;
...
pub type RmCancelCurrentTask = unsafe extern "system" fn(dwsessionhandle: u32) -> super::super::Foundation::WIN32_ERROR;
windows_link::link!("rstrtmgr.dll" "system" fn RmCancelCurrentTask(dwsessionhandle : u32) -> super::super::Foundation::WIN32_ERROR);
pub type RmEndSession = unsafe extern "system" fn(dwsessionhandle: u32) -> super::super::Foundation::WIN32_ERROR;
windows_link::link!("rstrtmgr.dll" "system" fn RmEndSession(dwsessionhandle : u32) -> super::super::Foundation::WIN32_ERROR);
pub type RmGetFilterList = unsafe extern "system" fn(dwsessionhandle: u32, pbfilterbuf: *mut u8, cbfilterbuf: u32, cbfilterbufneeded: *mut u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RmGetList = unsafe extern "system" fn(dwsessionhandle: u32, pnprocinfoneeded: *mut u32, pnprocinfo: *mut u32, rgaffectedapps: *mut RM_PROCESS_INFO, lpdwrebootreasons: *mut u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RmJoinSession = unsafe extern "system" fn(psessionhandle: *mut u32, strsessionkey: windows_sys::core::PCWSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RmRegisterResources = unsafe extern "system" fn(dwsessionhandle: u32, nfiles: u32, rgsfilenames: *const windows_sys::core::PCWSTR, napplications: u32, rgapplications: *const RM_UNIQUE_PROCESS, nservices: u32, rgsservicenames: *const windows_sys::core::PCWSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RmRemoveFilter = unsafe extern "system" fn(dwsessionhandle: u32, strmodulename: windows_sys::core::PCWSTR, pprocess: *const RM_UNIQUE_PROCESS, strserviceshortname: windows_sys::core::PCWSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RmRestart = unsafe extern "system" fn(dwsessionhandle: u32, dwrestartflags: u32, fnstatus: RM_WRITE_STATUS_CALLBACK) -> super::super::Foundation::WIN32_ERROR;
...
pub type RmShutdown = unsafe extern "system" fn(dwsessionhandle: u32, lactionflags: u32, fnstatus: RM_WRITE_STATUS_CALLBACK) -> super::super::Foundation::WIN32_ERROR;
...
pub type RmStartSession = unsafe extern "system" fn(psessionhandle: *mut u32, dwsessionflags: u32, strsessionkey: windows_sys::core::PWSTR) -> super::super::Foundation::WIN32_ERROR;
