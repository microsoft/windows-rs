...
::windows_sys::core::windows_link ! ( "rstrtmgr.dll" ,"system" fn RmAddFilter ( dwsessionhandle : u32 , strmodulename : :: windows_sys::core::PCWSTR , pprocess : *const RM_UNIQUE_PROCESS , strserviceshortname : :: windows_sys::core::PCWSTR , filteraction : RM_FILTER_ACTION ) -> u32 );
::windows_sys::core::windows_link ! ( "rstrtmgr.dll" ,"system" fn RmCancelCurrentTask ( dwsessionhandle : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "rstrtmgr.dll" ,"system" fn RmEndSession ( dwsessionhandle : u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "rstrtmgr.dll" ,"system" fn RmGetFilterList ( dwsessionhandle : u32 , pbfilterbuf : *mut u8 , cbfilterbuf : u32 , cbfilterbufneeded : *mut u32 ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "rstrtmgr.dll" ,"system" fn RmGetList ( dwsessionhandle : u32 , pnprocinfoneeded : *mut u32 , pnprocinfo : *mut u32 , rgaffectedapps : *mut RM_PROCESS_INFO , lpdwrebootreasons : *mut u32 ) -> u32 );
::windows_sys::core::windows_link ! ( "rstrtmgr.dll" ,"system" fn RmJoinSession ( psessionhandle : *mut u32 , strsessionkey : :: windows_sys::core::PCWSTR ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "rstrtmgr.dll" ,"system" fn RmRegisterResources ( dwsessionhandle : u32 , nfiles : u32 , rgsfilenames : *const :: windows_sys::core::PWSTR , napplications : u32 , rgapplications : *const RM_UNIQUE_PROCESS , nservices : u32 , rgsservicenames : *const :: windows_sys::core::PWSTR ) -> u32 );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "rstrtmgr.dll" ,"system" fn RmRemoveFilter ( dwsessionhandle : u32 , strmodulename : :: windows_sys::core::PCWSTR , pprocess : *const RM_UNIQUE_PROCESS , strserviceshortname : :: windows_sys::core::PCWSTR ) -> u32 );
::windows_sys::core::windows_link ! ( "rstrtmgr.dll" ,"system" fn RmRestart ( dwsessionhandle : u32 , dwrestartflags : u32 , fnstatus : RM_WRITE_STATUS_CALLBACK ) -> u32 );
::windows_sys::core::windows_link ! ( "rstrtmgr.dll" ,"system" fn RmShutdown ( dwsessionhandle : u32 , lactionflags : u32 , fnstatus : RM_WRITE_STATUS_CALLBACK ) -> u32 );
::windows_sys::core::windows_link ! ( "rstrtmgr.dll" ,"system" fn RmStartSession ( psessionhandle : *mut u32 , dwsessionflags : u32 , strsessionkey : :: windows_sys::core::PWSTR ) -> u32 );
