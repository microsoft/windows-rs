pub type ActivateActCtx = unsafe extern "system" fn(hactctx: super::super::Foundation::HANDLE, lpcookie: *mut usize) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn ActivateActCtx(hactctx : super::super::Foundation::HANDLE, lpcookie : *mut usize) -> windows_sys::core::BOOL);
pub type AddRefActCtx = unsafe extern "system" fn(hactctx: super::super::Foundation::HANDLE);
windows_link::link!("kernel32.dll" "system" fn AddRefActCtx(hactctx : super::super::Foundation::HANDLE));
pub type ApplyDeltaA = unsafe extern "system" fn(applyflags: i64, lpsourcename: windows_sys::core::PCSTR, lpdeltaname: windows_sys::core::PCSTR, lptargetname: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
windows_link::link!("msdelta.dll" "system" fn ApplyDeltaA(applyflags : i64, lpsourcename : windows_sys::core::PCSTR, lpdeltaname : windows_sys::core::PCSTR, lptargetname : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
pub type ApplyDeltaB = unsafe extern "system" fn(applyflags: i64, source: DELTA_INPUT, delta: DELTA_INPUT, lptarget: *mut DELTA_OUTPUT) -> windows_sys::core::BOOL;
windows_link::link!("msdelta.dll" "system" fn ApplyDeltaB(applyflags : i64, source : DELTA_INPUT, delta : DELTA_INPUT, lptarget : *mut DELTA_OUTPUT) -> windows_sys::core::BOOL);
pub type ApplyDeltaGetReverseB = unsafe extern "system" fn(applyflags: i64, source: DELTA_INPUT, delta: DELTA_INPUT, lpreversefiletime: *const super::super::Foundation::FILETIME, lptarget: *mut DELTA_OUTPUT, lptargetreverse: *mut DELTA_OUTPUT) -> windows_sys::core::BOOL;
windows_link::link!("msdelta.dll" "system" fn ApplyDeltaGetReverseB(applyflags : i64, source : DELTA_INPUT, delta : DELTA_INPUT, lpreversefiletime : *const super::super::Foundation::FILETIME, lptarget : *mut DELTA_OUTPUT, lptargetreverse : *mut DELTA_OUTPUT) -> windows_sys::core::BOOL);
pub type ApplyDeltaProvidedB = unsafe extern "system" fn(applyflags: i64, source: DELTA_INPUT, delta: DELTA_INPUT, lptarget: *mut core::ffi::c_void, utargetsize: usize) -> windows_sys::core::BOOL;
windows_link::link!("msdelta.dll" "system" fn ApplyDeltaProvidedB(applyflags : i64, source : DELTA_INPUT, delta : DELTA_INPUT, lptarget : *mut core::ffi::c_void, utargetsize : usize) -> windows_sys::core::BOOL);
pub type ApplyDeltaW = unsafe extern "system" fn(applyflags: i64, lpsourcename: windows_sys::core::PCWSTR, lpdeltaname: windows_sys::core::PCWSTR, lptargetname: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
windows_link::link!("msdelta.dll" "system" fn ApplyDeltaW(applyflags : i64, lpsourcename : windows_sys::core::PCWSTR, lpdeltaname : windows_sys::core::PCWSTR, lptargetname : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
pub type ApplyPatchToFileA = unsafe extern "system" fn(patchfilename: windows_sys::core::PCSTR, oldfilename: windows_sys::core::PCSTR, newfilename: windows_sys::core::PCSTR, applyoptionflags: u32) -> windows_sys::core::BOOL;
...
pub type ApplyPatchToFileByHandles = unsafe extern "system" fn(patchfilehandle: super::super::Foundation::HANDLE, oldfilehandle: super::super::Foundation::HANDLE, newfilehandle: super::super::Foundation::HANDLE, applyoptionflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("mspatcha.dll" "system" fn ApplyPatchToFileByHandles(patchfilehandle : super::super::Foundation::HANDLE, oldfilehandle : super::super::Foundation::HANDLE, newfilehandle : super::super::Foundation::HANDLE, applyoptionflags : u32) -> windows_sys::core::BOOL);
pub type ApplyPatchToFileByHandlesEx = unsafe extern "system" fn(patchfilehandle: super::super::Foundation::HANDLE, oldfilehandle: super::super::Foundation::HANDLE, newfilehandle: super::super::Foundation::HANDLE, applyoptionflags: u32, progresscallback: PPATCH_PROGRESS_CALLBACK, callbackcontext: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type ApplyPatchToFileExA = unsafe extern "system" fn(patchfilename: windows_sys::core::PCSTR, oldfilename: windows_sys::core::PCSTR, newfilename: windows_sys::core::PCSTR, applyoptionflags: u32, progresscallback: PPATCH_PROGRESS_CALLBACK, callbackcontext: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type ApplyPatchToFileExW = unsafe extern "system" fn(patchfilename: windows_sys::core::PCWSTR, oldfilename: windows_sys::core::PCWSTR, newfilename: windows_sys::core::PCWSTR, applyoptionflags: u32, progresscallback: PPATCH_PROGRESS_CALLBACK, callbackcontext: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type ApplyPatchToFileW = unsafe extern "system" fn(patchfilename: windows_sys::core::PCWSTR, oldfilename: windows_sys::core::PCWSTR, newfilename: windows_sys::core::PCWSTR, applyoptionflags: u32) -> windows_sys::core::BOOL;
...
pub type CreateActCtxA = unsafe extern "system" fn(pactctx: *const ACTCTXA) -> super::super::Foundation::HANDLE;
windows_link::link!("kernel32.dll" "system" fn CreateActCtxA(pactctx : *const ACTCTXA) -> super::super::Foundation::HANDLE);
pub type CreateActCtxW = unsafe extern "system" fn(pactctx: *const ACTCTXW) -> super::super::Foundation::HANDLE;
windows_link::link!("kernel32.dll" "system" fn CreateActCtxW(pactctx : *const ACTCTXW) -> super::super::Foundation::HANDLE);
#[cfg(feature = "Win32_Security_Cryptography")]
pub type CreateDeltaA = unsafe extern "system" fn(filetypeset: i64, setflags: i64, resetflags: i64, lpsourcename: windows_sys::core::PCSTR, lptargetname: windows_sys::core::PCSTR, lpsourceoptionsname: windows_sys::core::PCSTR, lptargetoptionsname: windows_sys::core::PCSTR, globaloptions: DELTA_INPUT, lptargetfiletime: *const super::super::Foundation::FILETIME, hashalgid: super::super::Security::Cryptography::ALG_ID, lpdeltaname: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Security_Cryptography")]
windows_link::link!("msdelta.dll" "system" fn CreateDeltaA(filetypeset : i64, setflags : i64, resetflags : i64, lpsourcename : windows_sys::core::PCSTR, lptargetname : windows_sys::core::PCSTR, lpsourceoptionsname : windows_sys::core::PCSTR, lptargetoptionsname : windows_sys::core::PCSTR, globaloptions : DELTA_INPUT, lptargetfiletime : *const super::super::Foundation::FILETIME, hashalgid : super::super::Security::Cryptography::ALG_ID, lpdeltaname : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Security_Cryptography")]
pub type CreateDeltaB = unsafe extern "system" fn(filetypeset: i64, setflags: i64, resetflags: i64, source: DELTA_INPUT, target: DELTA_INPUT, sourceoptions: DELTA_INPUT, targetoptions: DELTA_INPUT, globaloptions: DELTA_INPUT, lptargetfiletime: *const super::super::Foundation::FILETIME, hashalgid: super::super::Security::Cryptography::ALG_ID, lpdelta: *mut DELTA_OUTPUT) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Security_Cryptography")]
...
#[cfg(feature = "Win32_Security_Cryptography")]
pub type CreateDeltaW = unsafe extern "system" fn(filetypeset: i64, setflags: i64, resetflags: i64, lpsourcename: windows_sys::core::PCWSTR, lptargetname: windows_sys::core::PCWSTR, lpsourceoptionsname: windows_sys::core::PCWSTR, lptargetoptionsname: windows_sys::core::PCWSTR, globaloptions: DELTA_INPUT, lptargetfiletime: *const super::super::Foundation::FILETIME, hashalgid: super::super::Security::Cryptography::ALG_ID, lpdeltaname: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Security_Cryptography")]
windows_link::link!("msdelta.dll" "system" fn CreateDeltaW(filetypeset : i64, setflags : i64, resetflags : i64, lpsourcename : windows_sys::core::PCWSTR, lptargetname : windows_sys::core::PCWSTR, lpsourceoptionsname : windows_sys::core::PCWSTR, lptargetoptionsname : windows_sys::core::PCWSTR, globaloptions : DELTA_INPUT, lptargetfiletime : *const super::super::Foundation::FILETIME, hashalgid : super::super::Security::Cryptography::ALG_ID, lpdeltaname : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
pub type CreatePatchFileA = unsafe extern "system" fn(oldfilename: windows_sys::core::PCSTR, newfilename: windows_sys::core::PCSTR, patchfilename: windows_sys::core::PCSTR, optionflags: u32, optiondata: *const PATCH_OPTION_DATA) -> windows_sys::core::BOOL;
...
pub type CreatePatchFileByHandles = unsafe extern "system" fn(oldfilehandle: super::super::Foundation::HANDLE, newfilehandle: super::super::Foundation::HANDLE, patchfilehandle: super::super::Foundation::HANDLE, optionflags: u32, optiondata: *const PATCH_OPTION_DATA) -> windows_sys::core::BOOL;
windows_link::link!("mspatchc.dll" "system" fn CreatePatchFileByHandles(oldfilehandle : super::super::Foundation::HANDLE, newfilehandle : super::super::Foundation::HANDLE, patchfilehandle : super::super::Foundation::HANDLE, optionflags : u32, optiondata : *const PATCH_OPTION_DATA) -> windows_sys::core::BOOL);
pub type CreatePatchFileByHandlesEx = unsafe extern "system" fn(oldfilecount: u32, oldfileinfoarray: *const PATCH_OLD_FILE_INFO_H, newfilehandle: super::super::Foundation::HANDLE, patchfilehandle: super::super::Foundation::HANDLE, optionflags: u32, optiondata: *const PATCH_OPTION_DATA, progresscallback: PPATCH_PROGRESS_CALLBACK, callbackcontext: *const core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("mspatchc.dll" "system" fn CreatePatchFileByHandlesEx(oldfilecount : u32, oldfileinfoarray : *const PATCH_OLD_FILE_INFO_H, newfilehandle : super::super::Foundation::HANDLE, patchfilehandle : super::super::Foundation::HANDLE, optionflags : u32, optiondata : *const PATCH_OPTION_DATA, progresscallback : PPATCH_PROGRESS_CALLBACK, callbackcontext : *const core::ffi::c_void) -> windows_sys::core::BOOL);
pub type CreatePatchFileExA = unsafe extern "system" fn(oldfilecount: u32, oldfileinfoarray: *const PATCH_OLD_FILE_INFO_A, newfilename: windows_sys::core::PCSTR, patchfilename: windows_sys::core::PCSTR, optionflags: u32, optiondata: *const PATCH_OPTION_DATA, progresscallback: PPATCH_PROGRESS_CALLBACK, callbackcontext: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type CreatePatchFileExW = unsafe extern "system" fn(oldfilecount: u32, oldfileinfoarray: *const PATCH_OLD_FILE_INFO_W, newfilename: windows_sys::core::PCWSTR, patchfilename: windows_sys::core::PCWSTR, optionflags: u32, optiondata: *const PATCH_OPTION_DATA, progresscallback: PPATCH_PROGRESS_CALLBACK, callbackcontext: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type CreatePatchFileW = unsafe extern "system" fn(oldfilename: windows_sys::core::PCWSTR, newfilename: windows_sys::core::PCWSTR, patchfilename: windows_sys::core::PCWSTR, optionflags: u32, optiondata: *const PATCH_OPTION_DATA) -> windows_sys::core::BOOL;
...
pub type DeactivateActCtx = unsafe extern "system" fn(dwflags: u32, ulcookie: usize) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn DeactivateActCtx(dwflags : u32, ulcookie : usize) -> windows_sys::core::BOOL);
pub type DeltaFree = unsafe extern "system" fn(lpmemory: *const core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("msdelta.dll" "system" fn DeltaFree(lpmemory : *const core::ffi::c_void) -> windows_sys::core::BOOL);
pub type DeltaNormalizeProvidedB = unsafe extern "system" fn(filetypeset: i64, normalizeflags: i64, normalizeoptions: DELTA_INPUT, lpsource: *mut core::ffi::c_void, usourcesize: usize) -> windows_sys::core::BOOL;
windows_link::link!("msdelta.dll" "system" fn DeltaNormalizeProvidedB(filetypeset : i64, normalizeflags : i64, normalizeoptions : DELTA_INPUT, lpsource : *mut core::ffi::c_void, usourcesize : usize) -> windows_sys::core::BOOL);
pub type ExtractPatchHeaderToFileA = unsafe extern "system" fn(patchfilename: windows_sys::core::PCSTR, patchheaderfilename: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type ExtractPatchHeaderToFileByHandles = unsafe extern "system" fn(patchfilehandle: super::super::Foundation::HANDLE, patchheaderfilehandle: super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("mspatchc.dll" "system" fn ExtractPatchHeaderToFileByHandles(patchfilehandle : super::super::Foundation::HANDLE, patchheaderfilehandle : super::super::Foundation::HANDLE) -> windows_sys::core::BOOL);
pub type ExtractPatchHeaderToFileW = unsafe extern "system" fn(patchfilename: windows_sys::core::PCWSTR, patchheaderfilename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type FindActCtxSectionGuid = unsafe extern "system" fn(dwflags: u32, lpextensionguid: *const windows_sys::core::GUID, ulsectionid: u32, lpguidtofind: *const windows_sys::core::GUID, returneddata: *mut ACTCTX_SECTION_KEYED_DATA) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_System_WindowsProgramming")]
...
#[cfg(feature = "Win32_System_WindowsProgramming")]
pub type FindActCtxSectionStringA = unsafe extern "system" fn(dwflags: u32, lpextensionguid: *const windows_sys::core::GUID, ulsectionid: u32, lpstringtofind: windows_sys::core::PCSTR, returneddata: *mut ACTCTX_SECTION_KEYED_DATA) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_System_WindowsProgramming")]
...
#[cfg(feature = "Win32_System_WindowsProgramming")]
pub type FindActCtxSectionStringW = unsafe extern "system" fn(dwflags: u32, lpextensionguid: *const windows_sys::core::GUID, ulsectionid: u32, lpstringtofind: windows_sys::core::PCWSTR, returneddata: *mut ACTCTX_SECTION_KEYED_DATA) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_System_WindowsProgramming")]
...
pub type GetCurrentActCtx = unsafe extern "system" fn(lphactctx: *mut super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn GetCurrentActCtx(lphactctx : *mut super::super::Foundation::HANDLE) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Security_Cryptography")]
pub type GetDeltaInfoA = unsafe extern "system" fn(lpdeltaname: windows_sys::core::PCSTR, lpheaderinfo: *mut DELTA_HEADER_INFO) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Security_Cryptography")]
windows_link::link!("msdelta.dll" "system" fn GetDeltaInfoA(lpdeltaname : windows_sys::core::PCSTR, lpheaderinfo : *mut DELTA_HEADER_INFO) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Security_Cryptography")]
pub type GetDeltaInfoB = unsafe extern "system" fn(delta: DELTA_INPUT, lpheaderinfo: *mut DELTA_HEADER_INFO) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Security_Cryptography")]
windows_link::link!("msdelta.dll" "system" fn GetDeltaInfoB(delta : DELTA_INPUT, lpheaderinfo : *mut DELTA_HEADER_INFO) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Security_Cryptography")]
pub type GetDeltaInfoW = unsafe extern "system" fn(lpdeltaname: windows_sys::core::PCWSTR, lpheaderinfo: *mut DELTA_HEADER_INFO) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Security_Cryptography")]
windows_link::link!("msdelta.dll" "system" fn GetDeltaInfoW(lpdeltaname : windows_sys::core::PCWSTR, lpheaderinfo : *mut DELTA_HEADER_INFO) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Security_Cryptography")]
pub type GetDeltaSignatureA = unsafe extern "system" fn(filetypeset: i64, hashalgid: super::super::Security::Cryptography::ALG_ID, lpsourcename: windows_sys::core::PCSTR, lphash: *mut DELTA_HASH) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Security_Cryptography")]
windows_link::link!("msdelta.dll" "system" fn GetDeltaSignatureA(filetypeset : i64, hashalgid : super::super::Security::Cryptography::ALG_ID, lpsourcename : windows_sys::core::PCSTR, lphash : *mut DELTA_HASH) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Security_Cryptography")]
pub type GetDeltaSignatureB = unsafe extern "system" fn(filetypeset: i64, hashalgid: super::super::Security::Cryptography::ALG_ID, source: DELTA_INPUT, lphash: *mut DELTA_HASH) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Security_Cryptography")]
windows_link::link!("msdelta.dll" "system" fn GetDeltaSignatureB(filetypeset : i64, hashalgid : super::super::Security::Cryptography::ALG_ID, source : DELTA_INPUT, lphash : *mut DELTA_HASH) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Security_Cryptography")]
pub type GetDeltaSignatureW = unsafe extern "system" fn(filetypeset: i64, hashalgid: super::super::Security::Cryptography::ALG_ID, lpsourcename: windows_sys::core::PCWSTR, lphash: *mut DELTA_HASH) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Security_Cryptography")]
windows_link::link!("msdelta.dll" "system" fn GetDeltaSignatureW(filetypeset : i64, hashalgid : super::super::Security::Cryptography::ALG_ID, lpsourcename : windows_sys::core::PCWSTR, lphash : *mut DELTA_HASH) -> windows_sys::core::BOOL);
pub type GetFilePatchSignatureA = unsafe extern "system" fn(filename: windows_sys::core::PCSTR, optionflags: u32, optiondata: *const core::ffi::c_void, ignorerangecount: u32, ignorerangearray: *const PATCH_IGNORE_RANGE, retainrangecount: u32, retainrangearray: *const PATCH_RETAIN_RANGE, signaturebuffersize: u32, signaturebuffer: windows_sys::core::PSTR) -> windows_sys::core::BOOL;
windows_link::link!("mspatcha.dll" "system" fn GetFilePatchSignatureA(filename : windows_sys::core::PCSTR, optionflags : u32, optiondata : *const core::ffi::c_void, ignorerangecount : u32, ignorerangearray : *const PATCH_IGNORE_RANGE, retainrangecount : u32, retainrangearray : *const PATCH_RETAIN_RANGE, signaturebuffersize : u32, signaturebuffer : windows_sys::core::PSTR) -> windows_sys::core::BOOL);
pub type GetFilePatchSignatureByBuffer = unsafe extern "system" fn(filebufferwritable: *mut u8, filesize: u32, optionflags: u32, optiondata: *const core::ffi::c_void, ignorerangecount: u32, ignorerangearray: *const PATCH_IGNORE_RANGE, retainrangecount: u32, retainrangearray: *const PATCH_RETAIN_RANGE, signaturebuffersize: u32, signaturebuffer: windows_sys::core::PSTR) -> windows_sys::core::BOOL;
...
pub type GetFilePatchSignatureByHandle = unsafe extern "system" fn(filehandle: super::super::Foundation::HANDLE, optionflags: u32, optiondata: *const core::ffi::c_void, ignorerangecount: u32, ignorerangearray: *const PATCH_IGNORE_RANGE, retainrangecount: u32, retainrangearray: *const PATCH_RETAIN_RANGE, signaturebuffersize: u32, signaturebuffer: windows_sys::core::PSTR) -> windows_sys::core::BOOL;
...
pub type GetFilePatchSignatureW = unsafe extern "system" fn(filename: windows_sys::core::PCWSTR, optionflags: u32, optiondata: *const core::ffi::c_void, ignorerangecount: u32, ignorerangearray: *const PATCH_IGNORE_RANGE, retainrangecount: u32, retainrangearray: *const PATCH_RETAIN_RANGE, signaturebuffersize: u32, signaturebuffer: windows_sys::core::PWSTR) -> windows_sys::core::BOOL;
windows_link::link!("mspatcha.dll" "system" fn GetFilePatchSignatureW(filename : windows_sys::core::PCWSTR, optionflags : u32, optiondata : *const core::ffi::c_void, ignorerangecount : u32, ignorerangearray : *const PATCH_IGNORE_RANGE, retainrangecount : u32, retainrangearray : *const PATCH_RETAIN_RANGE, signaturebuffersize : u32, signaturebuffer : windows_sys::core::PWSTR) -> windows_sys::core::BOOL);
pub type MsiAdvertiseProductA = unsafe extern "system" fn(szpackagepath: windows_sys::core::PCSTR, szscriptfilepath: windows_sys::core::PCSTR, sztransforms: windows_sys::core::PCSTR, lgidlanguage: u16) -> u32;
windows_link::link!("msi.dll" "system" fn MsiAdvertiseProductA(szpackagepath : windows_sys::core::PCSTR, szscriptfilepath : windows_sys::core::PCSTR, sztransforms : windows_sys::core::PCSTR, lgidlanguage : u16) -> u32);
pub type MsiAdvertiseProductExA = unsafe extern "system" fn(szpackagepath: windows_sys::core::PCSTR, szscriptfilepath: windows_sys::core::PCSTR, sztransforms: windows_sys::core::PCSTR, lgidlanguage: u16, dwplatform: u32, dwoptions: u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiAdvertiseProductExA(szpackagepath : windows_sys::core::PCSTR, szscriptfilepath : windows_sys::core::PCSTR, sztransforms : windows_sys::core::PCSTR, lgidlanguage : u16, dwplatform : u32, dwoptions : u32) -> u32);
pub type MsiAdvertiseProductExW = unsafe extern "system" fn(szpackagepath: windows_sys::core::PCWSTR, szscriptfilepath: windows_sys::core::PCWSTR, sztransforms: windows_sys::core::PCWSTR, lgidlanguage: u16, dwplatform: u32, dwoptions: u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiAdvertiseProductExW(szpackagepath : windows_sys::core::PCWSTR, szscriptfilepath : windows_sys::core::PCWSTR, sztransforms : windows_sys::core::PCWSTR, lgidlanguage : u16, dwplatform : u32, dwoptions : u32) -> u32);
pub type MsiAdvertiseProductW = unsafe extern "system" fn(szpackagepath: windows_sys::core::PCWSTR, szscriptfilepath: windows_sys::core::PCWSTR, sztransforms: windows_sys::core::PCWSTR, lgidlanguage: u16) -> u32;
windows_link::link!("msi.dll" "system" fn MsiAdvertiseProductW(szpackagepath : windows_sys::core::PCWSTR, szscriptfilepath : windows_sys::core::PCWSTR, sztransforms : windows_sys::core::PCWSTR, lgidlanguage : u16) -> u32);
#[cfg(feature = "Win32_System_Registry")]
pub type MsiAdvertiseScriptA = unsafe extern "system" fn(szscriptfile: windows_sys::core::PCSTR, dwflags: u32, phregdata: *const super::Registry::HKEY, fremoveitems: windows_sys::core::BOOL) -> u32;
#[cfg(feature = "Win32_System_Registry")]
windows_link::link!("msi.dll" "system" fn MsiAdvertiseScriptA(szscriptfile : windows_sys::core::PCSTR, dwflags : u32, phregdata : *const super::Registry::HKEY, fremoveitems : windows_sys::core::BOOL) -> u32);
#[cfg(feature = "Win32_System_Registry")]
pub type MsiAdvertiseScriptW = unsafe extern "system" fn(szscriptfile: windows_sys::core::PCWSTR, dwflags: u32, phregdata: *const super::Registry::HKEY, fremoveitems: windows_sys::core::BOOL) -> u32;
#[cfg(feature = "Win32_System_Registry")]
windows_link::link!("msi.dll" "system" fn MsiAdvertiseScriptW(szscriptfile : windows_sys::core::PCWSTR, dwflags : u32, phregdata : *const super::Registry::HKEY, fremoveitems : windows_sys::core::BOOL) -> u32);
pub type MsiApplyMultiplePatchesA = unsafe extern "system" fn(szpatchpackages: windows_sys::core::PCSTR, szproductcode: windows_sys::core::PCSTR, szpropertieslist: windows_sys::core::PCSTR) -> u32;
...
pub type MsiApplyMultiplePatchesW = unsafe extern "system" fn(szpatchpackages: windows_sys::core::PCWSTR, szproductcode: windows_sys::core::PCWSTR, szpropertieslist: windows_sys::core::PCWSTR) -> u32;
...
pub type MsiApplyPatchA = unsafe extern "system" fn(szpatchpackage: windows_sys::core::PCSTR, szinstallpackage: windows_sys::core::PCSTR, einstalltype: INSTALLTYPE, szcommandline: windows_sys::core::PCSTR) -> u32;
...
pub type MsiApplyPatchW = unsafe extern "system" fn(szpatchpackage: windows_sys::core::PCWSTR, szinstallpackage: windows_sys::core::PCWSTR, einstalltype: INSTALLTYPE, szcommandline: windows_sys::core::PCWSTR) -> u32;
...
pub type MsiBeginTransactionA = unsafe extern "system" fn(szname: windows_sys::core::PCSTR, dwtransactionattributes: u32, phtransactionhandle: *mut MSIHANDLE, phchangeofownerevent: *mut super::super::Foundation::HANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiBeginTransactionA(szname : windows_sys::core::PCSTR, dwtransactionattributes : u32, phtransactionhandle : *mut MSIHANDLE, phchangeofownerevent : *mut super::super::Foundation::HANDLE) -> u32);
pub type MsiBeginTransactionW = unsafe extern "system" fn(szname: windows_sys::core::PCWSTR, dwtransactionattributes: u32, phtransactionhandle: *mut MSIHANDLE, phchangeofownerevent: *mut super::super::Foundation::HANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiBeginTransactionW(szname : windows_sys::core::PCWSTR, dwtransactionattributes : u32, phtransactionhandle : *mut MSIHANDLE, phchangeofownerevent : *mut super::super::Foundation::HANDLE) -> u32);
pub type MsiCloseAllHandles = unsafe extern "system" fn() -> u32;
windows_link::link!("msi.dll" "system" fn MsiCloseAllHandles() -> u32);
pub type MsiCloseHandle = unsafe extern "system" fn(hany: MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiCloseHandle(hany : MSIHANDLE) -> u32);
pub type MsiCollectUserInfoA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiCollectUserInfoA(szproduct : windows_sys::core::PCSTR) -> u32);
pub type MsiCollectUserInfoW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiCollectUserInfoW(szproduct : windows_sys::core::PCWSTR) -> u32);
pub type MsiConfigureFeatureA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, szfeature: windows_sys::core::PCSTR, einstallstate: INSTALLSTATE) -> u32;
...
pub type MsiConfigureFeatureW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, szfeature: windows_sys::core::PCWSTR, einstallstate: INSTALLSTATE) -> u32;
...
pub type MsiConfigureProductA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, iinstalllevel: INSTALLLEVEL, einstallstate: INSTALLSTATE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiConfigureProductA(szproduct : windows_sys::core::PCSTR, iinstalllevel : INSTALLLEVEL, einstallstate : INSTALLSTATE) -> u32);
pub type MsiConfigureProductExA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, iinstalllevel: INSTALLLEVEL, einstallstate: INSTALLSTATE, szcommandline: windows_sys::core::PCSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiConfigureProductExA(szproduct : windows_sys::core::PCSTR, iinstalllevel : INSTALLLEVEL, einstallstate : INSTALLSTATE, szcommandline : windows_sys::core::PCSTR) -> u32);
pub type MsiConfigureProductExW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, iinstalllevel: INSTALLLEVEL, einstallstate: INSTALLSTATE, szcommandline: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiConfigureProductExW(szproduct : windows_sys::core::PCWSTR, iinstalllevel : INSTALLLEVEL, einstallstate : INSTALLSTATE, szcommandline : windows_sys::core::PCWSTR) -> u32);
pub type MsiConfigureProductW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, iinstalllevel: INSTALLLEVEL, einstallstate: INSTALLSTATE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiConfigureProductW(szproduct : windows_sys::core::PCWSTR, iinstalllevel : INSTALLLEVEL, einstallstate : INSTALLSTATE) -> u32);
pub type MsiCreateRecord = unsafe extern "system" fn(cparams: u32) -> MSIHANDLE;
windows_link::link!("msi.dll" "system" fn MsiCreateRecord(cparams : u32) -> MSIHANDLE);
pub type MsiCreateTransformSummaryInfoA = unsafe extern "system" fn(hdatabase: MSIHANDLE, hdatabasereference: MSIHANDLE, sztransformfile: windows_sys::core::PCSTR, ierrorconditions: MSITRANSFORM_ERROR, ivalidation: MSITRANSFORM_VALIDATE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiCreateTransformSummaryInfoA(hdatabase : MSIHANDLE, hdatabasereference : MSIHANDLE, sztransformfile : windows_sys::core::PCSTR, ierrorconditions : MSITRANSFORM_ERROR, ivalidation : MSITRANSFORM_VALIDATE) -> u32);
pub type MsiCreateTransformSummaryInfoW = unsafe extern "system" fn(hdatabase: MSIHANDLE, hdatabasereference: MSIHANDLE, sztransformfile: windows_sys::core::PCWSTR, ierrorconditions: MSITRANSFORM_ERROR, ivalidation: MSITRANSFORM_VALIDATE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiCreateTransformSummaryInfoW(hdatabase : MSIHANDLE, hdatabasereference : MSIHANDLE, sztransformfile : windows_sys::core::PCWSTR, ierrorconditions : MSITRANSFORM_ERROR, ivalidation : MSITRANSFORM_VALIDATE) -> u32);
pub type MsiDatabaseApplyTransformA = unsafe extern "system" fn(hdatabase: MSIHANDLE, sztransformfile: windows_sys::core::PCSTR, ierrorconditions: MSITRANSFORM_ERROR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiDatabaseApplyTransformA(hdatabase : MSIHANDLE, sztransformfile : windows_sys::core::PCSTR, ierrorconditions : MSITRANSFORM_ERROR) -> u32);
pub type MsiDatabaseApplyTransformW = unsafe extern "system" fn(hdatabase: MSIHANDLE, sztransformfile: windows_sys::core::PCWSTR, ierrorconditions: MSITRANSFORM_ERROR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiDatabaseApplyTransformW(hdatabase : MSIHANDLE, sztransformfile : windows_sys::core::PCWSTR, ierrorconditions : MSITRANSFORM_ERROR) -> u32);
pub type MsiDatabaseCommit = unsafe extern "system" fn(hdatabase: MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiDatabaseCommit(hdatabase : MSIHANDLE) -> u32);
pub type MsiDatabaseExportA = unsafe extern "system" fn(hdatabase: MSIHANDLE, sztablename: windows_sys::core::PCSTR, szfolderpath: windows_sys::core::PCSTR, szfilename: windows_sys::core::PCSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiDatabaseExportA(hdatabase : MSIHANDLE, sztablename : windows_sys::core::PCSTR, szfolderpath : windows_sys::core::PCSTR, szfilename : windows_sys::core::PCSTR) -> u32);
pub type MsiDatabaseExportW = unsafe extern "system" fn(hdatabase: MSIHANDLE, sztablename: windows_sys::core::PCWSTR, szfolderpath: windows_sys::core::PCWSTR, szfilename: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiDatabaseExportW(hdatabase : MSIHANDLE, sztablename : windows_sys::core::PCWSTR, szfolderpath : windows_sys::core::PCWSTR, szfilename : windows_sys::core::PCWSTR) -> u32);
pub type MsiDatabaseGenerateTransformA = unsafe extern "system" fn(hdatabase: MSIHANDLE, hdatabasereference: MSIHANDLE, sztransformfile: windows_sys::core::PCSTR, ireserved1: i32, ireserved2: i32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiDatabaseGenerateTransformA(hdatabase : MSIHANDLE, hdatabasereference : MSIHANDLE, sztransformfile : windows_sys::core::PCSTR, ireserved1 : i32, ireserved2 : i32) -> u32);
pub type MsiDatabaseGenerateTransformW = unsafe extern "system" fn(hdatabase: MSIHANDLE, hdatabasereference: MSIHANDLE, sztransformfile: windows_sys::core::PCWSTR, ireserved1: i32, ireserved2: i32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiDatabaseGenerateTransformW(hdatabase : MSIHANDLE, hdatabasereference : MSIHANDLE, sztransformfile : windows_sys::core::PCWSTR, ireserved1 : i32, ireserved2 : i32) -> u32);
pub type MsiDatabaseGetPrimaryKeysA = unsafe extern "system" fn(hdatabase: MSIHANDLE, sztablename: windows_sys::core::PCSTR, phrecord: *mut MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiDatabaseGetPrimaryKeysA(hdatabase : MSIHANDLE, sztablename : windows_sys::core::PCSTR, phrecord : *mut MSIHANDLE) -> u32);
pub type MsiDatabaseGetPrimaryKeysW = unsafe extern "system" fn(hdatabase: MSIHANDLE, sztablename: windows_sys::core::PCWSTR, phrecord: *mut MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiDatabaseGetPrimaryKeysW(hdatabase : MSIHANDLE, sztablename : windows_sys::core::PCWSTR, phrecord : *mut MSIHANDLE) -> u32);
pub type MsiDatabaseImportA = unsafe extern "system" fn(hdatabase: MSIHANDLE, szfolderpath: windows_sys::core::PCSTR, szfilename: windows_sys::core::PCSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiDatabaseImportA(hdatabase : MSIHANDLE, szfolderpath : windows_sys::core::PCSTR, szfilename : windows_sys::core::PCSTR) -> u32);
pub type MsiDatabaseImportW = unsafe extern "system" fn(hdatabase: MSIHANDLE, szfolderpath: windows_sys::core::PCWSTR, szfilename: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiDatabaseImportW(hdatabase : MSIHANDLE, szfolderpath : windows_sys::core::PCWSTR, szfilename : windows_sys::core::PCWSTR) -> u32);
pub type MsiDatabaseIsTablePersistentA = unsafe extern "system" fn(hdatabase: MSIHANDLE, sztablename: windows_sys::core::PCSTR) -> MSICONDITION;
windows_link::link!("msi.dll" "system" fn MsiDatabaseIsTablePersistentA(hdatabase : MSIHANDLE, sztablename : windows_sys::core::PCSTR) -> MSICONDITION);
pub type MsiDatabaseIsTablePersistentW = unsafe extern "system" fn(hdatabase: MSIHANDLE, sztablename: windows_sys::core::PCWSTR) -> MSICONDITION;
windows_link::link!("msi.dll" "system" fn MsiDatabaseIsTablePersistentW(hdatabase : MSIHANDLE, sztablename : windows_sys::core::PCWSTR) -> MSICONDITION);
pub type MsiDatabaseMergeA = unsafe extern "system" fn(hdatabase: MSIHANDLE, hdatabasemerge: MSIHANDLE, sztablename: windows_sys::core::PCSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiDatabaseMergeA(hdatabase : MSIHANDLE, hdatabasemerge : MSIHANDLE, sztablename : windows_sys::core::PCSTR) -> u32);
pub type MsiDatabaseMergeW = unsafe extern "system" fn(hdatabase: MSIHANDLE, hdatabasemerge: MSIHANDLE, sztablename: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiDatabaseMergeW(hdatabase : MSIHANDLE, hdatabasemerge : MSIHANDLE, sztablename : windows_sys::core::PCWSTR) -> u32);
pub type MsiDatabaseOpenViewA = unsafe extern "system" fn(hdatabase: MSIHANDLE, szquery: windows_sys::core::PCSTR, phview: *mut MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiDatabaseOpenViewA(hdatabase : MSIHANDLE, szquery : windows_sys::core::PCSTR, phview : *mut MSIHANDLE) -> u32);
pub type MsiDatabaseOpenViewW = unsafe extern "system" fn(hdatabase: MSIHANDLE, szquery: windows_sys::core::PCWSTR, phview: *mut MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiDatabaseOpenViewW(hdatabase : MSIHANDLE, szquery : windows_sys::core::PCWSTR, phview : *mut MSIHANDLE) -> u32);
pub type MsiDetermineApplicablePatchesA = unsafe extern "system" fn(szproductpackagepath: windows_sys::core::PCSTR, cpatchinfo: u32, ppatchinfo: *mut MSIPATCHSEQUENCEINFOA) -> u32;
...
pub type MsiDetermineApplicablePatchesW = unsafe extern "system" fn(szproductpackagepath: windows_sys::core::PCWSTR, cpatchinfo: u32, ppatchinfo: *mut MSIPATCHSEQUENCEINFOW) -> u32;
...
pub type MsiDeterminePatchSequenceA = unsafe extern "system" fn(szproductcode: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: MSIINSTALLCONTEXT, cpatchinfo: u32, ppatchinfo: *mut MSIPATCHSEQUENCEINFOA) -> u32;
...
pub type MsiDeterminePatchSequenceW = unsafe extern "system" fn(szproductcode: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: MSIINSTALLCONTEXT, cpatchinfo: u32, ppatchinfo: *mut MSIPATCHSEQUENCEINFOW) -> u32;
...
pub type MsiDoActionA = unsafe extern "system" fn(hinstall: MSIHANDLE, szaction: windows_sys::core::PCSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiDoActionA(hinstall : MSIHANDLE, szaction : windows_sys::core::PCSTR) -> u32);
pub type MsiDoActionW = unsafe extern "system" fn(hinstall: MSIHANDLE, szaction: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiDoActionW(hinstall : MSIHANDLE, szaction : windows_sys::core::PCWSTR) -> u32);
pub type MsiEnableLogA = unsafe extern "system" fn(dwlogmode: u32, szlogfile: windows_sys::core::PCSTR, dwlogattributes: u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiEnableLogA(dwlogmode : u32, szlogfile : windows_sys::core::PCSTR, dwlogattributes : u32) -> u32);
pub type MsiEnableLogW = unsafe extern "system" fn(dwlogmode: u32, szlogfile: windows_sys::core::PCWSTR, dwlogattributes: u32) -> u32;
...
pub type MsiEnableUIPreview = unsafe extern "system" fn(hdatabase: MSIHANDLE, phpreview: *mut MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiEnableUIPreview(hdatabase : MSIHANDLE, phpreview : *mut MSIHANDLE) -> u32);
pub type MsiEndTransaction = unsafe extern "system" fn(dwtransactionstate: MSITRANSACTIONSTATE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiEndTransaction(dwtransactionstate : MSITRANSACTIONSTATE) -> u32);
pub type MsiEnumClientsA = unsafe extern "system" fn(szcomponent: windows_sys::core::PCSTR, iproductindex: u32, lpproductbuf: windows_sys::core::PSTR) -> u32;
...
pub type MsiEnumClientsExA = unsafe extern "system" fn(szcomponent: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: u32, dwproductindex: u32, szproductbuf: windows_sys::core::PSTR, pdwinstalledcontext: *mut MSIINSTALLCONTEXT, szsid: windows_sys::core::PSTR, pcchsid: *mut u32) -> u32;
...
pub type MsiEnumClientsExW = unsafe extern "system" fn(szcomponent: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: u32, dwproductindex: u32, szproductbuf: windows_sys::core::PWSTR, pdwinstalledcontext: *mut MSIINSTALLCONTEXT, szsid: windows_sys::core::PWSTR, pcchsid: *mut u32) -> u32;
...
pub type MsiEnumClientsW = unsafe extern "system" fn(szcomponent: windows_sys::core::PCWSTR, iproductindex: u32, lpproductbuf: windows_sys::core::PWSTR) -> u32;
...
pub type MsiEnumComponentCostsA = unsafe extern "system" fn(hinstall: MSIHANDLE, szcomponent: windows_sys::core::PCSTR, dwindex: u32, istate: INSTALLSTATE, szdrivebuf: windows_sys::core::PSTR, pcchdrivebuf: *mut u32, picost: *mut i32, pitempcost: *mut i32) -> u32;
...
pub type MsiEnumComponentCostsW = unsafe extern "system" fn(hinstall: MSIHANDLE, szcomponent: windows_sys::core::PCWSTR, dwindex: u32, istate: INSTALLSTATE, szdrivebuf: windows_sys::core::PWSTR, pcchdrivebuf: *mut u32, picost: *mut i32, pitempcost: *mut i32) -> u32;
...
pub type MsiEnumComponentQualifiersA = unsafe extern "system" fn(szcomponent: windows_sys::core::PCSTR, iindex: u32, lpqualifierbuf: windows_sys::core::PSTR, pcchqualifierbuf: *mut u32, lpapplicationdatabuf: windows_sys::core::PSTR, pcchapplicationdatabuf: *mut u32) -> u32;
...
pub type MsiEnumComponentQualifiersW = unsafe extern "system" fn(szcomponent: windows_sys::core::PCWSTR, iindex: u32, lpqualifierbuf: windows_sys::core::PWSTR, pcchqualifierbuf: *mut u32, lpapplicationdatabuf: windows_sys::core::PWSTR, pcchapplicationdatabuf: *mut u32) -> u32;
...
pub type MsiEnumComponentsA = unsafe extern "system" fn(icomponentindex: u32, lpcomponentbuf: windows_sys::core::PSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiEnumComponentsA(icomponentindex : u32, lpcomponentbuf : windows_sys::core::PSTR) -> u32);
pub type MsiEnumComponentsExA = unsafe extern "system" fn(szusersid: windows_sys::core::PCSTR, dwcontext: u32, dwindex: u32, szinstalledcomponentcode: windows_sys::core::PSTR, pdwinstalledcontext: *mut MSIINSTALLCONTEXT, szsid: windows_sys::core::PSTR, pcchsid: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiEnumComponentsExA(szusersid : windows_sys::core::PCSTR, dwcontext : u32, dwindex : u32, szinstalledcomponentcode : windows_sys::core::PSTR, pdwinstalledcontext : *mut MSIINSTALLCONTEXT, szsid : windows_sys::core::PSTR, pcchsid : *mut u32) -> u32);
pub type MsiEnumComponentsExW = unsafe extern "system" fn(szusersid: windows_sys::core::PCWSTR, dwcontext: u32, dwindex: u32, szinstalledcomponentcode: windows_sys::core::PWSTR, pdwinstalledcontext: *mut MSIINSTALLCONTEXT, szsid: windows_sys::core::PWSTR, pcchsid: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiEnumComponentsExW(szusersid : windows_sys::core::PCWSTR, dwcontext : u32, dwindex : u32, szinstalledcomponentcode : windows_sys::core::PWSTR, pdwinstalledcontext : *mut MSIINSTALLCONTEXT, szsid : windows_sys::core::PWSTR, pcchsid : *mut u32) -> u32);
pub type MsiEnumComponentsW = unsafe extern "system" fn(icomponentindex: u32, lpcomponentbuf: windows_sys::core::PWSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiEnumComponentsW(icomponentindex : u32, lpcomponentbuf : windows_sys::core::PWSTR) -> u32);
pub type MsiEnumFeaturesA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, ifeatureindex: u32, lpfeaturebuf: windows_sys::core::PSTR, lpparentbuf: windows_sys::core::PSTR) -> u32;
...
pub type MsiEnumFeaturesW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, ifeatureindex: u32, lpfeaturebuf: windows_sys::core::PWSTR, lpparentbuf: windows_sys::core::PWSTR) -> u32;
...
pub type MsiEnumPatchesA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, ipatchindex: u32, lppatchbuf: windows_sys::core::PSTR, lptransformsbuf: windows_sys::core::PSTR, pcchtransformsbuf: *mut u32) -> u32;
...
pub type MsiEnumProductsA = unsafe extern "system" fn(iproductindex: u32, lpproductbuf: windows_sys::core::PSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiEnumProductsA(iproductindex : u32, lpproductbuf : windows_sys::core::PSTR) -> u32);
pub type MsiEnumProductsExA = unsafe extern "system" fn(szproductcode: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: u32, dwindex: u32, szinstalledproductcode: windows_sys::core::PSTR, pdwinstalledcontext: *mut MSIINSTALLCONTEXT, szsid: windows_sys::core::PSTR, pcchsid: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiEnumProductsExA(szproductcode : windows_sys::core::PCSTR, szusersid : windows_sys::core::PCSTR, dwcontext : u32, dwindex : u32, szinstalledproductcode : windows_sys::core::PSTR, pdwinstalledcontext : *mut MSIINSTALLCONTEXT, szsid : windows_sys::core::PSTR, pcchsid : *mut u32) -> u32);
pub type MsiEnumProductsExW = unsafe extern "system" fn(szproductcode: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: u32, dwindex: u32, szinstalledproductcode: windows_sys::core::PWSTR, pdwinstalledcontext: *mut MSIINSTALLCONTEXT, szsid: windows_sys::core::PWSTR, pcchsid: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiEnumProductsExW(szproductcode : windows_sys::core::PCWSTR, szusersid : windows_sys::core::PCWSTR, dwcontext : u32, dwindex : u32, szinstalledproductcode : windows_sys::core::PWSTR, pdwinstalledcontext : *mut MSIINSTALLCONTEXT, szsid : windows_sys::core::PWSTR, pcchsid : *mut u32) -> u32);
pub type MsiEnumProductsW = unsafe extern "system" fn(iproductindex: u32, lpproductbuf: windows_sys::core::PWSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiEnumProductsW(iproductindex : u32, lpproductbuf : windows_sys::core::PWSTR) -> u32);
pub type MsiEnumRelatedProductsA = unsafe extern "system" fn(lpupgradecode: windows_sys::core::PCSTR, dwreserved: u32, iproductindex: u32, lpproductbuf: windows_sys::core::PSTR) -> u32;
...
pub type MsiEnumRelatedProductsW = unsafe extern "system" fn(lpupgradecode: windows_sys::core::PCWSTR, dwreserved: u32, iproductindex: u32, lpproductbuf: windows_sys::core::PWSTR) -> u32;
...
pub type MsiEvaluateConditionA = unsafe extern "system" fn(hinstall: MSIHANDLE, szcondition: windows_sys::core::PCSTR) -> MSICONDITION;
windows_link::link!("msi.dll" "system" fn MsiEvaluateConditionA(hinstall : MSIHANDLE, szcondition : windows_sys::core::PCSTR) -> MSICONDITION);
pub type MsiEvaluateConditionW = unsafe extern "system" fn(hinstall: MSIHANDLE, szcondition: windows_sys::core::PCWSTR) -> MSICONDITION;
windows_link::link!("msi.dll" "system" fn MsiEvaluateConditionW(hinstall : MSIHANDLE, szcondition : windows_sys::core::PCWSTR) -> MSICONDITION);
pub type MsiExtractPatchXMLDataA = unsafe extern "system" fn(szpatchpath: windows_sys::core::PCSTR, dwreserved: u32, szxmldata: windows_sys::core::PSTR, pcchxmldata: *mut u32) -> u32;
...
pub type MsiExtractPatchXMLDataW = unsafe extern "system" fn(szpatchpath: windows_sys::core::PCWSTR, dwreserved: u32, szxmldata: windows_sys::core::PWSTR, pcchxmldata: *mut u32) -> u32;
...
pub type MsiFormatRecordA = unsafe extern "system" fn(hinstall: MSIHANDLE, hrecord: MSIHANDLE, szresultbuf: windows_sys::core::PSTR, pcchresultbuf: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiFormatRecordA(hinstall : MSIHANDLE, hrecord : MSIHANDLE, szresultbuf : windows_sys::core::PSTR, pcchresultbuf : *mut u32) -> u32);
pub type MsiFormatRecordW = unsafe extern "system" fn(hinstall: MSIHANDLE, hrecord: MSIHANDLE, szresultbuf: windows_sys::core::PWSTR, pcchresultbuf: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiFormatRecordW(hinstall : MSIHANDLE, hrecord : MSIHANDLE, szresultbuf : windows_sys::core::PWSTR, pcchresultbuf : *mut u32) -> u32);
pub type MsiGetActiveDatabase = unsafe extern "system" fn(hinstall: MSIHANDLE) -> MSIHANDLE;
windows_link::link!("msi.dll" "system" fn MsiGetActiveDatabase(hinstall : MSIHANDLE) -> MSIHANDLE);
pub type MsiGetComponentPathA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, szcomponent: windows_sys::core::PCSTR, lppathbuf: windows_sys::core::PSTR, pcchbuf: *mut u32) -> INSTALLSTATE;
...
pub type MsiGetComponentPathExA = unsafe extern "system" fn(szproductcode: windows_sys::core::PCSTR, szcomponentcode: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: MSIINSTALLCONTEXT, lpoutpathbuffer: windows_sys::core::PSTR, pcchoutpathbuffer: *mut u32) -> INSTALLSTATE;
...
pub type MsiGetComponentPathExW = unsafe extern "system" fn(szproductcode: windows_sys::core::PCWSTR, szcomponentcode: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: MSIINSTALLCONTEXT, lpoutpathbuffer: windows_sys::core::PWSTR, pcchoutpathbuffer: *mut u32) -> INSTALLSTATE;
...
pub type MsiGetComponentPathW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, szcomponent: windows_sys::core::PCWSTR, lppathbuf: windows_sys::core::PWSTR, pcchbuf: *mut u32) -> INSTALLSTATE;
...
pub type MsiGetComponentStateA = unsafe extern "system" fn(hinstall: MSIHANDLE, szcomponent: windows_sys::core::PCSTR, piinstalled: *mut INSTALLSTATE, piaction: *mut INSTALLSTATE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetComponentStateA(hinstall : MSIHANDLE, szcomponent : windows_sys::core::PCSTR, piinstalled : *mut INSTALLSTATE, piaction : *mut INSTALLSTATE) -> u32);
pub type MsiGetComponentStateW = unsafe extern "system" fn(hinstall: MSIHANDLE, szcomponent: windows_sys::core::PCWSTR, piinstalled: *mut INSTALLSTATE, piaction: *mut INSTALLSTATE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetComponentStateW(hinstall : MSIHANDLE, szcomponent : windows_sys::core::PCWSTR, piinstalled : *mut INSTALLSTATE, piaction : *mut INSTALLSTATE) -> u32);
pub type MsiGetDatabaseState = unsafe extern "system" fn(hdatabase: MSIHANDLE) -> MSIDBSTATE;
windows_link::link!("msi.dll" "system" fn MsiGetDatabaseState(hdatabase : MSIHANDLE) -> MSIDBSTATE);
pub type MsiGetFeatureCostA = unsafe extern "system" fn(hinstall: MSIHANDLE, szfeature: windows_sys::core::PCSTR, icosttree: MSICOSTTREE, istate: INSTALLSTATE, picost: *mut i32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetFeatureCostA(hinstall : MSIHANDLE, szfeature : windows_sys::core::PCSTR, icosttree : MSICOSTTREE, istate : INSTALLSTATE, picost : *mut i32) -> u32);
pub type MsiGetFeatureCostW = unsafe extern "system" fn(hinstall: MSIHANDLE, szfeature: windows_sys::core::PCWSTR, icosttree: MSICOSTTREE, istate: INSTALLSTATE, picost: *mut i32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetFeatureCostW(hinstall : MSIHANDLE, szfeature : windows_sys::core::PCWSTR, icosttree : MSICOSTTREE, istate : INSTALLSTATE, picost : *mut i32) -> u32);
pub type MsiGetFeatureInfoA = unsafe extern "system" fn(hproduct: MSIHANDLE, szfeature: windows_sys::core::PCSTR, lpattributes: *mut u32, lptitlebuf: windows_sys::core::PSTR, pcchtitlebuf: *mut u32, lphelpbuf: windows_sys::core::PSTR, pcchhelpbuf: *mut u32) -> u32;
...
pub type MsiGetFeatureInfoW = unsafe extern "system" fn(hproduct: MSIHANDLE, szfeature: windows_sys::core::PCWSTR, lpattributes: *mut u32, lptitlebuf: windows_sys::core::PWSTR, pcchtitlebuf: *mut u32, lphelpbuf: windows_sys::core::PWSTR, pcchhelpbuf: *mut u32) -> u32;
...
pub type MsiGetFeatureStateA = unsafe extern "system" fn(hinstall: MSIHANDLE, szfeature: windows_sys::core::PCSTR, piinstalled: *mut INSTALLSTATE, piaction: *mut INSTALLSTATE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetFeatureStateA(hinstall : MSIHANDLE, szfeature : windows_sys::core::PCSTR, piinstalled : *mut INSTALLSTATE, piaction : *mut INSTALLSTATE) -> u32);
pub type MsiGetFeatureStateW = unsafe extern "system" fn(hinstall: MSIHANDLE, szfeature: windows_sys::core::PCWSTR, piinstalled: *mut INSTALLSTATE, piaction: *mut INSTALLSTATE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetFeatureStateW(hinstall : MSIHANDLE, szfeature : windows_sys::core::PCWSTR, piinstalled : *mut INSTALLSTATE, piaction : *mut INSTALLSTATE) -> u32);
pub type MsiGetFeatureUsageA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, szfeature: windows_sys::core::PCSTR, pdwusecount: *mut u32, pwdateused: *mut u16) -> u32;
...
pub type MsiGetFeatureUsageW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, szfeature: windows_sys::core::PCWSTR, pdwusecount: *mut u32, pwdateused: *mut u16) -> u32;
...
pub type MsiGetFeatureValidStatesA = unsafe extern "system" fn(hinstall: MSIHANDLE, szfeature: windows_sys::core::PCSTR, lpinstallstates: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetFeatureValidStatesA(hinstall : MSIHANDLE, szfeature : windows_sys::core::PCSTR, lpinstallstates : *mut u32) -> u32);
pub type MsiGetFeatureValidStatesW = unsafe extern "system" fn(hinstall: MSIHANDLE, szfeature: windows_sys::core::PCWSTR, lpinstallstates: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetFeatureValidStatesW(hinstall : MSIHANDLE, szfeature : windows_sys::core::PCWSTR, lpinstallstates : *mut u32) -> u32);
pub type MsiGetFileHashA = unsafe extern "system" fn(szfilepath: windows_sys::core::PCSTR, dwoptions: u32, phash: *mut MSIFILEHASHINFO) -> u32;
...
pub type MsiGetFileHashW = unsafe extern "system" fn(szfilepath: windows_sys::core::PCWSTR, dwoptions: u32, phash: *mut MSIFILEHASHINFO) -> u32;
...
#[cfg(feature = "Win32_Security_Cryptography")]
pub type MsiGetFileSignatureInformationA = unsafe extern "system" fn(szsignedobjectpath: windows_sys::core::PCSTR, dwflags: u32, ppccertcontext: *mut *mut super::super::Security::Cryptography::CERT_CONTEXT, pbhashdata: *mut u8, pcbhashdata: *mut u32) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Security_Cryptography")]
windows_link::link!("msi.dll" "system" fn MsiGetFileSignatureInformationA(szsignedobjectpath : windows_sys::core::PCSTR, dwflags : u32, ppccertcontext : *mut *mut super::super::Security::Cryptography::CERT_CONTEXT, pbhashdata : *mut u8, pcbhashdata : *mut u32) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Cryptography")]
pub type MsiGetFileSignatureInformationW = unsafe extern "system" fn(szsignedobjectpath: windows_sys::core::PCWSTR, dwflags: u32, ppccertcontext: *mut *mut super::super::Security::Cryptography::CERT_CONTEXT, pbhashdata: *mut u8, pcbhashdata: *mut u32) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Security_Cryptography")]
windows_link::link!("msi.dll" "system" fn MsiGetFileSignatureInformationW(szsignedobjectpath : windows_sys::core::PCWSTR, dwflags : u32, ppccertcontext : *mut *mut super::super::Security::Cryptography::CERT_CONTEXT, pbhashdata : *mut u8, pcbhashdata : *mut u32) -> windows_sys::core::HRESULT);
pub type MsiGetFileVersionA = unsafe extern "system" fn(szfilepath: windows_sys::core::PCSTR, lpversionbuf: windows_sys::core::PSTR, pcchversionbuf: *mut u32, lplangbuf: windows_sys::core::PSTR, pcchlangbuf: *mut u32) -> u32;
...
pub type MsiGetFileVersionW = unsafe extern "system" fn(szfilepath: windows_sys::core::PCWSTR, lpversionbuf: windows_sys::core::PWSTR, pcchversionbuf: *mut u32, lplangbuf: windows_sys::core::PWSTR, pcchlangbuf: *mut u32) -> u32;
...
pub type MsiGetLanguage = unsafe extern "system" fn(hinstall: MSIHANDLE) -> u16;
windows_link::link!("msi.dll" "system" fn MsiGetLanguage(hinstall : MSIHANDLE) -> u16);
pub type MsiGetLastErrorRecord = unsafe extern "system" fn() -> MSIHANDLE;
windows_link::link!("msi.dll" "system" fn MsiGetLastErrorRecord() -> MSIHANDLE);
pub type MsiGetMode = unsafe extern "system" fn(hinstall: MSIHANDLE, erunmode: MSIRUNMODE) -> windows_sys::core::BOOL;
windows_link::link!("msi.dll" "system" fn MsiGetMode(hinstall : MSIHANDLE, erunmode : MSIRUNMODE) -> windows_sys::core::BOOL);
pub type MsiGetPatchFileListA = unsafe extern "system" fn(szproductcode: windows_sys::core::PCSTR, szpatchpackages: windows_sys::core::PCSTR, pcfiles: *mut u32, pphfilerecords: *mut *mut MSIHANDLE) -> u32;
...
pub type MsiGetPatchFileListW = unsafe extern "system" fn(szproductcode: windows_sys::core::PCWSTR, szpatchpackages: windows_sys::core::PCWSTR, pcfiles: *mut u32, pphfilerecords: *mut *mut MSIHANDLE) -> u32;
...
pub type MsiGetPatchInfoA = unsafe extern "system" fn(szpatch: windows_sys::core::PCSTR, szattribute: windows_sys::core::PCSTR, lpvaluebuf: windows_sys::core::PSTR, pcchvaluebuf: *mut u32) -> u32;
...
pub type MsiGetPatchInfoExA = unsafe extern "system" fn(szpatchcode: windows_sys::core::PCSTR, szproductcode: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: MSIINSTALLCONTEXT, szproperty: windows_sys::core::PCSTR, lpvalue: windows_sys::core::PSTR, pcchvalue: *mut u32) -> u32;
...
pub type MsiGetPatchInfoExW = unsafe extern "system" fn(szpatchcode: windows_sys::core::PCWSTR, szproductcode: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: MSIINSTALLCONTEXT, szproperty: windows_sys::core::PCWSTR, lpvalue: windows_sys::core::PWSTR, pcchvalue: *mut u32) -> u32;
...
pub type MsiGetPatchInfoW = unsafe extern "system" fn(szpatch: windows_sys::core::PCWSTR, szattribute: windows_sys::core::PCWSTR, lpvaluebuf: windows_sys::core::PWSTR, pcchvaluebuf: *mut u32) -> u32;
...
pub type MsiGetProductCodeA = unsafe extern "system" fn(szcomponent: windows_sys::core::PCSTR, lpbuf39: windows_sys::core::PSTR) -> u32;
...
pub type MsiGetProductCodeW = unsafe extern "system" fn(szcomponent: windows_sys::core::PCWSTR, lpbuf39: windows_sys::core::PWSTR) -> u32;
...
pub type MsiGetProductInfoA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, szattribute: windows_sys::core::PCSTR, lpvaluebuf: windows_sys::core::PSTR, pcchvaluebuf: *mut u32) -> u32;
...
pub type MsiGetProductInfoExA = unsafe extern "system" fn(szproductcode: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: MSIINSTALLCONTEXT, szproperty: windows_sys::core::PCSTR, szvalue: windows_sys::core::PSTR, pcchvalue: *mut u32) -> u32;
...
pub type MsiGetProductInfoExW = unsafe extern "system" fn(szproductcode: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: MSIINSTALLCONTEXT, szproperty: windows_sys::core::PCWSTR, szvalue: windows_sys::core::PWSTR, pcchvalue: *mut u32) -> u32;
...
pub type MsiGetProductInfoFromScriptA = unsafe extern "system" fn(szscriptfile: windows_sys::core::PCSTR, lpproductbuf39: windows_sys::core::PSTR, plgidlanguage: *mut u16, pdwversion: *mut u32, lpnamebuf: windows_sys::core::PSTR, pcchnamebuf: *mut u32, lppackagebuf: windows_sys::core::PSTR, pcchpackagebuf: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetProductInfoFromScriptA(szscriptfile : windows_sys::core::PCSTR, lpproductbuf39 : windows_sys::core::PSTR, plgidlanguage : *mut u16, pdwversion : *mut u32, lpnamebuf : windows_sys::core::PSTR, pcchnamebuf : *mut u32, lppackagebuf : windows_sys::core::PSTR, pcchpackagebuf : *mut u32) -> u32);
pub type MsiGetProductInfoFromScriptW = unsafe extern "system" fn(szscriptfile: windows_sys::core::PCWSTR, lpproductbuf39: windows_sys::core::PWSTR, plgidlanguage: *mut u16, pdwversion: *mut u32, lpnamebuf: windows_sys::core::PWSTR, pcchnamebuf: *mut u32, lppackagebuf: windows_sys::core::PWSTR, pcchpackagebuf: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetProductInfoFromScriptW(szscriptfile : windows_sys::core::PCWSTR, lpproductbuf39 : windows_sys::core::PWSTR, plgidlanguage : *mut u16, pdwversion : *mut u32, lpnamebuf : windows_sys::core::PWSTR, pcchnamebuf : *mut u32, lppackagebuf : windows_sys::core::PWSTR, pcchpackagebuf : *mut u32) -> u32);
pub type MsiGetProductInfoW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, szattribute: windows_sys::core::PCWSTR, lpvaluebuf: windows_sys::core::PWSTR, pcchvaluebuf: *mut u32) -> u32;
...
pub type MsiGetProductPropertyA = unsafe extern "system" fn(hproduct: MSIHANDLE, szproperty: windows_sys::core::PCSTR, lpvaluebuf: windows_sys::core::PSTR, pcchvaluebuf: *mut u32) -> u32;
...
pub type MsiGetProductPropertyW = unsafe extern "system" fn(hproduct: MSIHANDLE, szproperty: windows_sys::core::PCWSTR, lpvaluebuf: windows_sys::core::PWSTR, pcchvaluebuf: *mut u32) -> u32;
...
pub type MsiGetPropertyA = unsafe extern "system" fn(hinstall: MSIHANDLE, szname: windows_sys::core::PCSTR, szvaluebuf: windows_sys::core::PSTR, pcchvaluebuf: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetPropertyA(hinstall : MSIHANDLE, szname : windows_sys::core::PCSTR, szvaluebuf : windows_sys::core::PSTR, pcchvaluebuf : *mut u32) -> u32);
pub type MsiGetPropertyW = unsafe extern "system" fn(hinstall: MSIHANDLE, szname: windows_sys::core::PCWSTR, szvaluebuf: windows_sys::core::PWSTR, pcchvaluebuf: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetPropertyW(hinstall : MSIHANDLE, szname : windows_sys::core::PCWSTR, szvaluebuf : windows_sys::core::PWSTR, pcchvaluebuf : *mut u32) -> u32);
pub type MsiGetShortcutTargetA = unsafe extern "system" fn(szshortcutpath: windows_sys::core::PCSTR, szproductcode: windows_sys::core::PSTR, szfeatureid: windows_sys::core::PSTR, szcomponentcode: windows_sys::core::PSTR) -> u32;
...
pub type MsiGetShortcutTargetW = unsafe extern "system" fn(szshortcutpath: windows_sys::core::PCWSTR, szproductcode: windows_sys::core::PWSTR, szfeatureid: windows_sys::core::PWSTR, szcomponentcode: windows_sys::core::PWSTR) -> u32;
...
pub type MsiGetSourcePathA = unsafe extern "system" fn(hinstall: MSIHANDLE, szfolder: windows_sys::core::PCSTR, szpathbuf: windows_sys::core::PSTR, pcchpathbuf: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetSourcePathA(hinstall : MSIHANDLE, szfolder : windows_sys::core::PCSTR, szpathbuf : windows_sys::core::PSTR, pcchpathbuf : *mut u32) -> u32);
pub type MsiGetSourcePathW = unsafe extern "system" fn(hinstall: MSIHANDLE, szfolder: windows_sys::core::PCWSTR, szpathbuf: windows_sys::core::PWSTR, pcchpathbuf: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetSourcePathW(hinstall : MSIHANDLE, szfolder : windows_sys::core::PCWSTR, szpathbuf : windows_sys::core::PWSTR, pcchpathbuf : *mut u32) -> u32);
pub type MsiGetSummaryInformationA = unsafe extern "system" fn(hdatabase: MSIHANDLE, szdatabasepath: windows_sys::core::PCSTR, uiupdatecount: u32, phsummaryinfo: *mut MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetSummaryInformationA(hdatabase : MSIHANDLE, szdatabasepath : windows_sys::core::PCSTR, uiupdatecount : u32, phsummaryinfo : *mut MSIHANDLE) -> u32);
pub type MsiGetSummaryInformationW = unsafe extern "system" fn(hdatabase: MSIHANDLE, szdatabasepath: windows_sys::core::PCWSTR, uiupdatecount: u32, phsummaryinfo: *mut MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetSummaryInformationW(hdatabase : MSIHANDLE, szdatabasepath : windows_sys::core::PCWSTR, uiupdatecount : u32, phsummaryinfo : *mut MSIHANDLE) -> u32);
pub type MsiGetTargetPathA = unsafe extern "system" fn(hinstall: MSIHANDLE, szfolder: windows_sys::core::PCSTR, szpathbuf: windows_sys::core::PSTR, pcchpathbuf: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetTargetPathA(hinstall : MSIHANDLE, szfolder : windows_sys::core::PCSTR, szpathbuf : windows_sys::core::PSTR, pcchpathbuf : *mut u32) -> u32);
pub type MsiGetTargetPathW = unsafe extern "system" fn(hinstall: MSIHANDLE, szfolder: windows_sys::core::PCWSTR, szpathbuf: windows_sys::core::PWSTR, pcchpathbuf: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiGetTargetPathW(hinstall : MSIHANDLE, szfolder : windows_sys::core::PCWSTR, szpathbuf : windows_sys::core::PWSTR, pcchpathbuf : *mut u32) -> u32);
pub type MsiGetUserInfoA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, lpusernamebuf: windows_sys::core::PSTR, pcchusernamebuf: *mut u32, lporgnamebuf: windows_sys::core::PSTR, pcchorgnamebuf: *mut u32, lpserialbuf: windows_sys::core::PSTR, pcchserialbuf: *mut u32) -> USERINFOSTATE;
...
pub type MsiGetUserInfoW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, lpusernamebuf: windows_sys::core::PWSTR, pcchusernamebuf: *mut u32, lporgnamebuf: windows_sys::core::PWSTR, pcchorgnamebuf: *mut u32, lpserialbuf: windows_sys::core::PWSTR, pcchserialbuf: *mut u32) -> USERINFOSTATE;
...
pub type MsiInstallMissingComponentA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, szcomponent: windows_sys::core::PCSTR, einstallstate: INSTALLSTATE) -> u32;
...
pub type MsiInstallMissingComponentW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, szcomponent: windows_sys::core::PCWSTR, einstallstate: INSTALLSTATE) -> u32;
...
pub type MsiInstallMissingFileA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, szfile: windows_sys::core::PCSTR) -> u32;
...
pub type MsiInstallMissingFileW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, szfile: windows_sys::core::PCWSTR) -> u32;
...
pub type MsiInstallProductA = unsafe extern "system" fn(szpackagepath: windows_sys::core::PCSTR, szcommandline: windows_sys::core::PCSTR) -> u32;
...
pub type MsiInstallProductW = unsafe extern "system" fn(szpackagepath: windows_sys::core::PCWSTR, szcommandline: windows_sys::core::PCWSTR) -> u32;
...
pub type MsiIsProductElevatedA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, pfelevated: *mut windows_sys::core::BOOL) -> u32;
...
pub type MsiIsProductElevatedW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, pfelevated: *mut windows_sys::core::BOOL) -> u32;
...
pub type MsiJoinTransaction = unsafe extern "system" fn(htransactionhandle: MSIHANDLE, dwtransactionattributes: u32, phchangeofownerevent: *mut super::super::Foundation::HANDLE) -> u32;
...
pub type MsiLocateComponentA = unsafe extern "system" fn(szcomponent: windows_sys::core::PCSTR, lppathbuf: windows_sys::core::PSTR, pcchbuf: *mut u32) -> INSTALLSTATE;
...
pub type MsiLocateComponentW = unsafe extern "system" fn(szcomponent: windows_sys::core::PCWSTR, lppathbuf: windows_sys::core::PWSTR, pcchbuf: *mut u32) -> INSTALLSTATE;
...
pub type MsiNotifySidChangeA = unsafe extern "system" fn(poldsid: windows_sys::core::PCSTR, pnewsid: windows_sys::core::PCSTR) -> u32;
...
pub type MsiNotifySidChangeW = unsafe extern "system" fn(poldsid: windows_sys::core::PCWSTR, pnewsid: windows_sys::core::PCWSTR) -> u32;
...
pub type MsiOpenDatabaseA = unsafe extern "system" fn(szdatabasepath: windows_sys::core::PCSTR, szpersist: windows_sys::core::PCSTR, phdatabase: *mut MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiOpenDatabaseA(szdatabasepath : windows_sys::core::PCSTR, szpersist : windows_sys::core::PCSTR, phdatabase : *mut MSIHANDLE) -> u32);
pub type MsiOpenDatabaseW = unsafe extern "system" fn(szdatabasepath: windows_sys::core::PCWSTR, szpersist: windows_sys::core::PCWSTR, phdatabase: *mut MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiOpenDatabaseW(szdatabasepath : windows_sys::core::PCWSTR, szpersist : windows_sys::core::PCWSTR, phdatabase : *mut MSIHANDLE) -> u32);
pub type MsiOpenPackageA = unsafe extern "system" fn(szpackagepath: windows_sys::core::PCSTR, hproduct: *mut MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiOpenPackageA(szpackagepath : windows_sys::core::PCSTR, hproduct : *mut MSIHANDLE) -> u32);
pub type MsiOpenPackageExA = unsafe extern "system" fn(szpackagepath: windows_sys::core::PCSTR, dwoptions: u32, hproduct: *mut MSIHANDLE) -> u32;
...
pub type MsiOpenPackageExW = unsafe extern "system" fn(szpackagepath: windows_sys::core::PCWSTR, dwoptions: u32, hproduct: *mut MSIHANDLE) -> u32;
...
pub type MsiOpenPackageW = unsafe extern "system" fn(szpackagepath: windows_sys::core::PCWSTR, hproduct: *mut MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiOpenPackageW(szpackagepath : windows_sys::core::PCWSTR, hproduct : *mut MSIHANDLE) -> u32);
pub type MsiOpenProductA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, hproduct: *mut MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiOpenProductA(szproduct : windows_sys::core::PCSTR, hproduct : *mut MSIHANDLE) -> u32);
pub type MsiOpenProductW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, hproduct: *mut MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiOpenProductW(szproduct : windows_sys::core::PCWSTR, hproduct : *mut MSIHANDLE) -> u32);
pub type MsiPreviewBillboardA = unsafe extern "system" fn(hpreview: MSIHANDLE, szcontrolname: windows_sys::core::PCSTR, szbillboard: windows_sys::core::PCSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiPreviewBillboardA(hpreview : MSIHANDLE, szcontrolname : windows_sys::core::PCSTR, szbillboard : windows_sys::core::PCSTR) -> u32);
pub type MsiPreviewBillboardW = unsafe extern "system" fn(hpreview: MSIHANDLE, szcontrolname: windows_sys::core::PCWSTR, szbillboard: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiPreviewBillboardW(hpreview : MSIHANDLE, szcontrolname : windows_sys::core::PCWSTR, szbillboard : windows_sys::core::PCWSTR) -> u32);
pub type MsiPreviewDialogA = unsafe extern "system" fn(hpreview: MSIHANDLE, szdialogname: windows_sys::core::PCSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiPreviewDialogA(hpreview : MSIHANDLE, szdialogname : windows_sys::core::PCSTR) -> u32);
pub type MsiPreviewDialogW = unsafe extern "system" fn(hpreview: MSIHANDLE, szdialogname: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiPreviewDialogW(hpreview : MSIHANDLE, szdialogname : windows_sys::core::PCWSTR) -> u32);
#[cfg(feature = "Win32_System_Registry")]
pub type MsiProcessAdvertiseScriptA = unsafe extern "system" fn(szscriptfile: windows_sys::core::PCSTR, sziconfolder: windows_sys::core::PCSTR, hregdata: super::Registry::HKEY, fshortcuts: windows_sys::core::BOOL, fremoveitems: windows_sys::core::BOOL) -> u32;
#[cfg(feature = "Win32_System_Registry")]
windows_link::link!("msi.dll" "system" fn MsiProcessAdvertiseScriptA(szscriptfile : windows_sys::core::PCSTR, sziconfolder : windows_sys::core::PCSTR, hregdata : super::Registry::HKEY, fshortcuts : windows_sys::core::BOOL, fremoveitems : windows_sys::core::BOOL) -> u32);
#[cfg(feature = "Win32_System_Registry")]
pub type MsiProcessAdvertiseScriptW = unsafe extern "system" fn(szscriptfile: windows_sys::core::PCWSTR, sziconfolder: windows_sys::core::PCWSTR, hregdata: super::Registry::HKEY, fshortcuts: windows_sys::core::BOOL, fremoveitems: windows_sys::core::BOOL) -> u32;
#[cfg(feature = "Win32_System_Registry")]
...
pub type MsiProcessMessage = unsafe extern "system" fn(hinstall: MSIHANDLE, emessagetype: INSTALLMESSAGE, hrecord: MSIHANDLE) -> i32;
...
pub type MsiProvideAssemblyA = unsafe extern "system" fn(szassemblyname: windows_sys::core::PCSTR, szappcontext: windows_sys::core::PCSTR, dwinstallmode: u32, dwassemblyinfo: MSIASSEMBLYINFO, lppathbuf: windows_sys::core::PSTR, pcchpathbuf: *mut u32) -> u32;
...
pub type MsiProvideAssemblyW = unsafe extern "system" fn(szassemblyname: windows_sys::core::PCWSTR, szappcontext: windows_sys::core::PCWSTR, dwinstallmode: u32, dwassemblyinfo: MSIASSEMBLYINFO, lppathbuf: windows_sys::core::PWSTR, pcchpathbuf: *mut u32) -> u32;
...
pub type MsiProvideComponentA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, szfeature: windows_sys::core::PCSTR, szcomponent: windows_sys::core::PCSTR, dwinstallmode: u32, lppathbuf: windows_sys::core::PSTR, pcchpathbuf: *mut u32) -> u32;
...
pub type MsiProvideComponentW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, szfeature: windows_sys::core::PCWSTR, szcomponent: windows_sys::core::PCWSTR, dwinstallmode: u32, lppathbuf: windows_sys::core::PWSTR, pcchpathbuf: *mut u32) -> u32;
...
pub type MsiProvideQualifiedComponentA = unsafe extern "system" fn(szcategory: windows_sys::core::PCSTR, szqualifier: windows_sys::core::PCSTR, dwinstallmode: u32, lppathbuf: windows_sys::core::PSTR, pcchpathbuf: *mut u32) -> u32;
...
pub type MsiProvideQualifiedComponentExA = unsafe extern "system" fn(szcategory: windows_sys::core::PCSTR, szqualifier: windows_sys::core::PCSTR, dwinstallmode: u32, szproduct: windows_sys::core::PCSTR, dwunused1: u32, dwunused2: u32, lppathbuf: windows_sys::core::PSTR, pcchpathbuf: *mut u32) -> u32;
...
pub type MsiProvideQualifiedComponentExW = unsafe extern "system" fn(szcategory: windows_sys::core::PCWSTR, szqualifier: windows_sys::core::PCWSTR, dwinstallmode: u32, szproduct: windows_sys::core::PCWSTR, dwunused1: u32, dwunused2: u32, lppathbuf: windows_sys::core::PWSTR, pcchpathbuf: *mut u32) -> u32;
...
pub type MsiProvideQualifiedComponentW = unsafe extern "system" fn(szcategory: windows_sys::core::PCWSTR, szqualifier: windows_sys::core::PCWSTR, dwinstallmode: u32, lppathbuf: windows_sys::core::PWSTR, pcchpathbuf: *mut u32) -> u32;
...
pub type MsiQueryComponentStateA = unsafe extern "system" fn(szproductcode: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: MSIINSTALLCONTEXT, szcomponentcode: windows_sys::core::PCSTR, pdwstate: *mut INSTALLSTATE) -> u32;
...
pub type MsiQueryComponentStateW = unsafe extern "system" fn(szproductcode: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: MSIINSTALLCONTEXT, szcomponentcode: windows_sys::core::PCWSTR, pdwstate: *mut INSTALLSTATE) -> u32;
...
pub type MsiQueryFeatureStateA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, szfeature: windows_sys::core::PCSTR) -> INSTALLSTATE;
...
pub type MsiQueryFeatureStateExA = unsafe extern "system" fn(szproductcode: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: MSIINSTALLCONTEXT, szfeature: windows_sys::core::PCSTR, pdwstate: *mut INSTALLSTATE) -> u32;
...
pub type MsiQueryFeatureStateExW = unsafe extern "system" fn(szproductcode: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: MSIINSTALLCONTEXT, szfeature: windows_sys::core::PCWSTR, pdwstate: *mut INSTALLSTATE) -> u32;
...
pub type MsiQueryFeatureStateW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, szfeature: windows_sys::core::PCWSTR) -> INSTALLSTATE;
...
pub type MsiQueryProductStateA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR) -> INSTALLSTATE;
windows_link::link!("msi.dll" "system" fn MsiQueryProductStateA(szproduct : windows_sys::core::PCSTR) -> INSTALLSTATE);
pub type MsiQueryProductStateW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR) -> INSTALLSTATE;
windows_link::link!("msi.dll" "system" fn MsiQueryProductStateW(szproduct : windows_sys::core::PCWSTR) -> INSTALLSTATE);
pub type MsiRecordClearData = unsafe extern "system" fn(hrecord: MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiRecordClearData(hrecord : MSIHANDLE) -> u32);
pub type MsiRecordDataSize = unsafe extern "system" fn(hrecord: MSIHANDLE, ifield: u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiRecordDataSize(hrecord : MSIHANDLE, ifield : u32) -> u32);
pub type MsiRecordGetFieldCount = unsafe extern "system" fn(hrecord: MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiRecordGetFieldCount(hrecord : MSIHANDLE) -> u32);
pub type MsiRecordGetInteger = unsafe extern "system" fn(hrecord: MSIHANDLE, ifield: u32) -> i32;
windows_link::link!("msi.dll" "system" fn MsiRecordGetInteger(hrecord : MSIHANDLE, ifield : u32) -> i32);
pub type MsiRecordGetStringA = unsafe extern "system" fn(hrecord: MSIHANDLE, ifield: u32, szvaluebuf: windows_sys::core::PSTR, pcchvaluebuf: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiRecordGetStringA(hrecord : MSIHANDLE, ifield : u32, szvaluebuf : windows_sys::core::PSTR, pcchvaluebuf : *mut u32) -> u32);
pub type MsiRecordGetStringW = unsafe extern "system" fn(hrecord: MSIHANDLE, ifield: u32, szvaluebuf: windows_sys::core::PWSTR, pcchvaluebuf: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiRecordGetStringW(hrecord : MSIHANDLE, ifield : u32, szvaluebuf : windows_sys::core::PWSTR, pcchvaluebuf : *mut u32) -> u32);
pub type MsiRecordIsNull = unsafe extern "system" fn(hrecord: MSIHANDLE, ifield: u32) -> windows_sys::core::BOOL;
windows_link::link!("msi.dll" "system" fn MsiRecordIsNull(hrecord : MSIHANDLE, ifield : u32) -> windows_sys::core::BOOL);
pub type MsiRecordReadStream = unsafe extern "system" fn(hrecord: MSIHANDLE, ifield: u32, szdatabuf: windows_sys::core::PSTR, pcbdatabuf: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiRecordReadStream(hrecord : MSIHANDLE, ifield : u32, szdatabuf : windows_sys::core::PSTR, pcbdatabuf : *mut u32) -> u32);
pub type MsiRecordSetInteger = unsafe extern "system" fn(hrecord: MSIHANDLE, ifield: u32, ivalue: i32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiRecordSetInteger(hrecord : MSIHANDLE, ifield : u32, ivalue : i32) -> u32);
pub type MsiRecordSetStreamA = unsafe extern "system" fn(hrecord: MSIHANDLE, ifield: u32, szfilepath: windows_sys::core::PCSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiRecordSetStreamA(hrecord : MSIHANDLE, ifield : u32, szfilepath : windows_sys::core::PCSTR) -> u32);
pub type MsiRecordSetStreamW = unsafe extern "system" fn(hrecord: MSIHANDLE, ifield: u32, szfilepath: windows_sys::core::PCWSTR) -> u32;
...
pub type MsiRecordSetStringA = unsafe extern "system" fn(hrecord: MSIHANDLE, ifield: u32, szvalue: windows_sys::core::PCSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiRecordSetStringA(hrecord : MSIHANDLE, ifield : u32, szvalue : windows_sys::core::PCSTR) -> u32);
pub type MsiRecordSetStringW = unsafe extern "system" fn(hrecord: MSIHANDLE, ifield: u32, szvalue: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiRecordSetStringW(hrecord : MSIHANDLE, ifield : u32, szvalue : windows_sys::core::PCWSTR) -> u32);
pub type MsiReinstallFeatureA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, szfeature: windows_sys::core::PCSTR, dwreinstallmode: u32) -> u32;
...
pub type MsiReinstallFeatureW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, szfeature: windows_sys::core::PCWSTR, dwreinstallmode: u32) -> u32;
...
pub type MsiReinstallProductA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, szreinstallmode: u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiReinstallProductA(szproduct : windows_sys::core::PCSTR, szreinstallmode : u32) -> u32);
pub type MsiReinstallProductW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, szreinstallmode: u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiReinstallProductW(szproduct : windows_sys::core::PCWSTR, szreinstallmode : u32) -> u32);
pub type MsiRemovePatchesA = unsafe extern "system" fn(szpatchlist: windows_sys::core::PCSTR, szproductcode: windows_sys::core::PCSTR, euninstalltype: INSTALLTYPE, szpropertylist: windows_sys::core::PCSTR) -> u32;
...
pub type MsiRemovePatchesW = unsafe extern "system" fn(szpatchlist: windows_sys::core::PCWSTR, szproductcode: windows_sys::core::PCWSTR, euninstalltype: INSTALLTYPE, szpropertylist: windows_sys::core::PCWSTR) -> u32;
...
pub type MsiSequenceA = unsafe extern "system" fn(hinstall: MSIHANDLE, sztable: windows_sys::core::PCSTR, isequencemode: i32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSequenceA(hinstall : MSIHANDLE, sztable : windows_sys::core::PCSTR, isequencemode : i32) -> u32);
pub type MsiSequenceW = unsafe extern "system" fn(hinstall: MSIHANDLE, sztable: windows_sys::core::PCWSTR, isequencemode: i32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSequenceW(hinstall : MSIHANDLE, sztable : windows_sys::core::PCWSTR, isequencemode : i32) -> u32);
pub type MsiSetComponentStateA = unsafe extern "system" fn(hinstall: MSIHANDLE, szcomponent: windows_sys::core::PCSTR, istate: INSTALLSTATE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSetComponentStateA(hinstall : MSIHANDLE, szcomponent : windows_sys::core::PCSTR, istate : INSTALLSTATE) -> u32);
pub type MsiSetComponentStateW = unsafe extern "system" fn(hinstall: MSIHANDLE, szcomponent: windows_sys::core::PCWSTR, istate: INSTALLSTATE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSetComponentStateW(hinstall : MSIHANDLE, szcomponent : windows_sys::core::PCWSTR, istate : INSTALLSTATE) -> u32);
pub type MsiSetExternalUIA = unsafe extern "system" fn(puihandler: INSTALLUI_HANDLERA, dwmessagefilter: u32, pvcontext: *const core::ffi::c_void) -> INSTALLUI_HANDLERA;
...
pub type MsiSetExternalUIRecord = unsafe extern "system" fn(puihandler: PINSTALLUI_HANDLER_RECORD, dwmessagefilter: u32, pvcontext: *const core::ffi::c_void, ppuiprevhandler: PINSTALLUI_HANDLER_RECORD) -> u32;
...
pub type MsiSetExternalUIW = unsafe extern "system" fn(puihandler: INSTALLUI_HANDLERW, dwmessagefilter: u32, pvcontext: *const core::ffi::c_void) -> INSTALLUI_HANDLERW;
...
pub type MsiSetFeatureAttributesA = unsafe extern "system" fn(hinstall: MSIHANDLE, szfeature: windows_sys::core::PCSTR, dwattributes: u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSetFeatureAttributesA(hinstall : MSIHANDLE, szfeature : windows_sys::core::PCSTR, dwattributes : u32) -> u32);
pub type MsiSetFeatureAttributesW = unsafe extern "system" fn(hinstall: MSIHANDLE, szfeature: windows_sys::core::PCWSTR, dwattributes: u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSetFeatureAttributesW(hinstall : MSIHANDLE, szfeature : windows_sys::core::PCWSTR, dwattributes : u32) -> u32);
pub type MsiSetFeatureStateA = unsafe extern "system" fn(hinstall: MSIHANDLE, szfeature: windows_sys::core::PCSTR, istate: INSTALLSTATE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSetFeatureStateA(hinstall : MSIHANDLE, szfeature : windows_sys::core::PCSTR, istate : INSTALLSTATE) -> u32);
pub type MsiSetFeatureStateW = unsafe extern "system" fn(hinstall: MSIHANDLE, szfeature: windows_sys::core::PCWSTR, istate: INSTALLSTATE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSetFeatureStateW(hinstall : MSIHANDLE, szfeature : windows_sys::core::PCWSTR, istate : INSTALLSTATE) -> u32);
pub type MsiSetInstallLevel = unsafe extern "system" fn(hinstall: MSIHANDLE, iinstalllevel: i32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSetInstallLevel(hinstall : MSIHANDLE, iinstalllevel : i32) -> u32);
pub type MsiSetInternalUI = unsafe extern "system" fn(dwuilevel: INSTALLUILEVEL, phwnd: *mut super::super::Foundation::HWND) -> INSTALLUILEVEL;
...
pub type MsiSetMode = unsafe extern "system" fn(hinstall: MSIHANDLE, erunmode: MSIRUNMODE, fstate: windows_sys::core::BOOL) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSetMode(hinstall : MSIHANDLE, erunmode : MSIRUNMODE, fstate : windows_sys::core::BOOL) -> u32);
pub type MsiSetPropertyA = unsafe extern "system" fn(hinstall: MSIHANDLE, szname: windows_sys::core::PCSTR, szvalue: windows_sys::core::PCSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSetPropertyA(hinstall : MSIHANDLE, szname : windows_sys::core::PCSTR, szvalue : windows_sys::core::PCSTR) -> u32);
pub type MsiSetPropertyW = unsafe extern "system" fn(hinstall: MSIHANDLE, szname: windows_sys::core::PCWSTR, szvalue: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSetPropertyW(hinstall : MSIHANDLE, szname : windows_sys::core::PCWSTR, szvalue : windows_sys::core::PCWSTR) -> u32);
pub type MsiSetTargetPathA = unsafe extern "system" fn(hinstall: MSIHANDLE, szfolder: windows_sys::core::PCSTR, szfolderpath: windows_sys::core::PCSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSetTargetPathA(hinstall : MSIHANDLE, szfolder : windows_sys::core::PCSTR, szfolderpath : windows_sys::core::PCSTR) -> u32);
pub type MsiSetTargetPathW = unsafe extern "system" fn(hinstall: MSIHANDLE, szfolder: windows_sys::core::PCWSTR, szfolderpath: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSetTargetPathW(hinstall : MSIHANDLE, szfolder : windows_sys::core::PCWSTR, szfolderpath : windows_sys::core::PCWSTR) -> u32);
pub type MsiSourceListAddMediaDiskA = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32, dwdiskid: u32, szvolumelabel: windows_sys::core::PCSTR, szdiskprompt: windows_sys::core::PCSTR) -> u32;
...
pub type MsiSourceListAddMediaDiskW = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32, dwdiskid: u32, szvolumelabel: windows_sys::core::PCWSTR, szdiskprompt: windows_sys::core::PCWSTR) -> u32;
...
pub type MsiSourceListAddSourceA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, szusername: windows_sys::core::PCSTR, dwreserved: u32, szsource: windows_sys::core::PCSTR) -> u32;
...
pub type MsiSourceListAddSourceExA = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32, szsource: windows_sys::core::PCSTR, dwindex: u32) -> u32;
...
pub type MsiSourceListAddSourceExW = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32, szsource: windows_sys::core::PCWSTR, dwindex: u32) -> u32;
...
pub type MsiSourceListAddSourceW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, szusername: windows_sys::core::PCWSTR, dwreserved: u32, szsource: windows_sys::core::PCWSTR) -> u32;
...
pub type MsiSourceListClearAllA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, szusername: windows_sys::core::PCSTR, dwreserved: u32) -> u32;
...
pub type MsiSourceListClearAllExA = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32) -> u32;
...
pub type MsiSourceListClearAllExW = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32) -> u32;
...
pub type MsiSourceListClearAllW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, szusername: windows_sys::core::PCWSTR, dwreserved: u32) -> u32;
...
pub type MsiSourceListClearMediaDiskA = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32, dwdiskid: u32) -> u32;
...
pub type MsiSourceListClearMediaDiskW = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32, dwdiskid: u32) -> u32;
...
pub type MsiSourceListClearSourceA = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32, szsource: windows_sys::core::PCSTR) -> u32;
...
pub type MsiSourceListClearSourceW = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32, szsource: windows_sys::core::PCWSTR) -> u32;
...
pub type MsiSourceListEnumMediaDisksA = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32, dwindex: u32, pdwdiskid: *mut u32, szvolumelabel: windows_sys::core::PSTR, pcchvolumelabel: *mut u32, szdiskprompt: windows_sys::core::PSTR, pcchdiskprompt: *mut u32) -> u32;
...
pub type MsiSourceListEnumMediaDisksW = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32, dwindex: u32, pdwdiskid: *mut u32, szvolumelabel: windows_sys::core::PWSTR, pcchvolumelabel: *mut u32, szdiskprompt: windows_sys::core::PWSTR, pcchdiskprompt: *mut u32) -> u32;
...
pub type MsiSourceListEnumSourcesA = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32, dwindex: u32, szsource: windows_sys::core::PSTR, pcchsource: *mut u32) -> u32;
...
pub type MsiSourceListEnumSourcesW = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32, dwindex: u32, szsource: windows_sys::core::PWSTR, pcchsource: *mut u32) -> u32;
...
pub type MsiSourceListForceResolutionA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, szusername: windows_sys::core::PCSTR, dwreserved: u32) -> u32;
...
pub type MsiSourceListForceResolutionExA = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32) -> u32;
...
pub type MsiSourceListForceResolutionExW = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32) -> u32;
...
pub type MsiSourceListForceResolutionW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, szusername: windows_sys::core::PCWSTR, dwreserved: u32) -> u32;
...
pub type MsiSourceListGetInfoA = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32, szproperty: windows_sys::core::PCSTR, szvalue: windows_sys::core::PSTR, pcchvalue: *mut u32) -> u32;
...
pub type MsiSourceListGetInfoW = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32, szproperty: windows_sys::core::PCWSTR, szvalue: windows_sys::core::PWSTR, pcchvalue: *mut u32) -> u32;
...
pub type MsiSourceListSetInfoA = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCSTR, szusersid: windows_sys::core::PCSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32, szproperty: windows_sys::core::PCSTR, szvalue: windows_sys::core::PCSTR) -> u32;
...
pub type MsiSourceListSetInfoW = unsafe extern "system" fn(szproductcodeorpatchcode: windows_sys::core::PCWSTR, szusersid: windows_sys::core::PCWSTR, dwcontext: MSIINSTALLCONTEXT, dwoptions: u32, szproperty: windows_sys::core::PCWSTR, szvalue: windows_sys::core::PCWSTR) -> u32;
...
pub type MsiSummaryInfoGetPropertyA = unsafe extern "system" fn(hsummaryinfo: MSIHANDLE, uiproperty: u32, puidatatype: *mut u32, pivalue: *mut i32, pftvalue: *mut super::super::Foundation::FILETIME, szvaluebuf: windows_sys::core::PSTR, pcchvaluebuf: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSummaryInfoGetPropertyA(hsummaryinfo : MSIHANDLE, uiproperty : u32, puidatatype : *mut u32, pivalue : *mut i32, pftvalue : *mut super::super::Foundation::FILETIME, szvaluebuf : windows_sys::core::PSTR, pcchvaluebuf : *mut u32) -> u32);
pub type MsiSummaryInfoGetPropertyCount = unsafe extern "system" fn(hsummaryinfo: MSIHANDLE, puipropertycount: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSummaryInfoGetPropertyCount(hsummaryinfo : MSIHANDLE, puipropertycount : *mut u32) -> u32);
pub type MsiSummaryInfoGetPropertyW = unsafe extern "system" fn(hsummaryinfo: MSIHANDLE, uiproperty: u32, puidatatype: *mut u32, pivalue: *mut i32, pftvalue: *mut super::super::Foundation::FILETIME, szvaluebuf: windows_sys::core::PWSTR, pcchvaluebuf: *mut u32) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSummaryInfoGetPropertyW(hsummaryinfo : MSIHANDLE, uiproperty : u32, puidatatype : *mut u32, pivalue : *mut i32, pftvalue : *mut super::super::Foundation::FILETIME, szvaluebuf : windows_sys::core::PWSTR, pcchvaluebuf : *mut u32) -> u32);
pub type MsiSummaryInfoPersist = unsafe extern "system" fn(hsummaryinfo: MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSummaryInfoPersist(hsummaryinfo : MSIHANDLE) -> u32);
pub type MsiSummaryInfoSetPropertyA = unsafe extern "system" fn(hsummaryinfo: MSIHANDLE, uiproperty: u32, uidatatype: u32, ivalue: i32, pftvalue: *mut super::super::Foundation::FILETIME, szvalue: windows_sys::core::PCSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSummaryInfoSetPropertyA(hsummaryinfo : MSIHANDLE, uiproperty : u32, uidatatype : u32, ivalue : i32, pftvalue : *mut super::super::Foundation::FILETIME, szvalue : windows_sys::core::PCSTR) -> u32);
pub type MsiSummaryInfoSetPropertyW = unsafe extern "system" fn(hsummaryinfo: MSIHANDLE, uiproperty: u32, uidatatype: u32, ivalue: i32, pftvalue: *mut super::super::Foundation::FILETIME, szvalue: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiSummaryInfoSetPropertyW(hsummaryinfo : MSIHANDLE, uiproperty : u32, uidatatype : u32, ivalue : i32, pftvalue : *mut super::super::Foundation::FILETIME, szvalue : windows_sys::core::PCWSTR) -> u32);
pub type MsiUseFeatureA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, szfeature: windows_sys::core::PCSTR) -> INSTALLSTATE;
...
pub type MsiUseFeatureExA = unsafe extern "system" fn(szproduct: windows_sys::core::PCSTR, szfeature: windows_sys::core::PCSTR, dwinstallmode: u32, dwreserved: u32) -> INSTALLSTATE;
...
pub type MsiUseFeatureExW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, szfeature: windows_sys::core::PCWSTR, dwinstallmode: u32, dwreserved: u32) -> INSTALLSTATE;
...
pub type MsiUseFeatureW = unsafe extern "system" fn(szproduct: windows_sys::core::PCWSTR, szfeature: windows_sys::core::PCWSTR) -> INSTALLSTATE;
...
pub type MsiVerifyDiskSpace = unsafe extern "system" fn(hinstall: MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiVerifyDiskSpace(hinstall : MSIHANDLE) -> u32);
pub type MsiVerifyPackageA = unsafe extern "system" fn(szpackagepath: windows_sys::core::PCSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiVerifyPackageA(szpackagepath : windows_sys::core::PCSTR) -> u32);
pub type MsiVerifyPackageW = unsafe extern "system" fn(szpackagepath: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("msi.dll" "system" fn MsiVerifyPackageW(szpackagepath : windows_sys::core::PCWSTR) -> u32);
pub type MsiViewClose = unsafe extern "system" fn(hview: MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiViewClose(hview : MSIHANDLE) -> u32);
pub type MsiViewExecute = unsafe extern "system" fn(hview: MSIHANDLE, hrecord: MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiViewExecute(hview : MSIHANDLE, hrecord : MSIHANDLE) -> u32);
pub type MsiViewFetch = unsafe extern "system" fn(hview: MSIHANDLE, phrecord: *mut MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiViewFetch(hview : MSIHANDLE, phrecord : *mut MSIHANDLE) -> u32);
pub type MsiViewGetColumnInfo = unsafe extern "system" fn(hview: MSIHANDLE, ecolumninfo: MSICOLINFO, phrecord: *mut MSIHANDLE) -> u32;
...
pub type MsiViewGetErrorA = unsafe extern "system" fn(hview: MSIHANDLE, szcolumnnamebuffer: windows_sys::core::PSTR, pcchbuf: *mut u32) -> MSIDBERROR;
windows_link::link!("msi.dll" "system" fn MsiViewGetErrorA(hview : MSIHANDLE, szcolumnnamebuffer : windows_sys::core::PSTR, pcchbuf : *mut u32) -> MSIDBERROR);
pub type MsiViewGetErrorW = unsafe extern "system" fn(hview: MSIHANDLE, szcolumnnamebuffer: windows_sys::core::PWSTR, pcchbuf: *mut u32) -> MSIDBERROR;
windows_link::link!("msi.dll" "system" fn MsiViewGetErrorW(hview : MSIHANDLE, szcolumnnamebuffer : windows_sys::core::PWSTR, pcchbuf : *mut u32) -> MSIDBERROR);
pub type MsiViewModify = unsafe extern "system" fn(hview: MSIHANDLE, emodifymode: MSIMODIFY, hrecord: MSIHANDLE) -> u32;
windows_link::link!("msi.dll" "system" fn MsiViewModify(hview : MSIHANDLE, emodifymode : MSIMODIFY, hrecord : MSIHANDLE) -> u32);
pub type NormalizeFileForPatchSignature = unsafe extern "system" fn(filebuffer: *mut core::ffi::c_void, filesize: u32, optionflags: u32, optiondata: *const PATCH_OPTION_DATA, newfilecoffbase: u32, newfilecofftime: u32, ignorerangecount: u32, ignorerangearray: *const PATCH_IGNORE_RANGE, retainrangecount: u32, retainrangearray: *const PATCH_RETAIN_RANGE) -> i32;
...
pub type QueryActCtxSettingsW = unsafe extern "system" fn(dwflags: u32, hactctx: super::super::Foundation::HANDLE, settingsnamespace: windows_sys::core::PCWSTR, settingname: windows_sys::core::PCWSTR, pvbuffer: windows_sys::core::PWSTR, dwbuffer: usize, pdwwrittenorrequired: *mut usize) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn QueryActCtxSettingsW(dwflags : u32, hactctx : super::super::Foundation::HANDLE, settingsnamespace : windows_sys::core::PCWSTR, settingname : windows_sys::core::PCWSTR, pvbuffer : windows_sys::core::PWSTR, dwbuffer : usize, pdwwrittenorrequired : *mut usize) -> windows_sys::core::BOOL);
pub type QueryActCtxW = unsafe extern "system" fn(dwflags: u32, hactctx: super::super::Foundation::HANDLE, pvsubinstance: *const core::ffi::c_void, ulinfoclass: u32, pvbuffer: *mut core::ffi::c_void, cbbuffer: usize, pcbwrittenorrequired: *mut usize) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn QueryActCtxW(dwflags : u32, hactctx : super::super::Foundation::HANDLE, pvsubinstance : *const core::ffi::c_void, ulinfoclass : u32, pvbuffer : *mut core::ffi::c_void, cbbuffer : usize, pcbwrittenorrequired : *mut usize) -> windows_sys::core::BOOL);
pub type ReleaseActCtx = unsafe extern "system" fn(hactctx: super::super::Foundation::HANDLE);
windows_link::link!("kernel32.dll" "system" fn ReleaseActCtx(hactctx : super::super::Foundation::HANDLE));
pub type SfcGetNextProtectedFile = unsafe extern "system" fn(rpchandle: super::super::Foundation::HANDLE, protfiledata: *mut PROTECTED_FILE_DATA) -> windows_sys::core::BOOL;
windows_link::link!("sfc.dll" "system" fn SfcGetNextProtectedFile(rpchandle : super::super::Foundation::HANDLE, protfiledata : *mut PROTECTED_FILE_DATA) -> windows_sys::core::BOOL);
pub type SfcIsFileProtected = unsafe extern "system" fn(rpchandle: super::super::Foundation::HANDLE, protfilename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
windows_link::link!("sfc.dll" "system" fn SfcIsFileProtected(rpchandle : super::super::Foundation::HANDLE, protfilename : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_System_Registry")]
pub type SfcIsKeyProtected = unsafe extern "system" fn(keyhandle: super::Registry::HKEY, subkeyname: windows_sys::core::PCWSTR, keysam: u32) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_System_Registry")]
windows_link::link!("sfc.dll" "system" fn SfcIsKeyProtected(keyhandle : super::Registry::HKEY, subkeyname : windows_sys::core::PCWSTR, keysam : u32) -> windows_sys::core::BOOL);
pub type SfpVerifyFile = unsafe extern "system" fn(pszfilename: windows_sys::core::PCSTR, pszerror: windows_sys::core::PCSTR, dwerrsize: u32) -> windows_sys::core::BOOL;
windows_link::link!("sfc.dll" "system" fn SfpVerifyFile(pszfilename : windows_sys::core::PCSTR, pszerror : windows_sys::core::PCSTR, dwerrsize : u32) -> windows_sys::core::BOOL);
pub type TestApplyPatchToFileA = unsafe extern "system" fn(patchfilename: windows_sys::core::PCSTR, oldfilename: windows_sys::core::PCSTR, applyoptionflags: u32) -> windows_sys::core::BOOL;
...
pub type TestApplyPatchToFileByBuffers = unsafe extern "system" fn(patchfilebuffer: *const u8, patchfilesize: u32, oldfilebuffer: *const u8, oldfilesize: u32, newfilesize: *mut u32, applyoptionflags: u32) -> windows_sys::core::BOOL;
...
pub type TestApplyPatchToFileByHandles = unsafe extern "system" fn(patchfilehandle: super::super::Foundation::HANDLE, oldfilehandle: super::super::Foundation::HANDLE, applyoptionflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("mspatcha.dll" "system" fn TestApplyPatchToFileByHandles(patchfilehandle : super::super::Foundation::HANDLE, oldfilehandle : super::super::Foundation::HANDLE, applyoptionflags : u32) -> windows_sys::core::BOOL);
pub type TestApplyPatchToFileW = unsafe extern "system" fn(patchfilename: windows_sys::core::PCWSTR, oldfilename: windows_sys::core::PCWSTR, applyoptionflags: u32) -> windows_sys::core::BOOL;
...
pub type ZombifyActCtx = unsafe extern "system" fn(hactctx: super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
