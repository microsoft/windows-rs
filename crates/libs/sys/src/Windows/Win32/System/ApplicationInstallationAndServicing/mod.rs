...
pub const ASM_BINDF_BINPATH_PROBE_ONLY: ASM_BIND_FLAGS = 8;
pub const ASM_BINDF_FORCE_CACHE_INSTALL: ASM_BIND_FLAGS = 1;
pub const ASM_BINDF_PARENT_ASM_HINT: ASM_BIND_FLAGS = 32;
pub const ASM_BINDF_RFS_INTEGRITY_CHECK: ASM_BIND_FLAGS = 2;
pub const ASM_BINDF_RFS_MODULE_CHECK: ASM_BIND_FLAGS = 4;
pub const ASM_BINDF_SHARED_BINPATH_HINT: ASM_BIND_FLAGS = 16;
pub type ASM_BIND_FLAGS = i32;
pub const ASM_CMPF_ALL: ASM_CMP_FLAGS = 255;
pub const ASM_CMPF_BUILD_NUMBER: ASM_CMP_FLAGS = 8;
pub const ASM_CMPF_CULTURE: ASM_CMP_FLAGS = 64;
pub const ASM_CMPF_CUSTOM: ASM_CMP_FLAGS = 128;
pub const ASM_CMPF_DEFAULT: ASM_CMP_FLAGS = 256;
pub const ASM_CMPF_MAJOR_VERSION: ASM_CMP_FLAGS = 2;
pub const ASM_CMPF_MINOR_VERSION: ASM_CMP_FLAGS = 4;
pub const ASM_CMPF_NAME: ASM_CMP_FLAGS = 1;
pub const ASM_CMPF_PUBLIC_KEY_TOKEN: ASM_CMP_FLAGS = 32;
pub const ASM_CMPF_REVISION_NUMBER: ASM_CMP_FLAGS = 16;
pub type ASM_CMP_FLAGS = i32;
pub const ASM_DISPLAYF_CULTURE: ASM_DISPLAY_FLAGS = 2;
pub const ASM_DISPLAYF_CUSTOM: ASM_DISPLAY_FLAGS = 16;
pub const ASM_DISPLAYF_LANGUAGEID: ASM_DISPLAY_FLAGS = 64;
pub const ASM_DISPLAYF_PROCESSORARCHITECTURE: ASM_DISPLAY_FLAGS = 32;
pub const ASM_DISPLAYF_PUBLIC_KEY: ASM_DISPLAY_FLAGS = 8;
pub const ASM_DISPLAYF_PUBLIC_KEY_TOKEN: ASM_DISPLAY_FLAGS = 4;
pub const ASM_DISPLAYF_VERSION: ASM_DISPLAY_FLAGS = 1;
pub type ASM_DISPLAY_FLAGS = i32;
pub type ASM_NAME = i32;
pub const ASM_NAME_ALIAS: ASM_NAME = 12;
pub const ASM_NAME_BUILD_NUMBER: ASM_NAME = 6;
pub const ASM_NAME_CODEBASE_LASTMOD: ASM_NAME = 14;
pub const ASM_NAME_CODEBASE_URL: ASM_NAME = 13;
pub const ASM_NAME_CULTURE: ASM_NAME = 8;
pub const ASM_NAME_CUSTOM: ASM_NAME = 17;
pub const ASM_NAME_HASH_ALGID: ASM_NAME = 11;
pub const ASM_NAME_HASH_VALUE: ASM_NAME = 2;
pub const ASM_NAME_MAJOR_VERSION: ASM_NAME = 4;
pub const ASM_NAME_MAX_PARAMS: ASM_NAME = 20;
pub const ASM_NAME_MINOR_VERSION: ASM_NAME = 5;
pub const ASM_NAME_MVID: ASM_NAME = 19;
pub const ASM_NAME_NAME: ASM_NAME = 3;
pub const ASM_NAME_NULL_CUSTOM: ASM_NAME = 18;
pub const ASM_NAME_NULL_PUBLIC_KEY: ASM_NAME = 15;
pub const ASM_NAME_NULL_PUBLIC_KEY_TOKEN: ASM_NAME = 16;
pub const ASM_NAME_OSINFO_ARRAY: ASM_NAME = 10;
pub const ASM_NAME_PROCESSOR_ID_ARRAY: ASM_NAME = 9;
pub const ASM_NAME_PUBLIC_KEY: ASM_NAME = 0;
pub const ASM_NAME_PUBLIC_KEY_TOKEN: ASM_NAME = 1;
pub const ASM_NAME_REVISION_NUMBER: ASM_NAME = 7;
...
pub const CANOF_PARSE_DISPLAY_NAME: CREATE_ASM_NAME_OBJ_FLAGS = 1;
pub const CANOF_SET_DEFAULT_VALUES: CREATE_ASM_NAME_OBJ_FLAGS = 2;
...
pub const IASSEMBLYCACHE_UNINSTALL_DISPOSITION_ALREADY_UNINSTALLED: IASSEMBLYCACHE_UNINSTALL_DISPOSITION = 3;
pub const IASSEMBLYCACHE_UNINSTALL_DISPOSITION_DELETE_PENDING: IASSEMBLYCACHE_UNINSTALL_DISPOSITION = 4;
pub const IASSEMBLYCACHE_UNINSTALL_DISPOSITION_STILL_IN_USE: IASSEMBLYCACHE_UNINSTALL_DISPOSITION = 2;
pub const IASSEMBLYCACHE_UNINSTALL_DISPOSITION_UNINSTALLED: IASSEMBLYCACHE_UNINSTALL_DISPOSITION = 1;
...
pub const MSIASSEMBLYINFO_NETASSEMBLY: MSIASSEMBLYINFO = 0;
pub const MSIASSEMBLYINFO_WIN32ASSEMBLY: MSIASSEMBLYINFO = 1;
...
pub const MSIDBOPEN_CREATE: windows_sys::core::PCWSTR = 3 as _;
pub const MSIDBOPEN_CREATEDIRECT: windows_sys::core::PCWSTR = 4 as _;
pub const MSIDBOPEN_DIRECT: windows_sys::core::PCWSTR = 2 as _;
pub const MSIDBOPEN_PATCHFILE: i32 = 16;
pub const MSIDBOPEN_READONLY: windows_sys::core::PCWSTR = 0 as _;
pub const MSIDBOPEN_TRANSACT: windows_sys::core::PCWSTR = 1 as _;
...
pub const MSITRANSFORM_ERROR_NONE: MSITRANSFORM_ERROR = 0;
...
pub const PACKMAN_RUNTIME_INVALID: PACKMAN_RUNTIME = 6;
pub const PACKMAN_RUNTIME_JUPITER: PACKMAN_RUNTIME = 5;
pub const PACKMAN_RUNTIME_MODERN_NATIVE: PACKMAN_RUNTIME = 4;
pub const PACKMAN_RUNTIME_NATIVE: PACKMAN_RUNTIME = 1;
...
pub const PM_ACTIVATION_POLICY_INVALID: PM_ACTIVATION_POLICY = 7;
pub const PM_ACTIVATION_POLICY_MULTISESSION: PM_ACTIVATION_POLICY = 4;
pub const PM_ACTIVATION_POLICY_REPLACE: PM_ACTIVATION_POLICY = 2;
pub const PM_ACTIVATION_POLICY_REPLACESAMEPARAMS: PM_ACTIVATION_POLICY = 3;
pub const PM_ACTIVATION_POLICY_REPLACE_IGNOREFOREGROUND: PM_ACTIVATION_POLICY = 5;
pub const PM_ACTIVATION_POLICY_RESUME: PM_ACTIVATION_POLICY = 0;
pub const PM_ACTIVATION_POLICY_RESUMESAMEPARAMS: PM_ACTIVATION_POLICY = 1;
pub const PM_ACTIVATION_POLICY_UNKNOWN: PM_ACTIVATION_POLICY = 6;
pub type PM_APPLICATION_HUBTYPE = i32;
pub const PM_APPLICATION_HUBTYPE_INVALID: PM_APPLICATION_HUBTYPE = 2;
pub const PM_APPLICATION_HUBTYPE_MUSIC: PM_APPLICATION_HUBTYPE = 1;
pub const PM_APPLICATION_HUBTYPE_NONMUSIC: PM_APPLICATION_HUBTYPE = 0;
pub const PM_APPLICATION_INSTALL_DEBUG: PM_APPLICATION_INSTALL_TYPE = 3;
pub const PM_APPLICATION_INSTALL_ENTERPRISE: PM_APPLICATION_INSTALL_TYPE = 4;
pub const PM_APPLICATION_INSTALL_INVALID: PM_APPLICATION_INSTALL_TYPE = 5;
pub const PM_APPLICATION_INSTALL_IN_ROM: PM_APPLICATION_INSTALL_TYPE = 1;
pub const PM_APPLICATION_INSTALL_NORMAL: PM_APPLICATION_INSTALL_TYPE = 0;
pub const PM_APPLICATION_INSTALL_PA: PM_APPLICATION_INSTALL_TYPE = 2;
pub type PM_APPLICATION_INSTALL_TYPE = i32;
pub type PM_APPLICATION_STATE = i32;
pub const PM_APPLICATION_STATE_DISABLED_BACKING_UP: PM_APPLICATION_STATE = 9;
pub const PM_APPLICATION_STATE_DISABLED_ENTERPRISE: PM_APPLICATION_STATE = 8;
pub const PM_APPLICATION_STATE_DISABLED_MDIL_BINDING: PM_APPLICATION_STATE = 10;
pub const PM_APPLICATION_STATE_DISABLED_SD_CARD: PM_APPLICATION_STATE = 7;
pub const PM_APPLICATION_STATE_INSTALLED: PM_APPLICATION_STATE = 1;
pub const PM_APPLICATION_STATE_INSTALLING: PM_APPLICATION_STATE = 2;
pub const PM_APPLICATION_STATE_INVALID: PM_APPLICATION_STATE = 11;
pub const PM_APPLICATION_STATE_LICENSE_UPDATING: PM_APPLICATION_STATE = 5;
pub const PM_APPLICATION_STATE_MAX: PM_APPLICATION_STATE = 10;
pub const PM_APPLICATION_STATE_MIN: PM_APPLICATION_STATE = 0;
pub const PM_APPLICATION_STATE_MOVING: PM_APPLICATION_STATE = 6;
...
pub const PM_APP_FILTER_ALL: PM_ENUM_APP_FILTER = 0;
pub const PM_APP_FILTER_ALL_INCLUDE_MODERN: PM_ENUM_APP_FILTER = 6;
pub const PM_APP_FILTER_FRAMEWORK: PM_ENUM_APP_FILTER = 7;
pub const PM_APP_FILTER_GENRE: PM_ENUM_APP_FILTER = 2;
pub const PM_APP_FILTER_HUBTYPE: PM_ENUM_APP_FILTER = 4;
pub const PM_APP_FILTER_MAX: PM_ENUM_APP_FILTER = 8;
pub const PM_APP_FILTER_NONGAMES: PM_ENUM_APP_FILTER = 3;
pub const PM_APP_FILTER_PINABLEONKIDZONE: PM_ENUM_APP_FILTER = 5;
pub const PM_APP_FILTER_VISIBLE: PM_ENUM_APP_FILTER = 1;
pub type PM_APP_GENRE = i32;
pub const PM_APP_GENRE_GAMES: PM_APP_GENRE = 0;
...
pub const PM_ENUM_BSA_FILTER_ALL: PM_ENUM_BSA_FILTER = 26;
pub const PM_ENUM_BSA_FILTER_BY_ALL_LAUNCHONBOOT: PM_ENUM_BSA_FILTER = 30;
pub const PM_ENUM_BSA_FILTER_BY_PERIODIC: PM_ENUM_BSA_FILTER = 29;
pub const PM_ENUM_BSA_FILTER_BY_PRODUCTID: PM_ENUM_BSA_FILTER = 28;
pub const PM_ENUM_BSA_FILTER_BY_TASKID: PM_ENUM_BSA_FILTER = 27;
pub const PM_ENUM_BSA_FILTER_MAX: PM_ENUM_BSA_FILTER = 31;
pub type PM_ENUM_BW_FILTER = i32;
pub const PM_ENUM_BW_FILTER_BOOTWORKER_ALL: PM_ENUM_BW_FILTER = 31;
pub const PM_ENUM_BW_FILTER_BY_TASKID: PM_ENUM_BW_FILTER = 32;
pub const PM_ENUM_BW_FILTER_MAX: PM_ENUM_BW_FILTER = 33;
pub type PM_ENUM_EXTENSION_FILTER = i32;
pub const PM_ENUM_EXTENSION_FILTER_APPCONNECT: PM_ENUM_EXTENSION_FILTER = 17;
pub const PM_ENUM_EXTENSION_FILTER_BY_CONSUMER: PM_ENUM_EXTENSION_FILTER = 17;
pub const PM_ENUM_EXTENSION_FILTER_CACHEDFILEUPDATER_ALL: PM_ENUM_EXTENSION_FILTER = 25;
pub const PM_ENUM_EXTENSION_FILTER_FILEOPENPICKER_ALL: PM_ENUM_EXTENSION_FILTER = 23;
pub const PM_ENUM_EXTENSION_FILTER_FILESAVEPICKER_ALL: PM_ENUM_EXTENSION_FILTER = 24;
pub const PM_ENUM_EXTENSION_FILTER_FTASSOC_APPLICATION_ALL: PM_ENUM_EXTENSION_FILTER = 21;
pub const PM_ENUM_EXTENSION_FILTER_FTASSOC_CONTENTTYPE_ALL: PM_ENUM_EXTENSION_FILTER = 20;
pub const PM_ENUM_EXTENSION_FILTER_FTASSOC_FILETYPE_ALL: PM_ENUM_EXTENSION_FILTER = 19;
pub const PM_ENUM_EXTENSION_FILTER_MAX: PM_ENUM_EXTENSION_FILTER = 26;
...
pub const PM_LIVETILE_RECURRENCE_TYPE_INSTANT: PM_LIVETILE_RECURRENCE_TYPE = 0;
pub const PM_LIVETILE_RECURRENCE_TYPE_INTERVAL: PM_LIVETILE_RECURRENCE_TYPE = 2;
pub const PM_LIVETILE_RECURRENCE_TYPE_MAX: PM_LIVETILE_RECURRENCE_TYPE = 2;
pub const PM_LIVETILE_RECURRENCE_TYPE_ONETIME: PM_LIVETILE_RECURRENCE_TYPE = 1;
pub type PM_LOGO_SIZE = i32;
pub const PM_LOGO_SIZE_INVALID: PM_LOGO_SIZE = 3;
pub const PM_LOGO_SIZE_LARGE: PM_LOGO_SIZE = 2;
...
pub const PM_STARTTILE_TYPE_APPLIST: PM_STARTTILE_TYPE = 3;
pub const PM_STARTTILE_TYPE_APPLISTPRIMARY: PM_STARTTILE_TYPE = 4;
pub const PM_STARTTILE_TYPE_INVALID: PM_STARTTILE_TYPE = 5;
pub const PM_STARTTILE_TYPE_PRIMARY: PM_STARTTILE_TYPE = 1;
pub const PM_STARTTILE_TYPE_SECONDARY: PM_STARTTILE_TYPE = 2;
pub const PM_TASK_FILTER_APP_ALL: PM_ENUM_TASK_FILTER = 12;
pub const PM_TASK_FILTER_APP_TASK_TYPE: PM_ENUM_TASK_FILTER = 15;
pub const PM_TASK_FILTER_BGEXECUTION: PM_ENUM_TASK_FILTER = 16;
pub const PM_TASK_FILTER_DEHYD_SUPRESSING: PM_ENUM_TASK_FILTER = 14;
pub const PM_TASK_FILTER_MAX: PM_ENUM_TASK_FILTER = 17;
pub const PM_TASK_FILTER_TASK_TYPE: PM_ENUM_TASK_FILTER = 13;
pub type PM_TASK_TRANSITION = i32;
pub const PM_TASK_TRANSITION_CUSTOM: PM_TASK_TRANSITION = 6;
pub const PM_TASK_TRANSITION_DEFAULT: PM_TASK_TRANSITION = 0;
pub const PM_TASK_TRANSITION_INVALID: PM_TASK_TRANSITION = 7;
pub const PM_TASK_TRANSITION_NONE: PM_TASK_TRANSITION = 1;
pub const PM_TASK_TRANSITION_READERBOARD: PM_TASK_TRANSITION = 5;
pub const PM_TASK_TRANSITION_SLIDE: PM_TASK_TRANSITION = 3;
pub const PM_TASK_TRANSITION_SWIVEL: PM_TASK_TRANSITION = 4;
pub const PM_TASK_TRANSITION_TURNSTILE: PM_TASK_TRANSITION = 2;
pub type PM_TASK_TYPE = i32;
pub const PM_TASK_TYPE_BACKGROUNDSERVICEAGENT: PM_TASK_TYPE = 3;
pub const PM_TASK_TYPE_BACKGROUNDWORKER: PM_TASK_TYPE = 4;
pub const PM_TASK_TYPE_DEFAULT: PM_TASK_TYPE = 1;
pub const PM_TASK_TYPE_INVALID: PM_TASK_TYPE = 5;
pub const PM_TASK_TYPE_NORMAL: PM_TASK_TYPE = 0;
pub const PM_TASK_TYPE_SETTINGS: PM_TASK_TYPE = 2;
pub const PM_TILE_FILTER_APPLIST: PM_ENUM_TILE_FILTER = 8;
pub const PM_TILE_FILTER_APP_ALL: PM_ENUM_TILE_FILTER = 11;
pub const PM_TILE_FILTER_HUBTYPE: PM_ENUM_TILE_FILTER = 10;
pub const PM_TILE_FILTER_MAX: PM_ENUM_TILE_FILTER = 12;
pub const PM_TILE_FILTER_PINNED: PM_ENUM_TILE_FILTER = 9;
pub type PM_TILE_HUBTYPE = i32;
pub const PM_TILE_HUBTYPE_APPLIST: PM_TILE_HUBTYPE = 1073741824;
pub const PM_TILE_HUBTYPE_CACHED: PM_TILE_HUBTYPE = 67108864;
pub const PM_TILE_HUBTYPE_GAMES: PM_TILE_HUBTYPE = 536870912;
pub const PM_TILE_HUBTYPE_INVALID: PM_TILE_HUBTYPE = 67108865;
pub const PM_TILE_HUBTYPE_KIDZONE: PM_TILE_HUBTYPE = 33554432;
pub const PM_TILE_HUBTYPE_LOCKSCREEN: PM_TILE_HUBTYPE = 16777216;
pub const PM_TILE_HUBTYPE_MOSETTINGS: PM_TILE_HUBTYPE = 268435456;
pub const PM_TILE_HUBTYPE_MUSIC: PM_TILE_HUBTYPE = 1;
pub const PM_TILE_HUBTYPE_STARTMENU: PM_TILE_HUBTYPE = -2147483648;
pub type PM_TILE_SIZE = i32;
pub const PM_TILE_SIZE_INVALID: PM_TILE_SIZE = 5;
pub const PM_TILE_SIZE_LARGE: PM_TILE_SIZE = 2;
pub const PM_TILE_SIZE_MEDIUM: PM_TILE_SIZE = 1;
pub const PM_TILE_SIZE_SMALL: PM_TILE_SIZE = 0;
...
pub const QUERYASMINFO_FLAG_VALIDATE: QUERYASMINFO_FLAGS = 1;
...
pub const TILE_TEMPLATE_AGILESTORE: TILE_TEMPLATE_TYPE = 2;
pub const TILE_TEMPLATE_ALL: TILE_TEMPLATE_TYPE = 100;
pub const TILE_TEMPLATE_BADGE: TILE_TEMPLATE_TYPE = 16;
pub const TILE_TEMPLATE_BLOCK: TILE_TEMPLATE_TYPE = 17;
pub const TILE_TEMPLATE_BLOCKANDTEXT01: TILE_TEMPLATE_TYPE = 33;
pub const TILE_TEMPLATE_BLOCKANDTEXT02: TILE_TEMPLATE_TYPE = 34;
pub const TILE_TEMPLATE_CALENDAR: TILE_TEMPLATE_TYPE = 4;
pub const TILE_TEMPLATE_CONTACT: TILE_TEMPLATE_TYPE = 11;
pub const TILE_TEMPLATE_CYCLE: TILE_TEMPLATE_TYPE = 14;
pub const TILE_TEMPLATE_DEEPLINK: TILE_TEMPLATE_TYPE = 13;
pub const TILE_TEMPLATE_DEFAULT: TILE_TEMPLATE_TYPE = 15;
pub const TILE_TEMPLATE_FLIP: TILE_TEMPLATE_TYPE = 5;
pub const TILE_TEMPLATE_FOLDER: TILE_TEMPLATE_TYPE = 59;
pub const TILE_TEMPLATE_GAMES: TILE_TEMPLATE_TYPE = 3;
pub const TILE_TEMPLATE_GROUP: TILE_TEMPLATE_TYPE = 12;
pub const TILE_TEMPLATE_IMAGE: TILE_TEMPLATE_TYPE = 29;
pub const TILE_TEMPLATE_IMAGEANDTEXT01: TILE_TEMPLATE_TYPE = 31;
pub const TILE_TEMPLATE_IMAGEANDTEXT02: TILE_TEMPLATE_TYPE = 32;
pub const TILE_TEMPLATE_IMAGECOLLECTION: TILE_TEMPLATE_TYPE = 30;
pub const TILE_TEMPLATE_INVALID: TILE_TEMPLATE_TYPE = 0;
pub const TILE_TEMPLATE_METROCOUNT: TILE_TEMPLATE_TYPE = 1;
pub const TILE_TEMPLATE_METROCOUNTQUEUE: TILE_TEMPLATE_TYPE = 56;
pub const TILE_TEMPLATE_MUSICVIDEO: TILE_TEMPLATE_TYPE = 7;
pub const TILE_TEMPLATE_PEEKIMAGE01: TILE_TEMPLATE_TYPE = 39;
pub const TILE_TEMPLATE_PEEKIMAGE02: TILE_TEMPLATE_TYPE = 40;
pub const TILE_TEMPLATE_PEEKIMAGE03: TILE_TEMPLATE_TYPE = 41;
pub const TILE_TEMPLATE_PEEKIMAGE04: TILE_TEMPLATE_TYPE = 42;
pub const TILE_TEMPLATE_PEEKIMAGE05: TILE_TEMPLATE_TYPE = 43;
pub const TILE_TEMPLATE_PEEKIMAGE06: TILE_TEMPLATE_TYPE = 44;
pub const TILE_TEMPLATE_PEEKIMAGEANDTEXT01: TILE_TEMPLATE_TYPE = 35;
pub const TILE_TEMPLATE_PEEKIMAGEANDTEXT02: TILE_TEMPLATE_TYPE = 36;
pub const TILE_TEMPLATE_PEEKIMAGEANDTEXT03: TILE_TEMPLATE_TYPE = 37;
pub const TILE_TEMPLATE_PEEKIMAGEANDTEXT04: TILE_TEMPLATE_TYPE = 38;
pub const TILE_TEMPLATE_PEEKIMAGECOLLECTION01: TILE_TEMPLATE_TYPE = 45;
pub const TILE_TEMPLATE_PEEKIMAGECOLLECTION02: TILE_TEMPLATE_TYPE = 46;
pub const TILE_TEMPLATE_PEEKIMAGECOLLECTION03: TILE_TEMPLATE_TYPE = 47;
pub const TILE_TEMPLATE_PEEKIMAGECOLLECTION04: TILE_TEMPLATE_TYPE = 48;
pub const TILE_TEMPLATE_PEEKIMAGECOLLECTION05: TILE_TEMPLATE_TYPE = 49;
pub const TILE_TEMPLATE_PEEKIMAGECOLLECTION06: TILE_TEMPLATE_TYPE = 50;
pub const TILE_TEMPLATE_PEOPLE: TILE_TEMPLATE_TYPE = 10;
pub const TILE_TEMPLATE_SEARCH: TILE_TEMPLATE_TYPE = 57;
pub const TILE_TEMPLATE_SMALLIMAGEANDTEXT01: TILE_TEMPLATE_TYPE = 51;
pub const TILE_TEMPLATE_SMALLIMAGEANDTEXT02: TILE_TEMPLATE_TYPE = 52;
pub const TILE_TEMPLATE_SMALLIMAGEANDTEXT03: TILE_TEMPLATE_TYPE = 53;
pub const TILE_TEMPLATE_SMALLIMAGEANDTEXT04: TILE_TEMPLATE_TYPE = 54;
pub const TILE_TEMPLATE_SMALLIMAGEANDTEXT05: TILE_TEMPLATE_TYPE = 55;
pub const TILE_TEMPLATE_TEXT01: TILE_TEMPLATE_TYPE = 18;
pub const TILE_TEMPLATE_TEXT02: TILE_TEMPLATE_TYPE = 19;
pub const TILE_TEMPLATE_TEXT03: TILE_TEMPLATE_TYPE = 20;
pub const TILE_TEMPLATE_TEXT04: TILE_TEMPLATE_TYPE = 21;
pub const TILE_TEMPLATE_TEXT05: TILE_TEMPLATE_TYPE = 22;
pub const TILE_TEMPLATE_TEXT06: TILE_TEMPLATE_TYPE = 23;
pub const TILE_TEMPLATE_TEXT07: TILE_TEMPLATE_TYPE = 24;
pub const TILE_TEMPLATE_TEXT08: TILE_TEMPLATE_TYPE = 25;
pub const TILE_TEMPLATE_TEXT09: TILE_TEMPLATE_TYPE = 26;
pub const TILE_TEMPLATE_TEXT10: TILE_TEMPLATE_TYPE = 27;
pub const TILE_TEMPLATE_TEXT11: TILE_TEMPLATE_TYPE = 28;
pub const TILE_TEMPLATE_TILEFLYOUT01: TILE_TEMPLATE_TYPE = 58;
...
pub const ieError: RESULTTYPES = 1;
pub const ieInfo: RESULTTYPES = 3;
pub const ieStatusCancel: STATUSTYPES = 10;
pub const ieStatusCreateEngine: STATUSTYPES = 4;
pub const ieStatusFail: STATUSTYPES = 9;
pub const ieStatusGetCUB: STATUSTYPES = 0;
pub const ieStatusICECount: STATUSTYPES = 1;
pub const ieStatusMerge: STATUSTYPES = 2;
pub const ieStatusRunICE: STATUSTYPES = 6;
pub const ieStatusShutdown: STATUSTYPES = 7;
pub const ieStatusStarting: STATUSTYPES = 5;
pub const ieStatusSuccess: STATUSTYPES = 8;
pub const ieStatusSummaryInfo: STATUSTYPES = 3;
pub const ieUnknown: RESULTTYPES = 0;
pub const ieWarning: RESULTTYPES = 2;
pub type msidbAssemblyAttributes = i32;
pub const msidbAssemblyAttributesURT: msidbAssemblyAttributes = 0;
pub const msidbAssemblyAttributesWin32: msidbAssemblyAttributes = 1;
pub type msidbClassAttributes = i32;
pub const msidbClassAttributesRelativePath: msidbClassAttributes = 1;
pub type msidbComponentAttributes = i32;
pub const msidbComponentAttributes64bit: msidbComponentAttributes = 256;
pub const msidbComponentAttributesDisableRegistryReflection: msidbComponentAttributes = 512;
pub const msidbComponentAttributesLocalOnly: msidbComponentAttributes = 0;
pub const msidbComponentAttributesNeverOverwrite: msidbComponentAttributes = 128;
pub const msidbComponentAttributesODBCDataSource: msidbComponentAttributes = 32;
pub const msidbComponentAttributesOptional: msidbComponentAttributes = 2;
pub const msidbComponentAttributesPermanent: msidbComponentAttributes = 16;
pub const msidbComponentAttributesRegistryKeyPath: msidbComponentAttributes = 4;
pub const msidbComponentAttributesShared: msidbComponentAttributes = 2048;
pub const msidbComponentAttributesSharedDllRefCount: msidbComponentAttributes = 8;
pub const msidbComponentAttributesSourceOnly: msidbComponentAttributes = 1;
pub const msidbComponentAttributesTransitive: msidbComponentAttributes = 64;
pub const msidbComponentAttributesUninstallOnSupersedence: msidbComponentAttributes = 1024;
pub type msidbControlAttributes = i32;
pub const msidbControlAttributesBiDi: msidbControlAttributes = 224;
pub const msidbControlAttributesBitmap: msidbControlAttributes = 262144;
pub const msidbControlAttributesCDROMVolume: msidbControlAttributes = 524288;
pub const msidbControlAttributesComboList: msidbControlAttributes = 131072;
pub const msidbControlAttributesElevationShield: msidbControlAttributes = 8388608;
pub const msidbControlAttributesEnabled: msidbControlAttributes = 2;
pub const msidbControlAttributesFixedSize: msidbControlAttributes = 1048576;
pub const msidbControlAttributesFixedVolume: msidbControlAttributes = 131072;
pub const msidbControlAttributesFloppyVolume: msidbControlAttributes = 2097152;
pub const msidbControlAttributesFormatSize: msidbControlAttributes = 524288;
pub const msidbControlAttributesHasBorder: msidbControlAttributes = 16777216;
pub const msidbControlAttributesIcon: msidbControlAttributes = 524288;
pub const msidbControlAttributesIconSize16: msidbControlAttributes = 2097152;
pub const msidbControlAttributesIconSize32: msidbControlAttributes = 4194304;
pub const msidbControlAttributesIconSize48: msidbControlAttributes = 6291456;
pub const msidbControlAttributesImageHandle: msidbControlAttributes = 65536;
pub const msidbControlAttributesIndirect: msidbControlAttributes = 8;
pub const msidbControlAttributesInteger: msidbControlAttributes = 16;
pub const msidbControlAttributesLeftScroll: msidbControlAttributes = 128;
pub const msidbControlAttributesMultiline: msidbControlAttributes = 65536;
pub const msidbControlAttributesNoPrefix: msidbControlAttributes = 131072;
pub const msidbControlAttributesNoWrap: msidbControlAttributes = 262144;
pub const msidbControlAttributesPasswordInput: msidbControlAttributes = 2097152;
pub const msidbControlAttributesProgress95: msidbControlAttributes = 65536;
pub const msidbControlAttributesPushLike: msidbControlAttributes = 131072;
pub const msidbControlAttributesRAMDiskVolume: msidbControlAttributes = 1048576;
pub const msidbControlAttributesRTLRO: msidbControlAttributes = 32;
pub const msidbControlAttributesRemoteVolume: msidbControlAttributes = 262144;
pub const msidbControlAttributesRemovableVolume: msidbControlAttributes = 65536;
pub const msidbControlAttributesRightAligned: msidbControlAttributes = 64;
pub const msidbControlAttributesSorted: msidbControlAttributes = 65536;
pub const msidbControlAttributesSunken: msidbControlAttributes = 4;
pub const msidbControlAttributesTransparent: msidbControlAttributes = 65536;
pub const msidbControlAttributesUsersLanguage: msidbControlAttributes = 1048576;
pub const msidbControlAttributesVisible: msidbControlAttributes = 1;
pub const msidbControlShowRollbackCost: msidbControlAttributes = 4194304;
pub type msidbCustomActionType = i32;
pub const msidbCustomActionType64BitScript: msidbCustomActionType = 4096;
pub const msidbCustomActionTypeAsync: msidbCustomActionType = 128;
pub const msidbCustomActionTypeBinaryData: msidbCustomActionType = 0;
pub const msidbCustomActionTypeClientRepeat: msidbCustomActionType = 768;
pub const msidbCustomActionTypeCommit: msidbCustomActionType = 512;
pub const msidbCustomActionTypeContinue: msidbCustomActionType = 64;
pub const msidbCustomActionTypeDirectory: msidbCustomActionType = 32;
pub const msidbCustomActionTypeDll: msidbCustomActionType = 1;
pub const msidbCustomActionTypeExe: msidbCustomActionType = 2;
pub const msidbCustomActionTypeFirstSequence: msidbCustomActionType = 256;
pub const msidbCustomActionTypeHideTarget: msidbCustomActionType = 8192;
pub const msidbCustomActionTypeInScript: msidbCustomActionType = 1024;
pub const msidbCustomActionTypeInstall: msidbCustomActionType = 7;
pub const msidbCustomActionTypeJScript: msidbCustomActionType = 5;
pub const msidbCustomActionTypeNoImpersonate: msidbCustomActionType = 2048;
pub const msidbCustomActionTypeOncePerProcess: msidbCustomActionType = 512;
pub const msidbCustomActionTypePatchUninstall: msidbCustomActionType = 32768;
pub const msidbCustomActionTypeProperty: msidbCustomActionType = 48;
pub const msidbCustomActionTypeRollback: msidbCustomActionType = 256;
pub const msidbCustomActionTypeSourceFile: msidbCustomActionType = 16;
pub const msidbCustomActionTypeTSAware: msidbCustomActionType = 16384;
pub const msidbCustomActionTypeTextData: msidbCustomActionType = 3;
pub const msidbCustomActionTypeVBScript: msidbCustomActionType = 6;
pub type msidbDialogAttributes = i32;
pub const msidbDialogAttributesBiDi: msidbDialogAttributes = 896;
pub const msidbDialogAttributesError: msidbDialogAttributes = 65536;
pub const msidbDialogAttributesKeepModeless: msidbDialogAttributes = 16;
pub const msidbDialogAttributesLeftScroll: msidbDialogAttributes = 512;
pub const msidbDialogAttributesMinimize: msidbDialogAttributes = 4;
pub const msidbDialogAttributesModal: msidbDialogAttributes = 2;
pub const msidbDialogAttributesRTLRO: msidbDialogAttributes = 128;
pub const msidbDialogAttributesRightAligned: msidbDialogAttributes = 256;
pub const msidbDialogAttributesSysModal: msidbDialogAttributes = 8;
pub const msidbDialogAttributesTrackDiskSpace: msidbDialogAttributes = 32;
pub const msidbDialogAttributesUseCustomPalette: msidbDialogAttributes = 64;
pub const msidbDialogAttributesVisible: msidbDialogAttributes = 1;
pub const msidbEmbeddedHandlesBasic: msidbEmbeddedUIAttributes = 2;
pub const msidbEmbeddedUI: msidbEmbeddedUIAttributes = 1;
pub type msidbEmbeddedUIAttributes = i32;
pub type msidbFeatureAttributes = i32;
pub const msidbFeatureAttributesDisallowAdvertise: msidbFeatureAttributes = 8;
pub const msidbFeatureAttributesFavorAdvertise: msidbFeatureAttributes = 4;
pub const msidbFeatureAttributesFavorLocal: msidbFeatureAttributes = 0;
pub const msidbFeatureAttributesFavorSource: msidbFeatureAttributes = 1;
pub const msidbFeatureAttributesFollowParent: msidbFeatureAttributes = 2;
pub const msidbFeatureAttributesNoUnsupportedAdvertise: msidbFeatureAttributes = 32;
pub const msidbFeatureAttributesUIDisallowAbsent: msidbFeatureAttributes = 16;
pub type msidbFileAttributes = i32;
pub const msidbFileAttributesChecksum: msidbFileAttributes = 1024;
pub const msidbFileAttributesCompressed: msidbFileAttributes = 16384;
pub const msidbFileAttributesHidden: msidbFileAttributes = 2;
pub const msidbFileAttributesIsolatedComp: msidbFileAttributes = 16;
pub const msidbFileAttributesNoncompressed: msidbFileAttributes = 8192;
pub const msidbFileAttributesPatchAdded: msidbFileAttributes = 4096;
pub const msidbFileAttributesReadOnly: msidbFileAttributes = 1;
pub const msidbFileAttributesReserved0: msidbFileAttributes = 8;
pub const msidbFileAttributesReserved1: msidbFileAttributes = 64;
pub const msidbFileAttributesReserved2: msidbFileAttributes = 128;
pub const msidbFileAttributesReserved3: msidbFileAttributes = 256;
pub const msidbFileAttributesReserved4: msidbFileAttributes = 32768;
pub const msidbFileAttributesSystem: msidbFileAttributes = 4;
pub const msidbFileAttributesVital: msidbFileAttributes = 512;
pub type msidbIniFileAction = i32;
pub const msidbIniFileActionAddLine: msidbIniFileAction = 0;
pub const msidbIniFileActionAddTag: msidbIniFileAction = 3;
pub const msidbIniFileActionCreateLine: msidbIniFileAction = 1;
pub const msidbIniFileActionRemoveLine: msidbIniFileAction = 2;
pub const msidbIniFileActionRemoveTag: msidbIniFileAction = 4;
pub type msidbLocatorType = i32;
pub const msidbLocatorType64bit: msidbLocatorType = 16;
pub const msidbLocatorTypeDirectory: msidbLocatorType = 0;
pub const msidbLocatorTypeFileName: msidbLocatorType = 1;
pub const msidbLocatorTypeRawValue: msidbLocatorType = 2;
pub type msidbMoveFileOptions = i32;
pub const msidbMoveFileOptionsMove: msidbMoveFileOptions = 1;
pub type msidbODBCDataSourceRegistration = i32;
pub const msidbODBCDataSourceRegistrationPerMachine: msidbODBCDataSourceRegistration = 0;
pub const msidbODBCDataSourceRegistrationPerUser: msidbODBCDataSourceRegistration = 1;
pub type msidbPatchAttributes = i32;
pub const msidbPatchAttributesNonVital: msidbPatchAttributes = 1;
pub type msidbRegistryRoot = i32;
pub const msidbRegistryRootClassesRoot: msidbRegistryRoot = 0;
pub const msidbRegistryRootCurrentUser: msidbRegistryRoot = 1;
pub const msidbRegistryRootLocalMachine: msidbRegistryRoot = 2;
pub const msidbRegistryRootUsers: msidbRegistryRoot = 3;
pub type msidbRemoveFileInstallMode = i32;
pub const msidbRemoveFileInstallModeOnBoth: msidbRemoveFileInstallMode = 3;
pub const msidbRemoveFileInstallModeOnInstall: msidbRemoveFileInstallMode = 1;
pub const msidbRemoveFileInstallModeOnRemove: msidbRemoveFileInstallMode = 2;
pub type msidbServiceConfigEvent = i32;
pub const msidbServiceConfigEventInstall: msidbServiceConfigEvent = 1;
pub const msidbServiceConfigEventReinstall: msidbServiceConfigEvent = 4;
pub const msidbServiceConfigEventUninstall: msidbServiceConfigEvent = 2;
pub type msidbServiceControlEvent = i32;
pub const msidbServiceControlEventDelete: msidbServiceControlEvent = 8;
pub const msidbServiceControlEventStart: msidbServiceControlEvent = 1;
pub const msidbServiceControlEventStop: msidbServiceControlEvent = 2;
pub const msidbServiceControlEventUninstallDelete: msidbServiceControlEvent = 128;
pub const msidbServiceControlEventUninstallStart: msidbServiceControlEvent = 16;
pub const msidbServiceControlEventUninstallStop: msidbServiceControlEvent = 32;
pub type msidbServiceInstallErrorControl = i32;
pub const msidbServiceInstallErrorControlVital: msidbServiceInstallErrorControl = 32768;
pub type msidbSumInfoSourceType = i32;
pub const msidbSumInfoSourceTypeAdminImage: msidbSumInfoSourceType = 4;
pub const msidbSumInfoSourceTypeCompressed: msidbSumInfoSourceType = 2;
pub const msidbSumInfoSourceTypeLUAPackage: msidbSumInfoSourceType = 8;
pub const msidbSumInfoSourceTypeSFN: msidbSumInfoSourceType = 1;
pub type msidbTextStyleStyleBits = i32;
pub const msidbTextStyleStyleBitsBold: msidbTextStyleStyleBits = 1;
pub const msidbTextStyleStyleBitsItalic: msidbTextStyleStyleBits = 2;
pub const msidbTextStyleStyleBitsStrike: msidbTextStyleStyleBits = 8;
pub const msidbTextStyleStyleBitsUnderline: msidbTextStyleStyleBits = 4;
pub type msidbUpgradeAttributes = i32;
pub const msidbUpgradeAttributesIgnoreRemoveFailure: msidbUpgradeAttributes = 4;
pub const msidbUpgradeAttributesLanguagesExclusive: msidbUpgradeAttributes = 1024;
pub const msidbUpgradeAttributesMigrateFeatures: msidbUpgradeAttributes = 1;
pub const msidbUpgradeAttributesOnlyDetect: msidbUpgradeAttributes = 2;
pub const msidbUpgradeAttributesVersionMaxInclusive: msidbUpgradeAttributes = 512;
pub const msidbUpgradeAttributesVersionMinInclusive: msidbUpgradeAttributes = 256;
pub type msifiFastInstallBits = i32;
pub const msifiFastInstallLessPrgMsg: msifiFastInstallBits = 4;
pub const msifiFastInstallNoSR: msifiFastInstallBits = 1;
pub const msifiFastInstallQuickCosting: msifiFastInstallBits = 2;
pub const msirbRebootCustomActionReason: msirbRebootReason = 4;
pub const msirbRebootDeferred: msirbRebootType = 2;
pub const msirbRebootForceRebootReason: msirbRebootReason = 3;
pub const msirbRebootImmediate: msirbRebootType = 1;
pub const msirbRebootInUseFilesReason: msirbRebootReason = 1;
pub type msirbRebootReason = i32;
pub const msirbRebootScheduleRebootReason: msirbRebootReason = 2;
pub type msirbRebootType = i32;
pub const msirbRebootUndeterminedReason: msirbRebootReason = 0;
pub const msmErrorDirCreate: msmErrorType = 7;
pub const msmErrorExclusion: msmErrorType = 3;
pub const msmErrorFeatureRequired: msmErrorType = 8;
pub const msmErrorFileCreate: msmErrorType = 6;
pub const msmErrorLanguageFailed: msmErrorType = 2;
pub const msmErrorLanguageUnsupported: msmErrorType = 1;
pub const msmErrorResequenceMerge: msmErrorType = 5;
pub const msmErrorTableMerge: msmErrorType = 4;
