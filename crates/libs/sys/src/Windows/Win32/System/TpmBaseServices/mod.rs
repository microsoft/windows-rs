...
pub const TBS_COMMAND_LOCALITY_FOUR: TBS_COMMAND_LOCALITY = 4;
pub const TBS_COMMAND_LOCALITY_ONE: TBS_COMMAND_LOCALITY = 1;
pub const TBS_COMMAND_LOCALITY_THREE: TBS_COMMAND_LOCALITY = 3;
pub const TBS_COMMAND_LOCALITY_TWO: TBS_COMMAND_LOCALITY = 2;
pub const TBS_COMMAND_LOCALITY_ZERO: TBS_COMMAND_LOCALITY = 0;
pub type TBS_COMMAND_PRIORITY = u32;
pub const TBS_COMMAND_PRIORITY_HIGH: TBS_COMMAND_PRIORITY = 300;
pub const TBS_COMMAND_PRIORITY_LOW: TBS_COMMAND_PRIORITY = 100;
pub const TBS_COMMAND_PRIORITY_MAX: TBS_COMMAND_PRIORITY = 2147483648;
