...
windows_link::link!("tbs.dll" "system" fn Tbsi_Context_Create(pcontextparams : *mut TBS_CONTEXT_PARAMS, phcontext : *mut *mut core::ffi::c_void) -> u32);
...
windows_link::link!("tbs.dll" "system" fn Tbsi_Get_OwnerAuth(hcontext : *mut core::ffi::c_void, ownerauthtype : u32, poutputbuf : *mut u8, poutputbuflen : *mut u32) -> u32);
windows_link::link!("tbs.dll" "system" fn Tbsi_Get_TCG_Log(hcontext : *mut core::ffi::c_void, poutputbuf : *mut u8, poutputbuflen : *mut u32) -> u32);
...
windows_link::link!("tbs.dll" "system" fn Tbsi_Physical_Presence_Command(hcontext : *mut core::ffi::c_void, pabinput : *mut u8, cbinput : u32, paboutput : *mut u8, pcboutput : *mut u32) -> u32);
windows_link::link!("tbs.dll" "system" fn Tbsi_Revoke_Attestation() -> u32);
windows_link::link!("tbs.dll" "system" fn Tbsip_Cancel_Commands(hcontext : *mut core::ffi::c_void) -> u32);
windows_link::link!("tbs.dll" "system" fn Tbsip_Context_Close(hcontext : *mut core::ffi::c_void) -> u32);
