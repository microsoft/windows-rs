pub type GetDeviceID = unsafe extern "system" fn(pbwindowsaik: *mut u8, cbwindowsaik: u32, pcbresult: *mut u32, pfprotectedbytpm: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type GetDeviceIDString = unsafe extern "system" fn(pszwindowsaik: windows_sys::core::PWSTR, cchwindowsaik: u32, pcchresult: *mut u32, pfprotectedbytpm: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type Tbsi_Is_Tpm_Present = unsafe extern "system" fn() -> windows_sys::core::BOOL;
...
pub type Tbsi_Tpm_Vendor_Maintenance_Mode = unsafe extern "system" fn(pcontextparams: *const TBS_CONTEXT_PARAMS, phcontext: *mut *mut core::ffi::c_void) -> u32;
