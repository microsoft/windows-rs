pub type CLRCreateInstance = unsafe extern "system" fn(clsid: *const windows_sys::core::GUID, riid: *const windows_sys::core::GUID, ppinterface: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CallFunctionShim = unsafe extern "system" fn(szdllname: windows_sys::core::PCWSTR, szfunctionname: windows_sys::core::PCSTR, lpvargument1: *mut core::ffi::c_void, lpvargument2: *mut core::ffi::c_void, szversion: windows_sys::core::PCWSTR, pvreserved: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type ClrCreateManagedInstance = unsafe extern "system" fn(ptypename: windows_sys::core::PCWSTR, riid: *const windows_sys::core::GUID, ppobject: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CorBindToCurrentRuntime = unsafe extern "system" fn(pwszfilename: windows_sys::core::PCWSTR, rclsid: *const windows_sys::core::GUID, riid: *const windows_sys::core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CorBindToRuntime = unsafe extern "system" fn(pwszversion: windows_sys::core::PCWSTR, pwszbuildflavor: windows_sys::core::PCWSTR, rclsid: *const windows_sys::core::GUID, riid: *const windows_sys::core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CorBindToRuntimeByCfg = unsafe extern "system" fn(pcfgstream: *mut core::ffi::c_void, reserved: u32, startupflags: u32, rclsid: *const windows_sys::core::GUID, riid: *const windows_sys::core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_System_Com")]
...
pub type CorBindToRuntimeEx = unsafe extern "system" fn(pwszversion: windows_sys::core::PCWSTR, pwszbuildflavor: windows_sys::core::PCWSTR, startupflags: u32, rclsid: *const windows_sys::core::GUID, riid: *const windows_sys::core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CorBindToRuntimeHost = unsafe extern "system" fn(pwszversion: windows_sys::core::PCWSTR, pwszbuildflavor: windows_sys::core::PCWSTR, pwszhostconfigfile: windows_sys::core::PCWSTR, preserved: *mut core::ffi::c_void, startupflags: u32, rclsid: *const windows_sys::core::GUID, riid: *const windows_sys::core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CorExitProcess = unsafe extern "system" fn(exitcode: i32);
windows_link::link!("mscoree.dll" "system" fn CorExitProcess(exitcode : i32));
#[cfg(feature = "Win32_System_Threading")]
pub type CorLaunchApplication = unsafe extern "system" fn(dwclickoncehost: HOST_TYPE, pwzappfullname: windows_sys::core::PCWSTR, dwmanifestpaths: u32, ppwzmanifestpaths: *const windows_sys::core::PCWSTR, dwactivationdata: u32, ppwzactivationdata: *const windows_sys::core::PCWSTR, lpprocessinformation: *mut super::Threading::PROCESS_INFORMATION) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_System_Threading")]
...
pub type CorMarkThreadInThreadPool = unsafe extern "system" fn();
windows_link::link!("mscoree.dll" "system" fn CorMarkThreadInThreadPool());
pub type CreateDebuggingInterfaceFromVersion = unsafe extern "system" fn(idebuggerversion: i32, szdebuggeeversion: windows_sys::core::PCWSTR, ppcordb: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type GetCLRIdentityManager = unsafe extern "system" fn(riid: *const windows_sys::core::GUID, ppmanager: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type GetCORRequiredVersion = unsafe extern "system" fn(pbuffer: windows_sys::core::PWSTR, cchbuffer: u32, dwlength: *mut u32) -> windows_sys::core::HRESULT;
...
pub type GetCORSystemDirectory = unsafe extern "system" fn(pbuffer: windows_sys::core::PWSTR, cchbuffer: u32, dwlength: *mut u32) -> windows_sys::core::HRESULT;
...
pub type GetCORVersion = unsafe extern "system" fn(pbbuffer: windows_sys::core::PWSTR, cchbuffer: u32, dwlength: *mut u32) -> windows_sys::core::HRESULT;
...
pub type GetFileVersion = unsafe extern "system" fn(szfilename: windows_sys::core::PCWSTR, szbuffer: windows_sys::core::PWSTR, cchbuffer: u32, dwlength: *mut u32) -> windows_sys::core::HRESULT;
...
pub type GetRealProcAddress = unsafe extern "system" fn(pwszprocname: windows_sys::core::PCSTR, ppv: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type GetRequestedRuntimeVersion = unsafe extern "system" fn(pexe: windows_sys::core::PCWSTR, pversion: windows_sys::core::PWSTR, cchbuffer: u32, dwlength: *mut u32) -> windows_sys::core::HRESULT;
...
pub type GetRequestedRuntimeVersionForCLSID = unsafe extern "system" fn(rclsid: *const windows_sys::core::GUID, pversion: windows_sys::core::PWSTR, cchbuffer: u32, dwlength: *mut u32, dwresolutionflags: CLSID_RESOLUTION_FLAGS) -> windows_sys::core::HRESULT;
...
pub type GetVersionFromProcess = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, pversion: windows_sys::core::PWSTR, cchbuffer: u32, dwlength: *mut u32) -> windows_sys::core::HRESULT;
...
pub type LoadLibraryShim = unsafe extern "system" fn(szdllname: windows_sys::core::PCWSTR, szversion: windows_sys::core::PCWSTR, pvreserved: *mut core::ffi::c_void, phmoddll: *mut super::super::Foundation::HMODULE) -> windows_sys::core::HRESULT;
...
pub type LoadStringRC = unsafe extern "system" fn(iresouceid: u32, szbuffer: windows_sys::core::PWSTR, imax: i32, bquiet: i32) -> windows_sys::core::HRESULT;
...
pub type LoadStringRCEx = unsafe extern "system" fn(lcid: u32, iresouceid: u32, szbuffer: windows_sys::core::PWSTR, imax: i32, bquiet: i32, pcwchused: *mut i32) -> windows_sys::core::HRESULT;
...
pub type LockClrVersion = unsafe extern "system" fn(hostcallback: FLockClrVersionCallback, pbeginhostsetup: *mut FLockClrVersionCallback, pendhostsetup: *mut FLockClrVersionCallback) -> windows_sys::core::HRESULT;
...
pub type RunDll32ShimW = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hinst: super::super::Foundation::HINSTANCE, lpszcmdline: windows_sys::core::PCWSTR, ncmdshow: i32) -> windows_sys::core::HRESULT;
