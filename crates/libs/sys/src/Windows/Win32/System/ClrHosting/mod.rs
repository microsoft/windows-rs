...
#[cfg(feature = "Win32_Foundation")]
::windows_targets::link!("mscoree.dll" "system" #[doc = "*Required features: `\"Win32_System_ClrHosting\"`, `\"Win32_Foundation\"`*"] fn RunDll32ShimW(hwnd : super::super::Foundation:: HWND, hinst : super::super::Foundation:: HINSTANCE, lpszcmdline : ::windows_sys::core::PCWSTR, ncmdshow : i32) -> ::windows_sys::core::HRESULT);
