pub type ChangeServiceConfig2A = unsafe extern "system" fn(hservice: SC_HANDLE, dwinfolevel: SERVICE_CONFIG, lpinfo: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type ChangeServiceConfig2W = unsafe extern "system" fn(hservice: SC_HANDLE, dwinfolevel: SERVICE_CONFIG, lpinfo: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type CloseServiceHandle = unsafe extern "system" fn(hscobject: SC_HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CloseServiceHandle(hscobject : SC_HANDLE) -> windows_sys::core::BOOL);
pub type ControlService = unsafe extern "system" fn(hservice: SC_HANDLE, dwcontrol: u32, lpservicestatus: *mut SERVICE_STATUS) -> windows_sys::core::BOOL;
...
pub type ControlServiceExA = unsafe extern "system" fn(hservice: SC_HANDLE, dwcontrol: u32, dwinfolevel: u32, pcontrolparams: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type ControlServiceExW = unsafe extern "system" fn(hservice: SC_HANDLE, dwcontrol: u32, dwinfolevel: u32, pcontrolparams: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type DeleteService = unsafe extern "system" fn(hservice: SC_HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn DeleteService(hservice : SC_HANDLE) -> windows_sys::core::BOOL);
pub type EnumDependentServicesA = unsafe extern "system" fn(hservice: SC_HANDLE, dwservicestate: ENUM_SERVICE_STATE, lpservices: *mut ENUM_SERVICE_STATUSA, cbbufsize: u32, pcbbytesneeded: *mut u32, lpservicesreturned: *mut u32) -> windows_sys::core::BOOL;
...
pub type EnumDependentServicesW = unsafe extern "system" fn(hservice: SC_HANDLE, dwservicestate: ENUM_SERVICE_STATE, lpservices: *mut ENUM_SERVICE_STATUSW, cbbufsize: u32, pcbbytesneeded: *mut u32, lpservicesreturned: *mut u32) -> windows_sys::core::BOOL;
...
pub type EnumServicesStatusA = unsafe extern "system" fn(hscmanager: SC_HANDLE, dwservicetype: ENUM_SERVICE_TYPE, dwservicestate: ENUM_SERVICE_STATE, lpservices: *mut ENUM_SERVICE_STATUSA, cbbufsize: u32, pcbbytesneeded: *mut u32, lpservicesreturned: *mut u32, lpresumehandle: *mut u32) -> windows_sys::core::BOOL;
...
pub type EnumServicesStatusExA = unsafe extern "system" fn(hscmanager: SC_HANDLE, infolevel: SC_ENUM_TYPE, dwservicetype: ENUM_SERVICE_TYPE, dwservicestate: ENUM_SERVICE_STATE, lpservices: *mut u8, cbbufsize: u32, pcbbytesneeded: *mut u32, lpservicesreturned: *mut u32, lpresumehandle: *mut u32, pszgroupname: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn EnumServicesStatusExA(hscmanager : SC_HANDLE, infolevel : SC_ENUM_TYPE, dwservicetype : ENUM_SERVICE_TYPE, dwservicestate : ENUM_SERVICE_STATE, lpservices : *mut u8, cbbufsize : u32, pcbbytesneeded : *mut u32, lpservicesreturned : *mut u32, lpresumehandle : *mut u32, pszgroupname : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
pub type EnumServicesStatusExW = unsafe extern "system" fn(hscmanager: SC_HANDLE, infolevel: SC_ENUM_TYPE, dwservicetype: ENUM_SERVICE_TYPE, dwservicestate: ENUM_SERVICE_STATE, lpservices: *mut u8, cbbufsize: u32, pcbbytesneeded: *mut u32, lpservicesreturned: *mut u32, lpresumehandle: *mut u32, pszgroupname: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn EnumServicesStatusExW(hscmanager : SC_HANDLE, infolevel : SC_ENUM_TYPE, dwservicetype : ENUM_SERVICE_TYPE, dwservicestate : ENUM_SERVICE_STATE, lpservices : *mut u8, cbbufsize : u32, pcbbytesneeded : *mut u32, lpservicesreturned : *mut u32, lpresumehandle : *mut u32, pszgroupname : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
pub type EnumServicesStatusW = unsafe extern "system" fn(hscmanager: SC_HANDLE, dwservicetype: ENUM_SERVICE_TYPE, dwservicestate: ENUM_SERVICE_STATE, lpservices: *mut ENUM_SERVICE_STATUSW, cbbufsize: u32, pcbbytesneeded: *mut u32, lpservicesreturned: *mut u32, lpresumehandle: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetServiceDirectory = unsafe extern "system" fn(hservicestatus: SERVICE_STATUS_HANDLE, edirectorytype: SERVICE_DIRECTORY_TYPE, lppathbuffer: windows_sys::core::PWSTR, cchpathbufferlength: u32, lpcchrequiredbufferlength: *mut u32) -> u32;
...
pub type GetServiceDisplayNameA = unsafe extern "system" fn(hscmanager: SC_HANDLE, lpservicename: windows_sys::core::PCSTR, lpdisplayname: windows_sys::core::PSTR, lpcchbuffer: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetServiceDisplayNameW = unsafe extern "system" fn(hscmanager: SC_HANDLE, lpservicename: windows_sys::core::PCWSTR, lpdisplayname: windows_sys::core::PWSTR, lpcchbuffer: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetServiceKeyNameA = unsafe extern "system" fn(hscmanager: SC_HANDLE, lpdisplayname: windows_sys::core::PCSTR, lpservicename: windows_sys::core::PSTR, lpcchbuffer: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetServiceKeyNameW = unsafe extern "system" fn(hscmanager: SC_HANDLE, lpdisplayname: windows_sys::core::PCWSTR, lpservicename: windows_sys::core::PWSTR, lpcchbuffer: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetServiceRegistryStateKey = unsafe extern "system" fn(servicestatushandle: SERVICE_STATUS_HANDLE, statetype: SERVICE_REGISTRY_STATE_TYPE, accessmask: u32, servicestatekey: *mut super::Registry::HKEY) -> u32;
#[cfg(feature = "Win32_System_Registry")]
...
pub type GetSharedServiceDirectory = unsafe extern "system" fn(servicehandle: SC_HANDLE, directorytype: SERVICE_SHARED_DIRECTORY_TYPE, pathbuffer: windows_sys::core::PWSTR, pathbufferlength: u32, requiredbufferlength: *mut u32) -> u32;
...
#[cfg(feature = "Win32_System_Registry")]
pub type GetSharedServiceRegistryStateKey = unsafe extern "system" fn(servicehandle: SC_HANDLE, statetype: SERVICE_SHARED_REGISTRY_STATE_TYPE, accessmask: u32, servicestatekey: *mut super::Registry::HKEY) -> u32;
#[cfg(feature = "Win32_System_Registry")]
...
pub type LockServiceDatabase = unsafe extern "system" fn(hscmanager: SC_HANDLE) -> *mut core::ffi::c_void;
windows_link::link!("advapi32.dll" "system" fn LockServiceDatabase(hscmanager : SC_HANDLE) -> *mut core::ffi::c_void);
pub type NotifyBootConfigStatus = unsafe extern "system" fn(bootacceptable: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type NotifyServiceStatusChangeA = unsafe extern "system" fn(hservice: SC_HANDLE, dwnotifymask: SERVICE_NOTIFY, pnotifybuffer: *const SERVICE_NOTIFY_2A) -> u32;
...
pub type NotifyServiceStatusChangeW = unsafe extern "system" fn(hservice: SC_HANDLE, dwnotifymask: SERVICE_NOTIFY, pnotifybuffer: *const SERVICE_NOTIFY_2W) -> u32;
...
pub type OpenSCManagerA = unsafe extern "system" fn(lpmachinename: windows_sys::core::PCSTR, lpdatabasename: windows_sys::core::PCSTR, dwdesiredaccess: u32) -> SC_HANDLE;
...
pub type OpenSCManagerW = unsafe extern "system" fn(lpmachinename: windows_sys::core::PCWSTR, lpdatabasename: windows_sys::core::PCWSTR, dwdesiredaccess: u32) -> SC_HANDLE;
...
pub type OpenServiceA = unsafe extern "system" fn(hscmanager: SC_HANDLE, lpservicename: windows_sys::core::PCSTR, dwdesiredaccess: u32) -> SC_HANDLE;
...
pub type OpenServiceW = unsafe extern "system" fn(hscmanager: SC_HANDLE, lpservicename: windows_sys::core::PCWSTR, dwdesiredaccess: u32) -> SC_HANDLE;
...
pub type QueryServiceConfig2A = unsafe extern "system" fn(hservice: SC_HANDLE, dwinfolevel: SERVICE_CONFIG, lpbuffer: *mut u8, cbbufsize: u32, pcbbytesneeded: *mut u32) -> windows_sys::core::BOOL;
...
pub type QueryServiceConfig2W = unsafe extern "system" fn(hservice: SC_HANDLE, dwinfolevel: SERVICE_CONFIG, lpbuffer: *mut u8, cbbufsize: u32, pcbbytesneeded: *mut u32) -> windows_sys::core::BOOL;
...
pub type QueryServiceConfigA = unsafe extern "system" fn(hservice: SC_HANDLE, lpserviceconfig: *mut QUERY_SERVICE_CONFIGA, cbbufsize: u32, pcbbytesneeded: *mut u32) -> windows_sys::core::BOOL;
...
pub type QueryServiceConfigW = unsafe extern "system" fn(hservice: SC_HANDLE, lpserviceconfig: *mut QUERY_SERVICE_CONFIGW, cbbufsize: u32, pcbbytesneeded: *mut u32) -> windows_sys::core::BOOL;
...
pub type QueryServiceDynamicInformation = unsafe extern "system" fn(hservicestatus: SERVICE_STATUS_HANDLE, dwinfolevel: u32, ppdynamicinfo: *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type QueryServiceLockStatusA = unsafe extern "system" fn(hscmanager: SC_HANDLE, lplockstatus: *mut QUERY_SERVICE_LOCK_STATUSA, cbbufsize: u32, pcbbytesneeded: *mut u32) -> windows_sys::core::BOOL;
...
pub type QueryServiceLockStatusW = unsafe extern "system" fn(hscmanager: SC_HANDLE, lplockstatus: *mut QUERY_SERVICE_LOCK_STATUSW, cbbufsize: u32, pcbbytesneeded: *mut u32) -> windows_sys::core::BOOL;
...
pub type QueryServiceObjectSecurity = unsafe extern "system" fn(hservice: SC_HANDLE, dwsecurityinformation: u32, lpsecuritydescriptor: super::super::Security::PSECURITY_DESCRIPTOR, cbbufsize: u32, pcbbytesneeded: *mut u32) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Security")]
...
pub type QueryServiceStatus = unsafe extern "system" fn(hservice: SC_HANDLE, lpservicestatus: *mut SERVICE_STATUS) -> windows_sys::core::BOOL;
...
pub type QueryServiceStatusEx = unsafe extern "system" fn(hservice: SC_HANDLE, infolevel: SC_STATUS_TYPE, lpbuffer: *mut u8, cbbufsize: u32, pcbbytesneeded: *mut u32) -> windows_sys::core::BOOL;
...
pub type RegisterServiceCtrlHandlerA = unsafe extern "system" fn(lpservicename: windows_sys::core::PCSTR, lphandlerproc: LPHANDLER_FUNCTION) -> SERVICE_STATUS_HANDLE;
...
pub type RegisterServiceCtrlHandlerExA = unsafe extern "system" fn(lpservicename: windows_sys::core::PCSTR, lphandlerproc: LPHANDLER_FUNCTION_EX, lpcontext: *const core::ffi::c_void) -> SERVICE_STATUS_HANDLE;
...
pub type RegisterServiceCtrlHandlerExW = unsafe extern "system" fn(lpservicename: windows_sys::core::PCWSTR, lphandlerproc: LPHANDLER_FUNCTION_EX, lpcontext: *const core::ffi::c_void) -> SERVICE_STATUS_HANDLE;
...
pub type RegisterServiceCtrlHandlerW = unsafe extern "system" fn(lpservicename: windows_sys::core::PCWSTR, lphandlerproc: LPHANDLER_FUNCTION) -> SERVICE_STATUS_HANDLE;
...
pub type SetServiceBits = unsafe extern "system" fn(hservicestatus: SERVICE_STATUS_HANDLE, dwservicebits: u32, bsetbitson: windows_sys::core::BOOL, bupdateimmediately: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
#[cfg(feature = "Win32_Security")]
pub type SetServiceObjectSecurity = unsafe extern "system" fn(hservice: SC_HANDLE, dwsecurityinformation: super::super::Security::OBJECT_SECURITY_INFORMATION, lpsecuritydescriptor: super::super::Security::PSECURITY_DESCRIPTOR) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Security")]
...
pub type SetServiceStatus = unsafe extern "system" fn(hservicestatus: SERVICE_STATUS_HANDLE, lpservicestatus: *const SERVICE_STATUS) -> windows_sys::core::BOOL;
...
pub type StartServiceA = unsafe extern "system" fn(hservice: SC_HANDLE, dwnumserviceargs: u32, lpserviceargvectors: *const windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type StartServiceCtrlDispatcherA = unsafe extern "system" fn(lpservicestarttable: *const SERVICE_TABLE_ENTRYA) -> windows_sys::core::BOOL;
...
pub type StartServiceCtrlDispatcherW = unsafe extern "system" fn(lpservicestarttable: *const SERVICE_TABLE_ENTRYW) -> windows_sys::core::BOOL;
...
pub type StartServiceW = unsafe extern "system" fn(hservice: SC_HANDLE, dwnumserviceargs: u32, lpserviceargvectors: *const windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SubscribeServiceChangeNotifications = unsafe extern "system" fn(hservice: SC_HANDLE, eeventtype: SC_EVENT_TYPE, pcallback: PSC_NOTIFICATION_CALLBACK, pcallbackcontext: *const core::ffi::c_void, psubscription: *mut PSC_NOTIFICATION_REGISTRATION) -> u32;
...
pub type UnlockServiceDatabase = unsafe extern "system" fn(sclock: *const core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn UnlockServiceDatabase(sclock : *const core::ffi::c_void) -> windows_sys::core::BOOL);
pub type UnsubscribeServiceChangeNotifications = unsafe extern "system" fn(psubscription: PSC_NOTIFICATION_REGISTRATION);
...
pub type WaitServiceState = unsafe extern "system" fn(hservice: SC_HANDLE, dwnotify: u32, dwtimeout: u32, hcancelevent: super::super::Foundation::HANDLE) -> u32;
