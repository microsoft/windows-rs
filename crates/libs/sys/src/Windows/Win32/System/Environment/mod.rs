pub type CallEnclave = unsafe extern "system" fn(lproutine: isize, lpparameter: *const core::ffi::c_void, fwaitforthread: windows_sys::core::BOOL, lpreturnvalue: *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type CreateEnclave = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lpaddress: *const core::ffi::c_void, dwsize: usize, dwinitialcommitment: usize, flenclavetype: u32, lpenclaveinformation: *const core::ffi::c_void, dwinfolength: u32, lpenclaveerror: *mut u32) -> *mut core::ffi::c_void;
...
pub type CreateEnvironmentBlock = unsafe extern "system" fn(lpenvironment: *mut *mut core::ffi::c_void, htoken: super::super::Foundation::HANDLE, binherit: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type DeleteEnclave = unsafe extern "system" fn(lpaddress: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type DestroyEnvironmentBlock = unsafe extern "system" fn(lpenvironment: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type EnclaveCopyIntoEnclave = unsafe extern "system" fn(enclaveaddress: *mut core::ffi::c_void, unsecureaddress: *const core::ffi::c_void, numberofbytes: usize) -> windows_sys::core::HRESULT;
...
pub type EnclaveCopyOutOfEnclave = unsafe extern "system" fn(unsecureaddress: *mut core::ffi::c_void, enclaveaddress: *const core::ffi::c_void, numberofbytes: usize) -> windows_sys::core::HRESULT;
...
pub type EnclaveEncryptDataForTrustlet = unsafe extern "system" fn(datatoencrypt: *const core::ffi::c_void, datatoencryptsize: u32, trustletbindingdata: *const TRUSTLET_BINDING_DATA, encrypteddata: *mut core::ffi::c_void, buffersize: u32, encrypteddatasize: *mut u32) -> windows_sys::core::HRESULT;
...
pub type EnclaveGetAttestationReport = unsafe extern "system" fn(enclavedata: *const u8, report: *mut core::ffi::c_void, buffersize: u32, outputsize: *mut u32) -> windows_sys::core::HRESULT;
...
pub type EnclaveGetEnclaveInformation = unsafe extern "system" fn(informationsize: u32, enclaveinformation: *mut ENCLAVE_INFORMATION) -> windows_sys::core::HRESULT;
...
pub type EnclaveRestrictContainingProcessAccess = unsafe extern "system" fn(restrictaccess: windows_sys::core::BOOL, previouslyrestricted: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type EnclaveSealData = unsafe extern "system" fn(datatoencrypt: *const core::ffi::c_void, datatoencryptsize: u32, identitypolicy: ENCLAVE_SEALING_IDENTITY_POLICY, runtimepolicy: u32, protectedblob: *mut core::ffi::c_void, buffersize: u32, protectedblobsize: *mut u32) -> windows_sys::core::HRESULT;
...
pub type EnclaveUnsealData = unsafe extern "system" fn(protectedblob: *const core::ffi::c_void, protectedblobsize: u32, decrypteddata: *mut core::ffi::c_void, buffersize: u32, decrypteddatasize: *mut u32, sealingidentity: *mut ENCLAVE_IDENTITY, unsealingflags: *mut u32) -> windows_sys::core::HRESULT;
...
pub type EnclaveUsesAttestedKeys = unsafe extern "system" fn() -> bool;
windows_link::link!("vertdll.dll" "system" fn EnclaveUsesAttestedKeys() -> bool);
pub type EnclaveVerifyAttestationReport = unsafe extern "system" fn(enclavetype: u32, report: *const core::ffi::c_void, reportsize: u32) -> windows_sys::core::HRESULT;
...
pub type ExpandEnvironmentStringsA = unsafe extern "system" fn(lpsrc: windows_sys::core::PCSTR, lpdst: windows_sys::core::PSTR, nsize: u32) -> u32;
...
pub type ExpandEnvironmentStringsForUserA = unsafe extern "system" fn(htoken: super::super::Foundation::HANDLE, lpsrc: windows_sys::core::PCSTR, lpdest: windows_sys::core::PSTR, dwsize: u32) -> windows_sys::core::BOOL;
...
pub type ExpandEnvironmentStringsForUserW = unsafe extern "system" fn(htoken: super::super::Foundation::HANDLE, lpsrc: windows_sys::core::PCWSTR, lpdest: windows_sys::core::PWSTR, dwsize: u32) -> windows_sys::core::BOOL;
...
pub type ExpandEnvironmentStringsW = unsafe extern "system" fn(lpsrc: windows_sys::core::PCWSTR, lpdst: windows_sys::core::PWSTR, nsize: u32) -> u32;
...
pub type FreeEnvironmentStringsA = unsafe extern "system" fn(penv: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn FreeEnvironmentStringsA(penv : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
pub type FreeEnvironmentStringsW = unsafe extern "system" fn(penv: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn FreeEnvironmentStringsW(penv : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
pub type GetCommandLineA = unsafe extern "system" fn() -> windows_sys::core::PCSTR;
windows_link::link!("kernel32.dll" "system" fn GetCommandLineA() -> windows_sys::core::PCSTR);
pub type GetCommandLineW = unsafe extern "system" fn() -> windows_sys::core::PCWSTR;
windows_link::link!("kernel32.dll" "system" fn GetCommandLineW() -> windows_sys::core::PCWSTR);
pub type GetCurrentDirectoryA = unsafe extern "system" fn(nbufferlength: u32, lpbuffer: windows_sys::core::PSTR) -> u32;
windows_link::link!("kernel32.dll" "system" fn GetCurrentDirectoryA(nbufferlength : u32, lpbuffer : windows_sys::core::PSTR) -> u32);
pub type GetCurrentDirectoryW = unsafe extern "system" fn(nbufferlength: u32, lpbuffer: windows_sys::core::PWSTR) -> u32;
windows_link::link!("kernel32.dll" "system" fn GetCurrentDirectoryW(nbufferlength : u32, lpbuffer : windows_sys::core::PWSTR) -> u32);
pub type GetEnvironmentStrings = unsafe extern "system" fn() -> windows_sys::core::PSTR;
windows_link::link!("kernel32.dll" "system" fn GetEnvironmentStrings() -> windows_sys::core::PSTR);
pub type GetEnvironmentStringsW = unsafe extern "system" fn() -> windows_sys::core::PWSTR;
windows_link::link!("kernel32.dll" "system" fn GetEnvironmentStringsW() -> windows_sys::core::PWSTR);
pub type GetEnvironmentVariableA = unsafe extern "system" fn(lpname: windows_sys::core::PCSTR, lpbuffer: windows_sys::core::PSTR, nsize: u32) -> u32;
...
pub type GetEnvironmentVariableW = unsafe extern "system" fn(lpname: windows_sys::core::PCWSTR, lpbuffer: windows_sys::core::PWSTR, nsize: u32) -> u32;
...
pub type InitializeEnclave = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lpaddress: *const core::ffi::c_void, lpenclaveinformation: *const core::ffi::c_void, dwinfolength: u32, lpenclaveerror: *mut u32) -> windows_sys::core::BOOL;
...
pub type IsEnclaveTypeSupported = unsafe extern "system" fn(flenclavetype: u32) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn IsEnclaveTypeSupported(flenclavetype : u32) -> windows_sys::core::BOOL);
pub type LoadEnclaveData = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lpaddress: *const core::ffi::c_void, lpbuffer: *const core::ffi::c_void, nsize: usize, flprotect: u32, lppageinformation: *const core::ffi::c_void, dwinfolength: u32, lpnumberofbyteswritten: *mut usize, lpenclaveerror: *mut u32) -> windows_sys::core::BOOL;
...
pub type LoadEnclaveImageA = unsafe extern "system" fn(lpenclaveaddress: *const core::ffi::c_void, lpimagename: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type LoadEnclaveImageW = unsafe extern "system" fn(lpenclaveaddress: *const core::ffi::c_void, lpimagename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type NeedCurrentDirectoryForExePathA = unsafe extern "system" fn(exename: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type NeedCurrentDirectoryForExePathW = unsafe extern "system" fn(exename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SetCurrentDirectoryA = unsafe extern "system" fn(lppathname: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn SetCurrentDirectoryA(lppathname : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
pub type SetCurrentDirectoryW = unsafe extern "system" fn(lppathname: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn SetCurrentDirectoryW(lppathname : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
pub type SetEnvironmentStringsW = unsafe extern "system" fn(newenvironment: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SetEnvironmentVariableA = unsafe extern "system" fn(lpname: windows_sys::core::PCSTR, lpvalue: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type SetEnvironmentVariableW = unsafe extern "system" fn(lpname: windows_sys::core::PCWSTR, lpvalue: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type TerminateEnclave = unsafe extern "system" fn(lpaddress: *const core::ffi::c_void, fwait: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
