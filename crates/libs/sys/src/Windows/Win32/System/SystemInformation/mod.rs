pub type DnsHostnameToComputerNameExW = unsafe extern "system" fn(hostname: windows_sys::core::PCWSTR, computername: windows_sys::core::PWSTR, nsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type EnumSystemFirmwareTables = unsafe extern "system" fn(firmwaretableprovidersignature: FIRMWARE_TABLE_PROVIDER, pfirmwaretableenumbuffer: *mut u8, buffersize: u32) -> u32;
...
pub type GetComputerNameExA = unsafe extern "system" fn(nametype: COMPUTER_NAME_FORMAT, lpbuffer: windows_sys::core::PSTR, nsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetComputerNameExW = unsafe extern "system" fn(nametype: COMPUTER_NAME_FORMAT, lpbuffer: windows_sys::core::PWSTR, nsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetDeveloperDriveEnablementState = unsafe extern "system" fn() -> DEVELOPER_DRIVE_ENABLEMENT_STATE;
...
pub type GetFirmwareType = unsafe extern "system" fn(firmwaretype: *mut FIRMWARE_TYPE) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn GetFirmwareType(firmwaretype : *mut FIRMWARE_TYPE) -> windows_sys::core::BOOL);
pub type GetIntegratedDisplaySize = unsafe extern "system" fn(sizeininches: *mut f64) -> windows_sys::core::HRESULT;
...
pub type GetLocalTime = unsafe extern "system" fn(lpsystemtime: *mut super::super::Foundation::SYSTEMTIME);
windows_link::link!("kernel32.dll" "system" fn GetLocalTime(lpsystemtime : *mut super::super::Foundation::SYSTEMTIME));
pub type GetLogicalProcessorInformation = unsafe extern "system" fn(buffer: *mut SYSTEM_LOGICAL_PROCESSOR_INFORMATION, returnedlength: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetLogicalProcessorInformationEx = unsafe extern "system" fn(relationshiptype: LOGICAL_PROCESSOR_RELATIONSHIP, buffer: *mut SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX, returnedlength: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetNativeSystemInfo = unsafe extern "system" fn(lpsysteminfo: *mut SYSTEM_INFO);
windows_link::link!("kernel32.dll" "system" fn GetNativeSystemInfo(lpsysteminfo : *mut SYSTEM_INFO));
pub type GetOsManufacturingMode = unsafe extern "system" fn(pbenabled: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type GetOsSafeBootMode = unsafe extern "system" fn(flags: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("api-ms-win-core-sysinfo-l1-2-0.dll" "system" fn GetOsSafeBootMode(flags : *mut u32) -> windows_sys::core::BOOL);
pub type GetPhysicallyInstalledSystemMemory = unsafe extern "system" fn(totalmemoryinkilobytes: *mut u64) -> windows_sys::core::BOOL;
...
pub type GetProcessorSystemCycleTime = unsafe extern "system" fn(group: u16, buffer: *mut SYSTEM_PROCESSOR_CYCLE_TIME_INFORMATION, returnedlength: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetProductInfo = unsafe extern "system" fn(dwosmajorversion: u32, dwosminorversion: u32, dwspmajorversion: u32, dwspminorversion: u32, pdwreturnedproducttype: *mut OS_PRODUCT_TYPE) -> windows_sys::core::BOOL;
...
pub type GetRuntimeAttestationReport = unsafe extern "system" fn(nonce: *const u8, packageversion: u16, reporttypesbitmap: u64, reportbuffer: *mut core::ffi::c_void, reportbuffersize: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetSystemCpuSetInformation = unsafe extern "system" fn(information: *mut SYSTEM_CPU_SET_INFORMATION, bufferlength: u32, returnedlength: *mut u32, process: super::super::Foundation::HANDLE, flags: u32) -> windows_sys::core::BOOL;
...
pub type GetSystemDEPPolicy = unsafe extern "system" fn() -> DEP_SYSTEM_POLICY_TYPE;
windows_link::link!("kernel32.dll" "system" fn GetSystemDEPPolicy() -> DEP_SYSTEM_POLICY_TYPE);
pub type GetSystemDirectoryA = unsafe extern "system" fn(lpbuffer: windows_sys::core::PSTR, usize: u32) -> u32;
windows_link::link!("kernel32.dll" "system" fn GetSystemDirectoryA(lpbuffer : windows_sys::core::PSTR, usize : u32) -> u32);
pub type GetSystemDirectoryW = unsafe extern "system" fn(lpbuffer: windows_sys::core::PWSTR, usize: u32) -> u32;
windows_link::link!("kernel32.dll" "system" fn GetSystemDirectoryW(lpbuffer : windows_sys::core::PWSTR, usize : u32) -> u32);
pub type GetSystemFirmwareTable = unsafe extern "system" fn(firmwaretableprovidersignature: FIRMWARE_TABLE_PROVIDER, firmwaretableid: u32, pfirmwaretablebuffer: *mut u8, buffersize: u32) -> u32;
...
pub type GetSystemInfo = unsafe extern "system" fn(lpsysteminfo: *mut SYSTEM_INFO);
windows_link::link!("kernel32.dll" "system" fn GetSystemInfo(lpsysteminfo : *mut SYSTEM_INFO));
pub type GetSystemLeapSecondInformation = unsafe extern "system" fn(enabled: *mut windows_sys::core::BOOL, flags: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetSystemTime = unsafe extern "system" fn(lpsystemtime: *mut super::super::Foundation::SYSTEMTIME);
windows_link::link!("kernel32.dll" "system" fn GetSystemTime(lpsystemtime : *mut super::super::Foundation::SYSTEMTIME));
pub type GetSystemTimeAdjustment = unsafe extern "system" fn(lptimeadjustment: *mut u32, lptimeincrement: *mut u32, lptimeadjustmentdisabled: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type GetSystemTimeAdjustmentPrecise = unsafe extern "system" fn(lptimeadjustment: *mut u64, lptimeincrement: *mut u64, lptimeadjustmentdisabled: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type GetSystemTimeAsFileTime = unsafe extern "system" fn(lpsystemtimeasfiletime: *mut super::super::Foundation::FILETIME);
...
pub type GetSystemTimePreciseAsFileTime = unsafe extern "system" fn(lpsystemtimeasfiletime: *mut super::super::Foundation::FILETIME);
...
pub type GetSystemWindowsDirectoryA = unsafe extern "system" fn(lpbuffer: windows_sys::core::PSTR, usize: u32) -> u32;
windows_link::link!("kernel32.dll" "system" fn GetSystemWindowsDirectoryA(lpbuffer : windows_sys::core::PSTR, usize : u32) -> u32);
pub type GetSystemWindowsDirectoryW = unsafe extern "system" fn(lpbuffer: windows_sys::core::PWSTR, usize: u32) -> u32;
windows_link::link!("kernel32.dll" "system" fn GetSystemWindowsDirectoryW(lpbuffer : windows_sys::core::PWSTR, usize : u32) -> u32);
pub type GetSystemWow64Directory2A = unsafe extern "system" fn(lpbuffer: windows_sys::core::PSTR, usize: u32, imagefilemachinetype: IMAGE_FILE_MACHINE) -> u32;
...
pub type GetSystemWow64Directory2W = unsafe extern "system" fn(lpbuffer: windows_sys::core::PWSTR, usize: u32, imagefilemachinetype: IMAGE_FILE_MACHINE) -> u32;
...
pub type GetSystemWow64DirectoryA = unsafe extern "system" fn(lpbuffer: windows_sys::core::PSTR, usize: u32) -> u32;
windows_link::link!("kernel32.dll" "system" fn GetSystemWow64DirectoryA(lpbuffer : windows_sys::core::PSTR, usize : u32) -> u32);
pub type GetSystemWow64DirectoryW = unsafe extern "system" fn(lpbuffer: windows_sys::core::PWSTR, usize: u32) -> u32;
...
pub type GetVersion = unsafe extern "system" fn() -> u32;
windows_link::link!("kernel32.dll" "system" fn GetVersion() -> u32);
pub type GetVersionExA = unsafe extern "system" fn(lpversioninformation: *mut OSVERSIONINFOA) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn GetVersionExA(lpversioninformation : *mut OSVERSIONINFOA) -> windows_sys::core::BOOL);
pub type GetVersionExW = unsafe extern "system" fn(lpversioninformation: *mut OSVERSIONINFOW) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn GetVersionExW(lpversioninformation : *mut OSVERSIONINFOW) -> windows_sys::core::BOOL);
pub type GetWindowsDirectoryA = unsafe extern "system" fn(lpbuffer: windows_sys::core::PSTR, usize: u32) -> u32;
windows_link::link!("kernel32.dll" "system" fn GetWindowsDirectoryA(lpbuffer : windows_sys::core::PSTR, usize : u32) -> u32);
pub type GetWindowsDirectoryW = unsafe extern "system" fn(lpbuffer: windows_sys::core::PWSTR, usize: u32) -> u32;
...
pub type GlobalMemoryStatusEx = unsafe extern "system" fn(lpbuffer: *mut MEMORYSTATUSEX) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn GlobalMemoryStatusEx(lpbuffer : *mut MEMORYSTATUSEX) -> windows_sys::core::BOOL);
pub type IsUserCetAvailableInEnvironment = unsafe extern "system" fn(usercetenvironment: USER_CET_ENVIRONMENT) -> windows_sys::core::BOOL;
...
pub type IsWow64GuestMachineSupported = unsafe extern "system" fn(wowguestmachine: IMAGE_FILE_MACHINE, machineissupported: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type RtlConvertDeviceFamilyInfoToString = unsafe extern "system" fn(puldevicefamilybuffersize: *mut u32, puldeviceformbuffersize: *mut u32, devicefamily: windows_sys::core::PWSTR, deviceform: windows_sys::core::PWSTR) -> u32;
...
pub type RtlGetDeviceFamilyInfoEnum = unsafe extern "system" fn(pulluapinfo: *mut u64, puldevicefamily: *mut DEVICEFAMILYINFOENUM, puldeviceform: *mut DEVICEFAMILYDEVICEFORM);
...
pub type RtlGetProductInfo = unsafe extern "system" fn(osmajorversion: u32, osminorversion: u32, spmajorversion: u32, spminorversion: u32, returnedproducttype: *mut u32) -> bool;
...
pub type RtlGetSystemGlobalData = unsafe extern "system" fn(dataid: RTL_SYSTEM_GLOBAL_DATA_ID, buffer: *mut core::ffi::c_void, size: u32) -> u32;
...
pub type RtlOsDeploymentState = unsafe extern "system" fn(flags: u32) -> OS_DEPLOYEMENT_STATE_VALUES;
windows_link::link!("ntdll.dll" "system" fn RtlOsDeploymentState(flags : u32) -> OS_DEPLOYEMENT_STATE_VALUES);
pub type RtlSwitchedVVI = unsafe extern "system" fn(versioninfo: *const OSVERSIONINFOEXW, typemask: u32, conditionmask: u64) -> u32;
...
pub type SetComputerNameA = unsafe extern "system" fn(lpcomputername: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn SetComputerNameA(lpcomputername : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
pub type SetComputerNameEx2W = unsafe extern "system" fn(nametype: COMPUTER_NAME_FORMAT, flags: u32, lpbuffer: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SetComputerNameExA = unsafe extern "system" fn(nametype: COMPUTER_NAME_FORMAT, lpbuffer: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type SetComputerNameExW = unsafe extern "system" fn(nametype: COMPUTER_NAME_FORMAT, lpbuffer: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type SetComputerNameW = unsafe extern "system" fn(lpcomputername: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn SetComputerNameW(lpcomputername : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
pub type SetLocalTime = unsafe extern "system" fn(lpsystemtime: *const super::super::Foundation::SYSTEMTIME) -> windows_sys::core::BOOL;
...
pub type SetSystemTime = unsafe extern "system" fn(lpsystemtime: *const super::super::Foundation::SYSTEMTIME) -> windows_sys::core::BOOL;
...
pub type SetSystemTimeAdjustment = unsafe extern "system" fn(dwtimeadjustment: u32, btimeadjustmentdisabled: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type SetSystemTimeAdjustmentPrecise = unsafe extern "system" fn(dwtimeadjustment: u64, btimeadjustmentdisabled: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type VerSetConditionMask = unsafe extern "system" fn(conditionmask: u64, typemask: VER_FLAGS, condition: u8) -> u64;
windows_link::link!("kernel32.dll" "system" fn VerSetConditionMask(conditionmask : u64, typemask : VER_FLAGS, condition : u8) -> u64);
pub type VerifyVersionInfoA = unsafe extern "system" fn(lpversioninformation: *mut OSVERSIONINFOEXA, dwtypemask: VER_FLAGS, dwlconditionmask: u64) -> windows_sys::core::BOOL;
...
pub type VerifyVersionInfoW = unsafe extern "system" fn(lpversioninformation: *mut OSVERSIONINFOEXW, dwtypemask: VER_FLAGS, dwlconditionmask: u64) -> windows_sys::core::BOOL;
