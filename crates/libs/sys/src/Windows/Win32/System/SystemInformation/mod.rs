windows_link::link!("kernel32.dll" "system" fn DnsHostnameToComputerNameExW(hostname : windows_sys::core::PCWSTR, computername : windows_sys::core::PCWSTR, nsize : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("kernel32.dll" "system" fn GetComputerNameExA(nametype : COMPUTER_NAME_FORMAT, lpbuffer : windows_sys::core::PCSTR, nsize : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("kernel32.dll" "system" fn GetComputerNameExW(nametype : COMPUTER_NAME_FORMAT, lpbuffer : windows_sys::core::PCWSTR, nsize : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("kernel32.dll" "system" fn GetSystemDirectoryA(lpbuffer : windows_sys::core::PCSTR, usize : u32) -> u32);
windows_link::link!("kernel32.dll" "system" fn GetSystemDirectoryW(lpbuffer : windows_sys::core::PCWSTR, usize : u32) -> u32);
...
windows_link::link!("kernel32.dll" "system" fn GetSystemWindowsDirectoryW(lpbuffer : windows_sys::core::PCWSTR, usize : u32) -> u32);
...
windows_link::link!("api-ms-win-core-wow64-l1-1-1.dll" "system" fn GetSystemWow64Directory2W(lpbuffer : windows_sys::core::PCWSTR, usize : u32, imagefilemachinetype : IMAGE_FILE_MACHINE) -> u32);
windows_link::link!("kernel32.dll" "system" fn GetSystemWow64DirectoryA(lpbuffer : windows_sys::core::PCSTR, usize : u32) -> u32);
...
windows_link::link!("kernel32.dll" "system" fn GetWindowsDirectoryW(lpbuffer : windows_sys::core::PCWSTR, usize : u32) -> u32);
...
windows_link::link!("ntdll.dll" "system" fn RtlSwitchedVVI(versioninfo : *mut OSVERSIONINFOEXW, typemask : u32, conditionmask : u64) -> u32);
...
windows_link::link!("kernel32.dll" "system" fn SetLocalTime(lpsystemtime : *mut super::super::Foundation:: SYSTEMTIME) -> windows_sys::core::BOOL);
windows_link::link!("kernel32.dll" "system" fn SetSystemTime(lpsystemtime : *mut super::super::Foundation:: SYSTEMTIME) -> windows_sys::core::BOOL);
...
pub type PGET_SYSTEM_WOW64_DIRECTORY_W = Option<unsafe extern "system" fn(lpbuffer: windows_sys::core::PCWSTR, usize: u32) -> u32>;
