pub type EcClose = unsafe extern "system" fn(object: isize) -> windows_sys::core::BOOL;
windows_link::link!("wecapi.dll" "system" fn EcClose(object : isize) -> windows_sys::core::BOOL);
pub type EcDeleteSubscription = unsafe extern "system" fn(subscriptionname: windows_sys::core::PCWSTR, flags: u32) -> windows_sys::core::BOOL;
...
pub type EcEnumNextSubscription = unsafe extern "system" fn(subscriptionenum: isize, subscriptionnamebuffersize: u32, subscriptionnamebuffer: windows_sys::core::PWSTR, subscriptionnamebufferused: *mut u32) -> windows_sys::core::BOOL;
...
pub type EcGetObjectArrayProperty = unsafe extern "system" fn(objectarray: isize, propertyid: EC_SUBSCRIPTION_PROPERTY_ID, arrayindex: u32, flags: u32, propertyvaluebuffersize: u32, propertyvaluebuffer: *mut EC_VARIANT, propertyvaluebufferused: *mut u32) -> windows_sys::core::BOOL;
...
pub type EcGetObjectArraySize = unsafe extern "system" fn(objectarray: isize, objectarraysize: *mut u32) -> windows_sys::core::BOOL;
...
pub type EcGetSubscriptionProperty = unsafe extern "system" fn(subscription: isize, propertyid: EC_SUBSCRIPTION_PROPERTY_ID, flags: u32, propertyvaluebuffersize: u32, propertyvaluebuffer: *mut EC_VARIANT, propertyvaluebufferused: *mut u32) -> windows_sys::core::BOOL;
...
pub type EcInsertObjectArrayElement = unsafe extern "system" fn(objectarray: isize, arrayindex: u32) -> windows_sys::core::BOOL;
windows_link::link!("wecapi.dll" "system" fn EcInsertObjectArrayElement(objectarray : isize, arrayindex : u32) -> windows_sys::core::BOOL);
pub type EcOpenSubscription = unsafe extern "system" fn(subscriptionname: windows_sys::core::PCWSTR, accessmask: u32, flags: u32) -> isize;
...
pub type EcRemoveObjectArrayElement = unsafe extern "system" fn(objectarray: isize, arrayindex: u32) -> windows_sys::core::BOOL;
windows_link::link!("wecapi.dll" "system" fn EcRemoveObjectArrayElement(objectarray : isize, arrayindex : u32) -> windows_sys::core::BOOL);
pub type EcRetrySubscription = unsafe extern "system" fn(subscriptionname: windows_sys::core::PCWSTR, eventsourcename: windows_sys::core::PCWSTR, flags: u32) -> windows_sys::core::BOOL;
...
pub type EcSaveSubscription = unsafe extern "system" fn(subscription: isize, flags: u32) -> windows_sys::core::BOOL;
windows_link::link!("wecapi.dll" "system" fn EcSaveSubscription(subscription : isize, flags : u32) -> windows_sys::core::BOOL);
pub type EcSetObjectArrayProperty = unsafe extern "system" fn(objectarray: isize, propertyid: EC_SUBSCRIPTION_PROPERTY_ID, arrayindex: u32, flags: u32, propertyvalue: *mut EC_VARIANT) -> windows_sys::core::BOOL;
...
pub type EcSetSubscriptionProperty = unsafe extern "system" fn(subscription: isize, propertyid: EC_SUBSCRIPTION_PROPERTY_ID, flags: u32, propertyvalue: *mut EC_VARIANT) -> windows_sys::core::BOOL;
