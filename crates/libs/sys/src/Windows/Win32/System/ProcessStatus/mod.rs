...
windows_link::link!("psapi.dll" "system" fn GetDeviceDriverBaseNameA(imagebase : *mut core::ffi::c_void, lpfilename : windows_sys::core::PCSTR, nsize : u32) -> u32);
windows_link::link!("psapi.dll" "system" fn GetDeviceDriverBaseNameW(imagebase : *mut core::ffi::c_void, lpbasename : windows_sys::core::PCWSTR, nsize : u32) -> u32);
windows_link::link!("psapi.dll" "system" fn GetDeviceDriverFileNameA(imagebase : *mut core::ffi::c_void, lpfilename : windows_sys::core::PCSTR, nsize : u32) -> u32);
windows_link::link!("psapi.dll" "system" fn GetDeviceDriverFileNameW(imagebase : *mut core::ffi::c_void, lpfilename : windows_sys::core::PCWSTR, nsize : u32) -> u32);
windows_link::link!("psapi.dll" "system" fn GetMappedFileNameA(hprocess : super::super::Foundation:: HANDLE, lpv : *mut core::ffi::c_void, lpfilename : windows_sys::core::PCSTR, nsize : u32) -> u32);
windows_link::link!("psapi.dll" "system" fn GetMappedFileNameW(hprocess : super::super::Foundation:: HANDLE, lpv : *mut core::ffi::c_void, lpfilename : windows_sys::core::PCWSTR, nsize : u32) -> u32);
windows_link::link!("psapi.dll" "system" fn GetModuleBaseNameA(hprocess : super::super::Foundation:: HANDLE, hmodule : super::super::Foundation:: HMODULE, lpbasename : windows_sys::core::PCSTR, nsize : u32) -> u32);
windows_link::link!("psapi.dll" "system" fn GetModuleBaseNameW(hprocess : super::super::Foundation:: HANDLE, hmodule : super::super::Foundation:: HMODULE, lpbasename : windows_sys::core::PCWSTR, nsize : u32) -> u32);
...
windows_link::link!("psapi.dll" "system" fn GetModuleFileNameExW(hprocess : super::super::Foundation:: HANDLE, hmodule : super::super::Foundation:: HMODULE, lpfilename : windows_sys::core::PCWSTR, nsize : u32) -> u32);
...
windows_link::link!("psapi.dll" "system" fn GetProcessImageFileNameA(hprocess : super::super::Foundation:: HANDLE, lpimagefilename : windows_sys::core::PCSTR, nsize : u32) -> u32);
...
windows_link::link!("kernel32.dll" "system" fn K32GetDeviceDriverBaseNameA(imagebase : *mut core::ffi::c_void, lpfilename : windows_sys::core::PCSTR, nsize : u32) -> u32);
windows_link::link!("kernel32.dll" "system" fn K32GetDeviceDriverBaseNameW(imagebase : *mut core::ffi::c_void, lpbasename : windows_sys::core::PCWSTR, nsize : u32) -> u32);
windows_link::link!("kernel32.dll" "system" fn K32GetDeviceDriverFileNameA(imagebase : *mut core::ffi::c_void, lpfilename : windows_sys::core::PCSTR, nsize : u32) -> u32);
windows_link::link!("kernel32.dll" "system" fn K32GetDeviceDriverFileNameW(imagebase : *mut core::ffi::c_void, lpfilename : windows_sys::core::PCWSTR, nsize : u32) -> u32);
...
windows_link::link!("kernel32.dll" "system" fn K32GetMappedFileNameW(hprocess : super::super::Foundation:: HANDLE, lpv : *mut core::ffi::c_void, lpfilename : windows_sys::core::PCWSTR, nsize : u32) -> u32);
windows_link::link!("kernel32.dll" "system" fn K32GetModuleBaseNameA(hprocess : super::super::Foundation:: HANDLE, hmodule : super::super::Foundation:: HMODULE, lpbasename : windows_sys::core::PCSTR, nsize : u32) -> u32);
windows_link::link!("kernel32.dll" "system" fn K32GetModuleBaseNameW(hprocess : super::super::Foundation:: HANDLE, hmodule : super::super::Foundation:: HMODULE, lpbasename : windows_sys::core::PCWSTR, nsize : u32) -> u32);
windows_link::link!("kernel32.dll" "system" fn K32GetModuleFileNameExA(hprocess : super::super::Foundation:: HANDLE, hmodule : super::super::Foundation:: HMODULE, lpfilename : windows_sys::core::PCSTR, nsize : u32) -> u32);
windows_link::link!("kernel32.dll" "system" fn K32GetModuleFileNameExW(hprocess : super::super::Foundation:: HANDLE, hmodule : super::super::Foundation:: HMODULE, lpfilename : windows_sys::core::PCWSTR, nsize : u32) -> u32);
...
windows_link::link!("kernel32.dll" "system" fn K32GetProcessImageFileNameA(hprocess : super::super::Foundation:: HANDLE, lpimagefilename : windows_sys::core::PCSTR, nsize : u32) -> u32);
windows_link::link!("kernel32.dll" "system" fn K32GetProcessImageFileNameW(hprocess : super::super::Foundation:: HANDLE, lpimagefilename : windows_sys::core::PCWSTR, nsize : u32) -> u32);
