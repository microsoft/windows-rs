pub type EmptyWorkingSet = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("psapi.dll" "system" fn EmptyWorkingSet(hprocess : super::super::Foundation::HANDLE) -> windows_sys::core::BOOL);
pub type EnumDeviceDrivers = unsafe extern "system" fn(lpimagebase: *mut *mut core::ffi::c_void, cb: u32, lpcbneeded: *mut u32) -> windows_sys::core::BOOL;
...
pub type EnumPageFilesA = unsafe extern "system" fn(pcallbackroutine: PENUM_PAGE_FILE_CALLBACKA, pcontext: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type EnumPageFilesW = unsafe extern "system" fn(pcallbackroutine: PENUM_PAGE_FILE_CALLBACKW, pcontext: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type EnumProcessModules = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lphmodule: *mut super::super::Foundation::HMODULE, cb: u32, lpcbneeded: *mut u32) -> windows_sys::core::BOOL;
...
pub type EnumProcessModulesEx = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lphmodule: *mut super::super::Foundation::HMODULE, cb: u32, lpcbneeded: *mut u32, dwfilterflag: ENUM_PROCESS_MODULES_EX_FLAGS) -> windows_sys::core::BOOL;
...
pub type EnumProcesses = unsafe extern "system" fn(lpidprocess: *mut u32, cb: u32, lpcbneeded: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("psapi.dll" "system" fn EnumProcesses(lpidprocess : *mut u32, cb : u32, lpcbneeded : *mut u32) -> windows_sys::core::BOOL);
pub type GetDeviceDriverBaseNameA = unsafe extern "system" fn(imagebase: *const core::ffi::c_void, lpfilename: windows_sys::core::PSTR, nsize: u32) -> u32;
...
pub type GetDeviceDriverBaseNameW = unsafe extern "system" fn(imagebase: *const core::ffi::c_void, lpbasename: windows_sys::core::PWSTR, nsize: u32) -> u32;
...
pub type GetDeviceDriverFileNameA = unsafe extern "system" fn(imagebase: *const core::ffi::c_void, lpfilename: windows_sys::core::PSTR, nsize: u32) -> u32;
...
pub type GetDeviceDriverFileNameW = unsafe extern "system" fn(imagebase: *const core::ffi::c_void, lpfilename: windows_sys::core::PWSTR, nsize: u32) -> u32;
...
pub type GetMappedFileNameA = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lpv: *const core::ffi::c_void, lpfilename: windows_sys::core::PSTR, nsize: u32) -> u32;
...
pub type GetMappedFileNameW = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lpv: *const core::ffi::c_void, lpfilename: windows_sys::core::PWSTR, nsize: u32) -> u32;
...
pub type GetModuleBaseNameA = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, hmodule: super::super::Foundation::HMODULE, lpbasename: windows_sys::core::PSTR, nsize: u32) -> u32;
...
pub type GetModuleBaseNameW = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, hmodule: super::super::Foundation::HMODULE, lpbasename: windows_sys::core::PWSTR, nsize: u32) -> u32;
...
pub type GetModuleFileNameExA = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, hmodule: super::super::Foundation::HMODULE, lpfilename: windows_sys::core::PSTR, nsize: u32) -> u32;
...
pub type GetModuleFileNameExW = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, hmodule: super::super::Foundation::HMODULE, lpfilename: windows_sys::core::PWSTR, nsize: u32) -> u32;
...
pub type GetModuleInformation = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, hmodule: super::super::Foundation::HMODULE, lpmodinfo: *mut MODULEINFO, cb: u32) -> windows_sys::core::BOOL;
...
pub type GetPerformanceInfo = unsafe extern "system" fn(pperformanceinformation: *mut PERFORMANCE_INFORMATION, cb: u32) -> windows_sys::core::BOOL;
...
pub type GetProcessImageFileNameA = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lpimagefilename: windows_sys::core::PSTR, nsize: u32) -> u32;
...
pub type GetProcessImageFileNameW = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lpimagefilename: windows_sys::core::PWSTR, nsize: u32) -> u32;
...
pub type GetProcessMemoryInfo = unsafe extern "system" fn(process: super::super::Foundation::HANDLE, ppsmemcounters: *mut PROCESS_MEMORY_COUNTERS, cb: u32) -> windows_sys::core::BOOL;
...
pub type GetWsChanges = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lpwatchinfo: *mut PSAPI_WS_WATCH_INFORMATION, cb: u32) -> windows_sys::core::BOOL;
...
pub type GetWsChangesEx = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lpwatchinfoex: *mut PSAPI_WS_WATCH_INFORMATION_EX, cb: *mut u32) -> windows_sys::core::BOOL;
...
pub type InitializeProcessForWsWatch = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
...
pub type K32EmptyWorkingSet = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn K32EmptyWorkingSet(hprocess : super::super::Foundation::HANDLE) -> windows_sys::core::BOOL);
pub type K32EnumDeviceDrivers = unsafe extern "system" fn(lpimagebase: *mut *mut core::ffi::c_void, cb: u32, lpcbneeded: *mut u32) -> windows_sys::core::BOOL;
...
pub type K32EnumPageFilesA = unsafe extern "system" fn(pcallbackroutine: PENUM_PAGE_FILE_CALLBACKA, pcontext: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type K32EnumPageFilesW = unsafe extern "system" fn(pcallbackroutine: PENUM_PAGE_FILE_CALLBACKW, pcontext: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type K32EnumProcessModules = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lphmodule: *mut super::super::Foundation::HMODULE, cb: u32, lpcbneeded: *mut u32) -> windows_sys::core::BOOL;
...
pub type K32EnumProcessModulesEx = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lphmodule: *mut super::super::Foundation::HMODULE, cb: u32, lpcbneeded: *mut u32, dwfilterflag: u32) -> windows_sys::core::BOOL;
...
pub type K32EnumProcesses = unsafe extern "system" fn(lpidprocess: *mut u32, cb: u32, lpcbneeded: *mut u32) -> windows_sys::core::BOOL;
...
pub type K32GetDeviceDriverBaseNameA = unsafe extern "system" fn(imagebase: *const core::ffi::c_void, lpfilename: windows_sys::core::PSTR, nsize: u32) -> u32;
...
pub type K32GetDeviceDriverBaseNameW = unsafe extern "system" fn(imagebase: *const core::ffi::c_void, lpbasename: windows_sys::core::PWSTR, nsize: u32) -> u32;
...
pub type K32GetDeviceDriverFileNameA = unsafe extern "system" fn(imagebase: *const core::ffi::c_void, lpfilename: windows_sys::core::PSTR, nsize: u32) -> u32;
...
pub type K32GetDeviceDriverFileNameW = unsafe extern "system" fn(imagebase: *const core::ffi::c_void, lpfilename: windows_sys::core::PWSTR, nsize: u32) -> u32;
...
pub type K32GetMappedFileNameA = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lpv: *const core::ffi::c_void, lpfilename: windows_sys::core::PSTR, nsize: u32) -> u32;
...
pub type K32GetMappedFileNameW = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lpv: *const core::ffi::c_void, lpfilename: windows_sys::core::PWSTR, nsize: u32) -> u32;
...
pub type K32GetModuleBaseNameA = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, hmodule: super::super::Foundation::HMODULE, lpbasename: windows_sys::core::PSTR, nsize: u32) -> u32;
...
pub type K32GetModuleBaseNameW = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, hmodule: super::super::Foundation::HMODULE, lpbasename: windows_sys::core::PWSTR, nsize: u32) -> u32;
...
pub type K32GetModuleFileNameExA = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, hmodule: super::super::Foundation::HMODULE, lpfilename: windows_sys::core::PSTR, nsize: u32) -> u32;
...
pub type K32GetModuleFileNameExW = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, hmodule: super::super::Foundation::HMODULE, lpfilename: windows_sys::core::PWSTR, nsize: u32) -> u32;
...
pub type K32GetModuleInformation = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, hmodule: super::super::Foundation::HMODULE, lpmodinfo: *mut MODULEINFO, cb: u32) -> windows_sys::core::BOOL;
...
pub type K32GetPerformanceInfo = unsafe extern "system" fn(pperformanceinformation: *mut PERFORMANCE_INFORMATION, cb: u32) -> windows_sys::core::BOOL;
...
pub type K32GetProcessImageFileNameA = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lpimagefilename: windows_sys::core::PSTR, nsize: u32) -> u32;
...
pub type K32GetProcessImageFileNameW = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lpimagefilename: windows_sys::core::PWSTR, nsize: u32) -> u32;
...
pub type K32GetProcessMemoryInfo = unsafe extern "system" fn(process: super::super::Foundation::HANDLE, ppsmemcounters: *mut PROCESS_MEMORY_COUNTERS, cb: u32) -> windows_sys::core::BOOL;
...
pub type K32GetWsChanges = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lpwatchinfo: *mut PSAPI_WS_WATCH_INFORMATION, cb: u32) -> windows_sys::core::BOOL;
...
pub type K32GetWsChangesEx = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, lpwatchinfoex: *mut PSAPI_WS_WATCH_INFORMATION_EX, cb: *mut u32) -> windows_sys::core::BOOL;
...
pub type K32InitializeProcessForWsWatch = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
...
pub type K32QueryWorkingSet = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, pv: *mut core::ffi::c_void, cb: u32) -> windows_sys::core::BOOL;
...
pub type K32QueryWorkingSetEx = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, pv: *mut core::ffi::c_void, cb: u32) -> windows_sys::core::BOOL;
...
pub type QueryWorkingSet = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, pv: *mut core::ffi::c_void, cb: u32) -> windows_sys::core::BOOL;
...
pub type QueryWorkingSetEx = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, pv: *mut core::ffi::c_void, cb: u32) -> windows_sys::core::BOOL;
