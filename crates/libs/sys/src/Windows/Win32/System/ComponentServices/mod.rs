windows_link::link!("comsvcs.dll" "system" fn CoCreateActivity(piunknown : * mut core::ffi::c_void, riid : *mut windows_sys::core::GUID, ppobj : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("ole32.dll" "system" fn CoGetDefaultContext(apttype : super::Com:: APTTYPE, riid : *mut windows_sys::core::GUID, ppv : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("comsvcs.dll" "system" fn MTSCreateActivity(riid : *mut windows_sys::core::GUID, ppobj : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("comsvcs.dll" "C" fn RecycleSurrogate(lreasoncode : i32) -> windows_sys::core::HRESULT);
windows_link::link!("comsvcs.dll" "C" fn SafeRef(rid : *mut windows_sys::core::GUID, punk : * mut core::ffi::c_void) -> *mut core::ffi::c_void);
#[repr(C)]
#[derive(Clone, Copy)]
pub struct APPDATA {
    pub m_idApp: u32,
