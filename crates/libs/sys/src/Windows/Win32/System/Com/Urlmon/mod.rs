...
pub type CoInternetCombineIUri = unsafe extern "system" fn(pbaseuri: *mut core::ffi::c_void, prelativeuri: *mut core::ffi::c_void, dwcombineflags: u32, ppcombineduri: *mut *mut core::ffi::c_void, dwreserved: usize) -> windows_sys::core::HRESULT;
...
pub type CoInternetCombineUrl = unsafe extern "system" fn(pwzbaseurl: windows_sys::core::PCWSTR, pwzrelativeurl: windows_sys::core::PCWSTR, dwcombineflags: u32, pszresult: windows_sys::core::PWSTR, cchresult: u32, pcchresult: *mut u32, dwreserved: u32) -> windows_sys::core::HRESULT;
...
pub type CoInternetCombineUrlEx = unsafe extern "system" fn(pbaseuri: *mut core::ffi::c_void, pwzrelativeurl: windows_sys::core::PCWSTR, dwcombineflags: u32, ppcombineduri: *mut *mut core::ffi::c_void, dwreserved: usize) -> windows_sys::core::HRESULT;
...
pub type CoInternetCompareUrl = unsafe extern "system" fn(pwzurl1: windows_sys::core::PCWSTR, pwzurl2: windows_sys::core::PCWSTR, dwflags: u32) -> windows_sys::core::HRESULT;
...
pub type CoInternetCreateSecurityManager = unsafe extern "system" fn(psp: *mut core::ffi::c_void, ppsm: *mut *mut core::ffi::c_void, dwreserved: u32) -> windows_sys::core::HRESULT;
...
pub type CoInternetCreateZoneManager = unsafe extern "system" fn(psp: *mut core::ffi::c_void, ppzm: *mut *mut core::ffi::c_void, dwreserved: u32) -> windows_sys::core::HRESULT;
...
pub type CoInternetGetProtocolFlags = unsafe extern "system" fn(pwzurl: windows_sys::core::PCWSTR, pdwflags: *mut u32, dwreserved: u32) -> windows_sys::core::HRESULT;
...
pub type CoInternetGetSecurityUrl = unsafe extern "system" fn(pwszurl: windows_sys::core::PCWSTR, ppwszsecurl: *mut windows_sys::core::PWSTR, psuaction: PSUACTION, dwreserved: u32) -> windows_sys::core::HRESULT;
...
pub type CoInternetGetSecurityUrlEx = unsafe extern "system" fn(puri: *mut core::ffi::c_void, ppsecuri: *mut *mut core::ffi::c_void, psuaction: PSUACTION, dwreserved: usize) -> windows_sys::core::HRESULT;
...
pub type CoInternetGetSession = unsafe extern "system" fn(dwsessionmode: u32, ppiinternetsession: *mut *mut core::ffi::c_void, dwreserved: u32) -> windows_sys::core::HRESULT;
...
pub type CoInternetIsFeatureEnabledForIUri = unsafe extern "system" fn(featureentry: INTERNETFEATURELIST, dwflags: u32, piuri: *mut core::ffi::c_void, psecmgr: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CoInternetIsFeatureEnabledForUrl = unsafe extern "system" fn(featureentry: INTERNETFEATURELIST, dwflags: u32, szurl: windows_sys::core::PCWSTR, psecmgr: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CoInternetIsFeatureZoneElevationEnabled = unsafe extern "system" fn(szfromurl: windows_sys::core::PCWSTR, sztourl: windows_sys::core::PCWSTR, psecmgr: *mut core::ffi::c_void, dwflags: u32) -> windows_sys::core::HRESULT;
...
pub type CoInternetParseIUri = unsafe extern "system" fn(piuri: *mut core::ffi::c_void, parseaction: PARSEACTION, dwflags: u32, pwzresult: windows_sys::core::PWSTR, cchresult: u32, pcchresult: *mut u32, dwreserved: usize) -> windows_sys::core::HRESULT;
...
pub type CoInternetParseUrl = unsafe extern "system" fn(pwzurl: windows_sys::core::PCWSTR, parseaction: PARSEACTION, dwflags: u32, pszresult: windows_sys::core::PWSTR, cchresult: u32, pcchresult: *mut u32, dwreserved: u32) -> windows_sys::core::HRESULT;
...
pub type CoInternetQueryInfo = unsafe extern "system" fn(pwzurl: windows_sys::core::PCWSTR, queryoptions: QUERYOPTION, dwqueryflags: u32, pvbuffer: *mut core::ffi::c_void, cbbuffer: u32, pcbbuffer: *mut u32, dwreserved: u32) -> windows_sys::core::HRESULT;
...
pub type CoInternetSetFeatureEnabled = unsafe extern "system" fn(featureentry: INTERNETFEATURELIST, dwflags: u32, fenable: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type CreateAsyncBindCtx = unsafe extern "system" fn(reserved: u32, pbscb: *mut core::ffi::c_void, pefetc: *mut core::ffi::c_void, ppbc: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateAsyncBindCtxEx = unsafe extern "system" fn(pbc: *mut core::ffi::c_void, dwoptions: u32, pbscb: *mut core::ffi::c_void, penum: *mut core::ffi::c_void, ppbc: *mut *mut core::ffi::c_void, reserved: u32) -> windows_sys::core::HRESULT;
...
pub type CreateFormatEnumerator = unsafe extern "system" fn(cfmtetc: u32, rgfmtetc: *const super::FORMATETC, ppenumfmtetc: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateURLMoniker = unsafe extern "system" fn(pmkctx: *mut core::ffi::c_void, szurl: windows_sys::core::PCWSTR, ppmk: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateURLMonikerEx = unsafe extern "system" fn(pmkctx: *mut core::ffi::c_void, szurl: windows_sys::core::PCWSTR, ppmk: *mut *mut core::ffi::c_void, dwflags: u32) -> windows_sys::core::HRESULT;
...
pub type CreateURLMonikerEx2 = unsafe extern "system" fn(pmkctx: *mut core::ffi::c_void, puri: *mut core::ffi::c_void, ppmk: *mut *mut core::ffi::c_void, dwflags: u32) -> windows_sys::core::HRESULT;
...
pub type FindMediaType = unsafe extern "system" fn(rgsztypes: windows_sys::core::PCSTR, rgcftypes: *mut u16) -> windows_sys::core::HRESULT;
...
pub type FindMediaTypeClass = unsafe extern "system" fn(pbc: *mut core::ffi::c_void, sztype: windows_sys::core::PCSTR, pclsid: *mut windows_sys::core::GUID, reserved: u32) -> windows_sys::core::HRESULT;
...
pub type FindMimeFromData = unsafe extern "system" fn(pbc: *mut core::ffi::c_void, pwzurl: windows_sys::core::PCWSTR, pbuffer: *const core::ffi::c_void, cbsize: u32, pwzmimeproposed: windows_sys::core::PCWSTR, dwmimeflags: u32, ppwzmimeout: *mut windows_sys::core::PWSTR, dwreserved: u32) -> windows_sys::core::HRESULT;
...
pub type GetClassFileOrMime = unsafe extern "system" fn(pbc: *mut core::ffi::c_void, szfilename: windows_sys::core::PCWSTR, pbuffer: *const core::ffi::c_void, cbsize: u32, szmime: windows_sys::core::PCWSTR, dwreserved: u32, pclsid: *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type GetClassURL = unsafe extern "system" fn(szurl: windows_sys::core::PCWSTR, pclsid: *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type GetComponentIDFromCLSSPEC = unsafe extern "system" fn(pclassspec: *const super::uCLSSPEC, ppszcomponentid: *mut windows_sys::core::PSTR) -> windows_sys::core::HRESULT;
...
pub type GetSoftwareUpdateInfo = unsafe extern "system" fn(szdistunit: windows_sys::core::PCWSTR, psdi: *mut SOFTDISTINFO) -> windows_sys::core::HRESULT;
...
pub type HlinkGoBack = unsafe extern "system" fn(punk: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("urlmon.dll" "system" fn HlinkGoBack(punk : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type HlinkGoForward = unsafe extern "system" fn(punk: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("urlmon.dll" "system" fn HlinkGoForward(punk : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type HlinkNavigateMoniker = unsafe extern "system" fn(punk: *mut core::ffi::c_void, pmktarget: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type HlinkNavigateString = unsafe extern "system" fn(punk: *mut core::ffi::c_void, sztarget: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HlinkSimpleNavigateToMoniker = unsafe extern "system" fn(pmktarget: *mut core::ffi::c_void, szlocation: windows_sys::core::PCWSTR, sztargetframename: windows_sys::core::PCWSTR, punk: *mut core::ffi::c_void, pbc: *mut core::ffi::c_void, param5: *mut core::ffi::c_void, grfhlnf: u32, dwreserved: u32) -> windows_sys::core::HRESULT;
...
pub type HlinkSimpleNavigateToString = unsafe extern "system" fn(sztarget: windows_sys::core::PCWSTR, szlocation: windows_sys::core::PCWSTR, sztargetframename: windows_sys::core::PCWSTR, punk: *mut core::ffi::c_void, pbc: *mut core::ffi::c_void, param5: *mut core::ffi::c_void, grfhlnf: u32, dwreserved: u32) -> windows_sys::core::HRESULT;
...
pub type IEGetUserPrivateNamespaceName = unsafe extern "system" fn() -> windows_sys::core::PWSTR;
...
pub type IsAsyncMoniker = unsafe extern "system" fn(pmk: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("urlmon.dll" "system" fn IsAsyncMoniker(pmk : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type IsLoggingEnabledA = unsafe extern "system" fn(pszurl: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
windows_link::link!("urlmon.dll" "system" fn IsLoggingEnabledA(pszurl : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
pub type IsLoggingEnabledW = unsafe extern "system" fn(pwszurl: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
windows_link::link!("urlmon.dll" "system" fn IsLoggingEnabledW(pwszurl : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
pub type IsValidURL = unsafe extern "system" fn(pbc: *mut core::ffi::c_void, szurl: windows_sys::core::PCWSTR, dwreserved: u32) -> windows_sys::core::HRESULT;
...
pub type MkParseDisplayNameEx = unsafe extern "system" fn(pbc: *mut core::ffi::c_void, szdisplayname: windows_sys::core::PCWSTR, pcheaten: *mut u32, ppmk: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type ObtainUserAgentString = unsafe extern "system" fn(dwoption: u32, pszuaout: windows_sys::core::PSTR, cbsize: *mut u32) -> windows_sys::core::HRESULT;
...
pub type RegisterBindStatusCallback = unsafe extern "system" fn(pbc: *mut core::ffi::c_void, pbscb: *mut core::ffi::c_void, ppbscbprev: *mut *mut core::ffi::c_void, dwreserved: u32) -> windows_sys::core::HRESULT;
...
pub type RegisterFormatEnumerator = unsafe extern "system" fn(pbc: *mut core::ffi::c_void, pefetc: *mut core::ffi::c_void, reserved: u32) -> windows_sys::core::HRESULT;
...
pub type RegisterMediaTypeClass = unsafe extern "system" fn(pbc: *mut core::ffi::c_void, ctypes: u32, rgsztypes: *const windows_sys::core::PCSTR, rgclsid: *const windows_sys::core::GUID, reserved: u32) -> windows_sys::core::HRESULT;
...
pub type RegisterMediaTypes = unsafe extern "system" fn(ctypes: u32, rgsztypes: *const windows_sys::core::PCSTR, rgcftypes: *mut u16) -> windows_sys::core::HRESULT;
...
pub type RevokeBindStatusCallback = unsafe extern "system" fn(pbc: *mut core::ffi::c_void, pbscb: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type RevokeFormatEnumerator = unsafe extern "system" fn(pbc: *mut core::ffi::c_void, pefetc: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type SetSoftwareUpdateAdvertisementState = unsafe extern "system" fn(szdistunit: windows_sys::core::PCWSTR, dwadstate: u32, dwadvertisedversionms: u32, dwadvertisedversionls: u32) -> windows_sys::core::HRESULT;
...
pub type URLDownloadToCacheFileA = unsafe extern "system" fn(param0: *mut core::ffi::c_void, param1: windows_sys::core::PCSTR, param2: windows_sys::core::PSTR, cchfilename: u32, param4: u32, param5: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type URLDownloadToCacheFileW = unsafe extern "system" fn(param0: *mut core::ffi::c_void, param1: windows_sys::core::PCWSTR, param2: windows_sys::core::PWSTR, cchfilename: u32, param4: u32, param5: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type URLDownloadToFileA = unsafe extern "system" fn(param0: *mut core::ffi::c_void, param1: windows_sys::core::PCSTR, param2: windows_sys::core::PCSTR, param3: u32, param4: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type URLDownloadToFileW = unsafe extern "system" fn(param0: *mut core::ffi::c_void, param1: windows_sys::core::PCWSTR, param2: windows_sys::core::PCWSTR, param3: u32, param4: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type URLOpenBlockingStreamA = unsafe extern "system" fn(param0: *mut core::ffi::c_void, param1: windows_sys::core::PCSTR, param2: *mut *mut core::ffi::c_void, param3: u32, param4: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type URLOpenBlockingStreamW = unsafe extern "system" fn(param0: *mut core::ffi::c_void, param1: windows_sys::core::PCWSTR, param2: *mut *mut core::ffi::c_void, param3: u32, param4: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type URLOpenPullStreamA = unsafe extern "system" fn(param0: *mut core::ffi::c_void, param1: windows_sys::core::PCSTR, param2: u32, param3: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type URLOpenPullStreamW = unsafe extern "system" fn(param0: *mut core::ffi::c_void, param1: windows_sys::core::PCWSTR, param2: u32, param3: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type URLOpenStreamA = unsafe extern "system" fn(param0: *mut core::ffi::c_void, param1: windows_sys::core::PCSTR, param2: u32, param3: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type URLOpenStreamW = unsafe extern "system" fn(param0: *mut core::ffi::c_void, param1: windows_sys::core::PCWSTR, param2: u32, param3: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WriteHitLogging = unsafe extern "system" fn(lplogginginfo: *const HIT_LOGGING_INFO) -> windows_sys::core::BOOL;
