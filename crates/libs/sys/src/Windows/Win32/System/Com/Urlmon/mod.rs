...
pub const E_PENDING: ::windows_sys::core::HRESULT = 0x8000000Au32 as _;
...
pub const INET_E_AUTHENTICATION_REQUIRED: ::windows_sys::core::HRESULT = 0x800C0009u32 as _;
pub const INET_E_BLOCKED_ENHANCEDPROTECTEDMODE: ::windows_sys::core::HRESULT = 0x800C0506u32 as _;
pub const INET_E_BLOCKED_PLUGGABLE_PROTOCOL: ::windows_sys::core::HRESULT = 0x800C0505u32 as _;
pub const INET_E_BLOCKED_REDIRECT_XSECURITYID: ::windows_sys::core::HRESULT = 0x800C001Bu32 as _;
pub const INET_E_CANNOT_CONNECT: ::windows_sys::core::HRESULT = 0x800C0004u32 as _;
pub const INET_E_CANNOT_INSTANTIATE_OBJECT: ::windows_sys::core::HRESULT = 0x800C0010u32 as _;
pub const INET_E_CANNOT_LOAD_DATA: ::windows_sys::core::HRESULT = 0x800C000Fu32 as _;
pub const INET_E_CANNOT_LOCK_REQUEST: ::windows_sys::core::HRESULT = 0x800C0016u32 as _;
pub const INET_E_CANNOT_REPLACE_SFP_FILE: ::windows_sys::core::HRESULT = 0x800C0300u32 as _;
pub const INET_E_CODE_DOWNLOAD_DECLINED: ::windows_sys::core::HRESULT = 0x800C0100u32 as _;
pub const INET_E_CODE_INSTALL_BLOCKED_ARM: ::windows_sys::core::HRESULT = 0x800C0504u32 as _;
pub const INET_E_CODE_INSTALL_BLOCKED_BITNESS: ::windows_sys::core::HRESULT = 0x800C0507u32 as _;
pub const INET_E_CODE_INSTALL_BLOCKED_BY_HASH_POLICY: ::windows_sys::core::HRESULT = 0x800C0500u32 as _;
pub const INET_E_CODE_INSTALL_BLOCKED_IMMERSIVE: ::windows_sys::core::HRESULT = 0x800C0502u32 as _;
pub const INET_E_CODE_INSTALL_SUPPRESSED: ::windows_sys::core::HRESULT = 0x800C0400u32 as _;
pub const INET_E_CONNECTION_TIMEOUT: ::windows_sys::core::HRESULT = 0x800C000Bu32 as _;
pub const INET_E_DATA_NOT_AVAILABLE: ::windows_sys::core::HRESULT = 0x800C0007u32 as _;
pub const INET_E_DEFAULT_ACTION: i32 = -2146697199i32;
pub const INET_E_DOMINJECTIONVALIDATION: ::windows_sys::core::HRESULT = 0x800C001Cu32 as _;
pub const INET_E_DOWNLOAD_BLOCKED_BY_CSP: ::windows_sys::core::HRESULT = 0x800C0508u32 as _;
pub const INET_E_DOWNLOAD_BLOCKED_BY_INPRIVATE: ::windows_sys::core::HRESULT = 0x800C0501u32 as _;
pub const INET_E_DOWNLOAD_FAILURE: ::windows_sys::core::HRESULT = 0x800C0008u32 as _;
pub const INET_E_ERROR_FIRST: ::windows_sys::core::HRESULT = 0x800C0002u32 as _;
pub const INET_E_ERROR_LAST: i32 = -2146695928i32;
pub const INET_E_FORBIDFRAMING: ::windows_sys::core::HRESULT = 0x800C0503u32 as _;
pub const INET_E_HSTS_CERTIFICATE_ERROR: ::windows_sys::core::HRESULT = 0x800C001Eu32 as _;
pub const INET_E_INVALID_CERTIFICATE: ::windows_sys::core::HRESULT = 0x800C0019u32 as _;
pub const INET_E_INVALID_REQUEST: ::windows_sys::core::HRESULT = 0x800C000Cu32 as _;
pub const INET_E_INVALID_URL: ::windows_sys::core::HRESULT = 0x800C0002u32 as _;
pub const INET_E_NO_SESSION: ::windows_sys::core::HRESULT = 0x800C0003u32 as _;
pub const INET_E_NO_VALID_MEDIA: ::windows_sys::core::HRESULT = 0x800C000Au32 as _;
pub const INET_E_OBJECT_NOT_FOUND: ::windows_sys::core::HRESULT = 0x800C0006u32 as _;
pub const INET_E_QUERYOPTION_UNKNOWN: ::windows_sys::core::HRESULT = 0x800C0013u32 as _;
pub const INET_E_REDIRECTING: ::windows_sys::core::HRESULT = 0x800C0014u32 as _;
pub const INET_E_REDIRECT_FAILED: ::windows_sys::core::HRESULT = 0x800C0014u32 as _;
pub const INET_E_REDIRECT_TO_DIR: ::windows_sys::core::HRESULT = 0x800C0015u32 as _;
pub const INET_E_RESERVED_1: ::windows_sys::core::HRESULT = 0x800C001Au32 as _;
pub const INET_E_RESERVED_2: ::windows_sys::core::HRESULT = 0x800C001Fu32 as _;
pub const INET_E_RESERVED_3: ::windows_sys::core::HRESULT = 0x800C0020u32 as _;
pub const INET_E_RESERVED_4: ::windows_sys::core::HRESULT = 0x800C0021u32 as _;
pub const INET_E_RESERVED_5: ::windows_sys::core::HRESULT = 0x800C0022u32 as _;
pub const INET_E_RESOURCE_NOT_FOUND: ::windows_sys::core::HRESULT = 0x800C0005u32 as _;
pub const INET_E_RESULT_DISPATCHED: ::windows_sys::core::HRESULT = 0x800C0200u32 as _;
pub const INET_E_SECURITY_PROBLEM: ::windows_sys::core::HRESULT = 0x800C000Eu32 as _;
pub const INET_E_TERMINATED_BIND: ::windows_sys::core::HRESULT = 0x800C0018u32 as _;
pub const INET_E_UNKNOWN_PROTOCOL: ::windows_sys::core::HRESULT = 0x800C000Du32 as _;
pub const INET_E_USE_DEFAULT_PROTOCOLHANDLER: ::windows_sys::core::HRESULT = 0x800C0011u32 as _;
pub const INET_E_USE_DEFAULT_SETTING: ::windows_sys::core::HRESULT = 0x800C0012u32 as _;
pub const INET_E_USE_EXTEND_BINDING: ::windows_sys::core::HRESULT = 0x800C0017u32 as _;
pub const INET_E_VTAB_SWITCH_FORCE_ENGINE: ::windows_sys::core::HRESULT = 0x800C001Du32 as _;
...
pub const MK_S_ASYNCHRONOUS: ::windows_sys::core::HRESULT = 0x401E8u32 as _;
