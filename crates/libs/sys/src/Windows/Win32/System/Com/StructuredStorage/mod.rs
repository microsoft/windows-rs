...
pub union PROPVARIANT_0_0_0 {
    ...
    pub pStorage: core::mem::ManuallyDrop<*mut core::ffi::c_void>,
...
pub const PRSPEC_LPWSTR: PROPSPEC_KIND = 0;
pub const PRSPEC_PROPID: PROPSPEC_KIND = 1;
pub const PVCF_DEFAULT: PROPVAR_COMPARE_FLAGS = 0;
pub const PVCF_DIGITSASNUMBERS_CASESENSITIVE: PROPVAR_COMPARE_FLAGS = 32;
pub const PVCF_TREATEMPTYASGREATERTHAN: PROPVAR_COMPARE_FLAGS = 1;
pub const PVCF_USESTRCMP: PROPVAR_COMPARE_FLAGS = 2;
pub const PVCF_USESTRCMPC: PROPVAR_COMPARE_FLAGS = 4;
pub const PVCF_USESTRCMPI: PROPVAR_COMPARE_FLAGS = 8;
pub const PVCF_USESTRCMPIC: PROPVAR_COMPARE_FLAGS = 16;
pub const PVCHF_ALPHABOOL: PROPVAR_CHANGE_FLAGS = 2;
pub const PVCHF_DEFAULT: PROPVAR_CHANGE_FLAGS = 0;
pub const PVCHF_LOCALBOOL: PROPVAR_CHANGE_FLAGS = 8;
pub const PVCHF_NOHEXSTRING: PROPVAR_CHANGE_FLAGS = 16;
pub const PVCHF_NOUSEROVERRIDE: PROPVAR_CHANGE_FLAGS = 4;
pub const PVCHF_NOVALUEPROP: PROPVAR_CHANGE_FLAGS = 1;
...
pub type STGFMT = u32;
pub const STGFMT_ANY: STGFMT = 4;
pub const STGFMT_DOCFILE: STGFMT = 5;
pub const STGFMT_DOCUMENT: STGFMT = 0;
pub const STGFMT_FILE: STGFMT = 3;
pub const STGFMT_NATIVE: STGFMT = 1;
pub const STGFMT_STORAGE: STGFMT = 0;
