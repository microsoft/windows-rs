...
pub mod Urlmon;
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn BindMoniker ( pmk : IMoniker , grfopt : u32 , iidresult : *const :: windows_sys::core::GUID , ppvresult : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CLSIDFromProgID ( lpszprogid : :: windows_sys::core::PCWSTR , lpclsid : *mut :: windows_sys::core::GUID ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CLSIDFromProgIDEx ( lpszprogid : :: windows_sys::core::PCWSTR , lpclsid : *mut :: windows_sys::core::GUID ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CLSIDFromString ( lpsz : :: windows_sys::core::PCWSTR , pclsid : *mut :: windows_sys::core::GUID ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoAddRefServerProcess ( ) -> u32 );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoAllowSetForegroundWindow ( punk : :: windows_sys::core::IUnknown , lpvreserved : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoAllowUnmarshalerCLSID ( clsid : *const :: windows_sys::core::GUID ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoBuildVersion ( ) -> u32 );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoCancelCall ( dwthreadid : u32 , ultimeout : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoCopyProxy ( pproxy : :: windows_sys::core::IUnknown , ppcopy : *mut :: windows_sys::core::IUnknown ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoCreateFreeThreadedMarshaler ( punkouter : :: windows_sys::core::IUnknown , ppunkmarshal : *mut :: windows_sys::core::IUnknown ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoCreateGuid ( pguid : *mut :: windows_sys::core::GUID ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoCreateInstance ( rclsid : *const :: windows_sys::core::GUID , punkouter : :: windows_sys::core::IUnknown , dwclscontext : CLSCTX , riid : *const :: windows_sys::core::GUID , ppv : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoCreateInstanceEx ( clsid : *const :: windows_sys::core::GUID , punkouter : :: windows_sys::core::IUnknown , dwclsctx : CLSCTX , pserverinfo : *const COSERVERINFO , dwcount : u32 , presults : *mut MULTI_QI ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoCreateInstanceFromApp ( clsid : *const :: windows_sys::core::GUID , punkouter : :: windows_sys::core::IUnknown , dwclsctx : CLSCTX , reserved : *const ::core::ffi::c_void , dwcount : u32 , presults : *mut MULTI_QI ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoDecrementMTAUsage ( cookie : CO_MTA_USAGE_COOKIE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoDisableCallCancellation ( preserved : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoDisconnectContext ( dwtimeout : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoDisconnectObject ( punk : :: windows_sys::core::IUnknown , dwreserved : u32 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoDosDateTimeToFileTime ( ndosdate : u16 , ndostime : u16 , lpfiletime : *mut super::super::Foundation:: FILETIME ) -> super::super::Foundation:: BOOL );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoEnableCallCancellation ( preserved : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoFileTimeNow ( lpfiletime : *mut super::super::Foundation:: FILETIME ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoFileTimeToDosDateTime ( lpfiletime : *const super::super::Foundation:: FILETIME , lpdosdate : *mut u16 , lpdostime : *mut u16 ) -> super::super::Foundation:: BOOL );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoFreeAllLibraries ( ) -> ( ) );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoFreeLibrary ( hinst : super::super::Foundation:: HINSTANCE ) -> ( ) );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoFreeUnusedLibraries ( ) -> ( ) );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoFreeUnusedLibrariesEx ( dwunloaddelay : u32 , dwreserved : u32 ) -> ( ) );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoGetApartmentType ( papttype : *mut APTTYPE , paptqualifier : *mut APTTYPEQUALIFIER ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoGetCallContext ( riid : *const :: windows_sys::core::GUID , ppinterface : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoGetCallerTID ( lpdwtid : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoGetCancelObject ( dwthreadid : u32 , iid : *const :: windows_sys::core::GUID , ppunk : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoGetClassObject ( rclsid : *const :: windows_sys::core::GUID , dwclscontext : CLSCTX , pvreserved : *const ::core::ffi::c_void , riid : *const :: windows_sys::core::GUID , ppv : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoGetContextToken ( ptoken : *mut usize ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoGetCurrentLogicalThreadId ( pguid : *mut :: windows_sys::core::GUID ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoGetCurrentProcess ( ) -> u32 );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoGetMalloc ( dwmemcontext : u32 , ppmalloc : *mut IMalloc ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoGetObject ( pszname : :: windows_sys::core::PCWSTR , pbindoptions : *const BIND_OPTS , riid : *const :: windows_sys::core::GUID , ppv : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoGetObjectContext ( riid : *const :: windows_sys::core::GUID , ppv : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoGetPSClsid ( riid : *const :: windows_sys::core::GUID , pclsid : *mut :: windows_sys::core::GUID ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Security")]
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoGetSystemSecurityPermissions ( comsdtype : COMSD , ppsd : *mut super::super::Security:: PSECURITY_DESCRIPTOR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoGetTreatAsClass ( clsidold : *const :: windows_sys::core::GUID , pclsidnew : *mut :: windows_sys::core::GUID ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoImpersonateClient ( ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoIncrementMTAUsage ( pcookie : *mut CO_MTA_USAGE_COOKIE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoInitialize ( pvreserved : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoInitializeEx ( pvreserved : *const ::core::ffi::c_void , dwcoinit : COINIT ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Security")]
...
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoInstall ( pbc : IBindCtx , dwflags : u32 , pclassspec : *const uCLSSPEC , pquery : *const QUERYCONTEXT , pszcodebase : :: windows_sys::core::PCWSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoInvalidateRemoteMachineBindings ( pszmachinename : :: windows_sys::core::PCWSTR ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoIsHandlerConnected ( punk : :: windows_sys::core::IUnknown ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoIsOle1Class ( rclsid : *const :: windows_sys::core::GUID ) -> super::super::Foundation:: BOOL );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoLoadLibrary ( lpszlibname : :: windows_sys::core::PCWSTR , bautofree : super::super::Foundation:: BOOL ) -> super::super::Foundation:: HINSTANCE );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoLockObjectExternal ( punk : :: windows_sys::core::IUnknown , flock : super::super::Foundation:: BOOL , flastunlockreleases : super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoQueryAuthenticationServices ( pcauthsvc : *mut u32 , asauthsvc : *mut *mut SOLE_AUTHENTICATION_SERVICE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoQueryClientBlanket ( pauthnsvc : *mut u32 , pauthzsvc : *mut u32 , pserverprincname : *mut :: windows_sys::core::PWSTR , pauthnlevel : *mut u32 , pimplevel : *mut u32 , pprivs : *mut *mut ::core::ffi::c_void , pcapabilities : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoQueryProxyBlanket ( pproxy : :: windows_sys::core::IUnknown , pwauthnsvc : *mut u32 , pauthzsvc : *mut u32 , pserverprincname : *mut :: windows_sys::core::PWSTR , pauthnlevel : *mut u32 , pimplevel : *mut u32 , pauthinfo : *mut *mut ::core::ffi::c_void , pcapabilites : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoRegisterActivationFilter ( pactivationfilter : IActivationFilter ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoRegisterChannelHook ( extensionuuid : *const :: windows_sys::core::GUID , pchannelhook : IChannelHook ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoRegisterClassObject ( rclsid : *const :: windows_sys::core::GUID , punk : :: windows_sys::core::IUnknown , dwclscontext : CLSCTX , flags : REGCLS , lpdwregister : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoRegisterDeviceCatalog ( deviceinstanceid : :: windows_sys::core::PCWSTR , cookie : *mut CO_DEVICE_CATALOG_COOKIE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoRegisterInitializeSpy ( pspy : IInitializeSpy , pulicookie : *mut u64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoRegisterMallocSpy ( pmallocspy : IMallocSpy ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoRegisterPSClsid ( riid : *const :: windows_sys::core::GUID , rclsid : *const :: windows_sys::core::GUID ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoRegisterSurrogate ( psurrogate : ISurrogate ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoReleaseServerProcess ( ) -> u32 );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoResumeClassObjects ( ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoRevertToSelf ( ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoRevokeClassObject ( dwregister : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoRevokeDeviceCatalog ( cookie : CO_DEVICE_CATALOG_COOKIE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoRevokeInitializeSpy ( ulicookie : u64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoRevokeMallocSpy ( ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoSetCancelObject ( punk : :: windows_sys::core::IUnknown ) -> :: windows_sys::core::HRESULT );
...
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoSuspendClassObjects ( ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoSwitchCallContext ( pnewobject : :: windows_sys::core::IUnknown , ppoldobject : *mut :: windows_sys::core::IUnknown ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoTaskMemAlloc ( cb : usize ) -> *mut ::core::ffi::c_void );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoTaskMemFree ( pv : *const ::core::ffi::c_void ) -> ( ) );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoTaskMemRealloc ( pv : *const ::core::ffi::c_void , cb : usize ) -> *mut ::core::ffi::c_void );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoTestCancel ( ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoTreatAsClass ( clsidold : *const :: windows_sys::core::GUID , clsidnew : *const :: windows_sys::core::GUID ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoUninitialize ( ) -> ( ) );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoWaitForMultipleHandles ( dwflags : u32 , dwtimeout : u32 , chandles : u32 , phandles : *const super::super::Foundation:: HANDLE , lpdwindex : *mut u32 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CoWaitForMultipleObjects ( dwflags : u32 , dwtimeout : u32 , chandles : u32 , phandles : *const super::super::Foundation:: HANDLE , lpdwindex : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CreateAntiMoniker ( ppmk : *mut IMoniker ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CreateBindCtx ( reserved : u32 , ppbc : *mut IBindCtx ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CreateClassMoniker ( rclsid : *const :: windows_sys::core::GUID , ppmk : *mut IMoniker ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CreateDataAdviseHolder ( ppdaholder : *mut IDataAdviseHolder ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CreateDataCache ( punkouter : :: windows_sys::core::IUnknown , rclsid : *const :: windows_sys::core::GUID , iid : *const :: windows_sys::core::GUID , ppv : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CreateFileMoniker ( lpszpathname : :: windows_sys::core::PCWSTR , ppmk : *mut IMoniker ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CreateGenericComposite ( pmkfirst : IMoniker , pmkrest : IMoniker , ppmkcomposite : *mut IMoniker ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "urlmon.dll" ,"system" fn CreateIUriBuilder ( piuri : IUri , dwflags : u32 , dwreserved : usize , ppiuribuilder : *mut IUriBuilder ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CreateItemMoniker ( lpszdelim : :: windows_sys::core::PCWSTR , lpszitem : :: windows_sys::core::PCWSTR , ppmk : *mut IMoniker ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CreateObjrefMoniker ( punk : :: windows_sys::core::IUnknown , ppmk : *mut IMoniker ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CreatePointerMoniker ( punk : :: windows_sys::core::IUnknown , ppmk : *mut IMoniker ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn CreateStdProgressIndicator ( hwndparent : super::super::Foundation:: HWND , psztitle : :: windows_sys::core::PCWSTR , pibsccaller : IBindStatusCallback , ppibsc : *mut IBindStatusCallback ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "urlmon.dll" ,"system" fn CreateUri ( pwzuri : :: windows_sys::core::PCWSTR , dwflags : URI_CREATE_FLAGS , dwreserved : usize , ppuri : *mut IUri ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "urlmon.dll" ,"system" fn CreateUriFromMultiByteString ( pszansiinputuri : :: windows_sys::core::PCSTR , dwencodingflags : u32 , dwcodepage : u32 , dwcreateflags : u32 , dwreserved : usize , ppuri : *mut IUri ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "urlmon.dll" ,"system" fn CreateUriWithFragment ( pwzuri : :: windows_sys::core::PCWSTR , pwzfragment : :: windows_sys::core::PCWSTR , dwflags : u32 , dwreserved : usize , ppuri : *mut IUri ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn DcomChannelSetHResult ( pvreserved : *const ::core::ffi::c_void , pulreserved : *const u32 , appshr : :: windows_sys::core::HRESULT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn GetClassFile ( szfilename : :: windows_sys::core::PCWSTR , pclsid : *mut :: windows_sys::core::GUID ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "oleaut32.dll" ,"system" fn GetErrorInfo ( dwreserved : u32 , pperrinfo : *mut IErrorInfo ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn GetRunningObjectTable ( reserved : u32 , pprot : *mut IRunningObjectTable ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn IIDFromString ( lpsz : :: windows_sys::core::PCWSTR , lpiid : *mut :: windows_sys::core::GUID ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn MkParseDisplayName ( pbc : IBindCtx , szusername : :: windows_sys::core::PCWSTR , pcheaten : *mut u32 , ppmk : *mut IMoniker ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn MonikerCommonPrefixWith ( pmkthis : IMoniker , pmkother : IMoniker , ppmkcommon : *mut IMoniker ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn MonikerRelativePathTo ( pmksrc : IMoniker , pmkdest : IMoniker , ppmkrelpath : *mut IMoniker , dwreserved : super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn ProgIDFromCLSID ( clsid : *const :: windows_sys::core::GUID , lplpszprogid : *mut :: windows_sys::core::PWSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "oleaut32.dll" ,"system" fn SetErrorInfo ( dwreserved : u32 , perrinfo : IErrorInfo ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn StringFromCLSID ( rclsid : *const :: windows_sys::core::GUID , lplpsz : *mut :: windows_sys::core::PWSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn StringFromGUID2 ( rguid : *const :: windows_sys::core::GUID , lpsz : :: windows_sys::core::PWSTR , cchmax : i32 ) -> i32 );
::windows_sys::core::windows_link ! ( "ole32.dll" ,"system" fn StringFromIID ( rclsid : *const :: windows_sys::core::GUID , lplpsz : *mut :: windows_sys::core::PWSTR ) -> :: windows_sys::core::HRESULT );
