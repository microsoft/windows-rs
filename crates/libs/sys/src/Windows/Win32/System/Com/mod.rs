...
pub mod Urlmon;
pub type BindMoniker = unsafe extern "system" fn(pmk: *mut core::ffi::c_void, grfopt: u32, iidresult: *const windows_sys::core::GUID, ppvresult: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CLSIDFromProgID = unsafe extern "system" fn(lpszprogid: windows_sys::core::PCWSTR, lpclsid: *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type CLSIDFromProgIDEx = unsafe extern "system" fn(lpszprogid: windows_sys::core::PCWSTR, lpclsid: *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type CLSIDFromString = unsafe extern "system" fn(lpsz: windows_sys::core::PCWSTR, pclsid: *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type CoAddRefServerProcess = unsafe extern "system" fn() -> u32;
windows_link::link!("ole32.dll" "system" fn CoAddRefServerProcess() -> u32);
pub type CoAllowSetForegroundWindow = unsafe extern "system" fn(punk: *mut core::ffi::c_void, lpvreserved: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CoAllowUnmarshalerCLSID = unsafe extern "system" fn(clsid: *const windows_sys::core::GUID) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoAllowUnmarshalerCLSID(clsid : *const windows_sys::core::GUID) -> windows_sys::core::HRESULT);
pub type CoBuildVersion = unsafe extern "system" fn() -> u32;
windows_link::link!("ole32.dll" "system" fn CoBuildVersion() -> u32);
pub type CoCancelCall = unsafe extern "system" fn(dwthreadid: u32, ultimeout: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoCancelCall(dwthreadid : u32, ultimeout : u32) -> windows_sys::core::HRESULT);
pub type CoCopyProxy = unsafe extern "system" fn(pproxy: *mut core::ffi::c_void, ppcopy: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CoCreateFreeThreadedMarshaler = unsafe extern "system" fn(punkouter: *mut core::ffi::c_void, ppunkmarshal: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CoCreateGuid = unsafe extern "system" fn(pguid: *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoCreateGuid(pguid : *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT);
pub type CoCreateInstance = unsafe extern "system" fn(rclsid: *const windows_sys::core::GUID, punkouter: *mut core::ffi::c_void, dwclscontext: CLSCTX, riid: *const windows_sys::core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CoCreateInstanceEx = unsafe extern "system" fn(clsid: *const windows_sys::core::GUID, punkouter: *mut core::ffi::c_void, dwclsctx: CLSCTX, pserverinfo: *const COSERVERINFO, dwcount: u32, presults: *mut MULTI_QI) -> windows_sys::core::HRESULT;
...
pub type CoCreateInstanceFromApp = unsafe extern "system" fn(clsid: *const windows_sys::core::GUID, punkouter: *mut core::ffi::c_void, dwclsctx: CLSCTX, reserved: *const core::ffi::c_void, dwcount: u32, presults: *mut MULTI_QI) -> windows_sys::core::HRESULT;
...
pub type CoDecrementMTAUsage = unsafe extern "system" fn(cookie: CO_MTA_USAGE_COOKIE) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoDecrementMTAUsage(cookie : CO_MTA_USAGE_COOKIE) -> windows_sys::core::HRESULT);
pub type CoDisableCallCancellation = unsafe extern "system" fn(preserved: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoDisableCallCancellation(preserved : *const core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type CoDisconnectContext = unsafe extern "system" fn(dwtimeout: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoDisconnectContext(dwtimeout : u32) -> windows_sys::core::HRESULT);
pub type CoDisconnectObject = unsafe extern "system" fn(punk: *mut core::ffi::c_void, dwreserved: u32) -> windows_sys::core::HRESULT;
...
pub type CoDosDateTimeToFileTime = unsafe extern "system" fn(ndosdate: u16, ndostime: u16, lpfiletime: *mut super::super::Foundation::FILETIME) -> windows_sys::core::BOOL;
...
pub type CoEnableCallCancellation = unsafe extern "system" fn(preserved: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoEnableCallCancellation(preserved : *const core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type CoFileTimeNow = unsafe extern "system" fn(lpfiletime: *mut super::super::Foundation::FILETIME) -> windows_sys::core::HRESULT;
...
pub type CoFileTimeToDosDateTime = unsafe extern "system" fn(lpfiletime: *const super::super::Foundation::FILETIME, lpdosdate: *mut u16, lpdostime: *mut u16) -> windows_sys::core::BOOL;
...
pub type CoFreeAllLibraries = unsafe extern "system" fn();
windows_link::link!("ole32.dll" "system" fn CoFreeAllLibraries());
pub type CoFreeLibrary = unsafe extern "system" fn(hinst: super::super::Foundation::HINSTANCE);
windows_link::link!("ole32.dll" "system" fn CoFreeLibrary(hinst : super::super::Foundation::HINSTANCE));
pub type CoFreeUnusedLibraries = unsafe extern "system" fn();
windows_link::link!("ole32.dll" "system" fn CoFreeUnusedLibraries());
pub type CoFreeUnusedLibrariesEx = unsafe extern "system" fn(dwunloaddelay: u32, dwreserved: u32);
windows_link::link!("ole32.dll" "system" fn CoFreeUnusedLibrariesEx(dwunloaddelay : u32, dwreserved : u32));
pub type CoGetApartmentType = unsafe extern "system" fn(papttype: *mut APTTYPE, paptqualifier: *mut APTTYPEQUALIFIER) -> windows_sys::core::HRESULT;
...
pub type CoGetCallContext = unsafe extern "system" fn(riid: *const windows_sys::core::GUID, ppinterface: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CoGetCallerTID = unsafe extern "system" fn(lpdwtid: *mut u32) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoGetCallerTID(lpdwtid : *mut u32) -> windows_sys::core::HRESULT);
pub type CoGetCancelObject = unsafe extern "system" fn(dwthreadid: u32, iid: *const windows_sys::core::GUID, ppunk: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CoGetClassObject = unsafe extern "system" fn(rclsid: *const windows_sys::core::GUID, dwclscontext: u32, pvreserved: *const core::ffi::c_void, riid: *const windows_sys::core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CoGetContextToken = unsafe extern "system" fn(ptoken: *mut usize) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoGetContextToken(ptoken : *mut usize) -> windows_sys::core::HRESULT);
pub type CoGetCurrentLogicalThreadId = unsafe extern "system" fn(pguid: *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type CoGetCurrentProcess = unsafe extern "system" fn() -> u32;
windows_link::link!("ole32.dll" "system" fn CoGetCurrentProcess() -> u32);
pub type CoGetMalloc = unsafe extern "system" fn(dwmemcontext: u32, ppmalloc: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CoGetObject = unsafe extern "system" fn(pszname: windows_sys::core::PCWSTR, pbindoptions: *const BIND_OPTS, riid: *const windows_sys::core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CoGetObjectContext = unsafe extern "system" fn(riid: *const windows_sys::core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CoGetPSClsid = unsafe extern "system" fn(riid: *const windows_sys::core::GUID, pclsid: *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type CoGetSystemSecurityPermissions = unsafe extern "system" fn(comsdtype: COMSD, ppsd: *mut super::super::Security::PSECURITY_DESCRIPTOR) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Security")]
...
pub type CoGetTreatAsClass = unsafe extern "system" fn(clsidold: *const windows_sys::core::GUID, pclsidnew: *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type CoImpersonateClient = unsafe extern "system" fn() -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoImpersonateClient() -> windows_sys::core::HRESULT);
pub type CoIncrementMTAUsage = unsafe extern "system" fn(pcookie: *mut CO_MTA_USAGE_COOKIE) -> windows_sys::core::HRESULT;
windows_link::link!("combase.dll" "system" fn CoIncrementMTAUsage(pcookie : *mut CO_MTA_USAGE_COOKIE) -> windows_sys::core::HRESULT);
pub type CoInitialize = unsafe extern "system" fn(pvreserved: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoInitialize(pvreserved : *const core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type CoInitializeEx = unsafe extern "system" fn(pvreserved: *const core::ffi::c_void, dwcoinit: u32) -> windows_sys::core::HRESULT;
...
pub type CoInstall = unsafe extern "system" fn(pbc: *mut core::ffi::c_void, dwflags: u32, pclassspec: *const uCLSSPEC, pquery: *const QUERYCONTEXT, pszcodebase: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type CoInvalidateRemoteMachineBindings = unsafe extern "system" fn(pszmachinename: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type CoIsHandlerConnected = unsafe extern "system" fn(punk: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("ole32.dll" "system" fn CoIsHandlerConnected(punk : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
pub type CoIsOle1Class = unsafe extern "system" fn(rclsid: *const windows_sys::core::GUID) -> windows_sys::core::BOOL;
windows_link::link!("ole32.dll" "system" fn CoIsOle1Class(rclsid : *const windows_sys::core::GUID) -> windows_sys::core::BOOL);
pub type CoLoadLibrary = unsafe extern "system" fn(lpszlibname: windows_sys::core::PCWSTR, bautofree: windows_sys::core::BOOL) -> super::super::Foundation::HINSTANCE;
...
pub type CoLockObjectExternal = unsafe extern "system" fn(punk: *mut core::ffi::c_void, flock: windows_sys::core::BOOL, flastunlockreleases: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type CoQueryAuthenticationServices = unsafe extern "system" fn(pcauthsvc: *mut u32, asauthsvc: *mut *mut SOLE_AUTHENTICATION_SERVICE) -> windows_sys::core::HRESULT;
...
pub type CoQueryClientBlanket = unsafe extern "system" fn(pauthnsvc: *mut u32, pauthzsvc: *mut u32, pserverprincname: *mut windows_sys::core::PWSTR, pauthnlevel: *mut u32, pimplevel: *mut u32, pprivs: *mut *mut core::ffi::c_void, pcapabilities: *mut u32) -> windows_sys::core::HRESULT;
...
pub type CoQueryProxyBlanket = unsafe extern "system" fn(pproxy: *mut core::ffi::c_void, pwauthnsvc: *mut u32, pauthzsvc: *mut u32, pserverprincname: *mut windows_sys::core::PWSTR, pauthnlevel: *mut u32, pimplevel: *mut u32, pauthinfo: *mut *mut core::ffi::c_void, pcapabilites: *mut u32) -> windows_sys::core::HRESULT;
...
pub type CoRegisterActivationFilter = unsafe extern "system" fn(pactivationfilter: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CoRegisterChannelHook = unsafe extern "system" fn(extensionuuid: *const windows_sys::core::GUID, pchannelhook: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CoRegisterClassObject = unsafe extern "system" fn(rclsid: *const windows_sys::core::GUID, punk: *mut core::ffi::c_void, dwclscontext: CLSCTX, flags: u32, lpdwregister: *mut u32) -> windows_sys::core::HRESULT;
...
pub type CoRegisterDeviceCatalog = unsafe extern "system" fn(deviceinstanceid: windows_sys::core::PCWSTR, cookie: *mut CO_DEVICE_CATALOG_COOKIE) -> windows_sys::core::HRESULT;
...
pub type CoRegisterInitializeSpy = unsafe extern "system" fn(pspy: *mut core::ffi::c_void, pulicookie: *mut u64) -> windows_sys::core::HRESULT;
...
pub type CoRegisterMallocSpy = unsafe extern "system" fn(pmallocspy: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoRegisterMallocSpy(pmallocspy : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type CoRegisterPSClsid = unsafe extern "system" fn(riid: *const windows_sys::core::GUID, rclsid: *const windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type CoRegisterSurrogate = unsafe extern "system" fn(psurrogate: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoRegisterSurrogate(psurrogate : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type CoReleaseServerProcess = unsafe extern "system" fn() -> u32;
windows_link::link!("ole32.dll" "system" fn CoReleaseServerProcess() -> u32);
pub type CoResumeClassObjects = unsafe extern "system" fn() -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoResumeClassObjects() -> windows_sys::core::HRESULT);
pub type CoRevertToSelf = unsafe extern "system" fn() -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoRevertToSelf() -> windows_sys::core::HRESULT);
pub type CoRevokeClassObject = unsafe extern "system" fn(dwregister: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoRevokeClassObject(dwregister : u32) -> windows_sys::core::HRESULT);
pub type CoRevokeDeviceCatalog = unsafe extern "system" fn(cookie: CO_DEVICE_CATALOG_COOKIE) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoRevokeDeviceCatalog(cookie : CO_DEVICE_CATALOG_COOKIE) -> windows_sys::core::HRESULT);
pub type CoRevokeInitializeSpy = unsafe extern "system" fn(ulicookie: u64) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoRevokeInitializeSpy(ulicookie : u64) -> windows_sys::core::HRESULT);
pub type CoRevokeMallocSpy = unsafe extern "system" fn() -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoRevokeMallocSpy() -> windows_sys::core::HRESULT);
pub type CoSetCancelObject = unsafe extern "system" fn(punk: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoSetCancelObject(punk : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type CoSetProxyBlanket = unsafe extern "system" fn(pproxy: *mut core::ffi::c_void, dwauthnsvc: u32, dwauthzsvc: u32, pserverprincname: windows_sys::core::PCWSTR, dwauthnlevel: RPC_C_AUTHN_LEVEL, dwimplevel: RPC_C_IMP_LEVEL, pauthinfo: *const core::ffi::c_void, dwcapabilities: u32) -> windows_sys::core::HRESULT;
...
pub type CoSuspendClassObjects = unsafe extern "system" fn() -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoSuspendClassObjects() -> windows_sys::core::HRESULT);
pub type CoSwitchCallContext = unsafe extern "system" fn(pnewobject: *mut core::ffi::c_void, ppoldobject: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CoTaskMemRealloc = unsafe extern "system" fn(pv: *const core::ffi::c_void, cb: usize) -> *mut core::ffi::c_void;
windows_link::link!("ole32.dll" "system" fn CoTaskMemRealloc(pv : *const core::ffi::c_void, cb : usize) -> *mut core::ffi::c_void);
pub type CoTestCancel = unsafe extern "system" fn() -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CoTestCancel() -> windows_sys::core::HRESULT);
pub type CoTreatAsClass = unsafe extern "system" fn(clsidold: *const windows_sys::core::GUID, clsidnew: *const windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type CoWaitForMultipleHandles = unsafe extern "system" fn(dwflags: u32, dwtimeout: u32, chandles: u32, phandles: *const super::super::Foundation::HANDLE, lpdwindex: *mut u32) -> windows_sys::core::HRESULT;
...
pub type CoWaitForMultipleObjects = unsafe extern "system" fn(dwflags: u32, dwtimeout: u32, chandles: u32, phandles: *const super::super::Foundation::HANDLE, lpdwindex: *mut u32) -> windows_sys::core::HRESULT;
...
pub type CreateAntiMoniker = unsafe extern "system" fn(ppmk: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CreateAntiMoniker(ppmk : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type CreateBindCtx = unsafe extern "system" fn(reserved: u32, ppbc: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CreateBindCtx(reserved : u32, ppbc : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type CreateClassMoniker = unsafe extern "system" fn(rclsid: *const windows_sys::core::GUID, ppmk: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateDataAdviseHolder = unsafe extern "system" fn(ppdaholder: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("ole32.dll" "system" fn CreateDataAdviseHolder(ppdaholder : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type CreateDataCache = unsafe extern "system" fn(punkouter: *mut core::ffi::c_void, rclsid: *const windows_sys::core::GUID, iid: *const windows_sys::core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateFileMoniker = unsafe extern "system" fn(lpszpathname: windows_sys::core::PCWSTR, ppmk: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateGenericComposite = unsafe extern "system" fn(pmkfirst: *mut core::ffi::c_void, pmkrest: *mut core::ffi::c_void, ppmkcomposite: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateIUriBuilder = unsafe extern "system" fn(piuri: *mut core::ffi::c_void, dwflags: u32, dwreserved: usize, ppiuribuilder: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateItemMoniker = unsafe extern "system" fn(lpszdelim: windows_sys::core::PCWSTR, lpszitem: windows_sys::core::PCWSTR, ppmk: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateObjrefMoniker = unsafe extern "system" fn(punk: *mut core::ffi::c_void, ppmk: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreatePointerMoniker = unsafe extern "system" fn(punk: *mut core::ffi::c_void, ppmk: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateStdProgressIndicator = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, psztitle: windows_sys::core::PCWSTR, pibsccaller: *mut core::ffi::c_void, ppibsc: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateUri = unsafe extern "system" fn(pwzuri: windows_sys::core::PCWSTR, dwflags: URI_CREATE_FLAGS, dwreserved: usize, ppuri: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateUriFromMultiByteString = unsafe extern "system" fn(pszansiinputuri: windows_sys::core::PCSTR, dwencodingflags: u32, dwcodepage: u32, dwcreateflags: u32, dwreserved: usize, ppuri: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateUriWithFragment = unsafe extern "system" fn(pwzuri: windows_sys::core::PCWSTR, pwzfragment: windows_sys::core::PCWSTR, dwflags: u32, dwreserved: usize, ppuri: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type DcomChannelSetHResult = unsafe extern "system" fn(pvreserved: *const core::ffi::c_void, pulreserved: *const u32, appshr: windows_sys::core::HRESULT) -> windows_sys::core::HRESULT;
...
pub type GetClassFile = unsafe extern "system" fn(szfilename: windows_sys::core::PCWSTR, pclsid: *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type GetErrorInfo = unsafe extern "system" fn(dwreserved: u32, pperrinfo: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type GetRunningObjectTable = unsafe extern "system" fn(reserved: u32, pprot: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type IIDFromString = unsafe extern "system" fn(lpsz: windows_sys::core::PCWSTR, lpiid: *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type MkParseDisplayName = unsafe extern "system" fn(pbc: *mut core::ffi::c_void, szusername: windows_sys::core::PCWSTR, pcheaten: *mut u32, ppmk: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type MonikerCommonPrefixWith = unsafe extern "system" fn(pmkthis: *mut core::ffi::c_void, pmkother: *mut core::ffi::c_void, ppmkcommon: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type MonikerRelativePathTo = unsafe extern "system" fn(pmksrc: *mut core::ffi::c_void, pmkdest: *mut core::ffi::c_void, ppmkrelpath: *mut *mut core::ffi::c_void, dwreserved: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type ProgIDFromCLSID = unsafe extern "system" fn(clsid: *const windows_sys::core::GUID, lplpszprogid: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type SetErrorInfo = unsafe extern "system" fn(dwreserved: u32, perrinfo: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type StringFromCLSID = unsafe extern "system" fn(rclsid: *const windows_sys::core::GUID, lplpsz: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type StringFromGUID2 = unsafe extern "system" fn(rguid: *const windows_sys::core::GUID, lpsz: windows_sys::core::PWSTR, cchmax: i32) -> i32;
...
pub type StringFromIID = unsafe extern "system" fn(rclsid: *const windows_sys::core::GUID, lplpsz: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
