...
windows_link::link!("ole32.dll" "system" fn CoAllowUnmarshalerCLSID(clsid : *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT);
...
windows_link::link!("ole32.dll" "system" fn CoCreateInstance(rclsid : *mut windows_sys::core::GUID, punkouter : * mut core::ffi::c_void, dwclscontext : CLSCTX, riid : *mut windows_sys::core::GUID, ppv : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("ole32.dll" "system" fn CoCreateInstanceFromApp(clsid : *mut windows_sys::core::GUID, punkouter : * mut core::ffi::c_void, dwclsctx : CLSCTX, reserved : *mut core::ffi::c_void, dwcount : u32, presults : *mut MULTI_QI) -> windows_sys::core::HRESULT);
windows_link::link!("ole32.dll" "system" fn CoDecrementMTAUsage(cookie : CO_MTA_USAGE_COOKIE) -> windows_sys::core::HRESULT);
windows_link::link!("ole32.dll" "system" fn CoDisableCallCancellation(preserved : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("ole32.dll" "system" fn CoEnableCallCancellation(preserved : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("ole32.dll" "system" fn CoFileTimeToDosDateTime(lpfiletime : *mut super::super::Foundation:: FILETIME, lpdosdate : *mut u16, lpdostime : *mut u16) -> windows_sys::core::BOOL);
...
windows_link::link!("ole32.dll" "system" fn CoGetCancelObject(dwthreadid : u32, iid : *mut windows_sys::core::GUID, ppunk : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("ole32.dll" "system" fn CoGetObject(pszname : windows_sys::core::PCWSTR, pbindoptions : *mut BIND_OPTS, riid : *mut windows_sys::core::GUID, ppv : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("ole32.dll" "system" fn CoGetObjectContext(riid : *mut windows_sys::core::GUID, ppv : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("ole32.dll" "system" fn CoGetPSClsid(riid : *mut windows_sys::core::GUID, pclsid : *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT);
...
windows_link::link!("ole32.dll" "system" fn CoGetTreatAsClass(clsidold : *mut windows_sys::core::GUID, pclsidnew : *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT);
...
windows_link::link!("ole32.dll" "system" fn CoInitialize(pvreserved : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_Security")]
windows_link::link!("ole32.dll" "system" fn CoInitializeSecurity(psecdesc : super::super::Security:: PSECURITY_DESCRIPTOR, cauthsvc : i32, asauthsvc : *mut SOLE_AUTHENTICATION_SERVICE, preserved1 : *mut core::ffi::c_void, dwauthnlevel : RPC_C_AUTHN_LEVEL, dwimplevel : RPC_C_IMP_LEVEL, pauthlist : *mut core::ffi::c_void, dwcapabilities : u32, preserved3 : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("ole32.dll" "system" fn CoInstall(pbc : * mut core::ffi::c_void, dwflags : u32, pclassspec : *mut uCLSSPEC, pquery : *mut QUERYCONTEXT, pszcodebase : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
...
windows_link::link!("ole32.dll" "system" fn CoIsOle1Class(rclsid : *mut windows_sys::core::GUID) -> windows_sys::core::BOOL);
...
windows_link::link!("ole32.dll" "system" fn CoTreatAsClass(clsidold : *mut windows_sys::core::GUID, clsidnew : *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT);
windows_link::link!("ole32.dll" "system" fn CoUninitialize());
windows_link::link!("ole32.dll" "system" fn CoWaitForMultipleHandles(dwflags : u32, dwtimeout : u32, chandles : u32, phandles : *mut super::super::Foundation:: HANDLE, lpdwindex : *mut u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("ole32.dll" "system" fn CreateClassMoniker(rclsid : *mut windows_sys::core::GUID, ppmk : *mut * mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("ole32.dll" "system" fn CreateDataAdviseHolder(ppdaholder : *mut * mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("ole32.dll" "system" fn CreateDataCache(punkouter : * mut core::ffi::c_void, rclsid : *mut windows_sys::core::GUID, iid : *mut windows_sys::core::GUID, ppv : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("ole32.dll" "system" fn ProgIDFromCLSID(clsid : *mut windows_sys::core::GUID, lplpszprogid : *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT);
...
windows_link::link!("ole32.dll" "system" fn StringFromIID(rclsid : *mut windows_sys::core::GUID, lplpsz : *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT);
...
pub const COLE_DEFAULT_PRINCIPAL: windows_sys::core::PCWSTR = -1i64 as _;
