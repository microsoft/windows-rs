...
pub const AT_ENTITY: TDIENTITY_ENTITY_TYPE = 640;
...
pub const CL_NL_ENTITY: TDIENTITY_ENTITY_TYPE = 769;
pub const CL_NL_IP: u32 = 771;
pub const CL_NL_IPX: u32 = 769;
pub const CL_TL_ENTITY: TDIENTITY_ENTITY_TYPE = 1025;
...
pub const CO_NL_ENTITY: TDIENTITY_ENTITY_TYPE = 768;
pub const CO_TL_ENTITY: TDIENTITY_ENTITY_TYPE = 1024;
...
pub const DECISION_LOCATION_AUDIT: DECISION_LOCATION = 2;
pub const DECISION_LOCATION_ENFORCE_STATE_LIST: DECISION_LOCATION = 7;
pub const DECISION_LOCATION_ENTERPRISE_DEFINED_CLASS_ID: DECISION_LOCATION = 4;
pub const DECISION_LOCATION_FAILED_CONVERT_GUID: DECISION_LOCATION = 3;
pub const DECISION_LOCATION_GLOBAL_BUILT_IN_LIST: DECISION_LOCATION = 5;
pub const DECISION_LOCATION_NOT_FOUND: DECISION_LOCATION = 8;
pub const DECISION_LOCATION_PARAMETER_VALIDATION: DECISION_LOCATION = 1;
pub const DECISION_LOCATION_PROVIDER_BUILT_IN_LIST: DECISION_LOCATION = 6;
pub const DECISION_LOCATION_REFRESH_GLOBAL_DATA: DECISION_LOCATION = 0;
pub const DECISION_LOCATION_UNKNOWN: DECISION_LOCATION = 9;
...
pub const ER_ENTITY: TDIENTITY_ENTITY_TYPE = 896;
...
pub const EndpointIoControlType: TDI_TL_IO_CONTROL_TYPE = 0;
...
pub const FEATURE_CHANGE_TIME_MODULE_RELOAD: FEATURE_CHANGE_TIME = 1;
pub const FEATURE_CHANGE_TIME_READ: FEATURE_CHANGE_TIME = 0;
pub const FEATURE_CHANGE_TIME_REBOOT: FEATURE_CHANGE_TIME = 3;
pub const FEATURE_CHANGE_TIME_SESSION: FEATURE_CHANGE_TIME = 2;
pub type FEATURE_ENABLED_STATE = i32;
pub const FEATURE_ENABLED_STATE_DEFAULT: FEATURE_ENABLED_STATE = 0;
...
pub const GENERIC_ENTITY: TDIENTITY_ENTITY_TYPE = 0;
...
pub const GetSockOptIoControlType: TDI_TL_IO_CONTROL_TYPE = 2;
...
pub const IF_ENTITY: TDIENTITY_ENTITY_TYPE = 512;
...
pub const KEY_ALL_KEYS: WLDP_KEY = 2;
pub const KEY_OVERRIDE: WLDP_KEY = 1;
pub const KEY_UNKNOWN: WLDP_KEY = 0;
#[repr(C)]
#[cfg(feature = "Win32_System_Kernel")]
#[derive(Clone, Copy)]
...
pub const SetSockOptIoControlType: TDI_TL_IO_CONTROL_TYPE = 1;
...
pub const VALUENAME_BUILT_IN_LIST: VALUENAME = 2;
pub const VALUENAME_ENTERPRISE_DEFINED_CLASS_ID: VALUENAME = 1;
...
pub const WLDP_EXECUTION_EVALUATION_OPTION_EXECUTE_IN_INTERACTIVE_SESSION: WLDP_EXECUTION_EVALUATION_OPTIONS = 1;
pub const WLDP_EXECUTION_EVALUATION_OPTION_NONE: WLDP_EXECUTION_EVALUATION_OPTIONS = 0;
pub type WLDP_EXECUTION_POLICY = i32;
pub const WLDP_EXECUTION_POLICY_ALLOWED: WLDP_EXECUTION_POLICY = 1;
pub const WLDP_EXECUTION_POLICY_BLOCKED: WLDP_EXECUTION_POLICY = 0;
pub const WLDP_EXECUTION_POLICY_REQUIRE_SANDBOX: WLDP_EXECUTION_POLICY = 2;
...
pub const WLDP_HOST_ID_ALL: WLDP_HOST_ID = 7;
pub const WLDP_HOST_ID_GLOBAL: WLDP_HOST_ID = 1;
pub const WLDP_HOST_ID_IE: WLDP_HOST_ID = 5;
pub const WLDP_HOST_ID_MAX: WLDP_HOST_ID = 8;
pub const WLDP_HOST_ID_MSI: WLDP_HOST_ID = 6;
pub const WLDP_HOST_ID_POWERSHELL: WLDP_HOST_ID = 4;
pub const WLDP_HOST_ID_UNKNOWN: WLDP_HOST_ID = 0;
...
pub const WLDP_HOST_MAX: WLDP_HOST = 2;
...
pub const WLDP_HOST_RUNDLL32: WLDP_HOST = 0;
pub const WLDP_HOST_SVCHOST: WLDP_HOST = 1;
...
pub const WLDP_POLICY_SETTING_AV_PERF_MODE: WLDP_POLICY_SETTING = 1000;
...
pub const WLDP_SECURE_SETTING_VALUE_TYPE_BINARY: WLDP_SECURE_SETTING_VALUE_TYPE = 2;
pub const WLDP_SECURE_SETTING_VALUE_TYPE_BOOLEAN: WLDP_SECURE_SETTING_VALUE_TYPE = 0;
pub const WLDP_SECURE_SETTING_VALUE_TYPE_STRING: WLDP_SECURE_SETTING_VALUE_TYPE = 3;
pub const WLDP_SECURE_SETTING_VALUE_TYPE_ULONG: WLDP_SECURE_SETTING_VALUE_TYPE = 1;
...
pub const WLDP_WINDOWS_LOCKDOWN_MODE_LOCKED: WLDP_WINDOWS_LOCKDOWN_MODE = 2;
pub const WLDP_WINDOWS_LOCKDOWN_MODE_MAX: WLDP_WINDOWS_LOCKDOWN_MODE = 3;
pub const WLDP_WINDOWS_LOCKDOWN_MODE_TRIAL: WLDP_WINDOWS_LOCKDOWN_MODE = 1;
pub const WLDP_WINDOWS_LOCKDOWN_MODE_UNLOCKED: WLDP_WINDOWS_LOCKDOWN_MODE = 0;
pub type WLDP_WINDOWS_LOCKDOWN_RESTRICTION = i32;
pub const WLDP_WINDOWS_LOCKDOWN_RESTRICTION_MAX: WLDP_WINDOWS_LOCKDOWN_RESTRICTION = 3;
pub const WLDP_WINDOWS_LOCKDOWN_RESTRICTION_NONE: WLDP_WINDOWS_LOCKDOWN_RESTRICTION = 0;
pub const WLDP_WINDOWS_LOCKDOWN_RESTRICTION_NOUNLOCK: WLDP_WINDOWS_LOCKDOWN_RESTRICTION = 1;
pub const WLDP_WINDOWS_LOCKDOWN_RESTRICTION_NOUNLOCK_PERMANENT: WLDP_WINDOWS_LOCKDOWN_RESTRICTION = 2;
