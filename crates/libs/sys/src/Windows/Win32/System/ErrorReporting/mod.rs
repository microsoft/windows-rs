...
pub const WER_FAULT_REPORTING_ALWAYS_SHOW_UI: WER_FAULT_REPORTING = 16;
...
pub const WER_FAULT_REPORTING_FLAG_DISABLE_THREAD_SUSPENSION: WER_FAULT_REPORTING = 4;
pub const WER_FAULT_REPORTING_FLAG_NOHEAP: WER_FAULT_REPORTING = 1;
pub const WER_FAULT_REPORTING_FLAG_NO_HEAP_ON_QUEUE: u32 = 64;
pub const WER_FAULT_REPORTING_FLAG_QUEUE: WER_FAULT_REPORTING = 2;
pub const WER_FAULT_REPORTING_FLAG_QUEUE_UPLOAD: WER_FAULT_REPORTING = 8;
pub const WER_FAULT_REPORTING_NO_UI: u32 = 32;
pub type WER_FILE = u32;
pub const WER_FILE_ANONYMOUS_DATA: WER_FILE = 2;
pub const WER_FILE_COMPRESSED: u32 = 4;
pub const WER_FILE_DELETE_WHEN_DONE: WER_FILE = 1;
...
pub const WER_SUBMIT_ADD_REGISTERED_DATA: WER_SUBMIT_FLAGS = 16;
pub const WER_SUBMIT_ARCHIVE_PARAMETERS_ONLY: WER_SUBMIT_FLAGS = 4096;
pub const WER_SUBMIT_BYPASS_DATA_THROTTLING: WER_SUBMIT_FLAGS = 2048;
...
pub const WER_SUBMIT_HONOR_RECOVERY: WER_SUBMIT_FLAGS = 1;
pub const WER_SUBMIT_HONOR_RESTART: WER_SUBMIT_FLAGS = 2;
pub const WER_SUBMIT_NO_ARCHIVE: WER_SUBMIT_FLAGS = 256;
pub const WER_SUBMIT_NO_CLOSE_UI: WER_SUBMIT_FLAGS = 64;
pub const WER_SUBMIT_NO_QUEUE: WER_SUBMIT_FLAGS = 128;
pub const WER_SUBMIT_OUTOFPROCESS: WER_SUBMIT_FLAGS = 32;
pub const WER_SUBMIT_OUTOFPROCESS_ASYNC: WER_SUBMIT_FLAGS = 1024;
pub const WER_SUBMIT_QUEUE: WER_SUBMIT_FLAGS = 4;
pub const WER_SUBMIT_REPORT_MACHINE_ID: WER_SUBMIT_FLAGS = 8192;
pub type WER_SUBMIT_RESULT = i32;
pub const WER_SUBMIT_SHOW_DEBUG: WER_SUBMIT_FLAGS = 8;
pub const WER_SUBMIT_START_MINIMIZED: WER_SUBMIT_FLAGS = 512;
...
pub const frrvErr: EFaultRepRetVal = 3;
pub const frrvErrAnotherInstance: EFaultRepRetVal = 8;
pub const frrvErrDoubleFault: EFaultRepRetVal = 10;
pub const frrvErrNoDW: EFaultRepRetVal = 4;
pub const frrvErrNoMemory: EFaultRepRetVal = 9;
pub const frrvErrTimeout: EFaultRepRetVal = 5;
pub const frrvLaunchDebugger: EFaultRepRetVal = 6;
pub const frrvOk: EFaultRepRetVal = 0;
pub const frrvOkHeadless: EFaultRepRetVal = 7;
pub const frrvOkManifest: EFaultRepRetVal = 1;
pub const frrvOkQueued: EFaultRepRetVal = 2;
