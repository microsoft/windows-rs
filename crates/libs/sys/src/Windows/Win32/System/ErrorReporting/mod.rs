pub type AddERExcludedApplicationA = unsafe extern "system" fn(szapplication: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type AddERExcludedApplicationW = unsafe extern "system" fn(wszapplication: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type ReportFault = unsafe extern "system" fn(pep: *const super::Diagnostics::Debug::EXCEPTION_POINTERS, dwopt: u32) -> EFaultRepRetVal;
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_Kernel"))]
...
pub type WerAddExcludedApplication = unsafe extern "system" fn(pwzexename: windows_sys::core::PCWSTR, ballusers: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type WerFreeString = unsafe extern "system" fn(pwszstr: windows_sys::core::PCWSTR);
windows_link::link!("wer.dll" "system" fn WerFreeString(pwszstr : windows_sys::core::PCWSTR));
pub type WerGetFlags = unsafe extern "system" fn(hprocess: super::super::Foundation::HANDLE, pdwflags: *mut WER_FAULT_REPORTING) -> windows_sys::core::HRESULT;
...
pub type WerRegisterAdditionalProcess = unsafe extern "system" fn(processid: u32, captureextrainfoforthreadid: u32) -> windows_sys::core::HRESULT;
...
pub type WerRegisterAppLocalDump = unsafe extern "system" fn(localappdatarelativepath: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type WerRegisterCustomMetadata = unsafe extern "system" fn(key: windows_sys::core::PCWSTR, value: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type WerRegisterExcludedMemoryBlock = unsafe extern "system" fn(address: *const core::ffi::c_void, size: u32) -> windows_sys::core::HRESULT;
...
pub type WerRegisterFile = unsafe extern "system" fn(pwzfile: windows_sys::core::PCWSTR, regfiletype: WER_REGISTER_FILE_TYPE, dwflags: WER_FILE) -> windows_sys::core::HRESULT;
...
pub type WerRegisterMemoryBlock = unsafe extern "system" fn(pvaddress: *const core::ffi::c_void, dwsize: u32) -> windows_sys::core::HRESULT;
...
pub type WerRegisterRuntimeExceptionModule = unsafe extern "system" fn(pwszoutofprocesscallbackdll: windows_sys::core::PCWSTR, pcontext: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WerRemoveExcludedApplication = unsafe extern "system" fn(pwzexename: windows_sys::core::PCWSTR, ballusers: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_Kernel"))]
pub type WerReportAddDump = unsafe extern "system" fn(hreporthandle: HREPORT, hprocess: super::super::Foundation::HANDLE, hthread: super::super::Foundation::HANDLE, dumptype: WER_DUMP_TYPE, pexceptionparam: *const WER_EXCEPTION_INFORMATION, pdumpcustomoptions: *const WER_DUMP_CUSTOM_OPTIONS, dwflags: u32) -> windows_sys::core::HRESULT;
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_Kernel"))]
...
pub type WerReportAddFile = unsafe extern "system" fn(hreporthandle: HREPORT, pwzpath: windows_sys::core::PCWSTR, repfiletype: WER_FILE_TYPE, dwfileflags: WER_FILE) -> windows_sys::core::HRESULT;
...
pub type WerReportCloseHandle = unsafe extern "system" fn(hreporthandle: HREPORT) -> windows_sys::core::HRESULT;
windows_link::link!("wer.dll" "system" fn WerReportCloseHandle(hreporthandle : HREPORT) -> windows_sys::core::HRESULT);
pub type WerReportCreate = unsafe extern "system" fn(pwzeventtype: windows_sys::core::PCWSTR, reptype: WER_REPORT_TYPE, preportinformation: *const WER_REPORT_INFORMATION, phreporthandle: *mut HREPORT) -> windows_sys::core::HRESULT;
...
pub type WerReportHang = unsafe extern "system" fn(hwndhungapp: super::super::Foundation::HWND, pwzhungapplicationname: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type WerReportSetParameter = unsafe extern "system" fn(hreporthandle: HREPORT, dwparamid: u32, pwzname: windows_sys::core::PCWSTR, pwzvalue: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type WerReportSetUIOption = unsafe extern "system" fn(hreporthandle: HREPORT, repuitypeid: WER_REPORT_UI, pwzvalue: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type WerReportSubmit = unsafe extern "system" fn(hreporthandle: HREPORT, consent: WER_CONSENT, dwflags: WER_SUBMIT_FLAGS, psubmitresult: *mut WER_SUBMIT_RESULT) -> windows_sys::core::HRESULT;
...
pub type WerSetFlags = unsafe extern "system" fn(dwflags: WER_FAULT_REPORTING) -> windows_sys::core::HRESULT;
windows_link::link!("kernel32.dll" "system" fn WerSetFlags(dwflags : WER_FAULT_REPORTING) -> windows_sys::core::HRESULT);
pub type WerStoreClose = unsafe extern "system" fn(hreportstore: HREPORTSTORE);
windows_link::link!("wer.dll" "system" fn WerStoreClose(hreportstore : HREPORTSTORE));
pub type WerStoreGetFirstReportKey = unsafe extern "system" fn(hreportstore: HREPORTSTORE, ppszreportkey: *mut windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type WerStoreGetNextReportKey = unsafe extern "system" fn(hreportstore: HREPORTSTORE, ppszreportkey: *mut windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type WerStoreGetReportCount = unsafe extern "system" fn(hreportstore: HREPORTSTORE, pdwreportcount: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WerStoreGetSizeOnDisk = unsafe extern "system" fn(hreportstore: HREPORTSTORE, pqwsizeinbytes: *mut u64) -> windows_sys::core::HRESULT;
...
pub type WerStoreOpen = unsafe extern "system" fn(repstoretype: REPORT_STORE_TYPES, phreportstore: *mut HREPORTSTORE) -> windows_sys::core::HRESULT;
...
pub type WerStorePurge = unsafe extern "system" fn() -> windows_sys::core::HRESULT;
windows_link::link!("wer.dll" "system" fn WerStorePurge() -> windows_sys::core::HRESULT);
pub type WerStoreQueryReportMetadataV1 = unsafe extern "system" fn(hreportstore: HREPORTSTORE, pszreportkey: windows_sys::core::PCWSTR, preportmetadata: *mut WER_REPORT_METADATA_V1) -> windows_sys::core::HRESULT;
...
pub type WerStoreQueryReportMetadataV2 = unsafe extern "system" fn(hreportstore: HREPORTSTORE, pszreportkey: windows_sys::core::PCWSTR, preportmetadata: *mut WER_REPORT_METADATA_V2) -> windows_sys::core::HRESULT;
...
pub type WerStoreQueryReportMetadataV3 = unsafe extern "system" fn(hreportstore: HREPORTSTORE, pszreportkey: windows_sys::core::PCWSTR, preportmetadata: *mut WER_REPORT_METADATA_V3) -> windows_sys::core::HRESULT;
...
pub type WerStoreUploadReport = unsafe extern "system" fn(hreportstore: HREPORTSTORE, pszreportkey: windows_sys::core::PCWSTR, dwflags: u32, psubmitresult: *mut WER_SUBMIT_RESULT) -> windows_sys::core::HRESULT;
...
pub type WerUnregisterAdditionalProcess = unsafe extern "system" fn(processid: u32) -> windows_sys::core::HRESULT;
windows_link::link!("kernel32.dll" "system" fn WerUnregisterAdditionalProcess(processid : u32) -> windows_sys::core::HRESULT);
pub type WerUnregisterAppLocalDump = unsafe extern "system" fn() -> windows_sys::core::HRESULT;
windows_link::link!("kernel32.dll" "system" fn WerUnregisterAppLocalDump() -> windows_sys::core::HRESULT);
pub type WerUnregisterCustomMetadata = unsafe extern "system" fn(key: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type WerUnregisterExcludedMemoryBlock = unsafe extern "system" fn(address: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WerUnregisterFile = unsafe extern "system" fn(pwzfilepath: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
windows_link::link!("kernel32.dll" "system" fn WerUnregisterFile(pwzfilepath : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
pub type WerUnregisterMemoryBlock = unsafe extern "system" fn(pvaddress: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WerUnregisterRuntimeExceptionModule = unsafe extern "system" fn(pwszoutofprocesscallbackdll: windows_sys::core::PCWSTR, pcontext: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
