...
pub const APPNAME: INSTALLSPECTYPE = 1;
pub type APPSTATE = i32;
pub const ASSIGNED: APPSTATE = 1;
...
pub const COMCLASS: INSTALLSPECTYPE = 4;
pub const FILEEXT: INSTALLSPECTYPE = 2;
...
pub const GPO_OPEN_LOAD_REGISTRY: GPO_OPEN_FLAGS = 1;
pub const GPO_OPEN_READ_ONLY: GPO_OPEN_FLAGS = 2;
pub type GPO_OPTIONS = u32;
pub const GPO_OPTION_DISABLE_MACHINE: GPO_OPTIONS = 2;
pub const GPO_OPTION_DISABLE_USER: GPO_OPTIONS = 1;
pub type GPO_SECTION = u32;
pub const GPO_SECTION_MACHINE: GPO_SECTION = 2;
pub const GPO_SECTION_ROOT: GPO_SECTION = 0;
pub const GPO_SECTION_USER: GPO_SECTION = 1;
...
pub const backupMostRecent: GPMSearchProperty = 9;
pub const gpoComputerExtensions: GPMSearchProperty = 5;
pub const gpoDisplayName: GPMSearchProperty = 2;
pub const gpoDomain: GPMSearchProperty = 8;
pub const gpoEffectivePermissions: GPMSearchProperty = 1;
pub const gpoID: GPMSearchProperty = 4;
pub const gpoPermissions: GPMSearchProperty = 0;
pub const gpoUserExtensions: GPMSearchProperty = 6;
pub const gpoWMIFilter: GPMSearchProperty = 3;
pub const opContains: GPMSearchOperation = 1;
pub const opDestinationByRelativeName: GPMDestinationOption = 2;
pub const opDestinationNone: GPMDestinationOption = 1;
pub const opDestinationSameAsSource: GPMDestinationOption = 0;
pub const opDestinationSet: GPMDestinationOption = 3;
pub const opEquals: GPMSearchOperation = 0;
pub const opNotContains: GPMSearchOperation = 2;
pub const opNotEquals: GPMSearchOperation = 3;
pub const opReportComments: GPMReportingOptions = 1;
pub const opReportLegacy: GPMReportingOptions = 0;
pub const permGPOApply: GPMPermissionType = 65536;
pub const permGPOCustom: GPMPermissionType = 65795;
pub const permGPOEdit: GPMPermissionType = 65793;
pub const permGPOEditSecurityAndDelete: GPMPermissionType = 65794;
pub const permGPORead: GPMPermissionType = 65792;
pub const permSOMGPOCreate: GPMPermissionType = 1049600;
pub const permSOMLink: GPMPermissionType = 1835008;
pub const permSOMLogging: GPMPermissionType = 1573120;
pub const permSOMPlanning: GPMPermissionType = 1573376;
pub const permSOMStarterGPOCreate: GPMPermissionType = 1049856;
pub const permSOMWMICreate: GPMPermissionType = 1049344;
pub const permSOMWMIFullControl: GPMPermissionType = 1049345;
pub const permStarterGPOCustom: GPMPermissionType = 197891;
pub const permStarterGPOEdit: GPMPermissionType = 197889;
pub const permStarterGPOFullControl: GPMPermissionType = 197890;
pub const permStarterGPORead: GPMPermissionType = 197888;
pub const permWMIFilterCustom: GPMPermissionType = 131074;
pub const permWMIFilterEdit: GPMPermissionType = 131072;
pub const permWMIFilterFullControl: GPMPermissionType = 131073;
pub const repClientHealthRefreshXML: GPMReportType = 5;
pub const repClientHealthXML: GPMReportType = 4;
pub const repHTML: GPMReportType = 1;
pub const repInfraRefreshXML: GPMReportType = 3;
pub const repInfraXML: GPMReportType = 2;
pub const repXML: GPMReportType = 0;
pub const rsopLogging: GPMRSOPMode = 2;
pub const rsopPlanning: GPMRSOPMode = 1;
pub const rsopUnknown: GPMRSOPMode = 0;
pub const somDomain: GPMSOMType = 1;
pub const somLinks: GPMSearchProperty = 7;
pub const somOU: GPMSOMType = 2;
pub const somSite: GPMSOMType = 0;
pub const starterGPODisplayName: GPMSearchProperty = 12;
pub const starterGPODomain: GPMSearchProperty = 14;
pub const starterGPOEffectivePermissions: GPMSearchProperty = 11;
pub const starterGPOID: GPMSearchProperty = 13;
pub const starterGPOPermissions: GPMSearchProperty = 10;
pub const typeComputer: GPMEntryType = 1;
pub const typeCustom: GPMStarterGPOType = 1;
pub const typeGPO: GPMBackupType = 0;
pub const typeGlobalGroup: GPMEntryType = 3;
pub const typeLocalGroup: GPMEntryType = 2;
pub const typeStarterGPO: GPMBackupType = 1;
pub const typeSystem: GPMStarterGPOType = 0;
pub const typeUNCPath: GPMEntryType = 5;
pub const typeUniversalGroup: GPMEntryType = 4;
pub const typeUnknown: GPMEntryType = 6;
pub const typeUser: GPMEntryType = 0;
