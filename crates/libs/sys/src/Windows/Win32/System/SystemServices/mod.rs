...
pub const ALERT_SYSTEM_CRITICAL: ALERT_SYSTEM_SEV = 5;
pub const ALERT_SYSTEM_ERROR: ALERT_SYSTEM_SEV = 3;
pub const ALERT_SYSTEM_INFORMATIONAL: ALERT_SYSTEM_SEV = 1;
pub const ALERT_SYSTEM_QUERY: ALERT_SYSTEM_SEV = 4;
pub type ALERT_SYSTEM_SEV = u32;
pub const ALERT_SYSTEM_WARNING: ALERT_SYSTEM_SEV = 2;
...
pub const APPCOMMAND_BASS_BOOST: APPCOMMAND_ID = 20;
pub const APPCOMMAND_BASS_DOWN: APPCOMMAND_ID = 19;
pub const APPCOMMAND_BASS_UP: APPCOMMAND_ID = 21;
pub const APPCOMMAND_BROWSER_BACKWARD: APPCOMMAND_ID = 1;
pub const APPCOMMAND_BROWSER_FAVORITES: APPCOMMAND_ID = 6;
pub const APPCOMMAND_BROWSER_FORWARD: APPCOMMAND_ID = 2;
pub const APPCOMMAND_BROWSER_HOME: APPCOMMAND_ID = 7;
pub const APPCOMMAND_BROWSER_REFRESH: APPCOMMAND_ID = 3;
pub const APPCOMMAND_BROWSER_SEARCH: APPCOMMAND_ID = 5;
pub const APPCOMMAND_BROWSER_STOP: APPCOMMAND_ID = 4;
pub const APPCOMMAND_CLOSE: APPCOMMAND_ID = 31;
pub const APPCOMMAND_COPY: APPCOMMAND_ID = 36;
pub const APPCOMMAND_CORRECTION_LIST: APPCOMMAND_ID = 45;
pub const APPCOMMAND_CUT: APPCOMMAND_ID = 37;
pub const APPCOMMAND_DELETE: APPCOMMAND_ID = 53;
pub const APPCOMMAND_DICTATE_OR_COMMAND_CONTROL_TOGGLE: APPCOMMAND_ID = 43;
pub const APPCOMMAND_DWM_FLIP3D: APPCOMMAND_ID = 54;
pub const APPCOMMAND_FIND: APPCOMMAND_ID = 28;
pub const APPCOMMAND_FORWARD_MAIL: APPCOMMAND_ID = 40;
pub const APPCOMMAND_HELP: APPCOMMAND_ID = 27;
pub type APPCOMMAND_ID = u32;
pub const APPCOMMAND_LAUNCH_APP1: APPCOMMAND_ID = 17;
pub const APPCOMMAND_LAUNCH_APP2: APPCOMMAND_ID = 18;
pub const APPCOMMAND_LAUNCH_MAIL: APPCOMMAND_ID = 15;
pub const APPCOMMAND_LAUNCH_MEDIA_SELECT: APPCOMMAND_ID = 16;
pub const APPCOMMAND_MEDIA_CHANNEL_DOWN: APPCOMMAND_ID = 52;
pub const APPCOMMAND_MEDIA_CHANNEL_UP: APPCOMMAND_ID = 51;
pub const APPCOMMAND_MEDIA_FAST_FORWARD: APPCOMMAND_ID = 49;
pub const APPCOMMAND_MEDIA_NEXTTRACK: APPCOMMAND_ID = 11;
pub const APPCOMMAND_MEDIA_PAUSE: APPCOMMAND_ID = 47;
pub const APPCOMMAND_MEDIA_PLAY: APPCOMMAND_ID = 46;
pub const APPCOMMAND_MEDIA_PLAY_PAUSE: APPCOMMAND_ID = 14;
pub const APPCOMMAND_MEDIA_PREVIOUSTRACK: APPCOMMAND_ID = 12;
pub const APPCOMMAND_MEDIA_RECORD: APPCOMMAND_ID = 48;
pub const APPCOMMAND_MEDIA_REWIND: APPCOMMAND_ID = 50;
pub const APPCOMMAND_MEDIA_STOP: APPCOMMAND_ID = 13;
pub const APPCOMMAND_MICROPHONE_VOLUME_DOWN: APPCOMMAND_ID = 25;
pub const APPCOMMAND_MICROPHONE_VOLUME_MUTE: APPCOMMAND_ID = 24;
pub const APPCOMMAND_MICROPHONE_VOLUME_UP: APPCOMMAND_ID = 26;
pub const APPCOMMAND_MIC_ON_OFF_TOGGLE: APPCOMMAND_ID = 44;
pub const APPCOMMAND_NEW: APPCOMMAND_ID = 29;
pub const APPCOMMAND_OPEN: APPCOMMAND_ID = 30;
pub const APPCOMMAND_PASTE: APPCOMMAND_ID = 38;
pub const APPCOMMAND_PRINT: APPCOMMAND_ID = 33;
pub const APPCOMMAND_REDO: APPCOMMAND_ID = 35;
pub const APPCOMMAND_REPLY_TO_MAIL: APPCOMMAND_ID = 39;
pub const APPCOMMAND_SAVE: APPCOMMAND_ID = 32;
pub const APPCOMMAND_SEND_MAIL: APPCOMMAND_ID = 41;
pub const APPCOMMAND_SPELL_CHECK: APPCOMMAND_ID = 42;
pub const APPCOMMAND_TREBLE_DOWN: APPCOMMAND_ID = 22;
pub const APPCOMMAND_TREBLE_UP: APPCOMMAND_ID = 23;
pub const APPCOMMAND_UNDO: APPCOMMAND_ID = 34;
pub const APPCOMMAND_VOLUME_DOWN: APPCOMMAND_ID = 9;
pub const APPCOMMAND_VOLUME_MUTE: APPCOMMAND_ID = 8;
pub const APPCOMMAND_VOLUME_UP: APPCOMMAND_ID = 10;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const ASSERT_BREAKPOINT: u32 = 524291;
pub type ATF_FLAGS = u32;
pub const ATF_ONOFFFEEDBACK: ATF_FLAGS = 2;
pub const ATF_TIMEOUTON: ATF_FLAGS = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const BREAK_DEBUG_BASE: u32 = 524288;
...
pub const CFU_CF1UNDERLINE: CFE_UNDERLINE = 255;
pub const CFU_INVERT: CFE_UNDERLINE = 254;
pub const CFU_UNDERLINE: CFE_UNDERLINE = 1;
pub const CFU_UNDERLINEDASH: CFE_UNDERLINE = 5;
pub const CFU_UNDERLINEDASHDOT: CFE_UNDERLINE = 6;
pub const CFU_UNDERLINEDASHDOTDOT: CFE_UNDERLINE = 7;
pub const CFU_UNDERLINEDOTTED: CFE_UNDERLINE = 4;
pub const CFU_UNDERLINEDOUBLE: CFE_UNDERLINE = 3;
pub const CFU_UNDERLINEDOUBLEWAVE: CFE_UNDERLINE = 11;
pub const CFU_UNDERLINEHAIRLINE: CFE_UNDERLINE = 10;
pub const CFU_UNDERLINEHEAVYWAVE: CFE_UNDERLINE = 12;
pub const CFU_UNDERLINELONGDASH: CFE_UNDERLINE = 13;
pub const CFU_UNDERLINENONE: CFE_UNDERLINE = 0;
pub const CFU_UNDERLINETHICK: CFE_UNDERLINE = 9;
pub const CFU_UNDERLINETHICKDASH: CFE_UNDERLINE = 14;
pub const CFU_UNDERLINETHICKDASHDOT: CFE_UNDERLINE = 15;
pub const CFU_UNDERLINETHICKDASHDOTDOT: CFE_UNDERLINE = 16;
pub const CFU_UNDERLINETHICKDOTTED: CFE_UNDERLINE = 17;
pub const CFU_UNDERLINETHICKLONGDASH: CFE_UNDERLINE = 18;
pub const CFU_UNDERLINEWAVE: CFE_UNDERLINE = 8;
pub const CFU_UNDERLINEWORD: CFE_UNDERLINE = 2;
...
pub const GC_ALLGESTURES: GESTURECONFIG_FLAGS = 1;
pub const GC_PAN: GESTURECONFIG_FLAGS = 1;
pub const GC_PAN_WITH_GUTTER: GESTURECONFIG_FLAGS = 8;
pub const GC_PAN_WITH_INERTIA: GESTURECONFIG_FLAGS = 16;
pub const GC_PAN_WITH_SINGLE_FINGER_HORIZONTALLY: GESTURECONFIG_FLAGS = 4;
pub const GC_PAN_WITH_SINGLE_FINGER_VERTICALLY: GESTURECONFIG_FLAGS = 2;
pub const GC_PRESSANDTAP: GESTURECONFIG_FLAGS = 1;
pub const GC_ROLLOVER: GESTURECONFIG_FLAGS = 1;
pub const GC_ROTATE: GESTURECONFIG_FLAGS = 1;
pub const GC_TWOFINGERTAP: GESTURECONFIG_FLAGS = 1;
pub const GC_ZOOM: GESTURECONFIG_FLAGS = 1;
#[repr(C)]
...
pub const IGP_CONVERSION: IGP_ID = 8;
pub const IGP_GETIMEVERSION: IGP_ID = 4294967292;
pub type IGP_ID = u32;
pub const IGP_PROPERTY: IGP_ID = 4;
pub const IGP_SELECT: IGP_ID = 24;
pub const IGP_SENTENCE: IGP_ID = 12;
pub const IGP_SETCOMPSTR: IGP_ID = 20;
pub const IGP_UI: IGP_ID = 16;
#[repr(C, packed(4))]
...
pub const IMAGE_OS2_SIGNATURE: u16 = 17742;
pub const IMAGE_OS2_SIGNATURE_LE: u16 = 17740;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const IMAGE_VXD_SIGNATURE: u16 = 17740;
...
pub const IO_REPARSE_TAG_RESERVED_INVALID: i32 = -1073709056;
...
pub const IO_REPARSE_TAG_STORAGE_SYNC_FOLDER: i32 = -1879048153;
...
pub const ITWW_OPEN_CONNECT: WORD_WHEEL_OPEN_FLAGS = 0;
...
pub const MK_CONTROL: MODIFIERKEYS_FLAGS = 8;
pub const MK_LBUTTON: MODIFIERKEYS_FLAGS = 1;
pub const MK_MBUTTON: MODIFIERKEYS_FLAGS = 16;
pub const MK_RBUTTON: MODIFIERKEYS_FLAGS = 2;
pub const MK_SHIFT: MODIFIERKEYS_FLAGS = 4;
pub const MK_XBUTTON1: MODIFIERKEYS_FLAGS = 32;
pub const MK_XBUTTON2: MODIFIERKEYS_FLAGS = 64;
...
pub const PRAGMA_DEPRECATED_DDK: u32 = 1;
...
pub const RECO_COPY: RECO_FLAGS = 2;
pub const RECO_CUT: RECO_FLAGS = 3;
pub const RECO_DRAG: RECO_FLAGS = 4;
pub const RECO_DROP: RECO_FLAGS = 1;
pub type RECO_FLAGS = u32;
pub const RECO_PASTE: RECO_FLAGS = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const REDBOOK_DIGITAL_AUDIO_EXTRACTION_INFO_VERSION: u32 = 1;
...
pub const RuntimeReportTypeMax: RUNTIME_REPORT_TYPE = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const SE_GROUP_LOGON_ID: i32 = -1073741824;
...
pub const SFGAO_BROWSABLE: SFGAO_FLAGS = 134217728;
pub const SFGAO_CANCOPY: SFGAO_FLAGS = 1;
pub const SFGAO_CANDELETE: SFGAO_FLAGS = 32;
pub const SFGAO_CANLINK: SFGAO_FLAGS = 4;
pub const SFGAO_CANMONIKER: SFGAO_FLAGS = 4194304;
pub const SFGAO_CANMOVE: SFGAO_FLAGS = 2;
pub const SFGAO_CANRENAME: SFGAO_FLAGS = 16;
pub const SFGAO_CAPABILITYMASK: SFGAO_FLAGS = 375;
pub const SFGAO_COMPRESSED: SFGAO_FLAGS = 67108864;
pub const SFGAO_CONTENTSMASK: SFGAO_FLAGS = 2147483648;
pub const SFGAO_DISPLAYATTRMASK: SFGAO_FLAGS = 1032192;
pub const SFGAO_DROPTARGET: SFGAO_FLAGS = 256;
pub const SFGAO_ENCRYPTED: SFGAO_FLAGS = 8192;
pub const SFGAO_FILESYSANCESTOR: SFGAO_FLAGS = 268435456;
pub const SFGAO_FILESYSTEM: SFGAO_FLAGS = 1073741824;
pub type SFGAO_FLAGS = u32;
pub const SFGAO_FOLDER: SFGAO_FLAGS = 536870912;
pub const SFGAO_GHOSTED: SFGAO_FLAGS = 32768;
pub const SFGAO_HASPROPSHEET: SFGAO_FLAGS = 64;
pub const SFGAO_HASSTORAGE: SFGAO_FLAGS = 4194304;
pub const SFGAO_HASSUBFOLDER: SFGAO_FLAGS = 2147483648;
pub const SFGAO_HIDDEN: SFGAO_FLAGS = 524288;
pub const SFGAO_ISSLOW: SFGAO_FLAGS = 16384;
pub const SFGAO_LINK: SFGAO_FLAGS = 65536;
pub const SFGAO_NEWCONTENT: SFGAO_FLAGS = 2097152;
pub const SFGAO_NONENUMERATED: SFGAO_FLAGS = 1048576;
pub const SFGAO_PKEYSFGAOMASK: SFGAO_FLAGS = 2164539392;
pub const SFGAO_PLACEHOLDER: SFGAO_FLAGS = 2048;
pub const SFGAO_READONLY: SFGAO_FLAGS = 262144;
pub const SFGAO_REMOVABLE: SFGAO_FLAGS = 33554432;
pub const SFGAO_SHARE: SFGAO_FLAGS = 131072;
pub const SFGAO_STORAGE: SFGAO_FLAGS = 8;
pub const SFGAO_STORAGEANCESTOR: SFGAO_FLAGS = 8388608;
pub const SFGAO_STORAGECAPMASK: SFGAO_FLAGS = 1891958792;
pub const SFGAO_STREAM: SFGAO_FLAGS = 4194304;
pub const SFGAO_SYSTEM: SFGAO_FLAGS = 4096;
pub const SFGAO_VALIDATE: SFGAO_FLAGS = 16777216;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const SS_BITMAP: STATIC_STYLES = 14;
pub const SS_BLACKFRAME: STATIC_STYLES = 7;
pub const SS_BLACKRECT: STATIC_STYLES = 4;
pub const SS_CENTER: STATIC_STYLES = 1;
pub const SS_CENTERIMAGE: STATIC_STYLES = 512;
pub const SS_EDITCONTROL: STATIC_STYLES = 8192;
pub const SS_ELLIPSISMASK: STATIC_STYLES = 49152;
pub const SS_ENDELLIPSIS: STATIC_STYLES = 16384;
pub const SS_ENHMETAFILE: STATIC_STYLES = 15;
pub const SS_ETCHEDFRAME: STATIC_STYLES = 18;
pub const SS_ETCHEDHORZ: STATIC_STYLES = 16;
pub const SS_ETCHEDVERT: STATIC_STYLES = 17;
pub const SS_GRAYFRAME: STATIC_STYLES = 8;
pub const SS_GRAYRECT: STATIC_STYLES = 5;
pub const SS_ICON: STATIC_STYLES = 3;
pub const SS_LEFT: STATIC_STYLES = 0;
pub const SS_LEFTNOWORDWRAP: STATIC_STYLES = 12;
pub const SS_NOPREFIX: STATIC_STYLES = 128;
pub const SS_NOTIFY: STATIC_STYLES = 256;
pub const SS_OWNERDRAW: STATIC_STYLES = 13;
pub const SS_PATHELLIPSIS: STATIC_STYLES = 32768;
pub const SS_REALSIZECONTROL: STATIC_STYLES = 64;
pub const SS_REALSIZEIMAGE: STATIC_STYLES = 2048;
pub const SS_RIGHT: STATIC_STYLES = 2;
pub const SS_RIGHTJUST: STATIC_STYLES = 1024;
pub const SS_SIMPLE: STATIC_STYLES = 11;
pub const SS_SUNKEN: STATIC_STYLES = 4096;
pub const SS_TYPEMASK: STATIC_STYLES = 31;
pub const SS_USERITEM: STATIC_STYLES = 10;
pub const SS_WHITEFRAME: STATIC_STYLES = 9;
pub const SS_WHITERECT: STATIC_STYLES = 6;
pub const SS_WORDELLIPSIS: STATIC_STYLES = 49152;
...
pub const TAPE_DRIVE_ABSOLUTE_BLK: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147487744;
pub const TAPE_DRIVE_ABS_BLK_IMMED: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147491840;
...
pub const TAPE_DRIVE_END_OF_DATA: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147549184;
...
pub const TAPE_DRIVE_FILEMARKS: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147745792;
...
pub const TAPE_DRIVE_LOAD_UNLD_IMMED: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147483680;
pub const TAPE_DRIVE_LOAD_UNLOAD: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147483649;
pub const TAPE_DRIVE_LOCK_UNLK_IMMED: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147483776;
pub const TAPE_DRIVE_LOCK_UNLOCK: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147483652;
pub const TAPE_DRIVE_LOGICAL_BLK: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147500032;
pub const TAPE_DRIVE_LOG_BLK_IMMED: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147516416;
pub const TAPE_DRIVE_PADDING: u32 = 262144;
pub type TAPE_DRIVE_PROBLEM_TYPE = i32;
pub const TAPE_DRIVE_RELATIVE_BLKS: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147614720;
pub const TAPE_DRIVE_REPORT_SMKS: u32 = 524288;
pub const TAPE_DRIVE_RESERVED_BIT: u32 = 2147483648;
pub const TAPE_DRIVE_REVERSE_POSITION: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2151677952;
pub const TAPE_DRIVE_REWIND_IMMEDIATE: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147483656;
pub const TAPE_DRIVE_SELECT: u32 = 2;
pub const TAPE_DRIVE_SEQUENTIAL_FMKS: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2148007936;
pub const TAPE_DRIVE_SEQUENTIAL_SMKS: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2149580800;
pub const TAPE_DRIVE_SETMARKS: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2148532224;
pub const TAPE_DRIVE_SET_BLOCK_SIZE: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147483664;
pub const TAPE_DRIVE_SET_CMP_BOP_ONLY: u32 = 67108864;
pub const TAPE_DRIVE_SET_COMPRESSION: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147484160;
pub const TAPE_DRIVE_SET_ECC: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147483904;
pub const TAPE_DRIVE_SET_EOT_WZ_SIZE: u32 = 4194304;
pub const TAPE_DRIVE_SET_PADDING: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147484672;
pub const TAPE_DRIVE_SET_REPORT_SMKS: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147485696;
pub const TAPE_DRIVE_SPACE_IMMEDIATE: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2155872256;
pub const TAPE_DRIVE_TAPE_CAPACITY: u32 = 256;
pub const TAPE_DRIVE_TAPE_REMAINING: u32 = 512;
pub const TAPE_DRIVE_TENSION: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147483650;
pub const TAPE_DRIVE_TENSION_IMMED: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2147483712;
pub const TAPE_DRIVE_VARIABLE_BLOCK: u32 = 2048;
pub const TAPE_DRIVE_WRITE_FILEMARKS: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2181038080;
pub const TAPE_DRIVE_WRITE_LONG_FMKS: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2281701376;
pub const TAPE_DRIVE_WRITE_MARK_IMMED: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2415919104;
pub const TAPE_DRIVE_WRITE_PROTECT: u32 = 4096;
pub const TAPE_DRIVE_WRITE_SETMARKS: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2164260864;
pub const TAPE_DRIVE_WRITE_SHORT_FMKS: TAPE_GET_DRIVE_PARAMETERS_FEATURES_HIGH = 2214592512;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const _ARM64_MULT_INTRINS_SUPPORTED: u32 = 0;
