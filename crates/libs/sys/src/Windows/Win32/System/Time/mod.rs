...
windows_link::link!("kernel32.dll" "system" fn FileTimeToSystemTime(lpfiletime : *mut super::super::Foundation:: FILETIME, lpsystemtime : *mut super::super::Foundation:: SYSTEMTIME) -> windows_sys::core::BOOL);
...
windows_link::link!("kernel32.dll" "system" fn GetTimeZoneInformationForYear(wyear : u16, pdtzi : *mut DYNAMIC_TIME_ZONE_INFORMATION, ptzi : *mut TIME_ZONE_INFORMATION) -> windows_sys::core::BOOL);
windows_link::link!("kernel32.dll" "system" fn LocalFileTimeToLocalSystemTime(timezoneinformation : *mut TIME_ZONE_INFORMATION, localfiletime : *mut super::super::Foundation:: FILETIME, localsystemtime : *mut super::super::Foundation:: SYSTEMTIME) -> windows_sys::core::BOOL);
...
windows_link::link!("kernel32.dll" "system" fn SetDynamicTimeZoneInformation(lptimezoneinformation : *mut DYNAMIC_TIME_ZONE_INFORMATION) -> windows_sys::core::BOOL);
...
windows_link::link!("kernel32.dll" "system" fn SystemTimeToFileTime(lpsystemtime : *mut super::super::Foundation:: SYSTEMTIME, lpfiletime : *mut super::super::Foundation:: FILETIME) -> windows_sys::core::BOOL);
...
windows_link::link!("kernel32.dll" "system" fn TzSpecificLocalTimeToSystemTime(lptimezoneinformation : *mut TIME_ZONE_INFORMATION, lplocaltime : *mut super::super::Foundation:: SYSTEMTIME, lpuniversaltime : *mut super::super::Foundation:: SYSTEMTIME) -> windows_sys::core::BOOL);
