pub type ApplyGuestMemoryFix = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, virtualaddress: u64, fixbuffer: *const core::ffi::c_void, fixbuffersize: u32) -> windows_sys::core::HRESULT;
...
pub type ApplyPendingSavedStateFileReplayLog = unsafe extern "system" fn(vmrsfile: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type CallStackUnwind = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, imageinfo: *const MODULE_INFO, imageinfocount: u32, framecount: u32, callstack: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type FindSavedStateSymbolFieldInType = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, typename: windows_sys::core::PCSTR, fieldname: windows_sys::core::PCWSTR, offset: *mut u32, found: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type ForceActiveVirtualTrustLevel = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, virtualtrustlevel: u8) -> windows_sys::core::HRESULT;
...
pub type ForceArchitecture = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, architecture: VIRTUAL_PROCESSOR_ARCH) -> windows_sys::core::HRESULT;
...
pub type ForceNestedHostMode = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, hostmode: windows_sys::core::BOOL, oldmode: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type ForcePagingMode = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, pagingmode: PAGING_MODE) -> windows_sys::core::HRESULT;
...
pub type GetActiveVirtualTrustLevel = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, virtualtrustlevel: *mut u8) -> windows_sys::core::HRESULT;
...
pub type GetArchitecture = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, architecture: *mut VIRTUAL_PROCESSOR_ARCH) -> windows_sys::core::HRESULT;
...
pub type GetEnabledVirtualTrustLevels = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, virtualtrustlevels: *mut u32) -> windows_sys::core::HRESULT;
...
pub type GetGuestEnabledVirtualTrustLevels = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, virtualtrustlevels: *mut u32) -> windows_sys::core::HRESULT;
...
pub type GetGuestOsInfo = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, virtualtrustlevel: u8, guestosinfo: *mut GUEST_OS_INFO) -> windows_sys::core::HRESULT;
...
pub type GetGuestPhysicalMemoryChunks = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, memorychunkpagesize: *mut u64, memorychunks: *mut GPA_MEMORY_CHUNK, memorychunkcount: *mut u64) -> windows_sys::core::HRESULT;
...
pub type GetGuestRawSavedMemorySize = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, guestrawsavedmemorysize: *mut u64) -> windows_sys::core::HRESULT;
...
pub type GetMemoryBlockCacheLimit = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, memoryblockcachelimit: *mut u64) -> windows_sys::core::HRESULT;
...
pub type GetNestedVirtualizationMode = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, enabled: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type GetPagingMode = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, pagingmode: *mut PAGING_MODE) -> windows_sys::core::HRESULT;
...
pub type GetRegisterValue = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, registerid: u32, registervalue: *mut VIRTUAL_PROCESSOR_REGISTER) -> windows_sys::core::HRESULT;
...
pub type GetSavedStateSymbolFieldInfo = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, typename: windows_sys::core::PCSTR, typefieldinfomap: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type GetSavedStateSymbolProviderHandle = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void) -> super::super::Foundation::HANDLE;
...
pub type GetSavedStateSymbolTypeSize = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, typename: windows_sys::core::PCSTR, size: *mut u32) -> windows_sys::core::HRESULT;
...
pub type GetVpCount = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpcount: *mut u32) -> windows_sys::core::HRESULT;
...
pub type GuestPhysicalAddressToRawSavedMemoryOffset = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, physicaladdress: u64, rawsavedmemoryoffset: *mut u64) -> windows_sys::core::HRESULT;
...
pub type GuestVirtualAddressToPhysicalAddress = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, virtualaddress: u64, physicaladdress: *mut u64, unmappedregionsize: *mut u64) -> windows_sys::core::HRESULT;
...
pub type HdvCreateGuestMemoryAperture = unsafe extern "system" fn(requestor: *const core::ffi::c_void, guestphysicaladdress: u64, bytecount: u32, writeprotected: windows_sys::core::BOOL, mappedaddress: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type HdvCreateSectionBackedMmioRange = unsafe extern "system" fn(requestor: *const core::ffi::c_void, barindex: HDV_PCI_BAR_SELECTOR, offsetinpages: u64, lengthinpages: u64, mappingflags: HDV_MMIO_MAPPING_FLAGS, sectionhandle: super::super::Foundation::HANDLE, sectionoffsetinpages: u64) -> windows_sys::core::HRESULT;
...
pub type HdvDeliverGuestInterrupt = unsafe extern "system" fn(requestor: *const core::ffi::c_void, msiaddress: u64, msidata: u32) -> windows_sys::core::HRESULT;
...
pub type HdvDestroyGuestMemoryAperture = unsafe extern "system" fn(requestor: *const core::ffi::c_void, mappedaddress: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type HdvDestroySectionBackedMmioRange = unsafe extern "system" fn(requestor: *const core::ffi::c_void, barindex: HDV_PCI_BAR_SELECTOR, offsetinpages: u64) -> windows_sys::core::HRESULT;
...
pub type HdvInitializeDeviceHost = unsafe extern "system" fn(computesystem: super::HostComputeSystem::HCS_SYSTEM, devicehosthandle: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_System_HostComputeSystem")]
...
#[cfg(feature = "Win32_System_HostComputeSystem")]
pub type HdvInitializeDeviceHostEx = unsafe extern "system" fn(computesystem: super::HostComputeSystem::HCS_SYSTEM, flags: HDV_DEVICE_HOST_FLAGS, devicehosthandle: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_System_HostComputeSystem")]
...
pub type HdvReadGuestMemory = unsafe extern "system" fn(requestor: *const core::ffi::c_void, guestphysicaladdress: u64, bytecount: u32, buffer: *mut u8) -> windows_sys::core::HRESULT;
...
pub type HdvRegisterDoorbell = unsafe extern "system" fn(requestor: *const core::ffi::c_void, barindex: HDV_PCI_BAR_SELECTOR, baroffset: u64, triggervalue: u64, flags: u64, doorbellevent: super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type HdvTeardownDeviceHost = unsafe extern "system" fn(devicehosthandle: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type HdvUnregisterDoorbell = unsafe extern "system" fn(requestor: *const core::ffi::c_void, barindex: HDV_PCI_BAR_SELECTOR, baroffset: u64, triggervalue: u64, flags: u64) -> windows_sys::core::HRESULT;
...
pub type HdvWriteGuestMemory = unsafe extern "system" fn(requestor: *const core::ffi::c_void, guestphysicaladdress: u64, bytecount: u32, buffer: *const u8) -> windows_sys::core::HRESULT;
...
pub type InKernelSpace = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, inkernelspace: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type IsActiveVirtualTrustLevelEnabled = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, activevirtualtrustlevelenabled: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type IsNestedVirtualizationEnabled = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, enabled: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type LoadSavedStateFile = unsafe extern "system" fn(vmrsfile: windows_sys::core::PCWSTR, vmsavedstatedumphandle: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type LoadSavedStateFiles = unsafe extern "system" fn(binfile: windows_sys::core::PCWSTR, vsvfile: windows_sys::core::PCWSTR, vmsavedstatedumphandle: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type LoadSavedStateModuleSymbols = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, imagename: windows_sys::core::PCSTR, modulename: windows_sys::core::PCSTR, baseaddress: u64, sizeofbase: u32) -> windows_sys::core::HRESULT;
...
pub type LoadSavedStateModuleSymbolsEx = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, imagename: windows_sys::core::PCSTR, imagetimestamp: u32, modulename: windows_sys::core::PCSTR, baseaddress: u64, sizeofbase: u32) -> windows_sys::core::HRESULT;
...
pub type LoadSavedStateSymbolProvider = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, usersymbols: windows_sys::core::PCWSTR, force: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type LocateSavedStateFiles = unsafe extern "system" fn(vmname: windows_sys::core::PCWSTR, snapshotname: windows_sys::core::PCWSTR, binpath: *mut windows_sys::core::PWSTR, vsvpath: *mut windows_sys::core::PWSTR, vmrspath: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type ReadGuestPhysicalAddress = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, physicaladdress: u64, buffer: *mut core::ffi::c_void, buffersize: u32, bytesread: *mut u32) -> windows_sys::core::HRESULT;
...
pub type ReadGuestRawSavedMemory = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, rawsavedmemoryoffset: u64, buffer: *mut core::ffi::c_void, buffersize: u32, bytesread: *mut u32) -> windows_sys::core::HRESULT;
...
pub type ReadSavedStateGlobalVariable = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, globalname: windows_sys::core::PCSTR, buffer: *mut core::ffi::c_void, buffersize: u32) -> windows_sys::core::HRESULT;
...
pub type ReleaseSavedStateFiles = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type ReleaseSavedStateSymbolProvider = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type ResolveSavedStateGlobalVariableAddress = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, globalname: windows_sys::core::PCSTR, virtualaddress: *mut u64, size: *mut u32) -> windows_sys::core::HRESULT;
...
pub type ScanMemoryForDosImages = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, vpid: u32, startaddress: u64, endaddress: u64, callbackcontext: *mut core::ffi::c_void, foundimagecallback: FOUND_IMAGE_CALLBACK, standaloneaddress: *const u64, standaloneaddresscount: u32) -> windows_sys::core::HRESULT;
...
pub type SetMemoryBlockCacheLimit = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, memoryblockcachelimit: u64) -> windows_sys::core::HRESULT;
...
pub type SetSavedStateSymbolProviderDebugInfoCallback = unsafe extern "system" fn(vmsavedstatedumphandle: *mut core::ffi::c_void, callback: GUEST_SYMBOLS_PROVIDER_DEBUG_INFO_CALLBACK) -> windows_sys::core::HRESULT;
...
pub type WHvAcceptPartitionMigration = unsafe extern "system" fn(migrationhandle: super::super::Foundation::HANDLE, partition: *mut WHV_PARTITION_HANDLE) -> windows_sys::core::HRESULT;
...
pub type WHvAdviseGpaRange = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, gparanges: *const WHV_MEMORY_RANGE_ENTRY, gparangescount: u32, advice: WHV_ADVISE_GPA_RANGE_CODE, advicebuffer: *const core::ffi::c_void, advicebuffersizeinbytes: u32) -> windows_sys::core::HRESULT;
...
pub type WHvAllocateVpciResource = unsafe extern "system" fn(providerid: *const windows_sys::core::GUID, flags: WHV_ALLOCATE_VPCI_RESOURCE_FLAGS, resourcedescriptor: *const core::ffi::c_void, resourcedescriptorsizeinbytes: u32, vpciresource: *mut super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type WHvCancelPartitionMigration = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE) -> windows_sys::core::HRESULT;
...
pub type WHvCancelRunVirtualProcessor = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, flags: u32) -> windows_sys::core::HRESULT;
...
pub type WHvCompletePartitionMigration = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE) -> windows_sys::core::HRESULT;
...
pub type WHvCreateNotificationPort = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, parameters: *const WHV_NOTIFICATION_PORT_PARAMETERS, eventhandle: super::super::Foundation::HANDLE, porthandle: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WHvCreatePartition = unsafe extern "system" fn(partition: *mut WHV_PARTITION_HANDLE) -> windows_sys::core::HRESULT;
...
pub type WHvCreateTrigger = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, parameters: *const WHV_TRIGGER_PARAMETERS, triggerhandle: *mut *mut core::ffi::c_void, eventhandle: *mut super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type WHvCreateVirtualProcessor = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, flags: u32) -> windows_sys::core::HRESULT;
...
pub type WHvCreateVirtualProcessor2 = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, properties: *const WHV_VIRTUAL_PROCESSOR_PROPERTY, propertycount: u32) -> windows_sys::core::HRESULT;
...
pub type WHvCreateVpciDevice = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, logicaldeviceid: u64, vpciresource: super::super::Foundation::HANDLE, flags: WHV_CREATE_VPCI_DEVICE_FLAGS, notificationeventhandle: super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type WHvDeleteNotificationPort = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, porthandle: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WHvDeletePartition = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("winhvplatform.dll" "system" fn WHvDeletePartition(partition : WHV_PARTITION_HANDLE) -> windows_sys::core::HRESULT);
pub type WHvDeleteTrigger = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, triggerhandle: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WHvDeleteVirtualProcessor = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32) -> windows_sys::core::HRESULT;
...
pub type WHvDeleteVpciDevice = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, logicaldeviceid: u64) -> windows_sys::core::HRESULT;
...
pub type WHvEmulatorCreateEmulator = unsafe extern "system" fn(callbacks: *const WHV_EMULATOR_CALLBACKS, emulator: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WHvEmulatorDestroyEmulator = unsafe extern "system" fn(emulator: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WHvEmulatorTryIoEmulation = unsafe extern "system" fn(emulator: *const core::ffi::c_void, context: *const core::ffi::c_void, vpcontext: *const WHV_VP_EXIT_CONTEXT, ioinstructioncontext: *const WHV_X64_IO_PORT_ACCESS_CONTEXT, emulatorreturnstatus: *mut WHV_EMULATOR_STATUS) -> windows_sys::core::HRESULT;
...
pub type WHvEmulatorTryMmioEmulation = unsafe extern "system" fn(emulator: *const core::ffi::c_void, context: *const core::ffi::c_void, vpcontext: *const WHV_VP_EXIT_CONTEXT, mmioinstructioncontext: *const WHV_MEMORY_ACCESS_CONTEXT, emulatorreturnstatus: *mut WHV_EMULATOR_STATUS) -> windows_sys::core::HRESULT;
...
pub type WHvGetCapability = unsafe extern "system" fn(capabilitycode: WHV_CAPABILITY_CODE, capabilitybuffer: *mut core::ffi::c_void, capabilitybuffersizeinbytes: u32, writtensizeinbytes: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WHvGetInterruptTargetVpSet = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, destination: u64, destinationmode: WHV_INTERRUPT_DESTINATION_MODE, targetvps: *mut u32, vpcount: u32, targetvpcount: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WHvGetPartitionCounters = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, counterset: WHV_PARTITION_COUNTER_SET, buffer: *mut core::ffi::c_void, buffersizeinbytes: u32, byteswritten: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WHvGetPartitionProperty = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, propertycode: WHV_PARTITION_PROPERTY_CODE, propertybuffer: *mut core::ffi::c_void, propertybuffersizeinbytes: u32, writtensizeinbytes: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WHvGetVirtualProcessorCounters = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, counterset: WHV_PROCESSOR_COUNTER_SET, buffer: *mut core::ffi::c_void, buffersizeinbytes: u32, byteswritten: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WHvGetVirtualProcessorCpuidOutput = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, eax: u32, ecx: u32, cpuidoutput: *mut WHV_CPUID_OUTPUT) -> windows_sys::core::HRESULT;
...
pub type WHvGetVirtualProcessorInterruptControllerState = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, state: *mut core::ffi::c_void, statesize: u32, writtensize: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WHvGetVirtualProcessorInterruptControllerState2 = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, state: *mut core::ffi::c_void, statesize: u32, writtensize: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WHvGetVirtualProcessorRegisters = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, registernames: *const WHV_REGISTER_NAME, registercount: u32, registervalues: *mut WHV_REGISTER_VALUE) -> windows_sys::core::HRESULT;
...
pub type WHvGetVirtualProcessorState = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, statetype: WHV_VIRTUAL_PROCESSOR_STATE_TYPE, buffer: *mut core::ffi::c_void, buffersizeinbytes: u32, byteswritten: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WHvGetVirtualProcessorXsaveState = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, buffer: *mut core::ffi::c_void, buffersizeinbytes: u32, byteswritten: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WHvGetVpciDeviceInterruptTarget = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, logicaldeviceid: u64, index: u32, multimessagenumber: u32, target: *mut WHV_VPCI_INTERRUPT_TARGET, targetsizeinbytes: u32, byteswritten: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WHvGetVpciDeviceNotification = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, logicaldeviceid: u64, notification: *mut WHV_VPCI_DEVICE_NOTIFICATION, notificationsizeinbytes: u32) -> windows_sys::core::HRESULT;
...
pub type WHvGetVpciDeviceProperty = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, logicaldeviceid: u64, propertycode: WHV_VPCI_DEVICE_PROPERTY_CODE, propertybuffer: *mut core::ffi::c_void, propertybuffersizeinbytes: u32, writtensizeinbytes: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WHvMapGpaRange = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, sourceaddress: *const core::ffi::c_void, guestaddress: u64, sizeinbytes: u64, flags: WHV_MAP_GPA_RANGE_FLAGS) -> windows_sys::core::HRESULT;
...
pub type WHvMapGpaRange2 = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, process: super::super::Foundation::HANDLE, sourceaddress: *const core::ffi::c_void, guestaddress: u64, sizeinbytes: u64, flags: WHV_MAP_GPA_RANGE_FLAGS) -> windows_sys::core::HRESULT;
...
pub type WHvMapVpciDeviceInterrupt = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, logicaldeviceid: u64, index: u32, messagecount: u32, target: *const WHV_VPCI_INTERRUPT_TARGET, msiaddress: *mut u64, msidata: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WHvMapVpciDeviceMmioRanges = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, logicaldeviceid: u64, mappingcount: *mut u32, mappings: *mut *mut WHV_VPCI_MMIO_MAPPING) -> windows_sys::core::HRESULT;
...
pub type WHvPostVirtualProcessorSynicMessage = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, sintindex: u32, message: *const core::ffi::c_void, messagesizeinbytes: u32) -> windows_sys::core::HRESULT;
...
pub type WHvQueryGpaRangeDirtyBitmap = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, guestaddress: u64, rangesizeinbytes: u64, bitmap: *mut u64, bitmapsizeinbytes: u32) -> windows_sys::core::HRESULT;
...
pub type WHvReadGpaRange = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, guestaddress: u64, controls: WHV_ACCESS_GPA_CONTROLS, data: *mut core::ffi::c_void, datasizeinbytes: u32) -> windows_sys::core::HRESULT;
...
pub type WHvReadVpciDeviceRegister = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, logicaldeviceid: u64, register: *const WHV_VPCI_DEVICE_REGISTER, data: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WHvRegisterPartitionDoorbellEvent = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, matchdata: *const WHV_DOORBELL_MATCH_DATA, eventhandle: super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type WHvRequestInterrupt = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, interrupt: *const WHV_INTERRUPT_CONTROL, interruptcontrolsize: u32) -> windows_sys::core::HRESULT;
...
pub type WHvRequestVpciDeviceInterrupt = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, logicaldeviceid: u64, msiaddress: u64, msidata: u32) -> windows_sys::core::HRESULT;
...
pub type WHvResetPartition = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("winhvplatform.dll" "system" fn WHvResetPartition(partition : WHV_PARTITION_HANDLE) -> windows_sys::core::HRESULT);
pub type WHvResumePartitionTime = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE) -> windows_sys::core::HRESULT;
...
pub type WHvRetargetVpciDeviceInterrupt = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, logicaldeviceid: u64, msiaddress: u64, msidata: u32, target: *const WHV_VPCI_INTERRUPT_TARGET) -> windows_sys::core::HRESULT;
...
pub type WHvRunVirtualProcessor = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, exitcontext: *mut core::ffi::c_void, exitcontextsizeinbytes: u32) -> windows_sys::core::HRESULT;
...
pub type WHvSetNotificationPortProperty = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, porthandle: *const core::ffi::c_void, propertycode: WHV_NOTIFICATION_PORT_PROPERTY_CODE, propertyvalue: u64) -> windows_sys::core::HRESULT;
...
pub type WHvSetPartitionProperty = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, propertycode: WHV_PARTITION_PROPERTY_CODE, propertybuffer: *const core::ffi::c_void, propertybuffersizeinbytes: u32) -> windows_sys::core::HRESULT;
...
pub type WHvSetVirtualProcessorInterruptControllerState = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, state: *const core::ffi::c_void, statesize: u32) -> windows_sys::core::HRESULT;
...
pub type WHvSetVirtualProcessorInterruptControllerState2 = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, state: *const core::ffi::c_void, statesize: u32) -> windows_sys::core::HRESULT;
...
pub type WHvSetVirtualProcessorRegisters = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, registernames: *const WHV_REGISTER_NAME, registercount: u32, registervalues: *const WHV_REGISTER_VALUE) -> windows_sys::core::HRESULT;
...
pub type WHvSetVirtualProcessorState = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, statetype: WHV_VIRTUAL_PROCESSOR_STATE_TYPE, buffer: *const core::ffi::c_void, buffersizeinbytes: u32) -> windows_sys::core::HRESULT;
...
pub type WHvSetVirtualProcessorXsaveState = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, buffer: *const core::ffi::c_void, buffersizeinbytes: u32) -> windows_sys::core::HRESULT;
...
pub type WHvSetVpciDevicePowerState = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, logicaldeviceid: u64, powerstate: super::Power::DEVICE_POWER_STATE) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_System_Power")]
...
pub type WHvSetupPartition = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("winhvplatform.dll" "system" fn WHvSetupPartition(partition : WHV_PARTITION_HANDLE) -> windows_sys::core::HRESULT);
pub type WHvSignalVirtualProcessorSynicEvent = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, synicevent: WHV_SYNIC_EVENT_PARAMETERS, newlysignaled: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type WHvStartPartitionMigration = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, migrationhandle: *mut super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type WHvSuspendPartitionTime = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE) -> windows_sys::core::HRESULT;
...
pub type WHvTranslateGva = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, gva: u64, translateflags: WHV_TRANSLATE_GVA_FLAGS, translationresult: *mut WHV_TRANSLATE_GVA_RESULT, gpa: *mut u64) -> windows_sys::core::HRESULT;
...
pub type WHvUnmapGpaRange = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, guestaddress: u64, sizeinbytes: u64) -> windows_sys::core::HRESULT;
...
pub type WHvUnmapVpciDeviceInterrupt = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, logicaldeviceid: u64, index: u32) -> windows_sys::core::HRESULT;
...
pub type WHvUnmapVpciDeviceMmioRanges = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, logicaldeviceid: u64) -> windows_sys::core::HRESULT;
...
pub type WHvUnregisterPartitionDoorbellEvent = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, matchdata: *const WHV_DOORBELL_MATCH_DATA) -> windows_sys::core::HRESULT;
...
pub type WHvUpdateTriggerParameters = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, parameters: *const WHV_TRIGGER_PARAMETERS, triggerhandle: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WHvWriteGpaRange = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, vpindex: u32, guestaddress: u64, controls: WHV_ACCESS_GPA_CONTROLS, data: *const core::ffi::c_void, datasizeinbytes: u32) -> windows_sys::core::HRESULT;
...
pub type WHvWriteVpciDeviceRegister = unsafe extern "system" fn(partition: WHV_PARTITION_HANDLE, logicaldeviceid: u64, register: *const WHV_VPCI_DEVICE_REGISTER, data: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
