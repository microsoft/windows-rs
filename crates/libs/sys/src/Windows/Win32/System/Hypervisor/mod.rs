::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn ApplyGuestMemoryFix ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , virtualaddress : u64 , fixbuffer : *const ::core::ffi::c_void , fixbuffersize : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn ApplyPendingSavedStateFileReplayLog ( vmrsfile : :: windows_sys::core::PCWSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn CallStackUnwind ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , imageinfo : *const MODULE_INFO , imageinfocount : u32 , framecount : u32 , callstack : *mut :: windows_sys::core::PWSTR ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn FindSavedStateSymbolFieldInType ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , typename : :: windows_sys::core::PCSTR , fieldname : :: windows_sys::core::PCWSTR , offset : *mut u32 , found : *mut super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn ForceActiveVirtualTrustLevel ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , virtualtrustlevel : u8 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn ForceArchitecture ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , architecture : VIRTUAL_PROCESSOR_ARCH ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn ForceNestedHostMode ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , hostmode : super::super::Foundation:: BOOL , oldmode : *mut super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn ForcePagingMode ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , pagingmode : PAGING_MODE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn GetActiveVirtualTrustLevel ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , virtualtrustlevel : *mut u8 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn GetArchitecture ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , architecture : *mut VIRTUAL_PROCESSOR_ARCH ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn GetEnabledVirtualTrustLevels ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , virtualtrustlevels : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn GetGuestEnabledVirtualTrustLevels ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , virtualtrustlevels : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn GetGuestOsInfo ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , virtualtrustlevel : u8 , guestosinfo : *mut GUEST_OS_INFO ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn GetGuestPhysicalMemoryChunks ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , memorychunkpagesize : *mut u64 , memorychunks : *mut GPA_MEMORY_CHUNK , memorychunkcount : *mut u64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn GetGuestRawSavedMemorySize ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , guestrawsavedmemorysize : *mut u64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn GetMemoryBlockCacheLimit ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , memoryblockcachelimit : *mut u64 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn GetNestedVirtualizationMode ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , enabled : *mut super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn GetPagingMode ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , pagingmode : *mut PAGING_MODE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn GetRegisterValue ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , registerid : u32 , registervalue : *mut VIRTUAL_PROCESSOR_REGISTER ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn GetSavedStateSymbolFieldInfo ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , typename : :: windows_sys::core::PCSTR , typefieldinfomap : *mut :: windows_sys::core::PWSTR ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn GetSavedStateSymbolProviderHandle ( vmsavedstatedumphandle : *mut ::core::ffi::c_void ) -> super::super::Foundation:: HANDLE );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn GetSavedStateSymbolTypeSize ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , typename : :: windows_sys::core::PCSTR , size : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn GetVpCount ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpcount : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn GuestPhysicalAddressToRawSavedMemoryOffset ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , physicaladdress : u64 , rawsavedmemoryoffset : *mut u64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn GuestVirtualAddressToPhysicalAddress ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , virtualaddress : u64 , physicaladdress : *mut u64 , unmappedregionsize : *mut u64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmdevicehost.dll" ,"system" fn HdvCreateDeviceInstance ( devicehosthandle : *const ::core::ffi::c_void , devicetype : HDV_DEVICE_TYPE , deviceclassid : *const :: windows_sys::core::GUID , deviceinstanceid : *const :: windows_sys::core::GUID , deviceinterface : *const ::core::ffi::c_void , devicecontext : *const ::core::ffi::c_void , devicehandle : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "vmdevicehost.dll" ,"system" fn HdvCreateGuestMemoryAperture ( requestor : *const ::core::ffi::c_void , guestphysicaladdress : u64 , bytecount : u32 , writeprotected : super::super::Foundation:: BOOL , mappedaddress : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "vmdevicehost.dll" ,"system" fn HdvCreateSectionBackedMmioRange ( requestor : *const ::core::ffi::c_void , barindex : HDV_PCI_BAR_SELECTOR , offsetinpages : u64 , lengthinpages : u64 , mappingflags : HDV_MMIO_MAPPING_FLAGS , sectionhandle : super::super::Foundation:: HANDLE , sectionoffsetinpages : u64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmdevicehost.dll" ,"system" fn HdvDeliverGuestInterrupt ( requestor : *const ::core::ffi::c_void , msiaddress : u64 , msidata : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmdevicehost.dll" ,"system" fn HdvDestroyGuestMemoryAperture ( requestor : *const ::core::ffi::c_void , mappedaddress : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmdevicehost.dll" ,"system" fn HdvDestroySectionBackedMmioRange ( requestor : *const ::core::ffi::c_void , barindex : HDV_PCI_BAR_SELECTOR , offsetinpages : u64 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_HostComputeSystem")]
::windows_sys::core::link ! ( "vmdevicehost.dll" ,"system" fn HdvInitializeDeviceHost ( computesystem : super::HostComputeSystem:: HCS_SYSTEM , devicehosthandle : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmdevicehost.dll" ,"system" fn HdvReadGuestMemory ( requestor : *const ::core::ffi::c_void , guestphysicaladdress : u64 , bytecount : u32 , buffer : *mut u8 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "vmdevicehost.dll" ,"system" fn HdvRegisterDoorbell ( requestor : *const ::core::ffi::c_void , barindex : HDV_PCI_BAR_SELECTOR , baroffset : u64 , triggervalue : u64 , flags : u64 , doorbellevent : super::super::Foundation:: HANDLE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmdevicehost.dll" ,"system" fn HdvTeardownDeviceHost ( devicehosthandle : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmdevicehost.dll" ,"system" fn HdvUnregisterDoorbell ( requestor : *const ::core::ffi::c_void , barindex : HDV_PCI_BAR_SELECTOR , baroffset : u64 , triggervalue : u64 , flags : u64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmdevicehost.dll" ,"system" fn HdvWriteGuestMemory ( requestor : *const ::core::ffi::c_void , guestphysicaladdress : u64 , bytecount : u32 , buffer : *const u8 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn InKernelSpace ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , inkernelspace : *mut super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn IsActiveVirtualTrustLevelEnabled ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , activevirtualtrustlevelenabled : *mut super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn IsNestedVirtualizationEnabled ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , enabled : *mut super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn LoadSavedStateFile ( vmrsfile : :: windows_sys::core::PCWSTR , vmsavedstatedumphandle : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn LoadSavedStateFiles ( binfile : :: windows_sys::core::PCWSTR , vsvfile : :: windows_sys::core::PCWSTR , vmsavedstatedumphandle : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn LoadSavedStateModuleSymbols ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , imagename : :: windows_sys::core::PCSTR , modulename : :: windows_sys::core::PCSTR , baseaddress : u64 , sizeofbase : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn LoadSavedStateModuleSymbolsEx ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , imagename : :: windows_sys::core::PCSTR , imagetimestamp : u32 , modulename : :: windows_sys::core::PCSTR , baseaddress : u64 , sizeofbase : u32 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn LoadSavedStateSymbolProvider ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , usersymbols : :: windows_sys::core::PCWSTR , force : super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn LocateSavedStateFiles ( vmname : :: windows_sys::core::PCWSTR , snapshotname : :: windows_sys::core::PCWSTR , binpath : *mut :: windows_sys::core::PWSTR , vsvpath : *mut :: windows_sys::core::PWSTR , vmrspath : *mut :: windows_sys::core::PWSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn ReadGuestPhysicalAddress ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , physicaladdress : u64 , buffer : *mut ::core::ffi::c_void , buffersize : u32 , bytesread : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn ReadGuestRawSavedMemory ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , rawsavedmemoryoffset : u64 , buffer : *mut ::core::ffi::c_void , buffersize : u32 , bytesread : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn ReadSavedStateGlobalVariable ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , globalname : :: windows_sys::core::PCSTR , buffer : *mut ::core::ffi::c_void , buffersize : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn ReleaseSavedStateFiles ( vmsavedstatedumphandle : *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn ReleaseSavedStateSymbolProvider ( vmsavedstatedumphandle : *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn ResolveSavedStateGlobalVariableAddress ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , globalname : :: windows_sys::core::PCSTR , virtualaddress : *mut u64 , size : *mut u32 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn ScanMemoryForDosImages ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , vpid : u32 , startaddress : u64 , endaddress : u64 , callbackcontext : *mut ::core::ffi::c_void , foundimagecallback : FOUND_IMAGE_CALLBACK , standaloneaddress : *const u64 , standaloneaddresscount : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn SetMemoryBlockCacheLimit ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , memoryblockcachelimit : u64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "vmsavedstatedumpprovider.dll" ,"system" fn SetSavedStateSymbolProviderDebugInfoCallback ( vmsavedstatedumphandle : *mut ::core::ffi::c_void , callback : GUEST_SYMBOLS_PROVIDER_DEBUG_INFO_CALLBACK ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvAcceptPartitionMigration ( migrationhandle : super::super::Foundation:: HANDLE , partition : *mut WHV_PARTITION_HANDLE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvAdviseGpaRange ( partition : WHV_PARTITION_HANDLE , gparanges : *const WHV_MEMORY_RANGE_ENTRY , gparangescount : u32 , advice : WHV_ADVISE_GPA_RANGE_CODE , advicebuffer : *const ::core::ffi::c_void , advicebuffersizeinbytes : u32 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvAllocateVpciResource ( providerid : *const :: windows_sys::core::GUID , flags : WHV_ALLOCATE_VPCI_RESOURCE_FLAGS , resourcedescriptor : *const ::core::ffi::c_void , resourcedescriptorsizeinbytes : u32 , vpciresource : *mut super::super::Foundation:: HANDLE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvCancelPartitionMigration ( partition : WHV_PARTITION_HANDLE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvCancelRunVirtualProcessor ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , flags : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvCompletePartitionMigration ( partition : WHV_PARTITION_HANDLE ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvCreateNotificationPort ( partition : WHV_PARTITION_HANDLE , parameters : *const WHV_NOTIFICATION_PORT_PARAMETERS , eventhandle : super::super::Foundation:: HANDLE , porthandle : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvCreatePartition ( partition : *mut WHV_PARTITION_HANDLE ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvCreateTrigger ( partition : WHV_PARTITION_HANDLE , parameters : *const WHV_TRIGGER_PARAMETERS , triggerhandle : *mut *mut ::core::ffi::c_void , eventhandle : *mut super::super::Foundation:: HANDLE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvCreateVirtualProcessor ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , flags : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvCreateVirtualProcessor2 ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , properties : *const WHV_VIRTUAL_PROCESSOR_PROPERTY , propertycount : u32 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvCreateVpciDevice ( partition : WHV_PARTITION_HANDLE , logicaldeviceid : u64 , vpciresource : super::super::Foundation:: HANDLE , flags : WHV_CREATE_VPCI_DEVICE_FLAGS , notificationeventhandle : super::super::Foundation:: HANDLE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvDeleteNotificationPort ( partition : WHV_PARTITION_HANDLE , porthandle : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvDeletePartition ( partition : WHV_PARTITION_HANDLE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvDeleteTrigger ( partition : WHV_PARTITION_HANDLE , triggerhandle : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvDeleteVirtualProcessor ( partition : WHV_PARTITION_HANDLE , vpindex : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvDeleteVpciDevice ( partition : WHV_PARTITION_HANDLE , logicaldeviceid : u64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvemulation.dll" ,"system" fn WHvEmulatorCreateEmulator ( callbacks : *const WHV_EMULATOR_CALLBACKS , emulator : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvemulation.dll" ,"system" fn WHvEmulatorDestroyEmulator ( emulator : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
...
::windows_sys::core::link ! ( "winhvemulation.dll" ,"system" fn WHvEmulatorTryMmioEmulation ( emulator : *const ::core::ffi::c_void , context : *const ::core::ffi::c_void , vpcontext : *const WHV_VP_EXIT_CONTEXT , mmioinstructioncontext : *const WHV_MEMORY_ACCESS_CONTEXT , emulatorreturnstatus : *mut WHV_EMULATOR_STATUS ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvGetCapability ( capabilitycode : WHV_CAPABILITY_CODE , capabilitybuffer : *mut ::core::ffi::c_void , capabilitybuffersizeinbytes : u32 , writtensizeinbytes : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvGetInterruptTargetVpSet ( partition : WHV_PARTITION_HANDLE , destination : u64 , destinationmode : WHV_INTERRUPT_DESTINATION_MODE , targetvps : *mut u32 , vpcount : u32 , targetvpcount : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvGetPartitionCounters ( partition : WHV_PARTITION_HANDLE , counterset : WHV_PARTITION_COUNTER_SET , buffer : *mut ::core::ffi::c_void , buffersizeinbytes : u32 , byteswritten : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvGetPartitionProperty ( partition : WHV_PARTITION_HANDLE , propertycode : WHV_PARTITION_PROPERTY_CODE , propertybuffer : *mut ::core::ffi::c_void , propertybuffersizeinbytes : u32 , writtensizeinbytes : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvGetVirtualProcessorCounters ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , counterset : WHV_PROCESSOR_COUNTER_SET , buffer : *mut ::core::ffi::c_void , buffersizeinbytes : u32 , byteswritten : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvGetVirtualProcessorCpuidOutput ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , eax : u32 , ecx : u32 , cpuidoutput : *mut WHV_CPUID_OUTPUT ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvGetVirtualProcessorInterruptControllerState ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , state : *mut ::core::ffi::c_void , statesize : u32 , writtensize : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvGetVirtualProcessorInterruptControllerState2 ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , state : *mut ::core::ffi::c_void , statesize : u32 , writtensize : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvGetVirtualProcessorRegisters ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , registernames : *const WHV_REGISTER_NAME , registercount : u32 , registervalues : *mut WHV_REGISTER_VALUE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvGetVirtualProcessorState ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , statetype : WHV_VIRTUAL_PROCESSOR_STATE_TYPE , buffer : *mut ::core::ffi::c_void , buffersizeinbytes : u32 , byteswritten : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvGetVirtualProcessorXsaveState ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , buffer : *mut ::core::ffi::c_void , buffersizeinbytes : u32 , byteswritten : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvGetVpciDeviceInterruptTarget ( partition : WHV_PARTITION_HANDLE , logicaldeviceid : u64 , index : u32 , multimessagenumber : u32 , target : *mut WHV_VPCI_INTERRUPT_TARGET , targetsizeinbytes : u32 , byteswritten : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvGetVpciDeviceNotification ( partition : WHV_PARTITION_HANDLE , logicaldeviceid : u64 , notification : *mut WHV_VPCI_DEVICE_NOTIFICATION , notificationsizeinbytes : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvGetVpciDeviceProperty ( partition : WHV_PARTITION_HANDLE , logicaldeviceid : u64 , propertycode : WHV_VPCI_DEVICE_PROPERTY_CODE , propertybuffer : *mut ::core::ffi::c_void , propertybuffersizeinbytes : u32 , writtensizeinbytes : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvMapGpaRange ( partition : WHV_PARTITION_HANDLE , sourceaddress : *const ::core::ffi::c_void , guestaddress : u64 , sizeinbytes : u64 , flags : WHV_MAP_GPA_RANGE_FLAGS ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvMapGpaRange2 ( partition : WHV_PARTITION_HANDLE , process : super::super::Foundation:: HANDLE , sourceaddress : *const ::core::ffi::c_void , guestaddress : u64 , sizeinbytes : u64 , flags : WHV_MAP_GPA_RANGE_FLAGS ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvMapVpciDeviceInterrupt ( partition : WHV_PARTITION_HANDLE , logicaldeviceid : u64 , index : u32 , messagecount : u32 , target : *const WHV_VPCI_INTERRUPT_TARGET , msiaddress : *mut u64 , msidata : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvMapVpciDeviceMmioRanges ( partition : WHV_PARTITION_HANDLE , logicaldeviceid : u64 , mappingcount : *mut u32 , mappings : *mut *mut WHV_VPCI_MMIO_MAPPING ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvPostVirtualProcessorSynicMessage ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , sintindex : u32 , message : *const ::core::ffi::c_void , messagesizeinbytes : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvQueryGpaRangeDirtyBitmap ( partition : WHV_PARTITION_HANDLE , guestaddress : u64 , rangesizeinbytes : u64 , bitmap : *mut u64 , bitmapsizeinbytes : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvReadGpaRange ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , guestaddress : u64 , controls : WHV_ACCESS_GPA_CONTROLS , data : *mut ::core::ffi::c_void , datasizeinbytes : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvReadVpciDeviceRegister ( partition : WHV_PARTITION_HANDLE , logicaldeviceid : u64 , register : *const WHV_VPCI_DEVICE_REGISTER , data : *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvRegisterPartitionDoorbellEvent ( partition : WHV_PARTITION_HANDLE , matchdata : *const WHV_DOORBELL_MATCH_DATA , eventhandle : super::super::Foundation:: HANDLE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvRequestInterrupt ( partition : WHV_PARTITION_HANDLE , interrupt : *const WHV_INTERRUPT_CONTROL , interruptcontrolsize : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvRequestVpciDeviceInterrupt ( partition : WHV_PARTITION_HANDLE , logicaldeviceid : u64 , msiaddress : u64 , msidata : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvResetPartition ( partition : WHV_PARTITION_HANDLE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvResumePartitionTime ( partition : WHV_PARTITION_HANDLE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvRetargetVpciDeviceInterrupt ( partition : WHV_PARTITION_HANDLE , logicaldeviceid : u64 , msiaddress : u64 , msidata : u32 , target : *const WHV_VPCI_INTERRUPT_TARGET ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvRunVirtualProcessor ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , exitcontext : *mut ::core::ffi::c_void , exitcontextsizeinbytes : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvSetNotificationPortProperty ( partition : WHV_PARTITION_HANDLE , porthandle : *const ::core::ffi::c_void , propertycode : WHV_NOTIFICATION_PORT_PROPERTY_CODE , propertyvalue : u64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvSetPartitionProperty ( partition : WHV_PARTITION_HANDLE , propertycode : WHV_PARTITION_PROPERTY_CODE , propertybuffer : *const ::core::ffi::c_void , propertybuffersizeinbytes : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvSetVirtualProcessorInterruptControllerState ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , state : *const ::core::ffi::c_void , statesize : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvSetVirtualProcessorInterruptControllerState2 ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , state : *const ::core::ffi::c_void , statesize : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvSetVirtualProcessorRegisters ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , registernames : *const WHV_REGISTER_NAME , registercount : u32 , registervalues : *const WHV_REGISTER_VALUE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvSetVirtualProcessorState ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , statetype : WHV_VIRTUAL_PROCESSOR_STATE_TYPE , buffer : *const ::core::ffi::c_void , buffersizeinbytes : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvSetVirtualProcessorXsaveState ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , buffer : *const ::core::ffi::c_void , buffersizeinbytes : u32 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Power")]
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvSetVpciDevicePowerState ( partition : WHV_PARTITION_HANDLE , logicaldeviceid : u64 , powerstate : super::Power:: DEVICE_POWER_STATE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvSetupPartition ( partition : WHV_PARTITION_HANDLE ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvSignalVirtualProcessorSynicEvent ( partition : WHV_PARTITION_HANDLE , synicevent : WHV_SYNIC_EVENT_PARAMETERS , newlysignaled : *mut super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvStartPartitionMigration ( partition : WHV_PARTITION_HANDLE , migrationhandle : *mut super::super::Foundation:: HANDLE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvSuspendPartitionTime ( partition : WHV_PARTITION_HANDLE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvTranslateGva ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , gva : u64 , translateflags : WHV_TRANSLATE_GVA_FLAGS , translationresult : *mut WHV_TRANSLATE_GVA_RESULT , gpa : *mut u64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvUnmapGpaRange ( partition : WHV_PARTITION_HANDLE , guestaddress : u64 , sizeinbytes : u64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvUnmapVpciDeviceInterrupt ( partition : WHV_PARTITION_HANDLE , logicaldeviceid : u64 , index : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvUnmapVpciDeviceMmioRanges ( partition : WHV_PARTITION_HANDLE , logicaldeviceid : u64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvUnregisterPartitionDoorbellEvent ( partition : WHV_PARTITION_HANDLE , matchdata : *const WHV_DOORBELL_MATCH_DATA ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvUpdateTriggerParameters ( partition : WHV_PARTITION_HANDLE , parameters : *const WHV_TRIGGER_PARAMETERS , triggerhandle : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvWriteGpaRange ( partition : WHV_PARTITION_HANDLE , vpindex : u32 , guestaddress : u64 , controls : WHV_ACCESS_GPA_CONTROLS , data : *const ::core::ffi::c_void , datasizeinbytes : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "winhvplatform.dll" ,"system" fn WHvWriteVpciDeviceRegister ( partition : WHV_PARTITION_HANDLE , logicaldeviceid : u64 , register : *const WHV_VPCI_DEVICE_REGISTER , data : *const ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
