windows_link::link!("mqrt.dll" "system" fn MQADsPathToFormatName(lpwcsadspath : windows_sys::core::PCWSTR, lpwcsformatname : windows_sys::core::PCWSTR, lpdwformatnamelength : *mut u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("mqrt.dll" "system" fn MQFreeMemory(pvmemory : *mut core::ffi::c_void));
...
windows_link::link!("mqrt.dll" "system" fn MQGetSecurityContext(lpcertbuffer : *mut core::ffi::c_void, dwcertbufferlength : u32, phsecuritycontext : *mut super::super::Foundation:: HANDLE) -> windows_sys::core::HRESULT);
...
windows_link::link!("mqrt.dll" "system" fn MQInstanceToFormatName(pguid : *mut windows_sys::core::GUID, lpwcsformatname : windows_sys::core::PCWSTR, lpdwformatnamelength : *mut u32) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
windows_link::link!("mqrt.dll" "system" fn MQPathNameToFormatName(lpwcspathname : windows_sys::core::PCWSTR, lpwcsformatname : windows_sys::core::PCWSTR, lpdwformatnamelength : *mut u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("mqrt.dll" "system" fn MQSendMessage(hdestinationqueue : isize, pmessageprops : *mut MQMSGPROPS, ptransaction : * mut core::ffi::c_void) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
