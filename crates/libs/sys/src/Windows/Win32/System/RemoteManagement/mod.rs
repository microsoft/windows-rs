::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`*"] fn WSManCloseCommand(commandhandle : WSMAN_COMMAND_HANDLE, flags : u32, r#async : *const WSMAN_SHELL_ASYNC) -> ());
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`*"] fn WSManCloseOperation(operationhandle : WSMAN_OPERATION_HANDLE, flags : u32) -> u32);
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`*"] fn WSManCloseSession(session : WSMAN_SESSION_HANDLE, flags : u32) -> u32);
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`*"] fn WSManCloseShell(shellhandle : WSMAN_SHELL_HANDLE, flags : u32, r#async : *const WSMAN_SHELL_ASYNC) -> ());
#[cfg(feature = "Win32_Foundation")]
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`, `\"Win32_Foundation\"`*"] fn WSManConnectShell(session : WSMAN_SESSION_HANDLE, flags : u32, resourceuri : ::windows_sys::core::PCWSTR, shellid : ::windows_sys::core::PCWSTR, options : *const WSMAN_OPTION_SET, connectxml : *const WSMAN_DATA, r#async : *const WSMAN_SHELL_ASYNC, shell : *mut WSMAN_SHELL_HANDLE) -> ());
#[cfg(feature = "Win32_Foundation")]
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`, `\"Win32_Foundation\"`*"] fn WSManConnectShellCommand(shell : WSMAN_SHELL_HANDLE, flags : u32, commandid : ::windows_sys::core::PCWSTR, options : *const WSMAN_OPTION_SET, connectxml : *const WSMAN_DATA, r#async : *const WSMAN_SHELL_ASYNC, command : *mut WSMAN_COMMAND_HANDLE) -> ());
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`*"] fn WSManCreateSession(apihandle : WSMAN_API_HANDLE, connection : ::windows_sys::core::PCWSTR, flags : u32, serverauthenticationcredentials : *const WSMAN_AUTHENTICATION_CREDENTIALS, proxyinfo : *const WSMAN_PROXY_INFO, session : *mut WSMAN_SESSION_HANDLE) -> u32);
#[cfg(feature = "Win32_Foundation")]
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`, `\"Win32_Foundation\"`*"] fn WSManCreateShell(session : WSMAN_SESSION_HANDLE, flags : u32, resourceuri : ::windows_sys::core::PCWSTR, startupinfo : *const WSMAN_SHELL_STARTUP_INFO_V11, options : *const WSMAN_OPTION_SET, createxml : *const WSMAN_DATA, r#async : *const WSMAN_SHELL_ASYNC, shell : *mut WSMAN_SHELL_HANDLE) -> ());
#[cfg(feature = "Win32_Foundation")]
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`, `\"Win32_Foundation\"`*"] fn WSManCreateShellEx(session : WSMAN_SESSION_HANDLE, flags : u32, resourceuri : ::windows_sys::core::PCWSTR, shellid : ::windows_sys::core::PCWSTR, startupinfo : *const WSMAN_SHELL_STARTUP_INFO_V11, options : *const WSMAN_OPTION_SET, createxml : *const WSMAN_DATA, r#async : *const WSMAN_SHELL_ASYNC, shell : *mut WSMAN_SHELL_HANDLE) -> ());
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`*"] fn WSManDeinitialize(apihandle : WSMAN_API_HANDLE, flags : u32) -> u32);
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`*"] fn WSManDisconnectShell(shell : WSMAN_SHELL_HANDLE, flags : u32, disconnectinfo : *const WSMAN_SHELL_DISCONNECT_INFO, r#async : *const WSMAN_SHELL_ASYNC) -> ());
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`*"] fn WSManGetErrorMessage(apihandle : WSMAN_API_HANDLE, flags : u32, languagecode : ::windows_sys::core::PCWSTR, errorcode : u32, messagelength : u32, message : ::windows_sys::core::PWSTR, messagelengthused : *mut u32) -> u32);
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`*"] fn WSManGetSessionOptionAsDword(session : WSMAN_SESSION_HANDLE, option : WSManSessionOption, value : *mut u32) -> u32);
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`*"] fn WSManGetSessionOptionAsString(session : WSMAN_SESSION_HANDLE, option : WSManSessionOption, stringlength : u32, string : ::windows_sys::core::PWSTR, stringlengthused : *mut u32) -> u32);
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`*"] fn WSManInitialize(flags : u32, apihandle : *mut WSMAN_API_HANDLE) -> u32);
#[cfg(feature = "Win32_Foundation")]
...
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`*"] fn WSManReceiveShellOutput(shell : WSMAN_SHELL_HANDLE, command : WSMAN_COMMAND_HANDLE, flags : u32, desiredstreamset : *const WSMAN_STREAM_ID_SET, r#async : *const WSMAN_SHELL_ASYNC, receiveoperation : *mut WSMAN_OPERATION_HANDLE) -> ());
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`*"] fn WSManReconnectShell(shell : WSMAN_SHELL_HANDLE, flags : u32, r#async : *const WSMAN_SHELL_ASYNC) -> ());
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`*"] fn WSManReconnectShellCommand(commandhandle : WSMAN_COMMAND_HANDLE, flags : u32, r#async : *const WSMAN_SHELL_ASYNC) -> ());
#[cfg(feature = "Win32_Foundation")]
...
#[cfg(feature = "Win32_Foundation")]
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`, `\"Win32_Foundation\"`*"] fn WSManRunShellCommandEx(shell : WSMAN_SHELL_HANDLE, flags : u32, commandid : ::windows_sys::core::PCWSTR, commandline : ::windows_sys::core::PCWSTR, args : *const WSMAN_COMMAND_ARG_SET, options : *const WSMAN_OPTION_SET, r#async : *const WSMAN_SHELL_ASYNC, command : *mut WSMAN_COMMAND_HANDLE) -> ());
#[cfg(feature = "Win32_Foundation")]
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`, `\"Win32_Foundation\"`*"] fn WSManSendShellInput(shell : WSMAN_SHELL_HANDLE, command : WSMAN_COMMAND_HANDLE, flags : u32, streamid : ::windows_sys::core::PCWSTR, streamdata : *const WSMAN_DATA, endofstream : super::super::Foundation:: BOOL, r#async : *const WSMAN_SHELL_ASYNC, sendoperation : *mut WSMAN_OPERATION_HANDLE) -> ());
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`*"] fn WSManSetSessionOption(session : WSMAN_SESSION_HANDLE, option : WSManSessionOption, data : *const WSMAN_DATA) -> u32);
::windows_targets::link!("wsmsvc.dll" "system" #[doc = "*Required features: `\"Win32_System_RemoteManagement\"`*"] fn WSManSignalShell(shell : WSMAN_SHELL_HANDLE, command : WSMAN_COMMAND_HANDLE, flags : u32, code : ::windows_sys::core::PCWSTR, r#async : *const WSMAN_SHELL_ASYNC, signaloperation : *mut WSMAN_OPERATION_HANDLE) -> ());
