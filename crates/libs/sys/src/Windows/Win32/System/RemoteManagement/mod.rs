pub type WSManCloseCommand = unsafe extern "system" fn(commandhandle: WSMAN_COMMAND_HANDLE, flags: u32, r#async: *const WSMAN_SHELL_ASYNC);
...
pub type WSManCloseOperation = unsafe extern "system" fn(operationhandle: WSMAN_OPERATION_HANDLE, flags: u32) -> u32;
windows_link::link!("wsmsvc.dll" "system" fn WSManCloseOperation(operationhandle : WSMAN_OPERATION_HANDLE, flags : u32) -> u32);
pub type WSManCloseSession = unsafe extern "system" fn(session: WSMAN_SESSION_HANDLE, flags: u32) -> u32;
windows_link::link!("wsmsvc.dll" "system" fn WSManCloseSession(session : WSMAN_SESSION_HANDLE, flags : u32) -> u32);
pub type WSManCloseShell = unsafe extern "system" fn(shellhandle: WSMAN_SHELL_HANDLE, flags: u32, r#async: *const WSMAN_SHELL_ASYNC);
...
pub type WSManConnectShell = unsafe extern "system" fn(session: WSMAN_SESSION_HANDLE, flags: u32, resourceuri: windows_sys::core::PCWSTR, shellid: windows_sys::core::PCWSTR, options: *const WSMAN_OPTION_SET, connectxml: *const WSMAN_DATA, r#async: *const WSMAN_SHELL_ASYNC, shell: *mut WSMAN_SHELL_HANDLE);
...
pub type WSManConnectShellCommand = unsafe extern "system" fn(shell: WSMAN_SHELL_HANDLE, flags: u32, commandid: windows_sys::core::PCWSTR, options: *const WSMAN_OPTION_SET, connectxml: *const WSMAN_DATA, r#async: *const WSMAN_SHELL_ASYNC, command: *mut WSMAN_COMMAND_HANDLE);
...
pub type WSManCreateSession = unsafe extern "system" fn(apihandle: WSMAN_API_HANDLE, connection: windows_sys::core::PCWSTR, flags: u32, serverauthenticationcredentials: *const WSMAN_AUTHENTICATION_CREDENTIALS, proxyinfo: *const WSMAN_PROXY_INFO, session: *mut WSMAN_SESSION_HANDLE) -> u32;
...
pub type WSManCreateShell = unsafe extern "system" fn(session: WSMAN_SESSION_HANDLE, flags: u32, resourceuri: windows_sys::core::PCWSTR, startupinfo: *const WSMAN_SHELL_STARTUP_INFO_V11, options: *const WSMAN_OPTION_SET, createxml: *const WSMAN_DATA, r#async: *const WSMAN_SHELL_ASYNC, shell: *mut WSMAN_SHELL_HANDLE);
...
pub type WSManCreateShellEx = unsafe extern "system" fn(session: WSMAN_SESSION_HANDLE, flags: u32, resourceuri: windows_sys::core::PCWSTR, shellid: windows_sys::core::PCWSTR, startupinfo: *const WSMAN_SHELL_STARTUP_INFO_V11, options: *const WSMAN_OPTION_SET, createxml: *const WSMAN_DATA, r#async: *const WSMAN_SHELL_ASYNC, shell: *mut WSMAN_SHELL_HANDLE);
...
pub type WSManDeinitialize = unsafe extern "system" fn(apihandle: WSMAN_API_HANDLE, flags: u32) -> u32;
windows_link::link!("wsmsvc.dll" "system" fn WSManDeinitialize(apihandle : WSMAN_API_HANDLE, flags : u32) -> u32);
pub type WSManDisconnectShell = unsafe extern "system" fn(shell: WSMAN_SHELL_HANDLE, flags: u32, disconnectinfo: *const WSMAN_SHELL_DISCONNECT_INFO, r#async: *const WSMAN_SHELL_ASYNC);
...
pub type WSManGetErrorMessage = unsafe extern "system" fn(apihandle: WSMAN_API_HANDLE, flags: u32, languagecode: windows_sys::core::PCWSTR, errorcode: u32, messagelength: u32, message: windows_sys::core::PWSTR, messagelengthused: *mut u32) -> u32;
...
pub type WSManGetSessionOptionAsDword = unsafe extern "system" fn(session: WSMAN_SESSION_HANDLE, option: WSManSessionOption, value: *mut u32) -> u32;
...
pub type WSManGetSessionOptionAsString = unsafe extern "system" fn(session: WSMAN_SESSION_HANDLE, option: WSManSessionOption, stringlength: u32, string: windows_sys::core::PWSTR, stringlengthused: *mut u32) -> u32;
...
pub type WSManInitialize = unsafe extern "system" fn(flags: u32, apihandle: *mut WSMAN_API_HANDLE) -> u32;
windows_link::link!("wsmsvc.dll" "system" fn WSManInitialize(flags : u32, apihandle : *mut WSMAN_API_HANDLE) -> u32);
pub type WSManPluginAuthzOperationComplete = unsafe extern "system" fn(senderdetails: *const WSMAN_SENDER_DETAILS, flags: u32, userauthorizationcontext: *const core::ffi::c_void, errorcode: u32, extendederrorinformation: windows_sys::core::PCWSTR) -> u32;
...
pub type WSManPluginAuthzQueryQuotaComplete = unsafe extern "system" fn(senderdetails: *const WSMAN_SENDER_DETAILS, flags: u32, quota: *const WSMAN_AUTHZ_QUOTA, errorcode: u32, extendederrorinformation: windows_sys::core::PCWSTR) -> u32;
...
pub type WSManPluginAuthzUserComplete = unsafe extern "system" fn(senderdetails: *const WSMAN_SENDER_DETAILS, flags: u32, userauthorizationcontext: *const core::ffi::c_void, impersonationtoken: super::super::Foundation::HANDLE, userisadministrator: windows_sys::core::BOOL, errorcode: u32, extendederrorinformation: windows_sys::core::PCWSTR) -> u32;
...
pub type WSManPluginFreeRequestDetails = unsafe extern "system" fn(requestdetails: *const WSMAN_PLUGIN_REQUEST) -> u32;
windows_link::link!("wsmsvc.dll" "system" fn WSManPluginFreeRequestDetails(requestdetails : *const WSMAN_PLUGIN_REQUEST) -> u32);
pub type WSManPluginGetConfiguration = unsafe extern "system" fn(plugincontext: *const core::ffi::c_void, flags: u32, data: *mut WSMAN_DATA) -> u32;
...
pub type WSManPluginGetOperationParameters = unsafe extern "system" fn(requestdetails: *const WSMAN_PLUGIN_REQUEST, flags: u32, data: *mut WSMAN_DATA) -> u32;
...
pub type WSManPluginOperationComplete = unsafe extern "system" fn(requestdetails: *const WSMAN_PLUGIN_REQUEST, flags: u32, errorcode: u32, extendedinformation: windows_sys::core::PCWSTR) -> u32;
...
pub type WSManPluginReceiveResult = unsafe extern "system" fn(requestdetails: *const WSMAN_PLUGIN_REQUEST, flags: u32, stream: windows_sys::core::PCWSTR, streamresult: *const WSMAN_DATA, commandstate: windows_sys::core::PCWSTR, exitcode: u32) -> u32;
...
pub type WSManPluginReportCompletion = unsafe extern "system" fn(plugincontext: *const core::ffi::c_void, flags: u32) -> u32;
windows_link::link!("wsmsvc.dll" "system" fn WSManPluginReportCompletion(plugincontext : *const core::ffi::c_void, flags : u32) -> u32);
pub type WSManPluginReportContext = unsafe extern "system" fn(requestdetails: *const WSMAN_PLUGIN_REQUEST, flags: u32, context: *const core::ffi::c_void) -> u32;
...
pub type WSManReceiveShellOutput = unsafe extern "system" fn(shell: WSMAN_SHELL_HANDLE, command: WSMAN_COMMAND_HANDLE, flags: u32, desiredstreamset: *const WSMAN_STREAM_ID_SET, r#async: *const WSMAN_SHELL_ASYNC, receiveoperation: *mut WSMAN_OPERATION_HANDLE);
...
pub type WSManReconnectShell = unsafe extern "system" fn(shell: WSMAN_SHELL_HANDLE, flags: u32, r#async: *const WSMAN_SHELL_ASYNC);
...
pub type WSManReconnectShellCommand = unsafe extern "system" fn(commandhandle: WSMAN_COMMAND_HANDLE, flags: u32, r#async: *const WSMAN_SHELL_ASYNC);
...
pub type WSManRunShellCommand = unsafe extern "system" fn(shell: WSMAN_SHELL_HANDLE, flags: u32, commandline: windows_sys::core::PCWSTR, args: *const WSMAN_COMMAND_ARG_SET, options: *const WSMAN_OPTION_SET, r#async: *const WSMAN_SHELL_ASYNC, command: *mut WSMAN_COMMAND_HANDLE);
...
pub type WSManRunShellCommandEx = unsafe extern "system" fn(shell: WSMAN_SHELL_HANDLE, flags: u32, commandid: windows_sys::core::PCWSTR, commandline: windows_sys::core::PCWSTR, args: *const WSMAN_COMMAND_ARG_SET, options: *const WSMAN_OPTION_SET, r#async: *const WSMAN_SHELL_ASYNC, command: *mut WSMAN_COMMAND_HANDLE);
...
pub type WSManSendShellInput = unsafe extern "system" fn(shell: WSMAN_SHELL_HANDLE, command: WSMAN_COMMAND_HANDLE, flags: u32, streamid: windows_sys::core::PCWSTR, streamdata: *const WSMAN_DATA, endofstream: windows_sys::core::BOOL, r#async: *const WSMAN_SHELL_ASYNC, sendoperation: *mut WSMAN_OPERATION_HANDLE);
...
pub type WSManSetSessionOption = unsafe extern "system" fn(session: WSMAN_SESSION_HANDLE, option: WSManSessionOption, data: *const WSMAN_DATA) -> u32;
...
pub type WSManSignalShell = unsafe extern "system" fn(shell: WSMAN_SHELL_HANDLE, command: WSMAN_COMMAND_HANDLE, flags: u32, code: windows_sys::core::PCWSTR, r#async: *const WSMAN_SHELL_ASYNC, signaloperation: *mut WSMAN_OPERATION_HANDLE);
