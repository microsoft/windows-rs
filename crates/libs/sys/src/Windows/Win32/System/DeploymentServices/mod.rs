pub type PxeAsyncRecvDone = unsafe extern "system" fn(hclientrequest: super::super::Foundation::HANDLE, action: u32) -> u32;
windows_link::link!("wdspxe.dll" "system" fn PxeAsyncRecvDone(hclientrequest : super::super::Foundation::HANDLE, action : u32) -> u32);
pub type PxeDhcpAppendOption = unsafe extern "system" fn(preplypacket: *mut core::ffi::c_void, umaxreplypacketlen: u32, pureplypacketlen: *mut u32, boption: u8, boptionlen: u8, pvalue: *const core::ffi::c_void) -> u32;
...
pub type PxeDhcpAppendOptionRaw = unsafe extern "system" fn(preplypacket: *mut core::ffi::c_void, umaxreplypacketlen: u32, pureplypacketlen: *mut u32, ubufferlen: u16, pbuffer: *const core::ffi::c_void) -> u32;
...
pub type PxeDhcpGetOptionValue = unsafe extern "system" fn(ppacket: *const core::ffi::c_void, upacketlen: u32, uinstance: u32, boption: u8, pboptionlen: *mut u8, ppoptionvalue: *mut *mut core::ffi::c_void) -> u32;
...
pub type PxeDhcpGetVendorOptionValue = unsafe extern "system" fn(ppacket: *const core::ffi::c_void, upacketlen: u32, boption: u8, uinstance: u32, pboptionlen: *mut u8, ppoptionvalue: *mut *mut core::ffi::c_void) -> u32;
...
pub type PxeDhcpInitialize = unsafe extern "system" fn(precvpacket: *const core::ffi::c_void, urecvpacketlen: u32, preplypacket: *mut core::ffi::c_void, umaxreplypacketlen: u32, pureplypacketlen: *mut u32) -> u32;
...
pub type PxeDhcpIsValid = unsafe extern "system" fn(ppacket: *const core::ffi::c_void, upacketlen: u32, brequestpacket: windows_sys::core::BOOL, pbpxeoptionpresent: *mut windows_sys::core::BOOL) -> u32;
...
pub type PxeDhcpv6AppendOption = unsafe extern "system" fn(preply: *mut core::ffi::c_void, cbreply: u32, pcbreplyused: *mut u32, woptiontype: u16, cboption: u16, poption: *const core::ffi::c_void) -> u32;
...
pub type PxeDhcpv6AppendOptionRaw = unsafe extern "system" fn(preply: *mut core::ffi::c_void, cbreply: u32, pcbreplyused: *mut u32, cbbuffer: u16, pbuffer: *const core::ffi::c_void) -> u32;
...
pub type PxeDhcpv6CreateRelayRepl = unsafe extern "system" fn(prelaymessages: *const PXE_DHCPV6_NESTED_RELAY_MESSAGE, nrelaymessages: u32, pinnerpacket: *const u8, cbinnerpacket: u32, preplybuffer: *mut core::ffi::c_void, cbreplybuffer: u32, pcbreplybuffer: *mut u32) -> u32;
...
pub type PxeDhcpv6GetOptionValue = unsafe extern "system" fn(ppacket: *const core::ffi::c_void, upacketlen: u32, uinstance: u32, woption: u16, pwoptionlen: *mut u16, ppoptionvalue: *mut *mut core::ffi::c_void) -> u32;
...
pub type PxeDhcpv6GetVendorOptionValue = unsafe extern "system" fn(ppacket: *const core::ffi::c_void, upacketlen: u32, dwenterprisenumber: u32, woption: u16, uinstance: u32, pwoptionlen: *mut u16, ppoptionvalue: *mut *mut core::ffi::c_void) -> u32;
...
pub type PxeDhcpv6Initialize = unsafe extern "system" fn(prequest: *const core::ffi::c_void, cbrequest: u32, preply: *mut core::ffi::c_void, cbreply: u32, pcbreplyused: *mut u32) -> u32;
...
pub type PxeDhcpv6IsValid = unsafe extern "system" fn(ppacket: *const core::ffi::c_void, upacketlen: u32, brequestpacket: windows_sys::core::BOOL, pbpxeoptionpresent: *mut windows_sys::core::BOOL) -> u32;
...
pub type PxeDhcpv6ParseRelayForw = unsafe extern "system" fn(prelayforwpacket: *const core::ffi::c_void, urelayforwpacketlen: u32, prelaymessages: *mut PXE_DHCPV6_NESTED_RELAY_MESSAGE, nrelaymessages: u32, pnrelaymessages: *mut u32, ppinnerpacket: *mut *mut u8, pcbinnerpacket: *mut u32) -> u32;
...
pub type PxeGetServerInfo = unsafe extern "system" fn(uinfotype: u32, pbuffer: *mut core::ffi::c_void, ubufferlen: u32) -> u32;
windows_link::link!("wdspxe.dll" "system" fn PxeGetServerInfo(uinfotype : u32, pbuffer : *mut core::ffi::c_void, ubufferlen : u32) -> u32);
pub type PxeGetServerInfoEx = unsafe extern "system" fn(uinfotype: u32, pbuffer: *mut core::ffi::c_void, ubufferlen: u32, pubufferused: *mut u32) -> u32;
...
pub type PxePacketAllocate = unsafe extern "system" fn(hprovider: super::super::Foundation::HANDLE, hclientrequest: super::super::Foundation::HANDLE, usize: u32) -> *mut core::ffi::c_void;
...
pub type PxePacketFree = unsafe extern "system" fn(hprovider: super::super::Foundation::HANDLE, hclientrequest: super::super::Foundation::HANDLE, ppacket: *const core::ffi::c_void) -> u32;
...
pub type PxeProviderEnumClose = unsafe extern "system" fn(henum: super::super::Foundation::HANDLE) -> u32;
windows_link::link!("wdspxe.dll" "system" fn PxeProviderEnumClose(henum : super::super::Foundation::HANDLE) -> u32);
pub type PxeProviderEnumFirst = unsafe extern "system" fn(phenum: *mut super::super::Foundation::HANDLE) -> u32;
windows_link::link!("wdspxe.dll" "system" fn PxeProviderEnumFirst(phenum : *mut super::super::Foundation::HANDLE) -> u32);
pub type PxeProviderEnumNext = unsafe extern "system" fn(henum: super::super::Foundation::HANDLE, ppprovider: *mut *mut PXE_PROVIDER) -> u32;
...
pub type PxeProviderFreeInfo = unsafe extern "system" fn(pprovider: *const PXE_PROVIDER) -> u32;
windows_link::link!("wdspxe.dll" "system" fn PxeProviderFreeInfo(pprovider : *const PXE_PROVIDER) -> u32);
pub type PxeProviderQueryIndex = unsafe extern "system" fn(pszprovidername: windows_sys::core::PCWSTR, puindex: *mut u32) -> u32;
...
pub type PxeProviderRegister = unsafe extern "system" fn(pszprovidername: windows_sys::core::PCWSTR, pszmodulepath: windows_sys::core::PCWSTR, index: u32, biscritical: windows_sys::core::BOOL, phproviderkey: *mut super::Registry::HKEY) -> u32;
#[cfg(feature = "Win32_System_Registry")]
...
pub type PxeProviderSetAttribute = unsafe extern "system" fn(hprovider: super::super::Foundation::HANDLE, attribute: u32, pparameterbuffer: *const core::ffi::c_void, uparamlen: u32) -> u32;
...
pub type PxeProviderUnRegister = unsafe extern "system" fn(pszprovidername: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("wdspxe.dll" "system" fn PxeProviderUnRegister(pszprovidername : windows_sys::core::PCWSTR) -> u32);
pub type PxeRegisterCallback = unsafe extern "system" fn(hprovider: super::super::Foundation::HANDLE, callbacktype: u32, pcallbackfunction: *const core::ffi::c_void, pcontext: *const core::ffi::c_void) -> u32;
...
pub type PxeSendReply = unsafe extern "system" fn(hclientrequest: super::super::Foundation::HANDLE, ppacket: *const core::ffi::c_void, upacketlen: u32, paddress: *const PXE_ADDRESS) -> u32;
...
pub type PxeTrace = unsafe extern "C" fn(hprovider: super::super::Foundation::HANDLE, severity: u32, pszformat: windows_sys::core::PCWSTR, ...) -> u32;
...
pub type PxeTraceV = unsafe extern "system" fn(hprovider: super::super::Foundation::HANDLE, severity: u32, pszformat: windows_sys::core::PCWSTR, params: *const i8) -> u32;
...
pub type WdsBpAddOption = unsafe extern "system" fn(hhandle: super::super::Foundation::HANDLE, uoption: u32, uvaluelen: u32, pvalue: *const core::ffi::c_void) -> u32;
...
pub type WdsBpCloseHandle = unsafe extern "system" fn(hhandle: super::super::Foundation::HANDLE) -> u32;
windows_link::link!("wdsbp.dll" "system" fn WdsBpCloseHandle(hhandle : super::super::Foundation::HANDLE) -> u32);
pub type WdsBpGetOptionBuffer = unsafe extern "system" fn(hhandle: super::super::Foundation::HANDLE, ubufferlen: u32, pbuffer: *mut core::ffi::c_void, pubytes: *mut u32) -> u32;
...
pub type WdsBpInitialize = unsafe extern "system" fn(bpackettype: u8, phhandle: *mut super::super::Foundation::HANDLE) -> u32;
windows_link::link!("wdsbp.dll" "system" fn WdsBpInitialize(bpackettype : u8, phhandle : *mut super::super::Foundation::HANDLE) -> u32);
pub type WdsBpParseInitialize = unsafe extern "system" fn(ppacket: *const core::ffi::c_void, upacketlen: u32, pbpackettype: *mut u8, phhandle: *mut super::super::Foundation::HANDLE) -> u32;
...
pub type WdsBpParseInitializev6 = unsafe extern "system" fn(ppacket: *const core::ffi::c_void, upacketlen: u32, pbpackettype: *mut u8, phhandle: *mut super::super::Foundation::HANDLE) -> u32;
...
pub type WdsBpQueryOption = unsafe extern "system" fn(hhandle: super::super::Foundation::HANDLE, uoption: u32, uvaluelen: u32, pvalue: *mut core::ffi::c_void, pubytes: *mut u32) -> u32;
...
pub type WdsCliAuthorizeSession = unsafe extern "system" fn(hsession: super::super::Foundation::HANDLE, pcred: *const WDS_CLI_CRED) -> windows_sys::core::HRESULT;
...
pub type WdsCliCancelTransfer = unsafe extern "system" fn(htransfer: super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type WdsCliClose = unsafe extern "system" fn(handle: super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("wdsclientapi.dll" "system" fn WdsCliClose(handle : super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT);
pub type WdsCliCreateSession = unsafe extern "system" fn(pwszserver: windows_sys::core::PCWSTR, pcred: *const WDS_CLI_CRED, phsession: *mut super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type WdsCliFindFirstImage = unsafe extern "system" fn(hsession: super::super::Foundation::HANDLE, phfindhandle: *mut super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type WdsCliFindNextImage = unsafe extern "system" fn(handle: super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type WdsCliFreeStringArray = unsafe extern "system" fn(ppwszarray: *mut windows_sys::core::PWSTR, ulcount: u32) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetDriverQueryXml = unsafe extern "system" fn(pwszwindirpath: windows_sys::core::PCWSTR, ppwszdriverquery: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetEnumerationFlags = unsafe extern "system" fn(handle: super::super::Foundation::HANDLE, pdwflags: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImageArchitecture = unsafe extern "system" fn(hifh: super::super::Foundation::HANDLE, pdwvalue: *mut CPU_ARCHITECTURE) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImageDescription = unsafe extern "system" fn(hifh: super::super::Foundation::HANDLE, ppwszvalue: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImageFiles = unsafe extern "system" fn(hifh: super::super::Foundation::HANDLE, pppwszfiles: *mut *mut windows_sys::core::PWSTR, pdwcount: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImageGroup = unsafe extern "system" fn(hifh: super::super::Foundation::HANDLE, ppwszvalue: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImageHalName = unsafe extern "system" fn(hifh: super::super::Foundation::HANDLE, ppwszvalue: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImageHandleFromFindHandle = unsafe extern "system" fn(findhandle: super::super::Foundation::HANDLE, phimagehandle: *mut super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImageHandleFromTransferHandle = unsafe extern "system" fn(htransfer: super::super::Foundation::HANDLE, phimagehandle: *mut super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImageIndex = unsafe extern "system" fn(hifh: super::super::Foundation::HANDLE, pdwvalue: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImageLanguage = unsafe extern "system" fn(hifh: super::super::Foundation::HANDLE, ppwszvalue: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImageLanguages = unsafe extern "system" fn(hifh: super::super::Foundation::HANDLE, pppszvalues: *mut *mut *mut i8, pdwnumvalues: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImageLastModifiedTime = unsafe extern "system" fn(hifh: super::super::Foundation::HANDLE, ppsystimevalue: *mut *mut super::super::Foundation::SYSTEMTIME) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImageName = unsafe extern "system" fn(hifh: super::super::Foundation::HANDLE, ppwszvalue: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImageNamespace = unsafe extern "system" fn(hifh: super::super::Foundation::HANDLE, ppwszvalue: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImageParameter = unsafe extern "system" fn(hifh: super::super::Foundation::HANDLE, paramtype: WDS_CLI_IMAGE_PARAM_TYPE, presponse: *mut core::ffi::c_void, uresponselen: u32) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImagePath = unsafe extern "system" fn(hifh: super::super::Foundation::HANDLE, ppwszvalue: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImageSize = unsafe extern "system" fn(hifh: super::super::Foundation::HANDLE, pullvalue: *mut u64) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImageType = unsafe extern "system" fn(hifh: super::super::Foundation::HANDLE, pimagetype: *mut WDS_CLI_IMAGE_TYPE) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetImageVersion = unsafe extern "system" fn(hifh: super::super::Foundation::HANDLE, ppwszvalue: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type WdsCliGetTransferSize = unsafe extern "system" fn(hifh: super::super::Foundation::HANDLE, pullvalue: *mut u64) -> windows_sys::core::HRESULT;
...
pub type WdsCliInitializeLog = unsafe extern "system" fn(hsession: super::super::Foundation::HANDLE, ulclientarchitecture: CPU_ARCHITECTURE, pwszclientid: windows_sys::core::PCWSTR, pwszclientaddress: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type WdsCliLog = unsafe extern "C" fn(hsession: super::super::Foundation::HANDLE, ulloglevel: u32, ulmessagecode: u32, ...) -> windows_sys::core::HRESULT;
...
pub type WdsCliObtainDriverPackages = unsafe extern "system" fn(himage: super::super::Foundation::HANDLE, ppwszservername: *mut windows_sys::core::PWSTR, pppwszdriverpackages: *mut *mut windows_sys::core::PWSTR, pulcount: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WdsCliObtainDriverPackagesEx = unsafe extern "system" fn(hsession: super::super::Foundation::HANDLE, pwszmachineinfo: windows_sys::core::PCWSTR, ppwszservername: *mut windows_sys::core::PWSTR, pppwszdriverpackages: *mut *mut windows_sys::core::PWSTR, pulcount: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WdsCliTransferImage = unsafe extern "system" fn(himage: super::super::Foundation::HANDLE, pwszlocalpath: windows_sys::core::PCWSTR, dwflags: u32, dwreserved: u32, pfnwdsclicallback: PFN_WdsCliCallback, pvuserdata: *const core::ffi::c_void, phtransfer: *mut super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type WdsCliWaitForTransfer = unsafe extern "system" fn(htransfer: super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type WdsTransportClientAddRefBuffer = unsafe extern "system" fn(pvbuffer: *const core::ffi::c_void) -> u32;
windows_link::link!("wdstptc.dll" "system" fn WdsTransportClientAddRefBuffer(pvbuffer : *const core::ffi::c_void) -> u32);
pub type WdsTransportClientCancelSession = unsafe extern "system" fn(hsessionkey: super::super::Foundation::HANDLE) -> u32;
windows_link::link!("wdstptc.dll" "system" fn WdsTransportClientCancelSession(hsessionkey : super::super::Foundation::HANDLE) -> u32);
pub type WdsTransportClientCancelSessionEx = unsafe extern "system" fn(hsessionkey: super::super::Foundation::HANDLE, dwerrorcode: u32) -> u32;
...
pub type WdsTransportClientCloseSession = unsafe extern "system" fn(hsessionkey: super::super::Foundation::HANDLE) -> u32;
windows_link::link!("wdstptc.dll" "system" fn WdsTransportClientCloseSession(hsessionkey : super::super::Foundation::HANDLE) -> u32);
pub type WdsTransportClientCompleteReceive = unsafe extern "system" fn(hsessionkey: super::super::Foundation::HANDLE, ulsize: u32, pulloffset: *const u64) -> u32;
...
pub type WdsTransportClientInitialize = unsafe extern "system" fn() -> u32;
windows_link::link!("wdstptc.dll" "system" fn WdsTransportClientInitialize() -> u32);
pub type WdsTransportClientInitializeSession = unsafe extern "system" fn(psessionrequest: *const WDS_TRANSPORTCLIENT_REQUEST, pcallerdata: *const core::ffi::c_void, hsessionkey: *mut super::super::Foundation::HANDLE) -> u32;
...
pub type WdsTransportClientQueryStatus = unsafe extern "system" fn(hsessionkey: super::super::Foundation::HANDLE, pustatus: *mut u32, puerrorcode: *mut u32) -> u32;
...
pub type WdsTransportClientRegisterCallback = unsafe extern "system" fn(hsessionkey: super::super::Foundation::HANDLE, callbackid: TRANSPORTCLIENT_CALLBACK_ID, pfncallback: *const core::ffi::c_void) -> u32;
...
pub type WdsTransportClientReleaseBuffer = unsafe extern "system" fn(pvbuffer: *const core::ffi::c_void) -> u32;
windows_link::link!("wdstptc.dll" "system" fn WdsTransportClientReleaseBuffer(pvbuffer : *const core::ffi::c_void) -> u32);
pub type WdsTransportClientShutdown = unsafe extern "system" fn() -> u32;
windows_link::link!("wdstptc.dll" "system" fn WdsTransportClientShutdown() -> u32);
pub type WdsTransportClientStartSession = unsafe extern "system" fn(hsessionkey: super::super::Foundation::HANDLE) -> u32;
windows_link::link!("wdstptc.dll" "system" fn WdsTransportClientStartSession(hsessionkey : super::super::Foundation::HANDLE) -> u32);
pub type WdsTransportClientWaitForCompletion = unsafe extern "system" fn(hsessionkey: super::super::Foundation::HANDLE, utimeout: u32) -> u32;
...
pub type WdsTransportServerAllocateBuffer = unsafe extern "system" fn(hprovider: super::super::Foundation::HANDLE, ulbuffersize: u32) -> *mut core::ffi::c_void;
...
pub type WdsTransportServerCompleteRead = unsafe extern "system" fn(hprovider: super::super::Foundation::HANDLE, ulbytesread: u32, pvuserdata: *const core::ffi::c_void, hreadresult: windows_sys::core::HRESULT) -> windows_sys::core::HRESULT;
...
pub type WdsTransportServerFreeBuffer = unsafe extern "system" fn(hprovider: super::super::Foundation::HANDLE, pvbuffer: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WdsTransportServerRegisterCallback = unsafe extern "system" fn(hprovider: super::super::Foundation::HANDLE, callbackid: TRANSPORTPROVIDER_CALLBACK_ID, pfncallback: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WdsTransportServerTrace = unsafe extern "C" fn(hprovider: super::super::Foundation::HANDLE, severity: u32, pwszformat: windows_sys::core::PCWSTR, ...) -> windows_sys::core::HRESULT;
...
pub type WdsTransportServerTraceV = unsafe extern "system" fn(hprovider: super::super::Foundation::HANDLE, severity: u32, pwszformat: windows_sys::core::PCWSTR, params: *const i8) -> windows_sys::core::HRESULT;
