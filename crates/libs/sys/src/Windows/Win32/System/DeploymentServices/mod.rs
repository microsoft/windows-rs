...
pub const EVT_WDSMCS_E_CP_CALLBACKS_NOT_REG: ::windows_sys::core::HRESULT = 0xC1210254u32 as _;
pub const EVT_WDSMCS_E_CP_CLOSE_INSTANCE_FAILED: ::windows_sys::core::HRESULT = 0xC1210258u32 as _;
pub const EVT_WDSMCS_E_CP_DLL_LOAD_FAILED: ::windows_sys::core::HRESULT = 0xC1210250u32 as _;
pub const EVT_WDSMCS_E_CP_DLL_LOAD_FAILED_CRITICAL: ::windows_sys::core::HRESULT = 0xC121025Bu32 as _;
pub const EVT_WDSMCS_E_CP_INCOMPATIBLE_SERVER_VERSION: ::windows_sys::core::HRESULT = 0xC1210253u32 as _;
pub const EVT_WDSMCS_E_CP_INIT_FUNC_FAILED: ::windows_sys::core::HRESULT = 0xC1210252u32 as _;
pub const EVT_WDSMCS_E_CP_INIT_FUNC_MISSING: ::windows_sys::core::HRESULT = 0xC1210251u32 as _;
pub const EVT_WDSMCS_E_CP_MEMORY_LEAK: ::windows_sys::core::HRESULT = 0xC1210256u32 as _;
pub const EVT_WDSMCS_E_CP_OPEN_CONTENT_FAILED: ::windows_sys::core::HRESULT = 0xC1210259u32 as _;
pub const EVT_WDSMCS_E_CP_OPEN_INSTANCE_FAILED: ::windows_sys::core::HRESULT = 0xC1210257u32 as _;
pub const EVT_WDSMCS_E_CP_SHUTDOWN_FUNC_FAILED: ::windows_sys::core::HRESULT = 0xC1210255u32 as _;
pub const EVT_WDSMCS_E_DUPLICATE_MULTICAST_ADDR: ::windows_sys::core::HRESULT = 0xC1210202u32 as _;
pub const EVT_WDSMCS_E_NON_WDS_DUPLICATE_MULTICAST_ADDR: ::windows_sys::core::HRESULT = 0xC1210203u32 as _;
pub const EVT_WDSMCS_E_NSREG_CONTENT_PROVIDER_NOT_REG: ::windows_sys::core::HRESULT = 0xC1210301u32 as _;
pub const EVT_WDSMCS_E_NSREG_FAILURE: ::windows_sys::core::HRESULT = 0xC1210303u32 as _;
pub const EVT_WDSMCS_E_NSREG_NAMESPACE_EXISTS: ::windows_sys::core::HRESULT = 0xC1210302u32 as _;
pub const EVT_WDSMCS_E_NSREG_START_TIME_IN_PAST: ::windows_sys::core::HRESULT = 0xC1210300u32 as _;
pub const EVT_WDSMCS_E_PARAMETERS_READ_FAILED: ::windows_sys::core::HRESULT = 0xC1210201u32 as _;
pub const EVT_WDSMCS_S_PARAMETERS_READ: ::windows_sys::core::HRESULT = 0x41210200u32 as _;
pub const EVT_WDSMCS_W_CP_DLL_LOAD_FAILED_NOT_CRITICAL: ::windows_sys::core::HRESULT = 0x8121025Au32 as _;
...
pub const WDSMCCLIENT_CATEGORY: ::windows_sys::core::HRESULT = 0x2u32 as _;
pub const WDSMCSERVER_CATEGORY: ::windows_sys::core::HRESULT = 0x1u32 as _;
pub const WDSMCS_E_CLIENT_DOESNOT_SUPPORT_SECURITY_MODE: ::windows_sys::core::HRESULT = 0xC1210110u32 as _;
pub const WDSMCS_E_CLIENT_NOT_FOUND: ::windows_sys::core::HRESULT = 0xC1210104u32 as _;
pub const WDSMCS_E_CONTENT_NOT_FOUND: ::windows_sys::core::HRESULT = 0xC1210103u32 as _;
pub const WDSMCS_E_CONTENT_PROVIDER_NOT_FOUND: ::windows_sys::core::HRESULT = 0xC1210106u32 as _;
pub const WDSMCS_E_INCOMPATIBLE_VERSION: ::windows_sys::core::HRESULT = 0xC1210102u32 as _;
pub const WDSMCS_E_NAMESPACE_ALREADY_EXISTS: ::windows_sys::core::HRESULT = 0xC1210107u32 as _;
pub const WDSMCS_E_NAMESPACE_ALREADY_STARTED: ::windows_sys::core::HRESULT = 0xC1210109u32 as _;
pub const WDSMCS_E_NAMESPACE_NOT_FOUND: ::windows_sys::core::HRESULT = 0xC1210105u32 as _;
pub const WDSMCS_E_NAMESPACE_SHUTDOWN_IN_PROGRESS: ::windows_sys::core::HRESULT = 0xC1210108u32 as _;
pub const WDSMCS_E_NS_START_FAILED_NO_CLIENTS: ::windows_sys::core::HRESULT = 0xC121010Au32 as _;
pub const WDSMCS_E_PACKET_HAS_SECURITY: ::windows_sys::core::HRESULT = 0xC121010Eu32 as _;
pub const WDSMCS_E_PACKET_NOT_CHECKSUMED: ::windows_sys::core::HRESULT = 0xC121010Fu32 as _;
pub const WDSMCS_E_PACKET_NOT_HASHED: ::windows_sys::core::HRESULT = 0xC121010Cu32 as _;
pub const WDSMCS_E_PACKET_NOT_SIGNED: ::windows_sys::core::HRESULT = 0xC121010Du32 as _;
pub const WDSMCS_E_REQCALLBACKS_NOT_REG: ::windows_sys::core::HRESULT = 0xC1210101u32 as _;
pub const WDSMCS_E_SESSION_SHUTDOWN_IN_PROGRESS: ::windows_sys::core::HRESULT = 0xC1210100u32 as _;
pub const WDSMCS_E_START_TIME_IN_PAST: ::windows_sys::core::HRESULT = 0xC121010Bu32 as _;
pub const WDSTPC_E_ALREADY_COMPLETED: ::windows_sys::core::HRESULT = 0xC1220301u32 as _;
pub const WDSTPC_E_ALREADY_IN_LOWEST_SESSION: ::windows_sys::core::HRESULT = 0xC122030Au32 as _;
pub const WDSTPC_E_ALREADY_IN_PROGRESS: ::windows_sys::core::HRESULT = 0xC1220302u32 as _;
pub const WDSTPC_E_CALLBACKS_NOT_REG: ::windows_sys::core::HRESULT = 0xC1220300u32 as _;
pub const WDSTPC_E_CLIENT_DEMOTE_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC122030Bu32 as _;
pub const WDSTPC_E_KICKED_FAIL: ::windows_sys::core::HRESULT = 0xC1220307u32 as _;
pub const WDSTPC_E_KICKED_FALLBACK: ::windows_sys::core::HRESULT = 0xC1220306u32 as _;
pub const WDSTPC_E_KICKED_POLICY_NOT_MET: ::windows_sys::core::HRESULT = 0xC1220305u32 as _;
pub const WDSTPC_E_KICKED_UNKNOWN: ::windows_sys::core::HRESULT = 0xC1220308u32 as _;
pub const WDSTPC_E_MULTISTREAM_NOT_ENABLED: ::windows_sys::core::HRESULT = 0xC1220309u32 as _;
pub const WDSTPC_E_NOT_INITIALIZED: ::windows_sys::core::HRESULT = 0xC1220304u32 as _;
pub const WDSTPC_E_NO_IP4_INTERFACE: ::windows_sys::core::HRESULT = 0xC122030Cu32 as _;
pub const WDSTPC_E_UNKNOWN_ERROR: ::windows_sys::core::HRESULT = 0xC1220303u32 as _;
pub const WDSTPTC_E_WIM_APPLY_REQUIRES_REFERENCE_IMAGE: ::windows_sys::core::HRESULT = 0xC122030Du32 as _;
pub const WDSTPTMGMT_CATEGORY: ::windows_sys::core::HRESULT = 0x1u32 as _;
pub const WDSTPTMGMT_E_CANNOT_REFRESH_DIRTY_OBJECT: ::windows_sys::core::HRESULT = 0xC110010Fu32 as _;
pub const WDSTPTMGMT_E_CANNOT_REINITIALIZE_OBJECT: ::windows_sys::core::HRESULT = 0xC1100109u32 as _;
pub const WDSTPTMGMT_E_CONTENT_PROVIDER_ALREADY_REGISTERED: ::windows_sys::core::HRESULT = 0xC1100103u32 as _;
pub const WDSTPTMGMT_E_CONTENT_PROVIDER_NOT_REGISTERED: ::windows_sys::core::HRESULT = 0xC1100104u32 as _;
pub const WDSTPTMGMT_E_INVALID_AUTO_DISCONNECT_THRESHOLD: ::windows_sys::core::HRESULT = 0xC110011Cu32 as _;
pub const WDSTPTMGMT_E_INVALID_CLASS: ::windows_sys::core::HRESULT = 0xC1100102u32 as _;
pub const WDSTPTMGMT_E_INVALID_CONTENT_PROVIDER_NAME: ::windows_sys::core::HRESULT = 0xC1100105u32 as _;
pub const WDSTPTMGMT_E_INVALID_DIAGNOSTICS_COMPONENTS: ::windows_sys::core::HRESULT = 0xC110010Eu32 as _;
pub const WDSTPTMGMT_E_INVALID_IPV4_MULTICAST_ADDRESS: ::windows_sys::core::HRESULT = 0xC1100117u32 as _;
pub const WDSTPTMGMT_E_INVALID_IPV6_MULTICAST_ADDRESS: ::windows_sys::core::HRESULT = 0xC1100118u32 as _;
pub const WDSTPTMGMT_E_INVALID_IPV6_MULTICAST_ADDRESS_SOURCE: ::windows_sys::core::HRESULT = 0xC110011Au32 as _;
pub const WDSTPTMGMT_E_INVALID_IP_ADDRESS: ::windows_sys::core::HRESULT = 0xC1100116u32 as _;
pub const WDSTPTMGMT_E_INVALID_MULTISTREAM_STREAM_COUNT: ::windows_sys::core::HRESULT = 0xC110011Bu32 as _;
pub const WDSTPTMGMT_E_INVALID_NAMESPACE_DATA: ::windows_sys::core::HRESULT = 0xC110010Bu32 as _;
pub const WDSTPTMGMT_E_INVALID_NAMESPACE_NAME: ::windows_sys::core::HRESULT = 0xC110010Au32 as _;
pub const WDSTPTMGMT_E_INVALID_NAMESPACE_START_PARAMETERS: ::windows_sys::core::HRESULT = 0xC1100112u32 as _;
pub const WDSTPTMGMT_E_INVALID_NAMESPACE_START_TIME: ::windows_sys::core::HRESULT = 0xC110010Du32 as _;
pub const WDSTPTMGMT_E_INVALID_OPERATION: ::windows_sys::core::HRESULT = 0xC1100101u32 as _;
pub const WDSTPTMGMT_E_INVALID_PROPERTY: ::windows_sys::core::HRESULT = 0xC1100100u32 as _;
pub const WDSTPTMGMT_E_INVALID_SERVICE_IP_ADDRESS_RANGE: ::windows_sys::core::HRESULT = 0xC1100110u32 as _;
pub const WDSTPTMGMT_E_INVALID_SERVICE_PORT_RANGE: ::windows_sys::core::HRESULT = 0xC1100111u32 as _;
pub const WDSTPTMGMT_E_INVALID_SLOW_CLIENT_HANDLING_TYPE: ::windows_sys::core::HRESULT = 0xC110011Eu32 as _;
pub const WDSTPTMGMT_E_INVALID_TFTP_MAX_BLOCKSIZE: ::windows_sys::core::HRESULT = 0xC1100123u32 as _;
pub const WDSTPTMGMT_E_IPV6_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC1100119u32 as _;
pub const WDSTPTMGMT_E_MULTICAST_SESSION_POLICY_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC110011Du32 as _;
pub const WDSTPTMGMT_E_NAMESPACE_ALREADY_REGISTERED: ::windows_sys::core::HRESULT = 0xC1100107u32 as _;
pub const WDSTPTMGMT_E_NAMESPACE_NOT_ON_SERVER: ::windows_sys::core::HRESULT = 0xC1100114u32 as _;
pub const WDSTPTMGMT_E_NAMESPACE_NOT_REGISTERED: ::windows_sys::core::HRESULT = 0xC1100108u32 as _;
pub const WDSTPTMGMT_E_NAMESPACE_READ_ONLY: ::windows_sys::core::HRESULT = 0xC110010Cu32 as _;
pub const WDSTPTMGMT_E_NAMESPACE_REMOVED_FROM_SERVER: ::windows_sys::core::HRESULT = 0xC1100115u32 as _;
pub const WDSTPTMGMT_E_NETWORK_PROFILES_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC110011Fu32 as _;
pub const WDSTPTMGMT_E_TFTP_MAX_BLOCKSIZE_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC1100121u32 as _;
pub const WDSTPTMGMT_E_TFTP_VAR_WINDOW_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC1100122u32 as _;
pub const WDSTPTMGMT_E_TRANSPORT_SERVER_ROLE_NOT_CONFIGURED: ::windows_sys::core::HRESULT = 0xC1100106u32 as _;
pub const WDSTPTMGMT_E_TRANSPORT_SERVER_UNAVAILABLE: ::windows_sys::core::HRESULT = 0xC1100113u32 as _;
pub const WDSTPTMGMT_E_UDP_PORT_POLICY_NOT_SUPPORTED: ::windows_sys::core::HRESULT = 0xC1100120u32 as _;
