...
windows_link::link!("kernel32.dll" "system" fn CreateJobSet(numjob : u32, userjobset : *mut JOB_SET_ARRAY, flags : u32) -> windows_sys::core::BOOL);
windows_link::link!("kernel32.dll" "system" fn FreeMemoryJobObject(buffer : *mut core::ffi::c_void));
...
windows_link::link!("kernel32.dll" "system" fn SetInformationJobObject(hjob : super::super::Foundation:: HANDLE, jobobjectinformationclass : JOBOBJECTINFOCLASS, lpjobobjectinformation : *mut core::ffi::c_void, cbjobobjectinformationlength : u32) -> windows_sys::core::BOOL);
