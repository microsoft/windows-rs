pub type AbortSystemShutdownA = unsafe extern "system" fn(lpmachinename: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn AbortSystemShutdownA(lpmachinename : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
pub type AbortSystemShutdownW = unsafe extern "system" fn(lpmachinename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type CheckForHiberboot = unsafe extern "system" fn(phiberboot: *mut bool, bclearflag: bool) -> u32;
windows_link::link!("advapi32.dll" "system" fn CheckForHiberboot(phiberboot : *mut bool, bclearflag : bool) -> u32);
pub type ExitWindowsEx = unsafe extern "system" fn(uflags: EXIT_WINDOWS_FLAGS, dwreason: SHUTDOWN_REASON) -> windows_sys::core::BOOL;
...
pub type InitiateShutdownA = unsafe extern "system" fn(lpmachinename: windows_sys::core::PCSTR, lpmessage: windows_sys::core::PCSTR, dwgraceperiod: u32, dwshutdownflags: SHUTDOWN_FLAGS, dwreason: SHUTDOWN_REASON) -> u32;
...
pub type InitiateShutdownW = unsafe extern "system" fn(lpmachinename: windows_sys::core::PCWSTR, lpmessage: windows_sys::core::PCWSTR, dwgraceperiod: u32, dwshutdownflags: SHUTDOWN_FLAGS, dwreason: SHUTDOWN_REASON) -> u32;
...
pub type InitiateSystemShutdownA = unsafe extern "system" fn(lpmachinename: windows_sys::core::PCSTR, lpmessage: windows_sys::core::PCSTR, dwtimeout: u32, bforceappsclosed: windows_sys::core::BOOL, brebootaftershutdown: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type InitiateSystemShutdownExA = unsafe extern "system" fn(lpmachinename: windows_sys::core::PCSTR, lpmessage: windows_sys::core::PCSTR, dwtimeout: u32, bforceappsclosed: windows_sys::core::BOOL, brebootaftershutdown: windows_sys::core::BOOL, dwreason: SHUTDOWN_REASON) -> windows_sys::core::BOOL;
...
pub type InitiateSystemShutdownExW = unsafe extern "system" fn(lpmachinename: windows_sys::core::PCWSTR, lpmessage: windows_sys::core::PCWSTR, dwtimeout: u32, bforceappsclosed: windows_sys::core::BOOL, brebootaftershutdown: windows_sys::core::BOOL, dwreason: SHUTDOWN_REASON) -> windows_sys::core::BOOL;
...
pub type InitiateSystemShutdownW = unsafe extern "system" fn(lpmachinename: windows_sys::core::PCWSTR, lpmessage: windows_sys::core::PCWSTR, dwtimeout: u32, bforceappsclosed: windows_sys::core::BOOL, brebootaftershutdown: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type LockWorkStation = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn LockWorkStation() -> windows_sys::core::BOOL);
pub type ShutdownBlockReasonCreate = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, pwszreason: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type ShutdownBlockReasonDestroy = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn ShutdownBlockReasonDestroy(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type ShutdownBlockReasonQuery = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, pwszbuff: windows_sys::core::PWSTR, pcchbuff: *mut u32) -> windows_sys::core::BOOL;
