pub type AddDllDirectory = unsafe extern "system" fn(newdirectory: windows_sys::core::PCWSTR) -> *mut core::ffi::c_void;
windows_link::link!("kernel32.dll" "system" fn AddDllDirectory(newdirectory : windows_sys::core::PCWSTR) -> *mut core::ffi::c_void);
pub type BeginUpdateResourceA = unsafe extern "system" fn(pfilename: windows_sys::core::PCSTR, bdeleteexistingresources: windows_sys::core::BOOL) -> super::super::Foundation::HANDLE;
...
pub type BeginUpdateResourceW = unsafe extern "system" fn(pfilename: windows_sys::core::PCWSTR, bdeleteexistingresources: windows_sys::core::BOOL) -> super::super::Foundation::HANDLE;
...
pub type DisableThreadLibraryCalls = unsafe extern "system" fn(hlibmodule: super::super::Foundation::HMODULE) -> windows_sys::core::BOOL;
...
pub type EndUpdateResourceA = unsafe extern "system" fn(hupdate: super::super::Foundation::HANDLE, fdiscard: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type EndUpdateResourceW = unsafe extern "system" fn(hupdate: super::super::Foundation::HANDLE, fdiscard: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type EnumResourceLanguagesA = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lptype: windows_sys::core::PCSTR, lpname: windows_sys::core::PCSTR, lpenumfunc: ENUMRESLANGPROCA, lparam: isize) -> windows_sys::core::BOOL;
...
pub type EnumResourceLanguagesExA = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lptype: windows_sys::core::PCSTR, lpname: windows_sys::core::PCSTR, lpenumfunc: ENUMRESLANGPROCA, lparam: isize, dwflags: u32, langid: u16) -> windows_sys::core::BOOL;
...
pub type EnumResourceLanguagesExW = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lptype: windows_sys::core::PCWSTR, lpname: windows_sys::core::PCWSTR, lpenumfunc: ENUMRESLANGPROCW, lparam: isize, dwflags: u32, langid: u16) -> windows_sys::core::BOOL;
...
pub type EnumResourceLanguagesW = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lptype: windows_sys::core::PCWSTR, lpname: windows_sys::core::PCWSTR, lpenumfunc: ENUMRESLANGPROCW, lparam: isize) -> windows_sys::core::BOOL;
...
pub type EnumResourceNamesA = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lptype: windows_sys::core::PCSTR, lpenumfunc: ENUMRESNAMEPROCA, lparam: isize) -> windows_sys::core::BOOL;
...
pub type EnumResourceNamesExA = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lptype: windows_sys::core::PCSTR, lpenumfunc: ENUMRESNAMEPROCA, lparam: isize, dwflags: u32, langid: u16) -> windows_sys::core::BOOL;
...
pub type EnumResourceNamesExW = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lptype: windows_sys::core::PCWSTR, lpenumfunc: ENUMRESNAMEPROCW, lparam: isize, dwflags: u32, langid: u16) -> windows_sys::core::BOOL;
...
pub type EnumResourceNamesW = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lptype: windows_sys::core::PCWSTR, lpenumfunc: ENUMRESNAMEPROCW, lparam: isize) -> windows_sys::core::BOOL;
...
pub type EnumResourceTypesA = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lpenumfunc: ENUMRESTYPEPROCA, lparam: isize) -> windows_sys::core::BOOL;
...
pub type EnumResourceTypesExA = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lpenumfunc: ENUMRESTYPEPROCA, lparam: isize, dwflags: u32, langid: u16) -> windows_sys::core::BOOL;
...
pub type EnumResourceTypesExW = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lpenumfunc: ENUMRESTYPEPROCW, lparam: isize, dwflags: u32, langid: u16) -> windows_sys::core::BOOL;
...
pub type EnumResourceTypesW = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lpenumfunc: ENUMRESTYPEPROCW, lparam: isize) -> windows_sys::core::BOOL;
...
pub type FindResourceA = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lpname: windows_sys::core::PCSTR, lptype: windows_sys::core::PCSTR) -> super::super::Foundation::HRSRC;
...
pub type FindResourceExA = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lptype: windows_sys::core::PCSTR, lpname: windows_sys::core::PCSTR, wlanguage: u16) -> super::super::Foundation::HRSRC;
...
pub type FindResourceExW = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lptype: windows_sys::core::PCWSTR, lpname: windows_sys::core::PCWSTR, wlanguage: u16) -> super::super::Foundation::HRSRC;
...
pub type FindResourceW = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lpname: windows_sys::core::PCWSTR, lptype: windows_sys::core::PCWSTR) -> super::super::Foundation::HRSRC;
...
pub type FreeLibraryAndExitThread = unsafe extern "system" fn(hlibmodule: super::super::Foundation::HMODULE, dwexitcode: u32) -> !;
...
pub type FreeResource = unsafe extern "system" fn(hresdata: super::super::Foundation::HGLOBAL) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn FreeResource(hresdata : super::super::Foundation::HGLOBAL) -> windows_sys::core::BOOL);
pub type GetDllDirectoryA = unsafe extern "system" fn(nbufferlength: u32, lpbuffer: windows_sys::core::PSTR) -> u32;
windows_link::link!("kernel32.dll" "system" fn GetDllDirectoryA(nbufferlength : u32, lpbuffer : windows_sys::core::PSTR) -> u32);
pub type GetDllDirectoryW = unsafe extern "system" fn(nbufferlength: u32, lpbuffer: windows_sys::core::PWSTR) -> u32;
windows_link::link!("kernel32.dll" "system" fn GetDllDirectoryW(nbufferlength : u32, lpbuffer : windows_sys::core::PWSTR) -> u32);
pub type GetModuleFileNameA = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lpfilename: windows_sys::core::PSTR, nsize: u32) -> u32;
...
pub type GetModuleFileNameW = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lpfilename: windows_sys::core::PWSTR, nsize: u32) -> u32;
...
pub type GetModuleHandleA = unsafe extern "system" fn(lpmodulename: windows_sys::core::PCSTR) -> super::super::Foundation::HMODULE;
...
pub type GetModuleHandleExA = unsafe extern "system" fn(dwflags: u32, lpmodulename: windows_sys::core::PCSTR, phmodule: *mut super::super::Foundation::HMODULE) -> windows_sys::core::BOOL;
...
pub type GetModuleHandleExW = unsafe extern "system" fn(dwflags: u32, lpmodulename: windows_sys::core::PCWSTR, phmodule: *mut super::super::Foundation::HMODULE) -> windows_sys::core::BOOL;
...
pub type GetModuleHandleW = unsafe extern "system" fn(lpmodulename: windows_sys::core::PCWSTR) -> super::super::Foundation::HMODULE;
...
pub type GetProcAddress = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, lpprocname: windows_sys::core::PCSTR) -> super::super::Foundation::FARPROC;
...
pub type LoadLibraryA = unsafe extern "system" fn(lplibfilename: windows_sys::core::PCSTR) -> super::super::Foundation::HMODULE;
...
pub type LoadLibraryExA = unsafe extern "system" fn(lplibfilename: windows_sys::core::PCSTR, hfile: super::super::Foundation::HANDLE, dwflags: LOAD_LIBRARY_FLAGS) -> super::super::Foundation::HMODULE;
...
pub type LoadLibraryExW = unsafe extern "system" fn(lplibfilename: windows_sys::core::PCWSTR, hfile: super::super::Foundation::HANDLE, dwflags: LOAD_LIBRARY_FLAGS) -> super::super::Foundation::HMODULE;
...
pub type LoadLibraryW = unsafe extern "system" fn(lplibfilename: windows_sys::core::PCWSTR) -> super::super::Foundation::HMODULE;
...
pub type LoadModule = unsafe extern "system" fn(lpmodulename: windows_sys::core::PCSTR, lpparameterblock: *const core::ffi::c_void) -> u32;
...
pub type LoadPackagedLibrary = unsafe extern "system" fn(lpwlibfilename: windows_sys::core::PCWSTR, reserved: u32) -> super::super::Foundation::HMODULE;
...
pub type LoadResource = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, hresinfo: super::super::Foundation::HRSRC) -> super::super::Foundation::HGLOBAL;
...
pub type LockResource = unsafe extern "system" fn(hresdata: super::super::Foundation::HGLOBAL) -> *mut core::ffi::c_void;
windows_link::link!("kernel32.dll" "system" fn LockResource(hresdata : super::super::Foundation::HGLOBAL) -> *mut core::ffi::c_void);
pub type QueryOptionalDelayLoadedAPI = unsafe extern "system" fn(hparentmodule: super::super::Foundation::HMODULE, lpdllname: windows_sys::core::PCSTR, lpprocname: windows_sys::core::PCSTR, reserved: u32) -> windows_sys::core::BOOL;
...
pub type RemoveDllDirectory = unsafe extern "system" fn(cookie: *const core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn RemoveDllDirectory(cookie : *const core::ffi::c_void) -> windows_sys::core::BOOL);
pub type SetDefaultDllDirectories = unsafe extern "system" fn(directoryflags: LOAD_LIBRARY_FLAGS) -> windows_sys::core::BOOL;
...
pub type SetDllDirectoryA = unsafe extern "system" fn(lppathname: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn SetDllDirectoryA(lppathname : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
pub type SetDllDirectoryW = unsafe extern "system" fn(lppathname: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn SetDllDirectoryW(lppathname : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
pub type SizeofResource = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, hresinfo: super::super::Foundation::HRSRC) -> u32;
...
pub type UpdateResourceA = unsafe extern "system" fn(hupdate: super::super::Foundation::HANDLE, lptype: windows_sys::core::PCSTR, lpname: windows_sys::core::PCSTR, wlanguage: u16, lpdata: *const core::ffi::c_void, cb: u32) -> windows_sys::core::BOOL;
...
pub type UpdateResourceW = unsafe extern "system" fn(hupdate: super::super::Foundation::HANDLE, lptype: windows_sys::core::PCWSTR, lpname: windows_sys::core::PCWSTR, wlanguage: u16, lpdata: *const core::ffi::c_void, cb: u32) -> windows_sys::core::BOOL;
