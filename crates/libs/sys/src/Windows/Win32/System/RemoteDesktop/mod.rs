...
pub struct AAAccountingData {
    pub userName: core::mem::ManuallyDrop<windows_sys::core::BSTR>,
    pub clientName: core::mem::ManuallyDrop<windows_sys::core::BSTR>,
    pub authType: AAAuthSchemes,
    pub resourceName: core::mem::ManuallyDrop<windows_sys::core::BSTR>,
    pub portNumber: i32,
    pub protocolName: core::mem::ManuallyDrop<windows_sys::core::BSTR>,
    pub numberOfBytesReceived: i32,
    pub numberOfBytesTransfered: i32,
    pub reasonForDisconnect: core::mem::ManuallyDrop<windows_sys::core::BSTR>,
...
pub const AA_AUTH_ANY: AAAuthSchemes = 6;
pub const AA_AUTH_BASIC: AAAuthSchemes = 1;
pub const AA_AUTH_CONID: AAAuthSchemes = 10;
pub const AA_AUTH_COOKIE: AAAuthSchemes = 7;
pub const AA_AUTH_DIGEST: AAAuthSchemes = 8;
pub const AA_AUTH_LOGGEDONCREDENTIALS: AAAuthSchemes = 4;
pub const AA_AUTH_MAX: AAAuthSchemes = 12;
pub const AA_AUTH_MIN: AAAuthSchemes = 0;
pub const AA_AUTH_NEGOTIATE: AAAuthSchemes = 5;
pub const AA_AUTH_NTLM: AAAuthSchemes = 2;
pub const AA_AUTH_ORGID: AAAuthSchemes = 9;
pub const AA_AUTH_SC: AAAuthSchemes = 3;
pub const AA_AUTH_SSPI_NTLM: AAAuthSchemes = 11;
pub const AA_MAIN_SESSION_CLOSED: AAAccountingDataType = 3;
pub const AA_MAIN_SESSION_CREATION: AAAccountingDataType = 0;
pub const AA_SUB_SESSION_CLOSED: AAAccountingDataType = 2;
pub const AA_SUB_SESSION_CREATION: AAAccountingDataType = 1;
pub const AA_TRUSTEDUSER_TRUSTEDCLIENT: AATrustClassID = 2;
pub const AA_TRUSTEDUSER_UNTRUSTEDCLIENT: AATrustClassID = 1;
pub const AA_UNTRUSTED: AATrustClassID = 0;
...
pub const AllowOnlySDRServers: PolicyAttributeType = 7;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const CLIENT_MESSAGE_CONNECTION_ERROR: CLIENT_MESSAGE_TYPE = 2;
pub const CLIENT_MESSAGE_CONNECTION_INVALID: CLIENT_MESSAGE_TYPE = 0;
pub const CLIENT_MESSAGE_CONNECTION_STATUS: CLIENT_MESSAGE_TYPE = 1;
...
pub const CONNECTION_REQUEST_CANCELLED: CONNECTION_CHANGE_NOTIFICATION = 5;
pub const CONNECTION_REQUEST_FAILED: CONNECTION_CHANGE_NOTIFICATION = 2;
pub const CONNECTION_REQUEST_INVALID: CONNECTION_CHANGE_NOTIFICATION = 0;
pub const CONNECTION_REQUEST_LB_COMPLETED: CONNECTION_CHANGE_NOTIFICATION = 6;
pub const CONNECTION_REQUEST_ORCH_COMPLETED: CONNECTION_CHANGE_NOTIFICATION = 8;
pub const CONNECTION_REQUEST_PENDING: CONNECTION_CHANGE_NOTIFICATION = 1;
pub const CONNECTION_REQUEST_QUERY_PL_COMPLETED: CONNECTION_CHANGE_NOTIFICATION = 7;
pub const CONNECTION_REQUEST_SUCCEEDED: CONNECTION_CHANGE_NOTIFICATION = 4;
pub const CONNECTION_REQUEST_TIMEDOUT: CONNECTION_CHANGE_NOTIFICATION = 3;
pub const ClipboardRedirectionDisabled: PolicyAttributeType = 5;
...
pub const DisableAllRedirections: PolicyAttributeType = 1;
pub const DriveRedirectionDisabled: PolicyAttributeType = 2;
pub const EnableAllRedirections: PolicyAttributeType = 0;
pub const FARM: TARGET_TYPE = 1;
pub const FORCE_REJOIN: u32 = 2;
pub const FORCE_REJOIN_IN_CLUSTERMODE: u32 = 3;
pub const KEEP_EXISTING_SESSIONS: u32 = 8;
pub const KeyCombinationDown: KeyCombinationType = 4;
pub const KeyCombinationHome: KeyCombinationType = 0;
pub const KeyCombinationLeft: KeyCombinationType = 1;
pub const KeyCombinationRight: KeyCombinationType = 3;
pub const KeyCombinationScroll: KeyCombinationType = 5;
pub type KeyCombinationType = i32;
pub const KeyCombinationUp: KeyCombinationType = 2;
pub const LOAD_BALANCING_PLUGIN: PLUGIN_TYPE = 4;
...
pub const NONFARM: TARGET_TYPE = 2;
pub const NOTIFY_FOR_ALL_SESSIONS: u32 = 1;
pub const NOTIFY_FOR_THIS_SESSION: u32 = 0;
pub const ORCHESTRATION_PLUGIN: PLUGIN_TYPE = 16;
pub const OWNER_MS_TS_PLUGIN: TARGET_OWNER = 1;
pub const OWNER_MS_VM_PLUGIN: TARGET_OWNER = 2;
pub const OWNER_UNKNOWN: TARGET_OWNER = 0;
...
pub const PLACEMENT_PLUGIN: PLUGIN_TYPE = 8;
pub const PLUGIN_CAPABILITY_EXTERNAL_REDIRECTION: u32 = 1;
pub type PLUGIN_TYPE = i32;
pub const POLICY_PLUGIN: PLUGIN_TYPE = 1;
pub const POSITION_CONTINUOUS: AE_POSITION_FLAGS = 2;
pub const POSITION_DISCONTINUOUS: AE_POSITION_FLAGS = 1;
pub const POSITION_INVALID: AE_POSITION_FLAGS = 0;
pub const POSITION_QPC_ERROR: AE_POSITION_FLAGS = 4;
...
pub const PROVISIONING_PLUGIN: PLUGIN_TYPE = 32;
...
pub const PasswordEncodingUTF16BE: PasswordEncodingType = 2;
pub const PasswordEncodingUTF16LE: PasswordEncodingType = 1;
pub const PasswordEncodingUTF8: PasswordEncodingType = 0;
pub const PnpRedirectionDisabled: PolicyAttributeType = 6;
pub type PolicyAttributeType = i32;
pub const PortRedirectionDisabled: PolicyAttributeType = 4;
pub const PrinterRedirectionDisabled: PolicyAttributeType = 3;
...
pub const RDV_TASK_STATUS_APPLYING: RDV_TASK_STATUS = 3;
pub const RDV_TASK_STATUS_DOWNLOADING: RDV_TASK_STATUS = 2;
pub const RDV_TASK_STATUS_FAILED: RDV_TASK_STATUS = 7;
pub const RDV_TASK_STATUS_REBOOTED: RDV_TASK_STATUS = 5;
pub const RDV_TASK_STATUS_REBOOTING: RDV_TASK_STATUS = 4;
pub const RDV_TASK_STATUS_SEARCHING: RDV_TASK_STATUS = 1;
pub const RDV_TASK_STATUS_SUCCESS: RDV_TASK_STATUS = 6;
pub const RDV_TASK_STATUS_TIMEOUT: RDV_TASK_STATUS = 8;
pub const RDV_TASK_STATUS_UNKNOWN: RDV_TASK_STATUS = 0;
pub const RD_FARM_AUTO_PERSONAL_RDSH: RD_FARM_TYPE = 5;
pub const RD_FARM_AUTO_PERSONAL_VM: RD_FARM_TYPE = 3;
pub const RD_FARM_MANUAL_PERSONAL_RDSH: RD_FARM_TYPE = 4;
pub const RD_FARM_MANUAL_PERSONAL_VM: RD_FARM_TYPE = 2;
pub const RD_FARM_RDSH: RD_FARM_TYPE = 0;
pub const RD_FARM_TEMP_VM: RD_FARM_TYPE = 1;
pub type RD_FARM_TYPE = i32;
pub const RD_FARM_TYPE_UNKNOWN: RD_FARM_TYPE = -1;
...
pub const RESOURCE_PLUGIN: PLUGIN_TYPE = 2;
...
pub const RemoteActionAppSwitch: RemoteActionType = 4;
pub const RemoteActionAppbar: RemoteActionType = 1;
pub const RemoteActionCharms: RemoteActionType = 0;
pub const RemoteActionSnap: RemoteActionType = 2;
pub const RemoteActionStartScreen: RemoteActionType = 3;
pub type RemoteActionType = i32;
pub const SB_SYNCH_CONFLICT_MAX_WRITE_ATTEMPTS: u32 = 100;
pub const SESSION_TIMEOUT_ACTION_DISCONNECT: SESSION_TIMEOUT_ACTION_TYPE = 0;
pub const SESSION_TIMEOUT_ACTION_SILENT_REAUTH: SESSION_TIMEOUT_ACTION_TYPE = 1;
pub type SESSION_TIMEOUT_ACTION_TYPE = i32;
pub const SINGLE_SESSION: u32 = 1;
pub const STATE_ACTIVE: TSSESSION_STATE = 0;
pub const STATE_CONNECTED: TSSESSION_STATE = 1;
pub const STATE_CONNECTQUERY: TSSESSION_STATE = 2;
pub const STATE_DISCONNECTED: TSSESSION_STATE = 4;
pub const STATE_DOWN: TSSESSION_STATE = 8;
pub const STATE_IDLE: TSSESSION_STATE = 5;
pub const STATE_INIT: TSSESSION_STATE = 9;
pub const STATE_INVALID: TSSESSION_STATE = -1;
pub const STATE_LISTEN: TSSESSION_STATE = 6;
pub const STATE_MAX: TSSESSION_STATE = 10;
pub const STATE_RESET: TSSESSION_STATE = 7;
pub const STATE_SHADOW: TSSESSION_STATE = 3;
pub const SnapshotEncodingDataUri: SnapshotEncodingType = 0;
pub type SnapshotEncodingType = i32;
pub const SnapshotFormatBmp: SnapshotFormatType = 2;
pub const SnapshotFormatJpeg: SnapshotFormatType = 1;
pub const SnapshotFormatPng: SnapshotFormatType = 0;
pub type SnapshotFormatType = i32;
pub type TARGET_CHANGE_TYPE = i32;
pub const TARGET_CHANGE_UNSPEC: TARGET_CHANGE_TYPE = 1;
pub const TARGET_CHECKED_OUT: TARGET_STATE = 6;
pub const TARGET_DOWN: TARGET_STATE = 4;
pub const TARGET_EXTERNALIP_CHANGED: TARGET_CHANGE_TYPE = 2;
pub const TARGET_FARM_MEMBERSHIP_CHANGED: TARGET_CHANGE_TYPE = 1024;
pub const TARGET_HIBERNATED: TARGET_STATE = 5;
pub const TARGET_IDLE: TARGET_CHANGE_TYPE = 64;
pub const TARGET_INITIALIZING: TARGET_STATE = 2;
pub const TARGET_INTERNALIP_CHANGED: TARGET_CHANGE_TYPE = 4;
pub const TARGET_INUSE: TARGET_CHANGE_TYPE = 256;
pub const TARGET_INVALID: TARGET_STATE = 8;
pub const TARGET_JOINED: TARGET_CHANGE_TYPE = 8;
pub const TARGET_MAXSTATE: TARGET_STATE = 11;
pub type TARGET_OWNER = i32;
pub const TARGET_PATCH_COMPLETED: TARGET_PATCH_STATE = 3;
pub const TARGET_PATCH_FAILED: TARGET_PATCH_STATE = 4;
pub const TARGET_PATCH_IN_PROGRESS: TARGET_PATCH_STATE = 2;
pub const TARGET_PATCH_NOT_STARTED: TARGET_PATCH_STATE = 1;
pub type TARGET_PATCH_STATE = i32;
pub const TARGET_PATCH_STATE_CHANGED: TARGET_CHANGE_TYPE = 512;
pub const TARGET_PATCH_UNKNOWN: TARGET_PATCH_STATE = 0;
pub const TARGET_PENDING: TARGET_CHANGE_TYPE = 128;
pub const TARGET_REMOVED: TARGET_CHANGE_TYPE = 16;
pub const TARGET_RUNNING: TARGET_STATE = 3;
pub const TARGET_STARTING: TARGET_STATE = 9;
pub type TARGET_STATE = i32;
pub const TARGET_STATE_CHANGED: TARGET_CHANGE_TYPE = 32;
pub const TARGET_STOPPED: TARGET_STATE = 7;
pub const TARGET_STOPPING: TARGET_STATE = 10;
pub type TARGET_TYPE = i32;
pub const TARGET_UNKNOWN: TARGET_STATE = 1;
pub const TASK_PLUGIN: PLUGIN_TYPE = 64;
pub const TSPUB_PLUGIN_PD_ASSIGNMENT_EXISTING: TSPUB_PLUGIN_PD_ASSIGNMENT_TYPE = 1;
pub const TSPUB_PLUGIN_PD_ASSIGNMENT_NEW: TSPUB_PLUGIN_PD_ASSIGNMENT_TYPE = 0;
pub type TSPUB_PLUGIN_PD_ASSIGNMENT_TYPE = i32;
pub const TSPUB_PLUGIN_PD_QUERY_EXISTING: TSPUB_PLUGIN_PD_RESOLUTION_TYPE = 1;
pub const TSPUB_PLUGIN_PD_QUERY_OR_CREATE: TSPUB_PLUGIN_PD_RESOLUTION_TYPE = 0;
pub type TSPUB_PLUGIN_PD_RESOLUTION_TYPE = i32;
pub type TSSB_NOTIFICATION_TYPE = i32;
pub const TSSB_NOTIFY_CONNECTION_REQUEST_CHANGE: TSSB_NOTIFICATION_TYPE = 4;
pub const TSSB_NOTIFY_INVALID: TSSB_NOTIFICATION_TYPE = 0;
pub const TSSB_NOTIFY_SESSION_CHANGE: TSSB_NOTIFICATION_TYPE = 2;
pub const TSSB_NOTIFY_TARGET_CHANGE: TSSB_NOTIFICATION_TYPE = 1;
pub const TSSD_ADDR_IPv4: TSSD_AddrV46Type = 4;
pub const TSSD_ADDR_IPv6: TSSD_AddrV46Type = 6;
pub const TSSD_ADDR_UNDEFINED: TSSD_AddrV46Type = 0;
...
pub const TS_SB_SORT_BY_NAME: TS_SB_SORT_BY = 1;
pub const TS_SB_SORT_BY_NONE: TS_SB_SORT_BY = 0;
pub const TS_SB_SORT_BY_PROP: TS_SB_SORT_BY = 2;
pub const TS_VC_LISTENER_STATIC_CHANNEL: u32 = 1;
pub const UNKNOWN: TARGET_TYPE = 0;
pub const UNKNOWN_PLUGIN: PLUGIN_TYPE = 0;
...
pub const VM_HOST_STATUS_INIT_COMPLETE: VM_HOST_NOTIFY_STATUS = 2;
pub const VM_HOST_STATUS_INIT_FAILED: VM_HOST_NOTIFY_STATUS = 3;
pub const VM_HOST_STATUS_INIT_IN_PROGRESS: VM_HOST_NOTIFY_STATUS = 1;
pub const VM_HOST_STATUS_INIT_PENDING: VM_HOST_NOTIFY_STATUS = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const VM_NOTIFY_STATUS_CANCELED: VM_NOTIFY_STATUS = 4;
pub const VM_NOTIFY_STATUS_COMPLETE: VM_NOTIFY_STATUS = 2;
pub const VM_NOTIFY_STATUS_FAILED: VM_NOTIFY_STATUS = 3;
pub const VM_NOTIFY_STATUS_IN_PROGRESS: VM_NOTIFY_STATUS = 1;
pub const VM_NOTIFY_STATUS_PENDING: VM_NOTIFY_STATUS = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const WRDS_CONNECTION_SETTING_LEVEL_INVALID: WRDS_CONNECTION_SETTING_LEVEL = 0;
...
pub const WRDS_LISTENER_SETTING_LEVEL_INVALID: WRDS_LISTENER_SETTING_LEVEL = 0;
...
pub const WRDS_SETTING_LEVEL_INVALID: WRDS_SETTING_LEVEL = 0;
pub type WRDS_SETTING_STATUS = i32;
pub const WRDS_SETTING_STATUS_DISABLED: WRDS_SETTING_STATUS = 0;
pub const WRDS_SETTING_STATUS_ENABLED: WRDS_SETTING_STATUS = 1;
pub const WRDS_SETTING_STATUS_NOTAPPLICABLE: WRDS_SETTING_STATUS = -1;
pub const WRDS_SETTING_STATUS_NOTCONFIGURED: WRDS_SETTING_STATUS = 2;
pub type WRDS_SETTING_TYPE = i32;
pub const WRDS_SETTING_TYPE_INVALID: WRDS_SETTING_TYPE = 0;
pub const WRDS_SETTING_TYPE_MACHINE: WRDS_SETTING_TYPE = 1;
pub const WRDS_SETTING_TYPE_SAM: WRDS_SETTING_TYPE = 3;
pub const WRDS_SETTING_TYPE_USER: WRDS_SETTING_TYPE = 2;
...
pub const WRdsGraphicsChannelType_BestEffortDelivery: WRdsGraphicsChannelType = 1;
pub const WRdsGraphicsChannelType_GuaranteedDelivery: WRdsGraphicsChannelType = 0;
...
pub const WTSSBX_ADDRESS_FAMILY_AF_INET: WTSSBX_ADDRESS_FAMILY = 1;
pub const WTSSBX_ADDRESS_FAMILY_AF_INET6: WTSSBX_ADDRESS_FAMILY = 2;
pub const WTSSBX_ADDRESS_FAMILY_AF_IPX: WTSSBX_ADDRESS_FAMILY = 3;
pub const WTSSBX_ADDRESS_FAMILY_AF_NETBIOS: WTSSBX_ADDRESS_FAMILY = 4;
pub const WTSSBX_ADDRESS_FAMILY_AF_UNSPEC: WTSSBX_ADDRESS_FAMILY = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const WTSSBX_MACHINE_DRAIN_OFF: WTSSBX_MACHINE_DRAIN = 1;
pub const WTSSBX_MACHINE_DRAIN_ON: WTSSBX_MACHINE_DRAIN = 2;
pub const WTSSBX_MACHINE_DRAIN_UNSPEC: WTSSBX_MACHINE_DRAIN = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const WTSSBX_MACHINE_SESSION_MODE_MULTIPLE: WTSSBX_MACHINE_SESSION_MODE = 2;
pub const WTSSBX_MACHINE_SESSION_MODE_SINGLE: WTSSBX_MACHINE_SESSION_MODE = 1;
pub const WTSSBX_MACHINE_SESSION_MODE_UNSPEC: WTSSBX_MACHINE_SESSION_MODE = 0;
pub type WTSSBX_MACHINE_STATE = i32;
pub const WTSSBX_MACHINE_STATE_READY: WTSSBX_MACHINE_STATE = 1;
pub const WTSSBX_MACHINE_STATE_SYNCHRONIZING: WTSSBX_MACHINE_STATE = 2;
pub const WTSSBX_MACHINE_STATE_UNSPEC: WTSSBX_MACHINE_STATE = 0;
pub const WTSSBX_NOTIFICATION_ADDED: WTSSBX_NOTIFICATION_TYPE = 4;
pub const WTSSBX_NOTIFICATION_CHANGED: WTSSBX_NOTIFICATION_TYPE = 2;
pub const WTSSBX_NOTIFICATION_REMOVED: WTSSBX_NOTIFICATION_TYPE = 1;
pub const WTSSBX_NOTIFICATION_RESYNC: WTSSBX_NOTIFICATION_TYPE = 8;
...
pub const WTSSBX_SESSION_STATE_ACTIVE: WTSSBX_SESSION_STATE = 1;
pub const WTSSBX_SESSION_STATE_DISCONNECTED: WTSSBX_SESSION_STATE = 2;
pub const WTSSBX_SESSION_STATE_UNSPEC: WTSSBX_SESSION_STATE = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const WTS_CERT_TYPE_INVALID: WTS_CERT_TYPE = 0;
pub const WTS_CERT_TYPE_PROPRIETORY: WTS_CERT_TYPE = 1;
pub const WTS_CERT_TYPE_X509: WTS_CERT_TYPE = 2;
...
pub const WTS_CURRENT_SERVER: super::super::Foundation::HANDLE = 0 as _;
pub const WTS_CURRENT_SERVER_HANDLE: super::super::Foundation::HANDLE = 0 as _;
...
pub const WTS_DRAIN_IN_DRAIN: WTS_RCM_DRAIN_STATE = 1;
pub const WTS_DRAIN_NOT_IN_DRAIN: WTS_RCM_DRAIN_STATE = 2;
pub const WTS_DRAIN_STATE_NONE: WTS_RCM_DRAIN_STATE = 0;
...
pub const WTS_LOGON_ERR_HANDLED_DONT_SHOW: WTS_LOGON_ERROR_REDIRECTOR_RESPONSE = 3;
pub const WTS_LOGON_ERR_HANDLED_DONT_SHOW_START_OVER: WTS_LOGON_ERROR_REDIRECTOR_RESPONSE = 4;
pub const WTS_LOGON_ERR_HANDLED_SHOW: WTS_LOGON_ERROR_REDIRECTOR_RESPONSE = 2;
pub const WTS_LOGON_ERR_INVALID: WTS_LOGON_ERROR_REDIRECTOR_RESPONSE = 0;
pub const WTS_LOGON_ERR_NOT_HANDLED: WTS_LOGON_ERROR_REDIRECTOR_RESPONSE = 1;
...
pub const WTS_SECURITY_ALL_ACCESS: WTS_SECURITY_FLAGS = 983999;
pub const WTS_SECURITY_CONNECT: WTS_SECURITY_FLAGS = 256;
pub const WTS_SECURITY_CURRENT_GUEST_ACCESS: WTS_SECURITY_FLAGS = 72;
pub const WTS_SECURITY_CURRENT_USER_ACCESS: WTS_SECURITY_FLAGS = 590;
pub const WTS_SECURITY_DISCONNECT: WTS_SECURITY_FLAGS = 512;
pub type WTS_SECURITY_FLAGS = u32;
pub const WTS_SECURITY_GUEST_ACCESS: WTS_SECURITY_FLAGS = 32;
pub const WTS_SECURITY_LOGOFF: WTS_SECURITY_FLAGS = 64;
pub const WTS_SECURITY_LOGON: WTS_SECURITY_FLAGS = 32;
pub const WTS_SECURITY_MESSAGE: WTS_SECURITY_FLAGS = 128;
pub const WTS_SECURITY_QUERY_INFORMATION: WTS_SECURITY_FLAGS = 1;
pub const WTS_SECURITY_REMOTE_CONTROL: WTS_SECURITY_FLAGS = 16;
pub const WTS_SECURITY_RESET: WTS_SECURITY_FLAGS = 4;
pub const WTS_SECURITY_SET_INFORMATION: WTS_SECURITY_FLAGS = 2;
pub const WTS_SECURITY_USER_ACCESS: WTS_SECURITY_FLAGS = 329;
pub const WTS_SECURITY_VIRTUAL_CHANNELS: WTS_SECURITY_FLAGS = 8;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const WTS_SERVICE_NONE: WTS_RCM_SERVICE_STATE = 0;
pub const WTS_SERVICE_START: WTS_RCM_SERVICE_STATE = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const WTS_SERVICE_STOP: WTS_RCM_SERVICE_STATE = 2;
