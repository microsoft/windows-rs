...
pub const HKEY_CURRENT_USER_LOCAL_SETTINGS: HKEY = -2147483641 as _;
pub const HKEY_DYN_DATA: HKEY = -2147483642 as _;
pub const HKEY_LOCAL_MACHINE: HKEY = -2147483646 as _;
pub const HKEY_PERFORMANCE_DATA: HKEY = -2147483644 as _;
pub const HKEY_PERFORMANCE_NLSTEXT: HKEY = -2147483552 as _;
pub const HKEY_PERFORMANCE_TEXT: HKEY = -2147483568 as _;
...
pub const KEY_ALL_ACCESS: REG_SAM_FLAGS = 983103;
pub const KEY_CREATE_LINK: REG_SAM_FLAGS = 32;
pub const KEY_CREATE_SUB_KEY: REG_SAM_FLAGS = 4;
pub const KEY_ENUMERATE_SUB_KEYS: REG_SAM_FLAGS = 8;
pub const KEY_EXECUTE: REG_SAM_FLAGS = 131097;
pub const KEY_NOTIFY: REG_SAM_FLAGS = 16;
pub const KEY_QUERY_VALUE: REG_SAM_FLAGS = 1;
pub const KEY_READ: REG_SAM_FLAGS = 131097;
pub const KEY_SET_VALUE: REG_SAM_FLAGS = 2;
pub const KEY_WOW64_32KEY: REG_SAM_FLAGS = 512;
pub const KEY_WOW64_64KEY: REG_SAM_FLAGS = 256;
pub const KEY_WOW64_RES: REG_SAM_FLAGS = 768;
...
pub const REG_CREATED_NEW_KEY: REG_CREATE_KEY_DISPOSITION = 1;
pub type REG_CREATE_KEY_DISPOSITION = u32;
pub const REG_DWORD: REG_VALUE_TYPE = 4;
pub const REG_DWORD_BIG_ENDIAN: REG_VALUE_TYPE = 5;
pub const REG_DWORD_LITTLE_ENDIAN: REG_VALUE_TYPE = 4;
pub const REG_EXPAND_SZ: REG_VALUE_TYPE = 2;
pub const REG_FORCE_RESTORE: REG_RESTORE_KEY_FLAGS = 8;
pub const REG_FULL_RESOURCE_DESCRIPTOR: REG_VALUE_TYPE = 9;
pub const REG_KEY_INSTDEV: windows_sys::core::PCWSTR = windows_sys::core::w!("Installed");
pub const REG_LATEST_FORMAT: REG_SAVE_FORMAT = 2;
pub const REG_LINK: REG_VALUE_TYPE = 6;
pub const REG_MUI_STRING_TRUNCATE: u32 = 1;
pub const REG_MULTI_SZ: REG_VALUE_TYPE = 7;
pub const REG_NONE: REG_VALUE_TYPE = 0;
pub const REG_NOTIFY_CHANGE_ATTRIBUTES: REG_NOTIFY_FILTER = 2;
pub const REG_NOTIFY_CHANGE_LAST_SET: REG_NOTIFY_FILTER = 4;
pub const REG_NOTIFY_CHANGE_NAME: REG_NOTIFY_FILTER = 1;
pub const REG_NOTIFY_CHANGE_SECURITY: REG_NOTIFY_FILTER = 8;
pub type REG_NOTIFY_FILTER = u32;
pub const REG_NOTIFY_THREAD_AGNOSTIC: REG_NOTIFY_FILTER = 268435456;
pub const REG_NO_COMPRESSION: REG_SAVE_FORMAT = 4;
pub const REG_OPENED_EXISTING_KEY: REG_CREATE_KEY_DISPOSITION = 2;
pub type REG_OPEN_CREATE_OPTIONS = u32;
pub const REG_OPTION_BACKUP_RESTORE: REG_OPEN_CREATE_OPTIONS = 4;
pub const REG_OPTION_CREATE_LINK: REG_OPEN_CREATE_OPTIONS = 2;
pub const REG_OPTION_DONT_VIRTUALIZE: REG_OPEN_CREATE_OPTIONS = 16;
pub const REG_OPTION_NON_VOLATILE: REG_OPEN_CREATE_OPTIONS = 0;
pub const REG_OPTION_OPEN_LINK: REG_OPEN_CREATE_OPTIONS = 8;
pub const REG_OPTION_RESERVED: REG_OPEN_CREATE_OPTIONS = 0;
...
pub const REG_QWORD_LITTLE_ENDIAN: REG_VALUE_TYPE = 11;
pub const REG_RESOURCE_LIST: REG_VALUE_TYPE = 8;
pub const REG_RESOURCE_REQUIREMENTS_LIST: REG_VALUE_TYPE = 10;
...
pub const REG_STANDARD_FORMAT: REG_SAVE_FORMAT = 1;
pub const REG_SZ: REG_VALUE_TYPE = 1;
pub const REG_USE_CURRENT_SECURITY_CONTEXT: u32 = 2;
pub type REG_VALUE_TYPE = u32;
pub const REG_WHOLE_HIVE_VOLATILE: REG_RESTORE_KEY_FLAGS = 1;
pub const RRF_NOEXPAND: REG_ROUTINE_FLAGS = 268435456;
pub const RRF_RT_ANY: REG_ROUTINE_FLAGS = 65535;
pub const RRF_RT_DWORD: REG_ROUTINE_FLAGS = 24;
pub const RRF_RT_QWORD: REG_ROUTINE_FLAGS = 72;
pub const RRF_RT_REG_BINARY: REG_ROUTINE_FLAGS = 8;
pub const RRF_RT_REG_DWORD: REG_ROUTINE_FLAGS = 16;
pub const RRF_RT_REG_EXPAND_SZ: REG_ROUTINE_FLAGS = 4;
pub const RRF_RT_REG_MULTI_SZ: REG_ROUTINE_FLAGS = 32;
pub const RRF_RT_REG_NONE: REG_ROUTINE_FLAGS = 1;
pub const RRF_RT_REG_QWORD: REG_ROUTINE_FLAGS = 64;
pub const RRF_RT_REG_SZ: REG_ROUTINE_FLAGS = 2;
pub const RRF_SUBKEY_WOW6432KEY: REG_ROUTINE_FLAGS = 131072;
pub const RRF_SUBKEY_WOW6464KEY: REG_ROUTINE_FLAGS = 65536;
pub const RRF_WOW64_MASK: REG_ROUTINE_FLAGS = 196608;
pub const RRF_ZEROONFAILURE: REG_ROUTINE_FLAGS = 536870912;
