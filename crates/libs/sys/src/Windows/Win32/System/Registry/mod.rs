...
pub type RegCloseKey = unsafe extern "system" fn(hkey: HKEY) -> super::super::Foundation::WIN32_ERROR;
windows_link::link!("advapi32.dll" "system" fn RegCloseKey(hkey : HKEY) -> super::super::Foundation::WIN32_ERROR);
pub type RegConnectRegistryA = unsafe extern "system" fn(lpmachinename: windows_sys::core::PCSTR, hkey: HKEY, phkresult: *mut HKEY) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegConnectRegistryExA = unsafe extern "system" fn(lpmachinename: windows_sys::core::PCSTR, hkey: HKEY, flags: u32, phkresult: *mut HKEY) -> i32;
...
pub type RegConnectRegistryExW = unsafe extern "system" fn(lpmachinename: windows_sys::core::PCWSTR, hkey: HKEY, flags: u32, phkresult: *mut HKEY) -> i32;
...
pub type RegConnectRegistryW = unsafe extern "system" fn(lpmachinename: windows_sys::core::PCWSTR, hkey: HKEY, phkresult: *mut HKEY) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegCopyTreeA = unsafe extern "system" fn(hkeysrc: HKEY, lpsubkey: windows_sys::core::PCSTR, hkeydest: HKEY) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegCopyTreeW = unsafe extern "system" fn(hkeysrc: HKEY, lpsubkey: windows_sys::core::PCWSTR, hkeydest: HKEY) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegCreateKeyA = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCSTR, phkresult: *mut HKEY) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegDeleteKeyA = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegDeleteKeyExA = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCSTR, samdesired: u32, reserved: u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegDeleteKeyExW = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCWSTR, samdesired: u32, reserved: u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegDeleteKeyTransactedA = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCSTR, samdesired: u32, reserved: u32, htransaction: super::super::Foundation::HANDLE, pextendedparameter: *const core::ffi::c_void) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegDeleteKeyTransactedW = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCWSTR, samdesired: u32, reserved: u32, htransaction: super::super::Foundation::HANDLE, pextendedparameter: *const core::ffi::c_void) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegDeleteKeyValueA = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCSTR, lpvaluename: windows_sys::core::PCSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegDeleteKeyValueW = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCWSTR, lpvaluename: windows_sys::core::PCWSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegDeleteKeyW = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCWSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegDeleteTreeA = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegDeleteTreeW = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCWSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegDeleteValueA = unsafe extern "system" fn(hkey: HKEY, lpvaluename: windows_sys::core::PCSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegDeleteValueW = unsafe extern "system" fn(hkey: HKEY, lpvaluename: windows_sys::core::PCWSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegDisablePredefinedCache = unsafe extern "system" fn() -> super::super::Foundation::WIN32_ERROR;
windows_link::link!("advapi32.dll" "system" fn RegDisablePredefinedCache() -> super::super::Foundation::WIN32_ERROR);
pub type RegDisablePredefinedCacheEx = unsafe extern "system" fn() -> super::super::Foundation::WIN32_ERROR;
windows_link::link!("advapi32.dll" "system" fn RegDisablePredefinedCacheEx() -> super::super::Foundation::WIN32_ERROR);
pub type RegDisableReflectionKey = unsafe extern "system" fn(hbase: HKEY) -> super::super::Foundation::WIN32_ERROR;
windows_link::link!("advapi32.dll" "system" fn RegDisableReflectionKey(hbase : HKEY) -> super::super::Foundation::WIN32_ERROR);
pub type RegEnableReflectionKey = unsafe extern "system" fn(hbase: HKEY) -> super::super::Foundation::WIN32_ERROR;
windows_link::link!("advapi32.dll" "system" fn RegEnableReflectionKey(hbase : HKEY) -> super::super::Foundation::WIN32_ERROR);
pub type RegEnumKeyA = unsafe extern "system" fn(hkey: HKEY, dwindex: u32, lpname: windows_sys::core::PSTR, cchname: u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegEnumKeyExA = unsafe extern "system" fn(hkey: HKEY, dwindex: u32, lpname: windows_sys::core::PSTR, lpcchname: *mut u32, lpreserved: *const u32, lpclass: windows_sys::core::PSTR, lpcchclass: *mut u32, lpftlastwritetime: *mut super::super::Foundation::FILETIME) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegEnumKeyExW = unsafe extern "system" fn(hkey: HKEY, dwindex: u32, lpname: windows_sys::core::PWSTR, lpcchname: *mut u32, lpreserved: *const u32, lpclass: windows_sys::core::PWSTR, lpcchclass: *mut u32, lpftlastwritetime: *mut super::super::Foundation::FILETIME) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegEnumKeyW = unsafe extern "system" fn(hkey: HKEY, dwindex: u32, lpname: windows_sys::core::PWSTR, cchname: u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegEnumValueA = unsafe extern "system" fn(hkey: HKEY, dwindex: u32, lpvaluename: windows_sys::core::PSTR, lpcchvaluename: *mut u32, lpreserved: *const u32, lptype: *mut u32, lpdata: *mut u8, lpcbdata: *mut u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegEnumValueW = unsafe extern "system" fn(hkey: HKEY, dwindex: u32, lpvaluename: windows_sys::core::PWSTR, lpcchvaluename: *mut u32, lpreserved: *const u32, lptype: *mut u32, lpdata: *mut u8, lpcbdata: *mut u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegFlushKey = unsafe extern "system" fn(hkey: HKEY) -> super::super::Foundation::WIN32_ERROR;
windows_link::link!("advapi32.dll" "system" fn RegFlushKey(hkey : HKEY) -> super::super::Foundation::WIN32_ERROR);
#[cfg(feature = "Win32_Security")]
pub type RegGetKeySecurity = unsafe extern "system" fn(hkey: HKEY, securityinformation: super::super::Security::OBJECT_SECURITY_INFORMATION, psecuritydescriptor: super::super::Security::PSECURITY_DESCRIPTOR, lpcbsecuritydescriptor: *mut u32) -> super::super::Foundation::WIN32_ERROR;
#[cfg(feature = "Win32_Security")]
...
pub type RegGetValueA = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCSTR, lpvalue: windows_sys::core::PCSTR, dwflags: REG_ROUTINE_FLAGS, pdwtype: *mut REG_VALUE_TYPE, pvdata: *mut core::ffi::c_void, pcbdata: *mut u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegGetValueW = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCWSTR, lpvalue: windows_sys::core::PCWSTR, dwflags: REG_ROUTINE_FLAGS, pdwtype: *mut REG_VALUE_TYPE, pvdata: *mut core::ffi::c_void, pcbdata: *mut u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegLoadAppKeyA = unsafe extern "system" fn(lpfile: windows_sys::core::PCSTR, phkresult: *mut HKEY, samdesired: u32, dwoptions: u32, reserved: u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegLoadAppKeyW = unsafe extern "system" fn(lpfile: windows_sys::core::PCWSTR, phkresult: *mut HKEY, samdesired: u32, dwoptions: u32, reserved: u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegLoadKeyA = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCSTR, lpfile: windows_sys::core::PCSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegLoadKeyW = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCWSTR, lpfile: windows_sys::core::PCWSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegLoadMUIStringA = unsafe extern "system" fn(hkey: HKEY, pszvalue: windows_sys::core::PCSTR, pszoutbuf: windows_sys::core::PSTR, cboutbuf: u32, pcbdata: *mut u32, flags: u32, pszdirectory: windows_sys::core::PCSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegLoadMUIStringW = unsafe extern "system" fn(hkey: HKEY, pszvalue: windows_sys::core::PCWSTR, pszoutbuf: windows_sys::core::PWSTR, cboutbuf: u32, pcbdata: *mut u32, flags: u32, pszdirectory: windows_sys::core::PCWSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegNotifyChangeKeyValue = unsafe extern "system" fn(hkey: HKEY, bwatchsubtree: windows_sys::core::BOOL, dwnotifyfilter: REG_NOTIFY_FILTER, hevent: super::super::Foundation::HANDLE, fasynchronous: windows_sys::core::BOOL) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegOpenCurrentUser = unsafe extern "system" fn(samdesired: u32, phkresult: *mut HKEY) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegOpenKeyA = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCSTR, phkresult: *mut HKEY) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegOpenKeyExA = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCSTR, uloptions: u32, samdesired: REG_SAM_FLAGS, phkresult: *mut HKEY) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegOpenKeyExW = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCWSTR, uloptions: u32, samdesired: REG_SAM_FLAGS, phkresult: *mut HKEY) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegOpenKeyTransactedA = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCSTR, uloptions: u32, samdesired: REG_SAM_FLAGS, phkresult: *mut HKEY, htransaction: super::super::Foundation::HANDLE, pextendedparemeter: *const core::ffi::c_void) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegOpenKeyTransactedW = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCWSTR, uloptions: u32, samdesired: REG_SAM_FLAGS, phkresult: *mut HKEY, htransaction: super::super::Foundation::HANDLE, pextendedparemeter: *const core::ffi::c_void) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegOpenKeyW = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCWSTR, phkresult: *mut HKEY) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegOpenUserClassesRoot = unsafe extern "system" fn(htoken: super::super::Foundation::HANDLE, dwoptions: u32, samdesired: u32, phkresult: *mut HKEY) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegQueryInfoKeyW = unsafe extern "system" fn(hkey: HKEY, lpclass: windows_sys::core::PWSTR, lpcchclass: *mut u32, lpreserved: *const u32, lpcsubkeys: *mut u32, lpcbmaxsubkeylen: *mut u32, lpcbmaxclasslen: *mut u32, lpcvalues: *mut u32, lpcbmaxvaluenamelen: *mut u32, lpcbmaxvaluelen: *mut u32, lpcbsecuritydescriptor: *mut u32, lpftlastwritetime: *mut super::super::Foundation::FILETIME) -> super::super::Foundation::WIN32_ERROR;
windows_link::link!("advapi32.dll" "system" fn RegQueryInfoKeyW(hkey : HKEY, lpclass : windows_sys::core::PWSTR, lpcchclass : *mut u32, lpreserved : *const u32, lpcsubkeys : *mut u32, lpcbmaxsubkeylen : *mut u32, lpcbmaxclasslen : *mut u32, lpcvalues : *mut u32, lpcbmaxvaluenamelen : *mut u32, lpcbmaxvaluelen : *mut u32, lpcbsecuritydescriptor : *mut u32, lpftlastwritetime : *mut super::super::Foundation::FILETIME) -> super::super::Foundation::WIN32_ERROR);
pub type RegQueryMultipleValuesA = unsafe extern "system" fn(hkey: HKEY, val_list: *mut VALENTA, num_vals: u32, lpvaluebuf: windows_sys::core::PSTR, ldwtotsize: *mut u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegQueryMultipleValuesW = unsafe extern "system" fn(hkey: HKEY, val_list: *mut VALENTW, num_vals: u32, lpvaluebuf: windows_sys::core::PWSTR, ldwtotsize: *mut u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegQueryReflectionKey = unsafe extern "system" fn(hbase: HKEY, bisreflectiondisabled: *mut windows_sys::core::BOOL) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegQueryValueA = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCSTR, lpdata: windows_sys::core::PSTR, lpcbdata: *mut i32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegQueryValueExA = unsafe extern "system" fn(hkey: HKEY, lpvaluename: windows_sys::core::PCSTR, lpreserved: *const u32, lptype: *mut REG_VALUE_TYPE, lpdata: *mut u8, lpcbdata: *mut u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegQueryValueExW = unsafe extern "system" fn(hkey: HKEY, lpvaluename: windows_sys::core::PCWSTR, lpreserved: *const u32, lptype: *mut REG_VALUE_TYPE, lpdata: *mut u8, lpcbdata: *mut u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegQueryValueW = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCWSTR, lpdata: windows_sys::core::PWSTR, lpcbdata: *mut i32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegRenameKey = unsafe extern "system" fn(hkey: HKEY, lpsubkeyname: windows_sys::core::PCWSTR, lpnewkeyname: windows_sys::core::PCWSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegReplaceKeyA = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCSTR, lpnewfile: windows_sys::core::PCSTR, lpoldfile: windows_sys::core::PCSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegReplaceKeyW = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCWSTR, lpnewfile: windows_sys::core::PCWSTR, lpoldfile: windows_sys::core::PCWSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegRestoreKeyA = unsafe extern "system" fn(hkey: HKEY, lpfile: windows_sys::core::PCSTR, dwflags: u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegRestoreKeyW = unsafe extern "system" fn(hkey: HKEY, lpfile: windows_sys::core::PCWSTR, dwflags: u32) -> super::super::Foundation::WIN32_ERROR;
...
#[cfg(feature = "Win32_Security")]
pub type RegSaveKeyA = unsafe extern "system" fn(hkey: HKEY, lpfile: windows_sys::core::PCSTR, lpsecurityattributes: *const super::super::Security::SECURITY_ATTRIBUTES) -> super::super::Foundation::WIN32_ERROR;
#[cfg(feature = "Win32_Security")]
...
#[cfg(feature = "Win32_Security")]
pub type RegSaveKeyExA = unsafe extern "system" fn(hkey: HKEY, lpfile: windows_sys::core::PCSTR, lpsecurityattributes: *const super::super::Security::SECURITY_ATTRIBUTES, flags: REG_SAVE_FORMAT) -> super::super::Foundation::WIN32_ERROR;
#[cfg(feature = "Win32_Security")]
...
#[cfg(feature = "Win32_Security")]
pub type RegSaveKeyExW = unsafe extern "system" fn(hkey: HKEY, lpfile: windows_sys::core::PCWSTR, lpsecurityattributes: *const super::super::Security::SECURITY_ATTRIBUTES, flags: REG_SAVE_FORMAT) -> super::super::Foundation::WIN32_ERROR;
#[cfg(feature = "Win32_Security")]
...
#[cfg(feature = "Win32_Security")]
pub type RegSaveKeyW = unsafe extern "system" fn(hkey: HKEY, lpfile: windows_sys::core::PCWSTR, lpsecurityattributes: *const super::super::Security::SECURITY_ATTRIBUTES) -> super::super::Foundation::WIN32_ERROR;
#[cfg(feature = "Win32_Security")]
...
#[cfg(feature = "Win32_Security")]
pub type RegSetKeySecurity = unsafe extern "system" fn(hkey: HKEY, securityinformation: super::super::Security::OBJECT_SECURITY_INFORMATION, psecuritydescriptor: super::super::Security::PSECURITY_DESCRIPTOR) -> super::super::Foundation::WIN32_ERROR;
#[cfg(feature = "Win32_Security")]
...
pub type RegSetKeyValueA = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCSTR, lpvaluename: windows_sys::core::PCSTR, dwtype: u32, lpdata: *const core::ffi::c_void, cbdata: u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegSetKeyValueW = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCWSTR, lpvaluename: windows_sys::core::PCWSTR, dwtype: u32, lpdata: *const core::ffi::c_void, cbdata: u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegSetValueA = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCSTR, dwtype: REG_VALUE_TYPE, lpdata: windows_sys::core::PCSTR, cbdata: u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegSetValueExA = unsafe extern "system" fn(hkey: HKEY, lpvaluename: windows_sys::core::PCSTR, reserved: u32, dwtype: REG_VALUE_TYPE, lpdata: *const u8, cbdata: u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegSetValueExW = unsafe extern "system" fn(hkey: HKEY, lpvaluename: windows_sys::core::PCWSTR, reserved: u32, dwtype: REG_VALUE_TYPE, lpdata: *const u8, cbdata: u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegSetValueW = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCWSTR, dwtype: REG_VALUE_TYPE, lpdata: windows_sys::core::PCWSTR, cbdata: u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegUnLoadKeyA = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCSTR) -> super::super::Foundation::WIN32_ERROR;
...
pub type RegUnLoadKeyW = unsafe extern "system" fn(hkey: HKEY, lpsubkey: windows_sys::core::PCWSTR) -> super::super::Foundation::WIN32_ERROR;
