...
pub const HcsCreateOptions_1: HCS_CREATE_OPTIONS = 65536;
pub const HcsEventGroupLiveMigration: HCS_EVENT_TYPE = -2147483645;
pub const HcsEventGroupOperationInfo: HCS_EVENT_TYPE = -1073741823;
pub const HcsEventGroupVmLifecycle: HCS_EVENT_TYPE = -2147483646;
pub const HcsEventInvalid: HCS_EVENT_TYPE = 0;
pub const HcsEventOperationCallback: HCS_EVENT_TYPE = 16777216;
pub const HcsEventOptionEnableLiveMigrationEvents: HCS_EVENT_OPTIONS = 4;
pub const HcsEventOptionEnableOperationCallbacks: HCS_EVENT_OPTIONS = 1;
pub const HcsEventOptionEnableVmLifecycle: HCS_EVENT_OPTIONS = 2;
pub const HcsEventOptionNone: HCS_EVENT_OPTIONS = 0;
pub const HcsEventProcessExited: HCS_EVENT_TYPE = 65536;
pub const HcsEventServiceDisconnect: HCS_EVENT_TYPE = 33554432;
pub const HcsEventSystemCrashInitiated: HCS_EVENT_TYPE = 2;
pub const HcsEventSystemCrashReport: HCS_EVENT_TYPE = 3;
pub const HcsEventSystemExited: HCS_EVENT_TYPE = 1;
pub const HcsEventSystemGuestConnectionClosed: HCS_EVENT_TYPE = 6;
pub const HcsEventSystemRdpEnhancedModeStateChanged: HCS_EVENT_TYPE = 4;
pub const HcsEventSystemSiloJobCreated: HCS_EVENT_TYPE = 5;
pub const HcsNotificationFlagFailure: HCS_NOTIFICATION_FLAGS = -2147483648;
pub const HcsNotificationFlagSuccess: HCS_NOTIFICATION_FLAGS = 0;
pub const HcsNotificationFlagsReserved: HCS_NOTIFICATIONS = -268435456;
pub const HcsNotificationInvalid: HCS_NOTIFICATIONS = 0;
pub const HcsNotificationOperationProgressUpdate: HCS_NOTIFICATIONS = 256;
pub const HcsNotificationProcessExited: HCS_NOTIFICATIONS = 65536;
pub const HcsNotificationServiceDisconnect: HCS_NOTIFICATIONS = 16777216;
pub const HcsNotificationSystemCrashInitiated: HCS_NOTIFICATIONS = 13;
pub const HcsNotificationSystemCrashReport: HCS_NOTIFICATIONS = 6;
pub const HcsNotificationSystemCreateCompleted: HCS_NOTIFICATIONS = 2;
pub const HcsNotificationSystemExited: HCS_NOTIFICATIONS = 1;
pub const HcsNotificationSystemGetPropertiesCompleted: HCS_NOTIFICATIONS = 11;
pub const HcsNotificationSystemGuestConnectionClosed: HCS_NOTIFICATIONS = 14;
pub const HcsNotificationSystemModifyCompleted: HCS_NOTIFICATIONS = 12;
pub const HcsNotificationSystemOperationCompletion: HCS_NOTIFICATIONS = 15;
pub const HcsNotificationSystemPassThru: HCS_NOTIFICATIONS = 16;
pub const HcsNotificationSystemPauseCompleted: HCS_NOTIFICATIONS = 4;
pub const HcsNotificationSystemRdpEnhancedModeStateChanged: HCS_NOTIFICATIONS = 9;
pub const HcsNotificationSystemResumeCompleted: HCS_NOTIFICATIONS = 5;
pub const HcsNotificationSystemSaveCompleted: HCS_NOTIFICATIONS = 8;
pub const HcsNotificationSystemShutdownCompleted: HCS_NOTIFICATIONS = 10;
pub const HcsNotificationSystemShutdownFailed: HCS_NOTIFICATIONS = 10;
pub const HcsNotificationSystemSiloJobCreated: HCS_NOTIFICATIONS = 7;
pub const HcsNotificationSystemStartCompleted: HCS_NOTIFICATIONS = 3;
pub const HcsOperationOptionNone: HCS_OPERATION_OPTIONS = 0;
pub const HcsOperationOptionProgressUpdate: HCS_OPERATION_OPTIONS = 1;
pub const HcsOperationOptionReserved1: HCS_OPERATION_OPTIONS = 2;
pub const HcsOperationTypeCrash: HCS_OPERATION_TYPE = 15;
pub const HcsOperationTypeCreate: HCS_OPERATION_TYPE = 1;
pub const HcsOperationTypeCreateProcess: HCS_OPERATION_TYPE = 10;
pub const HcsOperationTypeEnumerate: HCS_OPERATION_TYPE = 0;
pub const HcsOperationTypeGetProcessInfo: HCS_OPERATION_TYPE = 12;
pub const HcsOperationTypeGetProcessProperties: HCS_OPERATION_TYPE = 13;
pub const HcsOperationTypeGetProperties: HCS_OPERATION_TYPE = 9;
pub const HcsOperationTypeLiveMigration: HCS_OPERATION_TYPE = 19;
pub const HcsOperationTypeModify: HCS_OPERATION_TYPE = 8;
pub const HcsOperationTypeModifyProcess: HCS_OPERATION_TYPE = 14;
pub const HcsOperationTypeNone: HCS_OPERATION_TYPE = -1;
pub const HcsOperationTypePause: HCS_OPERATION_TYPE = 4;
pub const HcsOperationTypeReserved1: HCS_OPERATION_TYPE = 16;
pub const HcsOperationTypeReserved2: HCS_OPERATION_TYPE = 17;
pub const HcsOperationTypeReserved3: HCS_OPERATION_TYPE = 18;
pub const HcsOperationTypeResume: HCS_OPERATION_TYPE = 5;
pub const HcsOperationTypeSave: HCS_OPERATION_TYPE = 6;
pub const HcsOperationTypeShutdown: HCS_OPERATION_TYPE = 3;
pub const HcsOperationTypeSignalProcess: HCS_OPERATION_TYPE = 11;
pub const HcsOperationTypeStart: HCS_OPERATION_TYPE = 2;
pub const HcsOperationTypeTerminate: HCS_OPERATION_TYPE = 7;
pub const HcsResourceTypeComObject: HCS_RESOURCE_TYPE = 3;
pub const HcsResourceTypeFile: HCS_RESOURCE_TYPE = 1;
pub const HcsResourceTypeJob: HCS_RESOURCE_TYPE = 2;
pub const HcsResourceTypeNone: HCS_RESOURCE_TYPE = 0;
pub const HcsResourceTypeSocket: HCS_RESOURCE_TYPE = 4;
