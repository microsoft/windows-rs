pub type HcsAddResourceToOperation = unsafe extern "system" fn(operation: HCS_OPERATION, r#type: HCS_RESOURCE_TYPE, uri: windows_sys::core::PCWSTR, handle: super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type HcsAttachLayerStorageFilter = unsafe extern "system" fn(layerpath: windows_sys::core::PCWSTR, layerdata: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsAttachOverlayFilter = unsafe extern "system" fn(volumemountpoint: windows_sys::core::PCWSTR, layerdata: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsCrashComputeSystem = unsafe extern "system" fn(computesystem: HCS_SYSTEM, operation: HCS_OPERATION, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsCreateComputeSystem = unsafe extern "system" fn(id: windows_sys::core::PCWSTR, configuration: windows_sys::core::PCWSTR, operation: HCS_OPERATION, securitydescriptor: *const super::super::Security::SECURITY_DESCRIPTOR, computesystem: *mut HCS_SYSTEM) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Security")]
...
pub type HcsCreateComputeSystemInNamespace = unsafe extern "system" fn(idnamespace: windows_sys::core::PCWSTR, id: windows_sys::core::PCWSTR, configuration: windows_sys::core::PCWSTR, operation: HCS_OPERATION, options: *const HCS_CREATE_OPTIONS, computesystem: *mut HCS_SYSTEM) -> windows_sys::core::HRESULT;
...
pub type HcsCreateEmptyGuestStateFile = unsafe extern "system" fn(gueststatefilepath: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsCreateEmptyRuntimeStateFile = unsafe extern "system" fn(runtimestatefilepath: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsCreateOperationWithNotifications = unsafe extern "system" fn(eventtypes: HCS_OPERATION_OPTIONS, context: *const core::ffi::c_void, callback: HCS_EVENT_CALLBACK) -> HCS_OPERATION;
...
#[cfg(feature = "Win32_Security")]
pub type HcsCreateProcess = unsafe extern "system" fn(computesystem: HCS_SYSTEM, processparameters: windows_sys::core::PCWSTR, operation: HCS_OPERATION, securitydescriptor: *const super::super::Security::SECURITY_DESCRIPTOR, process: *mut HCS_PROCESS) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Security")]
...
pub type HcsDestroyLayer = unsafe extern "system" fn(layerpath: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsDetachLayerStorageFilter = unsafe extern "system" fn(layerpath: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsDetachOverlayFilter = unsafe extern "system" fn(volumemountpoint: windows_sys::core::PCWSTR, layerdata: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsEnumerateComputeSystems = unsafe extern "system" fn(query: windows_sys::core::PCWSTR, operation: HCS_OPERATION) -> windows_sys::core::HRESULT;
...
pub type HcsEnumerateComputeSystemsInNamespace = unsafe extern "system" fn(idnamespace: windows_sys::core::PCWSTR, query: windows_sys::core::PCWSTR, operation: HCS_OPERATION) -> windows_sys::core::HRESULT;
...
pub type HcsExportLayer = unsafe extern "system" fn(layerpath: windows_sys::core::PCWSTR, exportfolderpath: windows_sys::core::PCWSTR, layerdata: windows_sys::core::PCWSTR, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsExportLegacyWritableLayer = unsafe extern "system" fn(writablelayermountpath: windows_sys::core::PCWSTR, writablelayerfolderpath: windows_sys::core::PCWSTR, exportfolderpath: windows_sys::core::PCWSTR, layerdata: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsFinalizeLiveMigration = unsafe extern "system" fn(computesystem: HCS_SYSTEM, operation: HCS_OPERATION, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsGetComputeSystemProperties = unsafe extern "system" fn(computesystem: HCS_SYSTEM, operation: HCS_OPERATION, propertyquery: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsGetLayerVhdMountPath = unsafe extern "system" fn(vhdhandle: super::super::Foundation::HANDLE, mountpath: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsGetOperationProperties = unsafe extern "system" fn(operation: HCS_OPERATION, options: windows_sys::core::PCWSTR, resultdocument: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsGetOperationResult = unsafe extern "system" fn(operation: HCS_OPERATION, resultdocument: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsGetOperationResultAndProcessInfo = unsafe extern "system" fn(operation: HCS_OPERATION, processinformation: *mut HCS_PROCESS_INFORMATION, resultdocument: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsGetProcessProperties = unsafe extern "system" fn(process: HCS_PROCESS, operation: HCS_OPERATION, propertyquery: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsGetProcessorCompatibilityFromSavedState = unsafe extern "system" fn(runtimefilename: windows_sys::core::PCWSTR, processorfeaturesstring: *mut windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsGetServiceProperties = unsafe extern "system" fn(propertyquery: windows_sys::core::PCWSTR, result: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsGrantVmAccess = unsafe extern "system" fn(vmid: windows_sys::core::PCWSTR, filepath: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsGrantVmGroupAccess = unsafe extern "system" fn(filepath: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsImportLayer = unsafe extern "system" fn(layerpath: windows_sys::core::PCWSTR, sourcefolderpath: windows_sys::core::PCWSTR, layerdata: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsInitializeLegacyWritableLayer = unsafe extern "system" fn(writablelayermountpath: windows_sys::core::PCWSTR, writablelayerfolderpath: windows_sys::core::PCWSTR, layerdata: windows_sys::core::PCWSTR, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsInitializeLiveMigrationOnSource = unsafe extern "system" fn(computesystem: HCS_SYSTEM, operation: HCS_OPERATION, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsInitializeWritableLayer = unsafe extern "system" fn(writablelayerpath: windows_sys::core::PCWSTR, layerdata: windows_sys::core::PCWSTR, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsModifyComputeSystem = unsafe extern "system" fn(computesystem: HCS_SYSTEM, operation: HCS_OPERATION, configuration: windows_sys::core::PCWSTR, identity: super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type HcsModifyProcess = unsafe extern "system" fn(process: HCS_PROCESS, operation: HCS_OPERATION, settings: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsModifyServiceSettings = unsafe extern "system" fn(settings: windows_sys::core::PCWSTR, result: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsOpenComputeSystem = unsafe extern "system" fn(id: windows_sys::core::PCWSTR, requestedaccess: u32, computesystem: *mut HCS_SYSTEM) -> windows_sys::core::HRESULT;
...
pub type HcsOpenComputeSystemInNamespace = unsafe extern "system" fn(idnamespace: windows_sys::core::PCWSTR, id: windows_sys::core::PCWSTR, requestedaccess: u32, computesystem: *mut HCS_SYSTEM) -> windows_sys::core::HRESULT;
...
pub type HcsPauseComputeSystem = unsafe extern "system" fn(computesystem: HCS_SYSTEM, operation: HCS_OPERATION, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsResumeComputeSystem = unsafe extern "system" fn(computesystem: HCS_SYSTEM, operation: HCS_OPERATION, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsRevokeVmAccess = unsafe extern "system" fn(vmid: windows_sys::core::PCWSTR, filepath: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsRevokeVmGroupAccess = unsafe extern "system" fn(filepath: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsSaveComputeSystem = unsafe extern "system" fn(computesystem: HCS_SYSTEM, operation: HCS_OPERATION, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsSetupBaseOSLayer = unsafe extern "system" fn(layerpath: windows_sys::core::PCWSTR, vhdhandle: super::super::Foundation::HANDLE, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsSetupBaseOSVolume = unsafe extern "system" fn(layerpath: windows_sys::core::PCWSTR, volumepath: windows_sys::core::PCWSTR, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsShutDownComputeSystem = unsafe extern "system" fn(computesystem: HCS_SYSTEM, operation: HCS_OPERATION, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsSignalProcess = unsafe extern "system" fn(process: HCS_PROCESS, operation: HCS_OPERATION, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsStartComputeSystem = unsafe extern "system" fn(computesystem: HCS_SYSTEM, operation: HCS_OPERATION, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsStartLiveMigrationOnSource = unsafe extern "system" fn(computesystem: HCS_SYSTEM, operation: HCS_OPERATION, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
windows_link::link!("computecore.dll" "system" fn HcsStartLiveMigrationOnSource(computesystem : HCS_SYSTEM, operation : HCS_OPERATION, options : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
pub type HcsStartLiveMigrationTransfer = unsafe extern "system" fn(computesystem: HCS_SYSTEM, operation: HCS_OPERATION, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
windows_link::link!("computecore.dll" "system" fn HcsStartLiveMigrationTransfer(computesystem : HCS_SYSTEM, operation : HCS_OPERATION, options : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
pub type HcsSubmitWerReport = unsafe extern "system" fn(settings: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
windows_link::link!("computecore.dll" "system" fn HcsSubmitWerReport(settings : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
pub type HcsTerminateComputeSystem = unsafe extern "system" fn(computesystem: HCS_SYSTEM, operation: HCS_OPERATION, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsTerminateProcess = unsafe extern "system" fn(process: HCS_PROCESS, operation: HCS_OPERATION, options: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsWaitForComputeSystemExit = unsafe extern "system" fn(computesystem: HCS_SYSTEM, timeoutms: u32, result: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsWaitForOperationResult = unsafe extern "system" fn(operation: HCS_OPERATION, timeoutms: u32, resultdocument: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsWaitForOperationResultAndProcessInfo = unsafe extern "system" fn(operation: HCS_OPERATION, timeoutms: u32, processinformation: *mut HCS_PROCESS_INFORMATION, resultdocument: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type HcsWaitForProcessExit = unsafe extern "system" fn(computesystem: HCS_PROCESS, timeoutms: u32, result: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub const HcsEventGroupLiveMigration: HCS_EVENT_TYPE = -2147483645i32;
...
pub const HcsEventOptionEnableLiveMigrationEvents: HCS_EVENT_OPTIONS = 4i32;
...
pub const HcsOperationOptionReserved1: HCS_OPERATION_OPTIONS = 2i32;
...
pub const HcsOperationTypeLiveMigration: HCS_OPERATION_TYPE = 19i32;
...
pub const HcsOperationTypeReserved1: HCS_OPERATION_TYPE = 16i32;
pub const HcsOperationTypeReserved2: HCS_OPERATION_TYPE = 17i32;
pub const HcsOperationTypeReserved3: HCS_OPERATION_TYPE = 18i32;
...
pub const HcsResourceTypeComObject: HCS_RESOURCE_TYPE = 3i32;
...
pub const HcsResourceTypeSocket: HCS_RESOURCE_TYPE = 4i32;
