...
windows_link::link!("ntdll.dll" "system" fn RtlInitializeCorrelationVector(correlationvector : *mut CORRELATION_VECTOR, version : i32, guid : *mut windows_sys::core::GUID) -> u32);
windows_link::link!("ntdll.dll" "system" fn RtlValidateCorrelationVector(vector : *mut CORRELATION_VECTOR) -> u32);
#[repr(C)]
#[derive(Clone, Copy)]
