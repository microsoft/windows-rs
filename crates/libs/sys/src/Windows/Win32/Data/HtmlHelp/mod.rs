...
::windows_sys::core::link ! ( "htmlhelp.dll" ,"system" fn HtmlHelpA ( hwndcaller : super::super::Foundation:: HWND , pszfile : :: windows_sys::core::PCSTR , ucommand : u32 , dwdata : usize ) -> super::super::Foundation:: HWND );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "htmlhelp.dll" ,"system" fn HtmlHelpW ( hwndcaller : super::super::Foundation:: HWND , pszfile : :: windows_sys::core::PCWSTR , ucommand : u32 , dwdata : usize ) -> super::super::Foundation:: HWND );
