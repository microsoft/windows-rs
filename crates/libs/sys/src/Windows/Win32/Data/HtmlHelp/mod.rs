pub type HtmlHelpA = unsafe extern "system" fn(hwndcaller: super::super::Foundation::HWND, pszfile: windows_sys::core::PCSTR, ucommand: u32, dwdata: usize) -> super::super::Foundation::HWND;
...
pub type HtmlHelpW = unsafe extern "system" fn(hwndcaller: super::super::Foundation::HWND, pszfile: windows_sys::core::PCWSTR, ucommand: u32, dwdata: usize) -> super::super::Foundation::HWND;
