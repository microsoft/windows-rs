...
::windows_sys::core::windows_link ! ( "xmllite.dll" ,"system" fn CreateXmlReader ( riid : *const :: windows_sys::core::GUID , ppvobject : *mut *mut ::core::ffi::c_void , pmalloc : super::super::super::System::Com:: IMalloc ) -> :: windows_sys::core::HRESULT );
...
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::windows_link ! ( "xmllite.dll" ,"system" fn CreateXmlWriter ( riid : *const :: windows_sys::core::GUID , ppvobject : *mut *mut ::core::ffi::c_void , pmalloc : super::super::super::System::Com:: IMalloc ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::windows_link ! ( "xmllite.dll" ,"system" fn CreateXmlWriterOutputWithEncodingCodePage ( poutputstream : :: windows_sys::core::IUnknown , pmalloc : super::super::super::System::Com:: IMalloc , nencodingcodepage : u32 , ppoutput : *mut :: windows_sys::core::IUnknown ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::windows_link ! ( "xmllite.dll" ,"system" fn CreateXmlWriterOutputWithEncodingName ( poutputstream : :: windows_sys::core::IUnknown , pmalloc : super::super::super::System::Com:: IMalloc , pwszencodingname : :: windows_sys::core::PCWSTR , ppoutput : *mut :: windows_sys::core::IUnknown ) -> :: windows_sys::core::HRESULT );
