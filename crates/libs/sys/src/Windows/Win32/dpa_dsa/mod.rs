...
windows_link::link!("comctl32.dll" "system" fn DPA_Merge(hdpadest : *mut _DPA, hdpasrc : *const _DPA, dwflags : u32, pfncompare : PFNDACOMPARE, pfnmerge : PFNDPAMERGE, lparam : super::LPARAM) -> windows_sys::core::BOOL);
#[cfg(feature = "objidlbase")]
...
#[cfg(feature = "minwindef")]
windows_link::link!("comctl32.dll" "system" fn DPA_Search(hdpa : *const _DPA, pfind : *const core::ffi::c_void, istart : i32, pfncompare : PFNDACOMPARE, lparam : super::LPARAM, options : u32) -> i32);
windows_link::link!("comctl32.dll" "system" fn DPA_SetPtr(hdpa : *mut _DPA, i : i32, p : *const core::ffi::c_void) -> windows_sys::core::BOOL);
#[cfg(feature = "minwindef")]
windows_link::link!("comctl32.dll" "system" fn DPA_Sort(hdpa : *mut _DPA, pfncompare : PFNDACOMPARE, lparam : super::LPARAM) -> windows_sys::core::BOOL);
