...
pub const WIA_ERROR_BUSY: windows_sys::core::HRESULT = 0x80210006_u32 as _;
pub const WIA_ERROR_COVER_OPEN: windows_sys::core::HRESULT = 0x80210010_u32 as _;
pub const WIA_ERROR_DESTINATION: windows_sys::core::HRESULT = 0x80210012_u32 as _;
pub const WIA_ERROR_DEVICE_COMMUNICATION: windows_sys::core::HRESULT = 0x8021000A_u32 as _;
pub const WIA_ERROR_DEVICE_LOCKED: windows_sys::core::HRESULT = 0x8021000D_u32 as _;
pub const WIA_ERROR_EXCEPTION_IN_DRIVER: windows_sys::core::HRESULT = 0x8021000E_u32 as _;
pub const WIA_ERROR_GENERAL_ERROR: windows_sys::core::HRESULT = 0x80210001_u32 as _;
pub const WIA_ERROR_INCORRECT_HARDWARE_SETTING: windows_sys::core::HRESULT = 0x8021000C_u32 as _;
pub const WIA_ERROR_INVALID_COMMAND: windows_sys::core::HRESULT = 0x8021000B_u32 as _;
pub const WIA_ERROR_INVALID_DRIVER_RESPONSE: windows_sys::core::HRESULT = 0x8021000F_u32 as _;
pub const WIA_ERROR_ITEM_DELETED: windows_sys::core::HRESULT = 0x80210009_u32 as _;
pub const WIA_ERROR_LAMP_OFF: windows_sys::core::HRESULT = 0x80210011_u32 as _;
pub const WIA_ERROR_MAXIMUM_PRINTER_ENDORSER_COUNTER: windows_sys::core::HRESULT = 0x80210015_u32 as _;
pub const WIA_ERROR_MULTI_FEED: windows_sys::core::HRESULT = 0x80210014_u32 as _;
pub const WIA_ERROR_NETWORK_RESERVATION_FAILED: windows_sys::core::HRESULT = 0x80210013_u32 as _;
pub const WIA_ERROR_OFFLINE: windows_sys::core::HRESULT = 0x80210005_u32 as _;
pub const WIA_ERROR_PAPER_EMPTY: windows_sys::core::HRESULT = 0x80210003_u32 as _;
pub const WIA_ERROR_PAPER_JAM: windows_sys::core::HRESULT = 0x80210002_u32 as _;
pub const WIA_ERROR_PAPER_PROBLEM: windows_sys::core::HRESULT = 0x80210004_u32 as _;
pub const WIA_ERROR_USER_INTERVENTION: windows_sys::core::HRESULT = 0x80210008_u32 as _;
pub const WIA_ERROR_WARMING_UP: windows_sys::core::HRESULT = 0x80210007_u32 as _;
...
pub const WIA_STATUS_CALIBRATING: windows_sys::core::HRESULT = 0x210003_u32 as _;
pub const WIA_STATUS_CLEAR: windows_sys::core::HRESULT = 0x210008_u32 as _;
pub const WIA_STATUS_END_OF_MEDIA: windows_sys::core::HRESULT = 0x210001_u32 as _;
pub const WIA_STATUS_NETWORK_DEVICE_RESERVED: windows_sys::core::HRESULT = 0x210007_u32 as _;
pub const WIA_STATUS_NOT_HANDLED: windows_sys::core::HRESULT = 0x21000A_u32 as _;
pub const WIA_STATUS_RESERVING_NETWORK_DEVICE: windows_sys::core::HRESULT = 0x210006_u32 as _;
pub const WIA_STATUS_SKIP_ITEM: windows_sys::core::HRESULT = 0x210009_u32 as _;
pub const WIA_STATUS_WARMING_UP: windows_sys::core::HRESULT = 0x210002_u32 as _;
pub const WIA_S_CHANGE_DEVICE: windows_sys::core::HRESULT = 0x21000B_u32 as _;
pub const WIA_S_NO_DEVICE_AVAILABLE: windows_sys::core::HRESULT = 0x80210015_u32 as _;
