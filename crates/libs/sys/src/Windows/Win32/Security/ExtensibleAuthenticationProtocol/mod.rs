...
pub type EapHostPeerFreeEapError = unsafe extern "system" fn(peaperror: *const EAP_ERROR);
...
pub type EapHostPeerFreeRuntimeMemory = unsafe extern "system" fn(pdata: *const u8);
...
pub type EapHostPeerGetDataToUnplumbCredentials = unsafe extern "system" fn(pconnectionidthatlastsavedcreds: *mut windows_sys::core::GUID, phcredentialimpersonationtoken: *mut isize, sessionhandle: u32, ppeaperror: *mut *mut EAP_ERROR, fsavetocredman: *mut windows_sys::core::BOOL) -> u32;
...
pub type EapHostPeerGetEncryptedPassword = unsafe extern "system" fn(dwsizeofpassword: u32, szpassword: windows_sys::core::PCWSTR, ppszencpassword: *mut windows_sys::core::PWSTR) -> u32;
