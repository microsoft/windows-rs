...
windows_link::link!("srpapi.dll" "system" fn SrpDoesPolicyAllowAppExecution(packageid : *mut super::super::Storage::Packaging::Appx:: PACKAGE_ID, isallowed : *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT);
...
windows_link::link!("srpapi.dll" "system" fn SrpGetEnterpriseIds(tokenhandle : super::super::Foundation:: HANDLE, numberofbytes : *mut u32, enterpriseids : *mut windows_sys::core::PWSTR, enterpriseidcount : *mut u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("srpapi.dll" "system" fn SrpHostingInitialize(version : SRPHOSTING_VERSION, r#type : SRPHOSTING_TYPE, pvdata : *mut core::ffi::c_void, cbdata : u32) -> windows_sys::core::HRESULT);
