...
windows_link::link!("certadm.dll" "system" fn CertSrvBackupGetBackupLogsW(hbc : *mut core::ffi::c_void, ppwszzbackuplogfiles : *mut windows_sys::core::PWSTR, pcbsize : *mut u32) -> windows_sys::core::HRESULT);
windows_link::link!("certadm.dll" "system" fn CertSrvBackupGetDatabaseNamesW(hbc : *mut core::ffi::c_void, ppwszzattachmentinformation : *mut windows_sys::core::PWSTR, pcbsize : *mut u32) -> windows_sys::core::HRESULT);
windows_link::link!("certadm.dll" "system" fn CertSrvBackupGetDynamicFileListW(hbc : *mut core::ffi::c_void, ppwszzfilelist : *mut windows_sys::core::PWSTR, pcbsize : *mut u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("certadm.dll" "system" fn CertSrvRestoreGetDatabaseLocationsW(hbc : *mut core::ffi::c_void, ppwszzdatabaselocationlist : *mut windows_sys::core::PWSTR, pcbsize : *mut u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("certpoleng.dll" "system" fn PstAcquirePrivateKey(pcert : *mut super:: CERT_CONTEXT) -> super::super::super::Foundation:: NTSTATUS);
...
windows_link::link!("certpoleng.dll" "system" fn PstGetCertificates(ptargetname : *mut super::super::super::Foundation:: UNICODE_STRING, ccriteria : u32, rgpcriteria : *mut super:: CERT_SELECT_CRITERIA, bisclient : windows_sys::core::BOOL, pdwcertchaincontextcount : *mut u32, ppcertchaincontexts : *mut *mut *mut super:: CERT_CHAIN_CONTEXT) -> super::super::super::Foundation:: NTSTATUS);
#[cfg(feature = "Win32_Security_Authentication_Identity")]
...
windows_link::link!("certpoleng.dll" "system" fn PstValidate(ptargetname : *mut super::super::super::Foundation:: UNICODE_STRING, bisclient : windows_sys::core::BOOL, prequestedissuancepolicy : *mut super:: CERT_USAGE_MATCH, phadditionalcertstore : *mut super:: HCERTSTORE, pcert : *mut super:: CERT_CONTEXT, pprovguid : *mut windows_sys::core::GUID) -> super::super::super::Foundation:: NTSTATUS);
...
pub type FNCERTSRVBACKUPGETDYNAMICFILELISTW = Option<unsafe extern "system" fn(hbc: *mut core::ffi::c_void, ppwszzfilelist: *mut *mut u16, pcbsize: *mut u32) -> windows_sys::core::HRESULT>;
