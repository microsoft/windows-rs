pub type CertSrvBackupClose = unsafe extern "system" fn(hbc: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("certadm.dll" "system" fn CertSrvBackupClose(hbc : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type CertSrvBackupEnd = unsafe extern "system" fn(hbc: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("certadm.dll" "system" fn CertSrvBackupEnd(hbc : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type CertSrvBackupFree = unsafe extern "system" fn(pv: *mut core::ffi::c_void);
windows_link::link!("certadm.dll" "system" fn CertSrvBackupFree(pv : *mut core::ffi::c_void));
pub type CertSrvBackupGetBackupLogsW = unsafe extern "system" fn(hbc: *const core::ffi::c_void, ppwszzbackuplogfiles: *mut windows_sys::core::PWSTR, pcbsize: *mut u32) -> windows_sys::core::HRESULT;
...
pub type CertSrvBackupGetDatabaseNamesW = unsafe extern "system" fn(hbc: *const core::ffi::c_void, ppwszzattachmentinformation: *mut windows_sys::core::PWSTR, pcbsize: *mut u32) -> windows_sys::core::HRESULT;
...
pub type CertSrvBackupGetDynamicFileListW = unsafe extern "system" fn(hbc: *const core::ffi::c_void, ppwszzfilelist: *mut windows_sys::core::PWSTR, pcbsize: *mut u32) -> windows_sys::core::HRESULT;
...
pub type CertSrvBackupOpenFileW = unsafe extern "system" fn(hbc: *mut core::ffi::c_void, pwszattachmentname: windows_sys::core::PCWSTR, cbreadhintsize: u32, plifilesize: *mut i64) -> windows_sys::core::HRESULT;
...
pub type CertSrvBackupPrepareW = unsafe extern "system" fn(pwszservername: windows_sys::core::PCWSTR, grbitjet: u32, dwbackupflags: CSBACKUP_TYPE, phbc: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CertSrvBackupRead = unsafe extern "system" fn(hbc: *mut core::ffi::c_void, pvbuffer: *mut core::ffi::c_void, cbbuffer: u32, pcbread: *mut u32) -> windows_sys::core::HRESULT;
...
pub type CertSrvBackupTruncateLogs = unsafe extern "system" fn(hbc: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("certadm.dll" "system" fn CertSrvBackupTruncateLogs(hbc : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type CertSrvIsServerOnlineW = unsafe extern "system" fn(pwszservername: windows_sys::core::PCWSTR, pfserveronline: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type CertSrvRestoreEnd = unsafe extern "system" fn(hbc: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("certadm.dll" "system" fn CertSrvRestoreEnd(hbc : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type CertSrvRestoreGetDatabaseLocationsW = unsafe extern "system" fn(hbc: *const core::ffi::c_void, ppwszzdatabaselocationlist: *mut windows_sys::core::PWSTR, pcbsize: *mut u32) -> windows_sys::core::HRESULT;
...
pub type CertSrvRestorePrepareW = unsafe extern "system" fn(pwszservername: windows_sys::core::PCWSTR, dwrestoreflags: u32, phbc: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CertSrvRestoreRegisterComplete = unsafe extern "system" fn(hbc: *mut core::ffi::c_void, hrrestorestate: windows_sys::core::HRESULT) -> windows_sys::core::HRESULT;
...
pub type CertSrvRestoreRegisterThroughFile = unsafe extern "system" fn(hbc: *mut core::ffi::c_void, pwszcheckpointfilepath: windows_sys::core::PCWSTR, pwszlogpath: windows_sys::core::PCWSTR, rgrstmap: *mut CSEDB_RSTMAPW, crstmap: i32, pwszbackuplogpath: windows_sys::core::PCWSTR, genlow: u32, genhigh: u32) -> windows_sys::core::HRESULT;
windows_link::link!("certadm.dll" "system" fn CertSrvRestoreRegisterThroughFile(hbc : *mut core::ffi::c_void, pwszcheckpointfilepath : windows_sys::core::PCWSTR, pwszlogpath : windows_sys::core::PCWSTR, rgrstmap : *mut CSEDB_RSTMAPW, crstmap : i32, pwszbackuplogpath : windows_sys::core::PCWSTR, genlow : u32, genhigh : u32) -> windows_sys::core::HRESULT);
pub type CertSrvRestoreRegisterW = unsafe extern "system" fn(hbc: *mut core::ffi::c_void, pwszcheckpointfilepath: windows_sys::core::PCWSTR, pwszlogpath: windows_sys::core::PCWSTR, rgrstmap: *mut CSEDB_RSTMAPW, crstmap: i32, pwszbackuplogpath: windows_sys::core::PCWSTR, genlow: u32, genhigh: u32) -> windows_sys::core::HRESULT;
...
pub type CertSrvServerControlW = unsafe extern "system" fn(pwszservername: windows_sys::core::PCWSTR, dwcontrolflags: u32, pcbout: *mut u32, ppbout: *mut *mut u8) -> windows_sys::core::HRESULT;
...
pub type PstAcquirePrivateKey = unsafe extern "system" fn(pcert: *const super::CERT_CONTEXT) -> super::super::super::Foundation::NTSTATUS;
...
pub type PstGetCertificateChain = unsafe extern "system" fn(pcert: *const super::CERT_CONTEXT, ptrustedissuers: *const super::super::Authentication::Identity::SecPkgContext_IssuerListInfoEx, ppcertchaincontext: *mut *mut super::CERT_CHAIN_CONTEXT) -> super::super::super::Foundation::NTSTATUS;
#[cfg(feature = "Win32_Security_Authentication_Identity")]
...
pub type PstGetCertificates = unsafe extern "system" fn(ptargetname: *const super::super::super::Foundation::UNICODE_STRING, ccriteria: u32, rgpcriteria: *const super::CERT_SELECT_CRITERIA, bisclient: windows_sys::core::BOOL, pdwcertchaincontextcount: *mut u32, ppcertchaincontexts: *mut *mut *mut super::CERT_CHAIN_CONTEXT) -> super::super::super::Foundation::NTSTATUS;
...
#[cfg(feature = "Win32_Security_Authentication_Identity")]
pub type PstGetTrustAnchors = unsafe extern "system" fn(ptargetname: *const super::super::super::Foundation::UNICODE_STRING, ccriteria: u32, rgpcriteria: *const super::CERT_SELECT_CRITERIA, pptrustedissuers: *mut *mut super::super::Authentication::Identity::SecPkgContext_IssuerListInfoEx) -> super::super::super::Foundation::NTSTATUS;
#[cfg(feature = "Win32_Security_Authentication_Identity")]
...
#[cfg(feature = "Win32_Security_Authentication_Identity")]
pub type PstGetTrustAnchorsEx = unsafe extern "system" fn(ptargetname: *const super::super::super::Foundation::UNICODE_STRING, ccriteria: u32, rgpcriteria: *const super::CERT_SELECT_CRITERIA, pcertcontext: *const super::CERT_CONTEXT, pptrustedissuers: *mut *mut super::super::Authentication::Identity::SecPkgContext_IssuerListInfoEx) -> super::super::super::Foundation::NTSTATUS;
#[cfg(feature = "Win32_Security_Authentication_Identity")]
...
pub type PstGetUserNameForCertificate = unsafe extern "system" fn(pcertcontext: *const super::CERT_CONTEXT, username: *mut super::super::super::Foundation::UNICODE_STRING) -> super::super::super::Foundation::NTSTATUS;
...
#[cfg(feature = "Win32_Security_Authentication_Identity")]
pub type PstMapCertificate = unsafe extern "system" fn(pcert: *const super::CERT_CONTEXT, ptokeninformationtype: *mut super::super::Authentication::Identity::LSA_TOKEN_INFORMATION_TYPE, pptokeninformation: *mut *mut core::ffi::c_void) -> super::super::super::Foundation::NTSTATUS;
#[cfg(feature = "Win32_Security_Authentication_Identity")]
