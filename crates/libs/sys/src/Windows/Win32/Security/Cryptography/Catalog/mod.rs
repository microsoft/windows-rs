::windows_targets::link!("wintrust.dll" "system" fn CryptCATAdminAcquireContext(phcatadmin : *mut isize, pgsubsystem : *const ::windows_sys::core::GUID, dwflags : u32) -> super::super::super::Foundation:: BOOL);
::windows_targets::link!("wintrust.dll" "system" fn CryptCATAdminAcquireContext2(phcatadmin : *mut isize, pgsubsystem : *const ::windows_sys::core::GUID, pwszhashalgorithm : ::windows_sys::core::PCWSTR, pstronghashpolicy : *const super:: CERT_STRONG_SIGN_PARA, dwflags : u32) -> super::super::super::Foundation:: BOOL);
...
::windows_targets::link!("wintrust.dll" "system" fn CryptCATAdminRemoveCatalog(hcatadmin : isize, pwszcatalogfile : ::windows_sys::core::PCWSTR, dwflags : u32) -> super::super::super::Foundation:: BOOL);
::windows_targets::link!("wintrust.dll" "system" fn CryptCATAdminResolveCatalogPath(hcatadmin : isize, pwszcatalogfile : ::windows_sys::core::PCWSTR, pscatinfo : *mut CATALOG_INFO, dwflags : u32) -> super::super::super::Foundation:: BOOL);
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
::windows_targets::link!("wintrust.dll" "system" #[doc = "Required features: `\"Win32_Security_Cryptography_Sip\"`"] fn CryptCATAllocSortedMemberInfo(hcatalog : super::super::super::Foundation:: HANDLE, pwszreferencetag : ::windows_sys::core::PCWSTR) -> *mut CRYPTCATMEMBER);
::windows_targets::link!("wintrust.dll" "system" fn CryptCATCDFClose(pcdf : *mut CRYPTCATCDF) -> super::super::super::Foundation:: BOOL);
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
::windows_targets::link!("wintrust.dll" "system" #[doc = "Required features: `\"Win32_Security_Cryptography_Sip\"`"] fn CryptCATCDFEnumAttributes(pcdf : *mut CRYPTCATCDF, pmember : *mut CRYPTCATMEMBER, pprevattr : *mut CRYPTCATATTRIBUTE, pfnparseerror : PFN_CDF_PARSE_ERROR_CALLBACK) -> *mut CRYPTCATATTRIBUTE);
...
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
::windows_targets::link!("wintrust.dll" "system" #[doc = "Required features: `\"Win32_Security_Cryptography_Sip\"`"] fn CryptCATCDFEnumMembers(pcdf : *mut CRYPTCATCDF, pprevmember : *mut CRYPTCATMEMBER, pfnparseerror : PFN_CDF_PARSE_ERROR_CALLBACK) -> *mut CRYPTCATMEMBER);
...
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
::windows_targets::link!("wintrust.dll" "system" #[doc = "Required features: `\"Win32_Security_Cryptography_Sip\"`"] fn CryptCATEnumerateAttr(hcatalog : super::super::super::Foundation:: HANDLE, pcatmember : *mut CRYPTCATMEMBER, pprevattr : *mut CRYPTCATATTRIBUTE) -> *mut CRYPTCATATTRIBUTE);
...
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
::windows_targets::link!("wintrust.dll" "system" #[doc = "Required features: `\"Win32_Security_Cryptography_Sip\"`"] fn CryptCATEnumerateMember(hcatalog : super::super::super::Foundation:: HANDLE, pprevmember : *mut CRYPTCATMEMBER) -> *mut CRYPTCATMEMBER);
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
::windows_targets::link!("wintrust.dll" "system" #[doc = "Required features: `\"Win32_Security_Cryptography_Sip\"`"] fn CryptCATFreeSortedMemberInfo(hcatalog : super::super::super::Foundation:: HANDLE, pcatmember : *mut CRYPTCATMEMBER));
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
::windows_targets::link!("wintrust.dll" "system" #[doc = "Required features: `\"Win32_Security_Cryptography_Sip\"`"] fn CryptCATGetAttrInfo(hcatalog : super::super::super::Foundation:: HANDLE, pcatmember : *mut CRYPTCATMEMBER, pwszreferencetag : ::windows_sys::core::PCWSTR) -> *mut CRYPTCATATTRIBUTE);
...
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
::windows_targets::link!("wintrust.dll" "system" #[doc = "Required features: `\"Win32_Security_Cryptography_Sip\"`"] fn CryptCATGetMemberInfo(hcatalog : super::super::super::Foundation:: HANDLE, pwszreferencetag : ::windows_sys::core::PCWSTR) -> *mut CRYPTCATMEMBER);
