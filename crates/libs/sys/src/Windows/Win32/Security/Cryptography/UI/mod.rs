pub type CertSelectionGetSerializedBlob = unsafe extern "system" fn(pcsi: *const CERT_SELECTUI_INPUT, ppoutbuffer: *mut *mut core::ffi::c_void, puloutbuffersize: *mut u32) -> windows_sys::core::HRESULT;
...
pub type CryptUIDlgCertMgr = unsafe extern "system" fn(pcryptuicertmgr: *const CRYPTUI_CERT_MGR_STRUCT) -> windows_sys::core::BOOL;
...
pub type CryptUIDlgSelectCertificateFromStore = unsafe extern "system" fn(hcertstore: super::HCERTSTORE, hwnd: super::super::super::Foundation::HWND, pwsztitle: windows_sys::core::PCWSTR, pwszdisplaystring: windows_sys::core::PCWSTR, dwdontusecolumn: u32, dwflags: u32, pvreserved: *const core::ffi::c_void) -> *mut super::CERT_CONTEXT;
...
pub type CryptUIDlgViewCertificateA = unsafe extern "system" fn(pcertviewinfo: *const CRYPTUI_VIEWCERTIFICATE_STRUCTA, pfpropertieschanged: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_Security_Cryptography_Catalog", feature = "Win32_Security_Cryptography_Sip", feature = "Win32_Security_WinTrust", feature = "Win32_UI_Controls", feature = "Win32_UI_WindowsAndMessaging"))]
...
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_Security_Cryptography_Catalog", feature = "Win32_Security_Cryptography_Sip", feature = "Win32_Security_WinTrust", feature = "Win32_UI_Controls", feature = "Win32_UI_WindowsAndMessaging"))]
pub type CryptUIDlgViewCertificateW = unsafe extern "system" fn(pcertviewinfo: *const CRYPTUI_VIEWCERTIFICATE_STRUCTW, pfpropertieschanged: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_Security_Cryptography_Catalog", feature = "Win32_Security_Cryptography_Sip", feature = "Win32_Security_WinTrust", feature = "Win32_UI_Controls", feature = "Win32_UI_WindowsAndMessaging"))]
...
pub type CryptUIDlgViewContext = unsafe extern "system" fn(dwcontexttype: u32, pvcontext: *const core::ffi::c_void, hwnd: super::super::super::Foundation::HWND, pwsztitle: windows_sys::core::PCWSTR, dwflags: u32, pvreserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type CryptUIWizDigitalSign = unsafe extern "system" fn(dwflags: u32, hwndparent: super::super::super::Foundation::HWND, pwszwizardtitle: windows_sys::core::PCWSTR, pdigitalsigninfo: *const CRYPTUI_WIZ_DIGITAL_SIGN_INFO, ppsigncontext: *mut *mut CRYPTUI_WIZ_DIGITAL_SIGN_CONTEXT) -> windows_sys::core::BOOL;
...
pub type CryptUIWizExport = unsafe extern "system" fn(dwflags: CRYPTUI_WIZ_FLAGS, hwndparent: super::super::super::Foundation::HWND, pwszwizardtitle: windows_sys::core::PCWSTR, pexportinfo: *const CRYPTUI_WIZ_EXPORT_INFO, pvoid: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type CryptUIWizFreeDigitalSignContext = unsafe extern "system" fn(psigncontext: *const CRYPTUI_WIZ_DIGITAL_SIGN_CONTEXT) -> windows_sys::core::BOOL;
...
pub type CryptUIWizImport = unsafe extern "system" fn(dwflags: CRYPTUI_WIZ_FLAGS, hwndparent: super::super::super::Foundation::HWND, pwszwizardtitle: windows_sys::core::PCWSTR, pimportsrc: *const CRYPTUI_WIZ_IMPORT_SRC_INFO, hdestcertstore: super::HCERTSTORE) -> windows_sys::core::BOOL;
