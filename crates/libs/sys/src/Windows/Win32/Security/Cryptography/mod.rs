...
pub mod UI;
pub type BCryptAddContextFunction = unsafe extern "system" fn(dwtable: BCRYPT_TABLE, pszcontext: windows_sys::core::PCWSTR, dwinterface: BCRYPT_INTERFACE, pszfunction: windows_sys::core::PCWSTR, dwposition: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptAddContextFunction(dwtable : BCRYPT_TABLE, pszcontext : windows_sys::core::PCWSTR, dwinterface : BCRYPT_INTERFACE, pszfunction : windows_sys::core::PCWSTR, dwposition : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptAddContextFunctionProvider = unsafe extern "system" fn(dwtable: u32, pszcontext: windows_sys::core::PCWSTR, dwinterface: u32, pszfunction: windows_sys::core::PCWSTR, pszprovider: windows_sys::core::PCWSTR, dwposition: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptAddContextFunctionProvider(dwtable : u32, pszcontext : windows_sys::core::PCWSTR, dwinterface : u32, pszfunction : windows_sys::core::PCWSTR, pszprovider : windows_sys::core::PCWSTR, dwposition : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptCloseAlgorithmProvider = unsafe extern "system" fn(halgorithm: BCRYPT_ALG_HANDLE, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptCloseAlgorithmProvider(halgorithm : BCRYPT_ALG_HANDLE, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptConfigureContext = unsafe extern "system" fn(dwtable: BCRYPT_TABLE, pszcontext: windows_sys::core::PCWSTR, pconfig: *const CRYPT_CONTEXT_CONFIG) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptConfigureContext(dwtable : BCRYPT_TABLE, pszcontext : windows_sys::core::PCWSTR, pconfig : *const CRYPT_CONTEXT_CONFIG) -> super::super::Foundation::NTSTATUS);
pub type BCryptConfigureContextFunction = unsafe extern "system" fn(dwtable: BCRYPT_TABLE, pszcontext: windows_sys::core::PCWSTR, dwinterface: BCRYPT_INTERFACE, pszfunction: windows_sys::core::PCWSTR, pconfig: *const CRYPT_CONTEXT_FUNCTION_CONFIG) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptConfigureContextFunction(dwtable : BCRYPT_TABLE, pszcontext : windows_sys::core::PCWSTR, dwinterface : BCRYPT_INTERFACE, pszfunction : windows_sys::core::PCWSTR, pconfig : *const CRYPT_CONTEXT_FUNCTION_CONFIG) -> super::super::Foundation::NTSTATUS);
pub type BCryptCreateContext = unsafe extern "system" fn(dwtable: BCRYPT_TABLE, pszcontext: windows_sys::core::PCWSTR, pconfig: *const CRYPT_CONTEXT_CONFIG) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptCreateContext(dwtable : BCRYPT_TABLE, pszcontext : windows_sys::core::PCWSTR, pconfig : *const CRYPT_CONTEXT_CONFIG) -> super::super::Foundation::NTSTATUS);
pub type BCryptCreateHash = unsafe extern "system" fn(halgorithm: BCRYPT_ALG_HANDLE, phhash: *mut BCRYPT_HASH_HANDLE, pbhashobject: *mut u8, cbhashobject: u32, pbsecret: *const u8, cbsecret: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptCreateHash(halgorithm : BCRYPT_ALG_HANDLE, phhash : *mut BCRYPT_HASH_HANDLE, pbhashobject : *mut u8, cbhashobject : u32, pbsecret : *const u8, cbsecret : u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptCreateMultiHash = unsafe extern "system" fn(halgorithm: BCRYPT_ALG_HANDLE, phhash: *mut BCRYPT_HASH_HANDLE, nhashes: u32, pbhashobject: *mut u8, cbhashobject: u32, pbsecret: *const u8, cbsecret: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptCreateMultiHash(halgorithm : BCRYPT_ALG_HANDLE, phhash : *mut BCRYPT_HASH_HANDLE, nhashes : u32, pbhashobject : *mut u8, cbhashobject : u32, pbsecret : *const u8, cbsecret : u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptDecapsulate = unsafe extern "system" fn(hkey: BCRYPT_KEY_HANDLE, pbciphertext: *const u8, cbciphertext: u32, pbsecretkey: *mut u8, cbsecretkey: u32, pcbsecretkey: *mut u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptDecapsulate(hkey : BCRYPT_KEY_HANDLE, pbciphertext : *const u8, cbciphertext : u32, pbsecretkey : *mut u8, cbsecretkey : u32, pcbsecretkey : *mut u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptDecrypt = unsafe extern "system" fn(hkey: BCRYPT_KEY_HANDLE, pbinput: *const u8, cbinput: u32, ppaddinginfo: *const core::ffi::c_void, pbiv: *mut u8, cbiv: u32, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: BCRYPT_FLAGS) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptDecrypt(hkey : BCRYPT_KEY_HANDLE, pbinput : *const u8, cbinput : u32, ppaddinginfo : *const core::ffi::c_void, pbiv : *mut u8, cbiv : u32, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : BCRYPT_FLAGS) -> super::super::Foundation::NTSTATUS);
pub type BCryptDeleteContext = unsafe extern "system" fn(dwtable: BCRYPT_TABLE, pszcontext: windows_sys::core::PCWSTR) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptDeleteContext(dwtable : BCRYPT_TABLE, pszcontext : windows_sys::core::PCWSTR) -> super::super::Foundation::NTSTATUS);
pub type BCryptDeriveKey = unsafe extern "system" fn(hsharedsecret: BCRYPT_SECRET_HANDLE, pwszkdf: windows_sys::core::PCWSTR, pparameterlist: *const BCryptBufferDesc, pbderivedkey: *mut u8, cbderivedkey: u32, pcbresult: *mut u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptDeriveKey(hsharedsecret : BCRYPT_SECRET_HANDLE, pwszkdf : windows_sys::core::PCWSTR, pparameterlist : *const BCryptBufferDesc, pbderivedkey : *mut u8, cbderivedkey : u32, pcbresult : *mut u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptDeriveKeyCapi = unsafe extern "system" fn(hhash: BCRYPT_HASH_HANDLE, htargetalg: BCRYPT_ALG_HANDLE, pbderivedkey: *mut u8, cbderivedkey: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptDeriveKeyCapi(hhash : BCRYPT_HASH_HANDLE, htargetalg : BCRYPT_ALG_HANDLE, pbderivedkey : *mut u8, cbderivedkey : u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptDeriveKeyPBKDF2 = unsafe extern "system" fn(hprf: BCRYPT_ALG_HANDLE, pbpassword: *const u8, cbpassword: u32, pbsalt: *const u8, cbsalt: u32, citerations: u64, pbderivedkey: *mut u8, cbderivedkey: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptDeriveKeyPBKDF2(hprf : BCRYPT_ALG_HANDLE, pbpassword : *const u8, cbpassword : u32, pbsalt : *const u8, cbsalt : u32, citerations : u64, pbderivedkey : *mut u8, cbderivedkey : u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptDestroyHash = unsafe extern "system" fn(hhash: BCRYPT_HASH_HANDLE) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptDestroyHash(hhash : BCRYPT_HASH_HANDLE) -> super::super::Foundation::NTSTATUS);
pub type BCryptDestroyKey = unsafe extern "system" fn(hkey: BCRYPT_KEY_HANDLE) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptDestroyKey(hkey : BCRYPT_KEY_HANDLE) -> super::super::Foundation::NTSTATUS);
pub type BCryptDestroySecret = unsafe extern "system" fn(hsecret: BCRYPT_SECRET_HANDLE) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptDestroySecret(hsecret : BCRYPT_SECRET_HANDLE) -> super::super::Foundation::NTSTATUS);
pub type BCryptDuplicateHash = unsafe extern "system" fn(hhash: BCRYPT_HASH_HANDLE, phnewhash: *mut BCRYPT_HASH_HANDLE, pbhashobject: *mut u8, cbhashobject: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptDuplicateHash(hhash : BCRYPT_HASH_HANDLE, phnewhash : *mut BCRYPT_HASH_HANDLE, pbhashobject : *mut u8, cbhashobject : u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptDuplicateKey = unsafe extern "system" fn(hkey: BCRYPT_KEY_HANDLE, phnewkey: *mut BCRYPT_KEY_HANDLE, pbkeyobject: *mut u8, cbkeyobject: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptDuplicateKey(hkey : BCRYPT_KEY_HANDLE, phnewkey : *mut BCRYPT_KEY_HANDLE, pbkeyobject : *mut u8, cbkeyobject : u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptEncapsulate = unsafe extern "system" fn(hkey: BCRYPT_KEY_HANDLE, pbsecretkey: *mut u8, cbsecretkey: u32, pcbsecretkey: *mut u32, pbciphertext: *mut u8, cbciphertext: u32, pcbciphertext: *mut u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptEncapsulate(hkey : BCRYPT_KEY_HANDLE, pbsecretkey : *mut u8, cbsecretkey : u32, pcbsecretkey : *mut u32, pbciphertext : *mut u8, cbciphertext : u32, pcbciphertext : *mut u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptEncrypt = unsafe extern "system" fn(hkey: BCRYPT_KEY_HANDLE, pbinput: *const u8, cbinput: u32, ppaddinginfo: *const core::ffi::c_void, pbiv: *mut u8, cbiv: u32, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: BCRYPT_FLAGS) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptEncrypt(hkey : BCRYPT_KEY_HANDLE, pbinput : *const u8, cbinput : u32, ppaddinginfo : *const core::ffi::c_void, pbiv : *mut u8, cbiv : u32, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : BCRYPT_FLAGS) -> super::super::Foundation::NTSTATUS);
pub type BCryptEnumAlgorithms = unsafe extern "system" fn(dwalgoperations: BCRYPT_OPERATION, palgcount: *mut u32, ppalglist: *mut *mut BCRYPT_ALGORITHM_IDENTIFIER, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptEnumAlgorithms(dwalgoperations : BCRYPT_OPERATION, palgcount : *mut u32, ppalglist : *mut *mut BCRYPT_ALGORITHM_IDENTIFIER, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptEnumContextFunctionProviders = unsafe extern "system" fn(dwtable: BCRYPT_TABLE, pszcontext: windows_sys::core::PCWSTR, dwinterface: BCRYPT_INTERFACE, pszfunction: windows_sys::core::PCWSTR, pcbbuffer: *mut u32, ppbuffer: *mut *mut CRYPT_CONTEXT_FUNCTION_PROVIDERS) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptEnumContextFunctionProviders(dwtable : BCRYPT_TABLE, pszcontext : windows_sys::core::PCWSTR, dwinterface : BCRYPT_INTERFACE, pszfunction : windows_sys::core::PCWSTR, pcbbuffer : *mut u32, ppbuffer : *mut *mut CRYPT_CONTEXT_FUNCTION_PROVIDERS) -> super::super::Foundation::NTSTATUS);
pub type BCryptEnumContextFunctions = unsafe extern "system" fn(dwtable: BCRYPT_TABLE, pszcontext: windows_sys::core::PCWSTR, dwinterface: BCRYPT_INTERFACE, pcbbuffer: *mut u32, ppbuffer: *mut *mut CRYPT_CONTEXT_FUNCTIONS) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptEnumContextFunctions(dwtable : BCRYPT_TABLE, pszcontext : windows_sys::core::PCWSTR, dwinterface : BCRYPT_INTERFACE, pcbbuffer : *mut u32, ppbuffer : *mut *mut CRYPT_CONTEXT_FUNCTIONS) -> super::super::Foundation::NTSTATUS);
pub type BCryptEnumContexts = unsafe extern "system" fn(dwtable: BCRYPT_TABLE, pcbbuffer: *mut u32, ppbuffer: *mut *mut CRYPT_CONTEXTS) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptEnumContexts(dwtable : BCRYPT_TABLE, pcbbuffer : *mut u32, ppbuffer : *mut *mut CRYPT_CONTEXTS) -> super::super::Foundation::NTSTATUS);
pub type BCryptEnumProviders = unsafe extern "system" fn(pszalgid: windows_sys::core::PCWSTR, pimplcount: *mut u32, ppimpllist: *mut *mut BCRYPT_PROVIDER_NAME, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptEnumProviders(pszalgid : windows_sys::core::PCWSTR, pimplcount : *mut u32, ppimpllist : *mut *mut BCRYPT_PROVIDER_NAME, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptEnumRegisteredProviders = unsafe extern "system" fn(pcbbuffer: *mut u32, ppbuffer: *mut *mut CRYPT_PROVIDERS) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptEnumRegisteredProviders(pcbbuffer : *mut u32, ppbuffer : *mut *mut CRYPT_PROVIDERS) -> super::super::Foundation::NTSTATUS);
pub type BCryptExportKey = unsafe extern "system" fn(hkey: BCRYPT_KEY_HANDLE, hexportkey: BCRYPT_KEY_HANDLE, pszblobtype: windows_sys::core::PCWSTR, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptExportKey(hkey : BCRYPT_KEY_HANDLE, hexportkey : BCRYPT_KEY_HANDLE, pszblobtype : windows_sys::core::PCWSTR, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptFinalizeKeyPair = unsafe extern "system" fn(hkey: BCRYPT_KEY_HANDLE, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptFinalizeKeyPair(hkey : BCRYPT_KEY_HANDLE, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptFinishHash = unsafe extern "system" fn(hhash: BCRYPT_HASH_HANDLE, pboutput: *mut u8, cboutput: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptFinishHash(hhash : BCRYPT_HASH_HANDLE, pboutput : *mut u8, cboutput : u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptFreeBuffer = unsafe extern "system" fn(pvbuffer: *const core::ffi::c_void);
windows_link::link!("bcrypt.dll" "system" fn BCryptFreeBuffer(pvbuffer : *const core::ffi::c_void));
pub type BCryptGenRandom = unsafe extern "system" fn(halgorithm: BCRYPT_ALG_HANDLE, pbbuffer: *mut u8, cbbuffer: u32, dwflags: BCRYPTGENRANDOM_FLAGS) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptGenRandom(halgorithm : BCRYPT_ALG_HANDLE, pbbuffer : *mut u8, cbbuffer : u32, dwflags : BCRYPTGENRANDOM_FLAGS) -> super::super::Foundation::NTSTATUS);
pub type BCryptGenerateKeyPair = unsafe extern "system" fn(halgorithm: BCRYPT_ALG_HANDLE, phkey: *mut BCRYPT_KEY_HANDLE, dwlength: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptGenerateKeyPair(halgorithm : BCRYPT_ALG_HANDLE, phkey : *mut BCRYPT_KEY_HANDLE, dwlength : u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptGenerateSymmetricKey = unsafe extern "system" fn(halgorithm: BCRYPT_ALG_HANDLE, phkey: *mut BCRYPT_KEY_HANDLE, pbkeyobject: *mut u8, cbkeyobject: u32, pbsecret: *const u8, cbsecret: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptGenerateSymmetricKey(halgorithm : BCRYPT_ALG_HANDLE, phkey : *mut BCRYPT_KEY_HANDLE, pbkeyobject : *mut u8, cbkeyobject : u32, pbsecret : *const u8, cbsecret : u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptGetFipsAlgorithmMode = unsafe extern "system" fn(pfenabled: *mut u8) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptGetFipsAlgorithmMode(pfenabled : *mut u8) -> super::super::Foundation::NTSTATUS);
pub type BCryptGetProperty = unsafe extern "system" fn(hobject: BCRYPT_HANDLE, pszproperty: windows_sys::core::PCWSTR, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptGetProperty(hobject : BCRYPT_HANDLE, pszproperty : windows_sys::core::PCWSTR, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptHash = unsafe extern "system" fn(halgorithm: BCRYPT_ALG_HANDLE, pbsecret: *const u8, cbsecret: u32, pbinput: *const u8, cbinput: u32, pboutput: *mut u8, cboutput: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptHash(halgorithm : BCRYPT_ALG_HANDLE, pbsecret : *const u8, cbsecret : u32, pbinput : *const u8, cbinput : u32, pboutput : *mut u8, cboutput : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptHashData = unsafe extern "system" fn(hhash: BCRYPT_HASH_HANDLE, pbinput: *const u8, cbinput: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptHashData(hhash : BCRYPT_HASH_HANDLE, pbinput : *const u8, cbinput : u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptImportKey = unsafe extern "system" fn(halgorithm: BCRYPT_ALG_HANDLE, himportkey: BCRYPT_KEY_HANDLE, pszblobtype: windows_sys::core::PCWSTR, phkey: *mut BCRYPT_KEY_HANDLE, pbkeyobject: *mut u8, cbkeyobject: u32, pbinput: *const u8, cbinput: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptImportKey(halgorithm : BCRYPT_ALG_HANDLE, himportkey : BCRYPT_KEY_HANDLE, pszblobtype : windows_sys::core::PCWSTR, phkey : *mut BCRYPT_KEY_HANDLE, pbkeyobject : *mut u8, cbkeyobject : u32, pbinput : *const u8, cbinput : u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptImportKeyPair = unsafe extern "system" fn(halgorithm: BCRYPT_ALG_HANDLE, himportkey: BCRYPT_KEY_HANDLE, pszblobtype: windows_sys::core::PCWSTR, phkey: *mut BCRYPT_KEY_HANDLE, pbinput: *const u8, cbinput: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptImportKeyPair(halgorithm : BCRYPT_ALG_HANDLE, himportkey : BCRYPT_KEY_HANDLE, pszblobtype : windows_sys::core::PCWSTR, phkey : *mut BCRYPT_KEY_HANDLE, pbinput : *const u8, cbinput : u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptKeyDerivation = unsafe extern "system" fn(hkey: BCRYPT_KEY_HANDLE, pparameterlist: *const BCryptBufferDesc, pbderivedkey: *mut u8, cbderivedkey: u32, pcbresult: *mut u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptKeyDerivation(hkey : BCRYPT_KEY_HANDLE, pparameterlist : *const BCryptBufferDesc, pbderivedkey : *mut u8, cbderivedkey : u32, pcbresult : *mut u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptOpenAlgorithmProvider = unsafe extern "system" fn(phalgorithm: *mut BCRYPT_ALG_HANDLE, pszalgid: windows_sys::core::PCWSTR, pszimplementation: windows_sys::core::PCWSTR, dwflags: BCRYPT_OPEN_ALGORITHM_PROVIDER_FLAGS) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptOpenAlgorithmProvider(phalgorithm : *mut BCRYPT_ALG_HANDLE, pszalgid : windows_sys::core::PCWSTR, pszimplementation : windows_sys::core::PCWSTR, dwflags : BCRYPT_OPEN_ALGORITHM_PROVIDER_FLAGS) -> super::super::Foundation::NTSTATUS);
pub type BCryptProcessMultiOperations = unsafe extern "system" fn(hobject: BCRYPT_HANDLE, operationtype: BCRYPT_MULTI_OPERATION_TYPE, poperations: *const core::ffi::c_void, cboperations: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptProcessMultiOperations(hobject : BCRYPT_HANDLE, operationtype : BCRYPT_MULTI_OPERATION_TYPE, poperations : *const core::ffi::c_void, cboperations : u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptQueryContextConfiguration = unsafe extern "system" fn(dwtable: BCRYPT_TABLE, pszcontext: windows_sys::core::PCWSTR, pcbbuffer: *mut u32, ppbuffer: *mut *mut CRYPT_CONTEXT_CONFIG) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptQueryContextConfiguration(dwtable : BCRYPT_TABLE, pszcontext : windows_sys::core::PCWSTR, pcbbuffer : *mut u32, ppbuffer : *mut *mut CRYPT_CONTEXT_CONFIG) -> super::super::Foundation::NTSTATUS);
pub type BCryptQueryContextFunctionConfiguration = unsafe extern "system" fn(dwtable: BCRYPT_TABLE, pszcontext: windows_sys::core::PCWSTR, dwinterface: BCRYPT_INTERFACE, pszfunction: windows_sys::core::PCWSTR, pcbbuffer: *mut u32, ppbuffer: *mut *mut CRYPT_CONTEXT_FUNCTION_CONFIG) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptQueryContextFunctionConfiguration(dwtable : BCRYPT_TABLE, pszcontext : windows_sys::core::PCWSTR, dwinterface : BCRYPT_INTERFACE, pszfunction : windows_sys::core::PCWSTR, pcbbuffer : *mut u32, ppbuffer : *mut *mut CRYPT_CONTEXT_FUNCTION_CONFIG) -> super::super::Foundation::NTSTATUS);
pub type BCryptQueryContextFunctionProperty = unsafe extern "system" fn(dwtable: BCRYPT_TABLE, pszcontext: windows_sys::core::PCWSTR, dwinterface: BCRYPT_INTERFACE, pszfunction: windows_sys::core::PCWSTR, pszproperty: windows_sys::core::PCWSTR, pcbvalue: *mut u32, ppbvalue: *mut *mut u8) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptQueryContextFunctionProperty(dwtable : BCRYPT_TABLE, pszcontext : windows_sys::core::PCWSTR, dwinterface : BCRYPT_INTERFACE, pszfunction : windows_sys::core::PCWSTR, pszproperty : windows_sys::core::PCWSTR, pcbvalue : *mut u32, ppbvalue : *mut *mut u8) -> super::super::Foundation::NTSTATUS);
pub type BCryptQueryProviderRegistration = unsafe extern "system" fn(pszprovider: windows_sys::core::PCWSTR, dwmode: BCRYPT_QUERY_PROVIDER_MODE, dwinterface: BCRYPT_INTERFACE, pcbbuffer: *mut u32, ppbuffer: *mut *mut CRYPT_PROVIDER_REG) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptQueryProviderRegistration(pszprovider : windows_sys::core::PCWSTR, dwmode : BCRYPT_QUERY_PROVIDER_MODE, dwinterface : BCRYPT_INTERFACE, pcbbuffer : *mut u32, ppbuffer : *mut *mut CRYPT_PROVIDER_REG) -> super::super::Foundation::NTSTATUS);
pub type BCryptRegisterConfigChangeNotify = unsafe extern "system" fn(phevent: *mut super::super::Foundation::HANDLE) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptRegisterConfigChangeNotify(phevent : *mut super::super::Foundation::HANDLE) -> super::super::Foundation::NTSTATUS);
pub type BCryptRegisterProvider = unsafe extern "system" fn(pszprovider: windows_sys::core::PCWSTR, dwflags: u32, preg: *const CRYPT_PROVIDER_REG) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptRegisterProvider(pszprovider : windows_sys::core::PCWSTR, dwflags : u32, preg : *const CRYPT_PROVIDER_REG) -> super::super::Foundation::NTSTATUS);
pub type BCryptRemoveContextFunction = unsafe extern "system" fn(dwtable: BCRYPT_TABLE, pszcontext: windows_sys::core::PCWSTR, dwinterface: BCRYPT_INTERFACE, pszfunction: windows_sys::core::PCWSTR) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptRemoveContextFunction(dwtable : BCRYPT_TABLE, pszcontext : windows_sys::core::PCWSTR, dwinterface : BCRYPT_INTERFACE, pszfunction : windows_sys::core::PCWSTR) -> super::super::Foundation::NTSTATUS);
pub type BCryptRemoveContextFunctionProvider = unsafe extern "system" fn(dwtable: u32, pszcontext: windows_sys::core::PCWSTR, dwinterface: u32, pszfunction: windows_sys::core::PCWSTR, pszprovider: windows_sys::core::PCWSTR) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptRemoveContextFunctionProvider(dwtable : u32, pszcontext : windows_sys::core::PCWSTR, dwinterface : u32, pszfunction : windows_sys::core::PCWSTR, pszprovider : windows_sys::core::PCWSTR) -> super::super::Foundation::NTSTATUS);
pub type BCryptResolveProviders = unsafe extern "system" fn(pszcontext: windows_sys::core::PCWSTR, dwinterface: u32, pszfunction: windows_sys::core::PCWSTR, pszprovider: windows_sys::core::PCWSTR, dwmode: BCRYPT_QUERY_PROVIDER_MODE, dwflags: BCRYPT_RESOLVE_PROVIDERS_FLAGS, pcbbuffer: *mut u32, ppbuffer: *mut *mut CRYPT_PROVIDER_REFS) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptResolveProviders(pszcontext : windows_sys::core::PCWSTR, dwinterface : u32, pszfunction : windows_sys::core::PCWSTR, pszprovider : windows_sys::core::PCWSTR, dwmode : BCRYPT_QUERY_PROVIDER_MODE, dwflags : BCRYPT_RESOLVE_PROVIDERS_FLAGS, pcbbuffer : *mut u32, ppbuffer : *mut *mut CRYPT_PROVIDER_REFS) -> super::super::Foundation::NTSTATUS);
pub type BCryptSecretAgreement = unsafe extern "system" fn(hprivkey: BCRYPT_KEY_HANDLE, hpubkey: BCRYPT_KEY_HANDLE, phagreedsecret: *mut BCRYPT_SECRET_HANDLE, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptSecretAgreement(hprivkey : BCRYPT_KEY_HANDLE, hpubkey : BCRYPT_KEY_HANDLE, phagreedsecret : *mut BCRYPT_SECRET_HANDLE, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptSetContextFunctionProperty = unsafe extern "system" fn(dwtable: BCRYPT_TABLE, pszcontext: windows_sys::core::PCWSTR, dwinterface: BCRYPT_INTERFACE, pszfunction: windows_sys::core::PCWSTR, pszproperty: windows_sys::core::PCWSTR, cbvalue: u32, pbvalue: *const u8) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptSetContextFunctionProperty(dwtable : BCRYPT_TABLE, pszcontext : windows_sys::core::PCWSTR, dwinterface : BCRYPT_INTERFACE, pszfunction : windows_sys::core::PCWSTR, pszproperty : windows_sys::core::PCWSTR, cbvalue : u32, pbvalue : *const u8) -> super::super::Foundation::NTSTATUS);
pub type BCryptSetProperty = unsafe extern "system" fn(hobject: BCRYPT_HANDLE, pszproperty: windows_sys::core::PCWSTR, pbinput: *const u8, cbinput: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptSetProperty(hobject : BCRYPT_HANDLE, pszproperty : windows_sys::core::PCWSTR, pbinput : *const u8, cbinput : u32, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type BCryptSignHash = unsafe extern "system" fn(hkey: BCRYPT_KEY_HANDLE, ppaddinginfo: *const core::ffi::c_void, pbinput: *const u8, cbinput: u32, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: BCRYPT_FLAGS) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptSignHash(hkey : BCRYPT_KEY_HANDLE, ppaddinginfo : *const core::ffi::c_void, pbinput : *const u8, cbinput : u32, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : BCRYPT_FLAGS) -> super::super::Foundation::NTSTATUS);
pub type BCryptUnregisterConfigChangeNotify = unsafe extern "system" fn(hevent: super::super::Foundation::HANDLE) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptUnregisterConfigChangeNotify(hevent : super::super::Foundation::HANDLE) -> super::super::Foundation::NTSTATUS);
pub type BCryptUnregisterProvider = unsafe extern "system" fn(pszprovider: windows_sys::core::PCWSTR) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptUnregisterProvider(pszprovider : windows_sys::core::PCWSTR) -> super::super::Foundation::NTSTATUS);
pub type BCryptVerifySignature = unsafe extern "system" fn(hkey: BCRYPT_KEY_HANDLE, ppaddinginfo: *const core::ffi::c_void, pbhash: *const u8, cbhash: u32, pbsignature: *const u8, cbsignature: u32, dwflags: BCRYPT_FLAGS) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcrypt.dll" "system" fn BCryptVerifySignature(hkey : BCRYPT_KEY_HANDLE, ppaddinginfo : *const core::ffi::c_void, pbhash : *const u8, cbhash : u32, pbsignature : *const u8, cbsignature : u32, dwflags : BCRYPT_FLAGS) -> super::super::Foundation::NTSTATUS);
pub type CertAddCRLContextToStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, pcrlcontext: *const CRL_CONTEXT, dwadddisposition: u32, ppstorecontext: *mut *mut CRL_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertAddCRLContextToStore(hcertstore : HCERTSTORE, pcrlcontext : *const CRL_CONTEXT, dwadddisposition : u32, ppstorecontext : *mut *mut CRL_CONTEXT) -> windows_sys::core::BOOL);
pub type CertAddCRLLinkToStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, pcrlcontext: *const CRL_CONTEXT, dwadddisposition: u32, ppstorecontext: *mut *mut CRL_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertAddCRLLinkToStore(hcertstore : HCERTSTORE, pcrlcontext : *const CRL_CONTEXT, dwadddisposition : u32, ppstorecontext : *mut *mut CRL_CONTEXT) -> windows_sys::core::BOOL);
pub type CertAddCTLContextToStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, pctlcontext: *const CTL_CONTEXT, dwadddisposition: u32, ppstorecontext: *mut *mut CTL_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertAddCTLContextToStore(hcertstore : HCERTSTORE, pctlcontext : *const CTL_CONTEXT, dwadddisposition : u32, ppstorecontext : *mut *mut CTL_CONTEXT) -> windows_sys::core::BOOL);
pub type CertAddCTLLinkToStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, pctlcontext: *const CTL_CONTEXT, dwadddisposition: u32, ppstorecontext: *mut *mut CTL_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertAddCTLLinkToStore(hcertstore : HCERTSTORE, pctlcontext : *const CTL_CONTEXT, dwadddisposition : u32, ppstorecontext : *mut *mut CTL_CONTEXT) -> windows_sys::core::BOOL);
pub type CertAddCertificateContextToStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, pcertcontext: *const CERT_CONTEXT, dwadddisposition: u32, ppstorecontext: *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertAddCertificateContextToStore(hcertstore : HCERTSTORE, pcertcontext : *const CERT_CONTEXT, dwadddisposition : u32, ppstorecontext : *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL);
pub type CertAddCertificateLinkToStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, pcertcontext: *const CERT_CONTEXT, dwadddisposition: u32, ppstorecontext: *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertAddCertificateLinkToStore(hcertstore : HCERTSTORE, pcertcontext : *const CERT_CONTEXT, dwadddisposition : u32, ppstorecontext : *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL);
pub type CertAddEncodedCRLToStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pbcrlencoded: *const u8, cbcrlencoded: u32, dwadddisposition: u32, ppcrlcontext: *mut *mut CRL_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertAddEncodedCRLToStore(hcertstore : HCERTSTORE, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pbcrlencoded : *const u8, cbcrlencoded : u32, dwadddisposition : u32, ppcrlcontext : *mut *mut CRL_CONTEXT) -> windows_sys::core::BOOL);
pub type CertAddEncodedCTLToStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, dwmsgandcertencodingtype: CERT_QUERY_ENCODING_TYPE, pbctlencoded: *const u8, cbctlencoded: u32, dwadddisposition: u32, ppctlcontext: *mut *mut CTL_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertAddEncodedCTLToStore(hcertstore : HCERTSTORE, dwmsgandcertencodingtype : CERT_QUERY_ENCODING_TYPE, pbctlencoded : *const u8, cbctlencoded : u32, dwadddisposition : u32, ppctlcontext : *mut *mut CTL_CONTEXT) -> windows_sys::core::BOOL);
pub type CertAddEncodedCertificateToStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pbcertencoded: *const u8, cbcertencoded: u32, dwadddisposition: u32, ppcertcontext: *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertAddEncodedCertificateToStore(hcertstore : HCERTSTORE, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pbcertencoded : *const u8, cbcertencoded : u32, dwadddisposition : u32, ppcertcontext : *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL);
pub type CertAddEncodedCertificateToSystemStoreA = unsafe extern "system" fn(szcertstorename: windows_sys::core::PCSTR, pbcertencoded: *const u8, cbcertencoded: u32) -> windows_sys::core::BOOL;
...
pub type CertAddEncodedCertificateToSystemStoreW = unsafe extern "system" fn(szcertstorename: windows_sys::core::PCWSTR, pbcertencoded: *const u8, cbcertencoded: u32) -> windows_sys::core::BOOL;
...
pub type CertAddEnhancedKeyUsageIdentifier = unsafe extern "system" fn(pcertcontext: *const CERT_CONTEXT, pszusageidentifier: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type CertAddRefServerOcspResponse = unsafe extern "system" fn(hserverocspresponse: *const core::ffi::c_void);
windows_link::link!("crypt32.dll" "system" fn CertAddRefServerOcspResponse(hserverocspresponse : *const core::ffi::c_void));
pub type CertAddRefServerOcspResponseContext = unsafe extern "system" fn(pserverocspresponsecontext: *const CERT_SERVER_OCSP_RESPONSE_CONTEXT);
...
pub type CertAddSerializedElementToStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, pbelement: *const u8, cbelement: u32, dwadddisposition: u32, dwflags: u32, dwcontexttypeflags: u32, pdwcontexttype: *mut u32, ppvcontext: *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type CertAddStoreToCollection = unsafe extern "system" fn(hcollectionstore: HCERTSTORE, hsiblingstore: HCERTSTORE, dwupdateflags: u32, dwpriority: u32) -> windows_sys::core::BOOL;
...
pub type CertAlgIdToOID = unsafe extern "system" fn(dwalgid: u32) -> windows_sys::core::PCSTR;
windows_link::link!("crypt32.dll" "system" fn CertAlgIdToOID(dwalgid : u32) -> windows_sys::core::PCSTR);
pub type CertCloseServerOcspResponse = unsafe extern "system" fn(hserverocspresponse: *const core::ffi::c_void, dwflags: u32);
windows_link::link!("crypt32.dll" "system" fn CertCloseServerOcspResponse(hserverocspresponse : *const core::ffi::c_void, dwflags : u32));
pub type CertCloseStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertCloseStore(hcertstore : HCERTSTORE, dwflags : u32) -> windows_sys::core::BOOL);
pub type CertCompareCertificate = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pcertid1: *const CERT_INFO, pcertid2: *const CERT_INFO) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertCompareCertificate(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pcertid1 : *const CERT_INFO, pcertid2 : *const CERT_INFO) -> windows_sys::core::BOOL);
pub type CertCompareCertificateName = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pcertname1: *const CRYPT_INTEGER_BLOB, pcertname2: *const CRYPT_INTEGER_BLOB) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertCompareCertificateName(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pcertname1 : *const CRYPT_INTEGER_BLOB, pcertname2 : *const CRYPT_INTEGER_BLOB) -> windows_sys::core::BOOL);
pub type CertCompareIntegerBlob = unsafe extern "system" fn(pint1: *const CRYPT_INTEGER_BLOB, pint2: *const CRYPT_INTEGER_BLOB) -> windows_sys::core::BOOL;
...
pub type CertComparePublicKeyInfo = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, ppublickey1: *const CERT_PUBLIC_KEY_INFO, ppublickey2: *const CERT_PUBLIC_KEY_INFO) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertComparePublicKeyInfo(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, ppublickey1 : *const CERT_PUBLIC_KEY_INFO, ppublickey2 : *const CERT_PUBLIC_KEY_INFO) -> windows_sys::core::BOOL);
pub type CertControlStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, dwflags: CERT_CONTROL_STORE_FLAGS, dwctrltype: u32, pvctrlpara: *const core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertControlStore(hcertstore : HCERTSTORE, dwflags : CERT_CONTROL_STORE_FLAGS, dwctrltype : u32, pvctrlpara : *const core::ffi::c_void) -> windows_sys::core::BOOL);
pub type CertCreateCRLContext = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pbcrlencoded: *const u8, cbcrlencoded: u32) -> *mut CRL_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertCreateCRLContext(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pbcrlencoded : *const u8, cbcrlencoded : u32) -> *mut CRL_CONTEXT);
pub type CertCreateCTLContext = unsafe extern "system" fn(dwmsgandcertencodingtype: u32, pbctlencoded: *const u8, cbctlencoded: u32) -> *mut CTL_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertCreateCTLContext(dwmsgandcertencodingtype : u32, pbctlencoded : *const u8, cbctlencoded : u32) -> *mut CTL_CONTEXT);
pub type CertCreateCTLEntryFromCertificateContextProperties = unsafe extern "system" fn(pcertcontext: *const CERT_CONTEXT, coptattr: u32, rgoptattr: *const CRYPT_ATTRIBUTE, dwflags: u32, pvreserved: *const core::ffi::c_void, pctlentry: *mut CTL_ENTRY, pcbctlentry: *mut u32) -> windows_sys::core::BOOL;
...
pub type CertCreateCertificateChainEngine = unsafe extern "system" fn(pconfig: *const CERT_CHAIN_ENGINE_CONFIG, phchainengine: *mut HCERTCHAINENGINE) -> windows_sys::core::BOOL;
...
pub type CertCreateCertificateContext = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pbcertencoded: *const u8, cbcertencoded: u32) -> *mut CERT_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertCreateCertificateContext(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pbcertencoded : *const u8, cbcertencoded : u32) -> *mut CERT_CONTEXT);
pub type CertCreateContext = unsafe extern "system" fn(dwcontexttype: u32, dwencodingtype: u32, pbencoded: *const u8, cbencoded: u32, dwflags: u32, pcreatepara: *const CERT_CREATE_CONTEXT_PARA) -> *mut core::ffi::c_void;
windows_link::link!("crypt32.dll" "system" fn CertCreateContext(dwcontexttype : u32, dwencodingtype : u32, pbencoded : *const u8, cbencoded : u32, dwflags : u32, pcreatepara : *const CERT_CREATE_CONTEXT_PARA) -> *mut core::ffi::c_void);
pub type CertCreateSelfSignCertificate = unsafe extern "system" fn(hcryptprovorncryptkey: HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, psubjectissuerblob: *const CRYPT_INTEGER_BLOB, dwflags: CERT_CREATE_SELFSIGN_FLAGS, pkeyprovinfo: *const CRYPT_KEY_PROV_INFO, psignaturealgorithm: *const CRYPT_ALGORITHM_IDENTIFIER, pstarttime: *const super::super::Foundation::SYSTEMTIME, pendtime: *const super::super::Foundation::SYSTEMTIME, pextensions: *const CERT_EXTENSIONS) -> *mut CERT_CONTEXT;
...
pub type CertDeleteCRLFromStore = unsafe extern "system" fn(pcrlcontext: *const CRL_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertDeleteCRLFromStore(pcrlcontext : *const CRL_CONTEXT) -> windows_sys::core::BOOL);
pub type CertDeleteCTLFromStore = unsafe extern "system" fn(pctlcontext: *const CTL_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertDeleteCTLFromStore(pctlcontext : *const CTL_CONTEXT) -> windows_sys::core::BOOL);
pub type CertDeleteCertificateFromStore = unsafe extern "system" fn(pcertcontext: *const CERT_CONTEXT) -> windows_sys::core::BOOL;
...
pub type CertDuplicateCRLContext = unsafe extern "system" fn(pcrlcontext: *const CRL_CONTEXT) -> *mut CRL_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertDuplicateCRLContext(pcrlcontext : *const CRL_CONTEXT) -> *mut CRL_CONTEXT);
pub type CertDuplicateCTLContext = unsafe extern "system" fn(pctlcontext: *const CTL_CONTEXT) -> *mut CTL_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertDuplicateCTLContext(pctlcontext : *const CTL_CONTEXT) -> *mut CTL_CONTEXT);
pub type CertDuplicateCertificateChain = unsafe extern "system" fn(pchaincontext: *const CERT_CHAIN_CONTEXT) -> *mut CERT_CHAIN_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertDuplicateCertificateChain(pchaincontext : *const CERT_CHAIN_CONTEXT) -> *mut CERT_CHAIN_CONTEXT);
pub type CertDuplicateCertificateContext = unsafe extern "system" fn(pcertcontext: *const CERT_CONTEXT) -> *mut CERT_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertDuplicateCertificateContext(pcertcontext : *const CERT_CONTEXT) -> *mut CERT_CONTEXT);
pub type CertDuplicateStore = unsafe extern "system" fn(hcertstore: HCERTSTORE) -> HCERTSTORE;
windows_link::link!("crypt32.dll" "system" fn CertDuplicateStore(hcertstore : HCERTSTORE) -> HCERTSTORE);
pub type CertEnumCRLContextProperties = unsafe extern "system" fn(pcrlcontext: *const CRL_CONTEXT, dwpropid: u32) -> u32;
windows_link::link!("crypt32.dll" "system" fn CertEnumCRLContextProperties(pcrlcontext : *const CRL_CONTEXT, dwpropid : u32) -> u32);
pub type CertEnumCRLsInStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, pprevcrlcontext: *const CRL_CONTEXT) -> *mut CRL_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertEnumCRLsInStore(hcertstore : HCERTSTORE, pprevcrlcontext : *const CRL_CONTEXT) -> *mut CRL_CONTEXT);
pub type CertEnumCTLContextProperties = unsafe extern "system" fn(pctlcontext: *const CTL_CONTEXT, dwpropid: u32) -> u32;
windows_link::link!("crypt32.dll" "system" fn CertEnumCTLContextProperties(pctlcontext : *const CTL_CONTEXT, dwpropid : u32) -> u32);
pub type CertEnumCTLsInStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, pprevctlcontext: *const CTL_CONTEXT) -> *mut CTL_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertEnumCTLsInStore(hcertstore : HCERTSTORE, pprevctlcontext : *const CTL_CONTEXT) -> *mut CTL_CONTEXT);
pub type CertEnumCertificateContextProperties = unsafe extern "system" fn(pcertcontext: *const CERT_CONTEXT, dwpropid: u32) -> u32;
...
pub type CertEnumCertificatesInStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, pprevcertcontext: *const CERT_CONTEXT) -> *mut CERT_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertEnumCertificatesInStore(hcertstore : HCERTSTORE, pprevcertcontext : *const CERT_CONTEXT) -> *mut CERT_CONTEXT);
pub type CertEnumPhysicalStore = unsafe extern "system" fn(pvsystemstore: *const core::ffi::c_void, dwflags: u32, pvarg: *mut core::ffi::c_void, pfnenum: PFN_CERT_ENUM_PHYSICAL_STORE) -> windows_sys::core::BOOL;
...
pub type CertEnumSubjectInSortedCTL = unsafe extern "system" fn(pctlcontext: *const CTL_CONTEXT, ppvnextsubject: *mut *mut core::ffi::c_void, psubjectidentifier: *mut CRYPT_INTEGER_BLOB, pencodedattributes: *mut CRYPT_INTEGER_BLOB) -> windows_sys::core::BOOL;
...
pub type CertEnumSystemStore = unsafe extern "system" fn(dwflags: u32, pvsystemstorelocationpara: *const core::ffi::c_void, pvarg: *mut core::ffi::c_void, pfnenum: PFN_CERT_ENUM_SYSTEM_STORE) -> windows_sys::core::BOOL;
...
pub type CertEnumSystemStoreLocation = unsafe extern "system" fn(dwflags: u32, pvarg: *mut core::ffi::c_void, pfnenum: PFN_CERT_ENUM_SYSTEM_STORE_LOCATION) -> windows_sys::core::BOOL;
...
pub type CertFindAttribute = unsafe extern "system" fn(pszobjid: windows_sys::core::PCSTR, cattr: u32, rgattr: *const CRYPT_ATTRIBUTE) -> *mut CRYPT_ATTRIBUTE;
windows_link::link!("crypt32.dll" "system" fn CertFindAttribute(pszobjid : windows_sys::core::PCSTR, cattr : u32, rgattr : *const CRYPT_ATTRIBUTE) -> *mut CRYPT_ATTRIBUTE);
pub type CertFindCRLInStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, dwfindflags: u32, dwfindtype: u32, pvfindpara: *const core::ffi::c_void, pprevcrlcontext: *const CRL_CONTEXT) -> *mut CRL_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertFindCRLInStore(hcertstore : HCERTSTORE, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, dwfindflags : u32, dwfindtype : u32, pvfindpara : *const core::ffi::c_void, pprevcrlcontext : *const CRL_CONTEXT) -> *mut CRL_CONTEXT);
pub type CertFindCTLInStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, dwmsgandcertencodingtype: u32, dwfindflags: u32, dwfindtype: CERT_FIND_TYPE, pvfindpara: *const core::ffi::c_void, pprevctlcontext: *const CTL_CONTEXT) -> *mut CTL_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertFindCTLInStore(hcertstore : HCERTSTORE, dwmsgandcertencodingtype : u32, dwfindflags : u32, dwfindtype : CERT_FIND_TYPE, pvfindpara : *const core::ffi::c_void, pprevctlcontext : *const CTL_CONTEXT) -> *mut CTL_CONTEXT);
pub type CertFindCertificateInCRL = unsafe extern "system" fn(pcert: *const CERT_CONTEXT, pcrlcontext: *const CRL_CONTEXT, dwflags: u32, pvreserved: *const core::ffi::c_void, ppcrlentry: *mut *mut CRL_ENTRY) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertFindCertificateInCRL(pcert : *const CERT_CONTEXT, pcrlcontext : *const CRL_CONTEXT, dwflags : u32, pvreserved : *const core::ffi::c_void, ppcrlentry : *mut *mut CRL_ENTRY) -> windows_sys::core::BOOL);
pub type CertFindCertificateInStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, dwfindflags: u32, dwfindtype: CERT_FIND_FLAGS, pvfindpara: *const core::ffi::c_void, pprevcertcontext: *const CERT_CONTEXT) -> *mut CERT_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertFindCertificateInStore(hcertstore : HCERTSTORE, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, dwfindflags : u32, dwfindtype : CERT_FIND_FLAGS, pvfindpara : *const core::ffi::c_void, pprevcertcontext : *const CERT_CONTEXT) -> *mut CERT_CONTEXT);
pub type CertFindChainInStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, dwfindflags: CERT_FIND_CHAIN_IN_STORE_FLAGS, dwfindtype: u32, pvfindpara: *const core::ffi::c_void, pprevchaincontext: *const CERT_CHAIN_CONTEXT) -> *mut CERT_CHAIN_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertFindChainInStore(hcertstore : HCERTSTORE, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, dwfindflags : CERT_FIND_CHAIN_IN_STORE_FLAGS, dwfindtype : u32, pvfindpara : *const core::ffi::c_void, pprevchaincontext : *const CERT_CHAIN_CONTEXT) -> *mut CERT_CHAIN_CONTEXT);
pub type CertFindExtension = unsafe extern "system" fn(pszobjid: windows_sys::core::PCSTR, cextensions: u32, rgextensions: *const CERT_EXTENSION) -> *mut CERT_EXTENSION;
windows_link::link!("crypt32.dll" "system" fn CertFindExtension(pszobjid : windows_sys::core::PCSTR, cextensions : u32, rgextensions : *const CERT_EXTENSION) -> *mut CERT_EXTENSION);
pub type CertFindRDNAttr = unsafe extern "system" fn(pszobjid: windows_sys::core::PCSTR, pname: *const CERT_NAME_INFO) -> *mut CERT_RDN_ATTR;
windows_link::link!("crypt32.dll" "system" fn CertFindRDNAttr(pszobjid : windows_sys::core::PCSTR, pname : *const CERT_NAME_INFO) -> *mut CERT_RDN_ATTR);
pub type CertFindSubjectInCTL = unsafe extern "system" fn(dwencodingtype: u32, dwsubjecttype: u32, pvsubject: *const core::ffi::c_void, pctlcontext: *const CTL_CONTEXT, dwflags: u32) -> *mut CTL_ENTRY;
windows_link::link!("crypt32.dll" "system" fn CertFindSubjectInCTL(dwencodingtype : u32, dwsubjecttype : u32, pvsubject : *const core::ffi::c_void, pctlcontext : *const CTL_CONTEXT, dwflags : u32) -> *mut CTL_ENTRY);
pub type CertFindSubjectInSortedCTL = unsafe extern "system" fn(psubjectidentifier: *const CRYPT_INTEGER_BLOB, pctlcontext: *const CTL_CONTEXT, dwflags: u32, pvreserved: *const core::ffi::c_void, pencodedattributes: *mut CRYPT_INTEGER_BLOB) -> windows_sys::core::BOOL;
...
pub type CertFreeCRLContext = unsafe extern "system" fn(pcrlcontext: *const CRL_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertFreeCRLContext(pcrlcontext : *const CRL_CONTEXT) -> windows_sys::core::BOOL);
pub type CertFreeCTLContext = unsafe extern "system" fn(pctlcontext: *const CTL_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertFreeCTLContext(pctlcontext : *const CTL_CONTEXT) -> windows_sys::core::BOOL);
pub type CertFreeCertificateChain = unsafe extern "system" fn(pchaincontext: *const CERT_CHAIN_CONTEXT);
windows_link::link!("crypt32.dll" "system" fn CertFreeCertificateChain(pchaincontext : *const CERT_CHAIN_CONTEXT));
pub type CertFreeCertificateChainEngine = unsafe extern "system" fn(hchainengine: HCERTCHAINENGINE);
windows_link::link!("crypt32.dll" "system" fn CertFreeCertificateChainEngine(hchainengine : HCERTCHAINENGINE));
pub type CertFreeCertificateChainList = unsafe extern "system" fn(prgpselection: *const *const CERT_CHAIN_CONTEXT);
windows_link::link!("crypt32.dll" "system" fn CertFreeCertificateChainList(prgpselection : *const *const CERT_CHAIN_CONTEXT));
pub type CertFreeCertificateContext = unsafe extern "system" fn(pcertcontext: *const CERT_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertFreeCertificateContext(pcertcontext : *const CERT_CONTEXT) -> windows_sys::core::BOOL);
pub type CertFreeServerOcspResponseContext = unsafe extern "system" fn(pserverocspresponsecontext: *const CERT_SERVER_OCSP_RESPONSE_CONTEXT);
...
pub type CertGetCRLContextProperty = unsafe extern "system" fn(pcrlcontext: *const CRL_CONTEXT, dwpropid: u32, pvdata: *mut core::ffi::c_void, pcbdata: *mut u32) -> windows_sys::core::BOOL;
...
pub type CertGetCRLFromStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, pissuercontext: *const CERT_CONTEXT, pprevcrlcontext: *const CRL_CONTEXT, pdwflags: *mut u32) -> *mut CRL_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertGetCRLFromStore(hcertstore : HCERTSTORE, pissuercontext : *const CERT_CONTEXT, pprevcrlcontext : *const CRL_CONTEXT, pdwflags : *mut u32) -> *mut CRL_CONTEXT);
pub type CertGetCTLContextProperty = unsafe extern "system" fn(pctlcontext: *const CTL_CONTEXT, dwpropid: u32, pvdata: *mut core::ffi::c_void, pcbdata: *mut u32) -> windows_sys::core::BOOL;
...
pub type CertGetCertificateChain = unsafe extern "system" fn(hchainengine: HCERTCHAINENGINE, pcertcontext: *const CERT_CONTEXT, ptime: *const super::super::Foundation::FILETIME, hadditionalstore: HCERTSTORE, pchainpara: *const CERT_CHAIN_PARA, dwflags: u32, pvreserved: *const core::ffi::c_void, ppchaincontext: *mut *mut CERT_CHAIN_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertGetCertificateChain(hchainengine : HCERTCHAINENGINE, pcertcontext : *const CERT_CONTEXT, ptime : *const super::super::Foundation::FILETIME, hadditionalstore : HCERTSTORE, pchainpara : *const CERT_CHAIN_PARA, dwflags : u32, pvreserved : *const core::ffi::c_void, ppchaincontext : *mut *mut CERT_CHAIN_CONTEXT) -> windows_sys::core::BOOL);
pub type CertGetCertificateContextProperty = unsafe extern "system" fn(pcertcontext: *const CERT_CONTEXT, dwpropid: u32, pvdata: *mut core::ffi::c_void, pcbdata: *mut u32) -> windows_sys::core::BOOL;
...
pub type CertGetEnhancedKeyUsage = unsafe extern "system" fn(pcertcontext: *const CERT_CONTEXT, dwflags: u32, pusage: *mut CTL_USAGE, pcbusage: *mut u32) -> windows_sys::core::BOOL;
...
pub type CertGetIntendedKeyUsage = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pcertinfo: *const CERT_INFO, pbkeyusage: *mut u8, cbkeyusage: u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertGetIntendedKeyUsage(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pcertinfo : *const CERT_INFO, pbkeyusage : *mut u8, cbkeyusage : u32) -> windows_sys::core::BOOL);
pub type CertGetIssuerCertificateFromStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, psubjectcontext: *const CERT_CONTEXT, pprevissuercontext: *const CERT_CONTEXT, pdwflags: *mut u32) -> *mut CERT_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertGetIssuerCertificateFromStore(hcertstore : HCERTSTORE, psubjectcontext : *const CERT_CONTEXT, pprevissuercontext : *const CERT_CONTEXT, pdwflags : *mut u32) -> *mut CERT_CONTEXT);
pub type CertGetNameStringA = unsafe extern "system" fn(pcertcontext: *const CERT_CONTEXT, dwtype: u32, dwflags: u32, pvtypepara: *const core::ffi::c_void, psznamestring: windows_sys::core::PSTR, cchnamestring: u32) -> u32;
...
pub type CertGetNameStringW = unsafe extern "system" fn(pcertcontext: *const CERT_CONTEXT, dwtype: u32, dwflags: u32, pvtypepara: *const core::ffi::c_void, psznamestring: windows_sys::core::PWSTR, cchnamestring: u32) -> u32;
...
pub type CertGetPublicKeyLength = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, ppublickey: *const CERT_PUBLIC_KEY_INFO) -> u32;
windows_link::link!("crypt32.dll" "system" fn CertGetPublicKeyLength(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, ppublickey : *const CERT_PUBLIC_KEY_INFO) -> u32);
pub type CertGetServerOcspResponseContext = unsafe extern "system" fn(hserverocspresponse: *const core::ffi::c_void, dwflags: u32, pvreserved: *const core::ffi::c_void) -> *mut CERT_SERVER_OCSP_RESPONSE_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertGetServerOcspResponseContext(hserverocspresponse : *const core::ffi::c_void, dwflags : u32, pvreserved : *const core::ffi::c_void) -> *mut CERT_SERVER_OCSP_RESPONSE_CONTEXT);
pub type CertGetStoreProperty = unsafe extern "system" fn(hcertstore: HCERTSTORE, dwpropid: u32, pvdata: *mut core::ffi::c_void, pcbdata: *mut u32) -> windows_sys::core::BOOL;
...
pub type CertGetSubjectCertificateFromStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pcertid: *const CERT_INFO) -> *mut CERT_CONTEXT;
windows_link::link!("crypt32.dll" "system" fn CertGetSubjectCertificateFromStore(hcertstore : HCERTSTORE, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pcertid : *const CERT_INFO) -> *mut CERT_CONTEXT);
pub type CertGetValidUsages = unsafe extern "system" fn(ccerts: u32, rghcerts: *const *const CERT_CONTEXT, cnumoids: *mut i32, rghoids: *mut windows_sys::core::PSTR, pcboids: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertGetValidUsages(ccerts : u32, rghcerts : *const *const CERT_CONTEXT, cnumoids : *mut i32, rghoids : *mut windows_sys::core::PSTR, pcboids : *mut u32) -> windows_sys::core::BOOL);
pub type CertIsRDNAttrsInCertificateName = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, dwflags: u32, pcertname: *const CRYPT_INTEGER_BLOB, prdn: *const CERT_RDN) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertIsRDNAttrsInCertificateName(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, dwflags : u32, pcertname : *const CRYPT_INTEGER_BLOB, prdn : *const CERT_RDN) -> windows_sys::core::BOOL);
pub type CertIsStrongHashToSign = unsafe extern "system" fn(pstrongsignpara: *const CERT_STRONG_SIGN_PARA, pwszcnghashalgid: windows_sys::core::PCWSTR, psigningcert: *const CERT_CONTEXT) -> windows_sys::core::BOOL;
...
pub type CertIsValidCRLForCertificate = unsafe extern "system" fn(pcert: *const CERT_CONTEXT, pcrl: *const CRL_CONTEXT, dwflags: u32, pvreserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type CertIsWeakHash = unsafe extern "system" fn(dwhashusetype: u32, pwszcnghashalgid: windows_sys::core::PCWSTR, dwchainflags: u32, psignerchaincontext: *const CERT_CHAIN_CONTEXT, ptimestamp: *const super::super::Foundation::FILETIME, pwszfilename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertIsWeakHash(dwhashusetype : u32, pwszcnghashalgid : windows_sys::core::PCWSTR, dwchainflags : u32, psignerchaincontext : *const CERT_CHAIN_CONTEXT, ptimestamp : *const super::super::Foundation::FILETIME, pwszfilename : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
pub type CertNameToStrA = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pname: *const CRYPT_INTEGER_BLOB, dwstrtype: CERT_STRING_TYPE, psz: windows_sys::core::PSTR, csz: u32) -> u32;
windows_link::link!("crypt32.dll" "system" fn CertNameToStrA(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pname : *const CRYPT_INTEGER_BLOB, dwstrtype : CERT_STRING_TYPE, psz : windows_sys::core::PSTR, csz : u32) -> u32);
pub type CertNameToStrW = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pname: *const CRYPT_INTEGER_BLOB, dwstrtype: CERT_STRING_TYPE, psz: windows_sys::core::PWSTR, csz: u32) -> u32;
windows_link::link!("crypt32.dll" "system" fn CertNameToStrW(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pname : *const CRYPT_INTEGER_BLOB, dwstrtype : CERT_STRING_TYPE, psz : windows_sys::core::PWSTR, csz : u32) -> u32);
pub type CertOIDToAlgId = unsafe extern "system" fn(pszobjid: windows_sys::core::PCSTR) -> u32;
windows_link::link!("crypt32.dll" "system" fn CertOIDToAlgId(pszobjid : windows_sys::core::PCSTR) -> u32);
pub type CertOpenServerOcspResponse = unsafe extern "system" fn(pchaincontext: *const CERT_CHAIN_CONTEXT, dwflags: u32, popenpara: *const CERT_SERVER_OCSP_RESPONSE_OPEN_PARA) -> *mut core::ffi::c_void;
windows_link::link!("crypt32.dll" "system" fn CertOpenServerOcspResponse(pchaincontext : *const CERT_CHAIN_CONTEXT, dwflags : u32, popenpara : *const CERT_SERVER_OCSP_RESPONSE_OPEN_PARA) -> *mut core::ffi::c_void);
pub type CertOpenStore = unsafe extern "system" fn(lpszstoreprovider: windows_sys::core::PCSTR, dwencodingtype: CERT_QUERY_ENCODING_TYPE, hcryptprov: HCRYPTPROV_LEGACY, dwflags: CERT_OPEN_STORE_FLAGS, pvpara: *const core::ffi::c_void) -> HCERTSTORE;
windows_link::link!("crypt32.dll" "system" fn CertOpenStore(lpszstoreprovider : windows_sys::core::PCSTR, dwencodingtype : CERT_QUERY_ENCODING_TYPE, hcryptprov : HCRYPTPROV_LEGACY, dwflags : CERT_OPEN_STORE_FLAGS, pvpara : *const core::ffi::c_void) -> HCERTSTORE);
pub type CertOpenSystemStoreA = unsafe extern "system" fn(hprov: HCRYPTPROV_LEGACY, szsubsystemprotocol: windows_sys::core::PCSTR) -> HCERTSTORE;
...
pub type CertOpenSystemStoreW = unsafe extern "system" fn(hprov: HCRYPTPROV_LEGACY, szsubsystemprotocol: windows_sys::core::PCWSTR) -> HCERTSTORE;
...
pub type CertRDNValueToStrA = unsafe extern "system" fn(dwvaluetype: u32, pvalue: *const CRYPT_INTEGER_BLOB, psz: windows_sys::core::PSTR, csz: u32) -> u32;
...
pub type CertRDNValueToStrW = unsafe extern "system" fn(dwvaluetype: u32, pvalue: *const CRYPT_INTEGER_BLOB, psz: windows_sys::core::PWSTR, csz: u32) -> u32;
...
pub type CertRegisterPhysicalStore = unsafe extern "system" fn(pvsystemstore: *const core::ffi::c_void, dwflags: u32, pwszstorename: windows_sys::core::PCWSTR, pstoreinfo: *const CERT_PHYSICAL_STORE_INFO, pvreserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type CertRegisterSystemStore = unsafe extern "system" fn(pvsystemstore: *const core::ffi::c_void, dwflags: u32, pstoreinfo: *const CERT_SYSTEM_STORE_INFO, pvreserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type CertRemoveEnhancedKeyUsageIdentifier = unsafe extern "system" fn(pcertcontext: *const CERT_CONTEXT, pszusageidentifier: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type CertRemoveStoreFromCollection = unsafe extern "system" fn(hcollectionstore: HCERTSTORE, hsiblingstore: HCERTSTORE);
...
pub type CertResyncCertificateChainEngine = unsafe extern "system" fn(hchainengine: HCERTCHAINENGINE) -> windows_sys::core::BOOL;
...
pub type CertRetrieveLogoOrBiometricInfo = unsafe extern "system" fn(pcertcontext: *const CERT_CONTEXT, lpszlogoorbiometrictype: windows_sys::core::PCSTR, dwretrievalflags: u32, dwtimeout: u32, dwflags: u32, pvreserved: *const core::ffi::c_void, ppbdata: *mut *mut u8, pcbdata: *mut u32, ppwszmimetype: *mut windows_sys::core::PWSTR) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertRetrieveLogoOrBiometricInfo(pcertcontext : *const CERT_CONTEXT, lpszlogoorbiometrictype : windows_sys::core::PCSTR, dwretrievalflags : u32, dwtimeout : u32, dwflags : u32, pvreserved : *const core::ffi::c_void, ppbdata : *mut *mut u8, pcbdata : *mut u32, ppwszmimetype : *mut windows_sys::core::PWSTR) -> windows_sys::core::BOOL);
pub type CertSaveStore = unsafe extern "system" fn(hcertstore: HCERTSTORE, dwencodingtype: CERT_QUERY_ENCODING_TYPE, dwsaveas: CERT_STORE_SAVE_AS, dwsaveto: CERT_STORE_SAVE_TO, pvsavetopara: *mut core::ffi::c_void, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertSaveStore(hcertstore : HCERTSTORE, dwencodingtype : CERT_QUERY_ENCODING_TYPE, dwsaveas : CERT_STORE_SAVE_AS, dwsaveto : CERT_STORE_SAVE_TO, pvsavetopara : *mut core::ffi::c_void, dwflags : u32) -> windows_sys::core::BOOL);
pub type CertSelectCertificateChains = unsafe extern "system" fn(pselectioncontext: *const windows_sys::core::GUID, dwflags: u32, pchainparameters: *const CERT_SELECT_CHAIN_PARA, ccriteria: u32, rgpcriteria: *const CERT_SELECT_CRITERIA, hstore: HCERTSTORE, pcselection: *mut u32, pprgpselection: *mut *mut *mut CERT_CHAIN_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertSelectCertificateChains(pselectioncontext : *const windows_sys::core::GUID, dwflags : u32, pchainparameters : *const CERT_SELECT_CHAIN_PARA, ccriteria : u32, rgpcriteria : *const CERT_SELECT_CRITERIA, hstore : HCERTSTORE, pcselection : *mut u32, pprgpselection : *mut *mut *mut CERT_CHAIN_CONTEXT) -> windows_sys::core::BOOL);
pub type CertSerializeCRLStoreElement = unsafe extern "system" fn(pcrlcontext: *const CRL_CONTEXT, dwflags: u32, pbelement: *mut u8, pcbelement: *mut u32) -> windows_sys::core::BOOL;
...
pub type CertSerializeCTLStoreElement = unsafe extern "system" fn(pctlcontext: *const CTL_CONTEXT, dwflags: u32, pbelement: *mut u8, pcbelement: *mut u32) -> windows_sys::core::BOOL;
...
pub type CertSerializeCertificateStoreElement = unsafe extern "system" fn(pcertcontext: *const CERT_CONTEXT, dwflags: u32, pbelement: *mut u8, pcbelement: *mut u32) -> windows_sys::core::BOOL;
...
pub type CertSetCRLContextProperty = unsafe extern "system" fn(pcrlcontext: *const CRL_CONTEXT, dwpropid: u32, dwflags: u32, pvdata: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type CertSetCTLContextProperty = unsafe extern "system" fn(pctlcontext: *const CTL_CONTEXT, dwpropid: u32, dwflags: u32, pvdata: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type CertSetCertificateContextPropertiesFromCTLEntry = unsafe extern "system" fn(pcertcontext: *const CERT_CONTEXT, pctlentry: *const CTL_ENTRY, dwflags: u32) -> windows_sys::core::BOOL;
...
pub type CertSetCertificateContextProperty = unsafe extern "system" fn(pcertcontext: *const CERT_CONTEXT, dwpropid: u32, dwflags: u32, pvdata: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type CertSetEnhancedKeyUsage = unsafe extern "system" fn(pcertcontext: *const CERT_CONTEXT, pusage: *const CTL_USAGE) -> windows_sys::core::BOOL;
...
pub type CertSetStoreProperty = unsafe extern "system" fn(hcertstore: HCERTSTORE, dwpropid: u32, dwflags: u32, pvdata: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type CertStrToNameA = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pszx500: windows_sys::core::PCSTR, dwstrtype: CERT_STRING_TYPE, pvreserved: *const core::ffi::c_void, pbencoded: *mut u8, pcbencoded: *mut u32, ppszerror: *mut windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertStrToNameA(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pszx500 : windows_sys::core::PCSTR, dwstrtype : CERT_STRING_TYPE, pvreserved : *const core::ffi::c_void, pbencoded : *mut u8, pcbencoded : *mut u32, ppszerror : *mut windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
pub type CertStrToNameW = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pszx500: windows_sys::core::PCWSTR, dwstrtype: CERT_STRING_TYPE, pvreserved: *const core::ffi::c_void, pbencoded: *mut u8, pcbencoded: *mut u32, ppszerror: *mut windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertStrToNameW(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pszx500 : windows_sys::core::PCWSTR, dwstrtype : CERT_STRING_TYPE, pvreserved : *const core::ffi::c_void, pbencoded : *mut u8, pcbencoded : *mut u32, ppszerror : *mut windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
pub type CertUnregisterPhysicalStore = unsafe extern "system" fn(pvsystemstore: *const core::ffi::c_void, dwflags: u32, pwszstorename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type CertUnregisterSystemStore = unsafe extern "system" fn(pvsystemstore: *const core::ffi::c_void, dwflags: u32) -> windows_sys::core::BOOL;
...
pub type CertVerifyCRLRevocation = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pcertid: *const CERT_INFO, ccrlinfo: u32, rgpcrlinfo: *const *const CRL_INFO) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CertVerifyCRLRevocation(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pcertid : *const CERT_INFO, ccrlinfo : u32, rgpcrlinfo : *const *const CRL_INFO) -> windows_sys::core::BOOL);
pub type CertVerifyCRLTimeValidity = unsafe extern "system" fn(ptimetoverify: *const super::super::Foundation::FILETIME, pcrlinfo: *const CRL_INFO) -> i32;
windows_link::link!("crypt32.dll" "system" fn CertVerifyCRLTimeValidity(ptimetoverify : *const super::super::Foundation::FILETIME, pcrlinfo : *const CRL_INFO) -> i32);
pub type CertVerifyCTLUsage = unsafe extern "system" fn(dwencodingtype: u32, dwsubjecttype: u32, pvsubject: *const core::ffi::c_void, psubjectusage: *const CTL_USAGE, dwflags: u32, pverifyusagepara: *const CTL_VERIFY_USAGE_PARA, pverifyusagestatus: *mut CTL_VERIFY_USAGE_STATUS) -> windows_sys::core::BOOL;
...
pub type CertVerifyCertificateChainPolicy = unsafe extern "system" fn(pszpolicyoid: windows_sys::core::PCSTR, pchaincontext: *const CERT_CHAIN_CONTEXT, ppolicypara: *const CERT_CHAIN_POLICY_PARA, ppolicystatus: *mut CERT_CHAIN_POLICY_STATUS) -> windows_sys::core::BOOL;
...
pub type CertVerifyRevocation = unsafe extern "system" fn(dwencodingtype: u32, dwrevtype: u32, ccontext: u32, rgpvcontext: *const *const core::ffi::c_void, dwflags: u32, prevpara: *const CERT_REVOCATION_PARA, prevstatus: *mut CERT_REVOCATION_STATUS) -> windows_sys::core::BOOL;
...
pub type CertVerifySubjectCertificateContext = unsafe extern "system" fn(psubject: *const CERT_CONTEXT, pissuer: *const CERT_CONTEXT, pdwflags: *mut u32) -> windows_sys::core::BOOL;
...
pub type CertVerifyTimeValidity = unsafe extern "system" fn(ptimetoverify: *const super::super::Foundation::FILETIME, pcertinfo: *const CERT_INFO) -> i32;
windows_link::link!("crypt32.dll" "system" fn CertVerifyTimeValidity(ptimetoverify : *const super::super::Foundation::FILETIME, pcertinfo : *const CERT_INFO) -> i32);
pub type CertVerifyValidityNesting = unsafe extern "system" fn(psubjectinfo: *const CERT_INFO, pissuerinfo: *const CERT_INFO) -> windows_sys::core::BOOL;
...
pub type CloseCryptoHandle = unsafe extern "system" fn(hcrypto: *const INFORMATIONCARD_CRYPTO_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("infocardapi.dll" "system" fn CloseCryptoHandle(hcrypto : *const INFORMATIONCARD_CRYPTO_HANDLE) -> windows_sys::core::HRESULT);
pub type CryptAcquireCertificatePrivateKey = unsafe extern "system" fn(pcert: *const CERT_CONTEXT, dwflags: CRYPT_ACQUIRE_FLAGS, pvparameters: *const core::ffi::c_void, phcryptprovorncryptkey: *mut HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, pdwkeyspec: *mut CERT_KEY_SPEC, pfcallerfreeprovorncryptkey: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptAcquireCertificatePrivateKey(pcert : *const CERT_CONTEXT, dwflags : CRYPT_ACQUIRE_FLAGS, pvparameters : *const core::ffi::c_void, phcryptprovorncryptkey : *mut HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, pdwkeyspec : *mut CERT_KEY_SPEC, pfcallerfreeprovorncryptkey : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type CryptAcquireContextA = unsafe extern "system" fn(phprov: *mut usize, szcontainer: windows_sys::core::PCSTR, szprovider: windows_sys::core::PCSTR, dwprovtype: u32, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptAcquireContextA(phprov : *mut usize, szcontainer : windows_sys::core::PCSTR, szprovider : windows_sys::core::PCSTR, dwprovtype : u32, dwflags : u32) -> windows_sys::core::BOOL);
pub type CryptAcquireContextW = unsafe extern "system" fn(phprov: *mut usize, szcontainer: windows_sys::core::PCWSTR, szprovider: windows_sys::core::PCWSTR, dwprovtype: u32, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptAcquireContextW(phprov : *mut usize, szcontainer : windows_sys::core::PCWSTR, szprovider : windows_sys::core::PCWSTR, dwprovtype : u32, dwflags : u32) -> windows_sys::core::BOOL);
pub type CryptBinaryToStringA = unsafe extern "system" fn(pbbinary: *const u8, cbbinary: u32, dwflags: CRYPT_STRING, pszstring: windows_sys::core::PSTR, pcchstring: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptBinaryToStringA(pbbinary : *const u8, cbbinary : u32, dwflags : CRYPT_STRING, pszstring : windows_sys::core::PSTR, pcchstring : *mut u32) -> windows_sys::core::BOOL);
pub type CryptBinaryToStringW = unsafe extern "system" fn(pbbinary: *const u8, cbbinary: u32, dwflags: CRYPT_STRING, pszstring: windows_sys::core::PWSTR, pcchstring: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptBinaryToStringW(pbbinary : *const u8, cbbinary : u32, dwflags : CRYPT_STRING, pszstring : windows_sys::core::PWSTR, pcchstring : *mut u32) -> windows_sys::core::BOOL);
pub type CryptCloseAsyncHandle = unsafe extern "system" fn(hasync: HCRYPTASYNC) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptCloseAsyncHandle(hasync : HCRYPTASYNC) -> windows_sys::core::BOOL);
pub type CryptContextAddRef = unsafe extern "system" fn(hprov: usize, pdwreserved: *const u32, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptContextAddRef(hprov : usize, pdwreserved : *const u32, dwflags : u32) -> windows_sys::core::BOOL);
pub type CryptCreateAsyncHandle = unsafe extern "system" fn(dwflags: u32, phasync: *mut HCRYPTASYNC) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptCreateAsyncHandle(dwflags : u32, phasync : *mut HCRYPTASYNC) -> windows_sys::core::BOOL);
pub type CryptCreateHash = unsafe extern "system" fn(hprov: usize, algid: ALG_ID, hkey: usize, dwflags: u32, phhash: *mut usize) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptCreateHash(hprov : usize, algid : ALG_ID, hkey : usize, dwflags : u32, phhash : *mut usize) -> windows_sys::core::BOOL);
pub type CryptCreateKeyIdentifierFromCSP = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pszpubkeyoid: windows_sys::core::PCSTR, ppubkeystruc: *const PUBLICKEYSTRUC, cbpubkeystruc: u32, dwflags: u32, pvreserved: *const core::ffi::c_void, pbhash: *mut u8, pcbhash: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptCreateKeyIdentifierFromCSP(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pszpubkeyoid : windows_sys::core::PCSTR, ppubkeystruc : *const PUBLICKEYSTRUC, cbpubkeystruc : u32, dwflags : u32, pvreserved : *const core::ffi::c_void, pbhash : *mut u8, pcbhash : *mut u32) -> windows_sys::core::BOOL);
pub type CryptDecodeMessage = unsafe extern "system" fn(dwmsgtypeflags: u32, pdecryptpara: *const CRYPT_DECRYPT_MESSAGE_PARA, pverifypara: *const CRYPT_VERIFY_MESSAGE_PARA, dwsignerindex: u32, pbencodedblob: *const u8, cbencodedblob: u32, dwprevinnercontenttype: u32, pdwmsgtype: *mut u32, pdwinnercontenttype: *mut u32, pbdecoded: *mut u8, pcbdecoded: *mut u32, ppxchgcert: *mut *mut CERT_CONTEXT, ppsignercert: *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptDecodeMessage(dwmsgtypeflags : u32, pdecryptpara : *const CRYPT_DECRYPT_MESSAGE_PARA, pverifypara : *const CRYPT_VERIFY_MESSAGE_PARA, dwsignerindex : u32, pbencodedblob : *const u8, cbencodedblob : u32, dwprevinnercontenttype : u32, pdwmsgtype : *mut u32, pdwinnercontenttype : *mut u32, pbdecoded : *mut u8, pcbdecoded : *mut u32, ppxchgcert : *mut *mut CERT_CONTEXT, ppsignercert : *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL);
pub type CryptDecodeObject = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, lpszstructtype: windows_sys::core::PCSTR, pbencoded: *const u8, cbencoded: u32, dwflags: u32, pvstructinfo: *mut core::ffi::c_void, pcbstructinfo: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptDecodeObject(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, lpszstructtype : windows_sys::core::PCSTR, pbencoded : *const u8, cbencoded : u32, dwflags : u32, pvstructinfo : *mut core::ffi::c_void, pcbstructinfo : *mut u32) -> windows_sys::core::BOOL);
pub type CryptDecodeObjectEx = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, lpszstructtype: windows_sys::core::PCSTR, pbencoded: *const u8, cbencoded: u32, dwflags: u32, pdecodepara: *const CRYPT_DECODE_PARA, pvstructinfo: *mut core::ffi::c_void, pcbstructinfo: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptDecodeObjectEx(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, lpszstructtype : windows_sys::core::PCSTR, pbencoded : *const u8, cbencoded : u32, dwflags : u32, pdecodepara : *const CRYPT_DECODE_PARA, pvstructinfo : *mut core::ffi::c_void, pcbstructinfo : *mut u32) -> windows_sys::core::BOOL);
pub type CryptDecrypt = unsafe extern "system" fn(hkey: usize, hhash: usize, r#final: windows_sys::core::BOOL, dwflags: u32, pbdata: *mut u8, pdwdatalen: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptDecrypt(hkey : usize, hhash : usize, r#final : windows_sys::core::BOOL, dwflags : u32, pbdata : *mut u8, pdwdatalen : *mut u32) -> windows_sys::core::BOOL);
pub type CryptDecryptAndVerifyMessageSignature = unsafe extern "system" fn(pdecryptpara: *const CRYPT_DECRYPT_MESSAGE_PARA, pverifypara: *const CRYPT_VERIFY_MESSAGE_PARA, dwsignerindex: u32, pbencryptedblob: *const u8, cbencryptedblob: u32, pbdecrypted: *mut u8, pcbdecrypted: *mut u32, ppxchgcert: *mut *mut CERT_CONTEXT, ppsignercert: *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptDecryptAndVerifyMessageSignature(pdecryptpara : *const CRYPT_DECRYPT_MESSAGE_PARA, pverifypara : *const CRYPT_VERIFY_MESSAGE_PARA, dwsignerindex : u32, pbencryptedblob : *const u8, cbencryptedblob : u32, pbdecrypted : *mut u8, pcbdecrypted : *mut u32, ppxchgcert : *mut *mut CERT_CONTEXT, ppsignercert : *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL);
pub type CryptDecryptMessage = unsafe extern "system" fn(pdecryptpara: *const CRYPT_DECRYPT_MESSAGE_PARA, pbencryptedblob: *const u8, cbencryptedblob: u32, pbdecrypted: *mut u8, pcbdecrypted: *mut u32, ppxchgcert: *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptDecryptMessage(pdecryptpara : *const CRYPT_DECRYPT_MESSAGE_PARA, pbencryptedblob : *const u8, cbencryptedblob : u32, pbdecrypted : *mut u8, pcbdecrypted : *mut u32, ppxchgcert : *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL);
pub type CryptDeriveKey = unsafe extern "system" fn(hprov: usize, algid: ALG_ID, hbasedata: usize, dwflags: u32, phkey: *mut usize) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptDeriveKey(hprov : usize, algid : ALG_ID, hbasedata : usize, dwflags : u32, phkey : *mut usize) -> windows_sys::core::BOOL);
pub type CryptDestroyHash = unsafe extern "system" fn(hhash: usize) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptDestroyHash(hhash : usize) -> windows_sys::core::BOOL);
pub type CryptDestroyKey = unsafe extern "system" fn(hkey: usize) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptDestroyKey(hkey : usize) -> windows_sys::core::BOOL);
pub type CryptDuplicateHash = unsafe extern "system" fn(hhash: usize, pdwreserved: *const u32, dwflags: u32, phhash: *mut usize) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptDuplicateHash(hhash : usize, pdwreserved : *const u32, dwflags : u32, phhash : *mut usize) -> windows_sys::core::BOOL);
pub type CryptDuplicateKey = unsafe extern "system" fn(hkey: usize, pdwreserved: *const u32, dwflags: u32, phkey: *mut usize) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptDuplicateKey(hkey : usize, pdwreserved : *const u32, dwflags : u32, phkey : *mut usize) -> windows_sys::core::BOOL);
pub type CryptEncodeObject = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, lpszstructtype: windows_sys::core::PCSTR, pvstructinfo: *const core::ffi::c_void, pbencoded: *mut u8, pcbencoded: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptEncodeObject(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, lpszstructtype : windows_sys::core::PCSTR, pvstructinfo : *const core::ffi::c_void, pbencoded : *mut u8, pcbencoded : *mut u32) -> windows_sys::core::BOOL);
pub type CryptEncodeObjectEx = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, lpszstructtype: windows_sys::core::PCSTR, pvstructinfo: *const core::ffi::c_void, dwflags: CRYPT_ENCODE_OBJECT_FLAGS, pencodepara: *const CRYPT_ENCODE_PARA, pvencoded: *mut core::ffi::c_void, pcbencoded: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptEncodeObjectEx(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, lpszstructtype : windows_sys::core::PCSTR, pvstructinfo : *const core::ffi::c_void, dwflags : CRYPT_ENCODE_OBJECT_FLAGS, pencodepara : *const CRYPT_ENCODE_PARA, pvencoded : *mut core::ffi::c_void, pcbencoded : *mut u32) -> windows_sys::core::BOOL);
pub type CryptEncrypt = unsafe extern "system" fn(hkey: usize, hhash: usize, r#final: windows_sys::core::BOOL, dwflags: u32, pbdata: *mut u8, pdwdatalen: *mut u32, dwbuflen: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptEncrypt(hkey : usize, hhash : usize, r#final : windows_sys::core::BOOL, dwflags : u32, pbdata : *mut u8, pdwdatalen : *mut u32, dwbuflen : u32) -> windows_sys::core::BOOL);
pub type CryptEncryptMessage = unsafe extern "system" fn(pencryptpara: *const CRYPT_ENCRYPT_MESSAGE_PARA, crecipientcert: u32, rgprecipientcert: *const *const CERT_CONTEXT, pbtobeencrypted: *const u8, cbtobeencrypted: u32, pbencryptedblob: *mut u8, pcbencryptedblob: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptEncryptMessage(pencryptpara : *const CRYPT_ENCRYPT_MESSAGE_PARA, crecipientcert : u32, rgprecipientcert : *const *const CERT_CONTEXT, pbtobeencrypted : *const u8, cbtobeencrypted : u32, pbencryptedblob : *mut u8, pcbencryptedblob : *mut u32) -> windows_sys::core::BOOL);
pub type CryptEnumKeyIdentifierProperties = unsafe extern "system" fn(pkeyidentifier: *const CRYPT_INTEGER_BLOB, dwpropid: u32, dwflags: u32, pwszcomputername: windows_sys::core::PCWSTR, pvreserved: *const core::ffi::c_void, pvarg: *mut core::ffi::c_void, pfnenum: PFN_CRYPT_ENUM_KEYID_PROP) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptEnumKeyIdentifierProperties(pkeyidentifier : *const CRYPT_INTEGER_BLOB, dwpropid : u32, dwflags : u32, pwszcomputername : windows_sys::core::PCWSTR, pvreserved : *const core::ffi::c_void, pvarg : *mut core::ffi::c_void, pfnenum : PFN_CRYPT_ENUM_KEYID_PROP) -> windows_sys::core::BOOL);
pub type CryptEnumOIDFunction = unsafe extern "system" fn(dwencodingtype: u32, pszfuncname: windows_sys::core::PCSTR, pszoid: windows_sys::core::PCSTR, dwflags: u32, pvarg: *mut core::ffi::c_void, pfnenumoidfunc: PFN_CRYPT_ENUM_OID_FUNC) -> windows_sys::core::BOOL;
...
pub type CryptEnumOIDInfo = unsafe extern "system" fn(dwgroupid: u32, dwflags: u32, pvarg: *mut core::ffi::c_void, pfnenumoidinfo: PFN_CRYPT_ENUM_OID_INFO) -> windows_sys::core::BOOL;
...
pub type CryptEnumProviderTypesA = unsafe extern "system" fn(dwindex: u32, pdwreserved: *const u32, dwflags: u32, pdwprovtype: *mut u32, sztypename: windows_sys::core::PSTR, pcbtypename: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptEnumProviderTypesW = unsafe extern "system" fn(dwindex: u32, pdwreserved: *const u32, dwflags: u32, pdwprovtype: *mut u32, sztypename: windows_sys::core::PWSTR, pcbtypename: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptEnumProvidersA = unsafe extern "system" fn(dwindex: u32, pdwreserved: *const u32, dwflags: u32, pdwprovtype: *mut u32, szprovname: windows_sys::core::PSTR, pcbprovname: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptEnumProvidersW = unsafe extern "system" fn(dwindex: u32, pdwreserved: *const u32, dwflags: u32, pdwprovtype: *mut u32, szprovname: windows_sys::core::PWSTR, pcbprovname: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptExportKey = unsafe extern "system" fn(hkey: usize, hexpkey: usize, dwblobtype: u32, dwflags: CRYPT_KEY_FLAGS, pbdata: *mut u8, pdwdatalen: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptExportKey(hkey : usize, hexpkey : usize, dwblobtype : u32, dwflags : CRYPT_KEY_FLAGS, pbdata : *mut u8, pdwdatalen : *mut u32) -> windows_sys::core::BOOL);
pub type CryptExportPKCS8 = unsafe extern "system" fn(hcryptprov: usize, dwkeyspec: u32, pszprivatekeyobjid: windows_sys::core::PCSTR, dwflags: u32, pvauxinfo: *const core::ffi::c_void, pbprivatekeyblob: *mut u8, pcbprivatekeyblob: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptExportPKCS8(hcryptprov : usize, dwkeyspec : u32, pszprivatekeyobjid : windows_sys::core::PCSTR, dwflags : u32, pvauxinfo : *const core::ffi::c_void, pbprivatekeyblob : *mut u8, pcbprivatekeyblob : *mut u32) -> windows_sys::core::BOOL);
pub type CryptExportPublicKeyInfo = unsafe extern "system" fn(hcryptprovorncryptkey: HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, dwkeyspec: u32, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pinfo: *mut CERT_PUBLIC_KEY_INFO, pcbinfo: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptExportPublicKeyInfo(hcryptprovorncryptkey : HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, dwkeyspec : u32, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pinfo : *mut CERT_PUBLIC_KEY_INFO, pcbinfo : *mut u32) -> windows_sys::core::BOOL);
pub type CryptExportPublicKeyInfoEx = unsafe extern "system" fn(hcryptprovorncryptkey: HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, dwkeyspec: u32, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pszpublickeyobjid: windows_sys::core::PCSTR, dwflags: u32, pvauxinfo: *const core::ffi::c_void, pinfo: *mut CERT_PUBLIC_KEY_INFO, pcbinfo: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptExportPublicKeyInfoFromBCryptKeyHandle = unsafe extern "system" fn(hbcryptkey: BCRYPT_KEY_HANDLE, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pszpublickeyobjid: windows_sys::core::PCSTR, dwflags: u32, pvauxinfo: *const core::ffi::c_void, pinfo: *mut CERT_PUBLIC_KEY_INFO, pcbinfo: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptExportPublicKeyInfoFromBCryptKeyHandle(hbcryptkey : BCRYPT_KEY_HANDLE, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pszpublickeyobjid : windows_sys::core::PCSTR, dwflags : u32, pvauxinfo : *const core::ffi::c_void, pinfo : *mut CERT_PUBLIC_KEY_INFO, pcbinfo : *mut u32) -> windows_sys::core::BOOL);
pub type CryptFindCertificateKeyProvInfo = unsafe extern "system" fn(pcert: *const CERT_CONTEXT, dwflags: CRYPT_FIND_FLAGS, pvreserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptFindCertificateKeyProvInfo(pcert : *const CERT_CONTEXT, dwflags : CRYPT_FIND_FLAGS, pvreserved : *const core::ffi::c_void) -> windows_sys::core::BOOL);
pub type CryptFindLocalizedName = unsafe extern "system" fn(pwszcryptname: windows_sys::core::PCWSTR) -> windows_sys::core::PCWSTR;
...
pub type CryptFindOIDInfo = unsafe extern "system" fn(dwkeytype: u32, pvkey: *const core::ffi::c_void, dwgroupid: u32) -> *mut CRYPT_OID_INFO;
windows_link::link!("crypt32.dll" "system" fn CryptFindOIDInfo(dwkeytype : u32, pvkey : *const core::ffi::c_void, dwgroupid : u32) -> *mut CRYPT_OID_INFO);
pub type CryptFormatObject = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, dwformattype: u32, dwformatstrtype: u32, pformatstruct: *const core::ffi::c_void, lpszstructtype: windows_sys::core::PCSTR, pbencoded: *const u8, cbencoded: u32, pbformat: *mut core::ffi::c_void, pcbformat: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptFormatObject(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, dwformattype : u32, dwformatstrtype : u32, pformatstruct : *const core::ffi::c_void, lpszstructtype : windows_sys::core::PCSTR, pbencoded : *const u8, cbencoded : u32, pbformat : *mut core::ffi::c_void, pcbformat : *mut u32) -> windows_sys::core::BOOL);
pub type CryptFreeOIDFunctionAddress = unsafe extern "system" fn(hfuncaddr: *const core::ffi::c_void, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptFreeOIDFunctionAddress(hfuncaddr : *const core::ffi::c_void, dwflags : u32) -> windows_sys::core::BOOL);
pub type CryptGenKey = unsafe extern "system" fn(hprov: usize, algid: ALG_ID, dwflags: CRYPT_KEY_FLAGS, phkey: *mut usize) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptGenKey(hprov : usize, algid : ALG_ID, dwflags : CRYPT_KEY_FLAGS, phkey : *mut usize) -> windows_sys::core::BOOL);
pub type CryptGenRandom = unsafe extern "system" fn(hprov: usize, dwlen: u32, pbbuffer: *mut u8) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptGenRandom(hprov : usize, dwlen : u32, pbbuffer : *mut u8) -> windows_sys::core::BOOL);
pub type CryptGetAsyncParam = unsafe extern "system" fn(hasync: HCRYPTASYNC, pszparamoid: windows_sys::core::PCSTR, ppvparam: *mut *mut core::ffi::c_void, ppfnfree: *mut PFN_CRYPT_ASYNC_PARAM_FREE_FUNC) -> windows_sys::core::BOOL;
...
pub type CryptGetDefaultOIDDllList = unsafe extern "system" fn(hfuncset: *const core::ffi::c_void, dwencodingtype: u32, pwszdlllist: windows_sys::core::PWSTR, pcchdlllist: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptGetDefaultOIDDllList(hfuncset : *const core::ffi::c_void, dwencodingtype : u32, pwszdlllist : windows_sys::core::PWSTR, pcchdlllist : *mut u32) -> windows_sys::core::BOOL);
pub type CryptGetDefaultOIDFunctionAddress = unsafe extern "system" fn(hfuncset: *const core::ffi::c_void, dwencodingtype: u32, pwszdll: windows_sys::core::PCWSTR, dwflags: u32, ppvfuncaddr: *mut *mut core::ffi::c_void, phfuncaddr: *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptGetDefaultOIDFunctionAddress(hfuncset : *const core::ffi::c_void, dwencodingtype : u32, pwszdll : windows_sys::core::PCWSTR, dwflags : u32, ppvfuncaddr : *mut *mut core::ffi::c_void, phfuncaddr : *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL);
pub type CryptGetDefaultProviderA = unsafe extern "system" fn(dwprovtype: u32, pdwreserved: *const u32, dwflags: u32, pszprovname: windows_sys::core::PSTR, pcbprovname: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptGetDefaultProviderW = unsafe extern "system" fn(dwprovtype: u32, pdwreserved: *const u32, dwflags: u32, pszprovname: windows_sys::core::PWSTR, pcbprovname: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptGetHashParam = unsafe extern "system" fn(hhash: usize, dwparam: u32, pbdata: *mut u8, pdwdatalen: *mut u32, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptGetHashParam(hhash : usize, dwparam : u32, pbdata : *mut u8, pdwdatalen : *mut u32, dwflags : u32) -> windows_sys::core::BOOL);
pub type CryptGetKeyIdentifierProperty = unsafe extern "system" fn(pkeyidentifier: *const CRYPT_INTEGER_BLOB, dwpropid: u32, dwflags: u32, pwszcomputername: windows_sys::core::PCWSTR, pvreserved: *const core::ffi::c_void, pvdata: *mut core::ffi::c_void, pcbdata: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptGetKeyIdentifierProperty(pkeyidentifier : *const CRYPT_INTEGER_BLOB, dwpropid : u32, dwflags : u32, pwszcomputername : windows_sys::core::PCWSTR, pvreserved : *const core::ffi::c_void, pvdata : *mut core::ffi::c_void, pcbdata : *mut u32) -> windows_sys::core::BOOL);
pub type CryptGetKeyParam = unsafe extern "system" fn(hkey: usize, dwparam: CRYPT_KEY_PARAM_ID, pbdata: *mut u8, pdwdatalen: *mut u32, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptGetKeyParam(hkey : usize, dwparam : CRYPT_KEY_PARAM_ID, pbdata : *mut u8, pdwdatalen : *mut u32, dwflags : u32) -> windows_sys::core::BOOL);
pub type CryptGetMessageCertificates = unsafe extern "system" fn(dwmsgandcertencodingtype: u32, hcryptprov: HCRYPTPROV_LEGACY, dwflags: u32, pbsignedblob: *const u8, cbsignedblob: u32) -> HCERTSTORE;
...
pub type CryptGetMessageSignerCount = unsafe extern "system" fn(dwmsgencodingtype: u32, pbsignedblob: *const u8, cbsignedblob: u32) -> i32;
...
pub type CryptGetOIDFunctionAddress = unsafe extern "system" fn(hfuncset: *const core::ffi::c_void, dwencodingtype: u32, pszoid: windows_sys::core::PCSTR, dwflags: u32, ppvfuncaddr: *mut *mut core::ffi::c_void, phfuncaddr: *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptGetOIDFunctionAddress(hfuncset : *const core::ffi::c_void, dwencodingtype : u32, pszoid : windows_sys::core::PCSTR, dwflags : u32, ppvfuncaddr : *mut *mut core::ffi::c_void, phfuncaddr : *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL);
pub type CryptGetOIDFunctionValue = unsafe extern "system" fn(dwencodingtype: u32, pszfuncname: windows_sys::core::PCSTR, pszoid: windows_sys::core::PCSTR, pwszvaluename: windows_sys::core::PCWSTR, pdwvaluetype: *mut u32, pbvaluedata: *mut u8, pcbvaluedata: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptGetObjectUrl = unsafe extern "system" fn(pszurloid: windows_sys::core::PCSTR, pvpara: *const core::ffi::c_void, dwflags: CRYPT_GET_URL_FLAGS, purlarray: *mut CRYPT_URL_ARRAY, pcburlarray: *mut u32, purlinfo: *mut CRYPT_URL_INFO, pcburlinfo: *mut u32, pvreserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("cryptnet.dll" "system" fn CryptGetObjectUrl(pszurloid : windows_sys::core::PCSTR, pvpara : *const core::ffi::c_void, dwflags : CRYPT_GET_URL_FLAGS, purlarray : *mut CRYPT_URL_ARRAY, pcburlarray : *mut u32, purlinfo : *mut CRYPT_URL_INFO, pcburlinfo : *mut u32, pvreserved : *const core::ffi::c_void) -> windows_sys::core::BOOL);
pub type CryptGetProvParam = unsafe extern "system" fn(hprov: usize, dwparam: u32, pbdata: *mut u8, pdwdatalen: *mut u32, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptGetProvParam(hprov : usize, dwparam : u32, pbdata : *mut u8, pdwdatalen : *mut u32, dwflags : u32) -> windows_sys::core::BOOL);
pub type CryptGetUserKey = unsafe extern "system" fn(hprov: usize, dwkeyspec: u32, phuserkey: *mut usize) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptGetUserKey(hprov : usize, dwkeyspec : u32, phuserkey : *mut usize) -> windows_sys::core::BOOL);
pub type CryptHashCertificate = unsafe extern "system" fn(hcryptprov: HCRYPTPROV_LEGACY, algid: ALG_ID, dwflags: u32, pbencoded: *const u8, cbencoded: u32, pbcomputedhash: *mut u8, pcbcomputedhash: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptHashCertificate2 = unsafe extern "system" fn(pwszcnghashalgid: windows_sys::core::PCWSTR, dwflags: u32, pvreserved: *const core::ffi::c_void, pbencoded: *const u8, cbencoded: u32, pbcomputedhash: *mut u8, pcbcomputedhash: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptHashData = unsafe extern "system" fn(hhash: usize, pbdata: *const u8, dwdatalen: u32, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptHashData(hhash : usize, pbdata : *const u8, dwdatalen : u32, dwflags : u32) -> windows_sys::core::BOOL);
pub type CryptHashMessage = unsafe extern "system" fn(phashpara: *const CRYPT_HASH_MESSAGE_PARA, fdetachedhash: windows_sys::core::BOOL, ctobehashed: u32, rgpbtobehashed: *const *const u8, rgcbtobehashed: *const u32, pbhashedblob: *mut u8, pcbhashedblob: *mut u32, pbcomputedhash: *mut u8, pcbcomputedhash: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptHashPublicKeyInfo = unsafe extern "system" fn(hcryptprov: HCRYPTPROV_LEGACY, algid: ALG_ID, dwflags: u32, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pinfo: *const CERT_PUBLIC_KEY_INFO, pbcomputedhash: *mut u8, pcbcomputedhash: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptHashPublicKeyInfo(hcryptprov : HCRYPTPROV_LEGACY, algid : ALG_ID, dwflags : u32, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pinfo : *const CERT_PUBLIC_KEY_INFO, pbcomputedhash : *mut u8, pcbcomputedhash : *mut u32) -> windows_sys::core::BOOL);
pub type CryptHashSessionKey = unsafe extern "system" fn(hhash: usize, hkey: usize, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptHashSessionKey(hhash : usize, hkey : usize, dwflags : u32) -> windows_sys::core::BOOL);
pub type CryptHashToBeSigned = unsafe extern "system" fn(hcryptprov: HCRYPTPROV_LEGACY, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pbencoded: *const u8, cbencoded: u32, pbcomputedhash: *mut u8, pcbcomputedhash: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptHashToBeSigned(hcryptprov : HCRYPTPROV_LEGACY, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pbencoded : *const u8, cbencoded : u32, pbcomputedhash : *mut u8, pcbcomputedhash : *mut u32) -> windows_sys::core::BOOL);
pub type CryptImportKey = unsafe extern "system" fn(hprov: usize, pbdata: *const u8, dwdatalen: u32, hpubkey: usize, dwflags: CRYPT_KEY_FLAGS, phkey: *mut usize) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptImportKey(hprov : usize, pbdata : *const u8, dwdatalen : u32, hpubkey : usize, dwflags : CRYPT_KEY_FLAGS, phkey : *mut usize) -> windows_sys::core::BOOL);
pub type CryptImportPKCS8 = unsafe extern "system" fn(sprivatekeyandparams: CRYPT_PKCS8_IMPORT_PARAMS, dwflags: CRYPT_KEY_FLAGS, phcryptprov: *mut usize, pvauxinfo: *const core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptImportPKCS8(sprivatekeyandparams : CRYPT_PKCS8_IMPORT_PARAMS, dwflags : CRYPT_KEY_FLAGS, phcryptprov : *mut usize, pvauxinfo : *const core::ffi::c_void) -> windows_sys::core::BOOL);
pub type CryptImportPublicKeyInfo = unsafe extern "system" fn(hcryptprov: usize, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pinfo: *const CERT_PUBLIC_KEY_INFO, phkey: *mut usize) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptImportPublicKeyInfo(hcryptprov : usize, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pinfo : *const CERT_PUBLIC_KEY_INFO, phkey : *mut usize) -> windows_sys::core::BOOL);
pub type CryptImportPublicKeyInfoEx = unsafe extern "system" fn(hcryptprov: usize, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pinfo: *const CERT_PUBLIC_KEY_INFO, aikeyalg: ALG_ID, dwflags: u32, pvauxinfo: *const core::ffi::c_void, phkey: *mut usize) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptImportPublicKeyInfoEx(hcryptprov : usize, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pinfo : *const CERT_PUBLIC_KEY_INFO, aikeyalg : ALG_ID, dwflags : u32, pvauxinfo : *const core::ffi::c_void, phkey : *mut usize) -> windows_sys::core::BOOL);
pub type CryptImportPublicKeyInfoEx2 = unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pinfo: *const CERT_PUBLIC_KEY_INFO, dwflags: CRYPT_IMPORT_PUBLIC_KEY_FLAGS, pvauxinfo: *const core::ffi::c_void, phkey: *mut BCRYPT_KEY_HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptImportPublicKeyInfoEx2(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pinfo : *const CERT_PUBLIC_KEY_INFO, dwflags : CRYPT_IMPORT_PUBLIC_KEY_FLAGS, pvauxinfo : *const core::ffi::c_void, phkey : *mut BCRYPT_KEY_HANDLE) -> windows_sys::core::BOOL);
pub type CryptInitOIDFunctionSet = unsafe extern "system" fn(pszfuncname: windows_sys::core::PCSTR, dwflags: u32) -> *mut core::ffi::c_void;
windows_link::link!("crypt32.dll" "system" fn CryptInitOIDFunctionSet(pszfuncname : windows_sys::core::PCSTR, dwflags : u32) -> *mut core::ffi::c_void);
pub type CryptInstallCancelRetrieval = unsafe extern "system" fn(pfncancel: PFN_CRYPT_CANCEL_RETRIEVAL, pvarg: *const core::ffi::c_void, dwflags: u32, pvreserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type CryptInstallDefaultContext = unsafe extern "system" fn(hcryptprov: usize, dwdefaulttype: CRYPT_DEFAULT_CONTEXT_TYPE, pvdefaultpara: *const core::ffi::c_void, dwflags: CRYPT_DEFAULT_CONTEXT_FLAGS, pvreserved: *const core::ffi::c_void, phdefaultcontext: *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptInstallDefaultContext(hcryptprov : usize, dwdefaulttype : CRYPT_DEFAULT_CONTEXT_TYPE, pvdefaultpara : *const core::ffi::c_void, dwflags : CRYPT_DEFAULT_CONTEXT_FLAGS, pvreserved : *const core::ffi::c_void, phdefaultcontext : *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL);
pub type CryptInstallOIDFunctionAddress = unsafe extern "system" fn(hmodule: super::super::Foundation::HMODULE, dwencodingtype: u32, pszfuncname: windows_sys::core::PCSTR, cfuncentry: u32, rgfuncentry: *const CRYPT_OID_FUNC_ENTRY, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptInstallOIDFunctionAddress(hmodule : super::super::Foundation::HMODULE, dwencodingtype : u32, pszfuncname : windows_sys::core::PCSTR, cfuncentry : u32, rgfuncentry : *const CRYPT_OID_FUNC_ENTRY, dwflags : u32) -> windows_sys::core::BOOL);
pub type CryptMemAlloc = unsafe extern "system" fn(cbsize: u32) -> *mut core::ffi::c_void;
windows_link::link!("crypt32.dll" "system" fn CryptMemAlloc(cbsize : u32) -> *mut core::ffi::c_void);
pub type CryptMemFree = unsafe extern "system" fn(pv: *const core::ffi::c_void);
windows_link::link!("crypt32.dll" "system" fn CryptMemFree(pv : *const core::ffi::c_void));
pub type CryptMemRealloc = unsafe extern "system" fn(pv: *const core::ffi::c_void, cbsize: u32) -> *mut core::ffi::c_void;
windows_link::link!("crypt32.dll" "system" fn CryptMemRealloc(pv : *const core::ffi::c_void, cbsize : u32) -> *mut core::ffi::c_void);
pub type CryptMsgCalculateEncodedLength = unsafe extern "system" fn(dwmsgencodingtype: u32, dwflags: u32, dwmsgtype: u32, pvmsgencodeinfo: *const core::ffi::c_void, pszinnercontentobjid: windows_sys::core::PCSTR, cbdata: u32) -> u32;
...
pub type CryptMsgClose = unsafe extern "system" fn(hcryptmsg: *const core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptMsgClose(hcryptmsg : *const core::ffi::c_void) -> windows_sys::core::BOOL);
pub type CryptMsgControl = unsafe extern "system" fn(hcryptmsg: *const core::ffi::c_void, dwflags: u32, dwctrltype: u32, pvctrlpara: *const core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptMsgControl(hcryptmsg : *const core::ffi::c_void, dwflags : u32, dwctrltype : u32, pvctrlpara : *const core::ffi::c_void) -> windows_sys::core::BOOL);
pub type CryptMsgCountersign = unsafe extern "system" fn(hcryptmsg: *const core::ffi::c_void, dwindex: u32, ccountersigners: u32, rgcountersigners: *const CMSG_SIGNER_ENCODE_INFO) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptMsgCountersign(hcryptmsg : *const core::ffi::c_void, dwindex : u32, ccountersigners : u32, rgcountersigners : *const CMSG_SIGNER_ENCODE_INFO) -> windows_sys::core::BOOL);
pub type CryptMsgCountersignEncoded = unsafe extern "system" fn(dwencodingtype: u32, pbsignerinfo: *const u8, cbsignerinfo: u32, ccountersigners: u32, rgcountersigners: *const CMSG_SIGNER_ENCODE_INFO, pbcountersignature: *mut u8, pcbcountersignature: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptMsgDuplicate = unsafe extern "system" fn(hcryptmsg: *const core::ffi::c_void) -> *mut core::ffi::c_void;
windows_link::link!("crypt32.dll" "system" fn CryptMsgDuplicate(hcryptmsg : *const core::ffi::c_void) -> *mut core::ffi::c_void);
pub type CryptMsgEncodeAndSignCTL = unsafe extern "system" fn(dwmsgencodingtype: u32, pctlinfo: *const CTL_INFO, psigninfo: *const CMSG_SIGNED_ENCODE_INFO, dwflags: u32, pbencoded: *mut u8, pcbencoded: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptMsgGetAndVerifySigner = unsafe extern "system" fn(hcryptmsg: *const core::ffi::c_void, csignerstore: u32, rghsignerstore: *const HCERTSTORE, dwflags: u32, ppsigner: *mut *mut CERT_CONTEXT, pdwsignerindex: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptMsgGetAndVerifySigner(hcryptmsg : *const core::ffi::c_void, csignerstore : u32, rghsignerstore : *const HCERTSTORE, dwflags : u32, ppsigner : *mut *mut CERT_CONTEXT, pdwsignerindex : *mut u32) -> windows_sys::core::BOOL);
pub type CryptMsgGetParam = unsafe extern "system" fn(hcryptmsg: *const core::ffi::c_void, dwparamtype: u32, dwindex: u32, pvdata: *mut core::ffi::c_void, pcbdata: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptMsgGetParam(hcryptmsg : *const core::ffi::c_void, dwparamtype : u32, dwindex : u32, pvdata : *mut core::ffi::c_void, pcbdata : *mut u32) -> windows_sys::core::BOOL);
pub type CryptMsgOpenToDecode = unsafe extern "system" fn(dwmsgencodingtype: u32, dwflags: u32, dwmsgtype: u32, hcryptprov: HCRYPTPROV_LEGACY, precipientinfo: *const CERT_INFO, pstreaminfo: *const CMSG_STREAM_INFO) -> *mut core::ffi::c_void;
windows_link::link!("crypt32.dll" "system" fn CryptMsgOpenToDecode(dwmsgencodingtype : u32, dwflags : u32, dwmsgtype : u32, hcryptprov : HCRYPTPROV_LEGACY, precipientinfo : *const CERT_INFO, pstreaminfo : *const CMSG_STREAM_INFO) -> *mut core::ffi::c_void);
pub type CryptMsgOpenToEncode = unsafe extern "system" fn(dwmsgencodingtype: u32, dwflags: u32, dwmsgtype: CRYPT_MSG_TYPE, pvmsgencodeinfo: *const core::ffi::c_void, pszinnercontentobjid: windows_sys::core::PCSTR, pstreaminfo: *const CMSG_STREAM_INFO) -> *mut core::ffi::c_void;
windows_link::link!("crypt32.dll" "system" fn CryptMsgOpenToEncode(dwmsgencodingtype : u32, dwflags : u32, dwmsgtype : CRYPT_MSG_TYPE, pvmsgencodeinfo : *const core::ffi::c_void, pszinnercontentobjid : windows_sys::core::PCSTR, pstreaminfo : *const CMSG_STREAM_INFO) -> *mut core::ffi::c_void);
pub type CryptMsgSignCTL = unsafe extern "system" fn(dwmsgencodingtype: u32, pbctlcontent: *const u8, cbctlcontent: u32, psigninfo: *const CMSG_SIGNED_ENCODE_INFO, dwflags: u32, pbencoded: *mut u8, pcbencoded: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptMsgUpdate = unsafe extern "system" fn(hcryptmsg: *const core::ffi::c_void, pbdata: *const u8, cbdata: u32, ffinal: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptMsgUpdate(hcryptmsg : *const core::ffi::c_void, pbdata : *const u8, cbdata : u32, ffinal : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type CryptMsgVerifyCountersignatureEncoded = unsafe extern "system" fn(hcryptprov: HCRYPTPROV_LEGACY, dwencodingtype: u32, pbsignerinfo: *const u8, cbsignerinfo: u32, pbsignerinfocountersignature: *const u8, cbsignerinfocountersignature: u32, pcicountersigner: *const CERT_INFO) -> windows_sys::core::BOOL;
...
pub type CryptQueryObject = unsafe extern "system" fn(dwobjecttype: CERT_QUERY_OBJECT_TYPE, pvobject: *const core::ffi::c_void, dwexpectedcontenttypeflags: CERT_QUERY_CONTENT_TYPE_FLAGS, dwexpectedformattypeflags: CERT_QUERY_FORMAT_TYPE_FLAGS, dwflags: u32, pdwmsgandcertencodingtype: *mut CERT_QUERY_ENCODING_TYPE, pdwcontenttype: *mut CERT_QUERY_CONTENT_TYPE, pdwformattype: *mut CERT_QUERY_FORMAT_TYPE, phcertstore: *mut HCERTSTORE, phmsg: *mut *mut core::ffi::c_void, ppvcontext: *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptQueryObject(dwobjecttype : CERT_QUERY_OBJECT_TYPE, pvobject : *const core::ffi::c_void, dwexpectedcontenttypeflags : CERT_QUERY_CONTENT_TYPE_FLAGS, dwexpectedformattypeflags : CERT_QUERY_FORMAT_TYPE_FLAGS, dwflags : u32, pdwmsgandcertencodingtype : *mut CERT_QUERY_ENCODING_TYPE, pdwcontenttype : *mut CERT_QUERY_CONTENT_TYPE, pdwformattype : *mut CERT_QUERY_FORMAT_TYPE, phcertstore : *mut HCERTSTORE, phmsg : *mut *mut core::ffi::c_void, ppvcontext : *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL);
pub type CryptRegisterDefaultOIDFunction = unsafe extern "system" fn(dwencodingtype: u32, pszfuncname: windows_sys::core::PCSTR, dwindex: u32, pwszdll: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type CryptRegisterOIDFunction = unsafe extern "system" fn(dwencodingtype: u32, pszfuncname: windows_sys::core::PCSTR, pszoid: windows_sys::core::PCSTR, pwszdll: windows_sys::core::PCWSTR, pszoverridefuncname: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type CryptRegisterOIDInfo = unsafe extern "system" fn(pinfo: *const CRYPT_OID_INFO, dwflags: u32) -> windows_sys::core::BOOL;
...
pub type CryptReleaseContext = unsafe extern "system" fn(hprov: usize, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptReleaseContext(hprov : usize, dwflags : u32) -> windows_sys::core::BOOL);
pub type CryptRetrieveObjectByUrlA = unsafe extern "system" fn(pszurl: windows_sys::core::PCSTR, pszobjectoid: windows_sys::core::PCSTR, dwretrievalflags: u32, dwtimeout: u32, ppvobject: *mut *mut core::ffi::c_void, hasyncretrieve: HCRYPTASYNC, pcredentials: *const CRYPT_CREDENTIALS, pvverify: *const core::ffi::c_void, pauxinfo: *mut CRYPT_RETRIEVE_AUX_INFO) -> windows_sys::core::BOOL;
...
pub type CryptRetrieveObjectByUrlW = unsafe extern "system" fn(pszurl: windows_sys::core::PCWSTR, pszobjectoid: windows_sys::core::PCSTR, dwretrievalflags: u32, dwtimeout: u32, ppvobject: *mut *mut core::ffi::c_void, hasyncretrieve: HCRYPTASYNC, pcredentials: *const CRYPT_CREDENTIALS, pvverify: *const core::ffi::c_void, pauxinfo: *mut CRYPT_RETRIEVE_AUX_INFO) -> windows_sys::core::BOOL;
...
pub type CryptSetAsyncParam = unsafe extern "system" fn(hasync: HCRYPTASYNC, pszparamoid: windows_sys::core::PCSTR, pvparam: *const core::ffi::c_void, pfnfree: PFN_CRYPT_ASYNC_PARAM_FREE_FUNC) -> windows_sys::core::BOOL;
...
pub type CryptSetHashParam = unsafe extern "system" fn(hhash: usize, dwparam: CRYPT_SET_HASH_PARAM, pbdata: *const u8, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptSetHashParam(hhash : usize, dwparam : CRYPT_SET_HASH_PARAM, pbdata : *const u8, dwflags : u32) -> windows_sys::core::BOOL);
pub type CryptSetKeyIdentifierProperty = unsafe extern "system" fn(pkeyidentifier: *const CRYPT_INTEGER_BLOB, dwpropid: u32, dwflags: u32, pwszcomputername: windows_sys::core::PCWSTR, pvreserved: *const core::ffi::c_void, pvdata: *const core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptSetKeyIdentifierProperty(pkeyidentifier : *const CRYPT_INTEGER_BLOB, dwpropid : u32, dwflags : u32, pwszcomputername : windows_sys::core::PCWSTR, pvreserved : *const core::ffi::c_void, pvdata : *const core::ffi::c_void) -> windows_sys::core::BOOL);
pub type CryptSetKeyParam = unsafe extern "system" fn(hkey: usize, dwparam: CRYPT_KEY_PARAM_ID, pbdata: *const u8, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptSetKeyParam(hkey : usize, dwparam : CRYPT_KEY_PARAM_ID, pbdata : *const u8, dwflags : u32) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_System_Registry")]
pub type CryptSetOIDFunctionValue = unsafe extern "system" fn(dwencodingtype: u32, pszfuncname: windows_sys::core::PCSTR, pszoid: windows_sys::core::PCSTR, pwszvaluename: windows_sys::core::PCWSTR, dwvaluetype: super::super::System::Registry::REG_VALUE_TYPE, pbvaluedata: *const u8, cbvaluedata: u32) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_System_Registry")]
windows_link::link!("crypt32.dll" "system" fn CryptSetOIDFunctionValue(dwencodingtype : u32, pszfuncname : windows_sys::core::PCSTR, pszoid : windows_sys::core::PCSTR, pwszvaluename : windows_sys::core::PCWSTR, dwvaluetype : super::super::System::Registry::REG_VALUE_TYPE, pbvaluedata : *const u8, cbvaluedata : u32) -> windows_sys::core::BOOL);
pub type CryptSetProvParam = unsafe extern "system" fn(hprov: usize, dwparam: CRYPT_SET_PROV_PARAM_ID, pbdata: *const u8, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptSetProvParam(hprov : usize, dwparam : CRYPT_SET_PROV_PARAM_ID, pbdata : *const u8, dwflags : u32) -> windows_sys::core::BOOL);
pub type CryptSetProviderA = unsafe extern "system" fn(pszprovname: windows_sys::core::PCSTR, dwprovtype: u32) -> windows_sys::core::BOOL;
...
pub type CryptSetProviderExA = unsafe extern "system" fn(pszprovname: windows_sys::core::PCSTR, dwprovtype: u32, pdwreserved: *const u32, dwflags: u32) -> windows_sys::core::BOOL;
...
pub type CryptSetProviderExW = unsafe extern "system" fn(pszprovname: windows_sys::core::PCWSTR, dwprovtype: u32, pdwreserved: *const u32, dwflags: u32) -> windows_sys::core::BOOL;
...
pub type CryptSetProviderW = unsafe extern "system" fn(pszprovname: windows_sys::core::PCWSTR, dwprovtype: u32) -> windows_sys::core::BOOL;
...
pub type CryptSignAndEncodeCertificate = unsafe extern "system" fn(hcryptprovorncryptkey: HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, dwkeyspec: CERT_KEY_SPEC, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, lpszstructtype: windows_sys::core::PCSTR, pvstructinfo: *const core::ffi::c_void, psignaturealgorithm: *const CRYPT_ALGORITHM_IDENTIFIER, pvhashauxinfo: *const core::ffi::c_void, pbencoded: *mut u8, pcbencoded: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptSignAndEncodeCertificate(hcryptprovorncryptkey : HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, dwkeyspec : CERT_KEY_SPEC, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, lpszstructtype : windows_sys::core::PCSTR, pvstructinfo : *const core::ffi::c_void, psignaturealgorithm : *const CRYPT_ALGORITHM_IDENTIFIER, pvhashauxinfo : *const core::ffi::c_void, pbencoded : *mut u8, pcbencoded : *mut u32) -> windows_sys::core::BOOL);
pub type CryptSignAndEncryptMessage = unsafe extern "system" fn(psignpara: *const CRYPT_SIGN_MESSAGE_PARA, pencryptpara: *const CRYPT_ENCRYPT_MESSAGE_PARA, crecipientcert: u32, rgprecipientcert: *const *const CERT_CONTEXT, pbtobesignedandencrypted: *const u8, cbtobesignedandencrypted: u32, pbsignedandencryptedblob: *mut u8, pcbsignedandencryptedblob: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptSignHashA = unsafe extern "system" fn(hhash: usize, dwkeyspec: u32, szdescription: windows_sys::core::PCSTR, dwflags: u32, pbsignature: *mut u8, pdwsiglen: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptSignHashA(hhash : usize, dwkeyspec : u32, szdescription : windows_sys::core::PCSTR, dwflags : u32, pbsignature : *mut u8, pdwsiglen : *mut u32) -> windows_sys::core::BOOL);
pub type CryptSignHashW = unsafe extern "system" fn(hhash: usize, dwkeyspec: u32, szdescription: windows_sys::core::PCWSTR, dwflags: u32, pbsignature: *mut u8, pdwsiglen: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptSignHashW(hhash : usize, dwkeyspec : u32, szdescription : windows_sys::core::PCWSTR, dwflags : u32, pbsignature : *mut u8, pdwsiglen : *mut u32) -> windows_sys::core::BOOL);
pub type CryptSignMessage = unsafe extern "system" fn(psignpara: *const CRYPT_SIGN_MESSAGE_PARA, fdetachedsignature: windows_sys::core::BOOL, ctobesigned: u32, rgpbtobesigned: *const *const u8, rgcbtobesigned: *const u32, pbsignedblob: *mut u8, pcbsignedblob: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptSignMessageWithKey = unsafe extern "system" fn(psignpara: *const CRYPT_KEY_SIGN_MESSAGE_PARA, pbtobesigned: *const u8, cbtobesigned: u32, pbsignedblob: *mut u8, pcbsignedblob: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptStringToBinaryA = unsafe extern "system" fn(pszstring: windows_sys::core::PCSTR, cchstring: u32, dwflags: CRYPT_STRING, pbbinary: *mut u8, pcbbinary: *mut u32, pdwskip: *mut u32, pdwflags: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptStringToBinaryA(pszstring : windows_sys::core::PCSTR, cchstring : u32, dwflags : CRYPT_STRING, pbbinary : *mut u8, pcbbinary : *mut u32, pdwskip : *mut u32, pdwflags : *mut u32) -> windows_sys::core::BOOL);
pub type CryptStringToBinaryW = unsafe extern "system" fn(pszstring: windows_sys::core::PCWSTR, cchstring: u32, dwflags: CRYPT_STRING, pbbinary: *mut u8, pcbbinary: *mut u32, pdwskip: *mut u32, pdwflags: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptStringToBinaryW(pszstring : windows_sys::core::PCWSTR, cchstring : u32, dwflags : CRYPT_STRING, pbbinary : *mut u8, pcbbinary : *mut u32, pdwskip : *mut u32, pdwflags : *mut u32) -> windows_sys::core::BOOL);
pub type CryptUninstallCancelRetrieval = unsafe extern "system" fn(dwflags: u32, pvreserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type CryptUninstallDefaultContext = unsafe extern "system" fn(hdefaultcontext: *const core::ffi::c_void, dwflags: u32, pvreserved: *const core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptUninstallDefaultContext(hdefaultcontext : *const core::ffi::c_void, dwflags : u32, pvreserved : *const core::ffi::c_void) -> windows_sys::core::BOOL);
pub type CryptUnprotectData = unsafe extern "system" fn(pdatain: *const CRYPT_INTEGER_BLOB, ppszdatadescr: *mut windows_sys::core::PWSTR, poptionalentropy: *const CRYPT_INTEGER_BLOB, pvreserved: *const core::ffi::c_void, ppromptstruct: *const CRYPTPROTECT_PROMPTSTRUCT, dwflags: u32, pdataout: *mut CRYPT_INTEGER_BLOB) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptUnprotectData(pdatain : *const CRYPT_INTEGER_BLOB, ppszdatadescr : *mut windows_sys::core::PWSTR, poptionalentropy : *const CRYPT_INTEGER_BLOB, pvreserved : *const core::ffi::c_void, ppromptstruct : *const CRYPTPROTECT_PROMPTSTRUCT, dwflags : u32, pdataout : *mut CRYPT_INTEGER_BLOB) -> windows_sys::core::BOOL);
pub type CryptUnprotectMemory = unsafe extern "system" fn(pdatain: *mut core::ffi::c_void, cbdatain: u32, dwflags: u32) -> windows_sys::core::BOOL;
...
pub type CryptUnregisterDefaultOIDFunction = unsafe extern "system" fn(dwencodingtype: u32, pszfuncname: windows_sys::core::PCSTR, pwszdll: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type CryptUnregisterOIDFunction = unsafe extern "system" fn(dwencodingtype: u32, pszfuncname: windows_sys::core::PCSTR, pszoid: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type CryptUnregisterOIDInfo = unsafe extern "system" fn(pinfo: *const CRYPT_OID_INFO) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptUnregisterOIDInfo(pinfo : *const CRYPT_OID_INFO) -> windows_sys::core::BOOL);
pub type CryptUpdateProtectedState = unsafe extern "system" fn(poldsid: super::PSID, pwszoldpassword: windows_sys::core::PCWSTR, dwflags: u32, pdwsuccesscount: *mut u32, pdwfailurecount: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptVerifyCertificateSignature = unsafe extern "system" fn(hcryptprov: HCRYPTPROV_LEGACY, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pbencoded: *const u8, cbencoded: u32, ppublickey: *const CERT_PUBLIC_KEY_INFO) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptVerifyCertificateSignature(hcryptprov : HCRYPTPROV_LEGACY, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pbencoded : *const u8, cbencoded : u32, ppublickey : *const CERT_PUBLIC_KEY_INFO) -> windows_sys::core::BOOL);
pub type CryptVerifyCertificateSignatureEx = unsafe extern "system" fn(hcryptprov: HCRYPTPROV_LEGACY, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, dwsubjecttype: u32, pvsubject: *const core::ffi::c_void, dwissuertype: u32, pvissuer: *const core::ffi::c_void, dwflags: CRYPT_VERIFY_CERT_FLAGS, pvextra: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptVerifyCertificateSignatureEx(hcryptprov : HCRYPTPROV_LEGACY, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, dwsubjecttype : u32, pvsubject : *const core::ffi::c_void, dwissuertype : u32, pvissuer : *const core::ffi::c_void, dwflags : CRYPT_VERIFY_CERT_FLAGS, pvextra : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
pub type CryptVerifyDetachedMessageHash = unsafe extern "system" fn(phashpara: *const CRYPT_HASH_MESSAGE_PARA, pbdetachedhashblob: *const u8, cbdetachedhashblob: u32, ctobehashed: u32, rgpbtobehashed: *const *const u8, rgcbtobehashed: *const u32, pbcomputedhash: *mut u8, pcbcomputedhash: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptVerifyDetachedMessageSignature = unsafe extern "system" fn(pverifypara: *const CRYPT_VERIFY_MESSAGE_PARA, dwsignerindex: u32, pbdetachedsignblob: *const u8, cbdetachedsignblob: u32, ctobesigned: u32, rgpbtobesigned: *const *const u8, rgcbtobesigned: *const u32, ppsignercert: *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptVerifyDetachedMessageSignature(pverifypara : *const CRYPT_VERIFY_MESSAGE_PARA, dwsignerindex : u32, pbdetachedsignblob : *const u8, cbdetachedsignblob : u32, ctobesigned : u32, rgpbtobesigned : *const *const u8, rgcbtobesigned : *const u32, ppsignercert : *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL);
pub type CryptVerifyMessageHash = unsafe extern "system" fn(phashpara: *const CRYPT_HASH_MESSAGE_PARA, pbhashedblob: *const u8, cbhashedblob: u32, pbtobehashed: *mut u8, pcbtobehashed: *mut u32, pbcomputedhash: *mut u8, pcbcomputedhash: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptVerifyMessageSignature = unsafe extern "system" fn(pverifypara: *const CRYPT_VERIFY_MESSAGE_PARA, dwsignerindex: u32, pbsignedblob: *const u8, cbsignedblob: u32, pbdecoded: *mut u8, pcbdecoded: *mut u32, ppsignercert: *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptVerifyMessageSignature(pverifypara : *const CRYPT_VERIFY_MESSAGE_PARA, dwsignerindex : u32, pbsignedblob : *const u8, cbsignedblob : u32, pbdecoded : *mut u8, pcbdecoded : *mut u32, ppsignercert : *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL);
pub type CryptVerifyMessageSignatureWithKey = unsafe extern "system" fn(pverifypara: *const CRYPT_KEY_VERIFY_MESSAGE_PARA, ppublickeyinfo: *const CERT_PUBLIC_KEY_INFO, pbsignedblob: *const u8, cbsignedblob: u32, pbdecoded: *mut u8, pcbdecoded: *mut u32) -> windows_sys::core::BOOL;
...
pub type CryptVerifySignatureA = unsafe extern "system" fn(hhash: usize, pbsignature: *const u8, dwsiglen: u32, hpubkey: usize, szdescription: windows_sys::core::PCSTR, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptVerifySignatureA(hhash : usize, pbsignature : *const u8, dwsiglen : u32, hpubkey : usize, szdescription : windows_sys::core::PCSTR, dwflags : u32) -> windows_sys::core::BOOL);
pub type CryptVerifySignatureW = unsafe extern "system" fn(hhash: usize, pbsignature: *const u8, dwsiglen: u32, hpubkey: usize, szdescription: windows_sys::core::PCWSTR, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CryptVerifySignatureW(hhash : usize, pbsignature : *const u8, dwsiglen : u32, hpubkey : usize, szdescription : windows_sys::core::PCWSTR, dwflags : u32) -> windows_sys::core::BOOL);
pub type CryptVerifyTimeStampSignature = unsafe extern "system" fn(pbtscontentinfo: *const u8, cbtscontentinfo: u32, pbdata: *const u8, cbdata: u32, hadditionalstore: HCERTSTORE, pptscontext: *mut *mut CRYPT_TIMESTAMP_CONTEXT, pptssigner: *mut *mut CERT_CONTEXT, phstore: *mut HCERTSTORE) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn CryptVerifyTimeStampSignature(pbtscontentinfo : *const u8, cbtscontentinfo : u32, pbdata : *const u8, cbdata : u32, hadditionalstore : HCERTSTORE, pptscontext : *mut *mut CRYPT_TIMESTAMP_CONTEXT, pptssigner : *mut *mut CERT_CONTEXT, phstore : *mut HCERTSTORE) -> windows_sys::core::BOOL);
pub type CryptXmlAddObject = unsafe extern "system" fn(hsignatureorobject: *const core::ffi::c_void, dwflags: u32, rgproperty: *const CRYPT_XML_PROPERTY, cproperty: u32, pencoded: *const CRYPT_XML_BLOB, ppobject: *mut *mut CRYPT_XML_OBJECT) -> windows_sys::core::HRESULT;
windows_link::link!("cryptxml.dll" "system" fn CryptXmlAddObject(hsignatureorobject : *const core::ffi::c_void, dwflags : u32, rgproperty : *const CRYPT_XML_PROPERTY, cproperty : u32, pencoded : *const CRYPT_XML_BLOB, ppobject : *mut *mut CRYPT_XML_OBJECT) -> windows_sys::core::HRESULT);
pub type CryptXmlClose = unsafe extern "system" fn(hcryptxml: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("cryptxml.dll" "system" fn CryptXmlClose(hcryptxml : *const core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type CryptXmlCreateReference = unsafe extern "system" fn(hcryptxml: *const core::ffi::c_void, dwflags: u32, wszid: windows_sys::core::PCWSTR, wszuri: windows_sys::core::PCWSTR, wsztype: windows_sys::core::PCWSTR, pdigestmethod: *const CRYPT_XML_ALGORITHM, ctransform: u32, rgtransform: *const CRYPT_XML_ALGORITHM, phreference: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("cryptxml.dll" "system" fn CryptXmlCreateReference(hcryptxml : *const core::ffi::c_void, dwflags : u32, wszid : windows_sys::core::PCWSTR, wszuri : windows_sys::core::PCWSTR, wsztype : windows_sys::core::PCWSTR, pdigestmethod : *const CRYPT_XML_ALGORITHM, ctransform : u32, rgtransform : *const CRYPT_XML_ALGORITHM, phreference : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type CryptXmlDigestReference = unsafe extern "system" fn(hreference: *const core::ffi::c_void, dwflags: u32, pdataproviderin: *const CRYPT_XML_DATA_PROVIDER) -> windows_sys::core::HRESULT;
windows_link::link!("cryptxml.dll" "system" fn CryptXmlDigestReference(hreference : *const core::ffi::c_void, dwflags : u32, pdataproviderin : *const CRYPT_XML_DATA_PROVIDER) -> windows_sys::core::HRESULT);
pub type CryptXmlEncode = unsafe extern "system" fn(hcryptxml: *const core::ffi::c_void, dwcharset: CRYPT_XML_CHARSET, rgproperty: *const CRYPT_XML_PROPERTY, cproperty: u32, pvcallbackstate: *mut core::ffi::c_void, pfnwrite: PFN_CRYPT_XML_WRITE_CALLBACK) -> windows_sys::core::HRESULT;
windows_link::link!("cryptxml.dll" "system" fn CryptXmlEncode(hcryptxml : *const core::ffi::c_void, dwcharset : CRYPT_XML_CHARSET, rgproperty : *const CRYPT_XML_PROPERTY, cproperty : u32, pvcallbackstate : *mut core::ffi::c_void, pfnwrite : PFN_CRYPT_XML_WRITE_CALLBACK) -> windows_sys::core::HRESULT);
pub type CryptXmlEnumAlgorithmInfo = unsafe extern "system" fn(dwgroupid: u32, dwflags: u32, pvarg: *mut core::ffi::c_void, pfnenumalginfo: PFN_CRYPT_XML_ENUM_ALG_INFO) -> windows_sys::core::HRESULT;
...
pub type CryptXmlFindAlgorithmInfo = unsafe extern "system" fn(dwfindbytype: u32, pvfindby: *const core::ffi::c_void, dwgroupid: u32, dwflags: u32) -> *mut CRYPT_XML_ALGORITHM_INFO;
windows_link::link!("cryptxml.dll" "system" fn CryptXmlFindAlgorithmInfo(dwfindbytype : u32, pvfindby : *const core::ffi::c_void, dwgroupid : u32, dwflags : u32) -> *mut CRYPT_XML_ALGORITHM_INFO);
pub type CryptXmlGetAlgorithmInfo = unsafe extern "system" fn(pxmlalgorithm: *const CRYPT_XML_ALGORITHM, dwflags: CRYPT_XML_FLAGS, ppalginfo: *mut *mut CRYPT_XML_ALGORITHM_INFO) -> windows_sys::core::HRESULT;
windows_link::link!("cryptxml.dll" "system" fn CryptXmlGetAlgorithmInfo(pxmlalgorithm : *const CRYPT_XML_ALGORITHM, dwflags : CRYPT_XML_FLAGS, ppalginfo : *mut *mut CRYPT_XML_ALGORITHM_INFO) -> windows_sys::core::HRESULT);
pub type CryptXmlGetDocContext = unsafe extern "system" fn(hcryptxml: *const core::ffi::c_void, ppstruct: *mut *mut CRYPT_XML_DOC_CTXT) -> windows_sys::core::HRESULT;
windows_link::link!("cryptxml.dll" "system" fn CryptXmlGetDocContext(hcryptxml : *const core::ffi::c_void, ppstruct : *mut *mut CRYPT_XML_DOC_CTXT) -> windows_sys::core::HRESULT);
pub type CryptXmlGetReference = unsafe extern "system" fn(hcryptxml: *const core::ffi::c_void, ppstruct: *mut *mut CRYPT_XML_REFERENCE) -> windows_sys::core::HRESULT;
windows_link::link!("cryptxml.dll" "system" fn CryptXmlGetReference(hcryptxml : *const core::ffi::c_void, ppstruct : *mut *mut CRYPT_XML_REFERENCE) -> windows_sys::core::HRESULT);
pub type CryptXmlGetSignature = unsafe extern "system" fn(hcryptxml: *const core::ffi::c_void, ppstruct: *mut *mut CRYPT_XML_SIGNATURE) -> windows_sys::core::HRESULT;
windows_link::link!("cryptxml.dll" "system" fn CryptXmlGetSignature(hcryptxml : *const core::ffi::c_void, ppstruct : *mut *mut CRYPT_XML_SIGNATURE) -> windows_sys::core::HRESULT);
pub type CryptXmlGetStatus = unsafe extern "system" fn(hcryptxml: *const core::ffi::c_void, pstatus: *mut CRYPT_XML_STATUS) -> windows_sys::core::HRESULT;
windows_link::link!("cryptxml.dll" "system" fn CryptXmlGetStatus(hcryptxml : *const core::ffi::c_void, pstatus : *mut CRYPT_XML_STATUS) -> windows_sys::core::HRESULT);
pub type CryptXmlGetTransforms = unsafe extern "system" fn(ppconfig: *mut *mut CRYPT_XML_TRANSFORM_CHAIN_CONFIG) -> windows_sys::core::HRESULT;
...
pub type CryptXmlImportPublicKey = unsafe extern "system" fn(dwflags: CRYPT_XML_FLAGS, pkeyvalue: *const CRYPT_XML_KEY_VALUE, phkey: *mut BCRYPT_KEY_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("cryptxml.dll" "system" fn CryptXmlImportPublicKey(dwflags : CRYPT_XML_FLAGS, pkeyvalue : *const CRYPT_XML_KEY_VALUE, phkey : *mut BCRYPT_KEY_HANDLE) -> windows_sys::core::HRESULT);
pub type CryptXmlOpenToDecode = unsafe extern "system" fn(pconfig: *const CRYPT_XML_TRANSFORM_CHAIN_CONFIG, dwflags: CRYPT_XML_FLAGS, rgproperty: *const CRYPT_XML_PROPERTY, cproperty: u32, pencoded: *const CRYPT_XML_BLOB, phcryptxml: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("cryptxml.dll" "system" fn CryptXmlOpenToDecode(pconfig : *const CRYPT_XML_TRANSFORM_CHAIN_CONFIG, dwflags : CRYPT_XML_FLAGS, rgproperty : *const CRYPT_XML_PROPERTY, cproperty : u32, pencoded : *const CRYPT_XML_BLOB, phcryptxml : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type CryptXmlOpenToEncode = unsafe extern "system" fn(pconfig: *const CRYPT_XML_TRANSFORM_CHAIN_CONFIG, dwflags: CRYPT_XML_FLAGS, wszid: windows_sys::core::PCWSTR, rgproperty: *const CRYPT_XML_PROPERTY, cproperty: u32, pencoded: *const CRYPT_XML_BLOB, phsignature: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("cryptxml.dll" "system" fn CryptXmlOpenToEncode(pconfig : *const CRYPT_XML_TRANSFORM_CHAIN_CONFIG, dwflags : CRYPT_XML_FLAGS, wszid : windows_sys::core::PCWSTR, rgproperty : *const CRYPT_XML_PROPERTY, cproperty : u32, pencoded : *const CRYPT_XML_BLOB, phsignature : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type CryptXmlSetHMACSecret = unsafe extern "system" fn(hsignature: *const core::ffi::c_void, pbsecret: *const u8, cbsecret: u32) -> windows_sys::core::HRESULT;
windows_link::link!("cryptxml.dll" "system" fn CryptXmlSetHMACSecret(hsignature : *const core::ffi::c_void, pbsecret : *const u8, cbsecret : u32) -> windows_sys::core::HRESULT);
pub type CryptXmlSign = unsafe extern "system" fn(hsignature: *const core::ffi::c_void, hkey: HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, dwkeyspec: CERT_KEY_SPEC, dwflags: CRYPT_XML_FLAGS, dwkeyinfospec: CRYPT_XML_KEYINFO_SPEC, pvkeyinfospec: *const core::ffi::c_void, psignaturemethod: *const CRYPT_XML_ALGORITHM, pcanonicalization: *const CRYPT_XML_ALGORITHM) -> windows_sys::core::HRESULT;
windows_link::link!("cryptxml.dll" "system" fn CryptXmlSign(hsignature : *const core::ffi::c_void, hkey : HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, dwkeyspec : CERT_KEY_SPEC, dwflags : CRYPT_XML_FLAGS, dwkeyinfospec : CRYPT_XML_KEYINFO_SPEC, pvkeyinfospec : *const core::ffi::c_void, psignaturemethod : *const CRYPT_XML_ALGORITHM, pcanonicalization : *const CRYPT_XML_ALGORITHM) -> windows_sys::core::HRESULT);
pub type CryptXmlVerifySignature = unsafe extern "system" fn(hsignature: *const core::ffi::c_void, hkey: BCRYPT_KEY_HANDLE, dwflags: CRYPT_XML_FLAGS) -> windows_sys::core::HRESULT;
windows_link::link!("cryptxml.dll" "system" fn CryptXmlVerifySignature(hsignature : *const core::ffi::c_void, hkey : BCRYPT_KEY_HANDLE, dwflags : CRYPT_XML_FLAGS) -> windows_sys::core::HRESULT);
pub type Decrypt = unsafe extern "system" fn(hcrypto: *const INFORMATIONCARD_CRYPTO_HANDLE, foaep: windows_sys::core::BOOL, cbindata: u32, pindata: *const u8, pcboutdata: *mut u32, ppoutdata: *mut *mut u8) -> windows_sys::core::HRESULT;
windows_link::link!("infocardapi.dll" "system" fn Decrypt(hcrypto : *const INFORMATIONCARD_CRYPTO_HANDLE, foaep : windows_sys::core::BOOL, cbindata : u32, pindata : *const u8, pcboutdata : *mut u32, ppoutdata : *mut *mut u8) -> windows_sys::core::HRESULT);
pub type Encrypt = unsafe extern "system" fn(hcrypto: *const INFORMATIONCARD_CRYPTO_HANDLE, foaep: windows_sys::core::BOOL, cbindata: u32, pindata: *const u8, pcboutdata: *mut u32, ppoutdata: *mut *mut u8) -> windows_sys::core::HRESULT;
windows_link::link!("infocardapi.dll" "system" fn Encrypt(hcrypto : *const INFORMATIONCARD_CRYPTO_HANDLE, foaep : windows_sys::core::BOOL, cbindata : u32, pindata : *const u8, pcboutdata : *mut u32, ppoutdata : *mut *mut u8) -> windows_sys::core::HRESULT);
pub type FindCertsByIssuer = unsafe extern "system" fn(pcertchains: *mut CERT_CHAIN, pcbcertchains: *mut u32, pccertchains: *mut u32, pbencodedissuername: *const u8, cbencodedissuername: u32, pwszpurpose: windows_sys::core::PCWSTR, dwkeyspec: u32) -> windows_sys::core::HRESULT;
...
pub type FreeToken = unsafe extern "system" fn(pallocmemory: *const GENERIC_XML_TOKEN) -> windows_sys::core::BOOL;
windows_link::link!("infocardapi.dll" "system" fn FreeToken(pallocmemory : *const GENERIC_XML_TOKEN) -> windows_sys::core::BOOL);
pub type GenerateDerivedKey = unsafe extern "system" fn(hcrypto: *const INFORMATIONCARD_CRYPTO_HANDLE, cblabel: u32, plabel: *const u8, cbnonce: u32, pnonce: *const u8, derivedkeylength: u32, offset: u32, algid: windows_sys::core::PCWSTR, pcbkey: *mut u32, ppkey: *mut *mut u8) -> windows_sys::core::HRESULT;
windows_link::link!("infocardapi.dll" "system" fn GenerateDerivedKey(hcrypto : *const INFORMATIONCARD_CRYPTO_HANDLE, cblabel : u32, plabel : *const u8, cbnonce : u32, pnonce : *const u8, derivedkeylength : u32, offset : u32, algid : windows_sys::core::PCWSTR, pcbkey : *mut u32, ppkey : *mut *mut u8) -> windows_sys::core::HRESULT);
pub type GetAsymmetricEncryptionInterface = unsafe extern "system" fn(pszprovidername: windows_sys::core::PCWSTR, pszalgid: windows_sys::core::PCWSTR, ppfunctiontable: *mut *mut BCRYPT_ASYMMETRIC_ENCRYPTION_FUNCTION_TABLE, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcryptprimitives.dll" "system" fn GetAsymmetricEncryptionInterface(pszprovidername : windows_sys::core::PCWSTR, pszalgid : windows_sys::core::PCWSTR, ppfunctiontable : *mut *mut BCRYPT_ASYMMETRIC_ENCRYPTION_FUNCTION_TABLE, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type GetBrowserToken = unsafe extern "system" fn(dwparamtype: u32, pparam: *const core::ffi::c_void, pcbtoken: *mut u32, pptoken: *mut *mut u8) -> windows_sys::core::HRESULT;
windows_link::link!("infocardapi.dll" "system" fn GetBrowserToken(dwparamtype : u32, pparam : *const core::ffi::c_void, pcbtoken : *mut u32, pptoken : *mut *mut u8) -> windows_sys::core::HRESULT);
pub type GetCipherInterface = unsafe extern "system" fn(pszprovidername: windows_sys::core::PCWSTR, pszalgid: windows_sys::core::PCWSTR, ppfunctiontable: *mut *mut BCRYPT_CIPHER_FUNCTION_TABLE, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcryptprimitives.dll" "system" fn GetCipherInterface(pszprovidername : windows_sys::core::PCWSTR, pszalgid : windows_sys::core::PCWSTR, ppfunctiontable : *mut *mut BCRYPT_CIPHER_FUNCTION_TABLE, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type GetCryptoTransform = unsafe extern "system" fn(hsymmetriccrypto: *const INFORMATIONCARD_CRYPTO_HANDLE, mode: u32, padding: PaddingMode, feedbacksize: u32, direction: Direction, cbiv: u32, piv: *const u8, pphtransform: *mut *mut INFORMATIONCARD_CRYPTO_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("infocardapi.dll" "system" fn GetCryptoTransform(hsymmetriccrypto : *const INFORMATIONCARD_CRYPTO_HANDLE, mode : u32, padding : PaddingMode, feedbacksize : u32, direction : Direction, cbiv : u32, piv : *const u8, pphtransform : *mut *mut INFORMATIONCARD_CRYPTO_HANDLE) -> windows_sys::core::HRESULT);
pub type GetHashInterface = unsafe extern "system" fn(pszprovidername: windows_sys::core::PCWSTR, pszalgid: windows_sys::core::PCWSTR, ppfunctiontable: *mut *mut BCRYPT_HASH_FUNCTION_TABLE, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcryptprimitives.dll" "system" fn GetHashInterface(pszprovidername : windows_sys::core::PCWSTR, pszalgid : windows_sys::core::PCWSTR, ppfunctiontable : *mut *mut BCRYPT_HASH_FUNCTION_TABLE, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type GetKeyDerivationInterface = unsafe extern "system" fn(pszprovidername: windows_sys::core::PCWSTR, pszalgid: windows_sys::core::PCWSTR, ppfunctiontable: *mut *mut BCRYPT_KEY_DERIVATION_FUNCTION_TABLE, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcryptprimitives.dll" "system" fn GetKeyDerivationInterface(pszprovidername : windows_sys::core::PCWSTR, pszalgid : windows_sys::core::PCWSTR, ppfunctiontable : *mut *mut BCRYPT_KEY_DERIVATION_FUNCTION_TABLE, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type GetKeyStorageInterface = unsafe extern "system" fn(pszprovidername: windows_sys::core::PCWSTR, ppfunctiontable: *mut *mut NCRYPT_KEY_STORAGE_FUNCTION_TABLE, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("ncrypt.dll" "system" fn GetKeyStorageInterface(pszprovidername : windows_sys::core::PCWSTR, ppfunctiontable : *mut *mut NCRYPT_KEY_STORAGE_FUNCTION_TABLE, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type GetKeyedHash = unsafe extern "system" fn(hsymmetriccrypto: *const INFORMATIONCARD_CRYPTO_HANDLE, pphhash: *mut *mut INFORMATIONCARD_CRYPTO_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("infocardapi.dll" "system" fn GetKeyedHash(hsymmetriccrypto : *const INFORMATIONCARD_CRYPTO_HANDLE, pphhash : *mut *mut INFORMATIONCARD_CRYPTO_HANDLE) -> windows_sys::core::HRESULT);
pub type GetRngInterface = unsafe extern "system" fn(pszprovidername: windows_sys::core::PCWSTR, ppfunctiontable: *mut *mut BCRYPT_RNG_FUNCTION_TABLE, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcryptprimitives.dll" "system" fn GetRngInterface(pszprovidername : windows_sys::core::PCWSTR, ppfunctiontable : *mut *mut BCRYPT_RNG_FUNCTION_TABLE, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type GetSChannelInterface = unsafe extern "system" fn(pszprovidername: windows_sys::core::PCWSTR, ppfunctiontable: *mut *mut NCRYPT_SSL_FUNCTION_TABLE, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("ncrypt.dll" "system" fn GetSChannelInterface(pszprovidername : windows_sys::core::PCWSTR, ppfunctiontable : *mut *mut NCRYPT_SSL_FUNCTION_TABLE, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type GetSecretAgreementInterface = unsafe extern "system" fn(pszprovidername: windows_sys::core::PCWSTR, pszalgid: windows_sys::core::PCWSTR, ppfunctiontable: *mut *mut BCRYPT_SECRET_AGREEMENT_FUNCTION_TABLE, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcryptprimitives.dll" "system" fn GetSecretAgreementInterface(pszprovidername : windows_sys::core::PCWSTR, pszalgid : windows_sys::core::PCWSTR, ppfunctiontable : *mut *mut BCRYPT_SECRET_AGREEMENT_FUNCTION_TABLE, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type GetSignatureInterface = unsafe extern "system" fn(pszprovidername: windows_sys::core::PCWSTR, pszalgid: windows_sys::core::PCWSTR, ppfunctiontable: *mut *mut BCRYPT_SIGNATURE_FUNCTION_TABLE, dwflags: u32) -> super::super::Foundation::NTSTATUS;
windows_link::link!("bcryptprimitives.dll" "system" fn GetSignatureInterface(pszprovidername : windows_sys::core::PCWSTR, pszalgid : windows_sys::core::PCWSTR, ppfunctiontable : *mut *mut BCRYPT_SIGNATURE_FUNCTION_TABLE, dwflags : u32) -> super::super::Foundation::NTSTATUS);
pub type GetToken = unsafe extern "system" fn(cpolicychain: u32, ppolicychain: *const POLICY_ELEMENT, securitytoken: *mut *mut GENERIC_XML_TOKEN, phprooftokencrypto: *mut *mut INFORMATIONCARD_CRYPTO_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("infocardapi.dll" "system" fn GetToken(cpolicychain : u32, ppolicychain : *const POLICY_ELEMENT, securitytoken : *mut *mut GENERIC_XML_TOKEN, phprooftokencrypto : *mut *mut INFORMATIONCARD_CRYPTO_HANDLE) -> windows_sys::core::HRESULT);
pub type HashCore = unsafe extern "system" fn(hcrypto: *const INFORMATIONCARD_CRYPTO_HANDLE, cbindata: u32, pindata: *const u8) -> windows_sys::core::HRESULT;
windows_link::link!("infocardapi.dll" "system" fn HashCore(hcrypto : *const INFORMATIONCARD_CRYPTO_HANDLE, cbindata : u32, pindata : *const u8) -> windows_sys::core::HRESULT);
pub type HashFinal = unsafe extern "system" fn(hcrypto: *const INFORMATIONCARD_CRYPTO_HANDLE, cbindata: u32, pindata: *const u8, pcboutdata: *mut u32, ppoutdata: *mut *mut u8) -> windows_sys::core::HRESULT;
windows_link::link!("infocardapi.dll" "system" fn HashFinal(hcrypto : *const INFORMATIONCARD_CRYPTO_HANDLE, cbindata : u32, pindata : *const u8, pcboutdata : *mut u32, ppoutdata : *mut *mut u8) -> windows_sys::core::HRESULT);
pub type ImportInformationCard = unsafe extern "system" fn(filename: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
windows_link::link!("infocardapi.dll" "system" fn ImportInformationCard(filename : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
pub type ManageCardSpace = unsafe extern "system" fn() -> windows_sys::core::HRESULT;
windows_link::link!("infocardapi.dll" "system" fn ManageCardSpace() -> windows_sys::core::HRESULT);
pub type NCryptCloseProtectionDescriptor = unsafe extern "system" fn(hdescriptor: super::NCRYPT_DESCRIPTOR_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptCloseProtectionDescriptor(hdescriptor : super::NCRYPT_DESCRIPTOR_HANDLE) -> windows_sys::core::HRESULT);
pub type NCryptCreateClaim = unsafe extern "system" fn(hsubjectkey: NCRYPT_KEY_HANDLE, hauthoritykey: NCRYPT_KEY_HANDLE, dwclaimtype: u32, pparameterlist: *const BCryptBufferDesc, pbclaimblob: *mut u8, cbclaimblob: u32, pcbresult: *mut u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptCreateClaim(hsubjectkey : NCRYPT_KEY_HANDLE, hauthoritykey : NCRYPT_KEY_HANDLE, dwclaimtype : u32, pparameterlist : *const BCryptBufferDesc, pbclaimblob : *mut u8, cbclaimblob : u32, pcbresult : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type NCryptCreatePersistedKey = unsafe extern "system" fn(hprovider: NCRYPT_PROV_HANDLE, phkey: *mut NCRYPT_KEY_HANDLE, pszalgid: windows_sys::core::PCWSTR, pszkeyname: windows_sys::core::PCWSTR, dwlegacykeyspec: CERT_KEY_SPEC, dwflags: NCRYPT_FLAGS) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptCreatePersistedKey(hprovider : NCRYPT_PROV_HANDLE, phkey : *mut NCRYPT_KEY_HANDLE, pszalgid : windows_sys::core::PCWSTR, pszkeyname : windows_sys::core::PCWSTR, dwlegacykeyspec : CERT_KEY_SPEC, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
pub type NCryptCreateProtectionDescriptor = unsafe extern "system" fn(pwszdescriptorstring: windows_sys::core::PCWSTR, dwflags: u32, phdescriptor: *mut super::NCRYPT_DESCRIPTOR_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptCreateProtectionDescriptor(pwszdescriptorstring : windows_sys::core::PCWSTR, dwflags : u32, phdescriptor : *mut super::NCRYPT_DESCRIPTOR_HANDLE) -> windows_sys::core::HRESULT);
pub type NCryptDecapsulate = unsafe extern "system" fn(hkey: NCRYPT_KEY_HANDLE, pbciphertext: *const u8, cbciphertext: u32, pbsecretkey: *mut u8, cbsecretkey: u32, pcbsecretkey: *mut u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptDecapsulate(hkey : NCRYPT_KEY_HANDLE, pbciphertext : *const u8, cbciphertext : u32, pbsecretkey : *mut u8, cbsecretkey : u32, pcbsecretkey : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type NCryptDecrypt = unsafe extern "system" fn(hkey: NCRYPT_KEY_HANDLE, pbinput: *const u8, cbinput: u32, ppaddinginfo: *const core::ffi::c_void, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: NCRYPT_FLAGS) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptDecrypt(hkey : NCRYPT_KEY_HANDLE, pbinput : *const u8, cbinput : u32, ppaddinginfo : *const core::ffi::c_void, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
pub type NCryptDeleteKey = unsafe extern "system" fn(hkey: NCRYPT_KEY_HANDLE, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptDeleteKey(hkey : NCRYPT_KEY_HANDLE, dwflags : u32) -> windows_sys::core::HRESULT);
pub type NCryptDeriveKey = unsafe extern "system" fn(hsharedsecret: NCRYPT_SECRET_HANDLE, pwszkdf: windows_sys::core::PCWSTR, pparameterlist: *const BCryptBufferDesc, pbderivedkey: *mut u8, cbderivedkey: u32, pcbresult: *mut u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptDeriveKey(hsharedsecret : NCRYPT_SECRET_HANDLE, pwszkdf : windows_sys::core::PCWSTR, pparameterlist : *const BCryptBufferDesc, pbderivedkey : *mut u8, cbderivedkey : u32, pcbresult : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type NCryptEncapsulate = unsafe extern "system" fn(hkey: NCRYPT_KEY_HANDLE, pbsecretkey: *mut u8, cbsecretkey: u32, pcbsecretkey: *mut u32, pbciphertext: *mut u8, cbciphertext: u32, pcbciphertext: *mut u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptEncapsulate(hkey : NCRYPT_KEY_HANDLE, pbsecretkey : *mut u8, cbsecretkey : u32, pcbsecretkey : *mut u32, pbciphertext : *mut u8, cbciphertext : u32, pcbciphertext : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type NCryptEncrypt = unsafe extern "system" fn(hkey: NCRYPT_KEY_HANDLE, pbinput: *const u8, cbinput: u32, ppaddinginfo: *const core::ffi::c_void, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: NCRYPT_FLAGS) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptEncrypt(hkey : NCRYPT_KEY_HANDLE, pbinput : *const u8, cbinput : u32, ppaddinginfo : *const core::ffi::c_void, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
pub type NCryptEnumAlgorithms = unsafe extern "system" fn(hprovider: NCRYPT_PROV_HANDLE, dwalgoperations: NCRYPT_OPERATION, pdwalgcount: *mut u32, ppalglist: *mut *mut NCryptAlgorithmName, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptEnumAlgorithms(hprovider : NCRYPT_PROV_HANDLE, dwalgoperations : NCRYPT_OPERATION, pdwalgcount : *mut u32, ppalglist : *mut *mut NCryptAlgorithmName, dwflags : u32) -> windows_sys::core::HRESULT);
pub type NCryptEnumKeys = unsafe extern "system" fn(hprovider: NCRYPT_PROV_HANDLE, pszscope: windows_sys::core::PCWSTR, ppkeyname: *mut *mut NCryptKeyName, ppenumstate: *mut *mut core::ffi::c_void, dwflags: NCRYPT_FLAGS) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptEnumKeys(hprovider : NCRYPT_PROV_HANDLE, pszscope : windows_sys::core::PCWSTR, ppkeyname : *mut *mut NCryptKeyName, ppenumstate : *mut *mut core::ffi::c_void, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
pub type NCryptEnumStorageProviders = unsafe extern "system" fn(pdwprovidercount: *mut u32, ppproviderlist: *mut *mut NCryptProviderName, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptEnumStorageProviders(pdwprovidercount : *mut u32, ppproviderlist : *mut *mut NCryptProviderName, dwflags : u32) -> windows_sys::core::HRESULT);
pub type NCryptExportKey = unsafe extern "system" fn(hkey: NCRYPT_KEY_HANDLE, hexportkey: NCRYPT_KEY_HANDLE, pszblobtype: windows_sys::core::PCWSTR, pparameterlist: *const BCryptBufferDesc, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: NCRYPT_FLAGS) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptExportKey(hkey : NCRYPT_KEY_HANDLE, hexportkey : NCRYPT_KEY_HANDLE, pszblobtype : windows_sys::core::PCWSTR, pparameterlist : *const BCryptBufferDesc, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
pub type NCryptFinalizeKey = unsafe extern "system" fn(hkey: NCRYPT_KEY_HANDLE, dwflags: NCRYPT_FLAGS) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptFinalizeKey(hkey : NCRYPT_KEY_HANDLE, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
pub type NCryptFreeBuffer = unsafe extern "system" fn(pvinput: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptFreeBuffer(pvinput : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type NCryptFreeObject = unsafe extern "system" fn(hobject: NCRYPT_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptFreeObject(hobject : NCRYPT_HANDLE) -> windows_sys::core::HRESULT);
pub type NCryptGetProperty = unsafe extern "system" fn(hobject: NCRYPT_HANDLE, pszproperty: windows_sys::core::PCWSTR, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: super::OBJECT_SECURITY_INFORMATION) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptGetProperty(hobject : NCRYPT_HANDLE, pszproperty : windows_sys::core::PCWSTR, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : super::OBJECT_SECURITY_INFORMATION) -> windows_sys::core::HRESULT);
pub type NCryptGetProtectionDescriptorInfo = unsafe extern "system" fn(hdescriptor: super::NCRYPT_DESCRIPTOR_HANDLE, pmempara: *const NCRYPT_ALLOC_PARA, dwinfotype: u32, ppvinfo: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptGetProtectionDescriptorInfo(hdescriptor : super::NCRYPT_DESCRIPTOR_HANDLE, pmempara : *const NCRYPT_ALLOC_PARA, dwinfotype : u32, ppvinfo : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type NCryptImportKey = unsafe extern "system" fn(hprovider: NCRYPT_PROV_HANDLE, himportkey: NCRYPT_KEY_HANDLE, pszblobtype: windows_sys::core::PCWSTR, pparameterlist: *const BCryptBufferDesc, phkey: *mut NCRYPT_KEY_HANDLE, pbdata: *const u8, cbdata: u32, dwflags: NCRYPT_FLAGS) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptImportKey(hprovider : NCRYPT_PROV_HANDLE, himportkey : NCRYPT_KEY_HANDLE, pszblobtype : windows_sys::core::PCWSTR, pparameterlist : *const BCryptBufferDesc, phkey : *mut NCRYPT_KEY_HANDLE, pbdata : *const u8, cbdata : u32, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
pub type NCryptIsAlgSupported = unsafe extern "system" fn(hprovider: NCRYPT_PROV_HANDLE, pszalgid: windows_sys::core::PCWSTR, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptIsAlgSupported(hprovider : NCRYPT_PROV_HANDLE, pszalgid : windows_sys::core::PCWSTR, dwflags : u32) -> windows_sys::core::HRESULT);
pub type NCryptIsKeyHandle = unsafe extern "system" fn(hkey: NCRYPT_KEY_HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("ncrypt.dll" "system" fn NCryptIsKeyHandle(hkey : NCRYPT_KEY_HANDLE) -> windows_sys::core::BOOL);
pub type NCryptKeyDerivation = unsafe extern "system" fn(hkey: NCRYPT_KEY_HANDLE, pparameterlist: *const BCryptBufferDesc, pbderivedkey: *mut u8, cbderivedkey: u32, pcbresult: *mut u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptKeyDerivation(hkey : NCRYPT_KEY_HANDLE, pparameterlist : *const BCryptBufferDesc, pbderivedkey : *mut u8, cbderivedkey : u32, pcbresult : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type NCryptNotifyChangeKey = unsafe extern "system" fn(hprovider: NCRYPT_PROV_HANDLE, phevent: *mut super::super::Foundation::HANDLE, dwflags: NCRYPT_FLAGS) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptNotifyChangeKey(hprovider : NCRYPT_PROV_HANDLE, phevent : *mut super::super::Foundation::HANDLE, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
pub type NCryptOpenKey = unsafe extern "system" fn(hprovider: NCRYPT_PROV_HANDLE, phkey: *mut NCRYPT_KEY_HANDLE, pszkeyname: windows_sys::core::PCWSTR, dwlegacykeyspec: CERT_KEY_SPEC, dwflags: NCRYPT_FLAGS) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptOpenKey(hprovider : NCRYPT_PROV_HANDLE, phkey : *mut NCRYPT_KEY_HANDLE, pszkeyname : windows_sys::core::PCWSTR, dwlegacykeyspec : CERT_KEY_SPEC, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
pub type NCryptOpenStorageProvider = unsafe extern "system" fn(phprovider: *mut NCRYPT_PROV_HANDLE, pszprovidername: windows_sys::core::PCWSTR, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptOpenStorageProvider(phprovider : *mut NCRYPT_PROV_HANDLE, pszprovidername : windows_sys::core::PCWSTR, dwflags : u32) -> windows_sys::core::HRESULT);
pub type NCryptProtectSecret = unsafe extern "system" fn(hdescriptor: super::NCRYPT_DESCRIPTOR_HANDLE, dwflags: u32, pbdata: *const u8, cbdata: u32, pmempara: *const NCRYPT_ALLOC_PARA, hwnd: super::super::Foundation::HWND, ppbprotectedblob: *mut *mut u8, pcbprotectedblob: *mut u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptProtectSecret(hdescriptor : super::NCRYPT_DESCRIPTOR_HANDLE, dwflags : u32, pbdata : *const u8, cbdata : u32, pmempara : *const NCRYPT_ALLOC_PARA, hwnd : super::super::Foundation::HWND, ppbprotectedblob : *mut *mut u8, pcbprotectedblob : *mut u32) -> windows_sys::core::HRESULT);
pub type NCryptQueryProtectionDescriptorName = unsafe extern "system" fn(pwszname: windows_sys::core::PCWSTR, pwszdescriptorstring: windows_sys::core::PWSTR, pcdescriptorstring: *mut usize, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptQueryProtectionDescriptorName(pwszname : windows_sys::core::PCWSTR, pwszdescriptorstring : windows_sys::core::PWSTR, pcdescriptorstring : *mut usize, dwflags : u32) -> windows_sys::core::HRESULT);
pub type NCryptRegisterProtectionDescriptorName = unsafe extern "system" fn(pwszname: windows_sys::core::PCWSTR, pwszdescriptorstring: windows_sys::core::PCWSTR, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptRegisterProtectionDescriptorName(pwszname : windows_sys::core::PCWSTR, pwszdescriptorstring : windows_sys::core::PCWSTR, dwflags : u32) -> windows_sys::core::HRESULT);
pub type NCryptSecretAgreement = unsafe extern "system" fn(hprivkey: NCRYPT_KEY_HANDLE, hpubkey: NCRYPT_KEY_HANDLE, phagreedsecret: *mut NCRYPT_SECRET_HANDLE, dwflags: NCRYPT_FLAGS) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptSecretAgreement(hprivkey : NCRYPT_KEY_HANDLE, hpubkey : NCRYPT_KEY_HANDLE, phagreedsecret : *mut NCRYPT_SECRET_HANDLE, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
pub type NCryptSetProperty = unsafe extern "system" fn(hobject: NCRYPT_HANDLE, pszproperty: windows_sys::core::PCWSTR, pbinput: *const u8, cbinput: u32, dwflags: NCRYPT_FLAGS) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptSetProperty(hobject : NCRYPT_HANDLE, pszproperty : windows_sys::core::PCWSTR, pbinput : *const u8, cbinput : u32, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
pub type NCryptSignHash = unsafe extern "system" fn(hkey: NCRYPT_KEY_HANDLE, ppaddinginfo: *const core::ffi::c_void, pbhashvalue: *const u8, cbhashvalue: u32, pbsignature: *mut u8, cbsignature: u32, pcbresult: *mut u32, dwflags: NCRYPT_FLAGS) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptSignHash(hkey : NCRYPT_KEY_HANDLE, ppaddinginfo : *const core::ffi::c_void, pbhashvalue : *const u8, cbhashvalue : u32, pbsignature : *mut u8, cbsignature : u32, pcbresult : *mut u32, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
pub type NCryptStreamClose = unsafe extern "system" fn(hstream: super::NCRYPT_STREAM_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptStreamClose(hstream : super::NCRYPT_STREAM_HANDLE) -> windows_sys::core::HRESULT);
pub type NCryptStreamOpenToProtect = unsafe extern "system" fn(hdescriptor: super::NCRYPT_DESCRIPTOR_HANDLE, dwflags: u32, hwnd: super::super::Foundation::HWND, pstreaminfo: *const NCRYPT_PROTECT_STREAM_INFO, phstream: *mut super::NCRYPT_STREAM_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptStreamOpenToProtect(hdescriptor : super::NCRYPT_DESCRIPTOR_HANDLE, dwflags : u32, hwnd : super::super::Foundation::HWND, pstreaminfo : *const NCRYPT_PROTECT_STREAM_INFO, phstream : *mut super::NCRYPT_STREAM_HANDLE) -> windows_sys::core::HRESULT);
pub type NCryptStreamOpenToUnprotect = unsafe extern "system" fn(pstreaminfo: *const NCRYPT_PROTECT_STREAM_INFO, dwflags: u32, hwnd: super::super::Foundation::HWND, phstream: *mut super::NCRYPT_STREAM_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptStreamOpenToUnprotect(pstreaminfo : *const NCRYPT_PROTECT_STREAM_INFO, dwflags : u32, hwnd : super::super::Foundation::HWND, phstream : *mut super::NCRYPT_STREAM_HANDLE) -> windows_sys::core::HRESULT);
pub type NCryptStreamOpenToUnprotectEx = unsafe extern "system" fn(pstreaminfo: *const NCRYPT_PROTECT_STREAM_INFO_EX, dwflags: u32, hwnd: super::super::Foundation::HWND, phstream: *mut super::NCRYPT_STREAM_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptStreamOpenToUnprotectEx(pstreaminfo : *const NCRYPT_PROTECT_STREAM_INFO_EX, dwflags : u32, hwnd : super::super::Foundation::HWND, phstream : *mut super::NCRYPT_STREAM_HANDLE) -> windows_sys::core::HRESULT);
pub type NCryptStreamUpdate = unsafe extern "system" fn(hstream: super::NCRYPT_STREAM_HANDLE, pbdata: *const u8, cbdata: usize, ffinal: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptStreamUpdate(hstream : super::NCRYPT_STREAM_HANDLE, pbdata : *const u8, cbdata : usize, ffinal : windows_sys::core::BOOL) -> windows_sys::core::HRESULT);
pub type NCryptTranslateHandle = unsafe extern "system" fn(phprovider: *mut NCRYPT_PROV_HANDLE, phkey: *mut NCRYPT_KEY_HANDLE, hlegacyprov: usize, hlegacykey: usize, dwlegacykeyspec: CERT_KEY_SPEC, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptTranslateHandle(phprovider : *mut NCRYPT_PROV_HANDLE, phkey : *mut NCRYPT_KEY_HANDLE, hlegacyprov : usize, hlegacykey : usize, dwlegacykeyspec : CERT_KEY_SPEC, dwflags : u32) -> windows_sys::core::HRESULT);
pub type NCryptUnprotectSecret = unsafe extern "system" fn(phdescriptor: *mut super::NCRYPT_DESCRIPTOR_HANDLE, dwflags: NCRYPT_FLAGS, pbprotectedblob: *const u8, cbprotectedblob: u32, pmempara: *const NCRYPT_ALLOC_PARA, hwnd: super::super::Foundation::HWND, ppbdata: *mut *mut u8, pcbdata: *mut u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptUnprotectSecret(phdescriptor : *mut super::NCRYPT_DESCRIPTOR_HANDLE, dwflags : NCRYPT_FLAGS, pbprotectedblob : *const u8, cbprotectedblob : u32, pmempara : *const NCRYPT_ALLOC_PARA, hwnd : super::super::Foundation::HWND, ppbdata : *mut *mut u8, pcbdata : *mut u32) -> windows_sys::core::HRESULT);
pub type NCryptVerifyClaim = unsafe extern "system" fn(hsubjectkey: NCRYPT_KEY_HANDLE, hauthoritykey: NCRYPT_KEY_HANDLE, dwclaimtype: u32, pparameterlist: *const BCryptBufferDesc, pbclaimblob: *const u8, cbclaimblob: u32, poutput: *mut BCryptBufferDesc, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptVerifyClaim(hsubjectkey : NCRYPT_KEY_HANDLE, hauthoritykey : NCRYPT_KEY_HANDLE, dwclaimtype : u32, pparameterlist : *const BCryptBufferDesc, pbclaimblob : *const u8, cbclaimblob : u32, poutput : *mut BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
pub type NCryptVerifySignature = unsafe extern "system" fn(hkey: NCRYPT_KEY_HANDLE, ppaddinginfo: *const core::ffi::c_void, pbhashvalue: *const u8, cbhashvalue: u32, pbsignature: *const u8, cbsignature: u32, dwflags: NCRYPT_FLAGS) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn NCryptVerifySignature(hkey : NCRYPT_KEY_HANDLE, ppaddinginfo : *const core::ffi::c_void, pbhashvalue : *const u8, cbhashvalue : u32, pbsignature : *const u8, cbsignature : u32, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
pub type PFXExportCertStore = unsafe extern "system" fn(hstore: HCERTSTORE, ppfx: *mut CRYPT_INTEGER_BLOB, szpassword: windows_sys::core::PCWSTR, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn PFXExportCertStore(hstore : HCERTSTORE, ppfx : *mut CRYPT_INTEGER_BLOB, szpassword : windows_sys::core::PCWSTR, dwflags : u32) -> windows_sys::core::BOOL);
pub type PFXExportCertStoreEx = unsafe extern "system" fn(hstore: HCERTSTORE, ppfx: *mut CRYPT_INTEGER_BLOB, szpassword: windows_sys::core::PCWSTR, pvpara: *const core::ffi::c_void, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn PFXExportCertStoreEx(hstore : HCERTSTORE, ppfx : *mut CRYPT_INTEGER_BLOB, szpassword : windows_sys::core::PCWSTR, pvpara : *const core::ffi::c_void, dwflags : u32) -> windows_sys::core::BOOL);
pub type PFXImportCertStore = unsafe extern "system" fn(ppfx: *const CRYPT_INTEGER_BLOB, szpassword: windows_sys::core::PCWSTR, dwflags: CRYPT_KEY_FLAGS) -> HCERTSTORE;
windows_link::link!("crypt32.dll" "system" fn PFXImportCertStore(ppfx : *const CRYPT_INTEGER_BLOB, szpassword : windows_sys::core::PCWSTR, dwflags : CRYPT_KEY_FLAGS) -> HCERTSTORE);
pub type PFXIsPFXBlob = unsafe extern "system" fn(ppfx: *const CRYPT_INTEGER_BLOB) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn PFXIsPFXBlob(ppfx : *const CRYPT_INTEGER_BLOB) -> windows_sys::core::BOOL);
pub type PFXVerifyPassword = unsafe extern "system" fn(ppfx: *const CRYPT_INTEGER_BLOB, szpassword: windows_sys::core::PCWSTR, dwflags: u32) -> windows_sys::core::BOOL;
windows_link::link!("crypt32.dll" "system" fn PFXVerifyPassword(ppfx : *const CRYPT_INTEGER_BLOB, szpassword : windows_sys::core::PCWSTR, dwflags : u32) -> windows_sys::core::BOOL);
pub type ProcessPrng = unsafe extern "system" fn(pbdata: *mut u8, cbdata: usize) -> windows_sys::core::BOOL;
windows_link::link!("bcryptprimitives.dll" "system" fn ProcessPrng(pbdata : *mut u8, cbdata : usize) -> windows_sys::core::BOOL);
pub type SignError = unsafe extern "system" fn() -> windows_sys::core::HRESULT;
windows_link::link!("mssign32.dll" "system" fn SignError() -> windows_sys::core::HRESULT);
pub type SignHash = unsafe extern "system" fn(hcrypto: *const INFORMATIONCARD_CRYPTO_HANDLE, cbhash: u32, phash: *const u8, hashalgoid: windows_sys::core::PCWSTR, pcbsig: *mut u32, ppsig: *mut *mut u8) -> windows_sys::core::HRESULT;
windows_link::link!("infocardapi.dll" "system" fn SignHash(hcrypto : *const INFORMATIONCARD_CRYPTO_HANDLE, cbhash : u32, phash : *const u8, hashalgoid : windows_sys::core::PCWSTR, pcbsig : *mut u32, ppsig : *mut *mut u8) -> windows_sys::core::HRESULT);
pub type SignerFreeSignerContext = unsafe extern "system" fn(psignercontext: *const SIGNER_CONTEXT) -> windows_sys::core::HRESULT;
windows_link::link!("mssign32.dll" "system" fn SignerFreeSignerContext(psignercontext : *const SIGNER_CONTEXT) -> windows_sys::core::HRESULT);
pub type SignerSign = unsafe extern "system" fn(psubjectinfo: *const SIGNER_SUBJECT_INFO, psignercert: *const SIGNER_CERT, psignatureinfo: *const SIGNER_SIGNATURE_INFO, pproviderinfo: *const SIGNER_PROVIDER_INFO, pwszhttptimestamp: windows_sys::core::PCWSTR, psrequest: *const CRYPT_ATTRIBUTES, psipdata: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("mssign32.dll" "system" fn SignerSign(psubjectinfo : *const SIGNER_SUBJECT_INFO, psignercert : *const SIGNER_CERT, psignatureinfo : *const SIGNER_SIGNATURE_INFO, pproviderinfo : *const SIGNER_PROVIDER_INFO, pwszhttptimestamp : windows_sys::core::PCWSTR, psrequest : *const CRYPT_ATTRIBUTES, psipdata : *const core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type SignerSignEx = unsafe extern "system" fn(dwflags: SIGNER_SIGN_FLAGS, psubjectinfo: *const SIGNER_SUBJECT_INFO, psignercert: *const SIGNER_CERT, psignatureinfo: *const SIGNER_SIGNATURE_INFO, pproviderinfo: *const SIGNER_PROVIDER_INFO, pwszhttptimestamp: windows_sys::core::PCWSTR, psrequest: *const CRYPT_ATTRIBUTES, psipdata: *const core::ffi::c_void, ppsignercontext: *mut *mut SIGNER_CONTEXT) -> windows_sys::core::HRESULT;
...
pub type SignerSignEx2 = unsafe extern "system" fn(dwflags: SIGNER_SIGN_FLAGS, psubjectinfo: *const SIGNER_SUBJECT_INFO, psignercert: *const SIGNER_CERT, psignatureinfo: *const SIGNER_SIGNATURE_INFO, pproviderinfo: *const SIGNER_PROVIDER_INFO, dwtimestampflags: SIGNER_TIMESTAMP_FLAGS, psztimestampalgorithmoid: windows_sys::core::PCSTR, pwszhttptimestamp: windows_sys::core::PCWSTR, psrequest: *const CRYPT_ATTRIBUTES, psipdata: *const core::ffi::c_void, ppsignercontext: *mut *mut SIGNER_CONTEXT, pcryptopolicy: *const CERT_STRONG_SIGN_PARA, preserved: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("mssign32.dll" "system" fn SignerSignEx2(dwflags : SIGNER_SIGN_FLAGS, psubjectinfo : *const SIGNER_SUBJECT_INFO, psignercert : *const SIGNER_CERT, psignatureinfo : *const SIGNER_SIGNATURE_INFO, pproviderinfo : *const SIGNER_PROVIDER_INFO, dwtimestampflags : SIGNER_TIMESTAMP_FLAGS, psztimestampalgorithmoid : windows_sys::core::PCSTR, pwszhttptimestamp : windows_sys::core::PCWSTR, psrequest : *const CRYPT_ATTRIBUTES, psipdata : *const core::ffi::c_void, ppsignercontext : *mut *mut SIGNER_CONTEXT, pcryptopolicy : *const CERT_STRONG_SIGN_PARA, preserved : *const core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type SignerSignEx3 = unsafe extern "system" fn(dwflags: SIGNER_SIGN_FLAGS, psubjectinfo: *const SIGNER_SUBJECT_INFO, psignercert: *const SIGNER_CERT, psignatureinfo: *const SIGNER_SIGNATURE_INFO, pproviderinfo: *const SIGNER_PROVIDER_INFO, dwtimestampflags: SIGNER_TIMESTAMP_FLAGS, psztimestampalgorithmoid: windows_sys::core::PCSTR, pwszhttptimestamp: windows_sys::core::PCWSTR, psrequest: *const CRYPT_ATTRIBUTES, psipdata: *const core::ffi::c_void, ppsignercontext: *mut *mut SIGNER_CONTEXT, pcryptopolicy: *const CERT_STRONG_SIGN_PARA, pdigestsigninfo: *const SIGNER_DIGEST_SIGN_INFO, preserved: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("mssign32.dll" "system" fn SignerSignEx3(dwflags : SIGNER_SIGN_FLAGS, psubjectinfo : *const SIGNER_SUBJECT_INFO, psignercert : *const SIGNER_CERT, psignatureinfo : *const SIGNER_SIGNATURE_INFO, pproviderinfo : *const SIGNER_PROVIDER_INFO, dwtimestampflags : SIGNER_TIMESTAMP_FLAGS, psztimestampalgorithmoid : windows_sys::core::PCSTR, pwszhttptimestamp : windows_sys::core::PCWSTR, psrequest : *const CRYPT_ATTRIBUTES, psipdata : *const core::ffi::c_void, ppsignercontext : *mut *mut SIGNER_CONTEXT, pcryptopolicy : *const CERT_STRONG_SIGN_PARA, pdigestsigninfo : *const SIGNER_DIGEST_SIGN_INFO, preserved : *const core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type SignerTimeStamp = unsafe extern "system" fn(psubjectinfo: *const SIGNER_SUBJECT_INFO, pwszhttptimestamp: windows_sys::core::PCWSTR, psrequest: *const CRYPT_ATTRIBUTES, psipdata: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("mssign32.dll" "system" fn SignerTimeStamp(psubjectinfo : *const SIGNER_SUBJECT_INFO, pwszhttptimestamp : windows_sys::core::PCWSTR, psrequest : *const CRYPT_ATTRIBUTES, psipdata : *const core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type SignerTimeStampEx = unsafe extern "system" fn(dwflags: u32, psubjectinfo: *const SIGNER_SUBJECT_INFO, pwszhttptimestamp: windows_sys::core::PCWSTR, psrequest: *const CRYPT_ATTRIBUTES, psipdata: *const core::ffi::c_void, ppsignercontext: *mut *mut SIGNER_CONTEXT) -> windows_sys::core::HRESULT;
windows_link::link!("mssign32.dll" "system" fn SignerTimeStampEx(dwflags : u32, psubjectinfo : *const SIGNER_SUBJECT_INFO, pwszhttptimestamp : windows_sys::core::PCWSTR, psrequest : *const CRYPT_ATTRIBUTES, psipdata : *const core::ffi::c_void, ppsignercontext : *mut *mut SIGNER_CONTEXT) -> windows_sys::core::HRESULT);
pub type SignerTimeStampEx2 = unsafe extern "system" fn(dwflags: SIGNER_TIMESTAMP_FLAGS, psubjectinfo: *const SIGNER_SUBJECT_INFO, pwszhttptimestamp: windows_sys::core::PCWSTR, dwalgid: ALG_ID, psrequest: *const CRYPT_ATTRIBUTES, psipdata: *const core::ffi::c_void, ppsignercontext: *mut *mut SIGNER_CONTEXT) -> windows_sys::core::HRESULT;
...
pub type SignerTimeStampEx3 = unsafe extern "system" fn(dwflags: SIGNER_TIMESTAMP_FLAGS, dwindex: u32, psubjectinfo: *const SIGNER_SUBJECT_INFO, pwszhttptimestamp: windows_sys::core::PCWSTR, pszalgorithmoid: windows_sys::core::PCWSTR, psrequest: *const CRYPT_ATTRIBUTES, psipdata: *const core::ffi::c_void, ppsignercontext: *mut *mut SIGNER_CONTEXT, pcryptopolicy: *const CERT_STRONG_SIGN_PARA, preserved: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("mssign32.dll" "system" fn SignerTimeStampEx3(dwflags : SIGNER_TIMESTAMP_FLAGS, dwindex : u32, psubjectinfo : *const SIGNER_SUBJECT_INFO, pwszhttptimestamp : windows_sys::core::PCWSTR, pszalgorithmoid : windows_sys::core::PCWSTR, psrequest : *const CRYPT_ATTRIBUTES, psipdata : *const core::ffi::c_void, ppsignercontext : *mut *mut SIGNER_CONTEXT, pcryptopolicy : *const CERT_STRONG_SIGN_PARA, preserved : *const core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type SslChangeNotify = unsafe extern "system" fn(hevent: super::super::Foundation::HANDLE, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslChangeNotify(hevent : super::super::Foundation::HANDLE, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslComputeClientAuthHash = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hmasterkey: NCRYPT_KEY_HANDLE, hhandshakehash: NCRYPT_HASH_HANDLE, pszalgid: windows_sys::core::PCWSTR, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslComputeClientAuthHash(hsslprovider : NCRYPT_PROV_HANDLE, hmasterkey : NCRYPT_KEY_HANDLE, hhandshakehash : NCRYPT_HASH_HANDLE, pszalgid : windows_sys::core::PCWSTR, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslComputeEapKeyBlock = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hmasterkey: NCRYPT_KEY_HANDLE, pbrandoms: *const u8, cbrandoms: u32, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslComputeEapKeyBlock(hsslprovider : NCRYPT_PROV_HANDLE, hmasterkey : NCRYPT_KEY_HANDLE, pbrandoms : *const u8, cbrandoms : u32, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslComputeFinishedHash = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hmasterkey: NCRYPT_KEY_HANDLE, hhandshakehash: NCRYPT_HASH_HANDLE, pboutput: *mut u8, cboutput: u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslComputeFinishedHash(hsslprovider : NCRYPT_PROV_HANDLE, hmasterkey : NCRYPT_KEY_HANDLE, hhandshakehash : NCRYPT_HASH_HANDLE, pboutput : *mut u8, cboutput : u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslComputeSessionHash = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hhandshakehash: NCRYPT_HASH_HANDLE, dwprotocol: u32, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslComputeSessionHash(hsslprovider : NCRYPT_PROV_HANDLE, hhandshakehash : NCRYPT_HASH_HANDLE, dwprotocol : u32, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslCreateClientAuthHash = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, phhandshakehash: *mut NCRYPT_HASH_HANDLE, dwprotocol: u32, dwciphersuite: u32, pszhashalgid: windows_sys::core::PCWSTR, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslCreateClientAuthHash(hsslprovider : NCRYPT_PROV_HANDLE, phhandshakehash : *mut NCRYPT_HASH_HANDLE, dwprotocol : u32, dwciphersuite : u32, pszhashalgid : windows_sys::core::PCWSTR, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslCreateEphemeralKey = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, phephemeralkey: *mut NCRYPT_KEY_HANDLE, dwprotocol: u32, dwciphersuite: u32, dwkeytype: u32, dwkeybitlen: u32, pbparams: *const u8, cbparams: u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslCreateEphemeralKey(hsslprovider : NCRYPT_PROV_HANDLE, phephemeralkey : *mut NCRYPT_KEY_HANDLE, dwprotocol : u32, dwciphersuite : u32, dwkeytype : u32, dwkeybitlen : u32, pbparams : *const u8, cbparams : u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslCreateHandshakeHash = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, phhandshakehash: *mut NCRYPT_HASH_HANDLE, dwprotocol: u32, dwciphersuite: u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslCreateHandshakeHash(hsslprovider : NCRYPT_PROV_HANDLE, phhandshakehash : *mut NCRYPT_HASH_HANDLE, dwprotocol : u32, dwciphersuite : u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslDecrementProviderReferenceCount = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslDecrementProviderReferenceCount(hsslprovider : NCRYPT_PROV_HANDLE) -> windows_sys::core::HRESULT);
pub type SslDecryptPacket = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hkey: NCRYPT_KEY_HANDLE, pbinput: *const u8, cbinput: u32, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, sequencenumber: u64, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslDecryptPacket(hsslprovider : NCRYPT_PROV_HANDLE, hkey : NCRYPT_KEY_HANDLE, pbinput : *const u8, cbinput : u32, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, sequencenumber : u64, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslDuplicateTranscriptHash = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, htranscripthash: NCRYPT_HASH_HANDLE, phtranscripthash: *mut NCRYPT_HASH_HANDLE, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslDuplicateTranscriptHash(hsslprovider : NCRYPT_PROV_HANDLE, htranscripthash : NCRYPT_HASH_HANDLE, phtranscripthash : *mut NCRYPT_HASH_HANDLE, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslEncryptPacket = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hkey: NCRYPT_KEY_HANDLE, pbinput: *const u8, cbinput: u32, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, sequencenumber: u64, dwcontenttype: u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslEncryptPacket(hsslprovider : NCRYPT_PROV_HANDLE, hkey : NCRYPT_KEY_HANDLE, pbinput : *const u8, cbinput : u32, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, sequencenumber : u64, dwcontenttype : u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslEnumCipherSuites = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hprivatekey: NCRYPT_KEY_HANDLE, ppciphersuite: *mut *mut NCRYPT_SSL_CIPHER_SUITE, ppenumstate: *mut *mut core::ffi::c_void, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslEnumCipherSuites(hsslprovider : NCRYPT_PROV_HANDLE, hprivatekey : NCRYPT_KEY_HANDLE, ppciphersuite : *mut *mut NCRYPT_SSL_CIPHER_SUITE, ppenumstate : *mut *mut core::ffi::c_void, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslEnumCipherSuitesEx = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hprivatekey: NCRYPT_KEY_HANDLE, ppciphersuite: *mut *mut NCRYPT_SSL_CIPHER_SUITE_EX, ppenumstate: *mut *mut core::ffi::c_void, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslEnumCipherSuitesEx(hsslprovider : NCRYPT_PROV_HANDLE, hprivatekey : NCRYPT_KEY_HANDLE, ppciphersuite : *mut *mut NCRYPT_SSL_CIPHER_SUITE_EX, ppenumstate : *mut *mut core::ffi::c_void, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslEnumEccCurves = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, pecccurvecount: *mut u32, ppecccurve: *mut *mut NCRYPT_SSL_ECC_CURVE, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslEnumEccCurves(hsslprovider : NCRYPT_PROV_HANDLE, pecccurvecount : *mut u32, ppecccurve : *mut *mut NCRYPT_SSL_ECC_CURVE, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslEnumProtocolProviders = unsafe extern "system" fn(pdwprovidercount: *mut u32, ppproviderlist: *mut *mut NCryptProviderName, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslEnumProtocolProviders(pdwprovidercount : *mut u32, ppproviderlist : *mut *mut NCryptProviderName, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslExpandBinderKey = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hearlykey: NCRYPT_KEY_HANDLE, phbinderkey: *mut NCRYPT_KEY_HANDLE, pparameterlist: *const BCryptBufferDesc, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslExpandBinderKey(hsslprovider : NCRYPT_PROV_HANDLE, hearlykey : NCRYPT_KEY_HANDLE, phbinderkey : *mut NCRYPT_KEY_HANDLE, pparameterlist : *const BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslExpandExporterMasterKey = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hbasekey: NCRYPT_KEY_HANDLE, hhashvalue: NCRYPT_HASH_HANDLE, phexportermasterkey: *mut NCRYPT_KEY_HANDLE, pparameterlist: *const BCryptBufferDesc, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslExpandExporterMasterKey(hsslprovider : NCRYPT_PROV_HANDLE, hbasekey : NCRYPT_KEY_HANDLE, hhashvalue : NCRYPT_HASH_HANDLE, phexportermasterkey : *mut NCRYPT_KEY_HANDLE, pparameterlist : *const BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslExpandPreSharedKey = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hresumptionmasterkey: NCRYPT_KEY_HANDLE, pbticketnonce: *const u8, cbticketnonce: u32, phpresharedkey: *mut NCRYPT_KEY_HANDLE, pparameterlist: *const BCryptBufferDesc, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslExpandPreSharedKey(hsslprovider : NCRYPT_PROV_HANDLE, hresumptionmasterkey : NCRYPT_KEY_HANDLE, pbticketnonce : *const u8, cbticketnonce : u32, phpresharedkey : *mut NCRYPT_KEY_HANDLE, pparameterlist : *const BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslExpandResumptionMasterKey = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hmasterkey: NCRYPT_KEY_HANDLE, hhashvalue: NCRYPT_HASH_HANDLE, phresumptionmasterkey: *mut NCRYPT_KEY_HANDLE, pparameterlist: *const BCryptBufferDesc, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslExpandResumptionMasterKey(hsslprovider : NCRYPT_PROV_HANDLE, hmasterkey : NCRYPT_KEY_HANDLE, hhashvalue : NCRYPT_HASH_HANDLE, phresumptionmasterkey : *mut NCRYPT_KEY_HANDLE, pparameterlist : *const BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslExpandTrafficKeys = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hbasekey: NCRYPT_KEY_HANDLE, hhashvalue: NCRYPT_HASH_HANDLE, phclienttraffickey: *mut NCRYPT_KEY_HANDLE, phservertraffickey: *mut NCRYPT_KEY_HANDLE, pparameterlist: *const BCryptBufferDesc, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslExpandTrafficKeys(hsslprovider : NCRYPT_PROV_HANDLE, hbasekey : NCRYPT_KEY_HANDLE, hhashvalue : NCRYPT_HASH_HANDLE, phclienttraffickey : *mut NCRYPT_KEY_HANDLE, phservertraffickey : *mut NCRYPT_KEY_HANDLE, pparameterlist : *const BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslExpandWriteKey = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hbasetraffickey: NCRYPT_KEY_HANDLE, phwritekey: *mut NCRYPT_KEY_HANDLE, pparameterlist: *const BCryptBufferDesc, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslExpandWriteKey(hsslprovider : NCRYPT_PROV_HANDLE, hbasetraffickey : NCRYPT_KEY_HANDLE, phwritekey : *mut NCRYPT_KEY_HANDLE, pparameterlist : *const BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslExportKey = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hkey: NCRYPT_KEY_HANDLE, pszblobtype: windows_sys::core::PCWSTR, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslExportKey(hsslprovider : NCRYPT_PROV_HANDLE, hkey : NCRYPT_KEY_HANDLE, pszblobtype : windows_sys::core::PCWSTR, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslExportKeyingMaterial = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hmasterkey: NCRYPT_KEY_HANDLE, slabel: windows_sys::core::PCSTR, pbrandoms: *const u8, cbrandoms: u32, pbcontextvalue: *const u8, cbcontextvalue: u16, pboutput: *mut u8, cboutput: u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslExportKeyingMaterial(hsslprovider : NCRYPT_PROV_HANDLE, hmasterkey : NCRYPT_KEY_HANDLE, slabel : windows_sys::core::PCSTR, pbrandoms : *const u8, cbrandoms : u32, pbcontextvalue : *const u8, cbcontextvalue : u16, pboutput : *mut u8, cboutput : u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslExtractEarlyKey = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hpresharedkey: NCRYPT_KEY_HANDLE, phearlykey: *mut NCRYPT_KEY_HANDLE, dwprotocol: u32, dwciphersuite: u32, pparameterlist: *const BCryptBufferDesc, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslExtractEarlyKey(hsslprovider : NCRYPT_PROV_HANDLE, hpresharedkey : NCRYPT_KEY_HANDLE, phearlykey : *mut NCRYPT_KEY_HANDLE, dwprotocol : u32, dwciphersuite : u32, pparameterlist : *const BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslExtractHandshakeKey = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hprivatekey: NCRYPT_KEY_HANDLE, hpublickey: NCRYPT_KEY_HANDLE, hearlykey: NCRYPT_KEY_HANDLE, phhandshakekey: *mut NCRYPT_KEY_HANDLE, pparameterlist: *const BCryptBufferDesc, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslExtractHandshakeKey(hsslprovider : NCRYPT_PROV_HANDLE, hprivatekey : NCRYPT_KEY_HANDLE, hpublickey : NCRYPT_KEY_HANDLE, hearlykey : NCRYPT_KEY_HANDLE, phhandshakekey : *mut NCRYPT_KEY_HANDLE, pparameterlist : *const BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslExtractMasterKey = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hhandshakekey: NCRYPT_KEY_HANDLE, phmasterkey: *mut NCRYPT_KEY_HANDLE, pparameterlist: *const BCryptBufferDesc, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslExtractMasterKey(hsslprovider : NCRYPT_PROV_HANDLE, hhandshakekey : NCRYPT_KEY_HANDLE, phmasterkey : *mut NCRYPT_KEY_HANDLE, pparameterlist : *const BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslFreeBuffer = unsafe extern "system" fn(pvinput: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslFreeBuffer(pvinput : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type SslFreeObject = unsafe extern "system" fn(hobject: NCRYPT_HANDLE, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslFreeObject(hobject : NCRYPT_HANDLE, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslGenerateMasterKey = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hprivatekey: NCRYPT_KEY_HANDLE, hpublickey: NCRYPT_KEY_HANDLE, phmasterkey: *mut NCRYPT_KEY_HANDLE, dwprotocol: u32, dwciphersuite: u32, pparameterlist: *const BCryptBufferDesc, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslGenerateMasterKey(hsslprovider : NCRYPT_PROV_HANDLE, hprivatekey : NCRYPT_KEY_HANDLE, hpublickey : NCRYPT_KEY_HANDLE, phmasterkey : *mut NCRYPT_KEY_HANDLE, dwprotocol : u32, dwciphersuite : u32, pparameterlist : *const BCryptBufferDesc, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslGeneratePreMasterKey = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hpublickey: NCRYPT_KEY_HANDLE, phpremasterkey: *mut NCRYPT_KEY_HANDLE, dwprotocol: u32, dwciphersuite: u32, pparameterlist: *const BCryptBufferDesc, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslGeneratePreMasterKey(hsslprovider : NCRYPT_PROV_HANDLE, hpublickey : NCRYPT_KEY_HANDLE, phpremasterkey : *mut NCRYPT_KEY_HANDLE, dwprotocol : u32, dwciphersuite : u32, pparameterlist : *const BCryptBufferDesc, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslGenerateSessionKeys = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hmasterkey: NCRYPT_KEY_HANDLE, phreadkey: *mut NCRYPT_KEY_HANDLE, phwritekey: *mut NCRYPT_KEY_HANDLE, pparameterlist: *const BCryptBufferDesc, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslGenerateSessionKeys(hsslprovider : NCRYPT_PROV_HANDLE, hmasterkey : NCRYPT_KEY_HANDLE, phreadkey : *mut NCRYPT_KEY_HANDLE, phwritekey : *mut NCRYPT_KEY_HANDLE, pparameterlist : *const BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslGetCipherSuitePRFHashAlgorithm = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, dwprotocol: u32, dwciphersuite: u32, dwkeytype: u32, szprfhash: windows_sys::core::PWSTR, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslGetCipherSuitePRFHashAlgorithm(hsslprovider : NCRYPT_PROV_HANDLE, dwprotocol : u32, dwciphersuite : u32, dwkeytype : u32, szprfhash : windows_sys::core::PWSTR, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslGetKeyProperty = unsafe extern "system" fn(hkey: NCRYPT_KEY_HANDLE, pszproperty: windows_sys::core::PCWSTR, ppboutput: *mut *mut u8, pcboutput: *mut u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslGetKeyProperty(hkey : NCRYPT_KEY_HANDLE, pszproperty : windows_sys::core::PCWSTR, ppboutput : *mut *mut u8, pcboutput : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslGetProviderProperty = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, pszproperty: windows_sys::core::PCWSTR, ppboutput: *mut *mut u8, pcboutput: *mut u32, ppenumstate: *mut *mut core::ffi::c_void, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslGetProviderProperty(hsslprovider : NCRYPT_PROV_HANDLE, pszproperty : windows_sys::core::PCWSTR, ppboutput : *mut *mut u8, pcboutput : *mut u32, ppenumstate : *mut *mut core::ffi::c_void, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslHashHandshake = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hhandshakehash: NCRYPT_HASH_HANDLE, pbinput: *const u8, cbinput: u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslHashHandshake(hsslprovider : NCRYPT_PROV_HANDLE, hhandshakehash : NCRYPT_HASH_HANDLE, pbinput : *const u8, cbinput : u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslImportKey = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, phkey: *mut NCRYPT_KEY_HANDLE, pszblobtype: windows_sys::core::PCWSTR, pbkeyblob: *const u8, cbkeyblob: u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslImportKey(hsslprovider : NCRYPT_PROV_HANDLE, phkey : *mut NCRYPT_KEY_HANDLE, pszblobtype : windows_sys::core::PCWSTR, pbkeyblob : *const u8, cbkeyblob : u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslImportMasterKey = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hprivatekey: NCRYPT_KEY_HANDLE, phmasterkey: *mut NCRYPT_KEY_HANDLE, dwprotocol: u32, dwciphersuite: u32, pparameterlist: *const BCryptBufferDesc, pbencryptedkey: *const u8, cbencryptedkey: u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslImportMasterKey(hsslprovider : NCRYPT_PROV_HANDLE, hprivatekey : NCRYPT_KEY_HANDLE, phmasterkey : *mut NCRYPT_KEY_HANDLE, dwprotocol : u32, dwciphersuite : u32, pparameterlist : *const BCryptBufferDesc, pbencryptedkey : *const u8, cbencryptedkey : u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslIncrementProviderReferenceCount = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslIncrementProviderReferenceCount(hsslprovider : NCRYPT_PROV_HANDLE) -> windows_sys::core::HRESULT);
pub type SslLookupCipherLengths = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, dwprotocol: u32, dwciphersuite: u32, dwkeytype: u32, pcipherlengths: *mut NCRYPT_SSL_CIPHER_LENGTHS, cbcipherlengths: u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslLookupCipherLengths(hsslprovider : NCRYPT_PROV_HANDLE, dwprotocol : u32, dwciphersuite : u32, dwkeytype : u32, pcipherlengths : *mut NCRYPT_SSL_CIPHER_LENGTHS, cbcipherlengths : u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslLookupCipherSuiteInfo = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, dwprotocol: u32, dwciphersuite: u32, dwkeytype: u32, pciphersuite: *mut NCRYPT_SSL_CIPHER_SUITE, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslLookupCipherSuiteInfo(hsslprovider : NCRYPT_PROV_HANDLE, dwprotocol : u32, dwciphersuite : u32, dwkeytype : u32, pciphersuite : *mut NCRYPT_SSL_CIPHER_SUITE, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslOpenPrivateKey = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, phprivatekey: *mut NCRYPT_KEY_HANDLE, pcertcontext: *const CERT_CONTEXT, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslOpenPrivateKey(hsslprovider : NCRYPT_PROV_HANDLE, phprivatekey : *mut NCRYPT_KEY_HANDLE, pcertcontext : *const CERT_CONTEXT, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslOpenProvider = unsafe extern "system" fn(phsslprovider: *mut NCRYPT_PROV_HANDLE, pszprovidername: windows_sys::core::PCWSTR, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslOpenProvider(phsslprovider : *mut NCRYPT_PROV_HANDLE, pszprovidername : windows_sys::core::PCWSTR, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslSignHash = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hprivatekey: NCRYPT_KEY_HANDLE, pbhashvalue: *const u8, cbhashvalue: u32, pbsignature: *mut u8, cbsignature: u32, pcbresult: *mut u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslSignHash(hsslprovider : NCRYPT_PROV_HANDLE, hprivatekey : NCRYPT_KEY_HANDLE, pbhashvalue : *const u8, cbhashvalue : u32, pbsignature : *mut u8, cbsignature : u32, pcbresult : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SslVerifySignature = unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hpublickey: NCRYPT_KEY_HANDLE, pbhashvalue: *const u8, cbhashvalue: u32, pbsignature: *const u8, cbsignature: u32, dwflags: u32) -> windows_sys::core::HRESULT;
windows_link::link!("ncrypt.dll" "system" fn SslVerifySignature(hsslprovider : NCRYPT_PROV_HANDLE, hpublickey : NCRYPT_KEY_HANDLE, pbhashvalue : *const u8, cbhashvalue : u32, pbsignature : *const u8, cbsignature : u32, dwflags : u32) -> windows_sys::core::HRESULT);
pub type SystemPrng = unsafe extern "system" fn(pbrandomdata: *mut u8, cbrandomdata: usize) -> windows_sys::core::BOOL;
windows_link::link!("bcryptprimitives.dll" "system" fn SystemPrng(pbrandomdata : *mut u8, cbrandomdata : usize) -> windows_sys::core::BOOL);
pub type TransformBlock = unsafe extern "system" fn(hcrypto: *const INFORMATIONCARD_CRYPTO_HANDLE, cbindata: u32, pindata: *const u8, pcboutdata: *mut u32, ppoutdata: *mut *mut u8) -> windows_sys::core::HRESULT;
windows_link::link!("infocardapi.dll" "system" fn TransformBlock(hcrypto : *const INFORMATIONCARD_CRYPTO_HANDLE, cbindata : u32, pindata : *const u8, pcboutdata : *mut u32, ppoutdata : *mut *mut u8) -> windows_sys::core::HRESULT);
pub type TransformFinalBlock = unsafe extern "system" fn(hcrypto: *const INFORMATIONCARD_CRYPTO_HANDLE, cbindata: u32, pindata: *const u8, pcboutdata: *mut u32, ppoutdata: *mut *mut u8) -> windows_sys::core::HRESULT;
windows_link::link!("infocardapi.dll" "system" fn TransformFinalBlock(hcrypto : *const INFORMATIONCARD_CRYPTO_HANDLE, cbindata : u32, pindata : *const u8, pcboutdata : *mut u32, ppoutdata : *mut *mut u8) -> windows_sys::core::HRESULT);
pub type VerifyHash = unsafe extern "system" fn(hcrypto: *const INFORMATIONCARD_CRYPTO_HANDLE, cbhash: u32, phash: *const u8, hashalgoid: windows_sys::core::PCWSTR, cbsig: u32, psig: *const u8, pfverified: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
windows_link::link!("infocardapi.dll" "system" fn VerifyHash(hcrypto : *const INFORMATIONCARD_CRYPTO_HANDLE, cbhash : u32, phash : *const u8, hashalgoid : windows_sys::core::PCWSTR, cbsig : u32, psig : *const u8, pfverified : *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT);
...
pub const BCRYPT_CSHAKE128_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("CSHAKE128");
pub const BCRYPT_CSHAKE128_ALG_HANDLE: BCRYPT_ALG_HANDLE = 1041u32 as _;
pub const BCRYPT_CSHAKE256_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("CSHAKE256");
pub const BCRYPT_CSHAKE256_ALG_HANDLE: BCRYPT_ALG_HANDLE = 1057u32 as _;
pub const BCRYPT_CUSTOMIZATION_STRING: windows_sys::core::PCWSTR = windows_sys::core::w!("CustomizationString");
...
pub const BCRYPT_FUNCTION_NAME_STRING: windows_sys::core::PCWSTR = windows_sys::core::w!("FunctionNameString");
...
pub const BCRYPT_HASH_DONT_RESET_FLAG: u32 = 1u32;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const BCRYPT_HMAC_SHA3_256_ALG_HANDLE: BCRYPT_ALG_HANDLE = 993u32 as _;
pub const BCRYPT_HMAC_SHA3_384_ALG_HANDLE: BCRYPT_ALG_HANDLE = 1009u32 as _;
pub const BCRYPT_HMAC_SHA3_512_ALG_HANDLE: BCRYPT_ALG_HANDLE = 1025u32 as _;
...
pub const BCRYPT_KMAC128_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("KMAC128");
...
pub const BCRYPT_PKCS11_RSA_AES_WRAP_BLOB_MAGIC: u32 = 1464877394u32;
...
pub const BCRYPT_SHA3_256_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("SHA3-256");
pub const BCRYPT_SHA3_256_ALG_HANDLE: BCRYPT_ALG_HANDLE = 945u32 as _;
pub const BCRYPT_SHA3_384_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("SHA3-384");
pub const BCRYPT_SHA3_384_ALG_HANDLE: BCRYPT_ALG_HANDLE = 961u32 as _;
pub const BCRYPT_SHA3_512_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("SHA3-512");
...
pub const CERT_CHAIN_MIN_TELEMETRY_RSA_PUB_KEY_BIT_LENGTH_DEFAULT: u32 = 2047u32;
pub const CERT_CHAIN_MIN_TELEMETRY_RSA_PUB_KEY_BIT_LENGTH_DISABLE: u32 = 4294967295u32;
...
pub const CERT_CHAIN_MIN_WEAK_RSA_PUB_KEY_BIT_LENGTH_DEFAULT: u32 = 2047u32;
pub const CERT_CHAIN_MIN_WEAK_RSA_PUB_KEY_BIT_LENGTH_DISABLE: u32 = 4294967295u32;
...
pub const CERT_CHAIN_POLICY_CT: windows_sys::core::PCSTR = 13i32 as _;
pub const CERT_CHAIN_POLICY_CT_ERROR_CANNOT_VALIDATE_SCT: i32 = -50i32;
pub const CERT_CHAIN_POLICY_CT_ERROR_INVALID_ISSUER_CERT: i32 = -101i32;
pub const CERT_CHAIN_POLICY_CT_ERROR_INVALID_SUBJECT_CERT: i32 = -100i32;
pub const CERT_CHAIN_POLICY_CT_ERROR_MISSING_SCT_EXTENSION: i32 = -110i32;
pub const CERT_CHAIN_POLICY_CT_ERROR_SCT_VALIDATION_STATUS_INSUFFICIENT: i32 = -4i32;
pub const CERT_CHAIN_POLICY_CT_ERROR_SCT_VALIDATION_STATUS_INVALID: i32 = -1i32;
pub const CERT_CHAIN_POLICY_CT_ERROR_SCT_VALIDATION_STATUS_UNKNOWN_LOG: i32 = -2i32;
pub const CERT_CHAIN_POLICY_CT_ERROR_SCT_VALIDATION_STATUS_UNKNOWN_VERSION: i32 = -3i32;
pub const CERT_CHAIN_POLICY_CT_ERROR_UNDECODABLE_SCT_EXTENSION: i32 = -112i32;
pub const CERT_CHAIN_POLICY_CT_ERROR_UNRETRIEVABLE_SCT_EXTENSION: i32 = -111i32;
pub const CERT_CHAIN_POLICY_CT_SUCCESS_SCT_VALIDIDATION_STATUS_VALID: u32 = 0u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_BEFORE_CODE_SIGNING_CT_LOGGING: u32 = 2u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_CANNOT_CREATE_POLICY: u32 = 300u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_CANNOT_CREATE_TEMP_FILE: u32 = 81u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_CANNOT_LOAD_CTLOG_STORE_FILE: u32 = 83u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_CANNOT_WRITE_TEMP_FILE: u32 = 82u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_EXPIRED_ROOT_CTL: u32 = 4u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_FAILED_INIT: u32 = 90u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_HASHING_ERROR: u32 = 200u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_INVALID_CHAIN_CONTEXT: u32 = 50u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_INVALID_CT_EXT: u32 = 61u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_INVALID_STR: u32 = 201u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_INVALID_TEMP_FILE: u32 = 80u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_MISSING_CT_EXT: u32 = 60u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_MISSING_ROOT_CTL: u32 = 52u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_NOT_SUPPORTED_CA: u32 = 51u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_NOT_THIRD_PARTY_CERT: u32 = 3u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_OUT_OF_MEMORY: u32 = 1u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_UNABLE_TO_DECODE_EXT: u32 = 62u32;
pub const CERT_CHAIN_POLICY_CT_WARNING_UNABLE_TO_DECODE_PARAMETERS: u32 = 70u32;
...
pub const CERT_COMPARE_SHA1_SHA256_HASH: u32 = 23u32;
pub const CERT_COMPARE_SHA256_HASH: u32 = 22u32;
...
pub const CERT_FIND_SHA1_SHA256_HASH: CERT_FIND_FLAGS = 1507328u32;
pub const CERT_FIND_SHA256_HASH: CERT_FIND_FLAGS = 1441792u32;
...
pub const CERT_FIRST_RESERVED_PROP_ID: u32 = 130u32;
...
pub const CERT_SHA1_SHA256_HASH_PROP_ID: u32 = 129u32;
...
pub const CERT_TRUST_HAS_MIN_TELEMETRY_RSA: u32 = 4194304u32;
pub const CERT_TRUST_HAS_MIN_WEAK_RSA: u32 = 8388608u32;
...
pub const MS_PLUTON_CRYPTO_PROVIDER: windows_sys::core::PCWSTR = windows_sys::core::w!("Microsoft Pluton Cryptographic Provider");
...
pub const NCRYPTBUFFER_ATTESTATION_STATEMENT_NONCE: u32 = 49u32;
pub const NCRYPTBUFFER_ATTESTATION_STATEMENT_SIGNATURE_HASH: u32 = 90u32;
pub const NCRYPTBUFFER_ATTESTATION_STATEMENT_SIGNATURE_PADDING_ALGO: u32 = 92u32;
pub const NCRYPTBUFFER_ATTESTATION_STATEMENT_SIGNATURE_PADDING_SALT: u32 = 93u32;
pub const NCRYPTBUFFER_ATTESTATION_STATEMENT_SIGNATURE_PADDING_SALT_SIZE: u32 = 93u32;
pub const NCRYPTBUFFER_ATTESTATION_STATEMENT_SIGNATURE_PADDING_SCHEME: u32 = 91u32;
...
pub const NCRYPTBUFFER_VBS_ATTESTATION_STATEMENT_IDENTITY_DETAILS: u32 = 95u32;
pub const NCRYPTBUFFER_VBS_ATTESTATION_STATEMENT_ROOT_DETAILS: u32 = 94u32;
...
pub const NCRYPT_ALLOW_KEY_ATTESTATION_FLAG: u32 = 16u32;
pub const NCRYPT_ALLOW_KEY_ENVELOPE_FLAG: u32 = 8u32;
pub const NCRYPT_ALLOW_KEY_IMPORT_EPHEMERAL_FLAG: u32 = 32u32;
pub const NCRYPT_ALLOW_KEY_IMPORT_FLAG: u32 = 8u32;
pub const NCRYPT_ALLOW_PKCS11_RSA_AES_EXPORT_FLAG: u32 = 16u32;
...
pub const NCRYPT_CLAIM_VBS_IDENTITY: u32 = 6u32;
pub const NCRYPT_CLAIM_VBS_KEY_ATTESTATION_STATEMENT: u32 = 4u32;
pub const NCRYPT_CLAIM_VBS_ROOT: u32 = 5u32;
pub const NCRYPT_CLAIM_WEB_AUTH_SUBJECT_ONLY: u32 = 258u32;
pub const NCRYPT_CLAIM_WEB_AUTH_SUBJECT_ONLY_V2: u32 = 259u32;
...
pub const NCRYPT_ISOLATED_KEY_FLAG_PER_BOOT_KEY: u32 = 4u32;
...
pub const NCRYPT_PLUTON_ECC_EKCERT_PROPERTY: windows_sys::core::PCWSTR = windows_sys::core::w!("PLUTON_ECC_EKCERT");
pub const NCRYPT_PLUTON_ECC_EKPUB_PROPERTY: windows_sys::core::PCWSTR = windows_sys::core::w!("PLUTON_ECC_EKPUB");
pub const NCRYPT_PLUTON_EKCERT_PROPERTY: windows_sys::core::PCWSTR = windows_sys::core::w!("PLUTON_EKCERT");
pub const NCRYPT_PLUTON_EKPUB_PROPERTY: windows_sys::core::PCWSTR = windows_sys::core::w!("PLUTON_EKPUB");
pub const NCRYPT_PLUTON_KDF_PARAMS_BUFFER_DESC_PROPERTY: windows_sys::core::PCWSTR = windows_sys::core::w!("PlutonKdfParamsBufferDesc");
pub const NCRYPT_PLUTON_KDF_PARENT_KEY_UNIQUE_NAME_PROPERTY: windows_sys::core::PCWSTR = windows_sys::core::w!("PlutonKdfParentKeyUniqueName");
...
pub const NCRYPT_REQUIRE_VBS_FLAG: u32 = 131072u32;
...
pub const NCRYPT_TPM_PERSISTENT_KEY_BLOB_MAGIC: u32 = 1297371211u32;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const NCRYPT_USE_VBS_PER_BOOT_KEY_FLAG: u32 = 262144u32;
...
pub const NCRYPT_VBS_IDENTITY_ATTESTATION_HEADER_CURRENT_VERSION: u32 = 0u32;
pub const NCRYPT_VBS_IDENTITY_ATTESTATION_HEADER_V0: u32 = 0u32;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const NCRYPT_VBS_IDENTITY_ATTESTATION_PADDING_CURRENT_VERSION: u32 = 0u32;
pub const NCRYPT_VBS_IDENTITY_ATTESTATION_PADDING_V0: u32 = 0u32;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const NCRYPT_VBS_KEY_ATTESTATION_STATEMENT_CURRENT_VERSION: u32 = 2u32;
pub const NCRYPT_VBS_KEY_ATTESTATION_STATEMENT_V1: u32 = 1u32;
pub const NCRYPT_VBS_KEY_ATTESTATION_STATEMENT_V2: u32 = 2u32;
pub const NCRYPT_VBS_KEY_ATTESTED_ATTRIBUTES_CURRENT_VERSION: u32 = 0u32;
pub const NCRYPT_VBS_KEY_FLAG_CREATED_IN_ISOLATION: u32 = 1u32;
pub const NCRYPT_VBS_KEY_FLAG_IMPORT_EPHEMERAL_ONLY: u32 = 8u32;
pub const NCRYPT_VBS_KEY_FLAG_IMPORT_ONLY: u32 = 2u32;
pub const NCRYPT_VBS_KEY_FLAG_PER_BOOT_KEY: u32 = 4u32;
pub const NCRYPT_VBS_RETURN_CLAIM_DETAILS_FLAG: u32 = 1048576u32;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const NCRYPT_VBS_ROOT_ATTESTATION_HEADER_CURRENT_VERSION: u32 = 0u32;
pub const NCRYPT_VBS_ROOT_ATTESTATION_HEADER_V0: u32 = 0u32;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const NCRYPT_VBS_ROOT_PUB_PROPERTY: windows_sys::core::PCWSTR = windows_sys::core::w!("VBS_ROOT_PUB");
...
pub const PKCS12_NAMED_NO_PERSIST_KEY: u32 = 131072u32;
...
pub const VBS_IDENTITY_ATTESTATION_HEADER_MAGIC: u32 = 1212369238u32;
pub const VBS_KEY_ATTESTATION_STATEMENT_MAGIC: u32 = 1396788054u32;
pub const VBS_ROOT_ATTESTATION_HEADER_MAGIC: u32 = 1212371542u32;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const WINCRYPT_OCSP_REQUEST: windows_sys::core::PCSTR = 66i32 as _;
pub const WINCRYPT_OCSP_RESPONSE: windows_sys::core::PCSTR = 67i32 as _;
pub const WINCRYPT_PKCS7_SIGNER_INFO: windows_sys::core::PCSTR = 500i32 as _;
pub const WINCRYPT_X509_EXTENSIONS: windows_sys::core::PCSTR = 5i32 as _;
pub const WINCRYPT_X509_NAME: windows_sys::core::PCSTR = 7i32 as _;
