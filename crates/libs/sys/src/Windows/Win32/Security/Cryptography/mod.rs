...
windows_link::link!("bcrypt.dll" "system" fn BCryptConfigureContext(dwtable : BCRYPT_TABLE, pszcontext : windows_sys::core::PCWSTR, pconfig : *mut CRYPT_CONTEXT_CONFIG) -> super::super::Foundation:: NTSTATUS);
windows_link::link!("bcrypt.dll" "system" fn BCryptConfigureContextFunction(dwtable : BCRYPT_TABLE, pszcontext : windows_sys::core::PCWSTR, dwinterface : BCRYPT_INTERFACE, pszfunction : windows_sys::core::PCWSTR, pconfig : *mut CRYPT_CONTEXT_FUNCTION_CONFIG) -> super::super::Foundation:: NTSTATUS);
...
windows_link::link!("bcrypt.dll" "system" fn BCryptCreateMultiHash(halgorithm : BCRYPT_ALG_HANDLE, phhash : *mut BCRYPT_HASH_HANDLE, nhashes : u32, pbhashobject : *mut u8, cbhashobject : u32, pbsecret : *mut u8, cbsecret : u32, dwflags : u32) -> super::super::Foundation:: NTSTATUS);
windows_link::link!("bcrypt.dll" "system" fn BCryptDecrypt(hkey : BCRYPT_KEY_HANDLE, pbinput : *mut u8, cbinput : u32, ppaddinginfo : *mut core::ffi::c_void, pbiv : *mut u8, cbiv : u32, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : BCRYPT_FLAGS) -> super::super::Foundation:: NTSTATUS);
...
windows_link::link!("bcrypt.dll" "system" fn BCryptDeriveKey(hsharedsecret : BCRYPT_SECRET_HANDLE, pwszkdf : windows_sys::core::PCWSTR, pparameterlist : *mut BCryptBufferDesc, pbderivedkey : *mut u8, cbderivedkey : u32, pcbresult : *mut u32, dwflags : u32) -> super::super::Foundation:: NTSTATUS);
...
windows_link::link!("bcrypt.dll" "system" fn BCryptDeriveKeyPBKDF2(hprf : BCRYPT_ALG_HANDLE, pbpassword : *mut u8, cbpassword : u32, pbsalt : *mut u8, cbsalt : u32, citerations : u64, pbderivedkey : *mut u8, cbderivedkey : u32, dwflags : u32) -> super::super::Foundation:: NTSTATUS);
...
windows_link::link!("bcrypt.dll" "system" fn BCryptFreeBuffer(pvbuffer : *mut core::ffi::c_void));
...
windows_link::link!("bcrypt.dll" "system" fn BCryptGenerateSymmetricKey(halgorithm : BCRYPT_ALG_HANDLE, phkey : *mut BCRYPT_KEY_HANDLE, pbkeyobject : *mut u8, cbkeyobject : u32, pbsecret : *mut u8, cbsecret : u32, dwflags : u32) -> super::super::Foundation:: NTSTATUS);
...
windows_link::link!("bcrypt.dll" "system" fn BCryptHash(halgorithm : BCRYPT_ALG_HANDLE, pbsecret : *mut u8, cbsecret : u32, pbinput : *mut u8, cbinput : u32, pboutput : *mut u8, cboutput : u32) -> super::super::Foundation:: NTSTATUS);
...
windows_link::link!("bcrypt.dll" "system" fn BCryptImportKey(halgorithm : BCRYPT_ALG_HANDLE, himportkey : BCRYPT_KEY_HANDLE, pszblobtype : windows_sys::core::PCWSTR, phkey : *mut BCRYPT_KEY_HANDLE, pbkeyobject : *mut u8, cbkeyobject : u32, pbinput : *mut u8, cbinput : u32, dwflags : u32) -> super::super::Foundation:: NTSTATUS);
windows_link::link!("bcrypt.dll" "system" fn BCryptImportKeyPair(halgorithm : BCRYPT_ALG_HANDLE, himportkey : BCRYPT_KEY_HANDLE, pszblobtype : windows_sys::core::PCWSTR, phkey : *mut BCRYPT_KEY_HANDLE, pbinput : *mut u8, cbinput : u32, dwflags : u32) -> super::super::Foundation:: NTSTATUS);
windows_link::link!("bcrypt.dll" "system" fn BCryptKeyDerivation(hkey : BCRYPT_KEY_HANDLE, pparameterlist : *mut BCryptBufferDesc, pbderivedkey : *mut u8, cbderivedkey : u32, pcbresult : *mut u32, dwflags : u32) -> super::super::Foundation:: NTSTATUS);
...
windows_link::link!("bcrypt.dll" "system" fn BCryptProcessMultiOperations(hobject : BCRYPT_HANDLE, operationtype : BCRYPT_MULTI_OPERATION_TYPE, poperations : *mut core::ffi::c_void, cboperations : u32, dwflags : u32) -> super::super::Foundation:: NTSTATUS);
...
windows_link::link!("bcrypt.dll" "system" fn BCryptRegisterProvider(pszprovider : windows_sys::core::PCWSTR, dwflags : u32, preg : *mut CRYPT_PROVIDER_REG) -> super::super::Foundation:: NTSTATUS);
...
windows_link::link!("bcrypt.dll" "system" fn BCryptSetContextFunctionProperty(dwtable : BCRYPT_TABLE, pszcontext : windows_sys::core::PCWSTR, dwinterface : BCRYPT_INTERFACE, pszfunction : windows_sys::core::PCWSTR, pszproperty : windows_sys::core::PCWSTR, cbvalue : u32, pbvalue : *mut u8) -> super::super::Foundation:: NTSTATUS);
windows_link::link!("bcrypt.dll" "system" fn BCryptSetProperty(hobject : BCRYPT_HANDLE, pszproperty : windows_sys::core::PCWSTR, pbinput : *mut u8, cbinput : u32, dwflags : u32) -> super::super::Foundation:: NTSTATUS);
windows_link::link!("bcrypt.dll" "system" fn BCryptSignHash(hkey : BCRYPT_KEY_HANDLE, ppaddinginfo : *mut core::ffi::c_void, pbinput : *mut u8, cbinput : u32, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : BCRYPT_FLAGS) -> super::super::Foundation:: NTSTATUS);
...
windows_link::link!("bcrypt.dll" "system" fn BCryptVerifySignature(hkey : BCRYPT_KEY_HANDLE, ppaddinginfo : *mut core::ffi::c_void, pbhash : *mut u8, cbhash : u32, pbsignature : *mut u8, cbsignature : u32, dwflags : BCRYPT_FLAGS) -> super::super::Foundation:: NTSTATUS);
windows_link::link!("crypt32.dll" "system" fn CertAddCRLContextToStore(hcertstore : HCERTSTORE, pcrlcontext : *mut CRL_CONTEXT, dwadddisposition : u32, ppstorecontext : *mut *mut CRL_CONTEXT) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertAddCRLLinkToStore(hcertstore : HCERTSTORE, pcrlcontext : *mut CRL_CONTEXT, dwadddisposition : u32, ppstorecontext : *mut *mut CRL_CONTEXT) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertAddCTLContextToStore(hcertstore : HCERTSTORE, pctlcontext : *mut CTL_CONTEXT, dwadddisposition : u32, ppstorecontext : *mut *mut CTL_CONTEXT) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CertAddCertificateContextToStore(hcertstore : HCERTSTORE, pcertcontext : *mut CERT_CONTEXT, dwadddisposition : u32, ppstorecontext : *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertAddCertificateLinkToStore(hcertstore : HCERTSTORE, pcertcontext : *mut CERT_CONTEXT, dwadddisposition : u32, ppstorecontext : *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CertAddEncodedCTLToStore(hcertstore : HCERTSTORE, dwmsgandcertencodingtype : CERT_QUERY_ENCODING_TYPE, pbctlencoded : *mut u8, cbctlencoded : u32, dwadddisposition : u32, ppctlcontext : *mut *mut CTL_CONTEXT) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertAddEncodedCertificateToStore(hcertstore : HCERTSTORE, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pbcertencoded : *mut u8, cbcertencoded : u32, dwadddisposition : u32, ppcertcontext : *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertAddEncodedCertificateToSystemStoreA(szcertstorename : windows_sys::core::PCSTR, pbcertencoded : *mut u8, cbcertencoded : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CertAddEnhancedKeyUsageIdentifier(pcertcontext : *mut CERT_CONTEXT, pszusageidentifier : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertAddRefServerOcspResponse(hserverocspresponse : *const core::ffi::c_void));
windows_link::link!("crypt32.dll" "system" fn CertAddRefServerOcspResponseContext(pserverocspresponsecontext : *mut CERT_SERVER_OCSP_RESPONSE_CONTEXT));
windows_link::link!("crypt32.dll" "system" fn CertAddSerializedElementToStore(hcertstore : HCERTSTORE, pbelement : *mut u8, cbelement : u32, dwadddisposition : u32, dwflags : u32, dwcontexttypeflags : u32, pdwcontexttype : *mut u32, ppvcontext : *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CertAlgIdToOID(dwalgid : u32) -> windows_sys::core::PSTR);
windows_link::link!("crypt32.dll" "system" fn CertCloseServerOcspResponse(hserverocspresponse : *mut core::ffi::c_void, dwflags : u32));
...
windows_link::link!("crypt32.dll" "system" fn CertCompareCertificateName(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pcertname1 : *mut CRYPT_INTEGER_BLOB, pcertname2 : *mut CRYPT_INTEGER_BLOB) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertCompareIntegerBlob(pint1 : *mut CRYPT_INTEGER_BLOB, pint2 : *mut CRYPT_INTEGER_BLOB) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertComparePublicKeyInfo(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, ppublickey1 : *mut CERT_PUBLIC_KEY_INFO, ppublickey2 : *mut CERT_PUBLIC_KEY_INFO) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CertCreateCRLContext(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pbcrlencoded : *mut u8, cbcrlencoded : u32) -> *mut CRL_CONTEXT);
windows_link::link!("crypt32.dll" "system" fn CertCreateCTLContext(dwmsgandcertencodingtype : u32, pbctlencoded : *mut u8, cbctlencoded : u32) -> *mut CTL_CONTEXT);
...
windows_link::link!("crypt32.dll" "system" fn CertCreateCertificateContext(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pbcertencoded : *mut u8, cbcertencoded : u32) -> *mut CERT_CONTEXT);
windows_link::link!("crypt32.dll" "system" fn CertCreateContext(dwcontexttype : u32, dwencodingtype : u32, pbencoded : *mut u8, cbencoded : u32, dwflags : u32, pcreatepara : *mut CERT_CREATE_CONTEXT_PARA) -> *mut core::ffi::c_void);
windows_link::link!("crypt32.dll" "system" fn CertCreateSelfSignCertificate(hcryptprovorncryptkey : HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, psubjectissuerblob : *mut CRYPT_INTEGER_BLOB, dwflags : CERT_CREATE_SELFSIGN_FLAGS, pkeyprovinfo : *mut CRYPT_KEY_PROV_INFO, psignaturealgorithm : *mut CRYPT_ALGORITHM_IDENTIFIER, pstarttime : *mut super::super::Foundation:: SYSTEMTIME, pendtime : *mut super::super::Foundation:: SYSTEMTIME, pextensions : *mut CERT_EXTENSIONS) -> *mut CERT_CONTEXT);
windows_link::link!("crypt32.dll" "system" fn CertDeleteCRLFromStore(pcrlcontext : *const CRL_CONTEXT) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertDeleteCTLFromStore(pctlcontext : *mut CTL_CONTEXT) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertDeleteCertificateFromStore(pcertcontext : *mut CERT_CONTEXT) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertDuplicateCRLContext(pcrlcontext : *mut CRL_CONTEXT) -> *mut CRL_CONTEXT);
windows_link::link!("crypt32.dll" "system" fn CertDuplicateCTLContext(pctlcontext : *mut CTL_CONTEXT) -> *mut CTL_CONTEXT);
windows_link::link!("crypt32.dll" "system" fn CertDuplicateCertificateChain(pchaincontext : *mut CERT_CHAIN_CONTEXT) -> *mut CERT_CHAIN_CONTEXT);
windows_link::link!("crypt32.dll" "system" fn CertDuplicateCertificateContext(pcertcontext : *mut CERT_CONTEXT) -> *mut CERT_CONTEXT);
...
windows_link::link!("crypt32.dll" "system" fn CertEnumCRLsInStore(hcertstore : HCERTSTORE, pprevcrlcontext : *mut CRL_CONTEXT) -> *mut CRL_CONTEXT);
windows_link::link!("crypt32.dll" "system" fn CertEnumCTLContextProperties(pctlcontext : *mut CTL_CONTEXT, dwpropid : u32) -> u32);
windows_link::link!("crypt32.dll" "system" fn CertEnumCTLsInStore(hcertstore : HCERTSTORE, pprevctlcontext : *mut CTL_CONTEXT) -> *mut CTL_CONTEXT);
...
windows_link::link!("crypt32.dll" "system" fn CertEnumCertificatesInStore(hcertstore : HCERTSTORE, pprevcertcontext : *mut CERT_CONTEXT) -> *mut CERT_CONTEXT);
windows_link::link!("crypt32.dll" "system" fn CertEnumPhysicalStore(pvsystemstore : *mut core::ffi::c_void, dwflags : u32, pvarg : *mut core::ffi::c_void, pfnenum : PFN_CERT_ENUM_PHYSICAL_STORE) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertEnumSubjectInSortedCTL(pctlcontext : *mut CTL_CONTEXT, ppvnextsubject : *mut *mut core::ffi::c_void, psubjectidentifier : *mut CRYPT_INTEGER_BLOB, pencodedattributes : *mut CRYPT_INTEGER_BLOB) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertEnumSystemStore(dwflags : u32, pvsystemstorelocationpara : *mut core::ffi::c_void, pvarg : *mut core::ffi::c_void, pfnenum : PFN_CERT_ENUM_SYSTEM_STORE) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CertFindAttribute(pszobjid : windows_sys::core::PCSTR, cattr : u32, rgattr : *mut CRYPT_ATTRIBUTE) -> *mut CRYPT_ATTRIBUTE);
...
windows_link::link!("crypt32.dll" "system" fn CertFindCTLInStore(hcertstore : HCERTSTORE, dwmsgandcertencodingtype : u32, dwfindflags : u32, dwfindtype : CERT_FIND_TYPE, pvfindpara : *mut core::ffi::c_void, pprevctlcontext : *mut CTL_CONTEXT) -> *mut CTL_CONTEXT);
...
windows_link::link!("crypt32.dll" "system" fn CertFindChainInStore(hcertstore : HCERTSTORE, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, dwfindflags : CERT_FIND_CHAIN_IN_STORE_FLAGS, dwfindtype : u32, pvfindpara : *mut core::ffi::c_void, pprevchaincontext : *mut CERT_CHAIN_CONTEXT) -> *mut CERT_CHAIN_CONTEXT);
windows_link::link!("crypt32.dll" "system" fn CertFindExtension(pszobjid : windows_sys::core::PCSTR, cextensions : u32, rgextensions : *mut CERT_EXTENSION) -> *mut CERT_EXTENSION);
...
windows_link::link!("crypt32.dll" "system" fn CertFindSubjectInCTL(dwencodingtype : u32, dwsubjecttype : u32, pvsubject : *mut core::ffi::c_void, pctlcontext : *mut CTL_CONTEXT, dwflags : u32) -> *mut CTL_ENTRY);
...
windows_link::link!("crypt32.dll" "system" fn CertFreeCertificateChainList(prgpselection : *mut *mut CERT_CHAIN_CONTEXT));
windows_link::link!("crypt32.dll" "system" fn CertFreeCertificateContext(pcertcontext : *mut CERT_CONTEXT) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertFreeServerOcspResponseContext(pserverocspresponsecontext : *mut CERT_SERVER_OCSP_RESPONSE_CONTEXT));
windows_link::link!("crypt32.dll" "system" fn CertGetCRLContextProperty(pcrlcontext : *mut CRL_CONTEXT, dwpropid : u32, pvdata : *mut core::ffi::c_void, pcbdata : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CertGetCTLContextProperty(pctlcontext : *mut CTL_CONTEXT, dwpropid : u32, pvdata : *mut core::ffi::c_void, pcbdata : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertGetCertificateChain(hchainengine : HCERTCHAINENGINE, pcertcontext : *mut CERT_CONTEXT, ptime : *mut super::super::Foundation:: FILETIME, hadditionalstore : HCERTSTORE, pchainpara : *mut CERT_CHAIN_PARA, dwflags : u32, pvreserved : *mut core::ffi::c_void, ppchaincontext : *mut *mut CERT_CHAIN_CONTEXT) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertGetCertificateContextProperty(pcertcontext : *mut CERT_CONTEXT, dwpropid : u32, pvdata : *mut core::ffi::c_void, pcbdata : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertGetEnhancedKeyUsage(pcertcontext : *mut CERT_CONTEXT, dwflags : u32, pusage : *mut CTL_USAGE, pcbusage : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CertGetNameStringA(pcertcontext : *mut CERT_CONTEXT, dwtype : u32, dwflags : u32, pvtypepara : *mut core::ffi::c_void, psznamestring : windows_sys::core::PCSTR, cchnamestring : u32) -> u32);
windows_link::link!("crypt32.dll" "system" fn CertGetNameStringW(pcertcontext : *mut CERT_CONTEXT, dwtype : u32, dwflags : u32, pvtypepara : *mut core::ffi::c_void, psznamestring : windows_sys::core::PCWSTR, cchnamestring : u32) -> u32);
...
windows_link::link!("crypt32.dll" "system" fn CertGetServerOcspResponseContext(hserverocspresponse : *mut core::ffi::c_void, dwflags : u32, pvreserved : *mut core::ffi::c_void) -> *mut CERT_SERVER_OCSP_RESPONSE_CONTEXT);
...
windows_link::link!("crypt32.dll" "system" fn CertGetSubjectCertificateFromStore(hcertstore : HCERTSTORE, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pcertid : *mut CERT_INFO) -> *mut CERT_CONTEXT);
...
windows_link::link!("crypt32.dll" "system" fn CertIsRDNAttrsInCertificateName(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, dwflags : u32, pcertname : *mut CRYPT_INTEGER_BLOB, prdn : *mut CERT_RDN) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CertIsValidCRLForCertificate(pcert : *mut CERT_CONTEXT, pcrl : *mut CRL_CONTEXT, dwflags : u32, pvreserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertIsWeakHash(dwhashusetype : u32, pwszcnghashalgid : windows_sys::core::PCWSTR, dwchainflags : u32, psignerchaincontext : *mut CERT_CHAIN_CONTEXT, ptimestamp : *mut super::super::Foundation:: FILETIME, pwszfilename : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CertNameToStrW(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pname : *mut CRYPT_INTEGER_BLOB, dwstrtype : CERT_STRING_TYPE, psz : windows_sys::core::PCWSTR, csz : u32) -> u32);
windows_link::link!("crypt32.dll" "system" fn CertOIDToAlgId(pszobjid : windows_sys::core::PCSTR) -> u32);
windows_link::link!("crypt32.dll" "system" fn CertOpenServerOcspResponse(pchaincontext : *mut CERT_CHAIN_CONTEXT, dwflags : u32, popenpara : *mut CERT_SERVER_OCSP_RESPONSE_OPEN_PARA) -> *mut core::ffi::c_void);
windows_link::link!("crypt32.dll" "system" fn CertOpenStore(lpszstoreprovider : windows_sys::core::PCSTR, dwencodingtype : CERT_QUERY_ENCODING_TYPE, hcryptprov : HCRYPTPROV_LEGACY, dwflags : CERT_OPEN_STORE_FLAGS, pvpara : *mut core::ffi::c_void) -> HCERTSTORE);
...
windows_link::link!("crypt32.dll" "system" fn CertRDNValueToStrW(dwvaluetype : u32, pvalue : *mut CRYPT_INTEGER_BLOB, psz : windows_sys::core::PCWSTR, csz : u32) -> u32);
windows_link::link!("crypt32.dll" "system" fn CertRegisterPhysicalStore(pvsystemstore : *mut core::ffi::c_void, dwflags : u32, pwszstorename : windows_sys::core::PCWSTR, pstoreinfo : *mut CERT_PHYSICAL_STORE_INFO, pvreserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CertRetrieveLogoOrBiometricInfo(pcertcontext : *mut CERT_CONTEXT, lpszlogoorbiometrictype : windows_sys::core::PCSTR, dwretrievalflags : u32, dwtimeout : u32, dwflags : u32, pvreserved : *mut core::ffi::c_void, ppbdata : *mut *mut u8, pcbdata : *mut u32, ppwszmimetype : *mut windows_sys::core::PWSTR) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CertSelectCertificateChains(pselectioncontext : *mut windows_sys::core::GUID, dwflags : u32, pchainparameters : *mut CERT_SELECT_CHAIN_PARA, ccriteria : u32, rgpcriteria : *mut CERT_SELECT_CRITERIA, hstore : HCERTSTORE, pcselection : *mut u32, pprgpselection : *mut *mut *mut CERT_CHAIN_CONTEXT) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CertSerializeCTLStoreElement(pctlcontext : *mut CTL_CONTEXT, dwflags : u32, pbelement : *mut u8, pcbelement : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CertSetCTLContextProperty(pctlcontext : *mut CTL_CONTEXT, dwpropid : u32, dwflags : u32, pvdata : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CertSetCertificateContextProperty(pcertcontext : *mut CERT_CONTEXT, dwpropid : u32, dwflags : u32, pvdata : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertSetEnhancedKeyUsage(pcertcontext : *mut CERT_CONTEXT, pusage : *mut CTL_USAGE) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CertStrToNameA(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pszx500 : windows_sys::core::PCSTR, dwstrtype : CERT_STRING_TYPE, pvreserved : *mut core::ffi::c_void, pbencoded : *mut u8, pcbencoded : *mut u32, ppszerror : *mut windows_sys::core::PSTR) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertStrToNameW(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pszx500 : windows_sys::core::PCWSTR, dwstrtype : CERT_STRING_TYPE, pvreserved : *mut core::ffi::c_void, pbencoded : *mut u8, pcbencoded : *mut u32, ppszerror : *mut windows_sys::core::PWSTR) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertUnregisterPhysicalStore(pvsystemstore : *mut core::ffi::c_void, dwflags : u32, pwszstorename : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertUnregisterSystemStore(pvsystemstore : *mut core::ffi::c_void, dwflags : u32) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertVerifyCRLRevocation(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pcertid : *mut CERT_INFO, ccrlinfo : u32, rgpcrlinfo : *mut *mut CRL_INFO) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CertVerifyCTLUsage(dwencodingtype : u32, dwsubjecttype : u32, pvsubject : *mut core::ffi::c_void, psubjectusage : *mut CTL_USAGE, dwflags : u32, pverifyusagepara : *mut CTL_VERIFY_USAGE_PARA, pverifyusagestatus : *mut CTL_VERIFY_USAGE_STATUS) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertVerifyCertificateChainPolicy(pszpolicyoid : windows_sys::core::PCSTR, pchaincontext : *mut CERT_CHAIN_CONTEXT, ppolicypara : *mut CERT_CHAIN_POLICY_PARA, ppolicystatus : *mut CERT_CHAIN_POLICY_STATUS) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertVerifyRevocation(dwencodingtype : u32, dwrevtype : u32, ccontext : u32, rgpvcontext : *mut *mut core::ffi::c_void, dwflags : u32, prevpara : *mut CERT_REVOCATION_PARA, prevstatus : *mut CERT_REVOCATION_STATUS) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertVerifySubjectCertificateContext(psubject : *mut CERT_CONTEXT, pissuer : *mut CERT_CONTEXT, pdwflags : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CertVerifyTimeValidity(ptimetoverify : *mut super::super::Foundation:: FILETIME, pcertinfo : *mut CERT_INFO) -> i32);
windows_link::link!("crypt32.dll" "system" fn CertVerifyValidityNesting(psubjectinfo : *mut CERT_INFO, pissuerinfo : *mut CERT_INFO) -> windows_sys::core::BOOL);
windows_link::link!("infocardapi.dll" "system" fn CloseCryptoHandle(hcrypto : *mut INFORMATIONCARD_CRYPTO_HANDLE) -> windows_sys::core::HRESULT);
...
windows_link::link!("crypt32.dll" "system" fn CryptBinaryToStringA(pbbinary : *mut u8, cbbinary : u32, dwflags : CRYPT_STRING, pszstring : windows_sys::core::PCSTR, pcchstring : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptCreateKeyIdentifierFromCSP(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pszpubkeyoid : windows_sys::core::PCSTR, ppubkeystruc : *mut PUBLICKEYSTRUC, cbpubkeystruc : u32, dwflags : u32, pvreserved : *mut core::ffi::c_void, pbhash : *mut u8, pcbhash : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptDecryptMessage(pdecryptpara : *mut CRYPT_DECRYPT_MESSAGE_PARA, pbencryptedblob : *mut u8, cbencryptedblob : u32, pbdecrypted : *mut u8, pcbdecrypted : *mut u32, ppxchgcert : *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL);
...
windows_link::link!("advapi32.dll" "system" fn CryptDuplicateHash(hhash : usize, pdwreserved : *mut u32, dwflags : u32, phhash : *mut usize) -> windows_sys::core::BOOL);
windows_link::link!("advapi32.dll" "system" fn CryptDuplicateKey(hkey : usize, pdwreserved : *mut u32, dwflags : u32, phkey : *mut usize) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptEncodeObject(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, lpszstructtype : windows_sys::core::PCSTR, pvstructinfo : *mut core::ffi::c_void, pbencoded : *mut u8, pcbencoded : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptEncryptMessage(pencryptpara : *mut CRYPT_ENCRYPT_MESSAGE_PARA, crecipientcert : u32, rgprecipientcert : *mut *mut CERT_CONTEXT, pbtobeencrypted : *mut u8, cbtobeencrypted : u32, pbencryptedblob : *mut u8, pcbencryptedblob : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptEnumKeyIdentifierProperties(pkeyidentifier : *mut CRYPT_INTEGER_BLOB, dwpropid : u32, dwflags : u32, pwszcomputername : windows_sys::core::PCWSTR, pvreserved : *mut core::ffi::c_void, pvarg : *mut core::ffi::c_void, pfnenum : PFN_CRYPT_ENUM_KEYID_PROP) -> windows_sys::core::BOOL);
...
windows_link::link!("advapi32.dll" "system" fn CryptEnumProviderTypesA(dwindex : u32, pdwreserved : *mut u32, dwflags : u32, pdwprovtype : *mut u32, sztypename : windows_sys::core::PCSTR, pcbtypename : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("advapi32.dll" "system" fn CryptEnumProvidersA(dwindex : u32, pdwreserved : *mut u32, dwflags : u32, pdwprovtype : *mut u32, szprovname : windows_sys::core::PCSTR, pcbprovname : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("advapi32.dll" "system" fn CryptEnumProvidersW(dwindex : u32, pdwreserved : *mut u32, dwflags : u32, pdwprovtype : *mut u32, szprovname : windows_sys::core::PCWSTR, pcbprovname : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptExportPKCS8(hcryptprov : usize, dwkeyspec : u32, pszprivatekeyobjid : windows_sys::core::PCSTR, dwflags : u32, pvauxinfo : *mut core::ffi::c_void, pbprivatekeyblob : *mut u8, pcbprivatekeyblob : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptFindCertificateKeyProvInfo(pcert : *mut CERT_CONTEXT, dwflags : CRYPT_FIND_FLAGS, pvreserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptFindLocalizedName(pwszcryptname : windows_sys::core::PCWSTR) -> windows_sys::core::PWSTR);
windows_link::link!("crypt32.dll" "system" fn CryptFindOIDInfo(dwkeytype : u32, pvkey : *mut core::ffi::c_void, dwgroupid : u32) -> *mut CRYPT_OID_INFO);
windows_link::link!("crypt32.dll" "system" fn CryptFormatObject(dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, dwformattype : u32, dwformatstrtype : u32, pformatstruct : *mut core::ffi::c_void, lpszstructtype : windows_sys::core::PCSTR, pbencoded : *mut u8, cbencoded : u32, pbformat : *mut core::ffi::c_void, pcbformat : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptGetDefaultOIDDllList(hfuncset : *mut core::ffi::c_void, dwencodingtype : u32, pwszdlllist : windows_sys::core::PCWSTR, pcchdlllist : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("advapi32.dll" "system" fn CryptGetDefaultProviderA(dwprovtype : u32, pdwreserved : *mut u32, dwflags : u32, pszprovname : windows_sys::core::PCSTR, pcbprovname : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("advapi32.dll" "system" fn CryptGetDefaultProviderW(dwprovtype : u32, pdwreserved : *mut u32, dwflags : u32, pszprovname : windows_sys::core::PCWSTR, pcbprovname : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptGetKeyIdentifierProperty(pkeyidentifier : *mut CRYPT_INTEGER_BLOB, dwpropid : u32, dwflags : u32, pwszcomputername : windows_sys::core::PCWSTR, pvreserved : *mut core::ffi::c_void, pvdata : *mut core::ffi::c_void, pcbdata : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptGetMessageCertificates(dwmsgandcertencodingtype : u32, hcryptprov : HCRYPTPROV_LEGACY, dwflags : u32, pbsignedblob : *mut u8, cbsignedblob : u32) -> HCERTSTORE);
...
windows_link::link!("cryptnet.dll" "system" fn CryptGetObjectUrl(pszurloid : windows_sys::core::PCSTR, pvpara : *mut core::ffi::c_void, dwflags : CRYPT_GET_URL_FLAGS, purlarray : *mut CRYPT_URL_ARRAY, pcburlarray : *mut u32, purlinfo : *mut CRYPT_URL_INFO, pcburlinfo : *mut u32, pvreserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptHashCertificate(hcryptprov : HCRYPTPROV_LEGACY, algid : ALG_ID, dwflags : u32, pbencoded : *mut u8, cbencoded : u32, pbcomputedhash : *mut u8, pcbcomputedhash : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptHashCertificate2(pwszcnghashalgid : windows_sys::core::PCWSTR, dwflags : u32, pvreserved : *mut core::ffi::c_void, pbencoded : *mut u8, cbencoded : u32, pbcomputedhash : *mut u8, pcbcomputedhash : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("advapi32.dll" "system" fn CryptHashData(hhash : usize, pbdata : *mut u8, dwdatalen : u32, dwflags : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("advapi32.dll" "system" fn CryptImportKey(hprov : usize, pbdata : *mut u8, dwdatalen : u32, hpubkey : usize, dwflags : CRYPT_KEY_FLAGS, phkey : *mut usize) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptImportPublicKeyInfo(hcryptprov : usize, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pinfo : *mut CERT_PUBLIC_KEY_INFO, phkey : *mut usize) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptImportPublicKeyInfoEx(hcryptprov : usize, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pinfo : *mut CERT_PUBLIC_KEY_INFO, aikeyalg : ALG_ID, dwflags : u32, pvauxinfo : *mut core::ffi::c_void, phkey : *mut usize) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptInstallOIDFunctionAddress(hmodule : super::super::Foundation:: HMODULE, dwencodingtype : u32, pszfuncname : windows_sys::core::PCSTR, cfuncentry : u32, rgfuncentry : *mut CRYPT_OID_FUNC_ENTRY, dwflags : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptMsgCalculateEncodedLength(dwmsgencodingtype : u32, dwflags : u32, dwmsgtype : u32, pvmsgencodeinfo : *mut core::ffi::c_void, pszinnercontentobjid : windows_sys::core::PCSTR, cbdata : u32) -> u32);
windows_link::link!("crypt32.dll" "system" fn CryptMsgClose(hcryptmsg : *const core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptMsgControl(hcryptmsg : *mut core::ffi::c_void, dwflags : u32, dwctrltype : u32, pvctrlpara : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptMsgCountersign(hcryptmsg : *mut core::ffi::c_void, dwindex : u32, ccountersigners : u32, rgcountersigners : *mut CMSG_SIGNER_ENCODE_INFO) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptMsgEncodeAndSignCTL(dwmsgencodingtype : u32, pctlinfo : *mut CTL_INFO, psigninfo : *mut CMSG_SIGNED_ENCODE_INFO, dwflags : u32, pbencoded : *mut u8, pcbencoded : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptMsgGetAndVerifySigner(hcryptmsg : *mut core::ffi::c_void, csignerstore : u32, rghsignerstore : *mut HCERTSTORE, dwflags : u32, ppsigner : *mut *mut CERT_CONTEXT, pdwsignerindex : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptMsgOpenToDecode(dwmsgencodingtype : u32, dwflags : u32, dwmsgtype : u32, hcryptprov : HCRYPTPROV_LEGACY, precipientinfo : *mut CERT_INFO, pstreaminfo : *mut CMSG_STREAM_INFO) -> *mut core::ffi::c_void);
windows_link::link!("crypt32.dll" "system" fn CryptMsgOpenToEncode(dwmsgencodingtype : u32, dwflags : u32, dwmsgtype : CRYPT_MSG_TYPE, pvmsgencodeinfo : *mut core::ffi::c_void, pszinnercontentobjid : windows_sys::core::PCSTR, pstreaminfo : *mut CMSG_STREAM_INFO) -> *mut core::ffi::c_void);
windows_link::link!("crypt32.dll" "system" fn CryptMsgSignCTL(dwmsgencodingtype : u32, pbctlcontent : *mut u8, cbctlcontent : u32, psigninfo : *mut CMSG_SIGNED_ENCODE_INFO, dwflags : u32, pbencoded : *mut u8, pcbencoded : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptMsgUpdate(hcryptmsg : *mut core::ffi::c_void, pbdata : *mut u8, cbdata : u32, ffinal : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptMsgVerifyCountersignatureEncoded(hcryptprov : HCRYPTPROV_LEGACY, dwencodingtype : u32, pbsignerinfo : *mut u8, cbsignerinfo : u32, pbsignerinfocountersignature : *mut u8, cbsignerinfocountersignature : u32, pcicountersigner : *mut CERT_INFO) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptMsgVerifyCountersignatureEncodedEx(hcryptprov : HCRYPTPROV_LEGACY, dwencodingtype : u32, pbsignerinfo : *mut u8, cbsignerinfo : u32, pbsignerinfocountersignature : *mut u8, cbsignerinfocountersignature : u32, dwsignertype : u32, pvsigner : *mut core::ffi::c_void, dwflags : u32, pvextra : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptProtectData(pdatain : *mut CRYPT_INTEGER_BLOB, szdatadescr : windows_sys::core::PCWSTR, poptionalentropy : *mut CRYPT_INTEGER_BLOB, pvreserved : *mut core::ffi::c_void, ppromptstruct : *mut CRYPTPROTECT_PROMPTSTRUCT, dwflags : u32, pdataout : *mut CRYPT_INTEGER_BLOB) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptRetrieveTimeStamp(wszurl : windows_sys::core::PCWSTR, dwretrievalflags : u32, dwtimeout : u32, pszhashid : windows_sys::core::PCSTR, ppara : *mut CRYPT_TIMESTAMP_PARA, pbdata : *mut u8, cbdata : u32, pptscontext : *mut *mut CRYPT_TIMESTAMP_CONTEXT, pptssigner : *mut *mut CERT_CONTEXT, phstore : *mut HCERTSTORE) -> windows_sys::core::BOOL);
...
windows_link::link!("advapi32.dll" "system" fn CryptSetHashParam(hhash : usize, dwparam : CRYPT_SET_HASH_PARAM, pbdata : *mut u8, dwflags : u32) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptSetKeyIdentifierProperty(pkeyidentifier : *mut CRYPT_INTEGER_BLOB, dwpropid : u32, dwflags : u32, pwszcomputername : windows_sys::core::PCWSTR, pvreserved : *mut core::ffi::c_void, pvdata : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("advapi32.dll" "system" fn CryptSetKeyParam(hkey : usize, dwparam : CRYPT_KEY_PARAM_ID, pbdata : *mut u8, dwflags : u32) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_System_Registry")]
windows_link::link!("crypt32.dll" "system" fn CryptSetOIDFunctionValue(dwencodingtype : u32, pszfuncname : windows_sys::core::PCSTR, pszoid : windows_sys::core::PCSTR, pwszvaluename : windows_sys::core::PCWSTR, dwvaluetype : super::super::System::Registry:: REG_VALUE_TYPE, pbvaluedata : *mut u8, cbvaluedata : u32) -> windows_sys::core::BOOL);
windows_link::link!("advapi32.dll" "system" fn CryptSetProvParam(hprov : usize, dwparam : CRYPT_SET_PROV_PARAM_ID, pbdata : *mut u8, dwflags : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptSignAndEncodeCertificate(hcryptprovorncryptkey : HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, dwkeyspec : CERT_KEY_SPEC, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, lpszstructtype : windows_sys::core::PCSTR, pvstructinfo : *mut core::ffi::c_void, psignaturealgorithm : *mut CRYPT_ALGORITHM_IDENTIFIER, pvhashauxinfo : *mut core::ffi::c_void, pbencoded : *mut u8, pcbencoded : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptSignAndEncryptMessage(psignpara : *mut CRYPT_SIGN_MESSAGE_PARA, pencryptpara : *mut CRYPT_ENCRYPT_MESSAGE_PARA, crecipientcert : u32, rgprecipientcert : *mut *mut CERT_CONTEXT, pbtobesignedandencrypted : *mut u8, cbtobesignedandencrypted : u32, pbsignedandencryptedblob : *mut u8, pcbsignedandencryptedblob : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptSignMessage(psignpara : *mut CRYPT_SIGN_MESSAGE_PARA, fdetachedsignature : windows_sys::core::BOOL, ctobesigned : u32, rgpbtobesigned : *mut *mut u8, rgcbtobesigned : *mut u32, pbsignedblob : *mut u8, pcbsignedblob : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptUninstallDefaultContext(hdefaultcontext : *mut core::ffi::c_void, dwflags : u32, pvreserved : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptUnprotectData(pdatain : *mut CRYPT_INTEGER_BLOB, ppszdatadescr : *mut windows_sys::core::PWSTR, poptionalentropy : *mut CRYPT_INTEGER_BLOB, pvreserved : *mut core::ffi::c_void, ppromptstruct : *mut CRYPTPROTECT_PROMPTSTRUCT, dwflags : u32, pdataout : *mut CRYPT_INTEGER_BLOB) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptUnregisterOIDInfo(pinfo : *mut CRYPT_OID_INFO) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptVerifyCertificateSignature(hcryptprov : HCRYPTPROV_LEGACY, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, pbencoded : *mut u8, cbencoded : u32, ppublickey : *mut CERT_PUBLIC_KEY_INFO) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptVerifyCertificateSignatureEx(hcryptprov : HCRYPTPROV_LEGACY, dwcertencodingtype : CERT_QUERY_ENCODING_TYPE, dwsubjecttype : u32, pvsubject : *mut core::ffi::c_void, dwissuertype : u32, pvissuer : *mut core::ffi::c_void, dwflags : CRYPT_VERIFY_CERT_FLAGS, pvextra : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptVerifyDetachedMessageHash(phashpara : *mut CRYPT_HASH_MESSAGE_PARA, pbdetachedhashblob : *mut u8, cbdetachedhashblob : u32, ctobehashed : u32, rgpbtobehashed : *mut *mut u8, rgcbtobehashed : *mut u32, pbcomputedhash : *mut u8, pcbcomputedhash : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptVerifyDetachedMessageSignature(pverifypara : *mut CRYPT_VERIFY_MESSAGE_PARA, dwsignerindex : u32, pbdetachedsignblob : *mut u8, cbdetachedsignblob : u32, ctobesigned : u32, rgpbtobesigned : *mut *mut u8, rgcbtobesigned : *mut u32, ppsignercert : *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL);
...
windows_link::link!("crypt32.dll" "system" fn CryptVerifyMessageSignature(pverifypara : *mut CRYPT_VERIFY_MESSAGE_PARA, dwsignerindex : u32, pbsignedblob : *mut u8, cbsignedblob : u32, pbdecoded : *mut u8, pcbdecoded : *mut u32, ppsignercert : *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptVerifyMessageSignatureWithKey(pverifypara : *mut CRYPT_KEY_VERIFY_MESSAGE_PARA, ppublickeyinfo : *mut CERT_PUBLIC_KEY_INFO, pbsignedblob : *mut u8, cbsignedblob : u32, pbdecoded : *mut u8, pcbdecoded : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("advapi32.dll" "system" fn CryptVerifySignatureA(hhash : usize, pbsignature : *mut u8, dwsiglen : u32, hpubkey : usize, szdescription : windows_sys::core::PCSTR, dwflags : u32) -> windows_sys::core::BOOL);
windows_link::link!("advapi32.dll" "system" fn CryptVerifySignatureW(hhash : usize, pbsignature : *mut u8, dwsiglen : u32, hpubkey : usize, szdescription : windows_sys::core::PCWSTR, dwflags : u32) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn CryptVerifyTimeStampSignature(pbtscontentinfo : *mut u8, cbtscontentinfo : u32, pbdata : *mut u8, cbdata : u32, hadditionalstore : HCERTSTORE, pptscontext : *mut *mut CRYPT_TIMESTAMP_CONTEXT, pptssigner : *mut *mut CERT_CONTEXT, phstore : *mut HCERTSTORE) -> windows_sys::core::BOOL);
...
windows_link::link!("cryptxml.dll" "system" fn CryptXmlClose(hcryptxml : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("cryptxml.dll" "system" fn CryptXmlCreateReference(hcryptxml : *mut core::ffi::c_void, dwflags : u32, wszid : windows_sys::core::PCWSTR, wszuri : windows_sys::core::PCWSTR, wsztype : windows_sys::core::PCWSTR, pdigestmethod : *mut CRYPT_XML_ALGORITHM, ctransform : u32, rgtransform : *mut CRYPT_XML_ALGORITHM, phreference : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("cryptxml.dll" "system" fn CryptXmlDigestReference(hreference : *mut core::ffi::c_void, dwflags : u32, pdataproviderin : *mut CRYPT_XML_DATA_PROVIDER) -> windows_sys::core::HRESULT);
windows_link::link!("cryptxml.dll" "system" fn CryptXmlEncode(hcryptxml : *mut core::ffi::c_void, dwcharset : CRYPT_XML_CHARSET, rgproperty : *mut CRYPT_XML_PROPERTY, cproperty : u32, pvcallbackstate : *mut core::ffi::c_void, pfnwrite : PFN_CRYPT_XML_WRITE_CALLBACK) -> windows_sys::core::HRESULT);
...
windows_link::link!("cryptxml.dll" "system" fn CryptXmlGetAlgorithmInfo(pxmlalgorithm : *mut CRYPT_XML_ALGORITHM, dwflags : CRYPT_XML_FLAGS, ppalginfo : *mut *mut CRYPT_XML_ALGORITHM_INFO) -> windows_sys::core::HRESULT);
windows_link::link!("cryptxml.dll" "system" fn CryptXmlGetDocContext(hcryptxml : *mut core::ffi::c_void, ppstruct : *mut *mut CRYPT_XML_DOC_CTXT) -> windows_sys::core::HRESULT);
windows_link::link!("cryptxml.dll" "system" fn CryptXmlGetReference(hcryptxml : *mut core::ffi::c_void, ppstruct : *mut *mut CRYPT_XML_REFERENCE) -> windows_sys::core::HRESULT);
windows_link::link!("cryptxml.dll" "system" fn CryptXmlGetSignature(hcryptxml : *mut core::ffi::c_void, ppstruct : *mut *mut CRYPT_XML_SIGNATURE) -> windows_sys::core::HRESULT);
windows_link::link!("cryptxml.dll" "system" fn CryptXmlGetStatus(hcryptxml : *mut core::ffi::c_void, pstatus : *mut CRYPT_XML_STATUS) -> windows_sys::core::HRESULT);
...
windows_link::link!("cryptxml.dll" "system" fn CryptXmlImportPublicKey(dwflags : CRYPT_XML_FLAGS, pkeyvalue : *mut CRYPT_XML_KEY_VALUE, phkey : *mut BCRYPT_KEY_HANDLE) -> windows_sys::core::HRESULT);
windows_link::link!("cryptxml.dll" "system" fn CryptXmlOpenToDecode(pconfig : *mut CRYPT_XML_TRANSFORM_CHAIN_CONFIG, dwflags : CRYPT_XML_FLAGS, rgproperty : *mut CRYPT_XML_PROPERTY, cproperty : u32, pencoded : *mut CRYPT_XML_BLOB, phcryptxml : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("cryptxml.dll" "system" fn CryptXmlOpenToEncode(pconfig : *mut CRYPT_XML_TRANSFORM_CHAIN_CONFIG, dwflags : CRYPT_XML_FLAGS, wszid : windows_sys::core::PCWSTR, rgproperty : *mut CRYPT_XML_PROPERTY, cproperty : u32, pencoded : *mut CRYPT_XML_BLOB, phsignature : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("cryptxml.dll" "system" fn CryptXmlSetHMACSecret(hsignature : *mut core::ffi::c_void, pbsecret : *mut u8, cbsecret : u32) -> windows_sys::core::HRESULT);
windows_link::link!("cryptxml.dll" "system" fn CryptXmlSign(hsignature : *mut core::ffi::c_void, hkey : HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, dwkeyspec : CERT_KEY_SPEC, dwflags : CRYPT_XML_FLAGS, dwkeyinfospec : CRYPT_XML_KEYINFO_SPEC, pvkeyinfospec : *mut core::ffi::c_void, psignaturemethod : *mut CRYPT_XML_ALGORITHM, pcanonicalization : *mut CRYPT_XML_ALGORITHM) -> windows_sys::core::HRESULT);
...
windows_link::link!("infocardapi.dll" "system" fn Encrypt(hcrypto : *mut INFORMATIONCARD_CRYPTO_HANDLE, foaep : windows_sys::core::BOOL, cbindata : u32, pindata : *mut u8, pcboutdata : *mut u32, ppoutdata : *mut *mut u8) -> windows_sys::core::HRESULT);
windows_link::link!("wintrust.dll" "system" fn FindCertsByIssuer(pcertchains : *mut CERT_CHAIN, pcbcertchains : *mut u32, pccertchains : *mut u32, pbencodedissuername : *mut u8, cbencodedissuername : u32, pwszpurpose : windows_sys::core::PCWSTR, dwkeyspec : u32) -> windows_sys::core::HRESULT);
windows_link::link!("infocardapi.dll" "system" fn FreeToken(pallocmemory : *mut GENERIC_XML_TOKEN) -> windows_sys::core::BOOL);
windows_link::link!("infocardapi.dll" "system" fn GenerateDerivedKey(hcrypto : *mut INFORMATIONCARD_CRYPTO_HANDLE, cblabel : u32, plabel : *mut u8, cbnonce : u32, pnonce : *mut u8, derivedkeylength : u32, offset : u32, algid : windows_sys::core::PCWSTR, pcbkey : *mut u32, ppkey : *mut *mut u8) -> windows_sys::core::HRESULT);
...
windows_link::link!("infocardapi.dll" "system" fn GetBrowserToken(dwparamtype : u32, pparam : *mut core::ffi::c_void, pcbtoken : *mut u32, pptoken : *mut *mut u8) -> windows_sys::core::HRESULT);
...
windows_link::link!("infocardapi.dll" "system" fn GetCryptoTransform(hsymmetriccrypto : *mut INFORMATIONCARD_CRYPTO_HANDLE, mode : u32, padding : PaddingMode, feedbacksize : u32, direction : Direction, cbiv : u32, piv : *mut u8, pphtransform : *mut *mut INFORMATIONCARD_CRYPTO_HANDLE) -> windows_sys::core::HRESULT);
...
windows_link::link!("infocardapi.dll" "system" fn GetKeyedHash(hsymmetriccrypto : *mut INFORMATIONCARD_CRYPTO_HANDLE, pphhash : *mut *mut INFORMATIONCARD_CRYPTO_HANDLE) -> windows_sys::core::HRESULT);
...
windows_link::link!("infocardapi.dll" "system" fn GetToken(cpolicychain : u32, ppolicychain : *mut POLICY_ELEMENT, securitytoken : *mut *mut GENERIC_XML_TOKEN, phprooftokencrypto : *mut *mut INFORMATIONCARD_CRYPTO_HANDLE) -> windows_sys::core::HRESULT);
windows_link::link!("infocardapi.dll" "system" fn HashCore(hcrypto : *mut INFORMATIONCARD_CRYPTO_HANDLE, cbindata : u32, pindata : *mut u8) -> windows_sys::core::HRESULT);
windows_link::link!("infocardapi.dll" "system" fn HashFinal(hcrypto : *mut INFORMATIONCARD_CRYPTO_HANDLE, cbindata : u32, pindata : *mut u8, pcboutdata : *mut u32, ppoutdata : *mut *mut u8) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn NCryptCreateClaim(hsubjectkey : NCRYPT_KEY_HANDLE, hauthoritykey : NCRYPT_KEY_HANDLE, dwclaimtype : u32, pparameterlist : *mut BCryptBufferDesc, pbclaimblob : *mut u8, cbclaimblob : u32, pcbresult : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn NCryptDecrypt(hkey : NCRYPT_KEY_HANDLE, pbinput : *mut u8, cbinput : u32, ppaddinginfo : *mut core::ffi::c_void, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
windows_link::link!("ncrypt.dll" "system" fn NCryptDeleteKey(hkey : NCRYPT_KEY_HANDLE, dwflags : u32) -> windows_sys::core::HRESULT);
windows_link::link!("ncrypt.dll" "system" fn NCryptDeriveKey(hsharedsecret : NCRYPT_SECRET_HANDLE, pwszkdf : windows_sys::core::PCWSTR, pparameterlist : *mut BCryptBufferDesc, pbderivedkey : *mut u8, cbderivedkey : u32, pcbresult : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
windows_link::link!("ncrypt.dll" "system" fn NCryptEncrypt(hkey : NCRYPT_KEY_HANDLE, pbinput : *mut u8, cbinput : u32, ppaddinginfo : *mut core::ffi::c_void, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn NCryptExportKey(hkey : NCRYPT_KEY_HANDLE, hexportkey : NCRYPT_KEY_HANDLE, pszblobtype : windows_sys::core::PCWSTR, pparameterlist : *mut BCryptBufferDesc, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn NCryptGetProtectionDescriptorInfo(hdescriptor : super:: NCRYPT_DESCRIPTOR_HANDLE, pmempara : *mut NCRYPT_ALLOC_PARA, dwinfotype : u32, ppvinfo : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("ncrypt.dll" "system" fn NCryptImportKey(hprovider : NCRYPT_PROV_HANDLE, himportkey : NCRYPT_KEY_HANDLE, pszblobtype : windows_sys::core::PCWSTR, pparameterlist : *mut BCryptBufferDesc, phkey : *mut NCRYPT_KEY_HANDLE, pbdata : *mut u8, cbdata : u32, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn NCryptProtectSecret(hdescriptor : super:: NCRYPT_DESCRIPTOR_HANDLE, dwflags : u32, pbdata : *mut u8, cbdata : u32, pmempara : *mut NCRYPT_ALLOC_PARA, hwnd : super::super::Foundation:: HWND, ppbprotectedblob : *mut *mut u8, pcbprotectedblob : *mut u32) -> windows_sys::core::HRESULT);
windows_link::link!("ncrypt.dll" "system" fn NCryptQueryProtectionDescriptorName(pwszname : windows_sys::core::PCWSTR, pwszdescriptorstring : windows_sys::core::PCWSTR, pcdescriptorstring : *mut usize, dwflags : u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn NCryptSetProperty(hobject : NCRYPT_HANDLE, pszproperty : windows_sys::core::PCWSTR, pbinput : *mut u8, cbinput : u32, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
windows_link::link!("ncrypt.dll" "system" fn NCryptSignHash(hkey : NCRYPT_KEY_HANDLE, ppaddinginfo : *mut core::ffi::c_void, pbhashvalue : *mut u8, cbhashvalue : u32, pbsignature : *mut u8, cbsignature : u32, pcbresult : *mut u32, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn NCryptStreamOpenToUnprotect(pstreaminfo : *mut NCRYPT_PROTECT_STREAM_INFO, dwflags : u32, hwnd : super::super::Foundation:: HWND, phstream : *mut super:: NCRYPT_STREAM_HANDLE) -> windows_sys::core::HRESULT);
windows_link::link!("ncrypt.dll" "system" fn NCryptStreamOpenToUnprotectEx(pstreaminfo : *mut NCRYPT_PROTECT_STREAM_INFO_EX, dwflags : u32, hwnd : super::super::Foundation:: HWND, phstream : *mut super:: NCRYPT_STREAM_HANDLE) -> windows_sys::core::HRESULT);
windows_link::link!("ncrypt.dll" "system" fn NCryptStreamUpdate(hstream : super:: NCRYPT_STREAM_HANDLE, pbdata : *mut u8, cbdata : usize, ffinal : windows_sys::core::BOOL) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn NCryptVerifyClaim(hsubjectkey : NCRYPT_KEY_HANDLE, hauthoritykey : NCRYPT_KEY_HANDLE, dwclaimtype : u32, pparameterlist : *mut BCryptBufferDesc, pbclaimblob : *mut u8, cbclaimblob : u32, poutput : *mut BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
windows_link::link!("ncrypt.dll" "system" fn NCryptVerifySignature(hkey : NCRYPT_KEY_HANDLE, ppaddinginfo : *mut core::ffi::c_void, pbhashvalue : *mut u8, cbhashvalue : u32, pbsignature : *mut u8, cbsignature : u32, dwflags : NCRYPT_FLAGS) -> windows_sys::core::HRESULT);
...
windows_link::link!("crypt32.dll" "system" fn PFXExportCertStoreEx(hstore : HCERTSTORE, ppfx : *mut CRYPT_INTEGER_BLOB, szpassword : windows_sys::core::PCWSTR, pvpara : *mut core::ffi::c_void, dwflags : u32) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn PFXImportCertStore(ppfx : *mut CRYPT_INTEGER_BLOB, szpassword : windows_sys::core::PCWSTR, dwflags : CRYPT_KEY_FLAGS) -> HCERTSTORE);
windows_link::link!("crypt32.dll" "system" fn PFXIsPFXBlob(ppfx : *mut CRYPT_INTEGER_BLOB) -> windows_sys::core::BOOL);
windows_link::link!("crypt32.dll" "system" fn PFXVerifyPassword(ppfx : *mut CRYPT_INTEGER_BLOB, szpassword : windows_sys::core::PCWSTR, dwflags : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("infocardapi.dll" "system" fn SignHash(hcrypto : *mut INFORMATIONCARD_CRYPTO_HANDLE, cbhash : u32, phash : *mut u8, hashalgoid : windows_sys::core::PCWSTR, pcbsig : *mut u32, ppsig : *mut *mut u8) -> windows_sys::core::HRESULT);
windows_link::link!("mssign32.dll" "system" fn SignerFreeSignerContext(psignercontext : *mut SIGNER_CONTEXT) -> windows_sys::core::HRESULT);
...
windows_link::link!("mssign32.dll" "system" fn SignerSignEx(dwflags : SIGNER_SIGN_FLAGS, psubjectinfo : *mut SIGNER_SUBJECT_INFO, psignercert : *mut SIGNER_CERT, psignatureinfo : *mut SIGNER_SIGNATURE_INFO, pproviderinfo : *mut SIGNER_PROVIDER_INFO, pwszhttptimestamp : windows_sys::core::PCWSTR, psrequest : *mut CRYPT_ATTRIBUTES, psipdata : *mut core::ffi::c_void, ppsignercontext : *mut *mut SIGNER_CONTEXT) -> windows_sys::core::HRESULT);
...
windows_link::link!("mssign32.dll" "system" fn SignerSignEx3(dwflags : SIGNER_SIGN_FLAGS, psubjectinfo : *mut SIGNER_SUBJECT_INFO, psignercert : *mut SIGNER_CERT, psignatureinfo : *mut SIGNER_SIGNATURE_INFO, pproviderinfo : *mut SIGNER_PROVIDER_INFO, dwtimestampflags : SIGNER_TIMESTAMP_FLAGS, psztimestampalgorithmoid : windows_sys::core::PCSTR, pwszhttptimestamp : windows_sys::core::PCWSTR, psrequest : *mut CRYPT_ATTRIBUTES, psipdata : *mut core::ffi::c_void, ppsignercontext : *mut *mut SIGNER_CONTEXT, pcryptopolicy : *mut CERT_STRONG_SIGN_PARA, pdigestsigninfo : *mut SIGNER_DIGEST_SIGN_INFO, preserved : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("mssign32.dll" "system" fn SignerTimeStampEx2(dwflags : SIGNER_TIMESTAMP_FLAGS, psubjectinfo : *mut SIGNER_SUBJECT_INFO, pwszhttptimestamp : windows_sys::core::PCWSTR, dwalgid : ALG_ID, psrequest : *mut CRYPT_ATTRIBUTES, psipdata : *mut core::ffi::c_void, ppsignercontext : *mut *mut SIGNER_CONTEXT) -> windows_sys::core::HRESULT);
windows_link::link!("mssign32.dll" "system" fn SignerTimeStampEx3(dwflags : SIGNER_TIMESTAMP_FLAGS, dwindex : u32, psubjectinfo : *mut SIGNER_SUBJECT_INFO, pwszhttptimestamp : windows_sys::core::PCWSTR, pszalgorithmoid : windows_sys::core::PCWSTR, psrequest : *mut CRYPT_ATTRIBUTES, psipdata : *mut core::ffi::c_void, ppsignercontext : *mut *mut SIGNER_CONTEXT, pcryptopolicy : *mut CERT_STRONG_SIGN_PARA, preserved : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn SslCreateEphemeralKey(hsslprovider : NCRYPT_PROV_HANDLE, phephemeralkey : *mut NCRYPT_KEY_HANDLE, dwprotocol : u32, dwciphersuite : u32, dwkeytype : u32, dwkeybitlen : u32, pbparams : *mut u8, cbparams : u32, dwflags : u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn SslEncryptPacket(hsslprovider : NCRYPT_PROV_HANDLE, hkey : NCRYPT_KEY_HANDLE, pbinput : *mut u8, cbinput : u32, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, sequencenumber : u64, dwcontenttype : u32, dwflags : u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn SslExpandExporterMasterKey(hsslprovider : NCRYPT_PROV_HANDLE, hbasekey : NCRYPT_KEY_HANDLE, hhashvalue : NCRYPT_HASH_HANDLE, phexportermasterkey : *mut NCRYPT_KEY_HANDLE, pparameterlist : *mut BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
windows_link::link!("ncrypt.dll" "system" fn SslExpandPreSharedKey(hsslprovider : NCRYPT_PROV_HANDLE, hresumptionmasterkey : NCRYPT_KEY_HANDLE, pbticketnonce : *mut u8, cbticketnonce : u32, phpresharedkey : *mut NCRYPT_KEY_HANDLE, pparameterlist : *mut BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
windows_link::link!("ncrypt.dll" "system" fn SslExpandResumptionMasterKey(hsslprovider : NCRYPT_PROV_HANDLE, hmasterkey : NCRYPT_KEY_HANDLE, hhashvalue : NCRYPT_HASH_HANDLE, phresumptionmasterkey : *mut NCRYPT_KEY_HANDLE, pparameterlist : *mut BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
windows_link::link!("ncrypt.dll" "system" fn SslExpandTrafficKeys(hsslprovider : NCRYPT_PROV_HANDLE, hbasekey : NCRYPT_KEY_HANDLE, hhashvalue : NCRYPT_HASH_HANDLE, phclienttraffickey : *mut NCRYPT_KEY_HANDLE, phservertraffickey : *mut NCRYPT_KEY_HANDLE, pparameterlist : *mut BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn SslExtractEarlyKey(hsslprovider : NCRYPT_PROV_HANDLE, hpresharedkey : NCRYPT_KEY_HANDLE, phearlykey : *mut NCRYPT_KEY_HANDLE, dwprotocol : u32, dwciphersuite : u32, pparameterlist : *mut BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn SslExtractMasterKey(hsslprovider : NCRYPT_PROV_HANDLE, hhandshakekey : NCRYPT_KEY_HANDLE, phmasterkey : *mut NCRYPT_KEY_HANDLE, pparameterlist : *mut BCryptBufferDesc, dwflags : u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn SslGenerateMasterKey(hsslprovider : NCRYPT_PROV_HANDLE, hprivatekey : NCRYPT_KEY_HANDLE, hpublickey : NCRYPT_KEY_HANDLE, phmasterkey : *mut NCRYPT_KEY_HANDLE, dwprotocol : u32, dwciphersuite : u32, pparameterlist : *mut BCryptBufferDesc, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
windows_link::link!("ncrypt.dll" "system" fn SslGeneratePreMasterKey(hsslprovider : NCRYPT_PROV_HANDLE, hpublickey : NCRYPT_KEY_HANDLE, phpremasterkey : *mut NCRYPT_KEY_HANDLE, dwprotocol : u32, dwciphersuite : u32, pparameterlist : *mut BCryptBufferDesc, pboutput : *mut u8, cboutput : u32, pcbresult : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn SslGetCipherSuitePRFHashAlgorithm(hsslprovider : NCRYPT_PROV_HANDLE, dwprotocol : u32, dwciphersuite : u32, dwkeytype : u32, szprfhash : windows_sys::core::PCWSTR, dwflags : u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn SslImportMasterKey(hsslprovider : NCRYPT_PROV_HANDLE, hprivatekey : NCRYPT_KEY_HANDLE, phmasterkey : *mut NCRYPT_KEY_HANDLE, dwprotocol : u32, dwciphersuite : u32, pparameterlist : *mut BCryptBufferDesc, pbencryptedkey : *mut u8, cbencryptedkey : u32, dwflags : u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn SslOpenPrivateKey(hsslprovider : NCRYPT_PROV_HANDLE, phprivatekey : *mut NCRYPT_KEY_HANDLE, pcertcontext : *mut CERT_CONTEXT, dwflags : u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("ncrypt.dll" "system" fn SslSignHash(hsslprovider : NCRYPT_PROV_HANDLE, hprivatekey : NCRYPT_KEY_HANDLE, pbhashvalue : *mut u8, cbhashvalue : u32, pbsignature : *mut u8, cbsignature : u32, pcbresult : *mut u32, dwflags : u32) -> windows_sys::core::HRESULT);
windows_link::link!("ncrypt.dll" "system" fn SslVerifySignature(hsslprovider : NCRYPT_PROV_HANDLE, hpublickey : NCRYPT_KEY_HANDLE, pbhashvalue : *mut u8, cbhashvalue : u32, pbsignature : *mut u8, cbsignature : u32, dwflags : u32) -> windows_sys::core::HRESULT);
windows_link::link!("bcryptprimitives.dll" "system" fn SystemPrng(pbrandomdata : *mut u8, cbrandomdata : usize) -> windows_sys::core::BOOL);
windows_link::link!("infocardapi.dll" "system" fn TransformBlock(hcrypto : *mut INFORMATIONCARD_CRYPTO_HANDLE, cbindata : u32, pindata : *mut u8, pcboutdata : *mut u32, ppoutdata : *mut *mut u8) -> windows_sys::core::HRESULT);
...
pub const BCRYPT_3DES_112_CBC_ALG_HANDLE: BCRYPT_ALG_HANDLE = 369i64 as _;
pub const BCRYPT_3DES_112_CFB_ALG_HANDLE: BCRYPT_ALG_HANDLE = 401i64 as _;
pub const BCRYPT_3DES_112_ECB_ALG_HANDLE: BCRYPT_ALG_HANDLE = 385i64 as _;
pub const BCRYPT_3DES_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("3DES");
pub const BCRYPT_3DES_CBC_ALG_HANDLE: BCRYPT_ALG_HANDLE = 321i64 as _;
pub const BCRYPT_3DES_CFB_ALG_HANDLE: BCRYPT_ALG_HANDLE = 353i64 as _;
pub const BCRYPT_3DES_ECB_ALG_HANDLE: BCRYPT_ALG_HANDLE = 337i64 as _;
pub const BCRYPT_AES_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("AES");
pub const BCRYPT_AES_CBC_ALG_HANDLE: BCRYPT_ALG_HANDLE = 417i64 as _;
pub const BCRYPT_AES_CCM_ALG_HANDLE: BCRYPT_ALG_HANDLE = 465i64 as _;
pub const BCRYPT_AES_CFB_ALG_HANDLE: BCRYPT_ALG_HANDLE = 449i64 as _;
pub const BCRYPT_AES_CMAC_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("AES-CMAC");
pub const BCRYPT_AES_CMAC_ALG_HANDLE: BCRYPT_ALG_HANDLE = 257i64 as _;
pub const BCRYPT_AES_ECB_ALG_HANDLE: BCRYPT_ALG_HANDLE = 433i64 as _;
pub const BCRYPT_AES_GCM_ALG_HANDLE: BCRYPT_ALG_HANDLE = 481i64 as _;
pub const BCRYPT_AES_GMAC_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("AES-GMAC");
pub const BCRYPT_AES_GMAC_ALG_HANDLE: BCRYPT_ALG_HANDLE = 273i64 as _;
...
pub const BCRYPT_CAPI_KDF_ALG_HANDLE: BCRYPT_ALG_HANDLE = 801i64 as _;
pub const BCRYPT_CHACHA20_POLY1305_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("CHACHA20_POLY1305");
pub const BCRYPT_CHACHA20_POLY1305_ALG_HANDLE: BCRYPT_ALG_HANDLE = 929i64 as _;
...
pub const BCRYPT_DESX_CBC_ALG_HANDLE: BCRYPT_ALG_HANDLE = 545i64 as _;
pub const BCRYPT_DESX_CFB_ALG_HANDLE: BCRYPT_ALG_HANDLE = 577i64 as _;
pub const BCRYPT_DESX_ECB_ALG_HANDLE: BCRYPT_ALG_HANDLE = 561i64 as _;
pub const BCRYPT_DES_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("DES");
pub const BCRYPT_DES_CBC_ALG_HANDLE: BCRYPT_ALG_HANDLE = 497i64 as _;
pub const BCRYPT_DES_CFB_ALG_HANDLE: BCRYPT_ALG_HANDLE = 529i64 as _;
pub const BCRYPT_DES_ECB_ALG_HANDLE: BCRYPT_ALG_HANDLE = 513i64 as _;
pub const BCRYPT_DH_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("DH");
pub const BCRYPT_DH_ALG_HANDLE: BCRYPT_ALG_HANDLE = 641i64 as _;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const BCRYPT_DSA_ALG_HANDLE: BCRYPT_ALG_HANDLE = 721i64 as _;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const BCRYPT_HKDF_ALG_HANDLE: BCRYPT_ALG_HANDLE = 913i64 as _;
...
pub const BCRYPT_HMAC_MD2_ALG_HANDLE: BCRYPT_ALG_HANDLE = 289i64 as _;
pub const BCRYPT_HMAC_MD4_ALG_HANDLE: BCRYPT_ALG_HANDLE = 305i64 as _;
pub const BCRYPT_HMAC_MD5_ALG_HANDLE: BCRYPT_ALG_HANDLE = 145i64 as _;
pub const BCRYPT_HMAC_SHA1_ALG_HANDLE: BCRYPT_ALG_HANDLE = 161i64 as _;
pub const BCRYPT_HMAC_SHA256_ALG_HANDLE: BCRYPT_ALG_HANDLE = 177i64 as _;
pub const BCRYPT_HMAC_SHA384_ALG_HANDLE: BCRYPT_ALG_HANDLE = 193i64 as _;
pub const BCRYPT_HMAC_SHA512_ALG_HANDLE: BCRYPT_ALG_HANDLE = 209i64 as _;
...
pub const BCRYPT_MD2_ALG_HANDLE: BCRYPT_ALG_HANDLE = 1i64 as _;
pub const BCRYPT_MD4_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("MD4");
pub const BCRYPT_MD4_ALG_HANDLE: BCRYPT_ALG_HANDLE = 17i64 as _;
pub const BCRYPT_MD5_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("MD5");
pub const BCRYPT_MD5_ALG_HANDLE: BCRYPT_ALG_HANDLE = 33i64 as _;
...
pub const BCRYPT_PBKDF2_ALG_HANDLE: BCRYPT_ALG_HANDLE = 817i64 as _;
...
pub const BCRYPT_RC2_CBC_ALG_HANDLE: BCRYPT_ALG_HANDLE = 593i64 as _;
pub const BCRYPT_RC2_CFB_ALG_HANDLE: BCRYPT_ALG_HANDLE = 625i64 as _;
pub const BCRYPT_RC2_ECB_ALG_HANDLE: BCRYPT_ALG_HANDLE = 609i64 as _;
pub const BCRYPT_RC4_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("RC4");
pub const BCRYPT_RC4_ALG_HANDLE: BCRYPT_ALG_HANDLE = 113i64 as _;
pub type BCRYPT_RESOLVE_PROVIDERS_FLAGS = u32;
pub const BCRYPT_RNG_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("RNG");
pub const BCRYPT_RNG_ALG_HANDLE: BCRYPT_ALG_HANDLE = 129i64 as _;
...
pub const BCRYPT_RSA_ALG_HANDLE: BCRYPT_ALG_HANDLE = 225i64 as _;
pub const BCRYPT_RSA_SIGN_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("RSA_SIGN");
pub const BCRYPT_RSA_SIGN_ALG_HANDLE: BCRYPT_ALG_HANDLE = 785i64 as _;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const BCRYPT_SHA1_ALG_HANDLE: BCRYPT_ALG_HANDLE = 49i64 as _;
pub const BCRYPT_SHA256_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("SHA256");
pub const BCRYPT_SHA256_ALG_HANDLE: BCRYPT_ALG_HANDLE = 65i64 as _;
pub const BCRYPT_SHA384_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("SHA384");
pub const BCRYPT_SHA384_ALG_HANDLE: BCRYPT_ALG_HANDLE = 81i64 as _;
pub const BCRYPT_SHA512_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("SHA512");
pub const BCRYPT_SHA512_ALG_HANDLE: BCRYPT_ALG_HANDLE = 97i64 as _;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const BCRYPT_SP800108_CTR_HMAC_ALG_HANDLE: BCRYPT_ALG_HANDLE = 833i64 as _;
pub const BCRYPT_SP80056A_CONCAT_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("SP800_56A_CONCAT");
pub const BCRYPT_SP80056A_CONCAT_ALG_HANDLE: BCRYPT_ALG_HANDLE = 849i64 as _;
...
pub const BCRYPT_TLS1_1_KDF_ALG_HANDLE: BCRYPT_ALG_HANDLE = 865i64 as _;
pub const BCRYPT_TLS1_2_KDF_ALGORITHM: windows_sys::core::PCWSTR = windows_sys::core::w!("TLS1_2_KDF");
pub const BCRYPT_TLS1_2_KDF_ALG_HANDLE: BCRYPT_ALG_HANDLE = 881i64 as _;
...
pub const BCRYPT_XTS_AES_ALG_HANDLE: BCRYPT_ALG_HANDLE = 897i64 as _;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub type BCryptCreateHashFn = Option<unsafe extern "system" fn(halgorithm: BCRYPT_ALG_HANDLE, phhash: *mut BCRYPT_HASH_HANDLE, pbhashobject: *mut u8, cbhashobject: u32, pbsecret: *mut u8, cbsecret: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS>;
pub type BCryptCreateMultiHashFn = Option<unsafe extern "system" fn(halgorithm: BCRYPT_ALG_HANDLE, phhash: *mut BCRYPT_HASH_HANDLE, nhashes: u32, pbhashobject: *mut u8, cbhashobject: u32, pbsecret: *mut u8, cbsecret: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS>;
pub type BCryptDecryptFn = Option<unsafe extern "system" fn(hkey: BCRYPT_KEY_HANDLE, pbinput: *mut u8, cbinput: u32, ppaddinginfo: *mut core::ffi::c_void, pbiv: *mut u8, cbiv: u32, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: u32) -> super::super::Foundation::NTSTATUS>;
...
pub type BCryptDeriveKeyFn = Option<unsafe extern "system" fn(hsharedsecret: BCRYPT_SECRET_HANDLE, pwszkdf: windows_sys::core::PCWSTR, pparameterlist: *mut BCryptBufferDesc, pbderivedkey: *mut u8, cbderivedkey: u32, pcbresult: *mut u32, dwflags: u32) -> super::super::Foundation::NTSTATUS>;
...
pub type BCryptFreeBufferFn = Option<unsafe extern "system" fn(pvbuffer: *mut core::ffi::c_void)>;
...
pub type BCryptHashDataFn = Option<unsafe extern "system" fn(hhash: BCRYPT_HASH_HANDLE, pbinput: *mut u8, cbinput: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS>;
...
pub type BCryptImportKeyPairFn = Option<unsafe extern "system" fn(halgorithm: BCRYPT_ALG_HANDLE, himportkey: BCRYPT_KEY_HANDLE, pszblobtype: windows_sys::core::PCWSTR, phkey: *mut BCRYPT_KEY_HANDLE, pbinput: *mut u8, cbinput: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS>;
...
pub type BCryptProcessMultiOperationsFn = Option<unsafe extern "system" fn(hobject: BCRYPT_HANDLE, operationtype: BCRYPT_MULTI_OPERATION_TYPE, poperations: *mut core::ffi::c_void, cboperations: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS>;
...
pub type BCryptSetPropertyFn = Option<unsafe extern "system" fn(hobject: BCRYPT_HANDLE, pszproperty: windows_sys::core::PCWSTR, pbinput: *mut u8, cbinput: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS>;
...
pub type BCryptVerifySignatureFn = Option<unsafe extern "system" fn(hkey: BCRYPT_KEY_HANDLE, ppaddinginfo: *mut core::ffi::c_void, pbhash: *mut u8, cbhash: u32, pbsignature: *mut u8, cbsignature: u32, dwflags: u32) -> super::super::Foundation::NTSTATUS>;
...
pub const CERT_CHAIN_POLICY_AUTHENTICODE: windows_sys::core::PCSTR = 2i64 as _;
pub const CERT_CHAIN_POLICY_AUTHENTICODE_TS: windows_sys::core::PCSTR = 3i64 as _;
pub const CERT_CHAIN_POLICY_BASE: windows_sys::core::PCSTR = 1i64 as _;
pub const CERT_CHAIN_POLICY_BASIC_CONSTRAINTS: windows_sys::core::PCSTR = 5i64 as _;
pub const CERT_CHAIN_POLICY_EV: windows_sys::core::PCSTR = 8i64 as _;
...
pub const CERT_CHAIN_POLICY_MICROSOFT_ROOT: windows_sys::core::PCSTR = 7i64 as _;
pub const CERT_CHAIN_POLICY_NT_AUTH: windows_sys::core::PCSTR = 6i64 as _;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const CERT_CHAIN_POLICY_SSL: windows_sys::core::PCSTR = 4i64 as _;
pub const CERT_CHAIN_POLICY_SSL_F12: windows_sys::core::PCSTR = 9i64 as _;
...
pub const CERT_CHAIN_POLICY_SSL_HPKP_HEADER: windows_sys::core::PCSTR = 10i64 as _;
pub const CERT_CHAIN_POLICY_SSL_KEY_PIN: windows_sys::core::PCSTR = 12i64 as _;
...
pub const CERT_CHAIN_POLICY_THIRD_PARTY_ROOT: windows_sys::core::PCSTR = 11i64 as _;
...
pub const CERT_RETRIEVE_BIOMETRIC_PREDEFINED_BASE_TYPE: windows_sys::core::PCSTR = 1000i64 as _;
pub const CERT_RETRIEVE_COMMUNITY_LOGO: windows_sys::core::PCSTR = 3i64 as _;
pub const CERT_RETRIEVE_ISSUER_LOGO: windows_sys::core::PCSTR = 1i64 as _;
pub const CERT_RETRIEVE_SUBJECT_LOGO: windows_sys::core::PCSTR = 2i64 as _;
...
pub const CERT_STORE_PROV_COLLECTION: windows_sys::core::PCSTR = 11i64 as _;
...
pub const CERT_STORE_PROV_FILE: windows_sys::core::PCSTR = 3i64 as _;
pub const CERT_STORE_PROV_FILENAME: i32 = 8i32;
pub const CERT_STORE_PROV_FILENAME_A: windows_sys::core::PCSTR = 7i64 as _;
pub const CERT_STORE_PROV_FILENAME_W: windows_sys::core::PCSTR = 8i64 as _;
...
pub const CERT_STORE_PROV_LDAP_W: windows_sys::core::PCSTR = 16i64 as _;
pub const CERT_STORE_PROV_LM_SYSTEM_STORE_FLAG: CERT_STORE_PROV_FLAGS = 16u32;
pub const CERT_STORE_PROV_MEMORY: windows_sys::core::PCSTR = 2i64 as _;
pub const CERT_STORE_PROV_MSG: windows_sys::core::PCSTR = 1i64 as _;
pub const CERT_STORE_PROV_NO_PERSIST_FLAG: CERT_STORE_PROV_FLAGS = 4u32;
pub const CERT_STORE_PROV_PHYSICAL: i32 = 14i32;
pub const CERT_STORE_PROV_PHYSICAL_W: windows_sys::core::PCSTR = 14i64 as _;
pub const CERT_STORE_PROV_PKCS12: windows_sys::core::PCSTR = 17i64 as _;
pub const CERT_STORE_PROV_PKCS7: windows_sys::core::PCSTR = 5i64 as _;
...
pub const CERT_STORE_PROV_REG: windows_sys::core::PCSTR = 4i64 as _;
pub const CERT_STORE_PROV_SERIALIZED: windows_sys::core::PCSTR = 6i64 as _;
...
pub const CERT_STORE_PROV_SMART_CARD_W: windows_sys::core::PCSTR = 15i64 as _;
pub const CERT_STORE_PROV_SYSTEM: i32 = 10i32;
pub const CERT_STORE_PROV_SYSTEM_A: windows_sys::core::PCSTR = 9i64 as _;
pub const CERT_STORE_PROV_SYSTEM_REGISTRY: i32 = 13i32;
pub const CERT_STORE_PROV_SYSTEM_REGISTRY_A: windows_sys::core::PCSTR = 12i64 as _;
pub const CERT_STORE_PROV_SYSTEM_REGISTRY_W: windows_sys::core::PCSTR = 13i64 as _;
pub const CERT_STORE_PROV_SYSTEM_STORE_FLAG: CERT_STORE_PROV_FLAGS = 8u32;
pub const CERT_STORE_PROV_SYSTEM_W: windows_sys::core::PCSTR = 10i64 as _;
...
pub const CMC_ADD_ATTRIBUTES: windows_sys::core::PCSTR = 63i64 as _;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const CMC_ADD_EXTENSIONS: windows_sys::core::PCSTR = 62i64 as _;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const CMC_DATA: windows_sys::core::PCSTR = 59i64 as _;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const CMC_RESPONSE: windows_sys::core::PCSTR = 60i64 as _;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const CMC_STATUS: windows_sys::core::PCSTR = 61i64 as _;
...
pub const CMSG_DEFAULT_INSTALLABLE_FUNC_OID: windows_sys::core::PCSTR = 1i64 as _;
...
pub const CMS_SIGNER_INFO: windows_sys::core::PCSTR = 501i64 as _;
pub const CNG_RSA_PRIVATE_KEY_BLOB: windows_sys::core::PCSTR = 83i64 as _;
pub const CNG_RSA_PUBLIC_KEY_BLOB: windows_sys::core::PCSTR = 72i64 as _;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const CONTEXT_OID_CAPI2_ANY: windows_sys::core::PCSTR = 5i64 as _;
pub const CONTEXT_OID_CERTIFICATE: windows_sys::core::PCSTR = 1i64 as _;
pub const CONTEXT_OID_CREATE_OBJECT_CONTEXT_FUNC: windows_sys::core::PCSTR = windows_sys::core::s!("ContextDllCreateObjectContext");
pub const CONTEXT_OID_CRL: windows_sys::core::PCSTR = 2i64 as _;
pub const CONTEXT_OID_CTL: windows_sys::core::PCSTR = 3i64 as _;
pub const CONTEXT_OID_OCSP_RESP: windows_sys::core::PCSTR = 6i64 as _;
pub const CONTEXT_OID_PKCS7: windows_sys::core::PCSTR = 4i64 as _;
#[repr(C)]
#[derive(Clone, Copy)]
pub struct CPS_URLS {
...
pub const CREDENTIAL_OID_PASSWORD_CREDENTIALS_A: windows_sys::core::PCSTR = 1i64 as _;
pub const CREDENTIAL_OID_PASSWORD_CREDENTIALS_W: windows_sys::core::PCSTR = 2i64 as _;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const CRYPT_PARAM_ASYNC_RETRIEVAL_COMPLETION: windows_sys::core::PCSTR = 1i64 as _;
pub const CRYPT_PARAM_CANCEL_ASYNC_RETRIEVAL: windows_sys::core::PCSTR = 2i64 as _;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub type CRYPT_VERIFY_IMAGE_A = Option<unsafe extern "system" fn(szimage: windows_sys::core::PCSTR, pbsigdata: *mut u8) -> windows_sys::core::BOOL>;
...
pub type CryptXmlDllCloseDigest = Option<unsafe extern "system" fn(hdigest: *mut core::ffi::c_void) -> windows_sys::core::HRESULT>;
pub type CryptXmlDllCreateDigest = Option<unsafe extern "system" fn(pdigestmethod: *mut CRYPT_XML_ALGORITHM, pcbsize: *mut u32, phdigest: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT>;
pub type CryptXmlDllCreateKey = Option<unsafe extern "system" fn(pencoded: *mut CRYPT_XML_BLOB, phkey: *mut BCRYPT_KEY_HANDLE) -> windows_sys::core::HRESULT>;
pub type CryptXmlDllDigestData = Option<unsafe extern "system" fn(hdigest: *mut core::ffi::c_void, pbdata: *mut u8, cbdata: u32) -> windows_sys::core::HRESULT>;
...
pub type CryptXmlDllGetAlgorithmInfo = Option<unsafe extern "system" fn(pxmlalgorithm: *mut CRYPT_XML_ALGORITHM, ppalginfo: *mut *mut CRYPT_XML_ALGORITHM_INFO) -> windows_sys::core::HRESULT>;
...
pub type CryptXmlDllVerifySignature = Option<unsafe extern "system" fn(psignaturemethod: *mut CRYPT_XML_ALGORITHM, hkey: BCRYPT_KEY_HANDLE, pbinput: *mut u8, cbinput: u32, pbsignature: *mut u8, cbsignature: u32) -> windows_sys::core::HRESULT>;
...
pub const ECC_CMS_SHARED_INFO: windows_sys::core::PCSTR = 77i64 as _;
...
pub type NCryptDecryptFn = Option<unsafe extern "system" fn(hprovider: NCRYPT_PROV_HANDLE, hkey: NCRYPT_KEY_HANDLE, pbinput: *mut u8, cbinput: u32, ppaddinginfo: *mut core::ffi::c_void, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: u32) -> windows_sys::core::HRESULT>;
...
pub type NCryptDeriveKeyFn = Option<unsafe extern "system" fn(hprovider: NCRYPT_PROV_HANDLE, hsharedsecret: NCRYPT_SECRET_HANDLE, pwszkdf: windows_sys::core::PCWSTR, pparameterlist: *mut BCryptBufferDesc, pbderivedkey: *mut u8, cbderivedkey: u32, pcbresult: *mut u32, dwflags: u32) -> windows_sys::core::HRESULT>;
...
pub type NCryptExportKeyFn = Option<unsafe extern "system" fn(hprovider: NCRYPT_PROV_HANDLE, hkey: NCRYPT_KEY_HANDLE, hexportkey: NCRYPT_KEY_HANDLE, pszblobtype: windows_sys::core::PCWSTR, pparameterlist: *mut BCryptBufferDesc, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: u32) -> windows_sys::core::HRESULT>;
...
pub type NCryptSetKeyPropertyFn = Option<unsafe extern "system" fn(hprovider: NCRYPT_PROV_HANDLE, hkey: NCRYPT_KEY_HANDLE, pszproperty: windows_sys::core::PCWSTR, pbinput: *mut u8, cbinput: u32, dwflags: u32) -> windows_sys::core::HRESULT>;
pub type NCryptSetProviderPropertyFn = Option<unsafe extern "system" fn(hprovider: NCRYPT_PROV_HANDLE, pszproperty: windows_sys::core::PCWSTR, pbinput: *mut u8, cbinput: u32, dwflags: u32) -> windows_sys::core::HRESULT>;
...
pub type NCryptVerifyClaimFn = Option<unsafe extern "system" fn(hprov: NCRYPT_PROV_HANDLE, hsubjectkey: NCRYPT_KEY_HANDLE, hauthoritykey: NCRYPT_KEY_HANDLE, dwclaimtype: u32, pparameterlist: *mut BCryptBufferDesc, pbclaimblob: *mut u8, cbclaimblob: u32, poutput: *mut BCryptBufferDesc, dwflags: u32) -> windows_sys::core::HRESULT>;
...
pub const OCSP_BASIC_RESPONSE: windows_sys::core::PCSTR = 69i64 as _;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const OCSP_BASIC_SIGNED_RESPONSE: windows_sys::core::PCSTR = 68i64 as _;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const OCSP_REQUEST: windows_sys::core::PCSTR = 66i64 as _;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const OCSP_RESPONSE: windows_sys::core::PCSTR = 67i64 as _;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const OCSP_SIGNED_REQUEST: windows_sys::core::PCSTR = 65i64 as _;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub type PCRYPT_DECRYPT_PRIVATE_KEY_FUNC = Option<unsafe extern "system" fn(algorithm: CRYPT_ALGORITHM_IDENTIFIER, encryptedprivatekey: CRYPT_INTEGER_BLOB, pbcleartextkey: *mut u8, pcbcleartextkey: *mut u32, pvoiddecryptfunc: *mut core::ffi::c_void) -> windows_sys::core::BOOL>;
pub type PCRYPT_ENCRYPT_PRIVATE_KEY_FUNC = Option<unsafe extern "system" fn(palgorithm: *mut CRYPT_ALGORITHM_IDENTIFIER, pcleartextprivatekey: *mut CRYPT_INTEGER_BLOB, pbencryptedkey: *mut u8, pcbencryptedkey: *mut u32, pvoidencryptfunc: *mut core::ffi::c_void) -> windows_sys::core::BOOL>;
...
pub type PFNCryptStreamOutputCallback = Option<unsafe extern "system" fn(pvcallbackctxt: *mut core::ffi::c_void, pbdata: *mut u8, cbdata: usize, ffinal: windows_sys::core::BOOL) -> windows_sys::core::HRESULT>;
pub type PFNCryptStreamOutputCallbackEx = Option<unsafe extern "system" fn(pvcallbackctxt: *mut core::ffi::c_void, pbdata: *mut u8, cbdata: usize, hdescriptor: super::NCRYPT_DESCRIPTOR_HANDLE, ffinal: windows_sys::core::BOOL) -> windows_sys::core::HRESULT>;
pub type PFN_AUTHENTICODE_DIGEST_SIGN = Option<unsafe extern "system" fn(psigningcert: *mut CERT_CONTEXT, pmetadatablob: *mut CRYPT_INTEGER_BLOB, digestalgid: ALG_ID, pbtobesigneddigest: *mut u8, cbtobesigneddigest: u32, psigneddigest: *mut CRYPT_INTEGER_BLOB) -> windows_sys::core::HRESULT>;
pub type PFN_AUTHENTICODE_DIGEST_SIGN_EX = Option<unsafe extern "system" fn(pmetadatablob: *mut CRYPT_INTEGER_BLOB, digestalgid: ALG_ID, pbtobesigneddigest: *mut u8, cbtobesigneddigest: u32, psigneddigest: *mut CRYPT_INTEGER_BLOB, ppsignercert: *mut *mut CERT_CONTEXT, hcertchainstore: HCERTSTORE) -> windows_sys::core::HRESULT>;
...
pub type PFN_CARD_AUTHENTICATE_CHALLENGE = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pbresponsedata: *mut u8, cbresponsedata: u32, pcattemptsremaining: *mut u32) -> u32>;
pub type PFN_CARD_AUTHENTICATE_EX = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pinid: u32, dwflags: u32, pbpindata: *mut u8, cbpindata: u32, ppbsessionpin: *mut *mut u8, pcbsessionpin: *mut u32, pcattemptsremaining: *mut u32) -> u32>;
pub type PFN_CARD_AUTHENTICATE_PIN = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pwszuserid: windows_sys::core::PCWSTR, pbpin: *mut u8, cbpin: u32, pcattemptsremaining: *mut u32) -> u32>;
pub type PFN_CARD_CHANGE_AUTHENTICATOR = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pwszuserid: windows_sys::core::PCWSTR, pbcurrentauthenticator: *mut u8, cbcurrentauthenticator: u32, pbnewauthenticator: *mut u8, cbnewauthenticator: u32, cretrycount: u32, dwflags: u32, pcattemptsremaining: *mut u32) -> u32>;
pub type PFN_CARD_CHANGE_AUTHENTICATOR_EX = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, dwflags: u32, dwauthenticatingpinid: u32, pbauthenticatingpindata: *mut u8, cbauthenticatingpindata: u32, dwtargetpinid: u32, pbtargetdata: *mut u8, cbtargetdata: u32, cretrycount: u32, pcattemptsremaining: *mut u32) -> u32>;
pub type PFN_CARD_CONSTRUCT_DH_AGREEMENT = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pagreementinfo: *mut CARD_DH_AGREEMENT_INFO) -> u32>;
pub type PFN_CARD_CREATE_CONTAINER = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, bcontainerindex: u8, dwflags: u32, dwkeyspec: u32, dwkeysize: u32, pbkeydata: *mut u8) -> u32>;
pub type PFN_CARD_CREATE_CONTAINER_EX = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, bcontainerindex: u8, dwflags: u32, dwkeyspec: u32, dwkeysize: u32, pbkeydata: *mut u8, pinid: u32) -> u32>;
...
pub type PFN_CARD_CREATE_FILE = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pszdirectoryname: windows_sys::core::PCSTR, pszfilename: windows_sys::core::PCSTR, cbinitialcreationsize: u32, accesscondition: CARD_FILE_ACCESS_CONDITION) -> u32>;
pub type PFN_CARD_DEAUTHENTICATE = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pwszuserid: windows_sys::core::PCWSTR, dwflags: u32) -> u32>;
pub type PFN_CARD_DEAUTHENTICATE_EX = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pinid: u32, dwflags: u32) -> u32>;
pub type PFN_CARD_DELETE_CONTAINER = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, bcontainerindex: u8, dwreserved: u32) -> u32>;
...
pub type PFN_CARD_DELETE_FILE = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pszdirectoryname: windows_sys::core::PCSTR, pszfilename: windows_sys::core::PCSTR, dwflags: u32) -> u32>;
...
pub type PFN_CARD_DESTROY_DH_AGREEMENT = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, bsecretagreementindex: u8, dwflags: u32) -> u32>;
pub type PFN_CARD_DESTROY_KEY = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, hkey: usize) -> u32>;
...
pub type PFN_CARD_GET_ALGORITHM_PROPERTY = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pwszalgid: windows_sys::core::PCWSTR, pwszproperty: windows_sys::core::PCWSTR, pbdata: *mut u8, cbdata: u32, pdwdatalen: *mut u32, dwflags: u32) -> u32>;
...
pub type PFN_CARD_GET_CHALLENGE_EX = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pinid: u32, ppbchallengedata: *mut *mut u8, pcbchallengedata: *mut u32, dwflags: u32) -> u32>;
pub type PFN_CARD_GET_CONTAINER_INFO = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, bcontainerindex: u8, dwflags: u32, pcontainerinfo: *mut CONTAINER_INFO) -> u32>;
...
pub type PFN_CARD_GET_KEY_PROPERTY = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, hkey: usize, pwszproperty: windows_sys::core::PCWSTR, pbdata: *mut u8, cbdata: u32, pdwdatalen: *mut u32, dwflags: u32) -> u32>;
pub type PFN_CARD_GET_PROPERTY = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, wszproperty: windows_sys::core::PCWSTR, pbdata: *mut u8, cbdata: u32, pdwdatalen: *mut u32, dwflags: u32) -> u32>;
pub type PFN_CARD_GET_SHARED_KEY_HANDLE = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pbinput: *mut u8, cbinput: u32, ppboutput: *mut *mut u8, pcboutput: *mut u32, phkey: *mut usize) -> u32>;
pub type PFN_CARD_IMPORT_SESSION_KEY = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, bcontainerindex: u8, ppaddinginfo: *mut core::ffi::c_void, pwszblobtype: windows_sys::core::PCWSTR, pwszalgid: windows_sys::core::PCWSTR, phkey: *mut usize, pbinput: *mut u8, cbinput: u32, dwflags: u32) -> u32>;
pub type PFN_CARD_PROCESS_ENCRYPTED_DATA = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, hkey: usize, pwszsecurefunction: windows_sys::core::PCWSTR, pencrypteddata: *mut CARD_ENCRYPTED_DATA, cencrypteddata: u32, pboutput: *mut u8, cboutput: u32, pdwoutputlen: *mut u32, dwflags: u32) -> u32>;
pub type PFN_CARD_QUERY_CAPABILITIES = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pcardcapabilities: *mut CARD_CAPABILITIES) -> u32>;
pub type PFN_CARD_QUERY_FREE_SPACE = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, dwflags: u32, pcardfreespaceinfo: *mut CARD_FREE_SPACE_INFO) -> u32>;
pub type PFN_CARD_QUERY_KEY_SIZES = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, dwkeyspec: u32, dwflags: u32, pkeysizes: *mut CARD_KEY_SIZES) -> u32>;
...
pub type PFN_CARD_RSA_DECRYPT = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pinfo: *mut CARD_RSA_DECRYPT_INFO) -> u32>;
...
pub type PFN_CARD_SET_PROPERTY = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, wszproperty: windows_sys::core::PCWSTR, pbdata: *mut u8, cbdatalen: u32, dwflags: u32) -> u32>;
pub type PFN_CARD_SIGN_DATA = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pinfo: *mut CARD_SIGNING_INFO) -> u32>;
pub type PFN_CARD_UNBLOCK_PIN = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pwszuserid: windows_sys::core::PCWSTR, pbauthenticationdata: *mut u8, cbauthenticationdata: u32, pbnewpindata: *mut u8, cbnewpindata: u32, cretrycount: u32, dwflags: u32) -> u32>;
pub type PFN_CARD_WRITE_FILE = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pszdirectoryname: windows_sys::core::PCSTR, pszfilename: windows_sys::core::PCSTR, dwflags: u32, pbdata: *mut u8, cbdata: u32) -> u32>;
pub type PFN_CERT_CHAIN_FIND_BY_ISSUER_CALLBACK = Option<unsafe extern "system" fn(pcert: *mut CERT_CONTEXT, pvfindarg: *mut core::ffi::c_void) -> windows_sys::core::BOOL>;
...
pub type PFN_CERT_ENUM_SYSTEM_STORE = Option<unsafe extern "system" fn(pvsystemstore: *mut core::ffi::c_void, dwflags: CERT_SYSTEM_STORE_FLAGS, pstoreinfo: *mut CERT_SYSTEM_STORE_INFO, pvreserved: *mut core::ffi::c_void, pvarg: *mut core::ffi::c_void) -> windows_sys::core::BOOL>;
...
pub type PFN_CERT_SERVER_OCSP_RESPONSE_UPDATE_CALLBACK = Option<unsafe extern "system" fn(pchaincontext: *mut CERT_CHAIN_CONTEXT, pserverocspresponsecontext: *mut CERT_SERVER_OCSP_RESPONSE_CONTEXT, pnewcrlcontext: *mut CRL_CONTEXT, pprevcrlcontext: *mut CRL_CONTEXT, pvarg: *mut core::ffi::c_void, dwwriteocspfileerror: u32)>;
pub type PFN_CERT_STORE_PROV_CLOSE = Option<unsafe extern "system" fn(hstoreprov: HCERTSTOREPROV, dwflags: u32)>;
pub type PFN_CERT_STORE_PROV_CONTROL = Option<unsafe extern "system" fn(hstoreprov: HCERTSTOREPROV, dwflags: u32, dwctrltype: u32, pvctrlpara: *mut core::ffi::c_void) -> windows_sys::core::BOOL>;
...
pub type PFN_CERT_STORE_PROV_DELETE_CTL = Option<unsafe extern "system" fn(hstoreprov: HCERTSTOREPROV, pctlcontext: *mut CTL_CONTEXT, dwflags: u32) -> windows_sys::core::BOOL>;
...
pub type PFN_CERT_STORE_PROV_FIND_CRL = Option<unsafe extern "system" fn(hstoreprov: HCERTSTOREPROV, pfindinfo: *mut CERT_STORE_PROV_FIND_INFO, pprevcrlcontext: *mut CRL_CONTEXT, dwflags: u32, ppvstoreprovfindinfo: *mut *mut core::ffi::c_void, ppprovcrlcontext: *mut *mut CRL_CONTEXT) -> windows_sys::core::BOOL>;
pub type PFN_CERT_STORE_PROV_FIND_CTL = Option<unsafe extern "system" fn(hstoreprov: HCERTSTOREPROV, pfindinfo: *mut CERT_STORE_PROV_FIND_INFO, pprevctlcontext: *mut CTL_CONTEXT, dwflags: u32, ppvstoreprovfindinfo: *mut *mut core::ffi::c_void, ppprovctlcontext: *mut *mut CTL_CONTEXT) -> windows_sys::core::BOOL>;
pub type PFN_CERT_STORE_PROV_FREE_FIND_CERT = Option<unsafe extern "system" fn(hstoreprov: HCERTSTOREPROV, pcertcontext: *mut CERT_CONTEXT, pvstoreprovfindinfo: *mut core::ffi::c_void, dwflags: u32) -> windows_sys::core::BOOL>;
pub type PFN_CERT_STORE_PROV_FREE_FIND_CRL = Option<unsafe extern "system" fn(hstoreprov: HCERTSTOREPROV, pcrlcontext: *mut CRL_CONTEXT, pvstoreprovfindinfo: *mut core::ffi::c_void, dwflags: u32) -> windows_sys::core::BOOL>;
pub type PFN_CERT_STORE_PROV_FREE_FIND_CTL = Option<unsafe extern "system" fn(hstoreprov: HCERTSTOREPROV, pctlcontext: *mut CTL_CONTEXT, pvstoreprovfindinfo: *mut core::ffi::c_void, dwflags: u32) -> windows_sys::core::BOOL>;
pub type PFN_CERT_STORE_PROV_GET_CERT_PROPERTY = Option<unsafe extern "system" fn(hstoreprov: HCERTSTOREPROV, pcertcontext: *mut CERT_CONTEXT, dwpropid: u32, dwflags: u32, pvdata: *mut core::ffi::c_void, pcbdata: *mut u32) -> windows_sys::core::BOOL>;
...
pub type PFN_CERT_STORE_PROV_GET_CTL_PROPERTY = Option<unsafe extern "system" fn(hstoreprov: HCERTSTOREPROV, pctlcontext: *mut CTL_CONTEXT, dwpropid: u32, dwflags: u32, pvdata: *mut core::ffi::c_void, pcbdata: *mut u32) -> windows_sys::core::BOOL>;
pub type PFN_CERT_STORE_PROV_READ_CERT = Option<unsafe extern "system" fn(hstoreprov: HCERTSTOREPROV, pstorecertcontext: *mut CERT_CONTEXT, dwflags: u32, ppprovcertcontext: *mut *mut CERT_CONTEXT) -> windows_sys::core::BOOL>;
...
pub type PFN_CERT_STORE_PROV_READ_CTL = Option<unsafe extern "system" fn(hstoreprov: HCERTSTOREPROV, pstorectlcontext: *mut CTL_CONTEXT, dwflags: u32, ppprovctlcontext: *mut *mut CTL_CONTEXT) -> windows_sys::core::BOOL>;
pub type PFN_CERT_STORE_PROV_SET_CERT_PROPERTY = Option<unsafe extern "system" fn(hstoreprov: HCERTSTOREPROV, pcertcontext: *mut CERT_CONTEXT, dwpropid: u32, dwflags: u32, pvdata: *mut core::ffi::c_void) -> windows_sys::core::BOOL>;
pub type PFN_CERT_STORE_PROV_SET_CRL_PROPERTY = Option<unsafe extern "system" fn(hstoreprov: HCERTSTOREPROV, pcrlcontext: *mut CRL_CONTEXT, dwpropid: u32, dwflags: u32, pvdata: *mut core::ffi::c_void) -> windows_sys::core::BOOL>;
pub type PFN_CERT_STORE_PROV_SET_CTL_PROPERTY = Option<unsafe extern "system" fn(hstoreprov: HCERTSTOREPROV, pctlcontext: *mut CTL_CONTEXT, dwpropid: u32, dwflags: u32, pvdata: *mut core::ffi::c_void) -> windows_sys::core::BOOL>;
pub type PFN_CERT_STORE_PROV_WRITE_CERT = Option<unsafe extern "system" fn(hstoreprov: HCERTSTOREPROV, pcertcontext: *mut CERT_CONTEXT, dwflags: u32) -> windows_sys::core::BOOL>;
pub type PFN_CERT_STORE_PROV_WRITE_CRL = Option<unsafe extern "system" fn(hstoreprov: HCERTSTOREPROV, pcrlcontext: *mut CRL_CONTEXT, dwflags: u32) -> windows_sys::core::BOOL>;
...
pub type PFN_CMSG_CNG_IMPORT_CONTENT_ENCRYPT_KEY = Option<unsafe extern "system" fn(pcngcontentdecryptinfo: *mut CMSG_CNG_CONTENT_DECRYPT_INFO, dwflags: u32, pvreserved: *mut core::ffi::c_void) -> windows_sys::core::BOOL>;
pub type PFN_CMSG_CNG_IMPORT_KEY_AGREE = Option<unsafe extern "system" fn(pcngcontentdecryptinfo: *mut CMSG_CNG_CONTENT_DECRYPT_INFO, pkeyagreedecryptpara: *mut CMSG_CTRL_KEY_AGREE_DECRYPT_PARA, dwflags: u32, pvreserved: *mut core::ffi::c_void) -> windows_sys::core::BOOL>;
...
pub type PFN_CMSG_EXPORT_KEY_AGREE = Option<unsafe extern "system" fn(pcontentencryptinfo: *mut CMSG_CONTENT_ENCRYPT_INFO, pkeyagreeencodeinfo: *mut CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO, pkeyagreeencryptinfo: *mut CMSG_KEY_AGREE_ENCRYPT_INFO, dwflags: u32, pvreserved: *mut core::ffi::c_void) -> windows_sys::core::BOOL>;
...
pub type PFN_CMSG_GEN_CONTENT_ENCRYPT_KEY = Option<unsafe extern "system" fn(pcontentencryptinfo: *mut CMSG_CONTENT_ENCRYPT_INFO, dwflags: u32, pvreserved: *mut core::ffi::c_void) -> windows_sys::core::BOOL>;
pub type PFN_CMSG_GEN_ENCRYPT_KEY = Option<unsafe extern "system" fn(phcryptprov: *mut usize, paiencrypt: *mut CRYPT_ALGORITHM_IDENTIFIER, pvencryptauxinfo: *mut core::ffi::c_void, ppublickeyinfo: *mut CERT_PUBLIC_KEY_INFO, pfnalloc: PFN_CMSG_ALLOC, phencryptkey: *mut usize, ppbencryptparameters: *mut *mut u8, pcbencryptparameters: *mut u32) -> windows_sys::core::BOOL>;
...
pub type PFN_CMSG_IMPORT_KEY_AGREE = Option<unsafe extern "system" fn(pcontentencryptionalgorithm: *mut CRYPT_ALGORITHM_IDENTIFIER, pkeyagreedecryptpara: *mut CMSG_CTRL_KEY_AGREE_DECRYPT_PARA, dwflags: u32, pvreserved: *mut core::ffi::c_void, phcontentencryptkey: *mut usize) -> windows_sys::core::BOOL>;
pub type PFN_CMSG_IMPORT_KEY_TRANS = Option<unsafe extern "system" fn(pcontentencryptionalgorithm: *mut CRYPT_ALGORITHM_IDENTIFIER, pkeytransdecryptpara: *mut CMSG_CTRL_KEY_TRANS_DECRYPT_PARA, dwflags: u32, pvreserved: *mut core::ffi::c_void, phcontentencryptkey: *mut usize) -> windows_sys::core::BOOL>;
pub type PFN_CMSG_IMPORT_MAIL_LIST = Option<unsafe extern "system" fn(pcontentencryptionalgorithm: *mut CRYPT_ALGORITHM_IDENTIFIER, pmaillistdecryptpara: *mut CMSG_CTRL_MAIL_LIST_DECRYPT_PARA, dwflags: u32, pvreserved: *mut core::ffi::c_void, phcontentencryptkey: *mut usize) -> windows_sys::core::BOOL>;
pub type PFN_CMSG_STREAM_OUTPUT = Option<unsafe extern "system" fn(pvarg: *mut core::ffi::c_void, pbdata: *mut u8, cbdata: u32, ffinal: windows_sys::core::BOOL) -> windows_sys::core::BOOL>;
pub type PFN_CRYPT_ALLOC = Option<unsafe extern "system" fn(cbsize: usize) -> *mut core::ffi::c_void>;
pub type PFN_CRYPT_ASYNC_PARAM_FREE_FUNC = Option<unsafe extern "system" fn(pszparamoid: windows_sys::core::PCSTR, pvparam: *mut core::ffi::c_void)>;
...
pub type PFN_CRYPT_ENUM_KEYID_PROP = Option<unsafe extern "system" fn(pkeyidentifier: *mut CRYPT_INTEGER_BLOB, dwflags: u32, pvreserved: *mut core::ffi::c_void, pvarg: *mut core::ffi::c_void, cprop: u32, rgdwpropid: *mut u32, rgpvdata: *mut *mut core::ffi::c_void, rgcbdata: *mut u32) -> windows_sys::core::BOOL>;
...
pub type PFN_CRYPT_EXTRACT_ENCODED_SIGNATURE_PARAMETERS_FUNC = Option<unsafe extern "system" fn(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, psignaturealgorithm: *mut CRYPT_ALGORITHM_IDENTIFIER, ppvdecodedsignpara: *mut *mut core::ffi::c_void, ppwszcnghashalgid: *mut windows_sys::core::PWSTR) -> windows_sys::core::BOOL>;
pub type PFN_CRYPT_FREE = Option<unsafe extern "system" fn(pv: *mut core::ffi::c_void)>;
...
pub type PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE_IDENTIFIER = Option<unsafe extern "system" fn(pplugincontext: *mut core::ffi::c_void, pidentifier: *mut CRYPT_INTEGER_BLOB)>;
pub type PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE_PASSWORD = Option<unsafe extern "system" fn(pplugincontext: *mut core::ffi::c_void, pwszpassword: windows_sys::core::PCWSTR)>;
pub type PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_GET = Option<unsafe extern "system" fn(pplugincontext: *mut core::ffi::c_void, pidentifier: *mut CRYPT_INTEGER_BLOB, dwnametype: u32, pnameblob: *mut CRYPT_INTEGER_BLOB, ppbcontent: *mut *mut u8, pcbcontent: *mut u32, ppwszpassword: *mut windows_sys::core::PWSTR, ppidentifier: *mut *mut CRYPT_INTEGER_BLOB) -> windows_sys::core::BOOL>;
pub type PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_INITIALIZE = Option<unsafe extern "system" fn(pfnflush: PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FLUSH, pcontext: *mut core::ffi::c_void, pdwexpectedobjectcount: *mut u32, ppfunctable: *mut *mut CRYPT_OBJECT_LOCATOR_PROVIDER_TABLE, ppplugincontext: *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL>;
...
pub type PFN_CRYPT_SIGN_AND_ENCODE_HASH_FUNC = Option<unsafe extern "system" fn(hkey: NCRYPT_KEY_HANDLE, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, psignaturealgorithm: *mut CRYPT_ALGORITHM_IDENTIFIER, pvdecodedsignpara: *mut core::ffi::c_void, pwszcngpubkeyalgid: windows_sys::core::PCWSTR, pwszcnghashalgid: windows_sys::core::PCWSTR, pbcomputedhash: *mut u8, cbcomputedhash: u32, pbsignature: *mut u8, pcbsignature: *mut u32) -> windows_sys::core::BOOL>;
...
pub type PFN_CRYPT_XML_CREATE_TRANSFORM = Option<unsafe extern "system" fn(ptransform: *mut CRYPT_XML_ALGORITHM, pproviderin: *mut CRYPT_XML_DATA_PROVIDER, pproviderout: *mut CRYPT_XML_DATA_PROVIDER) -> windows_sys::core::HRESULT>;
...
pub type PFN_CRYPT_XML_ENUM_ALG_INFO = Option<unsafe extern "system" fn(pinfo: *mut CRYPT_XML_ALGORITHM_INFO, pvarg: *mut core::ffi::c_void) -> windows_sys::core::BOOL>;
...
pub type PFN_CSP_CACHE_DELETE_FILE = Option<unsafe extern "system" fn(pvcachecontext: *mut core::ffi::c_void, wsztag: windows_sys::core::PCWSTR, dwflags: u32) -> u32>;
pub type PFN_CSP_CACHE_LOOKUP_FILE = Option<unsafe extern "system" fn(pvcachecontext: *mut core::ffi::c_void, wsztag: windows_sys::core::PCWSTR, dwflags: u32, ppbdata: *mut *mut u8, pcbdata: *mut u32) -> u32>;
pub type PFN_CSP_FREE = Option<unsafe extern "system" fn(address: *mut core::ffi::c_void)>;
pub type PFN_CSP_GET_DH_AGREEMENT = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, hsecretagreement: *mut core::ffi::c_void, pbsecretagreementindex: *mut u8, dwflags: u32) -> u32>;
...
pub type PFN_CSP_REALLOC = Option<unsafe extern "system" fn(address: *mut core::ffi::c_void, size: usize) -> *mut core::ffi::c_void>;
pub type PFN_CSP_UNPAD_DATA = Option<unsafe extern "system" fn(prsadecryptinfo: *mut CARD_RSA_DECRYPT_INFO, pcbunpaddeddata: *mut u32, ppbunpaddeddata: *mut *mut u8) -> u32>;
pub type PFN_EXPORT_PRIV_KEY_FUNC = Option<unsafe extern "system" fn(hcryptprov: usize, dwkeyspec: u32, pszprivatekeyobjid: windows_sys::core::PCSTR, dwflags: u32, pvauxinfo: *mut core::ffi::c_void, pprivatekeyinfo: *mut CRYPT_PRIVATE_KEY_INFO, pcbprivatekeyinfo: *mut u32) -> windows_sys::core::BOOL>;
...
pub type PFN_MD_ENCRYPT_DATA = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, hkey: usize, pwszsecurefunction: windows_sys::core::PCWSTR, pbinput: *mut u8, cbinput: u32, dwflags: u32, ppencrypteddata: *mut *mut CARD_ENCRYPTED_DATA, pcencrypteddata: *mut u32) -> u32>;
pub type PFN_MD_IMPORT_SESSION_KEY = Option<unsafe extern "system" fn(pcarddata: *mut CARD_DATA, pwszblobtype: windows_sys::core::PCWSTR, pwszalgid: windows_sys::core::PCWSTR, phkey: *mut usize, pbinput: *mut u8, cbinput: u32) -> u32>;
pub type PFN_NCRYPT_ALLOC = Option<unsafe extern "system" fn(cbsize: usize) -> *mut core::ffi::c_void>;
pub type PFN_NCRYPT_FREE = Option<unsafe extern "system" fn(pv: *mut core::ffi::c_void)>;
...
pub const PKCS7_SIGNER_INFO: windows_sys::core::PCSTR = 500i64 as _;
pub const PKCS_7_ASN_ENCODING: CERT_QUERY_ENCODING_TYPE = 65536u32;
pub const PKCS_7_NDR_ENCODING: u32 = 131072u32;
pub const PKCS_ATTRIBUTE: windows_sys::core::PCSTR = 22i64 as _;
pub const PKCS_ATTRIBUTES: windows_sys::core::PCSTR = 48i64 as _;
pub const PKCS_CONTENT_INFO: windows_sys::core::PCSTR = 33i64 as _;
pub const PKCS_CONTENT_INFO_SEQUENCE_OF_ANY: windows_sys::core::PCSTR = 23i64 as _;
pub const PKCS_CTL: windows_sys::core::PCSTR = 37i64 as _;
pub const PKCS_ENCRYPTED_PRIVATE_KEY_INFO: windows_sys::core::PCSTR = 45i64 as _;
pub const PKCS_PRIVATE_KEY_INFO: windows_sys::core::PCSTR = 44i64 as _;
pub const PKCS_RC2_CBC_PARAMETERS: windows_sys::core::PCSTR = 41i64 as _;
pub const PKCS_RSAES_OAEP_PARAMETERS: windows_sys::core::PCSTR = 76i64 as _;
pub const PKCS_RSA_PRIVATE_KEY: windows_sys::core::PCSTR = 43i64 as _;
pub const PKCS_RSA_SSA_PSS_PARAMETERS: windows_sys::core::PCSTR = 75i64 as _;
pub const PKCS_RSA_SSA_PSS_TRAILER_FIELD_BC: u32 = 1u32;
pub const PKCS_SMIME_CAPABILITIES: windows_sys::core::PCSTR = 42i64 as _;
pub const PKCS_SORTED_CTL: windows_sys::core::PCSTR = 49i64 as _;
pub const PKCS_TIME_REQUEST: windows_sys::core::PCSTR = 18i64 as _;
pub const PKCS_UTC_TIME: windows_sys::core::PCSTR = 17i64 as _;
...
pub const REVOCATION_OID_CRL_REVOCATION: windows_sys::core::PCSTR = 1i64 as _;
...
pub const RSA_CSP_PUBLICKEYBLOB: windows_sys::core::PCSTR = 19i64 as _;
...
pub type SslCreateEphemeralKeyFn = Option<unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, phephemeralkey: *mut NCRYPT_KEY_HANDLE, dwprotocol: u32, dwciphersuite: u32, dwkeytype: u32, dwkeybitlen: u32, pbparams: *mut u8, cbparams: u32, dwflags: u32) -> windows_sys::core::HRESULT>;
...
pub type SslDecryptPacketFn = Option<unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hkey: NCRYPT_KEY_HANDLE, pbinput: *mut u8, cbinput: u32, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, sequencenumber: u64, dwflags: u32) -> windows_sys::core::HRESULT>;
...
pub type SslEncryptPacketFn = Option<unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hkey: NCRYPT_KEY_HANDLE, pbinput: *mut u8, cbinput: u32, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, sequencenumber: u64, dwcontenttype: u32, dwflags: u32) -> windows_sys::core::HRESULT>;
...
pub type SslExpandBinderKeyFn = Option<unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hearlykey: NCRYPT_KEY_HANDLE, phbinderkey: *mut NCRYPT_KEY_HANDLE, pparameterlist: *mut BCryptBufferDesc, dwflags: u32) -> windows_sys::core::HRESULT>;
...
pub type SslExportKeyingMaterialFn = Option<unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hmasterkey: NCRYPT_KEY_HANDLE, slabel: windows_sys::core::PCSTR, pbrandoms: *mut u8, cbrandoms: u32, pbcontextvalue: *mut u8, cbcontextvalue: u16, pboutput: *mut u8, cboutput: u32, dwflags: u32) -> windows_sys::core::HRESULT>;
...
pub type SslExtractHandshakeKeyFn = Option<unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hprivatekey: NCRYPT_KEY_HANDLE, hpublickey: NCRYPT_KEY_HANDLE, hearlykey: NCRYPT_KEY_HANDLE, phhandshakekey: *mut NCRYPT_KEY_HANDLE, pparameterlist: *mut BCryptBufferDesc, dwflags: u32) -> windows_sys::core::HRESULT>;
pub type SslExtractMasterKeyFn = Option<unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hhandshakekey: NCRYPT_KEY_HANDLE, phmasterkey: *mut NCRYPT_KEY_HANDLE, pparameterlist: *mut BCryptBufferDesc, dwflags: u32) -> windows_sys::core::HRESULT>;
...
pub type SslGeneratePreMasterKeyFn = Option<unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hpublickey: NCRYPT_KEY_HANDLE, phpremasterkey: *mut NCRYPT_KEY_HANDLE, dwprotocol: u32, dwciphersuite: u32, pparameterlist: *mut BCryptBufferDesc, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32, dwflags: u32) -> windows_sys::core::HRESULT>;
...
pub type SslHashHandshakeFn = Option<unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hhandshakehash: NCRYPT_HASH_HANDLE, pbinput: *mut u8, cbinput: u32, dwflags: u32) -> windows_sys::core::HRESULT>;
...
pub type SslImportMasterKeyFn = Option<unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hprivatekey: NCRYPT_KEY_HANDLE, phmasterkey: *mut NCRYPT_KEY_HANDLE, dwprotocol: u32, dwciphersuite: u32, pparameterlist: *mut BCryptBufferDesc, pbencryptedkey: *mut u8, cbencryptedkey: u32, dwflags: u32) -> windows_sys::core::HRESULT>;
...
pub type SslOpenPrivateKeyFn = Option<unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, phprivatekey: *mut NCRYPT_KEY_HANDLE, pcertcontext: *mut CERT_CONTEXT, dwflags: u32) -> windows_sys::core::HRESULT>;
...
pub type SslVerifySignatureFn = Option<unsafe extern "system" fn(hsslprovider: NCRYPT_PROV_HANDLE, hpublickey: NCRYPT_KEY_HANDLE, pbhashvalue: *mut u8, cbhashvalue: u32, pbsignature: *mut u8, cbsignature: u32, dwflags: u32) -> windows_sys::core::HRESULT>;
...
pub const TIMESTAMP_INFO: windows_sys::core::PCSTR = 80i64 as _;
pub const TIMESTAMP_NO_AUTH_RETRIEVAL: u32 = 131072u32;
pub const TIMESTAMP_REQUEST: windows_sys::core::PCSTR = 78i64 as _;
pub const TIMESTAMP_RESPONSE: windows_sys::core::PCSTR = 79i64 as _;
...
pub const TIME_VALID_OID_FLUSH_CRL: windows_sys::core::PCSTR = 2i64 as _;
pub const TIME_VALID_OID_FLUSH_CRL_FROM_CERT: windows_sys::core::PCSTR = 3i64 as _;
pub const TIME_VALID_OID_FLUSH_CTL: windows_sys::core::PCSTR = 1i64 as _;
pub const TIME_VALID_OID_FLUSH_FRESHEST_CRL_FROM_CERT: windows_sys::core::PCSTR = 4i64 as _;
pub const TIME_VALID_OID_FLUSH_FRESHEST_CRL_FROM_CRL: windows_sys::core::PCSTR = 5i64 as _;
pub const TIME_VALID_OID_FLUSH_OBJECT_FUNC: windows_sys::core::PCSTR = windows_sys::core::s!("TimeValidDllFlushObject");
pub const TIME_VALID_OID_GET_CRL: windows_sys::core::PCSTR = 2i64 as _;
pub const TIME_VALID_OID_GET_CRL_FROM_CERT: windows_sys::core::PCSTR = 3i64 as _;
pub const TIME_VALID_OID_GET_CTL: windows_sys::core::PCSTR = 1i64 as _;
pub const TIME_VALID_OID_GET_FRESHEST_CRL_FROM_CERT: windows_sys::core::PCSTR = 4i64 as _;
pub const TIME_VALID_OID_GET_FRESHEST_CRL_FROM_CRL: windows_sys::core::PCSTR = 5i64 as _;
...
pub const URL_OID_CERTIFICATE_CRL_DIST_POINT: windows_sys::core::PCSTR = 2i64 as _;
pub const URL_OID_CERTIFICATE_CRL_DIST_POINT_AND_OCSP: windows_sys::core::PCSTR = 11i64 as _;
pub const URL_OID_CERTIFICATE_FRESHEST_CRL: windows_sys::core::PCSTR = 6i64 as _;
pub const URL_OID_CERTIFICATE_ISSUER: windows_sys::core::PCSTR = 1i64 as _;
pub const URL_OID_CERTIFICATE_OCSP: windows_sys::core::PCSTR = 9i64 as _;
pub const URL_OID_CERTIFICATE_OCSP_AND_CRL_DIST_POINT: windows_sys::core::PCSTR = 10i64 as _;
pub const URL_OID_CERTIFICATE_ONLY_OCSP: windows_sys::core::PCSTR = 13i64 as _;
pub const URL_OID_CRL_FRESHEST_CRL: windows_sys::core::PCSTR = 7i64 as _;
pub const URL_OID_CRL_ISSUER: windows_sys::core::PCSTR = 5i64 as _;
pub const URL_OID_CROSS_CERT_DIST_POINT: windows_sys::core::PCSTR = 8i64 as _;
pub const URL_OID_CROSS_CERT_SUBJECT_INFO_ACCESS: windows_sys::core::PCSTR = 12i64 as _;
pub const URL_OID_CTL_ISSUER: windows_sys::core::PCSTR = 3i64 as _;
pub const URL_OID_CTL_NEXT_UPDATE: windows_sys::core::PCSTR = 4i64 as _;
...
pub const X509_ALGORITHM_IDENTIFIER: windows_sys::core::PCSTR = 74i64 as _;
pub const X509_ALTERNATE_NAME: windows_sys::core::PCSTR = 12i64 as _;
pub const X509_ANY_STRING: i32 = 6i32;
pub const X509_ASN_ENCODING: CERT_QUERY_ENCODING_TYPE = 1u32;
pub const X509_AUTHORITY_INFO_ACCESS: windows_sys::core::PCSTR = 32i64 as _;
pub const X509_AUTHORITY_KEY_ID: windows_sys::core::PCSTR = 9i64 as _;
pub const X509_AUTHORITY_KEY_ID2: windows_sys::core::PCSTR = 31i64 as _;
pub const X509_BASIC_CONSTRAINTS: windows_sys::core::PCSTR = 13i64 as _;
pub const X509_BASIC_CONSTRAINTS2: windows_sys::core::PCSTR = 15i64 as _;
pub const X509_BIOMETRIC_EXT: windows_sys::core::PCSTR = 71i64 as _;
pub const X509_BITS: windows_sys::core::PCSTR = 26i64 as _;
pub const X509_BITS_WITHOUT_TRAILING_ZEROES: windows_sys::core::PCSTR = 51i64 as _;
pub const X509_CERT: windows_sys::core::PCSTR = 1i64 as _;
pub const X509_CERTIFICATE_TEMPLATE: windows_sys::core::PCSTR = 64i64 as _;
pub const X509_CERT_BUNDLE: windows_sys::core::PCSTR = 81i64 as _;
pub const X509_CERT_CRL_TO_BE_SIGNED: windows_sys::core::PCSTR = 3i64 as _;
pub const X509_CERT_PAIR: windows_sys::core::PCSTR = 53i64 as _;
pub const X509_CERT_POLICIES: windows_sys::core::PCSTR = 16i64 as _;
pub const X509_CERT_REQUEST_TO_BE_SIGNED: windows_sys::core::PCSTR = 4i64 as _;
pub const X509_CERT_TO_BE_SIGNED: windows_sys::core::PCSTR = 2i64 as _;
pub const X509_CHOICE_OF_TIME: windows_sys::core::PCSTR = 30i64 as _;
pub const X509_CRL_DIST_POINTS: windows_sys::core::PCSTR = 35i64 as _;
pub const X509_CRL_REASON_CODE: i32 = 29i32;
pub const X509_CROSS_CERT_DIST_POINTS: windows_sys::core::PCSTR = 58i64 as _;
pub const X509_DH_PARAMETERS: windows_sys::core::PCSTR = 47i64 as _;
pub const X509_DH_PUBLICKEY: i32 = 38i32;
pub const X509_DSS_PARAMETERS: windows_sys::core::PCSTR = 39i64 as _;
pub const X509_DSS_PUBLICKEY: i32 = 38i32;
pub const X509_DSS_SIGNATURE: windows_sys::core::PCSTR = 40i64 as _;
pub const X509_ECC_PARAMETERS: windows_sys::core::PCSTR = 85i64 as _;
pub const X509_ECC_PRIVATE_KEY: windows_sys::core::PCSTR = 82i64 as _;
pub const X509_ECC_SIGNATURE: windows_sys::core::PCSTR = 47i64 as _;
pub const X509_ENHANCED_KEY_USAGE: windows_sys::core::PCSTR = 36i64 as _;
pub const X509_ENUMERATED: windows_sys::core::PCSTR = 29i64 as _;
pub const X509_EXTENSIONS: windows_sys::core::PCSTR = 5i64 as _;
pub const X509_INTEGER: windows_sys::core::PCSTR = 27i64 as _;
pub const X509_ISSUING_DIST_POINT: windows_sys::core::PCSTR = 54i64 as _;
pub const X509_KEYGEN_REQUEST_TO_BE_SIGNED: windows_sys::core::PCSTR = 21i64 as _;
pub const X509_KEY_ATTRIBUTES: windows_sys::core::PCSTR = 10i64 as _;
pub const X509_KEY_USAGE: windows_sys::core::PCSTR = 14i64 as _;
pub const X509_KEY_USAGE_RESTRICTION: windows_sys::core::PCSTR = 11i64 as _;
pub const X509_LOGOTYPE_EXT: windows_sys::core::PCSTR = 70i64 as _;
pub const X509_MULTI_BYTE_INTEGER: windows_sys::core::PCSTR = 28i64 as _;
pub const X509_MULTI_BYTE_UINT: windows_sys::core::PCSTR = 38i64 as _;
pub const X509_NAME: windows_sys::core::PCSTR = 7i64 as _;
pub const X509_NAME_CONSTRAINTS: windows_sys::core::PCSTR = 55i64 as _;
pub const X509_NAME_VALUE: windows_sys::core::PCSTR = 6i64 as _;
pub const X509_NDR_ENCODING: u32 = 2u32;
pub const X509_OBJECT_IDENTIFIER: windows_sys::core::PCSTR = 73i64 as _;
pub const X509_OCTET_STRING: windows_sys::core::PCSTR = 25i64 as _;
pub const X509_PKIX_POLICY_QUALIFIER_USERNOTICE: windows_sys::core::PCSTR = 46i64 as _;
pub const X509_POLICY_CONSTRAINTS: windows_sys::core::PCSTR = 57i64 as _;
pub const X509_POLICY_MAPPINGS: windows_sys::core::PCSTR = 56i64 as _;
pub const X509_PUBLIC_KEY_INFO: windows_sys::core::PCSTR = 8i64 as _;
pub const X509_QC_STATEMENTS_EXT: windows_sys::core::PCSTR = 42i64 as _;
pub const X509_SEQUENCE_OF_ANY: windows_sys::core::PCSTR = 34i64 as _;
pub const X509_SUBJECT_DIR_ATTRS: windows_sys::core::PCSTR = 84i64 as _;
pub const X509_SUBJECT_INFO_ACCESS: i32 = 32i32;
pub const X509_UNICODE_ANY_STRING: i32 = 24i32;
pub const X509_UNICODE_NAME: windows_sys::core::PCSTR = 20i64 as _;
pub const X509_UNICODE_NAME_VALUE: windows_sys::core::PCSTR = 24i64 as _;
pub const X942_DH_PARAMETERS: windows_sys::core::PCSTR = 50i64 as _;
pub const X942_OTHER_INFO: windows_sys::core::PCSTR = 52i64 as _;
