pub type OpenPersonalTrustDBDialog = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
...
pub type OpenPersonalTrustDBDialogEx = unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, dwflags: u32, pvreserved: *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type WTHelperCertIsSelfSigned = unsafe extern "system" fn(dwencoding: u32, pcert: *mut super::Cryptography::CERT_INFO) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_Security_Cryptography")]
...
#[cfg(all(feature = "Win32_Security_Cryptography_Catalog", feature = "Win32_Security_Cryptography_Sip"))]
pub type WTHelperGetProvSignerFromChain = unsafe extern "system" fn(pprovdata: *mut CRYPT_PROVIDER_DATA, idxsigner: u32, fcountersigner: windows_sys::core::BOOL, idxcountersigner: u32) -> *mut CRYPT_PROVIDER_SGNR;
#[cfg(all(feature = "Win32_Security_Cryptography_Catalog", feature = "Win32_Security_Cryptography_Sip"))]
...
pub type WintrustAddActionID = unsafe extern "system" fn(pgactionid: *const windows_sys::core::GUID, fdwflags: u32, psprovinfo: *const CRYPT_REGISTER_ACTIONID) -> windows_sys::core::BOOL;
...
pub type WintrustAddDefaultForUsage = unsafe extern "system" fn(pszusageoid: windows_sys::core::PCSTR, psdefusage: *const CRYPT_PROVIDER_REGDEFUSAGE) -> windows_sys::core::BOOL;
...
pub type WintrustGetDefaultForUsage = unsafe extern "system" fn(dwaction: WINTRUST_GET_DEFAULT_FOR_USAGE_ACTION, pszusageoid: windows_sys::core::PCSTR, psusage: *mut CRYPT_PROVIDER_DEFUSAGE) -> windows_sys::core::BOOL;
...
#[cfg(all(feature = "Win32_Security_Cryptography_Catalog", feature = "Win32_Security_Cryptography_Sip"))]
pub type WintrustLoadFunctionPointers = unsafe extern "system" fn(pgactionid: *mut windows_sys::core::GUID, ppfns: *mut CRYPT_PROVIDER_FUNCTIONS) -> windows_sys::core::BOOL;
#[cfg(all(feature = "Win32_Security_Cryptography_Catalog", feature = "Win32_Security_Cryptography_Sip"))]
...
pub type WintrustRemoveActionID = unsafe extern "system" fn(pgactionid: *const windows_sys::core::GUID) -> windows_sys::core::BOOL;
...
pub type WintrustSetDefaultIncludePEPageHashes = unsafe extern "system" fn(fincludepepagehashes: windows_sys::core::BOOL);
...
pub type WintrustSetRegPolicyFlags = unsafe extern "system" fn(dwpolicyflags: WINTRUST_POLICY_FLAGS) -> windows_sys::core::BOOL;
