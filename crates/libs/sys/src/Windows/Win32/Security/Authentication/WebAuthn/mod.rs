...
pub type WebAuthNCancelCurrentOperation = unsafe extern "system" fn(pcancellationid: *const windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type WebAuthNDeletePlatformCredential = unsafe extern "system" fn(cbcredentialid: u32, pbcredentialid: *const u8) -> windows_sys::core::HRESULT;
...
pub type WebAuthNFreeAssertion = unsafe extern "system" fn(pwebauthnassertion: *const WEBAUTHN_ASSERTION);
windows_link::link!("webauthn.dll" "system" fn WebAuthNFreeAssertion(pwebauthnassertion : *const WEBAUTHN_ASSERTION));
pub type WebAuthNFreeAuthenticatorList = unsafe extern "system" fn(pauthenticatordetailslist: *const WEBAUTHN_AUTHENTICATOR_DETAILS_LIST);
...
pub type WebAuthNFreeCredentialAttestation = unsafe extern "system" fn(pwebauthncredentialattestation: *const WEBAUTHN_CREDENTIAL_ATTESTATION);
...
pub type WebAuthNFreePlatformCredentialList = unsafe extern "system" fn(pcredentialdetailslist: *const WEBAUTHN_CREDENTIAL_DETAILS_LIST);
...
pub type WebAuthNGetAuthenticatorList = unsafe extern "system" fn(pwebauthngetauthenticatorlistoptions: *const WEBAUTHN_AUTHENTICATOR_DETAILS_OPTIONS, ppauthenticatordetailslist: *mut *mut WEBAUTHN_AUTHENTICATOR_DETAILS_LIST) -> windows_sys::core::HRESULT;
...
pub type WebAuthNGetCancellationId = unsafe extern "system" fn(pcancellationid: *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type WebAuthNGetErrorName = unsafe extern "system" fn(hr: windows_sys::core::HRESULT) -> windows_sys::core::PCWSTR;
windows_link::link!("webauthn.dll" "system" fn WebAuthNGetErrorName(hr : windows_sys::core::HRESULT) -> windows_sys::core::PCWSTR);
pub type WebAuthNGetPlatformCredentialList = unsafe extern "system" fn(pgetcredentialsoptions: *const WEBAUTHN_GET_CREDENTIALS_OPTIONS, ppcredentialdetailslist: *mut *mut WEBAUTHN_CREDENTIAL_DETAILS_LIST) -> windows_sys::core::HRESULT;
...
pub type WebAuthNGetW3CExceptionDOMError = unsafe extern "system" fn(hr: windows_sys::core::HRESULT) -> windows_sys::core::HRESULT;
...
pub type WebAuthNIsUserVerifyingPlatformAuthenticatorAvailable = unsafe extern "system" fn(pbisuserverifyingplatformauthenticatoravailable: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
