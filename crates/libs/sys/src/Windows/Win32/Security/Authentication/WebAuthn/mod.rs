...
pub const AuthenticatorState_Disabled: AUTHENTICATOR_STATE = 0;
pub const AuthenticatorState_Enabled: AUTHENTICATOR_STATE = 1;
#[repr(C)]
...
pub const GetPublicKey: WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE = 3;
pub const GetUserVerificationCount: WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE = 2;
pub const GetUvCount: EXPERIMENTAL_WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE = 2;
pub type PLUGIN_LOCK_STATUS = i32;
pub const PerformUserVerification: WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE = 1;
...
pub const PluginLocked: PLUGIN_LOCK_STATUS = 0;
pub const PluginUnlocked: PLUGIN_LOCK_STATUS = 1;
...
pub const WEBAUTHN_PLUGIN_REQUEST_TYPE_CTAP2_CBOR: WEBAUTHN_PLUGIN_REQUEST_TYPE = 1;
