...
pub const ASC_REQ_ALLOW_CONTEXT_REPLAY: ASC_REQ_FLAGS = 4194304;
pub const ASC_REQ_ALLOW_MISSING_BINDINGS: ASC_REQ_FLAGS = 268435456;
pub const ASC_REQ_ALLOW_NON_USER_LOGONS: ASC_REQ_FLAGS = 2097152;
pub const ASC_REQ_ALLOW_NULL_SESSION: ASC_REQ_FLAGS = 1048576;
pub const ASC_REQ_CALL_LEVEL: ASC_REQ_FLAGS = 4096;
pub const ASC_REQ_CONFIDENTIALITY: ASC_REQ_FLAGS = 16;
pub const ASC_REQ_CONNECTION: ASC_REQ_FLAGS = 2048;
pub const ASC_REQ_DATAGRAM: ASC_REQ_FLAGS = 1024;
pub const ASC_REQ_DELEGATE: ASC_REQ_FLAGS = 1;
pub const ASC_REQ_EXPLICIT_SESSION: ASC_REQ_HIGH_FLAGS = 68719476736;
pub const ASC_REQ_EXTENDED_ERROR: ASC_REQ_FLAGS = 32768;
pub type ASC_REQ_FLAGS = u32;
pub const ASC_REQ_FRAGMENT_SUPPLIED: ASC_REQ_FLAGS = 8192;
pub const ASC_REQ_FRAGMENT_TO_FIT: ASC_REQ_FLAGS = 8388608;
pub type ASC_REQ_HIGH_FLAGS = u64;
pub const ASC_REQ_IDENTIFY: ASC_REQ_FLAGS = 524288;
pub const ASC_REQ_INTEGRITY: ASC_REQ_FLAGS = 131072;
pub const ASC_REQ_LICENSING: ASC_REQ_FLAGS = 262144;
pub const ASC_REQ_MESSAGES: ASC_REQ_HIGH_FLAGS = 4294967296;
pub const ASC_REQ_MUTUAL_AUTH: ASC_REQ_FLAGS = 2;
pub const ASC_REQ_NO_TOKEN: ASC_REQ_FLAGS = 16777216;
pub const ASC_REQ_PROXY_BINDINGS: ASC_REQ_FLAGS = 67108864;
pub const ASC_REQ_REPLAY_DETECT: ASC_REQ_FLAGS = 4;
pub const ASC_REQ_SEQUENCE_DETECT: ASC_REQ_FLAGS = 8;
pub const ASC_REQ_SESSION_TICKET: ASC_REQ_FLAGS = 64;
pub const ASC_REQ_STREAM: ASC_REQ_FLAGS = 65536;
pub const ASC_REQ_USE_DCE_STYLE: ASC_REQ_FLAGS = 512;
pub const ASC_REQ_USE_SESSION_KEY: ASC_REQ_FLAGS = 32;
...
pub const DOMAIN_LOCKOUT_ADMINS: DOMAIN_PASSWORD_PROPERTIES = 8;
pub const DOMAIN_NO_LM_OWF_CHANGE: i32 = 64;
pub const DOMAIN_PASSWORD_COMPLEX: DOMAIN_PASSWORD_PROPERTIES = 1;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const DOMAIN_PASSWORD_NO_ANON_CHANGE: DOMAIN_PASSWORD_PROPERTIES = 2;
pub const DOMAIN_PASSWORD_NO_CLEAR_CHANGE: DOMAIN_PASSWORD_PROPERTIES = 4;
pub type DOMAIN_PASSWORD_PROPERTIES = u32;
pub const DOMAIN_PASSWORD_STORE_CLEARTEXT: DOMAIN_PASSWORD_PROPERTIES = 16;
pub const DOMAIN_REFUSE_PASSWORD_CHANGE: DOMAIN_PASSWORD_PROPERTIES = 32;
pub const DS_INET_ADDRESS: KERB_ADDRESS_TYPE = 1;
pub const DS_NETBIOS_ADDRESS: KERB_ADDRESS_TYPE = 2;
...
pub const ISC_REQ_CALL_LEVEL: ISC_REQ_FLAGS = 4096;
pub const ISC_REQ_CONFIDENTIALITY: ISC_REQ_FLAGS = 16;
pub const ISC_REQ_CONFIDENTIALITY_ONLY: ISC_REQ_FLAGS = 1073741824;
pub const ISC_REQ_CONNECTION: ISC_REQ_FLAGS = 2048;
pub const ISC_REQ_DATAGRAM: ISC_REQ_FLAGS = 1024;
pub const ISC_REQ_DEFERRED_CRED_VALIDATION: ISC_REQ_HIGH_FLAGS = 8589934592;
pub const ISC_REQ_DELEGATE: ISC_REQ_FLAGS = 1;
pub const ISC_REQ_EXPLICIT_SESSION: ISC_REQ_HIGH_FLAGS = 68719476736;
pub const ISC_REQ_EXTENDED_ERROR: ISC_REQ_FLAGS = 16384;
pub type ISC_REQ_FLAGS = u32;
pub const ISC_REQ_FORWARD_CREDENTIALS: ISC_REQ_FLAGS = 4194304;
pub const ISC_REQ_FRAGMENT_SUPPLIED: ISC_REQ_FLAGS = 8192;
pub const ISC_REQ_FRAGMENT_TO_FIT: ISC_REQ_FLAGS = 2097152;
pub type ISC_REQ_HIGH_FLAGS = u64;
pub const ISC_REQ_IDENTIFY: ISC_REQ_FLAGS = 131072;
pub const ISC_REQ_INTEGRITY: ISC_REQ_FLAGS = 65536;
pub const ISC_REQ_MANUAL_CRED_VALIDATION: ISC_REQ_FLAGS = 524288;
pub const ISC_REQ_MESSAGES: ISC_REQ_HIGH_FLAGS = 4294967296;
pub const ISC_REQ_MUTUAL_AUTH: ISC_REQ_FLAGS = 2;
pub const ISC_REQ_NO_INTEGRITY: ISC_REQ_FLAGS = 8388608;
pub const ISC_REQ_NO_POST_HANDSHAKE_AUTH: ISC_REQ_HIGH_FLAGS = 17179869184;
pub const ISC_REQ_NULL_SESSION: ISC_REQ_FLAGS = 262144;
pub const ISC_REQ_PROMPT_FOR_CREDS: ISC_REQ_FLAGS = 64;
pub const ISC_REQ_REPLAY_DETECT: ISC_REQ_FLAGS = 4;
pub const ISC_REQ_RESERVED1: ISC_REQ_FLAGS = 1048576;
pub const ISC_REQ_REUSE_SESSION_TICKETS: ISC_REQ_HIGH_FLAGS = 34359738368;
pub const ISC_REQ_SEQUENCE_DETECT: ISC_REQ_FLAGS = 8;
pub const ISC_REQ_STREAM: ISC_REQ_FLAGS = 32768;
pub const ISC_REQ_UNVERIFIED_TARGET_NAME: ISC_REQ_FLAGS = 536870912;
pub const ISC_REQ_USE_DCE_STYLE: ISC_REQ_FLAGS = 512;
pub const ISC_REQ_USE_HTTP_STYLE: ISC_REQ_FLAGS = 16777216;
pub const ISC_REQ_USE_SESSION_KEY: ISC_REQ_FLAGS = 32;
...
pub const KERB_ETYPE_DES_CBC_CRC: KERB_CRYPTO_KEY_TYPE = 1;
pub const KERB_ETYPE_DES_CBC_MD4: KERB_CRYPTO_KEY_TYPE = 2;
pub const KERB_ETYPE_DES_CBC_MD5: KERB_CRYPTO_KEY_TYPE = 3;
...
pub const KERB_ETYPE_NULL: KERB_CRYPTO_KEY_TYPE = 0;
pub const KERB_ETYPE_PKCS7_PUB: u32 = 13;
pub const KERB_ETYPE_RC2_CBC_ENV: u32 = 12;
pub const KERB_ETYPE_RC4_HMAC_NT: KERB_CRYPTO_KEY_TYPE = 23;
...
pub const KERB_ETYPE_RC4_MD4: KERB_CRYPTO_KEY_TYPE = -128;
...
pub const KERB_REQUEST_ADD_CREDENTIAL: KERB_REQUEST_FLAGS = 1;
pub const KERB_REQUEST_CRED_LOCAL_ACCOUNT: u32 = 8;
pub type KERB_REQUEST_FLAGS = u32;
pub const KERB_REQUEST_REMOVE_CREDENTIAL: KERB_REQUEST_FLAGS = 4;
pub const KERB_REQUEST_REPLACE_CREDENTIAL: KERB_REQUEST_FLAGS = 2;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const KERB_TICKET_FLAGS_forwardable: KERB_TICKET_FLAGS = 1073741824;
pub const KERB_TICKET_FLAGS_forwarded: KERB_TICKET_FLAGS = 536870912;
pub const KERB_TICKET_FLAGS_hw_authent: KERB_TICKET_FLAGS = 1048576;
pub const KERB_TICKET_FLAGS_initial: KERB_TICKET_FLAGS = 4194304;
pub const KERB_TICKET_FLAGS_invalid: KERB_TICKET_FLAGS = 16777216;
pub const KERB_TICKET_FLAGS_may_postdate: KERB_TICKET_FLAGS = 67108864;
pub const KERB_TICKET_FLAGS_name_canonicalize: u32 = 65536;
pub const KERB_TICKET_FLAGS_ok_as_delegate: KERB_TICKET_FLAGS = 262144;
pub const KERB_TICKET_FLAGS_postdated: KERB_TICKET_FLAGS = 33554432;
pub const KERB_TICKET_FLAGS_pre_authent: KERB_TICKET_FLAGS = 2097152;
pub const KERB_TICKET_FLAGS_proxiable: KERB_TICKET_FLAGS = 268435456;
pub const KERB_TICKET_FLAGS_proxy: KERB_TICKET_FLAGS = 134217728;
pub const KERB_TICKET_FLAGS_renewable: KERB_TICKET_FLAGS = 8388608;
pub const KERB_TICKET_FLAGS_reserved: KERB_TICKET_FLAGS = 2147483648;
pub const KERB_TICKET_FLAGS_reserved1: KERB_TICKET_FLAGS = 1;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const LOGON_CACHED_ACCOUNT: MSV_SUB_AUTHENTICATION_FILTER = 4;
pub const LOGON_EXTRA_SIDS: MSV_SUB_AUTHENTICATION_FILTER = 32;
pub const LOGON_GRACE_LOGON: u32 = 16777216;
pub const LOGON_GUEST: MSV_SUB_AUTHENTICATION_FILTER = 1;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const LOGON_NOENCRYPTION: MSV_SUB_AUTHENTICATION_FILTER = 2;
...
pub const LOGON_PROFILE_PATH_RETURNED: MSV_SUB_AUTHENTICATION_FILTER = 1024;
pub const LOGON_RESOURCE_GROUPS: MSV_SUB_AUTHENTICATION_FILTER = 512;
pub const LOGON_SERVER_TRUST_ACCOUNT: MSV_SUB_AUTHENTICATION_FILTER = 128;
pub const LOGON_SUBAUTH_SESSION_KEY: MSV_SUB_AUTHENTICATION_FILTER = 64;
pub const LOGON_USED_LM_PASSWORD: MSV_SUB_AUTHENTICATION_FILTER = 8;
...
pub const MSV1_0_ALLOW_SERVER_TRUST_ACCOUNT: MSV_SUBAUTH_LOGON_PARAMETER_CONTROL = 32;
pub const MSV1_0_ALLOW_WORKSTATION_TRUST_ACCOUNT: MSV_SUBAUTH_LOGON_PARAMETER_CONTROL = 2048;
...
pub const MSV1_0_CLEARTEXT_PASSWORD_ALLOWED: MSV_SUBAUTH_LOGON_PARAMETER_CONTROL = 2;
...
pub const MSV1_0_CRED_LM_PRESENT: MSV_SUPPLEMENTAL_CREDENTIAL_FLAGS = 1;
pub const MSV1_0_CRED_NT_PRESENT: MSV_SUPPLEMENTAL_CREDENTIAL_FLAGS = 2;
pub const MSV1_0_CRED_REMOVED: u32 = 4;
pub const MSV1_0_CRED_SHA_PRESENT: u32 = 16;
pub const MSV1_0_CRED_VERSION: MSV_SUPPLEMENTAL_CREDENTIAL_FLAGS = 0;
...
pub const MSV1_0_DONT_TRY_GUEST_ACCOUNT: MSV_SUBAUTH_LOGON_PARAMETER_CONTROL = 16;
pub const MSV1_0_GUEST_LOGON: MSV1_0 = 2;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const MSV1_0_PASSTHRU: MSV1_0 = 1;
...
pub const MSV1_0_RETURN_PASSWORD_EXPIRY: MSV_SUBAUTH_LOGON_PARAMETER_CONTROL = 64;
pub const MSV1_0_RETURN_PROFILE_PATH: MSV_SUBAUTH_LOGON_PARAMETER_CONTROL = 512;
pub const MSV1_0_RETURN_USER_PARAMETERS: MSV_SUBAUTH_LOGON_PARAMETER_CONTROL = 8;
...
pub const MSV1_0_TRY_GUEST_ACCOUNT_ONLY: MSV_SUBAUTH_LOGON_PARAMETER_CONTROL = 256;
pub const MSV1_0_TRY_SPECIFIED_DOMAIN_ONLY: MSV_SUBAUTH_LOGON_PARAMETER_CONTROL = 1024;
pub const MSV1_0_UPDATE_LOGON_STATISTICS: MSV_SUBAUTH_LOGON_PARAMETER_CONTROL = 4;
...
pub const NetlogonGenericInformation: NETLOGON_LOGON_INFO_CLASS = 4;
pub const NetlogonInteractiveInformation: NETLOGON_LOGON_INFO_CLASS = 1;
pub const NetlogonInteractiveTransitiveInformation: NETLOGON_LOGON_INFO_CLASS = 5;
pub const NetlogonNetworkInformation: NETLOGON_LOGON_INFO_CLASS = 2;
pub const NetlogonNetworkTransitiveInformation: NETLOGON_LOGON_INFO_CLASS = 6;
pub const NetlogonServiceInformation: NETLOGON_LOGON_INFO_CLASS = 3;
pub const NetlogonServiceTransitiveInformation: NETLOGON_LOGON_INFO_CLASS = 7;
pub const NetlogonTicketLogonInformation: NETLOGON_LOGON_INFO_CLASS = 8;
...
pub const SCH_CRED_AUTO_CRED_VALIDATION: SCHANNEL_CRED_FLAGS = 32;
pub const SCH_CRED_CACHE_ONLY_URL_RETRIEVAL: u32 = 32768;
pub const SCH_CRED_CACHE_ONLY_URL_RETRIEVAL_ON_CREATE: SCHANNEL_CRED_FLAGS = 131072;
...
pub const SCH_CRED_IGNORE_NO_REVOCATION_CHECK: SCHANNEL_CRED_FLAGS = 2048;
pub const SCH_CRED_IGNORE_REVOCATION_OFFLINE: SCHANNEL_CRED_FLAGS = 4096;
pub const SCH_CRED_MANUAL_CRED_VALIDATION: SCHANNEL_CRED_FLAGS = 8;
...
pub const SCH_CRED_NO_SERVERNAME_CHECK: SCHANNEL_CRED_FLAGS = 4;
pub const SCH_CRED_NO_SYSTEM_MAPPER: SCHANNEL_CRED_FLAGS = 2;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const SCH_CRED_REVOCATION_CHECK_CHAIN: SCHANNEL_CRED_FLAGS = 512;
pub const SCH_CRED_REVOCATION_CHECK_CHAIN_EXCLUDE_ROOT: SCHANNEL_CRED_FLAGS = 1024;
pub const SCH_CRED_REVOCATION_CHECK_END_CERT: SCHANNEL_CRED_FLAGS = 256;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const SCH_CRED_USE_DEFAULT_CREDS: SCHANNEL_CRED_FLAGS = 64;
...
pub const SCH_DISABLE_RECONNECTS: SCHANNEL_CRED_FLAGS = 128;
...
pub const SCH_SEND_AUX_RECORD: SCHANNEL_CRED_FLAGS = 2097152;
pub const SCH_SEND_ROOT_CERT: SCHANNEL_CRED_FLAGS = 262144;
pub const SCH_USE_DTLS_ONLY: u32 = 16777216;
pub const SCH_USE_PRESHAREDKEY_ONLY: SCHANNEL_CRED_FLAGS = 8388608;
...
pub const SECPKG_ATTR_ACCESS_TOKEN: SECPKG_ATTR = 18;
pub const SECPKG_ATTR_APPLICATION_PROTOCOL: u32 = 35;
pub const SECPKG_ATTR_APP_DATA: SECPKG_ATTR = 94;
pub const SECPKG_ATTR_AUTHENTICATION_ID: u32 = 20;
pub const SECPKG_ATTR_AUTHORITY: SECPKG_ATTR = 6;
...
pub const SECPKG_ATTR_CERT_TRUST_STATUS: SECPKG_ATTR = 2147483780;
...
pub const SECPKG_ATTR_CLIENT_SPECIFIED_TARGET: SECPKG_ATTR = 27;
pub const SECPKG_ATTR_CONNECTION_INFO: SECPKG_ATTR = 90;
...
pub const SECPKG_ATTR_CREDS: SECPKG_ATTR = 2147483776;
pub const SECPKG_ATTR_CREDS_2: SECPKG_ATTR = 2147483782;
pub const SECPKG_ATTR_C_ACCESS_TOKEN: SECPKG_ATTR = 2147483666;
pub const SECPKG_ATTR_C_FULL_ACCESS_TOKEN: SECPKG_ATTR = 2147483778;
pub const SECPKG_ATTR_DCE_INFO: SECPKG_ATTR = 3;
pub const SECPKG_ATTR_DTLS_MTU: SECPKG_ATTR = 34;
pub const SECPKG_ATTR_EAP_KEY_BLOCK: SECPKG_ATTR = 91;
pub const SECPKG_ATTR_EAP_PRF_INFO: SECPKG_ATTR = 101;
pub const SECPKG_ATTR_EARLY_START: SECPKG_ATTR = 105;
pub const SECPKG_ATTR_ENDPOINT_BINDINGS: SECPKG_ATTR = 26;
pub const SECPKG_ATTR_FLAGS: SECPKG_ATTR = 14;
pub const SECPKG_ATTR_ISSUER_LIST: u32 = 80;
pub const SECPKG_ATTR_ISSUER_LIST_EX: SECPKG_ATTR = 89;
pub const SECPKG_ATTR_IS_LOOPBACK: u32 = 37;
pub const SECPKG_ATTR_KEYING_MATERIAL: u32 = 107;
pub const SECPKG_ATTR_KEYING_MATERIAL_INFO: SECPKG_ATTR = 106;
pub const SECPKG_ATTR_KEYING_MATERIAL_INPROC: u32 = 112;
pub const SECPKG_ATTR_KEYING_MATERIAL_TOKEN_BINDING: u32 = 111;
pub const SECPKG_ATTR_KEY_INFO: SECPKG_ATTR = 5;
pub const SECPKG_ATTR_LAST_CLIENT_TOKEN_STATUS: SECPKG_ATTR = 30;
pub type SECPKG_ATTR_LCT_STATUS = i32;
pub const SECPKG_ATTR_LIFESPAN: SECPKG_ATTR = 2;
pub const SECPKG_ATTR_LOCAL_CERT_CONTEXT: SECPKG_ATTR = 84;
pub const SECPKG_ATTR_LOCAL_CERT_INFO: u32 = 99;
pub const SECPKG_ATTR_LOCAL_CRED: SECPKG_ATTR = 82;
pub const SECPKG_ATTR_LOGOFF_TIME: u32 = 21;
pub const SECPKG_ATTR_MAPPED_CRED_ATTR: u32 = 92;
pub const SECPKG_ATTR_NAMES: SECPKG_ATTR = 1;
pub const SECPKG_ATTR_NATIVE_NAMES: SECPKG_ATTR = 13;
pub const SECPKG_ATTR_NEGOTIATED_TLS_EXTENSIONS: u32 = 36;
pub const SECPKG_ATTR_NEGOTIATION_INFO: SECPKG_ATTR = 12;
pub const SECPKG_ATTR_NEGOTIATION_PACKAGE: SECPKG_ATTR = 2147483777;
...
pub const SECPKG_ATTR_PACKAGE_INFO: SECPKG_ATTR = 10;
pub const SECPKG_ATTR_PASSWORD_EXPIRY: SECPKG_ATTR = 8;
...
pub const SECPKG_ATTR_ROOT_STORE: SECPKG_ATTR = 85;
...
pub const SECPKG_ATTR_SERVER_AUTH_FLAGS: SECPKG_ATTR = 2147483779;
pub const SECPKG_ATTR_SESSION_INFO: SECPKG_ATTR = 93;
pub const SECPKG_ATTR_SESSION_KEY: SECPKG_ATTR = 9;
pub const SECPKG_ATTR_SESSION_TICKET_KEYS: u32 = 115;
pub const SECPKG_ATTR_SIZES: SECPKG_ATTR = 0;
pub const SECPKG_ATTR_SRTP_PARAMETERS: u32 = 108;
pub const SECPKG_ATTR_STREAM_SIZES: SECPKG_ATTR = 4;
pub const SECPKG_ATTR_SUBJECT_SECURITY_ATTRIBUTES: SECPKG_ATTR = 124;
pub const SECPKG_ATTR_SUPPORTED_ALGS: u32 = 86;
pub const SECPKG_ATTR_SUPPORTED_PROTOCOLS: u32 = 88;
pub const SECPKG_ATTR_SUPPORTED_SIGNATURES: SECPKG_ATTR = 102;
pub const SECPKG_ATTR_TARGET: u32 = 19;
pub const SECPKG_ATTR_TARGET_INFORMATION: SECPKG_ATTR = 17;
...
pub const SECPKG_ATTR_UNIQUE_BINDINGS: SECPKG_ATTR = 25;
...
pub const SECPKG_CONTEXT_EXPORT_DELETE_OLD: EXPORT_SECURITY_CONTEXT_FLAGS = 2;
pub const SECPKG_CONTEXT_EXPORT_RESET_NEW: EXPORT_SECURITY_CONTEXT_FLAGS = 1;
pub const SECPKG_CONTEXT_EXPORT_TO_KERNEL: EXPORT_SECURITY_CONTEXT_FLAGS = 4;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const SECPKG_OPTIONS_TYPE_LSA: SECURITY_PACKAGE_OPTIONS_TYPE = 1;
pub const SECPKG_OPTIONS_TYPE_SSPI: SECURITY_PACKAGE_OPTIONS_TYPE = 2;
pub const SECPKG_OPTIONS_TYPE_UNKNOWN: SECURITY_PACKAGE_OPTIONS_TYPE = 0;
pub const SECPKG_PACKAGE_CHANGE_LOAD: SECPKG_PACKAGE_CHANGE_TYPE = 0;
pub const SECPKG_PACKAGE_CHANGE_SELECT: SECPKG_PACKAGE_CHANGE_TYPE = 2;
pub type SECPKG_PACKAGE_CHANGE_TYPE = u32;
pub const SECPKG_PACKAGE_CHANGE_UNLOAD: SECPKG_PACKAGE_CHANGE_TYPE = 1;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const SSL_SESSION_DISABLE_RECONNECTS: SCHANNEL_SESSION_TOKEN_FLAGS = 2;
pub const SSL_SESSION_ENABLE_RECONNECTS: SCHANNEL_SESSION_TOKEN_FLAGS = 1;
...
pub const TLS1_ALERT_FATAL: SCHANNEL_ALERT_TOKEN_ALERT_TYPE = 2;
...
pub const TLS1_ALERT_WARNING: SCHANNEL_ALERT_TOKEN_ALERT_TYPE = 1;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const TOKENBINDING_EXTENSION_FORMAT_UNDEFINED: TOKENBINDING_EXTENSION_FORMAT = 0;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const TOKENBINDING_KEY_PARAMETERS_TYPE_ANYEXISTING: TOKENBINDING_KEY_PARAMETERS_TYPE = 255;
pub const TOKENBINDING_KEY_PARAMETERS_TYPE_ECDSAP256: TOKENBINDING_KEY_PARAMETERS_TYPE = 2;
pub const TOKENBINDING_KEY_PARAMETERS_TYPE_RSA2048_PKCS: TOKENBINDING_KEY_PARAMETERS_TYPE = 0;
pub const TOKENBINDING_KEY_PARAMETERS_TYPE_RSA2048_PSS: TOKENBINDING_KEY_PARAMETERS_TYPE = 1;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const TOKENBINDING_TYPE_PROVIDED: TOKENBINDING_TYPE = 0;
pub const TOKENBINDING_TYPE_REFERRED: TOKENBINDING_TYPE = 1;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const TRUST_ATTRIBUTE_CROSS_ORGANIZATION: TRUSTED_DOMAIN_TRUST_ATTRIBUTES = 16;
...
pub const TRUST_ATTRIBUTE_FILTER_SIDS: TRUSTED_DOMAIN_TRUST_ATTRIBUTES = 4;
pub const TRUST_ATTRIBUTE_FOREST_TRANSITIVE: TRUSTED_DOMAIN_TRUST_ATTRIBUTES = 8;
pub const TRUST_ATTRIBUTE_NON_TRANSITIVE: TRUSTED_DOMAIN_TRUST_ATTRIBUTES = 1;
pub const TRUST_ATTRIBUTE_PIM_TRUST: u32 = 1024;
pub const TRUST_ATTRIBUTE_QUARANTINED_DOMAIN: u32 = 4;
pub const TRUST_ATTRIBUTE_TREAT_AS_EXTERNAL: TRUSTED_DOMAIN_TRUST_ATTRIBUTES = 64;
...
pub const TRUST_ATTRIBUTE_UPLEVEL_ONLY: TRUSTED_DOMAIN_TRUST_ATTRIBUTES = 2;
pub const TRUST_ATTRIBUTE_WITHIN_FOREST: TRUSTED_DOMAIN_TRUST_ATTRIBUTES = 32;
pub const TRUST_AUTH_TYPE_CLEAR: LSA_AUTH_INFORMATION_AUTH_TYPE = 2;
pub const TRUST_AUTH_TYPE_NONE: LSA_AUTH_INFORMATION_AUTH_TYPE = 0;
pub const TRUST_AUTH_TYPE_NT4OWF: LSA_AUTH_INFORMATION_AUTH_TYPE = 1;
pub const TRUST_AUTH_TYPE_VERSION: LSA_AUTH_INFORMATION_AUTH_TYPE = 3;
pub const TRUST_DIRECTION_BIDIRECTIONAL: TRUSTED_DOMAIN_TRUST_DIRECTION = 3;
pub const TRUST_DIRECTION_DISABLED: TRUSTED_DOMAIN_TRUST_DIRECTION = 0;
pub const TRUST_DIRECTION_INBOUND: TRUSTED_DOMAIN_TRUST_DIRECTION = 1;
pub const TRUST_DIRECTION_OUTBOUND: TRUSTED_DOMAIN_TRUST_DIRECTION = 2;
pub const TRUST_TYPE_AAD: u32 = 5;
pub const TRUST_TYPE_DCE: TRUSTED_DOMAIN_TRUST_TYPE = 4;
pub const TRUST_TYPE_DOWNLEVEL: TRUSTED_DOMAIN_TRUST_TYPE = 1;
pub const TRUST_TYPE_MIT: TRUSTED_DOMAIN_TRUST_TYPE = 3;
pub const TRUST_TYPE_UPLEVEL: TRUSTED_DOMAIN_TRUST_TYPE = 2;
...
pub const TlsParametersCngAlgUsageCertSig: eTlsAlgorithmUsage = 4;
pub const TlsParametersCngAlgUsageCipher: eTlsAlgorithmUsage = 2;
pub const TlsParametersCngAlgUsageDigest: eTlsAlgorithmUsage = 3;
pub const TlsParametersCngAlgUsageKeyExchange: eTlsAlgorithmUsage = 0;
pub const TlsParametersCngAlgUsageSignature: eTlsAlgorithmUsage = 1;
