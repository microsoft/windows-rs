...
windows_link::link!("secur32.dll" "system" fn AcceptSecurityContext(phcredential : *mut super::super::Credentials:: SecHandle, phcontext : *mut super::super::Credentials:: SecHandle, pinput : *mut SecBufferDesc, fcontextreq : ASC_REQ_FLAGS, targetdatarep : u32, phnewcontext : *mut super::super::Credentials:: SecHandle, poutput : *mut SecBufferDesc, pfcontextattr : *mut u32, ptsexpiry : *mut i64) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Credentials")]
...
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("secur32.dll" "system" fn AcquireCredentialsHandleW(pszprincipal : windows_sys::core::PCWSTR, pszpackage : windows_sys::core::PCWSTR, fcredentialuse : SECPKG_CRED, pvlogonid : *mut core::ffi::c_void, pauthdata : *mut core::ffi::c_void, pgetkeyfn : SEC_GET_KEY_FN, pvgetkeyargument : *mut core::ffi::c_void, phcredential : *mut super::super::Credentials:: SecHandle, ptsexpiry : *mut i64) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Credentials")]
...
windows_link::link!("secur32.dll" "system" fn AddSecurityPackageA(pszpackagename : windows_sys::core::PCSTR, poptions : *mut SECURITY_PACKAGE_OPTIONS) -> windows_sys::core::HRESULT);
...
windows_link::link!("advapi32.dll" "system" fn AuditComputeEffectivePolicyBySid(psid : super::super:: PSID, psubcategoryguids : *mut windows_sys::core::GUID, dwpolicycount : u32, ppauditpolicy : *mut *mut AUDIT_POLICY_INFORMATION) -> bool);
...
windows_link::link!("advapi32.dll" "system" fn AuditLookupCategoryIdFromCategoryGuid(pauditcategoryguid : *mut windows_sys::core::GUID, pauditcategoryid : *mut POLICY_AUDIT_EVENT_TYPE) -> bool);
windows_link::link!("advapi32.dll" "system" fn AuditLookupCategoryNameA(pauditcategoryguid : *mut windows_sys::core::GUID, ppszcategoryname : *mut windows_sys::core::PSTR) -> bool);
...
windows_link::link!("advapi32.dll" "system" fn AuditLookupSubCategoryNameA(pauditsubcategoryguid : *mut windows_sys::core::GUID, ppszsubcategoryname : *mut windows_sys::core::PSTR) -> bool);
windows_link::link!("advapi32.dll" "system" fn AuditLookupSubCategoryNameW(pauditsubcategoryguid : *mut windows_sys::core::GUID, ppszsubcategoryname : *mut windows_sys::core::PWSTR) -> bool);
...
windows_link::link!("advapi32.dll" "system" fn AuditQuerySystemPolicy(psubcategoryguids : *mut windows_sys::core::GUID, dwpolicycount : u32, ppauditpolicy : *mut *mut AUDIT_POLICY_INFORMATION) -> bool);
windows_link::link!("advapi32.dll" "system" fn AuditSetGlobalSaclA(objecttypename : windows_sys::core::PCSTR, acl : *mut super::super:: ACL) -> bool);
windows_link::link!("advapi32.dll" "system" fn AuditSetGlobalSaclW(objecttypename : windows_sys::core::PCWSTR, acl : *mut super::super:: ACL) -> bool);
windows_link::link!("advapi32.dll" "system" fn AuditSetPerUserPolicy(psid : super::super:: PSID, pauditpolicy : *mut AUDIT_POLICY_INFORMATION, dwpolicycount : u32) -> bool);
...
windows_link::link!("secur32.dll" "system" fn ChangeAccountPasswordA(pszpackagename : *mut i8, pszdomainname : *mut i8, pszaccountname : *mut i8, pszoldpassword : *mut i8, psznewpassword : *mut i8, bimpersonating : bool, dwreserved : u32, poutput : *mut SecBufferDesc) -> windows_sys::core::HRESULT);
windows_link::link!("secur32.dll" "system" fn ChangeAccountPasswordW(pszpackagename : *mut u16, pszdomainname : *mut u16, pszaccountname : *mut u16, pszoldpassword : *mut u16, psznewpassword : *mut u16, bimpersonating : bool, dwreserved : u32, poutput : *mut SecBufferDesc) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("secur32.dll" "system" fn CompleteAuthToken(phcontext : *mut super::super::Credentials:: SecHandle, ptoken : *mut SecBufferDesc) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("secur32.dll" "system" fn CredMarshalTargetInfo(intargetinfo : *mut super::super::Credentials:: CREDENTIAL_TARGET_INFORMATIONW, buffer : *mut *mut u16, buffersize : *mut u32) -> super::super::super::Foundation:: NTSTATUS);
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("secur32.dll" "system" fn CredUnmarshalTargetInfo(buffer : *mut u16, buffersize : u32, rettargetinfo : *mut *mut super::super::Credentials:: CREDENTIAL_TARGET_INFORMATIONW, retactualsize : *mut u32) -> super::super::super::Foundation:: NTSTATUS);
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("secur32.dll" "system" fn DecryptMessage(phcontext : *mut super::super::Credentials:: SecHandle, pmessage : *mut SecBufferDesc, messageseqno : u32, pfqop : *mut u32) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("secur32.dll" "system" fn DeleteSecurityContext(phcontext : *mut super::super::Credentials:: SecHandle) -> windows_sys::core::HRESULT);
...
windows_link::link!("secur32.dll" "system" fn GetComputerObjectNameA(nameformat : EXTENDED_NAME_FORMAT, lpnamebuffer : windows_sys::core::PCSTR, nsize : *mut u32) -> bool);
windows_link::link!("secur32.dll" "system" fn GetComputerObjectNameW(nameformat : EXTENDED_NAME_FORMAT, lpnamebuffer : windows_sys::core::PCWSTR, nsize : *mut u32) -> bool);
...
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("secur32.dll" "system" fn ImportSecurityContextA(pszpackage : windows_sys::core::PCSTR, ppackedcontext : *mut SecBuffer, token : *mut core::ffi::c_void, phcontext : *mut super::super::Credentials:: SecHandle) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("secur32.dll" "system" fn ImportSecurityContextW(pszpackage : windows_sys::core::PCWSTR, ppackedcontext : *mut SecBuffer, token : *mut core::ffi::c_void, phcontext : *mut super::super::Credentials:: SecHandle) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Credentials")]
...
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("secur32.dll" "system" fn InitializeSecurityContextA(phcredential : *mut super::super::Credentials:: SecHandle, phcontext : *mut super::super::Credentials:: SecHandle, psztargetname : *mut i8, fcontextreq : ISC_REQ_FLAGS, reserved1 : u32, targetdatarep : u32, pinput : *mut SecBufferDesc, reserved2 : u32, phnewcontext : *mut super::super::Credentials:: SecHandle, poutput : *mut SecBufferDesc, pfcontextattr : *mut u32, ptsexpiry : *mut i64) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Credentials")]
...
windows_link::link!("advapi32.dll" "system" fn LsaAddAccountRights(policyhandle : LSA_HANDLE, accountsid : super::super:: PSID, userrights : *mut LSA_UNICODE_STRING, countofrights : u32) -> super::super::super::Foundation:: NTSTATUS);
windows_link::link!("secur32.dll" "system" fn LsaCallAuthenticationPackage(lsahandle : super::super::super::Foundation:: HANDLE, authenticationpackage : u32, protocolsubmitbuffer : *mut core::ffi::c_void, submitbufferlength : u32, protocolreturnbuffer : *mut *mut core::ffi::c_void, returnbufferlength : *mut u32, protocolstatus : *mut i32) -> super::super::super::Foundation:: NTSTATUS);
...
windows_link::link!("advapi32.dll" "system" fn LsaEnumerateAccountsWithUserRight(policyhandle : LSA_HANDLE, userright : *mut LSA_UNICODE_STRING, buffer : *mut *mut core::ffi::c_void, countreturned : *mut u32) -> super::super::super::Foundation:: NTSTATUS);
...
windows_link::link!("secur32.dll" "system" fn LsaFreeReturnBuffer(buffer : *mut core::ffi::c_void) -> super::super::super::Foundation:: NTSTATUS);
windows_link::link!("advapi32.dll" "system" fn LsaGetAppliedCAPIDs(systemname : *mut LSA_UNICODE_STRING, capids : *mut *mut super::super:: PSID, capidcount : *mut u32) -> super::super::super::Foundation:: NTSTATUS);
windows_link::link!("secur32.dll" "system" fn LsaGetLogonSessionData(logonid : *mut super::super::super::Foundation:: LUID, pplogonsessiondata : *mut *mut SECURITY_LOGON_SESSION_DATA) -> super::super::super::Foundation:: NTSTATUS);
...
windows_link::link!("advapi32.dll" "system" fn LsaLookupSids2(policyhandle : LSA_HANDLE, lookupoptions : u32, count : u32, sids : *mut super::super:: PSID, referenceddomains : *mut *mut LSA_REFERENCED_DOMAIN_LIST, names : *mut *mut LSA_TRANSLATED_NAME) -> super::super::super::Foundation:: NTSTATUS);
windows_link::link!("advapi32.dll" "system" fn LsaNtStatusToWinError(status : super::super::super::Foundation:: NTSTATUS) -> u32);
windows_link::link!("advapi32.dll" "system" fn LsaOpenPolicy(systemname : *mut LSA_UNICODE_STRING, objectattributes : *mut LSA_OBJECT_ATTRIBUTES, desiredaccess : u32, policyhandle : *mut LSA_HANDLE) -> super::super::super::Foundation:: NTSTATUS);
windows_link::link!("advapi32.dll" "system" fn LsaOpenTrustedDomainByName(policyhandle : LSA_HANDLE, trusteddomainname : *mut LSA_UNICODE_STRING, desiredaccess : u32, trusteddomainhandle : *mut LSA_HANDLE) -> super::super::super::Foundation:: NTSTATUS);
windows_link::link!("advapi32.dll" "system" fn LsaQueryCAPs(capids : *mut super::super:: PSID, capidcount : u32, caps : *mut *mut CENTRAL_ACCESS_POLICY, capcount : *mut u32) -> super::super::super::Foundation:: NTSTATUS);
...
windows_link::link!("advapi32.dll" "system" fn LsaQueryForestTrustInformation2(policyhandle : LSA_HANDLE, trusteddomainname : *mut LSA_UNICODE_STRING, highestrecordtype : LSA_FOREST_TRUST_RECORD_TYPE, foresttrustinfo : *mut *mut LSA_FOREST_TRUST_INFORMATION2) -> super::super::super::Foundation:: NTSTATUS);
...
windows_link::link!("advapi32.dll" "system" fn LsaQueryTrustedDomainInfoByName(policyhandle : LSA_HANDLE, trusteddomainname : *mut LSA_UNICODE_STRING, informationclass : TRUSTED_INFORMATION_CLASS, buffer : *mut *mut core::ffi::c_void) -> super::super::super::Foundation:: NTSTATUS);
windows_link::link!("secur32.dll" "system" fn LsaRegisterLogonProcess(logonprocessname : *mut LSA_STRING, lsahandle : *mut super::super::super::Foundation:: HANDLE, securitymode : *mut u32) -> super::super::super::Foundation:: NTSTATUS);
...
windows_link::link!("advapi32.dll" "system" fn LsaSetDomainInformationPolicy(policyhandle : LSA_HANDLE, informationclass : POLICY_DOMAIN_INFORMATION_CLASS, buffer : *mut core::ffi::c_void) -> super::super::super::Foundation:: NTSTATUS);
windows_link::link!("advapi32.dll" "system" fn LsaSetForestTrustInformation(policyhandle : LSA_HANDLE, trusteddomainname : *mut LSA_UNICODE_STRING, foresttrustinfo : *mut LSA_FOREST_TRUST_INFORMATION, checkonly : bool, collisioninfo : *mut *mut LSA_FOREST_TRUST_COLLISION_INFORMATION) -> super::super::super::Foundation:: NTSTATUS);
windows_link::link!("advapi32.dll" "system" fn LsaSetForestTrustInformation2(policyhandle : LSA_HANDLE, trusteddomainname : *mut LSA_UNICODE_STRING, highestrecordtype : LSA_FOREST_TRUST_RECORD_TYPE, foresttrustinfo : *mut LSA_FOREST_TRUST_INFORMATION2, checkonly : bool, collisioninfo : *mut *mut LSA_FOREST_TRUST_COLLISION_INFORMATION) -> super::super::super::Foundation:: NTSTATUS);
windows_link::link!("advapi32.dll" "system" fn LsaSetInformationPolicy(policyhandle : LSA_HANDLE, informationclass : POLICY_INFORMATION_CLASS, buffer : *mut core::ffi::c_void) -> super::super::super::Foundation:: NTSTATUS);
windows_link::link!("advapi32.dll" "system" fn LsaSetTrustedDomainInfoByName(policyhandle : LSA_HANDLE, trusteddomainname : *mut LSA_UNICODE_STRING, informationclass : TRUSTED_INFORMATION_CLASS, buffer : *mut core::ffi::c_void) -> super::super::super::Foundation:: NTSTATUS);
windows_link::link!("advapi32.dll" "system" fn LsaSetTrustedDomainInformation(policyhandle : LSA_HANDLE, trusteddomainsid : super::super:: PSID, informationclass : TRUSTED_INFORMATION_CLASS, buffer : *mut core::ffi::c_void) -> super::super::super::Foundation:: NTSTATUS);
...
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("secur32.dll" "system" fn QueryContextAttributesA(phcontext : *mut super::super::Credentials:: SecHandle, ulattribute : SECPKG_ATTR, pbuffer : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("sspicli.dll" "system" fn QueryContextAttributesExA(phcontext : *mut super::super::Credentials:: SecHandle, ulattribute : SECPKG_ATTR, pbuffer : *mut core::ffi::c_void, cbbuffer : u32) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("sspicli.dll" "system" fn QueryContextAttributesExW(phcontext : *mut super::super::Credentials:: SecHandle, ulattribute : SECPKG_ATTR, pbuffer : *mut core::ffi::c_void, cbbuffer : u32) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Credentials")]
...
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("sspicli.dll" "system" fn QueryCredentialsAttributesExA(phcredential : *mut super::super::Credentials:: SecHandle, ulattribute : u32, pbuffer : *mut core::ffi::c_void, cbbuffer : u32) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("sspicli.dll" "system" fn QueryCredentialsAttributesExW(phcredential : *mut super::super::Credentials:: SecHandle, ulattribute : u32, pbuffer : *mut core::ffi::c_void, cbbuffer : u32) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("secur32.dll" "system" fn QueryCredentialsAttributesW(phcredential : *mut super::super::Credentials:: SecHandle, ulattribute : u32, pbuffer : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Credentials")]
...
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("secur32.dll" "system" fn RevertSecurityContext(phcontext : *mut super::super::Credentials:: SecHandle) -> windows_sys::core::HRESULT);
...
windows_link::link!("slc.dll" "system" fn SLClose(hslc : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("slc.dll" "system" fn SLDepositOfflineConfirmationIdEx(hslc : *mut core::ffi::c_void, pproductskuid : *mut windows_sys::core::GUID, pactivationinfo : *mut SL_ACTIVATION_INFO_HEADER, pwszinstallationid : windows_sys::core::PCWSTR, pwszconfirmationid : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
windows_link::link!("slc.dll" "system" fn SLFireEvent(hslc : *mut core::ffi::c_void, pwszeventid : windows_sys::core::PCWSTR, papplicationid : *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT);
...
windows_link::link!("slc.dll" "system" fn SLGenerateOfflineInstallationIdEx(hslc : *mut core::ffi::c_void, pproductskuid : *mut windows_sys::core::GUID, pactivationinfo : *mut SL_ACTIVATION_INFO_HEADER, ppwszinstallationid : *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT);
windows_link::link!("slc.dll" "system" fn SLGetApplicationInformation(hslc : *mut core::ffi::c_void, papplicationid : *mut windows_sys::core::GUID, pwszvaluename : windows_sys::core::PCWSTR, pedatatype : *mut SLDATATYPE, pcbvalue : *mut u32, ppbvalue : *mut *mut u8) -> windows_sys::core::HRESULT);
windows_link::link!("slc.dll" "system" fn SLGetGenuineInformation(pqueryid : *mut windows_sys::core::GUID, pwszvaluename : windows_sys::core::PCWSTR, pedatatype : *mut SLDATATYPE, pcbvalue : *mut u32, ppbvalue : *mut *mut u8) -> windows_sys::core::HRESULT);
windows_link::link!("slc.dll" "system" fn SLGetInstalledProductKeyIds(hslc : *mut core::ffi::c_void, pproductskuid : *mut windows_sys::core::GUID, pnproductkeyids : *mut u32, ppproductkeyids : *mut *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT);
...
windows_link::link!("slc.dll" "system" fn SLGetLicenseFileId(hslc : *mut core::ffi::c_void, cblicenseblob : u32, pblicenseblob : *mut u8, plicensefileid : *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT);
windows_link::link!("slc.dll" "system" fn SLGetLicenseInformation(hslc : *mut core::ffi::c_void, psllicenseid : *mut windows_sys::core::GUID, pwszvaluename : windows_sys::core::PCWSTR, pedatatype : *mut SLDATATYPE, pcbvalue : *mut u32, ppbvalue : *mut *mut u8) -> windows_sys::core::HRESULT);
...
windows_link::link!("slc.dll" "system" fn SLGetPKeyId(hslc : *mut core::ffi::c_void, pwszpkeyalgorithm : windows_sys::core::PCWSTR, pwszpkeystring : windows_sys::core::PCWSTR, cbpkeyspecificdata : u32, pbpkeyspecificdata : *mut u8, ppkeyid : *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT);
windows_link::link!("slc.dll" "system" fn SLGetPKeyInformation(hslc : *mut core::ffi::c_void, ppkeyid : *mut windows_sys::core::GUID, pwszvaluename : windows_sys::core::PCWSTR, pedatatype : *mut SLDATATYPE, pcbvalue : *mut u32, ppbvalue : *mut *mut u8) -> windows_sys::core::HRESULT);
windows_link::link!("slc.dll" "system" fn SLGetPolicyInformation(hslc : *mut core::ffi::c_void, pwszvaluename : windows_sys::core::PCWSTR, pedatatype : *mut SLDATATYPE, pcbvalue : *mut u32, ppbvalue : *mut *mut u8) -> windows_sys::core::HRESULT);
windows_link::link!("slc.dll" "system" fn SLGetPolicyInformationDWORD(hslc : *mut core::ffi::c_void, pwszvaluename : windows_sys::core::PCWSTR, pdwvalue : *mut u32) -> windows_sys::core::HRESULT);
windows_link::link!("slc.dll" "system" fn SLGetProductSkuInformation(hslc : *mut core::ffi::c_void, pproductskuid : *mut windows_sys::core::GUID, pwszvaluename : windows_sys::core::PCWSTR, pedatatype : *mut SLDATATYPE, pcbvalue : *mut u32, ppbvalue : *mut *mut u8) -> windows_sys::core::HRESULT);
windows_link::link!("slcext.dll" "system" fn SLGetReferralInformation(hslc : *mut core::ffi::c_void, ereferraltype : SLREFERRALTYPE, pskuorappid : *mut windows_sys::core::GUID, pwszvaluename : windows_sys::core::PCWSTR, ppwszvalue : *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT);
...
windows_link::link!("slc.dll" "system" fn SLInstallLicense(hslc : *mut core::ffi::c_void, cblicenseblob : u32, pblicenseblob : *mut u8, plicensefileid : *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT);
windows_link::link!("slc.dll" "system" fn SLInstallProofOfPurchase(hslc : *mut core::ffi::c_void, pwszpkeyalgorithm : windows_sys::core::PCWSTR, pwszpkeystring : windows_sys::core::PCWSTR, cbpkeyspecificdata : u32, pbpkeyspecificdata : *mut u8, ppkeyid : *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT);
windows_link::link!("slwga.dll" "system" fn SLIsGenuineLocal(pappid : *mut windows_sys::core::GUID, pgenuinestate : *mut SL_GENUINE_STATE, puioptions : *mut SL_NONGENUINE_UI_OPTIONS) -> windows_sys::core::HRESULT);
...
windows_link::link!("slc.dll" "system" fn SLRegisterEvent(hslc : *mut core::ffi::c_void, pwszeventid : windows_sys::core::PCWSTR, papplicationid : *mut windows_sys::core::GUID, hevent : super::super::super::Foundation:: HANDLE) -> windows_sys::core::HRESULT);
windows_link::link!("slc.dll" "system" fn SLSetCurrentProductKey(hslc : *mut core::ffi::c_void, pproductskuid : *mut windows_sys::core::GUID, pproductkeyid : *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT);
windows_link::link!("slc.dll" "system" fn SLSetGenuineInformation(pqueryid : *mut windows_sys::core::GUID, pwszvaluename : windows_sys::core::PCWSTR, edatatype : SLDATATYPE, cbvalue : u32, pbvalue : *mut u8) -> windows_sys::core::HRESULT);
windows_link::link!("slc.dll" "system" fn SLUninstallLicense(hslc : *mut core::ffi::c_void, plicensefileid : *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("secur32.dll" "system" fn SaslAcceptSecurityContext(phcredential : *mut super::super::Credentials:: SecHandle, phcontext : *mut super::super::Credentials:: SecHandle, pinput : *mut SecBufferDesc, fcontextreq : ASC_REQ_FLAGS, targetdatarep : u32, phnewcontext : *mut super::super::Credentials:: SecHandle, poutput : *mut SecBufferDesc, pfcontextattr : *mut u32, ptsexpiry : *mut i64) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("secur32.dll" "system" fn SaslGetContextOption(contexthandle : *mut super::super::Credentials:: SecHandle, option : u32, value : *mut core::ffi::c_void, size : u32, needed : *mut u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("secur32.dll" "system" fn SaslIdentifyPackageA(pinput : *mut SecBufferDesc, packageinfo : *mut *mut SecPkgInfoA) -> windows_sys::core::HRESULT);
windows_link::link!("secur32.dll" "system" fn SaslIdentifyPackageW(pinput : *mut SecBufferDesc, packageinfo : *mut *mut SecPkgInfoW) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Credentials")]
...
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("secur32.dll" "system" fn SaslSetContextOption(contexthandle : *mut super::super::Credentials:: SecHandle, option : u32, value : *mut core::ffi::c_void, size : u32) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("secur32.dll" "system" fn SetContextAttributesW(phcontext : *mut super::super::Credentials:: SecHandle, ulattribute : SECPKG_ATTR, pbuffer : *mut core::ffi::c_void, cbbuffer : u32) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Credentials")]
...
#[cfg(feature = "Win32_Security_Credentials")]
windows_link::link!("secur32.dll" "system" fn SetCredentialsAttributesW(phcredential : *mut super::super::Credentials:: SecHandle, ulattribute : u32, pbuffer : *mut core::ffi::c_void, cbbuffer : u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("schannel.dll" "system" fn SslGetServerIdentity(clienthello : *mut u8, clienthellosize : u32, serveridentity : *mut *mut u8, serveridentitysize : *mut u32, flags : u32) -> windows_sys::core::HRESULT);
windows_link::link!("secur32.dll" "system" fn SspiCompareAuthIdentities(authidentity1 : *mut core::ffi::c_void, authidentity2 : *mut core::ffi::c_void, samesupplieduser : *mut bool, samesuppliedidentity : *mut bool) -> windows_sys::core::HRESULT);
...
windows_link::link!("secur32.dll" "system" fn SspiFreeAuthIdentity(authdata : *mut core::ffi::c_void));
...
windows_link::link!("secur32.dll" "system" fn SspiIsAuthIdentityEncrypted(encryptedauthdata : *mut core::ffi::c_void) -> bool);
windows_link::link!("credui.dll" "system" fn SspiIsPromptingNeeded(errororntstatus : u32) -> bool);
windows_link::link!("secur32.dll" "system" fn SspiLocalFree(databuffer : *mut core::ffi::c_void));
windows_link::link!("secur32.dll" "system" fn SspiMarshalAuthIdentity(authidentity : *mut core::ffi::c_void, authidentitylength : *mut u32, authidentitybytearray : *mut *mut i8) -> windows_sys::core::HRESULT);
windows_link::link!("secur32.dll" "system" fn SspiPrepareForCredRead(authidentity : *mut core::ffi::c_void, psztargetname : windows_sys::core::PCWSTR, pcredmancredentialtype : *mut u32, ppszcredmantargetname : *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT);
windows_link::link!("secur32.dll" "system" fn SspiPrepareForCredWrite(authidentity : *mut core::ffi::c_void, psztargetname : windows_sys::core::PCWSTR, pcredmancredentialtype : *mut u32, ppszcredmantargetname : *mut windows_sys::core::PWSTR, ppszcredmanusername : *mut windows_sys::core::PWSTR, ppcredentialblob : *mut *mut u8, pcredentialblobsize : *mut u32) -> windows_sys::core::HRESULT);
windows_link::link!("credui.dll" "system" fn SspiPromptForCredentialsA(psztargetname : windows_sys::core::PCSTR, puiinfo : *mut core::ffi::c_void, dwautherror : u32, pszpackage : windows_sys::core::PCSTR, pinputauthidentity : *mut core::ffi::c_void, ppauthidentity : *mut *mut core::ffi::c_void, pfsave : *mut i32, dwflags : u32) -> u32);
windows_link::link!("credui.dll" "system" fn SspiPromptForCredentialsW(psztargetname : windows_sys::core::PCWSTR, puiinfo : *mut core::ffi::c_void, dwautherror : u32, pszpackage : windows_sys::core::PCWSTR, pinputauthidentity : *mut core::ffi::c_void, ppauthidentity : *mut *mut core::ffi::c_void, pfsave : *mut i32, dwflags : u32) -> u32);
...
windows_link::link!("secur32.dll" "system" fn SspiValidateAuthIdentity(authdata : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("secur32.dll" "system" fn SspiZeroAuthIdentity(authdata : *mut core::ffi::c_void));
...
windows_link::link!("tokenbinding.dll" "system" fn TokenBindingGenerateBinding(keytype : TOKENBINDING_KEY_PARAMETERS_TYPE, targeturl : windows_sys::core::PCWSTR, bindingtype : TOKENBINDING_TYPE, tlsekm : *mut core::ffi::c_void, tlsekmsize : u32, extensionformat : TOKENBINDING_EXTENSION_FORMAT, extensiondata : *mut core::ffi::c_void, tokenbinding : *mut *mut core::ffi::c_void, tokenbindingsize : *mut u32, resultdata : *mut *mut TOKENBINDING_RESULT_DATA) -> windows_sys::core::HRESULT);
windows_link::link!("tokenbinding.dll" "system" fn TokenBindingGenerateID(keytype : TOKENBINDING_KEY_PARAMETERS_TYPE, publickey : *mut core::ffi::c_void, publickeysize : u32, resultdata : *mut *mut TOKENBINDING_RESULT_DATA) -> windows_sys::core::HRESULT);
...
windows_link::link!("tokenbinding.dll" "system" fn TokenBindingGenerateMessage(tokenbindings : *mut *mut core::ffi::c_void, tokenbindingssize : *mut u32, tokenbindingscount : u32, tokenbindingmessage : *mut *mut core::ffi::c_void, tokenbindingmessagesize : *mut u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("tokenbinding.dll" "system" fn TokenBindingVerifyMessage(tokenbindingmessage : *mut core::ffi::c_void, tokenbindingmessagesize : u32, keytype : TOKENBINDING_KEY_PARAMETERS_TYPE, tlsekm : *mut core::ffi::c_void, tlsekmsize : u32, resultlist : *mut *mut TOKENBINDING_RESULT_LIST) -> windows_sys::core::HRESULT);
windows_link::link!("secur32.dll" "system" fn TranslateNameA(lpaccountname : windows_sys::core::PCSTR, accountnameformat : EXTENDED_NAME_FORMAT, desirednameformat : EXTENDED_NAME_FORMAT, lptranslatedname : windows_sys::core::PCSTR, nsize : *mut u32) -> bool);
windows_link::link!("secur32.dll" "system" fn TranslateNameW(lpaccountname : windows_sys::core::PCWSTR, accountnameformat : EXTENDED_NAME_FORMAT, desirednameformat : EXTENDED_NAME_FORMAT, lptranslatedname : windows_sys::core::PCWSTR, nsize : *mut u32) -> bool);
#[cfg(feature = "Win32_Security_Credentials")]
...
#[cfg(feature = "Win32_Security_Credentials")]
pub type CredReadDomainCredentialsFn = Option<unsafe extern "system" fn(logonid: *mut super::super::super::Foundation::LUID, credflags: u32, targetinfo: *mut super::super::Credentials::CREDENTIAL_TARGET_INFORMATIONW, flags: u32, count: *mut u32, credential: *mut *mut *mut ENCRYPTED_CREDENTIALW) -> super::super::super::Foundation::NTSTATUS>;
#[cfg(feature = "Win32_Security_Credentials")]
...
#[cfg(feature = "Win32_Security_Credentials")]
pub type CredWriteFn = Option<unsafe extern "system" fn(logonid: *mut super::super::super::Foundation::LUID, credflags: u32, credential: *mut ENCRYPTED_CREDENTIALW, flags: u32) -> super::super::super::Foundation::NTSTATUS>;
...
#[cfg(feature = "Win32_System_Kernel")]
pub type KspInitPackageFn = Option<unsafe extern "system" fn(functiontable: *mut SECPKG_KERNEL_FUNCTIONS) -> super::super::super::Foundation::NTSTATUS>;
pub type KspMakeSignatureFn = Option<unsafe extern "system" fn(contextid: usize, fqop: u32, message: *mut SecBufferDesc, messageseqno: u32) -> super::super::super::Foundation::NTSTATUS>;
...
pub type KspSerializeAuthDataFn = Option<unsafe extern "system" fn(pvauthdata: *mut core::ffi::c_void, size: *mut u32, serializeddata: *mut *mut core::ffi::c_void) -> super::super::super::Foundation::NTSTATUS>;
pub type KspSetPagingModeFn = Option<unsafe extern "system" fn(pagingmode: bool) -> super::super::super::Foundation::NTSTATUS>;
pub type KspUnsealMessageFn = Option<unsafe extern "system" fn(contextid: usize, message: *mut SecBufferDesc, messageseqno: u32, pfqop: *mut u32) -> super::super::super::Foundation::NTSTATUS>;
...
pub type LSA_AP_POST_LOGON_USER = Option<unsafe extern "system" fn(postlogonuserinfo: *mut SECPKG_POST_LOGON_USER_INFO) -> super::super::super::Foundation::NTSTATUS>;
#[repr(C)]
#[derive(Clone, Copy)]
...
#[cfg(feature = "Win32_System_Kernel")]
pub type PKSEC_REFERENCE_LIST_ENTRY = Option<unsafe extern "system" fn(entry: *mut KSEC_LIST_ENTRY, signature: u32, removenoref: bool) -> super::super::super::Foundation::NTSTATUS>;
...
pub type PKSEC_SERIALIZE_WINNT_AUTH_DATA = Option<unsafe extern "system" fn(pvauthdata: *mut core::ffi::c_void, size: *mut u32, serializeddata: *mut *mut core::ffi::c_void) -> super::super::super::Foundation::NTSTATUS>;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub type PLSA_ADD_CREDENTIAL = Option<unsafe extern "system" fn(logonid: *mut super::super::super::Foundation::LUID, authenticationpackage: u32, primarykeyvalue: *mut LSA_STRING, credentials: *mut LSA_STRING) -> super::super::super::Foundation::NTSTATUS>;
...
pub type PLSA_AP_CALL_PACKAGE = Option<unsafe extern "system" fn(clientrequest: *mut *mut core::ffi::c_void, protocolsubmitbuffer: *mut core::ffi::c_void, clientbufferbase: *mut core::ffi::c_void, submitbufferlength: u32, protocolreturnbuffer: *mut *mut core::ffi::c_void, returnbufferlength: *mut u32, protocolstatus: *mut i32) -> super::super::super::Foundation::NTSTATUS>;
pub type PLSA_AP_CALL_PACKAGE_PASSTHROUGH = Option<unsafe extern "system" fn(clientrequest: *mut *mut core::ffi::c_void, protocolsubmitbuffer: *mut core::ffi::c_void, clientbufferbase: *mut core::ffi::c_void, submitbufferlength: u32, protocolreturnbuffer: *mut *mut core::ffi::c_void, returnbufferlength: *mut u32, protocolstatus: *mut i32) -> super::super::super::Foundation::NTSTATUS>;
pub type PLSA_AP_INITIALIZE_PACKAGE = Option<unsafe extern "system" fn(authenticationpackageid: u32, lsadispatchtable: *mut LSA_DISPATCH_TABLE, database: *mut LSA_STRING, confidentiality: *mut LSA_STRING, authenticationpackagename: *mut *mut LSA_STRING) -> super::super::super::Foundation::NTSTATUS>;
...
pub type PLSA_CALL_PACKAGEEX = Option<unsafe extern "system" fn(authenticationpackage: *mut LSA_UNICODE_STRING, clientbufferbase: *mut core::ffi::c_void, protocolsubmitbuffer: *mut core::ffi::c_void, submitbufferlength: u32, protocolreturnbuffer: *mut *mut core::ffi::c_void, returnbufferlength: *mut u32, protocolstatus: *mut i32) -> super::super::super::Foundation::NTSTATUS>;
...
pub type PLSA_CLIENT_CALLBACK = Option<unsafe extern "system" fn(callback: windows_sys::core::PCSTR, argument1: usize, argument2: usize, input: *mut SecBuffer, output: *mut SecBuffer) -> super::super::super::Foundation::NTSTATUS>;
pub type PLSA_CLOSE_SAM_USER = Option<unsafe extern "system" fn(userhandle: *mut core::ffi::c_void) -> super::super::super::Foundation::NTSTATUS>;
...
pub type PLSA_COPY_FROM_CLIENT_BUFFER = Option<unsafe extern "system" fn(clientrequest: *mut *mut core::ffi::c_void, length: u32, buffertocopy: *mut core::ffi::c_void, clientbaseaddress: *mut core::ffi::c_void) -> super::super::super::Foundation::NTSTATUS>;
pub type PLSA_COPY_TO_CLIENT_BUFFER = Option<unsafe extern "system" fn(clientrequest: *mut *mut core::ffi::c_void, length: u32, clientbaseaddress: *mut core::ffi::c_void, buffertocopy: *mut core::ffi::c_void) -> super::super::super::Foundation::NTSTATUS>;
pub type PLSA_CRACK_SINGLE_NAME = Option<unsafe extern "system" fn(formatoffered: u32, performatgc: bool, nameinput: *mut LSA_UNICODE_STRING, prefix: *mut LSA_UNICODE_STRING, requestedformat: u32, crackedname: *mut LSA_UNICODE_STRING, dnsdomainname: *mut LSA_UNICODE_STRING, substatus: *mut u32) -> super::super::super::Foundation::NTSTATUS>;
...
pub type PLSA_DELETE_CREDENTIAL = Option<unsafe extern "system" fn(logonid: *mut super::super::super::Foundation::LUID, authenticationpackage: u32, primarykeyvalue: *mut LSA_STRING) -> super::super::super::Foundation::NTSTATUS>;
pub type PLSA_DELETE_LOGON_SESSION = Option<unsafe extern "system" fn(logonid: *mut super::super::super::Foundation::LUID) -> super::super::super::Foundation::NTSTATUS>;
pub type PLSA_DELETE_SHARED_MEMORY = Option<unsafe extern "system" fn(sharedmem: *mut core::ffi::c_void) -> bool>;
...
pub type PLSA_FREE_SHARED_MEMORY = Option<unsafe extern "system" fn(sharedmem: *mut core::ffi::c_void, memory: *mut core::ffi::c_void)>;
...
pub type PLSA_GET_AUTH_DATA_FOR_USER = Option<unsafe extern "system" fn(name: *mut SECURITY_STRING, nametype: SECPKG_NAME_TYPE, prefix: *mut SECURITY_STRING, userauthdata: *mut *mut u8, userauthdatasize: *mut u32, userflatname: *mut LSA_UNICODE_STRING) -> super::super::super::Foundation::NTSTATUS>;
...
pub type PLSA_GET_CREDENTIALS = Option<unsafe extern "system" fn(logonid: *mut super::super::super::Foundation::LUID, authenticationpackage: u32, querycontext: *mut u32, retrieveallcredentials: bool, primarykeyvalue: *mut LSA_STRING, primarykeylength: *mut u32, credentials: *mut LSA_STRING) -> super::super::super::Foundation::NTSTATUS>;
pub type PLSA_GET_EXTENDED_CALL_FLAGS = Option<unsafe extern "system" fn(flags: *mut u32) -> super::super::super::Foundation::NTSTATUS>;
pub type PLSA_GET_SERVICE_ACCOUNT_PASSWORD = Option<unsafe extern "system" fn(accountname: *mut LSA_UNICODE_STRING, domainname: *mut LSA_UNICODE_STRING, credfetch: CRED_FETCH, filetimeexpiry: *mut super::super::super::Foundation::FILETIME, currentpassword: *mut LSA_UNICODE_STRING, previouspassword: *mut LSA_UNICODE_STRING, filetimecurrpwdvalidforoutbound: *mut super::super::super::Foundation::FILETIME) -> super::super::super::Foundation::NTSTATUS>;
pub type PLSA_GET_USER_AUTH_DATA = Option<unsafe extern "system" fn(userhandle: *mut core::ffi::c_void, userauthdata: *mut *mut u8, userauthdatasize: *mut u32) -> super::super::super::Foundation::NTSTATUS>;
pub type PLSA_GET_USER_CREDENTIALS = Option<unsafe extern "system" fn(userhandle: *mut core::ffi::c_void, primarycreds: *mut *mut core::ffi::c_void, primarycredssize: *mut u32, supplementalcreds: *mut *mut core::ffi::c_void, supplementalcredssize: *mut u32) -> super::super::super::Foundation::NTSTATUS>;
...
pub type PLSA_MAP_BUFFER = Option<unsafe extern "system" fn(inputbuffer: *mut SecBuffer, outputbuffer: *mut SecBuffer) -> super::super::super::Foundation::NTSTATUS>;
pub type PLSA_OPEN_SAM_USER = Option<unsafe extern "system" fn(name: *mut SECURITY_STRING, nametype: SECPKG_NAME_TYPE, prefix: *mut SECURITY_STRING, allowguest: bool, reserved: u32, userhandle: *mut *mut core::ffi::c_void) -> super::super::super::Foundation::NTSTATUS>;
pub type PLSA_OPEN_TOKEN_BY_LOGON_ID = Option<unsafe extern "system" fn(logonid: *mut super::super::super::Foundation::LUID, rettokenhandle: *mut super::super::super::Foundation::HANDLE) -> super::super::super::Foundation::NTSTATUS>;
pub type PLSA_PROTECT_MEMORY = Option<unsafe extern "system" fn(buffer: *mut core::ffi::c_void, buffersize: u32)>;
pub type PLSA_QUERY_CLIENT_REQUEST = Option<unsafe extern "system" fn(clientrequest: *mut *mut core::ffi::c_void, querytype: u32, replybuffer: *mut *mut core::ffi::c_void) -> super::super::super::Foundation::NTSTATUS>;
...
pub type PLSA_SET_APP_MODE_INFO = Option<unsafe extern "system" fn(userfunction: u32, argument1: usize, argument2: usize, userdata: *mut SecBuffer, returntolsa: bool) -> super::super::super::Foundation::NTSTATUS>;
pub type PLSA_UNLOAD_PACKAGE = Option<unsafe extern "system" fn() -> super::super::super::Foundation::NTSTATUS>;
pub type PLSA_UPDATE_PRIMARY_CREDENTIALS = Option<unsafe extern "system" fn(primarycredentials: *mut SECPKG_PRIMARY_CRED, credentials: *mut SECPKG_SUPPLEMENTAL_CRED_ARRAY) -> super::super::super::Foundation::NTSTATUS>;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub type PSAM_PASSWORD_FILTER_ROUTINE = Option<unsafe extern "system" fn(accountname: *mut LSA_UNICODE_STRING, fullname: *mut LSA_UNICODE_STRING, password: *mut LSA_UNICODE_STRING, setoperation: bool) -> bool>;
...
pub type SpAcceptCredentialsFn = Option<unsafe extern "system" fn(logontype: SECURITY_LOGON_TYPE, accountname: *mut LSA_UNICODE_STRING, primarycredentials: *mut SECPKG_PRIMARY_CRED, supplementalcredentials: *mut SECPKG_SUPPLEMENTAL_CRED) -> super::super::super::Foundation::NTSTATUS>;
...
pub type SpAcquireCredentialsHandleFn = Option<unsafe extern "system" fn(principalname: *mut LSA_UNICODE_STRING, credentialuseflags: u32, logonid: *mut super::super::super::Foundation::LUID, authorizationdata: *mut core::ffi::c_void, getkeyfunciton: *mut core::ffi::c_void, getkeyargument: *mut core::ffi::c_void, credentialhandle: *mut usize, expirationtime: *mut i64) -> super::super::super::Foundation::NTSTATUS>;
pub type SpAddCredentialsFn = Option<unsafe extern "system" fn(credentialhandle: usize, principalname: *mut LSA_UNICODE_STRING, package: *mut LSA_UNICODE_STRING, credentialuseflags: u32, authorizationdata: *mut core::ffi::c_void, getkeyfunciton: *mut core::ffi::c_void, getkeyargument: *mut core::ffi::c_void, expirationtime: *mut i64) -> super::super::super::Foundation::NTSTATUS>;
pub type SpApplyControlTokenFn = Option<unsafe extern "system" fn(contexthandle: usize, controltoken: *mut SecBufferDesc) -> super::super::super::Foundation::NTSTATUS>;
pub type SpChangeAccountPasswordFn = Option<unsafe extern "system" fn(pdomainname: *mut LSA_UNICODE_STRING, paccountname: *mut LSA_UNICODE_STRING, poldpassword: *mut LSA_UNICODE_STRING, pnewpassword: *mut LSA_UNICODE_STRING, impersonating: bool, poutput: *mut SecBufferDesc) -> super::super::super::Foundation::NTSTATUS>;
pub type SpCompleteAuthTokenFn = Option<unsafe extern "system" fn(contexthandle: usize, inputbuffer: *mut SecBufferDesc) -> super::super::super::Foundation::NTSTATUS>;
pub type SpDeleteContextFn = Option<unsafe extern "system" fn(contexthandle: usize) -> super::super::super::Foundation::NTSTATUS>;
pub type SpDeleteCredentialsFn = Option<unsafe extern "system" fn(credentialhandle: usize, key: *mut SecBuffer) -> super::super::super::Foundation::NTSTATUS>;
pub type SpExchangeMetaDataFn = Option<unsafe extern "system" fn(credentialhandle: usize, targetname: *mut LSA_UNICODE_STRING, contextrequirements: u32, metadatalength: u32, metadata: *mut u8, contexthandle: *mut usize) -> super::super::super::Foundation::NTSTATUS>;
...
pub type SpFormatCredentialsFn = Option<unsafe extern "system" fn(credentials: *mut SecBuffer, formattedcredentials: *mut SecBuffer) -> super::super::super::Foundation::NTSTATUS>;
...
pub type SpGetCredUIContextFn = Option<unsafe extern "system" fn(contexthandle: usize, credtype: *mut windows_sys::core::GUID, flatcreduicontextlength: *mut u32, flatcreduicontext: *mut *mut u8) -> super::super::super::Foundation::NTSTATUS>;
...
pub type SpGetRemoteCredGuardSupplementalCredsFn = Option<unsafe extern "system" fn(credhandle: usize, targetname: *mut LSA_UNICODE_STRING, redirectedlogonhandle: *mut super::super::super::Foundation::HANDLE, callback: *mut PLSA_REDIRECTED_LOGON_CALLBACK, cleanupcallback: *mut PLSA_REDIRECTED_LOGON_CLEANUP_CALLBACK, supplementalcredssize: *mut u32, supplementalcreds: *mut *mut core::ffi::c_void) -> super::super::super::Foundation::NTSTATUS>;
...
pub type SpGetUserInfoFn = Option<unsafe extern "system" fn(logonid: *mut super::super::super::Foundation::LUID, flags: u32, userdata: *mut *mut SECURITY_USER_DATA) -> super::super::super::Foundation::NTSTATUS>;
pub type SpImportSecurityContextFn = Option<unsafe extern "system" fn(ppackedcontext: *mut SecBuffer, token: super::super::super::Foundation::HANDLE, phcontext: *mut usize) -> super::super::super::Foundation::NTSTATUS>;
...
pub type SpInstanceInitFn = Option<unsafe extern "system" fn(version: u32, functiontable: *mut SECPKG_DLL_FUNCTIONS, userfunctions: *mut *mut core::ffi::c_void) -> super::super::super::Foundation::NTSTATUS>;
#[cfg(all(feature = "Win32_Security_Credentials", feature = "Win32_System_Threading"))]
...
pub type SpMarshallSupplementalCredsFn = Option<unsafe extern "system" fn(credentialsize: u32, credentials: *mut u8, marshalledcredsize: *mut u32, marshalledcreds: *mut *mut core::ffi::c_void) -> super::super::super::Foundation::NTSTATUS>;
...
pub type SpQueryMetaDataFn = Option<unsafe extern "system" fn(credentialhandle: usize, targetname: *mut LSA_UNICODE_STRING, contextrequirements: u32, metadatalength: *mut u32, metadata: *mut *mut u8, contexthandle: *mut usize) -> super::super::super::Foundation::NTSTATUS>;
pub type SpSaveCredentialsFn = Option<unsafe extern "system" fn(credentialhandle: usize, credentials: *mut SecBuffer) -> super::super::super::Foundation::NTSTATUS>;
...
pub type SpSetContextAttributesFn = Option<unsafe extern "system" fn(contexthandle: usize, contextattribute: u32, buffer: *mut core::ffi::c_void, buffersize: u32) -> super::super::super::Foundation::NTSTATUS>;
pub type SpSetCredentialsAttributesFn = Option<unsafe extern "system" fn(credentialhandle: usize, credentialattribute: u32, buffer: *mut core::ffi::c_void, buffersize: u32) -> super::super::super::Foundation::NTSTATUS>;
...
pub type SpUpdateCredentialsFn = Option<unsafe extern "system" fn(contexthandle: usize, credtype: *mut windows_sys::core::GUID, flatcreduicontextlength: u32, flatcreduicontext: *mut u8) -> super::super::super::Foundation::NTSTATUS>;
...
pub type SpValidateTargetInfoFn = Option<unsafe extern "system" fn(clientrequest: *mut *mut core::ffi::c_void, protocolsubmitbuffer: *mut core::ffi::c_void, clientbufferbase: *mut core::ffi::c_void, submitbufferlength: u32, targetinfo: *mut SECPKG_TARGETINFO) -> super::super::super::Foundation::NTSTATUS>;
pub type SpVerifySignatureFn = Option<unsafe extern "system" fn(contexthandle: usize, messagebuffers: *mut SecBufferDesc, messagesequencenumber: u32, qualityofprotection: *mut u32) -> super::super::super::Foundation::NTSTATUS>;
#[cfg(feature = "Win32_Security_Cryptography")]
...
pub type SslGetExtensionsFn = Option<unsafe extern "system" fn(clienthello: *mut u8, clienthellobytesize: u32, genericextensions: *mut SCH_EXTENSION_DATA, genericextensionscount: u8, bytestoread: *mut u32, flags: SchGetExtensionsOptions) -> windows_sys::core::HRESULT>;
