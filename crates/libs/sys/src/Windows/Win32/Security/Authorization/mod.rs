...
pub type AuthzAddSidsToContext = unsafe extern "system" fn(hauthzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE, sids: *const super::SID_AND_ATTRIBUTES, sidcount: u32, restrictedsids: *const super::SID_AND_ATTRIBUTES, restrictedsidcount: u32, phnewauthzclientcontext: *mut AUTHZ_CLIENT_CONTEXT_HANDLE) -> windows_sys::core::BOOL;
...
pub type AuthzCachedAccessCheck = unsafe extern "system" fn(flags: u32, haccesscheckresults: AUTHZ_ACCESS_CHECK_RESULTS_HANDLE, prequest: *const AUTHZ_ACCESS_REQUEST, hauditevent: AUTHZ_AUDIT_EVENT_HANDLE, preply: *mut AUTHZ_ACCESS_REPLY) -> windows_sys::core::BOOL;
...
pub type AuthzEnumerateSecurityEventSources = unsafe extern "system" fn(dwflags: u32, buffer: *mut AUTHZ_SOURCE_SCHEMA_REGISTRATION, pdwcount: *mut u32, pdwlength: *mut u32) -> windows_sys::core::BOOL;
...
pub type AuthzEvaluateSacl = unsafe extern "system" fn(authzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE, prequest: *const AUTHZ_ACCESS_REQUEST, sacl: *const super::ACL, grantedaccess: u32, accessgranted: windows_sys::core::BOOL, pbgenerateaudit: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type AuthzFreeAuditEvent = unsafe extern "system" fn(hauditevent: AUTHZ_AUDIT_EVENT_HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("authz.dll" "system" fn AuthzFreeAuditEvent(hauditevent : AUTHZ_AUDIT_EVENT_HANDLE) -> windows_sys::core::BOOL);
pub type AuthzFreeCentralAccessPolicyCache = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("authz.dll" "system" fn AuthzFreeCentralAccessPolicyCache() -> windows_sys::core::BOOL);
pub type AuthzFreeContext = unsafe extern "system" fn(hauthzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE) -> windows_sys::core::BOOL;
...
pub type AuthzFreeHandle = unsafe extern "system" fn(haccesscheckresults: AUTHZ_ACCESS_CHECK_RESULTS_HANDLE) -> windows_sys::core::BOOL;
...
pub type AuthzFreeResourceManager = unsafe extern "system" fn(hauthzresourcemanager: AUTHZ_RESOURCE_MANAGER_HANDLE) -> windows_sys::core::BOOL;
...
pub type AuthzGetInformationFromContext = unsafe extern "system" fn(hauthzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE, infoclass: AUTHZ_CONTEXT_INFORMATION_CLASS, buffersize: u32, psizerequired: *mut u32, buffer: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type AuthzInitializeCompoundContext = unsafe extern "system" fn(usercontext: AUTHZ_CLIENT_CONTEXT_HANDLE, devicecontext: AUTHZ_CLIENT_CONTEXT_HANDLE, phcompoundcontext: *mut AUTHZ_CLIENT_CONTEXT_HANDLE) -> windows_sys::core::BOOL;
...
pub type AuthzInitializeContextFromSid = unsafe extern "system" fn(flags: u32, usersid: super::PSID, hauthzresourcemanager: AUTHZ_RESOURCE_MANAGER_HANDLE, pexpirationtime: *const i64, identifier: super::super::Foundation::LUID, dynamicgroupargs: *const core::ffi::c_void, phauthzclientcontext: *mut AUTHZ_CLIENT_CONTEXT_HANDLE) -> windows_sys::core::BOOL;
...
pub type AuthzInitializeContextFromToken = unsafe extern "system" fn(flags: u32, tokenhandle: super::super::Foundation::HANDLE, hauthzresourcemanager: AUTHZ_RESOURCE_MANAGER_HANDLE, pexpirationtime: *const i64, identifier: super::super::Foundation::LUID, dynamicgroupargs: *const core::ffi::c_void, phauthzclientcontext: *mut AUTHZ_CLIENT_CONTEXT_HANDLE) -> windows_sys::core::BOOL;
...
pub type AuthzInitializeObjectAccessAuditEvent = unsafe extern "C" fn(flags: AUTHZ_INITIALIZE_OBJECT_ACCESS_AUDIT_EVENT_FLAGS, hauditeventtype: AUTHZ_AUDIT_EVENT_TYPE_HANDLE, szoperationtype: windows_sys::core::PCWSTR, szobjecttype: windows_sys::core::PCWSTR, szobjectname: windows_sys::core::PCWSTR, szadditionalinfo: windows_sys::core::PCWSTR, phauditevent: *mut AUTHZ_AUDIT_EVENT_HANDLE, dwadditionalparametercount: u32, ...) -> windows_sys::core::BOOL;
...
pub type AuthzInitializeObjectAccessAuditEvent2 = unsafe extern "C" fn(flags: u32, hauditeventtype: AUTHZ_AUDIT_EVENT_TYPE_HANDLE, szoperationtype: windows_sys::core::PCWSTR, szobjecttype: windows_sys::core::PCWSTR, szobjectname: windows_sys::core::PCWSTR, szadditionalinfo: windows_sys::core::PCWSTR, szadditionalinfo2: windows_sys::core::PCWSTR, phauditevent: *mut AUTHZ_AUDIT_EVENT_HANDLE, dwadditionalparametercount: u32, ...) -> windows_sys::core::BOOL;
...
pub type AuthzInitializeRemoteResourceManager = unsafe extern "system" fn(prpcinitinfo: *const AUTHZ_RPC_INIT_INFO_CLIENT, phauthzresourcemanager: *mut AUTHZ_RESOURCE_MANAGER_HANDLE) -> windows_sys::core::BOOL;
...
pub type AuthzInitializeResourceManager = unsafe extern "system" fn(flags: u32, pfndynamicaccesscheck: PFN_AUTHZ_DYNAMIC_ACCESS_CHECK, pfncomputedynamicgroups: PFN_AUTHZ_COMPUTE_DYNAMIC_GROUPS, pfnfreedynamicgroups: PFN_AUTHZ_FREE_DYNAMIC_GROUPS, szresourcemanagername: windows_sys::core::PCWSTR, phauthzresourcemanager: *mut AUTHZ_RESOURCE_MANAGER_HANDLE) -> windows_sys::core::BOOL;
...
pub type AuthzInitializeResourceManagerEx = unsafe extern "system" fn(flags: AUTHZ_RESOURCE_MANAGER_FLAGS, pauthzinitinfo: *const AUTHZ_INIT_INFO, phauthzresourcemanager: *mut AUTHZ_RESOURCE_MANAGER_HANDLE) -> windows_sys::core::BOOL;
...
pub type AuthzInstallSecurityEventSource = unsafe extern "system" fn(dwflags: u32, pregistration: *const AUTHZ_SOURCE_SCHEMA_REGISTRATION) -> windows_sys::core::BOOL;
...
pub type AuthzModifyClaims = unsafe extern "system" fn(hauthzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE, claimclass: AUTHZ_CONTEXT_INFORMATION_CLASS, pclaimoperations: *const AUTHZ_SECURITY_ATTRIBUTE_OPERATION, pclaims: *const AUTHZ_SECURITY_ATTRIBUTES_INFORMATION) -> windows_sys::core::BOOL;
...
pub type AuthzModifySecurityAttributes = unsafe extern "system" fn(hauthzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE, poperations: *const AUTHZ_SECURITY_ATTRIBUTE_OPERATION, pattributes: *const AUTHZ_SECURITY_ATTRIBUTES_INFORMATION) -> windows_sys::core::BOOL;
...
pub type AuthzModifySids = unsafe extern "system" fn(hauthzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE, sidclass: AUTHZ_CONTEXT_INFORMATION_CLASS, psidoperations: *const AUTHZ_SID_OPERATION, psids: *const super::TOKEN_GROUPS) -> windows_sys::core::BOOL;
...
pub type AuthzOpenObjectAudit = unsafe extern "system" fn(flags: u32, hauthzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE, prequest: *const AUTHZ_ACCESS_REQUEST, hauditevent: AUTHZ_AUDIT_EVENT_HANDLE, psecuritydescriptor: super::PSECURITY_DESCRIPTOR, optionalsecuritydescriptorarray: *const super::PSECURITY_DESCRIPTOR, optionalsecuritydescriptorcount: u32, preply: *const AUTHZ_ACCESS_REPLY) -> windows_sys::core::BOOL;
...
pub type AuthzRegisterCapChangeNotification = unsafe extern "system" fn(phcapchangesubscription: *mut AUTHZ_CAP_CHANGE_SUBSCRIPTION_HANDLE, pfncapchangecallback: super::super::System::Threading::LPTHREAD_START_ROUTINE, pcallbackcontext: *const core::ffi::c_void) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_System_Threading")]
...
pub type AuthzRegisterSecurityEventSource = unsafe extern "system" fn(dwflags: u32, szeventsourcename: windows_sys::core::PCWSTR, pheventprovider: *mut AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE) -> windows_sys::core::BOOL;
...
pub type AuthzReportSecurityEvent = unsafe extern "C" fn(dwflags: u32, heventprovider: AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE, dwauditid: u32, pusersid: super::PSID, dwcount: u32, ...) -> windows_sys::core::BOOL;
...
pub type AuthzReportSecurityEventFromParams = unsafe extern "system" fn(dwflags: u32, heventprovider: AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE, dwauditid: u32, pusersid: super::PSID, pparams: *const AUDIT_PARAMS) -> windows_sys::core::BOOL;
...
pub type AuthzSetAppContainerInformation = unsafe extern "system" fn(hauthzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE, pappcontainersid: super::PSID, capabilitycount: u32, pcapabilitysids: *const super::SID_AND_ATTRIBUTES) -> windows_sys::core::BOOL;
...
pub type AuthzUninstallSecurityEventSource = unsafe extern "system" fn(dwflags: u32, szeventsourcename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type AuthzUnregisterCapChangeNotification = unsafe extern "system" fn(hcapchangesubscription: AUTHZ_CAP_CHANGE_SUBSCRIPTION_HANDLE) -> windows_sys::core::BOOL;
...
pub type AuthzUnregisterSecurityEventSource = unsafe extern "system" fn(dwflags: u32, pheventprovider: *mut AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE) -> windows_sys::core::BOOL;
...
pub type BuildExplicitAccessWithNameA = unsafe extern "system" fn(pexplicitaccess: *mut EXPLICIT_ACCESS_A, ptrusteename: windows_sys::core::PCSTR, accesspermissions: u32, accessmode: ACCESS_MODE, inheritance: super::ACE_FLAGS);
...
pub type BuildExplicitAccessWithNameW = unsafe extern "system" fn(pexplicitaccess: *mut EXPLICIT_ACCESS_W, ptrusteename: windows_sys::core::PCWSTR, accesspermissions: u32, accessmode: ACCESS_MODE, inheritance: super::ACE_FLAGS);
...
pub type BuildImpersonateExplicitAccessWithNameA = unsafe extern "system" fn(pexplicitaccess: *mut EXPLICIT_ACCESS_A, ptrusteename: windows_sys::core::PCSTR, ptrustee: *const TRUSTEE_A, accesspermissions: u32, accessmode: ACCESS_MODE, inheritance: u32);
...
pub type BuildImpersonateExplicitAccessWithNameW = unsafe extern "system" fn(pexplicitaccess: *mut EXPLICIT_ACCESS_W, ptrusteename: windows_sys::core::PCWSTR, ptrustee: *const TRUSTEE_W, accesspermissions: u32, accessmode: ACCESS_MODE, inheritance: u32);
...
pub type BuildImpersonateTrusteeA = unsafe extern "system" fn(ptrustee: *mut TRUSTEE_A, pimpersonatetrustee: *const TRUSTEE_A);
...
pub type BuildImpersonateTrusteeW = unsafe extern "system" fn(ptrustee: *mut TRUSTEE_W, pimpersonatetrustee: *const TRUSTEE_W);
...
pub type BuildTrusteeWithObjectsAndNameW = unsafe extern "system" fn(ptrustee: *mut TRUSTEE_W, pobjname: *const OBJECTS_AND_NAME_W, objecttype: SE_OBJECT_TYPE, objecttypename: windows_sys::core::PCWSTR, inheritedobjecttypename: windows_sys::core::PCWSTR, name: windows_sys::core::PCWSTR);
...
pub type BuildTrusteeWithObjectsAndSidA = unsafe extern "system" fn(ptrustee: *mut TRUSTEE_A, pobjsid: *const OBJECTS_AND_SID, pobjectguid: *const windows_sys::core::GUID, pinheritedobjectguid: *const windows_sys::core::GUID, psid: super::PSID);
...
pub type BuildTrusteeWithObjectsAndSidW = unsafe extern "system" fn(ptrustee: *mut TRUSTEE_W, pobjsid: *const OBJECTS_AND_SID, pobjectguid: *const windows_sys::core::GUID, pinheritedobjectguid: *const windows_sys::core::GUID, psid: super::PSID);
...
pub type ConvertSidToStringSidA = unsafe extern "system" fn(sid: super::PSID, stringsid: *mut windows_sys::core::PSTR) -> windows_sys::core::BOOL;
...
pub type ConvertSidToStringSidW = unsafe extern "system" fn(sid: super::PSID, stringsid: *mut windows_sys::core::PWSTR) -> windows_sys::core::BOOL;
...
pub type ConvertStringSecurityDescriptorToSecurityDescriptorA = unsafe extern "system" fn(stringsecuritydescriptor: windows_sys::core::PCSTR, stringsdrevision: u32, securitydescriptor: *mut super::PSECURITY_DESCRIPTOR, securitydescriptorsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type ConvertStringSecurityDescriptorToSecurityDescriptorW = unsafe extern "system" fn(stringsecuritydescriptor: windows_sys::core::PCWSTR, stringsdrevision: u32, securitydescriptor: *mut super::PSECURITY_DESCRIPTOR, securitydescriptorsize: *mut u32) -> windows_sys::core::BOOL;
...
pub type ConvertStringSidToSidA = unsafe extern "system" fn(stringsid: windows_sys::core::PCSTR, sid: *mut super::PSID) -> windows_sys::core::BOOL;
...
pub type ConvertStringSidToSidW = unsafe extern "system" fn(stringsid: windows_sys::core::PCWSTR, sid: *mut super::PSID) -> windows_sys::core::BOOL;
...
pub type FreeInheritedFromArray = unsafe extern "system" fn(pinheritarray: *const INHERITED_FROMW, acecnt: u16, pfnarray: *const FN_OBJECT_MGR_FUNCTS) -> super::super::Foundation::WIN32_ERROR;
...
pub type GetAuditedPermissionsFromAclA = unsafe extern "system" fn(pacl: *const super::ACL, ptrustee: *const TRUSTEE_A, psuccessfulauditedrights: *mut u32, pfailedauditrights: *mut u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type GetAuditedPermissionsFromAclW = unsafe extern "system" fn(pacl: *const super::ACL, ptrustee: *const TRUSTEE_W, psuccessfulauditedrights: *mut u32, pfailedauditrights: *mut u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type GetEffectiveRightsFromAclA = unsafe extern "system" fn(pacl: *const super::ACL, ptrustee: *const TRUSTEE_A, paccessrights: *mut u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type GetEffectiveRightsFromAclW = unsafe extern "system" fn(pacl: *const super::ACL, ptrustee: *const TRUSTEE_W, paccessrights: *mut u32) -> super::super::Foundation::WIN32_ERROR;
...
pub type GetExplicitEntriesFromAclA = unsafe extern "system" fn(pacl: *const super::ACL, pccountofexplicitentries: *mut u32, plistofexplicitentries: *mut *mut EXPLICIT_ACCESS_A) -> super::super::Foundation::WIN32_ERROR;
...
pub type GetExplicitEntriesFromAclW = unsafe extern "system" fn(pacl: *const super::ACL, pccountofexplicitentries: *mut u32, plistofexplicitentries: *mut *mut EXPLICIT_ACCESS_W) -> super::super::Foundation::WIN32_ERROR;
...
pub type GetMultipleTrusteeA = unsafe extern "system" fn(ptrustee: *const TRUSTEE_A) -> *mut TRUSTEE_A;
windows_link::link!("advapi32.dll" "system" fn GetMultipleTrusteeA(ptrustee : *const TRUSTEE_A) -> *mut TRUSTEE_A);
pub type GetMultipleTrusteeOperationA = unsafe extern "system" fn(ptrustee: *const TRUSTEE_A) -> MULTIPLE_TRUSTEE_OPERATION;
...
pub type GetMultipleTrusteeOperationW = unsafe extern "system" fn(ptrustee: *const TRUSTEE_W) -> MULTIPLE_TRUSTEE_OPERATION;
...
pub type GetMultipleTrusteeW = unsafe extern "system" fn(ptrustee: *const TRUSTEE_W) -> *mut TRUSTEE_W;
windows_link::link!("advapi32.dll" "system" fn GetMultipleTrusteeW(ptrustee : *const TRUSTEE_W) -> *mut TRUSTEE_W);
pub type GetNamedSecurityInfoA = unsafe extern "system" fn(pobjectname: windows_sys::core::PCSTR, objecttype: SE_OBJECT_TYPE, securityinfo: super::OBJECT_SECURITY_INFORMATION, ppsidowner: *mut super::PSID, ppsidgroup: *mut super::PSID, ppdacl: *mut *mut super::ACL, ppsacl: *mut *mut super::ACL, ppsecuritydescriptor: *mut super::PSECURITY_DESCRIPTOR) -> super::super::Foundation::WIN32_ERROR;
...
pub type GetNamedSecurityInfoW = unsafe extern "system" fn(pobjectname: windows_sys::core::PCWSTR, objecttype: SE_OBJECT_TYPE, securityinfo: super::OBJECT_SECURITY_INFORMATION, ppsidowner: *mut super::PSID, ppsidgroup: *mut super::PSID, ppdacl: *mut *mut super::ACL, ppsacl: *mut *mut super::ACL, ppsecuritydescriptor: *mut super::PSECURITY_DESCRIPTOR) -> super::super::Foundation::WIN32_ERROR;
...
pub type GetSecurityInfo = unsafe extern "system" fn(handle: super::super::Foundation::HANDLE, objecttype: SE_OBJECT_TYPE, securityinfo: super::OBJECT_SECURITY_INFORMATION, ppsidowner: *mut super::PSID, ppsidgroup: *mut super::PSID, ppdacl: *mut *mut super::ACL, ppsacl: *mut *mut super::ACL, ppsecuritydescriptor: *mut super::PSECURITY_DESCRIPTOR) -> super::super::Foundation::WIN32_ERROR;
...
pub type GetTrusteeFormA = unsafe extern "system" fn(ptrustee: *const TRUSTEE_A) -> TRUSTEE_FORM;
windows_link::link!("advapi32.dll" "system" fn GetTrusteeFormA(ptrustee : *const TRUSTEE_A) -> TRUSTEE_FORM);
pub type GetTrusteeFormW = unsafe extern "system" fn(ptrustee: *const TRUSTEE_W) -> TRUSTEE_FORM;
windows_link::link!("advapi32.dll" "system" fn GetTrusteeFormW(ptrustee : *const TRUSTEE_W) -> TRUSTEE_FORM);
pub type GetTrusteeNameA = unsafe extern "system" fn(ptrustee: *const TRUSTEE_A) -> windows_sys::core::PSTR;
windows_link::link!("advapi32.dll" "system" fn GetTrusteeNameA(ptrustee : *const TRUSTEE_A) -> windows_sys::core::PSTR);
pub type GetTrusteeNameW = unsafe extern "system" fn(ptrustee: *const TRUSTEE_W) -> windows_sys::core::PWSTR;
windows_link::link!("advapi32.dll" "system" fn GetTrusteeNameW(ptrustee : *const TRUSTEE_W) -> windows_sys::core::PWSTR);
pub type GetTrusteeTypeA = unsafe extern "system" fn(ptrustee: *const TRUSTEE_A) -> TRUSTEE_TYPE;
windows_link::link!("advapi32.dll" "system" fn GetTrusteeTypeA(ptrustee : *const TRUSTEE_A) -> TRUSTEE_TYPE);
pub type GetTrusteeTypeW = unsafe extern "system" fn(ptrustee: *const TRUSTEE_W) -> TRUSTEE_TYPE;
windows_link::link!("advapi32.dll" "system" fn GetTrusteeTypeW(ptrustee : *const TRUSTEE_W) -> TRUSTEE_TYPE);
pub type LookupSecurityDescriptorPartsA = unsafe extern "system" fn(ppowner: *mut *mut TRUSTEE_A, ppgroup: *mut *mut TRUSTEE_A, pccountofaccessentries: *mut u32, pplistofaccessentries: *mut *mut EXPLICIT_ACCESS_A, pccountofauditentries: *mut u32, pplistofauditentries: *mut *mut EXPLICIT_ACCESS_A, psd: super::PSECURITY_DESCRIPTOR) -> super::super::Foundation::WIN32_ERROR;
windows_link::link!("advapi32.dll" "system" fn LookupSecurityDescriptorPartsA(ppowner : *mut *mut TRUSTEE_A, ppgroup : *mut *mut TRUSTEE_A, pccountofaccessentries : *mut u32, pplistofaccessentries : *mut *mut EXPLICIT_ACCESS_A, pccountofauditentries : *mut u32, pplistofauditentries : *mut *mut EXPLICIT_ACCESS_A, psd : super::PSECURITY_DESCRIPTOR) -> super::super::Foundation::WIN32_ERROR);
pub type LookupSecurityDescriptorPartsW = unsafe extern "system" fn(ppowner: *mut *mut TRUSTEE_W, ppgroup: *mut *mut TRUSTEE_W, pccountofaccessentries: *mut u32, pplistofaccessentries: *mut *mut EXPLICIT_ACCESS_W, pccountofauditentries: *mut u32, pplistofauditentries: *mut *mut EXPLICIT_ACCESS_W, psd: super::PSECURITY_DESCRIPTOR) -> super::super::Foundation::WIN32_ERROR;
...
pub type SetEntriesInAclA = unsafe extern "system" fn(ccountofexplicitentries: u32, plistofexplicitentries: *const EXPLICIT_ACCESS_A, oldacl: *const super::ACL, newacl: *mut *mut super::ACL) -> super::super::Foundation::WIN32_ERROR;
...
pub type SetEntriesInAclW = unsafe extern "system" fn(ccountofexplicitentries: u32, plistofexplicitentries: *const EXPLICIT_ACCESS_W, oldacl: *const super::ACL, newacl: *mut *mut super::ACL) -> super::super::Foundation::WIN32_ERROR;
...
pub type SetNamedSecurityInfoA = unsafe extern "system" fn(pobjectname: windows_sys::core::PCSTR, objecttype: SE_OBJECT_TYPE, securityinfo: super::OBJECT_SECURITY_INFORMATION, psidowner: super::PSID, psidgroup: super::PSID, pdacl: *const super::ACL, psacl: *const super::ACL) -> super::super::Foundation::WIN32_ERROR;
...
pub type SetNamedSecurityInfoW = unsafe extern "system" fn(pobjectname: windows_sys::core::PCWSTR, objecttype: SE_OBJECT_TYPE, securityinfo: super::OBJECT_SECURITY_INFORMATION, psidowner: super::PSID, psidgroup: super::PSID, pdacl: *const super::ACL, psacl: *const super::ACL) -> super::super::Foundation::WIN32_ERROR;
...
pub type SetSecurityInfo = unsafe extern "system" fn(handle: super::super::Foundation::HANDLE, objecttype: SE_OBJECT_TYPE, securityinfo: super::OBJECT_SECURITY_INFORMATION, psidowner: super::PSID, psidgroup: super::PSID, pdacl: *const super::ACL, psacl: *const super::ACL) -> super::super::Foundation::WIN32_ERROR;
...
pub type TreeResetNamedSecurityInfoW = unsafe extern "system" fn(pobjectname: windows_sys::core::PCWSTR, objecttype: SE_OBJECT_TYPE, securityinfo: super::OBJECT_SECURITY_INFORMATION, powner: super::PSID, pgroup: super::PSID, pdacl: *const super::ACL, psacl: *const super::ACL, keepexplicit: windows_sys::core::BOOL, fnprogress: FN_PROGRESS, progressinvokesetting: PROG_INVOKE_SETTING, args: *const core::ffi::c_void) -> super::super::Foundation::WIN32_ERROR;
...
pub type TreeSetNamedSecurityInfoW = unsafe extern "system" fn(pobjectname: windows_sys::core::PCWSTR, objecttype: SE_OBJECT_TYPE, securityinfo: super::OBJECT_SECURITY_INFORMATION, powner: super::PSID, pgroup: super::PSID, pdacl: *const super::ACL, psacl: *const super::ACL, dwaction: TREE_SEC_INFO, fnprogress: FN_PROGRESS, progressinvokesetting: PROG_INVOKE_SETTING, args: *const core::ffi::c_void) -> super::super::Foundation::WIN32_ERROR;
