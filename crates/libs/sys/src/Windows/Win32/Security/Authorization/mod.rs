windows_link::link!("authz.dll" "system" fn AuthzAccessCheck(flags : AUTHZ_ACCESS_CHECK_FLAGS, hauthzclientcontext : AUTHZ_CLIENT_CONTEXT_HANDLE, prequest : *mut AUTHZ_ACCESS_REQUEST, hauditevent : AUTHZ_AUDIT_EVENT_HANDLE, psecuritydescriptor : super:: PSECURITY_DESCRIPTOR, optionalsecuritydescriptorarray : *mut super:: PSECURITY_DESCRIPTOR, optionalsecuritydescriptorcount : u32, preply : *mut AUTHZ_ACCESS_REPLY, phaccesscheckresults : *mut AUTHZ_ACCESS_CHECK_RESULTS_HANDLE) -> windows_sys::core::BOOL);
windows_link::link!("authz.dll" "system" fn AuthzAddSidsToContext(hauthzclientcontext : AUTHZ_CLIENT_CONTEXT_HANDLE, sids : *mut super:: SID_AND_ATTRIBUTES, sidcount : u32, restrictedsids : *mut super:: SID_AND_ATTRIBUTES, restrictedsidcount : u32, phnewauthzclientcontext : *mut AUTHZ_CLIENT_CONTEXT_HANDLE) -> windows_sys::core::BOOL);
...
windows_link::link!("authz.dll" "system" fn AuthzEvaluateSacl(authzclientcontext : AUTHZ_CLIENT_CONTEXT_HANDLE, prequest : *mut AUTHZ_ACCESS_REQUEST, sacl : *mut super:: ACL, grantedaccess : u32, accessgranted : windows_sys::core::BOOL, pbgenerateaudit : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
...
windows_link::link!("authz.dll" "system" fn AuthzInitializeContextFromToken(flags : u32, tokenhandle : super::super::Foundation:: HANDLE, hauthzresourcemanager : AUTHZ_RESOURCE_MANAGER_HANDLE, pexpirationtime : *mut i64, identifier : super::super::Foundation:: LUID, dynamicgroupargs : *mut core::ffi::c_void, phauthzclientcontext : *mut AUTHZ_CLIENT_CONTEXT_HANDLE) -> windows_sys::core::BOOL);
...
windows_link::link!("authz.dll" "system" fn AuthzInitializeRemoteResourceManager(prpcinitinfo : *mut AUTHZ_RPC_INIT_INFO_CLIENT, phauthzresourcemanager : *mut AUTHZ_RESOURCE_MANAGER_HANDLE) -> windows_sys::core::BOOL);
...
windows_link::link!("authz.dll" "system" fn AuthzInitializeResourceManagerEx(flags : AUTHZ_RESOURCE_MANAGER_FLAGS, pauthzinitinfo : *mut AUTHZ_INIT_INFO, phauthzresourcemanager : *mut AUTHZ_RESOURCE_MANAGER_HANDLE) -> windows_sys::core::BOOL);
...
windows_link::link!("authz.dll" "system" fn AuthzModifyClaims(hauthzclientcontext : AUTHZ_CLIENT_CONTEXT_HANDLE, claimclass : AUTHZ_CONTEXT_INFORMATION_CLASS, pclaimoperations : *mut AUTHZ_SECURITY_ATTRIBUTE_OPERATION, pclaims : *mut AUTHZ_SECURITY_ATTRIBUTES_INFORMATION) -> windows_sys::core::BOOL);
windows_link::link!("authz.dll" "system" fn AuthzModifySecurityAttributes(hauthzclientcontext : AUTHZ_CLIENT_CONTEXT_HANDLE, poperations : *mut AUTHZ_SECURITY_ATTRIBUTE_OPERATION, pattributes : *mut AUTHZ_SECURITY_ATTRIBUTES_INFORMATION) -> windows_sys::core::BOOL);
...
windows_link::link!("authz.dll" "system" fn AuthzRegisterCapChangeNotification(phcapchangesubscription : *mut AUTHZ_CAP_CHANGE_SUBSCRIPTION_HANDLE, pfncapchangecallback : super::super::System::Threading:: LPTHREAD_START_ROUTINE, pcallbackcontext : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
...
windows_link::link!("advapi32.dll" "system" fn BuildImpersonateExplicitAccessWithNameA(pexplicitaccess : *mut EXPLICIT_ACCESS_A, ptrusteename : windows_sys::core::PCSTR, ptrustee : *mut TRUSTEE_A, accesspermissions : u32, accessmode : ACCESS_MODE, inheritance : u32));
...
windows_link::link!("advapi32.dll" "system" fn BuildImpersonateTrusteeA(ptrustee : *mut TRUSTEE_A, pimpersonatetrustee : *mut TRUSTEE_A));
windows_link::link!("advapi32.dll" "system" fn BuildImpersonateTrusteeW(ptrustee : *mut TRUSTEE_W, pimpersonatetrustee : *mut TRUSTEE_W));
...
windows_link::link!("advapi32.dll" "system" fn BuildSecurityDescriptorW(powner : *mut TRUSTEE_W, pgroup : *mut TRUSTEE_W, ccountofaccessentries : u32, plistofaccessentries : *mut EXPLICIT_ACCESS_W, ccountofauditentries : u32, plistofauditentries : *mut EXPLICIT_ACCESS_W, poldsd : super:: PSECURITY_DESCRIPTOR, psizenewsd : *mut u32, pnewsd : *mut super:: PSECURITY_DESCRIPTOR) -> super::super::Foundation:: WIN32_ERROR);
...
windows_link::link!("advapi32.dll" "system" fn BuildTrusteeWithObjectsAndNameA(ptrustee : *mut TRUSTEE_A, pobjname : *mut OBJECTS_AND_NAME_A, objecttype : SE_OBJECT_TYPE, objecttypename : windows_sys::core::PCSTR, inheritedobjecttypename : windows_sys::core::PCSTR, name : windows_sys::core::PCSTR));
...
windows_link::link!("advapi32.dll" "system" fn BuildTrusteeWithObjectsAndSidA(ptrustee : *mut TRUSTEE_A, pobjsid : *mut OBJECTS_AND_SID, pobjectguid : *mut windows_sys::core::GUID, pinheritedobjectguid : *mut windows_sys::core::GUID, psid : super:: PSID));
...
windows_link::link!("advapi32.dll" "system" fn FreeInheritedFromArray(pinheritarray : *mut INHERITED_FROMW, acecnt : u16, pfnarray : *mut FN_OBJECT_MGR_FUNCTS) -> super::super::Foundation:: WIN32_ERROR);
windows_link::link!("advapi32.dll" "system" fn GetAuditedPermissionsFromAclA(pacl : *mut super:: ACL, ptrustee : *mut TRUSTEE_A, psuccessfulauditedrights : *mut u32, pfailedauditrights : *mut u32) -> super::super::Foundation:: WIN32_ERROR);
...
windows_link::link!("advapi32.dll" "system" fn GetEffectiveRightsFromAclA(pacl : *mut super:: ACL, ptrustee : *mut TRUSTEE_A, paccessrights : *mut u32) -> super::super::Foundation:: WIN32_ERROR);
windows_link::link!("advapi32.dll" "system" fn GetEffectiveRightsFromAclW(pacl : *mut super:: ACL, ptrustee : *mut TRUSTEE_W, paccessrights : *mut u32) -> super::super::Foundation:: WIN32_ERROR);
...
windows_link::link!("advapi32.dll" "system" fn GetInheritanceSourceA(pobjectname : windows_sys::core::PCSTR, objecttype : SE_OBJECT_TYPE, securityinfo : super:: OBJECT_SECURITY_INFORMATION, container : windows_sys::core::BOOL, pobjectclassguids : *mut *mut windows_sys::core::GUID, guidcount : u32, pacl : *mut super:: ACL, pfnarray : *mut FN_OBJECT_MGR_FUNCTS, pgenericmapping : *mut super:: GENERIC_MAPPING, pinheritarray : *mut INHERITED_FROMA) -> super::super::Foundation:: WIN32_ERROR);
windows_link::link!("advapi32.dll" "system" fn GetInheritanceSourceW(pobjectname : windows_sys::core::PCWSTR, objecttype : SE_OBJECT_TYPE, securityinfo : super:: OBJECT_SECURITY_INFORMATION, container : windows_sys::core::BOOL, pobjectclassguids : *mut *mut windows_sys::core::GUID, guidcount : u32, pacl : *mut super:: ACL, pfnarray : *mut FN_OBJECT_MGR_FUNCTS, pgenericmapping : *mut super:: GENERIC_MAPPING, pinheritarray : *mut INHERITED_FROMW) -> super::super::Foundation:: WIN32_ERROR);
windows_link::link!("advapi32.dll" "system" fn GetMultipleTrusteeA(ptrustee : *mut TRUSTEE_A) -> *mut TRUSTEE_A);
windows_link::link!("advapi32.dll" "system" fn GetMultipleTrusteeOperationA(ptrustee : *mut TRUSTEE_A) -> MULTIPLE_TRUSTEE_OPERATION);
windows_link::link!("advapi32.dll" "system" fn GetMultipleTrusteeOperationW(ptrustee : *mut TRUSTEE_W) -> MULTIPLE_TRUSTEE_OPERATION);
...
windows_link::link!("advapi32.dll" "system" fn GetTrusteeFormA(ptrustee : *mut TRUSTEE_A) -> TRUSTEE_FORM);
windows_link::link!("advapi32.dll" "system" fn GetTrusteeFormW(ptrustee : *mut TRUSTEE_W) -> TRUSTEE_FORM);
windows_link::link!("advapi32.dll" "system" fn GetTrusteeNameA(ptrustee : *mut TRUSTEE_A) -> windows_sys::core::PSTR);
...
windows_link::link!("advapi32.dll" "system" fn GetTrusteeTypeW(ptrustee : *mut TRUSTEE_W) -> TRUSTEE_TYPE);
...
windows_link::link!("advapi32.dll" "system" fn SetEntriesInAclA(ccountofexplicitentries : u32, plistofexplicitentries : *mut EXPLICIT_ACCESS_A, oldacl : *mut super:: ACL, newacl : *mut *mut super:: ACL) -> super::super::Foundation:: WIN32_ERROR);
windows_link::link!("advapi32.dll" "system" fn SetEntriesInAclW(ccountofexplicitentries : u32, plistofexplicitentries : *mut EXPLICIT_ACCESS_W, oldacl : *mut super:: ACL, newacl : *mut *mut super:: ACL) -> super::super::Foundation:: WIN32_ERROR);
windows_link::link!("advapi32.dll" "system" fn SetNamedSecurityInfoA(pobjectname : windows_sys::core::PCSTR, objecttype : SE_OBJECT_TYPE, securityinfo : super:: OBJECT_SECURITY_INFORMATION, psidowner : super:: PSID, psidgroup : super:: PSID, pdacl : *mut super:: ACL, psacl : *mut super:: ACL) -> super::super::Foundation:: WIN32_ERROR);
...
windows_link::link!("advapi32.dll" "system" fn SetSecurityInfo(handle : super::super::Foundation:: HANDLE, objecttype : SE_OBJECT_TYPE, securityinfo : super:: OBJECT_SECURITY_INFORMATION, psidowner : super:: PSID, psidgroup : super:: PSID, pdacl : *mut super:: ACL, psacl : *mut super:: ACL) -> super::super::Foundation:: WIN32_ERROR);
windows_link::link!("advapi32.dll" "system" fn TreeResetNamedSecurityInfoA(pobjectname : windows_sys::core::PCSTR, objecttype : SE_OBJECT_TYPE, securityinfo : super:: OBJECT_SECURITY_INFORMATION, powner : super:: PSID, pgroup : super:: PSID, pdacl : *mut super:: ACL, psacl : *mut super:: ACL, keepexplicit : windows_sys::core::BOOL, fnprogress : FN_PROGRESS, progressinvokesetting : PROG_INVOKE_SETTING, args : *mut core::ffi::c_void) -> super::super::Foundation:: WIN32_ERROR);
...
windows_link::link!("advapi32.dll" "system" fn TreeSetNamedSecurityInfoA(pobjectname : windows_sys::core::PCSTR, objecttype : SE_OBJECT_TYPE, securityinfo : super:: OBJECT_SECURITY_INFORMATION, powner : super:: PSID, pgroup : super:: PSID, pdacl : *mut super:: ACL, psacl : *mut super:: ACL, dwaction : TREE_SEC_INFO, fnprogress : FN_PROGRESS, progressinvokesetting : PROG_INVOKE_SETTING, args : *mut core::ffi::c_void) -> super::super::Foundation:: WIN32_ERROR);
...
pub type PFN_AUTHZ_COMPUTE_DYNAMIC_GROUPS = Option<unsafe extern "system" fn(hauthzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE, args: *mut core::ffi::c_void, psidattrarray: *mut *mut super::SID_AND_ATTRIBUTES, psidcount: *mut u32, prestrictedsidattrarray: *mut *mut super::SID_AND_ATTRIBUTES, prestrictedsidcount: *mut u32) -> windows_sys::core::BOOL>;
...
pub type PFN_AUTHZ_FREE_CENTRAL_ACCESS_POLICY = Option<unsafe extern "system" fn(pcentralaccesspolicy: *mut core::ffi::c_void)>;
pub type PFN_AUTHZ_FREE_DYNAMIC_GROUPS = Option<unsafe extern "system" fn(psidattrarray: *const super::SID_AND_ATTRIBUTES)>;
pub type PFN_AUTHZ_GET_CENTRAL_ACCESS_POLICY = Option<unsafe extern "system" fn(hauthzclientcontext: AUTHZ_CLIENT_CONTEXT_HANDLE, capid: super::PSID, pargs: *mut core::ffi::c_void, pcentralaccesspolicyapplicable: *mut windows_sys::core::BOOL, ppcentralaccesspolicy: *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL>;
