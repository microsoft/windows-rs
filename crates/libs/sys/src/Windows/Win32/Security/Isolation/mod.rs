...
pub type DeleteAppContainerProfile = unsafe extern "system" fn(pszappcontainername: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type DeriveAppContainerSidFromAppContainerName = unsafe extern "system" fn(pszappcontainername: windows_sys::core::PCWSTR, ppsidappcontainersid: *mut super::PSID) -> windows_sys::core::HRESULT;
...
pub type DeriveRestrictedAppContainerSidFromAppContainerSidAndRestrictedName = unsafe extern "system" fn(psidappcontainersid: super::PSID, pszrestrictedappcontainername: windows_sys::core::PCWSTR, ppsidrestrictedappcontainersid: *mut super::PSID) -> windows_sys::core::HRESULT;
...
pub type GetAppContainerFolderPath = unsafe extern "system" fn(pszappcontainersid: windows_sys::core::PCWSTR, ppszpath: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type GetAppContainerNamedObjectPath = unsafe extern "system" fn(token: super::super::Foundation::HANDLE, appcontainersid: super::PSID, objectpathlength: u32, objectpath: windows_sys::core::PWSTR, returnlength: *mut u32) -> windows_sys::core::BOOL;
...
pub type IsCrossIsolatedEnvironmentClipboardContent = unsafe extern "system" fn(iscrossisolatedenvironmentclipboardcontent: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type IsProcessInIsolatedContainer = unsafe extern "system" fn(isprocessinisolatedcontainer: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type IsProcessInIsolatedWindowsEnvironment = unsafe extern "system" fn(isprocessinisolatedwindowsenvironment: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type IsProcessInWDAGContainer = unsafe extern "system" fn(reserved: *const core::ffi::c_void, isprocessinwdagcontainer: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
