...
windows_link::link!("advapi32.dll" "system" fn CredMarshalCredentialW(credtype : CRED_MARSHAL_TYPE, credential : *mut core::ffi::c_void, marshaledcredential : *mut windows_sys::core::PWSTR) -> windows_sys::core::BOOL);
...
windows_link::link!("advapi32.dll" "system" fn CredProtectA(fasself : windows_sys::core::BOOL, pszcredentials : windows_sys::core::PCSTR, cchcredentials : u32, pszprotectedcredentials : windows_sys::core::PCSTR, pcchmaxchars : *mut u32, protectiontype : *mut CRED_PROTECTION_TYPE) -> windows_sys::core::BOOL);
windows_link::link!("advapi32.dll" "system" fn CredProtectW(fasself : windows_sys::core::BOOL, pszcredentials : windows_sys::core::PCWSTR, cchcredentials : u32, pszprotectedcredentials : windows_sys::core::PCWSTR, pcchmaxchars : *mut u32, protectiontype : *mut CRED_PROTECTION_TYPE) -> windows_sys::core::BOOL);
...
windows_link::link!("advapi32.dll" "system" fn CredReadDomainCredentialsA(targetinfo : *mut CREDENTIAL_TARGET_INFORMATIONA, flags : u32, count : *mut u32, credential : *mut *mut *mut CREDENTIALA) -> windows_sys::core::BOOL);
windows_link::link!("advapi32.dll" "system" fn CredReadDomainCredentialsW(targetinfo : *mut CREDENTIAL_TARGET_INFORMATIONW, flags : u32, count : *mut u32, credential : *mut *mut *mut CREDENTIALW) -> windows_sys::core::BOOL);
...
windows_link::link!("credui.dll" "system" fn CredUICmdLinePromptForCredentialsA(psztargetname : windows_sys::core::PCSTR, pcontext : *mut SecHandle, dwautherror : u32, username : windows_sys::core::PCSTR, uluserbuffersize : u32, pszpassword : windows_sys::core::PCSTR, ulpasswordbuffersize : u32, pfsave : *mut windows_sys::core::BOOL, dwflags : CREDUI_FLAGS) -> u32);
windows_link::link!("credui.dll" "system" fn CredUICmdLinePromptForCredentialsW(psztargetname : windows_sys::core::PCWSTR, pcontext : *mut SecHandle, dwautherror : u32, username : windows_sys::core::PCWSTR, uluserbuffersize : u32, pszpassword : windows_sys::core::PCWSTR, ulpasswordbuffersize : u32, pfsave : *mut windows_sys::core::BOOL, dwflags : CREDUI_FLAGS) -> u32);
...
windows_link::link!("credui.dll" "system" fn CredUIParseUserNameW(username : windows_sys::core::PCWSTR, user : windows_sys::core::PCWSTR, userbuffersize : u32, domain : windows_sys::core::PCWSTR, domainbuffersize : u32) -> super::super::Foundation:: WIN32_ERROR);
...
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("credui.dll" "system" fn CredUIPromptForCredentialsW(puiinfo : *mut CREDUI_INFOW, psztargetname : windows_sys::core::PCWSTR, pcontext : *mut SecHandle, dwautherror : u32, pszusername : windows_sys::core::PCWSTR, ulusernamebuffersize : u32, pszpassword : windows_sys::core::PCWSTR, ulpasswordbuffersize : u32, save : *mut windows_sys::core::BOOL, dwflags : CREDUI_FLAGS) -> super::super::Foundation:: WIN32_ERROR);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
windows_link::link!("advapi32.dll" "system" fn CredUnprotectA(fasself : windows_sys::core::BOOL, pszprotectedcredentials : windows_sys::core::PCSTR, cchprotectedcredentials : u32, pszcredentials : windows_sys::core::PCSTR, pcchmaxchars : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("advapi32.dll" "system" fn CredUnprotectW(fasself : windows_sys::core::BOOL, pszprotectedcredentials : windows_sys::core::PCWSTR, cchprotectedcredentials : u32, pszcredentials : windows_sys::core::PCWSTR, pcchmaxchars : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("advapi32.dll" "system" fn CredWriteA(credential : *mut CREDENTIALA, flags : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("advapi32.dll" "system" fn CredWriteW(credential : *mut CREDENTIALW, flags : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("winscard.dll" "system" fn SCardEstablishContext(dwscope : SCARD_SCOPE, pvreserved1 : *mut core::ffi::c_void, pvreserved2 : *mut core::ffi::c_void, phcontext : *mut usize) -> i32);
...
windows_link::link!("winscard.dll" "system" fn SCardFreeMemory(hcontext : usize, pvmem : *mut core::ffi::c_void) -> i32);
windows_link::link!("winscard.dll" "system" fn SCardGetAttrib(hcard : usize, dwattrid : u32, pbattr : *mut u8, pcbattrlen : *mut u32) -> i32);
windows_link::link!("winscard.dll" "system" fn SCardGetCardTypeProviderNameA(hcontext : usize, szcardname : windows_sys::core::PCSTR, dwproviderid : u32, szprovider : windows_sys::core::PCSTR, pcchprovider : *mut u32) -> i32);
windows_link::link!("winscard.dll" "system" fn SCardGetCardTypeProviderNameW(hcontext : usize, szcardname : windows_sys::core::PCWSTR, dwproviderid : u32, szprovider : windows_sys::core::PCWSTR, pcchprovider : *mut u32) -> i32);
...
windows_link::link!("winscard.dll" "system" fn SCardGetReaderDeviceInstanceIdW(hcontext : usize, szreadername : windows_sys::core::PCWSTR, szdeviceinstanceid : windows_sys::core::PCWSTR, pcchdeviceinstanceid : *mut u32) -> i32);
...
windows_link::link!("winscard.dll" "system" fn SCardIntroduceCardTypeW(hcontext : usize, szcardname : windows_sys::core::PCWSTR, pguidprimaryprovider : *mut windows_sys::core::GUID, rgguidinterfaces : *mut windows_sys::core::GUID, dwinterfacecount : u32, pbatr : *mut u8, pbatrmask : *mut u8, cbatrlen : u32) -> i32);
...
windows_link::link!("winscard.dll" "system" fn SCardListCardsW(hcontext : usize, pbatr : *mut u8, rgquidinterfaces : *mut windows_sys::core::GUID, cguidinterfacecount : u32, mszcards : windows_sys::core::PCWSTR, pcchcards : *mut u32) -> i32);
...
windows_link::link!("winscard.dll" "system" fn SCardListReaderGroupsA(hcontext : usize, mszgroups : windows_sys::core::PCSTR, pcchgroups : *mut u32) -> i32);
windows_link::link!("winscard.dll" "system" fn SCardListReaderGroupsW(hcontext : usize, mszgroups : windows_sys::core::PCWSTR, pcchgroups : *mut u32) -> i32);
windows_link::link!("winscard.dll" "system" fn SCardListReadersA(hcontext : usize, mszgroups : windows_sys::core::PCSTR, mszreaders : windows_sys::core::PCSTR, pcchreaders : *mut u32) -> i32);
...
windows_link::link!("winscard.dll" "system" fn SCardListReadersWithDeviceInstanceIdA(hcontext : usize, szdeviceinstanceid : windows_sys::core::PCSTR, mszreaders : windows_sys::core::PCSTR, pcchreaders : *mut u32) -> i32);
...
windows_link::link!("winscard.dll" "system" fn SCardLocateCardsByATRA(hcontext : usize, rgatrmasks : *mut SCARD_ATRMASK, catrs : u32, rgreaderstates : *mut SCARD_READERSTATEA, creaders : u32) -> i32);
windows_link::link!("winscard.dll" "system" fn SCardLocateCardsByATRW(hcontext : usize, rgatrmasks : *mut SCARD_ATRMASK, catrs : u32, rgreaderstates : *mut SCARD_READERSTATEW, creaders : u32) -> i32);
...
windows_link::link!("winscard.dll" "system" fn SCardReadCacheA(hcontext : usize, cardidentifier : *mut windows_sys::core::GUID, freshnesscounter : u32, lookupname : windows_sys::core::PCSTR, data : *mut u8, datalen : *mut u32) -> i32);
windows_link::link!("winscard.dll" "system" fn SCardReadCacheW(hcontext : usize, cardidentifier : *mut windows_sys::core::GUID, freshnesscounter : u32, lookupname : windows_sys::core::PCWSTR, data : *mut u8, datalen : *mut u32) -> i32);
...
windows_link::link!("winscard.dll" "system" fn SCardSetAttrib(hcard : usize, dwattrid : u32, pbattr : *mut u8, cbattrlen : u32) -> i32);
...
windows_link::link!("winscard.dll" "system" fn SCardStatusA(hcard : usize, mszreadernames : windows_sys::core::PCSTR, pcchreaderlen : *mut u32, pdwstate : *mut u32, pdwprotocol : *mut u32, pbatr : *mut u8, pcbatrlen : *mut u32) -> i32);
windows_link::link!("winscard.dll" "system" fn SCardStatusW(hcard : usize, mszreadernames : windows_sys::core::PCWSTR, pcchreaderlen : *mut u32, pdwstate : *mut u32, pdwprotocol : *mut u32, pbatr : *mut u8, pcbatrlen : *mut u32) -> i32);
windows_link::link!("winscard.dll" "system" fn SCardTransmit(hcard : usize, piosendpci : *mut SCARD_IO_REQUEST, pbsendbuffer : *mut u8, cbsendlength : u32, piorecvpci : *mut SCARD_IO_REQUEST, pbrecvbuffer : *mut u8, pcbrecvlength : *mut u32) -> i32);
...
windows_link::link!("winscard.dll" "system" fn SCardWriteCacheW(hcontext : usize, cardidentifier : *mut windows_sys::core::GUID, freshnesscounter : u32, lookupname : windows_sys::core::PCWSTR, data : *mut u8, datalen : u32) -> i32);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub type LPOCNCHKPROC = Option<unsafe extern "system" fn(param0: usize, param1: usize, param2: *mut core::ffi::c_void) -> windows_sys::core::BOOL>;
pub type LPOCNCONNPROCA = Option<unsafe extern "system" fn(param0: usize, param1: windows_sys::core::PCSTR, param2: windows_sys::core::PCSTR, param3: *mut core::ffi::c_void) -> usize>;
pub type LPOCNCONNPROCW = Option<unsafe extern "system" fn(param0: usize, param1: windows_sys::core::PCWSTR, param2: windows_sys::core::PCWSTR, param3: *mut core::ffi::c_void) -> usize>;
