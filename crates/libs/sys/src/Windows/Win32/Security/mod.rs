...
pub const ACE_INHERITED_OBJECT_TYPE_PRESENT: SYSTEM_AUDIT_OBJECT_ACE_FLAGS = 2;
pub const ACE_OBJECT_TYPE_PRESENT: SYSTEM_AUDIT_OBJECT_ACE_FLAGS = 1;
...
pub const ACL_REVISION: ACE_REVISION = 2;
pub const ACL_REVISION_DS: ACE_REVISION = 4;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const ATTRIBUTE_SECURITY_INFORMATION: OBJECT_SECURITY_INFORMATION = 32;
...
pub const BACKUP_SECURITY_INFORMATION: OBJECT_SECURITY_INFORMATION = 65536;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const CLAIM_SECURITY_ATTRIBUTE_DISABLED: CLAIM_SECURITY_ATTRIBUTE_FLAGS = 16;
pub const CLAIM_SECURITY_ATTRIBUTE_DISABLED_BY_DEFAULT: CLAIM_SECURITY_ATTRIBUTE_FLAGS = 8;
...
pub const CLAIM_SECURITY_ATTRIBUTE_MANDATORY: CLAIM_SECURITY_ATTRIBUTE_FLAGS = 32;
pub const CLAIM_SECURITY_ATTRIBUTE_NON_INHERITABLE: CLAIM_SECURITY_ATTRIBUTE_FLAGS = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const CLAIM_SECURITY_ATTRIBUTE_TYPE_BOOLEAN: CLAIM_SECURITY_ATTRIBUTE_VALUE_TYPE = 6;
pub const CLAIM_SECURITY_ATTRIBUTE_TYPE_FQBN: CLAIM_SECURITY_ATTRIBUTE_VALUE_TYPE = 4;
pub const CLAIM_SECURITY_ATTRIBUTE_TYPE_INT64: CLAIM_SECURITY_ATTRIBUTE_VALUE_TYPE = 1;
pub const CLAIM_SECURITY_ATTRIBUTE_TYPE_OCTET_STRING: CLAIM_SECURITY_ATTRIBUTE_VALUE_TYPE = 16;
pub const CLAIM_SECURITY_ATTRIBUTE_TYPE_SID: CLAIM_SECURITY_ATTRIBUTE_VALUE_TYPE = 5;
pub const CLAIM_SECURITY_ATTRIBUTE_TYPE_STRING: CLAIM_SECURITY_ATTRIBUTE_VALUE_TYPE = 3;
pub const CLAIM_SECURITY_ATTRIBUTE_TYPE_UINT64: CLAIM_SECURITY_ATTRIBUTE_VALUE_TYPE = 2;
pub const CLAIM_SECURITY_ATTRIBUTE_USE_FOR_DENY_ONLY: CLAIM_SECURITY_ATTRIBUTE_FLAGS = 4;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const CLAIM_SECURITY_ATTRIBUTE_VALUE_CASE_SENSITIVE: CLAIM_SECURITY_ATTRIBUTE_FLAGS = 2;
pub type CLAIM_SECURITY_ATTRIBUTE_VALUE_TYPE = u16;
pub const CONTAINER_INHERIT_ACE: ACE_FLAGS = 2;
pub type CREATE_RESTRICTED_TOKEN_FLAGS = u32;
pub const CVT_SECONDS: u32 = 1;
pub const DACL_SECURITY_INFORMATION: OBJECT_SECURITY_INFORMATION = 4;
pub const DISABLE_MAX_PRIVILEGE: CREATE_RESTRICTED_TOKEN_FLAGS = 1;
pub type ENUM_PERIOD = i32;
pub const ENUM_PERIOD_DAYS: ENUM_PERIOD = 3;
pub const ENUM_PERIOD_HOURS: ENUM_PERIOD = 2;
pub const ENUM_PERIOD_INVALID: ENUM_PERIOD = -1;
pub const ENUM_PERIOD_MINUTES: ENUM_PERIOD = 1;
pub const ENUM_PERIOD_MONTHS: ENUM_PERIOD = 5;
pub const ENUM_PERIOD_SECONDS: ENUM_PERIOD = 0;
pub const ENUM_PERIOD_WEEKS: ENUM_PERIOD = 4;
pub const ENUM_PERIOD_YEARS: ENUM_PERIOD = 6;
pub const FAILED_ACCESS_ACE_FLAG: ACE_FLAGS = 128;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const GROUP_SECURITY_INFORMATION: OBJECT_SECURITY_INFORMATION = 2;
pub const INHERITED_ACE: ACE_FLAGS = 16;
pub const INHERIT_NO_PROPAGATE: ACE_FLAGS = 4;
pub const INHERIT_ONLY: ACE_FLAGS = 8;
pub const INHERIT_ONLY_ACE: ACE_FLAGS = 8;
pub const LABEL_SECURITY_INFORMATION: OBJECT_SECURITY_INFORMATION = 16;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const LOGON32_LOGON_BATCH: LOGON32_LOGON = 4;
pub const LOGON32_LOGON_INTERACTIVE: LOGON32_LOGON = 2;
pub const LOGON32_LOGON_NETWORK: LOGON32_LOGON = 3;
pub const LOGON32_LOGON_NETWORK_CLEARTEXT: LOGON32_LOGON = 8;
pub const LOGON32_LOGON_NEW_CREDENTIALS: LOGON32_LOGON = 9;
pub const LOGON32_LOGON_SERVICE: LOGON32_LOGON = 5;
pub const LOGON32_LOGON_UNLOCK: LOGON32_LOGON = 7;
pub type LOGON32_PROVIDER = u32;
pub const LOGON32_PROVIDER_DEFAULT: LOGON32_PROVIDER = 0;
pub const LOGON32_PROVIDER_WINNT40: LOGON32_PROVIDER = 2;
pub const LOGON32_PROVIDER_WINNT50: LOGON32_PROVIDER = 3;
pub const LUA_TOKEN: CREATE_RESTRICTED_TOKEN_FLAGS = 4;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const MaxTokenInfoClass: TOKEN_INFORMATION_CLASS = 51;
pub type NCRYPT_DESCRIPTOR_HANDLE = *mut core::ffi::c_void;
pub type NCRYPT_STREAM_HANDLE = *mut core::ffi::c_void;
pub const NO_INHERITANCE: ACE_FLAGS = 0;
pub const NO_PROPAGATE_INHERIT_ACE: ACE_FLAGS = 4;
pub const OBJECT_INHERIT_ACE: ACE_FLAGS = 1;
...
pub const OWNER_SECURITY_INFORMATION: OBJECT_SECURITY_INFORMATION = 1;
...
pub const PROTECTED_DACL_SECURITY_INFORMATION: OBJECT_SECURITY_INFORMATION = 2147483648;
pub const PROTECTED_SACL_SECURITY_INFORMATION: OBJECT_SECURITY_INFORMATION = 1073741824;
...
pub const SACL_SECURITY_INFORMATION: OBJECT_SECURITY_INFORMATION = 8;
pub type SAFER_LEVEL_HANDLE = *mut core::ffi::c_void;
pub const SANDBOX_INERT: CREATE_RESTRICTED_TOKEN_FLAGS = 2;
pub const SCOPE_SECURITY_INFORMATION: OBJECT_SECURITY_INFORMATION = 64;
...
pub const SEF_AVOID_OWNER_CHECK: SECURITY_AUTO_INHERIT_FLAGS = 16;
pub const SEF_AVOID_OWNER_RESTRICTION: SECURITY_AUTO_INHERIT_FLAGS = 4096;
pub const SEF_AVOID_PRIVILEGE_CHECK: SECURITY_AUTO_INHERIT_FLAGS = 8;
pub const SEF_DACL_AUTO_INHERIT: SECURITY_AUTO_INHERIT_FLAGS = 1;
pub const SEF_DEFAULT_DESCRIPTOR_FOR_OBJECT: SECURITY_AUTO_INHERIT_FLAGS = 4;
pub const SEF_DEFAULT_GROUP_FROM_PARENT: SECURITY_AUTO_INHERIT_FLAGS = 64;
pub const SEF_DEFAULT_OWNER_FROM_PARENT: SECURITY_AUTO_INHERIT_FLAGS = 32;
pub const SEF_MACL_NO_EXECUTE_UP: SECURITY_AUTO_INHERIT_FLAGS = 1024;
pub const SEF_MACL_NO_READ_UP: SECURITY_AUTO_INHERIT_FLAGS = 512;
pub const SEF_MACL_NO_WRITE_UP: SECURITY_AUTO_INHERIT_FLAGS = 256;
pub const SEF_SACL_AUTO_INHERIT: SECURITY_AUTO_INHERIT_FLAGS = 2;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const SE_DACL_AUTO_INHERITED: SECURITY_DESCRIPTOR_CONTROL = 1024;
pub const SE_DACL_AUTO_INHERIT_REQ: SECURITY_DESCRIPTOR_CONTROL = 256;
pub const SE_DACL_DEFAULTED: SECURITY_DESCRIPTOR_CONTROL = 8;
pub const SE_DACL_PRESENT: SECURITY_DESCRIPTOR_CONTROL = 4;
pub const SE_DACL_PROTECTED: SECURITY_DESCRIPTOR_CONTROL = 4096;
...
pub const SE_GROUP_DEFAULTED: SECURITY_DESCRIPTOR_CONTROL = 2;
...
pub const SE_OWNER_DEFAULTED: SECURITY_DESCRIPTOR_CONTROL = 1;
pub const SE_PRIVILEGE_ENABLED: TOKEN_PRIVILEGES_ATTRIBUTES = 2;
pub const SE_PRIVILEGE_ENABLED_BY_DEFAULT: TOKEN_PRIVILEGES_ATTRIBUTES = 1;
pub const SE_PRIVILEGE_REMOVED: TOKEN_PRIVILEGES_ATTRIBUTES = 4;
pub const SE_PRIVILEGE_USED_FOR_ACCESS: TOKEN_PRIVILEGES_ATTRIBUTES = 2147483648;
...
pub const SE_RM_CONTROL_VALID: SECURITY_DESCRIPTOR_CONTROL = 16384;
pub const SE_SACL_AUTO_INHERITED: SECURITY_DESCRIPTOR_CONTROL = 2048;
pub const SE_SACL_AUTO_INHERIT_REQ: SECURITY_DESCRIPTOR_CONTROL = 512;
pub const SE_SACL_DEFAULTED: SECURITY_DESCRIPTOR_CONTROL = 32;
pub const SE_SACL_PRESENT: SECURITY_DESCRIPTOR_CONTROL = 16;
pub const SE_SACL_PROTECTED: SECURITY_DESCRIPTOR_CONTROL = 8192;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const SE_SELF_RELATIVE: SECURITY_DESCRIPTOR_CONTROL = 32768;
...
pub const SUB_CONTAINERS_AND_OBJECTS_INHERIT: ACE_FLAGS = 3;
pub const SUB_CONTAINERS_ONLY_INHERIT: ACE_FLAGS = 2;
pub const SUB_OBJECTS_ONLY_INHERIT: ACE_FLAGS = 1;
pub const SUCCESSFUL_ACCESS_ACE_FLAG: ACE_FLAGS = 64;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const TOKEN_ACCESS_PSEUDO_HANDLE: TOKEN_ACCESS_MASK = 24;
pub const TOKEN_ACCESS_PSEUDO_HANDLE_WIN8: TOKEN_ACCESS_MASK = 24;
pub const TOKEN_ACCESS_SYSTEM_SECURITY: TOKEN_ACCESS_MASK = 16777216;
pub const TOKEN_ADJUST_DEFAULT: TOKEN_ACCESS_MASK = 128;
pub const TOKEN_ADJUST_GROUPS: TOKEN_ACCESS_MASK = 64;
pub const TOKEN_ADJUST_PRIVILEGES: TOKEN_ACCESS_MASK = 32;
pub const TOKEN_ADJUST_SESSIONID: TOKEN_ACCESS_MASK = 256;
pub const TOKEN_ALL_ACCESS: TOKEN_ACCESS_MASK = 983551;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const TOKEN_ASSIGN_PRIMARY: TOKEN_ACCESS_MASK = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const TOKEN_DELETE: TOKEN_ACCESS_MASK = 65536;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const TOKEN_DUPLICATE: TOKEN_ACCESS_MASK = 2;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const TOKEN_EXECUTE: TOKEN_ACCESS_MASK = 131072;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const TOKEN_IMPERSONATE: TOKEN_ACCESS_MASK = 4;
...
pub const TOKEN_MANDATORY_POLICY_NEW_PROCESS_MIN: TOKEN_MANDATORY_POLICY_ID = 2;
pub const TOKEN_MANDATORY_POLICY_NO_WRITE_UP: TOKEN_MANDATORY_POLICY_ID = 1;
pub const TOKEN_MANDATORY_POLICY_OFF: TOKEN_MANDATORY_POLICY_ID = 0;
pub const TOKEN_MANDATORY_POLICY_VALID_MASK: TOKEN_MANDATORY_POLICY_ID = 3;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const TOKEN_QUERY: TOKEN_ACCESS_MASK = 8;
pub const TOKEN_QUERY_SOURCE: TOKEN_ACCESS_MASK = 16;
pub const TOKEN_READ: TOKEN_ACCESS_MASK = 131080;
pub const TOKEN_READ_CONTROL: TOKEN_ACCESS_MASK = 131072;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const TOKEN_TRUST_CONSTRAINT_MASK: TOKEN_ACCESS_MASK = 131096;
...
pub const TOKEN_WRITE: TOKEN_ACCESS_MASK = 131296;
pub const TOKEN_WRITE_DAC: TOKEN_ACCESS_MASK = 262144;
pub const TOKEN_WRITE_OWNER: TOKEN_ACCESS_MASK = 524288;
...
pub const UNPROTECTED_DACL_SECURITY_INFORMATION: OBJECT_SECURITY_INFORMATION = 536870912;
pub const UNPROTECTED_SACL_SECURITY_INFORMATION: OBJECT_SECURITY_INFORMATION = 268435456;
pub type WELL_KNOWN_SID_TYPE = i32;
pub const WRITE_RESTRICTED: CREATE_RESTRICTED_TOKEN_FLAGS = 8;
...
pub const cwcFILENAMESUFFIXMAX: u32 = 20;
pub const cwcHRESULTSTRING: u32 = 40;
