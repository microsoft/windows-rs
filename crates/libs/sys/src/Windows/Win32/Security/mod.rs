...
pub mod WinWlx;
pub type AccessCheck = unsafe extern "system" fn(psecuritydescriptor: PSECURITY_DESCRIPTOR, clienttoken: super::Foundation::HANDLE, desiredaccess: u32, genericmapping: *const GENERIC_MAPPING, privilegeset: *mut PRIVILEGE_SET, privilegesetlength: *mut u32, grantedaccess: *mut u32, accessstatus: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn AccessCheck(psecuritydescriptor : PSECURITY_DESCRIPTOR, clienttoken : super::Foundation::HANDLE, desiredaccess : u32, genericmapping : *const GENERIC_MAPPING, privilegeset : *mut PRIVILEGE_SET, privilegesetlength : *mut u32, grantedaccess : *mut u32, accessstatus : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type AccessCheckAndAuditAlarmA = unsafe extern "system" fn(subsystemname: windows_sys::core::PCSTR, handleid: *const core::ffi::c_void, objecttypename: windows_sys::core::PCSTR, objectname: windows_sys::core::PCSTR, securitydescriptor: PSECURITY_DESCRIPTOR, desiredaccess: u32, genericmapping: *const GENERIC_MAPPING, objectcreation: windows_sys::core::BOOL, grantedaccess: *mut u32, accessstatus: *mut windows_sys::core::BOOL, pfgenerateonclose: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type AccessCheckByType = unsafe extern "system" fn(psecuritydescriptor: PSECURITY_DESCRIPTOR, principalselfsid: PSID, clienttoken: super::Foundation::HANDLE, desiredaccess: u32, objecttypelist: *mut OBJECT_TYPE_LIST, objecttypelistlength: u32, genericmapping: *const GENERIC_MAPPING, privilegeset: *mut PRIVILEGE_SET, privilegesetlength: *mut u32, grantedaccess: *mut u32, accessstatus: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type AccessCheckByTypeResultList = unsafe extern "system" fn(psecuritydescriptor: PSECURITY_DESCRIPTOR, principalselfsid: PSID, clienttoken: super::Foundation::HANDLE, desiredaccess: u32, objecttypelist: *mut OBJECT_TYPE_LIST, objecttypelistlength: u32, genericmapping: *const GENERIC_MAPPING, privilegeset: *mut PRIVILEGE_SET, privilegesetlength: *mut u32, grantedaccesslist: *mut u32, accessstatuslist: *mut u32) -> windows_sys::core::BOOL;
...
pub type AccessCheckByTypeResultListAndAuditAlarmA = unsafe extern "system" fn(subsystemname: windows_sys::core::PCSTR, handleid: *const core::ffi::c_void, objecttypename: windows_sys::core::PCSTR, objectname: windows_sys::core::PCSTR, securitydescriptor: PSECURITY_DESCRIPTOR, principalselfsid: PSID, desiredaccess: u32, audittype: AUDIT_EVENT_TYPE, flags: u32, objecttypelist: *mut OBJECT_TYPE_LIST, objecttypelistlength: u32, genericmapping: *const GENERIC_MAPPING, objectcreation: windows_sys::core::BOOL, grantedaccess: *mut u32, accessstatuslist: *mut u32, pfgenerateonclose: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type AccessCheckByTypeResultListAndAuditAlarmByHandleA = unsafe extern "system" fn(subsystemname: windows_sys::core::PCSTR, handleid: *const core::ffi::c_void, clienttoken: super::Foundation::HANDLE, objecttypename: windows_sys::core::PCSTR, objectname: windows_sys::core::PCSTR, securitydescriptor: PSECURITY_DESCRIPTOR, principalselfsid: PSID, desiredaccess: u32, audittype: AUDIT_EVENT_TYPE, flags: u32, objecttypelist: *mut OBJECT_TYPE_LIST, objecttypelistlength: u32, genericmapping: *const GENERIC_MAPPING, objectcreation: windows_sys::core::BOOL, grantedaccess: *mut u32, accessstatuslist: *mut u32, pfgenerateonclose: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type AccessCheckByTypeResultListAndAuditAlarmByHandleW = unsafe extern "system" fn(subsystemname: windows_sys::core::PCWSTR, handleid: *const core::ffi::c_void, clienttoken: super::Foundation::HANDLE, objecttypename: windows_sys::core::PCWSTR, objectname: windows_sys::core::PCWSTR, securitydescriptor: PSECURITY_DESCRIPTOR, principalselfsid: PSID, desiredaccess: u32, audittype: AUDIT_EVENT_TYPE, flags: u32, objecttypelist: *mut OBJECT_TYPE_LIST, objecttypelistlength: u32, genericmapping: *const GENERIC_MAPPING, objectcreation: windows_sys::core::BOOL, grantedaccesslist: *mut u32, accessstatuslist: *mut u32, pfgenerateonclose: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type AccessCheckByTypeResultListAndAuditAlarmW = unsafe extern "system" fn(subsystemname: windows_sys::core::PCWSTR, handleid: *const core::ffi::c_void, objecttypename: windows_sys::core::PCWSTR, objectname: windows_sys::core::PCWSTR, securitydescriptor: PSECURITY_DESCRIPTOR, principalselfsid: PSID, desiredaccess: u32, audittype: AUDIT_EVENT_TYPE, flags: u32, objecttypelist: *mut OBJECT_TYPE_LIST, objecttypelistlength: u32, genericmapping: *const GENERIC_MAPPING, objectcreation: windows_sys::core::BOOL, grantedaccesslist: *mut u32, accessstatuslist: *mut u32, pfgenerateonclose: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type AddAccessAllowedAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: ACE_REVISION, accessmask: u32, psid: PSID) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn AddAccessAllowedAce(pacl : *mut ACL, dwacerevision : ACE_REVISION, accessmask : u32, psid : PSID) -> windows_sys::core::BOOL);
pub type AddAccessAllowedAceEx = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: ACE_REVISION, aceflags: ACE_FLAGS, accessmask: u32, psid: PSID) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn AddAccessAllowedAceEx(pacl : *mut ACL, dwacerevision : ACE_REVISION, aceflags : ACE_FLAGS, accessmask : u32, psid : PSID) -> windows_sys::core::BOOL);
pub type AddAccessAllowedObjectAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: ACE_REVISION, aceflags: ACE_FLAGS, accessmask: u32, objecttypeguid: *const windows_sys::core::GUID, inheritedobjecttypeguid: *const windows_sys::core::GUID, psid: PSID) -> windows_sys::core::BOOL;
...
pub type AddAccessDeniedAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: ACE_REVISION, accessmask: u32, psid: PSID) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn AddAccessDeniedAce(pacl : *mut ACL, dwacerevision : ACE_REVISION, accessmask : u32, psid : PSID) -> windows_sys::core::BOOL);
pub type AddAccessDeniedAceEx = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: ACE_REVISION, aceflags: ACE_FLAGS, accessmask: u32, psid: PSID) -> windows_sys::core::BOOL;
...
pub type AddAccessDeniedObjectAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: ACE_REVISION, aceflags: ACE_FLAGS, accessmask: u32, objecttypeguid: *const windows_sys::core::GUID, inheritedobjecttypeguid: *const windows_sys::core::GUID, psid: PSID) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn AddAccessDeniedObjectAce(pacl : *mut ACL, dwacerevision : ACE_REVISION, aceflags : ACE_FLAGS, accessmask : u32, objecttypeguid : *const windows_sys::core::GUID, inheritedobjecttypeguid : *const windows_sys::core::GUID, psid : PSID) -> windows_sys::core::BOOL);
pub type AddAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: ACE_REVISION, dwstartingaceindex: u32, pacelist: *const core::ffi::c_void, nacelistlength: u32) -> windows_sys::core::BOOL;
...
pub type AddAuditAccessAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: ACE_REVISION, dwaccessmask: u32, psid: PSID, bauditsuccess: windows_sys::core::BOOL, bauditfailure: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn AddAuditAccessAce(pacl : *mut ACL, dwacerevision : ACE_REVISION, dwaccessmask : u32, psid : PSID, bauditsuccess : windows_sys::core::BOOL, bauditfailure : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type AddAuditAccessAceEx = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: ACE_REVISION, aceflags: ACE_FLAGS, dwaccessmask: u32, psid: PSID, bauditsuccess: windows_sys::core::BOOL, bauditfailure: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn AddAuditAccessAceEx(pacl : *mut ACL, dwacerevision : ACE_REVISION, aceflags : ACE_FLAGS, dwaccessmask : u32, psid : PSID, bauditsuccess : windows_sys::core::BOOL, bauditfailure : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type AddAuditAccessObjectAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: ACE_REVISION, aceflags: ACE_FLAGS, accessmask: u32, objecttypeguid: *const windows_sys::core::GUID, inheritedobjecttypeguid: *const windows_sys::core::GUID, psid: PSID, bauditsuccess: windows_sys::core::BOOL, bauditfailure: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type AddConditionalAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: ACE_REVISION, aceflags: ACE_FLAGS, acetype: u8, accessmask: u32, psid: PSID, conditionstr: windows_sys::core::PCWSTR, returnlength: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn AddConditionalAce(pacl : *mut ACL, dwacerevision : ACE_REVISION, aceflags : ACE_FLAGS, acetype : u8, accessmask : u32, psid : PSID, conditionstr : windows_sys::core::PCWSTR, returnlength : *mut u32) -> windows_sys::core::BOOL);
pub type AddMandatoryAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: ACE_REVISION, aceflags: ACE_FLAGS, mandatorypolicy: u32, plabelsid: PSID) -> windows_sys::core::BOOL;
...
pub type AddResourceAttributeAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: ACE_REVISION, aceflags: ACE_FLAGS, accessmask: u32, psid: PSID, pattributeinfo: *const CLAIM_SECURITY_ATTRIBUTES_INFORMATION, preturnlength: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn AddResourceAttributeAce(pacl : *mut ACL, dwacerevision : ACE_REVISION, aceflags : ACE_FLAGS, accessmask : u32, psid : PSID, pattributeinfo : *const CLAIM_SECURITY_ATTRIBUTES_INFORMATION, preturnlength : *mut u32) -> windows_sys::core::BOOL);
pub type AddScopedPolicyIDAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: ACE_REVISION, aceflags: ACE_FLAGS, accessmask: u32, psid: PSID) -> windows_sys::core::BOOL;
...
pub type AdjustTokenGroups = unsafe extern "system" fn(tokenhandle: super::Foundation::HANDLE, resettodefault: windows_sys::core::BOOL, newstate: *const TOKEN_GROUPS, bufferlength: u32, previousstate: *mut TOKEN_GROUPS, returnlength: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn AdjustTokenGroups(tokenhandle : super::Foundation::HANDLE, resettodefault : windows_sys::core::BOOL, newstate : *const TOKEN_GROUPS, bufferlength : u32, previousstate : *mut TOKEN_GROUPS, returnlength : *mut u32) -> windows_sys::core::BOOL);
pub type AdjustTokenPrivileges = unsafe extern "system" fn(tokenhandle: super::Foundation::HANDLE, disableallprivileges: windows_sys::core::BOOL, newstate: *const TOKEN_PRIVILEGES, bufferlength: u32, previousstate: *mut TOKEN_PRIVILEGES, returnlength: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn AdjustTokenPrivileges(tokenhandle : super::Foundation::HANDLE, disableallprivileges : windows_sys::core::BOOL, newstate : *const TOKEN_PRIVILEGES, bufferlength : u32, previousstate : *mut TOKEN_PRIVILEGES, returnlength : *mut u32) -> windows_sys::core::BOOL);
pub type AllocateAndInitializeSid = unsafe extern "system" fn(pidentifierauthority: *const SID_IDENTIFIER_AUTHORITY, nsubauthoritycount: u8, nsubauthority0: u32, nsubauthority1: u32, nsubauthority2: u32, nsubauthority3: u32, nsubauthority4: u32, nsubauthority5: u32, nsubauthority6: u32, nsubauthority7: u32, psid: *mut PSID) -> windows_sys::core::BOOL;
...
pub type AllocateLocallyUniqueId = unsafe extern "system" fn(luid: *mut super::Foundation::LUID) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn AllocateLocallyUniqueId(luid : *mut super::Foundation::LUID) -> windows_sys::core::BOOL);
pub type AreAllAccessesGranted = unsafe extern "system" fn(grantedaccess: u32, desiredaccess: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn AreAllAccessesGranted(grantedaccess : u32, desiredaccess : u32) -> windows_sys::core::BOOL);
pub type AreAnyAccessesGranted = unsafe extern "system" fn(grantedaccess: u32, desiredaccess: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn AreAnyAccessesGranted(grantedaccess : u32, desiredaccess : u32) -> windows_sys::core::BOOL);
pub type CheckTokenCapability = unsafe extern "system" fn(tokenhandle: super::Foundation::HANDLE, capabilitysidtocheck: PSID, hascapability: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn CheckTokenCapability(tokenhandle : super::Foundation::HANDLE, capabilitysidtocheck : PSID, hascapability : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type CheckTokenMembership = unsafe extern "system" fn(tokenhandle: super::Foundation::HANDLE, sidtocheck: PSID, ismember: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CheckTokenMembership(tokenhandle : super::Foundation::HANDLE, sidtocheck : PSID, ismember : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type CheckTokenMembershipEx = unsafe extern "system" fn(tokenhandle: super::Foundation::HANDLE, sidtocheck: PSID, flags: u32, ismember: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn CheckTokenMembershipEx(tokenhandle : super::Foundation::HANDLE, sidtocheck : PSID, flags : u32, ismember : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type ConvertToAutoInheritPrivateObjectSecurity = unsafe extern "system" fn(parentdescriptor: PSECURITY_DESCRIPTOR, currentsecuritydescriptor: PSECURITY_DESCRIPTOR, newsecuritydescriptor: *mut PSECURITY_DESCRIPTOR, objecttype: *const windows_sys::core::GUID, isdirectoryobject: bool, genericmapping: *const GENERIC_MAPPING) -> windows_sys::core::BOOL;
...
pub type CopySid = unsafe extern "system" fn(ndestinationsidlength: u32, pdestinationsid: PSID, psourcesid: PSID) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn CopySid(ndestinationsidlength : u32, pdestinationsid : PSID, psourcesid : PSID) -> windows_sys::core::BOOL);
pub type CreatePrivateObjectSecurity = unsafe extern "system" fn(parentdescriptor: PSECURITY_DESCRIPTOR, creatordescriptor: PSECURITY_DESCRIPTOR, newdescriptor: *mut PSECURITY_DESCRIPTOR, isdirectoryobject: windows_sys::core::BOOL, token: super::Foundation::HANDLE, genericmapping: *const GENERIC_MAPPING) -> windows_sys::core::BOOL;
...
pub type CreateWellKnownSid = unsafe extern "system" fn(wellknownsidtype: WELL_KNOWN_SID_TYPE, domainsid: PSID, psid: PSID, cbsid: *mut u32) -> windows_sys::core::BOOL;
...
pub type DeleteAce = unsafe extern "system" fn(pacl: *mut ACL, dwaceindex: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn DeleteAce(pacl : *mut ACL, dwaceindex : u32) -> windows_sys::core::BOOL);
pub type DeriveCapabilitySidsFromName = unsafe extern "system" fn(capname: windows_sys::core::PCWSTR, capabilitygroupsids: *mut *mut PSID, capabilitygroupsidcount: *mut u32, capabilitysids: *mut *mut PSID, capabilitysidcount: *mut u32) -> windows_sys::core::BOOL;
...
pub type DestroyPrivateObjectSecurity = unsafe extern "system" fn(objectdescriptor: *const PSECURITY_DESCRIPTOR) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn DestroyPrivateObjectSecurity(objectdescriptor : *const PSECURITY_DESCRIPTOR) -> windows_sys::core::BOOL);
pub type DuplicateToken = unsafe extern "system" fn(existingtokenhandle: super::Foundation::HANDLE, impersonationlevel: SECURITY_IMPERSONATION_LEVEL, duplicatetokenhandle: *mut super::Foundation::HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn DuplicateToken(existingtokenhandle : super::Foundation::HANDLE, impersonationlevel : SECURITY_IMPERSONATION_LEVEL, duplicatetokenhandle : *mut super::Foundation::HANDLE) -> windows_sys::core::BOOL);
pub type DuplicateTokenEx = unsafe extern "system" fn(hexistingtoken: super::Foundation::HANDLE, dwdesiredaccess: TOKEN_ACCESS_MASK, lptokenattributes: *const SECURITY_ATTRIBUTES, impersonationlevel: SECURITY_IMPERSONATION_LEVEL, tokentype: TOKEN_TYPE, phnewtoken: *mut super::Foundation::HANDLE) -> windows_sys::core::BOOL;
...
pub type EqualDomainSid = unsafe extern "system" fn(psid1: PSID, psid2: PSID, pfequal: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn EqualDomainSid(psid1 : PSID, psid2 : PSID, pfequal : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type EqualPrefixSid = unsafe extern "system" fn(psid1: PSID, psid2: PSID) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn EqualPrefixSid(psid1 : PSID, psid2 : PSID) -> windows_sys::core::BOOL);
pub type EqualSid = unsafe extern "system" fn(psid1: PSID, psid2: PSID) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn EqualSid(psid1 : PSID, psid2 : PSID) -> windows_sys::core::BOOL);
pub type FindFirstFreeAce = unsafe extern "system" fn(pacl: *const ACL, pace: *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type FreeSid = unsafe extern "system" fn(psid: PSID) -> *mut core::ffi::c_void;
windows_link::link!("advapi32.dll" "system" fn FreeSid(psid : PSID) -> *mut core::ffi::c_void);
pub type GetAce = unsafe extern "system" fn(pacl: *const ACL, dwaceindex: u32, pace: *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn GetAce(pacl : *const ACL, dwaceindex : u32, pace : *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL);
pub type GetAclInformation = unsafe extern "system" fn(pacl: *const ACL, paclinformation: *mut core::ffi::c_void, naclinformationlength: u32, dwaclinformationclass: ACL_INFORMATION_CLASS) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn GetAclInformation(pacl : *const ACL, paclinformation : *mut core::ffi::c_void, naclinformationlength : u32, dwaclinformationclass : ACL_INFORMATION_CLASS) -> windows_sys::core::BOOL);
pub type GetAppContainerAce = unsafe extern "system" fn(acl: *const ACL, startingaceindex: u32, appcontainerace: *mut *mut core::ffi::c_void, appcontaineraceindex: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetCachedSigningLevel = unsafe extern "system" fn(file: super::Foundation::HANDLE, flags: *mut u32, signinglevel: *mut u32, thumbprint: *mut u8, thumbprintsize: *mut u32, thumbprintalgorithm: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetFileSecurityA = unsafe extern "system" fn(lpfilename: windows_sys::core::PCSTR, requestedinformation: u32, psecuritydescriptor: PSECURITY_DESCRIPTOR, nlength: u32, lpnlengthneeded: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn GetFileSecurityA(lpfilename : windows_sys::core::PCSTR, requestedinformation : u32, psecuritydescriptor : PSECURITY_DESCRIPTOR, nlength : u32, lpnlengthneeded : *mut u32) -> windows_sys::core::BOOL);
pub type GetFileSecurityW = unsafe extern "system" fn(lpfilename: windows_sys::core::PCWSTR, requestedinformation: u32, psecuritydescriptor: PSECURITY_DESCRIPTOR, nlength: u32, lpnlengthneeded: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn GetFileSecurityW(lpfilename : windows_sys::core::PCWSTR, requestedinformation : u32, psecuritydescriptor : PSECURITY_DESCRIPTOR, nlength : u32, lpnlengthneeded : *mut u32) -> windows_sys::core::BOOL);
pub type GetKernelObjectSecurity = unsafe extern "system" fn(handle: super::Foundation::HANDLE, requestedinformation: u32, psecuritydescriptor: PSECURITY_DESCRIPTOR, nlength: u32, lpnlengthneeded: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn GetKernelObjectSecurity(handle : super::Foundation::HANDLE, requestedinformation : u32, psecuritydescriptor : PSECURITY_DESCRIPTOR, nlength : u32, lpnlengthneeded : *mut u32) -> windows_sys::core::BOOL);
pub type GetLengthSid = unsafe extern "system" fn(psid: PSID) -> u32;
windows_link::link!("advapi32.dll" "system" fn GetLengthSid(psid : PSID) -> u32);
pub type GetPrivateObjectSecurity = unsafe extern "system" fn(objectdescriptor: PSECURITY_DESCRIPTOR, securityinformation: OBJECT_SECURITY_INFORMATION, resultantdescriptor: PSECURITY_DESCRIPTOR, descriptorlength: u32, returnlength: *mut u32) -> windows_sys::core::BOOL;
...
pub type GetSecurityDescriptorControl = unsafe extern "system" fn(psecuritydescriptor: PSECURITY_DESCRIPTOR, pcontrol: *mut u16, lpdwrevision: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn GetSecurityDescriptorControl(psecuritydescriptor : PSECURITY_DESCRIPTOR, pcontrol : *mut u16, lpdwrevision : *mut u32) -> windows_sys::core::BOOL);
pub type GetSecurityDescriptorDacl = unsafe extern "system" fn(psecuritydescriptor: PSECURITY_DESCRIPTOR, lpbdaclpresent: *mut windows_sys::core::BOOL, pdacl: *mut *mut ACL, lpbdacldefaulted: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn GetSecurityDescriptorDacl(psecuritydescriptor : PSECURITY_DESCRIPTOR, lpbdaclpresent : *mut windows_sys::core::BOOL, pdacl : *mut *mut ACL, lpbdacldefaulted : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type GetSecurityDescriptorGroup = unsafe extern "system" fn(psecuritydescriptor: PSECURITY_DESCRIPTOR, pgroup: *mut PSID, lpbgroupdefaulted: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn GetSecurityDescriptorGroup(psecuritydescriptor : PSECURITY_DESCRIPTOR, pgroup : *mut PSID, lpbgroupdefaulted : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type GetSecurityDescriptorLength = unsafe extern "system" fn(psecuritydescriptor: PSECURITY_DESCRIPTOR) -> u32;
windows_link::link!("advapi32.dll" "system" fn GetSecurityDescriptorLength(psecuritydescriptor : PSECURITY_DESCRIPTOR) -> u32);
pub type GetSecurityDescriptorOwner = unsafe extern "system" fn(psecuritydescriptor: PSECURITY_DESCRIPTOR, powner: *mut PSID, lpbownerdefaulted: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn GetSecurityDescriptorOwner(psecuritydescriptor : PSECURITY_DESCRIPTOR, powner : *mut PSID, lpbownerdefaulted : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type GetSecurityDescriptorRMControl = unsafe extern "system" fn(securitydescriptor: PSECURITY_DESCRIPTOR, rmcontrol: *mut u8) -> u32;
windows_link::link!("advapi32.dll" "system" fn GetSecurityDescriptorRMControl(securitydescriptor : PSECURITY_DESCRIPTOR, rmcontrol : *mut u8) -> u32);
pub type GetSecurityDescriptorSacl = unsafe extern "system" fn(psecuritydescriptor: PSECURITY_DESCRIPTOR, lpbsaclpresent: *mut windows_sys::core::BOOL, psacl: *mut *mut ACL, lpbsacldefaulted: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn GetSecurityDescriptorSacl(psecuritydescriptor : PSECURITY_DESCRIPTOR, lpbsaclpresent : *mut windows_sys::core::BOOL, psacl : *mut *mut ACL, lpbsacldefaulted : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type GetSidIdentifierAuthority = unsafe extern "system" fn(psid: PSID) -> *mut SID_IDENTIFIER_AUTHORITY;
windows_link::link!("advapi32.dll" "system" fn GetSidIdentifierAuthority(psid : PSID) -> *mut SID_IDENTIFIER_AUTHORITY);
pub type GetSidLengthRequired = unsafe extern "system" fn(nsubauthoritycount: u8) -> u32;
windows_link::link!("advapi32.dll" "system" fn GetSidLengthRequired(nsubauthoritycount : u8) -> u32);
pub type GetSidSubAuthority = unsafe extern "system" fn(psid: PSID, nsubauthority: u32) -> *mut u32;
windows_link::link!("advapi32.dll" "system" fn GetSidSubAuthority(psid : PSID, nsubauthority : u32) -> *mut u32);
pub type GetSidSubAuthorityCount = unsafe extern "system" fn(psid: PSID) -> *mut u8;
windows_link::link!("advapi32.dll" "system" fn GetSidSubAuthorityCount(psid : PSID) -> *mut u8);
pub type GetTokenInformation = unsafe extern "system" fn(tokenhandle: super::Foundation::HANDLE, tokeninformationclass: TOKEN_INFORMATION_CLASS, tokeninformation: *mut core::ffi::c_void, tokeninformationlength: u32, returnlength: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn GetTokenInformation(tokenhandle : super::Foundation::HANDLE, tokeninformationclass : TOKEN_INFORMATION_CLASS, tokeninformation : *mut core::ffi::c_void, tokeninformationlength : u32, returnlength : *mut u32) -> windows_sys::core::BOOL);
pub type GetUserObjectSecurity = unsafe extern "system" fn(hobj: super::Foundation::HANDLE, psirequested: *const u32, psid: PSECURITY_DESCRIPTOR, nlength: u32, lpnlengthneeded: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn GetUserObjectSecurity(hobj : super::Foundation::HANDLE, psirequested : *const u32, psid : PSECURITY_DESCRIPTOR, nlength : u32, lpnlengthneeded : *mut u32) -> windows_sys::core::BOOL);
pub type GetWindowsAccountDomainSid = unsafe extern "system" fn(psid: PSID, pdomainsid: PSID, cbdomainsid: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn GetWindowsAccountDomainSid(psid : PSID, pdomainsid : PSID, cbdomainsid : *mut u32) -> windows_sys::core::BOOL);
pub type ImpersonateAnonymousToken = unsafe extern "system" fn(threadhandle: super::Foundation::HANDLE) -> windows_sys::core::BOOL;
...
pub type ImpersonateLoggedOnUser = unsafe extern "system" fn(htoken: super::Foundation::HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn ImpersonateLoggedOnUser(htoken : super::Foundation::HANDLE) -> windows_sys::core::BOOL);
pub type ImpersonateSelf = unsafe extern "system" fn(impersonationlevel: SECURITY_IMPERSONATION_LEVEL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn ImpersonateSelf(impersonationlevel : SECURITY_IMPERSONATION_LEVEL) -> windows_sys::core::BOOL);
pub type InitializeAcl = unsafe extern "system" fn(pacl: *mut ACL, nacllength: u32, dwaclrevision: ACE_REVISION) -> windows_sys::core::BOOL;
...
pub type InitializeSecurityDescriptor = unsafe extern "system" fn(psecuritydescriptor: PSECURITY_DESCRIPTOR, dwrevision: u32) -> windows_sys::core::BOOL;
...
pub type InitializeSid = unsafe extern "system" fn(sid: PSID, pidentifierauthority: *const SID_IDENTIFIER_AUTHORITY, nsubauthoritycount: u8) -> windows_sys::core::BOOL;
...
pub type IsTokenRestricted = unsafe extern "system" fn(tokenhandle: super::Foundation::HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn IsTokenRestricted(tokenhandle : super::Foundation::HANDLE) -> windows_sys::core::BOOL);
pub type IsValidAcl = unsafe extern "system" fn(pacl: *const ACL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn IsValidAcl(pacl : *const ACL) -> windows_sys::core::BOOL);
pub type IsValidSecurityDescriptor = unsafe extern "system" fn(psecuritydescriptor: PSECURITY_DESCRIPTOR) -> windows_sys::core::BOOL;
...
pub type IsValidSid = unsafe extern "system" fn(psid: PSID) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn IsValidSid(psid : PSID) -> windows_sys::core::BOOL);
pub type IsWellKnownSid = unsafe extern "system" fn(psid: PSID, wellknownsidtype: WELL_KNOWN_SID_TYPE) -> windows_sys::core::BOOL;
...
pub type LogonUserA = unsafe extern "system" fn(lpszusername: windows_sys::core::PCSTR, lpszdomain: windows_sys::core::PCSTR, lpszpassword: windows_sys::core::PCSTR, dwlogontype: LOGON32_LOGON, dwlogonprovider: LOGON32_PROVIDER, phtoken: *mut super::Foundation::HANDLE) -> windows_sys::core::BOOL;
...
pub type LogonUserExA = unsafe extern "system" fn(lpszusername: windows_sys::core::PCSTR, lpszdomain: windows_sys::core::PCSTR, lpszpassword: windows_sys::core::PCSTR, dwlogontype: LOGON32_LOGON, dwlogonprovider: LOGON32_PROVIDER, phtoken: *mut super::Foundation::HANDLE, pplogonsid: *mut PSID, ppprofilebuffer: *mut *mut core::ffi::c_void, pdwprofilelength: *mut u32, pquotalimits: *mut QUOTA_LIMITS) -> windows_sys::core::BOOL;
...
pub type LogonUserW = unsafe extern "system" fn(lpszusername: windows_sys::core::PCWSTR, lpszdomain: windows_sys::core::PCWSTR, lpszpassword: windows_sys::core::PCWSTR, dwlogontype: LOGON32_LOGON, dwlogonprovider: LOGON32_PROVIDER, phtoken: *mut super::Foundation::HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn LogonUserW(lpszusername : windows_sys::core::PCWSTR, lpszdomain : windows_sys::core::PCWSTR, lpszpassword : windows_sys::core::PCWSTR, dwlogontype : LOGON32_LOGON, dwlogonprovider : LOGON32_PROVIDER, phtoken : *mut super::Foundation::HANDLE) -> windows_sys::core::BOOL);
pub type LookupAccountNameA = unsafe extern "system" fn(lpsystemname: windows_sys::core::PCSTR, lpaccountname: windows_sys::core::PCSTR, sid: PSID, cbsid: *mut u32, referenceddomainname: windows_sys::core::PSTR, cchreferenceddomainname: *mut u32, peuse: *mut SID_NAME_USE) -> windows_sys::core::BOOL;
...
pub type LookupAccountNameW = unsafe extern "system" fn(lpsystemname: windows_sys::core::PCWSTR, lpaccountname: windows_sys::core::PCWSTR, sid: PSID, cbsid: *mut u32, referenceddomainname: windows_sys::core::PWSTR, cchreferenceddomainname: *mut u32, peuse: *mut SID_NAME_USE) -> windows_sys::core::BOOL;
...
pub type LookupAccountSidA = unsafe extern "system" fn(lpsystemname: windows_sys::core::PCSTR, sid: PSID, name: windows_sys::core::PSTR, cchname: *mut u32, referenceddomainname: windows_sys::core::PSTR, cchreferenceddomainname: *mut u32, peuse: *mut SID_NAME_USE) -> windows_sys::core::BOOL;
...
pub type LookupAccountSidW = unsafe extern "system" fn(lpsystemname: windows_sys::core::PCWSTR, sid: PSID, name: windows_sys::core::PWSTR, cchname: *mut u32, referenceddomainname: windows_sys::core::PWSTR, cchreferenceddomainname: *mut u32, peuse: *mut SID_NAME_USE) -> windows_sys::core::BOOL;
...
pub type LookupPrivilegeDisplayNameA = unsafe extern "system" fn(lpsystemname: windows_sys::core::PCSTR, lpname: windows_sys::core::PCSTR, lpdisplayname: windows_sys::core::PSTR, cchdisplayname: *mut u32, lplanguageid: *mut u32) -> windows_sys::core::BOOL;
...
pub type LookupPrivilegeDisplayNameW = unsafe extern "system" fn(lpsystemname: windows_sys::core::PCWSTR, lpname: windows_sys::core::PCWSTR, lpdisplayname: windows_sys::core::PWSTR, cchdisplayname: *mut u32, lplanguageid: *mut u32) -> windows_sys::core::BOOL;
...
pub type LookupPrivilegeNameA = unsafe extern "system" fn(lpsystemname: windows_sys::core::PCSTR, lpluid: *const super::Foundation::LUID, lpname: windows_sys::core::PSTR, cchname: *mut u32) -> windows_sys::core::BOOL;
...
pub type LookupPrivilegeNameW = unsafe extern "system" fn(lpsystemname: windows_sys::core::PCWSTR, lpluid: *const super::Foundation::LUID, lpname: windows_sys::core::PWSTR, cchname: *mut u32) -> windows_sys::core::BOOL;
...
pub type LookupPrivilegeValueA = unsafe extern "system" fn(lpsystemname: windows_sys::core::PCSTR, lpname: windows_sys::core::PCSTR, lpluid: *mut super::Foundation::LUID) -> windows_sys::core::BOOL;
...
pub type LookupPrivilegeValueW = unsafe extern "system" fn(lpsystemname: windows_sys::core::PCWSTR, lpname: windows_sys::core::PCWSTR, lpluid: *mut super::Foundation::LUID) -> windows_sys::core::BOOL;
...
pub type MakeAbsoluteSD = unsafe extern "system" fn(pselfrelativesecuritydescriptor: PSECURITY_DESCRIPTOR, pabsolutesecuritydescriptor: PSECURITY_DESCRIPTOR, lpdwabsolutesecuritydescriptorsize: *mut u32, pdacl: *mut ACL, lpdwdaclsize: *mut u32, psacl: *mut ACL, lpdwsaclsize: *mut u32, powner: PSID, lpdwownersize: *mut u32, pprimarygroup: PSID, lpdwprimarygroupsize: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn MakeAbsoluteSD(pselfrelativesecuritydescriptor : PSECURITY_DESCRIPTOR, pabsolutesecuritydescriptor : PSECURITY_DESCRIPTOR, lpdwabsolutesecuritydescriptorsize : *mut u32, pdacl : *mut ACL, lpdwdaclsize : *mut u32, psacl : *mut ACL, lpdwsaclsize : *mut u32, powner : PSID, lpdwownersize : *mut u32, pprimarygroup : PSID, lpdwprimarygroupsize : *mut u32) -> windows_sys::core::BOOL);
pub type MakeSelfRelativeSD = unsafe extern "system" fn(pabsolutesecuritydescriptor: PSECURITY_DESCRIPTOR, pselfrelativesecuritydescriptor: PSECURITY_DESCRIPTOR, lpdwbufferlength: *mut u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn MakeSelfRelativeSD(pabsolutesecuritydescriptor : PSECURITY_DESCRIPTOR, pselfrelativesecuritydescriptor : PSECURITY_DESCRIPTOR, lpdwbufferlength : *mut u32) -> windows_sys::core::BOOL);
pub type MapGenericMask = unsafe extern "system" fn(accessmask: *mut u32, genericmapping: *const GENERIC_MAPPING);
windows_link::link!("advapi32.dll" "system" fn MapGenericMask(accessmask : *mut u32, genericmapping : *const GENERIC_MAPPING));
pub type ObjectCloseAuditAlarmA = unsafe extern "system" fn(subsystemname: windows_sys::core::PCSTR, handleid: *const core::ffi::c_void, generateonclose: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type ObjectCloseAuditAlarmW = unsafe extern "system" fn(subsystemname: windows_sys::core::PCWSTR, handleid: *const core::ffi::c_void, generateonclose: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type ObjectDeleteAuditAlarmA = unsafe extern "system" fn(subsystemname: windows_sys::core::PCSTR, handleid: *const core::ffi::c_void, generateonclose: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type ObjectDeleteAuditAlarmW = unsafe extern "system" fn(subsystemname: windows_sys::core::PCWSTR, handleid: *const core::ffi::c_void, generateonclose: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type ObjectPrivilegeAuditAlarmA = unsafe extern "system" fn(subsystemname: windows_sys::core::PCSTR, handleid: *const core::ffi::c_void, clienttoken: super::Foundation::HANDLE, desiredaccess: u32, privileges: *const PRIVILEGE_SET, accessgranted: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn ObjectPrivilegeAuditAlarmA(subsystemname : windows_sys::core::PCSTR, handleid : *const core::ffi::c_void, clienttoken : super::Foundation::HANDLE, desiredaccess : u32, privileges : *const PRIVILEGE_SET, accessgranted : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type ObjectPrivilegeAuditAlarmW = unsafe extern "system" fn(subsystemname: windows_sys::core::PCWSTR, handleid: *const core::ffi::c_void, clienttoken: super::Foundation::HANDLE, desiredaccess: u32, privileges: *const PRIVILEGE_SET, accessgranted: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn ObjectPrivilegeAuditAlarmW(subsystemname : windows_sys::core::PCWSTR, handleid : *const core::ffi::c_void, clienttoken : super::Foundation::HANDLE, desiredaccess : u32, privileges : *const PRIVILEGE_SET, accessgranted : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type PrivilegeCheck = unsafe extern "system" fn(clienttoken: super::Foundation::HANDLE, requiredprivileges: *mut PRIVILEGE_SET, pfresult: *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn PrivilegeCheck(clienttoken : super::Foundation::HANDLE, requiredprivileges : *mut PRIVILEGE_SET, pfresult : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type PrivilegedServiceAuditAlarmA = unsafe extern "system" fn(subsystemname: windows_sys::core::PCSTR, servicename: windows_sys::core::PCSTR, clienttoken: super::Foundation::HANDLE, privileges: *const PRIVILEGE_SET, accessgranted: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn PrivilegedServiceAuditAlarmA(subsystemname : windows_sys::core::PCSTR, servicename : windows_sys::core::PCSTR, clienttoken : super::Foundation::HANDLE, privileges : *const PRIVILEGE_SET, accessgranted : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type PrivilegedServiceAuditAlarmW = unsafe extern "system" fn(subsystemname: windows_sys::core::PCWSTR, servicename: windows_sys::core::PCWSTR, clienttoken: super::Foundation::HANDLE, privileges: *const PRIVILEGE_SET, accessgranted: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn PrivilegedServiceAuditAlarmW(subsystemname : windows_sys::core::PCWSTR, servicename : windows_sys::core::PCWSTR, clienttoken : super::Foundation::HANDLE, privileges : *const PRIVILEGE_SET, accessgranted : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type QuerySecurityAccessMask = unsafe extern "system" fn(securityinformation: OBJECT_SECURITY_INFORMATION, desiredaccess: *mut u32);
windows_link::link!("advapi32.dll" "system" fn QuerySecurityAccessMask(securityinformation : OBJECT_SECURITY_INFORMATION, desiredaccess : *mut u32));
pub type RevertToSelf = unsafe extern "system" fn() -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn RevertToSelf() -> windows_sys::core::BOOL);
pub type RtlConvertSidToUnicodeString = unsafe extern "system" fn(unicodestring: *mut super::Foundation::UNICODE_STRING, sid: PSID, allocatedestinationstring: bool) -> super::Foundation::NTSTATUS;
windows_link::link!("ntdll.dll" "system" fn RtlConvertSidToUnicodeString(unicodestring : *mut super::Foundation::UNICODE_STRING, sid : PSID, allocatedestinationstring : bool) -> super::Foundation::NTSTATUS);
pub type RtlNormalizeSecurityDescriptor = unsafe extern "system" fn(securitydescriptor: *mut PSECURITY_DESCRIPTOR, securitydescriptorlength: u32, newsecuritydescriptor: *mut PSECURITY_DESCRIPTOR, newsecuritydescriptorlength: *mut u32, checkonly: bool) -> bool;
...
pub type SetAclInformation = unsafe extern "system" fn(pacl: *mut ACL, paclinformation: *const core::ffi::c_void, naclinformationlength: u32, dwaclinformationclass: ACL_INFORMATION_CLASS) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn SetAclInformation(pacl : *mut ACL, paclinformation : *const core::ffi::c_void, naclinformationlength : u32, dwaclinformationclass : ACL_INFORMATION_CLASS) -> windows_sys::core::BOOL);
pub type SetCachedSigningLevel = unsafe extern "system" fn(sourcefiles: *const super::Foundation::HANDLE, sourcefilecount: u32, flags: u32, targetfile: super::Foundation::HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("kernel32.dll" "system" fn SetCachedSigningLevel(sourcefiles : *const super::Foundation::HANDLE, sourcefilecount : u32, flags : u32, targetfile : super::Foundation::HANDLE) -> windows_sys::core::BOOL);
pub type SetFileSecurityA = unsafe extern "system" fn(lpfilename: windows_sys::core::PCSTR, securityinformation: OBJECT_SECURITY_INFORMATION, psecuritydescriptor: PSECURITY_DESCRIPTOR) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn SetFileSecurityA(lpfilename : windows_sys::core::PCSTR, securityinformation : OBJECT_SECURITY_INFORMATION, psecuritydescriptor : PSECURITY_DESCRIPTOR) -> windows_sys::core::BOOL);
pub type SetFileSecurityW = unsafe extern "system" fn(lpfilename: windows_sys::core::PCWSTR, securityinformation: OBJECT_SECURITY_INFORMATION, psecuritydescriptor: PSECURITY_DESCRIPTOR) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn SetFileSecurityW(lpfilename : windows_sys::core::PCWSTR, securityinformation : OBJECT_SECURITY_INFORMATION, psecuritydescriptor : PSECURITY_DESCRIPTOR) -> windows_sys::core::BOOL);
pub type SetKernelObjectSecurity = unsafe extern "system" fn(handle: super::Foundation::HANDLE, securityinformation: OBJECT_SECURITY_INFORMATION, securitydescriptor: PSECURITY_DESCRIPTOR) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn SetKernelObjectSecurity(handle : super::Foundation::HANDLE, securityinformation : OBJECT_SECURITY_INFORMATION, securitydescriptor : PSECURITY_DESCRIPTOR) -> windows_sys::core::BOOL);
pub type SetPrivateObjectSecurity = unsafe extern "system" fn(securityinformation: OBJECT_SECURITY_INFORMATION, modificationdescriptor: PSECURITY_DESCRIPTOR, objectssecuritydescriptor: *mut PSECURITY_DESCRIPTOR, genericmapping: *const GENERIC_MAPPING, token: super::Foundation::HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn SetPrivateObjectSecurity(securityinformation : OBJECT_SECURITY_INFORMATION, modificationdescriptor : PSECURITY_DESCRIPTOR, objectssecuritydescriptor : *mut PSECURITY_DESCRIPTOR, genericmapping : *const GENERIC_MAPPING, token : super::Foundation::HANDLE) -> windows_sys::core::BOOL);
pub type SetPrivateObjectSecurityEx = unsafe extern "system" fn(securityinformation: OBJECT_SECURITY_INFORMATION, modificationdescriptor: PSECURITY_DESCRIPTOR, objectssecuritydescriptor: *mut PSECURITY_DESCRIPTOR, autoinheritflags: SECURITY_AUTO_INHERIT_FLAGS, genericmapping: *const GENERIC_MAPPING, token: super::Foundation::HANDLE) -> windows_sys::core::BOOL;
...
pub type SetSecurityAccessMask = unsafe extern "system" fn(securityinformation: OBJECT_SECURITY_INFORMATION, desiredaccess: *mut u32);
windows_link::link!("advapi32.dll" "system" fn SetSecurityAccessMask(securityinformation : OBJECT_SECURITY_INFORMATION, desiredaccess : *mut u32));
pub type SetSecurityDescriptorControl = unsafe extern "system" fn(psecuritydescriptor: PSECURITY_DESCRIPTOR, controlbitsofinterest: SECURITY_DESCRIPTOR_CONTROL, controlbitstoset: SECURITY_DESCRIPTOR_CONTROL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn SetSecurityDescriptorControl(psecuritydescriptor : PSECURITY_DESCRIPTOR, controlbitsofinterest : SECURITY_DESCRIPTOR_CONTROL, controlbitstoset : SECURITY_DESCRIPTOR_CONTROL) -> windows_sys::core::BOOL);
pub type SetSecurityDescriptorDacl = unsafe extern "system" fn(psecuritydescriptor: PSECURITY_DESCRIPTOR, bdaclpresent: windows_sys::core::BOOL, pdacl: *const ACL, bdacldefaulted: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn SetSecurityDescriptorDacl(psecuritydescriptor : PSECURITY_DESCRIPTOR, bdaclpresent : windows_sys::core::BOOL, pdacl : *const ACL, bdacldefaulted : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type SetSecurityDescriptorGroup = unsafe extern "system" fn(psecuritydescriptor: PSECURITY_DESCRIPTOR, pgroup: PSID, bgroupdefaulted: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn SetSecurityDescriptorGroup(psecuritydescriptor : PSECURITY_DESCRIPTOR, pgroup : PSID, bgroupdefaulted : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type SetSecurityDescriptorOwner = unsafe extern "system" fn(psecuritydescriptor: PSECURITY_DESCRIPTOR, powner: PSID, bownerdefaulted: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn SetSecurityDescriptorOwner(psecuritydescriptor : PSECURITY_DESCRIPTOR, powner : PSID, bownerdefaulted : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type SetSecurityDescriptorRMControl = unsafe extern "system" fn(securitydescriptor: PSECURITY_DESCRIPTOR, rmcontrol: *const u8) -> u32;
windows_link::link!("advapi32.dll" "system" fn SetSecurityDescriptorRMControl(securitydescriptor : PSECURITY_DESCRIPTOR, rmcontrol : *const u8) -> u32);
pub type SetSecurityDescriptorSacl = unsafe extern "system" fn(psecuritydescriptor: PSECURITY_DESCRIPTOR, bsaclpresent: windows_sys::core::BOOL, psacl: *const ACL, bsacldefaulted: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn SetSecurityDescriptorSacl(psecuritydescriptor : PSECURITY_DESCRIPTOR, bsaclpresent : windows_sys::core::BOOL, psacl : *const ACL, bsacldefaulted : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
pub type SetTokenInformation = unsafe extern "system" fn(tokenhandle: super::Foundation::HANDLE, tokeninformationclass: TOKEN_INFORMATION_CLASS, tokeninformation: *const core::ffi::c_void, tokeninformationlength: u32) -> windows_sys::core::BOOL;
windows_link::link!("advapi32.dll" "system" fn SetTokenInformation(tokenhandle : super::Foundation::HANDLE, tokeninformationclass : TOKEN_INFORMATION_CLASS, tokeninformation : *const core::ffi::c_void, tokeninformationlength : u32) -> windows_sys::core::BOOL);
pub type SetUserObjectSecurity = unsafe extern "system" fn(hobj: super::Foundation::HANDLE, psirequested: *const OBJECT_SECURITY_INFORMATION, psid: PSECURITY_DESCRIPTOR) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn SetUserObjectSecurity(hobj : super::Foundation::HANDLE, psirequested : *const OBJECT_SECURITY_INFORMATION, psid : PSECURITY_DESCRIPTOR) -> windows_sys::core::BOOL);
#[repr(C)]
...
pub const WinBuiltinOpenSSHUsersSid: WELL_KNOWN_SID_TYPE = 121i32;
...
pub const WinBuiltinUserModeHardwareOperatorsSid: WELL_KNOWN_SID_TYPE = 120i32;
