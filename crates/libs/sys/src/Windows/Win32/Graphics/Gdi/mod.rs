...
windows_link::link!("gdi32.dll" "system" fn AddFontMemResourceEx(pfileview : *mut core::ffi::c_void, cjsize : u32, pvresrved : *mut core::ffi::c_void, pnumfonts : *mut u32) -> super::super::Foundation:: HANDLE);
windows_link::link!("gdi32.dll" "system" fn AddFontResourceA(param0 : windows_sys::core::PCSTR) -> i32);
windows_link::link!("gdi32.dll" "system" fn AddFontResourceExA(name : windows_sys::core::PCSTR, fl : FONT_RESOURCE_CHARACTERISTICS, res : *mut core::ffi::c_void) -> i32);
...
windows_link::link!("gdi32.dll" "system" fn AnimatePalette(hpal : HPALETTE, istartindex : u32, centries : u32, ppe : *mut PALETTEENTRY) -> windows_sys::core::BOOL);
...
windows_link::link!("user32.dll" "system" fn ChangeDisplaySettingsExW(lpszdevicename : windows_sys::core::PCWSTR, lpdevmode : *mut DEVMODEW, hwnd : super::super::Foundation:: HWND, dwflags : CDS_TYPE, lparam : *mut core::ffi::c_void) -> DISP_CHANGE);
...
windows_link::link!("gdi32.dll" "system" fn CombineTransform(lpxfout : *mut XFORM, lpxf1 : *mut XFORM, lpxf2 : *mut XFORM) -> windows_sys::core::BOOL);
...
windows_link::link!("user32.dll" "system" fn CopyRect(lprcdst : *mut super::super::Foundation:: RECT, lprcsrc : *mut super::super::Foundation:: RECT) -> windows_sys::core::BOOL);
...
windows_link::link!("gdi32.dll" "system" fn CreateBitmapIndirect(pbm : *mut BITMAP) -> HBITMAP);
windows_link::link!("gdi32.dll" "system" fn CreateBrushIndirect(plbrush : *mut LOGBRUSH) -> HBRUSH);
...
windows_link::link!("gdi32.dll" "system" fn CreateDCA(pwszdriver : windows_sys::core::PCSTR, pwszdevice : windows_sys::core::PCSTR, pszport : windows_sys::core::PCSTR, pdm : *mut DEVMODEA) -> HDC);
...
windows_link::link!("gdi32.dll" "system" fn CreateDIBSection(hdc : HDC, pbmi : *mut BITMAPINFO, usage : DIB_USAGE, ppvbits : *mut *mut core::ffi::c_void, hsection : super::super::Foundation:: HANDLE, offset : u32) -> HBITMAP);
windows_link::link!("gdi32.dll" "system" fn CreateDIBitmap(hdc : HDC, pbmih : *mut BITMAPINFOHEADER, flinit : u32, pjbits : *mut core::ffi::c_void, pbmi : *mut BITMAPINFO, iusage : DIB_USAGE) -> HBITMAP);
...
windows_link::link!("gdi32.dll" "system" fn CreateEnhMetaFileA(hdc : HDC, lpfilename : windows_sys::core::PCSTR, lprc : *mut super::super::Foundation:: RECT, lpdesc : windows_sys::core::PCSTR) -> HDC);
windows_link::link!("gdi32.dll" "system" fn CreateEnhMetaFileW(hdc : HDC, lpfilename : windows_sys::core::PCWSTR, lprc : *mut super::super::Foundation:: RECT, lpdesc : windows_sys::core::PCWSTR) -> HDC);
...
windows_link::link!("gdi32.dll" "system" fn CreateFontIndirectA(lplf : *mut LOGFONTA) -> HFONT);
windows_link::link!("gdi32.dll" "system" fn CreateFontIndirectExA(param0 : *mut ENUMLOGFONTEXDVA) -> HFONT);
windows_link::link!("gdi32.dll" "system" fn CreateFontIndirectExW(param0 : *const ENUMLOGFONTEXDVW) -> HFONT);
windows_link::link!("gdi32.dll" "system" fn CreateFontIndirectW(lplf : *mut LOGFONTW) -> HFONT);
...
windows_link::link!("gdi32.dll" "system" fn CreateICW(pszdriver : windows_sys::core::PCWSTR, pszdevice : windows_sys::core::PCWSTR, pszport : windows_sys::core::PCWSTR, pdm : *mut DEVMODEW) -> HDC);
...
windows_link::link!("gdi32.dll" "system" fn CreatePalette(plpal : *mut LOGPALETTE) -> HPALETTE);
...
windows_link::link!("gdi32.dll" "system" fn CreatePenIndirect(plpen : *mut LOGPEN) -> HPEN);
windows_link::link!("gdi32.dll" "system" fn CreatePolyPolygonRgn(pptl : *mut super::super::Foundation:: POINT, pc : *mut i32, cpoly : i32, imode : CREATE_POLYGON_RGN_MODE) -> HRGN);
windows_link::link!("gdi32.dll" "system" fn CreatePolygonRgn(pptl : *mut super::super::Foundation:: POINT, cpoint : i32, imode : CREATE_POLYGON_RGN_MODE) -> HRGN);
windows_link::link!("gdi32.dll" "system" fn CreateRectRgn(x1 : i32, y1 : i32, x2 : i32, y2 : i32) -> HRGN);
windows_link::link!("gdi32.dll" "system" fn CreateRectRgnIndirect(lprect : *mut super::super::Foundation:: RECT) -> HRGN);
...
windows_link::link!("user32.dll" "system" fn DrawAnimatedRects(hwnd : super::super::Foundation:: HWND, idani : i32, lprcfrom : *mut super::super::Foundation:: RECT, lprcto : *mut super::super::Foundation:: RECT) -> windows_sys::core::BOOL);
windows_link::link!("user32.dll" "system" fn DrawCaption(hwnd : super::super::Foundation:: HWND, hdc : HDC, lprect : *mut super::super::Foundation:: RECT, flags : DRAW_CAPTION_FLAGS) -> windows_sys::core::BOOL);
...
windows_link::link!("user32.dll" "system" fn DrawFocusRect(hdc : HDC, lprc : *mut super::super::Foundation:: RECT) -> windows_sys::core::BOOL);
...
windows_link::link!("user32.dll" "system" fn DrawTextExA(hdc : HDC, lpchtext : windows_sys::core::PCSTR, cchtext : i32, lprc : *mut super::super::Foundation:: RECT, format : DRAW_TEXT_FORMAT, lpdtp : *mut DRAWTEXTPARAMS) -> i32);
windows_link::link!("user32.dll" "system" fn DrawTextExW(hdc : HDC, lpchtext : windows_sys::core::PCWSTR, cchtext : i32, lprc : *mut super::super::Foundation:: RECT, format : DRAW_TEXT_FORMAT, lpdtp : *mut DRAWTEXTPARAMS) -> i32);
...
windows_link::link!("user32.dll" "system" fn EnumDisplayMonitors(hdc : HDC, lprcclip : *mut super::super::Foundation:: RECT, lpfnenum : MONITORENUMPROC, dwdata : super::super::Foundation:: LPARAM) -> windows_sys::core::BOOL);
...
windows_link::link!("gdi32.dll" "system" fn EnumEnhMetaFile(hdc : HDC, hmf : HENHMETAFILE, proc : ENHMFENUMPROC, param3 : *mut core::ffi::c_void, lprect : *mut super::super::Foundation:: RECT) -> windows_sys::core::BOOL);
...
windows_link::link!("user32.dll" "system" fn EqualRect(lprc1 : *mut super::super::Foundation:: RECT, lprc2 : *mut super::super::Foundation:: RECT) -> windows_sys::core::BOOL);
...
windows_link::link!("gdi32.dll" "system" fn ExtCreateRegion(lpx : *mut XFORM, ncount : u32, lpdata : *mut RGNDATA) -> HRGN);
...
windows_link::link!("gdi32.dll" "system" fn ExtTextOutW(hdc : HDC, x : i32, y : i32, options : ETO_OPTIONS, lprect : *mut super::super::Foundation:: RECT, lpstring : windows_sys::core::PCWSTR, c : u32, lpdx : *mut i32) -> windows_sys::core::BOOL);
windows_link::link!("gdi32.dll" "system" fn FillPath(hdc : HDC) -> windows_sys::core::BOOL);
windows_link::link!("user32.dll" "system" fn FillRect(hdc : HDC, lprc : *mut super::super::Foundation:: RECT, hbr : HBRUSH) -> i32);
windows_link::link!("gdi32.dll" "system" fn FillRgn(hdc : HDC, hrgn : HRGN, hbr : HBRUSH) -> windows_sys::core::BOOL);
windows_link::link!("gdi32.dll" "system" fn FixBrushOrgEx(hdc : HDC, x : i32, y : i32, ptl : *mut super::super::Foundation:: POINT) -> windows_sys::core::BOOL);
...
windows_link::link!("user32.dll" "system" fn FrameRect(hdc : HDC, lprc : *mut super::super::Foundation:: RECT, hbr : HBRUSH) -> i32);
...
windows_link::link!("gdi32.dll" "system" fn GdiComment(hdc : HDC, nsize : u32, lpdata : *mut u8) -> windows_sys::core::BOOL);
...
windows_link::link!("gdi32.dll" "system" fn GdiGradientFill(hdc : HDC, pvertex : *mut TRIVERTEX, nvertex : u32, pmesh : *mut core::ffi::c_void, ncount : u32, ulmode : GRADIENT_FILL) -> windows_sys::core::BOOL);
...
windows_link::link!("gdi32.dll" "system" fn GetCharABCWidthsI(hdc : HDC, gifirst : u32, cgi : u32, pgi : *mut u16, pabc : *mut ABC) -> windows_sys::core::BOOL);
...
windows_link::link!("gdi32.dll" "system" fn GetCharWidthI(hdc : HDC, gifirst : u32, cgi : u32, pgi : *mut u16, piwidths : *mut i32) -> windows_sys::core::BOOL);
...
windows_link::link!("gdi32.dll" "system" fn GetEnhMetaFileDescriptionA(hemf : HENHMETAFILE, cchbuffer : u32, lpdescription : windows_sys::core::PCSTR) -> u32);
windows_link::link!("gdi32.dll" "system" fn GetEnhMetaFileDescriptionW(hemf : HENHMETAFILE, cchbuffer : u32, lpdescription : windows_sys::core::PCWSTR) -> u32);
...
windows_link::link!("gdi32.dll" "system" fn GetGlyphOutlineA(hdc : HDC, uchar : u32, fuformat : GET_GLYPH_OUTLINE_FORMAT, lpgm : *mut GLYPHMETRICS, cjbuffer : u32, pvbuffer : *mut core::ffi::c_void, lpmat2 : *mut MAT2) -> u32);
...
windows_link::link!("user32.dll" "system" fn GetTabbedTextExtentA(hdc : HDC, lpstring : windows_sys::core::PCSTR, chcount : i32, ntabpositions : i32, lpntabstoppositions : *mut i32) -> u32);
windows_link::link!("user32.dll" "system" fn GetTabbedTextExtentW(hdc : HDC, lpstring : windows_sys::core::PCWSTR, chcount : i32, ntabpositions : i32, lpntabstoppositions : *mut i32) -> u32);
...
windows_link::link!("gdi32.dll" "system" fn GetTextExtentExPointI(hdc : HDC, lpwszstring : *mut u16, cwchstring : i32, nmaxextent : i32, lpnfit : *mut i32, lpndx : *mut i32, lpsize : *mut super::super::Foundation:: SIZE) -> windows_sys::core::BOOL);
...
windows_link::link!("gdi32.dll" "system" fn GetTextExtentPointI(hdc : HDC, pgiin : *mut u16, cgi : i32, psize : *mut super::super::Foundation:: SIZE) -> windows_sys::core::BOOL);
...
windows_link::link!("gdi32.dll" "system" fn GetTextFaceA(hdc : HDC, c : i32, lpname : windows_sys::core::PCSTR) -> i32);
...
windows_link::link!("msimg32.dll" "system" fn GradientFill(hdc : HDC, pvertex : *mut TRIVERTEX, nvertex : u32, pmesh : *mut core::ffi::c_void, nmesh : u32, ulmode : GRADIENT_FILL) -> windows_sys::core::BOOL);
...
windows_link::link!("user32.dll" "system" fn IntersectRect(lprcdst : *mut super::super::Foundation:: RECT, lprcsrc1 : *mut super::super::Foundation:: RECT, lprcsrc2 : *mut super::super::Foundation:: RECT) -> windows_sys::core::BOOL);
...
windows_link::link!("user32.dll" "system" fn InvertRect(hdc : HDC, lprc : *mut super::super::Foundation:: RECT) -> windows_sys::core::BOOL);
...
windows_link::link!("fontsub.dll" "C" fn MergeFontPackage(puchmergefontbuffer : *mut u8, ulmergefontbuffersize : u32, puchfontpackagebuffer : *mut u8, ulfontpackagebuffersize : u32, ppuchdestbuffer : *mut *mut u8, puldestbuffersize : *mut u32, pulbyteswritten : *mut u32, usmode : u16, lpfnallocate : CFP_ALLOCPROC, lpfnreallocate : CFP_REALLOCPROC, lpfnfree : CFP_FREEPROC, lpvreserved : *mut core::ffi::c_void) -> u32);
windows_link::link!("gdi32.dll" "system" fn ModifyWorldTransform(hdc : HDC, lpxf : *mut XFORM, mode : MODIFY_WORLD_TRANSFORM_MODE) -> windows_sys::core::BOOL);
...
windows_link::link!("user32.dll" "system" fn MonitorFromRect(lprc : *mut super::super::Foundation:: RECT, dwflags : MONITOR_FROM_FLAGS) -> HMONITOR);
...
windows_link::link!("gdi32.dll" "system" fn PlayEnhMetaFile(hdc : HDC, hmf : HENHMETAFILE, lprect : *mut super::super::Foundation:: RECT) -> windows_sys::core::BOOL);
windows_link::link!("gdi32.dll" "system" fn PlayEnhMetaFileRecord(hdc : HDC, pht : *mut HANDLETABLE, pmr : *mut ENHMETARECORD, cht : u32) -> windows_sys::core::BOOL);
windows_link::link!("gdi32.dll" "system" fn PlayMetaFile(hdc : HDC, hmf : HMETAFILE) -> windows_sys::core::BOOL);
windows_link::link!("gdi32.dll" "system" fn PlayMetaFileRecord(hdc : HDC, lphandletable : *mut HANDLETABLE, lpmr : *mut METARECORD, noobjs : u32) -> windows_sys::core::BOOL);
...
windows_link::link!("gdi32.dll" "system" fn PolyDraw(hdc : HDC, apt : *mut super::super::Foundation:: POINT, aj : *mut u8, cpt : i32) -> windows_sys::core::BOOL);
windows_link::link!("gdi32.dll" "system" fn PolyPolygon(hdc : HDC, apt : *mut super::super::Foundation:: POINT, asz : *mut i32, csz : i32) -> windows_sys::core::BOOL);
windows_link::link!("gdi32.dll" "system" fn PolyPolyline(hdc : HDC, apt : *mut super::super::Foundation:: POINT, asz : *mut u32, csz : u32) -> windows_sys::core::BOOL);
windows_link::link!("gdi32.dll" "system" fn PolyTextOutA(hdc : HDC, ppt : *mut POLYTEXTA, nstrings : i32) -> windows_sys::core::BOOL);
windows_link::link!("gdi32.dll" "system" fn PolyTextOutW(hdc : HDC, ppt : *mut POLYTEXTW, nstrings : i32) -> windows_sys::core::BOOL);
windows_link::link!("gdi32.dll" "system" fn Polygon(hdc : HDC, apt : *mut super::super::Foundation:: POINT, cpt : i32) -> windows_sys::core::BOOL);
windows_link::link!("gdi32.dll" "system" fn Polyline(hdc : HDC, apt : *mut super::super::Foundation:: POINT, cpt : i32) -> windows_sys::core::BOOL);
...
windows_link::link!("user32.dll" "system" fn PtInRect(lprc : *mut super::super::Foundation:: RECT, pt : super::super::Foundation:: POINT) -> windows_sys::core::BOOL);
...
windows_link::link!("gdi32.dll" "system" fn RectInRegion(hrgn : HRGN, lprect : *mut super::super::Foundation:: RECT) -> windows_sys::core::BOOL);
windows_link::link!("gdi32.dll" "system" fn RectVisible(hdc : HDC, lprect : *mut super::super::Foundation:: RECT) -> windows_sys::core::BOOL);
windows_link::link!("gdi32.dll" "system" fn Rectangle(hdc : HDC, left : i32, top : i32, right : i32, bottom : i32) -> windows_sys::core::BOOL);
windows_link::link!("user32.dll" "system" fn RedrawWindow(hwnd : super::super::Foundation:: HWND, lprcupdate : *mut super::super::Foundation:: RECT, hrgnupdate : HRGN, flags : REDRAW_WINDOW_FLAGS) -> windows_sys::core::BOOL);
...
windows_link::link!("gdi32.dll" "system" fn RemoveFontResourceExW(name : windows_sys::core::PCWSTR, fl : u32, pdv : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_link::link!("gdi32.dll" "system" fn RemoveFontResourceW(lpfilename : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
windows_link::link!("gdi32.dll" "system" fn ResetDCA(hdc : HDC, lpdm : *mut DEVMODEA) -> HDC);
windows_link::link!("gdi32.dll" "system" fn ResetDCW(hdc : HDC, lpdm : *mut DEVMODEW) -> HDC);
...
windows_link::link!("gdi32.dll" "system" fn SetBitmapBits(hbm : HBITMAP, cb : u32, pvbits : *mut core::ffi::c_void) -> i32);
...
windows_link::link!("gdi32.dll" "system" fn SetBoundsRect(hdc : HDC, lprect : *mut super::super::Foundation:: RECT, flags : SET_BOUNDS_RECT_FLAGS) -> u32);
...
windows_link::link!("gdi32.dll" "system" fn SetColorAdjustment(hdc : HDC, lpca : *mut COLORADJUSTMENT) -> windows_sys::core::BOOL);
...
windows_link::link!("gdi32.dll" "system" fn SetDIBColorTable(hdc : HDC, istart : u32, centries : u32, prgbq : *mut RGBQUAD) -> u32);
...
windows_link::link!("gdi32.dll" "system" fn SetDIBitsToDevice(hdc : HDC, xdest : i32, ydest : i32, w : u32, h : u32, xsrc : i32, ysrc : i32, startscan : u32, clines : u32, lpvbits : *mut core::ffi::c_void, lpbmi : *mut BITMAPINFO, coloruse : DIB_USAGE) -> i32);
...
windows_link::link!("gdi32.dll" "system" fn SetWorldTransform(hdc : HDC, lpxf : *mut XFORM) -> windows_sys::core::BOOL);
...
windows_link::link!("user32.dll" "system" fn SubtractRect(lprcdst : *mut super::super::Foundation:: RECT, lprcsrc1 : *mut super::super::Foundation:: RECT, lprcsrc2 : *mut super::super::Foundation:: RECT) -> windows_sys::core::BOOL);
windows_link::link!("t2embed.dll" "system" fn TTCharToUnicode(hdc : HDC, puccharcodes : *mut u8, ulcharcodesize : u32, pusshortcodes : *mut u16, ulshortcodesize : u32, ulflags : u32) -> i32);
...
windows_link::link!("t2embed.dll" "system" fn TTEmbedFontEx(hdc : HDC, ulflags : TTEMBED_FLAGS, ulcharset : EMBED_FONT_CHARSET, pulprivstatus : *mut EMBEDDED_FONT_PRIV_STATUS, pulstatus : *mut u32, lpfnwritetostream : WRITEEMBEDPROC, lpvwritestream : *mut core::ffi::c_void, pulcharcodeset : *mut u32, uscharcodecount : u16, uslanguage : u16, pttembedinfo : *mut TTEMBEDINFO) -> i32);
...
windows_link::link!("t2embed.dll" "system" fn TTGetEmbeddedFontInfo(ulflags : TTEMBED_FLAGS, pulprivstatus : *mut u32, ulprivs : FONT_LICENSE_PRIVS, pulstatus : *mut u32, lpfnreadfromstream : READEMBEDPROC, lpvreadstream : *mut core::ffi::c_void, pttloadinfo : *mut TTLOADINFO) -> i32);
windows_link::link!("t2embed.dll" "system" fn TTGetEmbeddingType(hdc : HDC, pulembedtype : *mut EMBEDDED_FONT_PRIV_STATUS) -> i32);
windows_link::link!("t2embed.dll" "system" fn TTGetNewFontName(phfontreference : *mut super::super::Foundation:: HANDLE, wzwinfamilyname : windows_sys::core::PCWSTR, cchmaxwinname : i32, szmacfamilyname : windows_sys::core::PCSTR, cchmaxmacname : i32) -> i32);
...
windows_link::link!("t2embed.dll" "system" fn TTRunValidationTestsEx(hdc : HDC, ptestparam : *mut TTVALIDATIONTESTSPARAMSEX) -> i32);
...
windows_link::link!("user32.dll" "system" fn TabbedTextOutW(hdc : HDC, x : i32, y : i32, lpstring : windows_sys::core::PCWSTR, chcount : i32, ntabpositions : i32, lpntabstoppositions : *mut i32, ntaborigin : i32) -> i32);
...
windows_link::link!("user32.dll" "system" fn UnionRect(lprcdst : *mut super::super::Foundation:: RECT, lprcsrc1 : *mut super::super::Foundation:: RECT, lprcsrc2 : *mut super::super::Foundation:: RECT) -> windows_sys::core::BOOL);
...
windows_link::link!("opengl32.dll" "system" fn wglSwapMultipleBuffers(param0 : u32, param1 : *mut WGLSWAP) -> u32);
#[repr(C)]
...
pub type FONTENUMPROCA = Option<unsafe extern "system" fn(param0: *mut LOGFONTA, param1: *mut TEXTMETRICA, param2: u32, param3: super::super::Foundation::LPARAM) -> i32>;
...
pub type MFENUMPROC = Option<unsafe extern "system" fn(hdc: HDC, lpht: *mut HANDLETABLE, lpmr: *mut METARECORD, nobj: i32, param4: super::super::Foundation::LPARAM) -> i32>;
...
pub type WRITEEMBEDPROC = Option<unsafe extern "C" fn(param0: *mut core::ffi::c_void, param1: *mut core::ffi::c_void, param2: u32) -> u32>;
#[repr(C)]
#[derive(Clone, Copy, Default)]
pub struct XFORM {
    pub eM11: f32,
