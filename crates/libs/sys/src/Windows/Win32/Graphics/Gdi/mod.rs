pub type AbortPath = unsafe extern "system" fn(hdc: HDC) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn AbortPath(hdc : HDC) -> windows_sys::core::BOOL);
pub type AddFontMemResourceEx = unsafe extern "system" fn(pfileview: *const core::ffi::c_void, cjsize: u32, pvresrved: *const core::ffi::c_void, pnumfonts: *const u32) -> super::super::Foundation::HANDLE;
...
pub type AddFontResourceA = unsafe extern "system" fn(param0: windows_sys::core::PCSTR) -> i32;
windows_link::link!("gdi32.dll" "system" fn AddFontResourceA(param0 : windows_sys::core::PCSTR) -> i32);
pub type AddFontResourceExA = unsafe extern "system" fn(name: windows_sys::core::PCSTR, fl: FONT_RESOURCE_CHARACTERISTICS, res: *const core::ffi::c_void) -> i32;
...
pub type AddFontResourceExW = unsafe extern "system" fn(name: windows_sys::core::PCWSTR, fl: FONT_RESOURCE_CHARACTERISTICS, res: *const core::ffi::c_void) -> i32;
...
pub type AddFontResourceW = unsafe extern "system" fn(param0: windows_sys::core::PCWSTR) -> i32;
windows_link::link!("gdi32.dll" "system" fn AddFontResourceW(param0 : windows_sys::core::PCWSTR) -> i32);
pub type AlphaBlend = unsafe extern "system" fn(hdcdest: HDC, xorigindest: i32, yorigindest: i32, wdest: i32, hdest: i32, hdcsrc: HDC, xoriginsrc: i32, yoriginsrc: i32, wsrc: i32, hsrc: i32, ftn: BLENDFUNCTION) -> windows_sys::core::BOOL;
...
pub type AngleArc = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, r: u32, startangle: f32, sweepangle: f32) -> windows_sys::core::BOOL;
...
pub type AnimatePalette = unsafe extern "system" fn(hpal: HPALETTE, istartindex: u32, centries: u32, ppe: *const PALETTEENTRY) -> windows_sys::core::BOOL;
...
pub type Arc = unsafe extern "system" fn(hdc: HDC, x1: i32, y1: i32, x2: i32, y2: i32, x3: i32, y3: i32, x4: i32, y4: i32) -> windows_sys::core::BOOL;
...
pub type ArcTo = unsafe extern "system" fn(hdc: HDC, left: i32, top: i32, right: i32, bottom: i32, xr1: i32, yr1: i32, xr2: i32, yr2: i32) -> windows_sys::core::BOOL;
...
pub type BeginPath = unsafe extern "system" fn(hdc: HDC) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn BeginPath(hdc : HDC) -> windows_sys::core::BOOL);
pub type BitBlt = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, cx: i32, cy: i32, hdcsrc: HDC, x1: i32, y1: i32, rop: ROP_CODE) -> windows_sys::core::BOOL;
...
pub type CancelDC = unsafe extern "system" fn(hdc: HDC) -> windows_sys::core::BOOL;
...
pub type ChangeDisplaySettingsExA = unsafe extern "system" fn(lpszdevicename: windows_sys::core::PCSTR, lpdevmode: *const DEVMODEA, hwnd: super::super::Foundation::HWND, dwflags: CDS_TYPE, lparam: *const core::ffi::c_void) -> DISP_CHANGE;
...
pub type ChangeDisplaySettingsExW = unsafe extern "system" fn(lpszdevicename: windows_sys::core::PCWSTR, lpdevmode: *const DEVMODEW, hwnd: super::super::Foundation::HWND, dwflags: CDS_TYPE, lparam: *const core::ffi::c_void) -> DISP_CHANGE;
...
pub type Chord = unsafe extern "system" fn(hdc: HDC, x1: i32, y1: i32, x2: i32, y2: i32, x3: i32, y3: i32, x4: i32, y4: i32) -> windows_sys::core::BOOL;
...
pub type ClientToScreen = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lppoint: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
...
pub type CloseFigure = unsafe extern "system" fn(hdc: HDC) -> windows_sys::core::BOOL;
...
pub type CombineRgn = unsafe extern "system" fn(hrgndst: HRGN, hrgnsrc1: HRGN, hrgnsrc2: HRGN, imode: RGN_COMBINE_MODE) -> GDI_REGION_TYPE;
...
pub type CombineTransform = unsafe extern "system" fn(lpxfout: *mut XFORM, lpxf1: *const XFORM, lpxf2: *const XFORM) -> windows_sys::core::BOOL;
...
pub type CopyEnhMetaFileA = unsafe extern "system" fn(henh: HENHMETAFILE, lpfilename: windows_sys::core::PCSTR) -> HENHMETAFILE;
windows_link::link!("gdi32.dll" "system" fn CopyEnhMetaFileA(henh : HENHMETAFILE, lpfilename : windows_sys::core::PCSTR) -> HENHMETAFILE);
pub type CopyEnhMetaFileW = unsafe extern "system" fn(henh: HENHMETAFILE, lpfilename: windows_sys::core::PCWSTR) -> HENHMETAFILE;
windows_link::link!("gdi32.dll" "system" fn CopyEnhMetaFileW(henh : HENHMETAFILE, lpfilename : windows_sys::core::PCWSTR) -> HENHMETAFILE);
pub type CopyMetaFileA = unsafe extern "system" fn(param0: HMETAFILE, param1: windows_sys::core::PCSTR) -> HMETAFILE;
windows_link::link!("gdi32.dll" "system" fn CopyMetaFileA(param0 : HMETAFILE, param1 : windows_sys::core::PCSTR) -> HMETAFILE);
pub type CopyMetaFileW = unsafe extern "system" fn(param0: HMETAFILE, param1: windows_sys::core::PCWSTR) -> HMETAFILE;
windows_link::link!("gdi32.dll" "system" fn CopyMetaFileW(param0 : HMETAFILE, param1 : windows_sys::core::PCWSTR) -> HMETAFILE);
pub type CopyRect = unsafe extern "system" fn(lprcdst: *mut super::super::Foundation::RECT, lprcsrc: *const super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
pub type CreateCompatibleDC = unsafe extern "system" fn(hdc: HDC) -> HDC;
windows_link::link!("gdi32.dll" "system" fn CreateCompatibleDC(hdc : HDC) -> HDC);
pub type CreateDCA = unsafe extern "system" fn(pwszdriver: windows_sys::core::PCSTR, pwszdevice: windows_sys::core::PCSTR, pszport: windows_sys::core::PCSTR, pdm: *const DEVMODEA) -> HDC;
...
pub type CreateDCW = unsafe extern "system" fn(pwszdriver: windows_sys::core::PCWSTR, pwszdevice: windows_sys::core::PCWSTR, pszport: windows_sys::core::PCWSTR, pdm: *const DEVMODEW) -> HDC;
...
pub type CreateDIBPatternBrush = unsafe extern "system" fn(h: super::super::Foundation::HGLOBAL, iusage: DIB_USAGE) -> HBRUSH;
...
pub type CreateEnhMetaFileA = unsafe extern "system" fn(hdc: HDC, lpfilename: windows_sys::core::PCSTR, lprc: *const super::super::Foundation::RECT, lpdesc: windows_sys::core::PCSTR) -> HDC;
...
pub type CreateEnhMetaFileW = unsafe extern "system" fn(hdc: HDC, lpfilename: windows_sys::core::PCWSTR, lprc: *const super::super::Foundation::RECT, lpdesc: windows_sys::core::PCWSTR) -> HDC;
...
pub type CreateFontA = unsafe extern "system" fn(cheight: i32, cwidth: i32, cescapement: i32, corientation: i32, cweight: i32, bitalic: u32, bunderline: u32, bstrikeout: u32, icharset: u32, ioutprecision: u32, iclipprecision: u32, iquality: u32, ipitchandfamily: u32, pszfacename: windows_sys::core::PCSTR) -> HFONT;
...
pub type CreateFontW = unsafe extern "system" fn(cheight: i32, cwidth: i32, cescapement: i32, corientation: i32, cweight: i32, bitalic: u32, bunderline: u32, bstrikeout: u32, icharset: u32, ioutprecision: u32, iclipprecision: u32, iquality: u32, ipitchandfamily: u32, pszfacename: windows_sys::core::PCWSTR) -> HFONT;
...
pub type CreateHatchBrush = unsafe extern "system" fn(ihatch: HATCH_BRUSH_STYLE, color: super::super::Foundation::COLORREF) -> HBRUSH;
...
pub type CreateICA = unsafe extern "system" fn(pszdriver: windows_sys::core::PCSTR, pszdevice: windows_sys::core::PCSTR, pszport: windows_sys::core::PCSTR, pdm: *const DEVMODEA) -> HDC;
...
pub type CreateICW = unsafe extern "system" fn(pszdriver: windows_sys::core::PCWSTR, pszdevice: windows_sys::core::PCWSTR, pszport: windows_sys::core::PCWSTR, pdm: *const DEVMODEW) -> HDC;
...
pub type CreateMetaFileA = unsafe extern "system" fn(pszfile: windows_sys::core::PCSTR) -> HDC;
windows_link::link!("gdi32.dll" "system" fn CreateMetaFileA(pszfile : windows_sys::core::PCSTR) -> HDC);
pub type CreateMetaFileW = unsafe extern "system" fn(pszfile: windows_sys::core::PCWSTR) -> HDC;
...
pub type CreatePen = unsafe extern "system" fn(istyle: PEN_STYLE, cwidth: i32, color: super::super::Foundation::COLORREF) -> HPEN;
...
pub type CreateScalableFontResourceA = unsafe extern "system" fn(fdwhidden: u32, lpszfont: windows_sys::core::PCSTR, lpszfile: windows_sys::core::PCSTR, lpszpath: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type CreateScalableFontResourceW = unsafe extern "system" fn(fdwhidden: u32, lpszfont: windows_sys::core::PCWSTR, lpszfile: windows_sys::core::PCWSTR, lpszpath: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type CreateSolidBrush = unsafe extern "system" fn(color: super::super::Foundation::COLORREF) -> HBRUSH;
windows_link::link!("gdi32.dll" "system" fn CreateSolidBrush(color : super::super::Foundation::COLORREF) -> HBRUSH);
pub type DPtoLP = unsafe extern "system" fn(hdc: HDC, lppt: *mut super::super::Foundation::POINT, c: i32) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn DPtoLP(hdc : HDC, lppt : *mut super::super::Foundation::POINT, c : i32) -> windows_sys::core::BOOL);
pub type DeleteDC = unsafe extern "system" fn(hdc: HDC) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn DeleteDC(hdc : HDC) -> windows_sys::core::BOOL);
pub type DeleteEnhMetaFile = unsafe extern "system" fn(hmf: HENHMETAFILE) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn DeleteEnhMetaFile(hmf : HENHMETAFILE) -> windows_sys::core::BOOL);
pub type DeleteMetaFile = unsafe extern "system" fn(hmf: HMETAFILE) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn DeleteMetaFile(hmf : HMETAFILE) -> windows_sys::core::BOOL);
pub type DeleteObject = unsafe extern "system" fn(ho: HGDIOBJ) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn DeleteObject(ho : HGDIOBJ) -> windows_sys::core::BOOL);
pub type DrawAnimatedRects = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, idani: i32, lprcfrom: *const super::super::Foundation::RECT, lprcto: *const super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
pub type DrawCaption = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hdc: HDC, lprect: *const super::super::Foundation::RECT, flags: DRAW_CAPTION_FLAGS) -> windows_sys::core::BOOL;
...
pub type DrawEdge = unsafe extern "system" fn(hdc: HDC, qrc: *mut super::super::Foundation::RECT, edge: DRAWEDGE_FLAGS, grfflags: DRAW_EDGE_FLAGS) -> windows_sys::core::BOOL;
...
pub type DrawEscape = unsafe extern "system" fn(hdc: HDC, iescape: i32, cjin: i32, lpin: windows_sys::core::PCSTR) -> i32;
windows_link::link!("gdi32.dll" "system" fn DrawEscape(hdc : HDC, iescape : i32, cjin : i32, lpin : windows_sys::core::PCSTR) -> i32);
pub type DrawFocusRect = unsafe extern "system" fn(hdc: HDC, lprc: *const super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
pub type DrawFrameControl = unsafe extern "system" fn(hdc: HDC, lprc: *mut super::super::Foundation::RECT, utype: u32, ustate: u32) -> windows_sys::core::BOOL;
...
pub type DrawStateA = unsafe extern "system" fn(hdc: HDC, hbrfore: HBRUSH, qfncallback: DRAWSTATEPROC, ldata: super::super::Foundation::LPARAM, wdata: super::super::Foundation::WPARAM, x: i32, y: i32, cx: i32, cy: i32, uflags: DRAWSTATE_FLAGS) -> windows_sys::core::BOOL;
...
pub type DrawStateW = unsafe extern "system" fn(hdc: HDC, hbrfore: HBRUSH, qfncallback: DRAWSTATEPROC, ldata: super::super::Foundation::LPARAM, wdata: super::super::Foundation::WPARAM, x: i32, y: i32, cx: i32, cy: i32, uflags: DRAWSTATE_FLAGS) -> windows_sys::core::BOOL;
...
pub type DrawTextA = unsafe extern "system" fn(hdc: HDC, lpchtext: windows_sys::core::PCSTR, cchtext: i32, lprc: *mut super::super::Foundation::RECT, format: DRAW_TEXT_FORMAT) -> i32;
...
pub type DrawTextExA = unsafe extern "system" fn(hdc: HDC, lpchtext: windows_sys::core::PSTR, cchtext: i32, lprc: *mut super::super::Foundation::RECT, format: DRAW_TEXT_FORMAT, lpdtp: *const DRAWTEXTPARAMS) -> i32;
...
pub type DrawTextExW = unsafe extern "system" fn(hdc: HDC, lpchtext: windows_sys::core::PWSTR, cchtext: i32, lprc: *mut super::super::Foundation::RECT, format: DRAW_TEXT_FORMAT, lpdtp: *const DRAWTEXTPARAMS) -> i32;
...
pub type DrawTextW = unsafe extern "system" fn(hdc: HDC, lpchtext: windows_sys::core::PCWSTR, cchtext: i32, lprc: *mut super::super::Foundation::RECT, format: DRAW_TEXT_FORMAT) -> i32;
...
pub type Ellipse = unsafe extern "system" fn(hdc: HDC, left: i32, top: i32, right: i32, bottom: i32) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn Ellipse(hdc : HDC, left : i32, top : i32, right : i32, bottom : i32) -> windows_sys::core::BOOL);
pub type EndPaint = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lppaint: *const PAINTSTRUCT) -> windows_sys::core::BOOL;
...
pub type EndPath = unsafe extern "system" fn(hdc: HDC) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn EndPath(hdc : HDC) -> windows_sys::core::BOOL);
pub type EnumDisplayDevicesA = unsafe extern "system" fn(lpdevice: windows_sys::core::PCSTR, idevnum: u32, lpdisplaydevice: *mut DISPLAY_DEVICEA, dwflags: u32) -> windows_sys::core::BOOL;
...
pub type EnumDisplayDevicesW = unsafe extern "system" fn(lpdevice: windows_sys::core::PCWSTR, idevnum: u32, lpdisplaydevice: *mut DISPLAY_DEVICEW, dwflags: u32) -> windows_sys::core::BOOL;
...
pub type EnumDisplayMonitors = unsafe extern "system" fn(hdc: HDC, lprcclip: *const super::super::Foundation::RECT, lpfnenum: MONITORENUMPROC, dwdata: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
pub type EnumDisplaySettingsA = unsafe extern "system" fn(lpszdevicename: windows_sys::core::PCSTR, imodenum: ENUM_DISPLAY_SETTINGS_MODE, lpdevmode: *mut DEVMODEA) -> windows_sys::core::BOOL;
...
pub type EnumDisplaySettingsExA = unsafe extern "system" fn(lpszdevicename: windows_sys::core::PCSTR, imodenum: ENUM_DISPLAY_SETTINGS_MODE, lpdevmode: *mut DEVMODEA, dwflags: ENUM_DISPLAY_SETTINGS_FLAGS) -> windows_sys::core::BOOL;
...
pub type EnumDisplaySettingsExW = unsafe extern "system" fn(lpszdevicename: windows_sys::core::PCWSTR, imodenum: ENUM_DISPLAY_SETTINGS_MODE, lpdevmode: *mut DEVMODEW, dwflags: ENUM_DISPLAY_SETTINGS_FLAGS) -> windows_sys::core::BOOL;
...
pub type EnumDisplaySettingsW = unsafe extern "system" fn(lpszdevicename: windows_sys::core::PCWSTR, imodenum: ENUM_DISPLAY_SETTINGS_MODE, lpdevmode: *mut DEVMODEW) -> windows_sys::core::BOOL;
...
pub type EnumEnhMetaFile = unsafe extern "system" fn(hdc: HDC, hmf: HENHMETAFILE, proc: ENHMFENUMPROC, param3: *const core::ffi::c_void, lprect: *const super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
pub type EnumFontFamiliesA = unsafe extern "system" fn(hdc: HDC, lplogfont: windows_sys::core::PCSTR, lpproc: FONTENUMPROCA, lparam: super::super::Foundation::LPARAM) -> i32;
...
pub type EnumFontFamiliesW = unsafe extern "system" fn(hdc: HDC, lplogfont: windows_sys::core::PCWSTR, lpproc: FONTENUMPROCW, lparam: super::super::Foundation::LPARAM) -> i32;
...
pub type EnumFontsA = unsafe extern "system" fn(hdc: HDC, lplogfont: windows_sys::core::PCSTR, lpproc: FONTENUMPROCA, lparam: super::super::Foundation::LPARAM) -> i32;
...
pub type EnumFontsW = unsafe extern "system" fn(hdc: HDC, lplogfont: windows_sys::core::PCWSTR, lpproc: FONTENUMPROCW, lparam: super::super::Foundation::LPARAM) -> i32;
...
pub type EnumMetaFile = unsafe extern "system" fn(hdc: HDC, hmf: HMETAFILE, proc: MFENUMPROC, param3: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
pub type EqualRect = unsafe extern "system" fn(lprc1: *const super::super::Foundation::RECT, lprc2: *const super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
pub type EqualRgn = unsafe extern "system" fn(hrgn1: HRGN, hrgn2: HRGN) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn EqualRgn(hrgn1 : HRGN, hrgn2 : HRGN) -> windows_sys::core::BOOL);
pub type ExcludeClipRect = unsafe extern "system" fn(hdc: HDC, left: i32, top: i32, right: i32, bottom: i32) -> GDI_REGION_TYPE;
...
pub type ExtCreatePen = unsafe extern "system" fn(ipenstyle: u32, cwidth: u32, plbrush: *const LOGBRUSH, cstyle: u32, pstyle: *const u32) -> HPEN;
...
pub type ExtFloodFill = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, color: super::super::Foundation::COLORREF, r#type: EXT_FLOOD_FILL_TYPE) -> windows_sys::core::BOOL;
...
pub type ExtSelectClipRgn = unsafe extern "system" fn(hdc: HDC, hrgn: HRGN, mode: RGN_COMBINE_MODE) -> GDI_REGION_TYPE;
windows_link::link!("gdi32.dll" "system" fn ExtSelectClipRgn(hdc : HDC, hrgn : HRGN, mode : RGN_COMBINE_MODE) -> GDI_REGION_TYPE);
pub type ExtTextOutA = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, options: ETO_OPTIONS, lprect: *const super::super::Foundation::RECT, lpstring: windows_sys::core::PCSTR, c: u32, lpdx: *const i32) -> windows_sys::core::BOOL;
...
pub type ExtTextOutW = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, options: ETO_OPTIONS, lprect: *const super::super::Foundation::RECT, lpstring: windows_sys::core::PCWSTR, c: u32, lpdx: *const i32) -> windows_sys::core::BOOL;
...
pub type FillPath = unsafe extern "system" fn(hdc: HDC) -> windows_sys::core::BOOL;
...
pub type FillRgn = unsafe extern "system" fn(hdc: HDC, hrgn: HRGN, hbr: HBRUSH) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn FillRgn(hdc : HDC, hrgn : HRGN, hbr : HBRUSH) -> windows_sys::core::BOOL);
pub type FixBrushOrgEx = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, ptl: *const super::super::Foundation::POINT) -> windows_sys::core::BOOL;
...
pub type FlattenPath = unsafe extern "system" fn(hdc: HDC) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn FlattenPath(hdc : HDC) -> windows_sys::core::BOOL);
pub type FloodFill = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, color: super::super::Foundation::COLORREF) -> windows_sys::core::BOOL;
...
pub type FrameRgn = unsafe extern "system" fn(hdc: HDC, hrgn: HRGN, hbr: HBRUSH, w: i32, h: i32) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn FrameRgn(hdc : HDC, hrgn : HRGN, hbr : HBRUSH, w : i32, h : i32) -> windows_sys::core::BOOL);
pub type GdiAlphaBlend = unsafe extern "system" fn(hdcdest: HDC, xorigindest: i32, yorigindest: i32, wdest: i32, hdest: i32, hdcsrc: HDC, xoriginsrc: i32, yoriginsrc: i32, wsrc: i32, hsrc: i32, ftn: BLENDFUNCTION) -> windows_sys::core::BOOL;
...
pub type GdiComment = unsafe extern "system" fn(hdc: HDC, nsize: u32, lpdata: *const u8) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn GdiComment(hdc : HDC, nsize : u32, lpdata : *const u8) -> windows_sys::core::BOOL);
pub type GdiFlush = unsafe extern "system" fn() -> windows_sys::core::BOOL;
...
pub type GdiGradientFill = unsafe extern "system" fn(hdc: HDC, pvertex: *const TRIVERTEX, nvertex: u32, pmesh: *const core::ffi::c_void, ncount: u32, ulmode: GRADIENT_FILL) -> windows_sys::core::BOOL;
...
pub type GdiTransparentBlt = unsafe extern "system" fn(hdcdest: HDC, xorigindest: i32, yorigindest: i32, wdest: i32, hdest: i32, hdcsrc: HDC, xoriginsrc: i32, yoriginsrc: i32, wsrc: i32, hsrc: i32, crtransparent: u32) -> windows_sys::core::BOOL;
...
pub type GetAspectRatioFilterEx = unsafe extern "system" fn(hdc: HDC, lpsize: *mut super::super::Foundation::SIZE) -> windows_sys::core::BOOL;
...
pub type GetBitmapDimensionEx = unsafe extern "system" fn(hbit: HBITMAP, lpsize: *mut super::super::Foundation::SIZE) -> windows_sys::core::BOOL;
...
pub type GetBkColor = unsafe extern "system" fn(hdc: HDC) -> super::super::Foundation::COLORREF;
...
pub type GetBrushOrgEx = unsafe extern "system" fn(hdc: HDC, lppt: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn GetBrushOrgEx(hdc : HDC, lppt : *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL);
pub type GetCharABCWidthsA = unsafe extern "system" fn(hdc: HDC, wfirst: u32, wlast: u32, lpabc: *mut ABC) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn GetCharABCWidthsA(hdc : HDC, wfirst : u32, wlast : u32, lpabc : *mut ABC) -> windows_sys::core::BOOL);
pub type GetCharABCWidthsFloatA = unsafe extern "system" fn(hdc: HDC, ifirst: u32, ilast: u32, lpabc: *mut ABCFLOAT) -> windows_sys::core::BOOL;
...
pub type GetCharABCWidthsFloatW = unsafe extern "system" fn(hdc: HDC, ifirst: u32, ilast: u32, lpabc: *mut ABCFLOAT) -> windows_sys::core::BOOL;
...
pub type GetCharABCWidthsI = unsafe extern "system" fn(hdc: HDC, gifirst: u32, cgi: u32, pgi: *const u16, pabc: *mut ABC) -> windows_sys::core::BOOL;
...
pub type GetCharABCWidthsW = unsafe extern "system" fn(hdc: HDC, wfirst: u32, wlast: u32, lpabc: *mut ABC) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn GetCharABCWidthsW(hdc : HDC, wfirst : u32, wlast : u32, lpabc : *mut ABC) -> windows_sys::core::BOOL);
pub type GetCharWidth32A = unsafe extern "system" fn(hdc: HDC, ifirst: u32, ilast: u32, lpbuffer: *mut i32) -> windows_sys::core::BOOL;
...
pub type GetCharWidth32W = unsafe extern "system" fn(hdc: HDC, ifirst: u32, ilast: u32, lpbuffer: *mut i32) -> windows_sys::core::BOOL;
...
pub type GetCharWidthA = unsafe extern "system" fn(hdc: HDC, ifirst: u32, ilast: u32, lpbuffer: *mut i32) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn GetCharWidthA(hdc : HDC, ifirst : u32, ilast : u32, lpbuffer : *mut i32) -> windows_sys::core::BOOL);
pub type GetCharWidthFloatA = unsafe extern "system" fn(hdc: HDC, ifirst: u32, ilast: u32, lpbuffer: *mut f32) -> windows_sys::core::BOOL;
...
pub type GetCharWidthFloatW = unsafe extern "system" fn(hdc: HDC, ifirst: u32, ilast: u32, lpbuffer: *mut f32) -> windows_sys::core::BOOL;
...
pub type GetCharWidthI = unsafe extern "system" fn(hdc: HDC, gifirst: u32, cgi: u32, pgi: *const u16, piwidths: *mut i32) -> windows_sys::core::BOOL;
...
pub type GetCharWidthW = unsafe extern "system" fn(hdc: HDC, ifirst: u32, ilast: u32, lpbuffer: *mut i32) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn GetCharWidthW(hdc : HDC, ifirst : u32, ilast : u32, lpbuffer : *mut i32) -> windows_sys::core::BOOL);
pub type GetCharacterPlacementA = unsafe extern "system" fn(hdc: HDC, lpstring: windows_sys::core::PCSTR, ncount: i32, nmexextent: i32, lpresults: *mut GCP_RESULTSA, dwflags: GET_CHARACTER_PLACEMENT_FLAGS) -> u32;
...
pub type GetCharacterPlacementW = unsafe extern "system" fn(hdc: HDC, lpstring: windows_sys::core::PCWSTR, ncount: i32, nmexextent: i32, lpresults: *mut GCP_RESULTSW, dwflags: GET_CHARACTER_PLACEMENT_FLAGS) -> u32;
...
pub type GetClipBox = unsafe extern "system" fn(hdc: HDC, lprect: *mut super::super::Foundation::RECT) -> GDI_REGION_TYPE;
...
pub type GetColorAdjustment = unsafe extern "system" fn(hdc: HDC, lpca: *mut COLORADJUSTMENT) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn GetColorAdjustment(hdc : HDC, lpca : *mut COLORADJUSTMENT) -> windows_sys::core::BOOL);
pub type GetCurrentObject = unsafe extern "system" fn(hdc: HDC, r#type: u32) -> HGDIOBJ;
windows_link::link!("gdi32.dll" "system" fn GetCurrentObject(hdc : HDC, r#type : u32) -> HGDIOBJ);
pub type GetCurrentPositionEx = unsafe extern "system" fn(hdc: HDC, lppt: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
...
pub type GetDCBrushColor = unsafe extern "system" fn(hdc: HDC) -> super::super::Foundation::COLORREF;
...
pub type GetDCOrgEx = unsafe extern "system" fn(hdc: HDC, lppt: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn GetDCOrgEx(hdc : HDC, lppt : *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL);
pub type GetDCPenColor = unsafe extern "system" fn(hdc: HDC) -> super::super::Foundation::COLORREF;
...
pub type GetDeviceCaps = unsafe extern "system" fn(hdc: HDC, index: i32) -> i32;
windows_link::link!("gdi32.dll" "system" fn GetDeviceCaps(hdc : HDC, index : i32) -> i32);
pub type GetEnhMetaFileA = unsafe extern "system" fn(lpname: windows_sys::core::PCSTR) -> HENHMETAFILE;
...
pub type GetEnhMetaFileDescriptionA = unsafe extern "system" fn(hemf: HENHMETAFILE, cchbuffer: u32, lpdescription: windows_sys::core::PSTR) -> u32;
...
pub type GetEnhMetaFileDescriptionW = unsafe extern "system" fn(hemf: HENHMETAFILE, cchbuffer: u32, lpdescription: windows_sys::core::PWSTR) -> u32;
...
pub type GetEnhMetaFileW = unsafe extern "system" fn(lpname: windows_sys::core::PCWSTR) -> HENHMETAFILE;
...
pub type GetGlyphIndicesA = unsafe extern "system" fn(hdc: HDC, lpstr: windows_sys::core::PCSTR, c: i32, pgi: *mut u16, fl: u32) -> u32;
windows_link::link!("gdi32.dll" "system" fn GetGlyphIndicesA(hdc : HDC, lpstr : windows_sys::core::PCSTR, c : i32, pgi : *mut u16, fl : u32) -> u32);
pub type GetGlyphIndicesW = unsafe extern "system" fn(hdc: HDC, lpstr: windows_sys::core::PCWSTR, c: i32, pgi: *mut u16, fl: u32) -> u32;
...
pub type GetMapMode = unsafe extern "system" fn(hdc: HDC) -> HDC_MAP_MODE;
windows_link::link!("gdi32.dll" "system" fn GetMapMode(hdc : HDC) -> HDC_MAP_MODE);
pub type GetMetaFileA = unsafe extern "system" fn(lpname: windows_sys::core::PCSTR) -> HMETAFILE;
...
pub type GetMetaFileW = unsafe extern "system" fn(lpname: windows_sys::core::PCWSTR) -> HMETAFILE;
...
pub type GetMiterLimit = unsafe extern "system" fn(hdc: HDC, plimit: *mut f32) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn GetMiterLimit(hdc : HDC, plimit : *mut f32) -> windows_sys::core::BOOL);
pub type GetMonitorInfoA = unsafe extern "system" fn(hmonitor: HMONITOR, lpmi: *mut MONITORINFO) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn GetMonitorInfoA(hmonitor : HMONITOR, lpmi : *mut MONITORINFO) -> windows_sys::core::BOOL);
pub type GetMonitorInfoW = unsafe extern "system" fn(hmonitor: HMONITOR, lpmi: *mut MONITORINFO) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn GetMonitorInfoW(hmonitor : HMONITOR, lpmi : *mut MONITORINFO) -> windows_sys::core::BOOL);
pub type GetNearestColor = unsafe extern "system" fn(hdc: HDC, color: super::super::Foundation::COLORREF) -> super::super::Foundation::COLORREF;
...
pub type GetNearestPaletteIndex = unsafe extern "system" fn(h: HPALETTE, color: super::super::Foundation::COLORREF) -> u32;
...
pub type GetPixel = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32) -> super::super::Foundation::COLORREF;
...
pub type GetROP2 = unsafe extern "system" fn(hdc: HDC) -> R2_MODE;
...
pub type GetRasterizerCaps = unsafe extern "system" fn(lpraststat: *mut RASTERIZER_STATUS, cjbytes: u32) -> windows_sys::core::BOOL;
...
pub type GetRgnBox = unsafe extern "system" fn(hrgn: HRGN, lprc: *mut super::super::Foundation::RECT) -> GDI_REGION_TYPE;
...
pub type GetSysColor = unsafe extern "system" fn(nindex: SYS_COLOR_INDEX) -> u32;
windows_link::link!("user32.dll" "system" fn GetSysColor(nindex : SYS_COLOR_INDEX) -> u32);
pub type GetSysColorBrush = unsafe extern "system" fn(nindex: SYS_COLOR_INDEX) -> HBRUSH;
...
pub type GetTabbedTextExtentA = unsafe extern "system" fn(hdc: HDC, lpstring: windows_sys::core::PCSTR, chcount: i32, ntabpositions: i32, lpntabstoppositions: *const i32) -> u32;
...
pub type GetTabbedTextExtentW = unsafe extern "system" fn(hdc: HDC, lpstring: windows_sys::core::PCWSTR, chcount: i32, ntabpositions: i32, lpntabstoppositions: *const i32) -> u32;
...
pub type GetTextAlign = unsafe extern "system" fn(hdc: HDC) -> TEXT_ALIGN_OPTIONS;
...
pub type GetTextColor = unsafe extern "system" fn(hdc: HDC) -> super::super::Foundation::COLORREF;
windows_link::link!("gdi32.dll" "system" fn GetTextColor(hdc : HDC) -> super::super::Foundation::COLORREF);
pub type GetTextExtentExPointA = unsafe extern "system" fn(hdc: HDC, lpszstring: windows_sys::core::PCSTR, cchstring: i32, nmaxextent: i32, lpnfit: *mut i32, lpndx: *mut i32, lpsize: *mut super::super::Foundation::SIZE) -> windows_sys::core::BOOL;
...
pub type GetTextExtentExPointI = unsafe extern "system" fn(hdc: HDC, lpwszstring: *const u16, cwchstring: i32, nmaxextent: i32, lpnfit: *mut i32, lpndx: *mut i32, lpsize: *mut super::super::Foundation::SIZE) -> windows_sys::core::BOOL;
...
pub type GetTextExtentExPointW = unsafe extern "system" fn(hdc: HDC, lpszstring: windows_sys::core::PCWSTR, cchstring: i32, nmaxextent: i32, lpnfit: *mut i32, lpndx: *mut i32, lpsize: *mut super::super::Foundation::SIZE) -> windows_sys::core::BOOL;
...
pub type GetTextExtentPoint32A = unsafe extern "system" fn(hdc: HDC, lpstring: windows_sys::core::PCSTR, c: i32, psizl: *mut super::super::Foundation::SIZE) -> windows_sys::core::BOOL;
...
pub type GetTextExtentPoint32W = unsafe extern "system" fn(hdc: HDC, lpstring: windows_sys::core::PCWSTR, c: i32, psizl: *mut super::super::Foundation::SIZE) -> windows_sys::core::BOOL;
...
pub type GetTextExtentPointA = unsafe extern "system" fn(hdc: HDC, lpstring: windows_sys::core::PCSTR, c: i32, lpsz: *mut super::super::Foundation::SIZE) -> windows_sys::core::BOOL;
...
pub type GetTextExtentPointI = unsafe extern "system" fn(hdc: HDC, pgiin: *const u16, cgi: i32, psize: *mut super::super::Foundation::SIZE) -> windows_sys::core::BOOL;
...
pub type GetTextExtentPointW = unsafe extern "system" fn(hdc: HDC, lpstring: windows_sys::core::PCWSTR, c: i32, lpsz: *mut super::super::Foundation::SIZE) -> windows_sys::core::BOOL;
...
pub type GetTextFaceA = unsafe extern "system" fn(hdc: HDC, c: i32, lpname: windows_sys::core::PSTR) -> i32;
windows_link::link!("gdi32.dll" "system" fn GetTextFaceA(hdc : HDC, c : i32, lpname : windows_sys::core::PSTR) -> i32);
pub type GetTextFaceW = unsafe extern "system" fn(hdc: HDC, c: i32, lpname: windows_sys::core::PWSTR) -> i32;
windows_link::link!("gdi32.dll" "system" fn GetTextFaceW(hdc : HDC, c : i32, lpname : windows_sys::core::PWSTR) -> i32);
pub type GetTextMetricsA = unsafe extern "system" fn(hdc: HDC, lptm: *mut TEXTMETRICA) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn GetTextMetricsA(hdc : HDC, lptm : *mut TEXTMETRICA) -> windows_sys::core::BOOL);
pub type GetTextMetricsW = unsafe extern "system" fn(hdc: HDC, lptm: *mut TEXTMETRICW) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn GetTextMetricsW(hdc : HDC, lptm : *mut TEXTMETRICW) -> windows_sys::core::BOOL);
pub type GetUpdateRect = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lprect: *mut super::super::Foundation::RECT, berase: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type GetUpdateRgn = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hrgn: HRGN, berase: windows_sys::core::BOOL) -> GDI_REGION_TYPE;
...
pub type GetViewportExtEx = unsafe extern "system" fn(hdc: HDC, lpsize: *mut super::super::Foundation::SIZE) -> windows_sys::core::BOOL;
...
pub type GetViewportOrgEx = unsafe extern "system" fn(hdc: HDC, lppoint: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
...
pub type GetWindowExtEx = unsafe extern "system" fn(hdc: HDC, lpsize: *mut super::super::Foundation::SIZE) -> windows_sys::core::BOOL;
...
pub type GetWindowOrgEx = unsafe extern "system" fn(hdc: HDC, lppoint: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
...
pub type GetWindowRgn = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hrgn: HRGN) -> GDI_REGION_TYPE;
windows_link::link!("user32.dll" "system" fn GetWindowRgn(hwnd : super::super::Foundation::HWND, hrgn : HRGN) -> GDI_REGION_TYPE);
pub type GetWindowRgnBox = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lprc: *mut super::super::Foundation::RECT) -> GDI_REGION_TYPE;
...
pub type GetWorldTransform = unsafe extern "system" fn(hdc: HDC, lpxf: *mut XFORM) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn GetWorldTransform(hdc : HDC, lpxf : *mut XFORM) -> windows_sys::core::BOOL);
pub type GradientFill = unsafe extern "system" fn(hdc: HDC, pvertex: *const TRIVERTEX, nvertex: u32, pmesh: *const core::ffi::c_void, nmesh: u32, ulmode: GRADIENT_FILL) -> windows_sys::core::BOOL;
...
pub type GrayStringA = unsafe extern "system" fn(hdc: HDC, hbrush: HBRUSH, lpoutputfunc: GRAYSTRINGPROC, lpdata: super::super::Foundation::LPARAM, ncount: i32, x: i32, y: i32, nwidth: i32, nheight: i32) -> windows_sys::core::BOOL;
...
pub type GrayStringW = unsafe extern "system" fn(hdc: HDC, hbrush: HBRUSH, lpoutputfunc: GRAYSTRINGPROC, lpdata: super::super::Foundation::LPARAM, ncount: i32, x: i32, y: i32, nwidth: i32, nheight: i32) -> windows_sys::core::BOOL;
...
pub type InflateRect = unsafe extern "system" fn(lprc: *mut super::super::Foundation::RECT, dx: i32, dy: i32) -> windows_sys::core::BOOL;
...
pub type IntersectClipRect = unsafe extern "system" fn(hdc: HDC, left: i32, top: i32, right: i32, bottom: i32) -> GDI_REGION_TYPE;
windows_link::link!("gdi32.dll" "system" fn IntersectClipRect(hdc : HDC, left : i32, top : i32, right : i32, bottom : i32) -> GDI_REGION_TYPE);
pub type IntersectRect = unsafe extern "system" fn(lprcdst: *mut super::super::Foundation::RECT, lprcsrc1: *const super::super::Foundation::RECT, lprcsrc2: *const super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
pub type InvalidateRect = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lprect: *const super::super::Foundation::RECT, berase: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type InvalidateRgn = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hrgn: HRGN, berase: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type InvertRect = unsafe extern "system" fn(hdc: HDC, lprc: *const super::super::Foundation::RECT) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn InvertRect(hdc : HDC, lprc : *const super::super::Foundation::RECT) -> windows_sys::core::BOOL);
pub type InvertRgn = unsafe extern "system" fn(hdc: HDC, hrgn: HRGN) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn InvertRgn(hdc : HDC, hrgn : HRGN) -> windows_sys::core::BOOL);
pub type IsRectEmpty = unsafe extern "system" fn(lprc: *const super::super::Foundation::RECT) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn IsRectEmpty(lprc : *const super::super::Foundation::RECT) -> windows_sys::core::BOOL);
pub type LPtoDP = unsafe extern "system" fn(hdc: HDC, lppt: *mut super::super::Foundation::POINT, c: i32) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn LPtoDP(hdc : HDC, lppt : *mut super::super::Foundation::POINT, c : i32) -> windows_sys::core::BOOL);
pub type LineDDA = unsafe extern "system" fn(xstart: i32, ystart: i32, xend: i32, yend: i32, lpproc: LINEDDAPROC, data: super::super::Foundation::LPARAM) -> windows_sys::core::BOOL;
...
pub type LineTo = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn LineTo(hdc : HDC, x : i32, y : i32) -> windows_sys::core::BOOL);
pub type LoadBitmapA = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lpbitmapname: windows_sys::core::PCSTR) -> HBITMAP;
...
pub type LoadBitmapW = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lpbitmapname: windows_sys::core::PCWSTR) -> HBITMAP;
...
pub type LockWindowUpdate = unsafe extern "system" fn(hwndlock: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
...
pub type MaskBlt = unsafe extern "system" fn(hdcdest: HDC, xdest: i32, ydest: i32, width: i32, height: i32, hdcsrc: HDC, xsrc: i32, ysrc: i32, hbmmask: HBITMAP, xmask: i32, ymask: i32, rop: u32) -> windows_sys::core::BOOL;
...
pub type ModifyWorldTransform = unsafe extern "system" fn(hdc: HDC, lpxf: *const XFORM, mode: MODIFY_WORLD_TRANSFORM_MODE) -> windows_sys::core::BOOL;
...
pub type MoveToEx = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, lppt: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
...
pub type OffsetClipRgn = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32) -> GDI_REGION_TYPE;
windows_link::link!("gdi32.dll" "system" fn OffsetClipRgn(hdc : HDC, x : i32, y : i32) -> GDI_REGION_TYPE);
pub type OffsetRect = unsafe extern "system" fn(lprc: *mut super::super::Foundation::RECT, dx: i32, dy: i32) -> windows_sys::core::BOOL;
...
pub type OffsetRgn = unsafe extern "system" fn(hrgn: HRGN, x: i32, y: i32) -> GDI_REGION_TYPE;
windows_link::link!("gdi32.dll" "system" fn OffsetRgn(hrgn : HRGN, x : i32, y : i32) -> GDI_REGION_TYPE);
pub type OffsetViewportOrgEx = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, lppt: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
...
pub type OffsetWindowOrgEx = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, lppt: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
...
pub type PaintDesktop = unsafe extern "system" fn(hdc: HDC) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn PaintDesktop(hdc : HDC) -> windows_sys::core::BOOL);
pub type PaintRgn = unsafe extern "system" fn(hdc: HDC, hrgn: HRGN) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn PaintRgn(hdc : HDC, hrgn : HRGN) -> windows_sys::core::BOOL);
pub type PatBlt = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, w: i32, h: i32, rop: ROP_CODE) -> windows_sys::core::BOOL;
...
pub type Pie = unsafe extern "system" fn(hdc: HDC, left: i32, top: i32, right: i32, bottom: i32, xr1: i32, yr1: i32, xr2: i32, yr2: i32) -> windows_sys::core::BOOL;
...
pub type PlayEnhMetaFile = unsafe extern "system" fn(hdc: HDC, hmf: HENHMETAFILE, lprect: *const super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
pub type PlayEnhMetaFileRecord = unsafe extern "system" fn(hdc: HDC, pht: *const HANDLETABLE, pmr: *const ENHMETARECORD, cht: u32) -> windows_sys::core::BOOL;
...
pub type PlayMetaFile = unsafe extern "system" fn(hdc: HDC, hmf: HMETAFILE) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn PlayMetaFile(hdc : HDC, hmf : HMETAFILE) -> windows_sys::core::BOOL);
pub type PlayMetaFileRecord = unsafe extern "system" fn(hdc: HDC, lphandletable: *const HANDLETABLE, lpmr: *const METARECORD, noobjs: u32) -> windows_sys::core::BOOL;
...
pub type PlgBlt = unsafe extern "system" fn(hdcdest: HDC, lppoint: *const super::super::Foundation::POINT, hdcsrc: HDC, xsrc: i32, ysrc: i32, width: i32, height: i32, hbmmask: HBITMAP, xmask: i32, ymask: i32) -> windows_sys::core::BOOL;
...
pub type PolyBezier = unsafe extern "system" fn(hdc: HDC, apt: *const super::super::Foundation::POINT, cpt: u32) -> windows_sys::core::BOOL;
...
pub type PolyBezierTo = unsafe extern "system" fn(hdc: HDC, apt: *const super::super::Foundation::POINT, cpt: u32) -> windows_sys::core::BOOL;
...
pub type PolyDraw = unsafe extern "system" fn(hdc: HDC, apt: *const super::super::Foundation::POINT, aj: *const u8, cpt: i32) -> windows_sys::core::BOOL;
...
pub type PolyPolygon = unsafe extern "system" fn(hdc: HDC, apt: *const super::super::Foundation::POINT, asz: *const i32, csz: i32) -> windows_sys::core::BOOL;
...
pub type PolyPolyline = unsafe extern "system" fn(hdc: HDC, apt: *const super::super::Foundation::POINT, asz: *const u32, csz: u32) -> windows_sys::core::BOOL;
...
pub type PolyTextOutA = unsafe extern "system" fn(hdc: HDC, ppt: *const POLYTEXTA, nstrings: i32) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn PolyTextOutA(hdc : HDC, ppt : *const POLYTEXTA, nstrings : i32) -> windows_sys::core::BOOL);
pub type PolyTextOutW = unsafe extern "system" fn(hdc: HDC, ppt: *const POLYTEXTW, nstrings: i32) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn PolyTextOutW(hdc : HDC, ppt : *const POLYTEXTW, nstrings : i32) -> windows_sys::core::BOOL);
pub type Polygon = unsafe extern "system" fn(hdc: HDC, apt: *const super::super::Foundation::POINT, cpt: i32) -> windows_sys::core::BOOL;
...
pub type Polyline = unsafe extern "system" fn(hdc: HDC, apt: *const super::super::Foundation::POINT, cpt: i32) -> windows_sys::core::BOOL;
...
pub type PolylineTo = unsafe extern "system" fn(hdc: HDC, apt: *const super::super::Foundation::POINT, cpt: u32) -> windows_sys::core::BOOL;
...
pub type PtInRect = unsafe extern "system" fn(lprc: *const super::super::Foundation::RECT, pt: super::super::Foundation::POINT) -> windows_sys::core::BOOL;
...
pub type PtInRegion = unsafe extern "system" fn(hrgn: HRGN, x: i32, y: i32) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn PtInRegion(hrgn : HRGN, x : i32, y : i32) -> windows_sys::core::BOOL);
pub type PtVisible = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32) -> windows_sys::core::BOOL;
...
pub type RectInRegion = unsafe extern "system" fn(hrgn: HRGN, lprect: *const super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
pub type RectVisible = unsafe extern "system" fn(hdc: HDC, lprect: *const super::super::Foundation::RECT) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn RectVisible(hdc : HDC, lprect : *const super::super::Foundation::RECT) -> windows_sys::core::BOOL);
pub type Rectangle = unsafe extern "system" fn(hdc: HDC, left: i32, top: i32, right: i32, bottom: i32) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn Rectangle(hdc : HDC, left : i32, top : i32, right : i32, bottom : i32) -> windows_sys::core::BOOL);
pub type RedrawWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lprcupdate: *const super::super::Foundation::RECT, hrgnupdate: HRGN, flags: REDRAW_WINDOW_FLAGS) -> windows_sys::core::BOOL;
...
pub type RemoveFontMemResourceEx = unsafe extern "system" fn(h: super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn RemoveFontMemResourceEx(h : super::super::Foundation::HANDLE) -> windows_sys::core::BOOL);
pub type RemoveFontResourceA = unsafe extern "system" fn(lpfilename: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn RemoveFontResourceA(lpfilename : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
pub type RemoveFontResourceExA = unsafe extern "system" fn(name: windows_sys::core::PCSTR, fl: u32, pdv: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type RemoveFontResourceExW = unsafe extern "system" fn(name: windows_sys::core::PCWSTR, fl: u32, pdv: *const core::ffi::c_void) -> windows_sys::core::BOOL;
...
pub type RemoveFontResourceW = unsafe extern "system" fn(lpfilename: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type ResizePalette = unsafe extern "system" fn(hpal: HPALETTE, n: u32) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn ResizePalette(hpal : HPALETTE, n : u32) -> windows_sys::core::BOOL);
pub type RestoreDC = unsafe extern "system" fn(hdc: HDC, nsaveddc: i32) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn RestoreDC(hdc : HDC, nsaveddc : i32) -> windows_sys::core::BOOL);
pub type RoundRect = unsafe extern "system" fn(hdc: HDC, left: i32, top: i32, right: i32, bottom: i32, width: i32, height: i32) -> windows_sys::core::BOOL;
...
pub type ScaleViewportExtEx = unsafe extern "system" fn(hdc: HDC, xn: i32, dx: i32, yn: i32, yd: i32, lpsz: *mut super::super::Foundation::SIZE) -> windows_sys::core::BOOL;
...
pub type ScaleWindowExtEx = unsafe extern "system" fn(hdc: HDC, xn: i32, xd: i32, yn: i32, yd: i32, lpsz: *mut super::super::Foundation::SIZE) -> windows_sys::core::BOOL;
...
pub type ScreenToClient = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lppoint: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
...
pub type SelectClipPath = unsafe extern "system" fn(hdc: HDC, mode: RGN_COMBINE_MODE) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn SelectClipPath(hdc : HDC, mode : RGN_COMBINE_MODE) -> windows_sys::core::BOOL);
pub type SelectClipRgn = unsafe extern "system" fn(hdc: HDC, hrgn: HRGN) -> GDI_REGION_TYPE;
...
pub type SelectPalette = unsafe extern "system" fn(hdc: HDC, hpal: HPALETTE, bforcebkgd: windows_sys::core::BOOL) -> HPALETTE;
...
pub type SetBitmapDimensionEx = unsafe extern "system" fn(hbm: HBITMAP, w: i32, h: i32, lpsz: *mut super::super::Foundation::SIZE) -> windows_sys::core::BOOL;
...
pub type SetBkColor = unsafe extern "system" fn(hdc: HDC, color: super::super::Foundation::COLORREF) -> super::super::Foundation::COLORREF;
...
pub type SetBkMode = unsafe extern "system" fn(hdc: HDC, mode: i32) -> i32;
...
pub type SetBrushOrgEx = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, lppt: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
...
pub type SetColorAdjustment = unsafe extern "system" fn(hdc: HDC, lpca: *const COLORADJUSTMENT) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn SetColorAdjustment(hdc : HDC, lpca : *const COLORADJUSTMENT) -> windows_sys::core::BOOL);
pub type SetDCBrushColor = unsafe extern "system" fn(hdc: HDC, color: super::super::Foundation::COLORREF) -> super::super::Foundation::COLORREF;
...
pub type SetDCPenColor = unsafe extern "system" fn(hdc: HDC, color: super::super::Foundation::COLORREF) -> super::super::Foundation::COLORREF;
...
pub type SetMetaRgn = unsafe extern "system" fn(hdc: HDC) -> GDI_REGION_TYPE;
windows_link::link!("gdi32.dll" "system" fn SetMetaRgn(hdc : HDC) -> GDI_REGION_TYPE);
pub type SetMiterLimit = unsafe extern "system" fn(hdc: HDC, limit: f32, old: *mut f32) -> windows_sys::core::BOOL;
...
pub type SetPixel = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, color: super::super::Foundation::COLORREF) -> super::super::Foundation::COLORREF;
...
pub type SetPixelV = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, color: super::super::Foundation::COLORREF) -> windows_sys::core::BOOL;
...
pub type SetRect = unsafe extern "system" fn(lprc: *mut super::super::Foundation::RECT, xleft: i32, ytop: i32, xright: i32, ybottom: i32) -> windows_sys::core::BOOL;
...
pub type SetRectEmpty = unsafe extern "system" fn(lprc: *mut super::super::Foundation::RECT) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn SetRectEmpty(lprc : *mut super::super::Foundation::RECT) -> windows_sys::core::BOOL);
pub type SetRectRgn = unsafe extern "system" fn(hrgn: HRGN, left: i32, top: i32, right: i32, bottom: i32) -> windows_sys::core::BOOL;
...
pub type SetSysColors = unsafe extern "system" fn(celements: i32, lpaelements: *const i32, lpargbvalues: *const super::super::Foundation::COLORREF) -> windows_sys::core::BOOL;
...
pub type SetTextColor = unsafe extern "system" fn(hdc: HDC, color: super::super::Foundation::COLORREF) -> super::super::Foundation::COLORREF;
...
pub type SetTextJustification = unsafe extern "system" fn(hdc: HDC, extra: i32, count: i32) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn SetTextJustification(hdc : HDC, extra : i32, count : i32) -> windows_sys::core::BOOL);
pub type SetViewportExtEx = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, lpsz: *mut super::super::Foundation::SIZE) -> windows_sys::core::BOOL;
...
pub type SetViewportOrgEx = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, lppt: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
...
pub type SetWindowExtEx = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, lpsz: *mut super::super::Foundation::SIZE) -> windows_sys::core::BOOL;
...
pub type SetWindowOrgEx = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, lppt: *mut super::super::Foundation::POINT) -> windows_sys::core::BOOL;
...
pub type SetWindowRgn = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hrgn: HRGN, bredraw: windows_sys::core::BOOL) -> i32;
...
pub type SetWorldTransform = unsafe extern "system" fn(hdc: HDC, lpxf: *const XFORM) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn SetWorldTransform(hdc : HDC, lpxf : *const XFORM) -> windows_sys::core::BOOL);
pub type StretchBlt = unsafe extern "system" fn(hdcdest: HDC, xdest: i32, ydest: i32, wdest: i32, hdest: i32, hdcsrc: HDC, xsrc: i32, ysrc: i32, wsrc: i32, hsrc: i32, rop: ROP_CODE) -> windows_sys::core::BOOL;
...
pub type StrokeAndFillPath = unsafe extern "system" fn(hdc: HDC) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn StrokeAndFillPath(hdc : HDC) -> windows_sys::core::BOOL);
pub type StrokePath = unsafe extern "system" fn(hdc: HDC) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn StrokePath(hdc : HDC) -> windows_sys::core::BOOL);
pub type SubtractRect = unsafe extern "system" fn(lprcdst: *mut super::super::Foundation::RECT, lprcsrc1: *const super::super::Foundation::RECT, lprcsrc2: *const super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
pub type TTEmbedFontFromFileA = unsafe extern "system" fn(hdc: HDC, szfontfilename: windows_sys::core::PCSTR, usttcindex: u16, ulflags: TTEMBED_FLAGS, ulcharset: EMBED_FONT_CHARSET, pulprivstatus: *mut EMBEDDED_FONT_PRIV_STATUS, pulstatus: *mut u32, lpfnwritetostream: WRITEEMBEDPROC, lpvwritestream: *const core::ffi::c_void, puscharcodeset: *const u16, uscharcodecount: u16, uslanguage: u16, pttembedinfo: *const TTEMBEDINFO) -> i32;
...
pub type TTEnableEmbeddingForFacename = unsafe extern "system" fn(lpszfacename: windows_sys::core::PCSTR, benable: windows_sys::core::BOOL) -> i32;
...
pub type TTGetNewFontName = unsafe extern "system" fn(phfontreference: *const super::super::Foundation::HANDLE, wzwinfamilyname: windows_sys::core::PWSTR, cchmaxwinname: i32, szmacfamilyname: windows_sys::core::PSTR, cchmaxmacname: i32) -> i32;
...
pub type TTIsEmbeddingEnabled = unsafe extern "system" fn(hdc: HDC, pbenabled: *mut windows_sys::core::BOOL) -> i32;
windows_link::link!("t2embed.dll" "system" fn TTIsEmbeddingEnabled(hdc : HDC, pbenabled : *mut windows_sys::core::BOOL) -> i32);
pub type TTIsEmbeddingEnabledForFacename = unsafe extern "system" fn(lpszfacename: windows_sys::core::PCSTR, pbenabled: *mut windows_sys::core::BOOL) -> i32;
...
pub type TabbedTextOutA = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, lpstring: windows_sys::core::PCSTR, chcount: i32, ntabpositions: i32, lpntabstoppositions: *const i32, ntaborigin: i32) -> i32;
...
pub type TabbedTextOutW = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, lpstring: windows_sys::core::PCWSTR, chcount: i32, ntabpositions: i32, lpntabstoppositions: *const i32, ntaborigin: i32) -> i32;
...
pub type TextOutA = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, lpstring: windows_sys::core::PCSTR, c: i32) -> windows_sys::core::BOOL;
...
pub type TextOutW = unsafe extern "system" fn(hdc: HDC, x: i32, y: i32, lpstring: windows_sys::core::PCWSTR, c: i32) -> windows_sys::core::BOOL;
...
pub type TransparentBlt = unsafe extern "system" fn(hdcdest: HDC, xorigindest: i32, yorigindest: i32, wdest: i32, hdest: i32, hdcsrc: HDC, xoriginsrc: i32, yoriginsrc: i32, wsrc: i32, hsrc: i32, crtransparent: u32) -> windows_sys::core::BOOL;
...
pub type UnionRect = unsafe extern "system" fn(lprcdst: *mut super::super::Foundation::RECT, lprcsrc1: *const super::super::Foundation::RECT, lprcsrc2: *const super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
pub type UnrealizeObject = unsafe extern "system" fn(h: HGDIOBJ) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn UnrealizeObject(h : HGDIOBJ) -> windows_sys::core::BOOL);
pub type UpdateColors = unsafe extern "system" fn(hdc: HDC) -> windows_sys::core::BOOL;
windows_link::link!("gdi32.dll" "system" fn UpdateColors(hdc : HDC) -> windows_sys::core::BOOL);
pub type UpdateWindow = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn UpdateWindow(hwnd : super::super::Foundation::HWND) -> windows_sys::core::BOOL);
pub type ValidateRect = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, lprect: *const super::super::Foundation::RECT) -> windows_sys::core::BOOL;
...
pub type ValidateRgn = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, hrgn: HRGN) -> windows_sys::core::BOOL;
windows_link::link!("user32.dll" "system" fn ValidateRgn(hwnd : super::super::Foundation::HWND, hrgn : HRGN) -> windows_sys::core::BOOL);
pub type WidenPath = unsafe extern "system" fn(hdc: HDC) -> windows_sys::core::BOOL;
