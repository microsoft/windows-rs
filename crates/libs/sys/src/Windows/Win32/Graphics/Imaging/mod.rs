...
pub mod D2D;
::windows_sys::core::windows_link ! ( "windowscodecs.dll" ,"system" fn WICConvertBitmapSource ( dstformat : *const :: windows_sys::core::GUID , pisrc : IWICBitmapSource , ppidst : *mut IWICBitmapSource ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "windowscodecs.dll" ,"system" fn WICCreateBitmapFromSection ( width : u32 , height : u32 , pixelformat : *const :: windows_sys::core::GUID , hsection : super::super::Foundation:: HANDLE , stride : u32 , offset : u32 , ppibitmap : *mut IWICBitmap ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "windowscodecs.dll" ,"system" fn WICCreateBitmapFromSectionEx ( width : u32 , height : u32 , pixelformat : *const :: windows_sys::core::GUID , hsection : super::super::Foundation:: HANDLE , stride : u32 , offset : u32 , desiredaccesslevel : WICSectionAccessLevel , ppibitmap : *mut IWICBitmap ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "windowscodecs.dll" ,"system" fn WICGetMetadataContentSize ( guidcontainerformat : *const :: windows_sys::core::GUID , piwriter : IWICMetadataWriter , pcbsize : *mut u64 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "windowscodecs.dll" ,"system" fn WICMapGuidToShortName ( guid : *const :: windows_sys::core::GUID , cchname : u32 , wzname : :: windows_sys::core::PWSTR , pcchactual : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "windowscodecs.dll" ,"system" fn WICMapSchemaToName ( guidmetadataformat : *const :: windows_sys::core::GUID , pwzschema : :: windows_sys::core::PCWSTR , cchname : u32 , wzname : :: windows_sys::core::PWSTR , pcchactual : *mut u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "windowscodecs.dll" ,"system" fn WICMapShortNameToGuid ( wzname : :: windows_sys::core::PCWSTR , pguid : *mut :: windows_sys::core::GUID ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::windows_link ! ( "windowscodecs.dll" ,"system" fn WICMatchMetadataContent ( guidcontainerformat : *const :: windows_sys::core::GUID , pguidvendor : *const :: windows_sys::core::GUID , pistream : super::super::System::Com:: IStream , pguidmetadataformat : *mut :: windows_sys::core::GUID ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_System_Com")]
::windows_sys::core::windows_link ! ( "windowscodecs.dll" ,"system" fn WICSerializeMetadataContent ( guidcontainerformat : *const :: windows_sys::core::GUID , piwriter : IWICMetadataWriter , dwpersistoptions : u32 , pistream : super::super::System::Com:: IStream ) -> :: windows_sys::core::HRESULT );
