...
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathBeziersI(path : *mut GpPath, points : *mut Point, count : i32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathClosedCurve(path : *mut GpPath, points : *mut PointF, count : i32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathClosedCurve2(path : *mut GpPath, points : *mut PointF, count : i32, tension : f32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathClosedCurve2I(path : *mut GpPath, points : *mut Point, count : i32, tension : f32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathClosedCurveI(path : *mut GpPath, points : *mut Point, count : i32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathCurve3(path : *mut GpPath, points : *mut PointF, count : i32, offset : i32, numberofsegments : i32, tension : f32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathCurve3I(path : *mut GpPath, points : *mut Point, count : i32, offset : i32, numberofsegments : i32, tension : f32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathLine2(path : *mut GpPath, points : *mut PointF, count : i32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathPath(path : *mut GpPath, addingpath : *mut GpPath, connect : windows_sys::core::BOOL) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathPolygon(path : *mut GpPath, points : *mut PointF, count : i32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathRectangles(path : *mut GpPath, rects : *mut RectF, count : i32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathStringI(path : *mut GpPath, string : windows_sys::core::PCWSTR, length : i32, family : *mut GpFontFamily, style : i32, emsize : f32, layoutrect : *mut Rect, format : *mut GpStringFormat) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipAlloc(size : usize) -> *mut core::ffi::c_void);
windows_link::link!("gdiplus.dll" "system" fn GdipBeginContainer(graphics : *mut GpGraphics, dstrect : *mut RectF, srcrect : *mut RectF, unit : Unit, state : *mut u32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipBeginContainer2(graphics : *mut GpGraphics, state : *mut u32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipBeginContainerI(graphics : *mut GpGraphics, dstrect : *mut Rect, srcrect : *mut Rect, unit : Unit, state : *mut u32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipBitmapLockBits(bitmap : *mut GpBitmap, rect : *mut Rect, flags : u32, format : i32, lockedbitmapdata : *mut BitmapData) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipCloneStringFormat(format : *mut GpStringFormat, newformat : *mut *mut GpStringFormat) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipCombineRegionRect(region : *mut GpRegion, rect : *mut RectF, combinemode : CombineMode) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipCombineRegionRectI(region : *mut GpRegion, rect : *mut Rect, combinemode : CombineMode) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipComment(graphics : *mut GpGraphics, sizedata : u32, data : *mut u8) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipConvertToEmfPlusToFile(refgraphics : *mut GpGraphics, metafile : *mut GpMetafile, conversionfailureflag : *mut i32, filename : windows_sys::core::PCWSTR, emftype : EmfType, description : windows_sys::core::PCWSTR, out_metafile : *mut *mut GpMetafile) -> Status);
#[cfg(feature = "Win32_System_Com")]
windows_link::link!("gdiplus.dll" "system" fn GdipConvertToEmfPlusToStream(refgraphics : *mut GpGraphics, metafile : *mut GpMetafile, conversionfailureflag : *mut i32, stream : * mut core::ffi::c_void, emftype : EmfType, description : windows_sys::core::PCWSTR, out_metafile : *mut *mut GpMetafile) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipCreateFont(fontfamily : *mut GpFontFamily, emsize : f32, style : i32, unit : Unit, font : *mut *mut GpFont) -> Status);
...
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdiplus.dll" "system" fn GdipCreateFontFromLogfontA(hdc : super::Gdi:: HDC, logfont : *mut super::Gdi:: LOGFONTA, font : *mut *mut GpFont) -> Status);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdiplus.dll" "system" fn GdipCreateFontFromLogfontW(hdc : super::Gdi:: HDC, logfont : *mut super::Gdi:: LOGFONTW, font : *mut *mut GpFont) -> Status);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
windows_link::link!("gdiplus.dll" "system" fn GdipCreateLineBrushFromRect(rect : *mut RectF, color1 : u32, color2 : u32, mode : LinearGradientMode, wrapmode : WrapMode, linegradient : *mut *mut GpLineGradient) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipCreateLineBrushFromRectI(rect : *mut Rect, color1 : u32, color2 : u32, mode : LinearGradientMode, wrapmode : WrapMode, linegradient : *mut *mut GpLineGradient) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipCreateLineBrushFromRectWithAngle(rect : *mut RectF, color1 : u32, color2 : u32, angle : f32, isanglescalable : windows_sys::core::BOOL, wrapmode : WrapMode, linegradient : *mut *mut GpLineGradient) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipCreateLineBrushFromRectWithAngleI(rect : *mut Rect, color1 : u32, color2 : u32, angle : f32, isanglescalable : windows_sys::core::BOOL, wrapmode : WrapMode, linegradient : *mut *mut GpLineGradient) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipCreateMatrix3(rect : *mut RectF, dstplg : *mut PointF, matrix : *mut *mut Matrix) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipCreateMatrix3I(rect : *mut Rect, dstplg : *mut Point, matrix : *mut *mut Matrix) -> Status);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdiplus.dll" "system" fn GdipCreateMetafileFromWmf(hwmf : super::Gdi:: HMETAFILE, deletewmf : windows_sys::core::BOOL, wmfplaceablefileheader : *mut WmfPlaceableFileHeader, metafile : *mut *mut GpMetafile) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipCreateMetafileFromWmfFile(file : windows_sys::core::PCWSTR, wmfplaceablefileheader : *mut WmfPlaceableFileHeader, metafile : *mut *mut GpMetafile) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipCreatePath2I(param0 : *mut Point, param1 : *mut u8, param2 : i32, param3 : FillMode, path : *mut *mut GpPath) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipCreatePathGradient(points : *mut PointF, count : i32, wrapmode : WrapMode, polygradient : *mut *mut GpPathGradient) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipCreatePathGradientI(points : *mut Point, count : i32, wrapmode : WrapMode, polygradient : *mut *mut GpPathGradient) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipCreateRegionRect(rect : *mut RectF, region : *mut *mut GpRegion) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipCreateRegionRectI(rect : *mut Rect, region : *mut *mut GpRegion) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipCreateRegionRgnData(regiondata : *mut u8, size : i32, region : *mut *mut GpRegion) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipDrawClosedCurve(graphics : *mut GpGraphics, pen : *mut GpPen, points : *mut PointF, count : i32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipDrawClosedCurve2(graphics : *mut GpGraphics, pen : *mut GpPen, points : *mut PointF, count : i32, tension : f32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipDrawClosedCurve2I(graphics : *mut GpGraphics, pen : *mut GpPen, points : *mut Point, count : i32, tension : f32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipDrawClosedCurveI(graphics : *mut GpGraphics, pen : *mut GpPen, points : *mut Point, count : i32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipDrawCurve(graphics : *mut GpGraphics, pen : *mut GpPen, points : *mut PointF, count : i32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipDrawCurve2(graphics : *mut GpGraphics, pen : *mut GpPen, points : *mut PointF, count : i32, tension : f32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipDrawCurve3(graphics : *mut GpGraphics, pen : *mut GpPen, points : *mut PointF, count : i32, offset : i32, numberofsegments : i32, tension : f32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipDrawCurve3I(graphics : *mut GpGraphics, pen : *mut GpPen, points : *mut Point, count : i32, offset : i32, numberofsegments : i32, tension : f32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipDrawCurveI(graphics : *mut GpGraphics, pen : *mut GpPen, points : *mut Point, count : i32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipDrawDriverString(graphics : *mut GpGraphics, text : *mut u16, length : i32, font : *mut GpFont, brush : *mut GpBrush, positions : *mut PointF, flags : i32, matrix : *mut Matrix) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipDrawImagePoints(graphics : *mut GpGraphics, image : *mut GpImage, dstpoints : *mut PointF, count : i32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipDrawImagePointsI(graphics : *mut GpGraphics, image : *mut GpImage, dstpoints : *mut Point, count : i32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipDrawImagePointsRect(graphics : *mut GpGraphics, image : *mut GpImage, points : *mut PointF, count : i32, srcx : f32, srcy : f32, srcwidth : f32, srcheight : f32, srcunit : Unit, imageattributes : *mut GpImageAttributes, callback : isize, callbackdata : *mut core::ffi::c_void) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipDrawImagePointsRectI(graphics : *mut GpGraphics, image : *mut GpImage, points : *mut Point, count : i32, srcx : i32, srcy : i32, srcwidth : i32, srcheight : i32, srcunit : Unit, imageattributes : *mut GpImageAttributes, callback : isize, callbackdata : *mut core::ffi::c_void) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipDrawImageRectRect(graphics : *mut GpGraphics, image : *mut GpImage, dstx : f32, dsty : f32, dstwidth : f32, dstheight : f32, srcx : f32, srcy : f32, srcwidth : f32, srcheight : f32, srcunit : Unit, imageattributes : *mut GpImageAttributes, callback : isize, callbackdata : *mut core::ffi::c_void) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipDrawImageRectRectI(graphics : *mut GpGraphics, image : *mut GpImage, dstx : i32, dsty : i32, dstwidth : i32, dstheight : i32, srcx : i32, srcy : i32, srcwidth : i32, srcheight : i32, srcunit : Unit, imageattributes : *mut GpImageAttributes, callback : isize, callbackdata : *mut core::ffi::c_void) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipDrawLinesI(graphics : *mut GpGraphics, pen : *mut GpPen, points : *mut Point, count : i32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipDrawPolygon(graphics : *mut GpGraphics, pen : *mut GpPen, points : *mut PointF, count : i32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipDrawPolygonI(graphics : *mut GpGraphics, pen : *mut GpPen, points : *mut Point, count : i32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipDrawRectangles(graphics : *mut GpGraphics, pen : *mut GpPen, rects : *mut RectF, count : i32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipDrawRectanglesI(graphics : *mut GpGraphics, pen : *mut GpPen, rects : *mut Rect, count : i32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipDrawString(graphics : *mut GpGraphics, string : windows_sys::core::PCWSTR, length : i32, font : *mut GpFont, layoutrect : *mut RectF, stringformat : *mut GpStringFormat, brush : *mut GpBrush) -> Status);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
windows_link::link!("gdiplus.dll" "system" fn GdipEnumerateMetafileDestPoint(graphics : *mut GpGraphics, metafile : *mut GpMetafile, destpoint : *mut PointF, callback : isize, callbackdata : *mut core::ffi::c_void, imageattributes : *mut GpImageAttributes) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipEnumerateMetafileDestPointsI(graphics : *mut GpGraphics, metafile : *mut GpMetafile, destpoints : *mut Point, count : i32, callback : isize, callbackdata : *mut core::ffi::c_void, imageattributes : *mut GpImageAttributes) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipEnumerateMetafileDestRect(graphics : *mut GpGraphics, metafile : *mut GpMetafile, destrect : *mut RectF, callback : isize, callbackdata : *mut core::ffi::c_void, imageattributes : *mut GpImageAttributes) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipEnumerateMetafileDestRectI(graphics : *mut GpGraphics, metafile : *mut GpMetafile, destrect : *mut Rect, callback : isize, callbackdata : *mut core::ffi::c_void, imageattributes : *mut GpImageAttributes) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipEnumerateMetafileSrcRectDestPoint(graphics : *mut GpGraphics, metafile : *mut GpMetafile, destpoint : *mut PointF, srcrect : *mut RectF, srcunit : Unit, callback : isize, callbackdata : *mut core::ffi::c_void, imageattributes : *mut GpImageAttributes) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipEnumerateMetafileSrcRectDestPointI(graphics : *mut GpGraphics, metafile : *mut GpMetafile, destpoint : *mut Point, srcrect : *mut Rect, srcunit : Unit, callback : isize, callbackdata : *mut core::ffi::c_void, imageattributes : *mut GpImageAttributes) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipEnumerateMetafileSrcRectDestRect(graphics : *mut GpGraphics, metafile : *mut GpMetafile, destrect : *mut RectF, srcrect : *mut RectF, srcunit : Unit, callback : isize, callbackdata : *mut core::ffi::c_void, imageattributes : *mut GpImageAttributes) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipFillClosedCurve(graphics : *mut GpGraphics, brush : *mut GpBrush, points : *mut PointF, count : i32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipFillClosedCurve2I(graphics : *mut GpGraphics, brush : *mut GpBrush, points : *mut Point, count : i32, tension : f32, fillmode : FillMode) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipFillPolygon(graphics : *mut GpGraphics, brush : *mut GpBrush, points : *mut PointF, count : i32, fillmode : FillMode) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipFillPolygon2(graphics : *mut GpGraphics, brush : *mut GpBrush, points : *mut PointF, count : i32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipFillPolygon2I(graphics : *mut GpGraphics, brush : *mut GpBrush, points : *mut Point, count : i32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipFillRectanglesI(graphics : *mut GpGraphics, brush : *mut GpBrush, rects : *mut Rect, count : i32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipGetCellAscent(family : *mut GpFontFamily, style : i32, cellascent : *mut u16) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipGetCellDescent(family : *mut GpFontFamily, style : i32, celldescent : *mut u16) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipGetEncoderParameterList(image : *mut GpImage, clsidencoder : *mut windows_sys::core::GUID, size : u32, buffer : *mut EncoderParameters) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipGetFontCollectionFamilyList(fontcollection : *mut GpFontCollection, numsought : i32, gpfamilies : *mut *mut GpFontFamily, numfound : *mut i32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipGetFontHeight(font : *mut GpFont, graphics : *mut GpGraphics, height : *mut f32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipGetFontHeightGivenDPI(font : *mut GpFont, dpi : f32, height : *mut f32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipGetLineSpacing(family : *mut GpFontFamily, style : i32, linespacing : *mut u16) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipGetMatrixElements(matrix : *mut Matrix, matrixout : *mut f32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipGetMetafileDownLevelRasterizationLimit(metafile : *mut GpMetafile, metafilerasterizationlimitdpi : *mut u32) -> Status);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathGradientSurroundColorsWithCount(brush : *mut GpPathGradient, color : *mut u32, count : *mut i32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathTypes(path : *mut GpPath, types : *mut u8, count : i32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathWorldBounds(path : *mut GpPath, bounds : *mut RectF, matrix : *mut Matrix, pen : *mut GpPen) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathWorldBoundsI(path : *mut GpPath, bounds : *mut Rect, matrix : *mut Matrix, pen : *mut GpPen) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipGetStringFormatAlign(format : *mut GpStringFormat, align : *mut StringAlignment) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipGetStringFormatDigitSubstitution(format : *mut GpStringFormat, language : *mut u16, substitute : *mut StringDigitSubstitute) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipGetStringFormatFlags(format : *mut GpStringFormat, flags : *mut i32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipGetStringFormatLineAlign(format : *mut GpStringFormat, align : *mut StringAlignment) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipGetStringFormatMeasurableCharacterRangeCount(format : *mut GpStringFormat, count : *mut i32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipGetStringFormatTabStopCount(format : *mut GpStringFormat, count : *mut i32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipGetStringFormatTrimming(format : *mut GpStringFormat, trimming : *mut StringTrimming) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipImageGetFrameCount(image : *mut GpImage, dimensionid : *mut windows_sys::core::GUID, count : *mut u32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipImageSelectActiveFrame(image : *mut GpImage, dimensionid : *mut windows_sys::core::GUID, frameindex : u32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipIsMatrixIdentity(matrix : *mut Matrix, result : *mut windows_sys::core::BOOL) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipIsMatrixInvertible(matrix : *mut Matrix, result : *mut windows_sys::core::BOOL) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipIsStyleAvailable(family : *mut GpFontFamily, style : i32, isstyleavailable : *mut windows_sys::core::BOOL) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipMeasureCharacterRanges(graphics : *mut GpGraphics, string : windows_sys::core::PCWSTR, length : i32, font : *mut GpFont, layoutrect : *mut RectF, stringformat : *mut GpStringFormat, regioncount : i32, regions : *mut *mut GpRegion) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipMeasureDriverString(graphics : *mut GpGraphics, text : *mut u16, length : i32, font : *mut GpFont, positions : *mut PointF, flags : i32, matrix : *mut Matrix, boundingbox : *mut RectF) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipMultiplyLineTransform(brush : *mut GpLineGradient, matrix : *mut Matrix, order : MatrixOrder) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipMultiplyPenTransform(pen : *mut GpPen, matrix : *mut Matrix, order : MatrixOrder) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipMultiplyTextureTransform(brush : *mut GpTexture, matrix : *mut Matrix, order : MatrixOrder) -> Status);
...
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdiplus.dll" "system" fn GdipRecordMetafile(referencehdc : super::Gdi:: HDC, r#type : EmfType, framerect : *mut RectF, frameunit : MetafileFrameUnit, description : windows_sys::core::PCWSTR, metafile : *mut *mut GpMetafile) -> Status);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdiplus.dll" "system" fn GdipRecordMetafileFileName(filename : windows_sys::core::PCWSTR, referencehdc : super::Gdi:: HDC, r#type : EmfType, framerect : *mut RectF, frameunit : MetafileFrameUnit, description : windows_sys::core::PCWSTR, metafile : *mut *mut GpMetafile) -> Status);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdiplus.dll" "system" fn GdipRecordMetafileFileNameI(filename : windows_sys::core::PCWSTR, referencehdc : super::Gdi:: HDC, r#type : EmfType, framerect : *mut Rect, frameunit : MetafileFrameUnit, description : windows_sys::core::PCWSTR, metafile : *mut *mut GpMetafile) -> Status);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_System_Com"))]
windows_link::link!("gdiplus.dll" "system" fn GdipRecordMetafileStream(stream : * mut core::ffi::c_void, referencehdc : super::Gdi:: HDC, r#type : EmfType, framerect : *mut RectF, frameunit : MetafileFrameUnit, description : windows_sys::core::PCWSTR, metafile : *mut *mut GpMetafile) -> Status);
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_System_Com"))]
windows_link::link!("gdiplus.dll" "system" fn GdipRecordMetafileStreamI(stream : * mut core::ffi::c_void, referencehdc : super::Gdi:: HDC, r#type : EmfType, framerect : *mut Rect, frameunit : MetafileFrameUnit, description : windows_sys::core::PCWSTR, metafile : *mut *mut GpMetafile) -> Status);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
windows_link::link!("gdiplus.dll" "system" fn GdipSaveAdd(image : *mut GpImage, encoderparams : *mut EncoderParameters) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipSaveAddImage(image : *mut GpImage, newimage : *mut GpImage, encoderparams : *mut EncoderParameters) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipSaveGraphics(graphics : *mut GpGraphics, state : *mut u32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipSaveImageToFile(image : *mut GpImage, filename : windows_sys::core::PCWSTR, clsidencoder : *mut windows_sys::core::GUID, encoderparams : *mut EncoderParameters) -> Status);
#[cfg(feature = "Win32_System_Com")]
windows_link::link!("gdiplus.dll" "system" fn GdipSaveImageToStream(image : *mut GpImage, stream : * mut core::ffi::c_void, clsidencoder : *mut windows_sys::core::GUID, encoderparams : *mut EncoderParameters) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipSetImageAttributesColorMatrix(imageattr : *mut GpImageAttributes, r#type : ColorAdjustType, enableflag : windows_sys::core::BOOL, colormatrix : *mut ColorMatrix, graymatrix : *mut ColorMatrix, flags : ColorMatrixFlags) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipSetImageAttributesRemapTable(imageattr : *mut GpImageAttributes, r#type : ColorAdjustType, enableflag : windows_sys::core::BOOL, mapsize : u32, map : *mut ColorMap) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipSetLinePresetBlend(brush : *mut GpLineGradient, blend : *mut u32, positions : *mut f32, count : i32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipSetLineSigmaBlend(brush : *mut GpLineGradient, focus : f32, scale : f32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipSetLineTransform(brush : *mut GpLineGradient, matrix : *mut Matrix) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipSetPathGradientBlend(brush : *mut GpPathGradient, blend : *mut f32, positions : *mut f32, count : i32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipSetPathGradientCenterColor(brush : *mut GpPathGradient, colors : u32) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipSetPathGradientCenterPoint(brush : *mut GpPathGradient, points : *mut PointF) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipSetPathGradientCenterPointI(brush : *mut GpPathGradient, points : *mut Point) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipSetPathGradientPresetBlend(brush : *mut GpPathGradient, blend : *mut u32, positions : *mut f32, count : i32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipSetPathGradientSurroundColorsWithCount(brush : *mut GpPathGradient, color : *mut u32, count : *mut i32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenCompoundArray(pen : *mut GpPen, dash : *mut f32, count : i32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenDashArray(pen : *mut GpPen, dash : *mut f32, count : i32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipSetPropertyItem(image : *mut GpImage, item : *mut PropertyItem) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipSetStringFormatMeasurableCharacterRanges(format : *mut GpStringFormat, rangecount : i32, ranges : *mut CharacterRange) -> Status);
windows_link::link!("gdiplus.dll" "system" fn GdipSetStringFormatTabStops(format : *mut GpStringFormat, firsttaboffset : f32, count : i32, tabstops : *mut f32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipSetTextureTransform(brush : *mut GpTexture, matrix : *mut Matrix) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdipWarpPath(path : *mut GpPath, matrix : *mut Matrix, points : *mut PointF, count : i32, srcx : f32, srcy : f32, srcwidth : f32, srcheight : f32, warpmode : WarpMode, flatness : f32) -> Status);
...
windows_link::link!("gdiplus.dll" "system" fn GdiplusStartup(token : *mut usize, input : *mut GdiplusStartupInput, output : *mut GdiplusStartupOutput) -> Status);
