pub type GdipAddPathArc = unsafe extern "system" fn(path: *mut GpPath, x: f32, y: f32, width: f32, height: f32, startangle: f32, sweepangle: f32) -> Status;
...
pub type GdipAddPathArcI = unsafe extern "system" fn(path: *mut GpPath, x: i32, y: i32, width: i32, height: i32, startangle: f32, sweepangle: f32) -> Status;
...
pub type GdipAddPathBezier = unsafe extern "system" fn(path: *mut GpPath, x1: f32, y1: f32, x2: f32, y2: f32, x3: f32, y3: f32, x4: f32, y4: f32) -> Status;
...
pub type GdipAddPathBezierI = unsafe extern "system" fn(path: *mut GpPath, x1: i32, y1: i32, x2: i32, y2: i32, x3: i32, y3: i32, x4: i32, y4: i32) -> Status;
...
pub type GdipAddPathBeziers = unsafe extern "system" fn(path: *mut GpPath, points: *const PointF, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathBeziers(path : *mut GpPath, points : *const PointF, count : i32) -> Status);
pub type GdipAddPathBeziersI = unsafe extern "system" fn(path: *mut GpPath, points: *const Point, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathBeziersI(path : *mut GpPath, points : *const Point, count : i32) -> Status);
pub type GdipAddPathClosedCurve = unsafe extern "system" fn(path: *mut GpPath, points: *const PointF, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathClosedCurve(path : *mut GpPath, points : *const PointF, count : i32) -> Status);
pub type GdipAddPathClosedCurve2 = unsafe extern "system" fn(path: *mut GpPath, points: *const PointF, count: i32, tension: f32) -> Status;
...
pub type GdipAddPathClosedCurve2I = unsafe extern "system" fn(path: *mut GpPath, points: *const Point, count: i32, tension: f32) -> Status;
...
pub type GdipAddPathClosedCurveI = unsafe extern "system" fn(path: *mut GpPath, points: *const Point, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathClosedCurveI(path : *mut GpPath, points : *const Point, count : i32) -> Status);
pub type GdipAddPathCurve = unsafe extern "system" fn(path: *mut GpPath, points: *const PointF, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathCurve(path : *mut GpPath, points : *const PointF, count : i32) -> Status);
pub type GdipAddPathCurve2 = unsafe extern "system" fn(path: *mut GpPath, points: *const PointF, count: i32, tension: f32) -> Status;
...
pub type GdipAddPathCurve2I = unsafe extern "system" fn(path: *mut GpPath, points: *const Point, count: i32, tension: f32) -> Status;
...
pub type GdipAddPathCurve3 = unsafe extern "system" fn(path: *mut GpPath, points: *const PointF, count: i32, offset: i32, numberofsegments: i32, tension: f32) -> Status;
...
pub type GdipAddPathCurve3I = unsafe extern "system" fn(path: *mut GpPath, points: *const Point, count: i32, offset: i32, numberofsegments: i32, tension: f32) -> Status;
...
pub type GdipAddPathCurveI = unsafe extern "system" fn(path: *mut GpPath, points: *const Point, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathCurveI(path : *mut GpPath, points : *const Point, count : i32) -> Status);
pub type GdipAddPathEllipse = unsafe extern "system" fn(path: *mut GpPath, x: f32, y: f32, width: f32, height: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathEllipse(path : *mut GpPath, x : f32, y : f32, width : f32, height : f32) -> Status);
pub type GdipAddPathEllipseI = unsafe extern "system" fn(path: *mut GpPath, x: i32, y: i32, width: i32, height: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathEllipseI(path : *mut GpPath, x : i32, y : i32, width : i32, height : i32) -> Status);
pub type GdipAddPathLine = unsafe extern "system" fn(path: *mut GpPath, x1: f32, y1: f32, x2: f32, y2: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathLine(path : *mut GpPath, x1 : f32, y1 : f32, x2 : f32, y2 : f32) -> Status);
pub type GdipAddPathLine2 = unsafe extern "system" fn(path: *mut GpPath, points: *const PointF, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathLine2(path : *mut GpPath, points : *const PointF, count : i32) -> Status);
pub type GdipAddPathLine2I = unsafe extern "system" fn(path: *mut GpPath, points: *const Point, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathLine2I(path : *mut GpPath, points : *const Point, count : i32) -> Status);
pub type GdipAddPathLineI = unsafe extern "system" fn(path: *mut GpPath, x1: i32, y1: i32, x2: i32, y2: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathLineI(path : *mut GpPath, x1 : i32, y1 : i32, x2 : i32, y2 : i32) -> Status);
pub type GdipAddPathPath = unsafe extern "system" fn(path: *mut GpPath, addingpath: *const GpPath, connect: windows_sys::core::BOOL) -> Status;
...
pub type GdipAddPathPie = unsafe extern "system" fn(path: *mut GpPath, x: f32, y: f32, width: f32, height: f32, startangle: f32, sweepangle: f32) -> Status;
...
pub type GdipAddPathPieI = unsafe extern "system" fn(path: *mut GpPath, x: i32, y: i32, width: i32, height: i32, startangle: f32, sweepangle: f32) -> Status;
...
pub type GdipAddPathPolygon = unsafe extern "system" fn(path: *mut GpPath, points: *const PointF, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathPolygon(path : *mut GpPath, points : *const PointF, count : i32) -> Status);
pub type GdipAddPathPolygonI = unsafe extern "system" fn(path: *mut GpPath, points: *const Point, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathPolygonI(path : *mut GpPath, points : *const Point, count : i32) -> Status);
pub type GdipAddPathRectangle = unsafe extern "system" fn(path: *mut GpPath, x: f32, y: f32, width: f32, height: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathRectangle(path : *mut GpPath, x : f32, y : f32, width : f32, height : f32) -> Status);
pub type GdipAddPathRectangleI = unsafe extern "system" fn(path: *mut GpPath, x: i32, y: i32, width: i32, height: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathRectangleI(path : *mut GpPath, x : i32, y : i32, width : i32, height : i32) -> Status);
pub type GdipAddPathRectangles = unsafe extern "system" fn(path: *mut GpPath, rects: *const RectF, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathRectangles(path : *mut GpPath, rects : *const RectF, count : i32) -> Status);
pub type GdipAddPathRectanglesI = unsafe extern "system" fn(path: *mut GpPath, rects: *const Rect, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipAddPathRectanglesI(path : *mut GpPath, rects : *const Rect, count : i32) -> Status);
pub type GdipAddPathString = unsafe extern "system" fn(path: *mut GpPath, string: windows_sys::core::PCWSTR, length: i32, family: *const GpFontFamily, style: i32, emsize: f32, layoutrect: *const RectF, format: *const GpStringFormat) -> Status;
...
pub type GdipAddPathStringI = unsafe extern "system" fn(path: *mut GpPath, string: windows_sys::core::PCWSTR, length: i32, family: *const GpFontFamily, style: i32, emsize: f32, layoutrect: *const Rect, format: *const GpStringFormat) -> Status;
...
pub type GdipAlloc = unsafe extern "system" fn(size: usize) -> *mut core::ffi::c_void;
windows_link::link!("gdiplus.dll" "system" fn GdipAlloc(size : usize) -> *mut core::ffi::c_void);
pub type GdipBeginContainer = unsafe extern "system" fn(graphics: *mut GpGraphics, dstrect: *const RectF, srcrect: *const RectF, unit: Unit, state: *mut u32) -> Status;
...
pub type GdipBeginContainer2 = unsafe extern "system" fn(graphics: *mut GpGraphics, state: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipBeginContainer2(graphics : *mut GpGraphics, state : *mut u32) -> Status);
pub type GdipBeginContainerI = unsafe extern "system" fn(graphics: *mut GpGraphics, dstrect: *const Rect, srcrect: *const Rect, unit: Unit, state: *mut u32) -> Status;
...
pub type GdipBitmapApplyEffect = unsafe extern "system" fn(bitmap: *mut GpBitmap, effect: *mut CGpEffect, roi: *mut super::super::Foundation::RECT, useauxdata: windows_sys::core::BOOL, auxdata: *mut *mut core::ffi::c_void, auxdatasize: *mut i32) -> Status;
...
pub type GdipBitmapConvertFormat = unsafe extern "system" fn(pinputbitmap: *mut GpBitmap, format: i32, dithertype: DitherType, palettetype: PaletteType, palette: *mut ColorPalette, alphathresholdpercent: f32) -> Status;
...
pub type GdipBitmapGetHistogram = unsafe extern "system" fn(bitmap: *mut GpBitmap, format: HistogramFormat, numberofentries: u32, channel0: *mut u32, channel1: *mut u32, channel2: *mut u32, channel3: *mut u32) -> Status;
...
pub type GdipBitmapGetHistogramSize = unsafe extern "system" fn(format: HistogramFormat, numberofentries: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipBitmapGetHistogramSize(format : HistogramFormat, numberofentries : *mut u32) -> Status);
pub type GdipBitmapGetPixel = unsafe extern "system" fn(bitmap: *mut GpBitmap, x: i32, y: i32, color: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipBitmapGetPixel(bitmap : *mut GpBitmap, x : i32, y : i32, color : *mut u32) -> Status);
pub type GdipBitmapLockBits = unsafe extern "system" fn(bitmap: *mut GpBitmap, rect: *const Rect, flags: u32, format: i32, lockedbitmapdata: *mut BitmapData) -> Status;
...
pub type GdipBitmapSetPixel = unsafe extern "system" fn(bitmap: *mut GpBitmap, x: i32, y: i32, color: u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipBitmapSetPixel(bitmap : *mut GpBitmap, x : i32, y : i32, color : u32) -> Status);
pub type GdipBitmapSetResolution = unsafe extern "system" fn(bitmap: *mut GpBitmap, xdpi: f32, ydpi: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipBitmapSetResolution(bitmap : *mut GpBitmap, xdpi : f32, ydpi : f32) -> Status);
pub type GdipBitmapUnlockBits = unsafe extern "system" fn(bitmap: *mut GpBitmap, lockedbitmapdata: *mut BitmapData) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipBitmapUnlockBits(bitmap : *mut GpBitmap, lockedbitmapdata : *mut BitmapData) -> Status);
pub type GdipClearPathMarkers = unsafe extern "system" fn(path: *mut GpPath) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipClearPathMarkers(path : *mut GpPath) -> Status);
pub type GdipCloneBitmapArea = unsafe extern "system" fn(x: f32, y: f32, width: f32, height: f32, format: i32, srcbitmap: *mut GpBitmap, dstbitmap: *mut *mut GpBitmap) -> Status;
...
pub type GdipCloneBitmapAreaI = unsafe extern "system" fn(x: i32, y: i32, width: i32, height: i32, format: i32, srcbitmap: *mut GpBitmap, dstbitmap: *mut *mut GpBitmap) -> Status;
...
pub type GdipCloneBrush = unsafe extern "system" fn(brush: *mut GpBrush, clonebrush: *mut *mut GpBrush) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipCloneBrush(brush : *mut GpBrush, clonebrush : *mut *mut GpBrush) -> Status);
pub type GdipCloneCustomLineCap = unsafe extern "system" fn(customcap: *mut GpCustomLineCap, clonedcap: *mut *mut GpCustomLineCap) -> Status;
...
pub type GdipCloneFont = unsafe extern "system" fn(font: *mut GpFont, clonefont: *mut *mut GpFont) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipCloneFont(font : *mut GpFont, clonefont : *mut *mut GpFont) -> Status);
pub type GdipCloneFontFamily = unsafe extern "system" fn(fontfamily: *mut GpFontFamily, clonedfontfamily: *mut *mut GpFontFamily) -> Status;
...
pub type GdipCloneImage = unsafe extern "system" fn(image: *mut GpImage, cloneimage: *mut *mut GpImage) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipCloneImage(image : *mut GpImage, cloneimage : *mut *mut GpImage) -> Status);
pub type GdipCloneImageAttributes = unsafe extern "system" fn(imageattr: *const GpImageAttributes, cloneimageattr: *mut *mut GpImageAttributes) -> Status;
...
pub type GdipCloneMatrix = unsafe extern "system" fn(matrix: *mut Matrix, clonematrix: *mut *mut Matrix) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipCloneMatrix(matrix : *mut Matrix, clonematrix : *mut *mut Matrix) -> Status);
pub type GdipClonePath = unsafe extern "system" fn(path: *mut GpPath, clonepath: *mut *mut GpPath) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipClonePath(path : *mut GpPath, clonepath : *mut *mut GpPath) -> Status);
pub type GdipClonePen = unsafe extern "system" fn(pen: *mut GpPen, clonepen: *mut *mut GpPen) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipClonePen(pen : *mut GpPen, clonepen : *mut *mut GpPen) -> Status);
pub type GdipCloneRegion = unsafe extern "system" fn(region: *mut GpRegion, cloneregion: *mut *mut GpRegion) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipCloneRegion(region : *mut GpRegion, cloneregion : *mut *mut GpRegion) -> Status);
pub type GdipCloneStringFormat = unsafe extern "system" fn(format: *const GpStringFormat, newformat: *mut *mut GpStringFormat) -> Status;
...
pub type GdipClosePathFigure = unsafe extern "system" fn(path: *mut GpPath) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipClosePathFigure(path : *mut GpPath) -> Status);
pub type GdipClosePathFigures = unsafe extern "system" fn(path: *mut GpPath) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipClosePathFigures(path : *mut GpPath) -> Status);
pub type GdipCombineRegionPath = unsafe extern "system" fn(region: *mut GpRegion, path: *mut GpPath, combinemode: CombineMode) -> Status;
...
pub type GdipCombineRegionRect = unsafe extern "system" fn(region: *mut GpRegion, rect: *const RectF, combinemode: CombineMode) -> Status;
...
pub type GdipCombineRegionRectI = unsafe extern "system" fn(region: *mut GpRegion, rect: *const Rect, combinemode: CombineMode) -> Status;
...
pub type GdipCombineRegionRegion = unsafe extern "system" fn(region: *mut GpRegion, region2: *mut GpRegion, combinemode: CombineMode) -> Status;
...
pub type GdipComment = unsafe extern "system" fn(graphics: *mut GpGraphics, sizedata: u32, data: *const u8) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipComment(graphics : *mut GpGraphics, sizedata : u32, data : *const u8) -> Status);
pub type GdipConvertToEmfPlus = unsafe extern "system" fn(refgraphics: *const GpGraphics, metafile: *mut GpMetafile, conversionfailureflag: *mut i32, emftype: EmfType, description: windows_sys::core::PCWSTR, out_metafile: *mut *mut GpMetafile) -> Status;
...
pub type GdipConvertToEmfPlusToFile = unsafe extern "system" fn(refgraphics: *const GpGraphics, metafile: *mut GpMetafile, conversionfailureflag: *mut i32, filename: windows_sys::core::PCWSTR, emftype: EmfType, description: windows_sys::core::PCWSTR, out_metafile: *mut *mut GpMetafile) -> Status;
...
pub type GdipConvertToEmfPlusToStream = unsafe extern "system" fn(refgraphics: *const GpGraphics, metafile: *mut GpMetafile, conversionfailureflag: *mut i32, stream: *mut core::ffi::c_void, emftype: EmfType, description: windows_sys::core::PCWSTR, out_metafile: *mut *mut GpMetafile) -> Status;
#[cfg(feature = "Win32_System_Com")]
...
pub type GdipCreateAdjustableArrowCap = unsafe extern "system" fn(height: f32, width: f32, isfilled: windows_sys::core::BOOL, cap: *mut *mut GpAdjustableArrowCap) -> Status;
...
pub type GdipCreateBitmapFromFile = unsafe extern "system" fn(filename: windows_sys::core::PCWSTR, bitmap: *mut *mut GpBitmap) -> Status;
...
pub type GdipCreateBitmapFromFileICM = unsafe extern "system" fn(filename: windows_sys::core::PCWSTR, bitmap: *mut *mut GpBitmap) -> Status;
...
pub type GdipCreateBitmapFromGdiDib = unsafe extern "system" fn(gdibitmapinfo: *const super::Gdi::BITMAPINFO, gdibitmapdata: *mut core::ffi::c_void, bitmap: *mut *mut GpBitmap) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GdipCreateBitmapFromGraphics = unsafe extern "system" fn(width: i32, height: i32, target: *mut GpGraphics, bitmap: *mut *mut GpBitmap) -> Status;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipCreateBitmapFromHBITMAP = unsafe extern "system" fn(hbm: super::Gdi::HBITMAP, hpal: super::Gdi::HPALETTE, bitmap: *mut *mut GpBitmap) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GdipCreateBitmapFromHICON = unsafe extern "system" fn(hicon: super::super::UI::WindowsAndMessaging::HICON, bitmap: *mut *mut GpBitmap) -> Status;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
pub type GdipCreateBitmapFromResource = unsafe extern "system" fn(hinstance: super::super::Foundation::HINSTANCE, lpbitmapname: windows_sys::core::PCWSTR, bitmap: *mut *mut GpBitmap) -> Status;
...
pub type GdipCreateBitmapFromScan0 = unsafe extern "system" fn(width: i32, height: i32, stride: i32, format: i32, scan0: *const u8, bitmap: *mut *mut GpBitmap) -> Status;
...
#[cfg(feature = "Win32_System_Com")]
pub type GdipCreateBitmapFromStream = unsafe extern "system" fn(stream: *mut core::ffi::c_void, bitmap: *mut *mut GpBitmap) -> Status;
#[cfg(feature = "Win32_System_Com")]
...
#[cfg(feature = "Win32_System_Com")]
pub type GdipCreateBitmapFromStreamICM = unsafe extern "system" fn(stream: *mut core::ffi::c_void, bitmap: *mut *mut GpBitmap) -> Status;
#[cfg(feature = "Win32_System_Com")]
...
pub type GdipCreateCachedBitmap = unsafe extern "system" fn(bitmap: *mut GpBitmap, graphics: *mut GpGraphics, cachedbitmap: *mut *mut GpCachedBitmap) -> Status;
...
pub type GdipCreateCustomLineCap = unsafe extern "system" fn(fillpath: *mut GpPath, strokepath: *mut GpPath, basecap: LineCap, baseinset: f32, customcap: *mut *mut GpCustomLineCap) -> Status;
...
pub type GdipCreateEffect = unsafe extern "system" fn(guid: windows_sys::core::GUID, effect: *mut *mut CGpEffect) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipCreateEffect(guid : windows_sys::core::GUID, effect : *mut *mut CGpEffect) -> Status);
pub type GdipCreateFont = unsafe extern "system" fn(fontfamily: *const GpFontFamily, emsize: f32, style: i32, unit: Unit, font: *mut *mut GpFont) -> Status;
...
pub type GdipCreateFontFamilyFromName = unsafe extern "system" fn(name: windows_sys::core::PCWSTR, fontcollection: *mut GpFontCollection, fontfamily: *mut *mut GpFontFamily) -> Status;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipCreateFontFromDC = unsafe extern "system" fn(hdc: super::Gdi::HDC, font: *mut *mut GpFont) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdiplus.dll" "system" fn GdipCreateFontFromDC(hdc : super::Gdi::HDC, font : *mut *mut GpFont) -> Status);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipCreateFontFromLogfontA = unsafe extern "system" fn(hdc: super::Gdi::HDC, logfont: *const super::Gdi::LOGFONTA, font: *mut *mut GpFont) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipCreateFontFromLogfontW = unsafe extern "system" fn(hdc: super::Gdi::HDC, logfont: *const super::Gdi::LOGFONTW, font: *mut *mut GpFont) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipCreateFromHDC = unsafe extern "system" fn(hdc: super::Gdi::HDC, graphics: *mut *mut GpGraphics) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdiplus.dll" "system" fn GdipCreateFromHDC(hdc : super::Gdi::HDC, graphics : *mut *mut GpGraphics) -> Status);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipCreateFromHDC2 = unsafe extern "system" fn(hdc: super::Gdi::HDC, hdevice: super::super::Foundation::HANDLE, graphics: *mut *mut GpGraphics) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GdipCreateFromHWND = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, graphics: *mut *mut GpGraphics) -> Status;
...
pub type GdipCreateFromHWNDICM = unsafe extern "system" fn(hwnd: super::super::Foundation::HWND, graphics: *mut *mut GpGraphics) -> Status;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipCreateHBITMAPFromBitmap = unsafe extern "system" fn(bitmap: *mut GpBitmap, hbmreturn: *mut super::Gdi::HBITMAP, background: u32) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type GdipCreateHICONFromBitmap = unsafe extern "system" fn(bitmap: *mut GpBitmap, hbmreturn: *mut super::super::UI::WindowsAndMessaging::HICON) -> Status;
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipCreateHalftonePalette = unsafe extern "system" fn() -> super::Gdi::HPALETTE;
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdiplus.dll" "system" fn GdipCreateHalftonePalette() -> super::Gdi::HPALETTE);
pub type GdipCreateHatchBrush = unsafe extern "system" fn(hatchstyle: HatchStyle, forecol: u32, backcol: u32, brush: *mut *mut GpHatch) -> Status;
...
pub type GdipCreateImageAttributes = unsafe extern "system" fn(imageattr: *mut *mut GpImageAttributes) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipCreateImageAttributes(imageattr : *mut *mut GpImageAttributes) -> Status);
pub type GdipCreateLineBrush = unsafe extern "system" fn(point1: *const PointF, point2: *const PointF, color1: u32, color2: u32, wrapmode: WrapMode, linegradient: *mut *mut GpLineGradient) -> Status;
...
pub type GdipCreateLineBrushFromRect = unsafe extern "system" fn(rect: *const RectF, color1: u32, color2: u32, mode: LinearGradientMode, wrapmode: WrapMode, linegradient: *mut *mut GpLineGradient) -> Status;
...
pub type GdipCreateLineBrushFromRectI = unsafe extern "system" fn(rect: *const Rect, color1: u32, color2: u32, mode: LinearGradientMode, wrapmode: WrapMode, linegradient: *mut *mut GpLineGradient) -> Status;
...
pub type GdipCreateLineBrushFromRectWithAngle = unsafe extern "system" fn(rect: *const RectF, color1: u32, color2: u32, angle: f32, isanglescalable: windows_sys::core::BOOL, wrapmode: WrapMode, linegradient: *mut *mut GpLineGradient) -> Status;
...
pub type GdipCreateLineBrushFromRectWithAngleI = unsafe extern "system" fn(rect: *const Rect, color1: u32, color2: u32, angle: f32, isanglescalable: windows_sys::core::BOOL, wrapmode: WrapMode, linegradient: *mut *mut GpLineGradient) -> Status;
...
pub type GdipCreateLineBrushI = unsafe extern "system" fn(point1: *const Point, point2: *const Point, color1: u32, color2: u32, wrapmode: WrapMode, linegradient: *mut *mut GpLineGradient) -> Status;
...
pub type GdipCreateMatrix = unsafe extern "system" fn(matrix: *mut *mut Matrix) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipCreateMatrix(matrix : *mut *mut Matrix) -> Status);
pub type GdipCreateMatrix2 = unsafe extern "system" fn(m11: f32, m12: f32, m21: f32, m22: f32, dx: f32, dy: f32, matrix: *mut *mut Matrix) -> Status;
...
pub type GdipCreateMatrix3 = unsafe extern "system" fn(rect: *const RectF, dstplg: *const PointF, matrix: *mut *mut Matrix) -> Status;
...
pub type GdipCreateMatrix3I = unsafe extern "system" fn(rect: *const Rect, dstplg: *const Point, matrix: *mut *mut Matrix) -> Status;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipCreateMetafileFromEmf = unsafe extern "system" fn(hemf: super::Gdi::HENHMETAFILE, deleteemf: windows_sys::core::BOOL, metafile: *mut *mut GpMetafile) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GdipCreateMetafileFromFile = unsafe extern "system" fn(file: windows_sys::core::PCWSTR, metafile: *mut *mut GpMetafile) -> Status;
...
#[cfg(feature = "Win32_System_Com")]
pub type GdipCreateMetafileFromStream = unsafe extern "system" fn(stream: *mut core::ffi::c_void, metafile: *mut *mut GpMetafile) -> Status;
#[cfg(feature = "Win32_System_Com")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipCreateMetafileFromWmf = unsafe extern "system" fn(hwmf: super::Gdi::HMETAFILE, deletewmf: windows_sys::core::BOOL, wmfplaceablefileheader: *const WmfPlaceableFileHeader, metafile: *mut *mut GpMetafile) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GdipCreateMetafileFromWmfFile = unsafe extern "system" fn(file: windows_sys::core::PCWSTR, wmfplaceablefileheader: *const WmfPlaceableFileHeader, metafile: *mut *mut GpMetafile) -> Status;
...
pub type GdipCreatePath = unsafe extern "system" fn(brushmode: FillMode, path: *mut *mut GpPath) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipCreatePath(brushmode : FillMode, path : *mut *mut GpPath) -> Status);
pub type GdipCreatePath2 = unsafe extern "system" fn(param0: *const PointF, param1: *const u8, param2: i32, param3: FillMode, path: *mut *mut GpPath) -> Status;
...
pub type GdipCreatePath2I = unsafe extern "system" fn(param0: *const Point, param1: *const u8, param2: i32, param3: FillMode, path: *mut *mut GpPath) -> Status;
...
pub type GdipCreatePathGradient = unsafe extern "system" fn(points: *const PointF, count: i32, wrapmode: WrapMode, polygradient: *mut *mut GpPathGradient) -> Status;
...
pub type GdipCreatePathGradientFromPath = unsafe extern "system" fn(path: *const GpPath, polygradient: *mut *mut GpPathGradient) -> Status;
...
pub type GdipCreatePathGradientI = unsafe extern "system" fn(points: *const Point, count: i32, wrapmode: WrapMode, polygradient: *mut *mut GpPathGradient) -> Status;
...
pub type GdipCreatePathIter = unsafe extern "system" fn(iterator: *mut *mut GpPathIterator, path: *mut GpPath) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipCreatePathIter(iterator : *mut *mut GpPathIterator, path : *mut GpPath) -> Status);
pub type GdipCreatePen1 = unsafe extern "system" fn(color: u32, width: f32, unit: Unit, pen: *mut *mut GpPen) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipCreatePen1(color : u32, width : f32, unit : Unit, pen : *mut *mut GpPen) -> Status);
pub type GdipCreatePen2 = unsafe extern "system" fn(brush: *mut GpBrush, width: f32, unit: Unit, pen: *mut *mut GpPen) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipCreatePen2(brush : *mut GpBrush, width : f32, unit : Unit, pen : *mut *mut GpPen) -> Status);
pub type GdipCreateRegion = unsafe extern "system" fn(region: *mut *mut GpRegion) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipCreateRegion(region : *mut *mut GpRegion) -> Status);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipCreateRegionHrgn = unsafe extern "system" fn(hrgn: super::Gdi::HRGN, region: *mut *mut GpRegion) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdiplus.dll" "system" fn GdipCreateRegionHrgn(hrgn : super::Gdi::HRGN, region : *mut *mut GpRegion) -> Status);
pub type GdipCreateRegionPath = unsafe extern "system" fn(path: *mut GpPath, region: *mut *mut GpRegion) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipCreateRegionPath(path : *mut GpPath, region : *mut *mut GpRegion) -> Status);
pub type GdipCreateRegionRect = unsafe extern "system" fn(rect: *const RectF, region: *mut *mut GpRegion) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipCreateRegionRect(rect : *const RectF, region : *mut *mut GpRegion) -> Status);
pub type GdipCreateRegionRectI = unsafe extern "system" fn(rect: *const Rect, region: *mut *mut GpRegion) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipCreateRegionRectI(rect : *const Rect, region : *mut *mut GpRegion) -> Status);
pub type GdipCreateRegionRgnData = unsafe extern "system" fn(regiondata: *const u8, size: i32, region: *mut *mut GpRegion) -> Status;
...
pub type GdipCreateSolidFill = unsafe extern "system" fn(color: u32, brush: *mut *mut GpSolidFill) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipCreateSolidFill(color : u32, brush : *mut *mut GpSolidFill) -> Status);
#[cfg(feature = "Win32_System_Com")]
pub type GdipCreateStreamOnFile = unsafe extern "system" fn(filename: windows_sys::core::PCWSTR, access: u32, stream: *mut *mut core::ffi::c_void) -> Status;
#[cfg(feature = "Win32_System_Com")]
...
pub type GdipCreateStringFormat = unsafe extern "system" fn(formatattributes: i32, language: u16, format: *mut *mut GpStringFormat) -> Status;
...
pub type GdipCreateTexture = unsafe extern "system" fn(image: *mut GpImage, wrapmode: WrapMode, texture: *mut *mut GpTexture) -> Status;
...
pub type GdipCreateTexture2 = unsafe extern "system" fn(image: *mut GpImage, wrapmode: WrapMode, x: f32, y: f32, width: f32, height: f32, texture: *mut *mut GpTexture) -> Status;
...
pub type GdipCreateTexture2I = unsafe extern "system" fn(image: *mut GpImage, wrapmode: WrapMode, x: i32, y: i32, width: i32, height: i32, texture: *mut *mut GpTexture) -> Status;
...
pub type GdipCreateTextureIA = unsafe extern "system" fn(image: *mut GpImage, imageattributes: *const GpImageAttributes, x: f32, y: f32, width: f32, height: f32, texture: *mut *mut GpTexture) -> Status;
...
pub type GdipCreateTextureIAI = unsafe extern "system" fn(image: *mut GpImage, imageattributes: *const GpImageAttributes, x: i32, y: i32, width: i32, height: i32, texture: *mut *mut GpTexture) -> Status;
...
pub type GdipDeleteBrush = unsafe extern "system" fn(brush: *mut GpBrush) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDeleteBrush(brush : *mut GpBrush) -> Status);
pub type GdipDeleteCachedBitmap = unsafe extern "system" fn(cachedbitmap: *mut GpCachedBitmap) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDeleteCachedBitmap(cachedbitmap : *mut GpCachedBitmap) -> Status);
pub type GdipDeleteCustomLineCap = unsafe extern "system" fn(customcap: *mut GpCustomLineCap) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDeleteCustomLineCap(customcap : *mut GpCustomLineCap) -> Status);
pub type GdipDeleteEffect = unsafe extern "system" fn(effect: *mut CGpEffect) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDeleteEffect(effect : *mut CGpEffect) -> Status);
pub type GdipDeleteFont = unsafe extern "system" fn(font: *mut GpFont) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDeleteFont(font : *mut GpFont) -> Status);
pub type GdipDeleteFontFamily = unsafe extern "system" fn(fontfamily: *mut GpFontFamily) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDeleteFontFamily(fontfamily : *mut GpFontFamily) -> Status);
pub type GdipDeleteGraphics = unsafe extern "system" fn(graphics: *mut GpGraphics) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDeleteGraphics(graphics : *mut GpGraphics) -> Status);
pub type GdipDeleteMatrix = unsafe extern "system" fn(matrix: *mut Matrix) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDeleteMatrix(matrix : *mut Matrix) -> Status);
pub type GdipDeletePath = unsafe extern "system" fn(path: *mut GpPath) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDeletePath(path : *mut GpPath) -> Status);
pub type GdipDeletePathIter = unsafe extern "system" fn(iterator: *mut GpPathIterator) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDeletePathIter(iterator : *mut GpPathIterator) -> Status);
pub type GdipDeletePen = unsafe extern "system" fn(pen: *mut GpPen) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDeletePen(pen : *mut GpPen) -> Status);
pub type GdipDeletePrivateFontCollection = unsafe extern "system" fn(fontcollection: *mut *mut GpFontCollection) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDeletePrivateFontCollection(fontcollection : *mut *mut GpFontCollection) -> Status);
pub type GdipDeleteRegion = unsafe extern "system" fn(region: *mut GpRegion) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDeleteRegion(region : *mut GpRegion) -> Status);
pub type GdipDeleteStringFormat = unsafe extern "system" fn(format: *mut GpStringFormat) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDeleteStringFormat(format : *mut GpStringFormat) -> Status);
pub type GdipDisposeImage = unsafe extern "system" fn(image: *mut GpImage) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDisposeImage(image : *mut GpImage) -> Status);
pub type GdipDisposeImageAttributes = unsafe extern "system" fn(imageattr: *mut GpImageAttributes) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDisposeImageAttributes(imageattr : *mut GpImageAttributes) -> Status);
pub type GdipDrawArc = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, x: f32, y: f32, width: f32, height: f32, startangle: f32, sweepangle: f32) -> Status;
...
pub type GdipDrawArcI = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, x: i32, y: i32, width: i32, height: i32, startangle: f32, sweepangle: f32) -> Status;
...
pub type GdipDrawBezier = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, x1: f32, y1: f32, x2: f32, y2: f32, x3: f32, y3: f32, x4: f32, y4: f32) -> Status;
...
pub type GdipDrawBezierI = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, x1: i32, y1: i32, x2: i32, y2: i32, x3: i32, y3: i32, x4: i32, y4: i32) -> Status;
...
pub type GdipDrawBeziers = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, points: *const PointF, count: i32) -> Status;
...
pub type GdipDrawBeziersI = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, points: *const Point, count: i32) -> Status;
...
pub type GdipDrawCachedBitmap = unsafe extern "system" fn(graphics: *mut GpGraphics, cachedbitmap: *mut GpCachedBitmap, x: i32, y: i32) -> Status;
...
pub type GdipDrawClosedCurve = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, points: *const PointF, count: i32) -> Status;
...
pub type GdipDrawClosedCurve2 = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, points: *const PointF, count: i32, tension: f32) -> Status;
...
pub type GdipDrawClosedCurve2I = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, points: *const Point, count: i32, tension: f32) -> Status;
...
pub type GdipDrawClosedCurveI = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, points: *const Point, count: i32) -> Status;
...
pub type GdipDrawCurve = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, points: *const PointF, count: i32) -> Status;
...
pub type GdipDrawCurve2 = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, points: *const PointF, count: i32, tension: f32) -> Status;
...
pub type GdipDrawCurve2I = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, points: *const Point, count: i32, tension: f32) -> Status;
...
pub type GdipDrawCurve3 = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, points: *const PointF, count: i32, offset: i32, numberofsegments: i32, tension: f32) -> Status;
...
pub type GdipDrawCurve3I = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, points: *const Point, count: i32, offset: i32, numberofsegments: i32, tension: f32) -> Status;
...
pub type GdipDrawCurveI = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, points: *const Point, count: i32) -> Status;
...
pub type GdipDrawDriverString = unsafe extern "system" fn(graphics: *mut GpGraphics, text: *const u16, length: i32, font: *const GpFont, brush: *const GpBrush, positions: *const PointF, flags: i32, matrix: *const Matrix) -> Status;
...
pub type GdipDrawEllipse = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, x: f32, y: f32, width: f32, height: f32) -> Status;
...
pub type GdipDrawEllipseI = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, x: i32, y: i32, width: i32, height: i32) -> Status;
...
pub type GdipDrawImage = unsafe extern "system" fn(graphics: *mut GpGraphics, image: *mut GpImage, x: f32, y: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDrawImage(graphics : *mut GpGraphics, image : *mut GpImage, x : f32, y : f32) -> Status);
pub type GdipDrawImageFX = unsafe extern "system" fn(graphics: *mut GpGraphics, image: *mut GpImage, source: *mut RectF, xform: *mut Matrix, effect: *mut CGpEffect, imageattributes: *mut GpImageAttributes, srcunit: Unit) -> Status;
...
pub type GdipDrawImageI = unsafe extern "system" fn(graphics: *mut GpGraphics, image: *mut GpImage, x: i32, y: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDrawImageI(graphics : *mut GpGraphics, image : *mut GpImage, x : i32, y : i32) -> Status);
pub type GdipDrawImagePointRect = unsafe extern "system" fn(graphics: *mut GpGraphics, image: *mut GpImage, x: f32, y: f32, srcx: f32, srcy: f32, srcwidth: f32, srcheight: f32, srcunit: Unit) -> Status;
...
pub type GdipDrawImagePointRectI = unsafe extern "system" fn(graphics: *mut GpGraphics, image: *mut GpImage, x: i32, y: i32, srcx: i32, srcy: i32, srcwidth: i32, srcheight: i32, srcunit: Unit) -> Status;
...
pub type GdipDrawImagePoints = unsafe extern "system" fn(graphics: *mut GpGraphics, image: *mut GpImage, dstpoints: *const PointF, count: i32) -> Status;
...
pub type GdipDrawImagePointsI = unsafe extern "system" fn(graphics: *mut GpGraphics, image: *mut GpImage, dstpoints: *const Point, count: i32) -> Status;
...
pub type GdipDrawImagePointsRect = unsafe extern "system" fn(graphics: *mut GpGraphics, image: *mut GpImage, points: *const PointF, count: i32, srcx: f32, srcy: f32, srcwidth: f32, srcheight: f32, srcunit: Unit, imageattributes: *const GpImageAttributes, callback: isize, callbackdata: *mut core::ffi::c_void) -> Status;
...
pub type GdipDrawImagePointsRectI = unsafe extern "system" fn(graphics: *mut GpGraphics, image: *mut GpImage, points: *const Point, count: i32, srcx: i32, srcy: i32, srcwidth: i32, srcheight: i32, srcunit: Unit, imageattributes: *const GpImageAttributes, callback: isize, callbackdata: *mut core::ffi::c_void) -> Status;
...
pub type GdipDrawImageRect = unsafe extern "system" fn(graphics: *mut GpGraphics, image: *mut GpImage, x: f32, y: f32, width: f32, height: f32) -> Status;
...
pub type GdipDrawImageRectI = unsafe extern "system" fn(graphics: *mut GpGraphics, image: *mut GpImage, x: i32, y: i32, width: i32, height: i32) -> Status;
...
pub type GdipDrawImageRectRect = unsafe extern "system" fn(graphics: *mut GpGraphics, image: *mut GpImage, dstx: f32, dsty: f32, dstwidth: f32, dstheight: f32, srcx: f32, srcy: f32, srcwidth: f32, srcheight: f32, srcunit: Unit, imageattributes: *const GpImageAttributes, callback: isize, callbackdata: *mut core::ffi::c_void) -> Status;
...
pub type GdipDrawImageRectRectI = unsafe extern "system" fn(graphics: *mut GpGraphics, image: *mut GpImage, dstx: i32, dsty: i32, dstwidth: i32, dstheight: i32, srcx: i32, srcy: i32, srcwidth: i32, srcheight: i32, srcunit: Unit, imageattributes: *const GpImageAttributes, callback: isize, callbackdata: *mut core::ffi::c_void) -> Status;
...
pub type GdipDrawLine = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, x1: f32, y1: f32, x2: f32, y2: f32) -> Status;
...
pub type GdipDrawLineI = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, x1: i32, y1: i32, x2: i32, y2: i32) -> Status;
...
pub type GdipDrawLines = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, points: *const PointF, count: i32) -> Status;
...
pub type GdipDrawLinesI = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, points: *const Point, count: i32) -> Status;
...
pub type GdipDrawPath = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, path: *mut GpPath) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipDrawPath(graphics : *mut GpGraphics, pen : *mut GpPen, path : *mut GpPath) -> Status);
pub type GdipDrawPie = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, x: f32, y: f32, width: f32, height: f32, startangle: f32, sweepangle: f32) -> Status;
...
pub type GdipDrawPieI = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, x: i32, y: i32, width: i32, height: i32, startangle: f32, sweepangle: f32) -> Status;
...
pub type GdipDrawPolygon = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, points: *const PointF, count: i32) -> Status;
...
pub type GdipDrawPolygonI = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, points: *const Point, count: i32) -> Status;
...
pub type GdipDrawRectangle = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, x: f32, y: f32, width: f32, height: f32) -> Status;
...
pub type GdipDrawRectangleI = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, x: i32, y: i32, width: i32, height: i32) -> Status;
...
pub type GdipDrawRectangles = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, rects: *const RectF, count: i32) -> Status;
...
pub type GdipDrawRectanglesI = unsafe extern "system" fn(graphics: *mut GpGraphics, pen: *mut GpPen, rects: *const Rect, count: i32) -> Status;
...
pub type GdipDrawString = unsafe extern "system" fn(graphics: *mut GpGraphics, string: windows_sys::core::PCWSTR, length: i32, font: *const GpFont, layoutrect: *const RectF, stringformat: *const GpStringFormat, brush: *const GpBrush) -> Status;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipEmfToWmfBits = unsafe extern "system" fn(hemf: super::Gdi::HENHMETAFILE, cbdata16: u32, pdata16: *mut u8, imapmode: i32, eflags: i32) -> u32;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GdipEndContainer = unsafe extern "system" fn(graphics: *mut GpGraphics, state: u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipEndContainer(graphics : *mut GpGraphics, state : u32) -> Status);
pub type GdipEnumerateMetafileDestPoint = unsafe extern "system" fn(graphics: *mut GpGraphics, metafile: *const GpMetafile, destpoint: *const PointF, callback: isize, callbackdata: *mut core::ffi::c_void, imageattributes: *const GpImageAttributes) -> Status;
...
pub type GdipEnumerateMetafileDestPointI = unsafe extern "system" fn(graphics: *mut GpGraphics, metafile: *const GpMetafile, destpoint: *const Point, callback: isize, callbackdata: *mut core::ffi::c_void, imageattributes: *const GpImageAttributes) -> Status;
...
pub type GdipEnumerateMetafileDestPoints = unsafe extern "system" fn(graphics: *mut GpGraphics, metafile: *const GpMetafile, destpoints: *const PointF, count: i32, callback: isize, callbackdata: *mut core::ffi::c_void, imageattributes: *const GpImageAttributes) -> Status;
...
pub type GdipEnumerateMetafileDestPointsI = unsafe extern "system" fn(graphics: *mut GpGraphics, metafile: *const GpMetafile, destpoints: *const Point, count: i32, callback: isize, callbackdata: *mut core::ffi::c_void, imageattributes: *const GpImageAttributes) -> Status;
...
pub type GdipEnumerateMetafileDestRect = unsafe extern "system" fn(graphics: *mut GpGraphics, metafile: *const GpMetafile, destrect: *const RectF, callback: isize, callbackdata: *mut core::ffi::c_void, imageattributes: *const GpImageAttributes) -> Status;
...
pub type GdipEnumerateMetafileDestRectI = unsafe extern "system" fn(graphics: *mut GpGraphics, metafile: *const GpMetafile, destrect: *const Rect, callback: isize, callbackdata: *mut core::ffi::c_void, imageattributes: *const GpImageAttributes) -> Status;
...
pub type GdipEnumerateMetafileSrcRectDestPoint = unsafe extern "system" fn(graphics: *mut GpGraphics, metafile: *const GpMetafile, destpoint: *const PointF, srcrect: *const RectF, srcunit: Unit, callback: isize, callbackdata: *mut core::ffi::c_void, imageattributes: *const GpImageAttributes) -> Status;
...
pub type GdipEnumerateMetafileSrcRectDestPointI = unsafe extern "system" fn(graphics: *mut GpGraphics, metafile: *const GpMetafile, destpoint: *const Point, srcrect: *const Rect, srcunit: Unit, callback: isize, callbackdata: *mut core::ffi::c_void, imageattributes: *const GpImageAttributes) -> Status;
...
pub type GdipEnumerateMetafileSrcRectDestPoints = unsafe extern "system" fn(graphics: *mut GpGraphics, metafile: *const GpMetafile, destpoints: *const PointF, count: i32, srcrect: *const RectF, srcunit: Unit, callback: isize, callbackdata: *mut core::ffi::c_void, imageattributes: *const GpImageAttributes) -> Status;
...
pub type GdipEnumerateMetafileSrcRectDestPointsI = unsafe extern "system" fn(graphics: *mut GpGraphics, metafile: *const GpMetafile, destpoints: *const Point, count: i32, srcrect: *const Rect, srcunit: Unit, callback: isize, callbackdata: *mut core::ffi::c_void, imageattributes: *const GpImageAttributes) -> Status;
...
pub type GdipEnumerateMetafileSrcRectDestRect = unsafe extern "system" fn(graphics: *mut GpGraphics, metafile: *const GpMetafile, destrect: *const RectF, srcrect: *const RectF, srcunit: Unit, callback: isize, callbackdata: *mut core::ffi::c_void, imageattributes: *const GpImageAttributes) -> Status;
...
pub type GdipEnumerateMetafileSrcRectDestRectI = unsafe extern "system" fn(graphics: *mut GpGraphics, metafile: *const GpMetafile, destrect: *const Rect, srcrect: *const Rect, srcunit: Unit, callback: isize, callbackdata: *mut core::ffi::c_void, imageattributes: *const GpImageAttributes) -> Status;
...
pub type GdipFillClosedCurve = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, points: *const PointF, count: i32) -> Status;
...
pub type GdipFillClosedCurve2 = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, points: *const PointF, count: i32, tension: f32, fillmode: FillMode) -> Status;
...
pub type GdipFillClosedCurve2I = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, points: *const Point, count: i32, tension: f32, fillmode: FillMode) -> Status;
...
pub type GdipFillClosedCurveI = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, points: *const Point, count: i32) -> Status;
...
pub type GdipFillEllipse = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, x: f32, y: f32, width: f32, height: f32) -> Status;
...
pub type GdipFillEllipseI = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, x: i32, y: i32, width: i32, height: i32) -> Status;
...
pub type GdipFillPath = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, path: *mut GpPath) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipFillPath(graphics : *mut GpGraphics, brush : *mut GpBrush, path : *mut GpPath) -> Status);
pub type GdipFillPie = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, x: f32, y: f32, width: f32, height: f32, startangle: f32, sweepangle: f32) -> Status;
...
pub type GdipFillPieI = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, x: i32, y: i32, width: i32, height: i32, startangle: f32, sweepangle: f32) -> Status;
...
pub type GdipFillPolygon = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, points: *const PointF, count: i32, fillmode: FillMode) -> Status;
...
pub type GdipFillPolygon2 = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, points: *const PointF, count: i32) -> Status;
...
pub type GdipFillPolygon2I = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, points: *const Point, count: i32) -> Status;
...
pub type GdipFillPolygonI = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, points: *const Point, count: i32, fillmode: FillMode) -> Status;
...
pub type GdipFillRectangle = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, x: f32, y: f32, width: f32, height: f32) -> Status;
...
pub type GdipFillRectangleI = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, x: i32, y: i32, width: i32, height: i32) -> Status;
...
pub type GdipFillRectangles = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, rects: *const RectF, count: i32) -> Status;
...
pub type GdipFillRectanglesI = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, rects: *const Rect, count: i32) -> Status;
...
pub type GdipFillRegion = unsafe extern "system" fn(graphics: *mut GpGraphics, brush: *mut GpBrush, region: *mut GpRegion) -> Status;
...
pub type GdipFindFirstImageItem = unsafe extern "system" fn(image: *mut GpImage, item: *mut ImageItemData) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipFindFirstImageItem(image : *mut GpImage, item : *mut ImageItemData) -> Status);
pub type GdipFindNextImageItem = unsafe extern "system" fn(image: *mut GpImage, item: *mut ImageItemData) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipFindNextImageItem(image : *mut GpImage, item : *mut ImageItemData) -> Status);
pub type GdipFlattenPath = unsafe extern "system" fn(path: *mut GpPath, matrix: *mut Matrix, flatness: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipFlattenPath(path : *mut GpPath, matrix : *mut Matrix, flatness : f32) -> Status);
pub type GdipFlush = unsafe extern "system" fn(graphics: *mut GpGraphics, intention: FlushIntention) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipFlush(graphics : *mut GpGraphics, intention : FlushIntention) -> Status);
pub type GdipFree = unsafe extern "system" fn(ptr: *mut core::ffi::c_void);
windows_link::link!("gdiplus.dll" "system" fn GdipFree(ptr : *mut core::ffi::c_void));
pub type GdipGetAdjustableArrowCapFillState = unsafe extern "system" fn(cap: *mut GpAdjustableArrowCap, fillstate: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipGetAdjustableArrowCapHeight = unsafe extern "system" fn(cap: *mut GpAdjustableArrowCap, height: *mut f32) -> Status;
...
pub type GdipGetAdjustableArrowCapMiddleInset = unsafe extern "system" fn(cap: *mut GpAdjustableArrowCap, middleinset: *mut f32) -> Status;
...
pub type GdipGetAdjustableArrowCapWidth = unsafe extern "system" fn(cap: *mut GpAdjustableArrowCap, width: *mut f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetAdjustableArrowCapWidth(cap : *mut GpAdjustableArrowCap, width : *mut f32) -> Status);
pub type GdipGetAllPropertyItems = unsafe extern "system" fn(image: *mut GpImage, totalbuffersize: u32, numproperties: u32, allitems: *mut PropertyItem) -> Status;
...
pub type GdipGetBrushType = unsafe extern "system" fn(brush: *mut GpBrush, r#type: *mut BrushType) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetBrushType(brush : *mut GpBrush, r#type : *mut BrushType) -> Status);
pub type GdipGetCellAscent = unsafe extern "system" fn(family: *const GpFontFamily, style: i32, cellascent: *mut u16) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetCellAscent(family : *const GpFontFamily, style : i32, cellascent : *mut u16) -> Status);
pub type GdipGetCellDescent = unsafe extern "system" fn(family: *const GpFontFamily, style: i32, celldescent: *mut u16) -> Status;
...
pub type GdipGetClip = unsafe extern "system" fn(graphics: *mut GpGraphics, region: *mut GpRegion) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetClip(graphics : *mut GpGraphics, region : *mut GpRegion) -> Status);
pub type GdipGetClipBounds = unsafe extern "system" fn(graphics: *mut GpGraphics, rect: *mut RectF) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetClipBounds(graphics : *mut GpGraphics, rect : *mut RectF) -> Status);
pub type GdipGetClipBoundsI = unsafe extern "system" fn(graphics: *mut GpGraphics, rect: *mut Rect) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetClipBoundsI(graphics : *mut GpGraphics, rect : *mut Rect) -> Status);
pub type GdipGetCompositingMode = unsafe extern "system" fn(graphics: *mut GpGraphics, compositingmode: *mut CompositingMode) -> Status;
...
pub type GdipGetCompositingQuality = unsafe extern "system" fn(graphics: *mut GpGraphics, compositingquality: *mut CompositingQuality) -> Status;
...
pub type GdipGetCustomLineCapBaseCap = unsafe extern "system" fn(customcap: *mut GpCustomLineCap, basecap: *mut LineCap) -> Status;
...
pub type GdipGetCustomLineCapBaseInset = unsafe extern "system" fn(customcap: *mut GpCustomLineCap, inset: *mut f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetCustomLineCapBaseInset(customcap : *mut GpCustomLineCap, inset : *mut f32) -> Status);
pub type GdipGetCustomLineCapStrokeCaps = unsafe extern "system" fn(customcap: *mut GpCustomLineCap, startcap: *mut LineCap, endcap: *mut LineCap) -> Status;
...
pub type GdipGetCustomLineCapStrokeJoin = unsafe extern "system" fn(customcap: *mut GpCustomLineCap, linejoin: *mut LineJoin) -> Status;
...
pub type GdipGetCustomLineCapType = unsafe extern "system" fn(customcap: *mut GpCustomLineCap, captype: *mut CustomLineCapType) -> Status;
...
pub type GdipGetCustomLineCapWidthScale = unsafe extern "system" fn(customcap: *mut GpCustomLineCap, widthscale: *mut f32) -> Status;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipGetDC = unsafe extern "system" fn(graphics: *mut GpGraphics, hdc: *mut super::Gdi::HDC) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdiplus.dll" "system" fn GdipGetDC(graphics : *mut GpGraphics, hdc : *mut super::Gdi::HDC) -> Status);
pub type GdipGetDpiX = unsafe extern "system" fn(graphics: *mut GpGraphics, dpi: *mut f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetDpiX(graphics : *mut GpGraphics, dpi : *mut f32) -> Status);
pub type GdipGetDpiY = unsafe extern "system" fn(graphics: *mut GpGraphics, dpi: *mut f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetDpiY(graphics : *mut GpGraphics, dpi : *mut f32) -> Status);
pub type GdipGetEffectParameterSize = unsafe extern "system" fn(effect: *mut CGpEffect, size: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetEffectParameterSize(effect : *mut CGpEffect, size : *mut u32) -> Status);
pub type GdipGetEffectParameters = unsafe extern "system" fn(effect: *mut CGpEffect, size: *mut u32, params: *mut core::ffi::c_void) -> Status;
...
pub type GdipGetEmHeight = unsafe extern "system" fn(family: *const GpFontFamily, style: i32, emheight: *mut u16) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetEmHeight(family : *const GpFontFamily, style : i32, emheight : *mut u16) -> Status);
pub type GdipGetEncoderParameterList = unsafe extern "system" fn(image: *mut GpImage, clsidencoder: *const windows_sys::core::GUID, size: u32, buffer: *mut EncoderParameters) -> Status;
...
pub type GdipGetEncoderParameterListSize = unsafe extern "system" fn(image: *mut GpImage, clsidencoder: *const windows_sys::core::GUID, size: *mut u32) -> Status;
...
pub type GdipGetFamily = unsafe extern "system" fn(font: *mut GpFont, family: *mut *mut GpFontFamily) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetFamily(font : *mut GpFont, family : *mut *mut GpFontFamily) -> Status);
pub type GdipGetFamilyName = unsafe extern "system" fn(family: *const GpFontFamily, name: windows_sys::core::PWSTR, language: u16) -> Status;
...
pub type GdipGetFontCollectionFamilyCount = unsafe extern "system" fn(fontcollection: *mut GpFontCollection, numfound: *mut i32) -> Status;
...
pub type GdipGetFontCollectionFamilyList = unsafe extern "system" fn(fontcollection: *const GpFontCollection, numsought: i32, gpfamilies: *mut *mut GpFontFamily, numfound: *mut i32) -> Status;
...
pub type GdipGetFontHeight = unsafe extern "system" fn(font: *const GpFont, graphics: *const GpGraphics, height: *mut f32) -> Status;
...
pub type GdipGetFontHeightGivenDPI = unsafe extern "system" fn(font: *const GpFont, dpi: f32, height: *mut f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetFontHeightGivenDPI(font : *const GpFont, dpi : f32, height : *mut f32) -> Status);
pub type GdipGetFontSize = unsafe extern "system" fn(font: *mut GpFont, size: *mut f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetFontSize(font : *mut GpFont, size : *mut f32) -> Status);
pub type GdipGetFontStyle = unsafe extern "system" fn(font: *mut GpFont, style: *mut i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetFontStyle(font : *mut GpFont, style : *mut i32) -> Status);
pub type GdipGetFontUnit = unsafe extern "system" fn(font: *mut GpFont, unit: *mut Unit) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetFontUnit(font : *mut GpFont, unit : *mut Unit) -> Status);
pub type GdipGetGenericFontFamilyMonospace = unsafe extern "system" fn(nativefamily: *mut *mut GpFontFamily) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetGenericFontFamilyMonospace(nativefamily : *mut *mut GpFontFamily) -> Status);
pub type GdipGetGenericFontFamilySansSerif = unsafe extern "system" fn(nativefamily: *mut *mut GpFontFamily) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetGenericFontFamilySansSerif(nativefamily : *mut *mut GpFontFamily) -> Status);
pub type GdipGetGenericFontFamilySerif = unsafe extern "system" fn(nativefamily: *mut *mut GpFontFamily) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetGenericFontFamilySerif(nativefamily : *mut *mut GpFontFamily) -> Status);
pub type GdipGetHatchBackgroundColor = unsafe extern "system" fn(brush: *mut GpHatch, backcol: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetHatchBackgroundColor(brush : *mut GpHatch, backcol : *mut u32) -> Status);
pub type GdipGetHatchForegroundColor = unsafe extern "system" fn(brush: *mut GpHatch, forecol: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetHatchForegroundColor(brush : *mut GpHatch, forecol : *mut u32) -> Status);
pub type GdipGetHatchStyle = unsafe extern "system" fn(brush: *mut GpHatch, hatchstyle: *mut HatchStyle) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetHatchStyle(brush : *mut GpHatch, hatchstyle : *mut HatchStyle) -> Status);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipGetHemfFromMetafile = unsafe extern "system" fn(metafile: *mut GpMetafile, hemf: *mut super::Gdi::HENHMETAFILE) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GdipGetImageAttributesAdjustedPalette = unsafe extern "system" fn(imageattr: *mut GpImageAttributes, colorpalette: *mut ColorPalette, coloradjusttype: ColorAdjustType) -> Status;
...
pub type GdipGetImageBounds = unsafe extern "system" fn(image: *mut GpImage, srcrect: *mut RectF, srcunit: *mut Unit) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImageBounds(image : *mut GpImage, srcrect : *mut RectF, srcunit : *mut Unit) -> Status);
pub type GdipGetImageDecoders = unsafe extern "system" fn(numdecoders: u32, size: u32, decoders: *mut ImageCodecInfo) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImageDecoders(numdecoders : u32, size : u32, decoders : *mut ImageCodecInfo) -> Status);
pub type GdipGetImageDecodersSize = unsafe extern "system" fn(numdecoders: *mut u32, size: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImageDecodersSize(numdecoders : *mut u32, size : *mut u32) -> Status);
pub type GdipGetImageDimension = unsafe extern "system" fn(image: *mut GpImage, width: *mut f32, height: *mut f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImageDimension(image : *mut GpImage, width : *mut f32, height : *mut f32) -> Status);
pub type GdipGetImageEncoders = unsafe extern "system" fn(numencoders: u32, size: u32, encoders: *mut ImageCodecInfo) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImageEncoders(numencoders : u32, size : u32, encoders : *mut ImageCodecInfo) -> Status);
pub type GdipGetImageEncodersSize = unsafe extern "system" fn(numencoders: *mut u32, size: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImageEncodersSize(numencoders : *mut u32, size : *mut u32) -> Status);
pub type GdipGetImageFlags = unsafe extern "system" fn(image: *mut GpImage, flags: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImageFlags(image : *mut GpImage, flags : *mut u32) -> Status);
pub type GdipGetImageGraphicsContext = unsafe extern "system" fn(image: *mut GpImage, graphics: *mut *mut GpGraphics) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImageGraphicsContext(image : *mut GpImage, graphics : *mut *mut GpGraphics) -> Status);
pub type GdipGetImageHeight = unsafe extern "system" fn(image: *mut GpImage, height: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImageHeight(image : *mut GpImage, height : *mut u32) -> Status);
pub type GdipGetImageHorizontalResolution = unsafe extern "system" fn(image: *mut GpImage, resolution: *mut f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImageHorizontalResolution(image : *mut GpImage, resolution : *mut f32) -> Status);
pub type GdipGetImageItemData = unsafe extern "system" fn(image: *mut GpImage, item: *mut ImageItemData) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImageItemData(image : *mut GpImage, item : *mut ImageItemData) -> Status);
pub type GdipGetImagePalette = unsafe extern "system" fn(image: *mut GpImage, palette: *mut ColorPalette, size: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImagePalette(image : *mut GpImage, palette : *mut ColorPalette, size : i32) -> Status);
pub type GdipGetImagePaletteSize = unsafe extern "system" fn(image: *mut GpImage, size: *mut i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImagePaletteSize(image : *mut GpImage, size : *mut i32) -> Status);
pub type GdipGetImagePixelFormat = unsafe extern "system" fn(image: *mut GpImage, format: *mut i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImagePixelFormat(image : *mut GpImage, format : *mut i32) -> Status);
pub type GdipGetImageRawFormat = unsafe extern "system" fn(image: *mut GpImage, format: *mut windows_sys::core::GUID) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImageRawFormat(image : *mut GpImage, format : *mut windows_sys::core::GUID) -> Status);
pub type GdipGetImageThumbnail = unsafe extern "system" fn(image: *mut GpImage, thumbwidth: u32, thumbheight: u32, thumbimage: *mut *mut GpImage, callback: isize, callbackdata: *mut core::ffi::c_void) -> Status;
...
pub type GdipGetImageType = unsafe extern "system" fn(image: *mut GpImage, r#type: *mut ImageType) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImageType(image : *mut GpImage, r#type : *mut ImageType) -> Status);
pub type GdipGetImageVerticalResolution = unsafe extern "system" fn(image: *mut GpImage, resolution: *mut f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImageVerticalResolution(image : *mut GpImage, resolution : *mut f32) -> Status);
pub type GdipGetImageWidth = unsafe extern "system" fn(image: *mut GpImage, width: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetImageWidth(image : *mut GpImage, width : *mut u32) -> Status);
pub type GdipGetInterpolationMode = unsafe extern "system" fn(graphics: *mut GpGraphics, interpolationmode: *mut InterpolationMode) -> Status;
...
pub type GdipGetLineBlend = unsafe extern "system" fn(brush: *mut GpLineGradient, blend: *mut f32, positions: *mut f32, count: i32) -> Status;
...
pub type GdipGetLineBlendCount = unsafe extern "system" fn(brush: *mut GpLineGradient, count: *mut i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetLineBlendCount(brush : *mut GpLineGradient, count : *mut i32) -> Status);
pub type GdipGetLineColors = unsafe extern "system" fn(brush: *mut GpLineGradient, colors: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetLineColors(brush : *mut GpLineGradient, colors : *mut u32) -> Status);
pub type GdipGetLineGammaCorrection = unsafe extern "system" fn(brush: *mut GpLineGradient, usegammacorrection: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipGetLinePresetBlend = unsafe extern "system" fn(brush: *mut GpLineGradient, blend: *mut u32, positions: *mut f32, count: i32) -> Status;
...
pub type GdipGetLinePresetBlendCount = unsafe extern "system" fn(brush: *mut GpLineGradient, count: *mut i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetLinePresetBlendCount(brush : *mut GpLineGradient, count : *mut i32) -> Status);
pub type GdipGetLineRect = unsafe extern "system" fn(brush: *mut GpLineGradient, rect: *mut RectF) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetLineRect(brush : *mut GpLineGradient, rect : *mut RectF) -> Status);
pub type GdipGetLineRectI = unsafe extern "system" fn(brush: *mut GpLineGradient, rect: *mut Rect) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetLineRectI(brush : *mut GpLineGradient, rect : *mut Rect) -> Status);
pub type GdipGetLineSpacing = unsafe extern "system" fn(family: *const GpFontFamily, style: i32, linespacing: *mut u16) -> Status;
...
pub type GdipGetLineTransform = unsafe extern "system" fn(brush: *mut GpLineGradient, matrix: *mut Matrix) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetLineTransform(brush : *mut GpLineGradient, matrix : *mut Matrix) -> Status);
pub type GdipGetLineWrapMode = unsafe extern "system" fn(brush: *mut GpLineGradient, wrapmode: *mut WrapMode) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetLineWrapMode(brush : *mut GpLineGradient, wrapmode : *mut WrapMode) -> Status);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipGetLogFontA = unsafe extern "system" fn(font: *mut GpFont, graphics: *mut GpGraphics, logfonta: *mut super::Gdi::LOGFONTA) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipGetLogFontW = unsafe extern "system" fn(font: *mut GpFont, graphics: *mut GpGraphics, logfontw: *mut super::Gdi::LOGFONTW) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GdipGetMatrixElements = unsafe extern "system" fn(matrix: *const Matrix, matrixout: *mut f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetMatrixElements(matrix : *const Matrix, matrixout : *mut f32) -> Status);
pub type GdipGetMetafileDownLevelRasterizationLimit = unsafe extern "system" fn(metafile: *const GpMetafile, metafilerasterizationlimitdpi: *mut u32) -> Status;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipGetMetafileHeaderFromEmf = unsafe extern "system" fn(hemf: super::Gdi::HENHMETAFILE, header: *mut MetafileHeader) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipGetMetafileHeaderFromFile = unsafe extern "system" fn(filename: windows_sys::core::PCWSTR, header: *mut MetafileHeader) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipGetMetafileHeaderFromMetafile = unsafe extern "system" fn(metafile: *mut GpMetafile, header: *mut MetafileHeader) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GdipGetMetafileHeaderFromStream = unsafe extern "system" fn(stream: *mut core::ffi::c_void, header: *mut MetafileHeader) -> Status;
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_System_Com"))]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipGetMetafileHeaderFromWmf = unsafe extern "system" fn(hwmf: super::Gdi::HMETAFILE, wmfplaceablefileheader: *const WmfPlaceableFileHeader, header: *mut MetafileHeader) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GdipGetNearestColor = unsafe extern "system" fn(graphics: *mut GpGraphics, argb: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetNearestColor(graphics : *mut GpGraphics, argb : *mut u32) -> Status);
pub type GdipGetPageScale = unsafe extern "system" fn(graphics: *mut GpGraphics, scale: *mut f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPageScale(graphics : *mut GpGraphics, scale : *mut f32) -> Status);
pub type GdipGetPageUnit = unsafe extern "system" fn(graphics: *mut GpGraphics, unit: *mut Unit) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPageUnit(graphics : *mut GpGraphics, unit : *mut Unit) -> Status);
pub type GdipGetPathData = unsafe extern "system" fn(path: *mut GpPath, pathdata: *mut PathData) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathData(path : *mut GpPath, pathdata : *mut PathData) -> Status);
pub type GdipGetPathFillMode = unsafe extern "system" fn(path: *mut GpPath, fillmode: *mut FillMode) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathFillMode(path : *mut GpPath, fillmode : *mut FillMode) -> Status);
pub type GdipGetPathGradientBlend = unsafe extern "system" fn(brush: *mut GpPathGradient, blend: *mut f32, positions: *mut f32, count: i32) -> Status;
...
pub type GdipGetPathGradientBlendCount = unsafe extern "system" fn(brush: *mut GpPathGradient, count: *mut i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathGradientBlendCount(brush : *mut GpPathGradient, count : *mut i32) -> Status);
pub type GdipGetPathGradientCenterColor = unsafe extern "system" fn(brush: *mut GpPathGradient, colors: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathGradientCenterColor(brush : *mut GpPathGradient, colors : *mut u32) -> Status);
pub type GdipGetPathGradientCenterPoint = unsafe extern "system" fn(brush: *mut GpPathGradient, points: *mut PointF) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathGradientCenterPoint(brush : *mut GpPathGradient, points : *mut PointF) -> Status);
pub type GdipGetPathGradientCenterPointI = unsafe extern "system" fn(brush: *mut GpPathGradient, points: *mut Point) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathGradientCenterPointI(brush : *mut GpPathGradient, points : *mut Point) -> Status);
pub type GdipGetPathGradientFocusScales = unsafe extern "system" fn(brush: *mut GpPathGradient, xscale: *mut f32, yscale: *mut f32) -> Status;
...
pub type GdipGetPathGradientGammaCorrection = unsafe extern "system" fn(brush: *mut GpPathGradient, usegammacorrection: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipGetPathGradientPath = unsafe extern "system" fn(brush: *mut GpPathGradient, path: *mut GpPath) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathGradientPath(brush : *mut GpPathGradient, path : *mut GpPath) -> Status);
pub type GdipGetPathGradientPointCount = unsafe extern "system" fn(brush: *mut GpPathGradient, count: *mut i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathGradientPointCount(brush : *mut GpPathGradient, count : *mut i32) -> Status);
pub type GdipGetPathGradientPresetBlend = unsafe extern "system" fn(brush: *mut GpPathGradient, blend: *mut u32, positions: *mut f32, count: i32) -> Status;
...
pub type GdipGetPathGradientPresetBlendCount = unsafe extern "system" fn(brush: *mut GpPathGradient, count: *mut i32) -> Status;
...
pub type GdipGetPathGradientRect = unsafe extern "system" fn(brush: *mut GpPathGradient, rect: *mut RectF) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathGradientRect(brush : *mut GpPathGradient, rect : *mut RectF) -> Status);
pub type GdipGetPathGradientRectI = unsafe extern "system" fn(brush: *mut GpPathGradient, rect: *mut Rect) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathGradientRectI(brush : *mut GpPathGradient, rect : *mut Rect) -> Status);
pub type GdipGetPathGradientSurroundColorCount = unsafe extern "system" fn(brush: *mut GpPathGradient, count: *mut i32) -> Status;
...
pub type GdipGetPathGradientSurroundColorsWithCount = unsafe extern "system" fn(brush: *const GpPathGradient, color: *mut u32, count: *mut i32) -> Status;
...
pub type GdipGetPathGradientTransform = unsafe extern "system" fn(brush: *mut GpPathGradient, matrix: *mut Matrix) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathGradientTransform(brush : *mut GpPathGradient, matrix : *mut Matrix) -> Status);
pub type GdipGetPathGradientWrapMode = unsafe extern "system" fn(brush: *mut GpPathGradient, wrapmode: *mut WrapMode) -> Status;
...
pub type GdipGetPathLastPoint = unsafe extern "system" fn(path: *mut GpPath, lastpoint: *mut PointF) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathLastPoint(path : *mut GpPath, lastpoint : *mut PointF) -> Status);
pub type GdipGetPathPoints = unsafe extern "system" fn(param0: *mut GpPath, points: *mut PointF, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathPoints(param0 : *mut GpPath, points : *mut PointF, count : i32) -> Status);
pub type GdipGetPathPointsI = unsafe extern "system" fn(param0: *mut GpPath, points: *mut Point, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathPointsI(param0 : *mut GpPath, points : *mut Point, count : i32) -> Status);
pub type GdipGetPathTypes = unsafe extern "system" fn(path: *const GpPath, types: *mut u8, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPathTypes(path : *const GpPath, types : *mut u8, count : i32) -> Status);
pub type GdipGetPathWorldBounds = unsafe extern "system" fn(path: *mut GpPath, bounds: *mut RectF, matrix: *const Matrix, pen: *const GpPen) -> Status;
...
pub type GdipGetPathWorldBoundsI = unsafe extern "system" fn(path: *mut GpPath, bounds: *mut Rect, matrix: *const Matrix, pen: *const GpPen) -> Status;
...
pub type GdipGetPointCount = unsafe extern "system" fn(path: *mut GpPath, count: *mut i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPointCount(path : *mut GpPath, count : *mut i32) -> Status);
pub type GdipGetPropertyCount = unsafe extern "system" fn(image: *mut GpImage, numofproperty: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPropertyCount(image : *mut GpImage, numofproperty : *mut u32) -> Status);
pub type GdipGetPropertyIdList = unsafe extern "system" fn(image: *mut GpImage, numofproperty: u32, list: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPropertyIdList(image : *mut GpImage, numofproperty : u32, list : *mut u32) -> Status);
pub type GdipGetPropertyItem = unsafe extern "system" fn(image: *mut GpImage, propid: u32, propsize: u32, buffer: *mut PropertyItem) -> Status;
...
pub type GdipGetPropertyItemSize = unsafe extern "system" fn(image: *mut GpImage, propid: u32, size: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetPropertyItemSize(image : *mut GpImage, propid : u32, size : *mut u32) -> Status);
pub type GdipGetPropertySize = unsafe extern "system" fn(image: *mut GpImage, totalbuffersize: *mut u32, numproperties: *mut u32) -> Status;
...
pub type GdipGetRegionBounds = unsafe extern "system" fn(region: *mut GpRegion, graphics: *mut GpGraphics, rect: *mut RectF) -> Status;
...
pub type GdipGetRegionBoundsI = unsafe extern "system" fn(region: *mut GpRegion, graphics: *mut GpGraphics, rect: *mut Rect) -> Status;
...
pub type GdipGetRegionData = unsafe extern "system" fn(region: *mut GpRegion, buffer: *mut u8, buffersize: u32, sizefilled: *mut u32) -> Status;
...
pub type GdipGetRegionDataSize = unsafe extern "system" fn(region: *mut GpRegion, buffersize: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetRegionDataSize(region : *mut GpRegion, buffersize : *mut u32) -> Status);
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipGetRegionHRgn = unsafe extern "system" fn(region: *mut GpRegion, graphics: *mut GpGraphics, hrgn: *mut super::Gdi::HRGN) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GdipGetRegionScans = unsafe extern "system" fn(region: *mut GpRegion, rects: *mut RectF, count: *mut i32, matrix: *mut Matrix) -> Status;
...
pub type GdipGetRegionScansCount = unsafe extern "system" fn(region: *mut GpRegion, count: *mut u32, matrix: *mut Matrix) -> Status;
...
pub type GdipGetRegionScansI = unsafe extern "system" fn(region: *mut GpRegion, rects: *mut Rect, count: *mut i32, matrix: *mut Matrix) -> Status;
...
pub type GdipGetRenderingOrigin = unsafe extern "system" fn(graphics: *mut GpGraphics, x: *mut i32, y: *mut i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetRenderingOrigin(graphics : *mut GpGraphics, x : *mut i32, y : *mut i32) -> Status);
pub type GdipGetSmoothingMode = unsafe extern "system" fn(graphics: *mut GpGraphics, smoothingmode: *mut SmoothingMode) -> Status;
...
pub type GdipGetSolidFillColor = unsafe extern "system" fn(brush: *mut GpSolidFill, color: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetSolidFillColor(brush : *mut GpSolidFill, color : *mut u32) -> Status);
pub type GdipGetStringFormatAlign = unsafe extern "system" fn(format: *const GpStringFormat, align: *mut StringAlignment) -> Status;
...
pub type GdipGetStringFormatDigitSubstitution = unsafe extern "system" fn(format: *const GpStringFormat, language: *mut u16, substitute: *mut StringDigitSubstitute) -> Status;
...
pub type GdipGetStringFormatFlags = unsafe extern "system" fn(format: *const GpStringFormat, flags: *mut i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetStringFormatFlags(format : *const GpStringFormat, flags : *mut i32) -> Status);
pub type GdipGetStringFormatHotkeyPrefix = unsafe extern "system" fn(format: *const GpStringFormat, hotkeyprefix: *mut i32) -> Status;
...
pub type GdipGetStringFormatLineAlign = unsafe extern "system" fn(format: *const GpStringFormat, align: *mut StringAlignment) -> Status;
...
pub type GdipGetStringFormatMeasurableCharacterRangeCount = unsafe extern "system" fn(format: *const GpStringFormat, count: *mut i32) -> Status;
...
pub type GdipGetStringFormatTabStopCount = unsafe extern "system" fn(format: *const GpStringFormat, count: *mut i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetStringFormatTabStopCount(format : *const GpStringFormat, count : *mut i32) -> Status);
pub type GdipGetStringFormatTabStops = unsafe extern "system" fn(format: *const GpStringFormat, count: i32, firsttaboffset: *mut f32, tabstops: *mut f32) -> Status;
...
pub type GdipGetStringFormatTrimming = unsafe extern "system" fn(format: *const GpStringFormat, trimming: *mut StringTrimming) -> Status;
...
pub type GdipGetTextContrast = unsafe extern "system" fn(graphics: *mut GpGraphics, contrast: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetTextContrast(graphics : *mut GpGraphics, contrast : *mut u32) -> Status);
pub type GdipGetTextRenderingHint = unsafe extern "system" fn(graphics: *mut GpGraphics, mode: *mut TextRenderingHint) -> Status;
...
pub type GdipGetTextureImage = unsafe extern "system" fn(brush: *mut GpTexture, image: *mut *mut GpImage) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetTextureImage(brush : *mut GpTexture, image : *mut *mut GpImage) -> Status);
pub type GdipGetTextureTransform = unsafe extern "system" fn(brush: *mut GpTexture, matrix: *mut Matrix) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetTextureTransform(brush : *mut GpTexture, matrix : *mut Matrix) -> Status);
pub type GdipGetTextureWrapMode = unsafe extern "system" fn(brush: *mut GpTexture, wrapmode: *mut WrapMode) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetTextureWrapMode(brush : *mut GpTexture, wrapmode : *mut WrapMode) -> Status);
pub type GdipGetVisibleClipBounds = unsafe extern "system" fn(graphics: *mut GpGraphics, rect: *mut RectF) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetVisibleClipBounds(graphics : *mut GpGraphics, rect : *mut RectF) -> Status);
pub type GdipGetVisibleClipBoundsI = unsafe extern "system" fn(graphics: *mut GpGraphics, rect: *mut Rect) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetVisibleClipBoundsI(graphics : *mut GpGraphics, rect : *mut Rect) -> Status);
pub type GdipGetWorldTransform = unsafe extern "system" fn(graphics: *mut GpGraphics, matrix: *mut Matrix) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGetWorldTransform(graphics : *mut GpGraphics, matrix : *mut Matrix) -> Status);
pub type GdipGraphicsClear = unsafe extern "system" fn(graphics: *mut GpGraphics, color: u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGraphicsClear(graphics : *mut GpGraphics, color : u32) -> Status);
pub type GdipGraphicsSetAbort = unsafe extern "system" fn(pgraphics: *mut GpGraphics, piabort: *mut core::ffi::c_void) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipGraphicsSetAbort(pgraphics : *mut GpGraphics, piabort : *mut core::ffi::c_void) -> Status);
pub type GdipImageForceValidation = unsafe extern "system" fn(image: *mut GpImage) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipImageForceValidation(image : *mut GpImage) -> Status);
pub type GdipImageGetFrameCount = unsafe extern "system" fn(image: *mut GpImage, dimensionid: *const windows_sys::core::GUID, count: *mut u32) -> Status;
...
pub type GdipImageGetFrameDimensionsCount = unsafe extern "system" fn(image: *mut GpImage, count: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipImageGetFrameDimensionsCount(image : *mut GpImage, count : *mut u32) -> Status);
pub type GdipImageGetFrameDimensionsList = unsafe extern "system" fn(image: *mut GpImage, dimensionids: *mut windows_sys::core::GUID, count: u32) -> Status;
...
pub type GdipImageRotateFlip = unsafe extern "system" fn(image: *mut GpImage, rftype: RotateFlipType) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipImageRotateFlip(image : *mut GpImage, rftype : RotateFlipType) -> Status);
pub type GdipImageSelectActiveFrame = unsafe extern "system" fn(image: *mut GpImage, dimensionid: *const windows_sys::core::GUID, frameindex: u32) -> Status;
...
pub type GdipImageSetAbort = unsafe extern "system" fn(pimage: *mut GpImage, piabort: *mut core::ffi::c_void) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipImageSetAbort(pimage : *mut GpImage, piabort : *mut core::ffi::c_void) -> Status);
pub type GdipInitializePalette = unsafe extern "system" fn(palette: *mut ColorPalette, palettetype: PaletteType, optimalcolors: i32, usetransparentcolor: windows_sys::core::BOOL, bitmap: *mut GpBitmap) -> Status;
...
pub type GdipInvertMatrix = unsafe extern "system" fn(matrix: *mut Matrix) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipInvertMatrix(matrix : *mut Matrix) -> Status);
pub type GdipIsClipEmpty = unsafe extern "system" fn(graphics: *mut GpGraphics, result: *mut windows_sys::core::BOOL) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipIsClipEmpty(graphics : *mut GpGraphics, result : *mut windows_sys::core::BOOL) -> Status);
pub type GdipIsEmptyRegion = unsafe extern "system" fn(region: *mut GpRegion, graphics: *mut GpGraphics, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsEqualRegion = unsafe extern "system" fn(region: *mut GpRegion, region2: *mut GpRegion, graphics: *mut GpGraphics, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsInfiniteRegion = unsafe extern "system" fn(region: *mut GpRegion, graphics: *mut GpGraphics, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsMatrixEqual = unsafe extern "system" fn(matrix: *const Matrix, matrix2: *const Matrix, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsMatrixIdentity = unsafe extern "system" fn(matrix: *const Matrix, result: *mut windows_sys::core::BOOL) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipIsMatrixIdentity(matrix : *const Matrix, result : *mut windows_sys::core::BOOL) -> Status);
pub type GdipIsMatrixInvertible = unsafe extern "system" fn(matrix: *const Matrix, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsOutlineVisiblePathPoint = unsafe extern "system" fn(path: *mut GpPath, x: f32, y: f32, pen: *mut GpPen, graphics: *mut GpGraphics, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsOutlineVisiblePathPointI = unsafe extern "system" fn(path: *mut GpPath, x: i32, y: i32, pen: *mut GpPen, graphics: *mut GpGraphics, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsStyleAvailable = unsafe extern "system" fn(family: *const GpFontFamily, style: i32, isstyleavailable: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsVisibleClipEmpty = unsafe extern "system" fn(graphics: *mut GpGraphics, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsVisiblePathPoint = unsafe extern "system" fn(path: *mut GpPath, x: f32, y: f32, graphics: *mut GpGraphics, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsVisiblePathPointI = unsafe extern "system" fn(path: *mut GpPath, x: i32, y: i32, graphics: *mut GpGraphics, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsVisiblePoint = unsafe extern "system" fn(graphics: *mut GpGraphics, x: f32, y: f32, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsVisiblePointI = unsafe extern "system" fn(graphics: *mut GpGraphics, x: i32, y: i32, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsVisibleRect = unsafe extern "system" fn(graphics: *mut GpGraphics, x: f32, y: f32, width: f32, height: f32, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsVisibleRectI = unsafe extern "system" fn(graphics: *mut GpGraphics, x: i32, y: i32, width: i32, height: i32, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsVisibleRegionPoint = unsafe extern "system" fn(region: *mut GpRegion, x: f32, y: f32, graphics: *mut GpGraphics, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsVisibleRegionPointI = unsafe extern "system" fn(region: *mut GpRegion, x: i32, y: i32, graphics: *mut GpGraphics, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsVisibleRegionRect = unsafe extern "system" fn(region: *mut GpRegion, x: f32, y: f32, width: f32, height: f32, graphics: *mut GpGraphics, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipIsVisibleRegionRectI = unsafe extern "system" fn(region: *mut GpRegion, x: i32, y: i32, width: i32, height: i32, graphics: *mut GpGraphics, result: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipLoadImageFromFile = unsafe extern "system" fn(filename: windows_sys::core::PCWSTR, image: *mut *mut GpImage) -> Status;
...
pub type GdipLoadImageFromFileICM = unsafe extern "system" fn(filename: windows_sys::core::PCWSTR, image: *mut *mut GpImage) -> Status;
...
#[cfg(feature = "Win32_System_Com")]
pub type GdipLoadImageFromStream = unsafe extern "system" fn(stream: *mut core::ffi::c_void, image: *mut *mut GpImage) -> Status;
#[cfg(feature = "Win32_System_Com")]
windows_link::link!("gdiplus.dll" "system" fn GdipLoadImageFromStream(stream : *mut core::ffi::c_void, image : *mut *mut GpImage) -> Status);
#[cfg(feature = "Win32_System_Com")]
pub type GdipLoadImageFromStreamICM = unsafe extern "system" fn(stream: *mut core::ffi::c_void, image: *mut *mut GpImage) -> Status;
#[cfg(feature = "Win32_System_Com")]
...
pub type GdipMeasureCharacterRanges = unsafe extern "system" fn(graphics: *mut GpGraphics, string: windows_sys::core::PCWSTR, length: i32, font: *const GpFont, layoutrect: *const RectF, stringformat: *const GpStringFormat, regioncount: i32, regions: *mut *mut GpRegion) -> Status;
...
pub type GdipMeasureDriverString = unsafe extern "system" fn(graphics: *mut GpGraphics, text: *const u16, length: i32, font: *const GpFont, positions: *const PointF, flags: i32, matrix: *const Matrix, boundingbox: *mut RectF) -> Status;
...
pub type GdipMeasureString = unsafe extern "system" fn(graphics: *mut GpGraphics, string: windows_sys::core::PCWSTR, length: i32, font: *const GpFont, layoutrect: *const RectF, stringformat: *const GpStringFormat, boundingbox: *mut RectF, codepointsfitted: *mut i32, linesfilled: *mut i32) -> Status;
...
pub type GdipMultiplyLineTransform = unsafe extern "system" fn(brush: *mut GpLineGradient, matrix: *const Matrix, order: MatrixOrder) -> Status;
...
pub type GdipMultiplyMatrix = unsafe extern "system" fn(matrix: *mut Matrix, matrix2: *mut Matrix, order: MatrixOrder) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipMultiplyMatrix(matrix : *mut Matrix, matrix2 : *mut Matrix, order : MatrixOrder) -> Status);
pub type GdipMultiplyPathGradientTransform = unsafe extern "system" fn(brush: *mut GpPathGradient, matrix: *const Matrix, order: MatrixOrder) -> Status;
...
pub type GdipMultiplyPenTransform = unsafe extern "system" fn(pen: *mut GpPen, matrix: *const Matrix, order: MatrixOrder) -> Status;
...
pub type GdipMultiplyTextureTransform = unsafe extern "system" fn(brush: *mut GpTexture, matrix: *const Matrix, order: MatrixOrder) -> Status;
...
pub type GdipMultiplyWorldTransform = unsafe extern "system" fn(graphics: *mut GpGraphics, matrix: *const Matrix, order: MatrixOrder) -> Status;
...
pub type GdipNewInstalledFontCollection = unsafe extern "system" fn(fontcollection: *mut *mut GpFontCollection) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipNewInstalledFontCollection(fontcollection : *mut *mut GpFontCollection) -> Status);
pub type GdipNewPrivateFontCollection = unsafe extern "system" fn(fontcollection: *mut *mut GpFontCollection) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipNewPrivateFontCollection(fontcollection : *mut *mut GpFontCollection) -> Status);
pub type GdipPathIterCopyData = unsafe extern "system" fn(iterator: *mut GpPathIterator, resultcount: *mut i32, points: *mut PointF, types: *mut u8, startindex: i32, endindex: i32) -> Status;
...
pub type GdipPathIterEnumerate = unsafe extern "system" fn(iterator: *mut GpPathIterator, resultcount: *mut i32, points: *mut PointF, types: *mut u8, count: i32) -> Status;
...
pub type GdipPathIterGetCount = unsafe extern "system" fn(iterator: *mut GpPathIterator, count: *mut i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipPathIterGetCount(iterator : *mut GpPathIterator, count : *mut i32) -> Status);
pub type GdipPathIterGetSubpathCount = unsafe extern "system" fn(iterator: *mut GpPathIterator, count: *mut i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipPathIterGetSubpathCount(iterator : *mut GpPathIterator, count : *mut i32) -> Status);
pub type GdipPathIterHasCurve = unsafe extern "system" fn(iterator: *mut GpPathIterator, hascurve: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipPathIterIsValid = unsafe extern "system" fn(iterator: *mut GpPathIterator, valid: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipPathIterNextMarker = unsafe extern "system" fn(iterator: *mut GpPathIterator, resultcount: *mut i32, startindex: *mut i32, endindex: *mut i32) -> Status;
...
pub type GdipPathIterNextMarkerPath = unsafe extern "system" fn(iterator: *mut GpPathIterator, resultcount: *mut i32, path: *mut GpPath) -> Status;
...
pub type GdipPathIterNextPathType = unsafe extern "system" fn(iterator: *mut GpPathIterator, resultcount: *mut i32, pathtype: *mut u8, startindex: *mut i32, endindex: *mut i32) -> Status;
...
pub type GdipPathIterNextSubpath = unsafe extern "system" fn(iterator: *mut GpPathIterator, resultcount: *mut i32, startindex: *mut i32, endindex: *mut i32, isclosed: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipPathIterNextSubpathPath = unsafe extern "system" fn(iterator: *mut GpPathIterator, resultcount: *mut i32, path: *mut GpPath, isclosed: *mut windows_sys::core::BOOL) -> Status;
...
pub type GdipPathIterRewind = unsafe extern "system" fn(iterator: *mut GpPathIterator) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipPathIterRewind(iterator : *mut GpPathIterator) -> Status);
pub type GdipPlayMetafileRecord = unsafe extern "system" fn(metafile: *const GpMetafile, recordtype: EmfPlusRecordType, flags: u32, datasize: u32, data: *const u8) -> Status;
...
pub type GdipPrivateAddFontFile = unsafe extern "system" fn(fontcollection: *mut GpFontCollection, filename: windows_sys::core::PCWSTR) -> Status;
...
pub type GdipPrivateAddMemoryFont = unsafe extern "system" fn(fontcollection: *mut GpFontCollection, memory: *const core::ffi::c_void, length: i32) -> Status;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipRecordMetafile = unsafe extern "system" fn(referencehdc: super::Gdi::HDC, r#type: EmfType, framerect: *const RectF, frameunit: MetafileFrameUnit, description: windows_sys::core::PCWSTR, metafile: *mut *mut GpMetafile) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipRecordMetafileFileName = unsafe extern "system" fn(filename: windows_sys::core::PCWSTR, referencehdc: super::Gdi::HDC, r#type: EmfType, framerect: *const RectF, frameunit: MetafileFrameUnit, description: windows_sys::core::PCWSTR, metafile: *mut *mut GpMetafile) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipRecordMetafileFileNameI = unsafe extern "system" fn(filename: windows_sys::core::PCWSTR, referencehdc: super::Gdi::HDC, r#type: EmfType, framerect: *const Rect, frameunit: MetafileFrameUnit, description: windows_sys::core::PCWSTR, metafile: *mut *mut GpMetafile) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipRecordMetafileI = unsafe extern "system" fn(referencehdc: super::Gdi::HDC, r#type: EmfType, framerect: *const Rect, frameunit: MetafileFrameUnit, description: windows_sys::core::PCWSTR, metafile: *mut *mut GpMetafile) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_System_Com"))]
pub type GdipRecordMetafileStream = unsafe extern "system" fn(stream: *mut core::ffi::c_void, referencehdc: super::Gdi::HDC, r#type: EmfType, framerect: *const RectF, frameunit: MetafileFrameUnit, description: windows_sys::core::PCWSTR, metafile: *mut *mut GpMetafile) -> Status;
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_System_Com"))]
...
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_System_Com"))]
pub type GdipRecordMetafileStreamI = unsafe extern "system" fn(stream: *mut core::ffi::c_void, referencehdc: super::Gdi::HDC, r#type: EmfType, framerect: *const Rect, frameunit: MetafileFrameUnit, description: windows_sys::core::PCWSTR, metafile: *mut *mut GpMetafile) -> Status;
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_System_Com"))]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipReleaseDC = unsafe extern "system" fn(graphics: *mut GpGraphics, hdc: super::Gdi::HDC) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("gdiplus.dll" "system" fn GdipReleaseDC(graphics : *mut GpGraphics, hdc : super::Gdi::HDC) -> Status);
pub type GdipRemovePropertyItem = unsafe extern "system" fn(image: *mut GpImage, propid: u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipRemovePropertyItem(image : *mut GpImage, propid : u32) -> Status);
pub type GdipResetClip = unsafe extern "system" fn(graphics: *mut GpGraphics) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipResetClip(graphics : *mut GpGraphics) -> Status);
pub type GdipResetImageAttributes = unsafe extern "system" fn(imageattr: *mut GpImageAttributes, r#type: ColorAdjustType) -> Status;
...
pub type GdipResetLineTransform = unsafe extern "system" fn(brush: *mut GpLineGradient) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipResetLineTransform(brush : *mut GpLineGradient) -> Status);
pub type GdipResetPageTransform = unsafe extern "system" fn(graphics: *mut GpGraphics) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipResetPageTransform(graphics : *mut GpGraphics) -> Status);
pub type GdipResetPath = unsafe extern "system" fn(path: *mut GpPath) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipResetPath(path : *mut GpPath) -> Status);
pub type GdipResetPathGradientTransform = unsafe extern "system" fn(brush: *mut GpPathGradient) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipResetPathGradientTransform(brush : *mut GpPathGradient) -> Status);
pub type GdipResetPenTransform = unsafe extern "system" fn(pen: *mut GpPen) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipResetPenTransform(pen : *mut GpPen) -> Status);
pub type GdipResetTextureTransform = unsafe extern "system" fn(brush: *mut GpTexture) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipResetTextureTransform(brush : *mut GpTexture) -> Status);
pub type GdipResetWorldTransform = unsafe extern "system" fn(graphics: *mut GpGraphics) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipResetWorldTransform(graphics : *mut GpGraphics) -> Status);
pub type GdipRestoreGraphics = unsafe extern "system" fn(graphics: *mut GpGraphics, state: u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipRestoreGraphics(graphics : *mut GpGraphics, state : u32) -> Status);
pub type GdipReversePath = unsafe extern "system" fn(path: *mut GpPath) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipReversePath(path : *mut GpPath) -> Status);
pub type GdipRotateLineTransform = unsafe extern "system" fn(brush: *mut GpLineGradient, angle: f32, order: MatrixOrder) -> Status;
...
pub type GdipRotateMatrix = unsafe extern "system" fn(matrix: *mut Matrix, angle: f32, order: MatrixOrder) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipRotateMatrix(matrix : *mut Matrix, angle : f32, order : MatrixOrder) -> Status);
pub type GdipRotatePathGradientTransform = unsafe extern "system" fn(brush: *mut GpPathGradient, angle: f32, order: MatrixOrder) -> Status;
...
pub type GdipRotatePenTransform = unsafe extern "system" fn(pen: *mut GpPen, angle: f32, order: MatrixOrder) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipRotatePenTransform(pen : *mut GpPen, angle : f32, order : MatrixOrder) -> Status);
pub type GdipRotateTextureTransform = unsafe extern "system" fn(brush: *mut GpTexture, angle: f32, order: MatrixOrder) -> Status;
...
pub type GdipRotateWorldTransform = unsafe extern "system" fn(graphics: *mut GpGraphics, angle: f32, order: MatrixOrder) -> Status;
...
pub type GdipSaveAdd = unsafe extern "system" fn(image: *mut GpImage, encoderparams: *const EncoderParameters) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSaveAdd(image : *mut GpImage, encoderparams : *const EncoderParameters) -> Status);
pub type GdipSaveAddImage = unsafe extern "system" fn(image: *mut GpImage, newimage: *mut GpImage, encoderparams: *const EncoderParameters) -> Status;
...
pub type GdipSaveGraphics = unsafe extern "system" fn(graphics: *mut GpGraphics, state: *mut u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSaveGraphics(graphics : *mut GpGraphics, state : *mut u32) -> Status);
pub type GdipSaveImageToFile = unsafe extern "system" fn(image: *mut GpImage, filename: windows_sys::core::PCWSTR, clsidencoder: *const windows_sys::core::GUID, encoderparams: *const EncoderParameters) -> Status;
...
#[cfg(feature = "Win32_System_Com")]
pub type GdipSaveImageToStream = unsafe extern "system" fn(image: *mut GpImage, stream: *mut core::ffi::c_void, clsidencoder: *const windows_sys::core::GUID, encoderparams: *const EncoderParameters) -> Status;
#[cfg(feature = "Win32_System_Com")]
...
pub type GdipScaleLineTransform = unsafe extern "system" fn(brush: *mut GpLineGradient, sx: f32, sy: f32, order: MatrixOrder) -> Status;
...
pub type GdipScaleMatrix = unsafe extern "system" fn(matrix: *mut Matrix, scalex: f32, scaley: f32, order: MatrixOrder) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipScaleMatrix(matrix : *mut Matrix, scalex : f32, scaley : f32, order : MatrixOrder) -> Status);
pub type GdipScalePathGradientTransform = unsafe extern "system" fn(brush: *mut GpPathGradient, sx: f32, sy: f32, order: MatrixOrder) -> Status;
...
pub type GdipScalePenTransform = unsafe extern "system" fn(pen: *mut GpPen, sx: f32, sy: f32, order: MatrixOrder) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipScalePenTransform(pen : *mut GpPen, sx : f32, sy : f32, order : MatrixOrder) -> Status);
pub type GdipScaleTextureTransform = unsafe extern "system" fn(brush: *mut GpTexture, sx: f32, sy: f32, order: MatrixOrder) -> Status;
...
pub type GdipScaleWorldTransform = unsafe extern "system" fn(graphics: *mut GpGraphics, sx: f32, sy: f32, order: MatrixOrder) -> Status;
...
pub type GdipSetAdjustableArrowCapFillState = unsafe extern "system" fn(cap: *mut GpAdjustableArrowCap, fillstate: windows_sys::core::BOOL) -> Status;
...
pub type GdipSetAdjustableArrowCapHeight = unsafe extern "system" fn(cap: *mut GpAdjustableArrowCap, height: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetAdjustableArrowCapHeight(cap : *mut GpAdjustableArrowCap, height : f32) -> Status);
pub type GdipSetAdjustableArrowCapMiddleInset = unsafe extern "system" fn(cap: *mut GpAdjustableArrowCap, middleinset: f32) -> Status;
...
pub type GdipSetAdjustableArrowCapWidth = unsafe extern "system" fn(cap: *mut GpAdjustableArrowCap, width: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetAdjustableArrowCapWidth(cap : *mut GpAdjustableArrowCap, width : f32) -> Status);
pub type GdipSetClipGraphics = unsafe extern "system" fn(graphics: *mut GpGraphics, srcgraphics: *mut GpGraphics, combinemode: CombineMode) -> Status;
...
#[cfg(feature = "Win32_Graphics_Gdi")]
pub type GdipSetClipHrgn = unsafe extern "system" fn(graphics: *mut GpGraphics, hrgn: super::Gdi::HRGN, combinemode: CombineMode) -> Status;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type GdipSetClipPath = unsafe extern "system" fn(graphics: *mut GpGraphics, path: *mut GpPath, combinemode: CombineMode) -> Status;
...
pub type GdipSetClipRect = unsafe extern "system" fn(graphics: *mut GpGraphics, x: f32, y: f32, width: f32, height: f32, combinemode: CombineMode) -> Status;
...
pub type GdipSetClipRectI = unsafe extern "system" fn(graphics: *mut GpGraphics, x: i32, y: i32, width: i32, height: i32, combinemode: CombineMode) -> Status;
...
pub type GdipSetClipRegion = unsafe extern "system" fn(graphics: *mut GpGraphics, region: *mut GpRegion, combinemode: CombineMode) -> Status;
...
pub type GdipSetCompositingMode = unsafe extern "system" fn(graphics: *mut GpGraphics, compositingmode: CompositingMode) -> Status;
...
pub type GdipSetCompositingQuality = unsafe extern "system" fn(graphics: *mut GpGraphics, compositingquality: CompositingQuality) -> Status;
...
pub type GdipSetCustomLineCapBaseCap = unsafe extern "system" fn(customcap: *mut GpCustomLineCap, basecap: LineCap) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetCustomLineCapBaseCap(customcap : *mut GpCustomLineCap, basecap : LineCap) -> Status);
pub type GdipSetCustomLineCapBaseInset = unsafe extern "system" fn(customcap: *mut GpCustomLineCap, inset: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetCustomLineCapBaseInset(customcap : *mut GpCustomLineCap, inset : f32) -> Status);
pub type GdipSetCustomLineCapStrokeCaps = unsafe extern "system" fn(customcap: *mut GpCustomLineCap, startcap: LineCap, endcap: LineCap) -> Status;
...
pub type GdipSetCustomLineCapStrokeJoin = unsafe extern "system" fn(customcap: *mut GpCustomLineCap, linejoin: LineJoin) -> Status;
...
pub type GdipSetCustomLineCapWidthScale = unsafe extern "system" fn(customcap: *mut GpCustomLineCap, widthscale: f32) -> Status;
...
pub type GdipSetEffectParameters = unsafe extern "system" fn(effect: *mut CGpEffect, params: *const core::ffi::c_void, size: u32) -> Status;
...
pub type GdipSetEmpty = unsafe extern "system" fn(region: *mut GpRegion) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetEmpty(region : *mut GpRegion) -> Status);
pub type GdipSetImageAttributesCachedBackground = unsafe extern "system" fn(imageattr: *mut GpImageAttributes, enableflag: windows_sys::core::BOOL) -> Status;
...
pub type GdipSetImageAttributesColorKeys = unsafe extern "system" fn(imageattr: *mut GpImageAttributes, r#type: ColorAdjustType, enableflag: windows_sys::core::BOOL, colorlow: u32, colorhigh: u32) -> Status;
...
pub type GdipSetImageAttributesColorMatrix = unsafe extern "system" fn(imageattr: *mut GpImageAttributes, r#type: ColorAdjustType, enableflag: windows_sys::core::BOOL, colormatrix: *const ColorMatrix, graymatrix: *const ColorMatrix, flags: ColorMatrixFlags) -> Status;
...
pub type GdipSetImageAttributesGamma = unsafe extern "system" fn(imageattr: *mut GpImageAttributes, r#type: ColorAdjustType, enableflag: windows_sys::core::BOOL, gamma: f32) -> Status;
...
pub type GdipSetImageAttributesNoOp = unsafe extern "system" fn(imageattr: *mut GpImageAttributes, r#type: ColorAdjustType, enableflag: windows_sys::core::BOOL) -> Status;
...
pub type GdipSetImageAttributesOutputChannel = unsafe extern "system" fn(imageattr: *mut GpImageAttributes, r#type: ColorAdjustType, enableflag: windows_sys::core::BOOL, channelflags: ColorChannelFlags) -> Status;
...
pub type GdipSetImageAttributesOutputChannelColorProfile = unsafe extern "system" fn(imageattr: *mut GpImageAttributes, r#type: ColorAdjustType, enableflag: windows_sys::core::BOOL, colorprofilefilename: windows_sys::core::PCWSTR) -> Status;
...
pub type GdipSetImageAttributesRemapTable = unsafe extern "system" fn(imageattr: *mut GpImageAttributes, r#type: ColorAdjustType, enableflag: windows_sys::core::BOOL, mapsize: u32, map: *const ColorMap) -> Status;
...
pub type GdipSetImageAttributesThreshold = unsafe extern "system" fn(imageattr: *mut GpImageAttributes, r#type: ColorAdjustType, enableflag: windows_sys::core::BOOL, threshold: f32) -> Status;
...
pub type GdipSetImageAttributesToIdentity = unsafe extern "system" fn(imageattr: *mut GpImageAttributes, r#type: ColorAdjustType) -> Status;
...
pub type GdipSetImageAttributesWrapMode = unsafe extern "system" fn(imageattr: *mut GpImageAttributes, wrap: WrapMode, argb: u32, clamp: windows_sys::core::BOOL) -> Status;
...
pub type GdipSetImagePalette = unsafe extern "system" fn(image: *mut GpImage, palette: *const ColorPalette) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetImagePalette(image : *mut GpImage, palette : *const ColorPalette) -> Status);
pub type GdipSetInfinite = unsafe extern "system" fn(region: *mut GpRegion) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetInfinite(region : *mut GpRegion) -> Status);
pub type GdipSetInterpolationMode = unsafe extern "system" fn(graphics: *mut GpGraphics, interpolationmode: InterpolationMode) -> Status;
...
pub type GdipSetLineBlend = unsafe extern "system" fn(brush: *mut GpLineGradient, blend: *const f32, positions: *const f32, count: i32) -> Status;
...
pub type GdipSetLineColors = unsafe extern "system" fn(brush: *mut GpLineGradient, color1: u32, color2: u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetLineColors(brush : *mut GpLineGradient, color1 : u32, color2 : u32) -> Status);
pub type GdipSetLineGammaCorrection = unsafe extern "system" fn(brush: *mut GpLineGradient, usegammacorrection: windows_sys::core::BOOL) -> Status;
...
pub type GdipSetLineLinearBlend = unsafe extern "system" fn(brush: *mut GpLineGradient, focus: f32, scale: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetLineLinearBlend(brush : *mut GpLineGradient, focus : f32, scale : f32) -> Status);
pub type GdipSetLinePresetBlend = unsafe extern "system" fn(brush: *mut GpLineGradient, blend: *const u32, positions: *const f32, count: i32) -> Status;
...
pub type GdipSetLineSigmaBlend = unsafe extern "system" fn(brush: *mut GpLineGradient, focus: f32, scale: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetLineSigmaBlend(brush : *mut GpLineGradient, focus : f32, scale : f32) -> Status);
pub type GdipSetLineTransform = unsafe extern "system" fn(brush: *mut GpLineGradient, matrix: *const Matrix) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetLineTransform(brush : *mut GpLineGradient, matrix : *const Matrix) -> Status);
pub type GdipSetLineWrapMode = unsafe extern "system" fn(brush: *mut GpLineGradient, wrapmode: WrapMode) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetLineWrapMode(brush : *mut GpLineGradient, wrapmode : WrapMode) -> Status);
pub type GdipSetMatrixElements = unsafe extern "system" fn(matrix: *mut Matrix, m11: f32, m12: f32, m21: f32, m22: f32, dx: f32, dy: f32) -> Status;
...
pub type GdipSetMetafileDownLevelRasterizationLimit = unsafe extern "system" fn(metafile: *mut GpMetafile, metafilerasterizationlimitdpi: u32) -> Status;
...
pub type GdipSetPageScale = unsafe extern "system" fn(graphics: *mut GpGraphics, scale: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPageScale(graphics : *mut GpGraphics, scale : f32) -> Status);
pub type GdipSetPageUnit = unsafe extern "system" fn(graphics: *mut GpGraphics, unit: Unit) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPageUnit(graphics : *mut GpGraphics, unit : Unit) -> Status);
pub type GdipSetPathFillMode = unsafe extern "system" fn(path: *mut GpPath, fillmode: FillMode) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPathFillMode(path : *mut GpPath, fillmode : FillMode) -> Status);
pub type GdipSetPathGradientBlend = unsafe extern "system" fn(brush: *mut GpPathGradient, blend: *const f32, positions: *const f32, count: i32) -> Status;
...
pub type GdipSetPathGradientCenterColor = unsafe extern "system" fn(brush: *mut GpPathGradient, colors: u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPathGradientCenterColor(brush : *mut GpPathGradient, colors : u32) -> Status);
pub type GdipSetPathGradientCenterPoint = unsafe extern "system" fn(brush: *mut GpPathGradient, points: *const PointF) -> Status;
...
pub type GdipSetPathGradientCenterPointI = unsafe extern "system" fn(brush: *mut GpPathGradient, points: *const Point) -> Status;
...
pub type GdipSetPathGradientFocusScales = unsafe extern "system" fn(brush: *mut GpPathGradient, xscale: f32, yscale: f32) -> Status;
...
pub type GdipSetPathGradientGammaCorrection = unsafe extern "system" fn(brush: *mut GpPathGradient, usegammacorrection: windows_sys::core::BOOL) -> Status;
...
pub type GdipSetPathGradientLinearBlend = unsafe extern "system" fn(brush: *mut GpPathGradient, focus: f32, scale: f32) -> Status;
...
pub type GdipSetPathGradientPath = unsafe extern "system" fn(brush: *mut GpPathGradient, path: *const GpPath) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPathGradientPath(brush : *mut GpPathGradient, path : *const GpPath) -> Status);
pub type GdipSetPathGradientPresetBlend = unsafe extern "system" fn(brush: *mut GpPathGradient, blend: *const u32, positions: *const f32, count: i32) -> Status;
...
pub type GdipSetPathGradientSigmaBlend = unsafe extern "system" fn(brush: *mut GpPathGradient, focus: f32, scale: f32) -> Status;
...
pub type GdipSetPathGradientSurroundColorsWithCount = unsafe extern "system" fn(brush: *mut GpPathGradient, color: *const u32, count: *mut i32) -> Status;
...
pub type GdipSetPathGradientTransform = unsafe extern "system" fn(brush: *mut GpPathGradient, matrix: *mut Matrix) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPathGradientTransform(brush : *mut GpPathGradient, matrix : *mut Matrix) -> Status);
pub type GdipSetPathGradientWrapMode = unsafe extern "system" fn(brush: *mut GpPathGradient, wrapmode: WrapMode) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPathGradientWrapMode(brush : *mut GpPathGradient, wrapmode : WrapMode) -> Status);
pub type GdipSetPathMarker = unsafe extern "system" fn(path: *mut GpPath) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPathMarker(path : *mut GpPath) -> Status);
pub type GdipSetPenBrushFill = unsafe extern "system" fn(pen: *mut GpPen, brush: *mut GpBrush) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenBrushFill(pen : *mut GpPen, brush : *mut GpBrush) -> Status);
pub type GdipSetPenColor = unsafe extern "system" fn(pen: *mut GpPen, argb: u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenColor(pen : *mut GpPen, argb : u32) -> Status);
pub type GdipSetPenCompoundArray = unsafe extern "system" fn(pen: *mut GpPen, dash: *const f32, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenCompoundArray(pen : *mut GpPen, dash : *const f32, count : i32) -> Status);
pub type GdipSetPenCustomEndCap = unsafe extern "system" fn(pen: *mut GpPen, customcap: *mut GpCustomLineCap) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenCustomEndCap(pen : *mut GpPen, customcap : *mut GpCustomLineCap) -> Status);
pub type GdipSetPenCustomStartCap = unsafe extern "system" fn(pen: *mut GpPen, customcap: *mut GpCustomLineCap) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenCustomStartCap(pen : *mut GpPen, customcap : *mut GpCustomLineCap) -> Status);
pub type GdipSetPenDashArray = unsafe extern "system" fn(pen: *mut GpPen, dash: *const f32, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenDashArray(pen : *mut GpPen, dash : *const f32, count : i32) -> Status);
pub type GdipSetPenDashCap197819 = unsafe extern "system" fn(pen: *mut GpPen, dashcap: DashCap) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenDashCap197819(pen : *mut GpPen, dashcap : DashCap) -> Status);
pub type GdipSetPenDashOffset = unsafe extern "system" fn(pen: *mut GpPen, offset: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenDashOffset(pen : *mut GpPen, offset : f32) -> Status);
pub type GdipSetPenDashStyle = unsafe extern "system" fn(pen: *mut GpPen, dashstyle: DashStyle) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenDashStyle(pen : *mut GpPen, dashstyle : DashStyle) -> Status);
pub type GdipSetPenEndCap = unsafe extern "system" fn(pen: *mut GpPen, endcap: LineCap) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenEndCap(pen : *mut GpPen, endcap : LineCap) -> Status);
pub type GdipSetPenLineCap197819 = unsafe extern "system" fn(pen: *mut GpPen, startcap: LineCap, endcap: LineCap, dashcap: DashCap) -> Status;
...
pub type GdipSetPenLineJoin = unsafe extern "system" fn(pen: *mut GpPen, linejoin: LineJoin) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenLineJoin(pen : *mut GpPen, linejoin : LineJoin) -> Status);
pub type GdipSetPenMiterLimit = unsafe extern "system" fn(pen: *mut GpPen, miterlimit: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenMiterLimit(pen : *mut GpPen, miterlimit : f32) -> Status);
pub type GdipSetPenMode = unsafe extern "system" fn(pen: *mut GpPen, penmode: PenAlignment) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenMode(pen : *mut GpPen, penmode : PenAlignment) -> Status);
pub type GdipSetPenStartCap = unsafe extern "system" fn(pen: *mut GpPen, startcap: LineCap) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenStartCap(pen : *mut GpPen, startcap : LineCap) -> Status);
pub type GdipSetPenTransform = unsafe extern "system" fn(pen: *mut GpPen, matrix: *mut Matrix) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenTransform(pen : *mut GpPen, matrix : *mut Matrix) -> Status);
pub type GdipSetPenUnit = unsafe extern "system" fn(pen: *mut GpPen, unit: Unit) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenUnit(pen : *mut GpPen, unit : Unit) -> Status);
pub type GdipSetPenWidth = unsafe extern "system" fn(pen: *mut GpPen, width: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPenWidth(pen : *mut GpPen, width : f32) -> Status);
pub type GdipSetPixelOffsetMode = unsafe extern "system" fn(graphics: *mut GpGraphics, pixeloffsetmode: PixelOffsetMode) -> Status;
...
pub type GdipSetPropertyItem = unsafe extern "system" fn(image: *mut GpImage, item: *const PropertyItem) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetPropertyItem(image : *mut GpImage, item : *const PropertyItem) -> Status);
pub type GdipSetRenderingOrigin = unsafe extern "system" fn(graphics: *mut GpGraphics, x: i32, y: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetRenderingOrigin(graphics : *mut GpGraphics, x : i32, y : i32) -> Status);
pub type GdipSetSmoothingMode = unsafe extern "system" fn(graphics: *mut GpGraphics, smoothingmode: SmoothingMode) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetSmoothingMode(graphics : *mut GpGraphics, smoothingmode : SmoothingMode) -> Status);
pub type GdipSetSolidFillColor = unsafe extern "system" fn(brush: *mut GpSolidFill, color: u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetSolidFillColor(brush : *mut GpSolidFill, color : u32) -> Status);
pub type GdipSetStringFormatAlign = unsafe extern "system" fn(format: *mut GpStringFormat, align: StringAlignment) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetStringFormatAlign(format : *mut GpStringFormat, align : StringAlignment) -> Status);
pub type GdipSetStringFormatDigitSubstitution = unsafe extern "system" fn(format: *mut GpStringFormat, language: u16, substitute: StringDigitSubstitute) -> Status;
...
pub type GdipSetStringFormatFlags = unsafe extern "system" fn(format: *mut GpStringFormat, flags: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetStringFormatFlags(format : *mut GpStringFormat, flags : i32) -> Status);
pub type GdipSetStringFormatHotkeyPrefix = unsafe extern "system" fn(format: *mut GpStringFormat, hotkeyprefix: i32) -> Status;
...
pub type GdipSetStringFormatLineAlign = unsafe extern "system" fn(format: *mut GpStringFormat, align: StringAlignment) -> Status;
...
pub type GdipSetStringFormatMeasurableCharacterRanges = unsafe extern "system" fn(format: *mut GpStringFormat, rangecount: i32, ranges: *const CharacterRange) -> Status;
...
pub type GdipSetStringFormatTabStops = unsafe extern "system" fn(format: *mut GpStringFormat, firsttaboffset: f32, count: i32, tabstops: *const f32) -> Status;
...
pub type GdipSetStringFormatTrimming = unsafe extern "system" fn(format: *mut GpStringFormat, trimming: StringTrimming) -> Status;
...
pub type GdipSetTextContrast = unsafe extern "system" fn(graphics: *mut GpGraphics, contrast: u32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetTextContrast(graphics : *mut GpGraphics, contrast : u32) -> Status);
pub type GdipSetTextRenderingHint = unsafe extern "system" fn(graphics: *mut GpGraphics, mode: TextRenderingHint) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetTextRenderingHint(graphics : *mut GpGraphics, mode : TextRenderingHint) -> Status);
pub type GdipSetTextureTransform = unsafe extern "system" fn(brush: *mut GpTexture, matrix: *const Matrix) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetTextureTransform(brush : *mut GpTexture, matrix : *const Matrix) -> Status);
pub type GdipSetTextureWrapMode = unsafe extern "system" fn(brush: *mut GpTexture, wrapmode: WrapMode) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetTextureWrapMode(brush : *mut GpTexture, wrapmode : WrapMode) -> Status);
pub type GdipSetWorldTransform = unsafe extern "system" fn(graphics: *mut GpGraphics, matrix: *mut Matrix) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipSetWorldTransform(graphics : *mut GpGraphics, matrix : *mut Matrix) -> Status);
pub type GdipShearMatrix = unsafe extern "system" fn(matrix: *mut Matrix, shearx: f32, sheary: f32, order: MatrixOrder) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipShearMatrix(matrix : *mut Matrix, shearx : f32, sheary : f32, order : MatrixOrder) -> Status);
pub type GdipStartPathFigure = unsafe extern "system" fn(path: *mut GpPath) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipStartPathFigure(path : *mut GpPath) -> Status);
pub type GdipStringFormatGetGenericDefault = unsafe extern "system" fn(format: *mut *mut GpStringFormat) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipStringFormatGetGenericDefault(format : *mut *mut GpStringFormat) -> Status);
pub type GdipStringFormatGetGenericTypographic = unsafe extern "system" fn(format: *mut *mut GpStringFormat) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipStringFormatGetGenericTypographic(format : *mut *mut GpStringFormat) -> Status);
pub type GdipTestControl = unsafe extern "system" fn(control: GpTestControlEnum, param1: *mut core::ffi::c_void) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipTestControl(control : GpTestControlEnum, param1 : *mut core::ffi::c_void) -> Status);
pub type GdipTransformMatrixPoints = unsafe extern "system" fn(matrix: *mut Matrix, pts: *mut PointF, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipTransformMatrixPoints(matrix : *mut Matrix, pts : *mut PointF, count : i32) -> Status);
pub type GdipTransformMatrixPointsI = unsafe extern "system" fn(matrix: *mut Matrix, pts: *mut Point, count: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipTransformMatrixPointsI(matrix : *mut Matrix, pts : *mut Point, count : i32) -> Status);
pub type GdipTransformPath = unsafe extern "system" fn(path: *mut GpPath, matrix: *mut Matrix) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipTransformPath(path : *mut GpPath, matrix : *mut Matrix) -> Status);
pub type GdipTransformPoints = unsafe extern "system" fn(graphics: *mut GpGraphics, destspace: CoordinateSpace, srcspace: CoordinateSpace, points: *mut PointF, count: i32) -> Status;
...
pub type GdipTransformPointsI = unsafe extern "system" fn(graphics: *mut GpGraphics, destspace: CoordinateSpace, srcspace: CoordinateSpace, points: *mut Point, count: i32) -> Status;
...
pub type GdipTransformRegion = unsafe extern "system" fn(region: *mut GpRegion, matrix: *mut Matrix) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipTransformRegion(region : *mut GpRegion, matrix : *mut Matrix) -> Status);
pub type GdipTranslateClip = unsafe extern "system" fn(graphics: *mut GpGraphics, dx: f32, dy: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipTranslateClip(graphics : *mut GpGraphics, dx : f32, dy : f32) -> Status);
pub type GdipTranslateClipI = unsafe extern "system" fn(graphics: *mut GpGraphics, dx: i32, dy: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipTranslateClipI(graphics : *mut GpGraphics, dx : i32, dy : i32) -> Status);
pub type GdipTranslateLineTransform = unsafe extern "system" fn(brush: *mut GpLineGradient, dx: f32, dy: f32, order: MatrixOrder) -> Status;
...
pub type GdipTranslateMatrix = unsafe extern "system" fn(matrix: *mut Matrix, offsetx: f32, offsety: f32, order: MatrixOrder) -> Status;
...
pub type GdipTranslatePathGradientTransform = unsafe extern "system" fn(brush: *mut GpPathGradient, dx: f32, dy: f32, order: MatrixOrder) -> Status;
...
pub type GdipTranslatePenTransform = unsafe extern "system" fn(pen: *mut GpPen, dx: f32, dy: f32, order: MatrixOrder) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipTranslatePenTransform(pen : *mut GpPen, dx : f32, dy : f32, order : MatrixOrder) -> Status);
pub type GdipTranslateRegion = unsafe extern "system" fn(region: *mut GpRegion, dx: f32, dy: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipTranslateRegion(region : *mut GpRegion, dx : f32, dy : f32) -> Status);
pub type GdipTranslateRegionI = unsafe extern "system" fn(region: *mut GpRegion, dx: i32, dy: i32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipTranslateRegionI(region : *mut GpRegion, dx : i32, dy : i32) -> Status);
pub type GdipTranslateTextureTransform = unsafe extern "system" fn(brush: *mut GpTexture, dx: f32, dy: f32, order: MatrixOrder) -> Status;
...
pub type GdipTranslateWorldTransform = unsafe extern "system" fn(graphics: *mut GpGraphics, dx: f32, dy: f32, order: MatrixOrder) -> Status;
...
pub type GdipVectorTransformMatrixPoints = unsafe extern "system" fn(matrix: *mut Matrix, pts: *mut PointF, count: i32) -> Status;
...
pub type GdipVectorTransformMatrixPointsI = unsafe extern "system" fn(matrix: *mut Matrix, pts: *mut Point, count: i32) -> Status;
...
pub type GdipWarpPath = unsafe extern "system" fn(path: *mut GpPath, matrix: *mut Matrix, points: *const PointF, count: i32, srcx: f32, srcy: f32, srcwidth: f32, srcheight: f32, warpmode: WarpMode, flatness: f32) -> Status;
...
pub type GdipWidenPath = unsafe extern "system" fn(nativepath: *mut GpPath, pen: *mut GpPen, matrix: *mut Matrix, flatness: f32) -> Status;
...
pub type GdipWindingModeOutline = unsafe extern "system" fn(path: *mut GpPath, matrix: *mut Matrix, flatness: f32) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdipWindingModeOutline(path : *mut GpPath, matrix : *mut Matrix, flatness : f32) -> Status);
pub type GdiplusNotificationHook = unsafe extern "system" fn(token: *mut usize) -> Status;
windows_link::link!("gdiplus.dll" "system" fn GdiplusNotificationHook(token : *mut usize) -> Status);
pub type GdiplusNotificationUnhook = unsafe extern "system" fn(token: usize);
windows_link::link!("gdiplus.dll" "system" fn GdiplusNotificationUnhook(token : usize));
pub type GdiplusShutdown = unsafe extern "system" fn(token: usize);
windows_link::link!("gdiplus.dll" "system" fn GdiplusShutdown(token : usize));
pub type GdiplusStartup = unsafe extern "system" fn(token: *mut usize, input: *const GdiplusStartupInput, output: *mut GdiplusStartupOutput) -> Status;
