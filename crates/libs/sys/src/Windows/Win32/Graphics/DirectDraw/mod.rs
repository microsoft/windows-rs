::windows_sys::core::link ! ( "ddraw.dll""system" #[doc = "*Required features: `\"Win32_Graphics_DirectDraw\"`*"] fn DirectDrawCreate ( lpguid : *mut :: windows_sys::core::GUID , lplpdd : *mut IDirectDraw , punkouter : :: windows_sys::core::IUnknown ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "ddraw.dll""system" #[doc = "*Required features: `\"Win32_Graphics_DirectDraw\"`*"] fn DirectDrawCreateClipper ( dwflags : u32 , lplpddclipper : *mut IDirectDrawClipper , punkouter : :: windows_sys::core::IUnknown ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "ddraw.dll""system" #[doc = "*Required features: `\"Win32_Graphics_DirectDraw\"`*"] fn DirectDrawCreateEx ( lpguid : *mut :: windows_sys::core::GUID , lplpdd : *mut *mut ::core::ffi::c_void , iid : *const :: windows_sys::core::GUID , punkouter : :: windows_sys::core::IUnknown ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "ddraw.dll""system" #[doc = "*Required features: `\"Win32_Graphics_DirectDraw\"`, `\"Win32_Foundation\"`*"] fn DirectDrawEnumerateA ( lpcallback : LPDDENUMCALLBACKA , lpcontext : *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Graphics_Gdi"))]
::windows_sys::core::link ! ( "ddraw.dll""system" #[doc = "*Required features: `\"Win32_Graphics_DirectDraw\"`, `\"Win32_Foundation\"`, `\"Win32_Graphics_Gdi\"`*"] fn DirectDrawEnumerateExA ( lpcallback : LPDDENUMCALLBACKEXA , lpcontext : *mut ::core::ffi::c_void , dwflags : u32 ) -> :: windows_sys::core::HRESULT );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Graphics_Gdi"))]
::windows_sys::core::link ! ( "ddraw.dll""system" #[doc = "*Required features: `\"Win32_Graphics_DirectDraw\"`, `\"Win32_Foundation\"`, `\"Win32_Graphics_Gdi\"`*"] fn DirectDrawEnumerateExW ( lpcallback : LPDDENUMCALLBACKEXW , lpcontext : *mut ::core::ffi::c_void , dwflags : u32 ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::link ! ( "ddraw.dll""system" #[doc = "*Required features: `\"Win32_Graphics_DirectDraw\"`, `\"Win32_Foundation\"`*"] fn DirectDrawEnumerateW ( lpcallback : LPDDENUMCALLBACKW , lpcontext : *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
