pub type PTCloseProvider = unsafe extern "system" fn(hprovider: HPTPROVIDER) -> windows_sys::core::HRESULT;
windows_link::link!("prntvpt.dll" "system" fn PTCloseProvider(hprovider : HPTPROVIDER) -> windows_sys::core::HRESULT);
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_System_Com"))]
pub type PTConvertDevModeToPrintTicket = unsafe extern "system" fn(hprovider: HPTPROVIDER, cbdevmode: u32, pdevmode: *const super::super::Gdi::DEVMODEA, scope: EPrintTicketScope, pprintticket: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_System_Com"))]
...
pub type PTGetPrintCapabilities = unsafe extern "system" fn(hprovider: HPTPROVIDER, pprintticket: *mut core::ffi::c_void, pcapabilities: *mut core::ffi::c_void, pbstrerrormessage: *mut windows_sys::core::BSTR) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_System_Com")]
...
#[cfg(feature = "Win32_System_Com")]
pub type PTGetPrintDeviceCapabilities = unsafe extern "system" fn(hprovider: HPTPROVIDER, pprintticket: *mut core::ffi::c_void, pdevicecapabilities: *mut core::ffi::c_void, pbstrerrormessage: *mut windows_sys::core::BSTR) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_System_Com")]
...
#[cfg(feature = "Win32_System_Com")]
pub type PTGetPrintDeviceResources = unsafe extern "system" fn(hprovider: HPTPROVIDER, pszlocalename: windows_sys::core::PCWSTR, pprintticket: *mut core::ffi::c_void, pdeviceresources: *mut core::ffi::c_void, pbstrerrormessage: *mut windows_sys::core::BSTR) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_System_Com")]
...
#[cfg(feature = "Win32_System_Com")]
pub type PTMergeAndValidatePrintTicket = unsafe extern "system" fn(hprovider: HPTPROVIDER, pbaseticket: *mut core::ffi::c_void, pdeltaticket: *mut core::ffi::c_void, scope: EPrintTicketScope, presultticket: *mut core::ffi::c_void, pbstrerrormessage: *mut windows_sys::core::BSTR) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_System_Com")]
...
pub type PTOpenProvider = unsafe extern "system" fn(pszprintername: windows_sys::core::PCWSTR, dwversion: u32, phprovider: *mut HPTPROVIDER) -> windows_sys::core::HRESULT;
...
pub type PTOpenProviderEx = unsafe extern "system" fn(pszprintername: windows_sys::core::PCWSTR, dwmaxversion: u32, dwprefversion: u32, phprovider: *mut HPTPROVIDER, pusedversion: *mut u32) -> windows_sys::core::HRESULT;
...
pub type PTQuerySchemaVersionSupport = unsafe extern "system" fn(pszprintername: windows_sys::core::PCWSTR, pmaxversion: *mut u32) -> windows_sys::core::HRESULT;
