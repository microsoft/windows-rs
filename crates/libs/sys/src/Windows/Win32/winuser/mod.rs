...
pub struct COMBOBOXINFO {
    ...
    pub stateButton: u32,
    pub hwndCombo: super::windef::HWND,
...
pub struct GUITHREADINFO {
    ...
    pub flags: u32,
    pub hwndActive: super::windef::HWND,
    pub hwndFocus: super::windef::HWND,
    pub hwndCapture: super::windef::HWND,
    pub hwndMenuOwner: super::windef::HWND,
    pub hwndMoveSize: super::windef::HWND,
...
pub struct HELPINFO {
    ...
    pub iCtrlId: i32,
    pub hItemHandle: super::winnt::HANDLE,
...
pub struct ICONMETRICSW {
    ...
    pub iVertSpacing: i32,
    pub iTitleWrap: i32,
    pub lfFont: super::wingdi::LOGFONTW,
}
...
pub struct MENUINFO {
    ...
    pub dwStyle: u32,
    pub cyMax: u32,
    pub hbrBack: super::windef::HBRUSH,
...
pub struct MENUITEMINFOA {
    ...
    pub fState: u32,
    pub wID: u32,
    pub hSubMenu: super::windef::HMENU,
...
pub struct MINMAXINFO {
    ...
    pub ptMaxPosition: super::windef::POINT,
    pub ptMinTrackSize: super::windef::POINT,
    pub ptMaxTrackSize: super::windef::POINT,
}
...
pub struct NONCLIENTMETRICSA {
    ...
    pub lfCaptionFont: super::wingdi::LOGFONTA,
    pub iSmCaptionWidth: i32,
    pub iSmCaptionHeight: i32,
    pub lfSmCaptionFont: super::wingdi::LOGFONTA,
    pub iMenuWidth: i32,
    pub iMenuHeight: i32,
    pub lfMenuFont: super::wingdi::LOGFONTA,
    pub lfStatusFont: super::wingdi::LOGFONTA,
    pub lfMessageFont: super::wingdi::LOGFONTA,
...
pub struct NONCLIENTMETRICSW {
    ...
    pub iCaptionWidth: i32,
    pub iCaptionHeight: i32,
    pub lfCaptionFont: super::wingdi::LOGFONTW,
    pub iSmCaptionWidth: i32,
    pub iSmCaptionHeight: i32,
    pub lfSmCaptionFont: super::wingdi::LOGFONTW,
    pub iMenuWidth: i32,
    pub iMenuHeight: i32,
    pub lfMenuFont: super::wingdi::LOGFONTW,
    pub lfStatusFont: super::wingdi::LOGFONTW,
...
pub struct POINTER_INFO {
    ...
    pub sourceDevice: super::winnt::HANDLE,
    pub hwndTarget: super::windef::HWND,
    pub ptPixelLocation: super::windef::POINT,
    pub ptHimetricLocation: super::windef::POINT,
    pub ptPixelLocationRaw: super::windef::POINT,
    pub ptHimetricLocationRaw: super::windef::POINT,
    pub dwTime: u32,
...
pub struct POINTER_TOUCH_INFO {
    ...
    pub rcContact: super::windef::RECT,
    pub rcContactRaw: super::windef::RECT,
    pub orientation: u32,
    pub pressure: u32,
}
#[repr(C)]
...
pub struct TOUCHINPUT {
    pub x: i32,
    pub y: i32,
    pub hSource: super::winnt::HANDLE,
    pub dwID: u32,
    pub dwFlags: u32,
    pub dwMask: u32,
    pub dwTime: u32,
...
pub struct TOUCH_HIT_TESTING_INPUT {
    ...
    pub nonOccludedBoundingBox: super::windef::RECT,
    pub orientation: u32,
}
...
pub struct UPDATELAYEREDWINDOWINFO {
    ...
    pub pptDst: *const super::windef::POINT,
    pub psize: *const super::windef::SIZE,
    pub hdcSrc: super::windef::HDC,
    pub pptSrc: *const super::windef::POINT,
    pub crKey: super::windef::COLORREF,
    pub pblend: *const super::wingdi::BLENDFUNCTION,
    pub dwFlags: u32,
...
pub struct WINDOWINFO {
    ...
    pub atomWindowType: super::minwindef::ATOM,
...
pub struct WINDOWPLACEMENT {
    ...
    pub flags: u32,
    pub showCmd: u32,
    pub ptMinPosition: super::windef::POINT,
    pub ptMaxPosition: super::windef::POINT,
...
pub struct WINDOW_ACTION {
    ...
    pub insertAfter: super::windef::HWND,
    pub placementState: WINDOW_PLACEMENT_STATE,
    pub normalRect: super::windef::RECT,
    pub workArea: super::windef::RECT,
    pub dpi: u32,
...
pub struct WNDCLASSA {
    ...
    pub hCursor: super::windef::HCURSOR,
    pub hbrBackground: super::windef::HBRUSH,
