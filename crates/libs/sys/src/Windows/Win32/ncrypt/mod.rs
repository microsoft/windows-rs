...
pub const NCRYPT_PCP_EKSTORE_PROPERTY: windows_sys::core::PCWSTR = windows_sys::core::w!("PCP_EKSTORE");
...
pub const NCRYPT_PCP_SDDIDK_CONTEXT_PROPERTY: windows_sys::core::PCWSTR = windows_sys::core::w!("PCP_SDDIDK_CONTEXT");
