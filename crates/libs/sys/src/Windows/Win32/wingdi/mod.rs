...
#[cfg(all(feature = "minwindef", feature = "windef"))]
windows_link::link!("gdi32.dll" "system" fn SetMiterLimit(hdc : super::HDC, limit : f32, old : super::PFLOAT) -> windows_sys::core::BOOL);
#[cfg(feature = "windef")]
...
#[cfg(feature = "windef")]
windows_link::link!("opengl32.dll" "system" fn wglUseFontOutlinesA(param0 : super::HDC, param1 : u32, param2 : u32, param3 : u32, param4 : f32, param5 : f32, param6 : i32, param7 : LPGLYPHMETRICSFLOAT) -> windows_sys::core::BOOL);
#[cfg(feature = "windef")]
windows_link::link!("opengl32.dll" "system" fn wglUseFontOutlinesW(param0 : super::HDC, param1 : u32, param2 : u32, param3 : u32, param4 : f32, param5 : f32, param6 : i32, param7 : LPGLYPHMETRICSFLOAT) -> windows_sys::core::BOOL);
#[repr(C)]
