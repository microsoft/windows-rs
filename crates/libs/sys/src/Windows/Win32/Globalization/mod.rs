...
windows_link::link!("kernel32.dll" "system" fn CompareStringA(locale : u32, dwcmpflags : u32, lpstring1 : *mut i8, cchcount1 : i32, lpstring2 : *mut i8, cchcount2 : i32) -> COMPARESTRING_RESULT);
...
windows_link::link!("kernel32.dll" "system" fn ConvertCalDateTimeToSystemTime(lpcaldatetime : *mut CALDATETIME, lpsystime : *mut super::Foundation:: SYSTEMTIME) -> windows_sys::core::BOOL);
...
windows_link::link!("kernel32.dll" "system" fn FindNLSStringEx(lplocalename : windows_sys::core::PCWSTR, dwfindnlsstringflags : u32, lpstringsource : windows_sys::core::PCWSTR, cchsource : i32, lpstringvalue : windows_sys::core::PCWSTR, cchvalue : i32, pcchfound : *mut i32, lpversioninformation : *mut NLSVERSIONINFO, lpreserved : *mut core::ffi::c_void, sorthandle : super::Foundation:: LPARAM) -> i32);
...
windows_link::link!("kernel32.dll" "system" fn FoldStringA(dwmapflags : FOLD_STRING_MAP_FLAGS, lpsrcstr : windows_sys::core::PCSTR, cchsrc : i32, lpdeststr : windows_sys::core::PCSTR, cchdest : i32) -> i32);
windows_link::link!("kernel32.dll" "system" fn FoldStringW(dwmapflags : FOLD_STRING_MAP_FLAGS, lpsrcstr : windows_sys::core::PCWSTR, cchsrc : i32, lpdeststr : windows_sys::core::PCWSTR, cchdest : i32) -> i32);
...
windows_link::link!("kernel32.dll" "system" fn GetCalendarInfoA(locale : u32, calendar : u32, caltype : u32, lpcaldata : windows_sys::core::PCSTR, cchdata : i32, lpvalue : *mut u32) -> i32);
windows_link::link!("kernel32.dll" "system" fn GetCalendarInfoEx(lplocalename : windows_sys::core::PCWSTR, calendar : u32, lpreserved : windows_sys::core::PCWSTR, caltype : u32, lpcaldata : windows_sys::core::PCWSTR, cchdata : i32, lpvalue : *mut u32) -> i32);
windows_link::link!("kernel32.dll" "system" fn GetCalendarInfoW(locale : u32, calendar : u32, caltype : u32, lpcaldata : windows_sys::core::PCWSTR, cchdata : i32, lpvalue : *mut u32) -> i32);
...
windows_link::link!("kernel32.dll" "system" fn GetCurrencyFormatA(locale : u32, dwflags : u32, lpvalue : windows_sys::core::PCSTR, lpformat : *mut CURRENCYFMTA, lpcurrencystr : windows_sys::core::PCSTR, cchcurrency : i32) -> i32);
windows_link::link!("kernel32.dll" "system" fn GetCurrencyFormatEx(lplocalename : windows_sys::core::PCWSTR, dwflags : u32, lpvalue : windows_sys::core::PCWSTR, lpformat : *mut CURRENCYFMTW, lpcurrencystr : windows_sys::core::PCWSTR, cchcurrency : i32) -> i32);
windows_link::link!("kernel32.dll" "system" fn GetCurrencyFormatW(locale : u32, dwflags : u32, lpvalue : windows_sys::core::PCWSTR, lpformat : *mut CURRENCYFMTW, lpcurrencystr : windows_sys::core::PCWSTR, cchcurrency : i32) -> i32);
windows_link::link!("kernel32.dll" "system" fn GetDateFormatA(locale : u32, dwflags : u32, lpdate : *mut super::Foundation:: SYSTEMTIME, lpformat : windows_sys::core::PCSTR, lpdatestr : windows_sys::core::PCSTR, cchdate : i32) -> i32);
...
windows_link::link!("kernel32.dll" "system" fn GetDateFormatW(locale : u32, dwflags : u32, lpdate : *mut super::Foundation:: SYSTEMTIME, lpformat : windows_sys::core::PCWSTR, lpdatestr : windows_sys::core::PCWSTR, cchdate : i32) -> i32);
...
windows_link::link!("kernel32.dll" "system" fn GetDurationFormat(locale : u32, dwflags : u32, lpduration : *mut super::Foundation:: SYSTEMTIME, ullduration : u64, lpformat : windows_sys::core::PCWSTR, lpdurationstr : windows_sys::core::PCWSTR, cchduration : i32) -> i32);
...
windows_link::link!("kernel32.dll" "system" fn GetFileMUIPath(dwflags : u32, pcwszfilepath : windows_sys::core::PCWSTR, pwszlanguage : windows_sys::core::PCWSTR, pcchlanguage : *mut u32, pwszfilemuipath : windows_sys::core::PCWSTR, pcchfilemuipath : *mut u32, pululenumerator : *mut u64) -> windows_sys::core::BOOL);
windows_link::link!("kernel32.dll" "system" fn GetGeoInfoA(location : i32, geotype : SYSGEOTYPE, lpgeodata : windows_sys::core::PCSTR, cchdata : i32, langid : u16) -> i32);
...
windows_link::link!("kernel32.dll" "system" fn GetGeoInfoW(location : i32, geotype : SYSGEOTYPE, lpgeodata : windows_sys::core::PCWSTR, cchdata : i32, langid : u16) -> i32);
windows_link::link!("kernel32.dll" "system" fn GetLocaleInfoA(locale : u32, lctype : u32, lplcdata : windows_sys::core::PCSTR, cchdata : i32) -> i32);
windows_link::link!("kernel32.dll" "system" fn GetLocaleInfoEx(lplocalename : windows_sys::core::PCWSTR, lctype : u32, lplcdata : windows_sys::core::PCWSTR, cchdata : i32) -> i32);
...
windows_link::link!("kernel32.dll" "system" fn GetNumberFormatA(locale : u32, dwflags : u32, lpvalue : windows_sys::core::PCSTR, lpformat : *mut NUMBERFMTA, lpnumberstr : windows_sys::core::PCSTR, cchnumber : i32) -> i32);
windows_link::link!("kernel32.dll" "system" fn GetNumberFormatEx(lplocalename : windows_sys::core::PCWSTR, dwflags : u32, lpvalue : windows_sys::core::PCWSTR, lpformat : *mut NUMBERFMTW, lpnumberstr : windows_sys::core::PCWSTR, cchnumber : i32) -> i32);
windows_link::link!("kernel32.dll" "system" fn GetNumberFormatW(locale : u32, dwflags : u32, lpvalue : windows_sys::core::PCWSTR, lpformat : *mut NUMBERFMTW, lpnumberstr : windows_sys::core::PCWSTR, cchnumber : i32) -> i32);
windows_link::link!("kernel32.dll" "system" fn GetOEMCP() -> u32);
windows_link::link!("kernel32.dll" "system" fn GetProcessPreferredUILanguages(dwflags : u32, pulnumlanguages : *mut u32, pwszlanguagesbuffer : windows_sys::core::PCWSTR, pcchlanguagesbuffer : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("kernel32.dll" "system" fn GetStringScripts(dwflags : u32, lpstring : windows_sys::core::PCWSTR, cchstring : i32, lpscripts : windows_sys::core::PCWSTR, cchscripts : i32) -> i32);
...
windows_link::link!("kernel32.dll" "system" fn GetSystemDefaultLocaleName(lplocalename : windows_sys::core::PCWSTR, cchlocalename : i32) -> i32);
windows_link::link!("kernel32.dll" "system" fn GetSystemDefaultUILanguage() -> u16);
windows_link::link!("kernel32.dll" "system" fn GetSystemPreferredUILanguages(dwflags : u32, pulnumlanguages : *mut u32, pwszlanguagesbuffer : windows_sys::core::PCWSTR, pcchlanguagesbuffer : *mut u32) -> windows_sys::core::BOOL);
...
windows_link::link!("kernel32.dll" "system" fn GetTimeFormatA(locale : u32, dwflags : u32, lptime : *mut super::Foundation:: SYSTEMTIME, lpformat : windows_sys::core::PCSTR, lptimestr : windows_sys::core::PCSTR, cchtime : i32) -> i32);
...
windows_link::link!("kernel32.dll" "system" fn GetTimeFormatW(locale : u32, dwflags : u32, lptime : *mut super::Foundation:: SYSTEMTIME, lpformat : windows_sys::core::PCWSTR, lptimestr : windows_sys::core::PCWSTR, cchtime : i32) -> i32);
windows_link::link!("kernel32.dll" "system" fn GetUILanguageInfo(dwflags : u32, pwmszlanguage : windows_sys::core::PCWSTR, pwszfallbacklanguages : windows_sys::core::PCWSTR, pcchfallbacklanguages : *mut u32, pattributes : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("kernel32.dll" "system" fn GetUserDefaultGeoName(geoname : windows_sys::core::PCWSTR, geonamecount : i32) -> i32);
...
windows_link::link!("kernel32.dll" "system" fn GetUserDefaultLocaleName(lplocalename : windows_sys::core::PCWSTR, cchlocalename : i32) -> i32);
...
windows_link::link!("kernel32.dll" "system" fn GetUserPreferredUILanguages(dwflags : u32, pulnumlanguages : *mut u32, pwszlanguagesbuffer : windows_sys::core::PCWSTR, pcchlanguagesbuffer : *mut u32) -> windows_sys::core::BOOL);
windows_link::link!("normaliz.dll" "system" fn IdnToAscii(dwflags : u32, lpunicodecharstr : windows_sys::core::PCWSTR, cchunicodechar : i32, lpasciicharstr : windows_sys::core::PCWSTR, cchasciichar : i32) -> i32);
...
windows_link::link!("normaliz.dll" "system" fn IdnToUnicode(dwflags : u32, lpasciicharstr : windows_sys::core::PCWSTR, cchasciichar : i32, lpunicodecharstr : windows_sys::core::PCWSTR, cchunicodechar : i32) -> i32);
...
windows_link::link!("kernel32.dll" "system" fn IsNLSDefinedString(function : u32, dwflags : u32, lpversioninformation : *mut NLSVERSIONINFO, lpstring : windows_sys::core::PCWSTR, cchstr : i32) -> windows_sys::core::BOOL);
...
windows_link::link!("advapi32.dll" "system" fn IsTextUnicode(lpv : *mut core::ffi::c_void, isize : i32, lpiresult : *mut IS_TEXT_UNICODE_RESULT) -> windows_sys::core::BOOL);
...
windows_link::link!("kernel32.dll" "system" fn LCIDToLocaleName(locale : u32, lpname : windows_sys::core::PCWSTR, cchname : i32, dwflags : u32) -> i32);
windows_link::link!("kernel32.dll" "system" fn LCMapStringA(locale : u32, dwmapflags : u32, lpsrcstr : windows_sys::core::PCSTR, cchsrc : i32, lpdeststr : windows_sys::core::PCSTR, cchdest : i32) -> i32);
windows_link::link!("kernel32.dll" "system" fn LCMapStringEx(lplocalename : windows_sys::core::PCWSTR, dwmapflags : u32, lpsrcstr : windows_sys::core::PCWSTR, cchsrc : i32, lpdeststr : windows_sys::core::PCWSTR, cchdest : i32, lpversioninformation : *mut NLSVERSIONINFO, lpreserved : *mut core::ffi::c_void, sorthandle : super::Foundation:: LPARAM) -> i32);
windows_link::link!("kernel32.dll" "system" fn LCMapStringW(locale : u32, dwmapflags : u32, lpsrcstr : windows_sys::core::PCWSTR, cchsrc : i32, lpdeststr : windows_sys::core::PCWSTR, cchdest : i32) -> i32);
...
windows_link::link!("elscore.dll" "system" fn MappingFreePropertyBag(pbag : *mut MAPPING_PROPERTY_BAG) -> windows_sys::core::HRESULT);
...
windows_link::link!("elscore.dll" "system" fn MappingGetServices(poptions : *mut MAPPING_ENUM_OPTIONS, prgservices : *mut *mut MAPPING_SERVICE_INFO, pdwservicescount : *mut u32) -> windows_sys::core::HRESULT);
windows_link::link!("elscore.dll" "system" fn MappingRecognizeText(pserviceinfo : *mut MAPPING_SERVICE_INFO, psztext : windows_sys::core::PCWSTR, dwlength : u32, dwindex : u32, poptions : *mut MAPPING_OPTIONS, pbag : *mut MAPPING_PROPERTY_BAG) -> windows_sys::core::HRESULT);
windows_link::link!("kernel32.dll" "system" fn MultiByteToWideChar(codepage : u32, dwflags : MULTI_BYTE_TO_WIDE_CHAR_FLAGS, lpmultibytestr : windows_sys::core::PCSTR, cbmultibyte : i32, lpwidecharstr : windows_sys::core::PCWSTR, cchwidechar : i32) -> i32);
...
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("usp10.dll" "system" fn ScriptApplyLogicalWidth(pidx : *mut i32, cchars : i32, cglyphs : i32, pwlogclust : *mut u16, psva : *mut SCRIPT_VISATTR, piadvance : *mut i32, psa : *mut SCRIPT_ANALYSIS, pabc : *mut super::Graphics::Gdi:: ABC, pijustify : *mut i32) -> windows_sys::core::HRESULT);
windows_link::link!("usp10.dll" "system" fn ScriptBreak(pwcchars : windows_sys::core::PCWSTR, cchars : i32, psa : *mut SCRIPT_ANALYSIS, psla : *mut SCRIPT_LOGATTR) -> windows_sys::core::HRESULT);
windows_link::link!("usp10.dll" "system" fn ScriptCPtoX(icp : i32, ftrailing : windows_sys::core::BOOL, cchars : i32, cglyphs : i32, pwlogclust : *mut u16, psva : *mut SCRIPT_VISATTR, piadvance : *mut i32, psa : *mut SCRIPT_ANALYSIS, pix : *mut i32) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("usp10.dll" "system" fn ScriptGetFontAlternateGlyphs(hdc : super::Graphics::Gdi:: HDC, psc : *mut *mut core::ffi::c_void, psa : *mut SCRIPT_ANALYSIS, tagscript : u32, taglangsys : u32, tagfeature : u32, wglyphid : u16, cmaxalternates : i32, palternateglyphs : *mut u16, pcalternates : *mut i32) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("usp10.dll" "system" fn ScriptGetFontLanguageTags(hdc : super::Graphics::Gdi:: HDC, psc : *mut *mut core::ffi::c_void, psa : *mut SCRIPT_ANALYSIS, tagscript : u32, cmaxtags : i32, plangsystags : *mut u32, pctags : *mut i32) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
windows_link::link!("usp10.dll" "system" fn ScriptGetLogicalWidths(psa : *mut SCRIPT_ANALYSIS, cchars : i32, cglyphs : i32, piglyphwidth : *mut i32, pwlogclust : *mut u16, psva : *mut SCRIPT_VISATTR, pidx : *mut i32) -> windows_sys::core::HRESULT);
...
windows_link::link!("usp10.dll" "system" fn ScriptItemize(pwcinchars : windows_sys::core::PCWSTR, cinchars : i32, cmaxitems : i32, pscontrol : *mut SCRIPT_CONTROL, psstate : *mut SCRIPT_STATE, pitems : *mut SCRIPT_ITEM, pcitems : *mut i32) -> windows_sys::core::HRESULT);
windows_link::link!("usp10.dll" "system" fn ScriptItemizeOpenType(pwcinchars : windows_sys::core::PCWSTR, cinchars : i32, cmaxitems : i32, pscontrol : *mut SCRIPT_CONTROL, psstate : *mut SCRIPT_STATE, pitems : *mut SCRIPT_ITEM, pscripttags : *mut u32, pcitems : *mut i32) -> windows_sys::core::HRESULT);
windows_link::link!("usp10.dll" "system" fn ScriptJustify(psva : *mut SCRIPT_VISATTR, piadvance : *mut i32, cglyphs : i32, idx : i32, iminkashida : i32, pijustify : *mut i32) -> windows_sys::core::HRESULT);
windows_link::link!("usp10.dll" "system" fn ScriptLayout(cruns : i32, pblevel : *mut u8, pivisualtological : *mut i32, pilogicaltovisual : *mut i32) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("usp10.dll" "system" fn ScriptPlace(hdc : super::Graphics::Gdi:: HDC, psc : *mut *mut core::ffi::c_void, pwglyphs : *mut u16, cglyphs : i32, psva : *mut SCRIPT_VISATTR, psa : *mut SCRIPT_ANALYSIS, piadvance : *mut i32, pgoffset : *mut GOFFSET, pabc : *mut super::Graphics::Gdi:: ABC) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("usp10.dll" "system" fn ScriptPositionSingleGlyph(hdc : super::Graphics::Gdi:: HDC, psc : *mut *mut core::ffi::c_void, psa : *mut SCRIPT_ANALYSIS, tagscript : u32, taglangsys : u32, tagfeature : u32, lparameter : i32, wglyphid : u16, iadvance : i32, goffset : GOFFSET, pioutadvance : *mut i32, poutgoffset : *mut GOFFSET) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("usp10.dll" "system" fn ScriptShapeOpenType(hdc : super::Graphics::Gdi:: HDC, psc : *mut *mut core::ffi::c_void, psa : *mut SCRIPT_ANALYSIS, tagscript : u32, taglangsys : u32, rcrangechars : *mut i32, rprangeproperties : *mut *mut TEXTRANGE_PROPERTIES, cranges : i32, pwcchars : windows_sys::core::PCWSTR, cchars : i32, cmaxglyphs : i32, pwlogclust : *mut u16, pcharprops : *mut SCRIPT_CHARPROP, pwoutglyphs : *mut u16, poutglyphprops : *mut SCRIPT_GLYPHPROP, pcglyphs : *mut i32) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
windows_link::link!("usp10.dll" "system" fn ScriptStringGetLogicalWidths(ssa : *mut core::ffi::c_void, pidx : *mut i32) -> windows_sys::core::HRESULT);
windows_link::link!("usp10.dll" "system" fn ScriptStringGetOrder(ssa : *mut core::ffi::c_void, puorder : *mut u32) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Graphics_Gdi")]
...
windows_link::link!("usp10.dll" "system" fn ScriptStringValidate(ssa : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("usp10.dll" "system" fn ScriptStringXtoCP(ssa : *mut core::ffi::c_void, ix : i32, pich : *mut i32, pitrailing : *mut i32) -> windows_sys::core::HRESULT);
windows_link::link!("usp10.dll" "system" fn ScriptString_pLogAttr(ssa : *const core::ffi::c_void) -> *mut SCRIPT_LOGATTR);
windows_link::link!("usp10.dll" "system" fn ScriptString_pSize(ssa : *mut core::ffi::c_void) -> *mut super::Foundation:: SIZE);
...
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_link::link!("usp10.dll" "system" fn ScriptTextOut(hdc : super::Graphics::Gdi:: HDC, psc : *mut *mut core::ffi::c_void, x : i32, y : i32, fuoptions : u32, lprc : *mut super::Foundation:: RECT, psa : *mut SCRIPT_ANALYSIS, pwcreserved : windows_sys::core::PCWSTR, ireserved : i32, pwglyphs : *mut u16, cglyphs : i32, piadvance : *mut i32, pijustify : *mut i32, pgoffset : *mut GOFFSET) -> windows_sys::core::HRESULT);
windows_link::link!("usp10.dll" "system" fn ScriptXtoCP(ix : i32, cchars : i32, cglyphs : i32, pwlogclust : *mut u16, psva : *mut SCRIPT_VISATTR, piadvance : *mut i32, psa : *mut SCRIPT_ANALYSIS, picp : *mut i32, pitrailing : *mut i32) -> windows_sys::core::HRESULT);
...
windows_link::link!("icuuc.dll" "C" fn UCNV_FROM_U_CALLBACK_ESCAPE(context : *mut core::ffi::c_void, fromuargs : *mut UConverterFromUnicodeArgs, codeunits : *mut u16, length : i32, codepoint : i32, reason : UConverterCallbackReason, err : *mut UErrorCode));
...
windows_link::link!("icuuc.dll" "C" fn UCNV_FROM_U_CALLBACK_STOP(context : *mut core::ffi::c_void, fromuargs : *mut UConverterFromUnicodeArgs, codeunits : *mut u16, length : i32, codepoint : i32, reason : UConverterCallbackReason, err : *mut UErrorCode));
...
windows_link::link!("icuuc.dll" "C" fn UCNV_TO_U_CALLBACK_ESCAPE(context : *mut core::ffi::c_void, touargs : *mut UConverterToUnicodeArgs, codeunits : windows_sys::core::PCSTR, length : i32, reason : UConverterCallbackReason, err : *mut UErrorCode));
windows_link::link!("icuuc.dll" "C" fn UCNV_TO_U_CALLBACK_SKIP(context : *mut core::ffi::c_void, touargs : *mut UConverterToUnicodeArgs, codeunits : windows_sys::core::PCSTR, length : i32, reason : UConverterCallbackReason, err : *mut UErrorCode));
windows_link::link!("icuuc.dll" "C" fn UCNV_TO_U_CALLBACK_STOP(context : *mut core::ffi::c_void, touargs : *mut UConverterToUnicodeArgs, codeunits : windows_sys::core::PCSTR, length : i32, reason : UConverterCallbackReason, err : *mut UErrorCode));
windows_link::link!("icuuc.dll" "C" fn UCNV_TO_U_CALLBACK_SUBSTITUTE(context : *mut core::ffi::c_void, touargs : *mut UConverterToUnicodeArgs, codeunits : windows_sys::core::PCSTR, length : i32, reason : UConverterCallbackReason, err : *mut UErrorCode));
...
windows_link::link!("kernel32.dll" "system" fn WideCharToMultiByte(codepage : u32, dwflags : u32, lpwidecharstr : windows_sys::core::PCWSTR, cchwidechar : i32, lpmultibytestr : windows_sys::core::PCSTR, cbmultibyte : i32, lpdefaultchar : windows_sys::core::PCSTR, lpuseddefaultchar : *mut windows_sys::core::BOOL) -> i32);
windows_link::link!("kernel32.dll" "system" fn lstrcatA(lpstring1 : windows_sys::core::PCSTR, lpstring2 : windows_sys::core::PCSTR) -> windows_sys::core::PSTR);
windows_link::link!("kernel32.dll" "system" fn lstrcatW(lpstring1 : windows_sys::core::PCWSTR, lpstring2 : windows_sys::core::PCWSTR) -> windows_sys::core::PWSTR);
...
windows_link::link!("kernel32.dll" "system" fn lstrcpyA(lpstring1 : windows_sys::core::PCSTR, lpstring2 : windows_sys::core::PCSTR) -> windows_sys::core::PSTR);
...
windows_link::link!("kernel32.dll" "system" fn lstrcpynA(lpstring1 : windows_sys::core::PCSTR, lpstring2 : windows_sys::core::PCSTR, imaxlength : i32) -> windows_sys::core::PSTR);
windows_link::link!("kernel32.dll" "system" fn lstrcpynW(lpstring1 : windows_sys::core::PCWSTR, lpstring2 : windows_sys::core::PCWSTR, imaxlength : i32) -> windows_sys::core::PWSTR);
...
windows_link::link!("icuuc.dll" "C" fn u_UCharsToChars(us : *mut u16, cs : windows_sys::core::PCSTR, length : i32));
windows_link::link!("icuuc.dll" "C" fn u_austrcpy(dst : windows_sys::core::PCSTR, src : *mut u16) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn u_austrncpy(dst : windows_sys::core::PCSTR, src : *mut u16, n : i32) -> windows_sys::core::PSTR);
...
windows_link::link!("icuuc.dll" "C" fn u_countChar32(s : *mut u16, length : i32) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn u_enumCharTypes(enumrange : *mut UCharEnumTypeRange, context : *mut core::ffi::c_void));
windows_link::link!("icuuc.dll" "C" fn u_errorName(code : UErrorCode) -> windows_sys::core::PSTR);
...
windows_link::link!("icuin.dll" "C" fn u_formatMessage(locale : windows_sys::core::PCSTR, pattern : *mut u16, patternlength : i32, result : *mut u16, resultlength : i32, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn u_getPropertyName(property : UProperty, namechoice : UPropertyNameChoice) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn u_getPropertyValueEnum(property : UProperty, alias : windows_sys::core::PCSTR) -> i32);
windows_link::link!("icuuc.dll" "C" fn u_getPropertyValueName(property : UProperty, value : i32, namechoice : UPropertyNameChoice) -> windows_sys::core::PSTR);
...
windows_link::link!("icuuc.dll" "C" fn u_memcasecmp(s1 : *mut u16, s2 : *mut u16, length : i32, options : u32) -> i32);
windows_link::link!("icuuc.dll" "C" fn u_memchr(s : *mut u16, c : u16, count : i32) -> *mut u16);
windows_link::link!("icuuc.dll" "C" fn u_memchr32(s : *mut u16, c : i32, count : i32) -> *mut u16);
windows_link::link!("icuuc.dll" "C" fn u_memcmp(buf1 : *mut u16, buf2 : *mut u16, count : i32) -> i32);
windows_link::link!("icuuc.dll" "C" fn u_memcmpCodePointOrder(s1 : *mut u16, s2 : *mut u16, count : i32) -> i32);
windows_link::link!("icuuc.dll" "C" fn u_memcpy(dest : *mut u16, src : *mut u16, count : i32) -> *mut u16);
windows_link::link!("icuuc.dll" "C" fn u_memmove(dest : *mut u16, src : *mut u16, count : i32) -> *mut u16);
windows_link::link!("icuuc.dll" "C" fn u_memrchr(s : *mut u16, c : u16, count : i32) -> *mut u16);
...
windows_link::link!("icuin.dll" "C" fn u_parseMessage(locale : windows_sys::core::PCSTR, pattern : *mut u16, patternlength : i32, source : *mut u16, sourcelength : i32, status : *mut UErrorCode));
windows_link::link!("icuin.dll" "C" fn u_parseMessageWithError(locale : windows_sys::core::PCSTR, pattern : *mut u16, patternlength : i32, source : *mut u16, sourcelength : i32, parseerror : *mut UParseError, status : *mut UErrorCode));
...
windows_link::link!("icuuc.dll" "C" fn u_shapeArabic(source : *mut u16, sourcelength : i32, dest : *mut u16, destsize : i32, options : u32, perrorcode : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn u_strCaseCompare(s1 : *mut u16, length1 : i32, s2 : *mut u16, length2 : i32, options : u32, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn u_strFindLast(s : *mut u16, length : i32, substring : *mut u16, sublength : i32) -> *mut u16);
...
windows_link::link!("icuuc.dll" "C" fn u_strFromUTF32(dest : *mut u16, destcapacity : i32, pdestlength : *mut i32, src : *mut i32, srclength : i32, perrorcode : *mut UErrorCode) -> *mut u16);
...
windows_link::link!("icuuc.dll" "C" fn u_strToJavaModifiedUTF8(dest : windows_sys::core::PCSTR, destcapacity : i32, pdestlength : *mut i32, src : *mut u16, srclength : i32, perrorcode : *mut UErrorCode) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn u_strToLower(dest : *mut u16, destcapacity : i32, src : *mut u16, srclength : i32, locale : windows_sys::core::PCSTR, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn u_strToUTF32(dest : *mut i32, destcapacity : i32, pdestlength : *mut i32, src : *mut u16, srclength : i32, perrorcode : *mut UErrorCode) -> *mut i32);
...
windows_link::link!("icuuc.dll" "C" fn u_strToUTF8(dest : windows_sys::core::PCSTR, destcapacity : i32, pdestlength : *mut i32, src : *mut u16, srclength : i32, perrorcode : *mut UErrorCode) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn u_strToUTF8WithSub(dest : windows_sys::core::PCSTR, destcapacity : i32, pdestlength : *mut i32, src : *mut u16, srclength : i32, subchar : i32, pnumsubstitutions : *mut i32, perrorcode : *mut UErrorCode) -> windows_sys::core::PSTR);
...
windows_link::link!("icuuc.dll" "C" fn u_strcat(dst : *mut u16, src : *mut u16) -> *mut u16);
windows_link::link!("icuuc.dll" "C" fn u_strchr(s : *mut u16, c : u16) -> *mut u16);
windows_link::link!("icuuc.dll" "C" fn u_strchr32(s : *mut u16, c : i32) -> *mut u16);
windows_link::link!("icuuc.dll" "C" fn u_strcmp(s1 : *mut u16, s2 : *mut u16) -> i32);
windows_link::link!("icuuc.dll" "C" fn u_strcmpCodePointOrder(s1 : *mut u16, s2 : *mut u16) -> i32);
windows_link::link!("icuuc.dll" "C" fn u_strcpy(dst : *mut u16, src : *const u16) -> *mut u16);
windows_link::link!("icuuc.dll" "C" fn u_strcspn(string : *mut u16, matchset : *mut u16) -> i32);
windows_link::link!("icuuc.dll" "C" fn u_strlen(s : *mut u16) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn u_strncmp(ucs1 : *mut u16, ucs2 : *mut u16, n : i32) -> i32);
windows_link::link!("icuuc.dll" "C" fn u_strncmpCodePointOrder(s1 : *const u16, s2 : *const u16, n : i32) -> i32);
windows_link::link!("icuuc.dll" "C" fn u_strncpy(dst : *mut u16, src : *mut u16, n : i32) -> *mut u16);
...
windows_link::link!("icuuc.dll" "C" fn u_strrstr(s : *mut u16, substring : *mut u16) -> *mut u16);
...
windows_link::link!("icuuc.dll" "C" fn u_versionToString(versionarray : *mut u8, versionstring : windows_sys::core::PCSTR));
...
windows_link::link!("icuin.dll" "C" fn u_vformatMessageWithError(locale : windows_sys::core::PCSTR, pattern : *mut u16, patternlength : i32, result : *mut u16, resultlength : i32, parseerror : *mut UParseError, ap : *mut i8, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn u_vparseMessage(locale : windows_sys::core::PCSTR, pattern : *mut u16, patternlength : i32, source : *mut u16, sourcelength : i32, ap : *mut i8, status : *mut UErrorCode));
windows_link::link!("icuin.dll" "C" fn u_vparseMessageWithError(locale : windows_sys::core::PCSTR, pattern : *mut u16, patternlength : i32, source : *mut u16, sourcelength : i32, ap : *mut i8, parseerror : *mut UParseError, status : *mut UErrorCode));
...
windows_link::link!("icuuc.dll" "C" fn ubidi_getDirection(pbidi : *mut UBiDi) -> UBiDiDirection);
windows_link::link!("icuuc.dll" "C" fn ubidi_getLength(pbidi : *mut UBiDi) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn ubidi_getParagraph(pbidi : *mut UBiDi, charindex : i32, pparastart : *mut i32, pparalimit : *mut i32, pparalevel : *mut u8, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn ubidi_getResultLength(pbidi : *mut UBiDi) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn ubidi_reorderLogical(levels : *mut u8, length : i32, indexmap : *mut i32));
windows_link::link!("icuuc.dll" "C" fn ubidi_reorderVisual(levels : *const u8, length : i32, indexmap : *mut i32));
windows_link::link!("icuuc.dll" "C" fn ubidi_setClassCallback(pbidi : *mut UBiDi, newfn : UBiDiClassCallback, newcontext : *mut core::ffi::c_void, oldfn : *mut UBiDiClassCallback, oldcontext : *mut *mut core::ffi::c_void, perrorcode : *mut UErrorCode));
...
windows_link::link!("icuuc.dll" "C" fn ubidi_setLine(pparabidi : *mut UBiDi, start : i32, limit : i32, plinebidi : *mut UBiDi, perrorcode : *mut UErrorCode));
...
windows_link::link!("icuuc.dll" "C" fn ubidi_writeReverse(src : *mut u16, srclength : i32, dest : *mut u16, destsize : i32, options : u16, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn ubiditransform_transform(pbiditransform : *mut UBiDiTransform, src : *mut u16, srclength : i32, dest : *mut u16, destsize : i32, inparalevel : u8, inorder : UBiDiOrder, outparalevel : u8, outorder : UBiDiOrder, domirroring : UBiDiMirroring, shapingoptions : u32, perrorcode : *mut UErrorCode) -> u32);
...
windows_link::link!("icuuc.dll" "C" fn ubrk_current(bi : *mut UBreakIterator) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn ubrk_getAvailable(index : i32) -> windows_sys::core::PSTR);
...
windows_link::link!("icuuc.dll" "C" fn ubrk_getLocaleByType(bi : *mut UBreakIterator, r#type : ULocDataLocaleType, status : *mut UErrorCode) -> windows_sys::core::PSTR);
...
windows_link::link!("icuuc.dll" "C" fn ubrk_openBinaryRules(binaryrules : *mut u8, ruleslength : i32, text : *mut u16, textlength : i32, status : *mut UErrorCode) -> *mut UBreakIterator);
windows_link::link!("icuuc.dll" "C" fn ubrk_openRules(rules : *mut u16, ruleslength : i32, text : *mut u16, textlength : i32, parseerr : *mut UParseError, status : *mut UErrorCode) -> *mut UBreakIterator);
...
windows_link::link!("icuuc.dll" "C" fn ubrk_setText(bi : *mut UBreakIterator, text : *mut u16, textlength : i32, status : *mut UErrorCode));
...
windows_link::link!("icuin.dll" "C" fn ucal_clone(cal : *mut *mut core::ffi::c_void, status : *mut UErrorCode) -> *mut *mut core::ffi::c_void);
...
windows_link::link!("icuin.dll" "C" fn ucal_equivalentTo(cal1 : *mut *mut core::ffi::c_void, cal2 : *mut *mut core::ffi::c_void) -> i8);
...
windows_link::link!("icuin.dll" "C" fn ucal_getAvailable(localeindex : i32) -> windows_sys::core::PSTR);
...
windows_link::link!("icuin.dll" "C" fn ucal_getDSTSavings(zoneid : *mut u16, ec : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn ucal_getDayOfWeekType(cal : *mut *mut core::ffi::c_void, dayofweek : UCalendarDaysOfWeek, status : *mut UErrorCode) -> UCalendarWeekdayType);
...
windows_link::link!("icuin.dll" "C" fn ucal_getLocaleByType(cal : *mut *mut core::ffi::c_void, r#type : ULocDataLocaleType, status : *mut UErrorCode) -> windows_sys::core::PSTR);
windows_link::link!("icuin.dll" "C" fn ucal_getMillis(cal : *mut *mut core::ffi::c_void, status : *mut UErrorCode) -> f64);
windows_link::link!("icuin.dll" "C" fn ucal_getNow() -> f64);
windows_link::link!("icuin.dll" "C" fn ucal_getTZDataVersion(status : *mut UErrorCode) -> windows_sys::core::PSTR);
windows_link::link!("icuin.dll" "C" fn ucal_getTimeZoneDisplayName(cal : *mut *mut core::ffi::c_void, r#type : UCalendarDisplayNameType, locale : windows_sys::core::PCSTR, result : *mut u16, resultlength : i32, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn ucal_getTimeZoneID(cal : *mut *mut core::ffi::c_void, result : *mut u16, resultlength : i32, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn ucal_getTimeZoneIDForWindowsID(winid : *mut u16, len : i32, region : windows_sys::core::PCSTR, id : *mut u16, idcapacity : i32, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn ucal_getTimeZoneTransitionDate(cal : *mut *mut core::ffi::c_void, r#type : UTimeZoneTransitionType, transition : *mut f64, status : *mut UErrorCode) -> i8);
windows_link::link!("icuin.dll" "C" fn ucal_getType(cal : *mut *mut core::ffi::c_void, status : *mut UErrorCode) -> windows_sys::core::PSTR);
...
windows_link::link!("icuin.dll" "C" fn ucal_inDaylightTime(cal : *mut *mut core::ffi::c_void, status : *mut UErrorCode) -> i8);
windows_link::link!("icuin.dll" "C" fn ucal_isSet(cal : *mut *mut core::ffi::c_void, field : UCalendarDateFields) -> i8);
windows_link::link!("icuin.dll" "C" fn ucal_isWeekend(cal : *mut *mut core::ffi::c_void, date : f64, status : *mut UErrorCode) -> i8);
windows_link::link!("icuin.dll" "C" fn ucal_open(zoneid : *mut u16, len : i32, locale : windows_sys::core::PCSTR, r#type : UCalendarType, status : *mut UErrorCode) -> *mut *mut core::ffi::c_void);
...
windows_link::link!("icuin.dll" "C" fn ucal_openTimeZoneIDEnumeration(zonetype : USystemTimeZoneType, region : windows_sys::core::PCSTR, rawoffset : *mut i32, ec : *mut UErrorCode) -> *mut UEnumeration);
...
windows_link::link!("icuin.dll" "C" fn ucal_setDefaultTimeZone(zoneid : *mut u16, ec : *mut UErrorCode));
...
windows_link::link!("icuuc.dll" "C" fn ucasemap_getBreakIterator(csm : *mut UCaseMap) -> *mut UBreakIterator);
windows_link::link!("icuuc.dll" "C" fn ucasemap_getLocale(csm : *const UCaseMap) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn ucasemap_getOptions(csm : *mut UCaseMap) -> u32);
...
windows_link::link!("icuuc.dll" "C" fn ucasemap_utf8FoldCase(csm : *mut UCaseMap, dest : windows_sys::core::PCSTR, destcapacity : i32, src : windows_sys::core::PCSTR, srclength : i32, perrorcode : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn ucasemap_utf8ToLower(csm : *mut UCaseMap, dest : windows_sys::core::PCSTR, destcapacity : i32, src : windows_sys::core::PCSTR, srclength : i32, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icu.dll" "C" fn ucfpos_getCategory(ucfpos : *mut UConstrainedFieldPosition, ec : *mut UErrorCode) -> i32);
...
windows_link::link!("icu.dll" "C" fn ucfpos_getInt64IterationContext(ucfpos : *mut UConstrainedFieldPosition, ec : *mut UErrorCode) -> i64);
...
windows_link::link!("icuuc.dll" "C" fn ucnv_cbToUWriteUChars(args : *mut UConverterToUnicodeArgs, source : *mut u16, length : i32, offsetindex : i32, err : *mut UErrorCode));
...
windows_link::link!("icuuc.dll" "C" fn ucnv_convertEx(targetcnv : *mut UConverter, sourcecnv : *mut UConverter, target : *mut *mut i8, targetlimit : windows_sys::core::PCSTR, source : *mut *mut i8, sourcelimit : windows_sys::core::PCSTR, pivotstart : *mut u16, pivotsource : *mut *mut u16, pivottarget : *mut *mut u16, pivotlimit : *mut u16, reset : i8, flush : i8, perrorcode : *mut UErrorCode));
...
windows_link::link!("icuuc.dll" "C" fn ucnv_detectUnicodeSignature(source : windows_sys::core::PCSTR, sourcelength : i32, signaturelength : *mut i32, perrorcode : *mut UErrorCode) -> windows_sys::core::PSTR);
...
windows_link::link!("icuuc.dll" "C" fn ucnv_fromUChars(cnv : *mut UConverter, dest : windows_sys::core::PCSTR, destcapacity : i32, src : *mut u16, srclength : i32, perrorcode : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn ucnv_fromUCountPending(cnv : *const UConverter, status : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn ucnv_fromUnicode(converter : *mut UConverter, target : *mut *mut i8, targetlimit : windows_sys::core::PCSTR, source : *mut *mut u16, sourcelimit : *mut u16, offsets : *mut i32, flush : i8, err : *mut UErrorCode));
windows_link::link!("icuuc.dll" "C" fn ucnv_getAlias(alias : windows_sys::core::PCSTR, n : u16, perrorcode : *mut UErrorCode) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn ucnv_getAliases(alias : windows_sys::core::PCSTR, aliases : *mut *mut i8, perrorcode : *mut UErrorCode));
windows_link::link!("icuuc.dll" "C" fn ucnv_getAvailableName(n : i32) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn ucnv_getCCSID(converter : *mut UConverter, err : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn ucnv_getCanonicalName(alias : windows_sys::core::PCSTR, standard : windows_sys::core::PCSTR, perrorcode : *mut UErrorCode) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn ucnv_getDefaultName() -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn ucnv_getDisplayName(converter : *mut UConverter, displaylocale : windows_sys::core::PCSTR, displayname : *mut u16, displaynamecapacity : i32, err : *mut UErrorCode) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn ucnv_getInvalidChars(converter : *mut UConverter, errbytes : windows_sys::core::PCSTR, len : *mut i8, err : *mut UErrorCode));
windows_link::link!("icuuc.dll" "C" fn ucnv_getInvalidUChars(converter : *mut UConverter, erruchars : *mut u16, len : *mut i8, err : *mut UErrorCode));
windows_link::link!("icuuc.dll" "C" fn ucnv_getMaxCharSize(converter : *mut UConverter) -> i8);
windows_link::link!("icuuc.dll" "C" fn ucnv_getMinCharSize(converter : *const UConverter) -> i8);
windows_link::link!("icuuc.dll" "C" fn ucnv_getName(converter : *mut UConverter, err : *mut UErrorCode) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn ucnv_getNextUChar(converter : *mut UConverter, source : *mut *mut i8, sourcelimit : windows_sys::core::PCSTR, err : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn ucnv_getPlatform(converter : *mut UConverter, err : *mut UErrorCode) -> UConverterPlatform);
windows_link::link!("icuuc.dll" "C" fn ucnv_getStandard(n : u16, perrorcode : *mut UErrorCode) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn ucnv_getStandardName(name : windows_sys::core::PCSTR, standard : windows_sys::core::PCSTR, perrorcode : *mut UErrorCode) -> windows_sys::core::PSTR);
...
windows_link::link!("icuuc.dll" "C" fn ucnv_getToUCallBack(converter : *mut UConverter, action : *mut UConverterToUCallback, context : *mut *mut core::ffi::c_void));
windows_link::link!("icuuc.dll" "C" fn ucnv_getType(converter : *mut UConverter) -> UConverterType);
...
windows_link::link!("icuuc.dll" "C" fn ucnv_isAmbiguous(cnv : *mut UConverter) -> i8);
...
windows_link::link!("icuuc.dll" "C" fn ucnv_openU(name : *mut u16, err : *mut UErrorCode) -> *mut UConverter);
...
windows_link::link!("icuuc.dll" "C" fn ucnv_safeClone(cnv : *mut UConverter, stackbuffer : *mut core::ffi::c_void, pbuffersize : *mut i32, status : *mut UErrorCode) -> *mut UConverter);
...
windows_link::link!("icuuc.dll" "C" fn ucnv_setFromUCallBack(converter : *mut UConverter, newaction : UConverterFromUCallback, newcontext : *mut core::ffi::c_void, oldaction : *mut UConverterFromUCallback, oldcontext : *mut *mut core::ffi::c_void, err : *mut UErrorCode));
...
windows_link::link!("icuuc.dll" "C" fn ucnv_setSubstString(cnv : *mut UConverter, s : *mut u16, length : i32, err : *mut UErrorCode));
windows_link::link!("icuuc.dll" "C" fn ucnv_setToUCallBack(converter : *mut UConverter, newaction : UConverterToUCallback, newcontext : *mut core::ffi::c_void, oldaction : *mut UConverterToUCallback, oldcontext : *mut *mut core::ffi::c_void, err : *mut UErrorCode));
...
windows_link::link!("icuuc.dll" "C" fn ucnv_toUCountPending(cnv : *mut UConverter, status : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn ucnv_toUnicode(converter : *mut UConverter, target : *mut *mut u16, targetlimit : *mut u16, source : *mut *mut i8, sourcelimit : windows_sys::core::PCSTR, offsets : *mut i32, flush : i8, err : *mut UErrorCode));
windows_link::link!("icuuc.dll" "C" fn ucnv_usesFallback(cnv : *mut UConverter) -> i8);
...
windows_link::link!("icuuc.dll" "C" fn ucnvsel_openFromSerialized(buffer : *mut core::ffi::c_void, length : i32, status : *mut UErrorCode) -> *mut UConverterSelector);
windows_link::link!("icuuc.dll" "C" fn ucnvsel_selectForString(sel : *mut UConverterSelector, s : *mut u16, length : i32, status : *mut UErrorCode) -> *mut UEnumeration);
windows_link::link!("icuuc.dll" "C" fn ucnvsel_selectForUTF8(sel : *mut UConverterSelector, s : windows_sys::core::PCSTR, length : i32, status : *mut UErrorCode) -> *mut UEnumeration);
...
windows_link::link!("icuin.dll" "C" fn ucol_cloneBinary(coll : *mut UCollator, buffer : *mut u8, capacity : i32, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn ucol_equal(coll : *mut UCollator, source : *mut u16, sourcelength : i32, target : *mut u16, targetlength : i32) -> i8);
windows_link::link!("icuin.dll" "C" fn ucol_getAttribute(coll : *mut UCollator, attr : UColAttribute, status : *mut UErrorCode) -> UColAttributeValue);
windows_link::link!("icuin.dll" "C" fn ucol_getAvailable(localeindex : i32) -> windows_sys::core::PSTR);
windows_link::link!("icuin.dll" "C" fn ucol_getBound(source : *mut u8, sourcelength : i32, boundtype : UColBoundMode, nooflevels : u32, result : *mut u8, resultlength : i32, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn ucol_getLocaleByType(coll : *mut UCollator, r#type : ULocDataLocaleType, status : *mut UErrorCode) -> windows_sys::core::PSTR);
...
windows_link::link!("icuin.dll" "C" fn ucol_getOffset(elems : *mut UCollationElements) -> i32);
...
windows_link::link!("icuin.dll" "C" fn ucol_getRules(coll : *mut UCollator, length : *mut i32) -> *mut u16);
...
windows_link::link!("icuin.dll" "C" fn ucol_getSortKey(coll : *mut UCollator, source : *mut u16, sourcelength : i32, result : *mut u8, resultlength : i32) -> i32);
windows_link::link!("icuin.dll" "C" fn ucol_getStrength(coll : *const UCollator) -> UColAttributeValue);
windows_link::link!("icuin.dll" "C" fn ucol_getTailoredSet(coll : *mut UCollator, status : *mut UErrorCode) -> *mut USet);
windows_link::link!("icuin.dll" "C" fn ucol_getUCAVersion(coll : *const UCollator, info : *mut u8));
windows_link::link!("icuin.dll" "C" fn ucol_getVariableTop(coll : *mut UCollator, status : *mut UErrorCode) -> u32);
windows_link::link!("icuin.dll" "C" fn ucol_getVersion(coll : *const UCollator, info : *mut u8));
windows_link::link!("icuin.dll" "C" fn ucol_greater(coll : *mut UCollator, source : *mut u16, sourcelength : i32, target : *mut u16, targetlength : i32) -> i8);
...
windows_link::link!("icuin.dll" "C" fn ucol_keyHashCode(key : *mut u8, length : i32) -> i32);
...
windows_link::link!("icuin.dll" "C" fn ucol_nextSortKeyPart(coll : *mut UCollator, iter : *mut UCharIterator, state : *mut u32, dest : *mut u8, count : i32, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn ucol_openBinary(bin : *mut u8, length : i32, base : *mut UCollator, status : *mut UErrorCode) -> *mut UCollator);
...
windows_link::link!("icuin.dll" "C" fn ucol_openRules(rules : *mut u16, ruleslength : i32, normalizationmode : UColAttributeValue, strength : UColAttributeValue, parseerror : *mut UParseError, status : *mut UErrorCode) -> *mut UCollator);
...
windows_link::link!("icuin.dll" "C" fn ucol_setText(elems : *mut UCollationElements, text : *mut u16, textlength : i32, status : *mut UErrorCode));
windows_link::link!("icuin.dll" "C" fn ucol_strcoll(coll : *mut UCollator, source : *mut u16, sourcelength : i32, target : *mut u16, targetlength : i32) -> UCollationResult);
windows_link::link!("icuin.dll" "C" fn ucol_strcollIter(coll : *mut UCollator, siter : *mut UCharIterator, titer : *mut UCharIterator, status : *mut UErrorCode) -> UCollationResult);
windows_link::link!("icuin.dll" "C" fn ucol_strcollUTF8(coll : *mut UCollator, source : windows_sys::core::PCSTR, sourcelength : i32, target : windows_sys::core::PCSTR, targetlength : i32, status : *mut UErrorCode) -> UCollationResult);
...
windows_link::link!("icu.dll" "C" fn ucpmap_getRange(map : *mut UCPMap, start : i32, option : UCPMapRangeOption, surrogatevalue : u32, filter : *mut UCPMapValueFilter, context : *mut core::ffi::c_void, pvalue : *mut u32) -> i32);
windows_link::link!("icu.dll" "C" fn ucptrie_close(trie : *mut UCPTrie));
windows_link::link!("icu.dll" "C" fn ucptrie_get(trie : *mut UCPTrie, c : i32) -> u32);
windows_link::link!("icu.dll" "C" fn ucptrie_getRange(trie : *mut UCPTrie, start : i32, option : UCPMapRangeOption, surrogatevalue : u32, filter : *mut UCPMapValueFilter, context : *mut core::ffi::c_void, pvalue : *mut u32) -> i32);
windows_link::link!("icu.dll" "C" fn ucptrie_getType(trie : *mut UCPTrie) -> UCPTrieType);
windows_link::link!("icu.dll" "C" fn ucptrie_getValueWidth(trie : *mut UCPTrie) -> UCPTrieValueWidth);
windows_link::link!("icu.dll" "C" fn ucptrie_internalSmallIndex(trie : *mut UCPTrie, c : i32) -> i32);
windows_link::link!("icu.dll" "C" fn ucptrie_internalSmallU8Index(trie : *const UCPTrie, lt1 : i32, t2 : u8, t3 : u8) -> i32);
windows_link::link!("icu.dll" "C" fn ucptrie_internalU8PrevIndex(trie : *mut UCPTrie, c : i32, start : *mut u8, src : *mut u8) -> i32);
windows_link::link!("icu.dll" "C" fn ucptrie_openFromBinary(r#type : UCPTrieType, valuewidth : UCPTrieValueWidth, data : *mut core::ffi::c_void, length : i32, pactuallength : *mut i32, perrorcode : *mut UErrorCode) -> *mut UCPTrie);
windows_link::link!("icu.dll" "C" fn ucptrie_toBinary(trie : *mut UCPTrie, data : *mut core::ffi::c_void, capacity : i32, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn ucsdet_getAllDetectableCharsets(ucsd : *mut UCharsetDetector, status : *mut UErrorCode) -> *mut UEnumeration);
windows_link::link!("icuin.dll" "C" fn ucsdet_getConfidence(ucsm : *const UCharsetMatch, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn ucsdet_getLanguage(ucsm : *const UCharsetMatch, status : *mut UErrorCode) -> windows_sys::core::PSTR);
windows_link::link!("icuin.dll" "C" fn ucsdet_getName(ucsm : *mut UCharsetMatch, status : *mut UErrorCode) -> windows_sys::core::PSTR);
windows_link::link!("icuin.dll" "C" fn ucsdet_getUChars(ucsm : *const UCharsetMatch, buf : *mut u16, cap : i32, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn ucsdet_isInputFilterEnabled(ucsd : *mut UCharsetDetector) -> i8);
...
windows_link::link!("icuuc.dll" "C" fn ucurr_getPluralName(currency : *mut u16, locale : windows_sys::core::PCSTR, ischoiceformat : *mut i8, pluralcount : windows_sys::core::PCSTR, len : *mut i32, ec : *mut UErrorCode) -> *mut u16);
windows_link::link!("icuuc.dll" "C" fn ucurr_getRoundingIncrement(currency : *mut u16, ec : *mut UErrorCode) -> f64);
...
windows_link::link!("icuuc.dll" "C" fn ucurr_isAvailable(isocode : *mut u16, from : f64, to : f64, errorcode : *mut UErrorCode) -> i8);
...
windows_link::link!("icuin.dll" "C" fn udat_adoptNumberFormatForFields(fmt : *mut *mut core::ffi::c_void, fields : *mut u16, numberformattoset : *mut *mut core::ffi::c_void, status : *mut UErrorCode));
windows_link::link!("icuin.dll" "C" fn udat_applyPattern(format : *mut *mut core::ffi::c_void, localized : i8, pattern : *mut u16, patternlength : i32));
...
windows_link::link!("icuin.dll" "C" fn udat_countSymbols(fmt : *mut *mut core::ffi::c_void, r#type : UDateFormatSymbolType) -> i32);
windows_link::link!("icuin.dll" "C" fn udat_format(format : *mut *mut core::ffi::c_void, datetoformat : f64, result : *mut u16, resultlength : i32, position : *mut UFieldPosition, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn udat_formatCalendar(format : *mut *mut core::ffi::c_void, calendar : *mut *mut core::ffi::c_void, result : *mut u16, capacity : i32, position : *mut UFieldPosition, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn udat_get2DigitYearStart(fmt : *mut *mut core::ffi::c_void, status : *mut UErrorCode) -> f64);
windows_link::link!("icuin.dll" "C" fn udat_getAvailable(localeindex : i32) -> windows_sys::core::PSTR);
windows_link::link!("icuin.dll" "C" fn udat_getBooleanAttribute(fmt : *mut *mut core::ffi::c_void, attr : UDateFormatBooleanAttribute, status : *mut UErrorCode) -> i8);
windows_link::link!("icuin.dll" "C" fn udat_getCalendar(fmt : *const *const core::ffi::c_void) -> *mut *mut core::ffi::c_void);
windows_link::link!("icuin.dll" "C" fn udat_getContext(fmt : *mut *mut core::ffi::c_void, r#type : UDisplayContextType, status : *mut UErrorCode) -> UDisplayContext);
windows_link::link!("icuin.dll" "C" fn udat_getLocaleByType(fmt : *const *const core::ffi::c_void, r#type : ULocDataLocaleType, status : *mut UErrorCode) -> windows_sys::core::PSTR);
windows_link::link!("icuin.dll" "C" fn udat_getNumberFormat(fmt : *const *const core::ffi::c_void) -> *mut *mut core::ffi::c_void);
windows_link::link!("icuin.dll" "C" fn udat_getNumberFormatForField(fmt : *mut *mut core::ffi::c_void, field : u16) -> *mut *mut core::ffi::c_void);
...
windows_link::link!("icuin.dll" "C" fn udat_isLenient(fmt : *mut *mut core::ffi::c_void) -> i8);
...
windows_link::link!("icuin.dll" "C" fn udat_parse(format : *mut *mut core::ffi::c_void, text : *mut u16, textlength : i32, parsepos : *mut i32, status : *mut UErrorCode) -> f64);
windows_link::link!("icuin.dll" "C" fn udat_parseCalendar(format : *mut *mut core::ffi::c_void, calendar : *mut *mut core::ffi::c_void, text : *mut u16, textlength : i32, parsepos : *mut i32, status : *mut UErrorCode));
...
windows_link::link!("icuin.dll" "C" fn udat_setCalendar(fmt : *mut *mut core::ffi::c_void, calendartoset : *mut *mut core::ffi::c_void));
...
windows_link::link!("icuin.dll" "C" fn udat_setNumberFormat(fmt : *mut *mut core::ffi::c_void, numberformattoset : *mut *mut core::ffi::c_void));
...
windows_link::link!("icuin.dll" "C" fn udatpg_addPattern(dtpg : *mut *mut core::ffi::c_void, pattern : *mut u16, patternlength : i32, r#override : i8, conflictingpattern : *mut u16, capacity : i32, plength : *mut i32, perrorcode : *mut UErrorCode) -> UDateTimePatternConflict);
...
windows_link::link!("icuin.dll" "C" fn udatpg_getAppendItemName(dtpg : *mut *mut core::ffi::c_void, field : UDateTimePatternField, plength : *mut i32) -> *mut u16);
windows_link::link!("icuin.dll" "C" fn udatpg_getBaseSkeleton(unuseddtpg : *mut *mut core::ffi::c_void, pattern : *mut u16, length : i32, baseskeleton : *mut u16, capacity : i32, perrorcode : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn udatpg_getBestPattern(dtpg : *mut *mut core::ffi::c_void, skeleton : *mut u16, length : i32, bestpattern : *mut u16, capacity : i32, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn udatpg_getDateTimeFormat(dtpg : *mut *mut core::ffi::c_void, plength : *mut i32) -> *mut u16);
windows_link::link!("icuin.dll" "C" fn udatpg_getDecimal(dtpg : *mut *mut core::ffi::c_void, plength : *mut i32) -> *mut u16);
windows_link::link!("icu.dll" "C" fn udatpg_getFieldDisplayName(dtpg : *mut *mut core::ffi::c_void, field : UDateTimePatternField, width : UDateTimePGDisplayWidth, fieldname : *mut u16, capacity : i32, perrorcode : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn udatpg_getPatternForSkeleton(dtpg : *mut *mut core::ffi::c_void, skeleton : *mut u16, skeletonlength : i32, plength : *mut i32) -> *mut u16);
windows_link::link!("icuin.dll" "C" fn udatpg_getSkeleton(unuseddtpg : *mut *mut core::ffi::c_void, pattern : *mut u16, length : i32, skeleton : *mut u16, capacity : i32, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn udatpg_openBaseSkeletons(dtpg : *mut *mut core::ffi::c_void, perrorcode : *mut UErrorCode) -> *mut UEnumeration);
...
windows_link::link!("icuin.dll" "C" fn udatpg_replaceFieldTypes(dtpg : *mut *mut core::ffi::c_void, pattern : *mut u16, patternlength : i32, skeleton : *mut u16, skeletonlength : i32, dest : *mut u16, destcapacity : i32, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn udatpg_setAppendItemName(dtpg : *mut *mut core::ffi::c_void, field : UDateTimePatternField, value : *mut u16, length : i32));
windows_link::link!("icuin.dll" "C" fn udatpg_setDateTimeFormat(dtpg : *const *const core::ffi::c_void, dtformat : *const u16, length : i32));
windows_link::link!("icuin.dll" "C" fn udatpg_setDecimal(dtpg : *mut *mut core::ffi::c_void, decimal : *mut u16, length : i32));
...
windows_link::link!("icuin.dll" "C" fn udtitvfmt_format(formatter : *mut UDateIntervalFormat, fromdate : f64, todate : f64, result : *mut u16, resultcapacity : i32, position : *mut UFieldPosition, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icu.dll" "C" fn udtitvfmt_resultAsValue(uresult : *mut UFormattedDateInterval, ec : *mut UErrorCode) -> *mut UFormattedValue);
...
windows_link::link!("icuuc.dll" "C" fn uenum_next(en : *mut UEnumeration, resultlength : *mut i32, status : *mut UErrorCode) -> windows_sys::core::PSTR);
...
windows_link::link!("icuuc.dll" "C" fn uenum_openUCharStringsEnumeration(strings : *mut *mut u16, count : i32, ec : *mut UErrorCode) -> *mut UEnumeration);
...
windows_link::link!("icuin.dll" "C" fn ufmt_getArrayLength(fmt : *mut *mut core::ffi::c_void, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn ufmt_getDate(fmt : *mut *mut core::ffi::c_void, status : *mut UErrorCode) -> f64);
windows_link::link!("icuin.dll" "C" fn ufmt_getDecNumChars(fmt : *mut *mut core::ffi::c_void, len : *mut i32, status : *mut UErrorCode) -> windows_sys::core::PSTR);
...
windows_link::link!("icuin.dll" "C" fn ufmt_getObject(fmt : *mut *mut core::ffi::c_void, status : *mut UErrorCode) -> *mut core::ffi::c_void);
...
windows_link::link!("icuin.dll" "C" fn ufmt_isNumeric(fmt : *mut *mut core::ffi::c_void) -> i8);
windows_link::link!("icuin.dll" "C" fn ufmt_open(status : *mut UErrorCode) -> *mut *mut core::ffi::c_void);
windows_link::link!("icu.dll" "C" fn ufmtval_getString(ufmtval : *mut UFormattedValue, plength : *mut i32, ec : *mut UErrorCode) -> *mut u16);
windows_link::link!("icu.dll" "C" fn ufmtval_nextPosition(ufmtval : *mut UFormattedValue, ucfpos : *mut UConstrainedFieldPosition, ec : *mut UErrorCode) -> i8);
windows_link::link!("icuin.dll" "C" fn ugender_getInstance(locale : windows_sys::core::PCSTR, status : *mut UErrorCode) -> *mut UGenderInfo);
windows_link::link!("icuin.dll" "C" fn ugender_getListGender(genderinfo : *mut UGenderInfo, genders : *mut UGender, size : i32, status : *mut UErrorCode) -> UGender);
windows_link::link!("icuuc.dll" "C" fn uidna_close(idna : *mut UIDNA));
windows_link::link!("icuuc.dll" "C" fn uidna_labelToASCII(idna : *mut UIDNA, label : *mut u16, length : i32, dest : *mut u16, capacity : i32, pinfo : *mut UIDNAInfo, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn uidna_labelToUnicode(idna : *mut UIDNA, label : *mut u16, length : i32, dest : *mut u16, capacity : i32, pinfo : *mut UIDNAInfo, perrorcode : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn uidna_labelToUnicodeUTF8(idna : *mut UIDNA, label : windows_sys::core::PCSTR, length : i32, dest : windows_sys::core::PCSTR, capacity : i32, pinfo : *mut UIDNAInfo, perrorcode : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn uidna_nameToASCII(idna : *mut UIDNA, name : *mut u16, length : i32, dest : *mut u16, capacity : i32, pinfo : *mut UIDNAInfo, perrorcode : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn uidna_nameToASCII_UTF8(idna : *mut UIDNA, name : windows_sys::core::PCSTR, length : i32, dest : windows_sys::core::PCSTR, capacity : i32, pinfo : *mut UIDNAInfo, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn uidna_nameToUnicodeUTF8(idna : *mut UIDNA, name : windows_sys::core::PCSTR, length : i32, dest : windows_sys::core::PCSTR, capacity : i32, pinfo : *mut UIDNAInfo, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn uiter_getState(iter : *mut UCharIterator) -> u32);
...
windows_link::link!("icuuc.dll" "C" fn uiter_setString(iter : *mut UCharIterator, s : *mut u16, length : i32));
...
windows_link::link!("icuuc.dll" "C" fn uldn_getContext(ldn : *mut ULocaleDisplayNames, r#type : UDisplayContextType, perrorcode : *mut UErrorCode) -> UDisplayContext);
windows_link::link!("icuuc.dll" "C" fn uldn_getDialectHandling(ldn : *const ULocaleDisplayNames) -> UDialectHandling);
windows_link::link!("icuuc.dll" "C" fn uldn_getLocale(ldn : *mut ULocaleDisplayNames) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn uldn_keyDisplayName(ldn : *mut ULocaleDisplayNames, key : windows_sys::core::PCSTR, result : *mut u16, maxresultsize : i32, perrorcode : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn uldn_keyValueDisplayName(ldn : *mut ULocaleDisplayNames, key : windows_sys::core::PCSTR, value : windows_sys::core::PCSTR, result : *mut u16, maxresultsize : i32, perrorcode : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn uldn_languageDisplayName(ldn : *mut ULocaleDisplayNames, lang : windows_sys::core::PCSTR, result : *mut u16, maxresultsize : i32, perrorcode : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn uldn_localeDisplayName(ldn : *mut ULocaleDisplayNames, locale : windows_sys::core::PCSTR, result : *mut u16, maxresultsize : i32, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn uldn_scriptCodeDisplayName(ldn : *mut ULocaleDisplayNames, scriptcode : UScriptCode, result : *mut u16, maxresultsize : i32, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn uldn_variantDisplayName(ldn : *mut ULocaleDisplayNames, variant : windows_sys::core::PCSTR, result : *mut u16, maxresultsize : i32, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn ulistfmt_format(listfmt : *mut UListFormatter, strings : *mut *mut u16, stringlengths : *mut i32, stringcount : i32, result : *mut u16, resultcapacity : i32, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icu.dll" "C" fn ulistfmt_resultAsValue(uresult : *mut UFormattedList, ec : *mut UErrorCode) -> *mut UFormattedValue);
windows_link::link!("icuuc.dll" "C" fn uloc_acceptLanguage(result : windows_sys::core::PCSTR, resultavailable : i32, outresult : *mut UAcceptResult, acceptlist : *mut *mut i8, acceptlistcount : i32, availablelocales : *mut UEnumeration, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn uloc_getAvailable(n : i32) -> windows_sys::core::PSTR);
...
windows_link::link!("icuuc.dll" "C" fn uloc_getDefault() -> windows_sys::core::PSTR);
...
windows_link::link!("icuuc.dll" "C" fn uloc_getISO3Country(localeid : windows_sys::core::PCSTR) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn uloc_getISO3Language(localeid : windows_sys::core::PCSTR) -> windows_sys::core::PSTR);
...
windows_link::link!("icuuc.dll" "C" fn uloc_toLegacyKey(keyword : windows_sys::core::PCSTR) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn uloc_toLegacyType(keyword : windows_sys::core::PCSTR, value : windows_sys::core::PCSTR) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn uloc_toUnicodeLocaleKey(keyword : windows_sys::core::PCSTR) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn uloc_toUnicodeLocaleType(keyword : windows_sys::core::PCSTR, value : windows_sys::core::PCSTR) -> windows_sys::core::PSTR);
...
windows_link::link!("icuin.dll" "C" fn umsg_applyPattern(fmt : *mut *mut core::ffi::c_void, pattern : *mut u16, patternlength : i32, parseerror : *mut UParseError, status : *mut UErrorCode));
windows_link::link!("icuin.dll" "C" fn umsg_autoQuoteApostrophe(pattern : *mut u16, patternlength : i32, dest : *mut u16, destcapacity : i32, ec : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn umsg_format(fmt : *mut *mut core::ffi::c_void, result : *mut u16, resultlength : i32, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn umsg_getLocale(fmt : *mut *mut core::ffi::c_void) -> windows_sys::core::PSTR);
windows_link::link!("icuin.dll" "C" fn umsg_open(pattern : *mut u16, patternlength : i32, locale : windows_sys::core::PCSTR, parseerror : *mut UParseError, status : *mut UErrorCode) -> *mut *mut core::ffi::c_void);
windows_link::link!("icuin.dll" "C" fn umsg_parse(fmt : *mut *mut core::ffi::c_void, source : *mut u16, sourcelength : i32, count : *mut i32, status : *mut UErrorCode));
windows_link::link!("icuin.dll" "C" fn umsg_setLocale(fmt : *mut *mut core::ffi::c_void, locale : windows_sys::core::PCSTR));
windows_link::link!("icuin.dll" "C" fn umsg_toPattern(fmt : *mut *mut core::ffi::c_void, result : *mut u16, resultlength : i32, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn umsg_vformat(fmt : *mut *mut core::ffi::c_void, result : *mut u16, resultlength : i32, ap : *mut i8, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn umsg_vparse(fmt : *mut *mut core::ffi::c_void, source : *mut u16, sourcelength : i32, count : *mut i32, ap : *mut i8, status : *mut UErrorCode));
...
windows_link::link!("icu.dll" "C" fn umutablecptrie_fromUCPTrie(trie : *mut UCPTrie, perrorcode : *mut UErrorCode) -> *mut UMutableCPTrie);
windows_link::link!("icu.dll" "C" fn umutablecptrie_get(trie : *mut UMutableCPTrie, c : i32) -> u32);
windows_link::link!("icu.dll" "C" fn umutablecptrie_getRange(trie : *mut UMutableCPTrie, start : i32, option : UCPMapRangeOption, surrogatevalue : u32, filter : *mut UCPMapValueFilter, context : *mut core::ffi::c_void, pvalue : *mut u32) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn unorm2_append(norm2 : *mut UNormalizer2, first : *mut u16, firstlength : i32, firstcapacity : i32, second : *mut u16, secondlength : i32, perrorcode : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn unorm2_close(norm2 : *mut UNormalizer2));
windows_link::link!("icuuc.dll" "C" fn unorm2_composePair(norm2 : *mut UNormalizer2, a : i32, b : i32) -> i32);
windows_link::link!("icuuc.dll" "C" fn unorm2_getCombiningClass(norm2 : *const UNormalizer2, c : i32) -> u8);
windows_link::link!("icuuc.dll" "C" fn unorm2_getDecomposition(norm2 : *mut UNormalizer2, c : i32, decomposition : *mut u16, capacity : i32, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn unorm2_getRawDecomposition(norm2 : *mut UNormalizer2, c : i32, decomposition : *mut u16, capacity : i32, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn unorm2_isNormalized(norm2 : *mut UNormalizer2, s : *mut u16, length : i32, perrorcode : *mut UErrorCode) -> i8);
windows_link::link!("icuuc.dll" "C" fn unorm2_normalize(norm2 : *mut UNormalizer2, src : *mut u16, length : i32, dest : *mut u16, capacity : i32, perrorcode : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn unorm2_normalizeSecondAndAppend(norm2 : *mut UNormalizer2, first : *mut u16, firstlength : i32, firstcapacity : i32, second : *mut u16, secondlength : i32, perrorcode : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn unorm2_openFiltered(norm2 : *mut UNormalizer2, filterset : *mut USet, perrorcode : *mut UErrorCode) -> *mut UNormalizer2);
windows_link::link!("icuuc.dll" "C" fn unorm2_quickCheck(norm2 : *mut UNormalizer2, s : *mut u16, length : i32, perrorcode : *mut UErrorCode) -> UNormalizationCheckResult);
windows_link::link!("icuuc.dll" "C" fn unorm2_spanQuickCheckYes(norm2 : *mut UNormalizer2, s : *mut u16, length : i32, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn unum_clone(fmt : *mut *mut core::ffi::c_void, status : *mut UErrorCode) -> *mut *mut core::ffi::c_void);
...
windows_link::link!("icuin.dll" "C" fn unum_format(fmt : *mut *mut core::ffi::c_void, number : i32, result : *mut u16, resultlength : i32, pos : *mut UFieldPosition, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn unum_formatDecimal(fmt : *mut *mut core::ffi::c_void, number : windows_sys::core::PCSTR, length : i32, result : *mut u16, resultlength : i32, pos : *mut UFieldPosition, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn unum_formatDoubleCurrency(fmt : *mut *mut core::ffi::c_void, number : f64, currency : *mut u16, result : *mut u16, resultlength : i32, pos : *mut UFieldPosition, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn unum_formatInt64(fmt : *mut *mut core::ffi::c_void, number : i64, result : *mut u16, resultlength : i32, pos : *mut UFieldPosition, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn unum_formatUFormattable(fmt : *mut *mut core::ffi::c_void, number : *mut *mut core::ffi::c_void, result : *mut u16, resultlength : i32, pos : *mut UFieldPosition, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn unum_getAttribute(fmt : *mut *mut core::ffi::c_void, attr : UNumberFormatAttribute) -> i32);
windows_link::link!("icuin.dll" "C" fn unum_getAvailable(localeindex : i32) -> windows_sys::core::PSTR);
windows_link::link!("icuin.dll" "C" fn unum_getContext(fmt : *mut *mut core::ffi::c_void, r#type : UDisplayContextType, status : *mut UErrorCode) -> UDisplayContext);
windows_link::link!("icuin.dll" "C" fn unum_getDoubleAttribute(fmt : *const *const core::ffi::c_void, attr : UNumberFormatAttribute) -> f64);
windows_link::link!("icuin.dll" "C" fn unum_getLocaleByType(fmt : *mut *mut core::ffi::c_void, r#type : ULocDataLocaleType, status : *mut UErrorCode) -> windows_sys::core::PSTR);
...
windows_link::link!("icuin.dll" "C" fn unum_parseDouble(fmt : *mut *mut core::ffi::c_void, text : *mut u16, textlength : i32, parsepos : *mut i32, status : *mut UErrorCode) -> f64);
...
windows_link::link!("icuin.dll" "C" fn unum_parseInt64(fmt : *mut *mut core::ffi::c_void, text : *mut u16, textlength : i32, parsepos : *mut i32, status : *mut UErrorCode) -> i64);
...
windows_link::link!("icuin.dll" "C" fn unum_setTextAttribute(fmt : *mut *mut core::ffi::c_void, tag : UNumberFormatTextAttribute, newvalue : *mut u16, newvaluelength : i32, status : *mut UErrorCode));
windows_link::link!("icuin.dll" "C" fn unum_toPattern(fmt : *mut *mut core::ffi::c_void, ispatternlocalized : i8, result : *mut u16, resultlength : i32, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icu.dll" "C" fn unumf_formatDecimal(uformatter : *mut UNumberFormatter, value : windows_sys::core::PCSTR, valuelen : i32, uresult : *mut UFormattedNumber, ec : *mut UErrorCode));
windows_link::link!("icu.dll" "C" fn unumf_formatDouble(uformatter : *mut UNumberFormatter, value : f64, uresult : *mut UFormattedNumber, ec : *mut UErrorCode));
windows_link::link!("icu.dll" "C" fn unumf_formatInt(uformatter : *mut UNumberFormatter, value : i64, uresult : *mut UFormattedNumber, ec : *mut UErrorCode));
...
windows_link::link!("icu.dll" "C" fn unumf_resultAsValue(uresult : *mut UFormattedNumber, ec : *mut UErrorCode) -> *mut UFormattedValue);
...
windows_link::link!("icu.dll" "C" fn unumf_resultNextFieldPosition(uresult : *mut UFormattedNumber, ufpos : *mut UFieldPosition, ec : *mut UErrorCode) -> i8);
...
windows_link::link!("icuin.dll" "C" fn unumsys_getDescription(unumsys : *mut UNumberingSystem, result : *mut u16, resultlength : i32, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn unumsys_getName(unumsys : *const UNumberingSystem) -> windows_sys::core::PSTR);
windows_link::link!("icuin.dll" "C" fn unumsys_getRadix(unumsys : *mut UNumberingSystem) -> i32);
windows_link::link!("icuin.dll" "C" fn unumsys_isAlgorithmic(unumsys : *mut UNumberingSystem) -> i8);
...
windows_link::link!("icuin.dll" "C" fn uplrules_getKeywords(uplrules : *mut UPluralRules, status : *mut UErrorCode) -> *mut UEnumeration);
...
windows_link::link!("icuin.dll" "C" fn uregex_appendReplacement(regexp : *mut URegularExpression, replacementtext : *mut u16, replacementlength : i32, destbuf : *mut *mut u16, destcapacity : *mut i32, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn uregex_clone(regexp : *mut URegularExpression, status : *mut UErrorCode) -> *mut URegularExpression);
...
windows_link::link!("icuin.dll" "C" fn uregex_getMatchCallback(regexp : *mut URegularExpression, callback : *mut URegexMatchCallback, context : *mut *mut core::ffi::c_void, status : *mut UErrorCode));
windows_link::link!("icuin.dll" "C" fn uregex_getStackLimit(regexp : *mut URegularExpression, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn uregex_getTimeLimit(regexp : *mut URegularExpression, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn uregex_hasAnchoringBounds(regexp : *mut URegularExpression, status : *mut UErrorCode) -> i8);
windows_link::link!("icuin.dll" "C" fn uregex_hasTransparentBounds(regexp : *mut URegularExpression, status : *mut UErrorCode) -> i8);
windows_link::link!("icuin.dll" "C" fn uregex_hitEnd(regexp : *mut URegularExpression, status : *mut UErrorCode) -> i8);
...
windows_link::link!("icuin.dll" "C" fn uregex_patternUText(regexp : *mut URegularExpression, status : *mut UErrorCode) -> *mut UText);
windows_link::link!("icuin.dll" "C" fn uregex_refreshUText(regexp : *mut URegularExpression, text : *mut UText, status : *mut UErrorCode));
windows_link::link!("icuin.dll" "C" fn uregex_regionEnd(regexp : *mut URegularExpression, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn uregex_regionEnd64(regexp : *mut URegularExpression, status : *mut UErrorCode) -> i64);
windows_link::link!("icuin.dll" "C" fn uregex_regionStart(regexp : *const URegularExpression, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn uregex_regionStart64(regexp : *mut URegularExpression, status : *mut UErrorCode) -> i64);
...
windows_link::link!("icuin.dll" "C" fn uregex_requireEnd(regexp : *mut URegularExpression, status : *mut UErrorCode) -> i8);
...
windows_link::link!("icuin.dll" "C" fn uregex_setText(regexp : *mut URegularExpression, text : *mut u16, textlength : i32, status : *mut UErrorCode));
...
windows_link::link!("icuin.dll" "C" fn uregion_areEqual(uregion : *mut URegion, otherregion : *mut URegion) -> i8);
...
windows_link::link!("icuin.dll" "C" fn uregion_getContainedRegions(uregion : *mut URegion, status : *mut UErrorCode) -> *mut UEnumeration);
windows_link::link!("icuin.dll" "C" fn uregion_getContainedRegionsOfType(uregion : *mut URegion, r#type : URegionType, status : *mut UErrorCode) -> *mut UEnumeration);
windows_link::link!("icuin.dll" "C" fn uregion_getContainingRegion(uregion : *mut URegion) -> *mut URegion);
windows_link::link!("icuin.dll" "C" fn uregion_getContainingRegionOfType(uregion : *const URegion, r#type : URegionType) -> *mut URegion);
windows_link::link!("icuin.dll" "C" fn uregion_getNumericCode(uregion : *mut URegion) -> i32);
windows_link::link!("icuin.dll" "C" fn uregion_getPreferredValues(uregion : *mut URegion, status : *mut UErrorCode) -> *mut UEnumeration);
windows_link::link!("icuin.dll" "C" fn uregion_getRegionCode(uregion : *mut URegion) -> windows_sys::core::PSTR);
...
windows_link::link!("icuin.dll" "C" fn uregion_getType(uregion : *mut URegion) -> URegionType);
...
windows_link::link!("icuin.dll" "C" fn ureldatefmt_combineDateAndTime(reldatefmt : *mut URelativeDateTimeFormatter, relativedatestring : *mut u16, relativedatestringlen : i32, timestring : *mut u16, timestringlen : i32, result : *mut u16, resultcapacity : i32, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn ureldatefmt_formatNumeric(reldatefmt : *mut URelativeDateTimeFormatter, offset : f64, unit : URelativeDateTimeUnit, result : *mut u16, resultcapacity : i32, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icu.dll" "C" fn ureldatefmt_formatToResult(reldatefmt : *mut URelativeDateTimeFormatter, offset : f64, unit : URelativeDateTimeUnit, result : *mut UFormattedRelativeDateTime, status : *mut UErrorCode));
...
windows_link::link!("icu.dll" "C" fn ureldatefmt_resultAsValue(ufrdt : *mut UFormattedRelativeDateTime, ec : *mut UErrorCode) -> *mut UFormattedValue);
windows_link::link!("icuuc.dll" "C" fn ures_close(resourcebundle : *mut UResourceBundle));
windows_link::link!("icuuc.dll" "C" fn ures_getBinary(resourcebundle : *mut UResourceBundle, len : *mut i32, status : *mut UErrorCode) -> *mut u8);
windows_link::link!("icuuc.dll" "C" fn ures_getByIndex(resourcebundle : *mut UResourceBundle, indexr : i32, fillin : *mut UResourceBundle, status : *mut UErrorCode) -> *mut UResourceBundle);
windows_link::link!("icuuc.dll" "C" fn ures_getByKey(resourcebundle : *mut UResourceBundle, key : windows_sys::core::PCSTR, fillin : *mut UResourceBundle, status : *mut UErrorCode) -> *mut UResourceBundle);
...
windows_link::link!("icuuc.dll" "C" fn ures_getKey(resourcebundle : *const UResourceBundle) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn ures_getLocaleByType(resourcebundle : *mut UResourceBundle, r#type : ULocDataLocaleType, status : *mut UErrorCode) -> windows_sys::core::PSTR);
...
windows_link::link!("icuuc.dll" "C" fn ures_getNextString(resourcebundle : *mut UResourceBundle, len : *mut i32, key : *mut *mut i8, status : *mut UErrorCode) -> *mut u16);
windows_link::link!("icuuc.dll" "C" fn ures_getSize(resourcebundle : *const UResourceBundle) -> i32);
windows_link::link!("icuuc.dll" "C" fn ures_getString(resourcebundle : *mut UResourceBundle, len : *mut i32, status : *mut UErrorCode) -> *mut u16);
windows_link::link!("icuuc.dll" "C" fn ures_getStringByIndex(resourcebundle : *mut UResourceBundle, indexs : i32, len : *mut i32, status : *mut UErrorCode) -> *mut u16);
...
windows_link::link!("icuuc.dll" "C" fn ures_getType(resourcebundle : *mut UResourceBundle) -> UResType);
windows_link::link!("icuuc.dll" "C" fn ures_getUInt(resourcebundle : *mut UResourceBundle, status : *mut UErrorCode) -> u32);
windows_link::link!("icuuc.dll" "C" fn ures_getUTF8String(resb : *mut UResourceBundle, dest : windows_sys::core::PCSTR, length : *mut i32, forcecopy : i8, status : *mut UErrorCode) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn ures_getUTF8StringByIndex(resb : *const UResourceBundle, stringindex : i32, dest : windows_sys::core::PCSTR, plength : *mut i32, forcecopy : i8, status : *mut UErrorCode) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn ures_getUTF8StringByKey(resb : *mut UResourceBundle, key : windows_sys::core::PCSTR, dest : windows_sys::core::PCSTR, plength : *mut i32, forcecopy : i8, status : *mut UErrorCode) -> windows_sys::core::PSTR);
windows_link::link!("icuuc.dll" "C" fn ures_getVersion(resb : *mut UResourceBundle, versioninfo : *mut u8));
...
windows_link::link!("icuuc.dll" "C" fn ures_openU(packagename : *mut u16, locale : windows_sys::core::PCSTR, status : *mut UErrorCode) -> *mut UResourceBundle);
...
windows_link::link!("icuuc.dll" "C" fn uscript_getName(scriptcode : UScriptCode) -> windows_sys::core::PSTR);
...
windows_link::link!("icuuc.dll" "C" fn uscript_getShortName(scriptcode : UScriptCode) -> windows_sys::core::PSTR);
...
windows_link::link!("icuin.dll" "C" fn usearch_getAttribute(strsrch : *mut UStringSearch, attribute : USearchAttribute) -> USearchAttributeValue);
windows_link::link!("icuin.dll" "C" fn usearch_getBreakIterator(strsrch : *mut UStringSearch) -> *mut UBreakIterator);
windows_link::link!("icuin.dll" "C" fn usearch_getCollator(strsrch : *mut UStringSearch) -> *mut UCollator);
windows_link::link!("icuin.dll" "C" fn usearch_getMatchedLength(strsrch : *mut UStringSearch) -> i32);
windows_link::link!("icuin.dll" "C" fn usearch_getMatchedStart(strsrch : *mut UStringSearch) -> i32);
windows_link::link!("icuin.dll" "C" fn usearch_getMatchedText(strsrch : *mut UStringSearch, result : *mut u16, resultcapacity : i32, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn usearch_getOffset(strsrch : *mut UStringSearch) -> i32);
windows_link::link!("icuin.dll" "C" fn usearch_getPattern(strsrch : *const UStringSearch, length : *mut i32) -> *mut u16);
windows_link::link!("icuin.dll" "C" fn usearch_getText(strsrch : *mut UStringSearch, length : *mut i32) -> *mut u16);
...
windows_link::link!("icuin.dll" "C" fn usearch_setPattern(strsrch : *mut UStringSearch, pattern : *mut u16, patternlength : i32, status : *mut UErrorCode));
windows_link::link!("icuin.dll" "C" fn usearch_setText(strsrch : *mut UStringSearch, text : *mut u16, textlength : i32, status : *mut UErrorCode));
...
windows_link::link!("icuuc.dll" "C" fn uset_addAllCodePoints(set : *mut USet, str : *mut u16, strlen : i32));
windows_link::link!("icuuc.dll" "C" fn uset_addRange(set : *mut USet, start : i32, end : i32));
windows_link::link!("icuuc.dll" "C" fn uset_addString(set : *mut USet, str : *mut u16, strlen : i32));
windows_link::link!("icuuc.dll" "C" fn uset_applyIntPropertyValue(set : *mut USet, prop : UProperty, value : i32, ec : *mut UErrorCode));
windows_link::link!("icuuc.dll" "C" fn uset_applyPattern(set : *mut USet, pattern : *mut u16, patternlength : i32, options : u32, status : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn uset_applyPropertyAlias(set : *mut USet, prop : *mut u16, proplength : i32, value : *mut u16, valuelength : i32, ec : *mut UErrorCode));
windows_link::link!("icuuc.dll" "C" fn uset_charAt(set : *mut USet, charindex : i32) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn uset_complementAll(set : *mut USet, complement : *mut USet));
...
windows_link::link!("icuuc.dll" "C" fn uset_containsNone(set1 : *mut USet, set2 : *mut USet) -> i8);
windows_link::link!("icuuc.dll" "C" fn uset_containsRange(set : *mut USet, start : i32, end : i32) -> i8);
windows_link::link!("icuuc.dll" "C" fn uset_containsSome(set1 : *mut USet, set2 : *mut USet) -> i8);
windows_link::link!("icuuc.dll" "C" fn uset_containsString(set : *mut USet, str : *mut u16, strlen : i32) -> i8);
windows_link::link!("icuuc.dll" "C" fn uset_equals(set1 : *mut USet, set2 : *mut USet) -> i8);
windows_link::link!("icuuc.dll" "C" fn uset_freeze(set : *mut USet));
windows_link::link!("icuuc.dll" "C" fn uset_getItem(set : *mut USet, itemindex : i32, start : *mut i32, end : *mut i32, str : *mut u16, strcapacity : i32, ec : *mut UErrorCode) -> i32);
windows_link::link!("icuuc.dll" "C" fn uset_getItemCount(set : *mut USet) -> i32);
windows_link::link!("icuuc.dll" "C" fn uset_getSerializedRange(set : *mut USerializedSet, rangeindex : i32, pstart : *mut i32, pend : *mut i32) -> i8);
windows_link::link!("icuuc.dll" "C" fn uset_getSerializedRangeCount(set : *mut USerializedSet) -> i32);
windows_link::link!("icuuc.dll" "C" fn uset_getSerializedSet(fillset : *mut USerializedSet, src : *mut u16, srclength : i32) -> i8);
windows_link::link!("icuuc.dll" "C" fn uset_indexOf(set : *mut USet, c : i32) -> i32);
windows_link::link!("icuuc.dll" "C" fn uset_isEmpty(set : *mut USet) -> i8);
windows_link::link!("icuuc.dll" "C" fn uset_isFrozen(set : *mut USet) -> i8);
...
windows_link::link!("icuuc.dll" "C" fn uset_openPattern(pattern : *mut u16, patternlength : i32, ec : *mut UErrorCode) -> *mut USet);
windows_link::link!("icuuc.dll" "C" fn uset_openPatternOptions(pattern : *mut u16, patternlength : i32, options : u32, ec : *mut UErrorCode) -> *mut USet);
windows_link::link!("icuuc.dll" "C" fn uset_remove(set : *mut USet, c : i32));
windows_link::link!("icuuc.dll" "C" fn uset_removeAll(set : *mut USet, removeset : *mut USet));
...
windows_link::link!("icuuc.dll" "C" fn uset_removeString(set : *mut USet, str : *mut u16, strlen : i32));
...
windows_link::link!("icuuc.dll" "C" fn uset_serialize(set : *mut USet, dest : *mut u16, destcapacity : i32, perrorcode : *mut UErrorCode) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn uset_span(set : *mut USet, s : *mut u16, length : i32, spancondition : USetSpanCondition) -> i32);
windows_link::link!("icuuc.dll" "C" fn uset_spanBack(set : *mut USet, s : *mut u16, length : i32, spancondition : USetSpanCondition) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn uset_toPattern(set : *mut USet, result : *mut u16, resultcapacity : i32, escapeunprintable : i8, ec : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn uspoof_areConfusable(sc : *mut USpoofChecker, id1 : *mut u16, length1 : i32, id2 : *mut u16, length2 : i32, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn uspoof_areConfusableUTF8(sc : *mut USpoofChecker, id1 : windows_sys::core::PCSTR, length1 : i32, id2 : windows_sys::core::PCSTR, length2 : i32, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn uspoof_check(sc : *mut USpoofChecker, id : *mut u16, length : i32, position : *mut i32, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn uspoof_check2(sc : *mut USpoofChecker, id : *mut u16, length : i32, checkresult : *mut USpoofCheckResult, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn uspoof_check2UTF8(sc : *mut USpoofChecker, id : windows_sys::core::PCSTR, length : i32, checkresult : *mut USpoofCheckResult, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn uspoof_clone(sc : *mut USpoofChecker, status : *mut UErrorCode) -> *mut USpoofChecker);
...
windows_link::link!("icuin.dll" "C" fn uspoof_getAllowedLocales(sc : *mut USpoofChecker, status : *mut UErrorCode) -> windows_sys::core::PSTR);
windows_link::link!("icuin.dll" "C" fn uspoof_getCheckResultChecks(checkresult : *mut USpoofCheckResult, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn uspoof_getCheckResultRestrictionLevel(checkresult : *mut USpoofCheckResult, status : *mut UErrorCode) -> URestrictionLevel);
windows_link::link!("icuin.dll" "C" fn uspoof_getChecks(sc : *mut USpoofChecker, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn uspoof_getRestrictionLevel(sc : *mut USpoofChecker) -> URestrictionLevel);
windows_link::link!("icuin.dll" "C" fn uspoof_getSkeleton(sc : *mut USpoofChecker, r#type : u32, id : *mut u16, length : i32, dest : *mut u16, destcapacity : i32, status : *mut UErrorCode) -> i32);
windows_link::link!("icuin.dll" "C" fn uspoof_getSkeletonUTF8(sc : *mut USpoofChecker, r#type : u32, id : windows_sys::core::PCSTR, length : i32, dest : windows_sys::core::PCSTR, destcapacity : i32, status : *mut UErrorCode) -> i32);
...
windows_link::link!("icuin.dll" "C" fn uspoof_openFromSerialized(data : *mut core::ffi::c_void, length : i32, pactuallength : *mut i32, perrorcode : *mut UErrorCode) -> *mut USpoofChecker);
...
windows_link::link!("icuin.dll" "C" fn uspoof_setAllowedChars(sc : *mut USpoofChecker, chars : *mut USet, status : *mut UErrorCode));
...
windows_link::link!("icuuc.dll" "C" fn utext_equals(a : *mut UText, b : *mut UText) -> i8);
...
windows_link::link!("icuuc.dll" "C" fn utext_hasMetaData(ut : *mut UText) -> i8);
...
windows_link::link!("icuuc.dll" "C" fn utext_openUChars(ut : *mut UText, s : *mut u16, length : i64, status : *mut UErrorCode) -> *mut UText);
...
windows_link::link!("icuuc.dll" "C" fn utf8_back1SafeBody(s : *mut u8, start : i32, i : i32) -> i32);
windows_link::link!("icuuc.dll" "C" fn utf8_nextCharSafeBody(s : *mut u8, pi : *mut i32, length : i32, c : i32, strict : i8) -> i32);
...
windows_link::link!("icuuc.dll" "C" fn utrace_functionName(fnnumber : i32) -> windows_sys::core::PSTR);
...
windows_link::link!("icuuc.dll" "C" fn utrace_setFunctions(context : *mut core::ffi::c_void, e : UTraceEntry, x : UTraceExit, d : UTraceData));
...
windows_link::link!("icuin.dll" "C" fn utrans_clone(trans : *mut *mut core::ffi::c_void, status : *mut UErrorCode) -> *mut *mut core::ffi::c_void);
...
windows_link::link!("icuin.dll" "C" fn utrans_getSourceSet(trans : *mut *mut core::ffi::c_void, ignorefilter : i8, fillin : *mut USet, status : *mut UErrorCode) -> *mut USet);
windows_link::link!("icuin.dll" "C" fn utrans_getUnicodeID(trans : *mut *mut core::ffi::c_void, resultlength : *mut i32) -> *mut u16);
...
windows_link::link!("icuin.dll" "C" fn utrans_openU(id : *mut u16, idlength : i32, dir : UTransDirection, rules : *mut u16, ruleslength : i32, parseerror : *mut UParseError, perrorcode : *mut UErrorCode) -> *mut *mut core::ffi::c_void);
windows_link::link!("icuin.dll" "C" fn utrans_register(adoptedtrans : *mut *mut core::ffi::c_void, status : *mut UErrorCode));
windows_link::link!("icuin.dll" "C" fn utrans_setFilter(trans : *mut *mut core::ffi::c_void, filterpattern : *mut u16, filterpatternlen : i32, status : *mut UErrorCode));
...
windows_link::link!("icuin.dll" "C" fn utrans_transIncremental(trans : *mut *mut core::ffi::c_void, rep : *mut *mut core::ffi::c_void, repfunc : *mut UReplaceableCallbacks, pos : *mut UTransPosition, status : *mut UErrorCode));
...
pub type UConverterToUCallback = Option<unsafe extern "C" fn(context: *mut core::ffi::c_void, args: *mut UConverterToUnicodeArgs, codeunits: windows_sys::core::PCSTR, length: i32, reason: UConverterCallbackReason, perrorcode: *mut UErrorCode)>;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub type UMemReallocFn = Option<unsafe extern "C" fn(context: *mut core::ffi::c_void, mem: *mut core::ffi::c_void, size: usize) -> *mut core::ffi::c_void>;
...
pub type UTraceData = Option<unsafe extern "C" fn(context: *mut core::ffi::c_void, fnnumber: i32, level: i32, fmt: windows_sys::core::PCSTR, args: *mut i8)>;
pub type UTraceEntry = Option<unsafe extern "C" fn(context: *mut core::ffi::c_void, fnnumber: i32)>;
pub type UTraceExit = Option<unsafe extern "C" fn(context: *mut core::ffi::c_void, fnnumber: i32, fmt: windows_sys::core::PCSTR, args: *mut i8)>;
