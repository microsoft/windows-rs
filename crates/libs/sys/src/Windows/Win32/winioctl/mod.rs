...
pub struct ASYNC_DUPLICATE_EXTENTS_STATUS {
    ...
    pub SourceFileOffset: super::winnt::DWORDLONG,
    pub TargetFileOffset: super::winnt::DWORDLONG,
    pub ByteCount: super::winnt::DWORDLONG,
    pub BytesDuplicated: super::winnt::DWORDLONG,
}
...
pub struct DEVICEDUMP_STORAGESTACK_PUBLIC_STATE_RECORD {
    pub Cdb: [u8; 16],
    pub Command: [u8; 16],
    pub StartTime: super::winnt::DWORDLONG,
    pub EndTime: super::winnt::DWORDLONG,
...
pub struct DEVICE_COPY_OFFLOAD_DESCRIPTOR {
    ...
    pub MaximumTransferSize: super::winnt::DWORDLONG,
    pub OptimalTransferCount: super::winnt::DWORDLONG,
...
pub struct DEVICE_DATA_SET_LB_PROVISIONING_STATE {
    pub Size: u32,
    pub Version: u32,
    pub SlabSizeInBytes: super::winnt::DWORDLONG,
...
pub struct DEVICE_DATA_SET_LB_PROVISIONING_STATE_V2 {
    ...
    pub Version: u32,
    pub SlabSizeInBytes: super::winnt::DWORDLONG,
    pub SlabOffsetDeltaInBytes: super::winnt::DWORDLONG,
    pub SlabAllocationBitMapBitCount: u32,
    pub SlabAllocationBitMapLength: u32,
    pub SlabAllocationBitMap: [u32; 1],
}
...
pub struct DEVICE_DSM_LOST_QUERY_OUTPUT {
    pub Version: u32,
    pub Size: u32,
    pub Alignment: super::winnt::DWORDLONG,
...
pub struct DEVICE_INTERNAL_STATUS_DATA {
    pub Version: u32,
    pub Size: u32,
    pub T10VendorId: super::winnt::DWORDLONG,
...
pub struct DEVICE_LB_PROVISIONING_DESCRIPTOR {
    ...
    pub _bitfield: u8,
    pub Reserved1: [u8; 7],
    pub OptimalUnmapGranularity: super::winnt::DWORDLONG,
    pub UnmapGranularityAlignment: super::winnt::DWORDLONG,
...
pub struct ENCRYPTION_KEY_CTRL_INPUT {
    ...
    pub KeySize: u16,
    pub DplLock: u32,
    pub DplUserId: super::winnt::DWORDLONG,
    pub DplCredentialId: super::winnt::DWORDLONG,
}
...
pub struct FILESYSTEM_STATISTICS_EX {
    ...
    pub Version: u16,
    pub SizeOfCompleteStructure: u32,
    pub UserFileReads: super::winnt::DWORDLONG,
    pub UserFileReadBytes: super::winnt::DWORDLONG,
    pub UserDiskReads: super::winnt::DWORDLONG,
    pub UserFileWrites: super::winnt::DWORDLONG,
    pub UserFileWriteBytes: super::winnt::DWORDLONG,
    pub UserDiskWrites: super::winnt::DWORDLONG,
    pub MetaDataReads: super::winnt::DWORDLONG,
    pub MetaDataReadBytes: super::winnt::DWORDLONG,
    pub MetaDataDiskReads: super::winnt::DWORDLONG,
    pub MetaDataWrites: super::winnt::DWORDLONG,
    pub MetaDataWriteBytes: super::winnt::DWORDLONG,
    pub MetaDataDiskWrites: super::winnt::DWORDLONG,
}
...
pub struct FILE_LAYOUT_ENTRY {
    ...
    pub FileReferenceNumber: super::winnt::DWORDLONG,
...
pub struct FILE_LAYOUT_NAME_ENTRY {
    ...
    pub Flags: u32,
    pub ParentFileReferenceNumber: super::winnt::DWORDLONG,
...
pub struct FILE_STORAGE_TIER {
    ...
    pub ProvisionedCapacity: super::winnt::DWORDLONG,
...
pub struct FSCTL_OFFLOAD_READ_INPUT {
    ...
    pub Reserved: u32,
    pub FileOffset: super::winnt::DWORDLONG,
...
pub struct FSCTL_OFFLOAD_WRITE_OUTPUT {
    pub Size: u32,
    pub Flags: u32,
    pub LengthWritten: super::winnt::DWORDLONG,
}
...
pub struct FS_BPIO_INPUT {
    ...
    pub Reserved1: super::winnt::DWORDLONG,
...
pub struct NTFS_STATISTICS_EX {
    pub LogFileFullExceptions: u32,
    pub OtherExceptions: u32,
    pub MftReads: super::winnt::DWORDLONG,
    pub MftReadBytes: super::winnt::DWORDLONG,
    pub MftWrites: super::winnt::DWORDLONG,
    pub MftWriteBytes: super::winnt::DWORDLONG,
    ...
    pub Mft2Writes: super::winnt::DWORDLONG,
    pub Mft2WriteBytes: super::winnt::DWORDLONG,
    ...
    pub RootIndexReads: super::winnt::DWORDLONG,
    pub RootIndexReadBytes: super::winnt::DWORDLONG,
    pub RootIndexWrites: super::winnt::DWORDLONG,
    pub RootIndexWriteBytes: super::winnt::DWORDLONG,
    pub BitmapReads: super::winnt::DWORDLONG,
    pub BitmapReadBytes: super::winnt::DWORDLONG,
    pub BitmapWrites: super::winnt::DWORDLONG,
    pub BitmapWriteBytes: super::winnt::DWORDLONG,
    ...
    pub MftBitmapReads: super::winnt::DWORDLONG,
    pub MftBitmapReadBytes: super::winnt::DWORDLONG,
    pub MftBitmapWrites: super::winnt::DWORDLONG,
    pub MftBitmapWriteBytes: super::winnt::DWORDLONG,
    ...
    pub UserIndexReads: super::winnt::DWORDLONG,
    pub UserIndexReadBytes: super::winnt::DWORDLONG,
    pub UserIndexWrites: super::winnt::DWORDLONG,
    pub UserIndexWriteBytes: super::winnt::DWORDLONG,
    pub LogFileReads: super::winnt::DWORDLONG,
    pub LogFileReadBytes: super::winnt::DWORDLONG,
    pub LogFileWrites: super::winnt::DWORDLONG,
    pub LogFileWriteBytes: super::winnt::DWORDLONG,
    pub Allocate: NTFS_STATISTICS_EX_4,
    pub DiskResourcesExhausted: u32,
    pub VolumeTrimCount: super::winnt::DWORDLONG,
    pub VolumeTrimTime: super::winnt::DWORDLONG,
    pub VolumeTrimByteCount: super::winnt::DWORDLONG,
    pub FileLevelTrimCount: super::winnt::DWORDLONG,
    pub FileLevelTrimTime: super::winnt::DWORDLONG,
    pub FileLevelTrimByteCount: super::winnt::DWORDLONG,
    pub VolumeTrimSkippedCount: super::winnt::DWORDLONG,
    pub VolumeTrimSkippedByteCount: super::winnt::DWORDLONG,
    pub NtfsFillStatInfoFromMftRecordCalledCount: super::winnt::DWORDLONG,
    pub NtfsFillStatInfoFromMftRecordBailedBecauseOfAttributeListCount: super::winnt::DWORDLONG,
...
pub struct NTFS_STATISTICS_EX_4 {
    ...
    pub Cache: u32,
    pub CacheMiss: u32,
    pub Clusters: super::winnt::DWORDLONG,
    pub HintsClusters: super::winnt::DWORDLONG,
    pub CacheClusters: super::winnt::DWORDLONG,
...
pub struct READ_USN_JOURNAL_DATA_V0 {
    ...
    pub Timeout: super::winnt::DWORDLONG,
    pub BytesToWaitFor: super::winnt::DWORDLONG,
    pub UsnJournalID: super::winnt::DWORDLONG,
}
#[repr(C)]
#[cfg(feature = "Win32_winnt")]
...
pub struct REMOVE_ELEMENT_AND_TRUNCATE_REQUEST {
    pub Version: u32,
    pub Size: u32,
    pub RequestCapacity: super::winnt::DWORDLONG,
    pub ElementIdentifier: u32,
    pub Reserved: u32,
}
#[repr(C)]
...
pub struct REQUEST_OPLOCK_OUTPUT_BUFFER {
    ...
    pub Flags: u32,
    pub AccessMode: super::winnt::ACCESS_MASK,
    pub ShareMode: u16,
}
...
pub struct SCM_BUS_RUNTIME_FW_ACTIVATION_INFO {
    ...
    pub EstimatedFirmwareActivationTimeInUSecs: super::winnt::DWORDLONG,
    pub EstimatedProcessorAccessQuiesceTimeInUSecs: super::winnt::DWORDLONG,
    pub EstimatedIOAccessQuiesceTimeInUSecs: super::winnt::DWORDLONG,
...
pub struct SD_CHANGE_MACHINE_SID_OUTPUT {
    ...
    pub NumSDUnused: super::winnt::DWORDLONG,
    pub NumSDTotal: super::winnt::DWORDLONG,
    pub NumMftSDChangedSuccess: super::winnt::DWORDLONG,
    pub NumMftSDChangedFail: super::winnt::DWORDLONG,
...
pub struct SD_QUERY_STATS_OUTPUT {
    ...
    pub SiiStreamSize: super::winnt::DWORDLONG,
    pub SiiAllocationSize: super::winnt::DWORDLONG,
    pub SdhStreamSize: super::winnt::DWORDLONG,
    pub SdhAllocationSize: super::winnt::DWORDLONG,
    pub NumSDTotal: super::winnt::DWORDLONG,
    pub NumSDUnused: super::winnt::DWORDLONG,
}
...
pub struct SET_DAX_ALLOC_ALIGNMENT_HINT_INPUT {
    ...
    pub FileOffsetToAlign: super::winnt::DWORDLONG,
...
pub struct STORAGE_DEVICE_LED_STATE_DESCRIPTOR {
    pub Version: u32,
    pub Size: u32,
    pub State: super::winnt::DWORDLONG,
}
#[repr(C)]
#[derive(Clone, Copy)]
...
pub struct STORAGE_DEVICE_POWER_CAP {
    ...
    pub MaxPower: super::winnt::DWORDLONG,
}
...
pub struct STORAGE_EVENT_NOTIFICATION {
    pub Version: u32,
    pub Size: u32,
    pub Events: super::winnt::DWORDLONG,
}
...
pub struct STORAGE_GET_BC_PROPERTIES_OUTPUT {
    ...
    pub MaximumRequestSize: super::winnt::DWORDLONG,
...
pub struct STORAGE_HW_BOOT_PARTITION_INFO {
    pub Version: u32,
    pub Size: u32,
    pub BPSZ: super::winnt::DWORDLONG,
    pub Flags: u32,
...
pub struct STORAGE_OFFLOAD_READ_OUTPUT {
    ...
    pub Reserved: u32,
    pub LengthProtected: super::winnt::DWORDLONG,
    pub TokenLength: u32,
    pub Token: STORAGE_OFFLOAD_TOKEN,
}
#[cfg(feature = "Win32_winnt")]
...
pub struct STORAGE_OFFLOAD_WRITE_OUTPUT {
    ...
    pub Reserved: u32,
    pub LengthCopied: super::winnt::DWORDLONG,
}
...
pub struct STORAGE_PHYSICAL_DEVICE_DATA {
    ...
    pub Model: [u8; 40],
    pub FirmwareRevision: [u8; 16],
    pub Capacity: super::winnt::DWORDLONG,
    pub PhysicalLocation: [u8; 32],
    pub Reserved: [u32; 2],
}
#[cfg(feature = "Win32_winnt")]
...
pub struct TXFS_GET_METADATA_INFO_OUT {
    ...
    pub LastLsn: super::winnt::DWORDLONG,
...
pub struct TXFS_MODIFY_RM {
    ...
    pub Reserved: super::winnt::DWORDLONG,
    pub LoggingMode: u16,
}
...
pub struct TXFS_QUERY_RM_INFORMATION {
    ...
    pub CurrentLsn: super::winnt::DWORDLONG,
    pub ArchiveTailLsn: super::winnt::DWORDLONG,
    ...
    pub Reserved: u16,
    pub RmState: u32,
    pub LogCapacity: super::winnt::DWORDLONG,
    pub LogFree: super::winnt::DWORDLONG,
    pub TopsSize: super::winnt::DWORDLONG,
    pub TopsUsed: super::winnt::DWORDLONG,
    pub TransactionCount: super::winnt::DWORDLONG,
    pub OnePCCount: super::winnt::DWORDLONG,
    pub TwoPCCount: super::winnt::DWORDLONG,
    pub NumberLogFileFull: super::winnt::DWORDLONG,
    pub OldestTransactionAge: super::winnt::DWORDLONG,
...
pub struct TXFS_ROLLFORWARD_REDO_INFORMATION {
    ...
    pub HighestRecoveryLsn: super::winnt::DWORDLONG,
    pub Flags: u32,
}
...
pub struct USN_JOURNAL_DATA_V0 {
    ...
    pub NextUsn: super::winnt::USN,
    pub LowestValidUsn: super::winnt::USN,
    pub MaxUsn: super::winnt::USN,
    pub MaximumSize: super::winnt::DWORDLONG,
    pub AllocationDelta: super::winnt::DWORDLONG,
}
#[repr(C)]
...
pub struct USN_JOURNAL_DATA_V2 {
    ...
    pub MaxSupportedMajorVersion: u16,
    pub Flags: u32,
    pub RangeTrackChunkSize: super::winnt::DWORDLONG,
...
pub struct USN_RECORD_V3 {
    ...
    pub ParentFileReferenceNumber: super::winnt::FILE_ID_128,
    pub Usn: super::winnt::USN,
    pub TimeStamp: i64,
    pub Reason: u32,
    pub SourceInfo: u32,
...
pub struct USN_TRACK_MODIFIED_RANGES {
    pub Flags: u32,
    pub Unused: u32,
    pub ChunkSize: super::winnt::DWORDLONG,
