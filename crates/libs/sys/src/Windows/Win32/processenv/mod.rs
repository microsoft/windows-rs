...
#[cfg(feature = "winnt")]
windows_link::link!("kernel32.dll" "system" fn FreeEnvironmentStringsA(penv : super::LPCH) -> windows_sys::core::BOOL);
#[cfg(feature = "winnt")]
windows_link::link!("kernel32.dll" "system" fn FreeEnvironmentStringsW(penv : super::LPWCH) -> windows_sys::core::BOOL);
...
#[cfg(feature = "winnt")]
windows_link::link!("kernel32.dll" "system" fn GetEnvironmentStrings() -> super::LPCH);
#[cfg(feature = "winnt")]
windows_link::link!("kernel32.dll" "system" fn GetEnvironmentStringsW() -> super::LPWCH);
...
#[cfg(feature = "winnt")]
windows_link::link!("kernel32.dll" "system" fn GetStdHandle(nstdhandle : u32) -> super::HANDLE);
...
#[cfg(feature = "winnt")]
windows_link::link!("kernel32.dll" "system" fn SetEnvironmentStringsW(newenvironment : super::LPWCH) -> windows_sys::core::BOOL);
...
#[cfg(feature = "winnt")]
windows_link::link!("kernel32.dll" "system" fn SetStdHandle(nstdhandle : u32, hhandle : super::HANDLE) -> windows_sys::core::BOOL);
#[cfg(feature = "winnt")]
windows_link::link!("kernel32.dll" "system" fn SetStdHandleEx(nstdhandle : u32, hhandle : super::HANDLE, phprevvalue : super::PHANDLE) -> windows_sys::core::BOOL);
