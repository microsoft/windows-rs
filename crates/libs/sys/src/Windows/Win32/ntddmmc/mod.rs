...
pub const SCSI_GET_CONFIGURATION_REQUEST_TYPE_ALL: i32 = 0;
pub const SCSI_GET_CONFIGURATION_REQUEST_TYPE_CURRENT: i32 = 1;
pub const SCSI_GET_CONFIGURATION_REQUEST_TYPE_ONE: i32 = 2;
