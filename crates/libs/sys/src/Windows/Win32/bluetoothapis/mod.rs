...
windows_link::link!("bthprops.cpl" "system" fn BluetoothDisplayDeviceProperties(hwndparent : super::HWND, pbtdi : *mut BLUETOOTH_DEVICE_INFO_STRUCT) -> windows_sys::core::BOOL);
#[cfg(feature = "winnt")]
windows_link::link!("bthprops.cpl" "system" fn BluetoothEnableDiscovery(hradio : super::HANDLE, fenabled : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
#[cfg(feature = "winnt")]
windows_link::link!("bthprops.cpl" "system" fn BluetoothEnableIncomingConnections(hradio : super::HANDLE, fenabled : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
#[cfg(all(feature = "bthdef", feature = "minwinbase", feature = "winnt"))]
windows_link::link!("bthprops.cpl" "system" fn BluetoothEnumerateInstalledServices(hradio : super::HANDLE, pbtdi : *const BLUETOOTH_DEVICE_INFO_STRUCT, pcserviceinout : *mut u32, pguidservices : *mut windows_sys::core::GUID) -> u32);
#[cfg(feature = "winnt")]
...
#[cfg(feature = "winnt")]
windows_link::link!("bthprops.cpl" "system" fn BluetoothFindFirstRadio(pbtfrp : *const BLUETOOTH_FIND_RADIO_PARAMS, phradio : *mut super::HANDLE) -> HBLUETOOTH_RADIO_FIND);
#[cfg(all(feature = "bthdef", feature = "minwinbase", feature = "winnt"))]
...
#[cfg(feature = "winnt")]
windows_link::link!("bthprops.cpl" "system" fn BluetoothFindNextRadio(hfind : HBLUETOOTH_RADIO_FIND, phradio : *mut super::HANDLE) -> windows_sys::core::BOOL);
#[cfg(feature = "winnt")]
...
#[cfg(feature = "winnt")]
windows_link::link!("bthprops.cpl" "system" fn BluetoothIsDiscoverable(hradio : super::HANDLE) -> windows_sys::core::BOOL);
...
#[cfg(all(feature = "bthdef", feature = "minwinbase", feature = "winnt"))]
windows_link::link!("bthprops.cpl" "system" fn BluetoothSetServiceState(hradio : super::HANDLE, pbtdi : *const BLUETOOTH_DEVICE_INFO_STRUCT, pguidservice : *const windows_sys::core::GUID, dwserviceflags : u32) -> u32);
#[cfg(feature = "winnt")]
