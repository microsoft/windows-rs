...
windows_link::link!("netapi32.dll" "system" fn NetWkstaGetInfo(servername : windows_sys::core::PCWSTR, level : u32, bufptr : *mut super::LPBYTE) -> u32);
#[cfg(feature = "minwindef")]
windows_link::link!("netapi32.dll" "system" fn NetWkstaSetInfo(servername : windows_sys::core::PCWSTR, level : u32, buffer : super::LPBYTE, parm_err : super::LPDWORD) -> u32);
#[cfg(all(feature = "minwindef", feature = "winnt"))]
windows_link::link!("netapi32.dll" "system" fn NetWkstaTransportAdd(servername : super::LPTSTR, level : u32, buf : super::LPBYTE, parm_err : super::LPDWORD) -> u32);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
windows_link::link!("netapi32.dll" "system" fn NetWkstaTransportEnum(servername : super::LPTSTR, level : u32, bufptr : *mut super::LPBYTE, prefmaxlen : u32, entriesread : super::LPDWORD, totalentries : super::LPDWORD, resume_handle : super::LPDWORD) -> u32);
#[cfg(feature = "minwindef")]
windows_link::link!("netapi32.dll" "system" fn NetWkstaUserEnum(servername : windows_sys::core::PCWSTR, level : u32, bufptr : *mut super::LPBYTE, prefmaxlen : u32, entriesread : super::LPDWORD, totalentries : super::LPDWORD, resumehandle : super::LPDWORD) -> u32);
#[cfg(feature = "minwindef")]
windows_link::link!("netapi32.dll" "system" fn NetWkstaUserGetInfo(reserved : windows_sys::core::PCWSTR, level : u32, bufptr : *mut super::LPBYTE) -> u32);
#[cfg(feature = "minwindef")]
windows_link::link!("netapi32.dll" "system" fn NetWkstaUserSetInfo(reserved : windows_sys::core::PCWSTR, level : u32, buf : super::LPBYTE, parm_err : super::LPDWORD) -> u32);
...
pub const TRANSPORT_NAME_PARMNUM: i32 = 202;
pub const TRANSPORT_QUALITYOFSERVICE_PARMNUM: i32 = 201;
pub const WKSTA_BUFFERNAMEDPIPES_PARMNUM: i32 = 51;
pub const WKSTA_BUFFERREADONLYFILES_PARMNUM: i32 = 59;
pub const WKSTA_BUFFILESWITHDENYWRITE_PARMNUM: i32 = 58;
pub const WKSTA_CACHEFILETIMEOUT_PARMNUM: i32 = 47;
pub const WKSTA_CHARCOUNT_PARMNUM: i32 = 12;
pub const WKSTA_CHARTIME_PARMNUM: i32 = 11;
pub const WKSTA_CHARWAIT_PARMNUM: i32 = 10;
pub const WKSTA_COMPUTERNAME_PARMNUM: i32 = 1;
pub const WKSTA_DORMANTFILELIMIT_PARMNUM: i32 = 46;
...
pub const WKSTA_KEEPCONN_PARMNUM: i32 = 13;
pub const WKSTA_KEEPSEARCH_PARMNUM: i32 = 14;
pub const WKSTA_LANGROUP_PARMNUM: i32 = 2;
pub const WKSTA_LANROOT_PARMNUM: i32 = 7;
pub const WKSTA_LOCKINCREMENT_PARMNUM: i32 = 42;
pub const WKSTA_LOCKMAXIMUM_PARMNUM: i32 = 43;
pub const WKSTA_LOCKQUOTA_PARMNUM: i32 = 41;
pub const WKSTA_LOGGED_ON_USERS_PARMNUM: i32 = 6;
pub const WKSTA_LOGON_DOMAIN_PARMNUM: i32 = 8;
pub const WKSTA_LOGON_SERVER_PARMNUM: i32 = 9;
pub const WKSTA_MAILSLOTS_PARMNUM: i32 = 30;
pub const WKSTA_MAXCMDS_PARMNUM: i32 = 15;
pub const WKSTA_MAXTHREADS_PARMNUM: i32 = 33;
pub const WKSTA_MAXWRKCACHE_PARMNUM: i32 = 17;
pub const WKSTA_NUMALERTS_PARMNUM: i32 = 20;
pub const WKSTA_NUMCHARBUF_PARMNUM: i32 = 22;
pub const WKSTA_NUMDGRAMBUF_PARMNUM: i32 = 31;
pub const WKSTA_NUMSERVICES_PARMNUM: i32 = 21;
pub const WKSTA_NUMWORKBUF_PARMNUM: i32 = 16;
pub const WKSTA_OTH_DOMAINS_PARMNUM: i32 = 101;
pub const WKSTA_PIPEINCREMENT_PARMNUM: i32 = 44;
pub const WKSTA_PIPEMAXIMUM_PARMNUM: i32 = 45;
pub const WKSTA_PLATFORM_ID_PARMNUM: i32 = 100;
pub const WKSTA_PRINTBUFTIME_PARMNUM: i32 = 28;
pub const WKSTA_READAHEADTHRUPUT_PARMNUM: i32 = 62;
pub const WKSTA_SESSTIMEOUT_PARMNUM: i32 = 18;
pub const WKSTA_SIZCHARBUF_PARMNUM: i32 = 23;
...
pub const WKSTA_USEENCRYPTION_PARMNUM: i32 = 57;
pub const WKSTA_USELOCKANDREADANDUNLOCK_PARMNUM: i32 = 52;
pub const WKSTA_USEOPPORTUNISTICLOCKING_PARMNUM: i32 = 48;
...
pub const WKSTA_UTILIZENTCACHING_PARMNUM: i32 = 53;
pub const WKSTA_VER_MAJOR_PARMNUM: i32 = 4;
pub const WKSTA_VER_MINOR_PARMNUM: i32 = 5;
pub const WKSTA_WRKHEURISTICS_PARMNUM: i32 = 32;
