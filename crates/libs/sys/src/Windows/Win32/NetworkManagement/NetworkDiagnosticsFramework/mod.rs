pub type NdfCancelIncident = unsafe extern "system" fn(handle: *const core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("ndfapi.dll" "system" fn NdfCancelIncident(handle : *const core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type NdfCloseIncident = unsafe extern "system" fn(handle: *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("ndfapi.dll" "system" fn NdfCloseIncident(handle : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type NdfCreateConnectivityIncident = unsafe extern "system" fn(handle: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type NdfCreateDNSIncident = unsafe extern "system" fn(hostname: windows_sys::core::PCWSTR, querytype: u16, handle: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type NdfCreateGroupingIncident = unsafe extern "system" fn(cloudname: windows_sys::core::PCWSTR, groupname: windows_sys::core::PCWSTR, identity: windows_sys::core::PCWSTR, invitation: windows_sys::core::PCWSTR, addresses: *const super::super::Networking::WinSock::SOCKET_ADDRESS_LIST, appid: windows_sys::core::PCWSTR, handle: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Networking_WinSock")]
...
pub type NdfCreateIncident = unsafe extern "system" fn(helperclassname: windows_sys::core::PCWSTR, celt: u32, attributes: *const HELPER_ATTRIBUTE, handle: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type NdfCreateNetConnectionIncident = unsafe extern "system" fn(handle: *mut *mut core::ffi::c_void, id: windows_sys::core::GUID) -> windows_sys::core::HRESULT;
...
pub type NdfCreatePnrpIncident = unsafe extern "system" fn(cloudname: windows_sys::core::PCWSTR, peername: windows_sys::core::PCWSTR, diagnosepublish: windows_sys::core::BOOL, appid: windows_sys::core::PCWSTR, handle: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type NdfCreateSharingIncident = unsafe extern "system" fn(uncpath: windows_sys::core::PCWSTR, handle: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type NdfCreateWebIncident = unsafe extern "system" fn(url: windows_sys::core::PCWSTR, handle: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type NdfCreateWebIncidentEx = unsafe extern "system" fn(url: windows_sys::core::PCWSTR, usewinhttp: windows_sys::core::BOOL, modulename: windows_sys::core::PCWSTR, handle: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type NdfCreateWinSockIncident = unsafe extern "system" fn(sock: super::super::Networking::WinSock::SOCKET, host: windows_sys::core::PCWSTR, port: u16, appid: windows_sys::core::PCWSTR, userid: *const super::super::Security::SID, handle: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
#[cfg(all(feature = "Win32_Networking_WinSock", feature = "Win32_Security"))]
...
pub type NdfDiagnoseIncident = unsafe extern "system" fn(handle: *const core::ffi::c_void, rootcausecount: *mut u32, rootcauses: *mut *mut RootCauseInfo, dwwait: u32, dwflags: u32) -> windows_sys::core::HRESULT;
...
pub type NdfExecuteDiagnosis = unsafe extern "system" fn(handle: *const core::ffi::c_void, hwnd: super::super::Foundation::HWND) -> windows_sys::core::HRESULT;
...
pub type NdfGetTraceFile = unsafe extern "system" fn(handle: *const core::ffi::c_void, tracefilelocation: *mut windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type NdfRepairIncident = unsafe extern "system" fn(handle: *const core::ffi::c_void, repairex: *const RepairInfoEx, dwwait: u32) -> windows_sys::core::HRESULT;
