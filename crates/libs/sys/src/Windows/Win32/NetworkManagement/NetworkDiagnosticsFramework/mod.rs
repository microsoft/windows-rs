...
pub const AT_BOOLEAN: ATTRIBUTE_TYPE = 1;
pub const AT_GUID: ATTRIBUTE_TYPE = 11;
pub const AT_INT16: ATTRIBUTE_TYPE = 4;
pub const AT_INT32: ATTRIBUTE_TYPE = 6;
pub const AT_INT64: ATTRIBUTE_TYPE = 8;
pub const AT_INT8: ATTRIBUTE_TYPE = 2;
pub const AT_INVALID: ATTRIBUTE_TYPE = 0;
pub const AT_LIFE_TIME: ATTRIBUTE_TYPE = 12;
pub const AT_OCTET_STRING: ATTRIBUTE_TYPE = 14;
pub const AT_SOCKADDR: ATTRIBUTE_TYPE = 13;
pub const AT_STRING: ATTRIBUTE_TYPE = 10;
pub const AT_UINT16: ATTRIBUTE_TYPE = 5;
pub const AT_UINT32: ATTRIBUTE_TYPE = 7;
pub const AT_UINT64: ATTRIBUTE_TYPE = 9;
pub const AT_UINT8: ATTRIBUTE_TYPE = 3;
...
pub const DS_CONFIRMED: DIAGNOSIS_STATUS = 1;
pub const DS_DEFERRED: DIAGNOSIS_STATUS = 4;
pub const DS_INDETERMINATE: DIAGNOSIS_STATUS = 3;
pub const DS_NOT_IMPLEMENTED: DIAGNOSIS_STATUS = 0;
...
pub const PT_DOWN_STREAM_HEALTH: PROBLEM_TYPE = 4;
pub const PT_HIGHER_UTILIZATION: PROBLEM_TYPE = 16;
pub const PT_HIGH_UTILIZATION: PROBLEM_TYPE = 8;
pub const PT_INVALID: PROBLEM_TYPE = 0;
pub const PT_LOWER_HEALTH: PROBLEM_TYPE = 2;
pub const PT_LOW_HEALTH: PROBLEM_TYPE = 1;
pub const PT_UP_STREAM_UTILIZATION: PROBLEM_TYPE = 32;
...
pub const RR_NORISK: REPAIR_RISK = 2;
pub const RR_NOROLLBACK: REPAIR_RISK = 0;
pub const RR_ROLLBACK: REPAIR_RISK = 1;
pub const RS_APPLICATION: REPAIR_SCOPE = 2;
pub const RS_DEFERRED: REPAIR_STATUS = 3;
pub const RS_NOT_IMPLEMENTED: REPAIR_STATUS = 0;
pub const RS_PROCESS: REPAIR_SCOPE = 3;
pub const RS_REPAIRED: REPAIR_STATUS = 1;
pub const RS_SYSTEM: REPAIR_SCOPE = 0;
pub const RS_UNREPAIRED: REPAIR_STATUS = 2;
pub const RS_USER: REPAIR_SCOPE = 1;
pub const RS_USER_ACTION: REPAIR_STATUS = 4;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const UIT_DUI: UI_INFO_TYPE = 4;
pub const UIT_HELP_PANE: UI_INFO_TYPE = 3;
pub const UIT_INVALID: UI_INFO_TYPE = 0;
pub const UIT_NONE: UI_INFO_TYPE = 1;
pub const UIT_SHELL_COMMAND: UI_INFO_TYPE = 2;
