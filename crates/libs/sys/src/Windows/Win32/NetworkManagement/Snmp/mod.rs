...
pub type SnmpEntityToStr = unsafe extern "system" fn(entity: isize, size: u32, string: windows_sys::core::PSTR) -> u32;
...
pub type SnmpMgrClose = unsafe extern "system" fn(session: *mut core::ffi::c_void) -> windows_sys::core::BOOL;
windows_link::link!("mgmtapi.dll" "system" fn SnmpMgrClose(session : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
pub type SnmpMgrCtl = unsafe extern "system" fn(session: *mut core::ffi::c_void, dwctlcode: u32, lpvinbuffer: *mut core::ffi::c_void, cbinbuffer: u32, lpvoutbuffer: *mut core::ffi::c_void, cboutbuffer: u32, lpcbbytesreturned: *mut u32) -> windows_sys::core::BOOL;
...
pub type SnmpMgrGetTrap = unsafe extern "system" fn(enterprise: *mut AsnObjectIdentifier, ipaddress: *mut AsnOctetString, generictrap: *mut SNMP_GENERICTRAP, specifictrap: *mut i32, timestamp: *mut u32, variablebindings: *mut SnmpVarBindList) -> windows_sys::core::BOOL;
...
pub type SnmpMgrOidToStr = unsafe extern "system" fn(oid: *mut AsnObjectIdentifier, string: *mut windows_sys::core::PSTR) -> windows_sys::core::BOOL;
...
pub type SnmpMgrOpen = unsafe extern "system" fn(lpagentaddress: windows_sys::core::PCSTR, lpagentcommunity: windows_sys::core::PCSTR, ntimeout: i32, nretries: i32) -> *mut core::ffi::c_void;
...
pub type SnmpMgrStrToOid = unsafe extern "system" fn(string: windows_sys::core::PCSTR, oid: *mut AsnObjectIdentifier) -> windows_sys::core::BOOL;
...
pub type SnmpMgrTrapListen = unsafe extern "system" fn(phtrapavailable: *mut super::super::Foundation::HANDLE) -> windows_sys::core::BOOL;
...
pub type SnmpOidToStr = unsafe extern "system" fn(srcoid: *const smiOID, size: u32, string: windows_sys::core::PSTR) -> u32;
...
pub type SnmpStrToEntity = unsafe extern "system" fn(session: isize, string: windows_sys::core::PCSTR) -> isize;
windows_link::link!("wsnmp32.dll" "system" fn SnmpStrToEntity(session : isize, string : windows_sys::core::PCSTR) -> isize);
pub type SnmpStrToOid = unsafe extern "system" fn(string: windows_sys::core::PCSTR, dstoid: *mut smiOID) -> u32;
...
pub type SnmpSvcSetLogType = unsafe extern "system" fn(nlogtype: i32);
...
pub type SnmpUtilDbgPrint = unsafe extern "C" fn(nloglevel: SNMP_LOG, szformat: windows_sys::core::PCSTR, ...);
windows_link::link!("snmpapi.dll" "C" fn SnmpUtilDbgPrint(nloglevel : SNMP_LOG, szformat : windows_sys::core::PCSTR, ...));
pub type SnmpUtilIdsToA = unsafe extern "system" fn(ids: *mut u32, idlength: u32) -> windows_sys::core::PSTR;
...
pub type SnmpUtilOidToA = unsafe extern "system" fn(oid: *mut AsnObjectIdentifier) -> windows_sys::core::PSTR;
