...
pub type WlanCloseHandle = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, preserved: *const core::ffi::c_void) -> u32;
...
pub type WlanConnect = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, pconnectionparameters: *const WLAN_CONNECTION_PARAMETERS, preserved: *const core::ffi::c_void) -> u32;
#[cfg(feature = "Win32_NetworkManagement_Ndis")]
...
#[cfg(feature = "Win32_NetworkManagement_Ndis")]
pub type WlanConnect2 = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, pconnectionparameters: *const WLAN_CONNECTION_PARAMETERS_V2, preserved: *const core::ffi::c_void) -> u32;
#[cfg(feature = "Win32_NetworkManagement_Ndis")]
...
pub type WlanDeleteProfile = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, strprofilename: windows_sys::core::PCWSTR, preserved: *const core::ffi::c_void) -> u32;
...
pub type WlanDisconnect = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, preserved: *const core::ffi::c_void) -> u32;
...
pub type WlanEnumInterfaces = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, preserved: *const core::ffi::c_void, ppinterfacelist: *mut *mut WLAN_INTERFACE_INFO_LIST) -> u32;
...
pub type WlanExtractPsdIEDataList = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, dwiedatasize: u32, prawiedata: *const u8, strformat: windows_sys::core::PCWSTR, preserved: *const core::ffi::c_void, pppsdiedatalist: *mut *mut WLAN_RAW_DATA_LIST) -> u32;
...
pub type WlanGetAvailableNetworkList = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, dwflags: u32, preserved: *const core::ffi::c_void, ppavailablenetworklist: *mut *mut WLAN_AVAILABLE_NETWORK_LIST) -> u32;
...
pub type WlanGetAvailableNetworkList2 = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, dwflags: u32, preserved: *const core::ffi::c_void, ppavailablenetworklist: *mut *mut WLAN_AVAILABLE_NETWORK_LIST_V2) -> u32;
...
pub type WlanGetFilterList = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, wlanfilterlisttype: WLAN_FILTER_LIST_TYPE, preserved: *const core::ffi::c_void, ppnetworklist: *mut *mut DOT11_NETWORK_LIST) -> u32;
...
pub type WlanGetInterfaceCapability = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, preserved: *const core::ffi::c_void, ppcapability: *mut *mut WLAN_INTERFACE_CAPABILITY) -> u32;
...
pub type WlanGetProfile = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, strprofilename: windows_sys::core::PCWSTR, preserved: *const core::ffi::c_void, pstrprofilexml: *mut windows_sys::core::PWSTR, pdwflags: *mut u32, pdwgrantedaccess: *mut u32) -> u32;
...
pub type WlanGetProfileCustomUserData = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, strprofilename: windows_sys::core::PCWSTR, preserved: *const core::ffi::c_void, pdwdatasize: *mut u32, ppdata: *mut *mut u8) -> u32;
...
pub type WlanGetProfileList = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, preserved: *const core::ffi::c_void, ppprofilelist: *mut *mut WLAN_PROFILE_INFO_LIST) -> u32;
...
pub type WlanGetSecuritySettings = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, securableobject: WLAN_SECURABLE_OBJECT, pvaluetype: *mut WLAN_OPCODE_VALUE_TYPE, pstrcurrentsddl: *mut windows_sys::core::PWSTR, pdwgrantedaccess: *mut u32) -> u32;
...
pub type WlanHostedNetworkForceStart = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pfailreason: *mut WLAN_HOSTED_NETWORK_REASON, pvreserved: *const core::ffi::c_void) -> u32;
...
pub type WlanHostedNetworkForceStop = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pfailreason: *mut WLAN_HOSTED_NETWORK_REASON, pvreserved: *const core::ffi::c_void) -> u32;
...
pub type WlanHostedNetworkInitSettings = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pfailreason: *mut WLAN_HOSTED_NETWORK_REASON, pvreserved: *const core::ffi::c_void) -> u32;
...
pub type WlanHostedNetworkQueryProperty = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, opcode: WLAN_HOSTED_NETWORK_OPCODE, pdwdatasize: *mut u32, ppvdata: *mut *mut core::ffi::c_void, pwlanopcodevaluetype: *mut WLAN_OPCODE_VALUE_TYPE, pvreserved: *const core::ffi::c_void) -> u32;
...
pub type WlanHostedNetworkQueryStatus = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, ppwlanhostednetworkstatus: *mut *mut WLAN_HOSTED_NETWORK_STATUS, pvreserved: *const core::ffi::c_void) -> u32;
...
pub type WlanHostedNetworkRefreshSecuritySettings = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pfailreason: *mut WLAN_HOSTED_NETWORK_REASON, pvreserved: *const core::ffi::c_void) -> u32;
...
pub type WlanHostedNetworkSetProperty = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, opcode: WLAN_HOSTED_NETWORK_OPCODE, dwdatasize: u32, pvdata: *const core::ffi::c_void, pfailreason: *mut WLAN_HOSTED_NETWORK_REASON, pvreserved: *const core::ffi::c_void) -> u32;
...
pub type WlanHostedNetworkSetSecondaryKey = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, dwkeylength: u32, puckeydata: *const u8, bispassphrase: windows_sys::core::BOOL, bpersistent: windows_sys::core::BOOL, pfailreason: *mut WLAN_HOSTED_NETWORK_REASON, pvreserved: *const core::ffi::c_void) -> u32;
...
pub type WlanHostedNetworkStartUsing = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pfailreason: *mut WLAN_HOSTED_NETWORK_REASON, pvreserved: *const core::ffi::c_void) -> u32;
...
pub type WlanHostedNetworkStopUsing = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pfailreason: *mut WLAN_HOSTED_NETWORK_REASON, pvreserved: *const core::ffi::c_void) -> u32;
...
pub type WlanOpenHandle = unsafe extern "system" fn(dwclientversion: u32, preserved: *const core::ffi::c_void, pdwnegotiatedversion: *mut u32, phclienthandle: *mut super::super::Foundation::HANDLE) -> u32;
...
pub type WlanQueryAutoConfigParameter = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, opcode: WLAN_AUTOCONF_OPCODE, preserved: *const core::ffi::c_void, pdwdatasize: *mut u32, ppdata: *mut *mut core::ffi::c_void, pwlanopcodevaluetype: *mut WLAN_OPCODE_VALUE_TYPE) -> u32;
...
pub type WlanQueryInterface = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, opcode: WLAN_INTF_OPCODE, preserved: *const core::ffi::c_void, pdwdatasize: *mut u32, ppdata: *mut *mut core::ffi::c_void, pwlanopcodevaluetype: *mut WLAN_OPCODE_VALUE_TYPE) -> u32;
...
pub type WlanReasonCodeToString = unsafe extern "system" fn(dwreasoncode: u32, dwbuffersize: u32, pstringbuffer: windows_sys::core::PCWSTR, preserved: *const core::ffi::c_void) -> u32;
...
pub type WlanRegisterNotification = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, dwnotifsource: WLAN_NOTIFICATION_SOURCES, bignoreduplicate: windows_sys::core::BOOL, funccallback: WLAN_NOTIFICATION_CALLBACK, pcallbackcontext: *const core::ffi::c_void, preserved: *const core::ffi::c_void, pdwprevnotifsource: *mut u32) -> u32;
...
pub type WlanRegisterVirtualStationNotification = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, bregister: windows_sys::core::BOOL, preserved: *const core::ffi::c_void) -> u32;
...
pub type WlanRenameProfile = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, stroldprofilename: windows_sys::core::PCWSTR, strnewprofilename: windows_sys::core::PCWSTR, preserved: *const core::ffi::c_void) -> u32;
...
pub type WlanScan = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, pdot11ssid: *const DOT11_SSID, piedata: *const WLAN_RAW_DATA, preserved: *const core::ffi::c_void) -> u32;
...
pub type WlanSetAutoConfigParameter = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, opcode: WLAN_AUTOCONF_OPCODE, dwdatasize: u32, pdata: *const core::ffi::c_void, preserved: *const core::ffi::c_void) -> u32;
...
pub type WlanSetFilterList = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, wlanfilterlisttype: WLAN_FILTER_LIST_TYPE, pnetworklist: *const DOT11_NETWORK_LIST, preserved: *const core::ffi::c_void) -> u32;
...
pub type WlanSetInterface = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, opcode: WLAN_INTF_OPCODE, dwdatasize: u32, pdata: *const core::ffi::c_void, preserved: *const core::ffi::c_void) -> u32;
...
pub type WlanSetProfile = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, dwflags: u32, strprofilexml: windows_sys::core::PCWSTR, stralluserprofilesecurity: windows_sys::core::PCWSTR, boverwrite: windows_sys::core::BOOL, preserved: *const core::ffi::c_void, pdwreasoncode: *mut u32) -> u32;
...
pub type WlanSetProfileCustomUserData = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, strprofilename: windows_sys::core::PCWSTR, dwdatasize: u32, pdata: *const u8, preserved: *const core::ffi::c_void) -> u32;
...
pub type WlanSetProfileEapXmlUserData = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, strprofilename: windows_sys::core::PCWSTR, dwflags: WLAN_SET_EAPHOST_FLAGS, streapxmluserdata: windows_sys::core::PCWSTR, preserved: *const core::ffi::c_void) -> u32;
...
pub type WlanSetProfileList = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, dwitems: u32, strprofilenames: *const windows_sys::core::PCWSTR, preserved: *const core::ffi::c_void) -> u32;
...
pub type WlanSetProfilePosition = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_sys::core::GUID, strprofilename: windows_sys::core::PCWSTR, dwposition: u32, preserved: *const core::ffi::c_void) -> u32;
...
pub type WlanSetPsdIEDataList = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, strformat: windows_sys::core::PCWSTR, ppsdiedatalist: *const WLAN_RAW_DATA_LIST, preserved: *const core::ffi::c_void) -> u32;
...
pub type WlanSetSecuritySettings = unsafe extern "system" fn(hclienthandle: super::super::Foundation::HANDLE, securableobject: WLAN_SECURABLE_OBJECT, strmodifiedsddl: windows_sys::core::PCWSTR) -> u32;
...
pub type WlanUIEditProfile = unsafe extern "system" fn(dwclientversion: u32, wstrprofilename: windows_sys::core::PCWSTR, pinterfaceguid: *const windows_sys::core::GUID, hwnd: super::super::Foundation::HWND, wlstartpage: WL_DISPLAY_PAGES, preserved: *const core::ffi::c_void, pwlanreasoncode: *mut u32) -> u32;
