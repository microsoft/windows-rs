...
pub const WnvCustomerAddressAdded: WNV_CA_NOTIFICATION_TYPE = 0;
pub const WnvCustomerAddressDeleted: WNV_CA_NOTIFICATION_TYPE = 1;
pub const WnvCustomerAddressMax: WNV_CA_NOTIFICATION_TYPE = 3;
pub const WnvCustomerAddressMoved: WNV_CA_NOTIFICATION_TYPE = 2;
pub const WnvCustomerAddressType: WNV_OBJECT_TYPE = 1;
pub const WnvNotificationTypeMax: WNV_NOTIFICATION_TYPE = 3;
pub const WnvObjectChangeType: WNV_NOTIFICATION_TYPE = 2;
pub const WnvObjectTypeMax: WNV_OBJECT_TYPE = 2;
pub const WnvPolicyMismatchType: WNV_NOTIFICATION_TYPE = 0;
pub const WnvProviderAddressType: WNV_OBJECT_TYPE = 0;
pub const WnvRedirectType: WNV_NOTIFICATION_TYPE = 1;
