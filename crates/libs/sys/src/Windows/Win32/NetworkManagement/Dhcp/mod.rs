pub type DhcpAddFilterV4 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, addfilterinfo: *const DHCP_FILTER_ADD_INFO, forceflag: windows_sys::core::BOOL) -> u32;
...
pub type DhcpAddSecurityGroup = unsafe extern "system" fn(pserver: windows_sys::core::PCWSTR) -> u32;
...
pub type DhcpAddSubnetElement = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, addelementinfo: *const DHCP_SUBNET_ELEMENT_DATA) -> u32;
...
pub type DhcpAddSubnetElementV4 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, addelementinfo: *const DHCP_SUBNET_ELEMENT_DATA_V4) -> u32;
...
pub type DhcpAddSubnetElementV5 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, addelementinfo: *const DHCP_SUBNET_ELEMENT_DATA_V5) -> u32;
...
pub type DhcpAddSubnetElementV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: DHCP_IPV6_ADDRESS, addelementinfo: *mut DHCP_SUBNET_ELEMENT_DATA_V6) -> u32;
...
pub type DhcpAuditLogGetParams = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, auditlogdir: *mut windows_sys::core::PWSTR, diskcheckinterval: *mut u32, maxlogfilessize: *mut u32, minspaceondisk: *mut u32) -> u32;
...
pub type DhcpAuditLogSetParams = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, auditlogdir: windows_sys::core::PCWSTR, diskcheckinterval: u32, maxlogfilessize: u32, minspaceondisk: u32) -> u32;
...
pub type DhcpCreateClass = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, reservedmustbezero: u32, classinfo: *mut DHCP_CLASS_INFO) -> u32;
...
pub type DhcpCreateClassV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, reservedmustbezero: u32, classinfo: *mut DHCP_CLASS_INFO_V6) -> u32;
...
pub type DhcpCreateClientInfo = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, clientinfo: *const DHCP_CLIENT_INFO) -> u32;
...
pub type DhcpCreateClientInfoV4 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, clientinfo: *const DHCP_CLIENT_INFO_V4) -> u32;
...
pub type DhcpCreateClientInfoVQ = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, clientinfo: *const DHCP_CLIENT_INFO_VQ) -> u32;
...
pub type DhcpCreateOption = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, optionid: u32, optioninfo: *const DHCP_OPTION) -> u32;
...
pub type DhcpCreateOptionV5 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionid: u32, classname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, optioninfo: *mut DHCP_OPTION) -> u32;
...
pub type DhcpCreateOptionV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionid: u32, classname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, optioninfo: *mut DHCP_OPTION) -> u32;
...
pub type DhcpCreateSubnet = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, subnetinfo: *const DHCP_SUBNET_INFO) -> u32;
...
pub type DhcpCreateSubnetV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: DHCP_IPV6_ADDRESS, subnetinfo: *mut DHCP_SUBNET_INFO_V6) -> u32;
...
pub type DhcpCreateSubnetVQ = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, subnetinfo: *const DHCP_SUBNET_INFO_VQ) -> u32;
...
pub type DhcpDeleteClass = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, reservedmustbezero: u32, classname: windows_sys::core::PCWSTR) -> u32;
...
pub type DhcpDeleteClassV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, reservedmustbezero: u32, classname: windows_sys::core::PCWSTR) -> u32;
...
pub type DhcpDeleteClientInfo = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, clientinfo: *const DHCP_SEARCH_INFO) -> u32;
...
pub type DhcpDeleteClientInfoV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, clientinfo: *const DHCP_SEARCH_INFO_V6) -> u32;
...
pub type DhcpDeleteFilterV4 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, deletefilterinfo: *const DHCP_ADDR_PATTERN) -> u32;
...
pub type DhcpDeleteSubnet = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, forceflag: DHCP_FORCE_FLAG) -> u32;
...
pub type DhcpDeleteSubnetV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: DHCP_IPV6_ADDRESS, forceflag: DHCP_FORCE_FLAG) -> u32;
...
pub type DhcpDeleteSuperScopeV4 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, superscopename: windows_sys::core::PCWSTR) -> u32;
...
pub type DhcpEnumClasses = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, reservedmustbezero: u32, resumehandle: *mut u32, preferredmaximum: u32, classinfoarray: *mut *mut DHCP_CLASS_INFO_ARRAY, nread: *mut u32, ntotal: *mut u32) -> u32;
...
pub type DhcpEnumClassesV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, reservedmustbezero: u32, resumehandle: *mut u32, preferredmaximum: u32, classinfoarray: *mut *mut DHCP_CLASS_INFO_ARRAY_V6, nread: *mut u32, ntotal: *mut u32) -> u32;
...
pub type DhcpEnumFilterV4 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, resumehandle: *mut DHCP_ADDR_PATTERN, preferredmaximum: u32, listtype: DHCP_FILTER_LIST_TYPE, enumfilterinfo: *mut *mut DHCP_FILTER_ENUM_INFO, elementsread: *mut u32, elementstotal: *mut u32) -> u32;
...
pub type DhcpEnumOptionValues = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, scopeinfo: *const DHCP_OPTION_SCOPE_INFO, resumehandle: *mut u32, preferredmaximum: u32, optionvalues: *mut *mut DHCP_OPTION_VALUE_ARRAY, optionsread: *mut u32, optionstotal: *mut u32) -> u32;
...
pub type DhcpEnumOptionsV5 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, classname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, resumehandle: *mut u32, preferredmaximum: u32, options: *mut *mut DHCP_OPTION_ARRAY, optionsread: *mut u32, optionstotal: *mut u32) -> u32;
...
pub type DhcpEnumOptionsV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, classname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, resumehandle: *mut u32, preferredmaximum: u32, options: *mut *mut DHCP_OPTION_ARRAY, optionsread: *mut u32, optionstotal: *mut u32) -> u32;
...
pub type DhcpEnumSubnetClients = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, resumehandle: *mut u32, preferredmaximum: u32, clientinfo: *mut *mut DHCP_CLIENT_INFO_ARRAY, clientsread: *mut u32, clientstotal: *mut u32) -> u32;
...
pub type DhcpEnumSubnetClientsFilterStatusInfo = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, resumehandle: *mut u32, preferredmaximum: u32, clientinfo: *mut *mut DHCP_CLIENT_FILTER_STATUS_INFO_ARRAY, clientsread: *mut u32, clientstotal: *mut u32) -> u32;
...
pub type DhcpEnumSubnetClientsV4 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, resumehandle: *mut u32, preferredmaximum: u32, clientinfo: *mut *mut DHCP_CLIENT_INFO_ARRAY_V4, clientsread: *mut u32, clientstotal: *mut u32) -> u32;
...
pub type DhcpEnumSubnetClientsV5 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, resumehandle: *mut u32, preferredmaximum: u32, clientinfo: *mut *mut DHCP_CLIENT_INFO_ARRAY_V5, clientsread: *mut u32, clientstotal: *mut u32) -> u32;
...
pub type DhcpEnumSubnetClientsV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: DHCP_IPV6_ADDRESS, resumehandle: *mut DHCP_IPV6_ADDRESS, preferredmaximum: u32, clientinfo: *mut *mut DHCP_CLIENT_INFO_ARRAY_V6, clientsread: *mut u32, clientstotal: *mut u32) -> u32;
...
pub type DhcpEnumSubnetClientsVQ = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, resumehandle: *mut u32, preferredmaximum: u32, clientinfo: *mut *mut DHCP_CLIENT_INFO_ARRAY_VQ, clientsread: *mut u32, clientstotal: *mut u32) -> u32;
...
pub type DhcpEnumSubnetElements = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, enumelementtype: DHCP_SUBNET_ELEMENT_TYPE, resumehandle: *mut u32, preferredmaximum: u32, enumelementinfo: *mut *mut DHCP_SUBNET_ELEMENT_INFO_ARRAY, elementsread: *mut u32, elementstotal: *mut u32) -> u32;
...
pub type DhcpEnumSubnetElementsV4 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, enumelementtype: DHCP_SUBNET_ELEMENT_TYPE, resumehandle: *mut u32, preferredmaximum: u32, enumelementinfo: *mut *mut DHCP_SUBNET_ELEMENT_INFO_ARRAY_V4, elementsread: *mut u32, elementstotal: *mut u32) -> u32;
...
pub type DhcpEnumSubnetElementsV5 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, enumelementtype: DHCP_SUBNET_ELEMENT_TYPE, resumehandle: *mut u32, preferredmaximum: u32, enumelementinfo: *mut *mut DHCP_SUBNET_ELEMENT_INFO_ARRAY_V5, elementsread: *mut u32, elementstotal: *mut u32) -> u32;
...
pub type DhcpEnumSubnetElementsV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: DHCP_IPV6_ADDRESS, enumelementtype: DHCP_SUBNET_ELEMENT_TYPE_V6, resumehandle: *mut u32, preferredmaximum: u32, enumelementinfo: *mut *mut DHCP_SUBNET_ELEMENT_INFO_ARRAY_V6, elementsread: *mut u32, elementstotal: *mut u32) -> u32;
...
pub type DhcpEnumSubnets = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, resumehandle: *mut u32, preferredmaximum: u32, enuminfo: *mut *mut DHCP_IP_ARRAY, elementsread: *mut u32, elementstotal: *mut u32) -> u32;
...
pub type DhcpEnumSubnetsV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, resumehandle: *mut u32, preferredmaximum: u32, enuminfo: *mut *mut DHCPV6_IP_ARRAY, elementsread: *mut u32, elementstotal: *mut u32) -> u32;
...
pub type DhcpGetAllOptionValues = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO, values: *mut *mut DHCP_ALL_OPTION_VALUES) -> u32;
...
pub type DhcpGetAllOptionValuesV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO6, values: *mut *mut DHCP_ALL_OPTION_VALUES) -> u32;
...
pub type DhcpGetAllOptions = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionstruct: *mut *mut DHCP_ALL_OPTIONS) -> u32;
...
pub type DhcpGetAllOptionsV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionstruct: *mut *mut DHCP_ALL_OPTIONS) -> u32;
...
pub type DhcpGetClassInfo = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, reservedmustbezero: u32, partialclassinfo: *mut DHCP_CLASS_INFO, filledclassinfo: *mut *mut DHCP_CLASS_INFO) -> u32;
...
pub type DhcpGetClientInfo = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, searchinfo: *const DHCP_SEARCH_INFO, clientinfo: *mut *mut DHCP_CLIENT_INFO) -> u32;
...
pub type DhcpGetClientInfoV4 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, searchinfo: *const DHCP_SEARCH_INFO, clientinfo: *mut *mut DHCP_CLIENT_INFO_V4) -> u32;
...
pub type DhcpGetClientInfoV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, searchinfo: *const DHCP_SEARCH_INFO_V6, clientinfo: *mut *mut DHCP_CLIENT_INFO_V6) -> u32;
...
pub type DhcpGetClientInfoVQ = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, searchinfo: *const DHCP_SEARCH_INFO, clientinfo: *mut *mut DHCP_CLIENT_INFO_VQ) -> u32;
...
pub type DhcpGetClientOptions = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, clientipaddress: u32, clientsubnetmask: u32, clientoptions: *mut *mut DHCP_OPTION_LIST) -> u32;
...
pub type DhcpGetFilterV4 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, globalfilterinfo: *mut DHCP_FILTER_GLOBAL_INFO) -> u32;
...
pub type DhcpGetMibInfo = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, mibinfo: *mut *mut DHCP_MIB_INFO) -> u32;
...
pub type DhcpGetMibInfoV5 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, mibinfo: *mut *mut DHCP_MIB_INFO_V5) -> u32;
...
pub type DhcpGetMibInfoV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, mibinfo: *mut *mut DHCP_MIB_INFO_V6) -> u32;
...
pub type DhcpGetOptionInfo = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, optionid: u32, optioninfo: *mut *mut DHCP_OPTION) -> u32;
...
pub type DhcpGetOptionInfoV5 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionid: u32, classname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, optioninfo: *mut *mut DHCP_OPTION) -> u32;
...
pub type DhcpGetOptionInfoV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionid: u32, classname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, optioninfo: *mut *mut DHCP_OPTION) -> u32;
...
pub type DhcpGetOptionValue = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, optionid: u32, scopeinfo: *const DHCP_OPTION_SCOPE_INFO, optionvalue: *mut *mut DHCP_OPTION_VALUE) -> u32;
...
pub type DhcpGetOptionValueV5 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionid: u32, classname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO, optionvalue: *mut *mut DHCP_OPTION_VALUE) -> u32;
...
pub type DhcpGetOptionValueV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionid: u32, classname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO6, optionvalue: *mut *mut DHCP_OPTION_VALUE) -> u32;
...
pub type DhcpGetOriginalSubnetMask = unsafe extern "system" fn(sadaptername: windows_sys::core::PCWSTR, dwsubnetmask: *mut u32) -> u32;
...
pub type DhcpGetServerBindingInfo = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, bindelementsinfo: *mut *mut DHCP_BIND_ELEMENT_ARRAY) -> u32;
...
pub type DhcpGetServerBindingInfoV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, bindelementsinfo: *mut *mut DHCPV6_BIND_ELEMENT_ARRAY) -> u32;
...
pub type DhcpGetServerSpecificStrings = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, serverspecificstrings: *mut *mut DHCP_SERVER_SPECIFIC_STRINGS) -> u32;
...
pub type DhcpGetSubnetDelayOffer = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, timedelayinmilliseconds: *mut u16) -> u32;
...
pub type DhcpGetSubnetInfo = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, subnetinfo: *mut *mut DHCP_SUBNET_INFO) -> u32;
...
pub type DhcpGetSubnetInfoV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: DHCP_IPV6_ADDRESS, subnetinfo: *mut *mut DHCP_SUBNET_INFO_V6) -> u32;
...
pub type DhcpGetSubnetInfoVQ = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, subnetinfo: *mut *mut DHCP_SUBNET_INFO_VQ) -> u32;
...
pub type DhcpGetSuperScopeInfoV4 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, superscopetable: *mut *mut DHCP_SUPER_SCOPE_TABLE) -> u32;
...
pub type DhcpGetVersion = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, majorversion: *mut u32, minorversion: *mut u32) -> u32;
...
pub type DhcpHlprAddV4PolicyCondition = unsafe extern "system" fn(policy: *mut DHCP_POLICY, parentexpr: u32, r#type: DHCP_POL_ATTR_TYPE, optionid: u32, suboptionid: u32, vendorname: windows_sys::core::PCWSTR, operator: DHCP_POL_COMPARATOR, value: *const u8, valuelength: u32, conditionindex: *mut u32) -> u32;
...
pub type DhcpHlprCreateV4Policy = unsafe extern "system" fn(policyname: windows_sys::core::PCWSTR, fglobalpolicy: windows_sys::core::BOOL, subnet: u32, processingorder: u32, rootoperator: DHCP_POL_LOGIC_OPER, description: windows_sys::core::PCWSTR, enabled: windows_sys::core::BOOL, policy: *mut *mut DHCP_POLICY) -> u32;
...
pub type DhcpHlprCreateV4PolicyEx = unsafe extern "system" fn(policyname: windows_sys::core::PCWSTR, fglobalpolicy: windows_sys::core::BOOL, subnet: u32, processingorder: u32, rootoperator: DHCP_POL_LOGIC_OPER, description: windows_sys::core::PCWSTR, enabled: windows_sys::core::BOOL, policy: *mut *mut DHCP_POLICY_EX) -> u32;
...
pub type DhcpHlprIsV4PolicySingleUC = unsafe extern "system" fn(policy: *const DHCP_POLICY) -> windows_sys::core::BOOL;
...
pub type DhcpHlprIsV4PolicyWellFormed = unsafe extern "system" fn(ppolicy: *const DHCP_POLICY) -> windows_sys::core::BOOL;
...
pub type DhcpModifyClass = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, reservedmustbezero: u32, classinfo: *mut DHCP_CLASS_INFO) -> u32;
...
pub type DhcpModifyClassV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, reservedmustbezero: u32, classinfo: *mut DHCP_CLASS_INFO_V6) -> u32;
...
pub type DhcpRegisterParamChange = unsafe extern "system" fn(flags: u32, reserved: *const core::ffi::c_void, adaptername: windows_sys::core::PCWSTR, classid: *mut DHCPCAPI_CLASSID, params: DHCPCAPI_PARAMS_ARRAY, handle: *mut core::ffi::c_void) -> u32;
...
pub type DhcpRemoveOption = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, optionid: u32) -> u32;
windows_link::link!("dhcpsapi.dll" "system" fn DhcpRemoveOption(serveripaddress : windows_sys::core::PCWSTR, optionid : u32) -> u32);
pub type DhcpRemoveOptionV5 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionid: u32, classname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR) -> u32;
...
pub type DhcpRemoveOptionV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionid: u32, classname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR) -> u32;
...
pub type DhcpRemoveOptionValue = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, optionid: u32, scopeinfo: *const DHCP_OPTION_SCOPE_INFO) -> u32;
...
pub type DhcpRemoveOptionValueV5 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionid: u32, classname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO) -> u32;
...
pub type DhcpRemoveOptionValueV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionid: u32, classname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO6) -> u32;
...
pub type DhcpRemoveSubnetElement = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, removeelementinfo: *const DHCP_SUBNET_ELEMENT_DATA, forceflag: DHCP_FORCE_FLAG) -> u32;
...
pub type DhcpRemoveSubnetElementV4 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, removeelementinfo: *const DHCP_SUBNET_ELEMENT_DATA_V4, forceflag: DHCP_FORCE_FLAG) -> u32;
...
pub type DhcpRemoveSubnetElementV5 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, removeelementinfo: *const DHCP_SUBNET_ELEMENT_DATA_V5, forceflag: DHCP_FORCE_FLAG) -> u32;
...
pub type DhcpRemoveSubnetElementV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: DHCP_IPV6_ADDRESS, removeelementinfo: *mut DHCP_SUBNET_ELEMENT_DATA_V6, forceflag: DHCP_FORCE_FLAG) -> u32;
...
pub type DhcpRequestParams = unsafe extern "system" fn(flags: u32, reserved: *mut core::ffi::c_void, adaptername: windows_sys::core::PCWSTR, classid: *mut DHCPCAPI_CLASSID, sendparams: DHCPCAPI_PARAMS_ARRAY, recdparams: DHCPCAPI_PARAMS_ARRAY, buffer: *mut u8, psize: *mut u32, requestidstr: windows_sys::core::PCWSTR) -> u32;
...
pub type DhcpScanDatabase = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, fixflag: u32, scanlist: *mut *mut DHCP_SCAN_LIST) -> u32;
...
pub type DhcpServerBackupDatabase = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, path: windows_sys::core::PCWSTR) -> u32;
...
pub type DhcpServerGetConfig = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, configinfo: *mut *mut DHCP_SERVER_CONFIG_INFO) -> u32;
...
pub type DhcpServerGetConfigV4 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, configinfo: *mut *mut DHCP_SERVER_CONFIG_INFO_V4) -> u32;
...
pub type DhcpServerGetConfigV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO6, configinfo: *mut *mut DHCP_SERVER_CONFIG_INFO_V6) -> u32;
...
pub type DhcpServerGetConfigVQ = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, configinfo: *mut *mut DHCP_SERVER_CONFIG_INFO_VQ) -> u32;
...
pub type DhcpServerQueryAttribute = unsafe extern "system" fn(serveripaddr: windows_sys::core::PCWSTR, dwreserved: u32, dhcpattribid: u32, pdhcpattrib: *mut *mut DHCP_ATTRIB) -> u32;
...
pub type DhcpServerQueryAttributes = unsafe extern "system" fn(serveripaddr: windows_sys::core::PCWSTR, dwreserved: u32, dwattribcount: u32, pdhcpattribs: *mut u32, pdhcpattribarr: *mut *mut DHCP_ATTRIB_ARRAY) -> u32;
...
pub type DhcpServerQueryDnsRegCredentials = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, unamesize: u32, uname: windows_sys::core::PWSTR, domainsize: u32, domain: windows_sys::core::PWSTR) -> u32;
...
pub type DhcpServerRedoAuthorization = unsafe extern "system" fn(serveripaddr: windows_sys::core::PCWSTR, dwreserved: u32) -> u32;
...
pub type DhcpServerRestoreDatabase = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, path: windows_sys::core::PCWSTR) -> u32;
...
pub type DhcpServerSetConfig = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, fieldstoset: u32, configinfo: *mut DHCP_SERVER_CONFIG_INFO) -> u32;
...
pub type DhcpServerSetConfigV4 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, fieldstoset: u32, configinfo: *mut DHCP_SERVER_CONFIG_INFO_V4) -> u32;
...
pub type DhcpServerSetConfigV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO6, fieldstoset: u32, configinfo: *mut DHCP_SERVER_CONFIG_INFO_V6) -> u32;
...
pub type DhcpServerSetConfigVQ = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, fieldstoset: u32, configinfo: *mut DHCP_SERVER_CONFIG_INFO_VQ) -> u32;
...
pub type DhcpServerSetDnsRegCredentials = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, uname: windows_sys::core::PCWSTR, domain: windows_sys::core::PCWSTR, passwd: windows_sys::core::PCWSTR) -> u32;
...
pub type DhcpServerSetDnsRegCredentialsV5 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, uname: windows_sys::core::PCWSTR, domain: windows_sys::core::PCWSTR, passwd: windows_sys::core::PCWSTR) -> u32;
...
pub type DhcpSetClientInfo = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, clientinfo: *const DHCP_CLIENT_INFO) -> u32;
...
pub type DhcpSetClientInfoV4 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, clientinfo: *const DHCP_CLIENT_INFO_V4) -> u32;
...
pub type DhcpSetClientInfoV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, clientinfo: *const DHCP_CLIENT_INFO_V6) -> u32;
...
pub type DhcpSetClientInfoVQ = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, clientinfo: *const DHCP_CLIENT_INFO_VQ) -> u32;
...
pub type DhcpSetFilterV4 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, globalfilterinfo: *const DHCP_FILTER_GLOBAL_INFO) -> u32;
...
pub type DhcpSetOptionInfo = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, optionid: u32, optioninfo: *const DHCP_OPTION) -> u32;
...
pub type DhcpSetOptionInfoV5 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionid: u32, classname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, optioninfo: *mut DHCP_OPTION) -> u32;
...
pub type DhcpSetOptionInfoV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionid: u32, classname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, optioninfo: *mut DHCP_OPTION) -> u32;
...
pub type DhcpSetOptionValue = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, optionid: u32, scopeinfo: *const DHCP_OPTION_SCOPE_INFO, optionvalue: *const DHCP_OPTION_DATA) -> u32;
...
pub type DhcpSetOptionValueV5 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionid: u32, classname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO, optionvalue: *mut DHCP_OPTION_DATA) -> u32;
...
pub type DhcpSetOptionValueV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionid: u32, classname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO6, optionvalue: *mut DHCP_OPTION_DATA) -> u32;
...
pub type DhcpSetOptionValues = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, scopeinfo: *const DHCP_OPTION_SCOPE_INFO, optionvalues: *const DHCP_OPTION_VALUE_ARRAY) -> u32;
...
pub type DhcpSetOptionValuesV5 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, classname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO, optionvalues: *mut DHCP_OPTION_VALUE_ARRAY) -> u32;
...
pub type DhcpSetServerBindingInfo = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, bindelementinfo: *mut DHCP_BIND_ELEMENT_ARRAY) -> u32;
...
pub type DhcpSetServerBindingInfoV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, bindelementinfo: *mut DHCPV6_BIND_ELEMENT_ARRAY) -> u32;
...
pub type DhcpSetSubnetDelayOffer = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, timedelayinmilliseconds: u16) -> u32;
...
pub type DhcpSetSubnetInfo = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, subnetinfo: *const DHCP_SUBNET_INFO) -> u32;
...
pub type DhcpSetSubnetInfoV6 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: DHCP_IPV6_ADDRESS, subnetinfo: *mut DHCP_SUBNET_INFO_V6) -> u32;
...
pub type DhcpSetSubnetInfoVQ = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, subnetinfo: *const DHCP_SUBNET_INFO_VQ) -> u32;
...
pub type DhcpSetSuperScopeV4 = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, superscopename: windows_sys::core::PCWSTR, changeexisting: windows_sys::core::BOOL) -> u32;
...
pub type DhcpUndoRequestParams = unsafe extern "system" fn(flags: u32, reserved: *const core::ffi::c_void, adaptername: windows_sys::core::PCWSTR, requestidstr: windows_sys::core::PCWSTR) -> u32;
...
pub type DhcpV4AddPolicyRange = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, policyname: windows_sys::core::PCWSTR, range: *const DHCP_IP_RANGE) -> u32;
...
pub type DhcpV4CreateClientInfo = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, clientinfo: *const DHCP_CLIENT_INFO_PB) -> u32;
...
pub type DhcpV4CreateClientInfoEx = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, clientinfo: *const DHCP_CLIENT_INFO_EX) -> u32;
...
pub type DhcpV4CreatePolicy = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, ppolicy: *const DHCP_POLICY) -> u32;
...
pub type DhcpV4CreatePolicyEx = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, policyex: *const DHCP_POLICY_EX) -> u32;
...
pub type DhcpV4DeletePolicy = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, fglobalpolicy: windows_sys::core::BOOL, subnetaddress: u32, policyname: windows_sys::core::PCWSTR) -> u32;
...
pub type DhcpV4EnumPolicies = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, resumehandle: *mut u32, preferredmaximum: u32, fglobalpolicy: windows_sys::core::BOOL, subnetaddress: u32, enuminfo: *mut *mut DHCP_POLICY_ARRAY, elementsread: *mut u32, elementstotal: *mut u32) -> u32;
...
pub type DhcpV4EnumPoliciesEx = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, resumehandle: *mut u32, preferredmaximum: u32, globalpolicy: windows_sys::core::BOOL, subnetaddress: u32, enuminfo: *mut *mut DHCP_POLICY_EX_ARRAY, elementsread: *mut u32, elementstotal: *mut u32) -> u32;
...
pub type DhcpV4EnumSubnetClients = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, resumehandle: *mut u32, preferredmaximum: u32, clientinfo: *mut *mut DHCP_CLIENT_INFO_PB_ARRAY, clientsread: *mut u32, clientstotal: *mut u32) -> u32;
...
pub type DhcpV4EnumSubnetClientsEx = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, resumehandle: *mut u32, preferredmaximum: u32, clientinfo: *mut *mut DHCP_CLIENT_INFO_EX_ARRAY, clientsread: *mut u32, clientstotal: *mut u32) -> u32;
...
pub type DhcpV4EnumSubnetReservations = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, resumehandle: *mut u32, preferredmaximum: u32, enumelementinfo: *mut *mut DHCP_RESERVATION_INFO_ARRAY, elementsread: *mut u32, elementstotal: *mut u32) -> u32;
...
pub type DhcpV4FailoverAddScopeToRelationship = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, prelationship: *const DHCP_FAILOVER_RELATIONSHIP) -> u32;
...
pub type DhcpV4FailoverCreateRelationship = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, prelationship: *const DHCP_FAILOVER_RELATIONSHIP) -> u32;
...
pub type DhcpV4FailoverDeleteRelationship = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, prelationshipname: windows_sys::core::PCWSTR) -> u32;
...
pub type DhcpV4FailoverDeleteScopeFromRelationship = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, prelationship: *const DHCP_FAILOVER_RELATIONSHIP) -> u32;
...
pub type DhcpV4FailoverEnumRelationship = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, resumehandle: *mut u32, preferredmaximum: u32, prelationship: *mut *mut DHCP_FAILOVER_RELATIONSHIP_ARRAY, relationshipread: *mut u32, relationshiptotal: *mut u32) -> u32;
...
pub type DhcpV4FailoverGetAddressStatus = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, pstatus: *mut u32) -> u32;
...
pub type DhcpV4FailoverGetClientInfo = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, searchinfo: *const DHCP_SEARCH_INFO, clientinfo: *mut *mut DHCPV4_FAILOVER_CLIENT_INFO) -> u32;
...
pub type DhcpV4FailoverGetRelationship = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, prelationshipname: windows_sys::core::PCWSTR, prelationship: *mut *mut DHCP_FAILOVER_RELATIONSHIP) -> u32;
...
pub type DhcpV4FailoverGetScopeRelationship = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, scopeid: u32, prelationship: *mut *mut DHCP_FAILOVER_RELATIONSHIP) -> u32;
...
pub type DhcpV4FailoverGetScopeStatistics = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, scopeid: u32, pstats: *mut *mut DHCP_FAILOVER_STATISTICS) -> u32;
...
pub type DhcpV4FailoverGetSystemTime = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, ptime: *mut u32, pmaxalloweddeltatime: *mut u32) -> u32;
...
pub type DhcpV4FailoverSetRelationship = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, prelationship: *const DHCP_FAILOVER_RELATIONSHIP) -> u32;
...
pub type DhcpV4FailoverTriggerAddrAllocation = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, pfailrelname: windows_sys::core::PCWSTR) -> u32;
...
pub type DhcpV4GetAllOptionValues = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO, values: *mut *mut DHCP_ALL_OPTION_VALUES_PB) -> u32;
...
pub type DhcpV4GetClientInfo = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, searchinfo: *const DHCP_SEARCH_INFO, clientinfo: *mut *mut DHCP_CLIENT_INFO_PB) -> u32;
...
pub type DhcpV4GetClientInfoEx = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, searchinfo: *const DHCP_SEARCH_INFO, clientinfo: *mut *mut DHCP_CLIENT_INFO_EX) -> u32;
...
pub type DhcpV4GetFreeIPAddress = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, scopeid: u32, startip: u32, endip: u32, numfreeaddrreq: u32, ipaddrlist: *mut *mut DHCP_IP_ARRAY) -> u32;
...
pub type DhcpV4GetOptionValue = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionid: u32, policyname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO, optionvalue: *mut *mut DHCP_OPTION_VALUE) -> u32;
...
pub type DhcpV4GetPolicy = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, fglobalpolicy: windows_sys::core::BOOL, subnetaddress: u32, policyname: windows_sys::core::PCWSTR, policy: *mut *mut DHCP_POLICY) -> u32;
...
pub type DhcpV4GetPolicyEx = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, globalpolicy: windows_sys::core::BOOL, subnetaddress: u32, policyname: windows_sys::core::PCWSTR, policy: *mut *mut DHCP_POLICY_EX) -> u32;
...
pub type DhcpV4QueryPolicyEnforcement = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, fglobalpolicy: windows_sys::core::BOOL, subnetaddress: u32, enabled: *mut windows_sys::core::BOOL) -> u32;
...
pub type DhcpV4RemoveOptionValue = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionid: u32, policyname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO) -> u32;
...
pub type DhcpV4RemovePolicyRange = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, subnetaddress: u32, policyname: windows_sys::core::PCWSTR, range: *const DHCP_IP_RANGE) -> u32;
...
pub type DhcpV4SetOptionValue = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, optionid: u32, policyname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO, optionvalue: *mut DHCP_OPTION_DATA) -> u32;
...
pub type DhcpV4SetOptionValues = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, flags: u32, policyname: windows_sys::core::PCWSTR, vendorname: windows_sys::core::PCWSTR, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO, optionvalues: *mut DHCP_OPTION_VALUE_ARRAY) -> u32;
...
pub type DhcpV4SetPolicy = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, fieldsmodified: u32, fglobalpolicy: windows_sys::core::BOOL, subnetaddress: u32, policyname: windows_sys::core::PCWSTR, policy: *const DHCP_POLICY) -> u32;
...
pub type DhcpV4SetPolicyEnforcement = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, fglobalpolicy: windows_sys::core::BOOL, subnetaddress: u32, enable: windows_sys::core::BOOL) -> u32;
...
pub type DhcpV4SetPolicyEx = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, fieldsmodified: u32, globalpolicy: windows_sys::core::BOOL, subnetaddress: u32, policyname: windows_sys::core::PCWSTR, policy: *const DHCP_POLICY_EX) -> u32;
...
pub type DhcpV6CreateClientInfo = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, clientinfo: *const DHCP_CLIENT_INFO_V6) -> u32;
...
pub type DhcpV6GetFreeIPAddress = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, scopeid: DHCP_IPV6_ADDRESS, startip: DHCP_IPV6_ADDRESS, endip: DHCP_IPV6_ADDRESS, numfreeaddrreq: u32, ipaddrlist: *mut *mut DHCPV6_IP_ARRAY) -> u32;
...
pub type DhcpV6GetStatelessStatistics = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, statelessstats: *mut *mut DHCPV6_STATELESS_STATS) -> u32;
...
pub type DhcpV6GetStatelessStoreParams = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, fserverlevel: windows_sys::core::BOOL, subnetaddress: DHCP_IPV6_ADDRESS, params: *mut *mut DHCPV6_STATELESS_PARAMS) -> u32;
...
pub type DhcpV6SetStatelessStoreParams = unsafe extern "system" fn(serveripaddress: windows_sys::core::PCWSTR, fserverlevel: windows_sys::core::BOOL, subnetaddress: DHCP_IPV6_ADDRESS, fieldmodified: u32, params: *const DHCPV6_STATELESS_PARAMS) -> u32;
...
pub type Dhcpv6ReleasePrefix = unsafe extern "system" fn(adaptername: windows_sys::core::PCWSTR, classid: *mut DHCPV6CAPI_CLASSID, leaseinfo: *mut DHCPV6PrefixLeaseInformation) -> u32;
...
pub type Dhcpv6RenewPrefix = unsafe extern "system" fn(adaptername: windows_sys::core::PCWSTR, pclassid: *mut DHCPV6CAPI_CLASSID, prefixleaseinfo: *mut DHCPV6PrefixLeaseInformation, pdwtimetowait: *mut u32, bvalidateprefix: u32) -> u32;
...
pub type Dhcpv6RequestParams = unsafe extern "system" fn(forcenewinform: windows_sys::core::BOOL, reserved: *mut core::ffi::c_void, adaptername: windows_sys::core::PCWSTR, classid: *mut DHCPV6CAPI_CLASSID, recdparams: DHCPV6CAPI_PARAMS_ARRAY, buffer: *mut u8, psize: *mut u32) -> u32;
...
pub type Dhcpv6RequestPrefix = unsafe extern "system" fn(adaptername: windows_sys::core::PCWSTR, pclassid: *mut DHCPV6CAPI_CLASSID, prefixleaseinfo: *mut DHCPV6PrefixLeaseInformation, pdwtimetowait: *mut u32) -> u32;
