...
pub const DRT_ACTIVE: DRT_STATUS = 0;
#[repr(C)]
#[cfg(feature = "Win32_Networking_WinSock")]
...
pub const DRT_ADDRESS_FLAG_ACCEPTED: DRT_ADDRESS_FLAGS = 1;
pub const DRT_ADDRESS_FLAG_BAD_VALIDATE_ID: DRT_ADDRESS_FLAGS = 32;
pub const DRT_ADDRESS_FLAG_INQUIRE: DRT_ADDRESS_FLAGS = 128;
pub const DRT_ADDRESS_FLAG_LOOP: DRT_ADDRESS_FLAGS = 8;
pub const DRT_ADDRESS_FLAG_REJECTED: DRT_ADDRESS_FLAGS = 2;
pub const DRT_ADDRESS_FLAG_SUSPECT_UNREGISTERED_ID: DRT_ADDRESS_FLAGS = 64;
pub const DRT_ADDRESS_FLAG_TOO_BUSY: DRT_ADDRESS_FLAGS = 16;
pub const DRT_ADDRESS_FLAG_UNREACHABLE: DRT_ADDRESS_FLAGS = 4;
#[repr(C)]
#[cfg(feature = "Win32_Networking_WinSock")]
...
pub const DRT_ALONE: DRT_STATUS = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const DRT_EVENT_LEAFSET_KEY_CHANGED: DRT_EVENT_TYPE = 1;
pub const DRT_EVENT_REGISTRATION_STATE_CHANGED: DRT_EVENT_TYPE = 2;
pub const DRT_EVENT_STATUS_CHANGED: DRT_EVENT_TYPE = 0;
...
pub const DRT_FAULTED: DRT_STATUS = 20;
pub const DRT_GLOBAL_SCOPE: DRT_SCOPE = 1;
pub const DRT_LEAFSET_KEY_ADDED: DRT_LEAFSET_KEY_CHANGE_TYPE = 0;
pub type DRT_LEAFSET_KEY_CHANGE_TYPE = i32;
pub const DRT_LEAFSET_KEY_DELETED: DRT_LEAFSET_KEY_CHANGE_TYPE = 1;
pub const DRT_LINK_LOCAL_ISATAP_SCOPEID: u32 = 4294967295;
pub const DRT_LINK_LOCAL_SCOPE: DRT_SCOPE = 3;
pub const DRT_MATCH_EXACT: DRT_MATCH_TYPE = 0;
pub const DRT_MATCH_INTERMEDIATE: DRT_MATCH_TYPE = 2;
pub const DRT_MATCH_NEAR: DRT_MATCH_TYPE = 1;
...
pub const DRT_NO_NETWORK: DRT_STATUS = 10;
...
pub const DRT_REGISTRATION_STATE_UNRESOLVEABLE: DRT_REGISTRATION_STATE = 1;
...
pub const DRT_SECURE_CONFIDENTIALPAYLOAD: DRT_SECURITY_MODE = 2;
pub const DRT_SECURE_MEMBERSHIP: DRT_SECURITY_MODE = 1;
pub const DRT_SECURE_RESOLVE: DRT_SECURITY_MODE = 0;
...
pub const DRT_SITE_LOCAL_SCOPE: DRT_SCOPE = 2;
pub type DRT_STATUS = i32;
pub const DRT_S_RETRY: windows_sys::core::HRESULT = 0x621010_u32 as _;
pub const FACILITY_DRT: u32 = 98;
pub const MaximumPeerDistClientInfoByHandlesClass: PEERDIST_CLIENT_INFO_BY_HANDLE_CLASS = 1;
...
pub const PEERDIST_PUBLICATION_OPTIONS_VERSION: i32 = 2;
pub const PEERDIST_PUBLICATION_OPTIONS_VERSION_1: i32 = 1;
pub const PEERDIST_PUBLICATION_OPTIONS_VERSION_2: i32 = 2;
...
pub const PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION: PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION_VALUE = 2;
pub const PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION_1: PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION_VALUE = 1;
pub const PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION_2: PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION_VALUE = 2;
pub type PEERDIST_RETRIEVAL_OPTIONS_CONTENTINFO_VERSION_VALUE = u32;
pub type PEERDIST_STATUS = i32;
pub const PEERDIST_STATUS_AVAILABLE: PEERDIST_STATUS = 2;
pub const PEERDIST_STATUS_DISABLED: PEERDIST_STATUS = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const PEERDIST_STATUS_UNAVAILABLE: PEERDIST_STATUS = 1;
#[repr(C)]
#[cfg(feature = "Win32_Networking_WinSock")]
#[derive(Clone, Copy)]
...
pub const PEER_APPLICATION_ALL_USERS: PEER_APPLICATION_REGISTRATION_TYPE = 1;
pub const PEER_APPLICATION_CURRENT_USER: PEER_APPLICATION_REGISTRATION_TYPE = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const PEER_CHANGE_ADDED: PEER_CHANGE_TYPE = 0;
pub const PEER_CHANGE_DELETED: PEER_CHANGE_TYPE = 1;
pub type PEER_CHANGE_TYPE = i32;
pub const PEER_CHANGE_UPDATED: PEER_CHANGE_TYPE = 2;
#[repr(C)]
#[cfg(feature = "Win32_Networking_WinSock")]
#[derive(Clone, Copy)]
...
pub const PEER_CONNECTED: PEER_CONNECTION_STATUS = 1;
pub const PEER_CONNECTION_DIRECT: PEER_CONNECTION_FLAGS = 2;
pub const PEER_CONNECTION_FAILED: PEER_CONNECTION_STATUS = 3;
...
pub const PEER_CONNECTION_NEIGHBOR: PEER_CONNECTION_FLAGS = 1;
...
pub const PEER_DEFER_EXPIRATION: PEER_GROUP_PROPERTY_FLAGS = 4;
pub const PEER_DISABLE_PRESENCE: PEER_GROUP_PROPERTY_FLAGS = 2;
pub const PEER_DISCONNECTED: PEER_CONNECTION_STATUS = 2;
#[repr(C)]
#[cfg(feature = "Win32_Networking_WinSock")]
#[derive(Clone, Copy)]
...
pub const PEER_EVENT_ENDPOINT_APPLICATION_CHANGED: PEER_COLLAB_EVENT_TYPE = 4;
pub const PEER_EVENT_ENDPOINT_CHANGED: PEER_COLLAB_EVENT_TYPE = 2;
#[repr(C)]
#[cfg(feature = "Win32_Networking_WinSock")]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const PEER_EVENT_ENDPOINT_OBJECT_CHANGED: PEER_COLLAB_EVENT_TYPE = 5;
pub const PEER_EVENT_ENDPOINT_PRESENCE_CHANGED: PEER_COLLAB_EVENT_TYPE = 3;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const PEER_EVENT_MY_APPLICATION_CHANGED: PEER_COLLAB_EVENT_TYPE = 8;
pub const PEER_EVENT_MY_ENDPOINT_CHANGED: PEER_COLLAB_EVENT_TYPE = 6;
pub const PEER_EVENT_MY_OBJECT_CHANGED: PEER_COLLAB_EVENT_TYPE = 9;
pub const PEER_EVENT_MY_PRESENCE_CHANGED: PEER_COLLAB_EVENT_TYPE = 7;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const PEER_EVENT_PEOPLE_NEAR_ME_CHANGED: PEER_COLLAB_EVENT_TYPE = 10;
#[repr(C)]
#[cfg(feature = "Win32_Networking_WinSock")]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const PEER_EVENT_REQUEST_STATUS_CHANGED: PEER_COLLAB_EVENT_TYPE = 11;
#[repr(C)]
#[cfg(feature = "Win32_Networking_WinSock")]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const PEER_EVENT_WATCHLIST_CHANGED: PEER_COLLAB_EVENT_TYPE = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const PEER_GRAPH_EVENT_CONNECTION_REQUIRED: PEER_GRAPH_EVENT_TYPE = 7;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const PEER_GRAPH_EVENT_DIRECT_CONNECTION: PEER_GRAPH_EVENT_TYPE = 4;
pub const PEER_GRAPH_EVENT_INCOMING_DATA: PEER_GRAPH_EVENT_TYPE = 6;
pub const PEER_GRAPH_EVENT_NEIGHBOR_CONNECTION: PEER_GRAPH_EVENT_TYPE = 5;
pub const PEER_GRAPH_EVENT_NODE_CHANGED: PEER_GRAPH_EVENT_TYPE = 8;
pub const PEER_GRAPH_EVENT_PROPERTY_CHANGED: PEER_GRAPH_EVENT_TYPE = 2;
pub const PEER_GRAPH_EVENT_RECORD_CHANGED: PEER_GRAPH_EVENT_TYPE = 3;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const PEER_GRAPH_EVENT_STATUS_CHANGED: PEER_GRAPH_EVENT_TYPE = 1;
pub const PEER_GRAPH_EVENT_SYNCHRONIZED: PEER_GRAPH_EVENT_TYPE = 9;
...
pub const PEER_GRAPH_PROPERTY_DEFER_EXPIRATION: PEER_GRAPH_PROPERTY_FLAGS = 2;
pub type PEER_GRAPH_PROPERTY_FLAGS = i32;
pub const PEER_GRAPH_PROPERTY_HEARTBEATS: PEER_GRAPH_PROPERTY_FLAGS = 1;
pub type PEER_GRAPH_SCOPE = i32;
pub const PEER_GRAPH_SCOPE_ANY: PEER_GRAPH_SCOPE = 0;
pub const PEER_GRAPH_SCOPE_GLOBAL: PEER_GRAPH_SCOPE = 1;
pub const PEER_GRAPH_SCOPE_LINKLOCAL: PEER_GRAPH_SCOPE = 3;
pub const PEER_GRAPH_SCOPE_LOOPBACK: PEER_GRAPH_SCOPE = 4;
pub const PEER_GRAPH_SCOPE_SITELOCAL: PEER_GRAPH_SCOPE = 2;
pub type PEER_GRAPH_STATUS_FLAGS = i32;
pub const PEER_GRAPH_STATUS_HAS_CONNECTIONS: PEER_GRAPH_STATUS_FLAGS = 2;
pub const PEER_GRAPH_STATUS_LISTENING: PEER_GRAPH_STATUS_FLAGS = 1;
pub const PEER_GRAPH_STATUS_SYNCHRONIZED: PEER_GRAPH_STATUS_FLAGS = 4;
pub type PEER_GROUP_AUTHENTICATION_SCHEME = i32;
pub const PEER_GROUP_EVENT_AUTHENTICATION_FAILED: PEER_GROUP_EVENT_TYPE = 11;
pub const PEER_GROUP_EVENT_CONNECTION_FAILED: PEER_GROUP_EVENT_TYPE = 10;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const PEER_GROUP_EVENT_DIRECT_CONNECTION: PEER_GROUP_EVENT_TYPE = 4;
pub const PEER_GROUP_EVENT_INCOMING_DATA: PEER_GROUP_EVENT_TYPE = 6;
pub const PEER_GROUP_EVENT_MEMBER_CHANGED: PEER_GROUP_EVENT_TYPE = 8;
pub const PEER_GROUP_EVENT_NEIGHBOR_CONNECTION: PEER_GROUP_EVENT_TYPE = 5;
pub const PEER_GROUP_EVENT_PROPERTY_CHANGED: PEER_GROUP_EVENT_TYPE = 2;
pub const PEER_GROUP_EVENT_RECORD_CHANGED: PEER_GROUP_EVENT_TYPE = 3;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const PEER_GROUP_EVENT_STATUS_CHANGED: PEER_GROUP_EVENT_TYPE = 1;
pub type PEER_GROUP_EVENT_TYPE = i32;
pub const PEER_GROUP_GMC_AUTHENTICATION: PEER_GROUP_AUTHENTICATION_SCHEME = 1;
pub type PEER_GROUP_ISSUE_CREDENTIAL_FLAGS = i32;
pub const PEER_GROUP_PASSWORD_AUTHENTICATION: PEER_GROUP_AUTHENTICATION_SCHEME = 2;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const PEER_GROUP_STATUS_HAS_CONNECTIONS: PEER_GROUP_STATUS = 2;
pub const PEER_GROUP_STATUS_LISTENING: PEER_GROUP_STATUS = 1;
pub const PEER_GROUP_STORE_CREDENTIALS: PEER_GROUP_ISSUE_CREDENTIAL_FLAGS = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const PEER_INVITATION_RESPONSE_ACCEPTED: PEER_INVITATION_RESPONSE_TYPE = 1;
pub const PEER_INVITATION_RESPONSE_DECLINED: PEER_INVITATION_RESPONSE_TYPE = 0;
pub const PEER_INVITATION_RESPONSE_ERROR: PEER_INVITATION_RESPONSE_TYPE = 3;
pub const PEER_INVITATION_RESPONSE_EXPIRED: PEER_INVITATION_RESPONSE_TYPE = 2;
...
pub const PEER_MEMBER_CONNECTED: PEER_MEMBER_CHANGE_TYPE = 1;
pub const PEER_MEMBER_DATA_OPTIONAL: PEER_GROUP_PROPERTY_FLAGS = 1;
pub const PEER_MEMBER_DISCONNECTED: PEER_MEMBER_CHANGE_TYPE = 2;
pub type PEER_MEMBER_FLAGS = i32;
pub const PEER_MEMBER_JOINED: PEER_MEMBER_CHANGE_TYPE = 4;
pub const PEER_MEMBER_LEFT: PEER_MEMBER_CHANGE_TYPE = 5;
pub const PEER_MEMBER_PRESENT: PEER_MEMBER_FLAGS = 1;
pub const PEER_MEMBER_UPDATED: PEER_MEMBER_CHANGE_TYPE = 3;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const PEER_NODE_CHANGE_CONNECTED: PEER_NODE_CHANGE_TYPE = 1;
pub const PEER_NODE_CHANGE_DISCONNECTED: PEER_NODE_CHANGE_TYPE = 2;
pub type PEER_NODE_CHANGE_TYPE = i32;
pub const PEER_NODE_CHANGE_UPDATED: PEER_NODE_CHANGE_TYPE = 3;
#[repr(C)]
#[cfg(feature = "Win32_Networking_WinSock")]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const PEER_PRESENCE_AWAY: PEER_PRESENCE_STATUS = 2;
pub const PEER_PRESENCE_BE_RIGHT_BACK: PEER_PRESENCE_STATUS = 3;
pub const PEER_PRESENCE_BUSY: PEER_PRESENCE_STATUS = 5;
pub const PEER_PRESENCE_IDLE: PEER_PRESENCE_STATUS = 4;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const PEER_PRESENCE_OFFLINE: PEER_PRESENCE_STATUS = 0;
pub const PEER_PRESENCE_ONLINE: PEER_PRESENCE_STATUS = 7;
pub const PEER_PRESENCE_ON_THE_PHONE: PEER_PRESENCE_STATUS = 6;
pub const PEER_PRESENCE_OUT_TO_LUNCH: PEER_PRESENCE_STATUS = 1;
pub type PEER_PRESENCE_STATUS = i32;
pub type PEER_PUBLICATION_SCOPE = i32;
pub const PEER_PUBLICATION_SCOPE_ALL: PEER_PUBLICATION_SCOPE = 3;
pub const PEER_PUBLICATION_SCOPE_INTERNET: PEER_PUBLICATION_SCOPE = 2;
pub const PEER_PUBLICATION_SCOPE_NEAR_ME: PEER_PUBLICATION_SCOPE = 1;
pub const PEER_PUBLICATION_SCOPE_NONE: PEER_PUBLICATION_SCOPE = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const PEER_RECORD_ADDED: PEER_RECORD_CHANGE_TYPE = 1;
pub type PEER_RECORD_CHANGE_TYPE = i32;
pub const PEER_RECORD_DELETED: PEER_RECORD_CHANGE_TYPE = 3;
pub const PEER_RECORD_EXPIRED: PEER_RECORD_CHANGE_TYPE = 4;
pub type PEER_RECORD_FLAGS = i32;
pub const PEER_RECORD_FLAG_AUTOREFRESH: PEER_RECORD_FLAGS = 1;
pub const PEER_RECORD_FLAG_DELETED: PEER_RECORD_FLAGS = 2;
pub const PEER_RECORD_UPDATED: PEER_RECORD_CHANGE_TYPE = 2;
#[repr(C)]
...
pub const PEER_SIGNIN_ALL: PEER_SIGNIN_FLAGS = 3;
pub type PEER_SIGNIN_FLAGS = i32;
pub const PEER_SIGNIN_INTERNET: PEER_SIGNIN_FLAGS = 2;
pub const PEER_SIGNIN_NEAR_ME: PEER_SIGNIN_FLAGS = 1;
pub const PEER_SIGNIN_NONE: PEER_SIGNIN_FLAGS = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const PEER_WATCH_ALLOWED: PEER_WATCH_PERMISSION = 1;
pub const PEER_WATCH_BLOCKED: PEER_WATCH_PERMISSION = 0;
...
pub const PNRP_CLOUD_FULL_PARTICIPANT: PNRP_CLOUD_FLAGS = 4;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const PNRP_CLOUD_NAME_LOCAL: PNRP_CLOUD_FLAGS = 1;
pub const PNRP_CLOUD_NO_FLAGS: PNRP_CLOUD_FLAGS = 0;
pub const PNRP_CLOUD_RESOLVE_ONLY: PNRP_CLOUD_FLAGS = 2;
pub type PNRP_CLOUD_STATE = i32;
pub const PNRP_CLOUD_STATE_ACTIVE: PNRP_CLOUD_STATE = 2;
pub const PNRP_CLOUD_STATE_ALONE: PNRP_CLOUD_STATE = 6;
pub const PNRP_CLOUD_STATE_DEAD: PNRP_CLOUD_STATE = 3;
pub const PNRP_CLOUD_STATE_DISABLED: PNRP_CLOUD_STATE = 4;
pub const PNRP_CLOUD_STATE_NO_NET: PNRP_CLOUD_STATE = 5;
pub const PNRP_CLOUD_STATE_SYNCHRONISING: PNRP_CLOUD_STATE = 1;
pub const PNRP_CLOUD_STATE_VIRTUAL: PNRP_CLOUD_STATE = 0;
pub type PNRP_EXTENDED_PAYLOAD_TYPE = i32;
pub const PNRP_EXTENDED_PAYLOAD_TYPE_BINARY: PNRP_EXTENDED_PAYLOAD_TYPE = 1;
pub const PNRP_EXTENDED_PAYLOAD_TYPE_NONE: PNRP_EXTENDED_PAYLOAD_TYPE = 0;
pub const PNRP_EXTENDED_PAYLOAD_TYPE_STRING: PNRP_EXTENDED_PAYLOAD_TYPE = 2;
pub const PNRP_GLOBAL_SCOPE: PNRP_SCOPE = 1;
pub const PNRP_LINK_LOCAL_SCOPE: PNRP_SCOPE = 3;
...
pub const PNRP_REGISTERED_ID_STATE_OK: PNRP_REGISTERED_ID_STATE = 1;
pub const PNRP_REGISTERED_ID_STATE_PROBLEM: PNRP_REGISTERED_ID_STATE = 2;
pub type PNRP_RESOLVE_CRITERIA = i32;
pub const PNRP_RESOLVE_CRITERIA_ANY_PEER_NAME: PNRP_RESOLVE_CRITERIA = 5;
pub const PNRP_RESOLVE_CRITERIA_DEFAULT: PNRP_RESOLVE_CRITERIA = 0;
pub const PNRP_RESOLVE_CRITERIA_NEAREST_NON_CURRENT_PROCESS_PEER_NAME: PNRP_RESOLVE_CRITERIA = 4;
pub const PNRP_RESOLVE_CRITERIA_NEAREST_PEER_NAME: PNRP_RESOLVE_CRITERIA = 6;
pub const PNRP_RESOLVE_CRITERIA_NEAREST_REMOTE_PEER_NAME: PNRP_RESOLVE_CRITERIA = 2;
pub const PNRP_RESOLVE_CRITERIA_NON_CURRENT_PROCESS_PEER_NAME: PNRP_RESOLVE_CRITERIA = 3;
pub const PNRP_RESOLVE_CRITERIA_REMOTE_PEER_NAME: PNRP_RESOLVE_CRITERIA = 1;
pub type PNRP_SCOPE = i32;
pub const PNRP_SCOPE_ANY: PNRP_SCOPE = 0;
pub const PNRP_SITE_LOCAL_SCOPE: PNRP_SCOPE = 2;
pub const PeerDistClientBasicInfo: PEERDIST_CLIENT_INFO_BY_HANDLE_CLASS = 0;
...
pub const WSA_PNRP_CLIENT_INVALID_COMPARTMENT_ID: u32 = 11506;
pub const WSA_PNRP_CLOUD_DISABLED: u32 = 11502;
pub const WSA_PNRP_CLOUD_IS_DEAD: u32 = 11509;
pub const WSA_PNRP_CLOUD_IS_SEARCH_ONLY: u32 = 11505;
pub const WSA_PNRP_CLOUD_NOT_FOUND: u32 = 11501;
pub const WSA_PNRP_DUPLICATE_PEER_NAME: u32 = 11508;
pub const WSA_PNRP_ERROR_BASE: u32 = 11500;
pub const WSA_PNRP_INVALID_IDENTITY: u32 = 11503;
pub const WSA_PNRP_TOO_MUCH_LOAD: u32 = 11504;
