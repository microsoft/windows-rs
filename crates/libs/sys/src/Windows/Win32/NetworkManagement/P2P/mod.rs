...
pub type DrtCreateDnsBootstrapResolver = unsafe extern "system" fn(port: u16, pwszaddress: windows_sys::core::PCWSTR, ppmodule: *mut *mut DRT_BOOTSTRAP_PROVIDER) -> windows_sys::core::HRESULT;
...
pub type DrtCreatePnrpBootstrapResolver = unsafe extern "system" fn(fpublish: windows_sys::core::BOOL, pwzpeername: windows_sys::core::PCWSTR, pwzcloudname: windows_sys::core::PCWSTR, pwzpublishingidentity: windows_sys::core::PCWSTR, ppresolver: *mut *mut DRT_BOOTSTRAP_PROVIDER) -> windows_sys::core::HRESULT;
...
pub type DrtGetInstanceName = unsafe extern "system" fn(hdrt: *const core::ffi::c_void, ulcbinstancenamesize: u32, pwzdrtinstancename: windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerCollabAddContact = unsafe extern "system" fn(pwzcontactdata: windows_sys::core::PCWSTR, ppcontact: *mut *mut PEER_CONTACT) -> windows_sys::core::HRESULT;
...
pub type PeerCollabDeleteContact = unsafe extern "system" fn(pwzpeername: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerCollabExportContact = unsafe extern "system" fn(pwzpeername: windows_sys::core::PCWSTR, ppwzcontactdata: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerCollabGetContact = unsafe extern "system" fn(pwzpeername: windows_sys::core::PCWSTR, ppcontact: *mut *mut PEER_CONTACT) -> windows_sys::core::HRESULT;
...
pub type PeerCollabGetEndpointName = unsafe extern "system" fn(ppwzendpointname: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerCollabParseContact = unsafe extern "system" fn(pwzcontactdata: windows_sys::core::PCWSTR, ppcontact: *mut *mut PEER_CONTACT) -> windows_sys::core::HRESULT;
...
#[cfg(feature = "Win32_Networking_WinSock")]
pub type PeerCollabQueryContactData = unsafe extern "system" fn(pcendpoint: *const PEER_ENDPOINT, ppwzcontactdata: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Networking_WinSock")]
...
pub type PeerCollabSetEndpointName = unsafe extern "system" fn(pwzendpointname: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerCreatePeerName = unsafe extern "system" fn(pwzidentity: windows_sys::core::PCWSTR, pwzclassifier: windows_sys::core::PCWSTR, ppwzpeername: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
#[cfg(feature = "Win32_System_IO")]
pub type PeerDistGetOverlappedResult = unsafe extern "system" fn(lpoverlapped: *const super::super::System::IO::OVERLAPPED, lpnumberofbytestransferred: *mut u32, bwait: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
#[cfg(feature = "Win32_System_IO")]
...
pub type PeerEnumGroups = unsafe extern "system" fn(pwzidentity: windows_sys::core::PCWSTR, phpeerenum: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
#[cfg(feature = "Win32_Networking_WinSock")]
pub type PeerGraphConnect = unsafe extern "system" fn(hgraph: *const core::ffi::c_void, pwzpeerid: windows_sys::core::PCWSTR, paddress: *const PEER_ADDRESS, pullconnectionid: *mut u64) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Networking_WinSock")]
...
pub type PeerGraphCreate = unsafe extern "system" fn(pgraphproperties: *const PEER_GRAPH_PROPERTIES, pwzdatabasename: windows_sys::core::PCWSTR, psecurityinterface: *const PEER_SECURITY_INTERFACE, phgraph: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type PeerGraphDelete = unsafe extern "system" fn(pwzgraphid: windows_sys::core::PCWSTR, pwzpeerid: windows_sys::core::PCWSTR, pwzdatabasename: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerGraphDeleteRecord = unsafe extern "system" fn(hgraph: *const core::ffi::c_void, precordid: *const windows_sys::core::GUID, flocal: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type PeerGraphEnumNodes = unsafe extern "system" fn(hgraph: *const core::ffi::c_void, pwzpeerid: windows_sys::core::PCWSTR, phpeerenum: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type PeerGraphEnumRecords = unsafe extern "system" fn(hgraph: *const core::ffi::c_void, precordtype: *const windows_sys::core::GUID, pwzpeerid: windows_sys::core::PCWSTR, phpeerenum: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type PeerGraphExportDatabase = unsafe extern "system" fn(hgraph: *const core::ffi::c_void, pwzfilepath: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerGraphImportDatabase = unsafe extern "system" fn(hgraph: *const core::ffi::c_void, pwzfilepath: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
#[cfg(feature = "Win32_Networking_WinSock")]
pub type PeerGraphOpenDirectConnection = unsafe extern "system" fn(hgraph: *const core::ffi::c_void, pwzpeerid: windows_sys::core::PCWSTR, paddress: *const PEER_ADDRESS, pullconnectionid: *mut u64) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Networking_WinSock")]
...
pub type PeerGraphSearchRecords = unsafe extern "system" fn(hgraph: *const core::ffi::c_void, pwzcriteria: windows_sys::core::PCWSTR, phpeerenum: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type PeerGraphSetNodeAttributes = unsafe extern "system" fn(hgraph: *const core::ffi::c_void, pwzattributes: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerGraphSetPresence = unsafe extern "system" fn(hgraph: *const core::ffi::c_void, fpresent: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type PeerGroupCreateInvitation = unsafe extern "system" fn(hgroup: *const core::ffi::c_void, pwzidentityinfo: windows_sys::core::PCWSTR, pftexpiration: *const super::super::Foundation::FILETIME, croles: u32, proles: *const windows_sys::core::GUID, ppwzinvitation: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerGroupCreatePasswordInvitation = unsafe extern "system" fn(hgroup: *const core::ffi::c_void, ppwzinvitation: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerGroupDelete = unsafe extern "system" fn(pwzidentity: windows_sys::core::PCWSTR, pwzgrouppeername: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerGroupEnumMembers = unsafe extern "system" fn(hgroup: *const core::ffi::c_void, dwflags: u32, pwzidentity: windows_sys::core::PCWSTR, phpeerenum: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type PeerGroupExportConfig = unsafe extern "system" fn(hgroup: *const core::ffi::c_void, pwzpassword: windows_sys::core::PCWSTR, ppwzxml: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerGroupExportDatabase = unsafe extern "system" fn(hgroup: *const core::ffi::c_void, pwzfilepath: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerGroupImportConfig = unsafe extern "system" fn(pwzxml: windows_sys::core::PCWSTR, pwzpassword: windows_sys::core::PCWSTR, foverwrite: windows_sys::core::BOOL, ppwzidentity: *mut windows_sys::core::PWSTR, ppwzgroup: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerGroupImportDatabase = unsafe extern "system" fn(hgroup: *const core::ffi::c_void, pwzfilepath: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
#[cfg(feature = "Win32_Security_Cryptography")]
pub type PeerGroupIssueCredentials = unsafe extern "system" fn(hgroup: *const core::ffi::c_void, pwzsubjectidentity: windows_sys::core::PCWSTR, pcredentialinfo: *const PEER_CREDENTIAL_INFO, dwflags: u32, ppwzinvitation: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Security_Cryptography")]
...
pub type PeerGroupJoin = unsafe extern "system" fn(pwzidentity: windows_sys::core::PCWSTR, pwzinvitation: windows_sys::core::PCWSTR, pwzcloud: windows_sys::core::PCWSTR, phgroup: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type PeerGroupOpen = unsafe extern "system" fn(pwzidentity: windows_sys::core::PCWSTR, pwzgrouppeername: windows_sys::core::PCWSTR, pwzcloud: windows_sys::core::PCWSTR, phgroup: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
#[cfg(feature = "Win32_Networking_WinSock")]
pub type PeerGroupOpenDirectConnection = unsafe extern "system" fn(hgroup: *const core::ffi::c_void, pwzidentity: windows_sys::core::PCWSTR, paddress: *const PEER_ADDRESS, pullconnectionid: *mut u64) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Networking_WinSock")]
...
#[cfg(feature = "Win32_Security_Cryptography")]
pub type PeerGroupParseInvitation = unsafe extern "system" fn(pwzinvitation: windows_sys::core::PCWSTR, ppinvitationinfo: *mut *mut PEER_INVITATION_INFO) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Security_Cryptography")]
...
pub type PeerGroupPasswordJoin = unsafe extern "system" fn(pwzidentity: windows_sys::core::PCWSTR, pwzinvitation: windows_sys::core::PCWSTR, pwzpassword: windows_sys::core::PCWSTR, pwzcloud: windows_sys::core::PCWSTR, phgroup: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type PeerGroupSearchRecords = unsafe extern "system" fn(hgroup: *const core::ffi::c_void, pwzcriteria: windows_sys::core::PCWSTR, phpeerenum: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type PeerHostNameToPeerName = unsafe extern "system" fn(pwzhostname: windows_sys::core::PCWSTR, ppwzpeername: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerIdentityCreate = unsafe extern "system" fn(pwzclassifier: windows_sys::core::PCWSTR, pwzfriendlyname: windows_sys::core::PCWSTR, hcryptprov: usize, ppwzidentity: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerIdentityDelete = unsafe extern "system" fn(pwzidentity: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
windows_link::link!("p2p.dll" "system" fn PeerIdentityDelete(pwzidentity : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
pub type PeerIdentityExport = unsafe extern "system" fn(pwzidentity: windows_sys::core::PCWSTR, pwzpassword: windows_sys::core::PCWSTR, ppwzexportxml: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerIdentityGetCryptKey = unsafe extern "system" fn(pwzidentity: windows_sys::core::PCWSTR, phcryptprov: *mut usize) -> windows_sys::core::HRESULT;
...
pub type PeerIdentityGetDefault = unsafe extern "system" fn(ppwzpeername: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerIdentityGetFriendlyName = unsafe extern "system" fn(pwzidentity: windows_sys::core::PCWSTR, ppwzfriendlyname: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerIdentityGetXML = unsafe extern "system" fn(pwzidentity: windows_sys::core::PCWSTR, ppwzidentityxml: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerIdentityImport = unsafe extern "system" fn(pwzimportxml: windows_sys::core::PCWSTR, pwzpassword: windows_sys::core::PCWSTR, ppwzidentity: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerIdentitySetFriendlyName = unsafe extern "system" fn(pwzidentity: windows_sys::core::PCWSTR, pwzfriendlyname: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type PeerNameToPeerHostName = unsafe extern "system" fn(pwzpeername: windows_sys::core::PCWSTR, ppwzhostname: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
#[cfg(feature = "Win32_Networking_WinSock")]
pub type PeerPnrpRegister = unsafe extern "system" fn(pcwzpeername: windows_sys::core::PCWSTR, pregistrationinfo: *const PEER_PNRP_REGISTRATION_INFO, phregistration: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Networking_WinSock")]
...
#[cfg(feature = "Win32_Networking_WinSock")]
pub type PeerPnrpResolve = unsafe extern "system" fn(pcwzpeername: windows_sys::core::PCWSTR, pcwzcloudname: windows_sys::core::PCWSTR, pcendpoints: *mut u32, ppendpoints: *mut *mut PEER_PNRP_ENDPOINT_INFO) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Networking_WinSock")]
...
pub type PeerPnrpStartResolve = unsafe extern "system" fn(pcwzpeername: windows_sys::core::PCWSTR, pcwzcloudname: windows_sys::core::PCWSTR, cmaxendpoints: u32, hevent: super::super::Foundation::HANDLE, phresolve: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
