windows_link::link!("drt.dll" "system" fn DrtClose(hdrt : *mut core::ffi::c_void));
windows_link::link!("drt.dll" "system" fn DrtContinueSearch(hsearchcontext : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Cryptography")]
windows_link::link!("drtprov.dll" "system" fn DrtCreateDerivedKey(plocalcert : *mut super::super::Security::Cryptography:: CERT_CONTEXT, pkey : *mut DRT_DATA) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Cryptography")]
windows_link::link!("drtprov.dll" "system" fn DrtCreateDerivedKeySecurityProvider(prootcert : *mut super::super::Security::Cryptography:: CERT_CONTEXT, plocalcert : *mut super::super::Security::Cryptography:: CERT_CONTEXT, ppsecurityprovider : *mut *mut DRT_SECURITY_PROVIDER) -> windows_sys::core::HRESULT);
...
windows_link::link!("drtprov.dll" "system" fn DrtDeleteDnsBootstrapResolver(presolver : *mut DRT_BOOTSTRAP_PROVIDER));
windows_link::link!("drttransport.dll" "system" fn DrtDeleteIpv6UdpTransport(htransport : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("drtprov.dll" "system" fn DrtDeleteNullSecurityProvider(psecurityprovider : *mut DRT_SECURITY_PROVIDER));
windows_link::link!("drtprov.dll" "system" fn DrtDeletePnrpBootstrapResolver(presolver : *const DRT_BOOTSTRAP_PROVIDER));
windows_link::link!("drt.dll" "system" fn DrtEndSearch(hsearchcontext : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("drt.dll" "system" fn DrtGetEventData(hdrt : *mut core::ffi::c_void, uleventdatalen : u32, peventdata : *mut DRT_EVENT_DATA) -> windows_sys::core::HRESULT);
...
windows_link::link!("drt.dll" "system" fn DrtGetInstanceName(hdrt : *mut core::ffi::c_void, ulcbinstancenamesize : u32, pwzdrtinstancename : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
...
windows_link::link!("drt.dll" "system" fn DrtGetSearchPathSize(hsearchcontext : *mut core::ffi::c_void, pulsearchpathsize : *mut u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("drt.dll" "system" fn DrtRegisterKey(hdrt : *mut core::ffi::c_void, pregistration : *mut DRT_REGISTRATION, pvkeycontext : *mut core::ffi::c_void, phkeyregistration : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("drt.dll" "system" fn DrtStartSearch(hdrt : *mut core::ffi::c_void, pkey : *mut DRT_DATA, pinfo : *mut DRT_SEARCH_INFO, timeout : u32, hevent : super::super::Foundation:: HANDLE, pvcontext : *mut core::ffi::c_void, hsearchcontext : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("drt.dll" "system" fn DrtUnregisterKey(hkeyregistration : *mut core::ffi::c_void));
windows_link::link!("drt.dll" "system" fn DrtUpdateKey(hkeyregistration : *mut core::ffi::c_void, pappdata : *mut DRT_DATA) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("p2p.dll" "system" fn PeerCollabAsyncInviteEndpoint(pcendpoint : *mut PEER_ENDPOINT, pcinvitation : *mut PEER_INVITATION, hevent : super::super::Foundation:: HANDLE, phinvitation : *mut super::super::Foundation:: HANDLE) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("p2p.dll" "system" fn PeerCollabDeleteEndpointData(pcendpoint : *mut PEER_ENDPOINT) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("p2p.dll" "system" fn PeerCollabEnumApplications(pcendpoint : *mut PEER_ENDPOINT, papplicationid : *mut windows_sys::core::GUID, phpeerenum : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("p2p.dll" "system" fn PeerCollabEnumObjects(pcendpoint : *mut PEER_ENDPOINT, pobjectid : *mut windows_sys::core::GUID, phpeerenum : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("p2p.dll" "system" fn PeerCollabGetApplicationRegistrationInfo(papplicationid : *mut windows_sys::core::GUID, registrationtype : PEER_APPLICATION_REGISTRATION_TYPE, ppapplication : *mut *mut PEER_APPLICATION_REGISTRATION_INFO) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("p2p.dll" "system" fn PeerCollabGetPresenceInfo(pcendpoint : *mut PEER_ENDPOINT, pppresenceinfo : *mut *mut PEER_PRESENCE_INFO) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerCollabGetSigninOptions(pdwsigninoptions : *mut u32) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("p2p.dll" "system" fn PeerCollabInviteContact(pccontact : *mut PEER_CONTACT, pcendpoint : *mut PEER_ENDPOINT, pcinvitation : *mut PEER_INVITATION, ppresponse : *mut *mut PEER_INVITATION_RESPONSE) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("p2p.dll" "system" fn PeerCollabInviteEndpoint(pcendpoint : *mut PEER_ENDPOINT, pcinvitation : *mut PEER_INVITATION, ppresponse : *mut *mut PEER_INVITATION_RESPONSE) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("p2p.dll" "system" fn PeerCollabQueryContactData(pcendpoint : *mut PEER_ENDPOINT, ppwzcontactdata : *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("p2p.dll" "system" fn PeerCollabRefreshEndpointData(pcendpoint : *mut PEER_ENDPOINT) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerCollabRegisterApplication(pcapplication : *mut PEER_APPLICATION_REGISTRATION_INFO, registrationtype : PEER_APPLICATION_REGISTRATION_TYPE) -> windows_sys::core::HRESULT);
...
windows_link::link!("p2p.dll" "system" fn PeerCollabSetObject(pcobject : *mut PEER_OBJECT) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("p2p.dll" "system" fn PeerCollabSubscribeEndpointData(pcendpoint : *mut PEER_ENDPOINT) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerCollabUnregisterApplication(papplicationid : *mut windows_sys::core::GUID, registrationtype : PEER_APPLICATION_REGISTRATION_TYPE) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerCollabUnregisterEvent(hpeerevent : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("p2p.dll" "system" fn PeerCollabUnsubscribeEndpointData(pcendpoint : *mut PEER_ENDPOINT) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_System_IO")]
windows_link::link!("peerdist.dll" "system" fn PeerDistClientCompleteContentInformation(hpeerdist : isize, hcontenthandle : isize, lpoverlapped : *mut super::super::System::IO:: OVERLAPPED) -> u32);
#[cfg(feature = "Win32_System_IO")]
windows_link::link!("peerdist.dll" "system" fn PeerDistClientFlushContent(hpeerdist : isize, pcontenttag : *mut PEERDIST_CONTENT_TAG, hcompletionport : super::super::Foundation:: HANDLE, ulcompletionkey : usize, lpoverlapped : *mut super::super::System::IO:: OVERLAPPED) -> u32);
...
windows_link::link!("peerdist.dll" "system" fn PeerDistClientOpenContent(hpeerdist : isize, pcontenttag : *mut PEERDIST_CONTENT_TAG, hcompletionport : super::super::Foundation:: HANDLE, ulcompletionkey : usize, phcontenthandle : *mut isize) -> u32);
#[cfg(feature = "Win32_System_IO")]
windows_link::link!("peerdist.dll" "system" fn PeerDistClientStreamRead(hpeerdist : isize, hcontenthandle : isize, cbmaxnumberofbytes : u32, pbuffer : *mut u8, dwtimeoutinmilliseconds : u32, lpoverlapped : *mut super::super::System::IO:: OVERLAPPED) -> u32);
#[cfg(feature = "Win32_System_IO")]
...
#[cfg(feature = "Win32_System_IO")]
windows_link::link!("peerdist.dll" "system" fn PeerDistRegisterForStatusChangeNotification(hpeerdist : isize, hcompletionport : super::super::Foundation:: HANDLE, ulcompletionkey : usize, lpoverlapped : *mut super::super::System::IO:: OVERLAPPED, ppeerdiststatus : *mut PEERDIST_STATUS) -> u32);
#[cfg(feature = "Win32_System_IO")]
windows_link::link!("peerdist.dll" "system" fn PeerDistRegisterForStatusChangeNotificationEx(hpeerdist : isize, hcompletionport : super::super::Foundation:: HANDLE, ulcompletionkey : usize, lpoverlapped : *mut super::super::System::IO:: OVERLAPPED, ppeerdiststatus : *mut PEERDIST_STATUS_INFO) -> u32);
#[cfg(feature = "Win32_System_IO")]
windows_link::link!("peerdist.dll" "system" fn PeerDistServerCancelAsyncOperation(hpeerdist : isize, cbcontentidentifier : u32, pcontentidentifier : *mut u8, poverlapped : *mut super::super::System::IO:: OVERLAPPED) -> u32);
...
windows_link::link!("peerdist.dll" "system" fn PeerDistServerOpenContentInformation(hpeerdist : isize, cbcontentidentifier : u32, pcontentidentifier : *mut u8, ullcontentoffset : u64, cbcontentlength : u64, hcompletionport : super::super::Foundation:: HANDLE, ulcompletionkey : usize, phcontentinfo : *mut isize) -> u32);
windows_link::link!("peerdist.dll" "system" fn PeerDistServerOpenContentInformationEx(hpeerdist : isize, cbcontentidentifier : u32, pcontentidentifier : *mut u8, ullcontentoffset : u64, cbcontentlength : u64, pretrievaloptions : *mut PEERDIST_RETRIEVAL_OPTIONS, hcompletionport : super::super::Foundation:: HANDLE, ulcompletionkey : usize, phcontentinfo : *mut isize) -> u32);
#[cfg(feature = "Win32_System_IO")]
windows_link::link!("peerdist.dll" "system" fn PeerDistServerPublishAddToStream(hpeerdist : isize, hstream : isize, cbnumberofbytes : u32, pbuffer : *mut u8, lpoverlapped : *mut super::super::System::IO:: OVERLAPPED) -> u32);
#[cfg(feature = "Win32_System_IO")]
...
#[cfg(feature = "Win32_System_IO")]
windows_link::link!("peerdist.dll" "system" fn PeerDistServerRetrieveContentInformation(hpeerdist : isize, hcontentinfo : isize, cbmaxnumberofbytes : u32, pbuffer : *mut u8, lpoverlapped : *mut super::super::System::IO:: OVERLAPPED) -> u32);
...
windows_link::link!("p2p.dll" "system" fn PeerFreeData(pvdata : *mut core::ffi::c_void));
windows_link::link!("p2p.dll" "system" fn PeerGetItemCount(hpeerenum : *mut core::ffi::c_void, pcount : *mut u32) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerGetNextItem(hpeerenum : *mut core::ffi::c_void, pcount : *mut u32, pppvitems : *mut *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphClose(hgraph : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphCloseDirectConnection(hgraph : *mut core::ffi::c_void, ullconnectionid : u64) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphConnect(hgraph : *mut core::ffi::c_void, pwzpeerid : windows_sys::core::PCWSTR, paddress : *mut PEER_ADDRESS, pullconnectionid : *mut u64) -> windows_sys::core::HRESULT);
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphCreate(pgraphproperties : *mut PEER_GRAPH_PROPERTIES, pwzdatabasename : windows_sys::core::PCWSTR, psecurityinterface : *mut PEER_SECURITY_INTERFACE, phgraph : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphEndEnumeration(hpeerenum : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphEnumNodes(hgraph : *mut core::ffi::c_void, pwzpeerid : windows_sys::core::PCWSTR, phpeerenum : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphEnumRecords(hgraph : *mut core::ffi::c_void, precordtype : *mut windows_sys::core::GUID, pwzpeerid : windows_sys::core::PCWSTR, phpeerenum : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphFreeData(pvdata : *mut core::ffi::c_void));
...
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphGetItemCount(hpeerenum : *mut core::ffi::c_void, pcount : *mut u32) -> windows_sys::core::HRESULT);
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphGetNextItem(hpeerenum : *mut core::ffi::c_void, pcount : *mut u32, pppvitems : *mut *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Networking_WinSock")]
...
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphGetRecord(hgraph : *mut core::ffi::c_void, precordid : *mut windows_sys::core::GUID, pprecord : *mut *mut PEER_RECORD) -> windows_sys::core::HRESULT);
...
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphListen(hgraph : *mut core::ffi::c_void, dwscope : u32, dwscopeid : u32, wport : u16) -> windows_sys::core::HRESULT);
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphOpen(pwzgraphid : windows_sys::core::PCWSTR, pwzpeerid : windows_sys::core::PCWSTR, pwzdatabasename : windows_sys::core::PCWSTR, psecurityinterface : *mut PEER_SECURITY_INTERFACE, crecordtypesyncprecedence : u32, precordtypesyncprecedence : *mut windows_sys::core::GUID, phgraph : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphOpenDirectConnection(hgraph : *mut core::ffi::c_void, pwzpeerid : windows_sys::core::PCWSTR, paddress : *mut PEER_ADDRESS, pullconnectionid : *mut u64) -> windows_sys::core::HRESULT);
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphPeerTimeToUniversalTime(hgraph : *mut core::ffi::c_void, pftpeertime : *mut super::super::Foundation:: FILETIME, pftuniversaltime : *mut super::super::Foundation:: FILETIME) -> windows_sys::core::HRESULT);
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphRegisterEvent(hgraph : *mut core::ffi::c_void, hevent : super::super::Foundation:: HANDLE, ceventregistrations : u32, peventregistrations : *mut PEER_GRAPH_EVENT_REGISTRATION, phpeerevent : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphSendData(hgraph : *mut core::ffi::c_void, ullconnectionid : u64, ptype : *mut windows_sys::core::GUID, cbdata : u32, pvdata : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphUpdateRecord(hgraph : *mut core::ffi::c_void, precord : *mut PEER_RECORD) -> windows_sys::core::HRESULT);
windows_link::link!("p2pgraph.dll" "system" fn PeerGraphValidateDeferredRecords(hgraph : *mut core::ffi::c_void, crecordids : u32, precordids : *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerGroupAddRecord(hgroup : *mut core::ffi::c_void, precord : *mut PEER_RECORD, precordid : *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerGroupClose(hgroup : *const core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerGroupCloseDirectConnection(hgroup : *mut core::ffi::c_void, ullconnectionid : u64) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerGroupConnect(hgroup : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("p2p.dll" "system" fn PeerGroupConnectByAddress(hgroup : *mut core::ffi::c_void, caddresses : u32, paddresses : *mut PEER_ADDRESS) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerGroupCreate(pproperties : *mut PEER_GROUP_PROPERTIES, phgroup : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerGroupCreateInvitation(hgroup : *mut core::ffi::c_void, pwzidentityinfo : windows_sys::core::PCWSTR, pftexpiration : *mut super::super::Foundation:: FILETIME, croles : u32, proles : *mut windows_sys::core::GUID, ppwzinvitation : *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerGroupCreatePasswordInvitation(hgroup : *mut core::ffi::c_void, ppwzinvitation : *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT);
...
windows_link::link!("p2p.dll" "system" fn PeerGroupEnumMembers(hgroup : *mut core::ffi::c_void, dwflags : u32, pwzidentity : windows_sys::core::PCWSTR, phpeerenum : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerGroupEnumRecords(hgroup : *mut core::ffi::c_void, precordtype : *mut windows_sys::core::GUID, phpeerenum : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerGroupExportConfig(hgroup : *mut core::ffi::c_void, pwzpassword : windows_sys::core::PCWSTR, ppwzxml : *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerGroupExportDatabase(hgroup : *mut core::ffi::c_void, pwzfilepath : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
...
windows_link::link!("p2p.dll" "system" fn PeerGroupGetProperties(hgroup : *mut core::ffi::c_void, ppproperties : *mut *mut PEER_GROUP_PROPERTIES) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerGroupGetRecord(hgroup : *mut core::ffi::c_void, precordid : *mut windows_sys::core::GUID, pprecord : *mut *mut PEER_RECORD) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerGroupGetStatus(hgroup : *mut core::ffi::c_void, pdwstatus : *mut u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("p2p.dll" "system" fn PeerGroupImportDatabase(hgroup : *mut core::ffi::c_void, pwzfilepath : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Cryptography")]
windows_link::link!("p2p.dll" "system" fn PeerGroupIssueCredentials(hgroup : *mut core::ffi::c_void, pwzsubjectidentity : windows_sys::core::PCWSTR, pcredentialinfo : *mut PEER_CREDENTIAL_INFO, dwflags : u32, ppwzinvitation : *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("p2p.dll" "system" fn PeerGroupOpenDirectConnection(hgroup : *mut core::ffi::c_void, pwzidentity : windows_sys::core::PCWSTR, paddress : *mut PEER_ADDRESS, pullconnectionid : *mut u64) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Security_Cryptography")]
...
windows_link::link!("p2p.dll" "system" fn PeerGroupRegisterEvent(hgroup : *mut core::ffi::c_void, hevent : super::super::Foundation:: HANDLE, ceventregistration : u32, peventregistrations : *mut PEER_GROUP_EVENT_REGISTRATION, phpeerevent : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
...
windows_link::link!("p2p.dll" "system" fn PeerGroupSearchRecords(hgroup : *mut core::ffi::c_void, pwzcriteria : windows_sys::core::PCWSTR, phpeerenum : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerGroupSendData(hgroup : *mut core::ffi::c_void, ullconnectionid : u64, ptype : *mut windows_sys::core::GUID, cbdata : u32, pvdata : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerGroupSetProperties(hgroup : *mut core::ffi::c_void, pproperties : *mut PEER_GROUP_PROPERTIES) -> windows_sys::core::HRESULT);
...
windows_link::link!("p2p.dll" "system" fn PeerGroupUniversalTimeToPeerTime(hgroup : *mut core::ffi::c_void, pftuniversaltime : *mut super::super::Foundation:: FILETIME, pftpeertime : *mut super::super::Foundation:: FILETIME) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerGroupUnregisterEvent(hpeerevent : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
windows_link::link!("p2p.dll" "system" fn PeerGroupUpdateRecord(hgroup : *mut core::ffi::c_void, precord : *mut PEER_RECORD) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("p2p.dll" "system" fn PeerPnrpGetEndpoint(hresolve : *mut core::ffi::c_void, ppendpoint : *mut *mut PEER_PNRP_ENDPOINT_INFO) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Networking_WinSock")]
...
windows_link::link!("p2p.dll" "system" fn PeerPnrpUnregister(hregistration : *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Networking_WinSock")]
...
pub type PFNPEER_FREE_SECURITY_DATA = Option<unsafe extern "system" fn(hgraph: *mut core::ffi::c_void, pvcontext: *mut core::ffi::c_void, psecuritydata: *mut PEER_DATA) -> windows_sys::core::HRESULT>;
pub type PFNPEER_ON_PASSWORD_AUTH_FAILED = Option<unsafe extern "system" fn(hgraph: *mut core::ffi::c_void, pvcontext: *mut core::ffi::c_void) -> windows_sys::core::HRESULT>;
...
pub type PFNPEER_VALIDATE_RECORD = Option<unsafe extern "system" fn(hgraph: *mut core::ffi::c_void, pvcontext: *mut core::ffi::c_void, precord: *mut PEER_RECORD, changetype: PEER_RECORD_CHANGE_TYPE) -> windows_sys::core::HRESULT>;
#[repr(C)]
#[derive(Clone, Copy, Default)]
