...
pub const DRT_E_BOOTSTRAPPROVIDER_IN_USE: ::windows_sys::core::HRESULT = 0x8062200Eu32 as _;
pub const DRT_E_BOOTSTRAPPROVIDER_NOT_ATTACHED: ::windows_sys::core::HRESULT = 0x8062200Fu32 as _;
pub const DRT_E_CAPABILITY_MISMATCH: ::windows_sys::core::HRESULT = 0x8062210Fu32 as _;
pub const DRT_E_DUPLICATE_KEY: ::windows_sys::core::HRESULT = 0x80622009u32 as _;
pub const DRT_E_FAULTED: ::windows_sys::core::HRESULT = 0x8062210Au32 as _;
pub const DRT_E_INSUFFICIENT_BUFFER: ::windows_sys::core::HRESULT = 0x8062210Cu32 as _;
pub const DRT_E_INVALID_ADDRESS: ::windows_sys::core::HRESULT = 0x80622005u32 as _;
pub const DRT_E_INVALID_BOOTSTRAP_PROVIDER: ::windows_sys::core::HRESULT = 0x80622004u32 as _;
pub const DRT_E_INVALID_CERT_CHAIN: ::windows_sys::core::HRESULT = 0x80621004u32 as _;
pub const DRT_E_INVALID_INSTANCE_PREFIX: ::windows_sys::core::HRESULT = 0x8062210Du32 as _;
pub const DRT_E_INVALID_KEY: ::windows_sys::core::HRESULT = 0x80621009u32 as _;
pub const DRT_E_INVALID_KEY_SIZE: ::windows_sys::core::HRESULT = 0x80621002u32 as _;
pub const DRT_E_INVALID_MAX_ADDRESSES: ::windows_sys::core::HRESULT = 0x80621007u32 as _;
pub const DRT_E_INVALID_MAX_ENDPOINTS: ::windows_sys::core::HRESULT = 0x80621011u32 as _;
pub const DRT_E_INVALID_MESSAGE: ::windows_sys::core::HRESULT = 0x80621005u32 as _;
pub const DRT_E_INVALID_PORT: ::windows_sys::core::HRESULT = 0x80622000u32 as _;
pub const DRT_E_INVALID_SCOPE: ::windows_sys::core::HRESULT = 0x80622006u32 as _;
pub const DRT_E_INVALID_SEARCH_INFO: ::windows_sys::core::HRESULT = 0x80622109u32 as _;
pub const DRT_E_INVALID_SEARCH_RANGE: ::windows_sys::core::HRESULT = 0x80621012u32 as _;
pub const DRT_E_INVALID_SECURITY_MODE: ::windows_sys::core::HRESULT = 0x8062210Eu32 as _;
pub const DRT_E_INVALID_SECURITY_PROVIDER: ::windows_sys::core::HRESULT = 0x80622002u32 as _;
pub const DRT_E_INVALID_SETTINGS: ::windows_sys::core::HRESULT = 0x80622108u32 as _;
pub const DRT_E_INVALID_TRANSPORT_PROVIDER: ::windows_sys::core::HRESULT = 0x80622001u32 as _;
pub const DRT_E_NO_ADDRESSES_AVAILABLE: ::windows_sys::core::HRESULT = 0x80622008u32 as _;
pub const DRT_E_NO_MORE: ::windows_sys::core::HRESULT = 0x80621006u32 as _;
pub const DRT_E_SEARCH_IN_PROGRESS: ::windows_sys::core::HRESULT = 0x80621008u32 as _;
pub const DRT_E_SECURITYPROVIDER_IN_USE: ::windows_sys::core::HRESULT = 0x8062200Cu32 as _;
pub const DRT_E_SECURITYPROVIDER_NOT_ATTACHED: ::windows_sys::core::HRESULT = 0x8062200Du32 as _;
pub const DRT_E_STILL_IN_USE: ::windows_sys::core::HRESULT = 0x80622003u32 as _;
pub const DRT_E_TIMEOUT: ::windows_sys::core::HRESULT = 0x80621001u32 as _;
pub const DRT_E_TRANSPORTPROVIDER_IN_USE: ::windows_sys::core::HRESULT = 0x8062200Au32 as _;
pub const DRT_E_TRANSPORTPROVIDER_NOT_ATTACHED: ::windows_sys::core::HRESULT = 0x8062200Bu32 as _;
pub const DRT_E_TRANSPORT_ALREADY_BOUND: ::windows_sys::core::HRESULT = 0x80622101u32 as _;
pub const DRT_E_TRANSPORT_ALREADY_EXISTS_FOR_SCOPE: ::windows_sys::core::HRESULT = 0x80622107u32 as _;
pub const DRT_E_TRANSPORT_EXECUTING_CALLBACK: ::windows_sys::core::HRESULT = 0x80622106u32 as _;
pub const DRT_E_TRANSPORT_INVALID_ARGUMENT: ::windows_sys::core::HRESULT = 0x80622104u32 as _;
pub const DRT_E_TRANSPORT_NOT_BOUND: ::windows_sys::core::HRESULT = 0x80622102u32 as _;
pub const DRT_E_TRANSPORT_NO_DEST_ADDRESSES: ::windows_sys::core::HRESULT = 0x80622105u32 as _;
pub const DRT_E_TRANSPORT_SHUTTING_DOWN: ::windows_sys::core::HRESULT = 0x80622007u32 as _;
pub const DRT_E_TRANSPORT_STILL_BOUND: ::windows_sys::core::HRESULT = 0x8062210Bu32 as _;
pub const DRT_E_TRANSPORT_UNEXPECTED: ::windows_sys::core::HRESULT = 0x80622103u32 as _;
...
pub const DRT_S_RETRY: ::windows_sys::core::HRESULT = 0x621010u32 as _;
...
pub const PEER_E_ALREADY_EXISTS: ::windows_sys::core::HRESULT = 0x800700B7u32 as _;
pub const PEER_E_CLIENT_INVALID_COMPARTMENT_ID: ::windows_sys::core::HRESULT = 0x80072CF2u32 as _;
pub const PEER_E_CLOUD_DISABLED: ::windows_sys::core::HRESULT = 0x80072CEEu32 as _;
pub const PEER_E_CLOUD_IS_DEAD: ::windows_sys::core::HRESULT = 0x80072CF5u32 as _;
pub const PEER_E_CLOUD_IS_SEARCH_ONLY: ::windows_sys::core::HRESULT = 0x80072CF1u32 as _;
pub const PEER_E_CLOUD_NOT_FOUND: ::windows_sys::core::HRESULT = 0x80072CEDu32 as _;
pub const PEER_E_DISK_FULL: ::windows_sys::core::HRESULT = 0x80070070u32 as _;
pub const PEER_E_DUPLICATE_PEER_NAME: ::windows_sys::core::HRESULT = 0x80072CF4u32 as _;
pub const PEER_E_INVALID_IDENTITY: ::windows_sys::core::HRESULT = 0x80072CEFu32 as _;
pub const PEER_E_NOT_FOUND: ::windows_sys::core::HRESULT = 0x80070490u32 as _;
pub const PEER_E_TOO_MUCH_LOAD: ::windows_sys::core::HRESULT = 0x80072CF0u32 as _;
