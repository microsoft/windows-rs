pub type MatchEnumTag = unsafe extern "system" fn(hmodule: super::super::Foundation::HANDLE, pwcarg: windows_sys::core::PCWSTR, dwnumarg: u32, penumtable: *const TOKEN_VALUE, pdwvalue: *mut u32) -> u32;
windows_link::link!("netsh.dll" "system" fn MatchEnumTag(hmodule : super::super::Foundation::HANDLE, pwcarg : windows_sys::core::PCWSTR, dwnumarg : u32, penumtable : *const TOKEN_VALUE, pdwvalue : *mut u32) -> u32);
pub type MatchToken = unsafe extern "system" fn(pwszusertoken: windows_sys::core::PCWSTR, pwszcmdtoken: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
windows_link::link!("netsh.dll" "system" fn MatchToken(pwszusertoken : windows_sys::core::PCWSTR, pwszcmdtoken : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
pub type PreprocessCommand = unsafe extern "system" fn(hmodule: super::super::Foundation::HANDLE, ppwcarguments: *mut windows_sys::core::PWSTR, dwcurrentindex: u32, dwargcount: u32, ptttags: *mut TAG_TYPE, dwtagcount: u32, dwminargs: u32, dwmaxargs: u32, pdwtagtype: *mut u32) -> u32;
windows_link::link!("netsh.dll" "system" fn PreprocessCommand(hmodule : super::super::Foundation::HANDLE, ppwcarguments : *mut windows_sys::core::PWSTR, dwcurrentindex : u32, dwargcount : u32, ptttags : *mut TAG_TYPE, dwtagcount : u32, dwminargs : u32, dwmaxargs : u32, pdwtagtype : *mut u32) -> u32);
pub type PrintError = unsafe extern "C" fn(hmodule: super::super::Foundation::HANDLE, dwerrid: u32, ...) -> u32;
windows_link::link!("netsh.dll" "C" fn PrintError(hmodule : super::super::Foundation::HANDLE, dwerrid : u32, ...) -> u32);
pub type PrintMessage = unsafe extern "C" fn(pwszformat: windows_sys::core::PCWSTR, ...) -> u32;
windows_link::link!("netsh.dll" "C" fn PrintMessage(pwszformat : windows_sys::core::PCWSTR, ...) -> u32);
pub type PrintMessageFromModule = unsafe extern "C" fn(hmodule: super::super::Foundation::HANDLE, dwmsgid: u32, ...) -> u32;
