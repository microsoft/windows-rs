pub type GetNetScheduleAccountInformation = unsafe extern "system" fn(pwszservername: windows_sys::core::PCWSTR, ccaccount: u32, wszaccount: windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type I_NetLogonControl2 = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, functioncode: u32, querylevel: u32, data: *const u8, buffer: *mut *mut u8) -> u32;
...
pub type LogErrorA = unsafe extern "system" fn(dwmessageid: u32, cnumberofsubstrings: u32, plpwssubstrings: *const windows_sys::core::PCSTR, dwerrorcode: u32);
...
pub type LogErrorW = unsafe extern "system" fn(dwmessageid: u32, cnumberofsubstrings: u32, plpwssubstrings: *const windows_sys::core::PCWSTR, dwerrorcode: u32);
...
pub type LogEventA = unsafe extern "system" fn(weventtype: u32, dwmessageid: u32, cnumberofsubstrings: u32, plpwssubstrings: *const windows_sys::core::PCSTR);
...
pub type LogEventW = unsafe extern "system" fn(weventtype: u32, dwmessageid: u32, cnumberofsubstrings: u32, plpwssubstrings: *const windows_sys::core::PCWSTR);
...
pub type NetAccessAdd = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, buf: *const u8, parm_err: *mut u32) -> u32;
...
pub type NetAccessDel = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, resource: windows_sys::core::PCWSTR) -> u32;
...
pub type NetAccessEnum = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, basepath: windows_sys::core::PCWSTR, recursive: u32, level: u32, bufptr: *mut *mut u8, prefmaxlen: u32, entriesread: *mut u32, totalentries: *mut u32, resume_handle: *mut u32) -> u32;
...
pub type NetAccessGetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, resource: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8) -> u32;
...
pub type NetAccessGetUserPerms = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, ugname: windows_sys::core::PCWSTR, resource: windows_sys::core::PCWSTR, perms: *mut u32) -> u32;
...
pub type NetAccessSetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, resource: windows_sys::core::PCWSTR, level: u32, buf: *const u8, parm_err: *mut u32) -> u32;
...
pub type NetAddAlternateComputerName = unsafe extern "system" fn(server: windows_sys::core::PCWSTR, alternatename: windows_sys::core::PCWSTR, domainaccount: windows_sys::core::PCWSTR, domainaccountpassword: windows_sys::core::PCWSTR, reserved: u32) -> u32;
...
pub type NetAddServiceAccount = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, accountname: windows_sys::core::PCWSTR, password: windows_sys::core::PCWSTR, flags: u32) -> super::super::Foundation::NTSTATUS;
...
pub type NetAlertRaise = unsafe extern "system" fn(alerttype: windows_sys::core::PCWSTR, buffer: *const core::ffi::c_void, buffersize: u32) -> u32;
...
pub type NetAlertRaiseEx = unsafe extern "system" fn(alerttype: windows_sys::core::PCWSTR, variableinfo: *const core::ffi::c_void, variableinfosize: u32, servicename: windows_sys::core::PCWSTR) -> u32;
...
pub type NetAuditClear = unsafe extern "system" fn(server: windows_sys::core::PCWSTR, backupfile: windows_sys::core::PCWSTR, service: windows_sys::core::PCWSTR) -> u32;
...
pub type NetAuditRead = unsafe extern "system" fn(server: windows_sys::core::PCWSTR, service: windows_sys::core::PCWSTR, auditloghandle: *mut HLOG, offset: u32, reserved1: *mut u32, reserved2: u32, offsetflag: u32, bufptr: *mut *mut u8, prefmaxlen: u32, bytesread: *mut u32, totalavailable: *mut u32) -> u32;
...
pub type NetAuditWrite = unsafe extern "system" fn(r#type: u32, buf: *mut u8, numbytes: u32, service: windows_sys::core::PCWSTR, reserved: *mut u8) -> u32;
...
pub type NetConfigGet = unsafe extern "system" fn(server: windows_sys::core::PCWSTR, component: windows_sys::core::PCWSTR, parameter: windows_sys::core::PCWSTR, bufptr: *mut *mut u8) -> u32;
...
pub type NetConfigGetAll = unsafe extern "system" fn(server: windows_sys::core::PCWSTR, component: windows_sys::core::PCWSTR, bufptr: *mut *mut u8) -> u32;
...
pub type NetConfigSet = unsafe extern "system" fn(server: windows_sys::core::PCWSTR, reserved1: windows_sys::core::PCWSTR, component: windows_sys::core::PCWSTR, level: u32, reserved2: u32, buf: *mut u8, reserved3: u32) -> u32;
...
pub type NetCreateProvisioningPackage = unsafe extern "system" fn(pprovisioningparams: *const NETSETUP_PROVISIONING_PARAMS, pppackagebindata: *mut *mut u8, pdwpackagebindatasize: *mut u32, pppackagetextdata: *mut windows_sys::core::PWSTR) -> u32;
...
pub type NetEnumerateComputerNames = unsafe extern "system" fn(server: windows_sys::core::PCWSTR, nametype: NET_COMPUTER_NAME_TYPE, reserved: u32, entrycount: *mut u32, computernames: *mut *mut windows_sys::core::PWSTR) -> u32;
...
pub type NetEnumerateServiceAccounts = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, flags: u32, accountscount: *mut u32, accounts: *mut *mut *mut u16) -> super::super::Foundation::NTSTATUS;
...
pub type NetErrorLogClear = unsafe extern "system" fn(uncservername: windows_sys::core::PCWSTR, backupfile: windows_sys::core::PCWSTR, reserved: *const u8) -> u32;
...
pub type NetErrorLogRead = unsafe extern "system" fn(uncservername: windows_sys::core::PCWSTR, reserved1: windows_sys::core::PCWSTR, errorloghandle: *const HLOG, offset: u32, reserved2: *const u32, reserved3: u32, offsetflag: u32, bufptr: *mut *mut u8, prefmaxsize: u32, bytesread: *mut u32, totalavailable: *mut u32) -> u32;
...
pub type NetErrorLogWrite = unsafe extern "system" fn(reserved1: *const u8, code: u32, component: windows_sys::core::PCWSTR, buffer: *const u8, numbytes: u32, msgbuf: *const u8, strcount: u32, reserved2: *const u8) -> u32;
...
#[cfg(feature = "Win32_Security_Cryptography")]
pub type NetGetAadJoinInformation = unsafe extern "system" fn(pcsztenantid: windows_sys::core::PCWSTR, ppjoininfo: *mut *mut DSREG_JOIN_INFO) -> windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Security_Cryptography")]
...
pub type NetGetAnyDCName = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, domainname: windows_sys::core::PCWSTR, buffer: *mut *mut u8) -> u32;
...
pub type NetGetDCName = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, domainname: windows_sys::core::PCWSTR, buffer: *mut *mut u8) -> u32;
...
pub type NetGetDisplayInformationIndex = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, prefix: windows_sys::core::PCWSTR, index: *mut u32) -> u32;
...
pub type NetGetJoinInformation = unsafe extern "system" fn(lpserver: windows_sys::core::PCWSTR, lpnamebuffer: *mut windows_sys::core::PWSTR, buffertype: *mut NETSETUP_JOIN_STATUS) -> u32;
...
pub type NetGetJoinableOUs = unsafe extern "system" fn(lpserver: windows_sys::core::PCWSTR, lpdomain: windows_sys::core::PCWSTR, lpaccount: windows_sys::core::PCWSTR, lppassword: windows_sys::core::PCWSTR, oucount: *mut u32, ous: *mut *mut windows_sys::core::PWSTR) -> u32;
...
pub type NetGroupAdd = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, buf: *const u8, parm_err: *mut u32) -> u32;
...
pub type NetGroupAddUser = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, groupname: windows_sys::core::PCWSTR, username: windows_sys::core::PCWSTR) -> u32;
...
pub type NetGroupDel = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, groupname: windows_sys::core::PCWSTR) -> u32;
...
pub type NetGroupDelUser = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, groupname: windows_sys::core::PCWSTR, username: windows_sys::core::PCWSTR) -> u32;
...
pub type NetGroupEnum = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8, prefmaxlen: u32, entriesread: *mut u32, totalentries: *mut u32, resume_handle: *mut usize) -> u32;
...
pub type NetGroupGetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, groupname: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8) -> u32;
...
pub type NetGroupGetUsers = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, groupname: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8, prefmaxlen: u32, entriesread: *mut u32, totalentries: *mut u32, resumehandle: *mut usize) -> u32;
...
pub type NetGroupSetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, groupname: windows_sys::core::PCWSTR, level: u32, buf: *const u8, parm_err: *mut u32) -> u32;
...
pub type NetGroupSetUsers = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, groupname: windows_sys::core::PCWSTR, level: u32, buf: *const u8, totalentries: u32) -> u32;
...
pub type NetIsServiceAccount = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, accountname: windows_sys::core::PCWSTR, isservice: *mut windows_sys::core::BOOL) -> super::super::Foundation::NTSTATUS;
...
pub type NetIsServiceAccount2 = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, accountname: windows_sys::core::PCWSTR, isservice: *mut windows_sys::core::BOOL, accounttype: *mut MSA_INFO_ACCOUNT_TYPE) -> super::super::Foundation::NTSTATUS;
...
pub type NetJoinDomain = unsafe extern "system" fn(lpserver: windows_sys::core::PCWSTR, lpdomain: windows_sys::core::PCWSTR, lpmachineaccountou: windows_sys::core::PCWSTR, lpaccount: windows_sys::core::PCWSTR, lppassword: windows_sys::core::PCWSTR, fjoinoptions: NET_JOIN_DOMAIN_JOIN_OPTIONS) -> u32;
...
pub type NetLocalGroupAdd = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, buf: *const u8, parm_err: *mut u32) -> u32;
...
pub type NetLocalGroupAddMember = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, groupname: windows_sys::core::PCWSTR, membersid: super::super::Security::PSID) -> u32;
#[cfg(feature = "Win32_Security")]
...
pub type NetLocalGroupAddMembers = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, groupname: windows_sys::core::PCWSTR, level: u32, buf: *const u8, totalentries: u32) -> u32;
...
pub type NetLocalGroupDel = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, groupname: windows_sys::core::PCWSTR) -> u32;
...
#[cfg(feature = "Win32_Security")]
pub type NetLocalGroupDelMember = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, groupname: windows_sys::core::PCWSTR, membersid: super::super::Security::PSID) -> u32;
#[cfg(feature = "Win32_Security")]
...
pub type NetLocalGroupDelMembers = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, groupname: windows_sys::core::PCWSTR, level: u32, buf: *const u8, totalentries: u32) -> u32;
...
pub type NetLocalGroupEnum = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8, prefmaxlen: u32, entriesread: *mut u32, totalentries: *mut u32, resumehandle: *mut usize) -> u32;
...
pub type NetLocalGroupGetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, groupname: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8) -> u32;
...
pub type NetLocalGroupGetMembers = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, localgroupname: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8, prefmaxlen: u32, entriesread: *mut u32, totalentries: *mut u32, resumehandle: *mut usize) -> u32;
...
pub type NetLocalGroupSetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, groupname: windows_sys::core::PCWSTR, level: u32, buf: *const u8, parm_err: *mut u32) -> u32;
...
pub type NetLocalGroupSetMembers = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, groupname: windows_sys::core::PCWSTR, level: u32, buf: *const u8, totalentries: u32) -> u32;
...
pub type NetMessageBufferSend = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, msgname: windows_sys::core::PCWSTR, fromname: windows_sys::core::PCWSTR, buf: *const u8, buflen: u32) -> u32;
...
pub type NetMessageNameAdd = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, msgname: windows_sys::core::PCWSTR) -> u32;
...
pub type NetMessageNameDel = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, msgname: windows_sys::core::PCWSTR) -> u32;
...
pub type NetMessageNameEnum = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, bufptr: *const *const u8, prefmaxlen: u32, entriesread: *mut u32, totalentries: *mut u32, resume_handle: *mut u32) -> u32;
...
pub type NetMessageNameGetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, msgname: windows_sys::core::PCWSTR, level: u32, bufptr: *const *const u8) -> u32;
...
pub type NetProvisionComputerAccount = unsafe extern "system" fn(lpdomain: windows_sys::core::PCWSTR, lpmachinename: windows_sys::core::PCWSTR, lpmachineaccountou: windows_sys::core::PCWSTR, lpdcname: windows_sys::core::PCWSTR, dwoptions: NETSETUP_PROVISION, pprovisionbindata: *mut *mut u8, pdwprovisionbindatasize: *mut u32, pprovisiontextdata: *mut windows_sys::core::PWSTR) -> u32;
...
pub type NetQueryDisplayInformation = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, index: u32, entriesrequested: u32, preferredmaximumlength: u32, returnedentrycount: *mut u32, sortedbuffer: *mut *mut core::ffi::c_void) -> u32;
...
pub type NetQueryServiceAccount = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, accountname: windows_sys::core::PCWSTR, infolevel: u32, buffer: *mut *mut u8) -> super::super::Foundation::NTSTATUS;
...
pub type NetRemoteComputerSupports = unsafe extern "system" fn(uncservername: windows_sys::core::PCWSTR, optionswanted: NET_REMOTE_COMPUTER_SUPPORTS_OPTIONS, optionssupported: *mut u32) -> u32;
...
pub type NetRemoteTOD = unsafe extern "system" fn(uncservername: windows_sys::core::PCWSTR, bufferptr: *mut *mut u8) -> u32;
windows_link::link!("netapi32.dll" "system" fn NetRemoteTOD(uncservername : windows_sys::core::PCWSTR, bufferptr : *mut *mut u8) -> u32);
pub type NetRemoveAlternateComputerName = unsafe extern "system" fn(server: windows_sys::core::PCWSTR, alternatename: windows_sys::core::PCWSTR, domainaccount: windows_sys::core::PCWSTR, domainaccountpassword: windows_sys::core::PCWSTR, reserved: u32) -> u32;
...
pub type NetRemoveServiceAccount = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, accountname: windows_sys::core::PCWSTR, flags: u32) -> super::super::Foundation::NTSTATUS;
...
pub type NetRenameMachineInDomain = unsafe extern "system" fn(lpserver: windows_sys::core::PCWSTR, lpnewmachinename: windows_sys::core::PCWSTR, lpaccount: windows_sys::core::PCWSTR, lppassword: windows_sys::core::PCWSTR, frenameoptions: u32) -> u32;
...
pub type NetReplExportDirAdd = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, buf: *const u8, parm_err: *mut u32) -> u32;
...
pub type NetReplExportDirDel = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, dirname: windows_sys::core::PCWSTR) -> u32;
...
pub type NetReplExportDirEnum = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8, prefmaxlen: u32, entriesread: *mut u32, totalentries: *mut u32, resumehandle: *mut u32) -> u32;
...
pub type NetReplExportDirGetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, dirname: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8) -> u32;
...
pub type NetReplExportDirLock = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, dirname: windows_sys::core::PCWSTR) -> u32;
...
pub type NetReplExportDirSetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, dirname: windows_sys::core::PCWSTR, level: u32, buf: *const u8, parm_err: *mut u32) -> u32;
...
pub type NetReplExportDirUnlock = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, dirname: windows_sys::core::PCWSTR, unlockforce: u32) -> u32;
...
pub type NetReplGetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8) -> u32;
...
pub type NetReplImportDirAdd = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, buf: *const u8, parm_err: *mut u32) -> u32;
...
pub type NetReplImportDirDel = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, dirname: windows_sys::core::PCWSTR) -> u32;
...
pub type NetReplImportDirEnum = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8, prefmaxlen: u32, entriesread: *mut u32, totalentries: *mut u32, resumehandle: *mut u32) -> u32;
...
pub type NetReplImportDirGetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, dirname: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8) -> u32;
...
pub type NetReplImportDirLock = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, dirname: windows_sys::core::PCWSTR) -> u32;
...
pub type NetReplImportDirUnlock = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, dirname: windows_sys::core::PCWSTR, unlockforce: u32) -> u32;
...
pub type NetReplSetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, buf: *const u8, parm_err: *mut u32) -> u32;
...
pub type NetRequestOfflineDomainJoin = unsafe extern "system" fn(pprovisionbindata: *const u8, cbprovisionbindatasize: u32, dwoptions: NET_REQUEST_PROVISION_OPTIONS, lpwindowspath: windows_sys::core::PCWSTR) -> u32;
...
pub type NetRequestProvisioningPackageInstall = unsafe extern "system" fn(ppackagebindata: *const u8, dwpackagebindatasize: u32, dwprovisionoptions: NET_REQUEST_PROVISION_OPTIONS, lpwindowspath: windows_sys::core::PCWSTR, pvreserved: *const core::ffi::c_void) -> u32;
...
pub type NetScheduleJobAdd = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, buffer: *mut u8, jobid: *mut u32) -> u32;
...
pub type NetScheduleJobDel = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, minjobid: u32, maxjobid: u32) -> u32;
...
pub type NetScheduleJobEnum = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, pointertobuffer: *mut *mut u8, prefferedmaximumlength: u32, entriesread: *mut u32, totalentries: *mut u32, resumehandle: *mut u32) -> u32;
...
pub type NetScheduleJobGetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, jobid: u32, pointertobuffer: *mut *mut u8) -> u32;
...
pub type NetServerComputerNameAdd = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, emulateddomainname: windows_sys::core::PCWSTR, emulatedservername: windows_sys::core::PCWSTR) -> u32;
...
pub type NetServerComputerNameDel = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, emulatedservername: windows_sys::core::PCWSTR) -> u32;
...
pub type NetServerDiskEnum = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8, prefmaxlen: u32, entriesread: *mut u32, totalentries: *mut u32, resume_handle: *mut u32) -> u32;
...
pub type NetServerEnum = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8, prefmaxlen: u32, entriesread: *mut u32, totalentries: *mut u32, servertype: NET_SERVER_TYPE, domain: windows_sys::core::PCWSTR, resume_handle: *mut u32) -> u32;
...
pub type NetServerGetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8) -> u32;
...
pub type NetServerSetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, buf: *const u8, parmerror: *mut u32) -> u32;
...
pub type NetServerTransportAdd = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, bufptr: *const u8) -> u32;
...
pub type NetServerTransportAddEx = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, bufptr: *const u8) -> u32;
...
pub type NetServerTransportDel = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, bufptr: *const u8) -> u32;
...
pub type NetServerTransportEnum = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8, prefmaxlen: u32, entriesread: *mut u32, totalentries: *mut u32, resume_handle: *mut u32) -> u32;
...
pub type NetServiceControl = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, service: windows_sys::core::PCWSTR, opcode: u32, arg: u32, bufptr: *mut *mut u8) -> u32;
...
pub type NetServiceEnum = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8, prefmaxlen: u32, entriesread: *mut u32, totalentries: *mut u32, resume_handle: *mut u32) -> u32;
...
pub type NetServiceGetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, service: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8) -> u32;
...
pub type NetServiceInstall = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, service: windows_sys::core::PCWSTR, argc: u32, argv: *const windows_sys::core::PCWSTR, bufptr: *mut *mut u8) -> u32;
...
pub type NetSetPrimaryComputerName = unsafe extern "system" fn(server: windows_sys::core::PCWSTR, primaryname: windows_sys::core::PCWSTR, domainaccount: windows_sys::core::PCWSTR, domainaccountpassword: windows_sys::core::PCWSTR, reserved: u32) -> u32;
...
pub type NetUnjoinDomain = unsafe extern "system" fn(lpserver: windows_sys::core::PCWSTR, lpaccount: windows_sys::core::PCWSTR, lppassword: windows_sys::core::PCWSTR, funjoinoptions: u32) -> u32;
...
pub type NetUseDel = unsafe extern "system" fn(uncservername: windows_sys::core::PCWSTR, usename: windows_sys::core::PCWSTR, forcelevelflags: FORCE_LEVEL_FLAGS) -> u32;
...
pub type NetUseEnum = unsafe extern "system" fn(uncservername: windows_sys::core::PCWSTR, levelflags: u32, bufptr: *mut *mut u8, preferedmaximumsize: u32, entriesread: *mut u32, totalentries: *mut u32, resumehandle: *mut u32) -> u32;
...
pub type NetUseGetInfo = unsafe extern "system" fn(uncservername: windows_sys::core::PCWSTR, usename: windows_sys::core::PCWSTR, levelflags: u32, bufptr: *mut *mut u8) -> u32;
...
pub type NetUserAdd = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, buf: *const u8, parm_err: *mut u32) -> u32;
...
pub type NetUserChangePassword = unsafe extern "system" fn(domainname: windows_sys::core::PCWSTR, username: windows_sys::core::PCWSTR, oldpassword: windows_sys::core::PCWSTR, newpassword: windows_sys::core::PCWSTR) -> u32;
...
pub type NetUserDel = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, username: windows_sys::core::PCWSTR) -> u32;
...
pub type NetUserEnum = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, filter: NET_USER_ENUM_FILTER_FLAGS, bufptr: *mut *mut u8, prefmaxlen: u32, entriesread: *mut u32, totalentries: *mut u32, resume_handle: *mut u32) -> u32;
...
pub type NetUserGetGroups = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, username: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8, prefmaxlen: u32, entriesread: *mut u32, totalentries: *mut u32) -> u32;
...
pub type NetUserGetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, username: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8) -> u32;
...
pub type NetUserGetLocalGroups = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, username: windows_sys::core::PCWSTR, level: u32, flags: u32, bufptr: *mut *mut u8, prefmaxlen: u32, entriesread: *mut u32, totalentries: *mut u32) -> u32;
...
pub type NetUserModalsGet = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8) -> u32;
...
pub type NetUserModalsSet = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, buf: *const u8, parm_err: *mut u32) -> u32;
...
pub type NetUserSetGroups = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, username: windows_sys::core::PCWSTR, level: u32, buf: *const u8, num_entries: u32) -> u32;
...
pub type NetUserSetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, username: windows_sys::core::PCWSTR, level: u32, buf: *const u8, parm_err: *mut u32) -> u32;
...
pub type NetValidateName = unsafe extern "system" fn(lpserver: windows_sys::core::PCWSTR, lpname: windows_sys::core::PCWSTR, lpaccount: windows_sys::core::PCWSTR, lppassword: windows_sys::core::PCWSTR, nametype: NETSETUP_NAME_TYPE) -> u32;
...
pub type NetValidatePasswordPolicy = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, qualifier: *mut core::ffi::c_void, validationtype: NET_VALIDATE_PASSWORD_TYPE, inputarg: *mut core::ffi::c_void, outputarg: *mut *mut core::ffi::c_void) -> u32;
...
pub type NetWkstaGetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8) -> u32;
...
pub type NetWkstaSetInfo = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, buffer: *const u8, parm_err: *mut u32) -> u32;
...
pub type NetWkstaTransportDel = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, transportname: windows_sys::core::PCWSTR, ucond: FORCE_LEVEL_FLAGS) -> u32;
...
pub type NetWkstaUserEnum = unsafe extern "system" fn(servername: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8, prefmaxlen: u32, entriesread: *mut u32, totalentries: *mut u32, resumehandle: *mut u32) -> u32;
...
pub type NetWkstaUserGetInfo = unsafe extern "system" fn(reserved: windows_sys::core::PCWSTR, level: u32, bufptr: *mut *mut u8) -> u32;
...
pub type NetWkstaUserSetInfo = unsafe extern "system" fn(reserved: windows_sys::core::PCWSTR, level: u32, buf: *const u8, parm_err: *mut u32) -> u32;
...
pub type RouterAssert = unsafe extern "system" fn(pszfailedassertion: windows_sys::core::PCSTR, pszfilename: windows_sys::core::PCSTR, dwlinenumber: u32, pszmessage: windows_sys::core::PCSTR);
...
pub type RouterGetErrorStringA = unsafe extern "system" fn(dwerrorcode: u32, lplpszerrorstring: *mut windows_sys::core::PSTR) -> u32;
...
pub type RouterGetErrorStringW = unsafe extern "system" fn(dwerrorcode: u32, lplpwszerrorstring: *mut windows_sys::core::PWSTR) -> u32;
...
pub type RouterLogEventA = unsafe extern "system" fn(hloghandle: super::super::Foundation::HANDLE, dweventtype: u32, dwmessageid: u32, dwsubstringcount: u32, plpszsubstringarray: *const windows_sys::core::PCSTR, dwerrorcode: u32);
...
pub type RouterLogEventDataA = unsafe extern "system" fn(hloghandle: super::super::Foundation::HANDLE, dweventtype: u32, dwmessageid: u32, dwsubstringcount: u32, plpszsubstringarray: *const windows_sys::core::PCSTR, dwdatabytes: u32, lpdatabytes: *mut u8);
...
pub type RouterLogEventDataW = unsafe extern "system" fn(hloghandle: super::super::Foundation::HANDLE, dweventtype: u32, dwmessageid: u32, dwsubstringcount: u32, plpszsubstringarray: *const windows_sys::core::PCWSTR, dwdatabytes: u32, lpdatabytes: *mut u8);
...
pub type RouterLogEventExA = unsafe extern "C" fn(hloghandle: super::super::Foundation::HANDLE, dweventtype: u32, dwerrorcode: u32, dwmessageid: u32, ptszformat: windows_sys::core::PCSTR, ...);
...
pub type RouterLogEventExW = unsafe extern "C" fn(hloghandle: super::super::Foundation::HANDLE, dweventtype: u32, dwerrorcode: u32, dwmessageid: u32, ptszformat: windows_sys::core::PCWSTR, ...);
...
pub type RouterLogEventStringA = unsafe extern "system" fn(hloghandle: super::super::Foundation::HANDLE, dweventtype: u32, dwmessageid: u32, dwsubstringcount: u32, plpszsubstringarray: *const windows_sys::core::PCSTR, dwerrorcode: u32, dwerrorindex: u32);
...
pub type RouterLogEventStringW = unsafe extern "system" fn(hloghandle: super::super::Foundation::HANDLE, dweventtype: u32, dwmessageid: u32, dwsubstringcount: u32, plpszsubstringarray: *const windows_sys::core::PCWSTR, dwerrorcode: u32, dwerrorindex: u32);
...
pub type RouterLogEventValistExA = unsafe extern "system" fn(hloghandle: super::super::Foundation::HANDLE, dweventtype: u32, dwerrorcode: u32, dwmessageid: u32, ptszformat: windows_sys::core::PCSTR, arglist: *mut i8);
...
pub type RouterLogEventValistExW = unsafe extern "system" fn(hloghandle: super::super::Foundation::HANDLE, dweventtype: u32, dwerrorcode: u32, dwmessageid: u32, ptszformat: windows_sys::core::PCWSTR, arglist: *mut i8);
...
pub type RouterLogEventW = unsafe extern "system" fn(hloghandle: super::super::Foundation::HANDLE, dweventtype: u32, dwmessageid: u32, dwsubstringcount: u32, plpszsubstringarray: *const windows_sys::core::PCWSTR, dwerrorcode: u32);
...
pub type RouterLogRegisterA = unsafe extern "system" fn(lpszsource: windows_sys::core::PCSTR) -> super::super::Foundation::HANDLE;
...
pub type RouterLogRegisterW = unsafe extern "system" fn(lpszsource: windows_sys::core::PCWSTR) -> super::super::Foundation::HANDLE;
...
pub type SetNetScheduleAccountInformation = unsafe extern "system" fn(pwszservername: windows_sys::core::PCWSTR, pwszaccount: windows_sys::core::PCWSTR, pwszpassword: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type TraceDumpExA = unsafe extern "system" fn(dwtraceid: u32, dwflags: u32, lpbbytes: *mut u8, dwbytecount: u32, dwgroupsize: u32, baddressprefix: windows_sys::core::BOOL, lpszprefix: windows_sys::core::PCSTR) -> u32;
...
pub type TraceDumpExW = unsafe extern "system" fn(dwtraceid: u32, dwflags: u32, lpbbytes: *mut u8, dwbytecount: u32, dwgroupsize: u32, baddressprefix: windows_sys::core::BOOL, lpszprefix: windows_sys::core::PCWSTR) -> u32;
...
pub type TracePrintfA = unsafe extern "C" fn(dwtraceid: u32, lpszformat: windows_sys::core::PCSTR, ...) -> u32;
windows_link::link!("rtutils.dll" "C" fn TracePrintfA(dwtraceid : u32, lpszformat : windows_sys::core::PCSTR, ...) -> u32);
pub type TracePrintfExA = unsafe extern "C" fn(dwtraceid: u32, dwflags: u32, lpszformat: windows_sys::core::PCSTR, ...) -> u32;
windows_link::link!("rtutils.dll" "C" fn TracePrintfExA(dwtraceid : u32, dwflags : u32, lpszformat : windows_sys::core::PCSTR, ...) -> u32);
pub type TracePrintfExW = unsafe extern "C" fn(dwtraceid: u32, dwflags: u32, lpszformat: windows_sys::core::PCWSTR, ...) -> u32;
windows_link::link!("rtutils.dll" "C" fn TracePrintfExW(dwtraceid : u32, dwflags : u32, lpszformat : windows_sys::core::PCWSTR, ...) -> u32);
pub type TracePrintfW = unsafe extern "C" fn(dwtraceid: u32, lpszformat: windows_sys::core::PCWSTR, ...) -> u32;
windows_link::link!("rtutils.dll" "C" fn TracePrintfW(dwtraceid : u32, lpszformat : windows_sys::core::PCWSTR, ...) -> u32);
pub type TracePutsExA = unsafe extern "system" fn(dwtraceid: u32, dwflags: u32, lpszstring: windows_sys::core::PCSTR) -> u32;
windows_link::link!("rtutils.dll" "system" fn TracePutsExA(dwtraceid : u32, dwflags : u32, lpszstring : windows_sys::core::PCSTR) -> u32);
pub type TracePutsExW = unsafe extern "system" fn(dwtraceid: u32, dwflags: u32, lpszstring: windows_sys::core::PCWSTR) -> u32;
windows_link::link!("rtutils.dll" "system" fn TracePutsExW(dwtraceid : u32, dwflags : u32, lpszstring : windows_sys::core::PCWSTR) -> u32);
pub type TraceRegisterExA = unsafe extern "system" fn(lpszcallername: windows_sys::core::PCSTR, dwflags: u32) -> u32;
windows_link::link!("rtutils.dll" "system" fn TraceRegisterExA(lpszcallername : windows_sys::core::PCSTR, dwflags : u32) -> u32);
pub type TraceRegisterExW = unsafe extern "system" fn(lpszcallername: windows_sys::core::PCWSTR, dwflags: u32) -> u32;
windows_link::link!("rtutils.dll" "system" fn TraceRegisterExW(lpszcallername : windows_sys::core::PCWSTR, dwflags : u32) -> u32);
pub type TraceVprintfExA = unsafe extern "system" fn(dwtraceid: u32, dwflags: u32, lpszformat: windows_sys::core::PCSTR, arglist: *mut i8) -> u32;
...
pub type TraceVprintfExW = unsafe extern "system" fn(dwtraceid: u32, dwflags: u32, lpszformat: windows_sys::core::PCWSTR, arglist: *mut i8) -> u32;
