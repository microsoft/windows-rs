...
windows_link::link!("ondemandconnroutehelper.dll" "system" fn OnDemandRegisterNotification(callback : ONDEMAND_NOTIFICATION_CALLBACK, callbackcontext : *mut core::ffi::c_void, registrationhandle : *mut super::super::Foundation:: HANDLE) -> windows_sys::core::HRESULT);
...
windows_link::link!("wcmapi.dll" "system" fn WcmQueryProperty(pinterface : *mut windows_sys::core::GUID, strprofilename : windows_sys::core::PCWSTR, property : WCM_PROPERTY, preserved : *mut core::ffi::c_void, pdwdatasize : *mut u32, ppdata : *mut *mut u8) -> u32);
...
windows_link::link!("wcmapi.dll" "system" fn WcmSetProperty(pinterface : *mut windows_sys::core::GUID, strprofilename : windows_sys::core::PCWSTR, property : WCM_PROPERTY, preserved : *mut core::ffi::c_void, dwdatasize : u32, pbdata : *mut u8) -> u32);
#[repr(C)]
#[derive(Clone, Copy)]
