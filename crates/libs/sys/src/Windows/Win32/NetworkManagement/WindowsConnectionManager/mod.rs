...
pub type OnDemandGetRoutingHint = unsafe extern "system" fn(destinationhostname: windows_sys::core::PCWSTR, interfaceindex: *mut u32) -> windows_sys::core::HRESULT;
...
pub type WcmGetProfileList = unsafe extern "system" fn(preserved: *const core::ffi::c_void, ppprofilelist: *mut *mut WCM_PROFILE_INFO_LIST) -> u32;
...
pub type WcmQueryProperty = unsafe extern "system" fn(pinterface: *const windows_sys::core::GUID, strprofilename: windows_sys::core::PCWSTR, property: WCM_PROPERTY, preserved: *const core::ffi::c_void, pdwdatasize: *mut u32, ppdata: *mut *mut u8) -> u32;
...
pub type WcmSetProfileList = unsafe extern "system" fn(pprofilelist: *const WCM_PROFILE_INFO_LIST, dwposition: u32, fignoreunknownprofiles: windows_sys::core::BOOL, preserved: *const core::ffi::c_void) -> u32;
...
pub type WcmSetProperty = unsafe extern "system" fn(pinterface: *const windows_sys::core::GUID, strprofilename: windows_sys::core::PCWSTR, property: WCM_PROPERTY, preserved: *const core::ffi::c_void, dwdatasize: u32, pbdata: *const u8) -> u32;
