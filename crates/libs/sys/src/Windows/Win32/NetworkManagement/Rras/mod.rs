pub type MgmAddGroupMembershipEntry = unsafe extern "system" fn(hprotocol: super::super::Foundation::HANDLE, dwsourceaddr: u32, dwsourcemask: u32, dwgroupaddr: u32, dwgroupmask: u32, dwifindex: u32, dwifnexthopipaddr: u32, dwflags: u32) -> u32;
...
pub type MgmDeRegisterMProtocol = unsafe extern "system" fn(hprotocol: super::super::Foundation::HANDLE) -> u32;
windows_link::link!("rtm.dll" "system" fn MgmDeRegisterMProtocol(hprotocol : super::super::Foundation::HANDLE) -> u32);
pub type MgmDeleteGroupMembershipEntry = unsafe extern "system" fn(hprotocol: super::super::Foundation::HANDLE, dwsourceaddr: u32, dwsourcemask: u32, dwgroupaddr: u32, dwgroupmask: u32, dwifindex: u32, dwifnexthopipaddr: u32, dwflags: u32) -> u32;
...
pub type MgmGetFirstMfe = unsafe extern "system" fn(pdwbuffersize: *mut u32, pbbuffer: *mut u8, pdwnumentries: *mut u32) -> u32;
windows_link::link!("rtm.dll" "system" fn MgmGetFirstMfe(pdwbuffersize : *mut u32, pbbuffer : *mut u8, pdwnumentries : *mut u32) -> u32);
pub type MgmGetFirstMfeStats = unsafe extern "system" fn(pdwbuffersize: *mut u32, pbbuffer: *mut u8, pdwnumentries: *mut u32, dwflags: u32) -> u32;
...
pub type MgmGetMfe = unsafe extern "system" fn(pimm: *mut super::IpHelper::MIB_IPMCAST_MFE, pdwbuffersize: *mut u32, pbbuffer: *mut u8) -> u32;
#[cfg(feature = "Win32_NetworkManagement_IpHelper")]
...
#[cfg(feature = "Win32_NetworkManagement_IpHelper")]
pub type MgmGetMfeStats = unsafe extern "system" fn(pimm: *mut super::IpHelper::MIB_IPMCAST_MFE, pdwbuffersize: *mut u32, pbbuffer: *mut u8, dwflags: u32) -> u32;
#[cfg(feature = "Win32_NetworkManagement_IpHelper")]
...
#[cfg(feature = "Win32_NetworkManagement_IpHelper")]
pub type MgmGetNextMfe = unsafe extern "system" fn(pimmstart: *mut super::IpHelper::MIB_IPMCAST_MFE, pdwbuffersize: *mut u32, pbbuffer: *mut u8, pdwnumentries: *mut u32) -> u32;
#[cfg(feature = "Win32_NetworkManagement_IpHelper")]
...
#[cfg(feature = "Win32_NetworkManagement_IpHelper")]
pub type MgmGetNextMfeStats = unsafe extern "system" fn(pimmstart: *mut super::IpHelper::MIB_IPMCAST_MFE, pdwbuffersize: *mut u32, pbbuffer: *mut u8, pdwnumentries: *mut u32, dwflags: u32) -> u32;
#[cfg(feature = "Win32_NetworkManagement_IpHelper")]
...
pub type MgmGetProtocolOnInterface = unsafe extern "system" fn(dwifindex: u32, dwifnexthopaddr: u32, pdwifprotocolid: *mut u32, pdwifcomponentid: *mut u32) -> u32;
...
pub type MgmGroupEnumerationEnd = unsafe extern "system" fn(henum: super::super::Foundation::HANDLE) -> u32;
windows_link::link!("rtm.dll" "system" fn MgmGroupEnumerationEnd(henum : super::super::Foundation::HANDLE) -> u32);
pub type MgmGroupEnumerationGetNext = unsafe extern "system" fn(henum: super::super::Foundation::HANDLE, pdwbuffersize: *mut u32, pbbuffer: *mut u8, pdwnumentries: *mut u32) -> u32;
...
pub type MgmGroupEnumerationStart = unsafe extern "system" fn(hprotocol: super::super::Foundation::HANDLE, metenumtype: MGM_ENUM_TYPES, phenumhandle: *mut super::super::Foundation::HANDLE) -> u32;
...
pub type MgmRegisterMProtocol = unsafe extern "system" fn(prpiinfo: *mut ROUTING_PROTOCOL_CONFIG, dwprotocolid: u32, dwcomponentid: u32, phprotocol: *mut super::super::Foundation::HANDLE) -> u32;
...
pub type MgmReleaseInterfaceOwnership = unsafe extern "system" fn(hprotocol: super::super::Foundation::HANDLE, dwifindex: u32, dwifnexthopaddr: u32) -> u32;
...
pub type MgmTakeInterfaceOwnership = unsafe extern "system" fn(hprotocol: super::super::Foundation::HANDLE, dwifindex: u32, dwifnexthopaddr: u32) -> u32;
...
pub type MprAdminBufferFree = unsafe extern "system" fn(pbuffer: *const core::ffi::c_void) -> u32;
windows_link::link!("mprapi.dll" "system" fn MprAdminBufferFree(pbuffer : *const core::ffi::c_void) -> u32);
pub type MprAdminConnectionClearStats = unsafe extern "system" fn(hrasserver: isize, hrasconnection: super::super::Foundation::HANDLE) -> u32;
...
pub type MprAdminConnectionEnum = unsafe extern "system" fn(hrasserver: isize, dwlevel: u32, lplpbbuffer: *mut *mut u8, dwprefmaxlen: u32, lpdwentriesread: *mut u32, lpdwtotalentries: *mut u32, lpdwresumehandle: *const u32) -> u32;
...
pub type MprAdminConnectionEnumEx = unsafe extern "system" fn(hrasserver: isize, pobjectheader: *const MPRAPI_OBJECT_HEADER, dwpreferedmaxlen: u32, lpdwentriesread: *mut u32, lpdwtotalentries: *mut u32, pprasconn: *mut *mut RAS_CONNECTION_EX, lpdwresumehandle: *const u32) -> u32;
...
pub type MprAdminConnectionGetInfo = unsafe extern "system" fn(hrasserver: isize, dwlevel: u32, hrasconnection: super::super::Foundation::HANDLE, lplpbbuffer: *mut *mut u8) -> u32;
...
pub type MprAdminConnectionGetInfoEx = unsafe extern "system" fn(hrasserver: isize, hrasconnection: super::super::Foundation::HANDLE, prasconnection: *mut RAS_CONNECTION_EX) -> u32;
...
pub type MprAdminConnectionRemoveQuarantine = unsafe extern "system" fn(hrasserver: super::super::Foundation::HANDLE, hrasconnection: super::super::Foundation::HANDLE, fisipaddress: windows_sys::core::BOOL) -> u32;
...
pub type MprAdminDeregisterConnectionNotification = unsafe extern "system" fn(hmprserver: isize, heventnotification: super::super::Foundation::HANDLE) -> u32;
...
pub type MprAdminDeviceEnum = unsafe extern "system" fn(hmprserver: isize, dwlevel: u32, lplpbbuffer: *mut *mut u8, lpdwtotalentries: *mut u32) -> u32;
...
pub type MprAdminEstablishDomainRasServer = unsafe extern "system" fn(pszdomain: windows_sys::core::PCWSTR, pszmachine: windows_sys::core::PCWSTR, benable: windows_sys::core::BOOL) -> u32;
...
pub type MprAdminGetErrorString = unsafe extern "system" fn(dwerror: u32, lplpwserrorstring: *mut windows_sys::core::PWSTR) -> u32;
...
pub type MprAdminGetPDCServer = unsafe extern "system" fn(lpszdomain: windows_sys::core::PCWSTR, lpszserver: windows_sys::core::PCWSTR, lpszpdcserver: windows_sys::core::PWSTR) -> u32;
...
pub type MprAdminInterfaceConnect = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE, hevent: super::super::Foundation::HANDLE, fsynchronous: windows_sys::core::BOOL) -> u32;
...
pub type MprAdminInterfaceCreate = unsafe extern "system" fn(hmprserver: isize, dwlevel: u32, lpbbuffer: *const u8, phinterface: *mut super::super::Foundation::HANDLE) -> u32;
...
pub type MprAdminInterfaceDelete = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE) -> u32;
...
pub type MprAdminInterfaceDeviceGetInfo = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE, dwindex: u32, dwlevel: u32, lplpbuffer: *mut *mut u8) -> u32;
...
pub type MprAdminInterfaceDeviceSetInfo = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE, dwindex: u32, dwlevel: u32, lpbbuffer: *const u8) -> u32;
...
pub type MprAdminInterfaceDisconnect = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE) -> u32;
...
pub type MprAdminInterfaceEnum = unsafe extern "system" fn(hmprserver: isize, dwlevel: u32, lplpbbuffer: *mut *mut u8, dwprefmaxlen: u32, lpdwentriesread: *mut u32, lpdwtotalentries: *mut u32, lpdwresumehandle: *const u32) -> u32;
...
pub type MprAdminInterfaceGetCredentials = unsafe extern "system" fn(lpwsserver: windows_sys::core::PCWSTR, lpwsinterfacename: windows_sys::core::PCWSTR, lpwsusername: windows_sys::core::PWSTR, lpwspassword: windows_sys::core::PWSTR, lpwsdomainname: windows_sys::core::PWSTR) -> u32;
...
pub type MprAdminInterfaceGetCredentialsEx = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE, dwlevel: u32, lplpbbuffer: *mut *mut u8) -> u32;
...
pub type MprAdminInterfaceGetCustomInfoEx = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE, pcustominfo: *mut MPR_IF_CUSTOMINFOEX2) -> u32;
#[cfg(all(feature = "Win32_Networking_WinSock", feature = "Win32_Security_Cryptography"))]
...
pub type MprAdminInterfaceGetHandle = unsafe extern "system" fn(hmprserver: isize, lpwsinterfacename: windows_sys::core::PCWSTR, phinterface: *mut super::super::Foundation::HANDLE, fincludeclientinterfaces: windows_sys::core::BOOL) -> u32;
...
pub type MprAdminInterfaceGetInfo = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE, dwlevel: u32, lplpbbuffer: *const *const u8) -> u32;
...
pub type MprAdminInterfaceQueryUpdateResult = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE, dwprotocolid: u32, lpdwupdateresult: *mut u32) -> u32;
...
pub type MprAdminInterfaceSetCredentials = unsafe extern "system" fn(lpwsserver: windows_sys::core::PCWSTR, lpwsinterfacename: windows_sys::core::PCWSTR, lpwsusername: windows_sys::core::PCWSTR, lpwsdomainname: windows_sys::core::PCWSTR, lpwspassword: windows_sys::core::PCWSTR) -> u32;
...
pub type MprAdminInterfaceSetCredentialsEx = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE, dwlevel: u32, lpbbuffer: *const u8) -> u32;
...
#[cfg(all(feature = "Win32_Networking_WinSock", feature = "Win32_Security_Cryptography"))]
pub type MprAdminInterfaceSetCustomInfoEx = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE, pcustominfo: *const MPR_IF_CUSTOMINFOEX2) -> u32;
#[cfg(all(feature = "Win32_Networking_WinSock", feature = "Win32_Security_Cryptography"))]
...
pub type MprAdminInterfaceSetInfo = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE, dwlevel: u32, lpbbuffer: *const u8) -> u32;
...
pub type MprAdminInterfaceTransportAdd = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE, dwtransportid: u32, pinterfaceinfo: *const u8, dwinterfaceinfosize: u32) -> u32;
...
pub type MprAdminInterfaceTransportGetInfo = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE, dwtransportid: u32, ppinterfaceinfo: *mut *mut u8, lpdwinterfaceinfosize: *mut u32) -> u32;
...
pub type MprAdminInterfaceTransportRemove = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE, dwtransportid: u32) -> u32;
...
pub type MprAdminInterfaceTransportSetInfo = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE, dwtransportid: u32, pinterfaceinfo: *const u8, dwinterfaceinfosize: u32) -> u32;
...
pub type MprAdminInterfaceUpdatePhonebookInfo = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE) -> u32;
...
pub type MprAdminInterfaceUpdateRoutes = unsafe extern "system" fn(hmprserver: isize, hinterface: super::super::Foundation::HANDLE, dwprotocolid: u32, hevent: super::super::Foundation::HANDLE) -> u32;
...
pub type MprAdminIsDomainRasServer = unsafe extern "system" fn(pszdomain: windows_sys::core::PCWSTR, pszmachine: windows_sys::core::PCWSTR, pbisrasserver: *mut windows_sys::core::BOOL) -> u32;
...
pub type MprAdminIsServiceInitialized = unsafe extern "system" fn(lpwsservername: windows_sys::core::PCWSTR, fisserviceinitialized: *const windows_sys::core::BOOL) -> u32;
...
pub type MprAdminIsServiceRunning = unsafe extern "system" fn(lpwsservername: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type MprAdminMIBBufferFree = unsafe extern "system" fn(pbuffer: *const core::ffi::c_void) -> u32;
windows_link::link!("mprapi.dll" "system" fn MprAdminMIBBufferFree(pbuffer : *const core::ffi::c_void) -> u32);
pub type MprAdminMIBEntryCreate = unsafe extern "system" fn(hmibserver: isize, dwpid: u32, dwroutingpid: u32, lpentry: *const core::ffi::c_void, dwentrysize: u32) -> u32;
...
pub type MprAdminMIBEntryDelete = unsafe extern "system" fn(hmibserver: isize, dwprotocolid: u32, dwroutingpid: u32, lpentry: *const core::ffi::c_void, dwentrysize: u32) -> u32;
...
pub type MprAdminMIBEntryGet = unsafe extern "system" fn(hmibserver: isize, dwprotocolid: u32, dwroutingpid: u32, lpinentry: *const core::ffi::c_void, dwinentrysize: u32, lplpoutentry: *mut *mut core::ffi::c_void, lpoutentrysize: *mut u32) -> u32;
...
pub type MprAdminMIBEntryGetFirst = unsafe extern "system" fn(hmibserver: isize, dwprotocolid: u32, dwroutingpid: u32, lpinentry: *const core::ffi::c_void, dwinentrysize: u32, lplpoutentry: *mut *mut core::ffi::c_void, lpoutentrysize: *mut u32) -> u32;
...
pub type MprAdminMIBEntryGetNext = unsafe extern "system" fn(hmibserver: isize, dwprotocolid: u32, dwroutingpid: u32, lpinentry: *const core::ffi::c_void, dwinentrysize: u32, lplpoutentry: *mut *mut core::ffi::c_void, lpoutentrysize: *mut u32) -> u32;
...
pub type MprAdminMIBEntrySet = unsafe extern "system" fn(hmibserver: isize, dwprotocolid: u32, dwroutingpid: u32, lpentry: *const core::ffi::c_void, dwentrysize: u32) -> u32;
...
pub type MprAdminMIBServerConnect = unsafe extern "system" fn(lpwsservername: windows_sys::core::PCWSTR, phmibserver: *mut isize) -> u32;
...
pub type MprAdminMIBServerDisconnect = unsafe extern "system" fn(hmibserver: isize);
windows_link::link!("mprapi.dll" "system" fn MprAdminMIBServerDisconnect(hmibserver : isize));
pub type MprAdminPortClearStats = unsafe extern "system" fn(hrasserver: isize, hport: super::super::Foundation::HANDLE) -> u32;
windows_link::link!("mprapi.dll" "system" fn MprAdminPortClearStats(hrasserver : isize, hport : super::super::Foundation::HANDLE) -> u32);
pub type MprAdminPortDisconnect = unsafe extern "system" fn(hrasserver: isize, hport: super::super::Foundation::HANDLE) -> u32;
windows_link::link!("mprapi.dll" "system" fn MprAdminPortDisconnect(hrasserver : isize, hport : super::super::Foundation::HANDLE) -> u32);
pub type MprAdminPortEnum = unsafe extern "system" fn(hrasserver: isize, dwlevel: u32, hrasconnection: super::super::Foundation::HANDLE, lplpbbuffer: *mut *mut u8, dwprefmaxlen: u32, lpdwentriesread: *mut u32, lpdwtotalentries: *mut u32, lpdwresumehandle: *const u32) -> u32;
...
pub type MprAdminPortGetInfo = unsafe extern "system" fn(hrasserver: isize, dwlevel: u32, hport: super::super::Foundation::HANDLE, lplpbbuffer: *mut *mut u8) -> u32;
...
pub type MprAdminPortReset = unsafe extern "system" fn(hrasserver: isize, hport: super::super::Foundation::HANDLE) -> u32;
windows_link::link!("mprapi.dll" "system" fn MprAdminPortReset(hrasserver : isize, hport : super::super::Foundation::HANDLE) -> u32);
pub type MprAdminRegisterConnectionNotification = unsafe extern "system" fn(hmprserver: isize, heventnotification: super::super::Foundation::HANDLE) -> u32;
...
pub type MprAdminSendUserMessage = unsafe extern "system" fn(hmprserver: isize, hconnection: super::super::Foundation::HANDLE, lpwszmessage: windows_sys::core::PCWSTR) -> u32;
...
pub type MprAdminServerConnect = unsafe extern "system" fn(lpwsservername: windows_sys::core::PCWSTR, phmprserver: *mut isize) -> u32;
...
pub type MprAdminServerDisconnect = unsafe extern "system" fn(hmprserver: isize);
windows_link::link!("mprapi.dll" "system" fn MprAdminServerDisconnect(hmprserver : isize));
pub type MprAdminServerGetCredentials = unsafe extern "system" fn(hmprserver: isize, dwlevel: u32, lplpbbuffer: *const *const u8) -> u32;
...
pub type MprAdminServerGetInfo = unsafe extern "system" fn(hmprserver: isize, dwlevel: u32, lplpbbuffer: *mut *mut u8) -> u32;
...
pub type MprAdminServerGetInfoEx = unsafe extern "system" fn(hmprserver: isize, pserverinfo: *mut MPR_SERVER_EX1) -> u32;
#[cfg(feature = "Win32_Security_Cryptography")]
windows_link::link!("mprapi.dll" "system" fn MprAdminServerGetInfoEx(hmprserver : isize, pserverinfo : *mut MPR_SERVER_EX1) -> u32);
pub type MprAdminServerSetCredentials = unsafe extern "system" fn(hmprserver: isize, dwlevel: u32, lpbbuffer: *const u8) -> u32;
windows_link::link!("mprapi.dll" "system" fn MprAdminServerSetCredentials(hmprserver : isize, dwlevel : u32, lpbbuffer : *const u8) -> u32);
pub type MprAdminServerSetInfo = unsafe extern "system" fn(hmprserver: isize, dwlevel: u32, lpbbuffer: *const u8) -> u32;
windows_link::link!("mprapi.dll" "system" fn MprAdminServerSetInfo(hmprserver : isize, dwlevel : u32, lpbbuffer : *const u8) -> u32);
#[cfg(feature = "Win32_Security_Cryptography")]
pub type MprAdminServerSetInfoEx = unsafe extern "system" fn(hmprserver: isize, pserverinfo: *const MPR_SERVER_SET_CONFIG_EX1) -> u32;
#[cfg(feature = "Win32_Security_Cryptography")]
...
pub type MprAdminTransportCreate = unsafe extern "system" fn(hmprserver: isize, dwtransportid: u32, lpwstransportname: windows_sys::core::PCWSTR, pglobalinfo: *const u8, dwglobalinfosize: u32, pclientinterfaceinfo: *const u8, dwclientinterfaceinfosize: u32, lpwsdllpath: windows_sys::core::PCWSTR) -> u32;
...
pub type MprAdminTransportGetInfo = unsafe extern "system" fn(hmprserver: isize, dwtransportid: u32, ppglobalinfo: *mut *mut u8, lpdwglobalinfosize: *mut u32, ppclientinterfaceinfo: *mut *mut u8, lpdwclientinterfaceinfosize: *mut u32) -> u32;
...
pub type MprAdminTransportSetInfo = unsafe extern "system" fn(hmprserver: isize, dwtransportid: u32, pglobalinfo: *const u8, dwglobalinfosize: u32, pclientinterfaceinfo: *const u8, dwclientinterfaceinfosize: u32) -> u32;
...
pub type MprAdminUpdateConnection = unsafe extern "system" fn(hrasserver: isize, hrasconnection: super::super::Foundation::HANDLE, prasupdateconnection: *const RAS_UPDATE_CONNECTION) -> u32;
...
pub type MprAdminUserGetInfo = unsafe extern "system" fn(lpszserver: windows_sys::core::PCWSTR, lpszuser: windows_sys::core::PCWSTR, dwlevel: u32, lpbbuffer: *mut u8) -> u32;
...
pub type MprAdminUserSetInfo = unsafe extern "system" fn(lpszserver: windows_sys::core::PCWSTR, lpszuser: windows_sys::core::PCWSTR, dwlevel: u32, lpbbuffer: *const u8) -> u32;
...
pub type MprConfigBufferFree = unsafe extern "system" fn(pbuffer: *const core::ffi::c_void) -> u32;
windows_link::link!("mprapi.dll" "system" fn MprConfigBufferFree(pbuffer : *const core::ffi::c_void) -> u32);
pub type MprConfigFilterGetInfo = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, dwlevel: u32, dwtransportid: u32, lpbuffer: *mut u8) -> u32;
...
pub type MprConfigFilterSetInfo = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, dwlevel: u32, dwtransportid: u32, lpbuffer: *const u8) -> u32;
...
pub type MprConfigGetFriendlyName = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, pszguidname: windows_sys::core::PCWSTR, pszbuffer: windows_sys::core::PWSTR, dwbuffersize: u32) -> u32;
...
pub type MprConfigGetGuidName = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, pszfriendlyname: windows_sys::core::PCWSTR, pszbuffer: windows_sys::core::PWSTR, dwbuffersize: u32) -> u32;
...
pub type MprConfigInterfaceCreate = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, dwlevel: u32, lpbbuffer: *const u8, phrouterinterface: *mut super::super::Foundation::HANDLE) -> u32;
...
pub type MprConfigInterfaceDelete = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, hrouterinterface: super::super::Foundation::HANDLE) -> u32;
...
pub type MprConfigInterfaceEnum = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, dwlevel: u32, lplpbuffer: *mut *mut u8, dwprefmaxlen: u32, lpdwentriesread: *mut u32, lpdwtotalentries: *mut u32, lpdwresumehandle: *mut u32) -> u32;
...
#[cfg(all(feature = "Win32_Networking_WinSock", feature = "Win32_Security_Cryptography"))]
pub type MprConfigInterfaceGetCustomInfoEx = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, hrouterinterface: super::super::Foundation::HANDLE, pcustominfo: *mut MPR_IF_CUSTOMINFOEX2) -> u32;
#[cfg(all(feature = "Win32_Networking_WinSock", feature = "Win32_Security_Cryptography"))]
...
pub type MprConfigInterfaceGetHandle = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, lpwsinterfacename: windows_sys::core::PCWSTR, phrouterinterface: *mut super::super::Foundation::HANDLE) -> u32;
...
pub type MprConfigInterfaceGetInfo = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, hrouterinterface: super::super::Foundation::HANDLE, dwlevel: u32, lplpbuffer: *mut *mut u8, lpdwbuffersize: *mut u32) -> u32;
...
#[cfg(all(feature = "Win32_Networking_WinSock", feature = "Win32_Security_Cryptography"))]
pub type MprConfigInterfaceSetCustomInfoEx = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, hrouterinterface: super::super::Foundation::HANDLE, pcustominfo: *const MPR_IF_CUSTOMINFOEX2) -> u32;
#[cfg(all(feature = "Win32_Networking_WinSock", feature = "Win32_Security_Cryptography"))]
...
pub type MprConfigInterfaceSetInfo = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, hrouterinterface: super::super::Foundation::HANDLE, dwlevel: u32, lpbbuffer: *const u8) -> u32;
...
pub type MprConfigInterfaceTransportAdd = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, hrouterinterface: super::super::Foundation::HANDLE, dwtransportid: u32, lpwstransportname: windows_sys::core::PCWSTR, pinterfaceinfo: *const u8, dwinterfaceinfosize: u32, phrouteriftransport: *mut super::super::Foundation::HANDLE) -> u32;
...
pub type MprConfigInterfaceTransportEnum = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, hrouterinterface: super::super::Foundation::HANDLE, dwlevel: u32, lplpbuffer: *mut *mut u8, dwprefmaxlen: u32, lpdwentriesread: *mut u32, lpdwtotalentries: *mut u32, lpdwresumehandle: *mut u32) -> u32;
...
pub type MprConfigInterfaceTransportGetHandle = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, hrouterinterface: super::super::Foundation::HANDLE, dwtransportid: u32, phrouteriftransport: *mut super::super::Foundation::HANDLE) -> u32;
...
pub type MprConfigInterfaceTransportGetInfo = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, hrouterinterface: super::super::Foundation::HANDLE, hrouteriftransport: super::super::Foundation::HANDLE, ppinterfaceinfo: *mut *mut u8, lpdwinterfaceinfosize: *mut u32) -> u32;
...
pub type MprConfigInterfaceTransportRemove = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, hrouterinterface: super::super::Foundation::HANDLE, hrouteriftransport: super::super::Foundation::HANDLE) -> u32;
...
pub type MprConfigInterfaceTransportSetInfo = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, hrouterinterface: super::super::Foundation::HANDLE, hrouteriftransport: super::super::Foundation::HANDLE, pinterfaceinfo: *const u8, dwinterfaceinfosize: u32) -> u32;
...
pub type MprConfigServerBackup = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, lpwspath: windows_sys::core::PCWSTR) -> u32;
...
pub type MprConfigServerConnect = unsafe extern "system" fn(lpwsservername: windows_sys::core::PCWSTR, phmprconfig: *mut super::super::Foundation::HANDLE) -> u32;
...
pub type MprConfigServerDisconnect = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE);
windows_link::link!("mprapi.dll" "system" fn MprConfigServerDisconnect(hmprconfig : super::super::Foundation::HANDLE));
pub type MprConfigServerGetInfo = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, dwlevel: u32, lplpbbuffer: *mut *mut u8) -> u32;
...
#[cfg(feature = "Win32_Security_Cryptography")]
pub type MprConfigServerGetInfoEx = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, pserverinfo: *mut MPR_SERVER_EX1) -> u32;
#[cfg(feature = "Win32_Security_Cryptography")]
...
pub type MprConfigServerInstall = unsafe extern "system" fn(dwlevel: u32, pbuffer: *const core::ffi::c_void) -> u32;
windows_link::link!("mprapi.dll" "system" fn MprConfigServerInstall(dwlevel : u32, pbuffer : *const core::ffi::c_void) -> u32);
pub type MprConfigServerRefresh = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE) -> u32;
windows_link::link!("mprapi.dll" "system" fn MprConfigServerRefresh(hmprconfig : super::super::Foundation::HANDLE) -> u32);
pub type MprConfigServerRestore = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, lpwspath: windows_sys::core::PCWSTR) -> u32;
...
pub type MprConfigServerSetInfo = unsafe extern "system" fn(hmprserver: isize, dwlevel: u32, lpbbuffer: *const u8) -> u32;
windows_link::link!("mprapi.dll" "system" fn MprConfigServerSetInfo(hmprserver : isize, dwlevel : u32, lpbbuffer : *const u8) -> u32);
#[cfg(feature = "Win32_Security_Cryptography")]
pub type MprConfigServerSetInfoEx = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, psetserverconfig: *const MPR_SERVER_SET_CONFIG_EX1) -> u32;
#[cfg(feature = "Win32_Security_Cryptography")]
...
pub type MprConfigTransportCreate = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, dwtransportid: u32, lpwstransportname: windows_sys::core::PCWSTR, pglobalinfo: *const u8, dwglobalinfosize: u32, pclientinterfaceinfo: *const u8, dwclientinterfaceinfosize: u32, lpwsdllpath: windows_sys::core::PCWSTR, phroutertransport: *mut super::super::Foundation::HANDLE) -> u32;
...
pub type MprConfigTransportDelete = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, hroutertransport: super::super::Foundation::HANDLE) -> u32;
...
pub type MprConfigTransportEnum = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, dwlevel: u32, lplpbuffer: *mut *mut u8, dwprefmaxlen: u32, lpdwentriesread: *mut u32, lpdwtotalentries: *mut u32, lpdwresumehandle: *mut u32) -> u32;
...
pub type MprConfigTransportGetHandle = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, dwtransportid: u32, phroutertransport: *mut super::super::Foundation::HANDLE) -> u32;
...
pub type MprConfigTransportGetInfo = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, hroutertransport: super::super::Foundation::HANDLE, ppglobalinfo: *mut *mut u8, lpdwglobalinfosize: *mut u32, ppclientinterfaceinfo: *mut *mut u8, lpdwclientinterfaceinfosize: *mut u32, lplpwsdllpath: *mut windows_sys::core::PWSTR) -> u32;
...
pub type MprConfigTransportSetInfo = unsafe extern "system" fn(hmprconfig: super::super::Foundation::HANDLE, hroutertransport: super::super::Foundation::HANDLE, pglobalinfo: *const u8, dwglobalinfosize: u32, pclientinterfaceinfo: *const u8, dwclientinterfaceinfosize: u32, lpwsdllpath: windows_sys::core::PCWSTR) -> u32;
...
pub type MprInfoBlockAdd = unsafe extern "system" fn(lpheader: *const core::ffi::c_void, dwinfotype: u32, dwitemsize: u32, dwitemcount: u32, lpitemdata: *const u8, lplpnewheader: *mut *mut core::ffi::c_void) -> u32;
...
pub type MprInfoBlockFind = unsafe extern "system" fn(lpheader: *const core::ffi::c_void, dwinfotype: u32, lpdwitemsize: *mut u32, lpdwitemcount: *mut u32, lplpitemdata: *mut *mut u8) -> u32;
...
pub type MprInfoBlockQuerySize = unsafe extern "system" fn(lpheader: *const core::ffi::c_void) -> u32;
windows_link::link!("mprapi.dll" "system" fn MprInfoBlockQuerySize(lpheader : *const core::ffi::c_void) -> u32);
pub type MprInfoBlockRemove = unsafe extern "system" fn(lpheader: *const core::ffi::c_void, dwinfotype: u32, lplpnewheader: *mut *mut core::ffi::c_void) -> u32;
...
pub type MprInfoBlockSet = unsafe extern "system" fn(lpheader: *const core::ffi::c_void, dwinfotype: u32, dwitemsize: u32, dwitemcount: u32, lpitemdata: *const u8, lplpnewheader: *mut *mut core::ffi::c_void) -> u32;
...
pub type MprInfoCreate = unsafe extern "system" fn(dwversion: u32, lplpnewheader: *mut *mut core::ffi::c_void) -> u32;
windows_link::link!("mprapi.dll" "system" fn MprInfoCreate(dwversion : u32, lplpnewheader : *mut *mut core::ffi::c_void) -> u32);
pub type MprInfoDelete = unsafe extern "system" fn(lpheader: *const core::ffi::c_void) -> u32;
windows_link::link!("mprapi.dll" "system" fn MprInfoDelete(lpheader : *const core::ffi::c_void) -> u32);
pub type MprInfoDuplicate = unsafe extern "system" fn(lpheader: *const core::ffi::c_void, lplpnewheader: *mut *mut core::ffi::c_void) -> u32;
...
pub type MprInfoRemoveAll = unsafe extern "system" fn(lpheader: *const core::ffi::c_void, lplpnewheader: *mut *mut core::ffi::c_void) -> u32;
...
pub type RasClearConnectionStatistics = unsafe extern "system" fn(hrasconn: HRASCONN) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasClearConnectionStatistics(hrasconn : HRASCONN) -> u32);
pub type RasClearLinkStatistics = unsafe extern "system" fn(hrasconn: HRASCONN, dwsubentry: u32) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasClearLinkStatistics(hrasconn : HRASCONN, dwsubentry : u32) -> u32);
pub type RasConnectionNotificationA = unsafe extern "system" fn(param0: HRASCONN, param1: super::super::Foundation::HANDLE, param2: u32) -> u32;
...
pub type RasConnectionNotificationW = unsafe extern "system" fn(param0: HRASCONN, param1: super::super::Foundation::HANDLE, param2: u32) -> u32;
...
pub type RasCreatePhonebookEntryA = unsafe extern "system" fn(param0: super::super::Foundation::HWND, param1: windows_sys::core::PCSTR) -> u32;
...
pub type RasCreatePhonebookEntryW = unsafe extern "system" fn(param0: super::super::Foundation::HWND, param1: windows_sys::core::PCWSTR) -> u32;
...
pub type RasDeleteEntryA = unsafe extern "system" fn(param0: windows_sys::core::PCSTR, param1: windows_sys::core::PCSTR) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasDeleteEntryA(param0 : windows_sys::core::PCSTR, param1 : windows_sys::core::PCSTR) -> u32);
pub type RasDeleteEntryW = unsafe extern "system" fn(param0: windows_sys::core::PCWSTR, param1: windows_sys::core::PCWSTR) -> u32;
...
pub type RasDeleteSubEntryA = unsafe extern "system" fn(pszphonebook: windows_sys::core::PCSTR, pszentry: windows_sys::core::PCSTR, dwsubentryid: u32) -> u32;
...
pub type RasDeleteSubEntryW = unsafe extern "system" fn(pszphonebook: windows_sys::core::PCWSTR, pszentry: windows_sys::core::PCWSTR, dwsubentryid: u32) -> u32;
...
pub type RasDialA = unsafe extern "system" fn(param0: *const RASDIALEXTENSIONS, param1: windows_sys::core::PCSTR, param2: *const RASDIALPARAMSA, param3: u32, param4: *const core::ffi::c_void, param5: *mut HRASCONN) -> u32;
...
pub type RasDialDlgA = unsafe extern "system" fn(lpszphonebook: windows_sys::core::PCSTR, lpszentry: windows_sys::core::PCSTR, lpszphonenumber: windows_sys::core::PCSTR, lpinfo: *mut RASDIALDLG) -> windows_sys::core::BOOL;
...
pub type RasDialDlgW = unsafe extern "system" fn(lpszphonebook: windows_sys::core::PCWSTR, lpszentry: windows_sys::core::PCWSTR, lpszphonenumber: windows_sys::core::PCWSTR, lpinfo: *mut RASDIALDLG) -> windows_sys::core::BOOL;
...
pub type RasDialW = unsafe extern "system" fn(param0: *const RASDIALEXTENSIONS, param1: windows_sys::core::PCWSTR, param2: *const RASDIALPARAMSW, param3: u32, param4: *const core::ffi::c_void, param5: *mut HRASCONN) -> u32;
...
pub type RasEditPhonebookEntryA = unsafe extern "system" fn(param0: super::super::Foundation::HWND, param1: windows_sys::core::PCSTR, param2: windows_sys::core::PCSTR) -> u32;
...
pub type RasEditPhonebookEntryW = unsafe extern "system" fn(param0: super::super::Foundation::HWND, param1: windows_sys::core::PCWSTR, param2: windows_sys::core::PCWSTR) -> u32;
...
pub type RasEntryDlgA = unsafe extern "system" fn(lpszphonebook: windows_sys::core::PCSTR, lpszentry: windows_sys::core::PCSTR, lpinfo: *mut RASENTRYDLGA) -> windows_sys::core::BOOL;
...
pub type RasEntryDlgW = unsafe extern "system" fn(lpszphonebook: windows_sys::core::PCWSTR, lpszentry: windows_sys::core::PCWSTR, lpinfo: *mut RASENTRYDLGW) -> windows_sys::core::BOOL;
...
pub type RasEnumAutodialAddressesA = unsafe extern "system" fn(lpprasautodialaddresses: *mut windows_sys::core::PSTR, lpdwcbrasautodialaddresses: *mut u32, lpdwcrasautodialaddresses: *mut u32) -> u32;
...
pub type RasEnumAutodialAddressesW = unsafe extern "system" fn(lpprasautodialaddresses: *mut windows_sys::core::PWSTR, lpdwcbrasautodialaddresses: *mut u32, lpdwcrasautodialaddresses: *mut u32) -> u32;
...
pub type RasEnumConnectionsA = unsafe extern "system" fn(param0: *mut RASCONNA, param1: *mut u32, param2: *mut u32) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasEnumConnectionsA(param0 : *mut RASCONNA, param1 : *mut u32, param2 : *mut u32) -> u32);
pub type RasEnumConnectionsW = unsafe extern "system" fn(param0: *mut RASCONNW, param1: *mut u32, param2: *mut u32) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasEnumConnectionsW(param0 : *mut RASCONNW, param1 : *mut u32, param2 : *mut u32) -> u32);
pub type RasEnumDevicesA = unsafe extern "system" fn(param0: *mut RASDEVINFOA, param1: *mut u32, param2: *mut u32) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasEnumDevicesA(param0 : *mut RASDEVINFOA, param1 : *mut u32, param2 : *mut u32) -> u32);
pub type RasEnumDevicesW = unsafe extern "system" fn(param0: *mut RASDEVINFOW, param1: *mut u32, param2: *mut u32) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasEnumDevicesW(param0 : *mut RASDEVINFOW, param1 : *mut u32, param2 : *mut u32) -> u32);
pub type RasEnumEntriesA = unsafe extern "system" fn(param0: windows_sys::core::PCSTR, param1: windows_sys::core::PCSTR, param2: *mut RASENTRYNAMEA, param3: *mut u32, param4: *mut u32) -> u32;
...
pub type RasEnumEntriesW = unsafe extern "system" fn(param0: windows_sys::core::PCWSTR, param1: windows_sys::core::PCWSTR, param2: *mut RASENTRYNAMEW, param3: *mut u32, param4: *mut u32) -> u32;
...
pub type RasFreeEapUserIdentityA = unsafe extern "system" fn(praseapuseridentity: *const RASEAPUSERIDENTITYA);
windows_link::link!("rasapi32.dll" "system" fn RasFreeEapUserIdentityA(praseapuseridentity : *const RASEAPUSERIDENTITYA));
pub type RasFreeEapUserIdentityW = unsafe extern "system" fn(praseapuseridentity: *const RASEAPUSERIDENTITYW);
windows_link::link!("rasapi32.dll" "system" fn RasFreeEapUserIdentityW(praseapuseridentity : *const RASEAPUSERIDENTITYW));
pub type RasGetAutodialAddressA = unsafe extern "system" fn(param0: windows_sys::core::PCSTR, param1: *const u32, param2: *mut RASAUTODIALENTRYA, param3: *mut u32, param4: *mut u32) -> u32;
...
pub type RasGetAutodialAddressW = unsafe extern "system" fn(param0: windows_sys::core::PCWSTR, param1: *const u32, param2: *mut RASAUTODIALENTRYW, param3: *mut u32, param4: *mut u32) -> u32;
...
pub type RasGetAutodialEnableA = unsafe extern "system" fn(param0: u32, param1: *mut windows_sys::core::BOOL) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasGetAutodialEnableA(param0 : u32, param1 : *mut windows_sys::core::BOOL) -> u32);
pub type RasGetAutodialEnableW = unsafe extern "system" fn(param0: u32, param1: *mut windows_sys::core::BOOL) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasGetAutodialEnableW(param0 : u32, param1 : *mut windows_sys::core::BOOL) -> u32);
pub type RasGetAutodialParamA = unsafe extern "system" fn(param0: u32, param1: *mut core::ffi::c_void, param2: *mut u32) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasGetAutodialParamA(param0 : u32, param1 : *mut core::ffi::c_void, param2 : *mut u32) -> u32);
pub type RasGetAutodialParamW = unsafe extern "system" fn(param0: u32, param1: *mut core::ffi::c_void, param2: *mut u32) -> u32;
...
pub type RasGetConnectStatusA = unsafe extern "system" fn(param0: HRASCONN, param1: *mut RASCONNSTATUSA) -> u32;
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("rasapi32.dll" "system" fn RasGetConnectStatusA(param0 : HRASCONN, param1 : *mut RASCONNSTATUSA) -> u32);
#[cfg(feature = "Win32_Networking_WinSock")]
pub type RasGetConnectStatusW = unsafe extern "system" fn(param0: HRASCONN, param1: *mut RASCONNSTATUSW) -> u32;
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("rasapi32.dll" "system" fn RasGetConnectStatusW(param0 : HRASCONN, param1 : *mut RASCONNSTATUSW) -> u32);
pub type RasGetConnectionStatistics = unsafe extern "system" fn(hrasconn: HRASCONN, lpstatistics: *mut RAS_STATS) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasGetConnectionStatistics(hrasconn : HRASCONN, lpstatistics : *mut RAS_STATS) -> u32);
pub type RasGetCountryInfoA = unsafe extern "system" fn(param0: *mut RASCTRYINFO, param1: *mut u32) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasGetCountryInfoA(param0 : *mut RASCTRYINFO, param1 : *mut u32) -> u32);
pub type RasGetCountryInfoW = unsafe extern "system" fn(param0: *mut RASCTRYINFO, param1: *mut u32) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasGetCountryInfoW(param0 : *mut RASCTRYINFO, param1 : *mut u32) -> u32);
pub type RasGetCredentialsA = unsafe extern "system" fn(param0: windows_sys::core::PCSTR, param1: windows_sys::core::PCSTR, param2: *mut RASCREDENTIALSA) -> u32;
...
pub type RasGetCredentialsW = unsafe extern "system" fn(param0: windows_sys::core::PCWSTR, param1: windows_sys::core::PCWSTR, param2: *mut RASCREDENTIALSW) -> u32;
...
pub type RasGetCustomAuthDataA = unsafe extern "system" fn(pszphonebook: windows_sys::core::PCSTR, pszentry: windows_sys::core::PCSTR, pbcustomauthdata: *mut u8, pdwsizeofcustomauthdata: *mut u32) -> u32;
...
pub type RasGetCustomAuthDataW = unsafe extern "system" fn(pszphonebook: windows_sys::core::PCWSTR, pszentry: windows_sys::core::PCWSTR, pbcustomauthdata: *mut u8, pdwsizeofcustomauthdata: *mut u32) -> u32;
...
pub type RasGetEapUserDataA = unsafe extern "system" fn(htoken: super::super::Foundation::HANDLE, pszphonebook: windows_sys::core::PCSTR, pszentry: windows_sys::core::PCSTR, pbeapdata: *mut u8, pdwsizeofeapdata: *mut u32) -> u32;
...
pub type RasGetEapUserDataW = unsafe extern "system" fn(htoken: super::super::Foundation::HANDLE, pszphonebook: windows_sys::core::PCWSTR, pszentry: windows_sys::core::PCWSTR, pbeapdata: *mut u8, pdwsizeofeapdata: *mut u32) -> u32;
...
pub type RasGetEapUserIdentityA = unsafe extern "system" fn(pszphonebook: windows_sys::core::PCSTR, pszentry: windows_sys::core::PCSTR, dwflags: u32, hwnd: super::super::Foundation::HWND, ppraseapuseridentity: *mut *mut RASEAPUSERIDENTITYA) -> u32;
...
pub type RasGetEapUserIdentityW = unsafe extern "system" fn(pszphonebook: windows_sys::core::PCWSTR, pszentry: windows_sys::core::PCWSTR, dwflags: u32, hwnd: super::super::Foundation::HWND, ppraseapuseridentity: *mut *mut RASEAPUSERIDENTITYW) -> u32;
...
pub type RasGetEntryDialParamsA = unsafe extern "system" fn(param0: windows_sys::core::PCSTR, param1: *mut RASDIALPARAMSA, param2: *mut windows_sys::core::BOOL) -> u32;
...
pub type RasGetEntryDialParamsW = unsafe extern "system" fn(param0: windows_sys::core::PCWSTR, param1: *mut RASDIALPARAMSW, param2: *mut windows_sys::core::BOOL) -> u32;
...
#[cfg(feature = "Win32_Networking_WinSock")]
pub type RasGetEntryPropertiesA = unsafe extern "system" fn(param0: windows_sys::core::PCSTR, param1: windows_sys::core::PCSTR, param2: *mut RASENTRYA, param3: *mut u32, param4: *mut u8, param5: *mut u32) -> u32;
#[cfg(feature = "Win32_Networking_WinSock")]
...
#[cfg(feature = "Win32_Networking_WinSock")]
pub type RasGetEntryPropertiesW = unsafe extern "system" fn(param0: windows_sys::core::PCWSTR, param1: windows_sys::core::PCWSTR, param2: *mut RASENTRYW, param3: *mut u32, param4: *mut u8, param5: *mut u32) -> u32;
#[cfg(feature = "Win32_Networking_WinSock")]
...
pub type RasGetErrorStringA = unsafe extern "system" fn(resourceid: u32, lpszstring: windows_sys::core::PSTR, inbufsize: u32) -> u32;
...
pub type RasGetErrorStringW = unsafe extern "system" fn(resourceid: u32, lpszstring: windows_sys::core::PWSTR, inbufsize: u32) -> u32;
...
pub type RasGetLinkStatistics = unsafe extern "system" fn(hrasconn: HRASCONN, dwsubentry: u32, lpstatistics: *mut RAS_STATS) -> u32;
...
pub type RasGetPCscf = unsafe extern "system" fn(lpszpcscf: windows_sys::core::PWSTR) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasGetPCscf(lpszpcscf : windows_sys::core::PWSTR) -> u32);
pub type RasGetProjectionInfoA = unsafe extern "system" fn(param0: HRASCONN, param1: RASPROJECTION, param2: *mut core::ffi::c_void, param3: *mut u32) -> u32;
...
#[cfg(feature = "Win32_Networking_WinSock")]
pub type RasGetProjectionInfoEx = unsafe extern "system" fn(hrasconn: HRASCONN, prasprojection: *mut RAS_PROJECTION_INFO, lpdwsize: *mut u32) -> u32;
#[cfg(feature = "Win32_Networking_WinSock")]
...
pub type RasGetProjectionInfoW = unsafe extern "system" fn(param0: HRASCONN, param1: RASPROJECTION, param2: *mut core::ffi::c_void, param3: *mut u32) -> u32;
...
pub type RasGetSubEntryHandleA = unsafe extern "system" fn(param0: HRASCONN, param1: u32, param2: *mut HRASCONN) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasGetSubEntryHandleA(param0 : HRASCONN, param1 : u32, param2 : *mut HRASCONN) -> u32);
pub type RasGetSubEntryHandleW = unsafe extern "system" fn(param0: HRASCONN, param1: u32, param2: *mut HRASCONN) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasGetSubEntryHandleW(param0 : HRASCONN, param1 : u32, param2 : *mut HRASCONN) -> u32);
pub type RasGetSubEntryPropertiesA = unsafe extern "system" fn(param0: windows_sys::core::PCSTR, param1: windows_sys::core::PCSTR, param2: u32, param3: *mut RASSUBENTRYA, param4: *mut u32, param5: *mut u8, param6: *mut u32) -> u32;
...
pub type RasGetSubEntryPropertiesW = unsafe extern "system" fn(param0: windows_sys::core::PCWSTR, param1: windows_sys::core::PCWSTR, param2: u32, param3: *mut RASSUBENTRYW, param4: *mut u32, param5: *mut u8, param6: *mut u32) -> u32;
...
pub type RasHangUpA = unsafe extern "system" fn(param0: HRASCONN) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasHangUpA(param0 : HRASCONN) -> u32);
pub type RasHangUpW = unsafe extern "system" fn(param0: HRASCONN) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasHangUpW(param0 : HRASCONN) -> u32);
pub type RasInvokeEapUI = unsafe extern "system" fn(param0: HRASCONN, param1: u32, param2: *const RASDIALEXTENSIONS, param3: super::super::Foundation::HWND) -> u32;
...
pub type RasPhonebookDlgA = unsafe extern "system" fn(lpszphonebook: windows_sys::core::PCSTR, lpszentry: windows_sys::core::PCSTR, lpinfo: *mut RASPBDLGA) -> windows_sys::core::BOOL;
...
pub type RasPhonebookDlgW = unsafe extern "system" fn(lpszphonebook: windows_sys::core::PCWSTR, lpszentry: windows_sys::core::PCWSTR, lpinfo: *mut RASPBDLGW) -> windows_sys::core::BOOL;
...
pub type RasRenameEntryA = unsafe extern "system" fn(param0: windows_sys::core::PCSTR, param1: windows_sys::core::PCSTR, param2: windows_sys::core::PCSTR) -> u32;
...
pub type RasRenameEntryW = unsafe extern "system" fn(param0: windows_sys::core::PCWSTR, param1: windows_sys::core::PCWSTR, param2: windows_sys::core::PCWSTR) -> u32;
...
pub type RasSetAutodialAddressA = unsafe extern "system" fn(param0: windows_sys::core::PCSTR, param1: u32, param2: *const RASAUTODIALENTRYA, param3: u32, param4: u32) -> u32;
...
pub type RasSetAutodialAddressW = unsafe extern "system" fn(param0: windows_sys::core::PCWSTR, param1: u32, param2: *const RASAUTODIALENTRYW, param3: u32, param4: u32) -> u32;
...
pub type RasSetAutodialEnableA = unsafe extern "system" fn(param0: u32, param1: windows_sys::core::BOOL) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasSetAutodialEnableA(param0 : u32, param1 : windows_sys::core::BOOL) -> u32);
pub type RasSetAutodialEnableW = unsafe extern "system" fn(param0: u32, param1: windows_sys::core::BOOL) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasSetAutodialEnableW(param0 : u32, param1 : windows_sys::core::BOOL) -> u32);
pub type RasSetAutodialParamA = unsafe extern "system" fn(param0: u32, param1: *const core::ffi::c_void, param2: u32) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasSetAutodialParamA(param0 : u32, param1 : *const core::ffi::c_void, param2 : u32) -> u32);
pub type RasSetAutodialParamW = unsafe extern "system" fn(param0: u32, param1: *const core::ffi::c_void, param2: u32) -> u32;
windows_link::link!("rasapi32.dll" "system" fn RasSetAutodialParamW(param0 : u32, param1 : *const core::ffi::c_void, param2 : u32) -> u32);
pub type RasSetCredentialsA = unsafe extern "system" fn(param0: windows_sys::core::PCSTR, param1: windows_sys::core::PCSTR, param2: *const RASCREDENTIALSA, param3: windows_sys::core::BOOL) -> u32;
...
pub type RasSetCredentialsW = unsafe extern "system" fn(param0: windows_sys::core::PCWSTR, param1: windows_sys::core::PCWSTR, param2: *const RASCREDENTIALSW, param3: windows_sys::core::BOOL) -> u32;
...
pub type RasSetCustomAuthDataA = unsafe extern "system" fn(pszphonebook: windows_sys::core::PCSTR, pszentry: windows_sys::core::PCSTR, pbcustomauthdata: *const u8, dwsizeofcustomauthdata: u32) -> u32;
...
pub type RasSetCustomAuthDataW = unsafe extern "system" fn(pszphonebook: windows_sys::core::PCWSTR, pszentry: windows_sys::core::PCWSTR, pbcustomauthdata: *const u8, dwsizeofcustomauthdata: u32) -> u32;
...
pub type RasSetEapUserDataA = unsafe extern "system" fn(htoken: super::super::Foundation::HANDLE, pszphonebook: windows_sys::core::PCSTR, pszentry: windows_sys::core::PCSTR, pbeapdata: *const u8, dwsizeofeapdata: u32) -> u32;
...
pub type RasSetEapUserDataW = unsafe extern "system" fn(htoken: super::super::Foundation::HANDLE, pszphonebook: windows_sys::core::PCWSTR, pszentry: windows_sys::core::PCWSTR, pbeapdata: *const u8, dwsizeofeapdata: u32) -> u32;
...
pub type RasSetEntryDialParamsA = unsafe extern "system" fn(param0: windows_sys::core::PCSTR, param1: *const RASDIALPARAMSA, param2: windows_sys::core::BOOL) -> u32;
...
pub type RasSetEntryDialParamsW = unsafe extern "system" fn(param0: windows_sys::core::PCWSTR, param1: *const RASDIALPARAMSW, param2: windows_sys::core::BOOL) -> u32;
...
#[cfg(feature = "Win32_Networking_WinSock")]
pub type RasSetEntryPropertiesA = unsafe extern "system" fn(param0: windows_sys::core::PCSTR, param1: windows_sys::core::PCSTR, param2: *const RASENTRYA, param3: u32, param4: *const u8, param5: u32) -> u32;
#[cfg(feature = "Win32_Networking_WinSock")]
...
#[cfg(feature = "Win32_Networking_WinSock")]
pub type RasSetEntryPropertiesW = unsafe extern "system" fn(param0: windows_sys::core::PCWSTR, param1: windows_sys::core::PCWSTR, param2: *const RASENTRYW, param3: u32, param4: *const u8, param5: u32) -> u32;
#[cfg(feature = "Win32_Networking_WinSock")]
...
pub type RasSetSubEntryPropertiesA = unsafe extern "system" fn(param0: windows_sys::core::PCSTR, param1: windows_sys::core::PCSTR, param2: u32, param3: *const RASSUBENTRYA, param4: u32, param5: *const u8, param6: u32) -> u32;
...
pub type RasSetSubEntryPropertiesW = unsafe extern "system" fn(param0: windows_sys::core::PCWSTR, param1: windows_sys::core::PCWSTR, param2: u32, param3: *const RASSUBENTRYW, param4: u32, param5: *const u8, param6: u32) -> u32;
...
#[cfg(feature = "Win32_Networking_WinSock")]
pub type RasUpdateConnection = unsafe extern "system" fn(hrasconn: HRASCONN, lprasupdateconn: *const RASUPDATECONN) -> u32;
#[cfg(feature = "Win32_Networking_WinSock")]
windows_link::link!("rasapi32.dll" "system" fn RasUpdateConnection(hrasconn : HRASCONN, lprasupdateconn : *const RASUPDATECONN) -> u32);
pub type RasValidateEntryNameA = unsafe extern "system" fn(param0: windows_sys::core::PCSTR, param1: windows_sys::core::PCSTR) -> u32;
...
pub type RasValidateEntryNameW = unsafe extern "system" fn(param0: windows_sys::core::PCWSTR, param1: windows_sys::core::PCWSTR) -> u32;
...
pub type RtmAddNextHop = unsafe extern "system" fn(rtmreghandle: isize, nexthopinfo: *mut RTM_NEXTHOP_INFO, nexthophandle: *mut isize, changeflags: *mut u32) -> u32;
...
pub type RtmAddRouteToDest = unsafe extern "system" fn(rtmreghandle: isize, routehandle: *mut isize, destaddress: *mut RTM_NET_ADDRESS, routeinfo: *mut RTM_ROUTE_INFO, timetolive: u32, routelisthandle: isize, notifytype: u32, notifyhandle: isize, changeflags: *mut u32) -> u32;
...
pub type RtmBlockMethods = unsafe extern "system" fn(rtmreghandle: isize, targethandle: super::super::Foundation::HANDLE, targettype: u8, blockingflag: u32) -> u32;
...
#[cfg(feature = "Win32_Networking_WinSock")]
pub type RtmConvertIpv6AddressAndLengthToNetAddress = unsafe extern "system" fn(pnetaddress: *mut RTM_NET_ADDRESS, address: super::super::Networking::WinSock::IN6_ADDR, dwlength: u32, dwaddresssize: u32) -> u32;
#[cfg(feature = "Win32_Networking_WinSock")]
...
#[cfg(feature = "Win32_Networking_WinSock")]
pub type RtmConvertNetAddressToIpv6AddressAndLength = unsafe extern "system" fn(pnetaddress: *mut RTM_NET_ADDRESS, paddress: *mut super::super::Networking::WinSock::IN6_ADDR, plength: *mut u32, dwaddresssize: u32) -> u32;
#[cfg(feature = "Win32_Networking_WinSock")]
...
pub type RtmCreateDestEnum = unsafe extern "system" fn(rtmreghandle: isize, targetviews: u32, enumflags: u32, netaddress: *mut RTM_NET_ADDRESS, protocolid: u32, rtmenumhandle: *mut isize) -> u32;
...
pub type RtmCreateNextHopEnum = unsafe extern "system" fn(rtmreghandle: isize, enumflags: u32, netaddress: *mut RTM_NET_ADDRESS, rtmenumhandle: *mut isize) -> u32;
...
pub type RtmCreateRouteEnum = unsafe extern "system" fn(rtmreghandle: isize, desthandle: isize, targetviews: u32, enumflags: u32, startdest: *mut RTM_NET_ADDRESS, matchingflags: u32, criteriaroute: *mut RTM_ROUTE_INFO, criteriainterface: u32, rtmenumhandle: *mut isize) -> u32;
...
pub type RtmCreateRouteList = unsafe extern "system" fn(rtmreghandle: isize, routelisthandle: *mut isize) -> u32;
windows_link::link!("rtm.dll" "system" fn RtmCreateRouteList(rtmreghandle : isize, routelisthandle : *mut isize) -> u32);
pub type RtmCreateRouteListEnum = unsafe extern "system" fn(rtmreghandle: isize, routelisthandle: isize, rtmenumhandle: *mut isize) -> u32;
...
pub type RtmDeleteEnumHandle = unsafe extern "system" fn(rtmreghandle: isize, enumhandle: isize) -> u32;
windows_link::link!("rtm.dll" "system" fn RtmDeleteEnumHandle(rtmreghandle : isize, enumhandle : isize) -> u32);
pub type RtmDeleteNextHop = unsafe extern "system" fn(rtmreghandle: isize, nexthophandle: isize, nexthopinfo: *mut RTM_NEXTHOP_INFO) -> u32;
...
pub type RtmDeleteRouteList = unsafe extern "system" fn(rtmreghandle: isize, routelisthandle: isize) -> u32;
windows_link::link!("rtm.dll" "system" fn RtmDeleteRouteList(rtmreghandle : isize, routelisthandle : isize) -> u32);
pub type RtmDeleteRouteToDest = unsafe extern "system" fn(rtmreghandle: isize, routehandle: isize, changeflags: *mut u32) -> u32;
windows_link::link!("rtm.dll" "system" fn RtmDeleteRouteToDest(rtmreghandle : isize, routehandle : isize, changeflags : *mut u32) -> u32);
pub type RtmDeregisterEntity = unsafe extern "system" fn(rtmreghandle: isize) -> u32;
windows_link::link!("rtm.dll" "system" fn RtmDeregisterEntity(rtmreghandle : isize) -> u32);
pub type RtmDeregisterFromChangeNotification = unsafe extern "system" fn(rtmreghandle: isize, notifyhandle: isize) -> u32;
windows_link::link!("rtm.dll" "system" fn RtmDeregisterFromChangeNotification(rtmreghandle : isize, notifyhandle : isize) -> u32);
pub type RtmFindNextHop = unsafe extern "system" fn(rtmreghandle: isize, nexthopinfo: *mut RTM_NEXTHOP_INFO, nexthophandle: *mut isize, nexthoppointer: *mut *mut RTM_NEXTHOP_INFO) -> u32;
...
pub type RtmGetChangeStatus = unsafe extern "system" fn(rtmreghandle: isize, notifyhandle: isize, desthandle: isize, changestatus: *mut windows_sys::core::BOOL) -> u32;
...
pub type RtmGetChangedDests = unsafe extern "system" fn(rtmreghandle: isize, notifyhandle: isize, numdests: *mut u32, changeddests: *mut RTM_DEST_INFO) -> u32;
...
pub type RtmGetDestInfo = unsafe extern "system" fn(rtmreghandle: isize, desthandle: isize, protocolid: u32, targetviews: u32, destinfo: *mut RTM_DEST_INFO) -> u32;
...
pub type RtmGetEntityInfo = unsafe extern "system" fn(rtmreghandle: isize, entityhandle: isize, entityinfo: *mut RTM_ENTITY_INFO) -> u32;
...
pub type RtmGetEntityMethods = unsafe extern "system" fn(rtmreghandle: isize, entityhandle: isize, nummethods: *mut u32, exptmethods: *mut RTM_ENTITY_EXPORT_METHOD) -> u32;
...
pub type RtmGetEnumDests = unsafe extern "system" fn(rtmreghandle: isize, enumhandle: isize, numdests: *mut u32, destinfos: *mut RTM_DEST_INFO) -> u32;
...
pub type RtmGetEnumNextHops = unsafe extern "system" fn(rtmreghandle: isize, enumhandle: isize, numnexthops: *mut u32, nexthophandles: *mut isize) -> u32;
...
pub type RtmGetEnumRoutes = unsafe extern "system" fn(rtmreghandle: isize, enumhandle: isize, numroutes: *mut u32, routehandles: *mut isize) -> u32;
...
pub type RtmGetExactMatchDestination = unsafe extern "system" fn(rtmreghandle: isize, destaddress: *mut RTM_NET_ADDRESS, protocolid: u32, targetviews: u32, destinfo: *mut RTM_DEST_INFO) -> u32;
...
pub type RtmGetExactMatchRoute = unsafe extern "system" fn(rtmreghandle: isize, destaddress: *mut RTM_NET_ADDRESS, matchingflags: u32, routeinfo: *mut RTM_ROUTE_INFO, interfaceindex: u32, targetviews: u32, routehandle: *mut isize) -> u32;
...
pub type RtmGetLessSpecificDestination = unsafe extern "system" fn(rtmreghandle: isize, desthandle: isize, protocolid: u32, targetviews: u32, destinfo: *mut RTM_DEST_INFO) -> u32;
...
pub type RtmGetListEnumRoutes = unsafe extern "system" fn(rtmreghandle: isize, enumhandle: isize, numroutes: *mut u32, routehandles: *mut isize) -> u32;
...
pub type RtmGetMostSpecificDestination = unsafe extern "system" fn(rtmreghandle: isize, destaddress: *mut RTM_NET_ADDRESS, protocolid: u32, targetviews: u32, destinfo: *mut RTM_DEST_INFO) -> u32;
...
pub type RtmGetNextHopInfo = unsafe extern "system" fn(rtmreghandle: isize, nexthophandle: isize, nexthopinfo: *mut RTM_NEXTHOP_INFO) -> u32;
...
pub type RtmGetNextHopPointer = unsafe extern "system" fn(rtmreghandle: isize, nexthophandle: isize, nexthoppointer: *mut *mut RTM_NEXTHOP_INFO) -> u32;
...
pub type RtmGetOpaqueInformationPointer = unsafe extern "system" fn(rtmreghandle: isize, desthandle: isize, opaqueinfopointer: *mut *mut core::ffi::c_void) -> u32;
...
pub type RtmGetRegisteredEntities = unsafe extern "system" fn(rtmreghandle: isize, numentities: *mut u32, entityhandles: *mut isize, entityinfos: *mut RTM_ENTITY_INFO) -> u32;
...
pub type RtmGetRouteInfo = unsafe extern "system" fn(rtmreghandle: isize, routehandle: isize, routeinfo: *mut RTM_ROUTE_INFO, destaddress: *mut RTM_NET_ADDRESS) -> u32;
...
pub type RtmGetRoutePointer = unsafe extern "system" fn(rtmreghandle: isize, routehandle: isize, routepointer: *mut *mut RTM_ROUTE_INFO) -> u32;
...
pub type RtmHoldDestination = unsafe extern "system" fn(rtmreghandle: isize, desthandle: isize, targetviews: u32, holdtime: u32) -> u32;
...
pub type RtmIgnoreChangedDests = unsafe extern "system" fn(rtmreghandle: isize, notifyhandle: isize, numdests: u32, changeddests: *mut isize) -> u32;
...
pub type RtmInsertInRouteList = unsafe extern "system" fn(rtmreghandle: isize, routelisthandle: isize, numroutes: u32, routehandles: *mut isize) -> u32;
...
pub type RtmInvokeMethod = unsafe extern "system" fn(rtmreghandle: isize, entityhandle: isize, input: *mut RTM_ENTITY_METHOD_INPUT, outputsize: *mut u32, output: *mut RTM_ENTITY_METHOD_OUTPUT) -> u32;
...
pub type RtmIsBestRoute = unsafe extern "system" fn(rtmreghandle: isize, routehandle: isize, bestinviews: *mut u32) -> u32;
windows_link::link!("rtm.dll" "system" fn RtmIsBestRoute(rtmreghandle : isize, routehandle : isize, bestinviews : *mut u32) -> u32);
pub type RtmIsMarkedForChangeNotification = unsafe extern "system" fn(rtmreghandle: isize, notifyhandle: isize, desthandle: isize, destmarked: *mut windows_sys::core::BOOL) -> u32;
...
pub type RtmLockDestination = unsafe extern "system" fn(rtmreghandle: isize, desthandle: isize, exclusive: windows_sys::core::BOOL, lockdest: windows_sys::core::BOOL) -> u32;
...
pub type RtmLockNextHop = unsafe extern "system" fn(rtmreghandle: isize, nexthophandle: isize, exclusive: windows_sys::core::BOOL, locknexthop: windows_sys::core::BOOL, nexthoppointer: *mut *mut RTM_NEXTHOP_INFO) -> u32;
...
pub type RtmLockRoute = unsafe extern "system" fn(rtmreghandle: isize, routehandle: isize, exclusive: windows_sys::core::BOOL, lockroute: windows_sys::core::BOOL, routepointer: *mut *mut RTM_ROUTE_INFO) -> u32;
...
pub type RtmMarkDestForChangeNotification = unsafe extern "system" fn(rtmreghandle: isize, notifyhandle: isize, desthandle: isize, markdest: windows_sys::core::BOOL) -> u32;
...
pub type RtmReferenceHandles = unsafe extern "system" fn(rtmreghandle: isize, numhandles: u32, rtmhandles: *mut super::super::Foundation::HANDLE) -> u32;
...
pub type RtmRegisterEntity = unsafe extern "system" fn(rtmentityinfo: *mut RTM_ENTITY_INFO, exportmethods: *mut RTM_ENTITY_EXPORT_METHODS, eventcallback: RTM_EVENT_CALLBACK, reserveopaquepointer: windows_sys::core::BOOL, rtmregprofile: *mut RTM_REGN_PROFILE, rtmreghandle: *mut isize) -> u32;
...
pub type RtmRegisterForChangeNotification = unsafe extern "system" fn(rtmreghandle: isize, targetviews: u32, notifyflags: u32, notifycontext: *mut core::ffi::c_void, notifyhandle: *mut isize) -> u32;
...
pub type RtmReleaseChangedDests = unsafe extern "system" fn(rtmreghandle: isize, notifyhandle: isize, numdests: u32, changeddests: *mut RTM_DEST_INFO) -> u32;
...
pub type RtmReleaseDestInfo = unsafe extern "system" fn(rtmreghandle: isize, destinfo: *mut RTM_DEST_INFO) -> u32;
windows_link::link!("rtm.dll" "system" fn RtmReleaseDestInfo(rtmreghandle : isize, destinfo : *mut RTM_DEST_INFO) -> u32);
pub type RtmReleaseDests = unsafe extern "system" fn(rtmreghandle: isize, numdests: u32, destinfos: *mut RTM_DEST_INFO) -> u32;
windows_link::link!("rtm.dll" "system" fn RtmReleaseDests(rtmreghandle : isize, numdests : u32, destinfos : *mut RTM_DEST_INFO) -> u32);
pub type RtmReleaseEntities = unsafe extern "system" fn(rtmreghandle: isize, numentities: u32, entityhandles: *mut isize) -> u32;
windows_link::link!("rtm.dll" "system" fn RtmReleaseEntities(rtmreghandle : isize, numentities : u32, entityhandles : *mut isize) -> u32);
pub type RtmReleaseEntityInfo = unsafe extern "system" fn(rtmreghandle: isize, entityinfo: *mut RTM_ENTITY_INFO) -> u32;
windows_link::link!("rtm.dll" "system" fn RtmReleaseEntityInfo(rtmreghandle : isize, entityinfo : *mut RTM_ENTITY_INFO) -> u32);
pub type RtmReleaseNextHopInfo = unsafe extern "system" fn(rtmreghandle: isize, nexthopinfo: *mut RTM_NEXTHOP_INFO) -> u32;
windows_link::link!("rtm.dll" "system" fn RtmReleaseNextHopInfo(rtmreghandle : isize, nexthopinfo : *mut RTM_NEXTHOP_INFO) -> u32);
pub type RtmReleaseNextHops = unsafe extern "system" fn(rtmreghandle: isize, numnexthops: u32, nexthophandles: *mut isize) -> u32;
windows_link::link!("rtm.dll" "system" fn RtmReleaseNextHops(rtmreghandle : isize, numnexthops : u32, nexthophandles : *mut isize) -> u32);
pub type RtmReleaseRouteInfo = unsafe extern "system" fn(rtmreghandle: isize, routeinfo: *mut RTM_ROUTE_INFO) -> u32;
windows_link::link!("rtm.dll" "system" fn RtmReleaseRouteInfo(rtmreghandle : isize, routeinfo : *mut RTM_ROUTE_INFO) -> u32);
pub type RtmReleaseRoutes = unsafe extern "system" fn(rtmreghandle: isize, numroutes: u32, routehandles: *mut isize) -> u32;
windows_link::link!("rtm.dll" "system" fn RtmReleaseRoutes(rtmreghandle : isize, numroutes : u32, routehandles : *mut isize) -> u32);
pub type RtmUpdateAndUnlockRoute = unsafe extern "system" fn(rtmreghandle: isize, routehandle: isize, timetolive: u32, routelisthandle: isize, notifytype: u32, notifyhandle: isize, changeflags: *mut u32) -> u32;
