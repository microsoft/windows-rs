...
pub const ALL_SOURCES: MGM_ENUM_TYPES = 1;
pub const ANY_SOURCE: MGM_ENUM_TYPES = 0;
...
pub const MPRDM_DialAll: MPR_INTERFACE_DIAL_MODE = 1;
pub const MPRDM_DialAsNeeded: MPR_INTERFACE_DIAL_MODE = 2;
pub const MPRDM_DialFirst: MPR_INTERFACE_DIAL_MODE = 0;
...
pub type MPR_ET = u32;
pub const MPR_ET_None: MPR_ET = 0;
pub const MPR_ET_Optional: MPR_ET = 3;
pub const MPR_ET_Require: MPR_ET = 1;
pub const MPR_ET_RequireMax: MPR_ET = 2;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub type MPR_VS = u32;
pub const MPR_VS_Default: MPR_VS = 0;
pub const MPR_VS_Ikev2First: u32 = 8;
pub const MPR_VS_Ikev2Only: u32 = 7;
pub const MPR_VS_L2tpFirst: MPR_VS = 4;
pub const MPR_VS_L2tpOnly: MPR_VS = 3;
pub const MPR_VS_PptpFirst: MPR_VS = 2;
pub const MPR_VS_PptpOnly: MPR_VS = 1;
...
pub const PPP_LCP_CHAP: PPP_LCP = 49699;
pub const PPP_LCP_CHAP_MD5: PPP_LCP_INFO_AUTH_DATA = 5;
pub const PPP_LCP_CHAP_MS: PPP_LCP_INFO_AUTH_DATA = 128;
pub const PPP_LCP_CHAP_MSV2: PPP_LCP_INFO_AUTH_DATA = 129;
pub const PPP_LCP_DES_56: u32 = 16;
pub const PPP_LCP_EAP: PPP_LCP = 49703;
...
pub const PPP_LCP_PAP: PPP_LCP = 49187;
pub const PPP_LCP_PFC: u32 = 2;
pub const PPP_LCP_SPAP: PPP_LCP = 49191;
...
pub const RASCSS_Dormant: RASCONNSUBSTATE = 1;
pub const RASCSS_None: RASCONNSUBSTATE = 0;
pub const RASCSS_Reconnected: RASCONNSUBSTATE = 8192;
pub const RASCSS_Reconnecting: RASCONNSUBSTATE = 2;
pub const RASCS_AllDevicesConnected: RASCONNSTATE = 4;
pub const RASCS_ApplySettings: RASCONNSTATE = 24;
pub const RASCS_AuthAck: RASCONNSTATE = 12;
pub const RASCS_AuthCallback: RASCONNSTATE = 8;
pub const RASCS_AuthChangePassword: RASCONNSTATE = 9;
pub const RASCS_AuthLinkSpeed: RASCONNSTATE = 11;
pub const RASCS_AuthNotify: RASCONNSTATE = 6;
pub const RASCS_AuthProject: RASCONNSTATE = 10;
pub const RASCS_AuthRetry: RASCONNSTATE = 7;
pub const RASCS_Authenticate: RASCONNSTATE = 5;
pub const RASCS_Authenticated: RASCONNSTATE = 14;
pub const RASCS_CallbackComplete: RASCONNSTATE = 20;
pub const RASCS_CallbackSetByCaller: RASCONNSTATE = 4098;
pub const RASCS_ConnectDevice: RASCONNSTATE = 2;
pub const RASCS_Connected: RASCONNSTATE = 8192;
pub const RASCS_DONE: u32 = 8192;
pub const RASCS_DeviceConnected: RASCONNSTATE = 3;
pub const RASCS_Disconnected: RASCONNSTATE = 8193;
pub const RASCS_Interactive: RASCONNSTATE = 4096;
pub const RASCS_InvokeEapUI: RASCONNSTATE = 4100;
pub const RASCS_LogonNetwork: RASCONNSTATE = 21;
pub const RASCS_OpenPort: RASCONNSTATE = 0;
pub const RASCS_PAUSED: u32 = 4096;
pub const RASCS_PasswordExpired: RASCONNSTATE = 4099;
pub const RASCS_PortOpened: RASCONNSTATE = 1;
pub const RASCS_PrepareForCallback: RASCONNSTATE = 15;
pub const RASCS_Projected: RASCONNSTATE = 18;
pub const RASCS_ReAuthenticate: RASCONNSTATE = 13;
pub const RASCS_RetryAuthentication: RASCONNSTATE = 4097;
pub const RASCS_StartAuthentication: RASCONNSTATE = 19;
pub const RASCS_SubEntryConnected: RASCONNSTATE = 22;
pub const RASCS_SubEntryDisconnected: RASCONNSTATE = 23;
pub const RASCS_WaitForCallback: RASCONNSTATE = 17;
pub const RASCS_WaitForModemReset: RASCONNSTATE = 16;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const RASEDM_DialAll: RASENTRY_DIAL_MODE = 1;
pub const RASEDM_DialAsNeeded: RASENTRY_DIAL_MODE = 2;
#[repr(C)]
#[cfg(feature = "Win32_Networking_WinSock")]
#[derive(Clone, Copy)]
...
pub const RASIKEv2_FLAGS_BEHIND_NAT: RASIKEV_PROJECTION_INFO_FLAGS = 2;
pub const RASIKEv2_FLAGS_MOBIKESUPPORTED: RASIKEV_PROJECTION_INFO_FLAGS = 1;
pub const RASIKEv2_FLAGS_SERVERBEHIND_NAT: RASIKEV_PROJECTION_INFO_FLAGS = 4;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const RASLCPAD_CHAP_MD5: RASPPP_PROJECTION_INFO_SERVER_AUTH_DATA = 5;
pub const RASLCPAD_CHAP_MS: RASPPP_PROJECTION_INFO_SERVER_AUTH_DATA = 128;
pub const RASLCPAD_CHAP_MSV2: RASPPP_PROJECTION_INFO_SERVER_AUTH_DATA = 129;
pub const RASLCPAP_CHAP: RASPPP_PROJECTION_INFO_SERVER_AUTH_PROTOCOL = 49699;
pub const RASLCPAP_EAP: RASPPP_PROJECTION_INFO_SERVER_AUTH_PROTOCOL = 49703;
pub const RASLCPAP_PAP: RASPPP_PROJECTION_INFO_SERVER_AUTH_PROTOCOL = 49187;
pub const RASLCPAP_SPAP: RASPPP_PROJECTION_INFO_SERVER_AUTH_PROTOCOL = 49191;
...
pub const RASP_Amb: RASPROJECTION = 65536;
pub const RASP_PppCcp: RASPROJECTION = 33021;
pub const RASP_PppIp: RASPROJECTION = 32801;
pub const RASP_PppIpv6: RASPROJECTION = 32855;
pub const RASP_PppIpx: RASPROJECTION = 32811;
pub const RASP_PppLcp: RASPROJECTION = 49185;
pub const RASP_PppNbf: RASPROJECTION = 32831;
...
pub const RAS_FLAGS_ARAP_CONNECTION: RAS_FLAGS = 16;
pub const RAS_FLAGS_DORMANT: RAS_FLAGS = 32;
pub const RAS_FLAGS_IKEV2_CONNECTION: RAS_FLAGS = 16;
pub const RAS_FLAGS_MESSENGER_PRESENT: RAS_FLAGS = 2;
pub const RAS_FLAGS_PPP_CONNECTION: RAS_FLAGS = 1;
pub const RAS_FLAGS_QUARANTINE_PRESENT: RAS_FLAGS = 8;
...
pub const RTM_CHANGE_NOTIFICATION: RTM_EVENT_TYPE = 3;
...
pub const RTM_ENTITY_DEREGISTERED: RTM_EVENT_TYPE = 1;
...
pub const RTM_ENTITY_REGISTERED: RTM_EVENT_TYPE = 0;
...
pub const RTM_ROUTE_EXPIRED: RTM_EVENT_TYPE = 2;
...
pub const SECURITYMSG_ERROR: SECURITY_MESSAGE_MSG_ID = 3;
pub const SECURITYMSG_FAILURE: SECURITY_MESSAGE_MSG_ID = 2;
pub const SECURITYMSG_SUCCESS: SECURITY_MESSAGE_MSG_ID = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
