pub type DnsAcquireContextHandle_A = unsafe extern "system" fn(credentialflags: u32, credentials: *const core::ffi::c_void, pcontext: *mut super::super::Foundation::HANDLE) -> i32;
...
pub type DnsAcquireContextHandle_W = unsafe extern "system" fn(credentialflags: u32, credentials: *const core::ffi::c_void, pcontext: *mut super::super::Foundation::HANDLE) -> i32;
...
pub type DnsCancelQueryRaw = unsafe extern "system" fn(cancelhandle: *const DNS_QUERY_RAW_CANCEL) -> i32;
...
pub type DnsConnectionDeleteProxyInfo = unsafe extern "system" fn(pwszconnectionname: windows_sys::core::PCWSTR, r#type: DNS_CONNECTION_PROXY_TYPE) -> u32;
...
pub type DnsConnectionGetProxyInfo = unsafe extern "system" fn(pwszconnectionname: windows_sys::core::PCWSTR, r#type: DNS_CONNECTION_PROXY_TYPE, pproxyinfo: *mut DNS_CONNECTION_PROXY_INFO) -> u32;
...
pub type DnsConnectionGetProxyInfoForHostUrl = unsafe extern "system" fn(pwszhosturl: windows_sys::core::PCWSTR, pselectioncontext: *const u8, dwselectioncontextlength: u32, dwexplicitinterfaceindex: u32, pproxyinfoex: *mut DNS_CONNECTION_PROXY_INFO_EX) -> u32;
...
pub type DnsConnectionGetProxyInfoForHostUrlEx = unsafe extern "system" fn(pwszhosturl: windows_sys::core::PCWSTR, pselectioncontext: *const u8, dwselectioncontextlength: u32, dwexplicitinterfaceindex: u32, pwszconnectionname: windows_sys::core::PCWSTR, pproxyinfoex: *mut DNS_CONNECTION_PROXY_INFO_EX) -> u32;
...
pub type DnsConnectionGetProxyList = unsafe extern "system" fn(pwszconnectionname: windows_sys::core::PCWSTR, pproxylist: *mut DNS_CONNECTION_PROXY_LIST) -> u32;
...
pub type DnsConnectionSetProxyInfo = unsafe extern "system" fn(pwszconnectionname: windows_sys::core::PCWSTR, r#type: DNS_CONNECTION_PROXY_TYPE, pproxyinfo: *const DNS_CONNECTION_PROXY_INFO) -> u32;
...
pub type DnsFreeProxyName = unsafe extern "system" fn(proxyname: windows_sys::core::PCWSTR);
...
pub type DnsGetProxyInformation = unsafe extern "system" fn(hostname: windows_sys::core::PCWSTR, proxyinformation: *mut DNS_PROXY_INFORMATION, defaultproxyinformation: *mut DNS_PROXY_INFORMATION, completionroutine: DNS_PROXY_COMPLETION_ROUTINE, completioncontext: *const core::ffi::c_void) -> u32;
...
pub type DnsIsFlatRecord = unsafe extern "system" fn(precord: *const DNS_RECORDA, ullflags: u64, pfflat: *mut windows_sys::core::BOOL) -> i32;
...
pub type DnsNameCompare_A = unsafe extern "system" fn(pname1: windows_sys::core::PCSTR, pname2: windows_sys::core::PCSTR) -> windows_sys::core::BOOL;
...
pub type DnsNameCompare_W = unsafe extern "system" fn(pname1: windows_sys::core::PCWSTR, pname2: windows_sys::core::PCWSTR) -> windows_sys::core::BOOL;
...
pub type DnsQueryConfig = unsafe extern "system" fn(config: DNS_CONFIG_TYPE, flag: u32, pwsadaptername: windows_sys::core::PCWSTR, preserved: *const core::ffi::c_void, pbuffer: *mut core::ffi::c_void, pbuflen: *mut u32) -> i32;
...
pub type DnsQueryRaw = unsafe extern "system" fn(queryrequest: *const DNS_QUERY_RAW_REQUEST, cancelhandle: *mut DNS_QUERY_RAW_CANCEL) -> i32;
...
pub type DnsQueryRawResultFree = unsafe extern "system" fn(queryresults: *const DNS_QUERY_RAW_RESULT);
windows_link::link!("dnsapi.dll" "system" fn DnsQueryRawResultFree(queryresults : *const DNS_QUERY_RAW_RESULT));
pub type DnsQuery_A = unsafe extern "system" fn(pszname: windows_sys::core::PCSTR, wtype: u16, options: DNS_QUERY_OPTIONS, pextra: *mut core::ffi::c_void, ppqueryresults: *mut *mut DNS_RECORDA, preserved: *mut *mut core::ffi::c_void) -> super::super::Foundation::WIN32_ERROR;
...
pub type DnsQuery_UTF8 = unsafe extern "system" fn(pszname: windows_sys::core::PCSTR, wtype: u16, options: DNS_QUERY_OPTIONS, pextra: *mut core::ffi::c_void, ppqueryresults: *mut *mut DNS_RECORDA, preserved: *mut *mut core::ffi::c_void) -> super::super::Foundation::WIN32_ERROR;
...
pub type DnsQuery_W = unsafe extern "system" fn(pszname: windows_sys::core::PCWSTR, wtype: u16, options: DNS_QUERY_OPTIONS, pextra: *mut core::ffi::c_void, ppqueryresults: *mut *mut DNS_RECORDA, preserved: *mut *mut core::ffi::c_void) -> super::super::Foundation::WIN32_ERROR;
...
pub type DnsRecordCompare = unsafe extern "system" fn(precord1: *const DNS_RECORDA, precord2: *const DNS_RECORDA) -> windows_sys::core::BOOL;
...
pub type DnsRecordSetCompare = unsafe extern "system" fn(prr1: *mut DNS_RECORDA, prr2: *mut DNS_RECORDA, ppdiff1: *mut *mut DNS_RECORDA, ppdiff2: *mut *mut DNS_RECORDA) -> windows_sys::core::BOOL;
...
pub type DnsServiceConstructInstance = unsafe extern "system" fn(pservicename: windows_sys::core::PCWSTR, phostname: windows_sys::core::PCWSTR, pip4: *const u32, pip6: *const IP6_ADDRESS, wport: u16, wpriority: u16, wweight: u16, dwpropertiescount: u32, keys: *const windows_sys::core::PCWSTR, values: *const windows_sys::core::PCWSTR) -> *mut DNS_SERVICE_INSTANCE;
...
pub type DnsValidateName_A = unsafe extern "system" fn(pszname: windows_sys::core::PCSTR, format: DNS_NAME_FORMAT) -> i32;
windows_link::link!("dnsapi.dll" "system" fn DnsValidateName_A(pszname : windows_sys::core::PCSTR, format : DNS_NAME_FORMAT) -> i32);
pub type DnsValidateName_UTF8 = unsafe extern "system" fn(pszname: windows_sys::core::PCSTR, format: DNS_NAME_FORMAT) -> i32;
windows_link::link!("dnsapi.dll" "system" fn DnsValidateName_UTF8(pszname : windows_sys::core::PCSTR, format : DNS_NAME_FORMAT) -> i32);
pub type DnsValidateName_W = unsafe extern "system" fn(pszname: windows_sys::core::PCWSTR, format: DNS_NAME_FORMAT) -> i32;
windows_link::link!("dnsapi.dll" "system" fn DnsValidateName_W(pszname : windows_sys::core::PCWSTR, format : DNS_NAME_FORMAT) -> i32);
pub type DnsWriteQuestionToBuffer_UTF8 = unsafe extern "system" fn(pdnsbuffer: *mut DNS_MESSAGE_BUFFER, pdwbuffersize: *mut u32, pszname: windows_sys::core::PCSTR, wtype: u16, xid: u16, frecursiondesired: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
...
pub type DnsWriteQuestionToBuffer_W = unsafe extern "system" fn(pdnsbuffer: *mut DNS_MESSAGE_BUFFER, pdwbuffersize: *mut u32, pszname: windows_sys::core::PCWSTR, wtype: u16, xid: u16, frecursiondesired: windows_sys::core::BOOL) -> windows_sys::core::BOOL;
