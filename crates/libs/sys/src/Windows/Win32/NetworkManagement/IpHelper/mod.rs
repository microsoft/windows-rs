...
pub const GAA_FLAG_INCLUDE_ALL_COMPARTMENTS: GET_ADAPTERS_ADDRESSES_FLAGS = 512;
pub const GAA_FLAG_INCLUDE_ALL_INTERFACES: GET_ADAPTERS_ADDRESSES_FLAGS = 256;
pub const GAA_FLAG_INCLUDE_GATEWAYS: GET_ADAPTERS_ADDRESSES_FLAGS = 128;
pub const GAA_FLAG_INCLUDE_PREFIX: GET_ADAPTERS_ADDRESSES_FLAGS = 16;
pub const GAA_FLAG_INCLUDE_TUNNEL_BINDINGORDER: GET_ADAPTERS_ADDRESSES_FLAGS = 1024;
pub const GAA_FLAG_INCLUDE_WINS_INFO: GET_ADAPTERS_ADDRESSES_FLAGS = 64;
pub const GAA_FLAG_SKIP_ANYCAST: GET_ADAPTERS_ADDRESSES_FLAGS = 2;
pub const GAA_FLAG_SKIP_DNS_INFO: u32 = 2048;
pub const GAA_FLAG_SKIP_DNS_SERVER: GET_ADAPTERS_ADDRESSES_FLAGS = 8;
pub const GAA_FLAG_SKIP_FRIENDLY_NAME: GET_ADAPTERS_ADDRESSES_FLAGS = 32;
pub const GAA_FLAG_SKIP_MULTICAST: GET_ADAPTERS_ADDRESSES_FLAGS = 4;
pub const GAA_FLAG_SKIP_UNICAST: GET_ADAPTERS_ADDRESSES_FLAGS = 1;
pub type GET_ADAPTERS_ADDRESSES_FLAGS = u32;
pub const GF_FRAGCACHE: GLOBAL_FILTER = 9;
pub const GF_FRAGMENTS: GLOBAL_FILTER = 2;
pub const GF_STRONGHOST: GLOBAL_FILTER = 8;
...
pub const PFFT_FILTER: PFFRAMETYPE = 1;
pub const PFFT_FRAG: PFFRAMETYPE = 2;
pub const PFFT_SPOOF: PFFRAMETYPE = 3;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const PF_ACTION_DROP: PFFORWARD_ACTION = 1;
pub const PF_ACTION_FORWARD: PFFORWARD_ACTION = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const PF_IPV4: PFADDRESSTYPE = 0;
pub const PF_IPV6: PFADDRESSTYPE = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
