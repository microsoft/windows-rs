...
#[cfg(feature = "wincrypt")]
windows_link::link!("cryptxml.dll" "system" fn CryptXmlSign(hsignature : HCRYPTXML, hkey : super::HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, dwkeyspec : u32, dwflags : u32, dwkeyinfospec : CRYPT_XML_KEYINFO_SPEC, pvkeyinfospec : *const core::ffi::c_void, psignaturemethod : *const CRYPT_XML_ALGORITHM, pcanonicalization : *const CRYPT_XML_ALGORITHM) -> windows_sys::core::HRESULT);
#[cfg(feature = "bcrypt")]
windows_link::link!("cryptxml.dll" "system" fn CryptXmlVerifySignature(hsignature : HCRYPTXML, hkey : super::BCRYPT_KEY_HANDLE, dwflags : u32) -> windows_sys::core::HRESULT);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub struct CRYPT_XML_REFERENCE {
    ...
    pub DigestValue: super::CRYPT_DATA_BLOB,
    pub cTransform: u32,
...
pub struct CRYPT_XML_SIGNATURE {
    ...
    pub SignatureValue: super::CRYPT_DATA_BLOB,
...
#[cfg(feature = "bcrypt")]
pub type CryptXmlDllCreateKey = Option<unsafe extern "system" fn(pencoded: *const CRYPT_XML_BLOB, phkey: *mut super::BCRYPT_KEY_HANDLE) -> windows_sys::core::HRESULT>;
...
#[cfg(feature = "ncrypt")]
pub type CryptXmlDllEncodeKeyValue = Option<unsafe extern "system" fn(hkey: super::NCRYPT_KEY_HANDLE, dwcharset: CRYPT_XML_CHARSET, pvcallbackstate: *mut core::ffi::c_void, pfnwrite: PFN_CRYPT_XML_WRITE_CALLBACK) -> windows_sys::core::HRESULT>;
...
#[cfg(feature = "wincrypt")]
pub type CryptXmlDllSignData = Option<unsafe extern "system" fn(psignaturemethod: *const CRYPT_XML_ALGORITHM, hcryptprovorncryptkey: super::HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, dwkeyspec: u32, pbinput: *const u8, cbinput: u32, pboutput: *mut u8, cboutput: u32, pcbresult: *mut u32) -> windows_sys::core::HRESULT>;
#[cfg(feature = "bcrypt")]
pub type CryptXmlDllVerifySignature = Option<unsafe extern "system" fn(psignaturemethod: *const CRYPT_XML_ALGORITHM, hkey: super::BCRYPT_KEY_HANDLE, pbinput: *const u8, cbinput: u32, pbsignature: *const u8, cbsignature: u32) -> windows_sys::core::HRESULT>;
