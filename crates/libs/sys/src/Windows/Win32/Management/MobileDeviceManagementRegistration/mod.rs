...
::windows_targets::link!("mdmregistration.dll" "system" #[doc = "*Required features: `\"Win32_Management_MobileDeviceManagementRegistration\"`*"] fn RegisterDeviceDualEnrollMmpcUsingAADDeviceCredentials(cchenrollmentid : u32, pszenrollmentid : ::windows_sys::core::PWSTR) -> ::windows_sys::core::HRESULT);
#[cfg(feature = "Win32_Foundation")]
