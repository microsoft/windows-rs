pub type ApplyLocalManagementSyncML = unsafe extern "system" fn(syncmlrequest: windows_sys::core::PCWSTR, syncmlresult: *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type DiscoverManagementService = unsafe extern "system" fn(pszupn: windows_sys::core::PCWSTR, ppmgmtinfo: *mut *mut MANAGEMENT_SERVICE_INFO) -> windows_sys::core::HRESULT;
...
pub type DiscoverManagementServiceEx = unsafe extern "system" fn(pszupn: windows_sys::core::PCWSTR, pszdiscoveryservicecandidate: windows_sys::core::PCWSTR, ppmgmtinfo: *mut *mut MANAGEMENT_SERVICE_INFO) -> windows_sys::core::HRESULT;
...
pub type GetDeviceManagementConfigInfo = unsafe extern "system" fn(providerid: windows_sys::core::PCWSTR, configstringbufferlength: *mut u32, configstring: windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type GetDeviceRegistrationInfo = unsafe extern "system" fn(deviceinformationclass: REGISTRATION_INFORMATION_CLASS, ppdeviceregistrationinfo: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type GetManagementAppHyperlink = unsafe extern "system" fn(cchhyperlink: u32, pszhyperlink: windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type IsDeviceRegisteredWithManagement = unsafe extern "system" fn(pfisdeviceregisteredwithmanagement: *mut windows_sys::core::BOOL, cchupn: u32, pszupn: windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
...
pub type IsManagementRegistrationAllowed = unsafe extern "system" fn(pfismanagementregistrationallowed: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type IsMdmUxWithoutAadAllowed = unsafe extern "system" fn(isenrollmentallowed: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type RegisterDeviceWithLocalManagement = unsafe extern "system" fn(alreadyregistered: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type RegisterDeviceWithManagement = unsafe extern "system" fn(pszupn: windows_sys::core::PCWSTR, ppszmdmserviceuri: windows_sys::core::PCWSTR, ppzsaccesstoken: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type RegisterDeviceWithManagementUsingAADCredentials = unsafe extern "system" fn(usertoken: super::super::Foundation::HANDLE) -> windows_sys::core::HRESULT;
...
pub type RegisterDeviceWithManagementUsingAADDeviceCredentials = unsafe extern "system" fn() -> windows_sys::core::HRESULT;
...
pub type RegisterDeviceWithManagementUsingAADDeviceCredentials2 = unsafe extern "system" fn(mdmapplicationid: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type SetDeviceManagementConfigInfo = unsafe extern "system" fn(providerid: windows_sys::core::PCWSTR, configstring: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
...
pub type SetManagedExternally = unsafe extern "system" fn(ismanagedexternally: windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
...
pub type UnregisterDeviceWithLocalManagement = unsafe extern "system" fn() -> windows_sys::core::HRESULT;
windows_link::link!("mdmlocalmanagement.dll" "system" fn UnregisterDeviceWithLocalManagement() -> windows_sys::core::HRESULT);
pub type UnregisterDeviceWithManagement = unsafe extern "system" fn(enrollmentid: windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT;
