::windows_sys::core::windows_link ! ( "mdmlocalmanagement.dll" ,"system" fn ApplyLocalManagementSyncML ( syncmlrequest : :: windows_sys::core::PCWSTR , syncmlresult : *mut :: windows_sys::core::PWSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "mdmregistration.dll" ,"system" fn DiscoverManagementService ( pszupn : :: windows_sys::core::PCWSTR , ppmgmtinfo : *mut *mut MANAGEMENT_SERVICE_INFO ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "mdmregistration.dll" ,"system" fn DiscoverManagementServiceEx ( pszupn : :: windows_sys::core::PCWSTR , pszdiscoveryservicecandidate : :: windows_sys::core::PCWSTR , ppmgmtinfo : *mut *mut MANAGEMENT_SERVICE_INFO ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "mdmregistration.dll" ,"system" fn GetDeviceManagementConfigInfo ( providerid : :: windows_sys::core::PCWSTR , configstringbufferlength : *mut u32 , configstring : :: windows_sys::core::PWSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "mdmregistration.dll" ,"system" fn GetDeviceRegistrationInfo ( deviceinformationclass : REGISTRATION_INFORMATION_CLASS , ppdeviceregistrationinfo : *mut *mut ::core::ffi::c_void ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "mdmregistration.dll" ,"system" fn GetManagementAppHyperlink ( cchhyperlink : u32 , pszhyperlink : :: windows_sys::core::PWSTR ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "mdmregistration.dll" ,"system" fn IsDeviceRegisteredWithManagement ( pfisdeviceregisteredwithmanagement : *mut super::super::Foundation:: BOOL , cchupn : u32 , pszupn : :: windows_sys::core::PWSTR ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "mdmregistration.dll" ,"system" fn IsManagementRegistrationAllowed ( pfismanagementregistrationallowed : *mut super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "mdmregistration.dll" ,"system" fn IsMdmUxWithoutAadAllowed ( isenrollmentallowed : *mut super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "mdmlocalmanagement.dll" ,"system" fn RegisterDeviceWithLocalManagement ( alreadyregistered : *mut super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "mdmregistration.dll" ,"system" fn RegisterDeviceWithManagement ( pszupn : :: windows_sys::core::PCWSTR , ppszmdmserviceuri : :: windows_sys::core::PCWSTR , ppzsaccesstoken : :: windows_sys::core::PCWSTR ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "mdmregistration.dll" ,"system" fn RegisterDeviceWithManagementUsingAADCredentials ( usertoken : super::super::Foundation:: HANDLE ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "mdmregistration.dll" ,"system" fn RegisterDeviceWithManagementUsingAADDeviceCredentials ( ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "mdmregistration.dll" ,"system" fn RegisterDeviceWithManagementUsingAADDeviceCredentials2 ( mdmapplicationid : :: windows_sys::core::PCWSTR ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "mdmregistration.dll" ,"system" fn SetDeviceManagementConfigInfo ( providerid : :: windows_sys::core::PCWSTR , configstring : :: windows_sys::core::PCWSTR ) -> :: windows_sys::core::HRESULT );
#[cfg(feature = "Win32_Foundation")]
::windows_sys::core::windows_link ! ( "mdmregistration.dll" ,"system" fn SetManagedExternally ( ismanagedexternally : super::super::Foundation:: BOOL ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "mdmlocalmanagement.dll" ,"system" fn UnregisterDeviceWithLocalManagement ( ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::windows_link ! ( "mdmregistration.dll" ,"system" fn UnregisterDeviceWithManagement ( enrollmentid : :: windows_sys::core::PCWSTR ) -> :: windows_sys::core::HRESULT );
