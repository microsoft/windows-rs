...
pub const DRM_ACTIVATE_CANCEL: i32 = 8;
pub const DRM_ACTIVATE_DELAYED: i32 = 64;
pub const DRM_ACTIVATE_GROUPIDENTITY: i32 = 2;
pub const DRM_ACTIVATE_MACHINE: i32 = 1;
pub const DRM_ACTIVATE_SHARED_GROUPIDENTITY: i32 = 32;
...
pub const DRM_AILT_CANCEL: i32 = 4;
pub const DRM_AILT_NONSILENT: i32 = 1;
pub const DRM_AILT_OBTAIN_ALL: i32 = 2;
pub const DRM_AL_CANCEL: i32 = 4;
pub const DRM_AL_FETCHNOADVISORY: i32 = 8;
pub const DRM_AL_NONSILENT: i32 = 1;
pub const DRM_AL_NOPERSIST: i32 = 2;
pub const DRM_AL_NOUI: i32 = 16;
pub const DRM_AUTO_GENERATE_KEY: i32 = 16;
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const DRM_EL_CLIENTLICENSOR: i32 = 128;
pub const DRM_EL_CLIENTLICENSOR_LID: i32 = 256;
pub const DRM_EL_EUL: i32 = 32;
pub const DRM_EL_EUL_LID: i32 = 64;
pub const DRM_EL_EXPIRED: i32 = 4096;
pub const DRM_EL_GROUPIDENTITY: i32 = 2;
pub const DRM_EL_GROUPIDENTITY_LID: i32 = 8;
pub const DRM_EL_GROUPIDENTITY_NAME: i32 = 4;
pub const DRM_EL_ISSUANCELICENSE_TEMPLATE: i32 = 16384;
pub const DRM_EL_ISSUANCELICENSE_TEMPLATE_LID: i32 = 32768;
pub const DRM_EL_ISSUERNAME: i32 = 8192;
pub const DRM_EL_MACHINE: i32 = 1;
pub const DRM_EL_REVOCATIONLIST: i32 = 1024;
pub const DRM_EL_REVOCATIONLIST_LID: i32 = 2048;
...
pub const DRM_LOCKBOXTYPE_NONE: i32 = 0;
pub const DRM_LOCKBOXTYPE_WHITEBOX: i32 = 1;
...
pub const DRM_OWNER_LICENSE_NOPERSIST: i32 = 32;
pub const DRM_REUSE_KEY: i32 = 64;
pub const DRM_SERVER_ISSUANCELICENSE: i32 = 8;
pub const DRM_SERVICE_LOCATION_ENTERPRISE: i32 = 2;
pub const DRM_SERVICE_LOCATION_INTERNET: i32 = 1;
pub const DRM_SERVICE_TYPE_ACTIVATION: i32 = 1;
pub const DRM_SERVICE_TYPE_CERTIFICATION: i32 = 2;
pub const DRM_SERVICE_TYPE_CLIENTLICENSOR: i32 = 8;
pub const DRM_SERVICE_TYPE_PUBLISHING: i32 = 4;
pub const DRM_SERVICE_TYPE_SILENT: i32 = 16;
pub const DRM_SIGN_CANCEL: i32 = 4;
pub const DRM_SIGN_OFFLINE: i32 = 2;
pub const DRM_SIGN_ONLINE: i32 = 1;
