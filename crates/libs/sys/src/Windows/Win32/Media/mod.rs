...
pub const ED_DEVCAP_ATN_READ: TIMECODE_SAMPLE_FLAGS = 5047;
pub const ED_DEVCAP_RTC_READ: TIMECODE_SAMPLE_FLAGS = 5050;
pub const ED_DEVCAP_TIMECODE_READ: TIMECODE_SAMPLE_FLAGS = 4121;
