...
::windows_sys::core::link ! ( "winmm.dll" ,"system" fn timeBeginPeriod ( uperiod : u32 ) -> u32 );
::windows_sys::core::link ! ( "winmm.dll" ,"system" fn timeEndPeriod ( uperiod : u32 ) -> u32 );
::windows_sys::core::link ! ( "winmm.dll" ,"system" fn timeGetDevCaps ( ptc : *mut TIMECAPS , cbtc : u32 ) -> u32 );
::windows_sys::core::link ! ( "winmm.dll" ,"system" fn timeGetSystemTime ( pmmt : *mut MMTIME , cbmmt : u32 ) -> u32 );
::windows_sys::core::link ! ( "winmm.dll" ,"system" fn timeGetTime ( ) -> u32 );
::windows_sys::core::link ! ( "winmm.dll" ,"system" fn timeKillEvent ( utimerid : u32 ) -> u32 );
::windows_sys::core::link ! ( "winmm.dll" ,"system" fn timeSetEvent ( udelay : u32 , uresolution : u32 , fptc : LPTIMECALLBACK , dwuser : usize , fuevent : u32 ) -> u32 );
