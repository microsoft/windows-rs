...
pub struct ALLOCATOR_PROPERTIES_EX {
    ...
    pub PrevSegment: core::mem::ManuallyDrop<*mut core::ffi::c_void>,
...
pub const FramingProp_Ex: FRAMING_PROP = 3;
pub const FramingProp_None: FRAMING_PROP = 1;
pub const FramingProp_Old: FRAMING_PROP = 2;
pub const FramingProp_Uninitialized: FRAMING_PROP = 0;
pub const Framing_Cache_ReadLast: FRAMING_CACHE_OPS = 1;
pub const Framing_Cache_ReadOrig: FRAMING_CACHE_OPS = 2;
pub const Framing_Cache_Update: FRAMING_CACHE_OPS = 0;
pub const Framing_Cache_Write: FRAMING_CACHE_OPS = 3;
...
pub const IOCTL_KS_HANDSHAKE: u32 = 3080223;
...
pub const KSCAMERA_EXTENDEDPROP_BACKGROUNDSEGMENTATION_BLUR: u64 = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const KSCAMERA_EXTENDEDPROP_BACKGROUNDSEGMENTATION_MASK: u64 = 2;
pub const KSCAMERA_EXTENDEDPROP_BACKGROUNDSEGMENTATION_OFF: u64 = 0;
pub const KSCAMERA_EXTENDEDPROP_BACKGROUNDSEGMENTATION_SHALLOWFOCUS: u64 = 4;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const KSCAMERA_EXTENDEDPROP_DIGITALWINDOW_AUTOFACEFRAMING: u64 = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const KSCAMERA_EXTENDEDPROP_DIGITALWINDOW_MANUAL: u64 = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const KSCAMERA_EXTENDEDPROP_EYEGAZECORRECTION_OFF: u64 = 0;
pub const KSCAMERA_EXTENDEDPROP_EYEGAZECORRECTION_ON: u64 = 1;
pub const KSCAMERA_EXTENDEDPROP_EYEGAZECORRECTION_STARE: u64 = 2;
...
pub const KSCAMERA_EXTENDEDPROP_FRAMERATE_THROTTLE_OFF: u64 = 0;
pub const KSCAMERA_EXTENDEDPROP_FRAMERATE_THROTTLE_ON: u64 = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const KSPIN_FLAG_CRITICAL_PROCESSING: u32 = 2;
pub const KSPIN_FLAG_DENY_USERMODE_ACCESS: u32 = 2147483648;
pub const KSPIN_FLAG_DISPATCH_LEVEL_PROCESSING: u32 = 1;
...
pub const KSPIN_FLAG_HYPERCRITICAL_PROCESSING: u32 = 4;
...
pub const KSPROPERTY_NETWORKCAMERACONTROL_NTPINFO_TYPE_CUSTOM: KSPROPERTY_NETWORKCAMERACONTROL_NTPINFO_TYPE = 2;
...
pub const KSSTREAM_READ: u32 = 0;
#[repr(C)]
#[derive(Clone, Debug, PartialEq)]
pub struct KSSTREAM_SEGMENT {
    pub KsInterfaceHandler: core::mem::ManuallyDrop<*mut core::ffi::c_void>,
    pub KsDataTypeHandler: core::mem::ManuallyDrop<*mut core::ffi::c_void>,
...
pub const KSSTREAM_WRITE: u32 = 1;
...
pub const KS_MemoryTypeAnyHost: KS_LogicalMemoryType = 6;
pub const KS_MemoryTypeDeviceHostMapped: KS_LogicalMemoryType = 3;
pub const KS_MemoryTypeDeviceSpecific: KS_LogicalMemoryType = 4;
pub const KS_MemoryTypeDontCare: KS_LogicalMemoryType = 0;
pub const KS_MemoryTypeKernelNonPaged: KS_LogicalMemoryType = 2;
pub const KS_MemoryTypeKernelPaged: KS_LogicalMemoryType = 1;
pub const KS_MemoryTypeUser: KS_LogicalMemoryType = 5;
...
pub const KsAllocatorMode_Kernel: KSALLOCATORMODE = 1;
pub const KsAllocatorMode_User: KSALLOCATORMODE = 0;
pub const KsIoOperation_Read: KSIOOPERATION = 1;
pub const KsIoOperation_Write: KSIOOPERATION = 0;
pub const KsPeekOperation_AddRef: KSPEEKOPERATION = 1;
pub const KsPeekOperation_PeekOnly: KSPEEKOPERATION = 0;
...
pub const PipeState_CompressionUnknown: PIPE_STATE = 3;
pub const PipeState_DontCare: PIPE_STATE = 0;
pub const PipeState_Finalized: PIPE_STATE = 4;
pub const PipeState_RangeFixed: PIPE_STATE = 2;
pub const PipeState_RangeNotFixed: PIPE_STATE = 1;
pub const Pipe_Allocator_FirstPin: PIPE_ALLOCATOR_PLACE = 1;
pub const Pipe_Allocator_LastPin: PIPE_ALLOCATOR_PLACE = 2;
pub const Pipe_Allocator_MiddlePin: PIPE_ALLOCATOR_PLACE = 3;
pub const Pipe_Allocator_None: PIPE_ALLOCATOR_PLACE = 0;
