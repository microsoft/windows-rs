...
windows_link::link!("msdmo.dll" "system" fn DMOGetName(clsiddmo : *mut windows_sys::core::GUID, szname : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
windows_link::link!("msdmo.dll" "system" fn DMOGetTypes(clsiddmo : *mut windows_sys::core::GUID, ulinputtypesrequested : u32, pulinputtypessupplied : *mut u32, pinputtypes : *mut DMO_PARTIAL_MEDIATYPE, uloutputtypesrequested : u32, puloutputtypessupplied : *mut u32, poutputtypes : *mut DMO_PARTIAL_MEDIATYPE) -> windows_sys::core::HRESULT);
windows_link::link!("msdmo.dll" "system" fn DMORegister(szname : windows_sys::core::PCWSTR, clsiddmo : *mut windows_sys::core::GUID, guidcategory : *mut windows_sys::core::GUID, dwflags : u32, cintypes : u32, pintypes : *mut DMO_PARTIAL_MEDIATYPE, couttypes : u32, pouttypes : *mut DMO_PARTIAL_MEDIATYPE) -> windows_sys::core::HRESULT);
...
windows_link::link!("msdmo.dll" "system" fn MoCopyMediaType(pmtdest : *mut DMO_MEDIA_TYPE, pmtsrc : *mut DMO_MEDIA_TYPE) -> windows_sys::core::HRESULT);
...
windows_link::link!("msdmo.dll" "system" fn MoDuplicateMediaType(ppmtdest : *mut *mut DMO_MEDIA_TYPE, pmtsrc : *mut DMO_MEDIA_TYPE) -> windows_sys::core::HRESULT);
