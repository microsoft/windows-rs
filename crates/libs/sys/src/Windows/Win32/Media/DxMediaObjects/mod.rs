pub type DMOEnum = unsafe extern "system" fn(guidcategory: *const windows_sys::core::GUID, dwflags: u32, cintypes: u32, pintypes: *const DMO_PARTIAL_MEDIATYPE, couttypes: u32, pouttypes: *const DMO_PARTIAL_MEDIATYPE, ppenum: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type DMOGetName = unsafe extern "system" fn(clsiddmo: *const windows_sys::core::GUID, szname: windows_sys::core::PWSTR) -> windows_sys::core::HRESULT;
windows_link::link!("msdmo.dll" "system" fn DMOGetName(clsiddmo : *const windows_sys::core::GUID, szname : windows_sys::core::PWSTR) -> windows_sys::core::HRESULT);
...
pub type DMORegister = unsafe extern "system" fn(szname: windows_sys::core::PCWSTR, clsiddmo: *const windows_sys::core::GUID, guidcategory: *const windows_sys::core::GUID, dwflags: u32, cintypes: u32, pintypes: *const DMO_PARTIAL_MEDIATYPE, couttypes: u32, pouttypes: *const DMO_PARTIAL_MEDIATYPE) -> windows_sys::core::HRESULT;
...
windows_link::link!("msdmo.dll" "system" fn MoCopyMediaType(pmtdest : *mut DMO_MEDIA_TYPE, pmtsrc : *const DMO_MEDIA_TYPE) -> windows_sys::core::HRESULT);
pub type MoCreateMediaType = unsafe extern "system" fn(ppmt: *mut *mut DMO_MEDIA_TYPE, cbformat: u32) -> windows_sys::core::HRESULT;
windows_link::link!("msdmo.dll" "system" fn MoCreateMediaType(ppmt : *mut *mut DMO_MEDIA_TYPE, cbformat : u32) -> windows_sys::core::HRESULT);
pub type MoDeleteMediaType = unsafe extern "system" fn(pmt: *mut DMO_MEDIA_TYPE) -> windows_sys::core::HRESULT;
windows_link::link!("msdmo.dll" "system" fn MoDeleteMediaType(pmt : *mut DMO_MEDIA_TYPE) -> windows_sys::core::HRESULT);
...
windows_link::link!("msdmo.dll" "system" fn MoDuplicateMediaType(ppmtdest : *mut *mut DMO_MEDIA_TYPE, pmtsrc : *const DMO_MEDIA_TYPE) -> windows_sys::core::HRESULT);
pub type MoFreeMediaType = unsafe extern "system" fn(pmt: *mut DMO_MEDIA_TYPE) -> windows_sys::core::HRESULT;
windows_link::link!("msdmo.dll" "system" fn MoFreeMediaType(pmt : *mut DMO_MEDIA_TYPE) -> windows_sys::core::HRESULT);
pub type MoInitMediaType = unsafe extern "system" fn(pmt: *mut DMO_MEDIA_TYPE, cbformat: u32) -> windows_sys::core::HRESULT;
windows_link::link!("msdmo.dll" "system" fn MoInitMediaType(pmt : *mut DMO_MEDIA_TYPE, cbformat : u32) -> windows_sys::core::HRESULT);
