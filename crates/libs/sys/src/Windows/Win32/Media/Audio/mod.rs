...
pub const CALLBACK_EVENT: MIDI_WAVE_OPEN_TYPE = 327680;
pub const CALLBACK_FUNCTION: MIDI_WAVE_OPEN_TYPE = 196608;
pub const CALLBACK_NULL: MIDI_WAVE_OPEN_TYPE = 0;
pub const CALLBACK_TASK: MIDI_WAVE_OPEN_TYPE = 131072;
pub const CALLBACK_THREAD: MIDI_WAVE_OPEN_TYPE = 131072;
pub const CALLBACK_TYPEMASK: MIDI_WAVE_OPEN_TYPE = 458752;
...
pub const DEVICE_STATE_ACTIVE: DEVICE_STATE = 1;
pub const DEVICE_STATE_DISABLED: DEVICE_STATE = 2;
pub const DEVICE_STATE_NOTPRESENT: DEVICE_STATE = 4;
pub const DEVICE_STATE_UNPLUGGED: DEVICE_STATE = 8;
...
pub const Full: AudioStateMonitorSoundLevel = 2;
...
pub const Low: AudioStateMonitorSoundLevel = 1;
...
pub const MIDI_IO_STATUS: MIDI_WAVE_OPEN_TYPE = 32;
...
pub const MIXERLINE_COMPONENTTYPE_DST_DIGITAL: MIXERLINE_COMPONENTTYPE = 1;
pub const MIXERLINE_COMPONENTTYPE_DST_FIRST: i32 = 0;
pub const MIXERLINE_COMPONENTTYPE_DST_HEADPHONES: MIXERLINE_COMPONENTTYPE = 5;
pub const MIXERLINE_COMPONENTTYPE_DST_LAST: u32 = 8;
pub const MIXERLINE_COMPONENTTYPE_DST_LINE: MIXERLINE_COMPONENTTYPE = 2;
pub const MIXERLINE_COMPONENTTYPE_DST_MONITOR: MIXERLINE_COMPONENTTYPE = 3;
pub const MIXERLINE_COMPONENTTYPE_DST_SPEAKERS: MIXERLINE_COMPONENTTYPE = 4;
pub const MIXERLINE_COMPONENTTYPE_DST_TELEPHONE: MIXERLINE_COMPONENTTYPE = 6;
pub const MIXERLINE_COMPONENTTYPE_DST_UNDEFINED: MIXERLINE_COMPONENTTYPE = 0;
pub const MIXERLINE_COMPONENTTYPE_DST_VOICEIN: MIXERLINE_COMPONENTTYPE = 8;
pub const MIXERLINE_COMPONENTTYPE_DST_WAVEIN: MIXERLINE_COMPONENTTYPE = 7;
pub const MIXERLINE_COMPONENTTYPE_SRC_ANALOG: MIXERLINE_COMPONENTTYPE = 4106;
pub const MIXERLINE_COMPONENTTYPE_SRC_AUXILIARY: MIXERLINE_COMPONENTTYPE = 4105;
pub const MIXERLINE_COMPONENTTYPE_SRC_COMPACTDISC: MIXERLINE_COMPONENTTYPE = 4101;
pub const MIXERLINE_COMPONENTTYPE_SRC_DIGITAL: MIXERLINE_COMPONENTTYPE = 4097;
pub const MIXERLINE_COMPONENTTYPE_SRC_FIRST: i32 = 4096;
pub const MIXERLINE_COMPONENTTYPE_SRC_LAST: u32 = 4106;
pub const MIXERLINE_COMPONENTTYPE_SRC_LINE: MIXERLINE_COMPONENTTYPE = 4098;
pub const MIXERLINE_COMPONENTTYPE_SRC_MICROPHONE: MIXERLINE_COMPONENTTYPE = 4099;
pub const MIXERLINE_COMPONENTTYPE_SRC_PCSPEAKER: MIXERLINE_COMPONENTTYPE = 4103;
pub const MIXERLINE_COMPONENTTYPE_SRC_SYNTHESIZER: MIXERLINE_COMPONENTTYPE = 4100;
pub const MIXERLINE_COMPONENTTYPE_SRC_TELEPHONE: MIXERLINE_COMPONENTTYPE = 4102;
pub const MIXERLINE_COMPONENTTYPE_SRC_UNDEFINED: MIXERLINE_COMPONENTTYPE = 4096;
pub const MIXERLINE_COMPONENTTYPE_SRC_WAVEOUT: MIXERLINE_COMPONENTTYPE = 4104;
...
pub const Muted: AudioStateMonitorSoundLevel = 0;
...
pub const SND_ALIAS: SND_FLAGS = 65536;
pub const SND_ALIAS_ID: SND_FLAGS = 1114112;
pub const SND_ALIAS_START: u32 = 0;
pub const SND_APPLICATION: SND_FLAGS = 128;
pub const SND_ASYNC: SND_FLAGS = 1;
pub const SND_FILENAME: SND_FLAGS = 131072;
pub type SND_FLAGS = u32;
pub const SND_LOOP: SND_FLAGS = 8;
pub const SND_MEMORY: SND_FLAGS = 4;
pub const SND_NODEFAULT: SND_FLAGS = 2;
pub const SND_NOSTOP: SND_FLAGS = 16;
pub const SND_NOWAIT: SND_FLAGS = 8192;
pub const SND_PURGE: SND_FLAGS = 64;
pub const SND_RESOURCE: SND_FLAGS = 262148;
pub const SND_RING: i32 = 1048576;
pub const SND_SENTRY: SND_FLAGS = 524288;
pub const SND_SYNC: SND_FLAGS = 0;
pub const SND_SYSTEM: SND_FLAGS = 2097152;
...
pub const SpatialAudioHrtfDirectivity_Cardioid: SpatialAudioHrtfDirectivityType = 1;
pub const SpatialAudioHrtfDirectivity_Cone: SpatialAudioHrtfDirectivityType = 2;
pub const SpatialAudioHrtfDirectivity_OmniDirectional: SpatialAudioHrtfDirectivityType = 0;
#[repr(C, packed(1))]
#[derive(Clone, Copy, Default)]
...
pub const SpatialAudioHrtfDistanceDecay_CustomDecay: SpatialAudioHrtfDistanceDecayType = 1;
pub const SpatialAudioHrtfDistanceDecay_NaturalDecay: SpatialAudioHrtfDistanceDecayType = 0;
pub type SpatialAudioHrtfEnvironmentType = i32;
pub const SpatialAudioHrtfEnvironment_Average: SpatialAudioHrtfEnvironmentType = 4;
pub const SpatialAudioHrtfEnvironment_Large: SpatialAudioHrtfEnvironmentType = 2;
pub const SpatialAudioHrtfEnvironment_Medium: SpatialAudioHrtfEnvironmentType = 1;
pub const SpatialAudioHrtfEnvironment_Outdoors: SpatialAudioHrtfEnvironmentType = 3;
pub const SpatialAudioHrtfEnvironment_Small: SpatialAudioHrtfEnvironmentType = 0;
...
pub const WAVE_ALLOWSYNC: MIDI_WAVE_OPEN_TYPE = 2;
...
pub const WAVE_FORMAT_DIRECT: MIDI_WAVE_OPEN_TYPE = 8;
pub const WAVE_FORMAT_DIRECT_QUERY: MIDI_WAVE_OPEN_TYPE = 9;
pub const WAVE_FORMAT_PCM: u32 = 1;
pub const WAVE_FORMAT_QUERY: MIDI_WAVE_OPEN_TYPE = 1;
pub const WAVE_INVALIDFORMAT: u32 = 0;
pub const WAVE_MAPPED: MIDI_WAVE_OPEN_TYPE = 4;
pub const WAVE_MAPPED_DEFAULT_COMMUNICATION_DEVICE: MIDI_WAVE_OPEN_TYPE = 16;
