...
pub type ActivateAudioInterfaceAsync = unsafe extern "system" fn(deviceinterfacepath: windows_sys::core::PCWSTR, riid: *const windows_sys::core::GUID, activationparams: *const super::super::System::Com::StructuredStorage::PROPVARIANT, completionhandler: *mut core::ffi::c_void, activationoperation: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
pub type CoRegisterMessageFilter = unsafe extern "system" fn(lpmessagefilter: *mut core::ffi::c_void, lplpmessagefilter: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateCaptureAudioStateMonitor = unsafe extern "system" fn(audiostatemonitor: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateCaptureAudioStateMonitorForCategory = unsafe extern "system" fn(category: AUDIO_STREAM_CATEGORY, audiostatemonitor: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateCaptureAudioStateMonitorForCategoryAndDeviceId = unsafe extern "system" fn(category: AUDIO_STREAM_CATEGORY, deviceid: windows_sys::core::PCWSTR, audiostatemonitor: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateCaptureAudioStateMonitorForCategoryAndDeviceRole = unsafe extern "system" fn(category: AUDIO_STREAM_CATEGORY, role: ERole, audiostatemonitor: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateRenderAudioStateMonitor = unsafe extern "system" fn(audiostatemonitor: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateRenderAudioStateMonitorForCategory = unsafe extern "system" fn(category: AUDIO_STREAM_CATEGORY, audiostatemonitor: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateRenderAudioStateMonitorForCategoryAndDeviceId = unsafe extern "system" fn(category: AUDIO_STREAM_CATEGORY, deviceid: windows_sys::core::PCWSTR, audiostatemonitor: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type CreateRenderAudioStateMonitorForCategoryAndDeviceRole = unsafe extern "system" fn(category: AUDIO_STREAM_CATEGORY, role: ERole, audiostatemonitor: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type PlaySoundA = unsafe extern "system" fn(pszsound: windows_sys::core::PCSTR, hmod: super::super::Foundation::HMODULE, fdwsound: SND_FLAGS) -> windows_sys::core::BOOL;
...
pub type PlaySoundW = unsafe extern "system" fn(pszsound: windows_sys::core::PCWSTR, hmod: super::super::Foundation::HMODULE, fdwsound: SND_FLAGS) -> windows_sys::core::BOOL;
...
pub type acmDriverAddA = unsafe extern "system" fn(phadid: *mut HACMDRIVERID, hinstmodule: super::super::Foundation::HINSTANCE, lparam: super::super::Foundation::LPARAM, dwpriority: u32, fdwadd: u32) -> u32;
...
pub type acmDriverAddW = unsafe extern "system" fn(phadid: *mut HACMDRIVERID, hinstmodule: super::super::Foundation::HINSTANCE, lparam: super::super::Foundation::LPARAM, dwpriority: u32, fdwadd: u32) -> u32;
...
pub type acmDriverID = unsafe extern "system" fn(hao: HACMOBJ, phadid: *mut HACMDRIVERID, fdwdriverid: u32) -> u32;
...
pub type acmDriverOpen = unsafe extern "system" fn(phad: *mut HACMDRIVER, hadid: HACMDRIVERID, fdwopen: u32) -> u32;
...
pub type acmStreamOpen = unsafe extern "system" fn(phas: *mut HACMSTREAM, had: HACMDRIVER, pwfxsrc: *mut WAVEFORMATEX, pwfxdst: *mut WAVEFORMATEX, pwfltr: *mut WAVEFILTER, dwcallback: usize, dwinstance: usize, fdwopen: u32) -> u32;
...
pub type midiInGetErrorTextA = unsafe extern "system" fn(mmrerror: u32, psztext: windows_sys::core::PSTR, cchtext: u32) -> u32;
windows_link::link!("winmm.dll" "system" fn midiInGetErrorTextA(mmrerror : u32, psztext : windows_sys::core::PSTR, cchtext : u32) -> u32);
pub type midiInGetErrorTextW = unsafe extern "system" fn(mmrerror: u32, psztext: windows_sys::core::PWSTR, cchtext: u32) -> u32;
...
pub type midiOutGetErrorTextA = unsafe extern "system" fn(mmrerror: u32, psztext: windows_sys::core::PSTR, cchtext: u32) -> u32;
windows_link::link!("winmm.dll" "system" fn midiOutGetErrorTextA(mmrerror : u32, psztext : windows_sys::core::PSTR, cchtext : u32) -> u32);
pub type midiOutGetErrorTextW = unsafe extern "system" fn(mmrerror: u32, psztext: windows_sys::core::PWSTR, cchtext: u32) -> u32;
...
pub type mixerOpen = unsafe extern "system" fn(phmx: *mut HMIXER, umxid: u32, dwcallback: usize, dwinstance: usize, fdwopen: u32) -> u32;
...
pub type sndPlaySoundA = unsafe extern "system" fn(pszsound: windows_sys::core::PCSTR, fusound: u32) -> windows_sys::core::BOOL;
windows_link::link!("winmm.dll" "system" fn sndPlaySoundA(pszsound : windows_sys::core::PCSTR, fusound : u32) -> windows_sys::core::BOOL);
pub type sndPlaySoundW = unsafe extern "system" fn(pszsound: windows_sys::core::PCWSTR, fusound: u32) -> windows_sys::core::BOOL;
...
pub type waveInGetErrorTextA = unsafe extern "system" fn(mmrerror: u32, psztext: windows_sys::core::PSTR, cchtext: u32) -> u32;
windows_link::link!("winmm.dll" "system" fn waveInGetErrorTextA(mmrerror : u32, psztext : windows_sys::core::PSTR, cchtext : u32) -> u32);
pub type waveInGetErrorTextW = unsafe extern "system" fn(mmrerror: u32, psztext: windows_sys::core::PWSTR, cchtext: u32) -> u32;
...
pub type waveOutGetErrorTextA = unsafe extern "system" fn(mmrerror: u32, psztext: windows_sys::core::PSTR, cchtext: u32) -> u32;
windows_link::link!("winmm.dll" "system" fn waveOutGetErrorTextA(mmrerror : u32, psztext : windows_sys::core::PSTR, cchtext : u32) -> u32);
pub type waveOutGetErrorTextW = unsafe extern "system" fn(mmrerror: u32, psztext: windows_sys::core::PWSTR, cchtext: u32) -> u32;
