::windows_sys::core::link ! ( "xaudio2_8.dll" ,"system" fn CreateAudioReverb ( ppapo : *mut :: windows_sys::core::IUnknown ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "xaudio2_8.dll" ,"system" fn CreateAudioVolumeMeter ( ppapo : *mut :: windows_sys::core::IUnknown ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "xaudio2_8.dll" ,"cdecl" fn CreateFX ( clsid : *const :: windows_sys::core::GUID , peffect : *mut :: windows_sys::core::IUnknown , pinitdat : *const ::core::ffi::c_void , initdatabytesize : u32 ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "hrtfapo.dll" ,"system" fn CreateHrtfApo ( init : *const HrtfApoInit , xapo : *mut IXAPO ) -> :: windows_sys::core::HRESULT );
::windows_sys::core::link ! ( "xaudio2_8.dll" ,"system" fn XAudio2CreateWithVersionInfo ( ppxaudio2 : *mut IXAudio2 , flags : u32 , xaudio2processor : u32 , ntddiversion : u32 ) -> :: windows_sys::core::HRESULT );
