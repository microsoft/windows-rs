...
pub mod Xml;
::windows_sys::core::link ! ( "quartz.dll" ,"system" fn AMGetErrorTextA ( hr : :: windows_sys::core::HRESULT , pbuffer : :: windows_sys::core::PSTR , maxlen : u32 ) -> u32 );
::windows_sys::core::link ! ( "quartz.dll" ,"system" fn AMGetErrorTextW ( hr : :: windows_sys::core::HRESULT , pbuffer : :: windows_sys::core::PWSTR , maxlen : u32 ) -> u32 );
