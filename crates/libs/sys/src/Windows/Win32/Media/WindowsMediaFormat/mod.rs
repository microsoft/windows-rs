pub type WMCreateBackupRestorer = unsafe extern "system" fn(pcallback: *mut core::ffi::c_void, ppbackup: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WMCreateEditor = unsafe extern "system" fn(ppeditor: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("wmvcore.dll" "system" fn WMCreateEditor(ppeditor : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type WMCreateIndexer = unsafe extern "system" fn(ppindexer: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("wmvcore.dll" "system" fn WMCreateIndexer(ppindexer : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type WMCreateProfileManager = unsafe extern "system" fn(ppprofilemanager: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WMCreateReader = unsafe extern "system" fn(punkcert: *mut core::ffi::c_void, dwrights: u32, ppreader: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WMCreateSyncReader = unsafe extern "system" fn(punkcert: *mut core::ffi::c_void, dwrights: u32, ppsyncreader: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WMCreateWriter = unsafe extern "system" fn(punkcert: *mut core::ffi::c_void, ppwriter: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WMCreateWriterFileSink = unsafe extern "system" fn(ppsink: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("wmvcore.dll" "system" fn WMCreateWriterFileSink(ppsink : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type WMCreateWriterNetworkSink = unsafe extern "system" fn(ppsink: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
...
pub type WMCreateWriterPushSink = unsafe extern "system" fn(ppsink: *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT;
windows_link::link!("wmvcore.dll" "system" fn WMCreateWriterPushSink(ppsink : *mut *mut core::ffi::c_void) -> windows_sys::core::HRESULT);
pub type WMIsContentProtected = unsafe extern "system" fn(pwszfilename: windows_sys::core::PCWSTR, pfisprotected: *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT;
