...
pub struct NET_VALIDATE_PERSISTED_FIELDS {
    ...
    pub BadPasswordTime: super::minwindef::FILETIME,
    pub LockoutTime: super::minwindef::FILETIME,
...
pub struct USER_INFO_2 {
    ...
    pub usri2_logon_hours: super::minwindef::PBYTE,
...
pub struct USER_INFO_22 {
    ...
    pub usri22_logon_hours: super::minwindef::PBYTE,
...
pub struct USER_INFO_3 {
    ...
    pub usri3_logon_hours: super::minwindef::PBYTE,
...
pub struct USER_INFO_4 {
    ...
    pub usri4_logon_hours: super::minwindef::PBYTE,
    ...
    pub usri4_user_sid: super::winnt::PSID,
