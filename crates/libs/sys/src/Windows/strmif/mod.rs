...
pub struct COLORKEY {
    ...
    pub LowColorValue: super::windef::COLORREF,
    pub HighColorValue: super::windef::COLORREF,
}
...
pub struct VMRALLOCATIONINFO {
    ...
    pub lpPixFmt: super::ksmedia::LPDDPIXELFORMAT,
