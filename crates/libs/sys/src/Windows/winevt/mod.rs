#[cfg(feature = "winnt")]
windows_link::link!("wevtapi.dll" "system" fn EvtArchiveExportedLog(session : EVT_HANDLE, logfilepath : windows_sys::core::PCWSTR, locale : super::winnt::LCID, flags : u32) -> windows_sys::core::BOOL);
#[cfg(feature = "winnt")]
...
#[cfg(all(feature = "minwinbase", feature = "minwindef", feature = "winnt"))]
windows_link::link!("wevtapi.dll" "system" fn EvtGetObjectArrayProperty(objectarray : EVT_OBJECT_ARRAY_PROPERTY_HANDLE, propertyid : u32, arrayindex : u32, flags : u32, propertyvaluebuffersize : u32, propertyvaluebuffer : *mut EVT_VARIANT, propertyvaluebufferused : *mut u32) -> windows_sys::core::BOOL);
#[cfg(feature = "winnt")]
windows_link::link!("wevtapi.dll" "system" fn EvtGetObjectArraySize(objectarray : EVT_OBJECT_ARRAY_PROPERTY_HANDLE, objectarraysize : *mut u32) -> windows_sys::core::BOOL);
#[cfg(all(feature = "minwinbase", feature = "minwindef", feature = "winnt"))]
...
#[cfg(feature = "winnt")]
windows_link::link!("wevtapi.dll" "system" fn EvtNext(resultset : EVT_HANDLE, eventssize : u32, events : *mut super::winnt::HANDLE, timeout : u32, flags : u32, returned : *mut u32) -> windows_sys::core::BOOL);
#[cfg(feature = "winnt")]
...
#[cfg(feature = "winnt")]
windows_link::link!("wevtapi.dll" "system" fn EvtOpenPublisherMetadata(session : EVT_HANDLE, publisherid : windows_sys::core::PCWSTR, logfilepath : windows_sys::core::PCWSTR, locale : super::winnt::LCID, flags : u32) -> EVT_HANDLE);
#[cfg(feature = "winnt")]
...
#[cfg(feature = "winnt")]
windows_link::link!("wevtapi.dll" "system" fn EvtSubscribe(session : EVT_HANDLE, signalevent : super::winnt::HANDLE, channelpath : windows_sys::core::PCWSTR, query : windows_sys::core::PCWSTR, bookmark : EVT_HANDLE, context : *mut core::ffi::c_void, callback : EVT_SUBSCRIBE_CALLBACK, flags : u32) -> EVT_HANDLE);
#[cfg(feature = "winnt")]
...
pub union EVT_VARIANT_0 {
    ...
    pub XmlValArr: *mut windows_sys::core::PCWSTR,
}
#[cfg(all(feature = "minwinbase", feature = "minwindef", feature = "winnt"))]
