windows_link::link!("vhfum.dll" "system" fn VhfAsyncOperationComplete(vhfoperationhandle : *mut core::ffi::c_void, completionstatus : super::super::super::Win32::Foundation:: NTSTATUS) -> super::super::super::Win32::Foundation:: NTSTATUS);
windows_link::link!("vhfum.dll" "system" fn VhfCreate(vhfconfig : *mut VHF_CONFIG, vhfhandle : *mut *mut core::ffi::c_void) -> super::super::super::Win32::Foundation:: NTSTATUS);
...
windows_link::link!("vhfum.dll" "system" fn VhfStart(vhfhandle : *mut core::ffi::c_void) -> super::super::super::Win32::Foundation:: NTSTATUS);
