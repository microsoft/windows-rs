...
pub const LockQueueAfdWorkQueueLock: KSPIN_LOCK_QUEUE_NUMBER = 13;
pub const LockQueueBcbLock: KSPIN_LOCK_QUEUE_NUMBER = 14;
pub const LockQueueIoCancelLock: KSPIN_LOCK_QUEUE_NUMBER = 7;
pub const LockQueueIoCompletionLock: KSPIN_LOCK_QUEUE_NUMBER = 11;
pub const LockQueueIoDatabaseLock: KSPIN_LOCK_QUEUE_NUMBER = 10;
pub const LockQueueIoVpbLock: KSPIN_LOCK_QUEUE_NUMBER = 9;
pub const LockQueueMasterLock: KSPIN_LOCK_QUEUE_NUMBER = 5;
pub const LockQueueMaximumLock: KSPIN_LOCK_QUEUE_NUMBER = 17;
pub const LockQueueNonPagedPoolLock: KSPIN_LOCK_QUEUE_NUMBER = 6;
pub const LockQueueNtfsStructLock: KSPIN_LOCK_QUEUE_NUMBER = 12;
pub const LockQueueUnusedSpare0: KSPIN_LOCK_QUEUE_NUMBER = 0;
pub const LockQueueUnusedSpare1: KSPIN_LOCK_QUEUE_NUMBER = 1;
pub const LockQueueUnusedSpare15: KSPIN_LOCK_QUEUE_NUMBER = 15;
pub const LockQueueUnusedSpare16: KSPIN_LOCK_QUEUE_NUMBER = 16;
pub const LockQueueUnusedSpare2: KSPIN_LOCK_QUEUE_NUMBER = 2;
pub const LockQueueUnusedSpare3: KSPIN_LOCK_QUEUE_NUMBER = 3;
pub const LockQueueUnusedSpare8: KSPIN_LOCK_QUEUE_NUMBER = 8;
pub const LockQueueVacbLock: KSPIN_LOCK_QUEUE_NUMBER = 4;
#[repr(C)]
#[derive(Clone, Copy)]
pub struct MDL {
    pub Next: *mut Self,
