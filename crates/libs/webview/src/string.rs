...
pub(crate) fn encode(value: &str) -> Vec<u16> {
...
pub(crate) unsafe fn decode(value: LPCWSTR) -> String {
    if value.is_null() {
        return String::new();
    }
...
pub(crate) unsafe fn take(value: LPWSTR) -> String {
...
pub(crate) unsafe fn allocate(value: &str) -> Result<LPWSTR> {
