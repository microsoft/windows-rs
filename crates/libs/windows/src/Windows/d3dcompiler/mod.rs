...
#[inline]
pub unsafe fn D3DCompile<P2, P4, P5, P6>(psrcdata: *const core::ffi::c_void, srcdatasize: usize, psourcename: P2, pdefines: Option<*const super::d3dcommon::D3D_SHADER_MACRO>, pinclude: P4, pentrypoint: P5, ptarget: P6, flags1: u32, flags2: u32, ppcode: *mut Option<super::d3dcommon::ID3D10Blob>, pperrormsgs: *mut Option<super::d3dcommon::ID3D10Blob>) -> windows_core::HRESULT
where
...
#[cfg(feature = "d3dcommon")]
#[inline]
pub unsafe fn D3DCompile2<P2, P4, P5, P6>(psrcdata: *const core::ffi::c_void, srcdatasize: usize, psourcename: P2, pdefines: Option<*const super::d3dcommon::D3D_SHADER_MACRO>, pinclude: P4, pentrypoint: P5, ptarget: P6, flags1: u32, flags2: u32, secondarydataflags: u32, psecondarydata: Option<*const core::ffi::c_void>, secondarydatasize: usize, ppcode: *mut Option<super::d3dcommon::ID3D10Blob>, pperrormsgs: *mut Option<super::d3dcommon::ID3D10Blob>) -> windows_core::HRESULT
where
    P2: windows_core::Param<windows_core::PCSTR>,
    P4: windows_core::Param<super::d3dcommon::ID3DInclude>,
    P5: windows_core::Param<windows_core::PCSTR>,
...
#[cfg(feature = "d3dcommon")]
#[inline]
pub unsafe fn D3DCompileFromFile<P0, P2, P3, P4>(pfilename: P0, pdefines: Option<*const super::d3dcommon::D3D_SHADER_MACRO>, pinclude: P2, pentrypoint: P3, ptarget: P4, flags1: u32, flags2: u32, ppcode: *mut Option<super::d3dcommon::ID3D10Blob>, pperrormsgs: *mut Option<super::d3dcommon::ID3D10Blob>) -> windows_core::HRESULT
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<super::d3dcommon::ID3DInclude>,
...
#[cfg(feature = "d3dcommon")]
#[inline]
pub unsafe fn D3DCompressShaders(pshaderdata: &[D3D_SHADER_DATA], uflags: u32) -> windows_core::Result<super::d3dcommon::ID3D10Blob> {
...
#[cfg(feature = "d3dcommon")]
#[inline]
pub unsafe fn D3DCreateBlob(size: usize) -> windows_core::Result<super::d3dcommon::ID3D10Blob> {
...
#[cfg(feature = "d3dcommon")]
#[inline]
pub unsafe fn D3DDecompressShaders(psrcdata: *const core::ffi::c_void, srcdatasize: usize, unumshaders: u32, ustartindex: u32, pindices: Option<*const u32>, uflags: u32, ppshaders: *mut Option<super::d3dcommon::ID3D10Blob>, ptotalshaders: Option<*mut u32>) -> windows_core::HRESULT {
    windows_core::link!("d3dcompiler_47.dll" "system" fn D3DDecompressShaders(psrcdata : *const core::ffi::c_void, srcdatasize : usize, unumshaders : u32, ustartindex : u32, pindices : *const u32, uflags : u32, ppshaders : *mut *mut core::ffi::c_void, ptotalshaders : *mut u32) -> windows_core::HRESULT);
...
#[cfg(feature = "d3dcommon")]
#[inline]
pub unsafe fn D3DDisassemble<P3>(psrcdata: *const core::ffi::c_void, srcdatasize: usize, flags: u32, szcomments: P3) -> windows_core::Result<super::d3dcommon::ID3D10Blob>
where
    P3: windows_core::Param<windows_core::PCSTR>,
{
...
#[cfg(feature = "d3dcommon")]
#[inline]
pub unsafe fn D3DDisassembleRegion<P3>(psrcdata: *const core::ffi::c_void, srcdatasize: usize, flags: u32, szcomments: P3, startbyteoffset: usize, numinsts: usize, pfinishbyteoffset: Option<*mut usize>, ppdisassembly: *mut Option<super::d3dcommon::ID3D10Blob>) -> windows_core::HRESULT
where
    P3: windows_core::Param<windows_core::PCSTR>,
{
...
#[cfg(feature = "d3dcommon")]
#[inline]
pub unsafe fn D3DGetBlobPart(psrcdata: *const core::ffi::c_void, srcdatasize: usize, part: D3D_BLOB_PART, flags: u32) -> windows_core::Result<super::d3dcommon::ID3D10Blob> {
...
#[cfg(feature = "d3dcommon")]
#[inline]
pub unsafe fn D3DGetDebugInfo(psrcdata: *const core::ffi::c_void, srcdatasize: usize) -> windows_core::Result<super::d3dcommon::ID3D10Blob> {
...
#[cfg(feature = "d3dcommon")]
#[inline]
pub unsafe fn D3DGetInputAndOutputSignatureBlob(psrcdata: *const core::ffi::c_void, srcdatasize: usize) -> windows_core::Result<super::d3dcommon::ID3D10Blob> {
...
#[cfg(feature = "d3dcommon")]
#[inline]
pub unsafe fn D3DGetInputSignatureBlob(psrcdata: *const core::ffi::c_void, srcdatasize: usize) -> windows_core::Result<super::d3dcommon::ID3D10Blob> {
...
#[cfg(feature = "d3dcommon")]
#[inline]
pub unsafe fn D3DGetOutputSignatureBlob(psrcdata: *const core::ffi::c_void, srcdatasize: usize) -> windows_core::Result<super::d3dcommon::ID3D10Blob> {
...
#[cfg(feature = "d3dcommon")]
#[inline]
pub unsafe fn D3DPreprocess<P2, P4>(psrcdata: *const core::ffi::c_void, srcdatasize: usize, psourcename: P2, pdefines: Option<*const super::d3dcommon::D3D_SHADER_MACRO>, pinclude: P4, ppcodetext: *mut Option<super::d3dcommon::ID3D10Blob>, pperrormsgs: *mut Option<super::d3dcommon::ID3D10Blob>) -> windows_core::HRESULT
where
    P2: windows_core::Param<windows_core::PCSTR>,
    P4: windows_core::Param<super::d3dcommon::ID3DInclude>,
{
    windows_core::link!("d3dcompiler_47.dll" "system" fn D3DPreprocess(psrcdata : *const core::ffi::c_void, srcdatasize : usize, psourcename : windows_core::PCSTR, pdefines : *const super::d3dcommon::D3D_SHADER_MACRO, pinclude : *mut core::ffi::c_void, ppcodetext : *mut *mut core::ffi::c_void, pperrormsgs : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
...
#[cfg(feature = "d3dcommon")]
#[inline]
pub unsafe fn D3DReadFileToBlob<P0>(pfilename: P0) -> windows_core::Result<super::d3dcommon::ID3D10Blob>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn D3DReflect(psrcdata: *const core::ffi::c_void, srcdatasize: usize, pinterface: *const windows_core::GUID, ppreflector: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
    windows_core::link!("d3dcompiler_47.dll" "system" fn D3DReflect(psrcdata : *const core::ffi::c_void, srcdatasize : usize, pinterface : *const windows_core::GUID, ppreflector : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
...
#[cfg(feature = "d3dcommon")]
#[inline]
pub unsafe fn D3DSetBlobPart(psrcdata: *const core::ffi::c_void, srcdatasize: usize, part: D3D_BLOB_PART, flags: u32, ppart: *const core::ffi::c_void, partsize: usize) -> windows_core::Result<super::d3dcommon::ID3D10Blob> {
...
#[cfg(feature = "d3dcommon")]
#[inline]
pub unsafe fn D3DStripShader(pshaderbytecode: *const core::ffi::c_void, bytecodelength: usize, ustripflags: u32) -> windows_core::Result<super::d3dcommon::ID3D10Blob> {
...
where
    P0: windows_core::Param<super::d3dcommon::ID3D10Blob>,
...
#[cfg(feature = "d3dcommon")]
pub type pD3DCompile = Option<unsafe extern "system" fn(psrcdata: *const core::ffi::c_void, srcdatasize: usize, pfilename: windows_core::PCSTR, pdefines: *const super::d3dcommon::D3D_SHADER_MACRO, pinclude: windows_core::Ref<super::d3dcommon::ID3DInclude>, pentrypoint: windows_core::PCSTR, ptarget: windows_core::PCSTR, flags1: u32, flags2: u32, ppcode: windows_core::OutRef<super::d3dcommon::ID3D10Blob>, pperrormsgs: windows_core::OutRef<super::d3dcommon::ID3D10Blob>) -> windows_core::HRESULT>;
#[cfg(feature = "d3dcommon")]
pub type pD3DDisassemble = Option<unsafe extern "system" fn(psrcdata: *const core::ffi::c_void, srcdatasize: usize, flags: u32, szcomments: windows_core::PCSTR, ppdisassembly: windows_core::OutRef<super::d3dcommon::ID3D10Blob>) -> windows_core::HRESULT>;
#[cfg(feature = "d3dcommon")]
pub type pD3DPreprocess = Option<unsafe extern "system" fn(psrcdata: *const core::ffi::c_void, srcdatasize: usize, pfilename: windows_core::PCSTR, pdefines: *const super::d3dcommon::D3D_SHADER_MACRO, pinclude: windows_core::Ref<super::d3dcommon::ID3DInclude>, ppcodetext: windows_core::OutRef<super::d3dcommon::ID3D10Blob>, pperrormsgs: windows_core::OutRef<super::d3dcommon::ID3D10Blob>) -> windows_core::HRESULT>;
