...
impl IOleCommandTarget_Vtbl {
    pub const fn new<Identity: IOleCommandTarget_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Exec<Identity: IOleCommandTarget_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pguidcmdgroup: *const windows_core::GUID, ncmdid: u32, ncmdexecopt: u32, pvain: *const super::oaidl::VARIANT, pvaout: *mut super::oaidl::VARIANT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait IOleDocumentView_Impl: windows_core::IUnknownImpl {
    ...
    fn SetRect(&self, prcview: *const super::windef::RECT) -> windows_core::Result<()>;
    fn GetRect(&self) -> windows_core::Result<super::windef::RECT>;
    fn SetRectComplex(&self, prcview: *const super::windef::RECT, prchscroll: *const super::windef::RECT, prcvscroll: *const super::windef::RECT, prcsizebox: *const super::windef::RECT) -> windows_core::Result<()>;
    ...
    fn SaveViewState(&self, pstm: windows_core::Ref<super::objidlbase::IStream>) -> windows_core::Result<()>;
...
impl IOleDocumentView_Vtbl {
    pub const fn new<Identity: IOleDocumentView_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn SetRect<Identity: IOleDocumentView_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, prcview: *const super::windef::RECT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IOleDocumentView_Impl::SetRect(this, core::mem::transmute_copy(&prcview)).into()
            }
        }
        unsafe extern "system" fn GetRect<Identity: IOleDocumentView_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, prcview: *mut super::windef::RECT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetRectComplex<Identity: IOleDocumentView_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, prcview: *const super::windef::RECT, prchscroll: *const super::windef::RECT, prcvscroll: *const super::windef::RECT, prcsizebox: *const super::windef::RECT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IPrint_Vtbl {
    pub const fn new<Identity: IPrint_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Print<Identity: IPrint_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, grfflags: u32, pptd: *mut *mut super::objidl::DVTARGETDEVICE, pppageset: *mut *mut PAGESET, pstgmoptions: *mut super::objidl::STGMEDIUM, pcallback: *mut core::ffi::c_void, nfirstpage: i32, pcpagesprinted: *mut i32, pnlastpage: *mut i32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IProtectedModeMenuServices_Vtbl {
    pub const fn new<Identity: IProtectedModeMenuServices_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn LoadMenu<Identity: IProtectedModeMenuServices_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pszmodulename: windows_core::PCWSTR, pszmenuname: windows_core::PCWSTR, phmenu: *mut super::windef::HMENU) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn LoadMenuID<Identity: IProtectedModeMenuServices_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pszmodulename: windows_core::PCWSTR, wresourceid: u16, phmenu: *mut super::windef::HMENU) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
