...
impl ICompositionCapabilitiesInteropFactory {
    ...
    pub unsafe fn GetForWindow(&self, hwnd: super::windef::HWND) -> windows_core::Result<super::UI::Composition::ICompositionCapabilities> {
        unsafe {
...
pub struct ICompositionCapabilitiesInteropFactory_Vtbl {
    ...
    #[cfg(all(feature = "UI_Composition", feature = "windef"))]
    pub GetForWindow: unsafe extern "system" fn(*mut core::ffi::c_void, super::windef::HWND, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
...
pub trait ICompositionCapabilitiesInteropFactory_Impl: windows_core::IUnknownImpl {
    fn GetForWindow(&self, hwnd: super::windef::HWND) -> windows_core::Result<super::UI::Composition::ICompositionCapabilities>;
}
#[cfg(all(feature = "UI_Composition", feature = "windef"))]
impl ICompositionCapabilitiesInteropFactory_Vtbl {
    pub const fn new<Identity: ICompositionCapabilitiesInteropFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetForWindow<Identity: ICompositionCapabilitiesInteropFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hwnd: super::windef::HWND, result: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
...
impl ICompositionDrawingSurfaceInterop {
    ...
    #[cfg(feature = "windef")]
    pub unsafe fn Resize(&self, sizepixels: super::windef::SIZE) -> windows_core::HRESULT {
...
pub struct ICompositionDrawingSurfaceInterop_Vtbl {
    ...
    #[cfg(feature = "windef")]
    pub Resize: unsafe extern "system" fn(*mut core::ffi::c_void, super::windef::SIZE) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    Resize: usize,
    #[cfg(feature = "windef")]
...
pub trait ICompositionDrawingSurfaceInterop_Impl: windows_core::IUnknownImpl {
    ...
    fn Resize(&self, sizepixels: &super::windef::SIZE) -> windows_core::Result<()>;
...
impl ICompositionDrawingSurfaceInterop_Vtbl {
    pub const fn new<Identity: ICompositionDrawingSurfaceInterop_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn BeginDraw<Identity: ICompositionDrawingSurfaceInterop_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, updaterect: *const super::windef::RECT, iid: *const windows_core::GUID, updateobject: *mut *mut core::ffi::c_void, updateoffset: *mut super::windef::POINT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Resize<Identity: ICompositionDrawingSurfaceInterop_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, sizepixels: super::windef::SIZE) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ICompositionDrawingSurfaceInterop_Impl::Resize(this, core::mem::transmute(&sizepixels)).into()
            }
        }
        unsafe extern "system" fn Scroll<Identity: ICompositionDrawingSurfaceInterop_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, scrollrect: *const super::windef::RECT, cliprect: *const super::windef::RECT, offsetx: i32, offsety: i32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ICompositionDrawingSurfaceInterop2 {
    #[cfg(feature = "windef")]
    pub unsafe fn CopySurface<P0>(&self, destinationresource: P0, destinationoffsetx: i32, destinationoffsety: i32, sourcerectangle: Option<*const super::windef::RECT>) -> windows_core::HRESULT
    where
...
pub struct ICompositionDrawingSurfaceInterop2_Vtbl {
    ...
    #[cfg(feature = "windef")]
    pub CopySurface: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, i32, i32, *const super::windef::RECT) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    CopySurface: usize,
}
#[cfg(feature = "windef")]
pub trait ICompositionDrawingSurfaceInterop2_Impl: ICompositionDrawingSurfaceInterop_Impl {
    fn CopySurface(&self, destinationresource: windows_core::Ref<windows_core::IUnknown>, destinationoffsetx: i32, destinationoffsety: i32, sourcerectangle: *const super::windef::RECT) -> windows_core::Result<()>;
}
#[cfg(feature = "windef")]
impl ICompositionDrawingSurfaceInterop2_Vtbl {
    pub const fn new<Identity: ICompositionDrawingSurfaceInterop2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CopySurface<Identity: ICompositionDrawingSurfaceInterop2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, destinationresource: *mut core::ffi::c_void, destinationoffsetx: i32, destinationoffsety: i32, sourcerectangle: *const super::windef::RECT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ICompositorDesktopInterop {
    ...
    pub unsafe fn CreateDesktopWindowTarget(&self, hwndtarget: super::windef::HWND, istopmost: bool) -> windows_core::Result<super::UI::Composition::Desktop::IDesktopWindowTarget> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub struct ICompositorDesktopInterop_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(all(feature = "UI_Composition_Desktop", feature = "windef"))]
    pub CreateDesktopWindowTarget: unsafe extern "system" fn(*mut core::ffi::c_void, super::windef::HWND, windows_core::BOOL, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
...
pub trait ICompositorDesktopInterop_Impl: windows_core::IUnknownImpl {
    fn CreateDesktopWindowTarget(&self, hwndtarget: super::windef::HWND, istopmost: windows_core::BOOL) -> windows_core::Result<super::UI::Composition::Desktop::IDesktopWindowTarget>;
...
impl ICompositorDesktopInterop_Vtbl {
    pub const fn new<Identity: ICompositorDesktopInterop_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateDesktopWindowTarget<Identity: ICompositorDesktopInterop_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hwndtarget: super::windef::HWND, istopmost: windows_core::BOOL, result: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ICompositorInterop {
    ...
    pub unsafe fn CreateCompositionSurfaceForHandle(&self, swapchain: super::winnt::HANDLE) -> windows_core::Result<super::UI::Composition::ICompositionSurface> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateCompositionSurfaceForSwapChain<P0>(&self, swapchain: P0) -> windows_core::Result<super::UI::Composition::ICompositionSurface>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
    ...
    #[cfg(feature = "UI_Composition")]
    pub unsafe fn CreateGraphicsDevice<P0>(&self, renderingdevice: P0) -> windows_core::Result<super::UI::Composition::ICompositionGraphicsDevice>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
...
pub struct ICompositorInterop_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(all(feature = "UI_Composition", feature = "winnt"))]
    pub CreateCompositionSurfaceForHandle: unsafe extern "system" fn(*mut core::ffi::c_void, super::winnt::HANDLE, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
...
pub trait ICompositorInterop_Impl: windows_core::IUnknownImpl {
    fn CreateCompositionSurfaceForHandle(&self, swapchain: super::winnt::HANDLE) -> windows_core::Result<super::UI::Composition::ICompositionSurface>;
    fn CreateCompositionSurfaceForSwapChain(&self, swapchain: windows_core::Ref<windows_core::IUnknown>) -> windows_core::Result<super::UI::Composition::ICompositionSurface>;
    fn CreateGraphicsDevice(&self, renderingdevice: windows_core::Ref<windows_core::IUnknown>) -> windows_core::Result<super::UI::Composition::ICompositionGraphicsDevice>;
}
#[cfg(all(feature = "UI_Composition", feature = "winnt"))]
impl ICompositorInterop_Vtbl {
    pub const fn new<Identity: ICompositorInterop_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateCompositionSurfaceForHandle<Identity: ICompositorInterop_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, swapchain: super::winnt::HANDLE, result: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ICompositorInterop2 {
    ...
    #[cfg(feature = "UI_Composition")]
    pub unsafe fn CreateCompositionTexture<P0>(&self, d3dtexture: P0) -> windows_core::Result<super::UI::Composition::ICompositionTexture>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
...
pub trait ICompositorInterop2_Impl: windows_core::IUnknownImpl {
    ...
    fn CreateCompositionTexture(&self, d3dtexture: windows_core::Ref<windows_core::IUnknown>) -> windows_core::Result<super::UI::Composition::ICompositionTexture>;
}
#[cfg(feature = "UI_Composition")]
...
impl IDesktopWindowTargetInterop {
    #[cfg(feature = "windef")]
    pub unsafe fn get_Hwnd(&self) -> windows_core::Result<super::windef::HWND> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub struct IDesktopWindowTargetInterop_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "windef")]
    pub get_Hwnd: unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::windef::HWND) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    get_Hwnd: usize,
}
#[cfg(feature = "windef")]
pub trait IDesktopWindowTargetInterop_Impl: windows_core::IUnknownImpl {
    fn get_Hwnd(&self) -> windows_core::Result<super::windef::HWND>;
}
#[cfg(feature = "windef")]
impl IDesktopWindowTargetInterop_Vtbl {
    pub const fn new<Identity: IDesktopWindowTargetInterop_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn get_Hwnd<Identity: IDesktopWindowTargetInterop_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: *mut super::windef::HWND) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IVisualInteractionSourceInterop {
    ...
    pub unsafe fn TryRedirectForManipulation(&self, pointerinfo: *const super::winuser::POINTER_INFO) -> windows_core::HRESULT {
...
pub struct IVisualInteractionSourceInterop_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(all(feature = "windef", feature = "winnt", feature = "winuser"))]
    pub TryRedirectForManipulation: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::winuser::POINTER_INFO) -> windows_core::HRESULT,
...
pub trait IVisualInteractionSourceInterop_Impl: windows_core::IUnknownImpl {
    fn TryRedirectForManipulation(&self, pointerinfo: *const super::winuser::POINTER_INFO) -> windows_core::Result<()>;
}
#[cfg(all(feature = "windef", feature = "winnt", feature = "winuser"))]
impl IVisualInteractionSourceInterop_Vtbl {
    pub const fn new<Identity: IVisualInteractionSourceInterop_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn TryRedirectForManipulation<Identity: IVisualInteractionSourceInterop_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pointerinfo: *const super::winuser::POINTER_INFO) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
