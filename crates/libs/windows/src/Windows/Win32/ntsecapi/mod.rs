#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AuditComputeEffectivePolicyBySid(psid: super::PSID, psubcategoryguids: &[windows_core::GUID], ppauditpolicy: *mut PAUDIT_POLICY_INFORMATION) -> bool {
    windows_core::link!("advapi32.dll" "system" fn AuditComputeEffectivePolicyBySid(psid : super::PSID, psubcategoryguids : *const windows_core::GUID, dwpolicycount : u32, ppauditpolicy : *mut PAUDIT_POLICY_INFORMATION) -> bool);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AuditComputeEffectivePolicyByToken(htokenhandle: super::HANDLE, psubcategoryguids: &[windows_core::GUID], ppauditpolicy: *mut PAUDIT_POLICY_INFORMATION) -> bool {
    windows_core::link!("advapi32.dll" "system" fn AuditComputeEffectivePolicyByToken(htokenhandle : super::HANDLE, psubcategoryguids : *const windows_core::GUID, dwpolicycount : u32, ppauditpolicy : *mut PAUDIT_POLICY_INFORMATION) -> bool);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AuditQueryGlobalSaclA<P0>(objecttypename: P0, acl: *mut super::PACL) -> bool
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_core::link!("advapi32.dll" "system" fn AuditQueryGlobalSaclA(objecttypename : windows_core::PCSTR, acl : *mut super::PACL) -> bool);
    unsafe { AuditQueryGlobalSaclA(objecttypename.param().abi(), acl as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AuditQueryGlobalSaclW<P0>(objecttypename: P0, acl: *mut super::PACL) -> bool
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("advapi32.dll" "system" fn AuditQueryGlobalSaclW(objecttypename : windows_core::PCWSTR, acl : *mut super::PACL) -> bool);
    unsafe { AuditQueryGlobalSaclW(objecttypename.param().abi(), acl as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AuditQueryPerUserPolicy(psid: super::PSID, psubcategoryguids: &[windows_core::GUID], ppauditpolicy: *mut PAUDIT_POLICY_INFORMATION) -> bool {
    windows_core::link!("advapi32.dll" "system" fn AuditQueryPerUserPolicy(psid : super::PSID, psubcategoryguids : *const windows_core::GUID, dwpolicycount : u32, ppauditpolicy : *mut PAUDIT_POLICY_INFORMATION) -> bool);
    unsafe { AuditQueryPerUserPolicy(psid, psubcategoryguids.as_ptr(), psubcategoryguids.len().try_into().unwrap(), ppauditpolicy as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AuditQuerySecurity(securityinformation: super::SECURITY_INFORMATION, ppsecuritydescriptor: *mut super::PSECURITY_DESCRIPTOR) -> bool {
    windows_core::link!("advapi32.dll" "system" fn AuditQuerySecurity(securityinformation : super::SECURITY_INFORMATION, ppsecuritydescriptor : *mut super::PSECURITY_DESCRIPTOR) -> bool);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AuditSetGlobalSaclA<P0>(objecttypename: P0, acl: Option<*const super::ACL>) -> bool
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_core::link!("advapi32.dll" "system" fn AuditSetGlobalSaclA(objecttypename : windows_core::PCSTR, acl : *const super::ACL) -> bool);
    unsafe { AuditSetGlobalSaclA(objecttypename.param().abi(), acl.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AuditSetGlobalSaclW<P0>(objecttypename: P0, acl: Option<*const super::ACL>) -> bool
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("advapi32.dll" "system" fn AuditSetGlobalSaclW(objecttypename : windows_core::PCWSTR, acl : *const super::ACL) -> bool);
    unsafe { AuditSetGlobalSaclW(objecttypename.param().abi(), acl.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AuditSetPerUserPolicy(psid: super::PSID, pauditpolicy: &[PCAUDIT_POLICY_INFORMATION]) -> bool {
    windows_core::link!("advapi32.dll" "system" fn AuditSetPerUserPolicy(psid : super::PSID, pauditpolicy : PCAUDIT_POLICY_INFORMATION, dwpolicycount : u32) -> bool);
    unsafe { AuditSetPerUserPolicy(psid, core::mem::transmute(pauditpolicy.as_ptr()), pauditpolicy.len().try_into().unwrap()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AuditSetSecurity(securityinformation: super::SECURITY_INFORMATION, psecuritydescriptor: super::PSECURITY_DESCRIPTOR) -> bool {
    windows_core::link!("advapi32.dll" "system" fn AuditSetSecurity(securityinformation : super::SECURITY_INFORMATION, psecuritydescriptor : super::PSECURITY_DESCRIPTOR) -> bool);
