...
#[inline]
pub unsafe fn CryptCATAdminAcquireContext2(phcatadmin: *mut isize, pgsubsystem: Option<*const windows_core::GUID>, pwszhashalgorithm: Option<windows_core::PCWSTR>, pstronghashpolicy: Option<*const super::CERT_STRONG_SIGN_PARA>, dwflags: Option<u32>) -> windows_core::Result<()> {
    ...
    unsafe { CryptCATAdminAcquireContext2(phcatadmin as _, pgsubsystem.unwrap_or(core::mem::zeroed()) as _, pwszhashalgorithm.unwrap_or(core::mem::zeroed()) as _, pstronghashpolicy.unwrap_or(core::mem::zeroed()) as _, dwflags.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn CryptCATAdminAddCatalog(hcatadmin: isize, pwszcatalogfile: windows_core::PCWSTR, pwszselectbasename: Option<windows_core::PCWSTR>, dwflags: u32) -> isize {
    ...
    unsafe { CryptCATAdminAddCatalog(hcatadmin, core::mem::transmute(pwszcatalogfile), pwszselectbasename.unwrap_or(core::mem::zeroed()) as _, dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn CryptCATAdminRemoveCatalog(hcatadmin: isize, pwszcatalogfile: windows_core::PCWSTR, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptCATAdminRemoveCatalog(hcatadmin, core::mem::transmute(pwszcatalogfile), dwflags).ok() }
}
#[inline]
pub unsafe fn CryptCATAdminResolveCatalogPath(hcatadmin: isize, pwszcatalogfile: windows_core::PCWSTR, pscatinfo: *mut CATALOG_INFO, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptCATAdminResolveCatalogPath(hcatadmin, core::mem::transmute(pwszcatalogfile), pscatinfo as _, dwflags).ok() }
}
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
#[inline]
pub unsafe fn CryptCATAllocSortedMemberInfo(hcatalog: super::super::super::Foundation::HANDLE, pwszreferencetag: windows_core::PCWSTR) -> *mut CRYPTCATMEMBER {
    ...
    unsafe { CryptCATAllocSortedMemberInfo(hcatalog, core::mem::transmute(pwszreferencetag)) }
}
#[inline]
...
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
#[inline]
pub unsafe fn CryptCATCDFEnumAttributesWithCDFTag(pcdf: *const CRYPTCATCDF, pwszmembertag: windows_core::PCWSTR, pmember: *const CRYPTCATMEMBER, pprevattr: *const CRYPTCATATTRIBUTE, pfnparseerror: PFN_CDF_PARSE_ERROR_CALLBACK) -> *mut CRYPTCATATTRIBUTE {
    ...
    unsafe { CryptCATCDFEnumAttributesWithCDFTag(pcdf, core::mem::transmute(pwszmembertag), pmember, pprevattr, pfnparseerror) }
}
#[inline]
...
#[inline]
pub unsafe fn CryptCATCDFOpen(pwszfilepath: windows_core::PCWSTR, pfnparseerror: PFN_CDF_PARSE_ERROR_CALLBACK) -> *mut CRYPTCATCDF {
    ...
    unsafe { CryptCATCDFOpen(core::mem::transmute(pwszfilepath), pfnparseerror) }
}
#[inline]
...
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
#[inline]
pub unsafe fn CryptCATGetAttrInfo(hcatalog: super::super::super::Foundation::HANDLE, pcatmember: *mut CRYPTCATMEMBER, pwszreferencetag: windows_core::PCWSTR) -> *mut CRYPTCATATTRIBUTE {
    ...
    unsafe { CryptCATGetAttrInfo(hcatalog, pcatmember as _, core::mem::transmute(pwszreferencetag)) }
}
#[inline]
pub unsafe fn CryptCATGetCatAttrInfo(hcatalog: super::super::super::Foundation::HANDLE, pwszreferencetag: windows_core::PCWSTR) -> *mut CRYPTCATATTRIBUTE {
    ...
    unsafe { CryptCATGetCatAttrInfo(hcatalog, core::mem::transmute(pwszreferencetag)) }
}
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
#[inline]
pub unsafe fn CryptCATGetMemberInfo(hcatalog: super::super::super::Foundation::HANDLE, pwszreferencetag: windows_core::PCWSTR) -> *mut CRYPTCATMEMBER {
    ...
    unsafe { CryptCATGetMemberInfo(hcatalog, core::mem::transmute(pwszreferencetag)) }
}
#[inline]
...
#[inline]
pub unsafe fn CryptCATOpen(pwszfilename: windows_core::PCWSTR, fdwopenflags: CRYPTCAT_OPEN_FLAGS, hprov: usize, dwpublicversion: CRYPTCAT_VERSION, dwencodingtype: u32) -> super::super::super::Foundation::HANDLE {
    ...
    unsafe { CryptCATOpen(core::mem::transmute(pwszfilename), fdwopenflags, hprov, dwpublicversion, dwencodingtype) }
}
#[inline]
...
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
#[inline]
pub unsafe fn CryptCATPutAttrInfo(hcatalog: super::super::super::Foundation::HANDLE, pcatmember: *mut CRYPTCATMEMBER, pwszreferencetag: windows_core::PCWSTR, dwattrtypeandaction: u32, cbdata: u32, pbdata: *mut u8) -> *mut CRYPTCATATTRIBUTE {
    ...
    unsafe { CryptCATPutAttrInfo(hcatalog, pcatmember as _, core::mem::transmute(pwszreferencetag), dwattrtypeandaction, cbdata, pbdata as _) }
}
#[inline]
pub unsafe fn CryptCATPutCatAttrInfo(hcatalog: super::super::super::Foundation::HANDLE, pwszreferencetag: windows_core::PCWSTR, dwattrtypeandaction: u32, cbdata: u32, pbdata: *mut u8) -> *mut CRYPTCATATTRIBUTE {
    ...
    unsafe { CryptCATPutCatAttrInfo(hcatalog, core::mem::transmute(pwszreferencetag), dwattrtypeandaction, cbdata, pbdata as _) }
}
#[cfg(feature = "Win32_Security_Cryptography_Sip")]
#[inline]
pub unsafe fn CryptCATPutMemberInfo(hcatalog: super::super::super::Foundation::HANDLE, pwszfilename: Option<windows_core::PCWSTR>, pwszreferencetag: windows_core::PCWSTR, pgsubjecttype: *mut windows_core::GUID, dwcertversion: u32, cbsipindirectdata: u32, pbsipindirectdata: *mut u8) -> *mut CRYPTCATMEMBER {
    ...
    unsafe { CryptCATPutMemberInfo(hcatalog, pwszfilename.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pwszreferencetag), pgsubjecttype as _, dwcertversion, cbsipindirectdata, pbsipindirectdata as _) }
}
#[inline]
...
#[inline]
pub unsafe fn IsCatalogFile(hfile: super::super::super::Foundation::HANDLE, pwszfilename: Option<windows_core::PCWSTR>) -> windows_core::BOOL {
    ...
    unsafe { IsCatalogFile(hfile, pwszfilename.unwrap_or(core::mem::zeroed()) as _) }
}
#[repr(C)]
