...
pub mod UI;
#[inline]
pub unsafe fn BCryptAddContextFunction(dwtable: BCRYPT_TABLE, pszcontext: windows_core::PCWSTR, dwinterface: BCRYPT_INTERFACE, pszfunction: windows_core::PCWSTR, dwposition: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptAddContextFunction(dwtable, core::mem::transmute(pszcontext), dwinterface, core::mem::transmute(pszfunction), dwposition) }
}
#[inline]
pub unsafe fn BCryptAddContextFunctionProvider(dwtable: u32, pszcontext: windows_core::PCWSTR, dwinterface: u32, pszfunction: windows_core::PCWSTR, pszprovider: windows_core::PCWSTR, dwposition: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptAddContextFunctionProvider(dwtable, core::mem::transmute(pszcontext), dwinterface, core::mem::transmute(pszfunction), core::mem::transmute(pszprovider), dwposition) }
}
#[inline]
...
#[inline]
pub unsafe fn BCryptConfigureContext(dwtable: BCRYPT_TABLE, pszcontext: windows_core::PCWSTR, pconfig: *const CRYPT_CONTEXT_CONFIG) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptConfigureContext(dwtable, core::mem::transmute(pszcontext), pconfig) }
}
#[inline]
pub unsafe fn BCryptConfigureContextFunction(dwtable: BCRYPT_TABLE, pszcontext: windows_core::PCWSTR, dwinterface: BCRYPT_INTERFACE, pszfunction: windows_core::PCWSTR, pconfig: *const CRYPT_CONTEXT_FUNCTION_CONFIG) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptConfigureContextFunction(dwtable, core::mem::transmute(pszcontext), dwinterface, core::mem::transmute(pszfunction), pconfig) }
}
#[inline]
pub unsafe fn BCryptCreateContext(dwtable: BCRYPT_TABLE, pszcontext: windows_core::PCWSTR, pconfig: Option<*const CRYPT_CONTEXT_CONFIG>) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptCreateContext(dwtable, core::mem::transmute(pszcontext), pconfig.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn BCryptDeleteContext(dwtable: BCRYPT_TABLE, pszcontext: windows_core::PCWSTR) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptDeleteContext(dwtable, core::mem::transmute(pszcontext)) }
}
#[inline]
pub unsafe fn BCryptDeriveKey(hsharedsecret: BCRYPT_SECRET_HANDLE, pwszkdf: windows_core::PCWSTR, pparameterlist: Option<*const BCryptBufferDesc>, pbderivedkey: Option<&mut [u8]>, pcbresult: *mut u32, dwflags: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptDeriveKey(hsharedsecret, core::mem::transmute(pwszkdf), pparameterlist.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pbderivedkey.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pbderivedkey.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pcbresult as _, dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn BCryptEnumContextFunctionProviders(dwtable: BCRYPT_TABLE, pszcontext: windows_core::PCWSTR, dwinterface: BCRYPT_INTERFACE, pszfunction: windows_core::PCWSTR, pcbbuffer: *mut u32, ppbuffer: Option<*mut *mut CRYPT_CONTEXT_FUNCTION_PROVIDERS>) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptEnumContextFunctionProviders(dwtable, core::mem::transmute(pszcontext), dwinterface, core::mem::transmute(pszfunction), pcbbuffer as _, ppbuffer.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn BCryptEnumContextFunctions(dwtable: BCRYPT_TABLE, pszcontext: windows_core::PCWSTR, dwinterface: BCRYPT_INTERFACE, pcbbuffer: *mut u32, ppbuffer: Option<*mut *mut CRYPT_CONTEXT_FUNCTIONS>) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptEnumContextFunctions(dwtable, core::mem::transmute(pszcontext), dwinterface, pcbbuffer as _, ppbuffer.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn BCryptEnumProviders(pszalgid: windows_core::PCWSTR, pimplcount: *mut u32, ppimpllist: *mut *mut BCRYPT_PROVIDER_NAME, dwflags: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptEnumProviders(core::mem::transmute(pszalgid), pimplcount as _, ppimpllist as _, dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn BCryptExportKey(hkey: BCRYPT_KEY_HANDLE, hexportkey: Option<BCRYPT_KEY_HANDLE>, pszblobtype: windows_core::PCWSTR, pboutput: Option<&mut [u8]>, pcbresult: *mut u32, dwflags: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptExportKey(hkey, hexportkey.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pszblobtype), core::mem::transmute(pboutput.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pboutput.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pcbresult as _, dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn BCryptGetProperty(hobject: BCRYPT_HANDLE, pszproperty: windows_core::PCWSTR, pboutput: Option<&mut [u8]>, pcbresult: *mut u32, dwflags: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptGetProperty(hobject, core::mem::transmute(pszproperty), core::mem::transmute(pboutput.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pboutput.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pcbresult as _, dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn BCryptImportKey(halgorithm: BCRYPT_ALG_HANDLE, himportkey: Option<BCRYPT_KEY_HANDLE>, pszblobtype: windows_core::PCWSTR, phkey: *mut BCRYPT_KEY_HANDLE, pbkeyobject: Option<&mut [u8]>, pbinput: &[u8], dwflags: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptImportKey(halgorithm, himportkey.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pszblobtype), phkey as _, core::mem::transmute(pbkeyobject.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pbkeyobject.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), core::mem::transmute(pbinput.as_ptr()), pbinput.len().try_into().unwrap(), dwflags) }
}
#[inline]
pub unsafe fn BCryptImportKeyPair(halgorithm: BCRYPT_ALG_HANDLE, himportkey: Option<BCRYPT_KEY_HANDLE>, pszblobtype: windows_core::PCWSTR, phkey: *mut BCRYPT_KEY_HANDLE, pbinput: &[u8], dwflags: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptImportKeyPair(halgorithm, himportkey.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pszblobtype), phkey as _, core::mem::transmute(pbinput.as_ptr()), pbinput.len().try_into().unwrap(), dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn BCryptOpenAlgorithmProvider(phalgorithm: *mut BCRYPT_ALG_HANDLE, pszalgid: windows_core::PCWSTR, pszimplementation: Option<windows_core::PCWSTR>, dwflags: BCRYPT_OPEN_ALGORITHM_PROVIDER_FLAGS) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptOpenAlgorithmProvider(phalgorithm as _, core::mem::transmute(pszalgid), pszimplementation.unwrap_or(core::mem::zeroed()) as _, dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn BCryptQueryContextConfiguration(dwtable: BCRYPT_TABLE, pszcontext: windows_core::PCWSTR, pcbbuffer: *mut u32, ppbuffer: Option<*mut *mut CRYPT_CONTEXT_CONFIG>) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptQueryContextConfiguration(dwtable, core::mem::transmute(pszcontext), pcbbuffer as _, ppbuffer.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn BCryptQueryContextFunctionConfiguration(dwtable: BCRYPT_TABLE, pszcontext: windows_core::PCWSTR, dwinterface: BCRYPT_INTERFACE, pszfunction: windows_core::PCWSTR, pcbbuffer: *mut u32, ppbuffer: Option<*mut *mut CRYPT_CONTEXT_FUNCTION_CONFIG>) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptQueryContextFunctionConfiguration(dwtable, core::mem::transmute(pszcontext), dwinterface, core::mem::transmute(pszfunction), pcbbuffer as _, ppbuffer.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn BCryptQueryContextFunctionProperty(dwtable: BCRYPT_TABLE, pszcontext: windows_core::PCWSTR, dwinterface: BCRYPT_INTERFACE, pszfunction: windows_core::PCWSTR, pszproperty: windows_core::PCWSTR, pcbvalue: *mut u32, ppbvalue: Option<*mut *mut u8>) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptQueryContextFunctionProperty(dwtable, core::mem::transmute(pszcontext), dwinterface, core::mem::transmute(pszfunction), core::mem::transmute(pszproperty), pcbvalue as _, ppbvalue.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn BCryptQueryProviderRegistration(pszprovider: windows_core::PCWSTR, dwmode: BCRYPT_QUERY_PROVIDER_MODE, dwinterface: BCRYPT_INTERFACE, pcbbuffer: *mut u32, ppbuffer: Option<*mut *mut CRYPT_PROVIDER_REG>) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptQueryProviderRegistration(core::mem::transmute(pszprovider), dwmode, dwinterface, pcbbuffer as _, ppbuffer.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn BCryptRegisterProvider(pszprovider: windows_core::PCWSTR, dwflags: u32, preg: *const CRYPT_PROVIDER_REG) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptRegisterProvider(core::mem::transmute(pszprovider), dwflags, preg) }
}
#[inline]
pub unsafe fn BCryptRemoveContextFunction(dwtable: BCRYPT_TABLE, pszcontext: windows_core::PCWSTR, dwinterface: BCRYPT_INTERFACE, pszfunction: windows_core::PCWSTR) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptRemoveContextFunction(dwtable, core::mem::transmute(pszcontext), dwinterface, core::mem::transmute(pszfunction)) }
}
#[inline]
pub unsafe fn BCryptRemoveContextFunctionProvider(dwtable: u32, pszcontext: windows_core::PCWSTR, dwinterface: u32, pszfunction: windows_core::PCWSTR, pszprovider: windows_core::PCWSTR) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptRemoveContextFunctionProvider(dwtable, core::mem::transmute(pszcontext), dwinterface, core::mem::transmute(pszfunction), core::mem::transmute(pszprovider)) }
}
#[inline]
pub unsafe fn BCryptResolveProviders(pszcontext: Option<windows_core::PCWSTR>, dwinterface: Option<u32>, pszfunction: Option<windows_core::PCWSTR>, pszprovider: Option<windows_core::PCWSTR>, dwmode: BCRYPT_QUERY_PROVIDER_MODE, dwflags: BCRYPT_RESOLVE_PROVIDERS_FLAGS, pcbbuffer: *mut u32, ppbuffer: Option<*mut *mut CRYPT_PROVIDER_REFS>) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptResolveProviders(pszcontext.unwrap_or(core::mem::zeroed()) as _, dwinterface.unwrap_or(core::mem::zeroed()) as _, pszfunction.unwrap_or(core::mem::zeroed()) as _, pszprovider.unwrap_or(core::mem::zeroed()) as _, dwmode, dwflags, pcbbuffer as _, ppbuffer.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn BCryptSetContextFunctionProperty(dwtable: BCRYPT_TABLE, pszcontext: windows_core::PCWSTR, dwinterface: BCRYPT_INTERFACE, pszfunction: windows_core::PCWSTR, pszproperty: windows_core::PCWSTR, pbvalue: Option<&[u8]>) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptSetContextFunctionProperty(dwtable, core::mem::transmute(pszcontext), dwinterface, core::mem::transmute(pszfunction), core::mem::transmute(pszproperty), pbvalue.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), core::mem::transmute(pbvalue.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr()))) }
}
#[inline]
pub unsafe fn BCryptSetProperty(hobject: BCRYPT_HANDLE, pszproperty: windows_core::PCWSTR, pbinput: &[u8], dwflags: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { BCryptSetProperty(hobject as _, core::mem::transmute(pszproperty), core::mem::transmute(pbinput.as_ptr()), pbinput.len().try_into().unwrap(), dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn BCryptUnregisterProvider(pszprovider: windows_core::PCWSTR) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptUnregisterProvider(pszprovider : windows_core::PCWSTR) -> windows_core:: NTSTATUS);
    unsafe { BCryptUnregisterProvider(core::mem::transmute(pszprovider)) }
}
#[inline]
...
#[inline]
pub unsafe fn CertAddEncodedCertificateToSystemStoreA(szcertstorename: windows_core::PCSTR, pbcertencoded: &[u8]) -> windows_core::Result<()> {
    ...
    unsafe { CertAddEncodedCertificateToSystemStoreA(core::mem::transmute(szcertstorename), core::mem::transmute(pbcertencoded.as_ptr()), pbcertencoded.len().try_into().unwrap()).ok() }
}
#[inline]
pub unsafe fn CertAddEncodedCertificateToSystemStoreW(szcertstorename: windows_core::PCWSTR, pbcertencoded: &[u8]) -> windows_core::Result<()> {
    ...
    unsafe { CertAddEncodedCertificateToSystemStoreW(core::mem::transmute(szcertstorename), core::mem::transmute(pbcertencoded.as_ptr()), pbcertencoded.len().try_into().unwrap()).ok() }
}
#[inline]
pub unsafe fn CertAddEnhancedKeyUsageIdentifier(pcertcontext: *const CERT_CONTEXT, pszusageidentifier: windows_core::PCSTR) -> windows_core::Result<()> {
    ...
    unsafe { CertAddEnhancedKeyUsageIdentifier(pcertcontext, core::mem::transmute(pszusageidentifier)).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CertFindAttribute(pszobjid: windows_core::PCSTR, rgattr: &[CRYPT_ATTRIBUTE]) -> *mut CRYPT_ATTRIBUTE {
    ...
    unsafe { CertFindAttribute(core::mem::transmute(pszobjid), rgattr.len().try_into().unwrap(), core::mem::transmute(rgattr.as_ptr())) }
}
#[inline]
...
#[inline]
pub unsafe fn CertFindExtension(pszobjid: windows_core::PCSTR, rgextensions: &[CERT_EXTENSION]) -> *mut CERT_EXTENSION {
    ...
    unsafe { CertFindExtension(core::mem::transmute(pszobjid), rgextensions.len().try_into().unwrap(), core::mem::transmute(rgextensions.as_ptr())) }
}
#[inline]
pub unsafe fn CertFindRDNAttr(pszobjid: windows_core::PCSTR, pname: *const CERT_NAME_INFO) -> *mut CERT_RDN_ATTR {
    ...
    unsafe { CertFindRDNAttr(core::mem::transmute(pszobjid), pname) }
}
#[inline]
...
#[inline]
pub unsafe fn CertIsStrongHashToSign(pstrongsignpara: *const CERT_STRONG_SIGN_PARA, pwszcnghashalgid: windows_core::PCWSTR, psigningcert: Option<*const CERT_CONTEXT>) -> windows_core::Result<()> {
    ...
    unsafe { CertIsStrongHashToSign(pstrongsignpara, core::mem::transmute(pwszcnghashalgid), psigningcert.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CertIsWeakHash(dwhashusetype: u32, pwszcnghashalgid: windows_core::PCWSTR, dwchainflags: u32, psignerchaincontext: Option<*const CERT_CHAIN_CONTEXT>, ptimestamp: Option<*const super::super::Foundation::FILETIME>, pwszfilename: Option<windows_core::PCWSTR>) -> windows_core::BOOL {
    ...
    unsafe { CertIsWeakHash(dwhashusetype, core::mem::transmute(pwszcnghashalgid), dwchainflags, psignerchaincontext.unwrap_or(core::mem::zeroed()) as _, ptimestamp.unwrap_or(core::mem::zeroed()) as _, pwszfilename.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn CertOIDToAlgId(pszobjid: windows_core::PCSTR) -> u32 {
    windows_core::link!("crypt32.dll" "system" fn CertOIDToAlgId(pszobjid : windows_core::PCSTR) -> u32);
    unsafe { CertOIDToAlgId(core::mem::transmute(pszobjid)) }
}
#[inline]
...
#[inline]
pub unsafe fn CertOpenStore(lpszstoreprovider: windows_core::PCSTR, dwencodingtype: CERT_QUERY_ENCODING_TYPE, hcryptprov: Option<HCRYPTPROV_LEGACY>, dwflags: CERT_OPEN_STORE_FLAGS, pvpara: Option<*const core::ffi::c_void>) -> windows_core::Result<HCERTSTORE> {
    ...
    let result__ = unsafe { CertOpenStore(core::mem::transmute(lpszstoreprovider), dwencodingtype, hcryptprov.unwrap_or(core::mem::zeroed()) as _, dwflags, pvpara.unwrap_or(core::mem::zeroed()) as _) };
    (!result__.is_invalid()).then_some(result__).ok_or_else(windows_core::Error::from_thread)
}
#[inline]
pub unsafe fn CertOpenSystemStoreA(hprov: Option<HCRYPTPROV_LEGACY>, szsubsystemprotocol: windows_core::PCSTR) -> windows_core::Result<HCERTSTORE> {
    ...
    let result__ = unsafe { CertOpenSystemStoreA(hprov.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(szsubsystemprotocol)) };
    (!result__.is_invalid()).then_some(result__).ok_or_else(windows_core::Error::from_thread)
}
#[inline]
pub unsafe fn CertOpenSystemStoreW(hprov: Option<HCRYPTPROV_LEGACY>, szsubsystemprotocol: windows_core::PCWSTR) -> windows_core::Result<HCERTSTORE> {
    ...
    let result__ = unsafe { CertOpenSystemStoreW(hprov.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(szsubsystemprotocol)) };
    (!result__.is_invalid()).then_some(result__).ok_or_else(windows_core::Error::from_thread)
}
#[inline]
...
#[inline]
pub unsafe fn CertRegisterPhysicalStore(pvsystemstore: *const core::ffi::c_void, dwflags: u32, pwszstorename: windows_core::PCWSTR, pstoreinfo: *const CERT_PHYSICAL_STORE_INFO, pvreserved: Option<*const core::ffi::c_void>) -> windows_core::BOOL {
    ...
    unsafe { CertRegisterPhysicalStore(pvsystemstore, dwflags, core::mem::transmute(pwszstorename), pstoreinfo, pvreserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn CertRemoveEnhancedKeyUsageIdentifier(pcertcontext: *const CERT_CONTEXT, pszusageidentifier: windows_core::PCSTR) -> windows_core::Result<()> {
    ...
    unsafe { CertRemoveEnhancedKeyUsageIdentifier(pcertcontext, core::mem::transmute(pszusageidentifier)).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CertRetrieveLogoOrBiometricInfo(pcertcontext: *const CERT_CONTEXT, lpszlogoorbiometrictype: windows_core::PCSTR, dwretrievalflags: u32, dwtimeout: u32, dwflags: u32, pvreserved: Option<*const core::ffi::c_void>, ppbdata: *mut *mut u8, pcbdata: *mut u32, ppwszmimetype: Option<*mut windows_core::PWSTR>) -> windows_core::Result<()> {
    ...
    unsafe { CertRetrieveLogoOrBiometricInfo(pcertcontext, core::mem::transmute(lpszlogoorbiometrictype), dwretrievalflags, dwtimeout, dwflags, pvreserved.unwrap_or(core::mem::zeroed()) as _, ppbdata as _, pcbdata as _, ppwszmimetype.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CertStrToNameA(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pszx500: windows_core::PCSTR, dwstrtype: CERT_STRING_TYPE, pvreserved: Option<*const core::ffi::c_void>, pbencoded: Option<*mut u8>, pcbencoded: *mut u32, ppszerror: Option<*mut windows_core::PCSTR>) -> windows_core::Result<()> {
    ...
    unsafe { CertStrToNameA(dwcertencodingtype, core::mem::transmute(pszx500), dwstrtype, pvreserved.unwrap_or(core::mem::zeroed()) as _, pbencoded.unwrap_or(core::mem::zeroed()) as _, pcbencoded as _, ppszerror.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn CertStrToNameW(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pszx500: windows_core::PCWSTR, dwstrtype: CERT_STRING_TYPE, pvreserved: Option<*const core::ffi::c_void>, pbencoded: Option<*mut u8>, pcbencoded: *mut u32, ppszerror: Option<*mut windows_core::PCWSTR>) -> windows_core::Result<()> {
    ...
    unsafe { CertStrToNameW(dwcertencodingtype, core::mem::transmute(pszx500), dwstrtype, pvreserved.unwrap_or(core::mem::zeroed()) as _, pbencoded.unwrap_or(core::mem::zeroed()) as _, pcbencoded as _, ppszerror.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn CertUnregisterPhysicalStore(pvsystemstore: *const core::ffi::c_void, dwflags: u32, pwszstorename: windows_core::PCWSTR) -> windows_core::BOOL {
    ...
    unsafe { CertUnregisterPhysicalStore(pvsystemstore, dwflags, core::mem::transmute(pwszstorename)) }
}
#[inline]
...
#[inline]
pub unsafe fn CertVerifyCertificateChainPolicy(pszpolicyoid: windows_core::PCSTR, pchaincontext: *const CERT_CHAIN_CONTEXT, ppolicypara: *const CERT_CHAIN_POLICY_PARA, ppolicystatus: *mut CERT_CHAIN_POLICY_STATUS) -> windows_core::BOOL {
    ...
    unsafe { CertVerifyCertificateChainPolicy(core::mem::transmute(pszpolicyoid), pchaincontext, ppolicypara, ppolicystatus as _) }
}
#[inline]
...
#[inline]
pub unsafe fn CryptAcquireContextA(phprov: *mut usize, szcontainer: Option<windows_core::PCSTR>, szprovider: Option<windows_core::PCSTR>, dwprovtype: u32, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptAcquireContextA(phprov as _, szcontainer.unwrap_or(core::mem::zeroed()) as _, szprovider.unwrap_or(core::mem::zeroed()) as _, dwprovtype, dwflags).ok() }
}
#[inline]
pub unsafe fn CryptAcquireContextW(phprov: *mut usize, szcontainer: Option<windows_core::PCWSTR>, szprovider: Option<windows_core::PCWSTR>, dwprovtype: u32, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptAcquireContextW(phprov as _, szcontainer.unwrap_or(core::mem::zeroed()) as _, szprovider.unwrap_or(core::mem::zeroed()) as _, dwprovtype, dwflags).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CryptCreateKeyIdentifierFromCSP(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pszpubkeyoid: Option<windows_core::PCSTR>, ppubkeystruc: *const PUBLICKEYSTRUC, cbpubkeystruc: u32, dwflags: u32, pvreserved: Option<*const core::ffi::c_void>, pbhash: Option<*mut u8>, pcbhash: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptCreateKeyIdentifierFromCSP(dwcertencodingtype, pszpubkeyoid.unwrap_or(core::mem::zeroed()) as _, ppubkeystruc, cbpubkeystruc, dwflags, pvreserved.unwrap_or(core::mem::zeroed()) as _, pbhash.unwrap_or(core::mem::zeroed()) as _, pcbhash as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CryptDecodeObject(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, lpszstructtype: windows_core::PCSTR, pbencoded: &[u8], dwflags: u32, pvstructinfo: Option<*mut core::ffi::c_void>, pcbstructinfo: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptDecodeObject(dwcertencodingtype, core::mem::transmute(lpszstructtype), core::mem::transmute(pbencoded.as_ptr()), pbencoded.len().try_into().unwrap(), dwflags, pvstructinfo.unwrap_or(core::mem::zeroed()) as _, pcbstructinfo as _).ok() }
}
#[inline]
pub unsafe fn CryptDecodeObjectEx(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, lpszstructtype: windows_core::PCSTR, pbencoded: &[u8], dwflags: u32, pdecodepara: Option<*const CRYPT_DECODE_PARA>, pvstructinfo: Option<*mut core::ffi::c_void>, pcbstructinfo: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptDecodeObjectEx(dwcertencodingtype, core::mem::transmute(lpszstructtype), core::mem::transmute(pbencoded.as_ptr()), pbencoded.len().try_into().unwrap(), dwflags, pdecodepara.unwrap_or(core::mem::zeroed()) as _, pvstructinfo.unwrap_or(core::mem::zeroed()) as _, pcbstructinfo as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CryptEncodeObject(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, lpszstructtype: windows_core::PCSTR, pvstructinfo: *const core::ffi::c_void, pbencoded: Option<*mut u8>, pcbencoded: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptEncodeObject(dwcertencodingtype, core::mem::transmute(lpszstructtype), pvstructinfo, pbencoded.unwrap_or(core::mem::zeroed()) as _, pcbencoded as _).ok() }
}
#[inline]
pub unsafe fn CryptEncodeObjectEx(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, lpszstructtype: windows_core::PCSTR, pvstructinfo: *const core::ffi::c_void, dwflags: CRYPT_ENCODE_OBJECT_FLAGS, pencodepara: Option<*const CRYPT_ENCODE_PARA>, pvencoded: Option<*mut core::ffi::c_void>, pcbencoded: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptEncodeObjectEx(dwcertencodingtype, core::mem::transmute(lpszstructtype), pvstructinfo, dwflags, pencodepara.unwrap_or(core::mem::zeroed()) as _, pvencoded.unwrap_or(core::mem::zeroed()) as _, pcbencoded as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CryptEnumKeyIdentifierProperties(pkeyidentifier: Option<*const CRYPT_INTEGER_BLOB>, dwpropid: u32, dwflags: u32, pwszcomputername: Option<windows_core::PCWSTR>, pvreserved: Option<*const core::ffi::c_void>, pvarg: Option<*mut core::ffi::c_void>, pfnenum: PFN_CRYPT_ENUM_KEYID_PROP) -> windows_core::Result<()> {
    ...
    unsafe { CryptEnumKeyIdentifierProperties(pkeyidentifier.unwrap_or(core::mem::zeroed()) as _, dwpropid, dwflags, pwszcomputername.unwrap_or(core::mem::zeroed()) as _, pvreserved.unwrap_or(core::mem::zeroed()) as _, pvarg.unwrap_or(core::mem::zeroed()) as _, pfnenum).ok() }
}
#[inline]
pub unsafe fn CryptEnumOIDFunction(dwencodingtype: u32, pszfuncname: Option<windows_core::PCSTR>, pszoid: Option<windows_core::PCSTR>, dwflags: u32, pvarg: Option<*mut core::ffi::c_void>, pfnenumoidfunc: PFN_CRYPT_ENUM_OID_FUNC) -> windows_core::Result<()> {
    ...
    unsafe { CryptEnumOIDFunction(dwencodingtype, pszfuncname.unwrap_or(core::mem::zeroed()) as _, pszoid.unwrap_or(core::mem::zeroed()) as _, dwflags, pvarg.unwrap_or(core::mem::zeroed()) as _, pfnenumoidfunc).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CryptExportPKCS8(hcryptprov: usize, dwkeyspec: u32, pszprivatekeyobjid: windows_core::PCSTR, dwflags: u32, pvauxinfo: Option<*const core::ffi::c_void>, pbprivatekeyblob: Option<*mut u8>, pcbprivatekeyblob: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptExportPKCS8(hcryptprov, dwkeyspec, core::mem::transmute(pszprivatekeyobjid), dwflags, pvauxinfo.unwrap_or(core::mem::zeroed()) as _, pbprivatekeyblob.unwrap_or(core::mem::zeroed()) as _, pcbprivatekeyblob as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CryptExportPublicKeyInfoEx(hcryptprovorncryptkey: HCRYPTPROV_OR_NCRYPT_KEY_HANDLE, dwkeyspec: Option<u32>, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pszpublickeyobjid: Option<windows_core::PCSTR>, dwflags: u32, pvauxinfo: Option<*const core::ffi::c_void>, pinfo: Option<*mut CERT_PUBLIC_KEY_INFO>, pcbinfo: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptExportPublicKeyInfoEx(hcryptprovorncryptkey, dwkeyspec.unwrap_or(core::mem::zeroed()) as _, dwcertencodingtype, pszpublickeyobjid.unwrap_or(core::mem::zeroed()) as _, dwflags, pvauxinfo.unwrap_or(core::mem::zeroed()) as _, pinfo.unwrap_or(core::mem::zeroed()) as _, pcbinfo as _).ok() }
}
#[inline]
pub unsafe fn CryptExportPublicKeyInfoFromBCryptKeyHandle(hbcryptkey: BCRYPT_KEY_HANDLE, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, pszpublickeyobjid: Option<windows_core::PCSTR>, dwflags: u32, pvauxinfo: Option<*const core::ffi::c_void>, pinfo: Option<*mut CERT_PUBLIC_KEY_INFO>, pcbinfo: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { CryptExportPublicKeyInfoFromBCryptKeyHandle(hbcryptkey, dwcertencodingtype, pszpublickeyobjid.unwrap_or(core::mem::zeroed()) as _, dwflags, pvauxinfo.unwrap_or(core::mem::zeroed()) as _, pinfo.unwrap_or(core::mem::zeroed()) as _, pcbinfo as _) }
}
#[inline]
...
#[inline]
pub unsafe fn CryptFindLocalizedName(pwszcryptname: windows_core::PCWSTR) -> windows_core::PCWSTR {
    windows_core::link!("crypt32.dll" "system" fn CryptFindLocalizedName(pwszcryptname : windows_core::PCWSTR) -> windows_core::PCWSTR);
    unsafe { CryptFindLocalizedName(core::mem::transmute(pwszcryptname)) }
}
#[inline]
...
#[inline]
pub unsafe fn CryptFormatObject(dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, dwformattype: u32, dwformatstrtype: u32, pformatstruct: Option<*const core::ffi::c_void>, lpszstructtype: Option<windows_core::PCSTR>, pbencoded: &[u8], pbformat: Option<*mut core::ffi::c_void>, pcbformat: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptFormatObject(dwcertencodingtype, dwformattype, dwformatstrtype, pformatstruct.unwrap_or(core::mem::zeroed()) as _, lpszstructtype.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pbencoded.as_ptr()), pbencoded.len().try_into().unwrap(), pbformat.unwrap_or(core::mem::zeroed()) as _, pcbformat as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CryptGetAsyncParam(hasync: HCRYPTASYNC, pszparamoid: windows_core::PCSTR, ppvparam: Option<*mut *mut core::ffi::c_void>, ppfnfree: Option<*mut PFN_CRYPT_ASYNC_PARAM_FREE_FUNC>) -> windows_core::BOOL {
    ...
    unsafe { CryptGetAsyncParam(hasync, core::mem::transmute(pszparamoid), ppvparam.unwrap_or(core::mem::zeroed()) as _, ppfnfree.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn CryptGetDefaultOIDFunctionAddress(hfuncset: *const core::ffi::c_void, dwencodingtype: u32, pwszdll: Option<windows_core::PCWSTR>, dwflags: u32, ppvfuncaddr: *mut *mut core::ffi::c_void, phfuncaddr: *mut *mut core::ffi::c_void) -> windows_core::BOOL {
    ...
    unsafe { CryptGetDefaultOIDFunctionAddress(hfuncset, dwencodingtype, pwszdll.unwrap_or(core::mem::zeroed()) as _, dwflags, ppvfuncaddr as _, phfuncaddr as _) }
}
#[inline]
...
#[inline]
pub unsafe fn CryptGetKeyIdentifierProperty(pkeyidentifier: *const CRYPT_INTEGER_BLOB, dwpropid: u32, dwflags: u32, pwszcomputername: Option<windows_core::PCWSTR>, pvreserved: Option<*const core::ffi::c_void>, pvdata: Option<*mut core::ffi::c_void>, pcbdata: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptGetKeyIdentifierProperty(pkeyidentifier, dwpropid, dwflags, pwszcomputername.unwrap_or(core::mem::zeroed()) as _, pvreserved.unwrap_or(core::mem::zeroed()) as _, pvdata.unwrap_or(core::mem::zeroed()) as _, pcbdata as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CryptGetOIDFunctionAddress(hfuncset: *const core::ffi::c_void, dwencodingtype: u32, pszoid: windows_core::PCSTR, dwflags: u32, ppvfuncaddr: *mut *mut core::ffi::c_void, phfuncaddr: *mut *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { CryptGetOIDFunctionAddress(hfuncset, dwencodingtype, core::mem::transmute(pszoid), dwflags, ppvfuncaddr as _, phfuncaddr as _).ok() }
}
#[inline]
pub unsafe fn CryptGetOIDFunctionValue(dwencodingtype: u32, pszfuncname: windows_core::PCSTR, pszoid: windows_core::PCSTR, pwszvaluename: Option<windows_core::PCWSTR>, pdwvaluetype: Option<*mut u32>, pbvaluedata: Option<*mut u8>, pcbvaluedata: Option<*mut u32>) -> windows_core::Result<()> {
    ...
    unsafe { CryptGetOIDFunctionValue(dwencodingtype, core::mem::transmute(pszfuncname), core::mem::transmute(pszoid), pwszvaluename.unwrap_or(core::mem::zeroed()) as _, pdwvaluetype.unwrap_or(core::mem::zeroed()) as _, pbvaluedata.unwrap_or(core::mem::zeroed()) as _, pcbvaluedata.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn CryptGetObjectUrl(pszurloid: windows_core::PCSTR, pvpara: *const core::ffi::c_void, dwflags: CRYPT_GET_URL_FLAGS, purlarray: Option<*mut CRYPT_URL_ARRAY>, pcburlarray: *mut u32, purlinfo: Option<*mut CRYPT_URL_INFO>, pcburlinfo: Option<*mut u32>, pvreserved: Option<*const core::ffi::c_void>) -> windows_core::Result<()> {
    ...
    unsafe { CryptGetObjectUrl(core::mem::transmute(pszurloid), pvpara, dwflags, purlarray.unwrap_or(core::mem::zeroed()) as _, pcburlarray as _, purlinfo.unwrap_or(core::mem::zeroed()) as _, pcburlinfo.unwrap_or(core::mem::zeroed()) as _, pvreserved.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CryptHashCertificate2(pwszcnghashalgid: windows_core::PCWSTR, dwflags: u32, pvreserved: Option<*const core::ffi::c_void>, pbencoded: Option<&[u8]>, pbcomputedhash: Option<*mut u8>, pcbcomputedhash: *mut u32) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn CryptInitOIDFunctionSet(pszfuncname: windows_core::PCSTR, dwflags: u32) -> *mut core::ffi::c_void {
    ...
    unsafe { CryptInitOIDFunctionSet(core::mem::transmute(pszfuncname), dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn CryptInstallOIDFunctionAddress(hmodule: Option<super::super::Foundation::HMODULE>, dwencodingtype: u32, pszfuncname: windows_core::PCSTR, rgfuncentry: &[CRYPT_OID_FUNC_ENTRY], dwflags: u32) -> windows_core::BOOL {
    ...
    unsafe { CryptInstallOIDFunctionAddress(hmodule.unwrap_or(core::mem::zeroed()) as _, dwencodingtype, core::mem::transmute(pszfuncname), rgfuncentry.len().try_into().unwrap(), core::mem::transmute(rgfuncentry.as_ptr()), dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn CryptMsgCalculateEncodedLength(dwmsgencodingtype: u32, dwflags: u32, dwmsgtype: u32, pvmsgencodeinfo: *const core::ffi::c_void, pszinnercontentobjid: Option<windows_core::PCSTR>, cbdata: u32) -> u32 {
    ...
    unsafe { CryptMsgCalculateEncodedLength(dwmsgencodingtype, dwflags, dwmsgtype, pvmsgencodeinfo, pszinnercontentobjid.unwrap_or(core::mem::zeroed()) as _, cbdata) }
}
#[inline]
...
#[inline]
pub unsafe fn CryptMsgOpenToEncode(dwmsgencodingtype: u32, dwflags: u32, dwmsgtype: CRYPT_MSG_TYPE, pvmsgencodeinfo: *const core::ffi::c_void, pszinnercontentobjid: Option<windows_core::PCSTR>, pstreaminfo: Option<*const CMSG_STREAM_INFO>) -> *mut core::ffi::c_void {
    ...
    unsafe { CryptMsgOpenToEncode(dwmsgencodingtype, dwflags, dwmsgtype, pvmsgencodeinfo, pszinnercontentobjid.unwrap_or(core::mem::zeroed()) as _, pstreaminfo.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
pub unsafe fn CryptProtectData(pdatain: *const CRYPT_INTEGER_BLOB, szdatadescr: Option<windows_core::PCWSTR>, poptionalentropy: Option<*const CRYPT_INTEGER_BLOB>, pvreserved: Option<*const core::ffi::c_void>, ppromptstruct: Option<*const CRYPTPROTECT_PROMPTSTRUCT>, dwflags: u32, pdataout: *mut CRYPT_INTEGER_BLOB) -> windows_core::Result<()> {
    ...
    unsafe { CryptProtectData(pdatain, szdatadescr.unwrap_or(core::mem::zeroed()) as _, poptionalentropy.unwrap_or(core::mem::zeroed()) as _, pvreserved.unwrap_or(core::mem::zeroed()) as _, ppromptstruct.unwrap_or(core::mem::zeroed()) as _, dwflags, pdataout as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CryptRegisterDefaultOIDFunction(dwencodingtype: u32, pszfuncname: windows_core::PCSTR, dwindex: u32, pwszdll: windows_core::PCWSTR) -> windows_core::BOOL {
    ...
    unsafe { CryptRegisterDefaultOIDFunction(dwencodingtype, core::mem::transmute(pszfuncname), dwindex, core::mem::transmute(pwszdll)) }
}
#[inline]
pub unsafe fn CryptRegisterOIDFunction(dwencodingtype: u32, pszfuncname: windows_core::PCSTR, pszoid: windows_core::PCSTR, pwszdll: Option<windows_core::PCWSTR>, pszoverridefuncname: Option<windows_core::PCSTR>) -> windows_core::BOOL {
    ...
    unsafe { CryptRegisterOIDFunction(dwencodingtype, core::mem::transmute(pszfuncname), core::mem::transmute(pszoid), pwszdll.unwrap_or(core::mem::zeroed()) as _, pszoverridefuncname.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn CryptRetrieveObjectByUrlA(pszurl: windows_core::PCSTR, pszobjectoid: Option<windows_core::PCSTR>, dwretrievalflags: u32, dwtimeout: u32, ppvobject: *mut *mut core::ffi::c_void, hasyncretrieve: Option<HCRYPTASYNC>, pcredentials: Option<*const CRYPT_CREDENTIALS>, pvverify: Option<*const core::ffi::c_void>, pauxinfo: Option<*mut CRYPT_RETRIEVE_AUX_INFO>) -> windows_core::BOOL {
    ...
    unsafe { CryptRetrieveObjectByUrlA(core::mem::transmute(pszurl), pszobjectoid.unwrap_or(core::mem::zeroed()) as _, dwretrievalflags, dwtimeout, ppvobject as _, hasyncretrieve.unwrap_or(core::mem::zeroed()) as _, pcredentials.unwrap_or(core::mem::zeroed()) as _, pvverify.unwrap_or(core::mem::zeroed()) as _, pauxinfo.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn CryptRetrieveObjectByUrlW(pszurl: windows_core::PCWSTR, pszobjectoid: Option<windows_core::PCSTR>, dwretrievalflags: u32, dwtimeout: u32, ppvobject: *mut *mut core::ffi::c_void, hasyncretrieve: Option<HCRYPTASYNC>, pcredentials: Option<*const CRYPT_CREDENTIALS>, pvverify: Option<*const core::ffi::c_void>, pauxinfo: Option<*mut CRYPT_RETRIEVE_AUX_INFO>) -> windows_core::BOOL {
    ...
    unsafe { CryptRetrieveObjectByUrlW(core::mem::transmute(pszurl), pszobjectoid.unwrap_or(core::mem::zeroed()) as _, dwretrievalflags, dwtimeout, ppvobject as _, hasyncretrieve.unwrap_or(core::mem::zeroed()) as _, pcredentials.unwrap_or(core::mem::zeroed()) as _, pvverify.unwrap_or(core::mem::zeroed()) as _, pauxinfo.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn CryptRetrieveTimeStamp(wszurl: windows_core::PCWSTR, dwretrievalflags: u32, dwtimeout: u32, pszhashid: windows_core::PCSTR, ppara: Option<*const CRYPT_TIMESTAMP_PARA>, pbdata: &[u8], pptscontext: *mut *mut CRYPT_TIMESTAMP_CONTEXT, pptssigner: *mut *mut CERT_CONTEXT, phstore: Option<*mut HCERTSTORE>) -> windows_core::Result<()> {
    ...
    unsafe { CryptRetrieveTimeStamp(core::mem::transmute(wszurl), dwretrievalflags, dwtimeout, core::mem::transmute(pszhashid), ppara.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pbdata.as_ptr()), pbdata.len().try_into().unwrap(), pptscontext as _, pptssigner as _, phstore.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn CryptSetAsyncParam(hasync: HCRYPTASYNC, pszparamoid: windows_core::PCSTR, pvparam: Option<*const core::ffi::c_void>, pfnfree: PFN_CRYPT_ASYNC_PARAM_FREE_FUNC) -> windows_core::BOOL {
    ...
    unsafe { CryptSetAsyncParam(hasync, core::mem::transmute(pszparamoid), pvparam.unwrap_or(core::mem::zeroed()) as _, pfnfree) }
}
#[inline]
...
#[inline]
pub unsafe fn CryptSetKeyIdentifierProperty(pkeyidentifier: *const CRYPT_INTEGER_BLOB, dwpropid: u32, dwflags: u32, pwszcomputername: Option<windows_core::PCWSTR>, pvreserved: Option<*const core::ffi::c_void>, pvdata: Option<*const core::ffi::c_void>) -> windows_core::Result<()> {
    ...
    unsafe { CryptSetKeyIdentifierProperty(pkeyidentifier, dwpropid, dwflags, pwszcomputername.unwrap_or(core::mem::zeroed()) as _, pvreserved.unwrap_or(core::mem::zeroed()) as _, pvdata.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CryptSetOIDFunctionValue(dwencodingtype: u32, pszfuncname: windows_core::PCSTR, pszoid: windows_core::PCSTR, pwszvaluename: Option<windows_core::PCWSTR>, dwvaluetype: super::super::System::Registry::REG_VALUE_TYPE, pbvaluedata: Option<&[u8]>) -> windows_core::BOOL {
    ...
    unsafe { CryptSetOIDFunctionValue(dwencodingtype, core::mem::transmute(pszfuncname), core::mem::transmute(pszoid), pwszvaluename.unwrap_or(core::mem::zeroed()) as _, dwvaluetype, core::mem::transmute(pbvaluedata.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pbvaluedata.as_deref().map_or(0, |slice| slice.len().try_into().unwrap())) }
}
#[inline]
...
#[inline]
pub unsafe fn CryptSetProviderA(pszprovname: windows_core::PCSTR, dwprovtype: u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptSetProviderA(core::mem::transmute(pszprovname), dwprovtype).ok() }
}
#[inline]
pub unsafe fn CryptSetProviderExA(pszprovname: windows_core::PCSTR, dwprovtype: u32, pdwreserved: Option<*const u32>, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptSetProviderExA(core::mem::transmute(pszprovname), dwprovtype, pdwreserved.unwrap_or(core::mem::zeroed()) as _, dwflags).ok() }
}
#[inline]
pub unsafe fn CryptSetProviderExW(pszprovname: windows_core::PCWSTR, dwprovtype: u32, pdwreserved: Option<*const u32>, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptSetProviderExW(core::mem::transmute(pszprovname), dwprovtype, pdwreserved.unwrap_or(core::mem::zeroed()) as _, dwflags).ok() }
}
#[inline]
pub unsafe fn CryptSetProviderW(pszprovname: windows_core::PCWSTR, dwprovtype: u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptSetProviderW(core::mem::transmute(pszprovname), dwprovtype).ok() }
}
#[inline]
pub unsafe fn CryptSignAndEncodeCertificate(hcryptprovorncryptkey: Option<HCRYPTPROV_OR_NCRYPT_KEY_HANDLE>, dwkeyspec: Option<CERT_KEY_SPEC>, dwcertencodingtype: CERT_QUERY_ENCODING_TYPE, lpszstructtype: windows_core::PCSTR, pvstructinfo: *const core::ffi::c_void, psignaturealgorithm: *const CRYPT_ALGORITHM_IDENTIFIER, pvhashauxinfo: Option<*const core::ffi::c_void>, pbencoded: Option<*mut u8>, pcbencoded: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptSignAndEncodeCertificate(hcryptprovorncryptkey.unwrap_or(core::mem::zeroed()) as _, dwkeyspec.unwrap_or(core::mem::zeroed()) as _, dwcertencodingtype, core::mem::transmute(lpszstructtype), pvstructinfo, psignaturealgorithm, pvhashauxinfo.unwrap_or(core::mem::zeroed()) as _, pbencoded.unwrap_or(core::mem::zeroed()) as _, pcbencoded as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CryptSignHashA(hhash: usize, dwkeyspec: u32, szdescription: Option<windows_core::PCSTR>, dwflags: u32, pbsignature: Option<*mut u8>, pdwsiglen: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptSignHashA(hhash, dwkeyspec, szdescription.unwrap_or(core::mem::zeroed()) as _, dwflags, pbsignature.unwrap_or(core::mem::zeroed()) as _, pdwsiglen as _).ok() }
}
#[inline]
pub unsafe fn CryptSignHashW(hhash: usize, dwkeyspec: u32, szdescription: Option<windows_core::PCWSTR>, dwflags: u32, pbsignature: Option<*mut u8>, pdwsiglen: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptSignHashW(hhash, dwkeyspec, szdescription.unwrap_or(core::mem::zeroed()) as _, dwflags, pbsignature.unwrap_or(core::mem::zeroed()) as _, pdwsiglen as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CryptUnregisterDefaultOIDFunction(dwencodingtype: u32, pszfuncname: windows_core::PCSTR, pwszdll: windows_core::PCWSTR) -> windows_core::BOOL {
    ...
    unsafe { CryptUnregisterDefaultOIDFunction(dwencodingtype, core::mem::transmute(pszfuncname), core::mem::transmute(pwszdll)) }
}
#[inline]
pub unsafe fn CryptUnregisterOIDFunction(dwencodingtype: u32, pszfuncname: windows_core::PCSTR, pszoid: windows_core::PCSTR) -> windows_core::BOOL {
    ...
    unsafe { CryptUnregisterOIDFunction(dwencodingtype, core::mem::transmute(pszfuncname), core::mem::transmute(pszoid)) }
}
#[inline]
...
#[inline]
pub unsafe fn CryptUpdateProtectedState(poldsid: Option<super::PSID>, pwszoldpassword: Option<windows_core::PCWSTR>, dwflags: u32, pdwsuccesscount: Option<*mut u32>, pdwfailurecount: Option<*mut u32>) -> windows_core::Result<()> {
    ...
    unsafe { CryptUpdateProtectedState(poldsid.unwrap_or(core::mem::zeroed()) as _, pwszoldpassword.unwrap_or(core::mem::zeroed()) as _, dwflags, pdwsuccesscount.unwrap_or(core::mem::zeroed()) as _, pdwfailurecount.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CryptVerifySignatureA(hhash: usize, pbsignature: &[u8], hpubkey: usize, szdescription: Option<windows_core::PCSTR>, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptVerifySignatureA(hhash, core::mem::transmute(pbsignature.as_ptr()), pbsignature.len().try_into().unwrap(), hpubkey, szdescription.unwrap_or(core::mem::zeroed()) as _, dwflags).ok() }
}
#[inline]
pub unsafe fn CryptVerifySignatureW(hhash: usize, pbsignature: &[u8], hpubkey: usize, szdescription: Option<windows_core::PCWSTR>, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { CryptVerifySignatureW(hhash, core::mem::transmute(pbsignature.as_ptr()), pbsignature.len().try_into().unwrap(), hpubkey, szdescription.unwrap_or(core::mem::zeroed()) as _, dwflags).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CryptXmlCreateReference(hcryptxml: *const core::ffi::c_void, dwflags: u32, wszid: Option<windows_core::PCWSTR>, wszuri: Option<windows_core::PCWSTR>, wsztype: Option<windows_core::PCWSTR>, pdigestmethod: *const CRYPT_XML_ALGORITHM, rgtransform: Option<&[CRYPT_XML_ALGORITHM]>, phreference: *mut *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { CryptXmlCreateReference(hcryptxml, dwflags, wszid.unwrap_or(core::mem::zeroed()) as _, wszuri.unwrap_or(core::mem::zeroed()) as _, wsztype.unwrap_or(core::mem::zeroed()) as _, pdigestmethod, rgtransform.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), core::mem::transmute(rgtransform.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), phreference as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CryptXmlOpenToEncode(pconfig: Option<*const CRYPT_XML_TRANSFORM_CHAIN_CONFIG>, dwflags: CRYPT_XML_FLAGS, wszid: Option<windows_core::PCWSTR>, rgproperty: Option<&[CRYPT_XML_PROPERTY]>, pencoded: Option<*const CRYPT_XML_BLOB>, phsignature: *mut *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { CryptXmlOpenToEncode(pconfig.unwrap_or(core::mem::zeroed()) as _, dwflags, wszid.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(rgproperty.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), rgproperty.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pencoded.unwrap_or(core::mem::zeroed()) as _, phsignature as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn FindCertsByIssuer(pcertchains: Option<*mut CERT_CHAIN>, pcbcertchains: *mut u32, pccertchains: *mut u32, pbencodedissuername: Option<&[u8]>, pwszpurpose: Option<windows_core::PCWSTR>, dwkeyspec: u32) -> windows_core::Result<()> {
    ...
    unsafe { FindCertsByIssuer(pcertchains.unwrap_or(core::mem::zeroed()) as _, pcbcertchains as _, pccertchains as _, core::mem::transmute(pbencodedissuername.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pbencodedissuername.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pwszpurpose.unwrap_or(core::mem::zeroed()) as _, dwkeyspec).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn GenerateDerivedKey(hcrypto: *const INFORMATIONCARD_CRYPTO_HANDLE, plabel: &[u8], pnonce: &[u8], derivedkeylength: u32, offset: u32, algid: windows_core::PCWSTR, pcbkey: *mut u32, ppkey: *mut *mut u8) -> windows_core::Result<()> {
    ...
    unsafe { GenerateDerivedKey(hcrypto, plabel.len().try_into().unwrap(), core::mem::transmute(plabel.as_ptr()), pnonce.len().try_into().unwrap(), core::mem::transmute(pnonce.as_ptr()), derivedkeylength, offset, core::mem::transmute(algid), pcbkey as _, ppkey as _).ok() }
}
#[inline]
pub unsafe fn GetAsymmetricEncryptionInterface(pszprovidername: windows_core::PCWSTR, pszalgid: windows_core::PCWSTR, ppfunctiontable: *mut *mut BCRYPT_ASYMMETRIC_ENCRYPTION_FUNCTION_TABLE, dwflags: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { GetAsymmetricEncryptionInterface(core::mem::transmute(pszprovidername), core::mem::transmute(pszalgid), ppfunctiontable as _, dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn GetCipherInterface(pszprovidername: windows_core::PCWSTR, pszalgid: windows_core::PCWSTR, ppfunctiontable: *mut *mut BCRYPT_CIPHER_FUNCTION_TABLE, dwflags: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { GetCipherInterface(core::mem::transmute(pszprovidername), core::mem::transmute(pszalgid), ppfunctiontable as _, dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn GetHashInterface(pszprovidername: windows_core::PCWSTR, pszalgid: windows_core::PCWSTR, ppfunctiontable: *mut *mut BCRYPT_HASH_FUNCTION_TABLE, dwflags: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { GetHashInterface(core::mem::transmute(pszprovidername), core::mem::transmute(pszalgid), ppfunctiontable as _, dwflags) }
}
#[inline]
pub unsafe fn GetKeyDerivationInterface(pszprovidername: windows_core::PCWSTR, pszalgid: windows_core::PCWSTR, ppfunctiontable: *mut *mut BCRYPT_KEY_DERIVATION_FUNCTION_TABLE, dwflags: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { GetKeyDerivationInterface(core::mem::transmute(pszprovidername), core::mem::transmute(pszalgid), ppfunctiontable as _, dwflags) }
}
#[inline]
pub unsafe fn GetKeyStorageInterface(pszprovidername: windows_core::PCWSTR, ppfunctiontable: *mut *mut NCRYPT_KEY_STORAGE_FUNCTION_TABLE, dwflags: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { GetKeyStorageInterface(core::mem::transmute(pszprovidername), ppfunctiontable as _, dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn GetRngInterface(pszprovidername: windows_core::PCWSTR, ppfunctiontable: *mut *mut BCRYPT_RNG_FUNCTION_TABLE, dwflags: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { GetRngInterface(core::mem::transmute(pszprovidername), ppfunctiontable as _, dwflags) }
}
#[inline]
pub unsafe fn GetSChannelInterface(pszprovidername: windows_core::PCWSTR, ppfunctiontable: *mut *mut NCRYPT_SSL_FUNCTION_TABLE, dwflags: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { GetSChannelInterface(core::mem::transmute(pszprovidername), ppfunctiontable as _, dwflags) }
}
#[inline]
pub unsafe fn GetSecretAgreementInterface(pszprovidername: windows_core::PCWSTR, pszalgid: windows_core::PCWSTR, ppfunctiontable: *mut *mut BCRYPT_SECRET_AGREEMENT_FUNCTION_TABLE, dwflags: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { GetSecretAgreementInterface(core::mem::transmute(pszprovidername), core::mem::transmute(pszalgid), ppfunctiontable as _, dwflags) }
}
#[inline]
pub unsafe fn GetSignatureInterface(pszprovidername: windows_core::PCWSTR, pszalgid: windows_core::PCWSTR, ppfunctiontable: *mut *mut BCRYPT_SIGNATURE_FUNCTION_TABLE, dwflags: u32) -> windows_core::NTSTATUS {
    ...
    unsafe { GetSignatureInterface(core::mem::transmute(pszprovidername), core::mem::transmute(pszalgid), ppfunctiontable as _, dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn ImportInformationCard(filename: windows_core::PCWSTR) -> windows_core::Result<()> {
    windows_core::link!("infocardapi.dll" "system" fn ImportInformationCard(filename : windows_core::PCWSTR) -> windows_core::HRESULT);
    unsafe { ImportInformationCard(core::mem::transmute(filename)).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn NCryptCreatePersistedKey(hprovider: NCRYPT_PROV_HANDLE, phkey: *mut NCRYPT_KEY_HANDLE, pszalgid: windows_core::PCWSTR, pszkeyname: Option<windows_core::PCWSTR>, dwlegacykeyspec: CERT_KEY_SPEC, dwflags: NCRYPT_FLAGS) -> windows_core::Result<()> {
    ...
    unsafe { NCryptCreatePersistedKey(hprovider, phkey as _, core::mem::transmute(pszalgid), pszkeyname.unwrap_or(core::mem::zeroed()) as _, dwlegacykeyspec, dwflags).ok() }
}
#[inline]
pub unsafe fn NCryptCreateProtectionDescriptor(pwszdescriptorstring: windows_core::PCWSTR, dwflags: u32) -> windows_core::Result<super::NCRYPT_DESCRIPTOR_HANDLE> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        NCryptCreateProtectionDescriptor(core::mem::transmute(pwszdescriptorstring), dwflags, &mut result__).map(|| result__)
    }
}
#[inline]
...
#[inline]
pub unsafe fn NCryptDeriveKey(hsharedsecret: NCRYPT_SECRET_HANDLE, pwszkdf: windows_core::PCWSTR, pparameterlist: Option<*const BCryptBufferDesc>, pbderivedkey: Option<&mut [u8]>, pcbresult: *mut u32, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { NCryptDeriveKey(hsharedsecret, core::mem::transmute(pwszkdf), pparameterlist.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pbderivedkey.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pbderivedkey.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pcbresult as _, dwflags).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn NCryptEnumKeys(hprovider: NCRYPT_PROV_HANDLE, pszscope: Option<windows_core::PCWSTR>, ppkeyname: *mut *mut NCryptKeyName, ppenumstate: *mut *mut core::ffi::c_void, dwflags: NCRYPT_FLAGS) -> windows_core::Result<()> {
    ...
    unsafe { NCryptEnumKeys(hprovider, pszscope.unwrap_or(core::mem::zeroed()) as _, ppkeyname as _, ppenumstate as _, dwflags).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn NCryptExportKey(hkey: NCRYPT_KEY_HANDLE, hexportkey: Option<NCRYPT_KEY_HANDLE>, pszblobtype: windows_core::PCWSTR, pparameterlist: Option<*const BCryptBufferDesc>, pboutput: Option<&mut [u8]>, pcbresult: *mut u32, dwflags: NCRYPT_FLAGS) -> windows_core::Result<()> {
    ...
    unsafe { NCryptExportKey(hkey, hexportkey.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pszblobtype), pparameterlist.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pboutput.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pboutput.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pcbresult as _, dwflags).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn NCryptGetProperty(hobject: NCRYPT_HANDLE, pszproperty: windows_core::PCWSTR, pboutput: Option<&mut [u8]>, pcbresult: *mut u32, dwflags: super::OBJECT_SECURITY_INFORMATION) -> windows_core::Result<()> {
    ...
    unsafe { NCryptGetProperty(hobject, core::mem::transmute(pszproperty), core::mem::transmute(pboutput.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pboutput.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pcbresult as _, dwflags).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn NCryptImportKey(hprovider: NCRYPT_PROV_HANDLE, himportkey: Option<NCRYPT_KEY_HANDLE>, pszblobtype: windows_core::PCWSTR, pparameterlist: Option<*const BCryptBufferDesc>, phkey: *mut NCRYPT_KEY_HANDLE, pbdata: &[u8], dwflags: NCRYPT_FLAGS) -> windows_core::Result<()> {
    ...
    unsafe { NCryptImportKey(hprovider, himportkey.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pszblobtype), pparameterlist.unwrap_or(core::mem::zeroed()) as _, phkey as _, core::mem::transmute(pbdata.as_ptr()), pbdata.len().try_into().unwrap(), dwflags).ok() }
}
#[inline]
pub unsafe fn NCryptIsAlgSupported(hprovider: NCRYPT_PROV_HANDLE, pszalgid: windows_core::PCWSTR, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { NCryptIsAlgSupported(hprovider, core::mem::transmute(pszalgid), dwflags).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn NCryptOpenKey(hprovider: NCRYPT_PROV_HANDLE, phkey: *mut NCRYPT_KEY_HANDLE, pszkeyname: windows_core::PCWSTR, dwlegacykeyspec: CERT_KEY_SPEC, dwflags: NCRYPT_FLAGS) -> windows_core::Result<()> {
    ...
    unsafe { NCryptOpenKey(hprovider, phkey as _, core::mem::transmute(pszkeyname), dwlegacykeyspec, dwflags).ok() }
}
#[inline]
pub unsafe fn NCryptOpenStorageProvider(phprovider: *mut NCRYPT_PROV_HANDLE, pszprovidername: Option<windows_core::PCWSTR>, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { NCryptOpenStorageProvider(phprovider as _, pszprovidername.unwrap_or(core::mem::zeroed()) as _, dwflags).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn NCryptQueryProtectionDescriptorName(pwszname: windows_core::PCWSTR, pwszdescriptorstring: Option<windows_core::PWSTR>, pcdescriptorstring: *mut usize, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { NCryptQueryProtectionDescriptorName(core::mem::transmute(pwszname), pwszdescriptorstring.unwrap_or(core::mem::zeroed()) as _, pcdescriptorstring as _, dwflags).ok() }
}
#[inline]
pub unsafe fn NCryptRegisterProtectionDescriptorName(pwszname: windows_core::PCWSTR, pwszdescriptorstring: Option<windows_core::PCWSTR>, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { NCryptRegisterProtectionDescriptorName(core::mem::transmute(pwszname), pwszdescriptorstring.unwrap_or(core::mem::zeroed()) as _, dwflags).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn NCryptSetProperty(hobject: NCRYPT_HANDLE, pszproperty: windows_core::PCWSTR, pbinput: &[u8], dwflags: NCRYPT_FLAGS) -> windows_core::Result<()> {
    ...
    unsafe { NCryptSetProperty(hobject, core::mem::transmute(pszproperty), core::mem::transmute(pbinput.as_ptr()), pbinput.len().try_into().unwrap(), dwflags).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn PFXExportCertStore(hstore: HCERTSTORE, ppfx: *mut CRYPT_INTEGER_BLOB, szpassword: windows_core::PCWSTR, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { PFXExportCertStore(hstore, ppfx as _, core::mem::transmute(szpassword), dwflags).ok() }
}
#[inline]
pub unsafe fn PFXExportCertStoreEx(hstore: HCERTSTORE, ppfx: *mut CRYPT_INTEGER_BLOB, szpassword: windows_core::PCWSTR, pvpara: *const core::ffi::c_void, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { PFXExportCertStoreEx(hstore, ppfx as _, core::mem::transmute(szpassword), pvpara, dwflags).ok() }
}
#[inline]
pub unsafe fn PFXImportCertStore(ppfx: *const CRYPT_INTEGER_BLOB, szpassword: windows_core::PCWSTR, dwflags: CRYPT_KEY_FLAGS) -> windows_core::Result<HCERTSTORE> {
    ...
    let result__ = unsafe { PFXImportCertStore(ppfx, core::mem::transmute(szpassword), dwflags) };
    (!result__.is_invalid()).then_some(result__).ok_or_else(windows_core::Error::from_thread)
}
#[inline]
...
#[inline]
pub unsafe fn PFXVerifyPassword(ppfx: *const CRYPT_INTEGER_BLOB, szpassword: windows_core::PCWSTR, dwflags: u32) -> windows_core::BOOL {
    ...
    unsafe { PFXVerifyPassword(ppfx, core::mem::transmute(szpassword), dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn SignHash(hcrypto: *const INFORMATIONCARD_CRYPTO_HANDLE, phash: &[u8], hashalgoid: windows_core::PCWSTR, pcbsig: *mut u32, ppsig: *mut *mut u8) -> windows_core::Result<()> {
    ...
    unsafe { SignHash(hcrypto, phash.len().try_into().unwrap(), core::mem::transmute(phash.as_ptr()), core::mem::transmute(hashalgoid), pcbsig as _, ppsig as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn SignerSign(psubjectinfo: *const SIGNER_SUBJECT_INFO, psignercert: *const SIGNER_CERT, psignatureinfo: *const SIGNER_SIGNATURE_INFO, pproviderinfo: Option<*const SIGNER_PROVIDER_INFO>, pwszhttptimestamp: Option<windows_core::PCWSTR>, psrequest: Option<*const CRYPT_ATTRIBUTES>, psipdata: Option<*const core::ffi::c_void>) -> windows_core::Result<()> {
    ...
    unsafe { SignerSign(psubjectinfo, psignercert, psignatureinfo, pproviderinfo.unwrap_or(core::mem::zeroed()) as _, pwszhttptimestamp.unwrap_or(core::mem::zeroed()) as _, psrequest.unwrap_or(core::mem::zeroed()) as _, psipdata.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn SignerSignEx(dwflags: SIGNER_SIGN_FLAGS, psubjectinfo: *const SIGNER_SUBJECT_INFO, psignercert: *const SIGNER_CERT, psignatureinfo: *const SIGNER_SIGNATURE_INFO, pproviderinfo: Option<*const SIGNER_PROVIDER_INFO>, pwszhttptimestamp: Option<windows_core::PCWSTR>, psrequest: Option<*const CRYPT_ATTRIBUTES>, psipdata: Option<*const core::ffi::c_void>) -> windows_core::Result<*mut SIGNER_CONTEXT> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        SignerSignEx(dwflags, psubjectinfo, psignercert, psignatureinfo, pproviderinfo.unwrap_or(core::mem::zeroed()) as _, pwszhttptimestamp.unwrap_or(core::mem::zeroed()) as _, psrequest.unwrap_or(core::mem::zeroed()) as _, psipdata.unwrap_or(core::mem::zeroed()) as _, &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn SignerSignEx2(dwflags: SIGNER_SIGN_FLAGS, psubjectinfo: *const SIGNER_SUBJECT_INFO, psignercert: *const SIGNER_CERT, psignatureinfo: *const SIGNER_SIGNATURE_INFO, pproviderinfo: Option<*const SIGNER_PROVIDER_INFO>, dwtimestampflags: Option<SIGNER_TIMESTAMP_FLAGS>, psztimestampalgorithmoid: Option<windows_core::PCSTR>, pwszhttptimestamp: Option<windows_core::PCWSTR>, psrequest: Option<*const CRYPT_ATTRIBUTES>, psipdata: Option<*const core::ffi::c_void>, ppsignercontext: *mut *mut SIGNER_CONTEXT, pcryptopolicy: Option<*const CERT_STRONG_SIGN_PARA>, preserved: Option<*const core::ffi::c_void>) -> windows_core::Result<()> {
    ...
    unsafe {
        SignerSignEx2(
            ...
            psztimestampalgorithmoid.unwrap_or(core::mem::zeroed()) as _,
            pwszhttptimestamp.unwrap_or(core::mem::zeroed()) as _,
...
#[inline]
pub unsafe fn SignerTimeStamp(psubjectinfo: *const SIGNER_SUBJECT_INFO, pwszhttptimestamp: windows_core::PCWSTR, psrequest: Option<*const CRYPT_ATTRIBUTES>, psipdata: Option<*const core::ffi::c_void>) -> windows_core::Result<()> {
    ...
    unsafe { SignerTimeStamp(psubjectinfo, core::mem::transmute(pwszhttptimestamp), psrequest.unwrap_or(core::mem::zeroed()) as _, psipdata.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn SignerTimeStampEx(dwflags: Option<u32>, psubjectinfo: *const SIGNER_SUBJECT_INFO, pwszhttptimestamp: windows_core::PCWSTR, psrequest: *const CRYPT_ATTRIBUTES, psipdata: *const core::ffi::c_void) -> windows_core::Result<*mut SIGNER_CONTEXT> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        SignerTimeStampEx(dwflags.unwrap_or(core::mem::zeroed()) as _, psubjectinfo, core::mem::transmute(pwszhttptimestamp), psrequest, psipdata, &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn SignerTimeStampEx2(dwflags: Option<SIGNER_TIMESTAMP_FLAGS>, psubjectinfo: *const SIGNER_SUBJECT_INFO, pwszhttptimestamp: windows_core::PCWSTR, dwalgid: ALG_ID, psrequest: *const CRYPT_ATTRIBUTES, psipdata: *const core::ffi::c_void) -> windows_core::Result<*mut SIGNER_CONTEXT> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        SignerTimeStampEx2(dwflags.unwrap_or(core::mem::zeroed()) as _, psubjectinfo, core::mem::transmute(pwszhttptimestamp), dwalgid, psrequest, psipdata, &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn SignerTimeStampEx3(dwflags: SIGNER_TIMESTAMP_FLAGS, dwindex: u32, psubjectinfo: *const SIGNER_SUBJECT_INFO, pwszhttptimestamp: windows_core::PCWSTR, pszalgorithmoid: windows_core::PCWSTR, psrequest: Option<*const CRYPT_ATTRIBUTES>, psipdata: Option<*const core::ffi::c_void>, ppsignercontext: *mut *mut SIGNER_CONTEXT, pcryptopolicy: Option<*const CERT_STRONG_SIGN_PARA>, preserved: Option<*const core::ffi::c_void>) -> windows_core::Result<()> {
    ...
    unsafe { SignerTimeStampEx3(dwflags, dwindex, psubjectinfo, core::mem::transmute(pwszhttptimestamp), core::mem::transmute(pszalgorithmoid), psrequest.unwrap_or(core::mem::zeroed()) as _, psipdata.unwrap_or(core::mem::zeroed()) as _, ppsignercontext as _, pcryptopolicy.unwrap_or(core::mem::zeroed()) as _, preserved.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn SslComputeClientAuthHash(hsslprovider: NCRYPT_PROV_HANDLE, hmasterkey: NCRYPT_KEY_HANDLE, hhandshakehash: NCRYPT_HASH_HANDLE, pszalgid: windows_core::PCWSTR, pboutput: Option<&mut [u8]>, pcbresult: *mut u32, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { SslComputeClientAuthHash(hsslprovider, hmasterkey, hhandshakehash, core::mem::transmute(pszalgid), core::mem::transmute(pboutput.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pboutput.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pcbresult as _, dwflags).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn SslCreateClientAuthHash(hsslprovider: NCRYPT_PROV_HANDLE, phhandshakehash: *mut NCRYPT_HASH_HANDLE, dwprotocol: u32, dwciphersuite: u32, pszhashalgid: windows_core::PCWSTR, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { SslCreateClientAuthHash(hsslprovider, phhandshakehash as _, dwprotocol, dwciphersuite, core::mem::transmute(pszhashalgid), dwflags).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn SslExportKey(hsslprovider: NCRYPT_PROV_HANDLE, hkey: NCRYPT_KEY_HANDLE, pszblobtype: windows_core::PCWSTR, pboutput: Option<&mut [u8]>, pcbresult: *mut u32, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { SslExportKey(hsslprovider, hkey, core::mem::transmute(pszblobtype), core::mem::transmute(pboutput.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pboutput.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pcbresult as _, dwflags).ok() }
}
#[inline]
pub unsafe fn SslExportKeyingMaterial(hsslprovider: NCRYPT_PROV_HANDLE, hmasterkey: NCRYPT_KEY_HANDLE, slabel: windows_core::PCSTR, pbrandoms: Option<&[u8]>, pbcontextvalue: Option<&[u8]>, pboutput: &mut [u8], dwflags: u32) -> windows_core::Result<()> {
...
#[inline]
pub unsafe fn SslGetKeyProperty(hkey: NCRYPT_KEY_HANDLE, pszproperty: windows_core::PCWSTR, ppboutput: *mut *mut u8, pcboutput: *mut u32, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { SslGetKeyProperty(hkey, core::mem::transmute(pszproperty), ppboutput as _, pcboutput as _, dwflags).ok() }
}
#[inline]
pub unsafe fn SslGetProviderProperty(hsslprovider: NCRYPT_PROV_HANDLE, pszproperty: windows_core::PCWSTR, ppboutput: *mut *mut u8, pcboutput: *mut u32, ppenumstate: Option<*mut *mut core::ffi::c_void>, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { SslGetProviderProperty(hsslprovider, core::mem::transmute(pszproperty), ppboutput as _, pcboutput as _, ppenumstate.unwrap_or(core::mem::zeroed()) as _, dwflags).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn SslImportKey(hsslprovider: NCRYPT_PROV_HANDLE, phkey: *mut NCRYPT_KEY_HANDLE, pszblobtype: windows_core::PCWSTR, pbkeyblob: &[u8], dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { SslImportKey(hsslprovider, phkey as _, core::mem::transmute(pszblobtype), core::mem::transmute(pbkeyblob.as_ptr()), pbkeyblob.len().try_into().unwrap(), dwflags).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn SslOpenProvider(phsslprovider: *mut NCRYPT_PROV_HANDLE, pszprovidername: windows_core::PCWSTR, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { SslOpenProvider(phsslprovider as _, core::mem::transmute(pszprovidername), dwflags).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn VerifyHash(hcrypto: *const INFORMATIONCARD_CRYPTO_HANDLE, phash: &[u8], hashalgoid: windows_core::PCWSTR, psig: &[u8]) -> windows_core::Result<windows_core::BOOL> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        VerifyHash(hcrypto, phash.len().try_into().unwrap(), core::mem::transmute(phash.as_ptr()), core::mem::transmute(hashalgoid), psig.len().try_into().unwrap(), core::mem::transmute(psig.as_ptr()), &mut result__).map(|| result__)
    }
}
