...
impl ICertSrvSetupVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ICertSrvSetupImpl, const OFFSET: isize>() -> ICertSrvSetupVtbl {
...
impl ICertSrvSetupKeyInformationVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ICertSrvSetupKeyInformationImpl, const OFFSET: isize>() -> ICertSrvSetupKeyInformationVtbl {
...
impl ICertSrvSetupKeyInformationCollectionVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ICertSrvSetupKeyInformationCollectionImpl, const OFFSET: isize>() -> ICertSrvSetupKeyInformationCollectionVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<ICertSrvSetupKeyInformationCollection>, ::windows::core::GetTrustLevel, _NewEnum::<Impl, OFFSET>, Item::<Impl, OFFSET>, Count::<Impl, OFFSET>, Add::<Impl, OFFSET>)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
impl ICertificateEnrollmentPolicyServerSetupVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ICertificateEnrollmentPolicyServerSetupImpl, const OFFSET: isize>() -> ICertificateEnrollmentPolicyServerSetupVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<ICertificateEnrollmentPolicyServerSetup>, ::windows::core::GetTrustLevel, ErrorString::<Impl, OFFSET>, InitializeInstallDefaults::<Impl, OFFSET>, GetProperty::<Impl, OFFSET>, SetProperty::<Impl, OFFSET>, Install::<Impl, OFFSET>, UnInstall::<Impl, OFFSET>)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
impl ICertificateEnrollmentServerSetupVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ICertificateEnrollmentServerSetupImpl, const OFFSET: isize>() -> ICertificateEnrollmentServerSetupVtbl {
        ...
        Self(
            ...
            ::windows::core::Release::<Identity, OFFSET>,
            ::windows::core::GetIids,
            ::windows::core::GetRuntimeClassName::<ICertificateEnrollmentServerSetup>,
            ::windows::core::GetTrustLevel,
            ErrorString::<Impl, OFFSET>,
            InitializeInstallDefaults::<Impl, OFFSET>,
            GetProperty::<Impl, OFFSET>,
            SetProperty::<Impl, OFFSET>,
            SetApplicationPoolCredentials::<Impl, OFFSET>,
            Install::<Impl, OFFSET>,
...
impl IMSCEPSetupVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IMSCEPSetupImpl, const OFFSET: isize>() -> IMSCEPSetupVtbl {
