...
#[inline]
pub unsafe fn CryptUIDlgSelectCertificateFromStore(hcertstore: super::HCERTSTORE, hwnd: Option<super::super::super::Foundation::HWND>, pwsztitle: Option<windows_core::PCWSTR>, pwszdisplaystring: Option<windows_core::PCWSTR>, dwdontusecolumn: u32, dwflags: u32, pvreserved: *const core::ffi::c_void) -> *mut super::CERT_CONTEXT {
    ...
    unsafe { CryptUIDlgSelectCertificateFromStore(hcertstore, hwnd.unwrap_or(core::mem::zeroed()) as _, pwsztitle.unwrap_or(core::mem::zeroed()) as _, pwszdisplaystring.unwrap_or(core::mem::zeroed()) as _, dwdontusecolumn, dwflags, pvreserved) }
}
...
#[inline]
pub unsafe fn CryptUIDlgViewContext(dwcontexttype: u32, pvcontext: *const core::ffi::c_void, hwnd: Option<super::super::super::Foundation::HWND>, pwsztitle: Option<windows_core::PCWSTR>, dwflags: u32, pvreserved: *const core::ffi::c_void) -> windows_core::BOOL {
    ...
    unsafe { CryptUIDlgViewContext(dwcontexttype, pvcontext, hwnd.unwrap_or(core::mem::zeroed()) as _, pwsztitle.unwrap_or(core::mem::zeroed()) as _, dwflags, pvreserved) }
}
#[inline]
pub unsafe fn CryptUIWizDigitalSign(dwflags: u32, hwndparent: Option<super::super::super::Foundation::HWND>, pwszwizardtitle: Option<windows_core::PCWSTR>, pdigitalsigninfo: *const CRYPTUI_WIZ_DIGITAL_SIGN_INFO, ppsigncontext: Option<*mut *mut CRYPTUI_WIZ_DIGITAL_SIGN_CONTEXT>) -> windows_core::BOOL {
    ...
    unsafe { CryptUIWizDigitalSign(dwflags, hwndparent.unwrap_or(core::mem::zeroed()) as _, pwszwizardtitle.unwrap_or(core::mem::zeroed()) as _, pdigitalsigninfo, ppsigncontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn CryptUIWizExport(dwflags: CRYPTUI_WIZ_FLAGS, hwndparent: Option<super::super::super::Foundation::HWND>, pwszwizardtitle: Option<windows_core::PCWSTR>, pexportinfo: *const CRYPTUI_WIZ_EXPORT_INFO, pvoid: Option<*const core::ffi::c_void>) -> windows_core::Result<()> {
    ...
    unsafe { CryptUIWizExport(dwflags, hwndparent.unwrap_or(core::mem::zeroed()) as _, pwszwizardtitle.unwrap_or(core::mem::zeroed()) as _, pexportinfo, pvoid.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn CryptUIWizImport(dwflags: CRYPTUI_WIZ_FLAGS, hwndparent: Option<super::super::super::Foundation::HWND>, pwszwizardtitle: Option<windows_core::PCWSTR>, pimportsrc: Option<*const CRYPTUI_WIZ_IMPORT_SRC_INFO>, hdestcertstore: Option<super::HCERTSTORE>) -> windows_core::Result<()> {
    ...
    unsafe { CryptUIWizImport(dwflags, hwndparent.unwrap_or(core::mem::zeroed()) as _, pwszwizardtitle.unwrap_or(core::mem::zeroed()) as _, pimportsrc.unwrap_or(core::mem::zeroed()) as _, hdestcertstore.unwrap_or(core::mem::zeroed()) as _).ok() }
}
