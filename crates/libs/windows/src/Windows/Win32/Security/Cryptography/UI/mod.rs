...
pub unsafe fn CertSelectionGetSerializedBlob(pcsi: *const CERT_SELECTUI_INPUT, ppoutbuffer: *mut *mut core::ffi::c_void, puloutbuffersize: *mut u32) -> windows_core::Result<()> {
    ...
    CertSelectionGetSerializedBlob(pcsi, core::mem::transmute(ppoutbuffer), core::mem::transmute(puloutbuffersize)).ok()
}
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    CryptUIDlgSelectCertificateFromStore(hcertstore, core::mem::transmute(hwnd.unwrap_or(core::mem::zeroed())), pwsztitle.param().abi(), pwszdisplaystring.param().abi(), dwdontusecolumn, dwflags, pvreserved)
}
...
pub unsafe fn CryptUIDlgViewCertificateA(pcertviewinfo: *const CRYPTUI_VIEWCERTIFICATE_STRUCTA, pfpropertieschanged: *mut super::super::super::Foundation::BOOL) -> windows_core::Result<()> {
    ...
    CryptUIDlgViewCertificateA(pcertviewinfo, core::mem::transmute(pfpropertieschanged)).ok()
}
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_Security_Cryptography_Catalog", feature = "Win32_Security_Cryptography_Sip", feature = "Win32_Security_WinTrust", feature = "Win32_UI_Controls", feature = "Win32_UI_WindowsAndMessaging"))]
#[inline]
pub unsafe fn CryptUIDlgViewCertificateW(pcertviewinfo: *const CRYPTUI_VIEWCERTIFICATE_STRUCTW, pfpropertieschanged: *mut super::super::super::Foundation::BOOL) -> windows_core::Result<()> {
    ...
    CryptUIDlgViewCertificateW(pcertviewinfo, core::mem::transmute(pfpropertieschanged)).ok()
}
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    CryptUIDlgViewContext(dwcontexttype, pvcontext, core::mem::transmute(hwnd.unwrap_or(core::mem::zeroed())), pwsztitle.param().abi(), dwflags, pvreserved)
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    CryptUIWizDigitalSign(dwflags, core::mem::transmute(hwndparent.unwrap_or(core::mem::zeroed())), pwszwizardtitle.param().abi(), pdigitalsigninfo, core::mem::transmute(ppsigncontext.unwrap_or(core::mem::zeroed())))
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    CryptUIWizExport(dwflags, core::mem::transmute(hwndparent.unwrap_or(core::mem::zeroed())), pwszwizardtitle.param().abi(), pexportinfo, core::mem::transmute(pvoid.unwrap_or(core::mem::zeroed()))).ok()
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    CryptUIWizImport(dwflags, core::mem::transmute(hwndparent.unwrap_or(core::mem::zeroed())), pwszwizardtitle.param().abi(), core::mem::transmute(pimportsrc.unwrap_or(core::mem::zeroed())), core::mem::transmute(hdestcertstore.unwrap_or(core::mem::zeroed()))).ok()
}
