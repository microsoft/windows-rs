...
#[inline]
pub unsafe fn CryptUIDlgSelectCertificateFromStore<P2, P3>(hcertstore: super::HCERTSTORE, hwnd: super::super::super::Foundation::HWND, pwsztitle: P2, pwszdisplaystring: P3, dwdontusecolumn: u32, dwflags: u32, pvreserved: *const core::ffi::c_void) -> *mut super::CERT_CONTEXT
where
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { CryptUIDlgSelectCertificateFromStore(hcertstore, hwnd, pwsztitle.param().abi(), pwszdisplaystring.param().abi(), dwdontusecolumn, dwflags, pvreserved) }
}
...
#[inline]
pub unsafe fn CryptUIDlgViewContext<P3>(dwcontexttype: u32, pvcontext: *const core::ffi::c_void, hwnd: super::super::super::Foundation::HWND, pwsztitle: P3, dwflags: u32, pvreserved: *const core::ffi::c_void) -> windows_core::BOOL
where
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { CryptUIDlgViewContext(dwcontexttype, pvcontext, hwnd, pwsztitle.param().abi(), dwflags, pvreserved) }
}
#[inline]
pub unsafe fn CryptUIWizDigitalSign<P2>(dwflags: u32, hwndparent: super::super::super::Foundation::HWND, pwszwizardtitle: P2, pdigitalsigninfo: *const CRYPTUI_WIZ_DIGITAL_SIGN_INFO, ppsigncontext: *mut *mut CRYPTUI_WIZ_DIGITAL_SIGN_CONTEXT) -> windows_core::BOOL
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { CryptUIWizDigitalSign(dwflags, hwndparent, pwszwizardtitle.param().abi(), pdigitalsigninfo, ppsigncontext as _) }
}
#[inline]
pub unsafe fn CryptUIWizExport<P2>(dwflags: CRYPTUI_WIZ_FLAGS, hwndparent: super::super::super::Foundation::HWND, pwszwizardtitle: P2, pexportinfo: *const CRYPTUI_WIZ_EXPORT_INFO, pvoid: *const core::ffi::c_void) -> windows_core::BOOL
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { CryptUIWizExport(dwflags, hwndparent, pwszwizardtitle.param().abi(), pexportinfo, pvoid) }
}
#[inline]
