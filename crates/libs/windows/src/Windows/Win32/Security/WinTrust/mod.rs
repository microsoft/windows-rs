...
pub const CAT_MEMBERINFO2_STRUCT: windows_core::PCSTR = 2223i32 as _;
pub const CAT_MEMBERINFO_OBJID: windows_core::PCSTR = windows_core::s!("1.3.6.1.4.1.311.12.2.2");
pub const CAT_MEMBERINFO_STRUCT: windows_core::PCSTR = 2222i32 as _;
pub const CAT_NAMEVALUE_OBJID: windows_core::PCSTR = windows_core::s!("1.3.6.1.4.1.311.12.2.1");
pub const CAT_NAMEVALUE_STRUCT: windows_core::PCSTR = 2221i32 as _;
...
pub const INTENT_TO_SEAL_ATTRIBUTE_STRUCT: windows_core::PCSTR = 2010i32 as _;
...
pub const SEALING_SIGNATURE_ATTRIBUTE_STRUCT: windows_core::PCSTR = 2011i32 as _;
pub const SEALING_TIMESTAMP_ATTRIBUTE_STRUCT: windows_core::PCSTR = 2012i32 as _;
...
pub const SPC_CAB_DATA_STRUCT: windows_core::PCSTR = 2008i32 as _;
...
pub const SPC_FINANCIAL_CRITERIA_STRUCT: windows_core::PCSTR = 2002i32 as _;
pub const SPC_GLUE_RDN_OBJID: windows_core::PCSTR = windows_core::s!("1.3.6.1.4.1.311.2.1.25");
pub const SPC_INDIRECT_DATA_CONTENT_STRUCT: windows_core::PCSTR = 2003i32 as _;
...
pub const SPC_JAVA_CLASS_DATA_STRUCT: windows_core::PCSTR = 2009i32 as _;
pub const SPC_LINK_OBJID: windows_core::PCSTR = windows_core::s!("1.3.6.1.4.1.311.2.1.28");
pub const SPC_LINK_STRUCT: windows_core::PCSTR = 2005i32 as _;
pub const SPC_MINIMAL_CRITERIA_OBJID: windows_core::PCSTR = windows_core::s!("1.3.6.1.4.1.311.2.1.26");
pub const SPC_MINIMAL_CRITERIA_STRUCT: windows_core::PCSTR = 2001i32 as _;
...
pub const SPC_PE_IMAGE_DATA_STRUCT: windows_core::PCSTR = 2004i32 as _;
...
#[repr(C)]
#[cfg(all(feature = "Win32_Security_Cryptography", feature = "Win32_Security_Cryptography_Catalog", feature = "Win32_Security_Cryptography_Sip"))]
#[derive(Clone, Copy, Debug, PartialEq)]
