    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { WintrustAddDefaultForUsage(core::mem::transmute_copy(&pszusageoid.param().borrow()), psdefusage).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { WintrustGetDefaultForUsage(dwaction, core::mem::transmute_copy(&pszusageoid.param().borrow()), psusage as _).ok() }
}
#[inline]
