    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        ...
        RegisterLicenseKeyWithExpiration(core::mem::transmute_copy(&licensekey.param().borrow()), validityindays, &mut result__).map(|| result__)
    }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { ValidateLicenseKeyProtection(core::mem::transmute_copy(&licensekey.param().borrow()), notvalidbefore as _, notvalidafter as _, status as _).ok() }
}
