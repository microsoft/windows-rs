...
pub const SCE_LOG_LEVEL_ALWAYS: SCE_LOG_ERR_LEVEL = 0i32;
pub const SCE_LOG_LEVEL_DEBUG: SCE_LOG_ERR_LEVEL = 3i32;
pub const SCE_LOG_LEVEL_DETAIL: SCE_LOG_ERR_LEVEL = 2i32;
pub const SCE_LOG_LEVEL_ERROR: SCE_LOG_ERR_LEVEL = 1i32;
