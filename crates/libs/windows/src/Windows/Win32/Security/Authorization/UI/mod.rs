...
pub trait IEffectivePermission_Impl {
...
impl IEffectivePermission_Vtbl {
    ...
    {
        unsafe extern "system" fn GetEffectivePermission<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, pguidobjecttype: *const windows_core::GUID, pusersid: super::super::PSID, pszservername: windows_core::PCWSTR, psd: super::super::PSECURITY_DESCRIPTOR, ppobjecttypelist: *mut *mut super::super::OBJECT_TYPE_LIST, pcobjecttypelistlength: *mut u32, ppgrantedaccesslist: *mut *mut u32, pcgrantedaccesslistlength: *mut u32) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IEffectivePermission_Impl,
        {
            unsafe {
...
pub trait IEffectivePermission2_Impl {
...
impl IEffectivePermission2_Vtbl {
    ...
    {
        unsafe extern "system" fn ComputeEffectivePermissionWithSecondarySecurity<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(
...
#[cfg(feature = "Win32_UI_Controls")]
pub trait ISecurityInformation_Impl {
...
impl ISecurityInformation_Vtbl {
    ...
    {
        unsafe extern "system" fn GetObjectInformation<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, pobjectinfo: *mut SI_OBJECT_INFO) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISecurityInformation_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn GetSecurity<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, requestedinformation: super::super::OBJECT_SECURITY_INFORMATION, ppsecuritydescriptor: *mut super::super::PSECURITY_DESCRIPTOR, fdefault: windows_core::BOOL) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISecurityInformation_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn SetSecurity<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, securityinformation: super::super::OBJECT_SECURITY_INFORMATION, psecuritydescriptor: super::super::PSECURITY_DESCRIPTOR) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISecurityInformation_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn GetAccessRights<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, pguidobjecttype: *const windows_core::GUID, dwflags: SECURITY_INFO_PAGE_FLAGS, ppaccess: *mut *mut SI_ACCESS, pcaccesses: *mut u32, pidefaultaccess: *mut u32) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISecurityInformation_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn MapGeneric<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, pguidobjecttype: *const windows_core::GUID, paceflags: *mut u8, pmask: *mut u32) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISecurityInformation_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn GetInheritTypes<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, ppinherittypes: *mut *mut SI_INHERIT_TYPE, pcinherittypes: *mut u32) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISecurityInformation_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn PropertySheetPageCallback<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, hwnd: super::super::super::Foundation::HWND, umsg: super::super::super::UI::Controls::PSPCB_MESSAGE, upage: SI_PAGE_TYPE) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISecurityInformation_Impl,
        {
            unsafe {
...
#[cfg(feature = "Win32_System_Com")]
pub trait ISecurityInformation2_Impl {
...
impl ISecurityInformation2_Vtbl {
    ...
    {
        unsafe extern "system" fn IsDaclCanonical<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, pdacl: *const super::super::ACL) -> windows_core::BOOL
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISecurityInformation2_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn LookupSids<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, csids: u32, rgpsids: *const super::super::PSID, ppdo: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISecurityInformation2_Impl,
        {
            unsafe {
...
pub trait ISecurityInformation3_Impl {
...
impl ISecurityInformation3_Vtbl {
    ...
    {
        unsafe extern "system" fn GetFullResourceName<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, ppszresourcename: *mut windows_core::PWSTR) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISecurityInformation3_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn OpenElevatedEditor<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, hwnd: super::super::super::Foundation::HWND, upage: SI_PAGE_TYPE) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISecurityInformation3_Impl,
        {
            unsafe {
...
pub trait ISecurityInformation4_Impl {
...
impl ISecurityInformation4_Vtbl {
    ...
    {
        unsafe extern "system" fn GetSecondarySecurity<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, psecurityobjects: *mut *mut SECURITY_OBJECT, psecurityobjectcount: *mut u32) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISecurityInformation4_Impl,
        {
            unsafe {
...
pub trait ISecurityObjectTypeInfo_Impl {
...
impl ISecurityObjectTypeInfo_Vtbl {
    ...
    {
        unsafe extern "system" fn GetInheritSource<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, si: u32, pacl: *mut super::super::ACL, ppinheritarray: *mut *mut super::INHERITED_FROMA) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISecurityObjectTypeInfo_Impl,
        {
            unsafe {
