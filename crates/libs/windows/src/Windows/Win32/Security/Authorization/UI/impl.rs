...
impl IEffectivePermissionVtbl {
    pub const fn new<Impl: IEffectivePermissionImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> IEffectivePermissionVtbl {
        unsafe extern "system" fn GetEffectivePermission<Impl: IEffectivePermissionImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, pguidobjecttype: *const ::windows::core::GUID, pusersid: super::super::super::Foundation::PSID, pszservername: super::super::super::Foundation::PWSTR, psd: *mut super::super::SECURITY_DESCRIPTOR, ppobjecttypelist: *mut *mut super::super::OBJECT_TYPE_LIST, pcobjecttypelistlength: *mut u32, ppgrantedaccesslist: *mut *mut u32, pcgrantedaccesslistlength: *mut u32) -> ::windows::core::HRESULT {
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<IEffectivePermission>, base.5, GetEffectivePermission::<Impl, OFFSET>)
    }
}
...
impl IEffectivePermission2Vtbl {
    pub const fn new<Impl: IEffectivePermission2Impl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> IEffectivePermission2Vtbl {
        unsafe extern "system" fn ComputeEffectivePermissionWithSecondarySecurity<Impl: IEffectivePermission2Impl, const OFFSET: usize>(
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<IEffectivePermission2>, base.5, ComputeEffectivePermissionWithSecondarySecurity::<Impl, OFFSET>)
    }
}
...
impl ISecurityInformationVtbl {
    pub const fn new<Impl: ISecurityInformationImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> ISecurityInformationVtbl {
        unsafe extern "system" fn GetObjectInformation<Impl: ISecurityInformationImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, pobjectinfo: *mut SI_OBJECT_INFO) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn GetSecurity<Impl: ISecurityInformationImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, requestedinformation: super::super::OBJECT_SECURITY_INFORMATION, ppsecuritydescriptor: *mut *mut super::super::SECURITY_DESCRIPTOR, fdefault: super::super::super::Foundation::BOOL) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn SetSecurity<Impl: ISecurityInformationImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, securityinformation: super::super::OBJECT_SECURITY_INFORMATION, psecuritydescriptor: *mut super::super::SECURITY_DESCRIPTOR) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn GetAccessRights<Impl: ISecurityInformationImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, pguidobjecttype: *const ::windows::core::GUID, dwflags: SECURITY_INFO_PAGE_FLAGS, ppaccess: *mut *mut SI_ACCESS, pcaccesses: *mut u32, pidefaultaccess: *mut u32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn MapGeneric<Impl: ISecurityInformationImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, pguidobjecttype: *const ::windows::core::GUID, paceflags: *mut u8, pmask: *mut u32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn GetInheritTypes<Impl: ISecurityInformationImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, ppinherittypes: *mut *mut SI_INHERIT_TYPE, pcinherittypes: *mut u32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn PropertySheetPageCallback<Impl: ISecurityInformationImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, hwnd: super::super::super::Foundation::HWND, umsg: super::super::super::UI::Controls::PSPCB_MESSAGE, upage: SI_PAGE_TYPE) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<ISecurityInformation>, base.5, GetObjectInformation::<Impl, OFFSET>, GetSecurity::<Impl, OFFSET>, SetSecurity::<Impl, OFFSET>, GetAccessRights::<Impl, OFFSET>, MapGeneric::<Impl, OFFSET>, GetInheritTypes::<Impl, OFFSET>, PropertySheetPageCallback::<Impl, OFFSET>)
    }
}
...
impl ISecurityInformation2Vtbl {
    pub const fn new<Impl: ISecurityInformation2Impl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> ISecurityInformation2Vtbl {
        unsafe extern "system" fn IsDaclCanonical<Impl: ISecurityInformation2Impl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, pdacl: *mut super::super::ACL) -> super::super::super::Foundation::BOOL {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn LookupSids<Impl: ISecurityInformation2Impl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, csids: u32, rgpsids: *mut super::super::super::Foundation::PSID, ppdo: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<ISecurityInformation2>, base.5, IsDaclCanonical::<Impl, OFFSET>, LookupSids::<Impl, OFFSET>)
    }
}
...
impl ISecurityInformation3Vtbl {
    pub const fn new<Impl: ISecurityInformation3Impl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> ISecurityInformation3Vtbl {
        unsafe extern "system" fn GetFullResourceName<Impl: ISecurityInformation3Impl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, ppszresourcename: *mut super::super::super::Foundation::PWSTR) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn OpenElevatedEditor<Impl: ISecurityInformation3Impl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, hwnd: super::super::super::Foundation::HWND, upage: SI_PAGE_TYPE) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<ISecurityInformation3>, base.5, GetFullResourceName::<Impl, OFFSET>, OpenElevatedEditor::<Impl, OFFSET>)
    }
}
...
impl ISecurityInformation4Vtbl {
    pub const fn new<Impl: ISecurityInformation4Impl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> ISecurityInformation4Vtbl {
        unsafe extern "system" fn GetSecondarySecurity<Impl: ISecurityInformation4Impl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, psecurityobjects: *mut *mut SECURITY_OBJECT, psecurityobjectcount: *mut u32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<ISecurityInformation4>, base.5, GetSecondarySecurity::<Impl, OFFSET>)
    }
}
...
impl ISecurityObjectTypeInfoVtbl {
    pub const fn new<Impl: ISecurityObjectTypeInfoImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> ISecurityObjectTypeInfoVtbl {
        unsafe extern "system" fn GetInheritSource<Impl: ISecurityObjectTypeInfoImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, si: u32, pacl: *mut super::super::ACL, ppinheritarray: *mut *mut super::INHERITED_FROMA) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<ISecurityObjectTypeInfo>, base.5, GetInheritSource::<Impl, OFFSET>)
    }
}
