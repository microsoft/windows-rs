#[inline]
pub unsafe fn CreateAppContainerProfile<P0, P1, P2>(pszappcontainername: P0, pszdisplayname: P1, pszdescription: P2, pcapabilities: Option<&[super::SID_AND_ATTRIBUTES]>) -> Result<super::PSID, windows_result::HRESULT>
where
...
#[inline]
pub unsafe fn DeleteAppContainerProfile<P0>(pszappcontainername: P0) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn DeriveAppContainerSidFromAppContainerName<P0>(pszappcontainername: P0) -> Result<super::PSID, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn DeriveRestrictedAppContainerSidFromAppContainerSidAndRestrictedName<P1>(psidappcontainersid: super::PSID, pszrestrictedappcontainername: P1) -> Result<super::PSID, windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn GetAppContainerFolderPath<P0>(pszappcontainersid: P0) -> Result<windows_core::PWSTR, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn GetAppContainerNamedObjectPath(token: Option<super::super::Foundation::HANDLE>, appcontainersid: Option<super::PSID>, objectpath: Option<&mut [u16]>, returnlength: *mut u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetAppContainerRegistryLocation(desiredaccess: u32) -> Result<super::super::System::Registry::HKEY, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn IsCrossIsolatedEnvironmentClipboardContent() -> Result<windows_core::BOOL, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn IsProcessInIsolatedContainer() -> Result<windows_core::BOOL, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn IsProcessInIsolatedWindowsEnvironment() -> Result<windows_core::BOOL, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn IsProcessInWDAGContainer(reserved: *const core::ffi::c_void) -> Result<windows_core::BOOL, windows_result::HRESULT> {
...
impl IIsolatedAppLauncher {
    pub unsafe fn Launch<P0, P1>(&self, appusermodelid: P0, arguments: P1, telemetryparameters: *const IsolatedAppLauncherTelemetryParameters) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IIsolatedAppLauncher_Impl: windows_core::IUnknownImpl {
    fn Launch(&self, appusermodelid: &windows_core::PCWSTR, arguments: &windows_core::PCWSTR, telemetryparameters: *const IsolatedAppLauncherTelemetryParameters) -> Result<(), windows_result::HRESULT>;
}
...
impl IIsolatedProcessLauncher {
    pub unsafe fn LaunchProcess<P0, P1, P2>(&self, process: P0, arguments: P1, workingdirectory: P2) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn ShareDirectory<P0, P1>(&self, hostpath: P0, containerpath: P1, readonly: bool) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetContainerGuid(&self) -> Result<windows_core::GUID, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetContainerGuid)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn AllowSetForegroundAccess(&self, pid: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).AllowSetForegroundAccess)(windows_core::Interface::as_raw(self), pid).ok() }
    }
    pub unsafe fn IsContainerRunning(&self) -> Result<windows_core::BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IIsolatedProcessLauncher_Impl: windows_core::IUnknownImpl {
    fn LaunchProcess(&self, process: &windows_core::PCWSTR, arguments: &windows_core::PCWSTR, workingdirectory: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn ShareDirectory(&self, hostpath: &windows_core::PCWSTR, containerpath: &windows_core::PCWSTR, readonly: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn GetContainerGuid(&self) -> Result<windows_core::GUID, windows_result::HRESULT>;
    fn AllowSetForegroundAccess(&self, pid: u32) -> Result<(), windows_result::HRESULT>;
    fn IsContainerRunning(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
}
...
impl IIsolatedProcessLauncher2 {
    pub unsafe fn LaunchProcess2<P0, P1, P2>(&self, process: P0, arguments: P1, workingdirectory: P2, correlationguid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IIsolatedProcessLauncher2_Impl: IIsolatedProcessLauncher_Impl {
    fn LaunchProcess2(&self, process: &windows_core::PCWSTR, arguments: &windows_core::PCWSTR, workingdirectory: &windows_core::PCWSTR, correlationguid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>;
}
