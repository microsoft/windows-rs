...
pub const AuthenticatorState_Disabled: AUTHENTICATOR_STATE = AUTHENTICATOR_STATE(0);
pub const AuthenticatorState_Enabled: AUTHENTICATOR_STATE = AUTHENTICATOR_STATE(1);
#[repr(C)]
...
pub const GetPubKey: EXPERIMENTAL_WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE = EXPERIMENTAL_WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE(3);
pub const GetPublicKey: WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE = WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE(3);
pub const GetUserVerificationCount: WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE = WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE(2);
pub const GetUvCount: EXPERIMENTAL_WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE = EXPERIMENTAL_WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE(2);
...
pub const PerformUserVerification: WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE = WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE(1);
pub const PerformUv: EXPERIMENTAL_WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE = EXPERIMENTAL_WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE(1);
pub const PluginAuthenticatorState_Disabled: EXPERIMENTAL_PLUGIN_AUTHENTICATOR_STATE = EXPERIMENTAL_PLUGIN_AUTHENTICATOR_STATE(1);
pub const PluginAuthenticatorState_Enabled: EXPERIMENTAL_PLUGIN_AUTHENTICATOR_STATE = EXPERIMENTAL_PLUGIN_AUTHENTICATOR_STATE(2);
pub const PluginAuthenticatorState_Unknown: EXPERIMENTAL_PLUGIN_AUTHENTICATOR_STATE = EXPERIMENTAL_PLUGIN_AUTHENTICATOR_STATE(0);
pub const PluginLocked: PLUGIN_LOCK_STATUS = PLUGIN_LOCK_STATUS(0);
pub const PluginUnlocked: PLUGIN_LOCK_STATUS = PLUGIN_LOCK_STATUS(1);
...
pub const WEBAUTHN_CTAPCBOR_ECC_PUBLIC_KEY_CURRENT_VERSION: u32 = 1;
...
pub const WEBAUTHN_CTAPCBOR_GET_ASSERTION_REQUEST_CURRENT_VERSION: u32 = 1;
...
pub const WEBAUTHN_CTAPCBOR_HMAC_SALT_EXTENSION_CURRENT_VERSION: u32 = 1;
...
pub const WEBAUTHN_CTAPCBOR_MAKE_CREDENTIAL_REQUEST_CURRENT_VERSION: u32 = 1;
...
pub const WEBAUTHN_PLUGIN_REQUEST_TYPE_CTAP2_CBOR: WEBAUTHN_PLUGIN_REQUEST_TYPE = WEBAUTHN_PLUGIN_REQUEST_TYPE(1);
