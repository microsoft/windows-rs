...
impl AsyncIAssociatedIdentityProvider {
    pub unsafe fn Begin_AssociateIdentity(&self, hwndparent: super::super::super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Finish_AssociateIdentity(&self) -> Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore, windows_result::HRESULT> {
        unsafe {
    ...
    pub unsafe fn Begin_DisassociateIdentity<P1>(&self, hwndparent: super::super::super::super::Foundation::HWND, lpszuniqueid: P1) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Finish_DisassociateIdentity(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Finish_DisassociateIdentity)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Begin_ChangeCredential<P1>(&self, hwndparent: super::super::super::super::Foundation::HWND, lpszuniqueid: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn Finish_ChangeCredential(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait AsyncIAssociatedIdentityProvider_Impl: windows_core::IUnknownImpl {
    fn Begin_AssociateIdentity(&self, hwndparent: super::super::super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT>;
    fn Finish_AssociateIdentity(&self) -> Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore, windows_result::HRESULT>;
    fn Begin_DisassociateIdentity(&self, hwndparent: super::super::super::super::Foundation::HWND, lpszuniqueid: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn Finish_DisassociateIdentity(&self) -> Result<(), windows_result::HRESULT>;
    fn Begin_ChangeCredential(&self, hwndparent: super::super::super::super::Foundation::HWND, lpszuniqueid: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn Finish_ChangeCredential(&self) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
...
impl AsyncIConnectedIdentityProvider {
    pub unsafe fn Begin_ConnectIdentity(&self, authbuffer: &[u8]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Begin_GetUrl<P1>(&self, identifier: IDENTITY_URL, context: P1) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Finish_GetUrl(&self, postdata: *mut super::super::super::super::System::Variant::VARIANT, url: *mut windows_core::PWSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Begin_GetAccountState(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Begin_GetAccountState)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Finish_GetAccountState(&self) -> Result<ACCOUNT_STATE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait AsyncIConnectedIdentityProvider_Impl: windows_core::IUnknownImpl {
    fn Begin_ConnectIdentity(&self, authbuffer: *const u8, authbuffersize: u32) -> Result<(), windows_result::HRESULT>;
    fn Finish_ConnectIdentity(&self) -> Result<(), windows_result::HRESULT>;
    fn Begin_DisconnectIdentity(&self) -> Result<(), windows_result::HRESULT>;
    fn Finish_DisconnectIdentity(&self) -> Result<(), windows_result::HRESULT>;
    fn Begin_IsConnected(&self) -> Result<(), windows_result::HRESULT>;
    fn Finish_IsConnected(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
    fn Begin_GetUrl(&self, identifier: IDENTITY_URL, context: windows_core::Ref<'_, super::super::super::super::System::Com::IBindCtx>) -> Result<(), windows_result::HRESULT>;
    fn Finish_GetUrl(&self, postdata: *mut super::super::super::super::System::Variant::VARIANT, url: *mut windows_core::PWSTR) -> Result<(), windows_result::HRESULT>;
    fn Begin_GetAccountState(&self) -> Result<(), windows_result::HRESULT>;
    fn Finish_GetAccountState(&self) -> Result<ACCOUNT_STATE, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl AsyncIIdentityAdvise {
    pub unsafe fn Begin_IdentityUpdated<P1>(&self, dwidentityupdateevents: u32, lpszuniqueid: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn Finish_IdentityUpdated(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait AsyncIIdentityAdvise_Impl: windows_core::IUnknownImpl {
    fn Begin_IdentityUpdated(&self, dwidentityupdateevents: u32, lpszuniqueid: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn Finish_IdentityUpdated(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl AsyncIIdentityAuthentication {
    pub unsafe fn Begin_SetIdentityCredential(&self, credbuffer: Option<&[u8]>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Finish_SetIdentityCredential(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Finish_SetIdentityCredential)(windows_core::Interface::as_raw(self)).ok() }
    }
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn Begin_ValidateIdentityCredential(&self, credbuffer: &[u8], ppidentityproperties: Option<*mut Option<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>>) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn Finish_ValidateIdentityCredential(&self, ppidentityproperties: Option<*mut Option<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>>) -> Result<(), windows_result::HRESULT> {
...
pub trait AsyncIIdentityAuthentication_Impl: windows_core::IUnknownImpl {
    fn Begin_SetIdentityCredential(&self, credbuffer: *const u8, credbufferlength: u32) -> Result<(), windows_result::HRESULT>;
    fn Finish_SetIdentityCredential(&self) -> Result<(), windows_result::HRESULT>;
    fn Begin_ValidateIdentityCredential(&self, credbuffer: *const u8, credbufferlength: u32, ppidentityproperties: windows_core::OutRef<'_, super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>) -> Result<(), windows_result::HRESULT>;
    fn Finish_ValidateIdentityCredential(&self, ppidentityproperties: windows_core::OutRef<'_, super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
...
impl AsyncIIdentityProvider {
    ...
    pub unsafe fn Begin_GetIdentityEnum(&self, eidentitytype: IDENTITY_TYPE, pfilterkey: Option<*const super::super::super::super::Foundation::PROPERTYKEY>, pfilterpropvarvalue: Option<*const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT>) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Finish_GetIdentityEnum(&self) -> Result<super::super::super::super::System::Com::IEnumUnknown, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn Begin_Create<P0>(&self, lpszusername: P0, pkeywordstoadd: *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn Finish_Create(&self) -> Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn Begin_Import<P0>(&self, ppropertystore: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Finish_Import(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Finish_Import)(windows_core::Interface::as_raw(self)).ok() }
    }
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn Begin_Delete<P0>(&self, lpszuniqueid: P0, pkeywordstodelete: *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn Finish_Delete(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Finish_Delete)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Begin_FindByUniqueID<P0>(&self, lpszuniqueid: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn Finish_FindByUniqueID(&self) -> Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Begin_GetProviderPropertyStore(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Begin_GetProviderPropertyStore)(windows_core::Interface::as_raw(self)).ok() }
    }
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn Finish_GetProviderPropertyStore(&self) -> Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Begin_Advise<P0>(&self, pidentityadvise: P0, dwidentityupdateevents: u32) -> Result<(), windows_result::HRESULT>
    where
...
pub trait AsyncIIdentityProvider_Impl: windows_core::IUnknownImpl {
    fn Begin_GetIdentityEnum(&self, eidentitytype: IDENTITY_TYPE, pfilterkey: *const super::super::super::super::Foundation::PROPERTYKEY, pfilterpropvarvalue: *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT>;
    fn Finish_GetIdentityEnum(&self) -> Result<super::super::super::super::System::Com::IEnumUnknown, windows_result::HRESULT>;
    fn Begin_Create(&self, lpszusername: &windows_core::PCWSTR, pkeywordstoadd: *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT>;
    fn Finish_Create(&self) -> Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore, windows_result::HRESULT>;
    fn Begin_Import(&self, ppropertystore: windows_core::Ref<'_, super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>) -> Result<(), windows_result::HRESULT>;
    fn Finish_Import(&self) -> Result<(), windows_result::HRESULT>;
    fn Begin_Delete(&self, lpszuniqueid: &windows_core::PCWSTR, pkeywordstodelete: *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT>;
    fn Finish_Delete(&self) -> Result<(), windows_result::HRESULT>;
    fn Begin_FindByUniqueID(&self, lpszuniqueid: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn Finish_FindByUniqueID(&self) -> Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore, windows_result::HRESULT>;
    fn Begin_GetProviderPropertyStore(&self) -> Result<(), windows_result::HRESULT>;
    fn Finish_GetProviderPropertyStore(&self) -> Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore, windows_result::HRESULT>;
    fn Begin_Advise(&self, pidentityadvise: windows_core::Ref<'_, IIdentityAdvise>, dwidentityupdateevents: u32) -> Result<(), windows_result::HRESULT>;
    fn Finish_Advise(&self) -> Result<u32, windows_result::HRESULT>;
    fn Begin_UnAdvise(&self, dwcookie: u32) -> Result<(), windows_result::HRESULT>;
    fn Finish_UnAdvise(&self) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant", feature = "Win32_UI_Shell_PropertiesSystem"))]
...
impl AsyncIIdentityStore {
    pub unsafe fn Begin_GetCount(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Begin_GetCount)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Finish_GetCount(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Finish_GetCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn Begin_GetAt(&self, dwprovider: u32, pprovguid: Option<*mut windows_core::GUID>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Finish_GetAt(&self, pprovguid: Option<*mut windows_core::GUID>, ppidentityprovider: *mut Option<windows_core::IUnknown>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Begin_AddToCache<P0>(&self, lpszuniqueid: P0, providerguid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn Finish_AddToCache(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Finish_AddToCache)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Begin_ConvertToSid<P0>(&self, lpszuniqueid: P0, providerguid: *const windows_core::GUID, cbsid: u16, psid: Option<*mut u8>) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn Finish_ConvertToSid(&self, psid: Option<*mut u8>, pcbrequiredsid: *mut u16) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn Begin_EnumerateIdentities(&self, eidentitytype: IDENTITY_TYPE, pfilterkey: Option<*const super::super::super::super::Foundation::PROPERTYKEY>, pfilterpropvarvalue: Option<*const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT>) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Finish_EnumerateIdentities(&self) -> Result<super::super::super::super::System::Com::IEnumUnknown, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Begin_Reset(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Begin_Reset)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Finish_Reset(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait AsyncIIdentityStore_Impl: windows_core::IUnknownImpl {
    fn Begin_GetCount(&self) -> Result<(), windows_result::HRESULT>;
    fn Finish_GetCount(&self) -> Result<u32, windows_result::HRESULT>;
    fn Begin_GetAt(&self, dwprovider: u32, pprovguid: *mut windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn Finish_GetAt(&self, pprovguid: *mut windows_core::GUID, ppidentityprovider: windows_core::OutRef<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn Begin_AddToCache(&self, lpszuniqueid: &windows_core::PCWSTR, providerguid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn Finish_AddToCache(&self) -> Result<(), windows_result::HRESULT>;
    fn Begin_ConvertToSid(&self, lpszuniqueid: &windows_core::PCWSTR, providerguid: *const windows_core::GUID, cbsid: u16, psid: *mut u8) -> Result<(), windows_result::HRESULT>;
    fn Finish_ConvertToSid(&self, psid: *mut u8, pcbrequiredsid: *mut u16) -> Result<(), windows_result::HRESULT>;
    fn Begin_EnumerateIdentities(&self, eidentitytype: IDENTITY_TYPE, pfilterkey: *const super::super::super::super::Foundation::PROPERTYKEY, pfilterpropvarvalue: *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT>;
    fn Finish_EnumerateIdentities(&self) -> Result<super::super::super::super::System::Com::IEnumUnknown, windows_result::HRESULT>;
    fn Begin_Reset(&self) -> Result<(), windows_result::HRESULT>;
    fn Finish_Reset(&self) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl AsyncIIdentityStoreEx {
    pub unsafe fn Begin_CreateConnectedIdentity<P0, P1>(&self, localname: P0, connectedname: P1, providerguid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn Finish_CreateConnectedIdentity(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Finish_CreateConnectedIdentity)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Begin_DeleteConnectedIdentity<P0>(&self, connectedname: P0, providerguid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn Finish_DeleteConnectedIdentity(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait AsyncIIdentityStoreEx_Impl: windows_core::IUnknownImpl {
    fn Begin_CreateConnectedIdentity(&self, localname: &windows_core::PCWSTR, connectedname: &windows_core::PCWSTR, providerguid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn Finish_CreateConnectedIdentity(&self) -> Result<(), windows_result::HRESULT>;
    fn Begin_DeleteConnectedIdentity(&self, connectedname: &windows_core::PCWSTR, providerguid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn Finish_DeleteConnectedIdentity(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IAssociatedIdentityProvider {
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn AssociateIdentity(&self, hwndparent: super::super::super::super::Foundation::HWND) -> Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn DisassociateIdentity<P1>(&self, hwndparent: super::super::super::super::Foundation::HWND, lpszuniqueid: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn ChangeCredential<P1>(&self, hwndparent: super::super::super::super::Foundation::HWND, lpszuniqueid: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IAssociatedIdentityProvider_Impl: windows_core::IUnknownImpl {
    fn AssociateIdentity(&self, hwndparent: super::super::super::super::Foundation::HWND) -> Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore, windows_result::HRESULT>;
    fn DisassociateIdentity(&self, hwndparent: super::super::super::super::Foundation::HWND, lpszuniqueid: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn ChangeCredential(&self, hwndparent: super::super::super::super::Foundation::HWND, lpszuniqueid: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
...
impl IConnectedIdentityProvider {
    pub unsafe fn ConnectIdentity(&self, authbuffer: &[u8]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn DisconnectIdentity(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).DisconnectIdentity)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn IsConnected(&self) -> Result<windows_core::BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetUrl<P1>(&self, identifier: IDENTITY_URL, context: P1, postdata: *mut super::super::super::super::System::Variant::VARIANT, url: *mut windows_core::PWSTR) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::super::super::System::Com::IBindCtx>,
    {
    ...
    pub unsafe fn GetAccountState(&self) -> Result<ACCOUNT_STATE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IConnectedIdentityProvider_Impl: windows_core::IUnknownImpl {
    fn ConnectIdentity(&self, authbuffer: *const u8, authbuffersize: u32) -> Result<(), windows_result::HRESULT>;
    fn DisconnectIdentity(&self) -> Result<(), windows_result::HRESULT>;
    fn IsConnected(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
    fn GetUrl(&self, identifier: IDENTITY_URL, context: windows_core::Ref<'_, super::super::super::super::System::Com::IBindCtx>, postdata: *mut super::super::super::super::System::Variant::VARIANT, url: *mut windows_core::PWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetAccountState(&self) -> Result<ACCOUNT_STATE, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IIdentityAdvise {
    pub unsafe fn IdentityUpdated<P1>(&self, dwidentityupdateevents: IdentityUpdateEvent, lpszuniqueid: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IIdentityAdvise_Impl: windows_core::IUnknownImpl {
    fn IdentityUpdated(&self, dwidentityupdateevents: &IdentityUpdateEvent, lpszuniqueid: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
...
impl IIdentityAuthentication {
    pub unsafe fn SetIdentityCredential(&self, credbuffer: Option<&[u8]>) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn ValidateIdentityCredential(&self, credbuffer: &[u8], ppidentityproperties: Option<*mut Option<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>>) -> Result<(), windows_result::HRESULT> {
...
pub trait IIdentityAuthentication_Impl: windows_core::IUnknownImpl {
    fn SetIdentityCredential(&self, credbuffer: *const u8, credbufferlength: u32) -> Result<(), windows_result::HRESULT>;
    fn ValidateIdentityCredential(&self, credbuffer: *const u8, credbufferlength: u32, ppidentityproperties: windows_core::OutRef<'_, super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
...
impl IIdentityProvider {
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn GetIdentityEnum(&self, eidentitytype: IDENTITY_TYPE, pfilterkey: Option<*const super::super::super::super::Foundation::PROPERTYKEY>, pfilterpropvarvalue: Option<*const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT>) -> Result<super::super::super::super::System::Com::IEnumUnknown, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant", feature = "Win32_UI_Shell_PropertiesSystem"))]
    pub unsafe fn Create<P0>(&self, lpszusername: P0, pppropertystore: *mut Option<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>, pkeywordstoadd: *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn Import<P0>(&self, ppropertystore: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>,
    {
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn Delete<P0>(&self, lpszuniqueid: P0, pkeywordstodelete: *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn FindByUniqueID<P0>(&self, lpszuniqueid: P0) -> Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn GetProviderPropertyStore(&self) -> Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Advise<P0>(&self, pidentityadvise: P0, dwidentityupdateevents: IdentityUpdateEvent) -> Result<u32, windows_result::HRESULT>
    where
        P0: windows_core::Param<IIdentityAdvise>,
    {
        unsafe {
...
pub trait IIdentityProvider_Impl: windows_core::IUnknownImpl {
    fn GetIdentityEnum(&self, eidentitytype: IDENTITY_TYPE, pfilterkey: *const super::super::super::super::Foundation::PROPERTYKEY, pfilterpropvarvalue: *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<super::super::super::super::System::Com::IEnumUnknown, windows_result::HRESULT>;
    fn Create(&self, lpszusername: &windows_core::PCWSTR, pppropertystore: windows_core::OutRef<'_, super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>, pkeywordstoadd: *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT>;
    fn Import(&self, ppropertystore: windows_core::Ref<'_, super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>) -> Result<(), windows_result::HRESULT>;
    fn Delete(&self, lpszuniqueid: &windows_core::PCWSTR, pkeywordstodelete: *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT>;
    fn FindByUniqueID(&self, lpszuniqueid: &windows_core::PCWSTR) -> Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore, windows_result::HRESULT>;
    fn GetProviderPropertyStore(&self) -> Result<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore, windows_result::HRESULT>;
    fn Advise(&self, pidentityadvise: windows_core::Ref<'_, IIdentityAdvise>, dwidentityupdateevents: &IdentityUpdateEvent) -> Result<u32, windows_result::HRESULT>;
...
impl IIdentityStore {
    ...
    pub unsafe fn GetAt(&self, dwprovider: u32, pprovguid: Option<*mut windows_core::GUID>, ppidentityprovider: *mut Option<windows_core::IUnknown>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn AddToCache<P0>(&self, lpszuniqueid: P0, providerguid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn ConvertToSid<P0>(&self, lpszuniqueid: P0, providerguid: *const windows_core::GUID, psid: Option<&mut [u8]>, pcbrequiredsid: *mut u16) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IIdentityStore_Impl: windows_core::IUnknownImpl {
    ...
    fn GetAt(&self, dwprovider: u32, pprovguid: *mut windows_core::GUID, ppidentityprovider: windows_core::OutRef<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn AddToCache(&self, lpszuniqueid: &windows_core::PCWSTR, providerguid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn ConvertToSid(&self, lpszuniqueid: &windows_core::PCWSTR, providerguid: *const windows_core::GUID, cbsid: u16, psid: *mut u8, pcbrequiredsid: *mut u16) -> Result<(), windows_result::HRESULT>;
    fn EnumerateIdentities(&self, eidentitytype: IDENTITY_TYPE, pfilterkey: *const super::super::super::super::Foundation::PROPERTYKEY, pfilterpropvarvalue: *const super::super::super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<super::super::super::super::System::Com::IEnumUnknown, windows_result::HRESULT>;
...
impl IIdentityStoreEx {
    pub unsafe fn CreateConnectedIdentity<P0, P1>(&self, localname: P0, connectedname: P1, providerguid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn DeleteConnectedIdentity<P0>(&self, connectedname: P0, providerguid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IIdentityStoreEx_Impl: windows_core::IUnknownImpl {
    fn CreateConnectedIdentity(&self, localname: &windows_core::PCWSTR, connectedname: &windows_core::PCWSTR, providerguid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn DeleteConnectedIdentity(&self, connectedname: &windows_core::PCWSTR, providerguid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>;
}
