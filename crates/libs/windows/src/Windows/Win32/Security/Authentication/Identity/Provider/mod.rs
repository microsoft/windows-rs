...
impl AsyncIConnectedIdentityProvider {
    ...
    pub unsafe fn Begin_ConnectIdentity(&self, authbuffer: &[u8]) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).Begin_ConnectIdentity)(::core::mem::transmute_copy(self), ::core::mem::transmute(authbuffer.as_ptr()), authbuffer.len() as _).ok()
    }
    #[doc = "*Required features: 'Win32_Security_Authentication_Identity_Provider'*"]
...
impl AsyncIIdentityAuthentication {
    ...
    pub unsafe fn Begin_SetIdentityCredential(&self, credbuffer: ::core::option::Option<&[u8]>) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).Begin_SetIdentityCredential)(::core::mem::transmute_copy(self), ::core::mem::transmute(credbuffer.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), credbuffer.as_ref().map_or(0, |value| value.len()) as _).ok()
    }
    #[doc = "*Required features: 'Win32_Security_Authentication_Identity_Provider'*"]
    ...
    pub unsafe fn Begin_ValidateIdentityCredential(&self, credbuffer: &[u8], ppidentityproperties: *mut ::core::option::Option<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).Begin_ValidateIdentityCredential)(::core::mem::transmute_copy(self), ::core::mem::transmute(credbuffer.as_ptr()), credbuffer.len() as _, ::core::mem::transmute(ppidentityproperties)).ok()
    }
    #[doc = "*Required features: 'Win32_Security_Authentication_Identity_Provider', 'Win32_UI_Shell_PropertiesSystem'*"]
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
...
impl IConnectedIdentityProvider {
    ...
    pub unsafe fn ConnectIdentity(&self, authbuffer: &[u8]) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).ConnectIdentity)(::core::mem::transmute_copy(self), ::core::mem::transmute(authbuffer.as_ptr()), authbuffer.len() as _).ok()
    }
    #[doc = "*Required features: 'Win32_Security_Authentication_Identity_Provider'*"]
...
impl IIdentityAuthentication {
    ...
    pub unsafe fn SetIdentityCredential(&self, credbuffer: ::core::option::Option<&[u8]>) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).SetIdentityCredential)(::core::mem::transmute_copy(self), ::core::mem::transmute(credbuffer.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), credbuffer.as_ref().map_or(0, |value| value.len()) as _).ok()
    }
    #[doc = "*Required features: 'Win32_Security_Authentication_Identity_Provider', 'Win32_UI_Shell_PropertiesSystem'*"]
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn ValidateIdentityCredential(&self, credbuffer: &[u8], ppidentityproperties: *mut ::core::option::Option<super::super::super::super::UI::Shell::PropertiesSystem::IPropertyStore>) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).ValidateIdentityCredential)(::core::mem::transmute_copy(self), ::core::mem::transmute(credbuffer.as_ptr()), credbuffer.len() as _, ::core::mem::transmute(ppidentityproperties)).ok()
    }
}
...
impl IIdentityStore {
    ...
    #[doc = "*Required features: 'Win32_Security_Authentication_Identity_Provider'*"]
    pub unsafe fn ConvertToSid<'a, Param0: ::windows::core::IntoParam<'a, ::windows::core::PCWSTR>>(&self, lpszuniqueid: Param0, providerguid: *const ::windows::core::GUID, psid: ::core::option::Option<&mut [u8]>, pcbrequiredsid: *mut u16) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).ConvertToSid)(::core::mem::transmute_copy(self), lpszuniqueid.into_param().abi(), ::core::mem::transmute(providerguid), psid.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(psid.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), ::core::mem::transmute(pcbrequiredsid)).ok()
    }
    #[doc = "*Required features: 'Win32_Security_Authentication_Identity_Provider', 'Win32_Foundation', 'Win32_System_Com_StructuredStorage', 'Win32_UI_Shell_PropertiesSystem'*"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com_StructuredStorage", feature = "Win32_UI_Shell_PropertiesSystem"))]
