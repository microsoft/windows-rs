    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    DSCreateISecurityInfoObject(pwszobjectpath.param().abi(), pwszobjectclass.param().abi(), dwflags, core::mem::transmute(ppsi), core::mem::transmute(pfnreadsd.unwrap_or(core::mem::zeroed())), core::mem::transmute(pfnwritesd.unwrap_or(core::mem::zeroed())), lpcontext).ok()
}
#[cfg(feature = "Win32_Security_Authorization_UI")]
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    DSCreateSecurityPage(pwszobjectpath.param().abi(), pwszobjectclass.param().abi(), dwflags, core::mem::transmute(phpage), core::mem::transmute(pfnreadsd.unwrap_or(core::mem::zeroed())), core::mem::transmute(pfnwritesd.unwrap_or(core::mem::zeroed())), lpcontext).ok()
}
#[inline]
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    DSEditSecurity(hwndowner, pwszobjectpath.param().abi(), pwszobjectclass.param().abi(), dwflags, pwszcaption.param().abi(), core::mem::transmute(pfnreadsd.unwrap_or(core::mem::zeroed())), core::mem::transmute(pfnwritesd.unwrap_or(core::mem::zeroed())), lpcontext).ok()
}
