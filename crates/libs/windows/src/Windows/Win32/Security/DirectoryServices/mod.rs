...
#[inline]
pub unsafe fn DSCreateISecurityInfoObject<P0, P1, P6>(pwszobjectpath: P0, pwszobjectclass: P1, dwflags: u32, ppsi: *mut Option<super::Authorization::UI::ISecurityInformation>, pfnreadsd: PFNREADOBJECTSECURITY, pfnwritesd: PFNWRITEOBJECTSECURITY, lpcontext: P6) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    P6: windows_core::Param<super::super::Foundation::LPARAM>,
{
    ...
    DSCreateISecurityInfoObject(pwszobjectpath.param().abi(), pwszobjectclass.param().abi(), core::mem::transmute(dwflags), core::mem::transmute(ppsi), core::mem::transmute(pfnreadsd), core::mem::transmute(pfnwritesd), lpcontext.param().abi()).ok()
}
#[cfg(feature = "Win32_Security_Authorization_UI")]
#[inline]
pub unsafe fn DSCreateISecurityInfoObjectEx<P0, P1, P2, P3, P4, P9>(pwszobjectpath: P0, pwszobjectclass: P1, pwszserver: P2, pwszusername: P3, pwszpassword: P4, dwflags: u32, ppsi: *mut Option<super::Authorization::UI::ISecurityInformation>, pfnreadsd: PFNREADOBJECTSECURITY, pfnwritesd: PFNWRITEOBJECTSECURITY, lpcontext: P9) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    ...
    P9: windows_core::Param<super::super::Foundation::LPARAM>,
{
    ...
    DSCreateISecurityInfoObjectEx(pwszobjectpath.param().abi(), pwszobjectclass.param().abi(), pwszserver.param().abi(), pwszusername.param().abi(), pwszpassword.param().abi(), core::mem::transmute(dwflags), core::mem::transmute(ppsi), core::mem::transmute(pfnreadsd), core::mem::transmute(pfnwritesd), lpcontext.param().abi()).ok()
}
#[cfg(feature = "Win32_UI_Controls")]
#[inline]
pub unsafe fn DSCreateSecurityPage<P0, P1, P6>(pwszobjectpath: P0, pwszobjectclass: P1, dwflags: u32, phpage: *mut super::super::UI::Controls::HPROPSHEETPAGE, pfnreadsd: PFNREADOBJECTSECURITY, pfnwritesd: PFNWRITEOBJECTSECURITY, lpcontext: P6) -> windows_core::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    P6: windows_core::Param<super::super::Foundation::LPARAM>,
{
    ...
    DSCreateSecurityPage(pwszobjectpath.param().abi(), pwszobjectclass.param().abi(), core::mem::transmute(dwflags), core::mem::transmute(phpage), core::mem::transmute(pfnreadsd), core::mem::transmute(pfnwritesd), lpcontext.param().abi()).ok()
}
#[inline]
pub unsafe fn DSEditSecurity<P0, P1, P2, P4, P7>(hwndowner: P0, pwszobjectpath: P1, pwszobjectclass: P2, dwflags: u32, pwszcaption: P4, pfnreadsd: PFNREADOBJECTSECURITY, pfnwritesd: PFNWRITEOBJECTSECURITY, lpcontext: P7) -> windows_core::Result<()>
where
    P0: windows_core::Param<super::super::Foundation::HWND>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
    P4: windows_core::Param<windows_core::PCWSTR>,
    P7: windows_core::Param<super::super::Foundation::LPARAM>,
{
