#[inline]
pub unsafe fn DdqCancelDiagnosticRecordOperation(hsession: HDIAGNOSTIC_DATA_QUERY_SESSION) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqCloseSession(hsession: HDIAGNOSTIC_DATA_QUERY_SESSION) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqCreateSession(accesslevel: DdqAccessLevel) -> Result<HDIAGNOSTIC_DATA_QUERY_SESSION, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqExtractDiagnosticReport<P2, P3>(hsession: HDIAGNOSTIC_DATA_QUERY_SESSION, reportstoretype: u32, reportkey: P2, destinationpath: P3) -> Result<(), windows_result::HRESULT>
where
...
#[inline]
pub unsafe fn DdqFreeDiagnosticRecordLocaleTags(htagdescription: HDIAGNOSTIC_EVENT_TAG_DESCRIPTION) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqFreeDiagnosticRecordPage(hrecord: HDIAGNOSTIC_RECORD) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqFreeDiagnosticRecordProducerCategories(hcategorydescription: HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqFreeDiagnosticRecordProducers(hproducerdescription: HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqFreeDiagnosticReport(hreport: HDIAGNOSTIC_REPORT) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticDataAccessLevelAllowed() -> Result<DdqAccessLevel, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordAtIndex(hrecord: HDIAGNOSTIC_RECORD, index: u32, record: *mut DIAGNOSTIC_DATA_RECORD) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordBinaryDistribution(hsession: HDIAGNOSTIC_DATA_QUERY_SESSION, producernames: &[windows_core::PCWSTR], topnbinaries: u32, binarystats: *mut *mut DIAGNOSTIC_DATA_EVENT_BINARY_STATS, statcount: *mut u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordCategoryAtIndex(hcategorydescription: HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION, index: u32) -> Result<DIAGNOSTIC_DATA_EVENT_CATEGORY_DESCRIPTION, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordCategoryCount(hcategorydescription: HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION) -> Result<u32, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordCount(hrecord: HDIAGNOSTIC_RECORD) -> Result<u32, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordLocaleTagAtIndex(htagdescription: HDIAGNOSTIC_EVENT_TAG_DESCRIPTION, index: u32) -> Result<DIAGNOSTIC_DATA_EVENT_TAG_DESCRIPTION, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordLocaleTagCount(htagdescription: HDIAGNOSTIC_EVENT_TAG_DESCRIPTION) -> Result<u32, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordLocaleTags<P1>(hsession: HDIAGNOSTIC_DATA_QUERY_SESSION, locale: P1) -> Result<HDIAGNOSTIC_EVENT_TAG_DESCRIPTION, windows_result::HRESULT>
where
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordPage(hsession: HDIAGNOSTIC_DATA_QUERY_SESSION, searchcriteria: *const DIAGNOSTIC_DATA_SEARCH_CRITERIA, offset: u32, pagerecordcount: u32, baserowid: i64) -> Result<HDIAGNOSTIC_RECORD, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordPayload(hsession: HDIAGNOSTIC_DATA_QUERY_SESSION, rowid: i64) -> Result<windows_core::PCWSTR, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordProducerAtIndex(hproducerdescription: HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION, index: u32) -> Result<DIAGNOSTIC_DATA_EVENT_PRODUCER_DESCRIPTION, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordProducerCategories<P1>(hsession: HDIAGNOSTIC_DATA_QUERY_SESSION, producername: P1) -> Result<HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION, windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordProducerCount(hproducerdescription: HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION) -> Result<u32, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordProducers(hsession: HDIAGNOSTIC_DATA_QUERY_SESSION) -> Result<HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordStats(hsession: HDIAGNOSTIC_DATA_QUERY_SESSION, searchcriteria: *const DIAGNOSTIC_DATA_SEARCH_CRITERIA, recordcount: *mut u32, minrowid: *mut i64, maxrowid: *mut i64) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordSummary(hsession: HDIAGNOSTIC_DATA_QUERY_SESSION, producernames: &[windows_core::PCWSTR], generalstats: *mut DIAGNOSTIC_DATA_GENERAL_STATS) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticRecordTagDistribution(hsession: HDIAGNOSTIC_DATA_QUERY_SESSION, producernames: &[windows_core::PCWSTR], tagstats: *mut *mut DIAGNOSTIC_DATA_EVENT_TAG_STATS, statcount: *mut u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticReport(hsession: HDIAGNOSTIC_DATA_QUERY_SESSION, reportstoretype: u32) -> Result<HDIAGNOSTIC_REPORT, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticReportAtIndex(hreport: HDIAGNOSTIC_REPORT, index: u32, report: *mut DIAGNOSTIC_REPORT_DATA) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticReportCount(hreport: HDIAGNOSTIC_REPORT) -> Result<u32, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetDiagnosticReportStoreReportCount(hsession: HDIAGNOSTIC_DATA_QUERY_SESSION, reportstoretype: u32) -> Result<u32, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetSessionAccessLevel(hsession: HDIAGNOSTIC_DATA_QUERY_SESSION) -> Result<DdqAccessLevel, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqGetTranscriptConfiguration(hsession: HDIAGNOSTIC_DATA_QUERY_SESSION) -> Result<DIAGNOSTIC_DATA_EVENT_TRANSCRIPT_CONFIGURATION, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdqSetTranscriptConfiguration(hsession: HDIAGNOSTIC_DATA_QUERY_SESSION, desiredconfig: *const DIAGNOSTIC_DATA_EVENT_TRANSCRIPT_CONFIGURATION) -> Result<(), windows_result::HRESULT> {
