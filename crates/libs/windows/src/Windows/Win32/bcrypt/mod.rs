...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PBCRYPT_AUTHENTICATED_CIPHER_MODE_INFO(pub *mut BCRYPT_AUTHENTICATED_CIPHER_MODE_INFO);
#[cfg(feature = "minwindef")]
impl PBCRYPT_AUTHENTICATED_CIPHER_MODE_INFO {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
#[cfg(feature = "minwindef")]
impl Default for PBCRYPT_AUTHENTICATED_CIPHER_MODE_INFO {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PBCRYPT_DH_KEY_BLOB(pub *mut BCRYPT_DH_KEY_BLOB);
impl PBCRYPT_DH_KEY_BLOB {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PBCRYPT_DH_KEY_BLOB {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PBCRYPT_DSA_KEY_BLOB(pub *mut BCRYPT_DSA_KEY_BLOB);
impl PBCRYPT_DSA_KEY_BLOB {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PBCRYPT_DSA_KEY_BLOB {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PBCRYPT_DSA_KEY_BLOB_V2(pub *mut BCRYPT_DSA_KEY_BLOB_V2);
impl PBCRYPT_DSA_KEY_BLOB_V2 {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PBCRYPT_DSA_KEY_BLOB_V2 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PBCRYPT_ECCFULLKEY_BLOB(pub *mut BCRYPT_ECCFULLKEY_BLOB);
impl PBCRYPT_ECCFULLKEY_BLOB {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PBCRYPT_ECCFULLKEY_BLOB {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PBCRYPT_ECCKEY_BLOB(pub *mut BCRYPT_ECCKEY_BLOB);
impl PBCRYPT_ECCKEY_BLOB {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PBCRYPT_ECCKEY_BLOB {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PBCRYPT_INTERFACE_VERSION(pub *mut BCRYPT_INTERFACE_VERSION);
impl PBCRYPT_INTERFACE_VERSION {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PBCRYPT_INTERFACE_VERSION {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PBCRYPT_KEY_DATA_BLOB_HEADER(pub *mut BCRYPT_KEY_DATA_BLOB_HEADER);
impl PBCRYPT_KEY_DATA_BLOB_HEADER {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PBCRYPT_KEY_DATA_BLOB_HEADER {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PBCRYPT_MLKEM_KEY_BLOB(pub *mut BCRYPT_MLKEM_KEY_BLOB);
impl PBCRYPT_MLKEM_KEY_BLOB {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PBCRYPT_MLKEM_KEY_BLOB {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PBCRYPT_PKCS11_RSA_AES_WRAP_BLOB(pub *mut BCRYPT_PKCS11_RSA_AES_WRAP_BLOB);
impl PBCRYPT_PKCS11_RSA_AES_WRAP_BLOB {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PBCRYPT_PKCS11_RSA_AES_WRAP_BLOB {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PBCRYPT_PQDSA_KEY_BLOB(pub *mut BCRYPT_PQDSA_KEY_BLOB);
impl PBCRYPT_PQDSA_KEY_BLOB {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PBCRYPT_PQDSA_KEY_BLOB {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PBCryptBuffer(pub *mut BCryptBuffer);
impl PBCryptBuffer {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PBCryptBuffer {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PBCryptBufferDesc(pub *mut BCryptBufferDesc);
impl PBCryptBufferDesc {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PBCryptBufferDesc {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PCRYPT_CONTEXTS(pub *mut CRYPT_CONTEXTS);
impl PCRYPT_CONTEXTS {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PCRYPT_CONTEXTS {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PCRYPT_CONTEXT_CONFIG(pub *mut CRYPT_CONTEXT_CONFIG);
impl PCRYPT_CONTEXT_CONFIG {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PCRYPT_CONTEXT_CONFIG {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PCRYPT_CONTEXT_FUNCTIONS(pub *mut CRYPT_CONTEXT_FUNCTIONS);
impl PCRYPT_CONTEXT_FUNCTIONS {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PCRYPT_CONTEXT_FUNCTIONS {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PCRYPT_CONTEXT_FUNCTION_CONFIG(pub *mut CRYPT_CONTEXT_FUNCTION_CONFIG);
impl PCRYPT_CONTEXT_FUNCTION_CONFIG {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PCRYPT_CONTEXT_FUNCTION_CONFIG {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PCRYPT_CONTEXT_FUNCTION_PROVIDERS(pub *mut CRYPT_CONTEXT_FUNCTION_PROVIDERS);
impl PCRYPT_CONTEXT_FUNCTION_PROVIDERS {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PCRYPT_CONTEXT_FUNCTION_PROVIDERS {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PCRYPT_IMAGE_REF(pub *mut CRYPT_IMAGE_REF);
impl PCRYPT_IMAGE_REF {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PCRYPT_IMAGE_REF {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PCRYPT_IMAGE_REG(pub *mut CRYPT_IMAGE_REG);
impl PCRYPT_IMAGE_REG {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PCRYPT_IMAGE_REG {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PCRYPT_INTERFACE_REG(pub *mut CRYPT_INTERFACE_REG);
impl PCRYPT_INTERFACE_REG {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PCRYPT_INTERFACE_REG {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PCRYPT_PROPERTY_REF(pub *mut CRYPT_PROPERTY_REF);
#[cfg(feature = "minwindef")]
impl PCRYPT_PROPERTY_REF {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
#[cfg(feature = "minwindef")]
impl Default for PCRYPT_PROPERTY_REF {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PCRYPT_PROVIDERS(pub *mut CRYPT_PROVIDERS);
impl PCRYPT_PROVIDERS {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PCRYPT_PROVIDERS {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PCRYPT_PROVIDER_REF(pub *mut CRYPT_PROVIDER_REF);
#[cfg(feature = "minwindef")]
impl PCRYPT_PROVIDER_REF {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
#[cfg(feature = "minwindef")]
impl Default for PCRYPT_PROVIDER_REF {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PCRYPT_PROVIDER_REFS(pub *mut CRYPT_PROVIDER_REFS);
#[cfg(feature = "minwindef")]
impl PCRYPT_PROVIDER_REFS {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
#[cfg(feature = "minwindef")]
impl Default for PCRYPT_PROVIDER_REFS {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PCRYPT_PROVIDER_REG(pub *mut CRYPT_PROVIDER_REG);
impl PCRYPT_PROVIDER_REG {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PCRYPT_PROVIDER_REG {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PNTSTATUS(pub *mut NTSTATUS);
impl PNTSTATUS {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PNTSTATUS {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PSSL_ECCKEY_BLOB(pub *mut SSL_ECCKEY_BLOB);
impl PSSL_ECCKEY_BLOB {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PSSL_ECCKEY_BLOB {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PTLS_HYBRID_KEYEXCHANGE_BLOB(pub *mut TLS_HYBRID_KEYEXCHANGE_BLOB);
#[cfg(feature = "minwindef")]
impl PTLS_HYBRID_KEYEXCHANGE_BLOB {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
#[cfg(feature = "minwindef")]
impl Default for PTLS_HYBRID_KEYEXCHANGE_BLOB {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PTLS_KEM_CIPHERTEXT_BLOB(pub *mut TLS_KEM_CIPHERTEXT_BLOB);
impl PTLS_KEM_CIPHERTEXT_BLOB {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PTLS_KEM_CIPHERTEXT_BLOB {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
