#[inline]
pub unsafe fn BCryptAddContextFunction<P1, P3>(dwtable: u32, pszcontext: P1, dwinterface: u32, pszfunction: P3, dwposition: u32) -> windows_core::NTSTATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptAddContextFunction(dwtable : u32, pszcontext : windows_core::PCWSTR, dwinterface : u32, pszfunction : windows_core::PCWSTR, dwposition : u32) -> windows_core::NTSTATUS);
...
#[inline]
pub unsafe fn BCryptConfigureContext<P1>(dwtable: u32, pszcontext: P1, pconfig: PCRYPT_CONTEXT_CONFIG) -> windows_core::NTSTATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptConfigureContext(dwtable : u32, pszcontext : windows_core::PCWSTR, pconfig : PCRYPT_CONTEXT_CONFIG) -> windows_core::NTSTATUS);
    unsafe { BCryptConfigureContext(dwtable, pszcontext.param().abi(), pconfig) }
}
#[inline]
pub unsafe fn BCryptConfigureContextFunction<P1, P3>(dwtable: u32, pszcontext: P1, dwinterface: u32, pszfunction: P3, pconfig: PCRYPT_CONTEXT_FUNCTION_CONFIG) -> windows_core::NTSTATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptConfigureContextFunction(dwtable : u32, pszcontext : windows_core::PCWSTR, dwinterface : u32, pszfunction : windows_core::PCWSTR, pconfig : PCRYPT_CONTEXT_FUNCTION_CONFIG) -> windows_core::NTSTATUS);
    unsafe { BCryptConfigureContextFunction(dwtable, pszcontext.param().abi(), dwinterface, pszfunction.param().abi(), pconfig) }
}
#[inline]
pub unsafe fn BCryptCreateContext<P1>(dwtable: u32, pszcontext: P1, pconfig: Option<PCRYPT_CONTEXT_CONFIG>) -> windows_core::NTSTATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptCreateContext(dwtable : u32, pszcontext : windows_core::PCWSTR, pconfig : PCRYPT_CONTEXT_CONFIG) -> windows_core::NTSTATUS);
    unsafe { BCryptCreateContext(dwtable, pszcontext.param().abi(), pconfig.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptCreateHash(halgorithm: BCRYPT_ALG_HANDLE, phhash: *mut BCRYPT_HASH_HANDLE, pbhashobject: Option<super::PUCHAR>, cbhashobject: u32, pbsecret: Option<&[u8]>, dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptCreateHash(halgorithm : BCRYPT_ALG_HANDLE, phhash : *mut BCRYPT_HASH_HANDLE, pbhashobject : super::PUCHAR, cbhashobject : u32, pbsecret : super::PUCHAR, cbsecret : u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptCreateHash(halgorithm as _, phhash as _, pbhashobject.unwrap_or(core::mem::zeroed()) as _, cbhashobject, core::mem::transmute(pbsecret.map_or(core::ptr::null(), |slice| slice.as_ptr())), pbsecret.map_or(0, |slice| slice.len().try_into().unwrap()), dwflags) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptCreateMultiHash(halgorithm: BCRYPT_ALG_HANDLE, phhash: *mut BCRYPT_HASH_HANDLE, nhashes: u32, pbhashobject: Option<super::PUCHAR>, cbhashobject: u32, pbsecret: Option<&[u8]>, dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptCreateMultiHash(halgorithm : BCRYPT_ALG_HANDLE, phhash : *mut BCRYPT_HASH_HANDLE, nhashes : u32, pbhashobject : super::PUCHAR, cbhashobject : u32, pbsecret : super::PUCHAR, cbsecret : u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptCreateMultiHash(halgorithm as _, phhash as _, nhashes, pbhashobject.unwrap_or(core::mem::zeroed()) as _, cbhashobject, core::mem::transmute(pbsecret.map_or(core::ptr::null(), |slice| slice.as_ptr())), pbsecret.map_or(0, |slice| slice.len().try_into().unwrap()), dwflags) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptDecapsulate(hkey: BCRYPT_KEY_HANDLE, pbciphertext: &[u8], pbsecretkey: Option<super::PUCHAR>, cbsecretkey: u32, pcbsecretkey: *mut u32, dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptDecapsulate(hkey : BCRYPT_KEY_HANDLE, pbciphertext : super::PUCHAR, cbciphertext : u32, pbsecretkey : super::PUCHAR, cbsecretkey : u32, pcbsecretkey : *mut u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptDecapsulate(hkey, core::mem::transmute(pbciphertext.as_ptr()), pbciphertext.len().try_into().unwrap(), pbsecretkey.unwrap_or(core::mem::zeroed()) as _, cbsecretkey, pcbsecretkey as _, dwflags) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptDecrypt(hkey: BCRYPT_KEY_HANDLE, pbinput: Option<&[u8]>, ppaddinginfo: Option<*const core::ffi::c_void>, pbiv: Option<&mut [u8]>, pboutput: Option<super::PUCHAR>, cboutput: u32, pcbresult: *mut u32, dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptDecrypt(hkey : BCRYPT_KEY_HANDLE, pbinput : super::PUCHAR, cbinput : u32, ppaddinginfo : *const core::ffi::c_void, pbiv : super::PUCHAR, cbiv : u32, pboutput : super::PUCHAR, cboutput : u32, pcbresult : *mut u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptDecrypt(hkey as _, core::mem::transmute(pbinput.map_or(core::ptr::null(), |slice| slice.as_ptr())), pbinput.map_or(0, |slice| slice.len().try_into().unwrap()), ppaddinginfo.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pbiv.as_deref().map_or(core::ptr::null_mut(), |slice| slice.as_ptr().cast_mut())), pbiv.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pboutput.unwrap_or(core::mem::zeroed()) as _, cboutput, pcbresult as _, dwflags) }
}
#[inline]
pub unsafe fn BCryptDeleteContext<P1>(dwtable: u32, pszcontext: P1) -> windows_core::NTSTATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptDeleteContext(dwtable : u32, pszcontext : windows_core::PCWSTR) -> windows_core::NTSTATUS);
    unsafe { BCryptDeleteContext(dwtable, pszcontext.param().abi()) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptDeriveKey<P1>(hsharedsecret: BCRYPT_SECRET_HANDLE, pwszkdf: P1, pparameterlist: Option<*const BCryptBufferDesc>, pbderivedkey: Option<super::PUCHAR>, cbderivedkey: u32, pcbresult: *mut u32, dwflags: u32) -> windows_core::NTSTATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptDeriveKey(hsharedsecret : BCRYPT_SECRET_HANDLE, pwszkdf : windows_core::PCWSTR, pparameterlist : *const BCryptBufferDesc, pbderivedkey : super::PUCHAR, cbderivedkey : u32, pcbresult : *mut u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptDeriveKey(hsharedsecret, pwszkdf.param().abi(), pparameterlist.unwrap_or(core::mem::zeroed()) as _, pbderivedkey.unwrap_or(core::mem::zeroed()) as _, cbderivedkey, pcbresult as _, dwflags) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptDeriveKeyCapi(hhash: BCRYPT_HASH_HANDLE, htargetalg: Option<BCRYPT_ALG_HANDLE>, pbderivedkey: super::PUCHAR, cbderivedkey: u32, dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptDeriveKeyCapi(hhash : BCRYPT_HASH_HANDLE, htargetalg : BCRYPT_ALG_HANDLE, pbderivedkey : super::PUCHAR, cbderivedkey : u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptDeriveKeyCapi(hhash, htargetalg.unwrap_or(core::mem::zeroed()) as _, pbderivedkey as _, cbderivedkey, dwflags) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptDeriveKeyPBKDF2(hprf: BCRYPT_ALG_HANDLE, pbpassword: Option<&[u8]>, pbsalt: Option<&[u8]>, citerations: u64, pbderivedkey: super::PUCHAR, cbderivedkey: u32, dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptDeriveKeyPBKDF2(hprf : BCRYPT_ALG_HANDLE, pbpassword : super::PUCHAR, cbpassword : u32, pbsalt : super::PUCHAR, cbsalt : u32, citerations : u64, pbderivedkey : super::PUCHAR, cbderivedkey : u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptDeriveKeyPBKDF2(hprf, core::mem::transmute(pbpassword.map_or(core::ptr::null(), |slice| slice.as_ptr())), pbpassword.map_or(0, |slice| slice.len().try_into().unwrap()), core::mem::transmute(pbsalt.map_or(core::ptr::null(), |slice| slice.as_ptr())), pbsalt.map_or(0, |slice| slice.len().try_into().unwrap()), citerations, pbderivedkey as _, cbderivedkey, dwflags) }
}
#[inline]
...
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptDuplicateHash(hhash: BCRYPT_HASH_HANDLE, phnewhash: *mut BCRYPT_HASH_HANDLE, pbhashobject: Option<super::PUCHAR>, cbhashobject: u32, dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptDuplicateHash(hhash : BCRYPT_HASH_HANDLE, phnewhash : *mut BCRYPT_HASH_HANDLE, pbhashobject : super::PUCHAR, cbhashobject : u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptDuplicateHash(hhash, phnewhash as _, pbhashobject.unwrap_or(core::mem::zeroed()) as _, cbhashobject, dwflags) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptDuplicateKey(hkey: BCRYPT_KEY_HANDLE, phnewkey: *mut BCRYPT_KEY_HANDLE, pbkeyobject: Option<super::PUCHAR>, cbkeyobject: u32, dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptDuplicateKey(hkey : BCRYPT_KEY_HANDLE, phnewkey : *mut BCRYPT_KEY_HANDLE, pbkeyobject : super::PUCHAR, cbkeyobject : u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptDuplicateKey(hkey, phnewkey as _, pbkeyobject.unwrap_or(core::mem::zeroed()) as _, cbkeyobject, dwflags) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptEncapsulate(hkey: BCRYPT_KEY_HANDLE, pbsecretkey: Option<super::PUCHAR>, cbsecretkey: u32, pcbsecretkey: *mut u32, pbciphertext: Option<super::PUCHAR>, cbciphertext: u32, pcbciphertext: *mut u32, dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptEncapsulate(hkey : BCRYPT_KEY_HANDLE, pbsecretkey : super::PUCHAR, cbsecretkey : u32, pcbsecretkey : *mut u32, pbciphertext : super::PUCHAR, cbciphertext : u32, pcbciphertext : *mut u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptEncapsulate(hkey, pbsecretkey.unwrap_or(core::mem::zeroed()) as _, cbsecretkey, pcbsecretkey as _, pbciphertext.unwrap_or(core::mem::zeroed()) as _, cbciphertext, pcbciphertext as _, dwflags) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptEncrypt(hkey: BCRYPT_KEY_HANDLE, pbinput: Option<&[u8]>, ppaddinginfo: Option<*const core::ffi::c_void>, pbiv: Option<&mut [u8]>, pboutput: Option<super::PUCHAR>, cboutput: u32, pcbresult: *mut u32, dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptEncrypt(hkey : BCRYPT_KEY_HANDLE, pbinput : super::PUCHAR, cbinput : u32, ppaddinginfo : *const core::ffi::c_void, pbiv : super::PUCHAR, cbiv : u32, pboutput : super::PUCHAR, cboutput : u32, pcbresult : *mut u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptEncrypt(hkey as _, core::mem::transmute(pbinput.map_or(core::ptr::null(), |slice| slice.as_ptr())), pbinput.map_or(0, |slice| slice.len().try_into().unwrap()), ppaddinginfo.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pbiv.as_deref().map_or(core::ptr::null_mut(), |slice| slice.as_ptr().cast_mut())), pbiv.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pboutput.unwrap_or(core::mem::zeroed()) as _, cboutput, pcbresult as _, dwflags) }
}
#[inline]
pub unsafe fn BCryptEnumAlgorithms(dwalgoperations: u32, palgcount: *mut u32, ppalglist: *mut *mut BCRYPT_ALGORITHM_IDENTIFIER, dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptEnumAlgorithms(dwalgoperations : u32, palgcount : *mut u32, ppalglist : *mut *mut BCRYPT_ALGORITHM_IDENTIFIER, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptEnumAlgorithms(dwalgoperations, palgcount as _, ppalglist as _, dwflags) }
}
#[inline]
pub unsafe fn BCryptEnumContextFunctionProviders<P1, P3>(dwtable: u32, pszcontext: P1, dwinterface: u32, pszfunction: P3, pcbbuffer: *mut u32, ppbuffer: *mut PCRYPT_CONTEXT_FUNCTION_PROVIDERS) -> windows_core::NTSTATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptEnumContextFunctionProviders(dwtable : u32, pszcontext : windows_core::PCWSTR, dwinterface : u32, pszfunction : windows_core::PCWSTR, pcbbuffer : *mut u32, ppbuffer : *mut PCRYPT_CONTEXT_FUNCTION_PROVIDERS) -> windows_core::NTSTATUS);
...
#[inline]
pub unsafe fn BCryptEnumContextFunctions<P1>(dwtable: u32, pszcontext: P1, dwinterface: u32, pcbbuffer: *mut u32, ppbuffer: *mut PCRYPT_CONTEXT_FUNCTIONS) -> windows_core::NTSTATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptEnumContextFunctions(dwtable : u32, pszcontext : windows_core::PCWSTR, dwinterface : u32, pcbbuffer : *mut u32, ppbuffer : *mut PCRYPT_CONTEXT_FUNCTIONS) -> windows_core::NTSTATUS);
    unsafe { BCryptEnumContextFunctions(dwtable, pszcontext.param().abi(), dwinterface, pcbbuffer as _, ppbuffer as _) }
}
#[inline]
pub unsafe fn BCryptEnumContexts(dwtable: u32, pcbbuffer: *mut u32, ppbuffer: *mut PCRYPT_CONTEXTS) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptEnumContexts(dwtable : u32, pcbbuffer : *mut u32, ppbuffer : *mut PCRYPT_CONTEXTS) -> windows_core::NTSTATUS);
...
#[inline]
pub unsafe fn BCryptEnumRegisteredProviders(pcbbuffer: *mut u32, ppbuffer: *mut PCRYPT_PROVIDERS) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptEnumRegisteredProviders(pcbbuffer : *mut u32, ppbuffer : *mut PCRYPT_PROVIDERS) -> windows_core::NTSTATUS);
    unsafe { BCryptEnumRegisteredProviders(pcbbuffer as _, ppbuffer as _) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptExportKey<P2>(hkey: BCRYPT_KEY_HANDLE, hexportkey: Option<BCRYPT_KEY_HANDLE>, pszblobtype: P2, pboutput: Option<super::PUCHAR>, cboutput: u32, pcbresult: *mut u32, dwflags: u32) -> windows_core::NTSTATUS
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptExportKey(hkey : BCRYPT_KEY_HANDLE, hexportkey : BCRYPT_KEY_HANDLE, pszblobtype : windows_core::PCWSTR, pboutput : super::PUCHAR, cboutput : u32, pcbresult : *mut u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptExportKey(hkey, hexportkey.unwrap_or(core::mem::zeroed()) as _, pszblobtype.param().abi(), pboutput.unwrap_or(core::mem::zeroed()) as _, cboutput, pcbresult as _, dwflags) }
}
#[inline]
...
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptFinishHash(hhash: BCRYPT_HASH_HANDLE, pboutput: super::PUCHAR, cboutput: u32, dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptFinishHash(hhash : BCRYPT_HASH_HANDLE, pboutput : super::PUCHAR, cboutput : u32, dwflags : u32) -> windows_core::NTSTATUS);
...
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptGenRandom(halgorithm: Option<BCRYPT_ALG_HANDLE>, pbbuffer: super::PUCHAR, cbbuffer: u32, dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptGenRandom(halgorithm : BCRYPT_ALG_HANDLE, pbbuffer : super::PUCHAR, cbbuffer : u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptGenRandom(halgorithm.unwrap_or(core::mem::zeroed()) as _, pbbuffer as _, cbbuffer, dwflags) }
}
#[inline]
...
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptGenerateSymmetricKey(halgorithm: BCRYPT_ALG_HANDLE, phkey: *mut BCRYPT_KEY_HANDLE, pbkeyobject: Option<super::PUCHAR>, cbkeyobject: u32, pbsecret: &[u8], dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptGenerateSymmetricKey(halgorithm : BCRYPT_ALG_HANDLE, phkey : *mut BCRYPT_KEY_HANDLE, pbkeyobject : super::PUCHAR, cbkeyobject : u32, pbsecret : super::PUCHAR, cbsecret : u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptGenerateSymmetricKey(halgorithm as _, phkey as _, pbkeyobject.unwrap_or(core::mem::zeroed()) as _, cbkeyobject, core::mem::transmute(pbsecret.as_ptr()), pbsecret.len().try_into().unwrap(), dwflags) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn BCryptGetFipsAlgorithmMode(pfenabled: *mut super::BOOLEAN) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptGetFipsAlgorithmMode(pfenabled : *mut super::BOOLEAN) -> windows_core::NTSTATUS);
    unsafe { BCryptGetFipsAlgorithmMode(pfenabled as _) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptGetProperty<P1>(hobject: BCRYPT_HANDLE, pszproperty: P1, pboutput: Option<super::PUCHAR>, cboutput: u32, pcbresult: *mut u32, dwflags: u32) -> windows_core::NTSTATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptGetProperty(hobject : BCRYPT_HANDLE, pszproperty : windows_core::PCWSTR, pboutput : super::PUCHAR, cboutput : u32, pcbresult : *mut u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptGetProperty(hobject, pszproperty.param().abi(), pboutput.unwrap_or(core::mem::zeroed()) as _, cboutput, pcbresult as _, dwflags) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptHash(halgorithm: BCRYPT_ALG_HANDLE, pbsecret: Option<&[u8]>, pbinput: &[u8], pboutput: super::PUCHAR, cboutput: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptHash(halgorithm : BCRYPT_ALG_HANDLE, pbsecret : super::PUCHAR, cbsecret : u32, pbinput : super::PUCHAR, cbinput : u32, pboutput : super::PUCHAR, cboutput : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptHash(halgorithm as _, core::mem::transmute(pbsecret.map_or(core::ptr::null(), |slice| slice.as_ptr())), pbsecret.map_or(0, |slice| slice.len().try_into().unwrap()), core::mem::transmute(pbinput.as_ptr()), pbinput.len().try_into().unwrap(), pboutput as _, cboutput) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptHashData(hhash: BCRYPT_HASH_HANDLE, pbinput: &[u8], dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptHashData(hhash : BCRYPT_HASH_HANDLE, pbinput : super::PUCHAR, cbinput : u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptHashData(hhash as _, core::mem::transmute(pbinput.as_ptr()), pbinput.len().try_into().unwrap(), dwflags) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptImportKey<P2>(halgorithm: BCRYPT_ALG_HANDLE, himportkey: Option<BCRYPT_KEY_HANDLE>, pszblobtype: P2, phkey: *mut BCRYPT_KEY_HANDLE, pbkeyobject: Option<super::PUCHAR>, cbkeyobject: u32, pbinput: &[u8], dwflags: u32) -> windows_core::NTSTATUS
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptImportKey(halgorithm : BCRYPT_ALG_HANDLE, himportkey : BCRYPT_KEY_HANDLE, pszblobtype : windows_core::PCWSTR, phkey : *mut BCRYPT_KEY_HANDLE, pbkeyobject : super::PUCHAR, cbkeyobject : u32, pbinput : super::PUCHAR, cbinput : u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptImportKey(halgorithm, himportkey.unwrap_or(core::mem::zeroed()) as _, pszblobtype.param().abi(), phkey as _, pbkeyobject.unwrap_or(core::mem::zeroed()) as _, cbkeyobject, core::mem::transmute(pbinput.as_ptr()), pbinput.len().try_into().unwrap(), dwflags) }
}
#[cfg(feature = "minwindef")]
#[inline]
...
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptImportKeyPair(halgorithm : BCRYPT_ALG_HANDLE, himportkey : BCRYPT_KEY_HANDLE, pszblobtype : windows_core::PCWSTR, phkey : *mut BCRYPT_KEY_HANDLE, pbinput : super::PUCHAR, cbinput : u32, dwflags : u32) -> windows_core::NTSTATUS);
...
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptKeyDerivation(hkey: BCRYPT_KEY_HANDLE, pparameterlist: Option<*const BCryptBufferDesc>, pbderivedkey: super::PUCHAR, cbderivedkey: u32, pcbresult: *mut u32, dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptKeyDerivation(hkey : BCRYPT_KEY_HANDLE, pparameterlist : *const BCryptBufferDesc, pbderivedkey : super::PUCHAR, cbderivedkey : u32, pcbresult : *mut u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptKeyDerivation(hkey, pparameterlist.unwrap_or(core::mem::zeroed()) as _, pbderivedkey as _, cbderivedkey, pcbresult as _, dwflags) }
}
#[inline]
pub unsafe fn BCryptOpenAlgorithmProvider<P1, P2>(phalgorithm: *mut BCRYPT_ALG_HANDLE, pszalgid: P1, pszimplementation: P2, dwflags: u32) -> windows_core::NTSTATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptOpenAlgorithmProvider(phalgorithm : *mut BCRYPT_ALG_HANDLE, pszalgid : windows_core::PCWSTR, pszimplementation : windows_core::PCWSTR, dwflags : u32) -> windows_core::NTSTATUS);
...
#[inline]
pub unsafe fn BCryptQueryContextConfiguration<P1>(dwtable: u32, pszcontext: P1, pcbbuffer: *mut u32, ppbuffer: *mut PCRYPT_CONTEXT_CONFIG) -> windows_core::NTSTATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptQueryContextConfiguration(dwtable : u32, pszcontext : windows_core::PCWSTR, pcbbuffer : *mut u32, ppbuffer : *mut PCRYPT_CONTEXT_CONFIG) -> windows_core::NTSTATUS);
    unsafe { BCryptQueryContextConfiguration(dwtable, pszcontext.param().abi(), pcbbuffer as _, ppbuffer as _) }
}
#[inline]
pub unsafe fn BCryptQueryContextFunctionConfiguration<P1, P3>(dwtable: u32, pszcontext: P1, dwinterface: u32, pszfunction: P3, pcbbuffer: *mut u32, ppbuffer: *mut PCRYPT_CONTEXT_FUNCTION_CONFIG) -> windows_core::NTSTATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptQueryContextFunctionConfiguration(dwtable : u32, pszcontext : windows_core::PCWSTR, dwinterface : u32, pszfunction : windows_core::PCWSTR, pcbbuffer : *mut u32, ppbuffer : *mut PCRYPT_CONTEXT_FUNCTION_CONFIG) -> windows_core::NTSTATUS);
...
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptQueryContextFunctionProperty<P1, P3, P4>(dwtable: u32, pszcontext: P1, dwinterface: u32, pszfunction: P3, pszproperty: P4, pcbvalue: *mut u32, ppbvalue: *mut super::PUCHAR) -> windows_core::NTSTATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptQueryContextFunctionProperty(dwtable : u32, pszcontext : windows_core::PCWSTR, dwinterface : u32, pszfunction : windows_core::PCWSTR, pszproperty : windows_core::PCWSTR, pcbvalue : *mut u32, ppbvalue : *mut super::PUCHAR) -> windows_core::NTSTATUS);
...
#[inline]
pub unsafe fn BCryptQueryProviderRegistration<P0>(pszprovider: P0, dwmode: u32, dwinterface: u32, pcbbuffer: *mut u32, ppbuffer: *mut PCRYPT_PROVIDER_REG) -> windows_core::NTSTATUS
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptQueryProviderRegistration(pszprovider : windows_core::PCWSTR, dwmode : u32, dwinterface : u32, pcbbuffer : *mut u32, ppbuffer : *mut PCRYPT_PROVIDER_REG) -> windows_core::NTSTATUS);
    unsafe { BCryptQueryProviderRegistration(pszprovider.param().abi(), dwmode, dwinterface, pcbbuffer as _, ppbuffer as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn BCryptRegisterConfigChangeNotify(phevent: *mut super::HANDLE) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptRegisterConfigChangeNotify(phevent : *mut super::HANDLE) -> windows_core::NTSTATUS);
    unsafe { BCryptRegisterConfigChangeNotify(phevent as _) }
}
#[inline]
pub unsafe fn BCryptRemoveContextFunction<P1, P3>(dwtable: u32, pszcontext: P1, dwinterface: u32, pszfunction: P3) -> windows_core::NTSTATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptRemoveContextFunction(dwtable : u32, pszcontext : windows_core::PCWSTR, dwinterface : u32, pszfunction : windows_core::PCWSTR) -> windows_core::NTSTATUS);
    unsafe { BCryptRemoveContextFunction(dwtable, pszcontext.param().abi(), dwinterface, pszfunction.param().abi()) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptResolveProviders<P0, P2, P3>(pszcontext: P0, dwinterface: Option<u32>, pszfunction: P2, pszprovider: P3, dwmode: u32, dwflags: u32, pcbbuffer: *mut u32, ppbuffer: *mut PCRYPT_PROVIDER_REFS) -> windows_core::NTSTATUS
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptResolveProviders(pszcontext : windows_core::PCWSTR, dwinterface : u32, pszfunction : windows_core::PCWSTR, pszprovider : windows_core::PCWSTR, dwmode : u32, dwflags : u32, pcbbuffer : *mut u32, ppbuffer : *mut PCRYPT_PROVIDER_REFS) -> windows_core::NTSTATUS);
...
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptSetContextFunctionProperty<P1, P3, P4>(dwtable: u32, pszcontext: P1, dwinterface: u32, pszfunction: P3, pszproperty: P4, pbvalue: Option<&[u8]>) -> windows_core::NTSTATUS
where
    P1: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptSetContextFunctionProperty(dwtable : u32, pszcontext : windows_core::PCWSTR, dwinterface : u32, pszfunction : windows_core::PCWSTR, pszproperty : windows_core::PCWSTR, cbvalue : u32, pbvalue : super::PUCHAR) -> windows_core::NTSTATUS);
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bcrypt.dll" "system" fn BCryptSetProperty(hobject : BCRYPT_HANDLE, pszproperty : windows_core::PCWSTR, pbinput : super::PUCHAR, cbinput : u32, dwflags : u32) -> windows_core::NTSTATUS);
...
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptSignHash(hkey: BCRYPT_KEY_HANDLE, ppaddinginfo: Option<*const core::ffi::c_void>, pbinput: &[u8], pboutput: Option<super::PUCHAR>, cboutput: u32, pcbresult: *mut u32, dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptSignHash(hkey : BCRYPT_KEY_HANDLE, ppaddinginfo : *const core::ffi::c_void, pbinput : super::PUCHAR, cbinput : u32, pboutput : super::PUCHAR, cboutput : u32, pcbresult : *mut u32, dwflags : u32) -> windows_core::NTSTATUS);
    unsafe { BCryptSignHash(hkey, ppaddinginfo.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pbinput.as_ptr()), pbinput.len().try_into().unwrap(), pboutput.unwrap_or(core::mem::zeroed()) as _, cboutput, pcbresult as _, dwflags) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn BCryptUnregisterConfigChangeNotify(hevent: super::HANDLE) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptUnregisterConfigChangeNotify(hevent : super::HANDLE) -> windows_core::NTSTATUS);
    unsafe { BCryptUnregisterConfigChangeNotify(hevent) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BCryptVerifySignature(hkey: BCRYPT_KEY_HANDLE, ppaddinginfo: Option<*const core::ffi::c_void>, pbhash: &[u8], pbsignature: &[u8], dwflags: u32) -> windows_core::NTSTATUS {
    windows_core::link!("bcrypt.dll" "system" fn BCryptVerifySignature(hkey : BCRYPT_KEY_HANDLE, ppaddinginfo : *const core::ffi::c_void, pbhash : super::PUCHAR, cbhash : u32, pbsignature : super::PUCHAR, cbsignature : u32, dwflags : u32) -> windows_core::NTSTATUS);
...
pub type PNTSTATUS = *mut windows_core::NTSTATUS;
