...
impl IMLOperatorAttributesVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IMLOperatorAttributesImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IMLOperatorAttributesVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, GetAttributeElementCount::<Impl, IMPL_OFFSET>, GetAttribute::<Impl, IMPL_OFFSET>, GetStringAttributeElementLength::<Impl, IMPL_OFFSET>, GetStringAttributeElement::<Impl, IMPL_OFFSET>)
    }
...
impl IMLOperatorKernelVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IMLOperatorKernelImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IMLOperatorKernelVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, Compute::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IMLOperatorKernelContextVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IMLOperatorKernelContextImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IMLOperatorKernelContextVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, GetInputTensor::<Impl, IMPL_OFFSET>, GetOutputTensor::<Impl, IMPL_OFFSET>, GetOutputTensor::<Impl, IMPL_OFFSET>, AllocateTemporaryData::<Impl, IMPL_OFFSET>, GetExecutionInterface::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IMLOperatorKernelCreationContextVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IMLOperatorKernelCreationContextImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IMLOperatorKernelCreationContextVtbl {
        ...
        Self(
            ...
            GetAttributeElementCount::<Impl, IMPL_OFFSET>,
            GetAttribute::<Impl, IMPL_OFFSET>,
            GetStringAttributeElementLength::<Impl, IMPL_OFFSET>,
            GetStringAttributeElement::<Impl, IMPL_OFFSET>,
            GetInputCount::<Impl, IMPL_OFFSET>,
            GetOutputCount::<Impl, IMPL_OFFSET>,
            IsInputValid::<Impl, IMPL_OFFSET>,
            IsOutputValid::<Impl, IMPL_OFFSET>,
            GetInputEdgeDescription::<Impl, IMPL_OFFSET>,
            GetOutputEdgeDescription::<Impl, IMPL_OFFSET>,
            HasTensorShapeDescription::<Impl, IMPL_OFFSET>,
            GetTensorShapeDescription::<Impl, IMPL_OFFSET>,
            GetExecutionInterface::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IMLOperatorKernelFactoryVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IMLOperatorKernelFactoryImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IMLOperatorKernelFactoryVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, CreateKernel::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IMLOperatorRegistryVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IMLOperatorRegistryImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IMLOperatorRegistryVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, RegisterOperatorSetSchema::<Impl, IMPL_OFFSET>, RegisterOperatorKernel::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IMLOperatorShapeInferenceContextVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IMLOperatorShapeInferenceContextImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IMLOperatorShapeInferenceContextVtbl {
        ...
        Self(
            ...
            IsOutputValid::<Impl, IMPL_OFFSET>,
            GetInputEdgeDescription::<Impl, IMPL_OFFSET>,
            GetInputTensorDimensionCount::<Impl, IMPL_OFFSET>,
            GetInputTensorShape::<Impl, IMPL_OFFSET>,
            SetOutputTensorShape::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IMLOperatorShapeInferrerVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IMLOperatorShapeInferrerImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IMLOperatorShapeInferrerVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, InferOutputShapes::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IMLOperatorTensorVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IMLOperatorTensorImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IMLOperatorTensorVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, GetDimensionCount::<Impl, IMPL_OFFSET>, GetShape::<Impl, IMPL_OFFSET>, GetTensorDataType::<Impl, IMPL_OFFSET>, IsCpuData::<Impl, IMPL_OFFSET>, IsDataInterface::<Impl, IMPL_OFFSET>, GetData::<Impl, IMPL_OFFSET>, GetDataInterface::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IMLOperatorTensorShapeDescriptionVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IMLOperatorTensorShapeDescriptionImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IMLOperatorTensorShapeDescriptionVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, GetInputTensorDimensionCount::<Impl, IMPL_OFFSET>, GetInputTensorShape::<Impl, IMPL_OFFSET>, HasOutputShapeDescription::<Impl, IMPL_OFFSET>, GetOutputTensorDimensionCount::<Impl, IMPL_OFFSET>, GetOutputTensorShape::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IMLOperatorTypeInferenceContextVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IMLOperatorTypeInferenceContextImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IMLOperatorTypeInferenceContextVtbl {
        ...
        Self(
            ...
            IsOutputValid::<Impl, IMPL_OFFSET>,
            GetInputEdgeDescription::<Impl, IMPL_OFFSET>,
            SetOutputEdgeDescription::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IMLOperatorTypeInferrerVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IMLOperatorTypeInferrerImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IMLOperatorTypeInferrerVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, InferOutputTypes::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IWinMLEvaluationContextVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWinMLEvaluationContextImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWinMLEvaluationContextVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, BindValue::<Impl, IMPL_OFFSET>, GetValueByName::<Impl, IMPL_OFFSET>, Clear::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IWinMLModelVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWinMLModelImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWinMLModelVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, GetDescription::<Impl, IMPL_OFFSET>, EnumerateMetadata::<Impl, IMPL_OFFSET>, EnumerateModelInputs::<Impl, IMPL_OFFSET>, EnumerateModelOutputs::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IWinMLRuntimeVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWinMLRuntimeImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWinMLRuntimeVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, LoadModel::<Impl, IMPL_OFFSET>, CreateEvaluationContext::<Impl, IMPL_OFFSET>, EvaluateModel::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IWinMLRuntimeFactoryVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWinMLRuntimeFactoryImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWinMLRuntimeFactoryVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, CreateRuntime::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
