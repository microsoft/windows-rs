...
pub const DML_CREATE_DEVICE_FLAG_DEBUG: DML_CREATE_DEVICE_FLAGS = 1i32;
pub const DML_CREATE_DEVICE_FLAG_NONE: DML_CREATE_DEVICE_FLAGS = 0i32;
...
pub const DML_EXECUTION_FLAG_ALLOW_HALF_PRECISION_COMPUTATION: DML_EXECUTION_FLAGS = 1i32;
pub const DML_EXECUTION_FLAG_DESCRIPTORS_VOLATILE: DML_EXECUTION_FLAGS = 4i32;
pub const DML_EXECUTION_FLAG_DISABLE_META_COMMANDS: DML_EXECUTION_FLAGS = 2i32;
pub const DML_EXECUTION_FLAG_NONE: DML_EXECUTION_FLAGS = 0i32;
...
pub const DML_FEATURE_LEVEL_4_1: DML_FEATURE_LEVEL = 16640i32;
pub const DML_FEATURE_LEVEL_5_0: DML_FEATURE_LEVEL = 20480i32;
...
pub const DML_TENSOR_FLAG_NONE: DML_TENSOR_FLAGS = 0i32;
pub const DML_TENSOR_FLAG_OWNED_BY_DML: DML_TENSOR_FLAGS = 1i32;
...
pub struct DML_BINDING_TABLE_DESC {
    pub Dispatchable: Option<IDMLDispatchable>,
...
pub struct DML_BUFFER_BINDING {
    pub Buffer: Option<super::super::super::Graphics::Direct3D12::ID3D12Resource>,
    pub Offset: u64,
    pub SizeInBytes: u64,
}
#[cfg(feature = "Win32_Graphics_Direct3D12")]
...
pub struct DML_OPERATOR_GRAPH_NODE_DESC {
    pub Operator: Option<IDMLOperator>,
    pub Name: windows_core::PCSTR,
}
