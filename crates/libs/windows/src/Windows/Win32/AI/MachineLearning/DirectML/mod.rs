...
#[inline]
pub unsafe fn DMLCreateDevice<P0, T>(d3d12device: P0, flags: DML_CREATE_DEVICE_FLAGS, result__: *mut Option<T>) -> Result<(), windows_result::HRESULT>
where
...
#[cfg(feature = "Win32_Graphics_Direct3D12")]
#[inline]
pub unsafe fn DMLCreateDevice1<P0, T>(d3d12device: P0, flags: DML_CREATE_DEVICE_FLAGS, minimumfeaturelevel: DML_FEATURE_LEVEL, result__: *mut Option<T>) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<super::super::super::Graphics::Direct3D12::ID3D12Device>,
    T: windows_core::Interface,
{
...
impl IDMLBindingTable {
    ...
    #[cfg(feature = "Win32_Graphics_Direct3D12")]
    pub unsafe fn Reset(&self, desc: Option<*const DML_BINDING_TABLE_DESC>) -> Result<(), windows_result::HRESULT> {
...
pub trait IDMLBindingTable_Impl: IDMLDeviceChild_Impl {
    ...
    fn Reset(&self, desc: *const DML_BINDING_TABLE_DESC) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Direct3D12")]
...
impl IDMLDevice {
    pub unsafe fn CheckFeatureSupport(&self, feature: DML_FEATURE, featurequerydatasize: u32, featurequerydata: Option<*const core::ffi::c_void>, featuresupportdatasize: u32, featuresupportdata: *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn CreateOperator<T>(&self, desc: *const DML_OPERATOR_DESC, result__: *mut Option<T>) -> Result<(), windows_result::HRESULT>
    where
        T: windows_core::Interface,
    {
    ...
    pub unsafe fn CompileOperator<P0, T>(&self, op: P0, flags: DML_EXECUTION_FLAGS, result__: *mut Option<T>) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn CreateOperatorInitializer<T>(&self, operators: Option<&[Option<IDMLCompiledOperator>]>) -> Result<T, windows_result::HRESULT>
    where
        T: windows_core::Interface,
    {
    ...
    pub unsafe fn CreateCommandRecorder<T>(&self) -> Result<T, windows_result::HRESULT>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
    ...
    #[cfg(feature = "Win32_Graphics_Direct3D12")]
    pub unsafe fn CreateBindingTable<T>(&self, desc: Option<*const DML_BINDING_TABLE_DESC>) -> Result<T, windows_result::HRESULT>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
    ...
    pub unsafe fn Evict(&self, ppobjects: &[Option<IDMLPageable>]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn MakeResident(&self, ppobjects: &[Option<IDMLPageable>]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetParentDevice<T>(&self) -> Result<T, windows_result::HRESULT>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
...
pub trait IDMLDevice_Impl: IDMLObject_Impl {
    fn CheckFeatureSupport(&self, feature: DML_FEATURE, featurequerydatasize: u32, featurequerydata: *const core::ffi::c_void, featuresupportdatasize: u32, featuresupportdata: *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn CreateOperator(&self, desc: *const DML_OPERATOR_DESC, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn CompileOperator(&self, op: windows_core::Ref<'_, IDMLOperator>, flags: DML_EXECUTION_FLAGS, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn CreateOperatorInitializer(&self, operatorcount: u32, operators: *const Option<IDMLCompiledOperator>, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn CreateCommandRecorder(&self, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn CreateBindingTable(&self, desc: *const DML_BINDING_TABLE_DESC, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn Evict(&self, count: u32, ppobjects: *const Option<IDMLPageable>) -> Result<(), windows_result::HRESULT>;
    fn MakeResident(&self, count: u32, ppobjects: *const Option<IDMLPageable>) -> Result<(), windows_result::HRESULT>;
    fn GetDeviceRemovedReason(&self) -> Result<(), windows_result::HRESULT>;
    fn GetParentDevice(&self, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Direct3D12")]
...
impl IDMLDevice1 {
    pub unsafe fn CompileGraph<T>(&self, desc: *const DML_GRAPH_DESC, flags: DML_EXECUTION_FLAGS, result__: *mut Option<T>) -> Result<(), windows_result::HRESULT>
    where
        T: windows_core::Interface,
    {
...
pub trait IDMLDevice1_Impl: IDMLDevice_Impl {
    fn CompileGraph(&self, desc: *const DML_GRAPH_DESC, flags: DML_EXECUTION_FLAGS, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Direct3D12")]
...
impl IDMLObject {
    pub unsafe fn GetPrivateData(&self, guid: *const windows_core::GUID, datasize: *mut u32, data: Option<*mut core::ffi::c_void>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetPrivateData(&self, guid: *const windows_core::GUID, datasize: u32, data: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetPrivateDataInterface<P1>(&self, guid: *const windows_core::GUID, data: P1) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IDMLObject_Impl: windows_core::IUnknownImpl {
    fn GetPrivateData(&self, guid: *const windows_core::GUID, datasize: *mut u32, data: *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn SetPrivateData(&self, guid: *const windows_core::GUID, datasize: u32, data: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn SetPrivateDataInterface(&self, guid: *const windows_core::GUID, data: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
...
impl IDMLOperatorInitializer {
    pub unsafe fn Reset(&self, operators: Option<&[Option<IDMLCompiledOperator>]>) -> Result<(), windows_result::HRESULT> {
...
pub trait IDMLOperatorInitializer_Impl: IDMLDispatchable_Impl {
    fn Reset(&self, operatorcount: u32, operators: *const Option<IDMLCompiledOperator>) -> Result<(), windows_result::HRESULT>;
}
