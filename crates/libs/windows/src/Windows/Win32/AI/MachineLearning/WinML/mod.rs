#[inline]
pub unsafe fn MLCreateOperatorRegistry() -> Result<IMLOperatorRegistry, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WinMLCreateRuntime() -> Result<IWinMLRuntime, windows_result::HRESULT> {
...
impl IMLOperatorAttributes {
    pub unsafe fn GetAttributeElementCount<P0>(&self, name: P0, r#type: MLOperatorAttributeType) -> Result<u32, windows_result::HRESULT>
    where
    ...
    pub unsafe fn GetAttribute<P0>(&self, name: P0, r#type: MLOperatorAttributeType, elementcount: u32, elementbytesize: usize, value: *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCSTR>,
    {
    ...
    pub unsafe fn GetStringAttributeElementLength<P0>(&self, name: P0, elementindex: u32) -> Result<u32, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCSTR>,
    {
        unsafe {
    ...
    pub unsafe fn GetStringAttributeElement<P0>(&self, name: P0, elementindex: u32, attributeelement: &mut [u8]) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCSTR>,
    {
...
pub trait IMLOperatorAttributes_Impl: windows_core::IUnknownImpl {
    fn GetAttributeElementCount(&self, name: &windows_core::PCSTR, r#type: MLOperatorAttributeType) -> Result<u32, windows_result::HRESULT>;
    fn GetAttribute(&self, name: &windows_core::PCSTR, r#type: MLOperatorAttributeType, elementcount: u32, elementbytesize: usize, value: *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn GetStringAttributeElementLength(&self, name: &windows_core::PCSTR, elementindex: u32) -> Result<u32, windows_result::HRESULT>;
    fn GetStringAttributeElement(&self, name: &windows_core::PCSTR, elementindex: u32, attributeelementbytesize: u32, attributeelement: windows_core::PSTR) -> Result<(), windows_result::HRESULT>;
}
...
impl IMLOperatorKernel {
    pub unsafe fn Compute<P0>(&self, context: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IMLOperatorKernel_Impl: windows_core::IUnknownImpl {
    fn Compute(&self, context: windows_core::Ref<'_, IMLOperatorKernelContext>) -> Result<(), windows_result::HRESULT>;
}
...
impl IMLOperatorKernelContext {
    pub unsafe fn GetInputTensor(&self, inputindex: u32) -> Result<IMLOperatorTensor, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetOutputTensor(&self, outputindex: u32, dimensionsizes: &[u32]) -> Result<IMLOperatorTensor, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetOutputTensor2(&self, outputindex: u32) -> Result<IMLOperatorTensor, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AllocateTemporaryData(&self, size: usize) -> Result<windows_core::IUnknown, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetExecutionInterface(&self) -> Result<windows_core::IUnknown, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IMLOperatorKernelContext_Impl: windows_core::IUnknownImpl {
    fn GetInputTensor(&self, inputindex: u32) -> Result<IMLOperatorTensor, windows_result::HRESULT>;
    fn GetOutputTensor(&self, outputindex: u32, dimensioncount: u32, dimensionsizes: *const u32) -> Result<IMLOperatorTensor, windows_result::HRESULT>;
    fn GetOutputTensor2(&self, outputindex: u32) -> Result<IMLOperatorTensor, windows_result::HRESULT>;
    fn AllocateTemporaryData(&self, size: usize) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
...
impl IMLOperatorKernelCreationContext {
    ...
    pub unsafe fn GetInputEdgeDescription(&self, inputindex: u32) -> Result<MLOperatorEdgeDescription, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetOutputEdgeDescription(&self, outputindex: u32) -> Result<MLOperatorEdgeDescription, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetTensorShapeDescription(&self) -> Result<IMLOperatorTensorShapeDescription, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IMLOperatorKernelCreationContext_Impl: IMLOperatorAttributes_Impl {
    ...
    fn GetInputEdgeDescription(&self, inputindex: u32) -> Result<MLOperatorEdgeDescription, windows_result::HRESULT>;
    fn GetOutputEdgeDescription(&self, outputindex: u32) -> Result<MLOperatorEdgeDescription, windows_result::HRESULT>;
    fn HasTensorShapeDescription(&self) -> bool;
    fn GetTensorShapeDescription(&self) -> Result<IMLOperatorTensorShapeDescription, windows_result::HRESULT>;
    fn GetExecutionInterface(&self, executionobject: windows_core::OutRef<'_, windows_core::IUnknown>);
}
...
impl IMLOperatorKernelFactory {
    pub unsafe fn CreateKernel<P0>(&self, context: P0) -> Result<IMLOperatorKernel, windows_result::HRESULT>
    where
...
pub trait IMLOperatorKernelFactory_Impl: windows_core::IUnknownImpl {
    fn CreateKernel(&self, context: windows_core::Ref<'_, IMLOperatorKernelCreationContext>) -> Result<IMLOperatorKernel, windows_result::HRESULT>;
}
...
impl IMLOperatorRegistry {
    pub unsafe fn RegisterOperatorSetSchema<P4, P5>(&self, operatorsetid: *const MLOperatorSetId, baselineversion: i32, schema: Option<&[*const MLOperatorSchemaDescription]>, typeinferrer: P4, shapeinferrer: P5) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn RegisterOperatorKernel<P1, P2>(&self, operatorkernel: *const MLOperatorKernelDescription, operatorkernelfactory: P1, shapeinferrer: P2) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IMLOperatorRegistry_Impl: windows_core::IUnknownImpl {
    fn RegisterOperatorSetSchema(&self, operatorsetid: *const MLOperatorSetId, baselineversion: i32, schema: *const *const MLOperatorSchemaDescription, schemacount: u32, typeinferrer: windows_core::Ref<'_, IMLOperatorTypeInferrer>, shapeinferrer: windows_core::Ref<'_, IMLOperatorShapeInferrer>) -> Result<(), windows_result::HRESULT>;
    fn RegisterOperatorKernel(&self, operatorkernel: *const MLOperatorKernelDescription, operatorkernelfactory: windows_core::Ref<'_, IMLOperatorKernelFactory>, shapeinferrer: windows_core::Ref<'_, IMLOperatorShapeInferrer>) -> Result<(), windows_result::HRESULT>;
}
...
impl IMLOperatorShapeInferenceContext {
    ...
    pub unsafe fn GetInputTensorDimensionCount(&self, inputindex: u32) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetInputTensorShape(&self, inputindex: u32, dimensions: &mut [u32]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetOutputTensorShape(&self, outputindex: u32, dimensioncount: u32, dimensions: *const u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IMLOperatorShapeInferenceContext_Impl: IMLOperatorAttributes_Impl {
    ...
    fn IsOutputValid(&self, outputindex: u32) -> bool;
    fn GetInputEdgeDescription(&self, inputindex: u32) -> Result<MLOperatorEdgeDescription, windows_result::HRESULT>;
    fn GetInputTensorDimensionCount(&self, inputindex: u32) -> Result<u32, windows_result::HRESULT>;
    fn GetInputTensorShape(&self, inputindex: u32, dimensioncount: u32, dimensions: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn SetOutputTensorShape(&self, outputindex: u32, dimensioncount: u32, dimensions: *const u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IMLOperatorShapeInferrer {
    pub unsafe fn InferOutputShapes<P0>(&self, context: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IMLOperatorShapeInferrer_Impl: windows_core::IUnknownImpl {
    fn InferOutputShapes(&self, context: windows_core::Ref<'_, IMLOperatorShapeInferenceContext>) -> Result<(), windows_result::HRESULT>;
}
...
impl IMLOperatorTensor {
    ...
    pub unsafe fn GetShape(&self, dimensions: &mut [u32]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetDataInterface(&self) -> Result<windows_core::IUnknown, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IMLOperatorTensor_Impl: windows_core::IUnknownImpl {
    ...
    fn GetShape(&self, dimensioncount: u32, dimensions: *mut u32) -> Result<(), windows_result::HRESULT>;
...
impl IMLOperatorTensorShapeDescription {
    ...
    pub unsafe fn GetOutputTensorDimensionCount(&self, outputindex: u32) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetOutputTensorShape(&self, outputindex: u32, dimensions: &mut [u32]) -> Result<(), windows_result::HRESULT> {
...
pub trait IMLOperatorTensorShapeDescription_Impl: windows_core::IUnknownImpl {
    ...
    fn GetOutputTensorDimensionCount(&self, outputindex: u32) -> Result<u32, windows_result::HRESULT>;
    fn GetOutputTensorShape(&self, outputindex: u32, dimensioncount: u32, dimensions: *mut u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IMLOperatorTypeInferenceContext {
    ...
    pub unsafe fn SetOutputEdgeDescription(&self, outputindex: u32, edgedescription: *const MLOperatorEdgeDescription) -> Result<(), windows_result::HRESULT> {
...
pub trait IMLOperatorTypeInferenceContext_Impl: IMLOperatorAttributes_Impl {
    ...
    fn IsOutputValid(&self, outputindex: u32) -> bool;
    fn GetInputEdgeDescription(&self, inputindex: u32) -> Result<MLOperatorEdgeDescription, windows_result::HRESULT>;
    fn SetOutputEdgeDescription(&self, outputindex: u32, edgedescription: *const MLOperatorEdgeDescription) -> Result<(), windows_result::HRESULT>;
}
...
impl IMLOperatorTypeInferrer {
    pub unsafe fn InferOutputTypes<P0>(&self, context: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IMLOperatorTypeInferrer_Impl: windows_core::IUnknownImpl {
    fn InferOutputTypes(&self, context: windows_core::Ref<'_, IMLOperatorTypeInferenceContext>) -> Result<(), windows_result::HRESULT>;
}
...
impl IWinMLEvaluationContext {
    ...
    pub unsafe fn BindValue(&self, pdescriptor: *const WINML_BINDING_DESC) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).BindValue)(windows_core::Interface::as_raw(self), core::mem::transmute(pdescriptor)).ok() }
    }
    #[cfg(feature = "Win32_Graphics_Direct3D12")]
    pub unsafe fn GetValueByName<P0>(&self, name: P0) -> Result<*mut WINML_BINDING_DESC, windows_result::HRESULT>
    where
...
pub trait IWinMLEvaluationContext_Impl: windows_core::IUnknownImpl {
    fn BindValue(&self, pdescriptor: *const WINML_BINDING_DESC) -> Result<(), windows_result::HRESULT>;
    fn GetValueByName(&self, name: &windows_core::PCWSTR) -> Result<*mut WINML_BINDING_DESC, windows_result::HRESULT>;
...
impl IWinMLModel {
    pub unsafe fn GetDescription(&self) -> Result<*mut WINML_MODEL_DESC, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDescription)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn EnumerateMetadata(&self, index: u32, pkey: *mut windows_core::PCWSTR, pvalue: *mut windows_core::PCWSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn EnumerateModelInputs(&self, index: u32) -> Result<*mut WINML_VARIABLE_DESC, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumerateModelOutputs(&self, index: u32) -> Result<*mut WINML_VARIABLE_DESC, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWinMLModel_Impl: windows_core::IUnknownImpl {
    fn GetDescription(&self) -> Result<*mut WINML_MODEL_DESC, windows_result::HRESULT>;
    fn EnumerateMetadata(&self, index: u32, pkey: *mut windows_core::PCWSTR, pvalue: *mut windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn EnumerateModelInputs(&self, index: u32) -> Result<*mut WINML_VARIABLE_DESC, windows_result::HRESULT>;
    fn EnumerateModelOutputs(&self, index: u32) -> Result<*mut WINML_VARIABLE_DESC, windows_result::HRESULT>;
}
...
impl IWinMLRuntime {
    pub unsafe fn LoadModel<P0>(&self, path: P0) -> Result<IWinMLModel, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    #[cfg(feature = "Win32_Graphics_Direct3D12")]
    pub unsafe fn CreateEvaluationContext<P0>(&self, device: P0) -> Result<IWinMLEvaluationContext, windows_result::HRESULT>
    where
    ...
    pub unsafe fn EvaluateModel<P0>(&self, pcontext: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IWinMLRuntime_Impl: windows_core::IUnknownImpl {
    fn LoadModel(&self, path: &windows_core::PCWSTR) -> Result<IWinMLModel, windows_result::HRESULT>;
    fn CreateEvaluationContext(&self, device: windows_core::Ref<'_, super::super::super::Graphics::Direct3D12::ID3D12Device>) -> Result<IWinMLEvaluationContext, windows_result::HRESULT>;
    fn EvaluateModel(&self, pcontext: windows_core::Ref<'_, IWinMLEvaluationContext>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Direct3D12")]
...
impl IWinMLRuntimeFactory {
    pub unsafe fn CreateRuntime(&self, runtimetype: WINML_RUNTIME_TYPE) -> Result<IWinMLRuntime, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWinMLRuntimeFactory_Impl: windows_core::IUnknownImpl {
    fn CreateRuntime(&self, runtimetype: WINML_RUNTIME_TYPE) -> Result<IWinMLRuntime, windows_result::HRESULT>;
}
