...
impl IMLOperatorAttributes {
    ...
    {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).GetAttributeElementCount)(windows_core::Interface::as_raw(self), name.param().abi(), core::mem::transmute(r#type), &mut result__).map(|| result__)
    }
    ...
    where
        P0: windows_core::Param<windows_core::PCSTR>,
    {
        (windows_core::Interface::vtable(self).GetAttribute)(windows_core::Interface::as_raw(self), name.param().abi(), core::mem::transmute(r#type), core::mem::transmute(elementcount), core::mem::transmute(elementbytesize), core::mem::transmute(value)).ok()
    }
    ...
    {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).GetStringAttributeElementLength)(windows_core::Interface::as_raw(self), name.param().abi(), core::mem::transmute(elementindex), &mut result__).map(|| result__)
    }
    pub unsafe fn GetStringAttributeElement<P0>(&self, name: P0, elementindex: u32, attributeelement: &mut [u8]) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCSTR>,
    {
        (windows_core::Interface::vtable(self).GetStringAttributeElement)(windows_core::Interface::as_raw(self), name.param().abi(), core::mem::transmute(elementindex), attributeelement.len().try_into().unwrap(), core::mem::transmute(attributeelement.as_ptr())).ok()
    }
}
#[repr(C)]
...
impl IMLOperatorKernelContext {
    pub unsafe fn GetInputTensor(&self, inputindex: u32) -> windows_core::Result<IMLOperatorTensor> {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).GetInputTensor)(windows_core::Interface::as_raw(self), core::mem::transmute(inputindex), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    }
    pub unsafe fn GetOutputTensor(&self, outputindex: u32, dimensionsizes: &[u32]) -> windows_core::Result<IMLOperatorTensor> {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).GetOutputTensor)(windows_core::Interface::as_raw(self), core::mem::transmute(outputindex), dimensionsizes.len().try_into().unwrap(), core::mem::transmute(dimensionsizes.as_ptr()), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    }
    pub unsafe fn GetOutputTensor2(&self, outputindex: u32) -> windows_core::Result<IMLOperatorTensor> {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).GetOutputTensor2)(windows_core::Interface::as_raw(self), core::mem::transmute(outputindex), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    }
    pub unsafe fn AllocateTemporaryData(&self, size: usize) -> windows_core::Result<windows_core::IUnknown> {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).AllocateTemporaryData)(windows_core::Interface::as_raw(self), core::mem::transmute(size), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    }
...
impl IMLOperatorKernelCreationContext {
    ...
    pub unsafe fn IsInputValid(&self, inputindex: u32) -> bool {
        (windows_core::Interface::vtable(self).IsInputValid)(windows_core::Interface::as_raw(self), core::mem::transmute(inputindex))
    }
    pub unsafe fn IsOutputValid(&self, outputindex: u32) -> bool {
        (windows_core::Interface::vtable(self).IsOutputValid)(windows_core::Interface::as_raw(self), core::mem::transmute(outputindex))
    }
    pub unsafe fn GetInputEdgeDescription(&self, inputindex: u32) -> windows_core::Result<MLOperatorEdgeDescription> {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).GetInputEdgeDescription)(windows_core::Interface::as_raw(self), core::mem::transmute(inputindex), &mut result__).map(|| result__)
    }
    pub unsafe fn GetOutputEdgeDescription(&self, outputindex: u32) -> windows_core::Result<MLOperatorEdgeDescription> {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).GetOutputEdgeDescription)(windows_core::Interface::as_raw(self), core::mem::transmute(outputindex), &mut result__).map(|| result__)
    }
...
impl IMLOperatorRegistry {
    ...
    {
        (windows_core::Interface::vtable(self).RegisterOperatorKernel)(windows_core::Interface::as_raw(self), core::mem::transmute(operatorkernel), operatorkernelfactory.param().abi(), shapeinferrer.param().abi()).ok()
    }
}
#[repr(C)]
...
impl IMLOperatorShapeInferenceContext {
    ...
    pub unsafe fn GetInputTensorDimensionCount(&self, inputindex: u32) -> windows_core::Result<u32> {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).GetInputTensorDimensionCount)(windows_core::Interface::as_raw(self), core::mem::transmute(inputindex), &mut result__).map(|| result__)
    }
    pub unsafe fn GetInputTensorShape(&self, inputindex: u32, dimensions: &mut [u32]) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetInputTensorShape)(windows_core::Interface::as_raw(self), core::mem::transmute(inputindex), dimensions.len().try_into().unwrap(), core::mem::transmute(dimensions.as_ptr())).ok()
    }
...
impl IMLOperatorTensorShapeDescription {
    ...
    pub unsafe fn GetOutputTensorDimensionCount(&self, outputindex: u32) -> windows_core::Result<u32> {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).GetOutputTensorDimensionCount)(windows_core::Interface::as_raw(self), core::mem::transmute(outputindex), &mut result__).map(|| result__)
    }
    pub unsafe fn GetOutputTensorShape(&self, outputindex: u32, dimensions: &mut [u32]) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetOutputTensorShape)(windows_core::Interface::as_raw(self), core::mem::transmute(outputindex), dimensions.len().try_into().unwrap(), core::mem::transmute(dimensions.as_ptr())).ok()
    }
}
#[repr(C)]
...
impl IWinMLModel {
    ...
    pub unsafe fn EnumerateModelInputs(&self, index: u32) -> windows_core::Result<*mut WINML_VARIABLE_DESC> {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).EnumerateModelInputs)(windows_core::Interface::as_raw(self), core::mem::transmute(index), &mut result__).map(|| result__)
    }
    pub unsafe fn EnumerateModelOutputs(&self, index: u32) -> windows_core::Result<*mut WINML_VARIABLE_DESC> {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).EnumerateModelOutputs)(windows_core::Interface::as_raw(self), core::mem::transmute(index), &mut result__).map(|| result__)
    }
}
#[repr(C)]
...
impl IWinMLRuntimeFactory {
    pub unsafe fn CreateRuntime(&self, runtimetype: WINML_RUNTIME_TYPE) -> windows_core::Result<IWinMLRuntime> {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).CreateRuntime)(windows_core::Interface::as_raw(self), core::mem::transmute(runtimetype), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[repr(C)]
