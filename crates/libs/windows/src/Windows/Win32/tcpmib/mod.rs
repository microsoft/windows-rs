...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCP6ROW_OWNER_MODULE(pub *mut MIB_TCP6ROW_OWNER_MODULE);
impl PMIB_TCP6ROW_OWNER_MODULE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCP6ROW_OWNER_MODULE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCP6ROW_OWNER_PID(pub *mut MIB_TCP6ROW_OWNER_PID);
impl PMIB_TCP6ROW_OWNER_PID {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCP6ROW_OWNER_PID {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCP6TABLE_OWNER_MODULE(pub *mut MIB_TCP6TABLE_OWNER_MODULE);
impl PMIB_TCP6TABLE_OWNER_MODULE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCP6TABLE_OWNER_MODULE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCP6TABLE_OWNER_PID(pub *mut MIB_TCP6TABLE_OWNER_PID);
impl PMIB_TCP6TABLE_OWNER_PID {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCP6TABLE_OWNER_PID {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCPROW(pub *mut MIB_TCPROW_LH);
impl PMIB_TCPROW {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCPROW {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCPROW2(pub *mut MIB_TCPROW2);
impl PMIB_TCPROW2 {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCPROW2 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCPROW_LH(pub *mut MIB_TCPROW_LH);
impl PMIB_TCPROW_LH {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCPROW_LH {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCPROW_OWNER_MODULE(pub *mut MIB_TCPROW_OWNER_MODULE);
impl PMIB_TCPROW_OWNER_MODULE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCPROW_OWNER_MODULE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCPROW_OWNER_PID(pub *mut MIB_TCPROW_OWNER_PID);
impl PMIB_TCPROW_OWNER_PID {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCPROW_OWNER_PID {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCPROW_W2K(pub *mut MIB_TCPROW_W2K);
impl PMIB_TCPROW_W2K {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCPROW_W2K {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCPSTATS(pub *mut MIB_TCPSTATS_LH);
impl PMIB_TCPSTATS {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCPSTATS {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCPSTATS2(pub *mut MIB_TCPSTATS2);
impl PMIB_TCPSTATS2 {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCPSTATS2 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCPSTATS_LH(pub *mut MIB_TCPSTATS_LH);
impl PMIB_TCPSTATS_LH {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCPSTATS_LH {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCPSTATS_W2K(pub *mut MIB_TCPSTATS_W2K);
impl PMIB_TCPSTATS_W2K {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCPSTATS_W2K {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCPTABLE(pub *mut MIB_TCPTABLE);
impl PMIB_TCPTABLE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCPTABLE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCPTABLE2(pub *mut MIB_TCPTABLE2);
impl PMIB_TCPTABLE2 {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCPTABLE2 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCPTABLE_OWNER_MODULE(pub *mut MIB_TCPTABLE_OWNER_MODULE);
impl PMIB_TCPTABLE_OWNER_MODULE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCPTABLE_OWNER_MODULE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PMIB_TCPTABLE_OWNER_PID(pub *mut MIB_TCPTABLE_OWNER_PID);
impl PMIB_TCPTABLE_OWNER_PID {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PMIB_TCPTABLE_OWNER_PID {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PTCP_CONNECTION_OFFLOAD_STATE(pub *mut TCP_CONNECTION_OFFLOAD_STATE);
impl PTCP_CONNECTION_OFFLOAD_STATE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PTCP_CONNECTION_OFFLOAD_STATE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PTCP_RTO_ALGORITHM(pub *mut TCP_RTO_ALGORITHM);
impl PTCP_RTO_ALGORITHM {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PTCP_RTO_ALGORITHM {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
