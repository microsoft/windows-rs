...
#[cfg(feature = "objidl")]
#[inline]
pub unsafe fn OleConvertOLESTREAMToIStorage(lpolestream: LPOLESTREAM, pstg: &Option<super::IStorage>, ptd: *const super::DVTARGETDEVICE) -> windows_core::HRESULT {
...
#[inline]
pub unsafe fn OleConvertOLESTREAMToIStorage2(lpolestream: LPOLESTREAM, pstg: &Option<super::IStorage>, ptd: Option<*const super::DVTARGETDEVICE>, opt: Option<u32>, pvcallbackcontext: Option<*const core::ffi::c_void>, pqueryconvertolelinkcallback: OLESTREAMQUERYCONVERTOLELINKCALLBACK) -> windows_core::HRESULT {
...
#[cfg(all(feature = "minwindef", feature = "objidl", feature = "objidlbase", feature = "windef", feature = "winnt", feature = "wtypes", feature = "wtypesbase"))]
#[inline]
pub unsafe fn OleConvertOLESTREAMToIStorageEx(polestm: LPOLESTREAM, pstg: &Option<super::IStorage>, pcfformat: *mut super::CLIPFORMAT, plwwidth: *mut i32, plheight: *mut i32, pdwsize: *mut u32, pmedium: super::LPSTGMEDIUM) -> windows_core::HRESULT {
