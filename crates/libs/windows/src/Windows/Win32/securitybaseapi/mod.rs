...
#[inline]
pub unsafe fn AccessCheck(psecuritydescriptor: super::PSECURITY_DESCRIPTOR, clienttoken: super::HANDLE, desiredaccess: u32, genericmapping: super::PGENERIC_MAPPING, privilegeset: Option<super::PPRIVILEGE_SET>, privilegesetlength: super::LPDWORD, grantedaccess: super::LPDWORD, accessstatus: super::LPBOOL) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn AccessCheck(psecuritydescriptor : super::PSECURITY_DESCRIPTOR, clienttoken : super::HANDLE, desiredaccess : u32, genericmapping : super::PGENERIC_MAPPING, privilegeset : super::PPRIVILEGE_SET, privilegesetlength : super::LPDWORD, grantedaccess : super::LPDWORD, accessstatus : super::LPBOOL) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn AccessCheckByType(psecuritydescriptor: super::PSECURITY_DESCRIPTOR, principalselfsid: Option<super::PSID>, clienttoken: super::HANDLE, desiredaccess: u32, objecttypelist: Option<&mut [super::OBJECT_TYPE_LIST]>, genericmapping: super::PGENERIC_MAPPING, privilegeset: Option<super::PPRIVILEGE_SET>, privilegesetlength: super::LPDWORD, grantedaccess: super::LPDWORD, accessstatus: super::LPBOOL) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn AccessCheckByType(psecuritydescriptor : super::PSECURITY_DESCRIPTOR, principalselfsid : super::PSID, clienttoken : super::HANDLE, desiredaccess : u32, objecttypelist : super::POBJECT_TYPE_LIST, objecttypelistlength : u32, genericmapping : super::PGENERIC_MAPPING, privilegeset : super::PPRIVILEGE_SET, privilegesetlength : super::LPDWORD, grantedaccess : super::LPDWORD, accessstatus : super::LPBOOL) -> windows_core::BOOL);
    unsafe { AccessCheckByType(psecuritydescriptor, principalselfsid.unwrap_or(core::mem::zeroed()) as _, clienttoken, desiredaccess, core::mem::transmute(objecttypelist.as_deref().map_or(core::ptr::null_mut(), |slice| slice.as_ptr().cast_mut())), objecttypelist.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), genericmapping, privilegeset.unwrap_or(core::mem::zeroed()) as _, privilegesetlength as _, grantedaccess as _, accessstatus as _) }
}
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn AccessCheckByTypeResultList(psecuritydescriptor: super::PSECURITY_DESCRIPTOR, principalselfsid: Option<super::PSID>, clienttoken: super::HANDLE, desiredaccess: u32, objecttypelist: Option<super::POBJECT_TYPE_LIST>, objecttypelistlength: u32, genericmapping: super::PGENERIC_MAPPING, privilegeset: Option<super::PPRIVILEGE_SET>, privilegesetlength: super::LPDWORD, grantedaccesslist: super::LPDWORD, accessstatuslist: super::LPDWORD) -> windows_core::BOOL {
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn AccessCheckByTypeResultListAndAuditAlarmByHandleW<P0, P3, P4>(subsystemname: P0, handleid: *const core::ffi::c_void, clienttoken: super::HANDLE, objecttypename: P3, objectname: P4, securitydescriptor: super::PSECURITY_DESCRIPTOR, principalselfsid: Option<super::PSID>, desiredaccess: u32, audittype: super::AUDIT_EVENT_TYPE, flags: u32, objecttypelist: Option<super::POBJECT_TYPE_LIST>, objecttypelistlength: u32, genericmapping: super::PGENERIC_MAPPING, objectcreation: bool, grantedaccesslist: super::LPDWORD, accessstatuslist: super::LPDWORD, pfgenerateonclose: super::LPBOOL) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("advapi32.dll" "system" fn AccessCheckByTypeResultListAndAuditAlarmByHandleW(subsystemname : windows_core::PCWSTR, handleid : *const core::ffi::c_void, clienttoken : super::HANDLE, objecttypename : windows_core::PCWSTR, objectname : windows_core::PCWSTR, securitydescriptor : super::PSECURITY_DESCRIPTOR, principalselfsid : super::PSID, desiredaccess : u32, audittype : super::AUDIT_EVENT_TYPE, flags : u32, objecttypelist : super::POBJECT_TYPE_LIST, objecttypelistlength : u32, genericmapping : super::PGENERIC_MAPPING, objectcreation : windows_core::BOOL, grantedaccesslist : super::LPDWORD, accessstatuslist : super::LPDWORD, pfgenerateonclose : super::LPBOOL) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AddAccessAllowedAce(pacl: super::PACL, dwacerevision: u32, accessmask: u32, psid: super::PSID) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn AddAccessAllowedAce(pacl : super::PACL, dwacerevision : u32, accessmask : u32, psid : super::PSID) -> windows_core::BOOL);
    unsafe { AddAccessAllowedAce(pacl as _, dwacerevision, accessmask, psid) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AddAccessAllowedAceEx(pacl: super::PACL, dwacerevision: u32, aceflags: u32, accessmask: u32, psid: super::PSID) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn AddAccessAllowedAceEx(pacl : super::PACL, dwacerevision : u32, aceflags : u32, accessmask : u32, psid : super::PSID) -> windows_core::BOOL);
    unsafe { AddAccessAllowedAceEx(pacl as _, dwacerevision, aceflags, accessmask, psid) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AddAccessAllowedObjectAce(pacl: super::PACL, dwacerevision: u32, aceflags: u32, accessmask: u32, objecttypeguid: Option<*const windows_core::GUID>, inheritedobjecttypeguid: Option<*const windows_core::GUID>, psid: super::PSID) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn AddAccessAllowedObjectAce(pacl : super::PACL, dwacerevision : u32, aceflags : u32, accessmask : u32, objecttypeguid : *const windows_core::GUID, inheritedobjecttypeguid : *const windows_core::GUID, psid : super::PSID) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AddAccessDeniedAce(pacl: super::PACL, dwacerevision: u32, accessmask: u32, psid: super::PSID) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn AddAccessDeniedAce(pacl : super::PACL, dwacerevision : u32, accessmask : u32, psid : super::PSID) -> windows_core::BOOL);
    unsafe { AddAccessDeniedAce(pacl as _, dwacerevision, accessmask, psid) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AddAccessDeniedAceEx(pacl: super::PACL, dwacerevision: u32, aceflags: u32, accessmask: u32, psid: super::PSID) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn AddAccessDeniedAceEx(pacl : super::PACL, dwacerevision : u32, aceflags : u32, accessmask : u32, psid : super::PSID) -> windows_core::BOOL);
    unsafe { AddAccessDeniedAceEx(pacl as _, dwacerevision, aceflags, accessmask, psid) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AddAccessDeniedObjectAce(pacl: super::PACL, dwacerevision: u32, aceflags: u32, accessmask: u32, objecttypeguid: Option<*const windows_core::GUID>, inheritedobjecttypeguid: Option<*const windows_core::GUID>, psid: super::PSID) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn AddAccessDeniedObjectAce(pacl : super::PACL, dwacerevision : u32, aceflags : u32, accessmask : u32, objecttypeguid : *const windows_core::GUID, inheritedobjecttypeguid : *const windows_core::GUID, psid : super::PSID) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AddAce(pacl: super::PACL, dwacerevision: u32, dwstartingaceindex: u32, pacelist: *const core::ffi::c_void, nacelistlength: u32) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn AddAce(pacl : super::PACL, dwacerevision : u32, dwstartingaceindex : u32, pacelist : *const core::ffi::c_void, nacelistlength : u32) -> windows_core::BOOL);
    unsafe { AddAce(pacl as _, dwacerevision, dwstartingaceindex, pacelist, nacelistlength) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AddAuditAccessAce(pacl: super::PACL, dwacerevision: u32, dwaccessmask: u32, psid: super::PSID, bauditsuccess: bool, bauditfailure: bool) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn AddAuditAccessAce(pacl : super::PACL, dwacerevision : u32, dwaccessmask : u32, psid : super::PSID, bauditsuccess : windows_core::BOOL, bauditfailure : windows_core::BOOL) -> windows_core::BOOL);
    unsafe { AddAuditAccessAce(pacl as _, dwacerevision, dwaccessmask, psid, bauditsuccess.into(), bauditfailure.into()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AddAuditAccessAceEx(pacl: super::PACL, dwacerevision: u32, aceflags: u32, dwaccessmask: u32, psid: super::PSID, bauditsuccess: bool, bauditfailure: bool) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn AddAuditAccessAceEx(pacl : super::PACL, dwacerevision : u32, aceflags : u32, dwaccessmask : u32, psid : super::PSID, bauditsuccess : windows_core::BOOL, bauditfailure : windows_core::BOOL) -> windows_core::BOOL);
    unsafe { AddAuditAccessAceEx(pacl as _, dwacerevision, aceflags, dwaccessmask, psid, bauditsuccess.into(), bauditfailure.into()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AddAuditAccessObjectAce(pacl: super::PACL, dwacerevision: u32, aceflags: u32, accessmask: u32, objecttypeguid: Option<*const windows_core::GUID>, inheritedobjecttypeguid: Option<*const windows_core::GUID>, psid: super::PSID, bauditsuccess: bool, bauditfailure: bool) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn AddAuditAccessObjectAce(pacl : super::PACL, dwacerevision : u32, aceflags : u32, accessmask : u32, objecttypeguid : *const windows_core::GUID, inheritedobjecttypeguid : *const windows_core::GUID, psid : super::PSID, bauditsuccess : windows_core::BOOL, bauditfailure : windows_core::BOOL) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AddMandatoryAce(pacl: super::PACL, dwacerevision: u32, aceflags: u32, mandatorypolicy: u32, plabelsid: super::PSID) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn AddMandatoryAce(pacl : super::PACL, dwacerevision : u32, aceflags : u32, mandatorypolicy : u32, plabelsid : super::PSID) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn AddResourceAttributeAce(pacl: super::PACL, dwacerevision: u32, aceflags: u32, accessmask: u32, psid: super::PSID, pattributeinfo: super::PCLAIM_SECURITY_ATTRIBUTES_INFORMATION, preturnlength: super::PDWORD) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn AddResourceAttributeAce(pacl : super::PACL, dwacerevision : u32, aceflags : u32, accessmask : u32, psid : super::PSID, pattributeinfo : super::PCLAIM_SECURITY_ATTRIBUTES_INFORMATION, preturnlength : super::PDWORD) -> windows_core::BOOL);
    unsafe { AddResourceAttributeAce(pacl as _, dwacerevision, aceflags, accessmask, psid, pattributeinfo, preturnlength as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AddScopedPolicyIDAce(pacl: super::PACL, dwacerevision: u32, aceflags: u32, accessmask: u32, psid: super::PSID) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn AddScopedPolicyIDAce(pacl : super::PACL, dwacerevision : u32, aceflags : u32, accessmask : u32, psid : super::PSID) -> windows_core::BOOL);
    unsafe { AddScopedPolicyIDAce(pacl as _, dwacerevision, aceflags, accessmask, psid) }
}
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn AdjustTokenGroups(tokenhandle: super::HANDLE, resettodefault: bool, newstate: Option<super::PTOKEN_GROUPS>, bufferlength: u32, previousstate: Option<super::PTOKEN_GROUPS>, returnlength: Option<super::PDWORD>) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn AdjustTokenGroups(tokenhandle : super::HANDLE, resettodefault : windows_core::BOOL, newstate : super::PTOKEN_GROUPS, bufferlength : u32, previousstate : super::PTOKEN_GROUPS, returnlength : super::PDWORD) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn AdjustTokenPrivileges(tokenhandle: super::HANDLE, disableallprivileges: bool, newstate: Option<super::PTOKEN_PRIVILEGES>, bufferlength: u32, previousstate: Option<super::PTOKEN_PRIVILEGES>, returnlength: Option<super::PDWORD>) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn AdjustTokenPrivileges(tokenhandle : super::HANDLE, disableallprivileges : windows_core::BOOL, newstate : super::PTOKEN_PRIVILEGES, bufferlength : u32, previousstate : super::PTOKEN_PRIVILEGES, returnlength : super::PDWORD) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AllocateAndInitializeSid(pidentifierauthority: super::PSID_IDENTIFIER_AUTHORITY, nsubauthoritycount: u8, nsubauthority0: u32, nsubauthority1: u32, nsubauthority2: u32, nsubauthority3: u32, nsubauthority4: u32, nsubauthority5: u32, nsubauthority6: u32, nsubauthority7: u32, psid: *mut super::PSID) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn AllocateAndInitializeSid(pidentifierauthority : super::PSID_IDENTIFIER_AUTHORITY, nsubauthoritycount : u8, nsubauthority0 : u32, nsubauthority1 : u32, nsubauthority2 : u32, nsubauthority3 : u32, nsubauthority4 : u32, nsubauthority5 : u32, nsubauthority6 : u32, nsubauthority7 : u32, psid : *mut super::PSID) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AllocateLocallyUniqueId(luid: super::PLUID) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn AllocateLocallyUniqueId(luid : super::PLUID) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn CheckTokenCapability(tokenhandle: Option<super::HANDLE>, capabilitysidtocheck: super::PSID, hascapability: super::PBOOL) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn CheckTokenCapability(tokenhandle : super::HANDLE, capabilitysidtocheck : super::PSID, hascapability : super::PBOOL) -> windows_core::BOOL);
    unsafe { CheckTokenCapability(tokenhandle.unwrap_or(core::mem::zeroed()) as _, capabilitysidtocheck, hascapability as _) }
}
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn CheckTokenMembership(tokenhandle: Option<super::HANDLE>, sidtocheck: super::PSID, ismember: super::PBOOL) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn CheckTokenMembership(tokenhandle : super::HANDLE, sidtocheck : super::PSID, ismember : super::PBOOL) -> windows_core::BOOL);
    unsafe { CheckTokenMembership(tokenhandle.unwrap_or(core::mem::zeroed()) as _, sidtocheck, ismember as _) }
}
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn CheckTokenMembershipEx(tokenhandle: Option<super::HANDLE>, sidtocheck: super::PSID, flags: u32, ismember: super::PBOOL) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn CheckTokenMembershipEx(tokenhandle : super::HANDLE, sidtocheck : super::PSID, flags : u32, ismember : super::PBOOL) -> windows_core::BOOL);
    unsafe { CheckTokenMembershipEx(tokenhandle.unwrap_or(core::mem::zeroed()) as _, sidtocheck, flags, ismember as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ConvertToAutoInheritPrivateObjectSecurity(parentdescriptor: Option<super::PSECURITY_DESCRIPTOR>, currentsecuritydescriptor: super::PSECURITY_DESCRIPTOR, newsecuritydescriptor: *mut super::PSECURITY_DESCRIPTOR, objecttype: Option<*const windows_core::GUID>, isdirectoryobject: super::BOOLEAN, genericmapping: super::PGENERIC_MAPPING) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn ConvertToAutoInheritPrivateObjectSecurity(parentdescriptor : super::PSECURITY_DESCRIPTOR, currentsecuritydescriptor : super::PSECURITY_DESCRIPTOR, newsecuritydescriptor : *mut super::PSECURITY_DESCRIPTOR, objecttype : *const windows_core::GUID, isdirectoryobject : super::BOOLEAN, genericmapping : super::PGENERIC_MAPPING) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn CreatePrivateObjectSecurity(parentdescriptor: Option<super::PSECURITY_DESCRIPTOR>, creatordescriptor: Option<super::PSECURITY_DESCRIPTOR>, newdescriptor: *mut super::PSECURITY_DESCRIPTOR, isdirectoryobject: bool, token: Option<super::HANDLE>, genericmapping: super::PGENERIC_MAPPING) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn CreatePrivateObjectSecurity(parentdescriptor : super::PSECURITY_DESCRIPTOR, creatordescriptor : super::PSECURITY_DESCRIPTOR, newdescriptor : *mut super::PSECURITY_DESCRIPTOR, isdirectoryobject : windows_core::BOOL, token : super::HANDLE, genericmapping : super::PGENERIC_MAPPING) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn CreatePrivateObjectSecurityEx(parentdescriptor: Option<super::PSECURITY_DESCRIPTOR>, creatordescriptor: Option<super::PSECURITY_DESCRIPTOR>, newdescriptor: *mut super::PSECURITY_DESCRIPTOR, objecttype: Option<*const windows_core::GUID>, iscontainerobject: bool, autoinheritflags: u32, token: Option<super::HANDLE>, genericmapping: super::PGENERIC_MAPPING) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn CreatePrivateObjectSecurityEx(parentdescriptor : super::PSECURITY_DESCRIPTOR, creatordescriptor : super::PSECURITY_DESCRIPTOR, newdescriptor : *mut super::PSECURITY_DESCRIPTOR, objecttype : *const windows_core::GUID, iscontainerobject : windows_core::BOOL, autoinheritflags : u32, token : super::HANDLE, genericmapping : super::PGENERIC_MAPPING) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn CreatePrivateObjectSecurityWithMultipleInheritance(parentdescriptor: Option<super::PSECURITY_DESCRIPTOR>, creatordescriptor: Option<super::PSECURITY_DESCRIPTOR>, newdescriptor: *mut super::PSECURITY_DESCRIPTOR, objecttypes: Option<&[*const windows_core::GUID]>, iscontainerobject: bool, autoinheritflags: u32, token: Option<super::HANDLE>, genericmapping: super::PGENERIC_MAPPING) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn CreatePrivateObjectSecurityWithMultipleInheritance(parentdescriptor : super::PSECURITY_DESCRIPTOR, creatordescriptor : super::PSECURITY_DESCRIPTOR, newdescriptor : *mut super::PSECURITY_DESCRIPTOR, objecttypes : *const *const windows_core::GUID, guidcount : u32, iscontainerobject : windows_core::BOOL, autoinheritflags : u32, token : super::HANDLE, genericmapping : super::PGENERIC_MAPPING) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn CreateRestrictedToken(existingtokenhandle: super::HANDLE, flags: u32, sidstodisable: Option<&[super::SID_AND_ATTRIBUTES]>, privilegestodelete: Option<&[super::LUID_AND_ATTRIBUTES]>, sidstorestrict: Option<&[super::SID_AND_ATTRIBUTES]>, newtokenhandle: super::PHANDLE) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn CreateRestrictedToken(existingtokenhandle : super::HANDLE, flags : u32, disablesidcount : u32, sidstodisable : super::PSID_AND_ATTRIBUTES, deleteprivilegecount : u32, privilegestodelete : super::PLUID_AND_ATTRIBUTES, restrictedsidcount : u32, sidstorestrict : super::PSID_AND_ATTRIBUTES, newtokenhandle : super::PHANDLE) -> windows_core::BOOL);
    unsafe {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn DeleteAce(pacl: super::PACL, dwaceindex: u32) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn DeleteAce(pacl : super::PACL, dwaceindex : u32) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn DuplicateToken(existingtokenhandle: super::HANDLE, impersonationlevel: super::SECURITY_IMPERSONATION_LEVEL, duplicatetokenhandle: super::PHANDLE) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn DuplicateToken(existingtokenhandle : super::HANDLE, impersonationlevel : super::SECURITY_IMPERSONATION_LEVEL, duplicatetokenhandle : super::PHANDLE) -> windows_core::BOOL);
    unsafe { DuplicateToken(existingtokenhandle, impersonationlevel, duplicatetokenhandle) }
}
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
#[inline]
pub unsafe fn DuplicateTokenEx(hexistingtoken: super::HANDLE, dwdesiredaccess: u32, lptokenattributes: Option<super::LPSECURITY_ATTRIBUTES>, impersonationlevel: super::SECURITY_IMPERSONATION_LEVEL, tokentype: super::TOKEN_TYPE, phnewtoken: super::PHANDLE) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn DuplicateTokenEx(hexistingtoken : super::HANDLE, dwdesiredaccess : u32, lptokenattributes : super::LPSECURITY_ATTRIBUTES, impersonationlevel : super::SECURITY_IMPERSONATION_LEVEL, tokentype : super::TOKEN_TYPE, phnewtoken : super::PHANDLE) -> windows_core::BOOL);
    unsafe { DuplicateTokenEx(hexistingtoken, dwdesiredaccess, lptokenattributes.unwrap_or(core::mem::zeroed()) as _, impersonationlevel, tokentype, phnewtoken) }
}
#[cfg(feature = "winnt")]
#[inline]
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn FindFirstFreeAce(pacl: super::PACL, pace: *mut *mut core::ffi::c_void) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn FindFirstFreeAce(pacl : super::PACL, pace : *mut *mut core::ffi::c_void) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetAce(pacl: super::PACL, dwaceindex: u32, pace: *mut *mut core::ffi::c_void) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn GetAce(pacl : super::PACL, dwaceindex : u32, pace : *mut *mut core::ffi::c_void) -> windows_core::BOOL);
    unsafe { GetAce(pacl, dwaceindex, pace as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetAclInformation(pacl: super::PACL, paclinformation: *mut core::ffi::c_void, naclinformationlength: u32, dwaclinformationclass: super::ACL_INFORMATION_CLASS) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn GetAclInformation(pacl : super::PACL, paclinformation : *mut core::ffi::c_void, naclinformationlength : u32, dwaclinformationclass : super::ACL_INFORMATION_CLASS) -> windows_core::BOOL);
    unsafe { GetAclInformation(pacl, paclinformation as _, naclinformationlength, dwaclinformationclass) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetAppContainerAce(acl: super::PACL, startingaceindex: u32, appcontainerace: *mut *mut core::ffi::c_void, appcontaineraceindex: Option<*mut u32>) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn GetAppContainerAce(acl : super::PACL, startingaceindex : u32, appcontainerace : *mut *mut core::ffi::c_void, appcontaineraceindex : *mut u32) -> windows_core::BOOL);
    unsafe { GetAppContainerAce(acl, startingaceindex, appcontainerace as _, appcontaineraceindex.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn GetCachedSigningLevel(file: super::HANDLE, flags: super::PULONG, signinglevel: super::PULONG, thumbprint: Option<super::PUCHAR>, thumbprintsize: Option<super::PULONG>, thumbprintalgorithm: Option<super::PULONG>) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn GetCachedSigningLevel(file : super::HANDLE, flags : super::PULONG, signinglevel : super::PULONG, thumbprint : super::PUCHAR, thumbprintsize : super::PULONG, thumbprintalgorithm : super::PULONG) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn GetFileSecurityW<P0>(lpfilename: P0, requestedinformation: super::SECURITY_INFORMATION, psecuritydescriptor: Option<super::PSECURITY_DESCRIPTOR>, nlength: u32, lpnlengthneeded: super::LPDWORD) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("advapi32.dll" "system" fn GetFileSecurityW(lpfilename : windows_core::PCWSTR, requestedinformation : super::SECURITY_INFORMATION, psecuritydescriptor : super::PSECURITY_DESCRIPTOR, nlength : u32, lpnlengthneeded : super::LPDWORD) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn GetKernelObjectSecurity(handle: super::HANDLE, requestedinformation: super::SECURITY_INFORMATION, psecuritydescriptor: Option<super::PSECURITY_DESCRIPTOR>, nlength: u32, lpnlengthneeded: super::LPDWORD) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn GetKernelObjectSecurity(handle : super::HANDLE, requestedinformation : super::SECURITY_INFORMATION, psecuritydescriptor : super::PSECURITY_DESCRIPTOR, nlength : u32, lpnlengthneeded : super::LPDWORD) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn GetPrivateObjectSecurity(objectdescriptor: super::PSECURITY_DESCRIPTOR, securityinformation: super::SECURITY_INFORMATION, resultantdescriptor: Option<super::PSECURITY_DESCRIPTOR>, descriptorlength: u32, returnlength: super::PDWORD) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn GetPrivateObjectSecurity(objectdescriptor : super::PSECURITY_DESCRIPTOR, securityinformation : super::SECURITY_INFORMATION, resultantdescriptor : super::PSECURITY_DESCRIPTOR, descriptorlength : u32, returnlength : super::PDWORD) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn GetSecurityDescriptorControl(psecuritydescriptor: super::PSECURITY_DESCRIPTOR, pcontrol: super::PSECURITY_DESCRIPTOR_CONTROL, lpdwrevision: super::LPDWORD) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn GetSecurityDescriptorControl(psecuritydescriptor : super::PSECURITY_DESCRIPTOR, pcontrol : super::PSECURITY_DESCRIPTOR_CONTROL, lpdwrevision : super::LPDWORD) -> windows_core::BOOL);
    unsafe { GetSecurityDescriptorControl(psecuritydescriptor, pcontrol as _, lpdwrevision as _) }
}
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn GetSecurityDescriptorDacl(psecuritydescriptor: super::PSECURITY_DESCRIPTOR, lpbdaclpresent: super::LPBOOL, pdacl: *mut super::PACL, lpbdacldefaulted: super::LPBOOL) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn GetSecurityDescriptorDacl(psecuritydescriptor : super::PSECURITY_DESCRIPTOR, lpbdaclpresent : super::LPBOOL, pdacl : *mut super::PACL, lpbdacldefaulted : super::LPBOOL) -> windows_core::BOOL);
    unsafe { GetSecurityDescriptorDacl(psecuritydescriptor, lpbdaclpresent as _, pdacl as _, lpbdacldefaulted as _) }
}
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn GetSecurityDescriptorGroup(psecuritydescriptor: super::PSECURITY_DESCRIPTOR, pgroup: *mut super::PSID, lpbgroupdefaulted: super::LPBOOL) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn GetSecurityDescriptorGroup(psecuritydescriptor : super::PSECURITY_DESCRIPTOR, pgroup : *mut super::PSID, lpbgroupdefaulted : super::LPBOOL) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn GetSecurityDescriptorOwner(psecuritydescriptor: super::PSECURITY_DESCRIPTOR, powner: *mut super::PSID, lpbownerdefaulted: super::LPBOOL) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn GetSecurityDescriptorOwner(psecuritydescriptor : super::PSECURITY_DESCRIPTOR, powner : *mut super::PSID, lpbownerdefaulted : super::LPBOOL) -> windows_core::BOOL);
    unsafe { GetSecurityDescriptorOwner(psecuritydescriptor, powner as _, lpbownerdefaulted as _) }
}
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn GetSecurityDescriptorRMControl(securitydescriptor: super::PSECURITY_DESCRIPTOR, rmcontrol: super::PUCHAR) -> u32 {
    windows_core::link!("advapi32.dll" "system" fn GetSecurityDescriptorRMControl(securitydescriptor : super::PSECURITY_DESCRIPTOR, rmcontrol : super::PUCHAR) -> u32);
    unsafe { GetSecurityDescriptorRMControl(securitydescriptor, rmcontrol as _) }
}
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn GetSecurityDescriptorSacl(psecuritydescriptor: super::PSECURITY_DESCRIPTOR, lpbsaclpresent: super::LPBOOL, psacl: *mut super::PACL, lpbsacldefaulted: super::LPBOOL) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn GetSecurityDescriptorSacl(psecuritydescriptor : super::PSECURITY_DESCRIPTOR, lpbsaclpresent : super::LPBOOL, psacl : *mut super::PACL, lpbsacldefaulted : super::LPBOOL) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn GetTokenInformation(tokenhandle: super::HANDLE, tokeninformationclass: super::TOKEN_INFORMATION_CLASS, tokeninformation: Option<*mut core::ffi::c_void>, tokeninformationlength: u32, returnlength: super::PDWORD) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn GetTokenInformation(tokenhandle : super::HANDLE, tokeninformationclass : super::TOKEN_INFORMATION_CLASS, tokeninformation : *mut core::ffi::c_void, tokeninformationlength : u32, returnlength : super::PDWORD) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn InitializeAcl(pacl: super::PACL, nacllength: u32, dwaclrevision: u32) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn InitializeAcl(pacl : super::PACL, nacllength : u32, dwaclrevision : u32) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn InitializeSid(sid: super::PSID, pidentifierauthority: super::PSID_IDENTIFIER_AUTHORITY, nsubauthoritycount: u8) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn InitializeSid(sid : super::PSID, pidentifierauthority : super::PSID_IDENTIFIER_AUTHORITY, nsubauthoritycount : u8) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn IsValidAcl(pacl: super::PACL) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn IsValidAcl(pacl : super::PACL) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn MakeAbsoluteSD(pselfrelativesecuritydescriptor: super::PSECURITY_DESCRIPTOR, pabsolutesecuritydescriptor: Option<super::PSECURITY_DESCRIPTOR>, lpdwabsolutesecuritydescriptorsize: super::LPDWORD, pdacl: Option<super::PACL>, lpdwdaclsize: super::LPDWORD, psacl: Option<super::PACL>, lpdwsaclsize: super::LPDWORD, powner: Option<super::PSID>, lpdwownersize: super::LPDWORD, pprimarygroup: Option<super::PSID>, lpdwprimarygroupsize: super::LPDWORD) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn MakeAbsoluteSD(pselfrelativesecuritydescriptor : super::PSECURITY_DESCRIPTOR, pabsolutesecuritydescriptor : super::PSECURITY_DESCRIPTOR, lpdwabsolutesecuritydescriptorsize : super::LPDWORD, pdacl : super::PACL, lpdwdaclsize : super::LPDWORD, psacl : super::PACL, lpdwsaclsize : super::LPDWORD, powner : super::PSID, lpdwownersize : super::LPDWORD, pprimarygroup : super::PSID, lpdwprimarygroupsize : super::LPDWORD) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn MakeSelfRelativeSD(pabsolutesecuritydescriptor: super::PSECURITY_DESCRIPTOR, pselfrelativesecuritydescriptor: Option<super::PSECURITY_DESCRIPTOR>, lpdwbufferlength: super::LPDWORD) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn MakeSelfRelativeSD(pabsolutesecuritydescriptor : super::PSECURITY_DESCRIPTOR, pselfrelativesecuritydescriptor : super::PSECURITY_DESCRIPTOR, lpdwbufferlength : super::LPDWORD) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn MapGenericMask(accessmask: super::PDWORD, genericmapping: super::PGENERIC_MAPPING) {
    windows_core::link!("advapi32.dll" "system" fn MapGenericMask(accessmask : super::PDWORD, genericmapping : super::PGENERIC_MAPPING));
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ObjectPrivilegeAuditAlarmW<P0>(subsystemname: P0, handleid: *const core::ffi::c_void, clienttoken: super::HANDLE, desiredaccess: u32, privileges: super::PPRIVILEGE_SET, accessgranted: bool) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("advapi32.dll" "system" fn ObjectPrivilegeAuditAlarmW(subsystemname : windows_core::PCWSTR, handleid : *const core::ffi::c_void, clienttoken : super::HANDLE, desiredaccess : u32, privileges : super::PPRIVILEGE_SET, accessgranted : windows_core::BOOL) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn PrivilegeCheck(clienttoken: super::HANDLE, requiredprivileges: super::PPRIVILEGE_SET, pfresult: super::LPBOOL) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn PrivilegeCheck(clienttoken : super::HANDLE, requiredprivileges : super::PPRIVILEGE_SET, pfresult : super::LPBOOL) -> windows_core::BOOL);
    unsafe { PrivilegeCheck(clienttoken, requiredprivileges as _, pfresult as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn PrivilegedServiceAuditAlarmW<P0, P1>(subsystemname: P0, servicename: P1, clienttoken: super::HANDLE, privileges: super::PPRIVILEGE_SET, accessgranted: bool) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("advapi32.dll" "system" fn PrivilegedServiceAuditAlarmW(subsystemname : windows_core::PCWSTR, servicename : windows_core::PCWSTR, clienttoken : super::HANDLE, privileges : super::PPRIVILEGE_SET, accessgranted : windows_core::BOOL) -> windows_core::BOOL);
...
pub unsafe fn QuerySecurityAccessMask(securityinformation: super::SECURITY_INFORMATION) -> u32 {
    windows_core::link!("advapi32.dll" "system" fn QuerySecurityAccessMask(securityinformation : super::SECURITY_INFORMATION, desiredaccess : super::LPDWORD));
    unsafe {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetAclInformation(pacl: super::PACL, paclinformation: *const core::ffi::c_void, naclinformationlength: u32, dwaclinformationclass: super::ACL_INFORMATION_CLASS) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn SetAclInformation(pacl : super::PACL, paclinformation : *const core::ffi::c_void, naclinformationlength : u32, dwaclinformationclass : super::ACL_INFORMATION_CLASS) -> windows_core::BOOL);
...
pub unsafe fn SetCachedSigningLevel(sourcefiles: &[super::HANDLE], flags: u32, targetfile: Option<super::HANDLE>) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SetCachedSigningLevel(sourcefiles : super::PHANDLE, sourcefilecount : u32, flags : u32, targetfile : super::HANDLE) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetPrivateObjectSecurity(securityinformation: super::SECURITY_INFORMATION, modificationdescriptor: super::PSECURITY_DESCRIPTOR, objectssecuritydescriptor: *mut super::PSECURITY_DESCRIPTOR, genericmapping: super::PGENERIC_MAPPING, token: Option<super::HANDLE>) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn SetPrivateObjectSecurity(securityinformation : super::SECURITY_INFORMATION, modificationdescriptor : super::PSECURITY_DESCRIPTOR, objectssecuritydescriptor : *mut super::PSECURITY_DESCRIPTOR, genericmapping : super::PGENERIC_MAPPING, token : super::HANDLE) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetPrivateObjectSecurityEx(securityinformation: super::SECURITY_INFORMATION, modificationdescriptor: super::PSECURITY_DESCRIPTOR, objectssecuritydescriptor: *mut super::PSECURITY_DESCRIPTOR, autoinheritflags: u32, genericmapping: super::PGENERIC_MAPPING, token: Option<super::HANDLE>) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn SetPrivateObjectSecurityEx(securityinformation : super::SECURITY_INFORMATION, modificationdescriptor : super::PSECURITY_DESCRIPTOR, objectssecuritydescriptor : *mut super::PSECURITY_DESCRIPTOR, autoinheritflags : u32, genericmapping : super::PGENERIC_MAPPING, token : super::HANDLE) -> windows_core::BOOL);
...
pub unsafe fn SetSecurityAccessMask(securityinformation: super::SECURITY_INFORMATION) -> u32 {
    windows_core::link!("advapi32.dll" "system" fn SetSecurityAccessMask(securityinformation : super::SECURITY_INFORMATION, desiredaccess : super::LPDWORD));
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetSecurityDescriptorDacl(psecuritydescriptor: super::PSECURITY_DESCRIPTOR, bdaclpresent: bool, pdacl: Option<super::PACL>, bdacldefaulted: bool) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn SetSecurityDescriptorDacl(psecuritydescriptor : super::PSECURITY_DESCRIPTOR, bdaclpresent : windows_core::BOOL, pdacl : super::PACL, bdacldefaulted : windows_core::BOOL) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn SetSecurityDescriptorRMControl(securitydescriptor: super::PSECURITY_DESCRIPTOR, rmcontrol: Option<super::PUCHAR>) -> u32 {
    windows_core::link!("advapi32.dll" "system" fn SetSecurityDescriptorRMControl(securitydescriptor : super::PSECURITY_DESCRIPTOR, rmcontrol : super::PUCHAR) -> u32);
    unsafe { SetSecurityDescriptorRMControl(securitydescriptor as _, rmcontrol.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetSecurityDescriptorSacl(psecuritydescriptor: super::PSECURITY_DESCRIPTOR, bsaclpresent: bool, psacl: Option<super::PACL>, bsacldefaulted: bool) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn SetSecurityDescriptorSacl(psecuritydescriptor : super::PSECURITY_DESCRIPTOR, bsaclpresent : windows_core::BOOL, psacl : super::PACL, bsacldefaulted : windows_core::BOOL) -> windows_core::BOOL);
