...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn uaw_wcschr(string: *const u16, character: u16) -> super::PUWSTR {
    windows_core::link!("kernel32.dll" "C" fn uaw_wcschr(string : *const u16, character : u16) -> super::PUWSTR);
    unsafe { uaw_wcschr(string, character) }
}
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn uaw_wcscpy(destination: *mut u16, source: *const u16) -> super::PUWSTR {
    windows_core::link!("kernel32.dll" "C" fn uaw_wcscpy(destination : *mut u16, source : *const u16) -> super::PUWSTR);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn uaw_wcsrchr(string: *const u16, character: u16) -> super::PUWSTR {
    windows_core::link!("kernel32.dll" "C" fn uaw_wcsrchr(string : *const u16, character : u16) -> super::PUWSTR);
