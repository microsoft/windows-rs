#[cfg(feature = "windef")]
#[inline]
pub unsafe fn DCompositionAttachMouseDragToHwnd<P0>(visual: P0, hwnd: super::HWND, enable: bool) -> windows_core::HRESULT
where
    P0: windows_core::Param<IDCompositionVisual>,
{
    windows_core::link!("dcomp.dll" "system" fn DCompositionAttachMouseDragToHwnd(visual : *mut core::ffi::c_void, hwnd : super::HWND, enable : windows_core::BOOL) -> windows_core::HRESULT);
    unsafe { DCompositionAttachMouseDragToHwnd(visual.param().abi(), hwnd, enable.into()) }
}
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn DCompositionAttachMouseWheelToHwnd<P0>(visual: P0, hwnd: super::HWND, enable: bool) -> windows_core::HRESULT
where
    P0: windows_core::Param<IDCompositionVisual>,
{
    windows_core::link!("dcomp.dll" "system" fn DCompositionAttachMouseWheelToHwnd(visual : *mut core::ffi::c_void, hwnd : super::HWND, enable : windows_core::BOOL) -> windows_core::HRESULT);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn DCompositionWaitForCompositorClock(handles: Option<&[super::HANDLE]>, timeoutinms: u32) -> u32 {
...
impl IDCompositionAffineTransform2DEffect {
    #[cfg(feature = "d2d")]
    pub unsafe fn SetInterpolationMode(&self, interpolationmode: super::D2D1_2DAFFINETRANSFORM_INTERPOLATION_MODE) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetInterpolationMode)(windows_core::Interface::as_raw(self), interpolationmode) }
    }
    #[cfg(feature = "d2d")]
    pub unsafe fn SetBorderMode(&self, bordermode: super::D2D1_BORDER_MODE) -> windows_core::HRESULT {
    ...
    pub unsafe fn SetTransformMatrix(&self, transformmatrix: *const super::D2D1_MATRIX_3X2_F) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetTransformMatrix)(windows_core::Interface::as_raw(self), transformmatrix) }
    }
    pub unsafe fn SetTransformMatrixElement<P2>(&self, row: i32, column: i32, animation: P2) -> windows_core::HRESULT
    where
        P2: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetTransformMatrixElement)(windows_core::Interface::as_raw(self), row, column, animation.param().abi()) }
    }
    pub unsafe fn SetTransformMatrixElement2(&self, row: i32, column: i32, value: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetTransformMatrixElement2)(windows_core::Interface::as_raw(self), row, column, value) }
    }
    pub unsafe fn SetSharpness<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetSharpness)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetSharpness2(&self, sharpness: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetSharpness2)(windows_core::Interface::as_raw(self), sharpness) }
    }
}
#[repr(C)]
#[doc(hidden)]
pub struct IDCompositionAffineTransform2DEffect_Vtbl {
    ...
    #[cfg(feature = "d2d")]
    pub SetInterpolationMode: unsafe extern "system" fn(*mut core::ffi::c_void, super::D2D1_2DAFFINETRANSFORM_INTERPOLATION_MODE) -> windows_core::HRESULT,
    #[cfg(not(feature = "d2d"))]
    SetInterpolationMode: usize,
    #[cfg(feature = "d2d")]
    pub SetBorderMode: unsafe extern "system" fn(*mut core::ffi::c_void, super::D2D1_BORDER_MODE) -> windows_core::HRESULT,
    #[cfg(not(feature = "d2d"))]
    SetBorderMode: usize,
    #[cfg(all(feature = "dcommon", feature = "minwindef"))]
    pub SetTransformMatrix: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::D2D1_MATRIX_3X2_F) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "dcommon", feature = "minwindef")))]
...
#[cfg(all(feature = "d2d", feature = "dcommon", feature = "minwindef"))]
pub trait IDCompositionAffineTransform2DEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetInterpolationMode(&self, interpolationmode: super::D2D1_2DAFFINETRANSFORM_INTERPOLATION_MODE) -> windows_core::Result<()>;
    fn SetBorderMode(&self, bordermode: super::D2D1_BORDER_MODE) -> windows_core::Result<()>;
    fn SetTransformMatrix(&self, transformmatrix: *const super::D2D1_MATRIX_3X2_F) -> windows_core::Result<()>;
...
impl IDCompositionAffineTransform2DEffect_Vtbl {
    pub const fn new<Identity: IDCompositionAffineTransform2DEffect_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetInterpolationMode<Identity: IDCompositionAffineTransform2DEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, interpolationmode: super::D2D1_2DAFFINETRANSFORM_INTERPOLATION_MODE) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetBorderMode<Identity: IDCompositionAffineTransform2DEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, bordermode: super::D2D1_BORDER_MODE) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDCompositionAffineTransform2DEffect_Impl::SetBorderMode(this, core::mem::transmute_copy(&bordermode)).into()
            }
        }
        unsafe extern "system" fn SetTransformMatrix<Identity: IDCompositionAffineTransform2DEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, transformmatrix: *const super::D2D1_MATRIX_3X2_F) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionArithmeticCompositeEffect {
    #[cfg(all(feature = "d2d", feature = "dcommon", feature = "minwindef"))]
    pub unsafe fn SetCoefficients(&self, coefficients: *const super::D2D1_VECTOR_4F) -> windows_core::HRESULT {
    ...
    pub unsafe fn SetCoefficient1<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetCoefficient1)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetCoefficient12(&self, coeffcient1: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetCoefficient12)(windows_core::Interface::as_raw(self), coeffcient1) }
    }
    pub unsafe fn SetCoefficient2<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetCoefficient2)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetCoefficient22(&self, coefficient2: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetCoefficient22)(windows_core::Interface::as_raw(self), coefficient2) }
    }
    pub unsafe fn SetCoefficient3<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetCoefficient3)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetCoefficient32(&self, coefficient3: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetCoefficient32)(windows_core::Interface::as_raw(self), coefficient3) }
    }
    pub unsafe fn SetCoefficient4<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetCoefficient4)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetCoefficient42(&self, coefficient4: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetCoefficient42)(windows_core::Interface::as_raw(self), coefficient4) }
    }
}
#[repr(C)]
#[doc(hidden)]
pub struct IDCompositionArithmeticCompositeEffect_Vtbl {
    pub base__: IDCompositionFilterEffect_Vtbl,
    #[cfg(all(feature = "d2d", feature = "dcommon", feature = "minwindef"))]
    pub SetCoefficients: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::D2D1_VECTOR_4F) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "d2d", feature = "dcommon", feature = "minwindef")))]
...
pub trait IDCompositionArithmeticCompositeEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetCoefficients(&self, coefficients: *const super::D2D1_VECTOR_4F) -> windows_core::Result<()>;
...
impl IDCompositionArithmeticCompositeEffect_Vtbl {
    pub const fn new<Identity: IDCompositionArithmeticCompositeEffect_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetCoefficients<Identity: IDCompositionArithmeticCompositeEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, coefficients: *const super::D2D1_VECTOR_4F) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionBlendEffect {
    #[cfg(feature = "d2d")]
    pub unsafe fn SetMode(&self, mode: super::D2D1_BLEND_MODE) -> windows_core::HRESULT {
...
pub struct IDCompositionBlendEffect_Vtbl {
    pub base__: IDCompositionFilterEffect_Vtbl,
    #[cfg(feature = "d2d")]
    pub SetMode: unsafe extern "system" fn(*mut core::ffi::c_void, super::D2D1_BLEND_MODE) -> windows_core::HRESULT,
    #[cfg(not(feature = "d2d"))]
    SetMode: usize,
}
#[cfg(feature = "d2d")]
pub trait IDCompositionBlendEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetMode(&self, mode: super::D2D1_BLEND_MODE) -> windows_core::Result<()>;
}
#[cfg(feature = "d2d")]
impl IDCompositionBlendEffect_Vtbl {
    pub const fn new<Identity: IDCompositionBlendEffect_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetMode<Identity: IDCompositionBlendEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, mode: super::D2D1_BLEND_MODE) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionBrightnessEffect {
    #[cfg(all(feature = "d2d", feature = "dcommon", feature = "minwindef"))]
    pub unsafe fn SetWhitePoint(&self, whitepoint: *const super::D2D1_VECTOR_2F) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetWhitePoint)(windows_core::Interface::as_raw(self), whitepoint) }
    }
    #[cfg(all(feature = "d2d", feature = "dcommon", feature = "minwindef"))]
    pub unsafe fn SetBlackPoint(&self, blackpoint: *const super::D2D1_VECTOR_2F) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetBlackPoint)(windows_core::Interface::as_raw(self), blackpoint) }
    }
    pub unsafe fn SetWhitePointX<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetWhitePointX)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetWhitePointX2(&self, whitepointx: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetWhitePointX2)(windows_core::Interface::as_raw(self), whitepointx) }
    }
    pub unsafe fn SetWhitePointY<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetWhitePointY)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetWhitePointY2(&self, whitepointy: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetWhitePointY2)(windows_core::Interface::as_raw(self), whitepointy) }
    }
    pub unsafe fn SetBlackPointX<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetBlackPointX)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetBlackPointX2(&self, blackpointx: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetBlackPointX2)(windows_core::Interface::as_raw(self), blackpointx) }
    }
    pub unsafe fn SetBlackPointY<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetBlackPointY)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetBlackPointY2(&self, blackpointy: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetBlackPointY2)(windows_core::Interface::as_raw(self), blackpointy) }
    }
}
#[repr(C)]
#[doc(hidden)]
pub struct IDCompositionBrightnessEffect_Vtbl {
    pub base__: IDCompositionFilterEffect_Vtbl,
    #[cfg(all(feature = "d2d", feature = "dcommon", feature = "minwindef"))]
    pub SetWhitePoint: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::D2D1_VECTOR_2F) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "d2d", feature = "dcommon", feature = "minwindef")))]
    SetWhitePoint: usize,
    #[cfg(all(feature = "d2d", feature = "dcommon", feature = "minwindef"))]
    pub SetBlackPoint: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::D2D1_VECTOR_2F) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "d2d", feature = "dcommon", feature = "minwindef")))]
    SetBlackPoint: usize,
...
pub trait IDCompositionBrightnessEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetWhitePoint(&self, whitepoint: *const super::D2D1_VECTOR_2F) -> windows_core::Result<()>;
    fn SetBlackPoint(&self, blackpoint: *const super::D2D1_VECTOR_2F) -> windows_core::Result<()>;
...
impl IDCompositionBrightnessEffect_Vtbl {
    pub const fn new<Identity: IDCompositionBrightnessEffect_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetWhitePoint<Identity: IDCompositionBrightnessEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, whitepoint: *const super::D2D1_VECTOR_2F) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDCompositionBrightnessEffect_Impl::SetWhitePoint(this, core::mem::transmute_copy(&whitepoint)).into()
            }
        }
        unsafe extern "system" fn SetBlackPoint<Identity: IDCompositionBrightnessEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, blackpoint: *const super::D2D1_VECTOR_2F) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionColorMatrixEffect {
    ...
    where
        P2: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetMatrixElement)(windows_core::Interface::as_raw(self), row, column, animation.param().abi()) }
    }
    pub unsafe fn SetMatrixElement2(&self, row: i32, column: i32, value: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetMatrixElement2)(windows_core::Interface::as_raw(self), row, column, value) }
    }
    #[cfg(feature = "d2d")]
    pub unsafe fn SetAlphaMode(&self, mode: super::D2D1_COLORMATRIX_ALPHA_MODE) -> windows_core::HRESULT {
...
pub struct IDCompositionColorMatrixEffect_Vtbl {
    ...
    #[cfg(feature = "d2d")]
    pub SetAlphaMode: unsafe extern "system" fn(*mut core::ffi::c_void, super::D2D1_COLORMATRIX_ALPHA_MODE) -> windows_core::HRESULT,
    #[cfg(not(feature = "d2d"))]
    SetAlphaMode: usize,
    pub SetClampOutput: unsafe extern "system" fn(*mut core::ffi::c_void, windows_core::BOOL) -> windows_core::HRESULT,
}
...
impl IDCompositionColorMatrixEffect_Vtbl {
    pub const fn new<Identity: IDCompositionColorMatrixEffect_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn SetAlphaMode<Identity: IDCompositionColorMatrixEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, mode: super::D2D1_COLORMATRIX_ALPHA_MODE) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionCompositeEffect {
    #[cfg(feature = "d2d")]
    pub unsafe fn SetMode(&self, mode: super::D2D1_COMPOSITE_MODE) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetMode)(windows_core::Interface::as_raw(self), mode) }
    }
}
#[repr(C)]
...
pub struct IDCompositionCompositeEffect_Vtbl {
    pub base__: IDCompositionFilterEffect_Vtbl,
    #[cfg(feature = "d2d")]
    pub SetMode: unsafe extern "system" fn(*mut core::ffi::c_void, super::D2D1_COMPOSITE_MODE) -> windows_core::HRESULT,
    #[cfg(not(feature = "d2d"))]
    SetMode: usize,
}
#[cfg(feature = "d2d")]
pub trait IDCompositionCompositeEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetMode(&self, mode: super::D2D1_COMPOSITE_MODE) -> windows_core::Result<()>;
}
#[cfg(feature = "d2d")]
impl IDCompositionCompositeEffect_Vtbl {
    pub const fn new<Identity: IDCompositionCompositeEffect_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetMode<Identity: IDCompositionCompositeEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, mode: super::D2D1_COMPOSITE_MODE) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionDesktopDevice {
    #[cfg(feature = "windef")]
    pub unsafe fn CreateTargetForHwnd(&self, hwnd: super::HWND, topmost: bool) -> windows_core::Result<IDCompositionTarget> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateTargetForHwnd)(windows_core::Interface::as_raw(self), hwnd, topmost.into(), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    #[cfg(feature = "winnt")]
    pub unsafe fn CreateSurfaceFromHandle(&self, handle: super::HANDLE) -> windows_core::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSurfaceFromHandle)(windows_core::Interface::as_raw(self), handle, &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    #[cfg(feature = "windef")]
    pub unsafe fn CreateSurfaceFromHwnd(&self, hwnd: super::HWND) -> windows_core::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSurfaceFromHwnd)(windows_core::Interface::as_raw(self), hwnd, &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
}
#[repr(C)]
...
pub struct IDCompositionDesktopDevice_Vtbl {
    ...
    #[cfg(feature = "winnt")]
    pub CreateSurfaceFromHandle: unsafe extern "system" fn(*mut core::ffi::c_void, super::HANDLE, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "winnt"))]
    CreateSurfaceFromHandle: usize,
    #[cfg(feature = "windef")]
    pub CreateSurfaceFromHwnd: unsafe extern "system" fn(*mut core::ffi::c_void, super::HWND, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
...
pub trait IDCompositionDesktopDevice_Impl: IDCompositionDevice2_Impl {
    fn CreateTargetForHwnd(&self, hwnd: super::HWND, topmost: windows_core::BOOL) -> windows_core::Result<IDCompositionTarget>;
    fn CreateSurfaceFromHandle(&self, handle: super::HANDLE) -> windows_core::Result<windows_core::IUnknown>;
    fn CreateSurfaceFromHwnd(&self, hwnd: super::HWND) -> windows_core::Result<windows_core::IUnknown>;
}
#[cfg(all(feature = "dxgi", feature = "windef", feature = "winnt"))]
impl IDCompositionDesktopDevice_Vtbl {
    pub const fn new<Identity: IDCompositionDesktopDevice_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateTargetForHwnd<Identity: IDCompositionDesktopDevice_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hwnd: super::HWND, topmost: windows_core::BOOL, target: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateSurfaceFromHandle<Identity: IDCompositionDesktopDevice_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, handle: super::HANDLE, surface: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateSurfaceFromHwnd<Identity: IDCompositionDesktopDevice_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hwnd: super::HWND, surface: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionDevice {
    ...
    pub unsafe fn CreateVisual(&self) -> windows_core::Result<IDCompositionVisual> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateVisual)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    #[cfg(feature = "dxgi")]
    pub unsafe fn CreateSurface(&self, width: u32, height: u32, pixelformat: super::DXGI_FORMAT, alphamode: super::DXGI_ALPHA_MODE) -> windows_core::Result<IDCompositionSurface> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSurface)(windows_core::Interface::as_raw(self), width, height, pixelformat, alphamode, &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    #[cfg(feature = "dxgi")]
    pub unsafe fn CreateVirtualSurface(&self, initialwidth: u32, initialheight: u32, pixelformat: super::DXGI_FORMAT, alphamode: super::DXGI_ALPHA_MODE) -> windows_core::Result<IDCompositionVirtualSurface> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateVirtualSurface)(windows_core::Interface::as_raw(self), initialwidth, initialheight, pixelformat, alphamode, &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    #[cfg(feature = "winnt")]
    pub unsafe fn CreateSurfaceFromHandle(&self, handle: super::HANDLE) -> windows_core::Result<windows_core::IUnknown> {
    ...
    pub unsafe fn CreateTranslateTransform(&self) -> windows_core::Result<IDCompositionTranslateTransform> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateTranslateTransform)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateScaleTransform(&self) -> windows_core::Result<IDCompositionScaleTransform> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateScaleTransform)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateRotateTransform(&self) -> windows_core::Result<IDCompositionRotateTransform> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateRotateTransform)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateSkewTransform(&self) -> windows_core::Result<IDCompositionSkewTransform> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSkewTransform)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateMatrixTransform(&self) -> windows_core::Result<IDCompositionMatrixTransform> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateMatrixTransform)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateTransformGroup(&self, transforms: &[Option<IDCompositionTransform>]) -> windows_core::Result<IDCompositionTransform> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateTransformGroup)(windows_core::Interface::as_raw(self), core::mem::transmute(transforms.as_ptr()), transforms.len().try_into().unwrap(), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateTranslateTransform3D(&self) -> windows_core::Result<IDCompositionTranslateTransform3D> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateTranslateTransform3D)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateScaleTransform3D(&self) -> windows_core::Result<IDCompositionScaleTransform3D> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateScaleTransform3D)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateRotateTransform3D(&self) -> windows_core::Result<IDCompositionRotateTransform3D> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateRotateTransform3D)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateMatrixTransform3D(&self) -> windows_core::Result<IDCompositionMatrixTransform3D> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateMatrixTransform3D)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateTransform3DGroup(&self, transforms3d: &[Option<IDCompositionTransform3D>]) -> windows_core::Result<IDCompositionTransform3D> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateTransform3DGroup)(windows_core::Interface::as_raw(self), core::mem::transmute(transforms3d.as_ptr()), transforms3d.len().try_into().unwrap(), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateEffectGroup(&self) -> windows_core::Result<IDCompositionEffectGroup> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateEffectGroup)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateRectangleClip(&self) -> windows_core::Result<IDCompositionRectangleClip> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateRectangleClip)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateAnimation(&self) -> windows_core::Result<IDCompositionAnimation> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateAnimation)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
...
pub struct IDCompositionDevice_Vtbl {
    ...
    #[cfg(feature = "dxgi")]
    pub CreateSurface: unsafe extern "system" fn(*mut core::ffi::c_void, u32, u32, super::DXGI_FORMAT, super::DXGI_ALPHA_MODE, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "dxgi"))]
    CreateSurface: usize,
    #[cfg(feature = "dxgi")]
    pub CreateVirtualSurface: unsafe extern "system" fn(*mut core::ffi::c_void, u32, u32, super::DXGI_FORMAT, super::DXGI_ALPHA_MODE, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "dxgi"))]
...
pub trait IDCompositionDevice_Impl: windows_core::IUnknownImpl {
    ...
    fn CreateSurface(&self, width: u32, height: u32, pixelformat: super::DXGI_FORMAT, alphamode: super::DXGI_ALPHA_MODE) -> windows_core::Result<IDCompositionSurface>;
    fn CreateVirtualSurface(&self, initialwidth: u32, initialheight: u32, pixelformat: super::DXGI_FORMAT, alphamode: super::DXGI_ALPHA_MODE) -> windows_core::Result<IDCompositionVirtualSurface>;
    fn CreateSurfaceFromHandle(&self, handle: super::HANDLE) -> windows_core::Result<windows_core::IUnknown>;
    fn CreateSurfaceFromHwnd(&self, hwnd: super::HWND) -> windows_core::Result<windows_core::IUnknown>;
...
impl IDCompositionDevice_Vtbl {
    pub const fn new<Identity: IDCompositionDevice_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn CreateTargetForHwnd<Identity: IDCompositionDevice_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hwnd: super::HWND, topmost: windows_core::BOOL, target: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateSurface<Identity: IDCompositionDevice_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, width: u32, height: u32, pixelformat: super::DXGI_FORMAT, alphamode: super::DXGI_ALPHA_MODE, surface: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateVirtualSurface<Identity: IDCompositionDevice_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, initialwidth: u32, initialheight: u32, pixelformat: super::DXGI_FORMAT, alphamode: super::DXGI_ALPHA_MODE, virtualsurface: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateSurfaceFromHandle<Identity: IDCompositionDevice_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, handle: super::HANDLE, surface: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateSurfaceFromHwnd<Identity: IDCompositionDevice_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hwnd: super::HWND, surface: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionDevice2 {
        ...
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSurfaceFactory)(windows_core::Interface::as_raw(self), renderingdevice.param().abi(), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    #[cfg(feature = "dxgi")]
    pub unsafe fn CreateSurface(&self, width: u32, height: u32, pixelformat: super::DXGI_FORMAT, alphamode: super::DXGI_ALPHA_MODE) -> windows_core::Result<IDCompositionSurface> {
...
impl IDCompositionDevice2_Vtbl {
    pub const fn new<Identity: IDCompositionDevice2_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn CreateSurface<Identity: IDCompositionDevice2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, width: u32, height: u32, pixelformat: super::DXGI_FORMAT, alphamode: super::DXGI_ALPHA_MODE, surface: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateVirtualSurface<Identity: IDCompositionDevice2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, initialwidth: u32, initialheight: u32, pixelformat: super::DXGI_FORMAT, alphamode: super::DXGI_ALPHA_MODE, virtualsurface: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionDevice3 {
    pub unsafe fn CreateGaussianBlurEffect(&self) -> windows_core::Result<IDCompositionGaussianBlurEffect> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateGaussianBlurEffect)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateBrightnessEffect(&self) -> windows_core::Result<IDCompositionBrightnessEffect> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateBrightnessEffect)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateColorMatrixEffect(&self) -> windows_core::Result<IDCompositionColorMatrixEffect> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateColorMatrixEffect)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateShadowEffect(&self) -> windows_core::Result<IDCompositionShadowEffect> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateShadowEffect)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateHueRotationEffect(&self) -> windows_core::Result<IDCompositionHueRotationEffect> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateHueRotationEffect)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateSaturationEffect(&self) -> windows_core::Result<IDCompositionSaturationEffect> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSaturationEffect)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateTurbulenceEffect(&self) -> windows_core::Result<IDCompositionTurbulenceEffect> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateTurbulenceEffect)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateLinearTransferEffect(&self) -> windows_core::Result<IDCompositionLinearTransferEffect> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateLinearTransferEffect)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateTableTransferEffect(&self) -> windows_core::Result<IDCompositionTableTransferEffect> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateTableTransferEffect)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateCompositeEffect(&self) -> windows_core::Result<IDCompositionCompositeEffect> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateCompositeEffect)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateBlendEffect(&self) -> windows_core::Result<IDCompositionBlendEffect> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateBlendEffect)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateArithmeticCompositeEffect(&self) -> windows_core::Result<IDCompositionArithmeticCompositeEffect> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateArithmeticCompositeEffect)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateAffineTransform2DEffect(&self) -> windows_core::Result<IDCompositionAffineTransform2DEffect> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateAffineTransform2DEffect)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
}
#[repr(C)]
...
impl IDCompositionDevice5 {
    pub unsafe fn CreateDynamicTexture(&self) -> windows_core::Result<IDCompositionDynamicTexture> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateDynamicTexture)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
}
#[repr(C)]
...
impl IDCompositionDynamicTexture {
    ...
    pub unsafe fn SetTexture<P0>(&self, ptexture: P0, prects: *const super::D2D_RECT_L, rectcount: usize) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionTexture>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetTexture)(windows_core::Interface::as_raw(self), ptexture.param().abi(), prects, rectcount) }
    }
    pub unsafe fn SetTexture2<P0>(&self, ptexture: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionTexture>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetTexture2)(windows_core::Interface::as_raw(self), ptexture.param().abi()) }
    }
}
#[repr(C)]
#[doc(hidden)]
pub struct IDCompositionDynamicTexture_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(all(feature = "dcommon", feature = "windef"))]
    pub SetTexture: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *const super::D2D_RECT_L, usize) -> windows_core::HRESULT,
...
pub trait IDCompositionDynamicTexture_Impl: windows_core::IUnknownImpl {
    fn SetTexture(&self, ptexture: windows_core::Ref<IDCompositionTexture>, prects: *const super::D2D_RECT_L, rectcount: usize) -> windows_core::Result<()>;
...
impl IDCompositionDynamicTexture_Vtbl {
    pub const fn new<Identity: IDCompositionDynamicTexture_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetTexture<Identity: IDCompositionDynamicTexture_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, ptexture: *mut core::ffi::c_void, prects: *const super::D2D_RECT_L, rectcount: usize) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionEffectGroup {
    ...
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetOpacity)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetOpacity2(&self, opacity: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetOpacity2)(windows_core::Interface::as_raw(self), opacity) }
    }
...
impl IDCompositionGaussianBlurEffect {
    pub unsafe fn SetStandardDeviation<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetStandardDeviation)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetStandardDeviation2(&self, amount: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetStandardDeviation2)(windows_core::Interface::as_raw(self), amount) }
    }
    #[cfg(feature = "d2d")]
    pub unsafe fn SetBorderMode(&self, mode: super::D2D1_BORDER_MODE) -> windows_core::HRESULT {
...
pub trait IDCompositionGaussianBlurEffect_Impl: IDCompositionFilterEffect_Impl {
    ...
    fn SetBorderMode(&self, mode: super::D2D1_BORDER_MODE) -> windows_core::Result<()>;
}
#[cfg(feature = "d2d")]
impl IDCompositionGaussianBlurEffect_Vtbl {
    pub const fn new<Identity: IDCompositionGaussianBlurEffect_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn SetBorderMode<Identity: IDCompositionGaussianBlurEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, mode: super::D2D1_BORDER_MODE) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionHueRotationEffect {
    pub unsafe fn SetAngle<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetAngle)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetAngle2(&self, amountdegrees: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetAngle2)(windows_core::Interface::as_raw(self), amountdegrees) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IDCompositionInkTrailDevice {
    pub unsafe fn CreateDelegatedInkTrail(&self) -> windows_core::Result<IDCompositionDelegatedInkTrail> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateDelegatedInkTrail)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
        ...
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateDelegatedInkTrailForSwapChain)(windows_core::Interface::as_raw(self), swapchain.param().abi(), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
}
#[repr(C)]
...
impl IDCompositionLinearTransferEffect {
    pub unsafe fn SetRedYIntercept<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetRedYIntercept)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetRedYIntercept2(&self, redyintercept: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetRedYIntercept2)(windows_core::Interface::as_raw(self), redyintercept) }
    }
    pub unsafe fn SetRedSlope<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetRedSlope)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetRedSlope2(&self, redslope: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetRedSlope2)(windows_core::Interface::as_raw(self), redslope) }
    }
    ...
    pub unsafe fn SetGreenYIntercept<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetGreenYIntercept)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetGreenYIntercept2(&self, greenyintercept: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetGreenYIntercept2)(windows_core::Interface::as_raw(self), greenyintercept) }
    }
    pub unsafe fn SetGreenSlope<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetGreenSlope)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetGreenSlope2(&self, greenslope: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetGreenSlope2)(windows_core::Interface::as_raw(self), greenslope) }
    }
    ...
    pub unsafe fn SetBlueYIntercept<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetBlueYIntercept)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetBlueYIntercept2(&self, blueyintercept: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetBlueYIntercept2)(windows_core::Interface::as_raw(self), blueyintercept) }
    }
    pub unsafe fn SetBlueSlope<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetBlueSlope)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetBlueSlope2(&self, blueslope: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetBlueSlope2)(windows_core::Interface::as_raw(self), blueslope) }
    }
    ...
    pub unsafe fn SetAlphaYIntercept<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetAlphaYIntercept)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetAlphaYIntercept2(&self, alphayintercept: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetAlphaYIntercept2)(windows_core::Interface::as_raw(self), alphayintercept) }
    }
    pub unsafe fn SetAlphaSlope<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetAlphaSlope)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetAlphaSlope2(&self, alphaslope: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetAlphaSlope2)(windows_core::Interface::as_raw(self), alphaslope) }
    }
...
impl IDCompositionMatrixTransform {
    #[cfg(all(feature = "dcommon", feature = "minwindef"))]
    pub unsafe fn SetMatrix(&self, matrix: *const super::D2D_MATRIX_3X2_F) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetMatrix)(windows_core::Interface::as_raw(self), matrix) }
    }
    pub unsafe fn SetMatrixElement<P2>(&self, row: i32, column: i32, animation: P2) -> windows_core::HRESULT
    where
...
pub struct IDCompositionMatrixTransform_Vtbl {
    ...
    #[cfg(all(feature = "dcommon", feature = "minwindef"))]
    pub SetMatrix: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::D2D_MATRIX_3X2_F) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "dcommon", feature = "minwindef")))]
    SetMatrix: usize,
    pub SetMatrixElement: unsafe extern "system" fn(*mut core::ffi::c_void, i32, i32, *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub SetMatrixElement2: unsafe extern "system" fn(*mut core::ffi::c_void, i32, i32, f32) -> windows_core::HRESULT,
...
pub trait IDCompositionMatrixTransform_Impl: IDCompositionTransform_Impl {
    fn SetMatrix(&self, matrix: *const super::D2D_MATRIX_3X2_F) -> windows_core::Result<()>;
    fn SetMatrixElement(&self, row: i32, column: i32, animation: windows_core::Ref<IDCompositionAnimation>) -> windows_core::Result<()>;
    fn SetMatrixElement2(&self, row: i32, column: i32, value: f32) -> windows_core::Result<()>;
}
#[cfg(all(feature = "dcommon", feature = "minwindef"))]
impl IDCompositionMatrixTransform_Vtbl {
    pub const fn new<Identity: IDCompositionMatrixTransform_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetMatrix<Identity: IDCompositionMatrixTransform_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, matrix: *const super::D2D_MATRIX_3X2_F) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionMatrixTransform3D {
    #[cfg(feature = "d3d9")]
    pub unsafe fn SetMatrix(&self, matrix: *const super::D3DMATRIX) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetMatrix)(windows_core::Interface::as_raw(self), matrix) }
    }
    pub unsafe fn SetMatrixElement<P2>(&self, row: i32, column: i32, animation: P2) -> windows_core::HRESULT
    where
...
pub struct IDCompositionMatrixTransform3D_Vtbl {
    ...
    #[cfg(feature = "d3d9")]
    pub SetMatrix: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::D3DMATRIX) -> windows_core::HRESULT,
...
pub trait IDCompositionMatrixTransform3D_Impl: IDCompositionTransform3D_Impl {
    fn SetMatrix(&self, matrix: *const super::D3DMATRIX) -> windows_core::Result<()>;
    fn SetMatrixElement(&self, row: i32, column: i32, animation: windows_core::Ref<IDCompositionAnimation>) -> windows_core::Result<()>;
    fn SetMatrixElement2(&self, row: i32, column: i32, value: f32) -> windows_core::Result<()>;
}
#[cfg(feature = "d3d9")]
impl IDCompositionMatrixTransform3D_Vtbl {
    pub const fn new<Identity: IDCompositionMatrixTransform3D_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetMatrix<Identity: IDCompositionMatrixTransform3D_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, matrix: *const super::D3DMATRIX) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionRectangleClip {
    pub unsafe fn SetLeft<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetLeft)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetLeft2(&self, left: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetLeft2)(windows_core::Interface::as_raw(self), left) }
    }
    pub unsafe fn SetTop<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetTop)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetTop2(&self, top: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetTop2)(windows_core::Interface::as_raw(self), top) }
    }
    pub unsafe fn SetRight<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetRight)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetRight2(&self, right: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetRight2)(windows_core::Interface::as_raw(self), right) }
    }
    pub unsafe fn SetBottom<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetBottom)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetBottom2(&self, bottom: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetBottom2)(windows_core::Interface::as_raw(self), bottom) }
    }
    pub unsafe fn SetTopLeftRadiusX<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetTopLeftRadiusX)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetTopLeftRadiusX2(&self, radius: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetTopLeftRadiusX2)(windows_core::Interface::as_raw(self), radius) }
    }
    pub unsafe fn SetTopLeftRadiusY<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetTopLeftRadiusY)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetTopLeftRadiusY2(&self, radius: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetTopLeftRadiusY2)(windows_core::Interface::as_raw(self), radius) }
    }
    pub unsafe fn SetTopRightRadiusX<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetTopRightRadiusX)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetTopRightRadiusX2(&self, radius: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetTopRightRadiusX2)(windows_core::Interface::as_raw(self), radius) }
    }
    pub unsafe fn SetTopRightRadiusY<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetTopRightRadiusY)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetTopRightRadiusY2(&self, radius: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetTopRightRadiusY2)(windows_core::Interface::as_raw(self), radius) }
    }
    pub unsafe fn SetBottomLeftRadiusX<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetBottomLeftRadiusX)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetBottomLeftRadiusX2(&self, radius: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetBottomLeftRadiusX2)(windows_core::Interface::as_raw(self), radius) }
    }
    pub unsafe fn SetBottomLeftRadiusY<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetBottomLeftRadiusY)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetBottomLeftRadiusY2(&self, radius: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetBottomLeftRadiusY2)(windows_core::Interface::as_raw(self), radius) }
    }
    pub unsafe fn SetBottomRightRadiusX<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetBottomRightRadiusX)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetBottomRightRadiusX2(&self, radius: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetBottomRightRadiusX2)(windows_core::Interface::as_raw(self), radius) }
    }
    pub unsafe fn SetBottomRightRadiusY<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetBottomRightRadiusY)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetBottomRightRadiusY2(&self, radius: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetBottomRightRadiusY2)(windows_core::Interface::as_raw(self), radius) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IDCompositionRotateTransform {
    ...
    pub unsafe fn SetAngle2(&self, angle: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetAngle2)(windows_core::Interface::as_raw(self), angle) }
    }
    pub unsafe fn SetCenterX<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetCenterX)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetCenterX2(&self, centerx: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetCenterX2)(windows_core::Interface::as_raw(self), centerx) }
    }
    pub unsafe fn SetCenterY<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetCenterY)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetCenterY2(&self, centery: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetCenterY2)(windows_core::Interface::as_raw(self), centery) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IDCompositionRotateTransform3D {
    ...
    pub unsafe fn SetAxisX<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetAxisX)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetAxisX2(&self, axisx: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetAxisX2)(windows_core::Interface::as_raw(self), axisx) }
    }
    pub unsafe fn SetAxisY<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetAxisY)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetAxisY2(&self, axisy: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetAxisY2)(windows_core::Interface::as_raw(self), axisy) }
    }
    pub unsafe fn SetAxisZ<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetAxisZ)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetAxisZ2(&self, axisz: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetAxisZ2)(windows_core::Interface::as_raw(self), axisz) }
    }
    pub unsafe fn SetCenterX<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    ...
    pub unsafe fn SetCenterZ<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetCenterZ)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetCenterZ2(&self, centerz: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetCenterZ2)(windows_core::Interface::as_raw(self), centerz) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IDCompositionSaturationEffect {
    pub unsafe fn SetSaturation<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetSaturation)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetSaturation2(&self, ratio: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetSaturation2)(windows_core::Interface::as_raw(self), ratio) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IDCompositionScaleTransform {
    pub unsafe fn SetScaleX<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetScaleX)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetScaleX2(&self, scalex: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetScaleX2)(windows_core::Interface::as_raw(self), scalex) }
    }
    pub unsafe fn SetScaleY<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetScaleY)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetScaleY2(&self, scaley: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetScaleY2)(windows_core::Interface::as_raw(self), scaley) }
    }
    pub unsafe fn SetCenterX<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
...
impl IDCompositionScaleTransform3D {
    ...
    pub unsafe fn SetScaleZ<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetScaleZ)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetScaleZ2(&self, scalez: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetScaleZ2)(windows_core::Interface::as_raw(self), scalez) }
    }
    pub unsafe fn SetCenterX<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
...
impl IDCompositionShadowEffect {
    ...
    #[cfg(all(feature = "d2d", feature = "dcommon", feature = "minwindef"))]
    pub unsafe fn SetColor(&self, color: *const super::D2D1_VECTOR_4F) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetColor)(windows_core::Interface::as_raw(self), color) }
    }
    pub unsafe fn SetRed<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetRed)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetRed2(&self, amount: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetRed2)(windows_core::Interface::as_raw(self), amount) }
    }
    pub unsafe fn SetGreen<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetGreen)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetGreen2(&self, amount: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetGreen2)(windows_core::Interface::as_raw(self), amount) }
    }
    pub unsafe fn SetBlue<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetBlue)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetBlue2(&self, amount: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetBlue2)(windows_core::Interface::as_raw(self), amount) }
    }
    pub unsafe fn SetAlpha<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetAlpha)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetAlpha2(&self, amount: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetAlpha2)(windows_core::Interface::as_raw(self), amount) }
    }
}
#[repr(C)]
#[doc(hidden)]
pub struct IDCompositionShadowEffect_Vtbl {
    ...
    pub SetStandardDeviation2: unsafe extern "system" fn(*mut core::ffi::c_void, f32) -> windows_core::HRESULT,
    #[cfg(all(feature = "d2d", feature = "dcommon", feature = "minwindef"))]
    pub SetColor: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::D2D1_VECTOR_4F) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "d2d", feature = "dcommon", feature = "minwindef")))]
    SetColor: usize,
...
pub trait IDCompositionShadowEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetStandardDeviation(&self, animation: windows_core::Ref<IDCompositionAnimation>) -> windows_core::Result<()>;
    fn SetStandardDeviation2(&self, amount: f32) -> windows_core::Result<()>;
    fn SetColor(&self, color: *const super::D2D1_VECTOR_4F) -> windows_core::Result<()>;
...
impl IDCompositionShadowEffect_Vtbl {
    pub const fn new<Identity: IDCompositionShadowEffect_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn SetColor<Identity: IDCompositionShadowEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, color: *const super::D2D1_VECTOR_4F) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionSkewTransform {
    pub unsafe fn SetAngleX<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetAngleX)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetAngleX2(&self, anglex: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetAngleX2)(windows_core::Interface::as_raw(self), anglex) }
    }
    pub unsafe fn SetAngleY<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetAngleY)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetAngleY2(&self, angley: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetAngleY2)(windows_core::Interface::as_raw(self), angley) }
    }
    pub unsafe fn SetCenterX<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
...
impl IDCompositionSurface {
    ...
    #[cfg(feature = "windef")]
    pub unsafe fn Scroll(&self, scrollrect: Option<*const super::RECT>, cliprect: Option<*const super::RECT>, offsetx: i32, offsety: i32) -> windows_core::HRESULT {
...
pub struct IDCompositionSurface_Vtbl {
    ...
    #[cfg(feature = "windef")]
    pub Scroll: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::RECT, *const super::RECT, i32, i32) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    Scroll: usize,
}
#[cfg(feature = "windef")]
pub trait IDCompositionSurface_Impl: windows_core::IUnknownImpl {
    fn BeginDraw(&self, updaterect: *const super::RECT, iid: *const windows_core::GUID, updateobject: *mut *mut core::ffi::c_void, updateoffset: *mut super::POINT) -> windows_core::Result<()>;
    fn EndDraw(&self) -> windows_core::Result<()>;
    fn SuspendDraw(&self) -> windows_core::Result<()>;
    fn ResumeDraw(&self) -> windows_core::Result<()>;
    fn Scroll(&self, scrollrect: *const super::RECT, cliprect: *const super::RECT, offsetx: i32, offsety: i32) -> windows_core::Result<()>;
}
#[cfg(feature = "windef")]
impl IDCompositionSurface_Vtbl {
    pub const fn new<Identity: IDCompositionSurface_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn BeginDraw<Identity: IDCompositionSurface_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, updaterect: *const super::RECT, iid: *const windows_core::GUID, updateobject: *mut *mut core::ffi::c_void, updateoffset: *mut super::POINT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Scroll<Identity: IDCompositionSurface_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, scrollrect: *const super::RECT, cliprect: *const super::RECT, offsetx: i32, offsety: i32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionSurfaceFactory_Vtbl {
    pub const fn new<Identity: IDCompositionSurfaceFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateSurface<Identity: IDCompositionSurfaceFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, width: u32, height: u32, pixelformat: super::DXGI_FORMAT, alphamode: super::DXGI_ALPHA_MODE, surface: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateVirtualSurface<Identity: IDCompositionSurfaceFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, initialwidth: u32, initialheight: u32, pixelformat: super::DXGI_FORMAT, alphamode: super::DXGI_ALPHA_MODE, virtualsurface: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionTableTransferEffect {
    ...
    pub unsafe fn SetRedTableValue<P1>(&self, index: u32, animation: P1) -> windows_core::HRESULT
    where
        P1: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetRedTableValue)(windows_core::Interface::as_raw(self), index, animation.param().abi()) }
    }
    pub unsafe fn SetRedTableValue2(&self, index: u32, value: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetRedTableValue2)(windows_core::Interface::as_raw(self), index, value) }
    }
    pub unsafe fn SetGreenTableValue<P1>(&self, index: u32, animation: P1) -> windows_core::HRESULT
    where
        P1: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetGreenTableValue)(windows_core::Interface::as_raw(self), index, animation.param().abi()) }
    }
    pub unsafe fn SetGreenTableValue2(&self, index: u32, value: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetGreenTableValue2)(windows_core::Interface::as_raw(self), index, value) }
    }
    pub unsafe fn SetBlueTableValue<P1>(&self, index: u32, animation: P1) -> windows_core::HRESULT
    where
        P1: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetBlueTableValue)(windows_core::Interface::as_raw(self), index, animation.param().abi()) }
    }
    pub unsafe fn SetBlueTableValue2(&self, index: u32, value: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetBlueTableValue2)(windows_core::Interface::as_raw(self), index, value) }
    }
    pub unsafe fn SetAlphaTableValue<P1>(&self, index: u32, animation: P1) -> windows_core::HRESULT
    where
        P1: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetAlphaTableValue)(windows_core::Interface::as_raw(self), index, animation.param().abi()) }
    }
    pub unsafe fn SetAlphaTableValue2(&self, index: u32, value: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetAlphaTableValue2)(windows_core::Interface::as_raw(self), index, value) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IDCompositionTexture {
    #[cfg(feature = "dcommon")]
    pub unsafe fn SetSourceRect(&self, sourcerect: *const super::D2D_RECT_U) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetSourceRect)(windows_core::Interface::as_raw(self), sourcerect) }
    }
    #[cfg(feature = "dxgi")]
    pub unsafe fn SetColorSpace(&self, colorspace: super::DXGI_COLOR_SPACE_TYPE) -> windows_core::HRESULT {
...
pub struct IDCompositionTexture_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "dcommon")]
    pub SetSourceRect: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::D2D_RECT_U) -> windows_core::HRESULT,
    #[cfg(not(feature = "dcommon"))]
    SetSourceRect: usize,
    #[cfg(feature = "dxgi")]
    pub SetColorSpace: unsafe extern "system" fn(*mut core::ffi::c_void, super::DXGI_COLOR_SPACE_TYPE) -> windows_core::HRESULT,
    #[cfg(not(feature = "dxgi"))]
    SetColorSpace: usize,
    #[cfg(feature = "dxgi")]
    pub SetAlphaMode: unsafe extern "system" fn(*mut core::ffi::c_void, super::DXGI_ALPHA_MODE) -> windows_core::HRESULT,
    #[cfg(not(feature = "dxgi"))]
    SetAlphaMode: usize,
...
pub trait IDCompositionTexture_Impl: windows_core::IUnknownImpl {
    fn SetSourceRect(&self, sourcerect: *const super::D2D_RECT_U) -> windows_core::Result<()>;
    fn SetColorSpace(&self, colorspace: super::DXGI_COLOR_SPACE_TYPE) -> windows_core::Result<()>;
    fn SetAlphaMode(&self, alphamode: super::DXGI_ALPHA_MODE) -> windows_core::Result<()>;
...
impl IDCompositionTexture_Vtbl {
    pub const fn new<Identity: IDCompositionTexture_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetSourceRect<Identity: IDCompositionTexture_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, sourcerect: *const super::D2D_RECT_U) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDCompositionTexture_Impl::SetSourceRect(this, core::mem::transmute_copy(&sourcerect)).into()
            }
        }
        unsafe extern "system" fn SetColorSpace<Identity: IDCompositionTexture_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, colorspace: super::DXGI_COLOR_SPACE_TYPE) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDCompositionTexture_Impl::SetColorSpace(this, core::mem::transmute_copy(&colorspace)).into()
            }
        }
        unsafe extern "system" fn SetAlphaMode<Identity: IDCompositionTexture_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, alphamode: super::DXGI_ALPHA_MODE) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionTranslateTransform {
    pub unsafe fn SetOffsetX<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetOffsetX)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetOffsetX2(&self, offsetx: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetOffsetX2)(windows_core::Interface::as_raw(self), offsetx) }
    }
    pub unsafe fn SetOffsetY<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetOffsetY)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetOffsetY2(&self, offsety: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetOffsetY2)(windows_core::Interface::as_raw(self), offsety) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IDCompositionTranslateTransform3D {
    ...
    pub unsafe fn SetOffsetZ<P0>(&self, animation: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetOffsetZ)(windows_core::Interface::as_raw(self), animation.param().abi()) }
    }
    pub unsafe fn SetOffsetZ2(&self, offsetz: f32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetOffsetZ2)(windows_core::Interface::as_raw(self), offsetz) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IDCompositionTurbulenceEffect {
    #[cfg(all(feature = "d2d", feature = "dcommon", feature = "minwindef"))]
    pub unsafe fn SetOffset(&self, offset: *const super::D2D1_VECTOR_2F) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetOffset)(windows_core::Interface::as_raw(self), offset) }
    }
    #[cfg(all(feature = "d2d", feature = "dcommon", feature = "minwindef"))]
    pub unsafe fn SetBaseFrequency(&self, frequency: *const super::D2D1_VECTOR_2F) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetBaseFrequency)(windows_core::Interface::as_raw(self), frequency) }
    }
    #[cfg(all(feature = "d2d", feature = "dcommon", feature = "minwindef"))]
    pub unsafe fn SetSize(&self, size: *const super::D2D1_VECTOR_2F) -> windows_core::HRESULT {
    ...
    #[cfg(feature = "d2d")]
    pub unsafe fn SetNoise(&self, noise: super::D2D1_TURBULENCE_NOISE) -> windows_core::HRESULT {
...
pub struct IDCompositionTurbulenceEffect_Vtbl {
    pub base__: IDCompositionFilterEffect_Vtbl,
    #[cfg(all(feature = "d2d", feature = "dcommon", feature = "minwindef"))]
    pub SetOffset: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::D2D1_VECTOR_2F) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "d2d", feature = "dcommon", feature = "minwindef")))]
    SetOffset: usize,
    #[cfg(all(feature = "d2d", feature = "dcommon", feature = "minwindef"))]
    pub SetBaseFrequency: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::D2D1_VECTOR_2F) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "d2d", feature = "dcommon", feature = "minwindef")))]
    SetBaseFrequency: usize,
    #[cfg(all(feature = "d2d", feature = "dcommon", feature = "minwindef"))]
    pub SetSize: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::D2D1_VECTOR_2F) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "d2d", feature = "dcommon", feature = "minwindef")))]
    SetSize: usize,
    ...
    #[cfg(feature = "d2d")]
    pub SetNoise: unsafe extern "system" fn(*mut core::ffi::c_void, super::D2D1_TURBULENCE_NOISE) -> windows_core::HRESULT,
    #[cfg(not(feature = "d2d"))]
    SetNoise: usize,
...
pub trait IDCompositionTurbulenceEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetOffset(&self, offset: *const super::D2D1_VECTOR_2F) -> windows_core::Result<()>;
    fn SetBaseFrequency(&self, frequency: *const super::D2D1_VECTOR_2F) -> windows_core::Result<()>;
    fn SetSize(&self, size: *const super::D2D1_VECTOR_2F) -> windows_core::Result<()>;
    fn SetNumOctaves(&self, numoctaves: u32) -> windows_core::Result<()>;
    fn SetSeed(&self, seed: u32) -> windows_core::Result<()>;
    fn SetNoise(&self, noise: super::D2D1_TURBULENCE_NOISE) -> windows_core::Result<()>;
...
impl IDCompositionTurbulenceEffect_Vtbl {
    pub const fn new<Identity: IDCompositionTurbulenceEffect_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetOffset<Identity: IDCompositionTurbulenceEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, offset: *const super::D2D1_VECTOR_2F) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDCompositionTurbulenceEffect_Impl::SetOffset(this, core::mem::transmute_copy(&offset)).into()
            }
        }
        unsafe extern "system" fn SetBaseFrequency<Identity: IDCompositionTurbulenceEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, frequency: *const super::D2D1_VECTOR_2F) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDCompositionTurbulenceEffect_Impl::SetBaseFrequency(this, core::mem::transmute_copy(&frequency)).into()
            }
        }
        unsafe extern "system" fn SetSize<Identity: IDCompositionTurbulenceEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, size: *const super::D2D1_VECTOR_2F) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetNoise<Identity: IDCompositionTurbulenceEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, noise: super::D2D1_TURBULENCE_NOISE) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionVirtualSurface {
    ...
    #[cfg(feature = "windef")]
    pub unsafe fn Trim(&self, rectangles: Option<&[super::RECT]>) -> windows_core::HRESULT {
...
pub struct IDCompositionVirtualSurface_Vtbl {
    ...
    #[cfg(feature = "windef")]
    pub Trim: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::RECT, u32) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    Trim: usize,
}
#[cfg(feature = "windef")]
pub trait IDCompositionVirtualSurface_Impl: IDCompositionSurface_Impl {
    ...
    fn Trim(&self, rectangles: *const super::RECT, count: u32) -> windows_core::Result<()>;
}
#[cfg(feature = "windef")]
impl IDCompositionVirtualSurface_Vtbl {
    pub const fn new<Identity: IDCompositionVirtualSurface_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Trim<Identity: IDCompositionVirtualSurface_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, rectangles: *const super::RECT, count: u32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionVisual {
    ...
    pub unsafe fn SetTransform<P0>(&self, transform: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionTransform>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetTransform)(windows_core::Interface::as_raw(self), transform.param().abi()) }
    }
    #[cfg(all(feature = "dcommon", feature = "minwindef"))]
    pub unsafe fn SetTransform2(&self, matrix: *const super::D2D_MATRIX_3X2_F) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetTransform2)(windows_core::Interface::as_raw(self), matrix) }
    }
    ...
    pub unsafe fn SetClip<P0>(&self, clip: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IDCompositionClip>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetClip)(windows_core::Interface::as_raw(self), clip.param().abi()) }
    }
    #[cfg(all(feature = "dcommon", feature = "minwindef"))]
    pub unsafe fn SetClip2(&self, rect: *const super::D2D_RECT_F) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetClip2)(windows_core::Interface::as_raw(self), rect) }
    }
...
pub struct IDCompositionVisual_Vtbl {
    ...
    #[cfg(all(feature = "dcommon", feature = "minwindef"))]
    pub SetTransform2: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::D2D_MATRIX_3X2_F) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "dcommon", feature = "minwindef")))]
    SetTransform2: usize,
    ...
    #[cfg(all(feature = "dcommon", feature = "minwindef"))]
    pub SetClip2: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::D2D_RECT_F) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "dcommon", feature = "minwindef")))]
    SetClip2: usize,
...
pub trait IDCompositionVisual_Impl: windows_core::IUnknownImpl {
    ...
    fn SetTransform2(&self, matrix: *const super::D2D_MATRIX_3X2_F) -> windows_core::Result<()>;
    ...
    fn SetClip2(&self, rect: *const super::D2D_RECT_F) -> windows_core::Result<()>;
...
impl IDCompositionVisual_Vtbl {
    pub const fn new<Identity: IDCompositionVisual_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn SetTransform2<Identity: IDCompositionVisual_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, matrix: *const super::D2D_MATRIX_3X2_F) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetClip2<Identity: IDCompositionVisual_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, rect: *const super::D2D_RECT_F) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDCompositionVisual3 {
    ...
    #[cfg(all(feature = "dcommon", feature = "minwindef"))]
    pub unsafe fn SetTransform2(&self, matrix: *const super::D2D_MATRIX_4X4_F) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetTransform2)(windows_core::Interface::as_raw(self), matrix) }
    }
...
pub struct IDCompositionVisual3_Vtbl {
    ...
    pub SetTransform: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(all(feature = "dcommon", feature = "minwindef"))]
    pub SetTransform2: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::D2D_MATRIX_4X4_F) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "dcommon", feature = "minwindef")))]
    SetTransform2: usize,
...
pub trait IDCompositionVisual3_Impl: IDCompositionVisualDebug_Impl {
    ...
    fn SetTransform2(&self, matrix: *const super::D2D_MATRIX_4X4_F) -> windows_core::Result<()>;
...
impl IDCompositionVisual3_Vtbl {
    pub const fn new<Identity: IDCompositionVisual3_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn SetTransform2<Identity: IDCompositionVisual3_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, matrix: *const super::D2D_MATRIX_4X4_F) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
