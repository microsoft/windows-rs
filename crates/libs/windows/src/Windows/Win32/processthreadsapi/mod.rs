...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetCurrentProcess() -> super::HANDLE {
    windows_core::link!("kernel32.dll" "system" fn GetCurrentProcess() -> super::HANDLE);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetCurrentThread() -> super::HANDLE {
    windows_core::link!("kernel32.dll" "system" fn GetCurrentThread() -> super::HANDLE);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetPriorityClass(hprocess: super::HANDLE) -> u32 {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetProcessId(process: super::HANDLE) -> u32 {
    windows_core::link!("kernel32.dll" "system" fn GetProcessId(process : super::HANDLE) -> u32);
    unsafe { GetProcessId(process) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetProcessIdOfThread(thread: super::HANDLE) -> u32 {
    windows_core::link!("kernel32.dll" "system" fn GetProcessIdOfThread(thread : super::HANDLE) -> u32);
    unsafe { GetProcessIdOfThread(thread) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetProcessInformation(hprocess: super::HANDLE, processinformationclass: PROCESS_INFORMATION_CLASS, processinformation: *mut core::ffi::c_void, processinformationsize: u32) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn GetProcessInformation(hprocess : super::HANDLE, processinformationclass : PROCESS_INFORMATION_CLASS, processinformation : *mut core::ffi::c_void, processinformationsize : u32) -> windows_core::BOOL);
    unsafe { GetProcessInformation(hprocess, processinformationclass, processinformation as _, processinformationsize) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetProcessMitigationPolicy(hprocess: super::HANDLE, mitigationpolicy: super::PROCESS_MITIGATION_POLICY, lpbuffer: *mut core::ffi::c_void, dwlength: usize) -> windows_core::BOOL {
...
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
#[inline]
pub unsafe fn GetThreadContext(hthread: super::HANDLE, lpcontext: super::LPCONTEXT) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn GetThreadContext(hthread : super::HANDLE, lpcontext : super::LPCONTEXT) -> windows_core::BOOL);
    unsafe { GetThreadContext(hthread, lpcontext as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetThreadDescription(hthread: super::HANDLE) -> windows_core::Result<windows_core::PWSTR> {
    windows_core::link!("kernel32.dll" "system" fn GetThreadDescription(hthread : super::HANDLE, ppszthreaddescription : *mut windows_core::PWSTR) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetThreadId(thread: super::HANDLE) -> u32 {
    windows_core::link!("kernel32.dll" "system" fn GetThreadId(thread : super::HANDLE) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetThreadInformation(hthread: super::HANDLE, threadinformationclass: THREAD_INFORMATION_CLASS, threadinformation: *mut core::ffi::c_void, threadinformationsize: u32) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn GetThreadInformation(hthread : super::HANDLE, threadinformationclass : THREAD_INFORMATION_CLASS, threadinformation : *mut core::ffi::c_void, threadinformationsize : u32) -> windows_core::BOOL);
    unsafe { GetThreadInformation(hthread, threadinformationclass, threadinformation as _, threadinformationsize) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetThreadPriority(hthread: super::HANDLE) -> i32 {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn OpenProcess(dwdesiredaccess: u32, binherithandle: bool, dwprocessid: u32) -> super::HANDLE {
    windows_core::link!("kernel32.dll" "system" fn OpenProcess(dwdesiredaccess : u32, binherithandle : windows_core::BOOL, dwprocessid : u32) -> super::HANDLE);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn OpenThread(dwdesiredaccess: u32, binherithandle: bool, dwthreadid: u32) -> super::HANDLE {
    windows_core::link!("kernel32.dll" "system" fn OpenThread(dwdesiredaccess : u32, binherithandle : windows_core::BOOL, dwthreadid : u32) -> super::HANDLE);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn QueueUserAPC(pfnapc: super::PAPCFUNC, hthread: super::HANDLE, dwdata: usize) -> u32 {
    windows_core::link!("kernel32.dll" "system" fn QueueUserAPC(pfnapc : super::PAPCFUNC, hthread : super::HANDLE, dwdata : usize) -> u32);
    unsafe { QueueUserAPC(pfnapc, hthread, dwdata) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn QueueUserAPC2(apcroutine: super::PAPCFUNC, thread: super::HANDLE, data: usize, flags: QUEUE_USER_APC_FLAGS) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn QueueUserAPC2(apcroutine : super::PAPCFUNC, thread : super::HANDLE, data : usize, flags : QUEUE_USER_APC_FLAGS) -> windows_core::BOOL);
    unsafe { QueueUserAPC2(apcroutine, thread, data, flags) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ResumeThread(hthread: super::HANDLE) -> u32 {
    windows_core::link!("kernel32.dll" "system" fn ResumeThread(hthread : super::HANDLE) -> u32);
    unsafe { ResumeThread(hthread) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetPriorityClass(hprocess: super::HANDLE, dwpriorityclass: u32) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SetPriorityClass(hprocess : super::HANDLE, dwpriorityclass : u32) -> windows_core::BOOL);
    unsafe { SetPriorityClass(hprocess, dwpriorityclass) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetProcessAffinityUpdateMode(hprocess: super::HANDLE, dwflags: u32) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SetProcessAffinityUpdateMode(hprocess : super::HANDLE, dwflags : u32) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetProcessDefaultCpuSets(process: super::HANDLE, cpusetids: Option<&[u32]>) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SetProcessDefaultCpuSets(process : super::HANDLE, cpusetids : *const u32, cpusetidcount : u32) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetProcessInformation(hprocess: super::HANDLE, processinformationclass: PROCESS_INFORMATION_CLASS, processinformation: *const core::ffi::c_void, processinformationsize: u32) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SetProcessInformation(hprocess : super::HANDLE, processinformationclass : PROCESS_INFORMATION_CLASS, processinformation : *const core::ffi::c_void, processinformationsize : u32) -> windows_core::BOOL);
    unsafe { SetProcessInformation(hprocess, processinformationclass, processinformation, processinformationsize) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetProcessMitigationPolicy(mitigationpolicy: super::PROCESS_MITIGATION_POLICY, lpbuffer: *const core::ffi::c_void, dwlength: usize) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SetProcessMitigationPolicy(mitigationpolicy : super::PROCESS_MITIGATION_POLICY, lpbuffer : *const core::ffi::c_void, dwlength : usize) -> windows_core::BOOL);
    unsafe { SetProcessMitigationPolicy(mitigationpolicy, lpbuffer, dwlength) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetProcessPriorityBoost(hprocess: super::HANDLE, bdisablepriorityboost: bool) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SetProcessPriorityBoost(hprocess : super::HANDLE, bdisablepriorityboost : windows_core::BOOL) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetThreadContext(hthread: super::HANDLE, lpcontext: *const super::CONTEXT) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SetThreadContext(hthread : super::HANDLE, lpcontext : *const super::CONTEXT) -> windows_core::BOOL);
    unsafe { SetThreadContext(hthread, lpcontext) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetThreadDescription<P1>(hthread: super::HANDLE, lpthreaddescription: P1) -> windows_core::HRESULT
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("kernel32.dll" "system" fn SetThreadDescription(hthread : super::HANDLE, lpthreaddescription : windows_core::PCWSTR) -> windows_core::HRESULT);
    unsafe { SetThreadDescription(hthread, lpthreaddescription.param().abi()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetThreadIdealProcessor(hthread: super::HANDLE, dwidealprocessor: u32) -> u32 {
    windows_core::link!("kernel32.dll" "system" fn SetThreadIdealProcessor(hthread : super::HANDLE, dwidealprocessor : u32) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetThreadInformation(hthread: super::HANDLE, threadinformationclass: THREAD_INFORMATION_CLASS, threadinformation: *const core::ffi::c_void, threadinformationsize: u32) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SetThreadInformation(hthread : super::HANDLE, threadinformationclass : THREAD_INFORMATION_CLASS, threadinformation : *const core::ffi::c_void, threadinformationsize : u32) -> windows_core::BOOL);
    unsafe { SetThreadInformation(hthread, threadinformationclass, threadinformation, threadinformationsize) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetThreadPriority(hthread: super::HANDLE, npriority: i32) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SetThreadPriority(hthread : super::HANDLE, npriority : i32) -> windows_core::BOOL);
    unsafe { SetThreadPriority(hthread, npriority) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetThreadPriorityBoost(hthread: super::HANDLE, bdisablepriorityboost: bool) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SetThreadPriorityBoost(hthread : super::HANDLE, bdisablepriorityboost : windows_core::BOOL) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetThreadSelectedCpuSets(thread: super::HANDLE, cpusetids: &[u32]) -> windows_core::BOOL {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SuspendThread(hthread: super::HANDLE) -> u32 {
    windows_core::link!("kernel32.dll" "system" fn SuspendThread(hthread : super::HANDLE) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn TerminateProcess(hprocess: super::HANDLE, uexitcode: u32) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn TerminateProcess(hprocess : super::HANDLE, uexitcode : u32) -> windows_core::BOOL);
    unsafe { TerminateProcess(hprocess, uexitcode) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn TerminateThread(hthread: super::HANDLE, dwexitcode: u32) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn TerminateThread(hthread : super::HANDLE, dwexitcode : u32) -> windows_core::BOOL);
