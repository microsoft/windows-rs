...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn CreateTraceInstanceId(reghandle: super::HANDLE, instinfo: *mut EVENT_INSTANCE_INFO) -> u32 {
    windows_core::link!("advapi32.dll" "system" fn CreateTraceInstanceId(reghandle : super::HANDLE, instinfo : *mut EVENT_INSTANCE_INFO) -> u32);
...
#[inline]
pub unsafe fn EnableTraceEx(providerid: *const windows_core::GUID, sourceid: Option<*const windows_core::GUID>, traceid: CONTROLTRACE_ID, isenabled: u32, level: u8, matchanykeyword: u64, matchallkeyword: u64, enableproperty: u32, enablefilterdesc: Option<*const super::EVENT_FILTER_DESCRIPTOR>) -> u32 {
    windows_core::link!("advapi32.dll" "system" fn EnableTraceEx(providerid : *const windows_core::GUID, sourceid : *const windows_core::GUID, traceid : CONTROLTRACE_ID, isenabled : u32, level : u8, matchanykeyword : u64, matchallkeyword : u64, enableproperty : u32, enablefilterdesc : *const super::EVENT_FILTER_DESCRIPTOR) -> u32);
...
#[inline]
pub unsafe fn ProcessTrace(handlearray: &[PROCESSTRACE_HANDLE], starttime: Option<*const super::FILETIME>, endtime: Option<*const super::FILETIME>) -> u32 {
    windows_core::link!("advapi32.dll" "system" fn ProcessTrace(handlearray : *const PROCESSTRACE_HANDLE, handlecount : u32, starttime : *const super::FILETIME, endtime : *const super::FILETIME) -> u32);
...
#[cfg(feature = "vadefs")]
#[inline]
pub unsafe fn TraceMessageVa(loggerhandle: TRACELOGGER_HANDLE, messageflags: u32, messageguid: *const windows_core::GUID, messagenumber: u16, messagearglist: super::va_list) -> u32 {
    windows_core::link!("advapi32.dll" "C" fn TraceMessageVa(loggerhandle : TRACELOGGER_HANDLE, messageflags : u32, messageguid : *const windows_core::GUID, messagenumber : u16, messagearglist : super::va_list) -> u32);
    unsafe { TraceMessageVa(loggerhandle, messageflags, messageguid, messagenumber, messagearglist) }
}
#[inline]
