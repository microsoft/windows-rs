...
impl IMLangCodePages {
    ...
    pub unsafe fn GetStrCodePages(&self, pszsrc: *const u16, cchsrc: i32, dwprioritycodepages: u32, pdwcodepages: Option<*mut u32>, pcchcodepages: Option<*mut i32>) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetStrCodePages)(windows_core::Interface::as_raw(self), pszsrc, cchsrc, dwprioritycodepages, pdwcodepages.unwrap_or(core::mem::zeroed()) as _, pcchcodepages.unwrap_or(core::mem::zeroed()) as _) }
    }
...
impl IMLangFontLink {
    #[cfg(feature = "windef")]
    pub unsafe fn GetFontCodePages(&self, hdc: super::HDC, hfont: super::HFONT, pdwcodepages: Option<*mut u32>) -> windows_core::HRESULT {
    ...
    #[cfg(feature = "windef")]
    pub unsafe fn MapFont(&self, hdc: super::HDC, dwcodepages: u32, hsrcfont: super::HFONT, phdestfont: Option<*mut super::HFONT>) -> windows_core::HRESULT {
    ...
    #[cfg(feature = "windef")]
    pub unsafe fn ReleaseFont(&self, hfont: super::HFONT) -> windows_core::HRESULT {
...
pub struct IMLangFontLink_Vtbl {
    ...
    #[cfg(feature = "windef")]
    pub GetFontCodePages: unsafe extern "system" fn(*mut core::ffi::c_void, super::HDC, super::HFONT, *mut u32) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    GetFontCodePages: usize,
    #[cfg(feature = "windef")]
    pub MapFont: unsafe extern "system" fn(*mut core::ffi::c_void, super::HDC, u32, super::HFONT, *mut super::HFONT) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    MapFont: usize,
    #[cfg(feature = "windef")]
    pub ReleaseFont: unsafe extern "system" fn(*mut core::ffi::c_void, super::HFONT) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    ReleaseFont: usize,
...
pub trait IMLangFontLink_Impl: IMLangCodePages_Impl {
    fn GetFontCodePages(&self, hdc: super::HDC, hfont: super::HFONT, pdwcodepages: *mut u32) -> windows_core::Result<()>;
    fn MapFont(&self, hdc: super::HDC, dwcodepages: u32, hsrcfont: super::HFONT, phdestfont: *mut super::HFONT) -> windows_core::Result<()>;
...
impl IMLangFontLink_Vtbl {
    pub const fn new<Identity: IMLangFontLink_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetFontCodePages<Identity: IMLangFontLink_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hdc: super::HDC, hfont: super::HFONT, pdwcodepages: *mut u32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn MapFont<Identity: IMLangFontLink_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hdc: super::HDC, dwcodepages: u32, hsrcfont: super::HFONT, phdestfont: *mut super::HFONT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ReleaseFont<Identity: IMLangFontLink_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hfont: super::HFONT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IMLangFontLink2 {
    ...
    #[cfg(feature = "windef")]
    pub unsafe fn MapFont(&self, hdc: super::HDC, dwcodepages: u32, chsrc: u16, pfont: Option<*mut super::HFONT>) -> windows_core::HRESULT {
...
pub struct IMLangFontLink2_Vtbl {
    ...
    pub ResetFontMapping: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(feature = "windef")]
    pub MapFont: unsafe extern "system" fn(*mut core::ffi::c_void, super::HDC, u32, u16, *mut super::HFONT) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    MapFont: usize,
    #[cfg(feature = "windef")]
...
impl IMLangFontLink2_Vtbl {
    pub const fn new<Identity: IMLangFontLink2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetFontCodePages<Identity: IMLangFontLink2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hdc: super::HDC, hfont: super::HFONT, pdwcodepages: *mut u32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ReleaseFont<Identity: IMLangFontLink2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hfont: super::HFONT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn MapFont<Identity: IMLangFontLink2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hdc: super::HDC, dwcodepages: u32, chsrc: u16, pfont: *mut super::HFONT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IMLangLineBreakConsole {
    ...
    #[cfg(feature = "winnt")]
    pub unsafe fn BreakLineW(&self, locale: super::LCID, pszsrc: *const u16, cchsrc: i32, cmaxcolumns: i32, pcchline: Option<*mut i32>, pcchskip: Option<*mut i32>) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).BreakLineW)(windows_core::Interface::as_raw(self), locale, pszsrc, cchsrc, cmaxcolumns, pcchline.unwrap_or(core::mem::zeroed()) as _, pcchskip.unwrap_or(core::mem::zeroed()) as _) }
    }
    #[cfg(feature = "winnt")]
    pub unsafe fn BreakLineA(&self, locale: super::LCID, ucodepage: u32, pszsrc: *const i8, cchsrc: i32, cmaxcolumns: i32, pcchline: Option<*mut i32>, pcchskip: Option<*mut i32>) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).BreakLineA)(windows_core::Interface::as_raw(self), locale, ucodepage, pszsrc, cchsrc, cmaxcolumns, pcchline.unwrap_or(core::mem::zeroed()) as _, pcchskip.unwrap_or(core::mem::zeroed()) as _) }
    }
}
#[repr(C)]
#[doc(hidden)]
pub struct IMLangLineBreakConsole_Vtbl {
    ...
    #[cfg(feature = "winnt")]
    pub BreakLineW: unsafe extern "system" fn(*mut core::ffi::c_void, super::LCID, *const u16, i32, i32, *mut i32, *mut i32) -> windows_core::HRESULT,
    #[cfg(not(feature = "winnt"))]
    BreakLineW: usize,
    #[cfg(feature = "winnt")]
    pub BreakLineA: unsafe extern "system" fn(*mut core::ffi::c_void, super::LCID, u32, *const i8, i32, i32, *mut i32, *mut i32) -> windows_core::HRESULT,
    #[cfg(not(feature = "winnt"))]
    BreakLineA: usize,
}
#[cfg(feature = "winnt")]
pub trait IMLangLineBreakConsole_Impl: windows_core::IUnknownImpl {
    ...
    fn BreakLineW(&self, locale: super::LCID, pszsrc: *const u16, cchsrc: i32, cmaxcolumns: i32, pcchline: *mut i32, pcchskip: *mut i32) -> windows_core::Result<()>;
    fn BreakLineA(&self, locale: super::LCID, ucodepage: u32, pszsrc: *const i8, cchsrc: i32, cmaxcolumns: i32, pcchline: *mut i32, pcchskip: *mut i32) -> windows_core::Result<()>;
}
#[cfg(feature = "winnt")]
impl IMLangLineBreakConsole_Vtbl {
    pub const fn new<Identity: IMLangLineBreakConsole_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn BreakLineW<Identity: IMLangLineBreakConsole_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, locale: super::LCID, pszsrc: *const u16, cchsrc: i32, cmaxcolumns: i32, pcchline: *mut i32, pcchskip: *mut i32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn BreakLineA<Identity: IMLangLineBreakConsole_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, locale: super::LCID, ucodepage: u32, pszsrc: *const i8, cchsrc: i32, cmaxcolumns: i32, pcchline: *mut i32, pcchskip: *mut i32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IMLangStringAStr {
    pub unsafe fn SetAStr<P3>(&self, ldestpos: i32, ldestlen: i32, ucodepage: u32, pszsrc: P3, cchsrc: i32, pcchactual: Option<*mut i32>, plactuallen: Option<*mut i32>) -> windows_core::HRESULT
    where
        P3: windows_core::Param<windows_core::PCSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetAStr)(windows_core::Interface::as_raw(self), ldestpos, ldestlen, ucodepage, pszsrc.param().abi(), cchsrc, pcchactual.unwrap_or(core::mem::zeroed()) as _, plactuallen.unwrap_or(core::mem::zeroed()) as _) }
    }
    ...
    pub unsafe fn UnlockAStr<P0>(&self, pszsrc: P0, cchsrc: i32, pcchactual: Option<*mut i32>, plactuallen: Option<*mut i32>) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).UnlockAStr)(windows_core::Interface::as_raw(self), pszsrc.param().abi(), cchsrc, pcchactual.unwrap_or(core::mem::zeroed()) as _, plactuallen.unwrap_or(core::mem::zeroed()) as _) }
    }
    #[cfg(feature = "winnt")]
    pub unsafe fn SetLocale(&self, ldestpos: i32, ldestlen: i32, locale: super::LCID) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetLocale)(windows_core::Interface::as_raw(self), ldestpos, ldestlen, locale) }
    }
    #[cfg(feature = "winnt")]
    pub unsafe fn GetLocale(&self, lsrcpos: i32, lsrcmaxlen: i32, plocale: Option<*mut super::LCID>, pllocalepos: Option<*mut i32>, pllocalelen: Option<*mut i32>) -> windows_core::HRESULT {
...
pub struct IMLangStringAStr_Vtbl {
    ...
    #[cfg(feature = "winnt")]
    pub SetLocale: unsafe extern "system" fn(*mut core::ffi::c_void, i32, i32, super::LCID) -> windows_core::HRESULT,
    #[cfg(not(feature = "winnt"))]
    SetLocale: usize,
    #[cfg(feature = "winnt")]
    pub GetLocale: unsafe extern "system" fn(*mut core::ffi::c_void, i32, i32, *mut super::LCID, *mut i32, *mut i32) -> windows_core::HRESULT,
    #[cfg(not(feature = "winnt"))]
    GetLocale: usize,
}
#[cfg(feature = "winnt")]
pub trait IMLangStringAStr_Impl: IMLangString_Impl {
    ...
    fn SetLocale(&self, ldestpos: i32, ldestlen: i32, locale: super::LCID) -> windows_core::Result<()>;
    fn GetLocale(&self, lsrcpos: i32, lsrcmaxlen: i32, plocale: *mut super::LCID, pllocalepos: *mut i32, pllocalelen: *mut i32) -> windows_core::Result<()>;
}
#[cfg(feature = "winnt")]
impl IMLangStringAStr_Vtbl {
    pub const fn new<Identity: IMLangStringAStr_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn SetLocale<Identity: IMLangStringAStr_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, ldestpos: i32, ldestlen: i32, locale: super::LCID) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetLocale<Identity: IMLangStringAStr_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, lsrcpos: i32, lsrcmaxlen: i32, plocale: *mut super::LCID, pllocalepos: *mut i32, pllocalelen: *mut i32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IMLangStringWStr {
    pub unsafe fn SetWStr<P2>(&self, ldestpos: i32, ldestlen: i32, pszsrc: P2, cchsrc: i32, pcchactual: Option<*mut i32>, plactuallen: Option<*mut i32>) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetWStr)(windows_core::Interface::as_raw(self), ldestpos, ldestlen, pszsrc.param().abi(), cchsrc, pcchactual.unwrap_or(core::mem::zeroed()) as _, plactuallen.unwrap_or(core::mem::zeroed()) as _) }
    }
    ...
    pub unsafe fn GetWStr(&self, lsrcpos: i32, lsrclen: i32, pszdest: Option<windows_core::PWSTR>, cchdest: i32, pcchactual: Option<*mut i32>, plactuallen: Option<*mut i32>) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetWStr)(windows_core::Interface::as_raw(self), lsrcpos, lsrclen, pszdest.unwrap_or(core::mem::zeroed()) as _, cchdest, pcchactual.unwrap_or(core::mem::zeroed()) as _, plactuallen.unwrap_or(core::mem::zeroed()) as _) }
    }
    ...
    pub unsafe fn UnlockWStr<P0>(&self, pszsrc: P0, cchsrc: i32, pcchactual: Option<*mut i32>, plactuallen: Option<*mut i32>) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).UnlockWStr)(windows_core::Interface::as_raw(self), pszsrc.param().abi(), cchsrc, pcchactual.unwrap_or(core::mem::zeroed()) as _, plactuallen.unwrap_or(core::mem::zeroed()) as _) }
    }
    #[cfg(feature = "winnt")]
    pub unsafe fn SetLocale(&self, ldestpos: i32, ldestlen: i32, locale: super::LCID) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetLocale)(windows_core::Interface::as_raw(self), ldestpos, ldestlen, locale) }
...
impl IMLangStringWStr_Vtbl {
    pub const fn new<Identity: IMLangStringWStr_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn SetLocale<Identity: IMLangStringWStr_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, ldestpos: i32, ldestlen: i32, locale: super::LCID) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetLocale<Identity: IMLangStringWStr_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, lsrcpos: i32, lsrcmaxlen: i32, plocale: *mut super::LCID, pllocalepos: *mut i32, pllocalelen: *mut i32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IMultiLanguage {
    ...
    #[cfg(feature = "winnt")]
    pub unsafe fn GetRfc1766FromLcid(&self, locale: super::LCID) -> windows_core::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "winnt")]
    pub unsafe fn GetLcidFromRfc1766(&self, plocale: *mut super::LCID, bstrrfc1766: &windows_core::BSTR) -> windows_core::HRESULT {
...
pub struct IMultiLanguage_Vtbl {
    ...
    #[cfg(feature = "winnt")]
    pub GetRfc1766FromLcid: unsafe extern "system" fn(*mut core::ffi::c_void, super::LCID, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "winnt"))]
    GetRfc1766FromLcid: usize,
    #[cfg(feature = "winnt")]
    pub GetLcidFromRfc1766: unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::LCID, *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "winnt"))]
...
impl IMultiLanguage_Vtbl {
    pub const fn new<Identity: IMultiLanguage_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetRfc1766FromLcid<Identity: IMultiLanguage_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, locale: super::LCID, pbstrrfc1766: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetLcidFromRfc1766<Identity: IMultiLanguage_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, plocale: *mut super::LCID, bstrrfc1766: *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IMultiLanguage2 {
    ...
    #[cfg(feature = "winnt")]
    pub unsafe fn EnumCodePages(&self, grfflags: u32, langid: super::LANGID) -> windows_core::Result<IEnumCodePage> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "winnt")]
    pub unsafe fn EnumRfc1766(&self, langid: super::LANGID) -> windows_core::Result<IEnumRfc1766> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    where
        ...
        P6: windows_core::Param<super::IStream>,
    {
    ...
    #[cfg(feature = "windef")]
    pub unsafe fn ValidateCodePage(&self, uicodepage: u32, hwnd: super::HWND) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).ValidateCodePage)(windows_core::Interface::as_raw(self), uicodepage, hwnd) }
    }
    #[cfg(feature = "winnt")]
    pub unsafe fn GetCodePageDescription(&self, uicodepage: u32, lcid: super::LCID, lpwidecharstr: windows_core::PWSTR, cchwidechar: i32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetCodePageDescription)(windows_core::Interface::as_raw(self), uicodepage, lcid, lpwidecharstr, cchwidechar) }
    }
    ...
    #[cfg(feature = "winnt")]
    pub unsafe fn EnumScripts(&self, dwflags: u32, langid: super::LANGID) -> windows_core::Result<IEnumScript> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "windef")]
    pub unsafe fn ValidateCodePageEx(&self, uicodepage: u32, hwnd: super::HWND, dwfiodcontrol: u32) -> windows_core::HRESULT {
...
pub struct IMultiLanguage2_Vtbl {
    ...
    GetLcidFromRfc1766: usize,
    #[cfg(feature = "winnt")]
    pub EnumRfc1766: unsafe extern "system" fn(*mut core::ffi::c_void, super::LANGID, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "winnt"))]
    EnumRfc1766: usize,
    #[cfg(feature = "winnt")]
    ...
    #[cfg(feature = "windef")]
    pub ValidateCodePage: unsafe extern "system" fn(*mut core::ffi::c_void, u32, super::HWND) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    ValidateCodePage: usize,
    #[cfg(feature = "winnt")]
    pub GetCodePageDescription: unsafe extern "system" fn(*mut core::ffi::c_void, u32, super::LCID, windows_core::PWSTR, i32) -> windows_core::HRESULT,
    #[cfg(not(feature = "winnt"))]
    ...
    #[cfg(feature = "winnt")]
    pub EnumScripts: unsafe extern "system" fn(*mut core::ffi::c_void, u32, super::LANGID, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "winnt"))]
    EnumScripts: usize,
    #[cfg(feature = "windef")]
    pub ValidateCodePageEx: unsafe extern "system" fn(*mut core::ffi::c_void, u32, super::HWND, u32) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
...
pub trait IMultiLanguage2_Impl: windows_core::IUnknownImpl {
    ...
    fn DetectCodepageInIStream(&self, dwflag: u32, dwprefwincodepage: u32, pstmin: windows_core::Ref<super::IStream>, lpencoding: *mut DetectEncodingInfo, pnscores: *mut i32) -> windows_core::Result<()>;
    ...
    fn ValidateCodePage(&self, uicodepage: u32, hwnd: super::HWND) -> windows_core::Result<()>;
    fn GetCodePageDescription(&self, uicodepage: u32, lcid: super::LCID, lpwidecharstr: windows_core::PWSTR, cchwidechar: i32) -> windows_core::Result<()>;
    ...
    fn EnumScripts(&self, dwflags: u32, langid: super::LANGID) -> windows_core::Result<IEnumScript>;
    fn ValidateCodePageEx(&self, uicodepage: u32, hwnd: super::HWND, dwfiodcontrol: u32) -> windows_core::Result<()>;
}
#[cfg(all(feature = "objidlbase", feature = "windef", feature = "winnt"))]
impl IMultiLanguage2_Vtbl {
    pub const fn new<Identity: IMultiLanguage2_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn EnumCodePages<Identity: IMultiLanguage2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, grfflags: u32, langid: super::LANGID, ppenumcodepage: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetRfc1766FromLcid<Identity: IMultiLanguage2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, locale: super::LCID, pbstrrfc1766: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetLcidFromRfc1766<Identity: IMultiLanguage2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, plocale: *mut super::LCID, bstrrfc1766: *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMultiLanguage2_Impl::GetLcidFromRfc1766(this, core::mem::transmute_copy(&plocale), core::mem::transmute(&bstrrfc1766)).into()
            }
        }
        unsafe extern "system" fn EnumRfc1766<Identity: IMultiLanguage2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, langid: super::LANGID, ppenumrfc1766: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ValidateCodePage<Identity: IMultiLanguage2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, uicodepage: u32, hwnd: super::HWND) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IMultiLanguage2_Impl::ValidateCodePage(this, core::mem::transmute_copy(&uicodepage), core::mem::transmute_copy(&hwnd)).into()
            }
        }
        unsafe extern "system" fn GetCodePageDescription<Identity: IMultiLanguage2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, uicodepage: u32, lcid: super::LCID, lpwidecharstr: windows_core::PWSTR, cchwidechar: i32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn EnumScripts<Identity: IMultiLanguage2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, dwflags: u32, langid: super::LANGID, ppenumscript: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ValidateCodePageEx<Identity: IMultiLanguage2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, uicodepage: u32, hwnd: super::HWND, dwfiodcontrol: u32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait IMultiLanguage3_Impl: IMultiLanguage2_Impl {
    ...
    fn DetectOutboundCodePageInIStream(&self, dwflags: u32, pstrin: windows_core::Ref<super::IStream>, puipreferredcodepages: *const u32, npreferredcodepages: u32, puidetectedcodepages: *mut u32, pndetectedcodepages: *mut u32, lpspecialchar: &windows_core::PCWSTR) -> windows_core::Result<()>;
}
#[cfg(all(feature = "objidlbase", feature = "windef", feature = "winnt"))]
