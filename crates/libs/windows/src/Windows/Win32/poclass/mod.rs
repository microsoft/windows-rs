...
pub const ACPI_TIME_ZONE_UNKNOWN: i32 = 2047;
pub const ACTIVE_COOLING: i32 = 0;
...
pub const BATTERY_CAPACITY_RELATIVE: i32 = 1073741824;
...
pub const BATTERY_CHARGING: i32 = 4;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const BATTERY_DISCHARGING: i32 = 2;
#[repr(C)]
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
...
pub const BATTERY_IS_SHORT_TERM: i32 = 536870912;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const BATTERY_POWER_ON_LINE: i32 = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const BATTERY_SEALED: i32 = 268435456;
pub const BATTERY_SET_CHARGER_ID_SUPPORTED: i32 = 8;
pub const BATTERY_SET_CHARGE_SUPPORTED: i32 = 1;
pub const BATTERY_SET_CHARGINGSOURCE_SUPPORTED: i32 = 4;
pub const BATTERY_SET_DISCHARGE_SUPPORTED: i32 = 2;
#[repr(C)]
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
...
pub const BATTERY_TAG_INVALID: i32 = 0;
pub const BATTERY_TEST_EXEMPT: i32 = 16;
...
pub const IOCTL_ACPI_GET_REAL_TIME: i32 = 2703888;
pub const IOCTL_ACPI_SET_REAL_TIME: i32 = 2720276;
pub const IOCTL_BATTERY_CHARGING_SOURCE_CHANGE: i32 = 2703440;
pub const IOCTL_BATTERY_QUERY_INFORMATION: i32 = 2703428;
pub const IOCTL_BATTERY_QUERY_STATUS: i32 = 2703436;
pub const IOCTL_BATTERY_QUERY_TAG: i32 = 2703424;
pub const IOCTL_BATTERY_SET_INFORMATION: i32 = 2719816;
pub const IOCTL_GET_ACPI_TIME_AND_ALARM_CAPABILITIES: i32 = 2703900;
pub const IOCTL_GET_PROCESSOR_OBJ_INFO: i32 = 2703744;
pub const IOCTL_GET_SYS_BUTTON_CAPS: i32 = 2703680;
pub const IOCTL_GET_SYS_BUTTON_EVENT: i32 = 2703684;
pub const IOCTL_GET_WAKE_ALARM_POLICY: i32 = 2736652;
pub const IOCTL_GET_WAKE_ALARM_SYSTEM_POWERSTATE: i32 = 2703896;
pub const IOCTL_GET_WAKE_ALARM_VALUE: i32 = 2736648;
pub const IOCTL_NOTIFY_SWITCH_EVENT: i32 = 2703616;
pub const IOCTL_QUERY_CUSTOMIZED_INPUT_FROM_PLATFORM: i32 = 2704004;
pub const IOCTL_QUERY_CUSTOMIZED_IO_CAPABILITIES: i32 = 2704000;
pub const IOCTL_QUERY_LID: i32 = 2703552;
pub const IOCTL_RUN_ACTIVE_COOLING_METHOD: i32 = 2719880;
pub const IOCTL_SEND_CUSTOMIZED_OUTPUT_TO_PLATFORM: i32 = 2720392;
pub const IOCTL_SET_SYS_MESSAGE_INDICATOR: i32 = 2720192;
pub const IOCTL_SET_WAKE_ALARM_POLICY: i32 = 2720260;
pub const IOCTL_SET_WAKE_ALARM_VALUE: i32 = 2720256;
pub const IOCTL_THERMAL_QUERY_INFORMATION: i32 = 2703488;
pub const IOCTL_THERMAL_READ_POLICY: i32 = 2703508;
pub const IOCTL_THERMAL_READ_TEMPERATURE: i32 = 2703504;
pub const IOCTL_THERMAL_SET_COOLING_POLICY: i32 = 2719876;
pub const IOCTL_THERMAL_SET_PASSIVE_LIMIT: i32 = 2719884;
...
pub const PROCESSOR_NUMBER_PKEY: super::DEVPROPKEY = super::DEVPROPKEY { fmtid: windows_core::GUID::from_u128(0x5724c81d_d5af_4c1f_a103_a06e28f204c6), pid: super::DEVPROPID(1) };
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const SYS_BUTTON_LID: i32 = 4;
pub const SYS_BUTTON_LID_CHANGED: i32 = 524288;
pub const SYS_BUTTON_LID_CLOSED: i32 = 131072;
pub const SYS_BUTTON_LID_INITIAL: i32 = 262144;
pub const SYS_BUTTON_LID_OPEN: i32 = 65536;
pub const SYS_BUTTON_LID_STATE_MASK: i32 = 196608;
pub const SYS_BUTTON_POWER: i32 = 1;
pub const SYS_BUTTON_SLEEP: i32 = 2;
...
pub struct THERMAL_INFORMATION {
    ...
    pub Processors: super::KAFFINITY,
...
pub const THERMAL_WAIT_READ_TIMEOUT_IMMEDIATE: i32 = 0;
pub const THERMAL_WAIT_READ_TIMEOUT_NONE: u32 = 4294967295;
pub const TZ_ACTIVATION_REASON_CURRENT: i32 = 2;
pub const TZ_ACTIVATION_REASON_THERMAL: i32 = 1;
