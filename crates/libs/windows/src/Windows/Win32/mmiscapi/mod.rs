...
#[inline]
pub unsafe fn CloseDriver(hdriver: super::HDRVR, lparam1: super::LPARAM, lparam2: super::LPARAM) -> super::LRESULT {
    windows_core::link!("winmm.dll" "system" fn CloseDriver(hdriver : super::HDRVR, lparam1 : super::LPARAM, lparam2 : super::LPARAM) -> super::LRESULT);
    unsafe { CloseDriver(hdriver, lparam1, lparam2) }
}
#[cfg(all(feature = "minwindef", feature = "mmsyscom"))]
#[inline]
pub unsafe fn DefDriverProc(dwdriveridentifier: usize, hdrvr: super::HDRVR, umsg: u32, lparam1: super::LPARAM, lparam2: super::LPARAM) -> super::LRESULT {
    windows_core::link!("winmm.dll" "system" fn DefDriverProc(dwdriveridentifier : usize, hdrvr : super::HDRVR, umsg : u32, lparam1 : super::LPARAM, lparam2 : super::LPARAM) -> super::LRESULT);
    unsafe { DefDriverProc(dwdriveridentifier, hdrvr, umsg, lparam1, lparam2) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn DriverCallback(dwcallback: usize, dwflags: u32, hdevice: super::HDRVR, dwmsg: u32, dwuser: usize, dwparam1: usize, dwparam2: usize) -> windows_core::BOOL {
    windows_core::link!("winmm.dll" "system" fn DriverCallback(dwcallback : usize, dwflags : u32, hdevice : super::HDRVR, dwmsg : u32, dwuser : usize, dwparam1 : usize, dwparam2 : usize) -> windows_core::BOOL);
    unsafe { DriverCallback(dwcallback, dwflags, hdevice, dwmsg, dwuser, dwparam1, dwparam2) }
}
#[cfg(all(feature = "minwindef", feature = "mmsyscom"))]
#[inline]
pub unsafe fn DrvGetModuleHandle(hdriver: super::HDRVR) -> super::HMODULE {
    windows_core::link!("winmm.dll" "system" fn DrvGetModuleHandle(hdriver : super::HDRVR) -> super::HMODULE);
    unsafe { DrvGetModuleHandle(hdriver) }
}
#[cfg(all(feature = "minwindef", feature = "mmsyscom"))]
#[inline]
pub unsafe fn GetDriverModuleHandle(hdriver: super::HDRVR) -> super::HMODULE {
    windows_core::link!("winmm.dll" "system" fn GetDriverModuleHandle(hdriver : super::HDRVR) -> super::HMODULE);
    unsafe { GetDriverModuleHandle(hdriver) }
}
#[cfg(all(feature = "minwindef", feature = "mmsyscom"))]
#[inline]
pub unsafe fn OpenDriver<P0, P1>(szdrivername: P0, szsectionname: P1, lparam2: super::LPARAM) -> super::HDRVR
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("winmm.dll" "system" fn OpenDriver(szdrivername : windows_core::PCWSTR, szsectionname : windows_core::PCWSTR, lparam2 : super::LPARAM) -> super::HDRVR);
    unsafe { OpenDriver(szdrivername.param().abi(), szsectionname.param().abi(), lparam2) }
}
#[cfg(all(feature = "minwindef", feature = "mmsyscom"))]
#[inline]
pub unsafe fn SendDriverMessage(hdriver: super::HDRVR, message: u32, lparam1: super::LPARAM, lparam2: super::LPARAM) -> super::LRESULT {
    windows_core::link!("winmm.dll" "system" fn SendDriverMessage(hdriver : super::HDRVR, message : u32, lparam1 : super::LPARAM, lparam2 : super::LPARAM) -> super::LRESULT);
    unsafe { SendDriverMessage(hdriver, message, lparam1, lparam2) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn mmDrvInstall<P1>(hdriver: super::HDRVR, wszdrventry: P1, drvmessage: DRIVERMSGPROC, wflags: u32) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("winmm.dll" "system" fn mmDrvInstall(hdriver : super::HDRVR, wszdrventry : windows_core::PCWSTR, drvmessage : DRIVERMSGPROC, wflags : u32) -> u32);
    unsafe { mmDrvInstall(hdriver, wszdrventry.param().abi(), drvmessage, wflags) }
}
#[cfg(all(feature = "minwindef", feature = "mmsyscom"))]
#[inline]
pub unsafe fn mmioAdvance(hmmio: HMMIO, pmmioinfo: Option<LPMMIOINFO>, fuadvance: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mmioAdvance(hmmio : HMMIO, pmmioinfo : LPMMIOINFO, fuadvance : u32) -> super::MMRESULT);
    unsafe { mmioAdvance(hmmio, pmmioinfo.unwrap_or(core::mem::zeroed()) as _, fuadvance) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn mmioAscend(hmmio: HMMIO, pmmcki: LPMMCKINFO, fuascend: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mmioAscend(hmmio : HMMIO, pmmcki : LPMMCKINFO, fuascend : u32) -> super::MMRESULT);
    unsafe { mmioAscend(hmmio, pmmcki, fuascend) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn mmioClose(hmmio: HMMIO, fuclose: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mmioClose(hmmio : HMMIO, fuclose : u32) -> super::MMRESULT);
    unsafe { mmioClose(hmmio, fuclose) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn mmioCreateChunk(hmmio: HMMIO, pmmcki: LPMMCKINFO, fucreate: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mmioCreateChunk(hmmio : HMMIO, pmmcki : LPMMCKINFO, fucreate : u32) -> super::MMRESULT);
    unsafe { mmioCreateChunk(hmmio, pmmcki, fucreate) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn mmioDescend(hmmio: HMMIO, pmmcki: LPMMCKINFO, pmmckiparent: Option<*const MMCKINFO>, fudescend: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mmioDescend(hmmio : HMMIO, pmmcki : LPMMCKINFO, pmmckiparent : *const MMCKINFO, fudescend : u32) -> super::MMRESULT);
    unsafe { mmioDescend(hmmio, pmmcki as _, pmmckiparent.unwrap_or(core::mem::zeroed()) as _, fudescend) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn mmioFlush(hmmio: HMMIO, fuflush: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mmioFlush(hmmio : HMMIO, fuflush : u32) -> super::MMRESULT);
    unsafe { mmioFlush(hmmio, fuflush) }
}
#[cfg(all(feature = "minwindef", feature = "mmsyscom"))]
#[inline]
pub unsafe fn mmioGetInfo(hmmio: HMMIO, pmmioinfo: LPMMIOINFO, fuinfo: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mmioGetInfo(hmmio : HMMIO, pmmioinfo : LPMMIOINFO, fuinfo : u32) -> super::MMRESULT);
...
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn mmioOpenA(pszfilename: Option<&mut [u8; 128]>, pmmioinfo: Option<LPMMIOINFO>, fdwopen: u32) -> HMMIO {
    windows_core::link!("winmm.dll" "system" fn mmioOpenA(pszfilename : windows_core::PSTR, pmmioinfo : LPMMIOINFO, fdwopen : u32) -> HMMIO);
    unsafe { mmioOpenA(core::mem::transmute(pszfilename.as_deref().map_or(core::ptr::null_mut(), |slice| slice.as_ptr().cast_mut())), pmmioinfo.unwrap_or(core::mem::zeroed()) as _, fdwopen) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn mmioOpenW(pszfilename: Option<&mut [u16; 64]>, pmmioinfo: Option<LPMMIOINFO>, fdwopen: u32) -> HMMIO {
    windows_core::link!("winmm.dll" "system" fn mmioOpenW(pszfilename : windows_core::PWSTR, pmmioinfo : LPMMIOINFO, fdwopen : u32) -> HMMIO);
    unsafe { mmioOpenW(core::mem::transmute(pszfilename.as_deref().map_or(core::ptr::null_mut(), |slice| slice.as_ptr().cast_mut())), pmmioinfo.unwrap_or(core::mem::zeroed()) as _, fdwopen) }
}
#[inline]
pub unsafe fn mmioRead(hmmio: HMMIO, pch: HPSTR, cch: i32) -> i32 {
    windows_core::link!("winmm.dll" "system" fn mmioRead(hmmio : HMMIO, pch : HPSTR, cch : i32) -> i32);
    unsafe { mmioRead(hmmio, pch as _, cch) }
}
#[cfg(all(feature = "minwindef", feature = "mmsyscom"))]
#[inline]
pub unsafe fn mmioRenameA<P0, P1>(pszfilename: P0, psznewfilename: P1, pmmioinfo: Option<LPCMMIOINFO>, fdwrename: u32) -> super::MMRESULT
where
    P0: windows_core::Param<windows_core::PCSTR>,
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_core::link!("winmm.dll" "system" fn mmioRenameA(pszfilename : windows_core::PCSTR, psznewfilename : windows_core::PCSTR, pmmioinfo : LPCMMIOINFO, fdwrename : u32) -> super::MMRESULT);
    unsafe { mmioRenameA(pszfilename.param().abi(), psznewfilename.param().abi(), pmmioinfo.unwrap_or(core::mem::zeroed()) as _, fdwrename) }
}
#[cfg(all(feature = "minwindef", feature = "mmsyscom"))]
#[inline]
pub unsafe fn mmioRenameW<P0, P1>(pszfilename: P0, psznewfilename: P1, pmmioinfo: Option<LPCMMIOINFO>, fdwrename: u32) -> super::MMRESULT
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("winmm.dll" "system" fn mmioRenameW(pszfilename : windows_core::PCWSTR, psznewfilename : windows_core::PCWSTR, pmmioinfo : LPCMMIOINFO, fdwrename : u32) -> super::MMRESULT);
...
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn mmioSendMessage(hmmio: HMMIO, umsg: u32, lparam1: Option<super::LPARAM>, lparam2: Option<super::LPARAM>) -> super::LRESULT {
    windows_core::link!("winmm.dll" "system" fn mmioSendMessage(hmmio : HMMIO, umsg : u32, lparam1 : super::LPARAM, lparam2 : super::LPARAM) -> super::LRESULT);
    unsafe { mmioSendMessage(hmmio, umsg, lparam1.unwrap_or(core::mem::zeroed()) as _, lparam2.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn mmioSetBuffer(hmmio: HMMIO, pchbuffer: Option<windows_core::PSTR>, cchbuffer: i32, fubuffer: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mmioSetBuffer(hmmio : HMMIO, pchbuffer : windows_core::PSTR, cchbuffer : i32, fubuffer : u32) -> super::MMRESULT);
    unsafe { mmioSetBuffer(hmmio, pchbuffer.unwrap_or(core::mem::zeroed()) as _, cchbuffer, fubuffer) }
}
#[cfg(all(feature = "minwindef", feature = "mmsyscom"))]
#[inline]
pub unsafe fn mmioSetInfo(hmmio: HMMIO, pmmioinfo: LPCMMIOINFO, fuinfo: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mmioSetInfo(hmmio : HMMIO, pmmioinfo : LPCMMIOINFO, fuinfo : u32) -> super::MMRESULT);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn sndOpenSound<P0, P1>(eventname: P0, appname: P1, flags: i32, filehandle: super::PHANDLE) -> i32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("api-ms-win-mm-misc-l1-1-1.dll" "system" fn sndOpenSound(eventname : windows_core::PCWSTR, appname : windows_core::PCWSTR, flags : i32, filehandle : super::PHANDLE) -> i32);
    unsafe { sndOpenSound(eventname.param().abi(), appname.param().abi(), flags, filehandle) }
}
...
#[cfg(feature = "minwindef")]
pub type LPMMIOPROC = Option<unsafe extern "system" fn(lpmmioinfo: windows_core::PCSTR, umsg: u32, lparam1: super::LPARAM, lparam2: super::LPARAM) -> super::LRESULT>;
#[repr(C, packed(1))]
#[derive(Clone, Copy, Default)]
pub struct MMCKINFO {
    pub ckid: FOURCC,
