...
pub const MENROLL_E_CERTAUTH_FAILED_TO_FIND_CERT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180028u32 as _);
pub const MENROLL_E_CERTPOLICY_PRIVATEKEYCREATION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180027u32 as _);
pub const MENROLL_E_CONNECTIVITY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180010u32 as _);
pub const MENROLL_E_CUSTOMSERVERERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180032u32 as _);
pub const MENROLL_E_DEVICECAPREACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180013u32 as _);
pub const MENROLL_E_DEVICENOTSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180014u32 as _);
pub const MENROLL_E_DEVICE_ALREADY_ENROLLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8018000Au32 as _);
pub const MENROLL_E_DEVICE_AUTHENTICATION_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180002u32 as _);
pub const MENROLL_E_DEVICE_AUTHORIZATION_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180003u32 as _);
pub const MENROLL_E_DEVICE_CERTIFCATEREQUEST_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180004u32 as _);
pub const MENROLL_E_DEVICE_CERTIFICATEREQUEST_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180004u32 as _);
pub const MENROLL_E_DEVICE_CONFIGMGRSERVER_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180005u32 as _);
pub const MENROLL_E_DEVICE_INTERNALSERVICE_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180006u32 as _);
pub const MENROLL_E_DEVICE_INVALIDSECURITY_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180007u32 as _);
pub const MENROLL_E_DEVICE_MANAGEMENT_BLOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180026u32 as _);
pub const MENROLL_E_DEVICE_MESSAGE_FORMAT_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180001u32 as _);
pub const MENROLL_E_DEVICE_NOT_ENROLLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8018000Bu32 as _);
pub const MENROLL_E_DEVICE_UNKNOWN_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180008u32 as _);
pub const MENROLL_E_DISCOVERY_SEC_CERT_DATE_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8018000Du32 as _);
pub const MENROLL_E_EMPTY_MESSAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180029u32 as _);
pub const MENROLL_E_ENROLLMENTDATAINVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180019u32 as _);
pub const MENROLL_E_ENROLLMENT_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180009u32 as _);
pub const MENROLL_E_INMAINTENANCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180017u32 as _);
pub const MENROLL_E_INSECUREREDIRECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8018001Au32 as _);
pub const MENROLL_E_INVALIDSSLCERT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180012u32 as _);
pub const MENROLL_E_MDM_NOT_CONFIGURED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180031u32 as _);
pub const MENROLL_E_NOTELIGIBLETORENEW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180016u32 as _);
pub const MENROLL_E_NOTSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180015u32 as _);
pub const MENROLL_E_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180015u32 as _);
pub const MENROLL_E_PASSWORD_NEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8018000Eu32 as _);
pub const MENROLL_E_PLATFORM_LICENSE_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8018001Cu32 as _);
pub const MENROLL_E_PLATFORM_UNKNOWN_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8018001Du32 as _);
pub const MENROLL_E_PLATFORM_WRONG_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8018001Bu32 as _);
pub const MENROLL_E_PROV_CSP_APPMGMT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180025u32 as _);
pub const MENROLL_E_PROV_CSP_CERTSTORE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8018001Eu32 as _);
pub const MENROLL_E_PROV_CSP_DMCLIENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180020u32 as _);
pub const MENROLL_E_PROV_CSP_MISC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180022u32 as _);
pub const MENROLL_E_PROV_CSP_PFW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180021u32 as _);
pub const MENROLL_E_PROV_CSP_W7: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8018001Fu32 as _);
pub const MENROLL_E_PROV_SSLCERTNOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180024u32 as _);
pub const MENROLL_E_PROV_UNKNOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180023u32 as _);
pub const MENROLL_E_USERLICENSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180018u32 as _);
pub const MENROLL_E_USER_CANCELED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8018002Au32 as _);
pub const MENROLL_E_USER_CANCELLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180030u32 as _);
pub const MENROLL_E_USER_LICENSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80180018u32 as _);
pub const MENROLL_E_WAB_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8018000Fu32 as _);
pub const MREGISTER_E_DEVICE_ALREADY_REGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8019000Au32 as _);
pub const MREGISTER_E_DEVICE_AUTHENTICATION_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190002u32 as _);
pub const MREGISTER_E_DEVICE_AUTHORIZATION_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190003u32 as _);
pub const MREGISTER_E_DEVICE_CERTIFCATEREQUEST_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190004u32 as _);
pub const MREGISTER_E_DEVICE_CONFIGMGRSERVER_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190005u32 as _);
pub const MREGISTER_E_DEVICE_INTERNALSERVICE_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190006u32 as _);
pub const MREGISTER_E_DEVICE_INVALIDSECURITY_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190007u32 as _);
pub const MREGISTER_E_DEVICE_MESSAGE_FORMAT_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190001u32 as _);
pub const MREGISTER_E_DEVICE_NOT_AD_REGISTERED_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8019000Du32 as _);
pub const MREGISTER_E_DEVICE_NOT_REGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8019000Bu32 as _);
pub const MREGISTER_E_DEVICE_UNKNOWN_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190008u32 as _);
pub const MREGISTER_E_DISCOVERY_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8019000Eu32 as _);
pub const MREGISTER_E_DISCOVERY_REDIRECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8019000Cu32 as _);
pub const MREGISTER_E_REGISTRATION_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190009u32 as _);
