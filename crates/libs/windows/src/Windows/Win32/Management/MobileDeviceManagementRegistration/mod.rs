...
{
    ::windows::core::windows_link ! ( "mdmlocalmanagement.dll" ,"system" fn ApplyLocalManagementSyncML ( syncmlrequest : :: windows::core::PCWSTR , syncmlresult : *mut :: windows::core::PWSTR ) -> :: windows::core::HRESULT );
...
where
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ::windows::core::windows_link ! ( "mdmregistration.dll" ,"system" fn DiscoverManagementService ( pszupn : :: windows::core::PCWSTR , ppmgmtinfo : *mut *mut MANAGEMENT_SERVICE_INFO ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
{
    ::windows::core::windows_link ! ( "mdmregistration.dll" ,"system" fn DiscoverManagementServiceEx ( pszupn : :: windows::core::PCWSTR , pszdiscoveryservicecandidate : :: windows::core::PCWSTR , ppmgmtinfo : *mut *mut MANAGEMENT_SERVICE_INFO ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
where
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ::windows::core::windows_link ! ( "mdmregistration.dll" ,"system" fn GetDeviceManagementConfigInfo ( providerid : :: windows::core::PCWSTR , configstringbufferlength : *mut u32 , configstring : :: windows::core::PWSTR ) -> :: windows::core::HRESULT );
...
pub unsafe fn GetDeviceRegistrationInfo(deviceinformationclass: REGISTRATION_INFORMATION_CLASS, ppdeviceregistrationinfo: *mut *mut ::core::ffi::c_void) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "mdmregistration.dll" ,"system" fn GetDeviceRegistrationInfo ( deviceinformationclass : REGISTRATION_INFORMATION_CLASS , ppdeviceregistrationinfo : *mut *mut ::core::ffi::c_void ) -> :: windows::core::HRESULT );
...
pub unsafe fn GetManagementAppHyperlink(pszhyperlink: &mut [u16]) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "mdmregistration.dll" ,"system" fn GetManagementAppHyperlink ( cchhyperlink : u32 , pszhyperlink : :: windows::core::PWSTR ) -> :: windows::core::HRESULT );
...
pub unsafe fn IsDeviceRegisteredWithManagement(pfisdeviceregisteredwithmanagement: *mut super::super::Foundation::BOOL, pszupn: ::core::option::Option<&mut [u16]>) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "mdmregistration.dll" ,"system" fn IsDeviceRegisteredWithManagement ( pfisdeviceregisteredwithmanagement : *mut super::super::Foundation:: BOOL , cchupn : u32 , pszupn : :: windows::core::PWSTR ) -> :: windows::core::HRESULT );
...
pub unsafe fn IsManagementRegistrationAllowed() -> ::windows::core::Result<super::super::Foundation::BOOL> {
    ::windows::core::windows_link ! ( "mdmregistration.dll" ,"system" fn IsManagementRegistrationAllowed ( pfismanagementregistrationallowed : *mut super::super::Foundation:: BOOL ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
pub unsafe fn IsMdmUxWithoutAadAllowed() -> ::windows::core::Result<super::super::Foundation::BOOL> {
    ::windows::core::windows_link ! ( "mdmregistration.dll" ,"system" fn IsMdmUxWithoutAadAllowed ( isenrollmentallowed : *mut super::super::Foundation:: BOOL ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
pub unsafe fn RegisterDeviceWithLocalManagement() -> ::windows::core::Result<super::super::Foundation::BOOL> {
    ::windows::core::windows_link ! ( "mdmlocalmanagement.dll" ,"system" fn RegisterDeviceWithLocalManagement ( alreadyregistered : *mut super::super::Foundation:: BOOL ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
{
    ::windows::core::windows_link ! ( "mdmregistration.dll" ,"system" fn RegisterDeviceWithManagement ( pszupn : :: windows::core::PCWSTR , ppszmdmserviceuri : :: windows::core::PCWSTR , ppzsaccesstoken : :: windows::core::PCWSTR ) -> :: windows::core::HRESULT );
...
{
    ::windows::core::windows_link ! ( "mdmregistration.dll" ,"system" fn RegisterDeviceWithManagementUsingAADCredentials ( usertoken : super::super::Foundation:: HANDLE ) -> :: windows::core::HRESULT );
...
pub unsafe fn RegisterDeviceWithManagementUsingAADDeviceCredentials() -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "mdmregistration.dll" ,"system" fn RegisterDeviceWithManagementUsingAADDeviceCredentials ( ) -> :: windows::core::HRESULT );
...
where
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ::windows::core::windows_link ! ( "mdmregistration.dll" ,"system" fn RegisterDeviceWithManagementUsingAADDeviceCredentials2 ( mdmapplicationid : :: windows::core::PCWSTR ) -> :: windows::core::HRESULT );
...
where
    ...
    P1: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ::windows::core::windows_link ! ( "mdmregistration.dll" ,"system" fn SetDeviceManagementConfigInfo ( providerid : :: windows::core::PCWSTR , configstring : :: windows::core::PCWSTR ) -> :: windows::core::HRESULT );
...
{
    ::windows::core::windows_link ! ( "mdmregistration.dll" ,"system" fn SetManagedExternally ( ismanagedexternally : super::super::Foundation:: BOOL ) -> :: windows::core::HRESULT );
    SetManagedExternally(ismanagedexternally.into()).ok()
}
#[doc = "*Required features: `\"Win32_Management_MobileDeviceManagementRegistration\"`*"]
#[inline]
pub unsafe fn UnregisterDeviceWithLocalManagement() -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "mdmlocalmanagement.dll" ,"system" fn UnregisterDeviceWithLocalManagement ( ) -> :: windows::core::HRESULT );
...
where
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ::windows::core::windows_link ! ( "mdmregistration.dll" ,"system" fn UnregisterDeviceWithManagement ( enrollmentid : :: windows::core::PCWSTR ) -> :: windows::core::HRESULT );
