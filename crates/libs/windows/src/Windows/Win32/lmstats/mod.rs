...
#[inline]
pub unsafe fn NetStatisticsGet(servername: super::LPTSTR, service: super::LPTSTR, level: u32, options: u32, buffer: *mut super::LPBYTE) -> u32 {
    windows_core::link!("netapi32.dll" "system" fn NetStatisticsGet(servername : super::LPTSTR, service : super::LPTSTR, level : u32, options : u32, buffer : *mut super::LPBYTE) -> u32);
