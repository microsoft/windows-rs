...
pub const FILTER_E_ACCESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041703u32 as _);
pub const FILTER_E_EMBEDDING_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041707u32 as _);
pub const FILTER_E_END_OF_CHUNKS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041700u32 as _);
pub const FILTER_E_LINK_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041708u32 as _);
pub const FILTER_E_NO_MORE_TEXT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041701u32 as _);
pub const FILTER_E_NO_MORE_VALUES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041702u32 as _);
pub const FILTER_E_NO_TEXT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041705u32 as _);
pub const FILTER_E_NO_VALUES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041706u32 as _);
pub const FILTER_E_PASSWORD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004170Bu32 as _);
pub const FILTER_E_UNKNOWNFORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004170Cu32 as _);
pub const FILTER_S_LAST_TEXT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41709u32 as _);
pub const FILTER_S_LAST_VALUES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4170Au32 as _);
pub const FILTER_W_MONIKER_CLIPPED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41704u32 as _);
...
pub const NOT_AN_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80000u32 as _);
