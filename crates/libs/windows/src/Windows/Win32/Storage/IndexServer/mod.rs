...
pub const FILTER_E_ACCESS: windows_core::HRESULT = 0x80041703_u32 as _;
pub const FILTER_E_EMBEDDING_UNAVAILABLE: windows_core::HRESULT = 0x80041707_u32 as _;
pub const FILTER_E_END_OF_CHUNKS: windows_core::HRESULT = 0x80041700_u32 as _;
pub const FILTER_E_LINK_UNAVAILABLE: windows_core::HRESULT = 0x80041708_u32 as _;
pub const FILTER_E_NO_MORE_TEXT: windows_core::HRESULT = 0x80041701_u32 as _;
pub const FILTER_E_NO_MORE_VALUES: windows_core::HRESULT = 0x80041702_u32 as _;
pub const FILTER_E_NO_TEXT: windows_core::HRESULT = 0x80041705_u32 as _;
pub const FILTER_E_NO_VALUES: windows_core::HRESULT = 0x80041706_u32 as _;
pub const FILTER_E_PASSWORD: windows_core::HRESULT = 0x8004170B_u32 as _;
pub const FILTER_E_UNKNOWNFORMAT: windows_core::HRESULT = 0x8004170C_u32 as _;
pub const FILTER_S_LAST_TEXT: windows_core::HRESULT = 0x41709_u32 as _;
pub const FILTER_S_LAST_VALUES: windows_core::HRESULT = 0x4170A_u32 as _;
pub const FILTER_W_MONIKER_CLIPPED: windows_core::HRESULT = 0x41704_u32 as _;
...
pub const NOT_AN_ERROR: windows_core::HRESULT = 0x80000_u32 as _;
