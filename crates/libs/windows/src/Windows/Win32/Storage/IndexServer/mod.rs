...
pub const CHUNK_EOC: CHUNK_BREAKTYPE = CHUNK_BREAKTYPE(4);
pub const CHUNK_EOP: CHUNK_BREAKTYPE = CHUNK_BREAKTYPE(3);
pub const CHUNK_EOS: CHUNK_BREAKTYPE = CHUNK_BREAKTYPE(2);
pub const CHUNK_EOW: CHUNK_BREAKTYPE = CHUNK_BREAKTYPE(1);
pub const CHUNK_FILTER_OWNED_VALUE: CHUNKSTATE = CHUNKSTATE(4);
pub const CHUNK_IMAGE: CHUNKSTATE = CHUNKSTATE(8);
pub const CHUNK_NO_BREAK: CHUNK_BREAKTYPE = CHUNK_BREAKTYPE(0);
pub const CHUNK_TEXT: CHUNKSTATE = CHUNKSTATE(1);
pub const CHUNK_VALUE: CHUNKSTATE = CHUNKSTATE(2);
...
pub const DBKIND_GUID: DBKINDENUM = DBKINDENUM(6);
pub const DBKIND_GUID_NAME: DBKINDENUM = DBKINDENUM(0);
pub const DBKIND_GUID_PROPID: DBKINDENUM = DBKINDENUM(1);
pub const DBKIND_NAME: DBKINDENUM = DBKINDENUM(2);
pub const DBKIND_PGUID_NAME: DBKINDENUM = DBKINDENUM(3);
pub const DBKIND_PGUID_PROPID: DBKINDENUM = DBKINDENUM(4);
pub const DBKIND_PROPID: DBKINDENUM = DBKINDENUM(5);
...
pub const FILTER_PIXELFORMAT_BGR8: IMAGE_PIXELFORMAT = IMAGE_PIXELFORMAT(2);
pub const FILTER_PIXELFORMAT_BGRA8: IMAGE_PIXELFORMAT = IMAGE_PIXELFORMAT(0);
pub const FILTER_PIXELFORMAT_PBGRA8: IMAGE_PIXELFORMAT = IMAGE_PIXELFORMAT(1);
...
pub const GENERATE_METHOD_EXACT: u32 = 0;
pub const GENERATE_METHOD_INFLECT: u32 = 2;
pub const GENERATE_METHOD_PREFIX: u32 = 1;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct IFILTER_FLAGS(pub i32);
pub const IFILTER_FLAGS_OLE_PROPERTIES: IFILTER_FLAGS = IFILTER_FLAGS(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct IFILTER_INIT(pub i32);
pub const IFILTER_INIT_APPLY_CRAWL_ATTRIBUTES: IFILTER_INIT = IFILTER_INIT(256);
pub const IFILTER_INIT_APPLY_INDEX_ATTRIBUTES: IFILTER_INIT = IFILTER_INIT(16);
pub const IFILTER_INIT_APPLY_OTHER_ATTRIBUTES: IFILTER_INIT = IFILTER_INIT(32);
pub const IFILTER_INIT_CANON_HYPHENS: IFILTER_INIT = IFILTER_INIT(4);
pub const IFILTER_INIT_CANON_PARAGRAPHS: IFILTER_INIT = IFILTER_INIT(1);
pub const IFILTER_INIT_CANON_SPACES: IFILTER_INIT = IFILTER_INIT(8);
pub const IFILTER_INIT_DISABLE_EMBEDDED: IFILTER_INIT = IFILTER_INIT(2048);
pub const IFILTER_INIT_EMIT_FORMATTING: IFILTER_INIT = IFILTER_INIT(4096);
pub const IFILTER_INIT_FILTER_AGGRESSIVE_BREAK: IFILTER_INIT = IFILTER_INIT(1024);
pub const IFILTER_INIT_FILTER_OWNED_VALUE_OK: IFILTER_INIT = IFILTER_INIT(512);
pub const IFILTER_INIT_HARD_LINE_BREAKS: IFILTER_INIT = IFILTER_INIT(2);
pub const IFILTER_INIT_INDEXING_ONLY: IFILTER_INIT = IFILTER_INIT(64);
pub const IFILTER_INIT_SEARCH_LINKS: IFILTER_INIT = IFILTER_INIT(128);
...
impl IPhraseSink {
    pub unsafe fn PutSmallPhrase<P0, P2>(&self, pwcnoun: P0, cwcnoun: u32, pwcmodifier: P2, cwcmodifier: u32, ulattachmenttype: u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).PutSmallPhrase)(windows_core::Interface::as_raw(self), pwcnoun.param().abi(), cwcnoun, pwcmodifier.param().abi(), cwcmodifier, ulattachmenttype) }
    }
    pub unsafe fn PutPhrase<P0>(&self, pwcphrase: P0, cwcphrase: u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).PutPhrase)(windows_core::Interface::as_raw(self), pwcphrase.param().abi(), cwcphrase) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IPixelFilter {
    ...
    pub unsafe fn GetPixelsForImage(&self, scalingfactor: f32, sourcerect: *const super::super::Foundation::RECT, pixelbuffer: &mut [u8]) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetPixelsForImage)(windows_core::Interface::as_raw(self), scalingfactor, sourcerect, pixelbuffer.len().try_into().unwrap(), core::mem::transmute(pixelbuffer.as_ptr())) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
pub const PROPID_QUERY_ALL: u32 = 6;
pub const PROPID_QUERY_HITCOUNT: u32 = 4;
pub const PROPID_QUERY_LASTSEENTIME: u32 = 10;
pub const PROPID_QUERY_RANK: u32 = 3;
pub const PROPID_QUERY_RANKVECTOR: u32 = 2;
pub const PROPID_QUERY_UNFILTERED: u32 = 7;
pub const PROPID_QUERY_VIRTUALPATH: u32 = 9;
pub const PROPID_QUERY_WORKID: u32 = 5;
pub const PROPID_STG_CONTENTS: u32 = 19;
pub const PROXIMITY_UNIT_CHAPTER: u32 = 3;
pub const PROXIMITY_UNIT_PARAGRAPH: u32 = 2;
pub const PROXIMITY_UNIT_SENTENCE: u32 = 1;
pub const PROXIMITY_UNIT_WORD: u32 = 0;
...
pub const SCOPE_FLAG_DEEP: u32 = 2;
pub const SCOPE_FLAG_INCLUDE: u32 = 1;
pub const SCOPE_FLAG_MASK: u32 = 255;
pub const SCOPE_TYPE_MASK: u32 = 4294967040;
pub const SCOPE_TYPE_VPATH: u32 = 512;
pub const SCOPE_TYPE_WINPATH: u32 = 256;
...
pub const VECTOR_RANK_DICE: u32 = 3;
pub const VECTOR_RANK_INNER: u32 = 2;
pub const VECTOR_RANK_JACCARD: u32 = 4;
pub const VECTOR_RANK_MAX: u32 = 1;
pub const VECTOR_RANK_MIN: u32 = 0;
pub const WORDREP_BREAK_EOC: WORDREP_BREAK_TYPE = WORDREP_BREAK_TYPE(3);
pub const WORDREP_BREAK_EOP: WORDREP_BREAK_TYPE = WORDREP_BREAK_TYPE(2);
pub const WORDREP_BREAK_EOS: WORDREP_BREAK_TYPE = WORDREP_BREAK_TYPE(1);
pub const WORDREP_BREAK_EOW: WORDREP_BREAK_TYPE = WORDREP_BREAK_TYPE(0);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
