#[inline]
pub unsafe fn FCIAddFile(hfci: *const core::ffi::c_void, pszsourcefile: windows_core::PCSTR, pszfilename: windows_core::PCSTR, fexecute: bool, pfnfcignc: PFNFCIGETNEXTCABINET, pfnfcis: PFNFCISTATUS, pfnfcigoi: PFNFCIGETOPENINFO, typecompress: u16) -> windows_core::BOOL {
    ...
    unsafe { FCIAddFile(hfci, core::mem::transmute(pszsourcefile), core::mem::transmute(pszfilename), fexecute.into(), pfnfcignc, pfnfcis, pfnfcigoi, typecompress) }
}
#[inline]
...
#[inline]
pub unsafe fn FDICopy(hfdi: *const core::ffi::c_void, pszcabinet: windows_core::PCSTR, pszcabpath: windows_core::PCSTR, flags: i32, pfnfdin: PFNFDINOTIFY, pfnfdid: PFNFDIDECRYPT, pvuser: Option<*const core::ffi::c_void>) -> windows_core::BOOL {
    ...
    unsafe { FDICopy(hfdi, core::mem::transmute(pszcabinet), core::mem::transmute(pszcabpath), flags, pfnfdin, pfnfdid, pvuser.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn FDITruncateCabinet(hfdi: *const core::ffi::c_void, pszcabinetname: windows_core::PCSTR, ifoldertodelete: u16) -> windows_core::BOOL {
    ...
    unsafe { FDITruncateCabinet(hfdi, core::mem::transmute(pszcabinetname), ifoldertodelete) }
}
...
pub type PFNFCIDELETE = Option<unsafe extern "C" fn(pszfile: windows_core::PCSTR, err: *mut i32, pv: *mut core::ffi::c_void) -> i32>;
pub type PFNFCIFILEPLACED = Option<unsafe extern "C" fn(pccab: *mut CCAB, pszfile: windows_core::PCSTR, cbfile: i32, fcontinuation: windows_core::BOOL, pv: *mut core::ffi::c_void) -> i32>;
pub type PFNFCIFREE = Option<unsafe extern "C" fn(memory: *mut core::ffi::c_void)>;
pub type PFNFCIGETNEXTCABINET = Option<unsafe extern "C" fn(pccab: *mut CCAB, cbprevcab: u32, pv: *mut core::ffi::c_void) -> windows_core::BOOL>;
pub type PFNFCIGETOPENINFO = Option<unsafe extern "C" fn(pszname: windows_core::PCSTR, pdate: *mut u16, ptime: *mut u16, pattribs: *mut u16, err: *mut i32, pv: *mut core::ffi::c_void) -> isize>;
pub type PFNFCIGETTEMPFILE = Option<unsafe extern "C" fn(psztempname: windows_core::PSTR, cbtempname: i32, pv: *mut core::ffi::c_void) -> windows_core::BOOL>;
pub type PFNFCIOPEN = Option<unsafe extern "C" fn(pszfile: windows_core::PCSTR, oflag: i32, pmode: i32, err: *mut i32, pv: *mut core::ffi::c_void) -> isize>;
...
pub type PFNOPEN = Option<unsafe extern "C" fn(pszfile: windows_core::PCSTR, oflag: i32, pmode: i32) -> isize>;
