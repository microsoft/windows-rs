...
pub unsafe fn FCIDestroy(hfci: *const ::core::ffi::c_void) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "cabinet.dll" ,"cdecl" fn FCIDestroy ( hfci : *const ::core::ffi::c_void ) -> super::super::Foundation:: BOOL );
...
{
    ::windows::core::windows_link ! ( "cabinet.dll" ,"cdecl" fn FCIFlushCabinet ( hfci : *const ::core::ffi::c_void , fgetnextcab : super::super::Foundation:: BOOL , pfnfcignc : * mut::core::ffi::c_void , pfnfcis : * mut::core::ffi::c_void ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn FCIFlushFolder(hfci: *const ::core::ffi::c_void, pfnfcignc: PFNFCIGETNEXTCABINET, pfnfcis: PFNFCISTATUS) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "cabinet.dll" ,"cdecl" fn FCIFlushFolder ( hfci : *const ::core::ffi::c_void , pfnfcignc : * mut::core::ffi::c_void , pfnfcis : * mut::core::ffi::c_void ) -> super::super::Foundation:: BOOL );
...
where
    ...
    P1: ::std::convert::Into<::windows::core::PCSTR>,
{
    ::windows::core::windows_link ! ( "cabinet.dll" ,"cdecl" fn FDICopy ( hfdi : *const ::core::ffi::c_void , pszcabinet : :: windows::core::PCSTR , pszcabpath : :: windows::core::PCSTR , flags : i32 , pfnfdin : * mut::core::ffi::c_void , pfnfdid : * mut::core::ffi::c_void , pvuser : *const ::core::ffi::c_void ) -> super::super::Foundation:: BOOL );
    FDICopy(::core::mem::transmute(hfdi), pszcabinet.into(), pszcabpath.into(), flags, ::core::mem::transmute(pfnfdin), ::core::mem::transmute(pfnfdid), ::core::mem::transmute(pvuser.unwrap_or(::std::ptr::null())))
}
#[doc = "*Required features: `\"Win32_Storage_Cabinets\"`, `\"Win32_Foundation\"`*"]
#[cfg(feature = "Win32_Foundation")]
#[inline]
...
pub unsafe fn FDIDestroy(hfdi: *const ::core::ffi::c_void) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "cabinet.dll" ,"cdecl" fn FDIDestroy ( hfdi : *const ::core::ffi::c_void ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn FDIIsCabinet(hfdi: *const ::core::ffi::c_void, hf: isize, pfdici: ::core::option::Option<*mut FDICABINETINFO>) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "cabinet.dll" ,"cdecl" fn FDIIsCabinet ( hfdi : *const ::core::ffi::c_void , hf : isize , pfdici : *mut FDICABINETINFO ) -> super::super::Foundation:: BOOL );
    FDIIsCabinet(::core::mem::transmute(hfdi), hf, ::core::mem::transmute(pfdici.unwrap_or(::std::ptr::null_mut())))
}
#[doc = "*Required features: `\"Win32_Storage_Cabinets\"`, `\"Win32_Foundation\"`*"]
#[cfg(feature = "Win32_Foundation")]
#[inline]
...
where
    P0: ::std::convert::Into<::windows::core::PCSTR>,
{
    ::windows::core::windows_link ! ( "cabinet.dll" ,"cdecl" fn FDITruncateCabinet ( hfdi : *const ::core::ffi::c_void , pszcabinetname : :: windows::core::PCSTR , ifoldertodelete : u16 ) -> super::super::Foundation:: BOOL );
