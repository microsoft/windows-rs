...
impl IDiskQuotaControlVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IDiskQuotaControlImpl, const OFFSET: isize>() -> IDiskQuotaControlVtbl {
...
impl IDiskQuotaEventsVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IDiskQuotaEventsImpl, const OFFSET: isize>() -> IDiskQuotaEventsVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IDiskQuotaEvents>, ::windows::core::GetTrustLevel, OnUserNameChanged::<Impl, OFFSET>)
    }
}
...
impl IDiskQuotaUserVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IDiskQuotaUserImpl, const OFFSET: isize>() -> IDiskQuotaUserVtbl {
...
impl IDiskQuotaUserBatchVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IDiskQuotaUserBatchImpl, const OFFSET: isize>() -> IDiskQuotaUserBatchVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IDiskQuotaUserBatch>, ::windows::core::GetTrustLevel, Add::<Impl, OFFSET>, Remove::<Impl, OFFSET>, RemoveAll::<Impl, OFFSET>, FlushToDisk::<Impl, OFFSET>)
    }
}
...
impl IEnumDiskQuotaUsersVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IEnumDiskQuotaUsersImpl, const OFFSET: isize>() -> IEnumDiskQuotaUsersVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IEnumDiskQuotaUsers>, ::windows::core::GetTrustLevel, Next::<Impl, OFFSET>, Skip::<Impl, OFFSET>, Reset::<Impl, OFFSET>, Clone::<Impl, OFFSET>)
    }
}
