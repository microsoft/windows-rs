...
impl IDedupBackupSupportVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IDedupBackupSupportImpl, const OFFSET: isize>() -> IDedupBackupSupportVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IDedupBackupSupport>, ::windows::core::GetTrustLevel, RestoreFiles::<Impl, OFFSET>)
    }
}
...
impl IDedupChunkLibraryVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IDedupChunkLibraryImpl, const OFFSET: isize>() -> IDedupChunkLibraryVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IDedupChunkLibrary>, ::windows::core::GetTrustLevel, InitializeForPushBuffers::<Impl, OFFSET>, Uninitialize::<Impl, OFFSET>, SetParameter::<Impl, OFFSET>, StartChunking::<Impl, OFFSET>)
    }
}
...
impl IDedupDataPortVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IDedupDataPortImpl, const OFFSET: isize>() -> IDedupDataPortVtbl {
...
impl IDedupDataPortManagerVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IDedupDataPortManagerImpl, const OFFSET: isize>() -> IDedupDataPortManagerVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IDedupDataPortManager>, ::windows::core::GetTrustLevel, GetConfiguration::<Impl, OFFSET>, GetVolumeStatus::<Impl, OFFSET>, GetVolumeDataPort::<Impl, OFFSET>)
    }
}
...
impl IDedupIterateChunksHash32Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IDedupIterateChunksHash32Impl, const OFFSET: isize>() -> IDedupIterateChunksHash32Vtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IDedupIterateChunksHash32>, ::windows::core::GetTrustLevel, PushBuffer::<Impl, OFFSET>, Next::<Impl, OFFSET>, Drain::<Impl, OFFSET>, Reset::<Impl, OFFSET>)
    }
}
...
impl IDedupReadFileCallbackVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IDedupReadFileCallbackImpl, const OFFSET: isize>() -> IDedupReadFileCallbackVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IDedupReadFileCallback>, ::windows::core::GetTrustLevel, ReadBackupFile::<Impl, OFFSET>, OrderContainersRestore::<Impl, OFFSET>, PreviewContainerRead::<Impl, OFFSET>)
    }
}
