...
impl IDedupChunkLibrary {
    ...
    pub unsafe fn SetParameter<P1>(&self, dwparamtype: u32, vparamvalue: P1) -> windows_core::Result<()>
    where
...
impl IDedupDataPortManager {
    ...
    pub unsafe fn GetVolumeStatus<P1>(&self, options: u32, path: P1) -> windows_core::Result<DedupDataPortVolumeStatus>
    where
    ...
    pub unsafe fn GetVolumeDataPort<P1>(&self, options: u32, path: P1) -> windows_core::Result<IDedupDataPort>
    where
        P1: windows_core::Param<windows_core::BSTR>,
    {
        let mut result__ = core::mem::zeroed();
