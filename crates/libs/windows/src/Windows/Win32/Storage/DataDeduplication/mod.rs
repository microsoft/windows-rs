...
windows_core::imp::define_interface!(IDedupBackupSupport, IDedupBackupSupport_Vtbl, 0x909e949d_2b57_5f60_b260_f4a58a5a3ec0);
windows_core::imp::interface_hierarchy!(IDedupBackupSupport, windows_core::IUnknown);
impl IDedupBackupSupport {
    pub unsafe fn RestoreFiles<P2>(&self, numberoffiles: u32, filefullpaths: *mut windows_core::BSTR, store: P2, flags: u32, fileresults: *mut windows_core::HRESULT) -> windows_core::Result<()>
    where
...
pub struct IDedupBackupSupport_Vtbl {
    ...
    pub RestoreFiles: unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut *mut core::ffi::c_void, *mut core::ffi::c_void, u32, *mut windows_core::HRESULT) -> windows_core::HRESULT,
}
pub trait IDedupBackupSupport_Impl: windows_core::IUnknownImpl {
    fn RestoreFiles(&self, numberoffiles: u32, filefullpaths: *mut windows_core::BSTR, store: windows_core::Ref<IDedupReadFileCallback>, flags: u32, fileresults: *mut windows_core::HRESULT) -> windows_core::Result<()>;
}
impl IDedupBackupSupport_Vtbl {
    pub const fn new<Identity: IDedupBackupSupport_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn RestoreFiles<Identity: IDedupBackupSupport_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, numberoffiles: u32, filefullpaths: *mut *mut core::ffi::c_void, store: *mut core::ffi::c_void, flags: u32, fileresults: *mut windows_core::HRESULT) -> windows_core::HRESULT {
            unsafe {
...
windows_core::imp::define_interface!(IDedupDataPort, IDedupDataPort_Vtbl, 0xc9acf763_a4ef_5c66_8b01_a357a121af51);
...
impl IDedupDataPort {
    ...
    pub unsafe fn LookupChunks(&self, phashes: &mut [DedupHash], prequestid: *mut windows_core::GUID) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).LookupChunks)(windows_core::Interface::as_raw(self), phashes.len().try_into().unwrap(), core::mem::transmute(phashes.as_ptr()), prequestid as _).ok() }
    }
    pub unsafe fn InsertChunks(&self, pchunkmetadata: &mut [DedupChunk], pchunkdata: &mut [u8], prequestid: *mut windows_core::GUID) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).InsertChunks)(windows_core::Interface::as_raw(self), pchunkmetadata.len().try_into().unwrap(), core::mem::transmute(pchunkmetadata.as_ptr()), pchunkdata.len().try_into().unwrap(), core::mem::transmute(pchunkdata.as_ptr()), prequestid as _).ok() }
    }
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn InsertChunksWithStream<P3>(&self, pchunkmetadata: &mut [DedupChunk], databytecount: u32, pchunkdatastream: P3, prequestid: *mut windows_core::GUID) -> windows_core::Result<()>
    where
        P3: windows_core::Param<super::super::System::Com::IStream>,
    {
        unsafe { (windows_core::Interface::vtable(self).InsertChunksWithStream)(windows_core::Interface::as_raw(self), pchunkmetadata.len().try_into().unwrap(), core::mem::transmute(pchunkmetadata.as_ptr()), databytecount, pchunkdatastream.param().abi(), prequestid as _).ok() }
    }
    pub unsafe fn CommitStreams(&self, pstreams: &mut [DedupStream], pentries: &mut [DedupStreamEntry], prequestid: *mut windows_core::GUID) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).CommitStreams)(windows_core::Interface::as_raw(self), pstreams.len().try_into().unwrap(), core::mem::transmute(pstreams.as_ptr()), pentries.len().try_into().unwrap(), core::mem::transmute(pentries.as_ptr()), prequestid as _).ok() }
    }
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CommitStreamsWithStream<P3>(&self, pstreams: &mut [DedupStream], entrycount: u32, pentriesstream: P3, prequestid: *mut windows_core::GUID) -> windows_core::Result<()>
    where
        P3: windows_core::Param<super::super::System::Com::IStream>,
    {
        unsafe { (windows_core::Interface::vtable(self).CommitStreamsWithStream)(windows_core::Interface::as_raw(self), pstreams.len().try_into().unwrap(), core::mem::transmute(pstreams.as_ptr()), entrycount, pentriesstream.param().abi(), prequestid as _).ok() }
    }
    pub unsafe fn GetStreams(&self, pstreampaths: &mut [windows_core::BSTR], prequestid: *mut windows_core::GUID) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetStreams)(windows_core::Interface::as_raw(self), pstreampaths.len().try_into().unwrap(), core::mem::transmute(pstreampaths.as_ptr()), prequestid as _).ok() }
    }
    ...
    pub unsafe fn GetChunks(&self, phashes: &mut [DedupHash], prequestid: *mut windows_core::GUID) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetChunks)(windows_core::Interface::as_raw(self), phashes.len().try_into().unwrap(), core::mem::transmute(phashes.as_ptr()), prequestid as _).ok() }
    }
...
pub struct IDedupDataPort_Vtbl {
    ...
    pub LookupChunks: unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut DedupHash, *mut windows_core::GUID) -> windows_core::HRESULT,
    pub InsertChunks: unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut DedupChunk, u32, *mut u8, *mut windows_core::GUID) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Com")]
    pub InsertChunksWithStream: unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut DedupChunk, u32, *mut core::ffi::c_void, *mut windows_core::GUID) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    InsertChunksWithStream: usize,
    pub CommitStreams: unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut DedupStream, u32, *mut DedupStreamEntry, *mut windows_core::GUID) -> windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Com")]
    pub CommitStreamsWithStream: unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut DedupStream, u32, *mut core::ffi::c_void, *mut windows_core::GUID) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    CommitStreamsWithStream: usize,
    pub GetStreams: unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut *mut core::ffi::c_void, *mut windows_core::GUID) -> windows_core::HRESULT,
    ...
    pub GetChunks: unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut DedupHash, *mut windows_core::GUID) -> windows_core::HRESULT,
...
pub trait IDedupDataPort_Impl: windows_core::IUnknownImpl {
    ...
    fn LookupChunks(&self, count: u32, phashes: *mut DedupHash, prequestid: *mut windows_core::GUID) -> windows_core::Result<()>;
    fn InsertChunks(&self, chunkcount: u32, pchunkmetadata: *mut DedupChunk, databytecount: u32, pchunkdata: *mut u8, prequestid: *mut windows_core::GUID) -> windows_core::Result<()>;
    fn InsertChunksWithStream(&self, chunkcount: u32, pchunkmetadata: *mut DedupChunk, databytecount: u32, pchunkdatastream: windows_core::Ref<super::super::System::Com::IStream>, prequestid: *mut windows_core::GUID) -> windows_core::Result<()>;
    fn CommitStreams(&self, streamcount: u32, pstreams: *mut DedupStream, entrycount: u32, pentries: *mut DedupStreamEntry, prequestid: *mut windows_core::GUID) -> windows_core::Result<()>;
    fn CommitStreamsWithStream(&self, streamcount: u32, pstreams: *mut DedupStream, entrycount: u32, pentriesstream: windows_core::Ref<super::super::System::Com::IStream>, prequestid: *mut windows_core::GUID) -> windows_core::Result<()>;
    fn GetStreams(&self, streamcount: u32, pstreampaths: *mut windows_core::BSTR, prequestid: *mut windows_core::GUID) -> windows_core::Result<()>;
    ...
    fn GetChunks(&self, count: u32, phashes: *mut DedupHash, prequestid: *mut windows_core::GUID) -> windows_core::Result<()>;
...
impl IDedupDataPort_Vtbl {
    pub const fn new<Identity: IDedupDataPort_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn LookupChunks<Identity: IDedupDataPort_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, count: u32, phashes: *mut DedupHash, prequestid: *mut windows_core::GUID) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDedupDataPort_Impl::LookupChunks(this, core::mem::transmute_copy(&count), core::mem::transmute_copy(&phashes), core::mem::transmute_copy(&prequestid)).into()
            }
        }
        unsafe extern "system" fn InsertChunks<Identity: IDedupDataPort_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, chunkcount: u32, pchunkmetadata: *mut DedupChunk, databytecount: u32, pchunkdata: *mut u8, prequestid: *mut windows_core::GUID) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDedupDataPort_Impl::InsertChunks(this, core::mem::transmute_copy(&chunkcount), core::mem::transmute_copy(&pchunkmetadata), core::mem::transmute_copy(&databytecount), core::mem::transmute_copy(&pchunkdata), core::mem::transmute_copy(&prequestid)).into()
            }
        }
        unsafe extern "system" fn InsertChunksWithStream<Identity: IDedupDataPort_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, chunkcount: u32, pchunkmetadata: *mut DedupChunk, databytecount: u32, pchunkdatastream: *mut core::ffi::c_void, prequestid: *mut windows_core::GUID) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDedupDataPort_Impl::InsertChunksWithStream(this, core::mem::transmute_copy(&chunkcount), core::mem::transmute_copy(&pchunkmetadata), core::mem::transmute_copy(&databytecount), core::mem::transmute_copy(&pchunkdatastream), core::mem::transmute_copy(&prequestid)).into()
            }
        }
        unsafe extern "system" fn CommitStreams<Identity: IDedupDataPort_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, streamcount: u32, pstreams: *mut DedupStream, entrycount: u32, pentries: *mut DedupStreamEntry, prequestid: *mut windows_core::GUID) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDedupDataPort_Impl::CommitStreams(this, core::mem::transmute_copy(&streamcount), core::mem::transmute_copy(&pstreams), core::mem::transmute_copy(&entrycount), core::mem::transmute_copy(&pentries), core::mem::transmute_copy(&prequestid)).into()
            }
        }
        unsafe extern "system" fn CommitStreamsWithStream<Identity: IDedupDataPort_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, streamcount: u32, pstreams: *mut DedupStream, entrycount: u32, pentriesstream: *mut core::ffi::c_void, prequestid: *mut windows_core::GUID) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDedupDataPort_Impl::CommitStreamsWithStream(this, core::mem::transmute_copy(&streamcount), core::mem::transmute_copy(&pstreams), core::mem::transmute_copy(&entrycount), core::mem::transmute_copy(&pentriesstream), core::mem::transmute_copy(&prequestid)).into()
            }
        }
        unsafe extern "system" fn GetStreams<Identity: IDedupDataPort_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, streamcount: u32, pstreampaths: *mut *mut core::ffi::c_void, prequestid: *mut windows_core::GUID) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDedupDataPort_Impl::GetStreams(this, core::mem::transmute_copy(&streamcount), core::mem::transmute_copy(&pstreampaths), core::mem::transmute_copy(&prequestid)).into()
            }
        }
        ...
        unsafe extern "system" fn GetChunks<Identity: IDedupDataPort_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, count: u32, phashes: *mut DedupHash, prequestid: *mut windows_core::GUID) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDedupDataPort_Impl::GetChunks(this, core::mem::transmute_copy(&count), core::mem::transmute_copy(&phashes), core::mem::transmute_copy(&prequestid)).into()
            }
        }
...
windows_core::imp::define_interface!(IDedupIterateChunksHash32, IDedupIterateChunksHash32_Vtbl, 0x9388cda6_5c4c_5ba7_ba93_2250e48f7b14);
windows_core::imp::interface_hierarchy!(IDedupIterateChunksHash32, windows_core::IUnknown);
impl IDedupIterateChunksHash32 {
    pub unsafe fn PushBuffer(&self, pbuffer: &mut [u8]) -> windows_core::Result<()> {
...
pub struct IDedupIterateChunksHash32_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    pub PushBuffer: unsafe extern "system" fn(*mut core::ffi::c_void, *mut u8, u32) -> windows_core::HRESULT,
...
pub trait IDedupIterateChunksHash32_Impl: windows_core::IUnknownImpl {
    fn PushBuffer(&self, pbuffer: *mut u8, ulbufferlength: u32) -> windows_core::Result<()>;
...
impl IDedupIterateChunksHash32_Vtbl {
    pub const fn new<Identity: IDedupIterateChunksHash32_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn PushBuffer<Identity: IDedupIterateChunksHash32_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pbuffer: *mut u8, ulbufferlength: u32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
