...
impl IDedupBackupSupport {
    pub unsafe fn RestoreFiles<P2>(&self, numberoffiles: u32, filefullpaths: *const windows_core::BSTR, store: P2, flags: u32, fileresults: *mut windows_core::HRESULT) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IDedupBackupSupport_Impl: windows_core::IUnknownImpl {
    fn RestoreFiles(&self, numberoffiles: u32, filefullpaths: *const windows_core::BSTR, store: windows_core::Ref<'_, IDedupReadFileCallback>, flags: u32, fileresults: *mut windows_core::HRESULT) -> Result<(), windows_result::HRESULT>;
}
...
impl IDedupChunkLibrary {
    pub unsafe fn InitializeForPushBuffers(&self) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetParameter(&self, dwparamtype: u32, vparamvalue: &super::super::System::Variant::VARIANT) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn StartChunking(&self, iiditeratorinterfaceid: windows_core::GUID) -> Result<windows_core::IUnknown, windows_result::HRESULT> {
        unsafe {
...
pub trait IDedupChunkLibrary_Impl: windows_core::IUnknownImpl {
    fn InitializeForPushBuffers(&self) -> Result<(), windows_result::HRESULT>;
    fn Uninitialize(&self) -> Result<(), windows_result::HRESULT>;
    fn SetParameter(&self, dwparamtype: u32, vparamvalue: &super::super::System::Variant::VARIANT) -> Result<(), windows_result::HRESULT>;
    fn StartChunking(&self, iiditeratorinterfaceid: &windows_core::GUID) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IDedupDataPort {
    pub unsafe fn GetStatus(&self, pstatus: *mut DedupDataPortVolumeStatus, pdataheadroommb: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn LookupChunks(&self, phashes: &[DedupHash]) -> Result<windows_core::GUID, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn InsertChunks(&self, pchunkmetadata: &[DedupChunk], pchunkdata: &[u8]) -> Result<windows_core::GUID, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn InsertChunksWithStream<P3>(&self, pchunkmetadata: &[DedupChunk], databytecount: u32, pchunkdatastream: P3) -> Result<windows_core::GUID, windows_result::HRESULT>
    where
    ...
    pub unsafe fn CommitStreams(&self, pstreams: &[DedupStream], pentries: &[DedupStreamEntry]) -> Result<windows_core::GUID, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CommitStreamsWithStream<P3>(&self, pstreams: &[DedupStream], entrycount: u32, pentriesstream: P3) -> Result<windows_core::GUID, windows_result::HRESULT>
    where
        P3: windows_core::Param<super::super::System::Com::IStream>,
    {
        unsafe {
    ...
    pub unsafe fn GetStreams(&self, pstreampaths: &[windows_core::BSTR]) -> Result<windows_core::GUID, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetStreamsResults(&self, requestid: windows_core::GUID, maxwaitms: u32, streamentryindex: u32, pstreamcount: *mut u32, ppstreams: *mut *mut DedupStream, pentrycount: *mut u32, ppentries: *mut *mut DedupStreamEntry, pstatus: *mut DedupDataPortRequestStatus, ppitemresults: *mut *mut windows_core::HRESULT) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetChunks(&self, phashes: &[DedupHash]) -> Result<windows_core::GUID, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetChunksResults(&self, requestid: windows_core::GUID, maxwaitms: u32, chunkindex: u32, pchunkcount: *mut u32, ppchunkmetadata: *mut *mut DedupChunk, pdatabytecount: *mut u32, ppchunkdata: *mut *mut u8, pstatus: *mut DedupDataPortRequestStatus, ppitemresults: *mut *mut windows_core::HRESULT) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetRequestStatus(&self, requestid: windows_core::GUID) -> Result<DedupDataPortRequestStatus, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetRequestResults(&self, requestid: windows_core::GUID, maxwaitms: u32, pbatchresult: *mut windows_core::HRESULT, pbatchcount: *mut u32, pstatus: *mut DedupDataPortRequestStatus, ppitemresults: *mut *mut windows_core::HRESULT) -> Result<(), windows_result::HRESULT> {
...
pub trait IDedupDataPort_Impl: windows_core::IUnknownImpl {
    fn GetStatus(&self, pstatus: *mut DedupDataPortVolumeStatus, pdataheadroommb: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn LookupChunks(&self, count: u32, phashes: *const DedupHash) -> Result<windows_core::GUID, windows_result::HRESULT>;
    fn InsertChunks(&self, chunkcount: u32, pchunkmetadata: *const DedupChunk, databytecount: u32, pchunkdata: *const u8) -> Result<windows_core::GUID, windows_result::HRESULT>;
    fn InsertChunksWithStream(&self, chunkcount: u32, pchunkmetadata: *const DedupChunk, databytecount: u32, pchunkdatastream: windows_core::Ref<'_, super::super::System::Com::IStream>) -> Result<windows_core::GUID, windows_result::HRESULT>;
    fn CommitStreams(&self, streamcount: u32, pstreams: *const DedupStream, entrycount: u32, pentries: *const DedupStreamEntry) -> Result<windows_core::GUID, windows_result::HRESULT>;
    fn CommitStreamsWithStream(&self, streamcount: u32, pstreams: *const DedupStream, entrycount: u32, pentriesstream: windows_core::Ref<'_, super::super::System::Com::IStream>) -> Result<windows_core::GUID, windows_result::HRESULT>;
    fn GetStreams(&self, streamcount: u32, pstreampaths: *const windows_core::BSTR) -> Result<windows_core::GUID, windows_result::HRESULT>;
    fn GetStreamsResults(&self, requestid: &windows_core::GUID, maxwaitms: u32, streamentryindex: u32, pstreamcount: *mut u32, ppstreams: *mut *mut DedupStream, pentrycount: *mut u32, ppentries: *mut *mut DedupStreamEntry, pstatus: *mut DedupDataPortRequestStatus, ppitemresults: *mut *mut windows_core::HRESULT) -> Result<(), windows_result::HRESULT>;
    fn GetChunks(&self, count: u32, phashes: *const DedupHash) -> Result<windows_core::GUID, windows_result::HRESULT>;
    fn GetChunksResults(&self, requestid: &windows_core::GUID, maxwaitms: u32, chunkindex: u32, pchunkcount: *mut u32, ppchunkmetadata: *mut *mut DedupChunk, pdatabytecount: *mut u32, ppchunkdata: *mut *mut u8, pstatus: *mut DedupDataPortRequestStatus, ppitemresults: *mut *mut windows_core::HRESULT) -> Result<(), windows_result::HRESULT>;
    fn GetRequestStatus(&self, requestid: &windows_core::GUID) -> Result<DedupDataPortRequestStatus, windows_result::HRESULT>;
    fn GetRequestResults(&self, requestid: &windows_core::GUID, maxwaitms: u32, pbatchresult: *mut windows_core::HRESULT, pbatchcount: *mut u32, pstatus: *mut DedupDataPortRequestStatus, ppitemresults: *mut *mut windows_core::HRESULT) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IDedupDataPortManager {
    pub unsafe fn GetConfiguration(&self, pminchunksize: *mut u32, pmaxchunksize: *mut u32, pchunkingalgorithm: *mut DedupChunkingAlgorithm, phashingalgorithm: *mut DedupHashingAlgorithm, pcompressionalgorithm: *mut DedupCompressionAlgorithm) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetVolumeStatus(&self, options: u32, path: &windows_core::BSTR) -> Result<DedupDataPortVolumeStatus, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetVolumeDataPort(&self, options: u32, path: &windows_core::BSTR) -> Result<IDedupDataPort, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDedupDataPortManager_Impl: windows_core::IUnknownImpl {
    fn GetConfiguration(&self, pminchunksize: *mut u32, pmaxchunksize: *mut u32, pchunkingalgorithm: *mut DedupChunkingAlgorithm, phashingalgorithm: *mut DedupHashingAlgorithm, pcompressionalgorithm: *mut DedupCompressionAlgorithm) -> Result<(), windows_result::HRESULT>;
    fn GetVolumeStatus(&self, options: u32, path: &windows_core::BSTR) -> Result<DedupDataPortVolumeStatus, windows_result::HRESULT>;
    fn GetVolumeDataPort(&self, options: u32, path: &windows_core::BSTR) -> Result<IDedupDataPort, windows_result::HRESULT>;
}
...
impl IDedupIterateChunksHash32 {
    pub unsafe fn PushBuffer(&self, pbuffer: &[u8]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Next(&self, parrchunks: &mut [DEDUP_CHUNK_INFO_HASH32], pulfetched: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Drain(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IDedupIterateChunksHash32_Impl: windows_core::IUnknownImpl {
    fn PushBuffer(&self, pbuffer: *const u8, ulbufferlength: u32) -> Result<(), windows_result::HRESULT>;
    fn Next(&self, ulmaxchunks: u32, parrchunks: *mut DEDUP_CHUNK_INFO_HASH32, pulfetched: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn Drain(&self) -> Result<(), windows_result::HRESULT>;
...
impl IDedupReadFileCallback {
    pub unsafe fn ReadBackupFile(&self, filefullpath: &windows_core::BSTR, fileoffset: i64, filebuffer: &mut [u8], returnedsize: *mut u32, flags: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn OrderContainersRestore(&self, containerpaths: &[windows_core::BSTR], readplanentries: *mut u32, readplan: *mut *mut DEDUP_CONTAINER_EXTENT) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn PreviewContainerRead(&self, filefullpath: &windows_core::BSTR, readoffsets: &[DDP_FILE_EXTENT]) -> Result<(), windows_result::HRESULT> {
...
pub trait IDedupReadFileCallback_Impl: windows_core::IUnknownImpl {
    fn ReadBackupFile(&self, filefullpath: &windows_core::BSTR, fileoffset: i64, sizetoread: u32, filebuffer: *mut u8, returnedsize: *mut u32, flags: u32) -> Result<(), windows_result::HRESULT>;
    fn OrderContainersRestore(&self, numberofcontainers: u32, containerpaths: *const windows_core::BSTR, readplanentries: *mut u32, readplan: *mut *mut DEDUP_CONTAINER_EXTENT) -> Result<(), windows_result::HRESULT>;
    fn PreviewContainerRead(&self, filefullpath: &windows_core::BSTR, numberofreads: u32, readoffsets: *const DDP_FILE_EXTENT) -> Result<(), windows_result::HRESULT>;
}
