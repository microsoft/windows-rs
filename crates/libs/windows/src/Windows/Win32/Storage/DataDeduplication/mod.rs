...
pub trait IDedupBackupSupport_Impl {
...
impl IDedupBackupSupport_Vtbl {
    ...
    {
        unsafe extern "system" fn RestoreFiles<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, numberoffiles: u32, filefullpaths: *const *mut core::ffi::c_void, store: *mut core::ffi::c_void, flags: u32, fileresults: *mut windows_core::HRESULT) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IDedupBackupSupport_Impl,
        {
            unsafe {
...
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
pub trait IDedupChunkLibrary_Impl {
...
impl IDedupChunkLibrary_Vtbl {
        ...
        <Identity as windows_core::IUnknownImpl>::Impl: IDedupChunkLibrary_Impl,
    {
        ...
        unsafe extern "system" fn SetParameter<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, dwparamtype: u32, vparamvalue: super::super::System::Variant::VARIANT) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IDedupChunkLibrary_Impl,
        {
            unsafe {
...
impl IDedupDataPort_Vtbl {
        ...
        <Identity as windows_core::IUnknownImpl>::Impl: IDedupDataPort_Impl,
    {
        ...
        unsafe extern "system" fn GetStreams<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, streamcount: u32, pstreampaths: *const *mut core::ffi::c_void, prequestid: *mut windows_core::GUID) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IDedupDataPort_Impl,
        {
            unsafe {
...
pub trait IDedupDataPortManager_Impl {
...
impl IDedupDataPortManager_Vtbl {
        ...
        <Identity as windows_core::IUnknownImpl>::Impl: IDedupDataPortManager_Impl,
    {
        ...
        unsafe extern "system" fn GetVolumeStatus<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, options: u32, path: *mut core::ffi::c_void, pstatus: *mut DedupDataPortVolumeStatus) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IDedupDataPortManager_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn GetVolumeDataPort<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, options: u32, path: *mut core::ffi::c_void, ppdataport: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IDedupDataPortManager_Impl,
        {
            unsafe {
...
pub trait IDedupIterateChunksHash32_Impl {
...
pub trait IDedupReadFileCallback_Impl {
...
impl IDedupReadFileCallback_Vtbl {
    ...
    {
        unsafe extern "system" fn ReadBackupFile<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, filefullpath: *mut core::ffi::c_void, fileoffset: i64, sizetoread: u32, filebuffer: *mut u8, returnedsize: *mut u32, flags: u32) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IDedupReadFileCallback_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn OrderContainersRestore<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, numberofcontainers: u32, containerpaths: *const *mut core::ffi::c_void, readplanentries: *mut u32, readplan: *mut *mut DEDUP_CONTAINER_EXTENT) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IDedupReadFileCallback_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn PreviewContainerRead<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, filefullpath: *mut core::ffi::c_void, numberofreads: u32, readoffsets: *const DDP_FILE_EXTENT) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IDedupReadFileCallback_Impl,
        {
            unsafe {
