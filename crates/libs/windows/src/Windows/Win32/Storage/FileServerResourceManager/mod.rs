...
impl IFsrmReport {
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn SetFilter<P1>(&self, filter: FsrmReportFilter, filtervalue: P1) -> windows_core::Result<()>
    where
...
impl IFsrmReportManager {
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn SetDefaultFilter<P2>(&self, reporttype: FsrmReportType, filter: FsrmReportFilter, filtervalue: P2) -> windows_core::Result<()>
    where
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn SetReportSizeLimit<P1>(&self, limit: FsrmReportLimit, limitvalue: P1) -> windows_core::Result<()>
    where
        P1: windows_core::Param<super::super::System::Variant::VARIANT>,
    {
