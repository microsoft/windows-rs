...
{
    ::windows::core::link ! ( "cabinet.dll""system" fn CloseCompressor ( compressorhandle : COMPRESSOR_HANDLE ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn CloseDecompressor(decompressorhandle: isize) -> super::super::Foundation::BOOL {
    ::windows::core::link ! ( "cabinet.dll""system" fn CloseDecompressor ( decompressorhandle : isize ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn Decompress(decompressorhandle: isize, compresseddata: ::core::option::Option<*const ::core::ffi::c_void>, compresseddatasize: usize, uncompressedbuffer: ::core::option::Option<*mut ::core::ffi::c_void>, uncompressedbuffersize: usize, uncompresseddatasize: ::core::option::Option<*mut usize>) -> super::super::Foundation::BOOL {
    ::windows::core::link ! ( "cabinet.dll""system" fn Decompress ( decompressorhandle : isize , compresseddata : *const ::core::ffi::c_void , compresseddatasize : usize , uncompressedbuffer : *mut ::core::ffi::c_void , uncompressedbuffersize : usize , uncompresseddatasize : *mut usize ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<COMPRESSOR_HANDLE>,
{
    ::windows::core::link ! ( "cabinet.dll""system" fn ResetCompressor ( compressorhandle : COMPRESSOR_HANDLE ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn ResetDecompressor(decompressorhandle: isize) -> super::super::Foundation::BOOL {
    ::windows::core::link ! ( "cabinet.dll""system" fn ResetDecompressor ( decompressorhandle : isize ) -> super::super::Foundation:: BOOL );
