#[inline]
pub unsafe fn FhServiceBlockBackup(pipe: FH_SERVICE_PIPE_HANDLE) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn FhServiceClosePipe(pipe: FH_SERVICE_PIPE_HANDLE) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn FhServiceOpenPipe(startserviceifstopped: bool) -> windows_result::Result<FH_SERVICE_PIPE_HANDLE> {
...
#[inline]
pub unsafe fn FhServiceReloadConfiguration(pipe: FH_SERVICE_PIPE_HANDLE) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn FhServiceStartBackup(pipe: FH_SERVICE_PIPE_HANDLE, lowpriorityio: bool) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn FhServiceStopBackup(pipe: FH_SERVICE_PIPE_HANDLE, stoptracking: bool) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn FhServiceUnblockBackup(pipe: FH_SERVICE_PIPE_HANDLE) -> windows_result::Result<()> {
...
impl IFhConfigMgr {
    pub unsafe fn LoadConfiguration(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).LoadConfiguration)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn CreateDefaultConfiguration(&self, overwriteifexists: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn SaveConfiguration(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SaveConfiguration)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn AddRemoveExcludeRule(&self, add: bool, category: FH_PROTECTED_ITEM_CATEGORY, item: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetIncludeExcludeRules(&self, include: bool, category: FH_PROTECTED_ITEM_CATEGORY) -> windows_result::Result<IFhScopeIterator> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetLocalPolicy(&self, localpolicytype: FH_LOCAL_POLICY_TYPE) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetLocalPolicy(&self, localpolicytype: FH_LOCAL_POLICY_TYPE, policyvalue: u64) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetBackupStatus(&self) -> windows_result::Result<FH_BACKUP_STATUS> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetBackupStatus)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetBackupStatus(&self, backupstatus: FH_BACKUP_STATUS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetBackupStatus)(windows_core::Interface::as_raw(self), backupstatus).ok() }
    }
    pub unsafe fn GetDefaultTarget(&self) -> windows_result::Result<IFhTarget> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ValidateTarget(&self, targeturl: &windows_core::BSTR) -> windows_result::Result<FH_DEVICE_VALIDATION_RESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ProvisionAndSetNewTarget(&self, targeturl: &windows_core::BSTR, targetname: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn ChangeDefaultTargetRecommendation(&self, recommend: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn QueryProtectionStatus(&self, protectionstate: *mut u32, protecteduntiltime: *mut windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IFhConfigMgr_Impl: windows_core::IUnknownImpl {
    fn LoadConfiguration(&self) -> windows_result::Result<()>;
    fn CreateDefaultConfiguration(&self, overwriteifexists: windows_core::BOOL) -> windows_result::Result<()>;
    fn SaveConfiguration(&self) -> windows_result::Result<()>;
    fn AddRemoveExcludeRule(&self, add: windows_core::BOOL, category: FH_PROTECTED_ITEM_CATEGORY, item: &windows_core::BSTR) -> windows_result::Result<()>;
    fn GetIncludeExcludeRules(&self, include: windows_core::BOOL, category: FH_PROTECTED_ITEM_CATEGORY) -> windows_result::Result<IFhScopeIterator>;
    fn GetLocalPolicy(&self, localpolicytype: FH_LOCAL_POLICY_TYPE) -> windows_result::Result<u64>;
    fn SetLocalPolicy(&self, localpolicytype: FH_LOCAL_POLICY_TYPE, policyvalue: u64) -> windows_result::Result<()>;
    fn GetBackupStatus(&self) -> windows_result::Result<FH_BACKUP_STATUS>;
    fn SetBackupStatus(&self, backupstatus: FH_BACKUP_STATUS) -> windows_result::Result<()>;
    fn GetDefaultTarget(&self) -> windows_result::Result<IFhTarget>;
    fn ValidateTarget(&self, targeturl: &windows_core::BSTR) -> windows_result::Result<FH_DEVICE_VALIDATION_RESULT>;
    fn ProvisionAndSetNewTarget(&self, targeturl: &windows_core::BSTR, targetname: &windows_core::BSTR) -> windows_result::Result<()>;
    fn ChangeDefaultTargetRecommendation(&self, recommend: windows_core::BOOL) -> windows_result::Result<()>;
    fn QueryProtectionStatus(&self, protectionstate: *mut u32, protecteduntiltime: *mut windows_core::BSTR) -> windows_result::Result<()>;
}
...
impl IFhReassociation {
    ...
    pub unsafe fn ScanTargetForConfigurations(&self, targeturl: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetConfigurationDetails(&self, index: u32, username: *mut windows_core::BSTR, pcname: *mut windows_core::BSTR, backuptime: *mut super::super::Foundation::FILETIME) -> windows_result::Result<()> {
    ...
    pub unsafe fn SelectConfiguration(&self, index: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SelectConfiguration)(windows_core::Interface::as_raw(self), index).ok() }
    }
    pub unsafe fn PerformReassociation(&self, overwriteifexists: bool) -> windows_result::Result<()> {
...
pub trait IFhReassociation_Impl: windows_core::IUnknownImpl {
    fn ValidateTarget(&self, targeturl: &windows_core::BSTR) -> windows_result::Result<FH_DEVICE_VALIDATION_RESULT>;
    fn ScanTargetForConfigurations(&self, targeturl: &windows_core::BSTR) -> windows_result::Result<()>;
    fn GetConfigurationDetails(&self, index: u32, username: *mut windows_core::BSTR, pcname: *mut windows_core::BSTR, backuptime: *mut super::super::Foundation::FILETIME) -> windows_result::Result<()>;
    fn SelectConfiguration(&self, index: u32) -> windows_result::Result<()>;
    fn PerformReassociation(&self, overwriteifexists: windows_core::BOOL) -> windows_result::Result<()>;
}
...
impl IFhScopeIterator {
    pub unsafe fn MoveToNextItem(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).MoveToNextItem)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn GetItem(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IFhScopeIterator_Impl: windows_core::IUnknownImpl {
    fn MoveToNextItem(&self) -> windows_result::Result<()>;
    fn GetItem(&self) -> windows_result::Result<windows_core::BSTR>;
}
...
impl IFhTarget {
    pub unsafe fn GetStringProperty(&self, propertytype: FH_TARGET_PROPERTY_TYPE) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetNumericalProperty(&self, propertytype: FH_TARGET_PROPERTY_TYPE) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IFhTarget_Impl: windows_core::IUnknownImpl {
    fn GetStringProperty(&self, propertytype: FH_TARGET_PROPERTY_TYPE) -> windows_result::Result<windows_core::BSTR>;
    fn GetNumericalProperty(&self, propertytype: FH_TARGET_PROPERTY_TYPE) -> windows_result::Result<u64>;
}
impl IFhTarget_Vtbl {
