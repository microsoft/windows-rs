...
impl IFhConfigMgr_Vtbl {
    ...
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IFhConfigMgr_Impl,
    {
        ...
        unsafe extern "system" fn CreateDefaultConfiguration<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, overwriteifexists: windows_core::BOOL) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IFhConfigMgr_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn AddRemoveExcludeRule<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, add: windows_core::BOOL, category: FH_PROTECTED_ITEM_CATEGORY, item: *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IFhConfigMgr_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn GetIncludeExcludeRules<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, include: windows_core::BOOL, category: FH_PROTECTED_ITEM_CATEGORY, iterator: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IFhConfigMgr_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn ValidateTarget<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, targeturl: *mut core::ffi::c_void, validationresult: *mut FH_DEVICE_VALIDATION_RESULT) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IFhConfigMgr_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn ProvisionAndSetNewTarget<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, targeturl: *mut core::ffi::c_void, targetname: *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IFhConfigMgr_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn ChangeDefaultTargetRecommendation<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, recommend: windows_core::BOOL) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IFhConfigMgr_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn QueryProtectionStatus<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, protectionstate: *mut u32, protecteduntiltime: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IFhConfigMgr_Impl,
        {
            unsafe {
...
pub trait IFhReassociation_Impl {
    fn ValidateTarget(&self, targeturl: &windows_core::BSTR) -> windows_core::Result<FH_DEVICE_VALIDATION_RESULT>;
...
impl IFhReassociation_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IFhReassociation_Impl,
    {
        unsafe extern "system" fn ValidateTarget<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, targeturl: *mut core::ffi::c_void, validationresult: *mut FH_DEVICE_VALIDATION_RESULT) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IFhReassociation_Impl,
        ...
        unsafe extern "system" fn ScanTargetForConfigurations<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, targeturl: *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IFhReassociation_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn GetConfigurationDetails<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, index: u32, username: *mut *mut core::ffi::c_void, pcname: *mut *mut core::ffi::c_void, backuptime: *mut super::super::Foundation::FILETIME) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IFhReassociation_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn PerformReassociation<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, overwriteifexists: windows_core::BOOL) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IFhReassociation_Impl,
        {
            unsafe {
...
pub trait IFhScopeIterator_Impl {
...
impl IFhScopeIterator_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IFhScopeIterator_Impl,
    {
        ...
        unsafe extern "system" fn GetItem<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, item: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IFhScopeIterator_Impl,
        {
            unsafe {
...
impl IFhTarget_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IFhTarget_Impl,
    {
        unsafe extern "system" fn GetStringProperty<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, propertytype: FH_TARGET_PROPERTY_TYPE, propertyvalue: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IFhTarget_Impl,
        {
            unsafe {
