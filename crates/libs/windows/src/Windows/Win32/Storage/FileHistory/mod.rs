...
pub const FHCFG_E_CONFIGURATION_PREVIOUSLY_LOADED: windows_core::HRESULT = 0x80040305_u32 as _;
pub const FHCFG_E_CONFIG_ALREADY_EXISTS: windows_core::HRESULT = 0x80040302_u32 as _;
pub const FHCFG_E_CONFIG_FILE_NOT_FOUND: windows_core::HRESULT = 0x80040301_u32 as _;
pub const FHCFG_E_CORRUPT_CONFIG_FILE: windows_core::HRESULT = 0x80040300_u32 as _;
pub const FHCFG_E_INVALID_REHYDRATION_STATE: windows_core::HRESULT = 0x8004030A_u32 as _;
pub const FHCFG_E_LEGACY_BACKUP_NOT_FOUND: windows_core::HRESULT = 0x80040315_u32 as _;
pub const FHCFG_E_LEGACY_BACKUP_USER_EXCLUDED: windows_core::HRESULT = 0x80040314_u32 as _;
pub const FHCFG_E_LEGACY_TARGET_UNSUPPORTED: windows_core::HRESULT = 0x80040312_u32 as _;
pub const FHCFG_E_LEGACY_TARGET_VALIDATION_UNSUPPORTED: windows_core::HRESULT = 0x80040313_u32 as _;
pub const FHCFG_E_NO_VALID_CONFIGURATION_LOADED: windows_core::HRESULT = 0x80040303_u32 as _;
pub const FHCFG_E_RECOMMENDATION_CHANGE_NOT_ALLOWED: windows_core::HRESULT = 0x80040310_u32 as _;
pub const FHCFG_E_TARGET_CANNOT_BE_USED: windows_core::HRESULT = 0x80040309_u32 as _;
pub const FHCFG_E_TARGET_NOT_CONFIGURED: windows_core::HRESULT = 0x80040307_u32 as _;
pub const FHCFG_E_TARGET_NOT_CONNECTED: windows_core::HRESULT = 0x80040304_u32 as _;
pub const FHCFG_E_TARGET_NOT_ENOUGH_FREE_SPACE: windows_core::HRESULT = 0x80040308_u32 as _;
pub const FHCFG_E_TARGET_REHYDRATED_ELSEWHERE: windows_core::HRESULT = 0x80040311_u32 as _;
pub const FHCFG_E_TARGET_VERIFICATION_FAILED: windows_core::HRESULT = 0x80040306_u32 as _;
pub const FHSVC_E_BACKUP_BLOCKED: windows_core::HRESULT = 0x80040600_u32 as _;
pub const FHSVC_E_CONFIG_DISABLED: windows_core::HRESULT = 0x80040602_u32 as _;
pub const FHSVC_E_CONFIG_DISABLED_GP: windows_core::HRESULT = 0x80040603_u32 as _;
pub const FHSVC_E_CONFIG_REHYDRATING: windows_core::HRESULT = 0x80040605_u32 as _;
pub const FHSVC_E_FATAL_CONFIG_ERROR: windows_core::HRESULT = 0x80040604_u32 as _;
pub const FHSVC_E_NOT_CONFIGURED: windows_core::HRESULT = 0x80040601_u32 as _;
