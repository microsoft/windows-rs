...
pub const ACT_AUTHORIZED: ACT_AUTHORIZATION_STATE_VALUE = ACT_AUTHORIZATION_STATE_VALUE(1);
pub const ACT_AUTHORIZE_ON_RESUME: u32 = 1;
pub const ACT_AUTHORIZE_ON_SESSION_UNLOCK: u32 = 2;
pub const ACT_UNAUTHORIZED: ACT_AUTHORIZATION_STATE_VALUE = ACT_AUTHORIZATION_STATE_VALUE(0);
...
pub const ES_AUTHN_ERROR_END: u32 = 1279;
pub const ES_AUTHN_ERROR_START: u32 = 1024;
pub const ES_E_AUTHORIZED_UNEXPECTED: u32 = 3221491978;
pub const ES_E_BAD_SEQUENCE: u32 = 3221488135;
pub const ES_E_CHALLENGE_MISMATCH: u32 = 3221491969;
pub const ES_E_CHALLENGE_SIZE_MISMATCH: u32 = 3221491970;
pub const ES_E_DEVICE_DIGEST_MISSING: u32 = 3221491976;
pub const ES_E_FRIENDLY_NAME_TOO_LONG: u32 = 3221491971;
pub const ES_E_GROUP_POLICY_FORBIDDEN_OPERATION: u32 = 3221488140;
pub const ES_E_GROUP_POLICY_FORBIDDEN_USE: u32 = 3221488139;
pub const ES_E_INCOMPLETE_COMMAND: u32 = 3221488134;
pub const ES_E_INCONSISTENT_PARAM_LENGTH: u32 = 3221488143;
pub const ES_E_INVALID_CAPABILITY: u32 = 3221488138;
pub const ES_E_INVALID_FIELD_IDENTIFIER: u32 = 3221491968;
pub const ES_E_INVALID_PARAM_COMBINATION: u32 = 3221488141;
pub const ES_E_INVALID_PARAM_LENGTH: u32 = 3221488142;
pub const ES_E_INVALID_RESPONSE: u32 = 3221488128;
pub const ES_E_INVALID_SILO: u32 = 3221488137;
pub const ES_E_NOT_AUTHORIZED_UNEXPECTED: u32 = 3221491977;
pub const ES_E_NO_AUTHENTICATION_REQUIRED: u32 = 3221488640;
pub const ES_E_NO_PROBE: u32 = 3221488136;
pub const ES_E_OTHER_SECURITY_PROTOCOL_ACTIVE: u32 = 3221491975;
pub const ES_E_PASSWORD_HINT_TOO_LONG: u32 = 3221491974;
pub const ES_E_PASSWORD_TOO_LONG: u32 = 3221491973;
pub const ES_E_PROVISIONED_UNEXPECTED: u32 = 3221491979;
pub const ES_E_SILO_NAME_TOO_LONG: u32 = 3221491972;
pub const ES_E_UNKNOWN_DIGEST_ALGORITHM: u32 = 3221491980;
pub const ES_E_UNPROVISIONED_HARDWARE: u32 = 3221488132;
pub const ES_E_UNSUPPORTED_HARDWARE: u32 = 3221488133;
pub const ES_GENERAL_ERROR_END: u32 = 1023;
pub const ES_GENERAL_ERROR_START: u32 = 512;
pub const ES_PW_SILO_ERROR_END: u32 = 4607;
pub const ES_PW_SILO_ERROR_START: u32 = 4352;
pub const ES_RESERVED_COM_ERROR_END: u32 = 511;
pub const ES_RESERVED_COM_ERROR_START: u32 = 0;
pub const ES_RESERVED_SILO_ERROR_END: u32 = 4095;
pub const ES_RESERVED_SILO_ERROR_START: u32 = 1280;
pub const ES_RESERVED_SILO_SPECIFIC_ERROR_END: u32 = 49151;
pub const ES_RESERVED_SILO_SPECIFIC_ERROR_START: u32 = 4608;
pub const ES_VENDOR_ERROR_END: u32 = 65535;
pub const ES_VENDOR_ERROR_START: u32 = 49152;
...
pub const FACILITY_ENHANCED_STORAGE: u32 = 4;
...
impl IEnhancedStorageACT {
    pub unsafe fn Authorize(&self, hwndparent: u32, dwflags: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).Authorize)(windows_core::Interface::as_raw(self), hwndparent, dwflags) }
    }
    pub unsafe fn Unauthorize(&self) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).Unauthorize)(windows_core::Interface::as_raw(self)) }
    }
    ...
    pub unsafe fn GetSilos(&self, pppienhancedstoragesilos: *mut *mut Option<IEnhancedStorageSilo>, pcenhancedstoragesilos: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetSilos)(windows_core::Interface::as_raw(self), pppienhancedstoragesilos as _, pcenhancedstoragesilos as _) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IEnhancedStorageACT3 {
    pub unsafe fn UnauthorizeEx(&self, dwflags: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).UnauthorizeEx)(windows_core::Interface::as_raw(self), dwflags) }
    }
...
impl IEnhancedStorageSilo {
    ...
    pub unsafe fn GetActions(&self, pppienhancedstoragesiloactions: *mut *mut Option<IEnhancedStorageSiloAction>, pcenhancedstoragesiloactions: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetActions)(windows_core::Interface::as_raw(self), pppienhancedstoragesiloactions as _, pcenhancedstoragesiloactions as _) }
    }
    pub unsafe fn SendCommand(&self, command: u8, pbcommandbuffer: &[u8], pbresponsebuffer: *mut u8, pcbresponsebuffer: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SendCommand)(windows_core::Interface::as_raw(self), command, core::mem::transmute(pbcommandbuffer.as_ptr()), pbcommandbuffer.len().try_into().unwrap(), pbresponsebuffer as _, pcbresponsebuffer as _) }
    }
...
impl IEnumEnhancedStorageACT {
    pub unsafe fn GetACTs(&self, pppienhancedstorageacts: *mut *mut Option<IEnhancedStorageACT>, pcenhancedstorageacts: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetACTs)(windows_core::Interface::as_raw(self), pppienhancedstorageacts as _, pcenhancedstorageacts as _) }
    }
...
pub const MATCH_KIND_LEXICAL: i32 = 1;
pub const MATCH_KIND_SEMANTIC: i32 = 2;
