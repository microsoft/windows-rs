...
impl IEnhancedStorageACT {
    pub unsafe fn Authorize(&self, hwndparent: u32, dwflags: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Authorize)(windows_core::Interface::as_raw(self), hwndparent, dwflags).ok() }
    }
    pub unsafe fn Unauthorize(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Unauthorize)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn GetAuthorizationState(&self) -> windows_result::Result<ACT_AUTHORIZATION_STATE> {
        unsafe {
    ...
    pub unsafe fn GetMatchingVolume(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMatchingVolume)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetUniqueIdentity(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetUniqueIdentity)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetSilos(&self, pppienhancedstoragesilos: *mut *mut Option<IEnhancedStorageSilo>, pcenhancedstoragesilos: *mut u32) -> windows_result::Result<()> {
...
pub trait IEnhancedStorageACT_Impl: windows_core::IUnknownImpl {
    fn Authorize(&self, hwndparent: u32, dwflags: u32) -> windows_result::Result<()>;
    fn Unauthorize(&self) -> windows_result::Result<()>;
    fn GetAuthorizationState(&self) -> windows_result::Result<ACT_AUTHORIZATION_STATE>;
    fn GetMatchingVolume(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn GetUniqueIdentity(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn GetSilos(&self, pppienhancedstoragesilos: *mut *mut Option<IEnhancedStorageSilo>, pcenhancedstoragesilos: *mut u32) -> windows_result::Result<()>;
}
...
impl IEnhancedStorageACT2 {
    ...
    pub unsafe fn IsDeviceRemovable(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IEnhancedStorageACT2_Impl: IEnhancedStorageACT_Impl {
    ...
    fn IsDeviceRemovable(&self) -> windows_result::Result<windows_core::BOOL>;
}
...
impl IEnhancedStorageACT3 {
    pub unsafe fn UnauthorizeEx(&self, dwflags: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).UnauthorizeEx)(windows_core::Interface::as_raw(self), dwflags).ok() }
    }
    pub unsafe fn IsQueueFrozen(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsQueueFrozen)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetShellExtSupport(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IEnhancedStorageACT3_Impl: IEnhancedStorageACT2_Impl {
    fn UnauthorizeEx(&self, dwflags: u32) -> windows_result::Result<()>;
    fn IsQueueFrozen(&self) -> windows_result::Result<windows_core::BOOL>;
    fn GetShellExtSupport(&self) -> windows_result::Result<windows_core::BOOL>;
}
...
impl IEnhancedStorageSilo {
    pub unsafe fn GetInfo(&self) -> windows_result::Result<SILO_INFO> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetInfo)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetActions(&self, pppienhancedstoragesiloactions: *mut *mut Option<IEnhancedStorageSiloAction>, pcenhancedstoragesiloactions: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SendCommand(&self, command: u8, pbcommandbuffer: &[u8], pbresponsebuffer: *mut u8, pcbresponsebuffer: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetPortableDevice(&self) -> windows_result::Result<super::super::Devices::PortableDevices::IPortableDevice> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetDevicePath(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IEnhancedStorageSilo_Impl: windows_core::IUnknownImpl {
    fn GetInfo(&self) -> windows_result::Result<SILO_INFO>;
    fn GetActions(&self, pppienhancedstoragesiloactions: *mut *mut Option<IEnhancedStorageSiloAction>, pcenhancedstoragesiloactions: *mut u32) -> windows_result::Result<()>;
    fn SendCommand(&self, command: u8, pbcommandbuffer: *const u8, cbcommandbuffer: u32, pbresponsebuffer: *mut u8, pcbresponsebuffer: *mut u32) -> windows_result::Result<()>;
    fn GetPortableDevice(&self) -> windows_result::Result<super::super::Devices::PortableDevices::IPortableDevice>;
    fn GetDevicePath(&self) -> windows_result::Result<windows_core::PWSTR>;
}
#[cfg(feature = "Win32_Devices_PortableDevices")]
...
impl IEnumEnhancedStorageACT {
    pub unsafe fn GetACTs(&self, pppienhancedstorageacts: *mut *mut Option<IEnhancedStorageACT>, pcenhancedstorageacts: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetMatchingACT<P0>(&self, szvolume: P0) -> windows_result::Result<IEnhancedStorageACT>
    where
...
pub trait IEnumEnhancedStorageACT_Impl: windows_core::IUnknownImpl {
    fn GetACTs(&self, pppienhancedstorageacts: *mut *mut Option<IEnhancedStorageACT>, pcenhancedstorageacts: *mut u32) -> windows_result::Result<()>;
    fn GetMatchingACT(&self, szvolume: &windows_core::PCWSTR) -> windows_result::Result<IEnhancedStorageACT>;
}
