    ...
    P0: windows_core::Param<PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT>,
{
    ...
    PrjAllocateAlignedBuffer(namespacevirtualizationcontext.param().abi(), core::mem::transmute(size))
}
#[inline]
    ...
    P0: windows_core::Param<PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT>,
{
    ...
    PrjClearNegativePathCache(namespacevirtualizationcontext.param().abi(), core::mem::transmute(totalentrynumber.unwrap_or(core::ptr::null_mut()))).ok()
}
#[inline]
    ...
    P0: windows_core::Param<PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT>,
{
    ...
    PrjCompleteCommand(namespacevirtualizationcontext.param().abi(), core::mem::transmute(commandid), core::mem::transmute(completionresult), core::mem::transmute(extendedparameters.unwrap_or(core::ptr::null()))).ok()
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    PrjDeleteFile(namespacevirtualizationcontext.param().abi(), destinationfilename.param().abi(), core::mem::transmute(updateflags), core::mem::transmute(failurereason.unwrap_or(core::ptr::null_mut()))).ok()
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    PrjFillDirEntryBuffer2(direntrybufferhandle.param().abi(), filename.param().abi(), core::mem::transmute(filebasicinfo.unwrap_or(core::ptr::null())), core::mem::transmute(extendedinfo.unwrap_or(core::ptr::null()))).ok()
}
#[inline]
    ...
    P0: windows_core::Param<PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT>,
{
    ...
    PrjGetVirtualizationInstanceInfo(namespacevirtualizationcontext.param().abi(), core::mem::transmute(virtualizationinstanceinfo)).ok()
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    PrjMarkDirectoryAsPlaceholder(rootpathname.param().abi(), targetpathname.param().abi(), core::mem::transmute(versioninfo.unwrap_or(core::ptr::null())), core::mem::transmute(virtualizationinstanceid)).ok()
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    let mut result__ = core::mem::zeroed();
    PrjStartVirtualizing(virtualizationrootpath.param().abi(), core::mem::transmute(callbacks), core::mem::transmute(instancecontext.unwrap_or(core::ptr::null())), core::mem::transmute(options.unwrap_or(core::ptr::null())), &mut result__).map(|| core::mem::transmute(result__))
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    PrjUpdateFileIfNeeded(namespacevirtualizationcontext.param().abi(), destinationfilename.param().abi(), core::mem::transmute(placeholderinfo), core::mem::transmute(placeholderinfosize), core::mem::transmute(updateflags), core::mem::transmute(failurereason.unwrap_or(core::ptr::null_mut()))).ok()
}
#[inline]
    ...
    P0: windows_core::Param<PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT>,
{
    ...
    PrjWriteFileData(namespacevirtualizationcontext.param().abi(), core::mem::transmute(datastreamid), core::mem::transmute(buffer), core::mem::transmute(byteoffset), core::mem::transmute(length)).ok()
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    PrjWritePlaceholderInfo(namespacevirtualizationcontext.param().abi(), destinationfilename.param().abi(), core::mem::transmute(placeholderinfo), core::mem::transmute(placeholderinfosize)).ok()
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    PrjWritePlaceholderInfo2(namespacevirtualizationcontext.param().abi(), destinationfilename.param().abi(), core::mem::transmute(placeholderinfo), core::mem::transmute(placeholderinfosize), core::mem::transmute(extendedinfo.unwrap_or(core::ptr::null()))).ok()
}
