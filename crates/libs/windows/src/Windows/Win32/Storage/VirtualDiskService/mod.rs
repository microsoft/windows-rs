...
impl IEnumVdsObject {
    pub unsafe fn Next(&self, ppobjectarray: &mut [Option<windows_core::IUnknown>], pcfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
...
pub trait IEnumVdsObject_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, ppobjectarray: *mut Option<windows_core::IUnknown>, pcfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumVdsObject>;
}
...
impl IVdsAdmin {
    pub unsafe fn RegisterProvider<P2, P4, P5>(&self, providerid: windows_core::GUID, providerclsid: windows_core::GUID, pwszname: P2, r#type: VDS_PROVIDER_TYPE, pwszmachinename: P4, pwszversion: P5, guidversionid: windows_core::GUID) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn UnregisterProvider(&self, providerid: windows_core::GUID) -> windows_result::Result<()> {
...
pub trait IVdsAdmin_Impl: windows_core::IUnknownImpl {
    fn RegisterProvider(&self, providerid: &windows_core::GUID, providerclsid: &windows_core::GUID, pwszname: &windows_core::PCWSTR, r#type: VDS_PROVIDER_TYPE, pwszmachinename: &windows_core::PCWSTR, pwszversion: &windows_core::PCWSTR, guidversionid: &windows_core::GUID) -> windows_result::Result<()>;
    fn UnregisterProvider(&self, providerid: &windows_core::GUID) -> windows_result::Result<()>;
}
impl IVdsAdmin_Vtbl {
...
impl IVdsAdvancedDisk {
    pub unsafe fn GetPartitionProperties(&self, ulloffset: u64, ppartitionprop: *mut VDS_PARTITION_PROP) -> windows_result::Result<()> {
    ...
    pub unsafe fn QueryPartitions(&self, pppartitionproparray: *mut *mut VDS_PARTITION_PROP, plnumberofpartitions: *mut i32) -> windows_result::Result<()> {
    ...
    pub unsafe fn CreatePartition(&self, ulloffset: u64, ullsize: u64, para: *const CREATE_PARTITION_PARAMETERS) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn DeletePartition(&self, ulloffset: u64, bforce: bool, bforceprotected: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn ChangeAttributes(&self, ulloffset: u64, para: *const CHANGE_ATTRIBUTES_PARAMETERS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ChangeAttributes)(windows_core::Interface::as_raw(self), ulloffset, para).ok() }
    }
    pub unsafe fn AssignDriveLetter(&self, ulloffset: u64, wcletter: u16) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).AssignDriveLetter)(windows_core::Interface::as_raw(self), ulloffset, wcletter).ok() }
    }
    pub unsafe fn DeleteDriveLetter(&self, ulloffset: u64, wcletter: u16) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).DeleteDriveLetter)(windows_core::Interface::as_raw(self), ulloffset, wcletter).ok() }
    }
    pub unsafe fn GetDriveLetter(&self, ulloffset: u64, pwcletter: windows_core::PWSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn FormatPartition<P2>(&self, ulloffset: u64, r#type: VDS_FILE_SYSTEM_TYPE, pwszlabel: P2, dwunitallocationsize: u32, bforce: bool, bquickformat: bool, benablecompression: bool) -> windows_result::Result<IVdsAsync>
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn Clean(&self, bforce: bool, bforceoem: bool, bfullclean: bool) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsAdvancedDisk_Impl: windows_core::IUnknownImpl {
    fn GetPartitionProperties(&self, ulloffset: u64, ppartitionprop: *mut VDS_PARTITION_PROP) -> windows_result::Result<()>;
    fn QueryPartitions(&self, pppartitionproparray: *mut *mut VDS_PARTITION_PROP, plnumberofpartitions: *mut i32) -> windows_result::Result<()>;
    fn CreatePartition(&self, ulloffset: u64, ullsize: u64, para: *const CREATE_PARTITION_PARAMETERS) -> windows_result::Result<IVdsAsync>;
    fn DeletePartition(&self, ulloffset: u64, bforce: windows_core::BOOL, bforceprotected: windows_core::BOOL) -> windows_result::Result<()>;
    fn ChangeAttributes(&self, ulloffset: u64, para: *const CHANGE_ATTRIBUTES_PARAMETERS) -> windows_result::Result<()>;
    fn AssignDriveLetter(&self, ulloffset: u64, wcletter: u16) -> windows_result::Result<()>;
    fn DeleteDriveLetter(&self, ulloffset: u64, wcletter: u16) -> windows_result::Result<()>;
    fn GetDriveLetter(&self, ulloffset: u64, pwcletter: windows_core::PWSTR) -> windows_result::Result<()>;
    fn FormatPartition(&self, ulloffset: u64, r#type: VDS_FILE_SYSTEM_TYPE, pwszlabel: &windows_core::PCWSTR, dwunitallocationsize: u32, bforce: windows_core::BOOL, bquickformat: windows_core::BOOL, benablecompression: windows_core::BOOL) -> windows_result::Result<IVdsAsync>;
    fn Clean(&self, bforce: windows_core::BOOL, bforceoem: windows_core::BOOL, bfullclean: windows_core::BOOL) -> windows_result::Result<IVdsAsync>;
}
...
impl IVdsAdvancedDisk2 {
    pub unsafe fn ChangePartitionType(&self, ulloffset: u64, bforce: bool, para: *const CHANGE_PARTITION_TYPE_PARAMETERS) -> windows_result::Result<()> {
...
pub trait IVdsAdvancedDisk2_Impl: windows_core::IUnknownImpl {
    fn ChangePartitionType(&self, ulloffset: u64, bforce: windows_core::BOOL, para: *const CHANGE_PARTITION_TYPE_PARAMETERS) -> windows_result::Result<()>;
}
...
impl IVdsAdvancedDisk3 {
    pub unsafe fn GetProperties(&self, padvdiskprop: *mut VDS_ADVANCEDDISK_PROP) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProperties)(windows_core::Interface::as_raw(self), padvdiskprop as _).ok() }
    }
    pub unsafe fn GetUniqueId(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsAdvancedDisk3_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, padvdiskprop: *mut VDS_ADVANCEDDISK_PROP) -> windows_result::Result<()>;
    fn GetUniqueId(&self) -> windows_result::Result<windows_core::PWSTR>;
}
...
impl IVdsAdviseSink {
    pub unsafe fn OnNotify(&self, pnotificationarray: &[VDS_NOTIFICATION]) -> windows_result::Result<()> {
...
pub trait IVdsAdviseSink_Impl: windows_core::IUnknownImpl {
    fn OnNotify(&self, lnumberofnotifications: i32, pnotificationarray: *const VDS_NOTIFICATION) -> windows_result::Result<()>;
}
...
impl IVdsAsync {
    ...
    pub unsafe fn Wait(&self, phrresult: *mut windows_core::HRESULT, pasyncout: *mut VDS_ASYNC_OUTPUT) -> windows_result::Result<()> {
    ...
    pub unsafe fn QueryStatus(&self, phrresult: *mut windows_core::HRESULT, pulpercentcompleted: *mut u32) -> windows_result::Result<()> {
...
pub trait IVdsAsync_Impl: windows_core::IUnknownImpl {
    ...
    fn Wait(&self, phrresult: *mut windows_core::HRESULT, pasyncout: *mut VDS_ASYNC_OUTPUT) -> windows_result::Result<()>;
    fn QueryStatus(&self, phrresult: *mut windows_core::HRESULT, pulpercentcompleted: *mut u32) -> windows_result::Result<()>;
}
impl IVdsAsync_Vtbl {
...
impl IVdsController {
    pub unsafe fn GetProperties(&self, pcontrollerprop: *mut VDS_CONTROLLER_PROP) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProperties)(windows_core::Interface::as_raw(self), pcontrollerprop as _).ok() }
    }
    pub unsafe fn GetSubSystem(&self) -> windows_result::Result<IVdsSubSystem> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetPortProperties(&self, sportnumber: i16, pportprop: *mut VDS_PORT_PROP) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetStatus(&self, status: VDS_CONTROLLER_STATUS) -> windows_result::Result<()> {
...
pub trait IVdsController_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, pcontrollerprop: *mut VDS_CONTROLLER_PROP) -> windows_result::Result<()>;
    fn GetSubSystem(&self) -> windows_result::Result<IVdsSubSystem>;
    fn GetPortProperties(&self, sportnumber: i16, pportprop: *mut VDS_PORT_PROP) -> windows_result::Result<()>;
    fn FlushCache(&self) -> windows_result::Result<()>;
    fn InvalidateCache(&self) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn QueryAssociatedLuns(&self) -> windows_result::Result<IEnumVdsObject>;
    fn SetStatus(&self, status: VDS_CONTROLLER_STATUS) -> windows_result::Result<()>;
}
...
impl IVdsControllerControllerPort {
    pub unsafe fn QueryControllerPorts(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsControllerControllerPort_Impl: windows_core::IUnknownImpl {
    fn QueryControllerPorts(&self) -> windows_result::Result<IEnumVdsObject>;
}
...
impl IVdsControllerPort {
    pub unsafe fn GetProperties(&self, pportprop: *mut VDS_PORT_PROP) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProperties)(windows_core::Interface::as_raw(self), pportprop as _).ok() }
    }
    pub unsafe fn GetController(&self) -> windows_result::Result<IVdsController> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetStatus(&self, status: VDS_PORT_STATUS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetStatus)(windows_core::Interface::as_raw(self), status).ok() }
    }
}
#[repr(C)]
...
pub trait IVdsControllerPort_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, pportprop: *mut VDS_PORT_PROP) -> windows_result::Result<()>;
    fn GetController(&self) -> windows_result::Result<IVdsController>;
    fn QueryAssociatedLuns(&self) -> windows_result::Result<IEnumVdsObject>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn SetStatus(&self, status: VDS_PORT_STATUS) -> windows_result::Result<()>;
}
...
impl IVdsCreatePartitionEx {
    pub unsafe fn CreatePartitionEx(&self, ulloffset: u64, ullsize: u64, ulalign: u32, para: *const CREATE_PARTITION_PARAMETERS) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsCreatePartitionEx_Impl: windows_core::IUnknownImpl {
    fn CreatePartitionEx(&self, ulloffset: u64, ullsize: u64, ulalign: u32, para: *const CREATE_PARTITION_PARAMETERS) -> windows_result::Result<IVdsAsync>;
}
...
impl IVdsDisk {
    pub unsafe fn GetProperties(&self, pdiskproperties: *mut VDS_DISK_PROP) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProperties)(windows_core::Interface::as_raw(self), pdiskproperties as _).ok() }
    }
    pub unsafe fn GetPack(&self) -> windows_result::Result<IVdsPack> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetIdentificationData(&self, pluninfo: *mut VDS_LUN_INFORMATION) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetIdentificationData)(windows_core::Interface::as_raw(self), pluninfo as _).ok() }
    }
    pub unsafe fn QueryExtents(&self, ppextentarray: *mut *mut VDS_DISK_EXTENT, plnumberofextents: *mut i32) -> windows_result::Result<()> {
    ...
    pub unsafe fn ConvertStyle(&self, newstyle: VDS_PARTITION_STYLE) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ConvertStyle)(windows_core::Interface::as_raw(self), newstyle).ok() }
    }
    pub unsafe fn SetFlags(&self, ulflags: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetFlags)(windows_core::Interface::as_raw(self), ulflags).ok() }
    }
    pub unsafe fn ClearFlags(&self, ulflags: u32) -> windows_result::Result<()> {
...
pub trait IVdsDisk_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, pdiskproperties: *mut VDS_DISK_PROP) -> windows_result::Result<()>;
    fn GetPack(&self) -> windows_result::Result<IVdsPack>;
    fn GetIdentificationData(&self, pluninfo: *mut VDS_LUN_INFORMATION) -> windows_result::Result<()>;
    fn QueryExtents(&self, ppextentarray: *mut *mut VDS_DISK_EXTENT, plnumberofextents: *mut i32) -> windows_result::Result<()>;
    fn ConvertStyle(&self, newstyle: VDS_PARTITION_STYLE) -> windows_result::Result<()>;
    fn SetFlags(&self, ulflags: u32) -> windows_result::Result<()>;
    fn ClearFlags(&self, ulflags: u32) -> windows_result::Result<()>;
}
impl IVdsDisk_Vtbl {
...
impl IVdsDisk2 {
    pub unsafe fn SetSANMode(&self, benable: bool) -> windows_result::Result<()> {
...
pub trait IVdsDisk2_Impl: windows_core::IUnknownImpl {
    fn SetSANMode(&self, benable: windows_core::BOOL) -> windows_result::Result<()>;
}
impl IVdsDisk2_Vtbl {
...
impl IVdsDisk3 {
    pub unsafe fn GetProperties2(&self, pdiskproperties: *mut VDS_DISK_PROP2) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProperties2)(windows_core::Interface::as_raw(self), pdiskproperties as _).ok() }
    }
    pub unsafe fn QueryFreeExtents(&self, ulalign: u32, ppfreeextentarray: *mut *mut VDS_DISK_FREE_EXTENT, plnumberoffreeextents: *mut i32) -> windows_result::Result<()> {
...
pub trait IVdsDisk3_Impl: windows_core::IUnknownImpl {
    fn GetProperties2(&self, pdiskproperties: *mut VDS_DISK_PROP2) -> windows_result::Result<()>;
    fn QueryFreeExtents(&self, ulalign: u32, ppfreeextentarray: *mut *mut VDS_DISK_FREE_EXTENT, plnumberoffreeextents: *mut i32) -> windows_result::Result<()>;
}
impl IVdsDisk3_Vtbl {
...
impl IVdsDiskOnline {
    pub unsafe fn Online(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Online)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Offline(&self) -> windows_result::Result<()> {
...
pub trait IVdsDiskOnline_Impl: windows_core::IUnknownImpl {
    fn Online(&self) -> windows_result::Result<()>;
    fn Offline(&self) -> windows_result::Result<()>;
}
...
impl IVdsDiskPartitionMF {
    pub unsafe fn GetPartitionFileSystemProperties(&self, ulloffset: u64, pfilesystemprop: *mut VDS_FILE_SYSTEM_PROP) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetPartitionFileSystemTypeName(&self, ulloffset: u64) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn QueryPartitionFileSystemFormatSupport(&self, ulloffset: u64, ppfilesystemsupportprops: *mut *mut VDS_FILE_SYSTEM_FORMAT_SUPPORT_PROP, plnumberoffilesystems: *mut i32) -> windows_result::Result<()> {
    ...
    pub unsafe fn FormatPartitionEx<P1, P4>(&self, ulloffset: u64, pwszfilesystemtypename: P1, usfilesystemrevision: u16, uldesiredunitallocationsize: u32, pwszlabel: P4, bforce: bool, bquickformat: bool, benablecompression: bool) -> windows_result::Result<IVdsAsync>
    where
...
pub trait IVdsDiskPartitionMF_Impl: windows_core::IUnknownImpl {
    fn GetPartitionFileSystemProperties(&self, ulloffset: u64, pfilesystemprop: *mut VDS_FILE_SYSTEM_PROP) -> windows_result::Result<()>;
    fn GetPartitionFileSystemTypeName(&self, ulloffset: u64) -> windows_result::Result<windows_core::PWSTR>;
    fn QueryPartitionFileSystemFormatSupport(&self, ulloffset: u64, ppfilesystemsupportprops: *mut *mut VDS_FILE_SYSTEM_FORMAT_SUPPORT_PROP, plnumberoffilesystems: *mut i32) -> windows_result::Result<()>;
    fn FormatPartitionEx(&self, ulloffset: u64, pwszfilesystemtypename: &windows_core::PCWSTR, usfilesystemrevision: u16, uldesiredunitallocationsize: u32, pwszlabel: &windows_core::PCWSTR, bforce: windows_core::BOOL, bquickformat: windows_core::BOOL, benablecompression: windows_core::BOOL) -> windows_result::Result<IVdsAsync>;
}
...
impl IVdsDiskPartitionMF2 {
    pub unsafe fn FormatPartitionEx2<P1, P4>(&self, ulloffset: u64, pwszfilesystemtypename: P1, usfilesystemrevision: u16, uldesiredunitallocationsize: u32, pwszlabel: P4, options: u32) -> windows_result::Result<IVdsAsync>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
        P4: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IVdsDiskPartitionMF2_Impl: windows_core::IUnknownImpl {
    fn FormatPartitionEx2(&self, ulloffset: u64, pwszfilesystemtypename: &windows_core::PCWSTR, usfilesystemrevision: u16, uldesiredunitallocationsize: u32, pwszlabel: &windows_core::PCWSTR, options: u32) -> windows_result::Result<IVdsAsync>;
}
...
impl IVdsDrive {
    pub unsafe fn GetProperties(&self, pdriveprop: *mut VDS_DRIVE_PROP) -> windows_result::Result<()> {
    ...
    pub unsafe fn QueryExtents(&self, ppextentarray: *mut *mut VDS_DRIVE_EXTENT, plnumberofextents: *mut i32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).QueryExtents)(windows_core::Interface::as_raw(self), ppextentarray as _, plnumberofextents as _).ok() }
    }
    pub unsafe fn SetFlags(&self, ulflags: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetFlags)(windows_core::Interface::as_raw(self), ulflags).ok() }
    ...
    pub unsafe fn SetStatus(&self, status: VDS_DRIVE_STATUS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetStatus)(windows_core::Interface::as_raw(self), status).ok() }
    }
}
#[repr(C)]
...
pub trait IVdsDrive_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, pdriveprop: *mut VDS_DRIVE_PROP) -> windows_result::Result<()>;
    fn GetSubSystem(&self) -> windows_result::Result<IVdsSubSystem>;
    fn QueryExtents(&self, ppextentarray: *mut *mut VDS_DRIVE_EXTENT, plnumberofextents: *mut i32) -> windows_result::Result<()>;
    fn SetFlags(&self, ulflags: u32) -> windows_result::Result<()>;
    fn ClearFlags(&self, ulflags: u32) -> windows_result::Result<()>;
    fn SetStatus(&self, status: VDS_DRIVE_STATUS) -> windows_result::Result<()>;
}
impl IVdsDrive_Vtbl {
...
impl IVdsDrive2 {
    pub unsafe fn GetProperties2(&self, pdriveprop2: *mut VDS_DRIVE_PROP2) -> windows_result::Result<()> {
...
pub trait IVdsDrive2_Impl: windows_core::IUnknownImpl {
    fn GetProperties2(&self, pdriveprop2: *mut VDS_DRIVE_PROP2) -> windows_result::Result<()>;
}
...
impl IVdsHbaPort {
    pub unsafe fn GetProperties(&self, phbaportprop: *mut VDS_HBAPORT_PROP) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProperties)(windows_core::Interface::as_raw(self), phbaportprop as _).ok() }
    }
    pub unsafe fn SetAllPathStatuses(&self, status: VDS_PATH_STATUS) -> windows_result::Result<()> {
...
pub trait IVdsHbaPort_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, phbaportprop: *mut VDS_HBAPORT_PROP) -> windows_result::Result<()>;
    fn SetAllPathStatuses(&self, status: VDS_PATH_STATUS) -> windows_result::Result<()>;
}
...
impl IVdsHwProvider {
    pub unsafe fn QuerySubSystems(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Reenumerate(&self) -> windows_result::Result<()> {
...
pub trait IVdsHwProvider_Impl: windows_core::IUnknownImpl {
    fn QuerySubSystems(&self) -> windows_result::Result<IEnumVdsObject>;
    fn Reenumerate(&self) -> windows_result::Result<()>;
...
impl IVdsHwProviderPrivate {
    pub unsafe fn QueryIfCreatedLun<P0>(&self, pwszdevicepath: P0, pvdsluninformation: *const VDS_LUN_INFORMATION) -> windows_result::Result<windows_core::GUID>
    where
...
pub trait IVdsHwProviderPrivate_Impl: windows_core::IUnknownImpl {
    fn QueryIfCreatedLun(&self, pwszdevicepath: &windows_core::PCWSTR, pvdsluninformation: *const VDS_LUN_INFORMATION) -> windows_result::Result<windows_core::GUID>;
}
...
impl IVdsHwProviderPrivateMpio {
    pub unsafe fn SetAllPathStatusesFromHbaPort(&self, hbaportprop: VDS_HBAPORT_PROP, status: VDS_PATH_STATUS) -> windows_result::Result<()> {
...
pub trait IVdsHwProviderPrivateMpio_Impl: windows_core::IUnknownImpl {
    fn SetAllPathStatusesFromHbaPort(&self, hbaportprop: &VDS_HBAPORT_PROP, status: VDS_PATH_STATUS) -> windows_result::Result<()>;
}
...
impl IVdsHwProviderStoragePools {
    pub unsafe fn QueryStoragePools(&self, ulflags: u32, ullremainingfreespace: u64, ppoolattributes: *const VDS_POOL_ATTRIBUTES) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateLunInStoragePool<P3>(&self, r#type: VDS_LUN_TYPE, ullsizeinbytes: u64, storagepoolid: windows_core::GUID, pwszunmaskinglist: P3, phints2: *const VDS_HINTS2) -> windows_result::Result<IVdsAsync>
    where
    ...
    pub unsafe fn QueryMaxLunCreateSizeInStoragePool(&self, r#type: VDS_LUN_TYPE, storagepoolid: windows_core::GUID, phints2: *const VDS_HINTS2) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsHwProviderStoragePools_Impl: windows_core::IUnknownImpl {
    fn QueryStoragePools(&self, ulflags: u32, ullremainingfreespace: u64, ppoolattributes: *const VDS_POOL_ATTRIBUTES) -> windows_result::Result<IEnumVdsObject>;
    fn CreateLunInStoragePool(&self, r#type: VDS_LUN_TYPE, ullsizeinbytes: u64, storagepoolid: &windows_core::GUID, pwszunmaskinglist: &windows_core::PCWSTR, phints2: *const VDS_HINTS2) -> windows_result::Result<IVdsAsync>;
    fn QueryMaxLunCreateSizeInStoragePool(&self, r#type: VDS_LUN_TYPE, storagepoolid: &windows_core::GUID, phints2: *const VDS_HINTS2) -> windows_result::Result<u64>;
}
...
impl IVdsHwProviderType {
    pub unsafe fn GetProviderType(&self) -> windows_result::Result<VDS_HWPROVIDER_TYPE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsHwProviderType_Impl: windows_core::IUnknownImpl {
    fn GetProviderType(&self) -> windows_result::Result<VDS_HWPROVIDER_TYPE>;
}
...
impl IVdsHwProviderType2 {
    pub unsafe fn GetProviderType2(&self) -> windows_result::Result<VDS_HWPROVIDER_TYPE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsHwProviderType2_Impl: windows_core::IUnknownImpl {
    fn GetProviderType2(&self) -> windows_result::Result<VDS_HWPROVIDER_TYPE>;
}
...
impl IVdsIscsiInitiatorAdapter {
    pub unsafe fn GetProperties(&self, pinitiatoradapterprop: *mut VDS_ISCSI_INITIATOR_ADAPTER_PROP) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProperties)(windows_core::Interface::as_raw(self), pinitiatoradapterprop as _).ok() }
    }
    pub unsafe fn QueryInitiatorPortals(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn LoginToTarget(&self, logintype: VDS_ISCSI_LOGIN_TYPE, targetid: windows_core::GUID, targetportalid: windows_core::GUID, initiatorportalid: windows_core::GUID, ulloginflags: u32, bheaderdigest: bool, bdatadigest: bool, authtype: VDS_ISCSI_AUTH_TYPE) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn LogoutFromTarget(&self, targetid: windows_core::GUID) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsIscsiInitiatorAdapter_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, pinitiatoradapterprop: *mut VDS_ISCSI_INITIATOR_ADAPTER_PROP) -> windows_result::Result<()>;
    fn QueryInitiatorPortals(&self) -> windows_result::Result<IEnumVdsObject>;
    fn LoginToTarget(&self, logintype: VDS_ISCSI_LOGIN_TYPE, targetid: &windows_core::GUID, targetportalid: &windows_core::GUID, initiatorportalid: &windows_core::GUID, ulloginflags: u32, bheaderdigest: windows_core::BOOL, bdatadigest: windows_core::BOOL, authtype: VDS_ISCSI_AUTH_TYPE) -> windows_result::Result<IVdsAsync>;
    fn LogoutFromTarget(&self, targetid: &windows_core::GUID) -> windows_result::Result<IVdsAsync>;
}
...
impl IVdsIscsiInitiatorPortal {
    pub unsafe fn GetProperties(&self, pinitiatorportalprop: *mut VDS_ISCSI_INITIATOR_PORTAL_PROP) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProperties)(windows_core::Interface::as_raw(self), pinitiatorportalprop as _).ok() }
    }
    pub unsafe fn GetInitiatorAdapter(&self) -> windows_result::Result<IVdsIscsiInitiatorAdapter> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetIpsecTunnelAddress(&self, ptunneladdress: *const VDS_IPADDRESS, pdestinationaddress: *const VDS_IPADDRESS) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetIpsecSecurity(&self, targetportalid: windows_core::GUID) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetIpsecSecurity(&self, targetportalid: windows_core::GUID, ullsecurityflags: u64, pipseckey: *const VDS_ISCSI_IPSEC_KEY) -> windows_result::Result<()> {
...
pub trait IVdsIscsiInitiatorPortal_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, pinitiatorportalprop: *mut VDS_ISCSI_INITIATOR_PORTAL_PROP) -> windows_result::Result<()>;
    fn GetInitiatorAdapter(&self) -> windows_result::Result<IVdsIscsiInitiatorAdapter>;
    fn SetIpsecTunnelAddress(&self, ptunneladdress: *const VDS_IPADDRESS, pdestinationaddress: *const VDS_IPADDRESS) -> windows_result::Result<()>;
    fn GetIpsecSecurity(&self, targetportalid: &windows_core::GUID) -> windows_result::Result<u64>;
    fn SetIpsecSecurity(&self, targetportalid: &windows_core::GUID, ullsecurityflags: u64, pipseckey: *const VDS_ISCSI_IPSEC_KEY) -> windows_result::Result<()>;
}
...
impl IVdsIscsiPortal {
    pub unsafe fn GetProperties(&self, pportalprop: *mut VDS_ISCSI_PORTAL_PROP) -> windows_result::Result<()> {
    ...
    pub unsafe fn QueryAssociatedPortalGroups(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetStatus(&self, status: VDS_ISCSI_PORTAL_STATUS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetStatus)(windows_core::Interface::as_raw(self), status).ok() }
    }
    pub unsafe fn SetIpsecTunnelAddress(&self, ptunneladdress: *const VDS_IPADDRESS, pdestinationaddress: *const VDS_IPADDRESS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetIpsecTunnelAddress)(windows_core::Interface::as_raw(self), ptunneladdress, pdestinationaddress).ok() }
    }
    pub unsafe fn GetIpsecSecurity(&self, pinitiatorportaladdress: *const VDS_IPADDRESS) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetIpsecSecurity(&self, pinitiatorportaladdress: *const VDS_IPADDRESS, ullsecurityflags: u64, pipseckey: *const VDS_ISCSI_IPSEC_KEY) -> windows_result::Result<()> {
...
pub trait IVdsIscsiPortal_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, pportalprop: *mut VDS_ISCSI_PORTAL_PROP) -> windows_result::Result<()>;
    fn GetSubSystem(&self) -> windows_result::Result<IVdsSubSystem>;
    fn QueryAssociatedPortalGroups(&self) -> windows_result::Result<IEnumVdsObject>;
    fn SetStatus(&self, status: VDS_ISCSI_PORTAL_STATUS) -> windows_result::Result<()>;
    fn SetIpsecTunnelAddress(&self, ptunneladdress: *const VDS_IPADDRESS, pdestinationaddress: *const VDS_IPADDRESS) -> windows_result::Result<()>;
    fn GetIpsecSecurity(&self, pinitiatorportaladdress: *const VDS_IPADDRESS) -> windows_result::Result<u64>;
    fn SetIpsecSecurity(&self, pinitiatorportaladdress: *const VDS_IPADDRESS, ullsecurityflags: u64, pipseckey: *const VDS_ISCSI_IPSEC_KEY) -> windows_result::Result<()>;
}
...
impl IVdsIscsiPortalGroup {
    pub unsafe fn GetProperties(&self, pportalgroupprop: *mut VDS_ISCSI_PORTALGROUP_PROP) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProperties)(windows_core::Interface::as_raw(self), pportalgroupprop as _).ok() }
    }
    pub unsafe fn GetTarget(&self) -> windows_result::Result<IVdsIscsiTarget> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn QueryAssociatedPortals(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AddPortal(&self, portalid: windows_core::GUID) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RemovePortal(&self, portalid: windows_core::GUID) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Delete(&self) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsIscsiPortalGroup_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, pportalgroupprop: *mut VDS_ISCSI_PORTALGROUP_PROP) -> windows_result::Result<()>;
    fn GetTarget(&self) -> windows_result::Result<IVdsIscsiTarget>;
    fn QueryAssociatedPortals(&self) -> windows_result::Result<IEnumVdsObject>;
    fn AddPortal(&self, portalid: &windows_core::GUID) -> windows_result::Result<IVdsAsync>;
    fn RemovePortal(&self, portalid: &windows_core::GUID) -> windows_result::Result<IVdsAsync>;
    fn Delete(&self) -> windows_result::Result<IVdsAsync>;
}
...
impl IVdsIscsiPortalLocal {
    pub unsafe fn SetIpsecSecurityLocal(&self, ullsecurityflags: u64, pipseckey: *const VDS_ISCSI_IPSEC_KEY) -> windows_result::Result<()> {
...
pub trait IVdsIscsiPortalLocal_Impl: windows_core::IUnknownImpl {
    fn SetIpsecSecurityLocal(&self, ullsecurityflags: u64, pipseckey: *const VDS_ISCSI_IPSEC_KEY) -> windows_result::Result<()>;
}
...
impl IVdsIscsiTarget {
    pub unsafe fn GetProperties(&self, ptargetprop: *mut VDS_ISCSI_TARGET_PROP) -> windows_result::Result<()> {
    ...
    pub unsafe fn QueryPortalGroups(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreatePortalGroup(&self) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetFriendlyName<P0>(&self, pwszfriendlyname: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetSharedSecret<P1>(&self, ptargetsharedsecret: *const VDS_ISCSI_SHARED_SECRET, pwszinitiatorname: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn RememberInitiatorSharedSecret<P0>(&self, pwszinitiatorname: P0, pinitiatorsharedsecret: *const VDS_ISCSI_SHARED_SECRET) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetConnectedInitiators(&self, pppwszinitiatorlist: *mut *mut windows_core::PWSTR, plnumberofinitiators: *mut i32) -> windows_result::Result<()> {
...
pub trait IVdsIscsiTarget_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, ptargetprop: *mut VDS_ISCSI_TARGET_PROP) -> windows_result::Result<()>;
    fn GetSubSystem(&self) -> windows_result::Result<IVdsSubSystem>;
    fn QueryPortalGroups(&self) -> windows_result::Result<IEnumVdsObject>;
    fn QueryAssociatedLuns(&self) -> windows_result::Result<IEnumVdsObject>;
    fn CreatePortalGroup(&self) -> windows_result::Result<IVdsAsync>;
    fn Delete(&self) -> windows_result::Result<IVdsAsync>;
    fn SetFriendlyName(&self, pwszfriendlyname: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn SetSharedSecret(&self, ptargetsharedsecret: *const VDS_ISCSI_SHARED_SECRET, pwszinitiatorname: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn RememberInitiatorSharedSecret(&self, pwszinitiatorname: &windows_core::PCWSTR, pinitiatorsharedsecret: *const VDS_ISCSI_SHARED_SECRET) -> windows_result::Result<()>;
    fn GetConnectedInitiators(&self, pppwszinitiatorlist: *mut *mut windows_core::PWSTR, plnumberofinitiators: *mut i32) -> windows_result::Result<()>;
}
...
impl IVdsLun {
    pub unsafe fn GetProperties(&self, plunprop: *mut VDS_LUN_PROP) -> windows_result::Result<()> {
    ...
    pub unsafe fn QueryActiveControllers(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Extend(&self, ullnumberofbytestoadd: u64, pdriveidarray: &[windows_core::GUID]) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Shrink(&self, ullnumberofbytestoremove: u64) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn QueryPlexes(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AddPlex(&self, lunid: windows_core::GUID) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RemovePlex(&self, plexid: windows_core::GUID) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Recover(&self) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetMask<P0>(&self, pwszunmaskinglist: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn AssociateControllers(&self, pactivecontrolleridarray: &[windows_core::GUID], pinactivecontrolleridarray: &[windows_core::GUID]) -> windows_result::Result<()> {
    ...
    pub unsafe fn QueryHints(&self, phints: *mut VDS_HINTS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).QueryHints)(windows_core::Interface::as_raw(self), phints as _).ok() }
    }
    pub unsafe fn ApplyHints(&self, phints: *const VDS_HINTS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ApplyHints)(windows_core::Interface::as_raw(self), phints).ok() }
    }
    pub unsafe fn SetStatus(&self, status: VDS_LUN_STATUS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetStatus)(windows_core::Interface::as_raw(self), status).ok() }
    }
    pub unsafe fn QueryMaxLunExtendSize(&self, pdriveidarray: &[windows_core::GUID]) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsLun_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, plunprop: *mut VDS_LUN_PROP) -> windows_result::Result<()>;
    fn GetSubSystem(&self) -> windows_result::Result<IVdsSubSystem>;
    fn GetIdentificationData(&self, pluninfo: *mut VDS_LUN_INFORMATION) -> windows_result::Result<()>;
    fn QueryActiveControllers(&self) -> windows_result::Result<IEnumVdsObject>;
    fn Extend(&self, ullnumberofbytestoadd: u64, pdriveidarray: *const windows_core::GUID, lnumberofdrives: i32) -> windows_result::Result<IVdsAsync>;
    fn Shrink(&self, ullnumberofbytestoremove: u64) -> windows_result::Result<IVdsAsync>;
    fn QueryPlexes(&self) -> windows_result::Result<IEnumVdsObject>;
    fn AddPlex(&self, lunid: &windows_core::GUID) -> windows_result::Result<IVdsAsync>;
    fn RemovePlex(&self, plexid: &windows_core::GUID) -> windows_result::Result<IVdsAsync>;
    fn Recover(&self) -> windows_result::Result<IVdsAsync>;
    fn SetMask(&self, pwszunmaskinglist: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn Delete(&self) -> windows_result::Result<()>;
    fn AssociateControllers(&self, pactivecontrolleridarray: *const windows_core::GUID, lnumberofactivecontrollers: i32, pinactivecontrolleridarray: *const windows_core::GUID, lnumberofinactivecontrollers: i32) -> windows_result::Result<()>;
    fn QueryHints(&self, phints: *mut VDS_HINTS) -> windows_result::Result<()>;
    fn ApplyHints(&self, phints: *const VDS_HINTS) -> windows_result::Result<()>;
    fn SetStatus(&self, status: VDS_LUN_STATUS) -> windows_result::Result<()>;
    fn QueryMaxLunExtendSize(&self, pdriveidarray: *const windows_core::GUID, lnumberofdrives: i32) -> windows_result::Result<u64>;
}
impl IVdsLun_Vtbl {
...
impl IVdsLun2 {
    pub unsafe fn QueryHints2(&self, phints2: *mut VDS_HINTS2) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).QueryHints2)(windows_core::Interface::as_raw(self), phints2 as _).ok() }
    }
    pub unsafe fn ApplyHints2(&self, phints2: *const VDS_HINTS2) -> windows_result::Result<()> {
...
pub trait IVdsLun2_Impl: windows_core::IUnknownImpl {
    fn QueryHints2(&self, phints2: *mut VDS_HINTS2) -> windows_result::Result<()>;
    fn ApplyHints2(&self, phints2: *const VDS_HINTS2) -> windows_result::Result<()>;
}
impl IVdsLun2_Vtbl {
...
impl IVdsLunControllerPorts {
    pub unsafe fn AssociateControllerPorts(&self, pactivecontrollerportidarray: &[windows_core::GUID], pinactivecontrollerportidarray: &[windows_core::GUID]) -> windows_result::Result<()> {
    ...
    pub unsafe fn QueryActiveControllerPorts(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsLunControllerPorts_Impl: windows_core::IUnknownImpl {
    fn AssociateControllerPorts(&self, pactivecontrollerportidarray: *const windows_core::GUID, lnumberofactivecontrollerports: i32, pinactivecontrollerportidarray: *const windows_core::GUID, lnumberofinactivecontrollerports: i32) -> windows_result::Result<()>;
    fn QueryActiveControllerPorts(&self) -> windows_result::Result<IEnumVdsObject>;
}
...
impl IVdsLunIscsi {
    pub unsafe fn AssociateTargets(&self, ptargetidarray: &[windows_core::GUID]) -> windows_result::Result<()> {
    ...
    pub unsafe fn QueryAssociatedTargets(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsLunIscsi_Impl: windows_core::IUnknownImpl {
    fn AssociateTargets(&self, ptargetidarray: *const windows_core::GUID, lnumberoftargets: i32) -> windows_result::Result<()>;
    fn QueryAssociatedTargets(&self) -> windows_result::Result<IEnumVdsObject>;
}
...
impl IVdsLunMpio {
    pub unsafe fn GetPathInfo(&self, pppaths: *mut *mut VDS_PATH_INFO, plnumberofpaths: *mut i32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetLoadBalancePolicy(&self, ppolicy: *mut VDS_LOADBALANCE_POLICY_ENUM, pppaths: *mut *mut VDS_PATH_POLICY, plnumberofpaths: *mut i32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetLoadBalancePolicy(&self, policy: VDS_LOADBALANCE_POLICY_ENUM, ppaths: &[VDS_PATH_POLICY]) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetSupportedLbPolicies(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsLunMpio_Impl: windows_core::IUnknownImpl {
    fn GetPathInfo(&self, pppaths: *mut *mut VDS_PATH_INFO, plnumberofpaths: *mut i32) -> windows_result::Result<()>;
    fn GetLoadBalancePolicy(&self, ppolicy: *mut VDS_LOADBALANCE_POLICY_ENUM, pppaths: *mut *mut VDS_PATH_POLICY, plnumberofpaths: *mut i32) -> windows_result::Result<()>;
    fn SetLoadBalancePolicy(&self, policy: VDS_LOADBALANCE_POLICY_ENUM, ppaths: *const VDS_PATH_POLICY, lnumberofpaths: i32) -> windows_result::Result<()>;
    fn GetSupportedLbPolicies(&self) -> windows_result::Result<u32>;
}
...
impl IVdsLunNumber {
    pub unsafe fn GetLunNumber(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsLunNumber_Impl: windows_core::IUnknownImpl {
    fn GetLunNumber(&self) -> windows_result::Result<u32>;
}
...
impl IVdsLunPlex {
    pub unsafe fn GetProperties(&self, pplexprop: *mut VDS_LUN_PLEX_PROP) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProperties)(windows_core::Interface::as_raw(self), pplexprop as _).ok() }
    }
    pub unsafe fn GetLun(&self) -> windows_result::Result<IVdsLun> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsLunPlex_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, pplexprop: *mut VDS_LUN_PLEX_PROP) -> windows_result::Result<()>;
    fn GetLun(&self) -> windows_result::Result<IVdsLun>;
    fn QueryExtents(&self, ppextentarray: *mut *mut VDS_DRIVE_EXTENT, plnumberofextents: *mut i32) -> windows_result::Result<()>;
    fn QueryHints(&self, phints: *mut VDS_HINTS) -> windows_result::Result<()>;
    fn ApplyHints(&self, phints: *const VDS_HINTS) -> windows_result::Result<()>;
}
...
impl IVdsMaintenance {
    pub unsafe fn StartMaintenance(&self, operation: VDS_MAINTENANCE_OPERATION) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).StartMaintenance)(windows_core::Interface::as_raw(self), operation).ok() }
    }
    pub unsafe fn StopMaintenance(&self, operation: VDS_MAINTENANCE_OPERATION) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).StopMaintenance)(windows_core::Interface::as_raw(self), operation).ok() }
    }
    pub unsafe fn PulseMaintenance(&self, operation: VDS_MAINTENANCE_OPERATION, ulcount: u32) -> windows_result::Result<()> {
...
pub trait IVdsMaintenance_Impl: windows_core::IUnknownImpl {
    fn StartMaintenance(&self, operation: VDS_MAINTENANCE_OPERATION) -> windows_result::Result<()>;
    fn StopMaintenance(&self, operation: VDS_MAINTENANCE_OPERATION) -> windows_result::Result<()>;
    fn PulseMaintenance(&self, operation: VDS_MAINTENANCE_OPERATION, ulcount: u32) -> windows_result::Result<()>;
}
...
impl IVdsOpenVDisk {
    ...
    pub unsafe fn Attach<P0>(&self, pstringsecuritydescriptor: P0, flags: super::Vhd::ATTACH_VIRTUAL_DISK_FLAG, providerspecificflags: u32, timeoutinms: u32) -> windows_result::Result<IVdsAsync>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    #[cfg(feature = "Win32_Storage_Vhd")]
    pub unsafe fn Detach(&self, flags: super::Vhd::DETACH_VIRTUAL_DISK_FLAG, providerspecificflags: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Detach)(windows_core::Interface::as_raw(self), flags, providerspecificflags).ok() }
    }
    #[cfg(feature = "Win32_Storage_Vhd")]
    pub unsafe fn DetachAndDelete(&self, flags: super::Vhd::DETACH_VIRTUAL_DISK_FLAG, providerspecificflags: u32) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_Storage_Vhd")]
    pub unsafe fn Compact(&self, flags: super::Vhd::COMPACT_VIRTUAL_DISK_FLAG, reserved: u32) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_Storage_Vhd")]
    pub unsafe fn Merge(&self, flags: super::Vhd::MERGE_VIRTUAL_DISK_FLAG, mergedepth: u32) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_Storage_Vhd")]
    pub unsafe fn Expand(&self, flags: super::Vhd::EXPAND_VIRTUAL_DISK_FLAG, newsize: u64) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsOpenVDisk_Impl: windows_core::IUnknownImpl {
    fn Attach(&self, pstringsecuritydescriptor: &windows_core::PCWSTR, flags: super::Vhd::ATTACH_VIRTUAL_DISK_FLAG, providerspecificflags: u32, timeoutinms: u32) -> windows_result::Result<IVdsAsync>;
    fn Detach(&self, flags: super::Vhd::DETACH_VIRTUAL_DISK_FLAG, providerspecificflags: u32) -> windows_result::Result<()>;
    fn DetachAndDelete(&self, flags: super::Vhd::DETACH_VIRTUAL_DISK_FLAG, providerspecificflags: u32) -> windows_result::Result<()>;
    fn Compact(&self, flags: super::Vhd::COMPACT_VIRTUAL_DISK_FLAG, reserved: u32) -> windows_result::Result<IVdsAsync>;
    fn Merge(&self, flags: super::Vhd::MERGE_VIRTUAL_DISK_FLAG, mergedepth: u32) -> windows_result::Result<IVdsAsync>;
    fn Expand(&self, flags: super::Vhd::EXPAND_VIRTUAL_DISK_FLAG, newsize: u64) -> windows_result::Result<IVdsAsync>;
}
#[cfg(feature = "Win32_Storage_Vhd")]
...
impl IVdsPack {
    pub unsafe fn GetProperties(&self, ppackprop: *mut VDS_PACK_PROP) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProperties)(windows_core::Interface::as_raw(self), ppackprop as _).ok() }
    }
    pub unsafe fn GetProvider(&self) -> windows_result::Result<IVdsProvider> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn QueryVolumes(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn QueryDisks(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateVolume(&self, r#type: VDS_VOLUME_TYPE, pinputdiskarray: &[VDS_INPUT_DISK], ulstripesize: u32) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AddDisk(&self, diskid: windows_core::GUID, partitionstyle: VDS_PARTITION_STYLE, bashotspare: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn MigrateDisks(&self, pdiskarray: *const windows_core::GUID, lnumberofdisks: i32, targetpack: windows_core::GUID, bforce: bool, bqueryonly: bool, presults: *mut windows_core::HRESULT, pbrebootneeded: *mut windows_core::BOOL) -> windows_result::Result<()> {
    ...
    pub unsafe fn ReplaceDisk(&self, olddiskid: windows_core::GUID, newdiskid: windows_core::GUID) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RemoveMissingDisk(&self, diskid: windows_core::GUID) -> windows_result::Result<()> {
...
pub trait IVdsPack_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, ppackprop: *mut VDS_PACK_PROP) -> windows_result::Result<()>;
    fn GetProvider(&self) -> windows_result::Result<IVdsProvider>;
    fn QueryVolumes(&self) -> windows_result::Result<IEnumVdsObject>;
    fn QueryDisks(&self) -> windows_result::Result<IEnumVdsObject>;
    fn CreateVolume(&self, r#type: VDS_VOLUME_TYPE, pinputdiskarray: *const VDS_INPUT_DISK, lnumberofdisks: i32, ulstripesize: u32) -> windows_result::Result<IVdsAsync>;
    fn AddDisk(&self, diskid: &windows_core::GUID, partitionstyle: VDS_PARTITION_STYLE, bashotspare: windows_core::BOOL) -> windows_result::Result<()>;
    fn MigrateDisks(&self, pdiskarray: *const windows_core::GUID, lnumberofdisks: i32, targetpack: &windows_core::GUID, bforce: windows_core::BOOL, bqueryonly: windows_core::BOOL, presults: *mut windows_core::HRESULT, pbrebootneeded: *mut windows_core::BOOL) -> windows_result::Result<()>;
    fn ReplaceDisk(&self, olddiskid: &windows_core::GUID, newdiskid: &windows_core::GUID) -> windows_result::Result<IVdsAsync>;
    fn RemoveMissingDisk(&self, diskid: &windows_core::GUID) -> windows_result::Result<()>;
    fn Recover(&self) -> windows_result::Result<IVdsAsync>;
}
impl IVdsPack_Vtbl {
...
impl IVdsPack2 {
    pub unsafe fn CreateVolume2(&self, r#type: VDS_VOLUME_TYPE, pinputdiskarray: &[VDS_INPUT_DISK], ulstripesize: u32, ulalign: u32) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsPack2_Impl: windows_core::IUnknownImpl {
    fn CreateVolume2(&self, r#type: VDS_VOLUME_TYPE, pinputdiskarray: *const VDS_INPUT_DISK, lnumberofdisks: i32, ulstripesize: u32, ulalign: u32) -> windows_result::Result<IVdsAsync>;
}
impl IVdsPack2_Vtbl {
...
impl IVdsProvider {
    pub unsafe fn GetProperties(&self, pproviderprop: *mut VDS_PROVIDER_PROP) -> windows_result::Result<()> {
...
pub trait IVdsProvider_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, pproviderprop: *mut VDS_PROVIDER_PROP) -> windows_result::Result<()>;
}
...
impl IVdsProviderPrivate {
    pub unsafe fn GetObject(&self, objectid: windows_core::GUID, r#type: VDS_OBJECT_TYPE) -> windows_result::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn OnLoad<P0, P1>(&self, pwszmachinename: P0, pcallbackobject: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn OnUnload(&self, bforceunload: bool) -> windows_result::Result<()> {
...
pub trait IVdsProviderPrivate_Impl: windows_core::IUnknownImpl {
    fn GetObject(&self, objectid: &windows_core::GUID, r#type: VDS_OBJECT_TYPE) -> windows_result::Result<windows_core::IUnknown>;
    fn OnLoad(&self, pwszmachinename: &windows_core::PCWSTR, pcallbackobject: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn OnUnload(&self, bforceunload: windows_core::BOOL) -> windows_result::Result<()>;
}
...
impl IVdsProviderSupport {
    pub unsafe fn GetVersionSupport(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsProviderSupport_Impl: windows_core::IUnknownImpl {
    fn GetVersionSupport(&self) -> windows_result::Result<u32>;
}
...
impl IVdsRemovable {
    pub unsafe fn QueryMedia(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).QueryMedia)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Eject(&self) -> windows_result::Result<()> {
...
pub trait IVdsRemovable_Impl: windows_core::IUnknownImpl {
    fn QueryMedia(&self) -> windows_result::Result<()>;
    fn Eject(&self) -> windows_result::Result<()>;
}
...
impl IVdsService {
    ...
    pub unsafe fn QueryMaskedDisks(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn QueryUnallocatedDisks(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn QueryDriveLetters(&self, wcfirstletter: u16, pdriveletterproparray: &mut [VDS_DRIVE_LETTER_PROP]) -> windows_result::Result<()> {
    ...
    pub unsafe fn QueryFileSystemTypes(&self, ppfilesystemtypeprops: *mut *mut VDS_FILE_SYSTEM_TYPE_PROP, plnumberoffilesystems: *mut i32) -> windows_result::Result<()> {
    ...
    pub unsafe fn CleanupObsoleteMountPoints(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).CleanupObsoleteMountPoints)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Advise<P0>(&self, psink: P0) -> windows_result::Result<u32>
    where
    ...
    pub unsafe fn Unadvise(&self, dwcookie: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Unadvise)(windows_core::Interface::as_raw(self), dwcookie).ok() }
    }
    pub unsafe fn Reboot(&self) -> windows_result::Result<()> {
...
pub trait IVdsService_Impl: windows_core::IUnknownImpl {
    fn IsServiceReady(&self) -> windows_result::Result<()>;
    fn WaitForServiceReady(&self) -> windows_result::Result<()>;
    fn GetProperties(&self) -> windows_result::Result<VDS_SERVICE_PROP>;
    fn QueryProviders(&self, masks: u32) -> windows_result::Result<IEnumVdsObject>;
    fn QueryMaskedDisks(&self) -> windows_result::Result<IEnumVdsObject>;
    fn QueryUnallocatedDisks(&self) -> windows_result::Result<IEnumVdsObject>;
    fn GetObject(&self, objectid: &windows_core::GUID, r#type: VDS_OBJECT_TYPE) -> windows_result::Result<windows_core::IUnknown>;
    fn QueryDriveLetters(&self, wcfirstletter: u16, count: u32, pdriveletterproparray: *mut VDS_DRIVE_LETTER_PROP) -> windows_result::Result<()>;
    fn QueryFileSystemTypes(&self, ppfilesystemtypeprops: *mut *mut VDS_FILE_SYSTEM_TYPE_PROP, plnumberoffilesystems: *mut i32) -> windows_result::Result<()>;
    fn Reenumerate(&self) -> windows_result::Result<()>;
    fn Refresh(&self) -> windows_result::Result<()>;
    fn CleanupObsoleteMountPoints(&self) -> windows_result::Result<()>;
    fn Advise(&self, psink: windows_core::Ref<IVdsAdviseSink>) -> windows_result::Result<u32>;
    fn Unadvise(&self, dwcookie: u32) -> windows_result::Result<()>;
    fn Reboot(&self) -> windows_result::Result<()>;
    fn SetFlags(&self, ulflags: u32) -> windows_result::Result<()>;
    fn ClearFlags(&self, ulflags: u32) -> windows_result::Result<()>;
}
...
impl IVdsServiceHba {
    pub unsafe fn QueryHbaPorts(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsServiceHba_Impl: windows_core::IUnknownImpl {
    fn QueryHbaPorts(&self) -> windows_result::Result<IEnumVdsObject>;
}
...
impl IVdsServiceInitialization {
    pub unsafe fn Initialize<P0>(&self, pwszmachinename: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IVdsServiceInitialization_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, pwszmachinename: &windows_core::PCWSTR) -> windows_result::Result<()>;
}
...
impl IVdsServiceIscsi {
    pub unsafe fn GetInitiatorName(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetInitiatorName)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn QueryInitiatorAdapters(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetIpsecGroupPresharedKey(&self, pipseckey: *const VDS_ISCSI_IPSEC_KEY) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetIpsecGroupPresharedKey)(windows_core::Interface::as_raw(self), pipseckey).ok() }
    }
    pub unsafe fn SetAllIpsecTunnelAddresses(&self, ptunneladdress: *const VDS_IPADDRESS, pdestinationaddress: *const VDS_IPADDRESS) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetAllIpsecSecurity(&self, targetportalid: windows_core::GUID, ullsecurityflags: u64, pipseckey: *const VDS_ISCSI_IPSEC_KEY) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetInitiatorSharedSecret(&self, pinitiatorsharedsecret: *const VDS_ISCSI_SHARED_SECRET, targetid: windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn RememberTargetSharedSecret(&self, targetid: windows_core::GUID, ptargetsharedsecret: *const VDS_ISCSI_SHARED_SECRET) -> windows_result::Result<()> {
...
pub trait IVdsServiceIscsi_Impl: windows_core::IUnknownImpl {
    fn GetInitiatorName(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn QueryInitiatorAdapters(&self) -> windows_result::Result<IEnumVdsObject>;
    fn SetIpsecGroupPresharedKey(&self, pipseckey: *const VDS_ISCSI_IPSEC_KEY) -> windows_result::Result<()>;
    fn SetAllIpsecTunnelAddresses(&self, ptunneladdress: *const VDS_IPADDRESS, pdestinationaddress: *const VDS_IPADDRESS) -> windows_result::Result<()>;
    fn SetAllIpsecSecurity(&self, targetportalid: &windows_core::GUID, ullsecurityflags: u64, pipseckey: *const VDS_ISCSI_IPSEC_KEY) -> windows_result::Result<()>;
    fn SetInitiatorSharedSecret(&self, pinitiatorsharedsecret: *const VDS_ISCSI_SHARED_SECRET, targetid: &windows_core::GUID) -> windows_result::Result<()>;
    fn RememberTargetSharedSecret(&self, targetid: &windows_core::GUID, ptargetsharedsecret: *const VDS_ISCSI_SHARED_SECRET) -> windows_result::Result<()>;
}
...
impl IVdsServiceLoader {
    pub unsafe fn LoadService<P0>(&self, pwszmachinename: P0) -> windows_result::Result<IVdsService>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
...
pub trait IVdsServiceLoader_Impl: windows_core::IUnknownImpl {
    fn LoadService(&self, pwszmachinename: &windows_core::PCWSTR) -> windows_result::Result<IVdsService>;
}
...
impl IVdsServiceSAN {
    pub unsafe fn GetSANPolicy(&self) -> windows_result::Result<VDS_SAN_POLICY> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSANPolicy)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetSANPolicy(&self, sanpolicy: VDS_SAN_POLICY) -> windows_result::Result<()> {
...
pub trait IVdsServiceSAN_Impl: windows_core::IUnknownImpl {
    fn GetSANPolicy(&self) -> windows_result::Result<VDS_SAN_POLICY>;
    fn SetSANPolicy(&self, sanpolicy: VDS_SAN_POLICY) -> windows_result::Result<()>;
}
...
impl IVdsServiceSw {
    pub unsafe fn GetDiskObject<P0>(&self, pwszdeviceid: P0) -> windows_result::Result<windows_core::IUnknown>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
...
pub trait IVdsServiceSw_Impl: windows_core::IUnknownImpl {
    fn GetDiskObject(&self, pwszdeviceid: &windows_core::PCWSTR) -> windows_result::Result<windows_core::IUnknown>;
}
...
impl IVdsServiceUninstallDisk {
    pub unsafe fn GetDiskIdFromLunInfo(&self, pluninfo: *const VDS_LUN_INFORMATION) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn UninstallDisks(&self, pdiskidarray: *const windows_core::GUID, ulcount: u32, bforce: bool, pbreboot: *mut u8, presults: *mut windows_core::HRESULT) -> windows_result::Result<()> {
...
pub trait IVdsServiceUninstallDisk_Impl: windows_core::IUnknownImpl {
    fn GetDiskIdFromLunInfo(&self, pluninfo: *const VDS_LUN_INFORMATION) -> windows_result::Result<windows_core::GUID>;
    fn UninstallDisks(&self, pdiskidarray: *const windows_core::GUID, ulcount: u32, bforce: bool, pbreboot: *mut u8, presults: *mut windows_core::HRESULT) -> windows_result::Result<()>;
}
...
impl IVdsStoragePool {
    ...
    pub unsafe fn GetProperties(&self, pstoragepoolprop: *mut VDS_STORAGE_POOL_PROP) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProperties)(windows_core::Interface::as_raw(self), pstoragepoolprop as _).ok() }
    }
    pub unsafe fn GetAttributes(&self, pstoragepoolattributes: *mut VDS_POOL_ATTRIBUTES) -> windows_result::Result<()> {
    ...
    pub unsafe fn QueryDriveExtents(&self, ppextentarray: *mut *mut VDS_STORAGE_POOL_DRIVE_EXTENT, plnumberofextents: *mut i32) -> windows_result::Result<()> {
    ...
    pub unsafe fn QueryAllocatedLuns(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn QueryAllocatedStoragePools(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsStoragePool_Impl: windows_core::IUnknownImpl {
    fn GetProvider(&self) -> windows_result::Result<IVdsProvider>;
    fn GetProperties(&self, pstoragepoolprop: *mut VDS_STORAGE_POOL_PROP) -> windows_result::Result<()>;
    fn GetAttributes(&self, pstoragepoolattributes: *mut VDS_POOL_ATTRIBUTES) -> windows_result::Result<()>;
    fn QueryDriveExtents(&self, ppextentarray: *mut *mut VDS_STORAGE_POOL_DRIVE_EXTENT, plnumberofextents: *mut i32) -> windows_result::Result<()>;
    fn QueryAllocatedLuns(&self) -> windows_result::Result<IEnumVdsObject>;
    fn QueryAllocatedStoragePools(&self) -> windows_result::Result<IEnumVdsObject>;
}
...
impl IVdsSubSystem {
    pub unsafe fn GetProperties(&self, psubsystemprop: *mut VDS_SUB_SYSTEM_PROP) -> windows_result::Result<()> {
    ...
    pub unsafe fn QueryControllers(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn QueryLuns(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn QueryDrives(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetDrive(&self, sbusnumber: i16, sslotnumber: i16) -> windows_result::Result<IVdsDrive> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetControllerStatus(&self, ponlinecontrolleridarray: &[windows_core::GUID], pofflinecontrolleridarray: &[windows_core::GUID]) -> windows_result::Result<()> {
    ...
    pub unsafe fn CreateLun<P4>(&self, r#type: VDS_LUN_TYPE, ullsizeinbytes: u64, pdriveidarray: &[windows_core::GUID], pwszunmaskinglist: P4, phints: *const VDS_HINTS) -> windows_result::Result<IVdsAsync>
    where
        P4: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn ReplaceDrive(&self, drivetobereplaced: windows_core::GUID, replacementdrive: windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetStatus(&self, status: VDS_SUB_SYSTEM_STATUS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetStatus)(windows_core::Interface::as_raw(self), status).ok() }
    }
    pub unsafe fn QueryMaxLunCreateSize(&self, r#type: VDS_LUN_TYPE, pdriveidarray: &[windows_core::GUID], phints: *const VDS_HINTS) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsSubSystem_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, psubsystemprop: *mut VDS_SUB_SYSTEM_PROP) -> windows_result::Result<()>;
    fn GetProvider(&self) -> windows_result::Result<IVdsProvider>;
    fn QueryControllers(&self) -> windows_result::Result<IEnumVdsObject>;
    fn QueryLuns(&self) -> windows_result::Result<IEnumVdsObject>;
    fn QueryDrives(&self) -> windows_result::Result<IEnumVdsObject>;
    fn GetDrive(&self, sbusnumber: i16, sslotnumber: i16) -> windows_result::Result<IVdsDrive>;
    fn Reenumerate(&self) -> windows_result::Result<()>;
    fn SetControllerStatus(&self, ponlinecontrolleridarray: *const windows_core::GUID, lnumberofonlinecontrollers: i32, pofflinecontrolleridarray: *const windows_core::GUID, lnumberofofflinecontrollers: i32) -> windows_result::Result<()>;
    fn CreateLun(&self, r#type: VDS_LUN_TYPE, ullsizeinbytes: u64, pdriveidarray: *const windows_core::GUID, lnumberofdrives: i32, pwszunmaskinglist: &windows_core::PCWSTR, phints: *const VDS_HINTS) -> windows_result::Result<IVdsAsync>;
    fn ReplaceDrive(&self, drivetobereplaced: &windows_core::GUID, replacementdrive: &windows_core::GUID) -> windows_result::Result<()>;
    fn SetStatus(&self, status: VDS_SUB_SYSTEM_STATUS) -> windows_result::Result<()>;
    fn QueryMaxLunCreateSize(&self, r#type: VDS_LUN_TYPE, pdriveidarray: *const windows_core::GUID, lnumberofdrives: i32, phints: *const VDS_HINTS) -> windows_result::Result<u64>;
}
...
impl IVdsSubSystem2 {
    pub unsafe fn GetProperties2(&self, psubsystemprop2: *mut VDS_SUB_SYSTEM_PROP2) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProperties2)(windows_core::Interface::as_raw(self), psubsystemprop2 as _).ok() }
    }
    pub unsafe fn GetDrive2(&self, sbusnumber: i16, sslotnumber: i16, ulenclosurenumber: u32) -> windows_result::Result<IVdsDrive> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateLun2<P4>(&self, r#type: VDS_LUN_TYPE, ullsizeinbytes: u64, pdriveidarray: &[windows_core::GUID], pwszunmaskinglist: P4, phints2: *const VDS_HINTS2) -> windows_result::Result<IVdsAsync>
    where
        P4: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn QueryMaxLunCreateSize2(&self, r#type: VDS_LUN_TYPE, pdriveidarray: &[windows_core::GUID], phints2: *const VDS_HINTS2) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsSubSystem2_Impl: windows_core::IUnknownImpl {
    fn GetProperties2(&self, psubsystemprop2: *mut VDS_SUB_SYSTEM_PROP2) -> windows_result::Result<()>;
    fn GetDrive2(&self, sbusnumber: i16, sslotnumber: i16, ulenclosurenumber: u32) -> windows_result::Result<IVdsDrive>;
    fn CreateLun2(&self, r#type: VDS_LUN_TYPE, ullsizeinbytes: u64, pdriveidarray: *const windows_core::GUID, lnumberofdrives: i32, pwszunmaskinglist: &windows_core::PCWSTR, phints2: *const VDS_HINTS2) -> windows_result::Result<IVdsAsync>;
    fn QueryMaxLunCreateSize2(&self, r#type: VDS_LUN_TYPE, pdriveidarray: *const windows_core::GUID, lnumberofdrives: i32, phints2: *const VDS_HINTS2) -> windows_result::Result<u64>;
}
...
impl IVdsSubSystemImportTarget {
    pub unsafe fn GetImportTarget(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetImportTarget)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetImportTarget<P0>(&self, pwsziscsiname: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IVdsSubSystemImportTarget_Impl: windows_core::IUnknownImpl {
    fn GetImportTarget(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetImportTarget(&self, pwsziscsiname: &windows_core::PCWSTR) -> windows_result::Result<()>;
}
...
impl IVdsSubSystemInterconnect {
    pub unsafe fn GetSupportedInterconnects(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsSubSystemInterconnect_Impl: windows_core::IUnknownImpl {
    fn GetSupportedInterconnects(&self) -> windows_result::Result<u32>;
}
...
impl IVdsSubSystemIscsi {
    pub unsafe fn QueryTargets(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn QueryPortals(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateTarget<P0, P1>(&self, pwsziscsiname: P0, pwszfriendlyname: P1) -> windows_result::Result<IVdsAsync>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IVdsSubSystemIscsi_Impl: windows_core::IUnknownImpl {
    fn QueryTargets(&self) -> windows_result::Result<IEnumVdsObject>;
    fn QueryPortals(&self) -> windows_result::Result<IEnumVdsObject>;
    fn CreateTarget(&self, pwsziscsiname: &windows_core::PCWSTR, pwszfriendlyname: &windows_core::PCWSTR) -> windows_result::Result<IVdsAsync>;
    fn SetIpsecGroupPresharedKey(&self, pipseckey: *const VDS_ISCSI_IPSEC_KEY) -> windows_result::Result<()>;
}
...
impl IVdsSwProvider {
    pub unsafe fn QueryPacks(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreatePack(&self) -> windows_result::Result<IVdsPack> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsSwProvider_Impl: windows_core::IUnknownImpl {
    fn QueryPacks(&self) -> windows_result::Result<IEnumVdsObject>;
    fn CreatePack(&self) -> windows_result::Result<IVdsPack>;
}
...
impl IVdsVDisk {
    #[cfg(feature = "Win32_Storage_Vhd")]
    pub unsafe fn Open(&self, accessmask: super::Vhd::VIRTUAL_DISK_ACCESS_MASK, flags: super::Vhd::OPEN_VIRTUAL_DISK_FLAG, readwritedepth: u32) -> windows_result::Result<IVdsOpenVDisk> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_Storage_Vhd")]
    pub unsafe fn GetProperties(&self, pdiskproperties: *mut VDS_VDISK_PROPERTIES) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProperties)(windows_core::Interface::as_raw(self), pdiskproperties as _).ok() }
    }
    pub unsafe fn GetHostVolume(&self) -> windows_result::Result<IVdsVolume> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetDeviceName(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsVDisk_Impl: windows_core::IUnknownImpl {
    fn Open(&self, accessmask: super::Vhd::VIRTUAL_DISK_ACCESS_MASK, flags: super::Vhd::OPEN_VIRTUAL_DISK_FLAG, readwritedepth: u32) -> windows_result::Result<IVdsOpenVDisk>;
    fn GetProperties(&self, pdiskproperties: *mut VDS_VDISK_PROPERTIES) -> windows_result::Result<()>;
    fn GetHostVolume(&self) -> windows_result::Result<IVdsVolume>;
    fn GetDeviceName(&self) -> windows_result::Result<windows_core::PWSTR>;
}
#[cfg(feature = "Win32_Storage_Vhd")]
impl IVdsVDisk_Vtbl {
...
impl IVdsVdProvider {
    pub unsafe fn QueryVDisks(&self) -> windows_result::Result<IEnumVdsObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_Storage_Vhd")]
    pub unsafe fn AddVDisk<P1>(&self, virtualdevicetype: *const super::Vhd::VIRTUAL_STORAGE_TYPE, ppath: P1, ppvdisk: *mut Option<IVdsVDisk>) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetDiskFromVDisk<P0>(&self, pvdisk: P0) -> windows_result::Result<IVdsDisk>
    where
    ...
    pub unsafe fn GetVDiskFromDisk<P0>(&self, pdisk: P0) -> windows_result::Result<IVdsVDisk>
    where
...
pub trait IVdsVdProvider_Impl: windows_core::IUnknownImpl {
    fn QueryVDisks(&self) -> windows_result::Result<IEnumVdsObject>;
    fn CreateVDisk(&self, virtualdevicetype: *const super::Vhd::VIRTUAL_STORAGE_TYPE, ppath: &windows_core::PCWSTR, pstringsecuritydescriptor: &windows_core::PCWSTR, flags: super::Vhd::CREATE_VIRTUAL_DISK_FLAG, providerspecificflags: u32, reserved: u32, pcreatediskparameters: *const VDS_CREATE_VDISK_PARAMETERS, ppasync: windows_core::OutRef<IVdsAsync>) -> windows_result::Result<()>;
    fn AddVDisk(&self, virtualdevicetype: *const super::Vhd::VIRTUAL_STORAGE_TYPE, ppath: &windows_core::PCWSTR, ppvdisk: windows_core::OutRef<IVdsVDisk>) -> windows_result::Result<()>;
    fn GetDiskFromVDisk(&self, pvdisk: windows_core::Ref<IVdsVDisk>) -> windows_result::Result<IVdsDisk>;
    fn GetVDiskFromDisk(&self, pdisk: windows_core::Ref<IVdsDisk>) -> windows_result::Result<IVdsVDisk>;
}
#[cfg(feature = "Win32_Storage_Vhd")]
...
impl IVdsVolume {
    pub unsafe fn GetProperties(&self, pvolumeproperties: *mut VDS_VOLUME_PROP) -> windows_result::Result<()> {
    ...
    pub unsafe fn Extend(&self, pinputdiskarray: &[VDS_INPUT_DISK]) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AddPlex(&self, volumeid: windows_core::GUID) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn BreakPlex(&self, plexid: windows_core::GUID) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Delete(&self, bforce: bool) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Delete)(windows_core::Interface::as_raw(self), bforce.into()).ok() }
    }
    pub unsafe fn SetFlags(&self, ulflags: u32, brevertonclose: bool) -> windows_result::Result<()> {
...
pub trait IVdsVolume_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, pvolumeproperties: *mut VDS_VOLUME_PROP) -> windows_result::Result<()>;
    fn GetPack(&self) -> windows_result::Result<IVdsPack>;
    fn QueryPlexes(&self) -> windows_result::Result<IEnumVdsObject>;
    fn Extend(&self, pinputdiskarray: *const VDS_INPUT_DISK, lnumberofdisks: i32) -> windows_result::Result<IVdsAsync>;
    fn Shrink(&self, ullnumberofbytestoremove: u64) -> windows_result::Result<IVdsAsync>;
    fn AddPlex(&self, volumeid: &windows_core::GUID) -> windows_result::Result<IVdsAsync>;
    fn BreakPlex(&self, plexid: &windows_core::GUID) -> windows_result::Result<IVdsAsync>;
    fn RemovePlex(&self, plexid: &windows_core::GUID) -> windows_result::Result<IVdsAsync>;
    fn Delete(&self, bforce: windows_core::BOOL) -> windows_result::Result<()>;
    fn SetFlags(&self, ulflags: u32, brevertonclose: windows_core::BOOL) -> windows_result::Result<()>;
    fn ClearFlags(&self, ulflags: u32) -> windows_result::Result<()>;
}
...
impl IVdsVolume2 {
    pub unsafe fn GetProperties2(&self, pvolumeproperties: *mut VDS_VOLUME_PROP2) -> windows_result::Result<()> {
...
pub trait IVdsVolume2_Impl: windows_core::IUnknownImpl {
    fn GetProperties2(&self, pvolumeproperties: *mut VDS_VOLUME_PROP2) -> windows_result::Result<()>;
}
...
impl IVdsVolumeMF {
    pub unsafe fn GetFileSystemProperties(&self, pfilesystemprop: *mut VDS_FILE_SYSTEM_PROP) -> windows_result::Result<()> {
    ...
    pub unsafe fn Format<P1>(&self, r#type: VDS_FILE_SYSTEM_TYPE, pwszlabel: P1, dwunitallocationsize: u32, bforce: bool, bquickformat: bool, benablecompression: bool) -> windows_result::Result<IVdsAsync>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn AddAccessPath<P0>(&self, pwszpath: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).AddAccessPath)(windows_core::Interface::as_raw(self), pwszpath.param().abi()).ok() }
    }
    pub unsafe fn QueryAccessPaths(&self, pwszpatharray: *mut *mut windows_core::PWSTR, plnumberofaccesspaths: *mut i32) -> windows_result::Result<()> {
    ...
    pub unsafe fn QueryReparsePoints(&self, ppreparsepointprops: *mut *mut VDS_REPARSE_POINT_PROP, plnumberofreparsepointprops: *mut i32) -> windows_result::Result<()> {
    ...
    pub unsafe fn DeleteAccessPath<P0>(&self, pwszpath: P0, bforce: bool) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IVdsVolumeMF_Impl: windows_core::IUnknownImpl {
    fn GetFileSystemProperties(&self, pfilesystemprop: *mut VDS_FILE_SYSTEM_PROP) -> windows_result::Result<()>;
    fn Format(&self, r#type: VDS_FILE_SYSTEM_TYPE, pwszlabel: &windows_core::PCWSTR, dwunitallocationsize: u32, bforce: windows_core::BOOL, bquickformat: windows_core::BOOL, benablecompression: windows_core::BOOL) -> windows_result::Result<IVdsAsync>;
    fn AddAccessPath(&self, pwszpath: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn QueryAccessPaths(&self, pwszpatharray: *mut *mut windows_core::PWSTR, plnumberofaccesspaths: *mut i32) -> windows_result::Result<()>;
    fn QueryReparsePoints(&self, ppreparsepointprops: *mut *mut VDS_REPARSE_POINT_PROP, plnumberofreparsepointprops: *mut i32) -> windows_result::Result<()>;
    fn DeleteAccessPath(&self, pwszpath: &windows_core::PCWSTR, bforce: windows_core::BOOL) -> windows_result::Result<()>;
    fn Mount(&self) -> windows_result::Result<()>;
    fn Dismount(&self, bforce: windows_core::BOOL, bpermanent: windows_core::BOOL) -> windows_result::Result<()>;
    fn SetFileSystemFlags(&self, ulflags: u32) -> windows_result::Result<()>;
    fn ClearFileSystemFlags(&self, ulflags: u32) -> windows_result::Result<()>;
}
...
impl IVdsVolumeMF2 {
    pub unsafe fn GetFileSystemTypeName(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFileSystemTypeName)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn QueryFileSystemFormatSupport(&self, ppfilesystemsupportprops: *mut *mut VDS_FILE_SYSTEM_FORMAT_SUPPORT_PROP, plnumberoffilesystems: *mut i32) -> windows_result::Result<()> {
    ...
    pub unsafe fn FormatEx<P0, P3>(&self, pwszfilesystemtypename: P0, usfilesystemrevision: u16, uldesiredunitallocationsize: u32, pwszlabel: P3, bforce: bool, bquickformat: bool, benablecompression: bool) -> windows_result::Result<IVdsAsync>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IVdsVolumeMF2_Impl: windows_core::IUnknownImpl {
    fn GetFileSystemTypeName(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn QueryFileSystemFormatSupport(&self, ppfilesystemsupportprops: *mut *mut VDS_FILE_SYSTEM_FORMAT_SUPPORT_PROP, plnumberoffilesystems: *mut i32) -> windows_result::Result<()>;
    fn FormatEx(&self, pwszfilesystemtypename: &windows_core::PCWSTR, usfilesystemrevision: u16, uldesiredunitallocationsize: u32, pwszlabel: &windows_core::PCWSTR, bforce: windows_core::BOOL, bquickformat: windows_core::BOOL, benablecompression: windows_core::BOOL) -> windows_result::Result<IVdsAsync>;
}
...
impl IVdsVolumeMF3 {
    pub unsafe fn QueryVolumeGuidPathnames(&self, pwszpatharray: *mut *mut windows_core::PWSTR, pulnumberofpaths: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn FormatEx2<P0, P3>(&self, pwszfilesystemtypename: P0, usfilesystemrevision: u16, uldesiredunitallocationsize: u32, pwszlabel: P3, options: u32) -> windows_result::Result<IVdsAsync>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn OfflineVolume(&self) -> windows_result::Result<()> {
...
pub trait IVdsVolumeMF3_Impl: windows_core::IUnknownImpl {
    fn QueryVolumeGuidPathnames(&self, pwszpatharray: *mut *mut windows_core::PWSTR, pulnumberofpaths: *mut u32) -> windows_result::Result<()>;
    fn FormatEx2(&self, pwszfilesystemtypename: &windows_core::PCWSTR, usfilesystemrevision: u16, uldesiredunitallocationsize: u32, pwszlabel: &windows_core::PCWSTR, options: u32) -> windows_result::Result<IVdsAsync>;
    fn OfflineVolume(&self) -> windows_result::Result<()>;
}
...
impl IVdsVolumePlex {
    pub unsafe fn GetProperties(&self, pplexproperties: *mut VDS_VOLUME_PLEX_PROP) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProperties)(windows_core::Interface::as_raw(self), pplexproperties as _).ok() }
    }
    pub unsafe fn GetVolume(&self) -> windows_result::Result<IVdsVolume> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Repair(&self, pinputdiskarray: &[VDS_INPUT_DISK]) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsVolumePlex_Impl: windows_core::IUnknownImpl {
    fn GetProperties(&self, pplexproperties: *mut VDS_VOLUME_PLEX_PROP) -> windows_result::Result<()>;
    fn GetVolume(&self) -> windows_result::Result<IVdsVolume>;
    fn QueryExtents(&self, ppextentarray: *mut *mut VDS_DISK_EXTENT, plnumberofextents: *mut i32) -> windows_result::Result<()>;
    fn Repair(&self, pinputdiskarray: *const VDS_INPUT_DISK, lnumberofdisks: i32) -> windows_result::Result<IVdsAsync>;
}
...
impl IVdsVolumeShrink {
    pub unsafe fn QueryMaxReclaimableBytes(&self) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).QueryMaxReclaimableBytes)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn Shrink(&self, ulldesirednumberofreclaimablebytes: u64, ullminnumberofreclaimablebytes: u64) -> windows_result::Result<IVdsAsync> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVdsVolumeShrink_Impl: windows_core::IUnknownImpl {
    fn QueryMaxReclaimableBytes(&self) -> windows_result::Result<u64>;
    fn Shrink(&self, ulldesirednumberofreclaimablebytes: u64, ullminnumberofreclaimablebytes: u64) -> windows_result::Result<IVdsAsync>;
}
