...
pub trait IVdsService_Impl: Sized {
    ...
    fn Advise(&self, psink: ::core::option::Option<&IVdsAdviseSink>) -> ::windows_core::Result<u32>;
...
pub trait IVdsVdProvider_Impl: Sized {
    ...
    fn AddVDisk(&self, virtualdevicetype: *const super::Vhd::VIRTUAL_STORAGE_TYPE, ppath: &::windows_core::PCWSTR, ppvdisk: *mut ::core::option::Option<IVdsVDisk>) -> ::windows_core::Result<()>;
    fn GetDiskFromVDisk(&self, pvdisk: ::core::option::Option<&IVdsVDisk>) -> ::windows_core::Result<IVdsDisk>;
    fn GetVDiskFromDisk(&self, pdisk: ::core::option::Option<&IVdsDisk>) -> ::windows_core::Result<IVdsVDisk>;
}
#[cfg(feature = "Win32_Storage_Vhd")]
