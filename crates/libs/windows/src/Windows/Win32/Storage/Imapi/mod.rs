...
pub const IMAPI_E_ALREADYOPEN: windows_core::HRESULT = 0x80040222_u32 as _;
pub const IMAPI_E_BADJOLIETNAME: windows_core::HRESULT = 0x8004021D_u32 as _;
pub const IMAPI_E_BOOTIMAGE_AND_NONBLANK_DISC: windows_core::HRESULT = 0x8004022E_u32 as _;
pub const IMAPI_E_CANNOT_WRITE_TO_MEDIA: windows_core::HRESULT = 0x8004022C_u32 as _;
pub const IMAPI_E_COMPRESSEDSTASH: windows_core::HRESULT = 0x80040228_u32 as _;
pub const IMAPI_E_DEVICE_INVALIDTYPE: windows_core::HRESULT = 0x80040214_u32 as _;
pub const IMAPI_E_DEVICE_NOPROPERTIES: windows_core::HRESULT = 0x80040211_u32 as _;
pub const IMAPI_E_DEVICE_NOTACCESSIBLE: windows_core::HRESULT = 0x80040212_u32 as _;
pub const IMAPI_E_DEVICE_NOTPRESENT: windows_core::HRESULT = 0x80040213_u32 as _;
pub const IMAPI_E_DEVICE_STILL_IN_USE: windows_core::HRESULT = 0x80040226_u32 as _;
pub const IMAPI_E_DISCFULL: windows_core::HRESULT = 0x8004021C_u32 as _;
pub const IMAPI_E_DISCINFO: windows_core::HRESULT = 0x80040219_u32 as _;
pub const IMAPI_E_ENCRYPTEDSTASH: windows_core::HRESULT = 0x80040229_u32 as _;
pub const IMAPI_E_FILEACCESS: windows_core::HRESULT = 0x80040218_u32 as _;
pub const IMAPI_E_FILEEXISTS: windows_core::HRESULT = 0x80040224_u32 as _;
pub const IMAPI_E_FILESYSTEM: windows_core::HRESULT = 0x80040217_u32 as _;
pub const IMAPI_E_GENERIC: windows_core::HRESULT = 0x8004020E_u32 as _;
pub const IMAPI_E_INITIALIZE_ENDWRITE: windows_core::HRESULT = 0x80040216_u32 as _;
pub const IMAPI_E_INITIALIZE_WRITE: windows_core::HRESULT = 0x80040215_u32 as _;
pub const IMAPI_E_INVALIDIMAGE: windows_core::HRESULT = 0x8004021E_u32 as _;
pub const IMAPI_E_LOSS_OF_STREAMING: windows_core::HRESULT = 0x80040227_u32 as _;
pub const IMAPI_E_MEDIUM_INVALIDTYPE: windows_core::HRESULT = 0x80040210_u32 as _;
pub const IMAPI_E_MEDIUM_NOTPRESENT: windows_core::HRESULT = 0x8004020F_u32 as _;
pub const IMAPI_E_NOACTIVEFORMAT: windows_core::HRESULT = 0x8004021F_u32 as _;
pub const IMAPI_E_NOACTIVERECORDER: windows_core::HRESULT = 0x80040220_u32 as _;
pub const IMAPI_E_NOTENOUGHDISKFORSTASH: windows_core::HRESULT = 0x8004022A_u32 as _;
pub const IMAPI_E_NOTINITIALIZED: windows_core::HRESULT = 0x8004020C_u32 as _;
pub const IMAPI_E_NOTOPENED: windows_core::HRESULT = 0x8004020B_u32 as _;
pub const IMAPI_E_REMOVABLESTASH: windows_core::HRESULT = 0x8004022B_u32 as _;
pub const IMAPI_E_STASHINUSE: windows_core::HRESULT = 0x80040225_u32 as _;
pub const IMAPI_E_TRACKNOTOPEN: windows_core::HRESULT = 0x8004021A_u32 as _;
pub const IMAPI_E_TRACKOPEN: windows_core::HRESULT = 0x8004021B_u32 as _;
pub const IMAPI_E_TRACK_NOT_BIG_ENOUGH: windows_core::HRESULT = 0x8004022D_u32 as _;
pub const IMAPI_E_USERABORT: windows_core::HRESULT = 0x8004020D_u32 as _;
pub const IMAPI_E_WRONGDISC: windows_core::HRESULT = 0x80040223_u32 as _;
pub const IMAPI_E_WRONGFORMAT: windows_core::HRESULT = 0x80040221_u32 as _;
...
pub const IMAPI_S_BUFFER_TO_SMALL: windows_core::HRESULT = 0x40201_u32 as _;
pub const IMAPI_S_PROPERTIESIGNORED: windows_core::HRESULT = 0x40200_u32 as _;
