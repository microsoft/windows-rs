...
impl IDiscRecorder {
    ...
    pub unsafe fn GetRecorderGUID(&self, pbyuniqueid: ::core::option::Option<&mut [u8]>, pulreturnsizerequired: *mut u32) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).GetRecorderGUID)(::core::mem::transmute_copy(self), ::core::mem::transmute(pbyuniqueid.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), pbyuniqueid.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(pulreturnsizerequired)).ok()
    }
    #[doc = "*Required features: 'Win32_Storage_Imapi'*"]
...
impl IStreamInterleave {
    ...
    pub unsafe fn Initialize<'a, const PARAM2: usize>(&self, streams: &[::core::option::Option<super::super::System::Com::IStream>; PARAM2], interleavesizes: &[u32; PARAM2]) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).Initialize)(::core::mem::transmute_copy(self), ::core::mem::transmute(streams.as_ptr()), ::core::mem::transmute(interleavesizes.as_ptr()), PARAM2 as _).ok()
    }
}
#[cfg(feature = "Win32_System_Com")]
