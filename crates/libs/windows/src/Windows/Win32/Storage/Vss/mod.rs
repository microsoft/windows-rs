...
impl IVssAdminEx {
    ...
    pub unsafe fn QueryProviders(&self) -> ::windows_core::Result<IVssEnumObject> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.QueryProviders)(::windows_core::Interface::as_raw(self), &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    pub unsafe fn AbortAllSnapshotsInProgress(&self) -> ::windows_core::Result<()> {
...
pub struct IVssComponent_Vtbl {
    ...
    pub GetComponentName: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    ...
    pub GetBackupMetadata: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    ...
    pub GetPartialFile: unsafe extern "system" fn(*mut ::core::ffi::c_void, u32, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    ...
    pub GetDirectedTarget: unsafe extern "system" fn(*mut ::core::ffi::c_void, u32, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub SetRestoreMetadata: unsafe extern "system" fn(*mut ::core::ffi::c_void, ::windows_core::PCWSTR) -> ::windows_core::HRESULT,
    pub GetRestoreMetadata: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    ...
    pub GetPreRestoreFailureMsg: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub SetPostRestoreFailureMsg: unsafe extern "system" fn(*mut ::core::ffi::c_void, ::windows_core::PCWSTR) -> ::windows_core::HRESULT,
    pub GetPostRestoreFailureMsg: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub SetBackupStamp: unsafe extern "system" fn(*mut ::core::ffi::c_void, ::windows_core::PCWSTR) -> ::windows_core::HRESULT,
    pub GetBackupStamp: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub GetPreviousBackupStamp: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub GetBackupOptions: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub GetRestoreOptions: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub GetRestoreSubcomponentCount: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut u32) -> ::windows_core::HRESULT,
    pub GetRestoreSubcomponent: unsafe extern "system" fn(*mut ::core::ffi::c_void, u32, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>, *mut bool) -> ::windows_core::HRESULT,
    ...
    pub AddDifferencedFilesByLastModifyLSN: unsafe extern "system" fn(*mut ::core::ffi::c_void, ::windows_core::PCWSTR, ::windows_core::PCWSTR, super::super::Foundation::BOOL, ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub GetDifferencedFilesCount: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut u32) -> ::windows_core::HRESULT,
    pub GetDifferencedFile: unsafe extern "system" fn(*mut ::core::ffi::c_void, u32, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>, *mut super::super::Foundation::BOOL, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>, *mut super::super::Foundation::FILETIME) -> ::windows_core::HRESULT,
}
...
impl IVssComponentEx {
    ...
    pub unsafe fn GetAlternateLocationMapping(&self, imapping: u32) -> ::windows_core::Result<IVssWMFiledesc> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.GetAlternateLocationMapping)(::windows_core::Interface::as_raw(self), imapping, &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    pub unsafe fn SetBackupMetadata<P0>(&self, wszdata: P0) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
    ...
    pub unsafe fn GetNewTarget(&self, inewtarget: u32) -> ::windows_core::Result<IVssWMFiledesc> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.GetNewTarget)(::windows_core::Interface::as_raw(self), inewtarget, &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    pub unsafe fn AddDirectedTarget<P0, P1, P2, P3, P4, P5>(&self, wszsourcepath: P0, wszsourcefilename: P1, wszsourcerangelist: P2, wszdestinationpath: P3, wszdestinationfilename: P4, wszdestinationrangelist: P5) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
...
pub struct IVssComponentEx_Vtbl {
    ...
    pub GetPrepareForBackupFailureMsg: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub GetPostSnapshotFailureMsg: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub GetAuthoritativeRestore: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut bool) -> ::windows_core::HRESULT,
    pub GetRollForward: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut VSS_ROLLFORWARD_TYPE, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub GetRestoreName: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
}
...
impl IVssComponentEx2 {
    ...
    pub unsafe fn GetAlternateLocationMapping(&self, imapping: u32) -> ::windows_core::Result<IVssWMFiledesc> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.base__.GetAlternateLocationMapping)(::windows_core::Interface::as_raw(self), imapping, &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    pub unsafe fn SetBackupMetadata<P0>(&self, wszdata: P0) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
    ...
    pub unsafe fn GetNewTarget(&self, inewtarget: u32) -> ::windows_core::Result<IVssWMFiledesc> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.base__.GetNewTarget)(::windows_core::Interface::as_raw(self), inewtarget, &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    pub unsafe fn AddDirectedTarget<P0, P1, P2, P3, P4, P5>(&self, wszsourcepath: P0, wszsourcefilename: P1, wszsourcerangelist: P2, wszdestinationpath: P3, wszdestinationfilename: P4, wszdestinationrangelist: P5) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
    ...
    pub unsafe fn GetPrepareForBackupFailureMsg(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.GetPrepareForBackupFailureMsg)(::windows_core::Interface::as_raw(self), &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    pub unsafe fn GetPostSnapshotFailureMsg(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.GetPostSnapshotFailureMsg)(::windows_core::Interface::as_raw(self), &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    pub unsafe fn GetAuthoritativeRestore(&self) -> ::windows_core::Result<bool> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.GetAuthoritativeRestore)(::windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
    }
    pub unsafe fn GetRollForward(&self, prolltype: *mut VSS_ROLLFORWARD_TYPE, pbstrpoint: *mut ::windows_core::BSTR) -> ::windows_core::Result<()> {
    ...
    pub unsafe fn GetRestoreName(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.GetRestoreName)(::windows_core::Interface::as_raw(self), &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
...
pub struct IVssComponentEx2_Vtbl {
    ...
    pub GetFailure: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut ::windows_core::HRESULT, *mut ::windows_core::HRESULT, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>, *mut u32) -> ::windows_core::HRESULT,
}
...
pub struct IVssCreateExpressWriterMetadata_Vtbl {
    ...
    pub SaveAsXML: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
}
...
impl IVssDifferentialSoftwareSnapshotMgmt2 {
    ...
    pub unsafe fn QueryVolumesSupportedForDiffAreas(&self, pwszoriginalvolumename: *const u16) -> ::windows_core::Result<IVssEnumMgmtObject> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.QueryVolumesSupportedForDiffAreas)(::windows_core::Interface::as_raw(self), pwszoriginalvolumename, &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    pub unsafe fn QueryDiffAreasForVolume(&self, pwszvolumename: *const u16) -> ::windows_core::Result<IVssEnumMgmtObject> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.QueryDiffAreasForVolume)(::windows_core::Interface::as_raw(self), pwszvolumename, &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    pub unsafe fn QueryDiffAreasOnVolume(&self, pwszvolumename: *const u16) -> ::windows_core::Result<IVssEnumMgmtObject> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.QueryDiffAreasOnVolume)(::windows_core::Interface::as_raw(self), pwszvolumename, &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    pub unsafe fn QueryDiffAreasForSnapshot(&self, snapshotid: ::windows_core::GUID) -> ::windows_core::Result<IVssEnumMgmtObject> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.QueryDiffAreasForSnapshot)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(snapshotid), &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
...
impl IVssDifferentialSoftwareSnapshotMgmt3 {
    ...
    pub unsafe fn QueryVolumesSupportedForDiffAreas(&self, pwszoriginalvolumename: *const u16) -> ::windows_core::Result<IVssEnumMgmtObject> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.base__.QueryVolumesSupportedForDiffAreas)(::windows_core::Interface::as_raw(self), pwszoriginalvolumename, &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    pub unsafe fn QueryDiffAreasForVolume(&self, pwszvolumename: *const u16) -> ::windows_core::Result<IVssEnumMgmtObject> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.base__.QueryDiffAreasForVolume)(::windows_core::Interface::as_raw(self), pwszvolumename, &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    pub unsafe fn QueryDiffAreasOnVolume(&self, pwszvolumename: *const u16) -> ::windows_core::Result<IVssEnumMgmtObject> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.base__.QueryDiffAreasOnVolume)(::windows_core::Interface::as_raw(self), pwszvolumename, &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    pub unsafe fn QueryDiffAreasForSnapshot(&self, snapshotid: ::windows_core::GUID) -> ::windows_core::Result<IVssEnumMgmtObject> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.base__.QueryDiffAreasForSnapshot)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(snapshotid), &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    pub unsafe fn ChangeDiffAreaMaximumSizeEx<P0>(&self, pwszvolumename: *const u16, pwszdiffareavolumename: *const u16, llmaximumdiffspace: i64, bvolatile: P0) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<super::super::Foundation::BOOL>,
    ...
    pub unsafe fn QueryMigrationStatus(&self, pwszvolumename: *const u16, pwszdiffareavolumename: *const u16) -> ::windows_core::Result<IVssAsync> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.QueryMigrationStatus)(::windows_core::Interface::as_raw(self), pwszvolumename, pwszdiffareavolumename, &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    pub unsafe fn SetSnapshotPriority(&self, idsnapshot: ::windows_core::GUID, priority: u8) -> ::windows_core::Result<()> {
...
impl IVssExpressWriter {
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).CreateMetadata)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(writerid), writername.into_param().abi(), usagetype, versionmajor, versionminor, reserved, &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
...
impl IVssFileShareSnapshotProvider {
    ...
    {
        (::windows_core::Interface::vtable(self).SetSnapshotProperty)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(snapshotid), esnapshotpropertyid, vproperty.into_param().abi()).ok()
    }
}
#[repr(C)]
pub struct IVssFileShareSnapshotProvider_Vtbl {
    ...
    pub SetSnapshotProperty: unsafe extern "system" fn(*mut ::core::ffi::c_void, ::windows_core::GUID, VSS_SNAPSHOT_PROPERTY_ID, ::std::mem::MaybeUninit<::windows_core::VARIANT>) -> ::windows_core::HRESULT,
}
...
pub struct IVssWMFiledesc_Vtbl {
    ...
    pub GetFilespec: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub GetRecursive: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut bool) -> ::windows_core::HRESULT,
    pub GetAlternateLocation: unsafe extern "system" fn(*mut ::core::ffi::c_void, *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
...
pub const VSS_E_ASRERROR_CRITICAL_DISKS_TOO_SMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042408u32 as _);
pub const VSS_E_ASRERROR_CRITICAL_DISK_CANNOT_BE_EXCLUDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042415u32 as _);
pub const VSS_E_ASRERROR_DATADISK_RDISK0: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042406u32 as _);
pub const VSS_E_ASRERROR_DISK_ASSIGNMENT_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042401u32 as _);
pub const VSS_E_ASRERROR_DISK_RECREATION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042402u32 as _);
pub const VSS_E_ASRERROR_DYNAMIC_VHD_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004240Au32 as _);
pub const VSS_E_ASRERROR_FIXED_PHYSICAL_DISK_AVAILABLE_AFTER_DISK_EXCLUSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042414u32 as _);
pub const VSS_E_ASRERROR_MISSING_DYNDISK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042404u32 as _);
pub const VSS_E_ASRERROR_NO_ARCPATH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042403u32 as _);
pub const VSS_E_ASRERROR_NO_PHYSICAL_DISK_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042413u32 as _);
pub const VSS_E_ASRERROR_RDISK0_TOOSMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042407u32 as _);
pub const VSS_E_ASRERROR_RDISK_FOR_SYSTEM_DISK_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042412u32 as _);
pub const VSS_E_ASRERROR_SHARED_CRIDISK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042405u32 as _);
pub const VSS_E_ASRERROR_SYSTEM_PARTITION_HIDDEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042416u32 as _);
pub const VSS_E_AUTORECOVERY_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800423FBu32 as _);
pub const VSS_E_BAD_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042301u32 as _);
pub const VSS_E_BREAK_REVERT_ID_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800423F6u32 as _);
pub const VSS_E_CANNOT_REVERT_DISKID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800423FEu32 as _);
pub const VSS_E_CLUSTER_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042400u32 as _);
pub const VSS_E_CLUSTER_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004232Eu32 as _);
pub const VSS_E_CORRUPT_XML_DOCUMENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042310u32 as _);
pub const VSS_E_CRITICAL_VOLUME_ON_INVALID_DISK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042411u32 as _);
pub const VSS_E_DYNAMIC_DISK_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800423FCu32 as _);
pub const VSS_E_FLUSH_WRITES_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042313u32 as _);
pub const VSS_E_FSS_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042417u32 as _);
pub const VSS_E_HOLD_WRITES_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042314u32 as _);
pub const VSS_E_INSUFFICIENT_STORAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004231Fu32 as _);
pub const VSS_E_INVALID_XML_DOCUMENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042311u32 as _);
pub const VSS_E_LEGACY_PROVIDER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800423F7u32 as _);
pub const VSS_E_MAXIMUM_DIFFAREA_ASSOCIATIONS_REACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004231Eu32 as _);
pub const VSS_E_MAXIMUM_NUMBER_OF_REMOTE_MACHINES_REACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042322u32 as _);
pub const VSS_E_MAXIMUM_NUMBER_OF_SNAPSHOTS_REACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042317u32 as _);
pub const VSS_E_MAXIMUM_NUMBER_OF_VOLUMES_REACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042312u32 as _);
pub const VSS_E_MISSING_DISK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800423F8u32 as _);
pub const VSS_E_MISSING_HIDDEN_VOLUME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800423F9u32 as _);
pub const VSS_E_MISSING_VOLUME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800423FAu32 as _);
pub const VSS_E_NESTED_VOLUME_LIMIT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004232Cu32 as _);
pub const VSS_E_NONTRANSPORTABLE_BCD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800423FDu32 as _);
pub const VSS_E_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004232Fu32 as _);
pub const VSS_E_NO_SNAPSHOTS_IMPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042320u32 as _);
pub const VSS_E_OBJECT_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004230Du32 as _);
pub const VSS_E_OBJECT_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042308u32 as _);
pub const VSS_E_PROVIDER_ALREADY_REGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042303u32 as _);
pub const VSS_E_PROVIDER_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042307u32 as _);
pub const VSS_E_PROVIDER_NOT_REGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042304u32 as _);
pub const VSS_E_PROVIDER_VETO: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042306u32 as _);
pub const VSS_E_REBOOT_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042327u32 as _);
pub const VSS_E_REMOTE_SERVER_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042323u32 as _);
pub const VSS_E_REMOTE_SERVER_UNSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042324u32 as _);
pub const VSS_E_RESYNC_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800423FFu32 as _);
pub const VSS_E_REVERT_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042325u32 as _);
pub const VSS_E_REVERT_VOLUME_LOST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042326u32 as _);
pub const VSS_E_SNAPSHOT_NOT_IN_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004232Bu32 as _);
pub const VSS_E_SNAPSHOT_SET_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042316u32 as _);
pub const VSS_E_SOME_SNAPSHOTS_NOT_IMPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042321u32 as _);
pub const VSS_E_TRANSACTION_FREEZE_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042328u32 as _);
pub const VSS_E_TRANSACTION_THAW_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042329u32 as _);
pub const VSS_E_UNEXPECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042302u32 as _);
pub const VSS_E_UNEXPECTED_PROVIDER_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004230Fu32 as _);
pub const VSS_E_UNEXPECTED_WRITER_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042315u32 as _);
pub const VSS_E_UNSELECTED_VOLUME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004232Au32 as _);
pub const VSS_E_UNSUPPORTED_CONTEXT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004231Bu32 as _);
pub const VSS_E_VOLUME_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004231Du32 as _);
pub const VSS_E_VOLUME_NOT_LOCAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004232Du32 as _);
pub const VSS_E_VOLUME_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004230Cu32 as _);
pub const VSS_E_VOLUME_NOT_SUPPORTED_BY_PROVIDER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004230Eu32 as _);
pub const VSS_E_WRITERERROR_INCONSISTENTSNAPSHOT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800423F0u32 as _);
pub const VSS_E_WRITERERROR_NONRETRYABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800423F4u32 as _);
pub const VSS_E_WRITERERROR_OUTOFRESOURCES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800423F1u32 as _);
pub const VSS_E_WRITERERROR_PARTIAL_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042336u32 as _);
pub const VSS_E_WRITERERROR_RECOVERY_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800423F5u32 as _);
pub const VSS_E_WRITERERROR_RETRYABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800423F3u32 as _);
pub const VSS_E_WRITERERROR_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800423F2u32 as _);
pub const VSS_E_WRITER_ALREADY_SUBSCRIBED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004231Au32 as _);
pub const VSS_E_WRITER_INFRASTRUCTURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042318u32 as _);
pub const VSS_E_WRITER_NOT_RESPONDING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042319u32 as _);
pub const VSS_E_WRITER_STATUS_NOT_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80042409u32 as _);
...
pub const VSS_S_ASYNC_CANCELLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4230Bu32 as _);
pub const VSS_S_ASYNC_FINISHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4230Au32 as _);
pub const VSS_S_ASYNC_PENDING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x42309u32 as _);
pub const VSS_S_SOME_SNAPSHOTS_NOT_IMPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x42321u32 as _);
