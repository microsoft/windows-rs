...
#[cfg(all(feature = "bcrypt", feature = "rpc", feature = "shobjidl_core", feature = "windef"))]
...
impl ICredentialProviderCredential {
    ...
    #[cfg(feature = "windef")]
    pub unsafe fn GetBitmapValue(&self, dwfieldid: u32) -> windows_core::Result<super::HBITMAP> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "bcrypt")]
    pub unsafe fn ReportResult(&self, ntsstatus: super::NTSTATUS, ntssubstatus: super::NTSTATUS, ppszoptionalstatustext: *mut windows_core::PWSTR, pcpsioptionalstatusicon: *mut CREDENTIAL_PROVIDER_STATUS_ICON) -> windows_core::HRESULT {
...
pub struct ICredentialProviderCredential_Vtbl {
    ...
    #[cfg(feature = "windef")]
    pub GetBitmapValue: unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut super::HBITMAP) -> windows_core::HRESULT,
    ...
    #[cfg(feature = "bcrypt")]
    pub ReportResult: unsafe extern "system" fn(*mut core::ffi::c_void, super::NTSTATUS, super::NTSTATUS, *mut windows_core::PWSTR, *mut CREDENTIAL_PROVIDER_STATUS_ICON) -> windows_core::HRESULT,
    #[cfg(not(feature = "bcrypt"))]
    ReportResult: usize,
}
#[cfg(all(feature = "bcrypt", feature = "rpc", feature = "windef"))]
pub trait ICredentialProviderCredential_Impl: windows_core::IUnknownImpl {
    ...
    fn GetBitmapValue(&self, dwfieldid: u32) -> windows_core::Result<super::HBITMAP>;
    ...
    fn ReportResult(&self, ntsstatus: super::NTSTATUS, ntssubstatus: super::NTSTATUS, ppszoptionalstatustext: *mut windows_core::PWSTR, pcpsioptionalstatusicon: *mut CREDENTIAL_PROVIDER_STATUS_ICON) -> windows_core::Result<()>;
}
#[cfg(all(feature = "bcrypt", feature = "rpc", feature = "windef"))]
impl ICredentialProviderCredential_Vtbl {
    pub const fn new<Identity: ICredentialProviderCredential_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetBitmapValue<Identity: ICredentialProviderCredential_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, dwfieldid: u32, phbmp: *mut super::HBITMAP) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ReportResult<Identity: ICredentialProviderCredential_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, ntsstatus: super::NTSTATUS, ntssubstatus: super::NTSTATUS, ppszoptionalstatustext: *mut windows_core::PWSTR, pcpsioptionalstatusicon: *mut CREDENTIAL_PROVIDER_STATUS_ICON) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ICredentialProviderCredentialEvents {
    ...
    #[cfg(feature = "windef")]
    pub unsafe fn SetFieldBitmap<P0>(&self, pcpc: P0, dwfieldid: u32, hbmp: super::HBITMAP) -> windows_core::HRESULT
    where
        P0: windows_core::Param<ICredentialProviderCredential>,
    {
    ...
    #[cfg(feature = "windef")]
    pub unsafe fn OnCreatingWindow(&self) -> windows_core::Result<super::HWND> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub struct ICredentialProviderCredentialEvents_Vtbl {
    ...
    #[cfg(feature = "windef")]
    pub SetFieldBitmap: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, u32, super::HBITMAP) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    ...
    #[cfg(feature = "windef")]
    pub OnCreatingWindow: unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::HWND) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
...
pub trait ICredentialProviderCredentialEvents_Impl: windows_core::IUnknownImpl {
    ...
    fn SetFieldBitmap(&self, pcpc: windows_core::Ref<ICredentialProviderCredential>, dwfieldid: u32, hbmp: super::HBITMAP) -> windows_core::Result<()>;
    ...
    fn OnCreatingWindow(&self) -> windows_core::Result<super::HWND>;
}
#[cfg(feature = "windef")]
impl ICredentialProviderCredentialEvents_Vtbl {
    pub const fn new<Identity: ICredentialProviderCredentialEvents_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn SetFieldBitmap<Identity: ICredentialProviderCredentialEvents_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pcpc: *mut core::ffi::c_void, dwfieldid: u32, hbmp: super::HBITMAP) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn OnCreatingWindow<Identity: ICredentialProviderCredentialEvents_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, phwndowner: *mut super::HWND) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ICredentialProviderUser {
    ...
    #[cfg(feature = "wtypes")]
    pub unsafe fn GetStringValue(&self, key: *const super::PROPERTYKEY) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ICredentialProviderUser_Vtbl {
    pub const fn new<Identity: ICredentialProviderUser_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetStringValue<Identity: ICredentialProviderUser_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, key: *const super::PROPERTYKEY, stringvalue: *mut windows_core::PWSTR) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetValue<Identity: ICredentialProviderUser_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, key: *const super::PROPERTYKEY, value: *mut super::PROPVARIANT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl core::ops::Deref for IQueryContinueWithStatus {
    type Target = super::IQueryContinue;
    fn deref(&self) -> &Self::Target {
        unsafe { core::mem::transmute(self) }
    }
}
#[cfg(feature = "shobjidl_core")]
windows_core::imp::interface_hierarchy!(IQueryContinueWithStatus, windows_core::IUnknown, super::IQueryContinue);
#[cfg(feature = "shobjidl_core")]
...
impl IQueryContinueWithStatus_Vtbl {
    pub const fn new<Identity: IQueryContinueWithStatus_Impl, const OFFSET: isize>() -> Self {
        ...
        Self { base__: super::IQueryContinue_Vtbl::new::<Identity, OFFSET>(), SetStatusMessage: SetStatusMessage::<Identity, OFFSET> }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IQueryContinueWithStatus as windows_core::Interface>::IID || iid == &<super::IQueryContinue as windows_core::Interface>::IID
    }
}
#[cfg(feature = "shobjidl_core")]
