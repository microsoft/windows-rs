...
#[inline]
pub unsafe fn Icmp6SendEcho2(icmphandle: super::winnt::HANDLE, event: Option<super::winnt::HANDLE>, apcroutine: super::minwindef::FARPROC, apccontext: Option<*const core::ffi::c_void>, sourceaddress: *const super::ws2ipdef::SOCKADDR_IN6_LH, destinationaddress: *const super::ws2ipdef::SOCKADDR_IN6_LH, requestdata: *const core::ffi::c_void, requestsize: u16, requestoptions: Option<*const super::ipexport::IP_OPTION_INFORMATION>, replybuffer: *mut core::ffi::c_void, replysize: u32, timeout: u32) -> u32 {
