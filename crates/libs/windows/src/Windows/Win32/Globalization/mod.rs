...
#[inline]
pub unsafe fn MappingDoAction<P2>(pbag: *mut MAPPING_PROPERTY_BAG, dwrangeindex: u32, pszactionid: P2) -> windows_core::HRESULT
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { MappingDoAction(pbag as _, dwrangeindex, pszactionid.param().abi()) }
}
#[inline]
pub unsafe fn MappingFreePropertyBag(pbag: *const MAPPING_PROPERTY_BAG) -> windows_core::HRESULT {
    windows_core::link!("elscore.dll" "system" fn MappingFreePropertyBag(pbag : *const MAPPING_PROPERTY_BAG) -> windows_core::HRESULT);
    unsafe { MappingFreePropertyBag(pbag) }
}
#[inline]
pub unsafe fn MappingFreeServices(pserviceinfo: *const MAPPING_SERVICE_INFO) -> windows_core::HRESULT {
    windows_core::link!("elscore.dll" "system" fn MappingFreeServices(pserviceinfo : *const MAPPING_SERVICE_INFO) -> windows_core::HRESULT);
    unsafe { MappingFreeServices(pserviceinfo) }
}
#[inline]
pub unsafe fn MappingGetServices(poptions: Option<*const MAPPING_ENUM_OPTIONS>, prgservices: *mut *mut MAPPING_SERVICE_INFO, pdwservicescount: *mut u32) -> windows_core::HRESULT {
    ...
    unsafe { MappingGetServices(poptions.unwrap_or(core::mem::zeroed()) as _, prgservices as _, pdwservicescount as _) }
}
#[inline]
pub unsafe fn MappingRecognizeText(pserviceinfo: *const MAPPING_SERVICE_INFO, psztext: &[u16], dwindex: u32, poptions: Option<*const MAPPING_OPTIONS>, pbag: *mut MAPPING_PROPERTY_BAG) -> windows_core::HRESULT {
    ...
    unsafe { MappingRecognizeText(pserviceinfo, core::mem::transmute(psztext.as_ptr()), psztext.len().try_into().unwrap(), dwindex, poptions.unwrap_or(core::mem::zeroed()) as _, pbag as _) }
}
#[inline]
...
#[inline]
pub unsafe fn ScriptApplyDigitSubstitution(psds: *const SCRIPT_DIGITSUBSTITUTE, psc: *mut SCRIPT_CONTROL, pss: *mut SCRIPT_STATE) -> windows_core::HRESULT {
    ...
    unsafe { ScriptApplyDigitSubstitution(psds, psc as _, pss as _) }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptApplyLogicalWidth(pidx: *const i32, cchars: i32, cglyphs: i32, pwlogclust: *const u16, psva: *const SCRIPT_VISATTR, piadvance: *const i32, psa: *const SCRIPT_ANALYSIS, pabc: Option<*mut super::Graphics::Gdi::ABC>, pijustify: *mut i32) -> windows_core::HRESULT {
    ...
    unsafe { ScriptApplyLogicalWidth(pidx, cchars, cglyphs, pwlogclust, psva, piadvance, psa, pabc.unwrap_or(core::mem::zeroed()) as _, pijustify as _) }
}
#[inline]
pub unsafe fn ScriptBreak<P0>(pwcchars: P0, cchars: i32, psa: *const SCRIPT_ANALYSIS, psla: *mut SCRIPT_LOGATTR) -> windows_core::HRESULT
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { ScriptBreak(pwcchars.param().abi(), cchars, psa, psla as _) }
}
#[inline]
pub unsafe fn ScriptCPtoX(icp: i32, ftrailing: bool, cglyphs: i32, pwlogclust: &[u16], psva: *const SCRIPT_VISATTR, piadvance: *const i32, psa: *const SCRIPT_ANALYSIS, pix: *mut i32) -> windows_core::HRESULT {
    ...
    unsafe { ScriptCPtoX(icp, ftrailing.into(), pwlogclust.len().try_into().unwrap(), cglyphs, core::mem::transmute(pwlogclust.as_ptr()), psva, piadvance, psa, pix as _) }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptCacheGetHeight(hdc: super::Graphics::Gdi::HDC, psc: *mut *mut core::ffi::c_void, tmheight: *mut i32) -> windows_core::HRESULT {
    ...
    unsafe { ScriptCacheGetHeight(hdc, psc as _, tmheight as _) }
}
#[inline]
pub unsafe fn ScriptFreeCache(psc: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
    windows_core::link!("usp10.dll" "system" fn ScriptFreeCache(psc : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe { ScriptFreeCache(psc as _) }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptGetCMap<P2>(hdc: super::Graphics::Gdi::HDC, psc: *mut *mut core::ffi::c_void, pwcinchars: P2, cchars: i32, dwflags: u32, pwoutglyphs: *mut u16) -> windows_core::HRESULT
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { ScriptGetCMap(hdc, psc as _, pwcinchars.param().abi(), cchars, dwflags, pwoutglyphs as _) }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptGetFontAlternateGlyphs(hdc: Option<super::Graphics::Gdi::HDC>, psc: *mut *mut core::ffi::c_void, psa: Option<*const SCRIPT_ANALYSIS>, tagscript: u32, taglangsys: u32, tagfeature: u32, wglyphid: u16, palternateglyphs: &mut [u16], pcalternates: *mut i32) -> windows_core::HRESULT {
    ...
    unsafe { ScriptGetFontAlternateGlyphs(hdc.unwrap_or(core::mem::zeroed()) as _, psc as _, psa.unwrap_or(core::mem::zeroed()) as _, tagscript, taglangsys, tagfeature, wglyphid, palternateglyphs.len().try_into().unwrap(), core::mem::transmute(palternateglyphs.as_ptr()), pcalternates as _) }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptGetFontFeatureTags(hdc: Option<super::Graphics::Gdi::HDC>, psc: *mut *mut core::ffi::c_void, psa: Option<*const SCRIPT_ANALYSIS>, tagscript: u32, taglangsys: u32, pfeaturetags: &mut [u32], pctags: *mut i32) -> windows_core::HRESULT {
    ...
    unsafe { ScriptGetFontFeatureTags(hdc.unwrap_or(core::mem::zeroed()) as _, psc as _, psa.unwrap_or(core::mem::zeroed()) as _, tagscript, taglangsys, pfeaturetags.len().try_into().unwrap(), core::mem::transmute(pfeaturetags.as_ptr()), pctags as _) }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptGetFontLanguageTags(hdc: Option<super::Graphics::Gdi::HDC>, psc: *mut *mut core::ffi::c_void, psa: Option<*const SCRIPT_ANALYSIS>, tagscript: u32, plangsystags: &mut [u32], pctags: *mut i32) -> windows_core::HRESULT {
    ...
    unsafe { ScriptGetFontLanguageTags(hdc.unwrap_or(core::mem::zeroed()) as _, psc as _, psa.unwrap_or(core::mem::zeroed()) as _, tagscript, plangsystags.len().try_into().unwrap(), core::mem::transmute(plangsystags.as_ptr()), pctags as _) }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptGetFontProperties(hdc: super::Graphics::Gdi::HDC, psc: *mut *mut core::ffi::c_void, sfp: *mut SCRIPT_FONTPROPERTIES) -> windows_core::HRESULT {
    ...
    unsafe { ScriptGetFontProperties(hdc, psc as _, sfp as _) }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptGetFontScriptTags(hdc: Option<super::Graphics::Gdi::HDC>, psc: *mut *mut core::ffi::c_void, psa: Option<*const SCRIPT_ANALYSIS>, pscripttags: &mut [u32], pctags: *mut i32) -> windows_core::HRESULT {
    ...
    unsafe { ScriptGetFontScriptTags(hdc.unwrap_or(core::mem::zeroed()) as _, psc as _, psa.unwrap_or(core::mem::zeroed()) as _, pscripttags.len().try_into().unwrap(), core::mem::transmute(pscripttags.as_ptr()), pctags as _) }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptGetGlyphABCWidth(hdc: super::Graphics::Gdi::HDC, psc: *mut *mut core::ffi::c_void, wglyph: u16, pabc: *mut super::Graphics::Gdi::ABC) -> windows_core::HRESULT {
    ...
    unsafe { ScriptGetGlyphABCWidth(hdc, psc as _, wglyph, pabc as _) }
}
#[inline]
pub unsafe fn ScriptGetLogicalWidths(psa: *const SCRIPT_ANALYSIS, cchars: i32, cglyphs: i32, piglyphwidth: *const i32, pwlogclust: *const u16, psva: *const SCRIPT_VISATTR, pidx: *const i32) -> windows_core::HRESULT {
    ...
    unsafe { ScriptGetLogicalWidths(psa, cchars, cglyphs, piglyphwidth, pwlogclust, psva, pidx) }
}
#[inline]
...
#[inline]
pub unsafe fn ScriptItemize(pwcinchars: &[u16], pscontrol: Option<*const SCRIPT_CONTROL>, psstate: Option<*const SCRIPT_STATE>, pitems: &mut [SCRIPT_ITEM], pcitems: *mut i32) -> windows_core::HRESULT {
    ...
    unsafe { ScriptItemize(core::mem::transmute(pwcinchars.as_ptr()), pwcinchars.len().try_into().unwrap(), pitems.len().try_into().unwrap(), pscontrol.unwrap_or(core::mem::zeroed()) as _, psstate.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pitems.as_ptr()), pcitems as _) }
}
#[inline]
pub unsafe fn ScriptItemizeOpenType(pwcinchars: &[u16], cmaxitems: i32, pscontrol: Option<*const SCRIPT_CONTROL>, psstate: Option<*const SCRIPT_STATE>, pitems: *mut SCRIPT_ITEM, pscripttags: *mut u32, pcitems: *mut i32) -> windows_core::HRESULT {
    ...
    unsafe { ScriptItemizeOpenType(core::mem::transmute(pwcinchars.as_ptr()), pwcinchars.len().try_into().unwrap(), cmaxitems, pscontrol.unwrap_or(core::mem::zeroed()) as _, psstate.unwrap_or(core::mem::zeroed()) as _, pitems as _, pscripttags as _, pcitems as _) }
}
#[inline]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptPlace(hdc: super::Graphics::Gdi::HDC, psc: *mut *mut core::ffi::c_void, pwglyphs: *const u16, cglyphs: i32, psva: *const SCRIPT_VISATTR, psa: *mut SCRIPT_ANALYSIS, piadvance: *mut i32, pgoffset: Option<*mut GOFFSET>, pabc: *mut super::Graphics::Gdi::ABC) -> windows_core::HRESULT {
    ...
    unsafe { ScriptPlace(hdc, psc as _, pwglyphs, cglyphs, psva, psa as _, piadvance as _, pgoffset.unwrap_or(core::mem::zeroed()) as _, pabc as _) }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptPlaceOpenType<P8>(hdc: Option<super::Graphics::Gdi::HDC>, psc: *mut *mut core::ffi::c_void, psa: *mut SCRIPT_ANALYSIS, tagscript: u32, taglangsys: u32, rcrangechars: Option<*const i32>, rprangeproperties: Option<*const *const TEXTRANGE_PROPERTIES>, cranges: i32, pwcchars: P8, pwlogclust: *const u16, pcharprops: *const SCRIPT_CHARPROP, cchars: i32, pwglyphs: *const u16, pglyphprops: *const SCRIPT_GLYPHPROP, cglyphs: i32, piadvance: *mut i32, pgoffset: *mut GOFFSET, pabc: Option<*mut super::Graphics::Gdi::ABC>) -> windows_core::HRESULT
where
    P8: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { ScriptPlaceOpenType(hdc.unwrap_or(core::mem::zeroed()) as _, psc as _, psa as _, tagscript, taglangsys, rcrangechars.unwrap_or(core::mem::zeroed()) as _, rprangeproperties.unwrap_or(core::mem::zeroed()) as _, cranges, pwcchars.param().abi(), pwlogclust, pcharprops, cchars, pwglyphs, pglyphprops, cglyphs, piadvance as _, pgoffset as _, pabc.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptPositionSingleGlyph(hdc: Option<super::Graphics::Gdi::HDC>, psc: *mut *mut core::ffi::c_void, psa: Option<*const SCRIPT_ANALYSIS>, tagscript: u32, taglangsys: u32, tagfeature: u32, lparameter: i32, wglyphid: u16, iadvance: i32, goffset: GOFFSET, pioutadvance: *mut i32, poutgoffset: *mut GOFFSET) -> windows_core::HRESULT {
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptShape<P2>(hdc: super::Graphics::Gdi::HDC, psc: *mut *mut core::ffi::c_void, pwcchars: P2, cchars: i32, cmaxglyphs: i32, psa: *mut SCRIPT_ANALYSIS, pwoutglyphs: *mut u16, pwlogclust: *mut u16, psva: *mut SCRIPT_VISATTR, pcglyphs: *mut i32) -> windows_core::HRESULT
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { ScriptShape(hdc, psc as _, pwcchars.param().abi(), cchars, cmaxglyphs, psa as _, pwoutglyphs as _, pwlogclust as _, psva as _, pcglyphs as _) }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptShapeOpenType<P8>(hdc: Option<super::Graphics::Gdi::HDC>, psc: *mut *mut core::ffi::c_void, psa: *mut SCRIPT_ANALYSIS, tagscript: u32, taglangsys: u32, rcrangechars: Option<*const i32>, rprangeproperties: Option<*const *const TEXTRANGE_PROPERTIES>, cranges: i32, pwcchars: P8, cchars: i32, cmaxglyphs: i32, pwlogclust: *mut u16, pcharprops: *mut SCRIPT_CHARPROP, pwoutglyphs: *mut u16, poutglyphprops: *mut SCRIPT_GLYPHPROP, pcglyphs: *mut i32) -> windows_core::HRESULT
where
    P8: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { ScriptShapeOpenType(hdc.unwrap_or(core::mem::zeroed()) as _, psc as _, psa as _, tagscript, taglangsys, rcrangechars.unwrap_or(core::mem::zeroed()) as _, rprangeproperties.unwrap_or(core::mem::zeroed()) as _, cranges, pwcchars.param().abi(), cchars, cmaxglyphs, pwlogclust as _, pcharprops as _, pwoutglyphs as _, poutglyphprops as _, pcglyphs as _) }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptStringAnalyse(hdc: super::Graphics::Gdi::HDC, pstring: *const core::ffi::c_void, cstring: i32, cglyphs: i32, icharset: i32, dwflags: u32, ireqwidth: i32, pscontrol: Option<*const SCRIPT_CONTROL>, psstate: Option<*const SCRIPT_STATE>, pidx: Option<*const i32>, ptabdef: Option<*const SCRIPT_TABDEF>, pbinclass: *const u8, pssa: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
    ...
    unsafe { ScriptStringAnalyse(hdc, pstring, cstring, cglyphs, icharset, dwflags, ireqwidth, pscontrol.unwrap_or(core::mem::zeroed()) as _, psstate.unwrap_or(core::mem::zeroed()) as _, pidx.unwrap_or(core::mem::zeroed()) as _, ptabdef.unwrap_or(core::mem::zeroed()) as _, pbinclass, pssa as _) }
}
#[inline]
...
#[inline]
pub unsafe fn ScriptStringFree(pssa: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
    windows_core::link!("usp10.dll" "system" fn ScriptStringFree(pssa : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe { ScriptStringFree(pssa as _) }
}
#[inline]
pub unsafe fn ScriptStringGetLogicalWidths(ssa: *const core::ffi::c_void, pidx: *mut i32) -> windows_core::HRESULT {
    ...
    unsafe { ScriptStringGetLogicalWidths(ssa, pidx as _) }
}
#[inline]
pub unsafe fn ScriptStringGetOrder(ssa: *const core::ffi::c_void, puorder: *mut u32) -> windows_core::HRESULT {
    ...
    unsafe { ScriptStringGetOrder(ssa, puorder as _) }
}
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptStringOut(ssa: *const core::ffi::c_void, ix: i32, iy: i32, uoptions: super::Graphics::Gdi::ETO_OPTIONS, prc: Option<*const super::Foundation::RECT>, iminsel: i32, imaxsel: i32, fdisabled: bool) -> windows_core::HRESULT {
    ...
    unsafe { ScriptStringOut(ssa, ix, iy, uoptions, prc.unwrap_or(core::mem::zeroed()) as _, iminsel, imaxsel, fdisabled.into()) }
}
#[inline]
pub unsafe fn ScriptStringValidate(ssa: *const core::ffi::c_void) -> windows_core::HRESULT {
    windows_core::link!("usp10.dll" "system" fn ScriptStringValidate(ssa : *const core::ffi::c_void) -> windows_core::HRESULT);
    unsafe { ScriptStringValidate(ssa) }
}
#[inline]
pub unsafe fn ScriptStringXtoCP(ssa: *const core::ffi::c_void, ix: i32, pich: *mut i32, pitrailing: *mut i32) -> windows_core::HRESULT {
    ...
    unsafe { ScriptStringXtoCP(ssa, ix, pich as _, pitrailing as _) }
}
#[inline]
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptSubstituteSingleGlyph(hdc: Option<super::Graphics::Gdi::HDC>, psc: *mut *mut core::ffi::c_void, psa: Option<*const SCRIPT_ANALYSIS>, tagscript: u32, taglangsys: u32, tagfeature: u32, lparameter: i32, wglyphid: u16, pwoutglyphid: *mut u16) -> windows_core::HRESULT {
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn ScriptTextOut<P7>(hdc: super::Graphics::Gdi::HDC, psc: *mut *mut core::ffi::c_void, x: i32, y: i32, fuoptions: u32, lprc: Option<*const super::Foundation::RECT>, psa: *const SCRIPT_ANALYSIS, pwcreserved: P7, ireserved: Option<i32>, pwglyphs: *const u16, cglyphs: i32, piadvance: *const i32, pijustify: Option<*const i32>, pgoffset: *const GOFFSET) -> windows_core::HRESULT
where
    P7: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { ScriptTextOut(hdc, psc as _, x, y, fuoptions, lprc.unwrap_or(core::mem::zeroed()) as _, psa, pwcreserved.param().abi(), ireserved.unwrap_or(core::mem::zeroed()) as _, pwglyphs, cglyphs, piadvance, pijustify.unwrap_or(core::mem::zeroed()) as _, pgoffset) }
}
#[inline]
pub unsafe fn ScriptXtoCP(ix: i32, cglyphs: i32, pwlogclust: &[u16], psva: *const SCRIPT_VISATTR, piadvance: *const i32, psa: *const SCRIPT_ANALYSIS, picp: *mut i32, pitrailing: *mut i32) -> windows_core::HRESULT {
    ...
    unsafe { ScriptXtoCP(ix, pwlogclust.len().try_into().unwrap(), cglyphs, core::mem::transmute(pwlogclust.as_ptr()), psva, piadvance, psa, picp as _, pitrailing as _) }
}
#[inline]
...
pub const ALL_SERVICES: u32 = 0;
pub const ALL_SERVICE_TYPES: u32 = 0;
...
pub const CANITER_SKIP_ZEROES: u32 = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const COMPARE_STRING: SYSNLS_FUNCTION = SYSNLS_FUNCTION(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CORRECTIVE_ACTION_DELETE: CORRECTIVE_ACTION = CORRECTIVE_ACTION(3);
pub const CORRECTIVE_ACTION_GET_SUGGESTIONS: CORRECTIVE_ACTION = CORRECTIVE_ACTION(1);
pub const CORRECTIVE_ACTION_NONE: CORRECTIVE_ACTION = CORRECTIVE_ACTION(0);
pub const CORRECTIVE_ACTION_REPLACE: CORRECTIVE_ACTION = CORRECTIVE_ACTION(2);
#[repr(C)]
...
pub const CPIOD_FORCE_PROMPT: i32 = -2147483648;
pub const CPIOD_PEEK: i32 = 1073741824;
pub const CP_ACP: u32 = 0;
pub const CP_INSTALLED: ENUM_SYSTEM_CODE_PAGES_FLAGS = ENUM_SYSTEM_CODE_PAGES_FLAGS(1);
pub const CP_MACCP: u32 = 2;
pub const CP_OEMCP: u32 = 1;
pub const CP_SUPPORTED: ENUM_SYSTEM_CODE_PAGES_FLAGS = ENUM_SYSTEM_CODE_PAGES_FLAGS(2);
pub const CP_SYMBOL: u32 = 42;
pub const CP_THREAD_ACP: u32 = 3;
pub const CP_UTF7: u32 = 65000;
pub const CP_UTF8: u32 = 65001;
pub const CSTR_EQUAL: COMPARESTRING_RESULT = COMPARESTRING_RESULT(2);
pub const CSTR_GREATER_THAN: COMPARESTRING_RESULT = COMPARESTRING_RESULT(3);
pub const CSTR_LESS_THAN: COMPARESTRING_RESULT = COMPARESTRING_RESULT(1);
...
pub const DATE_AUTOLAYOUT: ENUM_DATE_FORMATS_FLAGS = ENUM_DATE_FORMATS_FLAGS(64);
pub const DATE_LONGDATE: ENUM_DATE_FORMATS_FLAGS = ENUM_DATE_FORMATS_FLAGS(2);
pub const DATE_LTRREADING: ENUM_DATE_FORMATS_FLAGS = ENUM_DATE_FORMATS_FLAGS(16);
pub const DATE_MONTHDAY: ENUM_DATE_FORMATS_FLAGS = ENUM_DATE_FORMATS_FLAGS(128);
pub const DATE_RTLREADING: ENUM_DATE_FORMATS_FLAGS = ENUM_DATE_FORMATS_FLAGS(32);
pub const DATE_SHORTDATE: ENUM_DATE_FORMATS_FLAGS = ENUM_DATE_FORMATS_FLAGS(1);
pub const DATE_USE_ALT_CALENDAR: ENUM_DATE_FORMATS_FLAGS = ENUM_DATE_FORMATS_FLAGS(4);
pub const DATE_YEARMONTH: ENUM_DATE_FORMATS_FLAGS = ENUM_DATE_FORMATS_FLAGS(8);
pub const DayUnit: CALDATETIME_DATEUNIT = CALDATETIME_DATEUNIT(4);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const EraUnit: CALDATETIME_DATEUNIT = CALDATETIME_DATEUNIT(0);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const GEOCLASS_ALL: SYSGEOCLASS = SYSGEOCLASS(0);
pub const GEOCLASS_NATION: SYSGEOCLASS = SYSGEOCLASS(16);
pub const GEOCLASS_REGION: SYSGEOCLASS = SYSGEOCLASS(14);
pub const GEOID_NOT_AVAILABLE: i32 = -1;
pub const GEO_CURRENCYCODE: SYSGEOTYPE = SYSGEOTYPE(15);
pub const GEO_CURRENCYSYMBOL: SYSGEOTYPE = SYSGEOTYPE(16);
pub const GEO_DIALINGCODE: SYSGEOTYPE = SYSGEOTYPE(14);
...
pub const GEO_FRIENDLYNAME: SYSGEOTYPE = SYSGEOTYPE(8);
pub const GEO_ID: SYSGEOTYPE = SYSGEOTYPE(18);
pub const GEO_ISO2: SYSGEOTYPE = SYSGEOTYPE(4);
pub const GEO_ISO3: SYSGEOTYPE = SYSGEOTYPE(5);
pub const GEO_ISO_UN_NUMBER: SYSGEOTYPE = SYSGEOTYPE(12);
pub const GEO_LATITUDE: SYSGEOTYPE = SYSGEOTYPE(2);
pub const GEO_LCID: SYSGEOTYPE = SYSGEOTYPE(7);
pub const GEO_LONGITUDE: SYSGEOTYPE = SYSGEOTYPE(3);
pub const GEO_NAME: SYSGEOTYPE = SYSGEOTYPE(17);
pub const GEO_NATION: SYSGEOTYPE = SYSGEOTYPE(1);
pub const GEO_OFFICIALLANGUAGES: SYSGEOTYPE = SYSGEOTYPE(11);
pub const GEO_OFFICIALNAME: SYSGEOTYPE = SYSGEOTYPE(9);
pub const GEO_PARENT: SYSGEOTYPE = SYSGEOTYPE(13);
pub const GEO_RFC1766: SYSGEOTYPE = SYSGEOTYPE(6);
pub const GEO_TIMEZONES: SYSGEOTYPE = SYSGEOTYPE(10);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
pub struct GOFFSET {
    pub du: i32,
...
pub const HIGHLEVEL_SERVICE_TYPES: u32 = 1;
...
pub const HourUnit: CALDATETIME_DATEUNIT = CALDATETIME_DATEUNIT(5);
...
impl IMLangConvertCharset {
    ...
    pub unsafe fn DoConversionToUnicode<P0>(&self, psrcstr: P0, pcsrcsize: Option<*mut u32>, pdststr: windows_core::PWSTR, pcdstsize: Option<*mut u32>) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DoConversionToUnicode)(windows_core::Interface::as_raw(self), psrcstr.param().abi(), pcsrcsize.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pdststr), pcdstsize.unwrap_or(core::mem::zeroed()) as _) }
    }
    pub unsafe fn DoConversionFromUnicode<P0>(&self, psrcstr: P0, pcsrcsize: Option<*mut u32>, pdststr: windows_core::PSTR, pcdstsize: Option<*mut u32>) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DoConversionFromUnicode)(windows_core::Interface::as_raw(self), psrcstr.param().abi(), pcsrcsize.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pdststr), pcdstsize.unwrap_or(core::mem::zeroed()) as _) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IMLangFontLink {
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn GetFontCodePages(&self, hdc: super::Graphics::Gdi::HDC, hfont: super::Graphics::Gdi::HFONT, pdwcodepages: Option<*mut u32>) -> windows_core::HRESULT {
    ...
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn MapFont(&self, hdc: super::Graphics::Gdi::HDC, dwcodepages: u32, hsrcfont: super::Graphics::Gdi::HFONT, phdestfont: Option<*mut super::Graphics::Gdi::HFONT>) -> windows_core::HRESULT {
    ...
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn ReleaseFont(&self, hfont: super::Graphics::Gdi::HFONT) -> windows_core::HRESULT {
...
impl IMLangFontLink2 {
    ...
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn MapFont(&self, hdc: super::Graphics::Gdi::HDC, dwcodepages: u32, chsrc: u16, pfont: Option<*mut super::Graphics::Gdi::HFONT>) -> windows_core::HRESULT {
    ...
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn GetFontUnicodeRanges(&self, hdc: super::Graphics::Gdi::HDC, puiranges: *const u32, puranges: Option<*mut UNICODERANGE>) -> windows_core::HRESULT {
    ...
    pub unsafe fn GetScriptFontInfo(&self, sid: u8, dwflags: u32, puifonts: *mut u32, pscriptfont: Option<*mut SCRIPTFONTINFO>) -> windows_core::HRESULT {
...
impl IMLangLineBreakConsole {
    ...
    pub unsafe fn BreakLineW(&self, locale: u32, pszsrc: &[u16], cmaxcolumns: i32, pcchline: Option<*mut i32>, pcchskip: Option<*mut i32>) -> windows_core::HRESULT {
    ...
    pub unsafe fn BreakLineA(&self, locale: u32, ucodepage: u32, pszsrc: &[u8], cmaxcolumns: i32, pcchline: Option<*mut i32>, pcchskip: Option<*mut i32>) -> windows_core::HRESULT {
...
impl IMLangStringAStr {
    ...
    pub unsafe fn LockAStr(&self, lsrcpos: i32, lsrclen: i32, lflags: i32, ucodepagein: u32, cchrequest: i32, pucodepageout: Option<*mut u32>, ppszdest: Option<*mut windows_core::PSTR>, pcchdest: Option<*mut i32>, pldestlen: Option<*mut i32>) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).LockAStr)(windows_core::Interface::as_raw(self), lsrcpos, lsrclen, lflags, ucodepagein, cchrequest, pucodepageout.unwrap_or(core::mem::zeroed()) as _, ppszdest.unwrap_or(core::mem::zeroed()) as _, pcchdest.unwrap_or(core::mem::zeroed()) as _, pldestlen.unwrap_or(core::mem::zeroed()) as _) }
    }
    ...
    pub unsafe fn SetLocale(&self, ldestpos: i32, ldestlen: i32, locale: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetLocale)(windows_core::Interface::as_raw(self), ldestpos, ldestlen, locale) }
    }
    pub unsafe fn GetLocale(&self, lsrcpos: i32, lsrcmaxlen: i32, plocale: Option<*mut u32>, pllocalepos: Option<*mut i32>, pllocalelen: Option<*mut i32>) -> windows_core::HRESULT {
...
impl IMLangStringBufA {
    ...
    pub unsafe fn UnlockBuf<P0>(&self, pszbuf: P0, cchoffset: i32, cchwrite: i32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).UnlockBuf)(windows_core::Interface::as_raw(self), pszbuf.param().abi(), cchoffset, cchwrite) }
    }
...
impl IMLangStringWStr {
    ...
    pub unsafe fn LockWStr(&self, lsrcpos: i32, lsrclen: i32, lflags: i32, cchrequest: i32, ppszdest: Option<*mut windows_core::PWSTR>, pcchdest: Option<*mut i32>, pldestlen: Option<*mut i32>) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).LockWStr)(windows_core::Interface::as_raw(self), lsrcpos, lsrclen, lflags, cchrequest, ppszdest.unwrap_or(core::mem::zeroed()) as _, pcchdest.unwrap_or(core::mem::zeroed()) as _, pldestlen.unwrap_or(core::mem::zeroed()) as _) }
    }
...
impl IMultiLanguage {
    ...
    pub unsafe fn ConvertStringToUnicode<P2>(&self, pdwmode: Option<*mut u32>, dwencoding: u32, psrcstr: P2, pcsrcsize: Option<*mut u32>, pdststr: Option<windows_core::PWSTR>, pcdstsize: Option<*mut u32>) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).ConvertStringToUnicode)(windows_core::Interface::as_raw(self), pdwmode.unwrap_or(core::mem::zeroed()) as _, dwencoding, psrcstr.param().abi(), pcsrcsize.unwrap_or(core::mem::zeroed()) as _, pdststr.unwrap_or(core::mem::zeroed()) as _, pcdstsize.unwrap_or(core::mem::zeroed()) as _) }
    }
    pub unsafe fn ConvertStringFromUnicode<P2>(&self, pdwmode: Option<*mut u32>, dwencoding: u32, psrcstr: P2, pcsrcsize: Option<*mut u32>, pdststr: Option<windows_core::PSTR>, pcdstsize: Option<*mut u32>) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).ConvertStringFromUnicode)(windows_core::Interface::as_raw(self), pdwmode.unwrap_or(core::mem::zeroed()) as _, dwencoding, psrcstr.param().abi(), pcsrcsize.unwrap_or(core::mem::zeroed()) as _, pdststr.unwrap_or(core::mem::zeroed()) as _, pcdstsize.unwrap_or(core::mem::zeroed()) as _) }
    }
    ...
    pub unsafe fn GetLcidFromRfc1766(&self, plocale: *mut u32, bstrrfc1766: &windows_core::BSTR) -> windows_core::HRESULT {
    ...
    pub unsafe fn GetRfc1766Info(&self, locale: u32, prfc1766info: *mut RFC1766INFO) -> windows_core::HRESULT {
...
impl IMultiLanguage2 {
    ...
    pub unsafe fn GetCodePageInfo(&self, uicodepage: u32, langid: u16, pcodepageinfo: *mut MIMECPINFO) -> windows_core::HRESULT {
    ...
    pub unsafe fn GetRfc1766Info(&self, locale: u32, langid: u16, prfc1766info: *mut RFC1766INFO) -> windows_core::HRESULT {
    ...
    pub unsafe fn ConvertStringInIStream<P2, P5, P6>(&self, pdwmode: Option<*mut u32>, dwflag: u32, lpfallback: P2, dwsrcencoding: u32, dwdstencoding: u32, pstmin: P5, pstmout: P6) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
        P5: windows_core::Param<super::System::Com::IStream>,
        P6: windows_core::Param<super::System::Com::IStream>,
    {
        unsafe { (windows_core::Interface::vtable(self).ConvertStringInIStream)(windows_core::Interface::as_raw(self), pdwmode.unwrap_or(core::mem::zeroed()) as _, dwflag, lpfallback.param().abi(), dwsrcencoding, dwdstencoding, pstmin.param().abi(), pstmout.param().abi()) }
    }
    pub unsafe fn ConvertStringToUnicodeEx<P2, P7>(&self, pdwmode: Option<*mut u32>, dwencoding: u32, psrcstr: P2, pcsrcsize: Option<*mut u32>, pdststr: windows_core::PWSTR, pcdstsize: Option<*mut u32>, dwflag: u32, lpfallback: P7) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCSTR>,
        P7: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).ConvertStringToUnicodeEx)(windows_core::Interface::as_raw(self), pdwmode.unwrap_or(core::mem::zeroed()) as _, dwencoding, psrcstr.param().abi(), pcsrcsize.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pdststr), pcdstsize.unwrap_or(core::mem::zeroed()) as _, dwflag, lpfallback.param().abi()) }
    }
    pub unsafe fn ConvertStringFromUnicodeEx<P2, P7>(&self, pdwmode: Option<*mut u32>, dwencoding: u32, psrcstr: P2, pcsrcsize: Option<*mut u32>, pdststr: windows_core::PSTR, pcdstsize: Option<*mut u32>, dwflag: u32, lpfallback: P7) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
        P7: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn DetectInputCodepage<P2>(&self, dwflag: u32, dwprefwincodepage: u32, psrcstr: P2, pcsrcsize: *mut i32, lpencoding: *mut DetectEncodingInfo, pnscores: *mut i32) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DetectInputCodepage)(windows_core::Interface::as_raw(self), dwflag, dwprefwincodepage, psrcstr.param().abi(), pcsrcsize as _, lpencoding as _, pnscores as _) }
    }
    pub unsafe fn ValidateCodePage(&self, uicodepage: u32, hwnd: super::Foundation::HWND) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).ValidateCodePage)(windows_core::Interface::as_raw(self), uicodepage, hwnd) }
    }
    pub unsafe fn GetCodePageDescription(&self, uicodepage: u32, lcid: u32, lpwidecharstr: &mut [u16]) -> windows_core::HRESULT {
    ...
    pub unsafe fn ValidateCodePageEx(&self, uicodepage: u32, hwnd: super::Foundation::HWND, dwfiodcontrol: u32) -> windows_core::HRESULT {
...
pub const IS_TEXT_UNICODE_ASCII16: IS_TEXT_UNICODE_RESULT = IS_TEXT_UNICODE_RESULT(1);
pub const IS_TEXT_UNICODE_CONTROLS: IS_TEXT_UNICODE_RESULT = IS_TEXT_UNICODE_RESULT(4);
pub const IS_TEXT_UNICODE_ILLEGAL_CHARS: IS_TEXT_UNICODE_RESULT = IS_TEXT_UNICODE_RESULT(256);
pub const IS_TEXT_UNICODE_NOT_ASCII_MASK: IS_TEXT_UNICODE_RESULT = IS_TEXT_UNICODE_RESULT(61440);
pub const IS_TEXT_UNICODE_NOT_UNICODE_MASK: IS_TEXT_UNICODE_RESULT = IS_TEXT_UNICODE_RESULT(3840);
pub const IS_TEXT_UNICODE_NULL_BYTES: IS_TEXT_UNICODE_RESULT = IS_TEXT_UNICODE_RESULT(4096);
pub const IS_TEXT_UNICODE_ODD_LENGTH: IS_TEXT_UNICODE_RESULT = IS_TEXT_UNICODE_RESULT(512);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const IS_TEXT_UNICODE_REVERSE_ASCII16: IS_TEXT_UNICODE_RESULT = IS_TEXT_UNICODE_RESULT(16);
pub const IS_TEXT_UNICODE_REVERSE_CONTROLS: IS_TEXT_UNICODE_RESULT = IS_TEXT_UNICODE_RESULT(64);
pub const IS_TEXT_UNICODE_REVERSE_MASK: IS_TEXT_UNICODE_RESULT = IS_TEXT_UNICODE_RESULT(240);
pub const IS_TEXT_UNICODE_REVERSE_SIGNATURE: IS_TEXT_UNICODE_RESULT = IS_TEXT_UNICODE_RESULT(128);
pub const IS_TEXT_UNICODE_REVERSE_STATISTICS: IS_TEXT_UNICODE_RESULT = IS_TEXT_UNICODE_RESULT(32);
pub const IS_TEXT_UNICODE_SIGNATURE: IS_TEXT_UNICODE_RESULT = IS_TEXT_UNICODE_RESULT(8);
pub const IS_TEXT_UNICODE_STATISTICS: IS_TEXT_UNICODE_RESULT = IS_TEXT_UNICODE_RESULT(2);
pub const IS_TEXT_UNICODE_UNICODE_MASK: IS_TEXT_UNICODE_RESULT = IS_TEXT_UNICODE_RESULT(15);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
impl ISpellCheckProvider {
    ...
    pub unsafe fn SetOptionValue<P0>(&self, optionid: P0, value: u8) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetOptionValue)(windows_core::Interface::as_raw(self), optionid.param().abi(), value) }
    }
    #[cfg(feature = "Win32_System_Com")]
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn InitializeWordlist<P1>(&self, wordlisttype: WORDLIST_TYPE, words: P1) -> windows_core::HRESULT
    where
        P1: windows_core::Param<super::System::Com::IEnumString>,
    {
        unsafe { (windows_core::Interface::vtable(self).InitializeWordlist)(windows_core::Interface::as_raw(self), wordlisttype, words.param().abi()) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
pub const LCID_INSTALLED: IS_VALID_LOCALE_FLAGS = IS_VALID_LOCALE_FLAGS(1);
pub const LCID_SUPPORTED: IS_VALID_LOCALE_FLAGS = IS_VALID_LOCALE_FLAGS(2);
...
pub const LGRPID_INSTALLED: ENUM_SYSTEM_LANGUAGE_GROUPS_FLAGS = ENUM_SYSTEM_LANGUAGE_GROUPS_FLAGS(1);
pub const LGRPID_JAPANESE: u32 = 7;
pub const LGRPID_KOREAN: u32 = 8;
pub const LGRPID_SIMPLIFIED_CHINESE: u32 = 10;
pub const LGRPID_SUPPORTED: ENUM_SYSTEM_LANGUAGE_GROUPS_FLAGS = ENUM_SYSTEM_LANGUAGE_GROUPS_FLAGS(2);
...
pub const LINGUISTIC_IGNORECASE: COMPARE_STRING_FLAGS = COMPARE_STRING_FLAGS(16);
pub const LINGUISTIC_IGNOREDIACRITIC: COMPARE_STRING_FLAGS = COMPARE_STRING_FLAGS(32);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const LOWLEVEL_SERVICE_TYPES: u32 = 2;
...
pub const MAP_COMPOSITE: FOLD_STRING_MAP_FLAGS = FOLD_STRING_MAP_FLAGS(64);
pub const MAP_EXPAND_LIGATURES: FOLD_STRING_MAP_FLAGS = FOLD_STRING_MAP_FLAGS(8192);
pub const MAP_FOLDCZONE: FOLD_STRING_MAP_FLAGS = FOLD_STRING_MAP_FLAGS(16);
pub const MAP_FOLDDIGITS: FOLD_STRING_MAP_FLAGS = FOLD_STRING_MAP_FLAGS(128);
pub const MAP_PRECOMPOSED: FOLD_STRING_MAP_FLAGS = FOLD_STRING_MAP_FLAGS(32);
...
pub const MB_COMPOSITE: MULTI_BYTE_TO_WIDE_CHAR_FLAGS = MULTI_BYTE_TO_WIDE_CHAR_FLAGS(2);
pub const MB_ERR_INVALID_CHARS: MULTI_BYTE_TO_WIDE_CHAR_FLAGS = MULTI_BYTE_TO_WIDE_CHAR_FLAGS(8);
pub const MB_PRECOMPOSED: MULTI_BYTE_TO_WIDE_CHAR_FLAGS = MULTI_BYTE_TO_WIDE_CHAR_FLAGS(1);
pub const MB_USEGLYPHCHARS: MULTI_BYTE_TO_WIDE_CHAR_FLAGS = MULTI_BYTE_TO_WIDE_CHAR_FLAGS(4);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct MIMECONTF(pub i32);
pub const MIMECONTF_BROWSER: MIMECONTF = MIMECONTF(2);
pub const MIMECONTF_EXPORT: MIMECONTF = MIMECONTF(1024);
pub const MIMECONTF_IMPORT: MIMECONTF = MIMECONTF(8);
pub const MIMECONTF_MAILNEWS: MIMECONTF = MIMECONTF(1);
pub const MIMECONTF_MIME_IE4: MIMECONTF = MIMECONTF(268435456);
pub const MIMECONTF_MIME_LATEST: MIMECONTF = MIMECONTF(536870912);
pub const MIMECONTF_MIME_REGISTRY: MIMECONTF = MIMECONTF(1073741824);
pub const MIMECONTF_MINIMAL: MIMECONTF = MIMECONTF(4);
pub const MIMECONTF_PRIVCONVERTER: MIMECONTF = MIMECONTF(65536);
pub const MIMECONTF_SAVABLE_BROWSER: MIMECONTF = MIMECONTF(512);
pub const MIMECONTF_SAVABLE_MAILNEWS: MIMECONTF = MIMECONTF(256);
pub const MIMECONTF_VALID: MIMECONTF = MIMECONTF(131072);
pub const MIMECONTF_VALID_NLS: MIMECONTF = MIMECONTF(262144);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const MLCONVCHARF_AUTODETECT: MLCONVCHAR = MLCONVCHAR(1);
pub const MLCONVCHARF_DETECTJPN: MLCONVCHAR = MLCONVCHAR(32);
pub const MLCONVCHARF_ENTITIZE: MLCONVCHAR = MLCONVCHAR(2);
pub const MLCONVCHARF_NAME_ENTITIZE: MLCONVCHAR = MLCONVCHAR(4);
pub const MLCONVCHARF_NCR_ENTITIZE: MLCONVCHAR = MLCONVCHAR(2);
pub const MLCONVCHARF_NOBESTFITCHARS: MLCONVCHAR = MLCONVCHAR(16);
pub const MLCONVCHARF_USEDEFCHAR: MLCONVCHAR = MLCONVCHAR(8);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const MLDETECTCP_7BIT: MLDETECTCP = MLDETECTCP(1);
pub const MLDETECTCP_8BIT: MLDETECTCP = MLDETECTCP(2);
pub const MLDETECTCP_DBCS: MLDETECTCP = MLDETECTCP(4);
pub const MLDETECTCP_HTML: MLDETECTCP = MLDETECTCP(8);
pub const MLDETECTCP_NONE: MLDETECTCP = MLDETECTCP(0);
pub const MLDETECTCP_NUMBER: MLDETECTCP = MLDETECTCP(16);
pub const MLDETECTF_BROWSER: MLCP = MLCP(2);
pub const MLDETECTF_EURO_UTF8: MLCP = MLCP(128);
pub const MLDETECTF_FILTER_SPECIALCHAR: MLCP = MLCP(64);
pub const MLDETECTF_MAILNEWS: MLCP = MLCP(1);
pub const MLDETECTF_PREFERRED_ONLY: MLCP = MLCP(32);
pub const MLDETECTF_PRESERVE_ORDER: MLCP = MLCP(16);
pub const MLDETECTF_VALID: MLCP = MLCP(4);
pub const MLDETECTF_VALID_NLS: MLCP = MLCP(8);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct MLSTR_FLAGS(pub i32);
pub const MLSTR_READ: MLSTR_FLAGS = MLSTR_FLAGS(1);
pub const MLSTR_WRITE: MLSTR_FLAGS = MLSTR_FLAGS(2);
...
pub const MUI_LANGUAGE_EXACT: u32 = 16;
...
pub const MinuteUnit: CALDATETIME_DATEUNIT = CALDATETIME_DATEUNIT(6);
pub const MonthUnit: CALDATETIME_DATEUNIT = CALDATETIME_DATEUNIT(2);
#[repr(C)]
#[cfg(feature = "Win32_Graphics_Gdi")]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const NLS_CP_CPINFO: u32 = 268435456;
pub const NLS_CP_MBTOWC: u32 = 1073741824;
pub const NLS_CP_WCTOMB: u32 = 2147483648;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NORM_FORM(pub i32);
pub const NORM_IGNORECASE: COMPARE_STRING_FLAGS = COMPARE_STRING_FLAGS(1);
pub const NORM_IGNOREKANATYPE: COMPARE_STRING_FLAGS = COMPARE_STRING_FLAGS(65536);
pub const NORM_IGNORENONSPACE: COMPARE_STRING_FLAGS = COMPARE_STRING_FLAGS(2);
pub const NORM_IGNORESYMBOLS: COMPARE_STRING_FLAGS = COMPARE_STRING_FLAGS(4);
pub const NORM_IGNOREWIDTH: COMPARE_STRING_FLAGS = COMPARE_STRING_FLAGS(131072);
pub const NORM_LINGUISTIC_CASING: COMPARE_STRING_FLAGS = COMPARE_STRING_FLAGS(134217728);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const NUMSYS_NAME_CAPACITY: u32 = 8;
pub const NormalizationC: NORM_FORM = NORM_FORM(1);
pub const NormalizationD: NORM_FORM = NORM_FORM(2);
pub const NormalizationKC: NORM_FORM = NORM_FORM(5);
pub const NormalizationKD: NORM_FORM = NORM_FORM(6);
pub const NormalizationOther: NORM_FORM = NORM_FORM(0);
pub const OFFLINE_SERVICES: u32 = 2;
pub const ONLINE_SERVICES: u32 = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const SCRIPTCONTF_FIXED_FONT: SCRIPTFONTCONTF = SCRIPTFONTCONTF(1);
pub const SCRIPTCONTF_PROPORTIONAL_FONT: SCRIPTFONTCONTF = SCRIPTFONTCONTF(2);
pub const SCRIPTCONTF_SCRIPT_HIDE: SCRIPTFONTCONTF = SCRIPTFONTCONTF(131072);
pub const SCRIPTCONTF_SCRIPT_SYSTEM: SCRIPTFONTCONTF = SCRIPTFONTCONTF(262144);
pub const SCRIPTCONTF_SCRIPT_USER: SCRIPTFONTCONTF = SCRIPTFONTCONTF(65536);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const SCRIPT_JUSTIFY_ARABIC_ALEF: SCRIPT_JUSTIFY = SCRIPT_JUSTIFY(9);
pub const SCRIPT_JUSTIFY_ARABIC_BA: SCRIPT_JUSTIFY = SCRIPT_JUSTIFY(12);
pub const SCRIPT_JUSTIFY_ARABIC_BARA: SCRIPT_JUSTIFY = SCRIPT_JUSTIFY(13);
pub const SCRIPT_JUSTIFY_ARABIC_BLANK: SCRIPT_JUSTIFY = SCRIPT_JUSTIFY(1);
pub const SCRIPT_JUSTIFY_ARABIC_HA: SCRIPT_JUSTIFY = SCRIPT_JUSTIFY(10);
pub const SCRIPT_JUSTIFY_ARABIC_KASHIDA: SCRIPT_JUSTIFY = SCRIPT_JUSTIFY(8);
pub const SCRIPT_JUSTIFY_ARABIC_NORMAL: SCRIPT_JUSTIFY = SCRIPT_JUSTIFY(7);
pub const SCRIPT_JUSTIFY_ARABIC_RA: SCRIPT_JUSTIFY = SCRIPT_JUSTIFY(11);
pub const SCRIPT_JUSTIFY_ARABIC_SEEN: SCRIPT_JUSTIFY = SCRIPT_JUSTIFY(14);
pub const SCRIPT_JUSTIFY_ARABIC_SEEN_M: SCRIPT_JUSTIFY = SCRIPT_JUSTIFY(15);
pub const SCRIPT_JUSTIFY_BLANK: SCRIPT_JUSTIFY = SCRIPT_JUSTIFY(4);
pub const SCRIPT_JUSTIFY_CHARACTER: SCRIPT_JUSTIFY = SCRIPT_JUSTIFY(2);
pub const SCRIPT_JUSTIFY_NONE: SCRIPT_JUSTIFY = SCRIPT_JUSTIFY(0);
pub const SCRIPT_JUSTIFY_RESERVED1: SCRIPT_JUSTIFY = SCRIPT_JUSTIFY(3);
pub const SCRIPT_JUSTIFY_RESERVED2: SCRIPT_JUSTIFY = SCRIPT_JUSTIFY(5);
pub const SCRIPT_JUSTIFY_RESERVED3: SCRIPT_JUSTIFY = SCRIPT_JUSTIFY(6);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const SIC_ASCIIDIGIT: SCRIPT_IS_COMPLEX_FLAGS = SCRIPT_IS_COMPLEX_FLAGS(2);
pub const SIC_COMPLEX: SCRIPT_IS_COMPLEX_FLAGS = SCRIPT_IS_COMPLEX_FLAGS(1);
pub const SIC_NEUTRAL: SCRIPT_IS_COMPLEX_FLAGS = SCRIPT_IS_COMPLEX_FLAGS(4);
pub const SORTING_PARADIGM_ICU: u32 = 16777216;
pub const SORTING_PARADIGM_NLS: u32 = 0;
pub const SORT_DIGITSASNUMBERS: COMPARE_STRING_FLAGS = COMPARE_STRING_FLAGS(8);
pub const SORT_STRINGSORT: COMPARE_STRING_FLAGS = COMPARE_STRING_FLAGS(4096);
...
pub const SecondUnit: CALDATETIME_DATEUNIT = CALDATETIME_DATEUNIT(7);
pub const SpellCheckerFactory: windows_core::GUID = windows_core::GUID::from_u128(0x7ab36653_1796_484b_bdfa_e74f1db7c1dc);
pub const TCI_SRCCHARSET: TRANSLATE_CHARSET_INFO_FLAGS = TRANSLATE_CHARSET_INFO_FLAGS(1);
pub const TCI_SRCCODEPAGE: TRANSLATE_CHARSET_INFO_FLAGS = TRANSLATE_CHARSET_INFO_FLAGS(2);
pub const TCI_SRCFONTSIG: TRANSLATE_CHARSET_INFO_FLAGS = TRANSLATE_CHARSET_INFO_FLAGS(3);
pub const TCI_SRCLOCALE: TRANSLATE_CHARSET_INFO_FLAGS = TRANSLATE_CHARSET_INFO_FLAGS(4096);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const TIME_FORCE24HOURFORMAT: TIME_FORMAT_FLAGS = TIME_FORMAT_FLAGS(8);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const TIME_NOMINUTESORSECONDS: TIME_FORMAT_FLAGS = TIME_FORMAT_FLAGS(1);
pub const TIME_NOSECONDS: TIME_FORMAT_FLAGS = TIME_FORMAT_FLAGS(2);
pub const TIME_NOTIMEMARKER: TIME_FORMAT_FLAGS = TIME_FORMAT_FLAGS(4);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct TRANSLATE_CHARSET_INFO_FLAGS(pub u32);
pub const TickUnit: CALDATETIME_DATEUNIT = CALDATETIME_DATEUNIT(8);
...
pub const UBIDI_LOGICAL: UBiDiOrder = UBiDiOrder(0);
pub const UBIDI_LTR: UBiDiDirection = UBiDiDirection(0);
pub const UBIDI_MAP_NOWHERE: i32 = -1;
pub const UBIDI_MAX_EXPLICIT_LEVEL: u32 = 125;
pub const UBIDI_MIRRORING_OFF: UBiDiMirroring = UBiDiMirroring(0);
pub const UBIDI_MIRRORING_ON: UBiDiMirroring = UBiDiMirroring(1);
pub const UBIDI_MIXED: UBiDiDirection = UBiDiDirection(2);
pub const UBIDI_NEUTRAL: UBiDiDirection = UBiDiDirection(3);
pub const UBIDI_OPTION_DEFAULT: UBiDiReorderingOption = UBiDiReorderingOption(0);
pub const UBIDI_OPTION_INSERT_MARKS: UBiDiReorderingOption = UBiDiReorderingOption(1);
pub const UBIDI_OPTION_REMOVE_CONTROLS: UBiDiReorderingOption = UBiDiReorderingOption(2);
pub const UBIDI_OPTION_STREAMING: UBiDiReorderingOption = UBiDiReorderingOption(4);
pub const UBIDI_OUTPUT_REVERSE: u32 = 16;
pub const UBIDI_REMOVE_BIDI_CONTROLS: u32 = 8;
pub const UBIDI_REORDER_DEFAULT: UBiDiReorderingMode = UBiDiReorderingMode(0);
pub const UBIDI_REORDER_GROUP_NUMBERS_WITH_R: UBiDiReorderingMode = UBiDiReorderingMode(2);
pub const UBIDI_REORDER_INVERSE_FOR_NUMBERS_SPECIAL: UBiDiReorderingMode = UBiDiReorderingMode(6);
pub const UBIDI_REORDER_INVERSE_LIKE_DIRECT: UBiDiReorderingMode = UBiDiReorderingMode(5);
pub const UBIDI_REORDER_INVERSE_NUMBERS_AS_L: UBiDiReorderingMode = UBiDiReorderingMode(4);
pub const UBIDI_REORDER_NUMBERS_SPECIAL: UBiDiReorderingMode = UBiDiReorderingMode(1);
pub const UBIDI_REORDER_RUNS_ONLY: UBiDiReorderingMode = UBiDiReorderingMode(3);
pub const UBIDI_RTL: UBiDiDirection = UBiDiDirection(1);
pub const UBIDI_VISUAL: UBiDiOrder = UBiDiOrder(1);
pub const UBLOCK_ADLAM: UBlockCode = UBlockCode(263);
pub const UBLOCK_AEGEAN_NUMBERS: UBlockCode = UBlockCode(119);
pub const UBLOCK_AHOM: UBlockCode = UBlockCode(253);
pub const UBLOCK_ALCHEMICAL_SYMBOLS: UBlockCode = UBlockCode(208);
pub const UBLOCK_ALPHABETIC_PRESENTATION_FORMS: UBlockCode = UBlockCode(80);
pub const UBLOCK_ANATOLIAN_HIEROGLYPHS: UBlockCode = UBlockCode(254);
pub const UBLOCK_ANCIENT_GREEK_MUSICAL_NOTATION: UBlockCode = UBlockCode(126);
pub const UBLOCK_ANCIENT_GREEK_NUMBERS: UBlockCode = UBlockCode(127);
pub const UBLOCK_ANCIENT_SYMBOLS: UBlockCode = UBlockCode(165);
pub const UBLOCK_ARABIC: UBlockCode = UBlockCode(12);
pub const UBLOCK_ARABIC_EXTENDED_A: UBlockCode = UBlockCode(210);
pub const UBLOCK_ARABIC_MATHEMATICAL_ALPHABETIC_SYMBOLS: UBlockCode = UBlockCode(211);
pub const UBLOCK_ARABIC_PRESENTATION_FORMS_A: UBlockCode = UBlockCode(81);
pub const UBLOCK_ARABIC_PRESENTATION_FORMS_B: UBlockCode = UBlockCode(85);
pub const UBLOCK_ARABIC_SUPPLEMENT: UBlockCode = UBlockCode(128);
pub const UBLOCK_ARMENIAN: UBlockCode = UBlockCode(10);
pub const UBLOCK_ARROWS: UBlockCode = UBlockCode(46);
pub const UBLOCK_AVESTAN: UBlockCode = UBlockCode(188);
pub const UBLOCK_BALINESE: UBlockCode = UBlockCode(147);
pub const UBLOCK_BAMUM: UBlockCode = UBlockCode(177);
pub const UBLOCK_BAMUM_SUPPLEMENT: UBlockCode = UBlockCode(202);
pub const UBLOCK_BASIC_LATIN: UBlockCode = UBlockCode(1);
pub const UBLOCK_BASSA_VAH: UBlockCode = UBlockCode(221);
pub const UBLOCK_BATAK: UBlockCode = UBlockCode(199);
pub const UBLOCK_BENGALI: UBlockCode = UBlockCode(16);
pub const UBLOCK_BHAIKSUKI: UBlockCode = UBlockCode(264);
pub const UBLOCK_BLOCK_ELEMENTS: UBlockCode = UBlockCode(53);
pub const UBLOCK_BOPOMOFO: UBlockCode = UBlockCode(64);
pub const UBLOCK_BOPOMOFO_EXTENDED: UBlockCode = UBlockCode(67);
pub const UBLOCK_BOX_DRAWING: UBlockCode = UBlockCode(52);
pub const UBLOCK_BRAHMI: UBlockCode = UBlockCode(201);
pub const UBLOCK_BRAILLE_PATTERNS: UBlockCode = UBlockCode(57);
pub const UBLOCK_BUGINESE: UBlockCode = UBlockCode(129);
pub const UBLOCK_BUHID: UBlockCode = UBlockCode(100);
pub const UBLOCK_BYZANTINE_MUSICAL_SYMBOLS: UBlockCode = UBlockCode(91);
pub const UBLOCK_CARIAN: UBlockCode = UBlockCode(168);
pub const UBLOCK_CAUCASIAN_ALBANIAN: UBlockCode = UBlockCode(222);
pub const UBLOCK_CHAKMA: UBlockCode = UBlockCode(212);
pub const UBLOCK_CHAM: UBlockCode = UBlockCode(164);
pub const UBLOCK_CHEROKEE: UBlockCode = UBlockCode(32);
pub const UBLOCK_CHEROKEE_SUPPLEMENT: UBlockCode = UBlockCode(255);
pub const UBLOCK_CHESS_SYMBOLS: UBlockCode = UBlockCode(281);
pub const UBLOCK_CHORASMIAN: UBlockCode = UBlockCode(301);
pub const UBLOCK_CJK_COMPATIBILITY: UBlockCode = UBlockCode(69);
pub const UBLOCK_CJK_COMPATIBILITY_FORMS: UBlockCode = UBlockCode(83);
pub const UBLOCK_CJK_COMPATIBILITY_IDEOGRAPHS: UBlockCode = UBlockCode(79);
pub const UBLOCK_CJK_COMPATIBILITY_IDEOGRAPHS_SUPPLEMENT: UBlockCode = UBlockCode(95);
pub const UBLOCK_CJK_RADICALS_SUPPLEMENT: UBlockCode = UBlockCode(58);
pub const UBLOCK_CJK_STROKES: UBlockCode = UBlockCode(130);
pub const UBLOCK_CJK_SYMBOLS_AND_PUNCTUATION: UBlockCode = UBlockCode(61);
pub const UBLOCK_CJK_UNIFIED_IDEOGRAPHS: UBlockCode = UBlockCode(71);
pub const UBLOCK_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_A: UBlockCode = UBlockCode(70);
pub const UBLOCK_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_B: UBlockCode = UBlockCode(94);
pub const UBLOCK_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_C: UBlockCode = UBlockCode(197);
pub const UBLOCK_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_D: UBlockCode = UBlockCode(209);
pub const UBLOCK_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_E: UBlockCode = UBlockCode(256);
pub const UBLOCK_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_F: UBlockCode = UBlockCode(274);
pub const UBLOCK_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_G: UBlockCode = UBlockCode(302);
pub const UBLOCK_COMBINING_DIACRITICAL_MARKS: UBlockCode = UBlockCode(7);
pub const UBLOCK_COMBINING_DIACRITICAL_MARKS_EXTENDED: UBlockCode = UBlockCode(224);
pub const UBLOCK_COMBINING_DIACRITICAL_MARKS_SUPPLEMENT: UBlockCode = UBlockCode(131);
pub const UBLOCK_COMBINING_HALF_MARKS: UBlockCode = UBlockCode(82);
pub const UBLOCK_COMBINING_MARKS_FOR_SYMBOLS: UBlockCode = UBlockCode(43);
pub const UBLOCK_COMMON_INDIC_NUMBER_FORMS: UBlockCode = UBlockCode(178);
pub const UBLOCK_CONTROL_PICTURES: UBlockCode = UBlockCode(49);
pub const UBLOCK_COPTIC: UBlockCode = UBlockCode(132);
pub const UBLOCK_COPTIC_EPACT_NUMBERS: UBlockCode = UBlockCode(223);
pub const UBLOCK_COUNTING_ROD_NUMERALS: UBlockCode = UBlockCode(154);
pub const UBLOCK_CUNEIFORM: UBlockCode = UBlockCode(152);
pub const UBLOCK_CUNEIFORM_NUMBERS_AND_PUNCTUATION: UBlockCode = UBlockCode(153);
pub const UBLOCK_CURRENCY_SYMBOLS: UBlockCode = UBlockCode(42);
pub const UBLOCK_CYPRIOT_SYLLABARY: UBlockCode = UBlockCode(123);
pub const UBLOCK_CYRILLIC: UBlockCode = UBlockCode(9);
pub const UBLOCK_CYRILLIC_EXTENDED_A: UBlockCode = UBlockCode(158);
pub const UBLOCK_CYRILLIC_EXTENDED_B: UBlockCode = UBlockCode(160);
pub const UBLOCK_CYRILLIC_EXTENDED_C: UBlockCode = UBlockCode(265);
pub const UBLOCK_CYRILLIC_SUPPLEMENT: UBlockCode = UBlockCode(97);
pub const UBLOCK_CYRILLIC_SUPPLEMENTARY: UBlockCode = UBlockCode(97);
pub const UBLOCK_DESERET: UBlockCode = UBlockCode(90);
pub const UBLOCK_DEVANAGARI: UBlockCode = UBlockCode(15);
pub const UBLOCK_DEVANAGARI_EXTENDED: UBlockCode = UBlockCode(179);
pub const UBLOCK_DINGBATS: UBlockCode = UBlockCode(56);
pub const UBLOCK_DIVES_AKURU: UBlockCode = UBlockCode(303);
pub const UBLOCK_DOGRA: UBlockCode = UBlockCode(282);
pub const UBLOCK_DOMINO_TILES: UBlockCode = UBlockCode(171);
pub const UBLOCK_DUPLOYAN: UBlockCode = UBlockCode(225);
pub const UBLOCK_EARLY_DYNASTIC_CUNEIFORM: UBlockCode = UBlockCode(257);
pub const UBLOCK_EGYPTIAN_HIEROGLYPHS: UBlockCode = UBlockCode(194);
pub const UBLOCK_EGYPTIAN_HIEROGLYPH_FORMAT_CONTROLS: UBlockCode = UBlockCode(292);
pub const UBLOCK_ELBASAN: UBlockCode = UBlockCode(226);
pub const UBLOCK_ELYMAIC: UBlockCode = UBlockCode(293);
pub const UBLOCK_EMOTICONS: UBlockCode = UBlockCode(206);
pub const UBLOCK_ENCLOSED_ALPHANUMERICS: UBlockCode = UBlockCode(51);
pub const UBLOCK_ENCLOSED_ALPHANUMERIC_SUPPLEMENT: UBlockCode = UBlockCode(195);
pub const UBLOCK_ENCLOSED_CJK_LETTERS_AND_MONTHS: UBlockCode = UBlockCode(68);
pub const UBLOCK_ENCLOSED_IDEOGRAPHIC_SUPPLEMENT: UBlockCode = UBlockCode(196);
pub const UBLOCK_ETHIOPIC: UBlockCode = UBlockCode(31);
pub const UBLOCK_ETHIOPIC_EXTENDED: UBlockCode = UBlockCode(133);
pub const UBLOCK_ETHIOPIC_EXTENDED_A: UBlockCode = UBlockCode(200);
pub const UBLOCK_ETHIOPIC_SUPPLEMENT: UBlockCode = UBlockCode(134);
pub const UBLOCK_GENERAL_PUNCTUATION: UBlockCode = UBlockCode(40);
pub const UBLOCK_GEOMETRIC_SHAPES: UBlockCode = UBlockCode(54);
pub const UBLOCK_GEOMETRIC_SHAPES_EXTENDED: UBlockCode = UBlockCode(227);
pub const UBLOCK_GEORGIAN: UBlockCode = UBlockCode(29);
pub const UBLOCK_GEORGIAN_EXTENDED: UBlockCode = UBlockCode(283);
pub const UBLOCK_GEORGIAN_SUPPLEMENT: UBlockCode = UBlockCode(135);
pub const UBLOCK_GLAGOLITIC: UBlockCode = UBlockCode(136);
pub const UBLOCK_GLAGOLITIC_SUPPLEMENT: UBlockCode = UBlockCode(266);
pub const UBLOCK_GOTHIC: UBlockCode = UBlockCode(89);
pub const UBLOCK_GRANTHA: UBlockCode = UBlockCode(228);
pub const UBLOCK_GREEK: UBlockCode = UBlockCode(8);
pub const UBLOCK_GREEK_EXTENDED: UBlockCode = UBlockCode(39);
pub const UBLOCK_GUJARATI: UBlockCode = UBlockCode(18);
pub const UBLOCK_GUNJALA_GONDI: UBlockCode = UBlockCode(284);
pub const UBLOCK_GURMUKHI: UBlockCode = UBlockCode(17);
pub const UBLOCK_HALFWIDTH_AND_FULLWIDTH_FORMS: UBlockCode = UBlockCode(87);
pub const UBLOCK_HANGUL_COMPATIBILITY_JAMO: UBlockCode = UBlockCode(65);
pub const UBLOCK_HANGUL_JAMO: UBlockCode = UBlockCode(30);
pub const UBLOCK_HANGUL_JAMO_EXTENDED_A: UBlockCode = UBlockCode(180);
pub const UBLOCK_HANGUL_JAMO_EXTENDED_B: UBlockCode = UBlockCode(185);
pub const UBLOCK_HANGUL_SYLLABLES: UBlockCode = UBlockCode(74);
pub const UBLOCK_HANIFI_ROHINGYA: UBlockCode = UBlockCode(285);
pub const UBLOCK_HANUNOO: UBlockCode = UBlockCode(99);
pub const UBLOCK_HATRAN: UBlockCode = UBlockCode(258);
pub const UBLOCK_HEBREW: UBlockCode = UBlockCode(11);
pub const UBLOCK_HIGH_PRIVATE_USE_SURROGATES: UBlockCode = UBlockCode(76);
pub const UBLOCK_HIGH_SURROGATES: UBlockCode = UBlockCode(75);
pub const UBLOCK_HIRAGANA: UBlockCode = UBlockCode(62);
pub const UBLOCK_IDEOGRAPHIC_DESCRIPTION_CHARACTERS: UBlockCode = UBlockCode(60);
pub const UBLOCK_IDEOGRAPHIC_SYMBOLS_AND_PUNCTUATION: UBlockCode = UBlockCode(267);
pub const UBLOCK_IMPERIAL_ARAMAIC: UBlockCode = UBlockCode(186);
pub const UBLOCK_INDIC_SIYAQ_NUMBERS: UBlockCode = UBlockCode(286);
pub const UBLOCK_INSCRIPTIONAL_PAHLAVI: UBlockCode = UBlockCode(190);
pub const UBLOCK_INSCRIPTIONAL_PARTHIAN: UBlockCode = UBlockCode(189);
pub const UBLOCK_INVALID_CODE: UBlockCode = UBlockCode(-1);
pub const UBLOCK_IPA_EXTENSIONS: UBlockCode = UBlockCode(5);
pub const UBLOCK_JAVANESE: UBlockCode = UBlockCode(181);
pub const UBLOCK_KAITHI: UBlockCode = UBlockCode(193);
pub const UBLOCK_KANA_EXTENDED_A: UBlockCode = UBlockCode(275);
pub const UBLOCK_KANA_SUPPLEMENT: UBlockCode = UBlockCode(203);
pub const UBLOCK_KANBUN: UBlockCode = UBlockCode(66);
pub const UBLOCK_KANGXI_RADICALS: UBlockCode = UBlockCode(59);
pub const UBLOCK_KANNADA: UBlockCode = UBlockCode(22);
pub const UBLOCK_KATAKANA: UBlockCode = UBlockCode(63);
pub const UBLOCK_KATAKANA_PHONETIC_EXTENSIONS: UBlockCode = UBlockCode(107);
pub const UBLOCK_KAYAH_LI: UBlockCode = UBlockCode(162);
pub const UBLOCK_KHAROSHTHI: UBlockCode = UBlockCode(137);
pub const UBLOCK_KHITAN_SMALL_SCRIPT: UBlockCode = UBlockCode(304);
pub const UBLOCK_KHMER: UBlockCode = UBlockCode(36);
pub const UBLOCK_KHMER_SYMBOLS: UBlockCode = UBlockCode(113);
pub const UBLOCK_KHOJKI: UBlockCode = UBlockCode(229);
pub const UBLOCK_KHUDAWADI: UBlockCode = UBlockCode(230);
pub const UBLOCK_LAO: UBlockCode = UBlockCode(26);
pub const UBLOCK_LATIN_1_SUPPLEMENT: UBlockCode = UBlockCode(2);
pub const UBLOCK_LATIN_EXTENDED_A: UBlockCode = UBlockCode(3);
pub const UBLOCK_LATIN_EXTENDED_ADDITIONAL: UBlockCode = UBlockCode(38);
pub const UBLOCK_LATIN_EXTENDED_B: UBlockCode = UBlockCode(4);
pub const UBLOCK_LATIN_EXTENDED_C: UBlockCode = UBlockCode(148);
pub const UBLOCK_LATIN_EXTENDED_D: UBlockCode = UBlockCode(149);
pub const UBLOCK_LATIN_EXTENDED_E: UBlockCode = UBlockCode(231);
pub const UBLOCK_LEPCHA: UBlockCode = UBlockCode(156);
pub const UBLOCK_LETTERLIKE_SYMBOLS: UBlockCode = UBlockCode(44);
pub const UBLOCK_LIMBU: UBlockCode = UBlockCode(111);
pub const UBLOCK_LINEAR_A: UBlockCode = UBlockCode(232);
pub const UBLOCK_LINEAR_B_IDEOGRAMS: UBlockCode = UBlockCode(118);
pub const UBLOCK_LINEAR_B_SYLLABARY: UBlockCode = UBlockCode(117);
pub const UBLOCK_LISU: UBlockCode = UBlockCode(176);
pub const UBLOCK_LISU_SUPPLEMENT: UBlockCode = UBlockCode(305);
pub const UBLOCK_LOW_SURROGATES: UBlockCode = UBlockCode(77);
pub const UBLOCK_LYCIAN: UBlockCode = UBlockCode(167);
pub const UBLOCK_LYDIAN: UBlockCode = UBlockCode(169);
pub const UBLOCK_MAHAJANI: UBlockCode = UBlockCode(233);
pub const UBLOCK_MAHJONG_TILES: UBlockCode = UBlockCode(170);
pub const UBLOCK_MAKASAR: UBlockCode = UBlockCode(287);
pub const UBLOCK_MALAYALAM: UBlockCode = UBlockCode(23);
pub const UBLOCK_MANDAIC: UBlockCode = UBlockCode(198);
pub const UBLOCK_MANICHAEAN: UBlockCode = UBlockCode(234);
pub const UBLOCK_MARCHEN: UBlockCode = UBlockCode(268);
pub const UBLOCK_MASARAM_GONDI: UBlockCode = UBlockCode(276);
pub const UBLOCK_MATHEMATICAL_ALPHANUMERIC_SYMBOLS: UBlockCode = UBlockCode(93);
pub const UBLOCK_MATHEMATICAL_OPERATORS: UBlockCode = UBlockCode(47);
pub const UBLOCK_MAYAN_NUMERALS: UBlockCode = UBlockCode(288);
pub const UBLOCK_MEDEFAIDRIN: UBlockCode = UBlockCode(289);
pub const UBLOCK_MEETEI_MAYEK: UBlockCode = UBlockCode(184);
pub const UBLOCK_MEETEI_MAYEK_EXTENSIONS: UBlockCode = UBlockCode(213);
pub const UBLOCK_MENDE_KIKAKUI: UBlockCode = UBlockCode(235);
pub const UBLOCK_MEROITIC_CURSIVE: UBlockCode = UBlockCode(214);
pub const UBLOCK_MEROITIC_HIEROGLYPHS: UBlockCode = UBlockCode(215);
pub const UBLOCK_MIAO: UBlockCode = UBlockCode(216);
pub const UBLOCK_MISCELLANEOUS_MATHEMATICAL_SYMBOLS_A: UBlockCode = UBlockCode(102);
pub const UBLOCK_MISCELLANEOUS_MATHEMATICAL_SYMBOLS_B: UBlockCode = UBlockCode(105);
pub const UBLOCK_MISCELLANEOUS_SYMBOLS: UBlockCode = UBlockCode(55);
pub const UBLOCK_MISCELLANEOUS_SYMBOLS_AND_ARROWS: UBlockCode = UBlockCode(115);
pub const UBLOCK_MISCELLANEOUS_SYMBOLS_AND_PICTOGRAPHS: UBlockCode = UBlockCode(205);
pub const UBLOCK_MISCELLANEOUS_TECHNICAL: UBlockCode = UBlockCode(48);
pub const UBLOCK_MODI: UBlockCode = UBlockCode(236);
pub const UBLOCK_MODIFIER_TONE_LETTERS: UBlockCode = UBlockCode(138);
pub const UBLOCK_MONGOLIAN: UBlockCode = UBlockCode(37);
pub const UBLOCK_MONGOLIAN_SUPPLEMENT: UBlockCode = UBlockCode(269);
pub const UBLOCK_MRO: UBlockCode = UBlockCode(237);
pub const UBLOCK_MULTANI: UBlockCode = UBlockCode(259);
pub const UBLOCK_MUSICAL_SYMBOLS: UBlockCode = UBlockCode(92);
pub const UBLOCK_MYANMAR: UBlockCode = UBlockCode(28);
pub const UBLOCK_MYANMAR_EXTENDED_A: UBlockCode = UBlockCode(182);
pub const UBLOCK_MYANMAR_EXTENDED_B: UBlockCode = UBlockCode(238);
pub const UBLOCK_NABATAEAN: UBlockCode = UBlockCode(239);
pub const UBLOCK_NANDINAGARI: UBlockCode = UBlockCode(294);
pub const UBLOCK_NEWA: UBlockCode = UBlockCode(270);
pub const UBLOCK_NEW_TAI_LUE: UBlockCode = UBlockCode(139);
pub const UBLOCK_NKO: UBlockCode = UBlockCode(146);
pub const UBLOCK_NO_BLOCK: UBlockCode = UBlockCode(0);
pub const UBLOCK_NUMBER_FORMS: UBlockCode = UBlockCode(45);
pub const UBLOCK_NUSHU: UBlockCode = UBlockCode(277);
pub const UBLOCK_NYIAKENG_PUACHUE_HMONG: UBlockCode = UBlockCode(295);
pub const UBLOCK_OGHAM: UBlockCode = UBlockCode(34);
pub const UBLOCK_OLD_HUNGARIAN: UBlockCode = UBlockCode(260);
pub const UBLOCK_OLD_ITALIC: UBlockCode = UBlockCode(88);
pub const UBLOCK_OLD_NORTH_ARABIAN: UBlockCode = UBlockCode(240);
pub const UBLOCK_OLD_PERMIC: UBlockCode = UBlockCode(241);
pub const UBLOCK_OLD_PERSIAN: UBlockCode = UBlockCode(140);
pub const UBLOCK_OLD_SOGDIAN: UBlockCode = UBlockCode(290);
pub const UBLOCK_OLD_SOUTH_ARABIAN: UBlockCode = UBlockCode(187);
pub const UBLOCK_OLD_TURKIC: UBlockCode = UBlockCode(191);
pub const UBLOCK_OL_CHIKI: UBlockCode = UBlockCode(157);
pub const UBLOCK_OPTICAL_CHARACTER_RECOGNITION: UBlockCode = UBlockCode(50);
pub const UBLOCK_ORIYA: UBlockCode = UBlockCode(19);
pub const UBLOCK_ORNAMENTAL_DINGBATS: UBlockCode = UBlockCode(242);
pub const UBLOCK_OSAGE: UBlockCode = UBlockCode(271);
pub const UBLOCK_OSMANYA: UBlockCode = UBlockCode(122);
pub const UBLOCK_OTTOMAN_SIYAQ_NUMBERS: UBlockCode = UBlockCode(296);
pub const UBLOCK_PAHAWH_HMONG: UBlockCode = UBlockCode(243);
pub const UBLOCK_PALMYRENE: UBlockCode = UBlockCode(244);
pub const UBLOCK_PAU_CIN_HAU: UBlockCode = UBlockCode(245);
pub const UBLOCK_PHAGS_PA: UBlockCode = UBlockCode(150);
pub const UBLOCK_PHAISTOS_DISC: UBlockCode = UBlockCode(166);
pub const UBLOCK_PHOENICIAN: UBlockCode = UBlockCode(151);
pub const UBLOCK_PHONETIC_EXTENSIONS: UBlockCode = UBlockCode(114);
pub const UBLOCK_PHONETIC_EXTENSIONS_SUPPLEMENT: UBlockCode = UBlockCode(141);
pub const UBLOCK_PLAYING_CARDS: UBlockCode = UBlockCode(204);
pub const UBLOCK_PRIVATE_USE: UBlockCode = UBlockCode(78);
pub const UBLOCK_PRIVATE_USE_AREA: UBlockCode = UBlockCode(78);
pub const UBLOCK_PSALTER_PAHLAVI: UBlockCode = UBlockCode(246);
pub const UBLOCK_REJANG: UBlockCode = UBlockCode(163);
pub const UBLOCK_RUMI_NUMERAL_SYMBOLS: UBlockCode = UBlockCode(192);
pub const UBLOCK_RUNIC: UBlockCode = UBlockCode(35);
pub const UBLOCK_SAMARITAN: UBlockCode = UBlockCode(172);
pub const UBLOCK_SAURASHTRA: UBlockCode = UBlockCode(161);
pub const UBLOCK_SHARADA: UBlockCode = UBlockCode(217);
pub const UBLOCK_SHAVIAN: UBlockCode = UBlockCode(121);
pub const UBLOCK_SHORTHAND_FORMAT_CONTROLS: UBlockCode = UBlockCode(247);
pub const UBLOCK_SIDDHAM: UBlockCode = UBlockCode(248);
pub const UBLOCK_SINHALA: UBlockCode = UBlockCode(24);
pub const UBLOCK_SINHALA_ARCHAIC_NUMBERS: UBlockCode = UBlockCode(249);
pub const UBLOCK_SMALL_FORM_VARIANTS: UBlockCode = UBlockCode(84);
pub const UBLOCK_SMALL_KANA_EXTENSION: UBlockCode = UBlockCode(297);
pub const UBLOCK_SOGDIAN: UBlockCode = UBlockCode(291);
pub const UBLOCK_SORA_SOMPENG: UBlockCode = UBlockCode(218);
pub const UBLOCK_SOYOMBO: UBlockCode = UBlockCode(278);
pub const UBLOCK_SPACING_MODIFIER_LETTERS: UBlockCode = UBlockCode(6);
pub const UBLOCK_SPECIALS: UBlockCode = UBlockCode(86);
pub const UBLOCK_SUNDANESE: UBlockCode = UBlockCode(155);
pub const UBLOCK_SUNDANESE_SUPPLEMENT: UBlockCode = UBlockCode(219);
pub const UBLOCK_SUPERSCRIPTS_AND_SUBSCRIPTS: UBlockCode = UBlockCode(41);
pub const UBLOCK_SUPPLEMENTAL_ARROWS_A: UBlockCode = UBlockCode(103);
pub const UBLOCK_SUPPLEMENTAL_ARROWS_B: UBlockCode = UBlockCode(104);
pub const UBLOCK_SUPPLEMENTAL_ARROWS_C: UBlockCode = UBlockCode(250);
pub const UBLOCK_SUPPLEMENTAL_MATHEMATICAL_OPERATORS: UBlockCode = UBlockCode(106);
pub const UBLOCK_SUPPLEMENTAL_PUNCTUATION: UBlockCode = UBlockCode(142);
pub const UBLOCK_SUPPLEMENTAL_SYMBOLS_AND_PICTOGRAPHS: UBlockCode = UBlockCode(261);
pub const UBLOCK_SUPPLEMENTARY_PRIVATE_USE_AREA_A: UBlockCode = UBlockCode(109);
pub const UBLOCK_SUPPLEMENTARY_PRIVATE_USE_AREA_B: UBlockCode = UBlockCode(110);
pub const UBLOCK_SUTTON_SIGNWRITING: UBlockCode = UBlockCode(262);
pub const UBLOCK_SYLOTI_NAGRI: UBlockCode = UBlockCode(143);
pub const UBLOCK_SYMBOLS_AND_PICTOGRAPHS_EXTENDED_A: UBlockCode = UBlockCode(298);
pub const UBLOCK_SYMBOLS_FOR_LEGACY_COMPUTING: UBlockCode = UBlockCode(306);
pub const UBLOCK_SYRIAC: UBlockCode = UBlockCode(13);
pub const UBLOCK_SYRIAC_SUPPLEMENT: UBlockCode = UBlockCode(279);
pub const UBLOCK_TAGALOG: UBlockCode = UBlockCode(98);
pub const UBLOCK_TAGBANWA: UBlockCode = UBlockCode(101);
pub const UBLOCK_TAGS: UBlockCode = UBlockCode(96);
pub const UBLOCK_TAI_LE: UBlockCode = UBlockCode(112);
pub const UBLOCK_TAI_THAM: UBlockCode = UBlockCode(174);
pub const UBLOCK_TAI_VIET: UBlockCode = UBlockCode(183);
pub const UBLOCK_TAI_XUAN_JING_SYMBOLS: UBlockCode = UBlockCode(124);
pub const UBLOCK_TAKRI: UBlockCode = UBlockCode(220);
pub const UBLOCK_TAMIL: UBlockCode = UBlockCode(20);
pub const UBLOCK_TAMIL_SUPPLEMENT: UBlockCode = UBlockCode(299);
pub const UBLOCK_TANGUT: UBlockCode = UBlockCode(272);
pub const UBLOCK_TANGUT_COMPONENTS: UBlockCode = UBlockCode(273);
pub const UBLOCK_TANGUT_SUPPLEMENT: UBlockCode = UBlockCode(307);
pub const UBLOCK_TELUGU: UBlockCode = UBlockCode(21);
pub const UBLOCK_THAANA: UBlockCode = UBlockCode(14);
pub const UBLOCK_THAI: UBlockCode = UBlockCode(25);
pub const UBLOCK_TIBETAN: UBlockCode = UBlockCode(27);
pub const UBLOCK_TIFINAGH: UBlockCode = UBlockCode(144);
pub const UBLOCK_TIRHUTA: UBlockCode = UBlockCode(251);
pub const UBLOCK_TRANSPORT_AND_MAP_SYMBOLS: UBlockCode = UBlockCode(207);
pub const UBLOCK_UGARITIC: UBlockCode = UBlockCode(120);
pub const UBLOCK_UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS: UBlockCode = UBlockCode(33);
pub const UBLOCK_UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED: UBlockCode = UBlockCode(173);
pub const UBLOCK_VAI: UBlockCode = UBlockCode(159);
pub const UBLOCK_VARIATION_SELECTORS: UBlockCode = UBlockCode(108);
pub const UBLOCK_VARIATION_SELECTORS_SUPPLEMENT: UBlockCode = UBlockCode(125);
pub const UBLOCK_VEDIC_EXTENSIONS: UBlockCode = UBlockCode(175);
pub const UBLOCK_VERTICAL_FORMS: UBlockCode = UBlockCode(145);
pub const UBLOCK_WANCHO: UBlockCode = UBlockCode(300);
pub const UBLOCK_WARANG_CITI: UBlockCode = UBlockCode(252);
pub const UBLOCK_YEZIDI: UBlockCode = UBlockCode(308);
pub const UBLOCK_YIJING_HEXAGRAM_SYMBOLS: UBlockCode = UBlockCode(116);
pub const UBLOCK_YI_RADICALS: UBlockCode = UBlockCode(73);
pub const UBLOCK_YI_SYLLABLES: UBlockCode = UBlockCode(72);
pub const UBLOCK_ZANABAZAR_SQUARE: UBlockCode = UBlockCode(280);
pub const UBRK_CHARACTER: UBreakIteratorType = UBreakIteratorType(0);
pub const UBRK_LINE: UBreakIteratorType = UBreakIteratorType(2);
pub const UBRK_LINE_HARD: ULineBreakTag = ULineBreakTag(100);
pub const UBRK_LINE_HARD_LIMIT: ULineBreakTag = ULineBreakTag(200);
pub const UBRK_LINE_SOFT: ULineBreakTag = ULineBreakTag(0);
pub const UBRK_LINE_SOFT_LIMIT: ULineBreakTag = ULineBreakTag(100);
pub const UBRK_SENTENCE: UBreakIteratorType = UBreakIteratorType(3);
pub const UBRK_SENTENCE_SEP: USentenceBreakTag = USentenceBreakTag(100);
pub const UBRK_SENTENCE_SEP_LIMIT: USentenceBreakTag = USentenceBreakTag(200);
pub const UBRK_SENTENCE_TERM: USentenceBreakTag = USentenceBreakTag(0);
pub const UBRK_SENTENCE_TERM_LIMIT: USentenceBreakTag = USentenceBreakTag(100);
pub const UBRK_WORD: UBreakIteratorType = UBreakIteratorType(1);
pub const UBRK_WORD_IDEO: UWordBreak = UWordBreak(400);
pub const UBRK_WORD_IDEO_LIMIT: UWordBreak = UWordBreak(500);
pub const UBRK_WORD_KANA: UWordBreak = UWordBreak(300);
pub const UBRK_WORD_KANA_LIMIT: UWordBreak = UWordBreak(400);
pub const UBRK_WORD_LETTER: UWordBreak = UWordBreak(200);
pub const UBRK_WORD_LETTER_LIMIT: UWordBreak = UWordBreak(300);
pub const UBRK_WORD_NONE: UWordBreak = UWordBreak(0);
pub const UBRK_WORD_NONE_LIMIT: UWordBreak = UWordBreak(100);
pub const UBRK_WORD_NUMBER: UWordBreak = UWordBreak(100);
pub const UBRK_WORD_NUMBER_LIMIT: UWordBreak = UWordBreak(200);
#[repr(transparent)]
...
pub const UCAL_FIELD_COUNT: UCalendarDateFields = UCalendarDateFields(23);
...
pub const UCAL_TZ_LOCAL_DAYLIGHT_FORMER: UTimeZoneLocalOption = UTimeZoneLocalOption(7);
pub const UCAL_TZ_LOCAL_DAYLIGHT_LATTER: UTimeZoneLocalOption = UTimeZoneLocalOption(15);
pub const UCAL_TZ_LOCAL_FORMER: UTimeZoneLocalOption = UTimeZoneLocalOption(4);
pub const UCAL_TZ_LOCAL_LATTER: UTimeZoneLocalOption = UTimeZoneLocalOption(12);
pub const UCAL_TZ_LOCAL_STANDARD_FORMER: UTimeZoneLocalOption = UTimeZoneLocalOption(5);
pub const UCAL_TZ_LOCAL_STANDARD_LATTER: UTimeZoneLocalOption = UTimeZoneLocalOption(13);
pub const UCAL_TZ_TRANSITION_NEXT: UTimeZoneTransitionType = UTimeZoneTransitionType(0);
pub const UCAL_TZ_TRANSITION_NEXT_INCLUSIVE: UTimeZoneTransitionType = UTimeZoneTransitionType(1);
pub const UCAL_TZ_TRANSITION_PREVIOUS: UTimeZoneTransitionType = UTimeZoneTransitionType(2);
pub const UCAL_TZ_TRANSITION_PREVIOUS_INCLUSIVE: UTimeZoneTransitionType = UTimeZoneTransitionType(3);
...
pub const UCAL_ZONE_TYPE_ANY: USystemTimeZoneType = USystemTimeZoneType(0);
pub const UCAL_ZONE_TYPE_CANONICAL: USystemTimeZoneType = USystemTimeZoneType(1);
pub const UCAL_ZONE_TYPE_CANONICAL_LOCATION: USystemTimeZoneType = USystemTimeZoneType(2);
pub const UCHAR_AGE: UProperty = UProperty(16384);
pub const UCHAR_ALPHABETIC: UProperty = UProperty(0);
pub const UCHAR_ASCII_HEX_DIGIT: UProperty = UProperty(1);
pub const UCHAR_BIDI_CLASS: UProperty = UProperty(4096);
pub const UCHAR_BIDI_CONTROL: UProperty = UProperty(2);
pub const UCHAR_BIDI_MIRRORED: UProperty = UProperty(3);
pub const UCHAR_BIDI_MIRRORING_GLYPH: UProperty = UProperty(16385);
pub const UCHAR_BIDI_PAIRED_BRACKET: UProperty = UProperty(16397);
pub const UCHAR_BIDI_PAIRED_BRACKET_TYPE: UProperty = UProperty(4117);
pub const UCHAR_BINARY_START: UProperty = UProperty(0);
pub const UCHAR_BLOCK: UProperty = UProperty(4097);
pub const UCHAR_CANONICAL_COMBINING_CLASS: UProperty = UProperty(4098);
pub const UCHAR_CASED: UProperty = UProperty(49);
pub const UCHAR_CASE_FOLDING: UProperty = UProperty(16386);
pub const UCHAR_CASE_IGNORABLE: UProperty = UProperty(50);
pub const UCHAR_CASE_SENSITIVE: UProperty = UProperty(34);
pub const UCHAR_CHANGES_WHEN_CASEFOLDED: UProperty = UProperty(54);
pub const UCHAR_CHANGES_WHEN_CASEMAPPED: UProperty = UProperty(55);
pub const UCHAR_CHANGES_WHEN_LOWERCASED: UProperty = UProperty(51);
pub const UCHAR_CHANGES_WHEN_NFKC_CASEFOLDED: UProperty = UProperty(56);
pub const UCHAR_CHANGES_WHEN_TITLECASED: UProperty = UProperty(53);
pub const UCHAR_CHANGES_WHEN_UPPERCASED: UProperty = UProperty(52);
pub const UCHAR_DASH: UProperty = UProperty(4);
pub const UCHAR_DECOMPOSITION_TYPE: UProperty = UProperty(4099);
pub const UCHAR_DEFAULT_IGNORABLE_CODE_POINT: UProperty = UProperty(5);
pub const UCHAR_DEPRECATED: UProperty = UProperty(6);
pub const UCHAR_DIACRITIC: UProperty = UProperty(7);
pub const UCHAR_DOUBLE_START: UProperty = UProperty(12288);
pub const UCHAR_EAST_ASIAN_WIDTH: UProperty = UProperty(4100);
pub const UCHAR_EMOJI: UProperty = UProperty(57);
pub const UCHAR_EMOJI_COMPONENT: UProperty = UProperty(61);
pub const UCHAR_EMOJI_MODIFIER: UProperty = UProperty(59);
pub const UCHAR_EMOJI_MODIFIER_BASE: UProperty = UProperty(60);
pub const UCHAR_EMOJI_PRESENTATION: UProperty = UProperty(58);
pub const UCHAR_EXTENDED_PICTOGRAPHIC: UProperty = UProperty(64);
pub const UCHAR_EXTENDER: UProperty = UProperty(8);
pub const UCHAR_FULL_COMPOSITION_EXCLUSION: UProperty = UProperty(9);
pub const UCHAR_GENERAL_CATEGORY: UProperty = UProperty(4101);
pub const UCHAR_GENERAL_CATEGORY_MASK: UProperty = UProperty(8192);
pub const UCHAR_GRAPHEME_BASE: UProperty = UProperty(10);
pub const UCHAR_GRAPHEME_CLUSTER_BREAK: UProperty = UProperty(4114);
pub const UCHAR_GRAPHEME_EXTEND: UProperty = UProperty(11);
pub const UCHAR_GRAPHEME_LINK: UProperty = UProperty(12);
pub const UCHAR_HANGUL_SYLLABLE_TYPE: UProperty = UProperty(4107);
pub const UCHAR_HEX_DIGIT: UProperty = UProperty(13);
pub const UCHAR_HYPHEN: UProperty = UProperty(14);
pub const UCHAR_IDEOGRAPHIC: UProperty = UProperty(17);
pub const UCHAR_IDS_BINARY_OPERATOR: UProperty = UProperty(18);
pub const UCHAR_IDS_TRINARY_OPERATOR: UProperty = UProperty(19);
pub const UCHAR_ID_CONTINUE: UProperty = UProperty(15);
pub const UCHAR_ID_START: UProperty = UProperty(16);
pub const UCHAR_INDIC_POSITIONAL_CATEGORY: UProperty = UProperty(4118);
pub const UCHAR_INDIC_SYLLABIC_CATEGORY: UProperty = UProperty(4119);
pub const UCHAR_INT_START: UProperty = UProperty(4096);
pub const UCHAR_INVALID_CODE: UProperty = UProperty(-1);
pub const UCHAR_JOINING_GROUP: UProperty = UProperty(4102);
pub const UCHAR_JOINING_TYPE: UProperty = UProperty(4103);
pub const UCHAR_JOIN_CONTROL: UProperty = UProperty(20);
pub const UCHAR_LEAD_CANONICAL_COMBINING_CLASS: UProperty = UProperty(4112);
pub const UCHAR_LINE_BREAK: UProperty = UProperty(4104);
pub const UCHAR_LOGICAL_ORDER_EXCEPTION: UProperty = UProperty(21);
pub const UCHAR_LOWERCASE: UProperty = UProperty(22);
pub const UCHAR_LOWERCASE_MAPPING: UProperty = UProperty(16388);
pub const UCHAR_MASK_START: UProperty = UProperty(8192);
pub const UCHAR_MATH: UProperty = UProperty(23);
pub const UCHAR_MAX_VALUE: u32 = 1114111;
pub const UCHAR_MIN_VALUE: u32 = 0;
pub const UCHAR_NAME: UProperty = UProperty(16389);
pub const UCHAR_NFC_INERT: UProperty = UProperty(39);
pub const UCHAR_NFC_QUICK_CHECK: UProperty = UProperty(4110);
pub const UCHAR_NFD_INERT: UProperty = UProperty(37);
pub const UCHAR_NFD_QUICK_CHECK: UProperty = UProperty(4108);
pub const UCHAR_NFKC_INERT: UProperty = UProperty(40);
pub const UCHAR_NFKC_QUICK_CHECK: UProperty = UProperty(4111);
pub const UCHAR_NFKD_INERT: UProperty = UProperty(38);
pub const UCHAR_NFKD_QUICK_CHECK: UProperty = UProperty(4109);
pub const UCHAR_NONCHARACTER_CODE_POINT: UProperty = UProperty(24);
pub const UCHAR_NUMERIC_TYPE: UProperty = UProperty(4105);
pub const UCHAR_NUMERIC_VALUE: UProperty = UProperty(12288);
pub const UCHAR_OTHER_PROPERTY_START: UProperty = UProperty(28672);
pub const UCHAR_PATTERN_SYNTAX: UProperty = UProperty(42);
pub const UCHAR_PATTERN_WHITE_SPACE: UProperty = UProperty(43);
pub const UCHAR_POSIX_ALNUM: UProperty = UProperty(44);
pub const UCHAR_POSIX_BLANK: UProperty = UProperty(45);
pub const UCHAR_POSIX_GRAPH: UProperty = UProperty(46);
pub const UCHAR_POSIX_PRINT: UProperty = UProperty(47);
pub const UCHAR_POSIX_XDIGIT: UProperty = UProperty(48);
pub const UCHAR_PREPENDED_CONCATENATION_MARK: UProperty = UProperty(63);
pub const UCHAR_QUOTATION_MARK: UProperty = UProperty(25);
pub const UCHAR_RADICAL: UProperty = UProperty(26);
pub const UCHAR_REGIONAL_INDICATOR: UProperty = UProperty(62);
pub const UCHAR_SCRIPT: UProperty = UProperty(4106);
pub const UCHAR_SCRIPT_EXTENSIONS: UProperty = UProperty(28672);
pub const UCHAR_SEGMENT_STARTER: UProperty = UProperty(41);
pub const UCHAR_SENTENCE_BREAK: UProperty = UProperty(4115);
pub const UCHAR_SIMPLE_CASE_FOLDING: UProperty = UProperty(16390);
pub const UCHAR_SIMPLE_LOWERCASE_MAPPING: UProperty = UProperty(16391);
pub const UCHAR_SIMPLE_TITLECASE_MAPPING: UProperty = UProperty(16392);
pub const UCHAR_SIMPLE_UPPERCASE_MAPPING: UProperty = UProperty(16393);
pub const UCHAR_SOFT_DOTTED: UProperty = UProperty(27);
pub const UCHAR_STRING_START: UProperty = UProperty(16384);
pub const UCHAR_S_TERM: UProperty = UProperty(35);
pub const UCHAR_TERMINAL_PUNCTUATION: UProperty = UProperty(28);
pub const UCHAR_TITLECASE_MAPPING: UProperty = UProperty(16394);
pub const UCHAR_TRAIL_CANONICAL_COMBINING_CLASS: UProperty = UProperty(4113);
pub const UCHAR_UNIFIED_IDEOGRAPH: UProperty = UProperty(29);
pub const UCHAR_UPPERCASE: UProperty = UProperty(30);
pub const UCHAR_UPPERCASE_MAPPING: UProperty = UProperty(16396);
pub const UCHAR_VARIATION_SELECTOR: UProperty = UProperty(36);
pub const UCHAR_VERTICAL_ORIENTATION: UProperty = UProperty(4120);
pub const UCHAR_WHITE_SPACE: UProperty = UProperty(31);
pub const UCHAR_WORD_BREAK: UProperty = UProperty(4116);
pub const UCHAR_XID_CONTINUE: UProperty = UProperty(32);
pub const UCHAR_XID_START: UProperty = UProperty(33);
pub const UCLN_NO_AUTO_CLEANUP: u32 = 1;
pub const UCNV_BOCU1: UConverterType = UConverterType(28);
pub const UCNV_CESU8: UConverterType = UConverterType(31);
pub const UCNV_CLONE: UConverterCallbackReason = UConverterCallbackReason(5);
pub const UCNV_CLOSE: UConverterCallbackReason = UConverterCallbackReason(4);
pub const UCNV_COMPOUND_TEXT: UConverterType = UConverterType(33);
pub const UCNV_DBCS: UConverterType = UConverterType(1);
pub const UCNV_EBCDIC_STATEFUL: UConverterType = UConverterType(9);
...
pub const UCNV_HZ: UConverterType = UConverterType(23);
pub const UCNV_IBM: UConverterPlatform = UConverterPlatform(0);
pub const UCNV_ILLEGAL: UConverterCallbackReason = UConverterCallbackReason(1);
pub const UCNV_IMAP_MAILBOX: UConverterType = UConverterType(32);
pub const UCNV_IRREGULAR: UConverterCallbackReason = UConverterCallbackReason(2);
pub const UCNV_ISCII: UConverterType = UConverterType(25);
pub const UCNV_ISO_2022: UConverterType = UConverterType(10);
pub const UCNV_LATIN_1: UConverterType = UConverterType(3);
pub const UCNV_LMBCS_1: UConverterType = UConverterType(11);
pub const UCNV_LMBCS_11: UConverterType = UConverterType(18);
pub const UCNV_LMBCS_16: UConverterType = UConverterType(19);
pub const UCNV_LMBCS_17: UConverterType = UConverterType(20);
pub const UCNV_LMBCS_18: UConverterType = UConverterType(21);
pub const UCNV_LMBCS_19: UConverterType = UConverterType(22);
pub const UCNV_LMBCS_2: UConverterType = UConverterType(12);
pub const UCNV_LMBCS_3: UConverterType = UConverterType(13);
pub const UCNV_LMBCS_4: UConverterType = UConverterType(14);
pub const UCNV_LMBCS_5: UConverterType = UConverterType(15);
pub const UCNV_LMBCS_6: UConverterType = UConverterType(16);
pub const UCNV_LMBCS_8: UConverterType = UConverterType(17);
pub const UCNV_LMBCS_LAST: UConverterType = UConverterType(22);
...
pub const UCNV_MBCS: UConverterType = UConverterType(2);
pub const UCNV_NUMBER_OF_SUPPORTED_CONVERTER_TYPES: UConverterType = UConverterType(34);
pub const UCNV_OPTION_SEP_STRING: windows_core::PCSTR = windows_core::s!(",");
pub const UCNV_RESET: UConverterCallbackReason = UConverterCallbackReason(3);
pub const UCNV_ROUNDTRIP_AND_FALLBACK_SET: UConverterUnicodeSet = UConverterUnicodeSet(1);
pub const UCNV_ROUNDTRIP_SET: UConverterUnicodeSet = UConverterUnicodeSet(0);
pub const UCNV_SBCS: UConverterType = UConverterType(0);
pub const UCNV_SCSU: UConverterType = UConverterType(24);
...
pub const UCNV_UNASSIGNED: UConverterCallbackReason = UConverterCallbackReason(0);
pub const UCNV_UNKNOWN: UConverterPlatform = UConverterPlatform(-1);
pub const UCNV_UNSUPPORTED_CONVERTER: UConverterType = UConverterType(-1);
pub const UCNV_US_ASCII: UConverterType = UConverterType(26);
pub const UCNV_UTF16: UConverterType = UConverterType(29);
pub const UCNV_UTF16_BigEndian: UConverterType = UConverterType(5);
pub const UCNV_UTF16_LittleEndian: UConverterType = UConverterType(6);
pub const UCNV_UTF32: UConverterType = UConverterType(30);
pub const UCNV_UTF32_BigEndian: UConverterType = UConverterType(7);
pub const UCNV_UTF32_LittleEndian: UConverterType = UConverterType(8);
pub const UCNV_UTF7: UConverterType = UConverterType(27);
pub const UCNV_UTF8: UConverterType = UConverterType(4);
...
pub const UCOL_ALTERNATE_HANDLING: UColAttribute = UColAttribute(1);
pub const UCOL_ATTRIBUTE_COUNT: UColAttribute = UColAttribute(8);
pub const UCOL_BOUND_LOWER: UColBoundMode = UColBoundMode(0);
pub const UCOL_BOUND_UPPER: UColBoundMode = UColBoundMode(1);
pub const UCOL_BOUND_UPPER_LONG: UColBoundMode = UColBoundMode(2);
pub const UCOL_CASE_FIRST: UColAttribute = UColAttribute(2);
pub const UCOL_CASE_LEVEL: UColAttribute = UColAttribute(3);
pub const UCOL_CE_STRENGTH_LIMIT: UColAttributeValue = UColAttributeValue(3);
pub const UCOL_DECOMPOSITION_MODE: UColAttribute = UColAttribute(4);
pub const UCOL_DEFAULT: UColAttributeValue = UColAttributeValue(-1);
pub const UCOL_DEFAULT_STRENGTH: UColAttributeValue = UColAttributeValue(2);
pub const UCOL_EQUAL: UCollationResult = UCollationResult(0);
pub const UCOL_FRENCH_COLLATION: UColAttribute = UColAttribute(0);
pub const UCOL_FULL_RULES: UColRuleOption = UColRuleOption(1);
pub const UCOL_GREATER: UCollationResult = UCollationResult(1);
pub const UCOL_IDENTICAL: UColAttributeValue = UColAttributeValue(15);
pub const UCOL_LESS: UCollationResult = UCollationResult(-1);
pub const UCOL_LOWER_FIRST: UColAttributeValue = UColAttributeValue(24);
pub const UCOL_NON_IGNORABLE: UColAttributeValue = UColAttributeValue(21);
pub const UCOL_NORMALIZATION_MODE: UColAttribute = UColAttribute(4);
pub const UCOL_NUMERIC_COLLATION: UColAttribute = UColAttribute(7);
pub const UCOL_OFF: UColAttributeValue = UColAttributeValue(16);
pub const UCOL_ON: UColAttributeValue = UColAttributeValue(17);
pub const UCOL_PRIMARY: UColAttributeValue = UColAttributeValue(0);
pub const UCOL_QUATERNARY: UColAttributeValue = UColAttributeValue(3);
pub const UCOL_REORDER_CODE_CURRENCY: UColReorderCode = UColReorderCode(4099);
pub const UCOL_REORDER_CODE_DEFAULT: UColReorderCode = UColReorderCode(-1);
pub const UCOL_REORDER_CODE_DIGIT: UColReorderCode = UColReorderCode(4100);
pub const UCOL_REORDER_CODE_FIRST: UColReorderCode = UColReorderCode(4096);
pub const UCOL_REORDER_CODE_NONE: UColReorderCode = UColReorderCode(103);
pub const UCOL_REORDER_CODE_OTHERS: UColReorderCode = UColReorderCode(103);
pub const UCOL_REORDER_CODE_PUNCTUATION: UColReorderCode = UColReorderCode(4097);
pub const UCOL_REORDER_CODE_SPACE: UColReorderCode = UColReorderCode(4096);
pub const UCOL_REORDER_CODE_SYMBOL: UColReorderCode = UColReorderCode(4098);
pub const UCOL_SECONDARY: UColAttributeValue = UColAttributeValue(1);
pub const UCOL_SHIFTED: UColAttributeValue = UColAttributeValue(20);
pub const UCOL_STRENGTH: UColAttribute = UColAttribute(5);
pub const UCOL_STRENGTH_LIMIT: UColAttributeValue = UColAttributeValue(16);
pub const UCOL_TAILORING_ONLY: UColRuleOption = UColRuleOption(0);
pub const UCOL_TERTIARY: UColAttributeValue = UColAttributeValue(2);
pub const UCOL_UPPER_FIRST: UColAttributeValue = UColAttributeValue(25);
...
pub const UCONFIG_NO_BREAK_ITERATION: u32 = 1;
pub const UCONFIG_NO_COLLATION: u32 = 1;
...
pub const UCONFIG_NO_FORMATTING: u32 = 1;
pub const UCONFIG_NO_IDNA: u32 = 1;
pub const UCONFIG_NO_LEGACY_CONVERSION: u32 = 1;
pub const UCONFIG_NO_NORMALIZATION: u32 = 0;
pub const UCONFIG_NO_REGULAR_EXPRESSIONS: u32 = 1;
pub const UCONFIG_NO_SERVICE: u32 = 0;
pub const UCONFIG_NO_TRANSLITERATION: u32 = 1;
pub const UCONFIG_ONLY_COLLATION: u32 = 0;
pub const UCONFIG_ONLY_HTML_CONVERSION: u32 = 0;
pub const UCPMAP_RANGE_FIXED_ALL_SURROGATES: UCPMapRangeOption = UCPMapRangeOption(2);
pub const UCPMAP_RANGE_FIXED_LEAD_SURROGATES: UCPMapRangeOption = UCPMapRangeOption(1);
pub const UCPMAP_RANGE_NORMAL: UCPMapRangeOption = UCPMapRangeOption(0);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Default)]
...
pub const UCPTRIE_TYPE_ANY: UCPTrieType = UCPTrieType(-1);
pub const UCPTRIE_TYPE_FAST: UCPTrieType = UCPTrieType(0);
pub const UCPTRIE_TYPE_SMALL: UCPTrieType = UCPTrieType(1);
pub const UCPTRIE_VALUE_BITS_16: UCPTrieValueWidth = UCPTrieValueWidth(0);
pub const UCPTRIE_VALUE_BITS_32: UCPTrieValueWidth = UCPTrieValueWidth(1);
pub const UCPTRIE_VALUE_BITS_8: UCPTrieValueWidth = UCPTrieValueWidth(2);
pub const UCPTRIE_VALUE_BITS_ANY: UCPTrieValueWidth = UCPTrieValueWidth(-1);
#[repr(C)]
#[derive(Clone, Copy)]
pub struct UCPTrie {
    pub index: *const u16,
...
pub const UCURR_ALL: UCurrCurrencyType = UCurrCurrencyType(2147483647);
pub const UCURR_COMMON: UCurrCurrencyType = UCurrCurrencyType(1);
pub const UCURR_DEPRECATED: UCurrCurrencyType = UCurrCurrencyType(4);
pub const UCURR_LONG_NAME: UCurrNameStyle = UCurrNameStyle(1);
pub const UCURR_NARROW_SYMBOL_NAME: UCurrNameStyle = UCurrNameStyle(2);
pub const UCURR_NON_DEPRECATED: UCurrCurrencyType = UCurrCurrencyType(8);
pub const UCURR_SYMBOL_NAME: UCurrNameStyle = UCurrNameStyle(0);
pub const UCURR_UNCOMMON: UCurrCurrencyType = UCurrCurrencyType(2);
pub const UCURR_USAGE_CASH: UCurrencyUsage = UCurrencyUsage(1);
pub const UCURR_USAGE_STANDARD: UCurrencyUsage = UCurrencyUsage(0);
pub const UCURR_VARIANT_SYMBOL_NAME: UCurrNameStyle = UCurrNameStyle(3);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub type UConverterToUCallback = Option<unsafe extern "C" fn(context: *const core::ffi::c_void, args: *mut UConverterToUnicodeArgs, codeunits: windows_core::PCSTR, length: i32, reason: UConverterCallbackReason, perrorcode: *mut UErrorCode)>;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const UDATPG_ABBREVIATED: UDateTimePGDisplayWidth = UDateTimePGDisplayWidth(1);
pub const UDATPG_BASE_CONFLICT: UDateTimePatternConflict = UDateTimePatternConflict(1);
pub const UDATPG_CONFLICT: UDateTimePatternConflict = UDateTimePatternConflict(2);
pub const UDATPG_DAYPERIOD_FIELD: UDateTimePatternField = UDateTimePatternField(10);
pub const UDATPG_DAY_FIELD: UDateTimePatternField = UDateTimePatternField(9);
pub const UDATPG_DAY_OF_WEEK_IN_MONTH_FIELD: UDateTimePatternField = UDateTimePatternField(8);
pub const UDATPG_DAY_OF_YEAR_FIELD: UDateTimePatternField = UDateTimePatternField(7);
pub const UDATPG_ERA_FIELD: UDateTimePatternField = UDateTimePatternField(0);
pub const UDATPG_FIELD_COUNT: UDateTimePatternField = UDateTimePatternField(16);
pub const UDATPG_FRACTIONAL_SECOND_FIELD: UDateTimePatternField = UDateTimePatternField(14);
pub const UDATPG_HOUR_FIELD: UDateTimePatternField = UDateTimePatternField(11);
pub const UDATPG_MATCH_ALL_FIELDS_LENGTH: UDateTimePatternMatchOptions = UDateTimePatternMatchOptions(65535);
pub const UDATPG_MATCH_HOUR_FIELD_LENGTH: UDateTimePatternMatchOptions = UDateTimePatternMatchOptions(2048);
pub const UDATPG_MATCH_NO_OPTIONS: UDateTimePatternMatchOptions = UDateTimePatternMatchOptions(0);
pub const UDATPG_MINUTE_FIELD: UDateTimePatternField = UDateTimePatternField(12);
pub const UDATPG_MONTH_FIELD: UDateTimePatternField = UDateTimePatternField(3);
pub const UDATPG_NARROW: UDateTimePGDisplayWidth = UDateTimePGDisplayWidth(2);
pub const UDATPG_NO_CONFLICT: UDateTimePatternConflict = UDateTimePatternConflict(0);
pub const UDATPG_QUARTER_FIELD: UDateTimePatternField = UDateTimePatternField(2);
pub const UDATPG_SECOND_FIELD: UDateTimePatternField = UDateTimePatternField(13);
pub const UDATPG_WEEKDAY_FIELD: UDateTimePatternField = UDateTimePatternField(6);
pub const UDATPG_WEEK_OF_MONTH_FIELD: UDateTimePatternField = UDateTimePatternField(5);
pub const UDATPG_WEEK_OF_YEAR_FIELD: UDateTimePatternField = UDateTimePatternField(4);
pub const UDATPG_WIDE: UDateTimePGDisplayWidth = UDateTimePGDisplayWidth(0);
pub const UDATPG_YEAR_FIELD: UDateTimePatternField = UDateTimePatternField(1);
pub const UDATPG_ZONE_FIELD: UDateTimePatternField = UDateTimePatternField(15);
...
pub const UDAT_ABSOLUTE_DAY: UDateAbsoluteUnit = UDateAbsoluteUnit(7);
pub const UDAT_ABSOLUTE_FRIDAY: UDateAbsoluteUnit = UDateAbsoluteUnit(5);
pub const UDAT_ABSOLUTE_MONDAY: UDateAbsoluteUnit = UDateAbsoluteUnit(1);
pub const UDAT_ABSOLUTE_MONTH: UDateAbsoluteUnit = UDateAbsoluteUnit(9);
pub const UDAT_ABSOLUTE_NOW: UDateAbsoluteUnit = UDateAbsoluteUnit(11);
pub const UDAT_ABSOLUTE_SATURDAY: UDateAbsoluteUnit = UDateAbsoluteUnit(6);
pub const UDAT_ABSOLUTE_SUNDAY: UDateAbsoluteUnit = UDateAbsoluteUnit(0);
pub const UDAT_ABSOLUTE_THURSDAY: UDateAbsoluteUnit = UDateAbsoluteUnit(4);
pub const UDAT_ABSOLUTE_TUESDAY: UDateAbsoluteUnit = UDateAbsoluteUnit(2);
pub const UDAT_ABSOLUTE_UNIT_COUNT: UDateAbsoluteUnit = UDateAbsoluteUnit(12);
pub const UDAT_ABSOLUTE_WEDNESDAY: UDateAbsoluteUnit = UDateAbsoluteUnit(3);
pub const UDAT_ABSOLUTE_WEEK: UDateAbsoluteUnit = UDateAbsoluteUnit(8);
pub const UDAT_ABSOLUTE_YEAR: UDateAbsoluteUnit = UDateAbsoluteUnit(10);
pub const UDAT_AM_PMS: UDateFormatSymbolType = UDateFormatSymbolType(5);
pub const UDAT_AM_PM_FIELD: UDateFormatField = UDateFormatField(14);
pub const UDAT_AM_PM_MIDNIGHT_NOON_FIELD: UDateFormatField = UDateFormatField(35);
pub const UDAT_BOOLEAN_ATTRIBUTE_COUNT: UDateFormatBooleanAttribute = UDateFormatBooleanAttribute(4);
pub const UDAT_CYCLIC_YEARS_ABBREVIATED: UDateFormatSymbolType = UDateFormatSymbolType(23);
pub const UDAT_CYCLIC_YEARS_NARROW: UDateFormatSymbolType = UDateFormatSymbolType(24);
pub const UDAT_CYCLIC_YEARS_WIDE: UDateFormatSymbolType = UDateFormatSymbolType(22);
pub const UDAT_DATE_FIELD: UDateFormatField = UDateFormatField(3);
pub const UDAT_DAY: windows_core::PCSTR = windows_core::s!("d");
pub const UDAT_DAY_OF_WEEK_FIELD: UDateFormatField = UDateFormatField(9);
pub const UDAT_DAY_OF_WEEK_IN_MONTH_FIELD: UDateFormatField = UDateFormatField(11);
pub const UDAT_DAY_OF_YEAR_FIELD: UDateFormatField = UDateFormatField(10);
pub const UDAT_DEFAULT: UDateFormatStyle = UDateFormatStyle(2);
pub const UDAT_DIRECTION_COUNT: UDateDirection = UDateDirection(6);
pub const UDAT_DIRECTION_LAST: UDateDirection = UDateDirection(1);
pub const UDAT_DIRECTION_LAST_2: UDateDirection = UDateDirection(0);
pub const UDAT_DIRECTION_NEXT: UDateDirection = UDateDirection(3);
pub const UDAT_DIRECTION_NEXT_2: UDateDirection = UDateDirection(4);
pub const UDAT_DIRECTION_PLAIN: UDateDirection = UDateDirection(5);
pub const UDAT_DIRECTION_THIS: UDateDirection = UDateDirection(2);
pub const UDAT_DOW_LOCAL_FIELD: UDateFormatField = UDateFormatField(19);
pub const UDAT_ERAS: UDateFormatSymbolType = UDateFormatSymbolType(0);
pub const UDAT_ERA_FIELD: UDateFormatField = UDateFormatField(0);
pub const UDAT_ERA_NAMES: UDateFormatSymbolType = UDateFormatSymbolType(7);
pub const UDAT_EXTENDED_YEAR_FIELD: UDateFormatField = UDateFormatField(20);
pub const UDAT_FLEXIBLE_DAY_PERIOD_FIELD: UDateFormatField = UDateFormatField(36);
pub const UDAT_FRACTIONAL_SECOND_FIELD: UDateFormatField = UDateFormatField(8);
pub const UDAT_FULL: UDateFormatStyle = UDateFormatStyle(0);
pub const UDAT_FULL_RELATIVE: UDateFormatStyle = UDateFormatStyle(128);
pub const UDAT_GENERIC_TZ: windows_core::PCSTR = windows_core::s!("vvvv");
pub const UDAT_HOUR: windows_core::PCSTR = windows_core::s!("j");
pub const UDAT_HOUR0_FIELD: UDateFormatField = UDateFormatField(16);
pub const UDAT_HOUR1_FIELD: UDateFormatField = UDateFormatField(15);
...
pub const UDAT_HOUR_CYCLE_11: UDateFormatHourCycle = UDateFormatHourCycle(0);
pub const UDAT_HOUR_CYCLE_12: UDateFormatHourCycle = UDateFormatHourCycle(1);
pub const UDAT_HOUR_CYCLE_23: UDateFormatHourCycle = UDateFormatHourCycle(2);
pub const UDAT_HOUR_CYCLE_24: UDateFormatHourCycle = UDateFormatHourCycle(3);
...
pub const UDAT_HOUR_OF_DAY0_FIELD: UDateFormatField = UDateFormatField(5);
pub const UDAT_HOUR_OF_DAY1_FIELD: UDateFormatField = UDateFormatField(4);
pub const UDAT_JULIAN_DAY_FIELD: UDateFormatField = UDateFormatField(21);
pub const UDAT_LOCALIZED_CHARS: UDateFormatSymbolType = UDateFormatSymbolType(6);
pub const UDAT_LOCATION_TZ: windows_core::PCSTR = windows_core::s!("VVVV");
pub const UDAT_LONG: UDateFormatStyle = UDateFormatStyle(1);
pub const UDAT_LONG_RELATIVE: UDateFormatStyle = UDateFormatStyle(129);
pub const UDAT_MEDIUM: UDateFormatStyle = UDateFormatStyle(2);
pub const UDAT_MEDIUM_RELATIVE: UDateFormatStyle = UDateFormatStyle(130);
pub const UDAT_MILLISECONDS_IN_DAY_FIELD: UDateFormatField = UDateFormatField(22);
pub const UDAT_MINUTE: windows_core::PCSTR = windows_core::s!("m");
pub const UDAT_MINUTE_FIELD: UDateFormatField = UDateFormatField(6);
...
pub const UDAT_MONTHS: UDateFormatSymbolType = UDateFormatSymbolType(1);
pub const UDAT_MONTH_DAY: windows_core::PCSTR = windows_core::s!("MMMMd");
pub const UDAT_MONTH_FIELD: UDateFormatField = UDateFormatField(2);
pub const UDAT_MONTH_WEEKDAY_DAY: windows_core::PCSTR = windows_core::s!("MMMMEEEEd");
pub const UDAT_NARROW_MONTHS: UDateFormatSymbolType = UDateFormatSymbolType(8);
pub const UDAT_NARROW_QUARTERS: UDateFormatSymbolType = UDateFormatSymbolType(28);
pub const UDAT_NARROW_WEEKDAYS: UDateFormatSymbolType = UDateFormatSymbolType(9);
pub const UDAT_NONE: UDateFormatStyle = UDateFormatStyle(-1);
...
pub const UDAT_PARSE_ALLOW_NUMERIC: UDateFormatBooleanAttribute = UDateFormatBooleanAttribute(1);
pub const UDAT_PARSE_ALLOW_WHITESPACE: UDateFormatBooleanAttribute = UDateFormatBooleanAttribute(0);
pub const UDAT_PARSE_MULTIPLE_PATTERNS_FOR_MATCH: UDateFormatBooleanAttribute = UDateFormatBooleanAttribute(3);
pub const UDAT_PARSE_PARTIAL_LITERAL_MATCH: UDateFormatBooleanAttribute = UDateFormatBooleanAttribute(2);
pub const UDAT_PATTERN: UDateFormatStyle = UDateFormatStyle(-2);
pub const UDAT_QUARTER: windows_core::PCSTR = windows_core::s!("QQQQ");
pub const UDAT_QUARTERS: UDateFormatSymbolType = UDateFormatSymbolType(16);
pub const UDAT_QUARTER_FIELD: UDateFormatField = UDateFormatField(27);
pub const UDAT_RELATIVE: UDateFormatStyle = UDateFormatStyle(128);
pub const UDAT_RELATIVE_DAYS: UDateRelativeUnit = UDateRelativeUnit(3);
pub const UDAT_RELATIVE_HOURS: UDateRelativeUnit = UDateRelativeUnit(2);
pub const UDAT_RELATIVE_MINUTES: UDateRelativeUnit = UDateRelativeUnit(1);
pub const UDAT_RELATIVE_MONTHS: UDateRelativeUnit = UDateRelativeUnit(5);
pub const UDAT_RELATIVE_SECONDS: UDateRelativeUnit = UDateRelativeUnit(0);
pub const UDAT_RELATIVE_UNIT_COUNT: UDateRelativeUnit = UDateRelativeUnit(7);
pub const UDAT_RELATIVE_WEEKS: UDateRelativeUnit = UDateRelativeUnit(4);
pub const UDAT_RELATIVE_YEARS: UDateRelativeUnit = UDateRelativeUnit(6);
pub const UDAT_REL_LITERAL_FIELD: URelativeDateTimeFormatterField = URelativeDateTimeFormatterField(0);
pub const UDAT_REL_NUMERIC_FIELD: URelativeDateTimeFormatterField = URelativeDateTimeFormatterField(1);
pub const UDAT_REL_UNIT_DAY: URelativeDateTimeUnit = URelativeDateTimeUnit(4);
pub const UDAT_REL_UNIT_FRIDAY: URelativeDateTimeUnit = URelativeDateTimeUnit(13);
pub const UDAT_REL_UNIT_HOUR: URelativeDateTimeUnit = URelativeDateTimeUnit(5);
pub const UDAT_REL_UNIT_MINUTE: URelativeDateTimeUnit = URelativeDateTimeUnit(6);
pub const UDAT_REL_UNIT_MONDAY: URelativeDateTimeUnit = URelativeDateTimeUnit(9);
pub const UDAT_REL_UNIT_MONTH: URelativeDateTimeUnit = URelativeDateTimeUnit(2);
pub const UDAT_REL_UNIT_QUARTER: URelativeDateTimeUnit = URelativeDateTimeUnit(1);
pub const UDAT_REL_UNIT_SATURDAY: URelativeDateTimeUnit = URelativeDateTimeUnit(14);
pub const UDAT_REL_UNIT_SECOND: URelativeDateTimeUnit = URelativeDateTimeUnit(7);
pub const UDAT_REL_UNIT_SUNDAY: URelativeDateTimeUnit = URelativeDateTimeUnit(8);
pub const UDAT_REL_UNIT_THURSDAY: URelativeDateTimeUnit = URelativeDateTimeUnit(12);
pub const UDAT_REL_UNIT_TUESDAY: URelativeDateTimeUnit = URelativeDateTimeUnit(10);
pub const UDAT_REL_UNIT_WEDNESDAY: URelativeDateTimeUnit = URelativeDateTimeUnit(11);
pub const UDAT_REL_UNIT_WEEK: URelativeDateTimeUnit = URelativeDateTimeUnit(3);
pub const UDAT_REL_UNIT_YEAR: URelativeDateTimeUnit = URelativeDateTimeUnit(0);
pub const UDAT_SECOND: windows_core::PCSTR = windows_core::s!("s");
pub const UDAT_SECOND_FIELD: UDateFormatField = UDateFormatField(7);
pub const UDAT_SHORT: UDateFormatStyle = UDateFormatStyle(3);
pub const UDAT_SHORTER_WEEKDAYS: UDateFormatSymbolType = UDateFormatSymbolType(20);
pub const UDAT_SHORT_MONTHS: UDateFormatSymbolType = UDateFormatSymbolType(2);
pub const UDAT_SHORT_QUARTERS: UDateFormatSymbolType = UDateFormatSymbolType(17);
pub const UDAT_SHORT_RELATIVE: UDateFormatStyle = UDateFormatStyle(131);
pub const UDAT_SHORT_WEEKDAYS: UDateFormatSymbolType = UDateFormatSymbolType(4);
pub const UDAT_SPECIFIC_TZ: windows_core::PCSTR = windows_core::s!("zzzz");
pub const UDAT_STANDALONE_DAY_FIELD: UDateFormatField = UDateFormatField(25);
pub const UDAT_STANDALONE_MONTHS: UDateFormatSymbolType = UDateFormatSymbolType(10);
pub const UDAT_STANDALONE_MONTH_FIELD: UDateFormatField = UDateFormatField(26);
pub const UDAT_STANDALONE_NARROW_MONTHS: UDateFormatSymbolType = UDateFormatSymbolType(12);
pub const UDAT_STANDALONE_NARROW_QUARTERS: UDateFormatSymbolType = UDateFormatSymbolType(29);
pub const UDAT_STANDALONE_NARROW_WEEKDAYS: UDateFormatSymbolType = UDateFormatSymbolType(15);
pub const UDAT_STANDALONE_QUARTERS: UDateFormatSymbolType = UDateFormatSymbolType(18);
pub const UDAT_STANDALONE_QUARTER_FIELD: UDateFormatField = UDateFormatField(28);
pub const UDAT_STANDALONE_SHORTER_WEEKDAYS: UDateFormatSymbolType = UDateFormatSymbolType(21);
pub const UDAT_STANDALONE_SHORT_MONTHS: UDateFormatSymbolType = UDateFormatSymbolType(11);
pub const UDAT_STANDALONE_SHORT_QUARTERS: UDateFormatSymbolType = UDateFormatSymbolType(19);
pub const UDAT_STANDALONE_SHORT_WEEKDAYS: UDateFormatSymbolType = UDateFormatSymbolType(14);
pub const UDAT_STANDALONE_WEEKDAYS: UDateFormatSymbolType = UDateFormatSymbolType(13);
pub const UDAT_STYLE_LONG: UDateRelativeDateTimeFormatterStyle = UDateRelativeDateTimeFormatterStyle(0);
pub const UDAT_STYLE_NARROW: UDateRelativeDateTimeFormatterStyle = UDateRelativeDateTimeFormatterStyle(2);
pub const UDAT_STYLE_SHORT: UDateRelativeDateTimeFormatterStyle = UDateRelativeDateTimeFormatterStyle(1);
pub const UDAT_TIMEZONE_FIELD: UDateFormatField = UDateFormatField(17);
pub const UDAT_TIMEZONE_GENERIC_FIELD: UDateFormatField = UDateFormatField(24);
pub const UDAT_TIMEZONE_ISO_FIELD: UDateFormatField = UDateFormatField(32);
pub const UDAT_TIMEZONE_ISO_LOCAL_FIELD: UDateFormatField = UDateFormatField(33);
pub const UDAT_TIMEZONE_LOCALIZED_GMT_OFFSET_FIELD: UDateFormatField = UDateFormatField(31);
pub const UDAT_TIMEZONE_RFC_FIELD: UDateFormatField = UDateFormatField(23);
pub const UDAT_TIMEZONE_SPECIAL_FIELD: UDateFormatField = UDateFormatField(29);
pub const UDAT_WEEKDAY: windows_core::PCSTR = windows_core::s!("EEEE");
pub const UDAT_WEEKDAYS: UDateFormatSymbolType = UDateFormatSymbolType(3);
pub const UDAT_WEEK_OF_MONTH_FIELD: UDateFormatField = UDateFormatField(13);
pub const UDAT_WEEK_OF_YEAR_FIELD: UDateFormatField = UDateFormatField(12);
...
pub const UDAT_YEAR_FIELD: UDateFormatField = UDateFormatField(1);
...
pub const UDAT_YEAR_NAME_FIELD: UDateFormatField = UDateFormatField(30);
...
pub const UDAT_YEAR_WOY_FIELD: UDateFormatField = UDateFormatField(18);
pub const UDAT_ZODIAC_NAMES_ABBREVIATED: UDateFormatSymbolType = UDateFormatSymbolType(26);
pub const UDAT_ZODIAC_NAMES_NARROW: UDateFormatSymbolType = UDateFormatSymbolType(27);
pub const UDAT_ZODIAC_NAMES_WIDE: UDateFormatSymbolType = UDateFormatSymbolType(25);
pub const UDISPCTX_CAPITALIZATION_FOR_BEGINNING_OF_SENTENCE: UDisplayContext = UDisplayContext(258);
pub const UDISPCTX_CAPITALIZATION_FOR_MIDDLE_OF_SENTENCE: UDisplayContext = UDisplayContext(257);
pub const UDISPCTX_CAPITALIZATION_FOR_STANDALONE: UDisplayContext = UDisplayContext(260);
pub const UDISPCTX_CAPITALIZATION_FOR_UI_LIST_OR_MENU: UDisplayContext = UDisplayContext(259);
pub const UDISPCTX_CAPITALIZATION_NONE: UDisplayContext = UDisplayContext(256);
pub const UDISPCTX_DIALECT_NAMES: UDisplayContext = UDisplayContext(1);
pub const UDISPCTX_LENGTH_FULL: UDisplayContext = UDisplayContext(512);
pub const UDISPCTX_LENGTH_SHORT: UDisplayContext = UDisplayContext(513);
pub const UDISPCTX_NO_SUBSTITUTE: UDisplayContext = UDisplayContext(769);
pub const UDISPCTX_STANDARD_NAMES: UDisplayContext = UDisplayContext(0);
pub const UDISPCTX_SUBSTITUTE: UDisplayContext = UDisplayContext(768);
pub const UDISPCTX_TYPE_CAPITALIZATION: UDisplayContextType = UDisplayContextType(1);
pub const UDISPCTX_TYPE_DIALECT_HANDLING: UDisplayContextType = UDisplayContextType(0);
pub const UDISPCTX_TYPE_DISPLAY_LENGTH: UDisplayContextType = UDisplayContextType(2);
pub const UDISPCTX_TYPE_SUBSTITUTE_HANDLING: UDisplayContextType = UDisplayContextType(3);
pub const UDTS_DB2_TIME: UDateTimeScale = UDateTimeScale(8);
pub const UDTS_DOTNET_DATE_TIME: UDateTimeScale = UDateTimeScale(4);
pub const UDTS_EXCEL_TIME: UDateTimeScale = UDateTimeScale(7);
pub const UDTS_ICU4C_TIME: UDateTimeScale = UDateTimeScale(2);
pub const UDTS_JAVA_TIME: UDateTimeScale = UDateTimeScale(0);
pub const UDTS_MAC_OLD_TIME: UDateTimeScale = UDateTimeScale(5);
pub const UDTS_MAC_TIME: UDateTimeScale = UDateTimeScale(6);
pub const UDTS_UNIX_MICROSECONDS_TIME: UDateTimeScale = UDateTimeScale(9);
pub const UDTS_UNIX_TIME: UDateTimeScale = UDateTimeScale(1);
pub const UDTS_WINDOWS_FILE_TIME: UDateTimeScale = UDateTimeScale(3);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const UFIELD_CATEGORY_DATE: UFieldCategory = UFieldCategory(1);
pub const UFIELD_CATEGORY_DATE_INTERVAL: UFieldCategory = UFieldCategory(5);
pub const UFIELD_CATEGORY_DATE_INTERVAL_SPAN: UFieldCategory = UFieldCategory(4101);
pub const UFIELD_CATEGORY_LIST: UFieldCategory = UFieldCategory(3);
pub const UFIELD_CATEGORY_LIST_SPAN: UFieldCategory = UFieldCategory(4099);
pub const UFIELD_CATEGORY_NUMBER: UFieldCategory = UFieldCategory(2);
pub const UFIELD_CATEGORY_NUMBER_RANGE_SPAN: UFieldCategory = UFieldCategory(4098);
pub const UFIELD_CATEGORY_RELATIVE_DATETIME: UFieldCategory = UFieldCategory(4);
pub const UFIELD_CATEGORY_UNDEFINED: UFieldCategory = UFieldCategory(0);
pub const UFMT_ARRAY: UFormattableType = UFormattableType(4);
pub const UFMT_DATE: UFormattableType = UFormattableType(0);
pub const UFMT_DOUBLE: UFormattableType = UFormattableType(1);
pub const UFMT_INT64: UFormattableType = UFormattableType(5);
pub const UFMT_LONG: UFormattableType = UFormattableType(2);
pub const UFMT_OBJECT: UFormattableType = UFormattableType(6);
pub const UFMT_STRING: UFormattableType = UFormattableType(3);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const UGENDER_FEMALE: UGender = UGender(1);
pub const UGENDER_MALE: UGender = UGender(0);
pub const UGENDER_OTHER: UGender = UGender(2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const UITER_CURRENT: UCharIteratorOrigin = UCharIteratorOrigin(1);
pub const UITER_LENGTH: UCharIteratorOrigin = UCharIteratorOrigin(4);
pub const UITER_LIMIT: UCharIteratorOrigin = UCharIteratorOrigin(2);
pub const UITER_START: UCharIteratorOrigin = UCharIteratorOrigin(0);
pub const UITER_UNKNOWN_INDEX: i32 = -2;
pub const UITER_ZERO: UCharIteratorOrigin = UCharIteratorOrigin(3);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const ULDN_DIALECT_NAMES: UDialectHandling = UDialectHandling(1);
pub const ULDN_STANDARD_NAMES: UDialectHandling = UDialectHandling(0);
pub const ULISTFMT_ELEMENT_FIELD: UListFormatterField = UListFormatterField(1);
pub const ULISTFMT_LITERAL_FIELD: UListFormatterField = UListFormatterField(0);
pub const ULISTFMT_TYPE_AND: UListFormatterType = UListFormatterType(0);
pub const ULISTFMT_TYPE_OR: UListFormatterType = UListFormatterType(1);
pub const ULISTFMT_TYPE_UNITS: UListFormatterType = UListFormatterType(2);
pub const ULISTFMT_WIDTH_NARROW: UListFormatterWidth = UListFormatterWidth(2);
pub const ULISTFMT_WIDTH_SHORT: UListFormatterWidth = UListFormatterWidth(1);
pub const ULISTFMT_WIDTH_WIDE: UListFormatterWidth = UListFormatterWidth(0);
pub const ULOCDATA_ALT_QUOTATION_END: ULocaleDataDelimiterType = ULocaleDataDelimiterType(3);
pub const ULOCDATA_ALT_QUOTATION_START: ULocaleDataDelimiterType = ULocaleDataDelimiterType(2);
pub const ULOCDATA_ES_AUXILIARY: ULocaleDataExemplarSetType = ULocaleDataExemplarSetType(1);
pub const ULOCDATA_ES_INDEX: ULocaleDataExemplarSetType = ULocaleDataExemplarSetType(2);
pub const ULOCDATA_ES_PUNCTUATION: ULocaleDataExemplarSetType = ULocaleDataExemplarSetType(3);
pub const ULOCDATA_ES_STANDARD: ULocaleDataExemplarSetType = ULocaleDataExemplarSetType(0);
pub const ULOCDATA_QUOTATION_END: ULocaleDataDelimiterType = ULocaleDataDelimiterType(1);
pub const ULOCDATA_QUOTATION_START: ULocaleDataDelimiterType = ULocaleDataDelimiterType(0);
pub const ULOC_ACCEPT_FAILED: UAcceptResult = UAcceptResult(0);
pub const ULOC_ACCEPT_FALLBACK: UAcceptResult = UAcceptResult(2);
pub const ULOC_ACCEPT_VALID: UAcceptResult = UAcceptResult(1);
pub const ULOC_ACTUAL_LOCALE: ULocDataLocaleType = ULocDataLocaleType(0);
pub const ULOC_AVAILABLE_DEFAULT: ULocAvailableType = ULocAvailableType(0);
pub const ULOC_AVAILABLE_ONLY_LEGACY_ALIASES: ULocAvailableType = ULocAvailableType(1);
pub const ULOC_AVAILABLE_WITH_LEGACY_ALIASES: ULocAvailableType = ULocAvailableType(2);
...
pub const ULOC_LAYOUT_BTT: ULayoutType = ULayoutType(3);
pub const ULOC_LAYOUT_LTR: ULayoutType = ULayoutType(0);
pub const ULOC_LAYOUT_RTL: ULayoutType = ULayoutType(1);
pub const ULOC_LAYOUT_TTB: ULayoutType = ULayoutType(2);
pub const ULOC_LAYOUT_UNKNOWN: ULayoutType = ULayoutType(4);
...
pub const ULOC_VALID_LOCALE: ULocDataLocaleType = ULocDataLocaleType(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const UMEASFMT_WIDTH_COUNT: UMeasureFormatWidth = UMeasureFormatWidth(4);
pub const UMEASFMT_WIDTH_NARROW: UMeasureFormatWidth = UMeasureFormatWidth(2);
pub const UMEASFMT_WIDTH_NUMERIC: UMeasureFormatWidth = UMeasureFormatWidth(3);
pub const UMEASFMT_WIDTH_SHORT: UMeasureFormatWidth = UMeasureFormatWidth(1);
pub const UMEASFMT_WIDTH_WIDE: UMeasureFormatWidth = UMeasureFormatWidth(0);
pub const UMSGPAT_APOS_DOUBLE_OPTIONAL: UMessagePatternApostropheMode = UMessagePatternApostropheMode(0);
pub const UMSGPAT_APOS_DOUBLE_REQUIRED: UMessagePatternApostropheMode = UMessagePatternApostropheMode(1);
pub const UMSGPAT_ARG_NAME_NOT_NUMBER: i32 = -1;
pub const UMSGPAT_ARG_NAME_NOT_VALID: i32 = -2;
pub const UMSGPAT_ARG_TYPE_CHOICE: UMessagePatternArgType = UMessagePatternArgType(2);
pub const UMSGPAT_ARG_TYPE_NONE: UMessagePatternArgType = UMessagePatternArgType(0);
pub const UMSGPAT_ARG_TYPE_PLURAL: UMessagePatternArgType = UMessagePatternArgType(3);
pub const UMSGPAT_ARG_TYPE_SELECT: UMessagePatternArgType = UMessagePatternArgType(4);
pub const UMSGPAT_ARG_TYPE_SELECTORDINAL: UMessagePatternArgType = UMessagePatternArgType(5);
pub const UMSGPAT_ARG_TYPE_SIMPLE: UMessagePatternArgType = UMessagePatternArgType(1);
pub const UMSGPAT_PART_TYPE_ARG_DOUBLE: UMessagePatternPartType = UMessagePatternPartType(13);
pub const UMSGPAT_PART_TYPE_ARG_INT: UMessagePatternPartType = UMessagePatternPartType(12);
pub const UMSGPAT_PART_TYPE_ARG_LIMIT: UMessagePatternPartType = UMessagePatternPartType(6);
pub const UMSGPAT_PART_TYPE_ARG_NAME: UMessagePatternPartType = UMessagePatternPartType(8);
pub const UMSGPAT_PART_TYPE_ARG_NUMBER: UMessagePatternPartType = UMessagePatternPartType(7);
pub const UMSGPAT_PART_TYPE_ARG_SELECTOR: UMessagePatternPartType = UMessagePatternPartType(11);
pub const UMSGPAT_PART_TYPE_ARG_START: UMessagePatternPartType = UMessagePatternPartType(5);
pub const UMSGPAT_PART_TYPE_ARG_STYLE: UMessagePatternPartType = UMessagePatternPartType(10);
pub const UMSGPAT_PART_TYPE_ARG_TYPE: UMessagePatternPartType = UMessagePatternPartType(9);
pub const UMSGPAT_PART_TYPE_INSERT_CHAR: UMessagePatternPartType = UMessagePatternPartType(3);
pub const UMSGPAT_PART_TYPE_MSG_LIMIT: UMessagePatternPartType = UMessagePatternPartType(1);
pub const UMSGPAT_PART_TYPE_MSG_START: UMessagePatternPartType = UMessagePatternPartType(0);
pub const UMSGPAT_PART_TYPE_REPLACE_NUMBER: UMessagePatternPartType = UMessagePatternPartType(4);
pub const UMSGPAT_PART_TYPE_SKIP_SYNTAX: UMessagePatternPartType = UMessagePatternPartType(2);
pub const UMS_SI: UMeasurementSystem = UMeasurementSystem(0);
pub const UMS_UK: UMeasurementSystem = UMeasurementSystem(2);
pub const UMS_US: UMeasurementSystem = UMeasurementSystem(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const UNORM2_COMPOSE: UNormalization2Mode = UNormalization2Mode(0);
pub const UNORM2_COMPOSE_CONTIGUOUS: UNormalization2Mode = UNormalization2Mode(3);
pub const UNORM2_DECOMPOSE: UNormalization2Mode = UNormalization2Mode(1);
pub const UNORM2_FCD: UNormalization2Mode = UNormalization2Mode(2);
pub const UNORM_DEFAULT: UNormalizationMode = UNormalizationMode(4);
pub const UNORM_FCD: UNormalizationMode = UNormalizationMode(6);
pub const UNORM_INPUT_IS_FCD: u32 = 131072;
pub const UNORM_MAYBE: UNormalizationCheckResult = UNormalizationCheckResult(2);
pub const UNORM_MODE_COUNT: UNormalizationMode = UNormalizationMode(7);
pub const UNORM_NFC: UNormalizationMode = UNormalizationMode(4);
pub const UNORM_NFD: UNormalizationMode = UNormalizationMode(2);
pub const UNORM_NFKC: UNormalizationMode = UNormalizationMode(5);
pub const UNORM_NFKD: UNormalizationMode = UNormalizationMode(3);
pub const UNORM_NO: UNormalizationCheckResult = UNormalizationCheckResult(0);
pub const UNORM_NONE: UNormalizationMode = UNormalizationMode(1);
pub const UNORM_YES: UNormalizationCheckResult = UNormalizationCheckResult(1);
...
pub const UNUM_CURRENCY_INSERT: UCurrencySpacing = UCurrencySpacing(2);
pub const UNUM_CURRENCY_ISO: UNumberFormatStyle = UNumberFormatStyle(10);
pub const UNUM_CURRENCY_MATCH: UCurrencySpacing = UCurrencySpacing(0);
pub const UNUM_CURRENCY_PLURAL: UNumberFormatStyle = UNumberFormatStyle(11);
pub const UNUM_CURRENCY_SPACING_COUNT: UCurrencySpacing = UCurrencySpacing(3);
pub const UNUM_CURRENCY_STANDARD: UNumberFormatStyle = UNumberFormatStyle(16);
pub const UNUM_CURRENCY_SURROUNDING_MATCH: UCurrencySpacing = UCurrencySpacing(1);
...
pub const UNUM_DECIMAL_SEPARATOR_ALWAYS: UNumberDecimalSeparatorDisplay = UNumberDecimalSeparatorDisplay(1);
pub const UNUM_DECIMAL_SEPARATOR_AUTO: UNumberDecimalSeparatorDisplay = UNumberDecimalSeparatorDisplay(0);
pub const UNUM_DECIMAL_SEPARATOR_COUNT: UNumberDecimalSeparatorDisplay = UNumberDecimalSeparatorDisplay(2);
...
pub const UNUM_FORMAT_ATTRIBUTE_VALUE_HIDDEN: UNumberFormatAttributeValue = UNumberFormatAttributeValue(0);
pub const UNUM_FORMAT_FAIL_IF_MORE_THAN_MAX_DIGITS: UNumberFormatAttribute = UNumberFormatAttribute(4096);
...
pub const UNUM_GROUPING_AUTO: UNumberGroupingStrategy = UNumberGroupingStrategy(2);
pub const UNUM_GROUPING_MIN2: UNumberGroupingStrategy = UNumberGroupingStrategy(1);
pub const UNUM_GROUPING_OFF: UNumberGroupingStrategy = UNumberGroupingStrategy(0);
pub const UNUM_GROUPING_ON_ALIGNED: UNumberGroupingStrategy = UNumberGroupingStrategy(3);
...
pub const UNUM_GROUPING_THOUSANDS: UNumberGroupingStrategy = UNumberGroupingStrategy(4);
pub const UNUM_GROUPING_USED: UNumberFormatAttribute = UNumberFormatAttribute(1);
pub const UNUM_IDENTITY_FALLBACK_APPROXIMATELY: UNumberRangeIdentityFallback = UNumberRangeIdentityFallback(2);
pub const UNUM_IDENTITY_FALLBACK_APPROXIMATELY_OR_SINGLE_VALUE: UNumberRangeIdentityFallback = UNumberRangeIdentityFallback(1);
pub const UNUM_IDENTITY_FALLBACK_RANGE: UNumberRangeIdentityFallback = UNumberRangeIdentityFallback(3);
pub const UNUM_IDENTITY_FALLBACK_SINGLE_VALUE: UNumberRangeIdentityFallback = UNumberRangeIdentityFallback(0);
pub const UNUM_IDENTITY_RESULT_EQUAL_AFTER_ROUNDING: UNumberRangeIdentityResult = UNumberRangeIdentityResult(1);
pub const UNUM_IDENTITY_RESULT_EQUAL_BEFORE_ROUNDING: UNumberRangeIdentityResult = UNumberRangeIdentityResult(0);
pub const UNUM_IDENTITY_RESULT_NOT_EQUAL: UNumberRangeIdentityResult = UNumberRangeIdentityResult(2);
...
pub const UNUM_LONG: UNumberCompactStyle = UNumberCompactStyle(1);
...
pub const UNUM_MINIMUM_GROUPING_DIGITS_AUTO: UNumberFormatMinimumGroupingDigits = UNumberFormatMinimumGroupingDigits(-2);
pub const UNUM_MINIMUM_GROUPING_DIGITS_MIN2: UNumberFormatMinimumGroupingDigits = UNumberFormatMinimumGroupingDigits(-3);
...
pub const UNUM_MONETARY_GROUPING_SEPARATOR_SYMBOL: UNumberFormatSymbol = UNumberFormatSymbol(17);
...
pub const UNUM_PARSE_DECIMAL_MARK_REQUIRED: UNumberFormatAttribute = UNumberFormatAttribute(4098);
...
pub const UNUM_RANGE_COLLAPSE_ALL: UNumberRangeCollapse = UNumberRangeCollapse(3);
pub const UNUM_RANGE_COLLAPSE_AUTO: UNumberRangeCollapse = UNumberRangeCollapse(0);
pub const UNUM_RANGE_COLLAPSE_NONE: UNumberRangeCollapse = UNumberRangeCollapse(1);
pub const UNUM_RANGE_COLLAPSE_UNIT: UNumberRangeCollapse = UNumberRangeCollapse(2);
...
pub const UNUM_SHORT: UNumberCompactStyle = UNumberCompactStyle(0);
...
pub const UNUM_SIGN_ACCOUNTING: UNumberSignDisplay = UNumberSignDisplay(3);
pub const UNUM_SIGN_ACCOUNTING_ALWAYS: UNumberSignDisplay = UNumberSignDisplay(4);
pub const UNUM_SIGN_ACCOUNTING_EXCEPT_ZERO: UNumberSignDisplay = UNumberSignDisplay(6);
pub const UNUM_SIGN_ACCOUNTING_NEGATIVE: UNumberSignDisplay = UNumberSignDisplay(8);
pub const UNUM_SIGN_ALWAYS: UNumberSignDisplay = UNumberSignDisplay(1);
pub const UNUM_SIGN_ALWAYS_SHOWN: UNumberFormatAttribute = UNumberFormatAttribute(4100);
pub const UNUM_SIGN_AUTO: UNumberSignDisplay = UNumberSignDisplay(0);
pub const UNUM_SIGN_COUNT: UNumberSignDisplay = UNumberSignDisplay(9);
pub const UNUM_SIGN_EXCEPT_ZERO: UNumberSignDisplay = UNumberSignDisplay(5);
pub const UNUM_SIGN_FIELD: UNumberFormatFields = UNumberFormatFields(10);
pub const UNUM_SIGN_NEGATIVE: UNumberSignDisplay = UNumberSignDisplay(7);
pub const UNUM_SIGN_NEVER: UNumberSignDisplay = UNumberSignDisplay(2);
...
pub const UNUM_TRAILING_ZERO_AUTO: UNumberTrailingZeroDisplay = UNumberTrailingZeroDisplay(0);
pub const UNUM_TRAILING_ZERO_HIDE_IF_WHOLE: UNumberTrailingZeroDisplay = UNumberTrailingZeroDisplay(1);
pub const UNUM_TWO_DIGIT_SYMBOL: UNumberFormatSymbol = UNumberFormatSymbol(19);
pub const UNUM_UNIT_WIDTH_COUNT: UNumberUnitWidth = UNumberUnitWidth(7);
pub const UNUM_UNIT_WIDTH_FORMAL: UNumberUnitWidth = UNumberUnitWidth(4);
pub const UNUM_UNIT_WIDTH_FULL_NAME: UNumberUnitWidth = UNumberUnitWidth(2);
pub const UNUM_UNIT_WIDTH_HIDDEN: UNumberUnitWidth = UNumberUnitWidth(6);
pub const UNUM_UNIT_WIDTH_ISO_CODE: UNumberUnitWidth = UNumberUnitWidth(3);
pub const UNUM_UNIT_WIDTH_NARROW: UNumberUnitWidth = UNumberUnitWidth(0);
pub const UNUM_UNIT_WIDTH_SHORT: UNumberUnitWidth = UNumberUnitWidth(1);
pub const UNUM_UNIT_WIDTH_VARIANT: UNumberUnitWidth = UNumberUnitWidth(5);
...
pub const UPLURAL_TYPE_CARDINAL: UPluralType = UPluralType(0);
pub const UPLURAL_TYPE_ORDINAL: UPluralType = UPluralType(1);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const UREGEX_CASE_INSENSITIVE: URegexpFlag = URegexpFlag(2);
pub const UREGEX_COMMENTS: URegexpFlag = URegexpFlag(4);
pub const UREGEX_DOTALL: URegexpFlag = URegexpFlag(32);
pub const UREGEX_ERROR_ON_UNKNOWN_ESCAPES: URegexpFlag = URegexpFlag(512);
pub const UREGEX_LITERAL: URegexpFlag = URegexpFlag(16);
pub const UREGEX_MULTILINE: URegexpFlag = URegexpFlag(8);
pub const UREGEX_UNIX_LINES: URegexpFlag = URegexpFlag(1);
pub const UREGEX_UWORD: URegexpFlag = URegexpFlag(256);
pub const URES_ALIAS: UResType = UResType(3);
pub const URES_ARRAY: UResType = UResType(8);
pub const URES_BINARY: UResType = UResType(1);
pub const URES_INT: UResType = UResType(7);
pub const URES_INT_VECTOR: UResType = UResType(14);
pub const URES_NONE: UResType = UResType(-1);
pub const URES_STRING: UResType = UResType(0);
pub const URES_TABLE: UResType = UResType(2);
pub const URGN_CONTINENT: URegionType = URegionType(3);
pub const URGN_DEPRECATED: URegionType = URegionType(6);
pub const URGN_GROUPING: URegionType = URegionType(5);
pub const URGN_SUBCONTINENT: URegionType = URegionType(4);
pub const URGN_TERRITORY: URegionType = URegionType(1);
pub const URGN_UNKNOWN: URegionType = URegionType(0);
pub const URGN_WORLD: URegionType = URegionType(2);
...
pub const USCRIPT_ADLAM: UScriptCode = UScriptCode(167);
pub const USCRIPT_AFAKA: UScriptCode = UScriptCode(147);
pub const USCRIPT_AHOM: UScriptCode = UScriptCode(161);
pub const USCRIPT_ANATOLIAN_HIEROGLYPHS: UScriptCode = UScriptCode(156);
pub const USCRIPT_ARABIC: UScriptCode = UScriptCode(2);
pub const USCRIPT_ARMENIAN: UScriptCode = UScriptCode(3);
pub const USCRIPT_AVESTAN: UScriptCode = UScriptCode(117);
pub const USCRIPT_BALINESE: UScriptCode = UScriptCode(62);
pub const USCRIPT_BAMUM: UScriptCode = UScriptCode(130);
pub const USCRIPT_BASSA_VAH: UScriptCode = UScriptCode(134);
pub const USCRIPT_BATAK: UScriptCode = UScriptCode(63);
pub const USCRIPT_BENGALI: UScriptCode = UScriptCode(4);
pub const USCRIPT_BHAIKSUKI: UScriptCode = UScriptCode(168);
pub const USCRIPT_BLISSYMBOLS: UScriptCode = UScriptCode(64);
pub const USCRIPT_BOOK_PAHLAVI: UScriptCode = UScriptCode(124);
pub const USCRIPT_BOPOMOFO: UScriptCode = UScriptCode(5);
pub const USCRIPT_BRAHMI: UScriptCode = UScriptCode(65);
pub const USCRIPT_BRAILLE: UScriptCode = UScriptCode(46);
pub const USCRIPT_BUGINESE: UScriptCode = UScriptCode(55);
pub const USCRIPT_BUHID: UScriptCode = UScriptCode(44);
pub const USCRIPT_CANADIAN_ABORIGINAL: UScriptCode = UScriptCode(40);
pub const USCRIPT_CARIAN: UScriptCode = UScriptCode(104);
pub const USCRIPT_CAUCASIAN_ALBANIAN: UScriptCode = UScriptCode(159);
pub const USCRIPT_CHAKMA: UScriptCode = UScriptCode(118);
pub const USCRIPT_CHAM: UScriptCode = UScriptCode(66);
pub const USCRIPT_CHEROKEE: UScriptCode = UScriptCode(6);
pub const USCRIPT_CHORASMIAN: UScriptCode = UScriptCode(189);
pub const USCRIPT_CIRTH: UScriptCode = UScriptCode(67);
pub const USCRIPT_COMMON: UScriptCode = UScriptCode(0);
pub const USCRIPT_COPTIC: UScriptCode = UScriptCode(7);
pub const USCRIPT_CUNEIFORM: UScriptCode = UScriptCode(101);
pub const USCRIPT_CYPRIOT: UScriptCode = UScriptCode(47);
pub const USCRIPT_CYRILLIC: UScriptCode = UScriptCode(8);
pub const USCRIPT_DEMOTIC_EGYPTIAN: UScriptCode = UScriptCode(69);
pub const USCRIPT_DESERET: UScriptCode = UScriptCode(9);
pub const USCRIPT_DEVANAGARI: UScriptCode = UScriptCode(10);
pub const USCRIPT_DIVES_AKURU: UScriptCode = UScriptCode(190);
pub const USCRIPT_DOGRA: UScriptCode = UScriptCode(178);
pub const USCRIPT_DUPLOYAN: UScriptCode = UScriptCode(135);
pub const USCRIPT_EASTERN_SYRIAC: UScriptCode = UScriptCode(97);
pub const USCRIPT_EGYPTIAN_HIEROGLYPHS: UScriptCode = UScriptCode(71);
pub const USCRIPT_ELBASAN: UScriptCode = UScriptCode(136);
pub const USCRIPT_ELYMAIC: UScriptCode = UScriptCode(185);
pub const USCRIPT_ESTRANGELO_SYRIAC: UScriptCode = UScriptCode(95);
pub const USCRIPT_ETHIOPIC: UScriptCode = UScriptCode(11);
pub const USCRIPT_GEORGIAN: UScriptCode = UScriptCode(12);
pub const USCRIPT_GLAGOLITIC: UScriptCode = UScriptCode(56);
pub const USCRIPT_GOTHIC: UScriptCode = UScriptCode(13);
pub const USCRIPT_GRANTHA: UScriptCode = UScriptCode(137);
pub const USCRIPT_GREEK: UScriptCode = UScriptCode(14);
pub const USCRIPT_GUJARATI: UScriptCode = UScriptCode(15);
pub const USCRIPT_GUNJALA_GONDI: UScriptCode = UScriptCode(179);
pub const USCRIPT_GURMUKHI: UScriptCode = UScriptCode(16);
pub const USCRIPT_HAN: UScriptCode = UScriptCode(17);
pub const USCRIPT_HANGUL: UScriptCode = UScriptCode(18);
pub const USCRIPT_HANIFI_ROHINGYA: UScriptCode = UScriptCode(182);
pub const USCRIPT_HANUNOO: UScriptCode = UScriptCode(43);
pub const USCRIPT_HAN_WITH_BOPOMOFO: UScriptCode = UScriptCode(172);
pub const USCRIPT_HARAPPAN_INDUS: UScriptCode = UScriptCode(77);
pub const USCRIPT_HATRAN: UScriptCode = UScriptCode(162);
pub const USCRIPT_HEBREW: UScriptCode = UScriptCode(19);
pub const USCRIPT_HIERATIC_EGYPTIAN: UScriptCode = UScriptCode(70);
pub const USCRIPT_HIRAGANA: UScriptCode = UScriptCode(20);
pub const USCRIPT_IMPERIAL_ARAMAIC: UScriptCode = UScriptCode(116);
pub const USCRIPT_INHERITED: UScriptCode = UScriptCode(1);
pub const USCRIPT_INSCRIPTIONAL_PAHLAVI: UScriptCode = UScriptCode(122);
pub const USCRIPT_INSCRIPTIONAL_PARTHIAN: UScriptCode = UScriptCode(125);
pub const USCRIPT_INVALID_CODE: UScriptCode = UScriptCode(-1);
pub const USCRIPT_JAMO: UScriptCode = UScriptCode(173);
pub const USCRIPT_JAPANESE: UScriptCode = UScriptCode(105);
pub const USCRIPT_JAVANESE: UScriptCode = UScriptCode(78);
pub const USCRIPT_JURCHEN: UScriptCode = UScriptCode(148);
pub const USCRIPT_KAITHI: UScriptCode = UScriptCode(120);
pub const USCRIPT_KANNADA: UScriptCode = UScriptCode(21);
pub const USCRIPT_KATAKANA: UScriptCode = UScriptCode(22);
pub const USCRIPT_KATAKANA_OR_HIRAGANA: UScriptCode = UScriptCode(54);
pub const USCRIPT_KAYAH_LI: UScriptCode = UScriptCode(79);
pub const USCRIPT_KHAROSHTHI: UScriptCode = UScriptCode(57);
pub const USCRIPT_KHITAN_SMALL_SCRIPT: UScriptCode = UScriptCode(191);
pub const USCRIPT_KHMER: UScriptCode = UScriptCode(23);
pub const USCRIPT_KHOJKI: UScriptCode = UScriptCode(157);
pub const USCRIPT_KHUDAWADI: UScriptCode = UScriptCode(145);
pub const USCRIPT_KHUTSURI: UScriptCode = UScriptCode(72);
pub const USCRIPT_KOREAN: UScriptCode = UScriptCode(119);
pub const USCRIPT_KPELLE: UScriptCode = UScriptCode(138);
pub const USCRIPT_LANNA: UScriptCode = UScriptCode(106);
pub const USCRIPT_LAO: UScriptCode = UScriptCode(24);
pub const USCRIPT_LATIN: UScriptCode = UScriptCode(25);
pub const USCRIPT_LATIN_FRAKTUR: UScriptCode = UScriptCode(80);
pub const USCRIPT_LATIN_GAELIC: UScriptCode = UScriptCode(81);
pub const USCRIPT_LEPCHA: UScriptCode = UScriptCode(82);
pub const USCRIPT_LIMBU: UScriptCode = UScriptCode(48);
pub const USCRIPT_LINEAR_A: UScriptCode = UScriptCode(83);
pub const USCRIPT_LINEAR_B: UScriptCode = UScriptCode(49);
pub const USCRIPT_LISU: UScriptCode = UScriptCode(131);
pub const USCRIPT_LOMA: UScriptCode = UScriptCode(139);
pub const USCRIPT_LYCIAN: UScriptCode = UScriptCode(107);
pub const USCRIPT_LYDIAN: UScriptCode = UScriptCode(108);
pub const USCRIPT_MAHAJANI: UScriptCode = UScriptCode(160);
pub const USCRIPT_MAKASAR: UScriptCode = UScriptCode(180);
pub const USCRIPT_MALAYALAM: UScriptCode = UScriptCode(26);
pub const USCRIPT_MANDAEAN: UScriptCode = UScriptCode(84);
pub const USCRIPT_MANDAIC: UScriptCode = UScriptCode(84);
pub const USCRIPT_MANICHAEAN: UScriptCode = UScriptCode(121);
pub const USCRIPT_MARCHEN: UScriptCode = UScriptCode(169);
pub const USCRIPT_MASARAM_GONDI: UScriptCode = UScriptCode(175);
pub const USCRIPT_MATHEMATICAL_NOTATION: UScriptCode = UScriptCode(128);
pub const USCRIPT_MAYAN_HIEROGLYPHS: UScriptCode = UScriptCode(85);
pub const USCRIPT_MEDEFAIDRIN: UScriptCode = UScriptCode(181);
pub const USCRIPT_MEITEI_MAYEK: UScriptCode = UScriptCode(115);
pub const USCRIPT_MENDE: UScriptCode = UScriptCode(140);
pub const USCRIPT_MEROITIC: UScriptCode = UScriptCode(86);
pub const USCRIPT_MEROITIC_CURSIVE: UScriptCode = UScriptCode(141);
pub const USCRIPT_MEROITIC_HIEROGLYPHS: UScriptCode = UScriptCode(86);
pub const USCRIPT_MIAO: UScriptCode = UScriptCode(92);
pub const USCRIPT_MODI: UScriptCode = UScriptCode(163);
pub const USCRIPT_MONGOLIAN: UScriptCode = UScriptCode(27);
pub const USCRIPT_MOON: UScriptCode = UScriptCode(114);
pub const USCRIPT_MRO: UScriptCode = UScriptCode(149);
pub const USCRIPT_MULTANI: UScriptCode = UScriptCode(164);
pub const USCRIPT_MYANMAR: UScriptCode = UScriptCode(28);
pub const USCRIPT_NABATAEAN: UScriptCode = UScriptCode(143);
pub const USCRIPT_NAKHI_GEBA: UScriptCode = UScriptCode(132);
pub const USCRIPT_NANDINAGARI: UScriptCode = UScriptCode(187);
pub const USCRIPT_NEWA: UScriptCode = UScriptCode(170);
pub const USCRIPT_NEW_TAI_LUE: UScriptCode = UScriptCode(59);
pub const USCRIPT_NKO: UScriptCode = UScriptCode(87);
pub const USCRIPT_NUSHU: UScriptCode = UScriptCode(150);
pub const USCRIPT_NYIAKENG_PUACHUE_HMONG: UScriptCode = UScriptCode(186);
pub const USCRIPT_OGHAM: UScriptCode = UScriptCode(29);
pub const USCRIPT_OLD_CHURCH_SLAVONIC_CYRILLIC: UScriptCode = UScriptCode(68);
pub const USCRIPT_OLD_HUNGARIAN: UScriptCode = UScriptCode(76);
pub const USCRIPT_OLD_ITALIC: UScriptCode = UScriptCode(30);
pub const USCRIPT_OLD_NORTH_ARABIAN: UScriptCode = UScriptCode(142);
pub const USCRIPT_OLD_PERMIC: UScriptCode = UScriptCode(89);
pub const USCRIPT_OLD_PERSIAN: UScriptCode = UScriptCode(61);
pub const USCRIPT_OLD_SOGDIAN: UScriptCode = UScriptCode(184);
pub const USCRIPT_OLD_SOUTH_ARABIAN: UScriptCode = UScriptCode(133);
pub const USCRIPT_OL_CHIKI: UScriptCode = UScriptCode(109);
pub const USCRIPT_ORIYA: UScriptCode = UScriptCode(31);
pub const USCRIPT_ORKHON: UScriptCode = UScriptCode(88);
pub const USCRIPT_OSAGE: UScriptCode = UScriptCode(171);
pub const USCRIPT_OSMANYA: UScriptCode = UScriptCode(50);
pub const USCRIPT_PAHAWH_HMONG: UScriptCode = UScriptCode(75);
pub const USCRIPT_PALMYRENE: UScriptCode = UScriptCode(144);
pub const USCRIPT_PAU_CIN_HAU: UScriptCode = UScriptCode(165);
pub const USCRIPT_PHAGS_PA: UScriptCode = UScriptCode(90);
pub const USCRIPT_PHOENICIAN: UScriptCode = UScriptCode(91);
pub const USCRIPT_PHONETIC_POLLARD: UScriptCode = UScriptCode(92);
pub const USCRIPT_PSALTER_PAHLAVI: UScriptCode = UScriptCode(123);
pub const USCRIPT_REJANG: UScriptCode = UScriptCode(110);
pub const USCRIPT_RONGORONGO: UScriptCode = UScriptCode(93);
pub const USCRIPT_RUNIC: UScriptCode = UScriptCode(32);
pub const USCRIPT_SAMARITAN: UScriptCode = UScriptCode(126);
pub const USCRIPT_SARATI: UScriptCode = UScriptCode(94);
pub const USCRIPT_SAURASHTRA: UScriptCode = UScriptCode(111);
pub const USCRIPT_SHARADA: UScriptCode = UScriptCode(151);
pub const USCRIPT_SHAVIAN: UScriptCode = UScriptCode(51);
pub const USCRIPT_SIDDHAM: UScriptCode = UScriptCode(166);
pub const USCRIPT_SIGN_WRITING: UScriptCode = UScriptCode(112);
pub const USCRIPT_SIMPLIFIED_HAN: UScriptCode = UScriptCode(73);
pub const USCRIPT_SINDHI: UScriptCode = UScriptCode(145);
pub const USCRIPT_SINHALA: UScriptCode = UScriptCode(33);
pub const USCRIPT_SOGDIAN: UScriptCode = UScriptCode(183);
pub const USCRIPT_SORA_SOMPENG: UScriptCode = UScriptCode(152);
pub const USCRIPT_SOYOMBO: UScriptCode = UScriptCode(176);
pub const USCRIPT_SUNDANESE: UScriptCode = UScriptCode(113);
pub const USCRIPT_SYLOTI_NAGRI: UScriptCode = UScriptCode(58);
pub const USCRIPT_SYMBOLS: UScriptCode = UScriptCode(129);
pub const USCRIPT_SYMBOLS_EMOJI: UScriptCode = UScriptCode(174);
pub const USCRIPT_SYRIAC: UScriptCode = UScriptCode(34);
pub const USCRIPT_TAGALOG: UScriptCode = UScriptCode(42);
pub const USCRIPT_TAGBANWA: UScriptCode = UScriptCode(45);
pub const USCRIPT_TAI_LE: UScriptCode = UScriptCode(52);
pub const USCRIPT_TAI_VIET: UScriptCode = UScriptCode(127);
pub const USCRIPT_TAKRI: UScriptCode = UScriptCode(153);
pub const USCRIPT_TAMIL: UScriptCode = UScriptCode(35);
pub const USCRIPT_TANGUT: UScriptCode = UScriptCode(154);
pub const USCRIPT_TELUGU: UScriptCode = UScriptCode(36);
pub const USCRIPT_TENGWAR: UScriptCode = UScriptCode(98);
pub const USCRIPT_THAANA: UScriptCode = UScriptCode(37);
pub const USCRIPT_THAI: UScriptCode = UScriptCode(38);
pub const USCRIPT_TIBETAN: UScriptCode = UScriptCode(39);
pub const USCRIPT_TIFINAGH: UScriptCode = UScriptCode(60);
pub const USCRIPT_TIRHUTA: UScriptCode = UScriptCode(158);
pub const USCRIPT_TRADITIONAL_HAN: UScriptCode = UScriptCode(74);
pub const USCRIPT_UCAS: UScriptCode = UScriptCode(40);
pub const USCRIPT_UGARITIC: UScriptCode = UScriptCode(53);
pub const USCRIPT_UNKNOWN: UScriptCode = UScriptCode(103);
pub const USCRIPT_UNWRITTEN_LANGUAGES: UScriptCode = UScriptCode(102);
pub const USCRIPT_USAGE_ASPIRATIONAL: UScriptUsage = UScriptUsage(4);
pub const USCRIPT_USAGE_EXCLUDED: UScriptUsage = UScriptUsage(2);
pub const USCRIPT_USAGE_LIMITED_USE: UScriptUsage = UScriptUsage(3);
pub const USCRIPT_USAGE_NOT_ENCODED: UScriptUsage = UScriptUsage(0);
pub const USCRIPT_USAGE_RECOMMENDED: UScriptUsage = UScriptUsage(5);
pub const USCRIPT_USAGE_UNKNOWN: UScriptUsage = UScriptUsage(1);
pub const USCRIPT_VAI: UScriptCode = UScriptCode(99);
pub const USCRIPT_VISIBLE_SPEECH: UScriptCode = UScriptCode(100);
pub const USCRIPT_WANCHO: UScriptCode = UScriptCode(188);
pub const USCRIPT_WARANG_CITI: UScriptCode = UScriptCode(146);
pub const USCRIPT_WESTERN_SYRIAC: UScriptCode = UScriptCode(96);
pub const USCRIPT_WOLEAI: UScriptCode = UScriptCode(155);
pub const USCRIPT_YEZIDI: UScriptCode = UScriptCode(192);
pub const USCRIPT_YI: UScriptCode = UScriptCode(41);
pub const USCRIPT_ZANABAZAR_SQUARE: UScriptCode = UScriptCode(177);
pub const USEARCH_ANY_BASE_WEIGHT_IS_WILDCARD: USearchAttributeValue = USearchAttributeValue(4);
pub const USEARCH_DEFAULT: USearchAttributeValue = USearchAttributeValue(-1);
pub const USEARCH_DONE: i32 = -1;
pub const USEARCH_ELEMENT_COMPARISON: USearchAttribute = USearchAttribute(2);
pub const USEARCH_OFF: USearchAttributeValue = USearchAttributeValue(0);
pub const USEARCH_ON: USearchAttributeValue = USearchAttributeValue(1);
pub const USEARCH_OVERLAP: USearchAttribute = USearchAttribute(0);
pub const USEARCH_PATTERN_BASE_WEIGHT_IS_WILDCARD: USearchAttributeValue = USearchAttributeValue(3);
pub const USEARCH_STANDARD_ELEMENT_COMPARISON: USearchAttributeValue = USearchAttributeValue(2);
...
pub const USET_SPAN_CONTAINED: USetSpanCondition = USetSpanCondition(1);
pub const USET_SPAN_NOT_CONTAINED: USetSpanCondition = USetSpanCondition(0);
pub const USET_SPAN_SIMPLE: USetSpanCondition = USetSpanCondition(2);
pub const USPOOF_ALL_CHECKS: USpoofChecks = USpoofChecks(65535);
pub const USPOOF_ASCII: URestrictionLevel = URestrictionLevel(268435456);
pub const USPOOF_AUX_INFO: USpoofChecks = USpoofChecks(1073741824);
pub const USPOOF_CHAR_LIMIT: USpoofChecks = USpoofChecks(64);
pub const USPOOF_CONFUSABLE: USpoofChecks = USpoofChecks(7);
pub const USPOOF_HIDDEN_OVERLAY: USpoofChecks = USpoofChecks(256);
pub const USPOOF_HIGHLY_RESTRICTIVE: URestrictionLevel = URestrictionLevel(805306368);
pub const USPOOF_INVISIBLE: USpoofChecks = USpoofChecks(32);
pub const USPOOF_MINIMALLY_RESTRICTIVE: URestrictionLevel = URestrictionLevel(1342177280);
pub const USPOOF_MIXED_NUMBERS: USpoofChecks = USpoofChecks(128);
pub const USPOOF_MIXED_SCRIPT_CONFUSABLE: USpoofChecks = USpoofChecks(2);
pub const USPOOF_MODERATELY_RESTRICTIVE: URestrictionLevel = URestrictionLevel(1073741824);
pub const USPOOF_RESTRICTION_LEVEL: USpoofChecks = USpoofChecks(16);
pub const USPOOF_RESTRICTION_LEVEL_MASK: URestrictionLevel = URestrictionLevel(2130706432);
pub const USPOOF_SINGLE_SCRIPT_CONFUSABLE: USpoofChecks = USpoofChecks(1);
pub const USPOOF_SINGLE_SCRIPT_RESTRICTIVE: URestrictionLevel = URestrictionLevel(536870912);
pub const USPOOF_UNRESTRICTIVE: URestrictionLevel = URestrictionLevel(1610612736);
pub const USPOOF_WHOLE_SCRIPT_CONFUSABLE: USpoofChecks = USpoofChecks(4);
pub const USPREP_ALLOW_UNASSIGNED: u32 = 1;
pub const USPREP_DEFAULT: u32 = 0;
pub const USPREP_RFC3491_NAMEPREP: UStringPrepProfileType = UStringPrepProfileType(0);
pub const USPREP_RFC3530_NFS4_CIS_PREP: UStringPrepProfileType = UStringPrepProfileType(3);
pub const USPREP_RFC3530_NFS4_CS_PREP: UStringPrepProfileType = UStringPrepProfileType(1);
pub const USPREP_RFC3530_NFS4_CS_PREP_CI: UStringPrepProfileType = UStringPrepProfileType(2);
pub const USPREP_RFC3530_NFS4_MIXED_PREP_PREFIX: UStringPrepProfileType = UStringPrepProfileType(4);
pub const USPREP_RFC3530_NFS4_MIXED_PREP_SUFFIX: UStringPrepProfileType = UStringPrepProfileType(5);
pub const USPREP_RFC3722_ISCSI: UStringPrepProfileType = UStringPrepProfileType(6);
pub const USPREP_RFC3920_NODEPREP: UStringPrepProfileType = UStringPrepProfileType(7);
pub const USPREP_RFC3920_RESOURCEPREP: UStringPrepProfileType = UStringPrepProfileType(8);
pub const USPREP_RFC4011_MIB: UStringPrepProfileType = UStringPrepProfileType(9);
pub const USPREP_RFC4013_SASLPREP: UStringPrepProfileType = UStringPrepProfileType(10);
pub const USPREP_RFC4505_TRACE: UStringPrepProfileType = UStringPrepProfileType(11);
pub const USPREP_RFC4518_LDAP: UStringPrepProfileType = UStringPrepProfileType(12);
pub const USPREP_RFC4518_LDAP_CI: UStringPrepProfileType = UStringPrepProfileType(13);
pub const USP_E_SCRIPT_NOT_IN_FONT: windows_core::HRESULT = windows_core::HRESULT(0x80040200_u32 as _);
pub const USTRINGTRIE_BUILD_FAST: UStringTrieBuildOption = UStringTrieBuildOption(0);
pub const USTRINGTRIE_BUILD_SMALL: UStringTrieBuildOption = UStringTrieBuildOption(1);
pub const USTRINGTRIE_FINAL_VALUE: UStringTrieResult = UStringTrieResult(2);
pub const USTRINGTRIE_INTERMEDIATE_VALUE: UStringTrieResult = UStringTrieResult(3);
pub const USTRINGTRIE_NO_MATCH: UStringTrieResult = UStringTrieResult(0);
pub const USTRINGTRIE_NO_VALUE: UStringTrieResult = UStringTrieResult(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const UTRACE_COLLATION_START: UTraceFunctionNumber = UTraceFunctionNumber(8192);
pub const UTRACE_CONVERSION_START: UTraceFunctionNumber = UTraceFunctionNumber(4096);
pub const UTRACE_ERROR: UTraceLevel = UTraceLevel(0);
pub const UTRACE_FUNCTION_START: UTraceFunctionNumber = UTraceFunctionNumber(0);
pub const UTRACE_INFO: UTraceLevel = UTraceLevel(7);
pub const UTRACE_OFF: UTraceLevel = UTraceLevel(-1);
pub const UTRACE_OPEN_CLOSE: UTraceLevel = UTraceLevel(5);
pub const UTRACE_UCNV_CLONE: UTraceFunctionNumber = UTraceFunctionNumber(4099);
pub const UTRACE_UCNV_CLOSE: UTraceFunctionNumber = UTraceFunctionNumber(4100);
pub const UTRACE_UCNV_FLUSH_CACHE: UTraceFunctionNumber = UTraceFunctionNumber(4101);
pub const UTRACE_UCNV_LOAD: UTraceFunctionNumber = UTraceFunctionNumber(4102);
pub const UTRACE_UCNV_OPEN: UTraceFunctionNumber = UTraceFunctionNumber(4096);
pub const UTRACE_UCNV_OPEN_ALGORITHMIC: UTraceFunctionNumber = UTraceFunctionNumber(4098);
pub const UTRACE_UCNV_OPEN_PACKAGE: UTraceFunctionNumber = UTraceFunctionNumber(4097);
pub const UTRACE_UCNV_UNLOAD: UTraceFunctionNumber = UTraceFunctionNumber(4103);
pub const UTRACE_UCOL_CLOSE: UTraceFunctionNumber = UTraceFunctionNumber(8193);
pub const UTRACE_UCOL_GETLOCALE: UTraceFunctionNumber = UTraceFunctionNumber(8196);
pub const UTRACE_UCOL_GET_SORTKEY: UTraceFunctionNumber = UTraceFunctionNumber(8195);
pub const UTRACE_UCOL_NEXTSORTKEYPART: UTraceFunctionNumber = UTraceFunctionNumber(8197);
pub const UTRACE_UCOL_OPEN: UTraceFunctionNumber = UTraceFunctionNumber(8192);
pub const UTRACE_UCOL_OPEN_FROM_SHORT_STRING: UTraceFunctionNumber = UTraceFunctionNumber(8199);
pub const UTRACE_UCOL_STRCOLL: UTraceFunctionNumber = UTraceFunctionNumber(8194);
pub const UTRACE_UCOL_STRCOLLITER: UTraceFunctionNumber = UTraceFunctionNumber(8198);
pub const UTRACE_UCOL_STRCOLLUTF8: UTraceFunctionNumber = UTraceFunctionNumber(8200);
pub const UTRACE_UDATA_BUNDLE: UTraceFunctionNumber = UTraceFunctionNumber(12289);
pub const UTRACE_UDATA_DATA_FILE: UTraceFunctionNumber = UTraceFunctionNumber(12290);
pub const UTRACE_UDATA_RESOURCE: UTraceFunctionNumber = UTraceFunctionNumber(12288);
pub const UTRACE_UDATA_RES_FILE: UTraceFunctionNumber = UTraceFunctionNumber(12291);
pub const UTRACE_UDATA_START: UTraceFunctionNumber = UTraceFunctionNumber(12288);
pub const UTRACE_U_CLEANUP: UTraceFunctionNumber = UTraceFunctionNumber(1);
pub const UTRACE_U_INIT: UTraceFunctionNumber = UTraceFunctionNumber(0);
pub const UTRACE_VERBOSE: UTraceLevel = UTraceLevel(9);
pub const UTRACE_WARNING: UTraceLevel = UTraceLevel(3);
pub const UTRANS_FORWARD: UTransDirection = UTransDirection(0);
pub const UTRANS_REVERSE: UTransDirection = UTransDirection(1);
pub const UTSV_EPOCH_OFFSET_VALUE: UTimeScaleValue = UTimeScaleValue(1);
pub const UTSV_FROM_MAX_VALUE: UTimeScaleValue = UTimeScaleValue(3);
pub const UTSV_FROM_MIN_VALUE: UTimeScaleValue = UTimeScaleValue(2);
pub const UTSV_TO_MAX_VALUE: UTimeScaleValue = UTimeScaleValue(5);
pub const UTSV_TO_MIN_VALUE: UTimeScaleValue = UTimeScaleValue(4);
pub const UTSV_UNITS_VALUE: UTimeScaleValue = UTimeScaleValue(0);
pub const UTZFMT_PARSE_OPTION_ALL_STYLES: UTimeZoneFormatParseOption = UTimeZoneFormatParseOption(1);
pub const UTZFMT_PARSE_OPTION_NONE: UTimeZoneFormatParseOption = UTimeZoneFormatParseOption(0);
pub const UTZFMT_PARSE_OPTION_TZ_DATABASE_ABBREVIATIONS: UTimeZoneFormatParseOption = UTimeZoneFormatParseOption(2);
pub const UTZFMT_PAT_COUNT: UTimeZoneFormatGMTOffsetPatternType = UTimeZoneFormatGMTOffsetPatternType(6);
pub const UTZFMT_PAT_NEGATIVE_H: UTimeZoneFormatGMTOffsetPatternType = UTimeZoneFormatGMTOffsetPatternType(5);
pub const UTZFMT_PAT_NEGATIVE_HM: UTimeZoneFormatGMTOffsetPatternType = UTimeZoneFormatGMTOffsetPatternType(2);
pub const UTZFMT_PAT_NEGATIVE_HMS: UTimeZoneFormatGMTOffsetPatternType = UTimeZoneFormatGMTOffsetPatternType(3);
pub const UTZFMT_PAT_POSITIVE_H: UTimeZoneFormatGMTOffsetPatternType = UTimeZoneFormatGMTOffsetPatternType(4);
pub const UTZFMT_PAT_POSITIVE_HM: UTimeZoneFormatGMTOffsetPatternType = UTimeZoneFormatGMTOffsetPatternType(0);
pub const UTZFMT_PAT_POSITIVE_HMS: UTimeZoneFormatGMTOffsetPatternType = UTimeZoneFormatGMTOffsetPatternType(1);
pub const UTZFMT_STYLE_EXEMPLAR_LOCATION: UTimeZoneFormatStyle = UTimeZoneFormatStyle(19);
pub const UTZFMT_STYLE_GENERIC_LOCATION: UTimeZoneFormatStyle = UTimeZoneFormatStyle(0);
pub const UTZFMT_STYLE_GENERIC_LONG: UTimeZoneFormatStyle = UTimeZoneFormatStyle(1);
pub const UTZFMT_STYLE_GENERIC_SHORT: UTimeZoneFormatStyle = UTimeZoneFormatStyle(2);
pub const UTZFMT_STYLE_ISO_BASIC_FIXED: UTimeZoneFormatStyle = UTimeZoneFormatStyle(9);
pub const UTZFMT_STYLE_ISO_BASIC_FULL: UTimeZoneFormatStyle = UTimeZoneFormatStyle(11);
pub const UTZFMT_STYLE_ISO_BASIC_LOCAL_FIXED: UTimeZoneFormatStyle = UTimeZoneFormatStyle(10);
pub const UTZFMT_STYLE_ISO_BASIC_LOCAL_FULL: UTimeZoneFormatStyle = UTimeZoneFormatStyle(12);
pub const UTZFMT_STYLE_ISO_BASIC_LOCAL_SHORT: UTimeZoneFormatStyle = UTimeZoneFormatStyle(8);
pub const UTZFMT_STYLE_ISO_BASIC_SHORT: UTimeZoneFormatStyle = UTimeZoneFormatStyle(7);
pub const UTZFMT_STYLE_ISO_EXTENDED_FIXED: UTimeZoneFormatStyle = UTimeZoneFormatStyle(13);
pub const UTZFMT_STYLE_ISO_EXTENDED_FULL: UTimeZoneFormatStyle = UTimeZoneFormatStyle(15);
pub const UTZFMT_STYLE_ISO_EXTENDED_LOCAL_FIXED: UTimeZoneFormatStyle = UTimeZoneFormatStyle(14);
pub const UTZFMT_STYLE_ISO_EXTENDED_LOCAL_FULL: UTimeZoneFormatStyle = UTimeZoneFormatStyle(16);
pub const UTZFMT_STYLE_LOCALIZED_GMT: UTimeZoneFormatStyle = UTimeZoneFormatStyle(5);
pub const UTZFMT_STYLE_LOCALIZED_GMT_SHORT: UTimeZoneFormatStyle = UTimeZoneFormatStyle(6);
pub const UTZFMT_STYLE_SPECIFIC_LONG: UTimeZoneFormatStyle = UTimeZoneFormatStyle(3);
pub const UTZFMT_STYLE_SPECIFIC_SHORT: UTimeZoneFormatStyle = UTimeZoneFormatStyle(4);
pub const UTZFMT_STYLE_ZONE_ID: UTimeZoneFormatStyle = UTimeZoneFormatStyle(17);
pub const UTZFMT_STYLE_ZONE_ID_SHORT: UTimeZoneFormatStyle = UTimeZoneFormatStyle(18);
pub const UTZFMT_TIME_TYPE_DAYLIGHT: UTimeZoneFormatTimeType = UTimeZoneFormatTimeType(2);
pub const UTZFMT_TIME_TYPE_STANDARD: UTimeZoneFormatTimeType = UTimeZoneFormatTimeType(1);
pub const UTZFMT_TIME_TYPE_UNKNOWN: UTimeZoneFormatTimeType = UTimeZoneFormatTimeType(0);
pub const UTZNM_EXEMPLAR_LOCATION: UTimeZoneNameType = UTimeZoneNameType(64);
pub const UTZNM_LONG_DAYLIGHT: UTimeZoneNameType = UTimeZoneNameType(4);
pub const UTZNM_LONG_GENERIC: UTimeZoneNameType = UTimeZoneNameType(1);
pub const UTZNM_LONG_STANDARD: UTimeZoneNameType = UTimeZoneNameType(2);
pub const UTZNM_SHORT_DAYLIGHT: UTimeZoneNameType = UTimeZoneNameType(32);
pub const UTZNM_SHORT_GENERIC: UTimeZoneNameType = UTimeZoneNameType(8);
pub const UTZNM_SHORT_STANDARD: UTimeZoneNameType = UTimeZoneNameType(16);
pub const UTZNM_UNKNOWN: UTimeZoneNameType = UTimeZoneNameType(0);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct UText {
    pub magic: u32,
...
pub type UTraceData = Option<unsafe extern "C" fn(context: *const core::ffi::c_void, fnnumber: i32, level: i32, fmt: windows_core::PCSTR, args: *mut i8)>;
pub type UTraceEntry = Option<unsafe extern "C" fn(context: *const core::ffi::c_void, fnnumber: i32)>;
pub type UTraceExit = Option<unsafe extern "C" fn(context: *const core::ffi::c_void, fnnumber: i32, fmt: windows_core::PCSTR, args: *mut i8)>;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const U_ALPHAINDEX_INFLOW: UAlphabeticIndexLabelType = UAlphabeticIndexLabelType(2);
pub const U_ALPHAINDEX_NORMAL: UAlphabeticIndexLabelType = UAlphabeticIndexLabelType(0);
pub const U_ALPHAINDEX_OVERFLOW: UAlphabeticIndexLabelType = UAlphabeticIndexLabelType(3);
pub const U_ALPHAINDEX_UNDERFLOW: UAlphabeticIndexLabelType = UAlphabeticIndexLabelType(1);
pub const U_AMBIGUOUS_ALIAS_WARNING: UErrorCode = UErrorCode(-122);
pub const U_ARABIC_NUMBER: UCharDirection = UCharDirection(5);
...
pub const U_BLOCK_SEPARATOR: UCharDirection = UCharDirection(7);
pub const U_BOUNDARY_NEUTRAL: UCharDirection = UCharDirection(18);
pub const U_BPT_CLOSE: UBidiPairedBracketType = UBidiPairedBracketType(2);
pub const U_BPT_NONE: UBidiPairedBracketType = UBidiPairedBracketType(0);
pub const U_BPT_OPEN: UBidiPairedBracketType = UBidiPairedBracketType(1);
...
pub const U_CHAR16_IS_TYPEDEF: u32 = 1;
pub const U_CHARSET_FAMILY: u32 = 1;
pub const U_CHARSET_IS_UTF8: u32 = 1;
pub const U_CHAR_CATEGORY_COUNT: UCharCategory = UCharCategory(30);
pub const U_CHAR_NAME_ALIAS: UCharNameChoice = UCharNameChoice(3);
pub const U_CHECK_DYLOAD: u32 = 1;
pub const U_COLLATOR_VERSION_MISMATCH: UErrorCode = UErrorCode(28);
pub const U_COMBINED_IMPLEMENTATION: u32 = 1;
pub const U_COMBINING_SPACING_MARK: UCharCategory = UCharCategory(8);
pub const U_COMMON_NUMBER_SEPARATOR: UCharDirection = UCharDirection(6);
pub const U_COMPARE_CODE_POINT_ORDER: u32 = 32768;
pub const U_COMPARE_IGNORE_CASE: u32 = 65536;
pub const U_CONNECTOR_PUNCTUATION: UCharCategory = UCharCategory(22);
pub const U_CONTROL_CHAR: UCharCategory = UCharCategory(15);
pub const U_COPYRIGHT_STRING_LENGTH: u32 = 128;
pub const U_CPLUSPLUS_VERSION: u32 = 0;
pub const U_CURRENCY_SYMBOL: UCharCategory = UCharCategory(25);
pub const U_DASH_PUNCTUATION: UCharCategory = UCharCategory(19);
pub const U_DEBUG: u32 = 1;
pub const U_DECIMAL_DIGIT_NUMBER: UCharCategory = UCharCategory(9);
...
pub const U_DEFINE_FALSE_AND_TRUE: u32 = 1;
pub const U_DIFFERENT_UCA_VERSION: UErrorCode = UErrorCode(-121);
pub const U_DIR_NON_SPACING_MARK: UCharDirection = UCharDirection(17);
pub const U_DISABLE_RENAMING: u32 = 1;
pub const U_DT_CANONICAL: UDecompositionType = UDecompositionType(1);
pub const U_DT_CIRCLE: UDecompositionType = UDecompositionType(3);
pub const U_DT_COMPAT: UDecompositionType = UDecompositionType(2);
pub const U_DT_FINAL: UDecompositionType = UDecompositionType(4);
pub const U_DT_FONT: UDecompositionType = UDecompositionType(5);
pub const U_DT_FRACTION: UDecompositionType = UDecompositionType(6);
pub const U_DT_INITIAL: UDecompositionType = UDecompositionType(7);
pub const U_DT_ISOLATED: UDecompositionType = UDecompositionType(8);
pub const U_DT_MEDIAL: UDecompositionType = UDecompositionType(9);
pub const U_DT_NARROW: UDecompositionType = UDecompositionType(10);
pub const U_DT_NOBREAK: UDecompositionType = UDecompositionType(11);
pub const U_DT_NONE: UDecompositionType = UDecompositionType(0);
pub const U_DT_SMALL: UDecompositionType = UDecompositionType(12);
pub const U_DT_SQUARE: UDecompositionType = UDecompositionType(13);
pub const U_DT_SUB: UDecompositionType = UDecompositionType(14);
pub const U_DT_SUPER: UDecompositionType = UDecompositionType(15);
pub const U_DT_VERTICAL: UDecompositionType = UDecompositionType(16);
pub const U_DT_WIDE: UDecompositionType = UDecompositionType(17);
pub const U_DUPLICATE_KEYWORD: UErrorCode = UErrorCode(65805);
pub const U_EA_AMBIGUOUS: UEastAsianWidth = UEastAsianWidth(1);
pub const U_EA_FULLWIDTH: UEastAsianWidth = UEastAsianWidth(3);
pub const U_EA_HALFWIDTH: UEastAsianWidth = UEastAsianWidth(2);
pub const U_EA_NARROW: UEastAsianWidth = UEastAsianWidth(4);
pub const U_EA_NEUTRAL: UEastAsianWidth = UEastAsianWidth(0);
pub const U_EA_WIDE: UEastAsianWidth = UEastAsianWidth(5);
...
pub const U_ENCLOSING_MARK: UCharCategory = UCharCategory(7);
pub const U_END_PUNCTUATION: UCharCategory = UCharCategory(21);
pub const U_ENUM_OUT_OF_SYNC_ERROR: UErrorCode = UErrorCode(25);
pub const U_ERROR_WARNING_START: UErrorCode = UErrorCode(-128);
pub const U_EUROPEAN_NUMBER: UCharDirection = UCharDirection(2);
pub const U_EUROPEAN_NUMBER_SEPARATOR: UCharDirection = UCharDirection(3);
pub const U_EUROPEAN_NUMBER_TERMINATOR: UCharDirection = UCharDirection(4);
pub const U_EXTENDED_CHAR_NAME: UCharNameChoice = UCharNameChoice(2);
pub const U_FILE_ACCESS_ERROR: UErrorCode = UErrorCode(4);
pub const U_FINAL_PUNCTUATION: UCharCategory = UCharCategory(29);
pub const U_FIRST_STRONG_ISOLATE: UCharDirection = UCharDirection(19);
...
pub const U_FORMAT_CHAR: UCharCategory = UCharCategory(16);
pub const U_FORMAT_INEXACT_ERROR: UErrorCode = UErrorCode(65809);
pub const U_GCB_CONTROL: UGraphemeClusterBreak = UGraphemeClusterBreak(1);
pub const U_GCB_CR: UGraphemeClusterBreak = UGraphemeClusterBreak(2);
pub const U_GCB_EXTEND: UGraphemeClusterBreak = UGraphemeClusterBreak(3);
pub const U_GCB_E_BASE: UGraphemeClusterBreak = UGraphemeClusterBreak(13);
pub const U_GCB_E_BASE_GAZ: UGraphemeClusterBreak = UGraphemeClusterBreak(14);
pub const U_GCB_E_MODIFIER: UGraphemeClusterBreak = UGraphemeClusterBreak(15);
pub const U_GCB_GLUE_AFTER_ZWJ: UGraphemeClusterBreak = UGraphemeClusterBreak(16);
pub const U_GCB_L: UGraphemeClusterBreak = UGraphemeClusterBreak(4);
pub const U_GCB_LF: UGraphemeClusterBreak = UGraphemeClusterBreak(5);
pub const U_GCB_LV: UGraphemeClusterBreak = UGraphemeClusterBreak(6);
pub const U_GCB_LVT: UGraphemeClusterBreak = UGraphemeClusterBreak(7);
pub const U_GCB_OTHER: UGraphemeClusterBreak = UGraphemeClusterBreak(0);
pub const U_GCB_PREPEND: UGraphemeClusterBreak = UGraphemeClusterBreak(11);
pub const U_GCB_REGIONAL_INDICATOR: UGraphemeClusterBreak = UGraphemeClusterBreak(12);
pub const U_GCB_SPACING_MARK: UGraphemeClusterBreak = UGraphemeClusterBreak(10);
pub const U_GCB_T: UGraphemeClusterBreak = UGraphemeClusterBreak(8);
pub const U_GCB_V: UGraphemeClusterBreak = UGraphemeClusterBreak(9);
pub const U_GCB_ZWJ: UGraphemeClusterBreak = UGraphemeClusterBreak(17);
pub const U_GCC_MAJOR_MINOR: u32 = 0;
pub const U_GENERAL_OTHER_TYPES: UCharCategory = UCharCategory(0);
pub const U_HAVE_CHAR16_T: u32 = 1;
pub const U_HAVE_DEBUG_LOCATION_NEW: u32 = 1;
pub const U_HAVE_INTTYPES_H: u32 = 1;
pub const U_HAVE_LIB_SUFFIX: u32 = 1;
pub const U_HAVE_PLACEMENT_NEW: u32 = 0;
pub const U_HAVE_RBNF: u32 = 0;
pub const U_HAVE_RVALUE_REFERENCES: u32 = 1;
pub const U_HAVE_STDINT_H: u32 = 1;
pub const U_HAVE_STD_STRING: u32 = 0;
pub const U_HAVE_WCHAR_H: u32 = 0;
pub const U_HAVE_WCSCPY: u32 = 0;
...
pub const U_HST_LEADING_JAMO: UHangulSyllableType = UHangulSyllableType(1);
pub const U_HST_LVT_SYLLABLE: UHangulSyllableType = UHangulSyllableType(5);
pub const U_HST_LV_SYLLABLE: UHangulSyllableType = UHangulSyllableType(4);
pub const U_HST_NOT_APPLICABLE: UHangulSyllableType = UHangulSyllableType(0);
pub const U_HST_TRAILING_JAMO: UHangulSyllableType = UHangulSyllableType(3);
pub const U_HST_VOWEL_JAMO: UHangulSyllableType = UHangulSyllableType(2);
...
pub const U_INITIAL_PUNCTUATION: UCharCategory = UCharCategory(28);
pub const U_INPC_BOTTOM: UIndicPositionalCategory = UIndicPositionalCategory(1);
pub const U_INPC_BOTTOM_AND_LEFT: UIndicPositionalCategory = UIndicPositionalCategory(2);
pub const U_INPC_BOTTOM_AND_RIGHT: UIndicPositionalCategory = UIndicPositionalCategory(3);
pub const U_INPC_LEFT: UIndicPositionalCategory = UIndicPositionalCategory(4);
pub const U_INPC_LEFT_AND_RIGHT: UIndicPositionalCategory = UIndicPositionalCategory(5);
pub const U_INPC_NA: UIndicPositionalCategory = UIndicPositionalCategory(0);
pub const U_INPC_OVERSTRUCK: UIndicPositionalCategory = UIndicPositionalCategory(6);
pub const U_INPC_RIGHT: UIndicPositionalCategory = UIndicPositionalCategory(7);
pub const U_INPC_TOP: UIndicPositionalCategory = UIndicPositionalCategory(8);
pub const U_INPC_TOP_AND_BOTTOM: UIndicPositionalCategory = UIndicPositionalCategory(9);
pub const U_INPC_TOP_AND_BOTTOM_AND_LEFT: UIndicPositionalCategory = UIndicPositionalCategory(15);
pub const U_INPC_TOP_AND_BOTTOM_AND_RIGHT: UIndicPositionalCategory = UIndicPositionalCategory(10);
pub const U_INPC_TOP_AND_LEFT: UIndicPositionalCategory = UIndicPositionalCategory(11);
pub const U_INPC_TOP_AND_LEFT_AND_RIGHT: UIndicPositionalCategory = UIndicPositionalCategory(12);
pub const U_INPC_TOP_AND_RIGHT: UIndicPositionalCategory = UIndicPositionalCategory(13);
pub const U_INPC_VISUAL_ORDER_LEFT: UIndicPositionalCategory = UIndicPositionalCategory(14);
pub const U_INPUT_TOO_LONG_ERROR: UErrorCode = UErrorCode(31);
pub const U_INSC_AVAGRAHA: UIndicSyllabicCategory = UIndicSyllabicCategory(1);
pub const U_INSC_BINDU: UIndicSyllabicCategory = UIndicSyllabicCategory(2);
pub const U_INSC_BRAHMI_JOINING_NUMBER: UIndicSyllabicCategory = UIndicSyllabicCategory(3);
pub const U_INSC_CANTILLATION_MARK: UIndicSyllabicCategory = UIndicSyllabicCategory(4);
pub const U_INSC_CONSONANT: UIndicSyllabicCategory = UIndicSyllabicCategory(5);
pub const U_INSC_CONSONANT_DEAD: UIndicSyllabicCategory = UIndicSyllabicCategory(6);
pub const U_INSC_CONSONANT_FINAL: UIndicSyllabicCategory = UIndicSyllabicCategory(7);
pub const U_INSC_CONSONANT_HEAD_LETTER: UIndicSyllabicCategory = UIndicSyllabicCategory(8);
pub const U_INSC_CONSONANT_INITIAL_POSTFIXED: UIndicSyllabicCategory = UIndicSyllabicCategory(9);
pub const U_INSC_CONSONANT_KILLER: UIndicSyllabicCategory = UIndicSyllabicCategory(10);
pub const U_INSC_CONSONANT_MEDIAL: UIndicSyllabicCategory = UIndicSyllabicCategory(11);
pub const U_INSC_CONSONANT_PLACEHOLDER: UIndicSyllabicCategory = UIndicSyllabicCategory(12);
pub const U_INSC_CONSONANT_PRECEDING_REPHA: UIndicSyllabicCategory = UIndicSyllabicCategory(13);
pub const U_INSC_CONSONANT_PREFIXED: UIndicSyllabicCategory = UIndicSyllabicCategory(14);
pub const U_INSC_CONSONANT_SUBJOINED: UIndicSyllabicCategory = UIndicSyllabicCategory(15);
pub const U_INSC_CONSONANT_SUCCEEDING_REPHA: UIndicSyllabicCategory = UIndicSyllabicCategory(16);
pub const U_INSC_CONSONANT_WITH_STACKER: UIndicSyllabicCategory = UIndicSyllabicCategory(17);
pub const U_INSC_GEMINATION_MARK: UIndicSyllabicCategory = UIndicSyllabicCategory(18);
pub const U_INSC_INVISIBLE_STACKER: UIndicSyllabicCategory = UIndicSyllabicCategory(19);
pub const U_INSC_JOINER: UIndicSyllabicCategory = UIndicSyllabicCategory(20);
pub const U_INSC_MODIFYING_LETTER: UIndicSyllabicCategory = UIndicSyllabicCategory(21);
pub const U_INSC_NON_JOINER: UIndicSyllabicCategory = UIndicSyllabicCategory(22);
pub const U_INSC_NUKTA: UIndicSyllabicCategory = UIndicSyllabicCategory(23);
pub const U_INSC_NUMBER: UIndicSyllabicCategory = UIndicSyllabicCategory(24);
pub const U_INSC_NUMBER_JOINER: UIndicSyllabicCategory = UIndicSyllabicCategory(25);
pub const U_INSC_OTHER: UIndicSyllabicCategory = UIndicSyllabicCategory(0);
pub const U_INSC_PURE_KILLER: UIndicSyllabicCategory = UIndicSyllabicCategory(26);
pub const U_INSC_REGISTER_SHIFTER: UIndicSyllabicCategory = UIndicSyllabicCategory(27);
pub const U_INSC_SYLLABLE_MODIFIER: UIndicSyllabicCategory = UIndicSyllabicCategory(28);
pub const U_INSC_TONE_LETTER: UIndicSyllabicCategory = UIndicSyllabicCategory(29);
pub const U_INSC_TONE_MARK: UIndicSyllabicCategory = UIndicSyllabicCategory(30);
pub const U_INSC_VIRAMA: UIndicSyllabicCategory = UIndicSyllabicCategory(31);
pub const U_INSC_VISARGA: UIndicSyllabicCategory = UIndicSyllabicCategory(32);
pub const U_INSC_VOWEL: UIndicSyllabicCategory = UIndicSyllabicCategory(33);
pub const U_INSC_VOWEL_DEPENDENT: UIndicSyllabicCategory = UIndicSyllabicCategory(34);
pub const U_INSC_VOWEL_INDEPENDENT: UIndicSyllabicCategory = UIndicSyllabicCategory(35);
...
pub const U_IOSTREAM_SOURCE: u32 = 199711;
pub const U_IS_BIG_ENDIAN: u32 = 0;
pub const U_JG_AFRICAN_FEH: UJoiningGroup = UJoiningGroup(86);
pub const U_JG_AFRICAN_NOON: UJoiningGroup = UJoiningGroup(87);
pub const U_JG_AFRICAN_QAF: UJoiningGroup = UJoiningGroup(88);
pub const U_JG_AIN: UJoiningGroup = UJoiningGroup(1);
pub const U_JG_ALAPH: UJoiningGroup = UJoiningGroup(2);
pub const U_JG_ALEF: UJoiningGroup = UJoiningGroup(3);
pub const U_JG_BEH: UJoiningGroup = UJoiningGroup(4);
pub const U_JG_BETH: UJoiningGroup = UJoiningGroup(5);
pub const U_JG_BURUSHASKI_YEH_BARREE: UJoiningGroup = UJoiningGroup(54);
pub const U_JG_DAL: UJoiningGroup = UJoiningGroup(6);
pub const U_JG_DALATH_RISH: UJoiningGroup = UJoiningGroup(7);
pub const U_JG_E: UJoiningGroup = UJoiningGroup(8);
pub const U_JG_FARSI_YEH: UJoiningGroup = UJoiningGroup(55);
pub const U_JG_FE: UJoiningGroup = UJoiningGroup(51);
pub const U_JG_FEH: UJoiningGroup = UJoiningGroup(9);
pub const U_JG_FINAL_SEMKATH: UJoiningGroup = UJoiningGroup(10);
pub const U_JG_GAF: UJoiningGroup = UJoiningGroup(11);
pub const U_JG_GAMAL: UJoiningGroup = UJoiningGroup(12);
pub const U_JG_HAH: UJoiningGroup = UJoiningGroup(13);
pub const U_JG_HAMZA_ON_HEH_GOAL: UJoiningGroup = UJoiningGroup(14);
pub const U_JG_HANIFI_ROHINGYA_KINNA_YA: UJoiningGroup = UJoiningGroup(100);
pub const U_JG_HANIFI_ROHINGYA_PA: UJoiningGroup = UJoiningGroup(101);
pub const U_JG_HE: UJoiningGroup = UJoiningGroup(15);
pub const U_JG_HEH: UJoiningGroup = UJoiningGroup(16);
pub const U_JG_HEH_GOAL: UJoiningGroup = UJoiningGroup(17);
pub const U_JG_HETH: UJoiningGroup = UJoiningGroup(18);
pub const U_JG_KAF: UJoiningGroup = UJoiningGroup(19);
pub const U_JG_KAPH: UJoiningGroup = UJoiningGroup(20);
pub const U_JG_KHAPH: UJoiningGroup = UJoiningGroup(52);
pub const U_JG_KNOTTED_HEH: UJoiningGroup = UJoiningGroup(21);
pub const U_JG_LAM: UJoiningGroup = UJoiningGroup(22);
pub const U_JG_LAMADH: UJoiningGroup = UJoiningGroup(23);
pub const U_JG_MALAYALAM_BHA: UJoiningGroup = UJoiningGroup(89);
pub const U_JG_MALAYALAM_JA: UJoiningGroup = UJoiningGroup(90);
pub const U_JG_MALAYALAM_LLA: UJoiningGroup = UJoiningGroup(91);
pub const U_JG_MALAYALAM_LLLA: UJoiningGroup = UJoiningGroup(92);
pub const U_JG_MALAYALAM_NGA: UJoiningGroup = UJoiningGroup(93);
pub const U_JG_MALAYALAM_NNA: UJoiningGroup = UJoiningGroup(94);
pub const U_JG_MALAYALAM_NNNA: UJoiningGroup = UJoiningGroup(95);
pub const U_JG_MALAYALAM_NYA: UJoiningGroup = UJoiningGroup(96);
pub const U_JG_MALAYALAM_RA: UJoiningGroup = UJoiningGroup(97);
pub const U_JG_MALAYALAM_SSA: UJoiningGroup = UJoiningGroup(98);
pub const U_JG_MALAYALAM_TTA: UJoiningGroup = UJoiningGroup(99);
pub const U_JG_MANICHAEAN_ALEPH: UJoiningGroup = UJoiningGroup(58);
pub const U_JG_MANICHAEAN_AYIN: UJoiningGroup = UJoiningGroup(59);
pub const U_JG_MANICHAEAN_BETH: UJoiningGroup = UJoiningGroup(60);
pub const U_JG_MANICHAEAN_DALETH: UJoiningGroup = UJoiningGroup(61);
pub const U_JG_MANICHAEAN_DHAMEDH: UJoiningGroup = UJoiningGroup(62);
pub const U_JG_MANICHAEAN_FIVE: UJoiningGroup = UJoiningGroup(63);
pub const U_JG_MANICHAEAN_GIMEL: UJoiningGroup = UJoiningGroup(64);
pub const U_JG_MANICHAEAN_HETH: UJoiningGroup = UJoiningGroup(65);
pub const U_JG_MANICHAEAN_HUNDRED: UJoiningGroup = UJoiningGroup(66);
pub const U_JG_MANICHAEAN_KAPH: UJoiningGroup = UJoiningGroup(67);
pub const U_JG_MANICHAEAN_LAMEDH: UJoiningGroup = UJoiningGroup(68);
pub const U_JG_MANICHAEAN_MEM: UJoiningGroup = UJoiningGroup(69);
pub const U_JG_MANICHAEAN_NUN: UJoiningGroup = UJoiningGroup(70);
pub const U_JG_MANICHAEAN_ONE: UJoiningGroup = UJoiningGroup(71);
pub const U_JG_MANICHAEAN_PE: UJoiningGroup = UJoiningGroup(72);
pub const U_JG_MANICHAEAN_QOPH: UJoiningGroup = UJoiningGroup(73);
pub const U_JG_MANICHAEAN_RESH: UJoiningGroup = UJoiningGroup(74);
pub const U_JG_MANICHAEAN_SADHE: UJoiningGroup = UJoiningGroup(75);
pub const U_JG_MANICHAEAN_SAMEKH: UJoiningGroup = UJoiningGroup(76);
pub const U_JG_MANICHAEAN_TAW: UJoiningGroup = UJoiningGroup(77);
pub const U_JG_MANICHAEAN_TEN: UJoiningGroup = UJoiningGroup(78);
pub const U_JG_MANICHAEAN_TETH: UJoiningGroup = UJoiningGroup(79);
pub const U_JG_MANICHAEAN_THAMEDH: UJoiningGroup = UJoiningGroup(80);
pub const U_JG_MANICHAEAN_TWENTY: UJoiningGroup = UJoiningGroup(81);
pub const U_JG_MANICHAEAN_WAW: UJoiningGroup = UJoiningGroup(82);
pub const U_JG_MANICHAEAN_YODH: UJoiningGroup = UJoiningGroup(83);
pub const U_JG_MANICHAEAN_ZAYIN: UJoiningGroup = UJoiningGroup(84);
pub const U_JG_MEEM: UJoiningGroup = UJoiningGroup(24);
pub const U_JG_MIM: UJoiningGroup = UJoiningGroup(25);
pub const U_JG_NOON: UJoiningGroup = UJoiningGroup(26);
pub const U_JG_NO_JOINING_GROUP: UJoiningGroup = UJoiningGroup(0);
pub const U_JG_NUN: UJoiningGroup = UJoiningGroup(27);
pub const U_JG_NYA: UJoiningGroup = UJoiningGroup(56);
pub const U_JG_PE: UJoiningGroup = UJoiningGroup(28);
pub const U_JG_QAF: UJoiningGroup = UJoiningGroup(29);
pub const U_JG_QAPH: UJoiningGroup = UJoiningGroup(30);
pub const U_JG_REH: UJoiningGroup = UJoiningGroup(31);
pub const U_JG_REVERSED_PE: UJoiningGroup = UJoiningGroup(32);
pub const U_JG_ROHINGYA_YEH: UJoiningGroup = UJoiningGroup(57);
pub const U_JG_SAD: UJoiningGroup = UJoiningGroup(33);
pub const U_JG_SADHE: UJoiningGroup = UJoiningGroup(34);
pub const U_JG_SEEN: UJoiningGroup = UJoiningGroup(35);
pub const U_JG_SEMKATH: UJoiningGroup = UJoiningGroup(36);
pub const U_JG_SHIN: UJoiningGroup = UJoiningGroup(37);
pub const U_JG_STRAIGHT_WAW: UJoiningGroup = UJoiningGroup(85);
pub const U_JG_SWASH_KAF: UJoiningGroup = UJoiningGroup(38);
pub const U_JG_SYRIAC_WAW: UJoiningGroup = UJoiningGroup(39);
pub const U_JG_TAH: UJoiningGroup = UJoiningGroup(40);
pub const U_JG_TAW: UJoiningGroup = UJoiningGroup(41);
pub const U_JG_TEH_MARBUTA: UJoiningGroup = UJoiningGroup(42);
pub const U_JG_TEH_MARBUTA_GOAL: UJoiningGroup = UJoiningGroup(14);
pub const U_JG_TETH: UJoiningGroup = UJoiningGroup(43);
pub const U_JG_THIN_YEH: UJoiningGroup = UJoiningGroup(102);
pub const U_JG_VERTICAL_TAIL: UJoiningGroup = UJoiningGroup(103);
pub const U_JG_WAW: UJoiningGroup = UJoiningGroup(44);
pub const U_JG_YEH: UJoiningGroup = UJoiningGroup(45);
pub const U_JG_YEH_BARREE: UJoiningGroup = UJoiningGroup(46);
pub const U_JG_YEH_WITH_TAIL: UJoiningGroup = UJoiningGroup(47);
pub const U_JG_YUDH: UJoiningGroup = UJoiningGroup(48);
pub const U_JG_YUDH_HE: UJoiningGroup = UJoiningGroup(49);
pub const U_JG_ZAIN: UJoiningGroup = UJoiningGroup(50);
pub const U_JG_ZHAIN: UJoiningGroup = UJoiningGroup(53);
pub const U_JT_DUAL_JOINING: UJoiningType = UJoiningType(2);
pub const U_JT_JOIN_CAUSING: UJoiningType = UJoiningType(1);
pub const U_JT_LEFT_JOINING: UJoiningType = UJoiningType(3);
pub const U_JT_NON_JOINING: UJoiningType = UJoiningType(0);
pub const U_JT_RIGHT_JOINING: UJoiningType = UJoiningType(4);
pub const U_JT_TRANSPARENT: UJoiningType = UJoiningType(5);
pub const U_LB_ALPHABETIC: ULineBreak = ULineBreak(2);
pub const U_LB_AMBIGUOUS: ULineBreak = ULineBreak(1);
pub const U_LB_BREAK_AFTER: ULineBreak = ULineBreak(4);
pub const U_LB_BREAK_BEFORE: ULineBreak = ULineBreak(5);
pub const U_LB_BREAK_BOTH: ULineBreak = ULineBreak(3);
pub const U_LB_BREAK_SYMBOLS: ULineBreak = ULineBreak(27);
pub const U_LB_CARRIAGE_RETURN: ULineBreak = ULineBreak(10);
pub const U_LB_CLOSE_PARENTHESIS: ULineBreak = ULineBreak(36);
pub const U_LB_CLOSE_PUNCTUATION: ULineBreak = ULineBreak(8);
pub const U_LB_COMBINING_MARK: ULineBreak = ULineBreak(9);
pub const U_LB_COMPLEX_CONTEXT: ULineBreak = ULineBreak(24);
pub const U_LB_CONDITIONAL_JAPANESE_STARTER: ULineBreak = ULineBreak(37);
pub const U_LB_CONTINGENT_BREAK: ULineBreak = ULineBreak(7);
pub const U_LB_EXCLAMATION: ULineBreak = ULineBreak(11);
pub const U_LB_E_BASE: ULineBreak = ULineBreak(40);
pub const U_LB_E_MODIFIER: ULineBreak = ULineBreak(41);
pub const U_LB_GLUE: ULineBreak = ULineBreak(12);
pub const U_LB_H2: ULineBreak = ULineBreak(31);
pub const U_LB_H3: ULineBreak = ULineBreak(32);
pub const U_LB_HEBREW_LETTER: ULineBreak = ULineBreak(38);
pub const U_LB_HYPHEN: ULineBreak = ULineBreak(13);
pub const U_LB_IDEOGRAPHIC: ULineBreak = ULineBreak(14);
pub const U_LB_INFIX_NUMERIC: ULineBreak = ULineBreak(16);
pub const U_LB_INSEPARABLE: ULineBreak = ULineBreak(15);
pub const U_LB_INSEPERABLE: ULineBreak = ULineBreak(15);
pub const U_LB_JL: ULineBreak = ULineBreak(33);
pub const U_LB_JT: ULineBreak = ULineBreak(34);
pub const U_LB_JV: ULineBreak = ULineBreak(35);
pub const U_LB_LINE_FEED: ULineBreak = ULineBreak(17);
pub const U_LB_MANDATORY_BREAK: ULineBreak = ULineBreak(6);
pub const U_LB_NEXT_LINE: ULineBreak = ULineBreak(29);
pub const U_LB_NONSTARTER: ULineBreak = ULineBreak(18);
pub const U_LB_NUMERIC: ULineBreak = ULineBreak(19);
pub const U_LB_OPEN_PUNCTUATION: ULineBreak = ULineBreak(20);
pub const U_LB_POSTFIX_NUMERIC: ULineBreak = ULineBreak(21);
pub const U_LB_PREFIX_NUMERIC: ULineBreak = ULineBreak(22);
pub const U_LB_QUOTATION: ULineBreak = ULineBreak(23);
pub const U_LB_REGIONAL_INDICATOR: ULineBreak = ULineBreak(39);
pub const U_LB_SPACE: ULineBreak = ULineBreak(26);
pub const U_LB_SURROGATE: ULineBreak = ULineBreak(25);
pub const U_LB_UNKNOWN: ULineBreak = ULineBreak(0);
pub const U_LB_WORD_JOINER: ULineBreak = ULineBreak(30);
pub const U_LB_ZWJ: ULineBreak = ULineBreak(42);
pub const U_LB_ZWSPACE: ULineBreak = ULineBreak(28);
pub const U_LEFT_TO_RIGHT: UCharDirection = UCharDirection(0);
pub const U_LEFT_TO_RIGHT_EMBEDDING: UCharDirection = UCharDirection(11);
pub const U_LEFT_TO_RIGHT_ISOLATE: UCharDirection = UCharDirection(20);
pub const U_LEFT_TO_RIGHT_OVERRIDE: UCharDirection = UCharDirection(12);
pub const U_LETTER_NUMBER: UCharCategory = UCharCategory(10);
pub const U_LIB_SUFFIX_C_NAME_STRING: windows_core::PCSTR = windows_core::s!("");
pub const U_LINE_SEPARATOR: UCharCategory = UCharCategory(13);
pub const U_LONG_PROPERTY_NAME: UPropertyNameChoice = UPropertyNameChoice(1);
pub const U_LOWERCASE_LETTER: UCharCategory = UCharCategory(2);
...
pub const U_MATH_SYMBOL: UCharCategory = UCharCategory(24);
...
pub const U_MODIFIER_LETTER: UCharCategory = UCharCategory(4);
pub const U_MODIFIER_SYMBOL: UCharCategory = UCharCategory(26);
...
pub const U_NON_SPACING_MARK: UCharCategory = UCharCategory(6);
...
pub const U_NT_DECIMAL: UNumericType = UNumericType(1);
pub const U_NT_DIGIT: UNumericType = UNumericType(2);
pub const U_NT_NONE: UNumericType = UNumericType(0);
pub const U_NT_NUMERIC: UNumericType = UNumericType(3);
...
pub const U_OTHER_LETTER: UCharCategory = UCharCategory(5);
pub const U_OTHER_NEUTRAL: UCharDirection = UCharDirection(10);
pub const U_OTHER_NUMBER: UCharCategory = UCharCategory(11);
pub const U_OTHER_PUNCTUATION: UCharCategory = UCharCategory(23);
pub const U_OTHER_SYMBOL: UCharCategory = UCharCategory(27);
pub const U_OVERRIDE_CXX_ALLOCATION: u32 = 1;
pub const U_PARAGRAPH_SEPARATOR: UCharCategory = UCharCategory(14);
...
pub const U_PLATFORM_IS_DARWIN_BASED: u32 = 1;
...
pub const U_POP_DIRECTIONAL_FORMAT: UCharDirection = UCharDirection(16);
pub const U_POP_DIRECTIONAL_ISOLATE: UCharDirection = UCharDirection(22);
pub const U_PRIMARY_TOO_LONG_ERROR: UErrorCode = UErrorCode(22);
pub const U_PRIVATE_USE_CHAR: UCharCategory = UCharCategory(17);
...
pub const U_RIGHT_TO_LEFT: UCharDirection = UCharDirection(1);
pub const U_RIGHT_TO_LEFT_ARABIC: UCharDirection = UCharDirection(13);
pub const U_RIGHT_TO_LEFT_EMBEDDING: UCharDirection = UCharDirection(14);
pub const U_RIGHT_TO_LEFT_ISOLATE: UCharDirection = UCharDirection(21);
pub const U_RIGHT_TO_LEFT_OVERRIDE: UCharDirection = UCharDirection(15);
pub const U_RULE_MASK_ERROR: UErrorCode = UErrorCode(65557);
pub const U_SAFECLONE_ALLOCATED_WARNING: UErrorCode = UErrorCode(-126);
pub const U_SB_ATERM: USentenceBreak = USentenceBreak(1);
pub const U_SB_CLOSE: USentenceBreak = USentenceBreak(2);
pub const U_SB_CR: USentenceBreak = USentenceBreak(11);
pub const U_SB_EXTEND: USentenceBreak = USentenceBreak(12);
pub const U_SB_FORMAT: USentenceBreak = USentenceBreak(3);
pub const U_SB_LF: USentenceBreak = USentenceBreak(13);
pub const U_SB_LOWER: USentenceBreak = USentenceBreak(4);
pub const U_SB_NUMERIC: USentenceBreak = USentenceBreak(5);
pub const U_SB_OLETTER: USentenceBreak = USentenceBreak(6);
pub const U_SB_OTHER: USentenceBreak = USentenceBreak(0);
pub const U_SB_SCONTINUE: USentenceBreak = USentenceBreak(14);
pub const U_SB_SEP: USentenceBreak = USentenceBreak(7);
pub const U_SB_SP: USentenceBreak = USentenceBreak(8);
pub const U_SB_STERM: USentenceBreak = USentenceBreak(9);
pub const U_SB_UPPER: USentenceBreak = USentenceBreak(10);
pub const U_SEGMENT_SEPARATOR: UCharDirection = UCharDirection(8);
...
pub const U_SHORT_PROPERTY_NAME: UPropertyNameChoice = UPropertyNameChoice(0);
pub const U_SHOW_CPLUSPLUS_API: u32 = 0;
pub const U_SIZEOF_UCHAR: u32 = 2;
pub const U_SIZEOF_WCHAR_T: u32 = 1;
pub const U_SORT_KEY_TOO_SHORT_WARNING: UErrorCode = UErrorCode(-123);
pub const U_SPACE_SEPARATOR: UCharCategory = UCharCategory(12);
pub const U_START_PUNCTUATION: UCharCategory = UCharCategory(20);
...
pub const U_SURROGATE: UCharCategory = UCharCategory(18);
pub const U_TITLECASE_ADJUST_TO_CASED: u32 = 1024;
pub const U_TITLECASE_LETTER: UCharCategory = UCharCategory(3);
...
pub const U_UNASSIGNED: UCharCategory = UCharCategory(0);
...
pub const U_UNICODE_CHAR_NAME: UCharNameChoice = UCharNameChoice(0);
...
pub const U_UPPERCASE_LETTER: UCharCategory = UCharCategory(1);
...
pub const U_USING_ICU_NAMESPACE: u32 = 1;
...
pub const U_VO_ROTATED: UVerticalOrientation = UVerticalOrientation(0);
pub const U_VO_TRANSFORMED_ROTATED: UVerticalOrientation = UVerticalOrientation(1);
pub const U_VO_TRANSFORMED_UPRIGHT: UVerticalOrientation = UVerticalOrientation(2);
pub const U_VO_UPRIGHT: UVerticalOrientation = UVerticalOrientation(3);
pub const U_WB_ALETTER: UWordBreakValues = UWordBreakValues(1);
pub const U_WB_CR: UWordBreakValues = UWordBreakValues(8);
pub const U_WB_DOUBLE_QUOTE: UWordBreakValues = UWordBreakValues(16);
pub const U_WB_EXTEND: UWordBreakValues = UWordBreakValues(9);
pub const U_WB_EXTENDNUMLET: UWordBreakValues = UWordBreakValues(7);
pub const U_WB_E_BASE: UWordBreakValues = UWordBreakValues(17);
pub const U_WB_E_BASE_GAZ: UWordBreakValues = UWordBreakValues(18);
pub const U_WB_E_MODIFIER: UWordBreakValues = UWordBreakValues(19);
pub const U_WB_FORMAT: UWordBreakValues = UWordBreakValues(2);
pub const U_WB_GLUE_AFTER_ZWJ: UWordBreakValues = UWordBreakValues(20);
pub const U_WB_HEBREW_LETTER: UWordBreakValues = UWordBreakValues(14);
pub const U_WB_KATAKANA: UWordBreakValues = UWordBreakValues(3);
pub const U_WB_LF: UWordBreakValues = UWordBreakValues(10);
pub const U_WB_MIDLETTER: UWordBreakValues = UWordBreakValues(4);
pub const U_WB_MIDNUM: UWordBreakValues = UWordBreakValues(5);
pub const U_WB_MIDNUMLET: UWordBreakValues = UWordBreakValues(11);
pub const U_WB_NEWLINE: UWordBreakValues = UWordBreakValues(12);
pub const U_WB_NUMERIC: UWordBreakValues = UWordBreakValues(6);
pub const U_WB_OTHER: UWordBreakValues = UWordBreakValues(0);
pub const U_WB_REGIONAL_INDICATOR: UWordBreakValues = UWordBreakValues(13);
pub const U_WB_SINGLE_QUOTE: UWordBreakValues = UWordBreakValues(15);
pub const U_WB_WSEGSPACE: UWordBreakValues = UWordBreakValues(22);
pub const U_WB_ZWJ: UWordBreakValues = UWordBreakValues(21);
pub const U_WHITE_SPACE_NEUTRAL: UCharDirection = UCharDirection(9);
...
pub const WORDLIST_TYPE_ADD: WORDLIST_TYPE = WORDLIST_TYPE(1);
pub const WORDLIST_TYPE_AUTOCORRECT: WORDLIST_TYPE = WORDLIST_TYPE(3);
pub const WORDLIST_TYPE_EXCLUDE: WORDLIST_TYPE = WORDLIST_TYPE(2);
pub const WORDLIST_TYPE_IGNORE: WORDLIST_TYPE = WORDLIST_TYPE(0);
pub const WeekUnit: CALDATETIME_DATEUNIT = CALDATETIME_DATEUNIT(3);
pub const YearUnit: CALDATETIME_DATEUNIT = CALDATETIME_DATEUNIT(1);
pub const sidArabic: SCRIPTCONTF = SCRIPTCONTF(9);
pub const sidArmenian: SCRIPTCONTF = SCRIPTCONTF(7);
pub const sidAsciiLatin: SCRIPTCONTF = SCRIPTCONTF(3);
pub const sidAsciiSym: SCRIPTCONTF = SCRIPTCONTF(2);
pub const sidBengali: SCRIPTCONTF = SCRIPTCONTF(11);
pub const sidBopomofo: SCRIPTCONTF = SCRIPTCONTF(25);
pub const sidBraille: SCRIPTCONTF = SCRIPTCONTF(31);
pub const sidBurmese: SCRIPTCONTF = SCRIPTCONTF(36);
pub const sidCanSyllabic: SCRIPTCONTF = SCRIPTCONTF(28);
pub const sidCherokee: SCRIPTCONTF = SCRIPTCONTF(29);
pub const sidCyrillic: SCRIPTCONTF = SCRIPTCONTF(6);
pub const sidDefault: SCRIPTCONTF = SCRIPTCONTF(0);
pub const sidDevanagari: SCRIPTCONTF = SCRIPTCONTF(10);
pub const sidEthiopic: SCRIPTCONTF = SCRIPTCONTF(27);
pub const sidFEFirst: SCRIPTCONTF = SCRIPTCONTF(23);
pub const sidFELast: SCRIPTCONTF = SCRIPTCONTF(26);
pub const sidGeorgian: SCRIPTCONTF = SCRIPTCONTF(22);
pub const sidGreek: SCRIPTCONTF = SCRIPTCONTF(5);
pub const sidGujarati: SCRIPTCONTF = SCRIPTCONTF(13);
pub const sidGurmukhi: SCRIPTCONTF = SCRIPTCONTF(12);
pub const sidHan: SCRIPTCONTF = SCRIPTCONTF(26);
pub const sidHangul: SCRIPTCONTF = SCRIPTCONTF(23);
pub const sidHebrew: SCRIPTCONTF = SCRIPTCONTF(8);
pub const sidKana: SCRIPTCONTF = SCRIPTCONTF(24);
pub const sidKannada: SCRIPTCONTF = SCRIPTCONTF(17);
pub const sidKhmer: SCRIPTCONTF = SCRIPTCONTF(37);
pub const sidLao: SCRIPTCONTF = SCRIPTCONTF(20);
pub const sidLatin: SCRIPTCONTF = SCRIPTCONTF(4);
pub const sidLim: SCRIPTCONTF = SCRIPTCONTF(41);
pub const sidMalayalam: SCRIPTCONTF = SCRIPTCONTF(18);
pub const sidMerge: SCRIPTCONTF = SCRIPTCONTF(1);
pub const sidMongolian: SCRIPTCONTF = SCRIPTCONTF(39);
pub const sidOgham: SCRIPTCONTF = SCRIPTCONTF(33);
pub const sidOriya: SCRIPTCONTF = SCRIPTCONTF(14);
pub const sidRunic: SCRIPTCONTF = SCRIPTCONTF(32);
pub const sidSinhala: SCRIPTCONTF = SCRIPTCONTF(34);
pub const sidSyriac: SCRIPTCONTF = SCRIPTCONTF(35);
pub const sidTamil: SCRIPTCONTF = SCRIPTCONTF(15);
pub const sidTelugu: SCRIPTCONTF = SCRIPTCONTF(16);
pub const sidThaana: SCRIPTCONTF = SCRIPTCONTF(38);
pub const sidThai: SCRIPTCONTF = SCRIPTCONTF(19);
pub const sidTibetan: SCRIPTCONTF = SCRIPTCONTF(21);
pub const sidUserDefined: SCRIPTCONTF = SCRIPTCONTF(40);
pub const sidYi: SCRIPTCONTF = SCRIPTCONTF(30);
