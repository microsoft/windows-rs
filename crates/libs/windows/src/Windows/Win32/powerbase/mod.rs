#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn CallNtPowerInformation(informationlevel: super::POWER_INFORMATION_LEVEL, inputbuffer: Option<*const core::ffi::c_void>, inputbufferlength: u32, outputbuffer: Option<*mut core::ffi::c_void>, outputbufferlength: u32) -> i32 {
    windows_core::link!("powrprof.dll" "system" fn CallNtPowerInformation(informationlevel : super::POWER_INFORMATION_LEVEL, inputbuffer : *const core::ffi::c_void, inputbufferlength : u32, outputbuffer : *mut core::ffi::c_void, outputbufferlength : u32) -> i32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn PowerDeterminePlatformRoleEx(version: u32) -> super::POWER_PLATFORM_ROLE {
    windows_core::link!("powrprof.dll" "system" fn PowerDeterminePlatformRoleEx(version : u32) -> super::POWER_PLATFORM_ROLE);
...
#[cfg(feature = "winuser")]
#[inline]
pub unsafe fn PowerUnregisterSuspendResumeNotification(registrationhandle: super::HPOWERNOTIFY) -> u32 {
    windows_core::link!("powrprof.dll" "system" fn PowerUnregisterSuspendResumeNotification(registrationhandle : super::HPOWERNOTIFY) -> u32);
