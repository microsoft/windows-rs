#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn CommitComplete(enlistmenthandle: super::HANDLE, tmvirtualclock: *mut i64) -> windows_core::BOOL {
    windows_core::link!("ktmw32.dll" "system" fn CommitComplete(enlistmenthandle : super::HANDLE, tmvirtualclock : *mut i64) -> windows_core::BOOL);
    unsafe { CommitComplete(enlistmenthandle, tmvirtualclock as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn CommitEnlistment(enlistmenthandle: super::HANDLE, tmvirtualclock: *mut i64) -> windows_core::BOOL {
    windows_core::link!("ktmw32.dll" "system" fn CommitEnlistment(enlistmenthandle : super::HANDLE, tmvirtualclock : *mut i64) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn CreateEnlistment(lpenlistmentattributes: *mut super::SECURITY_ATTRIBUTES, resourcemanagerhandle: super::HANDLE, transactionhandle: super::HANDLE, notificationmask: super::NOTIFICATION_MASK, createoptions: u32, enlistmentkey: *mut core::ffi::c_void) -> super::HANDLE {
    windows_core::link!("ktmw32.dll" "system" fn CreateEnlistment(lpenlistmentattributes : *mut super::SECURITY_ATTRIBUTES, resourcemanagerhandle : super::HANDLE, transactionhandle : super::HANDLE, notificationmask : super::NOTIFICATION_MASK, createoptions : u32, enlistmentkey : *mut core::ffi::c_void) -> super::HANDLE);
...
#[inline]
pub unsafe fn CreateResourceManager<P4>(lpresourcemanagerattributes: *mut super::SECURITY_ATTRIBUTES, resourcemanagerid: *mut windows_core::GUID, createoptions: u32, tmhandle: super::HANDLE, description: P4) -> super::HANDLE
where
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("ktmw32.dll" "system" fn CreateResourceManager(lpresourcemanagerattributes : *mut super::SECURITY_ATTRIBUTES, resourcemanagerid : *mut windows_core::GUID, createoptions : u32, tmhandle : super::HANDLE, description : windows_core::PCWSTR) -> super::HANDLE);
...
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
#[inline]
pub unsafe fn CreateTransaction<P6>(lptransactionattributes: *mut super::SECURITY_ATTRIBUTES, uow: *mut windows_core::GUID, createoptions: u32, isolationlevel: u32, isolationflags: u32, timeout: u32, description: P6) -> super::HANDLE
where
    P6: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("ktmw32.dll" "system" fn CreateTransaction(lptransactionattributes : *mut super::SECURITY_ATTRIBUTES, uow : *mut windows_core::GUID, createoptions : u32, isolationlevel : u32, isolationflags : u32, timeout : u32, description : windows_core::PCWSTR) -> super::HANDLE);
...
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
#[inline]
pub unsafe fn CreateTransactionManager<P1>(lptransactionattributes: *mut super::SECURITY_ATTRIBUTES, logfilename: P1, createoptions: u32, commitstrength: u32) -> super::HANDLE
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("ktmw32.dll" "system" fn CreateTransactionManager(lptransactionattributes : *mut super::SECURITY_ATTRIBUTES, logfilename : windows_core::PCWSTR, createoptions : u32, commitstrength : u32) -> super::HANDLE);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetEnlistmentRecoveryInformation(enlistmenthandle: super::HANDLE, buffersize: u32, buffer: *mut core::ffi::c_void, bufferused: *mut u32) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn GetNotificationResourceManager(resourcemanagerhandle: super::HANDLE, transactionnotification: *mut super::TRANSACTION_NOTIFICATION, notificationlength: u32, dwmilliseconds: u32, returnlength: *mut u32) -> windows_core::BOOL {
...
#[cfg(all(feature = "ktmtypes", feature = "minwinbase", feature = "winnt"))]
#[inline]
pub unsafe fn GetNotificationResourceManagerAsync(resourcemanagerhandle: super::HANDLE, transactionnotification: *mut super::TRANSACTION_NOTIFICATION, transactionnotificationlength: u32, returnlength: *mut u32, lpoverlapped: *mut super::OVERLAPPED) -> windows_core::BOOL {
    windows_core::link!("ktmw32.dll" "system" fn GetNotificationResourceManagerAsync(resourcemanagerhandle : super::HANDLE, transactionnotification : *mut super::TRANSACTION_NOTIFICATION, transactionnotificationlength : u32, returnlength : *mut u32, lpoverlapped : *mut super::OVERLAPPED) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetTransactionInformation(transactionhandle: super::HANDLE, outcome: *mut u32, isolationlevel: *mut u32, isolationflags: *mut u32, timeout: *mut u32, description: Option<&mut [u16]>) -> windows_core::BOOL {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn OpenEnlistment(dwdesiredaccess: u32, resourcemanagerhandle: super::HANDLE, enlistmentid: *mut windows_core::GUID) -> super::HANDLE {
    windows_core::link!("ktmw32.dll" "system" fn OpenEnlistment(dwdesiredaccess : u32, resourcemanagerhandle : super::HANDLE, enlistmentid : *mut windows_core::GUID) -> super::HANDLE);
    unsafe { OpenEnlistment(dwdesiredaccess, resourcemanagerhandle, enlistmentid as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn OpenResourceManager(dwdesiredaccess: u32, tmhandle: super::HANDLE, resourcemanagerid: *mut windows_core::GUID) -> super::HANDLE {
    windows_core::link!("ktmw32.dll" "system" fn OpenResourceManager(dwdesiredaccess : u32, tmhandle : super::HANDLE, resourcemanagerid : *mut windows_core::GUID) -> super::HANDLE);
    unsafe { OpenResourceManager(dwdesiredaccess, tmhandle, resourcemanagerid as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn OpenTransaction(dwdesiredaccess: u32, transactionid: *mut windows_core::GUID) -> super::HANDLE {
    windows_core::link!("ktmw32.dll" "system" fn OpenTransaction(dwdesiredaccess : u32, transactionid : *mut windows_core::GUID) -> super::HANDLE);
    unsafe { OpenTransaction(dwdesiredaccess, transactionid as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn OpenTransactionManager<P0>(logfilename: P0, desiredaccess: super::ACCESS_MASK, openoptions: u32) -> super::HANDLE
where
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn OpenTransactionManagerById(transactionmanagerid: *const windows_core::GUID, desiredaccess: super::ACCESS_MASK, openoptions: u32) -> super::HANDLE {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn PrePrepareComplete(enlistmenthandle: super::HANDLE, tmvirtualclock: *mut i64) -> windows_core::BOOL {
    windows_core::link!("ktmw32.dll" "system" fn PrePrepareComplete(enlistmenthandle : super::HANDLE, tmvirtualclock : *mut i64) -> windows_core::BOOL);
    unsafe { PrePrepareComplete(enlistmenthandle, tmvirtualclock as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn PrePrepareEnlistment(enlistmenthandle: super::HANDLE, tmvirtualclock: *mut i64) -> windows_core::BOOL {
    windows_core::link!("ktmw32.dll" "system" fn PrePrepareEnlistment(enlistmenthandle : super::HANDLE, tmvirtualclock : *mut i64) -> windows_core::BOOL);
    unsafe { PrePrepareEnlistment(enlistmenthandle, tmvirtualclock as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn PrepareComplete(enlistmenthandle: super::HANDLE, tmvirtualclock: *mut i64) -> windows_core::BOOL {
    windows_core::link!("ktmw32.dll" "system" fn PrepareComplete(enlistmenthandle : super::HANDLE, tmvirtualclock : *mut i64) -> windows_core::BOOL);
    unsafe { PrepareComplete(enlistmenthandle, tmvirtualclock as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn PrepareEnlistment(enlistmenthandle: super::HANDLE, tmvirtualclock: *mut i64) -> windows_core::BOOL {
    windows_core::link!("ktmw32.dll" "system" fn PrepareEnlistment(enlistmenthandle : super::HANDLE, tmvirtualclock : *mut i64) -> windows_core::BOOL);
    unsafe { PrepareEnlistment(enlistmenthandle, tmvirtualclock as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ReadOnlyEnlistment(enlistmenthandle: super::HANDLE, tmvirtualclock: *mut i64) -> windows_core::BOOL {
    windows_core::link!("ktmw32.dll" "system" fn ReadOnlyEnlistment(enlistmenthandle : super::HANDLE, tmvirtualclock : *mut i64) -> windows_core::BOOL);
    unsafe { ReadOnlyEnlistment(enlistmenthandle, tmvirtualclock as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RecoverEnlistment(enlistmenthandle: super::HANDLE, enlistmentkey: *mut core::ffi::c_void) -> windows_core::BOOL {
    windows_core::link!("ktmw32.dll" "system" fn RecoverEnlistment(enlistmenthandle : super::HANDLE, enlistmentkey : *mut core::ffi::c_void) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RollbackComplete(enlistmenthandle: super::HANDLE, tmvirtualclock: *mut i64) -> windows_core::BOOL {
    windows_core::link!("ktmw32.dll" "system" fn RollbackComplete(enlistmenthandle : super::HANDLE, tmvirtualclock : *mut i64) -> windows_core::BOOL);
    unsafe { RollbackComplete(enlistmenthandle, tmvirtualclock as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RollbackEnlistment(enlistmenthandle: super::HANDLE, tmvirtualclock: *mut i64) -> windows_core::BOOL {
    windows_core::link!("ktmw32.dll" "system" fn RollbackEnlistment(enlistmenthandle : super::HANDLE, tmvirtualclock : *mut i64) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RollforwardTransactionManager(transactionmanagerhandle: super::HANDLE, tmvirtualclock: *mut i64) -> windows_core::BOOL {
    windows_core::link!("ktmw32.dll" "system" fn RollforwardTransactionManager(transactionmanagerhandle : super::HANDLE, tmvirtualclock : *mut i64) -> windows_core::BOOL);
    unsafe { RollforwardTransactionManager(transactionmanagerhandle, tmvirtualclock as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetEnlistmentRecoveryInformation(enlistmenthandle: super::HANDLE, buffersize: u32, buffer: *mut core::ffi::c_void) -> windows_core::BOOL {
    windows_core::link!("ktmw32.dll" "system" fn SetEnlistmentRecoveryInformation(enlistmenthandle : super::HANDLE, buffersize : u32, buffer : *mut core::ffi::c_void) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetTransactionInformation<P4>(transactionhandle: super::HANDLE, isolationlevel: u32, isolationflags: u32, timeout: u32, description: P4) -> windows_core::BOOL
where
    P4: windows_core::Param<windows_core::PCWSTR>,
{
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SinglePhaseReject(enlistmenthandle: super::HANDLE, tmvirtualclock: *mut i64) -> windows_core::BOOL {
    windows_core::link!("ktmw32.dll" "system" fn SinglePhaseReject(enlistmenthandle : super::HANDLE, tmvirtualclock : *mut i64) -> windows_core::BOOL);
