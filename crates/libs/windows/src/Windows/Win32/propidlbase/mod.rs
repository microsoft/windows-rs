...
impl IEnumSTATPROPSETSTG {
    #[cfg(feature = "minwindef")]
    pub unsafe fn Next(&self, celt: u32, rgelt: *mut STATPROPSETSTG, pceltfetched: Option<*mut u32>) -> windows_core::HRESULT {
...
impl IPropertyStorage_Vtbl {
    pub const fn new<Identity: IPropertyStorage_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn WriteMultiple<Identity: IPropertyStorage_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, cpspec: u32, rgpspec: *const PROPSPEC, rgpropvar: *const PROPVARIANT, propidnamefirst: super::PROPID) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn DeletePropertyNames<Identity: IPropertyStorage_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, cpropid: u32, rgpropid: *const super::PROPID) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetTimes<Identity: IPropertyStorage_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pctime: *const super::FILETIME, patime: *const super::FILETIME, pmtime: *const super::FILETIME) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub type LPENUMSTATPROPSETSTG = IEnumSTATPROPSETSTG;
pub type LPENUMSTATPROPSTG = IEnumSTATPROPSTG;
pub type LPPROPERTYSETSTORAGE = IPropertySetStorage;
pub type LPPROPERTYSTORAGE = IPropertyStorage;
#[cfg(all(feature = "minwindef", feature = "oaidl", feature = "objidl", feature = "objidlbase", feature = "winnt", feature = "wtypes", feature = "wtypesbase"))]
...
pub union PROPVARIANT_0_0_0 {
    ...
    pub pStorage: core::mem::ManuallyDrop<Option<super::IStorage>>,
