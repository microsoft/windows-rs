...
impl IOpcCertificateEnumerator {
    ...
    pub unsafe fn GetCurrent(&self) -> windows_core::Result<*mut super::CERT_CONTEXT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub struct IOpcCertificateEnumerator_Vtbl {
    ...
    #[cfg(all(feature = "minwindef", feature = "wincrypt"))]
    pub GetCurrent: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut super::CERT_CONTEXT) -> windows_core::HRESULT,
...
pub trait IOpcCertificateEnumerator_Impl: windows_core::IUnknownImpl {
    ...
    fn GetCurrent(&self) -> windows_core::Result<*mut super::CERT_CONTEXT>;
...
impl IOpcCertificateEnumerator_Vtbl {
    pub const fn new<Identity: IOpcCertificateEnumerator_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetCurrent<Identity: IOpcCertificateEnumerator_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, certificate: *mut *mut super::CERT_CONTEXT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IOpcFactory {
    ...
    pub unsafe fn CreateStreamOnFile<P0>(&self, filename: P0, iomode: OPC_STREAM_IO_MODE, securityattributes: *const super::SECURITY_ATTRIBUTES, dwflagsandattributes: u32) -> windows_core::Result<super::IStream>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
...
pub struct IOpcFactory_Vtbl {
    ...
    CreatePartUri: usize,
    #[cfg(all(feature = "minwinbase", feature = "objidlbase"))]
    pub CreateStreamOnFile: unsafe extern "system" fn(*mut core::ffi::c_void, windows_core::PCWSTR, OPC_STREAM_IO_MODE, *const super::SECURITY_ATTRIBUTES, u32, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
...
pub trait IOpcFactory_Impl: windows_core::IUnknownImpl {
    ...
    fn CreateStreamOnFile(&self, filename: &windows_core::PCWSTR, iomode: OPC_STREAM_IO_MODE, securityattributes: *const super::SECURITY_ATTRIBUTES, dwflagsandattributes: u32) -> windows_core::Result<super::IStream>;
...
impl IOpcFactory_Vtbl {
    pub const fn new<Identity: IOpcFactory_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn CreateStreamOnFile<Identity: IOpcFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, filename: windows_core::PCWSTR, iomode: OPC_STREAM_IO_MODE, securityattributes: *const super::SECURITY_ATTRIBUTES, dwflagsandattributes: u32, stream: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
