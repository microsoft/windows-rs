...
impl IOpcCertificateEnumerator_Vtbl {
    pub const fn new<Identity: IOpcCertificateEnumerator_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetCurrent<Identity: IOpcCertificateEnumerator_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, certificate: *mut *mut super::wincrypt::CERT_CONTEXT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IOpcCertificateSet_Vtbl {
    pub const fn new<Identity: IOpcCertificateSet_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Remove<Identity: IOpcCertificateSet_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, certificate: *const super::wincrypt::CERT_CONTEXT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait IOpcDigitalSignatureManager_Impl: windows_core::IUnknownImpl {
    ...
    fn Validate(&self, signature: windows_core::Ref<IOpcDigitalSignature>, certificate: *const super::wincrypt::CERT_CONTEXT) -> windows_core::Result<OPC_SIGNATURE_VALIDATION_RESULT>;
...
impl IOpcDigitalSignatureManager_Vtbl {
    pub const fn new<Identity: IOpcDigitalSignatureManager_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Validate<Identity: IOpcDigitalSignatureManager_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, signature: *mut core::ffi::c_void, certificate: *const super::wincrypt::CERT_CONTEXT, validationresult: *mut OPC_SIGNATURE_VALIDATION_RESULT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Sign<Identity: IOpcDigitalSignatureManager_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, certificate: *const super::wincrypt::CERT_CONTEXT, signingoptions: *mut core::ffi::c_void, digitalsignature: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait IOpcFactory_Impl: windows_core::IUnknownImpl {
    ...
    fn CreateStreamOnFile(&self, filename: &windows_core::PCWSTR, iomode: OPC_STREAM_IO_MODE, securityattributes: *const super::minwinbase::SECURITY_ATTRIBUTES, dwflagsandattributes: u32) -> windows_core::Result<super::objidlbase::IStream>;
    fn CreatePackage(&self) -> windows_core::Result<IOpcPackage>;
    fn ReadPackageFromStream(&self, stream: windows_core::Ref<super::objidlbase::IStream>, flags: OPC_READ_FLAGS) -> windows_core::Result<IOpcPackage>;
...
impl IOpcFactory_Vtbl {
    pub const fn new<Identity: IOpcFactory_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn CreateStreamOnFile<Identity: IOpcFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, filename: windows_core::PCWSTR, iomode: OPC_STREAM_IO_MODE, securityattributes: *const super::minwinbase::SECURITY_ATTRIBUTES, dwflagsandattributes: u32, stream: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IOpcRelationshipSet {
    ...
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<super::urlmon::IUri>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl IOpcUri {
    ...
    pub unsafe fn GetRelativeUri<P0>(&self, targetparturi: P0) -> windows_core::Result<super::urlmon::IUri>
    where
        P0: windows_core::Param<IOpcPartUri>,
    {
        unsafe {
...
pub struct IOpcUri_Vtbl {
    pub base__: super::urlmon::IUri_Vtbl,
...
impl IOpcUri_Vtbl {
    pub const fn new<Identity: IOpcUri_Impl, const OFFSET: isize>() -> Self {
        ...
        Self {
            base__: super::urlmon::IUri_Vtbl::new::<Identity, OFFSET>(),
