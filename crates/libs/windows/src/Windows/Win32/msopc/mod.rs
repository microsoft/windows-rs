...
impl IOpcDigitalSignatureManager {
        ...
        P0: windows_core::Param<IOpcPartUri>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ReplaceSignatureXml)(windows_core::Interface::as_raw(self), signaturepartname.param().abi(), newsignaturexml, count, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
}
#[repr(C)]
...
impl IOpcSignatureCustomObjectSet {
    pub unsafe fn Create(&self, xmlmarkup: *const u8, count: u32) -> windows_core::Result<IOpcSignatureCustomObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Create)(windows_core::Interface::as_raw(self), xmlmarkup, count, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
