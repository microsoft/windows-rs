...
pub trait IXpsOMCoreProperties_Impl: IXpsOMPart_Impl {
    ...
    fn GetCreated(&self) -> windows_core::Result<super::minwinbase::SYSTEMTIME>;
    fn SetCreated(&self, created: *const super::minwinbase::SYSTEMTIME) -> windows_core::Result<()>;
    ...
    fn GetLastPrinted(&self) -> windows_core::Result<super::minwinbase::SYSTEMTIME>;
    fn SetLastPrinted(&self, lastprinted: *const super::minwinbase::SYSTEMTIME) -> windows_core::Result<()>;
    fn GetModified(&self) -> windows_core::Result<super::minwinbase::SYSTEMTIME>;
    fn SetModified(&self, modified: *const super::minwinbase::SYSTEMTIME) -> windows_core::Result<()>;
...
impl IXpsOMCoreProperties_Vtbl {
    pub const fn new<Identity: IXpsOMCoreProperties_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetCreated<Identity: IXpsOMCoreProperties_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, created: *mut super::minwinbase::SYSTEMTIME) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetCreated<Identity: IXpsOMCoreProperties_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, created: *const super::minwinbase::SYSTEMTIME) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetLastPrinted<Identity: IXpsOMCoreProperties_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, lastprinted: *mut super::minwinbase::SYSTEMTIME) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetLastPrinted<Identity: IXpsOMCoreProperties_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, lastprinted: *const super::minwinbase::SYSTEMTIME) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IXpsOMCoreProperties_Impl::SetLastPrinted(this, core::mem::transmute_copy(&lastprinted)).into()
            }
        }
        unsafe extern "system" fn GetModified<Identity: IXpsOMCoreProperties_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, modified: *mut super::minwinbase::SYSTEMTIME) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetModified<Identity: IXpsOMCoreProperties_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, modified: *const super::minwinbase::SYSTEMTIME) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IXpsOMFontResource {
    ...
    where
        P0: windows_core::Param<super::objidlbase::IStream>,
        P2: windows_core::Param<super::msopc::IOpcPartUri>,
    {
...
impl IXpsOMObjectFactory {
    ...
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P5: windows_core::Param<super::msopc::IOpcPartUri>,
        ...
        P9: windows_core::Param<super::msopc::IOpcPartUri>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    where
        ...
        P3: windows_core::Param<super::msopc::IOpcPartUri>,
        ...
        P7: windows_core::Param<super::msopc::IOpcPartUri>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IXpsOMObjectFactory_Impl: windows_core::IUnknownImpl {
    ...
    fn CreatePackageFromStream(&self, stream: windows_core::Ref<super::objidlbase::IStream>, reuseobjects: windows_core::BOOL) -> windows_core::Result<IXpsOMPackage>;
    fn CreateStoryFragmentsResource(&self, acquiredstream: windows_core::Ref<super::objidlbase::IStream>, parturi: windows_core::Ref<super::msopc::IOpcPartUri>) -> windows_core::Result<IXpsOMStoryFragmentsResource>;
    fn CreateDocumentStructureResource(&self, acquiredstream: windows_core::Ref<super::objidlbase::IStream>, parturi: windows_core::Ref<super::msopc::IOpcPartUri>) -> windows_core::Result<IXpsOMDocumentStructureResource>;
    fn CreateSignatureBlockResource(&self, acquiredstream: windows_core::Ref<super::objidlbase::IStream>, parturi: windows_core::Ref<super::msopc::IOpcPartUri>) -> windows_core::Result<IXpsOMSignatureBlockResource>;
    fn CreateRemoteDictionaryResource(&self, dictionary: windows_core::Ref<IXpsOMDictionary>, parturi: windows_core::Ref<super::msopc::IOpcPartUri>) -> windows_core::Result<IXpsOMRemoteDictionaryResource>;
    fn CreateRemoteDictionaryResourceFromStream(&self, dictionarymarkupstream: windows_core::Ref<super::objidlbase::IStream>, dictionaryparturi: windows_core::Ref<super::msopc::IOpcPartUri>, resources: windows_core::Ref<IXpsOMPartResources>) -> windows_core::Result<IXpsOMRemoteDictionaryResource>;
    fn CreatePartResources(&self) -> windows_core::Result<IXpsOMPartResources>;
    fn CreateDocumentSequence(&self, parturi: windows_core::Ref<super::msopc::IOpcPartUri>) -> windows_core::Result<IXpsOMDocumentSequence>;
    fn CreateDocument(&self, parturi: windows_core::Ref<super::msopc::IOpcPartUri>) -> windows_core::Result<IXpsOMDocument>;
    fn CreatePageReference(&self, advisorypagedimensions: *const XPS_SIZE) -> windows_core::Result<IXpsOMPageReference>;
    fn CreatePage(&self, pagedimensions: *const XPS_SIZE, language: &windows_core::PCWSTR, parturi: windows_core::Ref<super::msopc::IOpcPartUri>) -> windows_core::Result<IXpsOMPage>;
    fn CreatePageFromStream(&self, pagemarkupstream: windows_core::Ref<super::objidlbase::IStream>, parturi: windows_core::Ref<super::msopc::IOpcPartUri>, resources: windows_core::Ref<IXpsOMPartResources>, reuseobjects: windows_core::BOOL) -> windows_core::Result<IXpsOMPage>;
    ...
    fn CreateColorProfileResource(&self, acquiredstream: windows_core::Ref<super::objidlbase::IStream>, parturi: windows_core::Ref<super::msopc::IOpcPartUri>) -> windows_core::Result<IXpsOMColorProfileResource>;
    ...
    fn CreateImageResource(&self, acquiredstream: windows_core::Ref<super::objidlbase::IStream>, contenttype: XPS_IMAGE_TYPE, parturi: windows_core::Ref<super::msopc::IOpcPartUri>) -> windows_core::Result<IXpsOMImageResource>;
    fn CreatePrintTicketResource(&self, acquiredstream: windows_core::Ref<super::objidlbase::IStream>, parturi: windows_core::Ref<super::msopc::IOpcPartUri>) -> windows_core::Result<IXpsOMPrintTicketResource>;
    fn CreateFontResource(&self, acquiredstream: windows_core::Ref<super::objidlbase::IStream>, fontembedding: XPS_FONT_EMBEDDING, parturi: windows_core::Ref<super::msopc::IOpcPartUri>, isobfsourcestream: windows_core::BOOL) -> windows_core::Result<IXpsOMFontResource>;
    ...
    fn CreateCoreProperties(&self, parturi: windows_core::Ref<super::msopc::IOpcPartUri>) -> windows_core::Result<IXpsOMCoreProperties>;
    ...
    fn CreatePackageWriterOnFile(&self, filename: &windows_core::PCWSTR, securityattributes: *const super::minwinbase::SECURITY_ATTRIBUTES, flagsandattributes: u32, optimizemarkupsize: windows_core::BOOL, interleaving: XPS_INTERLEAVING, documentsequencepartname: windows_core::Ref<super::msopc::IOpcPartUri>, coreproperties: windows_core::Ref<IXpsOMCoreProperties>, packagethumbnail: windows_core::Ref<IXpsOMImageResource>, documentsequenceprintticket: windows_core::Ref<IXpsOMPrintTicketResource>, discardcontrolpartname: windows_core::Ref<super::msopc::IOpcPartUri>) -> windows_core::Result<IXpsOMPackageWriter>;
    fn CreatePackageWriterOnStream(&self, outputstream: windows_core::Ref<super::objidlbase::ISequentialStream>, optimizemarkupsize: windows_core::BOOL, interleaving: XPS_INTERLEAVING, documentsequencepartname: windows_core::Ref<super::msopc::IOpcPartUri>, coreproperties: windows_core::Ref<IXpsOMCoreProperties>, packagethumbnail: windows_core::Ref<IXpsOMImageResource>, documentsequenceprintticket: windows_core::Ref<IXpsOMPrintTicketResource>, discardcontrolpartname: windows_core::Ref<super::msopc::IOpcPartUri>) -> windows_core::Result<IXpsOMPackageWriter>;
...
pub trait IXpsOMPackage_Impl: windows_core::IUnknownImpl {
    ...
    fn GetDiscardControlPartName(&self) -> windows_core::Result<super::msopc::IOpcPartUri>;
    fn SetDiscardControlPartName(&self, discardcontrolparturi: windows_core::Ref<super::msopc::IOpcPartUri>) -> windows_core::Result<()>;
...
impl IXpsOMPackage_Vtbl {
    pub const fn new<Identity: IXpsOMPackage_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn WriteToFile<Identity: IXpsOMPackage_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, filename: windows_core::PCWSTR, securityattributes: *const super::minwinbase::SECURITY_ATTRIBUTES, flagsandattributes: u32, optimizemarkupsize: windows_core::BOOL) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait IXpsOMPage_Impl: IXpsOMPart_Impl {
    ...
    fn GetDictionaryResource(&self) -> windows_core::Result<IXpsOMRemoteDictionaryResource>;
    fn SetDictionaryResource(&self, remotedictionaryresource: windows_core::Ref<IXpsOMRemoteDictionaryResource>) -> windows_core::Result<()>;
    fn Write(&self, stream: windows_core::Ref<super::objidlbase::ISequentialStream>, optimizemarkupsize: windows_core::BOOL) -> windows_core::Result<()>;
...
pub trait IXpsOMPartUriCollection_Impl: windows_core::IUnknownImpl {
    ...
    fn InsertAt(&self, index: u32, parturi: windows_core::Ref<super::msopc::IOpcPartUri>) -> windows_core::Result<()>;
    fn RemoveAt(&self, index: u32) -> windows_core::Result<()>;
...
pub trait IXpsOMVisual_Impl: IXpsOMShareable_Impl {
    ...
    fn GetHyperlinkNavigateUri(&self) -> windows_core::Result<super::urlmon::IUri>;
    fn SetHyperlinkNavigateUri(&self, hyperlinkuri: windows_core::Ref<super::urlmon::IUri>) -> windows_core::Result<()>;
    fn GetLanguage(&self) -> windows_core::Result<windows_core::PWSTR>;
    fn SetLanguage(&self, language: &windows_core::PCWSTR) -> windows_core::Result<()>;
}
#[cfg(feature = "Win32_urlmon")]
