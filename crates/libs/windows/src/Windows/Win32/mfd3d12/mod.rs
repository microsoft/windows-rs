...
impl IMFD3D12SynchronizationObject {
    ...
    pub unsafe fn SignalEventOnFinalResourceRelease(&self, hevent: super::winnt::HANDLE) -> windows_core::HRESULT {
...
pub struct IMFD3D12SynchronizationObject_Vtbl {
    ...
    #[cfg(feature = "Win32_winnt")]
    pub SignalEventOnFinalResourceRelease: unsafe extern "system" fn(*mut core::ffi::c_void, super::winnt::HANDLE) -> windows_core::HRESULT,
...
pub trait IMFD3D12SynchronizationObject_Impl: windows_core::IUnknownImpl {
    fn SignalEventOnFinalResourceRelease(&self, hevent: super::winnt::HANDLE) -> windows_core::Result<()>;
...
impl IMFD3D12SynchronizationObject_Vtbl {
    pub const fn new<Identity: IMFD3D12SynchronizationObject_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SignalEventOnFinalResourceRelease<Identity: IMFD3D12SynchronizationObject_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hevent: super::winnt::HANDLE) -> windows_core::HRESULT {
            unsafe {
...
impl IMFD3D12SynchronizationObjectCommands {
    ...
    where
        P0: windows_core::Param<super::d3d12::ID3D12CommandQueue>,
    {
    ...
    #[cfg(feature = "Win32_winnt")]
    pub unsafe fn SignalEventOnResourceReady(&self, hevent: super::winnt::HANDLE) -> windows_core::HRESULT {
...
pub struct IMFD3D12SynchronizationObjectCommands_Vtbl {
    ...
    #[cfg(feature = "Win32_winnt")]
    pub SignalEventOnResourceReady: unsafe extern "system" fn(*mut core::ffi::c_void, super::winnt::HANDLE) -> windows_core::HRESULT,
    #[cfg(not(feature = "Win32_winnt"))]
...
#[cfg(all(feature = "Win32_d3d12", feature = "Win32_winnt"))]
pub trait IMFD3D12SynchronizationObjectCommands_Impl: windows_core::IUnknownImpl {
    fn EnqueueResourceReady(&self, pproducercommandqueue: windows_core::Ref<super::d3d12::ID3D12CommandQueue>) -> windows_core::Result<()>;
    fn EnqueueResourceReadyWait(&self, pconsumercommandqueue: windows_core::Ref<super::d3d12::ID3D12CommandQueue>) -> windows_core::Result<()>;
    fn SignalEventOnResourceReady(&self, hevent: super::winnt::HANDLE) -> windows_core::Result<()>;
    fn EnqueueResourceRelease(&self, pconsumercommandqueue: windows_core::Ref<super::d3d12::ID3D12CommandQueue>) -> windows_core::Result<()>;
}
#[cfg(all(feature = "Win32_d3d12", feature = "Win32_winnt"))]
impl IMFD3D12SynchronizationObjectCommands_Vtbl {
    pub const fn new<Identity: IMFD3D12SynchronizationObjectCommands_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn SignalEventOnResourceReady<Identity: IMFD3D12SynchronizationObjectCommands_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hevent: super::winnt::HANDLE) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
