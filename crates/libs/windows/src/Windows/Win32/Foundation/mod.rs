...
pub const APPX_E_BLOCK_HASH_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080207u32 as _);
pub const APPX_E_CORRUPT_CONTENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080206u32 as _);
pub const APPX_E_DELTA_APPENDED_PACKAGE_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080210u32 as _);
pub const APPX_E_DELTA_BASELINE_VERSION_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8008020Du32 as _);
pub const APPX_E_DELTA_PACKAGE_MISSING_FILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8008020Eu32 as _);
pub const APPX_E_DIGEST_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080219u32 as _);
pub const APPX_E_FILE_COMPRESSION_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080214u32 as _);
pub const APPX_E_INTERLEAVING_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080201u32 as _);
pub const APPX_E_INVALID_APPINSTALLER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8008020Cu32 as _);
pub const APPX_E_INVALID_BLOCKMAP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080205u32 as _);
pub const APPX_E_INVALID_CONTENTGROUPMAP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8008020Bu32 as _);
pub const APPX_E_INVALID_DELTA_PACKAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8008020Fu32 as _);
pub const APPX_E_INVALID_ENCRYPTION_EXCLUSION_FILE_LIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080216u32 as _);
pub const APPX_E_INVALID_KEY_INFO: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8008020Au32 as _);
pub const APPX_E_INVALID_MANIFEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080204u32 as _);
pub const APPX_E_INVALID_PACKAGESIGNCONFIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080212u32 as _);
pub const APPX_E_INVALID_PACKAGE_FOLDER_ACLS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080217u32 as _);
pub const APPX_E_INVALID_PACKAGING_LAYOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080211u32 as _);
pub const APPX_E_INVALID_PAYLOAD_PACKAGE_EXTENSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080215u32 as _);
pub const APPX_E_INVALID_PUBLISHER_BRIDGING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080218u32 as _);
pub const APPX_E_INVALID_SIP_CLIENT_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080209u32 as _);
pub const APPX_E_MISSING_REQUIRED_FILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080203u32 as _);
pub const APPX_E_PACKAGING_INTERNAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080200u32 as _);
pub const APPX_E_RELATIONSHIPS_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080202u32 as _);
pub const APPX_E_REQUESTED_RANGE_TOO_LARGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080208u32 as _);
pub const APPX_E_RESOURCESPRI_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080213u32 as _);
pub const APP_LOCAL_DEVICE_ID_SIZE: u32 = 32u32;
pub const BT_E_SPURIOUS_ACTIVATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080300u32 as _);
pub const CACHE_E_FIRST: i32 = -2147221136i32;
pub const CACHE_E_LAST: i32 = -2147221121i32;
pub const CACHE_E_NOCACHE_UPDATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040170u32 as _);
pub const CACHE_S_FIRST: i32 = 262512i32;
pub const CACHE_S_FORMATETC_NOTSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40170u32 as _);
pub const CACHE_S_LAST: i32 = 262527i32;
pub const CACHE_S_SAMECACHE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40171u32 as _);
pub const CACHE_S_SOMECACHES_NOTUPDATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40172u32 as _);
pub const CAT_E_CATIDNOEXIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040160u32 as _);
pub const CAT_E_FIRST: i32 = -2147221152i32;
pub const CAT_E_LAST: i32 = -2147221151i32;
pub const CAT_E_NODESCRIPTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040161u32 as _);
pub const CERTSRV_E_ADMIN_DENIED_REQUEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094014u32 as _);
pub const CERTSRV_E_ALIGNMENT_FAULT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094010u32 as _);
pub const CERTSRV_E_ARCHIVED_KEY_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094804u32 as _);
pub const CERTSRV_E_ARCHIVED_KEY_UNEXPECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094810u32 as _);
pub const CERTSRV_E_BAD_RENEWAL_CERT_ATTRIBUTE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009400Eu32 as _);
pub const CERTSRV_E_BAD_RENEWAL_SUBJECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094806u32 as _);
pub const CERTSRV_E_BAD_REQUESTSTATUS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094003u32 as _);
pub const CERTSRV_E_BAD_REQUESTSUBJECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094001u32 as _);
pub const CERTSRV_E_BAD_REQUEST_KEY_ARCHIVAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009400Cu32 as _);
pub const CERTSRV_E_BAD_TEMPLATE_VERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094807u32 as _);
pub const CERTSRV_E_CERT_TYPE_OVERLAP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094814u32 as _);
pub const CERTSRV_E_CORRUPT_KEY_ATTESTATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009481Bu32 as _);
pub const CERTSRV_E_DOWNLEVEL_DC_SSL_OR_UPGRADE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094013u32 as _);
pub const CERTSRV_E_ENCODING_LENGTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094007u32 as _);
pub const CERTSRV_E_ENCRYPTION_CERT_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094018u32 as _);
pub const CERTSRV_E_ENROLL_DENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094011u32 as _);
pub const CERTSRV_E_EXPIRED_CHALLENGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009481Cu32 as _);
pub const CERTSRV_E_INVALID_ATTESTATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094819u32 as _);
pub const CERTSRV_E_INVALID_CA_CERTIFICATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094005u32 as _);
pub const CERTSRV_E_INVALID_EK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094817u32 as _);
pub const CERTSRV_E_INVALID_IDBINDING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094818u32 as _);
pub const CERTSRV_E_INVALID_REQUESTID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009481Eu32 as _);
pub const CERTSRV_E_INVALID_RESPONSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009481Du32 as _);
pub const CERTSRV_E_ISSUANCE_POLICY_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009480Cu32 as _);
pub const CERTSRV_E_KEY_ARCHIVAL_NOT_CONFIGURED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009400Au32 as _);
pub const CERTSRV_E_KEY_ATTESTATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009481Au32 as _);
pub const CERTSRV_E_KEY_ATTESTATION_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094017u32 as _);
pub const CERTSRV_E_KEY_LENGTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094811u32 as _);
pub const CERTSRV_E_NO_CAADMIN_DEFINED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009400Du32 as _);
pub const CERTSRV_E_NO_CERT_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094801u32 as _);
pub const CERTSRV_E_NO_DB_SESSIONS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009400Fu32 as _);
pub const CERTSRV_E_NO_POLICY_SERVER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094015u32 as _);
pub const CERTSRV_E_NO_REQUEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094002u32 as _);
pub const CERTSRV_E_NO_VALID_KRA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009400Bu32 as _);
pub const CERTSRV_E_PENDING_CLIENT_RESPONSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094820u32 as _);
pub const CERTSRV_E_PROPERTY_EMPTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094004u32 as _);
pub const CERTSRV_E_RENEWAL_BAD_PUBLIC_KEY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094816u32 as _);
pub const CERTSRV_E_REQUEST_PRECERTIFICATE_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009481Fu32 as _);
pub const CERTSRV_E_RESTRICTEDOFFICER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094009u32 as _);
pub const CERTSRV_E_ROLECONFLICT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094008u32 as _);
pub const CERTSRV_E_SEC_EXT_DIRECTORY_SID_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094821u32 as _);
pub const CERTSRV_E_SERVER_SUSPENDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094006u32 as _);
pub const CERTSRV_E_SIGNATURE_COUNT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009480Au32 as _);
pub const CERTSRV_E_SIGNATURE_POLICY_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094809u32 as _);
pub const CERTSRV_E_SIGNATURE_REJECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009480Bu32 as _);
pub const CERTSRV_E_SMIME_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094805u32 as _);
pub const CERTSRV_E_SUBJECT_ALT_NAME_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094803u32 as _);
pub const CERTSRV_E_SUBJECT_DIRECTORY_GUID_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009480Eu32 as _);
pub const CERTSRV_E_SUBJECT_DNS_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009480Fu32 as _);
pub const CERTSRV_E_SUBJECT_EMAIL_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094812u32 as _);
pub const CERTSRV_E_SUBJECT_UPN_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009480Du32 as _);
pub const CERTSRV_E_TEMPLATE_CONFLICT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094802u32 as _);
pub const CERTSRV_E_TEMPLATE_DENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094012u32 as _);
pub const CERTSRV_E_TEMPLATE_POLICY_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094808u32 as _);
pub const CERTSRV_E_TOO_MANY_SIGNATURES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094815u32 as _);
pub const CERTSRV_E_UNKNOWN_CERT_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094813u32 as _);
pub const CERTSRV_E_UNSUPPORTED_CERT_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094800u32 as _);
pub const CERTSRV_E_WEAK_SIGNATURE_OR_KEY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80094016u32 as _);
pub const CERT_E_CHAINING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B010Au32 as _);
pub const CERT_E_CN_NO_MATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B010Fu32 as _);
pub const CERT_E_CRITICAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0105u32 as _);
pub const CERT_E_EXPIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0101u32 as _);
pub const CERT_E_INVALID_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0114u32 as _);
pub const CERT_E_INVALID_POLICY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0113u32 as _);
pub const CERT_E_ISSUERCHAINING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0107u32 as _);
pub const CERT_E_MALFORMED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0108u32 as _);
pub const CERT_E_PATHLENCONST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0104u32 as _);
pub const CERT_E_PURPOSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0106u32 as _);
pub const CERT_E_REVOCATION_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B010Eu32 as _);
pub const CERT_E_REVOKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B010Cu32 as _);
pub const CERT_E_ROLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0103u32 as _);
pub const CERT_E_UNTRUSTEDCA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0112u32 as _);
pub const CERT_E_UNTRUSTEDROOT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0109u32 as _);
pub const CERT_E_UNTRUSTEDTESTROOT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B010Du32 as _);
pub const CERT_E_VALIDITYPERIODNESTING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0102u32 as _);
pub const CERT_E_WRONG_USAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0110u32 as _);
pub const CI_CORRUPT_CATALOG: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0041801u32 as _);
pub const CI_CORRUPT_DATABASE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0041800u32 as _);
pub const CI_CORRUPT_FILTER_BUFFER: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0041807u32 as _);
pub const CI_E_ALREADY_INITIALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004180Au32 as _);
pub const CI_E_BUFFERTOOSMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004180Cu32 as _);
pub const CI_E_CARDINALITY_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041827u32 as _);
pub const CI_E_CLIENT_FILTER_ABORT: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0041824u32 as _);
pub const CI_E_CONFIG_DISK_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041828u32 as _);
pub const CI_E_DISK_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041811u32 as _);
pub const CI_E_DISTRIBUTED_GROUPBY_UNSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041829u32 as _);
pub const CI_E_DUPLICATE_NOTIFICATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041817u32 as _);
pub const CI_E_ENUMERATION_STARTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0041822u32 as _);
pub const CI_E_FILTERING_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041810u32 as _);
pub const CI_E_INVALID_FLAGS_COMBINATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041819u32 as _);
pub const CI_E_INVALID_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004180Fu32 as _);
pub const CI_E_LOGON_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004181Cu32 as _);
pub const CI_E_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041815u32 as _);
pub const CI_E_NOT_INITIALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004180Bu32 as _);
pub const CI_E_NOT_RUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041820u32 as _);
pub const CI_E_NO_CATALOG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004181Du32 as _);
pub const CI_E_OUTOFSEQ_INCREMENT_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004181Au32 as _);
pub const CI_E_PROPERTY_NOT_CACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004180Du32 as _);
pub const CI_E_PROPERTY_TOOLARGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0041823u32 as _);
pub const CI_E_SHARING_VIOLATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004181Bu32 as _);
pub const CI_E_SHUTDOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041812u32 as _);
pub const CI_E_STRANGE_PAGEORSECTOR_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004181Eu32 as _);
pub const CI_E_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004181Fu32 as _);
pub const CI_E_UPDATES_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041818u32 as _);
pub const CI_E_USE_DEFAULT_PID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041816u32 as _);
pub const CI_E_WORKID_NOTVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041813u32 as _);
pub const CI_INCORRECT_VERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0041821u32 as _);
pub const CI_INVALID_INDEX: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0041808u32 as _);
pub const CI_INVALID_PARTITION: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0041802u32 as _);
pub const CI_INVALID_PRIORITY: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0041803u32 as _);
pub const CI_NO_CATALOG: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0041806u32 as _);
pub const CI_NO_STARTING_KEY: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0041804u32 as _);
pub const CI_OUT_OF_INDEX_IDS: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0041805u32 as _);
pub const CI_PROPSTORE_INCONSISTENCY: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0041809u32 as _);
pub const CI_S_CAT_STOPPED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41826u32 as _);
pub const CI_S_END_OF_ENUMERATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41814u32 as _);
pub const CI_S_NO_DOCSTORE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41825u32 as _);
pub const CI_S_WORKID_DELETED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4180Eu32 as _);
...
pub const CLASS_E_CLASSNOTAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040111u32 as _);
pub const CLASS_E_NOAGGREGATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040110u32 as _);
pub const CLASS_E_NOTLICENSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040112u32 as _);
...
pub const CLIPBRD_E_BAD_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401D3u32 as _);
pub const CLIPBRD_E_CANT_CLOSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401D4u32 as _);
pub const CLIPBRD_E_CANT_EMPTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401D1u32 as _);
pub const CLIPBRD_E_CANT_OPEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401D0u32 as _);
pub const CLIPBRD_E_CANT_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401D2u32 as _);
...
pub const COMADMIN_E_ALREADYINSTALLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110404u32 as _);
pub const COMADMIN_E_AMBIGUOUS_APPLICATION_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011045Cu32 as _);
pub const COMADMIN_E_AMBIGUOUS_PARTITION_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011045Du32 as _);
pub const COMADMIN_E_APPDIRNOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011041Fu32 as _);
pub const COMADMIN_E_APPLICATIONEXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011040Bu32 as _);
pub const COMADMIN_E_APPLID_MATCHES_CLSID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110446u32 as _);
pub const COMADMIN_E_APP_FILE_READFAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110408u32 as _);
pub const COMADMIN_E_APP_FILE_VERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110409u32 as _);
pub const COMADMIN_E_APP_FILE_WRITEFAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110407u32 as _);
pub const COMADMIN_E_APP_NOT_RUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011080Au32 as _);
pub const COMADMIN_E_AUTHENTICATIONLEVEL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110413u32 as _);
pub const COMADMIN_E_BADPATH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011040Au32 as _);
pub const COMADMIN_E_BADREGISTRYLIBID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011041Eu32 as _);
pub const COMADMIN_E_BADREGISTRYPROGID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110412u32 as _);
pub const COMADMIN_E_BASEPARTITION_REQUIRED_IN_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011081Fu32 as _);
pub const COMADMIN_E_BASE_PARTITION_ONLY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110450u32 as _);
pub const COMADMIN_E_CANNOT_ALIAS_EVENTCLASS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110820u32 as _);
pub const COMADMIN_E_CANTCOPYFILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011040Du32 as _);
pub const COMADMIN_E_CANTMAKEINPROCSERVICE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110814u32 as _);
pub const COMADMIN_E_CANTRECYCLELIBRARYAPPS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011080Fu32 as _);
pub const COMADMIN_E_CANTRECYCLESERVICEAPPS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110811u32 as _);
pub const COMADMIN_E_CANT_SUBSCRIBE_TO_COMPONENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011044Du32 as _);
pub const COMADMIN_E_CAN_NOT_EXPORT_APP_PROXY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011044Au32 as _);
pub const COMADMIN_E_CAN_NOT_EXPORT_SYS_APP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011044Cu32 as _);
pub const COMADMIN_E_CAN_NOT_START_APP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011044Bu32 as _);
pub const COMADMIN_E_CAT_BITNESSMISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110482u32 as _);
pub const COMADMIN_E_CAT_DUPLICATE_PARTITION_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110457u32 as _);
pub const COMADMIN_E_CAT_IMPORTED_COMPONENTS_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011045Bu32 as _);
pub const COMADMIN_E_CAT_INVALID_PARTITION_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110458u32 as _);
pub const COMADMIN_E_CAT_PARTITION_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110459u32 as _);
pub const COMADMIN_E_CAT_PAUSE_RESUME_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110485u32 as _);
pub const COMADMIN_E_CAT_SERVERFAULT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110486u32 as _);
pub const COMADMIN_E_CAT_UNACCEPTABLEBITNESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110483u32 as _);
pub const COMADMIN_E_CAT_WRONGAPPBITNESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110484u32 as _);
pub const COMADMIN_E_CLSIDORIIDMISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110418u32 as _);
pub const COMADMIN_E_COMPFILE_BADTLB: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110428u32 as _);
pub const COMADMIN_E_COMPFILE_CLASSNOTAVAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110427u32 as _);
pub const COMADMIN_E_COMPFILE_DOESNOTEXIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110424u32 as _);
pub const COMADMIN_E_COMPFILE_GETCLASSOBJ: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110426u32 as _);
pub const COMADMIN_E_COMPFILE_LOADDLLFAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110425u32 as _);
pub const COMADMIN_E_COMPFILE_NOREGISTRAR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110434u32 as _);
pub const COMADMIN_E_COMPFILE_NOTINSTALLABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110429u32 as _);
pub const COMADMIN_E_COMPONENTEXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110439u32 as _);
pub const COMADMIN_E_COMP_MOVE_BAD_DEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011042Eu32 as _);
pub const COMADMIN_E_COMP_MOVE_DEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011081Du32 as _);
pub const COMADMIN_E_COMP_MOVE_LOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011042Du32 as _);
pub const COMADMIN_E_COMP_MOVE_PRIVATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011081Eu32 as _);
pub const COMADMIN_E_COMP_MOVE_SOURCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011081Cu32 as _);
pub const COMADMIN_E_COREQCOMPINSTALLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110435u32 as _);
pub const COMADMIN_E_DEFAULT_PARTITION_NOT_IN_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110816u32 as _);
pub const COMADMIN_E_DLLLOADFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011041Du32 as _);
pub const COMADMIN_E_DLLREGISTERSERVER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011041Au32 as _);
pub const COMADMIN_E_EVENTCLASS_CANT_BE_SUBSCRIBER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011044Eu32 as _);
pub const COMADMIN_E_FILE_PARTITION_DUPLICATE_FILES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011045Au32 as _);
pub const COMADMIN_E_INVALIDUSERIDS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110410u32 as _);
pub const COMADMIN_E_INVALID_PARTITION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011080Bu32 as _);
pub const COMADMIN_E_KEYMISSING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110403u32 as _);
pub const COMADMIN_E_LEGACYCOMPS_NOT_ALLOWED_IN_1_0_FORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011081Au32 as _);
pub const COMADMIN_E_LEGACYCOMPS_NOT_ALLOWED_IN_NONBASE_PARTITIONS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011081Bu32 as _);
pub const COMADMIN_E_LIB_APP_PROXY_INCOMPATIBLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011044Fu32 as _);
pub const COMADMIN_E_MIG_SCHEMANOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110481u32 as _);
pub const COMADMIN_E_MIG_VERSIONNOTSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110480u32 as _);
pub const COMADMIN_E_NOREGISTRYCLSID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110411u32 as _);
pub const COMADMIN_E_NOSERVERSHARE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011041Bu32 as _);
pub const COMADMIN_E_NOTCHANGEABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011042Au32 as _);
pub const COMADMIN_E_NOTDELETEABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011042Bu32 as _);
pub const COMADMIN_E_NOTINREGISTRY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011043Eu32 as _);
pub const COMADMIN_E_NOUSER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011040Fu32 as _);
pub const COMADMIN_E_OBJECTERRORS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110401u32 as _);
pub const COMADMIN_E_OBJECTEXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110438u32 as _);
pub const COMADMIN_E_OBJECTINVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110402u32 as _);
pub const COMADMIN_E_OBJECTNOTPOOLABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011043Fu32 as _);
pub const COMADMIN_E_OBJECT_DOES_NOT_EXIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110809u32 as _);
pub const COMADMIN_E_OBJECT_PARENT_MISSING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110808u32 as _);
pub const COMADMIN_E_PARTITIONS_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110824u32 as _);
pub const COMADMIN_E_PARTITION_ACCESSDENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110818u32 as _);
pub const COMADMIN_E_PARTITION_MSI_ONLY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110819u32 as _);
pub const COMADMIN_E_PAUSEDPROCESSMAYNOTBERECYCLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110813u32 as _);
pub const COMADMIN_E_PRIVATE_ACCESSDENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110821u32 as _);
pub const COMADMIN_E_PROCESSALREADYRECYCLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110812u32 as _);
pub const COMADMIN_E_PROGIDINUSEBYCLSID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110815u32 as _);
pub const COMADMIN_E_PROPERTYSAVEFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110437u32 as _);
pub const COMADMIN_E_PROPERTY_OVERFLOW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011043Cu32 as _);
pub const COMADMIN_E_RECYCLEDPROCESSMAYNOTBEPAUSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110817u32 as _);
pub const COMADMIN_E_REGDB_ALREADYRUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110475u32 as _);
pub const COMADMIN_E_REGDB_NOTINITIALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110472u32 as _);
pub const COMADMIN_E_REGDB_NOTOPEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110473u32 as _);
pub const COMADMIN_E_REGDB_SYSTEMERR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110474u32 as _);
pub const COMADMIN_E_REGFILE_CORRUPT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011043Bu32 as _);
pub const COMADMIN_E_REGISTERTLB: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110430u32 as _);
pub const COMADMIN_E_REGISTRARFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110423u32 as _);
pub const COMADMIN_E_REGISTRY_ACCESSDENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110823u32 as _);
pub const COMADMIN_E_REMOTEINTERFACE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110419u32 as _);
pub const COMADMIN_E_REQUIRES_DIFFERENT_PLATFORM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110449u32 as _);
pub const COMADMIN_E_ROLEEXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011040Cu32 as _);
pub const COMADMIN_E_ROLE_DOES_NOT_EXIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110447u32 as _);
pub const COMADMIN_E_SAFERINVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110822u32 as _);
pub const COMADMIN_E_SERVICENOTINSTALLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110436u32 as _);
pub const COMADMIN_E_SESSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011042Cu32 as _);
pub const COMADMIN_E_START_APP_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110451u32 as _);
pub const COMADMIN_E_START_APP_NEEDS_COMPONENTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110448u32 as _);
pub const COMADMIN_E_SVCAPP_NOT_POOLABLE_OR_RECYCLABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011080Du32 as _);
pub const COMADMIN_E_SYSTEMAPP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110433u32 as _);
pub const COMADMIN_E_USERPASSWDNOTVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110414u32 as _);
pub const COMADMIN_E_USER_IN_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8011080Eu32 as _);
pub const COMQC_E_APPLICATION_NOT_QUEUED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110600u32 as _);
pub const COMQC_E_BAD_MESSAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110604u32 as _);
pub const COMQC_E_NO_IPERSISTSTREAM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110603u32 as _);
pub const COMQC_E_NO_QUEUEABLE_INTERFACES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110601u32 as _);
pub const COMQC_E_QUEUING_SERVICE_NOT_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110602u32 as _);
pub const COMQC_E_UNAUTHENTICATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110605u32 as _);
pub const COMQC_E_UNTRUSTED_ENQUEUER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110606u32 as _);
pub const CONTEXT_E_ABORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E002u32 as _);
pub const CONTEXT_E_ABORTING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E003u32 as _);
pub const CONTEXT_E_FIRST: i32 = -2147164160i32;
pub const CONTEXT_E_LAST: i32 = -2147164113i32;
pub const CONTEXT_E_NOCONTEXT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E004u32 as _);
pub const CONTEXT_E_NOJIT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E026u32 as _);
pub const CONTEXT_E_NOTRANSACTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E027u32 as _);
pub const CONTEXT_E_OLDREF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E007u32 as _);
pub const CONTEXT_E_ROLENOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E00Cu32 as _);
pub const CONTEXT_E_SYNCH_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E006u32 as _);
pub const CONTEXT_E_TMNOTAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E00Fu32 as _);
pub const CONTEXT_E_WOULD_DEADLOCK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E005u32 as _);
...
pub const CONVERT10_E_OLELINK_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401C7u32 as _);
pub const CONVERT10_E_OLESTREAM_BITMAP_TO_DIB: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401C3u32 as _);
pub const CONVERT10_E_OLESTREAM_FMT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401C2u32 as _);
pub const CONVERT10_E_OLESTREAM_GET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401C0u32 as _);
pub const CONVERT10_E_OLESTREAM_PUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401C1u32 as _);
pub const CONVERT10_E_STG_DIB_TO_BITMAP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401C6u32 as _);
pub const CONVERT10_E_STG_FMT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401C4u32 as _);
pub const CONVERT10_E_STG_NO_STD_STREAM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401C5u32 as _);
pub const CONVERT10_S_FIRST: i32 = 262592i32;
pub const CONVERT10_S_LAST: i32 = 262607i32;
pub const CONVERT10_S_NO_PRESENTATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x401C0u32 as _);
pub const CO_E_ACCESSCHECKFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001012Au32 as _);
pub const CO_E_ACESINWRONGORDER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001013Au32 as _);
pub const CO_E_ACNOTINITIALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001013Fu32 as _);
pub const CO_E_ACTIVATIONFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E021u32 as _);
pub const CO_E_ACTIVATIONFAILED_CATALOGERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E023u32 as _);
pub const CO_E_ACTIVATIONFAILED_EVENTLOGGED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E022u32 as _);
pub const CO_E_ACTIVATIONFAILED_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E024u32 as _);
pub const CO_E_ALREADYINITIALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401F1u32 as _);
pub const CO_E_APPDIDNTREG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401FEu32 as _);
pub const CO_E_APPNOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401F5u32 as _);
pub const CO_E_APPSINGLEUSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401F6u32 as _);
pub const CO_E_ASYNC_WORK_REJECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004029u32 as _);
pub const CO_E_ATTEMPT_TO_CREATE_OUTSIDE_CLIENT_CONTEXT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004024u32 as _);
pub const CO_E_BAD_PATH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080004u32 as _);
pub const CO_E_BAD_SERVER_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004014u32 as _);
pub const CO_E_CALL_OUT_OF_TX_SCOPE_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E030u32 as _);
pub const CO_E_CANCEL_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010140u32 as _);
pub const CO_E_CANTDETERMINECLASS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401F2u32 as _);
pub const CO_E_CANT_REMOTE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004013u32 as _);
pub const CO_E_CLASSSTRING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401F3u32 as _);
pub const CO_E_CLASS_CREATE_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080001u32 as _);
pub const CO_E_CLASS_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004027u32 as _);
pub const CO_E_CLRNOTAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004028u32 as _);
pub const CO_E_CLSREG_INCONSISTENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000401Fu32 as _);
pub const CO_E_CONVERSIONFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001012Eu32 as _);
pub const CO_E_CREATEPROCESS_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004018u32 as _);
pub const CO_E_DBERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E02Bu32 as _);
pub const CO_E_DECODEFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001013Du32 as _);
pub const CO_E_DLLNOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401F8u32 as _);
pub const CO_E_ELEVATION_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080017u32 as _);
pub const CO_E_ERRORINAPP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401F7u32 as _);
pub const CO_E_ERRORINDLL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401F9u32 as _);
pub const CO_E_EXCEEDSYSACLLIMIT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010139u32 as _);
pub const CO_E_EXIT_TRANSACTION_SCOPE_NOT_CALLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E031u32 as _);
pub const CO_E_FAILEDTOCLOSEHANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010138u32 as _);
pub const CO_E_FAILEDTOCREATEFILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010137u32 as _);
pub const CO_E_FAILEDTOGENUUID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010136u32 as _);
pub const CO_E_FAILEDTOGETSECCTX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010124u32 as _);
pub const CO_E_FAILEDTOGETTOKENINFO: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010126u32 as _);
pub const CO_E_FAILEDTOGETWINDIR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010134u32 as _);
pub const CO_E_FAILEDTOIMPERSONATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010123u32 as _);
pub const CO_E_FAILEDTOOPENPROCESSTOKEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001013Cu32 as _);
pub const CO_E_FAILEDTOOPENTHREADTOKEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010125u32 as _);
pub const CO_E_FAILEDTOQUERYCLIENTBLANKET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010128u32 as _);
pub const CO_E_FAILEDTOSETDACL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010129u32 as _);
pub const CO_E_FIRST: i32 = -2147221008i32;
pub const CO_E_IIDREG_INCONSISTENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004020u32 as _);
pub const CO_E_IIDSTRING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401F4u32 as _);
pub const CO_E_INCOMPATIBLESTREAMVERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001013Bu32 as _);
pub const CO_E_INITIALIZATIONFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E025u32 as _);
pub const CO_E_INIT_CLASS_CACHE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004009u32 as _);
pub const CO_E_INIT_MEMORY_ALLOCATOR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004008u32 as _);
pub const CO_E_INIT_ONLY_SINGLE_THREADED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004012u32 as _);
pub const CO_E_INIT_RPC_CHANNEL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000400Au32 as _);
pub const CO_E_INIT_SCM_EXEC_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004011u32 as _);
pub const CO_E_INIT_SCM_FILE_MAPPING_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000400Fu32 as _);
pub const CO_E_INIT_SCM_MAP_VIEW_OF_FILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004010u32 as _);
pub const CO_E_INIT_SCM_MUTEX_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000400Eu32 as _);
pub const CO_E_INIT_SHARED_ALLOCATOR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004007u32 as _);
pub const CO_E_INIT_TLS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004006u32 as _);
pub const CO_E_INIT_TLS_CHANNEL_CONTROL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000400Cu32 as _);
pub const CO_E_INIT_TLS_SET_CHANNEL_CONTROL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000400Bu32 as _);
pub const CO_E_INIT_UNACCEPTED_USER_ALLOCATOR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000400Du32 as _);
pub const CO_E_INVALIDSID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001012Du32 as _);
pub const CO_E_ISOLEVELMISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E02Fu32 as _);
pub const CO_E_LAST: i32 = -2147220993i32;
pub const CO_E_LAUNCH_PERMSSION_DENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000401Bu32 as _);
pub const CO_E_LOOKUPACCNAMEFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010132u32 as _);
pub const CO_E_LOOKUPACCSIDFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010130u32 as _);
pub const CO_E_MALFORMED_SPN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004033u32 as _);
pub const CO_E_MISSING_DISPLAYNAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080015u32 as _);
pub const CO_E_MSI_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004023u32 as _);
pub const CO_E_NETACCESSAPIFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001012Bu32 as _);
pub const CO_E_NOCOOKIES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E02Au32 as _);
pub const CO_E_NOIISINTRINSICS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E029u32 as _);
pub const CO_E_NOMATCHINGNAMEFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010131u32 as _);
pub const CO_E_NOMATCHINGSIDFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001012Fu32 as _);
pub const CO_E_NOSYNCHRONIZATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E02Eu32 as _);
pub const CO_E_NOTCONSTRUCTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E02Du32 as _);
pub const CO_E_NOTINITIALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401F0u32 as _);
pub const CO_E_NOTPOOLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E02Cu32 as _);
pub const CO_E_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004021u32 as _);
pub const CO_E_NO_SECCTX_IN_ACTIVATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000402Bu32 as _);
pub const CO_E_OBJISREG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401FCu32 as _);
pub const CO_E_OBJNOTCONNECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401FDu32 as _);
pub const CO_E_OBJNOTREG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401FBu32 as _);
pub const CO_E_OBJSRV_RPC_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080006u32 as _);
pub const CO_E_OLE1DDE_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004016u32 as _);
pub const CO_E_PATHTOOLONG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010135u32 as _);
pub const CO_E_PREMATURE_STUB_RUNDOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004035u32 as _);
pub const CO_E_RELEASED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401FFu32 as _);
pub const CO_E_RELOAD_DLL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004022u32 as _);
pub const CO_E_REMOTE_COMMUNICATION_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000401Du32 as _);
pub const CO_E_RUNAS_CREATEPROCESS_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004019u32 as _);
pub const CO_E_RUNAS_LOGON_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000401Au32 as _);
pub const CO_E_RUNAS_SYNTAX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004017u32 as _);
pub const CO_E_RUNAS_VALUE_MUST_BE_AAA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080016u32 as _);
pub const CO_E_SCM_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080002u32 as _);
pub const CO_E_SCM_RPC_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080003u32 as _);
pub const CO_E_SERVER_EXEC_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080005u32 as _);
pub const CO_E_SERVER_INIT_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000402Au32 as _);
pub const CO_E_SERVER_NOT_PAUSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004026u32 as _);
pub const CO_E_SERVER_PAUSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004025u32 as _);
pub const CO_E_SERVER_START_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000401Eu32 as _);
pub const CO_E_SERVER_STOPPING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080008u32 as _);
pub const CO_E_SETSERLHNDLFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010133u32 as _);
pub const CO_E_START_SERVICE_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000401Cu32 as _);
pub const CO_E_SXS_CONFIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004032u32 as _);
pub const CO_E_THREADINGMODEL_CHANGED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004E028u32 as _);
pub const CO_E_THREADPOOL_CONFIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004031u32 as _);
pub const CO_E_TRACKER_CONFIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004030u32 as _);
pub const CO_E_TRUSTEEDOESNTMATCHCLIENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010127u32 as _);
pub const CO_E_UNREVOKED_REGISTRATION_ON_APARTMENT_SHUTDOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004034u32 as _);
pub const CO_E_WRONGOSFORAPP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401FAu32 as _);
pub const CO_E_WRONGTRUSTEENAMESYNTAX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001012Cu32 as _);
pub const CO_E_WRONG_SERVER_IDENTITY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004015u32 as _);
pub const CO_S_FIRST: i32 = 262640i32;
pub const CO_S_LAST: i32 = 262655i32;
pub const CO_S_MACHINENAMENOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80013u32 as _);
pub const CO_S_NOTALLINTERFACES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80012u32 as _);
pub const CRYPT_E_ALREADY_DECRYPTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80091009u32 as _);
pub const CRYPT_E_ASN1_BADARGS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093109u32 as _);
pub const CRYPT_E_ASN1_BADPDU: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093108u32 as _);
pub const CRYPT_E_ASN1_BADREAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009310Au32 as _);
pub const CRYPT_E_ASN1_BADTAG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009310Bu32 as _);
pub const CRYPT_E_ASN1_CHOICE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009310Cu32 as _);
pub const CRYPT_E_ASN1_CONSTRAINT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093105u32 as _);
pub const CRYPT_E_ASN1_CORRUPT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093103u32 as _);
pub const CRYPT_E_ASN1_EOD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093102u32 as _);
pub const CRYPT_E_ASN1_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093100u32 as _);
pub const CRYPT_E_ASN1_EXTENDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093201u32 as _);
pub const CRYPT_E_ASN1_INTERNAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093101u32 as _);
pub const CRYPT_E_ASN1_LARGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093104u32 as _);
pub const CRYPT_E_ASN1_MEMORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093106u32 as _);
pub const CRYPT_E_ASN1_NOEOD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093202u32 as _);
pub const CRYPT_E_ASN1_NYI: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093134u32 as _);
pub const CRYPT_E_ASN1_OVERFLOW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093107u32 as _);
pub const CRYPT_E_ASN1_PDU_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093133u32 as _);
pub const CRYPT_E_ASN1_RULE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009310Du32 as _);
pub const CRYPT_E_ASN1_UTF8: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009310Eu32 as _);
pub const CRYPT_E_ATTRIBUTES_MISSING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009100Fu32 as _);
pub const CRYPT_E_AUTH_ATTR_MISSING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80091006u32 as _);
pub const CRYPT_E_BAD_ENCODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092002u32 as _);
pub const CRYPT_E_BAD_LEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092001u32 as _);
pub const CRYPT_E_BAD_MSG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009200Du32 as _);
pub const CRYPT_E_CONTROL_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009100Cu32 as _);
pub const CRYPT_E_DELETED_PREV: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092008u32 as _);
pub const CRYPT_E_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092005u32 as _);
pub const CRYPT_E_FILERESIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092025u32 as _);
pub const CRYPT_E_FILE_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092003u32 as _);
pub const CRYPT_E_HASH_VALUE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80091007u32 as _);
pub const CRYPT_E_INVALID_IA5_STRING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092022u32 as _);
pub const CRYPT_E_INVALID_INDEX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80091008u32 as _);
pub const CRYPT_E_INVALID_MSG_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80091004u32 as _);
pub const CRYPT_E_INVALID_NUMERIC_STRING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092020u32 as _);
pub const CRYPT_E_INVALID_PRINTABLE_STRING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092021u32 as _);
pub const CRYPT_E_INVALID_X500_STRING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092023u32 as _);
pub const CRYPT_E_ISSUER_SERIALNUMBER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009100Du32 as _);
pub const CRYPT_E_MISSING_PUBKEY_PARA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009202Cu32 as _);
pub const CRYPT_E_MSG_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80091001u32 as _);
pub const CRYPT_E_NOT_CHAR_STRING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092024u32 as _);
pub const CRYPT_E_NOT_DECRYPTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009100Au32 as _);
pub const CRYPT_E_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092004u32 as _);
pub const CRYPT_E_NOT_IN_CTL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009202Au32 as _);
pub const CRYPT_E_NOT_IN_REVOCATION_DATABASE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092014u32 as _);
pub const CRYPT_E_NO_DECRYPT_CERT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009200Cu32 as _);
pub const CRYPT_E_NO_KEY_PROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009200Bu32 as _);
pub const CRYPT_E_NO_MATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092009u32 as _);
pub const CRYPT_E_NO_PROVIDER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092006u32 as _);
pub const CRYPT_E_NO_REVOCATION_CHECK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092012u32 as _);
pub const CRYPT_E_NO_REVOCATION_DLL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092011u32 as _);
pub const CRYPT_E_NO_SIGNER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009200Eu32 as _);
pub const CRYPT_E_NO_TRUSTED_SIGNER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009202Bu32 as _);
pub const CRYPT_E_NO_VERIFY_USAGE_CHECK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092028u32 as _);
pub const CRYPT_E_NO_VERIFY_USAGE_DLL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092027u32 as _);
pub const CRYPT_E_OBJECT_LOCATOR_OBJECT_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009202Du32 as _);
pub const CRYPT_E_OID_FORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80091003u32 as _);
pub const CRYPT_E_OSS_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093000u32 as _);
pub const CRYPT_E_PENDING_CLOSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009200Fu32 as _);
pub const CRYPT_E_RECIPIENT_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009100Bu32 as _);
pub const CRYPT_E_REVOCATION_OFFLINE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092013u32 as _);
pub const CRYPT_E_REVOKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092010u32 as _);
pub const CRYPT_E_SECURITY_SETTINGS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092026u32 as _);
pub const CRYPT_E_SELF_SIGNED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092007u32 as _);
pub const CRYPT_E_SIGNER_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009100Eu32 as _);
pub const CRYPT_E_STREAM_INSUFFICIENT_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80091011u32 as _);
pub const CRYPT_E_STREAM_MSG_NOT_READY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80091010u32 as _);
pub const CRYPT_E_UNEXPECTED_ENCODING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80091005u32 as _);
pub const CRYPT_E_UNEXPECTED_MSG_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009200Au32 as _);
pub const CRYPT_E_UNKNOWN_ALGO: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80091002u32 as _);
pub const CRYPT_E_VERIFY_USAGE_OFFLINE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80092029u32 as _);
pub const CRYPT_I_NEW_PROTECTION_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x91012u32 as _);
pub const CS_E_ADMIN_LIMIT_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004016Du32 as _);
pub const CS_E_CLASS_NOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040166u32 as _);
pub const CS_E_FIRST: i32 = -2147221148i32;
pub const CS_E_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004016Fu32 as _);
pub const CS_E_INVALID_PATH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004016Bu32 as _);
pub const CS_E_INVALID_VERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040167u32 as _);
pub const CS_E_LAST: i32 = -2147221137i32;
pub const CS_E_NETWORK_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004016Cu32 as _);
pub const CS_E_NOT_DELETABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040165u32 as _);
pub const CS_E_NO_CLASSSTORE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040168u32 as _);
pub const CS_E_OBJECT_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004016Au32 as _);
pub const CS_E_OBJECT_NOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040169u32 as _);
pub const CS_E_PACKAGE_NOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040164u32 as _);
pub const CS_E_SCHEMA_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004016Eu32 as _);
pub const D2DERR_BAD_NUMBER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990011u32 as _);
pub const D2DERR_BITMAP_BOUND_AS_TARGET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990025u32 as _);
pub const D2DERR_BITMAP_CANNOT_DRAW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990021u32 as _);
pub const D2DERR_CYCLIC_GRAPH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990020u32 as _);
pub const D2DERR_DISPLAY_FORMAT_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990009u32 as _);
pub const D2DERR_DISPLAY_STATE_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990006u32 as _);
pub const D2DERR_EFFECT_IS_NOT_REGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990028u32 as _);
pub const D2DERR_EXCEEDS_MAX_BITMAP_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8899001Du32 as _);
pub const D2DERR_INCOMPATIBLE_BRUSH_TYPES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990018u32 as _);
pub const D2DERR_INSUFFICIENT_DEVICE_CAPABILITIES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990026u32 as _);
pub const D2DERR_INTERMEDIATE_TOO_LARGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990027u32 as _);
pub const D2DERR_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990008u32 as _);
pub const D2DERR_INVALID_CALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8899000Au32 as _);
pub const D2DERR_INVALID_GLYPH_IMAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8899002Eu32 as _);
pub const D2DERR_INVALID_GRAPH_CONFIGURATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8899001Eu32 as _);
pub const D2DERR_INVALID_INTERNAL_GRAPH_CONFIGURATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8899001Fu32 as _);
pub const D2DERR_INVALID_PROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990029u32 as _);
pub const D2DERR_INVALID_TARGET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990024u32 as _);
pub const D2DERR_LAYER_ALREADY_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990013u32 as _);
pub const D2DERR_MAX_TEXTURE_SIZE_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8899000Fu32 as _);
pub const D2DERR_NOT_INITIALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990002u32 as _);
pub const D2DERR_NO_HARDWARE_DEVICE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8899000Bu32 as _);
pub const D2DERR_NO_SUBPROPERTIES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8899002Au32 as _);
pub const D2DERR_ORIGINAL_TARGET_NOT_BOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990023u32 as _);
pub const D2DERR_OUTSTANDING_BITMAP_REFERENCES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990022u32 as _);
pub const D2DERR_POP_CALL_DID_NOT_MATCH_PUSH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990014u32 as _);
pub const D2DERR_PRINT_FORMAT_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8899002Cu32 as _);
pub const D2DERR_PRINT_JOB_CLOSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8899002Bu32 as _);
pub const D2DERR_PUSH_POP_UNBALANCED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990016u32 as _);
pub const D2DERR_RECREATE_TARGET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8899000Cu32 as _);
pub const D2DERR_RENDER_TARGET_HAS_LAYER_OR_CLIPRECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990017u32 as _);
pub const D2DERR_SCANNER_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990004u32 as _);
pub const D2DERR_SCREEN_ACCESS_DENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990005u32 as _);
pub const D2DERR_SHADER_COMPILE_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8899000Eu32 as _);
pub const D2DERR_TARGET_NOT_GDI_COMPATIBLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8899001Au32 as _);
pub const D2DERR_TEXT_EFFECT_IS_WRONG_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8899001Bu32 as _);
pub const D2DERR_TEXT_RENDERER_NOT_RELEASED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8899001Cu32 as _);
pub const D2DERR_TOO_MANY_SHADER_ELEMENTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8899000Du32 as _);
pub const D2DERR_TOO_MANY_TRANSFORM_INPUTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8899002Du32 as _);
pub const D2DERR_UNSUPPORTED_OPERATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990003u32 as _);
pub const D2DERR_UNSUPPORTED_VERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990010u32 as _);
pub const D2DERR_WIN32_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990019u32 as _);
pub const D2DERR_WRONG_FACTORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990012u32 as _);
pub const D2DERR_WRONG_RESOURCE_DOMAIN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990015u32 as _);
pub const D2DERR_WRONG_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990001u32 as _);
pub const D2DERR_ZERO_VECTOR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88990007u32 as _);
pub const D3D10_ERROR_FILE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88790002u32 as _);
pub const D3D10_ERROR_TOO_MANY_UNIQUE_STATE_OBJECTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88790001u32 as _);
pub const D3D11_ERROR_DEFERRED_CONTEXT_MAP_WITHOUT_INITIAL_DISCARD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887C0004u32 as _);
pub const D3D11_ERROR_FILE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887C0002u32 as _);
pub const D3D11_ERROR_TOO_MANY_UNIQUE_STATE_OBJECTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887C0001u32 as _);
pub const D3D11_ERROR_TOO_MANY_UNIQUE_VIEW_OBJECTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887C0003u32 as _);
pub const D3D12_ERROR_ADAPTER_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887E0001u32 as _);
pub const D3D12_ERROR_DRIVER_VERSION_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887E0002u32 as _);
pub const D3D12_ERROR_INVALID_REDIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887E0003u32 as _);
...
pub const DATA_S_SAMEFORMATETC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40130u32 as _);
...
pub const DCOMPOSITION_ERROR_SURFACE_BEING_RENDERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980801u32 as _);
pub const DCOMPOSITION_ERROR_SURFACE_NOT_BEING_RENDERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980802u32 as _);
pub const DCOMPOSITION_ERROR_WINDOW_ALREADY_COMPOSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980800u32 as _);
pub const DIGSIG_E_CRYPTO: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0008u32 as _);
pub const DIGSIG_E_DECODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0006u32 as _);
pub const DIGSIG_E_ENCODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0005u32 as _);
pub const DIGSIG_E_EXTENSIBILITY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0007u32 as _);
pub const DISP_E_ARRAYISLOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8002000Du32 as _);
pub const DISP_E_BADCALLEE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80020010u32 as _);
pub const DISP_E_BADINDEX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8002000Bu32 as _);
pub const DISP_E_BADPARAMCOUNT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8002000Eu32 as _);
pub const DISP_E_BADVARTYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80020008u32 as _);
pub const DISP_E_BUFFERTOOSMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80020013u32 as _);
pub const DISP_E_DIVBYZERO: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80020012u32 as _);
pub const DISP_E_EXCEPTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80020009u32 as _);
pub const DISP_E_MEMBERNOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80020003u32 as _);
pub const DISP_E_NONAMEDARGS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80020007u32 as _);
pub const DISP_E_NOTACOLLECTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80020011u32 as _);
pub const DISP_E_OVERFLOW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8002000Au32 as _);
pub const DISP_E_PARAMNOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80020004u32 as _);
pub const DISP_E_PARAMNOTOPTIONAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8002000Fu32 as _);
pub const DISP_E_TYPEMISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80020005u32 as _);
pub const DISP_E_UNKNOWNINTERFACE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80020001u32 as _);
pub const DISP_E_UNKNOWNLCID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8002000Cu32 as _);
pub const DISP_E_UNKNOWNNAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80020006u32 as _);
...
pub const DRAGDROP_E_ALREADYREGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040101u32 as _);
pub const DRAGDROP_E_CONCURRENT_DRAG_ATTEMPTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040103u32 as _);
pub const DRAGDROP_E_FIRST: i32 = -2147221248i32;
pub const DRAGDROP_E_INVALIDHWND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040102u32 as _);
pub const DRAGDROP_E_LAST: i32 = -2147221233i32;
pub const DRAGDROP_E_NOTREGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040100u32 as _);
pub const DRAGDROP_S_CANCEL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40101u32 as _);
pub const DRAGDROP_S_DROP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40100u32 as _);
pub const DRAGDROP_S_FIRST: i32 = 262400i32;
pub const DRAGDROP_S_LAST: i32 = 262415i32;
pub const DRAGDROP_S_USEDEFAULTCURSORS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40102u32 as _);
...
pub const DV_E_CLIPFORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004006Au32 as _);
pub const DV_E_DVASPECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004006Bu32 as _);
pub const DV_E_DVTARGETDEVICE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040065u32 as _);
pub const DV_E_DVTARGETDEVICE_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004006Cu32 as _);
pub const DV_E_FORMATETC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040064u32 as _);
pub const DV_E_LINDEX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040068u32 as _);
pub const DV_E_NOIVIEWOBJECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004006Du32 as _);
pub const DV_E_STATDATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040067u32 as _);
pub const DV_E_STGMEDIUM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040066u32 as _);
pub const DV_E_TYMED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040069u32 as _);
pub const DWMERR_CATASTROPHIC_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980702u32 as _);
pub const DWMERR_STATE_TRANSITION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980700u32 as _);
pub const DWMERR_THEME_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980701u32 as _);
pub const DWM_E_ADAPTER_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80263005u32 as _);
pub const DWM_E_COMPOSITIONDISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80263001u32 as _);
pub const DWM_E_NOT_QUEUING_PRESENTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80263004u32 as _);
pub const DWM_E_NO_REDIRECTION_SURFACE_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80263003u32 as _);
pub const DWM_E_REMOTING_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80263002u32 as _);
pub const DWM_E_TEXTURE_TOO_LARGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80263007u32 as _);
pub const DWM_S_GDI_REDIRECTION_SURFACE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x263005u32 as _);
pub const DWM_S_GDI_REDIRECTION_SURFACE_BLT_VIA_GDI: ::windows_core::HRESULT = ::windows_core::HRESULT(0x263008u32 as _);
pub const DWRITE_E_ALREADYREGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88985006u32 as _);
pub const DWRITE_E_CACHEFORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88985007u32 as _);
pub const DWRITE_E_CACHEVERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88985008u32 as _);
pub const DWRITE_E_FILEACCESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88985004u32 as _);
pub const DWRITE_E_FILEFORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88985000u32 as _);
pub const DWRITE_E_FILENOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88985003u32 as _);
pub const DWRITE_E_FLOWDIRECTIONCONFLICTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898500Bu32 as _);
pub const DWRITE_E_FONTCOLLECTIONOBSOLETE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88985005u32 as _);
pub const DWRITE_E_NOCOLOR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898500Cu32 as _);
pub const DWRITE_E_NOFONT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88985002u32 as _);
pub const DWRITE_E_TEXTRENDERERINCOMPATIBLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898500Au32 as _);
pub const DWRITE_E_UNEXPECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88985001u32 as _);
pub const DWRITE_E_UNSUPPORTEDOPERATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88985009u32 as _);
pub const DXCORE_ERROR_EVENT_NOT_UNREGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88800001u32 as _);
pub const DXGI_DDI_ERR_NONEXCLUSIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887B0003u32 as _);
pub const DXGI_DDI_ERR_UNSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887B0002u32 as _);
pub const DXGI_DDI_ERR_WASSTILLDRAWING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887B0001u32 as _);
pub const DXGI_STATUS_CLIPPED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87A0002u32 as _);
pub const DXGI_STATUS_DDA_WAS_STILL_DRAWING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87A000Au32 as _);
pub const DXGI_STATUS_GRAPHICS_VIDPN_SOURCE_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87A0006u32 as _);
pub const DXGI_STATUS_MODE_CHANGED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87A0007u32 as _);
pub const DXGI_STATUS_MODE_CHANGE_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87A0008u32 as _);
pub const DXGI_STATUS_NO_DESKTOP_ACCESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87A0005u32 as _);
pub const DXGI_STATUS_NO_REDIRECTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87A0004u32 as _);
pub const DXGI_STATUS_OCCLUDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87A0001u32 as _);
pub const DXGI_STATUS_PRESENT_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87A002Fu32 as _);
pub const DXGI_STATUS_UNOCCLUDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87A0009u32 as _);
pub const EAS_E_ADMINS_CANNOT_CHANGE_PASSWORD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80550008u32 as _);
pub const EAS_E_ADMINS_HAVE_BLANK_PASSWORD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80550007u32 as _);
pub const EAS_E_CONNECTED_ADMINS_NEED_TO_CHANGE_PASSWORD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8055000Bu32 as _);
pub const EAS_E_CURRENT_CONNECTED_USER_NEED_TO_CHANGE_PASSWORD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8055000Du32 as _);
pub const EAS_E_CURRENT_USER_HAS_BLANK_PASSWORD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80550004u32 as _);
pub const EAS_E_LOCAL_CONTROLLED_USERS_CANNOT_CHANGE_PASSWORD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80550009u32 as _);
pub const EAS_E_PASSWORD_POLICY_NOT_ENFORCEABLE_FOR_CONNECTED_ADMINS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8055000Au32 as _);
pub const EAS_E_PASSWORD_POLICY_NOT_ENFORCEABLE_FOR_CURRENT_CONNECTED_USER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8055000Cu32 as _);
pub const EAS_E_POLICY_COMPLIANT_WITH_ACTIONS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80550002u32 as _);
pub const EAS_E_POLICY_NOT_MANAGED_BY_OS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80550001u32 as _);
pub const EAS_E_REQUESTED_POLICY_NOT_ENFORCEABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80550003u32 as _);
pub const EAS_E_REQUESTED_POLICY_PASSWORD_EXPIRATION_INCOMPATIBLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80550005u32 as _);
pub const EAS_E_USER_CANNOT_CHANGE_PASSWORD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80550006u32 as _);
...
pub const ERROR_ALL_SIDS_FILTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0090002u32 as _);
...
pub const ERROR_ATTRIBUTE_NOT_PRESENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8083000Au32 as _);
pub const ERROR_AUDITING_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0090001u32 as _);
...
pub const ERROR_BIZRULES_NOT_ENABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0090003u32 as _);
...
pub const ERROR_CLIP_DEVICE_LICENSE_MISSING: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0EA0003u32 as _);
pub const ERROR_CLIP_KEYHOLDER_LICENSE_MISSING_OR_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0EA0005u32 as _);
pub const ERROR_CLIP_LICENSE_DEVICE_ID_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0EA000Au32 as _);
pub const ERROR_CLIP_LICENSE_EXPIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0EA0006u32 as _);
pub const ERROR_CLIP_LICENSE_HARDWARE_ID_OUT_OF_TOLERANCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0EA0009u32 as _);
pub const ERROR_CLIP_LICENSE_INVALID_SIGNATURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0EA0004u32 as _);
pub const ERROR_CLIP_LICENSE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0EA0002u32 as _);
pub const ERROR_CLIP_LICENSE_NOT_SIGNED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0EA0008u32 as _);
pub const ERROR_CLIP_LICENSE_SIGNED_BY_UNKNOWN_SOURCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0EA0007u32 as _);
...
pub const ERROR_CRED_REQUIRES_CONFIRMATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097019u32 as _);
...
pub const ERROR_DBG_ATTACH_PROCESS_FAILURE_LOCKDOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80B00002u32 as _);
pub const ERROR_DBG_COMMAND_EXCEPTION: WIN32_ERROR = WIN32_ERROR(697u32);
pub const ERROR_DBG_CONNECT_SERVER_FAILURE_LOCKDOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80B00003u32 as _);
...
pub const ERROR_DBG_CREATE_PROCESS_FAILURE_LOCKDOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80B00001u32 as _);
...
pub const ERROR_DBG_START_SERVER_FAILURE_LOCKDOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80B00004u32 as _);
...
pub const ERROR_DM_OPERATION_LIMIT_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0370600u32 as _);
...
pub const ERROR_FLT_ALREADY_ENLISTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F001Bu32 as _);
pub const ERROR_FLT_CBDQ_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F000Eu32 as _);
pub const ERROR_FLT_CONTEXT_ALLOCATION_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0016u32 as _);
pub const ERROR_FLT_CONTEXT_ALREADY_DEFINED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0002u32 as _);
pub const ERROR_FLT_CONTEXT_ALREADY_LINKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F001Cu32 as _);
pub const ERROR_FLT_DELETING_OBJECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F000Bu32 as _);
pub const ERROR_FLT_DISALLOW_FAST_IO: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0004u32 as _);
pub const ERROR_FLT_DO_NOT_ATTACH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F000Fu32 as _);
pub const ERROR_FLT_DO_NOT_DETACH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0010u32 as _);
pub const ERROR_FLT_DUPLICATE_ENTRY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F000Du32 as _);
pub const ERROR_FLT_FILTER_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0013u32 as _);
pub const ERROR_FLT_FILTER_NOT_READY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0008u32 as _);
pub const ERROR_FLT_INSTANCE_ALTITUDE_COLLISION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0011u32 as _);
pub const ERROR_FLT_INSTANCE_NAME_COLLISION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0012u32 as _);
pub const ERROR_FLT_INSTANCE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0015u32 as _);
pub const ERROR_FLT_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F000Au32 as _);
pub const ERROR_FLT_INVALID_ASYNCHRONOUS_REQUEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0003u32 as _);
pub const ERROR_FLT_INVALID_CONTEXT_REGISTRATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0017u32 as _);
pub const ERROR_FLT_INVALID_NAME_REQUEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0005u32 as _);
pub const ERROR_FLT_IO_COMPLETE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x1F0001u32 as _);
pub const ERROR_FLT_MUST_BE_NONPAGED_POOL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F000Cu32 as _);
pub const ERROR_FLT_NAME_CACHE_MISS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0018u32 as _);
pub const ERROR_FLT_NOT_INITIALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0007u32 as _);
pub const ERROR_FLT_NOT_SAFE_TO_POST_OPERATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0006u32 as _);
pub const ERROR_FLT_NO_DEVICE_OBJECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0019u32 as _);
pub const ERROR_FLT_NO_HANDLER_DEFINED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0001u32 as _);
pub const ERROR_FLT_NO_WAITER_FOR_REPLY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0020u32 as _);
pub const ERROR_FLT_POST_OPERATION_CLEANUP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0009u32 as _);
pub const ERROR_FLT_REGISTRATION_BUSY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0023u32 as _);
pub const ERROR_FLT_VOLUME_ALREADY_MOUNTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F001Au32 as _);
pub const ERROR_FLT_VOLUME_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0014u32 as _);
pub const ERROR_FLT_WCOS_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801F0024u32 as _);
...
pub const ERROR_GRAPHICS_ADAPTER_ACCESS_NOT_EXCLUDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026243Bu32 as _);
pub const ERROR_GRAPHICS_ADAPTER_CHAIN_NOT_READY: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262433u32 as _);
pub const ERROR_GRAPHICS_ADAPTER_MUST_HAVE_AT_LEAST_ONE_SOURCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262328u32 as _);
pub const ERROR_GRAPHICS_ADAPTER_MUST_HAVE_AT_LEAST_ONE_TARGET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262329u32 as _);
pub const ERROR_GRAPHICS_ADAPTER_WAS_RESET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262003u32 as _);
pub const ERROR_GRAPHICS_ALLOCATION_BUSY: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262102u32 as _);
pub const ERROR_GRAPHICS_ALLOCATION_CLOSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262112u32 as _);
pub const ERROR_GRAPHICS_ALLOCATION_CONTENT_LOST: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262116u32 as _);
pub const ERROR_GRAPHICS_ALLOCATION_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262106u32 as _);
pub const ERROR_GRAPHICS_CANCEL_VIDPN_TOPOLOGY_AUGMENTATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026235Au32 as _);
pub const ERROR_GRAPHICS_CANNOTCOLORCONVERT: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262008u32 as _);
pub const ERROR_GRAPHICS_CANT_ACCESS_ACTIVE_VIDPN: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262343u32 as _);
pub const ERROR_GRAPHICS_CANT_EVICT_PINNED_ALLOCATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262109u32 as _);
pub const ERROR_GRAPHICS_CANT_LOCK_MEMORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262101u32 as _);
pub const ERROR_GRAPHICS_CANT_RENDER_LOCKED_ALLOCATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262111u32 as _);
pub const ERROR_GRAPHICS_CHAINLINKS_NOT_ENUMERATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262432u32 as _);
pub const ERROR_GRAPHICS_CHAINLINKS_NOT_POWERED_ON: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262435u32 as _);
pub const ERROR_GRAPHICS_CHAINLINKS_NOT_STARTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262434u32 as _);
pub const ERROR_GRAPHICS_CHILD_DESCRIPTOR_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262401u32 as _);
pub const ERROR_GRAPHICS_CLIENTVIDPN_NOT_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026235Cu32 as _);
pub const ERROR_GRAPHICS_COPP_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262501u32 as _);
pub const ERROR_GRAPHICS_DATASET_IS_EMPTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x26234Bu32 as _);
pub const ERROR_GRAPHICS_DDCCI_CURRENT_CURRENT_VALUE_GREATER_THAN_MAXIMUM_VALUE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC02625D8u32 as _);
pub const ERROR_GRAPHICS_DDCCI_INVALID_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262585u32 as _);
pub const ERROR_GRAPHICS_DDCCI_INVALID_MESSAGE_CHECKSUM: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026258Bu32 as _);
pub const ERROR_GRAPHICS_DDCCI_INVALID_MESSAGE_COMMAND: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262589u32 as _);
pub const ERROR_GRAPHICS_DDCCI_INVALID_MESSAGE_LENGTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026258Au32 as _);
pub const ERROR_GRAPHICS_DDCCI_MONITOR_RETURNED_INVALID_TIMING_STATUS_BYTE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262586u32 as _);
pub const ERROR_GRAPHICS_DDCCI_VCP_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262584u32 as _);
pub const ERROR_GRAPHICS_DEPENDABLE_CHILD_STATUS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4026243Cu32 as _);
pub const ERROR_GRAPHICS_DISPLAY_DEVICE_NOT_ATTACHED_TO_DESKTOP: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC02625E2u32 as _);
pub const ERROR_GRAPHICS_DRIVER_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262009u32 as _);
pub const ERROR_GRAPHICS_EMPTY_ADAPTER_MONITOR_MODE_SUPPORT_INTERSECTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262325u32 as _);
pub const ERROR_GRAPHICS_FREQUENCYRANGE_ALREADY_IN_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026231Fu32 as _);
pub const ERROR_GRAPHICS_FREQUENCYRANGE_NOT_IN_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026231Du32 as _);
pub const ERROR_GRAPHICS_GAMMA_RAMP_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262348u32 as _);
pub const ERROR_GRAPHICS_GPU_EXCEPTION_ON_DEVICE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262200u32 as _);
pub const ERROR_GRAPHICS_I2C_DEVICE_DOES_NOT_EXIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262581u32 as _);
pub const ERROR_GRAPHICS_I2C_ERROR_RECEIVING_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262583u32 as _);
pub const ERROR_GRAPHICS_I2C_ERROR_TRANSMITTING_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262582u32 as _);
pub const ERROR_GRAPHICS_I2C_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262580u32 as _);
pub const ERROR_GRAPHICS_INCOMPATIBLE_PRIVATE_FORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262355u32 as _);
pub const ERROR_GRAPHICS_INCONSISTENT_DEVICE_LINK_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262436u32 as _);
pub const ERROR_GRAPHICS_INDIRECT_DISPLAY_ABANDON_SWAPCHAIN: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262012u32 as _);
pub const ERROR_GRAPHICS_INDIRECT_DISPLAY_DEVICE_STOPPED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262013u32 as _);
pub const ERROR_GRAPHICS_INSUFFICIENT_DMA_BUFFER: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262001u32 as _);
pub const ERROR_GRAPHICS_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC02625E7u32 as _);
pub const ERROR_GRAPHICS_INVALID_ACTIVE_REGION: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026230Bu32 as _);
pub const ERROR_GRAPHICS_INVALID_ALLOCATION_HANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262114u32 as _);
pub const ERROR_GRAPHICS_INVALID_ALLOCATION_INSTANCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262113u32 as _);
pub const ERROR_GRAPHICS_INVALID_ALLOCATION_USAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262110u32 as _);
pub const ERROR_GRAPHICS_INVALID_CLIENT_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026235Bu32 as _);
pub const ERROR_GRAPHICS_INVALID_COLORBASIS: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026233Eu32 as _);
pub const ERROR_GRAPHICS_INVALID_COPYPROTECTION_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026234Fu32 as _);
pub const ERROR_GRAPHICS_INVALID_DISPLAY_ADAPTER: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262002u32 as _);
pub const ERROR_GRAPHICS_INVALID_DRIVER_MODEL: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262004u32 as _);
pub const ERROR_GRAPHICS_INVALID_FREQUENCY: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026230Au32 as _);
pub const ERROR_GRAPHICS_INVALID_GAMMA_RAMP: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262347u32 as _);
pub const ERROR_GRAPHICS_INVALID_MODE_PRUNING_ALGORITHM: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262356u32 as _);
pub const ERROR_GRAPHICS_INVALID_MONITORDESCRIPTOR: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026232Bu32 as _);
pub const ERROR_GRAPHICS_INVALID_MONITORDESCRIPTORSET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026232Au32 as _);
pub const ERROR_GRAPHICS_INVALID_MONITOR_CAPABILITY_ORIGIN: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262357u32 as _);
pub const ERROR_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026231Cu32 as _);
pub const ERROR_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGESET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026231Bu32 as _);
pub const ERROR_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGE_CONSTRAINT: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262358u32 as _);
pub const ERROR_GRAPHICS_INVALID_MONITOR_SOURCEMODESET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262321u32 as _);
pub const ERROR_GRAPHICS_INVALID_MONITOR_SOURCE_MODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262322u32 as _);
pub const ERROR_GRAPHICS_INVALID_PATH_CONTENT_GEOMETRY_TRANSFORMATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262345u32 as _);
pub const ERROR_GRAPHICS_INVALID_PATH_CONTENT_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026234Eu32 as _);
pub const ERROR_GRAPHICS_INVALID_PATH_IMPORTANCE_ORDINAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262344u32 as _);
pub const ERROR_GRAPHICS_INVALID_PHYSICAL_MONITOR_HANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026258Cu32 as _);
pub const ERROR_GRAPHICS_INVALID_PIXELFORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026233Du32 as _);
pub const ERROR_GRAPHICS_INVALID_PIXELVALUEACCESSMODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026233Fu32 as _);
pub const ERROR_GRAPHICS_INVALID_POINTER: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC02625E4u32 as _);
pub const ERROR_GRAPHICS_INVALID_PRIMARYSURFACE_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026233Au32 as _);
pub const ERROR_GRAPHICS_INVALID_SCANLINE_ORDERING: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262352u32 as _);
pub const ERROR_GRAPHICS_INVALID_STRIDE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026233Cu32 as _);
pub const ERROR_GRAPHICS_INVALID_TOTAL_REGION: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026230Cu32 as _);
pub const ERROR_GRAPHICS_INVALID_VIDEOPRESENTSOURCESET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262315u32 as _);
pub const ERROR_GRAPHICS_INVALID_VIDEOPRESENTTARGETSET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262316u32 as _);
pub const ERROR_GRAPHICS_INVALID_VIDEO_PRESENT_SOURCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262304u32 as _);
pub const ERROR_GRAPHICS_INVALID_VIDEO_PRESENT_SOURCE_MODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262310u32 as _);
pub const ERROR_GRAPHICS_INVALID_VIDEO_PRESENT_TARGET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262305u32 as _);
pub const ERROR_GRAPHICS_INVALID_VIDEO_PRESENT_TARGET_MODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262311u32 as _);
pub const ERROR_GRAPHICS_INVALID_VIDPN: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262303u32 as _);
pub const ERROR_GRAPHICS_INVALID_VIDPN_PRESENT_PATH: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262319u32 as _);
pub const ERROR_GRAPHICS_INVALID_VIDPN_SOURCEMODESET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262308u32 as _);
pub const ERROR_GRAPHICS_INVALID_VIDPN_TARGETMODESET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262309u32 as _);
pub const ERROR_GRAPHICS_INVALID_VIDPN_TARGET_SUBSET_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026232Fu32 as _);
pub const ERROR_GRAPHICS_INVALID_VIDPN_TOPOLOGY: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262300u32 as _);
pub const ERROR_GRAPHICS_INVALID_VIDPN_TOPOLOGY_RECOMMENDATION_REASON: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026234Du32 as _);
pub const ERROR_GRAPHICS_INVALID_VISIBLEREGION_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026233Bu32 as _);
pub const ERROR_GRAPHICS_LEADLINK_NOT_ENUMERATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262431u32 as _);
pub const ERROR_GRAPHICS_LEADLINK_START_DEFERRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40262437u32 as _);
pub const ERROR_GRAPHICS_LINK_CONFIGURATION_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262017u32 as _);
pub const ERROR_GRAPHICS_MAX_NUM_PATHS_REACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262359u32 as _);
pub const ERROR_GRAPHICS_MCA_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262588u32 as _);
pub const ERROR_GRAPHICS_MCA_INVALID_CAPABILITIES_STRING: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262587u32 as _);
pub const ERROR_GRAPHICS_MCA_INVALID_TECHNOLOGY_TYPE_RETURNED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC02625DEu32 as _);
pub const ERROR_GRAPHICS_MCA_INVALID_VCP_VERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC02625D9u32 as _);
pub const ERROR_GRAPHICS_MCA_MCCS_VERSION_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC02625DBu32 as _);
pub const ERROR_GRAPHICS_MCA_MONITOR_VIOLATES_MCCS_SPECIFICATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC02625DAu32 as _);
pub const ERROR_GRAPHICS_MCA_UNSUPPORTED_COLOR_TEMPERATURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC02625DFu32 as _);
pub const ERROR_GRAPHICS_MCA_UNSUPPORTED_MCCS_VERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC02625DCu32 as _);
pub const ERROR_GRAPHICS_MIRRORING_DEVICES_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC02625E3u32 as _);
pub const ERROR_GRAPHICS_MODE_ALREADY_IN_MODESET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262314u32 as _);
pub const ERROR_GRAPHICS_MODE_ID_MUST_BE_UNIQUE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262324u32 as _);
pub const ERROR_GRAPHICS_MODE_NOT_IN_MODESET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026234Au32 as _);
pub const ERROR_GRAPHICS_MODE_NOT_PINNED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x262307u32 as _);
pub const ERROR_GRAPHICS_MONITORDESCRIPTOR_ALREADY_IN_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026232Du32 as _);
pub const ERROR_GRAPHICS_MONITORDESCRIPTOR_ID_MUST_BE_UNIQUE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026232Eu32 as _);
pub const ERROR_GRAPHICS_MONITORDESCRIPTOR_NOT_IN_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026232Cu32 as _);
pub const ERROR_GRAPHICS_MONITOR_COULD_NOT_BE_ASSOCIATED_WITH_ADAPTER: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262334u32 as _);
pub const ERROR_GRAPHICS_MONITOR_NOT_CONNECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262338u32 as _);
pub const ERROR_GRAPHICS_MONITOR_NO_LONGER_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026258Du32 as _);
pub const ERROR_GRAPHICS_MPO_ALLOCATION_UNPINNED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262018u32 as _);
pub const ERROR_GRAPHICS_MULTISAMPLING_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262349u32 as _);
pub const ERROR_GRAPHICS_NOT_A_LINKED_ADAPTER: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262430u32 as _);
pub const ERROR_GRAPHICS_NOT_EXCLUSIVE_MODE_OWNER: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262000u32 as _);
pub const ERROR_GRAPHICS_NOT_POST_DEVICE_DRIVER: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262438u32 as _);
pub const ERROR_GRAPHICS_NO_ACTIVE_VIDPN: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262336u32 as _);
pub const ERROR_GRAPHICS_NO_AVAILABLE_IMPORTANCE_ORDINALS: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262354u32 as _);
pub const ERROR_GRAPHICS_NO_AVAILABLE_VIDPN_TARGET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262333u32 as _);
pub const ERROR_GRAPHICS_NO_DISPLAY_DEVICE_CORRESPONDS_TO_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC02625E1u32 as _);
pub const ERROR_GRAPHICS_NO_DISPLAY_MODE_MANAGEMENT_SUPPORT: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262341u32 as _);
pub const ERROR_GRAPHICS_NO_MONITORS_CORRESPOND_TO_DISPLAY_DEVICE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC02625E5u32 as _);
pub const ERROR_GRAPHICS_NO_MORE_ELEMENTS_IN_DATASET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x26234Cu32 as _);
pub const ERROR_GRAPHICS_NO_PREFERRED_MODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x26231Eu32 as _);
pub const ERROR_GRAPHICS_NO_RECOMMENDED_FUNCTIONAL_VIDPN: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262323u32 as _);
pub const ERROR_GRAPHICS_NO_RECOMMENDED_VIDPN_TOPOLOGY: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026231Au32 as _);
pub const ERROR_GRAPHICS_NO_VIDEO_MEMORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262100u32 as _);
pub const ERROR_GRAPHICS_NO_VIDPNMGR: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262335u32 as _);
pub const ERROR_GRAPHICS_ONLY_CONSOLE_SESSION_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC02625E0u32 as _);
pub const ERROR_GRAPHICS_OPM_ALL_HDCP_HARDWARE_ALREADY_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262518u32 as _);
pub const ERROR_GRAPHICS_OPM_DRIVER_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026251Eu32 as _);
pub const ERROR_GRAPHICS_OPM_HDCP_SRM_NEVER_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262516u32 as _);
pub const ERROR_GRAPHICS_OPM_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026250Bu32 as _);
pub const ERROR_GRAPHICS_OPM_INVALID_CONFIGURATION_REQUEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262521u32 as _);
pub const ERROR_GRAPHICS_OPM_INVALID_ENCRYPTED_PARAMETERS: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262503u32 as _);
pub const ERROR_GRAPHICS_OPM_INVALID_HANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026250Cu32 as _);
pub const ERROR_GRAPHICS_OPM_INVALID_INFORMATION_REQUEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026251Du32 as _);
pub const ERROR_GRAPHICS_OPM_INVALID_SRM: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262512u32 as _);
pub const ERROR_GRAPHICS_OPM_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262500u32 as _);
pub const ERROR_GRAPHICS_OPM_NO_VIDEO_OUTPUTS_EXIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262505u32 as _);
pub const ERROR_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_ACP: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262514u32 as _);
pub const ERROR_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_CGMSA: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262515u32 as _);
pub const ERROR_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_HDCP: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262513u32 as _);
pub const ERROR_GRAPHICS_OPM_RESOLUTION_TOO_HIGH: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262517u32 as _);
pub const ERROR_GRAPHICS_OPM_SESSION_TYPE_CHANGE_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026251Bu32 as _);
pub const ERROR_GRAPHICS_OPM_SIGNALING_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262520u32 as _);
pub const ERROR_GRAPHICS_OPM_SPANNING_MODE_ENABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026250Fu32 as _);
pub const ERROR_GRAPHICS_OPM_THEATER_MODE_ENABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262510u32 as _);
pub const ERROR_GRAPHICS_OPM_VIDEO_OUTPUT_DOES_NOT_HAVE_COPP_SEMANTICS: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026251Cu32 as _);
pub const ERROR_GRAPHICS_OPM_VIDEO_OUTPUT_DOES_NOT_HAVE_OPM_SEMANTICS: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026251Fu32 as _);
pub const ERROR_GRAPHICS_OPM_VIDEO_OUTPUT_NO_LONGER_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026251Au32 as _);
pub const ERROR_GRAPHICS_PARAMETER_ARRAY_TOO_SMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC02625E6u32 as _);
pub const ERROR_GRAPHICS_PARTIAL_DATA_POPULATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4026200Au32 as _);
pub const ERROR_GRAPHICS_PATH_ALREADY_IN_TOPOLOGY: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262313u32 as _);
pub const ERROR_GRAPHICS_PATH_CONTENT_GEOMETRY_TRANSFORMATION_NOT_PINNED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x262351u32 as _);
pub const ERROR_GRAPHICS_PATH_CONTENT_GEOMETRY_TRANSFORMATION_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262346u32 as _);
pub const ERROR_GRAPHICS_PATH_NOT_IN_TOPOLOGY: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262327u32 as _);
pub const ERROR_GRAPHICS_PINNED_MODE_MUST_REMAIN_IN_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262312u32 as _);
pub const ERROR_GRAPHICS_POLLING_TOO_FREQUENTLY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40262439u32 as _);
pub const ERROR_GRAPHICS_PRESENT_BUFFER_NOT_BOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262010u32 as _);
pub const ERROR_GRAPHICS_PRESENT_DENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262007u32 as _);
pub const ERROR_GRAPHICS_PRESENT_INVALID_WINDOW: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026200Fu32 as _);
pub const ERROR_GRAPHICS_PRESENT_MODE_CHANGED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262005u32 as _);
pub const ERROR_GRAPHICS_PRESENT_OCCLUDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262006u32 as _);
pub const ERROR_GRAPHICS_PRESENT_REDIRECTION_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026200Bu32 as _);
pub const ERROR_GRAPHICS_PRESENT_UNOCCLUDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026200Cu32 as _);
pub const ERROR_GRAPHICS_PVP_HFS_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262511u32 as _);
pub const ERROR_GRAPHICS_PVP_INVALID_CERTIFICATE_LENGTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026250Eu32 as _);
pub const ERROR_GRAPHICS_RESOURCES_NOT_RELATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262330u32 as _);
pub const ERROR_GRAPHICS_SESSION_TYPE_CHANGE_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC02605E8u32 as _);
pub const ERROR_GRAPHICS_SKIP_ALLOCATION_PREPARATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40262201u32 as _);
pub const ERROR_GRAPHICS_SOURCE_ALREADY_IN_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262317u32 as _);
pub const ERROR_GRAPHICS_SOURCE_ID_MUST_BE_UNIQUE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262331u32 as _);
pub const ERROR_GRAPHICS_SOURCE_NOT_IN_TOPOLOGY: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262339u32 as _);
pub const ERROR_GRAPHICS_SPECIFIED_CHILD_ALREADY_CONNECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262400u32 as _);
pub const ERROR_GRAPHICS_STALE_MODESET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262320u32 as _);
pub const ERROR_GRAPHICS_STALE_VIDPN_TOPOLOGY: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262337u32 as _);
pub const ERROR_GRAPHICS_START_DEFERRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4026243Au32 as _);
pub const ERROR_GRAPHICS_TARGET_ALREADY_IN_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262318u32 as _);
pub const ERROR_GRAPHICS_TARGET_ID_MUST_BE_UNIQUE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262332u32 as _);
pub const ERROR_GRAPHICS_TARGET_NOT_IN_TOPOLOGY: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262340u32 as _);
pub const ERROR_GRAPHICS_TOO_MANY_REFERENCES: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262103u32 as _);
pub const ERROR_GRAPHICS_TOPOLOGY_CHANGES_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262353u32 as _);
pub const ERROR_GRAPHICS_TRY_AGAIN_LATER: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262104u32 as _);
pub const ERROR_GRAPHICS_TRY_AGAIN_NOW: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262105u32 as _);
pub const ERROR_GRAPHICS_UAB_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262502u32 as _);
pub const ERROR_GRAPHICS_UNASSIGNED_MODESET_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262350u32 as _);
pub const ERROR_GRAPHICS_UNKNOWN_CHILD_STATUS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4026242Fu32 as _);
pub const ERROR_GRAPHICS_UNSWIZZLING_APERTURE_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262107u32 as _);
pub const ERROR_GRAPHICS_UNSWIZZLING_APERTURE_UNSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262108u32 as _);
pub const ERROR_GRAPHICS_VAIL_FAILED_TO_SEND_COMPOSITION_WINDOW_DPI_MESSAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262016u32 as _);
pub const ERROR_GRAPHICS_VAIL_FAILED_TO_SEND_CREATE_SUPERWETINK_MESSAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262014u32 as _);
pub const ERROR_GRAPHICS_VAIL_FAILED_TO_SEND_DESTROY_SUPERWETINK_MESSAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262015u32 as _);
pub const ERROR_GRAPHICS_VAIL_STATE_CHANGED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262011u32 as _);
pub const ERROR_GRAPHICS_VIDEO_PRESENT_TARGETS_LESS_THAN_SOURCES: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262326u32 as _);
pub const ERROR_GRAPHICS_VIDPN_MODALITY_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262306u32 as _);
pub const ERROR_GRAPHICS_VIDPN_SOURCE_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262342u32 as _);
pub const ERROR_GRAPHICS_VIDPN_TOPOLOGY_CURRENTLY_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262302u32 as _);
pub const ERROR_GRAPHICS_VIDPN_TOPOLOGY_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262301u32 as _);
pub const ERROR_GRAPHICS_WINDOWDC_NOT_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026200Du32 as _);
pub const ERROR_GRAPHICS_WINDOWLESS_PRESENT_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026200Eu32 as _);
pub const ERROR_GRAPHICS_WRONG_ALLOCATION_DEVICE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0262115u32 as _);
...
pub const ERROR_HUNG_DISPLAY_DRIVER_THREAD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80260001u32 as _);
...
pub const ERROR_IO_PREEMPTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x89010001u32 as _);
...
pub const ERROR_MONITOR_INVALID_DESCRIPTOR_CHECKSUM: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0261003u32 as _);
pub const ERROR_MONITOR_INVALID_DETAILED_TIMING_BLOCK: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0261009u32 as _);
pub const ERROR_MONITOR_INVALID_MANUFACTURE_DATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC026100Au32 as _);
pub const ERROR_MONITOR_INVALID_SERIAL_NUMBER_MONDSC_BLOCK: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0261006u32 as _);
pub const ERROR_MONITOR_INVALID_STANDARD_TIMING_BLOCK: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0261004u32 as _);
pub const ERROR_MONITOR_INVALID_USER_FRIENDLY_MONDSC_BLOCK: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0261007u32 as _);
pub const ERROR_MONITOR_NO_DESCRIPTOR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x261001u32 as _);
pub const ERROR_MONITOR_NO_MORE_DESCRIPTOR_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0261008u32 as _);
pub const ERROR_MONITOR_UNKNOWN_DESCRIPTOR_FORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x261002u32 as _);
pub const ERROR_MONITOR_WMI_DATABLOCK_REGISTRATION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0261005u32 as _);
...
pub const ERROR_NOT_A_TIERED_VOLUME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80830009u32 as _);
...
pub const ERROR_NO_APPLICABLE_APP_LICENSES_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0EA0001u32 as _);
...
pub const ERROR_QUIC_ALPN_NEG_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80410007u32 as _);
pub const ERROR_QUIC_CONNECTION_IDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80410005u32 as _);
pub const ERROR_QUIC_CONNECTION_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80410006u32 as _);
pub const ERROR_QUIC_HANDSHAKE_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80410000u32 as _);
pub const ERROR_QUIC_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80410003u32 as _);
pub const ERROR_QUIC_PROTOCOL_VIOLATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80410004u32 as _);
pub const ERROR_QUIC_USER_CANCELED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80410002u32 as _);
pub const ERROR_QUIC_VER_NEG_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80410001u32 as _);
...
pub const ERROR_SECCORE_INVALID_COMMAND: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0E80000u32 as _);
...
pub const ERROR_SMB_BAD_CLUSTER_DIALECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC05D0001u32 as _);
pub const ERROR_SMB_GUEST_LOGON_BLOCKED: WIN32_ERROR = WIN32_ERROR(1272u32);
pub const ERROR_SMB_NO_PREAUTH_INTEGRITY_HASH_OVERLAP: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC05D0000u32 as _);
pub const ERROR_SMB_NO_SIGNING_ALGORITHM_OVERLAP: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC05D0002u32 as _);
...
pub const ERROR_SPACES_ALLOCATION_SIZE_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E7000Eu32 as _);
pub const ERROR_SPACES_CACHE_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70026u32 as _);
pub const ERROR_SPACES_CORRUPT_METADATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70018u32 as _);
pub const ERROR_SPACES_DRIVE_LOST_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E7001Fu32 as _);
pub const ERROR_SPACES_DRIVE_NOT_READY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E7001Du32 as _);
pub const ERROR_SPACES_DRIVE_OPERATIONAL_STATE_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70012u32 as _);
pub const ERROR_SPACES_DRIVE_REDUNDANCY_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70006u32 as _);
pub const ERROR_SPACES_DRIVE_SECTOR_SIZE_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70004u32 as _);
pub const ERROR_SPACES_DRIVE_SPLIT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E7001Eu32 as _);
pub const ERROR_SPACES_DRT_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70019u32 as _);
pub const ERROR_SPACES_ENCLOSURE_AWARE_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E7000Fu32 as _);
pub const ERROR_SPACES_ENTRY_INCOMPLETE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70013u32 as _);
pub const ERROR_SPACES_ENTRY_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70014u32 as _);
pub const ERROR_SPACES_EXTENDED_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E7000Cu32 as _);
pub const ERROR_SPACES_FAULT_DOMAIN_TYPE_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70001u32 as _);
pub const ERROR_SPACES_FLUSH_METADATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70025u32 as _);
pub const ERROR_SPACES_INCONSISTENCY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E7001Au32 as _);
pub const ERROR_SPACES_INTERLEAVE_LENGTH_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70009u32 as _);
pub const ERROR_SPACES_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70002u32 as _);
pub const ERROR_SPACES_LOG_NOT_READY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E7001Bu32 as _);
pub const ERROR_SPACES_MAP_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70016u32 as _);
pub const ERROR_SPACES_MARK_DIRTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70020u32 as _);
pub const ERROR_SPACES_NOT_ENOUGH_DRIVES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E7000Bu32 as _);
pub const ERROR_SPACES_NO_REDUNDANCY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E7001Cu32 as _);
pub const ERROR_SPACES_NUMBER_OF_COLUMNS_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E7000Au32 as _);
pub const ERROR_SPACES_NUMBER_OF_DATA_COPIES_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70007u32 as _);
pub const ERROR_SPACES_NUMBER_OF_GROUPS_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70011u32 as _);
pub const ERROR_SPACES_PARITY_LAYOUT_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70008u32 as _);
pub const ERROR_SPACES_POOL_WAS_DELETED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xE70001u32 as _);
pub const ERROR_SPACES_PROVISIONING_TYPE_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E7000Du32 as _);
pub const ERROR_SPACES_REPAIR_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70027u32 as _);
pub const ERROR_SPACES_RESILIENCY_TYPE_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70003u32 as _);
pub const ERROR_SPACES_UNSUPPORTED_VERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70017u32 as _);
pub const ERROR_SPACES_UPDATE_COLUMN_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70015u32 as _);
pub const ERROR_SPACES_WRITE_CACHE_SIZE_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80E70010u32 as _);
...
pub const ERROR_SVHDX_ERROR_NOT_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC05CFF00u32 as _);
pub const ERROR_SVHDX_ERROR_STORED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC05C0000u32 as _);
pub const ERROR_SVHDX_NO_INITIATOR: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC05CFF0Bu32 as _);
pub const ERROR_SVHDX_RESERVATION_CONFLICT: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC05CFF07u32 as _);
pub const ERROR_SVHDX_UNIT_ATTENTION_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC05CFF01u32 as _);
pub const ERROR_SVHDX_UNIT_ATTENTION_CAPACITY_DATA_CHANGED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC05CFF02u32 as _);
pub const ERROR_SVHDX_UNIT_ATTENTION_OPERATING_DEFINITION_CHANGED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC05CFF06u32 as _);
pub const ERROR_SVHDX_UNIT_ATTENTION_REGISTRATIONS_PREEMPTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC05CFF05u32 as _);
pub const ERROR_SVHDX_UNIT_ATTENTION_RESERVATIONS_PREEMPTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC05CFF03u32 as _);
pub const ERROR_SVHDX_UNIT_ATTENTION_RESERVATIONS_RELEASED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC05CFF04u32 as _);
pub const ERROR_SVHDX_VERSION_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC05CFF09u32 as _);
pub const ERROR_SVHDX_WRONG_FILE_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC05CFF08u32 as _);
...
pub const ERROR_TIERING_ALREADY_PROCESSING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80830006u32 as _);
pub const ERROR_TIERING_CANNOT_PIN_OBJECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80830007u32 as _);
pub const ERROR_TIERING_FILE_IS_NOT_PINNED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80830008u32 as _);
pub const ERROR_TIERING_INVALID_FILE_ID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80830004u32 as _);
pub const ERROR_TIERING_NOT_SUPPORTED_ON_VOLUME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80830001u32 as _);
pub const ERROR_TIERING_STORAGE_TIER_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80830003u32 as _);
pub const ERROR_TIERING_VOLUME_DISMOUNT_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80830002u32 as _);
pub const ERROR_TIERING_WRONG_CLUSTER_NODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80830005u32 as _);
...
pub const ERROR_VHDSET_BACKING_STORAGE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC05CFF0Cu32 as _);
...
pub const ERROR_VHD_SHARED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC05CFF0Au32 as _);
...
pub const ERROR_VOLSNAP_ACTIVATION_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80820002u32 as _);
pub const ERROR_VOLSNAP_BOOTFILE_NOT_VALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80820001u32 as _);
pub const ERROR_VOLSNAP_HIBERNATE_READY: WIN32_ERROR = WIN32_ERROR(761u32);
pub const ERROR_VOLSNAP_NO_BYPASSIO_WITH_SNAPSHOT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80820003u32 as _);
...
pub const EVENT_E_ALL_SUBSCRIBERS_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040201u32 as _);
pub const EVENT_E_CANT_MODIFY_OR_DELETE_CONFIGURED_OBJECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004020Eu32 as _);
pub const EVENT_E_CANT_MODIFY_OR_DELETE_UNCONFIGURED_OBJECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004020Du32 as _);
pub const EVENT_E_COMPLUS_NOT_INSTALLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004020Cu32 as _);
pub const EVENT_E_FIRST: i32 = -2147220992i32;
pub const EVENT_E_INTERNALERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040206u32 as _);
pub const EVENT_E_INTERNALEXCEPTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040205u32 as _);
pub const EVENT_E_INVALID_EVENT_CLASS_PARTITION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004020Fu32 as _);
pub const EVENT_E_INVALID_PER_USER_SID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040207u32 as _);
pub const EVENT_E_LAST: i32 = -2147220961i32;
pub const EVENT_E_MISSING_EVENTCLASS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004020Au32 as _);
pub const EVENT_E_NOT_ALL_REMOVED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004020Bu32 as _);
pub const EVENT_E_PER_USER_SID_NOT_LOGGED_ON: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040210u32 as _);
pub const EVENT_E_QUERYFIELD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040204u32 as _);
pub const EVENT_E_QUERYSYNTAX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040203u32 as _);
pub const EVENT_E_TOO_MANY_METHODS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040209u32 as _);
pub const EVENT_E_USER_EXCEPTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040208u32 as _);
pub const EVENT_S_FIRST: i32 = 262656i32;
pub const EVENT_S_LAST: i32 = 262687i32;
pub const EVENT_S_NOSUBSCRIBERS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40202u32 as _);
pub const EVENT_S_SOME_SUBSCRIBERS_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40200u32 as _);
...
pub const EXCEPTION_SPAPI_UNRECOVERABLE_STACK_OVERFLOW: NTSTATUS = NTSTATUS(-536870144i32);
pub const EXCEPTION_STACK_OVERFLOW: NTSTATUS = NTSTATUS(-1073741571i32);
pub const E_ABORT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004004u32 as _);
pub const E_ACCESSDENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80070005u32 as _);
pub const E_APPLICATION_ACTIVATION_EXEC_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8027025Bu32 as _);
pub const E_APPLICATION_ACTIVATION_TIMED_OUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8027025Au32 as _);
pub const E_APPLICATION_EXITING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000001Au32 as _);
pub const E_APPLICATION_MANAGER_NOT_RUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270257u32 as _);
pub const E_APPLICATION_NOT_REGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270254u32 as _);
pub const E_APPLICATION_TEMPORARY_LICENSE_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8027025Cu32 as _);
pub const E_APPLICATION_TRIAL_LICENSE_EXPIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8027025Du32 as _);
pub const E_APPLICATION_VIEW_EXITING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000001Bu32 as _);
pub const E_ASYNC_OPERATION_NOT_STARTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80000019u32 as _);
pub const E_AUDIO_ENGINE_NODE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80660001u32 as _);
pub const E_BLUETOOTH_ATT_ATTRIBUTE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8065000Au32 as _);
pub const E_BLUETOOTH_ATT_ATTRIBUTE_NOT_LONG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8065000Bu32 as _);
pub const E_BLUETOOTH_ATT_INSUFFICIENT_AUTHENTICATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80650005u32 as _);
pub const E_BLUETOOTH_ATT_INSUFFICIENT_AUTHORIZATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80650008u32 as _);
pub const E_BLUETOOTH_ATT_INSUFFICIENT_ENCRYPTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8065000Fu32 as _);
pub const E_BLUETOOTH_ATT_INSUFFICIENT_ENCRYPTION_KEY_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8065000Cu32 as _);
pub const E_BLUETOOTH_ATT_INSUFFICIENT_RESOURCES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80650011u32 as _);
pub const E_BLUETOOTH_ATT_INVALID_ATTRIBUTE_VALUE_LENGTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8065000Du32 as _);
pub const E_BLUETOOTH_ATT_INVALID_HANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80650001u32 as _);
pub const E_BLUETOOTH_ATT_INVALID_OFFSET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80650007u32 as _);
pub const E_BLUETOOTH_ATT_INVALID_PDU: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80650004u32 as _);
pub const E_BLUETOOTH_ATT_PREPARE_QUEUE_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80650009u32 as _);
pub const E_BLUETOOTH_ATT_READ_NOT_PERMITTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80650002u32 as _);
pub const E_BLUETOOTH_ATT_REQUEST_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80650006u32 as _);
pub const E_BLUETOOTH_ATT_UNKNOWN_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80651000u32 as _);
pub const E_BLUETOOTH_ATT_UNLIKELY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8065000Eu32 as _);
pub const E_BLUETOOTH_ATT_UNSUPPORTED_GROUP_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80650010u32 as _);
pub const E_BLUETOOTH_ATT_WRITE_NOT_PERMITTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80650003u32 as _);
pub const E_BOUNDS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000000Bu32 as _);
pub const E_CHANGED_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000000Cu32 as _);
pub const E_ELEVATED_ACTIVATION_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270251u32 as _);
pub const E_FAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004005u32 as _);
pub const E_FULL_ADMIN_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270253u32 as _);
pub const E_HANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80070006u32 as _);
pub const E_HDAUDIO_CONNECTION_LIST_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80660003u32 as _);
pub const E_HDAUDIO_EMPTY_CONNECTION_LIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80660002u32 as _);
pub const E_HDAUDIO_NO_LOGICAL_DEVICES_CREATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80660004u32 as _);
pub const E_HDAUDIO_NULL_LINKED_LIST_ENTRY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80660005u32 as _);
pub const E_ILLEGAL_DELEGATE_ASSIGNMENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80000018u32 as _);
pub const E_ILLEGAL_METHOD_CALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000000Eu32 as _);
pub const E_ILLEGAL_STATE_CHANGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000000Du32 as _);
pub const E_INVALIDARG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80070057u32 as _);
pub const E_INVALID_PROTOCOL_FORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x83760002u32 as _);
pub const E_INVALID_PROTOCOL_OPERATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x83760001u32 as _);
pub const E_MBN_BAD_SIM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548202u32 as _);
pub const E_MBN_CONTEXT_NOT_ACTIVATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548201u32 as _);
pub const E_MBN_DATA_CLASS_NOT_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548203u32 as _);
pub const E_MBN_DEFAULT_PROFILE_EXIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548219u32 as _);
pub const E_MBN_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548212u32 as _);
pub const E_MBN_INVALID_ACCESS_STRING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548204u32 as _);
pub const E_MBN_INVALID_CACHE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8054820Cu32 as _);
pub const E_MBN_INVALID_PROFILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548218u32 as _);
pub const E_MBN_MAX_ACTIVATED_CONTEXTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548205u32 as _);
pub const E_MBN_NOT_REGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8054820Du32 as _);
pub const E_MBN_PACKET_SVC_DETACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548206u32 as _);
pub const E_MBN_PIN_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548211u32 as _);
pub const E_MBN_PIN_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8054820Fu32 as _);
pub const E_MBN_PIN_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548210u32 as _);
pub const E_MBN_PROVIDERS_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8054820Eu32 as _);
pub const E_MBN_PROVIDER_NOT_VISIBLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548207u32 as _);
pub const E_MBN_RADIO_POWER_OFF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548208u32 as _);
pub const E_MBN_SERVICE_NOT_ACTIVATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548209u32 as _);
pub const E_MBN_SIM_NOT_INSERTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8054820Au32 as _);
pub const E_MBN_SMS_ENCODING_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548220u32 as _);
pub const E_MBN_SMS_FILTER_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548221u32 as _);
pub const E_MBN_SMS_FORMAT_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548227u32 as _);
pub const E_MBN_SMS_INVALID_MEMORY_INDEX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548222u32 as _);
pub const E_MBN_SMS_LANG_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548223u32 as _);
pub const E_MBN_SMS_MEMORY_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548224u32 as _);
pub const E_MBN_SMS_MEMORY_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548229u32 as _);
pub const E_MBN_SMS_NETWORK_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548225u32 as _);
pub const E_MBN_SMS_OPERATION_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548228u32 as _);
pub const E_MBN_SMS_UNKNOWN_SMSC_ADDRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80548226u32 as _);
pub const E_MBN_VOICE_CALL_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8054820Bu32 as _);
pub const E_MONITOR_RESOLUTION_TOO_LOW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270250u32 as _);
pub const E_MULTIPLE_EXTENSIONS_FOR_APPLICATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270255u32 as _);
pub const E_MULTIPLE_PACKAGES_FOR_FAMILY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270256u32 as _);
pub const E_NOINTERFACE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004002u32 as _);
pub const E_NOTIMPL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004001u32 as _);
pub const E_OUTOFMEMORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8007000Eu32 as _);
pub const E_POINTER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80004003u32 as _);
pub const E_PROTOCOL_EXTENSIONS_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x83760003u32 as _);
pub const E_PROTOCOL_VERSION_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x83760005u32 as _);
pub const E_SKYDRIVE_FILE_NOT_UPLOADED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270263u32 as _);
pub const E_SKYDRIVE_ROOT_TARGET_CANNOT_INDEX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270262u32 as _);
pub const E_SKYDRIVE_ROOT_TARGET_FILE_SYSTEM_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270260u32 as _);
pub const E_SKYDRIVE_ROOT_TARGET_OVERLAP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270261u32 as _);
pub const E_SKYDRIVE_ROOT_TARGET_VOLUME_ROOT_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270265u32 as _);
pub const E_SKYDRIVE_UPDATE_AVAILABILITY_FAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270264u32 as _);
pub const E_STRING_NOT_NULL_TERMINATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80000017u32 as _);
pub const E_SUBPROTOCOL_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x83760004u32 as _);
pub const E_SYNCENGINE_CLIENT_UPDATE_NEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802D006u32 as _);
pub const E_SYNCENGINE_FILE_IDENTIFIER_UNKNOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802C002u32 as _);
pub const E_SYNCENGINE_FILE_SIZE_EXCEEDS_REMAINING_QUOTA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802B002u32 as _);
pub const E_SYNCENGINE_FILE_SIZE_OVER_LIMIT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802B001u32 as _);
pub const E_SYNCENGINE_FILE_SYNC_PARTNER_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802B005u32 as _);
pub const E_SYNCENGINE_FOLDER_INACCESSIBLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802D001u32 as _);
pub const E_SYNCENGINE_FOLDER_IN_REDIRECTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802D00Bu32 as _);
pub const E_SYNCENGINE_FOLDER_ITEM_COUNT_LIMIT_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802B004u32 as _);
pub const E_SYNCENGINE_PATH_LENGTH_LIMIT_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802D004u32 as _);
pub const E_SYNCENGINE_PROXY_AUTHENTICATION_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802D007u32 as _);
pub const E_SYNCENGINE_REMOTE_PATH_LENGTH_LIMIT_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802D005u32 as _);
pub const E_SYNCENGINE_REQUEST_BLOCKED_BY_SERVICE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802C006u32 as _);
pub const E_SYNCENGINE_REQUEST_BLOCKED_DUE_TO_CLIENT_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802C007u32 as _);
pub const E_SYNCENGINE_SERVICE_AUTHENTICATION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802C003u32 as _);
pub const E_SYNCENGINE_SERVICE_RETURNED_UNEXPECTED_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802C005u32 as _);
pub const E_SYNCENGINE_STORAGE_SERVICE_BLOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802D00Au32 as _);
pub const E_SYNCENGINE_STORAGE_SERVICE_PROVISIONING_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802D008u32 as _);
pub const E_SYNCENGINE_SYNC_PAUSED_BY_SERVICE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802B006u32 as _);
pub const E_SYNCENGINE_UNKNOWN_SERVICE_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802C004u32 as _);
pub const E_SYNCENGINE_UNSUPPORTED_FILE_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802B003u32 as _);
pub const E_SYNCENGINE_UNSUPPORTED_FOLDER_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802D002u32 as _);
pub const E_SYNCENGINE_UNSUPPORTED_MARKET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802D003u32 as _);
pub const E_SYNCENGINE_UNSUPPORTED_REPARSE_POINT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8802D009u32 as _);
pub const E_UAC_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270252u32 as _);
pub const E_UNEXPECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000FFFFu32 as _);
...
pub const FA_E_HOMEGROUP_NOT_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270222u32 as _);
pub const FA_E_MAX_PERSISTED_ITEMS_REACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270220u32 as _);
pub const FDAEMON_E_CHANGEUPDATEFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041684u32 as _);
pub const FDAEMON_E_FATALERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041682u32 as _);
pub const FDAEMON_E_LOWRESOURCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041681u32 as _);
pub const FDAEMON_E_NOWORDLIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041687u32 as _);
pub const FDAEMON_E_PARTITIONDELETED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041683u32 as _);
pub const FDAEMON_E_TOOMANYFILTEREDBLOCKS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041688u32 as _);
pub const FDAEMON_E_WORDLISTCOMMITFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041686u32 as _);
pub const FDAEMON_W_EMPTYWORDLIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41685u32 as _);
pub const FDAEMON_W_WORDLISTFULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41680u32 as _);
pub const FILTER_E_ALREADY_OPEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041736u32 as _);
pub const FILTER_E_CONTENTINDEXCORRUPT: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0041734u32 as _);
pub const FILTER_E_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041738u32 as _);
pub const FILTER_E_NOT_OPEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041739u32 as _);
pub const FILTER_E_NO_SUCH_PROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004173Bu32 as _);
pub const FILTER_E_OFFLINE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004173Du32 as _);
pub const FILTER_E_PARTIALLY_FILTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004173Eu32 as _);
pub const FILTER_E_TOO_BIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041730u32 as _);
pub const FILTER_E_UNREACHABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041737u32 as _);
pub const FILTER_S_CONTENTSCAN_DELAYED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41733u32 as _);
pub const FILTER_S_DISK_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41735u32 as _);
pub const FILTER_S_FULL_CONTENTSCAN_IMMEDIATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41732u32 as _);
pub const FILTER_S_NO_PROPSETS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4173Au32 as _);
pub const FILTER_S_NO_SECURITY_DESCRIPTOR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4173Cu32 as _);
pub const FILTER_S_PARTIAL_CONTENTSCAN_IMMEDIATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41731u32 as _);
...
pub const FVE_E_AAD_ENDPOINT_BUSY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100E1u32 as _);
pub const FVE_E_AAD_SERVER_FAIL_BACKOFF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100EAu32 as _);
pub const FVE_E_AAD_SERVER_FAIL_RETRY_AFTER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100E9u32 as _);
pub const FVE_E_ACTION_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310009u32 as _);
pub const FVE_E_ADBACKUP_NOT_ENABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100D5u32 as _);
pub const FVE_E_AD_ATTR_NOT_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031000Eu32 as _);
pub const FVE_E_AD_BACKUP_REQUIRED_POLICY_NOT_SET_FIXED_DRIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100DBu32 as _);
pub const FVE_E_AD_BACKUP_REQUIRED_POLICY_NOT_SET_OS_DRIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100DAu32 as _);
pub const FVE_E_AD_BACKUP_REQUIRED_POLICY_NOT_SET_REMOVABLE_DRIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100DCu32 as _);
pub const FVE_E_AD_GUID_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031000Fu32 as _);
pub const FVE_E_AD_INSUFFICIENT_BUFFER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031001Au32 as _);
pub const FVE_E_AD_INVALID_DATASIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031000Cu32 as _);
pub const FVE_E_AD_INVALID_DATATYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031000Bu32 as _);
pub const FVE_E_AD_NO_VALUES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031000Du32 as _);
pub const FVE_E_AD_SCHEMA_NOT_INSTALLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031000Au32 as _);
pub const FVE_E_AUTH_INVALID_APPLICATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310044u32 as _);
pub const FVE_E_AUTH_INVALID_CONFIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310045u32 as _);
pub const FVE_E_AUTOUNLOCK_ENABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310029u32 as _);
pub const FVE_E_BAD_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310016u32 as _);
pub const FVE_E_BAD_INFORMATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310010u32 as _);
pub const FVE_E_BAD_PARTITION_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310014u32 as _);
pub const FVE_E_BCD_APPLICATIONS_PATH_INCORRECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310052u32 as _);
pub const FVE_E_BOOTABLE_CDDVD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310030u32 as _);
pub const FVE_E_BUFFER_TOO_LARGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100CFu32 as _);
pub const FVE_E_CANNOT_ENCRYPT_NO_KEY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031002Eu32 as _);
pub const FVE_E_CANNOT_SET_FVEK_ENCRYPTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031002Du32 as _);
pub const FVE_E_CANT_LOCK_AUTOUNLOCK_ENABLED_VOLUME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310097u32 as _);
pub const FVE_E_CLUSTERING_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031001Eu32 as _);
pub const FVE_E_CONV_READ: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031001Bu32 as _);
pub const FVE_E_CONV_RECOVERY_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310088u32 as _);
pub const FVE_E_CONV_WRITE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031001Cu32 as _);
pub const FVE_E_DATASET_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100EBu32 as _);
pub const FVE_E_DEBUGGER_ENABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031004Fu32 as _);
pub const FVE_E_DEVICELOCKOUT_COUNTER_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100CEu32 as _);
pub const FVE_E_DEVICE_LOCKOUT_COUNTER_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100CDu32 as _);
pub const FVE_E_DEVICE_NOT_JOINED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100E0u32 as _);
pub const FVE_E_DE_DEVICE_LOCKEDOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100CAu32 as _);
pub const FVE_E_DE_FIXED_DATA_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100C5u32 as _);
pub const FVE_E_DE_HARDWARE_NOT_COMPLIANT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100C6u32 as _);
pub const FVE_E_DE_OS_VOLUME_NOT_PROTECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100C9u32 as _);
pub const FVE_E_DE_PREVENTED_FOR_OS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100D1u32 as _);
pub const FVE_E_DE_PROTECTION_NOT_YET_ENABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100CBu32 as _);
pub const FVE_E_DE_PROTECTION_SUSPENDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100C8u32 as _);
pub const FVE_E_DE_VOLUME_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100D3u32 as _);
pub const FVE_E_DE_VOLUME_OPTED_OUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100D2u32 as _);
pub const FVE_E_DE_WINRE_NOT_CONFIGURED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100C7u32 as _);
pub const FVE_E_DRY_RUN_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031004Du32 as _);
pub const FVE_E_DV_NOT_ALLOWED_BY_GP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310071u32 as _);
pub const FVE_E_DV_NOT_SUPPORTED_ON_FS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310070u32 as _);
pub const FVE_E_EDRIVE_BAND_ENUMERATION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100E3u32 as _);
pub const FVE_E_EDRIVE_BAND_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100B0u32 as _);
pub const FVE_E_EDRIVE_DISALLOWED_BY_GP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100B1u32 as _);
pub const FVE_E_EDRIVE_DRY_RUN_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100BCu32 as _);
pub const FVE_E_EDRIVE_DV_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100B4u32 as _);
pub const FVE_E_EDRIVE_INCOMPATIBLE_FIRMWARE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100BFu32 as _);
pub const FVE_E_EDRIVE_INCOMPATIBLE_VOLUME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100B2u32 as _);
pub const FVE_E_EDRIVE_NO_FAILOVER_TO_SW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100AFu32 as _);
pub const FVE_E_EFI_ONLY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031009Cu32 as _);
pub const FVE_E_ENH_PIN_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310099u32 as _);
pub const FVE_E_EOW_NOT_SUPPORTED_IN_VERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100D4u32 as _);
pub const FVE_E_EXECUTE_REQUEST_SENT_TOO_SOON: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100DEu32 as _);
pub const FVE_E_FAILED_AUTHENTICATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310027u32 as _);
pub const FVE_E_FAILED_SECTOR_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310026u32 as _);
pub const FVE_E_FAILED_WRONG_FS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310013u32 as _);
pub const FVE_E_FIPS_DISABLE_PROTECTION_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310046u32 as _);
pub const FVE_E_FIPS_HASH_KDF_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310098u32 as _);
pub const FVE_E_FIPS_PREVENTS_EXTERNAL_KEY_EXPORT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310038u32 as _);
pub const FVE_E_FIPS_PREVENTS_PASSPHRASE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031006Cu32 as _);
pub const FVE_E_FIPS_PREVENTS_RECOVERY_PASSWORD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310037u32 as _);
pub const FVE_E_FIPS_RNG_CHECK_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310036u32 as _);
pub const FVE_E_FIRMWARE_TYPE_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310048u32 as _);
pub const FVE_E_FOREIGN_VOLUME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310023u32 as _);
pub const FVE_E_FS_MOUNTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031004Bu32 as _);
pub const FVE_E_FS_NOT_EXTENDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310047u32 as _);
pub const FVE_E_FULL_ENCRYPTION_NOT_ALLOWED_ON_TP_STORAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100A5u32 as _);
pub const FVE_E_HIDDEN_VOLUME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310056u32 as _);
pub const FVE_E_INVALID_BITLOCKER_OID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031006Eu32 as _);
pub const FVE_E_INVALID_DATUM_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031009Bu32 as _);
pub const FVE_E_INVALID_KEY_FORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310034u32 as _);
pub const FVE_E_INVALID_NBP_CERT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100E2u32 as _);
pub const FVE_E_INVALID_NKP_CERT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031009Fu32 as _);
pub const FVE_E_INVALID_PASSWORD_FORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310035u32 as _);
pub const FVE_E_INVALID_PIN_CHARS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031009Au32 as _);
pub const FVE_E_INVALID_PIN_CHARS_DETAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100CCu32 as _);
pub const FVE_E_INVALID_PROTECTOR_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031003Au32 as _);
pub const FVE_E_INVALID_STARTUP_OPTIONS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031005Bu32 as _);
pub const FVE_E_KEYFILE_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031003Du32 as _);
pub const FVE_E_KEYFILE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031003Cu32 as _);
pub const FVE_E_KEYFILE_NO_VMK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031003Eu32 as _);
pub const FVE_E_KEY_LENGTH_NOT_SUPPORTED_BY_EDRIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100A7u32 as _);
pub const FVE_E_KEY_PROTECTOR_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310069u32 as _);
pub const FVE_E_KEY_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031001Du32 as _);
pub const FVE_E_KEY_ROTATION_NOT_ENABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100DFu32 as _);
pub const FVE_E_KEY_ROTATION_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100DDu32 as _);
pub const FVE_E_LIVEID_ACCOUNT_BLOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100C3u32 as _);
pub const FVE_E_LIVEID_ACCOUNT_SUSPENDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100C2u32 as _);
pub const FVE_E_LOCKED_VOLUME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310000u32 as _);
pub const FVE_E_METADATA_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100ECu32 as _);
pub const FVE_E_MOR_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310055u32 as _);
pub const FVE_E_MULTIPLE_NKP_CERTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031009Du32 as _);
pub const FVE_E_NON_BITLOCKER_KU: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310093u32 as _);
pub const FVE_E_NON_BITLOCKER_OID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310085u32 as _);
pub const FVE_E_NOT_ACTIVATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310008u32 as _);
pub const FVE_E_NOT_ALLOWED_IN_SAFE_MODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310040u32 as _);
pub const FVE_E_NOT_ALLOWED_IN_VERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310053u32 as _);
pub const FVE_E_NOT_ALLOWED_ON_CLUSTER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100AEu32 as _);
pub const FVE_E_NOT_ALLOWED_ON_CSV_STACK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100ADu32 as _);
pub const FVE_E_NOT_ALLOWED_TO_UPGRADE_WHILE_CONVERTING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100B3u32 as _);
pub const FVE_E_NOT_DATA_VOLUME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310019u32 as _);
pub const FVE_E_NOT_DECRYPTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310039u32 as _);
pub const FVE_E_NOT_DE_VOLUME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100D7u32 as _);
pub const FVE_E_NOT_ENCRYPTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310001u32 as _);
pub const FVE_E_NOT_ON_STACK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031004Au32 as _);
pub const FVE_E_NOT_OS_VOLUME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310028u32 as _);
pub const FVE_E_NOT_PROVISIONED_ON_ALL_VOLUMES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100C4u32 as _);
pub const FVE_E_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310015u32 as _);
pub const FVE_E_NO_AUTOUNLOCK_MASTER_KEY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310054u32 as _);
pub const FVE_E_NO_BOOTMGR_METRIC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310005u32 as _);
pub const FVE_E_NO_BOOTSECTOR_METRIC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310004u32 as _);
pub const FVE_E_NO_EXISTING_PASSPHRASE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100A8u32 as _);
pub const FVE_E_NO_EXISTING_PIN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100A0u32 as _);
pub const FVE_E_NO_FEATURE_LICENSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031005Au32 as _);
pub const FVE_E_NO_LICENSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310049u32 as _);
pub const FVE_E_NO_MBR_METRIC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310003u32 as _);
pub const FVE_E_NO_PASSPHRASE_WITH_TPM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100ABu32 as _);
pub const FVE_E_NO_PREBOOT_KEYBOARD_DETECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100B5u32 as _);
pub const FVE_E_NO_PREBOOT_KEYBOARD_OR_WINRE_DETECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100B6u32 as _);
pub const FVE_E_NO_PROTECTORS_TO_TEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031003Bu32 as _);
pub const FVE_E_NO_SUCH_CAPABILITY_ON_TARGET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100D0u32 as _);
pub const FVE_E_NO_TPM_BIOS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310002u32 as _);
pub const FVE_E_NO_TPM_WITH_PASSPHRASE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100ACu32 as _);
pub const FVE_E_OPERATION_NOT_SUPPORTED_ON_VISTA_VOLUME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310096u32 as _);
pub const FVE_E_OSV_KSR_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100D9u32 as _);
pub const FVE_E_OS_NOT_PROTECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310020u32 as _);
pub const FVE_E_OS_VOLUME_PASSPHRASE_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031006Du32 as _);
pub const FVE_E_OVERLAPPED_UPDATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310024u32 as _);
pub const FVE_E_PASSPHRASE_PROTECTOR_CHANGE_BY_STD_USER_DISALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100C1u32 as _);
pub const FVE_E_PASSPHRASE_TOO_LONG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100AAu32 as _);
pub const FVE_E_PIN_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310043u32 as _);
pub const FVE_E_PIN_PROTECTOR_CHANGE_BY_STD_USER_DISALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100A2u32 as _);
pub const FVE_E_POLICY_CONFLICT_FDV_RK_OFF_AUK_ON: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310083u32 as _);
pub const FVE_E_POLICY_CONFLICT_FDV_RP_OFF_ADB_ON: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310091u32 as _);
pub const FVE_E_POLICY_CONFLICT_OSV_RP_OFF_ADB_ON: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310090u32 as _);
pub const FVE_E_POLICY_CONFLICT_RDV_RK_OFF_AUK_ON: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310084u32 as _);
pub const FVE_E_POLICY_CONFLICT_RDV_RP_OFF_ADB_ON: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310092u32 as _);
pub const FVE_E_POLICY_CONFLICT_RO_AND_STARTUP_KEY_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310087u32 as _);
pub const FVE_E_POLICY_INVALID_ENHANCED_BCD_SETTINGS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100BEu32 as _);
pub const FVE_E_POLICY_INVALID_PASSPHRASE_LENGTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310080u32 as _);
pub const FVE_E_POLICY_INVALID_PIN_LENGTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310068u32 as _);
pub const FVE_E_POLICY_ON_RDV_EXCLUSION_LIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100E4u32 as _);
pub const FVE_E_POLICY_PASSPHRASE_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031006Au32 as _);
pub const FVE_E_POLICY_PASSPHRASE_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031006Bu32 as _);
pub const FVE_E_POLICY_PASSPHRASE_REQUIRES_ASCII: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100A4u32 as _);
pub const FVE_E_POLICY_PASSPHRASE_TOO_SIMPLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310081u32 as _);
pub const FVE_E_POLICY_PASSWORD_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031002Cu32 as _);
pub const FVE_E_POLICY_PROHIBITS_SELFSIGNED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310086u32 as _);
pub const FVE_E_POLICY_RECOVERY_KEY_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031005Eu32 as _);
pub const FVE_E_POLICY_RECOVERY_KEY_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031005Fu32 as _);
pub const FVE_E_POLICY_RECOVERY_PASSWORD_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031005Cu32 as _);
pub const FVE_E_POLICY_RECOVERY_PASSWORD_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031005Du32 as _);
pub const FVE_E_POLICY_REQUIRES_RECOVERY_PASSWORD_ON_TOUCH_DEVICE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100B8u32 as _);
pub const FVE_E_POLICY_REQUIRES_STARTUP_PIN_ON_TOUCH_DEVICE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100B7u32 as _);
pub const FVE_E_POLICY_STARTUP_KEY_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310062u32 as _);
pub const FVE_E_POLICY_STARTUP_KEY_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310063u32 as _);
pub const FVE_E_POLICY_STARTUP_PIN_KEY_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310064u32 as _);
pub const FVE_E_POLICY_STARTUP_PIN_KEY_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310065u32 as _);
pub const FVE_E_POLICY_STARTUP_PIN_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310060u32 as _);
pub const FVE_E_POLICY_STARTUP_PIN_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310061u32 as _);
pub const FVE_E_POLICY_STARTUP_TPM_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310066u32 as _);
pub const FVE_E_POLICY_STARTUP_TPM_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310067u32 as _);
pub const FVE_E_POLICY_USER_CERTIFICATE_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310072u32 as _);
pub const FVE_E_POLICY_USER_CERTIFICATE_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310073u32 as _);
pub const FVE_E_POLICY_USER_CERT_MUST_BE_HW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310074u32 as _);
pub const FVE_E_POLICY_USER_CONFIGURE_FDV_AUTOUNLOCK_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310075u32 as _);
pub const FVE_E_POLICY_USER_CONFIGURE_RDV_AUTOUNLOCK_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310076u32 as _);
pub const FVE_E_POLICY_USER_CONFIGURE_RDV_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310077u32 as _);
pub const FVE_E_POLICY_USER_DISABLE_RDV_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310079u32 as _);
pub const FVE_E_POLICY_USER_ENABLE_RDV_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310078u32 as _);
pub const FVE_E_PREDICTED_TPM_PROTECTOR_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100E5u32 as _);
pub const FVE_E_PRIVATEKEY_AUTH_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310094u32 as _);
pub const FVE_E_PROTECTION_CANNOT_BE_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100D8u32 as _);
pub const FVE_E_PROTECTION_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310021u32 as _);
pub const FVE_E_PROTECTOR_CHANGE_MAX_PASSPHRASE_CHANGE_ATTEMPTS_REACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100C0u32 as _);
pub const FVE_E_PROTECTOR_CHANGE_MAX_PIN_CHANGE_ATTEMPTS_REACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100A3u32 as _);
pub const FVE_E_PROTECTOR_CHANGE_PASSPHRASE_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100A9u32 as _);
pub const FVE_E_PROTECTOR_CHANGE_PIN_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100A1u32 as _);
pub const FVE_E_PROTECTOR_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310031u32 as _);
pub const FVE_E_PROTECTOR_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310033u32 as _);
pub const FVE_E_PUBKEY_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310058u32 as _);
pub const FVE_E_RAW_ACCESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310050u32 as _);
pub const FVE_E_RAW_BLOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310051u32 as _);
pub const FVE_E_REBOOT_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031004Eu32 as _);
pub const FVE_E_RECOVERY_KEY_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310022u32 as _);
pub const FVE_E_RECOVERY_PARTITION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310082u32 as _);
pub const FVE_E_RELATIVE_PATH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310032u32 as _);
pub const FVE_E_REMOVAL_OF_DRA_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310095u32 as _);
pub const FVE_E_REMOVAL_OF_NKP_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031009Eu32 as _);
pub const FVE_E_SECUREBOOT_CONFIGURATION_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100BBu32 as _);
pub const FVE_E_SECUREBOOT_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100BAu32 as _);
pub const FVE_E_SECURE_KEY_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310007u32 as _);
pub const FVE_E_SETUP_TPM_CALLBACK_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100E6u32 as _);
pub const FVE_E_SHADOW_COPY_PRESENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100BDu32 as _);
pub const FVE_E_SYSTEM_VOLUME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310012u32 as _);
pub const FVE_E_TOKEN_NOT_IMPERSONATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031004Cu32 as _);
pub const FVE_E_TOO_SMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310011u32 as _);
pub const FVE_E_TPM_CONTEXT_SETUP_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100E7u32 as _);
pub const FVE_E_TPM_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031003Fu32 as _);
pub const FVE_E_TPM_INVALID_PCR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310041u32 as _);
pub const FVE_E_TPM_NOT_OWNED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310018u32 as _);
pub const FVE_E_TPM_NO_VMK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310042u32 as _);
pub const FVE_E_TPM_SRK_AUTH_NOT_ZERO: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310025u32 as _);
pub const FVE_E_TRANSIENT_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310057u32 as _);
pub const FVE_E_UPDATE_INVALID_CONFIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100E8u32 as _);
pub const FVE_E_VIRTUALIZED_SPACE_TOO_BIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310089u32 as _);
pub const FVE_E_VOLUME_BOUND_ALREADY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031001Fu32 as _);
pub const FVE_E_VOLUME_EXTEND_PREVENTS_EOW_DECRYPT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100D6u32 as _);
pub const FVE_E_VOLUME_HANDLE_OPEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310059u32 as _);
pub const FVE_E_VOLUME_NOT_BOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310017u32 as _);
pub const FVE_E_VOLUME_TOO_SMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031006Fu32 as _);
pub const FVE_E_WIPE_CANCEL_NOT_APPLICABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100B9u32 as _);
pub const FVE_E_WIPE_NOT_ALLOWED_ON_TP_STORAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803100A6u32 as _);
pub const FVE_E_WRONG_BOOTMGR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80310006u32 as _);
pub const FVE_E_WRONG_BOOTSECTOR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031002Au32 as _);
pub const FVE_E_WRONG_SYSTEM_FS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8031002Bu32 as _);
pub const FWP_E_ACTION_INCOMPATIBLE_WITH_LAYER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032002Cu32 as _);
pub const FWP_E_ACTION_INCOMPATIBLE_WITH_SUBLAYER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032002Du32 as _);
pub const FWP_E_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320009u32 as _);
pub const FWP_E_BUILTIN_OBJECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320017u32 as _);
pub const FWP_E_CALLOUT_NOTIFICATION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320037u32 as _);
pub const FWP_E_CALLOUT_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320001u32 as _);
pub const FWP_E_CONDITION_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320002u32 as _);
pub const FWP_E_CONNECTIONS_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320041u32 as _);
pub const FWP_E_CONTEXT_INCOMPATIBLE_WITH_CALLOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032002Fu32 as _);
pub const FWP_E_CONTEXT_INCOMPATIBLE_WITH_LAYER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032002Eu32 as _);
pub const FWP_E_DROP_NOICMP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320104u32 as _);
pub const FWP_E_DUPLICATE_AUTH_METHOD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032003Cu32 as _);
pub const FWP_E_DUPLICATE_CONDITION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032002Au32 as _);
pub const FWP_E_DUPLICATE_KEYMOD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032002Bu32 as _);
pub const FWP_E_DYNAMIC_SESSION_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032000Bu32 as _);
pub const FWP_E_EM_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320032u32 as _);
pub const FWP_E_FILTER_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320003u32 as _);
pub const FWP_E_IKEEXT_NOT_RUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320044u32 as _);
pub const FWP_E_INCOMPATIBLE_AUTH_METHOD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320030u32 as _);
pub const FWP_E_INCOMPATIBLE_CIPHER_TRANSFORM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032003Au32 as _);
pub const FWP_E_INCOMPATIBLE_DH_GROUP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320031u32 as _);
pub const FWP_E_INCOMPATIBLE_LAYER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320014u32 as _);
pub const FWP_E_INCOMPATIBLE_SA_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032001Bu32 as _);
pub const FWP_E_INCOMPATIBLE_TXN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320011u32 as _);
pub const FWP_E_INVALID_ACTION_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320024u32 as _);
pub const FWP_E_INVALID_AUTH_TRANSFORM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320038u32 as _);
pub const FWP_E_INVALID_CIPHER_TRANSFORM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320039u32 as _);
pub const FWP_E_INVALID_DNS_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320042u32 as _);
pub const FWP_E_INVALID_ENUMERATOR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032001Du32 as _);
pub const FWP_E_INVALID_FLAGS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032001Eu32 as _);
pub const FWP_E_INVALID_INTERVAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320021u32 as _);
pub const FWP_E_INVALID_NET_MASK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032001Fu32 as _);
pub const FWP_E_INVALID_PARAMETER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320035u32 as _);
pub const FWP_E_INVALID_RANGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320020u32 as _);
pub const FWP_E_INVALID_TRANSFORM_COMBINATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032003Bu32 as _);
pub const FWP_E_INVALID_TUNNEL_ENDPOINT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032003Du32 as _);
pub const FWP_E_INVALID_WEIGHT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320025u32 as _);
pub const FWP_E_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032000Au32 as _);
pub const FWP_E_KEY_DICTATION_INVALID_KEYING_MATERIAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320040u32 as _);
pub const FWP_E_KEY_DICTATOR_ALREADY_REGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032003Fu32 as _);
pub const FWP_E_KM_CLIENTS_ONLY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320015u32 as _);
pub const FWP_E_L2_DRIVER_NOT_READY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032003Eu32 as _);
pub const FWP_E_LAYER_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320004u32 as _);
pub const FWP_E_LIFETIME_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320016u32 as _);
pub const FWP_E_MATCH_TYPE_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320026u32 as _);
pub const FWP_E_NET_EVENTS_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320013u32 as _);
pub const FWP_E_NEVER_MATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320033u32 as _);
pub const FWP_E_NOTIFICATION_DROPPED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320019u32 as _);
pub const FWP_E_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320008u32 as _);
pub const FWP_E_NO_TXN_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032000Du32 as _);
pub const FWP_E_NULL_DISPLAY_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320023u32 as _);
pub const FWP_E_NULL_POINTER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032001Cu32 as _);
pub const FWP_E_OUT_OF_BOUNDS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320028u32 as _);
pub const FWP_E_PROVIDER_CONTEXT_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320034u32 as _);
pub const FWP_E_PROVIDER_CONTEXT_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320006u32 as _);
pub const FWP_E_PROVIDER_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320005u32 as _);
pub const FWP_E_RESERVED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320029u32 as _);
pub const FWP_E_SESSION_ABORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320010u32 as _);
pub const FWP_E_STILL_ON: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320043u32 as _);
pub const FWP_E_SUBLAYER_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320007u32 as _);
pub const FWP_E_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320012u32 as _);
pub const FWP_E_TOO_MANY_CALLOUTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320018u32 as _);
pub const FWP_E_TOO_MANY_SUBLAYERS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320036u32 as _);
pub const FWP_E_TRAFFIC_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032001Au32 as _);
pub const FWP_E_TXN_ABORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032000Fu32 as _);
pub const FWP_E_TXN_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032000Eu32 as _);
pub const FWP_E_TYPE_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320027u32 as _);
pub const FWP_E_WRONG_SESSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8032000Cu32 as _);
pub const FWP_E_ZERO_LENGTH_ARRAY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80320022u32 as _);
pub const GCN_E_DEFAULTNAMESPACE_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0029u32 as _);
pub const GCN_E_MODULE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0021u32 as _);
pub const GCN_E_NETADAPTER_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0026u32 as _);
pub const GCN_E_NETADAPTER_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0025u32 as _);
pub const GCN_E_NETCOMPARTMENT_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0027u32 as _);
pub const GCN_E_NETINTERFACE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0028u32 as _);
pub const GCN_E_NO_REQUEST_HANDLERS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0022u32 as _);
pub const GCN_E_REQUEST_UNSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0023u32 as _);
pub const GCN_E_RUNTIMEKEYS_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0024u32 as _);
...
pub const HCN_E_ADAPTER_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0006u32 as _);
pub const HCN_E_ADDR_INVALID_OR_RESERVED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B002Fu32 as _);
pub const HCN_E_DEGRADED_OPERATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0017u32 as _);
pub const HCN_E_ENDPOINT_ALREADY_ATTACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0014u32 as _);
pub const HCN_E_ENDPOINT_NAMESPACE_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B002Bu32 as _);
pub const HCN_E_ENDPOINT_NOT_ATTACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0034u32 as _);
pub const HCN_E_ENDPOINT_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0002u32 as _);
pub const HCN_E_ENDPOINT_NOT_LOCAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0035u32 as _);
pub const HCN_E_ENDPOINT_SHARING_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B001Du32 as _);
pub const HCN_E_ENTITY_HAS_REFERENCES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B002Cu32 as _);
pub const HCN_E_GUID_CONVERSION_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0019u32 as _);
pub const HCN_E_ICS_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B002Au32 as _);
pub const HCN_E_INVALID_ENDPOINT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B000Cu32 as _);
pub const HCN_E_INVALID_INTERNAL_PORT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B002Du32 as _);
pub const HCN_E_INVALID_IP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B001Eu32 as _);
pub const HCN_E_INVALID_IP_SUBNET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0033u32 as _);
pub const HCN_E_INVALID_JSON: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B001Bu32 as _);
pub const HCN_E_INVALID_JSON_REFERENCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B001Cu32 as _);
pub const HCN_E_INVALID_NETWORK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B000Au32 as _);
pub const HCN_E_INVALID_NETWORK_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B000Bu32 as _);
pub const HCN_E_INVALID_POLICY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B000Du32 as _);
pub const HCN_E_INVALID_POLICY_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B000Eu32 as _);
pub const HCN_E_INVALID_PREFIX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0030u32 as _);
pub const HCN_E_INVALID_REMOTE_ENDPOINT_OPERATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B000Fu32 as _);
pub const HCN_E_INVALID_SUBNET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0032u32 as _);
pub const HCN_E_LAYER_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0011u32 as _);
pub const HCN_E_LAYER_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0003u32 as _);
pub const HCN_E_MANAGER_STOPPED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0020u32 as _);
pub const HCN_E_MAPPING_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0016u32 as _);
pub const HCN_E_NAMESPACE_ATTACH_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B002Eu32 as _);
pub const HCN_E_NETWORK_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0010u32 as _);
pub const HCN_E_NETWORK_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0001u32 as _);
pub const HCN_E_OBJECT_USED_AFTER_UNLOAD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0031u32 as _);
pub const HCN_E_POLICY_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0012u32 as _);
pub const HCN_E_POLICY_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0008u32 as _);
pub const HCN_E_PORT_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0013u32 as _);
pub const HCN_E_PORT_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0007u32 as _);
pub const HCN_E_REGKEY_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B001Au32 as _);
pub const HCN_E_REQUEST_UNSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0015u32 as _);
pub const HCN_E_SHARED_SWITCH_MODIFICATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0018u32 as _);
pub const HCN_E_SUBNET_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0005u32 as _);
pub const HCN_E_SWITCH_EXTENSION_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B001Fu32 as _);
pub const HCN_E_SWITCH_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0004u32 as _);
pub const HCN_E_VFP_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0037u32 as _);
pub const HCN_E_VFP_PORTSETTING_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0009u32 as _);
pub const HCN_INTERFACEPARAMETERS_ALREADY_APPLIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803B0036u32 as _);
pub const HCS_E_ACCESS_DENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8037011Bu32 as _);
pub const HCS_E_CONNECTION_CLOSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8037010Au32 as _);
pub const HCS_E_CONNECTION_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370109u32 as _);
pub const HCS_E_CONNECT_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370108u32 as _);
pub const HCS_E_GUEST_CRITICAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8037011Cu32 as _);
pub const HCS_E_HYPERV_NOT_INSTALLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370102u32 as _);
pub const HCS_E_IMAGE_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370101u32 as _);
pub const HCS_E_INVALID_JSON: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8037010Du32 as _);
pub const HCS_E_INVALID_LAYER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370112u32 as _);
pub const HCS_E_INVALID_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370105u32 as _);
pub const HCS_E_OPERATION_ALREADY_CANCELLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370121u32 as _);
pub const HCS_E_OPERATION_ALREADY_STARTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370116u32 as _);
pub const HCS_E_OPERATION_NOT_STARTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370115u32 as _);
pub const HCS_E_OPERATION_PENDING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370117u32 as _);
pub const HCS_E_OPERATION_RESULT_ALLOCATION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8037011Au32 as _);
pub const HCS_E_OPERATION_SYSTEM_CALLBACK_ALREADY_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370119u32 as _);
pub const HCS_E_OPERATION_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370118u32 as _);
pub const HCS_E_PROCESS_ALREADY_STOPPED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8037011Fu32 as _);
pub const HCS_E_PROCESS_INFO_NOT_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8037011Du32 as _);
pub const HCS_E_PROTOCOL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370111u32 as _);
pub const HCS_E_SERVICE_DISCONNECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8037011Eu32 as _);
pub const HCS_E_SERVICE_NOT_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370114u32 as _);
pub const HCS_E_SYSTEM_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8037010Fu32 as _);
pub const HCS_E_SYSTEM_ALREADY_STOPPED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370110u32 as _);
pub const HCS_E_SYSTEM_NOT_CONFIGURED_FOR_OPERATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370120u32 as _);
pub const HCS_E_SYSTEM_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8037010Eu32 as _);
pub const HCS_E_TERMINATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370107u32 as _);
pub const HCS_E_TERMINATED_DURING_START: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370100u32 as _);
pub const HCS_E_UNEXPECTED_EXIT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370106u32 as _);
pub const HCS_E_UNKNOWN_MESSAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8037010Bu32 as _);
pub const HCS_E_UNSUPPORTED_PROTOCOL_VERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8037010Cu32 as _);
pub const HCS_E_WINDOWS_INSIDER_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370113u32 as _);
pub const HSP_BASE_ERROR_MASK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290100u32 as _);
pub const HSP_BASE_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x812901FFu32 as _);
pub const HSP_BS_ERROR_MASK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81281000u32 as _);
pub const HSP_BS_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x812810FFu32 as _);
pub const HSP_DRV_ERROR_MASK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290000u32 as _);
pub const HSP_DRV_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x812900FFu32 as _);
pub const HSP_E_ERROR_MASK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81280000u32 as _);
pub const HSP_E_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81280FFFu32 as _);
pub const HSP_KSP_ALGORITHM_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290209u32 as _);
pub const HSP_KSP_BUFFER_TOO_SMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290205u32 as _);
pub const HSP_KSP_DEVICE_NOT_READY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290201u32 as _);
pub const HSP_KSP_ERROR_MASK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290200u32 as _);
pub const HSP_KSP_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x812902FFu32 as _);
pub const HSP_KSP_INVALID_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290207u32 as _);
pub const HSP_KSP_INVALID_FLAGS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290208u32 as _);
pub const HSP_KSP_INVALID_KEY_HANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290203u32 as _);
pub const HSP_KSP_INVALID_KEY_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8129020Cu32 as _);
pub const HSP_KSP_INVALID_PARAMETER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290204u32 as _);
pub const HSP_KSP_INVALID_PROVIDER_HANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290202u32 as _);
pub const HSP_KSP_KEY_ALREADY_FINALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8129020Au32 as _);
pub const HSP_KSP_KEY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290215u32 as _);
pub const HSP_KSP_KEY_LOAD_FAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290217u32 as _);
pub const HSP_KSP_KEY_MISSING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290216u32 as _);
pub const HSP_KSP_KEY_NOT_FINALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8129020Bu32 as _);
pub const HSP_KSP_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290206u32 as _);
pub const HSP_KSP_NO_MEMORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290210u32 as _);
pub const HSP_KSP_NO_MORE_ITEMS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290218u32 as _);
pub const HSP_KSP_PARAMETER_NOT_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81290211u32 as _);
pub const HTTP_E_STATUS_AMBIGUOUS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8019012Cu32 as _);
pub const HTTP_E_STATUS_BAD_GATEWAY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801901F6u32 as _);
pub const HTTP_E_STATUS_BAD_METHOD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190195u32 as _);
pub const HTTP_E_STATUS_BAD_REQUEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190190u32 as _);
pub const HTTP_E_STATUS_CONFLICT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190199u32 as _);
pub const HTTP_E_STATUS_DENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190191u32 as _);
pub const HTTP_E_STATUS_EXPECTATION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801901A1u32 as _);
pub const HTTP_E_STATUS_FORBIDDEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190193u32 as _);
pub const HTTP_E_STATUS_GATEWAY_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801901F8u32 as _);
pub const HTTP_E_STATUS_GONE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8019019Au32 as _);
pub const HTTP_E_STATUS_LENGTH_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8019019Bu32 as _);
pub const HTTP_E_STATUS_MOVED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8019012Du32 as _);
pub const HTTP_E_STATUS_NONE_ACCEPTABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190196u32 as _);
pub const HTTP_E_STATUS_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190194u32 as _);
pub const HTTP_E_STATUS_NOT_MODIFIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190130u32 as _);
pub const HTTP_E_STATUS_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801901F5u32 as _);
pub const HTTP_E_STATUS_PAYMENT_REQ: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190192u32 as _);
pub const HTTP_E_STATUS_PRECOND_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8019019Cu32 as _);
pub const HTTP_E_STATUS_PROXY_AUTH_REQ: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190197u32 as _);
pub const HTTP_E_STATUS_RANGE_NOT_SATISFIABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801901A0u32 as _);
pub const HTTP_E_STATUS_REDIRECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8019012Eu32 as _);
pub const HTTP_E_STATUS_REDIRECT_KEEP_VERB: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190133u32 as _);
pub const HTTP_E_STATUS_REDIRECT_METHOD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8019012Fu32 as _);
pub const HTTP_E_STATUS_REQUEST_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190198u32 as _);
pub const HTTP_E_STATUS_REQUEST_TOO_LARGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8019019Du32 as _);
pub const HTTP_E_STATUS_SERVER_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801901F4u32 as _);
pub const HTTP_E_STATUS_SERVICE_UNAVAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801901F7u32 as _);
pub const HTTP_E_STATUS_UNEXPECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190001u32 as _);
pub const HTTP_E_STATUS_UNEXPECTED_CLIENT_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190004u32 as _);
pub const HTTP_E_STATUS_UNEXPECTED_REDIRECTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190003u32 as _);
pub const HTTP_E_STATUS_UNEXPECTED_SERVER_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190005u32 as _);
pub const HTTP_E_STATUS_UNSUPPORTED_MEDIA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8019019Fu32 as _);
pub const HTTP_E_STATUS_URI_TOO_LONG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8019019Eu32 as _);
pub const HTTP_E_STATUS_USE_PROXY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80190131u32 as _);
pub const HTTP_E_STATUS_VERSION_NOT_SUP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801901F9u32 as _);
pub const INPLACE_E_FIRST: i32 = -2147221088i32;
pub const INPLACE_E_LAST: i32 = -2147221073i32;
pub const INPLACE_E_NOTOOLSPACE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401A1u32 as _);
pub const INPLACE_E_NOTUNDOABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401A0u32 as _);
pub const INPLACE_S_FIRST: i32 = 262560i32;
pub const INPLACE_S_LAST: i32 = 262575i32;
pub const INPLACE_S_TRUNCATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x401A0u32 as _);
pub const INPUT_E_DEVICE_INFO: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80400006u32 as _);
pub const INPUT_E_DEVICE_PROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80400008u32 as _);
pub const INPUT_E_FRAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80400004u32 as _);
pub const INPUT_E_HISTORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80400005u32 as _);
pub const INPUT_E_MULTIMODAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80400002u32 as _);
pub const INPUT_E_OUT_OF_ORDER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80400000u32 as _);
pub const INPUT_E_PACKET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80400003u32 as _);
pub const INPUT_E_REENTRANCY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80400001u32 as _);
pub const INPUT_E_TRANSFORM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80400007u32 as _);
pub const INVALID_HANDLE_VALUE: HANDLE = HANDLE(-1i32 as _);
pub const IORING_E_COMPLETION_QUEUE_TOO_BIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80460005u32 as _);
pub const IORING_E_COMPLETION_QUEUE_TOO_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80460008u32 as _);
pub const IORING_E_CORRUPT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80460007u32 as _);
pub const IORING_E_REQUIRED_FLAG_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80460001u32 as _);
pub const IORING_E_SUBMISSION_QUEUE_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80460002u32 as _);
pub const IORING_E_SUBMISSION_QUEUE_TOO_BIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80460004u32 as _);
pub const IORING_E_SUBMIT_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80460006u32 as _);
pub const IORING_E_VERSION_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80460003u32 as _);
...
pub const LANGUAGE_E_DATABASE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041784u32 as _);
pub const LANGUAGE_S_LARGE_WORD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41781u32 as _);
...
pub const MEM_E_INVALID_LINK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080010u32 as _);
pub const MEM_E_INVALID_ROOT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080009u32 as _);
pub const MEM_E_INVALID_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080011u32 as _);
pub const MENROLL_S_ENROLLMENT_SUSPENDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x180011u32 as _);
pub const MILAVERR_INSUFFICIENTVIDEORESOURCES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980508u32 as _);
pub const MILAVERR_INVALIDWMPVERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980507u32 as _);
pub const MILAVERR_MEDIAPLAYERCLOSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898050Du32 as _);
pub const MILAVERR_MODULENOTLOADED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980505u32 as _);
pub const MILAVERR_NOCLOCK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980500u32 as _);
pub const MILAVERR_NOMEDIATYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980501u32 as _);
pub const MILAVERR_NOREADYFRAMES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980504u32 as _);
pub const MILAVERR_NOVIDEOMIXER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980502u32 as _);
pub const MILAVERR_NOVIDEOPRESENTER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980503u32 as _);
pub const MILAVERR_REQUESTEDTEXTURETOOBIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898050Au32 as _);
pub const MILAVERR_SEEKFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898050Bu32 as _);
pub const MILAVERR_UNEXPECTEDWMPFAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898050Cu32 as _);
pub const MILAVERR_UNKNOWNHARDWAREERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898050Eu32 as _);
pub const MILAVERR_VIDEOACCELERATIONNOTAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980509u32 as _);
pub const MILAVERR_WMPFACTORYNOTREGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980506u32 as _);
pub const MILEFFECTSERR_ALREADYATTACHEDTOLISTENER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980618u32 as _);
pub const MILEFFECTSERR_CONNECTORNOTASSOCIATEDWITHEFFECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980612u32 as _);
pub const MILEFFECTSERR_CONNECTORNOTCONNECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980611u32 as _);
pub const MILEFFECTSERR_CYCLEDETECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980614u32 as _);
pub const MILEFFECTSERR_EFFECTALREADYINAGRAPH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980616u32 as _);
pub const MILEFFECTSERR_EFFECTHASNOCHILDREN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980617u32 as _);
pub const MILEFFECTSERR_EFFECTINMORETHANONEGRAPH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980615u32 as _);
pub const MILEFFECTSERR_EFFECTNOTPARTOFGROUP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898060Fu32 as _);
pub const MILEFFECTSERR_EMPTYBOUNDS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898061Au32 as _);
pub const MILEFFECTSERR_NOINPUTSOURCEATTACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980610u32 as _);
pub const MILEFFECTSERR_NOTAFFINETRANSFORM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980619u32 as _);
pub const MILEFFECTSERR_OUTPUTSIZETOOLARGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898061Bu32 as _);
pub const MILEFFECTSERR_RESERVED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980613u32 as _);
pub const MILEFFECTSERR_UNKNOWNPROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898060Eu32 as _);
pub const MILERR_ADAPTER_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898009Eu32 as _);
pub const MILERR_ALREADYLOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980086u32 as _);
pub const MILERR_ALREADY_INITIALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898008Fu32 as _);
pub const MILERR_BADNUMBER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898000Au32 as _);
pub const MILERR_COLORSPACE_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898009Fu32 as _);
pub const MILERR_DEVICECANNOTRENDERTEXT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980088u32 as _);
pub const MILERR_DISPLAYFORMATNOTSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980084u32 as _);
pub const MILERR_DISPLAYID_ACCESS_DENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x889800A1u32 as _);
pub const MILERR_DISPLAYSTATEINVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980006u32 as _);
pub const MILERR_DXGI_ENUMERATION_OUT_OF_SYNC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898009Du32 as _);
pub const MILERR_GENERIC_IGNORE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898008Bu32 as _);
pub const MILERR_GLYPHBITMAPMISSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980089u32 as _);
pub const MILERR_INSUFFICIENTBUFFER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980002u32 as _);
pub const MILERR_INTERNALERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980080u32 as _);
pub const MILERR_INVALIDCALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980085u32 as _);
pub const MILERR_MALFORMEDGLYPHCACHE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898008Au32 as _);
pub const MILERR_MALFORMED_GUIDELINE_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898008Cu32 as _);
pub const MILERR_MAX_TEXTURE_SIZE_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898009Au32 as _);
pub const MILERR_MISMATCHED_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980090u32 as _);
pub const MILERR_MROW_READLOCK_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980097u32 as _);
pub const MILERR_MROW_UPDATE_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980098u32 as _);
pub const MILERR_NEED_RECREATE_AND_PRESENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898008Eu32 as _);
pub const MILERR_NONINVERTIBLEMATRIX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980007u32 as _);
pub const MILERR_NOTLOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980087u32 as _);
pub const MILERR_NOT_QUEUING_PRESENTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980094u32 as _);
pub const MILERR_NO_HARDWARE_DEVICE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898008Du32 as _);
pub const MILERR_NO_REDIRECTION_SURFACE_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980091u32 as _);
pub const MILERR_NO_REDIRECTION_SURFACE_RETRY_LATER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980095u32 as _);
pub const MILERR_OBJECTBUSY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980001u32 as _);
pub const MILERR_PREFILTER_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x889800A0u32 as _);
pub const MILERR_QPC_TIME_WENT_BACKWARD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898009Bu32 as _);
pub const MILERR_QUEUED_PRESENT_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980093u32 as _);
pub const MILERR_REMOTING_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980092u32 as _);
pub const MILERR_SCANNER_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980004u32 as _);
pub const MILERR_SCREENACCESSDENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980005u32 as _);
pub const MILERR_SHADER_COMPILE_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980099u32 as _);
pub const MILERR_TERMINATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980009u32 as _);
pub const MILERR_TOOMANYSHADERELEMNTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980096u32 as _);
pub const MILERR_WIN32ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980003u32 as _);
pub const MILERR_ZEROVECTOR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980008u32 as _);
pub const MK_E_CANTOPENFILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401EAu32 as _);
pub const MK_E_CONNECTMANUALLY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401E0u32 as _);
pub const MK_E_ENUMERATION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401EFu32 as _);
pub const MK_E_EXCEEDEDDEADLINE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401E1u32 as _);
pub const MK_E_FIRST: i32 = -2147221024i32;
pub const MK_E_INTERMEDIATEINTERFACENOTSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401E7u32 as _);
pub const MK_E_INVALIDEXTENSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401E6u32 as _);
pub const MK_E_LAST: i32 = -2147221009i32;
pub const MK_E_MUSTBOTHERUSER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401EBu32 as _);
pub const MK_E_NEEDGENERIC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401E2u32 as _);
pub const MK_E_NOINVERSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401ECu32 as _);
pub const MK_E_NOOBJECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401E5u32 as _);
pub const MK_E_NOPREFIX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401EEu32 as _);
pub const MK_E_NOSTORAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401EDu32 as _);
pub const MK_E_NOTBINDABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401E8u32 as _);
pub const MK_E_NOTBOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401E9u32 as _);
pub const MK_E_NO_NORMALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80080007u32 as _);
pub const MK_E_SYNTAX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401E4u32 as _);
pub const MK_E_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800401E3u32 as _);
pub const MK_S_FIRST: i32 = 262624i32;
pub const MK_S_HIM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x401E5u32 as _);
pub const MK_S_LAST: i32 = 262639i32;
pub const MK_S_ME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x401E4u32 as _);
pub const MK_S_MONIKERALREADYREGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x401E7u32 as _);
pub const MK_S_REDUCED_TO_SELF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x401E2u32 as _);
pub const MK_S_US: ::windows_core::HRESULT = ::windows_core::HRESULT(0x401E6u32 as _);
pub const MSDTC_E_DUPLICATE_RESOURCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80110701u32 as _);
pub const MSSIPOTF_E_BADVERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097015u32 as _);
pub const MSSIPOTF_E_BAD_FIRST_TABLE_PLACEMENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097008u32 as _);
pub const MSSIPOTF_E_BAD_MAGICNUMBER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097004u32 as _);
pub const MSSIPOTF_E_BAD_OFFSET_TABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097005u32 as _);
pub const MSSIPOTF_E_CANTGETOBJECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097002u32 as _);
pub const MSSIPOTF_E_CRYPT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097014u32 as _);
pub const MSSIPOTF_E_DSIG_STRUCTURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097016u32 as _);
pub const MSSIPOTF_E_FAILED_HINTS_CHECK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097011u32 as _);
pub const MSSIPOTF_E_FAILED_POLICY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097010u32 as _);
pub const MSSIPOTF_E_FILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097013u32 as _);
pub const MSSIPOTF_E_FILETOOSMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009700Bu32 as _);
pub const MSSIPOTF_E_FILE_CHECKSUM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009700Du32 as _);
pub const MSSIPOTF_E_NOHEADTABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097003u32 as _);
pub const MSSIPOTF_E_NOT_OPENTYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097012u32 as _);
pub const MSSIPOTF_E_OUTOFMEMRANGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097001u32 as _);
pub const MSSIPOTF_E_PCONST_CHECK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097017u32 as _);
pub const MSSIPOTF_E_STRUCTURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097018u32 as _);
pub const MSSIPOTF_E_TABLES_OVERLAP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097009u32 as _);
pub const MSSIPOTF_E_TABLE_CHECKSUM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009700Cu32 as _);
pub const MSSIPOTF_E_TABLE_LONGWORD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097007u32 as _);
pub const MSSIPOTF_E_TABLE_PADBYTES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009700Au32 as _);
pub const MSSIPOTF_E_TABLE_TAGORDER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80097006u32 as _);
pub const NAP_E_CONFLICTING_ID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270003u32 as _);
pub const NAP_E_ENTITY_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8027000Eu32 as _);
pub const NAP_E_ID_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8027000Au32 as _);
pub const NAP_E_INVALID_PACKET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270001u32 as _);
pub const NAP_E_MAXSIZE_TOO_SMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8027000Bu32 as _);
pub const NAP_E_MISMATCHED_ID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270008u32 as _);
pub const NAP_E_MISSING_SOH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270002u32 as _);
pub const NAP_E_NETSH_GROUPPOLICY_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8027000Fu32 as _);
pub const NAP_E_NOT_INITIALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270007u32 as _);
pub const NAP_E_NOT_PENDING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270009u32 as _);
pub const NAP_E_NOT_REGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270006u32 as _);
pub const NAP_E_NO_CACHED_SOH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270004u32 as _);
pub const NAP_E_SERVICE_NOT_RUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8027000Cu32 as _);
pub const NAP_E_SHV_CONFIG_EXISTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270011u32 as _);
pub const NAP_E_SHV_CONFIG_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270012u32 as _);
pub const NAP_E_SHV_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270013u32 as _);
pub const NAP_E_STILL_BOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270005u32 as _);
pub const NAP_E_TOO_MANY_CALLS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80270010u32 as _);
pub const NAP_S_CERT_ALREADY_PRESENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x27000Du32 as _);
pub const NOERROR: u32 = 0u32;
pub const NOT_AN_ERROR1: ::windows_core::HRESULT = ::windows_core::HRESULT(0x81600u32 as _);
pub const NO_ERROR: WIN32_ERROR = WIN32_ERROR(0u32);
pub const NTDDI_MAXVER: u32 = 2560u32;
pub const NTE_AUTHENTICATION_IGNORED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090031u32 as _);
pub const NTE_BAD_ALGID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090008u32 as _);
pub const NTE_BAD_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090005u32 as _);
pub const NTE_BAD_FLAGS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090009u32 as _);
pub const NTE_BAD_HASH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090002u32 as _);
pub const NTE_BAD_HASH_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009000Cu32 as _);
pub const NTE_BAD_KEY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090003u32 as _);
pub const NTE_BAD_KEYSET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090016u32 as _);
pub const NTE_BAD_KEYSET_PARAM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009001Fu32 as _);
pub const NTE_BAD_KEY_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009000Bu32 as _);
pub const NTE_BAD_LEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090004u32 as _);
pub const NTE_BAD_PROVIDER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090013u32 as _);
pub const NTE_BAD_PROV_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090014u32 as _);
pub const NTE_BAD_PUBLIC_KEY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090015u32 as _);
pub const NTE_BAD_SIGNATURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090006u32 as _);
pub const NTE_BAD_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009000Au32 as _);
pub const NTE_BAD_UID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090001u32 as _);
pub const NTE_BAD_VER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090007u32 as _);
pub const NTE_BUFFERS_OVERLAP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009002Bu32 as _);
pub const NTE_BUFFER_TOO_SMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090028u32 as _);
pub const NTE_DECRYPTION_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009002Cu32 as _);
pub const NTE_DEVICE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090035u32 as _);
pub const NTE_DEVICE_NOT_READY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090030u32 as _);
pub const NTE_DOUBLE_ENCRYPT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090012u32 as _);
pub const NTE_ENCRYPTION_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090034u32 as _);
pub const NTE_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009000Fu32 as _);
pub const NTE_FAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090020u32 as _);
pub const NTE_FIXEDPARAMETER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090025u32 as _);
pub const NTE_HMAC_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009002Fu32 as _);
pub const NTE_INCORRECT_PASSWORD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090033u32 as _);
pub const NTE_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009002Du32 as _);
pub const NTE_INVALID_HANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090026u32 as _);
pub const NTE_INVALID_PARAMETER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090027u32 as _);
pub const NTE_KEYSET_ENTRY_BAD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009001Au32 as _);
pub const NTE_KEYSET_NOT_DEF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090019u32 as _);
pub const NTE_NOT_ACTIVE_CONSOLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090038u32 as _);
pub const NTE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090011u32 as _);
pub const NTE_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090029u32 as _);
pub const NTE_NO_KEY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009000Du32 as _);
pub const NTE_NO_MEMORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009000Eu32 as _);
pub const NTE_NO_MORE_ITEMS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009002Au32 as _);
pub const NTE_OP_OK: u32 = 0u32;
pub const NTE_PASSWORD_CHANGE_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090037u32 as _);
pub const NTE_PERM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090010u32 as _);
pub const NTE_PROVIDER_DLL_FAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009001Du32 as _);
pub const NTE_PROV_DLL_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009001Eu32 as _);
pub const NTE_PROV_TYPE_ENTRY_BAD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090018u32 as _);
pub const NTE_PROV_TYPE_NOT_DEF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090017u32 as _);
pub const NTE_PROV_TYPE_NO_MATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009001Bu32 as _);
pub const NTE_SIGNATURE_FILE_BAD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009001Cu32 as _);
pub const NTE_SILENT_CONTEXT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090022u32 as _);
pub const NTE_SYS_ERR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090021u32 as _);
pub const NTE_TEMPORARY_PROFILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090024u32 as _);
pub const NTE_TOKEN_KEYSET_STORAGE_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090023u32 as _);
pub const NTE_UI_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009002Eu32 as _);
pub const NTE_USER_CANCELLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090036u32 as _);
pub const NTE_VALIDATION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090032u32 as _);
pub const OLEOBJ_E_FIRST: i32 = -2147221120i32;
pub const OLEOBJ_E_INVALIDVERB: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040181u32 as _);
pub const OLEOBJ_E_LAST: i32 = -2147221105i32;
pub const OLEOBJ_E_NOVERBS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040180u32 as _);
pub const OLEOBJ_S_CANNOT_DOVERB_NOW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40181u32 as _);
pub const OLEOBJ_S_FIRST: i32 = 262528i32;
pub const OLEOBJ_S_INVALIDHWND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40182u32 as _);
pub const OLEOBJ_S_INVALIDVERB: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40180u32 as _);
pub const OLEOBJ_S_LAST: i32 = 262543i32;
pub const OLE_E_ADVF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040001u32 as _);
pub const OLE_E_ADVISENOTSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040003u32 as _);
pub const OLE_E_BLANK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040007u32 as _);
pub const OLE_E_CANTCONVERT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040011u32 as _);
pub const OLE_E_CANT_BINDTOSOURCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004000Au32 as _);
pub const OLE_E_CANT_GETMONIKER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040009u32 as _);
pub const OLE_E_CLASSDIFF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040008u32 as _);
pub const OLE_E_ENUM_NOMORE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040002u32 as _);
pub const OLE_E_FIRST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040000u32 as _);
pub const OLE_E_INVALIDHWND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004000Fu32 as _);
pub const OLE_E_INVALIDRECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004000Du32 as _);
pub const OLE_E_LAST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800400FFu32 as _);
pub const OLE_E_NOCACHE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040006u32 as _);
pub const OLE_E_NOCONNECTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040004u32 as _);
pub const OLE_E_NOSTORAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040012u32 as _);
pub const OLE_E_NOTRUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040005u32 as _);
pub const OLE_E_NOT_INPLACEACTIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040010u32 as _);
pub const OLE_E_OLEVERB: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040000u32 as _);
pub const OLE_E_PROMPTSAVECANCELLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004000Cu32 as _);
pub const OLE_E_STATIC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004000Bu32 as _);
pub const OLE_E_WRONGCOMPOBJ: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004000Eu32 as _);
pub const OLE_S_FIRST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40000u32 as _);
pub const OLE_S_LAST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x400FFu32 as _);
pub const OLE_S_MAC_CLIPFORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40002u32 as _);
pub const OLE_S_STATIC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40001u32 as _);
pub const OLE_S_USEREG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40000u32 as _);
pub const ONL_CONNECTION_COUNT_LIMIT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8086000Du32 as _);
pub const ONL_E_ACCESS_DENIED_BY_TOU: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80860002u32 as _);
pub const ONL_E_ACCOUNT_LOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80860007u32 as _);
pub const ONL_E_ACCOUNT_SUSPENDED_ABUSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8086000Bu32 as _);
pub const ONL_E_ACCOUNT_SUSPENDED_COMPROIMISE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8086000Au32 as _);
pub const ONL_E_ACCOUNT_UPDATE_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80860005u32 as _);
pub const ONL_E_ACTION_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8086000Cu32 as _);
pub const ONL_E_CONNECTED_ACCOUNT_CAN_NOT_SIGNOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8086000Eu32 as _);
pub const ONL_E_EMAIL_VERIFICATION_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80860009u32 as _);
pub const ONL_E_FORCESIGNIN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80860006u32 as _);
pub const ONL_E_INVALID_APPLICATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80860003u32 as _);
pub const ONL_E_INVALID_AUTHENTICATION_TARGET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80860001u32 as _);
pub const ONL_E_PARENTAL_CONSENT_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80860008u32 as _);
pub const ONL_E_PASSWORD_UPDATE_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80860004u32 as _);
pub const ONL_E_REQUEST_THROTTLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80860010u32 as _);
pub const ONL_E_USER_AUTHENTICATION_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8086000Fu32 as _);
pub const OR_INVALID_OID: i32 = 1911i32;
pub const OR_INVALID_OXID: i32 = 1910i32;
pub const OR_INVALID_SET: i32 = 1912i32;
pub const OSS_ACCESS_SERIALIZATION_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093013u32 as _);
pub const OSS_API_DLL_NOT_LINKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093029u32 as _);
pub const OSS_BAD_ARG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093006u32 as _);
pub const OSS_BAD_ENCRULES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093016u32 as _);
pub const OSS_BAD_PTR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009300Bu32 as _);
pub const OSS_BAD_TABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009300Fu32 as _);
pub const OSS_BAD_TIME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009300Cu32 as _);
pub const OSS_BAD_VERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093007u32 as _);
pub const OSS_BERDER_DLL_NOT_LINKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009302Au32 as _);
pub const OSS_CANT_CLOSE_TRACE_FILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009302Eu32 as _);
pub const OSS_CANT_OPEN_TRACE_FILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009301Bu32 as _);
pub const OSS_CANT_OPEN_TRACE_WINDOW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093018u32 as _);
pub const OSS_COMPARATOR_CODE_NOT_LINKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093025u32 as _);
pub const OSS_COMPARATOR_DLL_NOT_LINKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093024u32 as _);
pub const OSS_CONSTRAINT_DLL_NOT_LINKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093023u32 as _);
pub const OSS_CONSTRAINT_VIOLATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093011u32 as _);
pub const OSS_COPIER_DLL_NOT_LINKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093022u32 as _);
pub const OSS_DATA_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093005u32 as _);
pub const OSS_FATAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093012u32 as _);
pub const OSS_INDEFINITE_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009300Du32 as _);
pub const OSS_LIMITED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009300Au32 as _);
pub const OSS_MEM_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009300Eu32 as _);
pub const OSS_MEM_MGR_DLL_NOT_LINKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093026u32 as _);
pub const OSS_MORE_BUF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093001u32 as _);
pub const OSS_MORE_INPUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093004u32 as _);
pub const OSS_MUTEX_NOT_CREATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009302Du32 as _);
pub const OSS_NEGATIVE_UINTEGER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093002u32 as _);
pub const OSS_NULL_FCN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093015u32 as _);
pub const OSS_NULL_TBL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093014u32 as _);
pub const OSS_OID_DLL_NOT_LINKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009301Au32 as _);
pub const OSS_OPEN_TYPE_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009302Cu32 as _);
pub const OSS_OUT_MEMORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093008u32 as _);
pub const OSS_OUT_OF_RANGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093021u32 as _);
pub const OSS_PDU_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093009u32 as _);
pub const OSS_PDU_RANGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093003u32 as _);
pub const OSS_PDV_CODE_NOT_LINKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093028u32 as _);
pub const OSS_PDV_DLL_NOT_LINKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093027u32 as _);
pub const OSS_PER_DLL_NOT_LINKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009302Bu32 as _);
pub const OSS_REAL_CODE_NOT_LINKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093020u32 as _);
pub const OSS_REAL_DLL_NOT_LINKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009301Fu32 as _);
pub const OSS_TABLE_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009301Du32 as _);
pub const OSS_TOO_LONG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093010u32 as _);
pub const OSS_TRACE_FILE_ALREADY_OPEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009301Cu32 as _);
pub const OSS_TYPE_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009301Eu32 as _);
pub const OSS_UNAVAIL_ENCRULES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093017u32 as _);
pub const OSS_UNIMPLEMENTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80093019u32 as _);
...
pub const PEER_E_ALREADY_LISTENING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630107u32 as _);
pub const PEER_E_CANNOT_CONVERT_PEER_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80634001u32 as _);
pub const PEER_E_CANNOT_START_SERVICE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630003u32 as _);
pub const PEER_E_CERT_STORE_CORRUPTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630801u32 as _);
pub const PEER_E_CHAIN_TOO_LONG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630703u32 as _);
pub const PEER_E_CIRCULAR_CHAIN_DETECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630706u32 as _);
pub const PEER_E_CLASSIFIER_TOO_LONG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630201u32 as _);
pub const PEER_E_CLOUD_NAME_AMBIGUOUS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80631005u32 as _);
pub const PEER_E_CONNECTION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630109u32 as _);
pub const PEER_E_CONNECTION_NOT_AUTHENTICATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8063010Au32 as _);
pub const PEER_E_CONNECTION_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630103u32 as _);
pub const PEER_E_CONNECTION_REFUSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8063010Bu32 as _);
pub const PEER_E_CONNECT_SELF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630106u32 as _);
pub const PEER_E_CONTACT_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80636001u32 as _);
pub const PEER_E_DATABASE_ACCESSDENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630302u32 as _);
pub const PEER_E_DATABASE_ALREADY_PRESENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630305u32 as _);
pub const PEER_E_DATABASE_NOT_PRESENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630306u32 as _);
pub const PEER_E_DBINITIALIZATION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630303u32 as _);
pub const PEER_E_DBNAME_CHANGED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630011u32 as _);
pub const PEER_E_DEFERRED_VALIDATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632030u32 as _);
pub const PEER_E_DUPLICATE_GRAPH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630012u32 as _);
pub const PEER_E_EVENT_HANDLE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630501u32 as _);
pub const PEER_E_FW_BLOCKED_BY_POLICY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80637009u32 as _);
pub const PEER_E_FW_BLOCKED_BY_SHIELDS_UP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8063700Au32 as _);
pub const PEER_E_FW_DECLINED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8063700Bu32 as _);
pub const PEER_E_FW_EXCEPTION_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80637008u32 as _);
pub const PEER_E_GRAPH_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630015u32 as _);
pub const PEER_E_GRAPH_NOT_READY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630013u32 as _);
pub const PEER_E_GRAPH_SHUTTING_DOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630014u32 as _);
pub const PEER_E_GROUPS_EXIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630204u32 as _);
pub const PEER_E_GROUP_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632092u32 as _);
pub const PEER_E_GROUP_NOT_READY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632091u32 as _);
pub const PEER_E_IDENTITY_DELETED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x806320A0u32 as _);
pub const PEER_E_IDENTITY_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630401u32 as _);
pub const PEER_E_INVALID_ADDRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80637007u32 as _);
pub const PEER_E_INVALID_ATTRIBUTES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630602u32 as _);
pub const PEER_E_INVALID_CLASSIFIER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632060u32 as _);
pub const PEER_E_INVALID_CLASSIFIER_PROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632072u32 as _);
pub const PEER_E_INVALID_CREDENTIAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632082u32 as _);
pub const PEER_E_INVALID_CREDENTIAL_INFO: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632081u32 as _);
pub const PEER_E_INVALID_DATABASE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630016u32 as _);
pub const PEER_E_INVALID_FRIENDLY_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632070u32 as _);
pub const PEER_E_INVALID_GRAPH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630010u32 as _);
pub const PEER_E_INVALID_GROUP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632093u32 as _);
pub const PEER_E_INVALID_GROUP_PROPERTIES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632040u32 as _);
pub const PEER_E_INVALID_PEER_HOST_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80634002u32 as _);
pub const PEER_E_INVALID_PEER_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632050u32 as _);
pub const PEER_E_INVALID_RECORD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632010u32 as _);
pub const PEER_E_INVALID_RECORD_EXPIRATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632080u32 as _);
pub const PEER_E_INVALID_RECORD_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632083u32 as _);
pub const PEER_E_INVALID_ROLE_PROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632071u32 as _);
pub const PEER_E_INVALID_SEARCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630601u32 as _);
pub const PEER_E_INVALID_TIME_PERIOD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630705u32 as _);
pub const PEER_E_INVITATION_NOT_TRUSTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630701u32 as _);
pub const PEER_E_INVITE_CANCELLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80637000u32 as _);
pub const PEER_E_INVITE_RESPONSE_NOT_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80637001u32 as _);
pub const PEER_E_IPV6_NOT_INSTALLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630001u32 as _);
pub const PEER_E_MAX_RECORD_SIZE_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630304u32 as _);
pub const PEER_E_NODE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630108u32 as _);
pub const PEER_E_NOT_AUTHORIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632020u32 as _);
pub const PEER_E_NOT_INITIALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630002u32 as _);
pub const PEER_E_NOT_LICENSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630004u32 as _);
pub const PEER_E_NOT_SIGNED_IN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80637003u32 as _);
pub const PEER_E_NO_CLOUD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80631001u32 as _);
pub const PEER_E_NO_KEY_ACCESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630203u32 as _);
pub const PEER_E_NO_MEMBERS_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632094u32 as _);
pub const PEER_E_NO_MEMBER_CONNECTIONS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632095u32 as _);
pub const PEER_E_NO_MORE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80634003u32 as _);
pub const PEER_E_PASSWORD_DOES_NOT_MEET_POLICY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632021u32 as _);
pub const PEER_E_PNRP_DUPLICATE_PEER_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80634005u32 as _);
pub const PEER_E_PRIVACY_DECLINED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80637004u32 as _);
pub const PEER_E_RECORD_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630301u32 as _);
pub const PEER_E_SERVICE_NOT_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x806320A1u32 as _);
pub const PEER_E_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80637005u32 as _);
pub const PEER_E_TOO_MANY_ATTRIBUTES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630017u32 as _);
pub const PEER_E_TOO_MANY_IDENTITIES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80630202u32 as _);
pub const PEER_E_UNABLE_TO_LISTEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632096u32 as _);
pub const PEER_E_UNSUPPORTED_VERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80632090u32 as _);
pub const PEER_S_ALREADY_A_MEMBER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x630006u32 as _);
pub const PEER_S_ALREADY_CONNECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x632000u32 as _);
pub const PEER_S_GRAPH_DATA_CREATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x630001u32 as _);
pub const PEER_S_NO_CONNECTIVITY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x630005u32 as _);
pub const PEER_S_NO_EVENT_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x630002u32 as _);
pub const PEER_S_SUBSCRIPTION_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x636000u32 as _);
pub const PERSIST_E_NOTSELFSIZING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B000Bu32 as _);
pub const PERSIST_E_SIZEDEFINITE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0009u32 as _);
pub const PERSIST_E_SIZEINDEFINITE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B000Au32 as _);
pub const PLA_E_CABAPI_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80300113u32 as _);
pub const PLA_E_CONFLICT_INCL_EXCL_API: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80300105u32 as _);
pub const PLA_E_CREDENTIALS_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80300103u32 as _);
pub const PLA_E_DCS_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803000B7u32 as _);
pub const PLA_E_DCS_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803000AAu32 as _);
pub const PLA_E_DCS_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80300002u32 as _);
pub const PLA_E_DCS_NOT_RUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80300104u32 as _);
pub const PLA_E_DCS_SINGLETON_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80300102u32 as _);
pub const PLA_E_DCS_START_WAIT_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8030010Au32 as _);
pub const PLA_E_DC_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80300109u32 as _);
pub const PLA_E_DC_START_WAIT_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8030010Bu32 as _);
pub const PLA_E_EXE_ALREADY_CONFIGURED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80300107u32 as _);
pub const PLA_E_EXE_FULL_PATH_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8030010Eu32 as _);
pub const PLA_E_EXE_PATH_NOT_VALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80300108u32 as _);
pub const PLA_E_INVALID_SESSION_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8030010Fu32 as _);
pub const PLA_E_NETWORK_EXE_NOT_VALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80300106u32 as _);
pub const PLA_E_NO_DUPLICATES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8030010Du32 as _);
pub const PLA_E_NO_MIN_DISK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80300070u32 as _);
pub const PLA_E_PLA_CHANNEL_NOT_ENABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80300110u32 as _);
pub const PLA_E_PROPERTY_CONFLICT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80300101u32 as _);
pub const PLA_E_REPORT_WAIT_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8030010Cu32 as _);
pub const PLA_E_RULES_MANAGER_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80300112u32 as _);
pub const PLA_E_TASKSCHED_CHANNEL_NOT_ENABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80300111u32 as _);
pub const PLA_E_TOO_MANY_FOLDERS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80300045u32 as _);
pub const PLA_S_PROPERTY_IGNORED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x300100u32 as _);
pub const PRESENTATION_ERROR_LOST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88810001u32 as _);
pub const PSINK_E_INDEX_ONLY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041791u32 as _);
pub const PSINK_E_LARGE_ATTACHMENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041792u32 as _);
pub const PSINK_E_QUERY_ONLY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041790u32 as _);
pub const PSINK_S_LARGE_WORD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41793u32 as _);
pub const QPARSE_E_EXPECTING_BRACE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041666u32 as _);
pub const QPARSE_E_EXPECTING_COMMA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041671u32 as _);
pub const QPARSE_E_EXPECTING_CURRENCY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041664u32 as _);
pub const QPARSE_E_EXPECTING_DATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041663u32 as _);
pub const QPARSE_E_EXPECTING_EOS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041670u32 as _);
pub const QPARSE_E_EXPECTING_GUID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041665u32 as _);
pub const QPARSE_E_EXPECTING_INTEGER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041661u32 as _);
pub const QPARSE_E_EXPECTING_PAREN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041667u32 as _);
pub const QPARSE_E_EXPECTING_PHRASE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004166Au32 as _);
pub const QPARSE_E_EXPECTING_PROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041668u32 as _);
pub const QPARSE_E_EXPECTING_REAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041662u32 as _);
pub const QPARSE_E_EXPECTING_REGEX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004166Cu32 as _);
pub const QPARSE_E_EXPECTING_REGEX_PROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004166Du32 as _);
pub const QPARSE_E_INVALID_GROUPING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041677u32 as _);
pub const QPARSE_E_INVALID_LITERAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004166Eu32 as _);
pub const QPARSE_E_INVALID_QUERY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004167Au32 as _);
pub const QPARSE_E_INVALID_RANKMETHOD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004167Bu32 as _);
pub const QPARSE_E_INVALID_SORT_ORDER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041675u32 as _);
pub const QPARSE_E_NOT_YET_IMPLEMENTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041669u32 as _);
pub const QPARSE_E_NO_SUCH_PROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004166Fu32 as _);
pub const QPARSE_E_NO_SUCH_SORT_PROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041674u32 as _);
pub const QPARSE_E_UNEXPECTED_EOS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041672u32 as _);
pub const QPARSE_E_UNEXPECTED_NOT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041660u32 as _);
pub const QPARSE_E_UNSUPPORTED_PROPERTY_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004166Bu32 as _);
pub const QPARSE_E_WEIGHT_OUT_OF_RANGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041673u32 as _);
pub const QPLIST_E_BAD_GUID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041659u32 as _);
pub const QPLIST_E_BYREF_USED_WITHOUT_PTRTYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004165Eu32 as _);
pub const QPLIST_E_CANT_OPEN_FILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041651u32 as _);
pub const QPLIST_E_CANT_SET_PROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004165Bu32 as _);
pub const QPLIST_E_DUPLICATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004165Cu32 as _);
pub const QPLIST_E_EXPECTING_CLOSE_PAREN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041657u32 as _);
pub const QPLIST_E_EXPECTING_GUID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041658u32 as _);
pub const QPLIST_E_EXPECTING_INTEGER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041656u32 as _);
pub const QPLIST_E_EXPECTING_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041653u32 as _);
pub const QPLIST_E_EXPECTING_PROP_SPEC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004165Au32 as _);
pub const QPLIST_E_EXPECTING_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041654u32 as _);
pub const QPLIST_E_READ_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041652u32 as _);
pub const QPLIST_E_UNRECOGNIZED_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041655u32 as _);
pub const QPLIST_E_VECTORBYREF_USED_ALONE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004165Du32 as _);
pub const QPLIST_S_DUPLICATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41679u32 as _);
pub const QUERY_E_ALLNOISE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041605u32 as _);
pub const QUERY_E_DIR_ON_REMOVABLE_DRIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004160Bu32 as _);
pub const QUERY_E_DUPLICATE_OUTPUT_COLUMN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041608u32 as _);
pub const QUERY_E_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041600u32 as _);
pub const QUERY_E_INVALIDCATEGORIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041604u32 as _);
pub const QUERY_E_INVALIDQUERY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041601u32 as _);
pub const QUERY_E_INVALIDRESTRICTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041602u32 as _);
pub const QUERY_E_INVALIDSORT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041603u32 as _);
pub const QUERY_E_INVALID_DIRECTORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004160Au32 as _);
pub const QUERY_E_INVALID_OUTPUT_COLUMN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041609u32 as _);
pub const QUERY_E_TIMEDOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041607u32 as _);
pub const QUERY_E_TOOCOMPLEX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041606u32 as _);
pub const QUERY_S_NO_QUERY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004160Cu32 as _);
pub const QUTIL_E_CANT_CONVERT_VROOT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041676u32 as _);
pub const QUTIL_E_INVALID_CODEPAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0041678u32 as _);
pub const REGDB_E_BADTHREADINGMODEL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040156u32 as _);
pub const REGDB_E_CLASSNOTREG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040154u32 as _);
pub const REGDB_E_FIRST: i32 = -2147221168i32;
pub const REGDB_E_IIDNOTREG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040155u32 as _);
pub const REGDB_E_INVALIDVALUE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040153u32 as _);
pub const REGDB_E_KEYMISSING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040152u32 as _);
pub const REGDB_E_LAST: i32 = -2147221153i32;
pub const REGDB_E_PACKAGEPOLICYVIOLATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040157u32 as _);
pub const REGDB_E_READREGDB: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040150u32 as _);
pub const REGDB_E_WRITEREGDB: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040151u32 as _);
...
pub const RO_E_BLOCKED_CROSS_ASTA_CALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000001Fu32 as _);
pub const RO_E_CANNOT_ACTIVATE_FULL_TRUST_SERVER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80000020u32 as _);
pub const RO_E_CANNOT_ACTIVATE_UNIVERSAL_APPLICATION_SERVER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80000021u32 as _);
pub const RO_E_CHANGE_NOTIFICATION_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80000015u32 as _);
pub const RO_E_CLOSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80000013u32 as _);
pub const RO_E_COMMITTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000001Eu32 as _);
pub const RO_E_ERROR_STRING_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80000016u32 as _);
pub const RO_E_EXCLUSIVE_WRITE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80000014u32 as _);
pub const RO_E_INVALID_METADATA_FILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80000012u32 as _);
pub const RO_E_METADATA_INVALID_TYPE_FORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80000011u32 as _);
pub const RO_E_METADATA_NAME_IS_NAMESPACE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80000010u32 as _);
pub const RO_E_METADATA_NAME_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000000Fu32 as _);
pub const RO_E_MUST_BE_AGILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000001Cu32 as _);
pub const RO_E_UNSUPPORTED_FROM_MTA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000001Du32 as _);
pub const RPC_E_ACCESS_DENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001011Bu32 as _);
pub const RPC_E_ATTEMPTED_MULTITHREAD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010102u32 as _);
pub const RPC_E_CALL_CANCELED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010002u32 as _);
pub const RPC_E_CALL_COMPLETE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010117u32 as _);
pub const RPC_E_CALL_REJECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010001u32 as _);
pub const RPC_E_CANTCALLOUT_AGAIN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010011u32 as _);
pub const RPC_E_CANTCALLOUT_INASYNCCALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010004u32 as _);
pub const RPC_E_CANTCALLOUT_INEXTERNALCALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010005u32 as _);
pub const RPC_E_CANTCALLOUT_ININPUTSYNCCALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001010Du32 as _);
pub const RPC_E_CANTPOST_INSENDCALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010003u32 as _);
pub const RPC_E_CANTTRANSMIT_CALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001000Au32 as _);
pub const RPC_E_CHANGED_MODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010106u32 as _);
pub const RPC_E_CLIENT_CANTMARSHAL_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001000Bu32 as _);
pub const RPC_E_CLIENT_CANTUNMARSHAL_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001000Cu32 as _);
pub const RPC_E_CLIENT_DIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010008u32 as _);
pub const RPC_E_CONNECTION_TERMINATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010006u32 as _);
pub const RPC_E_DISCONNECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010108u32 as _);
pub const RPC_E_FAULT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010104u32 as _);
pub const RPC_E_FULLSIC_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010121u32 as _);
pub const RPC_E_INVALIDMETHOD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010107u32 as _);
pub const RPC_E_INVALID_CALLDATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001010Cu32 as _);
pub const RPC_E_INVALID_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001000Fu32 as _);
pub const RPC_E_INVALID_DATAPACKET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010009u32 as _);
pub const RPC_E_INVALID_EXTENSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010112u32 as _);
pub const RPC_E_INVALID_HEADER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010111u32 as _);
pub const RPC_E_INVALID_IPID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010113u32 as _);
pub const RPC_E_INVALID_OBJECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010114u32 as _);
pub const RPC_E_INVALID_OBJREF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001011Du32 as _);
pub const RPC_E_INVALID_PARAMETER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010010u32 as _);
pub const RPC_E_INVALID_STD_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010122u32 as _);
pub const RPC_E_NOT_REGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010103u32 as _);
pub const RPC_E_NO_CONTEXT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001011Eu32 as _);
pub const RPC_E_NO_GOOD_SECURITY_PACKAGES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001011Au32 as _);
pub const RPC_E_NO_SYNC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010120u32 as _);
pub const RPC_E_OUT_OF_RESOURCES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010101u32 as _);
pub const RPC_E_REMOTE_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001011Cu32 as _);
pub const RPC_E_RETRY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010109u32 as _);
pub const RPC_E_SERVERCALL_REJECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001010Bu32 as _);
pub const RPC_E_SERVERCALL_RETRYLATER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001010Au32 as _);
pub const RPC_E_SERVERFAULT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010105u32 as _);
pub const RPC_E_SERVER_CANTMARSHAL_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001000Du32 as _);
pub const RPC_E_SERVER_CANTUNMARSHAL_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001000Eu32 as _);
pub const RPC_E_SERVER_DIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010007u32 as _);
pub const RPC_E_SERVER_DIED_DNE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010012u32 as _);
pub const RPC_E_SYS_CALL_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010100u32 as _);
pub const RPC_E_THREAD_NOT_INIT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001010Fu32 as _);
pub const RPC_E_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001011Fu32 as _);
pub const RPC_E_TOO_LATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010119u32 as _);
pub const RPC_E_UNEXPECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001FFFFu32 as _);
pub const RPC_E_UNSECURE_CALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010118u32 as _);
pub const RPC_E_VERSION_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010110u32 as _);
pub const RPC_E_WRONG_THREAD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8001010Eu32 as _);
...
pub const RPC_S_CALLPENDING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010115u32 as _);
...
pub const RPC_S_WAITONTIMER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80010116u32 as _);
...
pub const SCARD_E_BAD_SEEK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100029u32 as _);
pub const SCARD_E_CANCELLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100002u32 as _);
pub const SCARD_E_CANT_DISPOSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010000Eu32 as _);
pub const SCARD_E_CARD_UNSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010001Cu32 as _);
pub const SCARD_E_CERTIFICATE_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010002Du32 as _);
pub const SCARD_E_COMM_DATA_LOST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010002Fu32 as _);
pub const SCARD_E_DIR_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100023u32 as _);
pub const SCARD_E_DUPLICATE_READER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010001Bu32 as _);
pub const SCARD_E_FILE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100024u32 as _);
pub const SCARD_E_ICC_CREATEORDER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100021u32 as _);
pub const SCARD_E_ICC_INSTALLATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100020u32 as _);
pub const SCARD_E_INSUFFICIENT_BUFFER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100008u32 as _);
pub const SCARD_E_INVALID_ATR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100015u32 as _);
pub const SCARD_E_INVALID_CHV: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010002Au32 as _);
pub const SCARD_E_INVALID_HANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100003u32 as _);
pub const SCARD_E_INVALID_PARAMETER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100004u32 as _);
pub const SCARD_E_INVALID_TARGET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100005u32 as _);
pub const SCARD_E_INVALID_VALUE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100011u32 as _);
pub const SCARD_E_NOT_READY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100010u32 as _);
pub const SCARD_E_NOT_TRANSACTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100016u32 as _);
pub const SCARD_E_NO_ACCESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100027u32 as _);
pub const SCARD_E_NO_DIR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100025u32 as _);
pub const SCARD_E_NO_FILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100026u32 as _);
pub const SCARD_E_NO_KEY_CONTAINER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100030u32 as _);
pub const SCARD_E_NO_MEMORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100006u32 as _);
pub const SCARD_E_NO_PIN_CACHE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100033u32 as _);
pub const SCARD_E_NO_READERS_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010002Eu32 as _);
pub const SCARD_E_NO_SERVICE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010001Du32 as _);
pub const SCARD_E_NO_SMARTCARD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010000Cu32 as _);
pub const SCARD_E_NO_SUCH_CERTIFICATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010002Cu32 as _);
pub const SCARD_E_PCI_TOO_SMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100019u32 as _);
pub const SCARD_E_PIN_CACHE_EXPIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100032u32 as _);
pub const SCARD_E_PROTO_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010000Fu32 as _);
pub const SCARD_E_READER_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100017u32 as _);
pub const SCARD_E_READER_UNSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010001Au32 as _);
pub const SCARD_E_READ_ONLY_CARD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100034u32 as _);
pub const SCARD_E_SERVER_TOO_BUSY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100031u32 as _);
pub const SCARD_E_SERVICE_STOPPED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010001Eu32 as _);
pub const SCARD_E_SHARING_VIOLATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010000Bu32 as _);
pub const SCARD_E_SYSTEM_CANCELLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100012u32 as _);
pub const SCARD_E_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010000Au32 as _);
pub const SCARD_E_UNEXPECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010001Fu32 as _);
pub const SCARD_E_UNKNOWN_CARD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010000Du32 as _);
pub const SCARD_E_UNKNOWN_READER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100009u32 as _);
pub const SCARD_E_UNKNOWN_RES_MNG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010002Bu32 as _);
pub const SCARD_E_UNSUPPORTED_FEATURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100022u32 as _);
pub const SCARD_E_WRITE_TOO_MANY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100028u32 as _);
pub const SCARD_F_COMM_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100013u32 as _);
pub const SCARD_F_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100001u32 as _);
pub const SCARD_F_UNKNOWN_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100014u32 as _);
pub const SCARD_F_WAITED_TOO_LONG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100007u32 as _);
pub const SCARD_P_SHUTDOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100018u32 as _);
pub const SCARD_W_CACHE_ITEM_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100070u32 as _);
pub const SCARD_W_CACHE_ITEM_STALE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100071u32 as _);
pub const SCARD_W_CACHE_ITEM_TOO_BIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100072u32 as _);
pub const SCARD_W_CANCELLED_BY_USER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010006Eu32 as _);
pub const SCARD_W_CARD_NOT_AUTHENTICATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010006Fu32 as _);
pub const SCARD_W_CHV_BLOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010006Cu32 as _);
pub const SCARD_W_EOF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010006Du32 as _);
pub const SCARD_W_REMOVED_CARD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100069u32 as _);
pub const SCARD_W_RESET_CARD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100068u32 as _);
pub const SCARD_W_SECURITY_VIOLATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010006Au32 as _);
pub const SCARD_W_UNPOWERED_CARD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100067u32 as _);
pub const SCARD_W_UNRESPONSIVE_CARD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100066u32 as _);
pub const SCARD_W_UNSUPPORTED_CARD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80100065u32 as _);
pub const SCARD_W_WRONG_CHV: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8010006Bu32 as _);
pub const SCHED_E_ACCOUNT_DBASE_CORRUPT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041311u32 as _);
pub const SCHED_E_ACCOUNT_INFORMATION_NOT_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004130Fu32 as _);
pub const SCHED_E_ACCOUNT_NAME_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041310u32 as _);
pub const SCHED_E_ALREADY_RUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004131Fu32 as _);
pub const SCHED_E_CANNOT_OPEN_TASK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004130Du32 as _);
pub const SCHED_E_DEPRECATED_FEATURE_USED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041330u32 as _);
pub const SCHED_E_INVALIDVALUE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041318u32 as _);
pub const SCHED_E_INVALID_TASK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004130Eu32 as _);
pub const SCHED_E_INVALID_TASK_HASH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041321u32 as _);
pub const SCHED_E_MALFORMEDXML: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004131Au32 as _);
pub const SCHED_E_MISSINGNODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041319u32 as _);
pub const SCHED_E_NAMESPACE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041317u32 as _);
pub const SCHED_E_NO_SECURITY_SERVICES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041312u32 as _);
pub const SCHED_E_PAST_END_BOUNDARY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004131Eu32 as _);
pub const SCHED_E_SERVICE_NOT_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041322u32 as _);
pub const SCHED_E_SERVICE_NOT_INSTALLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004130Cu32 as _);
pub const SCHED_E_SERVICE_NOT_LOCALSYSTEM: i32 = 6200i32;
pub const SCHED_E_SERVICE_NOT_RUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041315u32 as _);
pub const SCHED_E_SERVICE_TOO_BUSY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041323u32 as _);
pub const SCHED_E_START_ON_DEMAND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041328u32 as _);
pub const SCHED_E_TASK_ATTEMPTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041324u32 as _);
pub const SCHED_E_TASK_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041326u32 as _);
pub const SCHED_E_TASK_NOT_READY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004130Au32 as _);
pub const SCHED_E_TASK_NOT_RUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004130Bu32 as _);
pub const SCHED_E_TASK_NOT_UBPM_COMPAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041329u32 as _);
pub const SCHED_E_TASK_NOT_V1_COMPAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041327u32 as _);
pub const SCHED_E_TOO_MANY_NODES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004131Du32 as _);
pub const SCHED_E_TRIGGER_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041309u32 as _);
pub const SCHED_E_UNEXPECTEDNODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041316u32 as _);
pub const SCHED_E_UNKNOWN_OBJECT_VERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041313u32 as _);
pub const SCHED_E_UNSUPPORTED_ACCOUNT_OPTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041314u32 as _);
pub const SCHED_E_USER_NOT_LOGGED_ON: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041320u32 as _);
pub const SCHED_S_BATCH_LOGON_PROBLEM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4131Cu32 as _);
pub const SCHED_S_EVENT_TRIGGER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41308u32 as _);
pub const SCHED_S_SOME_TRIGGERS_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4131Bu32 as _);
pub const SCHED_S_TASK_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41302u32 as _);
pub const SCHED_S_TASK_HAS_NOT_RUN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41303u32 as _);
pub const SCHED_S_TASK_NOT_SCHEDULED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41305u32 as _);
pub const SCHED_S_TASK_NO_MORE_RUNS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41304u32 as _);
pub const SCHED_S_TASK_NO_VALID_TRIGGERS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41307u32 as _);
pub const SCHED_S_TASK_QUEUED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41325u32 as _);
pub const SCHED_S_TASK_READY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41300u32 as _);
pub const SCHED_S_TASK_RUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41301u32 as _);
pub const SCHED_S_TASK_TERMINATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x41306u32 as _);
...
pub const SEARCH_E_NOMONIKER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800416A1u32 as _);
pub const SEARCH_E_NOREGION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800416A2u32 as _);
pub const SEARCH_S_NOMOREHITS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x416A0u32 as _);
pub const SEC_E_ALGORITHM_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090331u32 as _);
pub const SEC_E_APPLICATION_PROTOCOL_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090367u32 as _);
pub const SEC_E_BAD_BINDINGS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090346u32 as _);
pub const SEC_E_BAD_PKGID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090316u32 as _);
pub const SEC_E_BUFFER_TOO_SMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090321u32 as _);
pub const SEC_E_CANNOT_INSTALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090307u32 as _);
pub const SEC_E_CANNOT_PACK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090309u32 as _);
pub const SEC_E_CERT_EXPIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090328u32 as _);
pub const SEC_E_CERT_UNKNOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090327u32 as _);
pub const SEC_E_CERT_WRONG_USAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090349u32 as _);
pub const SEC_E_CONTEXT_EXPIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090317u32 as _);
pub const SEC_E_CROSSREALM_DELEGATION_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090357u32 as _);
pub const SEC_E_CRYPTO_SYSTEM_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090337u32 as _);
pub const SEC_E_DECRYPT_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090330u32 as _);
pub const SEC_E_DELEGATION_POLICY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009035Eu32 as _);
pub const SEC_E_DELEGATION_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090345u32 as _);
pub const SEC_E_DOWNGRADE_DETECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090350u32 as _);
pub const SEC_E_ENCRYPT_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090329u32 as _);
pub const SEC_E_EXT_BUFFER_TOO_SMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009036Au32 as _);
pub const SEC_E_ILLEGAL_MESSAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090326u32 as _);
pub const SEC_E_INCOMPLETE_CREDENTIALS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090320u32 as _);
pub const SEC_E_INCOMPLETE_MESSAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090318u32 as _);
pub const SEC_E_INSUFFICIENT_BUFFERS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009036Bu32 as _);
pub const SEC_E_INSUFFICIENT_MEMORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090300u32 as _);
pub const SEC_E_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090304u32 as _);
pub const SEC_E_INVALID_HANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090301u32 as _);
pub const SEC_E_INVALID_PARAMETER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009035Du32 as _);
pub const SEC_E_INVALID_TOKEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090308u32 as _);
pub const SEC_E_INVALID_UPN_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090369u32 as _);
pub const SEC_E_ISSUING_CA_UNTRUSTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090352u32 as _);
pub const SEC_E_ISSUING_CA_UNTRUSTED_KDC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090359u32 as _);
pub const SEC_E_KDC_CERT_EXPIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009035Au32 as _);
pub const SEC_E_KDC_CERT_REVOKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009035Bu32 as _);
pub const SEC_E_KDC_INVALID_REQUEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090340u32 as _);
pub const SEC_E_KDC_UNABLE_TO_REFER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090341u32 as _);
pub const SEC_E_KDC_UNKNOWN_ETYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090342u32 as _);
pub const SEC_E_LOGON_DENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009030Cu32 as _);
pub const SEC_E_MAX_REFERRALS_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090338u32 as _);
pub const SEC_E_MESSAGE_ALTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009030Fu32 as _);
pub const SEC_E_MULTIPLE_ACCOUNTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090347u32 as _);
pub const SEC_E_MUST_BE_KDC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090339u32 as _);
pub const SEC_E_MUTUAL_AUTH_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090363u32 as _);
pub const SEC_E_NOT_OWNER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090306u32 as _);
pub const SEC_E_NOT_SUPPORTED: i32 = -2146893054i32;
pub const SEC_E_NO_AUTHENTICATING_AUTHORITY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090311u32 as _);
pub const SEC_E_NO_CONTEXT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090361u32 as _);
pub const SEC_E_NO_CREDENTIALS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009030Eu32 as _);
pub const SEC_E_NO_IMPERSONATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009030Bu32 as _);
pub const SEC_E_NO_IP_ADDRESSES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090335u32 as _);
pub const SEC_E_NO_KERB_KEY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090348u32 as _);
pub const SEC_E_NO_PA_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009033Cu32 as _);
pub const SEC_E_NO_S4U_PROT_SUPPORT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090356u32 as _);
pub const SEC_E_NO_SPM: i32 = -2146893052i32;
pub const SEC_E_NO_TGT_REPLY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090334u32 as _);
pub const SEC_E_OK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x0u32 as _);
pub const SEC_E_ONLY_HTTPS_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090365u32 as _);
pub const SEC_E_OUT_OF_SEQUENCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090310u32 as _);
pub const SEC_E_PKINIT_CLIENT_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090354u32 as _);
pub const SEC_E_PKINIT_NAME_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009033Du32 as _);
pub const SEC_E_PKU2U_CERT_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090362u32 as _);
pub const SEC_E_POLICY_NLTM_ONLY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009035Fu32 as _);
pub const SEC_E_QOP_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009030Au32 as _);
pub const SEC_E_REVOCATION_OFFLINE_C: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090353u32 as _);
pub const SEC_E_REVOCATION_OFFLINE_KDC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090358u32 as _);
pub const SEC_E_SECPKG_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090305u32 as _);
pub const SEC_E_SECURITY_QOS_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090332u32 as _);
pub const SEC_E_SHUTDOWN_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009033Fu32 as _);
pub const SEC_E_SMARTCARD_CERT_EXPIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090355u32 as _);
pub const SEC_E_SMARTCARD_CERT_REVOKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090351u32 as _);
pub const SEC_E_SMARTCARD_LOGON_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009033Eu32 as _);
pub const SEC_E_STRONG_CRYPTO_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009033Au32 as _);
pub const SEC_E_TARGET_UNKNOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090303u32 as _);
pub const SEC_E_TIME_SKEW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090324u32 as _);
pub const SEC_E_TOO_MANY_PRINCIPALS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009033Bu32 as _);
pub const SEC_E_UNFINISHED_CONTEXT_DELETED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090333u32 as _);
pub const SEC_E_UNKNOWN_CREDENTIALS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009030Du32 as _);
pub const SEC_E_UNSUPPORTED_FUNCTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090302u32 as _);
pub const SEC_E_UNSUPPORTED_PREAUTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090343u32 as _);
pub const SEC_E_UNTRUSTED_ROOT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090325u32 as _);
pub const SEC_E_WRONG_CREDENTIAL_HANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090336u32 as _);
pub const SEC_E_WRONG_PRINCIPAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80090322u32 as _);
pub const SEC_I_ASYNC_CALL_PENDING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x90368u32 as _);
pub const SEC_I_COMPLETE_AND_CONTINUE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x90314u32 as _);
pub const SEC_I_COMPLETE_NEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x90313u32 as _);
pub const SEC_I_CONTEXT_EXPIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x90317u32 as _);
pub const SEC_I_CONTINUE_NEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x90312u32 as _);
pub const SEC_I_CONTINUE_NEEDED_MESSAGE_OK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x90366u32 as _);
pub const SEC_I_GENERIC_EXTENSION_RECEIVED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x90316u32 as _);
pub const SEC_I_INCOMPLETE_CREDENTIALS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x90320u32 as _);
pub const SEC_I_LOCAL_LOGON: ::windows_core::HRESULT = ::windows_core::HRESULT(0x90315u32 as _);
pub const SEC_I_MESSAGE_FRAGMENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x90364u32 as _);
pub const SEC_I_NO_LSA_CONTEXT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x90323u32 as _);
pub const SEC_I_NO_RENEGOTIATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x90360u32 as _);
pub const SEC_I_RENEGOTIATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x90321u32 as _);
pub const SEC_I_SIGNATURE_NEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x9035Cu32 as _);
pub const SEVERITY_ERROR: u32 = 1u32;
pub const SEVERITY_SUCCESS: u32 = 0u32;
pub const SPAPI_E_AUTHENTICODE_DISALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0240u32 as _);
pub const SPAPI_E_AUTHENTICODE_PUBLISHER_NOT_TRUSTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0243u32 as _);
pub const SPAPI_E_AUTHENTICODE_TRUSTED_PUBLISHER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0241u32 as _);
pub const SPAPI_E_AUTHENTICODE_TRUST_NOT_ESTABLISHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0242u32 as _);
pub const SPAPI_E_BAD_INTERFACE_INSTALLSECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F021Du32 as _);
pub const SPAPI_E_BAD_SECTION_NAME_LINE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0001u32 as _);
pub const SPAPI_E_BAD_SERVICE_INSTALLSECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0217u32 as _);
pub const SPAPI_E_CANT_LOAD_CLASS_ICON: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F020Cu32 as _);
pub const SPAPI_E_CANT_REMOVE_DEVINST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0232u32 as _);
pub const SPAPI_E_CLASS_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0201u32 as _);
pub const SPAPI_E_DEVICE_INSTALLER_NOT_READY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0246u32 as _);
pub const SPAPI_E_DEVICE_INSTALL_BLOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0248u32 as _);
pub const SPAPI_E_DEVICE_INTERFACE_ACTIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F021Bu32 as _);
pub const SPAPI_E_DEVICE_INTERFACE_REMOVED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F021Cu32 as _);
pub const SPAPI_E_DEVINFO_DATA_LOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0213u32 as _);
pub const SPAPI_E_DEVINFO_LIST_LOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0212u32 as _);
pub const SPAPI_E_DEVINFO_NOT_REGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0208u32 as _);
pub const SPAPI_E_DEVINSTALL_QUEUE_NONNATIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0230u32 as _);
pub const SPAPI_E_DEVINST_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0207u32 as _);
pub const SPAPI_E_DI_BAD_PATH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0214u32 as _);
pub const SPAPI_E_DI_DONT_INSTALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F022Bu32 as _);
pub const SPAPI_E_DI_DO_DEFAULT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F020Eu32 as _);
pub const SPAPI_E_DI_FUNCTION_OBSOLETE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F023Eu32 as _);
pub const SPAPI_E_DI_NOFILECOPY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F020Fu32 as _);
pub const SPAPI_E_DI_POSTPROCESSING_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0226u32 as _);
pub const SPAPI_E_DRIVER_INSTALL_BLOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0249u32 as _);
pub const SPAPI_E_DRIVER_NONNATIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0234u32 as _);
pub const SPAPI_E_DRIVER_STORE_ADD_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0247u32 as _);
pub const SPAPI_E_DRIVER_STORE_DELETE_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F024Cu32 as _);
pub const SPAPI_E_DUPLICATE_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0202u32 as _);
pub const SPAPI_E_ERROR_NOT_INSTALLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F1000u32 as _);
pub const SPAPI_E_EXPECTED_SECTION_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0000u32 as _);
pub const SPAPI_E_FILEQUEUE_LOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0216u32 as _);
pub const SPAPI_E_FILE_HASH_NOT_IN_CATALOG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F024Bu32 as _);
pub const SPAPI_E_GENERAL_SYNTAX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0003u32 as _);
pub const SPAPI_E_INCORRECTLY_COPIED_INF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0237u32 as _);
pub const SPAPI_E_INF_IN_USE_BY_DEVICES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F023Du32 as _);
pub const SPAPI_E_INVALID_CLASS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0206u32 as _);
pub const SPAPI_E_INVALID_CLASS_INSTALLER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F020Du32 as _);
pub const SPAPI_E_INVALID_COINSTALLER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0227u32 as _);
pub const SPAPI_E_INVALID_DEVINST_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0205u32 as _);
pub const SPAPI_E_INVALID_FILTER_DRIVER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F022Cu32 as _);
pub const SPAPI_E_INVALID_HWPROFILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0210u32 as _);
pub const SPAPI_E_INVALID_INF_LOGCONFIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F022Au32 as _);
pub const SPAPI_E_INVALID_MACHINENAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0220u32 as _);
pub const SPAPI_E_INVALID_PROPPAGE_PROVIDER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0224u32 as _);
pub const SPAPI_E_INVALID_REFERENCE_STRING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F021Fu32 as _);
pub const SPAPI_E_INVALID_REG_PROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0209u32 as _);
pub const SPAPI_E_INVALID_TARGET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0233u32 as _);
pub const SPAPI_E_IN_WOW64: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0235u32 as _);
pub const SPAPI_E_KEY_DOES_NOT_EXIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0204u32 as _);
pub const SPAPI_E_LINE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0102u32 as _);
pub const SPAPI_E_MACHINE_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0222u32 as _);
pub const SPAPI_E_NON_WINDOWS_DRIVER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F022Eu32 as _);
pub const SPAPI_E_NON_WINDOWS_NT_DRIVER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F022Du32 as _);
pub const SPAPI_E_NOT_AN_INSTALLED_OEM_INF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F023Cu32 as _);
pub const SPAPI_E_NOT_DISABLEABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0231u32 as _);
pub const SPAPI_E_NO_ASSOCIATED_CLASS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0200u32 as _);
pub const SPAPI_E_NO_ASSOCIATED_SERVICE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0219u32 as _);
pub const SPAPI_E_NO_AUTHENTICODE_CATALOG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F023Fu32 as _);
pub const SPAPI_E_NO_BACKUP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0103u32 as _);
pub const SPAPI_E_NO_CATALOG_FOR_OEM_INF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F022Fu32 as _);
pub const SPAPI_E_NO_CLASSINSTALL_PARAMS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0215u32 as _);
pub const SPAPI_E_NO_CLASS_DRIVER_LIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0218u32 as _);
pub const SPAPI_E_NO_COMPAT_DRIVERS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0228u32 as _);
pub const SPAPI_E_NO_CONFIGMGR_SERVICES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0223u32 as _);
pub const SPAPI_E_NO_DEFAULT_DEVICE_INTERFACE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F021Au32 as _);
pub const SPAPI_E_NO_DEVICE_ICON: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0229u32 as _);
pub const SPAPI_E_NO_DEVICE_SELECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0211u32 as _);
pub const SPAPI_E_NO_DRIVER_SELECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0203u32 as _);
pub const SPAPI_E_NO_INF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F020Au32 as _);
pub const SPAPI_E_NO_SUCH_DEVICE_INTERFACE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0225u32 as _);
pub const SPAPI_E_NO_SUCH_DEVINST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F020Bu32 as _);
pub const SPAPI_E_NO_SUCH_INTERFACE_CLASS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F021Eu32 as _);
pub const SPAPI_E_ONLY_VALIDATE_VIA_AUTHENTICODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0245u32 as _);
pub const SPAPI_E_PNP_REGISTRY_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F023Au32 as _);
pub const SPAPI_E_REMOTE_COMM_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0221u32 as _);
pub const SPAPI_E_REMOTE_REQUEST_UNSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F023Bu32 as _);
pub const SPAPI_E_SCE_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0238u32 as _);
pub const SPAPI_E_SECTION_NAME_TOO_LONG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0002u32 as _);
pub const SPAPI_E_SECTION_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0101u32 as _);
pub const SPAPI_E_SET_SYSTEM_RESTORE_POINT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0236u32 as _);
pub const SPAPI_E_SIGNATURE_OSATTRIBUTE_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0244u32 as _);
pub const SPAPI_E_UNKNOWN_EXCEPTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0239u32 as _);
pub const SPAPI_E_UNRECOVERABLE_STACK_OVERFLOW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0300u32 as _);
pub const SPAPI_E_WRONG_INF_STYLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F0100u32 as _);
pub const SPAPI_E_WRONG_INF_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800F024Au32 as _);
pub const SQLITE_E_ABORT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0004u32 as _);
pub const SQLITE_E_ABORT_ROLLBACK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0204u32 as _);
pub const SQLITE_E_AUTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0017u32 as _);
pub const SQLITE_E_BUSY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0005u32 as _);
pub const SQLITE_E_BUSY_RECOVERY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0105u32 as _);
pub const SQLITE_E_BUSY_SNAPSHOT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0205u32 as _);
pub const SQLITE_E_CANTOPEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF000Eu32 as _);
pub const SQLITE_E_CANTOPEN_CONVPATH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF040Eu32 as _);
pub const SQLITE_E_CANTOPEN_FULLPATH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF030Eu32 as _);
pub const SQLITE_E_CANTOPEN_ISDIR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF020Eu32 as _);
pub const SQLITE_E_CANTOPEN_NOTEMPDIR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF010Eu32 as _);
pub const SQLITE_E_CONSTRAINT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0013u32 as _);
pub const SQLITE_E_CONSTRAINT_CHECK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0113u32 as _);
pub const SQLITE_E_CONSTRAINT_COMMITHOOK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0213u32 as _);
pub const SQLITE_E_CONSTRAINT_FOREIGNKEY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0313u32 as _);
pub const SQLITE_E_CONSTRAINT_FUNCTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0413u32 as _);
pub const SQLITE_E_CONSTRAINT_NOTNULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0513u32 as _);
pub const SQLITE_E_CONSTRAINT_PRIMARYKEY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0613u32 as _);
pub const SQLITE_E_CONSTRAINT_ROWID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0A13u32 as _);
pub const SQLITE_E_CONSTRAINT_TRIGGER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0713u32 as _);
pub const SQLITE_E_CONSTRAINT_UNIQUE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0813u32 as _);
pub const SQLITE_E_CONSTRAINT_VTAB: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0913u32 as _);
pub const SQLITE_E_CORRUPT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF000Bu32 as _);
pub const SQLITE_E_CORRUPT_VTAB: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF010Bu32 as _);
pub const SQLITE_E_DONE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0065u32 as _);
pub const SQLITE_E_EMPTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0010u32 as _);
pub const SQLITE_E_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0001u32 as _);
pub const SQLITE_E_FORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0018u32 as _);
pub const SQLITE_E_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF000Du32 as _);
pub const SQLITE_E_INTERNAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0002u32 as _);
pub const SQLITE_E_INTERRUPT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0009u32 as _);
pub const SQLITE_E_IOERR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF000Au32 as _);
pub const SQLITE_E_IOERR_ACCESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0D0Au32 as _);
pub const SQLITE_E_IOERR_AUTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF1A03u32 as _);
pub const SQLITE_E_IOERR_BLOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0B0Au32 as _);
pub const SQLITE_E_IOERR_CHECKRESERVEDLOCK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0E0Au32 as _);
pub const SQLITE_E_IOERR_CLOSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF100Au32 as _);
pub const SQLITE_E_IOERR_CONVPATH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF1A0Au32 as _);
pub const SQLITE_E_IOERR_DELETE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0A0Au32 as _);
pub const SQLITE_E_IOERR_DELETE_NOENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF170Au32 as _);
pub const SQLITE_E_IOERR_DIR_CLOSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF110Au32 as _);
pub const SQLITE_E_IOERR_DIR_FSYNC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF050Au32 as _);
pub const SQLITE_E_IOERR_FSTAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF070Au32 as _);
pub const SQLITE_E_IOERR_FSYNC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF040Au32 as _);
pub const SQLITE_E_IOERR_GETTEMPPATH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF190Au32 as _);
pub const SQLITE_E_IOERR_LOCK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0F0Au32 as _);
pub const SQLITE_E_IOERR_MMAP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF180Au32 as _);
pub const SQLITE_E_IOERR_NOMEM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0C0Au32 as _);
pub const SQLITE_E_IOERR_RDLOCK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF090Au32 as _);
pub const SQLITE_E_IOERR_READ: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF010Au32 as _);
pub const SQLITE_E_IOERR_SEEK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF160Au32 as _);
pub const SQLITE_E_IOERR_SHMLOCK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF140Au32 as _);
pub const SQLITE_E_IOERR_SHMMAP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF150Au32 as _);
pub const SQLITE_E_IOERR_SHMOPEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF120Au32 as _);
pub const SQLITE_E_IOERR_SHMSIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF130Au32 as _);
pub const SQLITE_E_IOERR_SHORT_READ: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF020Au32 as _);
pub const SQLITE_E_IOERR_TRUNCATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF060Au32 as _);
pub const SQLITE_E_IOERR_UNLOCK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF080Au32 as _);
pub const SQLITE_E_IOERR_VNODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF1A02u32 as _);
pub const SQLITE_E_IOERR_WRITE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF030Au32 as _);
pub const SQLITE_E_LOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0006u32 as _);
pub const SQLITE_E_LOCKED_SHAREDCACHE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0106u32 as _);
pub const SQLITE_E_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0014u32 as _);
pub const SQLITE_E_MISUSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0015u32 as _);
pub const SQLITE_E_NOLFS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0016u32 as _);
pub const SQLITE_E_NOMEM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0007u32 as _);
pub const SQLITE_E_NOTADB: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF001Au32 as _);
pub const SQLITE_E_NOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF000Cu32 as _);
pub const SQLITE_E_NOTICE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF001Bu32 as _);
pub const SQLITE_E_NOTICE_RECOVER_ROLLBACK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF021Bu32 as _);
pub const SQLITE_E_NOTICE_RECOVER_WAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF011Bu32 as _);
pub const SQLITE_E_PERM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0003u32 as _);
pub const SQLITE_E_PROTOCOL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF000Fu32 as _);
pub const SQLITE_E_RANGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0019u32 as _);
pub const SQLITE_E_READONLY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0008u32 as _);
pub const SQLITE_E_READONLY_CANTLOCK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0208u32 as _);
pub const SQLITE_E_READONLY_DBMOVED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0408u32 as _);
pub const SQLITE_E_READONLY_RECOVERY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0108u32 as _);
pub const SQLITE_E_READONLY_ROLLBACK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0308u32 as _);
pub const SQLITE_E_ROW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0064u32 as _);
pub const SQLITE_E_SCHEMA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0011u32 as _);
pub const SQLITE_E_TOOBIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF0012u32 as _);
pub const SQLITE_E_WARNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF001Cu32 as _);
pub const SQLITE_E_WARNING_AUTOINDEX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87AF011Cu32 as _);
pub const STATEREPOSITORY_ERROR_CACHE_CORRUPTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80670012u32 as _);
pub const STATEREPOSITORY_ERROR_DICTIONARY_CORRUPTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80670005u32 as _);
pub const STATEREPOSITORY_E_BLOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80670006u32 as _);
pub const STATEREPOSITORY_E_BUSY_RECOVERY_RETRY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80670008u32 as _);
pub const STATEREPOSITORY_E_BUSY_RECOVERY_TIMEOUT_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8067000Du32 as _);
pub const STATEREPOSITORY_E_BUSY_RETRY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80670007u32 as _);
pub const STATEREPOSITORY_E_BUSY_TIMEOUT_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8067000Cu32 as _);
pub const STATEREPOSITORY_E_CACHE_NOT_INIITALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80670015u32 as _);
pub const STATEREPOSITORY_E_CONCURRENCY_LOCKING_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80670001u32 as _);
pub const STATEREPOSITORY_E_CONFIGURATION_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80670003u32 as _);
pub const STATEREPOSITORY_E_DEPENDENCY_NOT_RESOLVED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80670016u32 as _);
pub const STATEREPOSITORY_E_LOCKED_RETRY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80670009u32 as _);
pub const STATEREPOSITORY_E_LOCKED_SHAREDCACHE_RETRY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8067000Au32 as _);
pub const STATEREPOSITORY_E_LOCKED_SHAREDCACHE_TIMEOUT_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8067000Fu32 as _);
pub const STATEREPOSITORY_E_LOCKED_TIMEOUT_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8067000Eu32 as _);
pub const STATEREPOSITORY_E_SERVICE_STOP_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80670010u32 as _);
pub const STATEREPOSITORY_E_STATEMENT_INPROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80670002u32 as _);
pub const STATEREPOSITORY_E_TRANSACTION_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8067000Bu32 as _);
pub const STATEREPOSITORY_E_UNKNOWN_SCHEMA_VERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80670004u32 as _);
pub const STATEREPOSITORY_TRANSACTION_CALLER_ID_CHANGED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x670013u32 as _);
pub const STATEREPOSITORY_TRANSACTION_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80670014u32 as _);
pub const STATEREPOSTORY_E_NESTED_TRANSACTION_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80670011u32 as _);
...
pub const STATUS_CANT_ATTACH_TO_DEV_VOLUME: NTSTATUS = NTSTATUS(-1073740577i32);
...
pub const STATUS_FS_GUID_MISMATCH: NTSTATUS = NTSTATUS(-1073740578i32);
...
pub const STATUS_INVALID_CONFIG_VALUE: NTSTATUS = NTSTATUS(-1073740576i32);
...
pub const STATUS_LAPS_ENCRYPTION_REQUIRES_2016_DFL: NTSTATUS = NTSTATUS(-1073700722i32);
pub const STATUS_LAPS_LEGACY_SCHEMA_MISSING: NTSTATUS = NTSTATUS(-1073700724i32);
pub const STATUS_LAPS_SCHEMA_MISSING: NTSTATUS = NTSTATUS(-1073700723i32);
...
pub const STATUS_NOT_A_DEV_VOLUME: NTSTATUS = NTSTATUS(-1073740579i32);
...
pub const STATUS_POLICY_CONTROLLED_ACCOUNT: NTSTATUS = NTSTATUS(-1073700725i32);
...
pub const STATUS_SYSTEM_INTEGRITY_REPUTATION_EXPLICIT_DENY_FILE: NTSTATUS = NTSTATUS(-1058471923i32);
...
pub const STATUS_VHD_UNEXPECTED_ID: NTSTATUS = NTSTATUS(-1069940684i32);
...
pub const STATUS_VOLUME_UPGRADE_DISABLED: NTSTATUS = NTSTATUS(-1073740581i32);
pub const STATUS_VOLUME_UPGRADE_DISABLED_TILL_OS_DOWNGRADE_EXPIRED: NTSTATUS = NTSTATUS(-1073740580i32);
pub const STATUS_VOLUME_UPGRADE_NOT_NEEDED: NTSTATUS = NTSTATUS(-1073740583i32);
pub const STATUS_VOLUME_UPGRADE_PENDING: NTSTATUS = NTSTATUS(-1073740582i32);
...
pub const STG_E_ABNORMALAPIEXIT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800300FAu32 as _);
pub const STG_E_ACCESSDENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030005u32 as _);
pub const STG_E_BADBASEADDRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030110u32 as _);
pub const STG_E_CANTSAVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030103u32 as _);
pub const STG_E_CSS_AUTHENTICATION_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030306u32 as _);
pub const STG_E_CSS_KEY_NOT_ESTABLISHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030308u32 as _);
pub const STG_E_CSS_KEY_NOT_PRESENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030307u32 as _);
pub const STG_E_CSS_REGION_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8003030Au32 as _);
pub const STG_E_CSS_SCRAMBLED_SECTOR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030309u32 as _);
pub const STG_E_DEVICE_UNRESPONSIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8003020Au32 as _);
pub const STG_E_DISKISWRITEPROTECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030013u32 as _);
pub const STG_E_DOCFILECORRUPT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030109u32 as _);
pub const STG_E_DOCFILETOOLARGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030111u32 as _);
pub const STG_E_EXTANTMARSHALLINGS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030108u32 as _);
pub const STG_E_FILEALREADYEXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030050u32 as _);
pub const STG_E_FILENOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030002u32 as _);
pub const STG_E_FIRMWARE_IMAGE_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030209u32 as _);
pub const STG_E_FIRMWARE_SLOT_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030208u32 as _);
pub const STG_E_INCOMPLETE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030201u32 as _);
pub const STG_E_INSUFFICIENTMEMORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030008u32 as _);
pub const STG_E_INUSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030100u32 as _);
pub const STG_E_INVALIDFLAG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800300FFu32 as _);
pub const STG_E_INVALIDFUNCTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030001u32 as _);
pub const STG_E_INVALIDHANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030006u32 as _);
pub const STG_E_INVALIDHEADER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800300FBu32 as _);
pub const STG_E_INVALIDNAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800300FCu32 as _);
pub const STG_E_INVALIDPARAMETER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030057u32 as _);
pub const STG_E_INVALIDPOINTER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030009u32 as _);
pub const STG_E_LOCKVIOLATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030021u32 as _);
pub const STG_E_MEDIUMFULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030070u32 as _);
pub const STG_E_NOMOREFILES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030012u32 as _);
pub const STG_E_NOTCURRENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030101u32 as _);
pub const STG_E_NOTFILEBASEDSTORAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030107u32 as _);
pub const STG_E_NOTSIMPLEFORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030112u32 as _);
pub const STG_E_OLDDLL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030105u32 as _);
pub const STG_E_OLDFORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030104u32 as _);
pub const STG_E_PATHNOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030003u32 as _);
pub const STG_E_PROPSETMISMATCHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800300F0u32 as _);
pub const STG_E_READFAULT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8003001Eu32 as _);
pub const STG_E_RESETS_EXHAUSTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8003030Bu32 as _);
pub const STG_E_REVERTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030102u32 as _);
pub const STG_E_SEEKERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030019u32 as _);
pub const STG_E_SHAREREQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030106u32 as _);
pub const STG_E_SHAREVIOLATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030020u32 as _);
pub const STG_E_STATUS_COPY_PROTECTION_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030305u32 as _);
pub const STG_E_TERMINATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030202u32 as _);
pub const STG_E_TOOMANYOPENFILES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80030004u32 as _);
pub const STG_E_UNIMPLEMENTEDFUNCTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800300FEu32 as _);
pub const STG_E_UNKNOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800300FDu32 as _);
pub const STG_E_WRITEFAULT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8003001Du32 as _);
pub const STG_S_BLOCK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x30201u32 as _);
pub const STG_S_CANNOTCONSOLIDATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x30206u32 as _);
pub const STG_S_CONSOLIDATIONFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x30205u32 as _);
pub const STG_S_CONVERTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x30200u32 as _);
pub const STG_S_MONITORING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x30203u32 as _);
pub const STG_S_MULTIPLEOPENS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x30204u32 as _);
pub const STG_S_POWER_CYCLE_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x30207u32 as _);
pub const STG_S_RETRYNOW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x30202u32 as _);
...
pub const S_APPLICATION_ACTIVATION_ERROR_HANDLED_BY_DIALOG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x270259u32 as _);
pub const S_FALSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x1u32 as _);
pub const S_OK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x0u32 as _);
pub const S_STORE_LAUNCHED_FOR_REMEDIATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x270258u32 as _);
pub const TBSIMP_E_BUFFER_TOO_SMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290200u32 as _);
pub const TBSIMP_E_CLEANUP_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290201u32 as _);
pub const TBSIMP_E_COMMAND_CANCELED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029020Bu32 as _);
pub const TBSIMP_E_COMMAND_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290211u32 as _);
pub const TBSIMP_E_DUPLICATE_VHANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290206u32 as _);
pub const TBSIMP_E_HASH_BAD_KEY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290205u32 as _);
pub const TBSIMP_E_HASH_TABLE_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290216u32 as _);
pub const TBSIMP_E_INVALID_CONTEXT_HANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290202u32 as _);
pub const TBSIMP_E_INVALID_CONTEXT_PARAM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290203u32 as _);
pub const TBSIMP_E_INVALID_OUTPUT_POINTER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290207u32 as _);
pub const TBSIMP_E_INVALID_PARAMETER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290208u32 as _);
pub const TBSIMP_E_INVALID_RESOURCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290214u32 as _);
pub const TBSIMP_E_LIST_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029020Eu32 as _);
pub const TBSIMP_E_LIST_NO_MORE_ITEMS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029020Du32 as _);
pub const TBSIMP_E_NOTHING_TO_UNLOAD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290215u32 as _);
pub const TBSIMP_E_NOT_ENOUGH_SPACE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029020Fu32 as _);
pub const TBSIMP_E_NOT_ENOUGH_TPM_CONTEXTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290210u32 as _);
pub const TBSIMP_E_NO_EVENT_LOG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029021Bu32 as _);
pub const TBSIMP_E_OUT_OF_MEMORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029020Cu32 as _);
pub const TBSIMP_E_PPI_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290219u32 as _);
pub const TBSIMP_E_RESOURCE_EXPIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290213u32 as _);
pub const TBSIMP_E_RPC_INIT_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290209u32 as _);
pub const TBSIMP_E_SCHEDULER_NOT_RUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029020Au32 as _);
pub const TBSIMP_E_TOO_MANY_RESOURCES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290218u32 as _);
pub const TBSIMP_E_TOO_MANY_TBS_CONTEXTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290217u32 as _);
pub const TBSIMP_E_TPM_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290204u32 as _);
pub const TBSIMP_E_TPM_INCOMPATIBLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029021Au32 as _);
pub const TBSIMP_E_UNKNOWN_ORDINAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290212u32 as _);
pub const TBS_E_ACCESS_DENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80284012u32 as _);
pub const TBS_E_BAD_PARAMETER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80284002u32 as _);
pub const TBS_E_BUFFER_TOO_LARGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028400Eu32 as _);
pub const TBS_E_COMMAND_CANCELED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028400Du32 as _);
pub const TBS_E_INSUFFICIENT_BUFFER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80284005u32 as _);
pub const TBS_E_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80284001u32 as _);
pub const TBS_E_INVALID_CONTEXT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80284004u32 as _);
pub const TBS_E_INVALID_CONTEXT_PARAM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80284007u32 as _);
pub const TBS_E_INVALID_OUTPUT_POINTER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80284003u32 as _);
pub const TBS_E_IOERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80284006u32 as _);
pub const TBS_E_NO_EVENT_LOG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80284011u32 as _);
pub const TBS_E_OWNERAUTH_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80284015u32 as _);
pub const TBS_E_PPI_FUNCTION_UNSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80284014u32 as _);
pub const TBS_E_PPI_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028400Cu32 as _);
pub const TBS_E_PROVISIONING_INCOMPLETE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80284016u32 as _);
pub const TBS_E_PROVISIONING_NOT_ALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80284013u32 as _);
pub const TBS_E_SERVICE_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80284010u32 as _);
pub const TBS_E_SERVICE_NOT_RUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80284008u32 as _);
pub const TBS_E_SERVICE_START_PENDING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028400Bu32 as _);
pub const TBS_E_TOO_MANY_RESOURCES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028400Au32 as _);
pub const TBS_E_TOO_MANY_TBS_CONTEXTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80284009u32 as _);
pub const TBS_E_TPM_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028400Fu32 as _);
pub const TPC_E_INITIALIZE_FAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040223u32 as _);
pub const TPC_E_INVALID_CONFIGURATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040239u32 as _);
pub const TPC_E_INVALID_DATA_FROM_RECOGNIZER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004023Au32 as _);
pub const TPC_E_INVALID_INPUT_RECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040219u32 as _);
pub const TPC_E_INVALID_PACKET_DESCRIPTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040233u32 as _);
pub const TPC_E_INVALID_PROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040241u32 as _);
pub const TPC_E_INVALID_RIGHTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040236u32 as _);
pub const TPC_E_INVALID_STROKE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040222u32 as _);
pub const TPC_E_NOT_RELEVANT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040232u32 as _);
pub const TPC_E_NO_DEFAULT_TABLET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040212u32 as _);
pub const TPC_E_OUT_OF_ORDER_CALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040237u32 as _);
pub const TPC_E_QUEUE_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040238u32 as _);
pub const TPC_E_RECOGNIZER_NOT_REGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040235u32 as _);
pub const TPC_E_UNKNOWN_PROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004021Bu32 as _);
pub const TPC_S_INTERRUPTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40253u32 as _);
pub const TPC_S_NO_DATA_TO_PROCESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40254u32 as _);
pub const TPC_S_TRUNCATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40252u32 as _);
pub const TPMAPI_E_ACCESS_DENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290108u32 as _);
pub const TPMAPI_E_AUTHORIZATION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290109u32 as _);
pub const TPMAPI_E_AUTHORIZATION_REVOKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290126u32 as _);
pub const TPMAPI_E_AUTHORIZING_KEY_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290128u32 as _);
pub const TPMAPI_E_BUFFER_TOO_SMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290106u32 as _);
pub const TPMAPI_E_EMPTY_TCG_LOG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029011Au32 as _);
pub const TPMAPI_E_ENCRYPTION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290110u32 as _);
pub const TPMAPI_E_ENDORSEMENT_AUTH_NOT_NULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290125u32 as _);
pub const TPMAPI_E_FIPS_RNG_CHECK_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290119u32 as _);
pub const TPMAPI_E_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290107u32 as _);
pub const TPMAPI_E_INVALID_AUTHORIZATION_SIGNATURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290129u32 as _);
pub const TPMAPI_E_INVALID_CONTEXT_HANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029010Au32 as _);
pub const TPMAPI_E_INVALID_CONTEXT_PARAMS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290115u32 as _);
pub const TPMAPI_E_INVALID_DELEGATE_BLOB: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290114u32 as _);
pub const TPMAPI_E_INVALID_ENCODING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029010Eu32 as _);
pub const TPMAPI_E_INVALID_KEY_BLOB: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290116u32 as _);
pub const TPMAPI_E_INVALID_KEY_PARAMS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290111u32 as _);
pub const TPMAPI_E_INVALID_KEY_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029010Fu32 as _);
pub const TPMAPI_E_INVALID_MIGRATION_AUTHORIZATION_BLOB: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290112u32 as _);
pub const TPMAPI_E_INVALID_OUTPUT_POINTER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290103u32 as _);
pub const TPMAPI_E_INVALID_OWNER_AUTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290118u32 as _);
pub const TPMAPI_E_INVALID_PARAMETER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290104u32 as _);
pub const TPMAPI_E_INVALID_PCR_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290117u32 as _);
pub const TPMAPI_E_INVALID_PCR_INDEX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290113u32 as _);
pub const TPMAPI_E_INVALID_POLICYAUTH_BLOB_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029012Eu32 as _);
pub const TPMAPI_E_INVALID_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290100u32 as _);
pub const TPMAPI_E_INVALID_TCG_LOG_ENTRY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029011Bu32 as _);
pub const TPMAPI_E_INVALID_TPM_VERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029012Du32 as _);
pub const TPMAPI_E_MALFORMED_AUTHORIZATION_KEY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290127u32 as _);
pub const TPMAPI_E_MALFORMED_AUTHORIZATION_OTHER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029012Bu32 as _);
pub const TPMAPI_E_MALFORMED_AUTHORIZATION_POLICY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029012Au32 as _);
pub const TPMAPI_E_MESSAGE_TOO_LARGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029010Du32 as _);
pub const TPMAPI_E_NOT_ENOUGH_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290101u32 as _);
pub const TPMAPI_E_NO_AUTHORIZATION_CHAIN_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290122u32 as _);
pub const TPMAPI_E_NV_BITS_NOT_DEFINED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029011Fu32 as _);
pub const TPMAPI_E_NV_BITS_NOT_READY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290120u32 as _);
pub const TPMAPI_E_OUT_OF_MEMORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290105u32 as _);
pub const TPMAPI_E_OWNER_AUTH_NOT_NULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290124u32 as _);
pub const TPMAPI_E_POLICY_DENIES_OPERATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029011Eu32 as _);
pub const TPMAPI_E_SEALING_KEY_CHANGED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029012Cu32 as _);
pub const TPMAPI_E_SEALING_KEY_NOT_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290121u32 as _);
pub const TPMAPI_E_SVN_COUNTER_NOT_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290123u32 as _);
pub const TPMAPI_E_TBS_COMMUNICATION_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029010Bu32 as _);
pub const TPMAPI_E_TCG_INVALID_DIGEST_ENTRY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029011Du32 as _);
pub const TPMAPI_E_TCG_SEPARATOR_ABSENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029011Cu32 as _);
pub const TPMAPI_E_TOO_MUCH_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290102u32 as _);
pub const TPMAPI_E_TPM_COMMAND_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029010Cu32 as _);
pub const TPM_20_E_ASYMMETRIC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280081u32 as _);
pub const TPM_20_E_ATTRIBUTES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280082u32 as _);
pub const TPM_20_E_AUTHSIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280144u32 as _);
pub const TPM_20_E_AUTH_CONTEXT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280145u32 as _);
pub const TPM_20_E_AUTH_FAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028008Eu32 as _);
pub const TPM_20_E_AUTH_MISSING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280125u32 as _);
pub const TPM_20_E_AUTH_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280124u32 as _);
pub const TPM_20_E_AUTH_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028012Fu32 as _);
pub const TPM_20_E_BAD_AUTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802800A2u32 as _);
pub const TPM_20_E_BAD_CONTEXT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280150u32 as _);
pub const TPM_20_E_BINDING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802800A5u32 as _);
pub const TPM_20_E_CANCELED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280909u32 as _);
pub const TPM_20_E_COMMAND_CODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280143u32 as _);
pub const TPM_20_E_COMMAND_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280142u32 as _);
pub const TPM_20_E_CONTEXT_GAP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280901u32 as _);
pub const TPM_20_E_CPHASH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280151u32 as _);
pub const TPM_20_E_CURVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802800A6u32 as _);
pub const TPM_20_E_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280120u32 as _);
pub const TPM_20_E_ECC_CURVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280123u32 as _);
pub const TPM_20_E_ECC_POINT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802800A7u32 as _);
pub const TPM_20_E_EXCLUSIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280121u32 as _);
pub const TPM_20_E_EXPIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802800A3u32 as _);
pub const TPM_20_E_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280101u32 as _);
pub const TPM_20_E_HANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028008Bu32 as _);
pub const TPM_20_E_HASH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280083u32 as _);
pub const TPM_20_E_HIERARCHY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280085u32 as _);
pub const TPM_20_E_HMAC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280119u32 as _);
pub const TPM_20_E_INITIALIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280100u32 as _);
pub const TPM_20_E_INSUFFICIENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028009Au32 as _);
pub const TPM_20_E_INTEGRITY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028009Fu32 as _);
pub const TPM_20_E_KDF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028008Cu32 as _);
pub const TPM_20_E_KEY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028009Cu32 as _);
pub const TPM_20_E_KEY_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280087u32 as _);
pub const TPM_20_E_LOCALITY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280907u32 as _);
pub const TPM_20_E_LOCKOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280921u32 as _);
pub const TPM_20_E_MEMORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280904u32 as _);
pub const TPM_20_E_MGF: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280088u32 as _);
pub const TPM_20_E_MODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280089u32 as _);
pub const TPM_20_E_NEEDS_TEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280153u32 as _);
pub const TPM_20_E_NONCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028008Fu32 as _);
pub const TPM_20_E_NO_RESULT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280154u32 as _);
pub const TPM_20_E_NV_AUTHORIZATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280149u32 as _);
pub const TPM_20_E_NV_DEFINED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028014Cu32 as _);
pub const TPM_20_E_NV_LOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280148u32 as _);
pub const TPM_20_E_NV_RANGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280146u32 as _);
pub const TPM_20_E_NV_RATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280920u32 as _);
pub const TPM_20_E_NV_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280147u32 as _);
pub const TPM_20_E_NV_SPACE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028014Bu32 as _);
pub const TPM_20_E_NV_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280923u32 as _);
pub const TPM_20_E_NV_UNINITIALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028014Au32 as _);
pub const TPM_20_E_OBJECT_HANDLES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280906u32 as _);
pub const TPM_20_E_OBJECT_MEMORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280902u32 as _);
pub const TPM_20_E_PARENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280152u32 as _);
pub const TPM_20_E_PCR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280127u32 as _);
pub const TPM_20_E_PCR_CHANGED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280128u32 as _);
pub const TPM_20_E_POLICY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280126u32 as _);
pub const TPM_20_E_POLICY_CC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802800A4u32 as _);
pub const TPM_20_E_POLICY_FAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028009Du32 as _);
pub const TPM_20_E_PP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280090u32 as _);
pub const TPM_20_E_PRIVATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028010Bu32 as _);
pub const TPM_20_E_RANGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028008Du32 as _);
pub const TPM_20_E_REBOOT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280130u32 as _);
pub const TPM_20_E_RESERVED_BITS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802800A1u32 as _);
pub const TPM_20_E_RETRY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280922u32 as _);
pub const TPM_20_E_SCHEME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280092u32 as _);
pub const TPM_20_E_SELECTOR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280098u32 as _);
pub const TPM_20_E_SENSITIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280155u32 as _);
pub const TPM_20_E_SEQUENCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280103u32 as _);
pub const TPM_20_E_SESSION_HANDLES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280905u32 as _);
pub const TPM_20_E_SESSION_MEMORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280903u32 as _);
pub const TPM_20_E_SIGNATURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028009Bu32 as _);
pub const TPM_20_E_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280095u32 as _);
pub const TPM_20_E_SYMMETRIC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280096u32 as _);
pub const TPM_20_E_TAG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280097u32 as _);
pub const TPM_20_E_TESTING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028090Au32 as _);
pub const TPM_20_E_TICKET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802800A0u32 as _);
pub const TPM_20_E_TOO_MANY_CONTEXTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028012Eu32 as _);
pub const TPM_20_E_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028008Au32 as _);
pub const TPM_20_E_UNBALANCED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280131u32 as _);
pub const TPM_20_E_UPGRADE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028012Du32 as _);
pub const TPM_20_E_VALUE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280084u32 as _);
pub const TPM_20_E_YIELDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280908u32 as _);
pub const TPM_E_AREA_LOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028003Cu32 as _);
pub const TPM_E_ATTESTATION_CHALLENGE_NOT_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290412u32 as _);
pub const TPM_E_AUDITFAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280004u32 as _);
pub const TPM_E_AUDITFAIL_SUCCESSFUL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280031u32 as _);
pub const TPM_E_AUDITFAIL_UNSUCCESSFUL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280030u32 as _);
pub const TPM_E_AUTH2FAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028001Du32 as _);
pub const TPM_E_AUTHFAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280001u32 as _);
pub const TPM_E_AUTH_CONFLICT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028003Bu32 as _);
pub const TPM_E_BADCONTEXT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028005Au32 as _);
pub const TPM_E_BADINDEX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280002u32 as _);
pub const TPM_E_BADTAG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028001Eu32 as _);
pub const TPM_E_BAD_ATTRIBUTES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280042u32 as _);
pub const TPM_E_BAD_COUNTER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280045u32 as _);
pub const TPM_E_BAD_DATASIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028002Bu32 as _);
pub const TPM_E_BAD_DELEGATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280059u32 as _);
pub const TPM_E_BAD_HANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280058u32 as _);
pub const TPM_E_BAD_KEY_PROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280028u32 as _);
pub const TPM_E_BAD_LOCALITY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028003Du32 as _);
pub const TPM_E_BAD_MIGRATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280029u32 as _);
pub const TPM_E_BAD_MODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028002Cu32 as _);
pub const TPM_E_BAD_ORDINAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028000Au32 as _);
pub const TPM_E_BAD_PARAMETER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280003u32 as _);
pub const TPM_E_BAD_PARAM_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280019u32 as _);
pub const TPM_E_BAD_PRESENCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028002Du32 as _);
pub const TPM_E_BAD_SCHEME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028002Au32 as _);
pub const TPM_E_BAD_SIGNATURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280062u32 as _);
pub const TPM_E_BAD_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280034u32 as _);
pub const TPM_E_BAD_VERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028002Eu32 as _);
pub const TPM_E_BUFFER_LENGTH_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029041Eu32 as _);
pub const TPM_E_CLAIM_TYPE_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029041Cu32 as _);
pub const TPM_E_CLEAR_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280005u32 as _);
pub const TPM_E_COMMAND_BLOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280400u32 as _);
pub const TPM_E_CONTEXT_GAP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280047u32 as _);
pub const TPM_E_DAA_INPUT_DATA0: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280051u32 as _);
pub const TPM_E_DAA_INPUT_DATA1: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280052u32 as _);
pub const TPM_E_DAA_ISSUER_SETTINGS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280053u32 as _);
pub const TPM_E_DAA_ISSUER_VALIDITY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280056u32 as _);
pub const TPM_E_DAA_RESOURCES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280050u32 as _);
pub const TPM_E_DAA_STAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280055u32 as _);
pub const TPM_E_DAA_TPM_SETTINGS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280054u32 as _);
pub const TPM_E_DAA_WRONG_W: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280057u32 as _);
pub const TPM_E_DEACTIVATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280006u32 as _);
pub const TPM_E_DECRYPT_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280021u32 as _);
pub const TPM_E_DEFEND_LOCK_RUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280803u32 as _);
pub const TPM_E_DELEGATE_ADMIN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028004Du32 as _);
pub const TPM_E_DELEGATE_FAMILY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028004Cu32 as _);
pub const TPM_E_DELEGATE_LOCK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028004Bu32 as _);
pub const TPM_E_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280007u32 as _);
pub const TPM_E_DISABLED_CMD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280008u32 as _);
pub const TPM_E_DOING_SELFTEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280802u32 as _);
pub const TPM_E_DUPLICATE_VHANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280402u32 as _);
pub const TPM_E_EMBEDDED_COMMAND_BLOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280403u32 as _);
pub const TPM_E_EMBEDDED_COMMAND_UNSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280404u32 as _);
pub const TPM_E_ENCRYPT_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280020u32 as _);
pub const TPM_E_ERROR_MASK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280000u32 as _);
pub const TPM_E_FAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280009u32 as _);
pub const TPM_E_FAILEDSELFTEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028001Cu32 as _);
pub const TPM_E_FAMILYCOUNT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280040u32 as _);
pub const TPM_E_INAPPROPRIATE_ENC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028000Eu32 as _);
pub const TPM_E_INAPPROPRIATE_SIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280027u32 as _);
pub const TPM_E_INSTALL_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028000Bu32 as _);
pub const TPM_E_INVALID_AUTHHANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280022u32 as _);
pub const TPM_E_INVALID_FAMILY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280037u32 as _);
pub const TPM_E_INVALID_HANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280401u32 as _);
pub const TPM_E_INVALID_KEYHANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028000Cu32 as _);
pub const TPM_E_INVALID_KEYUSAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280024u32 as _);
pub const TPM_E_INVALID_OWNER_AUTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290601u32 as _);
pub const TPM_E_INVALID_PCR_INFO: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280010u32 as _);
pub const TPM_E_INVALID_POSTINIT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280026u32 as _);
pub const TPM_E_INVALID_RESOURCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280035u32 as _);
pub const TPM_E_INVALID_STRUCTURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280043u32 as _);
pub const TPM_E_IOERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028001Fu32 as _);
pub const TPM_E_KEYNOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028000Du32 as _);
pub const TPM_E_KEY_ALREADY_FINALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290414u32 as _);
pub const TPM_E_KEY_NOTSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028003Au32 as _);
pub const TPM_E_KEY_NOT_AUTHENTICATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290418u32 as _);
pub const TPM_E_KEY_NOT_FINALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290411u32 as _);
pub const TPM_E_KEY_NOT_LOADED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029040Fu32 as _);
pub const TPM_E_KEY_NOT_SIGNING_KEY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029041Au32 as _);
pub const TPM_E_KEY_OWNER_CONTROL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280044u32 as _);
pub const TPM_E_KEY_USAGE_POLICY_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290416u32 as _);
pub const TPM_E_KEY_USAGE_POLICY_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290415u32 as _);
pub const TPM_E_LOCKED_OUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029041Bu32 as _);
pub const TPM_E_MAXNVWRITES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280048u32 as _);
pub const TPM_E_MA_AUTHORITY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028005Fu32 as _);
pub const TPM_E_MA_DESTINATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028005Du32 as _);
pub const TPM_E_MA_SOURCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028005Eu32 as _);
pub const TPM_E_MA_TICKET_SIGNATURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028005Cu32 as _);
pub const TPM_E_MIGRATEFAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028000Fu32 as _);
pub const TPM_E_NEEDS_SELFTEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280801u32 as _);
pub const TPM_E_NOCONTEXTSPACE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280063u32 as _);
pub const TPM_E_NOOPERATOR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280049u32 as _);
pub const TPM_E_NOSPACE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280011u32 as _);
pub const TPM_E_NOSRK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280012u32 as _);
pub const TPM_E_NOTFIPS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280036u32 as _);
pub const TPM_E_NOTLOCAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280033u32 as _);
pub const TPM_E_NOTRESETABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280032u32 as _);
pub const TPM_E_NOTSEALED_BLOB: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280013u32 as _);
pub const TPM_E_NOT_FULLWRITE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280046u32 as _);
pub const TPM_E_NOT_PCR_BOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290413u32 as _);
pub const TPM_E_NO_ENDORSEMENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280023u32 as _);
pub const TPM_E_NO_KEY_CERTIFICATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290410u32 as _);
pub const TPM_E_NO_NV_PERMISSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280038u32 as _);
pub const TPM_E_NO_WRAP_TRANSPORT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028002Fu32 as _);
pub const TPM_E_OWNER_CONTROL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028004Fu32 as _);
pub const TPM_E_OWNER_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280014u32 as _);
pub const TPM_E_PCP_AUTHENTICATION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290408u32 as _);
pub const TPM_E_PCP_AUTHENTICATION_IGNORED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290409u32 as _);
pub const TPM_E_PCP_BUFFER_TOO_SMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290406u32 as _);
pub const TPM_E_PCP_DEVICE_NOT_READY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290401u32 as _);
pub const TPM_E_PCP_ERROR_MASK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290400u32 as _);
pub const TPM_E_PCP_FLAG_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290404u32 as _);
pub const TPM_E_PCP_IFX_RSA_KEY_CREATION_BLOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029041Fu32 as _);
pub const TPM_E_PCP_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290407u32 as _);
pub const TPM_E_PCP_INVALID_HANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290402u32 as _);
pub const TPM_E_PCP_INVALID_PARAMETER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290403u32 as _);
pub const TPM_E_PCP_KEY_HANDLE_INVALIDATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290422u32 as _);
pub const TPM_E_PCP_KEY_NOT_AIK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290419u32 as _);
pub const TPM_E_PCP_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290405u32 as _);
pub const TPM_E_PCP_PLATFORM_CLAIM_MAY_BE_OUTDATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40290424u32 as _);
pub const TPM_E_PCP_PLATFORM_CLAIM_OUTDATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40290425u32 as _);
pub const TPM_E_PCP_PLATFORM_CLAIM_REBOOT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40290426u32 as _);
pub const TPM_E_PCP_POLICY_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029040Au32 as _);
pub const TPM_E_PCP_PROFILE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029040Bu32 as _);
pub const TPM_E_PCP_RAW_POLICY_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290421u32 as _);
pub const TPM_E_PCP_TICKET_MISSING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290420u32 as _);
pub const TPM_E_PCP_UNSUPPORTED_PSS_SALT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40290423u32 as _);
pub const TPM_E_PCP_VALIDATION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029040Cu32 as _);
pub const TPM_E_PCP_WRONG_PARENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029040Eu32 as _);
pub const TPM_E_PERMANENTEK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280061u32 as _);
pub const TPM_E_PER_NOWRITE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028003Fu32 as _);
pub const TPM_E_PPI_ACPI_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290300u32 as _);
pub const TPM_E_PPI_BIOS_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290302u32 as _);
pub const TPM_E_PPI_BLOCKED_IN_BIOS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290304u32 as _);
pub const TPM_E_PPI_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290303u32 as _);
pub const TPM_E_PPI_USER_ABORT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290301u32 as _);
pub const TPM_E_PROVISIONING_INCOMPLETE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290600u32 as _);
pub const TPM_E_READ_ONLY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028003Eu32 as _);
pub const TPM_E_REQUIRES_SIGN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280039u32 as _);
pub const TPM_E_RESOURCEMISSING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028004Au32 as _);
pub const TPM_E_RESOURCES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280015u32 as _);
pub const TPM_E_RETRY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280800u32 as _);
pub const TPM_E_SHA_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028001Bu32 as _);
pub const TPM_E_SHA_THREAD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028001Au32 as _);
pub const TPM_E_SHORTRANDOM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280016u32 as _);
pub const TPM_E_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280017u32 as _);
pub const TPM_E_SOFT_KEY_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290417u32 as _);
pub const TPM_E_TOOMANYCONTEXTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028005Bu32 as _);
pub const TPM_E_TOO_MUCH_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290602u32 as _);
pub const TPM_E_TPM_GENERATED_EPS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290603u32 as _);
pub const TPM_E_TRANSPORT_NOTEXCLUSIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8028004Eu32 as _);
pub const TPM_E_VERSION_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8029041Du32 as _);
pub const TPM_E_WRITE_LOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280041u32 as _);
pub const TPM_E_WRONGPCRVAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280018u32 as _);
pub const TPM_E_WRONG_ENTITYTYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80280025u32 as _);
pub const TPM_E_ZERO_EXHAUST_ENABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80290500u32 as _);
pub const TRUE: BOOL = BOOL(1i32);
pub const TRUST_E_ACTION_UNKNOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0002u32 as _);
pub const TRUST_E_BAD_DIGEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80096010u32 as _);
pub const TRUST_E_BASIC_CONSTRAINTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80096019u32 as _);
pub const TRUST_E_CERT_SIGNATURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80096004u32 as _);
pub const TRUST_E_COUNTER_SIGNER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80096003u32 as _);
pub const TRUST_E_EXPLICIT_DISTRUST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0111u32 as _);
pub const TRUST_E_FAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B010Bu32 as _);
pub const TRUST_E_FINANCIAL_CRITERIA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8009601Eu32 as _);
pub const TRUST_E_MALFORMED_SIGNATURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80096011u32 as _);
pub const TRUST_E_NOSIGNATURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0100u32 as _);
pub const TRUST_E_NO_SIGNER_CERT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80096002u32 as _);
pub const TRUST_E_PROVIDER_UNKNOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0001u32 as _);
pub const TRUST_E_SUBJECT_FORM_UNKNOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0003u32 as _);
pub const TRUST_E_SUBJECT_NOT_TRUSTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800B0004u32 as _);
pub const TRUST_E_SYSTEM_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80096001u32 as _);
pub const TRUST_E_TIME_STAMP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80096005u32 as _);
pub const TYPE_E_AMBIGUOUSNAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8002802Cu32 as _);
pub const TYPE_E_BADMODULEKIND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800288BDu32 as _);
pub const TYPE_E_BUFFERTOOSMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80028016u32 as _);
pub const TYPE_E_CANTCREATETMPFILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80028CA3u32 as _);
pub const TYPE_E_CANTLOADLIBRARY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80029C4Au32 as _);
pub const TYPE_E_CIRCULARTYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80029C84u32 as _);
pub const TYPE_E_DLLFUNCTIONNOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8002802Fu32 as _);
pub const TYPE_E_DUPLICATEID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800288C6u32 as _);
pub const TYPE_E_ELEMENTNOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8002802Bu32 as _);
pub const TYPE_E_FIELDNOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80028017u32 as _);
pub const TYPE_E_INCONSISTENTPROPFUNCS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80029C83u32 as _);
pub const TYPE_E_INVALIDID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800288CFu32 as _);
pub const TYPE_E_INVALIDSTATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80028029u32 as _);
pub const TYPE_E_INVDATAREAD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80028018u32 as _);
pub const TYPE_E_IOERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80028CA2u32 as _);
pub const TYPE_E_LIBNOTREGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8002801Du32 as _);
pub const TYPE_E_NAMECONFLICT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8002802Du32 as _);
pub const TYPE_E_OUTOFBOUNDS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80028CA1u32 as _);
pub const TYPE_E_QUALIFIEDNAMEDISALLOWED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80028028u32 as _);
pub const TYPE_E_REGISTRYACCESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8002801Cu32 as _);
pub const TYPE_E_SIZETOOBIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800288C5u32 as _);
pub const TYPE_E_TYPEMISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80028CA0u32 as _);
pub const TYPE_E_UNDEFINEDTYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80028027u32 as _);
pub const TYPE_E_UNKNOWNLCID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8002802Eu32 as _);
pub const TYPE_E_UNSUPFORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80028019u32 as _);
pub const TYPE_E_WRONGTYPEKIND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8002802Au32 as _);
pub const UCEERR_BLOCKSFULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980409u32 as _);
pub const UCEERR_CHANNELSYNCABANDONED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980414u32 as _);
pub const UCEERR_CHANNELSYNCTIMEDOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980413u32 as _);
pub const UCEERR_COMMANDTRANSPORTDENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980418u32 as _);
pub const UCEERR_CONNECTIONIDLOOKUPFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980408u32 as _);
pub const UCEERR_CTXSTACKFRSTTARGETNULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980407u32 as _);
pub const UCEERR_FEEDBACK_UNSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980417u32 as _);
pub const UCEERR_GRAPHICSSTREAMALREADYOPEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980420u32 as _);
pub const UCEERR_GRAPHICSSTREAMUNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980419u32 as _);
pub const UCEERR_HANDLELOOKUPFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980405u32 as _);
pub const UCEERR_ILLEGALHANDLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980404u32 as _);
pub const UCEERR_ILLEGALPACKET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980402u32 as _);
pub const UCEERR_ILLEGALRECORDTYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898040Cu32 as _);
pub const UCEERR_INVALIDPACKETHEADER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980400u32 as _);
pub const UCEERR_MALFORMEDPACKET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980403u32 as _);
pub const UCEERR_MEMORYFAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898040Au32 as _);
pub const UCEERR_MISSINGBEGINCOMMAND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980412u32 as _);
pub const UCEERR_MISSINGENDCOMMAND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980411u32 as _);
pub const UCEERR_NO_MULTIPLE_WORKER_THREADS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898040Fu32 as _);
pub const UCEERR_OUTOFHANDLES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898040Du32 as _);
pub const UCEERR_PACKETRECORDOUTOFRANGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898040Bu32 as _);
pub const UCEERR_PARTITION_ZOMBIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980423u32 as _);
pub const UCEERR_REMOTINGNOTSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980410u32 as _);
pub const UCEERR_RENDERTHREADFAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980406u32 as _);
pub const UCEERR_TRANSPORTDISCONNECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980421u32 as _);
pub const UCEERR_TRANSPORTOVERLOADED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980422u32 as _);
pub const UCEERR_TRANSPORTUNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980416u32 as _);
pub const UCEERR_UNCHANGABLE_UPDATE_ATTEMPTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8898040Eu32 as _);
pub const UCEERR_UNKNOWNPACKET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980401u32 as _);
pub const UCEERR_UNSUPPORTEDTRANSPORTVERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88980415u32 as _);
pub const UI_E_AMBIGUOUS_MATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A000Au32 as _);
pub const UI_E_BOOLEAN_EXPECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0008u32 as _);
pub const UI_E_CREATE_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0001u32 as _);
pub const UI_E_DIFFERENT_OWNER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0009u32 as _);
pub const UI_E_END_KEYFRAME_NOT_DETERMINED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0104u32 as _);
pub const UI_E_FP_OVERFLOW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A000Bu32 as _);
pub const UI_E_ILLEGAL_REENTRANCY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0003u32 as _);
pub const UI_E_INVALID_DIMENSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A010Bu32 as _);
pub const UI_E_INVALID_OUTPUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0007u32 as _);
pub const UI_E_LOOPS_OVERLAP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0105u32 as _);
pub const UI_E_OBJECT_SEALED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0004u32 as _);
pub const UI_E_PRIMITIVE_OUT_OF_BOUNDS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A010Cu32 as _);
pub const UI_E_SHUTDOWN_CALLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0002u32 as _);
pub const UI_E_START_KEYFRAME_AFTER_END: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0103u32 as _);
pub const UI_E_STORYBOARD_ACTIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0101u32 as _);
pub const UI_E_STORYBOARD_NOT_PLAYING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0102u32 as _);
pub const UI_E_TIMER_CLIENT_ALREADY_CONNECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A010Au32 as _);
pub const UI_E_TIME_BEFORE_LAST_UPDATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0109u32 as _);
pub const UI_E_TRANSITION_ALREADY_USED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0106u32 as _);
pub const UI_E_TRANSITION_ECLIPSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0108u32 as _);
pub const UI_E_TRANSITION_NOT_IN_STORYBOARD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0107u32 as _);
pub const UI_E_VALUE_NOT_DETERMINED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0006u32 as _);
pub const UI_E_VALUE_NOT_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0005u32 as _);
pub const UI_E_WINDOW_CLOSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A0201u32 as _);
pub const UI_E_WRONG_THREAD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x802A000Cu32 as _);
pub const UTC_E_ACTION_NOT_SUPPORTED_IN_DESTINATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51044u32 as _);
pub const UTC_E_AGENT_DIAGNOSTICS_TOO_LARGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51055u32 as _);
pub const UTC_E_ALTERNATIVE_TRACE_CANNOT_PREEMPT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51002u32 as _);
pub const UTC_E_AOT_NOT_RUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51003u32 as _);
pub const UTC_E_API_BUSY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5102Bu32 as _);
pub const UTC_E_API_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5103Cu32 as _);
pub const UTC_E_API_RESULT_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51028u32 as _);
pub const UTC_E_BINARY_MISSING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51034u32 as _);
pub const UTC_E_CANNOT_LOAD_SCENARIO_EDITOR_XML: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5101Fu32 as _);
pub const UTC_E_CERT_REV_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5103Fu32 as _);
pub const UTC_E_CHILD_PROCESS_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5101Du32 as _);
pub const UTC_E_COMMAND_LINE_NOT_AUTHORIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5101Eu32 as _);
pub const UTC_E_DELAY_TERMINATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51025u32 as _);
pub const UTC_E_DEVICE_TICKET_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51026u32 as _);
pub const UTC_E_DIAGRULES_SCHEMAVERSION_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5100Au32 as _);
pub const UTC_E_ESCALATION_ALREADY_RUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5100Fu32 as _);
pub const UTC_E_ESCALATION_CANCELLED_AT_SHUTDOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5105Au32 as _);
pub const UTC_E_ESCALATION_DIRECTORY_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5102Fu32 as _);
pub const UTC_E_ESCALATION_NOT_AUTHORIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5101Bu32 as _);
pub const UTC_E_ESCALATION_TIMED_OUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51020u32 as _);
pub const UTC_E_EVENTLOG_ENTRY_MALFORMED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51009u32 as _);
pub const UTC_E_EXCLUSIVITY_NOT_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5102Du32 as _);
pub const UTC_E_EXE_TERMINATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5101Au32 as _);
pub const UTC_E_FAILED_TO_RECEIVE_AGENT_DIAGNOSTICS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51056u32 as _);
pub const UTC_E_FAILED_TO_RESOLVE_CONTAINER_ID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51036u32 as _);
pub const UTC_E_FAILED_TO_START_NDISCAP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51040u32 as _);
pub const UTC_E_FILTER_FUNCTION_RESTRICTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51048u32 as _);
pub const UTC_E_FILTER_ILLEGAL_EVAL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51053u32 as _);
pub const UTC_E_FILTER_INVALID_COMMAND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51052u32 as _);
pub const UTC_E_FILTER_INVALID_FUNCTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51050u32 as _);
pub const UTC_E_FILTER_INVALID_FUNCTION_PARAMS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51051u32 as _);
pub const UTC_E_FILTER_INVALID_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51046u32 as _);
pub const UTC_E_FILTER_MISSING_ATTRIBUTE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51045u32 as _);
pub const UTC_E_FILTER_VARIABLE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51047u32 as _);
pub const UTC_E_FILTER_VERSION_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51049u32 as _);
pub const UTC_E_FORWARDER_ALREADY_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51008u32 as _);
pub const UTC_E_FORWARDER_ALREADY_ENABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51007u32 as _);
pub const UTC_E_FORWARDER_PRODUCER_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51012u32 as _);
pub const UTC_E_GETFILEINFOACTION_FILE_NOT_APPROVED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5105Bu32 as _);
pub const UTC_E_GETFILE_EXTERNAL_PATH_NOT_APPROVED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5103Du32 as _);
pub const UTC_E_GETFILE_FILE_PATH_NOT_APPROVED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5102Eu32 as _);
pub const UTC_E_INSUFFICIENT_SPACE_TO_START_TRACE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51059u32 as _);
pub const UTC_E_INTENTIONAL_SCRIPT_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51013u32 as _);
pub const UTC_E_INVALID_AGGREGATION_STRUCT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51043u32 as _);
pub const UTC_E_INVALID_CUSTOM_FILTER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5100Cu32 as _);
pub const UTC_E_INVALID_FILTER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51019u32 as _);
pub const UTC_E_KERNELDUMP_LIMIT_REACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51041u32 as _);
pub const UTC_E_MISSING_AGGREGATE_EVENT_TAG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51042u32 as _);
pub const UTC_E_MULTIPLE_TIME_TRIGGER_ON_SINGLE_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51033u32 as _);
pub const UTC_E_NO_WER_LOGGER_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51015u32 as _);
pub const UTC_E_PERFTRACK_ALREADY_TRACING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51010u32 as _);
pub const UTC_E_REACHED_MAX_ESCALATIONS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51011u32 as _);
pub const UTC_E_REESCALATED_TOO_QUICKLY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5100Eu32 as _);
pub const UTC_E_RPC_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51029u32 as _);
pub const UTC_E_RPC_WAIT_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5102Au32 as _);
pub const UTC_E_SCENARIODEF_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51005u32 as _);
pub const UTC_E_SCENARIODEF_SCHEMAVERSION_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51018u32 as _);
pub const UTC_E_SCENARIO_HAS_NO_ACTIONS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51057u32 as _);
pub const UTC_E_SCENARIO_THROTTLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5103Bu32 as _);
pub const UTC_E_SCRIPT_MISSING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5103Au32 as _);
pub const UTC_E_SCRIPT_TERMINATED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5100Bu32 as _);
pub const UTC_E_SCRIPT_TYPE_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51004u32 as _);
pub const UTC_E_SETREGKEYACTION_TYPE_NOT_APPROVED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5105Cu32 as _);
pub const UTC_E_SETUP_NOT_AUTHORIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5101Cu32 as _);
pub const UTC_E_SETUP_TIMED_OUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51021u32 as _);
pub const UTC_E_SIF_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51024u32 as _);
pub const UTC_E_SQM_INIT_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51014u32 as _);
pub const UTC_E_THROTTLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51038u32 as _);
pub const UTC_E_TIME_TRIGGER_INVALID_TIME_RANGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51032u32 as _);
pub const UTC_E_TIME_TRIGGER_ONLY_VALID_ON_SINGLE_TRANSITION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51031u32 as _);
pub const UTC_E_TIME_TRIGGER_ON_START_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51030u32 as _);
pub const UTC_E_TOGGLE_TRACE_STARTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51001u32 as _);
pub const UTC_E_TRACEPROFILE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51006u32 as _);
pub const UTC_E_TRACERS_DONT_EXIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51016u32 as _);
pub const UTC_E_TRACE_BUFFER_LIMIT_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51027u32 as _);
pub const UTC_E_TRACE_MIN_DURATION_REQUIREMENT_NOT_MET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5102Cu32 as _);
pub const UTC_E_TRACE_NOT_RUNNING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5100Du32 as _);
pub const UTC_E_TRACE_THROTTLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5105Du32 as _);
pub const UTC_E_TRIGGER_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51022u32 as _);
pub const UTC_E_TRIGGER_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51023u32 as _);
pub const UTC_E_TRY_GET_SCENARIO_TIMEOUT_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C5103Eu32 as _);
pub const UTC_E_TTTRACER_RETURNED_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51054u32 as _);
pub const UTC_E_TTTRACER_STORAGE_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51058u32 as _);
pub const UTC_E_UNABLE_TO_RESOLVE_SESSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51037u32 as _);
pub const UTC_E_UNAPPROVED_SCRIPT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51039u32 as _);
pub const UTC_E_WINRT_INIT_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x87C51017u32 as _);
pub const VARIANT_FALSE: VARIANT_BOOL = VARIANT_BOOL(0i16);
pub const VARIANT_TRUE: VARIANT_BOOL = VARIANT_BOOL(-1i16);
pub const VIEW_E_DRAW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040140u32 as _);
pub const VIEW_E_FIRST: i32 = -2147221184i32;
pub const VIEW_E_LAST: i32 = -2147221169i32;
pub const VIEW_S_ALREADY_FROZEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x40140u32 as _);
pub const VIEW_S_FIRST: i32 = 262464i32;
pub const VIEW_S_LAST: i32 = 262479i32;
pub const VM_SAVED_STATE_DUMP_E_GUEST_MEMORY_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0370501u32 as _);
pub const VM_SAVED_STATE_DUMP_E_INVALID_VP_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0370506u32 as _);
pub const VM_SAVED_STATE_DUMP_E_NESTED_VIRTUALIZATION_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0370503u32 as _);
pub const VM_SAVED_STATE_DUMP_E_NO_VP_FOUND_IN_PARTITION_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0370502u32 as _);
pub const VM_SAVED_STATE_DUMP_E_PARTITION_STATE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0370500u32 as _);
pub const VM_SAVED_STATE_DUMP_E_VA_NOT_MAPPED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0370505u32 as _);
pub const VM_SAVED_STATE_DUMP_E_VP_VTL_NOT_ENABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0370509u32 as _);
pub const VM_SAVED_STATE_DUMP_E_WINDOWS_KERNEL_IMAGE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0xC0370504u32 as _);
...
pub const WBREAK_E_BUFFER_TOO_SMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041783u32 as _);
pub const WBREAK_E_END_OF_TEXT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041780u32 as _);
pub const WBREAK_E_INIT_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041785u32 as _);
pub const WBREAK_E_QUERY_ONLY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80041782u32 as _);
pub const WEB_E_INVALID_JSON_NUMBER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x83750008u32 as _);
pub const WEB_E_INVALID_JSON_STRING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x83750007u32 as _);
pub const WEB_E_INVALID_XML: ::windows_core::HRESULT = ::windows_core::HRESULT(0x83750002u32 as _);
pub const WEB_E_JSON_VALUE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x83750009u32 as _);
pub const WEB_E_MISSING_REQUIRED_ATTRIBUTE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x83750004u32 as _);
pub const WEB_E_MISSING_REQUIRED_ELEMENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x83750003u32 as _);
pub const WEB_E_RESOURCE_TOO_LARGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x83750006u32 as _);
pub const WEB_E_UNEXPECTED_CONTENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x83750005u32 as _);
pub const WEB_E_UNSUPPORTED_FORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x83750001u32 as _);
pub const WEP_E_BUFFER_TOO_LARGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88010009u32 as _);
pub const WEP_E_FIXED_DATA_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88010002u32 as _);
pub const WEP_E_HARDWARE_NOT_COMPLIANT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88010003u32 as _);
pub const WEP_E_LOCK_NOT_CONFIGURED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88010004u32 as _);
pub const WEP_E_NOT_PROVISIONED_ON_ALL_VOLUMES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88010001u32 as _);
pub const WEP_E_NO_LICENSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88010006u32 as _);
pub const WEP_E_OS_NOT_PROTECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88010007u32 as _);
pub const WEP_E_PROTECTION_SUSPENDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88010005u32 as _);
pub const WEP_E_UNEXPECTED_FAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88010008u32 as _);
pub const WER_E_ALREADY_REPORTING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801B8004u32 as _);
pub const WER_E_CANCELED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801B8001u32 as _);
pub const WER_E_CRASH_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801B8000u32 as _);
pub const WER_E_DUMP_THROTTLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801B8005u32 as _);
pub const WER_E_INSUFFICIENT_CONSENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801B8006u32 as _);
pub const WER_E_NETWORK_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801B8002u32 as _);
pub const WER_E_NOT_INITIALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801B8003u32 as _);
pub const WER_E_TOO_HEAVY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x801B8007u32 as _);
pub const WER_S_ASSERT_CONTINUE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x1B000Au32 as _);
pub const WER_S_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x1B0003u32 as _);
pub const WER_S_DISABLED_ARCHIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x1B0006u32 as _);
pub const WER_S_DISABLED_QUEUE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x1B0005u32 as _);
pub const WER_S_IGNORE_ALL_ASSERTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x1B0009u32 as _);
pub const WER_S_IGNORE_ASSERT_INSTANCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x1B0008u32 as _);
pub const WER_S_REPORT_ASYNC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x1B0007u32 as _);
pub const WER_S_REPORT_DEBUG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x1B0000u32 as _);
pub const WER_S_REPORT_QUEUED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x1B0002u32 as _);
pub const WER_S_REPORT_UPLOADED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x1B0001u32 as _);
pub const WER_S_REPORT_UPLOADED_CAB: ::windows_core::HRESULT = ::windows_core::HRESULT(0x1B000Cu32 as _);
pub const WER_S_SUSPENDED_UPLOAD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x1B0004u32 as _);
pub const WER_S_THROTTLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x1B000Bu32 as _);
pub const WHV_E_GPA_RANGE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370305u32 as _);
pub const WHV_E_INSUFFICIENT_BUFFER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370301u32 as _);
pub const WHV_E_INVALID_PARTITION_CONFIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370304u32 as _);
pub const WHV_E_INVALID_VP_REGISTER_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370309u32 as _);
pub const WHV_E_INVALID_VP_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370308u32 as _);
pub const WHV_E_UNKNOWN_CAPABILITY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370300u32 as _);
pub const WHV_E_UNKNOWN_PROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370302u32 as _);
pub const WHV_E_UNSUPPORTED_HYPERVISOR_CONFIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370303u32 as _);
pub const WHV_E_UNSUPPORTED_PROCESSOR_CONFIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370310u32 as _);
pub const WHV_E_VP_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370306u32 as _);
pub const WHV_E_VP_DOES_NOT_EXIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80370307u32 as _);
pub const WINCODEC_ERR_ALREADYLOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F0Du32 as _);
pub const WINCODEC_ERR_BADHEADER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F61u32 as _);
pub const WINCODEC_ERR_BADIMAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F60u32 as _);
pub const WINCODEC_ERR_BADMETADATAHEADER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F63u32 as _);
pub const WINCODEC_ERR_BADSTREAMDATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F70u32 as _);
pub const WINCODEC_ERR_CODECNOTHUMBNAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F44u32 as _);
pub const WINCODEC_ERR_CODECPRESENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F43u32 as _);
pub const WINCODEC_ERR_CODECTOOMANYSCANLINES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F46u32 as _);
pub const WINCODEC_ERR_COMPONENTINITIALIZEFAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F8Bu32 as _);
pub const WINCODEC_ERR_COMPONENTNOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F50u32 as _);
pub const WINCODEC_ERR_DUPLICATEMETADATAPRESENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F8Du32 as _);
pub const WINCODEC_ERR_FRAMEMISSING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F62u32 as _);
pub const WINCODEC_ERR_IMAGESIZEOUTOFRANGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F51u32 as _);
pub const WINCODEC_ERR_INSUFFICIENTBUFFER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F8Cu32 as _);
pub const WINCODEC_ERR_INTERNALERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F48u32 as _);
pub const WINCODEC_ERR_INVALIDJPEGSCANINDEX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F96u32 as _);
pub const WINCODEC_ERR_INVALIDPROGRESSIVELEVEL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F95u32 as _);
pub const WINCODEC_ERR_INVALIDQUERYCHARACTER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F93u32 as _);
pub const WINCODEC_ERR_INVALIDQUERYREQUEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F90u32 as _);
pub const WINCODEC_ERR_INVALIDREGISTRATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F8Au32 as _);
pub const WINCODEC_ERR_NOTINITIALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F0Cu32 as _);
pub const WINCODEC_ERR_PALETTEUNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F45u32 as _);
pub const WINCODEC_ERR_PROPERTYNOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F40u32 as _);
pub const WINCODEC_ERR_PROPERTYNOTSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F41u32 as _);
pub const WINCODEC_ERR_PROPERTYSIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F42u32 as _);
pub const WINCODEC_ERR_PROPERTYUNEXPECTEDTYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F8Eu32 as _);
pub const WINCODEC_ERR_REQUESTONLYVALIDATMETADATAROOT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F92u32 as _);
pub const WINCODEC_ERR_SOURCERECTDOESNOTMATCHDIMENSIONS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F49u32 as _);
pub const WINCODEC_ERR_STREAMNOTAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F73u32 as _);
pub const WINCODEC_ERR_STREAMREAD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F72u32 as _);
pub const WINCODEC_ERR_STREAMWRITE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F71u32 as _);
pub const WINCODEC_ERR_TOOMUCHMETADATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F52u32 as _);
pub const WINCODEC_ERR_UNEXPECTEDMETADATATYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F91u32 as _);
pub const WINCODEC_ERR_UNEXPECTEDSIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F8Fu32 as _);
pub const WINCODEC_ERR_UNKNOWNIMAGEFORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F07u32 as _);
pub const WINCODEC_ERR_UNSUPPORTEDOPERATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F81u32 as _);
pub const WINCODEC_ERR_UNSUPPORTEDPIXELFORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F80u32 as _);
pub const WINCODEC_ERR_UNSUPPORTEDVERSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F0Bu32 as _);
pub const WINCODEC_ERR_VALUEOUTOFRANGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F05u32 as _);
pub const WINCODEC_ERR_WIN32ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F94u32 as _);
pub const WINCODEC_ERR_WRONGSTATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88982F04u32 as _);
pub const WININET_E_ASYNC_THREAD_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F0Fu32 as _);
pub const WININET_E_BAD_AUTO_PROXY_SCRIPT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F86u32 as _);
pub const WININET_E_BAD_OPTION_LENGTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EEAu32 as _);
pub const WININET_E_BAD_REGISTRY_PARAMETER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EF6u32 as _);
pub const WININET_E_CANNOT_CONNECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EFDu32 as _);
pub const WININET_E_CHG_POST_IS_NON_SECURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F0Au32 as _);
pub const WININET_E_CLIENT_AUTH_CERT_NEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F0Cu32 as _);
pub const WININET_E_CLIENT_AUTH_NOT_SETUP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F0Eu32 as _);
pub const WININET_E_CONNECTION_ABORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EFEu32 as _);
pub const WININET_E_CONNECTION_RESET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EFFu32 as _);
pub const WININET_E_COOKIE_DECLINED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F82u32 as _);
pub const WININET_E_COOKIE_NEEDS_CONFIRMATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F81u32 as _);
pub const WININET_E_DECODING_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F8Fu32 as _);
pub const WININET_E_DIALOG_PENDING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F11u32 as _);
pub const WININET_E_DISCONNECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F83u32 as _);
pub const WININET_E_DOWNLEVEL_SERVER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F77u32 as _);
pub const WININET_E_EXTENDED_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EE3u32 as _);
pub const WININET_E_FAILED_DUETOSECURITYCHECK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F8Bu32 as _);
pub const WININET_E_FORCE_RETRY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F00u32 as _);
pub const WININET_E_HANDLE_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F04u32 as _);
pub const WININET_E_HEADER_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F7Bu32 as _);
pub const WININET_E_HEADER_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F76u32 as _);
pub const WININET_E_HTTPS_HTTP_SUBMIT_REDIR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F14u32 as _);
pub const WININET_E_HTTPS_TO_HTTP_ON_REDIR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F08u32 as _);
pub const WININET_E_HTTP_TO_HTTPS_ON_REDIR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F07u32 as _);
pub const WININET_E_INCORRECT_FORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EFBu32 as _);
pub const WININET_E_INCORRECT_HANDLE_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EF3u32 as _);
pub const WININET_E_INCORRECT_HANDLE_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EF2u32 as _);
pub const WININET_E_INCORRECT_PASSWORD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EEEu32 as _);
pub const WININET_E_INCORRECT_USER_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EEDu32 as _);
pub const WININET_E_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EE4u32 as _);
pub const WININET_E_INVALID_CA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F0Du32 as _);
pub const WININET_E_INVALID_HEADER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F79u32 as _);
pub const WININET_E_INVALID_OPERATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EF0u32 as _);
pub const WININET_E_INVALID_OPTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EE9u32 as _);
pub const WININET_E_INVALID_PROXY_REQUEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F01u32 as _);
pub const WININET_E_INVALID_QUERY_REQUEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F7Au32 as _);
pub const WININET_E_INVALID_SERVER_RESPONSE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F78u32 as _);
pub const WININET_E_INVALID_URL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EE5u32 as _);
pub const WININET_E_ITEM_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EFCu32 as _);
pub const WININET_E_LOGIN_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EEFu32 as _);
pub const WININET_E_LOGIN_FAILURE_DISPLAY_ENTITY_BODY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F8Eu32 as _);
pub const WININET_E_MIXED_SECURITY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F09u32 as _);
pub const WININET_E_NAME_NOT_RESOLVED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EE7u32 as _);
pub const WININET_E_NEED_UI: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F02u32 as _);
pub const WININET_E_NOT_INITIALIZED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F8Cu32 as _);
pub const WININET_E_NOT_PROXY_REQUEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EF4u32 as _);
pub const WININET_E_NOT_REDIRECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F80u32 as _);
pub const WININET_E_NO_CALLBACK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EF9u32 as _);
pub const WININET_E_NO_CONTEXT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EF8u32 as _);
pub const WININET_E_NO_DIRECT_ACCESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EF7u32 as _);
pub const WININET_E_NO_NEW_CONTAINERS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F13u32 as _);
pub const WININET_E_OPERATION_CANCELLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EF1u32 as _);
pub const WININET_E_OPTION_NOT_SETTABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EEBu32 as _);
pub const WININET_E_OUT_OF_HANDLES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EE1u32 as _);
pub const WININET_E_POST_IS_NON_SECURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F0Bu32 as _);
pub const WININET_E_PROTOCOL_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EE8u32 as _);
pub const WININET_E_PROXY_SERVER_UNREACHABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F85u32 as _);
pub const WININET_E_REDIRECT_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F7Cu32 as _);
pub const WININET_E_REDIRECT_NEEDS_CONFIRMATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F88u32 as _);
pub const WININET_E_REDIRECT_SCHEME_CHANGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F10u32 as _);
pub const WININET_E_REGISTRY_VALUE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EF5u32 as _);
pub const WININET_E_REQUEST_PENDING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EFAu32 as _);
pub const WININET_E_RETRY_DIALOG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F12u32 as _);
pub const WININET_E_SECURITY_CHANNEL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F7Du32 as _);
pub const WININET_E_SEC_CERT_CN_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F06u32 as _);
pub const WININET_E_SEC_CERT_DATE_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F05u32 as _);
pub const WININET_E_SEC_CERT_ERRORS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F17u32 as _);
pub const WININET_E_SEC_CERT_REVOKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F8Au32 as _);
pub const WININET_E_SEC_CERT_REV_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F19u32 as _);
pub const WININET_E_SEC_INVALID_CERT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F89u32 as _);
pub const WININET_E_SERVER_UNREACHABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F84u32 as _);
pub const WININET_E_SHUTDOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EECu32 as _);
pub const WININET_E_TCPIP_NOT_INSTALLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F7Fu32 as _);
pub const WININET_E_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EE2u32 as _);
pub const WININET_E_UNABLE_TO_CACHE_FILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F7Eu32 as _);
pub const WININET_E_UNABLE_TO_DOWNLOAD_SCRIPT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072F87u32 as _);
pub const WININET_E_UNRECOGNIZED_SCHEME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072EE6u32 as _);
pub const WINML_ERR_INVALID_BINDING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88900002u32 as _);
pub const WINML_ERR_INVALID_DEVICE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88900001u32 as _);
pub const WINML_ERR_SIZE_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88900004u32 as _);
pub const WINML_ERR_VALUE_NOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x88900003u32 as _);
pub const WINVER: u32 = 1280u32;
pub const WINVER_MAXVER: u32 = 2560u32;
pub const WPN_E_ACCESS_DENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0117u32 as _);
pub const WPN_E_ALL_URL_NOT_COMPLETED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0203u32 as _);
pub const WPN_E_CALLBACK_ALREADY_REGISTERED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0206u32 as _);
pub const WPN_E_CHANNEL_CLOSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0100u32 as _);
pub const WPN_E_CHANNEL_REQUEST_NOT_COMPLETE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0101u32 as _);
pub const WPN_E_CLOUD_AUTH_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E011Au32 as _);
pub const WPN_E_CLOUD_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0109u32 as _);
pub const WPN_E_CLOUD_DISABLED_FOR_APP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E020Bu32 as _);
pub const WPN_E_CLOUD_INCAPABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0110u32 as _);
pub const WPN_E_CLOUD_SERVICE_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E011Bu32 as _);
pub const WPN_E_DEV_ID_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0120u32 as _);
pub const WPN_E_DUPLICATE_CHANNEL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0104u32 as _);
pub const WPN_E_DUPLICATE_REGISTRATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0118u32 as _);
pub const WPN_E_FAILED_LOCK_SCREEN_UPDATE_INTIALIZATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E011Cu32 as _);
pub const WPN_E_GROUP_ALPHANUMERIC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E020Au32 as _);
pub const WPN_E_GROUP_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0209u32 as _);
pub const WPN_E_IMAGE_NOT_FOUND_IN_CACHE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0202u32 as _);
pub const WPN_E_INTERNET_INCAPABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0113u32 as _);
pub const WPN_E_INVALID_APP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0102u32 as _);
pub const WPN_E_INVALID_CLOUD_IMAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0204u32 as _);
pub const WPN_E_INVALID_HTTP_STATUS_CODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E012Bu32 as _);
pub const WPN_E_NOTIFICATION_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0111u32 as _);
pub const WPN_E_NOTIFICATION_HIDDEN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0107u32 as _);
pub const WPN_E_NOTIFICATION_ID_MATCHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0205u32 as _);
pub const WPN_E_NOTIFICATION_INCAPABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0112u32 as _);
pub const WPN_E_NOTIFICATION_NOT_POSTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0108u32 as _);
pub const WPN_E_NOTIFICATION_POSTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0106u32 as _);
pub const WPN_E_NOTIFICATION_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0115u32 as _);
pub const WPN_E_NOTIFICATION_TYPE_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0114u32 as _);
pub const WPN_E_OUTSTANDING_CHANNEL_REQUEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0103u32 as _);
pub const WPN_E_OUT_OF_SESSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0200u32 as _);
pub const WPN_E_PLATFORM_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0105u32 as _);
pub const WPN_E_POWER_SAVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0201u32 as _);
pub const WPN_E_PUSH_NOTIFICATION_INCAPABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0119u32 as _);
pub const WPN_E_STORAGE_LOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0208u32 as _);
pub const WPN_E_TAG_ALPHANUMERIC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E012Au32 as _);
pub const WPN_E_TAG_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0116u32 as _);
pub const WPN_E_TOAST_NOTIFICATION_DROPPED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803E0207u32 as _);
pub const WS_E_ADDRESS_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D000Bu32 as _);
pub const WS_E_ADDRESS_NOT_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D000Cu32 as _);
pub const WS_E_ENDPOINT_ACCESS_DENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0005u32 as _);
pub const WS_E_ENDPOINT_ACTION_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0011u32 as _);
pub const WS_E_ENDPOINT_DISCONNECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0014u32 as _);
pub const WS_E_ENDPOINT_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D000Fu32 as _);
pub const WS_E_ENDPOINT_FAULT_RECEIVED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0013u32 as _);
pub const WS_E_ENDPOINT_NOT_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D000Eu32 as _);
pub const WS_E_ENDPOINT_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D000Du32 as _);
pub const WS_E_ENDPOINT_TOO_BUSY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0012u32 as _);
pub const WS_E_ENDPOINT_UNREACHABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0010u32 as _);
pub const WS_E_INVALID_ENDPOINT_URL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0020u32 as _);
pub const WS_E_INVALID_FORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0000u32 as _);
pub const WS_E_INVALID_OPERATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0003u32 as _);
pub const WS_E_NOT_SUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0017u32 as _);
pub const WS_E_NO_TRANSLATION_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0009u32 as _);
pub const WS_E_NUMERIC_OVERFLOW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0002u32 as _);
pub const WS_E_OBJECT_FAULTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0001u32 as _);
pub const WS_E_OPERATION_ABANDONED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0007u32 as _);
pub const WS_E_OPERATION_ABORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0004u32 as _);
pub const WS_E_OPERATION_TIMED_OUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0006u32 as _);
pub const WS_E_OTHER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0021u32 as _);
pub const WS_E_PROXY_ACCESS_DENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0016u32 as _);
pub const WS_E_PROXY_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0015u32 as _);
pub const WS_E_PROXY_REQUIRES_BASIC_AUTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0018u32 as _);
pub const WS_E_PROXY_REQUIRES_DIGEST_AUTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0019u32 as _);
pub const WS_E_PROXY_REQUIRES_NEGOTIATE_AUTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D001Bu32 as _);
pub const WS_E_PROXY_REQUIRES_NTLM_AUTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D001Au32 as _);
pub const WS_E_QUOTA_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0008u32 as _);
pub const WS_E_SECURITY_SYSTEM_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0023u32 as _);
pub const WS_E_SECURITY_TOKEN_EXPIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D0022u32 as _);
pub const WS_E_SECURITY_VERIFICATION_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D000Au32 as _);
pub const WS_E_SERVER_REQUIRES_BASIC_AUTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D001Cu32 as _);
pub const WS_E_SERVER_REQUIRES_DIGEST_AUTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D001Du32 as _);
pub const WS_E_SERVER_REQUIRES_NEGOTIATE_AUTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D001Fu32 as _);
pub const WS_E_SERVER_REQUIRES_NTLM_AUTH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x803D001Eu32 as _);
pub const WS_S_ASYNC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x3D0000u32 as _);
pub const WS_S_END: ::windows_core::HRESULT = ::windows_core::HRESULT(0x3D0001u32 as _);
pub const XACT_E_ABORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D019u32 as _);
pub const XACT_E_ABORTING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D029u32 as _);
pub const XACT_E_ALREADYINPROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D018u32 as _);
pub const XACT_E_ALREADYOTHERSINGLEPHASE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D000u32 as _);
pub const XACT_E_CANTRETAIN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D001u32 as _);
pub const XACT_E_CLERKEXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D081u32 as _);
pub const XACT_E_CLERKNOTFOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D080u32 as _);
pub const XACT_E_COMMITFAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D002u32 as _);
pub const XACT_E_COMMITPREVENTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D003u32 as _);
pub const XACT_E_CONNECTION_DENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D01Du32 as _);
pub const XACT_E_CONNECTION_DOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D01Cu32 as _);
pub const XACT_E_DEST_TMNOTAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D022u32 as _);
pub const XACT_E_FIRST: u32 = 2147799040u32;
pub const XACT_E_HEURISTICABORT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D004u32 as _);
pub const XACT_E_HEURISTICCOMMIT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D005u32 as _);
pub const XACT_E_HEURISTICDAMAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D006u32 as _);
pub const XACT_E_HEURISTICDANGER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D007u32 as _);
pub const XACT_E_INDOUBT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D016u32 as _);
pub const XACT_E_INVALIDCOOKIE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D015u32 as _);
pub const XACT_E_INVALIDLSN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D084u32 as _);
pub const XACT_E_ISOLATIONLEVEL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D008u32 as _);
pub const XACT_E_LAST: u32 = 2147799083u32;
pub const XACT_E_LOGFULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D01Au32 as _);
pub const XACT_E_LU_TX_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D02Cu32 as _);
pub const XACT_E_NETWORK_TX_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D024u32 as _);
pub const XACT_E_NOASYNC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D009u32 as _);
pub const XACT_E_NOENLIST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D00Au32 as _);
pub const XACT_E_NOIMPORTOBJECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D014u32 as _);
pub const XACT_E_NOISORETAIN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D00Bu32 as _);
pub const XACT_E_NORESOURCE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D00Cu32 as _);
pub const XACT_E_NOTCURRENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D00Du32 as _);
pub const XACT_E_NOTIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D017u32 as _);
pub const XACT_E_NOTRANSACTION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D00Eu32 as _);
pub const XACT_E_NOTSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D00Fu32 as _);
pub const XACT_E_PARTNER_NETWORK_TX_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D025u32 as _);
pub const XACT_E_PULL_COMM_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D02Bu32 as _);
pub const XACT_E_PUSH_COMM_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D02Au32 as _);
pub const XACT_E_RECOVERYINPROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D082u32 as _);
pub const XACT_E_REENLISTTIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D01Eu32 as _);
pub const XACT_E_REPLAYREQUEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D085u32 as _);
pub const XACT_E_TIP_CONNECT_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D01Fu32 as _);
pub const XACT_E_TIP_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D023u32 as _);
pub const XACT_E_TIP_PROTOCOL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D020u32 as _);
pub const XACT_E_TIP_PULL_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D021u32 as _);
pub const XACT_E_TMNOTAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D01Bu32 as _);
pub const XACT_E_TRANSACTIONCLOSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D083u32 as _);
pub const XACT_E_UNABLE_TO_LOAD_DTC_PROXY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D028u32 as _);
pub const XACT_E_UNABLE_TO_READ_DTC_CONFIG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D027u32 as _);
pub const XACT_E_UNKNOWNRMGRID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D010u32 as _);
pub const XACT_E_WRONGSTATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D011u32 as _);
pub const XACT_E_WRONGUOW: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D012u32 as _);
pub const XACT_E_XA_TX_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D026u32 as _);
pub const XACT_E_XTIONEXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8004D013u32 as _);
pub const XACT_S_ABORTING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4D008u32 as _);
pub const XACT_S_ALLNORETAIN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4D007u32 as _);
pub const XACT_S_ASYNC: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4D000u32 as _);
pub const XACT_S_DEFECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4D001u32 as _);
pub const XACT_S_FIRST: u32 = 315392u32;
pub const XACT_S_LAST: u32 = 315408u32;
pub const XACT_S_LASTRESOURCEMANAGER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4D010u32 as _);
pub const XACT_S_LOCALLY_OK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4D00Au32 as _);
pub const XACT_S_MADECHANGESCONTENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4D005u32 as _);
pub const XACT_S_MADECHANGESINFORM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4D006u32 as _);
pub const XACT_S_OKINFORM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4D004u32 as _);
pub const XACT_S_READONLY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4D002u32 as _);
pub const XACT_S_SINGLEPHASE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4D009u32 as _);
pub const XACT_S_SOMENORETAIN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x4D003u32 as _);
pub const XENROLL_E_CANNOT_ADD_ROOT_CERT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80095001u32 as _);
pub const XENROLL_E_KEYSPEC_SMIME_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80095005u32 as _);
pub const XENROLL_E_KEY_NOT_EXPORTABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80095000u32 as _);
pub const XENROLL_E_RESPONSE_KA_HASH_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80095004u32 as _);
pub const XENROLL_E_RESPONSE_KA_HASH_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80095002u32 as _);
pub const XENROLL_E_RESPONSE_UNEXPECTED_KA_HASH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80095003u32 as _);
