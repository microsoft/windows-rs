...
pub const CONVERT10_E_OLELINK_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(-2147221049i32);
...
pub const TPM_E_TPM_GENERATED_EPS: ::windows_core::HRESULT = ::windows_core::HRESULT(-2144795133i32);
