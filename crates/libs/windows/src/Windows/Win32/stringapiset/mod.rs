...
#[inline]
pub unsafe fn CompareStringEx<P0>(lplocalename: P0, dwcmpflags: u32, lpstring1: *const u16, cchcount1: i32, lpstring2: *const u16, cchcount2: i32, lpversioninformation: Option<*const super::NLSVERSIONINFO>, lpreserved: Option<*const core::ffi::c_void>, lparam: Option<super::LPARAM>) -> i32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("kernel32.dll" "system" fn CompareStringEx(lplocalename : windows_core::PCWSTR, dwcmpflags : u32, lpstring1 : *const u16, cchcount1 : i32, lpstring2 : *const u16, cchcount2 : i32, lpversioninformation : *const super::NLSVERSIONINFO, lpreserved : *const core::ffi::c_void, lparam : super::LPARAM) -> i32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn CompareStringW(locale: super::LCID, dwcmpflags: u32, lpstring1: *const u16, cchcount1: i32, lpstring2: *const u16, cchcount2: i32) -> i32 {
    windows_core::link!("kernel32.dll" "system" fn CompareStringW(locale : super::LCID, dwcmpflags : u32, lpstring1 : *const u16, cchcount1 : i32, lpstring2 : *const u16, cchcount2 : i32) -> i32);
    unsafe { CompareStringW(locale, dwcmpflags, lpstring1, cchcount1, lpstring2, cchcount2) }
}
#[inline]
pub unsafe fn FoldStringW(dwmapflags: u32, lpsrcstr: *const u16, cchsrc: i32, lpdeststr: Option<windows_core::PWSTR>, cchdest: i32) -> i32 {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetStringTypeExW(locale: super::LCID, dwinfotype: u32, lpsrcstr: *const u16, cchsrc: i32, lpchartype: *mut u16) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn GetStringTypeExW(locale : super::LCID, dwinfotype : u32, lpsrcstr : *const u16, cchsrc : i32, lpchartype : *mut u16) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn MultiByteToWideChar(codepage: u32, dwflags: u32, lpmultibytestr: *const i8, cbmultibyte: i32, lpwidecharstr: Option<windows_core::PWSTR>, cchwidechar: i32) -> i32 {
...
#[inline]
pub unsafe fn WideCharToMultiByte(codepage: u32, dwflags: u32, lpwidecharstr: *const u16, cchwidechar: i32, lpmultibytestr: Option<windows_core::PSTR>, cbmultibyte: i32, lpdefaultchar: Option<*const i8>, lpuseddefaultchar: Option<*mut windows_core::BOOL>) -> i32 {
