    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe {
        ...
        MFCreateVirtualCamera(r#type, lifetime, access, friendlyname.param().abi(), sourceid.param().abi(), categories.map_or(core::ptr::null(), |slice| slice.as_ptr()), categories.map_or(0, |slice| slice.len().try_into().unwrap()), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
    }
}
#[inline]
...
#[cfg(feature = "mfobjects")]
windows_core::imp::interface_hierarchy!(IMFVirtualCamera, windows_core::IUnknown, super::IMFAttributes);
#[cfg(feature = "mfobjects")]
impl IMFVirtualCamera {
    ...
    #[cfg(feature = "devpropdef")]
    pub unsafe fn AddProperty(&self, pkey: *const super::DEVPROPKEY, r#type: super::DEVPROPTYPE, pbdata: &[u8]) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).AddProperty)(windows_core::Interface::as_raw(self), pkey, r#type, pbdata.as_ptr(), pbdata.len().try_into().unwrap()) }
    }
    ...
    {
        unsafe { (windows_core::Interface::vtable(self).AddRegistryEntry)(windows_core::Interface::as_raw(self), entryname.param().abi(), subkeypath.param().abi(), dwregtype, pbdata.as_ptr(), pbdata.len().try_into().unwrap()) }
    }
    ...
    #[cfg(feature = "mfidl")]
    pub unsafe fn GetMediaSource(&self) -> windows_core::Result<super::IMFMediaSource> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "winnt")]
    pub unsafe fn CreateSyncEvent(&self, kseventset: *const windows_core::GUID, kseventid: u32, kseventflags: u32, eventhandle: super::HANDLE) -> windows_core::Result<IMFCameraSyncObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSyncEvent)(windows_core::Interface::as_raw(self), kseventset, kseventid, kseventflags, eventhandle, &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    #[cfg(feature = "winnt")]
    pub unsafe fn CreateSyncSemaphore(&self, kseventset: *const windows_core::GUID, kseventid: u32, kseventflags: u32, semaphorehandle: super::HANDLE, semaphoreadjustment: i32) -> windows_core::Result<IMFCameraSyncObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSyncSemaphore)(windows_core::Interface::as_raw(self), kseventset, kseventid, kseventflags, semaphorehandle, semaphoreadjustment, &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
...
pub struct IMFVirtualCamera_Vtbl {
    ...
    #[cfg(feature = "devpropdef")]
    pub AddProperty: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::DEVPROPKEY, super::DEVPROPTYPE, *const u8, u32) -> windows_core::HRESULT,
    #[cfg(not(feature = "devpropdef"))]
    AddProperty: usize,
    ...
    #[cfg(feature = "winnt")]
    pub CreateSyncEvent: unsafe extern "system" fn(*mut core::ffi::c_void, *const windows_core::GUID, u32, u32, super::HANDLE, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "winnt"))]
    CreateSyncEvent: usize,
    #[cfg(feature = "winnt")]
    pub CreateSyncSemaphore: unsafe extern "system" fn(*mut core::ffi::c_void, *const windows_core::GUID, u32, u32, super::HANDLE, i32, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "winnt"))]
    CreateSyncSemaphore: usize,
    pub Shutdown: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
}
#[cfg(all(feature = "devpropdef", feature = "mfidl", feature = "mfobjects", feature = "minwindef", feature = "oaidl", feature = "objidl", feature = "objidlbase", feature = "propidlbase", feature = "winnt", feature = "wtypes", feature = "wtypesbase"))]
pub trait IMFVirtualCamera_Impl: super::IMFAttributes_Impl {
    fn AddDeviceSourceInfo(&self, devicesourceinfo: &windows_core::PCWSTR) -> windows_core::Result<()>;
    fn AddProperty(&self, pkey: *const super::DEVPROPKEY, r#type: super::DEVPROPTYPE, pbdata: *const u8, cbdata: u32) -> windows_core::Result<()>;
    ...
    fn Start(&self, pcallback: windows_core::Ref<super::IMFAsyncCallback>) -> windows_core::Result<()>;
    fn Stop(&self) -> windows_core::Result<()>;
    fn Remove(&self) -> windows_core::Result<()>;
    fn GetMediaSource(&self) -> windows_core::Result<super::IMFMediaSource>;
    ...
    fn CreateSyncEvent(&self, kseventset: *const windows_core::GUID, kseventid: u32, kseventflags: u32, eventhandle: super::HANDLE) -> windows_core::Result<IMFCameraSyncObject>;
    fn CreateSyncSemaphore(&self, kseventset: *const windows_core::GUID, kseventid: u32, kseventflags: u32, semaphorehandle: super::HANDLE, semaphoreadjustment: i32) -> windows_core::Result<IMFCameraSyncObject>;
...
impl IMFVirtualCamera_Vtbl {
    pub const fn new<Identity: IMFVirtualCamera_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn AddProperty<Identity: IMFVirtualCamera_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pkey: *const super::DEVPROPKEY, r#type: super::DEVPROPTYPE, pbdata: *const u8, cbdata: u32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateSyncEvent<Identity: IMFVirtualCamera_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, kseventset: *const windows_core::GUID, kseventid: u32, kseventflags: u32, eventhandle: super::HANDLE, camerasyncobject: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateSyncSemaphore<Identity: IMFVirtualCamera_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, kseventset: *const windows_core::GUID, kseventid: u32, kseventflags: u32, semaphorehandle: super::HANDLE, semaphoreadjustment: i32, camerasyncobject: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IMFVirtualCamera as windows_core::Interface>::IID || iid == &<super::IMFAttributes as windows_core::Interface>::IID
    }
}
#[cfg(all(feature = "devpropdef", feature = "mfidl", feature = "mfobjects", feature = "minwindef", feature = "oaidl", feature = "objidl", feature = "objidlbase", feature = "propidlbase", feature = "winnt", feature = "wtypes", feature = "wtypesbase"))]
