...
impl IFindSimilarResults {
    pub unsafe fn GetSize(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSize)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetNextFileId(&self, numtraitsmatched: *mut u32, similarityfileid: *mut SimilarityFileId) -> windows_result::Result<()> {
...
pub trait IFindSimilarResults_Impl: windows_core::IUnknownImpl {
    fn GetSize(&self) -> windows_result::Result<u32>;
    fn GetNextFileId(&self, numtraitsmatched: *mut u32, similarityfileid: *mut SimilarityFileId) -> windows_result::Result<()>;
}
...
impl IRdcComparator {
    pub unsafe fn Process(&self, endofinput: bool, endofoutput: *mut windows_core::BOOL, inputbuffer: *mut RdcBufferPointer, outputbuffer: *mut RdcNeedPointer, rdc_errorcode: *mut RDC_ErrorCode) -> windows_result::Result<()> {
...
pub trait IRdcComparator_Impl: windows_core::IUnknownImpl {
    fn Process(&self, endofinput: windows_core::BOOL, endofoutput: *mut windows_core::BOOL, inputbuffer: *mut RdcBufferPointer, outputbuffer: *mut RdcNeedPointer, rdc_errorcode: *mut RDC_ErrorCode) -> windows_result::Result<()>;
}
...
impl IRdcFileReader {
    pub unsafe fn GetFileSize(&self) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFileSize)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn Read(&self, offsetfilestart: u64, bytestoread: u32, bytesactuallyread: *mut u32, buffer: *mut u8, eof: *mut windows_core::BOOL) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFilePosition(&self) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRdcFileReader_Impl: windows_core::IUnknownImpl {
    fn GetFileSize(&self) -> windows_result::Result<u64>;
    fn Read(&self, offsetfilestart: u64, bytestoread: u32, bytesactuallyread: *mut u32, buffer: *mut u8, eof: *mut windows_core::BOOL) -> windows_result::Result<()>;
    fn GetFilePosition(&self) -> windows_result::Result<u64>;
}
...
impl IRdcFileWriter {
    pub unsafe fn Write(&self, offsetfilestart: u64, bytestowrite: u32) -> windows_result::Result<u8> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Truncate(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Truncate)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn DeleteOnClose(&self) -> windows_result::Result<()> {
...
pub trait IRdcFileWriter_Impl: IRdcFileReader_Impl {
    fn Write(&self, offsetfilestart: u64, bytestowrite: u32) -> windows_result::Result<u8>;
    fn Truncate(&self) -> windows_result::Result<()>;
    fn DeleteOnClose(&self) -> windows_result::Result<()>;
}
...
impl IRdcGenerator {
    pub unsafe fn GetGeneratorParameters(&self, level: u32) -> windows_result::Result<IRdcGeneratorParameters> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Process(&self, endofinput: bool, endofoutput: *mut windows_core::BOOL, inputbuffer: *mut RdcBufferPointer, outputbuffers: &mut [*mut RdcBufferPointer], rdc_errorcode: *mut RDC_ErrorCode) -> windows_result::Result<()> {
...
pub trait IRdcGenerator_Impl: windows_core::IUnknownImpl {
    fn GetGeneratorParameters(&self, level: u32) -> windows_result::Result<IRdcGeneratorParameters>;
    fn Process(&self, endofinput: windows_core::BOOL, endofoutput: *mut windows_core::BOOL, inputbuffer: *mut RdcBufferPointer, depth: u32, outputbuffers: *mut *mut RdcBufferPointer, rdc_errorcode: *mut RDC_ErrorCode) -> windows_result::Result<()>;
}
...
pub trait IRdcGeneratorFilterMaxParameters_Impl: windows_core::IUnknownImpl {
    fn GetHorizonSize(&self) -> windows_result::Result<u32>;
    fn SetHorizonSize(&self, horizonsize: u32) -> windows_result::Result<()>;
    fn GetHashWindowSize(&self) -> windows_result::Result<u32>;
    fn SetHashWindowSize(&self, hashwindowsize: u32) -> windows_result::Result<()>;
}
...
impl IRdcGeneratorParameters {
    pub unsafe fn GetGeneratorParametersType(&self) -> windows_result::Result<GeneratorParametersType> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetParametersVersion(&self, currentversion: *mut u32, minimumcompatibleappversion: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetSerializeSize(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSerializeSize)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn Serialize(&self, size: u32, parametersblob: *mut u8, byteswritten: *mut u32) -> windows_result::Result<()> {
...
pub trait IRdcGeneratorParameters_Impl: windows_core::IUnknownImpl {
    fn GetGeneratorParametersType(&self) -> windows_result::Result<GeneratorParametersType>;
    fn GetParametersVersion(&self, currentversion: *mut u32, minimumcompatibleappversion: *mut u32) -> windows_result::Result<()>;
    fn GetSerializeSize(&self) -> windows_result::Result<u32>;
    fn Serialize(&self, size: u32, parametersblob: *mut u8, byteswritten: *mut u32) -> windows_result::Result<()>;
}
...
impl IRdcLibrary {
    pub unsafe fn ComputeDefaultRecursionDepth(&self, filesize: u64) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateGeneratorParameters(&self, parameterstype: GeneratorParametersType, level: u32) -> windows_result::Result<IRdcGeneratorParameters> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn OpenGeneratorParameters(&self, size: u32, parametersblob: *const u8) -> windows_result::Result<IRdcGeneratorParameters> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateGenerator(&self, igeneratorparametersarray: &[Option<IRdcGeneratorParameters>]) -> windows_result::Result<IRdcGenerator> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateComparator<P0>(&self, iseedsignaturesfile: P0, comparatorbuffersize: u32) -> windows_result::Result<IRdcComparator>
    where
    ...
    pub unsafe fn CreateSignatureReader<P0>(&self, ifilereader: P0) -> windows_result::Result<IRdcSignatureReader>
    where
        P0: windows_core::Param<IRdcFileReader>,
    {
        unsafe {
    ...
    pub unsafe fn GetRDCVersion(&self, currentversion: *mut u32, minimumcompatibleappversion: *mut u32) -> windows_result::Result<()> {
...
pub trait IRdcLibrary_Impl: windows_core::IUnknownImpl {
    fn ComputeDefaultRecursionDepth(&self, filesize: u64) -> windows_result::Result<u32>;
    fn CreateGeneratorParameters(&self, parameterstype: GeneratorParametersType, level: u32) -> windows_result::Result<IRdcGeneratorParameters>;
    fn OpenGeneratorParameters(&self, size: u32, parametersblob: *const u8) -> windows_result::Result<IRdcGeneratorParameters>;
    fn CreateGenerator(&self, depth: u32, igeneratorparametersarray: *const Option<IRdcGeneratorParameters>) -> windows_result::Result<IRdcGenerator>;
    fn CreateComparator(&self, iseedsignaturesfile: windows_core::Ref<IRdcFileReader>, comparatorbuffersize: u32) -> windows_result::Result<IRdcComparator>;
    fn CreateSignatureReader(&self, ifilereader: windows_core::Ref<IRdcFileReader>) -> windows_result::Result<IRdcSignatureReader>;
    fn GetRDCVersion(&self, currentversion: *mut u32, minimumcompatibleappversion: *mut u32) -> windows_result::Result<()>;
}
...
impl IRdcSignatureReader {
    pub unsafe fn ReadHeader(&self) -> windows_result::Result<RDC_ErrorCode> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ReadHeader)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn ReadSignatures(&self, rdcsignaturepointer: *mut RdcSignaturePointer, endofoutput: *mut windows_core::BOOL) -> windows_result::Result<()> {
...
pub trait IRdcSignatureReader_Impl: windows_core::IUnknownImpl {
    fn ReadHeader(&self) -> windows_result::Result<RDC_ErrorCode>;
    fn ReadSignatures(&self, rdcsignaturepointer: *mut RdcSignaturePointer, endofoutput: *mut windows_core::BOOL) -> windows_result::Result<()>;
}
...
impl IRdcSimilarityGenerator {
    pub unsafe fn EnableSimilarity(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).EnableSimilarity)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Results(&self) -> windows_result::Result<SimilarityData> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRdcSimilarityGenerator_Impl: windows_core::IUnknownImpl {
    fn EnableSimilarity(&self) -> windows_result::Result<()>;
    fn Results(&self) -> windows_result::Result<SimilarityData>;
}
...
impl ISimilarity {
    pub unsafe fn CreateTable<P0>(&self, path: P0, truncate: bool, securitydescriptor: *const u8, recordsize: u32) -> windows_result::Result<RdcCreatedTables>
    where
    ...
    pub unsafe fn CreateTableIndirect<P0, P1>(&self, mapping: P0, fileidfile: P1, truncate: bool, recordsize: u32) -> windows_result::Result<RdcCreatedTables>
    where
    ...
    pub unsafe fn CloseTable(&self, isvalid: bool) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).CloseTable)(windows_core::Interface::as_raw(self), isvalid.into()).ok() }
    }
    pub unsafe fn Append(&self, similarityfileid: *const SimilarityFileId, similaritydata: *const SimilarityData) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Append)(windows_core::Interface::as_raw(self), similarityfileid, similaritydata).ok() }
    }
    pub unsafe fn FindSimilarFileId(&self, similaritydata: *const SimilarityData, numberofmatchesrequired: u16, resultssize: u32) -> windows_result::Result<IFindSimilarResults> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CopyAndSwap<P0, P1>(&self, newsimilaritytables: P0, reportprogress: P1) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetRecordCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISimilarity_Impl: windows_core::IUnknownImpl {
    fn CreateTable(&self, path: &windows_core::PCWSTR, truncate: windows_core::BOOL, securitydescriptor: *const u8, recordsize: u32) -> windows_result::Result<RdcCreatedTables>;
    fn CreateTableIndirect(&self, mapping: windows_core::Ref<ISimilarityTraitsMapping>, fileidfile: windows_core::Ref<IRdcFileWriter>, truncate: windows_core::BOOL, recordsize: u32) -> windows_result::Result<RdcCreatedTables>;
    fn CloseTable(&self, isvalid: windows_core::BOOL) -> windows_result::Result<()>;
    fn Append(&self, similarityfileid: *const SimilarityFileId, similaritydata: *const SimilarityData) -> windows_result::Result<()>;
    fn FindSimilarFileId(&self, similaritydata: *const SimilarityData, numberofmatchesrequired: u16, resultssize: u32) -> windows_result::Result<IFindSimilarResults>;
    fn CopyAndSwap(&self, newsimilaritytables: windows_core::Ref<ISimilarity>, reportprogress: windows_core::Ref<ISimilarityReportProgress>) -> windows_result::Result<()>;
    fn GetRecordCount(&self) -> windows_result::Result<u32>;
}
...
impl ISimilarityFileIdTable {
    ...
    pub unsafe fn CreateTableIndirect<P0>(&self, fileidfile: P0, truncate: bool, recordsize: u32) -> windows_result::Result<RdcCreatedTables>
    where
    ...
    pub unsafe fn Append(&self, similarityfileid: *const SimilarityFileId) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Append)(windows_core::Interface::as_raw(self), similarityfileid, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn Lookup(&self, similarityfileindex: u32, similarityfileid: *mut SimilarityFileId) -> windows_result::Result<()> {
    ...
    pub unsafe fn Invalidate(&self, similarityfileindex: u32) -> windows_result::Result<()> {
...
pub trait ISimilarityFileIdTable_Impl: windows_core::IUnknownImpl {
    fn CreateTable(&self, path: &windows_core::PCWSTR, truncate: windows_core::BOOL, securitydescriptor: *const u8, recordsize: u32) -> windows_result::Result<RdcCreatedTables>;
    fn CreateTableIndirect(&self, fileidfile: windows_core::Ref<IRdcFileWriter>, truncate: windows_core::BOOL, recordsize: u32) -> windows_result::Result<RdcCreatedTables>;
    fn CloseTable(&self, isvalid: windows_core::BOOL) -> windows_result::Result<()>;
    fn Append(&self, similarityfileid: *const SimilarityFileId) -> windows_result::Result<u32>;
    fn Lookup(&self, similarityfileindex: u32, similarityfileid: *mut SimilarityFileId) -> windows_result::Result<()>;
    fn Invalidate(&self, similarityfileindex: u32) -> windows_result::Result<()>;
    fn GetRecordCount(&self) -> windows_result::Result<u32>;
}
...
impl ISimilarityReportProgress {
    pub unsafe fn ReportProgress(&self, percentcompleted: u32) -> windows_result::Result<()> {
...
pub trait ISimilarityReportProgress_Impl: windows_core::IUnknownImpl {
    fn ReportProgress(&self, percentcompleted: u32) -> windows_result::Result<()>;
}
...
impl ISimilarityTableDumpState {
    pub unsafe fn GetNextData(&self, resultssize: u32, resultsused: *mut u32, eof: *mut windows_core::BOOL, results: *mut SimilarityDumpData) -> windows_result::Result<()> {
...
pub trait ISimilarityTableDumpState_Impl: windows_core::IUnknownImpl {
    fn GetNextData(&self, resultssize: u32, resultsused: *mut u32, eof: *mut windows_core::BOOL, results: *mut SimilarityDumpData) -> windows_result::Result<()>;
}
...
impl ISimilarityTraitsMappedView {
    pub unsafe fn Flush(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Flush)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Unmap(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Unmap)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Get(&self, index: u64, dirty: bool, numelements: u32) -> windows_result::Result<SimilarityMappedViewInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISimilarityTraitsMappedView_Impl: windows_core::IUnknownImpl {
    fn Flush(&self) -> windows_result::Result<()>;
    fn Unmap(&self) -> windows_result::Result<()>;
    fn Get(&self, index: u64, dirty: windows_core::BOOL, numelements: u32) -> windows_result::Result<SimilarityMappedViewInfo>;
...
impl ISimilarityTraitsMapping {
    ...
    pub unsafe fn SetFileSize(&self, filesize: u64) -> windows_result::Result<()> {
    ...
    pub unsafe fn OpenMapping(&self, accessmode: RdcMappingAccessMode, begin: u64, end: u64) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ResizeMapping(&self, accessmode: RdcMappingAccessMode, begin: u64, end: u64) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateView(&self, minimummappedpages: u32, accessmode: RdcMappingAccessMode) -> windows_result::Result<ISimilarityTraitsMappedView> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISimilarityTraitsMapping_Impl: windows_core::IUnknownImpl {
    ...
    fn SetFileSize(&self, filesize: u64) -> windows_result::Result<()>;
    fn GetFileSize(&self) -> windows_result::Result<u64>;
    fn OpenMapping(&self, accessmode: RdcMappingAccessMode, begin: u64, end: u64) -> windows_result::Result<u64>;
    fn ResizeMapping(&self, accessmode: RdcMappingAccessMode, begin: u64, end: u64) -> windows_result::Result<u64>;
    fn GetPageSize(&self, pagesize: *mut u32);
    fn CreateView(&self, minimummappedpages: u32, accessmode: RdcMappingAccessMode) -> windows_result::Result<ISimilarityTraitsMappedView>;
}
...
impl ISimilarityTraitsTable {
    pub unsafe fn CreateTable<P0>(&self, path: P0, truncate: bool, securitydescriptor: *const u8) -> windows_result::Result<RdcCreatedTables>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn CreateTableIndirect<P0>(&self, mapping: P0, truncate: bool) -> windows_result::Result<RdcCreatedTables>
    where
        P0: windows_core::Param<ISimilarityTraitsMapping>,
    {
        unsafe {
    ...
    pub unsafe fn Append(&self, data: *const SimilarityData, fileindex: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Append)(windows_core::Interface::as_raw(self), data, fileindex).ok() }
    }
    pub unsafe fn FindSimilarFileIndex(&self, similaritydata: *const SimilarityData, numberofmatchesrequired: u16, findsimilarfileindexresults: *mut FindSimilarFileIndexResults, resultssize: u32, resultsused: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn BeginDump(&self) -> windows_result::Result<ISimilarityTableDumpState> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetLastIndex(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISimilarityTraitsTable_Impl: windows_core::IUnknownImpl {
    fn CreateTable(&self, path: &windows_core::PCWSTR, truncate: windows_core::BOOL, securitydescriptor: *const u8) -> windows_result::Result<RdcCreatedTables>;
    fn CreateTableIndirect(&self, mapping: windows_core::Ref<ISimilarityTraitsMapping>, truncate: windows_core::BOOL) -> windows_result::Result<RdcCreatedTables>;
    fn CloseTable(&self, isvalid: windows_core::BOOL) -> windows_result::Result<()>;
    fn Append(&self, data: *const SimilarityData, fileindex: u32) -> windows_result::Result<()>;
    fn FindSimilarFileIndex(&self, similaritydata: *const SimilarityData, numberofmatchesrequired: u16, findsimilarfileindexresults: *mut FindSimilarFileIndexResults, resultssize: u32, resultsused: *mut u32) -> windows_result::Result<()>;
    fn BeginDump(&self) -> windows_result::Result<ISimilarityTableDumpState>;
    fn GetLastIndex(&self) -> windows_result::Result<u32>;
}
