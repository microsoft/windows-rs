#[inline]
pub unsafe fn AppCacheCheckManifest(pwszmasterurl: Option<windows_core::PCWSTR>, pwszmanifesturl: windows_core::PCWSTR, pbmanifestdata: &[u8], pbmanifestresponseheaders: &[u8], pestate: *mut APP_CACHE_STATE, phnewappcache: *mut *mut core::ffi::c_void) -> u32 {
    ...
    unsafe { AppCacheCheckManifest(pwszmasterurl.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pwszmanifesturl), core::mem::transmute(pbmanifestdata.as_ptr()), pbmanifestdata.len().try_into().unwrap(), core::mem::transmute(pbmanifestresponseheaders.as_ptr()), pbmanifestresponseheaders.len().try_into().unwrap(), pestate as _, phnewappcache as _) }
}
#[inline]
...
#[inline]
pub unsafe fn AppCacheCreateAndCommitFile(happcache: *const core::ffi::c_void, pwszsourcefilepath: windows_core::PCWSTR, pwszurl: windows_core::PCWSTR, pbresponseheaders: &[u8]) -> u32 {
    ...
    unsafe { AppCacheCreateAndCommitFile(happcache, core::mem::transmute(pwszsourcefilepath), core::mem::transmute(pwszurl), core::mem::transmute(pbresponseheaders.as_ptr()), pbresponseheaders.len().try_into().unwrap()) }
}
#[inline]
pub unsafe fn AppCacheDeleteGroup(pwszmanifesturl: windows_core::PCWSTR) -> u32 {
    windows_core::link!("wininet.dll" "system" fn AppCacheDeleteGroup(pwszmanifesturl : windows_core::PCWSTR) -> u32);
    unsafe { AppCacheDeleteGroup(core::mem::transmute(pwszmanifesturl)) }
}
#[inline]
pub unsafe fn AppCacheDeleteIEGroup(pwszmanifesturl: windows_core::PCWSTR) -> u32 {
    windows_core::link!("wininet.dll" "system" fn AppCacheDeleteIEGroup(pwszmanifesturl : windows_core::PCWSTR) -> u32);
    unsafe { AppCacheDeleteIEGroup(core::mem::transmute(pwszmanifesturl)) }
}
#[inline]
...
#[inline]
pub unsafe fn AppCacheGetFallbackUrl(happcache: *const core::ffi::c_void, pwszurl: windows_core::PCWSTR, ppwszfallbackurl: *mut windows_core::PWSTR) -> u32 {
    ...
    unsafe { AppCacheGetFallbackUrl(happcache, core::mem::transmute(pwszurl), ppwszfallbackurl as _) }
}
#[inline]
...
#[inline]
pub unsafe fn AppCacheLookup(pwszurl: windows_core::PCWSTR, dwflags: u32, phappcache: *mut *mut core::ffi::c_void) -> u32 {
    ...
    unsafe { AppCacheLookup(core::mem::transmute(pwszurl), dwflags, phappcache as _) }
}
#[inline]
pub unsafe fn CommitUrlCacheEntryA(lpszurlname: windows_core::PCSTR, lpszlocalfilename: Option<windows_core::PCSTR>, expiretime: super::super::Foundation::FILETIME, lastmodifiedtime: super::super::Foundation::FILETIME, cacheentrytype: u32, lpheaderinfo: Option<&[u8]>, lpszfileextension: Option<windows_core::PCSTR>, lpszoriginalurl: Option<windows_core::PCSTR>) -> windows_core::Result<()> {
    ...
    unsafe { CommitUrlCacheEntryA(core::mem::transmute(lpszurlname), lpszlocalfilename.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(expiretime), core::mem::transmute(lastmodifiedtime), cacheentrytype, core::mem::transmute(lpheaderinfo.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), lpheaderinfo.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), lpszfileextension.unwrap_or(core::mem::zeroed()) as _, lpszoriginalurl.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn CommitUrlCacheEntryBinaryBlob(pwszurlname: windows_core::PCWSTR, dwtype: u32, ftexpiretime: super::super::Foundation::FILETIME, ftmodifiedtime: super::super::Foundation::FILETIME, pbblob: Option<&[u8]>) -> u32 {
    ...
    unsafe { CommitUrlCacheEntryBinaryBlob(core::mem::transmute(pwszurlname), dwtype, core::mem::transmute(ftexpiretime), core::mem::transmute(ftmodifiedtime), core::mem::transmute(pbblob.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pbblob.as_deref().map_or(0, |slice| slice.len().try_into().unwrap())) }
}
#[inline]
pub unsafe fn CommitUrlCacheEntryW(lpszurlname: windows_core::PCWSTR, lpszlocalfilename: Option<windows_core::PCWSTR>, expiretime: super::super::Foundation::FILETIME, lastmodifiedtime: super::super::Foundation::FILETIME, cacheentrytype: u32, lpszheaderinfo: Option<&[u16]>, lpszfileextension: Option<windows_core::PCWSTR>, lpszoriginalurl: Option<windows_core::PCWSTR>) -> windows_core::Result<()> {
    ...
    unsafe { CommitUrlCacheEntryW(core::mem::transmute(lpszurlname), lpszlocalfilename.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(expiretime), core::mem::transmute(lastmodifiedtime), cacheentrytype, core::mem::transmute(lpszheaderinfo.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), lpszheaderinfo.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), lpszfileextension.unwrap_or(core::mem::zeroed()) as _, lpszoriginalurl.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn CreateMD5SSOHash(pszchallengeinfo: windows_core::PCWSTR, pwszrealm: windows_core::PCWSTR, pwsztarget: windows_core::PCWSTR, pbhexhash: *mut u8) -> windows_core::BOOL {
    ...
    unsafe { CreateMD5SSOHash(core::mem::transmute(pszchallengeinfo), core::mem::transmute(pwszrealm), core::mem::transmute(pwsztarget), pbhexhash as _) }
}
#[inline]
pub unsafe fn CreateUrlCacheContainerA(name: windows_core::PCSTR, lpcacheprefix: windows_core::PCSTR, lpszcachepath: Option<windows_core::PCSTR>, kbcachelimit: u32, dwcontainertype: u32, dwoptions: u32, pvbuffer: Option<*const core::ffi::c_void>, cbbuffer: Option<*const u32>) -> windows_core::Result<()> {
    ...
    unsafe { CreateUrlCacheContainerA(core::mem::transmute(name), core::mem::transmute(lpcacheprefix), lpszcachepath.unwrap_or(core::mem::zeroed()) as _, kbcachelimit, dwcontainertype, dwoptions, pvbuffer.unwrap_or(core::mem::zeroed()) as _, cbbuffer.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn CreateUrlCacheContainerW(name: windows_core::PCWSTR, lpcacheprefix: windows_core::PCWSTR, lpszcachepath: Option<windows_core::PCWSTR>, kbcachelimit: u32, dwcontainertype: u32, dwoptions: u32, pvbuffer: Option<*const core::ffi::c_void>, cbbuffer: Option<*const u32>) -> windows_core::Result<()> {
    ...
    unsafe { CreateUrlCacheContainerW(core::mem::transmute(name), core::mem::transmute(lpcacheprefix), lpszcachepath.unwrap_or(core::mem::zeroed()) as _, kbcachelimit, dwcontainertype, dwoptions, pvbuffer.unwrap_or(core::mem::zeroed()) as _, cbbuffer.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn CreateUrlCacheEntryA(lpszurlname: windows_core::PCSTR, dwexpectedfilesize: u32, lpszfileextension: Option<windows_core::PCSTR>, lpszfilename: &mut [u8; 260], dwreserved: u32) -> windows_core::Result<()> {
    ...
    unsafe { CreateUrlCacheEntryA(core::mem::transmute(lpszurlname), dwexpectedfilesize, lpszfileextension.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(lpszfilename.as_ptr()), dwreserved).ok() }
}
#[inline]
pub unsafe fn CreateUrlCacheEntryExW(lpszurlname: windows_core::PCWSTR, dwexpectedfilesize: u32, lpszfileextension: Option<windows_core::PCWSTR>, lpszfilename: &mut [u16; 260], dwreserved: u32, fpreserveincomingfilename: bool) -> windows_core::BOOL {
    ...
    unsafe { CreateUrlCacheEntryExW(core::mem::transmute(lpszurlname), dwexpectedfilesize, lpszfileextension.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(lpszfilename.as_ptr()), dwreserved, fpreserveincomingfilename.into()) }
}
#[inline]
pub unsafe fn CreateUrlCacheEntryW(lpszurlname: windows_core::PCWSTR, dwexpectedfilesize: u32, lpszfileextension: Option<windows_core::PCWSTR>, lpszfilename: &mut [u16; 260], dwreserved: u32) -> windows_core::Result<()> {
    ...
    unsafe { CreateUrlCacheEntryW(core::mem::transmute(lpszurlname), dwexpectedfilesize, lpszfileextension.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(lpszfilename.as_ptr()), dwreserved).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn DeleteIE3Cache(hwnd: super::super::Foundation::HWND, hinst: super::super::Foundation::HINSTANCE, lpszcmd: windows_core::PCSTR, ncmdshow: i32) -> u32 {
    ...
    unsafe { DeleteIE3Cache(hwnd, hinst, core::mem::transmute(lpszcmd), ncmdshow) }
}
#[inline]
pub unsafe fn DeleteUrlCacheContainerA(name: windows_core::PCSTR, dwoptions: u32) -> windows_core::Result<()> {
    windows_core::link!("wininet.dll" "system" fn DeleteUrlCacheContainerA(name : windows_core::PCSTR, dwoptions : u32) -> windows_core::BOOL);
    unsafe { DeleteUrlCacheContainerA(core::mem::transmute(name), dwoptions).ok() }
}
#[inline]
pub unsafe fn DeleteUrlCacheContainerW(name: windows_core::PCWSTR, dwoptions: u32) -> windows_core::Result<()> {
    ...
    unsafe { DeleteUrlCacheContainerW(core::mem::transmute(name), dwoptions).ok() }
}
#[inline]
pub unsafe fn DeleteUrlCacheEntry(lpszurlname: windows_core::PCSTR) -> windows_core::Result<()> {
    windows_core::link!("wininet.dll" "system" fn DeleteUrlCacheEntry(lpszurlname : windows_core::PCSTR) -> windows_core::BOOL);
    unsafe { DeleteUrlCacheEntry(core::mem::transmute(lpszurlname)).ok() }
}
#[inline]
pub unsafe fn DeleteUrlCacheEntryA(lpszurlname: windows_core::PCSTR) -> windows_core::Result<()> {
    windows_core::link!("wininet.dll" "system" fn DeleteUrlCacheEntryA(lpszurlname : windows_core::PCSTR) -> windows_core::BOOL);
    unsafe { DeleteUrlCacheEntryA(core::mem::transmute(lpszurlname)).ok() }
}
#[inline]
pub unsafe fn DeleteUrlCacheEntryW(lpszurlname: windows_core::PCWSTR) -> windows_core::Result<()> {
    windows_core::link!("wininet.dll" "system" fn DeleteUrlCacheEntryW(lpszurlname : windows_core::PCWSTR) -> windows_core::BOOL);
    unsafe { DeleteUrlCacheEntryW(core::mem::transmute(lpszurlname)).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn ExportCookieFileA(szfilename: windows_core::PCSTR, fappend: bool) -> windows_core::BOOL {
    ...
    unsafe { ExportCookieFileA(core::mem::transmute(szfilename), fappend.into()) }
}
#[inline]
pub unsafe fn ExportCookieFileW(szfilename: windows_core::PCWSTR, fappend: bool) -> windows_core::BOOL {
    ...
    unsafe { ExportCookieFileW(core::mem::transmute(szfilename), fappend.into()) }
}
#[inline]
...
#[inline]
pub unsafe fn FindFirstUrlCacheEntryA(lpszurlsearchpattern: Option<windows_core::PCSTR>, lpfirstcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOA>, lpcbcacheentryinfo: *mut u32) -> windows_core::Result<super::super::Foundation::HANDLE> {
    ...
    let result__ = unsafe { FindFirstUrlCacheEntryA(lpszurlsearchpattern.unwrap_or(core::mem::zeroed()) as _, lpfirstcacheentryinfo.unwrap_or(core::mem::zeroed()) as _, lpcbcacheentryinfo as _) };
    (!result__.is_invalid()).then_some(result__).ok_or_else(windows_core::Error::from_thread)
}
#[inline]
pub unsafe fn FindFirstUrlCacheEntryExA(lpszurlsearchpattern: Option<windows_core::PCSTR>, dwflags: u32, dwfilter: u32, groupid: i64, lpfirstcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOA>, lpcbcacheentryinfo: *mut u32, lpgroupattributes: Option<*const core::ffi::c_void>, lpcbgroupattributes: Option<*const u32>, lpreserved: Option<*const core::ffi::c_void>) -> windows_core::Result<super::super::Foundation::HANDLE> {
    ...
    let result__ = unsafe { FindFirstUrlCacheEntryExA(lpszurlsearchpattern.unwrap_or(core::mem::zeroed()) as _, dwflags, dwfilter, groupid, lpfirstcacheentryinfo.unwrap_or(core::mem::zeroed()) as _, lpcbcacheentryinfo as _, lpgroupattributes.unwrap_or(core::mem::zeroed()) as _, lpcbgroupattributes.unwrap_or(core::mem::zeroed()) as _, lpreserved.unwrap_or(core::mem::zeroed()) as _) };
    (!result__.is_invalid()).then_some(result__).ok_or_else(windows_core::Error::from_thread)
}
#[inline]
pub unsafe fn FindFirstUrlCacheEntryExW(lpszurlsearchpattern: Option<windows_core::PCWSTR>, dwflags: u32, dwfilter: u32, groupid: i64, lpfirstcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOW>, lpcbcacheentryinfo: *mut u32, lpgroupattributes: Option<*const core::ffi::c_void>, lpcbgroupattributes: Option<*const u32>, lpreserved: Option<*const core::ffi::c_void>) -> windows_core::Result<super::super::Foundation::HANDLE> {
    ...
    let result__ = unsafe { FindFirstUrlCacheEntryExW(lpszurlsearchpattern.unwrap_or(core::mem::zeroed()) as _, dwflags, dwfilter, groupid, lpfirstcacheentryinfo.unwrap_or(core::mem::zeroed()) as _, lpcbcacheentryinfo as _, lpgroupattributes.unwrap_or(core::mem::zeroed()) as _, lpcbgroupattributes.unwrap_or(core::mem::zeroed()) as _, lpreserved.unwrap_or(core::mem::zeroed()) as _) };
    (!result__.is_invalid()).then_some(result__).ok_or_else(windows_core::Error::from_thread)
}
#[inline]
pub unsafe fn FindFirstUrlCacheEntryW(lpszurlsearchpattern: Option<windows_core::PCWSTR>, lpfirstcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOW>, lpcbcacheentryinfo: *mut u32) -> windows_core::Result<super::super::Foundation::HANDLE> {
    ...
    let result__ = unsafe { FindFirstUrlCacheEntryW(lpszurlsearchpattern.unwrap_or(core::mem::zeroed()) as _, lpfirstcacheentryinfo.unwrap_or(core::mem::zeroed()) as _, lpcbcacheentryinfo as _) };
    (!result__.is_invalid()).then_some(result__).ok_or_else(windows_core::Error::from_thread)
}
#[inline]
...
#[inline]
pub unsafe fn FindP3PPolicySymbol(pszsymbol: windows_core::PCSTR) -> i32 {
    windows_core::link!("wininet.dll" "system" fn FindP3PPolicySymbol(pszsymbol : windows_core::PCSTR) -> i32);
    unsafe { FindP3PPolicySymbol(core::mem::transmute(pszsymbol)) }
}
#[inline]
pub unsafe fn FreeUrlCacheSpaceA(lpszcachepath: Option<windows_core::PCSTR>, dwsize: u32, dwfilter: u32) -> windows_core::Result<()> {
    ...
    unsafe { FreeUrlCacheSpaceA(lpszcachepath.unwrap_or(core::mem::zeroed()) as _, dwsize, dwfilter).ok() }
}
#[inline]
pub unsafe fn FreeUrlCacheSpaceW(lpszcachepath: Option<windows_core::PCWSTR>, dwsize: u32, dwfilter: u32) -> windows_core::Result<()> {
    ...
    unsafe { FreeUrlCacheSpaceW(lpszcachepath.unwrap_or(core::mem::zeroed()) as _, dwsize, dwfilter).ok() }
}
#[inline]
pub unsafe fn FtpCommandA(hconnect: *const core::ffi::c_void, fexpectresponse: bool, dwflags: FTP_FLAGS, lpszcommand: windows_core::PCSTR, dwcontext: Option<usize>, phftpcommand: Option<*mut *mut core::ffi::c_void>) -> windows_core::Result<()> {
    ...
    unsafe { FtpCommandA(hconnect, fexpectresponse.into(), dwflags, core::mem::transmute(lpszcommand), dwcontext.unwrap_or(core::mem::zeroed()) as _, phftpcommand.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn FtpCommandW(hconnect: *const core::ffi::c_void, fexpectresponse: bool, dwflags: FTP_FLAGS, lpszcommand: windows_core::PCWSTR, dwcontext: Option<usize>, phftpcommand: Option<*mut *mut core::ffi::c_void>) -> windows_core::Result<()> {
    ...
    unsafe { FtpCommandW(hconnect, fexpectresponse.into(), dwflags, core::mem::transmute(lpszcommand), dwcontext.unwrap_or(core::mem::zeroed()) as _, phftpcommand.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn FtpCreateDirectoryA(hconnect: *const core::ffi::c_void, lpszdirectory: windows_core::PCSTR) -> windows_core::Result<()> {
    ...
    unsafe { FtpCreateDirectoryA(hconnect, core::mem::transmute(lpszdirectory)).ok() }
}
#[inline]
pub unsafe fn FtpCreateDirectoryW(hconnect: *const core::ffi::c_void, lpszdirectory: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { FtpCreateDirectoryW(hconnect, core::mem::transmute(lpszdirectory)).ok() }
}
#[inline]
pub unsafe fn FtpDeleteFileA(hconnect: *const core::ffi::c_void, lpszfilename: windows_core::PCSTR) -> windows_core::Result<()> {
    ...
    unsafe { FtpDeleteFileA(hconnect, core::mem::transmute(lpszfilename)).ok() }
}
#[inline]
pub unsafe fn FtpDeleteFileW(hconnect: *const core::ffi::c_void, lpszfilename: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { FtpDeleteFileW(hconnect, core::mem::transmute(lpszfilename)).ok() }
}
#[cfg(feature = "Win32_Storage_FileSystem")]
#[inline]
pub unsafe fn FtpFindFirstFileA(hconnect: *const core::ffi::c_void, lpszsearchfile: Option<windows_core::PCSTR>, lpfindfiledata: Option<*mut super::super::Storage::FileSystem::WIN32_FIND_DATAA>, dwflags: u32, dwcontext: Option<usize>) -> *mut core::ffi::c_void {
    ...
    unsafe { FtpFindFirstFileA(hconnect, lpszsearchfile.unwrap_or(core::mem::zeroed()) as _, lpfindfiledata.unwrap_or(core::mem::zeroed()) as _, dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "Win32_Storage_FileSystem")]
#[inline]
pub unsafe fn FtpFindFirstFileW(hconnect: *const core::ffi::c_void, lpszsearchfile: Option<windows_core::PCWSTR>, lpfindfiledata: Option<*mut super::super::Storage::FileSystem::WIN32_FIND_DATAW>, dwflags: u32, dwcontext: Option<usize>) -> *mut core::ffi::c_void {
    ...
    unsafe { FtpFindFirstFileW(hconnect, lpszsearchfile.unwrap_or(core::mem::zeroed()) as _, lpfindfiledata.unwrap_or(core::mem::zeroed()) as _, dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn FtpGetFileA(hconnect: *const core::ffi::c_void, lpszremotefile: windows_core::PCSTR, lpsznewfile: windows_core::PCSTR, ffailifexists: bool, dwflagsandattributes: u32, dwflags: u32, dwcontext: Option<usize>) -> windows_core::Result<()> {
    ...
    unsafe { FtpGetFileA(hconnect, core::mem::transmute(lpszremotefile), core::mem::transmute(lpsznewfile), ffailifexists.into(), dwflagsandattributes, dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn FtpGetFileEx(hftpsession: *const core::ffi::c_void, lpszremotefile: windows_core::PCSTR, lpsznewfile: windows_core::PCWSTR, ffailifexists: bool, dwflagsandattributes: u32, dwflags: u32, dwcontext: Option<usize>) -> windows_core::BOOL {
    ...
    unsafe { FtpGetFileEx(hftpsession, core::mem::transmute(lpszremotefile), core::mem::transmute(lpsznewfile), ffailifexists.into(), dwflagsandattributes, dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn FtpGetFileW(hconnect: *const core::ffi::c_void, lpszremotefile: windows_core::PCWSTR, lpsznewfile: windows_core::PCWSTR, ffailifexists: bool, dwflagsandattributes: u32, dwflags: u32, dwcontext: Option<usize>) -> windows_core::Result<()> {
    ...
    unsafe { FtpGetFileW(hconnect, core::mem::transmute(lpszremotefile), core::mem::transmute(lpsznewfile), ffailifexists.into(), dwflagsandattributes, dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn FtpOpenFileA(hconnect: *const core::ffi::c_void, lpszfilename: windows_core::PCSTR, dwaccess: u32, dwflags: FTP_FLAGS, dwcontext: Option<usize>) -> *mut core::ffi::c_void {
    ...
    unsafe { FtpOpenFileA(hconnect, core::mem::transmute(lpszfilename), dwaccess, dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn FtpOpenFileW(hconnect: *const core::ffi::c_void, lpszfilename: windows_core::PCWSTR, dwaccess: u32, dwflags: FTP_FLAGS, dwcontext: Option<usize>) -> *mut core::ffi::c_void {
    ...
    unsafe { FtpOpenFileW(hconnect, core::mem::transmute(lpszfilename), dwaccess, dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn FtpPutFileA(hconnect: *const core::ffi::c_void, lpszlocalfile: windows_core::PCSTR, lpsznewremotefile: windows_core::PCSTR, dwflags: FTP_FLAGS, dwcontext: Option<usize>) -> windows_core::Result<()> {
    ...
    unsafe { FtpPutFileA(hconnect, core::mem::transmute(lpszlocalfile), core::mem::transmute(lpsznewremotefile), dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn FtpPutFileEx(hftpsession: *const core::ffi::c_void, lpszlocalfile: windows_core::PCWSTR, lpsznewremotefile: windows_core::PCSTR, dwflags: u32, dwcontext: Option<usize>) -> windows_core::BOOL {
    ...
    unsafe { FtpPutFileEx(hftpsession, core::mem::transmute(lpszlocalfile), core::mem::transmute(lpsznewremotefile), dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn FtpPutFileW(hconnect: *const core::ffi::c_void, lpszlocalfile: windows_core::PCWSTR, lpsznewremotefile: windows_core::PCWSTR, dwflags: FTP_FLAGS, dwcontext: Option<usize>) -> windows_core::Result<()> {
    ...
    unsafe { FtpPutFileW(hconnect, core::mem::transmute(lpszlocalfile), core::mem::transmute(lpsznewremotefile), dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn FtpRemoveDirectoryA(hconnect: *const core::ffi::c_void, lpszdirectory: windows_core::PCSTR) -> windows_core::Result<()> {
    ...
    unsafe { FtpRemoveDirectoryA(hconnect, core::mem::transmute(lpszdirectory)).ok() }
}
#[inline]
pub unsafe fn FtpRemoveDirectoryW(hconnect: *const core::ffi::c_void, lpszdirectory: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { FtpRemoveDirectoryW(hconnect, core::mem::transmute(lpszdirectory)).ok() }
}
#[inline]
pub unsafe fn FtpRenameFileA(hconnect: *const core::ffi::c_void, lpszexisting: windows_core::PCSTR, lpsznew: windows_core::PCSTR) -> windows_core::Result<()> {
    ...
    unsafe { FtpRenameFileA(hconnect, core::mem::transmute(lpszexisting), core::mem::transmute(lpsznew)).ok() }
}
#[inline]
pub unsafe fn FtpRenameFileW(hconnect: *const core::ffi::c_void, lpszexisting: windows_core::PCWSTR, lpsznew: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { FtpRenameFileW(hconnect, core::mem::transmute(lpszexisting), core::mem::transmute(lpsznew)).ok() }
}
#[inline]
pub unsafe fn FtpSetCurrentDirectoryA(hconnect: *const core::ffi::c_void, lpszdirectory: windows_core::PCSTR) -> windows_core::Result<()> {
    ...
    unsafe { FtpSetCurrentDirectoryA(hconnect, core::mem::transmute(lpszdirectory)).ok() }
}
#[inline]
pub unsafe fn FtpSetCurrentDirectoryW(hconnect: *const core::ffi::c_void, lpszdirectory: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { FtpSetCurrentDirectoryW(hconnect, core::mem::transmute(lpszdirectory)).ok() }
}
#[inline]
pub unsafe fn GetDiskInfoA(pszpath: windows_core::PCSTR, pdwclustersize: Option<*mut u32>, pdlavail: Option<*mut u64>, pdltotal: Option<*mut u64>) -> windows_core::BOOL {
    ...
    unsafe { GetDiskInfoA(core::mem::transmute(pszpath), pdwclustersize.unwrap_or(core::mem::zeroed()) as _, pdlavail.unwrap_or(core::mem::zeroed()) as _, pdltotal.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn GetUrlCacheEntryBinaryBlob(pwszurlname: windows_core::PCWSTR, dwtype: *mut u32, pftexpiretime: *mut super::super::Foundation::FILETIME, pftaccesstime: *mut super::super::Foundation::FILETIME, pftmodifiedtime: *mut super::super::Foundation::FILETIME, ppbblob: *mut *mut u8, pcbblob: *mut u32) -> u32 {
    ...
    unsafe { GetUrlCacheEntryBinaryBlob(core::mem::transmute(pwszurlname), dwtype as _, pftexpiretime as _, pftaccesstime as _, pftmodifiedtime as _, ppbblob as _, pcbblob as _) }
}
#[inline]
pub unsafe fn GetUrlCacheEntryInfoA(lpszurlname: windows_core::PCSTR, lpcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOA>, lpcbcacheentryinfo: Option<*mut u32>) -> windows_core::Result<()> {
    ...
    unsafe { GetUrlCacheEntryInfoA(core::mem::transmute(lpszurlname), lpcacheentryinfo.unwrap_or(core::mem::zeroed()) as _, lpcbcacheentryinfo.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn GetUrlCacheEntryInfoExA(lpszurl: windows_core::PCSTR, lpcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOA>, lpcbcacheentryinfo: Option<*mut u32>, lpszredirecturl: Option<windows_core::PCSTR>, lpcbredirecturl: Option<*const u32>, lpreserved: Option<*const core::ffi::c_void>, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { GetUrlCacheEntryInfoExA(core::mem::transmute(lpszurl), lpcacheentryinfo.unwrap_or(core::mem::zeroed()) as _, lpcbcacheentryinfo.unwrap_or(core::mem::zeroed()) as _, lpszredirecturl.unwrap_or(core::mem::zeroed()) as _, lpcbredirecturl.unwrap_or(core::mem::zeroed()) as _, lpreserved.unwrap_or(core::mem::zeroed()) as _, dwflags).ok() }
}
#[inline]
pub unsafe fn GetUrlCacheEntryInfoExW(lpszurl: windows_core::PCWSTR, lpcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOW>, lpcbcacheentryinfo: Option<*mut u32>, lpszredirecturl: Option<windows_core::PCWSTR>, lpcbredirecturl: Option<*const u32>, lpreserved: Option<*const core::ffi::c_void>, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { GetUrlCacheEntryInfoExW(core::mem::transmute(lpszurl), lpcacheentryinfo.unwrap_or(core::mem::zeroed()) as _, lpcbcacheentryinfo.unwrap_or(core::mem::zeroed()) as _, lpszredirecturl.unwrap_or(core::mem::zeroed()) as _, lpcbredirecturl.unwrap_or(core::mem::zeroed()) as _, lpreserved.unwrap_or(core::mem::zeroed()) as _, dwflags).ok() }
}
#[inline]
pub unsafe fn GetUrlCacheEntryInfoW(lpszurlname: windows_core::PCWSTR, lpcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOW>, lpcbcacheentryinfo: Option<*mut u32>) -> windows_core::Result<()> {
    ...
    unsafe { GetUrlCacheEntryInfoW(core::mem::transmute(lpszurlname), lpcacheentryinfo.unwrap_or(core::mem::zeroed()) as _, lpcbcacheentryinfo.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn GopherCreateLocatorA(lpszhost: windows_core::PCSTR, nserverport: u16, lpszdisplaystring: Option<windows_core::PCSTR>, lpszselectorstring: Option<windows_core::PCSTR>, dwgophertype: u32, lpszlocator: Option<windows_core::PSTR>, lpdwbufferlength: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { GopherCreateLocatorA(core::mem::transmute(lpszhost), nserverport, lpszdisplaystring.unwrap_or(core::mem::zeroed()) as _, lpszselectorstring.unwrap_or(core::mem::zeroed()) as _, dwgophertype, lpszlocator.unwrap_or(core::mem::zeroed()) as _, lpdwbufferlength as _).ok() }
}
#[inline]
pub unsafe fn GopherCreateLocatorW(lpszhost: windows_core::PCWSTR, nserverport: u16, lpszdisplaystring: Option<windows_core::PCWSTR>, lpszselectorstring: Option<windows_core::PCWSTR>, dwgophertype: u32, lpszlocator: Option<windows_core::PWSTR>, lpdwbufferlength: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { GopherCreateLocatorW(core::mem::transmute(lpszhost), nserverport, lpszdisplaystring.unwrap_or(core::mem::zeroed()) as _, lpszselectorstring.unwrap_or(core::mem::zeroed()) as _, dwgophertype, lpszlocator.unwrap_or(core::mem::zeroed()) as _, lpdwbufferlength as _).ok() }
}
#[inline]
pub unsafe fn GopherFindFirstFileA(hconnect: *const core::ffi::c_void, lpszlocator: Option<windows_core::PCSTR>, lpszsearchstring: Option<windows_core::PCSTR>, lpfinddata: Option<*mut GOPHER_FIND_DATAA>, dwflags: u32, dwcontext: Option<usize>) -> *mut core::ffi::c_void {
    ...
    unsafe { GopherFindFirstFileA(hconnect, lpszlocator.unwrap_or(core::mem::zeroed()) as _, lpszsearchstring.unwrap_or(core::mem::zeroed()) as _, lpfinddata.unwrap_or(core::mem::zeroed()) as _, dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn GopherFindFirstFileW(hconnect: *const core::ffi::c_void, lpszlocator: Option<windows_core::PCWSTR>, lpszsearchstring: Option<windows_core::PCWSTR>, lpfinddata: Option<*mut GOPHER_FIND_DATAW>, dwflags: u32, dwcontext: Option<usize>) -> *mut core::ffi::c_void {
    ...
    unsafe { GopherFindFirstFileW(hconnect, lpszlocator.unwrap_or(core::mem::zeroed()) as _, lpszsearchstring.unwrap_or(core::mem::zeroed()) as _, lpfinddata.unwrap_or(core::mem::zeroed()) as _, dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn GopherGetAttributeA(hconnect: *const core::ffi::c_void, lpszlocator: windows_core::PCSTR, lpszattributename: Option<windows_core::PCSTR>, lpbuffer: &mut [u8], lpdwcharactersreturned: *mut u32, lpfnenumerator: GOPHER_ATTRIBUTE_ENUMERATOR, dwcontext: Option<usize>) -> windows_core::Result<()> {
    ...
    unsafe { GopherGetAttributeA(hconnect, core::mem::transmute(lpszlocator), lpszattributename.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(lpbuffer.as_ptr()), lpbuffer.len().try_into().unwrap(), lpdwcharactersreturned as _, lpfnenumerator, dwcontext.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn GopherGetAttributeW(hconnect: *const core::ffi::c_void, lpszlocator: windows_core::PCWSTR, lpszattributename: Option<windows_core::PCWSTR>, lpbuffer: &mut [u8], lpdwcharactersreturned: *mut u32, lpfnenumerator: GOPHER_ATTRIBUTE_ENUMERATOR, dwcontext: Option<usize>) -> windows_core::Result<()> {
    ...
    unsafe { GopherGetAttributeW(hconnect, core::mem::transmute(lpszlocator), lpszattributename.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(lpbuffer.as_ptr()), lpbuffer.len().try_into().unwrap(), lpdwcharactersreturned as _, lpfnenumerator, dwcontext.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn GopherGetLocatorTypeA(lpszlocator: windows_core::PCSTR, lpdwgophertype: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { GopherGetLocatorTypeA(core::mem::transmute(lpszlocator), lpdwgophertype as _).ok() }
}
#[inline]
pub unsafe fn GopherGetLocatorTypeW(lpszlocator: windows_core::PCWSTR, lpdwgophertype: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { GopherGetLocatorTypeW(core::mem::transmute(lpszlocator), lpdwgophertype as _).ok() }
}
#[inline]
pub unsafe fn GopherOpenFileA(hconnect: *const core::ffi::c_void, lpszlocator: windows_core::PCSTR, lpszview: Option<windows_core::PCSTR>, dwflags: u32, dwcontext: Option<usize>) -> *mut core::ffi::c_void {
    ...
    unsafe { GopherOpenFileA(hconnect, core::mem::transmute(lpszlocator), lpszview.unwrap_or(core::mem::zeroed()) as _, dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn GopherOpenFileW(hconnect: *const core::ffi::c_void, lpszlocator: windows_core::PCWSTR, lpszview: Option<windows_core::PCWSTR>, dwflags: u32, dwcontext: Option<usize>) -> *mut core::ffi::c_void {
    ...
    unsafe { GopherOpenFileW(hconnect, core::mem::transmute(lpszlocator), lpszview.unwrap_or(core::mem::zeroed()) as _, dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn HttpCheckDavComplianceA(lpszurl: windows_core::PCSTR, lpszcompliancetoken: windows_core::PCSTR, lpffound: *mut windows_core::BOOL, hwnd: super::super::Foundation::HWND, lpvreserved: *const core::ffi::c_void) -> windows_core::BOOL {
    ...
    unsafe { HttpCheckDavComplianceA(core::mem::transmute(lpszurl), core::mem::transmute(lpszcompliancetoken), lpffound as _, hwnd, lpvreserved) }
}
#[inline]
pub unsafe fn HttpCheckDavComplianceW(lpszurl: windows_core::PCWSTR, lpszcompliancetoken: windows_core::PCWSTR, lpffound: *mut windows_core::BOOL, hwnd: super::super::Foundation::HWND, lpvreserved: *const core::ffi::c_void) -> windows_core::BOOL {
    ...
    unsafe { HttpCheckDavComplianceW(core::mem::transmute(lpszurl), core::mem::transmute(lpszcompliancetoken), lpffound as _, hwnd, lpvreserved) }
}
#[inline]
...
#[inline]
pub unsafe fn HttpGetServerCredentials(pwszurl: windows_core::PCWSTR, ppwszusername: *mut windows_core::PWSTR, ppwszpassword: *mut windows_core::PWSTR) -> u32 {
    ...
    unsafe { HttpGetServerCredentials(core::mem::transmute(pwszurl), ppwszusername as _, ppwszpassword as _) }
}
#[inline]
...
#[inline]
pub unsafe fn HttpIsHostHstsEnabled(pcwszurl: windows_core::PCWSTR, pfishsts: *mut windows_core::BOOL) -> u32 {
    ...
    unsafe { HttpIsHostHstsEnabled(core::mem::transmute(pcwszurl), pfishsts as _) }
}
#[inline]
...
#[inline]
pub unsafe fn HttpOpenRequestA(hconnect: *const core::ffi::c_void, lpszverb: Option<windows_core::PCSTR>, lpszobjectname: Option<windows_core::PCSTR>, lpszversion: Option<windows_core::PCSTR>, lpszreferrer: Option<windows_core::PCSTR>, lplpszaccepttypes: Option<*const windows_core::PCSTR>, dwflags: u32, dwcontext: Option<usize>) -> *mut core::ffi::c_void {
    ...
    unsafe { HttpOpenRequestA(hconnect, lpszverb.unwrap_or(core::mem::zeroed()) as _, lpszobjectname.unwrap_or(core::mem::zeroed()) as _, lpszversion.unwrap_or(core::mem::zeroed()) as _, lpszreferrer.unwrap_or(core::mem::zeroed()) as _, lplpszaccepttypes.unwrap_or(core::mem::zeroed()) as _, dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn HttpOpenRequestW(hconnect: *const core::ffi::c_void, lpszverb: Option<windows_core::PCWSTR>, lpszobjectname: Option<windows_core::PCWSTR>, lpszversion: Option<windows_core::PCWSTR>, lpszreferrer: Option<windows_core::PCWSTR>, lplpszaccepttypes: Option<*const windows_core::PCWSTR>, dwflags: u32, dwcontext: Option<usize>) -> *mut core::ffi::c_void {
    ...
    unsafe { HttpOpenRequestW(hconnect, lpszverb.unwrap_or(core::mem::zeroed()) as _, lpszobjectname.unwrap_or(core::mem::zeroed()) as _, lpszversion.unwrap_or(core::mem::zeroed()) as _, lpszreferrer.unwrap_or(core::mem::zeroed()) as _, lplpszaccepttypes.unwrap_or(core::mem::zeroed()) as _, dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn ImportCookieFileA(szfilename: windows_core::PCSTR) -> windows_core::BOOL {
    windows_core::link!("wininet.dll" "system" fn ImportCookieFileA(szfilename : windows_core::PCSTR) -> windows_core::BOOL);
    unsafe { ImportCookieFileA(core::mem::transmute(szfilename)) }
}
#[inline]
pub unsafe fn ImportCookieFileW(szfilename: windows_core::PCWSTR) -> windows_core::BOOL {
    windows_core::link!("wininet.dll" "system" fn ImportCookieFileW(szfilename : windows_core::PCWSTR) -> windows_core::BOOL);
    unsafe { ImportCookieFileW(core::mem::transmute(szfilename)) }
}
#[inline]
...
#[inline]
pub unsafe fn InternalInternetGetCookie(lpszurl: windows_core::PCSTR, lpszcookiedata: windows_core::PSTR, lpdwdatasize: *mut u32) -> u32 {
    ...
    unsafe { InternalInternetGetCookie(core::mem::transmute(lpszurl), core::mem::transmute(lpszcookiedata), lpdwdatasize as _) }
}
...
#[inline]
pub unsafe fn InternetCanonicalizeUrlA(lpszurl: windows_core::PCSTR, lpszbuffer: windows_core::PSTR, lpdwbufferlength: *mut u32, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { InternetCanonicalizeUrlA(core::mem::transmute(lpszurl), core::mem::transmute(lpszbuffer), lpdwbufferlength as _, dwflags).ok() }
}
#[inline]
pub unsafe fn InternetCanonicalizeUrlW(lpszurl: windows_core::PCWSTR, lpszbuffer: windows_core::PWSTR, lpdwbufferlength: *mut u32, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { InternetCanonicalizeUrlW(core::mem::transmute(lpszurl), core::mem::transmute(lpszbuffer), lpdwbufferlength as _, dwflags).ok() }
}
#[inline]
pub unsafe fn InternetCheckConnectionA(lpszurl: windows_core::PCSTR, dwflags: u32, dwreserved: u32) -> windows_core::Result<()> {
    ...
    unsafe { InternetCheckConnectionA(core::mem::transmute(lpszurl), dwflags, dwreserved).ok() }
}
#[inline]
pub unsafe fn InternetCheckConnectionW(lpszurl: windows_core::PCWSTR, dwflags: u32, dwreserved: u32) -> windows_core::Result<()> {
    ...
    unsafe { InternetCheckConnectionW(core::mem::transmute(lpszurl), dwflags, dwreserved).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn InternetCombineUrlA(lpszbaseurl: windows_core::PCSTR, lpszrelativeurl: windows_core::PCSTR, lpszbuffer: windows_core::PSTR, lpdwbufferlength: *mut u32, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { InternetCombineUrlA(core::mem::transmute(lpszbaseurl), core::mem::transmute(lpszrelativeurl), core::mem::transmute(lpszbuffer), lpdwbufferlength as _, dwflags).ok() }
}
#[inline]
pub unsafe fn InternetCombineUrlW(lpszbaseurl: windows_core::PCWSTR, lpszrelativeurl: windows_core::PCWSTR, lpszbuffer: windows_core::PWSTR, lpdwbufferlength: *mut u32, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { InternetCombineUrlW(core::mem::transmute(lpszbaseurl), core::mem::transmute(lpszrelativeurl), core::mem::transmute(lpszbuffer), lpdwbufferlength as _, dwflags).ok() }
}
#[inline]
pub unsafe fn InternetConfirmZoneCrossing(hwnd: super::super::Foundation::HWND, szurlprev: windows_core::PCSTR, szurlnew: windows_core::PCSTR, bpost: bool) -> u32 {
    ...
    unsafe { InternetConfirmZoneCrossing(hwnd, core::mem::transmute(szurlprev), core::mem::transmute(szurlnew), bpost.into()) }
}
#[inline]
pub unsafe fn InternetConfirmZoneCrossingA(hwnd: super::super::Foundation::HWND, szurlprev: windows_core::PCSTR, szurlnew: windows_core::PCSTR, bpost: bool) -> u32 {
    ...
    unsafe { InternetConfirmZoneCrossingA(hwnd, core::mem::transmute(szurlprev), core::mem::transmute(szurlnew), bpost.into()) }
}
#[inline]
pub unsafe fn InternetConfirmZoneCrossingW(hwnd: super::super::Foundation::HWND, szurlprev: windows_core::PCWSTR, szurlnew: windows_core::PCWSTR, bpost: bool) -> u32 {
    ...
    unsafe { InternetConfirmZoneCrossingW(hwnd, core::mem::transmute(szurlprev), core::mem::transmute(szurlnew), bpost.into()) }
}
#[inline]
pub unsafe fn InternetConnectA(hinternet: *const core::ffi::c_void, lpszservername: windows_core::PCSTR, nserverport: u16, lpszusername: Option<windows_core::PCSTR>, lpszpassword: Option<windows_core::PCSTR>, dwservice: u32, dwflags: u32, dwcontext: Option<usize>) -> *mut core::ffi::c_void {
    ...
    unsafe { InternetConnectA(hinternet, core::mem::transmute(lpszservername), nserverport, lpszusername.unwrap_or(core::mem::zeroed()) as _, lpszpassword.unwrap_or(core::mem::zeroed()) as _, dwservice, dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn InternetConnectW(hinternet: *const core::ffi::c_void, lpszservername: windows_core::PCWSTR, nserverport: u16, lpszusername: Option<windows_core::PCWSTR>, lpszpassword: Option<windows_core::PCWSTR>, dwservice: u32, dwflags: u32, dwcontext: Option<usize>) -> *mut core::ffi::c_void {
    ...
    unsafe { InternetConnectW(hinternet, core::mem::transmute(lpszservername), nserverport, lpszusername.unwrap_or(core::mem::zeroed()) as _, lpszpassword.unwrap_or(core::mem::zeroed()) as _, dwservice, dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn InternetConvertUrlFromWireToWideChar(pcszurl: &[u8], pcwszbaseurl: windows_core::PCWSTR, dwcodepagehost: u32, dwcodepagepath: u32, fencodepathextra: bool, dwcodepageextra: u32, ppwszconvertedurl: *mut windows_core::PWSTR) -> u32 {
    ...
    unsafe { InternetConvertUrlFromWireToWideChar(core::mem::transmute(pcszurl.as_ptr()), pcszurl.len().try_into().unwrap(), core::mem::transmute(pcwszbaseurl), dwcodepagehost, dwcodepagepath, fencodepathextra.into(), dwcodepageextra, ppwszconvertedurl as _) }
}
...
#[inline]
pub unsafe fn InternetDial(hwndparent: super::super::Foundation::HWND, lpszconnectoid: Option<windows_core::PCSTR>, dwflags: u32, lpdwconnection: *mut u32, dwreserved: u32) -> u32 {
    ...
    unsafe { InternetDial(hwndparent, lpszconnectoid.unwrap_or(core::mem::zeroed()) as _, dwflags, lpdwconnection as _, dwreserved) }
}
#[inline]
pub unsafe fn InternetDialA(hwndparent: super::super::Foundation::HWND, lpszconnectoid: Option<windows_core::PCSTR>, dwflags: u32, lpdwconnection: *mut usize, dwreserved: Option<u32>) -> u32 {
    ...
    unsafe { InternetDialA(hwndparent, lpszconnectoid.unwrap_or(core::mem::zeroed()) as _, dwflags, lpdwconnection as _, dwreserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn InternetDialW(hwndparent: super::super::Foundation::HWND, lpszconnectoid: Option<windows_core::PCWSTR>, dwflags: u32, lpdwconnection: *mut usize, dwreserved: Option<u32>) -> u32 {
    ...
    unsafe { InternetDialW(hwndparent, lpszconnectoid.unwrap_or(core::mem::zeroed()) as _, dwflags, lpdwconnection as _, dwreserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn InternetGetCookieA(lpszurl: windows_core::PCSTR, lpszcookiename: Option<windows_core::PCSTR>, lpszcookiedata: Option<windows_core::PSTR>, lpdwsize: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { InternetGetCookieA(core::mem::transmute(lpszurl), lpszcookiename.unwrap_or(core::mem::zeroed()) as _, lpszcookiedata.unwrap_or(core::mem::zeroed()) as _, lpdwsize as _).ok() }
}
#[inline]
pub unsafe fn InternetGetCookieEx2(pcwszurl: windows_core::PCWSTR, pcwszcookiename: Option<windows_core::PCWSTR>, dwflags: u32, ppcookies: *mut *mut INTERNET_COOKIE2, pdwcookiecount: *mut u32) -> u32 {
    ...
    unsafe { InternetGetCookieEx2(core::mem::transmute(pcwszurl), pcwszcookiename.unwrap_or(core::mem::zeroed()) as _, dwflags, ppcookies as _, pdwcookiecount as _) }
}
#[inline]
pub unsafe fn InternetGetCookieExA(lpszurl: windows_core::PCSTR, lpszcookiename: Option<windows_core::PCSTR>, lpszcookiedata: Option<windows_core::PCSTR>, lpdwsize: *mut u32, dwflags: INTERNET_COOKIE_FLAGS, lpreserved: Option<*const core::ffi::c_void>) -> windows_core::Result<()> {
    ...
    unsafe { InternetGetCookieExA(core::mem::transmute(lpszurl), lpszcookiename.unwrap_or(core::mem::zeroed()) as _, lpszcookiedata.unwrap_or(core::mem::zeroed()) as _, lpdwsize as _, dwflags, lpreserved.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn InternetGetCookieExW(lpszurl: windows_core::PCWSTR, lpszcookiename: Option<windows_core::PCWSTR>, lpszcookiedata: Option<windows_core::PCWSTR>, lpdwsize: *mut u32, dwflags: INTERNET_COOKIE_FLAGS, lpreserved: Option<*const core::ffi::c_void>) -> windows_core::Result<()> {
    ...
    unsafe { InternetGetCookieExW(core::mem::transmute(lpszurl), lpszcookiename.unwrap_or(core::mem::zeroed()) as _, lpszcookiedata.unwrap_or(core::mem::zeroed()) as _, lpdwsize as _, dwflags, lpreserved.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn InternetGetCookieW(lpszurl: windows_core::PCWSTR, lpszcookiename: Option<windows_core::PCWSTR>, lpszcookiedata: Option<windows_core::PWSTR>, lpdwsize: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { InternetGetCookieW(core::mem::transmute(lpszurl), lpszcookiename.unwrap_or(core::mem::zeroed()) as _, lpszcookiedata.unwrap_or(core::mem::zeroed()) as _, lpdwsize as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn InternetGetPerSiteCookieDecisionA(pchhostname: windows_core::PCSTR, presult: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { InternetGetPerSiteCookieDecisionA(core::mem::transmute(pchhostname), presult as _) }
}
#[inline]
pub unsafe fn InternetGetPerSiteCookieDecisionW(pchhostname: windows_core::PCWSTR, presult: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { InternetGetPerSiteCookieDecisionW(core::mem::transmute(pchhostname), presult as _) }
}
#[inline]
pub unsafe fn InternetGetProxyForUrl(hinternet: *const core::ffi::c_void, pcwszurl: windows_core::PCWSTR, pproxyinfolist: *mut WININET_PROXY_INFO_LIST) -> u32 {
    ...
    unsafe { InternetGetProxyForUrl(hinternet, core::mem::transmute(pcwszurl), pproxyinfolist as _) }
}
#[cfg(feature = "Win32_Security_Cryptography")]
#[inline]
pub unsafe fn InternetGetSecurityInfoByURL(lpszurl: windows_core::PCSTR, ppcertchain: *mut *mut super::super::Security::Cryptography::CERT_CHAIN_CONTEXT, pdwsecureflags: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { InternetGetSecurityInfoByURL(core::mem::transmute(lpszurl), ppcertchain as _, pdwsecureflags as _) }
}
#[cfg(feature = "Win32_Security_Cryptography")]
#[inline]
pub unsafe fn InternetGetSecurityInfoByURLA(lpszurl: windows_core::PCSTR, ppcertchain: *mut *mut super::super::Security::Cryptography::CERT_CHAIN_CONTEXT, pdwsecureflags: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { InternetGetSecurityInfoByURLA(core::mem::transmute(lpszurl), ppcertchain as _, pdwsecureflags as _) }
}
#[cfg(feature = "Win32_Security_Cryptography")]
#[inline]
pub unsafe fn InternetGetSecurityInfoByURLW(lpszurl: windows_core::PCWSTR, ppcertchain: *mut *mut super::super::Security::Cryptography::CERT_CHAIN_CONTEXT, pdwsecureflags: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { InternetGetSecurityInfoByURLW(core::mem::transmute(lpszurl), ppcertchain as _, pdwsecureflags as _) }
}
#[inline]
pub unsafe fn InternetGoOnline(lpszurl: Option<windows_core::PCSTR>, hwndparent: super::super::Foundation::HWND, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { InternetGoOnline(lpszurl.unwrap_or(core::mem::zeroed()) as _, hwndparent, dwflags).ok() }
}
#[inline]
pub unsafe fn InternetGoOnlineA(lpszurl: Option<windows_core::PCSTR>, hwndparent: super::super::Foundation::HWND, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { InternetGoOnlineA(lpszurl.unwrap_or(core::mem::zeroed()) as _, hwndparent, dwflags).ok() }
}
#[inline]
pub unsafe fn InternetGoOnlineW(lpszurl: Option<windows_core::PCWSTR>, hwndparent: super::super::Foundation::HWND, dwflags: u32) -> windows_core::Result<()> {
    ...
    unsafe { InternetGoOnlineW(lpszurl.unwrap_or(core::mem::zeroed()) as _, hwndparent, dwflags).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn InternetOpenA(lpszagent: Option<windows_core::PCSTR>, dwaccesstype: u32, lpszproxy: Option<windows_core::PCSTR>, lpszproxybypass: Option<windows_core::PCSTR>, dwflags: u32) -> *mut core::ffi::c_void {
    ...
    unsafe { InternetOpenA(lpszagent.unwrap_or(core::mem::zeroed()) as _, dwaccesstype, lpszproxy.unwrap_or(core::mem::zeroed()) as _, lpszproxybypass.unwrap_or(core::mem::zeroed()) as _, dwflags) }
}
#[inline]
pub unsafe fn InternetOpenUrlA(hinternet: *const core::ffi::c_void, lpszurl: windows_core::PCSTR, lpszheaders: Option<&[u8]>, dwflags: u32, dwcontext: Option<usize>) -> *mut core::ffi::c_void {
    ...
    unsafe { InternetOpenUrlA(hinternet, core::mem::transmute(lpszurl), core::mem::transmute(lpszheaders.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), lpszheaders.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn InternetOpenUrlW(hinternet: *const core::ffi::c_void, lpszurl: windows_core::PCWSTR, lpszheaders: Option<&[u16]>, dwflags: u32, dwcontext: Option<usize>) -> *mut core::ffi::c_void {
    ...
    unsafe { InternetOpenUrlW(hinternet, core::mem::transmute(lpszurl), core::mem::transmute(lpszheaders.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), lpszheaders.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), dwflags, dwcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn InternetOpenW(lpszagent: Option<windows_core::PCWSTR>, dwaccesstype: u32, lpszproxy: Option<windows_core::PCWSTR>, lpszproxybypass: Option<windows_core::PCWSTR>, dwflags: u32) -> *mut core::ffi::c_void {
    ...
    unsafe { InternetOpenW(lpszagent.unwrap_or(core::mem::zeroed()) as _, dwaccesstype, lpszproxy.unwrap_or(core::mem::zeroed()) as _, lpszproxybypass.unwrap_or(core::mem::zeroed()) as _, dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn InternetSetCookieA(lpszurl: windows_core::PCSTR, lpszcookiename: Option<windows_core::PCSTR>, lpszcookiedata: windows_core::PCSTR) -> windows_core::Result<()> {
    ...
    unsafe { InternetSetCookieA(core::mem::transmute(lpszurl), lpszcookiename.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(lpszcookiedata)).ok() }
}
#[inline]
pub unsafe fn InternetSetCookieEx2(pcwszurl: windows_core::PCWSTR, pcookie: *const INTERNET_COOKIE2, pcwszp3ppolicy: Option<windows_core::PCWSTR>, dwflags: u32, pdwcookiestate: *mut u32) -> u32 {
    ...
    unsafe { InternetSetCookieEx2(core::mem::transmute(pcwszurl), pcookie, pcwszp3ppolicy.unwrap_or(core::mem::zeroed()) as _, dwflags, pdwcookiestate as _) }
}
#[inline]
pub unsafe fn InternetSetCookieExA(lpszurl: windows_core::PCSTR, lpszcookiename: Option<windows_core::PCSTR>, lpszcookiedata: windows_core::PCSTR, dwflags: u32, dwreserved: Option<usize>) -> u32 {
    ...
    unsafe { InternetSetCookieExA(core::mem::transmute(lpszurl), lpszcookiename.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(lpszcookiedata), dwflags, dwreserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn InternetSetCookieExW(lpszurl: windows_core::PCWSTR, lpszcookiename: Option<windows_core::PCWSTR>, lpszcookiedata: windows_core::PCWSTR, dwflags: u32, dwreserved: Option<usize>) -> u32 {
    ...
    unsafe { InternetSetCookieExW(core::mem::transmute(lpszurl), lpszcookiename.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(lpszcookiedata), dwflags, dwreserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn InternetSetCookieW(lpszurl: windows_core::PCWSTR, lpszcookiename: Option<windows_core::PCWSTR>, lpszcookiedata: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { InternetSetCookieW(core::mem::transmute(lpszurl), lpszcookiename.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(lpszcookiedata)).ok() }
}
#[inline]
pub unsafe fn InternetSetDialState(lpszconnectoid: Option<windows_core::PCSTR>, dwstate: u32, dwreserved: u32) -> windows_core::BOOL {
    ...
    unsafe { InternetSetDialState(lpszconnectoid.unwrap_or(core::mem::zeroed()) as _, dwstate, dwreserved) }
}
#[inline]
pub unsafe fn InternetSetDialStateA(lpszconnectoid: Option<windows_core::PCSTR>, dwstate: u32, dwreserved: Option<u32>) -> windows_core::BOOL {
    ...
    unsafe { InternetSetDialStateA(lpszconnectoid.unwrap_or(core::mem::zeroed()) as _, dwstate, dwreserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn InternetSetDialStateW(lpszconnectoid: Option<windows_core::PCWSTR>, dwstate: u32, dwreserved: Option<u32>) -> windows_core::BOOL {
    ...
    unsafe { InternetSetDialStateW(lpszconnectoid.unwrap_or(core::mem::zeroed()) as _, dwstate, dwreserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn InternetSetPerSiteCookieDecisionA(pchhostname: windows_core::PCSTR, dwdecision: u32) -> windows_core::BOOL {
    ...
    unsafe { InternetSetPerSiteCookieDecisionA(core::mem::transmute(pchhostname), dwdecision) }
}
#[inline]
pub unsafe fn InternetSetPerSiteCookieDecisionW(pchhostname: windows_core::PCWSTR, dwdecision: u32) -> windows_core::BOOL {
    ...
    unsafe { InternetSetPerSiteCookieDecisionW(core::mem::transmute(pchhostname), dwdecision) }
}
#[inline]
...
#[inline]
pub unsafe fn InternetShowSecurityInfoByURL(lpszurl: windows_core::PCSTR, hwndparent: super::super::Foundation::HWND) -> windows_core::BOOL {
    ...
    unsafe { InternetShowSecurityInfoByURL(core::mem::transmute(lpszurl), hwndparent) }
}
#[inline]
pub unsafe fn InternetShowSecurityInfoByURLA(lpszurl: windows_core::PCSTR, hwndparent: super::super::Foundation::HWND) -> windows_core::BOOL {
    ...
    unsafe { InternetShowSecurityInfoByURLA(core::mem::transmute(lpszurl), hwndparent) }
}
#[inline]
pub unsafe fn InternetShowSecurityInfoByURLW(lpszurl: windows_core::PCWSTR, hwndparent: super::super::Foundation::HWND) -> windows_core::BOOL {
    ...
    unsafe { InternetShowSecurityInfoByURLW(core::mem::transmute(lpszurl), hwndparent) }
}
#[inline]
...
#[inline]
pub unsafe fn InternetTimeToSystemTime(lpsztime: windows_core::PCSTR, pst: *mut super::super::Foundation::SYSTEMTIME, dwreserved: Option<u32>) -> windows_core::Result<()> {
    ...
    unsafe { InternetTimeToSystemTime(core::mem::transmute(lpsztime), pst as _, dwreserved.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn InternetTimeToSystemTimeA(lpsztime: windows_core::PCSTR, pst: *mut super::super::Foundation::SYSTEMTIME, dwreserved: Option<u32>) -> windows_core::Result<()> {
    ...
    unsafe { InternetTimeToSystemTimeA(core::mem::transmute(lpsztime), pst as _, dwreserved.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn InternetTimeToSystemTimeW(lpsztime: windows_core::PCWSTR, pst: *mut super::super::Foundation::SYSTEMTIME, dwreserved: Option<u32>) -> windows_core::Result<()> {
    ...
    unsafe { InternetTimeToSystemTimeW(core::mem::transmute(lpsztime), pst as _, dwreserved.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn IsDomainLegalCookieDomainA(pchdomain: windows_core::PCSTR, pchfulldomain: windows_core::PCSTR) -> windows_core::BOOL {
    ...
    unsafe { IsDomainLegalCookieDomainA(core::mem::transmute(pchdomain), core::mem::transmute(pchfulldomain)) }
}
#[inline]
pub unsafe fn IsDomainLegalCookieDomainW(pchdomain: windows_core::PCWSTR, pchfulldomain: windows_core::PCWSTR) -> windows_core::BOOL {
    ...
    unsafe { IsDomainLegalCookieDomainW(core::mem::transmute(pchdomain), core::mem::transmute(pchfulldomain)) }
}
#[inline]
...
#[inline]
pub unsafe fn IsUrlCacheEntryExpiredA(lpszurlname: windows_core::PCSTR, dwflags: u32, pftlastmodified: *mut super::super::Foundation::FILETIME) -> windows_core::BOOL {
    ...
    unsafe { IsUrlCacheEntryExpiredA(core::mem::transmute(lpszurlname), dwflags, pftlastmodified as _) }
}
#[inline]
pub unsafe fn IsUrlCacheEntryExpiredW(lpszurlname: windows_core::PCWSTR, dwflags: u32, pftlastmodified: *mut super::super::Foundation::FILETIME) -> windows_core::BOOL {
    ...
    unsafe { IsUrlCacheEntryExpiredW(core::mem::transmute(lpszurlname), dwflags, pftlastmodified as _) }
}
#[inline]
...
#[inline]
pub unsafe fn PerformOperationOverUrlCacheA(pszurlsearchpattern: Option<windows_core::PCSTR>, dwflags: u32, dwfilter: u32, groupid: i64, preserved1: Option<*const core::ffi::c_void>, pdwreserved2: Option<*const u32>, preserved3: Option<*const core::ffi::c_void>, op: CACHE_OPERATOR, poperatordata: *mut core::ffi::c_void) -> windows_core::BOOL {
    ...
    unsafe { PerformOperationOverUrlCacheA(pszurlsearchpattern.unwrap_or(core::mem::zeroed()) as _, dwflags, dwfilter, groupid, preserved1.unwrap_or(core::mem::zeroed()) as _, pdwreserved2.unwrap_or(core::mem::zeroed()) as _, preserved3.unwrap_or(core::mem::zeroed()) as _, op, poperatordata as _) }
}
#[inline]
...
#[inline]
pub unsafe fn PrivacySetZonePreferenceW(dwzone: u32, dwtype: u32, dwtemplate: u32, pszpreference: Option<windows_core::PCWSTR>) -> u32 {
    ...
    unsafe { PrivacySetZonePreferenceW(dwzone, dwtype, dwtemplate, pszpreference.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn RetrieveUrlCacheEntryFileA(lpszurlname: windows_core::PCSTR, lpcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOA>, lpcbcacheentryinfo: *mut u32, dwreserved: Option<u32>) -> windows_core::Result<()> {
    ...
    unsafe { RetrieveUrlCacheEntryFileA(core::mem::transmute(lpszurlname), lpcacheentryinfo.unwrap_or(core::mem::zeroed()) as _, lpcbcacheentryinfo as _, dwreserved.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn RetrieveUrlCacheEntryFileW(lpszurlname: windows_core::PCWSTR, lpcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOW>, lpcbcacheentryinfo: *mut u32, dwreserved: Option<u32>) -> windows_core::Result<()> {
    ...
    unsafe { RetrieveUrlCacheEntryFileW(core::mem::transmute(lpszurlname), lpcacheentryinfo.unwrap_or(core::mem::zeroed()) as _, lpcbcacheentryinfo as _, dwreserved.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn RetrieveUrlCacheEntryStreamA(lpszurlname: windows_core::PCSTR, lpcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOA>, lpcbcacheentryinfo: *mut u32, frandomread: bool, dwreserved: Option<u32>) -> windows_core::Result<super::super::Foundation::HANDLE> {
    ...
    let result__ = unsafe { RetrieveUrlCacheEntryStreamA(core::mem::transmute(lpszurlname), lpcacheentryinfo.unwrap_or(core::mem::zeroed()) as _, lpcbcacheentryinfo as _, frandomread.into(), dwreserved.unwrap_or(core::mem::zeroed()) as _) };
    (!result__.is_invalid()).then_some(result__).ok_or_else(windows_core::Error::from_thread)
}
#[inline]
pub unsafe fn RetrieveUrlCacheEntryStreamW(lpszurlname: windows_core::PCWSTR, lpcacheentryinfo: Option<*mut INTERNET_CACHE_ENTRY_INFOW>, lpcbcacheentryinfo: *mut u32, frandomread: bool, dwreserved: Option<u32>) -> windows_core::Result<super::super::Foundation::HANDLE> {
    ...
    let result__ = unsafe { RetrieveUrlCacheEntryStreamW(core::mem::transmute(lpszurlname), lpcacheentryinfo.unwrap_or(core::mem::zeroed()) as _, lpcbcacheentryinfo as _, frandomread.into(), dwreserved.unwrap_or(core::mem::zeroed()) as _) };
    (!result__.is_invalid()).then_some(result__).ok_or_else(windows_core::Error::from_thread)
}
#[inline]
pub unsafe fn RunOnceUrlCache(hwnd: super::super::Foundation::HWND, hinst: super::super::Foundation::HINSTANCE, lpszcmd: windows_core::PCSTR, ncmdshow: i32) -> u32 {
    ...
    unsafe { RunOnceUrlCache(hwnd, hinst, core::mem::transmute(lpszcmd), ncmdshow) }
}
#[inline]
...
#[inline]
pub unsafe fn SetUrlCacheEntryGroup(lpszurlname: windows_core::PCSTR, dwflags: u32, groupid: i64, pbgroupattributes: Option<*const u8>, cbgroupattributes: Option<u32>, lpreserved: Option<*const core::ffi::c_void>) -> windows_core::BOOL {
    ...
    unsafe { SetUrlCacheEntryGroup(core::mem::transmute(lpszurlname), dwflags, groupid, pbgroupattributes.unwrap_or(core::mem::zeroed()) as _, cbgroupattributes.unwrap_or(core::mem::zeroed()) as _, lpreserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn SetUrlCacheEntryGroupA(lpszurlname: windows_core::PCSTR, dwflags: u32, groupid: i64, pbgroupattributes: Option<*const u8>, cbgroupattributes: Option<u32>, lpreserved: Option<*const core::ffi::c_void>) -> windows_core::BOOL {
    ...
    unsafe { SetUrlCacheEntryGroupA(core::mem::transmute(lpszurlname), dwflags, groupid, pbgroupattributes.unwrap_or(core::mem::zeroed()) as _, cbgroupattributes.unwrap_or(core::mem::zeroed()) as _, lpreserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn SetUrlCacheEntryGroupW(lpszurlname: windows_core::PCWSTR, dwflags: u32, groupid: i64, pbgroupattributes: Option<*const u8>, cbgroupattributes: Option<u32>, lpreserved: Option<*const core::ffi::c_void>) -> windows_core::BOOL {
    ...
    unsafe { SetUrlCacheEntryGroupW(core::mem::transmute(lpszurlname), dwflags, groupid, pbgroupattributes.unwrap_or(core::mem::zeroed()) as _, cbgroupattributes.unwrap_or(core::mem::zeroed()) as _, lpreserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn SetUrlCacheEntryInfoA(lpszurlname: windows_core::PCSTR, lpcacheentryinfo: *const INTERNET_CACHE_ENTRY_INFOA, dwfieldcontrol: u32) -> windows_core::Result<()> {
    ...
    unsafe { SetUrlCacheEntryInfoA(core::mem::transmute(lpszurlname), lpcacheentryinfo, dwfieldcontrol).ok() }
}
#[inline]
pub unsafe fn SetUrlCacheEntryInfoW(lpszurlname: windows_core::PCWSTR, lpcacheentryinfo: *const INTERNET_CACHE_ENTRY_INFOW, dwfieldcontrol: u32) -> windows_core::Result<()> {
    ...
    unsafe { SetUrlCacheEntryInfoW(core::mem::transmute(lpszurlname), lpcacheentryinfo, dwfieldcontrol).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn UnlockUrlCacheEntryFile(lpszurlname: windows_core::PCSTR, dwreserved: Option<u32>) -> windows_core::Result<()> {
    ...
    unsafe { UnlockUrlCacheEntryFile(core::mem::transmute(lpszurlname), dwreserved.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn UnlockUrlCacheEntryFileA(lpszurlname: windows_core::PCSTR, dwreserved: Option<u32>) -> windows_core::Result<()> {
    ...
    unsafe { UnlockUrlCacheEntryFileA(core::mem::transmute(lpszurlname), dwreserved.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn UnlockUrlCacheEntryFileW(lpszurlname: windows_core::PCWSTR, dwreserved: Option<u32>) -> windows_core::Result<()> {
    ...
    unsafe { UnlockUrlCacheEntryFileW(core::mem::transmute(lpszurlname), dwreserved.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn UpdateUrlCacheContentPath(sznewpath: windows_core::PCSTR) -> windows_core::BOOL {
    windows_core::link!("wininet.dll" "system" fn UpdateUrlCacheContentPath(sznewpath : windows_core::PCSTR) -> windows_core::BOOL);
    unsafe { UpdateUrlCacheContentPath(core::mem::transmute(sznewpath)) }
}
#[inline]
...
#[inline]
pub unsafe fn UrlCacheContainerSetEntryMaximumAge(pwszprefix: windows_core::PCWSTR, dwentrymaxage: u32) -> u32 {
    ...
    unsafe { UrlCacheContainerSetEntryMaximumAge(core::mem::transmute(pwszprefix), dwentrymaxage) }
}
#[inline]
pub unsafe fn UrlCacheCreateContainer(pwszname: windows_core::PCWSTR, pwszprefix: windows_core::PCWSTR, pwszdirectory: windows_core::PCWSTR, ulllimit: u64, dwoptions: u32) -> u32 {
    ...
    unsafe { UrlCacheCreateContainer(core::mem::transmute(pwszname), core::mem::transmute(pwszprefix), core::mem::transmute(pwszdirectory), ulllimit, dwoptions) }
}
#[inline]
pub unsafe fn UrlCacheFindFirstEntry(pwszprefix: Option<windows_core::PCWSTR>, dwflags: u32, dwfilter: u32, groupid: i64, pcacheentryinfo: *mut URLCACHE_ENTRY_INFO, phfind: *mut super::super::Foundation::HANDLE) -> u32 {
    ...
    unsafe { UrlCacheFindFirstEntry(pwszprefix.unwrap_or(core::mem::zeroed()) as _, dwflags, dwfilter, groupid, pcacheentryinfo as _, phfind as _) }
}
#[inline]
...
#[inline]
pub unsafe fn UrlCacheGetEntryInfo(happcache: Option<*const core::ffi::c_void>, pcwszurl: windows_core::PCWSTR, pcacheentryinfo: Option<*mut URLCACHE_ENTRY_INFO>) -> u32 {
    ...
    unsafe { UrlCacheGetEntryInfo(happcache.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pcwszurl), pcacheentryinfo.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn UrlCacheRetrieveEntryFile(happcache: Option<*const core::ffi::c_void>, pcwszurl: windows_core::PCWSTR, pcacheentryinfo: *mut URLCACHE_ENTRY_INFO, phentryfile: *mut *mut core::ffi::c_void) -> u32 {
    ...
    unsafe { UrlCacheRetrieveEntryFile(happcache.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pcwszurl), pcacheentryinfo as _, phentryfile as _) }
}
#[inline]
pub unsafe fn UrlCacheRetrieveEntryStream(happcache: Option<*const core::ffi::c_void>, pcwszurl: windows_core::PCWSTR, frandomread: bool, pcacheentryinfo: *mut URLCACHE_ENTRY_INFO, phentrystream: *mut *mut core::ffi::c_void) -> u32 {
    ...
    unsafe { UrlCacheRetrieveEntryStream(happcache.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pcwszurl), frandomread.into(), pcacheentryinfo as _, phentrystream as _) }
}
#[inline]
...
#[inline]
pub unsafe fn UrlCacheUpdateEntryExtraData(happcache: Option<*const core::ffi::c_void>, pcwszurl: windows_core::PCWSTR, pbextradata: &[u8]) -> u32 {
    ...
    unsafe { UrlCacheUpdateEntryExtraData(happcache.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pcwszurl), core::mem::transmute(pbextradata.as_ptr()), pbextradata.len().try_into().unwrap()) }
}
...
impl IDialBranding {
    pub unsafe fn Initialize(&self, pwzconnectoid: windows_core::PCWSTR) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Initialize)(windows_core::Interface::as_raw(self), core::mem::transmute(pwzconnectoid)).ok() }
    }
...
impl IDialEngine {
    pub unsafe fn Initialize<P1>(&self, pwzconnectoid: windows_core::PCWSTR, pides: P1) -> windows_core::Result<()>
    where
        P1: windows_core::Param<IDialEventSink>,
    {
        unsafe { (windows_core::Interface::vtable(self).Initialize)(windows_core::Interface::as_raw(self), core::mem::transmute(pwzconnectoid), pides.param().abi()).ok() }
    }
    pub unsafe fn GetProperty(&self, pwzproperty: windows_core::PCWSTR, pwzvalue: windows_core::PCWSTR, dwbufsize: u32) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProperty)(windows_core::Interface::as_raw(self), core::mem::transmute(pwzproperty), core::mem::transmute(pwzvalue), dwbufsize).ok() }
    }
    pub unsafe fn SetProperty(&self, pwzproperty: windows_core::PCWSTR, pwzvalue: windows_core::PCWSTR) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetProperty)(windows_core::Interface::as_raw(self), core::mem::transmute(pwzproperty), core::mem::transmute(pwzvalue)).ok() }
    }
...
impl IProofOfPossessionCookieInfoManager {
    pub unsafe fn GetCookieInfoForUri(&self, uri: windows_core::PCWSTR, cookieinfocount: *mut u32, cookieinfo: *mut *mut ProofOfPossessionCookieInfo) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetCookieInfoForUri)(windows_core::Interface::as_raw(self), core::mem::transmute(uri), cookieinfocount as _, cookieinfo as _).ok() }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IProofOfPossessionCookieInfoManager2 {
    pub unsafe fn GetCookieInfoWithUriForAccount<P0>(&self, webaccount: P0, uri: windows_core::PCWSTR, cookieinfocount: *mut u32, cookieinfo: *mut *mut ProofOfPossessionCookieInfo) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::IInspectable>,
    {
        unsafe { (windows_core::Interface::vtable(self).GetCookieInfoWithUriForAccount)(windows_core::Interface::as_raw(self), webaccount.param().abi(), core::mem::transmute(uri), cookieinfocount as _, cookieinfo as _).ok() }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IProofOfPossessionCookieInfoManager3 {
    pub unsafe fn GetCookieInfoForUriWithOptions(&self, uri: windows_core::PCWSTR, options: u32, cookieinfocount: *mut u32, cookieinfo: *mut *mut ProofOfPossessionCookieInfo) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetCookieInfoForUriWithOptions)(windows_core::Interface::as_raw(self), core::mem::transmute(uri), options, cookieinfocount as _, cookieinfo as _).ok() }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IProofOfPossessionCookieInfoManager4 {
    pub unsafe fn GetCookieInfoForUriWithUserAgentId(&self, uri: windows_core::PCWSTR, uaclientid: windows_core::PCWSTR, cookieinfocount: *mut u32, cookieinfo: *mut *mut ProofOfPossessionCookieInfo) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetCookieInfoForUriWithUserAgentId)(windows_core::Interface::as_raw(self), core::mem::transmute(uri), core::mem::transmute(uaclientid), cookieinfocount as _, cookieinfo as _).ok() }
    }
    pub unsafe fn GetCookieInfoWithUriAndUserAgentIdForAccount<P0>(&self, webaccount: P0, uri: windows_core::PCWSTR, uaclientid: windows_core::PCWSTR, cookieinfocount: *mut u32, cookieinfo: *mut *mut ProofOfPossessionCookieInfo) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::IInspectable>,
    {
        unsafe { (windows_core::Interface::vtable(self).GetCookieInfoWithUriAndUserAgentIdForAccount)(windows_core::Interface::as_raw(self), webaccount.param().abi(), core::mem::transmute(uri), core::mem::transmute(uaclientid), cookieinfocount as _, cookieinfo as _).ok() }
    }
}
#[repr(C)]
#[doc(hidden)]
