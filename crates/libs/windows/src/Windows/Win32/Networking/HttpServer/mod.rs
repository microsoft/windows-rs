    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { HttpAddFragmentToCache(requestqueuehandle, urlprefix.param().abi(), datachunk, cachepolicy, core::mem::transmute(overlapped.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { HttpAddUrl(requestqueuehandle, fullyqualifiedurl.param().abi(), core::mem::transmute(reserved.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { HttpAddUrlToUrlGroup(urlgroupid, pfullyqualifiedurl.param().abi(), urlcontext, core::mem::transmute(reserved.unwrap_or(core::mem::zeroed()))) }
}
#[cfg(feature = "Win32_System_IO")]
#[inline]
pub unsafe fn HttpCancelHttpRequest(requestqueuehandle: super::super::Foundation::HANDLE, requestid: u64, overlapped: Option<*mut super::super::System::IO::OVERLAPPED>) -> u32 {
    ...
    unsafe { HttpCancelHttpRequest(requestqueuehandle, requestid, core::mem::transmute(overlapped.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
...
pub unsafe fn HttpCreateHttpHandle(requestqueuehandle: *mut super::super::Foundation::HANDLE, reserved: Option<u32>) -> u32 {
    ...
    unsafe { HttpCreateHttpHandle(core::mem::transmute(requestqueuehandle), core::mem::transmute(reserved.unwrap_or(core::mem::zeroed()))) }
}
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { HttpCreateRequestQueue(core::mem::transmute(version), name.param().abi(), core::mem::transmute(securityattributes.unwrap_or(core::mem::zeroed())), core::mem::transmute(flags.unwrap_or(core::mem::zeroed())), core::mem::transmute(requestqueuehandle)) }
}
#[inline]
pub unsafe fn HttpCreateServerSession(version: HTTPAPI_VERSION, serversessionid: *mut u64, reserved: Option<u32>) -> u32 {
    ...
    unsafe { HttpCreateServerSession(core::mem::transmute(version), core::mem::transmute(serversessionid), core::mem::transmute(reserved.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
pub unsafe fn HttpCreateUrlGroup(serversessionid: u64, purlgroupid: *mut u64, reserved: Option<u32>) -> u32 {
    ...
    unsafe { HttpCreateUrlGroup(serversessionid, core::mem::transmute(purlgroupid), core::mem::transmute(reserved.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
    ...
    P4: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { HttpDeclarePush(requestqueuehandle, requestid, verb, path.param().abi(), query.param().abi(), core::mem::transmute(headers.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
...
pub unsafe fn HttpDeleteServiceConfiguration(servicehandle: Option<super::super::Foundation::HANDLE>, configid: HTTP_SERVICE_CONFIG_ID, pconfiginformation: *const core::ffi::c_void, configinformationlength: u32, poverlapped: Option<*const super::super::System::IO::OVERLAPPED>) -> u32 {
    ...
    unsafe { HttpDeleteServiceConfiguration(core::mem::transmute(servicehandle.unwrap_or(core::mem::zeroed())), configid, pconfiginformation, configinformationlength, core::mem::transmute(poverlapped.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { HttpFindUrlGroupId(fullyqualifiedurl.param().abi(), requestqueuehandle, core::mem::transmute(urlgroupid)) }
}
#[cfg(feature = "Win32_System_IO")]
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { HttpFlushResponseCache(requestqueuehandle, urlprefix.param().abi(), flags, core::mem::transmute(overlapped.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
pub unsafe fn HttpGetExtension(version: HTTPAPI_VERSION, extension: u32, buffer: *mut core::ffi::c_void, buffersize: u32) -> u32 {
    ...
    unsafe { HttpGetExtension(core::mem::transmute(version), extension, core::mem::transmute(buffer), buffersize) }
}
#[inline]
pub unsafe fn HttpInitialize(version: HTTPAPI_VERSION, flags: HTTP_INITIALIZE, preserved: Option<*mut core::ffi::c_void>) -> u32 {
    ...
    unsafe { HttpInitialize(core::mem::transmute(version), flags, core::mem::transmute(preserved.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { HttpPrepareUrl(core::mem::transmute(reserved.unwrap_or(core::mem::zeroed())), core::mem::transmute(flags.unwrap_or(core::mem::zeroed())), url.param().abi(), core::mem::transmute(preparedurl)) }
}
#[inline]
...
pub unsafe fn HttpQueryServerSessionProperty(serversessionid: u64, property: HTTP_SERVER_PROPERTY, propertyinformation: Option<*mut core::ffi::c_void>, propertyinformationlength: u32, returnlength: Option<*mut u32>) -> u32 {
    ...
    unsafe { HttpQueryServerSessionProperty(serversessionid, property, core::mem::transmute(propertyinformation.unwrap_or(core::mem::zeroed())), propertyinformationlength, core::mem::transmute(returnlength.unwrap_or(core::mem::zeroed()))) }
}
#[cfg(feature = "Win32_System_IO")]
#[inline]
...
pub unsafe fn HttpQueryUrlGroupProperty(urlgroupid: u64, property: HTTP_SERVER_PROPERTY, propertyinformation: Option<*mut core::ffi::c_void>, propertyinformationlength: u32, returnlength: Option<*mut u32>) -> u32 {
    ...
    unsafe { HttpQueryUrlGroupProperty(urlgroupid, property, core::mem::transmute(propertyinformation.unwrap_or(core::mem::zeroed())), propertyinformationlength, core::mem::transmute(returnlength.unwrap_or(core::mem::zeroed()))) }
}
#[cfg(feature = "Win32_System_IO")]
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { HttpReadFragmentFromCache(requestqueuehandle, urlprefix.param().abi(), core::mem::transmute(byterange.unwrap_or(core::mem::zeroed())), core::mem::transmute(buffer), bufferlength, core::mem::transmute(bytesread.unwrap_or(core::mem::zeroed())), core::mem::transmute(overlapped.unwrap_or(core::mem::zeroed()))) }
}
#[cfg(feature = "Win32_System_IO")]
#[inline]
pub unsafe fn HttpReceiveClientCertificate(requestqueuehandle: super::super::Foundation::HANDLE, connectionid: u64, flags: u32, sslclientcertinfo: *mut HTTP_SSL_CLIENT_CERT_INFO, sslclientcertinfosize: u32, bytesreceived: Option<*mut u32>, overlapped: Option<*mut super::super::System::IO::OVERLAPPED>) -> u32 {
    ...
    unsafe { HttpReceiveClientCertificate(requestqueuehandle, connectionid, flags, core::mem::transmute(sslclientcertinfo), sslclientcertinfosize, core::mem::transmute(bytesreceived.unwrap_or(core::mem::zeroed())), core::mem::transmute(overlapped.unwrap_or(core::mem::zeroed()))) }
}
...
pub unsafe fn HttpReceiveHttpRequest(requestqueuehandle: super::super::Foundation::HANDLE, requestid: u64, flags: HTTP_RECEIVE_HTTP_REQUEST_FLAGS, requestbuffer: *mut HTTP_REQUEST_V2, requestbufferlength: u32, bytesreturned: Option<*mut u32>, overlapped: Option<*mut super::super::System::IO::OVERLAPPED>) -> u32 {
    ...
    unsafe { HttpReceiveHttpRequest(requestqueuehandle, requestid, flags, core::mem::transmute(requestbuffer), requestbufferlength, core::mem::transmute(bytesreturned.unwrap_or(core::mem::zeroed())), core::mem::transmute(overlapped.unwrap_or(core::mem::zeroed()))) }
}
#[cfg(feature = "Win32_System_IO")]
#[inline]
pub unsafe fn HttpReceiveRequestEntityBody(requestqueuehandle: super::super::Foundation::HANDLE, requestid: u64, flags: u32, entitybuffer: *mut core::ffi::c_void, entitybufferlength: u32, bytesreturned: Option<*mut u32>, overlapped: Option<*mut super::super::System::IO::OVERLAPPED>) -> u32 {
    ...
    unsafe { HttpReceiveRequestEntityBody(requestqueuehandle, requestid, flags, core::mem::transmute(entitybuffer), entitybufferlength, core::mem::transmute(bytesreturned.unwrap_or(core::mem::zeroed())), core::mem::transmute(overlapped.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
...
pub unsafe fn HttpSetRequestProperty(requestqueuehandle: super::super::Foundation::HANDLE, id: u64, propertyid: HTTP_REQUEST_PROPERTY, input: Option<*const core::ffi::c_void>, inputpropertysize: u32, overlapped: *const super::super::System::IO::OVERLAPPED) -> u32 {
    ...
    unsafe { HttpSetRequestProperty(requestqueuehandle, id, propertyid, core::mem::transmute(input.unwrap_or(core::mem::zeroed())), inputpropertysize, overlapped) }
}
#[inline]
pub unsafe fn HttpSetRequestQueueProperty(requestqueuehandle: super::super::Foundation::HANDLE, property: HTTP_SERVER_PROPERTY, propertyinformation: *const core::ffi::c_void, propertyinformationlength: u32, reserved1: Option<u32>, reserved2: Option<*const core::ffi::c_void>) -> u32 {
    ...
    unsafe { HttpSetRequestQueueProperty(requestqueuehandle, property, propertyinformation, propertyinformationlength, core::mem::transmute(reserved1.unwrap_or(core::mem::zeroed())), core::mem::transmute(reserved2.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
...
pub unsafe fn HttpSetServiceConfiguration(servicehandle: Option<super::super::Foundation::HANDLE>, configid: HTTP_SERVICE_CONFIG_ID, pconfiginformation: *const core::ffi::c_void, configinformationlength: u32, poverlapped: Option<*const super::super::System::IO::OVERLAPPED>) -> u32 {
    ...
    unsafe { HttpSetServiceConfiguration(core::mem::transmute(servicehandle.unwrap_or(core::mem::zeroed())), configid, pconfiginformation, configinformationlength, core::mem::transmute(poverlapped.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
...
pub unsafe fn HttpTerminate(flags: HTTP_INITIALIZE, preserved: Option<*mut core::ffi::c_void>) -> u32 {
    ...
    unsafe { HttpTerminate(flags, core::mem::transmute(preserved.unwrap_or(core::mem::zeroed()))) }
}
#[cfg(feature = "Win32_System_IO")]
#[inline]
pub unsafe fn HttpUpdateServiceConfiguration(handle: Option<super::super::Foundation::HANDLE>, configid: HTTP_SERVICE_CONFIG_ID, configinfo: *const core::ffi::c_void, configinfolength: u32, overlapped: Option<*const super::super::System::IO::OVERLAPPED>) -> u32 {
    ...
    unsafe { HttpUpdateServiceConfiguration(core::mem::transmute(handle.unwrap_or(core::mem::zeroed())), configid, configinfo, configinfolength, core::mem::transmute(overlapped.unwrap_or(core::mem::zeroed()))) }
}
#[cfg(feature = "Win32_System_IO")]
#[inline]
pub unsafe fn HttpWaitForDemandStart(requestqueuehandle: super::super::Foundation::HANDLE, overlapped: Option<*mut super::super::System::IO::OVERLAPPED>) -> u32 {
    ...
    unsafe { HttpWaitForDemandStart(requestqueuehandle, core::mem::transmute(overlapped.unwrap_or(core::mem::zeroed()))) }
}
#[cfg(feature = "Win32_System_IO")]
#[inline]
pub unsafe fn HttpWaitForDisconnect(requestqueuehandle: super::super::Foundation::HANDLE, connectionid: u64, overlapped: Option<*mut super::super::System::IO::OVERLAPPED>) -> u32 {
    ...
    unsafe { HttpWaitForDisconnect(requestqueuehandle, connectionid, core::mem::transmute(overlapped.unwrap_or(core::mem::zeroed()))) }
}
#[cfg(feature = "Win32_System_IO")]
#[inline]
pub unsafe fn HttpWaitForDisconnectEx(requestqueuehandle: super::super::Foundation::HANDLE, connectionid: u64, reserved: Option<u32>, overlapped: Option<*mut super::super::System::IO::OVERLAPPED>) -> u32 {
    ...
    unsafe { HttpWaitForDisconnectEx(requestqueuehandle, connectionid, core::mem::transmute(reserved.unwrap_or(core::mem::zeroed())), core::mem::transmute(overlapped.unwrap_or(core::mem::zeroed()))) }
}
