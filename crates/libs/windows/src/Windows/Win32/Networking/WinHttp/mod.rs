    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { WinHttpConnect(hsession as _, core::mem::transmute_copy(&pswzservername.param().borrow()), nserverport, dwreserved) }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { WinHttpGetProxyForUrl(hsession as _, core::mem::transmute_copy(&lpcwszurl.param().borrow()), pautoproxyoptions as _, pproxyinfo as _).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { WinHttpGetProxyForUrlEx(hresolver, core::mem::transmute_copy(&pcwszurl.param().borrow()), pautoproxyoptions, pcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { WinHttpGetProxyForUrlEx2(hresolver, core::mem::transmute_copy(&pcwszurl.param().borrow()), pautoproxyoptions, pinterfaceselectioncontext.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), core::mem::transmute(pinterfaceselectioncontext.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pcontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { WinHttpOpen(core::mem::transmute_copy(&pszagentw.param().borrow()), dwaccesstype, core::mem::transmute_copy(&pszproxyw.param().borrow()), core::mem::transmute_copy(&pszproxybypassw.param().borrow()), dwflags) }
}
#[inline]
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { WinHttpOpenRequest(hconnect as _, core::mem::transmute_copy(&pwszverb.param().borrow()), core::mem::transmute_copy(&pwszobjectname.param().borrow()), core::mem::transmute_copy(&pwszversion.param().borrow()), core::mem::transmute_copy(&pwszreferrer.param().borrow()), ppwszaccepttypes, dwflags) }
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { WinHttpQueryHeaders(hrequest as _, dwinfolevel, core::mem::transmute_copy(&pwszname.param().borrow()), lpbuffer.unwrap_or(core::mem::zeroed()) as _, lpdwbufferlength as _, lpdwindex as _).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { WinHttpReadProxySettings(hsession, core::mem::transmute_copy(&pcwszconnectionname.param().borrow()), ffallbacktodefaultsettings.into(), fsetautodiscoverfordefaultsettings.into(), pdwsettingsversion as _, pfdefaultsettingsarereturned as _, pwinhttpproxysettings as _) }
}
#[inline]
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { WinHttpSetCredentials(hrequest as _, authtargets, authscheme, core::mem::transmute_copy(&pwszusername.param().borrow()), core::mem::transmute_copy(&pwszpassword.param().borrow()), pauthparams as _).ok() }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { WinHttpTimeToSystemTime(core::mem::transmute_copy(&pwsztime.param().borrow()), pst as _).ok() }
}
#[inline]
