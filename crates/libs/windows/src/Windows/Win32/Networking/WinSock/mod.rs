...
pub unsafe fn WSCGetApplicationCategory(path: &[u16], extra: Option<&[u16]>, ppermittedlspcategories: *mut u32, lperrno: *mut i32) -> i32 {
    ...
    unsafe { WSCGetApplicationCategory(core::mem::transmute(path.as_ptr()), path.len().try_into().unwrap(), core::mem::transmute(extra.map_or(core::ptr::null(), |slice| slice.as_ptr())), extra.map_or(0, |slice| slice.len().try_into().unwrap()), ppermittedlspcategories as _, lperrno as _) }
}
#[inline]
...
pub unsafe fn WSCSetApplicationCategory(path: &[u16], extra: Option<&[u16]>, permittedlspcategories: u32, pprevpermlspcat: Option<*mut u32>, lperrno: *mut i32) -> i32 {
    ...
    unsafe { WSCSetApplicationCategory(core::mem::transmute(path.as_ptr()), path.len().try_into().unwrap(), core::mem::transmute(extra.map_or(core::ptr::null(), |slice| slice.as_ptr())), extra.map_or(0, |slice| slice.len().try_into().unwrap()), permittedlspcategories, pprevpermlspcat.unwrap_or(core::mem::zeroed()) as _, lperrno as _) }
}
#[inline]
...
pub const AALTYPE_5: AAL_TYPE = AAL_TYPE(5);
pub const AALTYPE_USER: AAL_TYPE = AAL_TYPE(16);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const AF_12844: u16 = 25;
pub const AF_APPLETALK: u16 = 16;
pub const AF_ATM: u16 = 22;
pub const AF_BAN: u16 = 21;
pub const AF_CCITT: u16 = 10;
pub const AF_CHAOS: u16 = 5;
pub const AF_CLUSTER: u16 = 24;
pub const AF_DATAKIT: u16 = 9;
pub const AF_DECnet: u16 = 12;
pub const AF_DLI: u16 = 13;
pub const AF_ECMA: u16 = 8;
pub const AF_FIREFOX: u16 = 19;
pub const AF_HYLINK: u16 = 15;
pub const AF_HYPERV: u16 = 34;
pub const AF_ICLFXBM: u16 = 31;
pub const AF_IMPLINK: u16 = 3;
pub const AF_INET: ADDRESS_FAMILY = ADDRESS_FAMILY(2);
pub const AF_INET6: ADDRESS_FAMILY = ADDRESS_FAMILY(23);
pub const AF_IPX: u16 = 6;
pub const AF_IRDA: u16 = 26;
pub const AF_ISO: u16 = 7;
pub const AF_LAT: u16 = 14;
pub const AF_LINK: u16 = 33;
pub const AF_MAX: u16 = 29;
pub const AF_NETBIOS: u16 = 17;
pub const AF_NETDES: u16 = 28;
pub const AF_NS: u16 = 6;
pub const AF_OSI: u16 = 7;
pub const AF_PUP: u16 = 4;
pub const AF_SNA: u16 = 11;
pub const AF_TCNMESSAGE: u16 = 30;
pub const AF_TCNPROCESS: u16 = 29;
pub const AF_UNIX: u16 = 1;
pub const AF_UNKNOWN1: u16 = 20;
pub const AF_UNSPEC: ADDRESS_FAMILY = ADDRESS_FAMILY(0);
pub const AF_VOICEVIEW: u16 = 18;
...
pub const AI_EXTRA_DNSSEC_REQUIRED: u64 = 1;
...
pub const ARP_HW_802: ARP_HARDWARE_TYPE = ARP_HARDWARE_TYPE(6);
pub const ARP_HW_ENET: ARP_HARDWARE_TYPE = ARP_HARDWARE_TYPE(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct ARP_OPCODE(pub i32);
pub const ARP_REQUEST: ARP_OPCODE = ARP_OPCODE(1);
pub const ARP_RESPONSE: ARP_OPCODE = ARP_OPCODE(2);
...
pub const COMP_EQUAL: WSAECOMPARATOR = WSAECOMPARATOR(0);
pub const COMP_NOTLESS: WSAECOMPARATOR = WSAECOMPARATOR(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct CONTROL_CHANNEL_TRIGGER_STATUS(pub i32);
pub const CONTROL_CHANNEL_TRIGGER_STATUS_HARDWARE_SLOT_ALLOCATED: CONTROL_CHANNEL_TRIGGER_STATUS = CONTROL_CHANNEL_TRIGGER_STATUS(2);
pub const CONTROL_CHANNEL_TRIGGER_STATUS_INVALID: CONTROL_CHANNEL_TRIGGER_STATUS = CONTROL_CHANNEL_TRIGGER_STATUS(0);
pub const CONTROL_CHANNEL_TRIGGER_STATUS_POLICY_ERROR: CONTROL_CHANNEL_TRIGGER_STATUS = CONTROL_CHANNEL_TRIGGER_STATUS(3);
pub const CONTROL_CHANNEL_TRIGGER_STATUS_SERVICE_UNAVAILABLE: CONTROL_CHANNEL_TRIGGER_STATUS = CONTROL_CHANNEL_TRIGGER_STATUS(6);
pub const CONTROL_CHANNEL_TRIGGER_STATUS_SOFTWARE_SLOT_ALLOCATED: CONTROL_CHANNEL_TRIGGER_STATUS = CONTROL_CHANNEL_TRIGGER_STATUS(1);
pub const CONTROL_CHANNEL_TRIGGER_STATUS_SYSTEM_ERROR: CONTROL_CHANNEL_TRIGGER_STATUS = CONTROL_CHANNEL_TRIGGER_STATUS(4);
pub const CONTROL_CHANNEL_TRIGGER_STATUS_TRANSPORT_DISCONNECTED: CONTROL_CHANNEL_TRIGGER_STATUS = CONTROL_CHANNEL_TRIGGER_STATUS(5);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const DL_ADDRESS_LENGTH_MAXIMUM: u32 = 32;
#[repr(C)]
#[derive(Clone, Copy)]
pub union DL_EI48 {
    pub Byte: [u8; 3],
...
pub const ETHERNET_TYPE_802_1AD: u32 = 34984;
...
pub const E_WINDOW_ADVANCE_BY_TIME: eWINDOW_ADVANCE_METHOD = eWINDOW_ADVANCE_METHOD(1);
pub const E_WINDOW_USE_AS_DATA_CACHE: eWINDOW_ADVANCE_METHOD = eWINDOW_ADVANCE_METHOD(2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const FallbackIndexMax: FALLBACK_INDEX = FALLBACK_INDEX(1);
pub const FallbackIndexTcpFastopen: FALLBACK_INDEX = FALLBACK_INDEX(0);
...
pub const ICMP4_TIME_EXCEED_REASSEMBLY: ICMP4_TIME_EXCEED_CODE = ICMP4_TIME_EXCEED_CODE(1);
pub const ICMP4_TIME_EXCEED_TRANSIT: ICMP4_TIME_EXCEED_CODE = ICMP4_TIME_EXCEED_CODE(0);
pub const ICMP4_UNREACH_ADMIN: ICMP4_UNREACH_CODE = ICMP4_UNREACH_CODE(13);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct ICMP4_UNREACH_CODE(pub i32);
pub const ICMP4_UNREACH_FRAG_NEEDED: ICMP4_UNREACH_CODE = ICMP4_UNREACH_CODE(4);
pub const ICMP4_UNREACH_HOST: ICMP4_UNREACH_CODE = ICMP4_UNREACH_CODE(1);
pub const ICMP4_UNREACH_HOST_ADMIN: ICMP4_UNREACH_CODE = ICMP4_UNREACH_CODE(10);
pub const ICMP4_UNREACH_HOST_TOS: ICMP4_UNREACH_CODE = ICMP4_UNREACH_CODE(12);
pub const ICMP4_UNREACH_HOST_UNKNOWN: ICMP4_UNREACH_CODE = ICMP4_UNREACH_CODE(7);
pub const ICMP4_UNREACH_ISOLATED: ICMP4_UNREACH_CODE = ICMP4_UNREACH_CODE(8);
pub const ICMP4_UNREACH_NET: ICMP4_UNREACH_CODE = ICMP4_UNREACH_CODE(0);
pub const ICMP4_UNREACH_NET_ADMIN: ICMP4_UNREACH_CODE = ICMP4_UNREACH_CODE(9);
pub const ICMP4_UNREACH_NET_TOS: ICMP4_UNREACH_CODE = ICMP4_UNREACH_CODE(11);
pub const ICMP4_UNREACH_NET_UNKNOWN: ICMP4_UNREACH_CODE = ICMP4_UNREACH_CODE(6);
pub const ICMP4_UNREACH_PORT: ICMP4_UNREACH_CODE = ICMP4_UNREACH_CODE(3);
pub const ICMP4_UNREACH_PROTOCOL: ICMP4_UNREACH_CODE = ICMP4_UNREACH_CODE(2);
pub const ICMP4_UNREACH_SOURCEROUTE_FAILED: ICMP4_UNREACH_CODE = ICMP4_UNREACH_CODE(5);
...
pub const ICMP6_PARAMPROB_FIRSTFRAGMENT: u32 = 3;
...
pub const IE_AALParameters: Q2931_IE_TYPE = Q2931_IE_TYPE(0);
pub const IE_BHLI: Q2931_IE_TYPE = Q2931_IE_TYPE(3);
pub const IE_BLLI: Q2931_IE_TYPE = Q2931_IE_TYPE(4);
pub const IE_BroadbandBearerCapability: Q2931_IE_TYPE = Q2931_IE_TYPE(2);
pub const IE_CalledPartyNumber: Q2931_IE_TYPE = Q2931_IE_TYPE(5);
pub const IE_CalledPartySubaddress: Q2931_IE_TYPE = Q2931_IE_TYPE(6);
pub const IE_CallingPartyNumber: Q2931_IE_TYPE = Q2931_IE_TYPE(7);
pub const IE_CallingPartySubaddress: Q2931_IE_TYPE = Q2931_IE_TYPE(8);
pub const IE_Cause: Q2931_IE_TYPE = Q2931_IE_TYPE(9);
pub const IE_QOSClass: Q2931_IE_TYPE = Q2931_IE_TYPE(10);
pub const IE_TrafficDescriptor: Q2931_IE_TYPE = Q2931_IE_TYPE(1);
pub const IE_TransitNetworkSelection: Q2931_IE_TYPE = Q2931_IE_TYPE(11);
...
pub const IGMP_MAX_RESP_CODE_TYPE_FLOAT: IGMP_MAX_RESP_CODE_TYPE = IGMP_MAX_RESP_CODE_TYPE(1);
pub const IGMP_MAX_RESP_CODE_TYPE_NORMAL: IGMP_MAX_RESP_CODE_TYPE = IGMP_MAX_RESP_CODE_TYPE(0);
...
pub const INVALID_SOCKET: SOCKET = SOCKET(-1 as _);
#[repr(C)]
#[derive(Clone, Copy)]
pub struct IN_ADDR {
    pub S_un: IN_ADDR_0,
...
pub const IP6OPT_JUMBO: IPV6_OPTION_TYPE = IPV6_OPTION_TYPE(194);
pub const IP6OPT_MUTABLE: u32 = 32;
pub const IP6OPT_NSAP_ADDR: IPV6_OPTION_TYPE = IPV6_OPTION_TYPE(195);
pub const IP6OPT_PAD1: IPV6_OPTION_TYPE = IPV6_OPTION_TYPE(0);
pub const IP6OPT_PADN: IPV6_OPTION_TYPE = IPV6_OPTION_TYPE(1);
pub const IP6OPT_ROUTER_ALERT: IPV6_OPTION_TYPE = IPV6_OPTION_TYPE(5);
pub const IP6OPT_TUNNEL_LIMIT: IPV6_OPTION_TYPE = IPV6_OPTION_TYPE(4);
...
pub const IPPROTO_AH: IPPROTO = IPPROTO(51);
pub const IPPROTO_CBT: IPPROTO = IPPROTO(7);
pub const IPPROTO_DSTOPTS: IPPROTO = IPPROTO(60);
pub const IPPROTO_EGP: IPPROTO = IPPROTO(8);
pub const IPPROTO_ESP: IPPROTO = IPPROTO(50);
pub const IPPROTO_FRAGMENT: IPPROTO = IPPROTO(44);
pub const IPPROTO_GGP: IPPROTO = IPPROTO(3);
pub const IPPROTO_HOPOPTS: IPPROTO = IPPROTO(0);
pub const IPPROTO_ICLFXBM: IPPROTO = IPPROTO(78);
pub const IPPROTO_ICMP: IPPROTO = IPPROTO(1);
pub const IPPROTO_ICMPV6: IPPROTO = IPPROTO(58);
pub const IPPROTO_IDP: IPPROTO = IPPROTO(22);
pub const IPPROTO_IGMP: IPPROTO = IPPROTO(2);
pub const IPPROTO_IGP: IPPROTO = IPPROTO(9);
pub const IPPROTO_IP: IPPROTO = IPPROTO(0);
pub const IPPROTO_IPV4: IPPROTO = IPPROTO(4);
pub const IPPROTO_IPV6: IPPROTO = IPPROTO(41);
pub const IPPROTO_L2TP: IPPROTO = IPPROTO(115);
pub const IPPROTO_MAX: IPPROTO = IPPROTO(256);
pub const IPPROTO_ND: IPPROTO = IPPROTO(77);
pub const IPPROTO_NONE: IPPROTO = IPPROTO(59);
pub const IPPROTO_PGM: IPPROTO = IPPROTO(113);
pub const IPPROTO_PIM: IPPROTO = IPPROTO(103);
pub const IPPROTO_PUP: IPPROTO = IPPROTO(12);
pub const IPPROTO_RAW: IPPROTO = IPPROTO(255);
pub const IPPROTO_RDP: IPPROTO = IPPROTO(27);
pub const IPPROTO_RESERVED_IPSEC: IPPROTO = IPPROTO(258);
pub const IPPROTO_RESERVED_IPSECOFFLOAD: IPPROTO = IPPROTO(259);
pub const IPPROTO_RESERVED_MAX: IPPROTO = IPPROTO(261);
pub const IPPROTO_RESERVED_RAW: IPPROTO = IPPROTO(257);
pub const IPPROTO_RESERVED_WNV: IPPROTO = IPPROTO(260);
pub const IPPROTO_RM: IPPROTO = IPPROTO(113);
pub const IPPROTO_ROUTING: IPPROTO = IPPROTO(43);
pub const IPPROTO_SCTP: IPPROTO = IPPROTO(132);
pub const IPPROTO_ST: IPPROTO = IPPROTO(5);
pub const IPPROTO_TCP: IPPROTO = IPPROTO(6);
pub const IPPROTO_UDP: IPPROTO = IPPROTO(17);
#[repr(C, packed(1))]
#[derive(Clone, Copy, Default)]
...
pub const IPV4_MAX_MINIMUM_MTU: u32 = 576;
...
pub const IPX_ADDRESS_NOTIFY: i32 = 16396;
pub const IPX_DSTYPE: i32 = 16386;
pub const IPX_EXTENDED_ADDRESS: i32 = 16388;
pub const IPX_FILTERPTYPE: i32 = 16385;
pub const IPX_GETNETINFO: i32 = 16392;
pub const IPX_GETNETINFO_NORIP: i32 = 16393;
pub const IPX_IMMEDIATESPXACK: i32 = 16400;
...
pub const IPX_PTYPE: i32 = 16384;
pub const IPX_RECEIVE_BROADCAST: i32 = 16399;
...
pub const IPX_SPXGETCONNECTIONSTATUS: i32 = 16395;
pub const IPX_STOPFILTERPTYPE: i32 = 16387;
...
pub const IP_OPTION_TIMESTAMP_ADDRESS: IP_OPTION_TIMESTAMP_FLAGS = IP_OPTION_TIMESTAMP_FLAGS(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct IP_OPTION_TIMESTAMP_FLAGS(pub i32);
pub const IP_OPTION_TIMESTAMP_ONLY: IP_OPTION_TIMESTAMP_FLAGS = IP_OPTION_TIMESTAMP_FLAGS(0);
pub const IP_OPTION_TIMESTAMP_SPECIFIC_ADDRESS: IP_OPTION_TIMESTAMP_FLAGS = IP_OPTION_TIMESTAMP_FLAGS(3);
pub const IP_OPT_EOL: IPV4_OPTION_TYPE = IPV4_OPTION_TYPE(0);
pub const IP_OPT_LSRR: IPV4_OPTION_TYPE = IPV4_OPTION_TYPE(131);
pub const IP_OPT_MULTIDEST: IPV4_OPTION_TYPE = IPV4_OPTION_TYPE(149);
pub const IP_OPT_NOP: IPV4_OPTION_TYPE = IPV4_OPTION_TYPE(1);
pub const IP_OPT_ROUTER_ALERT: IPV4_OPTION_TYPE = IPV4_OPTION_TYPE(148);
pub const IP_OPT_RR: IPV4_OPTION_TYPE = IPV4_OPTION_TYPE(7);
pub const IP_OPT_SECURITY: IPV4_OPTION_TYPE = IPV4_OPTION_TYPE(130);
pub const IP_OPT_SID: IPV4_OPTION_TYPE = IPV4_OPTION_TYPE(136);
pub const IP_OPT_SSRR: IPV4_OPTION_TYPE = IPV4_OPTION_TYPE(137);
pub const IP_OPT_TS: IPV4_OPTION_TYPE = IPV4_OPTION_TYPE(68);
pub const IP_ORIGINAL_ARRIVAL_IF: i32 = 47;
pub const IP_PKTINFO: i32 = 19;
pub const IP_PKTINFO_EX: i32 = 51;
pub const IP_PMTUDISC_DO: PMTUD_STATE = PMTUD_STATE(1);
pub const IP_PMTUDISC_DONT: PMTUD_STATE = PMTUD_STATE(2);
pub const IP_PMTUDISC_MAX: PMTUD_STATE = PMTUD_STATE(4);
pub const IP_PMTUDISC_NOT_SET: PMTUD_STATE = PMTUD_STATE(0);
pub const IP_PMTUDISC_PROBE: PMTUD_STATE = PMTUD_STATE(3);
...
pub const IP_UNSPECIFIED_USER_MTU: u32 = 4294967295;
...
pub const IRLMP_9WIRE_MODE: i32 = 22;
pub const IRLMP_DISCOVERY_MODE: i32 = 25;
pub const IRLMP_ENUMDEVICES: i32 = 16;
pub const IRLMP_EXCLUSIVE_MODE: i32 = 20;
pub const IRLMP_IAS_QUERY: i32 = 18;
pub const IRLMP_IAS_SET: i32 = 17;
pub const IRLMP_IRLPT_MODE: i32 = 21;
pub const IRLMP_PARAMETERS: i32 = 24;
pub const IRLMP_SEND_PDU_LEN: i32 = 19;
pub const IRLMP_SHARP_MODE: i32 = 32;
pub const IRLMP_TINYTP_MODE: i32 = 23;
pub const ISOPROTO_CLNP: u32 = 31;
pub const ISOPROTO_CLTP: u32 = 30;
pub const ISOPROTO_ESIS: u32 = 34;
pub const ISOPROTO_INACT_NL: u32 = 33;
pub const ISOPROTO_INTRAISIS: u32 = 35;
pub const ISOPROTO_TP: u32 = 29;
pub const ISOPROTO_TP0: u32 = 25;
pub const ISOPROTO_TP1: u32 = 26;
pub const ISOPROTO_TP2: u32 = 27;
pub const ISOPROTO_TP3: u32 = 28;
pub const ISOPROTO_TP4: u32 = 29;
pub const ISOPROTO_X25: u32 = 32;
pub const ISO_EXP_DATA_NUSE: u32 = 1;
pub const ISO_EXP_DATA_USE: u32 = 0;
pub const ISO_HIERARCHICAL: u32 = 0;
pub const ISO_MAX_ADDR_LENGTH: u32 = 64;
pub const ISO_NON_HIERARCHICAL: u32 = 1;
pub const IpDadStateDeprecated: NL_DAD_STATE = NL_DAD_STATE(3);
pub const IpDadStateDuplicate: NL_DAD_STATE = NL_DAD_STATE(2);
pub const IpDadStateInvalid: NL_DAD_STATE = NL_DAD_STATE(0);
pub const IpDadStatePreferred: NL_DAD_STATE = NL_DAD_STATE(4);
pub const IpDadStateTentative: NL_DAD_STATE = NL_DAD_STATE(1);
pub const IpPrefixOriginDhcp: NL_PREFIX_ORIGIN = NL_PREFIX_ORIGIN(3);
pub const IpPrefixOriginManual: NL_PREFIX_ORIGIN = NL_PREFIX_ORIGIN(1);
pub const IpPrefixOriginOther: NL_PREFIX_ORIGIN = NL_PREFIX_ORIGIN(0);
pub const IpPrefixOriginRouterAdvertisement: NL_PREFIX_ORIGIN = NL_PREFIX_ORIGIN(4);
pub const IpPrefixOriginUnchanged: NL_PREFIX_ORIGIN = NL_PREFIX_ORIGIN(16);
pub const IpPrefixOriginWellKnown: NL_PREFIX_ORIGIN = NL_PREFIX_ORIGIN(2);
pub const IpSuffixOriginDhcp: NL_SUFFIX_ORIGIN = NL_SUFFIX_ORIGIN(3);
pub const IpSuffixOriginLinkLayerAddress: NL_SUFFIX_ORIGIN = NL_SUFFIX_ORIGIN(4);
pub const IpSuffixOriginManual: NL_SUFFIX_ORIGIN = NL_SUFFIX_ORIGIN(1);
pub const IpSuffixOriginOther: NL_SUFFIX_ORIGIN = NL_SUFFIX_ORIGIN(0);
pub const IpSuffixOriginRandom: NL_SUFFIX_ORIGIN = NL_SUFFIX_ORIGIN(5);
pub const IpSuffixOriginUnchanged: NL_SUFFIX_ORIGIN = NL_SUFFIX_ORIGIN(16);
pub const IpSuffixOriginWellKnown: NL_SUFFIX_ORIGIN = NL_SUFFIX_ORIGIN(2);
...
pub const LinkLocalAlwaysOff: NL_LINK_LOCAL_ADDRESS_BEHAVIOR = NL_LINK_LOCAL_ADDRESS_BEHAVIOR(0);
pub const LinkLocalAlwaysOn: NL_LINK_LOCAL_ADDRESS_BEHAVIOR = NL_LINK_LOCAL_ADDRESS_BEHAVIOR(2);
pub const LinkLocalDelayed: NL_LINK_LOCAL_ADDRESS_BEHAVIOR = NL_LINK_LOCAL_ADDRESS_BEHAVIOR(1);
pub const LinkLocalUnchanged: NL_LINK_LOCAL_ADDRESS_BEHAVIOR = NL_LINK_LOCAL_ADDRESS_BEHAVIOR(-1);
...
pub const MCAST_EXCLUDE: MULTICAST_MODE_TYPE = MULTICAST_MODE_TYPE(1);
pub const MCAST_INCLUDE: MULTICAST_MODE_TYPE = MULTICAST_MODE_TYPE(0);
...
pub const MIB_IPPROTO_BBN: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(12);
pub const MIB_IPPROTO_BGP: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(14);
pub const MIB_IPPROTO_CISCO: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(11);
pub const MIB_IPPROTO_DHCP: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(19);
pub const MIB_IPPROTO_DVMRP: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(17);
pub const MIB_IPPROTO_EGP: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(5);
pub const MIB_IPPROTO_EIGRP: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(16);
pub const MIB_IPPROTO_ES_IS: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(10);
pub const MIB_IPPROTO_GGP: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(6);
pub const MIB_IPPROTO_HELLO: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(7);
pub const MIB_IPPROTO_ICMP: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(4);
pub const MIB_IPPROTO_IDPR: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(15);
pub const MIB_IPPROTO_IS_IS: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(9);
pub const MIB_IPPROTO_LOCAL: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(2);
pub const MIB_IPPROTO_NETMGMT: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(3);
pub const MIB_IPPROTO_NT_AUTOSTATIC: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(10002);
pub const MIB_IPPROTO_NT_STATIC: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(10006);
pub const MIB_IPPROTO_NT_STATIC_NON_DOD: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(10007);
pub const MIB_IPPROTO_OSPF: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(13);
pub const MIB_IPPROTO_OTHER: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(1);
pub const MIB_IPPROTO_RIP: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(8);
pub const MIB_IPPROTO_RPL: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(18);
pub const MIT_GUID: NPI_MODULEID_TYPE = NPI_MODULEID_TYPE(1);
pub const MIT_IF_LUID: NPI_MODULEID_TYPE = NPI_MODULEID_TYPE(2);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const MLD_MAX_RESP_CODE_TYPE_FLOAT: MLD_MAX_RESP_CODE_TYPE = MLD_MAX_RESP_CODE_TYPE(1);
pub const MLD_MAX_RESP_CODE_TYPE_NORMAL: MLD_MAX_RESP_CODE_TYPE = MLD_MAX_RESP_CODE_TYPE(0);
pub const MSG_BCAST: u32 = 1024;
pub const MSG_CTRUNC: u32 = 512;
pub const MSG_DONTROUTE: SEND_RECV_FLAGS = SEND_RECV_FLAGS(4);
pub const MSG_ERRQUEUE: u32 = 4096;
pub const MSG_INTERRUPT: u32 = 16;
pub const MSG_MAXIOVLEN: u32 = 16;
pub const MSG_MCAST: u32 = 2048;
pub const MSG_OOB: SEND_RECV_FLAGS = SEND_RECV_FLAGS(1);
pub const MSG_PARTIAL: u32 = 32768;
pub const MSG_PEEK: SEND_RECV_FLAGS = SEND_RECV_FLAGS(2);
pub const MSG_PUSH_IMMEDIATE: SEND_RECV_FLAGS = SEND_RECV_FLAGS(32);
pub const MSG_TRUNC: u32 = 256;
pub const MSG_WAITALL: SEND_RECV_FLAGS = SEND_RECV_FLAGS(8);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const ND_OPT_ADVERTISEMENT_INTERVAL: ND_OPTION_TYPE = ND_OPTION_TYPE(7);
pub const ND_OPT_DNSSL: ND_OPTION_TYPE = ND_OPTION_TYPE(31);
pub const ND_OPT_DNSSL_MIN_LEN: u32 = 16;
pub const ND_OPT_HOME_AGENT_INFORMATION: ND_OPTION_TYPE = ND_OPTION_TYPE(8);
pub const ND_OPT_MTU: ND_OPTION_TYPE = ND_OPTION_TYPE(5);
pub const ND_OPT_NBMA_SHORTCUT_LIMIT: ND_OPTION_TYPE = ND_OPTION_TYPE(6);
...
pub const ND_OPT_PREF64: ND_OPTION_TYPE = ND_OPTION_TYPE(38);
pub const ND_OPT_PREF64_PREFIX_LENGTH_32: ND_OPT_PREF64_PREFIX_LENGTH_CODE = ND_OPT_PREF64_PREFIX_LENGTH_CODE(5);
pub const ND_OPT_PREF64_PREFIX_LENGTH_40: ND_OPT_PREF64_PREFIX_LENGTH_CODE = ND_OPT_PREF64_PREFIX_LENGTH_CODE(4);
pub const ND_OPT_PREF64_PREFIX_LENGTH_48: ND_OPT_PREF64_PREFIX_LENGTH_CODE = ND_OPT_PREF64_PREFIX_LENGTH_CODE(3);
pub const ND_OPT_PREF64_PREFIX_LENGTH_56: ND_OPT_PREF64_PREFIX_LENGTH_CODE = ND_OPT_PREF64_PREFIX_LENGTH_CODE(2);
pub const ND_OPT_PREF64_PREFIX_LENGTH_64: ND_OPT_PREF64_PREFIX_LENGTH_CODE = ND_OPT_PREF64_PREFIX_LENGTH_CODE(1);
pub const ND_OPT_PREF64_PREFIX_LENGTH_96: ND_OPT_PREF64_PREFIX_LENGTH_CODE = ND_OPT_PREF64_PREFIX_LENGTH_CODE(0);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct ND_OPT_PREF64_PREFIX_LENGTH_CODE(pub i32);
pub const ND_OPT_PREFIX_INFORMATION: ND_OPTION_TYPE = ND_OPTION_TYPE(3);
pub const ND_OPT_RDNSS: ND_OPTION_TYPE = ND_OPTION_TYPE(25);
pub const ND_OPT_RDNSS_MIN_LEN: u32 = 24;
pub const ND_OPT_REDIRECTED_HEADER: ND_OPTION_TYPE = ND_OPTION_TYPE(4);
pub const ND_OPT_RI_FLAG_PREFERENCE: u32 = 24;
pub const ND_OPT_ROUTE_INFO: ND_OPTION_TYPE = ND_OPTION_TYPE(24);
pub const ND_OPT_SOURCE_ADDR_LIST: ND_OPTION_TYPE = ND_OPTION_TYPE(9);
pub const ND_OPT_SOURCE_LINKADDR: ND_OPTION_TYPE = ND_OPTION_TYPE(1);
pub const ND_OPT_TARGET_ADDR_LIST: ND_OPTION_TYPE = ND_OPTION_TYPE(10);
pub const ND_OPT_TARGET_LINKADDR: ND_OPTION_TYPE = ND_OPTION_TYPE(2);
...
pub const NETBIOS_GROUP_NAME: u32 = 1;
pub const NETBIOS_NAME_LENGTH: u32 = 16;
pub const NETBIOS_TYPE_QUICK_GROUP: u32 = 3;
...
pub const NLA_802_1X_LOCATION: NLA_BLOB_DATA_TYPE = NLA_BLOB_DATA_TYPE(2);
...
pub const NLA_CONNECTIVITY: NLA_BLOB_DATA_TYPE = NLA_BLOB_DATA_TYPE(3);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NLA_CONNECTIVITY_TYPE(pub i32);
pub const NLA_FRIENDLY_NAME: u32 = 2;
pub const NLA_ICS: NLA_BLOB_DATA_TYPE = NLA_BLOB_DATA_TYPE(4);
pub const NLA_INTERFACE: NLA_BLOB_DATA_TYPE = NLA_BLOB_DATA_TYPE(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NLA_INTERNET(pub i32);
pub const NLA_INTERNET_NO: NLA_INTERNET = NLA_INTERNET(1);
pub const NLA_INTERNET_UNKNOWN: NLA_INTERNET = NLA_INTERNET(0);
pub const NLA_INTERNET_YES: NLA_INTERNET = NLA_INTERNET(2);
pub const NLA_NAMESPACE_GUID: windows_core::GUID = windows_core::GUID::from_u128(0x6642243a_3ba8_4aa6_baa5_2e0bd71fdd83);
pub const NLA_NETWORK_AD_HOC: NLA_CONNECTIVITY_TYPE = NLA_CONNECTIVITY_TYPE(0);
pub const NLA_NETWORK_MANAGED: NLA_CONNECTIVITY_TYPE = NLA_CONNECTIVITY_TYPE(1);
pub const NLA_NETWORK_UNKNOWN: NLA_CONNECTIVITY_TYPE = NLA_CONNECTIVITY_TYPE(3);
pub const NLA_NETWORK_UNMANAGED: NLA_CONNECTIVITY_TYPE = NLA_CONNECTIVITY_TYPE(2);
pub const NLA_RAW_DATA: NLA_BLOB_DATA_TYPE = NLA_BLOB_DATA_TYPE(0);
...
pub const NSPROTO_IPX: u32 = 1000;
pub const NSPROTO_SPX: u32 = 1256;
...
pub const NSP_NOTIFY_APC: WSACOMPLETIONTYPE = WSACOMPLETIONTYPE(4);
pub const NSP_NOTIFY_EVENT: WSACOMPLETIONTYPE = WSACOMPLETIONTYPE(2);
pub const NSP_NOTIFY_HWND: WSACOMPLETIONTYPE = WSACOMPLETIONTYPE(1);
pub const NSP_NOTIFY_IMMEDIATELY: WSACOMPLETIONTYPE = WSACOMPLETIONTYPE(0);
pub const NSP_NOTIFY_PORT: WSACOMPLETIONTYPE = WSACOMPLETIONTYPE(3);
#[repr(C)]
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_IO"))]
#[derive(Clone, Copy, Debug, Default)]
...
pub const NetworkCategoryDomainAuthenticated: NL_NETWORK_CATEGORY = NL_NETWORK_CATEGORY(2);
pub const NetworkCategoryPrivate: NL_NETWORK_CATEGORY = NL_NETWORK_CATEGORY(1);
pub const NetworkCategoryPublic: NL_NETWORK_CATEGORY = NL_NETWORK_CATEGORY(0);
pub const NetworkCategoryUnchanged: NL_NETWORK_CATEGORY = NL_NETWORK_CATEGORY(-1);
pub const NetworkCategoryUnknown: NL_NETWORK_CATEGORY = NL_NETWORK_CATEGORY(-1);
pub const NetworkConnectivityCostHintFixed: NL_NETWORK_CONNECTIVITY_COST_HINT = NL_NETWORK_CONNECTIVITY_COST_HINT(2);
pub const NetworkConnectivityCostHintUnknown: NL_NETWORK_CONNECTIVITY_COST_HINT = NL_NETWORK_CONNECTIVITY_COST_HINT(0);
pub const NetworkConnectivityCostHintUnrestricted: NL_NETWORK_CONNECTIVITY_COST_HINT = NL_NETWORK_CONNECTIVITY_COST_HINT(1);
pub const NetworkConnectivityCostHintVariable: NL_NETWORK_CONNECTIVITY_COST_HINT = NL_NETWORK_CONNECTIVITY_COST_HINT(3);
pub const NetworkConnectivityLevelHintConstrainedInternetAccess: NL_NETWORK_CONNECTIVITY_LEVEL_HINT = NL_NETWORK_CONNECTIVITY_LEVEL_HINT(4);
pub const NetworkConnectivityLevelHintHidden: NL_NETWORK_CONNECTIVITY_LEVEL_HINT = NL_NETWORK_CONNECTIVITY_LEVEL_HINT(5);
pub const NetworkConnectivityLevelHintInternetAccess: NL_NETWORK_CONNECTIVITY_LEVEL_HINT = NL_NETWORK_CONNECTIVITY_LEVEL_HINT(3);
pub const NetworkConnectivityLevelHintLocalAccess: NL_NETWORK_CONNECTIVITY_LEVEL_HINT = NL_NETWORK_CONNECTIVITY_LEVEL_HINT(2);
pub const NetworkConnectivityLevelHintNone: NL_NETWORK_CONNECTIVITY_LEVEL_HINT = NL_NETWORK_CONNECTIVITY_LEVEL_HINT(1);
pub const NetworkConnectivityLevelHintUnknown: NL_NETWORK_CONNECTIVITY_LEVEL_HINT = NL_NETWORK_CONNECTIVITY_LEVEL_HINT(0);
pub const NlatAnycast: NL_ADDRESS_TYPE = NL_ADDRESS_TYPE(2);
pub const NlatBroadcast: NL_ADDRESS_TYPE = NL_ADDRESS_TYPE(4);
pub const NlatInvalid: NL_ADDRESS_TYPE = NL_ADDRESS_TYPE(5);
pub const NlatMulticast: NL_ADDRESS_TYPE = NL_ADDRESS_TYPE(3);
pub const NlatUnicast: NL_ADDRESS_TYPE = NL_ADDRESS_TYPE(1);
pub const NlatUnspecified: NL_ADDRESS_TYPE = NL_ADDRESS_TYPE(0);
pub const NlbwDisabled: NL_BANDWIDTH_FLAG = NL_BANDWIDTH_FLAG(0);
pub const NlbwEnabled: NL_BANDWIDTH_FLAG = NL_BANDWIDTH_FLAG(1);
pub const NlbwUnchanged: NL_BANDWIDTH_FLAG = NL_BANDWIDTH_FLAG(-1);
pub const NldsDeprecated: NL_DAD_STATE = NL_DAD_STATE(3);
pub const NldsDuplicate: NL_DAD_STATE = NL_DAD_STATE(2);
pub const NldsInvalid: NL_DAD_STATE = NL_DAD_STATE(0);
pub const NldsPreferred: NL_DAD_STATE = NL_DAD_STATE(4);
pub const NldsTentative: NL_DAD_STATE = NL_DAD_STATE(1);
pub const NlincCategoryStateMax: NL_INTERFACE_NETWORK_CATEGORY_STATE = NL_INTERFACE_NETWORK_CATEGORY_STATE(4);
pub const NlincCategoryUnknown: NL_INTERFACE_NETWORK_CATEGORY_STATE = NL_INTERFACE_NETWORK_CATEGORY_STATE(0);
pub const NlincDomainAuthenticated: NL_INTERFACE_NETWORK_CATEGORY_STATE = NL_INTERFACE_NETWORK_CATEGORY_STATE(3);
pub const NlincPrivate: NL_INTERFACE_NETWORK_CATEGORY_STATE = NL_INTERFACE_NETWORK_CATEGORY_STATE(2);
pub const NlincPublic: NL_INTERFACE_NETWORK_CATEGORY_STATE = NL_INTERFACE_NETWORK_CATEGORY_STATE(1);
pub const NlnsDelay: NL_NEIGHBOR_STATE = NL_NEIGHBOR_STATE(3);
pub const NlnsIncomplete: NL_NEIGHBOR_STATE = NL_NEIGHBOR_STATE(1);
pub const NlnsMaximum: NL_NEIGHBOR_STATE = NL_NEIGHBOR_STATE(7);
pub const NlnsPermanent: NL_NEIGHBOR_STATE = NL_NEIGHBOR_STATE(6);
pub const NlnsProbe: NL_NEIGHBOR_STATE = NL_NEIGHBOR_STATE(2);
pub const NlnsReachable: NL_NEIGHBOR_STATE = NL_NEIGHBOR_STATE(5);
pub const NlnsStale: NL_NEIGHBOR_STATE = NL_NEIGHBOR_STATE(4);
pub const NlnsUnreachable: NL_NEIGHBOR_STATE = NL_NEIGHBOR_STATE(0);
pub const Nlro6to4: NL_ROUTE_ORIGIN = NL_ROUTE_ORIGIN(4);
pub const NlroDHCP: NL_ROUTE_ORIGIN = NL_ROUTE_ORIGIN(2);
pub const NlroManual: NL_ROUTE_ORIGIN = NL_ROUTE_ORIGIN(0);
pub const NlroRouterAdvertisement: NL_ROUTE_ORIGIN = NL_ROUTE_ORIGIN(3);
pub const NlroWellKnown: NL_ROUTE_ORIGIN = NL_ROUTE_ORIGIN(1);
pub const NlsoDhcp: NL_SUFFIX_ORIGIN = NL_SUFFIX_ORIGIN(3);
pub const NlsoLinkLayerAddress: NL_SUFFIX_ORIGIN = NL_SUFFIX_ORIGIN(4);
pub const NlsoManual: NL_SUFFIX_ORIGIN = NL_SUFFIX_ORIGIN(1);
pub const NlsoOther: NL_SUFFIX_ORIGIN = NL_SUFFIX_ORIGIN(0);
pub const NlsoRandom: NL_SUFFIX_ORIGIN = NL_SUFFIX_ORIGIN(5);
pub const NlsoWellKnown: NL_SUFFIX_ORIGIN = NL_SUFFIX_ORIGIN(2);
...
pub const PF_APPLETALK: u16 = 16;
pub const PF_ATM: u16 = 22;
pub const PF_BAN: u16 = 21;
pub const PF_CCITT: u16 = 10;
pub const PF_CHAOS: u16 = 5;
pub const PF_DATAKIT: u16 = 9;
pub const PF_DECnet: u16 = 12;
pub const PF_DLI: u16 = 13;
pub const PF_ECMA: u16 = 8;
pub const PF_FIREFOX: u16 = 19;
pub const PF_HYLINK: u16 = 15;
pub const PF_IMPLINK: u16 = 3;
pub const PF_IPX: u16 = 6;
pub const PF_IRDA: u16 = 26;
pub const PF_ISO: u16 = 7;
pub const PF_LAT: u16 = 14;
pub const PF_MAX: u16 = 29;
pub const PF_NS: u16 = 6;
pub const PF_OSI: u16 = 7;
pub const PF_PUP: u16 = 4;
pub const PF_SNA: u16 = 11;
pub const PF_UNIX: u16 = 1;
pub const PF_UNKNOWN1: u16 = 20;
pub const PF_VOICEVIEW: u16 = 18;
...
pub const POLLERR: WSAPOLL_EVENT_FLAGS = WSAPOLL_EVENT_FLAGS(1);
pub const POLLHUP: WSAPOLL_EVENT_FLAGS = WSAPOLL_EVENT_FLAGS(2);
pub const POLLIN: WSAPOLL_EVENT_FLAGS = WSAPOLL_EVENT_FLAGS(768);
pub const POLLNVAL: WSAPOLL_EVENT_FLAGS = WSAPOLL_EVENT_FLAGS(4);
pub const POLLOUT: WSAPOLL_EVENT_FLAGS = WSAPOLL_EVENT_FLAGS(16);
pub const POLLPRI: WSAPOLL_EVENT_FLAGS = WSAPOLL_EVENT_FLAGS(1024);
pub const POLLRDBAND: WSAPOLL_EVENT_FLAGS = WSAPOLL_EVENT_FLAGS(512);
pub const POLLRDNORM: WSAPOLL_EVENT_FLAGS = WSAPOLL_EVENT_FLAGS(256);
pub const POLLWRBAND: WSAPOLL_EVENT_FLAGS = WSAPOLL_EVENT_FLAGS(32);
pub const POLLWRNORM: WSAPOLL_EVENT_FLAGS = WSAPOLL_EVENT_FLAGS(16);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const PROTECTION_LEVEL_DEFAULT: u32 = 20;
...
pub const PROTO_IP_BBN: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(12);
pub const PROTO_IP_BGP: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(14);
pub const PROTO_IP_CISCO: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(11);
pub const PROTO_IP_DHCP: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(19);
pub const PROTO_IP_DVMRP: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(17);
pub const PROTO_IP_EGP: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(5);
pub const PROTO_IP_EIGRP: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(16);
pub const PROTO_IP_ES_IS: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(10);
pub const PROTO_IP_GGP: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(6);
pub const PROTO_IP_HELLO: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(7);
pub const PROTO_IP_ICMP: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(4);
pub const PROTO_IP_IDPR: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(15);
pub const PROTO_IP_IS_IS: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(9);
pub const PROTO_IP_LOCAL: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(2);
pub const PROTO_IP_NETMGMT: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(3);
pub const PROTO_IP_NT_AUTOSTATIC: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(10002);
pub const PROTO_IP_NT_STATIC: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(10006);
pub const PROTO_IP_NT_STATIC_NON_DOD: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(10007);
pub const PROTO_IP_OSPF: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(13);
pub const PROTO_IP_OTHER: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(1);
pub const PROTO_IP_RIP: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(8);
pub const PROTO_IP_RPL: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(18);
pub const PVD_CONFIG: i32 = 12289;
pub const ProviderInfoAudit: WSC_PROVIDER_INFO_TYPE = WSC_PROVIDER_INFO_TYPE(1);
pub const ProviderInfoLspCategories: WSC_PROVIDER_INFO_TYPE = WSC_PROVIDER_INFO_TYPE(0);
pub const ProviderLevel_None: NAPI_PROVIDER_LEVEL = NAPI_PROVIDER_LEVEL(0);
pub const ProviderLevel_Primary: NAPI_PROVIDER_LEVEL = NAPI_PROVIDER_LEVEL(2);
pub const ProviderLevel_Secondary: NAPI_PROVIDER_LEVEL = NAPI_PROVIDER_LEVEL(1);
pub const ProviderType_Application: NAPI_PROVIDER_TYPE = NAPI_PROVIDER_TYPE(1);
pub const ProviderType_Service: NAPI_PROVIDER_TYPE = NAPI_PROVIDER_TYPE(2);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct Q2931_IE {
...
pub const RCVALL_IPLEVEL: RCVALL_VALUE = RCVALL_VALUE(3);
pub const RCVALL_OFF: RCVALL_VALUE = RCVALL_VALUE(0);
pub const RCVALL_ON: RCVALL_VALUE = RCVALL_VALUE(1);
pub const RCVALL_SOCKETLEVELONLY: RCVALL_VALUE = RCVALL_VALUE(2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const RESOURCEDISPLAYTYPE_DOMAIN: RESOURCE_DISPLAY_TYPE = RESOURCE_DISPLAY_TYPE(1);
pub const RESOURCEDISPLAYTYPE_FILE: RESOURCE_DISPLAY_TYPE = RESOURCE_DISPLAY_TYPE(4);
pub const RESOURCEDISPLAYTYPE_GENERIC: RESOURCE_DISPLAY_TYPE = RESOURCE_DISPLAY_TYPE(0);
pub const RESOURCEDISPLAYTYPE_GROUP: RESOURCE_DISPLAY_TYPE = RESOURCE_DISPLAY_TYPE(5);
pub const RESOURCEDISPLAYTYPE_SERVER: RESOURCE_DISPLAY_TYPE = RESOURCE_DISPLAY_TYPE(2);
pub const RESOURCEDISPLAYTYPE_SHARE: RESOURCE_DISPLAY_TYPE = RESOURCE_DISPLAY_TYPE(3);
pub const RESOURCEDISPLAYTYPE_TREE: RESOURCE_DISPLAY_TYPE = RESOURCE_DISPLAY_TYPE(10);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const RIO_EVENT_COMPLETION: RIO_NOTIFICATION_COMPLETION_TYPE = RIO_NOTIFICATION_COMPLETION_TYPE(1);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default)]
...
pub const RIO_IOCP_COMPLETION: RIO_NOTIFICATION_COMPLETION_TYPE = RIO_NOTIFICATION_COMPLETION_TYPE(2);
...
pub const RNRSERVICE_DELETE: WSAESETSERVICEOP = WSAESETSERVICEOP(2);
pub const RNRSERVICE_DEREGISTER: WSAESETSERVICEOP = WSAESETSERVICEOP(1);
pub const RNRSERVICE_REGISTER: WSAESETSERVICEOP = WSAESETSERVICEOP(0);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
pub struct RSS_SCALABILITY_INFO {
    pub RssEnabled: bool,
}
pub const RouteProtocolBbn: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(12);
pub const RouteProtocolBgp: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(14);
pub const RouteProtocolCisco: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(11);
pub const RouteProtocolDhcp: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(19);
pub const RouteProtocolDvmrp: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(17);
pub const RouteProtocolEgp: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(5);
pub const RouteProtocolEigrp: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(16);
pub const RouteProtocolEsIs: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(10);
pub const RouteProtocolGgp: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(6);
pub const RouteProtocolHello: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(7);
pub const RouteProtocolIcmp: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(4);
pub const RouteProtocolIdpr: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(15);
pub const RouteProtocolIsIs: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(9);
pub const RouteProtocolLocal: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(2);
pub const RouteProtocolNetMgmt: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(3);
pub const RouteProtocolOspf: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(13);
pub const RouteProtocolOther: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(1);
pub const RouteProtocolRip: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(8);
pub const RouteProtocolRpl: NL_ROUTE_PROTOCOL = NL_ROUTE_PROTOCOL(18);
pub const RouterDiscoveryDhcp: NL_ROUTER_DISCOVERY_BEHAVIOR = NL_ROUTER_DISCOVERY_BEHAVIOR(2);
pub const RouterDiscoveryDisabled: NL_ROUTER_DISCOVERY_BEHAVIOR = NL_ROUTER_DISCOVERY_BEHAVIOR(0);
pub const RouterDiscoveryEnabled: NL_ROUTER_DISCOVERY_BEHAVIOR = NL_ROUTER_DISCOVERY_BEHAVIOR(1);
pub const RouterDiscoveryUnchanged: NL_ROUTER_DISCOVERY_BEHAVIOR = NL_ROUTER_DISCOVERY_BEHAVIOR(-1);
...
pub const SD_BOTH: WINSOCK_SHUTDOWN_HOW = WINSOCK_SHUTDOWN_HOW(2);
pub const SD_RECEIVE: WINSOCK_SHUTDOWN_HOW = WINSOCK_SHUTDOWN_HOW(0);
pub const SD_SEND: WINSOCK_SHUTDOWN_HOW = WINSOCK_SHUTDOWN_HOW(1);
...
pub const SERVICE_ADD_TYPE: SET_SERVICE_OPERATION = SET_SERVICE_OPERATION(4);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default)]
...
pub const SERVICE_DELETE_TYPE: SET_SERVICE_OPERATION = SET_SERVICE_OPERATION(5);
pub const SERVICE_DEREGISTER: SET_SERVICE_OPERATION = SET_SERVICE_OPERATION(2);
pub const SERVICE_FLAG_DEFER: u32 = 1;
pub const SERVICE_FLAG_HARD: u32 = 2;
pub const SERVICE_FLUSH: SET_SERVICE_OPERATION = SET_SERVICE_OPERATION(3);
#[repr(C)]
#[cfg(feature = "Win32_System_Com")]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const SERVICE_REGISTER: SET_SERVICE_OPERATION = SET_SERVICE_OPERATION(1);
...
pub const SIO_SOCKET_CLOSE_NOTIFY: u32 = 2550136845;
...
pub const SOCKET_SECURITY_PROTOCOL_DEFAULT: SOCKET_SECURITY_PROTOCOL = SOCKET_SECURITY_PROTOCOL(0);
pub const SOCKET_SECURITY_PROTOCOL_INVALID: SOCKET_SECURITY_PROTOCOL = SOCKET_SECURITY_PROTOCOL(3);
pub const SOCKET_SECURITY_PROTOCOL_IPSEC: SOCKET_SECURITY_PROTOCOL = SOCKET_SECURITY_PROTOCOL(1);
pub const SOCKET_SECURITY_PROTOCOL_IPSEC2: SOCKET_SECURITY_PROTOCOL = SOCKET_SECURITY_PROTOCOL(2);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const SOCK_DGRAM: WINSOCK_SOCKET_TYPE = WINSOCK_SOCKET_TYPE(2);
...
pub const SOCK_RAW: WINSOCK_SOCKET_TYPE = WINSOCK_SOCKET_TYPE(3);
pub const SOCK_RDM: WINSOCK_SOCKET_TYPE = WINSOCK_SOCKET_TYPE(4);
pub const SOCK_SEQPACKET: WINSOCK_SOCKET_TYPE = WINSOCK_SOCKET_TYPE(5);
pub const SOCK_STREAM: WINSOCK_SOCKET_TYPE = WINSOCK_SOCKET_TYPE(1);
pub const SOL_IP: u32 = 65531;
pub const SOL_IPV6: u32 = 65530;
pub const SOL_IRLMP: i32 = 255;
...
pub const SO_PROTOCOL_INFO: i32 = 8197;
...
pub const SYSTEM_CRITICAL_SOCKET: SOCKET_USAGE_TYPE = SOCKET_USAGE_TYPE(1);
pub const ScopeLevelAdmin: SCOPE_LEVEL = SCOPE_LEVEL(4);
pub const ScopeLevelCount: SCOPE_LEVEL = SCOPE_LEVEL(16);
pub const ScopeLevelGlobal: SCOPE_LEVEL = SCOPE_LEVEL(14);
pub const ScopeLevelInterface: SCOPE_LEVEL = SCOPE_LEVEL(1);
pub const ScopeLevelLink: SCOPE_LEVEL = SCOPE_LEVEL(2);
pub const ScopeLevelOrganization: SCOPE_LEVEL = SCOPE_LEVEL(8);
pub const ScopeLevelSite: SCOPE_LEVEL = SCOPE_LEVEL(5);
pub const ScopeLevelSubnet: SCOPE_LEVEL = SCOPE_LEVEL(3);
pub const SocketMaximumPriorityHintType: SOCKET_PRIORITY_HINT = SOCKET_PRIORITY_HINT(3);
pub const SocketPriorityHintLow: SOCKET_PRIORITY_HINT = SOCKET_PRIORITY_HINT(1);
pub const SocketPriorityHintNormal: SOCKET_PRIORITY_HINT = SOCKET_PRIORITY_HINT(2);
pub const SocketPriorityHintVeryLow: SOCKET_PRIORITY_HINT = SOCKET_PRIORITY_HINT(0);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct TCPSTATE(pub i32);
pub const TCPSTATE_CLOSED: TCPSTATE = TCPSTATE(0);
pub const TCPSTATE_CLOSE_WAIT: TCPSTATE = TCPSTATE(7);
pub const TCPSTATE_CLOSING: TCPSTATE = TCPSTATE(8);
pub const TCPSTATE_ESTABLISHED: TCPSTATE = TCPSTATE(4);
pub const TCPSTATE_FIN_WAIT_1: TCPSTATE = TCPSTATE(5);
pub const TCPSTATE_FIN_WAIT_2: TCPSTATE = TCPSTATE(6);
pub const TCPSTATE_LAST_ACK: TCPSTATE = TCPSTATE(9);
pub const TCPSTATE_LISTEN: TCPSTATE = TCPSTATE(1);
pub const TCPSTATE_MAX: TCPSTATE = TCPSTATE(11);
pub const TCPSTATE_SYN_RCVD: TCPSTATE = TCPSTATE(3);
pub const TCPSTATE_SYN_SENT: TCPSTATE = TCPSTATE(2);
pub const TCPSTATE_TIME_WAIT: TCPSTATE = TCPSTATE(10);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const TCP_ICW_LEVEL_AGGRESSIVE: TCP_ICW_LEVEL = TCP_ICW_LEVEL(3);
pub const TCP_ICW_LEVEL_COMPAT: TCP_ICW_LEVEL = TCP_ICW_LEVEL(254);
pub const TCP_ICW_LEVEL_DEFAULT: TCP_ICW_LEVEL = TCP_ICW_LEVEL(0);
pub const TCP_ICW_LEVEL_EXPERIMENTAL: TCP_ICW_LEVEL = TCP_ICW_LEVEL(4);
pub const TCP_ICW_LEVEL_HIGH: TCP_ICW_LEVEL = TCP_ICW_LEVEL(1);
pub const TCP_ICW_LEVEL_MAX: TCP_ICW_LEVEL = TCP_ICW_LEVEL(255);
pub const TCP_ICW_LEVEL_VERY_HIGH: TCP_ICW_LEVEL = TCP_ICW_LEVEL(2);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const TCP_INITIAL_RTO_UNSPECIFIED_MAX_SYN_RETRANSMISSIONS: u16 = 65535;
...
pub const TUNNEL_SUB_TYPE_CP: TUNNEL_SUB_TYPE = TUNNEL_SUB_TYPE(1);
pub const TUNNEL_SUB_TYPE_HA: TUNNEL_SUB_TYPE = TUNNEL_SUB_TYPE(3);
pub const TUNNEL_SUB_TYPE_IPTLS: TUNNEL_SUB_TYPE = TUNNEL_SUB_TYPE(2);
pub const TUNNEL_SUB_TYPE_NONE: TUNNEL_SUB_TYPE = TUNNEL_SUB_TYPE(0);
...
pub const VNSPROTO_IPC: u32 = 1;
pub const VNSPROTO_RELIABLE_IPC: u32 = 2;
...
pub const WINDOWS_PF_IRDA: u32 = 26;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const WSABASEERR: WSA_ERROR = WSA_ERROR(10000);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
pub struct WSABUF {
    pub len: u32,
...
pub const WSAEACCES: WSA_ERROR = WSA_ERROR(10013);
pub const WSAEADDRINUSE: WSA_ERROR = WSA_ERROR(10048);
pub const WSAEADDRNOTAVAIL: WSA_ERROR = WSA_ERROR(10049);
pub const WSAEAFNOSUPPORT: WSA_ERROR = WSA_ERROR(10047);
pub const WSAEALREADY: WSA_ERROR = WSA_ERROR(10037);
pub const WSAEBADF: WSA_ERROR = WSA_ERROR(10009);
pub const WSAECANCELLED: WSA_ERROR = WSA_ERROR(10103);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct WSAECOMPARATOR(pub i32);
pub const WSAECONNABORTED: WSA_ERROR = WSA_ERROR(10053);
pub const WSAECONNREFUSED: WSA_ERROR = WSA_ERROR(10061);
pub const WSAECONNRESET: WSA_ERROR = WSA_ERROR(10054);
pub const WSAEDESTADDRREQ: WSA_ERROR = WSA_ERROR(10039);
pub const WSAEDISCON: WSA_ERROR = WSA_ERROR(10101);
pub const WSAEDQUOT: WSA_ERROR = WSA_ERROR(10069);
pub const WSAEFAULT: WSA_ERROR = WSA_ERROR(10014);
pub const WSAEHOSTDOWN: WSA_ERROR = WSA_ERROR(10064);
pub const WSAEHOSTUNREACH: WSA_ERROR = WSA_ERROR(10065);
pub const WSAEINPROGRESS: WSA_ERROR = WSA_ERROR(10036);
pub const WSAEINTR: WSA_ERROR = WSA_ERROR(10004);
pub const WSAEINVAL: WSA_ERROR = WSA_ERROR(10022);
pub const WSAEINVALIDPROCTABLE: WSA_ERROR = WSA_ERROR(10104);
pub const WSAEINVALIDPROVIDER: WSA_ERROR = WSA_ERROR(10105);
pub const WSAEISCONN: WSA_ERROR = WSA_ERROR(10056);
pub const WSAELOOP: WSA_ERROR = WSA_ERROR(10062);
pub const WSAEMFILE: WSA_ERROR = WSA_ERROR(10024);
pub const WSAEMSGSIZE: WSA_ERROR = WSA_ERROR(10040);
pub const WSAENAMETOOLONG: WSA_ERROR = WSA_ERROR(10063);
pub const WSAENETDOWN: WSA_ERROR = WSA_ERROR(10050);
pub const WSAENETRESET: WSA_ERROR = WSA_ERROR(10052);
pub const WSAENETUNREACH: WSA_ERROR = WSA_ERROR(10051);
pub const WSAENOBUFS: WSA_ERROR = WSA_ERROR(10055);
pub const WSAENOMORE: WSA_ERROR = WSA_ERROR(10102);
pub const WSAENOPROTOOPT: WSA_ERROR = WSA_ERROR(10042);
pub const WSAENOTCONN: WSA_ERROR = WSA_ERROR(10057);
pub const WSAENOTEMPTY: WSA_ERROR = WSA_ERROR(10066);
pub const WSAENOTSOCK: WSA_ERROR = WSA_ERROR(10038);
pub const WSAEOPNOTSUPP: WSA_ERROR = WSA_ERROR(10045);
pub const WSAEPFNOSUPPORT: WSA_ERROR = WSA_ERROR(10046);
pub const WSAEPROCLIM: WSA_ERROR = WSA_ERROR(10067);
pub const WSAEPROTONOSUPPORT: WSA_ERROR = WSA_ERROR(10043);
pub const WSAEPROTOTYPE: WSA_ERROR = WSA_ERROR(10041);
pub const WSAEPROVIDERFAILEDINIT: WSA_ERROR = WSA_ERROR(10106);
pub const WSAEREFUSED: WSA_ERROR = WSA_ERROR(10112);
pub const WSAEREMOTE: WSA_ERROR = WSA_ERROR(10071);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct WSAESETSERVICEOP(pub i32);
pub const WSAESHUTDOWN: WSA_ERROR = WSA_ERROR(10058);
pub const WSAESOCKTNOSUPPORT: WSA_ERROR = WSA_ERROR(10044);
pub const WSAESTALE: WSA_ERROR = WSA_ERROR(10070);
pub const WSAETIMEDOUT: WSA_ERROR = WSA_ERROR(10060);
pub const WSAETOOMANYREFS: WSA_ERROR = WSA_ERROR(10059);
pub const WSAEUSERS: WSA_ERROR = WSA_ERROR(10068);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Default)]
...
pub const WSAEWOULDBLOCK: WSA_ERROR = WSA_ERROR(10035);
pub const WSAHOST_NOT_FOUND: WSA_ERROR = WSA_ERROR(11001);
...
pub const WSANOTINITIALISED: WSA_ERROR = WSA_ERROR(10093);
pub const WSANO_DATA: WSA_ERROR = WSA_ERROR(11004);
pub const WSANO_RECOVERY: WSA_ERROR = WSA_ERROR(11003);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const WSASERVICE_NOT_FOUND: WSA_ERROR = WSA_ERROR(10108);
pub const WSASYSCALLFAILURE: WSA_ERROR = WSA_ERROR(10107);
pub const WSASYSNOTREADY: WSA_ERROR = WSA_ERROR(10091);
...
pub const WSATRY_AGAIN: WSA_ERROR = WSA_ERROR(11002);
pub const WSATYPE_NOT_FOUND: WSA_ERROR = WSA_ERROR(10109);
pub const WSAVERNOTSUPPORTED: WSA_ERROR = WSA_ERROR(10092);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const WSA_E_CANCELLED: WSA_ERROR = WSA_ERROR(10111);
pub const WSA_E_NO_MORE: WSA_ERROR = WSA_ERROR(10110);
...
pub const WSA_INVALID_EVENT: WSAEVENT = WSAEVENT(0 as _);
pub const WSA_INVALID_HANDLE: WSA_ERROR = WSA_ERROR(6);
pub const WSA_INVALID_PARAMETER: WSA_ERROR = WSA_ERROR(87);
pub const WSA_IO_INCOMPLETE: WSA_ERROR = WSA_ERROR(996);
pub const WSA_IO_PENDING: WSA_ERROR = WSA_ERROR(997);
pub const WSA_IPSEC_NAME_POLICY_ERROR: WSA_ERROR = WSA_ERROR(11033);
pub const WSA_MAXIMUM_WAIT_EVENTS: u32 = 64;
pub const WSA_NOT_ENOUGH_MEMORY: WSA_ERROR = WSA_ERROR(8);
pub const WSA_OPERATION_ABORTED: WSA_ERROR = WSA_ERROR(995);
pub const WSA_QOS_ADMISSION_FAILURE: WSA_ERROR = WSA_ERROR(11010);
pub const WSA_QOS_BAD_OBJECT: WSA_ERROR = WSA_ERROR(11013);
pub const WSA_QOS_BAD_STYLE: WSA_ERROR = WSA_ERROR(11012);
pub const WSA_QOS_EFILTERCOUNT: WSA_ERROR = WSA_ERROR(11021);
pub const WSA_QOS_EFILTERSTYLE: WSA_ERROR = WSA_ERROR(11019);
pub const WSA_QOS_EFILTERTYPE: WSA_ERROR = WSA_ERROR(11020);
pub const WSA_QOS_EFLOWCOUNT: WSA_ERROR = WSA_ERROR(11023);
pub const WSA_QOS_EFLOWDESC: WSA_ERROR = WSA_ERROR(11026);
pub const WSA_QOS_EFLOWSPEC: WSA_ERROR = WSA_ERROR(11017);
pub const WSA_QOS_EOBJLENGTH: WSA_ERROR = WSA_ERROR(11022);
pub const WSA_QOS_EPOLICYOBJ: WSA_ERROR = WSA_ERROR(11025);
pub const WSA_QOS_EPROVSPECBUF: WSA_ERROR = WSA_ERROR(11018);
pub const WSA_QOS_EPSFILTERSPEC: WSA_ERROR = WSA_ERROR(11028);
pub const WSA_QOS_EPSFLOWSPEC: WSA_ERROR = WSA_ERROR(11027);
pub const WSA_QOS_ESDMODEOBJ: WSA_ERROR = WSA_ERROR(11029);
pub const WSA_QOS_ESERVICETYPE: WSA_ERROR = WSA_ERROR(11016);
pub const WSA_QOS_ESHAPERATEOBJ: WSA_ERROR = WSA_ERROR(11030);
pub const WSA_QOS_EUNKOWNPSOBJ: WSA_ERROR = WSA_ERROR(11024);
pub const WSA_QOS_GENERIC_ERROR: WSA_ERROR = WSA_ERROR(11015);
pub const WSA_QOS_NO_RECEIVERS: WSA_ERROR = WSA_ERROR(11008);
pub const WSA_QOS_NO_SENDERS: WSA_ERROR = WSA_ERROR(11007);
pub const WSA_QOS_POLICY_FAILURE: WSA_ERROR = WSA_ERROR(11011);
pub const WSA_QOS_RECEIVERS: WSA_ERROR = WSA_ERROR(11005);
pub const WSA_QOS_REQUEST_CONFIRMED: WSA_ERROR = WSA_ERROR(11009);
pub const WSA_QOS_RESERVED_PETYPE: WSA_ERROR = WSA_ERROR(11031);
pub const WSA_QOS_SENDERS: WSA_ERROR = WSA_ERROR(11006);
pub const WSA_QOS_TRAFFIC_CTRL_ERROR: WSA_ERROR = WSA_ERROR(11014);
pub const WSA_SECURE_HOST_NOT_FOUND: WSA_ERROR = WSA_ERROR(11032);
pub const WSA_WAIT_EVENT_0: WSA_ERROR = WSA_ERROR(0);
pub const WSA_WAIT_FAILED: u32 = 4294967295;
pub const WSA_WAIT_IO_COMPLETION: WSA_ERROR = WSA_ERROR(192);
...
pub const WsaBehaviorAll: WSA_COMPATIBILITY_BEHAVIOR_ID = WSA_COMPATIBILITY_BEHAVIOR_ID(0);
pub const WsaBehaviorAutoTuning: WSA_COMPATIBILITY_BEHAVIOR_ID = WSA_COMPATIBILITY_BEHAVIOR_ID(2);
pub const WsaBehaviorReceiveBuffering: WSA_COMPATIBILITY_BEHAVIOR_ID = WSA_COMPATIBILITY_BEHAVIOR_ID(1);
