...
impl AsyncIBackgroundCopyCallback {
    pub unsafe fn Begin_JobTransferred<P0>(&self, pjob: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Finish_JobTransferred(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Finish_JobTransferred)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Begin_JobError<P0, P1>(&self, pjob: P0, perror: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IBackgroundCopyJob>,
    ...
    pub unsafe fn Finish_JobError(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Finish_JobError)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Begin_JobModification<P0>(&self, pjob: P0, dwreserved: u32) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IBackgroundCopyJob>,
    {
    ...
    pub unsafe fn Finish_JobModification(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait AsyncIBackgroundCopyCallback_Impl: windows_core::IUnknownImpl {
    fn Begin_JobTransferred(&self, pjob: windows_core::Ref<'_, IBackgroundCopyJob>) -> Result<(), windows_result::HRESULT>;
    fn Finish_JobTransferred(&self) -> Result<(), windows_result::HRESULT>;
    fn Begin_JobError(&self, pjob: windows_core::Ref<'_, IBackgroundCopyJob>, perror: windows_core::Ref<'_, IBackgroundCopyError>) -> Result<(), windows_result::HRESULT>;
    fn Finish_JobError(&self) -> Result<(), windows_result::HRESULT>;
    fn Begin_JobModification(&self, pjob: windows_core::Ref<'_, IBackgroundCopyJob>, dwreserved: u32) -> Result<(), windows_result::HRESULT>;
    fn Finish_JobModification(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IBITSExtensionSetup {
    pub unsafe fn EnableBITSUploads(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).EnableBITSUploads)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn DisableBITSUploads(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).DisableBITSUploads)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn GetCleanupTaskName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
    ...
    pub unsafe fn GetCleanupTask(&self, riid: *const windows_core::GUID) -> Result<windows_core::IUnknown, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBITSExtensionSetup_Impl: super::super::System::Com::IDispatch_Impl {
    fn EnableBITSUploads(&self) -> Result<(), windows_result::HRESULT>;
    fn DisableBITSUploads(&self) -> Result<(), windows_result::HRESULT>;
    fn GetCleanupTaskName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn GetCleanupTask(&self, riid: *const windows_core::GUID) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IBITSExtensionSetupFactory {
    pub unsafe fn GetObject(&self, path: &windows_core::BSTR) -> Result<IBITSExtensionSetup, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBITSExtensionSetupFactory_Impl: super::super::System::Com::IDispatch_Impl {
    fn GetObject(&self, path: &windows_core::BSTR) -> Result<IBITSExtensionSetup, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IBackgroundCopyCallback {
    pub unsafe fn JobTransferred<P0>(&self, pjob: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IBackgroundCopyJob>,
    {
        unsafe { (windows_core::Interface::vtable(self).JobTransferred)(windows_core::Interface::as_raw(self), pjob.param().abi()).ok() }
    }
    pub unsafe fn JobError<P0, P1>(&self, pjob: P0, perror: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IBackgroundCopyJob>,
        P1: windows_core::Param<IBackgroundCopyError>,
    {
    ...
    pub unsafe fn JobModification<P0>(&self, pjob: P0, dwreserved: u32) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IBackgroundCopyJob>,
    {
...
pub trait IBackgroundCopyCallback_Impl: windows_core::IUnknownImpl {
    fn JobTransferred(&self, pjob: windows_core::Ref<'_, IBackgroundCopyJob>) -> Result<(), windows_result::HRESULT>;
    fn JobError(&self, pjob: windows_core::Ref<'_, IBackgroundCopyJob>, perror: windows_core::Ref<'_, IBackgroundCopyError>) -> Result<(), windows_result::HRESULT>;
    fn JobModification(&self, pjob: windows_core::Ref<'_, IBackgroundCopyJob>, dwreserved: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IBackgroundCopyCallback1 {
    pub unsafe fn OnStatus<P0, P1>(&self, pgroup: P0, pjob: P1, dwfileindex: u32, dwstatus: u32, dwnumofretries: u32, dwwin32result: u32, dwtransportresult: u32) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn OnProgress<P1, P2>(&self, progresstype: u32, pgroup: P1, pjob: P2, dwfileindex: u32, dwprogressvalue: u32) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn OnProgressEx<P1, P2>(&self, progresstype: u32, pgroup: P1, pjob: P2, dwfileindex: u32, dwprogressvalue: u32, pbyte: &[u8]) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<IBackgroundCopyGroup>,
        P2: windows_core::Param<IBackgroundCopyJob1>,
    {
...
pub trait IBackgroundCopyCallback1_Impl: windows_core::IUnknownImpl {
    fn OnStatus(&self, pgroup: windows_core::Ref<'_, IBackgroundCopyGroup>, pjob: windows_core::Ref<'_, IBackgroundCopyJob1>, dwfileindex: u32, dwstatus: u32, dwnumofretries: u32, dwwin32result: u32, dwtransportresult: u32) -> Result<(), windows_result::HRESULT>;
    fn OnProgress(&self, progresstype: u32, pgroup: windows_core::Ref<'_, IBackgroundCopyGroup>, pjob: windows_core::Ref<'_, IBackgroundCopyJob1>, dwfileindex: u32, dwprogressvalue: u32) -> Result<(), windows_result::HRESULT>;
    fn OnProgressEx(&self, progresstype: u32, pgroup: windows_core::Ref<'_, IBackgroundCopyGroup>, pjob: windows_core::Ref<'_, IBackgroundCopyJob1>, dwfileindex: u32, dwprogressvalue: u32, dwbytearraysize: u32, pbyte: *const u8) -> Result<(), windows_result::HRESULT>;
}
...
impl IBackgroundCopyCallback2 {
    pub unsafe fn FileTransferred<P0, P1>(&self, pjob: P0, pfile: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IBackgroundCopyJob>,
...
pub trait IBackgroundCopyCallback2_Impl: IBackgroundCopyCallback_Impl {
    fn FileTransferred(&self, pjob: windows_core::Ref<'_, IBackgroundCopyJob>, pfile: windows_core::Ref<'_, IBackgroundCopyFile>) -> Result<(), windows_result::HRESULT>;
}
...
impl IBackgroundCopyCallback3 {
    pub unsafe fn FileRangesTransferred<P0, P1>(&self, job: P0, file: P1, ranges: &[BG_FILE_RANGE]) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IBackgroundCopyJob>,
        P1: windows_core::Param<IBackgroundCopyFile>,
    {
...
pub trait IBackgroundCopyCallback3_Impl: IBackgroundCopyCallback2_Impl {
    fn FileRangesTransferred(&self, job: windows_core::Ref<'_, IBackgroundCopyJob>, file: windows_core::Ref<'_, IBackgroundCopyFile>, rangecount: u32, ranges: *const BG_FILE_RANGE) -> Result<(), windows_result::HRESULT>;
}
...
impl IBackgroundCopyError {
    pub unsafe fn GetError(&self, pcontext: *mut BG_ERROR_CONTEXT, pcode: *mut windows_core::HRESULT) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetError)(windows_core::Interface::as_raw(self), pcontext as _, pcode as _).ok() }
    }
    pub unsafe fn GetFile(&self) -> Result<IBackgroundCopyFile, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetErrorDescription(&self, languageid: u32) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetErrorContextDescription(&self, languageid: u32) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetProtocol(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBackgroundCopyError_Impl: windows_core::IUnknownImpl {
    fn GetError(&self, pcontext: *mut BG_ERROR_CONTEXT, pcode: *mut windows_core::HRESULT) -> Result<(), windows_result::HRESULT>;
    fn GetFile(&self) -> Result<IBackgroundCopyFile, windows_result::HRESULT>;
    fn GetErrorDescription(&self, languageid: u32) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetErrorContextDescription(&self, languageid: u32) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetProtocol(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
}
...
impl IBackgroundCopyFile {
    pub unsafe fn GetRemoteName(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRemoteName)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetLocalName(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLocalName)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetProgress(&self, pval: *mut BG_FILE_PROGRESS) -> Result<(), windows_result::HRESULT> {
...
pub trait IBackgroundCopyFile_Impl: windows_core::IUnknownImpl {
    fn GetRemoteName(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetLocalName(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetProgress(&self, pval: *mut BG_FILE_PROGRESS) -> Result<(), windows_result::HRESULT>;
}
...
impl IBackgroundCopyFile2 {
    pub unsafe fn GetFileRanges(&self, rangecount: *mut u32, ranges: *mut *mut BG_FILE_RANGE) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetRemoteName<P0>(&self, val: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IBackgroundCopyFile2_Impl: IBackgroundCopyFile_Impl {
    fn GetFileRanges(&self, rangecount: *mut u32, ranges: *mut *mut BG_FILE_RANGE) -> Result<(), windows_result::HRESULT>;
    fn SetRemoteName(&self, val: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
...
pub trait IBackgroundCopyFile3_Impl: IBackgroundCopyFile2_Impl {
    fn GetTemporaryName(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn SetValidationState(&self, state: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn GetValidationState(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
    fn IsDownloadedFromPeer(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
}
...
impl IBackgroundCopyFile4 {
    pub unsafe fn GetPeerDownloadStats(&self, pfromorigin: *mut u64, pfrompeers: *mut u64) -> Result<(), windows_result::HRESULT> {
...
pub trait IBackgroundCopyFile4_Impl: IBackgroundCopyFile3_Impl {
    fn GetPeerDownloadStats(&self, pfromorigin: *mut u64, pfrompeers: *mut u64) -> Result<(), windows_result::HRESULT>;
}
...
impl IBackgroundCopyFile5 {
    pub unsafe fn SetProperty(&self, propertyid: BITS_FILE_PROPERTY_ID, propertyvalue: BITS_FILE_PROPERTY_VALUE) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetProperty(&self, propertyid: BITS_FILE_PROPERTY_ID) -> Result<BITS_FILE_PROPERTY_VALUE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBackgroundCopyFile5_Impl: IBackgroundCopyFile4_Impl {
    fn SetProperty(&self, propertyid: BITS_FILE_PROPERTY_ID, propertyvalue: &BITS_FILE_PROPERTY_VALUE) -> Result<(), windows_result::HRESULT>;
    fn GetProperty(&self, propertyid: BITS_FILE_PROPERTY_ID) -> Result<BITS_FILE_PROPERTY_VALUE, windows_result::HRESULT>;
}
...
impl IBackgroundCopyFile6 {
    pub unsafe fn UpdateDownloadPosition(&self, offset: u64) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).UpdateDownloadPosition)(windows_core::Interface::as_raw(self), offset).ok() }
    }
    pub unsafe fn RequestFileRanges(&self, ranges: &[BG_FILE_RANGE]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetFilledFileRanges(&self, rangecount: *mut u32, ranges: *mut *mut BG_FILE_RANGE) -> Result<(), windows_result::HRESULT> {
...
pub trait IBackgroundCopyFile6_Impl: IBackgroundCopyFile5_Impl {
    fn UpdateDownloadPosition(&self, offset: u64) -> Result<(), windows_result::HRESULT>;
    fn RequestFileRanges(&self, rangecount: u32, ranges: *const BG_FILE_RANGE) -> Result<(), windows_result::HRESULT>;
    fn GetFilledFileRanges(&self, rangecount: *mut u32, ranges: *mut *mut BG_FILE_RANGE) -> Result<(), windows_result::HRESULT>;
}
...
impl IBackgroundCopyGroup {
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetProp(&self, propid: GROUPPROP) -> Result<super::super::System::Variant::VARIANT, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn SetProp(&self, propid: GROUPPROP, pvarval: *const super::super::System::Variant::VARIANT) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetProgress(&self, dwflags: u32) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetProgress)(windows_core::Interface::as_raw(self), dwflags, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetStatus(&self, pdwstatus: *mut u32, pdwjobindex: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetJob(&self, jobid: windows_core::GUID) -> Result<IBackgroundCopyJob1, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GroupID(&self) -> Result<windows_core::GUID, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GroupID)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn CreateJob(&self, guidjobid: windows_core::GUID) -> Result<IBackgroundCopyJob1, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumJobs(&self, dwflags: u32) -> Result<IEnumBackgroundCopyJobs1, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SwitchToForeground(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SwitchToForeground)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn QueryNewJobInterface(&self, iid: *const windows_core::GUID) -> Result<windows_core::IUnknown, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetNotificationPointer<P1>(&self, iid: *const windows_core::GUID, punk: P1) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IBackgroundCopyGroup_Impl: windows_core::IUnknownImpl {
    fn GetProp(&self, propid: GROUPPROP) -> Result<super::super::System::Variant::VARIANT, windows_result::HRESULT>;
    fn SetProp(&self, propid: GROUPPROP, pvarval: *const super::super::System::Variant::VARIANT) -> Result<(), windows_result::HRESULT>;
    fn GetProgress(&self, dwflags: u32) -> Result<u32, windows_result::HRESULT>;
    fn GetStatus(&self, pdwstatus: *mut u32, pdwjobindex: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetJob(&self, jobid: &windows_core::GUID) -> Result<IBackgroundCopyJob1, windows_result::HRESULT>;
    fn SuspendGroup(&self) -> Result<(), windows_result::HRESULT>;
    fn ResumeGroup(&self) -> Result<(), windows_result::HRESULT>;
    fn CancelGroup(&self) -> Result<(), windows_result::HRESULT>;
    fn Size(&self) -> Result<u32, windows_result::HRESULT>;
    fn GroupID(&self) -> Result<windows_core::GUID, windows_result::HRESULT>;
    fn CreateJob(&self, guidjobid: &windows_core::GUID) -> Result<IBackgroundCopyJob1, windows_result::HRESULT>;
    fn EnumJobs(&self, dwflags: u32) -> Result<IEnumBackgroundCopyJobs1, windows_result::HRESULT>;
    fn SwitchToForeground(&self) -> Result<(), windows_result::HRESULT>;
    fn QueryNewJobInterface(&self, iid: *const windows_core::GUID) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
    fn SetNotificationPointer(&self, iid: *const windows_core::GUID, punk: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IBackgroundCopyJob {
    pub unsafe fn AddFileSet(&self, pfileset: &[BG_FILE_INFO]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn AddFile<P0, P1>(&self, remoteurl: P0, localname: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn EnumFiles(&self) -> Result<IEnumBackgroundCopyFiles, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetType(&self) -> Result<BG_JOB_TYPE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetType)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetProgress(&self, pval: *mut BG_JOB_PROGRESS) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetProgress)(windows_core::Interface::as_raw(self), pval as _).ok() }
    }
    pub unsafe fn GetTimes(&self, pval: *mut BG_JOB_TIMES) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetTimes)(windows_core::Interface::as_raw(self), pval as _).ok() }
    }
    pub unsafe fn GetState(&self) -> Result<BG_JOB_STATE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetState)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetError(&self) -> Result<IBackgroundCopyError, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetProxySettings(&self, pproxyusage: *mut BG_JOB_PROXY_USAGE, pproxylist: *mut windows_core::PWSTR, pproxybypasslist: *mut windows_core::PWSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn TakeOwnership(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IBackgroundCopyJob_Impl: windows_core::IUnknownImpl {
    fn AddFileSet(&self, cfilecount: u32, pfileset: *const BG_FILE_INFO) -> Result<(), windows_result::HRESULT>;
    fn AddFile(&self, remoteurl: &windows_core::PCWSTR, localname: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn EnumFiles(&self) -> Result<IEnumBackgroundCopyFiles, windows_result::HRESULT>;
    ...
    fn GetType(&self) -> Result<BG_JOB_TYPE, windows_result::HRESULT>;
    fn GetProgress(&self, pval: *mut BG_JOB_PROGRESS) -> Result<(), windows_result::HRESULT>;
    fn GetTimes(&self, pval: *mut BG_JOB_TIMES) -> Result<(), windows_result::HRESULT>;
    fn GetState(&self) -> Result<BG_JOB_STATE, windows_result::HRESULT>;
    fn GetError(&self) -> Result<IBackgroundCopyError, windows_result::HRESULT>;
    fn GetOwner(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn SetDisplayName(&self, val: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetDisplayName(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn SetDescription(&self, val: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetDescription(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn SetPriority(&self, val: BG_JOB_PRIORITY) -> Result<(), windows_result::HRESULT>;
    fn GetPriority(&self) -> Result<BG_JOB_PRIORITY, windows_result::HRESULT>;
    fn SetNotifyFlags(&self, val: u32) -> Result<(), windows_result::HRESULT>;
    fn GetNotifyFlags(&self) -> Result<u32, windows_result::HRESULT>;
    fn SetNotifyInterface(&self, val: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn GetNotifyInterface(&self) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
    fn SetMinimumRetryDelay(&self, seconds: u32) -> Result<(), windows_result::HRESULT>;
    fn GetMinimumRetryDelay(&self) -> Result<u32, windows_result::HRESULT>;
    fn SetNoProgressTimeout(&self, seconds: u32) -> Result<(), windows_result::HRESULT>;
    fn GetNoProgressTimeout(&self) -> Result<u32, windows_result::HRESULT>;
    fn GetErrorCount(&self) -> Result<u32, windows_result::HRESULT>;
    fn SetProxySettings(&self, proxyusage: BG_JOB_PROXY_USAGE, proxylist: &windows_core::PCWSTR, proxybypasslist: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetProxySettings(&self, pproxyusage: *mut BG_JOB_PROXY_USAGE, pproxylist: *mut windows_core::PWSTR, pproxybypasslist: *mut windows_core::PWSTR) -> Result<(), windows_result::HRESULT>;
    fn TakeOwnership(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IBackgroundCopyJob1 {
    pub unsafe fn CancelJob(&self) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetStatus(&self, pdwstatus: *mut u32, pdwwin32result: *mut u32, pdwtransportresult: *mut u32, pdwnumofretries: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn AddFiles(&self, ppfileset: &[*const FILESETINFO]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetFile(&self, cfileindex: u32) -> Result<FILESETINFO, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFileCount(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn JobID(&self) -> Result<windows_core::GUID, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBackgroundCopyJob1_Impl: windows_core::IUnknownImpl {
    fn CancelJob(&self) -> Result<(), windows_result::HRESULT>;
    fn GetProgress(&self, dwflags: u32) -> Result<u32, windows_result::HRESULT>;
    fn GetStatus(&self, pdwstatus: *mut u32, pdwwin32result: *mut u32, pdwtransportresult: *mut u32, pdwnumofretries: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn AddFiles(&self, cfilecount: u32, ppfileset: *const *const FILESETINFO) -> Result<(), windows_result::HRESULT>;
    fn GetFile(&self, cfileindex: u32) -> Result<FILESETINFO, windows_result::HRESULT>;
    fn GetFileCount(&self) -> Result<u32, windows_result::HRESULT>;
    fn SwitchToForeground(&self) -> Result<(), windows_result::HRESULT>;
    fn JobID(&self) -> Result<windows_core::GUID, windows_result::HRESULT>;
}
...
impl IBackgroundCopyJob2 {
    pub unsafe fn SetNotifyCmdLine<P0, P1>(&self, program: P0, parameters: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetNotifyCmdLine(&self, pprogram: *mut windows_core::PWSTR, pparameters: *mut windows_core::PWSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetReplyProgress(&self, pprogress: *mut BG_JOB_REPLY_PROGRESS) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetReplyProgress)(windows_core::Interface::as_raw(self), pprogress as _).ok() }
    }
    pub unsafe fn GetReplyData(&self, ppbuffer: *mut *mut u8, plength: *mut u64) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetReplyData)(windows_core::Interface::as_raw(self), ppbuffer as _, plength as _).ok() }
    }
    pub unsafe fn SetReplyFileName<P0>(&self, replyfilename: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetReplyFileName)(windows_core::Interface::as_raw(self), replyfilename.param().abi()).ok() }
    }
    pub unsafe fn GetReplyFileName(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetReplyFileName)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetCredentials(&self, credentials: *const BG_AUTH_CREDENTIALS) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetCredentials)(windows_core::Interface::as_raw(self), credentials).ok() }
    }
    pub unsafe fn RemoveCredentials(&self, target: BG_AUTH_TARGET, scheme: BG_AUTH_SCHEME) -> Result<(), windows_result::HRESULT> {
...
pub trait IBackgroundCopyJob2_Impl: IBackgroundCopyJob_Impl {
    fn SetNotifyCmdLine(&self, program: &windows_core::PCWSTR, parameters: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetNotifyCmdLine(&self, pprogram: *mut windows_core::PWSTR, pparameters: *mut windows_core::PWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetReplyProgress(&self, pprogress: *mut BG_JOB_REPLY_PROGRESS) -> Result<(), windows_result::HRESULT>;
    fn GetReplyData(&self, ppbuffer: *mut *mut u8, plength: *mut u64) -> Result<(), windows_result::HRESULT>;
    fn SetReplyFileName(&self, replyfilename: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetReplyFileName(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn SetCredentials(&self, credentials: *const BG_AUTH_CREDENTIALS) -> Result<(), windows_result::HRESULT>;
    fn RemoveCredentials(&self, target: BG_AUTH_TARGET, scheme: BG_AUTH_SCHEME) -> Result<(), windows_result::HRESULT>;
}
...
impl IBackgroundCopyJob3 {
    pub unsafe fn ReplaceRemotePrefix<P0, P1>(&self, oldprefix: P0, newprefix: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn AddFileWithRanges<P0, P1>(&self, remoteurl: P0, localname: P1, ranges: &[BG_FILE_RANGE]) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetFileACLFlags(&self, flags: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetFileACLFlags)(windows_core::Interface::as_raw(self), flags).ok() }
    }
    pub unsafe fn GetFileACLFlags(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBackgroundCopyJob3_Impl: IBackgroundCopyJob2_Impl {
    fn ReplaceRemotePrefix(&self, oldprefix: &windows_core::PCWSTR, newprefix: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn AddFileWithRanges(&self, remoteurl: &windows_core::PCWSTR, localname: &windows_core::PCWSTR, rangecount: u32, ranges: *const BG_FILE_RANGE) -> Result<(), windows_result::HRESULT>;
    fn SetFileACLFlags(&self, flags: u32) -> Result<(), windows_result::HRESULT>;
    fn GetFileACLFlags(&self) -> Result<u32, windows_result::HRESULT>;
}
...
pub trait IBackgroundCopyJob4_Impl: IBackgroundCopyJob3_Impl {
    fn SetPeerCachingFlags(&self, flags: u32) -> Result<(), windows_result::HRESULT>;
    fn GetPeerCachingFlags(&self) -> Result<u32, windows_result::HRESULT>;
    fn GetOwnerIntegrityLevel(&self) -> Result<u32, windows_result::HRESULT>;
    fn GetOwnerElevationState(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
    fn SetMaximumDownloadTime(&self, timeout: u32) -> Result<(), windows_result::HRESULT>;
    fn GetMaximumDownloadTime(&self) -> Result<u32, windows_result::HRESULT>;
}
...
impl IBackgroundCopyJob5 {
    pub unsafe fn SetProperty(&self, propertyid: BITS_JOB_PROPERTY_ID, propertyvalue: BITS_JOB_PROPERTY_VALUE) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetProperty)(windows_core::Interface::as_raw(self), propertyid, core::mem::transmute(propertyvalue)).ok() }
    }
    pub unsafe fn GetProperty(&self, propertyid: BITS_JOB_PROPERTY_ID) -> Result<BITS_JOB_PROPERTY_VALUE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetProperty)(windows_core::Interface::as_raw(self), propertyid, &mut result__).map(|| result__)
        }
...
pub trait IBackgroundCopyJob5_Impl: IBackgroundCopyJob4_Impl {
    fn SetProperty(&self, propertyid: BITS_JOB_PROPERTY_ID, propertyvalue: &BITS_JOB_PROPERTY_VALUE) -> Result<(), windows_result::HRESULT>;
    fn GetProperty(&self, propertyid: BITS_JOB_PROPERTY_ID) -> Result<BITS_JOB_PROPERTY_VALUE, windows_result::HRESULT>;
}
...
impl IBackgroundCopyJobHttpOptions {
    pub unsafe fn SetClientCertificateByID<P1>(&self, storelocation: BG_CERT_STORE_LOCATION, storename: P1, pcerthashblob: &[u8; 20]) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetClientCertificateByName<P1, P2>(&self, storelocation: BG_CERT_STORE_LOCATION, storename: P1, subjectname: P2) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn RemoveClientCertificate(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).RemoveClientCertificate)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn GetClientCertificate(&self, pstorelocation: *mut BG_CERT_STORE_LOCATION, pstorename: *mut windows_core::PWSTR, ppcerthashblob: *mut *mut u8, psubjectname: *mut windows_core::PWSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetCustomHeaders<P0>(&self, requestheaders: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetCustomHeaders(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCustomHeaders)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetSecurityFlags(&self, flags: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetSecurityFlags)(windows_core::Interface::as_raw(self), flags).ok() }
    }
    pub unsafe fn GetSecurityFlags(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBackgroundCopyJobHttpOptions_Impl: windows_core::IUnknownImpl {
    fn SetClientCertificateByID(&self, storelocation: BG_CERT_STORE_LOCATION, storename: &windows_core::PCWSTR, pcerthashblob: *const u8) -> Result<(), windows_result::HRESULT>;
    fn SetClientCertificateByName(&self, storelocation: BG_CERT_STORE_LOCATION, storename: &windows_core::PCWSTR, subjectname: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn RemoveClientCertificate(&self) -> Result<(), windows_result::HRESULT>;
    fn GetClientCertificate(&self, pstorelocation: *mut BG_CERT_STORE_LOCATION, pstorename: *mut windows_core::PWSTR, ppcerthashblob: *mut *mut u8, psubjectname: *mut windows_core::PWSTR) -> Result<(), windows_result::HRESULT>;
    fn SetCustomHeaders(&self, requestheaders: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetCustomHeaders(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn SetSecurityFlags(&self, flags: u32) -> Result<(), windows_result::HRESULT>;
    fn GetSecurityFlags(&self) -> Result<u32, windows_result::HRESULT>;
}
...
impl IBackgroundCopyJobHttpOptions2 {
    pub unsafe fn SetHttpMethod<P0>(&self, method: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetHttpMethod)(windows_core::Interface::as_raw(self), method.param().abi()).ok() }
    }
    pub unsafe fn GetHttpMethod(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBackgroundCopyJobHttpOptions2_Impl: IBackgroundCopyJobHttpOptions_Impl {
    fn SetHttpMethod(&self, method: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetHttpMethod(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
}
...
impl IBackgroundCopyJobHttpOptions3 {
    pub unsafe fn SetServerCertificateValidationInterface<P0>(&self, certvalidationcallback: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
    ...
    pub unsafe fn MakeCustomHeadersWriteOnly(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IBackgroundCopyJobHttpOptions3_Impl: IBackgroundCopyJobHttpOptions2_Impl {
    fn SetServerCertificateValidationInterface(&self, certvalidationcallback: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn MakeCustomHeadersWriteOnly(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IBackgroundCopyManager {
    pub unsafe fn CreateJob<P0>(&self, displayname: P0, r#type: BG_JOB_TYPE, pjobid: *mut windows_core::GUID, ppjob: *mut Option<IBackgroundCopyJob>) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetJob(&self, jobid: *const windows_core::GUID) -> Result<IBackgroundCopyJob, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumJobs(&self, dwflags: u32) -> Result<IEnumBackgroundCopyJobs, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumJobs)(windows_core::Interface::as_raw(self), dwflags, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn GetErrorDescription(&self, hresult: windows_core::HRESULT, languageid: u32) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBackgroundCopyManager_Impl: windows_core::IUnknownImpl {
    fn CreateJob(&self, displayname: &windows_core::PCWSTR, r#type: BG_JOB_TYPE, pjobid: *mut windows_core::GUID, ppjob: windows_core::OutRef<'_, IBackgroundCopyJob>) -> Result<(), windows_result::HRESULT>;
    fn GetJob(&self, jobid: *const windows_core::GUID) -> Result<IBackgroundCopyJob, windows_result::HRESULT>;
    fn EnumJobs(&self, dwflags: u32) -> Result<IEnumBackgroundCopyJobs, windows_result::HRESULT>;
    fn GetErrorDescription(&self, hresult: windows_core::HRESULT, languageid: u32) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
}
...
impl IBackgroundCopyQMgr {
    pub unsafe fn CreateGroup(&self, guidgroupid: windows_core::GUID) -> Result<IBackgroundCopyGroup, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetGroup(&self, groupid: windows_core::GUID) -> Result<IBackgroundCopyGroup, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumGroups(&self, dwflags: u32) -> Result<IEnumBackgroundCopyGroups, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBackgroundCopyQMgr_Impl: windows_core::IUnknownImpl {
    fn CreateGroup(&self, guidgroupid: &windows_core::GUID) -> Result<IBackgroundCopyGroup, windows_result::HRESULT>;
    fn GetGroup(&self, groupid: &windows_core::GUID) -> Result<IBackgroundCopyGroup, windows_result::HRESULT>;
    fn EnumGroups(&self, dwflags: u32) -> Result<IEnumBackgroundCopyGroups, windows_result::HRESULT>;
}
...
impl IBackgroundCopyServerCertificateValidationCallback {
    pub unsafe fn ValidateServerCertificate<P0, P1>(&self, job: P0, file: P1, certdata: &[u8], certencodingtype: u32, certstoredata: &[u8]) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IBackgroundCopyJob>,
        P1: windows_core::Param<IBackgroundCopyFile>,
    {
...
pub trait IBackgroundCopyServerCertificateValidationCallback_Impl: windows_core::IUnknownImpl {
    fn ValidateServerCertificate(&self, job: windows_core::Ref<'_, IBackgroundCopyJob>, file: windows_core::Ref<'_, IBackgroundCopyFile>, certlength: u32, certdata: *const u8, certencodingtype: u32, certstorelength: u32, certstoredata: *const u8) -> Result<(), windows_result::HRESULT>;
}
...
impl IBitsPeer {
    pub unsafe fn GetPeerName(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetPeerName)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn IsAuthenticated(&self) -> Result<windows_core::BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsAuthenticated)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn IsAvailable(&self) -> Result<windows_core::BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBitsPeer_Impl: windows_core::IUnknownImpl {
    fn GetPeerName(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn IsAuthenticated(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
    fn IsAvailable(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
}
impl IBitsPeer_Vtbl {
...
impl IBitsPeerCacheAdministration {
    pub unsafe fn GetMaximumCacheSize(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMaximumCacheSize)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetMaximumCacheSize(&self, bytes: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetMaximumCacheSize)(windows_core::Interface::as_raw(self), bytes).ok() }
    }
    pub unsafe fn GetMaximumContentAge(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetConfigurationFlags(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetConfigurationFlags)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetConfigurationFlags(&self, flags: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetConfigurationFlags)(windows_core::Interface::as_raw(self), flags).ok() }
    }
    pub unsafe fn EnumRecords(&self) -> Result<IEnumBitsPeerCacheRecords, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetRecord(&self, id: *const windows_core::GUID) -> Result<IBitsPeerCacheRecord, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ClearRecords(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).ClearRecords)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn DeleteRecord(&self, id: *const windows_core::GUID) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).DeleteRecord)(windows_core::Interface::as_raw(self), id).ok() }
    }
    pub unsafe fn DeleteUrl<P0>(&self, url: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DeleteUrl)(windows_core::Interface::as_raw(self), url.param().abi()).ok() }
    }
    pub unsafe fn EnumPeers(&self) -> Result<IEnumBitsPeers, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ClearPeers(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).ClearPeers)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn DiscoverPeers(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IBitsPeerCacheAdministration_Impl: windows_core::IUnknownImpl {
    fn GetMaximumCacheSize(&self) -> Result<u32, windows_result::HRESULT>;
    fn SetMaximumCacheSize(&self, bytes: u32) -> Result<(), windows_result::HRESULT>;
    fn GetMaximumContentAge(&self) -> Result<u32, windows_result::HRESULT>;
    fn SetMaximumContentAge(&self, seconds: u32) -> windows_core::HRESULT;
    fn GetConfigurationFlags(&self) -> Result<u32, windows_result::HRESULT>;
    fn SetConfigurationFlags(&self, flags: u32) -> Result<(), windows_result::HRESULT>;
    fn EnumRecords(&self) -> Result<IEnumBitsPeerCacheRecords, windows_result::HRESULT>;
    fn GetRecord(&self, id: *const windows_core::GUID) -> Result<IBitsPeerCacheRecord, windows_result::HRESULT>;
    fn ClearRecords(&self) -> Result<(), windows_result::HRESULT>;
    fn DeleteRecord(&self, id: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn DeleteUrl(&self, url: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn EnumPeers(&self) -> Result<IEnumBitsPeers, windows_result::HRESULT>;
    fn ClearPeers(&self) -> Result<(), windows_result::HRESULT>;
    fn DiscoverPeers(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IBitsPeerCacheRecord {
    ...
    pub unsafe fn GetOriginUrl(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFileModificationTime(&self) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFileModificationTime)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetLastAccessTime(&self) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLastAccessTime)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn IsFileValidated(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).IsFileValidated)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn GetFileRanges(&self, prangecount: *mut u32, ppranges: *mut *mut BG_FILE_RANGE) -> Result<(), windows_result::HRESULT> {
...
pub trait IBitsPeerCacheRecord_Impl: windows_core::IUnknownImpl {
    fn GetId(&self) -> Result<windows_core::GUID, windows_result::HRESULT>;
    fn GetOriginUrl(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetFileSize(&self) -> Result<u64, windows_result::HRESULT>;
    fn GetFileModificationTime(&self) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT>;
    fn GetLastAccessTime(&self) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT>;
    fn IsFileValidated(&self) -> Result<(), windows_result::HRESULT>;
    fn GetFileRanges(&self, prangecount: *mut u32, ppranges: *mut *mut BG_FILE_RANGE) -> Result<(), windows_result::HRESULT>;
}
...
pub trait IBitsTokenOptions_Impl: windows_core::IUnknownImpl {
    fn SetHelperTokenFlags(&self, usageflags: BG_TOKEN) -> Result<(), windows_result::HRESULT>;
    fn GetHelperTokenFlags(&self) -> Result<BG_TOKEN, windows_result::HRESULT>;
    fn SetHelperToken(&self) -> Result<(), windows_result::HRESULT>;
    fn ClearHelperToken(&self) -> Result<(), windows_result::HRESULT>;
    fn GetHelperTokenSid(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
}
...
impl IEnumBackgroundCopyFiles {
    pub unsafe fn Next(&self, rgelt: &mut [Option<IBackgroundCopyFile>], pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Clone(&self) -> Result<IEnumBackgroundCopyFiles, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IEnumBackgroundCopyFiles_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, rgelt: *mut Option<IBackgroundCopyFile>, pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT>;
    fn Reset(&self) -> Result<(), windows_result::HRESULT>;
    fn Clone(&self) -> Result<IEnumBackgroundCopyFiles, windows_result::HRESULT>;
...
impl IEnumBackgroundCopyGroups {
    ...
    pub unsafe fn Clone(&self) -> Result<IEnumBackgroundCopyGroups, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumBackgroundCopyGroups_Impl: windows_core::IUnknownImpl {
    ...
    fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT>;
    fn Reset(&self) -> Result<(), windows_result::HRESULT>;
    fn Clone(&self) -> Result<IEnumBackgroundCopyGroups, windows_result::HRESULT>;
    fn GetCount(&self) -> Result<u32, windows_result::HRESULT>;
}
...
impl IEnumBackgroundCopyJobs {
    pub unsafe fn Next(&self, rgelt: &mut [Option<IBackgroundCopyJob>], pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), rgelt.len().try_into().unwrap(), core::mem::transmute(rgelt.as_ptr()), pceltfetched as _).ok() }
    }
    pub unsafe fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Skip)(windows_core::Interface::as_raw(self), celt).ok() }
    ...
    pub unsafe fn Clone(&self) -> Result<IEnumBackgroundCopyJobs, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumBackgroundCopyJobs_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, rgelt: *mut Option<IBackgroundCopyJob>, pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT>;
    fn Reset(&self) -> Result<(), windows_result::HRESULT>;
    fn Clone(&self) -> Result<IEnumBackgroundCopyJobs, windows_result::HRESULT>;
    fn GetCount(&self) -> Result<u32, windows_result::HRESULT>;
}
...
impl IEnumBackgroundCopyJobs1 {
    ...
    pub unsafe fn Clone(&self) -> Result<IEnumBackgroundCopyJobs1, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumBackgroundCopyJobs1_Impl: windows_core::IUnknownImpl {
    ...
    fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT>;
    fn Reset(&self) -> Result<(), windows_result::HRESULT>;
    fn Clone(&self) -> Result<IEnumBackgroundCopyJobs1, windows_result::HRESULT>;
    fn GetCount(&self) -> Result<u32, windows_result::HRESULT>;
}
...
impl IEnumBitsPeerCacheRecords {
    pub unsafe fn Next(&self, rgelt: &mut [Option<IBitsPeerCacheRecord>], pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), rgelt.len().try_into().unwrap(), core::mem::transmute(rgelt.as_ptr()), pceltfetched as _).ok() }
    }
    pub unsafe fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Skip)(windows_core::Interface::as_raw(self), celt).ok() }
    ...
    pub unsafe fn Clone(&self) -> Result<IEnumBitsPeerCacheRecords, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumBitsPeerCacheRecords_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, rgelt: *mut Option<IBitsPeerCacheRecord>, pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT>;
    fn Reset(&self) -> Result<(), windows_result::HRESULT>;
    fn Clone(&self) -> Result<IEnumBitsPeerCacheRecords, windows_result::HRESULT>;
    fn GetCount(&self) -> Result<u32, windows_result::HRESULT>;
}
...
impl IEnumBitsPeers {
    pub unsafe fn Next(&self, rgelt: &mut [Option<IBitsPeer>], pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), rgelt.len().try_into().unwrap(), core::mem::transmute(rgelt.as_ptr()), pceltfetched as _).ok() }
    }
    pub unsafe fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Skip)(windows_core::Interface::as_raw(self), celt).ok() }
    ...
    pub unsafe fn Clone(&self) -> Result<IEnumBitsPeers, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumBitsPeers_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, rgelt: *mut Option<IBitsPeer>, pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT>;
    fn Reset(&self) -> Result<(), windows_result::HRESULT>;
    fn Clone(&self) -> Result<IEnumBitsPeers, windows_result::HRESULT>;
    fn GetCount(&self) -> Result<u32, windows_result::HRESULT>;
}
