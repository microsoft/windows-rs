...
impl AsyncIBackgroundCopyCallback {
    pub unsafe fn Begin_JobTransferred<P0>(&self, pjob: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn Finish_JobTransferred(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Finish_JobTransferred)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Begin_JobError<P0, P1>(&self, pjob: P0, perror: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IBackgroundCopyJob>,
    ...
    pub unsafe fn Finish_JobError(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Finish_JobError)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Begin_JobModification<P0>(&self, pjob: P0, dwreserved: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IBackgroundCopyJob>,
    {
    ...
    pub unsafe fn Finish_JobModification(&self) -> windows_result::Result<()> {
...
pub trait AsyncIBackgroundCopyCallback_Impl: windows_core::IUnknownImpl {
    fn Begin_JobTransferred(&self, pjob: windows_core::Ref<IBackgroundCopyJob>) -> windows_result::Result<()>;
    fn Finish_JobTransferred(&self) -> windows_result::Result<()>;
    fn Begin_JobError(&self, pjob: windows_core::Ref<IBackgroundCopyJob>, perror: windows_core::Ref<IBackgroundCopyError>) -> windows_result::Result<()>;
    fn Finish_JobError(&self) -> windows_result::Result<()>;
    fn Begin_JobModification(&self, pjob: windows_core::Ref<IBackgroundCopyJob>, dwreserved: u32) -> windows_result::Result<()>;
    fn Finish_JobModification(&self) -> windows_result::Result<()>;
}
...
impl IBITSExtensionSetup {
    ...
    pub unsafe fn GetCleanupTask(&self, riid: *const windows_core::GUID) -> windows_result::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBITSExtensionSetup_Impl: super::super::System::Com::IDispatch_Impl {
    fn EnableBITSUploads(&self) -> windows_result::Result<()>;
    fn DisableBITSUploads(&self) -> windows_result::Result<()>;
    fn GetCleanupTaskName(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetCleanupTask(&self, riid: *const windows_core::GUID) -> windows_result::Result<windows_core::IUnknown>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IBITSExtensionSetupFactory {
    pub unsafe fn GetObject(&self, path: &windows_core::BSTR) -> windows_result::Result<IBITSExtensionSetup> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBITSExtensionSetupFactory_Impl: super::super::System::Com::IDispatch_Impl {
    fn GetObject(&self, path: &windows_core::BSTR) -> windows_result::Result<IBITSExtensionSetup>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IBackgroundCopyCallback {
    pub unsafe fn JobTransferred<P0>(&self, pjob: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IBackgroundCopyJob>,
    {
        unsafe { (windows_core::Interface::vtable(self).JobTransferred)(windows_core::Interface::as_raw(self), pjob.param().abi()).ok() }
    }
    pub unsafe fn JobError<P0, P1>(&self, pjob: P0, perror: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IBackgroundCopyJob>,
        P1: windows_core::Param<IBackgroundCopyError>,
    {
    ...
    pub unsafe fn JobModification<P0>(&self, pjob: P0, dwreserved: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IBackgroundCopyJob>,
    {
...
pub trait IBackgroundCopyCallback_Impl: windows_core::IUnknownImpl {
    fn JobTransferred(&self, pjob: windows_core::Ref<IBackgroundCopyJob>) -> windows_result::Result<()>;
    fn JobError(&self, pjob: windows_core::Ref<IBackgroundCopyJob>, perror: windows_core::Ref<IBackgroundCopyError>) -> windows_result::Result<()>;
    fn JobModification(&self, pjob: windows_core::Ref<IBackgroundCopyJob>, dwreserved: u32) -> windows_result::Result<()>;
}
...
impl IBackgroundCopyCallback1 {
    pub unsafe fn OnStatus<P0, P1>(&self, pgroup: P0, pjob: P1, dwfileindex: u32, dwstatus: u32, dwnumofretries: u32, dwwin32result: u32, dwtransportresult: u32) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn OnProgress<P1, P2>(&self, progresstype: u32, pgroup: P1, pjob: P2, dwfileindex: u32, dwprogressvalue: u32) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn OnProgressEx<P1, P2>(&self, progresstype: u32, pgroup: P1, pjob: P2, dwfileindex: u32, dwprogressvalue: u32, pbyte: &[u8]) -> windows_result::Result<()>
    where
        P1: windows_core::Param<IBackgroundCopyGroup>,
        P2: windows_core::Param<IBackgroundCopyJob1>,
    {
...
pub trait IBackgroundCopyCallback1_Impl: windows_core::IUnknownImpl {
    fn OnStatus(&self, pgroup: windows_core::Ref<IBackgroundCopyGroup>, pjob: windows_core::Ref<IBackgroundCopyJob1>, dwfileindex: u32, dwstatus: u32, dwnumofretries: u32, dwwin32result: u32, dwtransportresult: u32) -> windows_result::Result<()>;
    fn OnProgress(&self, progresstype: u32, pgroup: windows_core::Ref<IBackgroundCopyGroup>, pjob: windows_core::Ref<IBackgroundCopyJob1>, dwfileindex: u32, dwprogressvalue: u32) -> windows_result::Result<()>;
    fn OnProgressEx(&self, progresstype: u32, pgroup: windows_core::Ref<IBackgroundCopyGroup>, pjob: windows_core::Ref<IBackgroundCopyJob1>, dwfileindex: u32, dwprogressvalue: u32, dwbytearraysize: u32, pbyte: *const u8) -> windows_result::Result<()>;
}
...
impl IBackgroundCopyCallback2 {
    pub unsafe fn FileTransferred<P0, P1>(&self, pjob: P0, pfile: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IBackgroundCopyJob>,
...
pub trait IBackgroundCopyCallback2_Impl: IBackgroundCopyCallback_Impl {
    fn FileTransferred(&self, pjob: windows_core::Ref<IBackgroundCopyJob>, pfile: windows_core::Ref<IBackgroundCopyFile>) -> windows_result::Result<()>;
}
...
impl IBackgroundCopyCallback3 {
    pub unsafe fn FileRangesTransferred<P0, P1>(&self, job: P0, file: P1, ranges: &[BG_FILE_RANGE]) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IBackgroundCopyJob>,
        P1: windows_core::Param<IBackgroundCopyFile>,
    {
...
pub trait IBackgroundCopyCallback3_Impl: IBackgroundCopyCallback2_Impl {
    fn FileRangesTransferred(&self, job: windows_core::Ref<IBackgroundCopyJob>, file: windows_core::Ref<IBackgroundCopyFile>, rangecount: u32, ranges: *const BG_FILE_RANGE) -> windows_result::Result<()>;
}
...
impl IBackgroundCopyError {
    pub unsafe fn GetError(&self, pcontext: *mut BG_ERROR_CONTEXT, pcode: *mut windows_core::HRESULT) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetError)(windows_core::Interface::as_raw(self), pcontext as _, pcode as _).ok() }
    }
    pub unsafe fn GetFile(&self) -> windows_result::Result<IBackgroundCopyFile> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetErrorDescription(&self, languageid: u32) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetErrorContextDescription(&self, languageid: u32) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetProtocol(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBackgroundCopyError_Impl: windows_core::IUnknownImpl {
    fn GetError(&self, pcontext: *mut BG_ERROR_CONTEXT, pcode: *mut windows_core::HRESULT) -> windows_result::Result<()>;
    fn GetFile(&self) -> windows_result::Result<IBackgroundCopyFile>;
    fn GetErrorDescription(&self, languageid: u32) -> windows_result::Result<windows_core::PWSTR>;
    fn GetErrorContextDescription(&self, languageid: u32) -> windows_result::Result<windows_core::PWSTR>;
    fn GetProtocol(&self) -> windows_result::Result<windows_core::PWSTR>;
}
...
impl IBackgroundCopyFile {
    pub unsafe fn GetRemoteName(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRemoteName)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetLocalName(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLocalName)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetProgress(&self, pval: *mut BG_FILE_PROGRESS) -> windows_result::Result<()> {
...
pub trait IBackgroundCopyFile_Impl: windows_core::IUnknownImpl {
    fn GetRemoteName(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn GetLocalName(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn GetProgress(&self, pval: *mut BG_FILE_PROGRESS) -> windows_result::Result<()>;
}
...
impl IBackgroundCopyFile2 {
    pub unsafe fn GetFileRanges(&self, rangecount: *mut u32, ranges: *mut *mut BG_FILE_RANGE) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetRemoteName<P0>(&self, val: P0) -> windows_result::Result<()>
    where
...
pub trait IBackgroundCopyFile2_Impl: IBackgroundCopyFile_Impl {
    fn GetFileRanges(&self, rangecount: *mut u32, ranges: *mut *mut BG_FILE_RANGE) -> windows_result::Result<()>;
    fn SetRemoteName(&self, val: &windows_core::PCWSTR) -> windows_result::Result<()>;
}
...
pub trait IBackgroundCopyFile3_Impl: IBackgroundCopyFile2_Impl {
    fn GetTemporaryName(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetValidationState(&self, state: windows_core::BOOL) -> windows_result::Result<()>;
    fn GetValidationState(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsDownloadedFromPeer(&self) -> windows_result::Result<windows_core::BOOL>;
}
...
impl IBackgroundCopyFile4 {
    pub unsafe fn GetPeerDownloadStats(&self, pfromorigin: *mut u64, pfrompeers: *mut u64) -> windows_result::Result<()> {
...
pub trait IBackgroundCopyFile4_Impl: IBackgroundCopyFile3_Impl {
    fn GetPeerDownloadStats(&self, pfromorigin: *mut u64, pfrompeers: *mut u64) -> windows_result::Result<()>;
}
...
impl IBackgroundCopyFile5 {
    pub unsafe fn SetProperty(&self, propertyid: BITS_FILE_PROPERTY_ID, propertyvalue: BITS_FILE_PROPERTY_VALUE) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetProperty(&self, propertyid: BITS_FILE_PROPERTY_ID) -> windows_result::Result<BITS_FILE_PROPERTY_VALUE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBackgroundCopyFile5_Impl: IBackgroundCopyFile4_Impl {
    fn SetProperty(&self, propertyid: BITS_FILE_PROPERTY_ID, propertyvalue: &BITS_FILE_PROPERTY_VALUE) -> windows_result::Result<()>;
    fn GetProperty(&self, propertyid: BITS_FILE_PROPERTY_ID) -> windows_result::Result<BITS_FILE_PROPERTY_VALUE>;
}
...
impl IBackgroundCopyFile6 {
    pub unsafe fn UpdateDownloadPosition(&self, offset: u64) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).UpdateDownloadPosition)(windows_core::Interface::as_raw(self), offset).ok() }
    }
    pub unsafe fn RequestFileRanges(&self, ranges: &[BG_FILE_RANGE]) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFilledFileRanges(&self, rangecount: *mut u32, ranges: *mut *mut BG_FILE_RANGE) -> windows_result::Result<()> {
...
pub trait IBackgroundCopyFile6_Impl: IBackgroundCopyFile5_Impl {
    fn UpdateDownloadPosition(&self, offset: u64) -> windows_result::Result<()>;
    fn RequestFileRanges(&self, rangecount: u32, ranges: *const BG_FILE_RANGE) -> windows_result::Result<()>;
    fn GetFilledFileRanges(&self, rangecount: *mut u32, ranges: *mut *mut BG_FILE_RANGE) -> windows_result::Result<()>;
}
...
impl IBackgroundCopyGroup {
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetProp(&self, propid: GROUPPROP) -> windows_result::Result<super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn SetProp(&self, propid: GROUPPROP, pvarval: *const super::super::System::Variant::VARIANT) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetProgress(&self, dwflags: u32) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetProgress)(windows_core::Interface::as_raw(self), dwflags, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetStatus(&self, pdwstatus: *mut u32, pdwjobindex: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetJob(&self, jobid: windows_core::GUID) -> windows_result::Result<IBackgroundCopyJob1> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GroupID(&self) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GroupID)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn CreateJob(&self, guidjobid: windows_core::GUID) -> windows_result::Result<IBackgroundCopyJob1> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumJobs(&self, dwflags: u32) -> windows_result::Result<IEnumBackgroundCopyJobs1> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SwitchToForeground(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SwitchToForeground)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn QueryNewJobInterface(&self, iid: *const windows_core::GUID) -> windows_result::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetNotificationPointer<P1>(&self, iid: *const windows_core::GUID, punk: P1) -> windows_result::Result<()>
    where
...
pub trait IBackgroundCopyGroup_Impl: windows_core::IUnknownImpl {
    fn GetProp(&self, propid: GROUPPROP) -> windows_result::Result<super::super::System::Variant::VARIANT>;
    fn SetProp(&self, propid: GROUPPROP, pvarval: *const super::super::System::Variant::VARIANT) -> windows_result::Result<()>;
    fn GetProgress(&self, dwflags: u32) -> windows_result::Result<u32>;
    fn GetStatus(&self, pdwstatus: *mut u32, pdwjobindex: *mut u32) -> windows_result::Result<()>;
    fn GetJob(&self, jobid: &windows_core::GUID) -> windows_result::Result<IBackgroundCopyJob1>;
    fn SuspendGroup(&self) -> windows_result::Result<()>;
    fn ResumeGroup(&self) -> windows_result::Result<()>;
    fn CancelGroup(&self) -> windows_result::Result<()>;
    fn Size(&self) -> windows_result::Result<u32>;
    fn GroupID(&self) -> windows_result::Result<windows_core::GUID>;
    fn CreateJob(&self, guidjobid: &windows_core::GUID) -> windows_result::Result<IBackgroundCopyJob1>;
    fn EnumJobs(&self, dwflags: u32) -> windows_result::Result<IEnumBackgroundCopyJobs1>;
    fn SwitchToForeground(&self) -> windows_result::Result<()>;
    fn QueryNewJobInterface(&self, iid: *const windows_core::GUID) -> windows_result::Result<windows_core::IUnknown>;
    fn SetNotificationPointer(&self, iid: *const windows_core::GUID, punk: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IBackgroundCopyJob {
    pub unsafe fn AddFileSet(&self, pfileset: &[BG_FILE_INFO]) -> windows_result::Result<()> {
    ...
    pub unsafe fn AddFile<P0, P1>(&self, remoteurl: P0, localname: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn EnumFiles(&self) -> windows_result::Result<IEnumBackgroundCopyFiles> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetType(&self) -> windows_result::Result<BG_JOB_TYPE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetType)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetProgress(&self, pval: *mut BG_JOB_PROGRESS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProgress)(windows_core::Interface::as_raw(self), pval as _).ok() }
    }
    pub unsafe fn GetTimes(&self, pval: *mut BG_JOB_TIMES) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetTimes)(windows_core::Interface::as_raw(self), pval as _).ok() }
    }
    pub unsafe fn GetState(&self) -> windows_result::Result<BG_JOB_STATE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetState)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetError(&self) -> windows_result::Result<IBackgroundCopyError> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetProxySettings(&self, pproxyusage: *mut BG_JOB_PROXY_USAGE, pproxylist: *mut windows_core::PWSTR, pproxybypasslist: *mut windows_core::PWSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn TakeOwnership(&self) -> windows_result::Result<()> {
...
pub trait IBackgroundCopyJob_Impl: windows_core::IUnknownImpl {
    fn AddFileSet(&self, cfilecount: u32, pfileset: *const BG_FILE_INFO) -> windows_result::Result<()>;
    fn AddFile(&self, remoteurl: &windows_core::PCWSTR, localname: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn EnumFiles(&self) -> windows_result::Result<IEnumBackgroundCopyFiles>;
    ...
    fn GetType(&self) -> windows_result::Result<BG_JOB_TYPE>;
    fn GetProgress(&self, pval: *mut BG_JOB_PROGRESS) -> windows_result::Result<()>;
    fn GetTimes(&self, pval: *mut BG_JOB_TIMES) -> windows_result::Result<()>;
    fn GetState(&self) -> windows_result::Result<BG_JOB_STATE>;
    fn GetError(&self) -> windows_result::Result<IBackgroundCopyError>;
    fn GetOwner(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetDisplayName(&self, val: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetDisplayName(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetDescription(&self, val: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetDescription(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetPriority(&self, val: BG_JOB_PRIORITY) -> windows_result::Result<()>;
    fn GetPriority(&self) -> windows_result::Result<BG_JOB_PRIORITY>;
    fn SetNotifyFlags(&self, val: u32) -> windows_result::Result<()>;
    fn GetNotifyFlags(&self) -> windows_result::Result<u32>;
    fn SetNotifyInterface(&self, val: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn GetNotifyInterface(&self) -> windows_result::Result<windows_core::IUnknown>;
    fn SetMinimumRetryDelay(&self, seconds: u32) -> windows_result::Result<()>;
    fn GetMinimumRetryDelay(&self) -> windows_result::Result<u32>;
    fn SetNoProgressTimeout(&self, seconds: u32) -> windows_result::Result<()>;
    fn GetNoProgressTimeout(&self) -> windows_result::Result<u32>;
    fn GetErrorCount(&self) -> windows_result::Result<u32>;
    fn SetProxySettings(&self, proxyusage: BG_JOB_PROXY_USAGE, proxylist: &windows_core::PCWSTR, proxybypasslist: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetProxySettings(&self, pproxyusage: *mut BG_JOB_PROXY_USAGE, pproxylist: *mut windows_core::PWSTR, pproxybypasslist: *mut windows_core::PWSTR) -> windows_result::Result<()>;
    fn TakeOwnership(&self) -> windows_result::Result<()>;
}
...
impl IBackgroundCopyJob1 {
    pub unsafe fn CancelJob(&self) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetStatus(&self, pdwstatus: *mut u32, pdwwin32result: *mut u32, pdwtransportresult: *mut u32, pdwnumofretries: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn AddFiles(&self, ppfileset: &[*const FILESETINFO]) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFile(&self, cfileindex: u32) -> windows_result::Result<FILESETINFO> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFileCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn JobID(&self) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBackgroundCopyJob1_Impl: windows_core::IUnknownImpl {
    fn CancelJob(&self) -> windows_result::Result<()>;
    fn GetProgress(&self, dwflags: u32) -> windows_result::Result<u32>;
    fn GetStatus(&self, pdwstatus: *mut u32, pdwwin32result: *mut u32, pdwtransportresult: *mut u32, pdwnumofretries: *mut u32) -> windows_result::Result<()>;
    fn AddFiles(&self, cfilecount: u32, ppfileset: *const *const FILESETINFO) -> windows_result::Result<()>;
    fn GetFile(&self, cfileindex: u32) -> windows_result::Result<FILESETINFO>;
    fn GetFileCount(&self) -> windows_result::Result<u32>;
    fn SwitchToForeground(&self) -> windows_result::Result<()>;
    fn JobID(&self) -> windows_result::Result<windows_core::GUID>;
}
...
impl IBackgroundCopyJob2 {
    pub unsafe fn SetNotifyCmdLine<P0, P1>(&self, program: P0, parameters: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetNotifyCmdLine(&self, pprogram: *mut windows_core::PWSTR, pparameters: *mut windows_core::PWSTR) -> windows_result::Result<()> {
...
pub trait IBackgroundCopyJob2_Impl: IBackgroundCopyJob_Impl {
    fn SetNotifyCmdLine(&self, program: &windows_core::PCWSTR, parameters: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetNotifyCmdLine(&self, pprogram: *mut windows_core::PWSTR, pparameters: *mut windows_core::PWSTR) -> windows_result::Result<()>;
    fn GetReplyProgress(&self, pprogress: *mut BG_JOB_REPLY_PROGRESS) -> windows_result::Result<()>;
    fn GetReplyData(&self, ppbuffer: *mut *mut u8, plength: *mut u64) -> windows_result::Result<()>;
    fn SetReplyFileName(&self, replyfilename: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetReplyFileName(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetCredentials(&self, credentials: *const BG_AUTH_CREDENTIALS) -> windows_result::Result<()>;
    fn RemoveCredentials(&self, target: BG_AUTH_TARGET, scheme: BG_AUTH_SCHEME) -> windows_result::Result<()>;
}
...
impl IBackgroundCopyJob3 {
    pub unsafe fn ReplaceRemotePrefix<P0, P1>(&self, oldprefix: P0, newprefix: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn AddFileWithRanges<P0, P1>(&self, remoteurl: P0, localname: P1, ranges: &[BG_FILE_RANGE]) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetFileACLFlags(&self, flags: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetFileACLFlags)(windows_core::Interface::as_raw(self), flags).ok() }
    }
    pub unsafe fn GetFileACLFlags(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBackgroundCopyJob3_Impl: IBackgroundCopyJob2_Impl {
    fn ReplaceRemotePrefix(&self, oldprefix: &windows_core::PCWSTR, newprefix: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn AddFileWithRanges(&self, remoteurl: &windows_core::PCWSTR, localname: &windows_core::PCWSTR, rangecount: u32, ranges: *const BG_FILE_RANGE) -> windows_result::Result<()>;
    fn SetFileACLFlags(&self, flags: u32) -> windows_result::Result<()>;
    fn GetFileACLFlags(&self) -> windows_result::Result<u32>;
}
...
pub trait IBackgroundCopyJob4_Impl: IBackgroundCopyJob3_Impl {
    fn SetPeerCachingFlags(&self, flags: u32) -> windows_result::Result<()>;
    fn GetPeerCachingFlags(&self) -> windows_result::Result<u32>;
    fn GetOwnerIntegrityLevel(&self) -> windows_result::Result<u32>;
    fn GetOwnerElevationState(&self) -> windows_result::Result<windows_core::BOOL>;
    fn SetMaximumDownloadTime(&self, timeout: u32) -> windows_result::Result<()>;
    fn GetMaximumDownloadTime(&self) -> windows_result::Result<u32>;
}
...
impl IBackgroundCopyJob5 {
    pub unsafe fn SetProperty(&self, propertyid: BITS_JOB_PROPERTY_ID, propertyvalue: BITS_JOB_PROPERTY_VALUE) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetProperty)(windows_core::Interface::as_raw(self), propertyid, core::mem::transmute(propertyvalue)).ok() }
    }
    pub unsafe fn GetProperty(&self, propertyid: BITS_JOB_PROPERTY_ID) -> windows_result::Result<BITS_JOB_PROPERTY_VALUE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetProperty)(windows_core::Interface::as_raw(self), propertyid, &mut result__).map(|| result__)
        }
...
pub trait IBackgroundCopyJob5_Impl: IBackgroundCopyJob4_Impl {
    fn SetProperty(&self, propertyid: BITS_JOB_PROPERTY_ID, propertyvalue: &BITS_JOB_PROPERTY_VALUE) -> windows_result::Result<()>;
    fn GetProperty(&self, propertyid: BITS_JOB_PROPERTY_ID) -> windows_result::Result<BITS_JOB_PROPERTY_VALUE>;
}
...
impl IBackgroundCopyJobHttpOptions {
    pub unsafe fn SetClientCertificateByID<P1>(&self, storelocation: BG_CERT_STORE_LOCATION, storename: P1, pcerthashblob: &[u8; 20]) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetClientCertificateByName<P1, P2>(&self, storelocation: BG_CERT_STORE_LOCATION, storename: P1, subjectname: P2) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn RemoveClientCertificate(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).RemoveClientCertificate)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn GetClientCertificate(&self, pstorelocation: *mut BG_CERT_STORE_LOCATION, pstorename: *mut windows_core::PWSTR, ppcerthashblob: *mut *mut u8, psubjectname: *mut windows_core::PWSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetCustomHeaders<P0>(&self, requestheaders: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IBackgroundCopyJobHttpOptions_Impl: windows_core::IUnknownImpl {
    fn SetClientCertificateByID(&self, storelocation: BG_CERT_STORE_LOCATION, storename: &windows_core::PCWSTR, pcerthashblob: *const u8) -> windows_result::Result<()>;
    fn SetClientCertificateByName(&self, storelocation: BG_CERT_STORE_LOCATION, storename: &windows_core::PCWSTR, subjectname: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn RemoveClientCertificate(&self) -> windows_result::Result<()>;
    fn GetClientCertificate(&self, pstorelocation: *mut BG_CERT_STORE_LOCATION, pstorename: *mut windows_core::PWSTR, ppcerthashblob: *mut *mut u8, psubjectname: *mut windows_core::PWSTR) -> windows_result::Result<()>;
    fn SetCustomHeaders(&self, requestheaders: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetCustomHeaders(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetSecurityFlags(&self, flags: u32) -> windows_result::Result<()>;
    fn GetSecurityFlags(&self) -> windows_result::Result<u32>;
}
...
impl IBackgroundCopyJobHttpOptions2 {
    pub unsafe fn SetHttpMethod<P0>(&self, method: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetHttpMethod)(windows_core::Interface::as_raw(self), method.param().abi()).ok() }
    }
    pub unsafe fn GetHttpMethod(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBackgroundCopyJobHttpOptions2_Impl: IBackgroundCopyJobHttpOptions_Impl {
    fn SetHttpMethod(&self, method: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetHttpMethod(&self) -> windows_result::Result<windows_core::PWSTR>;
}
...
impl IBackgroundCopyJobHttpOptions3 {
    pub unsafe fn SetServerCertificateValidationInterface<P0>(&self, certvalidationcallback: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
    ...
    pub unsafe fn MakeCustomHeadersWriteOnly(&self) -> windows_result::Result<()> {
...
pub trait IBackgroundCopyJobHttpOptions3_Impl: IBackgroundCopyJobHttpOptions2_Impl {
    fn SetServerCertificateValidationInterface(&self, certvalidationcallback: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn MakeCustomHeadersWriteOnly(&self) -> windows_result::Result<()>;
}
...
impl IBackgroundCopyManager {
    pub unsafe fn CreateJob<P0>(&self, displayname: P0, r#type: BG_JOB_TYPE, pjobid: *mut windows_core::GUID, ppjob: *mut Option<IBackgroundCopyJob>) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetJob(&self, jobid: *const windows_core::GUID) -> windows_result::Result<IBackgroundCopyJob> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumJobs(&self, dwflags: u32) -> windows_result::Result<IEnumBackgroundCopyJobs> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumJobs)(windows_core::Interface::as_raw(self), dwflags, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn GetErrorDescription(&self, hresult: windows_core::HRESULT, languageid: u32) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBackgroundCopyManager_Impl: windows_core::IUnknownImpl {
    fn CreateJob(&self, displayname: &windows_core::PCWSTR, r#type: BG_JOB_TYPE, pjobid: *mut windows_core::GUID, ppjob: windows_core::OutRef<IBackgroundCopyJob>) -> windows_result::Result<()>;
    fn GetJob(&self, jobid: *const windows_core::GUID) -> windows_result::Result<IBackgroundCopyJob>;
    fn EnumJobs(&self, dwflags: u32) -> windows_result::Result<IEnumBackgroundCopyJobs>;
    fn GetErrorDescription(&self, hresult: windows_core::HRESULT, languageid: u32) -> windows_result::Result<windows_core::PWSTR>;
}
...
impl IBackgroundCopyQMgr {
    pub unsafe fn CreateGroup(&self, guidgroupid: windows_core::GUID) -> windows_result::Result<IBackgroundCopyGroup> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetGroup(&self, groupid: windows_core::GUID) -> windows_result::Result<IBackgroundCopyGroup> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumGroups(&self, dwflags: u32) -> windows_result::Result<IEnumBackgroundCopyGroups> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IBackgroundCopyQMgr_Impl: windows_core::IUnknownImpl {
    fn CreateGroup(&self, guidgroupid: &windows_core::GUID) -> windows_result::Result<IBackgroundCopyGroup>;
    fn GetGroup(&self, groupid: &windows_core::GUID) -> windows_result::Result<IBackgroundCopyGroup>;
    fn EnumGroups(&self, dwflags: u32) -> windows_result::Result<IEnumBackgroundCopyGroups>;
}
...
impl IBackgroundCopyServerCertificateValidationCallback {
    pub unsafe fn ValidateServerCertificate<P0, P1>(&self, job: P0, file: P1, certdata: &[u8], certencodingtype: u32, certstoredata: &[u8]) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IBackgroundCopyJob>,
        P1: windows_core::Param<IBackgroundCopyFile>,
    {
...
pub trait IBackgroundCopyServerCertificateValidationCallback_Impl: windows_core::IUnknownImpl {
    fn ValidateServerCertificate(&self, job: windows_core::Ref<IBackgroundCopyJob>, file: windows_core::Ref<IBackgroundCopyFile>, certlength: u32, certdata: *const u8, certencodingtype: u32, certstorelength: u32, certstoredata: *const u8) -> windows_result::Result<()>;
}
...
pub trait IBitsPeer_Impl: windows_core::IUnknownImpl {
    fn GetPeerName(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn IsAuthenticated(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsAvailable(&self) -> windows_result::Result<windows_core::BOOL>;
}
impl IBitsPeer_Vtbl {
...
impl IBitsPeerCacheAdministration {
    ...
    pub unsafe fn GetRecord(&self, id: *const windows_core::GUID) -> windows_result::Result<IBitsPeerCacheRecord> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ClearPeers(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ClearPeers)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn DiscoverPeers(&self) -> windows_result::Result<()> {
...
pub trait IBitsPeerCacheAdministration_Impl: windows_core::IUnknownImpl {
    fn GetMaximumCacheSize(&self) -> windows_result::Result<u32>;
    fn SetMaximumCacheSize(&self, bytes: u32) -> windows_result::Result<()>;
    fn GetMaximumContentAge(&self) -> windows_result::Result<u32>;
    fn SetMaximumContentAge(&self, seconds: u32) -> windows_core::HRESULT;
    fn GetConfigurationFlags(&self) -> windows_result::Result<u32>;
    fn SetConfigurationFlags(&self, flags: u32) -> windows_result::Result<()>;
    fn EnumRecords(&self) -> windows_result::Result<IEnumBitsPeerCacheRecords>;
    fn GetRecord(&self, id: *const windows_core::GUID) -> windows_result::Result<IBitsPeerCacheRecord>;
    fn ClearRecords(&self) -> windows_result::Result<()>;
    fn DeleteRecord(&self, id: *const windows_core::GUID) -> windows_result::Result<()>;
    fn DeleteUrl(&self, url: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn EnumPeers(&self) -> windows_result::Result<IEnumBitsPeers>;
    fn ClearPeers(&self) -> windows_result::Result<()>;
    fn DiscoverPeers(&self) -> windows_result::Result<()>;
}
...
impl IBitsPeerCacheRecord {
    ...
    pub unsafe fn GetOriginUrl(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFileModificationTime(&self) -> windows_result::Result<super::super::Foundation::FILETIME> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFileModificationTime)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetLastAccessTime(&self) -> windows_result::Result<super::super::Foundation::FILETIME> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLastAccessTime)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn IsFileValidated(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).IsFileValidated)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn GetFileRanges(&self, prangecount: *mut u32, ppranges: *mut *mut BG_FILE_RANGE) -> windows_result::Result<()> {
...
pub trait IBitsPeerCacheRecord_Impl: windows_core::IUnknownImpl {
    fn GetId(&self) -> windows_result::Result<windows_core::GUID>;
    fn GetOriginUrl(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn GetFileSize(&self) -> windows_result::Result<u64>;
    fn GetFileModificationTime(&self) -> windows_result::Result<super::super::Foundation::FILETIME>;
    fn GetLastAccessTime(&self) -> windows_result::Result<super::super::Foundation::FILETIME>;
    fn IsFileValidated(&self) -> windows_result::Result<()>;
    fn GetFileRanges(&self, prangecount: *mut u32, ppranges: *mut *mut BG_FILE_RANGE) -> windows_result::Result<()>;
}
...
pub trait IBitsTokenOptions_Impl: windows_core::IUnknownImpl {
    fn SetHelperTokenFlags(&self, usageflags: BG_TOKEN) -> windows_result::Result<()>;
    fn GetHelperTokenFlags(&self) -> windows_result::Result<BG_TOKEN>;
    fn SetHelperToken(&self) -> windows_result::Result<()>;
    fn ClearHelperToken(&self) -> windows_result::Result<()>;
    fn GetHelperTokenSid(&self) -> windows_result::Result<windows_core::PWSTR>;
}
...
impl IEnumBackgroundCopyFiles {
    pub unsafe fn Next(&self, rgelt: &mut [Option<IBackgroundCopyFile>], pceltfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumBackgroundCopyFiles> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IEnumBackgroundCopyFiles_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, rgelt: *mut Option<IBackgroundCopyFile>, pceltfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumBackgroundCopyFiles>;
...
impl IEnumBackgroundCopyGroups {
    pub unsafe fn Next(&self, rgelt: &mut [windows_core::GUID], pceltfetched: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), rgelt.len().try_into().unwrap(), core::mem::transmute(rgelt.as_ptr()), pceltfetched as _).ok() }
    }
    pub unsafe fn Skip(&self, celt: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Skip)(windows_core::Interface::as_raw(self), celt).ok() }
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumBackgroundCopyGroups> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumBackgroundCopyGroups_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, rgelt: *mut windows_core::GUID, pceltfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumBackgroundCopyGroups>;
    fn GetCount(&self) -> windows_result::Result<u32>;
}
...
impl IEnumBackgroundCopyJobs {
    pub unsafe fn Next(&self, rgelt: &mut [Option<IBackgroundCopyJob>], pceltfetched: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), rgelt.len().try_into().unwrap(), core::mem::transmute(rgelt.as_ptr()), pceltfetched as _).ok() }
    }
    pub unsafe fn Skip(&self, celt: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Skip)(windows_core::Interface::as_raw(self), celt).ok() }
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumBackgroundCopyJobs> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumBackgroundCopyJobs_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, rgelt: *mut Option<IBackgroundCopyJob>, pceltfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumBackgroundCopyJobs>;
    fn GetCount(&self) -> windows_result::Result<u32>;
}
...
impl IEnumBackgroundCopyJobs1 {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumBackgroundCopyJobs1> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumBackgroundCopyJobs1_Impl: windows_core::IUnknownImpl {
    ...
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumBackgroundCopyJobs1>;
    fn GetCount(&self) -> windows_result::Result<u32>;
}
...
impl IEnumBitsPeerCacheRecords {
    pub unsafe fn Next(&self, rgelt: &mut [Option<IBitsPeerCacheRecord>], pceltfetched: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), rgelt.len().try_into().unwrap(), core::mem::transmute(rgelt.as_ptr()), pceltfetched as _).ok() }
    }
    pub unsafe fn Skip(&self, celt: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Skip)(windows_core::Interface::as_raw(self), celt).ok() }
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumBitsPeerCacheRecords> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumBitsPeerCacheRecords_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, rgelt: *mut Option<IBitsPeerCacheRecord>, pceltfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumBitsPeerCacheRecords>;
    fn GetCount(&self) -> windows_result::Result<u32>;
}
...
impl IEnumBitsPeers {
    pub unsafe fn Next(&self, rgelt: &mut [Option<IBitsPeer>], pceltfetched: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), rgelt.len().try_into().unwrap(), core::mem::transmute(rgelt.as_ptr()), pceltfetched as _).ok() }
    }
    pub unsafe fn Skip(&self, celt: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Skip)(windows_core::Interface::as_raw(self), celt).ok() }
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumBitsPeers> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumBitsPeers_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, rgelt: *mut Option<IBitsPeer>, pceltfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumBitsPeers>;
    fn GetCount(&self) -> windows_result::Result<u32>;
}
