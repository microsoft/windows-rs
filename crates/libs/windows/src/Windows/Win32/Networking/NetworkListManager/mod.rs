...
impl IEnumNetworkConnections {
    ...
    pub unsafe fn _NewEnum(&self) -> Result<super::super::System::Ole::IEnumVARIANT, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self)._NewEnum)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn Next(&self, rgelt: &mut [Option<INetworkConnection>], pceltfetched: Option<*mut u32>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Clone(&self) -> Result<IEnumNetworkConnections, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IEnumNetworkConnections_Impl: super::super::System::Com::IDispatch_Impl {
    fn _NewEnum(&self) -> Result<super::super::System::Ole::IEnumVARIANT, windows_result::HRESULT>;
    fn Next(&self, celt: u32, rgelt: *mut Option<INetworkConnection>, pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT>;
    fn Reset(&self) -> Result<(), windows_result::HRESULT>;
    fn Clone(&self) -> Result<IEnumNetworkConnections, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IEnumNetworks {
    ...
    pub unsafe fn Next(&self, rgelt: &mut [Option<INetwork>], pceltfetched: Option<*mut u32>) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), rgelt.len().try_into().unwrap(), core::mem::transmute(rgelt.as_ptr()), pceltfetched.unwrap_or(core::mem::zeroed()) as _).ok() }
    }
    pub unsafe fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Skip)(windows_core::Interface::as_raw(self), celt).ok() }
    ...
    pub unsafe fn Clone(&self) -> Result<IEnumNetworks, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumNetworks_Impl: super::super::System::Com::IDispatch_Impl {
    fn _NewEnum(&self) -> Result<super::super::System::Ole::IEnumVARIANT, windows_result::HRESULT>;
    fn Next(&self, celt: u32, rgelt: *mut Option<INetwork>, pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT>;
    fn Reset(&self) -> Result<(), windows_result::HRESULT>;
    fn Clone(&self) -> Result<IEnumNetworks, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl INetwork {
    ...
    pub unsafe fn SetName(&self, sznetworknewname: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetDescription(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetDescription(&self, szdescription: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetNetworkId(&self) -> Result<windows_core::GUID, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNetworkId)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetDomainType(&self) -> Result<NLM_DOMAIN_TYPE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDomainType)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetNetworkConnections(&self) -> Result<IEnumNetworkConnections, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetTimeCreatedAndConnected(&self, pdwlowdatetimecreated: *mut u32, pdwhighdatetimecreated: *mut u32, pdwlowdatetimeconnected: *mut u32, pdwhighdatetimeconnected: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn IsConnectedToInternet(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsConnectedToInternet)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn IsConnected(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsConnected)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetConnectivity(&self) -> Result<NLM_CONNECTIVITY, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetConnectivity)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetCategory(&self) -> Result<NLM_NETWORK_CATEGORY, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCategory)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetCategory(&self, newcategory: NLM_NETWORK_CATEGORY) -> Result<(), windows_result::HRESULT> {
...
pub trait INetwork_Impl: super::super::System::Com::IDispatch_Impl {
    ...
    fn SetName(&self, sznetworknewname: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn GetDescription(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetDescription(&self, szdescription: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn GetNetworkId(&self) -> Result<windows_core::GUID, windows_result::HRESULT>;
    fn GetDomainType(&self) -> Result<NLM_DOMAIN_TYPE, windows_result::HRESULT>;
    fn GetNetworkConnections(&self) -> Result<IEnumNetworkConnections, windows_result::HRESULT>;
    fn GetTimeCreatedAndConnected(&self, pdwlowdatetimecreated: *mut u32, pdwhighdatetimecreated: *mut u32, pdwlowdatetimeconnected: *mut u32, pdwhighdatetimeconnected: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn IsConnectedToInternet(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT>;
    fn IsConnected(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT>;
    fn GetConnectivity(&self) -> Result<NLM_CONNECTIVITY, windows_result::HRESULT>;
    fn GetCategory(&self) -> Result<NLM_NETWORK_CATEGORY, windows_result::HRESULT>;
    fn SetCategory(&self, newcategory: NLM_NETWORK_CATEGORY) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
impl INetwork_Vtbl {
...
#[cfg(feature = "Win32_System_Com")]
impl INetwork2 {
    pub unsafe fn IsDomainAuthenticatedBy(&self, domainauthenticationkind: NLM_DOMAIN_AUTHENTICATION_KIND) -> Result<windows_core::BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait INetwork2_Impl: INetwork_Impl {
    fn IsDomainAuthenticatedBy(&self, domainauthenticationkind: NLM_DOMAIN_AUTHENTICATION_KIND) -> Result<windows_core::BOOL, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
impl INetwork2_Vtbl {
...
impl INetworkConnection {
    pub unsafe fn GetNetwork(&self) -> Result<INetwork, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetConnectionId(&self) -> Result<windows_core::GUID, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetConnectionId)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetAdapterId(&self) -> Result<windows_core::GUID, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait INetworkConnection_Impl: super::super::System::Com::IDispatch_Impl {
    fn GetNetwork(&self) -> Result<INetwork, windows_result::HRESULT>;
    fn IsConnectedToInternet(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT>;
    fn IsConnected(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT>;
    fn GetConnectivity(&self) -> Result<NLM_CONNECTIVITY, windows_result::HRESULT>;
    fn GetConnectionId(&self) -> Result<windows_core::GUID, windows_result::HRESULT>;
    fn GetAdapterId(&self) -> Result<windows_core::GUID, windows_result::HRESULT>;
    fn GetDomainType(&self) -> Result<NLM_DOMAIN_TYPE, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl INetworkConnectionCost {
    pub unsafe fn GetCost(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCost)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetDataPlanStatus(&self, pdataplanstatus: *mut NLM_DATAPLAN_STATUS) -> Result<(), windows_result::HRESULT> {
...
pub trait INetworkConnectionCost_Impl: windows_core::IUnknownImpl {
    fn GetCost(&self) -> Result<u32, windows_result::HRESULT>;
    fn GetDataPlanStatus(&self, pdataplanstatus: *mut NLM_DATAPLAN_STATUS) -> Result<(), windows_result::HRESULT>;
}
...
impl INetworkConnectionCostEvents {
    pub unsafe fn ConnectionCostChanged(&self, connectionid: windows_core::GUID, newcost: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn ConnectionDataPlanStatusChanged(&self, connectionid: windows_core::GUID) -> Result<(), windows_result::HRESULT> {
...
pub trait INetworkConnectionCostEvents_Impl: windows_core::IUnknownImpl {
    fn ConnectionCostChanged(&self, connectionid: &windows_core::GUID, newcost: u32) -> Result<(), windows_result::HRESULT>;
    fn ConnectionDataPlanStatusChanged(&self, connectionid: &windows_core::GUID) -> Result<(), windows_result::HRESULT>;
}
...
impl INetworkConnectionEvents {
    pub unsafe fn NetworkConnectionConnectivityChanged(&self, connectionid: windows_core::GUID, newconnectivity: NLM_CONNECTIVITY) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn NetworkConnectionPropertyChanged(&self, connectionid: windows_core::GUID, flags: NLM_CONNECTION_PROPERTY_CHANGE) -> Result<(), windows_result::HRESULT> {
...
pub trait INetworkConnectionEvents_Impl: windows_core::IUnknownImpl {
    fn NetworkConnectionConnectivityChanged(&self, connectionid: &windows_core::GUID, newconnectivity: NLM_CONNECTIVITY) -> Result<(), windows_result::HRESULT>;
    fn NetworkConnectionPropertyChanged(&self, connectionid: &windows_core::GUID, flags: NLM_CONNECTION_PROPERTY_CHANGE) -> Result<(), windows_result::HRESULT>;
}
...
impl INetworkCostManager {
    pub unsafe fn GetCost(&self, pcost: *mut u32, pdestipaddr: *const NLM_SOCKADDR) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetCost)(windows_core::Interface::as_raw(self), pcost as _, pdestipaddr).ok() }
    }
    pub unsafe fn GetDataPlanStatus(&self, pdataplanstatus: *mut NLM_DATAPLAN_STATUS, pdestipaddr: *const NLM_SOCKADDR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetDestinationAddresses(&self, pdestipaddrlist: &[NLM_SOCKADDR], bappend: super::super::Foundation::VARIANT_BOOL) -> Result<(), windows_result::HRESULT> {
...
pub trait INetworkCostManager_Impl: windows_core::IUnknownImpl {
    fn GetCost(&self, pcost: *mut u32, pdestipaddr: *const NLM_SOCKADDR) -> Result<(), windows_result::HRESULT>;
    fn GetDataPlanStatus(&self, pdataplanstatus: *mut NLM_DATAPLAN_STATUS, pdestipaddr: *const NLM_SOCKADDR) -> Result<(), windows_result::HRESULT>;
    fn SetDestinationAddresses(&self, length: u32, pdestipaddrlist: *const NLM_SOCKADDR, bappend: super::super::Foundation::VARIANT_BOOL) -> Result<(), windows_result::HRESULT>;
}
...
impl INetworkCostManagerEvents {
    pub unsafe fn CostChanged(&self, newcost: u32, pdestaddr: *const NLM_SOCKADDR) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).CostChanged)(windows_core::Interface::as_raw(self), newcost, pdestaddr).ok() }
    }
    pub unsafe fn DataPlanStatusChanged(&self, pdestaddr: *const NLM_SOCKADDR) -> Result<(), windows_result::HRESULT> {
...
pub trait INetworkCostManagerEvents_Impl: windows_core::IUnknownImpl {
    fn CostChanged(&self, newcost: u32, pdestaddr: *const NLM_SOCKADDR) -> Result<(), windows_result::HRESULT>;
    fn DataPlanStatusChanged(&self, pdestaddr: *const NLM_SOCKADDR) -> Result<(), windows_result::HRESULT>;
}
...
impl INetworkEvents {
    pub unsafe fn NetworkAdded(&self, networkid: windows_core::GUID) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn NetworkDeleted(&self, networkid: windows_core::GUID) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn NetworkConnectivityChanged(&self, networkid: windows_core::GUID, newconnectivity: NLM_CONNECTIVITY) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn NetworkPropertyChanged(&self, networkid: windows_core::GUID, flags: NLM_NETWORK_PROPERTY_CHANGE) -> Result<(), windows_result::HRESULT> {
...
pub trait INetworkEvents_Impl: windows_core::IUnknownImpl {
    fn NetworkAdded(&self, networkid: &windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn NetworkDeleted(&self, networkid: &windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn NetworkConnectivityChanged(&self, networkid: &windows_core::GUID, newconnectivity: NLM_CONNECTIVITY) -> Result<(), windows_result::HRESULT>;
    fn NetworkPropertyChanged(&self, networkid: &windows_core::GUID, flags: NLM_NETWORK_PROPERTY_CHANGE) -> Result<(), windows_result::HRESULT>;
}
...
impl INetworkListManager {
    pub unsafe fn GetNetworks(&self, flags: NLM_ENUM_NETWORK) -> Result<IEnumNetworks, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetNetwork(&self, gdnetworkid: windows_core::GUID) -> Result<INetwork, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetNetworkConnection(&self, gdnetworkconnectionid: windows_core::GUID) -> Result<INetworkConnection, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetSimulatedProfileInfo(&self, psimulatedinfo: *const NLM_SIMULATED_PROFILE_INFO) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetSimulatedProfileInfo)(windows_core::Interface::as_raw(self), psimulatedinfo).ok() }
    }
    pub unsafe fn ClearSimulatedProfileInfo(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait INetworkListManager_Impl: super::super::System::Com::IDispatch_Impl {
    fn GetNetworks(&self, flags: NLM_ENUM_NETWORK) -> Result<IEnumNetworks, windows_result::HRESULT>;
    fn GetNetwork(&self, gdnetworkid: &windows_core::GUID) -> Result<INetwork, windows_result::HRESULT>;
    fn GetNetworkConnections(&self) -> Result<IEnumNetworkConnections, windows_result::HRESULT>;
    fn GetNetworkConnection(&self, gdnetworkconnectionid: &windows_core::GUID) -> Result<INetworkConnection, windows_result::HRESULT>;
    fn IsConnectedToInternet(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT>;
    fn IsConnected(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT>;
    fn GetConnectivity(&self) -> Result<NLM_CONNECTIVITY, windows_result::HRESULT>;
    fn SetSimulatedProfileInfo(&self, psimulatedinfo: *const NLM_SIMULATED_PROFILE_INFO) -> Result<(), windows_result::HRESULT>;
    fn ClearSimulatedProfileInfo(&self) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl INetworkListManagerEvents {
    pub unsafe fn ConnectivityChanged(&self, newconnectivity: NLM_CONNECTIVITY) -> Result<(), windows_result::HRESULT> {
...
pub trait INetworkListManagerEvents_Impl: windows_core::IUnknownImpl {
    fn ConnectivityChanged(&self, newconnectivity: NLM_CONNECTIVITY) -> Result<(), windows_result::HRESULT>;
}
