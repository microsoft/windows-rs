...
pub const LDAP_ADMIN_LIMIT_EXCEEDED: LDAP_RETCODE = LDAP_RETCODE(11);
pub const LDAP_AFFECTS_MULTIPLE_DSAS: LDAP_RETCODE = LDAP_RETCODE(71);
pub const LDAP_ALIAS_DEREF_PROBLEM: LDAP_RETCODE = LDAP_RETCODE(36);
pub const LDAP_ALIAS_PROBLEM: LDAP_RETCODE = LDAP_RETCODE(33);
pub const LDAP_ALREADY_EXISTS: LDAP_RETCODE = LDAP_RETCODE(68);
...
pub const LDAP_ATTRIBUTE_OR_VALUE_EXISTS: LDAP_RETCODE = LDAP_RETCODE(20);
pub const LDAP_AUTH_METHOD_NOT_SUPPORTED: LDAP_RETCODE = LDAP_RETCODE(7);
pub const LDAP_AUTH_OTHERKIND: i32 = 134;
pub const LDAP_AUTH_SASL: i32 = 131;
pub const LDAP_AUTH_SIMPLE: i32 = 128;
pub const LDAP_AUTH_UNKNOWN: LDAP_RETCODE = LDAP_RETCODE(86);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const LDAP_BUSY: LDAP_RETCODE = LDAP_RETCODE(51);
...
pub const LDAP_CLIENT_LOOP: LDAP_RETCODE = LDAP_RETCODE(96);
pub const LDAP_COMPARE_CMD: i32 = 110;
pub const LDAP_COMPARE_FALSE: LDAP_RETCODE = LDAP_RETCODE(5);
pub const LDAP_COMPARE_TRUE: LDAP_RETCODE = LDAP_RETCODE(6);
pub const LDAP_CONFIDENTIALITY_REQUIRED: LDAP_RETCODE = LDAP_RETCODE(13);
pub const LDAP_CONNECT_ERROR: LDAP_RETCODE = LDAP_RETCODE(91);
pub const LDAP_CONSTRAINT_VIOLATION: LDAP_RETCODE = LDAP_RETCODE(19);
pub const LDAP_CONTROL_NOT_FOUND: LDAP_RETCODE = LDAP_RETCODE(93);
...
pub const LDAP_DECODING_ERROR: LDAP_RETCODE = LDAP_RETCODE(84);
...
pub const LDAP_ENCODING_ERROR: LDAP_RETCODE = LDAP_RETCODE(83);
...
pub const LDAP_FILTER_ERROR: LDAP_RETCODE = LDAP_RETCODE(87);
...
pub const LDAP_INAPPROPRIATE_AUTH: LDAP_RETCODE = LDAP_RETCODE(48);
pub const LDAP_INAPPROPRIATE_MATCHING: LDAP_RETCODE = LDAP_RETCODE(18);
pub const LDAP_INSUFFICIENT_RIGHTS: LDAP_RETCODE = LDAP_RETCODE(50);
pub const LDAP_INVALID_CMD: u32 = 255;
pub const LDAP_INVALID_CREDENTIALS: LDAP_RETCODE = LDAP_RETCODE(49);
pub const LDAP_INVALID_DN_SYNTAX: LDAP_RETCODE = LDAP_RETCODE(34);
pub const LDAP_INVALID_RES: u32 = 255;
pub const LDAP_INVALID_SYNTAX: LDAP_RETCODE = LDAP_RETCODE(21);
pub const LDAP_IS_LEAF: LDAP_RETCODE = LDAP_RETCODE(35);
pub const LDAP_LOCAL_ERROR: LDAP_RETCODE = LDAP_RETCODE(82);
pub const LDAP_LOOP_DETECT: LDAP_RETCODE = LDAP_RETCODE(54);
...
pub const LDAP_MORE_RESULTS_TO_RETURN: LDAP_RETCODE = LDAP_RETCODE(95);
pub const LDAP_MSG_ALL: u32 = 1;
pub const LDAP_MSG_ONE: u32 = 0;
pub const LDAP_MSG_RECEIVED: u32 = 2;
pub const LDAP_NAMING_VIOLATION: LDAP_RETCODE = LDAP_RETCODE(64);
pub const LDAP_NOT_ALLOWED_ON_NONLEAF: LDAP_RETCODE = LDAP_RETCODE(66);
pub const LDAP_NOT_ALLOWED_ON_RDN: LDAP_RETCODE = LDAP_RETCODE(67);
pub const LDAP_NOT_SUPPORTED: LDAP_RETCODE = LDAP_RETCODE(92);
pub const LDAP_NO_LIMIT: u32 = 0;
pub const LDAP_NO_MEMORY: LDAP_RETCODE = LDAP_RETCODE(90);
pub const LDAP_NO_OBJECT_CLASS_MODS: LDAP_RETCODE = LDAP_RETCODE(69);
pub const LDAP_NO_RESULTS_RETURNED: LDAP_RETCODE = LDAP_RETCODE(94);
pub const LDAP_NO_SUCH_ATTRIBUTE: LDAP_RETCODE = LDAP_RETCODE(16);
pub const LDAP_NO_SUCH_OBJECT: LDAP_RETCODE = LDAP_RETCODE(32);
pub const LDAP_OBJECT_CLASS_VIOLATION: LDAP_RETCODE = LDAP_RETCODE(65);
pub const LDAP_OFFSET_RANGE_ERROR: LDAP_RETCODE = LDAP_RETCODE(61);
...
pub const LDAP_OPERATIONS_ERROR: LDAP_RETCODE = LDAP_RETCODE(1);
...
pub const LDAP_OTHER: LDAP_RETCODE = LDAP_RETCODE(80);
...
pub const LDAP_PARAM_ERROR: LDAP_RETCODE = LDAP_RETCODE(89);
pub const LDAP_PARTIAL_RESULTS: LDAP_RETCODE = LDAP_RETCODE(9);
pub const LDAP_POLICYHINT_APPLY_FULLPWDPOLICY: u32 = 1;
pub const LDAP_PORT: u32 = 389;
pub const LDAP_PROTOCOL_ERROR: LDAP_RETCODE = LDAP_RETCODE(2);
pub const LDAP_REFERRAL: LDAP_RETCODE = LDAP_RETCODE(10);
#[repr(C)]
...
pub const LDAP_REFERRAL_LIMIT_EXCEEDED: LDAP_RETCODE = LDAP_RETCODE(97);
pub const LDAP_REFERRAL_V2: LDAP_RETCODE = LDAP_RETCODE(9);
pub const LDAP_RESULTS_TOO_LARGE: LDAP_RETCODE = LDAP_RETCODE(70);
...
pub const LDAP_SASL_BIND_IN_PROGRESS: LDAP_RETCODE = LDAP_RETCODE(14);
...
pub const LDAP_SERVER_DOWN: LDAP_RETCODE = LDAP_RETCODE(81);
...
pub const LDAP_SIZELIMIT_EXCEEDED: LDAP_RETCODE = LDAP_RETCODE(4);
pub const LDAP_SORT_CONTROL_MISSING: LDAP_RETCODE = LDAP_RETCODE(60);
...
pub const LDAP_STRONG_AUTH_REQUIRED: LDAP_RETCODE = LDAP_RETCODE(8);
pub const LDAP_SUBSTRING_ANY: i32 = 129;
pub const LDAP_SUBSTRING_FINAL: i32 = 130;
pub const LDAP_SUBSTRING_INITIAL: i32 = 128;
pub const LDAP_SUCCESS: LDAP_RETCODE = LDAP_RETCODE(0);
pub const LDAP_TIMELIMIT_EXCEEDED: LDAP_RETCODE = LDAP_RETCODE(3);
pub const LDAP_TIMEOUT: LDAP_RETCODE = LDAP_RETCODE(85);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const LDAP_UNAVAILABLE: LDAP_RETCODE = LDAP_RETCODE(52);
pub const LDAP_UNAVAILABLE_CRIT_EXTENSION: LDAP_RETCODE = LDAP_RETCODE(12);
pub const LDAP_UNBIND_CMD: i32 = 66;
pub const LDAP_UNDEFINED_TYPE: LDAP_RETCODE = LDAP_RETCODE(17);
pub const LDAP_UNICODE: u32 = 1;
pub const LDAP_UNWILLING_TO_PERFORM: LDAP_RETCODE = LDAP_RETCODE(53);
...
pub const LDAP_USER_CANCELLED: LDAP_RETCODE = LDAP_RETCODE(88);
...
pub const LDAP_VIRTUAL_LIST_VIEW_ERROR: LDAP_RETCODE = LDAP_RETCODE(76);
