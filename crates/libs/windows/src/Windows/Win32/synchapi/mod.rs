...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn CancelWaitableTimer(htimer: super::HANDLE) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn CancelWaitableTimer(htimer : super::HANDLE) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
#[inline]
pub unsafe fn DeleteCriticalSection(lpcriticalsection: super::LPCRITICAL_SECTION) {
    windows_core::link!("kernel32.dll" "system" fn DeleteCriticalSection(lpcriticalsection : super::LPCRITICAL_SECTION));
...
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
#[inline]
pub unsafe fn EnterCriticalSection(lpcriticalsection: super::LPCRITICAL_SECTION) {
    windows_core::link!("kernel32.dll" "system" fn EnterCriticalSection(lpcriticalsection : super::LPCRITICAL_SECTION));
...
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
#[inline]
pub unsafe fn InitializeCriticalSection(lpcriticalsection: super::LPCRITICAL_SECTION) {
    windows_core::link!("kernel32.dll" "system" fn InitializeCriticalSection(lpcriticalsection : super::LPCRITICAL_SECTION));
    unsafe { InitializeCriticalSection(lpcriticalsection as _) }
}
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
#[inline]
pub unsafe fn InitializeCriticalSectionAndSpinCount(lpcriticalsection: super::LPCRITICAL_SECTION, dwspincount: u32) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn InitializeCriticalSectionAndSpinCount(lpcriticalsection : super::LPCRITICAL_SECTION, dwspincount : u32) -> windows_core::BOOL);
    unsafe { InitializeCriticalSectionAndSpinCount(lpcriticalsection as _, dwspincount) }
}
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
#[inline]
pub unsafe fn InitializeCriticalSectionEx(lpcriticalsection: super::LPCRITICAL_SECTION, dwspincount: u32, flags: u32) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn InitializeCriticalSectionEx(lpcriticalsection : super::LPCRITICAL_SECTION, dwspincount : u32, flags : u32) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
#[inline]
pub unsafe fn LeaveCriticalSection(lpcriticalsection: super::LPCRITICAL_SECTION) {
    windows_core::link!("kernel32.dll" "system" fn LeaveCriticalSection(lpcriticalsection : super::LPCRITICAL_SECTION));
    unsafe { LeaveCriticalSection(lpcriticalsection as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn OpenEventA<P2>(dwdesiredaccess: u32, binherithandle: bool, lpname: P2) -> super::HANDLE
where
    P2: windows_core::Param<windows_core::PCSTR>,
{
    windows_core::link!("kernel32.dll" "system" fn OpenEventA(dwdesiredaccess : u32, binherithandle : windows_core::BOOL, lpname : windows_core::PCSTR) -> super::HANDLE);
    unsafe { OpenEventA(dwdesiredaccess, binherithandle.into(), lpname.param().abi()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn OpenEventW<P2>(dwdesiredaccess: u32, binherithandle: bool, lpname: P2) -> super::HANDLE
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("kernel32.dll" "system" fn OpenEventW(dwdesiredaccess : u32, binherithandle : windows_core::BOOL, lpname : windows_core::PCWSTR) -> super::HANDLE);
    unsafe { OpenEventW(dwdesiredaccess, binherithandle.into(), lpname.param().abi()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn OpenMutexW<P2>(dwdesiredaccess: u32, binherithandle: bool, lpname: P2) -> super::HANDLE
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("kernel32.dll" "system" fn OpenMutexW(dwdesiredaccess : u32, binherithandle : windows_core::BOOL, lpname : windows_core::PCWSTR) -> super::HANDLE);
    unsafe { OpenMutexW(dwdesiredaccess, binherithandle.into(), lpname.param().abi()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn OpenSemaphoreW<P2>(dwdesiredaccess: u32, binherithandle: bool, lpname: P2) -> super::HANDLE
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("kernel32.dll" "system" fn OpenSemaphoreW(dwdesiredaccess : u32, binherithandle : windows_core::BOOL, lpname : windows_core::PCWSTR) -> super::HANDLE);
    unsafe { OpenSemaphoreW(dwdesiredaccess, binherithandle.into(), lpname.param().abi()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn OpenWaitableTimerW<P2>(dwdesiredaccess: u32, binherithandle: bool, lptimername: P2) -> super::HANDLE
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("kernel32.dll" "system" fn OpenWaitableTimerW(dwdesiredaccess : u32, binherithandle : windows_core::BOOL, lptimername : windows_core::PCWSTR) -> super::HANDLE);
    unsafe { OpenWaitableTimerW(dwdesiredaccess, binherithandle.into(), lptimername.param().abi()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ReleaseMutex(hmutex: super::HANDLE) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn ReleaseMutex(hmutex : super::HANDLE) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ResetEvent(hevent: super::HANDLE) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn ResetEvent(hevent : super::HANDLE) -> windows_core::BOOL);
    unsafe { ResetEvent(hevent) }
}
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
#[inline]
pub unsafe fn SetCriticalSectionSpinCount(lpcriticalsection: super::LPCRITICAL_SECTION, dwspincount: u32) -> u32 {
    windows_core::link!("kernel32.dll" "system" fn SetCriticalSectionSpinCount(lpcriticalsection : super::LPCRITICAL_SECTION, dwspincount : u32) -> u32);
    unsafe { SetCriticalSectionSpinCount(lpcriticalsection as _, dwspincount) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetEvent(hevent: super::HANDLE) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SetEvent(hevent : super::HANDLE) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SignalObjectAndWait(hobjecttosignal: super::HANDLE, hobjecttowaiton: super::HANDLE, dwmilliseconds: u32, balertable: bool) -> u32 {
    windows_core::link!("kernel32.dll" "system" fn SignalObjectAndWait(hobjecttosignal : super::HANDLE, hobjecttowaiton : super::HANDLE, dwmilliseconds : u32, balertable : windows_core::BOOL) -> u32);
...
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
#[inline]
pub unsafe fn TryEnterCriticalSection(lpcriticalsection: super::LPCRITICAL_SECTION) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn TryEnterCriticalSection(lpcriticalsection : super::LPCRITICAL_SECTION) -> windows_core::BOOL);
    unsafe { TryEnterCriticalSection(lpcriticalsection as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WaitForMultipleObjects(lphandles: &[super::HANDLE], bwaitall: bool, dwmilliseconds: u32) -> u32 {
    windows_core::link!("kernel32.dll" "system" fn WaitForMultipleObjects(ncount : u32, lphandles : *const super::HANDLE, bwaitall : windows_core::BOOL, dwmilliseconds : u32) -> u32);
    unsafe { WaitForMultipleObjects(lphandles.len().try_into().unwrap(), lphandles.as_ptr(), bwaitall.into(), dwmilliseconds) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WaitForMultipleObjectsEx(lphandles: &[super::HANDLE], bwaitall: bool, dwmilliseconds: u32, balertable: bool) -> u32 {
    windows_core::link!("kernel32.dll" "system" fn WaitForMultipleObjectsEx(ncount : u32, lphandles : *const super::HANDLE, bwaitall : windows_core::BOOL, dwmilliseconds : u32, balertable : windows_core::BOOL) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WaitForSingleObject(hhandle: super::HANDLE, dwmilliseconds: u32) -> u32 {
    windows_core::link!("kernel32.dll" "system" fn WaitForSingleObject(hhandle : super::HANDLE, dwmilliseconds : u32) -> u32);
    unsafe { WaitForSingleObject(hhandle, dwmilliseconds) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WaitForSingleObjectEx(hhandle: super::HANDLE, dwmilliseconds: u32, balertable: bool) -> u32 {
    windows_core::link!("kernel32.dll" "system" fn WaitForSingleObjectEx(hhandle : super::HANDLE, dwmilliseconds : u32, balertable : windows_core::BOOL) -> u32);
