...
#[inline]
pub unsafe fn QOSAddSocketToFlow(qoshandle: super::HANDLE, socket: super::SOCKET, destaddr: Option<super::PSOCKADDR>, traffictype: QOS_TRAFFIC_TYPE, flags: Option<u32>, flowid: PQOS_FLOWID) -> windows_core::BOOL {
    windows_core::link!("qwave.dll" "system" fn QOSAddSocketToFlow(qoshandle : super::HANDLE, socket : super::SOCKET, destaddr : super::PSOCKADDR, traffictype : QOS_TRAFFIC_TYPE, flags : u32, flowid : PQOS_FLOWID) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn QOSCancel(qoshandle: super::HANDLE, overlapped: super::LPOVERLAPPED) -> windows_core::BOOL {
    windows_core::link!("qwave.dll" "system" fn QOSCancel(qoshandle : super::HANDLE, overlapped : super::LPOVERLAPPED) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn QOSCreateHandle(version: PQOS_VERSION, qoshandle: super::PHANDLE) -> windows_core::BOOL {
    windows_core::link!("qwave.dll" "system" fn QOSCreateHandle(version : PQOS_VERSION, qoshandle : super::PHANDLE) -> windows_core::BOOL);
    unsafe { QOSCreateHandle(version, qoshandle as _) }
}
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn QOSEnumerateFlows(qoshandle: super::HANDLE, size: super::PULONG, buffer: *mut core::ffi::c_void) -> windows_core::BOOL {
    windows_core::link!("qwave.dll" "system" fn QOSEnumerateFlows(qoshandle : super::HANDLE, size : super::PULONG, buffer : *mut core::ffi::c_void) -> windows_core::BOOL);
    unsafe { QOSEnumerateFlows(qoshandle, size as _, buffer as _) }
}
#[cfg(all(feature = "minwinbase", feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn QOSNotifyFlow(qoshandle: super::HANDLE, flowid: QOS_FLOWID, operation: QOS_NOTIFY_FLOW, size: Option<super::PULONG>, buffer: Option<*mut core::ffi::c_void>, flags: Option<u32>, overlapped: Option<super::LPOVERLAPPED>) -> windows_core::BOOL {
    windows_core::link!("qwave.dll" "system" fn QOSNotifyFlow(qoshandle : super::HANDLE, flowid : QOS_FLOWID, operation : QOS_NOTIFY_FLOW, size : super::PULONG, buffer : *mut core::ffi::c_void, flags : u32, overlapped : super::LPOVERLAPPED) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwinbase", feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn QOSQueryFlow(qoshandle: super::HANDLE, flowid: QOS_FLOWID, operation: QOS_QUERY_FLOW, size: super::PULONG, buffer: *mut core::ffi::c_void, flags: Option<u32>, overlapped: Option<super::LPOVERLAPPED>) -> windows_core::BOOL {
    windows_core::link!("qwave.dll" "system" fn QOSQueryFlow(qoshandle : super::HANDLE, flowid : QOS_FLOWID, operation : QOS_QUERY_FLOW, size : super::PULONG, buffer : *mut core::ffi::c_void, flags : u32, overlapped : super::LPOVERLAPPED) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
#[inline]
pub unsafe fn QOSSetFlow(qoshandle: super::HANDLE, flowid: QOS_FLOWID, operation: QOS_SET_FLOW, size: u32, buffer: *const core::ffi::c_void, flags: Option<u32>, overlapped: Option<super::LPOVERLAPPED>) -> windows_core::BOOL {
    windows_core::link!("qwave.dll" "system" fn QOSSetFlow(qoshandle : super::HANDLE, flowid : QOS_FLOWID, operation : QOS_SET_FLOW, size : u32, buffer : *const core::ffi::c_void, flags : u32, overlapped : super::LPOVERLAPPED) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn QOSStartTrackingClient(qoshandle: super::HANDLE, destaddr: super::PSOCKADDR, flags: Option<u32>) -> windows_core::BOOL {
    windows_core::link!("qwave.dll" "system" fn QOSStartTrackingClient(qoshandle : super::HANDLE, destaddr : super::PSOCKADDR, flags : u32) -> windows_core::BOOL);
    unsafe { QOSStartTrackingClient(qoshandle, destaddr, flags.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(all(feature = "winnt", feature = "ws2"))]
#[inline]
pub unsafe fn QOSStopTrackingClient(qoshandle: super::HANDLE, destaddr: super::PSOCKADDR, flags: Option<u32>) -> windows_core::BOOL {
    windows_core::link!("qwave.dll" "system" fn QOSStopTrackingClient(qoshandle : super::HANDLE, destaddr : super::PSOCKADDR, flags : u32) -> windows_core::BOOL);
