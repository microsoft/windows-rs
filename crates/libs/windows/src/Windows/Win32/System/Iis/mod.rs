...
pub unsafe fn GetExtensionVersion(pver: *mut HSE_VERSION_INFO) -> windows_core::BOOL {
    windows_link::link!("rpcproxy.dll" "system" fn GetExtensionVersion(pver : *mut HSE_VERSION_INFO) -> windows_core::BOOL);
    unsafe { GetExtensionVersion(pver as _) }
}
#[inline]
pub unsafe fn GetFilterVersion(pver: *mut HTTP_FILTER_VERSION) -> windows_core::BOOL {
    windows_link::link!("rpcproxy.dll" "system" fn GetFilterVersion(pver : *mut HTTP_FILTER_VERSION) -> windows_core::BOOL);
...
impl AsyncIFtpAuthenticationProvider {
    pub unsafe fn Begin_AuthenticateUser<P0, P1, P2, P3>(&self, pszsessionid: P0, pszsitename: P1, pszusername: P2, pszpassword: P3) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Finish_AuthenticateUser(&self, ppszcanonicalusername: *mut windows_core::PWSTR, pfauthenticated: *mut windows_core::BOOL) -> Result<(), windows_result::HRESULT> {
...
pub trait AsyncIFtpAuthenticationProvider_Impl: windows_core::IUnknownImpl {
    fn Begin_AuthenticateUser(&self, pszsessionid: &windows_core::PCWSTR, pszsitename: &windows_core::PCWSTR, pszusername: &windows_core::PCWSTR, pszpassword: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn Finish_AuthenticateUser(&self, ppszcanonicalusername: *mut windows_core::PWSTR, pfauthenticated: *mut windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
}
...
impl AsyncIFtpAuthorizationProvider {
    pub unsafe fn Begin_GetUserAccessPermission<P0, P1, P2, P3>(&self, pszsessionid: P0, pszsitename: P1, pszvirtualpath: P2, pszusername: P3) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn Finish_GetUserAccessPermission(&self) -> Result<FTP_ACCESS, windows_result::HRESULT> {
        unsafe {
...
pub trait AsyncIFtpAuthorizationProvider_Impl: windows_core::IUnknownImpl {
    fn Begin_GetUserAccessPermission(&self, pszsessionid: &windows_core::PCWSTR, pszsitename: &windows_core::PCWSTR, pszvirtualpath: &windows_core::PCWSTR, pszusername: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn Finish_GetUserAccessPermission(&self) -> Result<FTP_ACCESS, windows_result::HRESULT>;
}
...
impl AsyncIFtpHomeDirectoryProvider {
    pub unsafe fn Begin_GetUserHomeDirectoryData<P0, P1, P2>(&self, pszsessionid: P0, pszsitename: P1, pszusername: P2) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn Finish_GetUserHomeDirectoryData(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait AsyncIFtpHomeDirectoryProvider_Impl: windows_core::IUnknownImpl {
    fn Begin_GetUserHomeDirectoryData(&self, pszsessionid: &windows_core::PCWSTR, pszsitename: &windows_core::PCWSTR, pszusername: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn Finish_GetUserHomeDirectoryData(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
}
...
impl AsyncIFtpLogProvider {
    pub unsafe fn Begin_Log(&self, ploggingparameters: *const LOGGING_PARAMETERS) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Begin_Log)(windows_core::Interface::as_raw(self), ploggingparameters).ok() }
    }
    pub unsafe fn Finish_Log(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait AsyncIFtpLogProvider_Impl: windows_core::IUnknownImpl {
    fn Begin_Log(&self, ploggingparameters: *const LOGGING_PARAMETERS) -> Result<(), windows_result::HRESULT>;
    fn Finish_Log(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl AsyncIFtpPostprocessProvider {
    pub unsafe fn Begin_HandlePostprocess(&self, ppostprocessparameters: *const POST_PROCESS_PARAMETERS) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Finish_HandlePostprocess(&self) -> Result<FTP_PROCESS_STATUS, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait AsyncIFtpPostprocessProvider_Impl: windows_core::IUnknownImpl {
    fn Begin_HandlePostprocess(&self, ppostprocessparameters: *const POST_PROCESS_PARAMETERS) -> Result<(), windows_result::HRESULT>;
    fn Finish_HandlePostprocess(&self) -> Result<FTP_PROCESS_STATUS, windows_result::HRESULT>;
}
...
impl AsyncIFtpPreprocessProvider {
    pub unsafe fn Begin_HandlePreprocess(&self, ppreprocessparameters: *const PRE_PROCESS_PARAMETERS) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Finish_HandlePreprocess(&self) -> Result<FTP_PROCESS_STATUS, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait AsyncIFtpPreprocessProvider_Impl: windows_core::IUnknownImpl {
    fn Begin_HandlePreprocess(&self, ppreprocessparameters: *const PRE_PROCESS_PARAMETERS) -> Result<(), windows_result::HRESULT>;
    fn Finish_HandlePreprocess(&self) -> Result<FTP_PROCESS_STATUS, windows_result::HRESULT>;
}
...
impl AsyncIFtpRoleProvider {
    pub unsafe fn Begin_IsUserInRole<P0, P1, P2, P3>(&self, pszsessionid: P0, pszsitename: P1, pszusername: P2, pszrole: P3) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn Finish_IsUserInRole(&self) -> Result<windows_core::BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait AsyncIFtpRoleProvider_Impl: windows_core::IUnknownImpl {
    fn Begin_IsUserInRole(&self, pszsessionid: &windows_core::PCWSTR, pszsitename: &windows_core::PCWSTR, pszusername: &windows_core::PCWSTR, pszrole: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn Finish_IsUserInRole(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
}
...
impl AsyncIMSAdminBaseSinkW {
    pub unsafe fn Begin_SinkNotify(&self, pcochangelist: &[MD_CHANGE_OBJECT_W]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Finish_SinkNotify(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Finish_SinkNotify)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Begin_ShutdownNotify(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Begin_ShutdownNotify)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Finish_ShutdownNotify(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait AsyncIMSAdminBaseSinkW_Impl: windows_core::IUnknownImpl {
    fn Begin_SinkNotify(&self, dwmdnumelements: u32, pcochangelist: *const MD_CHANGE_OBJECT_W) -> Result<(), windows_result::HRESULT>;
    fn Finish_SinkNotify(&self) -> Result<(), windows_result::HRESULT>;
    fn Begin_ShutdownNotify(&self) -> Result<(), windows_result::HRESULT>;
    fn Finish_ShutdownNotify(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IADMEXT {
    ...
    pub unsafe fn EnumDcomCLSIDs(&self, pclsiddcom: *mut windows_core::GUID, dwenumindex: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IADMEXT_Impl: windows_core::IUnknownImpl {
    ...
    fn EnumDcomCLSIDs(&self, pclsiddcom: *mut windows_core::GUID, dwenumindex: u32) -> Result<(), windows_result::HRESULT>;
...
impl IFtpAuthenticationProvider {
    pub unsafe fn AuthenticateUser<P0, P1, P2, P3>(&self, pszsessionid: P0, pszsitename: P1, pszusername: P2, pszpassword: P3, ppszcanonicalusername: *mut windows_core::PWSTR, pfauthenticated: *mut windows_core::BOOL) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IFtpAuthenticationProvider_Impl: windows_core::IUnknownImpl {
    fn AuthenticateUser(&self, pszsessionid: &windows_core::PCWSTR, pszsitename: &windows_core::PCWSTR, pszusername: &windows_core::PCWSTR, pszpassword: &windows_core::PCWSTR, ppszcanonicalusername: *mut windows_core::PWSTR, pfauthenticated: *mut windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
}
...
impl IFtpAuthorizationProvider {
    pub unsafe fn GetUserAccessPermission<P0, P1, P2, P3>(&self, pszsessionid: P0, pszsitename: P1, pszvirtualpath: P2, pszusername: P3) -> Result<FTP_ACCESS, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IFtpAuthorizationProvider_Impl: windows_core::IUnknownImpl {
    fn GetUserAccessPermission(&self, pszsessionid: &windows_core::PCWSTR, pszsitename: &windows_core::PCWSTR, pszvirtualpath: &windows_core::PCWSTR, pszusername: &windows_core::PCWSTR) -> Result<FTP_ACCESS, windows_result::HRESULT>;
}
...
impl IFtpHomeDirectoryProvider {
    pub unsafe fn GetUserHomeDirectoryData<P0, P1, P2>(&self, pszsessionid: P0, pszsitename: P1, pszusername: P2) -> Result<windows_core::PWSTR, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IFtpHomeDirectoryProvider_Impl: windows_core::IUnknownImpl {
    fn GetUserHomeDirectoryData(&self, pszsessionid: &windows_core::PCWSTR, pszsitename: &windows_core::PCWSTR, pszusername: &windows_core::PCWSTR) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
}
...
impl IFtpLogProvider {
    pub unsafe fn Log(&self, ploggingparameters: *const LOGGING_PARAMETERS) -> Result<(), windows_result::HRESULT> {
...
pub trait IFtpLogProvider_Impl: windows_core::IUnknownImpl {
    fn Log(&self, ploggingparameters: *const LOGGING_PARAMETERS) -> Result<(), windows_result::HRESULT>;
}
...
impl IFtpPostprocessProvider {
    pub unsafe fn HandlePostprocess(&self, ppostprocessparameters: *const POST_PROCESS_PARAMETERS) -> Result<FTP_PROCESS_STATUS, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IFtpPostprocessProvider_Impl: windows_core::IUnknownImpl {
    fn HandlePostprocess(&self, ppostprocessparameters: *const POST_PROCESS_PARAMETERS) -> Result<FTP_PROCESS_STATUS, windows_result::HRESULT>;
}
...
impl IFtpPreprocessProvider {
    pub unsafe fn HandlePreprocess(&self, ppreprocessparameters: *const PRE_PROCESS_PARAMETERS) -> Result<FTP_PROCESS_STATUS, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IFtpPreprocessProvider_Impl: windows_core::IUnknownImpl {
    fn HandlePreprocess(&self, ppreprocessparameters: *const PRE_PROCESS_PARAMETERS) -> Result<FTP_PROCESS_STATUS, windows_result::HRESULT>;
}
...
impl IFtpProviderConstruct {
    ...
    pub unsafe fn Construct(&self, configurationentries: *const super::Com::SAFEARRAY) -> Result<(), windows_result::HRESULT> {
...
pub trait IFtpProviderConstruct_Impl: windows_core::IUnknownImpl {
    fn Construct(&self, configurationentries: *const super::Com::SAFEARRAY) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IFtpRoleProvider {
    pub unsafe fn IsUserInRole<P0, P1, P2, P3>(&self, pszsessionid: P0, pszsitename: P1, pszusername: P2, pszrole: P3) -> Result<windows_core::BOOL, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IFtpRoleProvider_Impl: windows_core::IUnknownImpl {
    fn IsUserInRole(&self, pszsessionid: &windows_core::PCWSTR, pszsitename: &windows_core::PCWSTR, pszusername: &windows_core::PCWSTR, pszrole: &windows_core::PCWSTR) -> Result<windows_core::BOOL, windows_result::HRESULT>;
}
...
impl IMSAdminBase2W {
    pub unsafe fn BackupWithPasswd<P0, P3>(&self, pszmdbackuplocation: P0, dwmdversion: u32, dwmdflags: u32, pszpasswd: P3) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn RestoreWithPasswd<P0, P3>(&self, pszmdbackuplocation: P0, dwmdversion: u32, dwmdflags: u32, pszpasswd: P3) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn Export<P0, P1, P2>(&self, pszpasswd: P0, pszfilename: P1, pszsourcepath: P2, dwmdflags: u32) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn Import<P0, P1, P2, P3>(&self, pszpasswd: P0, pszfilename: P1, pszsourcepath: P2, pszdestpath: P3, dwmdflags: u32) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn RestoreHistory<P0>(&self, pszmdhistorylocation: P0, dwmdmajorversion: u32, dwmdminorversion: u32, dwmdflags: u32) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn EnumHistory(&self, pszmdhistorylocation: &mut [u16; 256], pdwmdmajorversion: *mut u32, pdwmdminorversion: *mut u32, pftmdhistorytime: *mut super::super::Foundation::FILETIME, dwmdenumindex: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IMSAdminBase2W_Impl: IMSAdminBaseW_Impl {
    fn BackupWithPasswd(&self, pszmdbackuplocation: &windows_core::PCWSTR, dwmdversion: u32, dwmdflags: u32, pszpasswd: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn RestoreWithPasswd(&self, pszmdbackuplocation: &windows_core::PCWSTR, dwmdversion: u32, dwmdflags: u32, pszpasswd: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn Export(&self, pszpasswd: &windows_core::PCWSTR, pszfilename: &windows_core::PCWSTR, pszsourcepath: &windows_core::PCWSTR, dwmdflags: u32) -> Result<(), windows_result::HRESULT>;
    fn Import(&self, pszpasswd: &windows_core::PCWSTR, pszfilename: &windows_core::PCWSTR, pszsourcepath: &windows_core::PCWSTR, pszdestpath: &windows_core::PCWSTR, dwmdflags: u32) -> Result<(), windows_result::HRESULT>;
    fn RestoreHistory(&self, pszmdhistorylocation: &windows_core::PCWSTR, dwmdmajorversion: u32, dwmdminorversion: u32, dwmdflags: u32) -> Result<(), windows_result::HRESULT>;
    fn EnumHistory(&self, pszmdhistorylocation: windows_core::PWSTR, pdwmdmajorversion: *mut u32, pdwmdminorversion: *mut u32, pftmdhistorytime: *mut super::super::Foundation::FILETIME, dwmdenumindex: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IMSAdminBase3W {
    pub unsafe fn GetChildPaths<P1>(&self, hmdhandle: u32, pszmdpath: P1, pszbuffer: Option<&mut [u16]>, pcchmdrequiredbuffersize: Option<*mut u32>) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IMSAdminBase3W_Impl: IMSAdminBase2W_Impl {
    fn GetChildPaths(&self, hmdhandle: u32, pszmdpath: &windows_core::PCWSTR, cchmdbuffersize: u32, pszbuffer: windows_core::PWSTR, pcchmdrequiredbuffersize: *mut u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IMSAdminBaseSinkW {
    pub unsafe fn SinkNotify(&self, pcochangelist: &[MD_CHANGE_OBJECT_W]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn ShutdownNotify(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IMSAdminBaseSinkW_Impl: windows_core::IUnknownImpl {
    fn SinkNotify(&self, dwmdnumelements: u32, pcochangelist: *const MD_CHANGE_OBJECT_W) -> Result<(), windows_result::HRESULT>;
    fn ShutdownNotify(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IMSAdminBaseW {
    pub unsafe fn AddKey<P1>(&self, hmdhandle: u32, pszmdpath: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).AddKey)(windows_core::Interface::as_raw(self), hmdhandle, pszmdpath.param().abi()).ok() }
    }
    pub unsafe fn DeleteKey<P1>(&self, hmdhandle: u32, pszmdpath: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DeleteKey)(windows_core::Interface::as_raw(self), hmdhandle, pszmdpath.param().abi()).ok() }
    }
    pub unsafe fn DeleteChildKeys<P1>(&self, hmdhandle: u32, pszmdpath: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn EnumKeys<P1>(&self, hmdhandle: u32, pszmdpath: P1, pszmdname: &mut [u16; 256], dwmdenumobjectindex: u32) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn CopyKey<P1, P3>(&self, hmdsourcehandle: u32, pszmdsourcepath: P1, hmddesthandle: u32, pszmddestpath: P3, bmdoverwriteflag: bool, bmdcopyflag: bool) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn RenameKey<P1, P2>(&self, hmdhandle: u32, pszmdpath: P1, pszmdnewname: P2) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetData<P1>(&self, hmdhandle: u32, pszmdpath: P1, pmdrmddata: *mut METADATA_RECORD) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetData<P1>(&self, hmdhandle: u32, pszmdpath: P1, pmdrmddata: *mut METADATA_RECORD, pdwmdrequireddatalen: *mut u32) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn DeleteData<P1>(&self, hmdhandle: u32, pszmdpath: P1, dwmdidentifier: u32, dwmddatatype: u32) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn EnumData<P1>(&self, hmdhandle: u32, pszmdpath: P1, pmdrmddata: *mut METADATA_RECORD, dwmdenumdataindex: u32, pdwmdrequireddatalen: *mut u32) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetAllData<P1>(&self, hmdhandle: u32, pszmdpath: P1, dwmdattributes: u32, dwmdusertype: u32, dwmddatatype: u32, pdwmdnumdataentries: *mut u32, pdwmddatasetnumber: *mut u32, dwmdbuffersize: u32, pbmdbuffer: *mut u8, pdwmdrequiredbuffersize: *mut u32) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn DeleteAllData<P1>(&self, hmdhandle: u32, pszmdpath: P1, dwmdusertype: u32, dwmddatatype: u32) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn CopyData<P1, P3>(&self, hmdsourcehandle: u32, pszmdsourcepath: P1, hmddesthandle: u32, pszmddestpath: P3, dwmdattributes: u32, dwmdusertype: u32, dwmddatatype: u32, bmdcopyflag: bool) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetDataPaths<P1>(&self, hmdhandle: u32, pszmdpath: P1, dwmdidentifier: u32, dwmddatatype: u32, pszbuffer: &mut [u16], pdwmdrequiredbuffersize: *mut u32) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn OpenKey<P1>(&self, hmdhandle: u32, pszmdpath: P1, dwmdaccessrequested: u32, dwmdtimeout: u32) -> Result<u32, windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn CloseKey(&self, hmdhandle: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).CloseKey)(windows_core::Interface::as_raw(self), hmdhandle).ok() }
    }
    pub unsafe fn ChangePermissions(&self, hmdhandle: u32, dwmdtimeout: u32, dwmdaccessrequested: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetHandleInfo(&self, hmdhandle: u32) -> Result<METADATA_HANDLE_INFO, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetHandleInfo)(windows_core::Interface::as_raw(self), hmdhandle, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetSystemChangeNumber(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSystemChangeNumber)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetDataSetNumber<P1>(&self, hmdhandle: u32, pszmdpath: P1) -> Result<u32, windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn SetLastChangeTime<P1>(&self, hmdhandle: u32, pszmdpath: P1, pftmdlastchangetime: *const super::super::Foundation::FILETIME, blocaltime: bool) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetLastChangeTime<P1>(&self, hmdhandle: u32, pszmdpath: P1, pftmdlastchangetime: *mut super::super::Foundation::FILETIME, blocaltime: bool) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn KeyExchangePhase1(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).KeyExchangePhase1)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn KeyExchangePhase2(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).KeyExchangePhase2)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Backup<P0>(&self, pszmdbackuplocation: P0, dwmdversion: u32, dwmdflags: u32) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn Restore<P0>(&self, pszmdbackuplocation: P0, dwmdversion: u32, dwmdflags: u32) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn EnumBackups(&self, pszmdbackuplocation: &mut [u16; 256], pdwmdversion: *mut u32, pftmdbackuptime: *mut super::super::Foundation::FILETIME, dwmdenumindex: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn DeleteBackup<P0>(&self, pszmdbackuplocation: P0, dwmdversion: u32) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn UnmarshalInterface(&self) -> Result<IMSAdminBaseW, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetServerGuid(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IMSAdminBaseW_Impl: windows_core::IUnknownImpl {
    fn AddKey(&self, hmdhandle: u32, pszmdpath: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn DeleteKey(&self, hmdhandle: u32, pszmdpath: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn DeleteChildKeys(&self, hmdhandle: u32, pszmdpath: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn EnumKeys(&self, hmdhandle: u32, pszmdpath: &windows_core::PCWSTR, pszmdname: windows_core::PWSTR, dwmdenumobjectindex: u32) -> Result<(), windows_result::HRESULT>;
    fn CopyKey(&self, hmdsourcehandle: u32, pszmdsourcepath: &windows_core::PCWSTR, hmddesthandle: u32, pszmddestpath: &windows_core::PCWSTR, bmdoverwriteflag: windows_core::BOOL, bmdcopyflag: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn RenameKey(&self, hmdhandle: u32, pszmdpath: &windows_core::PCWSTR, pszmdnewname: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn SetData(&self, hmdhandle: u32, pszmdpath: &windows_core::PCWSTR, pmdrmddata: *mut METADATA_RECORD) -> Result<(), windows_result::HRESULT>;
    fn GetData(&self, hmdhandle: u32, pszmdpath: &windows_core::PCWSTR, pmdrmddata: *mut METADATA_RECORD, pdwmdrequireddatalen: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn DeleteData(&self, hmdhandle: u32, pszmdpath: &windows_core::PCWSTR, dwmdidentifier: u32, dwmddatatype: u32) -> Result<(), windows_result::HRESULT>;
    fn EnumData(&self, hmdhandle: u32, pszmdpath: &windows_core::PCWSTR, pmdrmddata: *mut METADATA_RECORD, dwmdenumdataindex: u32, pdwmdrequireddatalen: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetAllData(&self, hmdhandle: u32, pszmdpath: &windows_core::PCWSTR, dwmdattributes: u32, dwmdusertype: u32, dwmddatatype: u32, pdwmdnumdataentries: *mut u32, pdwmddatasetnumber: *mut u32, dwmdbuffersize: u32, pbmdbuffer: *mut u8, pdwmdrequiredbuffersize: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn DeleteAllData(&self, hmdhandle: u32, pszmdpath: &windows_core::PCWSTR, dwmdusertype: u32, dwmddatatype: u32) -> Result<(), windows_result::HRESULT>;
    fn CopyData(&self, hmdsourcehandle: u32, pszmdsourcepath: &windows_core::PCWSTR, hmddesthandle: u32, pszmddestpath: &windows_core::PCWSTR, dwmdattributes: u32, dwmdusertype: u32, dwmddatatype: u32, bmdcopyflag: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn GetDataPaths(&self, hmdhandle: u32, pszmdpath: &windows_core::PCWSTR, dwmdidentifier: u32, dwmddatatype: u32, dwmdbuffersize: u32, pszbuffer: windows_core::PWSTR, pdwmdrequiredbuffersize: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn OpenKey(&self, hmdhandle: u32, pszmdpath: &windows_core::PCWSTR, dwmdaccessrequested: u32, dwmdtimeout: u32) -> Result<u32, windows_result::HRESULT>;
    fn CloseKey(&self, hmdhandle: u32) -> Result<(), windows_result::HRESULT>;
    fn ChangePermissions(&self, hmdhandle: u32, dwmdtimeout: u32, dwmdaccessrequested: u32) -> Result<(), windows_result::HRESULT>;
    fn SaveData(&self) -> Result<(), windows_result::HRESULT>;
    fn GetHandleInfo(&self, hmdhandle: u32) -> Result<METADATA_HANDLE_INFO, windows_result::HRESULT>;
    fn GetSystemChangeNumber(&self) -> Result<u32, windows_result::HRESULT>;
    fn GetDataSetNumber(&self, hmdhandle: u32, pszmdpath: &windows_core::PCWSTR) -> Result<u32, windows_result::HRESULT>;
    fn SetLastChangeTime(&self, hmdhandle: u32, pszmdpath: &windows_core::PCWSTR, pftmdlastchangetime: *const super::super::Foundation::FILETIME, blocaltime: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn GetLastChangeTime(&self, hmdhandle: u32, pszmdpath: &windows_core::PCWSTR, pftmdlastchangetime: *mut super::super::Foundation::FILETIME, blocaltime: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn KeyExchangePhase1(&self) -> Result<(), windows_result::HRESULT>;
    fn KeyExchangePhase2(&self) -> Result<(), windows_result::HRESULT>;
    fn Backup(&self, pszmdbackuplocation: &windows_core::PCWSTR, dwmdversion: u32, dwmdflags: u32) -> Result<(), windows_result::HRESULT>;
    fn Restore(&self, pszmdbackuplocation: &windows_core::PCWSTR, dwmdversion: u32, dwmdflags: u32) -> Result<(), windows_result::HRESULT>;
    fn EnumBackups(&self, pszmdbackuplocation: windows_core::PWSTR, pdwmdversion: *mut u32, pftmdbackuptime: *mut super::super::Foundation::FILETIME, dwmdenumindex: u32) -> Result<(), windows_result::HRESULT>;
    fn DeleteBackup(&self, pszmdbackuplocation: &windows_core::PCWSTR, dwmdversion: u32) -> Result<(), windows_result::HRESULT>;
    fn UnmarshalInterface(&self) -> Result<IMSAdminBaseW, windows_result::HRESULT>;
    fn GetServerGuid(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IMSImpExpHelpW {
    pub unsafe fn EnumeratePathsInFile<P0, P1>(&self, pszfilename: P0, pszkeytype: P1, pszbuffer: Option<&mut [u16]>, pdwmdrequiredbuffersize: *mut u32) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IMSImpExpHelpW_Impl: windows_core::IUnknownImpl {
    fn EnumeratePathsInFile(&self, pszfilename: &windows_core::PCWSTR, pszkeytype: &windows_core::PCWSTR, dwmdbuffersize: u32, pszbuffer: windows_core::PWSTR, pdwmdrequiredbuffersize: *mut u32) -> Result<(), windows_result::HRESULT>;
}
