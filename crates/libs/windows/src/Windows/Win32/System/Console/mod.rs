...
pub const ALLOC_CONSOLE_MODE_DEFAULT: ALLOC_CONSOLE_MODE = ALLOC_CONSOLE_MODE(0);
pub const ALLOC_CONSOLE_MODE_NEW_WINDOW: ALLOC_CONSOLE_MODE = ALLOC_CONSOLE_MODE(1);
pub const ALLOC_CONSOLE_MODE_NO_WINDOW: ALLOC_CONSOLE_MODE = ALLOC_CONSOLE_MODE(2);
#[repr(C)]
...
pub const ALLOC_CONSOLE_RESULT_EXISTING_CONSOLE: ALLOC_CONSOLE_RESULT = ALLOC_CONSOLE_RESULT(2);
pub const ALLOC_CONSOLE_RESULT_NEW_CONSOLE: ALLOC_CONSOLE_RESULT = ALLOC_CONSOLE_RESULT(1);
pub const ALLOC_CONSOLE_RESULT_NO_CONSOLE: ALLOC_CONSOLE_RESULT = ALLOC_CONSOLE_RESULT(0);
...
pub const BACKGROUND_BLUE: CONSOLE_CHARACTER_ATTRIBUTES = CONSOLE_CHARACTER_ATTRIBUTES(16);
pub const BACKGROUND_GREEN: CONSOLE_CHARACTER_ATTRIBUTES = CONSOLE_CHARACTER_ATTRIBUTES(32);
pub const BACKGROUND_INTENSITY: CONSOLE_CHARACTER_ATTRIBUTES = CONSOLE_CHARACTER_ATTRIBUTES(128);
pub const BACKGROUND_RED: CONSOLE_CHARACTER_ATTRIBUTES = CONSOLE_CHARACTER_ATTRIBUTES(64);
...
pub const CHAR_TYPE_LEADING: u32 = 2;
pub const CHAR_TYPE_SBCS: u32 = 0;
pub const CHAR_TYPE_TRAILING: u32 = 3;
pub const COMMON_LVB_GRID_HORIZONTAL: CONSOLE_CHARACTER_ATTRIBUTES = CONSOLE_CHARACTER_ATTRIBUTES(1024);
pub const COMMON_LVB_GRID_LVERTICAL: CONSOLE_CHARACTER_ATTRIBUTES = CONSOLE_CHARACTER_ATTRIBUTES(2048);
pub const COMMON_LVB_GRID_RVERTICAL: CONSOLE_CHARACTER_ATTRIBUTES = CONSOLE_CHARACTER_ATTRIBUTES(4096);
pub const COMMON_LVB_LEADING_BYTE: CONSOLE_CHARACTER_ATTRIBUTES = CONSOLE_CHARACTER_ATTRIBUTES(256);
pub const COMMON_LVB_REVERSE_VIDEO: CONSOLE_CHARACTER_ATTRIBUTES = CONSOLE_CHARACTER_ATTRIBUTES(16384);
pub const COMMON_LVB_SBCSDBCS: CONSOLE_CHARACTER_ATTRIBUTES = CONSOLE_CHARACTER_ATTRIBUTES(768);
pub const COMMON_LVB_TRAILING_BYTE: CONSOLE_CHARACTER_ATTRIBUTES = CONSOLE_CHARACTER_ATTRIBUTES(512);
pub const COMMON_LVB_UNDERSCORE: CONSOLE_CHARACTER_ATTRIBUTES = CONSOLE_CHARACTER_ATTRIBUTES(32768);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CONSOLE_ALTENTER: u32 = 8;
pub const CONSOLE_ALTESC: u32 = 2;
pub const CONSOLE_ALTPRTSC: u32 = 16;
...
pub const CONSOLE_MODIFIER_ALT: u32 = 8;
pub const CONSOLE_MODIFIER_CONTROL: u32 = 4;
pub const CONSOLE_MODIFIER_SHIFT: u32 = 3;
pub const CONSOLE_MOUSE_DOWN: u32 = 8;
pub const CONSOLE_MOUSE_SELECTION: u32 = 4;
pub const CONSOLE_NOSHORTCUTKEY: u32 = 0;
...
pub const CONSOLE_SELECTION_INVERTED: u32 = 16;
...
pub const ConsoleEndTask: CONSOLECONTROL = CONSOLECONTROL(7);
pub const ConsoleNotifyConsoleApplication: CONSOLECONTROL = CONSOLECONTROL(1);
pub const ConsoleSetCaretInfo: CONSOLECONTROL = CONSOLECONTROL(3);
pub const ConsoleSetForeground: CONSOLECONTROL = CONSOLECONTROL(5);
pub const ConsoleSetWindowOwner: CONSOLECONTROL = CONSOLECONTROL(6);
pub const DISABLE_NEWLINE_AUTO_RETURN: CONSOLE_MODE = CONSOLE_MODE(8);
pub const DOUBLE_CLICK: u32 = 2;
pub const ENABLE_AUTO_POSITION: CONSOLE_MODE = CONSOLE_MODE(256);
pub const ENABLE_ECHO_INPUT: CONSOLE_MODE = CONSOLE_MODE(4);
pub const ENABLE_EXTENDED_FLAGS: CONSOLE_MODE = CONSOLE_MODE(128);
pub const ENABLE_INSERT_MODE: CONSOLE_MODE = CONSOLE_MODE(32);
pub const ENABLE_LINE_INPUT: CONSOLE_MODE = CONSOLE_MODE(2);
pub const ENABLE_LVB_GRID_WORLDWIDE: CONSOLE_MODE = CONSOLE_MODE(16);
pub const ENABLE_MOUSE_INPUT: CONSOLE_MODE = CONSOLE_MODE(16);
pub const ENABLE_PROCESSED_INPUT: CONSOLE_MODE = CONSOLE_MODE(1);
pub const ENABLE_PROCESSED_OUTPUT: CONSOLE_MODE = CONSOLE_MODE(1);
pub const ENABLE_QUICK_EDIT_MODE: CONSOLE_MODE = CONSOLE_MODE(64);
pub const ENABLE_VIRTUAL_TERMINAL_INPUT: CONSOLE_MODE = CONSOLE_MODE(512);
pub const ENABLE_VIRTUAL_TERMINAL_PROCESSING: CONSOLE_MODE = CONSOLE_MODE(4);
pub const ENABLE_WINDOW_INPUT: CONSOLE_MODE = CONSOLE_MODE(8);
pub const ENABLE_WRAP_AT_EOL_OUTPUT: CONSOLE_MODE = CONSOLE_MODE(2);
...
pub const FOREGROUND_BLUE: CONSOLE_CHARACTER_ATTRIBUTES = CONSOLE_CHARACTER_ATTRIBUTES(1);
pub const FOREGROUND_GREEN: CONSOLE_CHARACTER_ATTRIBUTES = CONSOLE_CHARACTER_ATTRIBUTES(2);
pub const FOREGROUND_INTENSITY: CONSOLE_CHARACTER_ATTRIBUTES = CONSOLE_CHARACTER_ATTRIBUTES(8);
pub const FOREGROUND_RED: CONSOLE_CHARACTER_ATTRIBUTES = CONSOLE_CHARACTER_ATTRIBUTES(4);
...
pub const PID_CONSOLE_CTRLKEYSDISABLED: u32 = 4;
pub const PID_CONSOLE_CURSOR_COLOR: u32 = 9;
pub const PID_CONSOLE_CURSOR_TYPE: u32 = 8;
pub const PID_CONSOLE_DEFAULTBACKGROUND: u32 = 12;
pub const PID_CONSOLE_DEFAULTFOREGROUND: u32 = 11;
pub const PID_CONSOLE_FILTERONPASTE: u32 = 3;
pub const PID_CONSOLE_FORCEV2: u32 = 1;
pub const PID_CONSOLE_INTERCEPT_COPY_PASTE: u32 = 10;
pub const PID_CONSOLE_LINESELECTION: u32 = 5;
pub const PID_CONSOLE_TERMINALSCROLLING: u32 = 13;
pub const PID_CONSOLE_WINDOWMAXIMIZED: u32 = 7;
pub const PID_CONSOLE_WINDOWTRANSPARENCY: u32 = 6;
pub const PID_CONSOLE_WRAPTEXT: u32 = 2;
...
pub const Reserved1: CONSOLECONTROL = CONSOLECONTROL(0);
pub const Reserved2: CONSOLECONTROL = CONSOLECONTROL(2);
pub const Reserved3: CONSOLECONTROL = CONSOLECONTROL(4);
...
pub const STD_ERROR_HANDLE: STD_HANDLE = STD_HANDLE(4294967284);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct STD_HANDLE(pub u32);
pub const STD_INPUT_HANDLE: STD_HANDLE = STD_HANDLE(4294967286);
pub const STD_OUTPUT_HANDLE: STD_HANDLE = STD_HANDLE(4294967285);
pub const VDM_CLIENT_RECT: u32 = 3;
pub const VDM_CLIENT_TO_SCREEN: u32 = 4;
pub const VDM_FULLSCREEN_NOPAINT: u32 = 7;
pub const VDM_HIDE_WINDOW: u32 = 1;
pub const VDM_IS_HIDDEN: u32 = 6;
pub const VDM_IS_ICONIC: u32 = 2;
pub const VDM_SCREEN_TO_CLIENT: u32 = 5;
