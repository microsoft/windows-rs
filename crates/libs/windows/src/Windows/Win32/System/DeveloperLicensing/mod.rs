...
{
    ::windows::core::windows_link ! ( "wsclient.dll" ,"system" fn AcquireDeveloperLicense ( hwndparent : super::super::Foundation:: HWND , pexpiration : *mut super::super::Foundation:: FILETIME ) -> :: windows::core::HRESULT );
...
pub unsafe fn CheckDeveloperLicense() -> ::windows::core::Result<super::super::Foundation::FILETIME> {
    ::windows::core::windows_link ! ( "wsclient.dll" ,"system" fn CheckDeveloperLicense ( pexpiration : *mut super::super::Foundation:: FILETIME ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "wsclient.dll" ,"system" fn RemoveDeveloperLicense ( hwndparent : super::super::Foundation:: HWND ) -> :: windows::core::HRESULT );
