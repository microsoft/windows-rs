#[inline]
pub unsafe fn AcquireDeveloperLicense(hwndparent: Option<super::super::Foundation::HWND>) -> windows_result::Result<super::super::Foundation::FILETIME> {
...
#[inline]
pub unsafe fn CheckDeveloperLicense() -> windows_result::Result<super::super::Foundation::FILETIME> {
...
#[inline]
pub unsafe fn RemoveDeveloperLicense(hwndparent: Option<super::super::Foundation::HWND>) -> windows_result::Result<()> {
