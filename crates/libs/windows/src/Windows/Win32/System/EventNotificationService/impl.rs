...
#[cfg(feature = "Win32_System_Com")]
impl ISensLogonVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ISensLogonImpl, const OFFSET: isize>() -> ISensLogonVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<ISensLogon>, ::windows::core::GetTrustLevel, Logon::<Impl, OFFSET>, Logoff::<Impl, OFFSET>, StartShell::<Impl, OFFSET>, DisplayLock::<Impl, OFFSET>, DisplayUnlock::<Impl, OFFSET>, StartScreenSaver::<Impl, OFFSET>, StopScreenSaver::<Impl, OFFSET>)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
impl ISensLogon2Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ISensLogon2Impl, const OFFSET: isize>() -> ISensLogon2Vtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<ISensLogon2>, ::windows::core::GetTrustLevel, Logon::<Impl, OFFSET>, Logoff::<Impl, OFFSET>, SessionDisconnect::<Impl, OFFSET>, SessionReconnect::<Impl, OFFSET>, PostShell::<Impl, OFFSET>)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
impl ISensNetworkVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ISensNetworkImpl, const OFFSET: isize>() -> ISensNetworkVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<ISensNetwork>, ::windows::core::GetTrustLevel, ConnectionMade::<Impl, OFFSET>, ConnectionMadeNoQOCInfo::<Impl, OFFSET>, ConnectionLost::<Impl, OFFSET>, DestinationReachable::<Impl, OFFSET>, DestinationReachableNoQOCInfo::<Impl, OFFSET>)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
#[cfg(feature = "Win32_System_Com")]
impl ISensOnNowVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ISensOnNowImpl, const OFFSET: isize>() -> ISensOnNowVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<ISensOnNow>, ::windows::core::GetTrustLevel, OnACPower::<Impl, OFFSET>, OnBatteryPower::<Impl, OFFSET>, BatteryLow::<Impl, OFFSET>)
    }
}
