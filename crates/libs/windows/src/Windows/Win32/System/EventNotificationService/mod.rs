#[inline]
pub unsafe fn IsDestinationReachableA<P0>(lpszdestination: P0, lpqocinfo: *mut QOCINFO) -> windows_result::Result<()>
where
...
#[inline]
pub unsafe fn IsDestinationReachableW<P0>(lpszdestination: P0, lpqocinfo: *mut QOCINFO) -> windows_result::Result<()>
where
...
#[inline]
pub unsafe fn IsNetworkAlive(lpdwflags: *mut u32) -> windows_result::Result<()> {
...
#[cfg(feature = "Win32_System_Com")]
impl ISensLogon {
    pub unsafe fn Logon(&self, bstrusername: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn Logoff(&self, bstrusername: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn StartShell(&self, bstrusername: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn DisplayLock(&self, bstrusername: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn DisplayUnlock(&self, bstrusername: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn StartScreenSaver(&self, bstrusername: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn StopScreenSaver(&self, bstrusername: &windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait ISensLogon_Impl: super::Com::IDispatch_Impl {
    fn Logon(&self, bstrusername: &windows_core::BSTR) -> windows_result::Result<()>;
    fn Logoff(&self, bstrusername: &windows_core::BSTR) -> windows_result::Result<()>;
    fn StartShell(&self, bstrusername: &windows_core::BSTR) -> windows_result::Result<()>;
    fn DisplayLock(&self, bstrusername: &windows_core::BSTR) -> windows_result::Result<()>;
    fn DisplayUnlock(&self, bstrusername: &windows_core::BSTR) -> windows_result::Result<()>;
    fn StartScreenSaver(&self, bstrusername: &windows_core::BSTR) -> windows_result::Result<()>;
    fn StopScreenSaver(&self, bstrusername: &windows_core::BSTR) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
#[cfg(feature = "Win32_System_Com")]
impl ISensLogon2 {
    pub unsafe fn Logon(&self, bstrusername: &windows_core::BSTR, dwsessionid: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Logoff(&self, bstrusername: &windows_core::BSTR, dwsessionid: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SessionDisconnect(&self, bstrusername: &windows_core::BSTR, dwsessionid: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SessionReconnect(&self, bstrusername: &windows_core::BSTR, dwsessionid: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn PostShell(&self, bstrusername: &windows_core::BSTR, dwsessionid: u32) -> windows_result::Result<()> {
...
pub trait ISensLogon2_Impl: super::Com::IDispatch_Impl {
    fn Logon(&self, bstrusername: &windows_core::BSTR, dwsessionid: u32) -> windows_result::Result<()>;
    fn Logoff(&self, bstrusername: &windows_core::BSTR, dwsessionid: u32) -> windows_result::Result<()>;
    fn SessionDisconnect(&self, bstrusername: &windows_core::BSTR, dwsessionid: u32) -> windows_result::Result<()>;
    fn SessionReconnect(&self, bstrusername: &windows_core::BSTR, dwsessionid: u32) -> windows_result::Result<()>;
    fn PostShell(&self, bstrusername: &windows_core::BSTR, dwsessionid: u32) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
#[cfg(feature = "Win32_System_Com")]
impl ISensNetwork {
    pub unsafe fn ConnectionMade(&self, bstrconnection: &windows_core::BSTR, ultype: u32, lpqocinfo: *const SENS_QOCINFO) -> windows_result::Result<()> {
    ...
    pub unsafe fn ConnectionMadeNoQOCInfo(&self, bstrconnection: &windows_core::BSTR, ultype: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn ConnectionLost(&self, bstrconnection: &windows_core::BSTR, ultype: SENS_CONNECTION_TYPE) -> windows_result::Result<()> {
    ...
    pub unsafe fn DestinationReachable(&self, bstrdestination: &windows_core::BSTR, bstrconnection: &windows_core::BSTR, ultype: u32, lpqocinfo: *const SENS_QOCINFO) -> windows_result::Result<()> {
    ...
    pub unsafe fn DestinationReachableNoQOCInfo(&self, bstrdestination: &windows_core::BSTR, bstrconnection: &windows_core::BSTR, ultype: u32) -> windows_result::Result<()> {
...
pub trait ISensNetwork_Impl: super::Com::IDispatch_Impl {
    fn ConnectionMade(&self, bstrconnection: &windows_core::BSTR, ultype: u32, lpqocinfo: *const SENS_QOCINFO) -> windows_result::Result<()>;
    fn ConnectionMadeNoQOCInfo(&self, bstrconnection: &windows_core::BSTR, ultype: u32) -> windows_result::Result<()>;
    fn ConnectionLost(&self, bstrconnection: &windows_core::BSTR, ultype: SENS_CONNECTION_TYPE) -> windows_result::Result<()>;
    fn DestinationReachable(&self, bstrdestination: &windows_core::BSTR, bstrconnection: &windows_core::BSTR, ultype: u32, lpqocinfo: *const SENS_QOCINFO) -> windows_result::Result<()>;
    fn DestinationReachableNoQOCInfo(&self, bstrdestination: &windows_core::BSTR, bstrconnection: &windows_core::BSTR, ultype: u32) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
#[cfg(feature = "Win32_System_Com")]
impl ISensOnNow {
    pub unsafe fn OnACPower(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).OnACPower)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn OnBatteryPower(&self, dwbatterylifepercent: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).OnBatteryPower)(windows_core::Interface::as_raw(self), dwbatterylifepercent).ok() }
    }
    pub unsafe fn BatteryLow(&self, dwbatterylifepercent: u32) -> windows_result::Result<()> {
...
pub trait ISensOnNow_Impl: super::Com::IDispatch_Impl {
    fn OnACPower(&self) -> windows_result::Result<()>;
    fn OnBatteryPower(&self, dwbatterylifepercent: u32) -> windows_result::Result<()>;
    fn BatteryLow(&self, dwbatterylifepercent: u32) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
