#[inline]
pub unsafe fn IsDestinationReachableA(lpszdestination: windows_core::PCSTR, lpqocinfo: *mut QOCINFO) -> windows_core::Result<()> {
    ...
    unsafe { IsDestinationReachableA(core::mem::transmute(lpszdestination), lpqocinfo as _).ok() }
}
#[inline]
pub unsafe fn IsDestinationReachableW(lpszdestination: windows_core::PCWSTR, lpqocinfo: *mut QOCINFO) -> windows_core::Result<()> {
    ...
    unsafe { IsDestinationReachableW(core::mem::transmute(lpszdestination), lpqocinfo as _).ok() }
}
#[inline]
