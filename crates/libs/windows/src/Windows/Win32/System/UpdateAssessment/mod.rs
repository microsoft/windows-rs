...
impl IWaaSAssessor {
    pub unsafe fn GetOSUpdateAssessment(&self) -> Result<OSUpdateAssessment, windows_result::HRESULT> {
        unsafe {
...
pub trait IWaaSAssessor_Impl: windows_core::IUnknownImpl {
    fn GetOSUpdateAssessment(&self) -> Result<OSUpdateAssessment, windows_result::HRESULT>;
}
