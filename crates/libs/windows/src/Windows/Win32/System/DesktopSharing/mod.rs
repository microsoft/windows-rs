...
impl IRDPSRAPIApplication {
    ...
    pub unsafe fn Windows(&self) -> ::windows_core::Result<IRDPSRAPIWindowList> {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIWindowList>();
    ...
    {
        (::windows_core::Interface::vtable(self).SetShared)(::windows_core::Interface::as_raw(self), newval.into_param().abi()).ok()
    }
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPIApplication {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0x41e7a09d_eb7a_436e_935d_780ca2628324);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPIApplication_Vtbl {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub Windows: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pwindowlist: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    Windows: usize,
    pub Id: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pretval: *mut i32) -> ::windows_core::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub Shared: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pretval: *mut super::super::Foundation::VARIANT_BOOL) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))]
    Shared: usize,
    #[cfg(feature = "Win32_Foundation")]
    pub SetShared: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, newval: super::super::Foundation::VARIANT_BOOL) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))]
    SetShared: usize,
...
impl IRDPSRAPIApplicationFilter {
    ...
    pub unsafe fn Applications(&self) -> ::windows_core::Result<IRDPSRAPIApplicationList> {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIApplicationList>();
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPIApplicationFilter {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0xd20f10ca_6637_4f06_b1d5_277ea7e5160d);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPIApplicationFilter_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    #[cfg(feature = "Win32_System_Com")]
    pub Applications: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, papplications: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    Applications: usize,
    #[cfg(feature = "Win32_System_Com")]
    pub Windows: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pwindows: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    Windows: usize,
    #[cfg(feature = "Win32_Foundation")]
    pub Enabled: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pretval: *mut super::super::Foundation::VARIANT_BOOL) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))]
    Enabled: usize,
    #[cfg(feature = "Win32_Foundation")]
...
impl IRDPSRAPIApplicationList {
    ...
    pub unsafe fn get_Item(&self, item: i32) -> ::windows_core::Result<IRDPSRAPIApplication> {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIApplication>();
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPIApplicationList {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0xd4b4aeb3_22dc_4837_b3b6_42ea2517849a);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPIApplicationList_Vtbl {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub get_Item: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, item: i32, papplication: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    get_Item: usize,
}
#[doc = "*Required features: `\"Win32_System_DesktopSharing\"`, `\"Win32_System_Com\"`*"]
...
impl IRDPSRAPIAttendee {
    ...
    pub unsafe fn RemoteName(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::windows_core::zeroed::<::windows_core::BSTR>();
        (::windows_core::Interface::vtable(self).RemoteName)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
    pub unsafe fn ControlLevel(&self) -> ::windows_core::Result<CTRL_LEVEL> {
        let mut result__ = ::windows_core::zeroed::<CTRL_LEVEL>();
        (::windows_core::Interface::vtable(self).ControlLevel)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
    ...
    pub unsafe fn Invitation(&self) -> ::windows_core::Result<IRDPSRAPIInvitation> {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIInvitation>();
        (::windows_core::Interface::vtable(self).Invitation)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
    ...
    pub unsafe fn ConnectivityInfo(&self) -> ::windows_core::Result<::windows_core::IUnknown> {
        let mut result__ = ::windows_core::zeroed::<::windows_core::IUnknown>();
        (::windows_core::Interface::vtable(self).ConnectivityInfo)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPIAttendee {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0xec0671b3_1b78_4b80_a464_9132247543e3);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPIAttendee_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub Id: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pid: *mut i32) -> ::windows_core::HRESULT,
    pub RemoteName: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pval: *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub ControlLevel: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pval: *mut CTRL_LEVEL) -> ::windows_core::HRESULT,
    pub SetControlLevel: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pnewval: CTRL_LEVEL) -> ::windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Com")]
    pub Invitation: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, ppval: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    Invitation: usize,
    pub TerminateConnection: unsafe extern "system" fn(this: *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
...
impl IRDPSRAPIAttendeeDisconnectInfo {
    ...
    pub unsafe fn Attendee(&self) -> ::windows_core::Result<IRDPSRAPIAttendee> {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIAttendee>();
        (::windows_core::Interface::vtable(self).Attendee)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
    pub unsafe fn Reason(&self) -> ::windows_core::Result<ATTENDEE_DISCONNECT_REASON> {
        let mut result__ = ::windows_core::zeroed::<ATTENDEE_DISCONNECT_REASON>();
    ...
    pub unsafe fn Code(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::windows_core::zeroed::<i32>();
        (::windows_core::Interface::vtable(self).Code)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPIAttendeeDisconnectInfo {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0xc187689f_447c_44a1_9c14_fffbb3b7ec17);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPIAttendeeDisconnectInfo_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    #[cfg(feature = "Win32_System_Com")]
    pub Attendee: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, retval: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    Attendee: usize,
...
impl IRDPSRAPIAttendeeManager {
    ...
    pub unsafe fn get_Item(&self, id: i32) -> ::windows_core::Result<IRDPSRAPIAttendee> {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIAttendee>();
        (::windows_core::Interface::vtable(self).get_Item)(::windows_core::Interface::as_raw(self), id, &mut result__).from_abi(result__)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPIAttendeeManager {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0xba3a37e8_33da_4749_8da0_07fa34da7944);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPIAttendeeManager_Vtbl {
    ...
    pub _NewEnum: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, retval: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Com")]
    pub get_Item: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, id: i32, ppitem: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    get_Item: usize,
}
...
pub struct IRDPSRAPIAudioStream_Vtbl {
    ...
    pub Initialize: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pnperiodinhundrednsintervals: *mut i64) -> ::windows_core::HRESULT,
...
impl IRDPSRAPIClipboardUseEvents {
    ...
    {
        let mut result__ = ::windows_core::zeroed::<super::super::Foundation::VARIANT_BOOL>();
        (::windows_core::Interface::vtable(self).OnPasteFromClipboard)(::windows_core::Interface::as_raw(self), clipboardformat, pattendee.into_param().abi(), &mut result__).from_abi(result__)
    }
}
...
pub struct IRDPSRAPIClipboardUseEvents_Vtbl {
    pub base__: ::windows_core::IUnknown_Vtbl,
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com"))]
    pub OnPasteFromClipboard: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, clipboardformat: u32, pattendee: *mut ::core::ffi::c_void, pretval: *mut super::super::Foundation::VARIANT_BOOL) -> ::windows_core::HRESULT,
...
impl IRDPSRAPIDebug {
    ...
    {
        (::windows_core::Interface::vtable(self).SetCLXCmdLine)(::windows_core::Interface::as_raw(self), clxcmdline.into_param().abi()).ok()
    }
    pub unsafe fn CLXCmdLine(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::windows_core::zeroed::<::windows_core::BSTR>();
        (::windows_core::Interface::vtable(self).CLXCmdLine)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
}
...
impl IRDPSRAPIFrameBuffer {
    ...
    pub unsafe fn GetFrameBufferBits(&self, x: i32, y: i32, width: i32, heigth: i32) -> ::windows_core::Result<*mut super::Com::SAFEARRAY> {
        ...
        (::windows_core::Interface::vtable(self).GetFrameBufferBits)(::windows_core::Interface::as_raw(self), x, y, width, heigth, &mut result__).from_abi(result__)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPIFrameBuffer {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0x3d67e7d2_b27b_448e_81b3_c6110ed8b4be);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPIFrameBuffer_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub Width: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, plwidth: *mut i32) -> ::windows_core::HRESULT,
    pub Height: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, plheight: *mut i32) -> ::windows_core::HRESULT,
    pub Bpp: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, plbpp: *mut i32) -> ::windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Com")]
    pub GetFrameBufferBits: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, x: i32, y: i32, width: i32, heigth: i32, ppbits: *mut *mut super::Com::SAFEARRAY) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
...
impl IRDPSRAPIInvitation {
    pub unsafe fn ConnectionString(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::windows_core::zeroed::<::windows_core::BSTR>();
        (::windows_core::Interface::vtable(self).ConnectionString)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
    ...
    pub unsafe fn AttendeeLimit(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::windows_core::zeroed::<i32>();
        (::windows_core::Interface::vtable(self).AttendeeLimit)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
    ...
    where
        P0: ::windows_core::IntoParam<super::super::Foundation::VARIANT_BOOL>,
    {
        (::windows_core::Interface::vtable(self).SetRevoked)(::windows_core::Interface::as_raw(self), newval.into_param().abi()).ok()
    }
}
#[cfg(feature = "Win32_System_Com")]
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPIInvitation {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0x4fac1d43_fc51_45bb_b1b4_2b53aa562fa3);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPIInvitation_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub ConnectionString: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pbstrval: *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub GroupName: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pbstrval: *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub Password: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pbstrval: *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub AttendeeLimit: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pretval: *mut i32) -> ::windows_core::HRESULT,
    pub SetAttendeeLimit: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, newval: i32) -> ::windows_core::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub Revoked: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pretval: *mut super::super::Foundation::VARIANT_BOOL) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))]
    Revoked: usize,
    #[cfg(feature = "Win32_Foundation")]
    pub SetRevoked: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, newval: super::super::Foundation::VARIANT_BOOL) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))]
    SetRevoked: usize,
}
#[doc = "*Required features: `\"Win32_System_DesktopSharing\"`, `\"Win32_System_Com\"`*"]
...
impl IRDPSRAPIInvitationManager {
    ...
    pub unsafe fn get_Item(&self, item: super::Com::VARIANT) -> ::windows_core::Result<IRDPSRAPIInvitation> {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIInvitation>();
    ...
    {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIInvitation>();
        (::windows_core::Interface::vtable(self).CreateInvitation)(::windows_core::Interface::as_raw(self), bstrauthstring.into_param().abi(), bstrgroupname.into_param().abi(), bstrpassword.into_param().abi(), attendeelimit, &mut result__).from_abi(result__)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPIInvitationManager {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0x4722b049_92c3_4c2d_8a65_f7348f644dcf);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPIInvitationManager_Vtbl {
    ...
    pub _NewEnum: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, retval: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
    pub get_Item: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, item: super::Com::VARIANT, ppinvitation: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole")))]
    get_Item: usize,
    pub Count: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pretval: *mut i32) -> ::windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Com")]
    pub CreateInvitation: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, bstrauthstring: ::std::mem::MaybeUninit<::windows_core::BSTR>, bstrgroupname: ::std::mem::MaybeUninit<::windows_core::BSTR>, bstrpassword: ::std::mem::MaybeUninit<::windows_core::BSTR>, attendeelimit: i32, ppinvitation: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
...
impl IRDPSRAPIPerfCounterLoggingManager {
    ...
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIPerfCounterLogger>();
        (::windows_core::Interface::vtable(self).CreateLogger)(::windows_core::Interface::as_raw(self), bstrcountername.into_param().abi(), &mut result__).from_abi(result__)
    }
}
...
impl IRDPSRAPISessionProperties {
    #[doc = "*Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`, `\"Win32_System_Ole\"`*"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
    pub unsafe fn get_Property<P0>(&self, propertyname: P0) -> ::windows_core::Result<super::Com::VARIANT>
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
    ...
    #[doc = "*Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`, `\"Win32_System_Ole\"`*"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
    pub unsafe fn put_Property<P0>(&self, propertyname: P0, newval: super::Com::VARIANT) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        (::windows_core::Interface::vtable(self).put_Property)(::windows_core::Interface::as_raw(self), propertyname.into_param().abi(), ::core::mem::transmute(newval)).ok()
    }
}
#[cfg(feature = "Win32_System_Com")]
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPISessionProperties {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0x339b24f2_9bc0_4f16_9aac_f165433d13d4);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPISessionProperties_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
    pub get_Property: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, propertyname: ::std::mem::MaybeUninit<::windows_core::BSTR>, pval: *mut super::Com::VARIANT) -> ::windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole")))]
    get_Property: usize,
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
    pub put_Property: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, propertyname: ::std::mem::MaybeUninit<::windows_core::BSTR>, newval: super::Com::VARIANT) -> ::windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole")))]
    put_Property: usize,
}
#[doc = "*Required features: `\"Win32_System_DesktopSharing\"`, `\"Win32_System_Com\"`*"]
...
impl IRDPSRAPISharingSession {
    ...
    pub unsafe fn Properties(&self) -> ::windows_core::Result<IRDPSRAPISessionProperties> {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPISessionProperties>();
    ...
    pub unsafe fn Attendees(&self) -> ::windows_core::Result<IRDPSRAPIAttendeeManager> {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIAttendeeManager>();
    ...
    pub unsafe fn Invitations(&self) -> ::windows_core::Result<IRDPSRAPIInvitationManager> {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIInvitationManager>();
    ...
    pub unsafe fn ApplicationFilter(&self) -> ::windows_core::Result<IRDPSRAPIApplicationFilter> {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIApplicationFilter>();
    ...
    pub unsafe fn VirtualChannelManager(&self) -> ::windows_core::Result<IRDPSRAPIVirtualChannelManager> {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIVirtualChannelManager>();
    ...
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        (::windows_core::Interface::vtable(self).ConnectToClient)(::windows_core::Interface::as_raw(self), bstrconnectionstring.into_param().abi()).ok()
    }
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPISharingSession {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0xeeb20886_e470_4cf6_842b_2739c0ec5cfb);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPISharingSession_Vtbl {
    ...
    pub SetColorDepth: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, colordepth: i32) -> ::windows_core::HRESULT,
    pub ColorDepth: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pcolordepth: *mut i32) -> ::windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Com")]
    pub Properties: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, ppval: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    Properties: usize,
    #[cfg(feature = "Win32_System_Com")]
    pub Attendees: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, ppval: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    Attendees: usize,
    #[cfg(feature = "Win32_System_Com")]
    pub Invitations: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, ppval: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    Invitations: usize,
    #[cfg(feature = "Win32_System_Com")]
    pub ApplicationFilter: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, ppval: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    ApplicationFilter: usize,
    #[cfg(feature = "Win32_System_Com")]
    pub VirtualChannelManager: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, ppval: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    ...
    pub ConnectToClient: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, bstrconnectionstring: ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
...
impl IRDPSRAPISharingSession2 {
    pub unsafe fn Open(&self) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).base__.Open)(::windows_core::Interface::as_raw(self)).ok()
    }
    pub unsafe fn Close(&self) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).base__.Close)(::windows_core::Interface::as_raw(self)).ok()
    }
    pub unsafe fn SetColorDepth(&self, colordepth: i32) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).base__.SetColorDepth)(::windows_core::Interface::as_raw(self), colordepth).ok()
    }
    pub unsafe fn ColorDepth(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::windows_core::zeroed::<i32>();
    ...
    pub unsafe fn VirtualChannelManager(&self) -> ::windows_core::Result<IRDPSRAPIVirtualChannelManager> {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIVirtualChannelManager>();
        (::windows_core::Interface::vtable(self).base__.VirtualChannelManager)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
    pub unsafe fn Pause(&self) -> ::windows_core::Result<()> {
    ...
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        (::windows_core::Interface::vtable(self).base__.ConnectToClient)(::windows_core::Interface::as_raw(self), bstrconnectionstring.into_param().abi()).ok()
    }
    pub unsafe fn SetDesktopSharedRect(&self, left: i32, top: i32, right: i32, bottom: i32) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).base__.SetDesktopSharedRect)(::windows_core::Interface::as_raw(self), left, top, right, bottom).ok()
    }
    pub unsafe fn GetDesktopSharedRect(&self, pleft: *mut i32, ptop: *mut i32, pright: *mut i32, pbottom: *mut i32) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).base__.GetDesktopSharedRect)(::windows_core::Interface::as_raw(self), pleft, ptop, pright, pbottom).ok()
    }
    ...
    where
        P0: ::windows_core::IntoParam<IRDPSRAPITransportStream>,
        P1: ::windows_core::IntoParam<::windows_core::BSTR>,
        P2: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
    ...
    pub unsafe fn FrameBuffer(&self) -> ::windows_core::Result<IRDPSRAPIFrameBuffer> {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIFrameBuffer>();
    ...
    where
        P0: ::windows_core::IntoParam<IRDPSRAPIAttendee>,
    {
        (::windows_core::Interface::vtable(self).SendControlLevelChangeResponse)(::windows_core::Interface::as_raw(self), pattendee.into_param().abi(), requestedlevel, reasoncode).ok()
    }
}
#[cfg(feature = "Win32_System_Com")]
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPISharingSession2 {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0xfee4ee57_e3e8_4205_8fb0_8fd1d0675c21);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPISharingSession2_Vtbl {
    ...
    pub ConnectUsingTransportStream: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pstream: *mut ::core::ffi::c_void, bstrgroup: ::std::mem::MaybeUninit<::windows_core::BSTR>, bstrauthenticatedattendeename: ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Com")]
    pub FrameBuffer: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, ppval: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    FrameBuffer: usize,
    #[cfg(feature = "Win32_System_Com")]
    pub SendControlLevelChangeResponse: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pattendee: *mut ::core::ffi::c_void, requestedlevel: CTRL_LEVEL, reasoncode: i32) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
...
impl IRDPSRAPITcpConnectionInfo {
    ...
    pub unsafe fn LocalPort(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::windows_core::zeroed::<i32>();
        (::windows_core::Interface::vtable(self).LocalPort)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
    pub unsafe fn LocalIP(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::windows_core::zeroed::<::windows_core::BSTR>();
        (::windows_core::Interface::vtable(self).LocalIP)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
    pub unsafe fn PeerPort(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::windows_core::zeroed::<i32>();
        (::windows_core::Interface::vtable(self).PeerPort)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
    pub unsafe fn PeerIP(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::windows_core::zeroed::<::windows_core::BSTR>();
        (::windows_core::Interface::vtable(self).PeerIP)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPITcpConnectionInfo {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0xf74049a4_3d06_4028_8193_0a8c29bc2452);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPITcpConnectionInfo_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub Protocol: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, plprotocol: *mut i32) -> ::windows_core::HRESULT,
    pub LocalPort: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, plport: *mut i32) -> ::windows_core::HRESULT,
    pub LocalIP: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pbsrlocalip: *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
...
impl IRDPSRAPITransportStream {
    pub unsafe fn AllocBuffer(&self, maxpayload: i32) -> ::windows_core::Result<IRDPSRAPITransportStreamBuffer> {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPITransportStreamBuffer>();
        (::windows_core::Interface::vtable(self).AllocBuffer)(::windows_core::Interface::as_raw(self), maxpayload, &mut result__).from_abi(result__)
    }
    pub unsafe fn FreeBuffer<P0>(&self, pbuffer: P0) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<IRDPSRAPITransportStreamBuffer>,
    {
        (::windows_core::Interface::vtable(self).FreeBuffer)(::windows_core::Interface::as_raw(self), pbuffer.into_param().abi()).ok()
    }
    pub unsafe fn WriteBuffer<P0>(&self, pbuffer: P0) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<IRDPSRAPITransportStreamBuffer>,
    {
        (::windows_core::Interface::vtable(self).WriteBuffer)(::windows_core::Interface::as_raw(self), pbuffer.into_param().abi()).ok()
    }
    pub unsafe fn ReadBuffer<P0>(&self, pbuffer: P0) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<IRDPSRAPITransportStreamBuffer>,
    {
        (::windows_core::Interface::vtable(self).ReadBuffer)(::windows_core::Interface::as_raw(self), pbuffer.into_param().abi()).ok()
    }
    pub unsafe fn Open<P0>(&self, pcallbacks: P0) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<IRDPSRAPITransportStreamEvents>,
    {
        (::windows_core::Interface::vtable(self).Open)(::windows_core::Interface::as_raw(self), pcallbacks.into_param().abi()).ok()
    }
    pub unsafe fn Close(&self) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).Close)(::windows_core::Interface::as_raw(self)).ok()
    }
...
pub struct IRDPSRAPITransportStream_Vtbl {
    pub base__: ::windows_core::IUnknown_Vtbl,
    pub AllocBuffer: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, maxpayload: i32, ppbuffer: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    pub FreeBuffer: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pbuffer: *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    pub WriteBuffer: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pbuffer: *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    pub ReadBuffer: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pbuffer: *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
...
impl IRDPSRAPITransportStreamBuffer {
    pub unsafe fn Storage(&self) -> ::windows_core::Result<*mut u8> {
        ...
        (::windows_core::Interface::vtable(self).Storage)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
    pub unsafe fn StorageSize(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::windows_core::zeroed::<i32>();
        (::windows_core::Interface::vtable(self).StorageSize)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
    pub unsafe fn PayloadSize(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::windows_core::zeroed::<i32>();
        (::windows_core::Interface::vtable(self).PayloadSize)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
    ...
    pub unsafe fn PayloadOffset(&self) -> ::windows_core::Result<i32> {
        let mut result__ = ::windows_core::zeroed::<i32>();
        (::windows_core::Interface::vtable(self).PayloadOffset)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
...
pub struct IRDPSRAPITransportStreamBuffer_Vtbl {
    pub base__: ::windows_core::IUnknown_Vtbl,
    pub Storage: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, ppbstorage: *mut *mut u8) -> ::windows_core::HRESULT,
    pub StorageSize: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, plmaxstore: *mut i32) -> ::windows_core::HRESULT,
    pub PayloadSize: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, plretval: *mut i32) -> ::windows_core::HRESULT,
    pub SetPayloadSize: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, lval: i32) -> ::windows_core::HRESULT,
    pub PayloadOffset: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, plretval: *mut i32) -> ::windows_core::HRESULT,
    pub SetPayloadOffset: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, lretval: i32) -> ::windows_core::HRESULT,
    pub Flags: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, plflags: *mut i32) -> ::windows_core::HRESULT,
    pub SetFlags: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, lflags: i32) -> ::windows_core::HRESULT,
...
impl IRDPSRAPITransportStreamEvents {
    ...
    where
        P0: ::windows_core::IntoParam<IRDPSRAPITransportStreamBuffer>,
    {
        (::windows_core::Interface::vtable(self).OnWriteCompleted)(::windows_core::Interface::as_raw(self), pbuffer.into_param().abi())
    }
    pub unsafe fn OnReadCompleted<P0>(&self, pbuffer: P0)
    where
        P0: ::windows_core::IntoParam<IRDPSRAPITransportStreamBuffer>,
    {
        (::windows_core::Interface::vtable(self).OnReadCompleted)(::windows_core::Interface::as_raw(self), pbuffer.into_param().abi())
    }
...
impl IRDPSRAPIViewer {
    ...
    where
        ...
        P2: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        (::windows_core::Interface::vtable(self).Connect)(::windows_core::Interface::as_raw(self), bstrconnectionstring.into_param().abi(), bstrname.into_param().abi(), bstrpassword.into_param().abi()).ok()
    }
    ...
    pub unsafe fn SmartSizing(&self) -> ::windows_core::Result<super::super::Foundation::VARIANT_BOOL> {
        let mut result__ = ::windows_core::zeroed::<super::super::Foundation::VARIANT_BOOL>();
        (::windows_core::Interface::vtable(self).SmartSizing)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
    ...
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        (::windows_core::Interface::vtable(self).SetDisconnectedText)(::windows_core::Interface::as_raw(self), bstrdisconnectedtext.into_param().abi()).ok()
    }
    pub unsafe fn DisconnectedText(&self) -> ::windows_core::Result<::windows_core::BSTR> {
        let mut result__ = ::windows_core::zeroed::<::windows_core::BSTR>();
        (::windows_core::Interface::vtable(self).DisconnectedText)(::windows_core::Interface::as_raw(self), &mut result__).from_abi(result__)
    }
    ...
    {
        let mut result__ = ::windows_core::zeroed::<::windows_core::BSTR>();
        (::windows_core::Interface::vtable(self).StartReverseConnectListener)(::windows_core::Interface::as_raw(self), bstrconnectionstring.into_param().abi(), bstrusername.into_param().abi(), bstrpassword.into_param().abi(), &mut result__).from_abi(result__)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPIViewer {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0xc6bfcd38_8ce9_404d_8ae8_f31d00c65cb5);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPIViewer_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub Connect: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, bstrconnectionstring: ::std::mem::MaybeUninit<::windows_core::BSTR>, bstrname: ::std::mem::MaybeUninit<::windows_core::BSTR>, bstrpassword: ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    ...
    VirtualChannelManager: usize,
    #[cfg(feature = "Win32_Foundation")]
    pub SetSmartSizing: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, vbsmartsizing: super::super::Foundation::VARIANT_BOOL) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))]
    SetSmartSizing: usize,
    #[cfg(feature = "Win32_Foundation")]
    pub SmartSizing: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pvbsmartsizing: *mut super::super::Foundation::VARIANT_BOOL) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))]
    SmartSizing: usize,
    pub RequestControl: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, ctrllevel: CTRL_LEVEL) -> ::windows_core::HRESULT,
    pub SetDisconnectedText: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, bstrdisconnectedtext: ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub DisconnectedText: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pbstrdisconnectedtext: *mut ::std::mem::MaybeUninit<::windows_core::BSTR>) -> ::windows_core::HRESULT,
    pub RequestColorDepthChange: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, bpp: i32) -> ::windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Com")]
    pub Properties: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, ppval: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    Properties: usize,
...
impl IRDPSRAPIVirtualChannel {
    ...
    where
        P0: ::windows_core::IntoParam<::windows_core::BSTR>,
    {
        (::windows_core::Interface::vtable(self).SendData)(::windows_core::Interface::as_raw(self), bstrdata.into_param().abi(), lattendeeid, channelsendflags).ok()
    }
    ...
    pub unsafe fn Priority(&self) -> ::windows_core::Result<CHANNEL_PRIORITY> {
        let mut result__ = ::windows_core::zeroed::<CHANNEL_PRIORITY>();
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPIVirtualChannel {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0x05e12f95_28b3_4c9a_8780_d0248574a1e0);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPIVirtualChannel_Vtbl {
    pub base__: super::Com::IDispatch_Vtbl,
    pub SendData: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, bstrdata: ::std::mem::MaybeUninit<::windows_core::BSTR>, lattendeeid: i32, channelsendflags: u32) -> ::windows_core::HRESULT,
    pub SetAccess: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, lattendeeid: i32, accesstype: CHANNEL_ACCESS_ENUM) -> ::windows_core::HRESULT,
...
impl IRDPSRAPIVirtualChannelManager {
    ...
    #[doc = "*Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`, `\"Win32_System_Ole\"`*"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
    pub unsafe fn get_Item(&self, item: super::Com::VARIANT) -> ::windows_core::Result<IRDPSRAPIVirtualChannel> {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIVirtualChannel>();
        (::windows_core::Interface::vtable(self).get_Item)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(item), &mut result__).from_abi(result__)
    }
    #[doc = "*Required features: `\"Win32_System_Com\"`*"]
    #[cfg(feature = "Win32_System_Com")]
    ...
    {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIVirtualChannel>();
        (::windows_core::Interface::vtable(self).CreateVirtualChannel)(::windows_core::Interface::as_raw(self), bstrchannelname.into_param().abi(), priority, channelflags, &mut result__).from_abi(result__)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPIVirtualChannelManager {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0x0d11c661_5d0d_4ee4_89df_2166ae1fdfed);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPIVirtualChannelManager_Vtbl {
    ...
    pub _NewEnum: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, retval: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
    pub get_Item: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, item: super::Com::VARIANT, pchannel: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole")))]
    get_Item: usize,
    #[cfg(feature = "Win32_System_Com")]
    pub CreateVirtualChannel: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, bstrchannelname: ::std::mem::MaybeUninit<::windows_core::BSTR>, priority: CHANNEL_PRIORITY, channelflags: u32, ppchannel: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPIWindow {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0xbeafe0f9_c77b_4933_ba9f_a24cddcc27cf);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPIWindow_Vtbl {
    ...
    pub Id: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pretval: *mut i32) -> ::windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Com")]
    pub Application: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, papplication: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    Application: usize,
    #[cfg(feature = "Win32_Foundation")]
    pub Shared: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pretval: *mut super::super::Foundation::VARIANT_BOOL) -> ::windows_core::HRESULT,
...
impl IRDPSRAPIWindowList {
    ...
    pub unsafe fn get_Item(&self, item: i32) -> ::windows_core::Result<IRDPSRAPIWindow> {
        let mut result__ = ::windows_core::zeroed::<IRDPSRAPIWindow>();
        (::windows_core::Interface::vtable(self).get_Item)(::windows_core::Interface::as_raw(self), item, &mut result__).from_abi(result__)
    }
}
#[cfg(feature = "Win32_System_Com")]
...
unsafe impl ::windows_core::ComInterface for IRDPSRAPIWindowList {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0x8a05ce44_715a_4116_a189_a118f30a07bd);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
pub struct IRDPSRAPIWindowList_Vtbl {
    ...
    pub _NewEnum: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, retval: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(feature = "Win32_System_Com")]
    pub get_Item: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, item: i32, pwindow: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_System_Com"))]
    get_Item: usize,
}
#[doc = "*Required features: `\"Win32_System_DesktopSharing\"`*"]
...
impl IRDPViewerInputSink {
    ...
    where
        P0: ::windows_core::IntoParam<super::super::Foundation::VARIANT_BOOL>,
    {
        (::windows_core::Interface::vtable(self).SendMouseButtonEvent)(::windows_core::Interface::as_raw(self), buttontype, vbbuttondown.into_param().abi(), xpos, ypos).ok()
    }
    ...
    {
        (::windows_core::Interface::vtable(self).SendKeyboardEvent)(::windows_core::Interface::as_raw(self), codetype, keycode, vbkeyup.into_param().abi(), vbrepeat.into_param().abi(), vbextended.into_param().abi()).ok()
    }
...
pub struct IRDPViewerInputSink_Vtbl {
    pub base__: ::windows_core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_Foundation")]
    pub SendMouseButtonEvent: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, buttontype: RDPSRAPI_MOUSE_BUTTON_TYPE, vbbuttondown: super::super::Foundation::VARIANT_BOOL, xpos: u32, ypos: u32) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))]
    SendMouseButtonEvent: usize,
    pub SendMouseMoveEvent: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, xpos: u32, ypos: u32) -> ::windows_core::HRESULT,
    pub SendMouseWheelEvent: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, wheelrotation: u16) -> ::windows_core::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub SendKeyboardEvent: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, codetype: RDPSRAPI_KBD_CODE_TYPE, keycode: u16, vbkeyup: super::super::Foundation::VARIANT_BOOL, vbrepeat: super::super::Foundation::VARIANT_BOOL, vbextended: super::super::Foundation::VARIANT_BOOL) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))]
    SendKeyboardEvent: usize,
    pub SendSyncEvent: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, syncflags: u32) -> ::windows_core::HRESULT,
    pub BeginTouchFrame: unsafe extern "system" fn(this: *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
...
unsafe impl ::windows_core::ComInterface for _IRDPSessionEvents {
    const IID: ::windows_core::GUID = ::windows_core::GUID::from_u128(0x98a97042_6698_40e9_8efd_b3200990004b);
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
#[doc(hidden)]
