...
impl IRDPSRAPIApplication {
    pub unsafe fn Windows(&self) -> Result<IRDPSRAPIWindowList, windows_result::HRESULT> {
        unsafe {
    ...
    pub unsafe fn Id(&self) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Id)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn Shared(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Shared)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetShared(&self, newval: super::super::Foundation::VARIANT_BOOL) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Flags(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRDPSRAPIApplication_Impl: super::Com::IDispatch_Impl {
    fn Windows(&self) -> Result<IRDPSRAPIWindowList, windows_result::HRESULT>;
    fn Id(&self) -> Result<i32, windows_result::HRESULT>;
    fn Shared(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT>;
    fn SetShared(&self, newval: super::super::Foundation::VARIANT_BOOL) -> Result<(), windows_result::HRESULT>;
    fn Name(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn Flags(&self) -> Result<u32, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRDPSRAPIApplicationFilter {
    pub unsafe fn Applications(&self) -> Result<IRDPSRAPIApplicationList, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRDPSRAPIApplicationFilter_Impl: super::Com::IDispatch_Impl {
    fn Applications(&self) -> Result<IRDPSRAPIApplicationList, windows_result::HRESULT>;
    fn Windows(&self) -> Result<IRDPSRAPIWindowList, windows_result::HRESULT>;
...
impl IRDPSRAPIApplicationList {
    ...
    pub unsafe fn get_Item(&self, item: i32) -> Result<IRDPSRAPIApplication, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRDPSRAPIApplicationList_Impl: super::Com::IDispatch_Impl {
    ...
    fn get_Item(&self, item: i32) -> Result<IRDPSRAPIApplication, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRDPSRAPIAttendee {
    ...
    pub unsafe fn RemoteName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ControlLevel(&self) -> Result<CTRL_LEVEL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ControlLevel)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetControlLevel(&self, pnewval: CTRL_LEVEL) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetControlLevel)(windows_core::Interface::as_raw(self), pnewval).ok() }
    }
    pub unsafe fn Invitation(&self) -> Result<IRDPSRAPIInvitation, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn TerminateConnection(&self) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn ConnectivityInfo(&self) -> Result<windows_core::IUnknown, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRDPSRAPIAttendee_Impl: super::Com::IDispatch_Impl {
    fn Id(&self) -> Result<i32, windows_result::HRESULT>;
    fn RemoteName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn ControlLevel(&self) -> Result<CTRL_LEVEL, windows_result::HRESULT>;
    fn SetControlLevel(&self, pnewval: CTRL_LEVEL) -> Result<(), windows_result::HRESULT>;
    fn Invitation(&self) -> Result<IRDPSRAPIInvitation, windows_result::HRESULT>;
    fn TerminateConnection(&self) -> Result<(), windows_result::HRESULT>;
    fn Flags(&self) -> Result<i32, windows_result::HRESULT>;
    fn ConnectivityInfo(&self) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRDPSRAPIAttendeeDisconnectInfo {
    pub unsafe fn Attendee(&self) -> Result<IRDPSRAPIAttendee, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Reason(&self) -> Result<ATTENDEE_DISCONNECT_REASON, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Reason)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn Code(&self) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRDPSRAPIAttendeeDisconnectInfo_Impl: super::Com::IDispatch_Impl {
    fn Attendee(&self) -> Result<IRDPSRAPIAttendee, windows_result::HRESULT>;
    fn Reason(&self) -> Result<ATTENDEE_DISCONNECT_REASON, windows_result::HRESULT>;
    fn Code(&self) -> Result<i32, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRDPSRAPIAttendeeManager {
    ...
    pub unsafe fn get_Item(&self, id: i32) -> Result<IRDPSRAPIAttendee, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRDPSRAPIAttendeeManager_Impl: super::Com::IDispatch_Impl {
    fn _NewEnum(&self) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
    fn get_Item(&self, id: i32) -> Result<IRDPSRAPIAttendee, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRDPSRAPIAudioStream {
    pub unsafe fn Initialize(&self) -> Result<i64, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetBuffer(&self, ppbdata: *mut *mut u8, pcbdata: *mut u32, ptimestamp: *mut u64) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn FreeBuffer(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IRDPSRAPIAudioStream_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self) -> Result<i64, windows_result::HRESULT>;
    fn Start(&self) -> Result<(), windows_result::HRESULT>;
    fn Stop(&self) -> Result<(), windows_result::HRESULT>;
    fn GetBuffer(&self, ppbdata: *mut *mut u8, pcbdata: *mut u32, ptimestamp: *mut u64) -> Result<(), windows_result::HRESULT>;
    fn FreeBuffer(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IRDPSRAPIClipboardUseEvents {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn OnPasteFromClipboard<P1>(&self, clipboardformat: u32, pattendee: P1) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT>
    where
...
pub trait IRDPSRAPIClipboardUseEvents_Impl: windows_core::IUnknownImpl {
    fn OnPasteFromClipboard(&self, clipboardformat: u32, pattendee: windows_core::Ref<'_, super::Com::IDispatch>) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IRDPSRAPIDebug {
    pub unsafe fn SetCLXCmdLine(&self, clxcmdline: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn CLXCmdLine(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRDPSRAPIDebug_Impl: windows_core::IUnknownImpl {
    fn SetCLXCmdLine(&self, clxcmdline: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn CLXCmdLine(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
}
...
impl IRDPSRAPIFrameBuffer {
    ...
    pub unsafe fn Bpp(&self) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Bpp)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetFrameBufferBits(&self, x: i32, y: i32, width: i32, heigth: i32) -> Result<*mut super::Com::SAFEARRAY, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRDPSRAPIFrameBuffer_Impl: super::Com::IDispatch_Impl {
    ...
    fn Bpp(&self) -> Result<i32, windows_result::HRESULT>;
    fn GetFrameBufferBits(&self, x: i32, y: i32, width: i32, heigth: i32) -> Result<*mut super::Com::SAFEARRAY, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRDPSRAPIInvitation {
    pub unsafe fn ConnectionString(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GroupName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Password(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AttendeeLimit(&self) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AttendeeLimit)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetAttendeeLimit(&self, newval: i32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetAttendeeLimit)(windows_core::Interface::as_raw(self), newval).ok() }
    }
    pub unsafe fn Revoked(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Revoked)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetRevoked(&self, newval: super::super::Foundation::VARIANT_BOOL) -> Result<(), windows_result::HRESULT> {
...
pub trait IRDPSRAPIInvitation_Impl: super::Com::IDispatch_Impl {
    fn ConnectionString(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn GroupName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn Password(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn AttendeeLimit(&self) -> Result<i32, windows_result::HRESULT>;
    fn SetAttendeeLimit(&self, newval: i32) -> Result<(), windows_result::HRESULT>;
    fn Revoked(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT>;
    fn SetRevoked(&self, newval: super::super::Foundation::VARIANT_BOOL) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRDPSRAPIInvitationManager {
    ...
    pub unsafe fn get_Item(&self, item: &super::Variant::VARIANT) -> Result<IRDPSRAPIInvitation, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateInvitation(&self, bstrauthstring: &windows_core::BSTR, bstrgroupname: &windows_core::BSTR, bstrpassword: &windows_core::BSTR, attendeelimit: i32) -> Result<IRDPSRAPIInvitation, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRDPSRAPIInvitationManager_Impl: super::Com::IDispatch_Impl {
    fn _NewEnum(&self) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
    fn get_Item(&self, item: &super::Variant::VARIANT) -> Result<IRDPSRAPIInvitation, windows_result::HRESULT>;
    fn Count(&self) -> Result<i32, windows_result::HRESULT>;
    fn CreateInvitation(&self, bstrauthstring: &windows_core::BSTR, bstrgroupname: &windows_core::BSTR, bstrpassword: &windows_core::BSTR, attendeelimit: i32) -> Result<IRDPSRAPIInvitation, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRDPSRAPIPerfCounterLogger {
    pub unsafe fn LogValue(&self, lvalue: i64) -> Result<(), windows_result::HRESULT> {
...
pub trait IRDPSRAPIPerfCounterLogger_Impl: windows_core::IUnknownImpl {
    fn LogValue(&self, lvalue: i64) -> Result<(), windows_result::HRESULT>;
}
...
impl IRDPSRAPIPerfCounterLoggingManager {
    pub unsafe fn CreateLogger(&self, bstrcountername: &windows_core::BSTR) -> Result<IRDPSRAPIPerfCounterLogger, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRDPSRAPIPerfCounterLoggingManager_Impl: windows_core::IUnknownImpl {
    fn CreateLogger(&self, bstrcountername: &windows_core::BSTR) -> Result<IRDPSRAPIPerfCounterLogger, windows_result::HRESULT>;
}
...
impl IRDPSRAPISessionProperties {
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn get_Property(&self, propertyname: &windows_core::BSTR) -> Result<super::Variant::VARIANT, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn put_Property(&self, propertyname: &windows_core::BSTR, newval: &super::Variant::VARIANT) -> Result<(), windows_result::HRESULT> {
...
pub trait IRDPSRAPISessionProperties_Impl: super::Com::IDispatch_Impl {
    fn get_Property(&self, propertyname: &windows_core::BSTR) -> Result<super::Variant::VARIANT, windows_result::HRESULT>;
    fn put_Property(&self, propertyname: &windows_core::BSTR, newval: &super::Variant::VARIANT) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRDPSRAPISharingSession {
    pub unsafe fn Open(&self) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetColorDepth(&self, colordepth: i32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetColorDepth)(windows_core::Interface::as_raw(self), colordepth).ok() }
    }
    pub unsafe fn ColorDepth(&self) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ColorDepth)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn Properties(&self) -> Result<IRDPSRAPISessionProperties, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Attendees(&self) -> Result<IRDPSRAPIAttendeeManager, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Invitations(&self) -> Result<IRDPSRAPIInvitationManager, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ApplicationFilter(&self) -> Result<IRDPSRAPIApplicationFilter, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn VirtualChannelManager(&self) -> Result<IRDPSRAPIVirtualChannelManager, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ConnectToClient(&self, bstrconnectionstring: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetDesktopSharedRect(&self, left: i32, top: i32, right: i32, bottom: i32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetDesktopSharedRect(&self, pleft: *mut i32, ptop: *mut i32, pright: *mut i32, pbottom: *mut i32) -> Result<(), windows_result::HRESULT> {
...
pub trait IRDPSRAPISharingSession_Impl: super::Com::IDispatch_Impl {
    fn Open(&self) -> Result<(), windows_result::HRESULT>;
    fn Close(&self) -> Result<(), windows_result::HRESULT>;
    fn SetColorDepth(&self, colordepth: i32) -> Result<(), windows_result::HRESULT>;
    fn ColorDepth(&self) -> Result<i32, windows_result::HRESULT>;
    fn Properties(&self) -> Result<IRDPSRAPISessionProperties, windows_result::HRESULT>;
    fn Attendees(&self) -> Result<IRDPSRAPIAttendeeManager, windows_result::HRESULT>;
    fn Invitations(&self) -> Result<IRDPSRAPIInvitationManager, windows_result::HRESULT>;
    fn ApplicationFilter(&self) -> Result<IRDPSRAPIApplicationFilter, windows_result::HRESULT>;
    fn VirtualChannelManager(&self) -> Result<IRDPSRAPIVirtualChannelManager, windows_result::HRESULT>;
    fn Pause(&self) -> Result<(), windows_result::HRESULT>;
    fn Resume(&self) -> Result<(), windows_result::HRESULT>;
    fn ConnectToClient(&self, bstrconnectionstring: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn SetDesktopSharedRect(&self, left: i32, top: i32, right: i32, bottom: i32) -> Result<(), windows_result::HRESULT>;
    fn GetDesktopSharedRect(&self, pleft: *mut i32, ptop: *mut i32, pright: *mut i32, pbottom: *mut i32) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRDPSRAPISharingSession2 {
    pub unsafe fn ConnectUsingTransportStream<P0>(&self, pstream: P0, bstrgroup: &windows_core::BSTR, bstrauthenticatedattendeename: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn FrameBuffer(&self) -> Result<IRDPSRAPIFrameBuffer, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SendControlLevelChangeResponse<P0>(&self, pattendee: P0, requestedlevel: CTRL_LEVEL, reasoncode: i32) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IRDPSRAPISharingSession2_Impl: IRDPSRAPISharingSession_Impl {
    fn ConnectUsingTransportStream(&self, pstream: windows_core::Ref<'_, IRDPSRAPITransportStream>, bstrgroup: &windows_core::BSTR, bstrauthenticatedattendeename: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn FrameBuffer(&self) -> Result<IRDPSRAPIFrameBuffer, windows_result::HRESULT>;
    fn SendControlLevelChangeResponse(&self, pattendee: windows_core::Ref<'_, IRDPSRAPIAttendee>, requestedlevel: CTRL_LEVEL, reasoncode: i32) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRDPSRAPITcpConnectionInfo {
    ...
    pub unsafe fn LocalPort(&self) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LocalPort)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn LocalIP(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn PeerPort(&self) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PeerPort)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn PeerIP(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRDPSRAPITcpConnectionInfo_Impl: super::Com::IDispatch_Impl {
    ...
    fn LocalPort(&self) -> Result<i32, windows_result::HRESULT>;
    fn LocalIP(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn PeerPort(&self) -> Result<i32, windows_result::HRESULT>;
    fn PeerIP(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRDPSRAPITransportStream {
    pub unsafe fn AllocBuffer(&self, maxpayload: i32) -> Result<IRDPSRAPITransportStreamBuffer, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn FreeBuffer<P0>(&self, pbuffer: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn WriteBuffer<P0>(&self, pbuffer: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IRDPSRAPITransportStreamBuffer>,
    {
        unsafe { (windows_core::Interface::vtable(self).WriteBuffer)(windows_core::Interface::as_raw(self), pbuffer.param().abi()).ok() }
    }
    pub unsafe fn ReadBuffer<P0>(&self, pbuffer: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IRDPSRAPITransportStreamBuffer>,
    {
        unsafe { (windows_core::Interface::vtable(self).ReadBuffer)(windows_core::Interface::as_raw(self), pbuffer.param().abi()).ok() }
    }
    pub unsafe fn Open<P0>(&self, pcallbacks: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IRDPSRAPITransportStream_Impl: windows_core::IUnknownImpl {
    fn AllocBuffer(&self, maxpayload: i32) -> Result<IRDPSRAPITransportStreamBuffer, windows_result::HRESULT>;
    fn FreeBuffer(&self, pbuffer: windows_core::Ref<'_, IRDPSRAPITransportStreamBuffer>) -> Result<(), windows_result::HRESULT>;
    fn WriteBuffer(&self, pbuffer: windows_core::Ref<'_, IRDPSRAPITransportStreamBuffer>) -> Result<(), windows_result::HRESULT>;
    fn ReadBuffer(&self, pbuffer: windows_core::Ref<'_, IRDPSRAPITransportStreamBuffer>) -> Result<(), windows_result::HRESULT>;
    fn Open(&self, pcallbacks: windows_core::Ref<'_, IRDPSRAPITransportStreamEvents>) -> Result<(), windows_result::HRESULT>;
    fn Close(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IRDPSRAPITransportStreamBuffer {
    ...
    pub unsafe fn SetFlags(&self, lflags: i32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetFlags)(windows_core::Interface::as_raw(self), lflags).ok() }
    }
    pub unsafe fn Context(&self) -> Result<windows_core::IUnknown, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRDPSRAPITransportStreamBuffer_Impl: windows_core::IUnknownImpl {
    fn Storage(&self) -> Result<*mut u8, windows_result::HRESULT>;
    fn StorageSize(&self) -> Result<i32, windows_result::HRESULT>;
    fn PayloadSize(&self) -> Result<i32, windows_result::HRESULT>;
    fn SetPayloadSize(&self, lval: i32) -> Result<(), windows_result::HRESULT>;
    fn PayloadOffset(&self) -> Result<i32, windows_result::HRESULT>;
    fn SetPayloadOffset(&self, lretval: i32) -> Result<(), windows_result::HRESULT>;
    fn Flags(&self) -> Result<i32, windows_result::HRESULT>;
    fn SetFlags(&self, lflags: i32) -> Result<(), windows_result::HRESULT>;
    fn Context(&self) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
...
impl IRDPSRAPIViewer {
    pub unsafe fn Connect(&self, bstrconnectionstring: &windows_core::BSTR, bstrname: &windows_core::BSTR, bstrpassword: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetSmartSizing(&self, vbsmartsizing: super::super::Foundation::VARIANT_BOOL) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetSmartSizing)(windows_core::Interface::as_raw(self), vbsmartsizing).ok() }
    }
    pub unsafe fn SmartSizing(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SmartSizing)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn RequestControl(&self, ctrllevel: CTRL_LEVEL) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).RequestControl)(windows_core::Interface::as_raw(self), ctrllevel).ok() }
    }
    pub unsafe fn SetDisconnectedText(&self, bstrdisconnectedtext: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn DisconnectedText(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RequestColorDepthChange(&self, bpp: i32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn StartReverseConnectListener(&self, bstrconnectionstring: &windows_core::BSTR, bstrusername: &windows_core::BSTR, bstrpassword: &windows_core::BSTR) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRDPSRAPIViewer_Impl: super::Com::IDispatch_Impl {
    fn Connect(&self, bstrconnectionstring: &windows_core::BSTR, bstrname: &windows_core::BSTR, bstrpassword: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn Disconnect(&self) -> Result<(), windows_result::HRESULT>;
    fn Attendees(&self) -> Result<IRDPSRAPIAttendeeManager, windows_result::HRESULT>;
    fn Invitations(&self) -> Result<IRDPSRAPIInvitationManager, windows_result::HRESULT>;
    fn ApplicationFilter(&self) -> Result<IRDPSRAPIApplicationFilter, windows_result::HRESULT>;
    fn VirtualChannelManager(&self) -> Result<IRDPSRAPIVirtualChannelManager, windows_result::HRESULT>;
    fn SetSmartSizing(&self, vbsmartsizing: super::super::Foundation::VARIANT_BOOL) -> Result<(), windows_result::HRESULT>;
    fn SmartSizing(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT>;
    fn RequestControl(&self, ctrllevel: CTRL_LEVEL) -> Result<(), windows_result::HRESULT>;
    fn SetDisconnectedText(&self, bstrdisconnectedtext: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn DisconnectedText(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn RequestColorDepthChange(&self, bpp: i32) -> Result<(), windows_result::HRESULT>;
    fn Properties(&self) -> Result<IRDPSRAPISessionProperties, windows_result::HRESULT>;
    fn StartReverseConnectListener(&self, bstrconnectionstring: &windows_core::BSTR, bstrusername: &windows_core::BSTR, bstrpassword: &windows_core::BSTR) -> Result<windows_core::BSTR, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRDPSRAPIVirtualChannel {
    pub unsafe fn SendData(&self, bstrdata: &windows_core::BSTR, lattendeeid: i32, channelsendflags: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetAccess(&self, lattendeeid: i32, accesstype: CHANNEL_ACCESS_ENUM) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Priority(&self) -> Result<CHANNEL_PRIORITY, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRDPSRAPIVirtualChannel_Impl: super::Com::IDispatch_Impl {
    fn SendData(&self, bstrdata: &windows_core::BSTR, lattendeeid: i32, channelsendflags: u32) -> Result<(), windows_result::HRESULT>;
    fn SetAccess(&self, lattendeeid: i32, accesstype: CHANNEL_ACCESS_ENUM) -> Result<(), windows_result::HRESULT>;
    fn Name(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn Flags(&self) -> Result<i32, windows_result::HRESULT>;
    fn Priority(&self) -> Result<CHANNEL_PRIORITY, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRDPSRAPIVirtualChannelManager {
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn get_Item(&self, item: &super::Variant::VARIANT) -> Result<IRDPSRAPIVirtualChannel, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_Item)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(item), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateVirtualChannel(&self, bstrchannelname: &windows_core::BSTR, priority: CHANNEL_PRIORITY, channelflags: u32) -> Result<IRDPSRAPIVirtualChannel, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRDPSRAPIVirtualChannelManager_Impl: super::Com::IDispatch_Impl {
    fn _NewEnum(&self) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
    fn get_Item(&self, item: &super::Variant::VARIANT) -> Result<IRDPSRAPIVirtualChannel, windows_result::HRESULT>;
    fn CreateVirtualChannel(&self, bstrchannelname: &windows_core::BSTR, priority: CHANNEL_PRIORITY, channelflags: u32) -> Result<IRDPSRAPIVirtualChannel, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRDPSRAPIWindow {
    ...
    pub unsafe fn Application(&self) -> Result<IRDPSRAPIApplication, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Show(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IRDPSRAPIWindow_Impl: super::Com::IDispatch_Impl {
    fn Id(&self) -> Result<i32, windows_result::HRESULT>;
    fn Application(&self) -> Result<IRDPSRAPIApplication, windows_result::HRESULT>;
    fn Shared(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT>;
    fn SetShared(&self, newval: super::super::Foundation::VARIANT_BOOL) -> Result<(), windows_result::HRESULT>;
    fn Name(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn Show(&self) -> Result<(), windows_result::HRESULT>;
    fn Flags(&self) -> Result<u32, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRDPSRAPIWindowList {
    ...
    pub unsafe fn get_Item(&self, item: i32) -> Result<IRDPSRAPIWindow, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_Item)(windows_core::Interface::as_raw(self), item, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IRDPSRAPIWindowList_Impl: super::Com::IDispatch_Impl {
    fn _NewEnum(&self) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
    fn get_Item(&self, item: i32) -> Result<IRDPSRAPIWindow, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRDPViewerInputSink {
    pub unsafe fn SendMouseButtonEvent(&self, buttontype: RDPSRAPI_MOUSE_BUTTON_TYPE, vbbuttondown: super::super::Foundation::VARIANT_BOOL, xpos: u32, ypos: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SendMouseMoveEvent(&self, xpos: u32, ypos: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SendMouseMoveEvent)(windows_core::Interface::as_raw(self), xpos, ypos).ok() }
    }
    pub unsafe fn SendMouseWheelEvent(&self, wheelrotation: u16) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SendMouseWheelEvent)(windows_core::Interface::as_raw(self), wheelrotation).ok() }
    }
    pub unsafe fn SendKeyboardEvent(&self, codetype: RDPSRAPI_KBD_CODE_TYPE, keycode: u16, vbkeyup: super::super::Foundation::VARIANT_BOOL, vbrepeat: super::super::Foundation::VARIANT_BOOL, vbextended: super::super::Foundation::VARIANT_BOOL) -> Result<(), windows_result::HRESULT> {
...
pub trait IRDPViewerInputSink_Impl: windows_core::IUnknownImpl {
    fn SendMouseButtonEvent(&self, buttontype: RDPSRAPI_MOUSE_BUTTON_TYPE, vbbuttondown: super::super::Foundation::VARIANT_BOOL, xpos: u32, ypos: u32) -> Result<(), windows_result::HRESULT>;
    fn SendMouseMoveEvent(&self, xpos: u32, ypos: u32) -> Result<(), windows_result::HRESULT>;
    fn SendMouseWheelEvent(&self, wheelrotation: u16) -> Result<(), windows_result::HRESULT>;
    fn SendKeyboardEvent(&self, codetype: RDPSRAPI_KBD_CODE_TYPE, keycode: u16, vbkeyup: super::super::Foundation::VARIANT_BOOL, vbrepeat: super::super::Foundation::VARIANT_BOOL, vbextended: super::super::Foundation::VARIANT_BOOL) -> Result<(), windows_result::HRESULT>;
    fn SendSyncEvent(&self, syncflags: u32) -> Result<(), windows_result::HRESULT>;
    fn BeginTouchFrame(&self) -> Result<(), windows_result::HRESULT>;
    fn AddTouchInput(&self, contactid: u32, event: u32, x: i32, y: i32) -> Result<(), windows_result::HRESULT>;
    fn EndTouchFrame(&self) -> Result<(), windows_result::HRESULT>;
}
