...
impl IPrintDocumentPageSource_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: IPrintDocumentPageSource_Impl, const OFFSET: isize>() -> IPrintDocumentPageSource_Vtbl {
        unsafe extern "system" fn GetPreviewPageCollection<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: IPrintDocumentPageSource_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, docpackagetarget: *mut core::ffi::c_void, docpagecollection: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            ...
            match IPrintDocumentPageSource_Impl::GetPreviewPageCollection(this, windows_core::from_raw_borrowed(&docpackagetarget)) {
                Ok(ok__) => {
                    core::ptr::write(docpagecollection, core::mem::transmute(ok__));
                    windows_core::HRESULT(0)
                }
                Err(err) => err.into(),
            }
        }
        unsafe extern "system" fn MakeDocument<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: IPrintDocumentPageSource_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, printtaskoptions: *mut core::ffi::c_void, docpackagetarget: *mut core::ffi::c_void) -> windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
        ...
        Self {
            ...
            GetPreviewPageCollection: GetPreviewPageCollection::<Identity, Impl, OFFSET>,
            MakeDocument: MakeDocument::<Identity, Impl, OFFSET>,
        }
    }
...
impl IPrintPreviewPageCollection_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: IPrintPreviewPageCollection_Impl, const OFFSET: isize>() -> IPrintPreviewPageCollection_Vtbl {
        unsafe extern "system" fn Paginate<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: IPrintPreviewPageCollection_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, currentjobpage: u32, printtaskoptions: *mut core::ffi::c_void) -> windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
        ...
        unsafe extern "system" fn MakePage<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: IPrintPreviewPageCollection_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, desiredjobpage: u32, width: f32, height: f32) -> windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            Paginate: Paginate::<Identity, Impl, OFFSET>,
            MakePage: MakePage::<Identity, Impl, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
