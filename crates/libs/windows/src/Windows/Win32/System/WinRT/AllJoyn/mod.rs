...
impl IWindowsDevicesAllJoynBusAttachmentFactoryInterop {
    pub unsafe fn CreateFromWin32Handle<T>(&self, win32handle: u64, enableaboutdata: u8) -> Result<T, windows_result::HRESULT>
    where
...
pub trait IWindowsDevicesAllJoynBusAttachmentFactoryInterop_Impl: windows_core::IUnknownImpl {
    fn CreateFromWin32Handle(&self, win32handle: u64, enableaboutdata: u8, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
}
...
impl IWindowsDevicesAllJoynBusAttachmentInterop {
    pub unsafe fn Win32Handle(&self) -> Result<u64, windows_result::HRESULT> {
        unsafe {
...
pub trait IWindowsDevicesAllJoynBusAttachmentInterop_Impl: windows_core::IUnknownImpl {
    fn Win32Handle(&self) -> Result<u64, windows_result::HRESULT>;
}
...
impl IWindowsDevicesAllJoynBusObjectFactoryInterop {
    pub unsafe fn CreateFromWin32Handle<T>(&self, win32handle: u64) -> Result<T, windows_result::HRESULT>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
...
pub trait IWindowsDevicesAllJoynBusObjectFactoryInterop_Impl: windows_core::IUnknownImpl {
    fn CreateFromWin32Handle(&self, win32handle: u64, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
}
...
impl IWindowsDevicesAllJoynBusObjectInterop {
    pub unsafe fn AddPropertyGetHandler(&self, context: *const core::ffi::c_void, interfacename: &windows_core::HSTRING, callback: isize) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn AddPropertySetHandler(&self, context: *const core::ffi::c_void, interfacename: &windows_core::HSTRING, callback: isize) -> Result<(), windows_result::HRESULT> {
...
pub trait IWindowsDevicesAllJoynBusObjectInterop_Impl: windows_core::IUnknownImpl {
    fn AddPropertyGetHandler(&self, context: *const core::ffi::c_void, interfacename: &windows_core::HSTRING, callback: isize) -> Result<(), windows_result::HRESULT>;
    fn AddPropertySetHandler(&self, context: *const core::ffi::c_void, interfacename: &windows_core::HSTRING, callback: isize) -> Result<(), windows_result::HRESULT>;
    fn Win32Handle(&self) -> Result<u64, windows_result::HRESULT>;
}
