...
impl IWindowsDevicesAllJoynBusAttachmentFactoryInteropVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWindowsDevicesAllJoynBusAttachmentFactoryInteropImpl, const OFFSET: isize>() -> IWindowsDevicesAllJoynBusAttachmentFactoryInteropVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IWindowsDevicesAllJoynBusAttachmentFactoryInterop>, ::windows::core::GetTrustLevel, CreateFromWin32Handle::<Impl, OFFSET>)
    }
}
...
impl IWindowsDevicesAllJoynBusAttachmentInteropVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWindowsDevicesAllJoynBusAttachmentInteropImpl, const OFFSET: isize>() -> IWindowsDevicesAllJoynBusAttachmentInteropVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IWindowsDevicesAllJoynBusAttachmentInterop>, ::windows::core::GetTrustLevel, Win32Handle::<Impl, OFFSET>)
    }
}
...
impl IWindowsDevicesAllJoynBusObjectFactoryInteropVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWindowsDevicesAllJoynBusObjectFactoryInteropImpl, const OFFSET: isize>() -> IWindowsDevicesAllJoynBusObjectFactoryInteropVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IWindowsDevicesAllJoynBusObjectFactoryInterop>, ::windows::core::GetTrustLevel, CreateFromWin32Handle::<Impl, OFFSET>)
    }
}
...
impl IWindowsDevicesAllJoynBusObjectInteropVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWindowsDevicesAllJoynBusObjectInteropImpl, const OFFSET: isize>() -> IWindowsDevicesAllJoynBusObjectInteropVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IWindowsDevicesAllJoynBusObjectInterop>, ::windows::core::GetTrustLevel, AddPropertyGetHandler::<Impl, OFFSET>, AddPropertySetHandler::<Impl, OFFSET>, Win32Handle::<Impl, OFFSET>)
    }
}
