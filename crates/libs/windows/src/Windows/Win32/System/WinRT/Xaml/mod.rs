...
pub struct IDesktopWindowXamlSourceNative2Vtbl {
    pub base: IDesktopWindowXamlSourceNativeVtbl,
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_UI_WindowsAndMessaging"))]
...
#[repr(C)]
#[doc(hidden)]
pub struct ISurfaceImageSourceManagerNativeVtbl {
    pub base: ::windows::core::IUnknownVtbl,
...
pub struct ISwapChainPanelNative2Vtbl {
    pub base: ISwapChainPanelNativeVtbl,
    #[cfg(feature = "Win32_Foundation")]
...
impl IVirtualSurfaceImageSourceNative {
    ...
    pub unsafe fn GetUpdateRects(&self, updates: *mut super::super::super::Foundation::RECT, count: u32) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).GetUpdateRects)(::core::mem::transmute_copy(self), ::core::mem::transmute(updates), ::core::mem::transmute(count)).ok()
    }
    #[doc = "*Required features: 'Win32_System_WinRT_Xaml', 'Win32_Foundation'*"]
    #[cfg(feature = "Win32_Foundation")]
...
pub struct IVirtualSurfaceImageSourceNativeVtbl {
    pub base: ISurfaceImageSourceNativeVtbl,
    #[cfg(feature = "Win32_Foundation")]
...
#[repr(C)]
#[doc(hidden)]
pub struct IVirtualSurfaceUpdatesCallbackNativeVtbl {
    pub base: ::windows::core::IUnknownVtbl,
