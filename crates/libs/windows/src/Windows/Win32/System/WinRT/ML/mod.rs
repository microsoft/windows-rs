...
#[cfg(feature = "Win32_Graphics_Direct3D12")]
pub trait ILearningModelDeviceFactoryNative_Impl: Sized + windows_core::IUnknownImpl {
...
impl ILearningModelDeviceFactoryNative_Vtbl {
    pub const fn new<Identity: ILearningModelDeviceFactoryNative_Impl, const OFFSET: isize>() -> ILearningModelDeviceFactoryNative_Vtbl {
...
#[cfg(feature = "Win32_AI_MachineLearning_WinML")]
pub trait ILearningModelOperatorProviderNative_Impl: Sized + windows_core::IUnknownImpl {
...
impl ILearningModelOperatorProviderNative_Vtbl {
    pub const fn new<Identity: ILearningModelOperatorProviderNative_Impl, const OFFSET: isize>() -> ILearningModelOperatorProviderNative_Vtbl {
...
pub trait ILearningModelSessionOptionsNative_Impl: Sized + windows_core::IUnknownImpl {
...
impl ILearningModelSessionOptionsNative_Vtbl {
    pub const fn new<Identity: ILearningModelSessionOptionsNative_Impl, const OFFSET: isize>() -> ILearningModelSessionOptionsNative_Vtbl {
...
pub trait ILearningModelSessionOptionsNative1_Impl: Sized + windows_core::IUnknownImpl {
...
impl ILearningModelSessionOptionsNative1_Vtbl {
    pub const fn new<Identity: ILearningModelSessionOptionsNative1_Impl, const OFFSET: isize>() -> ILearningModelSessionOptionsNative1_Vtbl {
...
#[cfg(feature = "Win32_Graphics_Direct3D12")]
pub trait ITensorNative_Impl: Sized + windows_core::IUnknownImpl {
...
impl ITensorNative_Vtbl {
    pub const fn new<Identity: ITensorNative_Impl, const OFFSET: isize>() -> ITensorNative_Vtbl {
...
#[cfg(feature = "Win32_Graphics_Direct3D12")]
pub trait ITensorStaticsNative_Impl: Sized + windows_core::IUnknownImpl {
...
impl ITensorStaticsNative_Vtbl {
    pub const fn new<Identity: ITensorStaticsNative_Impl, const OFFSET: isize>() -> ITensorStaticsNative_Vtbl {
