...
impl IOplockBreakingHandler {
    pub unsafe fn OplockBreaking(&self) -> windows_result::Result<()> {
...
pub trait IOplockBreakingHandler_Impl: windows_core::IUnknownImpl {
    fn OplockBreaking(&self) -> windows_result::Result<()>;
}
...
impl IRandomAccessStreamFileAccessMode {
    pub unsafe fn GetMode(&self) -> windows_result::Result<u32> {
        unsafe {
...
pub trait IRandomAccessStreamFileAccessMode_Impl: windows_core::IUnknownImpl {
    fn GetMode(&self) -> windows_result::Result<u32>;
}
...
impl IStorageFolderHandleAccess {
    pub unsafe fn Create<P0, P5>(&self, filename: P0, creationoptions: HANDLE_CREATION_OPTIONS, accessoptions: HANDLE_ACCESS_OPTIONS, sharingoptions: HANDLE_SHARING_OPTIONS, options: HANDLE_OPTIONS, oplockbreakinghandler: P5) -> windows_result::Result<super::super::super::Foundation::HANDLE>
    where
...
pub trait IStorageFolderHandleAccess_Impl: windows_core::IUnknownImpl {
    fn Create(&self, filename: &windows_core::PCWSTR, creationoptions: HANDLE_CREATION_OPTIONS, accessoptions: HANDLE_ACCESS_OPTIONS, sharingoptions: HANDLE_SHARING_OPTIONS, options: HANDLE_OPTIONS, oplockbreakinghandler: windows_core::Ref<IOplockBreakingHandler>) -> windows_result::Result<super::super::super::Foundation::HANDLE>;
}
...
impl IStorageItemHandleAccess {
    pub unsafe fn Create<P3>(&self, accessoptions: HANDLE_ACCESS_OPTIONS, sharingoptions: HANDLE_SHARING_OPTIONS, options: HANDLE_OPTIONS, oplockbreakinghandler: P3) -> windows_result::Result<super::super::super::Foundation::HANDLE>
    where
...
pub trait IStorageItemHandleAccess_Impl: windows_core::IUnknownImpl {
    fn Create(&self, accessoptions: HANDLE_ACCESS_OPTIONS, sharingoptions: HANDLE_SHARING_OPTIONS, options: HANDLE_OPTIONS, oplockbreakinghandler: windows_core::Ref<IOplockBreakingHandler>) -> windows_result::Result<super::super::super::Foundation::HANDLE>;
}
...
impl IUnbufferedFileHandleOplockCallback {
    pub unsafe fn OnBrokenCallback(&self) -> windows_result::Result<()> {
...
pub trait IUnbufferedFileHandleOplockCallback_Impl: windows_core::IUnknownImpl {
    fn OnBrokenCallback(&self) -> windows_result::Result<()>;
}
...
impl IUnbufferedFileHandleProvider {
    pub unsafe fn OpenUnbufferedFileHandle<P0>(&self, oplockbreakcallback: P0) -> windows_result::Result<usize>
    where
    ...
    pub unsafe fn CloseUnbufferedFileHandle(&self) -> windows_result::Result<()> {
...
pub trait IUnbufferedFileHandleProvider_Impl: windows_core::IUnknownImpl {
    fn OpenUnbufferedFileHandle(&self, oplockbreakcallback: windows_core::Ref<IUnbufferedFileHandleOplockCallback>) -> windows_result::Result<usize>;
    fn CloseUnbufferedFileHandle(&self) -> windows_result::Result<()>;
}
