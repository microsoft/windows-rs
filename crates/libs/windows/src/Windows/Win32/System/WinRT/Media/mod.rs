...
impl IAudioFrameNative {
    pub unsafe fn GetData<T>(&self) -> Result<T, windows_result::HRESULT>
    where
...
pub trait IAudioFrameNative_Impl: windows_core::IUnknownImpl {
    fn GetData(&self, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
}
...
impl IAudioFrameNativeFactory {
    ...
    pub unsafe fn CreateFromMFSample<P0, T>(&self, data: P0, forcereadonly: bool) -> Result<T, windows_result::HRESULT>
    where
...
pub trait IAudioFrameNativeFactory_Impl: windows_core::IUnknownImpl {
    fn CreateFromMFSample(&self, data: windows_core::Ref<'_, super::super::super::Media::MediaFoundation::IMFSample>, forcereadonly: windows_core::BOOL, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Media_MediaFoundation")]
...
impl IVideoFrameNative {
    ...
    pub unsafe fn GetDevice<T>(&self) -> Result<T, windows_result::HRESULT>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
...
pub trait IVideoFrameNative_Impl: windows_core::IUnknownImpl {
    fn GetData(&self, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn GetDevice(&self, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
}
...
impl IVideoFrameNativeFactory {
    #[cfg(feature = "Win32_Media_MediaFoundation")]
    pub unsafe fn CreateFromMFSample<P0, P6, T>(&self, data: P0, subtype: *const windows_core::GUID, width: u32, height: u32, forcereadonly: bool, mindisplayaperture: Option<*const super::super::super::Media::MediaFoundation::MFVideoArea>, device: P6) -> Result<T, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Media::MediaFoundation::IMFSample>,
