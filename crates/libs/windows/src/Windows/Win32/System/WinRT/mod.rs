...
pub unsafe fn RoRegisterActivationFactories(activatableclassids: &[::windows::core::HSTRING], activationfactorycallbacks: &[isize]) -> ::windows::core::Result<isize> {
    #[cfg(windows)]
    {
        ...
        RoRegisterActivationFactories(::core::mem::transmute(activatableclassids.as_ptr()), ::core::mem::transmute(activationfactorycallbacks.as_ptr()), activationfactorycallbacks.len() as _, ::core::mem::transmute(&mut result__)).from_abi::<isize>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn WindowsCreateString(sourcestring: &[u16]) -> ::windows::core::Result<::windows::core::HSTRING> {
    #[cfg(windows)]
    {
        ...
        let mut result__: ::core::mem::ManuallyDrop<::windows::core::HSTRING> = ::core::mem::zeroed();
        WindowsCreateString(::core::mem::transmute(sourcestring.as_ptr()), sourcestring.len() as _, ::core::mem::transmute(&mut result__)).from_abi::<::windows::core::HSTRING>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
