    ...
    P0: windows_core::Param<super::super::super::Graphics::Dxgi::IDXGIDevice>,
{
    ...
    unsafe {
        ...
        CreateDirect3D11DeviceFromDXGIDevice(core::mem::transmute_copy(&dxgidevice.param().borrow()), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[cfg(feature = "Win32_Graphics_Dxgi")]
#[inline]
    ...
    P0: windows_core::Param<super::super::super::Graphics::Dxgi::IDXGISurface>,
{
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        CreateDirect3D11SurfaceFromDXGISurface(core::mem::transmute_copy(&dgxisurface.param().borrow()), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    }
}
