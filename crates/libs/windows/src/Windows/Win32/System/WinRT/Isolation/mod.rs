...
impl IIsolatedEnvironmentInterop {
    pub unsafe fn GetHostHwndInterop(&self, containerhwnd: super::super::super::Foundation::HWND) -> windows_result::Result<super::super::super::Foundation::HWND> {
        unsafe {
...
pub trait IIsolatedEnvironmentInterop_Impl: windows_core::IUnknownImpl {
    fn GetHostHwndInterop(&self, containerhwnd: super::super::super::Foundation::HWND) -> windows_result::Result<super::super::super::Foundation::HWND>;
}
