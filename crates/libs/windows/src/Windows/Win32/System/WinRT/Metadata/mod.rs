...
#[inline]
pub unsafe fn RoGetMetaDataFile<P1>(name: &windows_core::HSTRING, metadatadispenser: P1, metadatafilepath: Option<*mut windows_core::HSTRING>, metadataimport: Option<*mut Option<IMetaDataImport2>>, typedeftoken: Option<*mut u32>) -> windows_core::HRESULT
where
    P1: windows_core::Param<IMetaDataDispenserEx>,
{
    ...
    unsafe { RoGetMetaDataFile(core::mem::transmute_copy(name), metadatadispenser.param().abi(), metadatafilepath.unwrap_or(core::mem::zeroed()) as _, metadataimport.unwrap_or(core::mem::zeroed()) as _, typedeftoken.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn RoGetParameterizedTypeInstanceIID<P2>(nameelements: &[windows_core::PCWSTR], metadatalocator: P2, iid: *mut windows_core::GUID, pextra: Option<*mut ROPARAMIIDHANDLE>) -> windows_core::HRESULT
where
    P2: windows_core::Param<IRoMetaDataLocator>,
{
    ...
    unsafe { RoGetParameterizedTypeInstanceIID(nameelements.len().try_into().unwrap(), core::mem::transmute(nameelements.as_ptr()), metadatalocator.param().abi(), iid as _, pextra.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn RoParseTypeName(typename: &windows_core::HSTRING, partscount: *mut u32, typenameparts: *mut *mut windows_core::HSTRING) -> windows_core::HRESULT {
    ...
    unsafe { RoParseTypeName(core::mem::transmute_copy(typename), partscount as _, typenameparts as _) }
}
#[inline]
pub unsafe fn RoResolveNamespace(name: &windows_core::HSTRING, windowsmetadatadir: &windows_core::HSTRING, packagegraphdirs: Option<&[windows_core::HSTRING]>, metadatafilepathscount: Option<*mut u32>, metadatafilepaths: Option<*mut *mut windows_core::HSTRING>, subnamespacescount: Option<*mut u32>, subnamespaces: Option<*mut *mut windows_core::HSTRING>) -> windows_core::HRESULT {
...
pub const COINITCOR_DEFAULT: COINITICOR = COINITICOR(0);
pub const COINITEE_DEFAULT: COINITIEE = COINITIEE(0);
pub const COINITEE_DLL: COINITIEE = COINITIEE(1);
pub const COINITEE_MAIN: COINITIEE = COINITIEE(2);
#[repr(transparent)]
...
pub const COR_E_ARGUMENT: i32 = -2147024809;
...
pub const COR_E_INVALIDCAST: i32 = -2147467262;
pub const COR_E_NULLREFERENCE: i32 = -2147467261;
pub const COR_E_OUTOFMEMORY: i32 = -2147024882;
pub const COR_E_TARGETPARAMCOUNT: windows_core::HRESULT = windows_core::HRESULT(0x8002000E_u32 as _);
pub const COR_E_UNAUTHORIZEDACCESS: i32 = -2147024891;
#[repr(C)]
...
pub const COR_ILEXCEPTION_CLAUSE_DEPRECATED: CorExceptionFlag = CorExceptionFlag(0);
pub const COR_ILEXCEPTION_CLAUSE_DUPLICATED: CorExceptionFlag = CorExceptionFlag(8);
pub const COR_ILEXCEPTION_CLAUSE_FAULT: CorExceptionFlag = CorExceptionFlag(4);
pub const COR_ILEXCEPTION_CLAUSE_FILTER: CorExceptionFlag = CorExceptionFlag(1);
pub const COR_ILEXCEPTION_CLAUSE_FINALLY: CorExceptionFlag = CorExceptionFlag(2);
pub const COR_ILEXCEPTION_CLAUSE_NONE: CorExceptionFlag = CorExceptionFlag(0);
pub const COR_ILEXCEPTION_CLAUSE_OFFSETLEN: CorExceptionFlag = CorExceptionFlag(0);
#[repr(C, packed(1))]
...
pub const COR_NATIVE_LINK_CUSTOM_VALUE_CC: u32 = 18;
...
pub const COUNINITEE_DEFAULT: COUNINITIEE = COUNINITIEE(0);
pub const COUNINITEE_DLL: COUNINITIEE = COUNINITIEE(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CompilationRelaxations_NoStringInterning: CompilationRelaxationsEnum = CompilationRelaxationsEnum(8);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CorILMethod_CompressedIL: CorILMethodFlags = CorILMethodFlags(64);
pub const CorILMethod_FatFormat: CorILMethodFlags = CorILMethodFlags(3);
pub const CorILMethod_FormatMask: CorILMethodFlags = CorILMethodFlags(7);
pub const CorILMethod_FormatShift: CorILMethodFlags = CorILMethodFlags(3);
pub const CorILMethod_InitLocals: CorILMethodFlags = CorILMethodFlags(16);
pub const CorILMethod_MoreSects: CorILMethodFlags = CorILMethodFlags(8);
pub const CorILMethod_Sect_EHTable: CorILMethodSect = CorILMethodSect(1);
pub const CorILMethod_Sect_FatFormat: CorILMethodSect = CorILMethodSect(64);
pub const CorILMethod_Sect_KindMask: CorILMethodSect = CorILMethodSect(63);
pub const CorILMethod_Sect_MoreSects: CorILMethodSect = CorILMethodSect(128);
pub const CorILMethod_Sect_OptILTable: CorILMethodSect = CorILMethodSect(2);
pub const CorILMethod_Sect_Reserved: CorILMethodSect = CorILMethodSect(0);
pub const CorILMethod_SmallFormat: CorILMethodFlags = CorILMethodFlags(0);
pub const CorILMethod_TinyFormat: CorILMethodFlags = CorILMethodFlags(2);
pub const CorILMethod_TinyFormat1: CorILMethodFlags = CorILMethodFlags(6);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const DESCR_GROUP_METHODDEF: i32 = 0;
pub const DESCR_GROUP_METHODIMPL: i32 = 1;
...
pub const DropMemberRefCAs: MergeFlags = MergeFlags(2);
pub const ELEMENT_TYPE_ARRAY: CorElementType = CorElementType(20);
pub const ELEMENT_TYPE_BOOLEAN: CorElementType = CorElementType(2);
pub const ELEMENT_TYPE_BYREF: CorElementType = CorElementType(16);
pub const ELEMENT_TYPE_CHAR: CorElementType = CorElementType(3);
pub const ELEMENT_TYPE_CLASS: CorElementType = CorElementType(18);
pub const ELEMENT_TYPE_CMOD_OPT: CorElementType = CorElementType(32);
pub const ELEMENT_TYPE_CMOD_REQD: CorElementType = CorElementType(31);
pub const ELEMENT_TYPE_END: CorElementType = CorElementType(0);
pub const ELEMENT_TYPE_FNPTR: CorElementType = CorElementType(27);
pub const ELEMENT_TYPE_GENERICINST: CorElementType = CorElementType(21);
pub const ELEMENT_TYPE_I: CorElementType = CorElementType(24);
pub const ELEMENT_TYPE_I1: CorElementType = CorElementType(4);
pub const ELEMENT_TYPE_I2: CorElementType = CorElementType(6);
pub const ELEMENT_TYPE_I4: CorElementType = CorElementType(8);
pub const ELEMENT_TYPE_I8: CorElementType = CorElementType(10);
pub const ELEMENT_TYPE_INTERNAL: CorElementType = CorElementType(33);
pub const ELEMENT_TYPE_MAX: CorElementType = CorElementType(34);
pub const ELEMENT_TYPE_MODIFIER: CorElementType = CorElementType(64);
pub const ELEMENT_TYPE_MVAR: CorElementType = CorElementType(30);
pub const ELEMENT_TYPE_OBJECT: CorElementType = CorElementType(28);
pub const ELEMENT_TYPE_PINNED: CorElementType = CorElementType(69);
pub const ELEMENT_TYPE_PTR: CorElementType = CorElementType(15);
pub const ELEMENT_TYPE_R4: CorElementType = CorElementType(12);
pub const ELEMENT_TYPE_R8: CorElementType = CorElementType(13);
pub const ELEMENT_TYPE_SENTINEL: CorElementType = CorElementType(65);
pub const ELEMENT_TYPE_STRING: CorElementType = CorElementType(14);
pub const ELEMENT_TYPE_SZARRAY: CorElementType = CorElementType(29);
pub const ELEMENT_TYPE_TYPEDBYREF: CorElementType = CorElementType(22);
pub const ELEMENT_TYPE_U: CorElementType = CorElementType(25);
pub const ELEMENT_TYPE_U1: CorElementType = CorElementType(5);
pub const ELEMENT_TYPE_U2: CorElementType = CorElementType(7);
pub const ELEMENT_TYPE_U4: CorElementType = CorElementType(9);
pub const ELEMENT_TYPE_U8: CorElementType = CorElementType(11);
pub const ELEMENT_TYPE_VALUETYPE: CorElementType = CorElementType(17);
pub const ELEMENT_TYPE_VAR: CorElementType = CorElementType(19);
pub const ELEMENT_TYPE_VOID: CorElementType = CorElementType(1);
...
impl ICeeGen {
    pub unsafe fn EmitString<P0>(&self, lpstring: P0, rva: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).EmitString)(windows_core::Interface::as_raw(self), lpstring.param().abi(), rva as _) }
    }
    pub unsafe fn GetString(&self, rva: u32, lpstring: Option<*mut windows_core::PWSTR>) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetString)(windows_core::Interface::as_raw(self), rva, lpstring.unwrap_or(core::mem::zeroed()) as _) }
    }
    pub unsafe fn AllocateMethodBuffer(&self, cchbuffer: u32, lpbuffer: *mut *mut u8, rva: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).AllocateMethodBuffer)(windows_core::Interface::as_raw(self), cchbuffer, lpbuffer as _, rva as _) }
    }
    pub unsafe fn GetMethodBuffer(&self, rva: u32, lpbuffer: *mut *mut u8) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetMethodBuffer)(windows_core::Interface::as_raw(self), rva, lpbuffer as _) }
    }
    ...
    pub unsafe fn GenerateCeeFile(&self) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GenerateCeeFile)(windows_core::Interface::as_raw(self)) }
    }
    pub unsafe fn GetIlSection(&self, section: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetIlSection)(windows_core::Interface::as_raw(self), section as _) }
    }
    pub unsafe fn GetStringSection(&self, section: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetStringSection)(windows_core::Interface::as_raw(self), section as _) }
    }
    pub unsafe fn AddSectionReloc(&self, section: *mut core::ffi::c_void, offset: u32, relativeto: *mut core::ffi::c_void, reloctype: CeeSectionRelocType) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).AddSectionReloc)(windows_core::Interface::as_raw(self), section as _, offset, relativeto as _, reloctype) }
    }
    pub unsafe fn GetSectionCreate<P0>(&self, name: P0, flags: u32, section: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).GetSectionCreate)(windows_core::Interface::as_raw(self), name.param().abi(), flags, section as _) }
    }
    pub unsafe fn GetSectionDataLen(&self, section: *mut core::ffi::c_void, datalen: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetSectionDataLen)(windows_core::Interface::as_raw(self), section as _, datalen as _) }
    }
    pub unsafe fn GetSectionBlock(&self, section: *mut core::ffi::c_void, len: u32, align: u32, ppbytes: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetSectionBlock)(windows_core::Interface::as_raw(self), section as _, len, align, ppbytes as _) }
    }
    pub unsafe fn TruncateSection(&self, section: *mut core::ffi::c_void, len: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).TruncateSection)(windows_core::Interface::as_raw(self), section as _, len) }
    }
    pub unsafe fn GenerateCeeMemoryImage(&self, ppimage: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GenerateCeeMemoryImage)(windows_core::Interface::as_raw(self), ppimage as _) }
    }
    pub unsafe fn ComputePointer(&self, section: *mut core::ffi::c_void, rva: u32, lpbuffer: *mut *mut u8) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).ComputePointer)(windows_core::Interface::as_raw(self), section as _, rva, lpbuffer as _) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IHostFilter {
    pub unsafe fn MarkToken(&self, tk: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).MarkToken)(windows_core::Interface::as_raw(self), tk) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
pub const IMAGE_CEE_CS_BYVALUE: CorArgType = CorArgType(10);
pub const IMAGE_CEE_CS_CALLCONV_C: CorUnmanagedCallingConvention = CorUnmanagedCallingConvention(1);
pub const IMAGE_CEE_CS_CALLCONV_DEFAULT: CorCallingConvention = CorCallingConvention(0);
pub const IMAGE_CEE_CS_CALLCONV_EXPLICITTHIS: CorCallingConvention = CorCallingConvention(64);
pub const IMAGE_CEE_CS_CALLCONV_FASTCALL: CorUnmanagedCallingConvention = CorUnmanagedCallingConvention(4);
pub const IMAGE_CEE_CS_CALLCONV_FIELD: CorCallingConvention = CorCallingConvention(6);
pub const IMAGE_CEE_CS_CALLCONV_GENERIC: CorCallingConvention = CorCallingConvention(16);
pub const IMAGE_CEE_CS_CALLCONV_GENERICINST: CorCallingConvention = CorCallingConvention(10);
pub const IMAGE_CEE_CS_CALLCONV_HASTHIS: CorCallingConvention = CorCallingConvention(32);
pub const IMAGE_CEE_CS_CALLCONV_LOCAL_SIG: CorCallingConvention = CorCallingConvention(7);
pub const IMAGE_CEE_CS_CALLCONV_MASK: CorCallingConvention = CorCallingConvention(15);
pub const IMAGE_CEE_CS_CALLCONV_MAX: CorCallingConvention = CorCallingConvention(12);
pub const IMAGE_CEE_CS_CALLCONV_NATIVEVARARG: CorCallingConvention = CorCallingConvention(11);
pub const IMAGE_CEE_CS_CALLCONV_PROPERTY: CorCallingConvention = CorCallingConvention(8);
pub const IMAGE_CEE_CS_CALLCONV_STDCALL: CorUnmanagedCallingConvention = CorUnmanagedCallingConvention(2);
pub const IMAGE_CEE_CS_CALLCONV_THISCALL: CorUnmanagedCallingConvention = CorUnmanagedCallingConvention(3);
pub const IMAGE_CEE_CS_CALLCONV_UNMGD: CorCallingConvention = CorCallingConvention(9);
pub const IMAGE_CEE_CS_CALLCONV_VARARG: CorCallingConvention = CorCallingConvention(5);
pub const IMAGE_CEE_CS_END: CorArgType = CorArgType(0);
pub const IMAGE_CEE_CS_I4: CorArgType = CorArgType(2);
pub const IMAGE_CEE_CS_I8: CorArgType = CorArgType(3);
pub const IMAGE_CEE_CS_OBJECT: CorArgType = CorArgType(7);
pub const IMAGE_CEE_CS_PTR: CorArgType = CorArgType(6);
pub const IMAGE_CEE_CS_R4: CorArgType = CorArgType(4);
pub const IMAGE_CEE_CS_R8: CorArgType = CorArgType(5);
pub const IMAGE_CEE_CS_STRUCT32: CorArgType = CorArgType(9);
pub const IMAGE_CEE_CS_STRUCT4: CorArgType = CorArgType(8);
pub const IMAGE_CEE_CS_VOID: CorArgType = CorArgType(1);
pub const IMAGE_CEE_UNMANAGED_CALLCONV_C: CorUnmanagedCallingConvention = CorUnmanagedCallingConvention(1);
pub const IMAGE_CEE_UNMANAGED_CALLCONV_FASTCALL: CorUnmanagedCallingConvention = CorUnmanagedCallingConvention(4);
pub const IMAGE_CEE_UNMANAGED_CALLCONV_STDCALL: CorUnmanagedCallingConvention = CorUnmanagedCallingConvention(2);
pub const IMAGE_CEE_UNMANAGED_CALLCONV_THISCALL: CorUnmanagedCallingConvention = CorUnmanagedCallingConvention(3);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const IMAGE_DIRECTORY_ENTRY_COMHEADER: ReplacesGeneralNumericDefines = ReplacesGeneralNumericDefines(14);
...
impl IMapToken {
    pub unsafe fn Map(&self, tkimp: u32, tkemit: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).Map)(windows_core::Interface::as_raw(self), tkimp, tkemit) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IMetaDataAssemblyEmit {
    pub unsafe fn DefineAssembly<P3>(&self, pbpublickey: *const core::ffi::c_void, cbpublickey: u32, ulhashalgid: u32, szname: P3, pmetadata: *const ASSEMBLYMETADATA, dwassemblyflags: u32, pma: *mut u32) -> windows_core::HRESULT
    where
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineAssembly)(windows_core::Interface::as_raw(self), pbpublickey, cbpublickey, ulhashalgid, szname.param().abi(), pmetadata, dwassemblyflags, pma as _) }
    }
    pub unsafe fn DefineAssemblyRef<P2>(&self, pbpublickeyortoken: *const core::ffi::c_void, cbpublickeyortoken: u32, szname: P2, pmetadata: *const ASSEMBLYMETADATA, pbhashvalue: *const core::ffi::c_void, cbhashvalue: u32, dwassemblyrefflags: u32, pmdar: *mut u32) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineAssemblyRef)(windows_core::Interface::as_raw(self), pbpublickeyortoken, cbpublickeyortoken, szname.param().abi(), pmetadata, pbhashvalue, cbhashvalue, dwassemblyrefflags, pmdar as _) }
    }
    pub unsafe fn DefineFile<P0>(&self, szname: P0, pbhashvalue: *const core::ffi::c_void, cbhashvalue: u32, dwfileflags: u32, pmdf: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineFile)(windows_core::Interface::as_raw(self), szname.param().abi(), pbhashvalue, cbhashvalue, dwfileflags, pmdf as _) }
    }
    pub unsafe fn DefineExportedType<P0>(&self, szname: P0, tkimplementation: u32, tktypedef: u32, dwexportedtypeflags: u32, pmdct: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineExportedType)(windows_core::Interface::as_raw(self), szname.param().abi(), tkimplementation, tktypedef, dwexportedtypeflags, pmdct as _) }
    }
    pub unsafe fn DefineManifestResource<P0>(&self, szname: P0, tkimplementation: u32, dwoffset: u32, dwresourceflags: u32, pmdmr: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineManifestResource)(windows_core::Interface::as_raw(self), szname.param().abi(), tkimplementation, dwoffset, dwresourceflags, pmdmr as _) }
    }
    pub unsafe fn SetAssemblyProps<P4>(&self, pma: u32, pbpublickey: *const core::ffi::c_void, cbpublickey: u32, ulhashalgid: u32, szname: P4, pmetadata: *const ASSEMBLYMETADATA, dwassemblyflags: u32) -> windows_core::HRESULT
    where
        P4: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetAssemblyProps)(windows_core::Interface::as_raw(self), pma, pbpublickey, cbpublickey, ulhashalgid, szname.param().abi(), pmetadata, dwassemblyflags) }
    }
    pub unsafe fn SetAssemblyRefProps<P3>(&self, ar: u32, pbpublickeyortoken: *const core::ffi::c_void, cbpublickeyortoken: u32, szname: P3, pmetadata: *const ASSEMBLYMETADATA, pbhashvalue: *const core::ffi::c_void, cbhashvalue: u32, dwassemblyrefflags: u32) -> windows_core::HRESULT
    where
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetAssemblyRefProps)(windows_core::Interface::as_raw(self), ar, pbpublickeyortoken, cbpublickeyortoken, szname.param().abi(), pmetadata, pbhashvalue, cbhashvalue, dwassemblyrefflags) }
    }
    pub unsafe fn SetFileProps(&self, file: u32, pbhashvalue: *const core::ffi::c_void, cbhashvalue: u32, dwfileflags: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetFileProps)(windows_core::Interface::as_raw(self), file, pbhashvalue, cbhashvalue, dwfileflags) }
    }
    pub unsafe fn SetExportedTypeProps(&self, ct: u32, tkimplementation: u32, tktypedef: u32, dwexportedtypeflags: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetExportedTypeProps)(windows_core::Interface::as_raw(self), ct, tkimplementation, tktypedef, dwexportedtypeflags) }
    }
    pub unsafe fn SetManifestResourceProps(&self, mr: u32, tkimplementation: u32, dwoffset: u32, dwresourceflags: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetManifestResourceProps)(windows_core::Interface::as_raw(self), mr, tkimplementation, dwoffset, dwresourceflags) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IMetaDataAssemblyImport {
    pub unsafe fn GetAssemblyProps(&self, mda: u32, ppbpublickey: *const *const core::ffi::c_void, pcbpublickey: *mut u32, pulhashalgid: *mut u32, szname: Option<&mut [u16]>, pchname: *mut u32, pmetadata: *mut ASSEMBLYMETADATA, pdwassemblyflags: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetAssemblyProps)(windows_core::Interface::as_raw(self), mda, ppbpublickey, pcbpublickey as _, pulhashalgid as _, core::mem::transmute(szname.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), szname.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pchname as _, pmetadata as _, pdwassemblyflags as _) }
    }
    ...
    pub unsafe fn GetFileProps(&self, mdf: u32, szname: Option<&mut [u16]>, pchname: *mut u32, ppbhashvalue: *const *const core::ffi::c_void, pcbhashvalue: *mut u32, pdwfileflags: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetFileProps)(windows_core::Interface::as_raw(self), mdf, core::mem::transmute(szname.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), szname.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pchname as _, ppbhashvalue, pcbhashvalue as _, pdwfileflags as _) }
    }
    pub unsafe fn GetExportedTypeProps(&self, mdct: u32, szname: Option<&mut [u16]>, pchname: *mut u32, ptkimplementation: *mut u32, ptktypedef: *mut u32, pdwexportedtypeflags: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetExportedTypeProps)(windows_core::Interface::as_raw(self), mdct, core::mem::transmute(szname.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), szname.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pchname as _, ptkimplementation as _, ptktypedef as _, pdwexportedtypeflags as _) }
    }
    pub unsafe fn GetManifestResourceProps(&self, mdmr: u32, szname: Option<&mut [u16]>, pchname: *mut u32, ptkimplementation: *mut u32, pdwoffset: *mut u32, pdwresourceflags: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetManifestResourceProps)(windows_core::Interface::as_raw(self), mdmr, core::mem::transmute(szname.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), szname.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pchname as _, ptkimplementation as _, pdwoffset as _, pdwresourceflags as _) }
    }
    pub unsafe fn EnumAssemblyRefs(&self, phenum: *mut *mut core::ffi::c_void, rassemblyrefs: *mut u32, cmax: u32, pctokens: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumAssemblyRefs)(windows_core::Interface::as_raw(self), phenum as _, rassemblyrefs as _, cmax, pctokens as _) }
    }
    pub unsafe fn EnumFiles(&self, phenum: *mut *mut core::ffi::c_void, rfiles: *mut u32, cmax: u32, pctokens: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumFiles)(windows_core::Interface::as_raw(self), phenum as _, rfiles as _, cmax, pctokens as _) }
    }
    pub unsafe fn EnumExportedTypes(&self, phenum: *mut *mut core::ffi::c_void, rexportedtypes: *mut u32, cmax: u32, pctokens: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumExportedTypes)(windows_core::Interface::as_raw(self), phenum as _, rexportedtypes as _, cmax, pctokens as _) }
    }
    pub unsafe fn EnumManifestResources(&self, phenum: *mut *mut core::ffi::c_void, rmanifestresources: *mut u32, cmax: u32, pctokens: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumManifestResources)(windows_core::Interface::as_raw(self), phenum as _, rmanifestresources as _, cmax, pctokens as _) }
    }
    pub unsafe fn GetAssemblyFromScope(&self, ptkassembly: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetAssemblyFromScope)(windows_core::Interface::as_raw(self), ptkassembly as _) }
    }
    pub unsafe fn FindExportedTypeByName<P0>(&self, szname: P0, mdtexportedtype: u32, ptkexportedtype: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).FindExportedTypeByName)(windows_core::Interface::as_raw(self), szname.param().abi(), mdtexportedtype, ptkexportedtype as _) }
    }
    pub unsafe fn FindManifestResourceByName<P0>(&self, szname: P0, ptkmanifestresource: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).FindManifestResourceByName)(windows_core::Interface::as_raw(self), szname.param().abi(), ptkmanifestresource as _) }
    }
    ...
    pub unsafe fn FindAssembliesByName<P0, P1, P2>(&self, szappbase: P0, szprivatebin: P1, szassemblyname: P2, ppiunk: *mut Option<windows_core::IUnknown>, cmax: u32, pcassemblies: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).FindAssembliesByName)(windows_core::Interface::as_raw(self), szappbase.param().abi(), szprivatebin.param().abi(), szassemblyname.param().abi(), core::mem::transmute(ppiunk), cmax, pcassemblies as _) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IMetaDataDispenserEx {
    ...
    pub unsafe fn SetOption(&self, optionid: *const windows_core::GUID, value: *const super::super::Variant::VARIANT) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetOption)(windows_core::Interface::as_raw(self), optionid, core::mem::transmute(value)) }
    }
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetOption(&self, optionid: *const windows_core::GUID, pvalue: *mut super::super::Variant::VARIANT) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetOption)(windows_core::Interface::as_raw(self), optionid, core::mem::transmute(pvalue)) }
    }
    ...
    pub unsafe fn GetCORSystemDirectory(&self, szbuffer: Option<&mut [u16]>, pchbuffer: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetCORSystemDirectory)(windows_core::Interface::as_raw(self), core::mem::transmute(szbuffer.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), szbuffer.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pchbuffer as _) }
    }
    pub unsafe fn FindAssembly<P0, P1, P2, P3, P4>(&self, szappbase: P0, szprivatebin: P1, szglobalbin: P2, szassemblyname: P3, szname: P4, cchname: u32, pcname: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
        ...
        P4: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).FindAssembly)(windows_core::Interface::as_raw(self), szappbase.param().abi(), szprivatebin.param().abi(), szglobalbin.param().abi(), szassemblyname.param().abi(), szname.param().abi(), cchname, pcname as _) }
    }
    pub unsafe fn FindAssemblyModule<P0, P1, P2, P3, P4>(&self, szappbase: P0, szprivatebin: P1, szglobalbin: P2, szassemblyname: P3, szmodulename: P4, szname: Option<&mut [u16]>, pcname: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
...
impl IMetaDataEmit {
    pub unsafe fn SetModuleProps<P0>(&self, szname: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetModuleProps)(windows_core::Interface::as_raw(self), szname.param().abi()) }
    }
    pub unsafe fn Save<P0>(&self, szfile: P0, dwsaveflags: u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).Save)(windows_core::Interface::as_raw(self), szfile.param().abi(), dwsaveflags) }
    }
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn SaveToStream<P0>(&self, pistream: P0, dwsaveflags: u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::super::Com::IStream>,
    {
        unsafe { (windows_core::Interface::vtable(self).SaveToStream)(windows_core::Interface::as_raw(self), pistream.param().abi(), dwsaveflags) }
    }
    pub unsafe fn GetSaveSize(&self, fsave: CorSaveSize, pdwsavesize: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetSaveSize)(windows_core::Interface::as_raw(self), fsave, pdwsavesize as _) }
    }
    pub unsafe fn DefineTypeDef<P0>(&self, sztypedef: P0, dwtypedefflags: u32, tkextends: u32, rtkimplements: *mut u32, ptd: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineTypeDef)(windows_core::Interface::as_raw(self), sztypedef.param().abi(), dwtypedefflags, tkextends, rtkimplements as _, ptd as _) }
    }
    pub unsafe fn DefineNestedType<P0>(&self, sztypedef: P0, dwtypedefflags: u32, tkextends: u32, rtkimplements: *mut u32, tdencloser: u32, ptd: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineNestedType)(windows_core::Interface::as_raw(self), sztypedef.param().abi(), dwtypedefflags, tkextends, rtkimplements as _, tdencloser, ptd as _) }
    }
    pub unsafe fn SetHandler<P0>(&self, punk: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetHandler)(windows_core::Interface::as_raw(self), punk.param().abi()) }
    }
    pub unsafe fn DefineMethod<P1>(&self, td: u32, szname: P1, dwmethodflags: u32, pvsigblob: *mut u8, cbsigblob: u32, ulcoderva: u32, dwimplflags: u32, pmd: *mut u32) -> windows_core::HRESULT
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineMethod)(windows_core::Interface::as_raw(self), td, szname.param().abi(), dwmethodflags, pvsigblob as _, cbsigblob, ulcoderva, dwimplflags, pmd as _) }
    }
    pub unsafe fn DefineMethodImpl(&self, td: u32, tkbody: u32, tkdecl: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).DefineMethodImpl)(windows_core::Interface::as_raw(self), td, tkbody, tkdecl) }
    }
    pub unsafe fn DefineTypeRefByName<P1>(&self, tkresolutionscope: u32, szname: P1, ptr: *mut u32) -> windows_core::HRESULT
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineTypeRefByName)(windows_core::Interface::as_raw(self), tkresolutionscope, szname.param().abi(), ptr as _) }
    }
    pub unsafe fn DefineImportType<P0, P3, P5>(&self, passemimport: P0, pbhashvalue: *const core::ffi::c_void, cbhashvalue: u32, pimport: P3, tdimport: u32, passememit: P5, ptr: *mut u32) -> windows_core::HRESULT
    where
    ...
    {
        unsafe { (windows_core::Interface::vtable(self).DefineImportType)(windows_core::Interface::as_raw(self), passemimport.param().abi(), pbhashvalue, cbhashvalue, pimport.param().abi(), tdimport, passememit.param().abi(), ptr as _) }
    }
    pub unsafe fn DefineMemberRef<P1>(&self, tkimport: u32, szname: P1, pvsigblob: *mut u8, cbsigblob: u32, pmr: *mut u32) -> windows_core::HRESULT
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineMemberRef)(windows_core::Interface::as_raw(self), tkimport, szname.param().abi(), pvsigblob as _, cbsigblob, pmr as _) }
    }
    pub unsafe fn DefineImportMember<P0, P3, P5>(&self, passemimport: P0, pbhashvalue: *const core::ffi::c_void, cbhashvalue: u32, pimport: P3, mbmember: u32, passememit: P5, tkparent: u32, pmr: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IMetaDataAssemblyImport>,
        P3: windows_core::Param<IMetaDataImport>,
        P5: windows_core::Param<IMetaDataAssemblyEmit>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineImportMember)(windows_core::Interface::as_raw(self), passemimport.param().abi(), pbhashvalue, cbhashvalue, pimport.param().abi(), mbmember, passememit.param().abi(), tkparent, pmr as _) }
    }
    pub unsafe fn DefineEvent<P1>(&self, td: u32, szevent: P1, dweventflags: u32, tkeventtype: u32, mdaddon: u32, mdremoveon: u32, mdfire: u32, rmdothermethods: *mut u32, pmdevent: *mut u32) -> windows_core::HRESULT
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineEvent)(windows_core::Interface::as_raw(self), td, szevent.param().abi(), dweventflags, tkeventtype, mdaddon, mdremoveon, mdfire, rmdothermethods as _, pmdevent as _) }
    }
    pub unsafe fn SetClassLayout(&self, td: u32, dwpacksize: u32, rfieldoffsets: *mut COR_FIELD_OFFSET, ulclasssize: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetClassLayout)(windows_core::Interface::as_raw(self), td, dwpacksize, rfieldoffsets as _, ulclasssize) }
    }
    pub unsafe fn DeleteClassLayout(&self, td: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).DeleteClassLayout)(windows_core::Interface::as_raw(self), td) }
    }
    pub unsafe fn SetFieldMarshal(&self, tk: u32, pvnativetype: *mut u8, cbnativetype: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetFieldMarshal)(windows_core::Interface::as_raw(self), tk, pvnativetype as _, cbnativetype) }
    }
    pub unsafe fn DeleteFieldMarshal(&self, tk: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).DeleteFieldMarshal)(windows_core::Interface::as_raw(self), tk) }
    }
    pub unsafe fn DefinePermissionSet(&self, tk: u32, dwaction: u32, pvpermission: *const core::ffi::c_void, cbpermission: u32, ppm: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).DefinePermissionSet)(windows_core::Interface::as_raw(self), tk, dwaction, pvpermission, cbpermission, ppm as _) }
    }
    pub unsafe fn SetRVA(&self, md: u32, ulrva: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetRVA)(windows_core::Interface::as_raw(self), md, ulrva) }
    }
    pub unsafe fn GetTokenFromSig(&self, pvsig: *mut u8, cbsig: u32, pmsig: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetTokenFromSig)(windows_core::Interface::as_raw(self), pvsig as _, cbsig, pmsig as _) }
    }
    pub unsafe fn DefineModuleRef<P0>(&self, szname: P0, pmur: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineModuleRef)(windows_core::Interface::as_raw(self), szname.param().abi(), pmur as _) }
    }
    pub unsafe fn SetParent(&self, mr: u32, tk: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetParent)(windows_core::Interface::as_raw(self), mr, tk) }
    }
    pub unsafe fn GetTokenFromTypeSpec(&self, pvsig: *mut u8, cbsig: u32, ptypespec: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetTokenFromTypeSpec)(windows_core::Interface::as_raw(self), pvsig as _, cbsig, ptypespec as _) }
    }
    pub unsafe fn SaveToMemory(&self, pbdata: *mut core::ffi::c_void, cbdata: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SaveToMemory)(windows_core::Interface::as_raw(self), pbdata as _, cbdata) }
    }
    pub unsafe fn DefineUserString<P0>(&self, szstring: P0, cchstring: u32, pstk: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineUserString)(windows_core::Interface::as_raw(self), szstring.param().abi(), cchstring, pstk as _) }
    }
    pub unsafe fn DeleteToken(&self, tkobj: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).DeleteToken)(windows_core::Interface::as_raw(self), tkobj) }
    }
    pub unsafe fn SetMethodProps(&self, md: u32, dwmethodflags: u32, ulcoderva: u32, dwimplflags: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetMethodProps)(windows_core::Interface::as_raw(self), md, dwmethodflags, ulcoderva, dwimplflags) }
    }
    pub unsafe fn SetTypeDefProps(&self, td: u32, dwtypedefflags: u32, tkextends: u32, rtkimplements: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetTypeDefProps)(windows_core::Interface::as_raw(self), td, dwtypedefflags, tkextends, rtkimplements as _) }
    }
    pub unsafe fn SetEventProps(&self, ev: u32, dweventflags: u32, tkeventtype: u32, mdaddon: u32, mdremoveon: u32, mdfire: u32, rmdothermethods: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetEventProps)(windows_core::Interface::as_raw(self), ev, dweventflags, tkeventtype, mdaddon, mdremoveon, mdfire, rmdothermethods as _) }
    }
    pub unsafe fn SetPermissionSetProps(&self, tk: u32, dwaction: u32, pvpermission: *const core::ffi::c_void, cbpermission: u32, ppm: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetPermissionSetProps)(windows_core::Interface::as_raw(self), tk, dwaction, pvpermission, cbpermission, ppm as _) }
    }
    pub unsafe fn DefinePinvokeMap<P2>(&self, tk: u32, dwmappingflags: u32, szimportname: P2, mrimportdll: u32) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefinePinvokeMap)(windows_core::Interface::as_raw(self), tk, dwmappingflags, szimportname.param().abi(), mrimportdll) }
    }
    pub unsafe fn SetPinvokeMap<P2>(&self, tk: u32, dwmappingflags: u32, szimportname: P2, mrimportdll: u32) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetPinvokeMap)(windows_core::Interface::as_raw(self), tk, dwmappingflags, szimportname.param().abi(), mrimportdll) }
    }
    pub unsafe fn DeletePinvokeMap(&self, tk: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).DeletePinvokeMap)(windows_core::Interface::as_raw(self), tk) }
    }
    pub unsafe fn DefineCustomAttribute(&self, tkowner: u32, tkctor: u32, pcustomattribute: *const core::ffi::c_void, cbcustomattribute: u32, pcv: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).DefineCustomAttribute)(windows_core::Interface::as_raw(self), tkowner, tkctor, pcustomattribute, cbcustomattribute, pcv as _) }
    }
    pub unsafe fn SetCustomAttributeValue(&self, pcv: u32, pcustomattribute: *const core::ffi::c_void, cbcustomattribute: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetCustomAttributeValue)(windows_core::Interface::as_raw(self), pcv, pcustomattribute, cbcustomattribute) }
    }
    pub unsafe fn DefineField<P1>(&self, td: u32, szname: P1, dwfieldflags: u32, pvsigblob: *mut u8, cbsigblob: u32, dwcplustypeflag: u32, pvalue: *const core::ffi::c_void, cchvalue: u32, pmd: *mut u32) -> windows_core::HRESULT
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineField)(windows_core::Interface::as_raw(self), td, szname.param().abi(), dwfieldflags, pvsigblob as _, cbsigblob, dwcplustypeflag, pvalue, cchvalue, pmd as _) }
    }
    pub unsafe fn DefineProperty<P1>(&self, td: u32, szproperty: P1, dwpropflags: u32, pvsig: *mut u8, cbsig: u32, dwcplustypeflag: u32, pvalue: *const core::ffi::c_void, cchvalue: u32, mdsetter: u32, mdgetter: u32, rmdothermethods: *mut u32, pmdprop: *mut u32) -> windows_core::HRESULT
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineProperty)(windows_core::Interface::as_raw(self), td, szproperty.param().abi(), dwpropflags, pvsig as _, cbsig, dwcplustypeflag, pvalue, cchvalue, mdsetter, mdgetter, rmdothermethods as _, pmdprop as _) }
    }
    pub unsafe fn DefineParam<P2>(&self, md: u32, ulparamseq: u32, szname: P2, dwparamflags: u32, dwcplustypeflag: u32, pvalue: *const core::ffi::c_void, cchvalue: u32, ppd: *mut u32) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineParam)(windows_core::Interface::as_raw(self), md, ulparamseq, szname.param().abi(), dwparamflags, dwcplustypeflag, pvalue, cchvalue, ppd as _) }
    }
    pub unsafe fn SetFieldProps(&self, fd: u32, dwfieldflags: u32, dwcplustypeflag: u32, pvalue: *const core::ffi::c_void, cchvalue: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetFieldProps)(windows_core::Interface::as_raw(self), fd, dwfieldflags, dwcplustypeflag, pvalue, cchvalue) }
    }
    pub unsafe fn SetPropertyProps(&self, pr: u32, dwpropflags: u32, dwcplustypeflag: u32, pvalue: *const core::ffi::c_void, cchvalue: u32, mdsetter: u32, mdgetter: u32, rmdothermethods: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetPropertyProps)(windows_core::Interface::as_raw(self), pr, dwpropflags, dwcplustypeflag, pvalue, cchvalue, mdsetter, mdgetter, rmdothermethods as _) }
    }
    pub unsafe fn SetParamProps<P1>(&self, pd: u32, szname: P1, dwparamflags: u32, dwcplustypeflag: u32, pvalue: *const core::ffi::c_void, cchvalue: u32) -> windows_core::HRESULT
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetParamProps)(windows_core::Interface::as_raw(self), pd, szname.param().abi(), dwparamflags, dwcplustypeflag, pvalue, cchvalue) }
    }
    pub unsafe fn DefineSecurityAttributeSet(&self, tkobj: u32, rsecattrs: *mut COR_SECATTR, csecattrs: u32, pulerrorattr: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).DefineSecurityAttributeSet)(windows_core::Interface::as_raw(self), tkobj, rsecattrs as _, csecattrs, pulerrorattr as _) }
    }
    pub unsafe fn ApplyEditAndContinue<P0>(&self, pimport: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe { (windows_core::Interface::vtable(self).ApplyEditAndContinue)(windows_core::Interface::as_raw(self), pimport.param().abi()) }
    }
    pub unsafe fn TranslateSigWithScope<P0, P3, P6, P7>(&self, passemimport: P0, pbhashvalue: *const core::ffi::c_void, cbhashvalue: u32, import: P3, pbsigblob: *mut u8, cbsigblob: u32, passememit: P6, emit: P7, pvtranslatedsig: *mut u8, cbtranslatedsigmax: u32, pcbtranslatedsig: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IMetaDataAssemblyImport>,
        P3: windows_core::Param<IMetaDataImport>,
    ...
    {
        unsafe { (windows_core::Interface::vtable(self).TranslateSigWithScope)(windows_core::Interface::as_raw(self), passemimport.param().abi(), pbhashvalue, cbhashvalue, import.param().abi(), pbsigblob as _, cbsigblob, passememit.param().abi(), emit.param().abi(), pvtranslatedsig as _, cbtranslatedsigmax, pcbtranslatedsig as _) }
    }
    pub unsafe fn SetMethodImplFlags(&self, md: u32, dwimplflags: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetMethodImplFlags)(windows_core::Interface::as_raw(self), md, dwimplflags) }
    }
    pub unsafe fn SetFieldRVA(&self, fd: u32, ulrva: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetFieldRVA)(windows_core::Interface::as_raw(self), fd, ulrva) }
    }
    pub unsafe fn Merge<P0, P1, P2>(&self, pimport: P0, phostmaptoken: P1, phandler: P2) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IMetaDataImport>,
        P1: windows_core::Param<IMapToken>,
        P2: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe { (windows_core::Interface::vtable(self).Merge)(windows_core::Interface::as_raw(self), pimport.param().abi(), phostmaptoken.param().abi(), phandler.param().abi()) }
    }
    pub unsafe fn MergeEnd(&self) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).MergeEnd)(windows_core::Interface::as_raw(self)) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IMetaDataEmit2 {
    pub unsafe fn DefineMethodSpec(&self, tkparent: u32, pvsigblob: *mut u8, cbsigblob: u32, pmi: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).DefineMethodSpec)(windows_core::Interface::as_raw(self), tkparent, pvsigblob as _, cbsigblob, pmi as _) }
    }
    pub unsafe fn GetDeltaSaveSize(&self, fsave: CorSaveSize, pdwsavesize: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetDeltaSaveSize)(windows_core::Interface::as_raw(self), fsave, pdwsavesize as _) }
    }
    pub unsafe fn SaveDelta<P0>(&self, szfile: P0, dwsaveflags: u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SaveDelta)(windows_core::Interface::as_raw(self), szfile.param().abi(), dwsaveflags) }
    }
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn SaveDeltaToStream<P0>(&self, pistream: P0, dwsaveflags: u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::super::Com::IStream>,
    {
        unsafe { (windows_core::Interface::vtable(self).SaveDeltaToStream)(windows_core::Interface::as_raw(self), pistream.param().abi(), dwsaveflags) }
    }
    pub unsafe fn SaveDeltaToMemory(&self, pbdata: *mut core::ffi::c_void, cbdata: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SaveDeltaToMemory)(windows_core::Interface::as_raw(self), pbdata as _, cbdata) }
    }
    pub unsafe fn DefineGenericParam<P3>(&self, tk: u32, ulparamseq: u32, dwparamflags: u32, szname: P3, reserved: u32, rtkconstraints: *mut u32, pgp: *mut u32) -> windows_core::HRESULT
    where
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DefineGenericParam)(windows_core::Interface::as_raw(self), tk, ulparamseq, dwparamflags, szname.param().abi(), reserved, rtkconstraints as _, pgp as _) }
    }
    pub unsafe fn SetGenericParamProps<P2>(&self, gp: u32, dwparamflags: u32, szname: P2, reserved: u32, rtkconstraints: *mut u32) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetGenericParamProps)(windows_core::Interface::as_raw(self), gp, dwparamflags, szname.param().abi(), reserved, rtkconstraints as _) }
    }
    pub unsafe fn ResetENCLog(&self) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).ResetENCLog)(windows_core::Interface::as_raw(self)) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IMetaDataError {
    pub unsafe fn OnError(&self, hrerror: windows_core::HRESULT, token: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).OnError)(windows_core::Interface::as_raw(self), hrerror, token) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IMetaDataFilter {
    pub unsafe fn UnmarkAll(&self) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).UnmarkAll)(windows_core::Interface::as_raw(self)) }
    }
    pub unsafe fn MarkToken(&self, tk: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).MarkToken)(windows_core::Interface::as_raw(self), tk) }
    }
    pub unsafe fn IsTokenMarked(&self, tk: u32, pismarked: *mut windows_core::BOOL) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).IsTokenMarked)(windows_core::Interface::as_raw(self), tk, pismarked as _) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IMetaDataImport {
    ...
    pub unsafe fn CountEnum(&self, henum: *mut core::ffi::c_void, pulcount: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).CountEnum)(windows_core::Interface::as_raw(self), henum as _, pulcount as _) }
    }
    pub unsafe fn ResetEnum(&self, henum: *mut core::ffi::c_void, ulpos: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).ResetEnum)(windows_core::Interface::as_raw(self), henum as _, ulpos) }
    }
    pub unsafe fn EnumTypeDefs(&self, phenum: *mut *mut core::ffi::c_void, rtypedefs: *mut u32, cmax: u32, pctypedefs: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumTypeDefs)(windows_core::Interface::as_raw(self), phenum as _, rtypedefs as _, cmax, pctypedefs as _) }
    }
    pub unsafe fn EnumInterfaceImpls(&self, phenum: *mut *mut core::ffi::c_void, td: u32, rimpls: *mut u32, cmax: u32, pcimpls: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumInterfaceImpls)(windows_core::Interface::as_raw(self), phenum as _, td, rimpls as _, cmax, pcimpls as _) }
    }
    pub unsafe fn EnumTypeRefs(&self, phenum: *mut *mut core::ffi::c_void, rtyperefs: *mut u32, cmax: u32, pctyperefs: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumTypeRefs)(windows_core::Interface::as_raw(self), phenum as _, rtyperefs as _, cmax, pctyperefs as _) }
    }
    pub unsafe fn FindTypeDefByName<P0>(&self, sztypedef: P0, tkenclosingclass: u32, ptd: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).FindTypeDefByName)(windows_core::Interface::as_raw(self), sztypedef.param().abi(), tkenclosingclass, ptd as _) }
    }
    pub unsafe fn GetScopeProps(&self, szname: Option<&mut [u16]>, pchname: *mut u32, pmvid: *mut windows_core::GUID) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetScopeProps)(windows_core::Interface::as_raw(self), core::mem::transmute(szname.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), szname.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pchname as _, pmvid as _) }
    }
    pub unsafe fn GetModuleFromScope(&self, pmd: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetModuleFromScope)(windows_core::Interface::as_raw(self), pmd as _) }
    }
    pub unsafe fn GetTypeDefProps(&self, td: u32, sztypedef: Option<&mut [u16]>, pchtypedef: *mut u32, pdwtypedefflags: *mut u32, ptkextends: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetTypeDefProps)(windows_core::Interface::as_raw(self), td, core::mem::transmute(sztypedef.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), sztypedef.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pchtypedef as _, pdwtypedefflags as _, ptkextends as _) }
    }
    pub unsafe fn GetInterfaceImplProps(&self, iiimpl: u32, pclass: *mut u32, ptkiface: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetInterfaceImplProps)(windows_core::Interface::as_raw(self), iiimpl, pclass as _, ptkiface as _) }
    }
    pub unsafe fn GetTypeRefProps(&self, tr: u32, ptkresolutionscope: *mut u32, szname: Option<&mut [u16]>, pchname: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetTypeRefProps)(windows_core::Interface::as_raw(self), tr, ptkresolutionscope as _, core::mem::transmute(szname.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), szname.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pchname as _) }
    }
    pub unsafe fn ResolveTypeRef(&self, tr: u32, riid: *const windows_core::GUID, ppiscope: *mut Option<windows_core::IUnknown>, ptd: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).ResolveTypeRef)(windows_core::Interface::as_raw(self), tr, riid, core::mem::transmute(ppiscope), ptd as _) }
    }
    pub unsafe fn EnumMembers(&self, phenum: *mut *mut core::ffi::c_void, cl: u32, rmembers: *mut u32, cmax: u32, pctokens: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumMembers)(windows_core::Interface::as_raw(self), phenum as _, cl, rmembers as _, cmax, pctokens as _) }
    }
    pub unsafe fn EnumMembersWithName<P2>(&self, phenum: *mut *mut core::ffi::c_void, cl: u32, szname: P2, rmembers: *mut u32, cmax: u32, pctokens: *mut u32) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).EnumMembersWithName)(windows_core::Interface::as_raw(self), phenum as _, cl, szname.param().abi(), rmembers as _, cmax, pctokens as _) }
    }
    pub unsafe fn EnumMethods(&self, phenum: *mut *mut core::ffi::c_void, cl: u32, rmethods: *mut u32, cmax: u32, pctokens: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumMethods)(windows_core::Interface::as_raw(self), phenum as _, cl, rmethods as _, cmax, pctokens as _) }
    }
    pub unsafe fn EnumMethodsWithName<P2>(&self, phenum: *mut *mut core::ffi::c_void, cl: u32, szname: P2, rmethods: *mut u32, cmax: u32, pctokens: *mut u32) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).EnumMethodsWithName)(windows_core::Interface::as_raw(self), phenum as _, cl, szname.param().abi(), rmethods as _, cmax, pctokens as _) }
    }
    pub unsafe fn EnumFields(&self, phenum: *mut *mut core::ffi::c_void, cl: u32, rfields: *mut u32, cmax: u32, pctokens: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumFields)(windows_core::Interface::as_raw(self), phenum as _, cl, rfields as _, cmax, pctokens as _) }
    }
    pub unsafe fn EnumFieldsWithName<P2>(&self, phenum: *mut *mut core::ffi::c_void, cl: u32, szname: P2, rfields: *mut u32, cmax: u32, pctokens: *mut u32) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).EnumFieldsWithName)(windows_core::Interface::as_raw(self), phenum as _, cl, szname.param().abi(), rfields as _, cmax, pctokens as _) }
    }
    pub unsafe fn EnumParams(&self, phenum: *mut *mut core::ffi::c_void, mb: u32, rparams: *mut u32, cmax: u32, pctokens: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumParams)(windows_core::Interface::as_raw(self), phenum as _, mb, rparams as _, cmax, pctokens as _) }
    }
    pub unsafe fn EnumMemberRefs(&self, phenum: *mut *mut core::ffi::c_void, tkparent: u32, rmemberrefs: *mut u32, cmax: u32, pctokens: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumMemberRefs)(windows_core::Interface::as_raw(self), phenum as _, tkparent, rmemberrefs as _, cmax, pctokens as _) }
    }
    pub unsafe fn EnumMethodImpls(&self, phenum: *mut *mut core::ffi::c_void, td: u32, rmethodbody: *mut u32, rmethoddecl: *mut u32, cmax: u32, pctokens: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumMethodImpls)(windows_core::Interface::as_raw(self), phenum as _, td, rmethodbody as _, rmethoddecl as _, cmax, pctokens as _) }
    }
    pub unsafe fn EnumPermissionSets(&self, phenum: *mut *mut core::ffi::c_void, tk: u32, dwactions: u32, rpermission: *mut u32, cmax: u32, pctokens: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumPermissionSets)(windows_core::Interface::as_raw(self), phenum as _, tk, dwactions, rpermission as _, cmax, pctokens as _) }
    }
    pub unsafe fn FindMember<P1>(&self, td: u32, szname: P1, pvsigblob: *mut u8, cbsigblob: u32, pmb: *mut u32) -> windows_core::HRESULT
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).FindMember)(windows_core::Interface::as_raw(self), td, szname.param().abi(), pvsigblob as _, cbsigblob, pmb as _) }
    }
    pub unsafe fn FindMethod<P1>(&self, td: u32, szname: P1, pvsigblob: *mut u8, cbsigblob: u32, pmb: *mut u32) -> windows_core::HRESULT
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).FindMethod)(windows_core::Interface::as_raw(self), td, szname.param().abi(), pvsigblob as _, cbsigblob, pmb as _) }
    }
    pub unsafe fn FindField<P1>(&self, td: u32, szname: P1, pvsigblob: *mut u8, cbsigblob: u32, pmb: *mut u32) -> windows_core::HRESULT
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).FindField)(windows_core::Interface::as_raw(self), td, szname.param().abi(), pvsigblob as _, cbsigblob, pmb as _) }
    }
    pub unsafe fn FindMemberRef<P1>(&self, td: u32, szname: P1, pvsigblob: *mut u8, cbsigblob: u32, pmr: *mut u32) -> windows_core::HRESULT
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).FindMemberRef)(windows_core::Interface::as_raw(self), td, szname.param().abi(), pvsigblob as _, cbsigblob, pmr as _) }
    }
    pub unsafe fn GetMethodProps(&self, mb: u32, pclass: *mut u32, szmethod: Option<&mut [u16]>, pchmethod: *mut u32, pdwattr: *mut u32, ppvsigblob: *mut *mut u8, pcbsigblob: *mut u32, pulcoderva: *mut u32, pdwimplflags: *mut u32) -> windows_core::HRESULT {
    ...
    pub unsafe fn GetMemberRefProps(&self, mr: u32, ptk: *mut u32, szmember: Option<&mut [u16]>, pchmember: *mut u32, ppvsigblob: *mut *mut u8, pbsig: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetMemberRefProps)(windows_core::Interface::as_raw(self), mr, ptk as _, core::mem::transmute(szmember.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), szmember.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pchmember as _, ppvsigblob as _, pbsig as _) }
    }
    pub unsafe fn EnumProperties(&self, phenum: *mut *mut core::ffi::c_void, td: u32, rproperties: *mut u32, cmax: u32, pcproperties: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumProperties)(windows_core::Interface::as_raw(self), phenum as _, td, rproperties as _, cmax, pcproperties as _) }
    }
    pub unsafe fn EnumEvents(&self, phenum: *mut *mut core::ffi::c_void, td: u32, revents: *mut u32, cmax: u32, pcevents: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumEvents)(windows_core::Interface::as_raw(self), phenum as _, td, revents as _, cmax, pcevents as _) }
    }
    pub unsafe fn GetEventProps<P2>(&self, ev: u32, pclass: *mut u32, szevent: P2, cchevent: u32, pchevent: *mut u32, pdweventflags: *mut u32, ptkeventtype: *mut u32, pmdaddon: *mut u32, pmdremoveon: *mut u32, pmdfire: *mut u32, rmdothermethod: *mut u32, cmax: u32, pcothermethod: *mut u32) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).GetEventProps)(windows_core::Interface::as_raw(self), ev, pclass as _, szevent.param().abi(), cchevent, pchevent as _, pdweventflags as _, ptkeventtype as _, pmdaddon as _, pmdremoveon as _, pmdfire as _, rmdothermethod as _, cmax, pcothermethod as _) }
    }
    pub unsafe fn EnumMethodSemantics(&self, phenum: *mut *mut core::ffi::c_void, mb: u32, reventprop: *mut u32, cmax: u32, pceventprop: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumMethodSemantics)(windows_core::Interface::as_raw(self), phenum as _, mb, reventprop as _, cmax, pceventprop as _) }
    }
    pub unsafe fn GetMethodSemantics(&self, mb: u32, tkeventprop: u32, pdwsemanticsflags: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetMethodSemantics)(windows_core::Interface::as_raw(self), mb, tkeventprop, pdwsemanticsflags as _) }
    }
    pub unsafe fn GetClassLayout(&self, td: u32, pdwpacksize: *mut u32, rfieldoffset: *mut COR_FIELD_OFFSET, cmax: u32, pcfieldoffset: *mut u32, pulclasssize: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetClassLayout)(windows_core::Interface::as_raw(self), td, pdwpacksize as _, rfieldoffset as _, cmax, pcfieldoffset as _, pulclasssize as _) }
    }
    pub unsafe fn GetFieldMarshal(&self, tk: u32, ppvnativetype: *mut *mut u8, pcbnativetype: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetFieldMarshal)(windows_core::Interface::as_raw(self), tk, ppvnativetype as _, pcbnativetype as _) }
    }
    pub unsafe fn GetRVA(&self, tk: u32, pulcoderva: *mut u32, pdwimplflags: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetRVA)(windows_core::Interface::as_raw(self), tk, pulcoderva as _, pdwimplflags as _) }
    }
    pub unsafe fn GetPermissionSetProps(&self, pm: u32, pdwaction: *mut u32, ppvpermission: *const *const core::ffi::c_void, pcbpermission: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetPermissionSetProps)(windows_core::Interface::as_raw(self), pm, pdwaction as _, ppvpermission, pcbpermission as _) }
    }
    pub unsafe fn GetSigFromToken(&self, mdsig: u32, ppvsig: *mut *mut u8, pcbsig: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetSigFromToken)(windows_core::Interface::as_raw(self), mdsig, ppvsig as _, pcbsig as _) }
    }
    pub unsafe fn GetModuleRefProps(&self, mur: u32, szname: Option<&mut [u16]>, pchname: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetModuleRefProps)(windows_core::Interface::as_raw(self), mur, core::mem::transmute(szname.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), szname.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pchname as _) }
    }
    pub unsafe fn EnumModuleRefs(&self, phenum: *mut *mut core::ffi::c_void, rmodulerefs: *mut u32, cmax: u32, pcmodulerefs: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumModuleRefs)(windows_core::Interface::as_raw(self), phenum as _, rmodulerefs as _, cmax, pcmodulerefs as _) }
    }
    pub unsafe fn GetTypeSpecFromToken(&self, typespec: u32, ppvsig: *mut *mut u8, pcbsig: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetTypeSpecFromToken)(windows_core::Interface::as_raw(self), typespec, ppvsig as _, pcbsig as _) }
    }
    pub unsafe fn GetNameFromToken(&self, tk: u32, pszutf8nameptr: *mut *mut i8) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetNameFromToken)(windows_core::Interface::as_raw(self), tk, pszutf8nameptr as _) }
    }
    pub unsafe fn EnumUnresolvedMethods(&self, phenum: *mut *mut core::ffi::c_void, rmethods: *mut u32, cmax: u32, pctokens: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumUnresolvedMethods)(windows_core::Interface::as_raw(self), phenum as _, rmethods as _, cmax, pctokens as _) }
    }
    pub unsafe fn GetUserString(&self, stk: u32, szstring: Option<&mut [u16]>, pchstring: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetUserString)(windows_core::Interface::as_raw(self), stk, core::mem::transmute(szstring.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), szstring.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pchstring as _) }
    }
    pub unsafe fn GetPinvokeMap(&self, tk: u32, pdwmappingflags: *mut u32, szimportname: Option<&mut [u16]>, pchimportname: *mut u32, pmrimportdll: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetPinvokeMap)(windows_core::Interface::as_raw(self), tk, pdwmappingflags as _, core::mem::transmute(szimportname.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), szimportname.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pchimportname as _, pmrimportdll as _) }
    }
    pub unsafe fn EnumSignatures(&self, phenum: *mut *mut core::ffi::c_void, rsignatures: *mut u32, cmax: u32, pcsignatures: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumSignatures)(windows_core::Interface::as_raw(self), phenum as _, rsignatures as _, cmax, pcsignatures as _) }
    }
    pub unsafe fn EnumTypeSpecs(&self, phenum: *mut *mut core::ffi::c_void, rtypespecs: *mut u32, cmax: u32, pctypespecs: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumTypeSpecs)(windows_core::Interface::as_raw(self), phenum as _, rtypespecs as _, cmax, pctypespecs as _) }
    }
    pub unsafe fn EnumUserStrings(&self, phenum: *mut *mut core::ffi::c_void, rstrings: *mut u32, cmax: u32, pcstrings: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumUserStrings)(windows_core::Interface::as_raw(self), phenum as _, rstrings as _, cmax, pcstrings as _) }
    }
    pub unsafe fn GetParamForMethodIndex(&self, md: u32, ulparamseq: u32, ppd: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetParamForMethodIndex)(windows_core::Interface::as_raw(self), md, ulparamseq, ppd as _) }
    }
    pub unsafe fn EnumCustomAttributes(&self, phenum: *mut *mut core::ffi::c_void, tk: u32, tktype: u32, rcustomattributes: *mut u32, cmax: u32, pccustomattributes: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumCustomAttributes)(windows_core::Interface::as_raw(self), phenum as _, tk, tktype, rcustomattributes as _, cmax, pccustomattributes as _) }
    }
    pub unsafe fn GetCustomAttributeProps(&self, cv: u32, ptkobj: *mut u32, ptktype: *mut u32, ppblob: *const *const core::ffi::c_void, pcbsize: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetCustomAttributeProps)(windows_core::Interface::as_raw(self), cv, ptkobj as _, ptktype as _, ppblob, pcbsize as _) }
    }
    pub unsafe fn FindTypeRef<P1>(&self, tkresolutionscope: u32, szname: P1, ptr: *mut u32) -> windows_core::HRESULT
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).FindTypeRef)(windows_core::Interface::as_raw(self), tkresolutionscope, szname.param().abi(), ptr as _) }
    }
    pub unsafe fn GetMemberProps(&self, mb: u32, pclass: *mut u32, szmember: Option<&mut [u16]>, pchmember: *mut u32, pdwattr: *mut u32, ppvsigblob: *mut *mut u8, pcbsigblob: *mut u32, pulcoderva: *mut u32, pdwimplflags: *mut u32, pdwcplustypeflag: *mut u32, ppvalue: *mut *mut core::ffi::c_void, pcchvalue: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetMemberProps)(windows_core::Interface::as_raw(self), mb, pclass as _, core::mem::transmute(szmember.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), szmember.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pchmember as _, pdwattr as _, ppvsigblob as _, pcbsigblob as _, pulcoderva as _, pdwimplflags as _, pdwcplustypeflag as _, ppvalue as _, pcchvalue as _) }
    }
    pub unsafe fn GetFieldProps(&self, mb: u32, pclass: *mut u32, szfield: Option<&mut [u16]>, pchfield: *mut u32, pdwattr: *mut u32, ppvsigblob: *mut *mut u8, pcbsigblob: *mut u32, pdwcplustypeflag: *mut u32, ppvalue: *mut *mut core::ffi::c_void, pcchvalue: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetFieldProps)(windows_core::Interface::as_raw(self), mb, pclass as _, core::mem::transmute(szfield.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), szfield.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pchfield as _, pdwattr as _, ppvsigblob as _, pcbsigblob as _, pdwcplustypeflag as _, ppvalue as _, pcchvalue as _) }
    }
    pub unsafe fn GetPropertyProps<P2>(&self, prop: u32, pclass: *mut u32, szproperty: P2, cchproperty: u32, pchproperty: *mut u32, pdwpropflags: *mut u32, ppvsig: *mut *mut u8, pbsig: *mut u32, pdwcplustypeflag: *mut u32, ppdefaultvalue: *mut *mut core::ffi::c_void, pcchdefaultvalue: *mut u32, pmdsetter: *mut u32, pmdgetter: *mut u32, rmdothermethod: *mut u32, cmax: u32, pcothermethod: *mut u32) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetParamProps(&self, tk: u32, pmd: *mut u32, pulsequence: *mut u32, szname: Option<&mut [u16]>, pchname: *mut u32, pdwattr: *mut u32, pdwcplustypeflag: *mut u32, ppvalue: *mut *mut core::ffi::c_void, pcchvalue: *mut u32) -> windows_core::HRESULT {
    ...
    pub unsafe fn GetCustomAttributeByName<P1>(&self, tkobj: u32, szname: P1, ppdata: *const *const core::ffi::c_void, pcbdata: *mut u32) -> windows_core::HRESULT
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).GetCustomAttributeByName)(windows_core::Interface::as_raw(self), tkobj, szname.param().abi(), ppdata, pcbdata as _) }
    }
    ...
    pub unsafe fn GetNestedClassProps(&self, tdnestedclass: u32, ptdenclosingclass: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetNestedClassProps)(windows_core::Interface::as_raw(self), tdnestedclass, ptdenclosingclass as _) }
    }
    pub unsafe fn GetNativeCallConvFromSig(&self, pvsig: *const core::ffi::c_void, cbsig: u32, pcallconv: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetNativeCallConvFromSig)(windows_core::Interface::as_raw(self), pvsig, cbsig, pcallconv as _) }
    }
    pub unsafe fn IsGlobal(&self, pd: u32, pbglobal: *mut i32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).IsGlobal)(windows_core::Interface::as_raw(self), pd, pbglobal as _) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IMetaDataImport2 {
    pub unsafe fn EnumGenericParams(&self, phenum: *mut *mut core::ffi::c_void, tk: u32, rgenericparams: *mut u32, cmax: u32, pcgenericparams: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumGenericParams)(windows_core::Interface::as_raw(self), phenum as _, tk, rgenericparams as _, cmax, pcgenericparams as _) }
    }
    pub unsafe fn GetGenericParamProps(&self, gp: u32, pulparamseq: *mut u32, pdwparamflags: *mut u32, ptowner: *mut u32, reserved: *mut u32, wzname: Option<&mut [u16]>, pchname: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetGenericParamProps)(windows_core::Interface::as_raw(self), gp, pulparamseq as _, pdwparamflags as _, ptowner as _, reserved as _, core::mem::transmute(wzname.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), wzname.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pchname as _) }
    }
    pub unsafe fn GetMethodSpecProps(&self, mi: u32, tkparent: *mut u32, ppvsigblob: *mut *mut u8, pcbsigblob: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetMethodSpecProps)(windows_core::Interface::as_raw(self), mi, tkparent as _, ppvsigblob as _, pcbsigblob as _) }
    }
    pub unsafe fn EnumGenericParamConstraints(&self, phenum: *mut *mut core::ffi::c_void, tk: u32, rgenericparamconstraints: *mut u32, cmax: u32, pcgenericparamconstraints: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumGenericParamConstraints)(windows_core::Interface::as_raw(self), phenum as _, tk, rgenericparamconstraints as _, cmax, pcgenericparamconstraints as _) }
    }
    pub unsafe fn GetGenericParamConstraintProps(&self, gpc: u32, ptgenericparam: *mut u32, ptkconstrainttype: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetGenericParamConstraintProps)(windows_core::Interface::as_raw(self), gpc, ptgenericparam as _, ptkconstrainttype as _) }
    }
    pub unsafe fn GetPEKind(&self, pdwpekind: *mut u32, pdwmachine: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetPEKind)(windows_core::Interface::as_raw(self), pdwpekind as _, pdwmachine as _) }
    }
    pub unsafe fn GetVersionString(&self, pwzbuf: Option<&mut [u16]>, pccbufsize: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetVersionString)(windows_core::Interface::as_raw(self), core::mem::transmute(pwzbuf.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pwzbuf.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pccbufsize as _) }
    }
    pub unsafe fn EnumMethodSpecs(&self, phenum: *mut *mut core::ffi::c_void, tk: u32, rmethodspecs: *mut u32, cmax: u32, pcmethodspecs: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).EnumMethodSpecs)(windows_core::Interface::as_raw(self), phenum as _, tk, rmethodspecs as _, cmax, pcmethodspecs as _) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IMetaDataInfo {
    pub unsafe fn GetFileMapping(&self, ppvdata: *const *const core::ffi::c_void, pcbdata: *mut u64, pdwmappingtype: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetFileMapping)(windows_core::Interface::as_raw(self), ppvdata, pcbdata as _, pdwmappingtype as _) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IMetaDataTables {
    pub unsafe fn GetStringHeapSize(&self, pcbstrings: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetStringHeapSize)(windows_core::Interface::as_raw(self), pcbstrings as _) }
    }
    pub unsafe fn GetBlobHeapSize(&self, pcbblobs: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetBlobHeapSize)(windows_core::Interface::as_raw(self), pcbblobs as _) }
    }
    pub unsafe fn GetGuidHeapSize(&self, pcbguids: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetGuidHeapSize)(windows_core::Interface::as_raw(self), pcbguids as _) }
    }
    pub unsafe fn GetUserStringHeapSize(&self, pcbblobs: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetUserStringHeapSize)(windows_core::Interface::as_raw(self), pcbblobs as _) }
    }
    pub unsafe fn GetNumTables(&self, pctables: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetNumTables)(windows_core::Interface::as_raw(self), pctables as _) }
    }
    pub unsafe fn GetTableIndex(&self, token: u32, pixtbl: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetTableIndex)(windows_core::Interface::as_raw(self), token, pixtbl as _) }
    }
    pub unsafe fn GetTableInfo(&self, ixtbl: u32, pcbrow: *mut u32, pcrows: *mut u32, pccols: *mut u32, pikey: *mut u32, ppname: *const *const i8) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetTableInfo)(windows_core::Interface::as_raw(self), ixtbl, pcbrow as _, pcrows as _, pccols as _, pikey as _, ppname) }
    }
    pub unsafe fn GetColumnInfo(&self, ixtbl: u32, ixcol: u32, pocol: *mut u32, pcbcol: *mut u32, ptype: *mut u32, ppname: *const *const i8) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetColumnInfo)(windows_core::Interface::as_raw(self), ixtbl, ixcol, pocol as _, pcbcol as _, ptype as _, ppname) }
    }
    pub unsafe fn GetCodedTokenInfo(&self, ixcdtkn: u32, pctokens: *mut u32, pptokens: *mut *mut u32, ppname: *const *const i8) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetCodedTokenInfo)(windows_core::Interface::as_raw(self), ixcdtkn, pctokens as _, pptokens as _, ppname) }
    }
    pub unsafe fn GetRow(&self, ixtbl: u32, rid: u32, pprow: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetRow)(windows_core::Interface::as_raw(self), ixtbl, rid, pprow as _) }
    }
    pub unsafe fn GetColumn(&self, ixtbl: u32, ixcol: u32, rid: u32, pval: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetColumn)(windows_core::Interface::as_raw(self), ixtbl, ixcol, rid, pval as _) }
    }
    pub unsafe fn GetString(&self, ixstring: u32, ppstring: *const *const i8) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetString)(windows_core::Interface::as_raw(self), ixstring, ppstring) }
    }
    pub unsafe fn GetBlob(&self, ixblob: u32, pcbdata: *mut u32, ppdata: *const *const core::ffi::c_void) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetBlob)(windows_core::Interface::as_raw(self), ixblob, pcbdata as _, ppdata) }
    }
    pub unsafe fn GetGuid(&self, ixguid: u32, ppguid: *const *const windows_core::GUID) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetGuid)(windows_core::Interface::as_raw(self), ixguid, ppguid) }
    }
    pub unsafe fn GetUserString(&self, ixuserstring: u32, pcbdata: *mut u32, ppdata: *const *const core::ffi::c_void) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetUserString)(windows_core::Interface::as_raw(self), ixuserstring, pcbdata as _, ppdata) }
    }
    pub unsafe fn GetNextString(&self, ixstring: u32, pnext: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetNextString)(windows_core::Interface::as_raw(self), ixstring, pnext as _) }
    }
    pub unsafe fn GetNextBlob(&self, ixblob: u32, pnext: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetNextBlob)(windows_core::Interface::as_raw(self), ixblob, pnext as _) }
    }
    pub unsafe fn GetNextGuid(&self, ixguid: u32, pnext: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetNextGuid)(windows_core::Interface::as_raw(self), ixguid, pnext as _) }
    }
    pub unsafe fn GetNextUserString(&self, ixuserstring: u32, pnext: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetNextUserString)(windows_core::Interface::as_raw(self), ixuserstring, pnext as _) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IMetaDataTables2 {
    pub unsafe fn GetMetaDataStorage(&self, ppvmd: *const *const core::ffi::c_void, pcbmd: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetMetaDataStorage)(windows_core::Interface::as_raw(self), ppvmd, pcbmd as _) }
    }
    pub unsafe fn GetMetaDataStreamInfo(&self, ix: u32, ppchname: *const *const i8, ppv: *const *const core::ffi::c_void, pcb: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetMetaDataStreamInfo)(windows_core::Interface::as_raw(self), ix, ppchname, ppv, pcb as _) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IMetaDataValidate {
    pub unsafe fn ValidatorInit<P1>(&self, dwmoduletype: u32, punk: P1) -> windows_core::HRESULT
    where
        P1: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe { (windows_core::Interface::vtable(self).ValidatorInit)(windows_core::Interface::as_raw(self), dwmoduletype, punk.param().abi()) }
    }
    pub unsafe fn ValidateMetaData(&self) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).ValidateMetaData)(windows_core::Interface::as_raw(self)) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IMetaDataWinMDImport {
    pub unsafe fn GetUntransformedTypeRefProps(&self, tr: u32, ptkresolutionscope: *mut u32, szname: Option<&mut [u16]>, pchname: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetUntransformedTypeRefProps)(windows_core::Interface::as_raw(self), tr, ptkresolutionscope as _, core::mem::transmute(szname.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), szname.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), pchname as _) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
pub const INVALID_CONNECTION_ID: u32 = 0;
...
pub const LoadAlways: LoadHintEnum = LoadHintEnum(1);
pub const LoadDefault: LoadHintEnum = LoadHintEnum(0);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct LoadHintEnum(pub i32);
pub const LoadNever: LoadHintEnum = LoadHintEnum(3);
pub const LoadSometimes: LoadHintEnum = LoadHintEnum(2);
...
pub const MAX_CONNECTION_NAME: u32 = 260;
pub const MDAssembly: CorLinkerOptions = CorLinkerOptions(0);
pub const MDDupAll: CorCheckDuplicatesFor = CorCheckDuplicatesFor(-1);
pub const MDDupAssembly: CorCheckDuplicatesFor = CorCheckDuplicatesFor(268435456);
pub const MDDupAssemblyRef: CorCheckDuplicatesFor = CorCheckDuplicatesFor(32768);
pub const MDDupCustomAttribute: CorCheckDuplicatesFor = CorCheckDuplicatesFor(32);
pub const MDDupDefault: CorCheckDuplicatesFor = CorCheckDuplicatesFor(1058840);
pub const MDDupENC: CorCheckDuplicatesFor = CorCheckDuplicatesFor(-1);
pub const MDDupEvent: CorCheckDuplicatesFor = CorCheckDuplicatesFor(512);
pub const MDDupExportedType: CorCheckDuplicatesFor = CorCheckDuplicatesFor(131072);
pub const MDDupFieldDef: CorCheckDuplicatesFor = CorCheckDuplicatesFor(1024);
pub const MDDupFile: CorCheckDuplicatesFor = CorCheckDuplicatesFor(65536);
pub const MDDupGenericParam: CorCheckDuplicatesFor = CorCheckDuplicatesFor(524288);
pub const MDDupGenericParamConstraint: CorCheckDuplicatesFor = CorCheckDuplicatesFor(2097152);
pub const MDDupImplMap: CorCheckDuplicatesFor = CorCheckDuplicatesFor(16384);
pub const MDDupInterfaceImpl: CorCheckDuplicatesFor = CorCheckDuplicatesFor(2);
pub const MDDupManifestResource: CorCheckDuplicatesFor = CorCheckDuplicatesFor(262144);
pub const MDDupMemberRef: CorCheckDuplicatesFor = CorCheckDuplicatesFor(16);
pub const MDDupMethodDef: CorCheckDuplicatesFor = CorCheckDuplicatesFor(4);
pub const MDDupMethodSpec: CorCheckDuplicatesFor = CorCheckDuplicatesFor(1048576);
pub const MDDupModuleRef: CorCheckDuplicatesFor = CorCheckDuplicatesFor(4096);
pub const MDDupParamDef: CorCheckDuplicatesFor = CorCheckDuplicatesFor(64);
pub const MDDupPermission: CorCheckDuplicatesFor = CorCheckDuplicatesFor(128);
pub const MDDupProperty: CorCheckDuplicatesFor = CorCheckDuplicatesFor(256);
pub const MDDupSignature: CorCheckDuplicatesFor = CorCheckDuplicatesFor(2048);
pub const MDDupTypeDef: CorCheckDuplicatesFor = CorCheckDuplicatesFor(1);
pub const MDDupTypeRef: CorCheckDuplicatesFor = CorCheckDuplicatesFor(8);
pub const MDDupTypeSpec: CorCheckDuplicatesFor = CorCheckDuplicatesFor(8192);
pub const MDErrorOutOfOrderAll: CorErrorIfEmitOutOfOrder = CorErrorIfEmitOutOfOrder(-1);
pub const MDErrorOutOfOrderDefault: CorErrorIfEmitOutOfOrder = CorErrorIfEmitOutOfOrder(0);
pub const MDErrorOutOfOrderNone: CorErrorIfEmitOutOfOrder = CorErrorIfEmitOutOfOrder(0);
pub const MDEventOutOfOrder: CorErrorIfEmitOutOfOrder = CorErrorIfEmitOutOfOrder(16);
pub const MDFieldOutOfOrder: CorErrorIfEmitOutOfOrder = CorErrorIfEmitOutOfOrder(2);
pub const MDImportOptionAll: CorImportOptions = CorImportOptions(-1);
pub const MDImportOptionAllCustomAttributes: CorImportOptions = CorImportOptions(32);
pub const MDImportOptionAllEvents: CorImportOptions = CorImportOptions(16);
pub const MDImportOptionAllExportedTypes: CorImportOptions = CorImportOptions(64);
pub const MDImportOptionAllFieldDefs: CorImportOptions = CorImportOptions(4);
pub const MDImportOptionAllMethodDefs: CorImportOptions = CorImportOptions(2);
pub const MDImportOptionAllProperties: CorImportOptions = CorImportOptions(8);
pub const MDImportOptionAllTypeDefs: CorImportOptions = CorImportOptions(1);
pub const MDImportOptionDefault: CorImportOptions = CorImportOptions(0);
pub const MDMemberRefToDef: CorRefToDefCheck = CorRefToDefCheck(2);
pub const MDMethodOutOfOrder: CorErrorIfEmitOutOfOrder = CorErrorIfEmitOutOfOrder(1);
pub const MDNetModule: CorLinkerOptions = CorLinkerOptions(1);
pub const MDNoDupChecks: CorCheckDuplicatesFor = CorCheckDuplicatesFor(0);
pub const MDNotifyAll: CorNotificationForTokenMovement = CorNotificationForTokenMovement(-1);
pub const MDNotifyAssemblyRef: CorNotificationForTokenMovement = CorNotificationForTokenMovement(16777216);
pub const MDNotifyCustomAttribute: CorNotificationForTokenMovement = CorNotificationForTokenMovement(2048);
pub const MDNotifyDefault: CorNotificationForTokenMovement = CorNotificationForTokenMovement(15);
pub const MDNotifyEvent: CorNotificationForTokenMovement = CorNotificationForTokenMovement(256);
pub const MDNotifyExportedType: CorNotificationForTokenMovement = CorNotificationForTokenMovement(67108864);
pub const MDNotifyFieldDef: CorNotificationForTokenMovement = CorNotificationForTokenMovement(4);
pub const MDNotifyFile: CorNotificationForTokenMovement = CorNotificationForTokenMovement(33554432);
pub const MDNotifyInterfaceImpl: CorNotificationForTokenMovement = CorNotificationForTokenMovement(64);
pub const MDNotifyMemberRef: CorNotificationForTokenMovement = CorNotificationForTokenMovement(2);
pub const MDNotifyMethodDef: CorNotificationForTokenMovement = CorNotificationForTokenMovement(1);
pub const MDNotifyModuleRef: CorNotificationForTokenMovement = CorNotificationForTokenMovement(16384);
pub const MDNotifyNameSpace: CorNotificationForTokenMovement = CorNotificationForTokenMovement(32768);
pub const MDNotifyNone: CorNotificationForTokenMovement = CorNotificationForTokenMovement(0);
pub const MDNotifyParamDef: CorNotificationForTokenMovement = CorNotificationForTokenMovement(32);
pub const MDNotifyPermission: CorNotificationForTokenMovement = CorNotificationForTokenMovement(8192);
pub const MDNotifyProperty: CorNotificationForTokenMovement = CorNotificationForTokenMovement(128);
pub const MDNotifyResource: CorNotificationForTokenMovement = CorNotificationForTokenMovement(134217728);
pub const MDNotifySecurityValue: CorNotificationForTokenMovement = CorNotificationForTokenMovement(4096);
pub const MDNotifySignature: CorNotificationForTokenMovement = CorNotificationForTokenMovement(512);
pub const MDNotifyTypeDef: CorNotificationForTokenMovement = CorNotificationForTokenMovement(16);
pub const MDNotifyTypeRef: CorNotificationForTokenMovement = CorNotificationForTokenMovement(8);
pub const MDNotifyTypeSpec: CorNotificationForTokenMovement = CorNotificationForTokenMovement(1024);
pub const MDParamOutOfOrder: CorErrorIfEmitOutOfOrder = CorErrorIfEmitOutOfOrder(4);
pub const MDPreserveLocalMemberRef: CorLocalRefPreservation = CorLocalRefPreservation(2);
pub const MDPreserveLocalRefsNone: CorLocalRefPreservation = CorLocalRefPreservation(0);
pub const MDPreserveLocalTypeRef: CorLocalRefPreservation = CorLocalRefPreservation(1);
pub const MDPropertyOutOfOrder: CorErrorIfEmitOutOfOrder = CorErrorIfEmitOutOfOrder(8);
pub const MDRefToDefAll: CorRefToDefCheck = CorRefToDefCheck(-1);
pub const MDRefToDefDefault: CorRefToDefCheck = CorRefToDefCheck(3);
pub const MDRefToDefNone: CorRefToDefCheck = CorRefToDefCheck(0);
pub const MDSetENCOff: CorSetENC = CorSetENC(2);
pub const MDSetENCOn: CorSetENC = CorSetENC(1);
pub const MDThreadSafetyDefault: CorThreadSafetyOptions = CorThreadSafetyOptions(0);
pub const MDThreadSafetyOff: CorThreadSafetyOptions = CorThreadSafetyOptions(0);
pub const MDThreadSafetyOn: CorThreadSafetyOptions = CorThreadSafetyOptions(1);
pub const MDTypeRefToDef: CorRefToDefCheck = CorRefToDefCheck(1);
pub const MDUpdateDelta: CorSetENC = CorSetENC(5);
pub const MDUpdateENC: CorSetENC = CorSetENC(1);
pub const MDUpdateExtension: CorSetENC = CorSetENC(3);
pub const MDUpdateFull: CorSetENC = CorSetENC(2);
pub const MDUpdateIncremental: CorSetENC = CorSetENC(4);
pub const MDUpdateMask: CorSetENC = CorSetENC(7);
...
pub const MergeExportedTypes: MergeFlags = MergeFlags(8);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct MergeFlags(pub i32);
pub const MergeFlagsNone: MergeFlags = MergeFlags(0);
pub const MergeManifest: MergeFlags = MergeFlags(1);
...
pub const NATIVE_TYPE_ANSIBSTR: CorNativeType = CorNativeType(35);
pub const NATIVE_TYPE_ARRAY: CorNativeType = CorNativeType(42);
pub const NATIVE_TYPE_ASANY: CorNativeType = CorNativeType(40);
pub const NATIVE_TYPE_BOOLEAN: CorNativeType = CorNativeType(2);
pub const NATIVE_TYPE_BSTR: CorNativeType = CorNativeType(19);
pub const NATIVE_TYPE_BYVALSTR: CorNativeType = CorNativeType(34);
pub const NATIVE_TYPE_CURRENCY: CorNativeType = CorNativeType(15);
pub const NATIVE_TYPE_CUSTOMMARSHALER: CorNativeType = CorNativeType(44);
pub const NATIVE_TYPE_DATE: CorNativeType = CorNativeType(18);
pub const NATIVE_TYPE_DECIMAL: CorNativeType = CorNativeType(17);
pub const NATIVE_TYPE_END: CorNativeType = CorNativeType(0);
pub const NATIVE_TYPE_ERROR: CorNativeType = CorNativeType(45);
pub const NATIVE_TYPE_FIXEDARRAY: CorNativeType = CorNativeType(30);
pub const NATIVE_TYPE_FIXEDSYSSTRING: CorNativeType = CorNativeType(23);
pub const NATIVE_TYPE_FUNC: CorNativeType = CorNativeType(38);
pub const NATIVE_TYPE_HSTRING: CorNativeType = CorNativeType(47);
pub const NATIVE_TYPE_I1: CorNativeType = CorNativeType(3);
pub const NATIVE_TYPE_I2: CorNativeType = CorNativeType(5);
pub const NATIVE_TYPE_I4: CorNativeType = CorNativeType(7);
pub const NATIVE_TYPE_I8: CorNativeType = CorNativeType(9);
pub const NATIVE_TYPE_IDISPATCH: CorNativeType = CorNativeType(26);
pub const NATIVE_TYPE_IINSPECTABLE: CorNativeType = CorNativeType(46);
pub const NATIVE_TYPE_INT: CorNativeType = CorNativeType(31);
pub const NATIVE_TYPE_INTF: CorNativeType = CorNativeType(28);
pub const NATIVE_TYPE_IUNKNOWN: CorNativeType = CorNativeType(25);
pub const NATIVE_TYPE_LPSTR: CorNativeType = CorNativeType(20);
pub const NATIVE_TYPE_LPSTRUCT: CorNativeType = CorNativeType(43);
pub const NATIVE_TYPE_LPTSTR: CorNativeType = CorNativeType(22);
pub const NATIVE_TYPE_LPUTF8STR: CorNativeType = CorNativeType(48);
pub const NATIVE_TYPE_LPWSTR: CorNativeType = CorNativeType(21);
pub const NATIVE_TYPE_MAX: CorNativeType = CorNativeType(80);
pub const NATIVE_TYPE_NESTEDSTRUCT: CorNativeType = CorNativeType(33);
pub const NATIVE_TYPE_OBJECTREF: CorNativeType = CorNativeType(24);
pub const NATIVE_TYPE_PTR: CorNativeType = CorNativeType(16);
pub const NATIVE_TYPE_R4: CorNativeType = CorNativeType(11);
pub const NATIVE_TYPE_R8: CorNativeType = CorNativeType(12);
pub const NATIVE_TYPE_SAFEARRAY: CorNativeType = CorNativeType(29);
pub const NATIVE_TYPE_STRUCT: CorNativeType = CorNativeType(27);
pub const NATIVE_TYPE_SYSCHAR: CorNativeType = CorNativeType(13);
pub const NATIVE_TYPE_TBSTR: CorNativeType = CorNativeType(36);
pub const NATIVE_TYPE_U1: CorNativeType = CorNativeType(4);
pub const NATIVE_TYPE_U2: CorNativeType = CorNativeType(6);
pub const NATIVE_TYPE_U4: CorNativeType = CorNativeType(8);
pub const NATIVE_TYPE_U8: CorNativeType = CorNativeType(10);
pub const NATIVE_TYPE_UINT: CorNativeType = CorNativeType(32);
pub const NATIVE_TYPE_VARIANT: CorNativeType = CorNativeType(14);
pub const NATIVE_TYPE_VARIANTBOOL: CorNativeType = CorNativeType(37);
pub const NATIVE_TYPE_VOID: CorNativeType = CorNativeType(1);
pub const NGenDefault: NGenHintEnum = NGenHintEnum(0);
pub const NGenEager: NGenHintEnum = NGenHintEnum(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NGenHintEnum(pub i32);
pub const NGenLazy: NGenHintEnum = NGenHintEnum(2);
pub const NGenNever: NGenHintEnum = NGenHintEnum(3);
...
pub const NoDupCheck: MergeFlags = MergeFlags(4);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
pub struct OSINFO {
...
pub const SERIALIZATION_TYPE_BOOLEAN: CorSerializationType = CorSerializationType(2);
pub const SERIALIZATION_TYPE_CHAR: CorSerializationType = CorSerializationType(3);
pub const SERIALIZATION_TYPE_ENUM: CorSerializationType = CorSerializationType(85);
pub const SERIALIZATION_TYPE_FIELD: CorSerializationType = CorSerializationType(83);
pub const SERIALIZATION_TYPE_I1: CorSerializationType = CorSerializationType(4);
pub const SERIALIZATION_TYPE_I2: CorSerializationType = CorSerializationType(6);
pub const SERIALIZATION_TYPE_I4: CorSerializationType = CorSerializationType(8);
pub const SERIALIZATION_TYPE_I8: CorSerializationType = CorSerializationType(10);
pub const SERIALIZATION_TYPE_PROPERTY: CorSerializationType = CorSerializationType(84);
pub const SERIALIZATION_TYPE_R4: CorSerializationType = CorSerializationType(12);
pub const SERIALIZATION_TYPE_R8: CorSerializationType = CorSerializationType(13);
pub const SERIALIZATION_TYPE_STRING: CorSerializationType = CorSerializationType(14);
pub const SERIALIZATION_TYPE_SZARRAY: CorSerializationType = CorSerializationType(29);
pub const SERIALIZATION_TYPE_TAGGED_OBJECT: CorSerializationType = CorSerializationType(81);
pub const SERIALIZATION_TYPE_TYPE: CorSerializationType = CorSerializationType(80);
pub const SERIALIZATION_TYPE_U1: CorSerializationType = CorSerializationType(5);
pub const SERIALIZATION_TYPE_U2: CorSerializationType = CorSerializationType(7);
pub const SERIALIZATION_TYPE_U4: CorSerializationType = CorSerializationType(9);
pub const SERIALIZATION_TYPE_U8: CorSerializationType = CorSerializationType(11);
pub const SERIALIZATION_TYPE_UNDEFINED: CorSerializationType = CorSerializationType(0);
pub const SIGN_MASK_FOURBYTE: i32 = -268435456;
pub const SIGN_MASK_ONEBYTE: i32 = -64;
pub const SIGN_MASK_TWOBYTE: i32 = -8192;
...
pub const ValidatorModuleTypeEnc: CorValidatorModuleType = CorValidatorModuleType(3);
pub const ValidatorModuleTypeIncr: CorValidatorModuleType = CorValidatorModuleType(4);
pub const ValidatorModuleTypeInvalid: CorValidatorModuleType = CorValidatorModuleType(0);
pub const ValidatorModuleTypeMax: CorValidatorModuleType = CorValidatorModuleType(4);
pub const ValidatorModuleTypeMin: CorValidatorModuleType = CorValidatorModuleType(1);
pub const ValidatorModuleTypeObj: CorValidatorModuleType = CorValidatorModuleType(2);
pub const ValidatorModuleTypePE: CorValidatorModuleType = CorValidatorModuleType(1);
pub const afContentType_Default: CorAssemblyFlags = CorAssemblyFlags(0);
pub const afContentType_Mask: CorAssemblyFlags = CorAssemblyFlags(3584);
pub const afContentType_WindowsRuntime: CorAssemblyFlags = CorAssemblyFlags(512);
pub const afDisableJITcompileOptimizer: CorAssemblyFlags = CorAssemblyFlags(16384);
pub const afEnableJITcompileTracking: CorAssemblyFlags = CorAssemblyFlags(32768);
pub const afPA_AMD64: CorAssemblyFlags = CorAssemblyFlags(64);
pub const afPA_ARM: CorAssemblyFlags = CorAssemblyFlags(80);
pub const afPA_FullMask: CorAssemblyFlags = CorAssemblyFlags(240);
pub const afPA_IA64: CorAssemblyFlags = CorAssemblyFlags(48);
pub const afPA_MSIL: CorAssemblyFlags = CorAssemblyFlags(16);
pub const afPA_Mask: CorAssemblyFlags = CorAssemblyFlags(112);
pub const afPA_NoPlatform: CorAssemblyFlags = CorAssemblyFlags(112);
pub const afPA_None: CorAssemblyFlags = CorAssemblyFlags(0);
pub const afPA_Shift: CorAssemblyFlags = CorAssemblyFlags(4);
pub const afPA_Specified: CorAssemblyFlags = CorAssemblyFlags(128);
pub const afPA_x86: CorAssemblyFlags = CorAssemblyFlags(32);
pub const afPublicKey: CorAssemblyFlags = CorAssemblyFlags(1);
pub const afRetargetable: CorAssemblyFlags = CorAssemblyFlags(256);
pub const catAll: CorAttributeTargets = CorAttributeTargets(24575);
pub const catAssembly: CorAttributeTargets = CorAttributeTargets(1);
pub const catClass: CorAttributeTargets = CorAttributeTargets(4);
pub const catClassMembers: CorAttributeTargets = CorAttributeTargets(6140);
pub const catConstructor: CorAttributeTargets = CorAttributeTargets(32);
pub const catDelegate: CorAttributeTargets = CorAttributeTargets(4096);
pub const catEnum: CorAttributeTargets = CorAttributeTargets(16);
pub const catEvent: CorAttributeTargets = CorAttributeTargets(512);
pub const catField: CorAttributeTargets = CorAttributeTargets(256);
pub const catGenericParameter: CorAttributeTargets = CorAttributeTargets(16384);
pub const catInterface: CorAttributeTargets = CorAttributeTargets(1024);
pub const catMethod: CorAttributeTargets = CorAttributeTargets(64);
pub const catModule: CorAttributeTargets = CorAttributeTargets(2);
pub const catParameter: CorAttributeTargets = CorAttributeTargets(2048);
pub const catProperty: CorAttributeTargets = CorAttributeTargets(128);
pub const catStruct: CorAttributeTargets = CorAttributeTargets(8);
pub const cssAccurate: CorSaveSize = CorSaveSize(0);
pub const cssDiscardTransientCAs: CorSaveSize = CorSaveSize(2);
pub const cssQuick: CorSaveSize = CorSaveSize(1);
pub const dclActionMask: CorDeclSecurity = CorDeclSecurity(31);
pub const dclActionNil: CorDeclSecurity = CorDeclSecurity(0);
pub const dclAssert: CorDeclSecurity = CorDeclSecurity(3);
pub const dclDemand: CorDeclSecurity = CorDeclSecurity(2);
pub const dclDeny: CorDeclSecurity = CorDeclSecurity(4);
pub const dclInheritanceCheck: CorDeclSecurity = CorDeclSecurity(7);
pub const dclLinktimeCheck: CorDeclSecurity = CorDeclSecurity(6);
pub const dclMaximumValue: CorDeclSecurity = CorDeclSecurity(15);
pub const dclNonCasDemand: CorDeclSecurity = CorDeclSecurity(13);
pub const dclNonCasInheritance: CorDeclSecurity = CorDeclSecurity(15);
pub const dclNonCasLinkDemand: CorDeclSecurity = CorDeclSecurity(14);
pub const dclPermitOnly: CorDeclSecurity = CorDeclSecurity(5);
pub const dclPrejitDenied: CorDeclSecurity = CorDeclSecurity(12);
pub const dclPrejitGrant: CorDeclSecurity = CorDeclSecurity(11);
pub const dclRequest: CorDeclSecurity = CorDeclSecurity(1);
pub const dclRequestMinimum: CorDeclSecurity = CorDeclSecurity(8);
pub const dclRequestOptional: CorDeclSecurity = CorDeclSecurity(9);
pub const dclRequestRefuse: CorDeclSecurity = CorDeclSecurity(10);
pub const evRTSpecialName: CorEventAttr = CorEventAttr(1024);
pub const evReservedMask: CorEventAttr = CorEventAttr(1024);
pub const evSpecialName: CorEventAttr = CorEventAttr(512);
pub const fdAssembly: CorFieldAttr = CorFieldAttr(3);
pub const fdFamANDAssem: CorFieldAttr = CorFieldAttr(2);
pub const fdFamORAssem: CorFieldAttr = CorFieldAttr(5);
pub const fdFamily: CorFieldAttr = CorFieldAttr(4);
pub const fdFieldAccessMask: CorFieldAttr = CorFieldAttr(7);
pub const fdHasDefault: CorFieldAttr = CorFieldAttr(32768);
pub const fdHasFieldMarshal: CorFieldAttr = CorFieldAttr(4096);
pub const fdHasFieldRVA: CorFieldAttr = CorFieldAttr(256);
pub const fdInitOnly: CorFieldAttr = CorFieldAttr(32);
pub const fdLiteral: CorFieldAttr = CorFieldAttr(64);
pub const fdNotSerialized: CorFieldAttr = CorFieldAttr(128);
pub const fdPinvokeImpl: CorFieldAttr = CorFieldAttr(8192);
pub const fdPrivate: CorFieldAttr = CorFieldAttr(1);
pub const fdPrivateScope: CorFieldAttr = CorFieldAttr(0);
pub const fdPublic: CorFieldAttr = CorFieldAttr(6);
pub const fdRTSpecialName: CorFieldAttr = CorFieldAttr(1024);
pub const fdReservedMask: CorFieldAttr = CorFieldAttr(38144);
pub const fdSpecialName: CorFieldAttr = CorFieldAttr(512);
pub const fdStatic: CorFieldAttr = CorFieldAttr(16);
pub const ffContainsMetaData: CorFileFlags = CorFileFlags(0);
pub const ffContainsNoMetaData: CorFileFlags = CorFileFlags(1);
pub const fmExecutableImage: CorFileMapping = CorFileMapping(1);
pub const fmFlat: CorFileMapping = CorFileMapping(0);
pub const gpContravariant: CorGenericParamAttr = CorGenericParamAttr(2);
pub const gpCovariant: CorGenericParamAttr = CorGenericParamAttr(1);
pub const gpDefaultConstructorConstraint: CorGenericParamAttr = CorGenericParamAttr(16);
pub const gpNoSpecialConstraint: CorGenericParamAttr = CorGenericParamAttr(0);
pub const gpNonVariant: CorGenericParamAttr = CorGenericParamAttr(0);
pub const gpNotNullableValueTypeConstraint: CorGenericParamAttr = CorGenericParamAttr(8);
pub const gpReferenceTypeConstraint: CorGenericParamAttr = CorGenericParamAttr(4);
pub const gpSpecialConstraintMask: CorGenericParamAttr = CorGenericParamAttr(28);
pub const gpVarianceMask: CorGenericParamAttr = CorGenericParamAttr(3);
pub const mdAbstract: CorMethodAttr = CorMethodAttr(1024);
pub const mdAssem: CorMethodAttr = CorMethodAttr(3);
pub const mdCheckAccessOnOverride: CorMethodAttr = CorMethodAttr(512);
pub const mdFamANDAssem: CorMethodAttr = CorMethodAttr(2);
pub const mdFamORAssem: CorMethodAttr = CorMethodAttr(5);
pub const mdFamily: CorMethodAttr = CorMethodAttr(4);
pub const mdFinal: CorMethodAttr = CorMethodAttr(32);
pub const mdHasSecurity: CorMethodAttr = CorMethodAttr(16384);
pub const mdHideBySig: CorMethodAttr = CorMethodAttr(128);
pub const mdMemberAccessMask: CorMethodAttr = CorMethodAttr(7);
pub const mdNewSlot: CorMethodAttr = CorMethodAttr(256);
pub const mdPinvokeImpl: CorMethodAttr = CorMethodAttr(8192);
pub const mdPrivate: CorMethodAttr = CorMethodAttr(1);
pub const mdPrivateScope: CorMethodAttr = CorMethodAttr(0);
pub const mdPublic: CorMethodAttr = CorMethodAttr(6);
pub const mdRTSpecialName: CorMethodAttr = CorMethodAttr(4096);
pub const mdRequireSecObject: CorMethodAttr = CorMethodAttr(32768);
pub const mdReservedMask: CorMethodAttr = CorMethodAttr(53248);
pub const mdReuseSlot: CorMethodAttr = CorMethodAttr(0);
pub const mdSpecialName: CorMethodAttr = CorMethodAttr(2048);
pub const mdStatic: CorMethodAttr = CorMethodAttr(16);
pub const mdUnmanagedExport: CorMethodAttr = CorMethodAttr(8);
pub const mdVirtual: CorMethodAttr = CorMethodAttr(64);
pub const mdVtableLayoutMask: CorMethodAttr = CorMethodAttr(256);
pub const mdtAssembly: CorTokenType = CorTokenType(536870912);
pub const mdtAssemblyRef: CorTokenType = CorTokenType(587202560);
pub const mdtBaseType: CorTokenType = CorTokenType(1912602624);
pub const mdtCustomAttribute: CorTokenType = CorTokenType(201326592);
pub const mdtEvent: CorTokenType = CorTokenType(335544320);
pub const mdtExportedType: CorTokenType = CorTokenType(654311424);
pub const mdtFieldDef: CorTokenType = CorTokenType(67108864);
pub const mdtFile: CorTokenType = CorTokenType(637534208);
pub const mdtGenericParam: CorTokenType = CorTokenType(704643072);
pub const mdtGenericParamConstraint: CorTokenType = CorTokenType(738197504);
pub const mdtInterfaceImpl: CorTokenType = CorTokenType(150994944);
pub const mdtManifestResource: CorTokenType = CorTokenType(671088640);
pub const mdtMemberRef: CorTokenType = CorTokenType(167772160);
pub const mdtMethodDef: CorTokenType = CorTokenType(100663296);
pub const mdtMethodImpl: CorTokenType = CorTokenType(419430400);
pub const mdtMethodSpec: CorTokenType = CorTokenType(721420288);
pub const mdtModule: CorTokenType = CorTokenType(0);
pub const mdtModuleRef: CorTokenType = CorTokenType(436207616);
pub const mdtName: CorTokenType = CorTokenType(1895825408);
pub const mdtParamDef: CorTokenType = CorTokenType(134217728);
pub const mdtPermission: CorTokenType = CorTokenType(234881024);
pub const mdtProperty: CorTokenType = CorTokenType(385875968);
pub const mdtSignature: CorTokenType = CorTokenType(285212672);
pub const mdtString: CorTokenType = CorTokenType(1879048192);
pub const mdtTypeDef: CorTokenType = CorTokenType(33554432);
pub const mdtTypeRef: CorTokenType = CorTokenType(16777216);
pub const mdtTypeSpec: CorTokenType = CorTokenType(452984832);
pub const miAggressiveInlining: CorMethodImpl = CorMethodImpl(256);
pub const miCodeTypeMask: CorMethodImpl = CorMethodImpl(3);
pub const miForwardRef: CorMethodImpl = CorMethodImpl(16);
pub const miIL: CorMethodImpl = CorMethodImpl(0);
pub const miInternalCall: CorMethodImpl = CorMethodImpl(4096);
pub const miManaged: CorMethodImpl = CorMethodImpl(0);
pub const miManagedMask: CorMethodImpl = CorMethodImpl(4);
pub const miMaxMethodImplVal: CorMethodImpl = CorMethodImpl(65535);
pub const miNative: CorMethodImpl = CorMethodImpl(1);
pub const miNoInlining: CorMethodImpl = CorMethodImpl(8);
pub const miNoOptimization: CorMethodImpl = CorMethodImpl(64);
pub const miOPTIL: CorMethodImpl = CorMethodImpl(2);
pub const miPreserveSig: CorMethodImpl = CorMethodImpl(128);
pub const miRuntime: CorMethodImpl = CorMethodImpl(3);
pub const miSecurityMitigations: CorMethodImpl = CorMethodImpl(1024);
pub const miSynchronized: CorMethodImpl = CorMethodImpl(32);
pub const miUnmanaged: CorMethodImpl = CorMethodImpl(4);
pub const miUserMask: CorMethodImpl = CorMethodImpl(5628);
pub const mrPrivate: CorManifestResourceFlags = CorManifestResourceFlags(2);
pub const mrPublic: CorManifestResourceFlags = CorManifestResourceFlags(1);
pub const mrVisibilityMask: CorManifestResourceFlags = CorManifestResourceFlags(7);
pub const msAddOn: CorMethodSemanticsAttr = CorMethodSemanticsAttr(8);
pub const msFire: CorMethodSemanticsAttr = CorMethodSemanticsAttr(32);
pub const msGetter: CorMethodSemanticsAttr = CorMethodSemanticsAttr(2);
pub const msOther: CorMethodSemanticsAttr = CorMethodSemanticsAttr(4);
pub const msRemoveOn: CorMethodSemanticsAttr = CorMethodSemanticsAttr(16);
pub const msSetter: CorMethodSemanticsAttr = CorMethodSemanticsAttr(1);
pub const nlfLastError: CorNativeLinkFlags = CorNativeLinkFlags(1);
pub const nlfMaxValue: CorNativeLinkFlags = CorNativeLinkFlags(3);
pub const nlfNoMangle: CorNativeLinkFlags = CorNativeLinkFlags(2);
pub const nlfNone: CorNativeLinkFlags = CorNativeLinkFlags(0);
pub const nltAnsi: CorNativeLinkType = CorNativeLinkType(2);
pub const nltAuto: CorNativeLinkType = CorNativeLinkType(4);
pub const nltMaxValue: CorNativeLinkType = CorNativeLinkType(7);
pub const nltNone: CorNativeLinkType = CorNativeLinkType(1);
pub const nltOle: CorNativeLinkType = CorNativeLinkType(5);
pub const nltUnicode: CorNativeLinkType = CorNativeLinkType(3);
pub const ntaReserved: NativeTypeArrayFlags = NativeTypeArrayFlags(65534);
pub const ntaSizeParamIndexSpecified: NativeTypeArrayFlags = NativeTypeArrayFlags(1);
pub const ofCheckIntegrity: CorOpenFlags = CorOpenFlags(2048);
pub const ofCopyMemory: CorOpenFlags = CorOpenFlags(2);
pub const ofNoTransform: CorOpenFlags = CorOpenFlags(4096);
pub const ofNoTypeLib: CorOpenFlags = CorOpenFlags(128);
pub const ofRead: CorOpenFlags = CorOpenFlags(0);
pub const ofReadOnly: CorOpenFlags = CorOpenFlags(16);
pub const ofReadWriteMask: CorOpenFlags = CorOpenFlags(1);
pub const ofReserved: CorOpenFlags = CorOpenFlags(-6336);
pub const ofReserved1: CorOpenFlags = CorOpenFlags(256);
pub const ofReserved2: CorOpenFlags = CorOpenFlags(512);
pub const ofReserved3: CorOpenFlags = CorOpenFlags(1024);
pub const ofTakeOwnership: CorOpenFlags = CorOpenFlags(32);
pub const ofWrite: CorOpenFlags = CorOpenFlags(1);
pub const pdHasDefault: CorParamAttr = CorParamAttr(4096);
pub const pdHasFieldMarshal: CorParamAttr = CorParamAttr(8192);
pub const pdIn: CorParamAttr = CorParamAttr(1);
pub const pdOptional: CorParamAttr = CorParamAttr(16);
pub const pdOut: CorParamAttr = CorParamAttr(2);
pub const pdReservedMask: CorParamAttr = CorParamAttr(61440);
pub const pdUnused: CorParamAttr = CorParamAttr(53216);
pub const pe32BitPreferred: CorPEKind = CorPEKind(16);
pub const pe32BitRequired: CorPEKind = CorPEKind(2);
pub const pe32Plus: CorPEKind = CorPEKind(4);
pub const pe32Unmanaged: CorPEKind = CorPEKind(8);
pub const peILonly: CorPEKind = CorPEKind(1);
pub const peNot: CorPEKind = CorPEKind(0);
pub const pmBestFitDisabled: CorPinvokeMap = CorPinvokeMap(32);
pub const pmBestFitEnabled: CorPinvokeMap = CorPinvokeMap(16);
pub const pmBestFitMask: CorPinvokeMap = CorPinvokeMap(48);
pub const pmBestFitUseAssem: CorPinvokeMap = CorPinvokeMap(0);
pub const pmCallConvCdecl: CorPinvokeMap = CorPinvokeMap(512);
pub const pmCallConvFastcall: CorPinvokeMap = CorPinvokeMap(1280);
pub const pmCallConvMask: CorPinvokeMap = CorPinvokeMap(1792);
pub const pmCallConvStdcall: CorPinvokeMap = CorPinvokeMap(768);
pub const pmCallConvThiscall: CorPinvokeMap = CorPinvokeMap(1024);
pub const pmCallConvWinapi: CorPinvokeMap = CorPinvokeMap(256);
pub const pmCharSetAnsi: CorPinvokeMap = CorPinvokeMap(2);
pub const pmCharSetAuto: CorPinvokeMap = CorPinvokeMap(6);
pub const pmCharSetMask: CorPinvokeMap = CorPinvokeMap(6);
pub const pmCharSetNotSpec: CorPinvokeMap = CorPinvokeMap(0);
pub const pmCharSetUnicode: CorPinvokeMap = CorPinvokeMap(4);
pub const pmMaxValue: CorPinvokeMap = CorPinvokeMap(65535);
pub const pmNoMangle: CorPinvokeMap = CorPinvokeMap(1);
pub const pmSupportsLastError: CorPinvokeMap = CorPinvokeMap(64);
pub const pmThrowOnUnmappableCharDisabled: CorPinvokeMap = CorPinvokeMap(8192);
pub const pmThrowOnUnmappableCharEnabled: CorPinvokeMap = CorPinvokeMap(4096);
pub const pmThrowOnUnmappableCharMask: CorPinvokeMap = CorPinvokeMap(12288);
pub const pmThrowOnUnmappableCharUseAssem: CorPinvokeMap = CorPinvokeMap(0);
pub const prHasDefault: CorPropertyAttr = CorPropertyAttr(4096);
pub const prRTSpecialName: CorPropertyAttr = CorPropertyAttr(1024);
pub const prReservedMask: CorPropertyAttr = CorPropertyAttr(62464);
pub const prSpecialName: CorPropertyAttr = CorPropertyAttr(512);
pub const prUnused: CorPropertyAttr = CorPropertyAttr(59903);
pub const regConfig: CorRegFlags = CorRegFlags(2);
pub const regHasRefs: CorRegFlags = CorRegFlags(4);
pub const regNoCopy: CorRegFlags = CorRegFlags(1);
pub const sdExecute: CeeSectionAttr = CeeSectionAttr(1610612768);
pub const sdNone: CeeSectionAttr = CeeSectionAttr(0);
pub const sdReadOnly: CeeSectionAttr = CeeSectionAttr(1073741888);
pub const sdReadWrite: CeeSectionAttr = CeeSectionAttr(3221225536);
pub const srNoBaseReloc: CeeSectionRelocType = CeeSectionRelocType(16384);
pub const srRelocAbsolute: CeeSectionRelocType = CeeSectionRelocType(0);
pub const srRelocAbsolutePtr: CeeSectionRelocType = CeeSectionRelocType(32768);
pub const srRelocAbsoluteTagged: CeeSectionRelocType = CeeSectionRelocType(13);
pub const srRelocCodeRelative: CeeSectionRelocType = CeeSectionRelocType(8);
pub const srRelocDir64: CeeSectionRelocType = CeeSectionRelocType(10);
pub const srRelocDir64Ptr: CeeSectionRelocType = CeeSectionRelocType(32778);
pub const srRelocFilePos: CeeSectionRelocType = CeeSectionRelocType(7);
pub const srRelocHighAdj: CeeSectionRelocType = CeeSectionRelocType(4);
pub const srRelocHighLow: CeeSectionRelocType = CeeSectionRelocType(3);
pub const srRelocHighLowPtr: CeeSectionRelocType = CeeSectionRelocType(32771);
pub const srRelocIA64Imm64: CeeSectionRelocType = CeeSectionRelocType(9);
pub const srRelocIA64Imm64Ptr: CeeSectionRelocType = CeeSectionRelocType(32777);
pub const srRelocIA64PcRel25: CeeSectionRelocType = CeeSectionRelocType(11);
pub const srRelocIA64PcRel64: CeeSectionRelocType = CeeSectionRelocType(12);
pub const srRelocMapToken: CeeSectionRelocType = CeeSectionRelocType(5);
pub const srRelocPtr: CeeSectionRelocType = CeeSectionRelocType(32768);
pub const srRelocRelative: CeeSectionRelocType = CeeSectionRelocType(6);
pub const srRelocRelativePtr: CeeSectionRelocType = CeeSectionRelocType(32774);
pub const srRelocSentinel: CeeSectionRelocType = CeeSectionRelocType(14);
pub const tdAbstract: CorTypeAttr = CorTypeAttr(128);
pub const tdAnsiClass: CorTypeAttr = CorTypeAttr(0);
pub const tdAutoClass: CorTypeAttr = CorTypeAttr(131072);
pub const tdAutoLayout: CorTypeAttr = CorTypeAttr(0);
pub const tdBeforeFieldInit: CorTypeAttr = CorTypeAttr(1048576);
pub const tdClass: CorTypeAttr = CorTypeAttr(0);
pub const tdClassSemanticsMask: CorTypeAttr = CorTypeAttr(32);
pub const tdCustomFormatClass: CorTypeAttr = CorTypeAttr(196608);
pub const tdCustomFormatMask: CorTypeAttr = CorTypeAttr(12582912);
pub const tdExplicitLayout: CorTypeAttr = CorTypeAttr(16);
pub const tdForwarder: CorTypeAttr = CorTypeAttr(2097152);
pub const tdHasSecurity: CorTypeAttr = CorTypeAttr(262144);
pub const tdImport: CorTypeAttr = CorTypeAttr(4096);
pub const tdInterface: CorTypeAttr = CorTypeAttr(32);
pub const tdLayoutMask: CorTypeAttr = CorTypeAttr(24);
pub const tdNestedAssembly: CorTypeAttr = CorTypeAttr(5);
pub const tdNestedFamANDAssem: CorTypeAttr = CorTypeAttr(6);
pub const tdNestedFamORAssem: CorTypeAttr = CorTypeAttr(7);
pub const tdNestedFamily: CorTypeAttr = CorTypeAttr(4);
pub const tdNestedPrivate: CorTypeAttr = CorTypeAttr(3);
pub const tdNestedPublic: CorTypeAttr = CorTypeAttr(2);
pub const tdNotPublic: CorTypeAttr = CorTypeAttr(0);
pub const tdPublic: CorTypeAttr = CorTypeAttr(1);
pub const tdRTSpecialName: CorTypeAttr = CorTypeAttr(2048);
pub const tdReservedMask: CorTypeAttr = CorTypeAttr(264192);
pub const tdSealed: CorTypeAttr = CorTypeAttr(256);
pub const tdSequentialLayout: CorTypeAttr = CorTypeAttr(8);
pub const tdSerializable: CorTypeAttr = CorTypeAttr(8192);
pub const tdSpecialName: CorTypeAttr = CorTypeAttr(1024);
pub const tdStringFormatMask: CorTypeAttr = CorTypeAttr(196608);
pub const tdUnicodeClass: CorTypeAttr = CorTypeAttr(65536);
pub const tdVisibilityMask: CorTypeAttr = CorTypeAttr(7);
pub const tdWindowsRuntime: CorTypeAttr = CorTypeAttr(16384);
