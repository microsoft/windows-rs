...
#[cfg(feature = "Win32_Storage_Xps_Printing")]
pub trait IPrintDocumentPageSource_Impl {
...
impl IPrintDocumentPageSource_Vtbl {
    ...
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IPrintDocumentPageSource_Impl,
    {
...
pub trait IPrintManagerInterop_Impl {
...
impl IPrintManagerInterop_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IPrintManagerInterop_Impl,
    {
...
pub trait IPrintPreviewPageCollection_Impl {
...
impl IPrintPreviewPageCollection_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IPrintPreviewPageCollection_Impl,
    {
...
#[cfg(all(feature = "Win32_Graphics_Printing", feature = "Win32_System_Com"))]
pub trait IPrintWorkflowConfigurationNative_Impl {
...
impl IPrintWorkflowConfigurationNative_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IPrintWorkflowConfigurationNative_Impl,
    {
...
impl IPrintWorkflowObjectModelSourceFileContentNative_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IPrintWorkflowObjectModelSourceFileContentNative_Impl,
    {
...
#[cfg(feature = "Win32_Storage_Xps")]
pub trait IPrintWorkflowXpsObjectModelTargetPackageNative_Impl {
...
impl IPrintWorkflowXpsObjectModelTargetPackageNative_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IPrintWorkflowXpsObjectModelTargetPackageNative_Impl,
    {
...
pub trait IPrintWorkflowXpsReceiver_Impl {
...
impl IPrintWorkflowXpsReceiver_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IPrintWorkflowXpsReceiver_Impl,
    {
...
impl IPrintWorkflowXpsReceiver2_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IPrintWorkflowXpsReceiver2_Impl,
    {
...
pub trait IPrinting3DManagerInterop_Impl {
    fn GetForWindow(&self, appwindow: super::super::super::Foundation::HWND, riid: *const windows_core::GUID, printmanager: *mut *mut core::ffi::c_void) -> windows_core::Result<()>;
    fn ShowPrintUIForWindowAsync(&self, appwindow: super::super::super::Foundation::HWND, riid: *const windows_core::GUID, asyncoperation: *mut *mut core::ffi::c_void) -> windows_core::Result<()>;
}
impl IPrinting3DManagerInterop_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IPrinting3DManagerInterop_Impl,
    {
        unsafe extern "system" fn GetForWindow<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, appwindow: super::super::super::Foundation::HWND, riid: *const windows_core::GUID, printmanager: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IPrinting3DManagerInterop_Impl,
