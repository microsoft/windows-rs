...
impl IPrintDocumentPageSource {
    ...
    pub unsafe fn GetPreviewPageCollection<P0>(&self, docpackagetarget: P0) -> windows_result::Result<IPrintPreviewPageCollection>
    where
    ...
    #[cfg(feature = "Win32_Storage_Xps_Printing")]
    pub unsafe fn MakeDocument<P0, P1>(&self, printtaskoptions: P0, docpackagetarget: P1) -> windows_result::Result<()>
    where
...
pub trait IPrintDocumentPageSource_Impl: windows_core::IUnknownImpl {
    fn GetPreviewPageCollection(&self, docpackagetarget: windows_core::Ref<super::super::super::Storage::Xps::Printing::IPrintDocumentPackageTarget>) -> windows_result::Result<IPrintPreviewPageCollection>;
    fn MakeDocument(&self, printtaskoptions: windows_core::Ref<windows_core::IInspectable>, docpackagetarget: windows_core::Ref<super::super::super::Storage::Xps::Printing::IPrintDocumentPackageTarget>) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Storage_Xps_Printing")]
...
impl IPrintManagerInterop {
    ...
    pub unsafe fn ShowPrintUIForWindowAsync<T>(&self, appwindow: super::super::super::Foundation::HWND) -> windows_result::Result<T>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
...
pub trait IPrintManagerInterop_Impl: windows_core::IUnknownImpl {
    fn GetForWindow(&self, appwindow: super::super::super::Foundation::HWND, riid: *const windows_core::GUID, printmanager: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn ShowPrintUIForWindowAsync(&self, appwindow: super::super::super::Foundation::HWND, riid: *const windows_core::GUID, asyncoperation: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
}
...
impl IPrintPreviewPageCollection {
    pub unsafe fn Paginate<P1>(&self, currentjobpage: u32, printtaskoptions: P1) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn MakePage(&self, desiredjobpage: u32, width: f32, height: f32) -> windows_result::Result<()> {
...
pub trait IPrintPreviewPageCollection_Impl: windows_core::IUnknownImpl {
    fn Paginate(&self, currentjobpage: u32, printtaskoptions: windows_core::Ref<windows_core::IInspectable>) -> windows_result::Result<()>;
    fn MakePage(&self, desiredjobpage: u32, width: f32, height: f32) -> windows_result::Result<()>;
}
...
impl IPrintWorkflowConfigurationNative {
    ...
    pub unsafe fn PrinterQueue(&self) -> windows_result::Result<super::super::super::Graphics::Printing::IPrinterQueue> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_Graphics_Printing", feature = "Win32_System_Com"))]
    pub unsafe fn DriverProperties(&self) -> windows_result::Result<super::super::super::Graphics::Printing::IPrinterPropertyBag> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_Graphics_Printing", feature = "Win32_System_Com"))]
    pub unsafe fn UserProperties(&self) -> windows_result::Result<super::super::super::Graphics::Printing::IPrinterPropertyBag> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPrintWorkflowConfigurationNative_Impl: windows_core::IUnknownImpl {
    fn PrinterQueue(&self) -> windows_result::Result<super::super::super::Graphics::Printing::IPrinterQueue>;
    fn DriverProperties(&self) -> windows_result::Result<super::super::super::Graphics::Printing::IPrinterPropertyBag>;
    fn UserProperties(&self) -> windows_result::Result<super::super::super::Graphics::Printing::IPrinterPropertyBag>;
}
#[cfg(all(feature = "Win32_Graphics_Printing", feature = "Win32_System_Com"))]
...
impl IPrintWorkflowObjectModelSourceFileContentNative {
    pub unsafe fn StartXpsOMGeneration<P0>(&self, receiver: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn ObjectFactory(&self) -> windows_result::Result<super::super::super::Storage::Xps::IXpsOMObjectFactory1> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPrintWorkflowObjectModelSourceFileContentNative_Impl: windows_core::IUnknownImpl {
    fn StartXpsOMGeneration(&self, receiver: windows_core::Ref<IPrintWorkflowXpsReceiver>) -> windows_result::Result<()>;
    fn ObjectFactory(&self) -> windows_result::Result<super::super::super::Storage::Xps::IXpsOMObjectFactory1>;
}
#[cfg(feature = "Win32_Storage_Xps")]
...
impl IPrintWorkflowXpsObjectModelTargetPackageNative {
    #[cfg(feature = "Win32_Storage_Xps")]
    pub unsafe fn DocumentPackageTarget(&self) -> windows_result::Result<super::super::super::Storage::Xps::IXpsDocumentPackageTarget> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPrintWorkflowXpsObjectModelTargetPackageNative_Impl: windows_core::IUnknownImpl {
    fn DocumentPackageTarget(&self) -> windows_result::Result<super::super::super::Storage::Xps::IXpsDocumentPackageTarget>;
}
#[cfg(feature = "Win32_Storage_Xps")]
...
impl IPrintWorkflowXpsReceiver {
    ...
    pub unsafe fn SetDocumentSequencePrintTicket<P0>(&self, documentsequenceprintticket: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn SetDocumentSequenceUri<P0>(&self, documentsequenceuri: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn AddDocumentData<P1, P2>(&self, documentid: u32, documentprintticket: P1, documenturi: P2) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Win32_Storage_Xps")]
    pub unsafe fn AddPage<P2, P3>(&self, documentid: u32, pageid: u32, pagereference: P2, pageuri: P3) -> windows_result::Result<()>
    where
...
pub trait IPrintWorkflowXpsReceiver_Impl: windows_core::IUnknownImpl {
    fn SetDocumentSequencePrintTicket(&self, documentsequenceprintticket: windows_core::Ref<super::super::Com::IStream>) -> windows_result::Result<()>;
    fn SetDocumentSequenceUri(&self, documentsequenceuri: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn AddDocumentData(&self, documentid: u32, documentprintticket: windows_core::Ref<super::super::Com::IStream>, documenturi: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn AddPage(&self, documentid: u32, pageid: u32, pagereference: windows_core::Ref<super::super::super::Storage::Xps::IXpsOMPageReference>, pageuri: &windows_core::PCWSTR) -> windows_result::Result<()>;
...
impl IPrintWorkflowXpsReceiver2 {
    pub unsafe fn Failed(&self, xpserror: windows_core::HRESULT) -> windows_result::Result<()> {
...
pub trait IPrintWorkflowXpsReceiver2_Impl: IPrintWorkflowXpsReceiver_Impl {
    fn Failed(&self, xpserror: windows_core::HRESULT) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_Storage_Xps", feature = "Win32_System_Com"))]
