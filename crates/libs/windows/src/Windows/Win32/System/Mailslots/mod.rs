    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    let result__ = CreateMailslotA(lpname.param().abi(), nmaxmessagesize, lreadtimeout, core::mem::transmute(lpsecurityattributes.unwrap_or(core::mem::zeroed())));
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    let result__ = CreateMailslotW(lpname.param().abi(), nmaxmessagesize, lreadtimeout, core::mem::transmute(lpsecurityattributes.unwrap_or(core::mem::zeroed())));
    (!result__.is_invalid()).then_some(result__).ok_or_else(windows_core::Error::from_win32)
}
#[inline]
pub unsafe fn GetMailslotInfo(hmailslot: super::super::Foundation::HANDLE, lpmaxmessagesize: Option<*mut u32>, lpnextsize: Option<*mut u32>, lpmessagecount: Option<*mut u32>, lpreadtimeout: Option<*mut u32>) -> windows_core::Result<()> {
    ...
    GetMailslotInfo(hmailslot, core::mem::transmute(lpmaxmessagesize.unwrap_or(core::mem::zeroed())), core::mem::transmute(lpnextsize.unwrap_or(core::mem::zeroed())), core::mem::transmute(lpmessagecount.unwrap_or(core::mem::zeroed())), core::mem::transmute(lpreadtimeout.unwrap_or(core::mem::zeroed()))).ok()
}
#[inline]
pub unsafe fn SetMailslotInfo(hmailslot: super::super::Foundation::HANDLE, lreadtimeout: u32) -> windows_core::Result<()> {
    ...
    SetMailslotInfo(hmailslot, lreadtimeout).ok()
}
