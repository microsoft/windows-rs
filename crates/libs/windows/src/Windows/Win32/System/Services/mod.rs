...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
#[inline]
pub unsafe fn GetServiceDisplayNameA<P0, P1>(hscmanager: P0, lpservicename: P1, lpdisplayname: ::windows_core::PSTR, lpcchbuffer: *mut u32) -> super::super::Foundation::BOOL
where
    P0: ::windows_core::IntoParam<super::super::Security::SC_HANDLE>,
    P1: ::windows_core::IntoParam<::windows_core::PCSTR>,
{
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
#[inline]
pub unsafe fn GetServiceDisplayNameW<P0, P1>(hscmanager: P0, lpservicename: P1, lpdisplayname: ::windows_core::PWSTR, lpcchbuffer: *mut u32) -> super::super::Foundation::BOOL
where
    P0: ::windows_core::IntoParam<super::super::Security::SC_HANDLE>,
    P1: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
#[inline]
pub unsafe fn GetServiceKeyNameA<P0, P1>(hscmanager: P0, lpdisplayname: P1, lpservicename: ::windows_core::PSTR, lpcchbuffer: *mut u32) -> super::super::Foundation::BOOL
where
    P0: ::windows_core::IntoParam<super::super::Security::SC_HANDLE>,
    P1: ::windows_core::IntoParam<::windows_core::PCSTR>,
{
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
#[inline]
pub unsafe fn GetServiceKeyNameW<P0, P1>(hscmanager: P0, lpdisplayname: P1, lpservicename: ::windows_core::PWSTR, lpcchbuffer: *mut u32) -> super::super::Foundation::BOOL
where
    P0: ::windows_core::IntoParam<super::super::Security::SC_HANDLE>,
    P1: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
#[inline]
pub unsafe fn StartServiceA<P0>(hservice: P0, lpserviceargvectors: ::core::option::Option<&[::windows_core::PCSTR]>) -> super::super::Foundation::BOOL
where
    P0: ::windows_core::IntoParam<super::super::Security::SC_HANDLE>,
{
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
#[inline]
pub unsafe fn StartServiceW<P0>(hservice: P0, lpserviceargvectors: ::core::option::Option<&[::windows_core::PCWSTR]>) -> super::super::Foundation::BOOL
where
    P0: ::windows_core::IntoParam<super::super::Security::SC_HANDLE>,
{
