...
#[doc = "*Required features: 'Win32_System_Services'*"]
#[inline]
pub unsafe fn GetServiceDirectory<'a, Param0: ::windows::core::IntoParam<'a, SERVICE_STATUS_HANDLE>>(hservicestatus: Param0, edirectorytype: SERVICE_DIRECTORY_TYPE, lppathbuffer: ::core::option::Option<&mut [u16]>, lpcchrequiredbufferlength: *mut u32) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
        ...
        ::core::mem::transmute(GetServiceDirectory(hservicestatus.into_param().abi(), ::core::mem::transmute(edirectorytype), ::core::mem::transmute(lppathbuffer.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), lppathbuffer.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(lpcchrequiredbufferlength)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn GetSharedServiceDirectory<'a, Param0: ::windows::core::IntoParam<'a, super::super::Security::SC_HANDLE>>(servicehandle: Param0, directorytype: SERVICE_SHARED_DIRECTORY_TYPE, pathbuffer: ::core::option::Option<&mut [u16]>, requiredbufferlength: *mut u32) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
        ...
        ::core::mem::transmute(GetSharedServiceDirectory(servicehandle.into_param().abi(), ::core::mem::transmute(directorytype), ::core::mem::transmute(pathbuffer.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), pathbuffer.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(requiredbufferlength)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
#[inline]
pub unsafe fn StartServiceA<'a, Param0: ::windows::core::IntoParam<'a, super::super::Security::SC_HANDLE>>(hservice: Param0, lpserviceargvectors: ::core::option::Option<&[::windows::core::PSTR]>) -> super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
        ...
        ::core::mem::transmute(StartServiceA(hservice.into_param().abi(), lpserviceargvectors.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(lpserviceargvectors.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr()))))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
#[inline]
pub unsafe fn StartServiceW<'a, Param0: ::windows::core::IntoParam<'a, super::super::Security::SC_HANDLE>>(hservice: Param0, lpserviceargvectors: ::core::option::Option<&[::windows::core::PWSTR]>) -> super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
        ...
        ::core::mem::transmute(StartServiceW(hservice.into_param().abi(), lpserviceargvectors.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(lpserviceargvectors.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr()))))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
