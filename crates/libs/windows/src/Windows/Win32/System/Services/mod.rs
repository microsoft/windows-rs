#[inline]
pub unsafe fn ChangeServiceConfig2A(hservice: SC_HANDLE, dwinfolevel: SERVICE_CONFIG, lpinfo: *const core::ffi::c_void) -> windows_core::BOOL {
    ...
    P10: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { ChangeServiceConfigA(hservice, dwservicetype, dwstarttype, dwerrorcontrol, lpbinarypathname.param().abi(), lploadordergroup.param().abi(), lpdwtagid as _, lpdependencies.param().abi(), lpservicestartname.param().abi(), lppassword.param().abi(), lpdisplayname.param().abi()) }
}
#[inline]
    ...
    P10: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { ChangeServiceConfigW(hservice, dwservicetype, dwstarttype, dwerrorcontrol, lpbinarypathname.param().abi(), lploadordergroup.param().abi(), lpdwtagid as _, lpdependencies.param().abi(), lpservicestartname.param().abi(), lppassword.param().abi(), lpdisplayname.param().abi()) }
}
#[inline]
    ...
    P12: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { CreateServiceA(hscmanager, lpservicename.param().abi(), lpdisplayname.param().abi(), dwdesiredaccess, dwservicetype, dwstarttype, dwerrorcontrol, lpbinarypathname.param().abi(), lploadordergroup.param().abi(), lpdwtagid as _, lpdependencies.param().abi(), lpservicestartname.param().abi(), lppassword.param().abi()) }
}
#[inline]
    ...
    P12: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { CreateServiceW(hscmanager, lpservicename.param().abi(), lpdisplayname.param().abi(), dwdesiredaccess, dwservicetype, dwstarttype, dwerrorcontrol, lpbinarypathname.param().abi(), lploadordergroup.param().abi(), lpdwtagid as _, lpdependencies.param().abi(), lpservicestartname.param().abi(), lppassword.param().abi()) }
}
#[inline]
...
#[inline]
pub unsafe fn EnumDependentServicesA(hservice: SC_HANDLE, dwservicestate: ENUM_SERVICE_STATE, lpservices: *mut ENUM_SERVICE_STATUSA, cbbufsize: u32, pcbbytesneeded: *mut u32, lpservicesreturned: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { EnumDependentServicesA(hservice, dwservicestate, lpservices as _, cbbufsize, pcbbytesneeded as _, lpservicesreturned as _) }
}
#[inline]
pub unsafe fn EnumDependentServicesW(hservice: SC_HANDLE, dwservicestate: ENUM_SERVICE_STATE, lpservices: *mut ENUM_SERVICE_STATUSW, cbbufsize: u32, pcbbytesneeded: *mut u32, lpservicesreturned: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { EnumDependentServicesW(hservice, dwservicestate, lpservices as _, cbbufsize, pcbbytesneeded as _, lpservicesreturned as _) }
}
#[inline]
pub unsafe fn EnumServicesStatusA(hscmanager: SC_HANDLE, dwservicetype: ENUM_SERVICE_TYPE, dwservicestate: ENUM_SERVICE_STATE, lpservices: *mut ENUM_SERVICE_STATUSA, cbbufsize: u32, pcbbytesneeded: *mut u32, lpservicesreturned: *mut u32, lpresumehandle: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { EnumServicesStatusA(hscmanager, dwservicetype, dwservicestate, lpservices as _, cbbufsize, pcbbytesneeded as _, lpservicesreturned as _, lpresumehandle as _) }
}
#[inline]
pub unsafe fn EnumServicesStatusExA<P9>(hscmanager: SC_HANDLE, infolevel: SC_ENUM_TYPE, dwservicetype: ENUM_SERVICE_TYPE, dwservicestate: ENUM_SERVICE_STATE, lpservices: *mut u8, cbbufsize: u32, pcbbytesneeded: *mut u32, lpservicesreturned: *mut u32, lpresumehandle: *mut u32, pszgroupname: P9) -> windows_core::BOOL
where
    P9: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { EnumServicesStatusExA(hscmanager, infolevel, dwservicetype, dwservicestate, lpservices as _, cbbufsize, pcbbytesneeded as _, lpservicesreturned as _, lpresumehandle as _, pszgroupname.param().abi()) }
}
#[inline]
pub unsafe fn EnumServicesStatusExW<P9>(hscmanager: SC_HANDLE, infolevel: SC_ENUM_TYPE, dwservicetype: ENUM_SERVICE_TYPE, dwservicestate: ENUM_SERVICE_STATE, lpservices: *mut u8, cbbufsize: u32, pcbbytesneeded: *mut u32, lpservicesreturned: *mut u32, lpresumehandle: *mut u32, pszgroupname: P9) -> windows_core::BOOL
where
    P9: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { EnumServicesStatusExW(hscmanager, infolevel, dwservicetype, dwservicestate, lpservices as _, cbbufsize, pcbbytesneeded as _, lpservicesreturned as _, lpresumehandle as _, pszgroupname.param().abi()) }
}
#[inline]
pub unsafe fn EnumServicesStatusW(hscmanager: SC_HANDLE, dwservicetype: ENUM_SERVICE_TYPE, dwservicestate: ENUM_SERVICE_STATE, lpservices: *mut ENUM_SERVICE_STATUSW, cbbufsize: u32, pcbbytesneeded: *mut u32, lpservicesreturned: *mut u32, lpresumehandle: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { EnumServicesStatusW(hscmanager, dwservicetype, dwservicestate, lpservices as _, cbbufsize, pcbbytesneeded as _, lpservicesreturned as _, lpresumehandle as _) }
}
#[inline]
pub unsafe fn GetServiceDirectory(hservicestatus: SERVICE_STATUS_HANDLE, edirectorytype: SERVICE_DIRECTORY_TYPE, lppathbuffer: windows_core::PWSTR, cchpathbufferlength: u32, lpcchrequiredbufferlength: *mut u32) -> u32 {
...
#[inline]
pub unsafe fn GetSharedServiceDirectory(servicehandle: SC_HANDLE, directorytype: SERVICE_SHARED_DIRECTORY_TYPE, pathbuffer: windows_core::PWSTR, pathbufferlength: u32, requiredbufferlength: *mut u32) -> u32 {
    ...
    unsafe { GetSharedServiceDirectory(servicehandle, directorytype, core::mem::transmute(pathbuffer), pathbufferlength, requiredbufferlength as _) }
}
#[cfg(feature = "Win32_System_Registry")]
#[inline]
...
#[inline]
pub unsafe fn QueryServiceConfig2A(hservice: SC_HANDLE, dwinfolevel: SERVICE_CONFIG, lpbuffer: *mut u8, cbbufsize: u32, pcbbytesneeded: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { QueryServiceConfig2A(hservice, dwinfolevel, lpbuffer as _, cbbufsize, pcbbytesneeded as _) }
}
#[inline]
pub unsafe fn QueryServiceConfig2W(hservice: SC_HANDLE, dwinfolevel: SERVICE_CONFIG, lpbuffer: *mut u8, cbbufsize: u32, pcbbytesneeded: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { QueryServiceConfig2W(hservice, dwinfolevel, lpbuffer as _, cbbufsize, pcbbytesneeded as _) }
}
#[inline]
pub unsafe fn QueryServiceConfigA(hservice: SC_HANDLE, lpserviceconfig: *mut QUERY_SERVICE_CONFIGA, cbbufsize: u32, pcbbytesneeded: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { QueryServiceConfigA(hservice, lpserviceconfig as _, cbbufsize, pcbbytesneeded as _) }
}
#[inline]
pub unsafe fn QueryServiceConfigW(hservice: SC_HANDLE, lpserviceconfig: *mut QUERY_SERVICE_CONFIGW, cbbufsize: u32, pcbbytesneeded: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { QueryServiceConfigW(hservice, lpserviceconfig as _, cbbufsize, pcbbytesneeded as _) }
}
#[inline]
...
#[inline]
pub unsafe fn QueryServiceLockStatusA(hscmanager: SC_HANDLE, lplockstatus: *mut QUERY_SERVICE_LOCK_STATUSA, cbbufsize: u32, pcbbytesneeded: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { QueryServiceLockStatusA(hscmanager, lplockstatus as _, cbbufsize, pcbbytesneeded as _) }
}
#[inline]
pub unsafe fn QueryServiceLockStatusW(hscmanager: SC_HANDLE, lplockstatus: *mut QUERY_SERVICE_LOCK_STATUSW, cbbufsize: u32, pcbbytesneeded: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { QueryServiceLockStatusW(hscmanager, lplockstatus as _, cbbufsize, pcbbytesneeded as _) }
}
...
#[inline]
pub unsafe fn QueryServiceStatusEx(hservice: SC_HANDLE, infolevel: SC_STATUS_TYPE, lpbuffer: *mut u8, cbbufsize: u32, pcbbytesneeded: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { QueryServiceStatusEx(hservice, infolevel, lpbuffer as _, cbbufsize, pcbbytesneeded as _) }
}
#[inline]
...
#[inline]
pub unsafe fn RegisterServiceCtrlHandlerExA<P0>(lpservicename: P0, lphandlerproc: LPHANDLER_FUNCTION_EX, lpcontext: *const core::ffi::c_void) -> SERVICE_STATUS_HANDLE
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
...
#[inline]
pub unsafe fn SetServiceBits(hservicestatus: SERVICE_STATUS_HANDLE, dwservicebits: u32, bsetbitson: bool, bupdateimmediately: bool) -> windows_core::BOOL {
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn SetServiceObjectSecurity(hservice: SC_HANDLE, dwsecurityinformation: super::super::Security::OBJECT_SECURITY_INFORMATION, lpsecuritydescriptor: super::super::Security::PSECURITY_DESCRIPTOR) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn StartServiceW(hservice: SC_HANDLE, dwnumserviceargs: u32, lpserviceargvectors: *const windows_core::PCWSTR) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn WaitServiceState(hservice: SC_HANDLE, dwnotify: u32, dwtimeout: u32, hcancelevent: super::super::Foundation::HANDLE) -> u32 {
    ...
    unsafe { WaitServiceState(hservice, dwnotify, dwtimeout, hcancelevent) }
}
