    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { ApplyPendingSavedStateFileReplayLog(core::mem::transmute_copy(&vmrsfile.param().borrow())).ok() }
}
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { FindSavedStateSymbolFieldInType(vmsavedstatedumphandle as _, vpid, core::mem::transmute_copy(&typename.param().borrow()), core::mem::transmute_copy(&fieldname.param().borrow()), offset as _, found as _).ok() }
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { GetSavedStateSymbolFieldInfo(vmsavedstatedumphandle as _, vpid, core::mem::transmute_copy(&typename.param().borrow()), typefieldinfomap as _).ok() }
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { GetSavedStateSymbolTypeSize(vmsavedstatedumphandle as _, vpid, core::mem::transmute_copy(&typename.param().borrow()), size as _).ok() }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { LoadSavedStateFile(core::mem::transmute_copy(&vmrsfile.param().borrow()), vmsavedstatedumphandle as _).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { LoadSavedStateFiles(core::mem::transmute_copy(&binfile.param().borrow()), core::mem::transmute_copy(&vsvfile.param().borrow()), vmsavedstatedumphandle as _).ok() }
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { LoadSavedStateModuleSymbols(vmsavedstatedumphandle as _, core::mem::transmute_copy(&imagename.param().borrow()), core::mem::transmute_copy(&modulename.param().borrow()), baseaddress, sizeofbase).ok() }
}
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { LoadSavedStateModuleSymbolsEx(vmsavedstatedumphandle as _, core::mem::transmute_copy(&imagename.param().borrow()), imagetimestamp, core::mem::transmute_copy(&modulename.param().borrow()), baseaddress, sizeofbase).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { LoadSavedStateSymbolProvider(vmsavedstatedumphandle as _, core::mem::transmute_copy(&usersymbols.param().borrow()), force.into()).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { LocateSavedStateFiles(core::mem::transmute_copy(&vmname.param().borrow()), core::mem::transmute_copy(&snapshotname.param().borrow()), binpath as _, vsvpath as _, vmrspath as _).ok() }
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { ReadSavedStateGlobalVariable(vmsavedstatedumphandle as _, vpid, core::mem::transmute_copy(&globalname.param().borrow()), buffer as _, buffersize).ok() }
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { ResolveSavedStateGlobalVariableAddress(vmsavedstatedumphandle as _, vpid, core::mem::transmute_copy(&globalname.param().borrow()), virtualaddress as _, size.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
