...
impl AsyncIDebugApplicationNodeEvents {
    pub unsafe fn Begin_onAddChild<P0>(&self, prddpchild: P0) -> windows_result::Result<()>
    where
...
pub trait AsyncIDebugApplicationNodeEvents_Impl: windows_core::IUnknownImpl {
    fn Begin_onAddChild(&self, prddpchild: windows_core::Ref<IDebugApplicationNode>) -> windows_result::Result<()>;
    fn Finish_onAddChild(&self) -> windows_result::Result<()>;
    fn Begin_onRemoveChild(&self, prddpchild: windows_core::Ref<IDebugApplicationNode>) -> windows_result::Result<()>;
    fn Finish_onRemoveChild(&self) -> windows_result::Result<()>;
    fn Begin_onDetach(&self) -> windows_result::Result<()>;
    fn Finish_onDetach(&self) -> windows_result::Result<()>;
    fn Begin_onAttach(&self, prddpparent: windows_core::Ref<IDebugApplicationNode>) -> windows_result::Result<()>;
    fn Finish_onAttach(&self) -> windows_result::Result<()>;
}
...
impl IActiveScript {
    pub unsafe fn SetScriptSite<P0>(&self, pass: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetScriptSite<T>(&self) -> windows_result::Result<T>
    where
    ...
    pub unsafe fn SetScriptState(&self, ss: SCRIPTSTATE) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetScriptState)(windows_core::Interface::as_raw(self), ss).ok() }
    }
    pub unsafe fn GetScriptState(&self) -> windows_result::Result<SCRIPTSTATE> {
        unsafe {
    ...
    pub unsafe fn AddNamedItem<P0>(&self, pstrname: P0, dwflags: u32) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn AddTypeLib(&self, rguidtypelib: *const windows_core::GUID, dwmajor: u32, dwminor: u32, dwflags: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetScriptDispatch<P0>(&self, pstritemname: P0) -> windows_result::Result<super::super::super::Com::IDispatch>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn GetCurrentScriptThreadID(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCurrentScriptThreadID)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetScriptThreadID(&self, dwwin32threadid: u32) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetScriptThreadState(&self, stidthread: u32) -> windows_result::Result<SCRIPTTHREADSTATE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn InterruptScriptThread(&self, stidthread: u32, pexcepinfo: *const super::super::super::Com::EXCEPINFO, dwflags: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IActiveScript> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IActiveScript_Impl: windows_core::IUnknownImpl {
    fn SetScriptSite(&self, pass: windows_core::Ref<IActiveScriptSite>) -> windows_result::Result<()>;
    fn GetScriptSite(&self, riid: *const windows_core::GUID, ppvobject: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn SetScriptState(&self, ss: SCRIPTSTATE) -> windows_result::Result<()>;
    fn GetScriptState(&self) -> windows_result::Result<SCRIPTSTATE>;
    fn Close(&self) -> windows_result::Result<()>;
    fn AddNamedItem(&self, pstrname: &windows_core::PCWSTR, dwflags: u32) -> windows_result::Result<()>;
    fn AddTypeLib(&self, rguidtypelib: *const windows_core::GUID, dwmajor: u32, dwminor: u32, dwflags: u32) -> windows_result::Result<()>;
    fn GetScriptDispatch(&self, pstritemname: &windows_core::PCWSTR) -> windows_result::Result<super::super::super::Com::IDispatch>;
    fn GetCurrentScriptThreadID(&self) -> windows_result::Result<u32>;
    fn GetScriptThreadID(&self, dwwin32threadid: u32) -> windows_result::Result<u32>;
    fn GetScriptThreadState(&self, stidthread: u32) -> windows_result::Result<SCRIPTTHREADSTATE>;
    fn InterruptScriptThread(&self, stidthread: u32, pexcepinfo: *const super::super::super::Com::EXCEPINFO, dwflags: u32) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IActiveScript>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IActiveScriptAuthor {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn AddNamedItem<P0, P2>(&self, pszname: P0, dwflags: u32, pdisp: P2) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn AddScriptlet<P0, P1, P2, P3, P4, P5>(&self, pszdefaultname: P0, pszcode: P1, pszitemname: P2, pszsubitemname: P3, pszeventname: P4, pszdelimiter: P5, dwcookie: u32, dwflags: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn ParseScriptText<P0, P1, P2>(&self, pszcode: P0, pszitemname: P1, pszdelimiter: P2, dwcookie: u32, dwflags: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn GetScriptTextAttributes<P0, P2>(&self, pszcode: P0, cch: u32, pszdelimiter: P2, dwflags: u32, pattr: *mut u16) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetScriptletTextAttributes<P0, P2>(&self, pszcode: P0, cch: u32, pszdelimiter: P2, dwflags: u32, pattr: *mut u16) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetRoot(&self) -> windows_result::Result<IScriptNode> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetLanguageFlags(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetEventHandler<P0, P1, P2, P3>(&self, pdisp: P0, pszitem: P1, pszsubitem: P2, pszevent: P3) -> windows_result::Result<IScriptEntry>
    where
    ...
    pub unsafe fn RemoveNamedItem<P0>(&self, pszname: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn RemoveTypeLib(&self, rguidtypelib: *const windows_core::GUID, dwmajor: u32, dwminor: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetChars(&self, frequestedlist: u32) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetInfoFromContext<P0>(&self, pszcode: P0, cchcode: u32, ichcurrentposition: u32, dwlisttypesrequested: u32, pdwlisttypesprovided: *mut u32, pichlistanchorposition: *mut u32, pichfuncanchorposition: *mut u32, pmemid: *mut i32, picurrentparameter: *mut i32, ppunk: *mut Option<windows_core::IUnknown>) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn IsCommitChar(&self, ch: u16) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IActiveScriptAuthor_Impl: windows_core::IUnknownImpl {
    fn AddNamedItem(&self, pszname: &windows_core::PCWSTR, dwflags: u32, pdisp: windows_core::Ref<super::super::super::Com::IDispatch>) -> windows_result::Result<()>;
    fn AddScriptlet(&self, pszdefaultname: &windows_core::PCWSTR, pszcode: &windows_core::PCWSTR, pszitemname: &windows_core::PCWSTR, pszsubitemname: &windows_core::PCWSTR, pszeventname: &windows_core::PCWSTR, pszdelimiter: &windows_core::PCWSTR, dwcookie: u32, dwflags: u32) -> windows_result::Result<()>;
    fn ParseScriptText(&self, pszcode: &windows_core::PCWSTR, pszitemname: &windows_core::PCWSTR, pszdelimiter: &windows_core::PCWSTR, dwcookie: u32, dwflags: u32) -> windows_result::Result<()>;
    fn GetScriptTextAttributes(&self, pszcode: &windows_core::PCWSTR, cch: u32, pszdelimiter: &windows_core::PCWSTR, dwflags: u32, pattr: *mut u16) -> windows_result::Result<()>;
    fn GetScriptletTextAttributes(&self, pszcode: &windows_core::PCWSTR, cch: u32, pszdelimiter: &windows_core::PCWSTR, dwflags: u32, pattr: *mut u16) -> windows_result::Result<()>;
    fn GetRoot(&self) -> windows_result::Result<IScriptNode>;
    fn GetLanguageFlags(&self) -> windows_result::Result<u32>;
    fn GetEventHandler(&self, pdisp: windows_core::Ref<super::super::super::Com::IDispatch>, pszitem: &windows_core::PCWSTR, pszsubitem: &windows_core::PCWSTR, pszevent: &windows_core::PCWSTR) -> windows_result::Result<IScriptEntry>;
    fn RemoveNamedItem(&self, pszname: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn AddTypeLib(&self, rguidtypelib: *const windows_core::GUID, dwmajor: u32, dwminor: u32, dwflags: u32) -> windows_result::Result<()>;
    fn RemoveTypeLib(&self, rguidtypelib: *const windows_core::GUID, dwmajor: u32, dwminor: u32) -> windows_result::Result<()>;
    fn GetChars(&self, frequestedlist: u32) -> windows_result::Result<windows_core::BSTR>;
    fn GetInfoFromContext(&self, pszcode: &windows_core::PCWSTR, cchcode: u32, ichcurrentposition: u32, dwlisttypesrequested: u32, pdwlisttypesprovided: *mut u32, pichlistanchorposition: *mut u32, pichfuncanchorposition: *mut u32, pmemid: *mut i32, picurrentparameter: *mut i32, ppunk: windows_core::OutRef<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn IsCommitChar(&self, ch: u16) -> windows_result::Result<windows_core::BOOL>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IActiveScriptAuthorProcedure {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn ParseProcedureText<P0, P1, P2, P3, P4, P7>(&self, pszcode: P0, pszformalparams: P1, pszprocedurename: P2, pszitemname: P3, pszdelimiter: P4, dwcookie: u32, dwflags: u32, pdispfor: P7) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IActiveScriptAuthorProcedure_Impl: windows_core::IUnknownImpl {
    fn ParseProcedureText(&self, pszcode: &windows_core::PCWSTR, pszformalparams: &windows_core::PCWSTR, pszprocedurename: &windows_core::PCWSTR, pszitemname: &windows_core::PCWSTR, pszdelimiter: &windows_core::PCWSTR, dwcookie: u32, dwflags: u32, pdispfor: windows_core::Ref<super::super::super::Com::IDispatch>) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IActiveScriptDebug32 {
    pub unsafe fn GetScriptTextAttributes<P0, P2>(&self, pstrcode: P0, unumcodechars: u32, pstrdelimiter: P2, dwflags: u32, pattr: *mut u16) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetScriptletTextAttributes<P0, P2>(&self, pstrcode: P0, unumcodechars: u32, pstrdelimiter: P2, dwflags: u32, pattr: *mut u16) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn EnumCodeContextsOfPosition(&self, dwsourcecontext: u32, ucharacteroffset: u32, unumchars: u32) -> windows_result::Result<IEnumDebugCodeContexts> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IActiveScriptDebug32_Impl: windows_core::IUnknownImpl {
    fn GetScriptTextAttributes(&self, pstrcode: &windows_core::PCWSTR, unumcodechars: u32, pstrdelimiter: &windows_core::PCWSTR, dwflags: u32, pattr: *mut u16) -> windows_result::Result<()>;
    fn GetScriptletTextAttributes(&self, pstrcode: &windows_core::PCWSTR, unumcodechars: u32, pstrdelimiter: &windows_core::PCWSTR, dwflags: u32, pattr: *mut u16) -> windows_result::Result<()>;
    fn EnumCodeContextsOfPosition(&self, dwsourcecontext: u32, ucharacteroffset: u32, unumchars: u32) -> windows_result::Result<IEnumDebugCodeContexts>;
}
...
impl IActiveScriptDebug64 {
    ...
    pub unsafe fn EnumCodeContextsOfPosition(&self, dwsourcecontext: u64, ucharacteroffset: u32, unumchars: u32) -> windows_result::Result<IEnumDebugCodeContexts> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumCodeContextsOfPosition)(windows_core::Interface::as_raw(self), dwsourcecontext, ucharacteroffset, unumchars, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IActiveScriptDebug64_Impl: windows_core::IUnknownImpl {
    fn GetScriptTextAttributes(&self, pstrcode: &windows_core::PCWSTR, unumcodechars: u32, pstrdelimiter: &windows_core::PCWSTR, dwflags: u32, pattr: *mut u16) -> windows_result::Result<()>;
    fn GetScriptletTextAttributes(&self, pstrcode: &windows_core::PCWSTR, unumcodechars: u32, pstrdelimiter: &windows_core::PCWSTR, dwflags: u32, pattr: *mut u16) -> windows_result::Result<()>;
    fn EnumCodeContextsOfPosition(&self, dwsourcecontext: u64, ucharacteroffset: u32, unumchars: u32) -> windows_result::Result<IEnumDebugCodeContexts>;
}
...
impl IActiveScriptEncode {
    pub unsafe fn EncodeSection<P0>(&self, pchin: P0, cchin: u32, pchout: windows_core::PWSTR, cchout: u32, pcchret: *mut u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn DecodeScript<P0>(&self, pchin: P0, cchin: u32, pchout: windows_core::PWSTR, cchout: u32, pcchret: *mut u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetEncodeProgId(&self, pbstrout: *mut windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IActiveScriptEncode_Impl: windows_core::IUnknownImpl {
    fn EncodeSection(&self, pchin: &windows_core::PCWSTR, cchin: u32, pchout: windows_core::PWSTR, cchout: u32, pcchret: *mut u32) -> windows_result::Result<()>;
    fn DecodeScript(&self, pchin: &windows_core::PCWSTR, cchin: u32, pchout: windows_core::PWSTR, cchout: u32, pcchret: *mut u32) -> windows_result::Result<()>;
    fn GetEncodeProgId(&self, pbstrout: *mut windows_core::BSTR) -> windows_result::Result<()>;
}
...
impl IActiveScriptError {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetExceptionInfo(&self, pexcepinfo: *mut super::super::super::Com::EXCEPINFO) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetSourcePosition(&self, pdwsourcecontext: *mut u32, pullinenumber: *mut u32, plcharacterposition: *mut i32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetSourceLineText(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IActiveScriptError_Impl: windows_core::IUnknownImpl {
    fn GetExceptionInfo(&self, pexcepinfo: *mut super::super::super::Com::EXCEPINFO) -> windows_result::Result<()>;
    fn GetSourcePosition(&self, pdwsourcecontext: *mut u32, pullinenumber: *mut u32, plcharacterposition: *mut i32) -> windows_result::Result<()>;
    fn GetSourceLineText(&self) -> windows_result::Result<windows_core::BSTR>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IActiveScriptError64 {
    pub unsafe fn GetSourcePosition64(&self, pdwsourcecontext: *mut u64, pullinenumber: *mut u32, plcharacterposition: *mut i32) -> windows_result::Result<()> {
...
pub trait IActiveScriptError64_Impl: IActiveScriptError_Impl {
    fn GetSourcePosition64(&self, pdwsourcecontext: *mut u64, pullinenumber: *mut u32, plcharacterposition: *mut i32) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IActiveScriptErrorDebug {
    pub unsafe fn GetDocumentContext(&self) -> windows_result::Result<IDebugDocumentContext> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetStackFrame(&self) -> windows_result::Result<IDebugStackFrame> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IActiveScriptErrorDebug_Impl: IActiveScriptError_Impl {
    fn GetDocumentContext(&self) -> windows_result::Result<IDebugDocumentContext>;
    fn GetStackFrame(&self) -> windows_result::Result<IDebugStackFrame>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IActiveScriptErrorDebug110 {
    pub unsafe fn GetExceptionThrownKind(&self) -> windows_result::Result<SCRIPT_ERROR_DEBUG_EXCEPTION_THROWN_KIND> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IActiveScriptErrorDebug110_Impl: windows_core::IUnknownImpl {
    fn GetExceptionThrownKind(&self) -> windows_result::Result<SCRIPT_ERROR_DEBUG_EXCEPTION_THROWN_KIND>;
}
...
impl IActiveScriptGarbageCollector {
    pub unsafe fn CollectGarbage(&self, scriptgctype: SCRIPTGCTYPE) -> windows_result::Result<()> {
...
pub trait IActiveScriptGarbageCollector_Impl: windows_core::IUnknownImpl {
    fn CollectGarbage(&self, scriptgctype: SCRIPTGCTYPE) -> windows_result::Result<()>;
}
...
impl IActiveScriptHostEncode {
    pub unsafe fn EncodeScriptHostFile(&self, bstrinfile: &windows_core::BSTR, pbstroutfile: *mut windows_core::BSTR, cflags: u32, bstrdefaultlang: &windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IActiveScriptHostEncode_Impl: windows_core::IUnknownImpl {
    fn EncodeScriptHostFile(&self, bstrinfile: &windows_core::BSTR, pbstroutfile: *mut windows_core::BSTR, cflags: u32, bstrdefaultlang: &windows_core::BSTR) -> windows_result::Result<()>;
}
...
impl IActiveScriptParse32 {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn AddScriptlet<P0, P1, P2, P3, P4, P5>(&self, pstrdefaultname: P0, pstrcode: P1, pstritemname: P2, pstrsubitemname: P3, pstreventname: P4, pstrdelimiter: P5, dwsourcecontextcookie: u32, ulstartinglinenumber: u32, dwflags: u32, pbstrname: *mut windows_core::BSTR, pexcepinfo: *mut super::super::super::Com::EXCEPINFO) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn ParseScriptText<P0, P1, P2, P3>(&self, pstrcode: P0, pstritemname: P1, punkcontext: P2, pstrdelimiter: P3, dwsourcecontextcookie: u32, ulstartinglinenumber: u32, dwflags: u32, pvarresult: *mut super::super::super::Variant::VARIANT, pexcepinfo: *mut super::super::super::Com::EXCEPINFO) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IActiveScriptParse32_Impl: windows_core::IUnknownImpl {
    ...
    fn AddScriptlet(&self, pstrdefaultname: &windows_core::PCWSTR, pstrcode: &windows_core::PCWSTR, pstritemname: &windows_core::PCWSTR, pstrsubitemname: &windows_core::PCWSTR, pstreventname: &windows_core::PCWSTR, pstrdelimiter: &windows_core::PCWSTR, dwsourcecontextcookie: u32, ulstartinglinenumber: u32, dwflags: u32, pbstrname: *mut windows_core::BSTR, pexcepinfo: *mut super::super::super::Com::EXCEPINFO) -> windows_result::Result<()>;
    fn ParseScriptText(&self, pstrcode: &windows_core::PCWSTR, pstritemname: &windows_core::PCWSTR, punkcontext: windows_core::Ref<windows_core::IUnknown>, pstrdelimiter: &windows_core::PCWSTR, dwsourcecontextcookie: u32, ulstartinglinenumber: u32, dwflags: u32, pvarresult: *mut super::super::super::Variant::VARIANT, pexcepinfo: *mut super::super::super::Com::EXCEPINFO) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IActiveScriptParse64 {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn AddScriptlet<P0, P1, P2, P3, P4, P5>(&self, pstrdefaultname: P0, pstrcode: P1, pstritemname: P2, pstrsubitemname: P3, pstreventname: P4, pstrdelimiter: P5, dwsourcecontextcookie: u64, ulstartinglinenumber: u32, dwflags: u32, pbstrname: *mut windows_core::BSTR, pexcepinfo: *mut super::super::super::Com::EXCEPINFO) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn ParseScriptText<P0, P1, P2, P3>(&self, pstrcode: P0, pstritemname: P1, punkcontext: P2, pstrdelimiter: P3, dwsourcecontextcookie: u64, ulstartinglinenumber: u32, dwflags: u32, pvarresult: *mut super::super::super::Variant::VARIANT, pexcepinfo: *mut super::super::super::Com::EXCEPINFO) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::IUnknown>,
...
pub trait IActiveScriptParse64_Impl: windows_core::IUnknownImpl {
    fn InitNew(&self) -> windows_result::Result<()>;
    fn AddScriptlet(&self, pstrdefaultname: &windows_core::PCWSTR, pstrcode: &windows_core::PCWSTR, pstritemname: &windows_core::PCWSTR, pstrsubitemname: &windows_core::PCWSTR, pstreventname: &windows_core::PCWSTR, pstrdelimiter: &windows_core::PCWSTR, dwsourcecontextcookie: u64, ulstartinglinenumber: u32, dwflags: u32, pbstrname: *mut windows_core::BSTR, pexcepinfo: *mut super::super::super::Com::EXCEPINFO) -> windows_result::Result<()>;
    fn ParseScriptText(&self, pstrcode: &windows_core::PCWSTR, pstritemname: &windows_core::PCWSTR, punkcontext: windows_core::Ref<windows_core::IUnknown>, pstrdelimiter: &windows_core::PCWSTR, dwsourcecontextcookie: u64, ulstartinglinenumber: u32, dwflags: u32, pvarresult: *mut super::super::super::Variant::VARIANT, pexcepinfo: *mut super::super::super::Com::EXCEPINFO) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IActiveScriptParseProcedure32 {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn ParseProcedureText<P0, P1, P2, P3, P4, P5>(&self, pstrcode: P0, pstrformalparams: P1, pstrprocedurename: P2, pstritemname: P3, punkcontext: P4, pstrdelimiter: P5, dwsourcecontextcookie: u32, ulstartinglinenumber: u32, dwflags: u32) -> windows_result::Result<super::super::super::Com::IDispatch>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IActiveScriptParseProcedure32_Impl: windows_core::IUnknownImpl {
    fn ParseProcedureText(&self, pstrcode: &windows_core::PCWSTR, pstrformalparams: &windows_core::PCWSTR, pstrprocedurename: &windows_core::PCWSTR, pstritemname: &windows_core::PCWSTR, punkcontext: windows_core::Ref<windows_core::IUnknown>, pstrdelimiter: &windows_core::PCWSTR, dwsourcecontextcookie: u32, ulstartinglinenumber: u32, dwflags: u32) -> windows_result::Result<super::super::super::Com::IDispatch>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IActiveScriptParseProcedure64 {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn ParseProcedureText<P0, P1, P2, P3, P4, P5>(&self, pstrcode: P0, pstrformalparams: P1, pstrprocedurename: P2, pstritemname: P3, punkcontext: P4, pstrdelimiter: P5, dwsourcecontextcookie: u64, ulstartinglinenumber: u32, dwflags: u32) -> windows_result::Result<super::super::super::Com::IDispatch>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IActiveScriptParseProcedure64_Impl: windows_core::IUnknownImpl {
    fn ParseProcedureText(&self, pstrcode: &windows_core::PCWSTR, pstrformalparams: &windows_core::PCWSTR, pstrprocedurename: &windows_core::PCWSTR, pstritemname: &windows_core::PCWSTR, punkcontext: windows_core::Ref<windows_core::IUnknown>, pstrdelimiter: &windows_core::PCWSTR, dwsourcecontextcookie: u64, ulstartinglinenumber: u32, dwflags: u32) -> windows_result::Result<super::super::super::Com::IDispatch>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IActiveScriptParseProcedureOld32 {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn ParseProcedureText<P0, P1, P2, P3, P4>(&self, pstrcode: P0, pstrformalparams: P1, pstritemname: P2, punkcontext: P3, pstrdelimiter: P4, dwsourcecontextcookie: u32, ulstartinglinenumber: u32, dwflags: u32) -> windows_result::Result<super::super::super::Com::IDispatch>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IActiveScriptParseProcedureOld32_Impl: windows_core::IUnknownImpl {
    fn ParseProcedureText(&self, pstrcode: &windows_core::PCWSTR, pstrformalparams: &windows_core::PCWSTR, pstritemname: &windows_core::PCWSTR, punkcontext: windows_core::Ref<windows_core::IUnknown>, pstrdelimiter: &windows_core::PCWSTR, dwsourcecontextcookie: u32, ulstartinglinenumber: u32, dwflags: u32) -> windows_result::Result<super::super::super::Com::IDispatch>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IActiveScriptParseProcedureOld64 {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn ParseProcedureText<P0, P1, P2, P3, P4>(&self, pstrcode: P0, pstrformalparams: P1, pstritemname: P2, punkcontext: P3, pstrdelimiter: P4, dwsourcecontextcookie: u64, ulstartinglinenumber: u32, dwflags: u32) -> windows_result::Result<super::super::super::Com::IDispatch>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IActiveScriptParseProcedureOld64_Impl: windows_core::IUnknownImpl {
    fn ParseProcedureText(&self, pstrcode: &windows_core::PCWSTR, pstrformalparams: &windows_core::PCWSTR, pstritemname: &windows_core::PCWSTR, punkcontext: windows_core::Ref<windows_core::IUnknown>, pstrdelimiter: &windows_core::PCWSTR, dwsourcecontextcookie: u64, ulstartinglinenumber: u32, dwflags: u32) -> windows_result::Result<super::super::super::Com::IDispatch>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IActiveScriptProfilerCallback {
    pub unsafe fn Initialize(&self, dwcontext: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Initialize)(windows_core::Interface::as_raw(self), dwcontext).ok() }
    }
    pub unsafe fn Shutdown(&self, hrreason: windows_core::HRESULT) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Shutdown)(windows_core::Interface::as_raw(self), hrreason).ok() }
    }
    pub unsafe fn ScriptCompiled<P2>(&self, scriptid: i32, r#type: PROFILER_SCRIPT_TYPE, pidebugdocumentcontext: P2) -> windows_result::Result<()>
    where
        P2: windows_core::Param<windows_core::IUnknown>,
    {
    ...
    pub unsafe fn FunctionCompiled<P2, P3, P4>(&self, functionid: i32, scriptid: i32, pwszfunctionname: P2, pwszfunctionnamehint: P3, pidebugdocumentcontext: P4) -> windows_result::Result<()>
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
        P3: windows_core::Param<windows_core::PCWSTR>,
        P4: windows_core::Param<windows_core::IUnknown>,
    ...
    pub unsafe fn OnFunctionEnter(&self, scriptid: i32, functionid: i32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).OnFunctionEnter)(windows_core::Interface::as_raw(self), scriptid, functionid).ok() }
    }
    pub unsafe fn OnFunctionExit(&self, scriptid: i32, functionid: i32) -> windows_result::Result<()> {
...
pub trait IActiveScriptProfilerCallback_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, dwcontext: u32) -> windows_result::Result<()>;
    fn Shutdown(&self, hrreason: windows_core::HRESULT) -> windows_result::Result<()>;
    fn ScriptCompiled(&self, scriptid: i32, r#type: PROFILER_SCRIPT_TYPE, pidebugdocumentcontext: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn FunctionCompiled(&self, functionid: i32, scriptid: i32, pwszfunctionname: &windows_core::PCWSTR, pwszfunctionnamehint: &windows_core::PCWSTR, pidebugdocumentcontext: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn OnFunctionEnter(&self, scriptid: i32, functionid: i32) -> windows_result::Result<()>;
    fn OnFunctionExit(&self, scriptid: i32, functionid: i32) -> windows_result::Result<()>;
}
...
impl IActiveScriptProfilerCallback2 {
    pub unsafe fn OnFunctionEnterByName<P0>(&self, pwszfunctionname: P0, r#type: PROFILER_SCRIPT_TYPE) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn OnFunctionExitByName<P0>(&self, pwszfunctionname: P0, r#type: PROFILER_SCRIPT_TYPE) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IActiveScriptProfilerCallback2_Impl: IActiveScriptProfilerCallback_Impl {
    fn OnFunctionEnterByName(&self, pwszfunctionname: &windows_core::PCWSTR, r#type: PROFILER_SCRIPT_TYPE) -> windows_result::Result<()>;
    fn OnFunctionExitByName(&self, pwszfunctionname: &windows_core::PCWSTR, r#type: PROFILER_SCRIPT_TYPE) -> windows_result::Result<()>;
}
...
impl IActiveScriptProfilerCallback3 {
    pub unsafe fn SetWebWorkerId(&self, webworkerid: u32) -> windows_result::Result<()> {
...
pub trait IActiveScriptProfilerCallback3_Impl: IActiveScriptProfilerCallback2_Impl {
    fn SetWebWorkerId(&self, webworkerid: u32) -> windows_result::Result<()>;
}
...
impl IActiveScriptProfilerControl {
    pub unsafe fn StartProfiling(&self, clsidprofilerobject: *const windows_core::GUID, dweventmask: u32, dwcontext: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetProfilerEventMask(&self, dweventmask: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetProfilerEventMask)(windows_core::Interface::as_raw(self), dweventmask).ok() }
    }
    pub unsafe fn StopProfiling(&self, hrshutdownreason: windows_core::HRESULT) -> windows_result::Result<()> {
...
pub trait IActiveScriptProfilerControl_Impl: windows_core::IUnknownImpl {
    fn StartProfiling(&self, clsidprofilerobject: *const windows_core::GUID, dweventmask: u32, dwcontext: u32) -> windows_result::Result<()>;
    fn SetProfilerEventMask(&self, dweventmask: u32) -> windows_result::Result<()>;
    fn StopProfiling(&self, hrshutdownreason: windows_core::HRESULT) -> windows_result::Result<()>;
}
...
impl IActiveScriptProfilerControl2 {
    pub unsafe fn CompleteProfilerStart(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).CompleteProfilerStart)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn PrepareProfilerStop(&self) -> windows_result::Result<()> {
...
pub trait IActiveScriptProfilerControl2_Impl: IActiveScriptProfilerControl_Impl {
    fn CompleteProfilerStart(&self) -> windows_result::Result<()>;
    fn PrepareProfilerStop(&self) -> windows_result::Result<()>;
}
...
impl IActiveScriptProfilerControl3 {
    pub unsafe fn EnumHeap(&self) -> windows_result::Result<IActiveScriptProfilerHeapEnum> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IActiveScriptProfilerControl3_Impl: IActiveScriptProfilerControl2_Impl {
    fn EnumHeap(&self) -> windows_result::Result<IActiveScriptProfilerHeapEnum>;
}
...
impl IActiveScriptProfilerControl4 {
    pub unsafe fn SummarizeHeap(&self, heapsummary: *mut PROFILER_HEAP_SUMMARY) -> windows_result::Result<()> {
...
pub trait IActiveScriptProfilerControl4_Impl: IActiveScriptProfilerControl3_Impl {
    fn SummarizeHeap(&self, heapsummary: *mut PROFILER_HEAP_SUMMARY) -> windows_result::Result<()>;
}
...
impl IActiveScriptProfilerControl5 {
    pub unsafe fn EnumHeap2(&self, enumflags: PROFILER_HEAP_ENUM_FLAGS) -> windows_result::Result<IActiveScriptProfilerHeapEnum> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IActiveScriptProfilerControl5_Impl: IActiveScriptProfilerControl4_Impl {
    fn EnumHeap2(&self, enumflags: PROFILER_HEAP_ENUM_FLAGS) -> windows_result::Result<IActiveScriptProfilerHeapEnum>;
}
...
impl IActiveScriptProfilerHeapEnum {
    pub unsafe fn Next(&self, heapobjects: &mut [*mut PROFILER_HEAP_OBJECT], pceltfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetOptionalInfo(&self, heapobject: *const PROFILER_HEAP_OBJECT, optionalinfo: &mut [PROFILER_HEAP_OBJECT_OPTIONAL_INFO]) -> windows_result::Result<()> {
    ...
    pub unsafe fn FreeObjectAndOptionalInfo(&self, heapobjects: &[*const PROFILER_HEAP_OBJECT]) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetNameIdMap(&self, pnamelist: *mut *mut *mut windows_core::PCWSTR, pcelt: *mut u32) -> windows_result::Result<()> {
...
pub trait IActiveScriptProfilerHeapEnum_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, heapobjects: *mut *mut PROFILER_HEAP_OBJECT, pceltfetched: *mut u32) -> windows_result::Result<()>;
    fn GetOptionalInfo(&self, heapobject: *const PROFILER_HEAP_OBJECT, celt: u32, optionalinfo: *mut PROFILER_HEAP_OBJECT_OPTIONAL_INFO) -> windows_result::Result<()>;
    fn FreeObjectAndOptionalInfo(&self, celt: u32, heapobjects: *const *const PROFILER_HEAP_OBJECT) -> windows_result::Result<()>;
    fn GetNameIdMap(&self, pnamelist: *mut *mut *mut windows_core::PCWSTR, pcelt: *mut u32) -> windows_result::Result<()>;
}
...
impl IActiveScriptProperty {
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetProperty(&self, dwproperty: u32, pvarindex: *const super::super::super::Variant::VARIANT) -> windows_result::Result<super::super::super::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn SetProperty(&self, dwproperty: u32, pvarindex: *const super::super::super::Variant::VARIANT, pvarvalue: *const super::super::super::Variant::VARIANT) -> windows_result::Result<()> {
...
pub trait IActiveScriptProperty_Impl: windows_core::IUnknownImpl {
    fn GetProperty(&self, dwproperty: u32, pvarindex: *const super::super::super::Variant::VARIANT) -> windows_result::Result<super::super::super::Variant::VARIANT>;
    fn SetProperty(&self, dwproperty: u32, pvarindex: *const super::super::super::Variant::VARIANT, pvarvalue: *const super::super::super::Variant::VARIANT) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IActiveScriptSIPInfo {
    pub unsafe fn GetSIPOID(&self) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IActiveScriptSIPInfo_Impl: windows_core::IUnknownImpl {
    fn GetSIPOID(&self) -> windows_result::Result<windows_core::GUID>;
}
...
impl IActiveScriptSite {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetItemInfo<P0>(&self, pstrname: P0, dwreturnmask: u32, ppiunkitem: *mut Option<windows_core::IUnknown>, ppti: *mut Option<super::super::super::Com::ITypeInfo>) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetDocVersionString(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn OnScriptTerminate(&self, pvarresult: *const super::super::super::Variant::VARIANT, pexcepinfo: *const super::super::super::Com::EXCEPINFO) -> windows_result::Result<()> {
    ...
    pub unsafe fn OnStateChange(&self, ssscriptstate: SCRIPTSTATE) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).OnStateChange)(windows_core::Interface::as_raw(self), ssscriptstate).ok() }
    }
    pub unsafe fn OnScriptError<P0>(&self, pscripterror: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn OnEnterScript(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).OnEnterScript)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn OnLeaveScript(&self) -> windows_result::Result<()> {
...
pub trait IActiveScriptSite_Impl: windows_core::IUnknownImpl {
    ...
    fn GetItemInfo(&self, pstrname: &windows_core::PCWSTR, dwreturnmask: u32, ppiunkitem: windows_core::OutRef<windows_core::IUnknown>, ppti: windows_core::OutRef<super::super::super::Com::ITypeInfo>) -> windows_result::Result<()>;
    fn GetDocVersionString(&self) -> windows_result::Result<windows_core::BSTR>;
    fn OnScriptTerminate(&self, pvarresult: *const super::super::super::Variant::VARIANT, pexcepinfo: *const super::super::super::Com::EXCEPINFO) -> windows_result::Result<()>;
    fn OnStateChange(&self, ssscriptstate: SCRIPTSTATE) -> windows_result::Result<()>;
    fn OnScriptError(&self, pscripterror: windows_core::Ref<IActiveScriptError>) -> windows_result::Result<()>;
    fn OnEnterScript(&self) -> windows_result::Result<()>;
    fn OnLeaveScript(&self) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IActiveScriptSiteDebug32 {
    pub unsafe fn GetDocumentContextFromPosition(&self, dwsourcecontext: u32, ucharacteroffset: u32, unumchars: u32) -> windows_result::Result<IDebugDocumentContext> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetApplication(&self) -> windows_result::Result<IDebugApplication32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetRootApplicationNode(&self) -> windows_result::Result<IDebugApplicationNode> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn OnScriptErrorDebug<P0>(&self, perrordebug: P0, pfenterdebugger: *mut windows_core::BOOL, pfcallonscripterrorwhencontinuing: *mut windows_core::BOOL) -> windows_result::Result<()>
    where
...
pub trait IActiveScriptSiteDebug32_Impl: windows_core::IUnknownImpl {
    fn GetDocumentContextFromPosition(&self, dwsourcecontext: u32, ucharacteroffset: u32, unumchars: u32) -> windows_result::Result<IDebugDocumentContext>;
    fn GetApplication(&self) -> windows_result::Result<IDebugApplication32>;
    fn GetRootApplicationNode(&self) -> windows_result::Result<IDebugApplicationNode>;
    fn OnScriptErrorDebug(&self, perrordebug: windows_core::Ref<IActiveScriptErrorDebug>, pfenterdebugger: *mut windows_core::BOOL, pfcallonscripterrorwhencontinuing: *mut windows_core::BOOL) -> windows_result::Result<()>;
}
...
impl IActiveScriptSiteDebug64 {
    pub unsafe fn GetDocumentContextFromPosition(&self, dwsourcecontext: u64, ucharacteroffset: u32, unumchars: u32) -> windows_result::Result<IDebugDocumentContext> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDocumentContextFromPosition)(windows_core::Interface::as_raw(self), dwsourcecontext, ucharacteroffset, unumchars, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn GetApplication(&self) -> windows_result::Result<IDebugApplication64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetApplication)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IActiveScriptSiteDebug64_Impl: windows_core::IUnknownImpl {
    fn GetDocumentContextFromPosition(&self, dwsourcecontext: u64, ucharacteroffset: u32, unumchars: u32) -> windows_result::Result<IDebugDocumentContext>;
    fn GetApplication(&self) -> windows_result::Result<IDebugApplication64>;
    fn GetRootApplicationNode(&self) -> windows_result::Result<IDebugApplicationNode>;
    fn OnScriptErrorDebug(&self, perrordebug: windows_core::Ref<IActiveScriptErrorDebug>, pfenterdebugger: *mut windows_core::BOOL, pfcallonscripterrorwhencontinuing: *mut windows_core::BOOL) -> windows_result::Result<()>;
}
...
impl IActiveScriptSiteDebugEx {
    pub unsafe fn OnCanNotJITScriptErrorDebug<P0>(&self, perrordebug: P0) -> windows_result::Result<windows_core::BOOL>
    where
        P0: windows_core::Param<IActiveScriptErrorDebug>,
    {
        unsafe {
...
pub trait IActiveScriptSiteDebugEx_Impl: windows_core::IUnknownImpl {
    fn OnCanNotJITScriptErrorDebug(&self, perrordebug: windows_core::Ref<IActiveScriptErrorDebug>) -> windows_result::Result<windows_core::BOOL>;
}
...
impl IActiveScriptSiteInterruptPoll {
    pub unsafe fn QueryContinue(&self) -> windows_result::Result<()> {
...
pub trait IActiveScriptSiteInterruptPoll_Impl: windows_core::IUnknownImpl {
    fn QueryContinue(&self) -> windows_result::Result<()>;
}
...
impl IActiveScriptSiteTraceInfo {
    pub unsafe fn SendScriptTraceInfo(&self, stieventtype: SCRIPTTRACEINFO, guidcontextid: windows_core::GUID, dwscriptcontextcookie: u32, lscriptstatementstart: i32, lscriptstatementend: i32, dwreserved: u64) -> windows_result::Result<()> {
...
pub trait IActiveScriptSiteTraceInfo_Impl: windows_core::IUnknownImpl {
    fn SendScriptTraceInfo(&self, stieventtype: SCRIPTTRACEINFO, guidcontextid: &windows_core::GUID, dwscriptcontextcookie: u32, lscriptstatementstart: i32, lscriptstatementend: i32, dwreserved: u64) -> windows_result::Result<()>;
}
...
impl IActiveScriptSiteUIControl {
    pub unsafe fn GetUIBehavior(&self, uicitem: SCRIPTUICITEM) -> windows_result::Result<SCRIPTUICHANDLING> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IActiveScriptSiteUIControl_Impl: windows_core::IUnknownImpl {
    fn GetUIBehavior(&self, uicitem: SCRIPTUICITEM) -> windows_result::Result<SCRIPTUICHANDLING>;
}
...
impl IActiveScriptSiteWindow {
    pub unsafe fn GetWindow(&self) -> windows_result::Result<super::super::super::super::Foundation::HWND> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IActiveScriptSiteWindow_Impl: windows_core::IUnknownImpl {
    fn GetWindow(&self) -> windows_result::Result<super::super::super::super::Foundation::HWND>;
...
impl IActiveScriptStats {
    pub unsafe fn GetStat(&self, stid: u32, pluhi: *mut u32, plulo: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetStat)(windows_core::Interface::as_raw(self), stid, pluhi as _, plulo as _).ok() }
    }
    pub unsafe fn GetStatEx(&self, guid: *const windows_core::GUID, pluhi: *mut u32, plulo: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetStatEx)(windows_core::Interface::as_raw(self), guid, pluhi as _, plulo as _).ok() }
    }
    pub unsafe fn ResetStats(&self) -> windows_result::Result<()> {
...
pub trait IActiveScriptStats_Impl: windows_core::IUnknownImpl {
    fn GetStat(&self, stid: u32, pluhi: *mut u32, plulo: *mut u32) -> windows_result::Result<()>;
    fn GetStatEx(&self, guid: *const windows_core::GUID, pluhi: *mut u32, plulo: *mut u32) -> windows_result::Result<()>;
    fn ResetStats(&self) -> windows_result::Result<()>;
}
...
impl IActiveScriptStringCompare {
    pub unsafe fn StrComp(&self, bszstr1: &windows_core::BSTR, bszstr2: &windows_core::BSTR) -> windows_result::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IActiveScriptStringCompare_Impl: windows_core::IUnknownImpl {
    fn StrComp(&self, bszstr1: &windows_core::BSTR, bszstr2: &windows_core::BSTR) -> windows_result::Result<i32>;
}
...
impl IActiveScriptTraceInfo {
    pub unsafe fn StartScriptTracing<P0>(&self, psitetraceinfo: P0, guidcontextid: windows_core::GUID) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn StopScriptTracing(&self) -> windows_result::Result<()> {
...
pub trait IActiveScriptTraceInfo_Impl: windows_core::IUnknownImpl {
    fn StartScriptTracing(&self, psitetraceinfo: windows_core::Ref<IActiveScriptSiteTraceInfo>, guidcontextid: &windows_core::GUID) -> windows_result::Result<()>;
    fn StopScriptTracing(&self) -> windows_result::Result<()>;
}
...
impl IActiveScriptWinRTErrorDebug {
    pub unsafe fn GetRestrictedErrorString(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetRestrictedErrorReference(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetCapabilitySid(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IActiveScriptWinRTErrorDebug_Impl: IActiveScriptError_Impl {
    fn GetRestrictedErrorString(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetRestrictedErrorReference(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetCapabilitySid(&self) -> windows_result::Result<windows_core::BSTR>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IApplicationDebugger {
    pub unsafe fn QueryAlive(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).QueryAlive)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn CreateInstanceAtDebugger<P1>(&self, rclsid: *const windows_core::GUID, punkouter: P1, dwclscontext: u32, riid: *const windows_core::GUID) -> windows_result::Result<windows_core::IUnknown>
    where
    ...
    pub unsafe fn onDebugOutput<P0>(&self, pstr: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).onDebugOutput)(windows_core::Interface::as_raw(self), pstr.param().abi()).ok() }
    }
    pub unsafe fn onHandleBreakPoint<P0, P2>(&self, prpt: P0, br: BREAKREASON, perror: P2) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn onDebuggerEvent<P1>(&self, riid: *const windows_core::GUID, punk: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::IUnknown>,
    {
...
pub trait IApplicationDebugger_Impl: windows_core::IUnknownImpl {
    fn QueryAlive(&self) -> windows_result::Result<()>;
    fn CreateInstanceAtDebugger(&self, rclsid: *const windows_core::GUID, punkouter: windows_core::Ref<windows_core::IUnknown>, dwclscontext: u32, riid: *const windows_core::GUID) -> windows_result::Result<windows_core::IUnknown>;
    fn onDebugOutput(&self, pstr: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn onHandleBreakPoint(&self, prpt: windows_core::Ref<IRemoteDebugApplicationThread>, br: BREAKREASON, perror: windows_core::Ref<IActiveScriptErrorDebug>) -> windows_result::Result<()>;
    fn onClose(&self) -> windows_result::Result<()>;
    fn onDebuggerEvent(&self, riid: *const windows_core::GUID, punk: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
}
...
impl IApplicationDebuggerUI {
    pub unsafe fn BringDocumentToTop<P0>(&self, pddt: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn BringDocumentContextToTop<P0>(&self, pddc: P0) -> windows_result::Result<()>
    where
...
pub trait IApplicationDebuggerUI_Impl: windows_core::IUnknownImpl {
    fn BringDocumentToTop(&self, pddt: windows_core::Ref<IDebugDocumentText>) -> windows_result::Result<()>;
    fn BringDocumentContextToTop(&self, pddc: windows_core::Ref<IDebugDocumentContext>) -> windows_result::Result<()>;
}
...
impl IBindEventHandler {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn BindHandler<P0, P1>(&self, pstrevent: P0, pdisp: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IBindEventHandler_Impl: windows_core::IUnknownImpl {
    fn BindHandler(&self, pstrevent: &windows_core::PCWSTR, pdisp: windows_core::Ref<super::super::super::Com::IDispatch>) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IDebugApplication11032 {
    pub unsafe fn SynchronousCallInMainThread<P0>(&self, pptc: P0, dwparam1: usize, dwparam2: usize, dwparam3: usize) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn AsynchronousCallInMainThread<P0>(&self, pptc: P0, dwparam1: usize, dwparam2: usize, dwparam3: usize) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IDebugThreadCall32>,
    {
    ...
    pub unsafe fn CallableWaitForHandles(&self, phandles: &[super::super::super::super::Foundation::HANDLE]) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDebugApplication11032_Impl: IRemoteDebugApplication110_Impl {
    fn SynchronousCallInMainThread(&self, pptc: windows_core::Ref<IDebugThreadCall32>, dwparam1: usize, dwparam2: usize, dwparam3: usize) -> windows_result::Result<()>;
    fn AsynchronousCallInMainThread(&self, pptc: windows_core::Ref<IDebugThreadCall32>, dwparam1: usize, dwparam2: usize, dwparam3: usize) -> windows_result::Result<()>;
    fn CallableWaitForHandles(&self, handlecount: u32, phandles: *const super::super::super::super::Foundation::HANDLE) -> windows_result::Result<u32>;
}
...
pub trait IDebugApplication11064_Impl: IRemoteDebugApplication110_Impl {
    fn SynchronousCallInMainThread(&self, pptc: windows_core::Ref<IDebugThreadCall64>, dwparam1: usize, dwparam2: usize, dwparam3: usize) -> windows_result::Result<()>;
    fn AsynchronousCallInMainThread(&self, pptc: windows_core::Ref<IDebugThreadCall64>, dwparam1: usize, dwparam2: usize, dwparam3: usize) -> windows_result::Result<()>;
    fn CallableWaitForHandles(&self, handlecount: u32, phandles: *const super::super::super::super::Foundation::HANDLE) -> windows_result::Result<u32>;
}
...
impl IDebugApplication32 {
    ...
    pub unsafe fn GetBreakFlags(&self, pabf: *mut u32, pprdatsteppingthread: *mut Option<IRemoteDebugApplicationThread>) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetCurrentThread(&self) -> windows_result::Result<IDebugApplicationThread> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateAsyncDebugOperation<P0>(&self, psdo: P0) -> windows_result::Result<IDebugAsyncOperation>
    where
    ...
    pub unsafe fn AddStackFrameSniffer<P0>(&self, pdsfs: P0) -> windows_result::Result<u32>
    where
    ...
    pub unsafe fn RemoveStackFrameSniffer(&self, dwcookie: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).RemoveStackFrameSniffer)(windows_core::Interface::as_raw(self), dwcookie).ok() }
    }
    pub unsafe fn QueryCurrentThreadIsDebuggerThread(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).QueryCurrentThreadIsDebuggerThread)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn SynchronousCallInDebuggerThread<P0>(&self, pptc: P0, dwparam1: u32, dwparam2: u32, dwparam3: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IDebugThreadCall32>,
    {
    ...
    pub unsafe fn CreateApplicationNode(&self) -> windows_result::Result<IDebugApplicationNode> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn FireDebuggerEvent<P1>(&self, riid: *const windows_core::GUID, punk: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe { (windows_core::Interface::vtable(self).FireDebuggerEvent)(windows_core::Interface::as_raw(self), riid, punk.param().abi()).ok() }
    }
    pub unsafe fn HandleRuntimeError<P0, P1>(&self, perrordebug: P0, pscriptsite: P1, pbra: *mut BREAKRESUMEACTION, perra: *mut ERRORRESUMEACTION, pfcallonscripterror: *mut windows_core::BOOL) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IActiveScriptErrorDebug>,
    ...
    pub unsafe fn AddGlobalExpressionContextProvider<P0>(&self, pdsfs: P0) -> windows_result::Result<u32>
    where
    ...
    pub unsafe fn RemoveGlobalExpressionContextProvider(&self, dwcookie: u32) -> windows_result::Result<()> {
...
pub trait IDebugApplication32_Impl: IRemoteDebugApplication_Impl {
    fn SetName(&self, pstrname: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn StepOutComplete(&self) -> windows_result::Result<()>;
    fn DebugOutput(&self, pstr: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn StartDebugSession(&self) -> windows_result::Result<()>;
    fn HandleBreakPoint(&self, br: BREAKREASON) -> windows_result::Result<BREAKRESUMEACTION>;
    fn Close(&self) -> windows_result::Result<()>;
    fn GetBreakFlags(&self, pabf: *mut u32, pprdatsteppingthread: windows_core::OutRef<IRemoteDebugApplicationThread>) -> windows_result::Result<()>;
    fn GetCurrentThread(&self) -> windows_result::Result<IDebugApplicationThread>;
    fn CreateAsyncDebugOperation(&self, psdo: windows_core::Ref<IDebugSyncOperation>) -> windows_result::Result<IDebugAsyncOperation>;
    fn AddStackFrameSniffer(&self, pdsfs: windows_core::Ref<IDebugStackFrameSniffer>) -> windows_result::Result<u32>;
    fn RemoveStackFrameSniffer(&self, dwcookie: u32) -> windows_result::Result<()>;
    fn QueryCurrentThreadIsDebuggerThread(&self) -> windows_result::Result<()>;
    fn SynchronousCallInDebuggerThread(&self, pptc: windows_core::Ref<IDebugThreadCall32>, dwparam1: u32, dwparam2: u32, dwparam3: u32) -> windows_result::Result<()>;
    fn CreateApplicationNode(&self) -> windows_result::Result<IDebugApplicationNode>;
    fn FireDebuggerEvent(&self, riid: *const windows_core::GUID, punk: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn HandleRuntimeError(&self, perrordebug: windows_core::Ref<IActiveScriptErrorDebug>, pscriptsite: windows_core::Ref<IActiveScriptSite>, pbra: *mut BREAKRESUMEACTION, perra: *mut ERRORRESUMEACTION, pfcallonscripterror: *mut windows_core::BOOL) -> windows_result::Result<()>;
    fn FCanJitDebug(&self) -> windows_core::BOOL;
    fn FIsAutoJitDebugEnabled(&self) -> windows_core::BOOL;
    fn AddGlobalExpressionContextProvider(&self, pdsfs: windows_core::Ref<IProvideExpressionContexts>) -> windows_result::Result<u32>;
    fn RemoveGlobalExpressionContextProvider(&self, dwcookie: u32) -> windows_result::Result<()>;
}
...
impl IDebugApplication64 {
    ...
    pub unsafe fn SynchronousCallInDebuggerThread<P0>(&self, pptc: P0, dwparam1: u64, dwparam2: u64, dwparam3: u64) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IDebugThreadCall64>,
    {
        unsafe { (windows_core::Interface::vtable(self).SynchronousCallInDebuggerThread)(windows_core::Interface::as_raw(self), pptc.param().abi(), dwparam1, dwparam2, dwparam3).ok() }
    ...
    pub unsafe fn AddGlobalExpressionContextProvider<P0>(&self, pdsfs: P0) -> windows_result::Result<u64>
    where
        P0: windows_core::Param<IProvideExpressionContexts>,
    {
        unsafe {
    ...
    pub unsafe fn RemoveGlobalExpressionContextProvider(&self, dwcookie: u64) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).RemoveGlobalExpressionContextProvider)(windows_core::Interface::as_raw(self), dwcookie).ok() }
    }
}
#[repr(C)]
...
pub trait IDebugApplication64_Impl: IRemoteDebugApplication_Impl {
    ...
    fn RemoveStackFrameSniffer(&self, dwcookie: u32) -> windows_result::Result<()>;
    fn QueryCurrentThreadIsDebuggerThread(&self) -> windows_result::Result<()>;
    fn SynchronousCallInDebuggerThread(&self, pptc: windows_core::Ref<IDebugThreadCall64>, dwparam1: u64, dwparam2: u64, dwparam3: u64) -> windows_result::Result<()>;
    fn CreateApplicationNode(&self) -> windows_result::Result<IDebugApplicationNode>;
    fn FireDebuggerEvent(&self, riid: *const windows_core::GUID, punk: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn HandleRuntimeError(&self, perrordebug: windows_core::Ref<IActiveScriptErrorDebug>, pscriptsite: windows_core::Ref<IActiveScriptSite>, pbra: *mut BREAKRESUMEACTION, perra: *mut ERRORRESUMEACTION, pfcallonscripterror: *mut windows_core::BOOL) -> windows_result::Result<()>;
    fn FCanJitDebug(&self) -> windows_core::BOOL;
    fn FIsAutoJitDebugEnabled(&self) -> windows_core::BOOL;
    fn AddGlobalExpressionContextProvider(&self, pdsfs: windows_core::Ref<IProvideExpressionContexts>) -> windows_result::Result<u64>;
    fn RemoveGlobalExpressionContextProvider(&self, dwcookie: u64) -> windows_result::Result<()>;
}
...
impl IDebugApplicationNode {
    pub unsafe fn EnumChildren(&self) -> windows_result::Result<IEnumDebugApplicationNodes> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetParent(&self) -> windows_result::Result<IDebugApplicationNode> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetDocumentProvider<P0>(&self, pddp: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn Attach<P0>(&self, pdanparent: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IDebugApplicationNode>,
    {
...
pub trait IDebugApplicationNode_Impl: IDebugDocumentProvider_Impl {
    fn EnumChildren(&self) -> windows_result::Result<IEnumDebugApplicationNodes>;
    fn GetParent(&self) -> windows_result::Result<IDebugApplicationNode>;
    fn SetDocumentProvider(&self, pddp: windows_core::Ref<IDebugDocumentProvider>) -> windows_result::Result<()>;
    fn Close(&self) -> windows_result::Result<()>;
    fn Attach(&self, pdanparent: windows_core::Ref<IDebugApplicationNode>) -> windows_result::Result<()>;
...
impl IDebugApplicationNode100 {
    pub unsafe fn SetFilterForEventSink(&self, dwcookie: u32, filter: APPLICATION_NODE_EVENT_FILTER) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetFilterForEventSink)(windows_core::Interface::as_raw(self), dwcookie, filter).ok() }
    }
    pub unsafe fn GetExcludedDocuments(&self, filter: APPLICATION_NODE_EVENT_FILTER) -> windows_result::Result<TEXT_DOCUMENT_ARRAY> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn QueryIsChildNode<P0>(&self, psearchkey: P0) -> windows_result::Result<()>
    where
...
pub trait IDebugApplicationNode100_Impl: windows_core::IUnknownImpl {
    fn SetFilterForEventSink(&self, dwcookie: u32, filter: APPLICATION_NODE_EVENT_FILTER) -> windows_result::Result<()>;
    fn GetExcludedDocuments(&self, filter: APPLICATION_NODE_EVENT_FILTER) -> windows_result::Result<TEXT_DOCUMENT_ARRAY>;
    fn QueryIsChildNode(&self, psearchkey: windows_core::Ref<IDebugDocument>) -> windows_result::Result<()>;
}
...
pub trait IDebugApplicationNodeEvents_Impl: windows_core::IUnknownImpl {
    fn onAddChild(&self, prddpchild: windows_core::Ref<IDebugApplicationNode>) -> windows_result::Result<()>;
    fn onRemoveChild(&self, prddpchild: windows_core::Ref<IDebugApplicationNode>) -> windows_result::Result<()>;
    fn onDetach(&self) -> windows_result::Result<()>;
    fn onAttach(&self, prddpparent: windows_core::Ref<IDebugApplicationNode>) -> windows_result::Result<()>;
}
...
impl IDebugApplicationThread {
    pub unsafe fn SynchronousCallIntoThread32<P0>(&self, pstcb: P0, dwparam1: u32, dwparam2: u32, dwparam3: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IDebugThreadCall32>,
    {
...
pub trait IDebugApplicationThread_Impl: IRemoteDebugApplicationThread_Impl {
    fn SynchronousCallIntoThread32(&self, pstcb: windows_core::Ref<IDebugThreadCall32>, dwparam1: u32, dwparam2: u32, dwparam3: u32) -> windows_result::Result<()>;
    fn QueryIsCurrentThread(&self) -> windows_result::Result<()>;
    fn QueryIsDebuggerThread(&self) -> windows_result::Result<()>;
    fn SetDescription(&self, pstrdescription: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn SetStateString(&self, pstrstate: &windows_core::PCWSTR) -> windows_result::Result<()>;
}
...
impl IDebugApplicationThread11032 {
    pub unsafe fn GetActiveThreadRequestCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn IsSuspendedForBreakPoint(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsSuspendedForBreakPoint)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn IsThreadCallable(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsThreadCallable)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn AsynchronousCallIntoThread<P0>(&self, pptc: P0, dwparam1: usize, dwparam2: usize, dwparam3: usize) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IDebugThreadCall32>,
    {
...
pub trait IDebugApplicationThread11032_Impl: windows_core::IUnknownImpl {
    fn GetActiveThreadRequestCount(&self) -> windows_result::Result<u32>;
    fn IsSuspendedForBreakPoint(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsThreadCallable(&self) -> windows_result::Result<windows_core::BOOL>;
    fn AsynchronousCallIntoThread(&self, pptc: windows_core::Ref<IDebugThreadCall32>, dwparam1: usize, dwparam2: usize, dwparam3: usize) -> windows_result::Result<()>;
}
...
pub trait IDebugApplicationThread11064_Impl: windows_core::IUnknownImpl {
    ...
    fn IsSuspendedForBreakPoint(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsThreadCallable(&self) -> windows_result::Result<windows_core::BOOL>;
    fn AsynchronousCallIntoThread(&self, pptc: windows_core::Ref<IDebugThreadCall64>, dwparam1: usize, dwparam2: usize, dwparam3: usize) -> windows_result::Result<()>;
}
...
impl IDebugApplicationThread64 {
    pub unsafe fn SynchronousCallIntoThread64<P0>(&self, pstcb: P0, dwparam1: u64, dwparam2: u64, dwparam3: u64) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IDebugThreadCall64>,
    {
...
pub trait IDebugApplicationThread64_Impl: IDebugApplicationThread_Impl {
    fn SynchronousCallIntoThread64(&self, pstcb: windows_core::Ref<IDebugThreadCall64>, dwparam1: u64, dwparam2: u64, dwparam3: u64) -> windows_result::Result<()>;
}
...
pub trait IDebugApplicationThreadEvents110_Impl: windows_core::IUnknownImpl {
    fn OnSuspendForBreakPoint(&self) -> windows_result::Result<()>;
    fn OnResumeFromBreakPoint(&self) -> windows_result::Result<()>;
    fn OnThreadRequestComplete(&self) -> windows_result::Result<()>;
    fn OnBeginThreadRequest(&self) -> windows_result::Result<()>;
}
...
impl IDebugAsyncOperation {
    pub unsafe fn GetSyncDebugOperation(&self) -> windows_result::Result<IDebugSyncOperation> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Start<P0>(&self, padocb: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn QueryIsComplete(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).QueryIsComplete)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn GetResult(&self, phrresult: *mut windows_core::HRESULT, ppunkresult: *mut Option<windows_core::IUnknown>) -> windows_result::Result<()> {
...
pub trait IDebugAsyncOperation_Impl: windows_core::IUnknownImpl {
    fn GetSyncDebugOperation(&self) -> windows_result::Result<IDebugSyncOperation>;
    fn Start(&self, padocb: windows_core::Ref<IDebugAsyncOperationCallBack>) -> windows_result::Result<()>;
    fn Abort(&self) -> windows_result::Result<()>;
    fn QueryIsComplete(&self) -> windows_result::Result<()>;
    fn GetResult(&self, phrresult: *mut windows_core::HRESULT, ppunkresult: windows_core::OutRef<windows_core::IUnknown>) -> windows_result::Result<()>;
}
...
impl IDebugAsyncOperationCallBack {
    pub unsafe fn onComplete(&self) -> windows_result::Result<()> {
...
pub trait IDebugAsyncOperationCallBack_Impl: windows_core::IUnknownImpl {
    fn onComplete(&self) -> windows_result::Result<()>;
}
...
impl IDebugCodeContext {
    ...
    pub unsafe fn SetBreakPoint(&self, bps: BREAKPOINT_STATE) -> windows_result::Result<()> {
...
pub trait IDebugCodeContext_Impl: windows_core::IUnknownImpl {
    fn GetDocumentContext(&self) -> windows_result::Result<IDebugDocumentContext>;
    fn SetBreakPoint(&self, bps: BREAKPOINT_STATE) -> windows_result::Result<()>;
}
...
impl IDebugCookie {
    pub unsafe fn SetDebugCookie(&self, dwdebugappcookie: u32) -> windows_result::Result<()> {
...
pub trait IDebugCookie_Impl: windows_core::IUnknownImpl {
    fn SetDebugCookie(&self, dwdebugappcookie: u32) -> windows_result::Result<()>;
}
...
impl IDebugDocumentContext {
    pub unsafe fn GetDocument(&self) -> windows_result::Result<IDebugDocument> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumCodeContexts(&self) -> windows_result::Result<IEnumDebugCodeContexts> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDebugDocumentContext_Impl: windows_core::IUnknownImpl {
    fn GetDocument(&self) -> windows_result::Result<IDebugDocument>;
    fn EnumCodeContexts(&self) -> windows_result::Result<IEnumDebugCodeContexts>;
}
...
impl IDebugDocumentHelper32 {
    pub unsafe fn Init<P0, P1, P2>(&self, pda: P0, pszshortname: P1, pszlongname: P2, docattr: u32) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn Attach<P0>(&self, pddhparent: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn AddDeferredText(&self, cchars: u32, dwtextstartcookie: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).AddDeferredText)(windows_core::Interface::as_raw(self), cchars, dwtextstartcookie).ok() }
    }
    pub unsafe fn DefineScriptBlock<P2>(&self, ulcharoffset: u32, cchars: u32, pas: P2, fscriptlet: bool) -> windows_result::Result<u32>
    where
    ...
    pub unsafe fn SetDefaultTextAttr(&self, statextattr: u16) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetDefaultTextAttr)(windows_core::Interface::as_raw(self), statextattr).ok() }
    }
    pub unsafe fn SetTextAttributes(&self, ulcharoffset: u32, pstatextattr: &[u16]) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetScriptBlockInfo(&self, dwsourcecontext: u32, ppasd: *mut Option<IActiveScript>, picharpos: *mut u32, pcchars: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn CreateDebugDocumentContext(&self, icharpos: u32, cchars: u32) -> windows_result::Result<IDebugDocumentContext> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn BringDocumentToTop(&self) -> windows_result::Result<()> {
...
pub trait IDebugDocumentHelper32_Impl: windows_core::IUnknownImpl {
    fn Init(&self, pda: windows_core::Ref<IDebugApplication32>, pszshortname: &windows_core::PCWSTR, pszlongname: &windows_core::PCWSTR, docattr: u32) -> windows_result::Result<()>;
    fn Attach(&self, pddhparent: windows_core::Ref<IDebugDocumentHelper32>) -> windows_result::Result<()>;
    fn Detach(&self) -> windows_result::Result<()>;
    fn AddUnicodeText(&self, psztext: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn AddDBCSText(&self, psztext: &windows_core::PCSTR) -> windows_result::Result<()>;
    fn SetDebugDocumentHost(&self, pddh: windows_core::Ref<IDebugDocumentHost>) -> windows_result::Result<()>;
    fn AddDeferredText(&self, cchars: u32, dwtextstartcookie: u32) -> windows_result::Result<()>;
    fn DefineScriptBlock(&self, ulcharoffset: u32, cchars: u32, pas: windows_core::Ref<IActiveScript>, fscriptlet: windows_core::BOOL) -> windows_result::Result<u32>;
    fn SetDefaultTextAttr(&self, statextattr: u16) -> windows_result::Result<()>;
    fn SetTextAttributes(&self, ulcharoffset: u32, cchars: u32, pstatextattr: *const u16) -> windows_result::Result<()>;
    fn SetLongName(&self, pszlongname: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn SetShortName(&self, pszshortname: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn SetDocumentAttr(&self, pszattributes: u32) -> windows_result::Result<()>;
    fn GetDebugApplicationNode(&self) -> windows_result::Result<IDebugApplicationNode>;
    fn GetScriptBlockInfo(&self, dwsourcecontext: u32, ppasd: windows_core::OutRef<IActiveScript>, picharpos: *mut u32, pcchars: *mut u32) -> windows_result::Result<()>;
    fn CreateDebugDocumentContext(&self, icharpos: u32, cchars: u32) -> windows_result::Result<IDebugDocumentContext>;
    fn BringDocumentToTop(&self) -> windows_result::Result<()>;
    fn BringDocumentContextToTop(&self, pddc: windows_core::Ref<IDebugDocumentContext>) -> windows_result::Result<()>;
}
...
impl IDebugDocumentHelper64 {
    ...
    pub unsafe fn DefineScriptBlock<P2>(&self, ulcharoffset: u32, cchars: u32, pas: P2, fscriptlet: bool) -> windows_result::Result<u64>
    where
        P2: windows_core::Param<IActiveScript>,
    {
        unsafe {
    ...
    pub unsafe fn GetScriptBlockInfo(&self, dwsourcecontext: u64, ppasd: *mut Option<IActiveScript>, picharpos: *mut u32, pcchars: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetScriptBlockInfo)(windows_core::Interface::as_raw(self), dwsourcecontext, core::mem::transmute(ppasd), picharpos as _, pcchars as _).ok() }
    }
    pub unsafe fn CreateDebugDocumentContext(&self, icharpos: u32, cchars: u32) -> windows_result::Result<IDebugDocumentContext> {
        unsafe {
...
pub trait IDebugDocumentHelper64_Impl: windows_core::IUnknownImpl {
    fn Init(&self, pda: windows_core::Ref<IDebugApplication64>, pszshortname: &windows_core::PCWSTR, pszlongname: &windows_core::PCWSTR, docattr: u32) -> windows_result::Result<()>;
    fn Attach(&self, pddhparent: windows_core::Ref<IDebugDocumentHelper64>) -> windows_result::Result<()>;
    fn Detach(&self) -> windows_result::Result<()>;
    fn AddUnicodeText(&self, psztext: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn AddDBCSText(&self, psztext: &windows_core::PCSTR) -> windows_result::Result<()>;
    fn SetDebugDocumentHost(&self, pddh: windows_core::Ref<IDebugDocumentHost>) -> windows_result::Result<()>;
    fn AddDeferredText(&self, cchars: u32, dwtextstartcookie: u32) -> windows_result::Result<()>;
    fn DefineScriptBlock(&self, ulcharoffset: u32, cchars: u32, pas: windows_core::Ref<IActiveScript>, fscriptlet: windows_core::BOOL) -> windows_result::Result<u64>;
    fn SetDefaultTextAttr(&self, statextattr: u16) -> windows_result::Result<()>;
    fn SetTextAttributes(&self, ulcharoffset: u32, cchars: u32, pstatextattr: *const u16) -> windows_result::Result<()>;
    fn SetLongName(&self, pszlongname: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn SetShortName(&self, pszshortname: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn SetDocumentAttr(&self, pszattributes: u32) -> windows_result::Result<()>;
    fn GetDebugApplicationNode(&self) -> windows_result::Result<IDebugApplicationNode>;
    fn GetScriptBlockInfo(&self, dwsourcecontext: u64, ppasd: windows_core::OutRef<IActiveScript>, picharpos: *mut u32, pcchars: *mut u32) -> windows_result::Result<()>;
    fn CreateDebugDocumentContext(&self, icharpos: u32, cchars: u32) -> windows_result::Result<IDebugDocumentContext>;
    fn BringDocumentToTop(&self) -> windows_result::Result<()>;
    fn BringDocumentContextToTop(&self, pddc: windows_core::Ref<IDebugDocumentContext>) -> windows_result::Result<()>;
}
...
impl IDebugDocumentHost {
    pub unsafe fn GetDeferredText(&self, dwtextstartcookie: u32, pchartext: windows_core::PWSTR, pstatextattr: *mut u16, pcnumchars: *mut u32, cmaxchars: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn OnCreateDocumentContext(&self) -> windows_result::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetPathName(&self, pbstrlongname: *mut windows_core::BSTR, pfisoriginalfile: *mut windows_core::BOOL) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFileName(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn NotifyChanged(&self) -> windows_result::Result<()> {
...
pub trait IDebugDocumentHost_Impl: windows_core::IUnknownImpl {
    fn GetDeferredText(&self, dwtextstartcookie: u32, pchartext: windows_core::PWSTR, pstatextattr: *mut u16, pcnumchars: *mut u32, cmaxchars: u32) -> windows_result::Result<()>;
    fn GetScriptTextAttributes(&self, pstrcode: &windows_core::PCWSTR, unumcodechars: u32, pstrdelimiter: &windows_core::PCWSTR, dwflags: u32, pattr: *mut u16) -> windows_result::Result<()>;
    fn OnCreateDocumentContext(&self) -> windows_result::Result<windows_core::IUnknown>;
    fn GetPathName(&self, pbstrlongname: *mut windows_core::BSTR, pfisoriginalfile: *mut windows_core::BOOL) -> windows_result::Result<()>;
    fn GetFileName(&self) -> windows_result::Result<windows_core::BSTR>;
    fn NotifyChanged(&self) -> windows_result::Result<()>;
}
...
impl IDebugDocumentInfo {
    pub unsafe fn GetName(&self, dnt: DOCUMENTNAMETYPE) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetDocumentClassId(&self) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDebugDocumentInfo_Impl: windows_core::IUnknownImpl {
    fn GetName(&self, dnt: DOCUMENTNAMETYPE) -> windows_result::Result<windows_core::BSTR>;
    fn GetDocumentClassId(&self) -> windows_result::Result<windows_core::GUID>;
}
...
impl IDebugDocumentText {
    ...
    pub unsafe fn GetLineOfPosition(&self, ccharacterposition: u32, pclinenumber: *mut u32, pccharacteroffsetinline: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetText(&self, ccharacterposition: u32, pchartext: windows_core::PWSTR, pstatextattr: Option<*mut u16>, pcnumchars: *mut u32, cmaxchars: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetPositionOfContext<P0>(&self, psc: P0, pccharacterposition: *mut u32, cnumchars: *mut u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IDebugDocumentContext>,
    {
    ...
    pub unsafe fn GetContextOfPosition(&self, ccharacterposition: u32, cnumchars: u32) -> windows_result::Result<IDebugDocumentContext> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDebugDocumentText_Impl: IDebugDocument_Impl {
    fn GetDocumentAttributes(&self) -> windows_result::Result<u32>;
    fn GetSize(&self, pcnumlines: *mut u32, pcnumchars: *mut u32) -> windows_result::Result<()>;
    fn GetPositionOfLine(&self, clinenumber: u32) -> windows_result::Result<u32>;
    fn GetLineOfPosition(&self, ccharacterposition: u32, pclinenumber: *mut u32, pccharacteroffsetinline: *mut u32) -> windows_result::Result<()>;
    fn GetText(&self, ccharacterposition: u32, pchartext: windows_core::PWSTR, pstatextattr: *mut u16, pcnumchars: *mut u32, cmaxchars: u32) -> windows_result::Result<()>;
    fn GetPositionOfContext(&self, psc: windows_core::Ref<IDebugDocumentContext>, pccharacterposition: *mut u32, cnumchars: *mut u32) -> windows_result::Result<()>;
    fn GetContextOfPosition(&self, ccharacterposition: u32, cnumchars: u32) -> windows_result::Result<IDebugDocumentContext>;
}
...
impl IDebugDocumentTextAuthor {
    pub unsafe fn InsertText(&self, ccharacterposition: u32, pchartext: &[u16]) -> windows_result::Result<()> {
    ...
    pub unsafe fn RemoveText(&self, ccharacterposition: u32, cnumtoremove: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn ReplaceText(&self, ccharacterposition: u32, pchartext: &[u16]) -> windows_result::Result<()> {
...
pub trait IDebugDocumentTextAuthor_Impl: IDebugDocumentText_Impl {
    fn InsertText(&self, ccharacterposition: u32, cnumtoinsert: u32, pchartext: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn RemoveText(&self, ccharacterposition: u32, cnumtoremove: u32) -> windows_result::Result<()>;
    fn ReplaceText(&self, ccharacterposition: u32, cnumtoreplace: u32, pchartext: &windows_core::PCWSTR) -> windows_result::Result<()>;
}
...
impl IDebugDocumentTextEvents {
    pub unsafe fn onDestroy(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).onDestroy)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn onInsertText(&self, ccharacterposition: u32, cnumtoinsert: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn onRemoveText(&self, ccharacterposition: u32, cnumtoremove: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn onReplaceText(&self, ccharacterposition: u32, cnumtoreplace: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn onUpdateTextAttributes(&self, ccharacterposition: u32, cnumtoupdate: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn onUpdateDocumentAttributes(&self, textdocattr: u32) -> windows_result::Result<()> {
...
pub trait IDebugDocumentTextEvents_Impl: windows_core::IUnknownImpl {
    fn onDestroy(&self) -> windows_result::Result<()>;
    fn onInsertText(&self, ccharacterposition: u32, cnumtoinsert: u32) -> windows_result::Result<()>;
    fn onRemoveText(&self, ccharacterposition: u32, cnumtoremove: u32) -> windows_result::Result<()>;
    fn onReplaceText(&self, ccharacterposition: u32, cnumtoreplace: u32) -> windows_result::Result<()>;
    fn onUpdateTextAttributes(&self, ccharacterposition: u32, cnumtoupdate: u32) -> windows_result::Result<()>;
    fn onUpdateDocumentAttributes(&self, textdocattr: u32) -> windows_result::Result<()>;
}
...
impl IDebugExpression {
    pub unsafe fn Start<P0>(&self, pdecb: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetResultAsString(&self, phrresult: *mut windows_core::HRESULT, pbstrresult: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetResultAsDebugProperty(&self, phrresult: *mut windows_core::HRESULT, ppdp: *mut Option<super::IDebugProperty>) -> windows_result::Result<()> {
...
pub trait IDebugExpression_Impl: windows_core::IUnknownImpl {
    fn Start(&self, pdecb: windows_core::Ref<IDebugExpressionCallBack>) -> windows_result::Result<()>;
    fn Abort(&self) -> windows_result::Result<()>;
    fn QueryIsComplete(&self) -> windows_result::Result<()>;
    fn GetResultAsString(&self, phrresult: *mut windows_core::HRESULT, pbstrresult: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn GetResultAsDebugProperty(&self, phrresult: *mut windows_core::HRESULT, ppdp: windows_core::OutRef<super::IDebugProperty>) -> windows_result::Result<()>;
}
...
impl IDebugExpressionContext {
    pub unsafe fn ParseLanguageText<P0, P2>(&self, pstrcode: P0, nradix: u32, pstrdelimiter: P2, dwflags: u32) -> windows_result::Result<IDebugExpression>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetLanguageInfo(&self, pbstrlanguagename: *mut windows_core::BSTR, planguageid: *mut windows_core::GUID) -> windows_result::Result<()> {
...
pub trait IDebugExpressionContext_Impl: windows_core::IUnknownImpl {
    fn ParseLanguageText(&self, pstrcode: &windows_core::PCWSTR, nradix: u32, pstrdelimiter: &windows_core::PCWSTR, dwflags: u32) -> windows_result::Result<IDebugExpression>;
    fn GetLanguageInfo(&self, pbstrlanguagename: *mut windows_core::BSTR, planguageid: *mut windows_core::GUID) -> windows_result::Result<()>;
}
...
impl IDebugFormatter {
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetStringForVariant(&self, pvar: *const super::super::super::Variant::VARIANT, nradix: u32) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetVariantForString<P0>(&self, pwstrvalue: P0) -> windows_result::Result<super::super::super::Variant::VARIANT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetStringForVarType(&self, vt: super::super::super::Variant::VARENUM, ptdescarraytype: *const super::super::super::Com::TYPEDESC) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDebugFormatter_Impl: windows_core::IUnknownImpl {
    fn GetStringForVariant(&self, pvar: *const super::super::super::Variant::VARIANT, nradix: u32) -> windows_result::Result<windows_core::BSTR>;
    fn GetVariantForString(&self, pwstrvalue: &windows_core::PCWSTR) -> windows_result::Result<super::super::super::Variant::VARIANT>;
    fn GetStringForVarType(&self, vt: super::super::super::Variant::VARENUM, ptdescarraytype: *const super::super::super::Com::TYPEDESC) -> windows_result::Result<windows_core::BSTR>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IDebugHelper {
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn CreatePropertyBrowser<P1, P2>(&self, pvar: *const super::super::super::Variant::VARIANT, bstrname: P1, pdat: P2) -> windows_result::Result<super::IDebugProperty>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn CreatePropertyBrowserEx<P1, P2, P3>(&self, pvar: *const super::super::super::Variant::VARIANT, bstrname: P1, pdat: P2, pdf: P3) -> windows_result::Result<super::IDebugProperty>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<IDebugApplicationThread>,
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateSimpleConnectionPoint<P0>(&self, pdisp: P0) -> windows_result::Result<ISimpleConnectionPoint>
    where
        P0: windows_core::Param<super::super::super::Com::IDispatch>,
    {
        unsafe {
...
pub trait IDebugHelper_Impl: windows_core::IUnknownImpl {
    fn CreatePropertyBrowser(&self, pvar: *const super::super::super::Variant::VARIANT, bstrname: &windows_core::PCWSTR, pdat: windows_core::Ref<IDebugApplicationThread>) -> windows_result::Result<super::IDebugProperty>;
    fn CreatePropertyBrowserEx(&self, pvar: *const super::super::super::Variant::VARIANT, bstrname: &windows_core::PCWSTR, pdat: windows_core::Ref<IDebugApplicationThread>, pdf: windows_core::Ref<IDebugFormatter>) -> windows_result::Result<super::IDebugProperty>;
    fn CreateSimpleConnectionPoint(&self, pdisp: windows_core::Ref<super::super::super::Com::IDispatch>) -> windows_result::Result<ISimpleConnectionPoint>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IDebugSessionProvider {
    pub unsafe fn StartDebugSession<P0>(&self, pda: P0) -> windows_result::Result<()>
    where
...
pub trait IDebugSessionProvider_Impl: windows_core::IUnknownImpl {
    fn StartDebugSession(&self, pda: windows_core::Ref<IRemoteDebugApplication>) -> windows_result::Result<()>;
}
...
impl IDebugStackFrame {
    pub unsafe fn GetCodeContext(&self) -> windows_result::Result<IDebugCodeContext> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetDescriptionString(&self, flong: bool) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetLanguageString(&self, flong: bool) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetThread(&self) -> windows_result::Result<IDebugApplicationThread> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetDebugProperty(&self) -> windows_result::Result<super::IDebugProperty> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDebugStackFrame_Impl: windows_core::IUnknownImpl {
    fn GetCodeContext(&self) -> windows_result::Result<IDebugCodeContext>;
    fn GetDescriptionString(&self, flong: windows_core::BOOL) -> windows_result::Result<windows_core::BSTR>;
    fn GetLanguageString(&self, flong: windows_core::BOOL) -> windows_result::Result<windows_core::BSTR>;
    fn GetThread(&self) -> windows_result::Result<IDebugApplicationThread>;
    fn GetDebugProperty(&self) -> windows_result::Result<super::IDebugProperty>;
}
...
impl IDebugStackFrame110 {
    pub unsafe fn GetStackFrameType(&self) -> windows_result::Result<DEBUG_STACKFRAME_TYPE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetStackFrameType)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetScriptInvocationContext(&self) -> windows_result::Result<IScriptInvocationContext> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDebugStackFrame110_Impl: IDebugStackFrame_Impl {
    fn GetStackFrameType(&self) -> windows_result::Result<DEBUG_STACKFRAME_TYPE>;
    fn GetScriptInvocationContext(&self) -> windows_result::Result<IScriptInvocationContext>;
}
...
impl IDebugStackFrameSniffer {
    pub unsafe fn EnumStackFrames(&self) -> windows_result::Result<IEnumDebugStackFrames> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDebugStackFrameSniffer_Impl: windows_core::IUnknownImpl {
    fn EnumStackFrames(&self) -> windows_result::Result<IEnumDebugStackFrames>;
}
...
impl IDebugStackFrameSnifferEx32 {
    pub unsafe fn EnumStackFramesEx32(&self, dwspmin: u32) -> windows_result::Result<IEnumDebugStackFrames> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDebugStackFrameSnifferEx32_Impl: IDebugStackFrameSniffer_Impl {
    fn EnumStackFramesEx32(&self, dwspmin: u32) -> windows_result::Result<IEnumDebugStackFrames>;
}
...
impl IDebugStackFrameSnifferEx64 {
    pub unsafe fn EnumStackFramesEx64(&self, dwspmin: u64) -> windows_result::Result<IEnumDebugStackFrames64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDebugStackFrameSnifferEx64_Impl: IDebugStackFrameSniffer_Impl {
    fn EnumStackFramesEx64(&self, dwspmin: u64) -> windows_result::Result<IEnumDebugStackFrames64>;
}
...
impl IDebugSyncOperation {
    pub unsafe fn GetTargetThread(&self) -> windows_result::Result<IDebugApplicationThread> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Execute(&self) -> windows_result::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn InProgressAbort(&self) -> windows_result::Result<()> {
...
pub trait IDebugSyncOperation_Impl: windows_core::IUnknownImpl {
    fn GetTargetThread(&self) -> windows_result::Result<IDebugApplicationThread>;
    fn Execute(&self) -> windows_result::Result<windows_core::IUnknown>;
    fn InProgressAbort(&self) -> windows_result::Result<()>;
}
...
impl IDebugThreadCall32 {
    pub unsafe fn ThreadCallHandler(&self, dwparam1: u32, dwparam2: u32, dwparam3: u32) -> windows_result::Result<()> {
...
pub trait IDebugThreadCall32_Impl: windows_core::IUnknownImpl {
    fn ThreadCallHandler(&self, dwparam1: u32, dwparam2: u32, dwparam3: u32) -> windows_result::Result<()>;
}
...
impl IDebugThreadCall64 {
    pub unsafe fn ThreadCallHandler(&self, dwparam1: u64, dwparam2: u64, dwparam3: u64) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ThreadCallHandler)(windows_core::Interface::as_raw(self), dwparam1, dwparam2, dwparam3).ok() }
    }
}
#[repr(C)]
...
pub trait IDebugThreadCall64_Impl: windows_core::IUnknownImpl {
    fn ThreadCallHandler(&self, dwparam1: u64, dwparam2: u64, dwparam3: u64) -> windows_result::Result<()>;
}
...
impl IEnumDebugApplicationNodes {
    pub unsafe fn Next(&self, celt: u32, pprddp: *mut Option<IDebugApplicationNode>, pceltfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumDebugApplicationNodes> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumDebugApplicationNodes_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, pprddp: windows_core::OutRef<IDebugApplicationNode>, pceltfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumDebugApplicationNodes>;
}
...
impl IEnumDebugCodeContexts {
    pub unsafe fn Next(&self, celt: u32, pscc: *mut Option<IDebugCodeContext>, pceltfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumDebugCodeContexts> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumDebugCodeContexts_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, pscc: windows_core::OutRef<IDebugCodeContext>, pceltfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumDebugCodeContexts>;
}
...
impl IEnumDebugExpressionContexts {
    pub unsafe fn Next(&self, celt: u32, ppdec: *mut Option<IDebugExpressionContext>, pceltfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumDebugExpressionContexts> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumDebugExpressionContexts_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, ppdec: windows_core::OutRef<IDebugExpressionContext>, pceltfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumDebugExpressionContexts>;
}
...
impl IEnumDebugStackFrames {
    pub unsafe fn Next(&self, celt: u32, prgdsfd: *mut DebugStackFrameDescriptor, pceltfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumDebugStackFrames> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumDebugStackFrames_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, prgdsfd: *mut DebugStackFrameDescriptor, pceltfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumDebugStackFrames>;
}
...
impl IEnumDebugStackFrames64 {
    pub unsafe fn Next64(&self, celt: u32, prgdsfd: *mut DebugStackFrameDescriptor64, pceltfetched: *mut u32) -> windows_result::Result<()> {
...
pub trait IEnumDebugStackFrames64_Impl: IEnumDebugStackFrames_Impl {
    fn Next64(&self, celt: u32, prgdsfd: *mut DebugStackFrameDescriptor64, pceltfetched: *mut u32) -> windows_result::Result<()>;
}
...
impl IEnumJsStackFrames {
    pub unsafe fn Next(&self, pframes: &mut [JS_NATIVE_FRAME], pcfetched: *mut u32) -> windows_result::Result<()> {
...
pub trait IEnumJsStackFrames_Impl: windows_core::IUnknownImpl {
    fn Next(&self, cframecount: u32, pframes: *mut JS_NATIVE_FRAME, pcfetched: *mut u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
}
...
impl IEnumRemoteDebugApplicationThreads {
    pub unsafe fn Next(&self, celt: u32, pprdat: *mut Option<IRemoteDebugApplicationThread>, pceltfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumRemoteDebugApplicationThreads> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumRemoteDebugApplicationThreads_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, pprdat: windows_core::OutRef<IRemoteDebugApplicationThread>, pceltfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumRemoteDebugApplicationThreads>;
}
...
impl IEnumRemoteDebugApplications {
    pub unsafe fn Next(&self, celt: u32, ppda: *mut Option<IRemoteDebugApplication>, pceltfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumRemoteDebugApplications> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumRemoteDebugApplications_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, ppda: windows_core::OutRef<IRemoteDebugApplication>, pceltfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumRemoteDebugApplications>;
}
...
impl IJsDebug {
    pub unsafe fn OpenVirtualProcess<P2>(&self, processid: u32, runtimejsbaseaddress: u64, pdatatarget: P2) -> windows_result::Result<IJsDebugProcess>
    where
...
pub trait IJsDebug_Impl: windows_core::IUnknownImpl {
    fn OpenVirtualProcess(&self, processid: u32, runtimejsbaseaddress: u64, pdatatarget: windows_core::Ref<IJsDebugDataTarget>) -> windows_result::Result<IJsDebugProcess>;
}
impl IJsDebug_Vtbl {
...
impl IJsDebugBreakPoint {
    ...
    pub unsafe fn GetDocumentPosition(&self, pdocumentid: *mut u64, pcharacteroffset: *mut u32, pstatementcharcount: *mut u32) -> windows_result::Result<()> {
...
pub trait IJsDebugBreakPoint_Impl: windows_core::IUnknownImpl {
    ...
    fn GetDocumentPosition(&self, pdocumentid: *mut u64, pcharacteroffset: *mut u32, pstatementcharcount: *mut u32) -> windows_result::Result<()>;
}
...
impl IJsDebugDataTarget {
    pub unsafe fn ReadMemory(&self, address: u64, flags: JsDebugReadMemoryFlags, pbuffer: &mut [u8], pbytesread: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn WriteMemory(&self, address: u64, pmemory: &[u8]) -> windows_result::Result<()> {
    ...
    pub unsafe fn AllocateVirtualMemory(&self, address: u64, size: u32, allocationtype: u32, pageprotection: u32) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn FreeVirtualMemory(&self, address: u64, size: u32, freetype: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).FreeVirtualMemory)(windows_core::Interface::as_raw(self), address, size, freetype).ok() }
    }
    pub unsafe fn GetTlsValue(&self, threadid: u32, tlsindex: u32) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ReadBSTR(&self, address: u64) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ReadNullTerminatedString(&self, address: u64, charactersize: u16, maxcharacters: u32) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateStackFrameEnumerator(&self, threadid: u32) -> windows_result::Result<IEnumJsStackFrames> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetThreadContext(&self, threadid: u32, contextflags: u32, pcontext: &mut [u8]) -> windows_result::Result<()> {
...
pub trait IJsDebugDataTarget_Impl: windows_core::IUnknownImpl {
    fn ReadMemory(&self, address: u64, flags: JsDebugReadMemoryFlags, pbuffer: *mut u8, size: u32, pbytesread: *mut u32) -> windows_result::Result<()>;
    fn WriteMemory(&self, address: u64, pmemory: *const u8, size: u32) -> windows_result::Result<()>;
    fn AllocateVirtualMemory(&self, address: u64, size: u32, allocationtype: u32, pageprotection: u32) -> windows_result::Result<u64>;
    fn FreeVirtualMemory(&self, address: u64, size: u32, freetype: u32) -> windows_result::Result<()>;
    fn GetTlsValue(&self, threadid: u32, tlsindex: u32) -> windows_result::Result<u64>;
    fn ReadBSTR(&self, address: u64) -> windows_result::Result<windows_core::BSTR>;
    fn ReadNullTerminatedString(&self, address: u64, charactersize: u16, maxcharacters: u32) -> windows_result::Result<windows_core::BSTR>;
    fn CreateStackFrameEnumerator(&self, threadid: u32) -> windows_result::Result<IEnumJsStackFrames>;
    fn GetThreadContext(&self, threadid: u32, contextflags: u32, contextsize: u32, pcontext: *mut core::ffi::c_void) -> windows_result::Result<()>;
}
...
impl IJsDebugFrame {
    pub unsafe fn GetStackRange(&self, pstart: *mut u64, pend: *mut u64) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetDocumentPositionWithId(&self, pdocumentid: *mut u64, pcharacteroffset: *mut u32, pstatementcharcount: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetDocumentPositionWithName(&self, pdocumentname: *mut windows_core::BSTR, pline: *mut u32, pcolumn: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetDebugProperty(&self) -> windows_result::Result<IJsDebugProperty> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDebugProperty)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn GetReturnAddress(&self) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetReturnAddress)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn Evaluate<P0>(&self, pexpressiontext: P0, ppdebugproperty: *mut Option<IJsDebugProperty>, perror: *mut windows_core::BSTR) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IJsDebugFrame_Impl: windows_core::IUnknownImpl {
    fn GetStackRange(&self, pstart: *mut u64, pend: *mut u64) -> windows_result::Result<()>;
    fn GetName(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetDocumentPositionWithId(&self, pdocumentid: *mut u64, pcharacteroffset: *mut u32, pstatementcharcount: *mut u32) -> windows_result::Result<()>;
    fn GetDocumentPositionWithName(&self, pdocumentname: *mut windows_core::BSTR, pline: *mut u32, pcolumn: *mut u32) -> windows_result::Result<()>;
    fn GetDebugProperty(&self) -> windows_result::Result<IJsDebugProperty>;
    fn GetReturnAddress(&self) -> windows_result::Result<u64>;
    fn Evaluate(&self, pexpressiontext: &windows_core::PCWSTR, ppdebugproperty: windows_core::OutRef<IJsDebugProperty>, perror: *mut windows_core::BSTR) -> windows_result::Result<()>;
}
...
impl IJsDebugProcess {
    pub unsafe fn CreateStackWalker(&self, threadid: u32) -> windows_result::Result<IJsDebugStackWalker> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateBreakPoint(&self, documentid: u64, characteroffset: u32, charactercount: u32, isenabled: bool) -> windows_result::Result<IJsDebugBreakPoint> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn PerformAsyncBreak(&self, threadid: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).PerformAsyncBreak)(windows_core::Interface::as_raw(self), threadid).ok() }
    }
    pub unsafe fn GetExternalStepAddress(&self) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IJsDebugProcess_Impl: windows_core::IUnknownImpl {
    fn CreateStackWalker(&self, threadid: u32) -> windows_result::Result<IJsDebugStackWalker>;
    fn CreateBreakPoint(&self, documentid: u64, characteroffset: u32, charactercount: u32, isenabled: windows_core::BOOL) -> windows_result::Result<IJsDebugBreakPoint>;
    fn PerformAsyncBreak(&self, threadid: u32) -> windows_result::Result<()>;
    fn GetExternalStepAddress(&self) -> windows_result::Result<u64>;
}
...
impl IJsDebugProperty {
    pub unsafe fn GetPropertyInfo(&self, nradix: u32, ppropertyinfo: *mut JsDebugPropertyInfo) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetMembers(&self, members: JS_PROPERTY_MEMBERS) -> windows_result::Result<IJsEnumDebugProperty> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IJsDebugProperty_Impl: windows_core::IUnknownImpl {
    fn GetPropertyInfo(&self, nradix: u32, ppropertyinfo: *mut JsDebugPropertyInfo) -> windows_result::Result<()>;
    fn GetMembers(&self, members: JS_PROPERTY_MEMBERS) -> windows_result::Result<IJsEnumDebugProperty>;
}
...
impl IJsDebugStackWalker {
    pub unsafe fn GetNext(&self) -> windows_result::Result<IJsDebugFrame> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IJsDebugStackWalker_Impl: windows_core::IUnknownImpl {
    fn GetNext(&self) -> windows_result::Result<IJsDebugFrame>;
}
...
impl IJsEnumDebugProperty {
    pub unsafe fn Next(&self, ppdebugproperty: &mut [Option<IJsDebugProperty>], pactualcount: *mut u32) -> windows_result::Result<()> {
...
pub trait IJsEnumDebugProperty_Impl: windows_core::IUnknownImpl {
    fn Next(&self, count: u32, ppdebugproperty: *mut Option<IJsDebugProperty>, pactualcount: *mut u32) -> windows_result::Result<()>;
...
impl IMachineDebugManager {
    pub unsafe fn AddApplication<P0>(&self, pda: P0) -> windows_result::Result<u32>
    where
        P0: windows_core::Param<IRemoteDebugApplication>,
    {
        unsafe {
    ...
    pub unsafe fn RemoveApplication(&self, dwappcookie: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).RemoveApplication)(windows_core::Interface::as_raw(self), dwappcookie).ok() }
    }
    pub unsafe fn EnumApplications(&self) -> windows_result::Result<IEnumRemoteDebugApplications> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IMachineDebugManager_Impl: windows_core::IUnknownImpl {
    fn AddApplication(&self, pda: windows_core::Ref<IRemoteDebugApplication>) -> windows_result::Result<u32>;
    fn RemoveApplication(&self, dwappcookie: u32) -> windows_result::Result<()>;
    fn EnumApplications(&self) -> windows_result::Result<IEnumRemoteDebugApplications>;
}
...
impl IMachineDebugManagerCookie {
    pub unsafe fn AddApplication<P0>(&self, pda: P0, dwdebugappcookie: u32) -> windows_result::Result<u32>
    where
        P0: windows_core::Param<IRemoteDebugApplication>,
    {
        unsafe {
    ...
    pub unsafe fn RemoveApplication(&self, dwdebugappcookie: u32, dwappcookie: u32) -> windows_result::Result<()> {
...
pub trait IMachineDebugManagerCookie_Impl: windows_core::IUnknownImpl {
    fn AddApplication(&self, pda: windows_core::Ref<IRemoteDebugApplication>, dwdebugappcookie: u32) -> windows_result::Result<u32>;
    fn RemoveApplication(&self, dwdebugappcookie: u32, dwappcookie: u32) -> windows_result::Result<()>;
    fn EnumApplications(&self) -> windows_result::Result<IEnumRemoteDebugApplications>;
}
...
impl IMachineDebugManagerEvents {
    pub unsafe fn onAddApplication<P0>(&self, pda: P0, dwappcookie: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IRemoteDebugApplication>,
    {
    ...
    pub unsafe fn onRemoveApplication<P0>(&self, pda: P0, dwappcookie: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IRemoteDebugApplication>,
    {
...
pub trait IMachineDebugManagerEvents_Impl: windows_core::IUnknownImpl {
    fn onAddApplication(&self, pda: windows_core::Ref<IRemoteDebugApplication>, dwappcookie: u32) -> windows_result::Result<()>;
    fn onRemoveApplication(&self, pda: windows_core::Ref<IRemoteDebugApplication>, dwappcookie: u32) -> windows_result::Result<()>;
}
...
impl IProcessDebugManager32 {
    pub unsafe fn CreateApplication(&self) -> windows_result::Result<IDebugApplication32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetDefaultApplication(&self) -> windows_result::Result<IDebugApplication32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateDebugDocumentHelper<P0>(&self, punkouter: P0) -> windows_result::Result<IDebugDocumentHelper32>
    where
...
pub trait IProcessDebugManager32_Impl: windows_core::IUnknownImpl {
    fn CreateApplication(&self) -> windows_result::Result<IDebugApplication32>;
    fn GetDefaultApplication(&self) -> windows_result::Result<IDebugApplication32>;
    fn AddApplication(&self, pda: windows_core::Ref<IDebugApplication32>) -> windows_result::Result<u32>;
    fn RemoveApplication(&self, dwappcookie: u32) -> windows_result::Result<()>;
    fn CreateDebugDocumentHelper(&self, punkouter: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<IDebugDocumentHelper32>;
}
...
impl IProcessDebugManager64 {
    pub unsafe fn CreateApplication(&self) -> windows_result::Result<IDebugApplication64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateApplication)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn GetDefaultApplication(&self) -> windows_result::Result<IDebugApplication64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDefaultApplication)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn CreateDebugDocumentHelper<P0>(&self, punkouter: P0) -> windows_result::Result<IDebugDocumentHelper64>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
...
pub trait IProcessDebugManager64_Impl: windows_core::IUnknownImpl {
    fn CreateApplication(&self) -> windows_result::Result<IDebugApplication64>;
    fn GetDefaultApplication(&self) -> windows_result::Result<IDebugApplication64>;
    fn AddApplication(&self, pda: windows_core::Ref<IDebugApplication64>) -> windows_result::Result<u32>;
    fn RemoveApplication(&self, dwappcookie: u32) -> windows_result::Result<()>;
    fn CreateDebugDocumentHelper(&self, punkouter: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<IDebugDocumentHelper64>;
}
...
impl IProvideExpressionContexts {
    pub unsafe fn EnumExpressionContexts(&self) -> windows_result::Result<IEnumDebugExpressionContexts> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IProvideExpressionContexts_Impl: windows_core::IUnknownImpl {
    fn EnumExpressionContexts(&self) -> windows_result::Result<IEnumDebugExpressionContexts>;
}
...
impl IRemoteDebugApplication {
    pub unsafe fn ResumeFromBreakPoint<P0>(&self, prptfocus: P0, bra: BREAKRESUMEACTION, era: ERRORRESUMEACTION) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IRemoteDebugApplicationThread>,
    {
    ...
    pub unsafe fn CauseBreak(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).CauseBreak)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn ConnectDebugger<P0>(&self, pad: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn DisconnectDebugger(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).DisconnectDebugger)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn GetDebugger(&self) -> windows_result::Result<IApplicationDebugger> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateInstanceAtApplication<P1>(&self, rclsid: *const windows_core::GUID, punkouter: P1, dwclscontext: u32, riid: *const windows_core::GUID) -> windows_result::Result<windows_core::IUnknown>
    where
        P1: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
    ...
    pub unsafe fn EnumThreads(&self) -> windows_result::Result<IEnumRemoteDebugApplicationThreads> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetRootNode(&self) -> windows_result::Result<IDebugApplicationNode> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumGlobalExpressionContexts(&self) -> windows_result::Result<IEnumDebugExpressionContexts> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRemoteDebugApplication_Impl: windows_core::IUnknownImpl {
    fn ResumeFromBreakPoint(&self, prptfocus: windows_core::Ref<IRemoteDebugApplicationThread>, bra: BREAKRESUMEACTION, era: ERRORRESUMEACTION) -> windows_result::Result<()>;
    fn CauseBreak(&self) -> windows_result::Result<()>;
    fn ConnectDebugger(&self, pad: windows_core::Ref<IApplicationDebugger>) -> windows_result::Result<()>;
    fn DisconnectDebugger(&self) -> windows_result::Result<()>;
    fn GetDebugger(&self) -> windows_result::Result<IApplicationDebugger>;
    fn CreateInstanceAtApplication(&self, rclsid: *const windows_core::GUID, punkouter: windows_core::Ref<windows_core::IUnknown>, dwclscontext: u32, riid: *const windows_core::GUID) -> windows_result::Result<windows_core::IUnknown>;
    fn QueryAlive(&self) -> windows_result::Result<()>;
    fn EnumThreads(&self) -> windows_result::Result<IEnumRemoteDebugApplicationThreads>;
    fn GetName(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetRootNode(&self) -> windows_result::Result<IDebugApplicationNode>;
    fn EnumGlobalExpressionContexts(&self) -> windows_result::Result<IEnumDebugExpressionContexts>;
}
...
impl IRemoteDebugApplication110 {
    pub unsafe fn SetDebuggerOptions(&self, mask: SCRIPT_DEBUGGER_OPTIONS, value: SCRIPT_DEBUGGER_OPTIONS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetDebuggerOptions)(windows_core::Interface::as_raw(self), mask, value).ok() }
    }
    pub unsafe fn GetCurrentDebuggerOptions(&self) -> windows_result::Result<SCRIPT_DEBUGGER_OPTIONS> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetMainThread(&self) -> windows_result::Result<IRemoteDebugApplicationThread> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRemoteDebugApplication110_Impl: windows_core::IUnknownImpl {
    fn SetDebuggerOptions(&self, mask: SCRIPT_DEBUGGER_OPTIONS, value: SCRIPT_DEBUGGER_OPTIONS) -> windows_result::Result<()>;
    fn GetCurrentDebuggerOptions(&self) -> windows_result::Result<SCRIPT_DEBUGGER_OPTIONS>;
    fn GetMainThread(&self) -> windows_result::Result<IRemoteDebugApplicationThread>;
}
...
pub trait IRemoteDebugApplicationEvents_Impl: windows_core::IUnknownImpl {
    fn OnConnectDebugger(&self, pad: windows_core::Ref<IApplicationDebugger>) -> windows_result::Result<()>;
    fn OnDisconnectDebugger(&self) -> windows_result::Result<()>;
    fn OnSetName(&self, pstrname: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn OnDebugOutput(&self, pstr: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn OnClose(&self) -> windows_result::Result<()>;
    fn OnEnterBreakPoint(&self, prdat: windows_core::Ref<IRemoteDebugApplicationThread>) -> windows_result::Result<()>;
    fn OnLeaveBreakPoint(&self, prdat: windows_core::Ref<IRemoteDebugApplicationThread>) -> windows_result::Result<()>;
    fn OnCreateThread(&self, prdat: windows_core::Ref<IRemoteDebugApplicationThread>) -> windows_result::Result<()>;
    fn OnDestroyThread(&self, prdat: windows_core::Ref<IRemoteDebugApplicationThread>) -> windows_result::Result<()>;
    fn OnBreakFlagChange(&self, abf: u32, prdatsteppingthread: windows_core::Ref<IRemoteDebugApplicationThread>) -> windows_result::Result<()>;
}
...
impl IRemoteDebugApplicationThread {
    pub unsafe fn GetSystemThreadId(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSystemThreadId)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetApplication(&self) -> windows_result::Result<IRemoteDebugApplication> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetApplication)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn GetDescription(&self, pbstrdescription: *mut windows_core::BSTR, pbstrstate: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetNextStatement<P0, P1>(&self, pstackframe: P0, pcodecontext: P1) -> windows_result::Result<()>
    where
...
pub trait IRemoteDebugApplicationThread_Impl: windows_core::IUnknownImpl {
    fn GetSystemThreadId(&self) -> windows_result::Result<u32>;
    fn GetApplication(&self) -> windows_result::Result<IRemoteDebugApplication>;
    fn EnumStackFrames(&self) -> windows_result::Result<IEnumDebugStackFrames>;
    fn GetDescription(&self, pbstrdescription: *mut windows_core::BSTR, pbstrstate: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn SetNextStatement(&self, pstackframe: windows_core::Ref<IDebugStackFrame>, pcodecontext: windows_core::Ref<IDebugCodeContext>) -> windows_result::Result<()>;
    fn GetState(&self) -> windows_result::Result<u32>;
    fn Suspend(&self) -> windows_result::Result<u32>;
    fn Resume(&self) -> windows_result::Result<u32>;
    fn GetSuspendCount(&self) -> windows_result::Result<u32>;
}
...
impl IRemoteDebugCriticalErrorEvent110 {
    pub unsafe fn GetErrorInfo(&self, pbstrsource: *mut windows_core::BSTR, pmessageid: *mut i32, pbstrmessage: *mut windows_core::BSTR, pplocation: *mut Option<IDebugDocumentContext>) -> windows_result::Result<()> {
...
pub trait IRemoteDebugCriticalErrorEvent110_Impl: windows_core::IUnknownImpl {
    fn GetErrorInfo(&self, pbstrsource: *mut windows_core::BSTR, pmessageid: *mut i32, pbstrmessage: *mut windows_core::BSTR, pplocation: windows_core::OutRef<IDebugDocumentContext>) -> windows_result::Result<()>;
}
...
impl IRemoteDebugInfoEvent110 {
    pub unsafe fn GetEventInfo(&self, pmessagetype: *mut DEBUG_EVENT_INFO_TYPE, pbstrmessage: *mut windows_core::BSTR, pbstrurl: *mut windows_core::BSTR, pplocation: *mut Option<IDebugDocumentContext>) -> windows_result::Result<()> {
...
pub trait IRemoteDebugInfoEvent110_Impl: windows_core::IUnknownImpl {
    fn GetEventInfo(&self, pmessagetype: *mut DEBUG_EVENT_INFO_TYPE, pbstrmessage: *mut windows_core::BSTR, pbstrurl: *mut windows_core::BSTR, pplocation: windows_core::OutRef<IDebugDocumentContext>) -> windows_result::Result<()>;
}
...
impl IScriptEntry {
    ...
    pub unsafe fn SetText<P0>(&self, psz: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetText)(windows_core::Interface::as_raw(self), psz.param().abi()).ok() }
    }
    pub unsafe fn GetBody(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetBody<P0>(&self, psz: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetName<P0>(&self, psz: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetItemName<P0>(&self, psz: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetSignature(&self, ppti: *mut Option<super::super::super::Com::ITypeInfo>, pimethod: *mut u32) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn SetSignature<P0>(&self, pti: P0, imethod: u32) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetRange(&self, pichmin: *mut u32, pcch: *mut u32) -> windows_result::Result<()> {
...
pub trait IScriptEntry_Impl: IScriptNode_Impl {
    ...
    fn SetText(&self, psz: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetBody(&self) -> windows_result::Result<windows_core::BSTR>;
    fn SetBody(&self, psz: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetName(&self) -> windows_result::Result<windows_core::BSTR>;
    fn SetName(&self, psz: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetItemName(&self) -> windows_result::Result<windows_core::BSTR>;
    fn SetItemName(&self, psz: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetSignature(&self, ppti: windows_core::OutRef<super::super::super::Com::ITypeInfo>, pimethod: *mut u32) -> windows_result::Result<()>;
    fn SetSignature(&self, pti: windows_core::Ref<super::super::super::Com::ITypeInfo>, imethod: u32) -> windows_result::Result<()>;
    fn GetRange(&self, pichmin: *mut u32, pcch: *mut u32) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IScriptInvocationContext {
    pub unsafe fn GetContextType(&self) -> windows_result::Result<SCRIPT_INVOCATION_CONTEXT_TYPE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetContextObject(&self) -> windows_result::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IScriptInvocationContext_Impl: windows_core::IUnknownImpl {
    fn GetContextType(&self) -> windows_result::Result<SCRIPT_INVOCATION_CONTEXT_TYPE>;
    fn GetContextDescription(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetContextObject(&self) -> windows_result::Result<windows_core::IUnknown>;
}
...
impl IScriptNode {
    ...
    pub unsafe fn GetLanguage(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateChildEntry<P2>(&self, isn: u32, dwcookie: u32, pszdelimiter: P2) -> windows_result::Result<IScriptEntry>
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateChildHandler<P0, P3, P4, P5>(&self, pszdefaultname: P0, prgpsznames: &[windows_core::PCWSTR], pszevent: P3, pszdelimiter: P4, ptisignature: P5, imethodsignature: u32, isn: u32, dwcookie: u32) -> windows_result::Result<IScriptEntry>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P3: windows_core::Param<windows_core::PCWSTR>,
        P4: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IScriptNode_Impl: windows_core::IUnknownImpl {
    fn Alive(&self) -> windows_result::Result<()>;
    fn Delete(&self) -> windows_result::Result<()>;
    fn GetParent(&self) -> windows_result::Result<IScriptNode>;
    fn GetIndexInParent(&self) -> windows_result::Result<u32>;
    fn GetCookie(&self) -> windows_result::Result<u32>;
    fn GetNumberOfChildren(&self) -> windows_result::Result<u32>;
    fn GetChild(&self, isn: u32) -> windows_result::Result<IScriptNode>;
    fn GetLanguage(&self) -> windows_result::Result<windows_core::BSTR>;
    fn CreateChildEntry(&self, isn: u32, dwcookie: u32, pszdelimiter: &windows_core::PCWSTR) -> windows_result::Result<IScriptEntry>;
    fn CreateChildHandler(&self, pszdefaultname: &windows_core::PCWSTR, prgpsznames: *const windows_core::PCWSTR, cpsznames: u32, pszevent: &windows_core::PCWSTR, pszdelimiter: &windows_core::PCWSTR, ptisignature: windows_core::Ref<super::super::super::Com::ITypeInfo>, imethodsignature: u32, isn: u32, dwcookie: u32) -> windows_result::Result<IScriptEntry>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IScriptScriptlet {
    pub unsafe fn GetSubItemName(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetSubItemName<P0>(&self, psz: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetSubItemName)(windows_core::Interface::as_raw(self), psz.param().abi()).ok() }
    }
    pub unsafe fn GetEventName(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetEventName<P0>(&self, psz: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetEventName)(windows_core::Interface::as_raw(self), psz.param().abi()).ok() }
    }
    pub unsafe fn GetSimpleEventName(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetSimpleEventName<P0>(&self, psz: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IScriptScriptlet_Impl: IScriptEntry_Impl {
    fn GetSubItemName(&self) -> windows_result::Result<windows_core::BSTR>;
    fn SetSubItemName(&self, psz: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetEventName(&self) -> windows_result::Result<windows_core::BSTR>;
    fn SetEventName(&self, psz: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetSimpleEventName(&self) -> windows_result::Result<windows_core::BSTR>;
    fn SetSimpleEventName(&self, psz: &windows_core::PCWSTR) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl ISimpleConnectionPoint {
    pub unsafe fn GetEventCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetEventCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn DescribeEvents(&self, ievent: u32, cevents: u32, prgid: *mut i32, prgbstr: *mut windows_core::BSTR, pceventsfetched: *mut u32) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Advise<P0>(&self, pdisp: P0) -> windows_result::Result<u32>
    where
        P0: windows_core::Param<super::super::super::Com::IDispatch>,
    {
        unsafe {
...
pub trait ISimpleConnectionPoint_Impl: windows_core::IUnknownImpl {
    fn GetEventCount(&self) -> windows_result::Result<u32>;
    fn DescribeEvents(&self, ievent: u32, cevents: u32, prgid: *mut i32, prgbstr: *mut windows_core::BSTR, pceventsfetched: *mut u32) -> windows_result::Result<()>;
    fn Advise(&self, pdisp: windows_core::Ref<super::super::super::Com::IDispatch>) -> windows_result::Result<u32>;
...
impl ITridentEventSink {
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn FireEvent<P0>(&self, pstrevent: P0, pdp: *const super::super::super::Com::DISPPARAMS, pvarres: *mut super::super::super::Variant::VARIANT, pei: *mut super::super::super::Com::EXCEPINFO) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait ITridentEventSink_Impl: windows_core::IUnknownImpl {
    fn FireEvent(&self, pstrevent: &windows_core::PCWSTR, pdp: *const super::super::super::Com::DISPPARAMS, pvarres: *mut super::super::super::Variant::VARIANT, pei: *mut super::super::super::Com::EXCEPINFO) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IWebAppDiagnosticsObjectInitialization {
    pub unsafe fn Initialize<P1>(&self, hpassedhandle: super::super::super::super::Foundation::HANDLE_PTR, pdebugapplication: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::IUnknown>,
    {
...
pub trait IWebAppDiagnosticsObjectInitialization_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, hpassedhandle: super::super::super::super::Foundation::HANDLE_PTR, pdebugapplication: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
}
...
impl IWebAppDiagnosticsSetup {
    pub unsafe fn DiagnosticsSupported(&self) -> windows_result::Result<super::super::super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DiagnosticsSupported)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn CreateObjectWithSiteAtWebApp(&self, rclsid: *const windows_core::GUID, dwclscontext: u32, riid: *const windows_core::GUID, hpasstoobject: usize) -> windows_result::Result<()> {
...
pub trait IWebAppDiagnosticsSetup_Impl: windows_core::IUnknownImpl {
    fn DiagnosticsSupported(&self) -> windows_result::Result<super::super::super::super::Foundation::VARIANT_BOOL>;
    fn CreateObjectWithSiteAtWebApp(&self, rclsid: *const windows_core::GUID, dwclscontext: u32, riid: *const windows_core::GUID, hpasstoobject: usize) -> windows_result::Result<()>;
}
