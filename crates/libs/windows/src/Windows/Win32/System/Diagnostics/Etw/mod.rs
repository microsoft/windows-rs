...
impl ITraceEvent {
    pub unsafe fn Clone(&self) -> Result<ITraceEvent, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn GetUserContext(&self) -> Result<*mut core::ffi::c_void, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetUserContext)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetEventRecord(&self) -> Result<*mut EVENT_RECORD, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetEventRecord)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetPayload(&self, payload: &[u8]) -> Result<(), windows_result::HRESULT> {
...
pub trait ITraceEvent_Impl: windows_core::IUnknownImpl {
    fn Clone(&self) -> Result<ITraceEvent, windows_result::HRESULT>;
    fn GetUserContext(&self) -> Result<*mut core::ffi::c_void, windows_result::HRESULT>;
    fn GetEventRecord(&self) -> Result<*mut EVENT_RECORD, windows_result::HRESULT>;
    fn SetPayload(&self, payload: *const u8, payloadsize: u32) -> Result<(), windows_result::HRESULT>;
    fn SetEventDescriptor(&self, eventdescriptor: *const EVENT_DESCRIPTOR) -> Result<(), windows_result::HRESULT>;
    fn SetProcessId(&self, processid: u32) -> Result<(), windows_result::HRESULT>;
    fn SetProcessorIndex(&self, processorindex: u32) -> Result<(), windows_result::HRESULT>;
    fn SetThreadId(&self, threadid: u32) -> Result<(), windows_result::HRESULT>;
    fn SetThreadTimes(&self, kerneltime: u32, usertime: u32) -> Result<(), windows_result::HRESULT>;
    fn SetActivityId(&self, activityid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn SetTimeStamp(&self, timestamp: *const i64) -> Result<(), windows_result::HRESULT>;
    fn SetProviderId(&self, providerid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>;
}
...
impl ITraceEventCallback {
    pub unsafe fn OnBeginProcessTrace<P0, P1>(&self, headerevent: P0, relogger: P1) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn OnFinalizeProcessTrace<P0>(&self, relogger: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn OnEvent<P0, P1>(&self, event: P0, relogger: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ITraceEvent>,
        P1: windows_core::Param<ITraceRelogger>,
    {
...
pub trait ITraceEventCallback_Impl: windows_core::IUnknownImpl {
    fn OnBeginProcessTrace(&self, headerevent: windows_core::Ref<'_, ITraceEvent>, relogger: windows_core::Ref<'_, ITraceRelogger>) -> Result<(), windows_result::HRESULT>;
    fn OnFinalizeProcessTrace(&self, relogger: windows_core::Ref<'_, ITraceRelogger>) -> Result<(), windows_result::HRESULT>;
    fn OnEvent(&self, event: windows_core::Ref<'_, ITraceEvent>, relogger: windows_core::Ref<'_, ITraceRelogger>) -> Result<(), windows_result::HRESULT>;
}
...
impl ITraceRelogger {
    pub unsafe fn AddLogfileTraceStream(&self, logfilename: &windows_core::BSTR, usercontext: *const core::ffi::c_void) -> Result<RELOGSTREAM_HANDLE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AddRealtimeTraceStream(&self, loggername: &windows_core::BSTR, usercontext: *const core::ffi::c_void) -> Result<RELOGSTREAM_HANDLE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RegisterCallback<P0>(&self, callback: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Inject<P0>(&self, event: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ITraceEvent>,
    {
        unsafe { (windows_core::Interface::vtable(self).Inject)(windows_core::Interface::as_raw(self), event.param().abi()).ok() }
    }
    pub unsafe fn CreateEventInstance(&self, tracehandle: RELOGSTREAM_HANDLE, flags: u32) -> Result<ITraceEvent, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ProcessTrace(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).ProcessTrace)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn SetOutputFilename(&self, logfilename: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetCompressionMode(&self, compressionmode: bool) -> Result<(), windows_result::HRESULT> {
...
pub trait ITraceRelogger_Impl: windows_core::IUnknownImpl {
    fn AddLogfileTraceStream(&self, logfilename: &windows_core::BSTR, usercontext: *const core::ffi::c_void) -> Result<RELOGSTREAM_HANDLE, windows_result::HRESULT>;
    fn AddRealtimeTraceStream(&self, loggername: &windows_core::BSTR, usercontext: *const core::ffi::c_void) -> Result<RELOGSTREAM_HANDLE, windows_result::HRESULT>;
    fn RegisterCallback(&self, callback: windows_core::Ref<'_, ITraceEventCallback>) -> Result<(), windows_result::HRESULT>;
    fn Inject(&self, event: windows_core::Ref<'_, ITraceEvent>) -> Result<(), windows_result::HRESULT>;
    fn CreateEventInstance(&self, tracehandle: &RELOGSTREAM_HANDLE, flags: u32) -> Result<ITraceEvent, windows_result::HRESULT>;
    fn ProcessTrace(&self) -> Result<(), windows_result::HRESULT>;
    fn SetOutputFilename(&self, logfilename: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn SetCompressionMode(&self, compressionmode: bool) -> Result<(), windows_result::HRESULT>;
