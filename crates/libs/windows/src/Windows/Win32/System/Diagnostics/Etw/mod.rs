...
pub unsafe fn EnumerateTraceGuids(guidpropertiesarray: &mut [*mut TRACE_GUID_PROPERTIES], guidcount: *mut u32) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(EnumerateTraceGuids(::core::mem::transmute(guidpropertiesarray.as_ptr()), guidpropertiesarray.len() as _, ::core::mem::transmute(guidcount)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn EventWrite(reghandle: u64, eventdescriptor: *const EVENT_DESCRIPTOR, userdata: ::core::option::Option<&[EVENT_DATA_DESCRIPTOR]>) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(EventWrite(::core::mem::transmute(reghandle), ::core::mem::transmute(eventdescriptor), userdata.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(userdata.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr()))))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
#[doc = "*Required features: 'Win32_System_Diagnostics_Etw'*"]
#[inline]
pub unsafe fn EventWriteEx(reghandle: u64, eventdescriptor: *const EVENT_DESCRIPTOR, filter: u64, flags: u32, activityid: *const ::windows::core::GUID, relatedactivityid: *const ::windows::core::GUID, userdata: ::core::option::Option<&[EVENT_DATA_DESCRIPTOR]>) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
        ...
        ::core::mem::transmute(EventWriteEx(::core::mem::transmute(reghandle), ::core::mem::transmute(eventdescriptor), ::core::mem::transmute(filter), ::core::mem::transmute(flags), ::core::mem::transmute(activityid), ::core::mem::transmute(relatedactivityid), userdata.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(userdata.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr()))))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
#[doc = "*Required features: 'Win32_System_Diagnostics_Etw'*"]
#[inline]
pub unsafe fn EventWriteTransfer(reghandle: u64, eventdescriptor: *const EVENT_DESCRIPTOR, activityid: *const ::windows::core::GUID, relatedactivityid: *const ::windows::core::GUID, userdata: ::core::option::Option<&[EVENT_DATA_DESCRIPTOR]>) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
        ...
        ::core::mem::transmute(EventWriteTransfer(::core::mem::transmute(reghandle), ::core::mem::transmute(eventdescriptor), ::core::mem::transmute(activityid), ::core::mem::transmute(relatedactivityid), userdata.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(userdata.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr()))))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
impl ITraceEvent {
    ...
    pub unsafe fn SetPayload(&self, payload: &[u8]) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).SetPayload)(::core::mem::transmute_copy(self), ::core::mem::transmute(payload.as_ptr()), payload.len() as _).ok()
    }
    #[doc = "*Required features: 'Win32_System_Diagnostics_Etw'*"]
...
pub unsafe fn ProcessTrace(handlearray: &[u64], starttime: *const super::super::super::Foundation::FILETIME, endtime: *const super::super::super::Foundation::FILETIME) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(ProcessTrace(::core::mem::transmute(handlearray.as_ptr()), handlearray.len() as _, ::core::mem::transmute(starttime), ::core::mem::transmute(endtime)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn QueryAllTracesA(propertyarray: &mut [*mut EVENT_TRACE_PROPERTIES], loggercount: *mut u32) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(QueryAllTracesA(::core::mem::transmute(propertyarray.as_ptr()), propertyarray.len() as _, ::core::mem::transmute(loggercount)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn QueryAllTracesW(propertyarray: &mut [*mut EVENT_TRACE_PROPERTIES], loggercount: *mut u32) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(QueryAllTracesW(::core::mem::transmute(propertyarray.as_ptr()), propertyarray.len() as _, ::core::mem::transmute(loggercount)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn RegisterTraceGuidsA<'a, Param5: ::windows::core::IntoParam<'a, ::windows::core::PCSTR>, Param6: ::windows::core::IntoParam<'a, ::windows::core::PCSTR>>(requestaddress: WMIDPREQUEST, requestcontext: *const ::core::ffi::c_void, controlguid: *const ::windows::core::GUID, traceguidreg: ::core::option::Option<&[TRACE_GUID_REGISTRATION]>, mofimagepath: Param5, mofresourcename: Param6, registrationhandle: *mut u64) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(RegisterTraceGuidsA(::core::mem::transmute(requestaddress), ::core::mem::transmute(requestcontext), ::core::mem::transmute(controlguid), traceguidreg.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(traceguidreg.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), mofimagepath.into_param().abi(), mofresourcename.into_param().abi(), ::core::mem::transmute(registrationhandle)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn TdhAggregatePayloadFilters<'a, const PARAM0: usize>(payloadfilterptrs: &[*const ::core::ffi::c_void; PARAM0], eventmatchallflags: ::core::option::Option<&[super::super::super::Foundation::BOOLEAN; PARAM0]>, eventfilterdescriptor: *mut EVENT_FILTER_DESCRIPTOR) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
        ...
        ::core::mem::transmute(TdhAggregatePayloadFilters(PARAM0 as _, ::core::mem::transmute(payloadfilterptrs.as_ptr()), ::core::mem::transmute(eventmatchallflags.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), ::core::mem::transmute(eventfilterdescriptor)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn TdhCreatePayloadFilter<'a, Param2: ::windows::core::IntoParam<'a, super::super::super::Foundation::BOOLEAN>>(providerguid: *const ::windows::core::GUID, eventdescriptor: *const EVENT_DESCRIPTOR, eventmatchany: Param2, payloadpredicates: &[PAYLOAD_FILTER_PREDICATE], payloadfilter: *mut *mut ::core::ffi::c_void) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(TdhCreatePayloadFilter(::core::mem::transmute(providerguid), ::core::mem::transmute(eventdescriptor), eventmatchany.into_param().abi(), payloadpredicates.len() as _, ::core::mem::transmute(payloadpredicates.as_ptr()), ::core::mem::transmute(payloadfilter)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
#[doc = "*Required features: 'Win32_System_Diagnostics_Etw'*"]
#[inline]
pub unsafe fn TdhEnumerateProviderFilters(guid: *const ::windows::core::GUID, tdhcontext: ::core::option::Option<&[TDH_CONTEXT]>, filtercount: *mut u32, buffer: *mut *mut PROVIDER_FILTER_INFO, buffersize: *mut u32) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
        ...
        ::core::mem::transmute(TdhEnumerateProviderFilters(::core::mem::transmute(guid), tdhcontext.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(tdhcontext.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), ::core::mem::transmute(filtercount), ::core::mem::transmute(buffer), ::core::mem::transmute(buffersize)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
#[doc = "*Required features: 'Win32_System_Diagnostics_Etw'*"]
#[inline]
pub unsafe fn TdhGetEventInformation(event: *const EVENT_RECORD, tdhcontext: ::core::option::Option<&[TDH_CONTEXT]>, buffer: *mut TRACE_EVENT_INFO, buffersize: *mut u32) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
        ...
        ::core::mem::transmute(TdhGetEventInformation(::core::mem::transmute(event), tdhcontext.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(tdhcontext.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), ::core::mem::transmute(buffer), ::core::mem::transmute(buffersize)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
#[doc = "*Required features: 'Win32_System_Diagnostics_Etw'*"]
#[inline]
pub unsafe fn TdhGetProperty(pevent: *const EVENT_RECORD, ptdhcontext: ::core::option::Option<&[TDH_CONTEXT]>, ppropertydata: &[PROPERTY_DATA_DESCRIPTOR], buffersize: u32, pbuffer: *mut u8) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
        ...
        ::core::mem::transmute(TdhGetProperty(::core::mem::transmute(pevent), ptdhcontext.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(ptdhcontext.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), ppropertydata.len() as _, ::core::mem::transmute(ppropertydata.as_ptr()), ::core::mem::transmute(buffersize), ::core::mem::transmute(pbuffer)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn TdhGetPropertySize(pevent: *const EVENT_RECORD, ptdhcontext: ::core::option::Option<&[TDH_CONTEXT]>, ppropertydata: &[PROPERTY_DATA_DESCRIPTOR], ppropertysize: *mut u32) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(TdhGetPropertySize(::core::mem::transmute(pevent), ptdhcontext.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(ptdhcontext.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), ppropertydata.len() as _, ::core::mem::transmute(ppropertydata.as_ptr()), ::core::mem::transmute(ppropertysize)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
