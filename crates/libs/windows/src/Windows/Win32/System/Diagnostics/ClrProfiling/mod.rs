...
impl ICorProfilerAssemblyReferenceProvider {
    #[cfg(feature = "Win32_System_WinRT_Metadata")]
    pub unsafe fn AddAssemblyReference(&self, passemblyrefinfo: *const COR_PRF_ASSEMBLY_REFERENCE_INFO) -> windows_result::Result<()> {
...
pub trait ICorProfilerAssemblyReferenceProvider_Impl: windows_core::IUnknownImpl {
    fn AddAssemblyReference(&self, passemblyrefinfo: *const COR_PRF_ASSEMBLY_REFERENCE_INFO) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_WinRT_Metadata")]
...
impl ICorProfilerCallback {
    pub unsafe fn Initialize<P0>(&self, picorprofilerinfounk: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn AppDomainCreationStarted(&self, appdomainid: usize) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).AppDomainCreationStarted)(windows_core::Interface::as_raw(self), appdomainid).ok() }
    }
    pub unsafe fn AppDomainCreationFinished(&self, appdomainid: usize, hrstatus: windows_core::HRESULT) -> windows_result::Result<()> {
    ...
    pub unsafe fn AppDomainShutdownStarted(&self, appdomainid: usize) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).AppDomainShutdownStarted)(windows_core::Interface::as_raw(self), appdomainid).ok() }
    }
    pub unsafe fn AppDomainShutdownFinished(&self, appdomainid: usize, hrstatus: windows_core::HRESULT) -> windows_result::Result<()> {
    ...
    pub unsafe fn AssemblyLoadStarted(&self, assemblyid: usize) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).AssemblyLoadStarted)(windows_core::Interface::as_raw(self), assemblyid).ok() }
    }
    pub unsafe fn AssemblyLoadFinished(&self, assemblyid: usize, hrstatus: windows_core::HRESULT) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).AssemblyLoadFinished)(windows_core::Interface::as_raw(self), assemblyid, hrstatus).ok() }
    }
    pub unsafe fn AssemblyUnloadStarted(&self, assemblyid: usize) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).AssemblyUnloadStarted)(windows_core::Interface::as_raw(self), assemblyid).ok() }
    }
    pub unsafe fn AssemblyUnloadFinished(&self, assemblyid: usize, hrstatus: windows_core::HRESULT) -> windows_result::Result<()> {
    ...
    pub unsafe fn ModuleLoadStarted(&self, moduleid: usize) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ModuleLoadStarted)(windows_core::Interface::as_raw(self), moduleid).ok() }
    }
    pub unsafe fn ModuleLoadFinished(&self, moduleid: usize, hrstatus: windows_core::HRESULT) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ModuleLoadFinished)(windows_core::Interface::as_raw(self), moduleid, hrstatus).ok() }
    }
    pub unsafe fn ModuleUnloadStarted(&self, moduleid: usize) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ModuleUnloadStarted)(windows_core::Interface::as_raw(self), moduleid).ok() }
    }
    pub unsafe fn ModuleUnloadFinished(&self, moduleid: usize, hrstatus: windows_core::HRESULT) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ModuleUnloadFinished)(windows_core::Interface::as_raw(self), moduleid, hrstatus).ok() }
    }
    pub unsafe fn ModuleAttachedToAssembly(&self, moduleid: usize, assemblyid: usize) -> windows_result::Result<()> {
    ...
    pub unsafe fn JITCompilationFinished(&self, functionid: usize, hrstatus: windows_core::HRESULT, fissafetoblock: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn JITCachedFunctionSearchStarted(&self, functionid: usize) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
    ...
    pub unsafe fn JITCachedFunctionSearchFinished(&self, functionid: usize, result: COR_PRF_JIT_CACHE) -> windows_result::Result<()> {
    ...
    pub unsafe fn JITFunctionPitched(&self, functionid: usize) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).JITFunctionPitched)(windows_core::Interface::as_raw(self), functionid).ok() }
    }
    pub unsafe fn JITInlining(&self, callerid: usize, calleeid: usize) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ThreadCreated(&self, threadid: usize) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ThreadCreated)(windows_core::Interface::as_raw(self), threadid).ok() }
    }
    pub unsafe fn ThreadDestroyed(&self, threadid: usize) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ThreadDestroyed)(windows_core::Interface::as_raw(self), threadid).ok() }
    }
    pub unsafe fn ThreadAssignedToOSThread(&self, managedthreadid: usize, osthreadid: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn RemotingClientInvocationStarted(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).RemotingClientInvocationStarted)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn RemotingClientSendingMessage(&self, pcookie: *const windows_core::GUID, fisasync: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn RemotingClientReceivingReply(&self, pcookie: *const windows_core::GUID, fisasync: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn RemotingClientInvocationFinished(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).RemotingClientInvocationFinished)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn RemotingServerReceivingMessage(&self, pcookie: *const windows_core::GUID, fisasync: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn RemotingServerInvocationStarted(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).RemotingServerInvocationStarted)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn RemotingServerInvocationReturned(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).RemotingServerInvocationReturned)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn RemotingServerSendingReply(&self, pcookie: *const windows_core::GUID, fisasync: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn UnmanagedToManagedTransition(&self, functionid: usize, reason: COR_PRF_TRANSITION_REASON) -> windows_result::Result<()> {
    ...
    pub unsafe fn ManagedToUnmanagedTransition(&self, functionid: usize, reason: COR_PRF_TRANSITION_REASON) -> windows_result::Result<()> {
    ...
    pub unsafe fn ObjectAllocated(&self, objectid: usize, classid: usize) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ObjectAllocated)(windows_core::Interface::as_raw(self), objectid, classid).ok() }
    }
    pub unsafe fn ObjectsAllocatedByClass(&self, cclasscount: u32, classids: *const usize, cobjects: *const u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn ObjectReferences(&self, objectid: usize, classid: usize, objectrefids: &[usize]) -> windows_result::Result<()> {
    ...
    pub unsafe fn RootReferences(&self, rootrefids: &[usize]) -> windows_result::Result<()> {
    ...
    pub unsafe fn ExceptionCatcherLeave(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ExceptionCatcherLeave)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn COMClassicVTableCreated(&self, wrappedclassid: usize, implementediid: *const windows_core::GUID, pvtable: *const core::ffi::c_void, cslots: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn COMClassicVTableDestroyed(&self, wrappedclassid: usize, implementediid: *const windows_core::GUID, pvtable: *const core::ffi::c_void) -> windows_result::Result<()> {
    ...
    pub unsafe fn ExceptionCLRCatcherFound(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ExceptionCLRCatcherFound)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn ExceptionCLRCatcherExecute(&self) -> windows_result::Result<()> {
...
pub trait ICorProfilerCallback_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, picorprofilerinfounk: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn Shutdown(&self) -> windows_result::Result<()>;
    fn AppDomainCreationStarted(&self, appdomainid: usize) -> windows_result::Result<()>;
    fn AppDomainCreationFinished(&self, appdomainid: usize, hrstatus: windows_core::HRESULT) -> windows_result::Result<()>;
    fn AppDomainShutdownStarted(&self, appdomainid: usize) -> windows_result::Result<()>;
    fn AppDomainShutdownFinished(&self, appdomainid: usize, hrstatus: windows_core::HRESULT) -> windows_result::Result<()>;
    fn AssemblyLoadStarted(&self, assemblyid: usize) -> windows_result::Result<()>;
    fn AssemblyLoadFinished(&self, assemblyid: usize, hrstatus: windows_core::HRESULT) -> windows_result::Result<()>;
    fn AssemblyUnloadStarted(&self, assemblyid: usize) -> windows_result::Result<()>;
    fn AssemblyUnloadFinished(&self, assemblyid: usize, hrstatus: windows_core::HRESULT) -> windows_result::Result<()>;
    fn ModuleLoadStarted(&self, moduleid: usize) -> windows_result::Result<()>;
    fn ModuleLoadFinished(&self, moduleid: usize, hrstatus: windows_core::HRESULT) -> windows_result::Result<()>;
    fn ModuleUnloadStarted(&self, moduleid: usize) -> windows_result::Result<()>;
    fn ModuleUnloadFinished(&self, moduleid: usize, hrstatus: windows_core::HRESULT) -> windows_result::Result<()>;
    fn ModuleAttachedToAssembly(&self, moduleid: usize, assemblyid: usize) -> windows_result::Result<()>;
    fn ClassLoadStarted(&self, classid: usize) -> windows_result::Result<()>;
    fn ClassLoadFinished(&self, classid: usize, hrstatus: windows_core::HRESULT) -> windows_result::Result<()>;
    fn ClassUnloadStarted(&self, classid: usize) -> windows_result::Result<()>;
    fn ClassUnloadFinished(&self, classid: usize, hrstatus: windows_core::HRESULT) -> windows_result::Result<()>;
    fn FunctionUnloadStarted(&self, functionid: usize) -> windows_result::Result<()>;
    fn JITCompilationStarted(&self, functionid: usize, fissafetoblock: windows_core::BOOL) -> windows_result::Result<()>;
    fn JITCompilationFinished(&self, functionid: usize, hrstatus: windows_core::HRESULT, fissafetoblock: windows_core::BOOL) -> windows_result::Result<()>;
    fn JITCachedFunctionSearchStarted(&self, functionid: usize) -> windows_result::Result<windows_core::BOOL>;
    fn JITCachedFunctionSearchFinished(&self, functionid: usize, result: COR_PRF_JIT_CACHE) -> windows_result::Result<()>;
    fn JITFunctionPitched(&self, functionid: usize) -> windows_result::Result<()>;
    fn JITInlining(&self, callerid: usize, calleeid: usize) -> windows_result::Result<windows_core::BOOL>;
    fn ThreadCreated(&self, threadid: usize) -> windows_result::Result<()>;
    fn ThreadDestroyed(&self, threadid: usize) -> windows_result::Result<()>;
    fn ThreadAssignedToOSThread(&self, managedthreadid: usize, osthreadid: u32) -> windows_result::Result<()>;
    fn RemotingClientInvocationStarted(&self) -> windows_result::Result<()>;
    fn RemotingClientSendingMessage(&self, pcookie: *const windows_core::GUID, fisasync: windows_core::BOOL) -> windows_result::Result<()>;
    fn RemotingClientReceivingReply(&self, pcookie: *const windows_core::GUID, fisasync: windows_core::BOOL) -> windows_result::Result<()>;
    fn RemotingClientInvocationFinished(&self) -> windows_result::Result<()>;
    fn RemotingServerReceivingMessage(&self, pcookie: *const windows_core::GUID, fisasync: windows_core::BOOL) -> windows_result::Result<()>;
    fn RemotingServerInvocationStarted(&self) -> windows_result::Result<()>;
    fn RemotingServerInvocationReturned(&self) -> windows_result::Result<()>;
    fn RemotingServerSendingReply(&self, pcookie: *const windows_core::GUID, fisasync: windows_core::BOOL) -> windows_result::Result<()>;
    fn UnmanagedToManagedTransition(&self, functionid: usize, reason: COR_PRF_TRANSITION_REASON) -> windows_result::Result<()>;
    fn ManagedToUnmanagedTransition(&self, functionid: usize, reason: COR_PRF_TRANSITION_REASON) -> windows_result::Result<()>;
    fn RuntimeSuspendStarted(&self, suspendreason: COR_PRF_SUSPEND_REASON) -> windows_result::Result<()>;
    fn RuntimeSuspendFinished(&self) -> windows_result::Result<()>;
    fn RuntimeSuspendAborted(&self) -> windows_result::Result<()>;
    fn RuntimeResumeStarted(&self) -> windows_result::Result<()>;
    fn RuntimeResumeFinished(&self) -> windows_result::Result<()>;
    fn RuntimeThreadSuspended(&self, threadid: usize) -> windows_result::Result<()>;
    fn RuntimeThreadResumed(&self, threadid: usize) -> windows_result::Result<()>;
    fn MovedReferences(&self, cmovedobjectidranges: u32, oldobjectidrangestart: *const usize, newobjectidrangestart: *const usize, cobjectidrangelength: *const u32) -> windows_result::Result<()>;
    fn ObjectAllocated(&self, objectid: usize, classid: usize) -> windows_result::Result<()>;
    fn ObjectsAllocatedByClass(&self, cclasscount: u32, classids: *const usize, cobjects: *const u32) -> windows_result::Result<()>;
    fn ObjectReferences(&self, objectid: usize, classid: usize, cobjectrefs: u32, objectrefids: *const usize) -> windows_result::Result<()>;
    fn RootReferences(&self, crootrefs: u32, rootrefids: *const usize) -> windows_result::Result<()>;
    fn ExceptionThrown(&self, thrownobjectid: usize) -> windows_result::Result<()>;
    fn ExceptionSearchFunctionEnter(&self, functionid: usize) -> windows_result::Result<()>;
    fn ExceptionSearchFunctionLeave(&self) -> windows_result::Result<()>;
    fn ExceptionSearchFilterEnter(&self, functionid: usize) -> windows_result::Result<()>;
    fn ExceptionSearchFilterLeave(&self) -> windows_result::Result<()>;
    fn ExceptionSearchCatcherFound(&self, functionid: usize) -> windows_result::Result<()>;
    fn ExceptionOSHandlerEnter(&self, __unused: usize) -> windows_result::Result<()>;
    fn ExceptionOSHandlerLeave(&self, __unused: usize) -> windows_result::Result<()>;
    fn ExceptionUnwindFunctionEnter(&self, functionid: usize) -> windows_result::Result<()>;
    fn ExceptionUnwindFunctionLeave(&self) -> windows_result::Result<()>;
    fn ExceptionUnwindFinallyEnter(&self, functionid: usize) -> windows_result::Result<()>;
    fn ExceptionUnwindFinallyLeave(&self) -> windows_result::Result<()>;
    fn ExceptionCatcherEnter(&self, functionid: usize, objectid: usize) -> windows_result::Result<()>;
    fn ExceptionCatcherLeave(&self) -> windows_result::Result<()>;
    fn COMClassicVTableCreated(&self, wrappedclassid: usize, implementediid: *const windows_core::GUID, pvtable: *const core::ffi::c_void, cslots: u32) -> windows_result::Result<()>;
    fn COMClassicVTableDestroyed(&self, wrappedclassid: usize, implementediid: *const windows_core::GUID, pvtable: *const core::ffi::c_void) -> windows_result::Result<()>;
    fn ExceptionCLRCatcherFound(&self) -> windows_result::Result<()>;
    fn ExceptionCLRCatcherExecute(&self) -> windows_result::Result<()>;
}
...
impl ICorProfilerCallback10 {
    pub unsafe fn EventPipeEventDelivered(&self, provider: usize, eventid: u32, eventversion: u32, metadatablob: &[u8], eventdata: &[u8], pactivityid: *const windows_core::GUID, prelatedactivityid: *const windows_core::GUID, eventthread: usize, numstackframes: u32, stackframes: *const usize) -> windows_result::Result<()> {
    ...
    pub unsafe fn EventPipeProviderCreated(&self, provider: usize) -> windows_result::Result<()> {
...
pub trait ICorProfilerCallback10_Impl: ICorProfilerCallback9_Impl {
    fn EventPipeEventDelivered(&self, provider: usize, eventid: u32, eventversion: u32, cbmetadatablob: u32, metadatablob: *const u8, cbeventdata: u32, eventdata: *const u8, pactivityid: *const windows_core::GUID, prelatedactivityid: *const windows_core::GUID, eventthread: usize, numstackframes: u32, stackframes: *const usize) -> windows_result::Result<()>;
    fn EventPipeProviderCreated(&self, provider: usize) -> windows_result::Result<()>;
}
...
impl ICorProfilerCallback11 {
    pub unsafe fn LoadAsNotificationOnly(&self, pbnotificationonly: *mut windows_core::BOOL) -> windows_result::Result<()> {
...
pub trait ICorProfilerCallback11_Impl: ICorProfilerCallback10_Impl {
    fn LoadAsNotificationOnly(&self, pbnotificationonly: *mut windows_core::BOOL) -> windows_result::Result<()>;
}
...
impl ICorProfilerCallback2 {
    pub unsafe fn ThreadNameChanged(&self, threadid: usize, name: Option<&[u16]>) -> windows_result::Result<()> {
    ...
    pub unsafe fn GarbageCollectionStarted(&self, generationcollected: &[windows_core::BOOL], reason: COR_PRF_GC_REASON) -> windows_result::Result<()> {
    ...
    pub unsafe fn SurvivingReferences(&self, csurvivingobjectidranges: u32, objectidrangestart: *const usize, cobjectidrangelength: *const u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GarbageCollectionFinished(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GarbageCollectionFinished)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn FinalizeableObjectQueued(&self, finalizerflags: u32, objectid: usize) -> windows_result::Result<()> {
    ...
    pub unsafe fn RootReferences2(&self, crootrefs: u32, rootrefids: *const usize, rootkinds: *const COR_PRF_GC_ROOT_KIND, rootflags: *const COR_PRF_GC_ROOT_FLAGS, rootids: *const usize) -> windows_result::Result<()> {
    ...
    pub unsafe fn HandleCreated(&self, handleid: usize, initialobjectid: usize) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).HandleCreated)(windows_core::Interface::as_raw(self), handleid, initialobjectid).ok() }
    }
    pub unsafe fn HandleDestroyed(&self, handleid: usize) -> windows_result::Result<()> {
...
pub trait ICorProfilerCallback2_Impl: ICorProfilerCallback_Impl {
    fn ThreadNameChanged(&self, threadid: usize, cchname: u32, name: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GarbageCollectionStarted(&self, cgenerations: i32, generationcollected: *const windows_core::BOOL, reason: COR_PRF_GC_REASON) -> windows_result::Result<()>;
    fn SurvivingReferences(&self, csurvivingobjectidranges: u32, objectidrangestart: *const usize, cobjectidrangelength: *const u32) -> windows_result::Result<()>;
    fn GarbageCollectionFinished(&self) -> windows_result::Result<()>;
    fn FinalizeableObjectQueued(&self, finalizerflags: u32, objectid: usize) -> windows_result::Result<()>;
    fn RootReferences2(&self, crootrefs: u32, rootrefids: *const usize, rootkinds: *const COR_PRF_GC_ROOT_KIND, rootflags: *const COR_PRF_GC_ROOT_FLAGS, rootids: *const usize) -> windows_result::Result<()>;
    fn HandleCreated(&self, handleid: usize, initialobjectid: usize) -> windows_result::Result<()>;
    fn HandleDestroyed(&self, handleid: usize) -> windows_result::Result<()>;
}
...
impl ICorProfilerCallback3 {
    pub unsafe fn InitializeForAttach<P0>(&self, pcorprofilerinfounk: P0, pvclientdata: *const core::ffi::c_void, cbclientdata: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
    ...
    pub unsafe fn ProfilerAttachComplete(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ProfilerAttachComplete)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn ProfilerDetachSucceeded(&self) -> windows_result::Result<()> {
...
pub trait ICorProfilerCallback3_Impl: ICorProfilerCallback2_Impl {
    fn InitializeForAttach(&self, pcorprofilerinfounk: windows_core::Ref<windows_core::IUnknown>, pvclientdata: *const core::ffi::c_void, cbclientdata: u32) -> windows_result::Result<()>;
    fn ProfilerAttachComplete(&self) -> windows_result::Result<()>;
    fn ProfilerDetachSucceeded(&self) -> windows_result::Result<()>;
}
...
impl ICorProfilerCallback4 {
    pub unsafe fn ReJITCompilationStarted(&self, functionid: usize, rejitid: usize, fissafetoblock: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetReJITParameters<P2>(&self, moduleid: usize, methodid: u32, pfunctioncontrol: P2) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn ReJITCompilationFinished(&self, functionid: usize, rejitid: usize, hrstatus: windows_core::HRESULT, fissafetoblock: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn ReJITError(&self, moduleid: usize, methodid: u32, functionid: usize, hrstatus: windows_core::HRESULT) -> windows_result::Result<()> {
    ...
    pub unsafe fn MovedReferences2(&self, cmovedobjectidranges: u32, oldobjectidrangestart: *const usize, newobjectidrangestart: *const usize, cobjectidrangelength: *const usize) -> windows_result::Result<()> {
    ...
    pub unsafe fn SurvivingReferences2(&self, csurvivingobjectidranges: u32, objectidrangestart: *const usize, cobjectidrangelength: *const usize) -> windows_result::Result<()> {
...
pub trait ICorProfilerCallback4_Impl: ICorProfilerCallback3_Impl {
    fn ReJITCompilationStarted(&self, functionid: usize, rejitid: usize, fissafetoblock: windows_core::BOOL) -> windows_result::Result<()>;
    fn GetReJITParameters(&self, moduleid: usize, methodid: u32, pfunctioncontrol: windows_core::Ref<ICorProfilerFunctionControl>) -> windows_result::Result<()>;
    fn ReJITCompilationFinished(&self, functionid: usize, rejitid: usize, hrstatus: windows_core::HRESULT, fissafetoblock: windows_core::BOOL) -> windows_result::Result<()>;
    fn ReJITError(&self, moduleid: usize, methodid: u32, functionid: usize, hrstatus: windows_core::HRESULT) -> windows_result::Result<()>;
    fn MovedReferences2(&self, cmovedobjectidranges: u32, oldobjectidrangestart: *const usize, newobjectidrangestart: *const usize, cobjectidrangelength: *const usize) -> windows_result::Result<()>;
    fn SurvivingReferences2(&self, csurvivingobjectidranges: u32, objectidrangestart: *const usize, cobjectidrangelength: *const usize) -> windows_result::Result<()>;
}
...
impl ICorProfilerCallback5 {
    pub unsafe fn ConditionalWeakTableElementReferences(&self, crootrefs: u32, keyrefids: *const usize, valuerefids: *const usize, rootids: *const usize) -> windows_result::Result<()> {
...
pub trait ICorProfilerCallback5_Impl: ICorProfilerCallback4_Impl {
    fn ConditionalWeakTableElementReferences(&self, crootrefs: u32, keyrefids: *const usize, valuerefids: *const usize, rootids: *const usize) -> windows_result::Result<()>;
}
...
impl ICorProfilerCallback6 {
    pub unsafe fn GetAssemblyReferences<P0, P1>(&self, wszassemblypath: P0, pasmrefprovider: P1) -> windows_result::Result<()>
    where
...
pub trait ICorProfilerCallback6_Impl: ICorProfilerCallback5_Impl {
    fn GetAssemblyReferences(&self, wszassemblypath: &windows_core::PCWSTR, pasmrefprovider: windows_core::Ref<ICorProfilerAssemblyReferenceProvider>) -> windows_result::Result<()>;
}
...
impl ICorProfilerCallback7 {
    pub unsafe fn ModuleInMemorySymbolsUpdated(&self, moduleid: usize) -> windows_result::Result<()> {
...
pub trait ICorProfilerCallback7_Impl: ICorProfilerCallback6_Impl {
    fn ModuleInMemorySymbolsUpdated(&self, moduleid: usize) -> windows_result::Result<()>;
}
...
impl ICorProfilerCallback8 {
    pub unsafe fn DynamicMethodJITCompilationStarted(&self, functionid: usize, fissafetoblock: bool, pilheader: *const u8, cbilheader: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn DynamicMethodJITCompilationFinished(&self, functionid: usize, hrstatus: windows_core::HRESULT, fissafetoblock: bool) -> windows_result::Result<()> {
...
pub trait ICorProfilerCallback8_Impl: ICorProfilerCallback7_Impl {
    fn DynamicMethodJITCompilationStarted(&self, functionid: usize, fissafetoblock: windows_core::BOOL, pilheader: *const u8, cbilheader: u32) -> windows_result::Result<()>;
    fn DynamicMethodJITCompilationFinished(&self, functionid: usize, hrstatus: windows_core::HRESULT, fissafetoblock: windows_core::BOOL) -> windows_result::Result<()>;
}
...
impl ICorProfilerCallback9 {
    pub unsafe fn DynamicMethodUnloaded(&self, functionid: usize) -> windows_result::Result<()> {
...
pub trait ICorProfilerCallback9_Impl: ICorProfilerCallback8_Impl {
    fn DynamicMethodUnloaded(&self, functionid: usize) -> windows_result::Result<()>;
}
...
impl ICorProfilerFunctionControl {
    pub unsafe fn SetCodegenFlags(&self, flags: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetCodegenFlags)(windows_core::Interface::as_raw(self), flags).ok() }
    }
    pub unsafe fn SetILFunctionBody(&self, pbnewilmethodheader: &[u8]) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetILInstrumentedCodeMap(&self, rgilmapentries: &[COR_IL_MAP]) -> windows_result::Result<()> {
...
pub trait ICorProfilerFunctionControl_Impl: windows_core::IUnknownImpl {
    fn SetCodegenFlags(&self, flags: u32) -> windows_result::Result<()>;
    fn SetILFunctionBody(&self, cbnewilmethodheader: u32, pbnewilmethodheader: *const u8) -> windows_result::Result<()>;
    fn SetILInstrumentedCodeMap(&self, cilmapentries: u32, rgilmapentries: *const COR_IL_MAP) -> windows_result::Result<()>;
}
...
impl ICorProfilerFunctionEnum {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<ICorProfilerFunctionEnum> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Next(&self, ids: &mut [COR_PRF_FUNCTION], pceltfetched: *mut u32) -> windows_result::Result<()> {
...
pub trait ICorProfilerFunctionEnum_Impl: windows_core::IUnknownImpl {
    ...
    fn Clone(&self) -> windows_result::Result<ICorProfilerFunctionEnum>;
    fn GetCount(&self) -> windows_result::Result<u32>;
    fn Next(&self, celt: u32, ids: *mut COR_PRF_FUNCTION, pceltfetched: *mut u32) -> windows_result::Result<()>;
}
...
impl ICorProfilerInfo {
    pub unsafe fn GetClassFromObject(&self, objectid: usize) -> windows_result::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetClassFromToken(&self, moduleid: usize, typedef: u32) -> windows_result::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetCodeInfo(&self, functionid: usize, pstart: *mut *mut u8, pcsize: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetEventMask(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetEventMask)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetFunctionFromIP(&self, ip: *const u8) -> windows_result::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFunctionFromIP)(windows_core::Interface::as_raw(self), ip, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetFunctionFromToken(&self, moduleid: usize, token: u32) -> windows_result::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetHandleFromThread(&self, threadid: usize) -> windows_result::Result<super::super::super::Foundation::HANDLE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetObjectSize(&self, objectid: usize) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_WinRT_Metadata")]
    pub unsafe fn IsArrayClass(&self, classid: usize, pbaseelemtype: *mut super::super::WinRT::Metadata::CorElementType, pbaseclassid: *mut usize, pcrank: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetThreadInfo(&self, threadid: usize) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetThreadInfo)(windows_core::Interface::as_raw(self), threadid, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetCurrentThreadID(&self) -> windows_result::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCurrentThreadID)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetClassIDInfo(&self, classid: usize, pmoduleid: *mut usize, ptypedeftoken: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFunctionInfo(&self, functionid: usize, pclassid: *mut usize, pmoduleid: *mut usize, ptoken: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetEventMask(&self, dwevents: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetEventMask)(windows_core::Interface::as_raw(self), dwevents).ok() }
    }
    pub unsafe fn SetEnterLeaveFunctionHooks(&self, pfuncenter: *const FunctionEnter, pfuncleave: *const FunctionLeave, pfunctailcall: *const FunctionTailcall) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetFunctionIDMapper(&self, pfunc: *const FunctionIDMapper) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetFunctionIDMapper)(windows_core::Interface::as_raw(self), pfunc).ok() }
    }
    pub unsafe fn GetTokenAndMetaDataFromFunction(&self, functionid: usize, riid: *const windows_core::GUID, ppimport: *mut Option<windows_core::IUnknown>, ptoken: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetModuleInfo(&self, moduleid: usize, ppbaseloadaddress: *mut *mut u8, pcchname: *mut u32, szname: &mut [u16], passemblyid: *mut usize) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetModuleMetaData(&self, moduleid: usize, dwopenflags: u32, riid: *const windows_core::GUID) -> windows_result::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetILFunctionBody(&self, moduleid: usize, methodid: u32, ppmethodheader: *mut *mut u8, pcbmethodsize: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetILFunctionBodyAllocator(&self, moduleid: usize) -> windows_result::Result<IMethodMalloc> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetILFunctionBody(&self, moduleid: usize, methodid: u32, pbnewilmethodheader: *const u8) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetAppDomainInfo(&self, appdomainid: usize, pcchname: *mut u32, szname: &mut [u16], pprocessid: *mut usize) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetAssemblyInfo(&self, assemblyid: usize, pcchname: *mut u32, szname: &mut [u16], pappdomainid: *mut usize, pmoduleid: *mut usize) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetFunctionReJIT(&self, functionid: usize) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetFunctionReJIT)(windows_core::Interface::as_raw(self), functionid).ok() }
    }
    pub unsafe fn ForceGC(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ForceGC)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn SetILInstrumentedCodeMap(&self, functionid: usize, fstartjit: bool, rgilmapentries: &[COR_IL_MAP]) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetInprocInspectionInterface(&self) -> windows_result::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetInprocInspectionIThisThread(&self) -> windows_result::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetThreadContext(&self, threadid: usize) -> windows_result::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn BeginInprocDebugging(&self, fthisthreadonly: bool) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EndInprocDebugging(&self, dwprofilercontext: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).EndInprocDebugging)(windows_core::Interface::as_raw(self), dwprofilercontext).ok() }
    }
    pub unsafe fn GetILToNativeMapping(&self, functionid: usize, pcmap: *mut u32, map: &mut [COR_DEBUG_IL_TO_NATIVE_MAP]) -> windows_result::Result<()> {
...
pub trait ICorProfilerInfo_Impl: windows_core::IUnknownImpl {
    fn GetClassFromObject(&self, objectid: usize) -> windows_result::Result<usize>;
    fn GetClassFromToken(&self, moduleid: usize, typedef: u32) -> windows_result::Result<usize>;
    fn GetCodeInfo(&self, functionid: usize, pstart: *mut *mut u8, pcsize: *mut u32) -> windows_result::Result<()>;
    fn GetEventMask(&self) -> windows_result::Result<u32>;
    fn GetFunctionFromIP(&self, ip: *const u8) -> windows_result::Result<usize>;
    fn GetFunctionFromToken(&self, moduleid: usize, token: u32) -> windows_result::Result<usize>;
    fn GetHandleFromThread(&self, threadid: usize) -> windows_result::Result<super::super::super::Foundation::HANDLE>;
    fn GetObjectSize(&self, objectid: usize) -> windows_result::Result<u32>;
    fn IsArrayClass(&self, classid: usize, pbaseelemtype: *mut super::super::WinRT::Metadata::CorElementType, pbaseclassid: *mut usize, pcrank: *mut u32) -> windows_result::Result<()>;
    fn GetThreadInfo(&self, threadid: usize) -> windows_result::Result<u32>;
    fn GetCurrentThreadID(&self) -> windows_result::Result<usize>;
    fn GetClassIDInfo(&self, classid: usize, pmoduleid: *mut usize, ptypedeftoken: *mut u32) -> windows_result::Result<()>;
    fn GetFunctionInfo(&self, functionid: usize, pclassid: *mut usize, pmoduleid: *mut usize, ptoken: *mut u32) -> windows_result::Result<()>;
    fn SetEventMask(&self, dwevents: u32) -> windows_result::Result<()>;
    fn SetEnterLeaveFunctionHooks(&self, pfuncenter: *const FunctionEnter, pfuncleave: *const FunctionLeave, pfunctailcall: *const FunctionTailcall) -> windows_result::Result<()>;
    fn SetFunctionIDMapper(&self, pfunc: *const FunctionIDMapper) -> windows_result::Result<()>;
    fn GetTokenAndMetaDataFromFunction(&self, functionid: usize, riid: *const windows_core::GUID, ppimport: windows_core::OutRef<windows_core::IUnknown>, ptoken: *mut u32) -> windows_result::Result<()>;
    fn GetModuleInfo(&self, moduleid: usize, ppbaseloadaddress: *mut *mut u8, cchname: u32, pcchname: *mut u32, szname: windows_core::PWSTR, passemblyid: *mut usize) -> windows_result::Result<()>;
    fn GetModuleMetaData(&self, moduleid: usize, dwopenflags: u32, riid: *const windows_core::GUID) -> windows_result::Result<windows_core::IUnknown>;
    fn GetILFunctionBody(&self, moduleid: usize, methodid: u32, ppmethodheader: *mut *mut u8, pcbmethodsize: *mut u32) -> windows_result::Result<()>;
    fn GetILFunctionBodyAllocator(&self, moduleid: usize) -> windows_result::Result<IMethodMalloc>;
    fn SetILFunctionBody(&self, moduleid: usize, methodid: u32, pbnewilmethodheader: *const u8) -> windows_result::Result<()>;
    fn GetAppDomainInfo(&self, appdomainid: usize, cchname: u32, pcchname: *mut u32, szname: windows_core::PWSTR, pprocessid: *mut usize) -> windows_result::Result<()>;
    fn GetAssemblyInfo(&self, assemblyid: usize, cchname: u32, pcchname: *mut u32, szname: windows_core::PWSTR, pappdomainid: *mut usize, pmoduleid: *mut usize) -> windows_result::Result<()>;
    fn SetFunctionReJIT(&self, functionid: usize) -> windows_result::Result<()>;
    fn ForceGC(&self) -> windows_result::Result<()>;
    fn SetILInstrumentedCodeMap(&self, functionid: usize, fstartjit: windows_core::BOOL, cilmapentries: u32, rgilmapentries: *const COR_IL_MAP) -> windows_result::Result<()>;
    fn GetInprocInspectionInterface(&self) -> windows_result::Result<windows_core::IUnknown>;
    fn GetInprocInspectionIThisThread(&self) -> windows_result::Result<windows_core::IUnknown>;
    fn GetThreadContext(&self, threadid: usize) -> windows_result::Result<usize>;
    fn BeginInprocDebugging(&self, fthisthreadonly: windows_core::BOOL) -> windows_result::Result<u32>;
    fn EndInprocDebugging(&self, dwprofilercontext: u32) -> windows_result::Result<()>;
    fn GetILToNativeMapping(&self, functionid: usize, cmap: u32, pcmap: *mut u32, map: *mut COR_DEBUG_IL_TO_NATIVE_MAP) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_WinRT_Metadata")]
...
impl ICorProfilerInfo10 {
    pub unsafe fn EnumerateObjectReferences(&self, objectid: usize, callback: ObjectReferenceCallback, clientdata: *mut core::ffi::c_void) -> windows_result::Result<()> {
    ...
    pub unsafe fn IsFrozenObject(&self, objectid: usize, pbfrozen: *mut windows_core::BOOL) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).IsFrozenObject)(windows_core::Interface::as_raw(self), objectid, pbfrozen as _).ok() }
    }
    pub unsafe fn GetLOHObjectSizeThreshold(&self, pthreshold: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn RequestReJITWithInliners(&self, dwrejitflags: u32, cfunctions: u32, moduleids: *const usize, methodids: *const u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SuspendRuntime(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SuspendRuntime)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn ResumeRuntime(&self) -> windows_result::Result<()> {
...
pub trait ICorProfilerInfo10_Impl: ICorProfilerInfo9_Impl {
    fn EnumerateObjectReferences(&self, objectid: usize, callback: ObjectReferenceCallback, clientdata: *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn IsFrozenObject(&self, objectid: usize, pbfrozen: *mut windows_core::BOOL) -> windows_result::Result<()>;
    fn GetLOHObjectSizeThreshold(&self, pthreshold: *mut u32) -> windows_result::Result<()>;
    fn RequestReJITWithInliners(&self, dwrejitflags: u32, cfunctions: u32, moduleids: *const usize, methodids: *const u32) -> windows_result::Result<()>;
    fn SuspendRuntime(&self) -> windows_result::Result<()>;
    fn ResumeRuntime(&self) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_WinRT_Metadata")]
...
impl ICorProfilerInfo11 {
    pub unsafe fn GetEnvironmentVariableA<P0>(&self, szname: P0, pcchvalue: *mut u32, szvalue: &mut [u16]) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetEnvironmentVariable<P0, P1>(&self, szname: P0, szvalue: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
...
pub trait ICorProfilerInfo11_Impl: ICorProfilerInfo10_Impl {
    fn GetEnvironmentVariableA(&self, szname: &windows_core::PCWSTR, cchvalue: u32, pcchvalue: *mut u32, szvalue: windows_core::PWSTR) -> windows_result::Result<()>;
    fn SetEnvironmentVariable(&self, szname: &windows_core::PCWSTR, szvalue: &windows_core::PCWSTR) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_WinRT_Metadata")]
...
impl ICorProfilerInfo12 {
    pub unsafe fn EventPipeStartSession(&self, pproviderconfigs: &[COR_PRF_EVENTPIPE_PROVIDER_CONFIG], requestrundown: bool) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EventPipeAddProviderToSession(&self, session: u64, providerconfig: COR_PRF_EVENTPIPE_PROVIDER_CONFIG) -> windows_result::Result<()> {
    ...
    pub unsafe fn EventPipeStopSession(&self, session: u64) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).EventPipeStopSession)(windows_core::Interface::as_raw(self), session).ok() }
    }
    pub unsafe fn EventPipeCreateProvider<P0>(&self, providername: P0) -> windows_result::Result<usize>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn EventPipeGetProviderInfo(&self, provider: usize, pcchname: *mut u32, providername: &mut [u16]) -> windows_result::Result<()> {
    ...
    pub unsafe fn EventPipeDefineEvent<P1>(&self, provider: usize, eventname: P1, eventid: u32, keywords: u64, eventversion: u32, level: u32, opcode: u8, needstack: bool, pparamdescs: &[COR_PRF_EVENTPIPE_PARAM_DESC]) -> windows_result::Result<usize>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn EventPipeWriteEvent(&self, event: usize, data: &[COR_PRF_EVENT_DATA], pactivityid: *const windows_core::GUID, prelatedactivityid: *const windows_core::GUID) -> windows_result::Result<()> {
...
pub trait ICorProfilerInfo12_Impl: ICorProfilerInfo11_Impl {
    fn EventPipeStartSession(&self, cproviderconfigs: u32, pproviderconfigs: *const COR_PRF_EVENTPIPE_PROVIDER_CONFIG, requestrundown: windows_core::BOOL) -> windows_result::Result<u64>;
    fn EventPipeAddProviderToSession(&self, session: u64, providerconfig: &COR_PRF_EVENTPIPE_PROVIDER_CONFIG) -> windows_result::Result<()>;
    fn EventPipeStopSession(&self, session: u64) -> windows_result::Result<()>;
    fn EventPipeCreateProvider(&self, providername: &windows_core::PCWSTR) -> windows_result::Result<usize>;
    fn EventPipeGetProviderInfo(&self, provider: usize, cchname: u32, pcchname: *mut u32, providername: windows_core::PWSTR) -> windows_result::Result<()>;
    fn EventPipeDefineEvent(&self, provider: usize, eventname: &windows_core::PCWSTR, eventid: u32, keywords: u64, eventversion: u32, level: u32, opcode: u8, needstack: windows_core::BOOL, cparamdescs: u32, pparamdescs: *const COR_PRF_EVENTPIPE_PARAM_DESC) -> windows_result::Result<usize>;
    fn EventPipeWriteEvent(&self, event: usize, cdata: u32, data: *const COR_PRF_EVENT_DATA, pactivityid: *const windows_core::GUID, prelatedactivityid: *const windows_core::GUID) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_WinRT_Metadata")]
...
impl ICorProfilerInfo13 {
    pub unsafe fn CreateHandle(&self, object: usize, r#type: COR_PRF_HANDLE_TYPE, phandle: *mut *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).CreateHandle)(windows_core::Interface::as_raw(self), object, r#type, phandle as _).ok() }
    }
    pub unsafe fn DestroyHandle(&self, handle: *const *const core::ffi::c_void) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).DestroyHandle)(windows_core::Interface::as_raw(self), handle).ok() }
    }
    pub unsafe fn GetObjectIDFromHandle(&self, handle: *const *const core::ffi::c_void) -> windows_result::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ICorProfilerInfo13_Impl: ICorProfilerInfo12_Impl {
    fn CreateHandle(&self, object: usize, r#type: COR_PRF_HANDLE_TYPE, phandle: *mut *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn DestroyHandle(&self, handle: *const *const core::ffi::c_void) -> windows_result::Result<()>;
    fn GetObjectIDFromHandle(&self, handle: *const *const core::ffi::c_void) -> windows_result::Result<usize>;
}
#[cfg(feature = "Win32_System_WinRT_Metadata")]
...
impl ICorProfilerInfo14 {
    pub unsafe fn EnumerateNonGCObjects(&self) -> windows_result::Result<ICorProfilerObjectEnum> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetNonGCHeapBounds(&self, pcobjectranges: *mut u32, ranges: &mut [COR_PRF_NONGC_HEAP_RANGE]) -> windows_result::Result<()> {
    ...
    pub unsafe fn EventPipeCreateProvider2<P0>(&self, providername: P0, pcallback: *const EventPipeProviderCallback) -> windows_result::Result<usize>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
...
pub trait ICorProfilerInfo14_Impl: ICorProfilerInfo13_Impl {
    fn EnumerateNonGCObjects(&self) -> windows_result::Result<ICorProfilerObjectEnum>;
    fn GetNonGCHeapBounds(&self, cobjectranges: u32, pcobjectranges: *mut u32, ranges: *mut COR_PRF_NONGC_HEAP_RANGE) -> windows_result::Result<()>;
    fn EventPipeCreateProvider2(&self, providername: &windows_core::PCWSTR, pcallback: *const EventPipeProviderCallback) -> windows_result::Result<usize>;
}
#[cfg(feature = "Win32_System_WinRT_Metadata")]
...
impl ICorProfilerInfo2 {
    pub unsafe fn DoStackSnapshot(&self, thread: usize, callback: *const StackSnapshotCallback, infoflags: u32, clientdata: *const core::ffi::c_void, context: &[u8]) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetEnterLeaveFunctionHooks2(&self, pfuncenter: *const FunctionEnter2, pfuncleave: *const FunctionLeave2, pfunctailcall: *const FunctionTailcall2) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFunctionInfo2(&self, funcid: usize, frameinfo: usize, pclassid: *mut usize, pmoduleid: *mut usize, ptoken: *mut u32, ctypeargs: u32, pctypeargs: *mut u32, typeargs: *mut usize) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetStringLayout(&self, pbufferlengthoffset: *mut u32, pstringlengthoffset: *mut u32, pbufferoffset: *mut u32) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_System_WinRT_Metadata")]
    pub unsafe fn GetClassLayout(&self, classid: usize, rfieldoffset: *mut super::super::WinRT::Metadata::COR_FIELD_OFFSET, cfieldoffset: u32, pcfieldoffset: *mut u32, pulclasssize: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetClassIDInfo2(&self, classid: usize, pmoduleid: *mut usize, ptypedeftoken: *mut u32, pparentclassid: *mut usize, cnumtypeargs: u32, pcnumtypeargs: *mut u32, typeargs: *mut usize) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetCodeInfo2(&self, functionid: usize, pccodeinfos: *mut u32, codeinfos: &mut [COR_PRF_CODE_INFO]) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetClassFromTokenAndTypeArgs(&self, moduleid: usize, typedef: u32, typeargs: &[usize]) -> windows_result::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFunctionFromTokenAndTypeArgs(&self, moduleid: usize, funcdef: u32, classid: usize, typeargs: &[usize]) -> windows_result::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumModuleFrozenObjects(&self, moduleid: usize) -> windows_result::Result<ICorProfilerObjectEnum> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetArrayObjectInfo(&self, objectid: usize, cdimensions: u32, pdimensionsizes: *mut u32, pdimensionlowerbounds: *mut i32, ppdata: *mut *mut u8) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetBoxClassLayout(&self, classid: usize) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetThreadAppDomain(&self, threadid: usize) -> windows_result::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetRVAStaticAddress(&self, classid: usize, fieldtoken: u32, ppaddress: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetAppDomainStaticAddress(&self, classid: usize, fieldtoken: u32, appdomainid: usize, ppaddress: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetThreadStaticAddress(&self, classid: usize, fieldtoken: u32, threadid: usize, ppaddress: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetContextStaticAddress(&self, classid: usize, fieldtoken: u32, contextid: usize, ppaddress: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetStaticFieldInfo(&self, classid: usize, fieldtoken: u32) -> windows_result::Result<COR_PRF_STATIC_TYPE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetGenerationBounds(&self, pcobjectranges: *mut u32, ranges: &mut [COR_PRF_GC_GENERATION_RANGE]) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetObjectGeneration(&self, objectid: usize) -> windows_result::Result<COR_PRF_GC_GENERATION_RANGE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetNotifiedExceptionClauseInfo(&self) -> windows_result::Result<COR_PRF_EX_CLAUSE_INFO> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ICorProfilerInfo2_Impl: ICorProfilerInfo_Impl {
    fn DoStackSnapshot(&self, thread: usize, callback: *const StackSnapshotCallback, infoflags: u32, clientdata: *const core::ffi::c_void, context: *const u8, contextsize: u32) -> windows_result::Result<()>;
    fn SetEnterLeaveFunctionHooks2(&self, pfuncenter: *const FunctionEnter2, pfuncleave: *const FunctionLeave2, pfunctailcall: *const FunctionTailcall2) -> windows_result::Result<()>;
    fn GetFunctionInfo2(&self, funcid: usize, frameinfo: usize, pclassid: *mut usize, pmoduleid: *mut usize, ptoken: *mut u32, ctypeargs: u32, pctypeargs: *mut u32, typeargs: *mut usize) -> windows_result::Result<()>;
    fn GetStringLayout(&self, pbufferlengthoffset: *mut u32, pstringlengthoffset: *mut u32, pbufferoffset: *mut u32) -> windows_result::Result<()>;
    fn GetClassLayout(&self, classid: usize, rfieldoffset: *mut super::super::WinRT::Metadata::COR_FIELD_OFFSET, cfieldoffset: u32, pcfieldoffset: *mut u32, pulclasssize: *mut u32) -> windows_result::Result<()>;
    fn GetClassIDInfo2(&self, classid: usize, pmoduleid: *mut usize, ptypedeftoken: *mut u32, pparentclassid: *mut usize, cnumtypeargs: u32, pcnumtypeargs: *mut u32, typeargs: *mut usize) -> windows_result::Result<()>;
    fn GetCodeInfo2(&self, functionid: usize, ccodeinfos: u32, pccodeinfos: *mut u32, codeinfos: *mut COR_PRF_CODE_INFO) -> windows_result::Result<()>;
    fn GetClassFromTokenAndTypeArgs(&self, moduleid: usize, typedef: u32, ctypeargs: u32, typeargs: *const usize) -> windows_result::Result<usize>;
    fn GetFunctionFromTokenAndTypeArgs(&self, moduleid: usize, funcdef: u32, classid: usize, ctypeargs: u32, typeargs: *const usize) -> windows_result::Result<usize>;
    fn EnumModuleFrozenObjects(&self, moduleid: usize) -> windows_result::Result<ICorProfilerObjectEnum>;
    fn GetArrayObjectInfo(&self, objectid: usize, cdimensions: u32, pdimensionsizes: *mut u32, pdimensionlowerbounds: *mut i32, ppdata: *mut *mut u8) -> windows_result::Result<()>;
    fn GetBoxClassLayout(&self, classid: usize) -> windows_result::Result<u32>;
    fn GetThreadAppDomain(&self, threadid: usize) -> windows_result::Result<usize>;
    fn GetRVAStaticAddress(&self, classid: usize, fieldtoken: u32, ppaddress: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn GetAppDomainStaticAddress(&self, classid: usize, fieldtoken: u32, appdomainid: usize, ppaddress: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn GetThreadStaticAddress(&self, classid: usize, fieldtoken: u32, threadid: usize, ppaddress: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn GetContextStaticAddress(&self, classid: usize, fieldtoken: u32, contextid: usize, ppaddress: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn GetStaticFieldInfo(&self, classid: usize, fieldtoken: u32) -> windows_result::Result<COR_PRF_STATIC_TYPE>;
    fn GetGenerationBounds(&self, cobjectranges: u32, pcobjectranges: *mut u32, ranges: *mut COR_PRF_GC_GENERATION_RANGE) -> windows_result::Result<()>;
    fn GetObjectGeneration(&self, objectid: usize) -> windows_result::Result<COR_PRF_GC_GENERATION_RANGE>;
    fn GetNotifiedExceptionClauseInfo(&self) -> windows_result::Result<COR_PRF_EX_CLAUSE_INFO>;
}
#[cfg(feature = "Win32_System_WinRT_Metadata")]
...
impl ICorProfilerInfo3 {
    pub unsafe fn EnumJITedFunctions(&self) -> windows_result::Result<ICorProfilerFunctionEnum> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RequestProfilerDetach(&self, dwexpectedcompletionmilliseconds: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetFunctionIDMapper2(&self, pfunc: *const FunctionIDMapper2, clientdata: *const core::ffi::c_void) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetFunctionIDMapper2)(windows_core::Interface::as_raw(self), pfunc, clientdata).ok() }
    }
    pub unsafe fn GetStringLayout2(&self, pstringlengthoffset: *mut u32, pbufferoffset: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetEnterLeaveFunctionHooks3(&self, pfuncenter3: *const FunctionEnter3, pfuncleave3: *const FunctionLeave3, pfunctailcall3: *const FunctionTailcall3) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetEnterLeaveFunctionHooks3WithInfo(&self, pfuncenter3withinfo: *const FunctionEnter3WithInfo, pfuncleave3withinfo: *const FunctionLeave3WithInfo, pfunctailcall3withinfo: *const FunctionTailcall3WithInfo) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFunctionEnter3Info(&self, functionid: usize, eltinfo: usize, pframeinfo: *mut usize, pcbargumentinfo: *mut u32, pargumentinfo: *mut COR_PRF_FUNCTION_ARGUMENT_INFO) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFunctionLeave3Info(&self, functionid: usize, eltinfo: usize, pframeinfo: *mut usize, pretvalrange: *mut COR_PRF_FUNCTION_ARGUMENT_RANGE) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFunctionTailcall3Info(&self, functionid: usize, eltinfo: usize) -> windows_result::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumModules(&self) -> windows_result::Result<ICorProfilerModuleEnum> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetRuntimeInformation(&self, pclrinstanceid: *mut u16, pruntimetype: *mut COR_PRF_RUNTIME_TYPE, pmajorversion: *mut u16, pminorversion: *mut u16, pbuildnumber: *mut u16, pqfeversion: *mut u16, pcchversionstring: *mut u32, szversionstring: &mut [u16]) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetThreadStaticAddress2(&self, classid: usize, fieldtoken: u32, appdomainid: usize, threadid: usize, ppaddress: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetAppDomainsContainingModule(&self, moduleid: usize, pcappdomainids: *mut u32, appdomainids: &mut [usize]) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetModuleInfo2(&self, moduleid: usize, ppbaseloadaddress: *mut *mut u8, pcchname: *mut u32, szname: &mut [u16], passemblyid: *mut usize, pdwmoduleflags: *mut u32) -> windows_result::Result<()> {
...
pub trait ICorProfilerInfo3_Impl: ICorProfilerInfo2_Impl {
    fn EnumJITedFunctions(&self) -> windows_result::Result<ICorProfilerFunctionEnum>;
    fn RequestProfilerDetach(&self, dwexpectedcompletionmilliseconds: u32) -> windows_result::Result<()>;
    fn SetFunctionIDMapper2(&self, pfunc: *const FunctionIDMapper2, clientdata: *const core::ffi::c_void) -> windows_result::Result<()>;
    fn GetStringLayout2(&self, pstringlengthoffset: *mut u32, pbufferoffset: *mut u32) -> windows_result::Result<()>;
    fn SetEnterLeaveFunctionHooks3(&self, pfuncenter3: *const FunctionEnter3, pfuncleave3: *const FunctionLeave3, pfunctailcall3: *const FunctionTailcall3) -> windows_result::Result<()>;
    fn SetEnterLeaveFunctionHooks3WithInfo(&self, pfuncenter3withinfo: *const FunctionEnter3WithInfo, pfuncleave3withinfo: *const FunctionLeave3WithInfo, pfunctailcall3withinfo: *const FunctionTailcall3WithInfo) -> windows_result::Result<()>;
    fn GetFunctionEnter3Info(&self, functionid: usize, eltinfo: usize, pframeinfo: *mut usize, pcbargumentinfo: *mut u32, pargumentinfo: *mut COR_PRF_FUNCTION_ARGUMENT_INFO) -> windows_result::Result<()>;
    fn GetFunctionLeave3Info(&self, functionid: usize, eltinfo: usize, pframeinfo: *mut usize, pretvalrange: *mut COR_PRF_FUNCTION_ARGUMENT_RANGE) -> windows_result::Result<()>;
    fn GetFunctionTailcall3Info(&self, functionid: usize, eltinfo: usize) -> windows_result::Result<usize>;
    fn EnumModules(&self) -> windows_result::Result<ICorProfilerModuleEnum>;
    fn GetRuntimeInformation(&self, pclrinstanceid: *mut u16, pruntimetype: *mut COR_PRF_RUNTIME_TYPE, pmajorversion: *mut u16, pminorversion: *mut u16, pbuildnumber: *mut u16, pqfeversion: *mut u16, cchversionstring: u32, pcchversionstring: *mut u32, szversionstring: windows_core::PWSTR) -> windows_result::Result<()>;
    fn GetThreadStaticAddress2(&self, classid: usize, fieldtoken: u32, appdomainid: usize, threadid: usize, ppaddress: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn GetAppDomainsContainingModule(&self, moduleid: usize, cappdomainids: u32, pcappdomainids: *mut u32, appdomainids: *mut usize) -> windows_result::Result<()>;
    fn GetModuleInfo2(&self, moduleid: usize, ppbaseloadaddress: *mut *mut u8, cchname: u32, pcchname: *mut u32, szname: windows_core::PWSTR, passemblyid: *mut usize, pdwmoduleflags: *mut u32) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_WinRT_Metadata")]
...
impl ICorProfilerInfo4 {
    pub unsafe fn EnumThreads(&self) -> windows_result::Result<ICorProfilerThreadEnum> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn InitializeCurrentThread(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).InitializeCurrentThread)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn RequestReJIT(&self, cfunctions: u32, moduleids: *const usize, methodids: *const u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn RequestRevert(&self, cfunctions: u32, moduleids: *const usize, methodids: *const u32, status: *mut windows_core::HRESULT) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetCodeInfo3(&self, functionid: usize, rejitid: usize, pccodeinfos: *mut u32, codeinfos: &mut [COR_PRF_CODE_INFO]) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFunctionFromIP2(&self, ip: *const u8, pfunctionid: *mut usize, prejitid: *mut usize) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetReJITIDs(&self, functionid: usize, pcrejitids: *mut u32, rejitids: &mut [usize]) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetILToNativeMapping2(&self, functionid: usize, rejitid: usize, pcmap: *mut u32, map: &mut [COR_DEBUG_IL_TO_NATIVE_MAP]) -> windows_result::Result<()> {
    ...
    pub unsafe fn EnumJITedFunctions2(&self) -> windows_result::Result<ICorProfilerFunctionEnum> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetObjectSize2(&self, objectid: usize) -> windows_result::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ICorProfilerInfo4_Impl: ICorProfilerInfo3_Impl {
    fn EnumThreads(&self) -> windows_result::Result<ICorProfilerThreadEnum>;
    fn InitializeCurrentThread(&self) -> windows_result::Result<()>;
    fn RequestReJIT(&self, cfunctions: u32, moduleids: *const usize, methodids: *const u32) -> windows_result::Result<()>;
    fn RequestRevert(&self, cfunctions: u32, moduleids: *const usize, methodids: *const u32, status: *mut windows_core::HRESULT) -> windows_result::Result<()>;
    fn GetCodeInfo3(&self, functionid: usize, rejitid: usize, ccodeinfos: u32, pccodeinfos: *mut u32, codeinfos: *mut COR_PRF_CODE_INFO) -> windows_result::Result<()>;
    fn GetFunctionFromIP2(&self, ip: *const u8, pfunctionid: *mut usize, prejitid: *mut usize) -> windows_result::Result<()>;
    fn GetReJITIDs(&self, functionid: usize, crejitids: u32, pcrejitids: *mut u32, rejitids: *mut usize) -> windows_result::Result<()>;
    fn GetILToNativeMapping2(&self, functionid: usize, rejitid: usize, cmap: u32, pcmap: *mut u32, map: *mut COR_DEBUG_IL_TO_NATIVE_MAP) -> windows_result::Result<()>;
    fn EnumJITedFunctions2(&self) -> windows_result::Result<ICorProfilerFunctionEnum>;
    fn GetObjectSize2(&self, objectid: usize) -> windows_result::Result<usize>;
}
#[cfg(feature = "Win32_System_WinRT_Metadata")]
...
impl ICorProfilerInfo5 {
    pub unsafe fn GetEventMask2(&self, pdweventslow: *mut u32, pdweventshigh: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetEventMask2(&self, dweventslow: u32, dweventshigh: u32) -> windows_result::Result<()> {
...
pub trait ICorProfilerInfo5_Impl: ICorProfilerInfo4_Impl {
    fn GetEventMask2(&self, pdweventslow: *mut u32, pdweventshigh: *mut u32) -> windows_result::Result<()>;
    fn SetEventMask2(&self, dweventslow: u32, dweventshigh: u32) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_WinRT_Metadata")]
...
impl ICorProfilerInfo6 {
    pub unsafe fn EnumNgenModuleMethodsInliningThisMethod(&self, inlinersmoduleid: usize, inlineemoduleid: usize, inlineemethodid: u32, incompletedata: *mut windows_core::BOOL, ppenum: *mut Option<ICorProfilerMethodEnum>) -> windows_result::Result<()> {
...
pub trait ICorProfilerInfo6_Impl: ICorProfilerInfo5_Impl {
    fn EnumNgenModuleMethodsInliningThisMethod(&self, inlinersmoduleid: usize, inlineemoduleid: usize, inlineemethodid: u32, incompletedata: *mut windows_core::BOOL, ppenum: windows_core::OutRef<ICorProfilerMethodEnum>) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_WinRT_Metadata")]
...
impl ICorProfilerInfo7 {
    pub unsafe fn ApplyMetaData(&self, moduleid: usize) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ApplyMetaData)(windows_core::Interface::as_raw(self), moduleid).ok() }
    }
    pub unsafe fn GetInMemorySymbolsLength(&self, moduleid: usize) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ReadInMemorySymbols(&self, moduleid: usize, symbolsreadoffset: u32, psymbolbytes: *mut u8, countsymbolbytes: u32, pcountsymbolbytesread: *mut u32) -> windows_result::Result<()> {
...
pub trait ICorProfilerInfo7_Impl: ICorProfilerInfo6_Impl {
    fn ApplyMetaData(&self, moduleid: usize) -> windows_result::Result<()>;
    fn GetInMemorySymbolsLength(&self, moduleid: usize) -> windows_result::Result<u32>;
    fn ReadInMemorySymbols(&self, moduleid: usize, symbolsreadoffset: u32, psymbolbytes: *mut u8, countsymbolbytes: u32, pcountsymbolbytesread: *mut u32) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_WinRT_Metadata")]
...
impl ICorProfilerInfo8 {
    pub unsafe fn IsFunctionDynamic(&self, functionid: usize) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFunctionFromIP3(&self, ip: *const u8, functionid: *mut usize, prejitid: *mut usize) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetDynamicFunctionInfo(&self, functionid: usize, moduleid: *mut usize, ppvsig: *mut *mut u8, pbsig: *mut u32, cchname: u32, pcchname: *mut u32, wszname: windows_core::PWSTR) -> windows_result::Result<()> {
...
pub trait ICorProfilerInfo8_Impl: ICorProfilerInfo7_Impl {
    fn IsFunctionDynamic(&self, functionid: usize) -> windows_result::Result<windows_core::BOOL>;
    fn GetFunctionFromIP3(&self, ip: *const u8, functionid: *mut usize, prejitid: *mut usize) -> windows_result::Result<()>;
    fn GetDynamicFunctionInfo(&self, functionid: usize, moduleid: *mut usize, ppvsig: *mut *mut u8, pbsig: *mut u32, cchname: u32, pcchname: *mut u32, wszname: windows_core::PWSTR) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_WinRT_Metadata")]
...
impl ICorProfilerInfo9 {
    pub unsafe fn GetNativeCodeStartAddresses(&self, functionid: usize, rejitid: usize, ccodestartaddresses: u32, pccodestartaddresses: *mut u32, codestartaddresses: *mut usize) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetILToNativeMapping3(&self, pnativecodestartaddress: usize, cmap: u32, pcmap: *mut u32, map: *mut COR_DEBUG_IL_TO_NATIVE_MAP) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetCodeInfo4(&self, pnativecodestartaddress: usize, ccodeinfos: u32, pccodeinfos: *mut u32, codeinfos: *mut COR_PRF_CODE_INFO) -> windows_result::Result<()> {
...
pub trait ICorProfilerInfo9_Impl: ICorProfilerInfo8_Impl {
    fn GetNativeCodeStartAddresses(&self, functionid: usize, rejitid: usize, ccodestartaddresses: u32, pccodestartaddresses: *mut u32, codestartaddresses: *mut usize) -> windows_result::Result<()>;
    fn GetILToNativeMapping3(&self, pnativecodestartaddress: usize, cmap: u32, pcmap: *mut u32, map: *mut COR_DEBUG_IL_TO_NATIVE_MAP) -> windows_result::Result<()>;
    fn GetCodeInfo4(&self, pnativecodestartaddress: usize, ccodeinfos: u32, pccodeinfos: *mut u32, codeinfos: *mut COR_PRF_CODE_INFO) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_WinRT_Metadata")]
...
impl ICorProfilerMethodEnum {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<ICorProfilerMethodEnum> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn Next(&self, elements: &mut [COR_PRF_METHOD], pceltfetched: *mut u32) -> windows_result::Result<()> {
...
pub trait ICorProfilerMethodEnum_Impl: windows_core::IUnknownImpl {
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<ICorProfilerMethodEnum>;
    fn GetCount(&self) -> windows_result::Result<u32>;
    fn Next(&self, celt: u32, elements: *mut COR_PRF_METHOD, pceltfetched: *mut u32) -> windows_result::Result<()>;
}
...
impl ICorProfilerModuleEnum {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<ICorProfilerModuleEnum> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn Next(&self, ids: &mut [usize], pceltfetched: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), ids.len().try_into().unwrap(), core::mem::transmute(ids.as_ptr()), pceltfetched as _).ok() }
    }
}
#[repr(C)]
...
pub trait ICorProfilerModuleEnum_Impl: windows_core::IUnknownImpl {
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<ICorProfilerModuleEnum>;
    fn GetCount(&self) -> windows_result::Result<u32>;
    fn Next(&self, celt: u32, ids: *mut usize, pceltfetched: *mut u32) -> windows_result::Result<()>;
}
...
impl ICorProfilerObjectEnum {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<ICorProfilerObjectEnum> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn Next(&self, objects: &mut [usize], pceltfetched: *mut u32) -> windows_result::Result<()> {
...
pub trait ICorProfilerObjectEnum_Impl: windows_core::IUnknownImpl {
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<ICorProfilerObjectEnum>;
    fn GetCount(&self) -> windows_result::Result<u32>;
    fn Next(&self, celt: u32, objects: *mut usize, pceltfetched: *mut u32) -> windows_result::Result<()>;
}
...
impl ICorProfilerThreadEnum {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<ICorProfilerThreadEnum> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait ICorProfilerThreadEnum_Impl: windows_core::IUnknownImpl {
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<ICorProfilerThreadEnum>;
    fn GetCount(&self) -> windows_result::Result<u32>;
    fn Next(&self, celt: u32, ids: *mut usize, pceltfetched: *mut u32) -> windows_result::Result<()>;
}
