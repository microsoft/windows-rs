...
#[doc = "*Required features: 'Win32_System_Diagnostics_ProcessSnapshotting'*"]
#[inline]
pub unsafe fn PssWalkSnapshot<'a, Param0: ::windows::core::IntoParam<'a, HPSS>, Param2: ::windows::core::IntoParam<'a, HPSSWALK>>(snapshothandle: Param0, informationclass: PSS_WALK_INFORMATION_CLASS, walkmarkerhandle: Param2, buffer: ::core::option::Option<&mut [u8]>) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
        ...
        ::core::mem::transmute(PssWalkSnapshot(snapshothandle.into_param().abi(), ::core::mem::transmute(informationclass), walkmarkerhandle.into_param().abi(), ::core::mem::transmute(buffer.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), buffer.as_ref().map_or(0, |value| value.len()) as _))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
