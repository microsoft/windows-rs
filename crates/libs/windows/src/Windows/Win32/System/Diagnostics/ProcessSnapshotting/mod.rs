...
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn PssCaptureSnapshot ( processhandle : super::super::super::Foundation:: HANDLE , captureflags : PSS_CAPTURE_FLAGS , threadcontextflags : u32 , snapshothandle : *mut HPSS ) -> u32 );
...
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn PssDuplicateSnapshot ( sourceprocesshandle : super::super::super::Foundation:: HANDLE , snapshothandle : HPSS , targetprocesshandle : super::super::super::Foundation:: HANDLE , targetsnapshothandle : *mut HPSS , flags : PSS_DUPLICATE_FLAGS ) -> u32 );
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn PssFreeSnapshot<'a, P0, P1>(processhandle: P0, snapshothandle: P1) -> u32
where
    P0: ::std::convert::Into<super::super::super::Foundation::HANDLE>,
    P1: ::std::convert::Into<HPSS>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn PssFreeSnapshot ( processhandle : super::super::super::Foundation:: HANDLE , snapshothandle : HPSS ) -> u32 );
...
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn PssQuerySnapshot ( snapshothandle : HPSS , informationclass : PSS_QUERY_INFORMATION_CLASS , buffer : *mut ::core::ffi::c_void , bufferlength : u32 ) -> u32 );
...
pub unsafe fn PssWalkMarkerCreate(allocator: ::core::option::Option<*const PSS_ALLOCATOR>, walkmarkerhandle: *mut HPSSWALK) -> u32 {
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn PssWalkMarkerCreate ( allocator : *const PSS_ALLOCATOR , walkmarkerhandle : *mut HPSSWALK ) -> u32 );
    PssWalkMarkerCreate(::core::mem::transmute(allocator.unwrap_or(::std::ptr::null())), ::core::mem::transmute(walkmarkerhandle))
}
#[doc = "*Required features: `\"Win32_System_Diagnostics_ProcessSnapshotting\"`*"]
#[inline]
pub unsafe fn PssWalkMarkerFree<'a, P0>(walkmarkerhandle: P0) -> u32
where
    P0: ::std::convert::Into<HPSSWALK>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn PssWalkMarkerFree ( walkmarkerhandle : HPSSWALK ) -> u32 );
...
where
    P0: ::std::convert::Into<HPSSWALK>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn PssWalkMarkerGetPosition ( walkmarkerhandle : HPSSWALK , position : *mut usize ) -> u32 );
    PssWalkMarkerGetPosition(walkmarkerhandle.into(), ::core::mem::transmute(position))
}
#[doc = "*Required features: `\"Win32_System_Diagnostics_ProcessSnapshotting\"`*"]
#[inline]
pub unsafe fn PssWalkMarkerSeekToBeginning<'a, P0>(walkmarkerhandle: P0) -> u32
where
    P0: ::std::convert::Into<HPSSWALK>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn PssWalkMarkerSeekToBeginning ( walkmarkerhandle : HPSSWALK ) -> u32 );
    PssWalkMarkerSeekToBeginning(walkmarkerhandle.into())
}
#[doc = "*Required features: `\"Win32_System_Diagnostics_ProcessSnapshotting\"`*"]
#[inline]
pub unsafe fn PssWalkMarkerSetPosition<'a, P0>(walkmarkerhandle: P0, position: usize) -> u32
where
    P0: ::std::convert::Into<HPSSWALK>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn PssWalkMarkerSetPosition ( walkmarkerhandle : HPSSWALK , position : usize ) -> u32 );
...
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn PssWalkSnapshot ( snapshothandle : HPSS , informationclass : PSS_WALK_INFORMATION_CLASS , walkmarkerhandle : HPSSWALK , buffer : *mut ::core::ffi::c_void , bufferlength : u32 ) -> u32 );
