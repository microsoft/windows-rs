...
impl IDebugExtendedProperty_Vtbl {
    ...
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IDebugExtendedProperty_Impl,
    {
...
impl IDebugProperty_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IDebugProperty_Impl,
    {
        ...
        unsafe extern "system" fn GetExtendedInfo<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, cinfos: u32, rgguidextendedinfo: *const windows_core::GUID, rgvar: *mut super::super::Variant::VARIANT) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IDebugProperty_Impl,
        {
            unsafe {
...
pub trait IDebugPropertyEnumType_All_Impl {
    fn GetName(&self) -> windows_core::Result<windows_core::BSTR>;
}
impl IDebugPropertyEnumType_All_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IDebugPropertyEnumType_All_Impl,
    {
        unsafe extern "system" fn GetName<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, __midl__idebugpropertyenumtype_all0000: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IDebugPropertyEnumType_All_Impl,
        {
            unsafe {
...
impl IDebugPropertyEnumType_Arguments_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IDebugPropertyEnumType_Arguments_Impl,
    {
...
impl IDebugPropertyEnumType_Locals_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IDebugPropertyEnumType_Locals_Impl,
    {
        Self { base__: IDebugPropertyEnumType_All_Vtbl::new::<Identity, OFFSET>() }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl IDebugPropertyEnumType_LocalsPlusArgs_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IDebugPropertyEnumType_LocalsPlusArgs_Impl,
    {
        Self { base__: IDebugPropertyEnumType_All_Vtbl::new::<Identity, OFFSET>() }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl IDebugPropertyEnumType_Registers_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IDebugPropertyEnumType_Registers_Impl,
    {
        Self { base__: IDebugPropertyEnumType_All_Vtbl::new::<Identity, OFFSET>() }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
pub trait IEnumDebugExtendedPropertyInfo_Impl {
...
impl IEnumDebugExtendedPropertyInfo_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IEnumDebugExtendedPropertyInfo_Impl,
    {
...
pub trait IEnumDebugPropertyInfo_Impl {
...
impl IEnumDebugPropertyInfo_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IEnumDebugPropertyInfo_Impl,
    {
...
impl IObjectSafety_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IObjectSafety_Impl,
    {
...
#[cfg(feature = "Win32_System_Ole")]
pub trait IPerPropertyBrowsing2_Impl {
...
impl IPerPropertyBrowsing2_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IPerPropertyBrowsing2_Impl,
    {
        unsafe extern "system" fn GetDisplayString<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, dispid: i32, pbstr: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IPerPropertyBrowsing2_Impl,
        {
            unsafe {
