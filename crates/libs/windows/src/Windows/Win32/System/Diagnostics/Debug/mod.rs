...
{
    ::windows::imp::link ! ( "dbghelp.dll""system" fn GetTimestampForLoadedLibrary ( module : super::super::super::Foundation:: HMODULE ) -> u32 );
...
pub unsafe fn SetThreadErrorMode(dwnewmode: THREAD_ERROR_MODE, lpoldmode: ::core::option::Option<*mut THREAD_ERROR_MODE>) -> super::super::super::Foundation::BOOL {
    ::windows::imp::link ! ( "kernel32.dll""system" fn SetThreadErrorMode ( dwnewmode : THREAD_ERROR_MODE , lpoldmode : *mut THREAD_ERROR_MODE ) -> super::super::super::Foundation:: BOOL );
