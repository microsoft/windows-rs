...
#[inline]
pub unsafe fn GetSystemPowerStatus(lpsystempowerstatus: *mut SYSTEM_POWER_STATUS) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn PowerClearRequest(powerrequest: super::super::Foundation::HANDLE, requesttype: POWER_REQUEST_TYPE) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn PowerCreateRequest(context: *const super::Threading::REASON_CONTEXT) -> windows_result::Result<super::super::Foundation::HANDLE> {
...
#[inline]
pub unsafe fn PowerRegisterForEffectivePowerModeNotifications(version: u32, callback: EFFECTIVE_POWER_MODE_CALLBACK, context: Option<*const core::ffi::c_void>, registrationhandle: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn PowerSetRequest(powerrequest: super::super::Foundation::HANDLE, requesttype: POWER_REQUEST_TYPE) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn PowerUnregisterFromEffectivePowerModeNotifications(registrationhandle: *const core::ffi::c_void) -> windows_result::Result<()> {
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn RegisterPowerSettingNotification(hrecipient: super::super::Foundation::HANDLE, powersettingguid: *const windows_core::GUID, flags: super::super::UI::WindowsAndMessaging::REGISTER_NOTIFICATION_FLAGS) -> windows_result::Result<HPOWERNOTIFY> {
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn RegisterSuspendResumeNotification(hrecipient: super::super::Foundation::HANDLE, flags: super::super::UI::WindowsAndMessaging::REGISTER_NOTIFICATION_FLAGS) -> windows_result::Result<HPOWERNOTIFY> {
...
#[inline]
pub unsafe fn SetSystemPowerState(fsuspend: bool, fforce: bool) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn UnregisterPowerSettingNotification(handle: HPOWERNOTIFY) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn UnregisterSuspendResumeNotification(handle: HPOWERNOTIFY) -> windows_result::Result<()> {
