...
pub unsafe fn EvtCreateRenderContext(valuepaths: ::core::option::Option<&[::windows::core::PWSTR]>, flags: u32) -> isize {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(EvtCreateRenderContext(valuepaths.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(valuepaths.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), ::core::mem::transmute(flags)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn EvtFormatMessage(publishermetadata: isize, event: isize, messageid: u32, values: ::core::option::Option<&[EVT_VARIANT]>, flags: u32, buffer: ::core::option::Option<&mut [u16]>, bufferused: *mut u32) -> super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(EvtFormatMessage(
            ...
            values.as_ref().map_or(0, |value| value.len()) as _,
            ::core::mem::transmute(values.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())),
            ::core::mem::transmute(flags),
            buffer.as_ref().map_or(0, |value| value.len()) as _,
            ::core::mem::transmute(buffer.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())),
...
pub unsafe fn EvtGetExtendedStatus(buffer: ::core::option::Option<&mut [u16]>, bufferused: *mut u32) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(EvtGetExtendedStatus(buffer.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(buffer.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), ::core::mem::transmute(bufferused)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn EvtNext(resultset: isize, events: &mut [isize], timeout: u32, flags: u32, returned: *mut u32) -> super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(EvtNext(::core::mem::transmute(resultset), events.len() as _, ::core::mem::transmute(events.as_ptr()), ::core::mem::transmute(timeout), ::core::mem::transmute(flags), ::core::mem::transmute(returned)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn EvtNextChannelPath(channelenum: isize, channelpathbuffer: ::core::option::Option<&mut [u16]>, channelpathbufferused: *mut u32) -> super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(EvtNextChannelPath(::core::mem::transmute(channelenum), channelpathbuffer.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(channelpathbuffer.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), ::core::mem::transmute(channelpathbufferused)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn EvtNextPublisherId(publisherenum: isize, publisheridbuffer: ::core::option::Option<&mut [u16]>, publisheridbufferused: *mut u32) -> super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(EvtNextPublisherId(::core::mem::transmute(publisherenum), publisheridbuffer.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(publisheridbuffer.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), ::core::mem::transmute(publisheridbufferused)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn ReportEventA<'a, Param0: ::windows::core::IntoParam<'a, EventSourceHandle>, Param4: ::windows::core::IntoParam<'a, super::super::Foundation::PSID>>(heventlog: Param0, wtype: REPORT_EVENT_TYPE, wcategory: u16, dweventid: u32, lpusersid: Param4, dwdatasize: u32, lpstrings: ::core::option::Option<&[::windows::core::PSTR]>, lprawdata: *const ::core::ffi::c_void) -> super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(ReportEventA(heventlog.into_param().abi(), ::core::mem::transmute(wtype), ::core::mem::transmute(wcategory), ::core::mem::transmute(dweventid), lpusersid.into_param().abi(), lpstrings.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(dwdatasize), ::core::mem::transmute(lpstrings.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), ::core::mem::transmute(lprawdata)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
