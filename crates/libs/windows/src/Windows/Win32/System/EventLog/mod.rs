#[inline]
pub unsafe fn BackupEventLogA<P1>(heventlog: super::super::Foundation::HANDLE, lpbackupfilename: P1) -> windows_core::BOOL
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { BackupEventLogA(heventlog, lpbackupfilename.param().abi()) }
}
#[inline]
pub unsafe fn BackupEventLogW<P1>(heventlog: super::super::Foundation::HANDLE, lpbackupfilename: P1) -> windows_core::BOOL
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { BackupEventLogW(heventlog, lpbackupfilename.param().abi()) }
}
#[inline]
pub unsafe fn ClearEventLogA<P1>(heventlog: super::super::Foundation::HANDLE, lpbackupfilename: P1) -> windows_core::BOOL
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { ClearEventLogA(heventlog, lpbackupfilename.param().abi()) }
}
#[inline]
pub unsafe fn ClearEventLogW<P1>(heventlog: super::super::Foundation::HANDLE, lpbackupfilename: P1) -> windows_core::BOOL
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { ClearEventLogW(heventlog, lpbackupfilename.param().abi()) }
}
#[inline]
pub unsafe fn CloseEventLog(heventlog: super::super::Foundation::HANDLE) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn CloseEventLog(heventlog : super::super::Foundation:: HANDLE) -> windows_core::BOOL);
    unsafe { CloseEventLog(heventlog) }
}
#[inline]
pub unsafe fn DeregisterEventSource(heventlog: super::super::Foundation::HANDLE) -> windows_core::BOOL {
    windows_core::link!("advapi32.dll" "system" fn DeregisterEventSource(heventlog : super::super::Foundation:: HANDLE) -> windows_core::BOOL);
    unsafe { DeregisterEventSource(heventlog) }
}
#[inline]
pub unsafe fn EvtArchiveExportedLog<P1>(session: EVT_HANDLE, logfilepath: P1, locale: u32, flags: u32) -> windows_core::BOOL
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { EvtArchiveExportedLog(session, logfilepath.param().abi(), locale, flags) }
}
#[inline]
pub unsafe fn EvtCancel(object: EVT_HANDLE) -> windows_core::BOOL {
    windows_core::link!("wevtapi.dll" "system" fn EvtCancel(object : EVT_HANDLE) -> windows_core::BOOL);
    unsafe { EvtCancel(object) }
}
#[inline]
pub unsafe fn EvtClearLog<P1, P2>(session: EVT_HANDLE, channelpath: P1, targetfilepath: P2, flags: u32) -> windows_core::BOOL
where
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { EvtClearLog(session, channelpath.param().abi(), targetfilepath.param().abi(), flags) }
}
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { EvtExportLog(session, path.param().abi(), query.param().abi(), targetfilepath.param().abi(), flags) }
}
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn EvtFormatMessage(publishermetadata: EVT_HANDLE, event: EVT_HANDLE, messageid: u32, valuecount: u32, values: *const EVT_VARIANT, flags: u32, buffersize: u32, buffer: windows_core::PWSTR, bufferused: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { EvtFormatMessage(publishermetadata, event, messageid, valuecount, values, flags, buffersize, core::mem::transmute(buffer), bufferused as _) }
}
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn EvtGetChannelConfigProperty(channelconfig: EVT_HANDLE, propertyid: EVT_CHANNEL_CONFIG_PROPERTY_ID, flags: u32, propertyvaluebuffersize: u32, propertyvaluebuffer: *mut EVT_VARIANT, propertyvaluebufferused: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { EvtGetChannelConfigProperty(channelconfig, propertyid, flags, propertyvaluebuffersize, propertyvaluebuffer as _, propertyvaluebufferused as _) }
}
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn EvtGetEventInfo(event: EVT_HANDLE, propertyid: EVT_EVENT_PROPERTY_ID, propertyvaluebuffersize: u32, propertyvaluebuffer: *mut EVT_VARIANT, propertyvaluebufferused: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { EvtGetEventInfo(event, propertyid, propertyvaluebuffersize, propertyvaluebuffer as _, propertyvaluebufferused as _) }
}
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn EvtGetEventMetadataProperty(eventmetadata: EVT_HANDLE, propertyid: EVT_EVENT_METADATA_PROPERTY_ID, flags: u32, eventmetadatapropertybuffersize: u32, eventmetadatapropertybuffer: *mut EVT_VARIANT, eventmetadatapropertybufferused: *mut u32) -> windows_core::BOOL {
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn EvtGetLogInfo(log: EVT_HANDLE, propertyid: EVT_LOG_PROPERTY_ID, propertyvaluebuffersize: u32, propertyvaluebuffer: *mut EVT_VARIANT, propertyvaluebufferused: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { EvtGetLogInfo(log, propertyid, propertyvaluebuffersize, propertyvaluebuffer as _, propertyvaluebufferused as _) }
}
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn EvtGetObjectArrayProperty(objectarray: isize, propertyid: u32, arrayindex: u32, flags: u32, propertyvaluebuffersize: u32, propertyvaluebuffer: *mut EVT_VARIANT, propertyvaluebufferused: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { EvtGetObjectArrayProperty(objectarray, propertyid, arrayindex, flags, propertyvaluebuffersize, propertyvaluebuffer as _, propertyvaluebufferused as _) }
}
#[inline]
pub unsafe fn EvtGetObjectArraySize(objectarray: isize, objectarraysize: *mut u32) -> windows_core::BOOL {
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn EvtGetPublisherMetadataProperty(publishermetadata: EVT_HANDLE, propertyid: EVT_PUBLISHER_METADATA_PROPERTY_ID, flags: u32, publishermetadatapropertybuffersize: u32, publishermetadatapropertybuffer: *mut EVT_VARIANT, publishermetadatapropertybufferused: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { EvtGetPublisherMetadataProperty(publishermetadata, propertyid, flags, publishermetadatapropertybuffersize, publishermetadatapropertybuffer as _, publishermetadatapropertybufferused as _) }
}
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn EvtGetQueryInfo(queryorsubscription: EVT_HANDLE, propertyid: EVT_QUERY_PROPERTY_ID, propertyvaluebuffersize: u32, propertyvaluebuffer: *mut EVT_VARIANT, propertyvaluebufferused: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { EvtGetQueryInfo(queryorsubscription, propertyid, propertyvaluebuffersize, propertyvaluebuffer as _, propertyvaluebufferused as _) }
}
#[inline]
pub unsafe fn EvtNext(resultset: EVT_HANDLE, eventssize: u32, events: *mut isize, timeout: u32, flags: u32, returned: *mut u32) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn EvtNextPublisherId(publisherenum: EVT_HANDLE, publisheridbuffersize: u32, publisheridbuffer: windows_core::PWSTR, publisheridbufferused: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { EvtNextPublisherId(publisherenum, publisheridbuffersize, core::mem::transmute(publisheridbuffer), publisheridbufferused as _) }
}
#[inline]
pub unsafe fn EvtOpenChannelConfig<P1>(session: EVT_HANDLE, channelpath: P1, flags: u32) -> EVT_HANDLE
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { EvtOpenChannelConfig(session, channelpath.param().abi(), flags) }
}
#[inline]
pub unsafe fn EvtOpenChannelEnum(session: EVT_HANDLE, flags: u32) -> EVT_HANDLE {
    windows_core::link!("wevtapi.dll" "system" fn EvtOpenChannelEnum(session : EVT_HANDLE, flags : u32) -> EVT_HANDLE);
    unsafe { EvtOpenChannelEnum(session, flags) }
}
#[inline]
...
#[inline]
pub unsafe fn EvtOpenLog<P1>(session: EVT_HANDLE, path: P1, flags: u32) -> EVT_HANDLE
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("wevtapi.dll" "system" fn EvtOpenLog(session : EVT_HANDLE, path : windows_core::PCWSTR, flags : u32) -> EVT_HANDLE);
    unsafe { EvtOpenLog(session, path.param().abi(), flags) }
}
#[inline]
pub unsafe fn EvtOpenPublisherEnum(session: EVT_HANDLE, flags: u32) -> EVT_HANDLE {
    windows_core::link!("wevtapi.dll" "system" fn EvtOpenPublisherEnum(session : EVT_HANDLE, flags : u32) -> EVT_HANDLE);
    unsafe { EvtOpenPublisherEnum(session, flags) }
}
#[inline]
pub unsafe fn EvtOpenPublisherMetadata<P1, P2>(session: EVT_HANDLE, publisherid: P1, logfilepath: P2, locale: u32, flags: u32) -> EVT_HANDLE
where
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { EvtOpenPublisherMetadata(session, publisherid.param().abi(), logfilepath.param().abi(), locale, flags) }
}
#[inline]
pub unsafe fn EvtOpenSession(loginclass: EVT_LOGIN_CLASS, login: *const core::ffi::c_void, timeout: u32, flags: u32) -> EVT_HANDLE {
    ...
    unsafe { EvtOpenSession(loginclass, login, timeout, flags) }
}
#[inline]
pub unsafe fn EvtQuery<P1, P2>(session: EVT_HANDLE, path: P1, query: P2, flags: u32) -> EVT_HANDLE
where
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { EvtQuery(session, path.param().abi(), query.param().abi(), flags) }
}
#[inline]
pub unsafe fn EvtRender(context: EVT_HANDLE, fragment: EVT_HANDLE, flags: u32, buffersize: u32, buffer: *mut core::ffi::c_void, bufferused: *mut u32, propertycount: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { EvtRender(context, fragment, flags, buffersize, buffer as _, bufferused as _, propertycount as _) }
}
#[inline]
...
#[inline]
pub unsafe fn EvtSeek(resultset: EVT_HANDLE, position: i64, bookmark: EVT_HANDLE, timeout: u32, flags: u32) -> windows_core::BOOL {
    ...
    unsafe { EvtSeek(resultset, position, bookmark, timeout, flags) }
}
#[cfg(feature = "Win32_Security")]
#[inline]
...
#[inline]
pub unsafe fn GetEventLogInformation(heventlog: super::super::Foundation::HANDLE, dwinfolevel: u32, lpbuffer: *mut core::ffi::c_void, cbbufsize: u32, pcbbytesneeded: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { GetEventLogInformation(heventlog, dwinfolevel, lpbuffer as _, cbbufsize, pcbbytesneeded as _) }
}
#[inline]
pub unsafe fn GetNumberOfEventLogRecords(heventlog: super::super::Foundation::HANDLE, numberofrecords: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { GetNumberOfEventLogRecords(heventlog, numberofrecords as _) }
}
#[inline]
pub unsafe fn GetOldestEventLogRecord(heventlog: super::super::Foundation::HANDLE, oldestrecord: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { GetOldestEventLogRecord(heventlog, oldestrecord as _) }
}
#[inline]
pub unsafe fn NotifyChangeEventLog(heventlog: super::super::Foundation::HANDLE, hevent: super::super::Foundation::HANDLE) -> windows_core::BOOL {
    ...
    unsafe { NotifyChangeEventLog(heventlog, hevent) }
}
#[inline]
pub unsafe fn OpenBackupEventLogA<P0, P1>(lpuncservername: P0, lpfilename: P1) -> super::super::Foundation::HANDLE
where
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { OpenBackupEventLogA(lpuncservername.param().abi(), lpfilename.param().abi()) }
}
#[inline]
pub unsafe fn OpenBackupEventLogW<P0, P1>(lpuncservername: P0, lpfilename: P1) -> super::super::Foundation::HANDLE
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { OpenBackupEventLogW(lpuncservername.param().abi(), lpfilename.param().abi()) }
}
#[inline]
pub unsafe fn OpenEventLogA<P0, P1>(lpuncservername: P0, lpsourcename: P1) -> super::super::Foundation::HANDLE
where
    P0: windows_core::Param<windows_core::PCSTR>,
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { OpenEventLogA(lpuncservername.param().abi(), lpsourcename.param().abi()) }
}
#[inline]
pub unsafe fn OpenEventLogW<P0, P1>(lpuncservername: P0, lpsourcename: P1) -> super::super::Foundation::HANDLE
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { OpenEventLogW(lpuncservername.param().abi(), lpsourcename.param().abi()) }
}
#[inline]
pub unsafe fn ReadEventLogA(heventlog: super::super::Foundation::HANDLE, dwreadflags: READ_EVENT_LOG_READ_FLAGS, dwrecordoffset: u32, lpbuffer: *mut core::ffi::c_void, nnumberofbytestoread: u32, pnbytesread: *mut u32, pnminnumberofbytesneeded: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { ReadEventLogA(heventlog, dwreadflags, dwrecordoffset, lpbuffer as _, nnumberofbytestoread, pnbytesread as _, pnminnumberofbytesneeded as _) }
}
#[inline]
pub unsafe fn ReadEventLogW(heventlog: super::super::Foundation::HANDLE, dwreadflags: READ_EVENT_LOG_READ_FLAGS, dwrecordoffset: u32, lpbuffer: *mut core::ffi::c_void, nnumberofbytestoread: u32, pnbytesread: *mut u32, pnminnumberofbytesneeded: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { ReadEventLogW(heventlog, dwreadflags, dwrecordoffset, lpbuffer as _, nnumberofbytestoread, pnbytesread as _, pnminnumberofbytesneeded as _) }
}
#[inline]
pub unsafe fn RegisterEventSourceA<P0, P1>(lpuncservername: P0, lpsourcename: P1) -> super::super::Foundation::HANDLE
where
    P0: windows_core::Param<windows_core::PCSTR>,
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { RegisterEventSourceA(lpuncservername.param().abi(), lpsourcename.param().abi()) }
}
#[inline]
pub unsafe fn RegisterEventSourceW<P0, P1>(lpuncservername: P0, lpsourcename: P1) -> super::super::Foundation::HANDLE
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { RegisterEventSourceW(lpuncservername.param().abi(), lpsourcename.param().abi()) }
}
#[cfg(feature = "Win32_Security")]
#[inline]
