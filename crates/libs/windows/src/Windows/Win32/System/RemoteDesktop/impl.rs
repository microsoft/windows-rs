...
pub trait IRemoteDesktopClientSettings_Impl: Sized + super::Com::IDispatch_Impl {
    ...
    fn GetRdpProperty(&self, propertyname: &::windows_core::BSTR) -> ::windows_core::Result<super::Com::VARIANT>;
    fn SetRdpProperty(&self, propertyname: &::windows_core::BSTR, value: &super::Com::VARIANT) -> ::windows_core::Result<()>;
}
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
...
impl IRemoteDesktopClientSettings_Vtbl {
    pub const fn new<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: IRemoteDesktopClientSettings_Impl, const OFFSET: isize>() -> IRemoteDesktopClientSettings_Vtbl {
        ...
        unsafe extern "system" fn GetRdpProperty<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: IRemoteDesktopClientSettings_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, propertyname: ::std::mem::MaybeUninit<::windows_core::BSTR>, value: *mut super::Com::VARIANT) -> ::windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
        ...
        unsafe extern "system" fn SetRdpProperty<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: IRemoteDesktopClientSettings_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, propertyname: ::std::mem::MaybeUninit<::windows_core::BSTR>, value: super::Com::VARIANT) -> ::windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
...
pub trait ITsSbClientConnection_Impl: Sized {
    ...
    fn PutContext(&self, contextid: &::windows_core::BSTR, context: &super::Com::VARIANT, existingcontext: *mut super::Com::VARIANT) -> ::windows_core::Result<()>;
    fn GetContext(&self, contextid: &::windows_core::BSTR) -> ::windows_core::Result<super::Com::VARIANT>;
...
impl ITsSbClientConnection_Vtbl {
    pub const fn new<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: ITsSbClientConnection_Impl, const OFFSET: isize>() -> ITsSbClientConnection_Vtbl {
        ...
        unsafe extern "system" fn PutContext<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: ITsSbClientConnection_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, contextid: ::std::mem::MaybeUninit<::windows_core::BSTR>, context: super::Com::VARIANT, existingcontext: *mut super::Com::VARIANT) -> ::windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
            this.PutContext(::core::mem::transmute(&contextid), ::core::mem::transmute(&context), ::core::mem::transmute_copy(&existingcontext)).into()
        }
        unsafe extern "system" fn GetContext<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: ITsSbClientConnection_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, contextid: ::std::mem::MaybeUninit<::windows_core::BSTR>, context: *mut super::Com::VARIANT) -> ::windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
...
pub trait ITsSbGlobalStore_Impl: Sized {
    ...
    fn GetFarmProperty(&self, farmname: &::windows_core::BSTR, propertyname: &::windows_core::BSTR, pvarvalue: *const super::Com::VARIANT) -> ::windows_core::Result<()>;
}
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
...
pub trait ITsSbResourcePluginStore_Impl: Sized {
    ...
    fn SetTargetProperty(&self, targetname: &::windows_core::BSTR, propertyname: &::windows_core::BSTR, pproperty: *const super::Com::VARIANT) -> ::windows_core::Result<()>;
    fn SetEnvironmentProperty(&self, environmentname: &::windows_core::BSTR, propertyname: &::windows_core::BSTR, pproperty: *const super::Com::VARIANT) -> ::windows_core::Result<()>;
    ...
    fn SetTargetPropertyWithVersionCheck(&self, ptarget: ::core::option::Option<&ITsSbTarget>, propertyname: &::windows_core::BSTR, pproperty: *const super::Com::VARIANT) -> ::windows_core::Result<()>;
    fn SetEnvironmentPropertyWithVersionCheck(&self, penvironment: ::core::option::Option<&ITsSbEnvironment>, propertyname: &::windows_core::BSTR, pproperty: *const super::Com::VARIANT) -> ::windows_core::Result<()>;
