...
pub trait ITsSbResourcePluginStore_Impl: Sized {
    ...
    fn SetTargetPropertyWithVersionCheck(&self, ptarget: ::core::option::Option<&ITsSbTarget>, propertyname: &::windows_core::BSTR, pproperty: *const ::windows_core::VARIANT) -> ::windows_core::Result<()>;
    fn SetEnvironmentPropertyWithVersionCheck(&self, penvironment: ::core::option::Option<&ITsSbEnvironment>, propertyname: &::windows_core::BSTR, pproperty: *const ::windows_core::VARIANT) -> ::windows_core::Result<()>;
