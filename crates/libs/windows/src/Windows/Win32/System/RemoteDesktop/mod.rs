#[inline]
pub unsafe fn ProcessIdToSessionId(dwprocessid: u32, psessionid: *mut u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("kernel32.dll" "system" fn ProcessIdToSessionId(dwprocessid : u32, psessionid : *mut u32) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTSConnectSessionA<P2>(logonid: u32, targetlogonid: u32, ppassword: P2, bwait: bool) -> Result<(), windows_result::HRESULT>
where
    P2: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSConnectSessionA(logonid : u32, targetlogonid : u32, ppassword : windows_core::PCSTR, bwait : windows_core::BOOL) -> windows_core::BOOL);
    unsafe { WTSConnectSessionA(logonid, targetlogonid, ppassword.param().abi(), bwait.into()).ok() }
}
#[inline]
pub unsafe fn WTSConnectSessionW<P2>(logonid: u32, targetlogonid: u32, ppassword: P2, bwait: bool) -> Result<(), windows_result::HRESULT>
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSConnectSessionW(logonid : u32, targetlogonid : u32, ppassword : windows_core::PCWSTR, bwait : windows_core::BOOL) -> windows_core::BOOL);
    unsafe { WTSConnectSessionW(logonid, targetlogonid, ppassword.param().abi(), bwait.into()).ok() }
}
#[inline]
pub unsafe fn WTSCreateListenerA<P3>(hserver: Option<super::super::Foundation::HANDLE>, preserved: *const core::ffi::c_void, reserved: u32, plistenername: P3, pbuffer: *const WTSLISTENERCONFIGA, flag: u32) -> Result<(), windows_result::HRESULT>
where
    P3: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSCreateListenerA(hserver : super::super::Foundation:: HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plistenername : windows_core::PCSTR, pbuffer : *const WTSLISTENERCONFIGA, flag : u32) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTSCreateListenerW<P3>(hserver: Option<super::super::Foundation::HANDLE>, preserved: *const core::ffi::c_void, reserved: u32, plistenername: P3, pbuffer: *const WTSLISTENERCONFIGW, flag: u32) -> Result<(), windows_result::HRESULT>
where
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSCreateListenerW(hserver : super::super::Foundation:: HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plistenername : windows_core::PCWSTR, pbuffer : *const WTSLISTENERCONFIGW, flag : u32) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTSDisconnectSession(hserver: Option<super::super::Foundation::HANDLE>, sessionid: u32, bwait: bool) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSDisconnectSession(hserver : super::super::Foundation:: HANDLE, sessionid : u32, bwait : windows_core::BOOL) -> windows_core::BOOL);
...
pub unsafe fn WTSEnableChildSessions(benable: bool) -> windows_core::BOOL {
    windows_link::link!("wtsapi32.dll" "system" fn WTSEnableChildSessions(benable : windows_core::BOOL) -> windows_core::BOOL);
    unsafe { WTSEnableChildSessions(benable.into()) }
}
#[inline]
pub unsafe fn WTSEnumerateListenersA(hserver: Option<super::super::Foundation::HANDLE>, preserved: *const core::ffi::c_void, reserved: u32, plisteners: Option<*mut *mut i8>, pcount: *mut u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSEnumerateListenersA(hserver : super::super::Foundation:: HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plisteners : *mut *mut i8, pcount : *mut u32) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTSEnumerateListenersW(hserver: Option<super::super::Foundation::HANDLE>, preserved: *const core::ffi::c_void, reserved: u32, plisteners: Option<*mut *mut u16>, pcount: *mut u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSEnumerateListenersW(hserver : super::super::Foundation:: HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plisteners : *mut *mut u16, pcount : *mut u32) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTSEnumerateProcessesA(hserver: Option<super::super::Foundation::HANDLE>, reserved: u32, version: u32, ppprocessinfo: *mut *mut WTS_PROCESS_INFOA, pcount: *mut u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSEnumerateProcessesA(hserver : super::super::Foundation:: HANDLE, reserved : u32, version : u32, ppprocessinfo : *mut *mut WTS_PROCESS_INFOA, pcount : *mut u32) -> windows_core::BOOL);
    unsafe { WTSEnumerateProcessesA(hserver.unwrap_or(core::mem::zeroed()) as _, reserved, version, ppprocessinfo as _, pcount as _).ok() }
}
#[inline]
pub unsafe fn WTSEnumerateProcessesExA(hserver: Option<super::super::Foundation::HANDLE>, plevel: *mut u32, sessionid: u32, ppprocessinfo: *mut windows_core::PSTR, pcount: *mut u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSEnumerateProcessesExA(hserver : super::super::Foundation:: HANDLE, plevel : *mut u32, sessionid : u32, ppprocessinfo : *mut windows_core::PSTR, pcount : *mut u32) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTSEnumerateProcessesExW(hserver: Option<super::super::Foundation::HANDLE>, plevel: *mut u32, sessionid: u32, ppprocessinfo: *mut windows_core::PWSTR, pcount: *mut u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSEnumerateProcessesExW(hserver : super::super::Foundation:: HANDLE, plevel : *mut u32, sessionid : u32, ppprocessinfo : *mut windows_core::PWSTR, pcount : *mut u32) -> windows_core::BOOL);
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn WTSEnumerateProcessesW(hserver: Option<super::super::Foundation::HANDLE>, reserved: u32, version: u32, ppprocessinfo: *mut *mut WTS_PROCESS_INFOW, pcount: *mut u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSEnumerateProcessesW(hserver : super::super::Foundation:: HANDLE, reserved : u32, version : u32, ppprocessinfo : *mut *mut WTS_PROCESS_INFOW, pcount : *mut u32) -> windows_core::BOOL);
    unsafe { WTSEnumerateProcessesW(hserver.unwrap_or(core::mem::zeroed()) as _, reserved, version, ppprocessinfo as _, pcount as _).ok() }
}
#[inline]
pub unsafe fn WTSEnumerateServersA<P0>(pdomainname: P0, reserved: u32, version: u32, ppserverinfo: *mut *mut WTS_SERVER_INFOA, pcount: *mut u32) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSEnumerateServersA(pdomainname : windows_core::PCSTR, reserved : u32, version : u32, ppserverinfo : *mut *mut WTS_SERVER_INFOA, pcount : *mut u32) -> windows_core::BOOL);
    unsafe { WTSEnumerateServersA(pdomainname.param().abi(), reserved, version, ppserverinfo as _, pcount as _).ok() }
}
#[inline]
pub unsafe fn WTSEnumerateServersW<P0>(pdomainname: P0, reserved: u32, version: u32, ppserverinfo: *mut *mut WTS_SERVER_INFOW, pcount: *mut u32) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSEnumerateServersW(pdomainname : windows_core::PCWSTR, reserved : u32, version : u32, ppserverinfo : *mut *mut WTS_SERVER_INFOW, pcount : *mut u32) -> windows_core::BOOL);
    unsafe { WTSEnumerateServersW(pdomainname.param().abi(), reserved, version, ppserverinfo as _, pcount as _).ok() }
}
#[inline]
pub unsafe fn WTSEnumerateSessionsA(hserver: Option<super::super::Foundation::HANDLE>, reserved: u32, version: u32, ppsessioninfo: *mut *mut WTS_SESSION_INFOA, pcount: *mut u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSEnumerateSessionsA(hserver : super::super::Foundation:: HANDLE, reserved : u32, version : u32, ppsessioninfo : *mut *mut WTS_SESSION_INFOA, pcount : *mut u32) -> windows_core::BOOL);
    unsafe { WTSEnumerateSessionsA(hserver.unwrap_or(core::mem::zeroed()) as _, reserved, version, ppsessioninfo as _, pcount as _).ok() }
}
#[inline]
pub unsafe fn WTSEnumerateSessionsExA(hserver: Option<super::super::Foundation::HANDLE>, plevel: *mut u32, filter: u32, ppsessioninfo: *mut *mut WTS_SESSION_INFO_1A, pcount: *mut u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSEnumerateSessionsExA(hserver : super::super::Foundation:: HANDLE, plevel : *mut u32, filter : u32, ppsessioninfo : *mut *mut WTS_SESSION_INFO_1A, pcount : *mut u32) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTSEnumerateSessionsExW(hserver: Option<super::super::Foundation::HANDLE>, plevel: *mut u32, filter: u32, ppsessioninfo: *mut *mut WTS_SESSION_INFO_1W, pcount: *mut u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSEnumerateSessionsExW(hserver : super::super::Foundation:: HANDLE, plevel : *mut u32, filter : u32, ppsessioninfo : *mut *mut WTS_SESSION_INFO_1W, pcount : *mut u32) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTSEnumerateSessionsW(hserver: Option<super::super::Foundation::HANDLE>, reserved: u32, version: u32, ppsessioninfo: *mut *mut WTS_SESSION_INFOW, pcount: *mut u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSEnumerateSessionsW(hserver : super::super::Foundation:: HANDLE, reserved : u32, version : u32, ppsessioninfo : *mut *mut WTS_SESSION_INFOW, pcount : *mut u32) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTSFreeMemoryExA(wtstypeclass: WTS_TYPE_CLASS, pmemory: *const core::ffi::c_void, numberofentries: u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSFreeMemoryExA(wtstypeclass : WTS_TYPE_CLASS, pmemory : *const core::ffi::c_void, numberofentries : u32) -> windows_core::BOOL);
    unsafe { WTSFreeMemoryExA(wtstypeclass, pmemory, numberofentries).ok() }
}
#[inline]
pub unsafe fn WTSFreeMemoryExW(wtstypeclass: WTS_TYPE_CLASS, pmemory: *const core::ffi::c_void, numberofentries: u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSFreeMemoryExW(wtstypeclass : WTS_TYPE_CLASS, pmemory : *const core::ffi::c_void, numberofentries : u32) -> windows_core::BOOL);
...
pub unsafe fn WTSGetChildSessionId(psessionid: *mut u32) -> windows_core::BOOL {
    windows_link::link!("wtsapi32.dll" "system" fn WTSGetChildSessionId(psessionid : *mut u32) -> windows_core::BOOL);
    unsafe { WTSGetChildSessionId(psessionid as _) }
}
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn WTSGetListenerSecurityA<P3>(hserver: Option<super::super::Foundation::HANDLE>, preserved: *const core::ffi::c_void, reserved: u32, plistenername: P3, securityinformation: super::super::Security::OBJECT_SECURITY_INFORMATION, psecuritydescriptor: Option<super::super::Security::PSECURITY_DESCRIPTOR>, nlength: u32, lpnlengthneeded: *mut u32) -> Result<(), windows_result::HRESULT>
where
    P3: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSGetListenerSecurityA(hserver : super::super::Foundation:: HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plistenername : windows_core::PCSTR, securityinformation : super::super::Security:: OBJECT_SECURITY_INFORMATION, psecuritydescriptor : super::super::Security:: PSECURITY_DESCRIPTOR, nlength : u32, lpnlengthneeded : *mut u32) -> windows_core::BOOL);
...
where
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSGetListenerSecurityW(hserver : super::super::Foundation:: HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plistenername : windows_core::PCWSTR, securityinformation : super::super::Security:: OBJECT_SECURITY_INFORMATION, psecuritydescriptor : super::super::Security:: PSECURITY_DESCRIPTOR, nlength : u32, lpnlengthneeded : *mut u32) -> windows_core::BOOL);
...
pub unsafe fn WTSIsChildSessionsEnabled(pbenabled: *mut windows_core::BOOL) -> windows_core::BOOL {
    windows_link::link!("wtsapi32.dll" "system" fn WTSIsChildSessionsEnabled(pbenabled : *mut windows_core::BOOL) -> windows_core::BOOL);
    unsafe { WTSIsChildSessionsEnabled(pbenabled as _) }
}
#[inline]
pub unsafe fn WTSLogoffSession(hserver: Option<super::super::Foundation::HANDLE>, sessionid: u32, bwait: bool) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSLogoffSession(hserver : super::super::Foundation:: HANDLE, sessionid : u32, bwait : windows_core::BOOL) -> windows_core::BOOL);
...
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSOpenServerA(pservername : windows_core::PCSTR) -> super::super::Foundation:: HANDLE);
...
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSOpenServerExA(pservername : windows_core::PCSTR) -> super::super::Foundation:: HANDLE);
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSOpenServerExW(pservername : windows_core::PCWSTR) -> super::super::Foundation:: HANDLE);
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSOpenServerW(pservername : windows_core::PCWSTR) -> super::super::Foundation:: HANDLE);
    unsafe { WTSOpenServerW(pservername.param().abi()) }
}
#[inline]
pub unsafe fn WTSQueryListenerConfigA<P3>(hserver: Option<super::super::Foundation::HANDLE>, preserved: *const core::ffi::c_void, reserved: u32, plistenername: P3, pbuffer: *mut WTSLISTENERCONFIGA) -> Result<(), windows_result::HRESULT>
where
    P3: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSQueryListenerConfigA(hserver : super::super::Foundation:: HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plistenername : windows_core::PCSTR, pbuffer : *mut WTSLISTENERCONFIGA) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTSQueryListenerConfigW<P3>(hserver: Option<super::super::Foundation::HANDLE>, preserved: *const core::ffi::c_void, reserved: u32, plistenername: P3, pbuffer: *mut WTSLISTENERCONFIGW) -> Result<(), windows_result::HRESULT>
where
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSQueryListenerConfigW(hserver : super::super::Foundation:: HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plistenername : windows_core::PCWSTR, pbuffer : *mut WTSLISTENERCONFIGW) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTSQuerySessionInformationA(hserver: Option<super::super::Foundation::HANDLE>, sessionid: u32, wtsinfoclass: WTS_INFO_CLASS, ppbuffer: *mut windows_core::PSTR, pbytesreturned: *mut u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSQuerySessionInformationA(hserver : super::super::Foundation:: HANDLE, sessionid : u32, wtsinfoclass : WTS_INFO_CLASS, ppbuffer : *mut windows_core::PSTR, pbytesreturned : *mut u32) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTSQuerySessionInformationW(hserver: Option<super::super::Foundation::HANDLE>, sessionid: u32, wtsinfoclass: WTS_INFO_CLASS, ppbuffer: *mut windows_core::PWSTR, pbytesreturned: *mut u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSQuerySessionInformationW(hserver : super::super::Foundation:: HANDLE, sessionid : u32, wtsinfoclass : WTS_INFO_CLASS, ppbuffer : *mut windows_core::PWSTR, pbytesreturned : *mut u32) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTSQueryUserConfigA<P0, P1>(pservername: P0, pusername: P1, wtsconfigclass: WTS_CONFIG_CLASS, ppbuffer: *mut windows_core::PSTR, pbytesreturned: *mut u32) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCSTR>,
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSQueryUserConfigA(pservername : windows_core::PCSTR, pusername : windows_core::PCSTR, wtsconfigclass : WTS_CONFIG_CLASS, ppbuffer : *mut windows_core::PSTR, pbytesreturned : *mut u32) -> windows_core::BOOL);
    unsafe { WTSQueryUserConfigA(pservername.param().abi(), pusername.param().abi(), wtsconfigclass, ppbuffer as _, pbytesreturned as _).ok() }
}
#[inline]
pub unsafe fn WTSQueryUserConfigW<P0, P1>(pservername: P0, pusername: P1, wtsconfigclass: WTS_CONFIG_CLASS, ppbuffer: *mut windows_core::PWSTR, pbytesreturned: *mut u32) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSQueryUserConfigW(pservername : windows_core::PCWSTR, pusername : windows_core::PCWSTR, wtsconfigclass : WTS_CONFIG_CLASS, ppbuffer : *mut windows_core::PWSTR, pbytesreturned : *mut u32) -> windows_core::BOOL);
    unsafe { WTSQueryUserConfigW(pservername.param().abi(), pusername.param().abi(), wtsconfigclass, ppbuffer as _, pbytesreturned as _).ok() }
}
#[inline]
pub unsafe fn WTSQueryUserToken(sessionid: u32, phtoken: *mut super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSQueryUserToken(sessionid : u32, phtoken : *mut super::super::Foundation:: HANDLE) -> windows_core::BOOL);
    unsafe { WTSQueryUserToken(sessionid, phtoken as _).ok() }
}
#[inline]
pub unsafe fn WTSRegisterSessionNotification(hwnd: super::super::Foundation::HWND, dwflags: u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSRegisterSessionNotification(hwnd : super::super::Foundation:: HWND, dwflags : u32) -> windows_core::BOOL);
    unsafe { WTSRegisterSessionNotification(hwnd, dwflags).ok() }
}
#[inline]
pub unsafe fn WTSRegisterSessionNotificationEx(hserver: Option<super::super::Foundation::HANDLE>, hwnd: super::super::Foundation::HWND, dwflags: u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSRegisterSessionNotificationEx(hserver : super::super::Foundation:: HANDLE, hwnd : super::super::Foundation:: HWND, dwflags : u32) -> windows_core::BOOL);
    unsafe { WTSRegisterSessionNotificationEx(hserver.unwrap_or(core::mem::zeroed()) as _, hwnd, dwflags).ok() }
}
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn WTSSendMessageA(hserver: Option<super::super::Foundation::HANDLE>, sessionid: u32, ptitle: &[u8], pmessage: &[u8], style: super::super::UI::WindowsAndMessaging::MESSAGEBOX_STYLE, timeout: u32, presponse: *mut super::super::UI::WindowsAndMessaging::MESSAGEBOX_RESULT, bwait: bool) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSSendMessageA(hserver : super::super::Foundation:: HANDLE, sessionid : u32, ptitle : windows_core::PCSTR, titlelength : u32, pmessage : windows_core::PCSTR, messagelength : u32, style : super::super::UI::WindowsAndMessaging:: MESSAGEBOX_STYLE, timeout : u32, presponse : *mut super::super::UI::WindowsAndMessaging:: MESSAGEBOX_RESULT, bwait : windows_core::BOOL) -> windows_core::BOOL);
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn WTSSendMessageW<P2, P4>(hserver: Option<super::super::Foundation::HANDLE>, sessionid: u32, ptitle: P2, titlelength: u32, pmessage: P4, messagelength: u32, style: super::super::UI::WindowsAndMessaging::MESSAGEBOX_STYLE, timeout: u32, presponse: *mut super::super::UI::WindowsAndMessaging::MESSAGEBOX_RESULT, bwait: bool) -> Result<(), windows_result::HRESULT>
where
    P2: windows_core::Param<windows_core::PCWSTR>,
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSSendMessageW(hserver : super::super::Foundation:: HANDLE, sessionid : u32, ptitle : windows_core::PCWSTR, titlelength : u32, pmessage : windows_core::PCWSTR, messagelength : u32, style : super::super::UI::WindowsAndMessaging:: MESSAGEBOX_STYLE, timeout : u32, presponse : *mut super::super::UI::WindowsAndMessaging:: MESSAGEBOX_RESULT, bwait : windows_core::BOOL) -> windows_core::BOOL);
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn WTSSetListenerSecurityA<P3>(hserver: Option<super::super::Foundation::HANDLE>, preserved: *const core::ffi::c_void, reserved: u32, plistenername: P3, securityinformation: super::super::Security::OBJECT_SECURITY_INFORMATION, psecuritydescriptor: super::super::Security::PSECURITY_DESCRIPTOR) -> Result<(), windows_result::HRESULT>
where
    P3: windows_core::Param<windows_core::PCSTR>,
{
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn WTSSetListenerSecurityW<P3>(hserver: Option<super::super::Foundation::HANDLE>, preserved: *const core::ffi::c_void, reserved: u32, plistenername: P3, securityinformation: super::super::Security::OBJECT_SECURITY_INFORMATION, psecuritydescriptor: super::super::Security::PSECURITY_DESCRIPTOR) -> Result<(), windows_result::HRESULT>
where
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSSetListenerSecurityW(hserver : super::super::Foundation:: HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plistenername : windows_core::PCWSTR, securityinformation : super::super::Security:: OBJECT_SECURITY_INFORMATION, psecuritydescriptor : super::super::Security:: PSECURITY_DESCRIPTOR) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTSSetRenderHint(prenderhintid: *mut u64, hwndowner: super::super::Foundation::HWND, renderhinttype: u32, phintdata: Option<&[u8]>) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSSetRenderHint(prenderhintid : *mut u64, hwndowner : super::super::Foundation:: HWND, renderhinttype : u32, cbhintdatalength : u32, phintdata : *const u8) -> windows_core::HRESULT);
...
#[inline]
pub unsafe fn WTSSetUserConfigA<P0, P1>(pservername: P0, pusername: P1, wtsconfigclass: WTS_CONFIG_CLASS, pbuffer: &[u8]) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCSTR>,
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSSetUserConfigA(pservername : windows_core::PCSTR, pusername : windows_core::PCSTR, wtsconfigclass : WTS_CONFIG_CLASS, pbuffer : windows_core::PCSTR, datalength : u32) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTSSetUserConfigW<P0, P1, P3>(pservername: P0, pusername: P1, wtsconfigclass: WTS_CONFIG_CLASS, pbuffer: P3, datalength: u32) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSSetUserConfigW(pservername : windows_core::PCWSTR, pusername : windows_core::PCWSTR, wtsconfigclass : WTS_CONFIG_CLASS, pbuffer : windows_core::PCWSTR, datalength : u32) -> windows_core::BOOL);
    unsafe { WTSSetUserConfigW(pservername.param().abi(), pusername.param().abi(), wtsconfigclass, pbuffer.param().abi(), datalength).ok() }
}
#[inline]
pub unsafe fn WTSShutdownSystem(hserver: Option<super::super::Foundation::HANDLE>, shutdownflag: u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSShutdownSystem(hserver : super::super::Foundation:: HANDLE, shutdownflag : u32) -> windows_core::BOOL);
    unsafe { WTSShutdownSystem(hserver.unwrap_or(core::mem::zeroed()) as _, shutdownflag).ok() }
}
#[inline]
pub unsafe fn WTSStartRemoteControlSessionA<P0>(ptargetservername: P0, targetlogonid: u32, hotkeyvk: u8, hotkeymodifiers: u16) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSStartRemoteControlSessionA(ptargetservername : windows_core::PCSTR, targetlogonid : u32, hotkeyvk : u8, hotkeymodifiers : u16) -> windows_core::BOOL);
    unsafe { WTSStartRemoteControlSessionA(ptargetservername.param().abi(), targetlogonid, hotkeyvk, hotkeymodifiers).ok() }
}
#[inline]
pub unsafe fn WTSStartRemoteControlSessionW<P0>(ptargetservername: P0, targetlogonid: u32, hotkeyvk: u8, hotkeymodifiers: u16) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSStartRemoteControlSessionW(ptargetservername : windows_core::PCWSTR, targetlogonid : u32, hotkeyvk : u8, hotkeymodifiers : u16) -> windows_core::BOOL);
    unsafe { WTSStartRemoteControlSessionW(ptargetservername.param().abi(), targetlogonid, hotkeyvk, hotkeymodifiers).ok() }
}
#[inline]
pub unsafe fn WTSStopRemoteControlSession(logonid: u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSStopRemoteControlSession(logonid : u32) -> windows_core::BOOL);
    unsafe { WTSStopRemoteControlSession(logonid).ok() }
}
#[inline]
pub unsafe fn WTSTerminateProcess(hserver: Option<super::super::Foundation::HANDLE>, processid: u32, exitcode: u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSTerminateProcess(hserver : super::super::Foundation:: HANDLE, processid : u32, exitcode : u32) -> windows_core::BOOL);
    unsafe { WTSTerminateProcess(hserver.unwrap_or(core::mem::zeroed()) as _, processid, exitcode).ok() }
}
#[inline]
pub unsafe fn WTSUnRegisterSessionNotification(hwnd: super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSUnRegisterSessionNotification(hwnd : super::super::Foundation:: HWND) -> windows_core::BOOL);
    unsafe { WTSUnRegisterSessionNotification(hwnd).ok() }
}
#[inline]
pub unsafe fn WTSUnRegisterSessionNotificationEx(hserver: Option<super::super::Foundation::HANDLE>, hwnd: super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSUnRegisterSessionNotificationEx(hserver : super::super::Foundation:: HANDLE, hwnd : super::super::Foundation:: HWND) -> windows_core::BOOL);
    unsafe { WTSUnRegisterSessionNotificationEx(hserver.unwrap_or(core::mem::zeroed()) as _, hwnd).ok() }
}
#[inline]
pub unsafe fn WTSVirtualChannelClose(hchannelhandle: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSVirtualChannelClose(hchannelhandle : super::super::Foundation:: HANDLE) -> windows_core::BOOL);
    unsafe { WTSVirtualChannelClose(hchannelhandle).ok() }
}
#[inline]
pub unsafe fn WTSVirtualChannelOpen<P2>(hserver: Option<super::super::Foundation::HANDLE>, sessionid: u32, pvirtualname: P2) -> Result<super::super::Foundation::HANDLE, windows_result::HRESULT>
where
    P2: windows_core::Param<windows_core::PCSTR>,
{
...
#[inline]
pub unsafe fn WTSVirtualChannelOpenEx<P1>(sessionid: u32, pvirtualname: P1, flags: u32) -> Result<super::super::Foundation::HANDLE, windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
...
#[inline]
pub unsafe fn WTSVirtualChannelPurgeInput(hchannelhandle: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSVirtualChannelPurgeInput(hchannelhandle : super::super::Foundation:: HANDLE) -> windows_core::BOOL);
    unsafe { WTSVirtualChannelPurgeInput(hchannelhandle).ok() }
}
#[inline]
pub unsafe fn WTSVirtualChannelPurgeOutput(hchannelhandle: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSVirtualChannelPurgeOutput(hchannelhandle : super::super::Foundation:: HANDLE) -> windows_core::BOOL);
    unsafe { WTSVirtualChannelPurgeOutput(hchannelhandle).ok() }
}
#[inline]
pub unsafe fn WTSVirtualChannelQuery(hchannelhandle: super::super::Foundation::HANDLE, param1: WTS_VIRTUAL_CLASS, ppbuffer: *mut *mut core::ffi::c_void, pbytesreturned: *mut u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSVirtualChannelQuery(hchannelhandle : super::super::Foundation:: HANDLE, param1 : WTS_VIRTUAL_CLASS, ppbuffer : *mut *mut core::ffi::c_void, pbytesreturned : *mut u32) -> windows_core::BOOL);
    unsafe { WTSVirtualChannelQuery(hchannelhandle, param1, ppbuffer as _, pbytesreturned as _).ok() }
}
#[inline]
pub unsafe fn WTSVirtualChannelRead(hchannelhandle: super::super::Foundation::HANDLE, timeout: u32, buffer: &mut [u8], pbytesread: *mut u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSVirtualChannelRead(hchannelhandle : super::super::Foundation:: HANDLE, timeout : u32, buffer : windows_core::PSTR, buffersize : u32, pbytesread : *mut u32) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTSVirtualChannelWrite(hchannelhandle: super::super::Foundation::HANDLE, buffer: &[u8], pbyteswritten: *mut u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSVirtualChannelWrite(hchannelhandle : super::super::Foundation:: HANDLE, buffer : windows_core::PCSTR, length : u32, pbyteswritten : *mut u32) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTSWaitSystemEvent(hserver: Option<super::super::Foundation::HANDLE>, eventmask: u32, peventflags: *mut u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wtsapi32.dll" "system" fn WTSWaitSystemEvent(hserver : super::super::Foundation:: HANDLE, eventmask : u32, peventflags : *mut u32) -> windows_core::BOOL);
...
#[cfg(feature = "Win32_System_Com")]
impl IADsTSUserEx {
    pub unsafe fn TerminalServicesProfilePath(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
    ...
    pub unsafe fn SetTerminalServicesProfilePath(&self, pnewval: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn TerminalServicesHomeDirectory(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetTerminalServicesHomeDirectory(&self, pnewval: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn TerminalServicesHomeDrive(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetTerminalServicesHomeDrive(&self, pnewval: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetConnectClientDrivesAtLogon(&self, newval: i32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetConnectClientDrivesAtLogon)(windows_core::Interface::as_raw(self), newval).ok() }
    }
    pub unsafe fn ConnectClientPrintersAtLogon(&self) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetTerminalServicesWorkDirectory(&self, pnewval: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn TerminalServicesInitialProgram(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetTerminalServicesInitialProgram(&self, pnewval: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
...
pub trait IADsTSUserEx_Impl: super::Com::IDispatch_Impl {
    fn TerminalServicesProfilePath(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetTerminalServicesProfilePath(&self, pnewval: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn TerminalServicesHomeDirectory(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetTerminalServicesHomeDirectory(&self, pnewval: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn TerminalServicesHomeDrive(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetTerminalServicesHomeDrive(&self, pnewval: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn AllowLogon(&self) -> Result<i32, windows_result::HRESULT>;
    fn SetAllowLogon(&self, newval: i32) -> Result<(), windows_result::HRESULT>;
    fn EnableRemoteControl(&self) -> Result<i32, windows_result::HRESULT>;
    fn SetEnableRemoteControl(&self, newval: i32) -> Result<(), windows_result::HRESULT>;
    fn MaxDisconnectionTime(&self) -> Result<i32, windows_result::HRESULT>;
    fn SetMaxDisconnectionTime(&self, newval: i32) -> Result<(), windows_result::HRESULT>;
    fn MaxConnectionTime(&self) -> Result<i32, windows_result::HRESULT>;
    fn SetMaxConnectionTime(&self, newval: i32) -> Result<(), windows_result::HRESULT>;
    fn MaxIdleTime(&self) -> Result<i32, windows_result::HRESULT>;
    fn SetMaxIdleTime(&self, newval: i32) -> Result<(), windows_result::HRESULT>;
    fn ReconnectionAction(&self) -> Result<i32, windows_result::HRESULT>;
    fn SetReconnectionAction(&self, newval: i32) -> Result<(), windows_result::HRESULT>;
    fn BrokenConnectionAction(&self) -> Result<i32, windows_result::HRESULT>;
    fn SetBrokenConnectionAction(&self, newval: i32) -> Result<(), windows_result::HRESULT>;
    fn ConnectClientDrivesAtLogon(&self) -> Result<i32, windows_result::HRESULT>;
    fn SetConnectClientDrivesAtLogon(&self, newval: i32) -> Result<(), windows_result::HRESULT>;
    fn ConnectClientPrintersAtLogon(&self) -> Result<i32, windows_result::HRESULT>;
    fn SetConnectClientPrintersAtLogon(&self, newval: i32) -> Result<(), windows_result::HRESULT>;
    fn DefaultToMainPrinter(&self) -> Result<i32, windows_result::HRESULT>;
    fn SetDefaultToMainPrinter(&self, newval: i32) -> Result<(), windows_result::HRESULT>;
    fn TerminalServicesWorkDirectory(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetTerminalServicesWorkDirectory(&self, pnewval: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn TerminalServicesInitialProgram(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetTerminalServicesInitialProgram(&self, pnewval: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IAudioDeviceEndpoint {
    pub unsafe fn SetBuffer(&self, maxperiod: i64, u32latencycoefficient: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetRTCaps(&self) -> Result<windows_core::BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRTCaps)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetEventDrivenCapable(&self) -> Result<windows_core::BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetEventDrivenCapable)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn WriteExclusiveModeParametersToSharedMemory(&self, htargetprocess: usize, hnsperiod: i64, hnsbufferduration: i64, u32latencycoefficient: u32, pu32sharedmemorysize: *mut u32, phsharedmemory: *mut usize) -> Result<(), windows_result::HRESULT> {
...
pub trait IAudioDeviceEndpoint_Impl: windows_core::IUnknownImpl {
    fn SetBuffer(&self, maxperiod: i64, u32latencycoefficient: u32) -> Result<(), windows_result::HRESULT>;
    fn GetRTCaps(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
    fn GetEventDrivenCapable(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
    fn WriteExclusiveModeParametersToSharedMemory(&self, htargetprocess: usize, hnsperiod: i64, hnsbufferduration: i64, u32latencycoefficient: u32, pu32sharedmemorysize: *mut u32, phsharedmemory: *mut usize) -> Result<(), windows_result::HRESULT>;
}
...
pub trait IAudioEndpoint_Impl: windows_core::IUnknownImpl {
    fn GetFrameFormat(&self) -> Result<*mut super::super::Media::Audio::WAVEFORMATEX, windows_result::HRESULT>;
    fn GetFramesPerPacket(&self) -> Result<u32, windows_result::HRESULT>;
    fn GetLatency(&self) -> Result<i64, windows_result::HRESULT>;
    fn SetStreamFlags(&self, streamflags: u32) -> Result<(), windows_result::HRESULT>;
    fn SetEventHandle(&self, eventhandle: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Media_Audio")]
...
impl IAudioEndpointRT {
    ...
    pub unsafe fn SetPinInactive(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetPinInactive)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn SetPinActive(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IAudioEndpointRT_Impl: windows_core::IUnknownImpl {
    ...
    fn SetPinInactive(&self) -> Result<(), windows_result::HRESULT>;
    fn SetPinActive(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IRemoteDesktopClient {
    ...
    pub unsafe fn Reconnect(&self, width: u32, height: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Reconnect)(windows_core::Interface::as_raw(self), width, height).ok() }
    }
    pub unsafe fn Settings(&self) -> Result<IRemoteDesktopClientSettings, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Actions(&self) -> Result<IRemoteDesktopClientActions, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn TouchPointer(&self) -> Result<IRemoteDesktopClientTouchPointer, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn DeleteSavedCredentials(&self, servername: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn UpdateSessionDisplaySettings(&self, width: u32, height: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn attachEvent<P1>(&self, eventname: &windows_core::BSTR, callback: P1) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn detachEvent<P1>(&self, eventname: &windows_core::BSTR, callback: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<super::Com::IDispatch>,
    {
...
pub trait IRemoteDesktopClient_Impl: super::Com::IDispatch_Impl {
    ...
    fn Reconnect(&self, width: u32, height: u32) -> Result<(), windows_result::HRESULT>;
    fn Settings(&self) -> Result<IRemoteDesktopClientSettings, windows_result::HRESULT>;
    fn Actions(&self) -> Result<IRemoteDesktopClientActions, windows_result::HRESULT>;
    fn TouchPointer(&self) -> Result<IRemoteDesktopClientTouchPointer, windows_result::HRESULT>;
    fn DeleteSavedCredentials(&self, servername: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn UpdateSessionDisplaySettings(&self, width: u32, height: u32) -> Result<(), windows_result::HRESULT>;
    fn attachEvent(&self, eventname: &windows_core::BSTR, callback: windows_core::Ref<'_, super::Com::IDispatch>) -> Result<(), windows_result::HRESULT>;
    fn detachEvent(&self, eventname: &windows_core::BSTR, callback: windows_core::Ref<'_, super::Com::IDispatch>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRemoteDesktopClientActions {
    pub unsafe fn SuspendScreenUpdates(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SuspendScreenUpdates)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn ResumeScreenUpdates(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).ResumeScreenUpdates)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn ExecuteRemoteAction(&self, remoteaction: RemoteActionType) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).ExecuteRemoteAction)(windows_core::Interface::as_raw(self), remoteaction).ok() }
    }
    pub unsafe fn GetSnapshot(&self, snapshotencoding: SnapshotEncodingType, snapshotformat: SnapshotFormatType, snapshotwidth: u32, snapshotheight: u32) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRemoteDesktopClientActions_Impl: super::Com::IDispatch_Impl {
    fn SuspendScreenUpdates(&self) -> Result<(), windows_result::HRESULT>;
    fn ResumeScreenUpdates(&self) -> Result<(), windows_result::HRESULT>;
    fn ExecuteRemoteAction(&self, remoteaction: RemoteActionType) -> Result<(), windows_result::HRESULT>;
    fn GetSnapshot(&self, snapshotencoding: SnapshotEncodingType, snapshotformat: SnapshotFormatType, snapshotwidth: u32, snapshotheight: u32) -> Result<windows_core::BSTR, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRemoteDesktopClientSettings {
    pub unsafe fn ApplySettings(&self, rdpfilecontents: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn RetrieveSettings(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetRdpProperty(&self, propertyname: &windows_core::BSTR) -> Result<super::Variant::VARIANT, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn SetRdpProperty(&self, propertyname: &windows_core::BSTR, value: &super::Variant::VARIANT) -> Result<(), windows_result::HRESULT> {
...
pub trait IRemoteDesktopClientSettings_Impl: super::Com::IDispatch_Impl {
    fn ApplySettings(&self, rdpfilecontents: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn RetrieveSettings(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn GetRdpProperty(&self, propertyname: &windows_core::BSTR) -> Result<super::Variant::VARIANT, windows_result::HRESULT>;
    fn SetRdpProperty(&self, propertyname: &windows_core::BSTR, value: &super::Variant::VARIANT) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRemoteDesktopClientTouchPointer {
    pub unsafe fn SetEnabled(&self, enabled: super::super::Foundation::VARIANT_BOOL) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetEventsEnabled(&self, eventsenabled: super::super::Foundation::VARIANT_BOOL) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetEventsEnabled)(windows_core::Interface::as_raw(self), eventsenabled).ok() }
    }
    pub unsafe fn EventsEnabled(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EventsEnabled)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetPointerSpeed(&self, pointerspeed: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetPointerSpeed)(windows_core::Interface::as_raw(self), pointerspeed).ok() }
    }
    pub unsafe fn PointerSpeed(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRemoteDesktopClientTouchPointer_Impl: super::Com::IDispatch_Impl {
    fn SetEnabled(&self, enabled: super::super::Foundation::VARIANT_BOOL) -> Result<(), windows_result::HRESULT>;
    fn Enabled(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT>;
    fn SetEventsEnabled(&self, eventsenabled: super::super::Foundation::VARIANT_BOOL) -> Result<(), windows_result::HRESULT>;
    fn EventsEnabled(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT>;
    fn SetPointerSpeed(&self, pointerspeed: u32) -> Result<(), windows_result::HRESULT>;
    fn PointerSpeed(&self) -> Result<u32, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRemoteSystemAdditionalInfoProvider {
    pub unsafe fn GetAdditionalInfo<T>(&self, deduplicationid: *mut windows_core::HSTRING) -> Result<T, windows_result::HRESULT>
    where
...
pub trait IRemoteSystemAdditionalInfoProvider_Impl: windows_core::IUnknownImpl {
    fn GetAdditionalInfo(&self, deduplicationid: *mut windows_core::HSTRING, riid: *const windows_core::GUID, mapview: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
}
...
impl ITSGAccountingEngine {
    pub unsafe fn DoAccounting(&self, accountingdatatype: AAAccountingDataType, accountingdata: &AAAccountingData) -> Result<(), windows_result::HRESULT> {
...
pub trait ITSGAccountingEngine_Impl: windows_core::IUnknownImpl {
    fn DoAccounting(&self, accountingdatatype: AAAccountingDataType, accountingdata: &AAAccountingData) -> Result<(), windows_result::HRESULT>;
}
...
impl ITSGAuthenticateUserSink {
    pub unsafe fn OnUserAuthenticated(&self, username: &windows_core::BSTR, userdomain: &windows_core::BSTR, context: usize, usertoken: super::super::Foundation::HANDLE_PTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn OnUserAuthenticationFailed(&self, context: usize, genericerrorcode: windows_core::HRESULT, specificerrorcode: windows_core::HRESULT) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn ReauthenticateUser(&self, context: usize) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).ReauthenticateUser)(windows_core::Interface::as_raw(self), context).ok() }
    }
    pub unsafe fn DisconnectUser(&self, context: usize) -> Result<(), windows_result::HRESULT> {
...
pub trait ITSGAuthenticateUserSink_Impl: windows_core::IUnknownImpl {
    fn OnUserAuthenticated(&self, username: &windows_core::BSTR, userdomain: &windows_core::BSTR, context: usize, usertoken: super::super::Foundation::HANDLE_PTR) -> Result<(), windows_result::HRESULT>;
    fn OnUserAuthenticationFailed(&self, context: usize, genericerrorcode: windows_core::HRESULT, specificerrorcode: windows_core::HRESULT) -> Result<(), windows_result::HRESULT>;
    fn ReauthenticateUser(&self, context: usize) -> Result<(), windows_result::HRESULT>;
    fn DisconnectUser(&self, context: usize) -> Result<(), windows_result::HRESULT>;
}
...
impl ITSGAuthenticationEngine {
    pub unsafe fn AuthenticateUser<P4>(&self, mainsessionid: windows_core::GUID, cookiedata: *const u8, numcookiebytes: u32, context: usize, psink: P4) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn CancelAuthentication(&self, mainsessionid: windows_core::GUID, context: usize) -> Result<(), windows_result::HRESULT> {
...
pub trait ITSGAuthenticationEngine_Impl: windows_core::IUnknownImpl {
    fn AuthenticateUser(&self, mainsessionid: &windows_core::GUID, cookiedata: *const u8, numcookiebytes: u32, context: usize, psink: windows_core::Ref<'_, ITSGAuthenticateUserSink>) -> Result<(), windows_result::HRESULT>;
    fn CancelAuthentication(&self, mainsessionid: &windows_core::GUID, context: usize) -> Result<(), windows_result::HRESULT>;
}
...
impl ITSGAuthorizeConnectionSink {
    pub unsafe fn OnConnectionAuthorized(&self, hrin: windows_core::HRESULT, mainsessionid: windows_core::GUID, pbsohresponse: &[u8], idletimeout: u32, sessiontimeout: u32, sessiontimeoutaction: SESSION_TIMEOUT_ACTION_TYPE, trustclass: AATrustClassID, policyattributes: *const u32) -> Result<(), windows_result::HRESULT> {
...
pub trait ITSGAuthorizeConnectionSink_Impl: windows_core::IUnknownImpl {
    fn OnConnectionAuthorized(&self, hrin: windows_core::HRESULT, mainsessionid: &windows_core::GUID, cbsohresponse: u32, pbsohresponse: *const u8, idletimeout: u32, sessiontimeout: u32, sessiontimeoutaction: SESSION_TIMEOUT_ACTION_TYPE, trustclass: AATrustClassID, policyattributes: *const u32) -> Result<(), windows_result::HRESULT>;
}
...
impl ITSGAuthorizeResourceSink {
    pub unsafe fn OnChannelAuthorized(&self, hrin: windows_core::HRESULT, mainsessionid: windows_core::GUID, subsessionid: i32, allowedresourcenames: &[windows_core::BSTR], failedresourcenames: &[windows_core::BSTR]) -> Result<(), windows_result::HRESULT> {
...
pub trait ITSGAuthorizeResourceSink_Impl: windows_core::IUnknownImpl {
    fn OnChannelAuthorized(&self, hrin: windows_core::HRESULT, mainsessionid: &windows_core::GUID, subsessionid: i32, allowedresourcenames: *const windows_core::BSTR, numallowedresourcenames: u32, failedresourcenames: *const windows_core::BSTR, numfailedresourcenames: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl ITSGPolicyEngine {
    pub unsafe fn AuthorizeConnection<P10>(&self, mainsessionid: windows_core::GUID, username: &windows_core::BSTR, authtype: AAAuthSchemes, clientmachineip: &windows_core::BSTR, clientmachinename: &windows_core::BSTR, sohdata: &[u8], cookiedata: &[u8], usertoken: super::super::Foundation::HANDLE_PTR, psink: P10) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn AuthorizeResource<P11>(&self, mainsessionid: windows_core::GUID, subsessionid: i32, username: &windows_core::BSTR, resourcenames: &[windows_core::BSTR], alternateresourcenames: &[windows_core::BSTR], portnumber: u32, operation: &windows_core::BSTR, cookie: &[u8], psink: P11) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn IsQuarantineEnabled(&self) -> Result<windows_core::BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ITSGPolicyEngine_Impl: windows_core::IUnknownImpl {
    fn AuthorizeConnection(&self, mainsessionid: &windows_core::GUID, username: &windows_core::BSTR, authtype: AAAuthSchemes, clientmachineip: &windows_core::BSTR, clientmachinename: &windows_core::BSTR, sohdata: *const u8, numsohbytes: u32, cookiedata: *const u8, numcookiebytes: u32, usertoken: super::super::Foundation::HANDLE_PTR, psink: windows_core::Ref<'_, ITSGAuthorizeConnectionSink>) -> Result<(), windows_result::HRESULT>;
    fn AuthorizeResource(&self, mainsessionid: &windows_core::GUID, subsessionid: i32, username: &windows_core::BSTR, resourcenames: *const windows_core::BSTR, numresources: u32, alternateresourcenames: *const windows_core::BSTR, numalternateresourcename: u32, portnumber: u32, operation: &windows_core::BSTR, cookie: *const u8, numbytesincookie: u32, psink: windows_core::Ref<'_, ITSGAuthorizeResourceSink>) -> Result<(), windows_result::HRESULT>;
    fn Refresh(&self) -> Result<(), windows_result::HRESULT>;
    fn IsQuarantineEnabled(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
}
...
impl ITsSbBaseNotifySink {
    pub unsafe fn OnError(&self, hrerror: windows_core::HRESULT) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).OnError)(windows_core::Interface::as_raw(self), hrerror).ok() }
    }
    pub unsafe fn OnReportStatus(&self, messagetype: CLIENT_MESSAGE_TYPE, messageid: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait ITsSbBaseNotifySink_Impl: windows_core::IUnknownImpl {
    fn OnError(&self, hrerror: windows_core::HRESULT) -> Result<(), windows_result::HRESULT>;
    fn OnReportStatus(&self, messagetype: CLIENT_MESSAGE_TYPE, messageid: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl ITsSbClientConnection {
    ...
    pub unsafe fn Domain(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn InitialProgram(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn LoadBalanceResult(&self) -> Result<ITsSbLoadBalanceResult, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn FarmName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn PutContext(&self, contextid: &windows_core::BSTR, context: &super::Variant::VARIANT, existingcontext: Option<*mut super::Variant::VARIANT>) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetContext(&self, contextid: &windows_core::BSTR) -> Result<super::Variant::VARIANT, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Environment(&self) -> Result<ITsSbEnvironment, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn get_ConnectionError(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).get_ConnectionError)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn SamUserAccount(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ClientConnectionPropertySet(&self) -> Result<ITsSbClientConnectionPropertySet, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ITsSbClientConnection_Impl: windows_core::IUnknownImpl {
    ...
    fn Domain(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn InitialProgram(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn LoadBalanceResult(&self) -> Result<ITsSbLoadBalanceResult, windows_result::HRESULT>;
    fn FarmName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn PutContext(&self, contextid: &windows_core::BSTR, context: &super::Variant::VARIANT, existingcontext: *mut super::Variant::VARIANT) -> Result<(), windows_result::HRESULT>;
    fn GetContext(&self, contextid: &windows_core::BSTR) -> Result<super::Variant::VARIANT, windows_result::HRESULT>;
    fn Environment(&self) -> Result<ITsSbEnvironment, windows_result::HRESULT>;
    fn get_ConnectionError(&self) -> Result<(), windows_result::HRESULT>;
    fn SamUserAccount(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn ClientConnectionPropertySet(&self) -> Result<ITsSbClientConnectionPropertySet, windows_result::HRESULT>;
    fn IsFirstAssignment(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
    fn RdFarmType(&self) -> Result<RD_FARM_TYPE, windows_result::HRESULT>;
    fn UserSidString(&self) -> Result<*mut i8, windows_result::HRESULT>;
    fn GetDisconnectedSession(&self) -> Result<ITsSbSession, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl ITsSbEnvironment {
    ...
    pub unsafe fn ServerWeight(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn EnvironmentPropertySet(&self) -> Result<ITsSbEnvironmentPropertySet, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn SetEnvironmentPropertySet<P0>(&self, pval: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait ITsSbEnvironment_Impl: windows_core::IUnknownImpl {
    ...
    fn ServerWeight(&self) -> Result<u32, windows_result::HRESULT>;
    fn EnvironmentPropertySet(&self) -> Result<ITsSbEnvironmentPropertySet, windows_result::HRESULT>;
    fn SetEnvironmentPropertySet(&self, pval: windows_core::Ref<'_, ITsSbEnvironmentPropertySet>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com_StructuredStorage")]
...
impl ITsSbFilterPluginStore {
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn SaveProperties<P0>(&self, ppropertyset: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn EnumerateProperties(&self) -> Result<ITsSbPropertySet, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn DeleteProperties(&self, propertyname: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
...
pub trait ITsSbFilterPluginStore_Impl: windows_core::IUnknownImpl {
    fn SaveProperties(&self, ppropertyset: windows_core::Ref<'_, ITsSbPropertySet>) -> Result<(), windows_result::HRESULT>;
    fn EnumerateProperties(&self) -> Result<ITsSbPropertySet, windows_result::HRESULT>;
    fn DeleteProperties(&self, propertyname: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com_StructuredStorage")]
...
impl ITsSbGenericNotifySink {
    pub unsafe fn OnCompleted(&self, status: windows_core::HRESULT) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).OnCompleted)(windows_core::Interface::as_raw(self), status).ok() }
    }
    pub unsafe fn GetWaitTimeout(&self) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ITsSbGenericNotifySink_Impl: windows_core::IUnknownImpl {
    fn OnCompleted(&self, status: windows_core::HRESULT) -> Result<(), windows_result::HRESULT>;
    fn GetWaitTimeout(&self) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT>;
}
...
impl ITsSbGlobalStore {
    pub unsafe fn QueryTarget(&self, providername: &windows_core::BSTR, targetname: &windows_core::BSTR, farmname: &windows_core::BSTR) -> Result<ITsSbTarget, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn QuerySessionBySessionId(&self, providername: &windows_core::BSTR, dwsessionid: u32, targetname: &windows_core::BSTR) -> Result<ITsSbSession, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn EnumerateFarms(&self, providername: &windows_core::BSTR, pdwcount: *mut u32, pval: *mut *mut super::Com::SAFEARRAY) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn EnumerateTargets(&self, providername: &windows_core::BSTR, farmname: &windows_core::BSTR, envname: &windows_core::BSTR, pdwcount: *mut u32, pval: *mut *mut Option<ITsSbTarget>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn EnumerateEnvironmentsByProvider(&self, providername: &windows_core::BSTR, pdwcount: *mut u32, ppval: *mut *mut Option<ITsSbEnvironment>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn EnumerateSessions(&self, providername: &windows_core::BSTR, targetname: &windows_core::BSTR, username: &windows_core::BSTR, userdomain: &windows_core::BSTR, poolname: &windows_core::BSTR, initialprogram: &windows_core::BSTR, psessionstate: *const TSSESSION_STATE, pdwcount: *mut u32, ppval: *mut *mut Option<ITsSbSession>) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetFarmProperty(&self, farmname: &windows_core::BSTR, propertyname: &windows_core::BSTR, pvarvalue: *const super::Variant::VARIANT) -> Result<(), windows_result::HRESULT> {
...
pub trait ITsSbGlobalStore_Impl: windows_core::IUnknownImpl {
    fn QueryTarget(&self, providername: &windows_core::BSTR, targetname: &windows_core::BSTR, farmname: &windows_core::BSTR) -> Result<ITsSbTarget, windows_result::HRESULT>;
    fn QuerySessionBySessionId(&self, providername: &windows_core::BSTR, dwsessionid: u32, targetname: &windows_core::BSTR) -> Result<ITsSbSession, windows_result::HRESULT>;
    fn EnumerateFarms(&self, providername: &windows_core::BSTR, pdwcount: *mut u32, pval: *mut *mut super::Com::SAFEARRAY) -> Result<(), windows_result::HRESULT>;
    fn EnumerateTargets(&self, providername: &windows_core::BSTR, farmname: &windows_core::BSTR, envname: &windows_core::BSTR, pdwcount: *mut u32, pval: *mut *mut Option<ITsSbTarget>) -> Result<(), windows_result::HRESULT>;
    fn EnumerateEnvironmentsByProvider(&self, providername: &windows_core::BSTR, pdwcount: *mut u32, ppval: *mut *mut Option<ITsSbEnvironment>) -> Result<(), windows_result::HRESULT>;
    fn EnumerateSessions(&self, providername: &windows_core::BSTR, targetname: &windows_core::BSTR, username: &windows_core::BSTR, userdomain: &windows_core::BSTR, poolname: &windows_core::BSTR, initialprogram: &windows_core::BSTR, psessionstate: *const TSSESSION_STATE, pdwcount: *mut u32, ppval: *mut *mut Option<ITsSbSession>) -> Result<(), windows_result::HRESULT>;
    fn GetFarmProperty(&self, farmname: &windows_core::BSTR, propertyname: &windows_core::BSTR, pvarvalue: *const super::Variant::VARIANT) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl ITsSbLoadBalanceResult {
    pub unsafe fn TargetName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ITsSbLoadBalanceResult_Impl: windows_core::IUnknownImpl {
    fn TargetName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
}
...
impl ITsSbLoadBalancing {
    pub unsafe fn GetMostSuitableTarget<P0, P1>(&self, pconnection: P0, plbsink: P1) -> Result<(), windows_result::HRESULT>
    where
...
pub trait ITsSbLoadBalancing_Impl: ITsSbPlugin_Impl {
    fn GetMostSuitableTarget(&self, pconnection: windows_core::Ref<'_, ITsSbClientConnection>, plbsink: windows_core::Ref<'_, ITsSbLoadBalancingNotifySink>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com_StructuredStorage")]
...
impl ITsSbLoadBalancingNotifySink {
    pub unsafe fn OnGetMostSuitableTarget<P0>(&self, plbresult: P0, fisnewconnection: bool) -> Result<(), windows_result::HRESULT>
    where
...
pub trait ITsSbLoadBalancingNotifySink_Impl: ITsSbBaseNotifySink_Impl {
    fn OnGetMostSuitableTarget(&self, plbresult: windows_core::Ref<'_, ITsSbLoadBalanceResult>, fisnewconnection: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
}
...
impl ITsSbOrchestration {
    pub unsafe fn PrepareTargetForConnect<P0, P1>(&self, pconnection: P0, porchestrationnotifysink: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ITsSbClientConnection>,
...
pub trait ITsSbOrchestration_Impl: ITsSbPlugin_Impl {
    fn PrepareTargetForConnect(&self, pconnection: windows_core::Ref<'_, ITsSbClientConnection>, porchestrationnotifysink: windows_core::Ref<'_, ITsSbOrchestrationNotifySink>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com_StructuredStorage")]
...
impl ITsSbOrchestrationNotifySink {
    pub unsafe fn OnReadyToConnect<P0>(&self, ptarget: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait ITsSbOrchestrationNotifySink_Impl: ITsSbBaseNotifySink_Impl {
    fn OnReadyToConnect(&self, ptarget: windows_core::Ref<'_, ITsSbTarget>) -> Result<(), windows_result::HRESULT>;
}
...
impl ITsSbPlacement {
    pub unsafe fn QueryEnvironmentForTarget<P0, P1>(&self, pconnection: P0, pplacementsink: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ITsSbClientConnection>,
...
pub trait ITsSbPlacement_Impl: ITsSbPlugin_Impl {
    fn QueryEnvironmentForTarget(&self, pconnection: windows_core::Ref<'_, ITsSbClientConnection>, pplacementsink: windows_core::Ref<'_, ITsSbPlacementNotifySink>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com_StructuredStorage")]
...
impl ITsSbPlacementNotifySink {
    pub unsafe fn OnQueryEnvironmentCompleted<P0>(&self, penvironment: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait ITsSbPlacementNotifySink_Impl: ITsSbBaseNotifySink_Impl {
    fn OnQueryEnvironmentCompleted(&self, penvironment: windows_core::Ref<'_, ITsSbEnvironment>) -> Result<(), windows_result::HRESULT>;
}
...
impl ITsSbPlugin {
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn Initialize<P0, P1, P2>(&self, pprovider: P0, pnotifysink: P1, ppropertyset: P2) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Terminate(&self, hr: windows_core::HRESULT) -> Result<(), windows_result::HRESULT> {
...
pub trait ITsSbPlugin_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, pprovider: windows_core::Ref<'_, ITsSbProvider>, pnotifysink: windows_core::Ref<'_, ITsSbPluginNotifySink>, ppropertyset: windows_core::Ref<'_, ITsSbPluginPropertySet>) -> Result<(), windows_result::HRESULT>;
    fn Terminate(&self, hr: windows_core::HRESULT) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com_StructuredStorage")]
...
impl ITsSbPluginNotifySink {
    pub unsafe fn OnInitialized(&self, hr: windows_core::HRESULT) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).OnInitialized)(windows_core::Interface::as_raw(self), hr).ok() }
    }
    pub unsafe fn OnTerminated(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait ITsSbPluginNotifySink_Impl: ITsSbBaseNotifySink_Impl {
    fn OnInitialized(&self, hr: windows_core::HRESULT) -> Result<(), windows_result::HRESULT>;
    fn OnTerminated(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl ITsSbProvider {
    pub unsafe fn CreateTargetObject(&self, targetname: &windows_core::BSTR, environmentname: &windows_core::BSTR) -> Result<ITsSbTarget, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateLoadBalanceResultObject(&self, targetname: &windows_core::BSTR) -> Result<ITsSbLoadBalanceResult, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateSessionObject(&self, targetname: &windows_core::BSTR, username: &windows_core::BSTR, domain: &windows_core::BSTR, sessionid: u32) -> Result<ITsSbSession, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn CreatePluginPropertySet(&self) -> Result<ITsSbPluginPropertySet, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn CreateTargetPropertySetObject(&self) -> Result<ITsSbTargetPropertySet, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateEnvironmentObject(&self, name: &windows_core::BSTR, serverweight: u32) -> Result<ITsSbEnvironment, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetResourcePluginStore(&self) -> Result<ITsSbResourcePluginStore, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFilterPluginStore(&self) -> Result<ITsSbFilterPluginStore, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RegisterForNotification<P2>(&self, notificationtype: u32, resourcetomonitor: &windows_core::BSTR, ppluginnotification: P2) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn UnRegisterForNotification(&self, notificationtype: u32, resourcetomonitor: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetInstanceOfGlobalStore(&self) -> Result<ITsSbGlobalStore, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn CreateEnvironmentPropertySetObject(&self) -> Result<ITsSbEnvironmentPropertySet, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ITsSbProvider_Impl: windows_core::IUnknownImpl {
    fn CreateTargetObject(&self, targetname: &windows_core::BSTR, environmentname: &windows_core::BSTR) -> Result<ITsSbTarget, windows_result::HRESULT>;
    fn CreateLoadBalanceResultObject(&self, targetname: &windows_core::BSTR) -> Result<ITsSbLoadBalanceResult, windows_result::HRESULT>;
    fn CreateSessionObject(&self, targetname: &windows_core::BSTR, username: &windows_core::BSTR, domain: &windows_core::BSTR, sessionid: u32) -> Result<ITsSbSession, windows_result::HRESULT>;
    fn CreatePluginPropertySet(&self) -> Result<ITsSbPluginPropertySet, windows_result::HRESULT>;
    fn CreateTargetPropertySetObject(&self) -> Result<ITsSbTargetPropertySet, windows_result::HRESULT>;
    fn CreateEnvironmentObject(&self, name: &windows_core::BSTR, serverweight: u32) -> Result<ITsSbEnvironment, windows_result::HRESULT>;
    fn GetResourcePluginStore(&self) -> Result<ITsSbResourcePluginStore, windows_result::HRESULT>;
    fn GetFilterPluginStore(&self) -> Result<ITsSbFilterPluginStore, windows_result::HRESULT>;
    fn RegisterForNotification(&self, notificationtype: u32, resourcetomonitor: &windows_core::BSTR, ppluginnotification: windows_core::Ref<'_, ITsSbResourceNotification>) -> Result<(), windows_result::HRESULT>;
    fn UnRegisterForNotification(&self, notificationtype: u32, resourcetomonitor: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn GetInstanceOfGlobalStore(&self) -> Result<ITsSbGlobalStore, windows_result::HRESULT>;
    fn CreateEnvironmentPropertySetObject(&self) -> Result<ITsSbEnvironmentPropertySet, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com_StructuredStorage")]
...
impl ITsSbProvisioning {
    pub unsafe fn CreateVirtualMachines<P2>(&self, jobxmlstring: &windows_core::BSTR, jobguid: &windows_core::BSTR, psink: P2) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn PatchVirtualMachines<P2>(&self, jobxmlstring: &windows_core::BSTR, jobguid: &windows_core::BSTR, psink: P2, pvmpatchinfo: *const VM_PATCH_INFO) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<ITsSbProvisioningPluginNotifySink>,
    {
    ...
    pub unsafe fn DeleteVirtualMachines<P2>(&self, jobxmlstring: &windows_core::BSTR, jobguid: &windows_core::BSTR, psink: P2) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<ITsSbProvisioningPluginNotifySink>,
    {
    ...
    pub unsafe fn CancelJob(&self, jobguid: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
...
pub trait ITsSbProvisioning_Impl: ITsSbPlugin_Impl {
    fn CreateVirtualMachines(&self, jobxmlstring: &windows_core::BSTR, jobguid: &windows_core::BSTR, psink: windows_core::Ref<'_, ITsSbProvisioningPluginNotifySink>) -> Result<(), windows_result::HRESULT>;
    fn PatchVirtualMachines(&self, jobxmlstring: &windows_core::BSTR, jobguid: &windows_core::BSTR, psink: windows_core::Ref<'_, ITsSbProvisioningPluginNotifySink>, pvmpatchinfo: *const VM_PATCH_INFO) -> Result<(), windows_result::HRESULT>;
    fn DeleteVirtualMachines(&self, jobxmlstring: &windows_core::BSTR, jobguid: &windows_core::BSTR, psink: windows_core::Ref<'_, ITsSbProvisioningPluginNotifySink>) -> Result<(), windows_result::HRESULT>;
    fn CancelJob(&self, jobguid: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com_StructuredStorage")]
...
impl ITsSbProvisioningPluginNotifySink {
    pub unsafe fn OnJobCreated(&self, pvmnotifyinfo: *const VM_NOTIFY_INFO) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).OnJobCreated)(windows_core::Interface::as_raw(self), pvmnotifyinfo).ok() }
    }
    pub unsafe fn OnVirtualMachineStatusChanged(&self, pvmnotifyentry: *const VM_NOTIFY_ENTRY, vmnotifystatus: VM_NOTIFY_STATUS, errorcode: windows_core::HRESULT, errordescr: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn OnJobCompleted(&self, resultcode: windows_core::HRESULT, resultdescription: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn OnJobCancelled(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).OnJobCancelled)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn LockVirtualMachine(&self, pvmnotifyentry: *const VM_NOTIFY_ENTRY) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).LockVirtualMachine)(windows_core::Interface::as_raw(self), pvmnotifyentry).ok() }
    }
    pub unsafe fn OnVirtualMachineHostStatusChanged(&self, vmhost: &windows_core::BSTR, vmhostnotifystatus: VM_HOST_NOTIFY_STATUS, errorcode: windows_core::HRESULT, errordescr: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
...
pub trait ITsSbProvisioningPluginNotifySink_Impl: windows_core::IUnknownImpl {
    fn OnJobCreated(&self, pvmnotifyinfo: *const VM_NOTIFY_INFO) -> Result<(), windows_result::HRESULT>;
    fn OnVirtualMachineStatusChanged(&self, pvmnotifyentry: *const VM_NOTIFY_ENTRY, vmnotifystatus: VM_NOTIFY_STATUS, errorcode: windows_core::HRESULT, errordescr: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn OnJobCompleted(&self, resultcode: windows_core::HRESULT, resultdescription: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn OnJobCancelled(&self) -> Result<(), windows_result::HRESULT>;
    fn LockVirtualMachine(&self, pvmnotifyentry: *const VM_NOTIFY_ENTRY) -> Result<(), windows_result::HRESULT>;
    fn OnVirtualMachineHostStatusChanged(&self, vmhost: &windows_core::BSTR, vmhostnotifystatus: VM_HOST_NOTIFY_STATUS, errorcode: windows_core::HRESULT, errordescr: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
}
...
impl ITsSbResourceNotification {
    pub unsafe fn NotifySessionChange<P1>(&self, changetype: TSSESSION_STATE, psession: P1) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn NotifyTargetChange<P1>(&self, targetchangetype: u32, ptarget: P1) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn NotifyClientConnectionStateChange<P1>(&self, changetype: CONNECTION_CHANGE_NOTIFICATION, pconnection: P1) -> Result<(), windows_result::HRESULT>
    where
...
pub trait ITsSbResourceNotification_Impl: windows_core::IUnknownImpl {
    fn NotifySessionChange(&self, changetype: TSSESSION_STATE, psession: windows_core::Ref<'_, ITsSbSession>) -> Result<(), windows_result::HRESULT>;
    fn NotifyTargetChange(&self, targetchangetype: u32, ptarget: windows_core::Ref<'_, ITsSbTarget>) -> Result<(), windows_result::HRESULT>;
    fn NotifyClientConnectionStateChange(&self, changetype: CONNECTION_CHANGE_NOTIFICATION, pconnection: windows_core::Ref<'_, ITsSbClientConnection>) -> Result<(), windows_result::HRESULT>;
}
...
impl ITsSbResourceNotificationEx {
    pub unsafe fn NotifySessionChangeEx(&self, targetname: &windows_core::BSTR, username: &windows_core::BSTR, domain: &windows_core::BSTR, sessionid: u32, sessionstate: TSSESSION_STATE) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn NotifyTargetChangeEx(&self, targetname: &windows_core::BSTR, targetchangetype: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn NotifyClientConnectionStateChangeEx(&self, username: &windows_core::BSTR, domain: &windows_core::BSTR, initialprogram: &windows_core::BSTR, poolname: &windows_core::BSTR, targetname: &windows_core::BSTR, connectionchangetype: CONNECTION_CHANGE_NOTIFICATION) -> Result<(), windows_result::HRESULT> {
...
pub trait ITsSbResourceNotificationEx_Impl: windows_core::IUnknownImpl {
    fn NotifySessionChangeEx(&self, targetname: &windows_core::BSTR, username: &windows_core::BSTR, domain: &windows_core::BSTR, sessionid: u32, sessionstate: TSSESSION_STATE) -> Result<(), windows_result::HRESULT>;
    fn NotifyTargetChangeEx(&self, targetname: &windows_core::BSTR, targetchangetype: u32) -> Result<(), windows_result::HRESULT>;
    fn NotifyClientConnectionStateChangeEx(&self, username: &windows_core::BSTR, domain: &windows_core::BSTR, initialprogram: &windows_core::BSTR, poolname: &windows_core::BSTR, targetname: &windows_core::BSTR, connectionchangetype: CONNECTION_CHANGE_NOTIFICATION) -> Result<(), windows_result::HRESULT>;
}
...
impl ITsSbResourcePluginStore {
    pub unsafe fn QueryTarget(&self, targetname: &windows_core::BSTR, farmname: &windows_core::BSTR) -> Result<ITsSbTarget, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn QuerySessionBySessionId(&self, dwsessionid: u32, targetname: &windows_core::BSTR) -> Result<ITsSbSession, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AddTargetToStore<P0>(&self, ptarget: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ITsSbTarget>,
    {
        unsafe { (windows_core::Interface::vtable(self).AddTargetToStore)(windows_core::Interface::as_raw(self), ptarget.param().abi()).ok() }
    }
    pub unsafe fn AddSessionToStore<P0>(&self, psession: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn AddEnvironmentToStore<P0>(&self, penvironment: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ITsSbEnvironment>,
    {
    ...
    pub unsafe fn RemoveEnvironmentFromStore(&self, environmentname: &windows_core::BSTR, bignoreowner: bool) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn EnumerateFarms(&self, pdwcount: *mut u32, pval: *mut *mut super::Com::SAFEARRAY) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).EnumerateFarms)(windows_core::Interface::as_raw(self), pdwcount as _, pval as _).ok() }
    }
    pub unsafe fn QueryEnvironment(&self, environmentname: &windows_core::BSTR) -> Result<ITsSbEnvironment, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumerateEnvironments(&self, pdwcount: *mut u32, pval: *mut *mut Option<ITsSbEnvironment>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SaveTarget<P0>(&self, ptarget: P0, bforcewrite: bool) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ITsSbTarget>,
    {
    ...
    pub unsafe fn SaveEnvironment<P0>(&self, penvironment: P0, bforcewrite: bool) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ITsSbEnvironment>,
    {
    ...
    pub unsafe fn SaveSession<P0>(&self, psession: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ITsSbSession>,
    {
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn SetTargetProperty(&self, targetname: &windows_core::BSTR, propertyname: &windows_core::BSTR, pproperty: *const super::Variant::VARIANT) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn SetEnvironmentProperty(&self, environmentname: &windows_core::BSTR, propertyname: &windows_core::BSTR, pproperty: *const super::Variant::VARIANT) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetTargetState(&self, targetname: &windows_core::BSTR, newstate: TARGET_STATE) -> Result<TARGET_STATE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetSessionState<P0>(&self, sbsession: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ITsSbSession>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetSessionState)(windows_core::Interface::as_raw(self), sbsession.param().abi()).ok() }
    }
    pub unsafe fn EnumerateTargets(&self, farmname: &windows_core::BSTR, envname: &windows_core::BSTR, sortbyfieldid: TS_SB_SORT_BY, sortybypropname: &windows_core::BSTR, pdwcount: *mut u32, pval: *mut *mut Option<ITsSbTarget>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn EnumerateSessions(&self, targetname: &windows_core::BSTR, username: &windows_core::BSTR, userdomain: &windows_core::BSTR, poolname: &windows_core::BSTR, initialprogram: &windows_core::BSTR, psessionstate: *const TSSESSION_STATE, pdwcount: *mut u32, ppval: *mut *mut Option<ITsSbSession>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn DeleteTarget(&self, targetname: &windows_core::BSTR, hostname: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn SetTargetPropertyWithVersionCheck<P0>(&self, ptarget: P0, propertyname: &windows_core::BSTR, pproperty: *const super::Variant::VARIANT) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ITsSbTarget>,
    {
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn SetEnvironmentPropertyWithVersionCheck<P0>(&self, penvironment: P0, propertyname: &windows_core::BSTR, pproperty: *const super::Variant::VARIANT) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ITsSbEnvironment>,
    {
    ...
    pub unsafe fn AcquireTargetLock(&self, targetname: &windows_core::BSTR, dwtimeout: u32) -> Result<windows_core::IUnknown, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ReleaseTargetLock<P0>(&self, pcontext: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn TestAndSetServerState(&self, poolname: &windows_core::BSTR, serverfqdn: &windows_core::BSTR, newstate: TARGET_STATE, teststate: TARGET_STATE) -> Result<TARGET_STATE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetServerWaitingToStart(&self, poolname: &windows_core::BSTR, servername: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetServerState(&self, poolname: &windows_core::BSTR, serverfqdn: &windows_core::BSTR) -> Result<TARGET_STATE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetServerDrainMode(&self, serverfqdn: &windows_core::BSTR, drainmode: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait ITsSbResourcePluginStore_Impl: windows_core::IUnknownImpl {
    fn QueryTarget(&self, targetname: &windows_core::BSTR, farmname: &windows_core::BSTR) -> Result<ITsSbTarget, windows_result::HRESULT>;
    fn QuerySessionBySessionId(&self, dwsessionid: u32, targetname: &windows_core::BSTR) -> Result<ITsSbSession, windows_result::HRESULT>;
    fn AddTargetToStore(&self, ptarget: windows_core::Ref<'_, ITsSbTarget>) -> Result<(), windows_result::HRESULT>;
    fn AddSessionToStore(&self, psession: windows_core::Ref<'_, ITsSbSession>) -> Result<(), windows_result::HRESULT>;
    fn AddEnvironmentToStore(&self, penvironment: windows_core::Ref<'_, ITsSbEnvironment>) -> Result<(), windows_result::HRESULT>;
    fn RemoveEnvironmentFromStore(&self, environmentname: &windows_core::BSTR, bignoreowner: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn EnumerateFarms(&self, pdwcount: *mut u32, pval: *mut *mut super::Com::SAFEARRAY) -> Result<(), windows_result::HRESULT>;
    fn QueryEnvironment(&self, environmentname: &windows_core::BSTR) -> Result<ITsSbEnvironment, windows_result::HRESULT>;
    fn EnumerateEnvironments(&self, pdwcount: *mut u32, pval: *mut *mut Option<ITsSbEnvironment>) -> Result<(), windows_result::HRESULT>;
    fn SaveTarget(&self, ptarget: windows_core::Ref<'_, ITsSbTarget>, bforcewrite: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SaveEnvironment(&self, penvironment: windows_core::Ref<'_, ITsSbEnvironment>, bforcewrite: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SaveSession(&self, psession: windows_core::Ref<'_, ITsSbSession>) -> Result<(), windows_result::HRESULT>;
    fn SetTargetProperty(&self, targetname: &windows_core::BSTR, propertyname: &windows_core::BSTR, pproperty: *const super::Variant::VARIANT) -> Result<(), windows_result::HRESULT>;
    fn SetEnvironmentProperty(&self, environmentname: &windows_core::BSTR, propertyname: &windows_core::BSTR, pproperty: *const super::Variant::VARIANT) -> Result<(), windows_result::HRESULT>;
    fn SetTargetState(&self, targetname: &windows_core::BSTR, newstate: TARGET_STATE) -> Result<TARGET_STATE, windows_result::HRESULT>;
    fn SetSessionState(&self, sbsession: windows_core::Ref<'_, ITsSbSession>) -> Result<(), windows_result::HRESULT>;
    fn EnumerateTargets(&self, farmname: &windows_core::BSTR, envname: &windows_core::BSTR, sortbyfieldid: TS_SB_SORT_BY, sortybypropname: &windows_core::BSTR, pdwcount: *mut u32, pval: *mut *mut Option<ITsSbTarget>) -> Result<(), windows_result::HRESULT>;
    fn EnumerateSessions(&self, targetname: &windows_core::BSTR, username: &windows_core::BSTR, userdomain: &windows_core::BSTR, poolname: &windows_core::BSTR, initialprogram: &windows_core::BSTR, psessionstate: *const TSSESSION_STATE, pdwcount: *mut u32, ppval: *mut *mut Option<ITsSbSession>) -> Result<(), windows_result::HRESULT>;
    fn GetFarmProperty(&self, farmname: &windows_core::BSTR, propertyname: &windows_core::BSTR, pvarvalue: *const super::Variant::VARIANT) -> Result<(), windows_result::HRESULT>;
    fn DeleteTarget(&self, targetname: &windows_core::BSTR, hostname: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn SetTargetPropertyWithVersionCheck(&self, ptarget: windows_core::Ref<'_, ITsSbTarget>, propertyname: &windows_core::BSTR, pproperty: *const super::Variant::VARIANT) -> Result<(), windows_result::HRESULT>;
    fn SetEnvironmentPropertyWithVersionCheck(&self, penvironment: windows_core::Ref<'_, ITsSbEnvironment>, propertyname: &windows_core::BSTR, pproperty: *const super::Variant::VARIANT) -> Result<(), windows_result::HRESULT>;
    fn AcquireTargetLock(&self, targetname: &windows_core::BSTR, dwtimeout: u32) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
    fn ReleaseTargetLock(&self, pcontext: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn TestAndSetServerState(&self, poolname: &windows_core::BSTR, serverfqdn: &windows_core::BSTR, newstate: TARGET_STATE, teststate: TARGET_STATE) -> Result<TARGET_STATE, windows_result::HRESULT>;
    fn SetServerWaitingToStart(&self, poolname: &windows_core::BSTR, servername: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn GetServerState(&self, poolname: &windows_core::BSTR, serverfqdn: &windows_core::BSTR) -> Result<TARGET_STATE, windows_result::HRESULT>;
    fn SetServerDrainMode(&self, serverfqdn: &windows_core::BSTR, drainmode: u32) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl ITsSbServiceNotification {
    pub unsafe fn NotifyServiceFailure(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).NotifyServiceFailure)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn NotifyServiceSuccess(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait ITsSbServiceNotification_Impl: windows_core::IUnknownImpl {
    fn NotifyServiceFailure(&self) -> Result<(), windows_result::HRESULT>;
    fn NotifyServiceSuccess(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl ITsSbSession {
    pub unsafe fn SessionId(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetTargetName(&self, targetname: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn State(&self) -> Result<TSSESSION_STATE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).State)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetState(&self, state: TSSESSION_STATE) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetState)(windows_core::Interface::as_raw(self), state).ok() }
    }
    pub unsafe fn CreateTime(&self) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateTime)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetCreateTime(&self, time: super::super::Foundation::FILETIME) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetCreateTime)(windows_core::Interface::as_raw(self), core::mem::transmute(time)).ok() }
    }
    pub unsafe fn DisconnectTime(&self) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DisconnectTime)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetDisconnectTime(&self, time: super::super::Foundation::FILETIME) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetInitialProgram(&self, application: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn ClientDisplay(&self) -> Result<CLIENT_DISPLAY, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ClientDisplay)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetClientDisplay(&self, pclientdisplay: CLIENT_DISPLAY) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn ProtocolType(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ProtocolType)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetProtocolType(&self, val: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait ITsSbSession_Impl: windows_core::IUnknownImpl {
    fn SessionId(&self) -> Result<u32, windows_result::HRESULT>;
    fn TargetName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetTargetName(&self, targetname: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn Username(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn Domain(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn State(&self) -> Result<TSSESSION_STATE, windows_result::HRESULT>;
    fn SetState(&self, state: TSSESSION_STATE) -> Result<(), windows_result::HRESULT>;
    fn CreateTime(&self) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT>;
    fn SetCreateTime(&self, time: &super::super::Foundation::FILETIME) -> Result<(), windows_result::HRESULT>;
    fn DisconnectTime(&self) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT>;
    fn SetDisconnectTime(&self, time: &super::super::Foundation::FILETIME) -> Result<(), windows_result::HRESULT>;
    fn InitialProgram(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetInitialProgram(&self, application: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn ClientDisplay(&self) -> Result<CLIENT_DISPLAY, windows_result::HRESULT>;
    fn SetClientDisplay(&self, pclientdisplay: &CLIENT_DISPLAY) -> Result<(), windows_result::HRESULT>;
    fn ProtocolType(&self) -> Result<u32, windows_result::HRESULT>;
    fn SetProtocolType(&self, val: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl ITsSbTarget {
    ...
    pub unsafe fn SetTargetName(&self, val: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetFarmName(&self, val: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetFarmName)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(val)).ok() }
    }
    pub unsafe fn TargetFQDN(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetTargetFQDN(&self, val: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn TargetNetbios(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetTargetNetbios(&self, val: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn get_IpAddresses(&self, sockaddr: *mut TSSD_ConnectionPoint, numaddresses: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn put_IpAddresses(&self, sockaddr: &[TSSD_ConnectionPoint]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn TargetState(&self) -> Result<TARGET_STATE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TargetState)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetTargetState(&self, state: TARGET_STATE) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetTargetState)(windows_core::Interface::as_raw(self), state).ok() }
    }
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn TargetPropertySet(&self) -> Result<ITsSbTargetPropertySet, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn SetTargetPropertySet<P0>(&self, pval: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn EnvironmentName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetEnvironmentName(&self, val: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
...
pub trait ITsSbTarget_Impl: windows_core::IUnknownImpl {
    fn TargetName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetTargetName(&self, val: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn FarmName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetFarmName(&self, val: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn TargetFQDN(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetTargetFQDN(&self, val: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn TargetNetbios(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetTargetNetbios(&self, val: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn get_IpAddresses(&self, sockaddr: *mut TSSD_ConnectionPoint, numaddresses: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn put_IpAddresses(&self, sockaddr: *const TSSD_ConnectionPoint, numaddresses: u32) -> Result<(), windows_result::HRESULT>;
    fn TargetState(&self) -> Result<TARGET_STATE, windows_result::HRESULT>;
    fn SetTargetState(&self, state: TARGET_STATE) -> Result<(), windows_result::HRESULT>;
    fn TargetPropertySet(&self) -> Result<ITsSbTargetPropertySet, windows_result::HRESULT>;
    fn SetTargetPropertySet(&self, pval: windows_core::Ref<'_, ITsSbTargetPropertySet>) -> Result<(), windows_result::HRESULT>;
    fn EnvironmentName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetEnvironmentName(&self, val: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn NumSessions(&self) -> Result<u32, windows_result::HRESULT>;
    fn NumPendingConnections(&self) -> Result<u32, windows_result::HRESULT>;
    fn TargetLoad(&self) -> Result<u32, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com_StructuredStorage")]
...
impl ITsSbTaskInfo {
    pub unsafe fn TargetId(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn StartTime(&self) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).StartTime)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn EndTime(&self) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EndTime)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn Deadline(&self) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Deadline)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn Identifier(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Label(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Context(&self) -> Result<*mut super::Com::SAFEARRAY, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Context)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn Plugin(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Status(&self) -> Result<RDV_TASK_STATUS, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ITsSbTaskInfo_Impl: windows_core::IUnknownImpl {
    fn TargetId(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn StartTime(&self) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT>;
    fn EndTime(&self) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT>;
    fn Deadline(&self) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT>;
    fn Identifier(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn Label(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn Context(&self) -> Result<*mut super::Com::SAFEARRAY, windows_result::HRESULT>;
    fn Plugin(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn Status(&self) -> Result<RDV_TASK_STATUS, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl ITsSbTaskPlugin {
    pub unsafe fn InitializeTaskPlugin<P0>(&self, pitssbtaskpluginnotifysink: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetTaskQueue(&self, pszhostname: &windows_core::BSTR, pitssbtaskinfo: &[Option<ITsSbTaskInfo>]) -> Result<(), windows_result::HRESULT> {
...
pub trait ITsSbTaskPlugin_Impl: ITsSbPlugin_Impl {
    fn InitializeTaskPlugin(&self, pitssbtaskpluginnotifysink: windows_core::Ref<'_, ITsSbTaskPluginNotifySink>) -> Result<(), windows_result::HRESULT>;
    fn SetTaskQueue(&self, pszhostname: &windows_core::BSTR, sbtaskinfosize: u32, pitssbtaskinfo: *const Option<ITsSbTaskInfo>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com_StructuredStorage")]
...
impl ITsSbTaskPluginNotifySink {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn OnSetTaskTime(&self, sztargetname: &windows_core::BSTR, taskstarttime: super::super::Foundation::FILETIME, taskendtime: super::super::Foundation::FILETIME, taskdeadline: super::super::Foundation::FILETIME, sztasklabel: &windows_core::BSTR, sztaskidentifier: &windows_core::BSTR, sztaskplugin: &windows_core::BSTR, dwtaskstatus: u32, sacontext: *const super::Com::SAFEARRAY) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn OnDeleteTaskTime(&self, sztargetname: &windows_core::BSTR, sztaskidentifier: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn OnUpdateTaskStatus(&self, sztargetname: &windows_core::BSTR, taskidentifier: &windows_core::BSTR, taskstatus: RDV_TASK_STATUS) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn OnReportTasks(&self, szhostname: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
...
pub trait ITsSbTaskPluginNotifySink_Impl: ITsSbBaseNotifySink_Impl {
    fn OnSetTaskTime(&self, sztargetname: &windows_core::BSTR, taskstarttime: &super::super::Foundation::FILETIME, taskendtime: &super::super::Foundation::FILETIME, taskdeadline: &super::super::Foundation::FILETIME, sztasklabel: &windows_core::BSTR, sztaskidentifier: &windows_core::BSTR, sztaskplugin: &windows_core::BSTR, dwtaskstatus: u32, sacontext: *const super::Com::SAFEARRAY) -> Result<(), windows_result::HRESULT>;
    fn OnDeleteTaskTime(&self, sztargetname: &windows_core::BSTR, sztaskidentifier: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn OnUpdateTaskStatus(&self, sztargetname: &windows_core::BSTR, taskidentifier: &windows_core::BSTR, taskstatus: RDV_TASK_STATUS) -> Result<(), windows_result::HRESULT>;
    fn OnReportTasks(&self, szhostname: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWRdsEnhancedFastReconnectArbitrator {
    pub unsafe fn GetSessionForEnhancedFastReconnect(&self, psessionidarray: *const i32, dwsessioncount: u32) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWRdsEnhancedFastReconnectArbitrator_Impl: windows_core::IUnknownImpl {
    fn GetSessionForEnhancedFastReconnect(&self, psessionidarray: *const i32, dwsessioncount: u32) -> Result<i32, windows_result::HRESULT>;
}
...
impl IWRdsGraphicsChannel {
    pub unsafe fn Write<P2>(&self, cbsize: u32, pbuffer: *const u8, pcontext: P2) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Open<P0, P1>(&self, pchannelevents: P0, popencontext: P1) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IWRdsGraphicsChannel_Impl: windows_core::IUnknownImpl {
    fn Write(&self, cbsize: u32, pbuffer: *const u8, pcontext: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn Close(&self) -> Result<(), windows_result::HRESULT>;
    fn Open(&self, pchannelevents: windows_core::Ref<'_, IWRdsGraphicsChannelEvents>, popencontext: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
}
...
impl IWRdsGraphicsChannelEvents {
    pub unsafe fn OnDataReceived(&self, cbsize: u32, pbuffer: *const u8) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).OnDataReceived)(windows_core::Interface::as_raw(self), cbsize, pbuffer).ok() }
    }
    pub unsafe fn OnClose(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).OnClose)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn OnChannelOpened<P1>(&self, openresult: windows_core::HRESULT, popencontext: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::IUnknown>,
    {
    ...
    pub unsafe fn OnDataSent<P0>(&self, pwritecontext: P0, bcancelled: bool, pbuffer: *const u8, cbbuffer: u32) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
    ...
    pub unsafe fn OnMetricsUpdate(&self, bandwidth: u32, rtt: u32, lastsentbyteindex: u64) -> Result<(), windows_result::HRESULT> {
...
pub trait IWRdsGraphicsChannelEvents_Impl: windows_core::IUnknownImpl {
    fn OnDataReceived(&self, cbsize: u32, pbuffer: *const u8) -> Result<(), windows_result::HRESULT>;
    fn OnClose(&self) -> Result<(), windows_result::HRESULT>;
    fn OnChannelOpened(&self, openresult: windows_core::HRESULT, popencontext: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn OnDataSent(&self, pwritecontext: windows_core::Ref<'_, windows_core::IUnknown>, bcancelled: windows_core::BOOL, pbuffer: *const u8, cbbuffer: u32) -> Result<(), windows_result::HRESULT>;
    fn OnMetricsUpdate(&self, bandwidth: u32, rtt: u32, lastsentbyteindex: u64) -> Result<(), windows_result::HRESULT>;
}
...
impl IWRdsGraphicsChannelManager {
    pub unsafe fn CreateChannel(&self, pszchannelname: *const u8, channeltype: WRdsGraphicsChannelType) -> Result<IWRdsGraphicsChannel, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWRdsGraphicsChannelManager_Impl: windows_core::IUnknownImpl {
    fn CreateChannel(&self, pszchannelname: *const u8, channeltype: WRdsGraphicsChannelType) -> Result<IWRdsGraphicsChannel, windows_result::HRESULT>;
}
...
impl IWRdsProtocolConnection {
    pub unsafe fn GetLogonErrorRedirector(&self) -> Result<IWRdsProtocolLogonErrorRedirector, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AcceptConnection(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).AcceptConnection)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn GetClientData(&self, pclientdata: *mut WTS_CLIENT_DATA) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetClientData)(windows_core::Interface::as_raw(self), pclientdata as _).ok() }
    }
    pub unsafe fn GetClientMonitorData(&self, pnummonitors: *mut u32, pprimarymonitor: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetUserCredentials(&self, pusercreds: *mut WTS_USER_CREDENTIAL) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetUserCredentials)(windows_core::Interface::as_raw(self), pusercreds as _).ok() }
    }
    pub unsafe fn GetLicenseConnection(&self) -> Result<IWRdsProtocolLicenseConnection, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AuthenticateClientToSession(&self, sessionid: *mut WTS_SESSION_ID) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn NotifySessionId(&self, sessionid: *const WTS_SESSION_ID, sessionhandle: super::super::Foundation::HANDLE_PTR) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).NotifySessionId)(windows_core::Interface::as_raw(self), sessionid, sessionhandle).ok() }
    }
    pub unsafe fn GetInputHandles(&self, pkeyboardhandle: *mut super::super::Foundation::HANDLE_PTR, pmousehandle: *mut super::super::Foundation::HANDLE_PTR, pbeephandle: *mut super::super::Foundation::HANDLE_PTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetVideoHandle(&self) -> Result<super::super::Foundation::HANDLE_PTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetVideoHandle)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn ConnectNotify(&self, sessionid: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).ConnectNotify)(windows_core::Interface::as_raw(self), sessionid).ok() }
    }
    pub unsafe fn IsUserAllowedToLogon<P2, P3>(&self, sessionid: u32, usertoken: super::super::Foundation::HANDLE_PTR, pdomainname: P2, pusername: P3) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SessionArbitrationEnumeration(&self, husertoken: super::super::Foundation::HANDLE_PTR, bsinglesessionperuserenabled: bool, psessionidarray: *mut u32, pdwsessionidentifiercount: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn LogonNotify<P1, P2>(&self, hclienttoken: super::super::Foundation::HANDLE_PTR, wszusername: P1, wszdomainname: P2, sessionid: *const WTS_SESSION_ID, pwrdsconnectionsettings: *mut WRDS_CONNECTION_SETTINGS) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn QueryProperty(&self, querytype: windows_core::GUID, ppropertyentriesin: &[WTS_PROPERTY_VALUE], ppropertyentriesout: &mut [WTS_PROPERTY_VALUE]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetShadowConnection(&self) -> Result<IWRdsProtocolShadowConnection, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn NotifyCommandProcessCreated(&self, sessionid: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IWRdsProtocolConnection_Impl: windows_core::IUnknownImpl {
    fn GetLogonErrorRedirector(&self) -> Result<IWRdsProtocolLogonErrorRedirector, windows_result::HRESULT>;
    fn AcceptConnection(&self) -> Result<(), windows_result::HRESULT>;
    fn GetClientData(&self, pclientdata: *mut WTS_CLIENT_DATA) -> Result<(), windows_result::HRESULT>;
    fn GetClientMonitorData(&self, pnummonitors: *mut u32, pprimarymonitor: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetUserCredentials(&self, pusercreds: *mut WTS_USER_CREDENTIAL) -> Result<(), windows_result::HRESULT>;
    fn GetLicenseConnection(&self) -> Result<IWRdsProtocolLicenseConnection, windows_result::HRESULT>;
    fn AuthenticateClientToSession(&self, sessionid: *mut WTS_SESSION_ID) -> Result<(), windows_result::HRESULT>;
    fn NotifySessionId(&self, sessionid: *const WTS_SESSION_ID, sessionhandle: super::super::Foundation::HANDLE_PTR) -> Result<(), windows_result::HRESULT>;
    fn GetInputHandles(&self, pkeyboardhandle: *mut super::super::Foundation::HANDLE_PTR, pmousehandle: *mut super::super::Foundation::HANDLE_PTR, pbeephandle: *mut super::super::Foundation::HANDLE_PTR) -> Result<(), windows_result::HRESULT>;
    fn GetVideoHandle(&self) -> Result<super::super::Foundation::HANDLE_PTR, windows_result::HRESULT>;
    fn ConnectNotify(&self, sessionid: u32) -> Result<(), windows_result::HRESULT>;
    fn IsUserAllowedToLogon(&self, sessionid: u32, usertoken: super::super::Foundation::HANDLE_PTR, pdomainname: &windows_core::PCWSTR, pusername: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn SessionArbitrationEnumeration(&self, husertoken: super::super::Foundation::HANDLE_PTR, bsinglesessionperuserenabled: windows_core::BOOL, psessionidarray: *mut u32, pdwsessionidentifiercount: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn LogonNotify(&self, hclienttoken: super::super::Foundation::HANDLE_PTR, wszusername: &windows_core::PCWSTR, wszdomainname: &windows_core::PCWSTR, sessionid: *const WTS_SESSION_ID, pwrdsconnectionsettings: *mut WRDS_CONNECTION_SETTINGS) -> Result<(), windows_result::HRESULT>;
    fn PreDisconnect(&self, disconnectreason: u32) -> Result<(), windows_result::HRESULT>;
    fn DisconnectNotify(&self) -> Result<(), windows_result::HRESULT>;
    fn Close(&self) -> Result<(), windows_result::HRESULT>;
    fn GetProtocolStatus(&self, pprotocolstatus: *mut WTS_PROTOCOL_STATUS) -> Result<(), windows_result::HRESULT>;
    fn GetLastInputTime(&self) -> Result<u64, windows_result::HRESULT>;
    fn SetErrorInfo(&self, ulerror: u32) -> Result<(), windows_result::HRESULT>;
    fn CreateVirtualChannel(&self, szendpointname: &windows_core::PCSTR, bstatic: windows_core::BOOL, requestedpriority: u32) -> Result<usize, windows_result::HRESULT>;
    fn QueryProperty(&self, querytype: &windows_core::GUID, ulnumentriesin: u32, ulnumentriesout: u32, ppropertyentriesin: *const WTS_PROPERTY_VALUE, ppropertyentriesout: *mut WTS_PROPERTY_VALUE) -> Result<(), windows_result::HRESULT>;
    fn GetShadowConnection(&self) -> Result<IWRdsProtocolShadowConnection, windows_result::HRESULT>;
    fn NotifyCommandProcessCreated(&self, sessionid: u32) -> Result<(), windows_result::HRESULT>;
}
...
pub trait IWRdsProtocolConnectionCallback_Impl: windows_core::IUnknownImpl {
    fn OnReady(&self) -> Result<(), windows_result::HRESULT>;
    fn BrokenConnection(&self, reason: u32, source: u32) -> Result<(), windows_result::HRESULT>;
    fn StopScreenUpdates(&self) -> Result<(), windows_result::HRESULT>;
    fn RedrawWindow(&self, rect: *const WTS_SMALL_RECT) -> Result<(), windows_result::HRESULT>;
    fn GetConnectionId(&self) -> Result<u32, windows_result::HRESULT>;
}
...
impl IWRdsProtocolConnectionSettings {
    pub unsafe fn SetConnectionSetting(&self, propertyid: windows_core::GUID, ppropertyentriesin: *const WTS_PROPERTY_VALUE) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetConnectionSetting(&self, propertyid: windows_core::GUID, ppropertyentriesout: *mut WTS_PROPERTY_VALUE) -> Result<(), windows_result::HRESULT> {
...
pub trait IWRdsProtocolConnectionSettings_Impl: windows_core::IUnknownImpl {
    fn SetConnectionSetting(&self, propertyid: &windows_core::GUID, ppropertyentriesin: *const WTS_PROPERTY_VALUE) -> Result<(), windows_result::HRESULT>;
    fn GetConnectionSetting(&self, propertyid: &windows_core::GUID, ppropertyentriesout: *mut WTS_PROPERTY_VALUE) -> Result<(), windows_result::HRESULT>;
}
...
impl IWRdsProtocolLicenseConnection {
    pub unsafe fn RequestLicensingCapabilities(&self, pplicensecapabilities: *mut WTS_LICENSE_CAPABILITIES, pcblicensecapabilities: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SendClientLicense(&self, pclientlicense: &[u8]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn RequestClientLicense(&self, reserve1: &[u8], ppclientlicense: *mut u8, pcbclientlicense: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn ProtocolComplete(&self, ulcomplete: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IWRdsProtocolLicenseConnection_Impl: windows_core::IUnknownImpl {
    fn RequestLicensingCapabilities(&self, pplicensecapabilities: *mut WTS_LICENSE_CAPABILITIES, pcblicensecapabilities: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn SendClientLicense(&self, pclientlicense: *const u8, cbclientlicense: u32) -> Result<(), windows_result::HRESULT>;
    fn RequestClientLicense(&self, reserve1: *const u8, reserve2: u32, ppclientlicense: *mut u8, pcbclientlicense: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn ProtocolComplete(&self, ulcomplete: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IWRdsProtocolListener {
    pub unsafe fn GetSettings(&self, wrdslistenersettinglevel: WRDS_LISTENER_SETTING_LEVEL) -> Result<WRDS_LISTENER_SETTINGS, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn StartListen<P0>(&self, pcallback: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn StopListen(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IWRdsProtocolListener_Impl: windows_core::IUnknownImpl {
    fn GetSettings(&self, wrdslistenersettinglevel: WRDS_LISTENER_SETTING_LEVEL) -> Result<WRDS_LISTENER_SETTINGS, windows_result::HRESULT>;
    fn StartListen(&self, pcallback: windows_core::Ref<'_, IWRdsProtocolListenerCallback>) -> Result<(), windows_result::HRESULT>;
    fn StopListen(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IWRdsProtocolListenerCallback {
    pub unsafe fn OnConnected<P0>(&self, pconnection: P0, pwrdsconnectionsettings: *const WRDS_CONNECTION_SETTINGS) -> Result<IWRdsProtocolConnectionCallback, windows_result::HRESULT>
    where
...
pub trait IWRdsProtocolListenerCallback_Impl: windows_core::IUnknownImpl {
    fn OnConnected(&self, pconnection: windows_core::Ref<'_, IWRdsProtocolConnection>, pwrdsconnectionsettings: *const WRDS_CONNECTION_SETTINGS) -> Result<IWRdsProtocolConnectionCallback, windows_result::HRESULT>;
}
...
impl IWRdsProtocolLogonErrorRedirector {
    pub unsafe fn OnBeginPainting(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).OnBeginPainting)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn RedirectStatus<P0>(&self, pszmessage: P0) -> Result<WTS_LOGON_ERROR_REDIRECTOR_RESPONSE, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn RedirectMessage<P0, P1>(&self, pszcaption: P0, pszmessage: P1, utype: u32) -> Result<WTS_LOGON_ERROR_REDIRECTOR_RESPONSE, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn RedirectLogonError<P2, P3>(&self, ntsstatus: i32, ntssubstatus: i32, pszcaption: P2, pszmessage: P3, utype: u32) -> Result<WTS_LOGON_ERROR_REDIRECTOR_RESPONSE, windows_result::HRESULT>
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IWRdsProtocolLogonErrorRedirector_Impl: windows_core::IUnknownImpl {
    fn OnBeginPainting(&self) -> Result<(), windows_result::HRESULT>;
    fn RedirectStatus(&self, pszmessage: &windows_core::PCWSTR) -> Result<WTS_LOGON_ERROR_REDIRECTOR_RESPONSE, windows_result::HRESULT>;
    fn RedirectMessage(&self, pszcaption: &windows_core::PCWSTR, pszmessage: &windows_core::PCWSTR, utype: u32) -> Result<WTS_LOGON_ERROR_REDIRECTOR_RESPONSE, windows_result::HRESULT>;
    fn RedirectLogonError(&self, ntsstatus: i32, ntssubstatus: i32, pszcaption: &windows_core::PCWSTR, pszmessage: &windows_core::PCWSTR, utype: u32) -> Result<WTS_LOGON_ERROR_REDIRECTOR_RESPONSE, windows_result::HRESULT>;
}
...
impl IWRdsProtocolManager {
    pub unsafe fn Initialize<P0>(&self, piwrdssettings: P0, pwrdssettings: *const WRDS_SETTINGS) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn CreateListener<P0>(&self, wszlistenername: P0) -> Result<IWRdsProtocolListener, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn NotifyServiceStateChange(&self, ptsservicestatechange: *const WTS_SERVICE_STATE) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn NotifySessionOfServiceStart(&self, sessionid: *const WTS_SESSION_ID) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).NotifySessionOfServiceStart)(windows_core::Interface::as_raw(self), sessionid).ok() }
    }
    pub unsafe fn NotifySessionOfServiceStop(&self, sessionid: *const WTS_SESSION_ID) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).NotifySessionOfServiceStop)(windows_core::Interface::as_raw(self), sessionid).ok() }
    }
    pub unsafe fn NotifySessionStateChange(&self, sessionid: *const WTS_SESSION_ID, eventid: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn NotifySettingsChange(&self, pwrdssettings: *const WRDS_SETTINGS) -> Result<(), windows_result::HRESULT> {
...
pub trait IWRdsProtocolManager_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, piwrdssettings: windows_core::Ref<'_, IWRdsProtocolSettings>, pwrdssettings: *const WRDS_SETTINGS) -> Result<(), windows_result::HRESULT>;
    fn CreateListener(&self, wszlistenername: &windows_core::PCWSTR) -> Result<IWRdsProtocolListener, windows_result::HRESULT>;
    fn NotifyServiceStateChange(&self, ptsservicestatechange: *const WTS_SERVICE_STATE) -> Result<(), windows_result::HRESULT>;
    fn NotifySessionOfServiceStart(&self, sessionid: *const WTS_SESSION_ID) -> Result<(), windows_result::HRESULT>;
    fn NotifySessionOfServiceStop(&self, sessionid: *const WTS_SESSION_ID) -> Result<(), windows_result::HRESULT>;
    fn NotifySessionStateChange(&self, sessionid: *const WTS_SESSION_ID, eventid: u32) -> Result<(), windows_result::HRESULT>;
    fn NotifySettingsChange(&self, pwrdssettings: *const WRDS_SETTINGS) -> Result<(), windows_result::HRESULT>;
...
impl IWRdsProtocolSettings {
    pub unsafe fn GetSettings(&self, wrdssettingtype: WRDS_SETTING_TYPE, wrdssettinglevel: WRDS_SETTING_LEVEL, pwrdssettings: *mut WRDS_SETTINGS) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn MergeSettings(&self, pwrdssettings: *const WRDS_SETTINGS, wrdsconnectionsettinglevel: WRDS_CONNECTION_SETTING_LEVEL, pwrdsconnectionsettings: *mut WRDS_CONNECTION_SETTINGS) -> Result<(), windows_result::HRESULT> {
...
pub trait IWRdsProtocolSettings_Impl: windows_core::IUnknownImpl {
    fn GetSettings(&self, wrdssettingtype: WRDS_SETTING_TYPE, wrdssettinglevel: WRDS_SETTING_LEVEL, pwrdssettings: *mut WRDS_SETTINGS) -> Result<(), windows_result::HRESULT>;
    fn MergeSettings(&self, pwrdssettings: *const WRDS_SETTINGS, wrdsconnectionsettinglevel: WRDS_CONNECTION_SETTING_LEVEL, pwrdsconnectionsettings: *mut WRDS_CONNECTION_SETTINGS) -> Result<(), windows_result::HRESULT>;
}
...
impl IWRdsProtocolShadowCallback {
    pub unsafe fn StopShadow(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).StopShadow)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn InvokeTargetShadow<P0, P10>(&self, ptargetservername: P0, targetsessionid: u32, pparam1: &[u8], pparam2: &[u8], pparam3: &[u8], pparam4: &[u8], pclientname: P10) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IWRdsProtocolShadowCallback_Impl: windows_core::IUnknownImpl {
    fn StopShadow(&self) -> Result<(), windows_result::HRESULT>;
    fn InvokeTargetShadow(&self, ptargetservername: &windows_core::PCWSTR, targetsessionid: u32, pparam1: *const u8, param1size: u32, pparam2: *const u8, param2size: u32, pparam3: *const u8, param3size: u32, pparam4: *const u8, param4size: u32, pclientname: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
...
impl IWRdsProtocolShadowConnection {
    pub unsafe fn Start<P0, P4>(&self, ptargetservername: P0, targetsessionid: u32, hotkeyvk: u8, hotkeymodifiers: u16, pshadowcallback: P4) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn DoTarget<P8>(&self, pparam1: &[u8], pparam2: &[u8], pparam3: &[u8], pparam4: &[u8], pclientname: P8) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IWRdsProtocolShadowConnection_Impl: windows_core::IUnknownImpl {
    fn Start(&self, ptargetservername: &windows_core::PCWSTR, targetsessionid: u32, hotkeyvk: u8, hotkeymodifiers: u16, pshadowcallback: windows_core::Ref<'_, IWRdsProtocolShadowCallback>) -> Result<(), windows_result::HRESULT>;
    fn Stop(&self) -> Result<(), windows_result::HRESULT>;
    fn DoTarget(&self, pparam1: *const u8, param1size: u32, pparam2: *const u8, param2size: u32, pparam3: *const u8, param3size: u32, pparam4: *const u8, param4size: u32, pclientname: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
...
impl IWRdsWddmIddProps {
    pub unsafe fn GetHardwareId(&self, pdisplaydriverhardwareid: &[u16]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn OnDriverLoad(&self, sessionid: u32, driverhandle: super::super::Foundation::HANDLE_PTR) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).OnDriverLoad)(windows_core::Interface::as_raw(self), sessionid, driverhandle).ok() }
    }
    pub unsafe fn OnDriverUnload(&self, sessionid: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).OnDriverUnload)(windows_core::Interface::as_raw(self), sessionid).ok() }
    }
    pub unsafe fn EnableWddmIdd(&self, enabled: bool) -> Result<(), windows_result::HRESULT> {
...
pub trait IWRdsWddmIddProps_Impl: windows_core::IUnknownImpl {
    fn GetHardwareId(&self, pdisplaydriverhardwareid: &windows_core::PCWSTR, count: u32) -> Result<(), windows_result::HRESULT>;
    fn OnDriverLoad(&self, sessionid: u32, driverhandle: super::super::Foundation::HANDLE_PTR) -> Result<(), windows_result::HRESULT>;
    fn OnDriverUnload(&self, sessionid: u32) -> Result<(), windows_result::HRESULT>;
    fn EnableWddmIdd(&self, enabled: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
}
...
impl IWRdsWddmIddProps1 {
    ...
    pub unsafe fn OnDriverLoad<P1>(&self, sessionid: u32, deviceinstance: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IWRdsWddmIddProps1_Impl: windows_core::IUnknownImpl {
    fn GetHardwareId(&self, pdisplaydriverhardwareid: &windows_core::PCWSTR, count: u32) -> Result<(), windows_result::HRESULT>;
    fn OnDriverLoad(&self, sessionid: u32, deviceinstance: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn OnDriverUnload(&self, sessionid: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IWTSBitmapRenderService {
    pub unsafe fn GetMappedRenderer<P1>(&self, mappingid: u64, pmappedrenderercallback: P1) -> Result<IWTSBitmapRenderer, windows_result::HRESULT>
    where
...
pub trait IWTSBitmapRenderService_Impl: windows_core::IUnknownImpl {
    fn GetMappedRenderer(&self, mappingid: u64, pmappedrenderercallback: windows_core::Ref<'_, IWTSBitmapRendererCallback>) -> Result<IWTSBitmapRenderer, windows_result::HRESULT>;
}
...
impl IWTSBitmapRenderer {
    pub unsafe fn Render(&self, imageformat: windows_core::GUID, dwwidth: u32, dwheight: u32, cbstride: i32, pimagebuffer: &[u8]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetRendererStatistics(&self) -> Result<BITMAP_RENDERER_STATISTICS, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRendererStatistics)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn RemoveMapping(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IWTSBitmapRenderer_Impl: windows_core::IUnknownImpl {
    fn Render(&self, imageformat: &windows_core::GUID, dwwidth: u32, dwheight: u32, cbstride: i32, cbimagebuffer: u32, pimagebuffer: *const u8) -> Result<(), windows_result::HRESULT>;
    fn GetRendererStatistics(&self) -> Result<BITMAP_RENDERER_STATISTICS, windows_result::HRESULT>;
    fn RemoveMapping(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IWTSBitmapRendererCallback {
    pub unsafe fn OnTargetSizeChanged(&self, rcnewsize: super::super::Foundation::RECT) -> Result<(), windows_result::HRESULT> {
...
pub trait IWTSBitmapRendererCallback_Impl: windows_core::IUnknownImpl {
    fn OnTargetSizeChanged(&self, rcnewsize: &super::super::Foundation::RECT) -> Result<(), windows_result::HRESULT>;
}
...
impl IWTSListener {
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn GetConfiguration(&self) -> Result<super::Com::StructuredStorage::IPropertyBag, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWTSListener_Impl: windows_core::IUnknownImpl {
    fn GetConfiguration(&self) -> Result<super::Com::StructuredStorage::IPropertyBag, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com_StructuredStorage")]
...
impl IWTSListenerCallback {
    pub unsafe fn OnNewChannelConnection<P0>(&self, pchannel: P0, data: &windows_core::BSTR, pbaccept: *mut windows_core::BOOL, ppcallback: *mut Option<IWTSVirtualChannelCallback>) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IWTSListenerCallback_Impl: windows_core::IUnknownImpl {
    fn OnNewChannelConnection(&self, pchannel: windows_core::Ref<'_, IWTSVirtualChannel>, data: &windows_core::BSTR, pbaccept: *mut windows_core::BOOL, ppcallback: windows_core::OutRef<'_, IWTSVirtualChannelCallback>) -> Result<(), windows_result::HRESULT>;
}
...
impl IWTSPlugin {
    pub unsafe fn Initialize<P0>(&self, pchannelmgr: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Connected(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Connected)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Disconnected(&self, dwdisconnectcode: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Disconnected)(windows_core::Interface::as_raw(self), dwdisconnectcode).ok() }
    }
    pub unsafe fn Terminated(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IWTSPlugin_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, pchannelmgr: windows_core::Ref<'_, IWTSVirtualChannelManager>) -> Result<(), windows_result::HRESULT>;
    fn Connected(&self) -> Result<(), windows_result::HRESULT>;
    fn Disconnected(&self, dwdisconnectcode: u32) -> Result<(), windows_result::HRESULT>;
    fn Terminated(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IWTSPluginServiceProvider {
    pub unsafe fn GetService(&self, serviceid: windows_core::GUID) -> Result<windows_core::IUnknown, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWTSPluginServiceProvider_Impl: windows_core::IUnknownImpl {
    fn GetService(&self, serviceid: &windows_core::GUID) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
}
...
impl IWTSProtocolConnection {
    pub unsafe fn GetLogonErrorRedirector(&self) -> Result<IWTSProtocolLogonErrorRedirector, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLogonErrorRedirector)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn SendPolicyData(&self, ppolicydata: *const WTS_POLICY_DATA) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetLicenseConnection(&self) -> Result<IWTSProtocolLicenseConnection, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLicenseConnection)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn NotifySessionId(&self, sessionid: *const WTS_SESSION_ID) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).NotifySessionId)(windows_core::Interface::as_raw(self), sessionid).ok() }
    }
    pub unsafe fn GetProtocolHandles(&self, pkeyboardhandle: *mut super::super::Foundation::HANDLE_PTR, pmousehandle: *mut super::super::Foundation::HANDLE_PTR, pbeephandle: *mut super::super::Foundation::HANDLE_PTR, pvideohandle: *mut super::super::Foundation::HANDLE_PTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn LogonNotify<P1, P2>(&self, hclienttoken: super::super::Foundation::HANDLE_PTR, wszusername: P1, wszdomainname: P2, sessionid: *const WTS_SESSION_ID) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetUserData(&self, ppolicydata: *const WTS_POLICY_DATA, pclientdata: *mut WTS_USER_DATA) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SendBeep(&self, frequency: u32, duration: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetShadowConnection(&self) -> Result<IWTSProtocolShadowConnection, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetShadowConnection)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IWTSProtocolConnection_Impl: windows_core::IUnknownImpl {
    fn GetLogonErrorRedirector(&self) -> Result<IWTSProtocolLogonErrorRedirector, windows_result::HRESULT>;
    fn SendPolicyData(&self, ppolicydata: *const WTS_POLICY_DATA) -> Result<(), windows_result::HRESULT>;
    fn AcceptConnection(&self) -> Result<(), windows_result::HRESULT>;
    fn GetClientData(&self, pclientdata: *mut WTS_CLIENT_DATA) -> Result<(), windows_result::HRESULT>;
    fn GetUserCredentials(&self, pusercreds: *mut WTS_USER_CREDENTIAL) -> Result<(), windows_result::HRESULT>;
    fn GetLicenseConnection(&self) -> Result<IWTSProtocolLicenseConnection, windows_result::HRESULT>;
    fn AuthenticateClientToSession(&self, sessionid: *mut WTS_SESSION_ID) -> Result<(), windows_result::HRESULT>;
    fn NotifySessionId(&self, sessionid: *const WTS_SESSION_ID) -> Result<(), windows_result::HRESULT>;
    fn GetProtocolHandles(&self, pkeyboardhandle: *mut super::super::Foundation::HANDLE_PTR, pmousehandle: *mut super::super::Foundation::HANDLE_PTR, pbeephandle: *mut super::super::Foundation::HANDLE_PTR, pvideohandle: *mut super::super::Foundation::HANDLE_PTR) -> Result<(), windows_result::HRESULT>;
    fn ConnectNotify(&self, sessionid: u32) -> Result<(), windows_result::HRESULT>;
    fn IsUserAllowedToLogon(&self, sessionid: u32, usertoken: super::super::Foundation::HANDLE_PTR, pdomainname: &windows_core::PCWSTR, pusername: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn SessionArbitrationEnumeration(&self, husertoken: super::super::Foundation::HANDLE_PTR, bsinglesessionperuserenabled: windows_core::BOOL, psessionidarray: *mut u32, pdwsessionidentifiercount: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn LogonNotify(&self, hclienttoken: super::super::Foundation::HANDLE_PTR, wszusername: &windows_core::PCWSTR, wszdomainname: &windows_core::PCWSTR, sessionid: *const WTS_SESSION_ID) -> Result<(), windows_result::HRESULT>;
    fn GetUserData(&self, ppolicydata: *const WTS_POLICY_DATA, pclientdata: *mut WTS_USER_DATA) -> Result<(), windows_result::HRESULT>;
    fn DisconnectNotify(&self) -> Result<(), windows_result::HRESULT>;
    fn Close(&self) -> Result<(), windows_result::HRESULT>;
    fn GetProtocolStatus(&self, pprotocolstatus: *mut WTS_PROTOCOL_STATUS) -> Result<(), windows_result::HRESULT>;
    fn GetLastInputTime(&self) -> Result<u64, windows_result::HRESULT>;
    fn SetErrorInfo(&self, ulerror: u32) -> Result<(), windows_result::HRESULT>;
    fn SendBeep(&self, frequency: u32, duration: u32) -> Result<(), windows_result::HRESULT>;
    fn CreateVirtualChannel(&self, szendpointname: &windows_core::PCSTR, bstatic: windows_core::BOOL, requestedpriority: u32) -> Result<usize, windows_result::HRESULT>;
    fn QueryProperty(&self, querytype: &windows_core::GUID, ulnumentriesin: u32, ulnumentriesout: u32, ppropertyentriesin: *const WTS_PROPERTY_VALUE, ppropertyentriesout: *mut WTS_PROPERTY_VALUE) -> Result<(), windows_result::HRESULT>;
    fn GetShadowConnection(&self) -> Result<IWTSProtocolShadowConnection, windows_result::HRESULT>;
}
...
impl IWTSProtocolConnectionCallback {
    ...
    pub unsafe fn DisplayIOCtl(&self, displayioctl: *const WTS_DISPLAY_IOCTL) -> Result<(), windows_result::HRESULT> {
...
pub trait IWTSProtocolConnectionCallback_Impl: windows_core::IUnknownImpl {
    ...
    fn StopScreenUpdates(&self) -> Result<(), windows_result::HRESULT>;
    fn RedrawWindow(&self, rect: *const WTS_SMALL_RECT) -> Result<(), windows_result::HRESULT>;
    fn DisplayIOCtl(&self, displayioctl: *const WTS_DISPLAY_IOCTL) -> Result<(), windows_result::HRESULT>;
}
...
pub trait IWTSProtocolListener_Impl: windows_core::IUnknownImpl {
    fn StartListen(&self, pcallback: windows_core::Ref<'_, IWTSProtocolListenerCallback>) -> Result<(), windows_result::HRESULT>;
    fn StopListen(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IWTSProtocolListenerCallback {
    pub unsafe fn OnConnected<P0>(&self, pconnection: P0) -> Result<IWTSProtocolConnectionCallback, windows_result::HRESULT>
    where
...
pub trait IWTSProtocolListenerCallback_Impl: windows_core::IUnknownImpl {
    fn OnConnected(&self, pconnection: windows_core::Ref<'_, IWTSProtocolConnection>) -> Result<IWTSProtocolConnectionCallback, windows_result::HRESULT>;
}
...
impl IWTSProtocolManager {
    pub unsafe fn CreateListener<P0>(&self, wszlistenername: P0) -> Result<IWTSProtocolListener, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
...
pub trait IWTSProtocolManager_Impl: windows_core::IUnknownImpl {
    fn CreateListener(&self, wszlistenername: &windows_core::PCWSTR) -> Result<IWTSProtocolListener, windows_result::HRESULT>;
    fn NotifyServiceStateChange(&self, ptsservicestatechange: *const WTS_SERVICE_STATE) -> Result<(), windows_result::HRESULT>;
    fn NotifySessionOfServiceStart(&self, sessionid: *const WTS_SESSION_ID) -> Result<(), windows_result::HRESULT>;
    fn NotifySessionOfServiceStop(&self, sessionid: *const WTS_SESSION_ID) -> Result<(), windows_result::HRESULT>;
    fn NotifySessionStateChange(&self, sessionid: *const WTS_SESSION_ID, eventid: u32) -> Result<(), windows_result::HRESULT>;
...
pub trait IWTSProtocolShadowConnection_Impl: windows_core::IUnknownImpl {
    fn Start(&self, ptargetservername: &windows_core::PCWSTR, targetsessionid: u32, hotkeyvk: u8, hotkeymodifiers: u16, pshadowcallback: windows_core::Ref<'_, IWTSProtocolShadowCallback>) -> Result<(), windows_result::HRESULT>;
    fn Stop(&self) -> Result<(), windows_result::HRESULT>;
    fn DoTarget(&self, pparam1: *const u8, param1size: u32, pparam2: *const u8, param2size: u32, pparam3: *const u8, param3size: u32, pparam4: *const u8, param4size: u32, pclientname: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
...
impl IWTSSBPlugin {
    pub unsafe fn Initialize(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Initialize)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn WTSSBX_MachineChangeNotification(&self, notificationtype: WTSSBX_NOTIFICATION_TYPE, machineid: i32, pmachineinfo: *const WTSSBX_MACHINE_INFO) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn WTSSBX_SessionChangeNotification(&self, notificationtype: WTSSBX_NOTIFICATION_TYPE, machineid: i32, sessioninfo: &[WTSSBX_SESSION_INFO]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn WTSSBX_GetMostSuitableServer<P0, P1, P2, P3>(&self, username: P0, domainname: P1, applicationtype: P2, farmname: P3, pmachineid: *mut i32) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn WTSSBX_GetUserExternalSession<P0, P1, P2>(&self, username: P0, domainname: P1, applicationtype: P2, redirectorinternalip: *const WTSSBX_IP_ADDRESS, psessionid: *mut u32, pmachineconnectinfo: *mut WTSSBX_MACHINE_CONNECT_INFO) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IWTSSBPlugin_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self) -> Result<u32, windows_result::HRESULT>;
    fn WTSSBX_MachineChangeNotification(&self, notificationtype: WTSSBX_NOTIFICATION_TYPE, machineid: i32, pmachineinfo: *const WTSSBX_MACHINE_INFO) -> Result<(), windows_result::HRESULT>;
    fn WTSSBX_SessionChangeNotification(&self, notificationtype: WTSSBX_NOTIFICATION_TYPE, machineid: i32, numofsessions: u32, sessioninfo: *const WTSSBX_SESSION_INFO) -> Result<(), windows_result::HRESULT>;
    fn WTSSBX_GetMostSuitableServer(&self, username: &windows_core::PCWSTR, domainname: &windows_core::PCWSTR, applicationtype: &windows_core::PCWSTR, farmname: &windows_core::PCWSTR, pmachineid: *mut i32) -> Result<(), windows_result::HRESULT>;
    fn Terminated(&self) -> Result<(), windows_result::HRESULT>;
    fn WTSSBX_GetUserExternalSession(&self, username: &windows_core::PCWSTR, domainname: &windows_core::PCWSTR, applicationtype: &windows_core::PCWSTR, redirectorinternalip: *const WTSSBX_IP_ADDRESS, psessionid: *mut u32, pmachineconnectinfo: *mut WTSSBX_MACHINE_CONNECT_INFO) -> Result<(), windows_result::HRESULT>;
}
...
impl IWTSVirtualChannel {
    pub unsafe fn Write<P2>(&self, pbuffer: &[u8], preserved: P2) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<windows_core::IUnknown>,
    {
...
pub trait IWTSVirtualChannel_Impl: windows_core::IUnknownImpl {
    fn Write(&self, cbsize: u32, pbuffer: *const u8, preserved: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn Close(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IWTSVirtualChannelCallback {
    pub unsafe fn OnDataReceived(&self, pbuffer: &[u8]) -> Result<(), windows_result::HRESULT> {
...
impl IWTSVirtualChannelManager {
    pub unsafe fn CreateListener<P0, P2>(&self, pszchannelname: P0, uflags: u32, plistenercallback: P2) -> Result<IWTSListener, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCSTR>,
...
pub trait IWTSVirtualChannelManager_Impl: windows_core::IUnknownImpl {
    fn CreateListener(&self, pszchannelname: &windows_core::PCSTR, uflags: u32, plistenercallback: windows_core::Ref<'_, IWTSListenerCallback>) -> Result<IWTSListener, windows_result::HRESULT>;
}
...
impl IWorkspace {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetWorkspaceNames(&self) -> Result<*mut super::Com::SAFEARRAY, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn StartRemoteApplication(&self, bstrworkspaceid: &windows_core::BSTR, psaparams: *const super::Com::SAFEARRAY) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetProcessId(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWorkspace_Impl: windows_core::IUnknownImpl {
    fn GetWorkspaceNames(&self) -> Result<*mut super::Com::SAFEARRAY, windows_result::HRESULT>;
    fn StartRemoteApplication(&self, bstrworkspaceid: &windows_core::BSTR, psaparams: *const super::Com::SAFEARRAY) -> Result<(), windows_result::HRESULT>;
    fn GetProcessId(&self) -> Result<u32, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWorkspace3 {
    pub unsafe fn GetClaimsToken2(&self, bstrclaimshint: &windows_core::BSTR, bstruserhint: &windows_core::BSTR, claimcookie: u32, hwndcreduiparent: u32, rectcreduiparent: super::super::Foundation::RECT) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetClaimsToken(&self, bstraccesstoken: &windows_core::BSTR, ullaccesstokenexpiration: u64, bstrrefreshtoken: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
...
pub trait IWorkspace3_Impl: IWorkspace2_Impl {
    fn GetClaimsToken2(&self, bstrclaimshint: &windows_core::BSTR, bstruserhint: &windows_core::BSTR, claimcookie: u32, hwndcreduiparent: u32, rectcreduiparent: &super::super::Foundation::RECT) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetClaimsToken(&self, bstraccesstoken: &windows_core::BSTR, ullaccesstokenexpiration: u64, bstrrefreshtoken: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWorkspaceClientExt {
    pub unsafe fn GetResourceId(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetResourceDisplayName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn IssueDisconnect(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IWorkspaceClientExt_Impl: windows_core::IUnknownImpl {
    fn GetResourceId(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn GetResourceDisplayName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn IssueDisconnect(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IWorkspaceRegistration {
    pub unsafe fn AddResource<P0>(&self, punk: P0) -> Result<u32, windows_result::HRESULT>
    where
    ...
    pub unsafe fn RemoveResource(&self, dwcookieconnection: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IWorkspaceRegistration_Impl: windows_core::IUnknownImpl {
    fn AddResource(&self, punk: windows_core::Ref<'_, IWorkspaceClientExt>) -> Result<u32, windows_result::HRESULT>;
    fn RemoveResource(&self, dwcookieconnection: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IWorkspaceRegistration2 {
    pub unsafe fn AddResourceEx<P0>(&self, punk: P0, bstreventloguploadaddress: &windows_core::BSTR, pdwcookie: *mut u32, correlationid: windows_core::GUID) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IWorkspaceClientExt>,
    {
    ...
    pub unsafe fn RemoveResourceEx(&self, dwcookieconnection: u32, correlationid: windows_core::GUID) -> Result<(), windows_result::HRESULT> {
...
pub trait IWorkspaceRegistration2_Impl: IWorkspaceRegistration_Impl {
    fn AddResourceEx(&self, punk: windows_core::Ref<'_, IWorkspaceClientExt>, bstreventloguploadaddress: &windows_core::BSTR, pdwcookie: *mut u32, correlationid: &windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn RemoveResourceEx(&self, dwcookieconnection: u32, correlationid: &windows_core::GUID) -> Result<(), windows_result::HRESULT>;
}
...
impl IWorkspaceReportMessage {
    pub unsafe fn RegisterErrorLogMessage(&self, bstrmessage: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn IsErrorMessageRegistered(&self, bstrwkspid: &windows_core::BSTR, dwerrortype: u32, bstrerrormessagetype: &windows_core::BSTR, dwerrorcode: u32) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RegisterErrorEvent(&self, bstrwkspid: &windows_core::BSTR, dwerrortype: u32, bstrerrormessagetype: &windows_core::BSTR, dwerrorcode: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IWorkspaceReportMessage_Impl: windows_core::IUnknownImpl {
    fn RegisterErrorLogMessage(&self, bstrmessage: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn IsErrorMessageRegistered(&self, bstrwkspid: &windows_core::BSTR, dwerrortype: u32, bstrerrormessagetype: &windows_core::BSTR, dwerrorcode: u32) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT>;
    fn RegisterErrorEvent(&self, bstrwkspid: &windows_core::BSTR, dwerrortype: u32, bstrerrormessagetype: &windows_core::BSTR, dwerrorcode: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IWorkspaceResTypeRegistry {
    pub unsafe fn AddResourceType(&self, fmachinewide: super::super::Foundation::VARIANT_BOOL, bstrfileextension: &windows_core::BSTR, bstrlauncher: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn DeleteResourceType(&self, fmachinewide: super::super::Foundation::VARIANT_BOOL, bstrfileextension: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetRegisteredFileExtensions(&self, fmachinewide: super::super::Foundation::VARIANT_BOOL) -> Result<*mut super::Com::SAFEARRAY, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetResourceTypeInfo(&self, fmachinewide: super::super::Foundation::VARIANT_BOOL, bstrfileextension: &windows_core::BSTR) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ModifyResourceType(&self, fmachinewide: super::super::Foundation::VARIANT_BOOL, bstrfileextension: &windows_core::BSTR, bstrlauncher: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
...
pub trait IWorkspaceResTypeRegistry_Impl: super::Com::IDispatch_Impl {
    fn AddResourceType(&self, fmachinewide: super::super::Foundation::VARIANT_BOOL, bstrfileextension: &windows_core::BSTR, bstrlauncher: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn DeleteResourceType(&self, fmachinewide: super::super::Foundation::VARIANT_BOOL, bstrfileextension: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn GetRegisteredFileExtensions(&self, fmachinewide: super::super::Foundation::VARIANT_BOOL) -> Result<*mut super::Com::SAFEARRAY, windows_result::HRESULT>;
    fn GetResourceTypeInfo(&self, fmachinewide: super::super::Foundation::VARIANT_BOOL, bstrfileextension: &windows_core::BSTR) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn ModifyResourceType(&self, fmachinewide: super::super::Foundation::VARIANT_BOOL, bstrfileextension: &windows_core::BSTR, bstrlauncher: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IWorkspaceScriptable {
    pub unsafe fn DisconnectWorkspace(&self, bstrworkspaceid: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn StartWorkspace(&self, bstrworkspaceid: &windows_core::BSTR, bstrusername: &windows_core::BSTR, bstrpassword: &windows_core::BSTR, bstrworkspaceparams: &windows_core::BSTR, ltimeout: i32, lflags: i32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn IsWorkspaceCredentialSpecified(&self, bstrworkspaceid: &windows_core::BSTR, bcountunauthenticatedcredentials: super::super::Foundation::VARIANT_BOOL) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn IsWorkspaceSSOEnabled(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsWorkspaceSSOEnabled)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn ClearWorkspaceCredential(&self, bstrworkspaceid: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn OnAuthenticated(&self, bstrworkspaceid: &windows_core::BSTR, bstrusername: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn DisconnectWorkspaceByFriendlyName(&self, bstrworkspacefriendlyname: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
...
pub trait IWorkspaceScriptable_Impl: super::Com::IDispatch_Impl {
    fn DisconnectWorkspace(&self, bstrworkspaceid: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn StartWorkspace(&self, bstrworkspaceid: &windows_core::BSTR, bstrusername: &windows_core::BSTR, bstrpassword: &windows_core::BSTR, bstrworkspaceparams: &windows_core::BSTR, ltimeout: i32, lflags: i32) -> Result<(), windows_result::HRESULT>;
    fn IsWorkspaceCredentialSpecified(&self, bstrworkspaceid: &windows_core::BSTR, bcountunauthenticatedcredentials: super::super::Foundation::VARIANT_BOOL) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT>;
    fn IsWorkspaceSSOEnabled(&self) -> Result<super::super::Foundation::VARIANT_BOOL, windows_result::HRESULT>;
    fn ClearWorkspaceCredential(&self, bstrworkspaceid: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn OnAuthenticated(&self, bstrworkspaceid: &windows_core::BSTR, bstrusername: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn DisconnectWorkspaceByFriendlyName(&self, bstrworkspacefriendlyname: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IWorkspaceScriptable2 {
    pub unsafe fn StartWorkspaceEx(&self, bstrworkspaceid: &windows_core::BSTR, bstrworkspacefriendlyname: &windows_core::BSTR, bstrredirectorname: &windows_core::BSTR, bstrusername: &windows_core::BSTR, bstrpassword: &windows_core::BSTR, bstrappcontainer: &windows_core::BSTR, bstrworkspaceparams: &windows_core::BSTR, ltimeout: i32, lflags: i32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn ResourceDismissed(&self, bstrworkspaceid: &windows_core::BSTR, bstrworkspacefriendlyname: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
...
pub trait IWorkspaceScriptable2_Impl: IWorkspaceScriptable_Impl {
    ...
    fn ResourceDismissed(&self, bstrworkspaceid: &windows_core::BSTR, bstrworkspacefriendlyname: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl ItsPubPlugin {
    pub unsafe fn GetResourceList<P0>(&self, userid: P0, pceapplistsize: *mut i32, resourcelist: *mut *mut pluginResource) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetResource<P0>(&self, alias: P0, flags: i32, resource: *mut pluginResource) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetCacheLastUpdateTime(&self) -> Result<u64, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCacheLastUpdateTime)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn pluginName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn pluginVersion(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ResolveResource<P3, P4>(&self, resourcetype: *mut u32, resourcelocation: &mut [u16; 256], endpointname: &mut [u16; 256], userid: P3, alias: P4) -> Result<(), windows_result::HRESULT>
    where
        P3: windows_core::Param<windows_core::PCWSTR>,
        P4: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait ItsPubPlugin_Impl: windows_core::IUnknownImpl {
    fn GetResourceList(&self, userid: &windows_core::PCWSTR, pceapplistsize: *mut i32, resourcelist: *mut *mut pluginResource) -> Result<(), windows_result::HRESULT>;
    fn GetResource(&self, alias: &windows_core::PCWSTR, flags: i32, resource: *mut pluginResource) -> Result<(), windows_result::HRESULT>;
    fn GetCacheLastUpdateTime(&self) -> Result<u64, windows_result::HRESULT>;
    fn pluginName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn pluginVersion(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn ResolveResource(&self, resourcetype: *mut u32, resourcelocation: windows_core::PWSTR, endpointname: windows_core::PWSTR, userid: &windows_core::PCWSTR, alias: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
...
impl ItsPubPlugin2 {
    pub unsafe fn GetResource2List<P0>(&self, userid: P0, pceapplistsize: *mut i32, resourcelist: *mut *mut pluginResource2) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetResource2<P0>(&self, alias: P0, flags: i32, resource: *mut pluginResource2) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn ResolvePersonalDesktop<P0, P1>(&self, userid: P0, poolid: P1, epdresolutiontype: TSPUB_PLUGIN_PD_RESOLUTION_TYPE, ppdassignmenttype: *mut TSPUB_PLUGIN_PD_ASSIGNMENT_TYPE, endpointname: &mut [u16; 256]) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn DeletePersonalDesktopAssignment<P0, P1, P2>(&self, userid: P0, poolid: P1, endpointname: P2) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
...
pub trait ItsPubPlugin2_Impl: ItsPubPlugin_Impl {
    fn GetResource2List(&self, userid: &windows_core::PCWSTR, pceapplistsize: *mut i32, resourcelist: *mut *mut pluginResource2) -> Result<(), windows_result::HRESULT>;
    fn GetResource2(&self, alias: &windows_core::PCWSTR, flags: i32, resource: *mut pluginResource2) -> Result<(), windows_result::HRESULT>;
    fn ResolvePersonalDesktop(&self, userid: &windows_core::PCWSTR, poolid: &windows_core::PCWSTR, epdresolutiontype: TSPUB_PLUGIN_PD_RESOLUTION_TYPE, ppdassignmenttype: *mut TSPUB_PLUGIN_PD_ASSIGNMENT_TYPE, endpointname: windows_core::PWSTR) -> Result<(), windows_result::HRESULT>;
    fn DeletePersonalDesktopAssignment(&self, userid: &windows_core::PCWSTR, poolid: &windows_core::PCWSTR, endpointname: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
