...
impl IItemEnumerator {
    ...
    pub unsafe fn Current(&self) -> Result<super::Variant::VARIANT, windows_result::HRESULT> {
        unsafe {
...
pub trait IItemEnumerator_Impl: windows_core::IUnknownImpl {
    fn Current(&self) -> Result<super::Variant::VARIANT, windows_result::HRESULT>;
...
impl ISettingsContext {
    ...
    pub unsafe fn Serialize<P0, P1>(&self, pstream: P0, ptarget: P1) -> Result<(), windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Deserialize<P0, P1>(&self, pstream: P0, ptarget: P1, pppresults: *mut *mut Option<ISettingsResult>) -> Result<usize, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Com::IStream>,
        P1: windows_core::Param<ITargetInfo>,
    {
    ...
    pub unsafe fn SetUserData(&self, puserdata: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetUserData)(windows_core::Interface::as_raw(self), puserdata).ok() }
    }
    pub unsafe fn GetUserData(&self) -> Result<*mut core::ffi::c_void, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetUserData)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetNamespaces(&self) -> Result<IItemEnumerator, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetStoredSettings<P0>(&self, pidentity: P0, ppaddedsettings: *mut Option<IItemEnumerator>, ppmodifiedsettings: *mut Option<IItemEnumerator>, ppdeletedsettings: *mut Option<IItemEnumerator>) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn RevertSetting<P0, P1>(&self, pidentity: P0, pwzsetting: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ISettingsIdentity>,
...
pub trait ISettingsContext_Impl: windows_core::IUnknownImpl {
    fn Serialize(&self, pstream: windows_core::Ref<'_, super::Com::IStream>, ptarget: windows_core::Ref<'_, ITargetInfo>) -> Result<(), windows_result::HRESULT>;
    fn Deserialize(&self, pstream: windows_core::Ref<'_, super::Com::IStream>, ptarget: windows_core::Ref<'_, ITargetInfo>, pppresults: *mut *mut Option<ISettingsResult>) -> Result<usize, windows_result::HRESULT>;
    fn SetUserData(&self, puserdata: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn GetUserData(&self) -> Result<*mut core::ffi::c_void, windows_result::HRESULT>;
    fn GetNamespaces(&self) -> Result<IItemEnumerator, windows_result::HRESULT>;
    fn GetStoredSettings(&self, pidentity: windows_core::Ref<'_, ISettingsIdentity>, ppaddedsettings: windows_core::OutRef<'_, IItemEnumerator>, ppmodifiedsettings: windows_core::OutRef<'_, IItemEnumerator>, ppdeletedsettings: windows_core::OutRef<'_, IItemEnumerator>) -> Result<(), windows_result::HRESULT>;
    fn RevertSetting(&self, pidentity: windows_core::Ref<'_, ISettingsIdentity>, pwzsetting: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl ISettingsEngine {
    pub unsafe fn GetNamespaces(&self, flags: WcmNamespaceEnumerationFlags, reserved: *const core::ffi::c_void) -> Result<IItemEnumerator, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetNamespace<P0>(&self, settingsid: P0, access: WcmNamespaceAccess, reserved: *const core::ffi::c_void) -> Result<ISettingsNamespace, windows_result::HRESULT>
    where
        P0: windows_core::Param<ISettingsIdentity>,
    {
        unsafe {
    ...
    pub unsafe fn GetErrorDescription(&self, hresult: i32) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateSettingsIdentity(&self) -> Result<ISettingsIdentity, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetStoreStatus(&self, reserved: *const core::ffi::c_void) -> Result<WcmUserStatus, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetStoreStatus)(windows_core::Interface::as_raw(self), reserved, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn LoadStore(&self, flags: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).LoadStore)(windows_core::Interface::as_raw(self), flags).ok() }
    }
    pub unsafe fn UnloadStore(&self, reserved: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).UnloadStore)(windows_core::Interface::as_raw(self), reserved).ok() }
    }
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn RegisterNamespace<P0, P1>(&self, settingsid: P0, stream: P1, pushsettings: bool) -> Result<super::Variant::VARIANT, windows_result::HRESULT>
    where
        P0: windows_core::Param<ISettingsIdentity>,
    ...
    pub unsafe fn UnregisterNamespace<P0>(&self, settingsid: P0, removesettings: bool) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ISettingsIdentity>,
    {
    ...
    pub unsafe fn CreateTargetInfo(&self) -> Result<ITargetInfo, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetTargetInfo(&self) -> Result<ITargetInfo, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetTargetInfo<P0>(&self, target: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn CreateSettingsContext(&self, flags: u32, reserved: *const core::ffi::c_void) -> Result<ISettingsContext, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetSettingsContext<P0>(&self, settingscontext: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn ApplySettingsContext<P0>(&self, settingscontext: P0, pppwzidentities: *mut *mut windows_core::PWSTR) -> Result<usize, windows_result::HRESULT>
    where
        P0: windows_core::Param<ISettingsContext>,
    {
        unsafe {
    ...
    pub unsafe fn GetSettingsContext(&self) -> Result<ISettingsContext, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISettingsEngine_Impl: windows_core::IUnknownImpl {
    fn GetNamespaces(&self, flags: WcmNamespaceEnumerationFlags, reserved: *const core::ffi::c_void) -> Result<IItemEnumerator, windows_result::HRESULT>;
    fn GetNamespace(&self, settingsid: windows_core::Ref<'_, ISettingsIdentity>, access: WcmNamespaceAccess, reserved: *const core::ffi::c_void) -> Result<ISettingsNamespace, windows_result::HRESULT>;
    fn GetErrorDescription(&self, hresult: i32) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn CreateSettingsIdentity(&self) -> Result<ISettingsIdentity, windows_result::HRESULT>;
    fn GetStoreStatus(&self, reserved: *const core::ffi::c_void) -> Result<WcmUserStatus, windows_result::HRESULT>;
    fn LoadStore(&self, flags: u32) -> Result<(), windows_result::HRESULT>;
    fn UnloadStore(&self, reserved: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn RegisterNamespace(&self, settingsid: windows_core::Ref<'_, ISettingsIdentity>, stream: windows_core::Ref<'_, super::Com::IStream>, pushsettings: windows_core::BOOL) -> Result<super::Variant::VARIANT, windows_result::HRESULT>;
    fn UnregisterNamespace(&self, settingsid: windows_core::Ref<'_, ISettingsIdentity>, removesettings: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn CreateTargetInfo(&self) -> Result<ITargetInfo, windows_result::HRESULT>;
    fn GetTargetInfo(&self) -> Result<ITargetInfo, windows_result::HRESULT>;
    fn SetTargetInfo(&self, target: windows_core::Ref<'_, ITargetInfo>) -> Result<(), windows_result::HRESULT>;
    fn CreateSettingsContext(&self, flags: u32, reserved: *const core::ffi::c_void) -> Result<ISettingsContext, windows_result::HRESULT>;
    fn SetSettingsContext(&self, settingscontext: windows_core::Ref<'_, ISettingsContext>) -> Result<(), windows_result::HRESULT>;
    fn ApplySettingsContext(&self, settingscontext: windows_core::Ref<'_, ISettingsContext>, pppwzidentities: *mut *mut windows_core::PWSTR) -> Result<usize, windows_result::HRESULT>;
    fn GetSettingsContext(&self) -> Result<ISettingsContext, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl ISettingsIdentity {
    pub unsafe fn GetAttribute<P1>(&self, reserved: *const core::ffi::c_void, name: P1) -> Result<windows_core::BSTR, windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn SetAttribute<P1, P2>(&self, reserved: *const core::ffi::c_void, name: P1, value: P2) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn SetFlags(&self, flags: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait ISettingsIdentity_Impl: windows_core::IUnknownImpl {
    fn GetAttribute(&self, reserved: *const core::ffi::c_void, name: &windows_core::PCWSTR) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetAttribute(&self, reserved: *const core::ffi::c_void, name: &windows_core::PCWSTR, value: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetFlags(&self) -> Result<u32, windows_result::HRESULT>;
    fn SetFlags(&self, flags: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl ISettingsItem {
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetValue(&self) -> Result<super::Variant::VARIANT, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn HasChild(&self) -> Result<windows_core::BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).HasChild)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn Children(&self) -> Result<IItemEnumerator, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetChild<P0>(&self, name: P0) -> Result<ISettingsItem, windows_result::HRESULT>
    where
    ...
    pub unsafe fn GetSettingByPath<P0>(&self, path: P0) -> Result<ISettingsItem, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn CreateSettingByPath<P0>(&self, path: P0) -> Result<ISettingsItem, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn RemoveSettingByPath<P0>(&self, path: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).RemoveSettingByPath)(windows_core::Interface::as_raw(self), path.param().abi()).ok() }
    }
    pub unsafe fn GetListKeyInformation(&self, keyname: *mut windows_core::BSTR) -> Result<WcmDataType, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn CreateListElement(&self, keydata: *const super::Variant::VARIANT) -> Result<ISettingsItem, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RemoveListElement<P0>(&self, elementname: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).RemoveListElement)(windows_core::Interface::as_raw(self), elementname.param().abi()).ok() }
    }
    pub unsafe fn Attributes(&self) -> Result<IItemEnumerator, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetAttribute<P0>(&self, name: P0) -> Result<super::Variant::VARIANT, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn GetRestrictionFacets(&self) -> Result<WcmRestrictionFacets, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetRestriction(&self, restrictionfacet: WcmRestrictionFacets) -> Result<super::Variant::VARIANT, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn GetKeyValue(&self) -> Result<super::Variant::VARIANT, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISettingsItem_Impl: windows_core::IUnknownImpl {
    ...
    fn GetValue(&self) -> Result<super::Variant::VARIANT, windows_result::HRESULT>;
    fn SetValue(&self, value: *const super::Variant::VARIANT) -> Result<(), windows_result::HRESULT>;
    fn GetSettingType(&self) -> Result<WcmSettingType, windows_result::HRESULT>;
    fn GetDataType(&self) -> Result<WcmDataType, windows_result::HRESULT>;
    fn GetValueRaw(&self, data: *mut *mut u8) -> Result<u32, windows_result::HRESULT>;
    fn SetValueRaw(&self, datatype: i32, data: *const u8, datasize: u32) -> Result<(), windows_result::HRESULT>;
    fn HasChild(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
    fn Children(&self) -> Result<IItemEnumerator, windows_result::HRESULT>;
    fn GetChild(&self, name: &windows_core::PCWSTR) -> Result<ISettingsItem, windows_result::HRESULT>;
    fn GetSettingByPath(&self, path: &windows_core::PCWSTR) -> Result<ISettingsItem, windows_result::HRESULT>;
    fn CreateSettingByPath(&self, path: &windows_core::PCWSTR) -> Result<ISettingsItem, windows_result::HRESULT>;
    fn RemoveSettingByPath(&self, path: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetListKeyInformation(&self, keyname: *mut windows_core::BSTR) -> Result<WcmDataType, windows_result::HRESULT>;
    fn CreateListElement(&self, keydata: *const super::Variant::VARIANT) -> Result<ISettingsItem, windows_result::HRESULT>;
    fn RemoveListElement(&self, elementname: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn Attributes(&self) -> Result<IItemEnumerator, windows_result::HRESULT>;
    fn GetAttribute(&self, name: &windows_core::PCWSTR) -> Result<super::Variant::VARIANT, windows_result::HRESULT>;
    fn GetPath(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn GetRestrictionFacets(&self) -> Result<WcmRestrictionFacets, windows_result::HRESULT>;
    fn GetRestriction(&self, restrictionfacet: WcmRestrictionFacets) -> Result<super::Variant::VARIANT, windows_result::HRESULT>;
    fn GetKeyValue(&self) -> Result<super::Variant::VARIANT, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl ISettingsNamespace {
    pub unsafe fn GetIdentity(&self) -> Result<ISettingsIdentity, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Settings(&self) -> Result<IItemEnumerator, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Save(&self, pushsettings: bool) -> Result<ISettingsResult, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISettingsNamespace_Impl: windows_core::IUnknownImpl {
    fn GetIdentity(&self) -> Result<ISettingsIdentity, windows_result::HRESULT>;
    fn Settings(&self) -> Result<IItemEnumerator, windows_result::HRESULT>;
    fn Save(&self, pushsettings: windows_core::BOOL) -> Result<ISettingsResult, windows_result::HRESULT>;
    fn GetSettingByPath(&self, path: &windows_core::PCWSTR) -> Result<ISettingsItem, windows_result::HRESULT>;
    fn CreateSettingByPath(&self, path: &windows_core::PCWSTR) -> Result<ISettingsItem, windows_result::HRESULT>;
    fn RemoveSettingByPath(&self, path: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetAttribute(&self, name: &windows_core::PCWSTR) -> Result<super::Variant::VARIANT, windows_result::HRESULT>;
...
impl ISettingsResult {
    ...
    pub unsafe fn GetContextDescription(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetLine(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLine)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetColumn(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISettingsResult_Impl: windows_core::IUnknownImpl {
    ...
    fn GetContextDescription(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn GetLine(&self) -> Result<u32, windows_result::HRESULT>;
    fn GetColumn(&self) -> Result<u32, windows_result::HRESULT>;
...
impl ITargetInfo {
    pub unsafe fn GetTargetMode(&self) -> Result<WcmTargetMode, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTargetMode)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetTargetMode(&self, targetmode: WcmTargetMode) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetTargetMode)(windows_core::Interface::as_raw(self), targetmode).ok() }
    }
    pub unsafe fn GetTemporaryStoreLocation(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetTemporaryStoreLocation<P0>(&self, temporarystorelocation: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetTargetID(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetTargetID(&self, targetid: windows_core::GUID) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetTargetID)(windows_core::Interface::as_raw(self), core::mem::transmute(targetid)).ok() }
    }
    pub unsafe fn GetTargetProcessorArchitecture(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetTargetProcessorArchitecture<P0>(&self, processorarchitecture: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetProperty<P1>(&self, offline: bool, property: P1) -> Result<windows_core::BSTR, windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn SetProperty<P1, P2>(&self, offline: bool, property: P1, value: P2) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetEnumerator(&self) -> Result<IItemEnumerator, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ExpandTarget<P1>(&self, offline: bool, location: P1) -> Result<windows_core::BSTR, windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn ExpandTargetPath<P1>(&self, offline: bool, location: P1) -> Result<windows_core::BSTR, windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn SetModulePath<P0, P1>(&self, module: P0, path: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn LoadModule<P0>(&self, module: P0) -> Result<super::super::Foundation::HMODULE, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn SetWow64Context<P0>(&self, installermodule: P0, wow64context: *const u8) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn TranslateWow64<P0, P1>(&self, clientarchitecture: P0, value: P1) -> Result<windows_core::BSTR, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetSchemaHiveLocation<P0>(&self, pwzhivedir: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetSchemaHiveLocation(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetSchemaHiveMountName<P0>(&self, pwzmountname: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetSchemaHiveMountName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ITargetInfo_Impl: windows_core::IUnknownImpl {
    fn GetTargetMode(&self) -> Result<WcmTargetMode, windows_result::HRESULT>;
    fn SetTargetMode(&self, targetmode: WcmTargetMode) -> Result<(), windows_result::HRESULT>;
    fn GetTemporaryStoreLocation(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetTemporaryStoreLocation(&self, temporarystorelocation: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetTargetID(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetTargetID(&self, targetid: &windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn GetTargetProcessorArchitecture(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetTargetProcessorArchitecture(&self, processorarchitecture: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetProperty(&self, offline: windows_core::BOOL, property: &windows_core::PCWSTR) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetProperty(&self, offline: windows_core::BOOL, property: &windows_core::PCWSTR, value: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetEnumerator(&self) -> Result<IItemEnumerator, windows_result::HRESULT>;
    fn ExpandTarget(&self, offline: windows_core::BOOL, location: &windows_core::PCWSTR) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn ExpandTargetPath(&self, offline: windows_core::BOOL, location: &windows_core::PCWSTR) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetModulePath(&self, module: &windows_core::PCWSTR, path: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn LoadModule(&self, module: &windows_core::PCWSTR) -> Result<super::super::Foundation::HMODULE, windows_result::HRESULT>;
    fn SetWow64Context(&self, installermodule: &windows_core::PCWSTR, wow64context: *const u8) -> Result<(), windows_result::HRESULT>;
    fn TranslateWow64(&self, clientarchitecture: &windows_core::PCWSTR, value: &windows_core::PCWSTR) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetSchemaHiveLocation(&self, pwzhivedir: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetSchemaHiveLocation(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetSchemaHiveMountName(&self, pwzmountname: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetSchemaHiveMountName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
}
