...
impl ISideShowBulkCapabilities {
    ...
    {
        unsafe { (windows_core::Interface::vtable(self).GetCapabilities)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(&in_keycollection.param().borrow()), core::mem::transmute(inout_pvalues)).ok() }
    }
}
#[repr(C)]
#[doc(hidden)]
...
pub trait ISideShowBulkCapabilities_Impl: ISideShowCapabilities_Impl {
    fn GetCapabilities(&self, in_keycollection: Option<&ISideShowKeyCollection>, inout_pvalues: windows_core::OutRef<ISideShowPropVariantCollection>) -> windows_core::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    ...
    pub const fn new<Identity: ISideShowBulkCapabilities_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetCapabilities<Identity: ISideShowBulkCapabilities_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, in_keycollection: *mut core::ffi::c_void, inout_pvalues: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                ...
                ISideShowBulkCapabilities_Impl::GetCapabilities(this, windows_core::Ref::option_from_abi(&in_keycollection), core::mem::transmute_copy(&inout_pvalues)).into()
            }
        }
...
impl ISideShowContent {
    ...
    {
        unsafe { (windows_core::Interface::vtable(self).GetContent)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(&in_picapabilities.param().borrow()), out_pdwsize as _, out_ppbdata as _).ok() }
    }
...
impl ISideShowContent_Vtbl {
    pub const fn new<Identity: ISideShowContent_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetContent<Identity: ISideShowContent_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, in_picapabilities: *mut core::ffi::c_void, out_pdwsize: *mut u32, out_ppbdata: *mut *mut u8) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowContent_Impl::GetContent(this, windows_core::Ref::option_from_abi(&in_picapabilities), core::mem::transmute_copy(&out_pdwsize), core::mem::transmute_copy(&out_ppbdata)).into()
            }
        }
...
impl ISideShowContentManager {
    ...
    {
        unsafe { (windows_core::Interface::vtable(self).Add)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(&in_picontent.param().borrow())).ok() }
    }
    ...
    {
        unsafe { (windows_core::Interface::vtable(self).SetEventSink)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(&in_pievents.param().borrow())).ok() }
    }
...
impl ISideShowContentManager_Vtbl {
    pub const fn new<Identity: ISideShowContentManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Add<Identity: ISideShowContentManager_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, in_picontent: *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowContentManager_Impl::Add(this, windows_core::Ref::option_from_abi(&in_picontent)).into()
            }
        }
        ...
        unsafe extern "system" fn SetEventSink<Identity: ISideShowContentManager_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, in_pievents: *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowContentManager_Impl::SetEventSink(this, windows_core::Ref::option_from_abi(&in_pievents)).into()
            }
        }
...
impl ISideShowEvents {
    ...
    where
        P0: windows_core::Param<ISideShowCapabilities>,
    {
        unsafe { (windows_core::Interface::vtable(self).ApplicationEvent)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(&in_picapabilities.param().borrow()), in_dweventid, in_pbeventdata.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), core::mem::transmute(in_pbeventdata.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr()))).ok() }
    }
    pub unsafe fn DeviceAdded<P0>(&self, in_pidevice: P0) -> windows_core::Result<()>
    where
        P0: windows_core::Param<ISideShowCapabilities>,
    {
        unsafe { (windows_core::Interface::vtable(self).DeviceAdded)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(&in_pidevice.param().borrow())).ok() }
    }
    pub unsafe fn DeviceRemoved<P0>(&self, in_pidevice: P0) -> windows_core::Result<()>
    where
        P0: windows_core::Param<ISideShowCapabilities>,
    {
        unsafe { (windows_core::Interface::vtable(self).DeviceRemoved)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(&in_pidevice.param().borrow())).ok() }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl ISideShowEvents_Vtbl {
    pub const fn new<Identity: ISideShowEvents_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn ApplicationEvent<Identity: ISideShowEvents_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, in_picapabilities: *mut core::ffi::c_void, in_dweventid: u32, in_dweventsize: u32, in_pbeventdata: *const u8) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowEvents_Impl::ApplicationEvent(this, windows_core::Ref::option_from_abi(&in_picapabilities), core::mem::transmute_copy(&in_dweventid), core::mem::transmute_copy(&in_dweventsize), core::mem::transmute_copy(&in_pbeventdata)).into()
            }
        }
        unsafe extern "system" fn DeviceAdded<Identity: ISideShowEvents_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, in_pidevice: *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowEvents_Impl::DeviceAdded(this, windows_core::Ref::option_from_abi(&in_pidevice)).into()
            }
        }
        unsafe extern "system" fn DeviceRemoved<Identity: ISideShowEvents_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, in_pidevice: *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowEvents_Impl::DeviceRemoved(this, windows_core::Ref::option_from_abi(&in_pidevice)).into()
            }
        }
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
...
impl ISideShowNotification {
    ...
    {
        unsafe { (windows_core::Interface::vtable(self).SetTitle)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(&in_pwsztitle.param().borrow())).ok() }
    }
    ...
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetMessage)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(&in_pwszmessage.param().borrow())).ok() }
    }
...
impl ISideShowNotificationManager {
    ...
    {
        unsafe { (windows_core::Interface::vtable(self).Show)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(&in_pinotification.param().borrow())).ok() }
    }
...
impl ISideShowNotificationManager_Vtbl {
    pub const fn new<Identity: ISideShowNotificationManager_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Show<Identity: ISideShowNotificationManager_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, in_pinotification: *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ISideShowNotificationManager_Impl::Show(this, windows_core::Ref::option_from_abi(&in_pinotification)).into()
            }
        }
