...
impl ISideShowBulkCapabilities {
    pub unsafe fn GetCapabilities<P0>(&self, in_keycollection: P0, inout_pvalues: *mut Option<ISideShowPropVariantCollection>) -> Result<(), windows_result::HRESULT>
    where
...
pub trait ISideShowBulkCapabilities_Impl: ISideShowCapabilities_Impl {
    fn GetCapabilities(&self, in_keycollection: windows_core::Ref<'_, ISideShowKeyCollection>, inout_pvalues: windows_core::OutRef<'_, ISideShowPropVariantCollection>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl ISideShowCapabilities {
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn GetCapability(&self, in_keycapability: *const super::super::Foundation::PROPERTYKEY, inout_pvalue: *mut super::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT> {
...
pub trait ISideShowCapabilities_Impl: windows_core::IUnknownImpl {
    fn GetCapability(&self, in_keycapability: *const super::super::Foundation::PROPERTYKEY, inout_pvalue: *mut super::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl ISideShowCapabilitiesCollection {
    ...
    pub unsafe fn GetAt(&self, in_dwindex: u32) -> Result<ISideShowCapabilities, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISideShowCapabilitiesCollection_Impl: windows_core::IUnknownImpl {
    ...
    fn GetAt(&self, in_dwindex: u32) -> Result<ISideShowCapabilities, windows_result::HRESULT>;
}
...
impl ISideShowContent {
    pub unsafe fn GetContent<P0>(&self, in_picapabilities: P0, out_pdwsize: *mut u32, out_ppbdata: *mut *mut u8) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn ContentId(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ContentId)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn DifferentiateContent(&self) -> Result<windows_core::BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISideShowContent_Impl: windows_core::IUnknownImpl {
    fn GetContent(&self, in_picapabilities: windows_core::Ref<'_, ISideShowCapabilities>, out_pdwsize: *mut u32, out_ppbdata: *mut *mut u8) -> Result<(), windows_result::HRESULT>;
    fn ContentId(&self) -> Result<u32, windows_result::HRESULT>;
    fn DifferentiateContent(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
}
...
impl ISideShowContentManager {
    pub unsafe fn Add<P0>(&self, in_picontent: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Remove(&self, in_contentid: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetEventSink<P0>(&self, in_pievents: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn GetDeviceCapabilities(&self) -> Result<ISideShowCapabilitiesCollection, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISideShowContentManager_Impl: windows_core::IUnknownImpl {
    fn Add(&self, in_picontent: windows_core::Ref<'_, ISideShowContent>) -> Result<(), windows_result::HRESULT>;
    fn Remove(&self, in_contentid: u32) -> Result<(), windows_result::HRESULT>;
    fn RemoveAll(&self) -> Result<(), windows_result::HRESULT>;
    fn SetEventSink(&self, in_pievents: windows_core::Ref<'_, ISideShowEvents>) -> Result<(), windows_result::HRESULT>;
    fn GetDeviceCapabilities(&self) -> Result<ISideShowCapabilitiesCollection, windows_result::HRESULT>;
}
...
impl ISideShowEvents {
    pub unsafe fn ContentMissing(&self, in_contentid: u32) -> Result<ISideShowContent, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ApplicationEvent<P0>(&self, in_picapabilities: P0, in_dweventid: u32, in_pbeventdata: Option<&[u8]>) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ISideShowCapabilities>,
    {
    ...
    pub unsafe fn DeviceAdded<P0>(&self, in_pidevice: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ISideShowCapabilities>,
    {
        unsafe { (windows_core::Interface::vtable(self).DeviceAdded)(windows_core::Interface::as_raw(self), in_pidevice.param().abi()).ok() }
    }
    pub unsafe fn DeviceRemoved<P0>(&self, in_pidevice: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ISideShowCapabilities>,
    {
...
pub trait ISideShowEvents_Impl: windows_core::IUnknownImpl {
    fn ContentMissing(&self, in_contentid: u32) -> Result<ISideShowContent, windows_result::HRESULT>;
    fn ApplicationEvent(&self, in_picapabilities: windows_core::Ref<'_, ISideShowCapabilities>, in_dweventid: u32, in_dweventsize: u32, in_pbeventdata: *const u8) -> Result<(), windows_result::HRESULT>;
    fn DeviceAdded(&self, in_pidevice: windows_core::Ref<'_, ISideShowCapabilities>) -> Result<(), windows_result::HRESULT>;
    fn DeviceRemoved(&self, in_pidevice: windows_core::Ref<'_, ISideShowCapabilities>) -> Result<(), windows_result::HRESULT>;
}
...
impl ISideShowKeyCollection {
    ...
    pub unsafe fn GetAt(&self, dwindex: u32, pkey: *mut super::super::Foundation::PROPERTYKEY) -> Result<(), windows_result::HRESULT> {
...
pub trait ISideShowKeyCollection_Impl: windows_core::IUnknownImpl {
    ...
    fn GetAt(&self, dwindex: u32, pkey: *mut super::super::Foundation::PROPERTYKEY) -> Result<(), windows_result::HRESULT>;
...
impl ISideShowNotification {
    ...
    pub unsafe fn Image(&self) -> Result<super::super::UI::WindowsAndMessaging::HICON, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_UI_WindowsAndMessaging")]
    pub unsafe fn SetImage(&self, in_hicon: super::super::UI::WindowsAndMessaging::HICON) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetImage)(windows_core::Interface::as_raw(self), in_hicon).ok() }
    }
    pub unsafe fn ExpirationTime(&self) -> Result<super::super::Foundation::SYSTEMTIME, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ExpirationTime)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetExpirationTime(&self, in_ptime: Option<*const super::super::Foundation::SYSTEMTIME>) -> Result<(), windows_result::HRESULT> {
...
pub trait ISideShowNotification_Impl: windows_core::IUnknownImpl {
    fn NotificationId(&self) -> Result<u32, windows_result::HRESULT>;
    fn SetNotificationId(&self, in_notificationid: u32) -> Result<(), windows_result::HRESULT>;
    fn Title(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn SetTitle(&self, in_pwsztitle: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn Message(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn SetMessage(&self, in_pwszmessage: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn Image(&self) -> Result<super::super::UI::WindowsAndMessaging::HICON, windows_result::HRESULT>;
    fn SetImage(&self, in_hicon: super::super::UI::WindowsAndMessaging::HICON) -> Result<(), windows_result::HRESULT>;
    fn ExpirationTime(&self) -> Result<super::super::Foundation::SYSTEMTIME, windows_result::HRESULT>;
    fn SetExpirationTime(&self, in_ptime: *const super::super::Foundation::SYSTEMTIME) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
impl ISideShowNotificationManager {
    pub unsafe fn Show<P0>(&self, in_pinotification: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Revoke(&self, in_notificationid: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Revoke)(windows_core::Interface::as_raw(self), in_notificationid).ok() }
    }
    pub unsafe fn RevokeAll(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait ISideShowNotificationManager_Impl: windows_core::IUnknownImpl {
    fn Show(&self, in_pinotification: windows_core::Ref<'_, ISideShowNotification>) -> Result<(), windows_result::HRESULT>;
    fn Revoke(&self, in_notificationid: u32) -> Result<(), windows_result::HRESULT>;
    fn RevokeAll(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl ISideShowPropVariantCollection {
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn Add(&self, pvalue: *const super::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn GetAt(&self, dwindex: u32, pvalue: *mut super::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT> {
...
pub trait ISideShowPropVariantCollection_Impl: windows_core::IUnknownImpl {
    fn Add(&self, pvalue: *const super::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT>;
    fn Clear(&self) -> Result<(), windows_result::HRESULT>;
    fn GetAt(&self, dwindex: u32, pvalue: *mut super::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT>;
    fn GetCount(&self, pcelems: *const u32) -> Result<(), windows_result::HRESULT>;
    fn RemoveAt(&self, dwindex: u32) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl ISideShowSession {
    pub unsafe fn RegisterContent(&self, in_applicationid: *const windows_core::GUID, in_endpointid: *const windows_core::GUID) -> Result<ISideShowContentManager, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RegisterNotifications(&self, in_applicationid: *const windows_core::GUID) -> Result<ISideShowNotificationManager, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISideShowSession_Impl: windows_core::IUnknownImpl {
    fn RegisterContent(&self, in_applicationid: *const windows_core::GUID, in_endpointid: *const windows_core::GUID) -> Result<ISideShowContentManager, windows_result::HRESULT>;
    fn RegisterNotifications(&self, in_applicationid: *const windows_core::GUID) -> Result<ISideShowNotificationManager, windows_result::HRESULT>;
}
