...
pub unsafe fn GetDeviceID(pbwindowsaik: ::core::option::Option<&mut [u8]>, pcbresult: *mut u32, pfprotectedbytpm: ::core::option::Option<*mut super::super::Foundation::BOOL>) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "tbs.dll" ,"system" fn GetDeviceID ( pbwindowsaik : *mut u8 , cbwindowsaik : u32 , pcbresult : *mut u32 , pfprotectedbytpm : *mut super::super::Foundation:: BOOL ) -> :: windows::core::HRESULT );
...
pub unsafe fn GetDeviceIDString(pszwindowsaik: ::core::option::Option<&mut [u16]>, pcchresult: *mut u32, pfprotectedbytpm: ::core::option::Option<*mut super::super::Foundation::BOOL>) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "tbs.dll" ,"system" fn GetDeviceIDString ( pszwindowsaik : :: windows::core::PWSTR , cchwindowsaik : u32 , pcchresult : *mut u32 , pfprotectedbytpm : *mut super::super::Foundation:: BOOL ) -> :: windows::core::HRESULT );
...
pub unsafe fn Tbsi_Context_Create(pcontextparams: *const TBS_CONTEXT_PARAMS, phcontext: *mut *mut ::core::ffi::c_void) -> u32 {
    ::windows::core::windows_link ! ( "tbs.dll" ,"system" fn Tbsi_Context_Create ( pcontextparams : *const TBS_CONTEXT_PARAMS , phcontext : *mut *mut ::core::ffi::c_void ) -> u32 );
...
pub unsafe fn Tbsi_Create_Windows_Key(keyhandle: u32) -> u32 {
    ::windows::core::windows_link ! ( "tbs.dll" ,"system" fn Tbsi_Create_Windows_Key ( keyhandle : u32 ) -> u32 );
    Tbsi_Create_Windows_Key(keyhandle)
}
#[doc = "*Required features: `\"Win32_System_TpmBaseServices\"`*"]
#[inline]
pub unsafe fn Tbsi_GetDeviceInfo(size: u32, info: *mut ::core::ffi::c_void) -> u32 {
    ::windows::core::windows_link ! ( "tbs.dll" ,"system" fn Tbsi_GetDeviceInfo ( size : u32 , info : *mut ::core::ffi::c_void ) -> u32 );
...
pub unsafe fn Tbsi_Get_OwnerAuth(hcontext: *const ::core::ffi::c_void, ownerauthtype: u32, poutputbuf: ::core::option::Option<*mut u8>, poutputbuflen: *mut u32) -> u32 {
    ::windows::core::windows_link ! ( "tbs.dll" ,"system" fn Tbsi_Get_OwnerAuth ( hcontext : *const ::core::ffi::c_void , ownerauthtype : u32 , poutputbuf : *mut u8 , poutputbuflen : *mut u32 ) -> u32 );
...
pub unsafe fn Tbsi_Get_TCG_Log(hcontext: *const ::core::ffi::c_void, poutputbuf: ::core::option::Option<*mut u8>, poutputbuflen: *mut u32) -> u32 {
    ::windows::core::windows_link ! ( "tbs.dll" ,"system" fn Tbsi_Get_TCG_Log ( hcontext : *const ::core::ffi::c_void , poutputbuf : *mut u8 , poutputbuflen : *mut u32 ) -> u32 );
...
pub unsafe fn Tbsi_Get_TCG_Log_Ex(logtype: u32, pboutput: ::core::option::Option<*mut u8>, pcboutput: *mut u32) -> u32 {
    ::windows::core::windows_link ! ( "tbs.dll" ,"system" fn Tbsi_Get_TCG_Log_Ex ( logtype : u32 , pboutput : *mut u8 , pcboutput : *mut u32 ) -> u32 );
...
pub unsafe fn Tbsi_Physical_Presence_Command(hcontext: *const ::core::ffi::c_void, pabinput: &[u8], paboutput: *mut u8, pcboutput: *mut u32) -> u32 {
    ::windows::core::windows_link ! ( "tbs.dll" ,"system" fn Tbsi_Physical_Presence_Command ( hcontext : *const ::core::ffi::c_void , pabinput : *const u8 , cbinput : u32 , paboutput : *mut u8 , pcboutput : *mut u32 ) -> u32 );
...
pub unsafe fn Tbsi_Revoke_Attestation() -> u32 {
    ::windows::core::windows_link ! ( "tbs.dll" ,"system" fn Tbsi_Revoke_Attestation ( ) -> u32 );
    Tbsi_Revoke_Attestation()
}
#[doc = "*Required features: `\"Win32_System_TpmBaseServices\"`*"]
#[inline]
pub unsafe fn Tbsip_Cancel_Commands(hcontext: *const ::core::ffi::c_void) -> u32 {
    ::windows::core::windows_link ! ( "tbs.dll" ,"system" fn Tbsip_Cancel_Commands ( hcontext : *const ::core::ffi::c_void ) -> u32 );
    Tbsip_Cancel_Commands(::core::mem::transmute(hcontext))
}
#[doc = "*Required features: `\"Win32_System_TpmBaseServices\"`*"]
#[inline]
pub unsafe fn Tbsip_Context_Close(hcontext: *const ::core::ffi::c_void) -> u32 {
    ::windows::core::windows_link ! ( "tbs.dll" ,"system" fn Tbsip_Context_Close ( hcontext : *const ::core::ffi::c_void ) -> u32 );
...
pub unsafe fn Tbsip_Submit_Command(hcontext: *const ::core::ffi::c_void, locality: TBS_COMMAND_LOCALITY, priority: TBS_COMMAND_PRIORITY, pabcommand: &[u8], pabresult: *mut u8, pcbresult: *mut u32) -> u32 {
    ::windows::core::windows_link ! ( "tbs.dll" ,"system" fn Tbsip_Submit_Command ( hcontext : *const ::core::ffi::c_void , locality : TBS_COMMAND_LOCALITY , priority : TBS_COMMAND_PRIORITY , pabcommand : *const u8 , cbcommand : u32 , pabresult : *mut u8 , pcbresult : *mut u32 ) -> u32 );
