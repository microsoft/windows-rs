...
#[inline]
pub unsafe fn GetDeviceID(pbwindowsaik: ::core::option::Option<&mut u8>, cbwindowsaik: u32, pcbresult: &mut u32, pfprotectedbytpm: ::core::option::Option<&mut super::super::Foundation::BOOL>) -> ::windows::core::Result<()> {
    ...
    GetDeviceID(::core::mem::transmute(pbwindowsaik), cbwindowsaik, ::core::mem::transmute(pcbresult), ::core::mem::transmute(pfprotectedbytpm)).ok()
}
#[doc = "*Required features: `\"Win32_System_TpmBaseServices\"`, `\"Win32_Foundation\"`*"]
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn GetDeviceIDString(pszwindowsaik: &mut [u16], pcchresult: &mut u32, pfprotectedbytpm: ::core::option::Option<&mut super::super::Foundation::BOOL>) -> ::windows::core::Result<()> {
    #[cfg_attr(windows, link(name = "windows"))]
    extern "system" {
...
#[doc = "*Required features: `\"Win32_System_TpmBaseServices\"`*"]
#[inline]
pub unsafe fn Tbsi_Physical_Presence_Command(hcontext: *const ::core::ffi::c_void, pabinput: &u8, cbinput: u32, paboutput: &mut u8, pcboutput: &mut u32) -> u32 {
    #[cfg_attr(windows, link(name = "windows"))]
    extern "system" {
    ...
    Tbsi_Physical_Presence_Command(::core::mem::transmute(hcontext), ::core::mem::transmute(pabinput), cbinput, ::core::mem::transmute(paboutput), ::core::mem::transmute(pcboutput))
}
#[doc = "*Required features: `\"Win32_System_TpmBaseServices\"`*"]
#[inline]
...
#[doc = "*Required features: `\"Win32_System_TpmBaseServices\"`*"]
#[inline]
pub unsafe fn Tbsip_Submit_Command(hcontext: *const ::core::ffi::c_void, locality: TBS_COMMAND_LOCALITY, priority: TBS_COMMAND_PRIORITY, pabcommand: &u8, cbcommand: u32, pabresult: &mut u8, pcbresult: &mut u32) -> u32 {
    #[cfg_attr(windows, link(name = "windows"))]
    extern "system" {
    ...
    Tbsip_Submit_Command(::core::mem::transmute(hcontext), locality, priority, ::core::mem::transmute(pabcommand), cbcommand, ::core::mem::transmute(pabresult), ::core::mem::transmute(pcbresult))
}
#[repr(C)]
#[doc = "*Required features: `\"Win32_System_TpmBaseServices\"`*"]
