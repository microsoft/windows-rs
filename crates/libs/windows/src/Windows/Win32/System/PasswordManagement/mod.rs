    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { MSChapSrvChangePassword(core::mem::transmute_copy(&servername.param().borrow()), core::mem::transmute_copy(&username.param().borrow()), lmoldpresent, lmoldowfpassword, lmnewowfpassword, ntoldowfpassword, ntnewowfpassword) }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { MSChapSrvChangePassword2(core::mem::transmute_copy(&servername.param().borrow()), core::mem::transmute_copy(&username.param().borrow()), newpasswordencryptedwitholdnt, oldntowfpasswordencryptedwithnewnt, lmpresent, newpasswordencryptedwitholdlm, oldlmowfpasswordencryptedwithnewlmornt) }
}
#[repr(C)]
