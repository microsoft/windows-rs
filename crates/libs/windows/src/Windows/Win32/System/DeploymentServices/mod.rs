...
pub const EVT_WDSMCS_E_CP_CALLBACKS_NOT_REG: windows_core::HRESULT = 0xC1210254_u32 as _;
pub const EVT_WDSMCS_E_CP_CLOSE_INSTANCE_FAILED: windows_core::HRESULT = 0xC1210258_u32 as _;
pub const EVT_WDSMCS_E_CP_DLL_LOAD_FAILED: windows_core::HRESULT = 0xC1210250_u32 as _;
pub const EVT_WDSMCS_E_CP_DLL_LOAD_FAILED_CRITICAL: windows_core::HRESULT = 0xC121025B_u32 as _;
pub const EVT_WDSMCS_E_CP_INCOMPATIBLE_SERVER_VERSION: windows_core::HRESULT = 0xC1210253_u32 as _;
pub const EVT_WDSMCS_E_CP_INIT_FUNC_FAILED: windows_core::HRESULT = 0xC1210252_u32 as _;
pub const EVT_WDSMCS_E_CP_INIT_FUNC_MISSING: windows_core::HRESULT = 0xC1210251_u32 as _;
pub const EVT_WDSMCS_E_CP_MEMORY_LEAK: windows_core::HRESULT = 0xC1210256_u32 as _;
pub const EVT_WDSMCS_E_CP_OPEN_CONTENT_FAILED: windows_core::HRESULT = 0xC1210259_u32 as _;
pub const EVT_WDSMCS_E_CP_OPEN_INSTANCE_FAILED: windows_core::HRESULT = 0xC1210257_u32 as _;
pub const EVT_WDSMCS_E_CP_SHUTDOWN_FUNC_FAILED: windows_core::HRESULT = 0xC1210255_u32 as _;
pub const EVT_WDSMCS_E_DUPLICATE_MULTICAST_ADDR: windows_core::HRESULT = 0xC1210202_u32 as _;
pub const EVT_WDSMCS_E_NON_WDS_DUPLICATE_MULTICAST_ADDR: windows_core::HRESULT = 0xC1210203_u32 as _;
pub const EVT_WDSMCS_E_NSREG_CONTENT_PROVIDER_NOT_REG: windows_core::HRESULT = 0xC1210301_u32 as _;
pub const EVT_WDSMCS_E_NSREG_FAILURE: windows_core::HRESULT = 0xC1210303_u32 as _;
pub const EVT_WDSMCS_E_NSREG_NAMESPACE_EXISTS: windows_core::HRESULT = 0xC1210302_u32 as _;
pub const EVT_WDSMCS_E_NSREG_START_TIME_IN_PAST: windows_core::HRESULT = 0xC1210300_u32 as _;
pub const EVT_WDSMCS_E_PARAMETERS_READ_FAILED: windows_core::HRESULT = 0xC1210201_u32 as _;
pub const EVT_WDSMCS_S_PARAMETERS_READ: windows_core::HRESULT = 0x41210200_u32 as _;
pub const EVT_WDSMCS_W_CP_DLL_LOAD_FAILED_NOT_CRITICAL: windows_core::HRESULT = 0x8121025A_u32 as _;
...
pub const WDSMCCLIENT_CATEGORY: windows_core::HRESULT = 0x2_u32 as _;
pub const WDSMCSERVER_CATEGORY: windows_core::HRESULT = 0x1_u32 as _;
pub const WDSMCS_E_CLIENT_DOESNOT_SUPPORT_SECURITY_MODE: windows_core::HRESULT = 0xC1210110_u32 as _;
pub const WDSMCS_E_CLIENT_NOT_FOUND: windows_core::HRESULT = 0xC1210104_u32 as _;
pub const WDSMCS_E_CONTENT_NOT_FOUND: windows_core::HRESULT = 0xC1210103_u32 as _;
pub const WDSMCS_E_CONTENT_PROVIDER_NOT_FOUND: windows_core::HRESULT = 0xC1210106_u32 as _;
pub const WDSMCS_E_INCOMPATIBLE_VERSION: windows_core::HRESULT = 0xC1210102_u32 as _;
pub const WDSMCS_E_NAMESPACE_ALREADY_EXISTS: windows_core::HRESULT = 0xC1210107_u32 as _;
pub const WDSMCS_E_NAMESPACE_ALREADY_STARTED: windows_core::HRESULT = 0xC1210109_u32 as _;
pub const WDSMCS_E_NAMESPACE_NOT_FOUND: windows_core::HRESULT = 0xC1210105_u32 as _;
pub const WDSMCS_E_NAMESPACE_SHUTDOWN_IN_PROGRESS: windows_core::HRESULT = 0xC1210108_u32 as _;
pub const WDSMCS_E_NS_START_FAILED_NO_CLIENTS: windows_core::HRESULT = 0xC121010A_u32 as _;
pub const WDSMCS_E_PACKET_HAS_SECURITY: windows_core::HRESULT = 0xC121010E_u32 as _;
pub const WDSMCS_E_PACKET_NOT_CHECKSUMED: windows_core::HRESULT = 0xC121010F_u32 as _;
pub const WDSMCS_E_PACKET_NOT_HASHED: windows_core::HRESULT = 0xC121010C_u32 as _;
pub const WDSMCS_E_PACKET_NOT_SIGNED: windows_core::HRESULT = 0xC121010D_u32 as _;
pub const WDSMCS_E_REQCALLBACKS_NOT_REG: windows_core::HRESULT = 0xC1210101_u32 as _;
pub const WDSMCS_E_SESSION_SHUTDOWN_IN_PROGRESS: windows_core::HRESULT = 0xC1210100_u32 as _;
pub const WDSMCS_E_START_TIME_IN_PAST: windows_core::HRESULT = 0xC121010B_u32 as _;
pub const WDSTPC_E_ALREADY_COMPLETED: windows_core::HRESULT = 0xC1220301_u32 as _;
pub const WDSTPC_E_ALREADY_IN_LOWEST_SESSION: windows_core::HRESULT = 0xC122030A_u32 as _;
pub const WDSTPC_E_ALREADY_IN_PROGRESS: windows_core::HRESULT = 0xC1220302_u32 as _;
pub const WDSTPC_E_CALLBACKS_NOT_REG: windows_core::HRESULT = 0xC1220300_u32 as _;
pub const WDSTPC_E_CLIENT_DEMOTE_NOT_SUPPORTED: windows_core::HRESULT = 0xC122030B_u32 as _;
pub const WDSTPC_E_KICKED_FAIL: windows_core::HRESULT = 0xC1220307_u32 as _;
pub const WDSTPC_E_KICKED_FALLBACK: windows_core::HRESULT = 0xC1220306_u32 as _;
pub const WDSTPC_E_KICKED_POLICY_NOT_MET: windows_core::HRESULT = 0xC1220305_u32 as _;
pub const WDSTPC_E_KICKED_UNKNOWN: windows_core::HRESULT = 0xC1220308_u32 as _;
pub const WDSTPC_E_MULTISTREAM_NOT_ENABLED: windows_core::HRESULT = 0xC1220309_u32 as _;
pub const WDSTPC_E_NOT_INITIALIZED: windows_core::HRESULT = 0xC1220304_u32 as _;
pub const WDSTPC_E_NO_IP4_INTERFACE: windows_core::HRESULT = 0xC122030C_u32 as _;
pub const WDSTPC_E_UNKNOWN_ERROR: windows_core::HRESULT = 0xC1220303_u32 as _;
pub const WDSTPTC_E_WIM_APPLY_REQUIRES_REFERENCE_IMAGE: windows_core::HRESULT = 0xC122030D_u32 as _;
pub const WDSTPTMGMT_CATEGORY: windows_core::HRESULT = 0x1_u32 as _;
pub const WDSTPTMGMT_E_CANNOT_REFRESH_DIRTY_OBJECT: windows_core::HRESULT = 0xC110010F_u32 as _;
pub const WDSTPTMGMT_E_CANNOT_REINITIALIZE_OBJECT: windows_core::HRESULT = 0xC1100109_u32 as _;
pub const WDSTPTMGMT_E_CONTENT_PROVIDER_ALREADY_REGISTERED: windows_core::HRESULT = 0xC1100103_u32 as _;
pub const WDSTPTMGMT_E_CONTENT_PROVIDER_NOT_REGISTERED: windows_core::HRESULT = 0xC1100104_u32 as _;
pub const WDSTPTMGMT_E_INVALID_AUTO_DISCONNECT_THRESHOLD: windows_core::HRESULT = 0xC110011C_u32 as _;
pub const WDSTPTMGMT_E_INVALID_CLASS: windows_core::HRESULT = 0xC1100102_u32 as _;
pub const WDSTPTMGMT_E_INVALID_CONTENT_PROVIDER_NAME: windows_core::HRESULT = 0xC1100105_u32 as _;
pub const WDSTPTMGMT_E_INVALID_DIAGNOSTICS_COMPONENTS: windows_core::HRESULT = 0xC110010E_u32 as _;
pub const WDSTPTMGMT_E_INVALID_IPV4_MULTICAST_ADDRESS: windows_core::HRESULT = 0xC1100117_u32 as _;
pub const WDSTPTMGMT_E_INVALID_IPV6_MULTICAST_ADDRESS: windows_core::HRESULT = 0xC1100118_u32 as _;
pub const WDSTPTMGMT_E_INVALID_IPV6_MULTICAST_ADDRESS_SOURCE: windows_core::HRESULT = 0xC110011A_u32 as _;
pub const WDSTPTMGMT_E_INVALID_IP_ADDRESS: windows_core::HRESULT = 0xC1100116_u32 as _;
pub const WDSTPTMGMT_E_INVALID_MULTISTREAM_STREAM_COUNT: windows_core::HRESULT = 0xC110011B_u32 as _;
pub const WDSTPTMGMT_E_INVALID_NAMESPACE_DATA: windows_core::HRESULT = 0xC110010B_u32 as _;
pub const WDSTPTMGMT_E_INVALID_NAMESPACE_NAME: windows_core::HRESULT = 0xC110010A_u32 as _;
pub const WDSTPTMGMT_E_INVALID_NAMESPACE_START_PARAMETERS: windows_core::HRESULT = 0xC1100112_u32 as _;
pub const WDSTPTMGMT_E_INVALID_NAMESPACE_START_TIME: windows_core::HRESULT = 0xC110010D_u32 as _;
pub const WDSTPTMGMT_E_INVALID_OPERATION: windows_core::HRESULT = 0xC1100101_u32 as _;
pub const WDSTPTMGMT_E_INVALID_PROPERTY: windows_core::HRESULT = 0xC1100100_u32 as _;
pub const WDSTPTMGMT_E_INVALID_SERVICE_IP_ADDRESS_RANGE: windows_core::HRESULT = 0xC1100110_u32 as _;
pub const WDSTPTMGMT_E_INVALID_SERVICE_PORT_RANGE: windows_core::HRESULT = 0xC1100111_u32 as _;
pub const WDSTPTMGMT_E_INVALID_SLOW_CLIENT_HANDLING_TYPE: windows_core::HRESULT = 0xC110011E_u32 as _;
pub const WDSTPTMGMT_E_INVALID_TFTP_MAX_BLOCKSIZE: windows_core::HRESULT = 0xC1100123_u32 as _;
pub const WDSTPTMGMT_E_IPV6_NOT_SUPPORTED: windows_core::HRESULT = 0xC1100119_u32 as _;
pub const WDSTPTMGMT_E_MULTICAST_SESSION_POLICY_NOT_SUPPORTED: windows_core::HRESULT = 0xC110011D_u32 as _;
pub const WDSTPTMGMT_E_NAMESPACE_ALREADY_REGISTERED: windows_core::HRESULT = 0xC1100107_u32 as _;
pub const WDSTPTMGMT_E_NAMESPACE_NOT_ON_SERVER: windows_core::HRESULT = 0xC1100114_u32 as _;
pub const WDSTPTMGMT_E_NAMESPACE_NOT_REGISTERED: windows_core::HRESULT = 0xC1100108_u32 as _;
pub const WDSTPTMGMT_E_NAMESPACE_READ_ONLY: windows_core::HRESULT = 0xC110010C_u32 as _;
pub const WDSTPTMGMT_E_NAMESPACE_REMOVED_FROM_SERVER: windows_core::HRESULT = 0xC1100115_u32 as _;
pub const WDSTPTMGMT_E_NETWORK_PROFILES_NOT_SUPPORTED: windows_core::HRESULT = 0xC110011F_u32 as _;
pub const WDSTPTMGMT_E_TFTP_MAX_BLOCKSIZE_NOT_SUPPORTED: windows_core::HRESULT = 0xC1100121_u32 as _;
pub const WDSTPTMGMT_E_TFTP_VAR_WINDOW_NOT_SUPPORTED: windows_core::HRESULT = 0xC1100122_u32 as _;
pub const WDSTPTMGMT_E_TRANSPORT_SERVER_ROLE_NOT_CONFIGURED: windows_core::HRESULT = 0xC1100106_u32 as _;
pub const WDSTPTMGMT_E_TRANSPORT_SERVER_UNAVAILABLE: windows_core::HRESULT = 0xC1100113_u32 as _;
pub const WDSTPTMGMT_E_UDP_PORT_POLICY_NOT_SUPPORTED: windows_core::HRESULT = 0xC1100120_u32 as _;
