...
pub const CI_E_CORRUPT_FWIDX: windows_core::HRESULT = 0xC004182D_u32 as _;
pub const CI_E_DIACRITIC_SETTINGS_DIFFER: windows_core::HRESULT = 0xC004182E_u32 as _;
pub const CI_E_INCONSISTENT_TRANSACTION: windows_core::HRESULT = 0xC0041832_u32 as _;
pub const CI_E_INVALID_CATALOG_LIST_VERSION: windows_core::HRESULT = 0x8004182F_u32 as _;
pub const CI_E_MULTIPLE_PROTECTED_USERS_UNSUPPORTED: windows_core::HRESULT = 0xC0041835_u32 as _;
pub const CI_E_NO_AUXMETADATA: windows_core::HRESULT = 0x8004182A_u32 as _;
pub const CI_E_NO_CATALOG_MANAGER: windows_core::HRESULT = 0xC0041831_u32 as _;
pub const CI_E_NO_PROTECTED_USER: windows_core::HRESULT = 0xC0041834_u32 as _;
pub const CI_E_PROTECTED_CATALOG_NON_INTERACTIVE_USER: windows_core::HRESULT = 0xC0041837_u32 as _;
pub const CI_E_PROTECTED_CATALOG_NOT_AVAILABLE: windows_core::HRESULT = 0xC0041833_u32 as _;
pub const CI_E_PROTECTED_CATALOG_SID_MISMATCH: windows_core::HRESULT = 0xC0041836_u32 as _;
pub const CI_S_CATALOG_RESET: windows_core::HRESULT = 0x41830_u32 as _;
pub const CI_S_CLIENT_REQUESTED_ABORT: windows_core::HRESULT = 0x4182B_u32 as _;
pub const CI_S_NEW_AUXMETADATA: windows_core::HRESULT = 0x41829_u32 as _;
pub const CI_S_RETRY_DOCUMENT: windows_core::HRESULT = 0x4182C_u32 as _;
...
pub const DB_E_ABORTLIMITREACHED: windows_core::HRESULT = 0x80040E31_u32 as _;
pub const DB_E_ALREADYINITIALIZED: windows_core::HRESULT = 0x80040E52_u32 as _;
pub const DB_E_ALTERRESTRICTED: windows_core::HRESULT = 0x80040E9D_u32 as _;
pub const DB_E_ASYNCNOTSUPPORTED: windows_core::HRESULT = 0x80040E95_u32 as _;
pub const DB_E_BADACCESSORFLAGS: windows_core::HRESULT = 0x80040E46_u32 as _;
pub const DB_E_BADACCESSORHANDLE: windows_core::HRESULT = 0x80040E00_u32 as _;
pub const DB_E_BADACCESSORTYPE: windows_core::HRESULT = 0x80040E4B_u32 as _;
pub const DB_E_BADBINDINFO: windows_core::HRESULT = 0x80040E08_u32 as _;
pub const DB_E_BADBOOKMARK: windows_core::HRESULT = 0x80040E0E_u32 as _;
pub const DB_E_BADCHAPTER: windows_core::HRESULT = 0x80040E06_u32 as _;
pub const DB_E_BADCOLUMNID: windows_core::HRESULT = 0x80040E11_u32 as _;
pub const DB_E_BADCOMMANDFLAGS: windows_core::HRESULT = 0x80040E8C_u32 as _;
pub const DB_E_BADCOMMANDID: windows_core::HRESULT = 0x80040E76_u32 as _;
pub const DB_E_BADCOMPAREOP: windows_core::HRESULT = 0x80040E27_u32 as _;
pub const DB_E_BADCONSTRAINTFORM: windows_core::HRESULT = 0x80040E78_u32 as _;
pub const DB_E_BADCONSTRAINTID: windows_core::HRESULT = 0x80040E8B_u32 as _;
pub const DB_E_BADCONSTRAINTTYPE: windows_core::HRESULT = 0x80040E77_u32 as _;
pub const DB_E_BADCONVERTFLAG: windows_core::HRESULT = 0x80040E5C_u32 as _;
pub const DB_E_BADCOPY: windows_core::HRESULT = 0x80040E39_u32 as _;
pub const DB_E_BADDEFERRABILITY: windows_core::HRESULT = 0x80040E79_u32 as _;
pub const DB_E_BADDYNAMICERRORID: windows_core::HRESULT = 0x80040E5A_u32 as _;
pub const DB_E_BADHRESULT: windows_core::HRESULT = 0x80040E58_u32 as _;
pub const DB_E_BADID: i32 = -2147217860i32;
pub const DB_E_BADINDEXID: windows_core::HRESULT = 0x80040E72_u32 as _;
pub const DB_E_BADINITSTRING: windows_core::HRESULT = 0x80040E73_u32 as _;
pub const DB_E_BADLOCKMODE: windows_core::HRESULT = 0x80040E0F_u32 as _;
pub const DB_E_BADLOOKUPID: windows_core::HRESULT = 0x80040E59_u32 as _;
pub const DB_E_BADMATCHTYPE: windows_core::HRESULT = 0x80040E80_u32 as _;
pub const DB_E_BADORDINAL: windows_core::HRESULT = 0x80040E55_u32 as _;
pub const DB_E_BADPARAMETERNAME: windows_core::HRESULT = 0x80040E5D_u32 as _;
pub const DB_E_BADPRECISION: windows_core::HRESULT = 0x80040E3A_u32 as _;
pub const DB_E_BADPROPERTYVALUE: windows_core::HRESULT = 0x80040E44_u32 as _;
pub const DB_E_BADRATIO: windows_core::HRESULT = 0x80040E12_u32 as _;
pub const DB_E_BADRECORDNUM: windows_core::HRESULT = 0x80040E42_u32 as _;
pub const DB_E_BADREGIONHANDLE: windows_core::HRESULT = 0x80040E2A_u32 as _;
pub const DB_E_BADROWHANDLE: windows_core::HRESULT = 0x80040E04_u32 as _;
pub const DB_E_BADSCALE: windows_core::HRESULT = 0x80040E3B_u32 as _;
pub const DB_E_BADSOURCEHANDLE: windows_core::HRESULT = 0x80040E50_u32 as _;
pub const DB_E_BADSTARTPOSITION: windows_core::HRESULT = 0x80040E1E_u32 as _;
pub const DB_E_BADSTATUSVALUE: windows_core::HRESULT = 0x80040E28_u32 as _;
pub const DB_E_BADSTORAGEFLAG: windows_core::HRESULT = 0x80040E26_u32 as _;
pub const DB_E_BADSTORAGEFLAGS: windows_core::HRESULT = 0x80040E47_u32 as _;
pub const DB_E_BADTABLEID: windows_core::HRESULT = 0x80040E3C_u32 as _;
pub const DB_E_BADTYPE: windows_core::HRESULT = 0x80040E3D_u32 as _;
pub const DB_E_BADTYPENAME: windows_core::HRESULT = 0x80040E30_u32 as _;
pub const DB_E_BADUPDATEDELETERULE: windows_core::HRESULT = 0x80040E8A_u32 as _;
pub const DB_E_BADVALUES: windows_core::HRESULT = 0x80040E13_u32 as _;
pub const DB_E_BOGUS: windows_core::HRESULT = 0x80040EFF_u32 as _;
pub const DB_E_BOOKMARKSKIPPED: windows_core::HRESULT = 0x80040E43_u32 as _;
pub const DB_E_BYREFACCESSORNOTSUPPORTED: windows_core::HRESULT = 0x80040E48_u32 as _;
pub const DB_E_CANCELED: windows_core::HRESULT = 0x80040E4E_u32 as _;
pub const DB_E_CANNOTCONNECT: windows_core::HRESULT = 0x80040E96_u32 as _;
pub const DB_E_CANNOTFREE: windows_core::HRESULT = 0x80040E1A_u32 as _;
pub const DB_E_CANNOTRESTART: windows_core::HRESULT = 0x80040E18_u32 as _;
pub const DB_E_CANTCANCEL: windows_core::HRESULT = 0x80040E15_u32 as _;
pub const DB_E_CANTCONVERTVALUE: windows_core::HRESULT = 0x80040E07_u32 as _;
pub const DB_E_CANTFETCHBACKWARDS: windows_core::HRESULT = 0x80040E24_u32 as _;
pub const DB_E_CANTFILTER: windows_core::HRESULT = 0x80040E5F_u32 as _;
pub const DB_E_CANTORDER: windows_core::HRESULT = 0x80040E60_u32 as _;
pub const DB_E_CANTSCROLLBACKWARDS: windows_core::HRESULT = 0x80040E29_u32 as _;
pub const DB_E_CANTTRANSLATE: windows_core::HRESULT = 0x80040E33_u32 as _;
pub const DB_E_CHAPTERNOTRELEASED: windows_core::HRESULT = 0x80040E4F_u32 as _;
pub const DB_E_COLUMNUNAVAILABLE: windows_core::HRESULT = 0x80040EA0_u32 as _;
pub const DB_E_COMMANDNOTPERSISTED: windows_core::HRESULT = 0x80040E67_u32 as _;
pub const DB_E_CONCURRENCYVIOLATION: windows_core::HRESULT = 0x80040E38_u32 as _;
pub const DB_E_COSTLIMIT: windows_core::HRESULT = 0x80040E0D_u32 as _;
pub const DB_E_DATAOVERFLOW: windows_core::HRESULT = 0x80040E57_u32 as _;
pub const DB_E_DELETEDROW: windows_core::HRESULT = 0x80040E23_u32 as _;
pub const DB_E_DIALECTNOTSUPPORTED: windows_core::HRESULT = 0x80040E16_u32 as _;
pub const DB_E_DROPRESTRICTED: windows_core::HRESULT = 0x80040E90_u32 as _;
pub const DB_E_DUPLICATECOLUMNID: windows_core::HRESULT = 0x80040E3E_u32 as _;
pub const DB_E_DUPLICATECONSTRAINTID: windows_core::HRESULT = 0x80040E99_u32 as _;
pub const DB_E_DUPLICATEDATASOURCE: windows_core::HRESULT = 0x80040E17_u32 as _;
pub const DB_E_DUPLICATEID: windows_core::HRESULT = 0x80040E68_u32 as _;
pub const DB_E_DUPLICATEINDEXID: windows_core::HRESULT = 0x80040E34_u32 as _;
pub const DB_E_DUPLICATETABLEID: windows_core::HRESULT = 0x80040E3F_u32 as _;
pub const DB_E_ERRORSINCOMMAND: windows_core::HRESULT = 0x80040E14_u32 as _;
pub const DB_E_ERRORSOCCURRED: windows_core::HRESULT = 0x80040E21_u32 as _;
pub const DB_E_GOALREJECTED: windows_core::HRESULT = 0x80040E1C_u32 as _;
pub const DB_E_INDEXINUSE: windows_core::HRESULT = 0x80040E36_u32 as _;
pub const DB_E_INTEGRITYVIOLATION: windows_core::HRESULT = 0x80040E2F_u32 as _;
pub const DB_E_INVALID: windows_core::HRESULT = 0x80040E45_u32 as _;
pub const DB_E_INVALIDTRANSITION: windows_core::HRESULT = 0x80040E2C_u32 as _;
pub const DB_E_LIMITREJECTED: windows_core::HRESULT = 0x80040E0B_u32 as _;
pub const DB_E_MAXPENDCHANGESEXCEEDED: windows_core::HRESULT = 0x80040E54_u32 as _;
pub const DB_E_MISMATCHEDPROVIDER: windows_core::HRESULT = 0x80040E75_u32 as _;
pub const DB_E_MULTIPLESTATEMENTS: windows_core::HRESULT = 0x80040E2E_u32 as _;
pub const DB_E_MULTIPLESTORAGE: windows_core::HRESULT = 0x80040E5E_u32 as _;
pub const DB_E_NEWLYINSERTED: windows_core::HRESULT = 0x80040E1B_u32 as _;
pub const DB_E_NOAGGREGATION: windows_core::HRESULT = 0x80040E22_u32 as _;
pub const DB_E_NOCOLUMN: windows_core::HRESULT = 0x80040E65_u32 as _;
pub const DB_E_NOCOMMAND: windows_core::HRESULT = 0x80040E0C_u32 as _;
pub const DB_E_NOCONSTRAINT: windows_core::HRESULT = 0x80040E9F_u32 as _;
pub const DB_E_NOINDEX: windows_core::HRESULT = 0x80040E35_u32 as _;
pub const DB_E_NOLOCALE: windows_core::HRESULT = 0x80040E41_u32 as _;
pub const DB_E_NONCONTIGUOUSRANGE: windows_core::HRESULT = 0x80040E2B_u32 as _;
pub const DB_E_NOPROVIDERSREGISTERED: windows_core::HRESULT = 0x80040E74_u32 as _;
pub const DB_E_NOQUERY: windows_core::HRESULT = 0x80040E1F_u32 as _;
pub const DB_E_NOSOURCEOBJECT: windows_core::HRESULT = 0x80040E91_u32 as _;
pub const DB_E_NOSTATISTIC: windows_core::HRESULT = 0x80040E9C_u32 as _;
pub const DB_E_NOTABLE: windows_core::HRESULT = 0x80040E37_u32 as _;
pub const DB_E_NOTAREFERENCECOLUMN: windows_core::HRESULT = 0x80040E0A_u32 as _;
pub const DB_E_NOTASUBREGION: windows_core::HRESULT = 0x80040E2D_u32 as _;
pub const DB_E_NOTCOLLECTION: windows_core::HRESULT = 0x80040E93_u32 as _;
pub const DB_E_NOTFOUND: windows_core::HRESULT = 0x80040E19_u32 as _;
pub const DB_E_NOTPREPARED: windows_core::HRESULT = 0x80040E4A_u32 as _;
pub const DB_E_NOTREENTRANT: windows_core::HRESULT = 0x80040E20_u32 as _;
pub const DB_E_NOTSUPPORTED: windows_core::HRESULT = 0x80040E53_u32 as _;
pub const DB_E_NULLACCESSORNOTSUPPORTED: windows_core::HRESULT = 0x80040E49_u32 as _;
pub const DB_E_OBJECTCREATIONLIMITREACHED: windows_core::HRESULT = 0x80040E69_u32 as _;
pub const DB_E_OBJECTMISMATCH: windows_core::HRESULT = 0x80040E8D_u32 as _;
pub const DB_E_OBJECTOPEN: windows_core::HRESULT = 0x80040E05_u32 as _;
pub const DB_E_OUTOFSPACE: windows_core::HRESULT = 0x80040E9A_u32 as _;
pub const DB_E_PARAMNOTOPTIONAL: windows_core::HRESULT = 0x80040E10_u32 as _;
pub const DB_E_PARAMUNAVAILABLE: windows_core::HRESULT = 0x80040E51_u32 as _;
pub const DB_E_PENDINGCHANGES: windows_core::HRESULT = 0x80040E56_u32 as _;
pub const DB_E_PENDINGINSERT: windows_core::HRESULT = 0x80040E5B_u32 as _;
pub const DB_E_READONLY: windows_core::HRESULT = 0x80040E94_u32 as _;
pub const DB_E_READONLYACCESSOR: windows_core::HRESULT = 0x80040E02_u32 as _;
pub const DB_E_RESOURCEEXISTS: windows_core::HRESULT = 0x80040E98_u32 as _;
pub const DB_E_RESOURCELOCKED: windows_core::HRESULT = 0x80040E92_u32 as _;
pub const DB_E_RESOURCENOTSUPPORTED: windows_core::HRESULT = 0x80040E9E_u32 as _;
pub const DB_E_RESOURCEOUTOFSCOPE: windows_core::HRESULT = 0x80040E8E_u32 as _;
pub const DB_E_ROWLIMITEXCEEDED: windows_core::HRESULT = 0x80040E01_u32 as _;
pub const DB_E_ROWSETINCOMMAND: windows_core::HRESULT = 0x80040E32_u32 as _;
pub const DB_E_ROWSNOTRELEASED: windows_core::HRESULT = 0x80040E25_u32 as _;
pub const DB_E_SCHEMAVIOLATION: windows_core::HRESULT = 0x80040E03_u32 as _;
pub const DB_E_TABLEINUSE: windows_core::HRESULT = 0x80040E40_u32 as _;
pub const DB_E_TIMEOUT: windows_core::HRESULT = 0x80040E97_u32 as _;
pub const DB_E_UNSUPPORTEDCONVERSION: windows_core::HRESULT = 0x80040E1D_u32 as _;
pub const DB_E_WRITEONLYACCESSOR: windows_core::HRESULT = 0x80040E4C_u32 as _;
...
pub const DB_SEC_E_AUTH_FAILED: windows_core::HRESULT = 0x80040E4D_u32 as _;
pub const DB_SEC_E_PERMISSIONDENIED: windows_core::HRESULT = 0x80040E09_u32 as _;
pub const DB_SEC_E_SAFEMODE_DENIED: windows_core::HRESULT = 0x80040E9B_u32 as _;
pub const DB_S_ASYNCHRONOUS: windows_core::HRESULT = 0x40ED0_u32 as _;
pub const DB_S_BADROWHANDLE: windows_core::HRESULT = 0x40ED3_u32 as _;
pub const DB_S_BOOKMARKSKIPPED: windows_core::HRESULT = 0x40EC3_u32 as _;
pub const DB_S_BUFFERFULL: windows_core::HRESULT = 0x40EC8_u32 as _;
pub const DB_S_CANTRELEASE: windows_core::HRESULT = 0x40ECA_u32 as _;
pub const DB_S_COLUMNSCHANGED: windows_core::HRESULT = 0x40ED1_u32 as _;
pub const DB_S_COLUMNTYPEMISMATCH: windows_core::HRESULT = 0x40EC1_u32 as _;
pub const DB_S_COMMANDREEXECUTED: windows_core::HRESULT = 0x40EC7_u32 as _;
pub const DB_S_DELETEDROW: windows_core::HRESULT = 0x40ED4_u32 as _;
pub const DB_S_DIALECTIGNORED: windows_core::HRESULT = 0x40ECD_u32 as _;
pub const DB_S_ENDOFROWSET: windows_core::HRESULT = 0x40EC6_u32 as _;
pub const DB_S_ERRORSOCCURRED: windows_core::HRESULT = 0x40EDA_u32 as _;
pub const DB_S_ERRORSRETURNED: windows_core::HRESULT = 0x40ED2_u32 as _;
pub const DB_S_GOALCHANGED: windows_core::HRESULT = 0x40ECB_u32 as _;
pub const DB_S_LOCKUPGRADED: windows_core::HRESULT = 0x40ED8_u32 as _;
pub const DB_S_MULTIPLECHANGES: windows_core::HRESULT = 0x40EDC_u32 as _;
pub const DB_S_NONEXTROWSET: windows_core::HRESULT = 0x40EC5_u32 as _;
pub const DB_S_NORESULT: windows_core::HRESULT = 0x40EC9_u32 as _;
pub const DB_S_NOROWSPECIFICCOLUMNS: windows_core::HRESULT = 0x40EDD_u32 as _;
pub const DB_S_NOTSINGLETON: windows_core::HRESULT = 0x40ED7_u32 as _;
pub const DB_S_PARAMUNAVAILABLE: windows_core::HRESULT = 0x40EDB_u32 as _;
pub const DB_S_PROPERTIESCHANGED: windows_core::HRESULT = 0x40ED9_u32 as _;
pub const DB_S_ROWLIMITEXCEEDED: windows_core::HRESULT = 0x40EC0_u32 as _;
pub const DB_S_STOPLIMITREACHED: windows_core::HRESULT = 0x40ED6_u32 as _;
pub const DB_S_TOOMANYCHANGES: windows_core::HRESULT = 0x40ED5_u32 as _;
pub const DB_S_TYPEINFOOVERRIDDEN: windows_core::HRESULT = 0x40EC2_u32 as _;
pub const DB_S_UNWANTEDOPERATION: windows_core::HRESULT = 0x40ECC_u32 as _;
pub const DB_S_UNWANTEDPHASE: windows_core::HRESULT = 0x40ECE_u32 as _;
pub const DB_S_UNWANTEDREASON: windows_core::HRESULT = 0x40ECF_u32 as _;
...
pub const IDS_MON_BUILTIN_PROPERTY: windows_core::HRESULT = 0x4093F_u32 as _;
pub const IDS_MON_BUILTIN_VIEW: windows_core::HRESULT = 0x40937_u32 as _;
pub const IDS_MON_CANNOT_CAST: windows_core::HRESULT = 0x40946_u32 as _;
pub const IDS_MON_CANNOT_CONVERT: windows_core::HRESULT = 0x4093B_u32 as _;
pub const IDS_MON_COLUMN_NOT_DEFINED: windows_core::HRESULT = 0x40936_u32 as _;
pub const IDS_MON_DATE_OUT_OF_RANGE: windows_core::HRESULT = 0x40947_u32 as _;
pub const IDS_MON_DEFAULT_ERROR: windows_core::HRESULT = 0x4092F_u32 as _;
pub const IDS_MON_ILLEGAL_PASSTHROUGH: windows_core::HRESULT = 0x40930_u32 as _;
pub const IDS_MON_INVALIDSELECT_COALESCE: windows_core::HRESULT = 0x40945_u32 as _;
pub const IDS_MON_INVALID_CATALOG: windows_core::HRESULT = 0x40944_u32 as _;
pub const IDS_MON_INVALID_IN_GROUP_CLAUSE: windows_core::HRESULT = 0x40948_u32 as _;
pub const IDS_MON_MATCH_STRING: windows_core::HRESULT = 0x40941_u32 as _;
pub const IDS_MON_NOT_COLUMN_OF_VIEW: windows_core::HRESULT = 0x4093E_u32 as _;
pub const IDS_MON_ORDINAL_OUT_OF_RANGE: windows_core::HRESULT = 0x40934_u32 as _;
pub const IDS_MON_OR_NOT: windows_core::HRESULT = 0x4093A_u32 as _;
pub const IDS_MON_OUT_OF_MEMORY: windows_core::HRESULT = 0x40938_u32 as _;
pub const IDS_MON_OUT_OF_RANGE: windows_core::HRESULT = 0x4093C_u32 as _;
pub const IDS_MON_PARSE_ERR_1_PARAM: windows_core::HRESULT = 0x40931_u32 as _;
pub const IDS_MON_PARSE_ERR_2_PARAM: windows_core::HRESULT = 0x40932_u32 as _;
pub const IDS_MON_PROPERTY_NAME_IN_VIEW: windows_core::HRESULT = 0x40942_u32 as _;
pub const IDS_MON_RELATIVE_INTERVAL: windows_core::HRESULT = 0x4093D_u32 as _;
pub const IDS_MON_SELECT_STAR: windows_core::HRESULT = 0x40939_u32 as _;
pub const IDS_MON_SEMI_COLON: windows_core::HRESULT = 0x40933_u32 as _;
pub const IDS_MON_VIEW_ALREADY_DEFINED: windows_core::HRESULT = 0x40943_u32 as _;
pub const IDS_MON_VIEW_NOT_DEFINED: windows_core::HRESULT = 0x40935_u32 as _;
pub const IDS_MON_WEIGHT_OUT_OF_RANGE: windows_core::HRESULT = 0x40940_u32 as _;
...
pub const INET_E_AGENT_CACHE_SIZE_EXCEEDED: windows_core::HRESULT = 0x800C0F82_u32 as _;
pub const INET_E_AGENT_CONNECTION_FAILED: windows_core::HRESULT = 0x800C0F83_u32 as _;
pub const INET_E_AGENT_EXCEEDING_CACHE_SIZE: windows_core::HRESULT = 0x800C0F90_u32 as _;
pub const INET_E_AGENT_MAX_SIZE_EXCEEDED: windows_core::HRESULT = 0x800C0F80_u32 as _;
pub const INET_E_SCHEDULED_EXCLUDE_RANGE: windows_core::HRESULT = 0x800C0F87_u32 as _;
pub const INET_E_SCHEDULED_UPDATES_DISABLED: windows_core::HRESULT = 0x800C0F84_u32 as _;
pub const INET_E_SCHEDULED_UPDATES_RESTRICTED: windows_core::HRESULT = 0x800C0F85_u32 as _;
pub const INET_E_SCHEDULED_UPDATE_INTERVAL: windows_core::HRESULT = 0x800C0F86_u32 as _;
pub const INET_S_AGENT_INCREASED_CACHE_SIZE: windows_core::HRESULT = 0xC0F90_u32 as _;
pub const INET_S_AGENT_PART_FAIL: windows_core::HRESULT = 0xC0F81_u32 as _;
...
pub const MD_E_BADCOORDINATE: windows_core::HRESULT = 0x80040E62_u32 as _;
pub const MD_E_BADTUPLE: windows_core::HRESULT = 0x80040E61_u32 as _;
pub const MD_E_INVALIDAXIS: windows_core::HRESULT = 0x80040E63_u32 as _;
pub const MD_E_INVALIDCELLRANGE: windows_core::HRESULT = 0x80040E64_u32 as _;
pub const MINFATALERR: u32 = 20u32;
pub const MIN_USER_DATATYPE: u32 = 256u32;
pub const MSG_CI_CORRUPT_INDEX_COMPONENT: windows_core::HRESULT = 0x4000102A_u32 as _;
pub const MSG_CI_CREATE_SEVER_ITEM_FAILED: windows_core::HRESULT = 0x80001048_u32 as _;
pub const MSG_CI_MASTER_MERGE_ABORTED: windows_core::HRESULT = 0x40001008_u32 as _;
pub const MSG_CI_MASTER_MERGE_ABORTED_LOW_DISK: windows_core::HRESULT = 0x40001043_u32 as _;
pub const MSG_CI_MASTER_MERGE_CANT_RESTART: windows_core::HRESULT = 0xC000100A_u32 as _;
pub const MSG_CI_MASTER_MERGE_CANT_START: windows_core::HRESULT = 0xC0001009_u32 as _;
pub const MSG_CI_MASTER_MERGE_COMPLETED: windows_core::HRESULT = 0x40001007_u32 as _;
pub const MSG_CI_MASTER_MERGE_REASON_EXPECTED_DOCS: windows_core::HRESULT = 0x40001046_u32 as _;
pub const MSG_CI_MASTER_MERGE_REASON_EXTERNAL: windows_core::HRESULT = 0x40001044_u32 as _;
pub const MSG_CI_MASTER_MERGE_REASON_INDEX_LIMIT: windows_core::HRESULT = 0x40001045_u32 as _;
pub const MSG_CI_MASTER_MERGE_REASON_NUMBER: windows_core::HRESULT = 0x40001047_u32 as _;
pub const MSG_CI_MASTER_MERGE_RESTARTED: windows_core::HRESULT = 0x40001019_u32 as _;
pub const MSG_CI_MASTER_MERGE_STARTED: windows_core::HRESULT = 0x40001006_u32 as _;
...
pub const NOT_N_PARSE_ERROR: windows_core::HRESULT = 0x8092E_u32 as _;
...
pub const QUERY_E_AGGREGATE_NOT_SUPPORTED: windows_core::HRESULT = 0x80041619_u32 as _;
pub const QUERY_E_ALLNOISE_AND_NO_RELDOC: windows_core::HRESULT = 0x8004160D_u32 as _;
pub const QUERY_E_ALLNOISE_AND_NO_RELPROP: windows_core::HRESULT = 0x8004160F_u32 as _;
pub const QUERY_E_DUPLICATE_RANGE_NAME: windows_core::HRESULT = 0x8004161B_u32 as _;
pub const QUERY_E_INCORRECT_VERSION: windows_core::HRESULT = 0x80041614_u32 as _;
pub const QUERY_E_INVALIDCOALESCE: windows_core::HRESULT = 0x80041617_u32 as _;
pub const QUERY_E_INVALIDSCOPE_COALESCE: windows_core::HRESULT = 0x80041615_u32 as _;
pub const QUERY_E_INVALIDSORT_COALESCE: windows_core::HRESULT = 0x80041616_u32 as _;
pub const QUERY_E_INVALID_DOCUMENT_IDENTIFIER: windows_core::HRESULT = 0x80041613_u32 as _;
pub const QUERY_E_NO_RELDOC: windows_core::HRESULT = 0x8004160E_u32 as _;
pub const QUERY_E_NO_RELPROP: windows_core::HRESULT = 0x80041610_u32 as _;
pub const QUERY_E_RELDOC_SYNTAX_NOT_SUPPORTED: windows_core::HRESULT = 0x80041612_u32 as _;
pub const QUERY_E_REPEATED_RELDOC: windows_core::HRESULT = 0x80041611_u32 as _;
pub const QUERY_E_TOP_LEVEL_IN_GROUP: windows_core::HRESULT = 0x8004161A_u32 as _;
pub const QUERY_E_UPGRADEINPROGRESS: windows_core::HRESULT = 0x80041618_u32 as _;
...
pub const SEC_E_BADTRUSTEEID: windows_core::HRESULT = 0x80040E6A_u32 as _;
pub const SEC_E_INITFAILED: i32 = -2147216383i32;
pub const SEC_E_INVALIDACCESSENTRY: windows_core::HRESULT = 0x80040E71_u32 as _;
pub const SEC_E_INVALIDACCESSENTRYLIST: windows_core::HRESULT = 0x80040E6F_u32 as _;
pub const SEC_E_INVALIDCONTEXT: i32 = -2147216381i32;
pub const SEC_E_INVALIDOBJECT: windows_core::HRESULT = 0x80040E6D_u32 as _;
pub const SEC_E_INVALIDOWNER: windows_core::HRESULT = 0x80040E70_u32 as _;
pub const SEC_E_NOMEMBERSHIPSUPPORT: windows_core::HRESULT = 0x80040E6C_u32 as _;
pub const SEC_E_NOOWNER: windows_core::HRESULT = 0x80040E6E_u32 as _;
pub const SEC_E_NOTINITIALIZED: i32 = -2147216382i32;
pub const SEC_E_NOTRUSTEEID: windows_core::HRESULT = 0x80040E6B_u32 as _;
...
#[repr(C)]
#[cfg(all(feature = "Win32_Storage_IndexServer", feature = "Win32_System_Com", feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub struct DBBINDING {
    ...
    pub obLength: usize,
    pub obStatus: usize,
    pub pTypeInfo: Option<super::Com::ITypeInfo>,
...
pub struct DBIMPLICITSESSION {
    pub pUnkOuter: Option<windows_core::IUnknown>,
    pub piid: *mut windows_core::GUID,
    pub pSession: Option<windows_core::IUnknown>,
}
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct RMTPACK {
    pub pISeqStream: Option<super::Com::ISequentialStream>,
    pub cbData: u32,
    pub cBSTR: u32,
...
pub struct SUBSCRIPTIONINFO {
    ...
    pub bstrUserName: windows_core::BSTR,
    pub bstrPassword: windows_core::BSTR,
    pub bstrFriendlyName: windows_core::BSTR,
    pub dwMaxSizeKB: u32,
