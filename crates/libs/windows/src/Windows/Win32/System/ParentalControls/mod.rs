...
impl IWindowsParentalControls {
    ...
    pub unsafe fn GetWebFilterInfo(&self, pguidid: &mut ::windows::core::GUID, ppszname: ::core::option::Option<&mut ::windows::core::PWSTR>) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.GetWebFilterInfo)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(pguidid), ::core::mem::transmute(ppszname)).ok()
    }
...
impl IWindowsParentalControlsCore {
    ...
    pub unsafe fn GetWebFilterInfo(&self, pguidid: &mut ::windows::core::GUID, ppszname: ::core::option::Option<&mut ::windows::core::PWSTR>) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).GetWebFilterInfo)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(pguidid), ::core::mem::transmute(ppszname)).ok()
    }
}
