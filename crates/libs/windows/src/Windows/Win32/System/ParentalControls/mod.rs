...
impl IWPCWebSettings {
    ...
    #[doc = "*Required features: 'Win32_System_ParentalControls', 'Win32_Foundation'*"]
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn RequestURLOverride<'a, Param0: ::windows::core::IntoParam<'a, super::super::Foundation::HWND>, Param1: ::windows::core::IntoParam<'a, ::windows::core::PCWSTR>>(&self, hwnd: Param0, pcszurl: Param1, ppcszsuburls: ::core::option::Option<&[::windows::core::PWSTR]>) -> ::windows::core::Result<super::super::Foundation::BOOL> {
        let mut result__: super::super::Foundation::BOOL = ::core::mem::zeroed();
        (::windows::core::Interface::vtable(self).RequestURLOverride)(::core::mem::transmute_copy(self), hwnd.into_param().abi(), pcszurl.into_param().abi(), ppcszsuburls.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(ppcszsuburls.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), ::core::mem::transmute(&mut result__)).from_abi::<super::super::Foundation::BOOL>(result__)
    }
}
