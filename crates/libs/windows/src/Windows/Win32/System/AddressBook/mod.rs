...
impl IMAPIStatus {
    ...
    pub unsafe fn FlushQueues(&self, uluiparam: usize, lptargettransport: &[ENTRYID], ulflags: u32) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).FlushQueues)(::core::mem::transmute_copy(self), ::core::mem::transmute(uluiparam), lptargettransport.len() as _, ::core::mem::transmute(lptargettransport.as_ptr()), ::core::mem::transmute(ulflags)).ok()
    }
}
