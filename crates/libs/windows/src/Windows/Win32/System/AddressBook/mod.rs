...
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn OpenStreamOnFile(lpallocatebuffer: LPALLOCATEBUFFER, lpfreebuffer: LPFREEBUFFER, ulflags: u32, lpszfilename: &i8, lpszprefix: ::core::option::Option<&i8>) -> ::windows::core::Result<super::Com::IStream> {
    #[cfg_attr(windows, link(name = "windows"))]
    extern "system" {
...
#[doc = "*Required features: `\"Win32_System_AddressBook\"`*"]
#[inline]
pub unsafe fn WrapStoreEntryID(ulflags: u32, lpszdllname: &i8, lporigentry: &[u8], lpcbwrappedentry: &mut u32, lppwrappedentry: *mut *mut ENTRYID) -> ::windows::core::Result<()> {
    #[cfg_attr(windows, link(name = "windows"))]
    extern "system" {
    ...
    WrapStoreEntryID(ulflags, ::core::mem::transmute(lpszdllname), lporigentry.len() as _, ::core::mem::transmute(lporigentry.as_ptr()), ::core::mem::transmute(lpcbwrappedentry), ::core::mem::transmute(lppwrappedentry)).ok()
}
#[doc = "*Required features: `\"Win32_System_AddressBook\"`*"]
#[repr(transparent)]
...
impl IABContainer {
    ...
    pub unsafe fn OpenEntry(&self, lpentryid: &[u8], lpinterface: &mut ::windows::core::GUID, ulflags: u32, lpulobjtype: &mut u32, lppunk: &mut ::core::option::Option<::windows::core::IUnknown>) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.OpenEntry)(::windows::core::Vtable::as_raw(self), lpentryid.len() as _, ::core::mem::transmute(lpentryid.as_ptr()), ::core::mem::transmute(lpinterface), ulflags, ::core::mem::transmute(lpulobjtype), ::core::mem::transmute(lppunk)).ok()
    }
    #[doc = "*Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`*"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com"))]
    pub unsafe fn SetSearchCriteria(&self, lprestriction: ::core::option::Option<&SRestriction>, lpcontainerlist: ::core::option::Option<&SBinaryArray>, ulsearchflags: u32) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.SetSearchCriteria)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(lprestriction), ::core::mem::transmute(lpcontainerlist), ulsearchflags).ok()
    }
    #[doc = "*Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`*"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com"))]
    pub unsafe fn GetSearchCriteria(&self, ulflags: u32, lpprestriction: ::core::option::Option<&mut *mut SRestriction>, lppcontainerlist: ::core::option::Option<&mut *mut SBinaryArray>, lpulsearchstate: ::core::option::Option<&mut u32>) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.GetSearchCriteria)(::windows::core::Vtable::as_raw(self), ulflags, ::core::mem::transmute(lpprestriction), ::core::mem::transmute(lppcontainerlist), ::core::mem::transmute(lpulsearchstate)).ok()
    }
    pub unsafe fn CreateEntry(&self, lpentryid: &[u8], ulcreateflags: u32) -> ::windows::core::Result<IMAPIProp> {
        let mut result__ = ::core::mem::MaybeUninit::zeroed();
        (::windows::core::Vtable::vtable(self).CreateEntry)(::windows::core::Vtable::as_raw(self), lpentryid.len() as _, ::core::mem::transmute(lpentryid.as_ptr()), ulcreateflags, ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<IMAPIProp>(result__)
    }
    pub unsafe fn CopyEntries<'a, P0>(&self, lpentries: &SBinaryArray, uluiparam: usize, lpprogress: P0, ulflags: u32) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, IMAPIProgress>>,
    {
    ...
    pub unsafe fn DeleteEntries(&self, lpentries: &SBinaryArray, ulflags: u32) -> ::windows::core::Result<()> {
    ...
    pub unsafe fn ResolveNames(&self, lpproptagarray: ::core::option::Option<&SPropTagArray>, ulflags: u32, lpadrlist: &ADRLIST) -> ::windows::core::Result<FlagList> {
        let mut result__ = ::core::mem::MaybeUninit::zeroed();
        (::windows::core::Vtable::vtable(self).ResolveNames)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(lpproptagarray), ulflags, ::core::mem::transmute(lpadrlist), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<FlagList>(result__)
    }
}
...
impl IMAPIContainer {
    ...
    pub unsafe fn OpenEntry(&self, lpentryid: &[u8], lpinterface: &mut ::windows::core::GUID, ulflags: u32, lpulobjtype: &mut u32, lppunk: &mut ::core::option::Option<::windows::core::IUnknown>) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).OpenEntry)(::windows::core::Vtable::as_raw(self), lpentryid.len() as _, ::core::mem::transmute(lpentryid.as_ptr()), ::core::mem::transmute(lpinterface), ulflags, ::core::mem::transmute(lpulobjtype), ::core::mem::transmute(lppunk)).ok()
    }
    #[doc = "*Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`*"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com"))]
    pub unsafe fn SetSearchCriteria(&self, lprestriction: ::core::option::Option<&SRestriction>, lpcontainerlist: ::core::option::Option<&SBinaryArray>, ulsearchflags: u32) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).SetSearchCriteria)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(lprestriction), ::core::mem::transmute(lpcontainerlist), ulsearchflags).ok()
    }
    #[doc = "*Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`*"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com"))]
    pub unsafe fn GetSearchCriteria(&self, ulflags: u32, lpprestriction: ::core::option::Option<&mut *mut SRestriction>, lppcontainerlist: ::core::option::Option<&mut *mut SBinaryArray>, lpulsearchstate: ::core::option::Option<&mut u32>) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).GetSearchCriteria)(::windows::core::Vtable::as_raw(self), ulflags, ::core::mem::transmute(lpprestriction), ::core::mem::transmute(lppcontainerlist), ::core::mem::transmute(lpulsearchstate)).ok()
    }
}
...
impl IMAPIFolder {
    ...
    pub unsafe fn CopyMessages<'a, P0>(&self, lpmsglist: &SBinaryArray, lpinterface: ::core::option::Option<&::windows::core::GUID>, lpdestfolder: *const ::core::ffi::c_void, uluiparam: usize, lpprogress: P0, ulflags: u32) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, IMAPIProgress>>,
    {
        (::windows::core::Vtable::vtable(self).CopyMessages)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(lpmsglist), ::core::mem::transmute(lpinterface), ::core::mem::transmute(lpdestfolder), uluiparam, lpprogress.into().abi(), ulflags).ok()
    }
    pub unsafe fn DeleteMessages<'a, P0>(&self, lpmsglist: &SBinaryArray, uluiparam: usize, lpprogress: P0, ulflags: u32) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, IMAPIProgress>>,
    {
    ...
    pub unsafe fn CreateFolder(&self, ulfoldertype: u32, lpszfoldername: &i8, lpszfoldercomment: ::core::option::Option<&i8>, lpinterface: ::core::option::Option<&::windows::core::GUID>, ulflags: u32) -> ::windows::core::Result<IMAPIFolder> {
        let mut result__ = ::core::mem::MaybeUninit::zeroed();
        (::windows::core::Vtable::vtable(self).CreateFolder)(::windows::core::Vtable::as_raw(self), ulfoldertype, ::core::mem::transmute(lpszfoldername), ::core::mem::transmute(lpszfoldercomment), ::core::mem::transmute(lpinterface), ulflags, ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<IMAPIFolder>(result__)
    }
    pub unsafe fn CopyFolder<'a, P0>(&self, lpentryid: &[u8], lpinterface: ::core::option::Option<&::windows::core::GUID>, lpdestfolder: *const ::core::ffi::c_void, lpsznewfoldername: &i8, uluiparam: usize, lpprogress: P0, ulflags: u32) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, IMAPIProgress>>,
    {
        (::windows::core::Vtable::vtable(self).CopyFolder)(::windows::core::Vtable::as_raw(self), lpentryid.len() as _, ::core::mem::transmute(lpentryid.as_ptr()), ::core::mem::transmute(lpinterface), ::core::mem::transmute(lpdestfolder), ::core::mem::transmute(lpsznewfoldername), uluiparam, lpprogress.into().abi(), ulflags).ok()
    }
    pub unsafe fn DeleteFolder<'a, P0>(&self, lpentryid: &[u8], uluiparam: usize, lpprogress: P0, ulflags: u32) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, IMAPIProgress>>,
    {
        (::windows::core::Vtable::vtable(self).DeleteFolder)(::windows::core::Vtable::as_raw(self), lpentryid.len() as _, ::core::mem::transmute(lpentryid.as_ptr()), uluiparam, lpprogress.into().abi(), ulflags).ok()
    }
    pub unsafe fn SetReadFlags<'a, P0>(&self, lpmsglist: &SBinaryArray, uluiparam: usize, lpprogress: P0, ulflags: u32) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, IMAPIProgress>>,
    {
    ...
    pub unsafe fn GetMessageStatus(&self, lpentryid: &[u8], ulflags: u32) -> ::windows::core::Result<u32> {
        let mut result__ = ::core::mem::MaybeUninit::zeroed();
        (::windows::core::Vtable::vtable(self).GetMessageStatus)(::windows::core::Vtable::as_raw(self), lpentryid.len() as _, ::core::mem::transmute(lpentryid.as_ptr()), ulflags, ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<u32>(result__)
    }
    pub unsafe fn SetMessageStatus(&self, lpentryid: &[u8], ulnewstatus: u32, ulnewstatusmask: u32) -> ::windows::core::Result<u32> {
        let mut result__ = ::core::mem::MaybeUninit::zeroed();
        (::windows::core::Vtable::vtable(self).SetMessageStatus)(::windows::core::Vtable::as_raw(self), lpentryid.len() as _, ::core::mem::transmute(lpentryid.as_ptr()), ulnewstatus, ulnewstatusmask, ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<u32>(result__)
    }
    pub unsafe fn SaveContentsSort(&self, lpsortcriteria: &SSortOrderSet, ulflags: u32) -> ::windows::core::Result<()> {
...
impl IMAPIStatus {
    ...
    pub unsafe fn ChangePassword(&self, lpoldpass: &i8, lpnewpass: &i8, ulflags: u32) -> ::windows::core::Result<()> {
...
impl IMessage {
    ...
    pub unsafe fn OpenAttach(&self, ulattachmentnum: u32, lpinterface: ::core::option::Option<&::windows::core::GUID>, ulflags: u32) -> ::windows::core::Result<IAttach> {
        let mut result__ = ::core::mem::MaybeUninit::zeroed();
        (::windows::core::Vtable::vtable(self).OpenAttach)(::windows::core::Vtable::as_raw(self), ulattachmentnum, ::core::mem::transmute(lpinterface), ulflags, ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<IAttach>(result__)
    }
    pub unsafe fn CreateAttach(&self, lpinterface: ::core::option::Option<&::windows::core::GUID>, ulflags: u32, lpulattachmentnum: &mut u32, lppattach: &mut ::core::option::Option<IAttach>) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).CreateAttach)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(lpinterface), ulflags, ::core::mem::transmute(lpulattachmentnum), ::core::mem::transmute(lppattach)).ok()
    }
    ...
    #[doc = "*Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`*"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com"))]
    pub unsafe fn ModifyRecipients(&self, ulflags: u32, lpmods: &ADRLIST) -> ::windows::core::Result<()> {
...
impl IMsgStore {
    ...
    pub unsafe fn Advise<'a, P0>(&self, lpentryid: ::core::option::Option<&[u8]>, uleventmask: u32, lpadvisesink: P0) -> ::windows::core::Result<u32>
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, IMAPIAdviseSink>>,
    {
        let mut result__ = ::core::mem::MaybeUninit::zeroed();
        (::windows::core::Vtable::vtable(self).Advise)(::windows::core::Vtable::as_raw(self), lpentryid.as_deref().map_or(0, |slice| slice.len() as _), ::core::mem::transmute(lpentryid.as_deref().map_or(::core::ptr::null(), |slice| slice.as_ptr())), uleventmask, lpadvisesink.into().abi(), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<u32>(result__)
    }
    pub unsafe fn Unadvise(&self, ulconnection: u32) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).Unadvise)(::windows::core::Vtable::as_raw(self), ulconnection).ok()
    }
    pub unsafe fn CompareEntryIDs(&self, lpentryid1: &[u8], lpentryid2: &[u8], ulflags: u32) -> ::windows::core::Result<u32> {
        let mut result__ = ::core::mem::MaybeUninit::zeroed();
        (::windows::core::Vtable::vtable(self).CompareEntryIDs)(::windows::core::Vtable::as_raw(self), lpentryid1.len() as _, ::core::mem::transmute(lpentryid1.as_ptr()), lpentryid2.len() as _, ::core::mem::transmute(lpentryid2.as_ptr()), ulflags, ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<u32>(result__)
    }
    pub unsafe fn OpenEntry(&self, lpentryid: &[u8], lpinterface: ::core::option::Option<&::windows::core::GUID>, ulflags: u32, lpulobjtype: &mut u32, ppunk: &mut ::core::option::Option<::windows::core::IUnknown>) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).OpenEntry)(::windows::core::Vtable::as_raw(self), lpentryid.len() as _, ::core::mem::transmute(lpentryid.as_ptr()), ::core::mem::transmute(lpinterface), ulflags, ::core::mem::transmute(lpulobjtype), ::core::mem::transmute(ppunk)).ok()
    }
    pub unsafe fn SetReceiveFolder(&self, lpszmessageclass: ::core::option::Option<&i8>, ulflags: u32, lpentryid: &[u8]) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).SetReceiveFolder)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(lpszmessageclass), ulflags, lpentryid.len() as _, ::core::mem::transmute(lpentryid.as_ptr())).ok()
    }
    pub unsafe fn GetReceiveFolder(&self, lpszmessageclass: ::core::option::Option<&i8>, ulflags: u32, lpcbentryid: &mut u32, lppentryid: &mut *mut ENTRYID, lppszexplicitclass: ::core::option::Option<&mut *mut i8>) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).GetReceiveFolder)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(lpszmessageclass), ulflags, ::core::mem::transmute(lpcbentryid), ::core::mem::transmute(lppentryid), ::core::mem::transmute(lppszexplicitclass)).ok()
    }
    ...
    pub unsafe fn AbortSubmit(&self, lpentryid: &[u8], ulflags: u32) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).AbortSubmit)(::windows::core::Vtable::as_raw(self), lpentryid.len() as _, ::core::mem::transmute(lpentryid.as_ptr()), ulflags).ok()
    }
    ...
    pub unsafe fn FinishedMsg(&self, ulflags: u32, lpentryid: &[u8]) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).FinishedMsg)(::windows::core::Vtable::as_raw(self), ulflags, lpentryid.len() as _, ::core::mem::transmute(lpentryid.as_ptr())).ok()
    }
    #[doc = "*Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`*"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com"))]
    pub unsafe fn NotifyNewMail(&self, lpnotification: &NOTIFICATION) -> ::windows::core::Result<()> {
...
impl IProviderAdmin {
    ...
    #[doc = "*Required features: `\"Win32_Foundation\"`, `\"Win32_System_Com\"`*"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com"))]
    pub unsafe fn CreateProvider(&self, lpszprovider: &i8, lpprops: &[SPropValue], uluiparam: usize, ulflags: u32) -> ::windows::core::Result<MAPIUID> {
        let mut result__ = ::core::mem::MaybeUninit::zeroed();
    ...
    pub unsafe fn DeleteProvider(&self, lpuid: &MAPIUID) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).DeleteProvider)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(lpuid)).ok()
    }
    pub unsafe fn OpenProfileSection(&self, lpuid: ::core::option::Option<&MAPIUID>, lpinterface: ::core::option::Option<&::windows::core::GUID>, ulflags: u32) -> ::windows::core::Result<IProfSect> {
        let mut result__ = ::core::mem::MaybeUninit::zeroed();
        (::windows::core::Vtable::vtable(self).OpenProfileSection)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(lpuid), ::core::mem::transmute(lpinterface), ulflags, ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<IProfSect>(result__)
    }
}
