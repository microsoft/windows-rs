...
impl IAccessibleWinSAT {
    pub unsafe fn SetAccessiblityData<P0, P1, P2>(&self, wsname: P0, wsvalue: P1, wsdesc: P2) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IAccessibleWinSAT_Impl: super::super::UI::Accessibility::IAccessible_Impl {
    fn SetAccessiblityData(&self, wsname: &windows_core::PCWSTR, wsvalue: &windows_core::PCWSTR, wsdesc: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant", feature = "Win32_UI_Accessibility"))]
...
impl IInitiateWinSATAssessment {
    pub unsafe fn InitiateAssessment<P0, P1>(&self, cmdline: P0, pcallbacks: P1, callerhwnd: Option<super::super::Foundation::HWND>) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn InitiateFormalAssessment<P0>(&self, pcallbacks: P0, callerhwnd: Option<super::super::Foundation::HWND>) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn CancelAssessment(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IInitiateWinSATAssessment_Impl: windows_core::IUnknownImpl {
    fn InitiateAssessment(&self, cmdline: &windows_core::PCWSTR, pcallbacks: windows_core::Ref<'_, IWinSATInitiateEvents>, callerhwnd: super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT>;
    fn InitiateFormalAssessment(&self, pcallbacks: windows_core::Ref<'_, IWinSATInitiateEvents>, callerhwnd: super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT>;
    fn CancelAssessment(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IProvideWinSATAssessmentInfo {
    pub unsafe fn Score(&self) -> Result<f32, windows_result::HRESULT> {
        unsafe {
...
pub trait IProvideWinSATAssessmentInfo_Impl: super::Com::IDispatch_Impl {
    fn Score(&self) -> Result<f32, windows_result::HRESULT>;
...
impl IProvideWinSATResultsInfo {
    pub unsafe fn GetAssessmentInfo(&self, assessment: WINSAT_ASSESSMENT_TYPE) -> Result<IProvideWinSATAssessmentInfo, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AssessmentState(&self) -> Result<WINSAT_ASSESSMENT_STATE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AssessmentDateTime(&self) -> Result<super::Variant::VARIANT, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SystemRating(&self) -> Result<f32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SystemRating)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn RatingStateDesc(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IProvideWinSATResultsInfo_Impl: super::Com::IDispatch_Impl {
    fn GetAssessmentInfo(&self, assessment: WINSAT_ASSESSMENT_TYPE) -> Result<IProvideWinSATAssessmentInfo, windows_result::HRESULT>;
    fn AssessmentState(&self) -> Result<WINSAT_ASSESSMENT_STATE, windows_result::HRESULT>;
    fn AssessmentDateTime(&self) -> Result<super::Variant::VARIANT, windows_result::HRESULT>;
    fn SystemRating(&self) -> Result<f32, windows_result::HRESULT>;
    fn RatingStateDesc(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IProvideWinSATVisuals {
    ...
    pub unsafe fn get_Bitmap(&self, bitmapsize: WINSAT_BITMAP_SIZE, state: WINSAT_ASSESSMENT_STATE, rating: f32) -> Result<super::super::Graphics::Gdi::HBITMAP, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IProvideWinSATVisuals_Impl: windows_core::IUnknownImpl {
    fn get_Bitmap(&self, bitmapsize: WINSAT_BITMAP_SIZE, state: WINSAT_ASSESSMENT_STATE, rating: f32) -> Result<super::super::Graphics::Gdi::HBITMAP, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Gdi")]
...
impl IQueryAllWinSATAssessments {
    ...
    pub unsafe fn get_AllXML(&self, xpath: &windows_core::BSTR, namespaces: &windows_core::BSTR) -> Result<super::super::Data::Xml::MsXml::IXMLDOMNodeList, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IQueryAllWinSATAssessments_Impl: super::Com::IDispatch_Impl {
    fn get_AllXML(&self, xpath: &windows_core::BSTR, namespaces: &windows_core::BSTR) -> Result<super::super::Data::Xml::MsXml::IXMLDOMNodeList, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_Data_Xml_MsXml", feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IQueryOEMWinSATCustomization {
    pub unsafe fn GetOEMPrePopulationInfo(&self) -> Result<WINSAT_OEM_CUSTOMIZATION_STATE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IQueryOEMWinSATCustomization_Impl: windows_core::IUnknownImpl {
    fn GetOEMPrePopulationInfo(&self) -> Result<WINSAT_OEM_CUSTOMIZATION_STATE, windows_result::HRESULT>;
}
...
impl IQueryRecentWinSATAssessment {
    #[cfg(feature = "Win32_Data_Xml_MsXml")]
    pub unsafe fn get_XML(&self, xpath: &windows_core::BSTR, namespaces: &windows_core::BSTR) -> Result<super::super::Data::Xml::MsXml::IXMLDOMNodeList, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Info(&self) -> Result<IProvideWinSATResultsInfo, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IQueryRecentWinSATAssessment_Impl: super::Com::IDispatch_Impl {
    fn get_XML(&self, xpath: &windows_core::BSTR, namespaces: &windows_core::BSTR) -> Result<super::super::Data::Xml::MsXml::IXMLDOMNodeList, windows_result::HRESULT>;
    fn Info(&self) -> Result<IProvideWinSATResultsInfo, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_Data_Xml_MsXml", feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IWinSATInitiateEvents {
    pub unsafe fn WinSATComplete<P1>(&self, hresult: windows_core::HRESULT, strdescription: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn WinSATUpdate<P2>(&self, ucurrenttick: u32, uticktotal: u32, strcurrentstate: P2) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IWinSATInitiateEvents_Impl: windows_core::IUnknownImpl {
    fn WinSATComplete(&self, hresult: windows_core::HRESULT, strdescription: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn WinSATUpdate(&self, ucurrenttick: u32, uticktotal: u32, strcurrentstate: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
