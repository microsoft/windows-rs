...
pub struct IAccessibleWinSATVtbl(
    ...
    #[cfg(not(any(feature = "Win32_System_Com", feature = "Win32_UI_Accessibility")))] usize,
    ...
    #[cfg(not(any(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_UI_Accessibility")))] usize,
