...
impl IRendezvousApplication {
    pub unsafe fn SetRendezvousSession<P0>(&self, prendezvoussession: P0) -> windows_result::Result<()>
    where
...
pub trait IRendezvousApplication_Impl: windows_core::IUnknownImpl {
    fn SetRendezvousSession(&self, prendezvoussession: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
}
...
impl IRendezvousSession {
    pub unsafe fn State(&self) -> windows_result::Result<RENDEZVOUS_SESSION_STATE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).State)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn RemoteUser(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SendContextData(&self, bstrdata: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn Terminate(&self, hr: windows_core::HRESULT, bstrappdata: &windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IRendezvousSession_Impl: windows_core::IUnknownImpl {
    fn State(&self) -> windows_result::Result<RENDEZVOUS_SESSION_STATE>;
    fn RemoteUser(&self) -> windows_result::Result<windows_core::BSTR>;
    fn Flags(&self) -> windows_result::Result<i32>;
    fn SendContextData(&self, bstrdata: &windows_core::BSTR) -> windows_result::Result<()>;
    fn Terminate(&self, hr: windows_core::HRESULT, bstrappdata: &windows_core::BSTR) -> windows_result::Result<()>;
}
