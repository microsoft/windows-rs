#[inline]
pub unsafe fn AssignProcessToJobObject(hjob: super::super::Foundation::HANDLE, hprocess: super::super::Foundation::HANDLE) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn CreateJobObjectA<P1>(lpjobattributes: *const super::super::Security::SECURITY_ATTRIBUTES, lpname: P1) -> super::super::Foundation::HANDLE
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { CreateJobObjectA(lpjobattributes, lpname.param().abi()) }
}
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn CreateJobObjectW<P1>(lpjobattributes: *const super::super::Security::SECURITY_ATTRIBUTES, lpname: P1) -> super::super::Foundation::HANDLE
where
...
#[inline]
pub unsafe fn IsProcessInJob(processhandle: super::super::Foundation::HANDLE, jobhandle: super::super::Foundation::HANDLE, result: *mut windows_core::BOOL) -> windows_core::BOOL {
    ...
    unsafe { IsProcessInJob(processhandle, jobhandle, result as _) }
}
#[inline]
pub unsafe fn OpenJobObjectA<P2>(dwdesiredaccess: u32, binherithandle: bool, lpname: P2) -> super::super::Foundation::HANDLE
where
...
#[inline]
pub unsafe fn OpenJobObjectW<P2>(dwdesiredaccess: u32, binherithandle: bool, lpname: P2) -> super::super::Foundation::HANDLE
where
...
#[inline]
pub unsafe fn QueryInformationJobObject(hjob: super::super::Foundation::HANDLE, jobobjectinformationclass: JOBOBJECTINFOCLASS, lpjobobjectinformation: *mut core::ffi::c_void, cbjobobjectinformationlength: u32, lpreturnlength: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { QueryInformationJobObject(hjob, jobobjectinformationclass, lpjobobjectinformation as _, cbjobobjectinformationlength, lpreturnlength as _) }
}
#[inline]
pub unsafe fn QueryIoRateControlInformationJobObject<P1>(hjob: super::super::Foundation::HANDLE, volumename: P1, infoblocks: *mut *mut JOBOBJECT_IO_RATE_CONTROL_INFORMATION, infoblockcount: *mut u32) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn UserHandleGrantAccess(huserhandle: super::super::Foundation::HANDLE, hjob: super::super::Foundation::HANDLE, bgrant: bool) -> windows_core::BOOL {
