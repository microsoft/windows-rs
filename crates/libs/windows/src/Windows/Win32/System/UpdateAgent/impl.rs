...
pub trait IUpdateDownloader_Impl: Sized + super::Com::IDispatch_Impl {
    ...
    fn BeginDownload(&self, onprogresschanged: ::core::option::Option<&::windows_core::IUnknown>, oncompleted: ::core::option::Option<&::windows_core::IUnknown>, state: &::windows_core::VARIANT) -> ::windows_core::Result<IDownloadJob>;
...
pub trait IUpdateInstaller_Impl: Sized + super::Com::IDispatch_Impl {
    ...
    fn Updates(&self) -> ::windows_core::Result<IUpdateCollection>;
    fn SetUpdates(&self, value: ::core::option::Option<&IUpdateCollection>) -> ::windows_core::Result<()>;
    fn BeginInstall(&self, onprogresschanged: ::core::option::Option<&::windows_core::IUnknown>, oncompleted: ::core::option::Option<&::windows_core::IUnknown>, state: &::windows_core::VARIANT) -> ::windows_core::Result<IInstallationJob>;
    fn BeginUninstall(&self, onprogresschanged: ::core::option::Option<&::windows_core::IUnknown>, oncompleted: ::core::option::Option<&::windows_core::IUnknown>, state: &::windows_core::VARIANT) -> ::windows_core::Result<IInstallationJob>;
...
pub trait IUpdateSearcher_Impl: Sized + super::Com::IDispatch_Impl {
    ...
    fn BeginSearch(&self, criteria: &::windows_core::BSTR, oncompleted: ::core::option::Option<&::windows_core::IUnknown>, state: &::windows_core::VARIANT) -> ::windows_core::Result<ISearchJob>;
