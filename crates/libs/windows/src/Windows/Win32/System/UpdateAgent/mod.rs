...
pub const WU_E_PT_DATA_BOUNDARY_RESTRICTED: ::windows_core::HRESULT = ::windows_core::HRESULT(-2145107712i32);
...
pub const WU_E_PT_GENERAL_AAD_CLIENT_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(-2145107711i32);
...
pub const WU_S_AAD_DEVICE_TICKET_NOT_NEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(2392066i32);
