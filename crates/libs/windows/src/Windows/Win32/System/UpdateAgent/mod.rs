...
pub const adAlwaysAutoDownload: AutoDownloadMode = AutoDownloadMode(2);
pub const adLetWindowsUpdateDecide: AutoDownloadMode = AutoDownloadMode(0);
pub const adNeverAutoDownload: AutoDownloadMode = AutoDownloadMode(1);
pub const asAlwaysAutoSelect: AutoSelectionMode = AutoSelectionMode(3);
pub const asAutoSelectIfDownloaded: AutoSelectionMode = AutoSelectionMode(1);
pub const asLetWindowsUpdateDecide: AutoSelectionMode = AutoSelectionMode(0);
pub const asNeverAutoSelect: AutoSelectionMode = AutoSelectionMode(2);
pub const asfAllowOnlineRegistration: AddServiceFlag = AddServiceFlag(2);
pub const asfAllowPendingRegistration: AddServiceFlag = AddServiceFlag(1);
pub const asfRegisterServiceWithAU: AddServiceFlag = AddServiceFlag(4);
pub const aunlDisabled: AutomaticUpdatesNotificationLevel = AutomaticUpdatesNotificationLevel(1);
pub const aunlNotConfigured: AutomaticUpdatesNotificationLevel = AutomaticUpdatesNotificationLevel(0);
pub const aunlNotifyBeforeDownload: AutomaticUpdatesNotificationLevel = AutomaticUpdatesNotificationLevel(2);
pub const aunlNotifyBeforeInstallation: AutomaticUpdatesNotificationLevel = AutomaticUpdatesNotificationLevel(3);
pub const aunlScheduledInstallation: AutomaticUpdatesNotificationLevel = AutomaticUpdatesNotificationLevel(4);
pub const auptDisableAutomaticUpdates: AutomaticUpdatesPermissionType = AutomaticUpdatesPermissionType(2);
pub const auptSetFeaturedUpdatesEnabled: AutomaticUpdatesPermissionType = AutomaticUpdatesPermissionType(4);
pub const auptSetIncludeRecommendedUpdates: AutomaticUpdatesPermissionType = AutomaticUpdatesPermissionType(3);
pub const auptSetNonAdministratorsElevated: AutomaticUpdatesPermissionType = AutomaticUpdatesPermissionType(5);
pub const auptSetNotificationLevel: AutomaticUpdatesPermissionType = AutomaticUpdatesPermissionType(1);
pub const ausidEveryDay: AutomaticUpdatesScheduledInstallationDay = AutomaticUpdatesScheduledInstallationDay(0);
pub const ausidEveryFriday: AutomaticUpdatesScheduledInstallationDay = AutomaticUpdatesScheduledInstallationDay(6);
pub const ausidEveryMonday: AutomaticUpdatesScheduledInstallationDay = AutomaticUpdatesScheduledInstallationDay(2);
pub const ausidEverySaturday: AutomaticUpdatesScheduledInstallationDay = AutomaticUpdatesScheduledInstallationDay(7);
pub const ausidEverySunday: AutomaticUpdatesScheduledInstallationDay = AutomaticUpdatesScheduledInstallationDay(1);
pub const ausidEveryThursday: AutomaticUpdatesScheduledInstallationDay = AutomaticUpdatesScheduledInstallationDay(5);
pub const ausidEveryTuesday: AutomaticUpdatesScheduledInstallationDay = AutomaticUpdatesScheduledInstallationDay(3);
pub const ausidEveryWednesday: AutomaticUpdatesScheduledInstallationDay = AutomaticUpdatesScheduledInstallationDay(4);
pub const auutCurrentUser: AutomaticUpdatesUserType = AutomaticUpdatesUserType(1);
pub const auutLocalAdministrator: AutomaticUpdatesUserType = AutomaticUpdatesUserType(2);
...
pub const daDetection: DeploymentAction = DeploymentAction(3);
pub const daInstallation: DeploymentAction = DeploymentAction(1);
pub const daNone: DeploymentAction = DeploymentAction(0);
pub const daOptionalInstallation: DeploymentAction = DeploymentAction(4);
pub const daUninstallation: DeploymentAction = DeploymentAction(2);
pub const downloadTypeFull: DownloadType = DownloadType(0);
pub const downloadTypeUpdateBootstrapper: DownloadType = DownloadType(1);
pub const dpExtraHigh: DownloadPriority = DownloadPriority(4);
pub const dpHigh: DownloadPriority = DownloadPriority(3);
pub const dpLow: DownloadPriority = DownloadPriority(1);
pub const dpNormal: DownloadPriority = DownloadPriority(2);
pub const dphDownloading: DownloadPhase = DownloadPhase(2);
pub const dphInitializing: DownloadPhase = DownloadPhase(1);
pub const dphVerifying: DownloadPhase = DownloadPhase(3);
pub const iiMinor: InstallationImpact = InstallationImpact(1);
pub const iiNormal: InstallationImpact = InstallationImpact(0);
pub const iiRequiresExclusiveHandling: InstallationImpact = InstallationImpact(2);
pub const irbAlwaysRequiresReboot: InstallationRebootBehavior = InstallationRebootBehavior(1);
pub const irbCanRequestReboot: InstallationRebootBehavior = InstallationRebootBehavior(2);
pub const irbNeverReboots: InstallationRebootBehavior = InstallationRebootBehavior(0);
pub const orcAborted: OperationResultCode = OperationResultCode(5);
pub const orcFailed: OperationResultCode = OperationResultCode(4);
pub const orcInProgress: OperationResultCode = OperationResultCode(1);
pub const orcNotStarted: OperationResultCode = OperationResultCode(0);
pub const orcSucceeded: OperationResultCode = OperationResultCode(2);
pub const orcSucceededWithErrors: OperationResultCode = OperationResultCode(3);
pub const searchScopeAllUsers: SearchScope = SearchScope(5);
pub const searchScopeCurrentUserOnly: SearchScope = SearchScope(2);
pub const searchScopeDefault: SearchScope = SearchScope(0);
pub const searchScopeMachineAndAllUsers: SearchScope = SearchScope(4);
pub const searchScopeMachineAndCurrentUser: SearchScope = SearchScope(3);
pub const searchScopeMachineOnly: SearchScope = SearchScope(1);
pub const ssDefault: ServerSelection = ServerSelection(0);
pub const ssManagedServer: ServerSelection = ServerSelection(1);
pub const ssOthers: ServerSelection = ServerSelection(3);
pub const ssWindowsUpdate: ServerSelection = ServerSelection(2);
pub const uecGeneral: UpdateExceptionContext = UpdateExceptionContext(1);
pub const uecSearchIncomplete: UpdateExceptionContext = UpdateExceptionContext(4);
pub const uecWindowsDriver: UpdateExceptionContext = UpdateExceptionContext(2);
pub const uecWindowsInstaller: UpdateExceptionContext = UpdateExceptionContext(3);
pub const uloForWebsiteAccess: UpdateLockdownOption = UpdateLockdownOption(1);
pub const uoInstallation: UpdateOperation = UpdateOperation(1);
pub const uoUninstallation: UpdateOperation = UpdateOperation(2);
pub const usoNonVolatileService: UpdateServiceOption = UpdateServiceOption(1);
pub const usrsNotRegistered: UpdateServiceRegistrationState = UpdateServiceRegistrationState(1);
pub const usrsRegistered: UpdateServiceRegistrationState = UpdateServiceRegistrationState(3);
pub const usrsRegistrationPending: UpdateServiceRegistrationState = UpdateServiceRegistrationState(2);
pub const utDriver: UpdateType = UpdateType(2);
pub const utSoftware: UpdateType = UpdateType(1);
