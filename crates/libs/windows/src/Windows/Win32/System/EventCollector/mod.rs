...
pub unsafe fn EcEnumNextSubscription(subscriptionenum: isize, subscriptionnamebuffer: ::core::option::Option<&mut [u16]>, subscriptionnamebufferused: *mut u32) -> super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(EcEnumNextSubscription(::core::mem::transmute(subscriptionenum), subscriptionnamebuffer.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(subscriptionnamebuffer.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), ::core::mem::transmute(subscriptionnamebufferused)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
