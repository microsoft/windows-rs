...
#[inline]
pub unsafe fn EcEnumNextSubscription(subscriptionenum: isize, subscriptionnamebuffersize: u32, subscriptionnamebuffer: windows_core::PWSTR, subscriptionnamebufferused: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { EcEnumNextSubscription(subscriptionenum, subscriptionnamebuffersize, core::mem::transmute(subscriptionnamebuffer), subscriptionnamebufferused as _) }
}
#[inline]
