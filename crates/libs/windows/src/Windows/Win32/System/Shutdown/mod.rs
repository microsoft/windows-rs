    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { AbortSystemShutdownA(core::mem::transmute_copy(&lpmachinename.param().borrow())).ok() }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { AbortSystemShutdownW(core::mem::transmute_copy(&lpmachinename.param().borrow())).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { InitiateShutdownA(core::mem::transmute_copy(&lpmachinename.param().borrow()), core::mem::transmute_copy(&lpmessage.param().borrow()), dwgraceperiod, dwshutdownflags, dwreason) }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { InitiateShutdownW(core::mem::transmute_copy(&lpmachinename.param().borrow()), core::mem::transmute_copy(&lpmessage.param().borrow()), dwgraceperiod, dwshutdownflags, dwreason) }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { InitiateSystemShutdownA(core::mem::transmute_copy(&lpmachinename.param().borrow()), core::mem::transmute_copy(&lpmessage.param().borrow()), dwtimeout, bforceappsclosed.into(), brebootaftershutdown.into()).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { InitiateSystemShutdownExA(core::mem::transmute_copy(&lpmachinename.param().borrow()), core::mem::transmute_copy(&lpmessage.param().borrow()), dwtimeout, bforceappsclosed.into(), brebootaftershutdown.into(), dwreason).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { InitiateSystemShutdownExW(core::mem::transmute_copy(&lpmachinename.param().borrow()), core::mem::transmute_copy(&lpmessage.param().borrow()), dwtimeout, bforceappsclosed.into(), brebootaftershutdown.into(), dwreason).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { InitiateSystemShutdownW(core::mem::transmute_copy(&lpmachinename.param().borrow()), core::mem::transmute_copy(&lpmessage.param().borrow()), dwtimeout, bforceappsclosed.into(), brebootaftershutdown.into()).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { ShutdownBlockReasonCreate(hwnd, core::mem::transmute_copy(&pwszreason.param().borrow())).ok() }
}
#[inline]
