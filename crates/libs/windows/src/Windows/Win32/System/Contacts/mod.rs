...
impl IContact {
    pub unsafe fn GetContactID(&self, pszcontactid: &mut [u16], pdwcchcontactidrequired: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetPath(&self, pszpath: &mut [u16], pdwcchpathrequired: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn CommitChanges(&self, dwcommitflags: u32) -> windows_result::Result<()> {
...
pub trait IContact_Impl: windows_core::IUnknownImpl {
    fn GetContactID(&self, pszcontactid: windows_core::PWSTR, cchcontactid: u32, pdwcchcontactidrequired: *mut u32) -> windows_result::Result<()>;
    fn GetPath(&self, pszpath: windows_core::PWSTR, cchpath: u32, pdwcchpathrequired: *mut u32) -> windows_result::Result<()>;
    fn CommitChanges(&self, dwcommitflags: u32) -> windows_result::Result<()>;
}
impl IContact_Vtbl {
...
impl IContactAggregationAggregate {
    ...
    pub unsafe fn GetComponentItems(&self) -> windows_result::Result<IContactAggregationContactCollection> {
        unsafe {
    ...
    pub unsafe fn Link<P0>(&self, paggregateid: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).Link)(windows_core::Interface::as_raw(self), paggregateid.param().abi()).ok() }
    }
    pub unsafe fn get_Groups(&self, options: CONTACT_AGGREGATION_COLLECTION_OPTIONS) -> windows_result::Result<IContactAggregationGroupCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IContactAggregationAggregate_Impl: windows_core::IUnknownImpl {
    ...
    fn GetComponentItems(&self) -> windows_result::Result<IContactAggregationContactCollection>;
    fn Link(&self, paggregateid: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn get_Groups(&self, options: CONTACT_AGGREGATION_COLLECTION_OPTIONS) -> windows_result::Result<IContactAggregationGroupCollection>;
    fn AntiLink(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetAntiLink(&self, pantilink: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn FavoriteOrder(&self) -> windows_result::Result<u32>;
    fn SetFavoriteOrder(&self, favoriteorder: u32) -> windows_result::Result<()>;
...
impl IContactAggregationAggregateCollection {
    pub unsafe fn FindFirst(&self) -> windows_result::Result<IContactAggregationAggregate> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn FindFirstByAntiLinkId<P0>(&self, pantilinkid: P0) -> windows_result::Result<IContactAggregationAggregate>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn FindNext(&self) -> windows_result::Result<IContactAggregationAggregate> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IContactAggregationAggregateCollection_Impl: windows_core::IUnknownImpl {
    fn FindFirst(&self) -> windows_result::Result<IContactAggregationAggregate>;
    fn FindFirstByAntiLinkId(&self, pantilinkid: &windows_core::PCWSTR) -> windows_result::Result<IContactAggregationAggregate>;
    fn FindNext(&self) -> windows_result::Result<IContactAggregationAggregate>;
...
impl IContactAggregationContact {
    ...
    pub unsafe fn RemoteObjectId(&self) -> windows_result::Result<*mut CONTACT_AGGREGATION_BLOB> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RemoteObjectId)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetRemoteObjectId(&self, premoteobjectid: *const CONTACT_AGGREGATION_BLOB) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetRemoteObjectId)(windows_core::Interface::as_raw(self), premoteobjectid).ok() }
    }
    pub unsafe fn SyncIdentityHash(&self) -> windows_result::Result<*mut CONTACT_AGGREGATION_BLOB> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SyncIdentityHash)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetSyncIdentityHash(&self, psyncidentityhash: *const CONTACT_AGGREGATION_BLOB) -> windows_result::Result<()> {
...
pub trait IContactAggregationContact_Impl: windows_core::IUnknownImpl {
    ...
    fn Save(&self) -> windows_result::Result<()>;
    fn MoveToAggregate(&self, paggregateid: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn Unlink(&self) -> windows_result::Result<()>;
    fn AccountId(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetAccountId(&self, paccountid: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn AggregateId(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn Id(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn IsMe(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsExternal(&self) -> windows_result::Result<windows_core::BOOL>;
    fn NetworkSourceId(&self) -> windows_result::Result<u32>;
    fn SetNetworkSourceId(&self, networksourceid: u32) -> windows_result::Result<()>;
    fn NetworkSourceIdString(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetNetworkSourceIdString(&self, pnetworksourceid: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn RemoteObjectId(&self) -> windows_result::Result<*mut CONTACT_AGGREGATION_BLOB>;
    fn SetRemoteObjectId(&self, premoteobjectid: *const CONTACT_AGGREGATION_BLOB) -> windows_result::Result<()>;
    fn SyncIdentityHash(&self) -> windows_result::Result<*mut CONTACT_AGGREGATION_BLOB>;
    fn SetSyncIdentityHash(&self, psyncidentityhash: *const CONTACT_AGGREGATION_BLOB) -> windows_result::Result<()>;
}
...
impl IContactAggregationContactCollection {
    pub unsafe fn FindFirst(&self) -> windows_result::Result<IContactAggregationContact> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindFirst)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn FindNext(&self) -> windows_result::Result<IContactAggregationContact> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindNext)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn FindFirstByIdentityHash<P0, P1>(&self, psourcetype: P0, paccountid: P1, pidentityhash: *const CONTACT_AGGREGATION_BLOB) -> windows_result::Result<IContactAggregationContact>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn FindFirstByRemoteId<P0, P1>(&self, psourcetype: P0, paccountid: P1, premoteobjectid: *const CONTACT_AGGREGATION_BLOB) -> windows_result::Result<IContactAggregationContact>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IContactAggregationContactCollection_Impl: windows_core::IUnknownImpl {
    fn FindFirst(&self) -> windows_result::Result<IContactAggregationContact>;
    fn FindNext(&self) -> windows_result::Result<IContactAggregationContact>;
    fn FindFirstByIdentityHash(&self, psourcetype: &windows_core::PCWSTR, paccountid: &windows_core::PCWSTR, pidentityhash: *const CONTACT_AGGREGATION_BLOB) -> windows_result::Result<IContactAggregationContact>;
    fn Count(&self) -> windows_result::Result<i32>;
    fn FindFirstByRemoteId(&self, psourcetype: &windows_core::PCWSTR, paccountid: &windows_core::PCWSTR, premoteobjectid: *const CONTACT_AGGREGATION_BLOB) -> windows_result::Result<IContactAggregationContact>;
}
...
impl IContactAggregationGroup {
    ...
    pub unsafe fn Add<P0>(&self, paggregateid: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).Add)(windows_core::Interface::as_raw(self), paggregateid.param().abi()).ok() }
    }
    pub unsafe fn Remove<P0>(&self, paggregateid: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).Remove)(windows_core::Interface::as_raw(self), paggregateid.param().abi()).ok() }
    }
    pub unsafe fn Members(&self) -> windows_result::Result<IContactAggregationAggregateCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GlobalObjectId(&self) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GlobalObjectId)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetGlobalObjectId(&self, pglobalobjectid: *const windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn Name(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Name)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetName<P0>(&self, pname: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IContactAggregationGroup_Impl: windows_core::IUnknownImpl {
    fn Delete(&self) -> windows_result::Result<()>;
    fn Save(&self) -> windows_result::Result<()>;
    fn Add(&self, paggregateid: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn Remove(&self, paggregateid: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn Members(&self) -> windows_result::Result<IContactAggregationAggregateCollection>;
    fn GlobalObjectId(&self) -> windows_result::Result<windows_core::GUID>;
    fn SetGlobalObjectId(&self, pglobalobjectid: *const windows_core::GUID) -> windows_result::Result<()>;
    fn Id(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn Name(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetName(&self, pname: &windows_core::PCWSTR) -> windows_result::Result<()>;
}
...
impl IContactAggregationGroupCollection {
    pub unsafe fn FindFirst(&self) -> windows_result::Result<IContactAggregationGroup> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindFirst)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn FindFirstByGlobalObjectId(&self, pglobalobjectid: *const windows_core::GUID) -> windows_result::Result<IContactAggregationGroup> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn FindNext(&self) -> windows_result::Result<IContactAggregationGroup> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindNext)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IContactAggregationGroupCollection_Impl: windows_core::IUnknownImpl {
    fn FindFirst(&self) -> windows_result::Result<IContactAggregationGroup>;
    fn FindFirstByGlobalObjectId(&self, pglobalobjectid: *const windows_core::GUID) -> windows_result::Result<IContactAggregationGroup>;
    fn FindNext(&self) -> windows_result::Result<IContactAggregationGroup>;
...
impl IContactAggregationLink {
    ...
    pub unsafe fn IsLinkResolved(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsLinkResolved)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetIsLinkResolved(&self, islinkresolved: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn ServerPerson(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ServerPerson)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetServerPerson<P0>(&self, pserverpersonid: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn ServerPersonBaseline(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ServerPersonBaseline)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetServerPersonBaseline<P0>(&self, pserverpersonid: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IContactAggregationLink_Impl: windows_core::IUnknownImpl {
    ...
    fn SetAccountId(&self, paccountid: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn Id(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn IsLinkResolved(&self) -> windows_result::Result<windows_core::BOOL>;
    fn SetIsLinkResolved(&self, islinkresolved: windows_core::BOOL) -> windows_result::Result<()>;
    fn NetworkSourceIdString(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetNetworkSourceIdString(&self, pnetworksourceid: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn RemoteObjectId(&self) -> windows_result::Result<*mut CONTACT_AGGREGATION_BLOB>;
    fn SetRemoteObjectId(&self, premoteobjectid: *const CONTACT_AGGREGATION_BLOB) -> windows_result::Result<()>;
    fn ServerPerson(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetServerPerson(&self, pserverpersonid: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn ServerPersonBaseline(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetServerPersonBaseline(&self, pserverpersonid: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn SyncIdentityHash(&self) -> windows_result::Result<*mut CONTACT_AGGREGATION_BLOB>;
    fn SetSyncIdentityHash(&self, psyncidentityhash: *const CONTACT_AGGREGATION_BLOB) -> windows_result::Result<()>;
}
...
impl IContactAggregationLinkCollection {
    pub unsafe fn FindFirst(&self) -> windows_result::Result<IContactAggregationLink> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindFirst)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn FindFirstByRemoteId<P0, P1>(&self, psourcetype: P0, paccountid: P1, premoteid: *const CONTACT_AGGREGATION_BLOB) -> windows_result::Result<IContactAggregationLink>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn FindNext(&self) -> windows_result::Result<IContactAggregationLink> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindNext)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IContactAggregationLinkCollection_Impl: windows_core::IUnknownImpl {
    fn FindFirst(&self) -> windows_result::Result<IContactAggregationLink>;
    fn FindFirstByRemoteId(&self, psourcetype: &windows_core::PCWSTR, paccountid: &windows_core::PCWSTR, premoteid: *const CONTACT_AGGREGATION_BLOB) -> windows_result::Result<IContactAggregationLink>;
    fn FindNext(&self) -> windows_result::Result<IContactAggregationLink>;
    fn Count(&self) -> windows_result::Result<u32>;
}
...
impl IContactAggregationManager {
    pub unsafe fn GetVersionInfo(&self, plmajorversion: *mut i32, plminorversion: *mut i32) -> windows_result::Result<()> {
    ...
    pub unsafe fn CreateOrOpenGroup<P0>(&self, pgroupname: P0, options: CONTACT_AGGREGATION_CREATE_OR_OPEN_OPTIONS, pcreatedgroup: *mut windows_core::BOOL) -> windows_result::Result<IContactAggregationGroup>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn CreateExternalContact(&self) -> windows_result::Result<IContactAggregationContact> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateServerPerson(&self) -> windows_result::Result<IContactAggregationServerPerson> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateServerContactLink(&self) -> windows_result::Result<IContactAggregationLink> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn OpenAggregateContact<P0>(&self, pitemid: P0) -> windows_result::Result<IContactAggregationAggregate>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn OpenContact<P0>(&self, pitemid: P0) -> windows_result::Result<IContactAggregationContact>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn OpenServerContactLink<P0>(&self, pitemid: P0) -> windows_result::Result<IContactAggregationLink>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn OpenServerPerson<P0>(&self, pitemid: P0) -> windows_result::Result<IContactAggregationServerPerson>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn get_Contacts(&self, options: CONTACT_AGGREGATION_COLLECTION_OPTIONS) -> windows_result::Result<IContactAggregationContactCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn get_AggregateContacts(&self, options: CONTACT_AGGREGATION_COLLECTION_OPTIONS) -> windows_result::Result<IContactAggregationAggregateCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ServerPersons(&self) -> windows_result::Result<IContactAggregationServerPersonCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn get_ServerContactLinks<P0>(&self, ppersonitemid: P0) -> windows_result::Result<IContactAggregationLinkCollection>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
...
pub trait IContactAggregationManager_Impl: windows_core::IUnknownImpl {
    fn GetVersionInfo(&self, plmajorversion: *mut i32, plminorversion: *mut i32) -> windows_result::Result<()>;
    fn CreateOrOpenGroup(&self, pgroupname: &windows_core::PCWSTR, options: CONTACT_AGGREGATION_CREATE_OR_OPEN_OPTIONS, pcreatedgroup: *mut windows_core::BOOL) -> windows_result::Result<IContactAggregationGroup>;
    fn CreateExternalContact(&self) -> windows_result::Result<IContactAggregationContact>;
    fn CreateServerPerson(&self) -> windows_result::Result<IContactAggregationServerPerson>;
    fn CreateServerContactLink(&self) -> windows_result::Result<IContactAggregationLink>;
    fn Flush(&self) -> windows_result::Result<()>;
    fn OpenAggregateContact(&self, pitemid: &windows_core::PCWSTR) -> windows_result::Result<IContactAggregationAggregate>;
    fn OpenContact(&self, pitemid: &windows_core::PCWSTR) -> windows_result::Result<IContactAggregationContact>;
    fn OpenServerContactLink(&self, pitemid: &windows_core::PCWSTR) -> windows_result::Result<IContactAggregationLink>;
    fn OpenServerPerson(&self, pitemid: &windows_core::PCWSTR) -> windows_result::Result<IContactAggregationServerPerson>;
    fn get_Contacts(&self, options: CONTACT_AGGREGATION_COLLECTION_OPTIONS) -> windows_result::Result<IContactAggregationContactCollection>;
    fn get_AggregateContacts(&self, options: CONTACT_AGGREGATION_COLLECTION_OPTIONS) -> windows_result::Result<IContactAggregationAggregateCollection>;
    fn get_Groups(&self, options: CONTACT_AGGREGATION_COLLECTION_OPTIONS) -> windows_result::Result<IContactAggregationGroupCollection>;
    fn ServerPersons(&self) -> windows_result::Result<IContactAggregationServerPersonCollection>;
    fn get_ServerContactLinks(&self, ppersonitemid: &windows_core::PCWSTR) -> windows_result::Result<IContactAggregationLinkCollection>;
}
...
impl IContactAggregationServerPerson {
    ...
    pub unsafe fn SetAggregateId<P0>(&self, paggregateid: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn AntiLinkBaseline(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AntiLinkBaseline)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetAntiLinkBaseline<P0>(&self, pantilink: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn ObjectId(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ObjectId)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetObjectId<P0>(&self, pobjectid: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IContactAggregationServerPerson_Impl: windows_core::IUnknownImpl {
    ...
    fn Save(&self) -> windows_result::Result<()>;
    fn AggregateId(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetAggregateId(&self, paggregateid: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn AntiLink(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetAntiLink(&self, pantilink: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn AntiLinkBaseline(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetAntiLinkBaseline(&self, pantilink: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn FavoriteOrder(&self) -> windows_result::Result<u32>;
    fn SetFavoriteOrder(&self, favoriteorder: u32) -> windows_result::Result<()>;
    fn FavoriteOrderBaseline(&self) -> windows_result::Result<u32>;
    fn SetFavoriteOrderBaseline(&self, favoriteorder: u32) -> windows_result::Result<()>;
    fn Groups(&self) -> windows_result::Result<*mut CONTACT_AGGREGATION_BLOB>;
    fn SetGroups(&self, pgroups: *const CONTACT_AGGREGATION_BLOB) -> windows_result::Result<()>;
    fn GroupsBaseline(&self) -> windows_result::Result<*mut CONTACT_AGGREGATION_BLOB>;
    fn SetGroupsBaseline(&self, pgroups: *const CONTACT_AGGREGATION_BLOB) -> windows_result::Result<()>;
    fn Id(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn IsTombstone(&self) -> windows_result::Result<windows_core::BOOL>;
    fn SetIsTombstone(&self, istombstone: windows_core::BOOL) -> windows_result::Result<()>;
    fn LinkedAggregateId(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetLinkedAggregateId(&self, plinkedaggregateid: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn ObjectId(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetObjectId(&self, pobjectid: &windows_core::PCWSTR) -> windows_result::Result<()>;
}
...
impl IContactAggregationServerPersonCollection {
    pub unsafe fn FindFirst(&self) -> windows_result::Result<IContactAggregationServerPerson> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindFirst)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn FindFirstByServerId<P0>(&self, pserverid: P0) -> windows_result::Result<IContactAggregationServerPerson>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn FindFirstByAggregateId<P0>(&self, paggregateid: P0) -> windows_result::Result<IContactAggregationServerPerson>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn FindFirstByLinkedAggregateId<P0>(&self, paggregateid: P0) -> windows_result::Result<IContactAggregationServerPerson>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn FindNext(&self) -> windows_result::Result<IContactAggregationServerPerson> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindNext)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IContactAggregationServerPersonCollection_Impl: windows_core::IUnknownImpl {
    fn FindFirst(&self) -> windows_result::Result<IContactAggregationServerPerson>;
    fn FindFirstByServerId(&self, pserverid: &windows_core::PCWSTR) -> windows_result::Result<IContactAggregationServerPerson>;
    fn FindFirstByAggregateId(&self, paggregateid: &windows_core::PCWSTR) -> windows_result::Result<IContactAggregationServerPerson>;
    fn FindFirstByLinkedAggregateId(&self, paggregateid: &windows_core::PCWSTR) -> windows_result::Result<IContactAggregationServerPerson>;
    fn FindNext(&self) -> windows_result::Result<IContactAggregationServerPerson>;
    fn Count(&self) -> windows_result::Result<u32>;
}
...
impl IContactCollection {
    ...
    pub unsafe fn Next(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn GetCurrent(&self) -> windows_result::Result<IContact> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IContactCollection_Impl: windows_core::IUnknownImpl {
    ...
    fn Next(&self) -> windows_result::Result<()>;
    fn GetCurrent(&self) -> windows_result::Result<IContact>;
}
...
impl IContactManager {
    pub unsafe fn Initialize<P0, P1>(&self, pszappname: P0, pszappversion: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn Load<P0>(&self, pszcontactid: P0) -> windows_result::Result<IContact>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn MergeContactIDs<P0, P1>(&self, psznewcontactid: P0, pszoldcontactid: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetMeContact(&self) -> windows_result::Result<IContact> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetMeContact<P0>(&self, pmecontact: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetContactCollection(&self) -> windows_result::Result<IContactCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IContactManager_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, pszappname: &windows_core::PCWSTR, pszappversion: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn Load(&self, pszcontactid: &windows_core::PCWSTR) -> windows_result::Result<IContact>;
    fn MergeContactIDs(&self, psznewcontactid: &windows_core::PCWSTR, pszoldcontactid: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetMeContact(&self) -> windows_result::Result<IContact>;
    fn SetMeContact(&self, pmecontact: windows_core::Ref<IContact>) -> windows_result::Result<()>;
    fn GetContactCollection(&self) -> windows_result::Result<IContactCollection>;
}
...
impl IContactProperties {
    pub unsafe fn GetString<P0>(&self, pszpropertyname: P0, dwflags: u32, pszvalue: &mut [u16], pdwcchpropertyvaluerequired: *mut u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetDate<P0>(&self, pszpropertyname: P0, dwflags: u32, pftdatetime: *mut super::super::Foundation::FILETIME) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetBinary<P0>(&self, pszpropertyname: P0, dwflags: u32, pszcontenttype: &mut [u16], pdwcchcontenttyperequired: *mut u32, ppstream: *mut Option<super::Com::IStream>) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetLabels<P0>(&self, pszarrayelementname: P0, dwflags: u32, pszlabels: &mut [u16], pdwcchlabelsrequired: *mut u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetString<P0, P2>(&self, pszpropertyname: P0, dwflags: u32, pszvalue: P2) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn SetDate<P0>(&self, pszpropertyname: P0, dwflags: u32, ftdatetime: super::super::Foundation::FILETIME) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn SetBinary<P0, P2, P3>(&self, pszpropertyname: P0, dwflags: u32, pszcontenttype: P2, pstream: P3) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn SetLabels<P0>(&self, pszarrayelementname: P0, dwflags: u32, ppszlabels: &[windows_core::PCWSTR]) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn CreateArrayNode<P0>(&self, pszarrayname: P0, dwflags: u32, fappend: bool, psznewarrayelementname: &mut [u16], pdwcchnewarrayelementnamerequired: *mut u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn DeleteProperty<P0>(&self, pszpropertyname: P0, dwflags: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn DeleteArrayNode<P0>(&self, pszarrayelementname: P0, dwflags: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn DeleteLabels<P0>(&self, pszarrayelementname: P0, dwflags: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetPropertyCollection<P2>(&self, pppropertycollection: *mut Option<IContactPropertyCollection>, dwflags: u32, pszmultivaluename: P2, ppszlabels: &[windows_core::PCWSTR], fanylabelmatches: bool) -> windows_result::Result<()>
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IContactProperties_Impl: windows_core::IUnknownImpl {
    fn GetString(&self, pszpropertyname: &windows_core::PCWSTR, dwflags: u32, pszvalue: windows_core::PWSTR, cchvalue: u32, pdwcchpropertyvaluerequired: *mut u32) -> windows_result::Result<()>;
    fn GetDate(&self, pszpropertyname: &windows_core::PCWSTR, dwflags: u32, pftdatetime: *mut super::super::Foundation::FILETIME) -> windows_result::Result<()>;
    fn GetBinary(&self, pszpropertyname: &windows_core::PCWSTR, dwflags: u32, pszcontenttype: windows_core::PWSTR, cchcontenttype: u32, pdwcchcontenttyperequired: *mut u32, ppstream: windows_core::OutRef<super::Com::IStream>) -> windows_result::Result<()>;
    fn GetLabels(&self, pszarrayelementname: &windows_core::PCWSTR, dwflags: u32, pszlabels: windows_core::PWSTR, cchlabels: u32, pdwcchlabelsrequired: *mut u32) -> windows_result::Result<()>;
    fn SetString(&self, pszpropertyname: &windows_core::PCWSTR, dwflags: u32, pszvalue: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn SetDate(&self, pszpropertyname: &windows_core::PCWSTR, dwflags: u32, ftdatetime: &super::super::Foundation::FILETIME) -> windows_result::Result<()>;
    fn SetBinary(&self, pszpropertyname: &windows_core::PCWSTR, dwflags: u32, pszcontenttype: &windows_core::PCWSTR, pstream: windows_core::Ref<super::Com::IStream>) -> windows_result::Result<()>;
    fn SetLabels(&self, pszarrayelementname: &windows_core::PCWSTR, dwflags: u32, dwlabelcount: u32, ppszlabels: *const windows_core::PCWSTR) -> windows_result::Result<()>;
    fn CreateArrayNode(&self, pszarrayname: &windows_core::PCWSTR, dwflags: u32, fappend: windows_core::BOOL, psznewarrayelementname: windows_core::PWSTR, cchnewarrayelementname: u32, pdwcchnewarrayelementnamerequired: *mut u32) -> windows_result::Result<()>;
    fn DeleteProperty(&self, pszpropertyname: &windows_core::PCWSTR, dwflags: u32) -> windows_result::Result<()>;
    fn DeleteArrayNode(&self, pszarrayelementname: &windows_core::PCWSTR, dwflags: u32) -> windows_result::Result<()>;
    fn DeleteLabels(&self, pszarrayelementname: &windows_core::PCWSTR, dwflags: u32) -> windows_result::Result<()>;
    fn GetPropertyCollection(&self, pppropertycollection: windows_core::OutRef<IContactPropertyCollection>, dwflags: u32, pszmultivaluename: &windows_core::PCWSTR, dwlabelcount: u32, ppszlabels: *const windows_core::PCWSTR, fanylabelmatches: windows_core::BOOL) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IContactPropertyCollection {
    ...
    pub unsafe fn GetPropertyName(&self, pszpropertyname: &mut [u16], pdwcchpropertynamerequired: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetPropertyType(&self, pdwtype: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetPropertyType)(windows_core::Interface::as_raw(self), pdwtype as _).ok() }
    }
    pub unsafe fn GetPropertyVersion(&self, pdwversion: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetPropertyVersion)(windows_core::Interface::as_raw(self), pdwversion as _).ok() }
    }
    pub unsafe fn GetPropertyModificationDate(&self, pftmodificationdate: *mut super::super::Foundation::FILETIME) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetPropertyArrayElementID(&self, pszarrayelementid: &mut [u16], pdwccharrayelementidrequired: *mut u32) -> windows_result::Result<()> {
...
pub trait IContactPropertyCollection_Impl: windows_core::IUnknownImpl {
    fn Reset(&self) -> windows_result::Result<()>;
    fn Next(&self) -> windows_result::Result<()>;
    fn GetPropertyName(&self, pszpropertyname: windows_core::PWSTR, cchpropertyname: u32, pdwcchpropertynamerequired: *mut u32) -> windows_result::Result<()>;
    fn GetPropertyType(&self, pdwtype: *mut u32) -> windows_result::Result<()>;
    fn GetPropertyVersion(&self, pdwversion: *mut u32) -> windows_result::Result<()>;
    fn GetPropertyModificationDate(&self, pftmodificationdate: *mut super::super::Foundation::FILETIME) -> windows_result::Result<()>;
    fn GetPropertyArrayElementID(&self, pszarrayelementid: windows_core::PWSTR, ccharrayelementid: u32, pdwccharrayelementidrequired: *mut u32) -> windows_result::Result<()>;
}
