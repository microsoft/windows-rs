...
impl IWsbApplicationAsyncVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWsbApplicationAsyncImpl, const OFFSET: isize>() -> IWsbApplicationAsyncVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IWsbApplicationAsync>, ::windows::core::GetTrustLevel, QueryStatus::<Impl, OFFSET>, Abort::<Impl, OFFSET>)
    }
}
...
impl IWsbApplicationBackupSupportVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWsbApplicationBackupSupportImpl, const OFFSET: isize>() -> IWsbApplicationBackupSupportVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IWsbApplicationBackupSupport>, ::windows::core::GetTrustLevel, CheckConsistency::<Impl, OFFSET>)
    }
}
...
impl IWsbApplicationRestoreSupportVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWsbApplicationRestoreSupportImpl, const OFFSET: isize>() -> IWsbApplicationRestoreSupportVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IWsbApplicationRestoreSupport>, ::windows::core::GetTrustLevel, PreRestore::<Impl, OFFSET>, PostRestore::<Impl, OFFSET>, OrderComponents::<Impl, OFFSET>, IsRollForwardSupported::<Impl, OFFSET>)
    }
}
