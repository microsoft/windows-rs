#[inline]
pub unsafe fn BroadcastSystemMessageA(flags: u32, lpinfo: *mut u32, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> i32 {
    ...
    unsafe { BroadcastSystemMessageA(flags, lpinfo as _, msg, wparam, lparam) }
}
#[inline]
pub unsafe fn BroadcastSystemMessageExA(flags: BROADCAST_SYSTEM_MESSAGE_FLAGS, lpinfo: *mut BROADCAST_SYSTEM_MESSAGE_INFO, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM, pbsminfo: *mut BSMINFO) -> i32 {
    ...
    unsafe { BroadcastSystemMessageExA(flags, lpinfo as _, msg, wparam, lparam, pbsminfo as _) }
}
#[inline]
pub unsafe fn BroadcastSystemMessageExW(flags: BROADCAST_SYSTEM_MESSAGE_FLAGS, lpinfo: *mut BROADCAST_SYSTEM_MESSAGE_INFO, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM, pbsminfo: *mut BSMINFO) -> i32 {
    ...
    unsafe { BroadcastSystemMessageExW(flags, lpinfo as _, msg, wparam, lparam, pbsminfo as _) }
}
#[inline]
pub unsafe fn BroadcastSystemMessageW(flags: BROADCAST_SYSTEM_MESSAGE_FLAGS, lpinfo: *mut BROADCAST_SYSTEM_MESSAGE_INFO, msg: u32, wparam: super::super::Foundation::WPARAM, lparam: super::super::Foundation::LPARAM) -> i32 {
    ...
    unsafe { BroadcastSystemMessageW(flags, lpinfo as _, msg, wparam, lparam) }
}
#[inline]
pub unsafe fn CloseDesktop(hdesktop: HDESK) -> windows_core::BOOL {
    windows_core::link!("user32.dll" "system" fn CloseDesktop(hdesktop : HDESK) -> windows_core::BOOL);
    unsafe { CloseDesktop(hdesktop) }
}
#[inline]
pub unsafe fn CloseWindowStation(hwinsta: HWINSTA) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn CreateDesktopA<P0, P1>(lpszdesktop: P0, lpszdevice: P1, pdevmode: *const super::super::Graphics::Gdi::DEVMODEA, dwflags: DESKTOP_CONTROL_FLAGS, dwdesiredaccess: u32, lpsa: *const super::super::Security::SECURITY_ATTRIBUTES) -> HDESK
where
    ...
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { CreateDesktopA(lpszdesktop.param().abi(), lpszdevice.param().abi(), pdevmode, dwflags, dwdesiredaccess, lpsa) }
}
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_Security"))]
#[inline]
pub unsafe fn CreateDesktopExA<P0, P1>(lpszdesktop: P0, lpszdevice: P1, pdevmode: *const super::super::Graphics::Gdi::DEVMODEA, dwflags: DESKTOP_CONTROL_FLAGS, dwdesiredaccess: u32, lpsa: *const super::super::Security::SECURITY_ATTRIBUTES, ulheapsize: u32, pvoid: *const core::ffi::c_void) -> HDESK
where
    P0: windows_core::Param<windows_core::PCSTR>,
    P1: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { CreateDesktopExA(lpszdesktop.param().abi(), lpszdevice.param().abi(), pdevmode, dwflags, dwdesiredaccess, lpsa, ulheapsize, pvoid) }
}
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_Security"))]
#[inline]
pub unsafe fn CreateDesktopExW<P0, P1>(lpszdesktop: P0, lpszdevice: P1, pdevmode: *const super::super::Graphics::Gdi::DEVMODEW, dwflags: DESKTOP_CONTROL_FLAGS, dwdesiredaccess: u32, lpsa: *const super::super::Security::SECURITY_ATTRIBUTES, ulheapsize: u32, pvoid: *const core::ffi::c_void) -> HDESK
where
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { CreateDesktopExW(lpszdesktop.param().abi(), lpszdevice.param().abi(), pdevmode, dwflags, dwdesiredaccess, lpsa, ulheapsize, pvoid) }
}
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_Security"))]
#[inline]
pub unsafe fn CreateDesktopW<P0, P1>(lpszdesktop: P0, lpszdevice: P1, pdevmode: *mut super::super::Graphics::Gdi::DEVMODEW, dwflags: DESKTOP_CONTROL_FLAGS, dwdesiredaccess: u32, lpsa: *mut super::super::Security::SECURITY_ATTRIBUTES) -> HDESK
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("user32.dll" "system" fn CreateDesktopW(lpszdesktop : windows_core::PCWSTR, lpszdevice : windows_core::PCWSTR, pdevmode : *mut super::super::Graphics::Gdi:: DEVMODEW, dwflags : DESKTOP_CONTROL_FLAGS, dwdesiredaccess : u32, lpsa : *mut super::super::Security:: SECURITY_ATTRIBUTES) -> HDESK);
    unsafe { CreateDesktopW(lpszdesktop.param().abi(), lpszdevice.param().abi(), pdevmode as _, dwflags, dwdesiredaccess, lpsa as _) }
}
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn CreateWindowStationA<P0>(lpwinsta: P0, dwflags: u32, dwdesiredaccess: u32, lpsa: *mut super::super::Security::SECURITY_ATTRIBUTES) -> HWINSTA
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_core::link!("user32.dll" "system" fn CreateWindowStationA(lpwinsta : windows_core::PCSTR, dwflags : u32, dwdesiredaccess : u32, lpsa : *mut super::super::Security:: SECURITY_ATTRIBUTES) -> HWINSTA);
    unsafe { CreateWindowStationA(lpwinsta.param().abi(), dwflags, dwdesiredaccess, lpsa as _) }
}
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn CreateWindowStationW<P0>(lpwinsta: P0, dwflags: u32, dwdesiredaccess: u32, lpsa: *mut super::super::Security::SECURITY_ATTRIBUTES) -> HWINSTA
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("user32.dll" "system" fn CreateWindowStationW(lpwinsta : windows_core::PCWSTR, dwflags : u32, dwdesiredaccess : u32, lpsa : *mut super::super::Security:: SECURITY_ATTRIBUTES) -> HWINSTA);
    unsafe { CreateWindowStationW(lpwinsta.param().abi(), dwflags, dwdesiredaccess, lpsa as _) }
}
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn EnumDesktopWindows(hdesktop: HDESK, lpfn: super::super::UI::WindowsAndMessaging::WNDENUMPROC, lparam: super::super::Foundation::LPARAM) -> windows_core::BOOL {
    ...
    unsafe { EnumDesktopWindows(hdesktop, lpfn, lparam) }
}
#[inline]
pub unsafe fn EnumDesktopsA(hwinsta: HWINSTA, lpenumfunc: DESKTOPENUMPROCA, lparam: super::super::Foundation::LPARAM) -> windows_core::BOOL {
    ...
    unsafe { EnumDesktopsA(hwinsta, lpenumfunc, lparam) }
}
#[inline]
pub unsafe fn EnumDesktopsW(hwinsta: HWINSTA, lpenumfunc: DESKTOPENUMPROCW, lparam: super::super::Foundation::LPARAM) -> windows_core::BOOL {
    ...
    unsafe { EnumDesktopsW(hwinsta, lpenumfunc, lparam) }
}
#[inline]
pub unsafe fn EnumWindowStationsA(lpenumfunc: WINSTAENUMPROCA, lparam: super::super::Foundation::LPARAM) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn EnumWindowStationsW(lpenumfunc: WINSTAENUMPROCW, lparam: super::super::Foundation::LPARAM) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn GetUserObjectInformationA(hobj: super::super::Foundation::HANDLE, nindex: USER_OBJECT_INFORMATION_INDEX, pvinfo: *mut core::ffi::c_void, nlength: u32, lpnlengthneeded: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { GetUserObjectInformationA(hobj, nindex, pvinfo as _, nlength, lpnlengthneeded as _) }
}
#[inline]
pub unsafe fn GetUserObjectInformationW(hobj: super::super::Foundation::HANDLE, nindex: USER_OBJECT_INFORMATION_INDEX, pvinfo: *mut core::ffi::c_void, nlength: u32, lpnlengthneeded: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { GetUserObjectInformationW(hobj, nindex, pvinfo as _, nlength, lpnlengthneeded as _) }
}
#[inline]
pub unsafe fn OpenDesktopA<P0>(lpszdesktop: P0, dwflags: DESKTOP_CONTROL_FLAGS, finherit: bool, dwdesiredaccess: u32) -> HDESK
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
...
#[inline]
pub unsafe fn OpenDesktopW<P0>(lpszdesktop: P0, dwflags: DESKTOP_CONTROL_FLAGS, finherit: bool, dwdesiredaccess: u32) -> HDESK
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn OpenInputDesktop(dwflags: DESKTOP_CONTROL_FLAGS, finherit: bool, dwdesiredaccess: DESKTOP_ACCESS_FLAGS) -> HDESK {
...
#[inline]
pub unsafe fn OpenWindowStationA<P0>(lpszwinsta: P0, finherit: bool, dwdesiredaccess: u32) -> HWINSTA
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
...
#[inline]
pub unsafe fn OpenWindowStationW<P0>(lpszwinsta: P0, finherit: bool, dwdesiredaccess: u32) -> HWINSTA
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn SetProcessWindowStation(hwinsta: HWINSTA) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn SetThreadDesktop(hdesktop: HDESK) -> windows_core::BOOL {
    windows_core::link!("user32.dll" "system" fn SetThreadDesktop(hdesktop : HDESK) -> windows_core::BOOL);
    unsafe { SetThreadDesktop(hdesktop) }
}
#[inline]
pub unsafe fn SetUserObjectInformationA(hobj: super::super::Foundation::HANDLE, nindex: i32, pvinfo: *const core::ffi::c_void, nlength: u32) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn SetUserObjectInformationW(hobj: super::super::Foundation::HANDLE, nindex: i32, pvinfo: *mut core::ffi::c_void, nlength: u32) -> windows_core::BOOL {
    windows_core::link!("user32.dll" "system" fn SetUserObjectInformationW(hobj : super::super::Foundation:: HANDLE, nindex : i32, pvinfo : *mut core::ffi::c_void, nlength : u32) -> windows_core::BOOL);
    unsafe { SetUserObjectInformationW(hobj, nindex, pvinfo as _, nlength) }
}
#[inline]
pub unsafe fn SwitchDesktop(hdesktop: HDESK) -> windows_core::BOOL {
