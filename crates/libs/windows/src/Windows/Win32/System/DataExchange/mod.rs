...
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn AddAtomA ( lpstring : :: windows::core::PCSTR ) -> u16 );
...
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn AddAtomW ( lpstring : :: windows::core::PCWSTR ) -> u16 );
...
pub unsafe fn CountClipboardFormats() -> i32 {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn CountClipboardFormats ( ) -> i32 );
...
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeAbandonTransaction ( idinst : u32 , hconv : HCONV , idtransaction : u32 ) -> super::super::Foundation:: BOOL );
...
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeAccessData ( hdata : HDDEDATA , pcbdatasize : *mut u32 ) -> *mut u8 );
...
where
    P0: ::std::convert::Into<HDDEDATA>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeAddData ( hdata : HDDEDATA , psrc : *const u8 , cb : u32 , cboff : u32 ) -> HDDEDATA );
...
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeClientTransaction ( pdata : *const u8 , cbdata : u32 , hconv : HCONV , hszitem : HSZ , wfmt : u32 , wtype : DDE_CLIENT_TRANSACTION_TYPE , dwtimeout : u32 , pdwresult : *mut u32 ) -> HDDEDATA );
...
where
    ...
    P1: ::std::convert::Into<HSZ>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeCmpStringHandles ( hsz1 : HSZ , hsz2 : HSZ ) -> i32 );
...
where
    ...
    P1: ::std::convert::Into<HSZ>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeConnect ( idinst : u32 , hszservice : HSZ , hsztopic : HSZ , pcc : *const CONVCONTEXT ) -> HCONV );
...
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeConnectList ( idinst : u32 , hszservice : HSZ , hsztopic : HSZ , hconvlist : HCONVLIST , pcc : *const CONVCONTEXT ) -> HCONVLIST );
...
where
    P0: ::std::convert::Into<HSZ>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeCreateDataHandle ( idinst : u32 , psrc : *const u8 , cb : u32 , cboff : u32 , hszitem : HSZ , wfmt : u32 , afcmd : u32 ) -> HDDEDATA );
...
where
    P0: ::std::convert::Into<::windows::core::PCSTR>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeCreateStringHandleA ( idinst : u32 , psz : :: windows::core::PCSTR , icodepage : i32 ) -> HSZ );
...
where
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeCreateStringHandleW ( idinst : u32 , psz : :: windows::core::PCWSTR , icodepage : i32 ) -> HSZ );
...
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeDisconnectList ( hconvlist : HCONVLIST ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<HCONV>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeEnableCallback ( idinst : u32 , hconv : HCONV , wcmd : DDE_ENABLE_CALLBACK_CMD ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<HDDEDATA>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeFreeDataHandle ( hdata : HDDEDATA ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<HSZ>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeFreeStringHandle ( idinst : u32 , hsz : HSZ ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<HDDEDATA>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeGetData ( hdata : HDDEDATA , pdst : *mut u8 , cbmax : u32 , cboff : u32 ) -> u32 );
...
pub unsafe fn DdeGetLastError(idinst: u32) -> u32 {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeGetLastError ( idinst : u32 ) -> u32 );
...
pub unsafe fn DdeInitializeA(pidinst: *mut u32, pfncallback: PFNCALLBACK, afcmd: DDE_INITIALIZE_COMMAND, ulres: u32) -> u32 {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeInitializeA ( pidinst : *mut u32 , pfncallback : * mut::core::ffi::c_void , afcmd : DDE_INITIALIZE_COMMAND , ulres : u32 ) -> u32 );
...
pub unsafe fn DdeInitializeW(pidinst: *mut u32, pfncallback: PFNCALLBACK, afcmd: DDE_INITIALIZE_COMMAND, ulres: u32) -> u32 {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeInitializeW ( pidinst : *mut u32 , pfncallback : * mut::core::ffi::c_void , afcmd : DDE_INITIALIZE_COMMAND , ulres : u32 ) -> u32 );
...
where
    ...
    P1: ::std::convert::Into<HSZ>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeNameService ( idinst : u32 , hsz1 : HSZ , hsz2 : HSZ , afcmd : DDE_NAME_SERVICE_CMD ) -> HDDEDATA );
...
where
    P0: ::std::convert::Into<HCONV>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeQueryConvInfo ( hconv : HCONV , idtransaction : u32 , pconvinfo : *mut CONVINFO ) -> u32 );
...
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeQueryNextServer ( hconvlist : HCONVLIST , hconvprev : HCONV ) -> HCONV );
...
where
    P0: ::std::convert::Into<HSZ>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeQueryStringA ( idinst : u32 , hsz : HSZ , psz : :: windows::core::PSTR , cchmax : u32 , icodepage : i32 ) -> u32 );
...
where
    P0: ::std::convert::Into<HSZ>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeQueryStringW ( idinst : u32 , hsz : HSZ , psz : :: windows::core::PWSTR , cchmax : u32 , icodepage : i32 ) -> u32 );
...
where
    P0: ::std::convert::Into<HCONV>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeReconnect ( hconv : HCONV ) -> HCONV );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DdeSetQualityOfService ( hwndclient : super::super::Foundation:: HWND , pqosnew : *const super::super::Security:: SECURITY_QUALITY_OF_SERVICE , pqosprev : *mut super::super::Security:: SECURITY_QUALITY_OF_SERVICE ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn DeleteAtom(natom: u16) -> u16 {
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn DeleteAtom ( natom : u16 ) -> u16 );
    DeleteAtom(natom)
}
#[doc = "*Required features: `\"Win32_System_DataExchange\"`, `\"Win32_Foundation\"`*"]
#[cfg(feature = "Win32_Foundation")]
...
pub unsafe fn EnumClipboardFormats(format: u32) -> u32 {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn EnumClipboardFormats ( format : u32 ) -> u32 );
...
where
    P0: ::std::convert::Into<::windows::core::PCSTR>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn FindAtomA ( lpstring : :: windows::core::PCSTR ) -> u16 );
...
where
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn FindAtomW ( lpstring : :: windows::core::PCWSTR ) -> u16 );
...
pub unsafe fn GetAtomNameA(natom: u16, lpbuffer: &mut [u8]) -> u32 {
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GetAtomNameA ( natom : u16 , lpbuffer : :: windows::core::PSTR , nsize : i32 ) -> u32 );
...
pub unsafe fn GetAtomNameW(natom: u16, lpbuffer: &mut [u16]) -> u32 {
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GetAtomNameW ( natom : u16 , lpbuffer : :: windows::core::PWSTR , nsize : i32 ) -> u32 );
...
pub unsafe fn GetClipboardData(uformat: u32) -> ::windows::core::Result<super::super::Foundation::HANDLE> {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn GetClipboardData ( uformat : u32 ) -> super::super::Foundation:: HANDLE );
...
pub unsafe fn GetClipboardFormatNameA(format: u32, lpszformatname: &mut [u8]) -> i32 {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn GetClipboardFormatNameA ( format : u32 , lpszformatname : :: windows::core::PSTR , cchmaxcount : i32 ) -> i32 );
...
pub unsafe fn GetClipboardFormatNameW(format: u32, lpszformatname: &mut [u16]) -> i32 {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn GetClipboardFormatNameW ( format : u32 , lpszformatname : :: windows::core::PWSTR , cchmaxcount : i32 ) -> i32 );
...
pub unsafe fn GetClipboardOwner() -> super::super::Foundation::HWND {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn GetClipboardOwner ( ) -> super::super::Foundation:: HWND );
    GetClipboardOwner()
}
#[doc = "*Required features: `\"Win32_System_DataExchange\"`*"]
#[inline]
pub unsafe fn GetClipboardSequenceNumber() -> u32 {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn GetClipboardSequenceNumber ( ) -> u32 );
...
pub unsafe fn GetClipboardViewer() -> super::super::Foundation::HWND {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn GetClipboardViewer ( ) -> super::super::Foundation:: HWND );
    GetClipboardViewer()
}
#[doc = "*Required features: `\"Win32_System_DataExchange\"`, `\"Win32_Foundation\"`*"]
#[cfg(feature = "Win32_Foundation")]
...
pub unsafe fn GetOpenClipboardWindow() -> super::super::Foundation::HWND {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn GetOpenClipboardWindow ( ) -> super::super::Foundation:: HWND );
    GetOpenClipboardWindow()
}
#[doc = "*Required features: `\"Win32_System_DataExchange\"`*"]
#[inline]
pub unsafe fn GetPriorityClipboardFormat(paformatprioritylist: &[u32]) -> i32 {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn GetPriorityClipboardFormat ( paformatprioritylist : *const u32 , cformats : i32 ) -> i32 );
...
where
    P0: ::std::convert::Into<::windows::core::PCSTR>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GlobalAddAtomA ( lpstring : :: windows::core::PCSTR ) -> u16 );
...
where
    P0: ::std::convert::Into<::windows::core::PCSTR>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GlobalAddAtomExA ( lpstring : :: windows::core::PCSTR , flags : u32 ) -> u16 );
...
where
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GlobalAddAtomExW ( lpstring : :: windows::core::PCWSTR , flags : u32 ) -> u16 );
...
where
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GlobalAddAtomW ( lpstring : :: windows::core::PCWSTR ) -> u16 );
    GlobalAddAtomW(lpstring.into())
}
#[doc = "*Required features: `\"Win32_System_DataExchange\"`*"]
#[inline]
pub unsafe fn GlobalDeleteAtom(natom: u16) -> u16 {
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GlobalDeleteAtom ( natom : u16 ) -> u16 );
...
where
    P0: ::std::convert::Into<::windows::core::PCSTR>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GlobalFindAtomA ( lpstring : :: windows::core::PCSTR ) -> u16 );
...
where
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GlobalFindAtomW ( lpstring : :: windows::core::PCWSTR ) -> u16 );
    GlobalFindAtomW(lpstring.into())
}
#[doc = "*Required features: `\"Win32_System_DataExchange\"`*"]
#[inline]
pub unsafe fn GlobalGetAtomNameA(natom: u16, lpbuffer: &mut [u8]) -> u32 {
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GlobalGetAtomNameA ( natom : u16 , lpbuffer : :: windows::core::PSTR , nsize : i32 ) -> u32 );
...
pub unsafe fn GlobalGetAtomNameW(natom: u16, lpbuffer: &mut [u16]) -> u32 {
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GlobalGetAtomNameW ( natom : u16 , lpbuffer : :: windows::core::PWSTR , nsize : i32 ) -> u32 );
...
pub unsafe fn IsClipboardFormatAvailable(format: u32) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn IsClipboardFormatAvailable ( format : u32 ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn PackDDElParam(msg: u32, uilo: usize, uihi: usize) -> super::super::Foundation::LPARAM {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn PackDDElParam ( msg : u32 , uilo : usize , uihi : usize ) -> super::super::Foundation:: LPARAM );
...
where
    P0: ::std::convert::Into<::windows::core::PCSTR>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn RegisterClipboardFormatA ( lpszformat : :: windows::core::PCSTR ) -> u32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::LPARAM>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn ReuseDDElParam ( lparam : super::super::Foundation:: LPARAM , msgin : u32 , msgout : u32 , uilo : usize , uihi : usize ) -> super::super::Foundation:: LPARAM );
...
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn SetClipboardData ( uformat : u32 , hmem : super::super::Foundation:: HANDLE ) -> super::super::Foundation:: HANDLE );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn SetClipboardViewer ( hwndnewviewer : super::super::Foundation:: HWND ) -> super::super::Foundation:: HWND );
...
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn SetWinMetaFileBits ( nsize : u32 , lpmeta16data : *const u8 , hdcref : super::super::Graphics::Gdi:: HDC , lpmfp : *const METAFILEPICT ) -> super::super::Graphics::Gdi:: HENHMETAFILE );
...
where
    P0: ::std::convert::Into<super::super::Foundation::LPARAM>,
{
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn UnpackDDElParam ( msg : u32 , lparam : super::super::Foundation:: LPARAM , puilo : *mut usize , puihi : *mut usize ) -> super::super::Foundation:: BOOL );
