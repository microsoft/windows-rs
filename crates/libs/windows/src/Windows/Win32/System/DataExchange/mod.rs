...
#[inline]
pub unsafe fn AddClipboardFormatListener(hwnd: super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn CloseClipboard() -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DdeImpersonateClient(hconv: HCONV) -> Result<(), windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn DdeSetQualityOfService(hwndclient: super::super::Foundation::HWND, pqosnew: *const super::super::Security::SECURITY_QUALITY_OF_SERVICE, pqosprev: *mut super::super::Security::SECURITY_QUALITY_OF_SERVICE) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn EmptyClipboard() -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetClipboardData(uformat: u32) -> Result<super::super::Foundation::HANDLE, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetClipboardOwner() -> Result<super::super::Foundation::HWND, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetClipboardViewer() -> Result<super::super::Foundation::HWND, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetOpenClipboardWindow() -> Result<super::super::Foundation::HWND, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetUpdatedClipboardFormats(lpuiformats: &mut [u32], pcformatsout: *mut u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn ImpersonateDdeClientWindow(hwndclient: super::super::Foundation::HWND, hwndserver: super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn IsClipboardFormatAvailable(format: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn OpenClipboard(hwndnewowner: Option<super::super::Foundation::HWND>) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn RemoveClipboardFormatListener(hwnd: super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn SetClipboardData(uformat: u32, hmem: Option<super::super::Foundation::HANDLE>) -> Result<super::super::Foundation::HANDLE, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn SetClipboardViewer(hwndnewviewer: super::super::Foundation::HWND) -> Result<super::super::Foundation::HWND, windows_result::HRESULT> {
