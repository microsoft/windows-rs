...
#[inline]
pub unsafe fn GetComputerNameExA(nametype: COMPUTER_NAME_FORMAT, lpbuffer: Option<windows_core::PSTR>, nsize: *mut u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetComputerNameExW(nametype: COMPUTER_NAME_FORMAT, lpbuffer: Option<windows_core::PWSTR>, nsize: *mut u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetFirmwareType(firmwaretype: *mut FIRMWARE_TYPE) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetIntegratedDisplaySize() -> Result<f64, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetLogicalProcessorInformation(buffer: Option<*mut SYSTEM_LOGICAL_PROCESSOR_INFORMATION>, returnedlength: *mut u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetLogicalProcessorInformationEx(relationshiptype: LOGICAL_PROCESSOR_RELATIONSHIP, buffer: Option<*mut SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX>, returnedlength: *mut u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetPhysicallyInstalledSystemMemory(totalmemoryinkilobytes: *mut u64) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetProcessorSystemCycleTime(group: u16, buffer: Option<*mut SYSTEM_PROCESSOR_CYCLE_TIME_INFORMATION>, returnedlength: *mut u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetSystemTimeAdjustment(lptimeadjustment: *mut u32, lptimeincrement: *mut u32, lptimeadjustmentdisabled: *mut windows_core::BOOL) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetSystemTimeAdjustmentPrecise(lptimeadjustment: *mut u64, lptimeincrement: *mut u64, lptimeadjustmentdisabled: *mut windows_core::BOOL) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetVersionExA(lpversioninformation: *mut OSVERSIONINFOA) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetVersionExW(lpversioninformation: *mut OSVERSIONINFOW) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GlobalMemoryStatusEx(lpbuffer: *mut MEMORYSTATUSEX) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn IsWow64GuestMachineSupported(wowguestmachine: IMAGE_FILE_MACHINE) -> Result<windows_core::BOOL, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn SetComputerNameA<P0>(lpcomputername: P0) -> Result<(), windows_result::HRESULT>
where
...
#[inline]
pub unsafe fn SetComputerNameExA<P1>(nametype: COMPUTER_NAME_FORMAT, lpbuffer: P1) -> Result<(), windows_result::HRESULT>
where
...
#[inline]
pub unsafe fn SetComputerNameExW<P1>(nametype: COMPUTER_NAME_FORMAT, lpbuffer: P1) -> Result<(), windows_result::HRESULT>
where
...
#[inline]
pub unsafe fn SetComputerNameW<P0>(lpcomputername: P0) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn SetLocalTime(lpsystemtime: *const super::super::Foundation::SYSTEMTIME) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn SetSystemTime(lpsystemtime: *const super::super::Foundation::SYSTEMTIME) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn SetSystemTimeAdjustment(dwtimeadjustment: u32, btimeadjustmentdisabled: bool) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn SetSystemTimeAdjustmentPrecise(dwtimeadjustment: u64, btimeadjustmentdisabled: bool) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn VerifyVersionInfoA(lpversioninformation: *mut OSVERSIONINFOEXA, dwtypemask: VER_FLAGS, dwlconditionmask: u64) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn VerifyVersionInfoW(lpversioninformation: *mut OSVERSIONINFOEXW, dwtypemask: VER_FLAGS, dwlconditionmask: u64) -> Result<(), windows_result::HRESULT> {
