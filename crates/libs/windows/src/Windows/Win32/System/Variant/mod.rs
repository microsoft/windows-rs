...
pub const DPF_ERROR: DRAWPROGRESSFLAGS = DRAWPROGRESSFLAGS(4);
pub const DPF_MARQUEE: DRAWPROGRESSFLAGS = DRAWPROGRESSFLAGS(1);
pub const DPF_MARQUEE_COMPLETE: DRAWPROGRESSFLAGS = DRAWPROGRESSFLAGS(2);
pub const DPF_NONE: DRAWPROGRESSFLAGS = DRAWPROGRESSFLAGS(0);
pub const DPF_STOPPED: DRAWPROGRESSFLAGS = DRAWPROGRESSFLAGS(16);
pub const DPF_WARNING: DRAWPROGRESSFLAGS = DRAWPROGRESSFLAGS(8);
#[repr(transparent)]
...
pub const PSTF_LOCAL: PSTIME_FLAGS = PSTIME_FLAGS(1);
pub const PSTF_UTC: PSTIME_FLAGS = PSTIME_FLAGS(0);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const VARIANT_ALPHABOOL: VAR_CHANGE_FLAGS = VAR_CHANGE_FLAGS(2);
pub const VARIANT_CALENDAR_GREGORIAN: VAR_CHANGE_FLAGS = VAR_CHANGE_FLAGS(64);
pub const VARIANT_CALENDAR_HIJRI: VAR_CHANGE_FLAGS = VAR_CHANGE_FLAGS(8);
pub const VARIANT_CALENDAR_THAI: VAR_CHANGE_FLAGS = VAR_CHANGE_FLAGS(32);
pub const VARIANT_LOCALBOOL: VAR_CHANGE_FLAGS = VAR_CHANGE_FLAGS(16);
pub const VARIANT_NOUSEROVERRIDE: VAR_CHANGE_FLAGS = VAR_CHANGE_FLAGS(4);
pub const VARIANT_NOVALUEPROP: VAR_CHANGE_FLAGS = VAR_CHANGE_FLAGS(1);
pub const VARIANT_USE_NLS: VAR_CHANGE_FLAGS = VAR_CHANGE_FLAGS(128);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const VT_ARRAY: VARENUM = VARENUM(8192);
pub const VT_BLOB: VARENUM = VARENUM(65);
pub const VT_BLOB_OBJECT: VARENUM = VARENUM(70);
pub const VT_BOOL: VARENUM = VARENUM(11);
pub const VT_BSTR: VARENUM = VARENUM(8);
pub const VT_BSTR_BLOB: VARENUM = VARENUM(4095);
pub const VT_BYREF: VARENUM = VARENUM(16384);
pub const VT_CARRAY: VARENUM = VARENUM(28);
pub const VT_CF: VARENUM = VARENUM(71);
pub const VT_CLSID: VARENUM = VARENUM(72);
pub const VT_CY: VARENUM = VARENUM(6);
pub const VT_DATE: VARENUM = VARENUM(7);
pub const VT_DECIMAL: VARENUM = VARENUM(14);
pub const VT_DISPATCH: VARENUM = VARENUM(9);
pub const VT_EMPTY: VARENUM = VARENUM(0);
pub const VT_ERROR: VARENUM = VARENUM(10);
pub const VT_FILETIME: VARENUM = VARENUM(64);
pub const VT_HRESULT: VARENUM = VARENUM(25);
pub const VT_I1: VARENUM = VARENUM(16);
pub const VT_I2: VARENUM = VARENUM(2);
pub const VT_I4: VARENUM = VARENUM(3);
pub const VT_I8: VARENUM = VARENUM(20);
pub const VT_ILLEGAL: VARENUM = VARENUM(65535);
pub const VT_ILLEGALMASKED: VARENUM = VARENUM(4095);
pub const VT_INT: VARENUM = VARENUM(22);
pub const VT_INT_PTR: VARENUM = VARENUM(37);
pub const VT_LPSTR: VARENUM = VARENUM(30);
pub const VT_LPWSTR: VARENUM = VARENUM(31);
pub const VT_NULL: VARENUM = VARENUM(1);
pub const VT_PTR: VARENUM = VARENUM(26);
pub const VT_R4: VARENUM = VARENUM(4);
pub const VT_R8: VARENUM = VARENUM(5);
pub const VT_RECORD: VARENUM = VARENUM(36);
pub const VT_RESERVED: VARENUM = VARENUM(32768);
pub const VT_SAFEARRAY: VARENUM = VARENUM(27);
pub const VT_STORAGE: VARENUM = VARENUM(67);
pub const VT_STORED_OBJECT: VARENUM = VARENUM(69);
pub const VT_STREAM: VARENUM = VARENUM(66);
pub const VT_STREAMED_OBJECT: VARENUM = VARENUM(68);
pub const VT_TYPEMASK: VARENUM = VARENUM(4095);
pub const VT_UI1: VARENUM = VARENUM(17);
pub const VT_UI2: VARENUM = VARENUM(18);
pub const VT_UI4: VARENUM = VARENUM(19);
pub const VT_UI8: VARENUM = VARENUM(21);
pub const VT_UINT: VARENUM = VARENUM(23);
pub const VT_UINT_PTR: VARENUM = VARENUM(38);
pub const VT_UNKNOWN: VARENUM = VARENUM(13);
pub const VT_USERDEFINED: VARENUM = VARENUM(29);
pub const VT_VARIANT: VARENUM = VARENUM(12);
pub const VT_VECTOR: VARENUM = VARENUM(4096);
pub const VT_VERSIONED_STREAM: VARENUM = VARENUM(73);
pub const VT_VOID: VARENUM = VARENUM(24);
