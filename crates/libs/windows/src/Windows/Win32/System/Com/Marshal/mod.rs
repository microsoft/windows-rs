...
#[inline]
pub unsafe fn CoGetMarshalSizeMax<P2>(pulsize: *mut u32, riid: *const windows_core::GUID, punk: P2, dwdestcontext: u32, pvdestcontext: Option<*const core::ffi::c_void>, mshlflags: u32) -> windows_result::Result<()>
where
...
#[inline]
pub unsafe fn CoGetStandardMarshal<P1>(riid: *const windows_core::GUID, punk: P1, dwdestcontext: u32, pvdestcontext: Option<*const core::ffi::c_void>, mshlflags: u32) -> windows_result::Result<IMarshal>
where
...
#[inline]
pub unsafe fn CoGetStdMarshalEx<P0>(punkouter: P0, smexflags: u32) -> windows_result::Result<windows_core::IUnknown>
where
...
#[inline]
pub unsafe fn CoMarshalHresult<P0>(pstm: P0, hresult: windows_core::HRESULT) -> windows_result::Result<()>
where
...
#[inline]
pub unsafe fn CoMarshalInterThreadInterfaceInStream<P1>(riid: *const windows_core::GUID, punk: P1) -> windows_result::Result<super::IStream>
where
    P1: windows_core::Param<windows_core::IUnknown>,
{
...
#[inline]
pub unsafe fn CoMarshalInterface<P0, P2>(pstm: P0, riid: *const windows_core::GUID, punk: P2, dwdestcontext: u32, pvdestcontext: Option<*const core::ffi::c_void>, mshlflags: u32) -> windows_result::Result<()>
where
    P0: windows_core::Param<super::IStream>,
    P2: windows_core::Param<windows_core::IUnknown>,
{
...
#[inline]
pub unsafe fn CoReleaseMarshalData<P0>(pstm: P0) -> windows_result::Result<()>
where
    P0: windows_core::Param<super::IStream>,
{
...
#[inline]
pub unsafe fn CoUnmarshalHresult<P0>(pstm: P0) -> windows_result::Result<windows_core::HRESULT>
where
    P0: windows_core::Param<super::IStream>,
{
...
#[inline]
pub unsafe fn CoUnmarshalInterface<P0, T>(pstm: P0) -> windows_result::Result<T>
where
    P0: windows_core::Param<super::IStream>,
...
impl IMarshal {
    pub unsafe fn GetUnmarshalClass(&self, riid: *const windows_core::GUID, pv: Option<*const core::ffi::c_void>, dwdestcontext: u32, pvdestcontext: Option<*const core::ffi::c_void>, mshlflags: u32) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetMarshalSizeMax(&self, riid: *const windows_core::GUID, pv: Option<*const core::ffi::c_void>, dwdestcontext: u32, pvdestcontext: Option<*const core::ffi::c_void>, mshlflags: u32) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn MarshalInterface<P0>(&self, pstm: P0, riid: *const windows_core::GUID, pv: Option<*const core::ffi::c_void>, dwdestcontext: u32, pvdestcontext: Option<*const core::ffi::c_void>, mshlflags: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::IStream>,
    {
    ...
    pub unsafe fn UnmarshalInterface<P0>(&self, pstm: P0, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::IStream>,
    {
    ...
    pub unsafe fn ReleaseMarshalData<P0>(&self, pstm: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::IStream>,
    {
        unsafe { (windows_core::Interface::vtable(self).ReleaseMarshalData)(windows_core::Interface::as_raw(self), pstm.param().abi()).ok() }
    }
    pub unsafe fn DisconnectObject(&self, dwreserved: u32) -> windows_result::Result<()> {
...
pub trait IMarshal_Impl: windows_core::IUnknownImpl {
    fn GetUnmarshalClass(&self, riid: *const windows_core::GUID, pv: *const core::ffi::c_void, dwdestcontext: u32, pvdestcontext: *const core::ffi::c_void, mshlflags: u32) -> windows_result::Result<windows_core::GUID>;
    fn GetMarshalSizeMax(&self, riid: *const windows_core::GUID, pv: *const core::ffi::c_void, dwdestcontext: u32, pvdestcontext: *const core::ffi::c_void, mshlflags: u32) -> windows_result::Result<u32>;
    fn MarshalInterface(&self, pstm: windows_core::Ref<super::IStream>, riid: *const windows_core::GUID, pv: *const core::ffi::c_void, dwdestcontext: u32, pvdestcontext: *const core::ffi::c_void, mshlflags: u32) -> windows_result::Result<()>;
    fn UnmarshalInterface(&self, pstm: windows_core::Ref<super::IStream>, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn ReleaseMarshalData(&self, pstm: windows_core::Ref<super::IStream>) -> windows_result::Result<()>;
    fn DisconnectObject(&self, dwreserved: u32) -> windows_result::Result<()>;
}
impl IMarshal_Vtbl {
...
impl IMarshalingStream {
    pub unsafe fn GetMarshalingContextAttribute(&self, attribute: super::CO_MARSHALING_CONTEXT_ATTRIBUTES) -> windows_result::Result<usize> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IMarshalingStream_Impl: super::IStream_Impl {
    fn GetMarshalingContextAttribute(&self, attribute: super::CO_MARSHALING_CONTEXT_ATTRIBUTES) -> windows_result::Result<usize>;
}
