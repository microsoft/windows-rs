    ...
    P1: windows_core::Param<IStorage>,
{
    ...
    OleConvertOLESTREAMToIStorageEx(polestm, pstg.param().abi(), pcfformat, plwwidth, plheight, pdwsize, core::mem::transmute(pmedium)).ok()
}
#[inline]
...
pub unsafe fn PropVariantToBSTR(propvar: *const PROPVARIANT) -> windows_core::Result<windows_core::BSTR> {
    windows_targets::link!("propsys.dll" "system" fn PropVariantToBSTR(propvar : *const PROPVARIANT, pbstrout : *mut core::mem::MaybeUninit < windows_core::BSTR >) -> windows_core::HRESULT);
    let mut result__ = core::mem::zeroed();
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    StgSetTimes(lpszname.param().abi(), core::mem::transmute(pctime.unwrap_or(core::ptr::null())), core::mem::transmute(patime.unwrap_or(core::ptr::null())), core::mem::transmute(pmtime.unwrap_or(core::ptr::null()))).ok()
}
#[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
#[inline]
...
impl IMemoryAllocator_Vtbl {
    pub const fn new<Identity: IMemoryAllocator_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Allocate<Identity: IMemoryAllocator_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, cbsize: u32) -> *mut core::ffi::c_void {
            let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
            IMemoryAllocator_Impl::Allocate(this, core::mem::transmute_copy(&cbsize))
        }
        unsafe extern "system" fn Free<Identity: IMemoryAllocator_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pv: *mut core::ffi::c_void) {
            let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
            IMemoryAllocator_Impl::Free(this, core::mem::transmute_copy(&pv))
        }
        Self { Allocate: Allocate::<Identity, OFFSET>, Free: Free::<Identity, OFFSET> }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IMemoryAllocator as windows_core::Interface>::IID
    }
}
impl windows_core::RuntimeName for IMemoryAllocator {}
