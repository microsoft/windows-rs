...
pub unsafe fn CoGetInstanceFromFile<'a, Param2: ::windows::core::IntoParam<'a, ::windows::core::IUnknown>, Param5: ::windows::core::IntoParam<'a, ::windows::core::PCWSTR>>(pserverinfo: *const super::COSERVERINFO, pclsid: *const ::windows::core::GUID, punkouter: Param2, dwclsctx: super::CLSCTX, grfmode: u32, pwszname: Param5, presults: &mut [super::MULTI_QI]) -> ::windows::core::Result<()> {
    #[cfg(windows)]
    {
        ...
        CoGetInstanceFromFile(::core::mem::transmute(pserverinfo), ::core::mem::transmute(pclsid), punkouter.into_param().abi(), ::core::mem::transmute(dwclsctx), ::core::mem::transmute(grfmode), pwszname.into_param().abi(), presults.len() as _, ::core::mem::transmute(presults.as_ptr())).ok()
    }
    #[cfg(not(windows))]
...
pub unsafe fn CoGetInstanceFromIStorage<'a, Param2: ::windows::core::IntoParam<'a, ::windows::core::IUnknown>, Param4: ::windows::core::IntoParam<'a, IStorage>>(pserverinfo: *const super::COSERVERINFO, pclsid: *const ::windows::core::GUID, punkouter: Param2, dwclsctx: super::CLSCTX, pstg: Param4, presults: &mut [super::MULTI_QI]) -> ::windows::core::Result<()> {
    #[cfg(windows)]
    {
        ...
        CoGetInstanceFromIStorage(::core::mem::transmute(pserverinfo), ::core::mem::transmute(pclsid), punkouter.into_param().abi(), ::core::mem::transmute(dwclsctx), pstg.into_param().abi(), presults.len() as _, ::core::mem::transmute(presults.as_ptr())).ok()
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
impl IPropertyBag2 {
    ...
    pub unsafe fn Read<'a, const PARAM0: usize, Param2: ::windows::core::IntoParam<'a, super::IErrorLog>>(&self, ppropbag: &[PROPBAG2; PARAM0], perrlog: Param2, pvarvalue: &mut [super::VARIANT; PARAM0], phrerror: &mut [::windows::core::HRESULT; PARAM0]) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).Read)(::core::mem::transmute_copy(self), PARAM0 as _, ::core::mem::transmute(ppropbag.as_ptr()), perrlog.into_param().abi(), ::core::mem::transmute(pvarvalue.as_ptr()), ::core::mem::transmute(phrerror.as_ptr())).ok()
    }
    #[doc = "*Required features: 'Win32_System_Com_StructuredStorage', 'Win32_Foundation', 'Win32_System_Ole'*"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Ole"))]
    pub unsafe fn Write<'a, const PARAM0: usize>(&self, ppropbag: &[PROPBAG2; PARAM0], pvarvalue: &[super::VARIANT; PARAM0]) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).Write)(::core::mem::transmute_copy(self), PARAM0 as _, ::core::mem::transmute(ppropbag.as_ptr()), ::core::mem::transmute(pvarvalue.as_ptr())).ok()
    }
    #[doc = "*Required features: 'Win32_System_Com_StructuredStorage'*"]
    ...
    pub unsafe fn GetPropertyInfo(&self, iproperty: u32, ppropbag: &mut [PROPBAG2], pcproperties: *mut u32) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).GetPropertyInfo)(::core::mem::transmute_copy(self), ::core::mem::transmute(iproperty), ppropbag.len() as _, ::core::mem::transmute(ppropbag.as_ptr()), ::core::mem::transmute(pcproperties)).ok()
    }
    #[doc = "*Required features: 'Win32_System_Com_StructuredStorage'*"]
...
impl IPropertyStorage {
    ...
    pub unsafe fn ReadMultiple<'a, const PARAM0: usize>(&self, rgpspec: &[PROPSPEC; PARAM0], rgpropvar: &mut [PROPVARIANT; PARAM0]) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).ReadMultiple)(::core::mem::transmute_copy(self), PARAM0 as _, ::core::mem::transmute(rgpspec.as_ptr()), ::core::mem::transmute(rgpropvar.as_ptr())).ok()
    }
    #[doc = "*Required features: 'Win32_System_Com_StructuredStorage', 'Win32_Foundation'*"]
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn WriteMultiple<'a, const PARAM0: usize>(&self, rgpspec: &[PROPSPEC; PARAM0], rgpropvar: &[PROPVARIANT; PARAM0], propidnamefirst: u32) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).WriteMultiple)(::core::mem::transmute_copy(self), PARAM0 as _, ::core::mem::transmute(rgpspec.as_ptr()), ::core::mem::transmute(rgpropvar.as_ptr()), ::core::mem::transmute(propidnamefirst)).ok()
    }
    #[doc = "*Required features: 'Win32_System_Com_StructuredStorage'*"]
    ...
    pub unsafe fn ReadPropertyNames<'a, const PARAM0: usize>(&self, rgpropid: &[u32; PARAM0], rglpwstrname: &mut [::windows::core::PWSTR; PARAM0]) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).ReadPropertyNames)(::core::mem::transmute_copy(self), PARAM0 as _, ::core::mem::transmute(rgpropid.as_ptr()), ::core::mem::transmute(rglpwstrname.as_ptr())).ok()
    }
    #[doc = "*Required features: 'Win32_System_Com_StructuredStorage'*"]
    pub unsafe fn WritePropertyNames<'a, const PARAM0: usize>(&self, rgpropid: &[u32; PARAM0], rglpwstrname: &[::windows::core::PWSTR; PARAM0]) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).WritePropertyNames)(::core::mem::transmute_copy(self), PARAM0 as _, ::core::mem::transmute(rgpropid.as_ptr()), ::core::mem::transmute(rglpwstrname.as_ptr())).ok()
    }
    #[doc = "*Required features: 'Win32_System_Com_StructuredStorage'*"]
...
impl IStorage {
    ...
    #[doc = "*Required features: 'Win32_System_Com_StructuredStorage'*"]
    pub unsafe fn CopyTo<'a, Param3: ::windows::core::IntoParam<'a, IStorage>>(&self, rgiidexclude: ::core::option::Option<&[::windows::core::GUID]>, snbexclude: *const *const u16, pstgdest: Param3) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).CopyTo)(::core::mem::transmute_copy(self), rgiidexclude.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(rgiidexclude.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), ::core::mem::transmute(snbexclude), pstgdest.into_param().abi()).ok()
    }
    #[doc = "*Required features: 'Win32_System_Com_StructuredStorage'*"]
