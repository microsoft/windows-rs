...
{
    ::windows_targets::link!("propsys.dll" "system" fn InitPropVariantFromResource(hinst : super::super::super::Foundation:: HMODULE, id : u32, ppropvar : *mut PROPVARIANT) -> ::windows_core::HRESULT);
    let mut result__ = ::windows_core::zeroed::<PROPVARIANT>();
...
pub unsafe fn PropVariantGetFileTimeElem(propvar: *const PROPVARIANT, ielem: u32) -> ::windows_core::Result<super::super::super::Foundation::FILETIME> {
    ...
    let mut result__ = ::windows_core::zeroed::<super::super::super::Foundation::FILETIME>();
