#[inline]
pub unsafe fn CoGetClassObjectFromURL<P1, P4, P5>(rclassid: *const windows_core::GUID, szcode: P1, dwfileversionms: u32, dwfileversionls: u32, sztype: P4, pbindctx: P5, dwclscontext: super::CLSCTX, pvreserved: Option<*const core::ffi::c_void>, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
where
...
#[inline]
pub unsafe fn CoInternetCombineIUri<P0, P1>(pbaseuri: P0, prelativeuri: P1, dwcombineflags: u32, ppcombineduri: *mut Option<super::IUri>, dwreserved: Option<usize>) -> windows_core::HRESULT
where
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { CoInternetCombineUrl(pwzbaseurl.param().abi(), pwzrelativeurl.param().abi(), dwcombineflags, core::mem::transmute(pszresult.as_ptr()), pszresult.len().try_into().unwrap(), pcchresult.unwrap_or(core::mem::zeroed()) as _, dwreserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn CoInternetCombineUrlEx<P0, P1>(pbaseuri: P0, pwzrelativeurl: P1, dwcombineflags: u32, ppcombineduri: *mut Option<super::IUri>, dwreserved: Option<usize>) -> windows_core::HRESULT
where
    P0: windows_core::Param<super::IUri>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn CoInternetGetSecurityUrlEx<P0>(puri: P0, ppsecuri: *mut Option<super::IUri>, psuaction: PSUACTION, dwreserved: Option<usize>) -> windows_core::HRESULT
where
    P0: windows_core::Param<super::IUri>,
{
    ...
    P0: windows_core::Param<super::IUri>,
{
    ...
    unsafe { CoInternetParseIUri(piuri.param().abi(), parseaction, dwflags, core::mem::transmute(pwzresult.as_ptr()), pwzresult.len().try_into().unwrap(), pcchresult as _, dwreserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { CoInternetParseUrl(pwzurl.param().abi(), parseaction, dwflags, core::mem::transmute(pszresult.as_ptr()), pszresult.len().try_into().unwrap(), pcchresult as _, dwreserved) }
}
#[inline]
...
pub unsafe fn CompareSecurityIds(pbsecurityid1: &[u8], pbsecurityid2: &[u8], dwreserved: u32) -> windows_core::HRESULT {
    ...
    unsafe { CompareSecurityIds(core::mem::transmute(pbsecurityid1.as_ptr()), pbsecurityid1.len().try_into().unwrap(), core::mem::transmute(pbsecurityid2.as_ptr()), pbsecurityid2.len().try_into().unwrap(), dwreserved) }
}
#[inline]
...
#[inline]
pub unsafe fn CopyBindInfo(pcbisrc: *const super::BINDINFO, pbidest: *mut super::BINDINFO) -> windows_core::HRESULT {
...
#[inline]
pub unsafe fn CreateAsyncBindCtxEx<P0, P2, P3>(pbc: P0, dwoptions: u32, pbscb: P2, penum: P3, ppbc: *mut Option<super::IBindCtx>, reserved: u32) -> windows_core::HRESULT
where
...
#[inline]
pub unsafe fn FaultInIEFeature(hwnd: super::super::super::Foundation::HWND, pclassspec: *const super::uCLSSPEC, pquery: Option<*mut super::QUERYCONTEXT>, dwflags: u32) -> windows_core::HRESULT {
...
#[inline]
pub unsafe fn RegisterBindStatusCallback<P0, P1>(pbc: P0, pbscb: P1, ppbscbprev: *mut Option<super::IBindStatusCallback>, dwreserved: u32) -> windows_core::HRESULT
where
    P0: windows_core::Param<super::IBindCtx>,
    P1: windows_core::Param<super::IBindStatusCallback>,
{
...
#[inline]
pub unsafe fn RegisterMediaTypes(ctypes: u32, rgsztypes: *const windows_core::PCSTR, rgcftypes: *mut u16) -> windows_core::HRESULT {
...
#[inline]
pub unsafe fn SetAccessForIEAppContainer(hobject: super::super::super::Foundation::HANDLE, ieobjecttype: IEObjectType, dwaccessmask: u32) -> windows_core::HRESULT {
    ...
    P5: windows_core::Param<super::IBindStatusCallback>,
{
    ...
    unsafe { URLDownloadToCacheFileA(param0.param().abi(), param1.param().abi(), core::mem::transmute(param2.as_ptr()), param2.len().try_into().unwrap(), param4, param5.param().abi()) }
}
#[inline]
    ...
    P5: windows_core::Param<super::IBindStatusCallback>,
{
    ...
    unsafe { URLDownloadToCacheFileW(param0.param().abi(), param1.param().abi(), core::mem::transmute(param2.as_ptr()), param2.len().try_into().unwrap(), param4, param5.param().abi()) }
}
#[inline]
...
pub const AUTHENTICATEF_BASIC: AUTHENTICATEF = AUTHENTICATEF(2);
pub const AUTHENTICATEF_HTTP: AUTHENTICATEF = AUTHENTICATEF(4);
pub const AUTHENTICATEF_PROXY: AUTHENTICATEF = AUTHENTICATEF(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const BINDF2_ALLOW_PROXY_CRED_PROMPT: BINDF2 = BINDF2(256);
pub const BINDF2_DISABLEAUTOCOOKIEHANDLING: BINDF2 = BINDF2(2);
pub const BINDF2_DISABLEBASICOVERHTTP: BINDF2 = BINDF2(1);
pub const BINDF2_DISABLE_HTTP_REDIRECT_CACHING: BINDF2 = BINDF2(64);
pub const BINDF2_DISABLE_HTTP_REDIRECT_XSECURITYID: BINDF2 = BINDF2(8);
pub const BINDF2_KEEP_CALLBACK_MODULE_LOADED: BINDF2 = BINDF2(128);
pub const BINDF2_READ_DATA_GREATER_THAN_4GB: BINDF2 = BINDF2(4);
pub const BINDF2_RESERVED_1: BINDF2 = BINDF2(-2147483648);
pub const BINDF2_RESERVED_10: BINDF2 = BINDF2(65536);
pub const BINDF2_RESERVED_11: BINDF2 = BINDF2(32768);
pub const BINDF2_RESERVED_12: BINDF2 = BINDF2(16384);
pub const BINDF2_RESERVED_13: BINDF2 = BINDF2(8192);
pub const BINDF2_RESERVED_14: BINDF2 = BINDF2(4096);
pub const BINDF2_RESERVED_15: BINDF2 = BINDF2(2048);
pub const BINDF2_RESERVED_16: BINDF2 = BINDF2(1024);
pub const BINDF2_RESERVED_17: BINDF2 = BINDF2(512);
pub const BINDF2_RESERVED_2: BINDF2 = BINDF2(1073741824);
pub const BINDF2_RESERVED_3: BINDF2 = BINDF2(536870912);
pub const BINDF2_RESERVED_4: BINDF2 = BINDF2(268435456);
pub const BINDF2_RESERVED_5: BINDF2 = BINDF2(134217728);
pub const BINDF2_RESERVED_6: BINDF2 = BINDF2(67108864);
pub const BINDF2_RESERVED_7: BINDF2 = BINDF2(33554432);
pub const BINDF2_RESERVED_8: BINDF2 = BINDF2(16777216);
pub const BINDF2_RESERVED_9: BINDF2 = BINDF2(8388608);
pub const BINDF2_RESERVED_A: BINDF2 = BINDF2(4194304);
pub const BINDF2_RESERVED_B: BINDF2 = BINDF2(2097152);
pub const BINDF2_RESERVED_C: BINDF2 = BINDF2(1048576);
pub const BINDF2_RESERVED_D: BINDF2 = BINDF2(524288);
pub const BINDF2_RESERVED_E: BINDF2 = BINDF2(262144);
pub const BINDF2_RESERVED_F: BINDF2 = BINDF2(131072);
pub const BINDF2_SETDOWNLOADMODE: BINDF2 = BINDF2(32);
pub const BINDF_ASYNCHRONOUS: BINDF = BINDF(1);
pub const BINDF_ASYNCSTORAGE: BINDF = BINDF(2);
pub const BINDF_DIRECT_READ: BINDF = BINDF(131072);
pub const BINDF_ENFORCERESTRICTED: BINDF = BINDF(8388608);
pub const BINDF_FORMS_SUBMIT: BINDF = BINDF(262144);
pub const BINDF_FREE_THREADED: BINDF = BINDF(65536);
pub const BINDF_FROMURLMON: BINDF = BINDF(1048576);
pub const BINDF_FWD_BACK: BINDF = BINDF(2097152);
pub const BINDF_GETCLASSOBJECT: BINDF = BINDF(16384);
pub const BINDF_GETFROMCACHE_IF_NET_FAIL: BINDF = BINDF(524288);
pub const BINDF_GETNEWESTVERSION: BINDF = BINDF(16);
pub const BINDF_HYPERLINK: BINDF = BINDF(1024);
pub const BINDF_IGNORESECURITYPROBLEM: BINDF = BINDF(256);
pub const BINDF_NEEDFILE: BINDF = BINDF(64);
pub const BINDF_NOPROGRESSIVERENDERING: BINDF = BINDF(4);
pub const BINDF_NOWRITECACHE: BINDF = BINDF(32);
pub const BINDF_NO_UI: BINDF = BINDF(2048);
pub const BINDF_OFFLINEOPERATION: BINDF = BINDF(8);
pub const BINDF_PRAGMA_NO_CACHE: BINDF = BINDF(8192);
pub const BINDF_PREFERDEFAULTHANDLER: BINDF = BINDF(4194304);
pub const BINDF_PULLDATA: BINDF = BINDF(128);
pub const BINDF_RESERVED_1: BINDF = BINDF(32768);
pub const BINDF_RESERVED_2: BINDF = BINDF(-2147483648);
pub const BINDF_RESERVED_3: BINDF = BINDF(16777216);
pub const BINDF_RESERVED_4: BINDF = BINDF(33554432);
pub const BINDF_RESERVED_5: BINDF = BINDF(67108864);
pub const BINDF_RESERVED_6: BINDF = BINDF(134217728);
pub const BINDF_RESERVED_7: BINDF = BINDF(1073741824);
pub const BINDF_RESERVED_8: BINDF = BINDF(536870912);
pub const BINDF_RESYNCHRONIZE: BINDF = BINDF(512);
pub const BINDF_SILENTOPERATION: BINDF = BINDF(4096);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct BINDHANDLETYPES(pub i32);
pub const BINDHANDLETYPES_APPCACHE: BINDHANDLETYPES = BINDHANDLETYPES(0);
pub const BINDHANDLETYPES_COUNT: BINDHANDLETYPES = BINDHANDLETYPES(2);
pub const BINDHANDLETYPES_DEPENDENCY: BINDHANDLETYPES = BINDHANDLETYPES(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct BINDINFO_OPTIONS(pub i32);
pub const BINDINFO_OPTIONS_ALLOWCONNECTDATA: BINDINFO_OPTIONS = BINDINFO_OPTIONS(536870912);
pub const BINDINFO_OPTIONS_BINDTOOBJECT: BINDINFO_OPTIONS = BINDINFO_OPTIONS(1048576);
pub const BINDINFO_OPTIONS_DISABLEAUTOREDIRECTS: BINDINFO_OPTIONS = BINDINFO_OPTIONS(1073741824);
pub const BINDINFO_OPTIONS_DISABLE_UTF8: BINDINFO_OPTIONS = BINDINFO_OPTIONS(262144);
pub const BINDINFO_OPTIONS_ENABLE_UTF8: BINDINFO_OPTIONS = BINDINFO_OPTIONS(131072);
pub const BINDINFO_OPTIONS_IGNOREHTTPHTTPSREDIRECTS: BINDINFO_OPTIONS = BINDINFO_OPTIONS(16777216);
pub const BINDINFO_OPTIONS_IGNOREMIMETEXTPLAIN: BINDINFO_OPTIONS = BINDINFO_OPTIONS(4194304);
pub const BINDINFO_OPTIONS_IGNORE_SSLERRORS_ONCE: BINDINFO_OPTIONS = BINDINFO_OPTIONS(33554432);
pub const BINDINFO_OPTIONS_SECURITYOPTOUT: BINDINFO_OPTIONS = BINDINFO_OPTIONS(2097152);
pub const BINDINFO_OPTIONS_SHDOCVW_NAVIGATE: BINDINFO_OPTIONS = BINDINFO_OPTIONS(-2147483648);
pub const BINDINFO_OPTIONS_USEBINDSTRINGCREDS: BINDINFO_OPTIONS = BINDINFO_OPTIONS(8388608);
pub const BINDINFO_OPTIONS_USE_IE_ENCODING: BINDINFO_OPTIONS = BINDINFO_OPTIONS(524288);
pub const BINDINFO_OPTIONS_WININETFLAG: BINDINFO_OPTIONS = BINDINFO_OPTIONS(65536);
pub const BINDINFO_WPC_DOWNLOADBLOCKED: BINDINFO_OPTIONS = BINDINFO_OPTIONS(134217728);
pub const BINDINFO_WPC_LOGGING_ENABLED: BINDINFO_OPTIONS = BINDINFO_OPTIONS(268435456);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct BINDSTATUS(pub i32);
pub const BINDSTATUS_64BIT_PROGRESS: BINDSTATUS = BINDSTATUS(56);
pub const BINDSTATUS_ACCEPTRANGES: BINDSTATUS = BINDSTATUS(33);
pub const BINDSTATUS_BEGINDOWNLOADCOMPONENTS: BINDSTATUS = BINDSTATUS(7);
pub const BINDSTATUS_BEGINDOWNLOADDATA: BINDSTATUS = BINDSTATUS(4);
pub const BINDSTATUS_BEGINSYNCOPERATION: BINDSTATUS = BINDSTATUS(15);
pub const BINDSTATUS_BEGINUPLOADDATA: BINDSTATUS = BINDSTATUS(17);
pub const BINDSTATUS_CACHECONTROL: BINDSTATUS = BINDSTATUS(48);
pub const BINDSTATUS_CACHEFILENAMEAVAILABLE: BINDSTATUS = BINDSTATUS(14);
pub const BINDSTATUS_CLASSIDAVAILABLE: BINDSTATUS = BINDSTATUS(12);
pub const BINDSTATUS_CLASSINSTALLLOCATION: BINDSTATUS = BINDSTATUS(23);
pub const BINDSTATUS_CLSIDCANINSTANTIATE: BINDSTATUS = BINDSTATUS(28);
pub const BINDSTATUS_COMPACT_POLICY_RECEIVED: BINDSTATUS = BINDSTATUS(35);
pub const BINDSTATUS_CONNECTING: BINDSTATUS = BINDSTATUS(2);
pub const BINDSTATUS_CONTENTDISPOSITIONATTACH: BINDSTATUS = BINDSTATUS(26);
pub const BINDSTATUS_CONTENTDISPOSITIONFILENAME: BINDSTATUS = BINDSTATUS(49);
pub const BINDSTATUS_COOKIE_SENT: BINDSTATUS = BINDSTATUS(34);
pub const BINDSTATUS_COOKIE_STATE_ACCEPT: BINDSTATUS = BINDSTATUS(38);
pub const BINDSTATUS_COOKIE_STATE_DOWNGRADE: BINDSTATUS = BINDSTATUS(42);
pub const BINDSTATUS_COOKIE_STATE_LEASH: BINDSTATUS = BINDSTATUS(41);
pub const BINDSTATUS_COOKIE_STATE_PROMPT: BINDSTATUS = BINDSTATUS(40);
pub const BINDSTATUS_COOKIE_STATE_REJECT: BINDSTATUS = BINDSTATUS(39);
pub const BINDSTATUS_COOKIE_STATE_UNKNOWN: BINDSTATUS = BINDSTATUS(37);
pub const BINDSTATUS_COOKIE_SUPPRESSED: BINDSTATUS = BINDSTATUS(36);
pub const BINDSTATUS_DECODING: BINDSTATUS = BINDSTATUS(24);
pub const BINDSTATUS_DIRECTBIND: BINDSTATUS = BINDSTATUS(30);
pub const BINDSTATUS_DISPLAYNAMEAVAILABLE: BINDSTATUS = BINDSTATUS(52);
pub const BINDSTATUS_DOWNLOADINGDATA: BINDSTATUS = BINDSTATUS(5);
pub const BINDSTATUS_ENCODING: BINDSTATUS = BINDSTATUS(21);
pub const BINDSTATUS_ENDDOWNLOADCOMPONENTS: BINDSTATUS = BINDSTATUS(9);
pub const BINDSTATUS_ENDDOWNLOADDATA: BINDSTATUS = BINDSTATUS(6);
pub const BINDSTATUS_ENDSYNCOPERATION: BINDSTATUS = BINDSTATUS(16);
pub const BINDSTATUS_ENDUPLOADDATA: BINDSTATUS = BINDSTATUS(19);
pub const BINDSTATUS_FILTERREPORTMIMETYPE: BINDSTATUS = BINDSTATUS(27);
pub const BINDSTATUS_FINDINGRESOURCE: BINDSTATUS = BINDSTATUS(1);
pub const BINDSTATUS_INSTALLINGCOMPONENTS: BINDSTATUS = BINDSTATUS(8);
pub const BINDSTATUS_IUNKNOWNAVAILABLE: BINDSTATUS = BINDSTATUS(29);
pub const BINDSTATUS_LAST: BINDSTATUS = BINDSTATUS(56);
pub const BINDSTATUS_LAST_PRIVATE: BINDSTATUS = BINDSTATUS(77);
pub const BINDSTATUS_LOADINGMIMEHANDLER: BINDSTATUS = BINDSTATUS(25);
pub const BINDSTATUS_MIMETEXTPLAINMISMATCH: BINDSTATUS = BINDSTATUS(50);
pub const BINDSTATUS_MIMETYPEAVAILABLE: BINDSTATUS = BINDSTATUS(13);
pub const BINDSTATUS_P3P_HEADER: BINDSTATUS = BINDSTATUS(44);
pub const BINDSTATUS_PERSISTENT_COOKIE_RECEIVED: BINDSTATUS = BINDSTATUS(46);
pub const BINDSTATUS_POLICY_HREF: BINDSTATUS = BINDSTATUS(43);
pub const BINDSTATUS_PROTOCOLCLASSID: BINDSTATUS = BINDSTATUS(20);
pub const BINDSTATUS_PROXYDETECTING: BINDSTATUS = BINDSTATUS(32);
pub const BINDSTATUS_PUBLISHERAVAILABLE: BINDSTATUS = BINDSTATUS(51);
pub const BINDSTATUS_RAWMIMETYPE: BINDSTATUS = BINDSTATUS(31);
pub const BINDSTATUS_REDIRECTING: BINDSTATUS = BINDSTATUS(3);
pub const BINDSTATUS_RESERVED_0: BINDSTATUS = BINDSTATUS(57);
pub const BINDSTATUS_RESERVED_1: BINDSTATUS = BINDSTATUS(58);
pub const BINDSTATUS_RESERVED_10: BINDSTATUS = BINDSTATUS(73);
pub const BINDSTATUS_RESERVED_11: BINDSTATUS = BINDSTATUS(74);
pub const BINDSTATUS_RESERVED_12: BINDSTATUS = BINDSTATUS(75);
pub const BINDSTATUS_RESERVED_13: BINDSTATUS = BINDSTATUS(76);
pub const BINDSTATUS_RESERVED_14: BINDSTATUS = BINDSTATUS(77);
pub const BINDSTATUS_RESERVED_2: BINDSTATUS = BINDSTATUS(59);
pub const BINDSTATUS_RESERVED_3: BINDSTATUS = BINDSTATUS(60);
pub const BINDSTATUS_RESERVED_4: BINDSTATUS = BINDSTATUS(61);
pub const BINDSTATUS_RESERVED_5: BINDSTATUS = BINDSTATUS(62);
pub const BINDSTATUS_RESERVED_6: BINDSTATUS = BINDSTATUS(63);
pub const BINDSTATUS_RESERVED_7: BINDSTATUS = BINDSTATUS(64);
pub const BINDSTATUS_RESERVED_8: BINDSTATUS = BINDSTATUS(65);
pub const BINDSTATUS_RESERVED_9: BINDSTATUS = BINDSTATUS(66);
pub const BINDSTATUS_RESERVED_A: BINDSTATUS = BINDSTATUS(67);
pub const BINDSTATUS_RESERVED_B: BINDSTATUS = BINDSTATUS(68);
pub const BINDSTATUS_RESERVED_C: BINDSTATUS = BINDSTATUS(69);
pub const BINDSTATUS_RESERVED_D: BINDSTATUS = BINDSTATUS(70);
pub const BINDSTATUS_RESERVED_E: BINDSTATUS = BINDSTATUS(71);
pub const BINDSTATUS_RESERVED_F: BINDSTATUS = BINDSTATUS(72);
pub const BINDSTATUS_SENDINGREQUEST: BINDSTATUS = BINDSTATUS(11);
pub const BINDSTATUS_SERVER_MIMETYPEAVAILABLE: BINDSTATUS = BINDSTATUS(54);
pub const BINDSTATUS_SESSION_COOKIES_ALLOWED: BINDSTATUS = BINDSTATUS(47);
pub const BINDSTATUS_SESSION_COOKIE_RECEIVED: BINDSTATUS = BINDSTATUS(45);
pub const BINDSTATUS_SNIFFED_CLASSIDAVAILABLE: BINDSTATUS = BINDSTATUS(55);
pub const BINDSTATUS_SSLUX_NAVBLOCKED: BINDSTATUS = BINDSTATUS(53);
pub const BINDSTATUS_UPLOADINGDATA: BINDSTATUS = BINDSTATUS(18);
pub const BINDSTATUS_USINGCACHEDCOPY: BINDSTATUS = BINDSTATUS(10);
pub const BINDSTATUS_VERIFIEDMIMETYPEAVAILABLE: BINDSTATUS = BINDSTATUS(22);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct BINDSTRING(pub i32);
pub const BINDSTRING_ACCEPT_ENCODINGS: BINDSTRING = BINDSTRING(11);
pub const BINDSTRING_ACCEPT_MIMES: BINDSTRING = BINDSTRING(2);
pub const BINDSTRING_DOC_URL: BINDSTRING = BINDSTRING(25);
pub const BINDSTRING_DOWNLOADPATH: BINDSTRING = BINDSTRING(19);
pub const BINDSTRING_ENTERPRISE_ID: BINDSTRING = BINDSTRING(24);
pub const BINDSTRING_EXTRA_URL: BINDSTRING = BINDSTRING(3);
pub const BINDSTRING_FLAG_BIND_TO_OBJECT: BINDSTRING = BINDSTRING(16);
pub const BINDSTRING_HEADERS: BINDSTRING = BINDSTRING(1);
pub const BINDSTRING_IID: BINDSTRING = BINDSTRING(15);
pub const BINDSTRING_INITIAL_FILENAME: BINDSTRING = BINDSTRING(21);
pub const BINDSTRING_LANGUAGE: BINDSTRING = BINDSTRING(4);
pub const BINDSTRING_OS: BINDSTRING = BINDSTRING(9);
pub const BINDSTRING_PASSWORD: BINDSTRING = BINDSTRING(6);
pub const BINDSTRING_POST_COOKIE: BINDSTRING = BINDSTRING(12);
pub const BINDSTRING_POST_DATA_MIME: BINDSTRING = BINDSTRING(13);
pub const BINDSTRING_PROXY_PASSWORD: BINDSTRING = BINDSTRING(23);
pub const BINDSTRING_PROXY_USERNAME: BINDSTRING = BINDSTRING(22);
pub const BINDSTRING_PTR_BIND_CONTEXT: BINDSTRING = BINDSTRING(17);
pub const BINDSTRING_ROOTDOC_URL: BINDSTRING = BINDSTRING(20);
pub const BINDSTRING_SAMESITE_COOKIE_LEVEL: BINDSTRING = BINDSTRING(26);
pub const BINDSTRING_UA_COLOR: BINDSTRING = BINDSTRING(8);
pub const BINDSTRING_UA_PIXELS: BINDSTRING = BINDSTRING(7);
pub const BINDSTRING_URL: BINDSTRING = BINDSTRING(14);
pub const BINDSTRING_USERNAME: BINDSTRING = BINDSTRING(5);
pub const BINDSTRING_USER_AGENT: BINDSTRING = BINDSTRING(10);
pub const BINDSTRING_XDR_ORIGIN: BINDSTRING = BINDSTRING(18);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct BINDVERB(pub i32);
pub const BINDVERB_CUSTOM: BINDVERB = BINDVERB(3);
pub const BINDVERB_GET: BINDVERB = BINDVERB(0);
pub const BINDVERB_POST: BINDVERB = BINDVERB(1);
pub const BINDVERB_PUT: BINDVERB = BINDVERB(2);
pub const BINDVERB_RESERVED1: BINDVERB = BINDVERB(4);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct BSCF(pub i32);
pub const BSCF_64BITLENGTHDOWNLOAD: BSCF = BSCF(64);
pub const BSCF_AVAILABLEDATASIZEUNKNOWN: BSCF = BSCF(16);
pub const BSCF_DATAFULLYAVAILABLE: BSCF = BSCF(8);
pub const BSCF_FIRSTDATANOTIFICATION: BSCF = BSCF(1);
pub const BSCF_INTERMEDIATEDATANOTIFICATION: BSCF = BSCF(2);
pub const BSCF_LASTDATANOTIFICATION: BSCF = BSCF(4);
pub const BSCF_SKIPDRAINDATAFORFILEURLS: BSCF = BSCF(32);
pub const CF_NULL: u32 = 0;
pub const CIP_ACCESS_DENIED: CIP_STATUS = CIP_STATUS(1);
pub const CIP_DISK_FULL: CIP_STATUS = CIP_STATUS(0);
pub const CIP_EXE_SELF_REGISTERATION_TIMEOUT: CIP_STATUS = CIP_STATUS(6);
pub const CIP_NAME_CONFLICT: CIP_STATUS = CIP_STATUS(4);
pub const CIP_NEED_REBOOT: CIP_STATUS = CIP_STATUS(8);
pub const CIP_NEED_REBOOT_UI_PERMISSION: CIP_STATUS = CIP_STATUS(9);
pub const CIP_NEWER_VERSION_EXISTS: CIP_STATUS = CIP_STATUS(2);
pub const CIP_OLDER_VERSION_EXISTS: CIP_STATUS = CIP_STATUS(3);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct CIP_STATUS(pub i32);
pub const CIP_TRUST_VERIFICATION_COMPONENT_MISSING: CIP_STATUS = CIP_STATUS(5);
pub const CIP_UNSAFE_TO_ABORT: CIP_STATUS = CIP_STATUS(7);
pub const CLASSIDPROP: MONIKERPROPERTY = MONIKERPROPERTY(2);
#[repr(C)]
...
pub const FEATURE_ADDON_MANAGEMENT: INTERNETFEATURELIST = INTERNETFEATURELIST(13);
pub const FEATURE_BEHAVIORS: INTERNETFEATURELIST = INTERNETFEATURELIST(6);
pub const FEATURE_BLOCK_INPUT_PROMPTS: INTERNETFEATURELIST = INTERNETFEATURELIST(27);
pub const FEATURE_DISABLE_LEGACY_COMPRESSION: INTERNETFEATURELIST = INTERNETFEATURELIST(22);
pub const FEATURE_DISABLE_MK_PROTOCOL: INTERNETFEATURELIST = INTERNETFEATURELIST(7);
pub const FEATURE_DISABLE_NAVIGATION_SOUNDS: INTERNETFEATURELIST = INTERNETFEATURELIST(21);
pub const FEATURE_DISABLE_TELNET_PROTOCOL: INTERNETFEATURELIST = INTERNETFEATURELIST(25);
pub const FEATURE_ENTRY_COUNT: INTERNETFEATURELIST = INTERNETFEATURELIST(28);
pub const FEATURE_FEEDS: INTERNETFEATURELIST = INTERNETFEATURELIST(26);
pub const FEATURE_FORCE_ADDR_AND_STATUS: INTERNETFEATURELIST = INTERNETFEATURELIST(23);
pub const FEATURE_GET_URL_DOM_FILEPATH_UNENCODED: INTERNETFEATURELIST = INTERNETFEATURELIST(18);
pub const FEATURE_HTTP_USERNAME_PASSWORD_DISABLE: INTERNETFEATURELIST = INTERNETFEATURELIST(15);
pub const FEATURE_LOCALMACHINE_LOCKDOWN: INTERNETFEATURELIST = INTERNETFEATURELIST(8);
pub const FEATURE_MIME_HANDLING: INTERNETFEATURELIST = INTERNETFEATURELIST(2);
pub const FEATURE_MIME_SNIFFING: INTERNETFEATURELIST = INTERNETFEATURELIST(3);
pub const FEATURE_OBJECT_CACHING: INTERNETFEATURELIST = INTERNETFEATURELIST(0);
pub const FEATURE_PROTOCOL_LOCKDOWN: INTERNETFEATURELIST = INTERNETFEATURELIST(14);
pub const FEATURE_RESTRICT_ACTIVEXINSTALL: INTERNETFEATURELIST = INTERNETFEATURELIST(10);
pub const FEATURE_RESTRICT_FILEDOWNLOAD: INTERNETFEATURELIST = INTERNETFEATURELIST(12);
pub const FEATURE_SAFE_BINDTOOBJECT: INTERNETFEATURELIST = INTERNETFEATURELIST(16);
pub const FEATURE_SECURITYBAND: INTERNETFEATURELIST = INTERNETFEATURELIST(9);
pub const FEATURE_SSLUX: INTERNETFEATURELIST = INTERNETFEATURELIST(20);
pub const FEATURE_TABBED_BROWSING: INTERNETFEATURELIST = INTERNETFEATURELIST(19);
pub const FEATURE_UNC_SAVEDFILECHECK: INTERNETFEATURELIST = INTERNETFEATURELIST(17);
pub const FEATURE_VALIDATE_NAVIGATE_URL: INTERNETFEATURELIST = INTERNETFEATURELIST(11);
pub const FEATURE_WEBOC_POPUPMANAGEMENT: INTERNETFEATURELIST = INTERNETFEATURELIST(5);
pub const FEATURE_WINDOW_RESTRICTIONS: INTERNETFEATURELIST = INTERNETFEATURELIST(4);
pub const FEATURE_XMLHTTP: INTERNETFEATURELIST = INTERNETFEATURELIST(24);
pub const FEATURE_ZONE_ELEVATION: INTERNETFEATURELIST = INTERNETFEATURELIST(1);
...
impl IDataFilter {
    pub unsafe fn DoEncode(&self, dwflags: u32, pbinbuffer: &[u8], pboutbuffer: &mut [u8], linbytesavailable: i32, plinbytesread: *mut i32, ploutbyteswritten: *mut i32, dwreserved: u32) -> windows_core::HRESULT {
    ...
    pub unsafe fn DoDecode(&self, dwflags: u32, pbinbuffer: &[u8], pboutbuffer: &mut [u8], linbytesavailable: i32, plinbytesread: *mut i32, ploutbyteswritten: *mut i32, dwreserved: u32) -> windows_core::HRESULT {
...
pub const IE_EPM_OBJECT_EVENT: IEObjectType = IEObjectType(0);
pub const IE_EPM_OBJECT_FILE: IEObjectType = IEObjectType(5);
pub const IE_EPM_OBJECT_MUTEX: IEObjectType = IEObjectType(1);
pub const IE_EPM_OBJECT_NAMED_PIPE: IEObjectType = IEObjectType(6);
pub const IE_EPM_OBJECT_REGISTRY: IEObjectType = IEObjectType(7);
pub const IE_EPM_OBJECT_SEMAPHORE: IEObjectType = IEObjectType(2);
pub const IE_EPM_OBJECT_SHARED_MEMORY: IEObjectType = IEObjectType(3);
pub const IE_EPM_OBJECT_WAITABLE_TIMER: IEObjectType = IEObjectType(4);
...
impl IInternetBindInfo {
    #[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_Security", feature = "Win32_System_Com_StructuredStorage"))]
    pub unsafe fn GetBindInfo(&self, grfbindf: *mut u32, pbindinfo: *mut super::BINDINFO) -> windows_core::HRESULT {
...
impl IInternetBindInfoEx {
    #[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_Security", feature = "Win32_System_Com_StructuredStorage"))]
    pub unsafe fn GetBindInfoEx(&self, grfbindf: *mut u32, pbindinfo: *mut super::BINDINFO, grfbindf2: *mut u32, pdwreserved: *mut u32) -> windows_core::HRESULT {
...
impl IInternetHostSecurityManager {
    ...
    pub unsafe fn QueryCustomPolicy(&self, guidkey: *const windows_core::GUID, pppolicy: *mut *mut u8, pcbpolicy: *mut u32, pcontext: &[u8], dwreserved: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).QueryCustomPolicy)(windows_core::Interface::as_raw(self), guidkey, pppolicy as _, pcbpolicy as _, core::mem::transmute(pcontext.as_ptr()), pcontext.len().try_into().unwrap(), dwreserved) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IInternetProtocol {
    pub unsafe fn Read(&self, pv: &mut [u8], pcbread: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).Read)(windows_core::Interface::as_raw(self), core::mem::transmute(pv.as_ptr()), pv.len().try_into().unwrap(), pcbread as _) }
    }
...
impl IInternetProtocolEx {
    pub unsafe fn StartEx<P0, P1, P2>(&self, puri: P0, poiprotsink: P1, poibindinfo: P2, grfpi: u32, dwreserved: super::super::super::Foundation::HANDLE_PTR) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::IUri>,
...
impl IInternetProtocolInfo {
    ...
    pub unsafe fn CombineUrl<P0, P1, P3>(&self, pwzbaseurl: P0, pwzrelativeurl: P1, dwcombineflags: u32, pwzresult: P3, cchresult: u32, pcchresult: *mut u32, dwreserved: u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).CombineUrl)(windows_core::Interface::as_raw(self), pwzbaseurl.param().abi(), pwzrelativeurl.param().abi(), dwcombineflags, pwzresult.param().abi(), cchresult, pcchresult as _, dwreserved) }
    }
...
impl IInternetProtocolRoot {
    pub unsafe fn Start<P0, P1, P2>(&self, szurl: P0, poiprotsink: P1, poibindinfo: P2, grfpi: u32, dwreserved: super::super::super::Foundation::HANDLE_PTR) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<IInternetProtocolSink>,
        P2: windows_core::Param<IInternetBindInfo>,
...
impl IInternetSecurityManager {
    ...
    pub unsafe fn GetSecurityId<P0>(&self, pwszurl: P0, pbsecurityid: &mut [u8; 512], pcbsecurityid: *mut u32, dwreserved: usize) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).GetSecurityId)(windows_core::Interface::as_raw(self), pwszurl.param().abi(), core::mem::transmute(pbsecurityid.as_ptr()), pcbsecurityid as _, dwreserved) }
    }
    pub unsafe fn ProcessUrlAction<P0>(&self, pwszurl: P0, dwaction: u32, ppolicy: &mut [u8], pcontext: *const u8, cbcontext: u32, dwflags: u32, dwreserved: u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).ProcessUrlAction)(windows_core::Interface::as_raw(self), pwszurl.param().abi(), dwaction, core::mem::transmute(ppolicy.as_ptr()), ppolicy.len().try_into().unwrap(), pcontext, cbcontext, dwflags, dwreserved) }
    }
    ...
    pub unsafe fn GetZoneMappings(&self, dwzone: u32, ppenumstring: *mut Option<super::IEnumString>, dwflags: u32) -> windows_core::HRESULT {
...
impl IInternetSecurityManagerEx {
    pub unsafe fn ProcessUrlActionEx<P0>(&self, pwszurl: P0, dwaction: u32, ppolicy: &mut [u8], pcontext: *const u8, cbcontext: u32, dwflags: u32, dwreserved: u32, pdwoutflags: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).ProcessUrlActionEx)(windows_core::Interface::as_raw(self), pwszurl.param().abi(), dwaction, core::mem::transmute(ppolicy.as_ptr()), ppolicy.len().try_into().unwrap(), pcontext, cbcontext, dwflags, dwreserved, pdwoutflags as _) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IInternetSecurityManagerEx2 {
    pub unsafe fn MapUrlToZoneEx2<P0>(&self, puri: P0, pdwzone: *mut u32, dwflags: u32, ppwszmappedurl: Option<*mut windows_core::PWSTR>, pdwoutflags: Option<*mut u32>) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::IUri>,
    {
        unsafe { (windows_core::Interface::vtable(self).MapUrlToZoneEx2)(windows_core::Interface::as_raw(self), puri.param().abi(), pdwzone as _, dwflags, ppwszmappedurl.unwrap_or(core::mem::zeroed()) as _, pdwoutflags.unwrap_or(core::mem::zeroed()) as _) }
    }
    pub unsafe fn ProcessUrlActionEx2<P0>(&self, puri: P0, dwaction: u32, ppolicy: &mut [u8], pcontext: *const u8, cbcontext: u32, dwflags: u32, dwreserved: usize, pdwoutflags: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::IUri>,
    {
        unsafe { (windows_core::Interface::vtable(self).ProcessUrlActionEx2)(windows_core::Interface::as_raw(self), puri.param().abi(), dwaction, core::mem::transmute(ppolicy.as_ptr()), ppolicy.len().try_into().unwrap(), pcontext, cbcontext, dwflags, dwreserved, pdwoutflags as _) }
    }
    pub unsafe fn GetSecurityIdEx2<P0>(&self, puri: P0, pbsecurityid: &mut [u8; 512], pcbsecurityid: *mut u32, dwreserved: usize) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::IUri>,
    {
        unsafe { (windows_core::Interface::vtable(self).GetSecurityIdEx2)(windows_core::Interface::as_raw(self), puri.param().abi(), core::mem::transmute(pbsecurityid.as_ptr()), pcbsecurityid as _, dwreserved) }
    }
...
impl IInternetZoneManager {
    ...
    pub unsafe fn SetZoneCustomPolicy(&self, dwzone: u32, guidkey: *const windows_core::GUID, ppolicy: &[u8], urlzonereg: URLZONEREG) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetZoneCustomPolicy)(windows_core::Interface::as_raw(self), dwzone, guidkey, core::mem::transmute(ppolicy.as_ptr()), ppolicy.len().try_into().unwrap(), urlzonereg) }
    }
    pub unsafe fn GetZoneActionPolicy(&self, dwzone: u32, dwaction: u32, ppolicy: &mut [u8], urlzonereg: URLZONEREG) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetZoneActionPolicy)(windows_core::Interface::as_raw(self), dwzone, dwaction, core::mem::transmute(ppolicy.as_ptr()), ppolicy.len().try_into().unwrap(), urlzonereg) }
    }
    pub unsafe fn SetZoneActionPolicy(&self, dwzone: u32, dwaction: u32, ppolicy: &[u8], urlzonereg: URLZONEREG) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetZoneActionPolicy)(windows_core::Interface::as_raw(self), dwzone, dwaction, core::mem::transmute(ppolicy.as_ptr()), ppolicy.len().try_into().unwrap(), urlzonereg) }
    }
    pub unsafe fn PromptAction<P2, P3>(&self, dwaction: u32, hwndparent: super::super::super::Foundation::HWND, pwszurl: P2, pwsztext: P3, dwpromptflags: u32) -> windows_core::HRESULT
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
...
impl IInternetZoneManagerEx {
    pub unsafe fn GetZoneActionPolicyEx(&self, dwzone: u32, dwaction: u32, ppolicy: &mut [u8], urlzonereg: URLZONEREG, dwflags: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetZoneActionPolicyEx)(windows_core::Interface::as_raw(self), dwzone, dwaction, core::mem::transmute(ppolicy.as_ptr()), ppolicy.len().try_into().unwrap(), urlzonereg, dwflags) }
    }
    pub unsafe fn SetZoneActionPolicyEx(&self, dwzone: u32, dwaction: u32, ppolicy: &[u8], urlzonereg: URLZONEREG, dwflags: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetZoneActionPolicyEx)(windows_core::Interface::as_raw(self), dwzone, dwaction, core::mem::transmute(ppolicy.as_ptr()), ppolicy.len().try_into().unwrap(), urlzonereg, dwflags) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl IWinInetCacheHints2 {
    pub unsafe fn SetCacheExtension2<P0>(&self, pwzext: P0, pwzcachefile: windows_core::PWSTR, pcchcachefile: *mut u32, pdwwinineterror: *mut u32, pdwreserved: *mut u32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetCacheExtension2)(windows_core::Interface::as_raw(self), pwzext.param().abi(), core::mem::transmute(pwzcachefile), pcchcachefile as _, pdwwinineterror as _, pdwreserved as _) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
pub const MAX_ZONE_DESCRIPTION: INET_ZONE_MANAGER_CONSTANTS = INET_ZONE_MANAGER_CONSTANTS(200);
pub const MAX_ZONE_PATH: INET_ZONE_MANAGER_CONSTANTS = INET_ZONE_MANAGER_CONSTANTS(260);
pub const MIMETYPEPROP: MONIKERPROPERTY = MONIKERPROPERTY(0);
...
pub const OIBDG_APARTMENTTHREADED: OIBDG_FLAGS = OIBDG_FLAGS(256);
pub const OIBDG_DATAONLY: OIBDG_FLAGS = OIBDG_FLAGS(4096);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const PARSE_ANCHOR: PARSEACTION = PARSEACTION(6);
pub const PARSE_CANONICALIZE: PARSEACTION = PARSEACTION(1);
pub const PARSE_DECODE_IS_ESCAPE: PARSEACTION = PARSEACTION(8);
pub const PARSE_DOCUMENT: PARSEACTION = PARSEACTION(5);
pub const PARSE_DOMAIN: PARSEACTION = PARSEACTION(15);
pub const PARSE_ENCODE_IS_UNESCAPE: PARSEACTION = PARSEACTION(7);
pub const PARSE_ESCAPE: PARSEACTION = PARSEACTION(18);
pub const PARSE_FRIENDLY: PARSEACTION = PARSEACTION(2);
pub const PARSE_LOCATION: PARSEACTION = PARSEACTION(16);
pub const PARSE_MIME: PARSEACTION = PARSEACTION(11);
pub const PARSE_PATH_FROM_URL: PARSEACTION = PARSEACTION(9);
pub const PARSE_ROOTDOCUMENT: PARSEACTION = PARSEACTION(4);
pub const PARSE_SCHEMA: PARSEACTION = PARSEACTION(13);
pub const PARSE_SECURITY_DOMAIN: PARSEACTION = PARSEACTION(17);
pub const PARSE_SECURITY_URL: PARSEACTION = PARSEACTION(3);
pub const PARSE_SERVER: PARSEACTION = PARSEACTION(12);
pub const PARSE_SITE: PARSEACTION = PARSEACTION(14);
pub const PARSE_UNESCAPE: PARSEACTION = PARSEACTION(19);
pub const PARSE_URL_FROM_PATH: PARSEACTION = PARSEACTION(10);
pub const PD_FORCE_SWITCH: PI_FLAGS = PI_FLAGS(65536);
pub const PI_APARTMENTTHREADED: PI_FLAGS = PI_FLAGS(256);
pub const PI_CLASSINSTALL: PI_FLAGS = PI_FLAGS(512);
pub const PI_CLSIDLOOKUP: PI_FLAGS = PI_FLAGS(32);
pub const PI_DATAPROGRESS: PI_FLAGS = PI_FLAGS(64);
pub const PI_FILTER_MODE: PI_FLAGS = PI_FLAGS(2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct PI_FLAGS(pub i32);
pub const PI_FORCE_ASYNC: PI_FLAGS = PI_FLAGS(4);
pub const PI_LOADAPPDIRECT: PI_FLAGS = PI_FLAGS(16384);
pub const PI_MIMEVERIFICATION: PI_FLAGS = PI_FLAGS(16);
pub const PI_NOMIMEHANDLER: PI_FLAGS = PI_FLAGS(32768);
pub const PI_PARSE_URL: PI_FLAGS = PI_FLAGS(1);
pub const PI_PASSONBINDCTX: PI_FLAGS = PI_FLAGS(8192);
pub const PI_PREFERDEFAULTHANDLER: PI_FLAGS = PI_FLAGS(131072);
pub const PI_SYNCHRONOUS: PI_FLAGS = PI_FLAGS(128);
pub const PI_USE_WORKERTHREAD: PI_FLAGS = PI_FLAGS(8);
pub const POPUPLEVELPROP: MONIKERPROPERTY = MONIKERPROPERTY(4);
#[repr(C)]
...
pub const PSU_DEFAULT: PSUACTION = PSUACTION(1);
pub const PSU_SECURITY_URL_ONLY: PSUACTION = PSUACTION(2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const PUAFOUT_DEFAULT: PUAFOUT = PUAFOUT(0);
pub const PUAFOUT_ISLOCKZONEPOLICY: PUAFOUT = PUAFOUT(1);
pub const PUAF_ACCEPT_WILDCARD_SCHEME: PUAF = PUAF(128);
pub const PUAF_CHECK_TIFS: PUAF = PUAF(16);
pub const PUAF_DEFAULT: PUAF = PUAF(0);
pub const PUAF_DEFAULTZONEPOL: PUAF = PUAF(262144);
pub const PUAF_DONTCHECKBOXINDIALOG: PUAF = PUAF(32);
pub const PUAF_DONT_USE_CACHE: PUAF = PUAF(4096);
pub const PUAF_DRAGPROTOCOLCHECK: PUAF = PUAF(2097152);
pub const PUAF_ENFORCERESTRICTED: PUAF = PUAF(256);
pub const PUAF_FORCEUI_FOREGROUND: PUAF = PUAF(8);
pub const PUAF_ISFILE: PUAF = PUAF(2);
pub const PUAF_LMZ_LOCKED: PUAF = PUAF(131072);
pub const PUAF_LMZ_UNLOCKED: PUAF = PUAF(65536);
pub const PUAF_NOSAVEDFILECHECK: PUAF = PUAF(512);
pub const PUAF_NOUI: PUAF = PUAF(1);
pub const PUAF_NOUIIFLOCKED: PUAF = PUAF(1048576);
pub const PUAF_NPL_USE_LOCKED_IF_RESTRICTED: PUAF = PUAF(524288);
pub const PUAF_REQUIRESAVEDFILECHECK: PUAF = PUAF(1024);
pub const PUAF_RESERVED1: PUAF = PUAF(8192);
pub const PUAF_RESERVED2: PUAF = PUAF(16384);
pub const PUAF_TRUSTED: PUAF = PUAF(64);
pub const PUAF_WARN_IF_DENIED: PUAF = PUAF(4);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct QUERYOPTION(pub i32);
pub const QUERY_CAN_NAVIGATE: QUERYOPTION = QUERYOPTION(7);
pub const QUERY_CONTENT_ENCODING: QUERYOPTION = QUERYOPTION(3);
pub const QUERY_CONTENT_TYPE: QUERYOPTION = QUERYOPTION(4);
pub const QUERY_EXPIRATION_DATE: QUERYOPTION = QUERYOPTION(1);
pub const QUERY_IS_CACHED: QUERYOPTION = QUERYOPTION(9);
pub const QUERY_IS_CACHED_AND_USABLE_OFFLINE: QUERYOPTION = QUERYOPTION(16);
pub const QUERY_IS_CACHED_OR_MAPPED: QUERYOPTION = QUERYOPTION(11);
pub const QUERY_IS_INSTALLEDENTRY: QUERYOPTION = QUERYOPTION(10);
pub const QUERY_IS_SAFE: QUERYOPTION = QUERYOPTION(14);
pub const QUERY_IS_SECURE: QUERYOPTION = QUERYOPTION(13);
pub const QUERY_RECOMBINE: QUERYOPTION = QUERYOPTION(6);
pub const QUERY_REFRESH: QUERYOPTION = QUERYOPTION(5);
pub const QUERY_TIME_OF_LAST_CHANGE: QUERYOPTION = QUERYOPTION(2);
pub const QUERY_USES_CACHE: QUERYOPTION = QUERYOPTION(12);
pub const QUERY_USES_HISTORYFOLDER: QUERYOPTION = QUERYOPTION(15);
pub const QUERY_USES_NETWORK: QUERYOPTION = QUERYOPTION(8);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const SZM_CREATE: SZM_FLAGS = SZM_FLAGS(0);
pub const SZM_DELETE: SZM_FLAGS = SZM_FLAGS(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const TRUSTEDDOWNLOADPROP: MONIKERPROPERTY = MONIKERPROPERTY(3);
...
pub const URLTEMPLATE_CUSTOM: URLTEMPLATE = URLTEMPLATE(0);
pub const URLTEMPLATE_HIGH: URLTEMPLATE = URLTEMPLATE(73728);
pub const URLTEMPLATE_LOW: URLTEMPLATE = URLTEMPLATE(65536);
pub const URLTEMPLATE_MEDHIGH: URLTEMPLATE = URLTEMPLATE(70912);
pub const URLTEMPLATE_MEDIUM: URLTEMPLATE = URLTEMPLATE(69632);
pub const URLTEMPLATE_MEDLOW: URLTEMPLATE = URLTEMPLATE(66816);
pub const URLTEMPLATE_PREDEFINED_MAX: URLTEMPLATE = URLTEMPLATE(131072);
pub const URLTEMPLATE_PREDEFINED_MIN: URLTEMPLATE = URLTEMPLATE(65536);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const URLZONEREG_DEFAULT: URLZONEREG = URLZONEREG(0);
pub const URLZONEREG_HKCU: URLZONEREG = URLZONEREG(2);
pub const URLZONEREG_HKLM: URLZONEREG = URLZONEREG(1);
pub const URLZONE_ESC_FLAG: u32 = 256;
pub const URLZONE_INTERNET: URLZONE = URLZONE(3);
pub const URLZONE_INTRANET: URLZONE = URLZONE(1);
pub const URLZONE_INVALID: URLZONE = URLZONE(-1);
pub const URLZONE_LOCAL_MACHINE: URLZONE = URLZONE(0);
pub const URLZONE_PREDEFINED_MAX: URLZONE = URLZONE(999);
pub const URLZONE_PREDEFINED_MIN: URLZONE = URLZONE(0);
pub const URLZONE_TRUSTED: URLZONE = URLZONE(2);
pub const URLZONE_UNTRUSTED: URLZONE = URLZONE(4);
pub const URLZONE_USER_MAX: URLZONE = URLZONE(10000);
pub const URLZONE_USER_MIN: URLZONE = URLZONE(1000);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct URL_ENCODING(pub i32);
pub const URL_ENCODING_DISABLE_UTF8: URL_ENCODING = URL_ENCODING(536870912);
pub const URL_ENCODING_ENABLE_UTF8: URL_ENCODING = URL_ENCODING(268435456);
pub const URL_ENCODING_NONE: URL_ENCODING = URL_ENCODING(0);
pub const URL_MK_LEGACY: u32 = 0;
pub const URL_MK_NO_CANONICALIZE: u32 = 2;
pub const URL_MK_UNIFORM: u32 = 1;
pub const USE_SRC_URL: MONIKERPROPERTY = MONIKERPROPERTY(1);
...
pub const Uri_HOST_DNS: Uri_HOST_TYPE = Uri_HOST_TYPE(1);
pub const Uri_HOST_IDN: Uri_HOST_TYPE = Uri_HOST_TYPE(4);
pub const Uri_HOST_IPV4: Uri_HOST_TYPE = Uri_HOST_TYPE(2);
pub const Uri_HOST_IPV6: Uri_HOST_TYPE = Uri_HOST_TYPE(3);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct Uri_HOST_TYPE(pub i32);
pub const Uri_HOST_UNKNOWN: Uri_HOST_TYPE = Uri_HOST_TYPE(0);
pub const Uri_PUNYCODE_IDN_HOST: u32 = 2;
pub const WININETINFO_OPTION_LOCK_HANDLE: u32 = 65534;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct ZAFLAGS(pub i32);
pub const ZAFLAGS_ADD_SITES: ZAFLAGS = ZAFLAGS(2);
pub const ZAFLAGS_CUSTOM_EDIT: ZAFLAGS = ZAFLAGS(1);
pub const ZAFLAGS_DETECT_INTRANET: ZAFLAGS = ZAFLAGS(256);
pub const ZAFLAGS_INCLUDE_INTRANET_SITES: ZAFLAGS = ZAFLAGS(16);
pub const ZAFLAGS_INCLUDE_PROXY_OVERRIDE: ZAFLAGS = ZAFLAGS(8);
pub const ZAFLAGS_NO_CACHE: ZAFLAGS = ZAFLAGS(262144);
pub const ZAFLAGS_NO_UI: ZAFLAGS = ZAFLAGS(32);
pub const ZAFLAGS_REQUIRE_VERIFICATION: ZAFLAGS = ZAFLAGS(4);
pub const ZAFLAGS_SUPPORTS_VERIFICATION: ZAFLAGS = ZAFLAGS(64);
pub const ZAFLAGS_UNC_AS_INTRANET: ZAFLAGS = ZAFLAGS(128);
pub const ZAFLAGS_USE_LOCKED_ZONES: ZAFLAGS = ZAFLAGS(65536);
pub const ZAFLAGS_VERIFY_TEMPLATE_SETTINGS: ZAFLAGS = ZAFLAGS(131072);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
