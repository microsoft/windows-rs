...
pub unsafe fn CopyStgMedium(pcstgmedsrc: *const super::STGMEDIUM) -> windows_core::Result<super::STGMEDIUM> {
    ...
    CopyStgMedium(core::mem::transmute(pcstgmedsrc), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
}
#[inline]
...
impl IInternetBindInfo {
    ...
    pub unsafe fn GetBindInfo(&self, grfbindf: *mut u32, pbindinfo: *mut super::BINDINFO) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetBindInfo)(windows_core::Interface::as_raw(self), grfbindf, core::mem::transmute(pbindinfo)).ok()
    }
...
impl IInternetBindInfoEx {
    ...
    pub unsafe fn GetBindInfoEx(&self, grfbindf: *mut u32, pbindinfo: *mut super::BINDINFO, grfbindf2: *mut u32, pdwreserved: *mut u32) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetBindInfoEx)(windows_core::Interface::as_raw(self), grfbindf, core::mem::transmute(pbindinfo), grfbindf2, pdwreserved).ok()
    }
}
#[repr(C)]
