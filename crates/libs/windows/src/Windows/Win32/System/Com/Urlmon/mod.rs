    ...
    P1: ::windows_core::IntoParam<super::IEnumFORMATETC>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    CreateAsyncBindCtx(reserved, pbscb.into_param().abi(), pefetc.into_param().abi(), &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
}
#[inline]
    ...
    P1: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    CreateURLMoniker(pmkctx.into_param().abi(), szurl.into_param().abi(), &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
}
#[inline]
    ...
    P0: ::windows_core::IntoParam<::windows_core::PCSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    FindMediaType(rgsztypes.into_param().abi(), &mut result__).map(|| result__)
}
#[inline]
    ...
    P2: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    GetClassFileOrMime(pbc.into_param().abi(), szfilename.into_param().abi(), ::core::mem::transmute(pbuffer.unwrap_or(::std::ptr::null())), cbsize, szmime.into_param().abi(), dwreserved, &mut result__).map(|| result__)
}
#[inline]
    ...
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    GetClassURL(szurl.into_param().abi(), &mut result__).map(|| result__)
}
#[inline]
...
impl IBindCallbackRedirect {
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).Redirect)(::windows_core::Interface::as_raw(self), lpcurl.into_param().abi(), &mut result__).map(|| result__)
    }
}
#[repr(C)]
...
impl IBindProtocol {
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).CreateBinding)(::windows_core::Interface::as_raw(self), szurl.into_param().abi(), pbc.into_param().abi(), &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
}
#[repr(C)]
...
impl ICodeInstall {
    pub unsafe fn GetWindow(&self, rguidreason: *const ::windows_core::GUID) -> ::windows_core::Result<super::super::super::Foundation::HWND> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.GetWindow)(::windows_core::Interface::as_raw(self), rguidreason, &mut result__).map(|| result__)
    }
...
impl IEncodingFilterFactory {
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).FindBestFilter)(::windows_core::Interface::as_raw(self), pwzcodein.into_param().abi(), pwzcodeout.into_param().abi(), ::core::mem::transmute(info), &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).GetDefaultFilter)(::windows_core::Interface::as_raw(self), pwzcodein.into_param().abi(), pwzcodeout.into_param().abi(), &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
}
#[repr(C)]
...
impl IHttpNegotiate {
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).BeginningTransaction)(::windows_core::Interface::as_raw(self), szurl.into_param().abi(), szheaders.into_param().abi(), dwreserved, &mut result__).map(|| result__)
    }
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).OnResponse)(::windows_core::Interface::as_raw(self), dwresponsecode, szresponseheaders.into_param().abi(), szrequestheaders.into_param().abi(), &mut result__).map(|| result__)
    }
}
#[repr(C)]
...
impl IHttpNegotiate2 {
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.BeginningTransaction)(::windows_core::Interface::as_raw(self), szurl.into_param().abi(), szheaders.into_param().abi(), dwreserved, &mut result__).map(|| result__)
    }
    pub unsafe fn OnResponse<P0, P1>(&self, dwresponsecode: u32, szresponseheaders: P0, szrequestheaders: P1) -> ::windows_core::Result<::windows_core::PWSTR>
    where
        P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.OnResponse)(::windows_core::Interface::as_raw(self), dwresponsecode, szresponseheaders.into_param().abi(), szrequestheaders.into_param().abi(), &mut result__).map(|| result__)
    }
...
impl IHttpNegotiate3 {
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.base__.BeginningTransaction)(::windows_core::Interface::as_raw(self), szurl.into_param().abi(), szheaders.into_param().abi(), dwreserved, &mut result__).map(|| result__)
    }
    pub unsafe fn OnResponse<P0, P1>(&self, dwresponsecode: u32, szresponseheaders: P0, szrequestheaders: P1) -> ::windows_core::Result<::windows_core::PWSTR>
    where
        P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
    ...
    {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.base__.OnResponse)(::windows_core::Interface::as_raw(self), dwresponsecode, szresponseheaders.into_param().abi(), szrequestheaders.into_param().abi(), &mut result__).map(|| result__)
    }
    pub unsafe fn GetRootSecurityId(&self, pbsecurityid: *mut u8, pcbsecurityid: *mut u32, dwreserved: usize) -> ::windows_core::Result<()> {
...
impl IInternetProtocolEx {
    ...
    pub unsafe fn Seek(&self, dlibmove: i64, dworigin: u32) -> ::windows_core::Result<u64> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.Seek)(::windows_core::Interface::as_raw(self), dlibmove, dworigin, &mut result__).map(|| result__)
    }
    pub unsafe fn LockRequest(&self, dwoptions: u32) -> ::windows_core::Result<()> {
...
impl IInternetSecurityManagerEx {
    ...
    pub unsafe fn GetSecuritySite(&self) -> ::windows_core::Result<IInternetSecurityMgrSite> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.GetSecuritySite)(::windows_core::Interface::as_raw(self), &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    pub unsafe fn MapUrlToZone<P0>(&self, pwszurl: P0, pdwzone: *mut u32, dwflags: u32) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
...
impl IInternetSecurityManagerEx2 {
    ...
    pub unsafe fn GetSecuritySite(&self) -> ::windows_core::Result<IInternetSecurityMgrSite> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.base__.GetSecuritySite)(::windows_core::Interface::as_raw(self), &mut result__).and_then(|| ::windows_core::Type::from_abi(result__))
    }
    pub unsafe fn MapUrlToZone<P0>(&self, pwszurl: P0, pdwzone: *mut u32, dwflags: u32) -> ::windows_core::Result<()>
    where
        P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
...
impl IInternetZoneManagerEx {
    ...
    pub unsafe fn GetZoneAt(&self, dwenum: u32, dwindex: u32) -> ::windows_core::Result<u32> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.GetZoneAt)(::windows_core::Interface::as_raw(self), dwenum, dwindex, &mut result__).map(|| result__)
    }
    pub unsafe fn DestroyZoneEnumerator(&self, dwenum: u32) -> ::windows_core::Result<()> {
...
impl IInternetZoneManagerEx2 {
    ...
    pub unsafe fn GetZoneAt(&self, dwenum: u32, dwindex: u32) -> ::windows_core::Result<u32> {
        let mut result__ = ::std::mem::zeroed();
        (::windows_core::Interface::vtable(self).base__.base__.GetZoneAt)(::windows_core::Interface::as_raw(self), dwenum, dwindex, &mut result__).map(|| result__)
    }
    pub unsafe fn DestroyZoneEnumerator(&self, dwenum: u32) -> ::windows_core::Result<()> {
...
pub const E_PENDING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8000000Au32 as _);
...
pub const INET_E_AUTHENTICATION_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0009u32 as _);
pub const INET_E_BLOCKED_ENHANCEDPROTECTEDMODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0506u32 as _);
pub const INET_E_BLOCKED_PLUGGABLE_PROTOCOL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0505u32 as _);
pub const INET_E_BLOCKED_REDIRECT_XSECURITYID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C001Bu32 as _);
pub const INET_E_CANNOT_CONNECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0004u32 as _);
pub const INET_E_CANNOT_INSTANTIATE_OBJECT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0010u32 as _);
pub const INET_E_CANNOT_LOAD_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C000Fu32 as _);
pub const INET_E_CANNOT_LOCK_REQUEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0016u32 as _);
pub const INET_E_CANNOT_REPLACE_SFP_FILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0300u32 as _);
pub const INET_E_CODE_DOWNLOAD_DECLINED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0100u32 as _);
pub const INET_E_CODE_INSTALL_BLOCKED_ARM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0504u32 as _);
pub const INET_E_CODE_INSTALL_BLOCKED_BITNESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0507u32 as _);
pub const INET_E_CODE_INSTALL_BLOCKED_BY_HASH_POLICY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0500u32 as _);
pub const INET_E_CODE_INSTALL_BLOCKED_IMMERSIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0502u32 as _);
pub const INET_E_CODE_INSTALL_SUPPRESSED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0400u32 as _);
pub const INET_E_CONNECTION_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C000Bu32 as _);
pub const INET_E_DATA_NOT_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0007u32 as _);
pub const INET_E_DEFAULT_ACTION: i32 = -2146697199i32;
pub const INET_E_DOMINJECTIONVALIDATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C001Cu32 as _);
pub const INET_E_DOWNLOAD_BLOCKED_BY_CSP: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0508u32 as _);
pub const INET_E_DOWNLOAD_BLOCKED_BY_INPRIVATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0501u32 as _);
pub const INET_E_DOWNLOAD_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0008u32 as _);
pub const INET_E_ERROR_FIRST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0002u32 as _);
pub const INET_E_ERROR_LAST: i32 = -2146695928i32;
pub const INET_E_FORBIDFRAMING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0503u32 as _);
pub const INET_E_HSTS_CERTIFICATE_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C001Eu32 as _);
pub const INET_E_INVALID_CERTIFICATE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0019u32 as _);
pub const INET_E_INVALID_REQUEST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C000Cu32 as _);
pub const INET_E_INVALID_URL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0002u32 as _);
pub const INET_E_NO_SESSION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0003u32 as _);
pub const INET_E_NO_VALID_MEDIA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C000Au32 as _);
pub const INET_E_OBJECT_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0006u32 as _);
pub const INET_E_QUERYOPTION_UNKNOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0013u32 as _);
pub const INET_E_REDIRECTING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0014u32 as _);
pub const INET_E_REDIRECT_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0014u32 as _);
pub const INET_E_REDIRECT_TO_DIR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0015u32 as _);
pub const INET_E_RESERVED_1: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C001Au32 as _);
pub const INET_E_RESERVED_2: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C001Fu32 as _);
pub const INET_E_RESERVED_3: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0020u32 as _);
pub const INET_E_RESERVED_4: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0021u32 as _);
pub const INET_E_RESERVED_5: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0022u32 as _);
pub const INET_E_RESOURCE_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0005u32 as _);
pub const INET_E_RESULT_DISPATCHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0200u32 as _);
pub const INET_E_SECURITY_PROBLEM: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C000Eu32 as _);
pub const INET_E_TERMINATED_BIND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0018u32 as _);
pub const INET_E_UNKNOWN_PROTOCOL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C000Du32 as _);
pub const INET_E_USE_DEFAULT_PROTOCOLHANDLER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0011u32 as _);
pub const INET_E_USE_DEFAULT_SETTING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0012u32 as _);
pub const INET_E_USE_EXTEND_BINDING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C0017u32 as _);
pub const INET_E_VTAB_SWITCH_FORCE_ENGINE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800C001Du32 as _);
...
pub const MK_S_ASYNCHRONOUS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x401E8u32 as _);
