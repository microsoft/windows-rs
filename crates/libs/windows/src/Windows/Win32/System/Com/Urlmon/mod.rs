...
pub const E_PENDING: windows_core::HRESULT = 0x8000000A_u32 as _;
...
pub const INET_E_AUTHENTICATION_REQUIRED: windows_core::HRESULT = 0x800C0009_u32 as _;
pub const INET_E_BLOCKED_ENHANCEDPROTECTEDMODE: windows_core::HRESULT = 0x800C0506_u32 as _;
pub const INET_E_BLOCKED_PLUGGABLE_PROTOCOL: windows_core::HRESULT = 0x800C0505_u32 as _;
pub const INET_E_BLOCKED_REDIRECT_XSECURITYID: windows_core::HRESULT = 0x800C001B_u32 as _;
pub const INET_E_CANNOT_CONNECT: windows_core::HRESULT = 0x800C0004_u32 as _;
pub const INET_E_CANNOT_INSTANTIATE_OBJECT: windows_core::HRESULT = 0x800C0010_u32 as _;
pub const INET_E_CANNOT_LOAD_DATA: windows_core::HRESULT = 0x800C000F_u32 as _;
pub const INET_E_CANNOT_LOCK_REQUEST: windows_core::HRESULT = 0x800C0016_u32 as _;
pub const INET_E_CANNOT_REPLACE_SFP_FILE: windows_core::HRESULT = 0x800C0300_u32 as _;
pub const INET_E_CODE_DOWNLOAD_DECLINED: windows_core::HRESULT = 0x800C0100_u32 as _;
pub const INET_E_CODE_INSTALL_BLOCKED_ARM: windows_core::HRESULT = 0x800C0504_u32 as _;
pub const INET_E_CODE_INSTALL_BLOCKED_BITNESS: windows_core::HRESULT = 0x800C0507_u32 as _;
pub const INET_E_CODE_INSTALL_BLOCKED_BY_HASH_POLICY: windows_core::HRESULT = 0x800C0500_u32 as _;
pub const INET_E_CODE_INSTALL_BLOCKED_IMMERSIVE: windows_core::HRESULT = 0x800C0502_u32 as _;
pub const INET_E_CODE_INSTALL_SUPPRESSED: windows_core::HRESULT = 0x800C0400_u32 as _;
pub const INET_E_CONNECTION_TIMEOUT: windows_core::HRESULT = 0x800C000B_u32 as _;
pub const INET_E_DATA_NOT_AVAILABLE: windows_core::HRESULT = 0x800C0007_u32 as _;
pub const INET_E_DEFAULT_ACTION: i32 = -2146697199i32;
pub const INET_E_DOMINJECTIONVALIDATION: windows_core::HRESULT = 0x800C001C_u32 as _;
pub const INET_E_DOWNLOAD_BLOCKED_BY_CSP: windows_core::HRESULT = 0x800C0508_u32 as _;
pub const INET_E_DOWNLOAD_BLOCKED_BY_INPRIVATE: windows_core::HRESULT = 0x800C0501_u32 as _;
pub const INET_E_DOWNLOAD_FAILURE: windows_core::HRESULT = 0x800C0008_u32 as _;
pub const INET_E_ERROR_FIRST: windows_core::HRESULT = 0x800C0002_u32 as _;
pub const INET_E_ERROR_LAST: i32 = -2146695928i32;
pub const INET_E_FORBIDFRAMING: windows_core::HRESULT = 0x800C0503_u32 as _;
pub const INET_E_HSTS_CERTIFICATE_ERROR: windows_core::HRESULT = 0x800C001E_u32 as _;
pub const INET_E_INVALID_CERTIFICATE: windows_core::HRESULT = 0x800C0019_u32 as _;
pub const INET_E_INVALID_REQUEST: windows_core::HRESULT = 0x800C000C_u32 as _;
pub const INET_E_INVALID_URL: windows_core::HRESULT = 0x800C0002_u32 as _;
pub const INET_E_NO_SESSION: windows_core::HRESULT = 0x800C0003_u32 as _;
pub const INET_E_NO_VALID_MEDIA: windows_core::HRESULT = 0x800C000A_u32 as _;
pub const INET_E_OBJECT_NOT_FOUND: windows_core::HRESULT = 0x800C0006_u32 as _;
pub const INET_E_QUERYOPTION_UNKNOWN: windows_core::HRESULT = 0x800C0013_u32 as _;
pub const INET_E_REDIRECTING: windows_core::HRESULT = 0x800C0014_u32 as _;
pub const INET_E_REDIRECT_FAILED: windows_core::HRESULT = 0x800C0014_u32 as _;
pub const INET_E_REDIRECT_TO_DIR: windows_core::HRESULT = 0x800C0015_u32 as _;
pub const INET_E_RESERVED_1: windows_core::HRESULT = 0x800C001A_u32 as _;
pub const INET_E_RESERVED_2: windows_core::HRESULT = 0x800C001F_u32 as _;
pub const INET_E_RESERVED_3: windows_core::HRESULT = 0x800C0020_u32 as _;
pub const INET_E_RESERVED_4: windows_core::HRESULT = 0x800C0021_u32 as _;
pub const INET_E_RESERVED_5: windows_core::HRESULT = 0x800C0022_u32 as _;
pub const INET_E_RESOURCE_NOT_FOUND: windows_core::HRESULT = 0x800C0005_u32 as _;
pub const INET_E_RESULT_DISPATCHED: windows_core::HRESULT = 0x800C0200_u32 as _;
pub const INET_E_SECURITY_PROBLEM: windows_core::HRESULT = 0x800C000E_u32 as _;
pub const INET_E_TERMINATED_BIND: windows_core::HRESULT = 0x800C0018_u32 as _;
pub const INET_E_UNKNOWN_PROTOCOL: windows_core::HRESULT = 0x800C000D_u32 as _;
pub const INET_E_USE_DEFAULT_PROTOCOLHANDLER: windows_core::HRESULT = 0x800C0011_u32 as _;
pub const INET_E_USE_DEFAULT_SETTING: windows_core::HRESULT = 0x800C0012_u32 as _;
pub const INET_E_USE_EXTEND_BINDING: windows_core::HRESULT = 0x800C0017_u32 as _;
pub const INET_E_VTAB_SWITCH_FORCE_ENGINE: windows_core::HRESULT = 0x800C001D_u32 as _;
...
pub const MK_S_ASYNCHRONOUS: windows_core::HRESULT = 0x401E8_u32 as _;
...
pub struct StartParam {
    pub iid: windows_core::GUID,
    pub pIBindCtx: Option<super::IBindCtx>,
