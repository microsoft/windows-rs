...
pub trait IChannelCredentials_Impl: Sized + super::IDispatch_Impl {
    ...
    fn SetClientCertificateFromStore(&self, storelocation: &::windows_core::BSTR, storename: &::windows_core::BSTR, findyype: &::windows_core::BSTR, findvalue: &super::VARIANT) -> ::windows_core::Result<()>;
    ...
    fn SetDefaultServiceCertificateFromStore(&self, storelocation: &::windows_core::BSTR, storename: &::windows_core::BSTR, findtype: &::windows_core::BSTR, findvalue: &super::VARIANT) -> ::windows_core::Result<()>;
...
impl IChannelCredentials_Vtbl {
    pub const fn new<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: IChannelCredentials_Impl, const OFFSET: isize>() -> IChannelCredentials_Vtbl {
        ...
        unsafe extern "system" fn SetDefaultServiceCertificateFromStore<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: IChannelCredentials_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, storelocation: ::std::mem::MaybeUninit<::windows_core::BSTR>, storename: ::std::mem::MaybeUninit<::windows_core::BSTR>, findtype: ::std::mem::MaybeUninit<::windows_core::BSTR>, findvalue: super::VARIANT) -> ::windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
