...
impl IMarshalVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IMarshalImpl, const OFFSET: isize>() -> IMarshalVtbl {
        unsafe extern "system" fn GetUnmarshalClass<Impl: IMarshalImpl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, riid: &::windows::core::GUID, pv: *const ::core::ffi::c_void, dwdestcontext: u32, pvdestcontext: *mut ::core::ffi::c_void, mshlflags: u32, pcid: *mut ::windows::core::GUID) -> ::windows::core::HRESULT {
        ...
        unsafe extern "system" fn GetMarshalSizeMax<Impl: IMarshalImpl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, riid: &::windows::core::GUID, pv: *const ::core::ffi::c_void, dwdestcontext: u32, pvdestcontext: *mut ::core::ffi::c_void, mshlflags: u32, psize: *mut u32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn MarshalInterface<Impl: IMarshalImpl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, pstm: ::windows::core::RawPtr, riid: &::windows::core::GUID, pv: *const ::core::ffi::c_void, dwdestcontext: u32, pvdestcontext: *mut ::core::ffi::c_void, mshlflags: u32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn UnmarshalInterface<Impl: IMarshalImpl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, pstm: ::windows::core::RawPtr, riid: &::windows::core::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IMarshal>, ::windows::core::GetTrustLevel, GetUnmarshalClass::<Impl, OFFSET>, GetMarshalSizeMax::<Impl, OFFSET>, MarshalInterface::<Impl, OFFSET>, UnmarshalInterface::<Impl, OFFSET>, ReleaseMarshalData::<Impl, OFFSET>, DisconnectObject::<Impl, OFFSET>)
    }
}
...
impl IMarshal2Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IMarshal2Impl, const OFFSET: isize>() -> IMarshal2Vtbl {
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IMarshal2>, ::windows::core::GetTrustLevel)
    }
}
...
impl IMarshalingStreamVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IMarshalingStreamImpl, const OFFSET: isize>() -> IMarshalingStreamVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IMarshalingStream>, ::windows::core::GetTrustLevel, GetMarshalingContextAttribute::<Impl, OFFSET>)
    }
}
