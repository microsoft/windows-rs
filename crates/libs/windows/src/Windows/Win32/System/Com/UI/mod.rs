...
impl IDummyHICONIncluder {
    ...
    pub unsafe fn Dummy(&self, h1: super::super::super::UI::WindowsAndMessaging::HICON, h2: super::super::super::Graphics::Gdi::HDC) -> windows_result::Result<()> {
...
pub trait IDummyHICONIncluder_Impl: windows_core::IUnknownImpl {
    fn Dummy(&self, h1: super::super::super::UI::WindowsAndMessaging::HICON, h2: super::super::super::Graphics::Gdi::HDC) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_UI_WindowsAndMessaging"))]
...
impl IThumbnailExtractor {
    ...
    pub unsafe fn ExtractThumbnail<P0>(&self, pstg: P0, ullength: u32, ulheight: u32, puloutputlength: *mut u32, puloutputheight: *mut u32, phoutputbitmap: *mut super::super::super::Graphics::Gdi::HBITMAP) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn OnFileUpdated<P0>(&self, pstg: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::StructuredStorage::IStorage>,
    {
...
pub trait IThumbnailExtractor_Impl: windows_core::IUnknownImpl {
    fn ExtractThumbnail(&self, pstg: windows_core::Ref<super::StructuredStorage::IStorage>, ullength: u32, ulheight: u32, puloutputlength: *mut u32, puloutputheight: *mut u32, phoutputbitmap: *mut super::super::super::Graphics::Gdi::HBITMAP) -> windows_result::Result<()>;
    fn OnFileUpdated(&self, pstg: windows_core::Ref<super::StructuredStorage::IStorage>) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_System_Com_StructuredStorage"))]
