...
#[inline]
pub unsafe fn EnclaveCopyIntoEnclave(enclaveaddress: *mut core::ffi::c_void, unsecureaddress: *const core::ffi::c_void, numberofbytes: usize) -> windows_core::Result<()> {
    windows_core::link!("vertdll.dll" "system" fn EnclaveCopyIntoEnclave(enclaveaddress : *mut core::ffi::c_void, unsecureaddress : *const core::ffi::c_void, numberofbytes : usize) -> windows_core::HRESULT);
    unsafe { EnclaveCopyIntoEnclave(enclaveaddress as _, unsecureaddress, numberofbytes).ok() }
}
#[inline]
pub unsafe fn EnclaveCopyOutOfEnclave(unsecureaddress: *mut core::ffi::c_void, enclaveaddress: *const core::ffi::c_void, numberofbytes: usize) -> windows_core::Result<()> {
    windows_core::link!("vertdll.dll" "system" fn EnclaveCopyOutOfEnclave(unsecureaddress : *mut core::ffi::c_void, enclaveaddress : *const core::ffi::c_void, numberofbytes : usize) -> windows_core::HRESULT);
    unsafe { EnclaveCopyOutOfEnclave(unsecureaddress as _, enclaveaddress, numberofbytes).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn EnclaveRestrictContainingProcessAccess(restrictaccess: bool, previouslyrestricted: Option<*mut windows_core::BOOL>) -> windows_core::Result<()> {
    windows_core::link!("vertdll.dll" "system" fn EnclaveRestrictContainingProcessAccess(restrictaccess : windows_core::BOOL, previouslyrestricted : *mut windows_core::BOOL) -> windows_core::HRESULT);
    unsafe { EnclaveRestrictContainingProcessAccess(restrictaccess.into(), previouslyrestricted.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn ExpandEnvironmentStringsA(lpsrc: windows_core::PCSTR, lpdst: Option<&mut [u8]>) -> u32 {
    ...
    unsafe { ExpandEnvironmentStringsA(core::mem::transmute(lpsrc), core::mem::transmute(lpdst.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), lpdst.as_deref().map_or(0, |slice| slice.len().try_into().unwrap())) }
}
#[inline]
pub unsafe fn ExpandEnvironmentStringsForUserA(htoken: Option<super::super::Foundation::HANDLE>, lpsrc: windows_core::PCSTR, lpdest: &mut [u8]) -> windows_core::Result<()> {
    ...
    unsafe { ExpandEnvironmentStringsForUserA(htoken.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(lpsrc), core::mem::transmute(lpdest.as_ptr()), lpdest.len().try_into().unwrap()).ok() }
}
#[inline]
pub unsafe fn ExpandEnvironmentStringsForUserW(htoken: Option<super::super::Foundation::HANDLE>, lpsrc: windows_core::PCWSTR, lpdest: &mut [u16]) -> windows_core::Result<()> {
    ...
    unsafe { ExpandEnvironmentStringsForUserW(htoken.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(lpsrc), core::mem::transmute(lpdest.as_ptr()), lpdest.len().try_into().unwrap()).ok() }
}
#[inline]
pub unsafe fn ExpandEnvironmentStringsW(lpsrc: windows_core::PCWSTR, lpdst: Option<&mut [u16]>) -> u32 {
    ...
    unsafe { ExpandEnvironmentStringsW(core::mem::transmute(lpsrc), core::mem::transmute(lpdst.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), lpdst.as_deref().map_or(0, |slice| slice.len().try_into().unwrap())) }
}
#[inline]
pub unsafe fn FreeEnvironmentStringsA(penv: windows_core::PCSTR) -> windows_core::Result<()> {
    windows_core::link!("kernel32.dll" "system" fn FreeEnvironmentStringsA(penv : windows_core::PCSTR) -> windows_core::BOOL);
    unsafe { FreeEnvironmentStringsA(core::mem::transmute(penv)).ok() }
}
#[inline]
pub unsafe fn FreeEnvironmentStringsW(penv: windows_core::PCWSTR) -> windows_core::Result<()> {
    windows_core::link!("kernel32.dll" "system" fn FreeEnvironmentStringsW(penv : windows_core::PCWSTR) -> windows_core::BOOL);
    unsafe { FreeEnvironmentStringsW(core::mem::transmute(penv)).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn GetEnvironmentVariableA(lpname: Option<windows_core::PCSTR>, lpbuffer: Option<&mut [u8]>) -> u32 {
    ...
    unsafe { GetEnvironmentVariableA(lpname.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(lpbuffer.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), lpbuffer.as_deref().map_or(0, |slice| slice.len().try_into().unwrap())) }
}
#[inline]
pub unsafe fn GetEnvironmentVariableW(lpname: Option<windows_core::PCWSTR>, lpbuffer: Option<&mut [u16]>) -> u32 {
    ...
    unsafe { GetEnvironmentVariableW(lpname.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(lpbuffer.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), lpbuffer.as_deref().map_or(0, |slice| slice.len().try_into().unwrap())) }
}
#[inline]
...
#[inline]
pub unsafe fn LoadEnclaveImageA(lpenclaveaddress: *const core::ffi::c_void, lpimagename: windows_core::PCSTR) -> windows_core::BOOL {
    ...
    unsafe { LoadEnclaveImageA(lpenclaveaddress, core::mem::transmute(lpimagename)) }
}
#[inline]
pub unsafe fn LoadEnclaveImageW(lpenclaveaddress: *const core::ffi::c_void, lpimagename: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { LoadEnclaveImageW(lpenclaveaddress, core::mem::transmute(lpimagename)).ok() }
}
#[inline]
pub unsafe fn NeedCurrentDirectoryForExePathA(exename: windows_core::PCSTR) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn NeedCurrentDirectoryForExePathA(exename : windows_core::PCSTR) -> windows_core::BOOL);
    unsafe { NeedCurrentDirectoryForExePathA(core::mem::transmute(exename)) }
}
#[inline]
pub unsafe fn NeedCurrentDirectoryForExePathW(exename: windows_core::PCWSTR) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn NeedCurrentDirectoryForExePathW(exename : windows_core::PCWSTR) -> windows_core::BOOL);
    unsafe { NeedCurrentDirectoryForExePathW(core::mem::transmute(exename)) }
}
#[inline]
pub unsafe fn SetCurrentDirectoryA(lppathname: windows_core::PCSTR) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SetCurrentDirectoryA(lppathname : windows_core::PCSTR) -> windows_core::BOOL);
    unsafe { SetCurrentDirectoryA(core::mem::transmute(lppathname)) }
}
#[inline]
pub unsafe fn SetCurrentDirectoryW(lppathname: windows_core::PCWSTR) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SetCurrentDirectoryW(lppathname : windows_core::PCWSTR) -> windows_core::BOOL);
    unsafe { SetCurrentDirectoryW(core::mem::transmute(lppathname)) }
}
#[inline]
pub unsafe fn SetEnvironmentStringsW(newenvironment: windows_core::PCWSTR) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SetEnvironmentStringsW(newenvironment : windows_core::PCWSTR) -> windows_core::BOOL);
    unsafe { SetEnvironmentStringsW(core::mem::transmute(newenvironment)) }
}
#[inline]
pub unsafe fn SetEnvironmentVariableA(lpname: windows_core::PCSTR, lpvalue: Option<windows_core::PCSTR>) -> windows_core::Result<()> {
    ...
    unsafe { SetEnvironmentVariableA(core::mem::transmute(lpname), lpvalue.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn SetEnvironmentVariableW(lpname: windows_core::PCWSTR, lpvalue: Option<windows_core::PCWSTR>) -> windows_core::Result<()> {
    ...
    unsafe { SetEnvironmentVariableW(core::mem::transmute(lpname), lpvalue.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
