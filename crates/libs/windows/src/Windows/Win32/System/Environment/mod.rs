...
{
    ::windows::core::windows_link ! ( "vertdll.dll" ,"system" fn CallEnclave ( lproutine : isize , lpparameter : *const ::core::ffi::c_void , fwaitforthread : super::super::Foundation:: BOOL , lpreturnvalue : *mut *mut ::core::ffi::c_void ) -> super::super::Foundation:: BOOL );
...
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn CreateEnclave ( hprocess : super::super::Foundation:: HANDLE , lpaddress : *const ::core::ffi::c_void , dwsize : usize , dwinitialcommitment : usize , flenclavetype : u32 , lpenclaveinformation : *const ::core::ffi::c_void , dwinfolength : u32 , lpenclaveerror : *mut u32 ) -> *mut ::core::ffi::c_void );
...
{
    ::windows::core::windows_link ! ( "userenv.dll" ,"system" fn CreateEnvironmentBlock ( lpenvironment : *mut *mut ::core::ffi::c_void , htoken : super::super::Foundation:: HANDLE , binherit : super::super::Foundation:: BOOL ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn DeleteEnclave(lpaddress: *const ::core::ffi::c_void) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "api-ms-win-core-enclave-l1-1-1.dll" ,"system" fn DeleteEnclave ( lpaddress : *const ::core::ffi::c_void ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn DestroyEnvironmentBlock(lpenvironment: *const ::core::ffi::c_void) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "userenv.dll" ,"system" fn DestroyEnvironmentBlock ( lpenvironment : *const ::core::ffi::c_void ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn EnclaveGetAttestationReport(enclavedata: ::core::option::Option<*const u8>, report: ::core::option::Option<*mut ::core::ffi::c_void>, buffersize: u32, outputsize: *mut u32) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "vertdll.dll" ,"system" fn EnclaveGetAttestationReport ( enclavedata : *const u8 , report : *mut ::core::ffi::c_void , buffersize : u32 , outputsize : *mut u32 ) -> :: windows::core::HRESULT );
...
pub unsafe fn EnclaveGetEnclaveInformation(informationsize: u32) -> ::windows::core::Result<ENCLAVE_INFORMATION> {
    ::windows::core::windows_link ! ( "vertdll.dll" ,"system" fn EnclaveGetEnclaveInformation ( informationsize : u32 , enclaveinformation : *mut ENCLAVE_INFORMATION ) -> :: windows::core::HRESULT );
...
pub unsafe fn EnclaveSealData(datatoencrypt: *const ::core::ffi::c_void, datatoencryptsize: u32, identitypolicy: ENCLAVE_SEALING_IDENTITY_POLICY, runtimepolicy: u32, protectedblob: ::core::option::Option<*mut ::core::ffi::c_void>, buffersize: u32, protectedblobsize: *mut u32) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "vertdll.dll" ,"system" fn EnclaveSealData ( datatoencrypt : *const ::core::ffi::c_void , datatoencryptsize : u32 , identitypolicy : ENCLAVE_SEALING_IDENTITY_POLICY , runtimepolicy : u32 , protectedblob : *mut ::core::ffi::c_void , buffersize : u32 , protectedblobsize : *mut u32 ) -> :: windows::core::HRESULT );
...
pub unsafe fn EnclaveUnsealData(protectedblob: *const ::core::ffi::c_void, protectedblobsize: u32, decrypteddata: ::core::option::Option<*mut ::core::ffi::c_void>, buffersize: u32, decrypteddatasize: *mut u32, sealingidentity: ::core::option::Option<*mut ENCLAVE_IDENTITY>, unsealingflags: ::core::option::Option<*mut u32>) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "vertdll.dll" ,"system" fn EnclaveUnsealData ( protectedblob : *const ::core::ffi::c_void , protectedblobsize : u32 , decrypteddata : *mut ::core::ffi::c_void , buffersize : u32 , decrypteddatasize : *mut u32 , sealingidentity : *mut ENCLAVE_IDENTITY , unsealingflags : *mut u32 ) -> :: windows::core::HRESULT );
...
pub unsafe fn EnclaveVerifyAttestationReport(enclavetype: u32, report: *const ::core::ffi::c_void, reportsize: u32) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "vertdll.dll" ,"system" fn EnclaveVerifyAttestationReport ( enclavetype : u32 , report : *const ::core::ffi::c_void , reportsize : u32 ) -> :: windows::core::HRESULT );
...
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn ExpandEnvironmentStringsA ( lpsrc : :: windows::core::PCSTR , lpdst : :: windows::core::PSTR , nsize : u32 ) -> u32 );
...
{
    ::windows::core::windows_link ! ( "userenv.dll" ,"system" fn ExpandEnvironmentStringsForUserA ( htoken : super::super::Foundation:: HANDLE , lpsrc : :: windows::core::PCSTR , lpdest : :: windows::core::PSTR , dwsize : u32 ) -> super::super::Foundation:: BOOL );
...
{
    ::windows::core::windows_link ! ( "userenv.dll" ,"system" fn ExpandEnvironmentStringsForUserW ( htoken : super::super::Foundation:: HANDLE , lpsrc : :: windows::core::PCWSTR , lpdest : :: windows::core::PWSTR , dwsize : u32 ) -> super::super::Foundation:: BOOL );
...
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn ExpandEnvironmentStringsW ( lpsrc : :: windows::core::PCWSTR , lpdst : :: windows::core::PWSTR , nsize : u32 ) -> u32 );
...
pub unsafe fn GetCommandLineA() -> ::windows::core::PSTR {
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GetCommandLineA ( ) -> :: windows::core::PSTR );
    GetCommandLineA()
}
#[doc = "*Required features: `\"Win32_System_Environment\"`*"]
#[inline]
pub unsafe fn GetCommandLineW() -> ::windows::core::PWSTR {
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GetCommandLineW ( ) -> :: windows::core::PWSTR );
    GetCommandLineW()
}
#[doc = "*Required features: `\"Win32_System_Environment\"`*"]
#[inline]
pub unsafe fn GetCurrentDirectoryA(lpbuffer: ::core::option::Option<&mut [u8]>) -> u32 {
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GetCurrentDirectoryA ( nbufferlength : u32 , lpbuffer : :: windows::core::PSTR ) -> u32 );
...
pub unsafe fn GetCurrentDirectoryW(lpbuffer: ::core::option::Option<&mut [u16]>) -> u32 {
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GetCurrentDirectoryW ( nbufferlength : u32 , lpbuffer : :: windows::core::PWSTR ) -> u32 );
...
pub unsafe fn GetEnvironmentStrings() -> ::windows::core::PSTR {
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GetEnvironmentStrings ( ) -> :: windows::core::PSTR );
    GetEnvironmentStrings()
}
#[doc = "*Required features: `\"Win32_System_Environment\"`*"]
#[inline]
pub unsafe fn GetEnvironmentStringsW() -> ::windows::core::PWSTR {
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GetEnvironmentStringsW ( ) -> :: windows::core::PWSTR );
...
where
    P0: ::std::convert::Into<::windows::core::PCSTR>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GetEnvironmentVariableA ( lpname : :: windows::core::PCSTR , lpbuffer : :: windows::core::PSTR , nsize : u32 ) -> u32 );
...
where
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn GetEnvironmentVariableW ( lpname : :: windows::core::PCWSTR , lpbuffer : :: windows::core::PWSTR , nsize : u32 ) -> u32 );
...
where
    P0: ::std::convert::Into<::windows::core::PCSTR>,
{
    ::windows::core::windows_link ! ( "api-ms-win-core-enclave-l1-1-1.dll" ,"system" fn LoadEnclaveImageA ( lpenclaveaddress : *const ::core::ffi::c_void , lpimagename : :: windows::core::PCSTR ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ::windows::core::windows_link ! ( "api-ms-win-core-enclave-l1-1-1.dll" ,"system" fn LoadEnclaveImageW ( lpenclaveaddress : *const ::core::ffi::c_void , lpimagename : :: windows::core::PCWSTR ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<::windows::core::PCSTR>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn NeedCurrentDirectoryForExePathA ( exename : :: windows::core::PCSTR ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn NeedCurrentDirectoryForExePathW ( exename : :: windows::core::PCWSTR ) -> super::super::Foundation:: BOOL );
...
where
    ...
    P1: ::std::convert::Into<::windows::core::PCSTR>,
{
    ::windows::core::windows_link ! ( "kernel32.dll" ,"system" fn SetEnvironmentVariableA ( lpname : :: windows::core::PCSTR , lpvalue : :: windows::core::PCSTR ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<super::super::Foundation::BOOL>,
{
    ::windows::core::windows_link ! ( "vertdll.dll" ,"system" fn TerminateEnclave ( lpaddress : *const ::core::ffi::c_void , fwait : super::super::Foundation:: BOOL ) -> super::super::Foundation:: BOOL );
