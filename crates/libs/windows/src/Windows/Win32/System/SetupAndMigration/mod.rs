...
#[inline]
pub unsafe fn RegisterWaitUntilOOBECompleted(oobecompletedcallback: OOBE_COMPLETED_CALLBACK, callbackcontext: *const core::ffi::c_void, waithandle: *mut *mut core::ffi::c_void) -> windows_core::BOOL {
    ...
    unsafe { RegisterWaitUntilOOBECompleted(oobecompletedcallback, callbackcontext, waithandle as _) }
}
#[inline]
pub unsafe fn UnregisterWaitUntilOOBECompleted(waithandle: *const core::ffi::c_void) -> windows_core::BOOL {
    ...
    unsafe { UnregisterWaitUntilOOBECompleted(waithandle) }
}
