...
impl IWSManVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWSManImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWSManVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, GetTypeInfoCount::<Impl, IMPL_OFFSET>, GetTypeInfo::<Impl, IMPL_OFFSET>, GetIDsOfNames::<Impl, IMPL_OFFSET>, Invoke::<Impl, IMPL_OFFSET>, CreateSession::<Impl, IMPL_OFFSET>, CreateConnectionOptions::<Impl, IMPL_OFFSET>, CommandLine::<Impl, IMPL_OFFSET>, Error::<Impl, IMPL_OFFSET>)
    }
...
impl IWSManConnectionOptionsVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWSManConnectionOptionsImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWSManConnectionOptionsVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, GetTypeInfoCount::<Impl, IMPL_OFFSET>, GetTypeInfo::<Impl, IMPL_OFFSET>, GetIDsOfNames::<Impl, IMPL_OFFSET>, Invoke::<Impl, IMPL_OFFSET>, UserName::<Impl, IMPL_OFFSET>, SetUserName::<Impl, IMPL_OFFSET>, SetPassword::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IWSManConnectionOptionsExVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWSManConnectionOptionsExImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWSManConnectionOptionsExVtbl {
        ...
        Self(
            ...
            CertificateThumbprint::<Impl, IMPL_OFFSET>,
            SetCertificateThumbprint::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IWSManConnectionOptionsEx2Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWSManConnectionOptionsEx2Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWSManConnectionOptionsEx2Vtbl {
        ...
        Self(
            ...
            ProxyIEConfig::<Impl, IMPL_OFFSET>,
            ProxyWinHttpConfig::<Impl, IMPL_OFFSET>,
            ProxyAutoDetect::<Impl, IMPL_OFFSET>,
            ProxyNoProxyServer::<Impl, IMPL_OFFSET>,
            ProxyAuthenticationUseNegotiate::<Impl, IMPL_OFFSET>,
            ProxyAuthenticationUseBasic::<Impl, IMPL_OFFSET>,
            ProxyAuthenticationUseDigest::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IWSManEnumeratorVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWSManEnumeratorImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWSManEnumeratorVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, GetTypeInfoCount::<Impl, IMPL_OFFSET>, GetTypeInfo::<Impl, IMPL_OFFSET>, GetIDsOfNames::<Impl, IMPL_OFFSET>, Invoke::<Impl, IMPL_OFFSET>, ReadItem::<Impl, IMPL_OFFSET>, AtEndOfStream::<Impl, IMPL_OFFSET>, Error::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IWSManExVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWSManExImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWSManExVtbl {
        ...
        Self(
            ...
            CreateConnectionOptions::<Impl, IMPL_OFFSET>,
            CommandLine::<Impl, IMPL_OFFSET>,
            Error::<Impl, IMPL_OFFSET>,
            CreateResourceLocator::<Impl, IMPL_OFFSET>,
            SessionFlagUTF8::<Impl, IMPL_OFFSET>,
            SessionFlagCredUsernamePassword::<Impl, IMPL_OFFSET>,
            SessionFlagSkipCACheck::<Impl, IMPL_OFFSET>,
            SessionFlagSkipCNCheck::<Impl, IMPL_OFFSET>,
            SessionFlagUseDigest::<Impl, IMPL_OFFSET>,
            SessionFlagUseNegotiate::<Impl, IMPL_OFFSET>,
            SessionFlagUseBasic::<Impl, IMPL_OFFSET>,
            SessionFlagUseKerberos::<Impl, IMPL_OFFSET>,
            SessionFlagNoEncryption::<Impl, IMPL_OFFSET>,
            SessionFlagEnableSPNServerPort::<Impl, IMPL_OFFSET>,
            SessionFlagUseNoAuthentication::<Impl, IMPL_OFFSET>,
            EnumerationFlagNonXmlText::<Impl, IMPL_OFFSET>,
            EnumerationFlagReturnEPR::<Impl, IMPL_OFFSET>,
            EnumerationFlagReturnObjectAndEPR::<Impl, IMPL_OFFSET>,
            GetErrorMessage::<Impl, IMPL_OFFSET>,
            EnumerationFlagHierarchyDeep::<Impl, IMPL_OFFSET>,
            EnumerationFlagHierarchyShallow::<Impl, IMPL_OFFSET>,
            EnumerationFlagHierarchyDeepBasePropsOnly::<Impl, IMPL_OFFSET>,
            EnumerationFlagReturnObject::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IWSManEx2Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWSManEx2Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWSManEx2Vtbl {
        ...
        Self(
            ...
            EnumerationFlagHierarchyDeepBasePropsOnly::<Impl, IMPL_OFFSET>,
            EnumerationFlagReturnObject::<Impl, IMPL_OFFSET>,
            SessionFlagUseClientCertificate::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IWSManEx3Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWSManEx3Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWSManEx3Vtbl {
        ...
        Self(
            ...
            EnumerationFlagReturnObject::<Impl, IMPL_OFFSET>,
            SessionFlagUseClientCertificate::<Impl, IMPL_OFFSET>,
            SessionFlagUTF16::<Impl, IMPL_OFFSET>,
            SessionFlagUseCredSsp::<Impl, IMPL_OFFSET>,
            EnumerationFlagAssociationInstance::<Impl, IMPL_OFFSET>,
            EnumerationFlagAssociatedInstance::<Impl, IMPL_OFFSET>,
            SessionFlagSkipRevocationCheck::<Impl, IMPL_OFFSET>,
            SessionFlagAllowNegotiateImplicitCredentials::<Impl, IMPL_OFFSET>,
            SessionFlagUseSsl::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IWSManInternalVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWSManInternalImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWSManInternalVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, GetTypeInfoCount::<Impl, IMPL_OFFSET>, GetTypeInfo::<Impl, IMPL_OFFSET>, GetIDsOfNames::<Impl, IMPL_OFFSET>, Invoke::<Impl, IMPL_OFFSET>, ConfigSDDL::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IWSManResourceLocatorVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWSManResourceLocatorImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWSManResourceLocatorVtbl {
        ...
        Self(
            ...
            AddSelector::<Impl, IMPL_OFFSET>,
            ClearSelectors::<Impl, IMPL_OFFSET>,
            FragmentPath::<Impl, IMPL_OFFSET>,
            SetFragmentPath::<Impl, IMPL_OFFSET>,
            FragmentDialect::<Impl, IMPL_OFFSET>,
            SetFragmentDialect::<Impl, IMPL_OFFSET>,
            AddOption::<Impl, IMPL_OFFSET>,
            SetMustUnderstandOptions::<Impl, IMPL_OFFSET>,
            MustUnderstandOptions::<Impl, IMPL_OFFSET>,
            ClearOptions::<Impl, IMPL_OFFSET>,
            Error::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IWSManSessionVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWSManSessionImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWSManSessionVtbl {
        ...
        Self(
            ...
            Invoke::<Impl, IMPL_OFFSET>,
            Enumerate::<Impl, IMPL_OFFSET>,
            Identify::<Impl, IMPL_OFFSET>,
            Error::<Impl, IMPL_OFFSET>,
            BatchItems::<Impl, IMPL_OFFSET>,
            SetBatchItems::<Impl, IMPL_OFFSET>,
