...
pub const WSMAN_DATA_NONE: WSManDataType = WSManDataType(0);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const WSMAN_DATA_TYPE_BINARY: WSManDataType = WSManDataType(2);
pub const WSMAN_DATA_TYPE_DWORD: WSManDataType = WSManDataType(4);
pub const WSMAN_DATA_TYPE_TEXT: WSManDataType = WSManDataType(1);
...
pub const WSMAN_FLAG_AUTH_BASIC: WSManAuthenticationFlags = WSManAuthenticationFlags(8);
pub const WSMAN_FLAG_AUTH_CLIENT_CERTIFICATE: WSManAuthenticationFlags = WSManAuthenticationFlags(32);
pub const WSMAN_FLAG_AUTH_CREDSSP: WSManAuthenticationFlags = WSManAuthenticationFlags(128);
pub const WSMAN_FLAG_AUTH_DIGEST: WSManAuthenticationFlags = WSManAuthenticationFlags(2);
pub const WSMAN_FLAG_AUTH_KERBEROS: WSManAuthenticationFlags = WSManAuthenticationFlags(16);
pub const WSMAN_FLAG_AUTH_NEGOTIATE: WSManAuthenticationFlags = WSManAuthenticationFlags(4);
pub const WSMAN_FLAG_CALLBACK_END_OF_OPERATION: WSManCallbackFlags = WSManCallbackFlags(1);
pub const WSMAN_FLAG_CALLBACK_END_OF_STREAM: WSManCallbackFlags = WSManCallbackFlags(8);
pub const WSMAN_FLAG_CALLBACK_NETWORK_FAILURE_DETECTED: WSManCallbackFlags = WSManCallbackFlags(256);
pub const WSMAN_FLAG_CALLBACK_RECEIVE_DELAY_STREAM_REQUEST_PROCESSED: WSManCallbackFlags = WSManCallbackFlags(8192);
pub const WSMAN_FLAG_CALLBACK_RECONNECTED_AFTER_NETWORK_FAILURE: WSManCallbackFlags = WSManCallbackFlags(1024);
pub const WSMAN_FLAG_CALLBACK_RETRYING_AFTER_NETWORK_FAILURE: WSManCallbackFlags = WSManCallbackFlags(512);
pub const WSMAN_FLAG_CALLBACK_RETRY_ABORTED_DUE_TO_INTERNAL_ERROR: WSManCallbackFlags = WSManCallbackFlags(4096);
pub const WSMAN_FLAG_CALLBACK_SHELL_AUTODISCONNECTED: WSManCallbackFlags = WSManCallbackFlags(64);
pub const WSMAN_FLAG_CALLBACK_SHELL_AUTODISCONNECTING: WSManCallbackFlags = WSManCallbackFlags(2048);
pub const WSMAN_FLAG_CALLBACK_SHELL_SUPPORTS_DISCONNECT: WSManCallbackFlags = WSManCallbackFlags(32);
pub const WSMAN_FLAG_DEFAULT_AUTHENTICATION: WSManAuthenticationFlags = WSManAuthenticationFlags(0);
pub const WSMAN_FLAG_DELETE_SERVER_SESSION: WSManShellFlag = WSManShellFlag(2);
pub const WSMAN_FLAG_NO_AUTHENTICATION: WSManAuthenticationFlags = WSManAuthenticationFlags(1);
pub const WSMAN_FLAG_NO_COMPRESSION: WSManShellFlag = WSManShellFlag(1);
pub const WSMAN_FLAG_RECEIVE_DELAY_OUTPUT_STREAM: WSManShellFlag = WSManShellFlag(16);
...
pub const WSMAN_FLAG_SERVER_BUFFERING_MODE_BLOCK: WSManShellFlag = WSManShellFlag(8);
pub const WSMAN_FLAG_SERVER_BUFFERING_MODE_DROP: WSManShellFlag = WSManShellFlag(4);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const WSMAN_OPTION_ALLOW_NEGOTIATE_IMPLICIT_CREDENTIALS: WSManSessionOption = WSManSessionOption(32);
pub const WSMAN_OPTION_DEFAULT_OPERATION_TIMEOUTMS: WSManSessionOption = WSManSessionOption(1);
pub const WSMAN_OPTION_ENABLE_SPN_SERVER_PORT: WSManSessionOption = WSManSessionOption(22);
pub const WSMAN_OPTION_LOCALE: WSManSessionOption = WSManSessionOption(25);
pub const WSMAN_OPTION_MACHINE_ID: WSManSessionOption = WSManSessionOption(23);
pub const WSMAN_OPTION_MAX_ENVELOPE_SIZE_KB: WSManSessionOption = WSManSessionOption(28);
pub const WSMAN_OPTION_MAX_RETRY_TIME: WSManSessionOption = WSManSessionOption(11);
pub const WSMAN_OPTION_PROXY_AUTO_DETECT: WSManProxyAccessType = WSManProxyAccessType(4);
pub const WSMAN_OPTION_PROXY_IE_PROXY_CONFIG: WSManProxyAccessType = WSManProxyAccessType(1);
pub const WSMAN_OPTION_PROXY_NO_PROXY_SERVER: WSManProxyAccessType = WSManProxyAccessType(8);
pub const WSMAN_OPTION_PROXY_WINHTTP_PROXY_CONFIG: WSManProxyAccessType = WSManProxyAccessType(2);
pub const WSMAN_OPTION_REDIRECT_LOCATION: WSManSessionOption = WSManSessionOption(30);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const WSMAN_OPTION_SHELL_MAX_DATA_SIZE_PER_MESSAGE_KB: WSManSessionOption = WSManSessionOption(29);
pub const WSMAN_OPTION_SKIP_CA_CHECK: WSManSessionOption = WSManSessionOption(18);
pub const WSMAN_OPTION_SKIP_CN_CHECK: WSManSessionOption = WSManSessionOption(19);
pub const WSMAN_OPTION_SKIP_REVOCATION_CHECK: WSManSessionOption = WSManSessionOption(31);
pub const WSMAN_OPTION_TIMEOUTMS_CLOSE_SHELL: WSManSessionOption = WSManSessionOption(17);
pub const WSMAN_OPTION_TIMEOUTMS_CREATE_SHELL: WSManSessionOption = WSManSessionOption(12);
pub const WSMAN_OPTION_TIMEOUTMS_RECEIVE_SHELL_OUTPUT: WSManSessionOption = WSManSessionOption(14);
pub const WSMAN_OPTION_TIMEOUTMS_RUN_SHELL_COMMAND: WSManSessionOption = WSManSessionOption(13);
pub const WSMAN_OPTION_TIMEOUTMS_SEND_SHELL_INPUT: WSManSessionOption = WSManSessionOption(15);
pub const WSMAN_OPTION_TIMEOUTMS_SIGNAL_SHELL: WSManSessionOption = WSManSessionOption(16);
pub const WSMAN_OPTION_UI_LANGUAGE: WSManSessionOption = WSManSessionOption(26);
pub const WSMAN_OPTION_UNENCRYPTED_MESSAGES: WSManSessionOption = WSManSessionOption(20);
pub const WSMAN_OPTION_USE_INTEARACTIVE_TOKEN: WSManSessionOption = WSManSessionOption(34);
pub const WSMAN_OPTION_USE_SSL: WSManSessionOption = WSManSessionOption(33);
pub const WSMAN_OPTION_UTF16: WSManSessionOption = WSManSessionOption(21);
...
pub const WSManFlagAllowNegotiateImplicitCredentials: WSManSessionFlags = WSManSessionFlags(67108864);
pub const WSManFlagAssociatedInstance: WSManEnumFlags = WSManEnumFlags(0);
pub const WSManFlagAssociationInstance: WSManEnumFlags = WSManEnumFlags(128);
pub const WSManFlagCredUsernamePassword: WSManSessionFlags = WSManSessionFlags(4096);
pub const WSManFlagEnableSPNServerPort: WSManSessionFlags = WSManSessionFlags(4194304);
pub const WSManFlagHierarchyDeep: WSManEnumFlags = WSManEnumFlags(0);
pub const WSManFlagHierarchyDeepBasePropsOnly: WSManEnumFlags = WSManEnumFlags(64);
pub const WSManFlagHierarchyShallow: WSManEnumFlags = WSManEnumFlags(32);
pub const WSManFlagNoEncryption: WSManSessionFlags = WSManSessionFlags(1048576);
pub const WSManFlagNonXmlText: WSManEnumFlags = WSManEnumFlags(1);
pub const WSManFlagProxyAuthenticationUseBasic: WSManProxyAuthenticationFlags = WSManProxyAuthenticationFlags(2);
pub const WSManFlagProxyAuthenticationUseDigest: WSManProxyAuthenticationFlags = WSManProxyAuthenticationFlags(4);
pub const WSManFlagProxyAuthenticationUseNegotiate: WSManProxyAuthenticationFlags = WSManProxyAuthenticationFlags(1);
pub const WSManFlagReturnEPR: WSManEnumFlags = WSManEnumFlags(2);
pub const WSManFlagReturnObject: WSManEnumFlags = WSManEnumFlags(0);
pub const WSManFlagReturnObjectAndEPR: WSManEnumFlags = WSManEnumFlags(4);
pub const WSManFlagSkipCACheck: WSManSessionFlags = WSManSessionFlags(8192);
pub const WSManFlagSkipCNCheck: WSManSessionFlags = WSManSessionFlags(16384);
pub const WSManFlagSkipRevocationCheck: WSManSessionFlags = WSManSessionFlags(33554432);
pub const WSManFlagUTF16: WSManSessionFlags = WSManSessionFlags(8388608);
pub const WSManFlagUTF8: WSManSessionFlags = WSManSessionFlags(1);
pub const WSManFlagUseBasic: WSManSessionFlags = WSManSessionFlags(262144);
pub const WSManFlagUseClientCertificate: WSManSessionFlags = WSManSessionFlags(2097152);
pub const WSManFlagUseCredSsp: WSManSessionFlags = WSManSessionFlags(16777216);
pub const WSManFlagUseDigest: WSManSessionFlags = WSManSessionFlags(65536);
pub const WSManFlagUseKerberos: WSManSessionFlags = WSManSessionFlags(524288);
pub const WSManFlagUseNegotiate: WSManSessionFlags = WSManSessionFlags(131072);
pub const WSManFlagUseNoAuthentication: WSManSessionFlags = WSManSessionFlags(32768);
pub const WSManFlagUseSsl: WSManSessionFlags = WSManSessionFlags(134217728);
...
pub const WSManProxyAutoDetect: WSManProxyAccessTypeFlags = WSManProxyAccessTypeFlags(4);
pub const WSManProxyIEConfig: WSManProxyAccessTypeFlags = WSManProxyAccessTypeFlags(1);
pub const WSManProxyNoProxyServer: WSManProxyAccessTypeFlags = WSManProxyAccessTypeFlags(8);
pub const WSManProxyWinHttpConfig: WSManProxyAccessTypeFlags = WSManProxyAccessTypeFlags(2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
