#[inline]
pub unsafe fn RmAddFilter<P1, P3>(dwsessionhandle: u32, strmodulename: P1, pprocess: *mut RM_UNIQUE_PROCESS, strserviceshortname: P3, filteraction: RM_FILTER_ACTION) -> windows_core::WIN32_ERROR
where
    P1: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("rstrtmgr.dll" "system" fn RmAddFilter(dwsessionhandle : u32, strmodulename : windows_core::PCWSTR, pprocess : *mut RM_UNIQUE_PROCESS, strserviceshortname : windows_core::PCWSTR, filteraction : RM_FILTER_ACTION) -> windows_core:: WIN32_ERROR);
    unsafe { RmAddFilter(dwsessionhandle, strmodulename.param().abi(), pprocess as _, strserviceshortname.param().abi(), filteraction) }
}
#[inline]
pub unsafe fn RmCancelCurrentTask(dwsessionhandle: u32) -> windows_core::WIN32_ERROR {
    windows_core::link!("rstrtmgr.dll" "system" fn RmCancelCurrentTask(dwsessionhandle : u32) -> windows_core:: WIN32_ERROR);
    unsafe { RmCancelCurrentTask(dwsessionhandle) }
}
#[inline]
pub unsafe fn RmEndSession(dwsessionhandle: u32) -> windows_core::WIN32_ERROR {
    windows_core::link!("rstrtmgr.dll" "system" fn RmEndSession(dwsessionhandle : u32) -> windows_core:: WIN32_ERROR);
    unsafe { RmEndSession(dwsessionhandle) }
}
#[inline]
pub unsafe fn RmGetFilterList(dwsessionhandle: u32, pbfilterbuf: *mut u8, cbfilterbuf: u32, cbfilterbufneeded: *mut u32) -> windows_core::WIN32_ERROR {
    windows_core::link!("rstrtmgr.dll" "system" fn RmGetFilterList(dwsessionhandle : u32, pbfilterbuf : *mut u8, cbfilterbuf : u32, cbfilterbufneeded : *mut u32) -> windows_core:: WIN32_ERROR);
    unsafe { RmGetFilterList(dwsessionhandle, pbfilterbuf as _, cbfilterbuf, cbfilterbufneeded as _) }
}
#[inline]
pub unsafe fn RmGetList(dwsessionhandle: u32, pnprocinfoneeded: *mut u32, pnprocinfo: *mut u32, rgaffectedapps: *mut RM_PROCESS_INFO, lpdwrebootreasons: *mut u32) -> windows_core::WIN32_ERROR {
    windows_core::link!("rstrtmgr.dll" "system" fn RmGetList(dwsessionhandle : u32, pnprocinfoneeded : *mut u32, pnprocinfo : *mut u32, rgaffectedapps : *mut RM_PROCESS_INFO, lpdwrebootreasons : *mut u32) -> windows_core:: WIN32_ERROR);
    unsafe { RmGetList(dwsessionhandle, pnprocinfoneeded as _, pnprocinfo as _, rgaffectedapps as _, lpdwrebootreasons as _) }
}
#[inline]
...
#[inline]
pub unsafe fn RmRegisterResources(dwsessionhandle: u32, nfiles: u32, rgsfilenames: *mut windows_core::PWSTR, napplications: u32, rgapplications: *mut RM_UNIQUE_PROCESS, nservices: u32, rgsservicenames: *mut windows_core::PWSTR) -> windows_core::WIN32_ERROR {
    windows_core::link!("rstrtmgr.dll" "system" fn RmRegisterResources(dwsessionhandle : u32, nfiles : u32, rgsfilenames : *mut windows_core::PWSTR, napplications : u32, rgapplications : *mut RM_UNIQUE_PROCESS, nservices : u32, rgsservicenames : *mut windows_core::PWSTR) -> windows_core:: WIN32_ERROR);
    unsafe { RmRegisterResources(dwsessionhandle, nfiles, rgsfilenames as _, napplications, rgapplications as _, nservices, rgsservicenames as _) }
}
#[inline]
pub unsafe fn RmRemoveFilter<P1, P3>(dwsessionhandle: u32, strmodulename: P1, pprocess: *mut RM_UNIQUE_PROCESS, strserviceshortname: P3) -> windows_core::WIN32_ERROR
where
    P1: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("rstrtmgr.dll" "system" fn RmRemoveFilter(dwsessionhandle : u32, strmodulename : windows_core::PCWSTR, pprocess : *mut RM_UNIQUE_PROCESS, strserviceshortname : windows_core::PCWSTR) -> windows_core:: WIN32_ERROR);
    unsafe { RmRemoveFilter(dwsessionhandle, strmodulename.param().abi(), pprocess as _, strserviceshortname.param().abi()) }
}
#[inline]
pub unsafe fn RmRestart(dwsessionhandle: u32, dwrestartflags: u32, fnstatus: RM_WRITE_STATUS_CALLBACK) -> windows_core::WIN32_ERROR {
    windows_core::link!("rstrtmgr.dll" "system" fn RmRestart(dwsessionhandle : u32, dwrestartflags : u32, fnstatus : RM_WRITE_STATUS_CALLBACK) -> windows_core:: WIN32_ERROR);
    unsafe { RmRestart(dwsessionhandle, dwrestartflags, fnstatus) }
}
#[inline]
pub unsafe fn RmShutdown(dwsessionhandle: u32, lactionflags: u32, fnstatus: RM_WRITE_STATUS_CALLBACK) -> windows_core::WIN32_ERROR {
    windows_core::link!("rstrtmgr.dll" "system" fn RmShutdown(dwsessionhandle : u32, lactionflags : u32, fnstatus : RM_WRITE_STATUS_CALLBACK) -> windows_core:: WIN32_ERROR);
    unsafe { RmShutdown(dwsessionhandle, lactionflags, fnstatus) }
}
#[inline]
pub unsafe fn RmStartSession(psessionhandle: *mut u32, dwsessionflags: u32, strsessionkey: windows_core::PWSTR) -> windows_core::WIN32_ERROR {
    ...
    unsafe { RmStartSession(psessionhandle as _, dwsessionflags, core::mem::transmute(strsessionkey)) }
}
