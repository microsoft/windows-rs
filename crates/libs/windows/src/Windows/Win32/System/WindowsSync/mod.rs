...
impl IAsynchronousDataRetriever {
    pub unsafe fn GetIdParameters(&self, pidparameters: *mut ID_PARAMETERS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetIdParameters)(windows_core::Interface::as_raw(self), pidparameters as _).ok() }
    }
    pub unsafe fn RegisterCallback<P0>(&self, pdataretrievercallback: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn RevokeCallback<P0>(&self, pdataretrievercallback: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IDataRetrieverCallback>,
    {
    ...
    pub unsafe fn LoadChangeData<P0>(&self, ploadchangecontext: P0) -> windows_result::Result<()>
    where
...
pub trait IAsynchronousDataRetriever_Impl: windows_core::IUnknownImpl {
    fn GetIdParameters(&self, pidparameters: *mut ID_PARAMETERS) -> windows_result::Result<()>;
    fn RegisterCallback(&self, pdataretrievercallback: windows_core::Ref<IDataRetrieverCallback>) -> windows_result::Result<()>;
    fn RevokeCallback(&self, pdataretrievercallback: windows_core::Ref<IDataRetrieverCallback>) -> windows_result::Result<()>;
    fn LoadChangeData(&self, ploadchangecontext: windows_core::Ref<ILoadChangeContext>) -> windows_result::Result<()>;
}
...
impl IChangeConflict {
    pub unsafe fn GetDestinationProviderConflictingChange(&self) -> windows_result::Result<ISyncChange> {
        unsafe {
    ...
    pub unsafe fn GetSourceProviderConflictingChange(&self) -> windows_result::Result<ISyncChange> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetDestinationProviderConflictingData(&self) -> windows_result::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetSourceProviderConflictingData(&self) -> windows_result::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetResolveActionForChange(&self, presolveaction: *mut SYNC_RESOLVE_ACTION) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetResolveActionForChange(&self, resolveaction: SYNC_RESOLVE_ACTION) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetResolveActionForChange)(windows_core::Interface::as_raw(self), resolveaction).ok() }
    }
    pub unsafe fn GetResolveActionForChangeUnit<P0>(&self, pchangeunit: P0, presolveaction: *mut SYNC_RESOLVE_ACTION) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn SetResolveActionForChangeUnit<P0>(&self, pchangeunit: P0, resolveaction: SYNC_RESOLVE_ACTION) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ISyncChangeUnit>,
    {
...
pub trait IChangeConflict_Impl: windows_core::IUnknownImpl {
    fn GetDestinationProviderConflictingChange(&self) -> windows_result::Result<ISyncChange>;
    fn GetSourceProviderConflictingChange(&self) -> windows_result::Result<ISyncChange>;
    fn GetDestinationProviderConflictingData(&self) -> windows_result::Result<windows_core::IUnknown>;
    fn GetSourceProviderConflictingData(&self) -> windows_result::Result<windows_core::IUnknown>;
    fn GetResolveActionForChange(&self, presolveaction: *mut SYNC_RESOLVE_ACTION) -> windows_result::Result<()>;
    fn SetResolveActionForChange(&self, resolveaction: SYNC_RESOLVE_ACTION) -> windows_result::Result<()>;
    fn GetResolveActionForChangeUnit(&self, pchangeunit: windows_core::Ref<ISyncChangeUnit>, presolveaction: *mut SYNC_RESOLVE_ACTION) -> windows_result::Result<()>;
    fn SetResolveActionForChangeUnit(&self, pchangeunit: windows_core::Ref<ISyncChangeUnit>, resolveaction: SYNC_RESOLVE_ACTION) -> windows_result::Result<()>;
}
...
impl IChangeUnitException {
    pub unsafe fn GetItemId(&self, pbitemid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetItemId)(windows_core::Interface::as_raw(self), pbitemid as _, pcbidsize as _).ok() }
    }
    pub unsafe fn GetChangeUnitId(&self, pbchangeunitid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetClockVector(&self, riid: *const windows_core::GUID, ppunk: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
...
pub trait IChangeUnitException_Impl: windows_core::IUnknownImpl {
    fn GetItemId(&self, pbitemid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()>;
    fn GetChangeUnitId(&self, pbchangeunitid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()>;
    fn GetClockVector(&self, riid: *const windows_core::GUID, ppunk: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
}
...
impl IChangeUnitListFilterInfo {
    pub unsafe fn Initialize(&self, ppbchangeunitids: *const *const u8, dwchangeunitcount: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetChangeUnitIdCount(&self, pdwchangeunitidcount: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetChangeUnitId(&self, dwchangeunitidindex: u32, pbchangeunitid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()> {
...
pub trait IChangeUnitListFilterInfo_Impl: ISyncFilterInfo_Impl {
    fn Initialize(&self, ppbchangeunitids: *const *const u8, dwchangeunitcount: u32) -> windows_result::Result<()>;
    fn GetChangeUnitIdCount(&self, pdwchangeunitidcount: *mut u32) -> windows_result::Result<()>;
    fn GetChangeUnitId(&self, dwchangeunitidindex: u32, pbchangeunitid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()>;
}
...
impl IClockVector {
    pub unsafe fn GetClockVectorElements(&self, riid: *const windows_core::GUID, ppienumclockvector: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetClockVectorElementCount(&self, pdwcount: *mut u32) -> windows_result::Result<()> {
...
pub trait IClockVector_Impl: windows_core::IUnknownImpl {
    fn GetClockVectorElements(&self, riid: *const windows_core::GUID, ppienumclockvector: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn GetClockVectorElementCount(&self, pdwcount: *mut u32) -> windows_result::Result<()>;
}
...
impl IClockVectorElement {
    pub unsafe fn GetReplicaKey(&self, pdwreplicakey: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetReplicaKey)(windows_core::Interface::as_raw(self), pdwreplicakey as _).ok() }
    }
    pub unsafe fn GetTickCount(&self, pulltickcount: *mut u64) -> windows_result::Result<()> {
...
pub trait IClockVectorElement_Impl: windows_core::IUnknownImpl {
    fn GetReplicaKey(&self, pdwreplicakey: *mut u32) -> windows_result::Result<()>;
    fn GetTickCount(&self, pulltickcount: *mut u64) -> windows_result::Result<()>;
}
...
impl ICombinedFilterInfo {
    pub unsafe fn GetFilterCount(&self, pdwfiltercount: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetFilterCount)(windows_core::Interface::as_raw(self), pdwfiltercount as _).ok() }
    }
    pub unsafe fn GetFilterInfo(&self, dwfilterindex: u32) -> windows_result::Result<ISyncFilterInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFilterCombinationType(&self, pfiltercombinationtype: *mut FILTER_COMBINATION_TYPE) -> windows_result::Result<()> {
...
pub trait ICombinedFilterInfo_Impl: ISyncFilterInfo_Impl {
    fn GetFilterCount(&self, pdwfiltercount: *mut u32) -> windows_result::Result<()>;
    fn GetFilterInfo(&self, dwfilterindex: u32) -> windows_result::Result<ISyncFilterInfo>;
    fn GetFilterCombinationType(&self, pfiltercombinationtype: *mut FILTER_COMBINATION_TYPE) -> windows_result::Result<()>;
}
...
impl IConstraintConflict {
    ...
    pub unsafe fn GetDestinationProviderOriginalChange(&self) -> windows_result::Result<ISyncChange> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetDestinationProviderOriginalData(&self) -> windows_result::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetConstraintResolveActionForChange(&self, pconstraintresolveaction: *mut SYNC_CONSTRAINT_RESOLVE_ACTION) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetConstraintResolveActionForChange(&self, constraintresolveaction: SYNC_CONSTRAINT_RESOLVE_ACTION) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetConstraintResolveActionForChangeUnit<P0>(&self, pchangeunit: P0, pconstraintresolveaction: *mut SYNC_CONSTRAINT_RESOLVE_ACTION) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ISyncChangeUnit>,
    {
    ...
    pub unsafe fn SetConstraintResolveActionForChangeUnit<P0>(&self, pchangeunit: P0, constraintresolveaction: SYNC_CONSTRAINT_RESOLVE_ACTION) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ISyncChangeUnit>,
    {
    ...
    pub unsafe fn GetConstraintConflictReason(&self, pconstraintconflictreason: *mut CONSTRAINT_CONFLICT_REASON) -> windows_result::Result<()> {
    ...
    pub unsafe fn IsTemporary(&self) -> windows_result::Result<()> {
...
pub trait IConstraintConflict_Impl: windows_core::IUnknownImpl {
    fn GetDestinationProviderConflictingChange(&self) -> windows_result::Result<ISyncChange>;
    fn GetSourceProviderConflictingChange(&self) -> windows_result::Result<ISyncChange>;
    fn GetDestinationProviderOriginalChange(&self) -> windows_result::Result<ISyncChange>;
    fn GetDestinationProviderConflictingData(&self) -> windows_result::Result<windows_core::IUnknown>;
    fn GetSourceProviderConflictingData(&self) -> windows_result::Result<windows_core::IUnknown>;
    fn GetDestinationProviderOriginalData(&self) -> windows_result::Result<windows_core::IUnknown>;
    fn GetConstraintResolveActionForChange(&self, pconstraintresolveaction: *mut SYNC_CONSTRAINT_RESOLVE_ACTION) -> windows_result::Result<()>;
    fn SetConstraintResolveActionForChange(&self, constraintresolveaction: SYNC_CONSTRAINT_RESOLVE_ACTION) -> windows_result::Result<()>;
    fn GetConstraintResolveActionForChangeUnit(&self, pchangeunit: windows_core::Ref<ISyncChangeUnit>, pconstraintresolveaction: *mut SYNC_CONSTRAINT_RESOLVE_ACTION) -> windows_result::Result<()>;
    fn SetConstraintResolveActionForChangeUnit(&self, pchangeunit: windows_core::Ref<ISyncChangeUnit>, constraintresolveaction: SYNC_CONSTRAINT_RESOLVE_ACTION) -> windows_result::Result<()>;
    fn GetConstraintConflictReason(&self, pconstraintconflictreason: *mut CONSTRAINT_CONFLICT_REASON) -> windows_result::Result<()>;
    fn IsTemporary(&self) -> windows_result::Result<()>;
}
...
impl IConstructReplicaKeyMap {
    pub unsafe fn FindOrAddReplica(&self, pbreplicaid: *const u8, pdwreplicakey: *mut u32) -> windows_result::Result<()> {
...
pub trait IConstructReplicaKeyMap_Impl: windows_core::IUnknownImpl {
    fn FindOrAddReplica(&self, pbreplicaid: *const u8, pdwreplicakey: *mut u32) -> windows_result::Result<()>;
}
...
impl ICoreFragment {
    pub unsafe fn NextColumn(&self, pchangeunitid: *mut u8, pchangeunitidsize: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn NextRange(&self, pitemid: *mut u8, pitemidsize: *mut u32, piclockvector: *mut Option<IClockVector>) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetColumnCount(&self, pcolumncount: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetColumnCount)(windows_core::Interface::as_raw(self), pcolumncount as _).ok() }
    }
    pub unsafe fn GetRangeCount(&self, prangecount: *mut u32) -> windows_result::Result<()> {
...
pub trait ICoreFragment_Impl: windows_core::IUnknownImpl {
    fn NextColumn(&self, pchangeunitid: *mut u8, pchangeunitidsize: *mut u32) -> windows_result::Result<()>;
    fn NextRange(&self, pitemid: *mut u8, pitemidsize: *mut u32, piclockvector: windows_core::OutRef<IClockVector>) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn GetColumnCount(&self, pcolumncount: *mut u32) -> windows_result::Result<()>;
    fn GetRangeCount(&self, prangecount: *mut u32) -> windows_result::Result<()>;
}
...
impl ICoreFragmentInspector {
    pub unsafe fn NextCoreFragments(&self, requestedcount: u32, ppicorefragments: *mut Option<ICoreFragment>, pfetchedcount: *mut u32) -> windows_result::Result<()> {
...
pub trait ICoreFragmentInspector_Impl: windows_core::IUnknownImpl {
    fn NextCoreFragments(&self, requestedcount: u32, ppicorefragments: windows_core::OutRef<ICoreFragment>, pfetchedcount: *mut u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
}
...
impl ICustomFilterInfo {
    pub unsafe fn GetSyncFilter(&self) -> windows_result::Result<ISyncFilter> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ICustomFilterInfo_Impl: ISyncFilterInfo_Impl {
    fn GetSyncFilter(&self) -> windows_result::Result<ISyncFilter>;
}
...
impl IDataRetrieverCallback {
    pub unsafe fn LoadChangeDataComplete<P0>(&self, punkdata: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn LoadChangeDataError(&self, hrerror: windows_core::HRESULT) -> windows_result::Result<()> {
...
pub trait IDataRetrieverCallback_Impl: windows_core::IUnknownImpl {
    fn LoadChangeDataComplete(&self, punkdata: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn LoadChangeDataError(&self, hrerror: windows_core::HRESULT) -> windows_result::Result<()>;
}
...
impl IEnumChangeUnitExceptions {
    pub unsafe fn Next(&self, cexceptions: u32, ppchangeunitexception: *mut Option<IChangeUnitException>, pcfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Skip(&self, cexceptions: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Skip)(windows_core::Interface::as_raw(self), cexceptions).ok() }
    }
    pub unsafe fn Reset(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Reset)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumChangeUnitExceptions> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IEnumChangeUnitExceptions_Impl: windows_core::IUnknownImpl {
    fn Next(&self, cexceptions: u32, ppchangeunitexception: windows_core::OutRef<IChangeUnitException>, pcfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, cexceptions: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumChangeUnitExceptions>;
}
...
impl IEnumClockVector {
    pub unsafe fn Next(&self, cclockvectorelements: u32, ppiclockvectorelements: *mut Option<IClockVectorElement>, pcfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Skip(&self, csyncversions: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Skip)(windows_core::Interface::as_raw(self), csyncversions).ok() }
    }
    pub unsafe fn Reset(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Reset)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumClockVector> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumClockVector_Impl: windows_core::IUnknownImpl {
    fn Next(&self, cclockvectorelements: u32, ppiclockvectorelements: windows_core::OutRef<IClockVectorElement>, pcfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, csyncversions: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumClockVector>;
}
...
impl IEnumFeedClockVector {
    pub unsafe fn Next(&self, cclockvectorelements: u32, ppiclockvectorelements: *mut Option<IFeedClockVectorElement>, pcfetched: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), cclockvectorelements, core::mem::transmute(ppiclockvectorelements), pcfetched as _).ok() }
    }
    pub unsafe fn Skip(&self, csyncversions: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Skip)(windows_core::Interface::as_raw(self), csyncversions).ok() }
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumFeedClockVector> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumFeedClockVector_Impl: windows_core::IUnknownImpl {
    fn Next(&self, cclockvectorelements: u32, ppiclockvectorelements: windows_core::OutRef<IFeedClockVectorElement>, pcfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, csyncversions: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumFeedClockVector>;
}
...
impl IEnumItemIds {
    pub unsafe fn Next(&self, pbitemid: *mut u8, pcbitemidsize: *mut u32) -> windows_result::Result<()> {
...
pub trait IEnumItemIds_Impl: windows_core::IUnknownImpl {
    fn Next(&self, pbitemid: *mut u8, pcbitemidsize: *mut u32) -> windows_result::Result<()>;
}
...
impl IEnumRangeExceptions {
    pub unsafe fn Next(&self, cexceptions: u32, pprangeexception: *mut Option<IRangeException>, pcfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumRangeExceptions> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumRangeExceptions_Impl: windows_core::IUnknownImpl {
    fn Next(&self, cexceptions: u32, pprangeexception: windows_core::OutRef<IRangeException>, pcfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, cexceptions: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumRangeExceptions>;
}
...
impl IEnumSingleItemExceptions {
    pub unsafe fn Next(&self, cexceptions: u32, ppsingleitemexception: *mut Option<ISingleItemException>, pcfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumSingleItemExceptions> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumSingleItemExceptions_Impl: windows_core::IUnknownImpl {
    fn Next(&self, cexceptions: u32, ppsingleitemexception: windows_core::OutRef<ISingleItemException>, pcfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, cexceptions: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumSingleItemExceptions>;
}
...
impl IEnumSyncChangeUnits {
    pub unsafe fn Next(&self, cchanges: u32, ppchangeunit: *mut Option<ISyncChangeUnit>, pcfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Skip(&self, cchanges: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Skip)(windows_core::Interface::as_raw(self), cchanges).ok() }
    }
    pub unsafe fn Reset(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Reset)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumSyncChangeUnits> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumSyncChangeUnits_Impl: windows_core::IUnknownImpl {
    fn Next(&self, cchanges: u32, ppchangeunit: windows_core::OutRef<ISyncChangeUnit>, pcfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, cchanges: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumSyncChangeUnits>;
}
...
impl IEnumSyncChanges {
    pub unsafe fn Next(&self, cchanges: u32, ppchange: *mut Option<ISyncChange>, pcfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumSyncChanges> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumSyncChanges_Impl: windows_core::IUnknownImpl {
    fn Next(&self, cchanges: u32, ppchange: windows_core::OutRef<ISyncChange>, pcfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, cchanges: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumSyncChanges>;
}
...
impl IEnumSyncProviderConfigUIInfos {
    ...
    pub unsafe fn Next(&self, ppsyncproviderconfiguiinfo: &mut [Option<ISyncProviderConfigUIInfo>], pcfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Skip(&self, cfactories: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Skip)(windows_core::Interface::as_raw(self), cfactories).ok() }
    }
    pub unsafe fn Reset(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Reset)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumSyncProviderConfigUIInfos> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumSyncProviderConfigUIInfos_Impl: windows_core::IUnknownImpl {
    fn Next(&self, cfactories: u32, ppsyncproviderconfiguiinfo: *mut Option<ISyncProviderConfigUIInfo>, pcfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, cfactories: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumSyncProviderConfigUIInfos>;
}
#[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
...
impl IEnumSyncProviderInfos {
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn Next(&self, ppsyncproviderinfo: &mut [Option<ISyncProviderInfo>], pcfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Skip(&self, cinstances: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Skip)(windows_core::Interface::as_raw(self), cinstances).ok() }
    }
    pub unsafe fn Reset(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Reset)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumSyncProviderInfos> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumSyncProviderInfos_Impl: windows_core::IUnknownImpl {
    fn Next(&self, cinstances: u32, ppsyncproviderinfo: *mut Option<ISyncProviderInfo>, pcfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, cinstances: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumSyncProviderInfos>;
}
#[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
...
impl IFeedClockVector {
    pub unsafe fn GetUpdateCount(&self, pdwupdatecount: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetUpdateCount)(windows_core::Interface::as_raw(self), pdwupdatecount as _).ok() }
    }
    pub unsafe fn IsNoConflictsSpecified(&self, pfisnoconflictsspecified: *mut windows_core::BOOL) -> windows_result::Result<()> {
...
pub trait IFeedClockVector_Impl: IClockVector_Impl {
    fn GetUpdateCount(&self, pdwupdatecount: *mut u32) -> windows_result::Result<()>;
    fn IsNoConflictsSpecified(&self, pfisnoconflictsspecified: *mut windows_core::BOOL) -> windows_result::Result<()>;
}
...
impl IFeedClockVectorElement {
    pub unsafe fn GetSyncTime(&self, psynctime: *mut SYNC_TIME) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetSyncTime)(windows_core::Interface::as_raw(self), psynctime as _).ok() }
    }
    pub unsafe fn GetFlags(&self, pbflags: *mut u8) -> windows_result::Result<()> {
...
pub trait IFeedClockVectorElement_Impl: IClockVectorElement_Impl {
    fn GetSyncTime(&self, psynctime: *mut SYNC_TIME) -> windows_result::Result<()>;
    fn GetFlags(&self, pbflags: *mut u8) -> windows_result::Result<()>;
}
...
impl IFilterKeyMap {
    pub unsafe fn GetCount(&self, pdwcount: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetCount)(windows_core::Interface::as_raw(self), pdwcount as _).ok() }
    }
    pub unsafe fn AddFilter<P0>(&self, pisyncfilter: P0, pdwfilterkey: *mut u32) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetFilter(&self, dwfilterkey: u32) -> windows_result::Result<ISyncFilter> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Serialize(&self, pbfilterkeymap: *mut u8, pcbfilterkeymap: *mut u32) -> windows_result::Result<()> {
...
pub trait IFilterKeyMap_Impl: windows_core::IUnknownImpl {
    fn GetCount(&self, pdwcount: *mut u32) -> windows_result::Result<()>;
    fn AddFilter(&self, pisyncfilter: windows_core::Ref<ISyncFilter>, pdwfilterkey: *mut u32) -> windows_result::Result<()>;
    fn GetFilter(&self, dwfilterkey: u32) -> windows_result::Result<ISyncFilter>;
    fn Serialize(&self, pbfilterkeymap: *mut u8, pcbfilterkeymap: *mut u32) -> windows_result::Result<()>;
}
...
impl IFilterRequestCallback {
    pub unsafe fn RequestFilter<P0>(&self, pfilter: P0, filteringtype: FILTERING_TYPE) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
...
pub trait IFilterRequestCallback_Impl: windows_core::IUnknownImpl {
    fn RequestFilter(&self, pfilter: windows_core::Ref<windows_core::IUnknown>, filteringtype: FILTERING_TYPE) -> windows_result::Result<()>;
}
...
impl IFilterTrackingProvider {
    pub unsafe fn SpecifyTrackedFilters<P0>(&self, pcallback: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn AddTrackedFilter<P0>(&self, pfilter: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ISyncFilter>,
    {
...
pub trait IFilterTrackingProvider_Impl: windows_core::IUnknownImpl {
    fn SpecifyTrackedFilters(&self, pcallback: windows_core::Ref<IFilterTrackingRequestCallback>) -> windows_result::Result<()>;
    fn AddTrackedFilter(&self, pfilter: windows_core::Ref<ISyncFilter>) -> windows_result::Result<()>;
}
...
impl IFilterTrackingRequestCallback {
    pub unsafe fn RequestTrackedFilter<P0>(&self, pfilter: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ISyncFilter>,
    {
...
pub trait IFilterTrackingRequestCallback_Impl: windows_core::IUnknownImpl {
    fn RequestTrackedFilter(&self, pfilter: windows_core::Ref<ISyncFilter>) -> windows_result::Result<()>;
}
...
impl IFilterTrackingSyncChangeBuilder {
    pub unsafe fn AddFilterChange(&self, dwfilterkey: u32, pfilterchange: *const SYNC_FILTER_CHANGE) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetAllChangeUnitsPresentFlag(&self) -> windows_result::Result<()> {
...
pub trait IFilterTrackingSyncChangeBuilder_Impl: windows_core::IUnknownImpl {
    fn AddFilterChange(&self, dwfilterkey: u32, pfilterchange: *const SYNC_FILTER_CHANGE) -> windows_result::Result<()>;
    fn SetAllChangeUnitsPresentFlag(&self) -> windows_result::Result<()>;
}
...
impl IForgottenKnowledge {
    pub unsafe fn ForgetToVersion<P0>(&self, pknowledge: P0, pversion: *const SYNC_VERSION) -> windows_result::Result<()>
    where
...
pub trait IForgottenKnowledge_Impl: ISyncKnowledge_Impl {
    fn ForgetToVersion(&self, pknowledge: windows_core::Ref<ISyncKnowledge>, pversion: *const SYNC_VERSION) -> windows_result::Result<()>;
}
...
impl IKnowledgeSyncProvider {
    pub unsafe fn BeginSession<P1>(&self, role: SYNC_PROVIDER_ROLE, psessionstate: P1) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetSyncBatchParameters(&self, ppsyncknowledge: *mut Option<ISyncKnowledge>, pdwrequestedbatchsize: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetChangeBatch<P1>(&self, dwbatchsize: u32, psyncknowledge: P1, ppsyncchangebatch: *mut Option<ISyncChangeBatch>, ppunkdataretriever: *mut Option<windows_core::IUnknown>) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetFullEnumerationChangeBatch<P2>(&self, dwbatchsize: u32, pblowerenumerationbound: *const u8, psyncknowledge: P2, ppsyncchangebatch: *mut Option<ISyncFullEnumerationChangeBatch>, ppunkdataretriever: *mut Option<windows_core::IUnknown>) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn ProcessChangeBatch<P1, P2, P3>(&self, resolutionpolicy: CONFLICT_RESOLUTION_POLICY, psourcechangebatch: P1, punkdataretriever: P2, pcallback: P3, psyncsessionstatistics: *mut SYNC_SESSION_STATISTICS) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn ProcessFullEnumerationChangeBatch<P1, P2, P3>(&self, resolutionpolicy: CONFLICT_RESOLUTION_POLICY, psourcechangebatch: P1, punkdataretriever: P2, pcallback: P3, psyncsessionstatistics: *mut SYNC_SESSION_STATISTICS) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn EndSession<P0>(&self, psessionstate: P0) -> windows_result::Result<()>
    where
...
pub trait IKnowledgeSyncProvider_Impl: ISyncProvider_Impl {
    fn BeginSession(&self, role: SYNC_PROVIDER_ROLE, psessionstate: windows_core::Ref<ISyncSessionState>) -> windows_result::Result<()>;
    fn GetSyncBatchParameters(&self, ppsyncknowledge: windows_core::OutRef<ISyncKnowledge>, pdwrequestedbatchsize: *mut u32) -> windows_result::Result<()>;
    fn GetChangeBatch(&self, dwbatchsize: u32, psyncknowledge: windows_core::Ref<ISyncKnowledge>, ppsyncchangebatch: windows_core::OutRef<ISyncChangeBatch>, ppunkdataretriever: windows_core::OutRef<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn GetFullEnumerationChangeBatch(&self, dwbatchsize: u32, pblowerenumerationbound: *const u8, psyncknowledge: windows_core::Ref<ISyncKnowledge>, ppsyncchangebatch: windows_core::OutRef<ISyncFullEnumerationChangeBatch>, ppunkdataretriever: windows_core::OutRef<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn ProcessChangeBatch(&self, resolutionpolicy: CONFLICT_RESOLUTION_POLICY, psourcechangebatch: windows_core::Ref<ISyncChangeBatch>, punkdataretriever: windows_core::Ref<windows_core::IUnknown>, pcallback: windows_core::Ref<ISyncCallback>, psyncsessionstatistics: *mut SYNC_SESSION_STATISTICS) -> windows_result::Result<()>;
    fn ProcessFullEnumerationChangeBatch(&self, resolutionpolicy: CONFLICT_RESOLUTION_POLICY, psourcechangebatch: windows_core::Ref<ISyncFullEnumerationChangeBatch>, punkdataretriever: windows_core::Ref<windows_core::IUnknown>, pcallback: windows_core::Ref<ISyncCallback>, psyncsessionstatistics: *mut SYNC_SESSION_STATISTICS) -> windows_result::Result<()>;
    fn EndSession(&self, psessionstate: windows_core::Ref<ISyncSessionState>) -> windows_result::Result<()>;
}
...
impl ILoadChangeContext {
    pub unsafe fn GetSyncChange(&self) -> windows_result::Result<ISyncChange> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetRecoverableErrorOnChange<P1>(&self, hrerror: windows_core::HRESULT, perrordata: P1) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn SetRecoverableErrorOnChangeUnit<P1, P2>(&self, hrerror: windows_core::HRESULT, pchangeunit: P1, perrordata: P2) -> windows_result::Result<()>
    where
...
pub trait ILoadChangeContext_Impl: windows_core::IUnknownImpl {
    fn GetSyncChange(&self) -> windows_result::Result<ISyncChange>;
    fn SetRecoverableErrorOnChange(&self, hrerror: windows_core::HRESULT, perrordata: windows_core::Ref<IRecoverableErrorData>) -> windows_result::Result<()>;
    fn SetRecoverableErrorOnChangeUnit(&self, hrerror: windows_core::HRESULT, pchangeunit: windows_core::Ref<ISyncChangeUnit>, perrordata: windows_core::Ref<IRecoverableErrorData>) -> windows_result::Result<()>;
}
...
impl IProviderConverter {
    pub unsafe fn Initialize<P0>(&self, pisyncprovider: P0) -> windows_result::Result<()>
    where
...
pub trait IProviderConverter_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, pisyncprovider: windows_core::Ref<ISyncProvider>) -> windows_result::Result<()>;
}
...
impl IRangeException {
    pub unsafe fn GetClosedRangeStart(&self, pbclosedrangestart: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetClosedRangeEnd(&self, pbclosedrangeend: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()> {
...
pub trait IRangeException_Impl: windows_core::IUnknownImpl {
    fn GetClosedRangeStart(&self, pbclosedrangestart: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()>;
    fn GetClosedRangeEnd(&self, pbclosedrangeend: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()>;
    fn GetClockVector(&self, riid: *const windows_core::GUID, ppunk: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
}
...
impl IRecoverableError {
    pub unsafe fn GetStage(&self, pstage: *mut SYNC_PROGRESS_STAGE) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetStage)(windows_core::Interface::as_raw(self), pstage as _).ok() }
    }
    pub unsafe fn GetProvider(&self, pproviderrole: *mut SYNC_PROVIDER_ROLE) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetProvider)(windows_core::Interface::as_raw(self), pproviderrole as _).ok() }
    }
    pub unsafe fn GetChangeWithRecoverableError(&self) -> windows_result::Result<ISyncChange> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetRecoverableErrorDataForChange(&self, phrerror: *mut windows_core::HRESULT, pperrordata: *mut Option<IRecoverableErrorData>) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetRecoverableErrorDataForChangeUnit<P0>(&self, pchangeunit: P0, phrerror: *mut windows_core::HRESULT, pperrordata: *mut Option<IRecoverableErrorData>) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ISyncChangeUnit>,
    {
...
pub trait IRecoverableError_Impl: windows_core::IUnknownImpl {
    fn GetStage(&self, pstage: *mut SYNC_PROGRESS_STAGE) -> windows_result::Result<()>;
    fn GetProvider(&self, pproviderrole: *mut SYNC_PROVIDER_ROLE) -> windows_result::Result<()>;
    fn GetChangeWithRecoverableError(&self) -> windows_result::Result<ISyncChange>;
    fn GetRecoverableErrorDataForChange(&self, phrerror: *mut windows_core::HRESULT, pperrordata: windows_core::OutRef<IRecoverableErrorData>) -> windows_result::Result<()>;
    fn GetRecoverableErrorDataForChangeUnit(&self, pchangeunit: windows_core::Ref<ISyncChangeUnit>, phrerror: *mut windows_core::HRESULT, pperrordata: windows_core::OutRef<IRecoverableErrorData>) -> windows_result::Result<()>;
}
...
impl IRecoverableErrorData {
    pub unsafe fn Initialize<P0, P1>(&self, pcszitemdisplayname: P0, pcszerrordescription: P1) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetItemDisplayName<P0>(&self, pszitemdisplayname: P0, pcchitemdisplayname: *mut u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetErrorDescription<P0>(&self, pszerrordescription: P0, pccherrordescription: *mut u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IRecoverableErrorData_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, pcszitemdisplayname: &windows_core::PCWSTR, pcszerrordescription: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetItemDisplayName(&self, pszitemdisplayname: &windows_core::PCWSTR, pcchitemdisplayname: *mut u32) -> windows_result::Result<()>;
    fn GetErrorDescription(&self, pszerrordescription: &windows_core::PCWSTR, pccherrordescription: *mut u32) -> windows_result::Result<()>;
}
...
impl IRegisteredSyncProvider {
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn Init<P2>(&self, pguidinstanceid: *const windows_core::GUID, pguidcontenttype: *const windows_core::GUID, pcontextpropertystore: P2) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetInstanceId(&self) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRegisteredSyncProvider_Impl: windows_core::IUnknownImpl {
    fn Init(&self, pguidinstanceid: *const windows_core::GUID, pguidcontenttype: *const windows_core::GUID, pcontextpropertystore: windows_core::Ref<super::super::UI::Shell::PropertiesSystem::IPropertyStore>) -> windows_result::Result<()>;
    fn GetInstanceId(&self) -> windows_result::Result<windows_core::GUID>;
    fn Reset(&self) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
...
impl IReplicaKeyMap {
    pub unsafe fn LookupReplicaKey(&self, pbreplicaid: *const u8, pdwreplicakey: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn LookupReplicaId(&self, dwreplicakey: u32, pbreplicaid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Serialize(&self, pbreplicakeymap: *mut u8, pcbreplicakeymap: *mut u32) -> windows_result::Result<()> {
...
pub trait IReplicaKeyMap_Impl: windows_core::IUnknownImpl {
    fn LookupReplicaKey(&self, pbreplicaid: *const u8, pdwreplicakey: *mut u32) -> windows_result::Result<()>;
    fn LookupReplicaId(&self, dwreplicakey: u32, pbreplicaid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()>;
    fn Serialize(&self, pbreplicakeymap: *mut u8, pcbreplicakeymap: *mut u32) -> windows_result::Result<()>;
}
...
impl IRequestFilteredSync {
    pub unsafe fn SpecifyFilter<P0>(&self, pcallback: P0) -> windows_result::Result<()>
    where
...
pub trait IRequestFilteredSync_Impl: windows_core::IUnknownImpl {
    fn SpecifyFilter(&self, pcallback: windows_core::Ref<IFilterRequestCallback>) -> windows_result::Result<()>;
}
...
impl ISupportFilteredSync {
    pub unsafe fn AddFilter<P0>(&self, pfilter: P0, filteringtype: FILTERING_TYPE) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
...
pub trait ISupportFilteredSync_Impl: windows_core::IUnknownImpl {
    fn AddFilter(&self, pfilter: windows_core::Ref<windows_core::IUnknown>, filteringtype: FILTERING_TYPE) -> windows_result::Result<()>;
}
...
impl ISupportLastWriteTime {
    pub unsafe fn GetItemChangeTime(&self, pbitemid: *const u8, pulltimestamp: *mut u64) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetChangeUnitChangeTime(&self, pbitemid: *const u8, pbchangeunitid: *const u8, pulltimestamp: *mut u64) -> windows_result::Result<()> {
...
pub trait ISupportLastWriteTime_Impl: windows_core::IUnknownImpl {
    fn GetItemChangeTime(&self, pbitemid: *const u8, pulltimestamp: *mut u64) -> windows_result::Result<()>;
    fn GetChangeUnitChangeTime(&self, pbitemid: *const u8, pbchangeunitid: *const u8, pulltimestamp: *mut u64) -> windows_result::Result<()>;
}
...
impl ISyncCallback {
    pub unsafe fn OnProgress(&self, provider: SYNC_PROVIDER_ROLE, syncstage: SYNC_PROGRESS_STAGE, dwcompletedwork: u32, dwtotalwork: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn OnChange<P0>(&self, psyncchange: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn OnConflict<P0>(&self, pconflict: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn OnFullEnumerationNeeded(&self, pfullenumerationaction: *mut SYNC_FULL_ENUMERATION_ACTION) -> windows_result::Result<()> {
    ...
    pub unsafe fn OnRecoverableError<P0>(&self, precoverableerror: P0) -> windows_result::Result<()>
    where
...
pub trait ISyncCallback_Impl: windows_core::IUnknownImpl {
    fn OnProgress(&self, provider: SYNC_PROVIDER_ROLE, syncstage: SYNC_PROGRESS_STAGE, dwcompletedwork: u32, dwtotalwork: u32) -> windows_result::Result<()>;
    fn OnChange(&self, psyncchange: windows_core::Ref<ISyncChange>) -> windows_result::Result<()>;
    fn OnConflict(&self, pconflict: windows_core::Ref<IChangeConflict>) -> windows_result::Result<()>;
    fn OnFullEnumerationNeeded(&self, pfullenumerationaction: *mut SYNC_FULL_ENUMERATION_ACTION) -> windows_result::Result<()>;
    fn OnRecoverableError(&self, precoverableerror: windows_core::Ref<IRecoverableError>) -> windows_result::Result<()>;
}
...
impl ISyncCallback2 {
    pub unsafe fn OnChangeApplied(&self, dwchangesapplied: u32, dwchangesfailed: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn OnChangeFailed(&self, dwchangesapplied: u32, dwchangesfailed: u32) -> windows_result::Result<()> {
...
pub trait ISyncCallback2_Impl: ISyncCallback_Impl {
    fn OnChangeApplied(&self, dwchangesapplied: u32, dwchangesfailed: u32) -> windows_result::Result<()>;
    fn OnChangeFailed(&self, dwchangesapplied: u32, dwchangesfailed: u32) -> windows_result::Result<()>;
}
...
impl ISyncChange {
    pub unsafe fn GetOwnerReplicaId(&self, pbreplicaid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetRootItemId(&self, pbrootitemid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetChangeVersion(&self, pbcurrentreplicaid: *const u8, pversion: *mut SYNC_VERSION) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetCreationVersion(&self, pbcurrentreplicaid: *const u8, pversion: *mut SYNC_VERSION) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetWorkEstimate(&self, pdwwork: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetWorkEstimate)(windows_core::Interface::as_raw(self), pdwwork as _).ok() }
    }
    pub unsafe fn GetChangeUnits(&self) -> windows_result::Result<IEnumSyncChangeUnits> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetMadeWithKnowledge(&self) -> windows_result::Result<ISyncKnowledge> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetLearnedKnowledge(&self) -> windows_result::Result<ISyncKnowledge> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetWorkEstimate(&self, dwwork: u32) -> windows_result::Result<()> {
...
pub trait ISyncChange_Impl: windows_core::IUnknownImpl {
    fn GetOwnerReplicaId(&self, pbreplicaid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()>;
    fn GetRootItemId(&self, pbrootitemid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()>;
    fn GetChangeVersion(&self, pbcurrentreplicaid: *const u8, pversion: *mut SYNC_VERSION) -> windows_result::Result<()>;
    fn GetCreationVersion(&self, pbcurrentreplicaid: *const u8, pversion: *mut SYNC_VERSION) -> windows_result::Result<()>;
    fn GetFlags(&self, pdwflags: *mut u32) -> windows_result::Result<()>;
    fn GetWorkEstimate(&self, pdwwork: *mut u32) -> windows_result::Result<()>;
    fn GetChangeUnits(&self) -> windows_result::Result<IEnumSyncChangeUnits>;
    fn GetMadeWithKnowledge(&self) -> windows_result::Result<ISyncKnowledge>;
    fn GetLearnedKnowledge(&self) -> windows_result::Result<ISyncKnowledge>;
    fn SetWorkEstimate(&self, dwwork: u32) -> windows_result::Result<()>;
}
...
impl ISyncChangeBatch {
    pub unsafe fn BeginUnorderedGroup(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).BeginUnorderedGroup)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn EndUnorderedGroup<P0>(&self, pmadewithknowledge: P0, fallchangesforknowledge: bool) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ISyncKnowledge>,
    {
    ...
    pub unsafe fn AddLoggedConflict<P6>(&self, pbownerreplicaid: *const u8, pbitemid: *const u8, pchangeversion: *const SYNC_VERSION, pcreationversion: *const SYNC_VERSION, dwflags: u32, dwworkforchange: u32, pconflictknowledge: P6) -> windows_result::Result<ISyncChangeBuilder>
    where
...
pub trait ISyncChangeBatch_Impl: ISyncChangeBatchBase_Impl {
    fn BeginUnorderedGroup(&self) -> windows_result::Result<()>;
    fn EndUnorderedGroup(&self, pmadewithknowledge: windows_core::Ref<ISyncKnowledge>, fallchangesforknowledge: windows_core::BOOL) -> windows_result::Result<()>;
    fn AddLoggedConflict(&self, pbownerreplicaid: *const u8, pbitemid: *const u8, pchangeversion: *const SYNC_VERSION, pcreationversion: *const SYNC_VERSION, dwflags: u32, dwworkforchange: u32, pconflictknowledge: windows_core::Ref<ISyncKnowledge>) -> windows_result::Result<ISyncChangeBuilder>;
}
...
impl ISyncChangeBatch2 {
    pub unsafe fn AddMergeTombstoneMetadataToGroup(&self, pbownerreplicaid: *const u8, pbwinneritemid: *const u8, pbitemid: *const u8, pchangeversion: *const SYNC_VERSION, pcreationversion: *const SYNC_VERSION, dwworkforchange: u32) -> windows_result::Result<ISyncChangeBuilder> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AddMergeTombstoneLoggedConflict<P6>(&self, pbownerreplicaid: *const u8, pbwinneritemid: *const u8, pbitemid: *const u8, pchangeversion: *const SYNC_VERSION, pcreationversion: *const SYNC_VERSION, dwworkforchange: u32, pconflictknowledge: P6) -> windows_result::Result<ISyncChangeBuilder>
    where
        P6: windows_core::Param<ISyncKnowledge>,
    {
        unsafe {
...
pub trait ISyncChangeBatch2_Impl: ISyncChangeBatch_Impl {
    fn AddMergeTombstoneMetadataToGroup(&self, pbownerreplicaid: *const u8, pbwinneritemid: *const u8, pbitemid: *const u8, pchangeversion: *const SYNC_VERSION, pcreationversion: *const SYNC_VERSION, dwworkforchange: u32) -> windows_result::Result<ISyncChangeBuilder>;
    fn AddMergeTombstoneLoggedConflict(&self, pbownerreplicaid: *const u8, pbwinneritemid: *const u8, pbitemid: *const u8, pchangeversion: *const SYNC_VERSION, pcreationversion: *const SYNC_VERSION, dwworkforchange: u32, pconflictknowledge: windows_core::Ref<ISyncKnowledge>) -> windows_result::Result<ISyncChangeBuilder>;
}
...
impl ISyncChangeBatchAdvanced {
    pub unsafe fn GetFilterInfo(&self) -> windows_result::Result<ISyncFilterInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ConvertFullEnumerationChangeBatchToRegularChangeBatch(&self) -> windows_result::Result<ISyncChangeBatch> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetUpperBoundItemId(&self, pbitemid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetBatchLevelKnowledgeShouldBeApplied(&self, pfbatchknowledgeshouldbeapplied: *mut windows_core::BOOL) -> windows_result::Result<()> {
...
pub trait ISyncChangeBatchAdvanced_Impl: windows_core::IUnknownImpl {
    fn GetFilterInfo(&self) -> windows_result::Result<ISyncFilterInfo>;
    fn ConvertFullEnumerationChangeBatchToRegularChangeBatch(&self) -> windows_result::Result<ISyncChangeBatch>;
    fn GetUpperBoundItemId(&self, pbitemid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()>;
    fn GetBatchLevelKnowledgeShouldBeApplied(&self, pfbatchknowledgeshouldbeapplied: *mut windows_core::BOOL) -> windows_result::Result<()>;
}
...
impl ISyncChangeBatchBase {
    pub unsafe fn GetChangeEnumerator(&self) -> windows_result::Result<IEnumSyncChanges> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetIsLastBatch(&self, pflastbatch: *mut windows_core::BOOL) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetIsLastBatch)(windows_core::Interface::as_raw(self), pflastbatch as _).ok() }
    }
    pub unsafe fn GetWorkEstimateForBatch(&self, pdwworkforbatch: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetRemainingWorkEstimateForSession(&self, pdwremainingworkforsession: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn BeginOrderedGroup(&self, pblowerbound: *const u8) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).BeginOrderedGroup)(windows_core::Interface::as_raw(self), pblowerbound).ok() }
    }
    pub unsafe fn EndOrderedGroup<P1>(&self, pbupperbound: *const u8, pmadewithknowledge: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<ISyncKnowledge>,
    {
    ...
    pub unsafe fn AddItemMetadataToGroup(&self, pbownerreplicaid: *const u8, pbitemid: *const u8, pchangeversion: *const SYNC_VERSION, pcreationversion: *const SYNC_VERSION, dwflags: u32, dwworkforchange: u32) -> windows_result::Result<ISyncChangeBuilder> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetPrerequisiteKnowledge(&self) -> windows_result::Result<ISyncKnowledge> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetSourceForgottenKnowledge(&self) -> windows_result::Result<IForgottenKnowledge> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetLastBatch(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetLastBatch)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn SetWorkEstimateForBatch(&self, dwworkforbatch: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetWorkEstimateForBatch)(windows_core::Interface::as_raw(self), dwworkforbatch).ok() }
    }
    pub unsafe fn SetRemainingWorkEstimateForSession(&self, dwremainingworkforsession: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Serialize(&self, pbchangebatch: *mut u8, pcbchangebatch: *mut u32) -> windows_result::Result<()> {
...
pub trait ISyncChangeBatchBase_Impl: windows_core::IUnknownImpl {
    fn GetChangeEnumerator(&self) -> windows_result::Result<IEnumSyncChanges>;
    fn GetIsLastBatch(&self, pflastbatch: *mut windows_core::BOOL) -> windows_result::Result<()>;
    fn GetWorkEstimateForBatch(&self, pdwworkforbatch: *mut u32) -> windows_result::Result<()>;
    fn GetRemainingWorkEstimateForSession(&self, pdwremainingworkforsession: *mut u32) -> windows_result::Result<()>;
    fn BeginOrderedGroup(&self, pblowerbound: *const u8) -> windows_result::Result<()>;
    fn EndOrderedGroup(&self, pbupperbound: *const u8, pmadewithknowledge: windows_core::Ref<ISyncKnowledge>) -> windows_result::Result<()>;
    fn AddItemMetadataToGroup(&self, pbownerreplicaid: *const u8, pbitemid: *const u8, pchangeversion: *const SYNC_VERSION, pcreationversion: *const SYNC_VERSION, dwflags: u32, dwworkforchange: u32) -> windows_result::Result<ISyncChangeBuilder>;
    fn GetLearnedKnowledge(&self) -> windows_result::Result<ISyncKnowledge>;
    fn GetPrerequisiteKnowledge(&self) -> windows_result::Result<ISyncKnowledge>;
    fn GetSourceForgottenKnowledge(&self) -> windows_result::Result<IForgottenKnowledge>;
    fn SetLastBatch(&self) -> windows_result::Result<()>;
    fn SetWorkEstimateForBatch(&self, dwworkforbatch: u32) -> windows_result::Result<()>;
    fn SetRemainingWorkEstimateForSession(&self, dwremainingworkforsession: u32) -> windows_result::Result<()>;
    fn Serialize(&self, pbchangebatch: *mut u8, pcbchangebatch: *mut u32) -> windows_result::Result<()>;
}
...
impl ISyncChangeBatchBase2 {
    pub unsafe fn SerializeWithOptions(&self, targetformatversion: SYNC_SERIALIZATION_VERSION, dwflags: u32, pbbuffer: *mut u8, pdwserializedsize: *mut u32) -> windows_result::Result<()> {
...
pub trait ISyncChangeBatchBase2_Impl: ISyncChangeBatchBase_Impl {
    fn SerializeWithOptions(&self, targetformatversion: SYNC_SERIALIZATION_VERSION, dwflags: u32, pbbuffer: *mut u8, pdwserializedsize: *mut u32) -> windows_result::Result<()>;
}
...
impl ISyncChangeBatchWithFilterKeyMap {
    pub unsafe fn GetFilterKeyMap(&self) -> windows_result::Result<IFilterKeyMap> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetFilterKeyMap<P0>(&self, pifilterkeymap: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn SetFilterForgottenKnowledge<P1>(&self, dwfilterkey: u32, pfilterforgottenknowledge: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<ISyncKnowledge>,
    {
    ...
    pub unsafe fn GetFilteredReplicaLearnedKnowledge<P0, P1>(&self, pdestinationknowledge: P0, pnewmoveins: P1) -> windows_result::Result<ISyncKnowledge>
    where
        P0: windows_core::Param<ISyncKnowledge>,
    ...
    pub unsafe fn GetLearnedFilterForgottenKnowledge<P0, P1>(&self, pdestinationknowledge: P0, pnewmoveins: P1, dwfilterkey: u32) -> windows_result::Result<ISyncKnowledge>
    where
        P0: windows_core::Param<ISyncKnowledge>,
        P1: windows_core::Param<IEnumItemIds>,
    {
    ...
    pub unsafe fn GetFilteredReplicaLearnedForgottenKnowledge<P0, P1>(&self, pdestinationknowledge: P0, pnewmoveins: P1) -> windows_result::Result<ISyncKnowledge>
    where
        P0: windows_core::Param<ISyncKnowledge>,
        P1: windows_core::Param<IEnumItemIds>,
    {
    ...
    pub unsafe fn GetFilteredReplicaLearnedForgottenKnowledgeAfterRecoveryComplete<P0, P1>(&self, pdestinationknowledge: P0, pnewmoveins: P1) -> windows_result::Result<ISyncKnowledge>
    where
        P0: windows_core::Param<ISyncKnowledge>,
        P1: windows_core::Param<IEnumItemIds>,
    {
    ...
    pub unsafe fn GetLearnedFilterForgottenKnowledgeAfterRecoveryComplete<P0, P1>(&self, pdestinationknowledge: P0, pnewmoveins: P1, dwfilterkey: u32) -> windows_result::Result<ISyncKnowledge>
    where
        P0: windows_core::Param<ISyncKnowledge>,
        P1: windows_core::Param<IEnumItemIds>,
    {
...
pub trait ISyncChangeBatchWithFilterKeyMap_Impl: windows_core::IUnknownImpl {
    fn GetFilterKeyMap(&self) -> windows_result::Result<IFilterKeyMap>;
    fn SetFilterKeyMap(&self, pifilterkeymap: windows_core::Ref<IFilterKeyMap>) -> windows_result::Result<()>;
    fn SetFilterForgottenKnowledge(&self, dwfilterkey: u32, pfilterforgottenknowledge: windows_core::Ref<ISyncKnowledge>) -> windows_result::Result<()>;
    fn GetFilteredReplicaLearnedKnowledge(&self, pdestinationknowledge: windows_core::Ref<ISyncKnowledge>, pnewmoveins: windows_core::Ref<IEnumItemIds>) -> windows_result::Result<ISyncKnowledge>;
    fn GetLearnedFilterForgottenKnowledge(&self, pdestinationknowledge: windows_core::Ref<ISyncKnowledge>, pnewmoveins: windows_core::Ref<IEnumItemIds>, dwfilterkey: u32) -> windows_result::Result<ISyncKnowledge>;
    fn GetFilteredReplicaLearnedForgottenKnowledge(&self, pdestinationknowledge: windows_core::Ref<ISyncKnowledge>, pnewmoveins: windows_core::Ref<IEnumItemIds>) -> windows_result::Result<ISyncKnowledge>;
    fn GetFilteredReplicaLearnedForgottenKnowledgeAfterRecoveryComplete(&self, pdestinationknowledge: windows_core::Ref<ISyncKnowledge>, pnewmoveins: windows_core::Ref<IEnumItemIds>) -> windows_result::Result<ISyncKnowledge>;
    fn GetLearnedFilterForgottenKnowledgeAfterRecoveryComplete(&self, pdestinationknowledge: windows_core::Ref<ISyncKnowledge>, pnewmoveins: windows_core::Ref<IEnumItemIds>, dwfilterkey: u32) -> windows_result::Result<ISyncKnowledge>;
}
...
impl ISyncChangeBatchWithPrerequisite {
    pub unsafe fn SetPrerequisiteKnowledge<P0>(&self, pprerequisiteknowledge: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ISyncKnowledge>,
    {
    ...
    pub unsafe fn GetLearnedKnowledgeWithPrerequisite<P0>(&self, pdestinationknowledge: P0) -> windows_result::Result<ISyncKnowledge>
    where
        P0: windows_core::Param<ISyncKnowledge>,
    {
        unsafe {
    ...
    pub unsafe fn GetLearnedForgottenKnowledge(&self) -> windows_result::Result<IForgottenKnowledge> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISyncChangeBatchWithPrerequisite_Impl: ISyncChangeBatchBase_Impl {
    fn SetPrerequisiteKnowledge(&self, pprerequisiteknowledge: windows_core::Ref<ISyncKnowledge>) -> windows_result::Result<()>;
    fn GetLearnedKnowledgeWithPrerequisite(&self, pdestinationknowledge: windows_core::Ref<ISyncKnowledge>) -> windows_result::Result<ISyncKnowledge>;
    fn GetLearnedForgottenKnowledge(&self) -> windows_result::Result<IForgottenKnowledge>;
}
...
impl ISyncChangeBuilder {
    pub unsafe fn AddChangeUnitMetadata(&self, pbchangeunitid: *const u8, pchangeunitversion: *const SYNC_VERSION) -> windows_result::Result<()> {
...
pub trait ISyncChangeBuilder_Impl: windows_core::IUnknownImpl {
    fn AddChangeUnitMetadata(&self, pbchangeunitid: *const u8, pchangeunitversion: *const SYNC_VERSION) -> windows_result::Result<()>;
}
...
impl ISyncChangeUnit {
    pub unsafe fn GetItemChange(&self) -> windows_result::Result<ISyncChange> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetChangeUnitVersion(&self, pbcurrentreplicaid: *const u8, pversion: *mut SYNC_VERSION) -> windows_result::Result<()> {
...
pub trait ISyncChangeUnit_Impl: windows_core::IUnknownImpl {
    fn GetItemChange(&self) -> windows_result::Result<ISyncChange>;
    fn GetChangeUnitId(&self, pbchangeunitid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()>;
    fn GetChangeUnitVersion(&self, pbcurrentreplicaid: *const u8, pversion: *mut SYNC_VERSION) -> windows_result::Result<()>;
}
...
impl ISyncChangeWithFilterKeyMap {
    ...
    pub unsafe fn GetFilterChange(&self, dwfilterkey: u32, pfilterchange: *mut SYNC_FILTER_CHANGE) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetAllChangeUnitsPresentFlag(&self, pfallchangeunitspresent: *mut windows_core::BOOL) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFilterForgottenKnowledge(&self, dwfilterkey: u32) -> windows_result::Result<ISyncKnowledge> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISyncChangeWithFilterKeyMap_Impl: windows_core::IUnknownImpl {
    fn GetFilterCount(&self, pdwfiltercount: *mut u32) -> windows_result::Result<()>;
    fn GetFilterChange(&self, dwfilterkey: u32, pfilterchange: *mut SYNC_FILTER_CHANGE) -> windows_result::Result<()>;
    fn GetAllChangeUnitsPresentFlag(&self, pfallchangeunitspresent: *mut windows_core::BOOL) -> windows_result::Result<()>;
    fn GetFilterForgottenKnowledge(&self, dwfilterkey: u32) -> windows_result::Result<ISyncKnowledge>;
    fn GetFilteredReplicaLearnedKnowledge(&self, pdestinationknowledge: windows_core::Ref<ISyncKnowledge>, pnewmoveins: windows_core::Ref<IEnumItemIds>) -> windows_result::Result<ISyncKnowledge>;
    fn GetLearnedFilterForgottenKnowledge(&self, pdestinationknowledge: windows_core::Ref<ISyncKnowledge>, pnewmoveins: windows_core::Ref<IEnumItemIds>, dwfilterkey: u32) -> windows_result::Result<ISyncKnowledge>;
    fn GetFilteredReplicaLearnedForgottenKnowledge(&self, pdestinationknowledge: windows_core::Ref<ISyncKnowledge>, pnewmoveins: windows_core::Ref<IEnumItemIds>) -> windows_result::Result<ISyncKnowledge>;
    fn GetFilteredReplicaLearnedForgottenKnowledgeAfterRecoveryComplete(&self, pdestinationknowledge: windows_core::Ref<ISyncKnowledge>, pnewmoveins: windows_core::Ref<IEnumItemIds>) -> windows_result::Result<ISyncKnowledge>;
...
impl ISyncConstraintCallback {
    pub unsafe fn OnConstraintConflict<P0>(&self, pconflict: P0) -> windows_result::Result<()>
    where
...
pub trait ISyncConstraintCallback_Impl: windows_core::IUnknownImpl {
    fn OnConstraintConflict(&self, pconflict: windows_core::Ref<IConstraintConflict>) -> windows_result::Result<()>;
}
...
impl ISyncDataConverter {
    pub unsafe fn ConvertDataRetrieverFromProviderFormat<P0, P1>(&self, punkdataretrieverin: P0, penumsyncchanges: P1) -> windows_result::Result<windows_core::IUnknown>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    ...
    pub unsafe fn ConvertDataRetrieverToProviderFormat<P0, P1>(&self, punkdataretrieverin: P0, penumsyncchanges: P1) -> windows_result::Result<windows_core::IUnknown>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
        P1: windows_core::Param<IEnumSyncChanges>,
    {
    ...
    pub unsafe fn ConvertDataFromProviderFormat<P0, P1>(&self, pdatacontext: P0, punkdatain: P1) -> windows_result::Result<windows_core::IUnknown>
    where
        P0: windows_core::Param<ILoadChangeContext>,
    ...
    pub unsafe fn ConvertDataToProviderFormat<P0, P1>(&self, pdatacontext: P0, punkdataout: P1) -> windows_result::Result<windows_core::IUnknown>
    where
        P0: windows_core::Param<ILoadChangeContext>,
        P1: windows_core::Param<windows_core::IUnknown>,
    {
...
pub trait ISyncDataConverter_Impl: windows_core::IUnknownImpl {
    fn ConvertDataRetrieverFromProviderFormat(&self, punkdataretrieverin: windows_core::Ref<windows_core::IUnknown>, penumsyncchanges: windows_core::Ref<IEnumSyncChanges>) -> windows_result::Result<windows_core::IUnknown>;
    fn ConvertDataRetrieverToProviderFormat(&self, punkdataretrieverin: windows_core::Ref<windows_core::IUnknown>, penumsyncchanges: windows_core::Ref<IEnumSyncChanges>) -> windows_result::Result<windows_core::IUnknown>;
    fn ConvertDataFromProviderFormat(&self, pdatacontext: windows_core::Ref<ILoadChangeContext>, punkdatain: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<windows_core::IUnknown>;
    fn ConvertDataToProviderFormat(&self, pdatacontext: windows_core::Ref<ILoadChangeContext>, punkdataout: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<windows_core::IUnknown>;
}
...
impl ISyncFilter {
    pub unsafe fn IsIdentical<P0>(&self, psyncfilter: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ISyncFilter>,
    {
        unsafe { (windows_core::Interface::vtable(self).IsIdentical)(windows_core::Interface::as_raw(self), psyncfilter.param().abi()).ok() }
    }
    pub unsafe fn Serialize(&self, pbsyncfilter: *mut u8, pcbsyncfilter: *mut u32) -> windows_result::Result<()> {
...
pub trait ISyncFilter_Impl: windows_core::IUnknownImpl {
    fn IsIdentical(&self, psyncfilter: windows_core::Ref<ISyncFilter>) -> windows_result::Result<()>;
    fn Serialize(&self, pbsyncfilter: *mut u8, pcbsyncfilter: *mut u32) -> windows_result::Result<()>;
}
...
impl ISyncFilterDeserializer {
    pub unsafe fn DeserializeSyncFilter(&self, pbsyncfilter: *const u8, dwcbsyncfilter: u32) -> windows_result::Result<ISyncFilter> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISyncFilterDeserializer_Impl: windows_core::IUnknownImpl {
    fn DeserializeSyncFilter(&self, pbsyncfilter: *const u8, dwcbsyncfilter: u32) -> windows_result::Result<ISyncFilter>;
}
...
impl ISyncFilterInfo {
    pub unsafe fn Serialize(&self, pbbuffer: *mut u8, pcbbuffer: *mut u32) -> windows_result::Result<()> {
...
pub trait ISyncFilterInfo_Impl: windows_core::IUnknownImpl {
    fn Serialize(&self, pbbuffer: *mut u8, pcbbuffer: *mut u32) -> windows_result::Result<()>;
}
...
impl ISyncFullEnumerationChange {
    pub unsafe fn GetLearnedKnowledgeAfterRecoveryComplete(&self) -> windows_result::Result<ISyncKnowledge> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISyncFullEnumerationChange_Impl: windows_core::IUnknownImpl {
    fn GetLearnedKnowledgeAfterRecoveryComplete(&self) -> windows_result::Result<ISyncKnowledge>;
    fn GetLearnedForgottenKnowledge(&self) -> windows_result::Result<IForgottenKnowledge>;
}
...
impl ISyncFullEnumerationChangeBatch {
    ...
    pub unsafe fn GetClosedLowerBoundItemId(&self, pbclosedlowerbounditemid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetClosedUpperBoundItemId(&self, pbclosedupperbounditemid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()> {
...
pub trait ISyncFullEnumerationChangeBatch_Impl: ISyncChangeBatchBase_Impl {
    fn GetLearnedKnowledgeAfterRecoveryComplete(&self) -> windows_result::Result<ISyncKnowledge>;
    fn GetClosedLowerBoundItemId(&self, pbclosedlowerbounditemid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()>;
    fn GetClosedUpperBoundItemId(&self, pbclosedupperbounditemid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()>;
}
...
impl ISyncKnowledge {
    ...
    pub unsafe fn Serialize(&self, fserializereplicakeymap: bool, pbknowledge: *mut u8, pcbknowledge: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetLocalTickCount(&self, ulltickcount: u64) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetLocalTickCount)(windows_core::Interface::as_raw(self), ulltickcount).ok() }
    }
    pub unsafe fn ContainsChange(&self, pbversionownerreplicaid: *const u8, pgiditemid: *const u8, psyncversion: *const SYNC_VERSION) -> windows_result::Result<()> {
    ...
    pub unsafe fn ContainsChangeUnit(&self, pbversionownerreplicaid: *const u8, pbitemid: *const u8, pbchangeunitid: *const u8, psyncversion: *const SYNC_VERSION) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetScopeVector(&self, riid: *const windows_core::GUID, ppunk: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetScopeVector)(windows_core::Interface::as_raw(self), riid, ppunk as _).ok() }
    }
    pub unsafe fn GetReplicaKeyMap(&self) -> windows_result::Result<IReplicaKeyMap> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<ISyncKnowledge> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn ConvertVersion<P0>(&self, pknowledgein: P0, pbcurrentownerid: *const u8, pversionin: *const SYNC_VERSION, pbnewownerid: *mut u8, pcbidsize: *mut u32, pversionout: *mut SYNC_VERSION) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ISyncKnowledge>,
    {
    ...
    pub unsafe fn MapRemoteToLocal<P0>(&self, premoteknowledge: P0) -> windows_result::Result<ISyncKnowledge>
    where
        P0: windows_core::Param<ISyncKnowledge>,
    {
        unsafe {
    ...
    pub unsafe fn Union<P0>(&self, pknowledge: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ISyncKnowledge>,
    {
        unsafe { (windows_core::Interface::vtable(self).Union)(windows_core::Interface::as_raw(self), pknowledge.param().abi()).ok() }
    }
    pub unsafe fn ProjectOntoItem(&self, pbitemid: *const u8) -> windows_result::Result<ISyncKnowledge> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ProjectOntoChangeUnit(&self, pbitemid: *const u8, pbchangeunitid: *const u8) -> windows_result::Result<ISyncKnowledge> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ProjectOntoRange(&self, psrngsyncrange: *const SYNC_RANGE) -> windows_result::Result<ISyncKnowledge> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ExcludeItem(&self, pbitemid: *const u8) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ExcludeItem)(windows_core::Interface::as_raw(self), pbitemid).ok() }
    }
    pub unsafe fn ExcludeChangeUnit(&self, pbitemid: *const u8, pbchangeunitid: *const u8) -> windows_result::Result<()> {
    ...
    pub unsafe fn ContainsKnowledge<P0>(&self, pknowledge: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ISyncKnowledge>,
    {
        unsafe { (windows_core::Interface::vtable(self).ContainsKnowledge)(windows_core::Interface::as_raw(self), pknowledge.param().abi()).ok() }
    }
    pub unsafe fn FindMinTickCountForReplica(&self, pbreplicaid: *const u8, pullreplicatickcount: *mut u64) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetRangeExceptions(&self, riid: *const windows_core::GUID, ppunk: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetRangeExceptions)(windows_core::Interface::as_raw(self), riid, ppunk as _).ok() }
    }
    pub unsafe fn GetSingleItemExceptions(&self, riid: *const windows_core::GUID, ppunk: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetSingleItemExceptions)(windows_core::Interface::as_raw(self), riid, ppunk as _).ok() }
    }
    pub unsafe fn GetChangeUnitExceptions(&self, riid: *const windows_core::GUID, ppunk: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetChangeUnitExceptions)(windows_core::Interface::as_raw(self), riid, ppunk as _).ok() }
    }
    pub unsafe fn FindClockVectorForItem(&self, pbitemid: *const u8, riid: *const windows_core::GUID, ppunk: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
    ...
    pub unsafe fn FindClockVectorForChangeUnit(&self, pbitemid: *const u8, pbchangeunitid: *const u8, riid: *const windows_core::GUID, ppunk: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetVersion(&self, pdwversion: *mut u32) -> windows_result::Result<()> {
...
pub trait ISyncKnowledge_Impl: windows_core::IUnknownImpl {
    fn GetOwnerReplicaId(&self, pbreplicaid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()>;
    fn Serialize(&self, fserializereplicakeymap: windows_core::BOOL, pbknowledge: *mut u8, pcbknowledge: *mut u32) -> windows_result::Result<()>;
    fn SetLocalTickCount(&self, ulltickcount: u64) -> windows_result::Result<()>;
    fn ContainsChange(&self, pbversionownerreplicaid: *const u8, pgiditemid: *const u8, psyncversion: *const SYNC_VERSION) -> windows_result::Result<()>;
    fn ContainsChangeUnit(&self, pbversionownerreplicaid: *const u8, pbitemid: *const u8, pbchangeunitid: *const u8, psyncversion: *const SYNC_VERSION) -> windows_result::Result<()>;
    fn GetScopeVector(&self, riid: *const windows_core::GUID, ppunk: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn GetReplicaKeyMap(&self) -> windows_result::Result<IReplicaKeyMap>;
    fn Clone(&self) -> windows_result::Result<ISyncKnowledge>;
    fn ConvertVersion(&self, pknowledgein: windows_core::Ref<ISyncKnowledge>, pbcurrentownerid: *const u8, pversionin: *const SYNC_VERSION, pbnewownerid: *mut u8, pcbidsize: *mut u32, pversionout: *mut SYNC_VERSION) -> windows_result::Result<()>;
    fn MapRemoteToLocal(&self, premoteknowledge: windows_core::Ref<ISyncKnowledge>) -> windows_result::Result<ISyncKnowledge>;
    fn Union(&self, pknowledge: windows_core::Ref<ISyncKnowledge>) -> windows_result::Result<()>;
    fn ProjectOntoItem(&self, pbitemid: *const u8) -> windows_result::Result<ISyncKnowledge>;
    fn ProjectOntoChangeUnit(&self, pbitemid: *const u8, pbchangeunitid: *const u8) -> windows_result::Result<ISyncKnowledge>;
    fn ProjectOntoRange(&self, psrngsyncrange: *const SYNC_RANGE) -> windows_result::Result<ISyncKnowledge>;
    fn ExcludeItem(&self, pbitemid: *const u8) -> windows_result::Result<()>;
    fn ExcludeChangeUnit(&self, pbitemid: *const u8, pbchangeunitid: *const u8) -> windows_result::Result<()>;
    fn ContainsKnowledge(&self, pknowledge: windows_core::Ref<ISyncKnowledge>) -> windows_result::Result<()>;
    fn FindMinTickCountForReplica(&self, pbreplicaid: *const u8, pullreplicatickcount: *mut u64) -> windows_result::Result<()>;
    fn GetRangeExceptions(&self, riid: *const windows_core::GUID, ppunk: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn GetSingleItemExceptions(&self, riid: *const windows_core::GUID, ppunk: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn GetChangeUnitExceptions(&self, riid: *const windows_core::GUID, ppunk: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn FindClockVectorForItem(&self, pbitemid: *const u8, riid: *const windows_core::GUID, ppunk: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn FindClockVectorForChangeUnit(&self, pbitemid: *const u8, pbchangeunitid: *const u8, riid: *const windows_core::GUID, ppunk: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn GetVersion(&self, pdwversion: *mut u32) -> windows_result::Result<()>;
}
...
impl ISyncKnowledge2 {
    ...
    pub unsafe fn ProjectOntoColumnSet(&self, ppcolumns: *const *const u8, count: u32) -> windows_result::Result<ISyncKnowledge2> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetLowestUncontainedId<P0>(&self, pisyncknowledge: P0, pbitemid: *mut u8, pcbitemidsize: *mut u32) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetInspector(&self, riid: *const windows_core::GUID, ppiinspector: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetInspector)(windows_core::Interface::as_raw(self), riid, ppiinspector as _).ok() }
    }
    pub unsafe fn GetMinimumSupportedVersion(&self, pversion: *mut SYNC_SERIALIZATION_VERSION) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetMinimumSupportedVersion)(windows_core::Interface::as_raw(self), pversion as _).ok() }
    }
    pub unsafe fn GetStatistics(&self, which: SYNC_STATISTICS, pvalue: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetStatistics)(windows_core::Interface::as_raw(self), which, pvalue as _).ok() }
    }
    pub unsafe fn ContainsKnowledgeForItem<P0>(&self, pknowledge: P0, pbitemid: *const u8) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ISyncKnowledge>,
    {
    ...
    pub unsafe fn ContainsKnowledgeForChangeUnit<P0>(&self, pknowledge: P0, pbitemid: *const u8, pbchangeunitid: *const u8) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ISyncKnowledge>,
    {
    ...
    pub unsafe fn ProjectOntoKnowledgeWithPrerequisite<P0, P1>(&self, pprerequisiteknowledge: P0, ptemplateknowledge: P1) -> windows_result::Result<ISyncKnowledge>
    where
        P0: windows_core::Param<ISyncKnowledge>,
        P1: windows_core::Param<ISyncKnowledge>,
    {
    ...
    pub unsafe fn Complement<P0>(&self, psyncknowledge: P0) -> windows_result::Result<ISyncKnowledge>
    where
        P0: windows_core::Param<ISyncKnowledge>,
    {
        unsafe {
    ...
    pub unsafe fn IntersectsWithKnowledge<P0>(&self, psyncknowledge: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ISyncKnowledge>,
    {
    ...
    pub unsafe fn GetKnowledgeCookie(&self) -> windows_result::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CompareToKnowledgeCookie<P0>(&self, pknowledgecookie: P0, presult: *mut KNOWLEDGE_COOKIE_COMPARISON_RESULT) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
...
pub trait ISyncKnowledge2_Impl: ISyncKnowledge_Impl {
    fn GetIdParameters(&self, pidparameters: *mut ID_PARAMETERS) -> windows_result::Result<()>;
    fn ProjectOntoColumnSet(&self, ppcolumns: *const *const u8, count: u32) -> windows_result::Result<ISyncKnowledge2>;
    fn SerializeWithOptions(&self, targetformatversion: SYNC_SERIALIZATION_VERSION, dwflags: u32, pbbuffer: *mut u8, pdwserializedsize: *mut u32) -> windows_result::Result<()>;
    fn GetLowestUncontainedId(&self, pisyncknowledge: windows_core::Ref<ISyncKnowledge2>, pbitemid: *mut u8, pcbitemidsize: *mut u32) -> windows_result::Result<()>;
    fn GetInspector(&self, riid: *const windows_core::GUID, ppiinspector: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn GetMinimumSupportedVersion(&self, pversion: *mut SYNC_SERIALIZATION_VERSION) -> windows_result::Result<()>;
    fn GetStatistics(&self, which: SYNC_STATISTICS, pvalue: *mut u32) -> windows_result::Result<()>;
    fn ContainsKnowledgeForItem(&self, pknowledge: windows_core::Ref<ISyncKnowledge>, pbitemid: *const u8) -> windows_result::Result<()>;
    fn ContainsKnowledgeForChangeUnit(&self, pknowledge: windows_core::Ref<ISyncKnowledge>, pbitemid: *const u8, pbchangeunitid: *const u8) -> windows_result::Result<()>;
    fn ProjectOntoKnowledgeWithPrerequisite(&self, pprerequisiteknowledge: windows_core::Ref<ISyncKnowledge>, ptemplateknowledge: windows_core::Ref<ISyncKnowledge>) -> windows_result::Result<ISyncKnowledge>;
    fn Complement(&self, psyncknowledge: windows_core::Ref<ISyncKnowledge>) -> windows_result::Result<ISyncKnowledge>;
    fn IntersectsWithKnowledge(&self, psyncknowledge: windows_core::Ref<ISyncKnowledge>) -> windows_result::Result<()>;
    fn GetKnowledgeCookie(&self) -> windows_result::Result<windows_core::IUnknown>;
    fn CompareToKnowledgeCookie(&self, pknowledgecookie: windows_core::Ref<windows_core::IUnknown>, presult: *mut KNOWLEDGE_COOKIE_COMPARISON_RESULT) -> windows_result::Result<()>;
}
...
impl ISyncMergeTombstoneChange {
    pub unsafe fn GetWinnerItemId(&self, pbwinneritemid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()> {
...
pub trait ISyncMergeTombstoneChange_Impl: windows_core::IUnknownImpl {
    fn GetWinnerItemId(&self, pbwinneritemid: *mut u8, pcbidsize: *mut u32) -> windows_result::Result<()>;
}
...
impl ISyncProviderConfigUI {
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn Init<P2>(&self, pguidinstanceid: *const windows_core::GUID, pguidcontenttype: *const windows_core::GUID, pconfigurationproperties: P2) -> windows_result::Result<()>
    where
        P2: windows_core::Param<super::super::UI::Shell::PropertiesSystem::IPropertyStore>,
    {
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn GetRegisteredProperties(&self) -> windows_result::Result<super::super::UI::Shell::PropertiesSystem::IPropertyStore> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn CreateAndRegisterNewSyncProvider<P1>(&self, hwndparent: Option<super::super::Foundation::HWND>, punkcontext: P1) -> windows_result::Result<ISyncProviderInfo>
    where
        P1: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn ModifySyncProvider<P1, P2>(&self, hwndparent: Option<super::super::Foundation::HWND>, punkcontext: P1, pproviderinfo: P2) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::IUnknown>,
...
pub trait ISyncProviderConfigUI_Impl: windows_core::IUnknownImpl {
    fn Init(&self, pguidinstanceid: *const windows_core::GUID, pguidcontenttype: *const windows_core::GUID, pconfigurationproperties: windows_core::Ref<super::super::UI::Shell::PropertiesSystem::IPropertyStore>) -> windows_result::Result<()>;
    fn GetRegisteredProperties(&self) -> windows_result::Result<super::super::UI::Shell::PropertiesSystem::IPropertyStore>;
    fn CreateAndRegisterNewSyncProvider(&self, hwndparent: super::super::Foundation::HWND, punkcontext: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<ISyncProviderInfo>;
    fn ModifySyncProvider(&self, hwndparent: super::super::Foundation::HWND, punkcontext: windows_core::Ref<windows_core::IUnknown>, pproviderinfo: windows_core::Ref<ISyncProviderInfo>) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
...
impl ISyncProviderConfigUIInfo {
    pub unsafe fn GetSyncProviderConfigUI(&self, dwclscontext: u32) -> windows_result::Result<ISyncProviderConfigUI> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISyncProviderConfigUIInfo_Impl: super::super::UI::Shell::PropertiesSystem::IPropertyStore_Impl {
    fn GetSyncProviderConfigUI(&self, dwclscontext: u32) -> windows_result::Result<ISyncProviderConfigUI>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant", feature = "Win32_UI_Shell_PropertiesSystem"))]
...
impl ISyncProviderInfo {
    pub unsafe fn GetSyncProvider(&self, dwclscontext: u32) -> windows_result::Result<IRegisteredSyncProvider> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISyncProviderInfo_Impl: super::super::UI::Shell::PropertiesSystem::IPropertyStore_Impl {
    fn GetSyncProvider(&self, dwclscontext: u32) -> windows_result::Result<IRegisteredSyncProvider>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant", feature = "Win32_UI_Shell_PropertiesSystem"))]
...
impl ISyncProviderRegistration {
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn CreateSyncProviderConfigUIRegistrationInstance(&self, pconfiguiconfig: *const SyncProviderConfigUIConfiguration) -> windows_result::Result<ISyncProviderConfigUIInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn UnregisterSyncProviderConfigUI(&self, pguidinstanceid: *const windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn EnumerateSyncProviderConfigUIs(&self, pguidcontenttype: Option<*const windows_core::GUID>, dwsupportedarchitecture: u32) -> windows_result::Result<IEnumSyncProviderConfigUIInfos> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn CreateSyncProviderRegistrationInstance(&self, pproviderconfiguration: *const SyncProviderConfiguration) -> windows_result::Result<ISyncProviderInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn UnregisterSyncProvider(&self, pguidinstanceid: *const windows_core::GUID) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).UnregisterSyncProvider)(windows_core::Interface::as_raw(self), pguidinstanceid).ok() }
    }
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn GetSyncProviderConfigUIInfoforProvider(&self, pguidproviderinstanceid: *const windows_core::GUID) -> windows_result::Result<ISyncProviderConfigUIInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumerateSyncProviders(&self, pguidcontenttype: Option<*const windows_core::GUID>, dwstateflagstofiltermask: u32, dwstateflagstofilter: u32, refproviderclsid: *const windows_core::GUID, dwsupportedarchitecture: u32) -> windows_result::Result<IEnumSyncProviderInfos> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn GetSyncProviderInfo(&self, pguidinstanceid: *const windows_core::GUID) -> windows_result::Result<ISyncProviderInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetSyncProviderFromInstanceId(&self, pguidinstanceid: *const windows_core::GUID, dwclscontext: u32) -> windows_result::Result<IRegisteredSyncProvider> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn GetSyncProviderConfigUIInfo(&self, pguidinstanceid: *const windows_core::GUID) -> windows_result::Result<ISyncProviderConfigUIInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetSyncProviderConfigUIFromInstanceId(&self, pguidinstanceid: *const windows_core::GUID, dwclscontext: u32) -> windows_result::Result<ISyncProviderConfigUI> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetSyncProviderState(&self, pguidinstanceid: *const windows_core::GUID) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetSyncProviderState(&self, pguidinstanceid: *const windows_core::GUID, dwstateflagsmask: u32, dwstateflags: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn RegisterForEvent(&self, phevent: *mut super::super::Foundation::HANDLE) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).RegisterForEvent)(windows_core::Interface::as_raw(self), phevent as _).ok() }
    }
    pub unsafe fn RevokeEvent(&self, hevent: super::super::Foundation::HANDLE) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).RevokeEvent)(windows_core::Interface::as_raw(self), hevent).ok() }
    }
    pub unsafe fn GetChange(&self, hevent: super::super::Foundation::HANDLE) -> windows_result::Result<ISyncRegistrationChange> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISyncProviderRegistration_Impl: windows_core::IUnknownImpl {
    fn CreateSyncProviderConfigUIRegistrationInstance(&self, pconfiguiconfig: *const SyncProviderConfigUIConfiguration) -> windows_result::Result<ISyncProviderConfigUIInfo>;
    fn UnregisterSyncProviderConfigUI(&self, pguidinstanceid: *const windows_core::GUID) -> windows_result::Result<()>;
    fn EnumerateSyncProviderConfigUIs(&self, pguidcontenttype: *const windows_core::GUID, dwsupportedarchitecture: u32) -> windows_result::Result<IEnumSyncProviderConfigUIInfos>;
    fn CreateSyncProviderRegistrationInstance(&self, pproviderconfiguration: *const SyncProviderConfiguration) -> windows_result::Result<ISyncProviderInfo>;
    fn UnregisterSyncProvider(&self, pguidinstanceid: *const windows_core::GUID) -> windows_result::Result<()>;
    fn GetSyncProviderConfigUIInfoforProvider(&self, pguidproviderinstanceid: *const windows_core::GUID) -> windows_result::Result<ISyncProviderConfigUIInfo>;
    fn EnumerateSyncProviders(&self, pguidcontenttype: *const windows_core::GUID, dwstateflagstofiltermask: u32, dwstateflagstofilter: u32, refproviderclsid: *const windows_core::GUID, dwsupportedarchitecture: u32) -> windows_result::Result<IEnumSyncProviderInfos>;
    fn GetSyncProviderInfo(&self, pguidinstanceid: *const windows_core::GUID) -> windows_result::Result<ISyncProviderInfo>;
    fn GetSyncProviderFromInstanceId(&self, pguidinstanceid: *const windows_core::GUID, dwclscontext: u32) -> windows_result::Result<IRegisteredSyncProvider>;
    fn GetSyncProviderConfigUIInfo(&self, pguidinstanceid: *const windows_core::GUID) -> windows_result::Result<ISyncProviderConfigUIInfo>;
    fn GetSyncProviderConfigUIFromInstanceId(&self, pguidinstanceid: *const windows_core::GUID, dwclscontext: u32) -> windows_result::Result<ISyncProviderConfigUI>;
    fn GetSyncProviderState(&self, pguidinstanceid: *const windows_core::GUID) -> windows_result::Result<u32>;
    fn SetSyncProviderState(&self, pguidinstanceid: *const windows_core::GUID, dwstateflagsmask: u32, dwstateflags: u32) -> windows_result::Result<()>;
    fn RegisterForEvent(&self, phevent: *mut super::super::Foundation::HANDLE) -> windows_result::Result<()>;
    fn RevokeEvent(&self, hevent: super::super::Foundation::HANDLE) -> windows_result::Result<()>;
    fn GetChange(&self, hevent: super::super::Foundation::HANDLE) -> windows_result::Result<ISyncRegistrationChange>;
}
#[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
...
impl ISyncRegistrationChange {
    pub unsafe fn GetEvent(&self) -> windows_result::Result<SYNC_REGISTRATION_EVENT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISyncRegistrationChange_Impl: windows_core::IUnknownImpl {
    fn GetEvent(&self) -> windows_result::Result<SYNC_REGISTRATION_EVENT>;
    fn GetInstanceId(&self) -> windows_result::Result<windows_core::GUID>;
}
...
impl ISyncSessionExtendedErrorInfo {
    pub unsafe fn GetSyncProviderWithError(&self) -> windows_result::Result<ISyncProvider> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISyncSessionExtendedErrorInfo_Impl: windows_core::IUnknownImpl {
    fn GetSyncProviderWithError(&self) -> windows_result::Result<ISyncProvider>;
}
...
impl ISyncSessionState {
    pub unsafe fn IsCanceled(&self, pfiscanceled: *mut windows_core::BOOL) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).IsCanceled)(windows_core::Interface::as_raw(self), pfiscanceled as _).ok() }
    }
    pub unsafe fn GetInfoForChangeApplication(&self, pbchangeapplierinfo: *mut u8, pcbchangeapplierinfo: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn LoadInfoFromChangeApplication(&self, pbchangeapplierinfo: *const u8, cbchangeapplierinfo: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetForgottenKnowledgeRecoveryRangeStart(&self, pbrangestart: *mut u8, pcbrangestart: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetForgottenKnowledgeRecoveryRangeEnd(&self, pbrangeend: *mut u8, pcbrangeend: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetForgottenKnowledgeRecoveryRange(&self, prange: *const SYNC_RANGE) -> windows_result::Result<()> {
...
pub trait ISyncSessionState_Impl: windows_core::IUnknownImpl {
    fn IsCanceled(&self, pfiscanceled: *mut windows_core::BOOL) -> windows_result::Result<()>;
    fn GetInfoForChangeApplication(&self, pbchangeapplierinfo: *mut u8, pcbchangeapplierinfo: *mut u32) -> windows_result::Result<()>;
    fn LoadInfoFromChangeApplication(&self, pbchangeapplierinfo: *const u8, cbchangeapplierinfo: u32) -> windows_result::Result<()>;
    fn GetForgottenKnowledgeRecoveryRangeStart(&self, pbrangestart: *mut u8, pcbrangestart: *mut u32) -> windows_result::Result<()>;
    fn GetForgottenKnowledgeRecoveryRangeEnd(&self, pbrangeend: *mut u8, pcbrangeend: *mut u32) -> windows_result::Result<()>;
    fn SetForgottenKnowledgeRecoveryRange(&self, prange: *const SYNC_RANGE) -> windows_result::Result<()>;
    fn OnProgress(&self, provider: SYNC_PROVIDER_ROLE, syncstage: SYNC_PROGRESS_STAGE, dwcompletedwork: u32, dwtotalwork: u32) -> windows_result::Result<()>;
}
...
impl ISyncSessionState2 {
    pub unsafe fn SetProviderWithError(&self, fself: bool) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetProviderWithError)(windows_core::Interface::as_raw(self), fself.into()).ok() }
    }
    pub unsafe fn GetSessionErrorStatus(&self, phrsessionerror: *mut windows_core::HRESULT) -> windows_result::Result<()> {
...
pub trait ISyncSessionState2_Impl: ISyncSessionState_Impl {
    fn SetProviderWithError(&self, fself: windows_core::BOOL) -> windows_result::Result<()>;
    fn GetSessionErrorStatus(&self, phrsessionerror: *mut windows_core::HRESULT) -> windows_result::Result<()>;
}
...
impl ISynchronousDataRetriever {
    ...
    pub unsafe fn LoadChangeData<P0>(&self, ploadchangecontext: P0) -> windows_result::Result<windows_core::IUnknown>
    where
        P0: windows_core::Param<ILoadChangeContext>,
    {
        unsafe {
...
pub trait ISynchronousDataRetriever_Impl: windows_core::IUnknownImpl {
    fn GetIdParameters(&self, pidparameters: *mut ID_PARAMETERS) -> windows_result::Result<()>;
    fn LoadChangeData(&self, ploadchangecontext: windows_core::Ref<ILoadChangeContext>) -> windows_result::Result<windows_core::IUnknown>;
}
