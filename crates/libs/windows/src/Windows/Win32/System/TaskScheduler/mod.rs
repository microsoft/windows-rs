...
impl IRegisteredTask {
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn RunEx<P0, P3>(&self, params: P0, flags: i32, sessionid: i32, user: P3) -> windows_core::Result<IRunningTask>
    where
        P0: windows_core::Param<super::Variant::VARIANT>,
...
impl ITaskFolder {
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn RegisterTask<P0, P1, P3, P4, P6>(&self, path: P0, xmltext: P1, flags: i32, userid: P3, password: P4, logontype: TASK_LOGON_TYPE, sddl: P6) -> windows_core::Result<IRegisteredTask>
    where
        P0: windows_core::Param<windows_core::BSTR>,
        P1: windows_core::Param<windows_core::BSTR>,
        P3: windows_core::Param<super::Variant::VARIANT>,
        P4: windows_core::Param<super::Variant::VARIANT>,
        P6: windows_core::Param<super::Variant::VARIANT>,
    {
        let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn RegisterTaskDefinition<P0, P1, P3, P4, P6>(&self, path: P0, pdefinition: P1, flags: i32, userid: P3, password: P4, logontype: TASK_LOGON_TYPE, sddl: P6) -> windows_core::Result<IRegisteredTask>
    where
        P0: windows_core::Param<windows_core::BSTR>,
