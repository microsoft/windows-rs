...
#[inline]
pub unsafe fn ApplicationRecoveryInProgress() -> Result<windows_core::BOOL, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetApplicationRestartSettings(hprocess: super::super::Foundation::HANDLE, pwzcommandline: Option<windows_core::PWSTR>, pcchsize: *mut u32, pdwflags: Option<*mut u32>) -> Result<(), windows_result::HRESULT> {
...
#[cfg(feature = "Win32_System_WindowsProgramming")]
#[inline]
pub unsafe fn RegisterApplicationRecoveryCallback(precoveycallback: super::WindowsProgramming::APPLICATION_RECOVERY_CALLBACK, pvparameter: Option<*const core::ffi::c_void>, dwpinginterval: u32, dwflags: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn RegisterApplicationRestart<P0>(pwzcommandline: P0, dwflags: REGISTER_APPLICATION_RESTART_FLAGS) -> Result<(), windows_result::HRESULT>
where
...
#[inline]
pub unsafe fn UnregisterApplicationRecoveryCallback() -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn UnregisterApplicationRestart() -> Result<(), windows_result::HRESULT> {
