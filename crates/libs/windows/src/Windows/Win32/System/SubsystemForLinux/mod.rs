#[inline]
pub unsafe fn WslConfigureDistribution(distributionname: windows_core::PCWSTR, defaultuid: u32, wsldistributionflags: WSL_DISTRIBUTION_FLAGS) -> windows_core::Result<()> {
    ...
    unsafe { WslConfigureDistribution(core::mem::transmute(distributionname), defaultuid, wsldistributionflags).ok() }
}
#[inline]
pub unsafe fn WslGetDistributionConfiguration(distributionname: windows_core::PCWSTR, distributionversion: *mut u32, defaultuid: *mut u32, wsldistributionflags: *mut WSL_DISTRIBUTION_FLAGS, defaultenvironmentvariables: *mut *mut windows_core::PSTR, defaultenvironmentvariablecount: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { WslGetDistributionConfiguration(core::mem::transmute(distributionname), distributionversion as _, defaultuid as _, wsldistributionflags as _, defaultenvironmentvariables as _, defaultenvironmentvariablecount as _).ok() }
}
#[inline]
pub unsafe fn WslIsDistributionRegistered(distributionname: windows_core::PCWSTR) -> windows_core::BOOL {
    ...
    unsafe { WslIsDistributionRegistered(core::mem::transmute(distributionname)) }
}
#[inline]
pub unsafe fn WslLaunch(distributionname: windows_core::PCWSTR, command: Option<windows_core::PCWSTR>, usecurrentworkingdirectory: bool, stdin: super::super::Foundation::HANDLE, stdout: super::super::Foundation::HANDLE, stderr: super::super::Foundation::HANDLE) -> windows_core::Result<super::super::Foundation::HANDLE> {
    ...
    unsafe {
        ...
        WslLaunch(core::mem::transmute(distributionname), command.unwrap_or(core::mem::zeroed()) as _, usecurrentworkingdirectory.into(), stdin, stdout, stderr, &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn WslLaunchInteractive(distributionname: windows_core::PCWSTR, command: Option<windows_core::PCWSTR>, usecurrentworkingdirectory: bool) -> windows_core::Result<u32> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        WslLaunchInteractive(core::mem::transmute(distributionname), command.unwrap_or(core::mem::zeroed()) as _, usecurrentworkingdirectory.into(), &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn WslRegisterDistribution(distributionname: windows_core::PCWSTR, targzfilename: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { WslRegisterDistribution(core::mem::transmute(distributionname), core::mem::transmute(targzfilename)).ok() }
}
#[inline]
pub unsafe fn WslUnregisterDistribution(distributionname: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { WslUnregisterDistribution(core::mem::transmute(distributionname)).ok() }
}
#[repr(transparent)]
