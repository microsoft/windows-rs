#[inline]
pub unsafe fn CallNamedPipeA(lpnamedpipename: windows_core::PCSTR, lpinbuffer: Option<*const core::ffi::c_void>, ninbuffersize: u32, lpoutbuffer: Option<*mut core::ffi::c_void>, noutbuffersize: u32, lpbytesread: *mut u32, ntimeout: u32) -> windows_core::Result<()> {
    ...
    unsafe { CallNamedPipeA(core::mem::transmute(lpnamedpipename), lpinbuffer.unwrap_or(core::mem::zeroed()) as _, ninbuffersize, lpoutbuffer.unwrap_or(core::mem::zeroed()) as _, noutbuffersize, lpbytesread as _, ntimeout).ok() }
}
#[inline]
pub unsafe fn CallNamedPipeW(lpnamedpipename: windows_core::PCWSTR, lpinbuffer: Option<*const core::ffi::c_void>, ninbuffersize: u32, lpoutbuffer: Option<*mut core::ffi::c_void>, noutbuffersize: u32, lpbytesread: *mut u32, ntimeout: u32) -> windows_core::BOOL {
    ...
    unsafe { CallNamedPipeW(core::mem::transmute(lpnamedpipename), lpinbuffer.unwrap_or(core::mem::zeroed()) as _, ninbuffersize, lpoutbuffer.unwrap_or(core::mem::zeroed()) as _, noutbuffersize, lpbytesread as _, ntimeout) }
}
...
#[inline]
pub unsafe fn CreateNamedPipeA(lpname: windows_core::PCSTR, dwopenmode: super::super::Storage::FileSystem::FILE_FLAGS_AND_ATTRIBUTES, dwpipemode: NAMED_PIPE_MODE, nmaxinstances: u32, noutbuffersize: u32, ninbuffersize: u32, ndefaulttimeout: u32, lpsecurityattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>) -> windows_core::Result<super::super::Foundation::HANDLE> {
    ...
    let result__ = unsafe { CreateNamedPipeA(core::mem::transmute(lpname), dwopenmode, dwpipemode, nmaxinstances, noutbuffersize, ninbuffersize, ndefaulttimeout, lpsecurityattributes.unwrap_or(core::mem::zeroed()) as _) };
    (!result__.is_invalid()).then_some(result__).ok_or_else(windows_core::Error::from_thread)
}
#[cfg(all(feature = "Win32_Security", feature = "Win32_Storage_FileSystem"))]
#[inline]
pub unsafe fn CreateNamedPipeW(lpname: windows_core::PCWSTR, dwopenmode: super::super::Storage::FileSystem::FILE_FLAGS_AND_ATTRIBUTES, dwpipemode: NAMED_PIPE_MODE, nmaxinstances: u32, noutbuffersize: u32, ninbuffersize: u32, ndefaulttimeout: u32, lpsecurityattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>) -> super::super::Foundation::HANDLE {
    ...
    unsafe { CreateNamedPipeW(core::mem::transmute(lpname), dwopenmode, dwpipemode, nmaxinstances, noutbuffersize, ninbuffersize, ndefaulttimeout, lpsecurityattributes.unwrap_or(core::mem::zeroed()) as _) }
}
...
#[inline]
pub unsafe fn WaitNamedPipeA(lpnamedpipename: windows_core::PCSTR, ntimeout: u32) -> windows_core::Result<()> {
    ...
    unsafe { WaitNamedPipeA(core::mem::transmute(lpnamedpipename), ntimeout).ok() }
}
#[inline]
pub unsafe fn WaitNamedPipeW(lpnamedpipename: windows_core::PCWSTR, ntimeout: u32) -> windows_core::BOOL {
    ...
    unsafe { WaitNamedPipeW(core::mem::transmute(lpnamedpipename), ntimeout) }
}
#[repr(transparent)]
