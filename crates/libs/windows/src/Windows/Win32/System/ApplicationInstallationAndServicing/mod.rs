#[inline]
pub unsafe fn ActivateActCtx(hactctx: Option<super::super::Foundation::HANDLE>, lpcookie: *mut usize) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn CreateActCtxA(pactctx: *const ACTCTXA) -> windows_result::Result<super::super::Foundation::HANDLE> {
...
#[inline]
pub unsafe fn CreateActCtxW(pactctx: *const ACTCTXW) -> windows_result::Result<super::super::Foundation::HANDLE> {
...
#[inline]
pub unsafe fn DeactivateActCtx(dwflags: u32, ulcookie: usize) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn FindActCtxSectionGuid(dwflags: u32, lpextensionguid: Option<*const windows_core::GUID>, ulsectionid: u32, lpguidtofind: Option<*const windows_core::GUID>, returneddata: *mut ACTCTX_SECTION_KEYED_DATA) -> windows_result::Result<()> {
...
#[cfg(feature = "Win32_System_WindowsProgramming")]
#[inline]
pub unsafe fn FindActCtxSectionStringA<P3>(dwflags: u32, lpextensionguid: Option<*const windows_core::GUID>, ulsectionid: u32, lpstringtofind: P3, returneddata: *mut ACTCTX_SECTION_KEYED_DATA) -> windows_result::Result<()>
where
    P3: windows_core::Param<windows_core::PCSTR>,
{
...
#[cfg(feature = "Win32_System_WindowsProgramming")]
#[inline]
pub unsafe fn FindActCtxSectionStringW<P3>(dwflags: u32, lpextensionguid: Option<*const windows_core::GUID>, ulsectionid: u32, lpstringtofind: P3, returneddata: *mut ACTCTX_SECTION_KEYED_DATA) -> windows_result::Result<()>
where
    P3: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn GetCurrentActCtx(lphactctx: *mut super::super::Foundation::HANDLE) -> windows_result::Result<()> {
...
#[cfg(feature = "Win32_Security_Cryptography")]
#[inline]
pub unsafe fn MsiGetFileSignatureInformationA<P0>(szsignedobjectpath: P0, dwflags: u32, ppccertcontext: *mut *mut super::super::Security::Cryptography::CERT_CONTEXT, pbhashdata: Option<*mut u8>, pcbhashdata: Option<*mut u32>) -> windows_result::Result<()>
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
...
#[cfg(feature = "Win32_Security_Cryptography")]
#[inline]
pub unsafe fn MsiGetFileSignatureInformationW<P0>(szsignedobjectpath: P0, dwflags: u32, ppccertcontext: *mut *mut super::super::Security::Cryptography::CERT_CONTEXT, pbhashdata: Option<*mut u8>, pcbhashdata: Option<*mut u32>) -> windows_result::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn QueryActCtxSettingsW<P2, P3>(dwflags: Option<u32>, hactctx: Option<super::super::Foundation::HANDLE>, settingsnamespace: P2, settingname: P3, pvbuffer: Option<windows_core::PWSTR>, dwbuffer: usize, pdwwrittenorrequired: Option<*mut usize>) -> windows_result::Result<()>
where
    P2: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn QueryActCtxW(dwflags: u32, hactctx: super::super::Foundation::HANDLE, pvsubinstance: Option<*const core::ffi::c_void>, ulinfoclass: u32, pvbuffer: Option<*mut core::ffi::c_void>, cbbuffer: usize, pcbwrittenorrequired: Option<*mut usize>) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn SfcGetNextProtectedFile(rpchandle: super::super::Foundation::HANDLE, protfiledata: *mut PROTECTED_FILE_DATA) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn ZombifyActCtx(hactctx: super::super::Foundation::HANDLE) -> windows_result::Result<()> {
...
impl IAssemblyCache {
    pub unsafe fn UninstallAssembly<P1>(&self, dwflags: u32, pszassemblyname: P1, prefdata: *mut FUSION_INSTALL_REFERENCE, puldisposition: *mut IASSEMBLYCACHE_UNINSTALL_DISPOSITION) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn QueryAssemblyInfo<P1>(&self, dwflags: QUERYASMINFO_FLAGS, pszassemblyname: P1, pasminfo: *mut ASSEMBLY_INFO) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn CreateAssemblyCacheItem<P3>(&self, dwflags: u32, pvreserved: *mut core::ffi::c_void, ppasmitem: *mut Option<IAssemblyCacheItem>, pszassemblyname: P3) -> windows_result::Result<()>
    where
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn Reserved(&self) -> windows_result::Result<windows_core::IUnknown> {
        unsafe {
    ...
    pub unsafe fn InstallAssembly<P1>(&self, dwflags: u32, pszmanifestfilepath: P1, prefdata: *mut FUSION_INSTALL_REFERENCE) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IAssemblyCache_Impl: windows_core::IUnknownImpl {
    fn UninstallAssembly(&self, dwflags: u32, pszassemblyname: &windows_core::PCWSTR, prefdata: *mut FUSION_INSTALL_REFERENCE, puldisposition: *mut IASSEMBLYCACHE_UNINSTALL_DISPOSITION) -> windows_result::Result<()>;
    fn QueryAssemblyInfo(&self, dwflags: QUERYASMINFO_FLAGS, pszassemblyname: &windows_core::PCWSTR, pasminfo: *mut ASSEMBLY_INFO) -> windows_result::Result<()>;
    fn CreateAssemblyCacheItem(&self, dwflags: u32, pvreserved: *mut core::ffi::c_void, ppasmitem: windows_core::OutRef<IAssemblyCacheItem>, pszassemblyname: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn Reserved(&self) -> windows_result::Result<windows_core::IUnknown>;
    fn InstallAssembly(&self, dwflags: u32, pszmanifestfilepath: &windows_core::PCWSTR, prefdata: *mut FUSION_INSTALL_REFERENCE) -> windows_result::Result<()>;
}
...
impl IAssemblyCacheItem {
    ...
    pub unsafe fn CreateStream<P1>(&self, dwflags: u32, pszstreamname: P1, dwformat: u32, dwformatflags: u32, ppistream: *mut Option<super::Com::IStream>, pulimaxsize: *mut u64) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn Commit(&self, dwflags: u32, puldisposition: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Commit)(windows_core::Interface::as_raw(self), dwflags, puldisposition as _).ok() }
    }
    pub unsafe fn AbortItem(&self) -> windows_result::Result<()> {
...
pub trait IAssemblyCacheItem_Impl: windows_core::IUnknownImpl {
    fn CreateStream(&self, dwflags: u32, pszstreamname: &windows_core::PCWSTR, dwformat: u32, dwformatflags: u32, ppistream: windows_core::OutRef<super::Com::IStream>, pulimaxsize: *mut u64) -> windows_result::Result<()>;
    fn Commit(&self, dwflags: u32, puldisposition: *mut u32) -> windows_result::Result<()>;
    fn AbortItem(&self) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IAssemblyName {
    pub unsafe fn SetProperty(&self, propertyid: u32, pvproperty: *mut core::ffi::c_void, cbproperty: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetProperty(&self, propertyid: u32, pvproperty: *mut core::ffi::c_void, pcbproperty: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Finalize(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Finalize)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn GetDisplayName(&self, szdisplayname: Option<windows_core::PWSTR>, pccdisplayname: *mut u32, dwdisplayflags: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Reserved<P1, P2, P3>(&self, refiid: *const windows_core::GUID, punkreserved1: P1, punkreserved2: P2, szreserved: P3, llreserved: i64, pvreserved: *mut core::ffi::c_void, cbreserved: u32, ppreserved: *mut *mut core::ffi::c_void) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetName(&self, lpcwbuffer: *mut u32, pwzname: Option<windows_core::PWSTR>) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetVersion(&self, pdwversionhi: *mut u32, pdwversionlow: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn IsEqual<P0>(&self, pname: P0, dwcmpflags: u32) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IAssemblyName> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IAssemblyName_Impl: windows_core::IUnknownImpl {
    fn SetProperty(&self, propertyid: u32, pvproperty: *mut core::ffi::c_void, cbproperty: u32) -> windows_result::Result<()>;
    fn GetProperty(&self, propertyid: u32, pvproperty: *mut core::ffi::c_void, pcbproperty: *mut u32) -> windows_result::Result<()>;
    fn Finalize(&self) -> windows_result::Result<()>;
    fn GetDisplayName(&self, szdisplayname: windows_core::PWSTR, pccdisplayname: *mut u32, dwdisplayflags: u32) -> windows_result::Result<()>;
    fn Reserved(&self, refiid: *const windows_core::GUID, punkreserved1: windows_core::Ref<windows_core::IUnknown>, punkreserved2: windows_core::Ref<windows_core::IUnknown>, szreserved: &windows_core::PCWSTR, llreserved: i64, pvreserved: *mut core::ffi::c_void, cbreserved: u32, ppreserved: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn GetName(&self, lpcwbuffer: *mut u32, pwzname: windows_core::PWSTR) -> windows_result::Result<()>;
    fn GetVersion(&self, pdwversionhi: *mut u32, pdwversionlow: *mut u32) -> windows_result::Result<()>;
    fn IsEqual(&self, pname: windows_core::Ref<IAssemblyName>, dwcmpflags: u32) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IAssemblyName>;
}
...
impl IEnumMsmDependency {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Next(&self, cfetch: u32, rgmsmdependencies: *mut Option<IMsmDependency>, pcfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Skip(&self, cskip: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumMsmDependency> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumMsmDependency_Impl: windows_core::IUnknownImpl {
    fn Next(&self, cfetch: u32, rgmsmdependencies: windows_core::OutRef<IMsmDependency>, pcfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, cskip: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumMsmDependency>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IEnumMsmError {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Next(&self, cfetch: u32, rgmsmerrors: *mut Option<IMsmError>, pcfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumMsmError> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumMsmError_Impl: windows_core::IUnknownImpl {
    fn Next(&self, cfetch: u32, rgmsmerrors: windows_core::OutRef<IMsmError>, pcfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, cskip: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumMsmError>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IEnumMsmString {
    pub unsafe fn Next(&self, cfetch: u32, rgbstrstrings: *mut windows_core::BSTR, pcfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumMsmString> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumMsmString_Impl: windows_core::IUnknownImpl {
    fn Next(&self, cfetch: u32, rgbstrstrings: *mut windows_core::BSTR, pcfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, cskip: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumMsmString>;
}
...
impl IMsmDependencies {
    pub unsafe fn get_Item(&self, item: i32) -> windows_result::Result<IMsmDependency> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Count(&self, count: *mut i32) -> windows_result::Result<()> {
...
pub trait IMsmDependencies_Impl: super::Com::IDispatch_Impl {
    fn get_Item(&self, item: i32) -> windows_result::Result<IMsmDependency>;
    fn Count(&self, count: *mut i32) -> windows_result::Result<()>;
...
#[cfg(feature = "Win32_System_Com")]
impl IMsmDependency {
    pub unsafe fn Module(&self, module: *mut windows_core::BSTR) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Module)(windows_core::Interface::as_raw(self), core::mem::transmute(module)).ok() }
    }
    pub unsafe fn Language(&self, language: *mut i16) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Language)(windows_core::Interface::as_raw(self), language as _).ok() }
    }
    pub unsafe fn Version(&self, version: *mut windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IMsmDependency_Impl: super::Com::IDispatch_Impl {
    fn Module(&self, module: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn Language(&self, language: *mut i16) -> windows_result::Result<()>;
    fn Version(&self, version: *mut windows_core::BSTR) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IMsmError {
    ...
    pub unsafe fn DatabaseKeys(&self) -> windows_result::Result<IMsmStrings> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ModuleTable(&self, errortable: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn ModuleKeys(&self) -> windows_result::Result<IMsmStrings> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IMsmError_Impl: super::Com::IDispatch_Impl {
    fn Type(&self, errortype: *mut msmErrorType) -> windows_result::Result<()>;
    fn Path(&self, errorpath: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn Language(&self, errorlanguage: *mut i16) -> windows_result::Result<()>;
    fn DatabaseTable(&self, errortable: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn DatabaseKeys(&self) -> windows_result::Result<IMsmStrings>;
    fn ModuleTable(&self, errortable: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn ModuleKeys(&self) -> windows_result::Result<IMsmStrings>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
impl IMsmError_Vtbl {
...
#[cfg(feature = "Win32_System_Com")]
impl IMsmErrors {
    pub unsafe fn get_Item(&self, item: i32) -> windows_result::Result<IMsmError> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_Item)(windows_core::Interface::as_raw(self), item, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IMsmErrors_Impl: super::Com::IDispatch_Impl {
    fn get_Item(&self, item: i32) -> windows_result::Result<IMsmError>;
    fn Count(&self, count: *mut i32) -> windows_result::Result<()>;
    fn _NewEnum(&self) -> windows_result::Result<windows_core::IUnknown>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
#[cfg(feature = "Win32_System_Com")]
impl IMsmGetFiles {
    pub unsafe fn ModuleFiles(&self) -> windows_result::Result<IMsmStrings> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IMsmGetFiles_Impl: super::Com::IDispatch_Impl {
    fn ModuleFiles(&self) -> windows_result::Result<IMsmStrings>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
#[cfg(feature = "Win32_System_Com")]
impl IMsmMerge {
    pub unsafe fn OpenDatabase(&self, path: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn OpenModule(&self, path: &windows_core::BSTR, language: i16) -> windows_result::Result<()> {
    ...
    pub unsafe fn Dependencies(&self) -> windows_result::Result<IMsmDependencies> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Merge(&self, feature: &windows_core::BSTR, redirectdir: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn Connect(&self, feature: &windows_core::BSTR) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Connect)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(feature)).ok() }
    }
    pub unsafe fn ExtractCAB(&self, filename: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn ExtractFiles(&self, path: &windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IMsmMerge_Impl: super::Com::IDispatch_Impl {
    fn OpenDatabase(&self, path: &windows_core::BSTR) -> windows_result::Result<()>;
    fn OpenModule(&self, path: &windows_core::BSTR, language: i16) -> windows_result::Result<()>;
    fn CloseDatabase(&self, commit: super::super::Foundation::VARIANT_BOOL) -> windows_result::Result<()>;
    fn CloseModule(&self) -> windows_result::Result<()>;
    fn OpenLog(&self, path: &windows_core::BSTR) -> windows_result::Result<()>;
    fn CloseLog(&self) -> windows_result::Result<()>;
    fn Log(&self, message: &windows_core::BSTR) -> windows_result::Result<()>;
    fn Errors(&self) -> windows_result::Result<IMsmErrors>;
    fn Dependencies(&self) -> windows_result::Result<IMsmDependencies>;
    fn Merge(&self, feature: &windows_core::BSTR, redirectdir: &windows_core::BSTR) -> windows_result::Result<()>;
    fn Connect(&self, feature: &windows_core::BSTR) -> windows_result::Result<()>;
    fn ExtractCAB(&self, filename: &windows_core::BSTR) -> windows_result::Result<()>;
    fn ExtractFiles(&self, path: &windows_core::BSTR) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
impl IMsmMerge_Vtbl {
...
#[cfg(feature = "Win32_System_Com")]
impl IMsmStrings {
    pub unsafe fn get_Item(&self, item: i32, r#return: *mut windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IMsmStrings_Impl: super::Com::IDispatch_Impl {
    fn get_Item(&self, item: i32, r#return: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn Count(&self, count: *mut i32) -> windows_result::Result<()>;
    fn _NewEnum(&self) -> windows_result::Result<windows_core::IUnknown>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IPMApplicationInfo {
    ...
    pub unsafe fn Version(&self, pversion: *mut windows_core::BSTR) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Version)(windows_core::Interface::as_raw(self), core::mem::transmute(pversion)).ok() }
    }
    pub unsafe fn get_InvocationInfo(&self, pimageurn: *mut windows_core::BSTR, pparameters: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn AppPlatMinorVersionLightUp(&self) -> windows_result::Result<u8> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn set_UpdateAvailable(&self, isupdateavailable: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn set_NotificationState(&self, isnotified: bool) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).set_NotificationState)(windows_core::Interface::as_raw(self), isnotified.into()).ok() }
    }
    pub unsafe fn set_IconPath(&self, appiconpath: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn set_UninstallableState(&self, isuninstallable: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn set_Title(&self, apptitle: &windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IPMApplicationInfo_Impl: windows_core::IUnknownImpl {
    fn ProductID(&self) -> windows_result::Result<windows_core::GUID>;
    fn InstanceID(&self) -> windows_result::Result<windows_core::GUID>;
    fn OfferID(&self) -> windows_result::Result<windows_core::GUID>;
    fn DefaultTask(&self, pdefaulttask: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn AppTitle(&self, papptitle: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn IconPath(&self, pappiconpath: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn NotificationState(&self) -> windows_result::Result<windows_core::BOOL>;
    fn AppInstallType(&self) -> windows_result::Result<PM_APPLICATION_INSTALL_TYPE>;
    fn State(&self) -> windows_result::Result<PM_APPLICATION_STATE>;
    fn IsRevoked(&self) -> windows_result::Result<windows_core::BOOL>;
    fn UpdateAvailable(&self) -> windows_result::Result<windows_core::BOOL>;
    fn InstallDate(&self) -> windows_result::Result<super::super::Foundation::FILETIME>;
    fn IsUninstallable(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsThemable(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsTrial(&self) -> windows_result::Result<windows_core::BOOL>;
    fn InstallPath(&self, pinstallpath: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn DataRoot(&self, pdataroot: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn Genre(&self) -> windows_result::Result<PM_APP_GENRE>;
    fn Publisher(&self, ppublisher: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn Author(&self, pauthor: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn Description(&self, pdescription: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn Version(&self, pversion: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn get_InvocationInfo(&self, pimageurn: *mut windows_core::BSTR, pparameters: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn AppPlatMajorVersion(&self) -> windows_result::Result<u8>;
    fn AppPlatMinorVersion(&self) -> windows_result::Result<u8>;
    fn PublisherID(&self) -> windows_result::Result<windows_core::GUID>;
    fn IsMultiCore(&self) -> windows_result::Result<windows_core::BOOL>;
    fn SID(&self, psid: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn AppPlatMajorVersionLightUp(&self) -> windows_result::Result<u8>;
    fn AppPlatMinorVersionLightUp(&self) -> windows_result::Result<u8>;
    fn set_UpdateAvailable(&self, isupdateavailable: windows_core::BOOL) -> windows_result::Result<()>;
    fn set_NotificationState(&self, isnotified: windows_core::BOOL) -> windows_result::Result<()>;
    fn set_IconPath(&self, appiconpath: &windows_core::BSTR) -> windows_result::Result<()>;
    fn set_UninstallableState(&self, isuninstallable: windows_core::BOOL) -> windows_result::Result<()>;
    fn IsPinableOnKidZone(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsOriginallyPreInstalled(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsInstallOnSD(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsOptoutOnSD(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsOptoutBackupRestore(&self) -> windows_result::Result<windows_core::BOOL>;
    fn set_EnterpriseDisabled(&self, isdisabled: windows_core::BOOL) -> windows_result::Result<()>;
    fn set_EnterpriseUninstallable(&self, isuninstallable: windows_core::BOOL) -> windows_result::Result<()>;
    fn EnterpriseDisabled(&self) -> windows_result::Result<windows_core::BOOL>;
    fn EnterpriseUninstallable(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsVisibleOnAppList(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsInboxApp(&self) -> windows_result::Result<windows_core::BOOL>;
    fn StorageID(&self) -> windows_result::Result<windows_core::GUID>;
    fn StartAppBlob(&self, pblob: *mut PM_STARTAPPBLOB) -> windows_result::Result<()>;
    fn IsMovable(&self) -> windows_result::Result<windows_core::BOOL>;
    fn DeploymentAppEnumerationHubFilter(&self) -> windows_result::Result<PM_TILE_HUBTYPE>;
    fn ModifiedDate(&self) -> windows_result::Result<super::super::Foundation::FILETIME>;
    fn IsOriginallyRestored(&self) -> windows_result::Result<windows_core::BOOL>;
    fn ShouldDeferMdilBind(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsFullyPreInstall(&self) -> windows_result::Result<windows_core::BOOL>;
    fn set_IsMdilMaintenanceNeeded(&self, fismdilmaintenanceneeded: windows_core::BOOL) -> windows_result::Result<()>;
    fn set_Title(&self, apptitle: &windows_core::BSTR) -> windows_result::Result<()>;
}
...
impl IPMApplicationInfoEnumerator {
    pub unsafe fn Next(&self) -> windows_result::Result<IPMApplicationInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPMApplicationInfoEnumerator_Impl: windows_core::IUnknownImpl {
    fn Next(&self) -> windows_result::Result<IPMApplicationInfo>;
}
...
impl IPMBackgroundServiceAgentInfo {
    ...
    pub unsafe fn TaskID(&self, ptaskid: *mut windows_core::BSTR) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).TaskID)(windows_core::Interface::as_raw(self), core::mem::transmute(ptaskid)).ok() }
    }
    pub unsafe fn BSAID(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BSAID)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn BGSpecifier(&self, pbgspecifier: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn IsLaunchOnBoot(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsLaunchOnBoot)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn set_IsScheduled(&self, isscheduled: bool) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).set_IsScheduled)(windows_core::Interface::as_raw(self), isscheduled.into()).ok() }
    }
    pub unsafe fn set_IsScheduleAllowed(&self, isscheduleallowed: bool) -> windows_result::Result<()> {
...
pub trait IPMBackgroundServiceAgentInfo_Impl: windows_core::IUnknownImpl {
    fn ProductID(&self) -> windows_result::Result<windows_core::GUID>;
    fn TaskID(&self, ptaskid: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn BSAID(&self) -> windows_result::Result<u32>;
    fn BGSpecifier(&self, pbgspecifier: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn BGName(&self, pbgname: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn BGSource(&self, pbgsource: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn BGType(&self, pbgtype: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn IsPeriodic(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsScheduled(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsScheduleAllowed(&self) -> windows_result::Result<windows_core::BOOL>;
    fn Description(&self, pdescription: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn IsLaunchOnBoot(&self) -> windows_result::Result<windows_core::BOOL>;
    fn set_IsScheduled(&self, isscheduled: windows_core::BOOL) -> windows_result::Result<()>;
    fn set_IsScheduleAllowed(&self, isscheduleallowed: windows_core::BOOL) -> windows_result::Result<()>;
}
...
impl IPMBackgroundServiceAgentInfoEnumerator {
    pub unsafe fn Next(&self) -> windows_result::Result<IPMBackgroundServiceAgentInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IPMBackgroundServiceAgentInfoEnumerator_Impl: windows_core::IUnknownImpl {
    fn Next(&self) -> windows_result::Result<IPMBackgroundServiceAgentInfo>;
}
...
pub trait IPMBackgroundWorkerInfo_Impl: windows_core::IUnknownImpl {
    ...
    fn TaskID(&self, ptaskid: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn BGName(&self, pbgname: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn MaxStartupLatency(&self) -> windows_result::Result<u32>;
    fn ExpectedRuntime(&self) -> windows_result::Result<u32>;
    fn IsBootWorker(&self) -> windows_result::Result<windows_core::BOOL>;
}
...
impl IPMBackgroundWorkerInfoEnumerator {
    pub unsafe fn Next(&self) -> windows_result::Result<IPMBackgroundWorkerInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IPMBackgroundWorkerInfoEnumerator_Impl: windows_core::IUnknownImpl {
    fn Next(&self) -> windows_result::Result<IPMBackgroundWorkerInfo>;
}
...
impl IPMDeploymentManager {
    pub unsafe fn ReportDownloadBegin(&self, productid: windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn ReportDownloadProgress(&self, productid: windows_core::GUID, usprogress: u16) -> windows_result::Result<()> {
    ...
    pub unsafe fn ReportDownloadComplete(&self, productid: windows_core::GUID, hrresult: windows_core::HRESULT) -> windows_result::Result<()> {
    ...
    pub unsafe fn BeginInstall(&self, pinstallinfo: *const PM_INSTALLINFO) -> windows_result::Result<()> {
    ...
    pub unsafe fn BeginUpdate(&self, pupdateinfo: *const PM_UPDATEINFO) -> windows_result::Result<()> {
    ...
    pub unsafe fn BeginDeployPackage(&self, pinstallinfo: *const PM_INSTALLINFO) -> windows_result::Result<()> {
    ...
    pub unsafe fn BeginUpdateDeployedPackageLegacy(&self, pupdateinfo: *const PM_UPDATEINFO_LEGACY) -> windows_result::Result<()> {
    ...
    pub unsafe fn BeginUninstall(&self, productid: windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn BeginEnterpriseAppInstall(&self, pinstallinfo: *const PM_INSTALLINFO) -> windows_result::Result<()> {
    ...
    pub unsafe fn BeginEnterpriseAppUpdate(&self, pupdateinfo: *const PM_UPDATEINFO) -> windows_result::Result<()> {
    ...
    pub unsafe fn BeginUpdateLicense(&self, productid: windows_core::GUID, offerid: windows_core::GUID, pblicense: &[u8]) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetLicenseChallengeByProductID(&self, productid: windows_core::GUID, ppbchallenge: *mut *mut u8, pcblicense: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn RevokeLicense(&self, productid: windows_core::GUID) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn RebindMdilBinaries(&self, productid: windows_core::GUID, filenames: *const super::Com::SAFEARRAY) -> windows_result::Result<()> {
    ...
    pub unsafe fn RebindAllMdilBinaries(&self, productid: windows_core::GUID, instanceid: windows_core::GUID) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn RegenerateXbf(&self, productid: windows_core::GUID, assemblypaths: *const super::Com::SAFEARRAY) -> windows_result::Result<()> {
    ...
    pub unsafe fn GenerateXbfForCurrentLocale(&self, productid: windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn BeginProvision(&self, productid: windows_core::GUID, xmlpath: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn BeginDeprovision(&self, productid: windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn ReindexSQLCEDatabases(&self, productid: windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetApplicationsNeedMaintenance(&self, requiredmaintenanceoperations: u32) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn UpdateChamberProfile(&self, productid: windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn EnterprisePolicyIsApplicationAllowed<P1>(&self, productid: windows_core::GUID, publishername: P1) -> windows_result::Result<windows_core::BOOL>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn BeginUpdateDeployedPackage(&self, pupdateinfo: *const PM_UPDATEINFO) -> windows_result::Result<()> {
    ...
    pub unsafe fn ReportRestoreCancelled(&self, productid: windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn ResolveResourceString<P0>(&self, resourcestring: P0, presolvedresourcestring: *mut windows_core::BSTR) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn UpdateCapabilitiesForModernApps(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).UpdateCapabilitiesForModernApps)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn ReportDownloadStatusUpdate(&self, productid: windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn BeginUninstallWithOptions(&self, productid: windows_core::GUID, removaloptions: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn BindDeferredMdilBinaries(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).BindDeferredMdilBinaries)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn GenerateXamlLightupXbfForCurrentLocale(&self, packagefamilyname: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn AddLicenseForAppx(&self, productid: windows_core::GUID, pblicense: &[u8], pbplayreadyheader: Option<&[u8]>) -> windows_result::Result<()> {
    ...
    pub unsafe fn FixJunctionsForAppsOnSDCard(&self) -> windows_result::Result<()> {
...
pub trait IPMDeploymentManager_Impl: windows_core::IUnknownImpl {
    fn ReportDownloadBegin(&self, productid: &windows_core::GUID) -> windows_result::Result<()>;
    fn ReportDownloadProgress(&self, productid: &windows_core::GUID, usprogress: u16) -> windows_result::Result<()>;
    fn ReportDownloadComplete(&self, productid: &windows_core::GUID, hrresult: windows_core::HRESULT) -> windows_result::Result<()>;
    fn BeginInstall(&self, pinstallinfo: *const PM_INSTALLINFO) -> windows_result::Result<()>;
    fn BeginUpdate(&self, pupdateinfo: *const PM_UPDATEINFO) -> windows_result::Result<()>;
    fn BeginDeployPackage(&self, pinstallinfo: *const PM_INSTALLINFO) -> windows_result::Result<()>;
    fn BeginUpdateDeployedPackageLegacy(&self, pupdateinfo: *const PM_UPDATEINFO_LEGACY) -> windows_result::Result<()>;
    fn BeginUninstall(&self, productid: &windows_core::GUID) -> windows_result::Result<()>;
    fn BeginEnterpriseAppInstall(&self, pinstallinfo: *const PM_INSTALLINFO) -> windows_result::Result<()>;
    fn BeginEnterpriseAppUpdate(&self, pupdateinfo: *const PM_UPDATEINFO) -> windows_result::Result<()>;
    fn BeginUpdateLicense(&self, productid: &windows_core::GUID, offerid: &windows_core::GUID, pblicense: *const u8, cblicense: u32) -> windows_result::Result<()>;
    fn GetLicenseChallenge(&self, packagepath: &windows_core::BSTR, ppbchallenge: *mut *mut u8, pcbchallenge: *mut u32, ppbkid: *mut *mut u8, pcbkid: *mut u32, ppbdeviceid: *mut *mut u8, pcbdeviceid: *mut u32, ppbsaltvalue: *mut *mut u8, pcbsaltvalue: *mut u32, ppbkgvvalue: *mut *mut u8, pcbkgvvalue: *mut u32) -> windows_result::Result<()>;
    fn GetLicenseChallengeByProductID(&self, productid: &windows_core::GUID, ppbchallenge: *mut *mut u8, pcblicense: *mut u32) -> windows_result::Result<()>;
    fn GetLicenseChallengeByProductID2(&self, productid: &windows_core::GUID, ppbchallenge: *mut *mut u8, pcblicense: *mut u32, ppbkid: *mut *mut u8, pcbkid: *mut u32, ppbdeviceid: *mut *mut u8, pcbdeviceid: *mut u32, ppbsaltvalue: *mut *mut u8, pcbsaltvalue: *mut u32, ppbkgvvalue: *mut *mut u8, pcbkgvvalue: *mut u32) -> windows_result::Result<()>;
    fn RevokeLicense(&self, productid: &windows_core::GUID) -> windows_result::Result<()>;
    fn RebindMdilBinaries(&self, productid: &windows_core::GUID, filenames: *const super::Com::SAFEARRAY) -> windows_result::Result<()>;
    fn RebindAllMdilBinaries(&self, productid: &windows_core::GUID, instanceid: &windows_core::GUID) -> windows_result::Result<()>;
    fn RegenerateXbf(&self, productid: &windows_core::GUID, assemblypaths: *const super::Com::SAFEARRAY) -> windows_result::Result<()>;
    fn GenerateXbfForCurrentLocale(&self, productid: &windows_core::GUID) -> windows_result::Result<()>;
    fn BeginProvision(&self, productid: &windows_core::GUID, xmlpath: &windows_core::BSTR) -> windows_result::Result<()>;
    fn BeginDeprovision(&self, productid: &windows_core::GUID) -> windows_result::Result<()>;
    fn ReindexSQLCEDatabases(&self, productid: &windows_core::GUID) -> windows_result::Result<()>;
    fn SetApplicationsNeedMaintenance(&self, requiredmaintenanceoperations: u32) -> windows_result::Result<u32>;
    fn UpdateChamberProfile(&self, productid: &windows_core::GUID) -> windows_result::Result<()>;
    fn EnterprisePolicyIsApplicationAllowed(&self, productid: &windows_core::GUID, publishername: &windows_core::PCWSTR) -> windows_result::Result<windows_core::BOOL>;
    fn BeginUpdateDeployedPackage(&self, pupdateinfo: *const PM_UPDATEINFO) -> windows_result::Result<()>;
    fn ReportRestoreCancelled(&self, productid: &windows_core::GUID) -> windows_result::Result<()>;
    fn ResolveResourceString(&self, resourcestring: &windows_core::PCWSTR, presolvedresourcestring: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn UpdateCapabilitiesForModernApps(&self) -> windows_result::Result<()>;
    fn ReportDownloadStatusUpdate(&self, productid: &windows_core::GUID) -> windows_result::Result<()>;
    fn BeginUninstallWithOptions(&self, productid: &windows_core::GUID, removaloptions: u32) -> windows_result::Result<()>;
    fn BindDeferredMdilBinaries(&self) -> windows_result::Result<()>;
    fn GenerateXamlLightupXbfForCurrentLocale(&self, packagefamilyname: &windows_core::BSTR) -> windows_result::Result<()>;
    fn AddLicenseForAppx(&self, productid: &windows_core::GUID, pblicense: *const u8, cblicense: u32, pbplayreadyheader: *const u8, cbplayreadyheader: u32) -> windows_result::Result<()>;
    fn FixJunctionsForAppsOnSDCard(&self) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IPMEnumerationManager {
    pub unsafe fn get_AllApplications(&self, ppappenum: *mut Option<IPMApplicationInfoEnumerator>, filter: &PM_ENUM_FILTER) -> windows_result::Result<()> {
    ...
    pub unsafe fn get_AllTiles(&self, pptileenum: *mut Option<IPMTileInfoEnumerator>, filter: &PM_ENUM_FILTER) -> windows_result::Result<()> {
    ...
    pub unsafe fn get_AllTasks(&self, pptaskenum: *mut Option<IPMTaskInfoEnumerator>, filter: &PM_ENUM_FILTER) -> windows_result::Result<()> {
    ...
    pub unsafe fn get_AllExtensions(&self, ppextensionenum: *mut Option<IPMExtensionInfoEnumerator>, filter: &PM_ENUM_FILTER) -> windows_result::Result<()> {
    ...
    pub unsafe fn get_AllBackgroundServiceAgents(&self, ppbsaenum: *mut Option<IPMBackgroundServiceAgentInfoEnumerator>, filter: &PM_ENUM_FILTER) -> windows_result::Result<()> {
    ...
    pub unsafe fn get_AllBackgroundWorkers(&self, ppbswenum: *mut Option<IPMBackgroundWorkerInfoEnumerator>, filter: &PM_ENUM_FILTER) -> windows_result::Result<()> {
    ...
    pub unsafe fn get_ApplicationInfo(&self, productid: windows_core::GUID) -> windows_result::Result<IPMApplicationInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn get_TileInfo(&self, productid: windows_core::GUID, tileid: &windows_core::BSTR) -> windows_result::Result<IPMTileInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn get_TaskInfo(&self, productid: windows_core::GUID, taskid: &windows_core::BSTR) -> windows_result::Result<IPMTaskInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn get_TaskInfoEx<P1>(&self, productid: windows_core::GUID, taskid: P1) -> windows_result::Result<IPMTaskInfo>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn get_BackgroundServiceAgentInfo(&self, bsaid: u32) -> windows_result::Result<IPMBackgroundServiceAgentInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AllLiveTileJobs(&self) -> windows_result::Result<IPMLiveTileJobInfoEnumerator> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn get_LiveTileJob(&self, productid: windows_core::GUID, tileid: &windows_core::BSTR, recurrencetype: PM_LIVETILE_RECURRENCE_TYPE) -> windows_result::Result<IPMLiveTileJobInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn get_ApplicationInfoExternal(&self, productid: windows_core::GUID) -> windows_result::Result<IPMApplicationInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn get_FileHandlerGenericLogo(&self, filetype: &windows_core::BSTR, logosize: PM_LOGO_SIZE, plogo: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn get_ApplicationInfoFromAccessClaims(&self, sysappid0: &windows_core::BSTR, sysappid1: &windows_core::BSTR) -> windows_result::Result<IPMApplicationInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn get_StartTileEnumeratorBlob(&self, filter: &PM_ENUM_FILTER, pctiles: *mut u32, pptileblobs: *mut *mut PM_STARTTILEBLOB) -> windows_result::Result<()> {
    ...
    pub unsafe fn get_StartAppEnumeratorBlob(&self, filter: &PM_ENUM_FILTER, pcapps: *mut u32, ppappblobs: *mut *mut PM_STARTAPPBLOB) -> windows_result::Result<()> {
...
pub trait IPMEnumerationManager_Impl: windows_core::IUnknownImpl {
    fn get_AllApplications(&self, ppappenum: windows_core::OutRef<IPMApplicationInfoEnumerator>, filter: &PM_ENUM_FILTER) -> windows_result::Result<()>;
    fn get_AllTiles(&self, pptileenum: windows_core::OutRef<IPMTileInfoEnumerator>, filter: &PM_ENUM_FILTER) -> windows_result::Result<()>;
    fn get_AllTasks(&self, pptaskenum: windows_core::OutRef<IPMTaskInfoEnumerator>, filter: &PM_ENUM_FILTER) -> windows_result::Result<()>;
    fn get_AllExtensions(&self, ppextensionenum: windows_core::OutRef<IPMExtensionInfoEnumerator>, filter: &PM_ENUM_FILTER) -> windows_result::Result<()>;
    fn get_AllBackgroundServiceAgents(&self, ppbsaenum: windows_core::OutRef<IPMBackgroundServiceAgentInfoEnumerator>, filter: &PM_ENUM_FILTER) -> windows_result::Result<()>;
    fn get_AllBackgroundWorkers(&self, ppbswenum: windows_core::OutRef<IPMBackgroundWorkerInfoEnumerator>, filter: &PM_ENUM_FILTER) -> windows_result::Result<()>;
    fn get_ApplicationInfo(&self, productid: &windows_core::GUID) -> windows_result::Result<IPMApplicationInfo>;
    fn get_TileInfo(&self, productid: &windows_core::GUID, tileid: &windows_core::BSTR) -> windows_result::Result<IPMTileInfo>;
    fn get_TaskInfo(&self, productid: &windows_core::GUID, taskid: &windows_core::BSTR) -> windows_result::Result<IPMTaskInfo>;
    fn get_TaskInfoEx(&self, productid: &windows_core::GUID, taskid: &windows_core::PCWSTR) -> windows_result::Result<IPMTaskInfo>;
    fn get_BackgroundServiceAgentInfo(&self, bsaid: u32) -> windows_result::Result<IPMBackgroundServiceAgentInfo>;
    fn AllLiveTileJobs(&self) -> windows_result::Result<IPMLiveTileJobInfoEnumerator>;
    fn get_LiveTileJob(&self, productid: &windows_core::GUID, tileid: &windows_core::BSTR, recurrencetype: PM_LIVETILE_RECURRENCE_TYPE) -> windows_result::Result<IPMLiveTileJobInfo>;
    fn get_ApplicationInfoExternal(&self, productid: &windows_core::GUID) -> windows_result::Result<IPMApplicationInfo>;
    fn get_FileHandlerGenericLogo(&self, filetype: &windows_core::BSTR, logosize: PM_LOGO_SIZE, plogo: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn get_ApplicationInfoFromAccessClaims(&self, sysappid0: &windows_core::BSTR, sysappid1: &windows_core::BSTR) -> windows_result::Result<IPMApplicationInfo>;
    fn get_StartTileEnumeratorBlob(&self, filter: &PM_ENUM_FILTER, pctiles: *mut u32, pptileblobs: *mut *mut PM_STARTTILEBLOB) -> windows_result::Result<()>;
    fn get_StartAppEnumeratorBlob(&self, filter: &PM_ENUM_FILTER, pcapps: *mut u32, ppappblobs: *mut *mut PM_STARTAPPBLOB) -> windows_result::Result<()>;
}
...
impl IPMExtensionCachedFileUpdaterInfo {
    pub unsafe fn SupportsUpdates(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPMExtensionCachedFileUpdaterInfo_Impl: windows_core::IUnknownImpl {
    fn SupportsUpdates(&self) -> windows_result::Result<windows_core::BOOL>;
}
...
impl IPMExtensionContractInfo {
    pub unsafe fn get_InvocationInfo(&self, paumid: *mut windows_core::BSTR, pargs: *mut windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IPMExtensionContractInfo_Impl: windows_core::IUnknownImpl {
    fn get_InvocationInfo(&self, paumid: *mut windows_core::BSTR, pargs: *mut windows_core::BSTR) -> windows_result::Result<()>;
}
...
impl IPMExtensionFileExtensionInfo {
    pub unsafe fn Name(&self, pname: *mut windows_core::BSTR) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Name)(windows_core::Interface::as_raw(self), core::mem::transmute(pname)).ok() }
    }
    pub unsafe fn DisplayName(&self, pdisplayname: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn get_Logo(&self, logosize: PM_LOGO_SIZE, plogo: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn get_ContentType(&self, filetype: &windows_core::BSTR, pcontenttype: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn get_FileType(&self, contenttype: &windows_core::BSTR, pfiletype: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn get_AllFileTypes(&self, pcbtypes: *mut u32, pptypes: *mut *mut windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IPMExtensionFileExtensionInfo_Impl: windows_core::IUnknownImpl {
    fn Name(&self, pname: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn DisplayName(&self, pdisplayname: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn get_Logo(&self, logosize: PM_LOGO_SIZE, plogo: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn get_ContentType(&self, filetype: &windows_core::BSTR, pcontenttype: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn get_FileType(&self, contenttype: &windows_core::BSTR, pfiletype: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn get_InvocationInfo(&self, pimageurn: *mut windows_core::BSTR, pparameters: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn get_AllFileTypes(&self, pcbtypes: *mut u32, pptypes: *mut *mut windows_core::BSTR) -> windows_result::Result<()>;
}
...
impl IPMExtensionFileOpenPickerInfo {
    pub unsafe fn get_AllFileTypes(&self, pctypes: *mut u32, pptypes: *mut *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn SupportsAllFileTypes(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPMExtensionFileOpenPickerInfo_Impl: windows_core::IUnknownImpl {
    fn get_AllFileTypes(&self, pctypes: *mut u32, pptypes: *mut *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn SupportsAllFileTypes(&self) -> windows_result::Result<windows_core::BOOL>;
}
...
impl IPMExtensionInfo {
    pub unsafe fn SupplierPID(&self) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SupplierPID)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SupplierTaskID(&self, psuppliertid: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn Title(&self, ptitle: *mut windows_core::BSTR) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Title)(windows_core::Interface::as_raw(self), core::mem::transmute(ptitle)).ok() }
    }
    pub unsafe fn IconPath(&self, piconpath: *mut windows_core::BSTR) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).IconPath)(windows_core::Interface::as_raw(self), core::mem::transmute(piconpath)).ok() }
    }
    pub unsafe fn ExtraFile(&self, pfilepath: *mut windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IPMExtensionInfo_Impl: windows_core::IUnknownImpl {
    fn SupplierPID(&self) -> windows_result::Result<windows_core::GUID>;
    fn SupplierTaskID(&self, psuppliertid: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn Title(&self, ptitle: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn IconPath(&self, piconpath: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn ExtraFile(&self, pfilepath: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn get_InvocationInfo(&self, pimageurn: *mut windows_core::BSTR, pparameters: *mut windows_core::BSTR) -> windows_result::Result<()>;
}
...
impl IPMExtensionInfoEnumerator {
    pub unsafe fn Next(&self) -> windows_result::Result<IPMExtensionInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IPMExtensionInfoEnumerator_Impl: windows_core::IUnknownImpl {
    fn Next(&self) -> windows_result::Result<IPMExtensionInfo>;
}
...
impl IPMExtensionProtocolInfo {
    pub unsafe fn Protocol(&self, pprotocol: *mut windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IPMExtensionProtocolInfo_Impl: windows_core::IUnknownImpl {
    fn Protocol(&self, pprotocol: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn get_InvocationInfo(&self, pimageurn: *mut windows_core::BSTR, pparameters: *mut windows_core::BSTR) -> windows_result::Result<()>;
}
...
impl IPMExtensionShareTargetInfo {
    ...
    pub unsafe fn get_AllDataFormats(&self, pcdataformats: *mut u32, ppdataformats: *mut *mut windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IPMExtensionShareTargetInfo_Impl: windows_core::IUnknownImpl {
    fn get_AllFileTypes(&self, pctypes: *mut u32, pptypes: *mut *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn get_AllDataFormats(&self, pcdataformats: *mut u32, ppdataformats: *mut *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn SupportsAllFileTypes(&self) -> windows_result::Result<windows_core::BOOL>;
}
...
impl IPMLiveTileJobInfo {
    ...
    pub unsafe fn TileID(&self, ptileid: *mut windows_core::BSTR) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).TileID)(windows_core::Interface::as_raw(self), core::mem::transmute(ptileid)).ok() }
    }
    pub unsafe fn NextSchedule(&self) -> windows_result::Result<super::super::Foundation::FILETIME> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).NextSchedule)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn set_NextSchedule(&self, ftnextschedule: super::super::Foundation::FILETIME) -> windows_result::Result<()> {
    ...
    pub unsafe fn StartSchedule(&self) -> windows_result::Result<super::super::Foundation::FILETIME> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).StartSchedule)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn set_StartSchedule(&self, ftstartschedule: super::super::Foundation::FILETIME) -> windows_result::Result<()> {
    ...
    pub unsafe fn set_TileXML(&self, ptilexml: &[u8]) -> windows_result::Result<()> {
    ...
    pub unsafe fn get_UrlXML(&self, purlxml: *mut *mut u8, pcburlxml: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).get_UrlXML)(windows_core::Interface::as_raw(self), purlxml as _, pcburlxml as _).ok() }
    }
    pub unsafe fn set_UrlXML(&self, purlxml: &[u8]) -> windows_result::Result<()> {
...
pub trait IPMLiveTileJobInfo_Impl: windows_core::IUnknownImpl {
    fn ProductID(&self) -> windows_result::Result<windows_core::GUID>;
    fn TileID(&self, ptileid: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn NextSchedule(&self) -> windows_result::Result<super::super::Foundation::FILETIME>;
    fn set_NextSchedule(&self, ftnextschedule: &super::super::Foundation::FILETIME) -> windows_result::Result<()>;
    fn StartSchedule(&self) -> windows_result::Result<super::super::Foundation::FILETIME>;
    fn set_StartSchedule(&self, ftstartschedule: &super::super::Foundation::FILETIME) -> windows_result::Result<()>;
    fn IntervalDuration(&self) -> windows_result::Result<u32>;
    fn set_IntervalDuration(&self, ulintervalduration: u32) -> windows_result::Result<()>;
    fn RunForever(&self) -> windows_result::Result<windows_core::BOOL>;
    fn set_RunForever(&self, frunforever: windows_core::BOOL) -> windows_result::Result<()>;
    fn MaxRunCount(&self) -> windows_result::Result<u32>;
    fn set_MaxRunCount(&self, ulmaxruncount: u32) -> windows_result::Result<()>;
    fn RunCount(&self) -> windows_result::Result<u32>;
    fn set_RunCount(&self, ulruncount: u32) -> windows_result::Result<()>;
    fn RecurrenceType(&self) -> windows_result::Result<u32>;
    fn set_RecurrenceType(&self, ulrecurrencetype: u32) -> windows_result::Result<()>;
    fn get_TileXML(&self, ptilexml: *mut *mut u8, pcbtilexml: *mut u32) -> windows_result::Result<()>;
    fn set_TileXML(&self, ptilexml: *const u8, cbtilexml: u32) -> windows_result::Result<()>;
    fn get_UrlXML(&self, purlxml: *mut *mut u8, pcburlxml: *mut u32) -> windows_result::Result<()>;
    fn set_UrlXML(&self, purlxml: *const u8, cburlxml: u32) -> windows_result::Result<()>;
    fn AttemptCount(&self) -> windows_result::Result<u32>;
    fn set_AttemptCount(&self, ulattemptcount: u32) -> windows_result::Result<()>;
    fn DownloadState(&self) -> windows_result::Result<u32>;
    fn set_DownloadState(&self, uldownloadstate: u32) -> windows_result::Result<()>;
}
...
impl IPMLiveTileJobInfoEnumerator {
    pub unsafe fn Next(&self) -> windows_result::Result<IPMLiveTileJobInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IPMLiveTileJobInfoEnumerator_Impl: windows_core::IUnknownImpl {
    fn Next(&self) -> windows_result::Result<IPMLiveTileJobInfo>;
}
...
impl IPMTaskInfo {
    ...
    pub unsafe fn NavigationPage(&self, pnavigationpage: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn ImagePath(&self, pimagepath: *mut windows_core::BSTR) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ImagePath)(windows_core::Interface::as_raw(self), core::mem::transmute(pimagepath)).ok() }
    }
    pub unsafe fn ImageParams(&self, pimageparams: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn InstallRootFolder(&self, pinstallrootfolder: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn DataRootFolder(&self, pdatarootfolder: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn BitsPerPixel(&self) -> windows_result::Result<u16> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BitsPerPixel)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SuppressesDehydration(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SuppressesDehydration)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn BackgroundExecutionAbilities(&self, pbackgroundexecutionabilities: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn IsOptedForExtendedMem(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPMTaskInfo_Impl: windows_core::IUnknownImpl {
    fn ProductID(&self) -> windows_result::Result<windows_core::GUID>;
    fn TaskID(&self, ptaskid: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn NavigationPage(&self, pnavigationpage: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn TaskTransition(&self) -> windows_result::Result<PM_TASK_TRANSITION>;
    fn RuntimeType(&self) -> windows_result::Result<PACKMAN_RUNTIME>;
    fn ActivationPolicy(&self) -> windows_result::Result<PM_ACTIVATION_POLICY>;
    fn TaskType(&self) -> windows_result::Result<PM_TASK_TYPE>;
    fn get_InvocationInfo(&self, pimageurn: *mut windows_core::BSTR, pparameters: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn ImagePath(&self, pimagepath: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn ImageParams(&self, pimageparams: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn InstallRootFolder(&self, pinstallrootfolder: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn DataRootFolder(&self, pdatarootfolder: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn IsSingleInstanceHost(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsInteropEnabled(&self) -> windows_result::Result<windows_core::BOOL>;
    fn ApplicationState(&self) -> windows_result::Result<PM_APPLICATION_STATE>;
    fn InstallType(&self) -> windows_result::Result<PM_APPLICATION_INSTALL_TYPE>;
    fn get_Version(&self, ptargetmajorversion: *mut u8, ptargetminorversion: *mut u8) -> windows_result::Result<()>;
    fn BitsPerPixel(&self) -> windows_result::Result<u16>;
    fn SuppressesDehydration(&self) -> windows_result::Result<windows_core::BOOL>;
    fn BackgroundExecutionAbilities(&self, pbackgroundexecutionabilities: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn IsOptedForExtendedMem(&self) -> windows_result::Result<windows_core::BOOL>;
}
...
impl IPMTaskInfoEnumerator {
    pub unsafe fn Next(&self) -> windows_result::Result<IPMTaskInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IPMTaskInfoEnumerator_Impl: windows_core::IUnknownImpl {
    fn Next(&self) -> windows_result::Result<IPMTaskInfo>;
}
...
impl IPMTileInfo {
    ...
    pub unsafe fn TemplateType(&self) -> windows_result::Result<TILE_TEMPLATE_TYPE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TemplateType)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn get_HubPinnedState(&self, hubtype: PM_TILE_HUBTYPE) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn get_HubPosition(&self, hubtype: PM_TILE_HUBTYPE) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_HubPosition)(windows_core::Interface::as_raw(self), hubtype, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn IsNotified(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn TileType(&self) -> windows_result::Result<PM_STARTTILE_TYPE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn get_PropertyById(&self, propid: u32) -> windows_result::Result<IPMTilePropertyInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn PropertyEnum(&self) -> windows_result::Result<IPMTilePropertyEnumerator> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn get_HubTileSize(&self, hubtype: PM_TILE_HUBTYPE) -> windows_result::Result<PM_TILE_SIZE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_HubTileSize)(windows_core::Interface::as_raw(self), hubtype, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn set_HubPosition(&self, hubtype: PM_TILE_HUBTYPE, position: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).set_HubPosition)(windows_core::Interface::as_raw(self), hubtype, position).ok() }
    }
    pub unsafe fn set_NotifiedState(&self, notified: bool) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).set_NotifiedState)(windows_core::Interface::as_raw(self), notified.into()).ok() }
    }
    pub unsafe fn set_HubPinnedState(&self, hubtype: PM_TILE_HUBTYPE, pinned: bool) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).set_HubPinnedState)(windows_core::Interface::as_raw(self), hubtype, pinned.into()).ok() }
    }
    pub unsafe fn set_HubTileSize(&self, hubtype: PM_TILE_HUBTYPE, size: PM_TILE_SIZE) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).set_HubTileSize)(windows_core::Interface::as_raw(self), hubtype, size).ok() }
    }
    pub unsafe fn set_InvocationInfo(&self, taskname: &windows_core::BSTR, taskparameters: &windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IPMTileInfo_Impl: windows_core::IUnknownImpl {
    fn ProductID(&self) -> windows_result::Result<windows_core::GUID>;
    fn TileID(&self, ptileid: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn TemplateType(&self) -> windows_result::Result<TILE_TEMPLATE_TYPE>;
    fn get_HubPinnedState(&self, hubtype: PM_TILE_HUBTYPE) -> windows_result::Result<windows_core::BOOL>;
    fn get_HubPosition(&self, hubtype: PM_TILE_HUBTYPE) -> windows_result::Result<u32>;
    fn IsNotified(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsDefault(&self) -> windows_result::Result<windows_core::BOOL>;
    fn TaskID(&self, ptaskid: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn TileType(&self) -> windows_result::Result<PM_STARTTILE_TYPE>;
    fn IsThemable(&self) -> windows_result::Result<windows_core::BOOL>;
    fn get_PropertyById(&self, propid: u32) -> windows_result::Result<IPMTilePropertyInfo>;
    fn get_InvocationInfo(&self, pimageurn: *mut windows_core::BSTR, pparameters: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn PropertyEnum(&self) -> windows_result::Result<IPMTilePropertyEnumerator>;
    fn get_HubTileSize(&self, hubtype: PM_TILE_HUBTYPE) -> windows_result::Result<PM_TILE_SIZE>;
    fn set_HubPosition(&self, hubtype: PM_TILE_HUBTYPE, position: u32) -> windows_result::Result<()>;
    fn set_NotifiedState(&self, notified: windows_core::BOOL) -> windows_result::Result<()>;
    fn set_HubPinnedState(&self, hubtype: PM_TILE_HUBTYPE, pinned: windows_core::BOOL) -> windows_result::Result<()>;
    fn set_HubTileSize(&self, hubtype: PM_TILE_HUBTYPE, size: PM_TILE_SIZE) -> windows_result::Result<()>;
    fn set_InvocationInfo(&self, taskname: &windows_core::BSTR, taskparameters: &windows_core::BSTR) -> windows_result::Result<()>;
    fn StartTileBlob(&self, pblob: *mut PM_STARTTILEBLOB) -> windows_result::Result<()>;
    fn IsRestoring(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsAutoRestoreDisabled(&self) -> windows_result::Result<windows_core::BOOL>;
    fn set_IsRestoring(&self, restoring: windows_core::BOOL) -> windows_result::Result<()>;
    fn set_IsAutoRestoreDisabled(&self, autorestoredisabled: windows_core::BOOL) -> windows_result::Result<()>;
}
...
impl IPMTileInfoEnumerator {
    pub unsafe fn Next(&self) -> windows_result::Result<IPMTileInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IPMTileInfoEnumerator_Impl: windows_core::IUnknownImpl {
    fn Next(&self) -> windows_result::Result<IPMTileInfo>;
}
...
impl IPMTilePropertyEnumerator {
    pub unsafe fn Next(&self) -> windows_result::Result<IPMTilePropertyInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IPMTilePropertyEnumerator_Impl: windows_core::IUnknownImpl {
    fn Next(&self) -> windows_result::Result<IPMTilePropertyInfo>;
}
...
impl IPMTilePropertyInfo {
    pub unsafe fn PropertyID(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PropertyID)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn PropertyValue(&self, ppropvalue: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn set_Property(&self, propvalue: &windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IPMTilePropertyInfo_Impl: windows_core::IUnknownImpl {
    fn PropertyID(&self) -> windows_result::Result<u32>;
    fn PropertyValue(&self, ppropvalue: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn set_Property(&self, propvalue: &windows_core::BSTR) -> windows_result::Result<()>;
}
...
impl IValidate {
    ...
    pub unsafe fn SetStatus(&self, pstatusfunction: LPEVALCOMCALLBACK, pcontext: *mut core::ffi::c_void) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetStatus)(windows_core::Interface::as_raw(self), pstatusfunction, pcontext as _).ok() }
    }
    pub unsafe fn Validate<P0>(&self, wzices: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IValidate_Impl: windows_core::IUnknownImpl {
    fn OpenDatabase(&self, szdatabase: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn OpenCUB(&self, szcubfile: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn CloseDatabase(&self) -> windows_result::Result<()>;
    fn CloseCUB(&self) -> windows_result::Result<()>;
    fn SetDisplay(&self, pdisplayfunction: LPDISPLAYVAL, pcontext: *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn SetStatus(&self, pstatusfunction: LPEVALCOMCALLBACK, pcontext: *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn Validate(&self, wzices: &windows_core::PCWSTR) -> windows_result::Result<()>;
}
impl IValidate_Vtbl {
