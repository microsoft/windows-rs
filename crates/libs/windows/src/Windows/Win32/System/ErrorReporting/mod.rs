#[inline]
pub unsafe fn AddERExcludedApplicationA<P0>(szapplication: P0) -> Result<(), windows_result::HRESULT>
where
...
#[inline]
pub unsafe fn AddERExcludedApplicationW<P0>(wszapplication: P0) -> Result<(), windows_result::HRESULT>
where
...
#[inline]
pub unsafe fn WerAddExcludedApplication<P0>(pwzexename: P0, ballusers: bool) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn WerGetFlags(hprocess: super::super::Foundation::HANDLE) -> Result<WER_FAULT_REPORTING, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WerRegisterAdditionalProcess(processid: u32, captureextrainfoforthreadid: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WerRegisterAppLocalDump<P0>(localappdatarelativepath: P0) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn WerRegisterCustomMetadata<P0, P1>(key: P0, value: P1) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn WerRegisterExcludedMemoryBlock(address: *const core::ffi::c_void, size: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WerRegisterFile<P0>(pwzfile: P0, regfiletype: WER_REGISTER_FILE_TYPE, dwflags: WER_FILE) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn WerRegisterMemoryBlock(pvaddress: *const core::ffi::c_void, dwsize: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WerRegisterRuntimeExceptionModule<P0>(pwszoutofprocesscallbackdll: P0, pcontext: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn WerRemoveExcludedApplication<P0>(pwzexename: P0, ballusers: bool) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[cfg(all(feature = "Win32_System_Diagnostics_Debug", feature = "Win32_System_Kernel"))]
#[inline]
pub unsafe fn WerReportAddDump(hreporthandle: HREPORT, hprocess: super::super::Foundation::HANDLE, hthread: Option<super::super::Foundation::HANDLE>, dumptype: WER_DUMP_TYPE, pexceptionparam: Option<*const WER_EXCEPTION_INFORMATION>, pdumpcustomoptions: Option<*const WER_DUMP_CUSTOM_OPTIONS>, dwflags: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WerReportAddFile<P1>(hreporthandle: HREPORT, pwzpath: P1, repfiletype: WER_FILE_TYPE, dwfileflags: WER_FILE) -> Result<(), windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn WerReportCloseHandle(hreporthandle: HREPORT) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WerReportCreate<P0>(pwzeventtype: P0, reptype: WER_REPORT_TYPE, preportinformation: Option<*const WER_REPORT_INFORMATION>) -> Result<HREPORT, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn WerReportHang<P1>(hwndhungapp: super::super::Foundation::HWND, pwzhungapplicationname: P1) -> Result<(), windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn WerReportSetParameter<P2, P3>(hreporthandle: HREPORT, dwparamid: u32, pwzname: P2, pwzvalue: P3) -> Result<(), windows_result::HRESULT>
where
...
#[inline]
pub unsafe fn WerReportSetUIOption<P2>(hreporthandle: HREPORT, repuitypeid: WER_REPORT_UI, pwzvalue: P2) -> Result<(), windows_result::HRESULT>
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn WerReportSubmit(hreporthandle: HREPORT, consent: WER_CONSENT, dwflags: WER_SUBMIT_FLAGS, psubmitresult: Option<*mut WER_SUBMIT_RESULT>) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WerSetFlags(dwflags: WER_FAULT_REPORTING) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WerStoreGetFirstReportKey(hreportstore: HREPORTSTORE, ppszreportkey: Option<*mut windows_core::PCWSTR>) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WerStoreGetNextReportKey(hreportstore: HREPORTSTORE, ppszreportkey: Option<*mut windows_core::PCWSTR>) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WerStoreGetReportCount(hreportstore: HREPORTSTORE) -> Result<u32, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WerStoreGetSizeOnDisk(hreportstore: HREPORTSTORE) -> Result<u64, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WerStoreOpen(repstoretype: REPORT_STORE_TYPES) -> Result<HREPORTSTORE, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WerStorePurge() -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wer.dll" "system" fn WerStorePurge() -> windows_core::HRESULT);
    unsafe { WerStorePurge().ok() }
}
#[inline]
pub unsafe fn WerStoreQueryReportMetadataV1<P1>(hreportstore: HREPORTSTORE, pszreportkey: P1, preportmetadata: *mut WER_REPORT_METADATA_V1) -> Result<(), windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn WerStoreQueryReportMetadataV2<P1>(hreportstore: HREPORTSTORE, pszreportkey: P1, preportmetadata: *mut WER_REPORT_METADATA_V2) -> Result<(), windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn WerStoreQueryReportMetadataV3<P1>(hreportstore: HREPORTSTORE, pszreportkey: P1, preportmetadata: *mut WER_REPORT_METADATA_V3) -> Result<(), windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn WerStoreUploadReport<P1>(hreportstore: HREPORTSTORE, pszreportkey: P1, dwflags: u32, psubmitresult: Option<*mut WER_SUBMIT_RESULT>) -> Result<(), windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn WerUnregisterAdditionalProcess(processid: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WerUnregisterAppLocalDump() -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WerUnregisterCustomMetadata<P0>(key: P0) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn WerUnregisterExcludedMemoryBlock(address: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WerUnregisterFile<P0>(pwzfilepath: P0) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn WerUnregisterMemoryBlock(pvaddress: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn WerUnregisterRuntimeExceptionModule<P0>(pwszoutofprocesscallbackdll: P0, pcontext: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
