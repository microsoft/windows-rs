...
pub unsafe fn UalInstrument(data: *const UAL_DATA_BLOB) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "ualapi.dll" ,"system" fn UalInstrument ( data : *const UAL_DATA_BLOB ) -> :: windows::core::HRESULT );
...
{
    ::windows::core::windows_link ! ( "ualapi.dll" ,"system" fn UalRegisterProduct ( wszproductname : :: windows::core::PCWSTR , wszrolename : :: windows::core::PCWSTR , wszguid : :: windows::core::PCWSTR ) -> :: windows::core::HRESULT );
...
pub unsafe fn UalStart(data: *const UAL_DATA_BLOB) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "ualapi.dll" ,"system" fn UalStart ( data : *const UAL_DATA_BLOB ) -> :: windows::core::HRESULT );
...
pub unsafe fn UalStop(data: *const UAL_DATA_BLOB) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "ualapi.dll" ,"system" fn UalStop ( data : *const UAL_DATA_BLOB ) -> :: windows::core::HRESULT );
