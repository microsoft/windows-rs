...
#[inline]
pub unsafe fn UalInstrument(data: *const UAL_DATA_BLOB) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn UalRegisterProduct<P0, P1, P2>(wszproductname: P0, wszrolename: P1, wszguid: P2) -> Result<(), windows_result::HRESULT>
where
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn UalStart(data: *const UAL_DATA_BLOB) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("ualapi.dll" "system" fn UalStart(data : *const UAL_DATA_BLOB) -> windows_core::HRESULT);
    unsafe { UalStart(data).ok() }
}
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn UalStop(data: *const UAL_DATA_BLOB) -> Result<(), windows_result::HRESULT> {
