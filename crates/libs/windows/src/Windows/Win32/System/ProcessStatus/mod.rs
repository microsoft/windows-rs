#[inline]
pub unsafe fn EmptyWorkingSet(hprocess: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn EnumDeviceDrivers(lpimagebase: *mut *mut core::ffi::c_void, cb: u32, lpcbneeded: *mut u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn EnumPageFilesA(pcallbackroutine: PENUM_PAGE_FILE_CALLBACKA, pcontext: *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn EnumPageFilesW(pcallbackroutine: PENUM_PAGE_FILE_CALLBACKW, pcontext: *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn EnumProcessModules(hprocess: super::super::Foundation::HANDLE, lphmodule: *mut super::super::Foundation::HMODULE, cb: u32, lpcbneeded: *mut u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn EnumProcessModulesEx(hprocess: super::super::Foundation::HANDLE, lphmodule: *mut super::super::Foundation::HMODULE, cb: u32, lpcbneeded: *mut u32, dwfilterflag: ENUM_PROCESS_MODULES_EX_FLAGS) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn EnumProcesses(lpidprocess: *mut u32, cb: u32, lpcbneeded: *mut u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetModuleInformation(hprocess: super::super::Foundation::HANDLE, hmodule: super::super::Foundation::HMODULE, lpmodinfo: *mut MODULEINFO, cb: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetPerformanceInfo(pperformanceinformation: *mut PERFORMANCE_INFORMATION, cb: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetProcessMemoryInfo(process: super::super::Foundation::HANDLE, ppsmemcounters: *mut PROCESS_MEMORY_COUNTERS, cb: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetWsChanges(hprocess: super::super::Foundation::HANDLE, lpwatchinfo: *mut PSAPI_WS_WATCH_INFORMATION, cb: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetWsChangesEx(hprocess: super::super::Foundation::HANDLE, lpwatchinfoex: *mut PSAPI_WS_WATCH_INFORMATION_EX, cb: *mut u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn InitializeProcessForWsWatch(hprocess: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn QueryWorkingSet(hprocess: super::super::Foundation::HANDLE, pv: *mut core::ffi::c_void, cb: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn QueryWorkingSetEx(hprocess: super::super::Foundation::HANDLE, pv: *mut core::ffi::c_void, cb: u32) -> Result<(), windows_result::HRESULT> {
