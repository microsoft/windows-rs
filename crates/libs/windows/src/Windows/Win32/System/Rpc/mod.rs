...
pub unsafe fn DceErrorInqTextA(rpcstatus: RPC_STATUS, errortext: &mut [u8; 256]) -> RPC_STATUS {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(DceErrorInqTextA(::core::mem::transmute(rpcstatus), ::core::mem::transmute(errortext.as_ptr())))
    }
    #[cfg(not(windows))]
...
pub unsafe fn DceErrorInqTextW(rpcstatus: RPC_STATUS, errortext: &mut [u16; 256]) -> RPC_STATUS {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(DceErrorInqTextW(::core::mem::transmute(rpcstatus), ::core::mem::transmute(errortext.as_ptr())))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
