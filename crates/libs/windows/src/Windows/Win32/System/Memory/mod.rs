...
#[inline]
pub unsafe fn AtlThunk_AllocateData() -> *mut AtlThunkData_t {
    ::windows_targets::link!("atlthunk.dll" "system" fn AtlThunk_AllocateData() -> *mut AtlThunkData_t);
    AtlThunk_AllocateData()
}
#[doc = "*Required features: `\"Win32_System_Memory\"`, `\"Win32_Foundation\"`, `\"Win32_UI_WindowsAndMessaging\"`*"]
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_UI_WindowsAndMessaging"))]
#[inline]
pub unsafe fn AtlThunk_DataToCode(param0: *mut AtlThunkData_t) -> super::super::UI::WindowsAndMessaging::WNDPROC {
    ::windows_targets::link!("atlthunk.dll" "system" fn AtlThunk_DataToCode(param0 : *mut AtlThunkData_t) -> super::super::UI::WindowsAndMessaging:: WNDPROC);
    AtlThunk_DataToCode(param0)
}
#[doc = "*Required features: `\"Win32_System_Memory\"`*"]
#[inline]
pub unsafe fn AtlThunk_FreeData(thunk: *mut AtlThunkData_t) {
    ::windows_targets::link!("atlthunk.dll" "system" fn AtlThunk_FreeData(thunk : *mut AtlThunkData_t) -> ());
    AtlThunk_FreeData(thunk)
}
#[doc = "*Required features: `\"Win32_System_Memory\"`*"]
#[inline]
pub unsafe fn AtlThunk_InitData(thunk: *mut AtlThunkData_t, proc: *mut ::core::ffi::c_void, firstparameter: usize) {
    ::windows_targets::link!("atlthunk.dll" "system" fn AtlThunk_InitData(thunk : *mut AtlThunkData_t, proc : *mut ::core::ffi::c_void, firstparameter : usize) -> ());
    AtlThunk_InitData(thunk, proc, firstparameter)
}
...
impl ::core::default::Default for AtlThunkData_t {
    fn default() -> Self {
