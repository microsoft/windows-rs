...
#[cfg(all(feature = "Win32_objectheader", feature = "Win32_windot11", feature = "Win32_winnt", feature = "Win32_wlantypes"))]
#[inline]
...
{
    windows_core::link!("wlanapi.dll" "system" fn WlanExtractPsdIEDataList(hclienthandle : super::winnt::HANDLE, dwiedatasize : u32, prawiedata : *const u8, strformat : windows_core::PCWSTR, preserved : *const core::ffi::c_void, pppsdiedatalist : *mut PWLAN_RAW_DATA_LIST) -> u32);
...
#[cfg(all(feature = "Win32_windot11", feature = "Win32_winnt", feature = "Win32_wlantypes"))]
#[inline]
...
#[cfg(all(feature = "Win32_winnt", feature = "Win32_wlantypes"))]
#[inline]
...
#[cfg(all(feature = "Win32_windot11", feature = "Win32_winnt", feature = "Win32_wlantypes"))]
#[inline]
pub unsafe fn WlanGetNetworkBssList(hclienthandle: super::winnt::HANDLE, pinterfaceguid: *const windows_core::GUID, pdot11ssid: Option<*const super::wlantypes::DOT11_SSID>, dot11bsstype: super::wlantypes::DOT11_BSS_TYPE, bsecurityenabled: bool, preserved: Option<*const core::ffi::c_void>, ppwlanbsslist: *mut PWLAN_BSS_LIST) -> u32 {
    windows_core::link!("wlanapi.dll" "system" fn WlanGetNetworkBssList(hclienthandle : super::winnt::HANDLE, pinterfaceguid : *const windows_core::GUID, pdot11ssid : *const super::wlantypes::DOT11_SSID, dot11bsstype : super::wlantypes::DOT11_BSS_TYPE, bsecurityenabled : windows_core::BOOL, preserved : *const core::ffi::c_void, ppwlanbsslist : *mut PWLAN_BSS_LIST) -> u32);
...
#[cfg(all(feature = "Win32_winnt", feature = "Win32_wlantypes"))]
#[inline]
pub unsafe fn WlanScan(hclienthandle: super::winnt::HANDLE, pinterfaceguid: *const windows_core::GUID, pdot11ssid: Option<*const super::wlantypes::DOT11_SSID>, piedata: Option<*const WLAN_RAW_DATA>, preserved: Option<*const core::ffi::c_void>) -> u32 {
    windows_core::link!("wlanapi.dll" "system" fn WlanScan(hclienthandle : super::winnt::HANDLE, pinterfaceguid : *const windows_core::GUID, pdot11ssid : *const super::wlantypes::DOT11_SSID, piedata : *const WLAN_RAW_DATA, preserved : *const core::ffi::c_void) -> u32);
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("wlanui.dll" "system" fn WlanUIEditProfile(dwclientversion : u32, wstrprofilename : windows_core::PCWSTR, pinterfaceguid : *const windows_core::GUID, hwnd : super::windef::HWND, wlstartpage : WL_DISPLAY_PAGES, preserved : *const core::ffi::c_void, pwlanreasoncode : *mut u32) -> u32);
...
pub struct PDOT11_NETWORK(pub *mut DOT11_NETWORK);
#[cfg(feature = "Win32_wlantypes")]
impl PDOT11_NETWORK {
...
#[cfg(feature = "Win32_wlantypes")]
impl Default for PDOT11_NETWORK {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PDOT11_NETWORK_LIST(pub *mut DOT11_NETWORK_LIST);
#[cfg(feature = "Win32_wlantypes")]
impl PDOT11_NETWORK_LIST {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
#[cfg(feature = "Win32_wlantypes")]
impl Default for PDOT11_NETWORK_LIST {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PDOT11_RADIO_STATE(pub *mut DOT11_RADIO_STATE);
impl PDOT11_RADIO_STATE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PDOT11_RADIO_STATE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[cfg(all(feature = "Win32_windot11", feature = "Win32_wlantypes"))]
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWFD_ROLE_TYPE(pub *mut WFD_ROLE_TYPE);
impl PWFD_ROLE_TYPE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWFD_ROLE_TYPE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_ADHOC_NETWORK_STATE(pub *mut WLAN_ADHOC_NETWORK_STATE);
impl PWLAN_ADHOC_NETWORK_STATE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_ADHOC_NETWORK_STATE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_AUTH_CIPHER_PAIR_LIST(pub *mut WLAN_AUTH_CIPHER_PAIR_LIST);
#[cfg(feature = "Win32_wlantypes")]
impl PWLAN_AUTH_CIPHER_PAIR_LIST {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
#[cfg(feature = "Win32_wlantypes")]
impl Default for PWLAN_AUTH_CIPHER_PAIR_LIST {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_AUTOCONF_OPCODE(pub *mut WLAN_AUTOCONF_OPCODE);
impl PWLAN_AUTOCONF_OPCODE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_AUTOCONF_OPCODE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_CONNECTION_MODE(pub *mut WLAN_CONNECTION_MODE);
impl PWLAN_CONNECTION_MODE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_CONNECTION_MODE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_CONNECTION_NOTIFICATION_DATA(pub *mut WLAN_CONNECTION_NOTIFICATION_DATA);
#[cfg(feature = "Win32_wlantypes")]
impl PWLAN_CONNECTION_NOTIFICATION_DATA {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
#[cfg(feature = "Win32_wlantypes")]
impl Default for PWLAN_CONNECTION_NOTIFICATION_DATA {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[cfg(all(feature = "Win32_objectheader", feature = "Win32_windot11", feature = "Win32_wlantypes"))]
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_CONNECTION_QOS_INFO(pub *mut WLAN_CONNECTION_QOS_INFO);
impl PWLAN_CONNECTION_QOS_INFO {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_CONNECTION_QOS_INFO {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_DEVICE_SERVICE_GUID_LIST(pub *mut WLAN_DEVICE_SERVICE_GUID_LIST);
impl PWLAN_DEVICE_SERVICE_GUID_LIST {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_DEVICE_SERVICE_GUID_LIST {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_DEVICE_SERVICE_NOTIFICATION_DATA(pub *mut WLAN_DEVICE_SERVICE_NOTIFICATION_DATA);
impl PWLAN_DEVICE_SERVICE_NOTIFICATION_DATA {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_DEVICE_SERVICE_NOTIFICATION_DATA {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_FILTER_LIST_TYPE(pub *mut WLAN_FILTER_LIST_TYPE);
impl PWLAN_FILTER_LIST_TYPE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_FILTER_LIST_TYPE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_HOSTED_NETWORK_CONNECTION_SETTINGS(pub *mut WLAN_HOSTED_NETWORK_CONNECTION_SETTINGS);
#[cfg(feature = "Win32_wlantypes")]
impl PWLAN_HOSTED_NETWORK_CONNECTION_SETTINGS {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
#[cfg(feature = "Win32_wlantypes")]
impl Default for PWLAN_HOSTED_NETWORK_CONNECTION_SETTINGS {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_HOSTED_NETWORK_NOTIFICATION_CODE(pub *mut WLAN_HOSTED_NETWORK_NOTIFICATION_CODE);
impl PWLAN_HOSTED_NETWORK_NOTIFICATION_CODE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_HOSTED_NETWORK_NOTIFICATION_CODE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_HOSTED_NETWORK_OPCODE(pub *mut WLAN_HOSTED_NETWORK_OPCODE);
impl PWLAN_HOSTED_NETWORK_OPCODE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_HOSTED_NETWORK_OPCODE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_HOSTED_NETWORK_PEER_AUTH_STATE(pub *mut WLAN_HOSTED_NETWORK_PEER_AUTH_STATE);
impl PWLAN_HOSTED_NETWORK_PEER_AUTH_STATE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_HOSTED_NETWORK_PEER_AUTH_STATE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_HOSTED_NETWORK_RADIO_STATE(pub *mut WLAN_HOSTED_NETWORK_RADIO_STATE);
impl PWLAN_HOSTED_NETWORK_RADIO_STATE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_HOSTED_NETWORK_RADIO_STATE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_HOSTED_NETWORK_REASON(pub *mut WLAN_HOSTED_NETWORK_REASON);
impl PWLAN_HOSTED_NETWORK_REASON {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_HOSTED_NETWORK_REASON {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_HOSTED_NETWORK_SECURITY_SETTINGS(pub *mut WLAN_HOSTED_NETWORK_SECURITY_SETTINGS);
#[cfg(feature = "Win32_wlantypes")]
impl PWLAN_HOSTED_NETWORK_SECURITY_SETTINGS {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
#[cfg(feature = "Win32_wlantypes")]
impl Default for PWLAN_HOSTED_NETWORK_SECURITY_SETTINGS {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_HOSTED_NETWORK_STATE(pub *mut WLAN_HOSTED_NETWORK_STATE);
impl PWLAN_HOSTED_NETWORK_STATE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_HOSTED_NETWORK_STATE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_HOSTED_NETWORK_STATE_CHANGE(pub *mut WLAN_HOSTED_NETWORK_STATE_CHANGE);
impl PWLAN_HOSTED_NETWORK_STATE_CHANGE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_HOSTED_NETWORK_STATE_CHANGE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_IHV_CONTROL_TYPE(pub *mut WLAN_IHV_CONTROL_TYPE);
impl PWLAN_IHV_CONTROL_TYPE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_IHV_CONTROL_TYPE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_INTERFACE_INFO(pub *mut WLAN_INTERFACE_INFO);
impl PWLAN_INTERFACE_INFO {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_INTERFACE_INFO {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_INTERFACE_INFO_LIST(pub *mut WLAN_INTERFACE_INFO_LIST);
impl PWLAN_INTERFACE_INFO_LIST {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_INTERFACE_INFO_LIST {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_INTERFACE_STATE(pub *mut WLAN_INTERFACE_STATE);
impl PWLAN_INTERFACE_STATE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_INTERFACE_STATE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_INTERFACE_TYPE(pub *mut WLAN_INTERFACE_TYPE);
impl PWLAN_INTERFACE_TYPE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_INTERFACE_TYPE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_INTF_OPCODE(pub *mut WLAN_INTF_OPCODE);
impl PWLAN_INTF_OPCODE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_INTF_OPCODE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_MAC_FRAME_STATISTICS(pub *mut WLAN_MAC_FRAME_STATISTICS);
impl PWLAN_MAC_FRAME_STATISTICS {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_MAC_FRAME_STATISTICS {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_NOTIFICATION_ACM(pub *mut WLAN_NOTIFICATION_ACM);
impl PWLAN_NOTIFICATION_ACM {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_NOTIFICATION_ACM {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_NOTIFICATION_MSM(pub *mut WLAN_NOTIFICATION_MSM);
impl PWLAN_NOTIFICATION_MSM {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_NOTIFICATION_MSM {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_NOTIFICATION_SECURITY(pub *mut WLAN_NOTIFICATION_SECURITY);
impl PWLAN_NOTIFICATION_SECURITY {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_NOTIFICATION_SECURITY {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_OPCODE_VALUE_TYPE(pub *mut WLAN_OPCODE_VALUE_TYPE);
impl PWLAN_OPCODE_VALUE_TYPE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_OPCODE_VALUE_TYPE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_OPERATIONAL_STATE(pub *mut WLAN_OPERATIONAL_STATE);
impl PWLAN_OPERATIONAL_STATE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_OPERATIONAL_STATE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_PHY_FRAME_STATISTICS(pub *mut WLAN_PHY_FRAME_STATISTICS);
impl PWLAN_PHY_FRAME_STATISTICS {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_PHY_FRAME_STATISTICS {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_PHY_RADIO_STATE(pub *mut WLAN_PHY_RADIO_STATE);
impl PWLAN_PHY_RADIO_STATE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_PHY_RADIO_STATE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_POWER_SETTING(pub *mut WLAN_POWER_SETTING);
impl PWLAN_POWER_SETTING {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_POWER_SETTING {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_PROFILE_INFO(pub *mut WLAN_PROFILE_INFO);
impl PWLAN_PROFILE_INFO {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_PROFILE_INFO {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_PROFILE_INFO_LIST(pub *mut WLAN_PROFILE_INFO_LIST);
impl PWLAN_PROFILE_INFO_LIST {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_PROFILE_INFO_LIST {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_QOS_CAPABILITIES(pub *mut WLAN_QOS_CAPABILITIES);
impl PWLAN_QOS_CAPABILITIES {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_QOS_CAPABILITIES {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_QOS_INFO(pub *mut WLAN_QOS_INFO);
impl PWLAN_QOS_INFO {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_QOS_INFO {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_RADIO_STATE(pub *mut WLAN_RADIO_STATE);
impl PWLAN_RADIO_STATE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_RADIO_STATE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_RATE_SET(pub *mut WLAN_RATE_SET);
impl PWLAN_RATE_SET {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_RATE_SET {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_RAW_DATA(pub *mut WLAN_RAW_DATA);
impl PWLAN_RAW_DATA {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_RAW_DATA {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_RAW_DATA_LIST(pub *mut WLAN_RAW_DATA_LIST);
impl PWLAN_RAW_DATA_LIST {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_RAW_DATA_LIST {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_REALTIME_CONNECTION_QUALITY_LINK_INFO(pub *mut WLAN_REALTIME_CONNECTION_QUALITY_LINK_INFO);
impl PWLAN_REALTIME_CONNECTION_QUALITY_LINK_INFO {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_REALTIME_CONNECTION_QUALITY_LINK_INFO {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_REASON_CODE(pub *mut u32);
impl PWLAN_REASON_CODE {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_REASON_CODE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_SECURABLE_OBJECT(pub *mut WLAN_SECURABLE_OBJECT);
impl PWLAN_SECURABLE_OBJECT {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_SECURABLE_OBJECT {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_SECURITY_ATTRIBUTES(pub *mut WLAN_SECURITY_ATTRIBUTES);
#[cfg(feature = "Win32_wlantypes")]
impl PWLAN_SECURITY_ATTRIBUTES {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
#[cfg(feature = "Win32_wlantypes")]
impl Default for PWLAN_SECURITY_ATTRIBUTES {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_SIGNAL_QUALITY(pub *mut u32);
impl PWLAN_SIGNAL_QUALITY {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_SIGNAL_QUALITY {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWLAN_STATISTICS(pub *mut WLAN_STATISTICS);
impl PWLAN_STATISTICS {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWLAN_STATISTICS {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct PWL_DISPLAY_PAGES(pub *mut WL_DISPLAY_PAGES);
impl PWL_DISPLAY_PAGES {
    pub fn is_invalid(&self) -> bool {
        self.0.is_null()
    }
}
impl Default for PWL_DISPLAY_PAGES {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
pub struct WLAN_AUTH_CIPHER_PAIR_LIST {
    pub dwNumberOfItems: u32,
    pub pAuthCipherPairList: [super::wlantypes::DOT11_AUTH_CIPHER_PAIR; 1],
}
#[cfg(feature = "Win32_wlantypes")]
...
pub struct WLAN_AVAILABLE_NETWORK {
    ...
    pub dot11DefaultAuthAlgorithm: super::wlantypes::DOT11_AUTH_ALGORITHM,
    pub dot11DefaultCipherAlgorithm: super::wlantypes::DOT11_CIPHER_ALGORITHM,
    pub dwFlags: u32,
    pub dwReserved: u32,
}
#[cfg(all(feature = "Win32_windot11", feature = "Win32_wlantypes"))]
...
pub struct WLAN_AVAILABLE_NETWORK_V2 {
    ...
    pub dot11DefaultCipherAlgorithm: super::wlantypes::DOT11_CIPHER_ALGORITHM,
    pub dwFlags: u32,
    pub AccessNetworkOptions: super::wlantypes::DOT11_ACCESSNETWORKOPTIONS,
    pub dot11HESSID: super::windot11::DOT11_HESSID,
    pub VenueInfo: super::wlantypes::DOT11_VENUEINFO,
    pub dwReserved: u32,
}
#[cfg(all(feature = "Win32_windot11", feature = "Win32_wlantypes"))]
...
pub struct WLAN_CONNECTION_PARAMETERS {
    ...
    pub pDot11Ssid: super::wlantypes::PDOT11_SSID,
...
pub struct WLAN_CONNECTION_PARAMETERS_V2 {
    ...
    pub dot11BssType: super::wlantypes::DOT11_BSS_TYPE,
    pub dwFlags: u32,
    pub pDot11AccessNetworkOptions: super::wlantypes::PDOT11_ACCESSNETWORKOPTIONS,
}
...
pub struct WLAN_HOSTED_NETWORK_CONNECTION_SETTINGS {
    pub hostedNetworkSSID: super::wlantypes::DOT11_SSID,
...
pub struct WLAN_HOSTED_NETWORK_SECURITY_SETTINGS {
    pub dot11AuthAlgo: super::wlantypes::DOT11_AUTH_ALGORITHM,
    pub dot11CipherAlgo: super::wlantypes::DOT11_CIPHER_ALGORITHM,
}
...
pub struct WLAN_SECURITY_ATTRIBUTES {
    ...
    pub dot11AuthAlgorithm: super::wlantypes::DOT11_AUTH_ALGORITHM,
    pub dot11CipherAlgorithm: super::wlantypes::DOT11_CIPHER_ALGORITHM,
}
