...
impl IWbemDecoupledBasicEventProvider {
    #[cfg(feature = "wbemcli")]
    pub unsafe fn GetSink<P1>(&self, a_flags: i32, a_context: P1) -> windows_core::Result<super::IWbemObjectSink>
    where
        P1: windows_core::Param<super::IWbemContext>,
    {
        unsafe {
    ...
    #[cfg(feature = "wbemcli")]
    pub unsafe fn GetService<P1>(&self, a_flags: i32, a_context: P1) -> windows_core::Result<super::IWbemServices>
    where
        P1: windows_core::Param<super::IWbemContext>,
    {
        unsafe {
...
pub trait IWbemDecoupledBasicEventProvider_Impl: IWbemDecoupledRegistrar_Impl {
    fn GetSink(&self, a_flags: i32, a_context: windows_core::Ref<super::IWbemContext>) -> windows_core::Result<super::IWbemObjectSink>;
    fn GetService(&self, a_flags: i32, a_context: windows_core::Ref<super::IWbemContext>) -> windows_core::Result<super::IWbemServices>;
}
#[cfg(feature = "wbemcli")]
...
pub trait IWbemDecoupledRegistrar_Impl: windows_core::IUnknownImpl {
    fn Register(&self, a_flags: i32, a_context: windows_core::Ref<super::IWbemContext>, a_user: &windows_core::PCWSTR, a_locale: &windows_core::PCWSTR, a_scope: &windows_core::PCWSTR, a_registration: &windows_core::PCWSTR, piunknown: windows_core::Ref<windows_core::IUnknown>) -> windows_core::Result<()>;
...
impl IWbemEventConsumerProvider {
    ...
    where
        P0: windows_core::Param<super::IWbemClassObject>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWbemEventConsumerProvider_Impl: windows_core::IUnknownImpl {
    fn FindConsumer(&self, plogicalconsumer: windows_core::Ref<super::IWbemClassObject>) -> windows_core::Result<IWbemUnboundObjectSink>;
}
#[cfg(feature = "wbemcli")]
...
impl IWbemEventProvider {
    ...
    where
        P0: windows_core::Param<super::IWbemObjectSink>,
    {
...
pub trait IWbemEventProvider_Impl: windows_core::IUnknownImpl {
    fn ProvideEvents(&self, psink: windows_core::Ref<super::IWbemObjectSink>, lflags: i32) -> windows_core::Result<()>;
}
#[cfg(feature = "wbemcli")]
...
impl core::ops::Deref for IWbemEventSink {
    type Target = super::IWbemObjectSink;
    fn deref(&self) -> &Self::Target {
        unsafe { core::mem::transmute(self) }
    }
}
#[cfg(feature = "wbemcli")]
windows_core::imp::interface_hierarchy!(IWbemEventSink, windows_core::IUnknown, super::IWbemObjectSink);
#[cfg(feature = "wbemcli")]
impl IWbemEventSink {
        ...
        P2: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRestrictedSink)(windows_core::Interface::as_raw(self), lnumqueries, awszqueries, pcallback.param().abi(), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
...
pub struct IWbemEventSink_Vtbl {
    pub base__: super::IWbemObjectSink_Vtbl,
...
#[cfg(feature = "wbemcli")]
pub trait IWbemEventSink_Impl: super::IWbemObjectSink_Impl {
...
impl IWbemEventSink_Vtbl {
    pub const fn new<Identity: IWbemEventSink_Impl, const OFFSET: isize>() -> Self {
        ...
        Self {
            base__: super::IWbemObjectSink_Vtbl::new::<Identity, OFFSET>(),
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IWbemEventSink as windows_core::Interface>::IID || iid == &<super::IWbemObjectSink as windows_core::Interface>::IID
    }
}
#[cfg(feature = "wbemcli")]
...
impl IWbemHiPerfProvider {
    ...
    #[cfg(feature = "wbemcli")]
    pub unsafe fn CreateRefreshableObject<P0, P1, P2, P4>(&self, pnamespace: P0, ptemplate: P1, prefresher: P2, lflags: i32, pcontext: P4, pprefreshable: *mut Option<super::IWbemObjectAccess>, plid: *mut i32) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::IWbemServices>,
        P1: windows_core::Param<super::IWbemObjectAccess>,
        P2: windows_core::Param<super::IWbemRefresher>,
    ...
    where
        P0: windows_core::Param<super::IWbemRefresher>,
    {
    ...
    where
        ...
        P2: windows_core::Param<super::IWbemRefresher>,
        P4: windows_core::Param<super::IWbemContext>,
        P5: windows_core::Param<super::IWbemHiPerfEnum>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl IWbemPropertyProvider {
    ...
    pub unsafe fn GetProperty(&self, lflags: i32, strlocale: &windows_core::BSTR, strclassmapping: &windows_core::BSTR, strinstmapping: &windows_core::BSTR, strpropmapping: &windows_core::BSTR) -> windows_core::Result<super::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "oaidl", feature = "wtypes", feature = "wtypesbase"))]
    pub unsafe fn PutProperty(&self, lflags: i32, strlocale: &windows_core::BSTR, strclassmapping: &windows_core::BSTR, strinstmapping: &windows_core::BSTR, strpropmapping: &windows_core::BSTR, pvvalue: *const super::VARIANT) -> windows_core::HRESULT {
...
pub struct IWbemPropertyProvider_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(all(feature = "oaidl", feature = "wtypes", feature = "wtypesbase"))]
    pub GetProperty: unsafe extern "system" fn(*mut core::ffi::c_void, i32, *mut core::ffi::c_void, *mut core::ffi::c_void, *mut core::ffi::c_void, *mut core::ffi::c_void, *mut super::VARIANT) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "oaidl", feature = "wtypes", feature = "wtypesbase")))]
    GetProperty: usize,
    #[cfg(all(feature = "oaidl", feature = "wtypes", feature = "wtypesbase"))]
    pub PutProperty: unsafe extern "system" fn(*mut core::ffi::c_void, i32, *mut core::ffi::c_void, *mut core::ffi::c_void, *mut core::ffi::c_void, *mut core::ffi::c_void, *const super::VARIANT) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "oaidl", feature = "wtypes", feature = "wtypesbase")))]
    PutProperty: usize,
}
#[cfg(all(feature = "oaidl", feature = "wtypes", feature = "wtypesbase"))]
pub trait IWbemPropertyProvider_Impl: windows_core::IUnknownImpl {
    fn GetProperty(&self, lflags: i32, strlocale: &windows_core::BSTR, strclassmapping: &windows_core::BSTR, strinstmapping: &windows_core::BSTR, strpropmapping: &windows_core::BSTR) -> windows_core::Result<super::VARIANT>;
    fn PutProperty(&self, lflags: i32, strlocale: &windows_core::BSTR, strclassmapping: &windows_core::BSTR, strinstmapping: &windows_core::BSTR, strpropmapping: &windows_core::BSTR, pvvalue: *const super::VARIANT) -> windows_core::Result<()>;
}
#[cfg(all(feature = "oaidl", feature = "wtypes", feature = "wtypesbase"))]
impl IWbemPropertyProvider_Vtbl {
    pub const fn new<Identity: IWbemPropertyProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetProperty<Identity: IWbemPropertyProvider_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, lflags: i32, strlocale: *mut core::ffi::c_void, strclassmapping: *mut core::ffi::c_void, strinstmapping: *mut core::ffi::c_void, strpropmapping: *mut core::ffi::c_void, pvvalue: *mut super::VARIANT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IWbemProviderIdentity {
    ...
    where
        P1: windows_core::Param<super::IWbemClassObject>,
    {
...
pub trait IWbemProviderIdentity_Impl: windows_core::IUnknownImpl {
    fn SetRegistrationObject(&self, lflags: i32, pprovreg: windows_core::Ref<super::IWbemClassObject>) -> windows_core::Result<()>;
}
#[cfg(feature = "wbemcli")]
...
impl IWbemProviderInit {
    ...
    where
        ...
        P2: windows_core::Param<windows_core::PCWSTR>,
        P3: windows_core::Param<windows_core::PCWSTR>,
        P4: windows_core::Param<super::IWbemServices>,
        P5: windows_core::Param<super::IWbemContext>,
...
pub trait IWbemProviderInit_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, wszuser: &windows_core::PCWSTR, lflags: i32, wsznamespace: &windows_core::PCWSTR, wszlocale: &windows_core::PCWSTR, pnamespace: windows_core::Ref<super::IWbemServices>, pctx: windows_core::Ref<super::IWbemContext>, pinitsink: windows_core::Ref<IWbemProviderInitSink>) -> windows_core::Result<()>;
}
#[cfg(feature = "wbemcli")]
...
impl IWbemUnboundObjectSink {
    #[cfg(feature = "wbemcli")]
    pub unsafe fn IndicateToConsumer<P0>(&self, plogicalconsumer: P0, lnumobjects: i32, apobjects: *const Option<super::IWbemClassObject>) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::IWbemClassObject>,
    {
...
pub trait IWbemUnboundObjectSink_Impl: windows_core::IUnknownImpl {
    fn IndicateToConsumer(&self, plogicalconsumer: windows_core::Ref<super::IWbemClassObject>, lnumobjects: i32, apobjects: *const Option<super::IWbemClassObject>) -> windows_core::Result<()>;
}
#[cfg(feature = "wbemcli")]
