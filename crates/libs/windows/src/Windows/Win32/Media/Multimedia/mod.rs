...
#[inline]
pub unsafe fn AVISaveOptionsFree(plpoptions: &[*const AVICOMPRESSOPTIONS]) -> windows_core::HRESULT {
...
#[inline]
pub unsafe fn AVISaveVA<P0>(szfile: P0, pclsidhandler: Option<*const windows_core::GUID>, lpfncallback: AVISAVECALLBACK, nstreams: i32, ppavi: *const Option<IAVIStream>, plpoptions: *const *const AVICOMPRESSOPTIONS) -> windows_core::HRESULT
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
...
#[inline]
pub unsafe fn AVISaveVW<P0>(szfile: P0, pclsidhandler: Option<*const windows_core::GUID>, lpfncallback: AVISAVECALLBACK, nstreams: i32, ppavi: *const Option<IAVIStream>, plpoptions: *const *const AVICOMPRESSOPTIONS) -> windows_core::HRESULT
where
...
pub const AUXM_INIT: u32 = 100;
pub const AUXM_INIT_EX: u32 = 104;
...
pub const DLG_ACMFILTERCHOOSE_ID: u32 = 71;
pub const DLG_ACMFORMATCHOOSE_ID: u32 = 70;
#[repr(C, packed(1))]
#[cfg(feature = "Win32_Media_Audio")]
#[derive(Clone, Copy, Default)]
...
pub const DRVM_ADD_THRU: u32 = 257;
...
pub const DRVM_IOCTL_LAST: u32 = 261;
pub const DRVM_MAPPER_CONSOLEVOICECOM_GET: u32 = 8215;
pub const DRVM_MAPPER_PREFERRED_FLAGS_PREFERREDONLY: u32 = 1;
pub const DRVM_MAPPER_PREFERRED_GET: u32 = 8213;
pub const DRVM_MAPPER_RECONFIGURE: u32 = 8193;
pub const DRVM_REMOVE_THRU: u32 = 258;
...
pub const DRV_PNPINSTALL: u32 = 2059;
pub const DRV_POWER: u32 = 15;
pub const DRV_QUERYCONFIGURE: u32 = 8;
pub const DRV_QUERYDEVICEINTERFACE: u32 = 2060;
pub const DRV_QUERYDEVICEINTERFACESIZE: u32 = 2061;
pub const DRV_QUERYDEVNODE: u32 = 2050;
pub const DRV_QUERYFUNCTIONINSTANCEID: u32 = 2065;
pub const DRV_QUERYFUNCTIONINSTANCEIDSIZE: u32 = 2066;
pub const DRV_QUERYIDFROMSTRINGID: u32 = 2064;
pub const DRV_QUERYMAPPABLE: u32 = 2053;
pub const DRV_QUERYMODULE: u32 = 2057;
pub const DRV_QUERYSTRINGID: u32 = 2062;
pub const DRV_QUERYSTRINGIDSIZE: u32 = 2063;
...
impl IAVIStream {
    pub unsafe fn Create(&self, lparam1: super::super::Foundation::LPARAM, lparam2: super::super::Foundation::LPARAM) -> windows_core::HRESULT {
...
pub const IDD_ACMFILTERCHOOSE_BTN_DELNAME: u32 = 104;
pub const IDD_ACMFILTERCHOOSE_BTN_HELP: u32 = 9;
pub const IDD_ACMFILTERCHOOSE_BTN_SETNAME: u32 = 103;
pub const IDD_ACMFILTERCHOOSE_CMB_CUSTOM: u32 = 100;
pub const IDD_ACMFILTERCHOOSE_CMB_FILTER: u32 = 102;
pub const IDD_ACMFILTERCHOOSE_CMB_FILTERTAG: u32 = 101;
pub const IDD_ACMFORMATCHOOSE_BTN_DELNAME: u32 = 104;
pub const IDD_ACMFORMATCHOOSE_BTN_HELP: u32 = 9;
pub const IDD_ACMFORMATCHOOSE_BTN_SETNAME: u32 = 103;
pub const IDD_ACMFORMATCHOOSE_CMB_CUSTOM: u32 = 100;
pub const IDD_ACMFORMATCHOOSE_CMB_FORMAT: u32 = 102;
pub const IDD_ACMFORMATCHOOSE_CMB_FORMATTAG: u32 = 101;
...
impl IGetFrame {
    ...
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn SetFormat(&self, lpbi: *const super::super::Graphics::Gdi::BITMAPINFOHEADER, lpbits: Option<*const core::ffi::c_void>, x: i32, y: i32, dx: i32, dy: i32) -> windows_core::HRESULT {
...
pub const JDD_CONFIGCHANGED: u32 = 2307;
pub const JDD_GETDEVCAPS: u32 = 2050;
pub const JDD_GETNUMDEVS: u32 = 2049;
pub const JDD_GETPOS: u32 = 2305;
pub const JDD_GETPOSEX: u32 = 2308;
pub const JDD_SETCALIBRATION: u32 = 2306;
...
pub const MCIERR_AVI_AUDIOERROR: u32 = 619;
pub const MCIERR_AVI_BADPALETTE: u32 = 620;
pub const MCIERR_AVI_CANTPLAYFULLSCREEN: u32 = 615;
pub const MCIERR_AVI_DISPLAYERROR: u32 = 618;
pub const MCIERR_AVI_NOCOMPRESSOR: u32 = 617;
pub const MCIERR_AVI_NODISPDIB: u32 = 614;
pub const MCIERR_AVI_NOTINTERLEAVED: u32 = 613;
pub const MCIERR_AVI_OLDAVIFORMAT: u32 = 612;
pub const MCIERR_AVI_TOOBIGFORVGA: u32 = 616;
...
pub const MCIERR_DGV_BAD_CLIPBOARD_RANGE: u32 = 517;
pub const MCIERR_DGV_DEVICE_LIMIT: u32 = 512;
pub const MCIERR_DGV_DEVICE_MEMORY_FULL: u32 = 516;
pub const MCIERR_DGV_DISK_FULL: u32 = 515;
pub const MCIERR_DGV_IOERR: u32 = 513;
pub const MCIERR_DGV_WORKSPACE_EMPTY: u32 = 514;
...
pub const MCIWNDF_NOTIFYMEDIA: u32 = 2048;
...
pub const MCIWNDM_GETDEVICE: u32 = 1249;
...
pub const MCIWNDM_GETERROR: u32 = 1252;
pub const MCIWNDM_GETERRORA: u32 = 1152;
pub const MCIWNDM_GETERRORW: u32 = 1252;
pub const MCIWNDM_GETFILENAME: u32 = 1248;
...
pub const MCIWNDM_GETTIMEFORMAT: u32 = 1244;
...
pub const MCIWNDM_NEW: u32 = 1258;
...
pub const MCIWNDM_OPEN: u32 = 1276;
...
pub const MCIWNDM_SETTIMEFORMAT: u32 = 1243;
...
pub const MCI_AVI_SETVIDEO_DRAW_PROCEDURE: i32 = 32768;
pub const MCI_AVI_SETVIDEO_PALETTE_COLOR: i32 = 33024;
pub const MCI_AVI_SETVIDEO_PALETTE_HALFTONE: i32 = 65535;
pub const MCI_AVI_STATUS_AUDIO_BREAKS: i32 = 32771;
pub const MCI_AVI_STATUS_FRAMES_SKIPPED: i32 = 32769;
pub const MCI_AVI_STATUS_LAST_PLAY_SPEED: i32 = 32770;
...
pub const MCI_FALSE: u32 = 531;
pub const MCI_FIRST: u32 = 2048;
pub const MCI_FLAG: u32 = 5;
pub const MCI_FORMAT_BYTES: u32 = 8;
pub const MCI_FORMAT_BYTES_S: u32 = 541;
pub const MCI_FORMAT_FRAMES: u32 = 3;
pub const MCI_FORMAT_FRAMES_S: u32 = 536;
pub const MCI_FORMAT_HMS: u32 = 1;
pub const MCI_FORMAT_HMS_S: u32 = 534;
pub const MCI_FORMAT_MILLISECONDS: u32 = 0;
pub const MCI_FORMAT_MILLISECONDS_S: u32 = 533;
pub const MCI_FORMAT_MSF: u32 = 2;
pub const MCI_FORMAT_MSF_S: u32 = 535;
pub const MCI_FORMAT_SAMPLES: u32 = 9;
pub const MCI_FORMAT_SAMPLES_S: u32 = 542;
pub const MCI_FORMAT_SMPTE_24: u32 = 4;
pub const MCI_FORMAT_SMPTE_24_S: u32 = 537;
pub const MCI_FORMAT_SMPTE_25: u32 = 5;
pub const MCI_FORMAT_SMPTE_25_S: u32 = 538;
pub const MCI_FORMAT_SMPTE_30: u32 = 6;
pub const MCI_FORMAT_SMPTE_30DROP: u32 = 7;
pub const MCI_FORMAT_SMPTE_30DROP_S: u32 = 540;
pub const MCI_FORMAT_SMPTE_30_S: u32 = 539;
pub const MCI_FORMAT_TMSF: u32 = 10;
pub const MCI_FORMAT_TMSF_S: u32 = 543;
...
pub const MCI_MCIAVI_PLAY_FULLBY2: i32 = 67108864;
pub const MCI_MCIAVI_PLAY_FULLSCREEN: i32 = 33554432;
pub const MCI_MCIAVI_PLAY_WINDOW: i32 = 16777216;
...
pub const MCI_SEQ_FILE_S: u32 = 1222;
pub const MCI_SEQ_FORMAT_SONGPTR: u32 = 16385;
pub const MCI_SEQ_FORMAT_SONGPTR_S: u32 = 1225;
pub const MCI_SEQ_MAPPER: u32 = 65535;
pub const MCI_SEQ_MAPPER_S: u32 = 1221;
pub const MCI_SEQ_MIDI: u32 = 16387;
pub const MCI_SEQ_MIDI_S: u32 = 1223;
pub const MCI_SEQ_NONE: u32 = 65533;
pub const MCI_SEQ_NONE_S: u32 = 1226;
...
pub const MCI_SEQ_SMPTE_S: u32 = 1224;
...
pub const MCI_VD_FORMAT_TRACK_S: u32 = 1029;
...
pub const MIDIMAPPER_S: u32 = 1227;
#[repr(C, packed(1))]
#[derive(Clone, Copy, Default)]
...
pub const MIDM_INIT: u32 = 100;
pub const MIDM_INIT_EX: u32 = 104;
pub const MIDM_MAPPER: u32 = 8192;
...
pub const MODM_INIT: u32 = 100;
pub const MODM_INIT_EX: u32 = 104;
pub const MODM_LONGDATA: u32 = 8;
pub const MODM_MAPPER: u32 = 8192;
...
pub const MODM_RECONFIGURE: u32 = 18280;
...
pub const MXDM_CLOSE: u32 = 4;
pub const MXDM_GETCONTROLDETAILS: u32 = 7;
pub const MXDM_GETDEVCAPS: u32 = 2;
pub const MXDM_GETLINECONTROLS: u32 = 6;
pub const MXDM_GETLINEINFO: u32 = 5;
pub const MXDM_GETNUMDEVS: u32 = 1;
pub const MXDM_INIT: u32 = 100;
pub const MXDM_INIT_EX: u32 = 104;
pub const MXDM_OPEN: u32 = 3;
pub const MXDM_SETCONTROLDETAILS: u32 = 8;
pub const MXDM_USER: u32 = 16384;
#[repr(C, packed(1))]
#[cfg(feature = "Win32_Media_Audio")]
#[derive(Clone, Copy, Default)]
...
pub const TDD_BEGINMINPERIOD: u32 = 2064;
pub const TDD_ENDMINPERIOD: u32 = 2068;
pub const TDD_GETDEVCAPS: u32 = 2060;
pub const TDD_GETSYSTEMTIME: u32 = 2056;
pub const TDD_KILLTIMEREVENT: u32 = 2048;
pub const TDD_SETTIMEREVENT: u32 = 2052;
#[repr(C, packed(1))]
#[derive(Clone, Copy, Default)]
...
pub const VFW_HIDE_CAMERACONTROL_PAGE: u32 = 4;
pub const VFW_HIDE_SETTINGS_PAGE: u32 = 1;
pub const VFW_HIDE_VIDEOSRC_PAGE: u32 = 2;
pub const VFW_OEM_ADD_PAGE: u32 = 2147483648;
pub const VFW_QUERY_DEV_CHANGED: u32 = 256;
pub const VFW_USE_DEVICE_HANDLE: u32 = 1;
pub const VFW_USE_STREAM_HANDLE: u32 = 2;
...
pub const WAVE_FORMAT_PCM_S: u32 = 1152;
...
pub const WAVE_MAPPER_S: u32 = 1153;
...
pub const WIDM_INIT: u32 = 100;
pub const WIDM_INIT_EX: u32 = 104;
...
pub const WM_CAP_DRIVER_GET_NAME: u32 = 1136;
pub const WM_CAP_DRIVER_GET_NAMEA: u32 = 1036;
pub const WM_CAP_DRIVER_GET_NAMEW: u32 = 1136;
pub const WM_CAP_DRIVER_GET_VERSION: u32 = 1137;
...
pub const WM_CAP_GET_MCI_DEVICE: u32 = 1191;
...
pub const WM_CAP_SET_CALLBACK_ERROR: u32 = 1126;
...
pub const WM_CAP_SET_CALLBACK_STATUS: u32 = 1127;
...
pub const WM_CAP_SET_MCI_DEVICE: u32 = 1190;
...
pub const WODM_INIT: u32 = 100;
pub const WODM_INIT_EX: u32 = 104;
