#[inline]
pub unsafe fn AVIBuildFilterA(lpszfilter: &mut [u8], fsaving: bool) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn AVIBuildFilterW(lpszfilter: &mut [u16], fsaving: bool) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn AVIClearClipboard() -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn AVIFileCreateStreamA<P0>(pfile: P0, ppavi: *mut Option<IAVIStream>, psi: *const AVISTREAMINFOA) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIFile>,
{
...
#[inline]
pub unsafe fn AVIFileCreateStreamW<P0>(pfile: P0, ppavi: *mut Option<IAVIStream>, psi: *const AVISTREAMINFOW) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIFile>,
{
...
#[inline]
pub unsafe fn AVIFileEndRecord<P0>(pfile: P0) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIFile>,
{
...
#[inline]
pub unsafe fn AVIFileGetStream<P0>(pfile: P0, ppavi: *mut Option<IAVIStream>, fcctype: u32, lparam: i32) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIFile>,
{
...
#[inline]
pub unsafe fn AVIFileInfoA<P0>(pfile: P0, pfi: *mut AVIFILEINFOA, lsize: i32) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIFile>,
{
...
#[inline]
pub unsafe fn AVIFileInfoW<P0>(pfile: P0, pfi: *mut AVIFILEINFOW, lsize: i32) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIFile>,
{
...
#[inline]
pub unsafe fn AVIFileOpenA<P1>(ppfile: *mut Option<IAVIFile>, szfile: P1, umode: u32, lphandler: Option<*const windows_core::GUID>) -> windows_result::Result<()>
where
...
#[inline]
pub unsafe fn AVIFileOpenW<P1>(ppfile: *mut Option<IAVIFile>, szfile: P1, umode: u32, lphandler: Option<*const windows_core::GUID>) -> windows_result::Result<()>
where
...
#[inline]
pub unsafe fn AVIFileReadData<P0>(pfile: P0, ckid: u32, lpdata: *mut core::ffi::c_void, lpcbdata: *mut i32) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIFile>,
{
...
#[inline]
pub unsafe fn AVIFileWriteData<P0>(pfile: P0, ckid: u32, lpdata: *const core::ffi::c_void, cbdata: i32) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIFile>,
{
...
#[inline]
pub unsafe fn AVIGetFromClipboard() -> windows_result::Result<IAVIFile> {
...
#[inline]
pub unsafe fn AVIMakeCompressedStream<P1>(ppscompressed: *mut Option<IAVIStream>, ppssource: P1, lpoptions: *const AVICOMPRESSOPTIONS, pclsidhandler: Option<*const windows_core::GUID>) -> windows_result::Result<()>
where
...
#[inline]
pub unsafe fn AVIMakeFileFromStreams(ppfile: *mut Option<IAVIFile>, papstreams: &[Option<IAVIStream>]) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn AVIMakeStreamFromClipboard(cfformat: u32, hglobal: super::super::Foundation::HANDLE) -> windows_result::Result<IAVIStream> {
...
#[inline]
pub unsafe fn AVIPutFileOnClipboard<P0>(pf: P0) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIFile>,
{
...
#[inline]
pub unsafe fn AVISaveA<P0, P4>(szfile: P0, pclsidhandler: Option<*const windows_core::GUID>, lpfncallback: AVISAVECALLBACK, nstreams: i32, pfile: P4, lpoptions: *const AVICOMPRESSOPTIONS) -> windows_result::Result<()>
where
...
#[inline]
pub unsafe fn AVISaveOptionsFree(plpoptions: &[*const AVICOMPRESSOPTIONS]) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn AVISaveVA<P0>(szfile: P0, pclsidhandler: Option<*const windows_core::GUID>, lpfncallback: AVISAVECALLBACK, nstreams: i32, ppavi: *const Option<IAVIStream>, plpoptions: *const *const AVICOMPRESSOPTIONS) -> windows_result::Result<()>
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
...
#[inline]
pub unsafe fn AVISaveVW<P0>(szfile: P0, pclsidhandler: Option<*const windows_core::GUID>, lpfncallback: AVISAVECALLBACK, nstreams: i32, ppavi: *const Option<IAVIStream>, plpoptions: *const *const AVICOMPRESSOPTIONS) -> windows_result::Result<()>
where
...
#[inline]
pub unsafe fn AVISaveW<P0, P4>(szfile: P0, pclsidhandler: Option<*const windows_core::GUID>, lpfncallback: AVISAVECALLBACK, nstreams: i32, pfile: P4, lpoptions: *const AVICOMPRESSOPTIONS) -> windows_result::Result<()>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P4: windows_core::Param<IAVIStream>,
{
...
#[inline]
pub unsafe fn AVIStreamBeginStreaming<P0>(pavi: P0, lstart: i32, lend: i32, lrate: i32) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
{
...
#[inline]
pub unsafe fn AVIStreamCreate(ppavi: *mut Option<IAVIStream>, lparam1: i32, lparam2: i32, pclsidhandler: Option<*const windows_core::GUID>) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn AVIStreamEndStreaming<P0>(pavi: P0) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
{
...
#[inline]
pub unsafe fn AVIStreamGetFrameClose<P0>(pg: P0) -> windows_result::Result<()>
where
    P0: windows_core::Param<IGetFrame>,
{
...
#[inline]
pub unsafe fn AVIStreamInfoA<P0>(pavi: P0, psi: *mut AVISTREAMINFOA, lsize: i32) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
{
...
#[inline]
pub unsafe fn AVIStreamInfoW<P0>(pavi: P0, psi: *mut AVISTREAMINFOW, lsize: i32) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
{
...
#[inline]
pub unsafe fn AVIStreamOpenFromFileA<P1>(ppavi: *mut Option<IAVIStream>, szfile: P1, fcctype: u32, lparam: i32, mode: u32, pclsidhandler: Option<*const windows_core::GUID>) -> windows_result::Result<()>
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
...
#[inline]
pub unsafe fn AVIStreamOpenFromFileW<P1>(ppavi: *mut Option<IAVIStream>, szfile: P1, fcctype: u32, lparam: i32, mode: u32, pclsidhandler: Option<*const windows_core::GUID>) -> windows_result::Result<()>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn AVIStreamRead<P0>(pavi: P0, lstart: i32, lsamples: i32, lpbuffer: Option<*mut core::ffi::c_void>, cbbuffer: i32, plbytes: Option<*mut i32>, plsamples: Option<*mut i32>) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
{
...
#[inline]
pub unsafe fn AVIStreamReadData<P0>(pavi: P0, fcc: u32, lp: Option<*mut core::ffi::c_void>, lpcb: *mut i32) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
{
...
#[inline]
pub unsafe fn AVIStreamReadFormat<P0>(pavi: P0, lpos: i32, lpformat: Option<*mut core::ffi::c_void>, lpcbformat: *mut i32) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
{
...
#[inline]
pub unsafe fn AVIStreamSetFormat<P0>(pavi: P0, lpos: i32, lpformat: *const core::ffi::c_void, cbformat: i32) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
{
...
#[inline]
pub unsafe fn AVIStreamWrite<P0>(pavi: P0, lstart: i32, lsamples: i32, lpbuffer: *const core::ffi::c_void, cbbuffer: i32, dwflags: u32, plsampwritten: Option<*mut i32>, plbyteswritten: Option<*mut i32>) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
{
...
#[inline]
pub unsafe fn AVIStreamWriteData<P0>(pavi: P0, fcc: u32, lp: *const core::ffi::c_void, cb: i32) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
{
...
#[inline]
pub unsafe fn CreateEditableStream<P1>(ppseditable: *mut Option<IAVIStream>, pssource: P1) -> windows_result::Result<()>
where
    P1: windows_core::Param<IAVIStream>,
{
...
#[inline]
pub unsafe fn EditStreamClone<P0>(pavi: P0) -> windows_result::Result<IAVIStream>
where
    P0: windows_core::Param<IAVIStream>,
{
...
#[inline]
pub unsafe fn EditStreamCopy<P0>(pavi: P0, plstart: *mut i32, pllength: *mut i32, ppresult: *mut Option<IAVIStream>) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
{
...
#[inline]
pub unsafe fn EditStreamCut<P0>(pavi: P0, plstart: *mut i32, pllength: *mut i32, ppresult: *mut Option<IAVIStream>) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
{
...
#[inline]
pub unsafe fn EditStreamPaste<P0, P3>(pavi: P0, plpos: *mut i32, pllength: *mut i32, pstream: P3, lstart: i32, lend: i32) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
...
#[inline]
pub unsafe fn EditStreamSetInfoA<P0>(pavi: P0, lpinfo: *const AVISTREAMINFOA, cbinfo: i32) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
{
...
#[inline]
pub unsafe fn EditStreamSetInfoW<P0>(pavi: P0, lpinfo: *const AVISTREAMINFOW, cbinfo: i32) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
{
...
#[inline]
pub unsafe fn EditStreamSetNameA<P0, P1>(pavi: P0, lpszname: P1) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
    P1: windows_core::Param<windows_core::PCSTR>,
{
...
#[inline]
pub unsafe fn EditStreamSetNameW<P0, P1>(pavi: P0, lpszname: P1) -> windows_result::Result<()>
where
    P0: windows_core::Param<IAVIStream>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
impl IAVIEditStream {
    pub unsafe fn Cut(&self, plstart: *mut i32, pllength: *mut i32, ppresult: *mut Option<IAVIStream>) -> windows_result::Result<()> {
    ...
    pub unsafe fn Copy(&self, plstart: *mut i32, pllength: *mut i32, ppresult: *mut Option<IAVIStream>) -> windows_result::Result<()> {
    ...
    pub unsafe fn Paste<P2>(&self, plpos: *mut i32, pllength: *mut i32, pstream: P2, lstart: i32, lend: i32) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IAVIStream> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn SetInfo(&self, lpinfo: *const AVISTREAMINFOW, cbinfo: i32) -> windows_result::Result<()> {
...
pub trait IAVIEditStream_Impl: windows_core::IUnknownImpl {
    fn Cut(&self, plstart: *mut i32, pllength: *mut i32, ppresult: windows_core::OutRef<IAVIStream>) -> windows_result::Result<()>;
    fn Copy(&self, plstart: *mut i32, pllength: *mut i32, ppresult: windows_core::OutRef<IAVIStream>) -> windows_result::Result<()>;
    fn Paste(&self, plpos: *mut i32, pllength: *mut i32, pstream: windows_core::Ref<IAVIStream>, lstart: i32, lend: i32) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IAVIStream>;
    fn SetInfo(&self, lpinfo: *const AVISTREAMINFOW, cbinfo: i32) -> windows_result::Result<()>;
}
...
impl IAVIFile {
    pub unsafe fn Info(&self, pfi: *mut AVIFILEINFOW, lsize: i32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Info)(windows_core::Interface::as_raw(self), pfi as _, lsize).ok() }
    }
    pub unsafe fn GetStream(&self, ppstream: *mut Option<IAVIStream>, fcctype: u32, lparam: i32) -> windows_result::Result<()> {
    ...
    pub unsafe fn CreateStream(&self, ppstream: *mut Option<IAVIStream>, psi: *const AVISTREAMINFOW) -> windows_result::Result<()> {
    ...
    pub unsafe fn WriteData(&self, ckid: u32, lpdata: *const core::ffi::c_void, cbdata: i32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).WriteData)(windows_core::Interface::as_raw(self), ckid, lpdata, cbdata).ok() }
    }
    pub unsafe fn ReadData(&self, ckid: u32, lpdata: *mut core::ffi::c_void, lpcbdata: *mut i32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ReadData)(windows_core::Interface::as_raw(self), ckid, lpdata as _, lpcbdata as _).ok() }
    }
    pub unsafe fn EndRecord(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).EndRecord)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn DeleteStream(&self, fcctype: u32, lparam: i32) -> windows_result::Result<()> {
...
pub trait IAVIFile_Impl: windows_core::IUnknownImpl {
    fn Info(&self, pfi: *mut AVIFILEINFOW, lsize: i32) -> windows_result::Result<()>;
    fn GetStream(&self, ppstream: windows_core::OutRef<IAVIStream>, fcctype: u32, lparam: i32) -> windows_result::Result<()>;
    fn CreateStream(&self, ppstream: windows_core::OutRef<IAVIStream>, psi: *const AVISTREAMINFOW) -> windows_result::Result<()>;
    fn WriteData(&self, ckid: u32, lpdata: *const core::ffi::c_void, cbdata: i32) -> windows_result::Result<()>;
    fn ReadData(&self, ckid: u32, lpdata: *mut core::ffi::c_void, lpcbdata: *mut i32) -> windows_result::Result<()>;
    fn EndRecord(&self) -> windows_result::Result<()>;
    fn DeleteStream(&self, fcctype: u32, lparam: i32) -> windows_result::Result<()>;
}
impl IAVIFile_Vtbl {
...
impl IAVIPersistFile {
    pub unsafe fn Reserved1(&self) -> windows_result::Result<()> {
...
pub trait IAVIPersistFile_Impl: super::super::System::Com::IPersistFile_Impl {
    fn Reserved1(&self) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IAVIStream {
    pub unsafe fn Create(&self, lparam1: super::super::Foundation::LPARAM, lparam2: super::super::Foundation::LPARAM) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Create)(windows_core::Interface::as_raw(self), lparam1, lparam2).ok() }
    }
    pub unsafe fn Info(&self, psi: *mut AVISTREAMINFOW, lsize: i32) -> windows_result::Result<()> {
    ...
    pub unsafe fn ReadFormat(&self, lpos: i32, lpformat: Option<*mut core::ffi::c_void>, lpcbformat: *mut i32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetFormat(&self, lpos: i32, lpformat: *const core::ffi::c_void, cbformat: i32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetFormat)(windows_core::Interface::as_raw(self), lpos, lpformat, cbformat).ok() }
    }
    pub unsafe fn Read(&self, lstart: i32, lsamples: i32, lpbuffer: Option<*mut core::ffi::c_void>, cbbuffer: i32, plbytes: Option<*mut i32>, plsamples: Option<*mut i32>) -> windows_result::Result<()> {
    ...
    pub unsafe fn Write(&self, lstart: i32, lsamples: i32, lpbuffer: *const core::ffi::c_void, cbbuffer: i32, dwflags: u32, plsampwritten: Option<*mut i32>, plbyteswritten: Option<*mut i32>) -> windows_result::Result<()> {
    ...
    pub unsafe fn Delete(&self, lstart: i32, lsamples: i32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Delete)(windows_core::Interface::as_raw(self), lstart, lsamples).ok() }
    }
    pub unsafe fn ReadData(&self, fcc: u32, lp: Option<*mut core::ffi::c_void>, lpcb: *mut i32) -> windows_result::Result<()> {
    ...
    pub unsafe fn WriteData(&self, fcc: u32, lp: *const core::ffi::c_void, cb: i32) -> windows_result::Result<()> {
...
pub trait IAVIStream_Impl: windows_core::IUnknownImpl {
    fn Create(&self, lparam1: super::super::Foundation::LPARAM, lparam2: super::super::Foundation::LPARAM) -> windows_result::Result<()>;
    fn Info(&self, psi: *mut AVISTREAMINFOW, lsize: i32) -> windows_result::Result<()>;
    fn FindSample(&self, lpos: i32, lflags: i32) -> i32;
    fn ReadFormat(&self, lpos: i32, lpformat: *mut core::ffi::c_void, lpcbformat: *mut i32) -> windows_result::Result<()>;
    fn SetFormat(&self, lpos: i32, lpformat: *const core::ffi::c_void, cbformat: i32) -> windows_result::Result<()>;
    fn Read(&self, lstart: i32, lsamples: i32, lpbuffer: *mut core::ffi::c_void, cbbuffer: i32, plbytes: *mut i32, plsamples: *mut i32) -> windows_result::Result<()>;
    fn Write(&self, lstart: i32, lsamples: i32, lpbuffer: *const core::ffi::c_void, cbbuffer: i32, dwflags: u32, plsampwritten: *mut i32, plbyteswritten: *mut i32) -> windows_result::Result<()>;
    fn Delete(&self, lstart: i32, lsamples: i32) -> windows_result::Result<()>;
    fn ReadData(&self, fcc: u32, lp: *mut core::ffi::c_void, lpcb: *mut i32) -> windows_result::Result<()>;
    fn WriteData(&self, fcc: u32, lp: *const core::ffi::c_void, cb: i32) -> windows_result::Result<()>;
    fn SetInfo(&self, lpinfo: *const AVISTREAMINFOW, cbinfo: i32) -> windows_result::Result<()>;
}
...
impl IAVIStreaming {
    pub unsafe fn Begin(&self, lstart: i32, lend: i32, lrate: i32) -> windows_result::Result<()> {
...
pub trait IAVIStreaming_Impl: windows_core::IUnknownImpl {
    fn Begin(&self, lstart: i32, lend: i32, lrate: i32) -> windows_result::Result<()>;
...
impl IGetFrame {
    ...
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn SetFormat(&self, lpbi: *const super::super::Graphics::Gdi::BITMAPINFOHEADER, lpbits: Option<*const core::ffi::c_void>, x: i32, y: i32, dx: i32, dy: i32) -> windows_result::Result<()> {
...
pub trait IGetFrame_Impl: windows_core::IUnknownImpl {
    ...
    fn Begin(&self, lstart: i32, lend: i32, lrate: i32) -> windows_result::Result<()>;
    fn End(&self) -> windows_result::Result<()>;
    fn SetFormat(&self, lpbi: *const super::super::Graphics::Gdi::BITMAPINFOHEADER, lpbits: *const core::ffi::c_void, x: i32, y: i32, dx: i32, dy: i32) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Gdi")]
impl IGetFrame_Vtbl {
