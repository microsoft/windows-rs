...
impl IWindowsMediaLibrarySharingDeviceVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWindowsMediaLibrarySharingDeviceImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWindowsMediaLibrarySharingDeviceVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, GetTypeInfoCount::<Impl, IMPL_OFFSET>, GetTypeInfo::<Impl, IMPL_OFFSET>, GetIDsOfNames::<Impl, IMPL_OFFSET>, Invoke::<Impl, IMPL_OFFSET>, DeviceID::<Impl, IMPL_OFFSET>, Authorization::<Impl, IMPL_OFFSET>, SetAuthorization::<Impl, IMPL_OFFSET>, Properties::<Impl, IMPL_OFFSET>)
    }
...
impl IWindowsMediaLibrarySharingDevicePropertiesVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWindowsMediaLibrarySharingDevicePropertiesImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWindowsMediaLibrarySharingDevicePropertiesVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, GetTypeInfoCount::<Impl, IMPL_OFFSET>, GetTypeInfo::<Impl, IMPL_OFFSET>, GetIDsOfNames::<Impl, IMPL_OFFSET>, Invoke::<Impl, IMPL_OFFSET>, Item::<Impl, IMPL_OFFSET>, Count::<Impl, IMPL_OFFSET>, GetProperty::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IWindowsMediaLibrarySharingDevicesVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWindowsMediaLibrarySharingDevicesImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWindowsMediaLibrarySharingDevicesVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, GetTypeInfoCount::<Impl, IMPL_OFFSET>, GetTypeInfo::<Impl, IMPL_OFFSET>, GetIDsOfNames::<Impl, IMPL_OFFSET>, Invoke::<Impl, IMPL_OFFSET>, Item::<Impl, IMPL_OFFSET>, Count::<Impl, IMPL_OFFSET>, GetDevice::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IWindowsMediaLibrarySharingServicesVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWindowsMediaLibrarySharingServicesImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWindowsMediaLibrarySharingServicesVtbl {
        ...
        Self(
            ...
            showShareMediaCPL::<Impl, IMPL_OFFSET>,
            userHomeMediaSharingState::<Impl, IMPL_OFFSET>,
            SetuserHomeMediaSharingState::<Impl, IMPL_OFFSET>,
            userHomeMediaSharingLibraryName::<Impl, IMPL_OFFSET>,
            SetuserHomeMediaSharingLibraryName::<Impl, IMPL_OFFSET>,
            computerHomeMediaSharingAllowedState::<Impl, IMPL_OFFSET>,
            SetcomputerHomeMediaSharingAllowedState::<Impl, IMPL_OFFSET>,
            userInternetMediaSharingState::<Impl, IMPL_OFFSET>,
            SetuserInternetMediaSharingState::<Impl, IMPL_OFFSET>,
            computerInternetMediaSharingAllowedState::<Impl, IMPL_OFFSET>,
            SetcomputerInternetMediaSharingAllowedState::<Impl, IMPL_OFFSET>,
            internetMediaSharingSecurityGroup::<Impl, IMPL_OFFSET>,
            SetinternetMediaSharingSecurityGroup::<Impl, IMPL_OFFSET>,
            allowSharingToAllDevices::<Impl, IMPL_OFFSET>,
            SetallowSharingToAllDevices::<Impl, IMPL_OFFSET>,
            setDefaultAuthorization::<Impl, IMPL_OFFSET>,
            setAuthorizationState::<Impl, IMPL_OFFSET>,
            getAllDevices::<Impl, IMPL_OFFSET>,
            customSettingsApplied::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
