...
pub struct IMDSPDevice2_Vtbl {
    ...
    #[cfg(feature = "Win32_System_Ole")]
    pub GetSpecifyPropertyPages: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void, *mut *mut windows_core::IUnknown, *mut u32) -> windows_core::HRESULT,
...
impl IMDSPDevice2_Vtbl {
    pub const fn new<Identity: IMDSPDevice2_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetSpecifyPropertyPages<Identity: IMDSPDevice2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, ppspecifyproppages: *mut *mut core::ffi::c_void, pppunknowns: *mut *mut windows_core::IUnknown, pcunks: *mut u32) -> windows_core::HRESULT {
            let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub struct IMDSPStorage4_Vtbl {
    ...
    pub GetReferences: unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32, *mut *mut IMDSPStorage) -> windows_core::HRESULT,
...
impl IMDSPStorage4_Vtbl {
    pub const fn new<Identity: IMDSPStorage4_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetReferences<Identity: IMDSPStorage4_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pdwrefs: *mut u32, pppispstorage: *mut *mut IMDSPStorage) -> windows_core::HRESULT {
            let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub struct IMDServiceProvider2_Vtbl {
    ...
    pub CreateDevice: unsafe extern "system" fn(*mut core::ffi::c_void, windows_core::PCWSTR, *mut u32, *mut *mut IMDSPDevice) -> windows_core::HRESULT,
}
...
impl IMDServiceProvider2_Vtbl {
    pub const fn new<Identity: IMDServiceProvider2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateDevice<Identity: IMDServiceProvider2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pwszdevicepath: windows_core::PCWSTR, pdwcount: *mut u32, pppdevicearray: *mut *mut IMDSPDevice) -> windows_core::HRESULT {
            let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IWMDMDevice2_Vtbl {
    pub const fn new<Identity: IWMDMDevice2_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetSpecifyPropertyPages<Identity: IWMDMDevice2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, ppspecifyproppages: *mut *mut core::ffi::c_void, pppunknowns: *mut *mut windows_core::IUnknown, pcunks: *mut u32) -> windows_core::HRESULT {
            let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub struct IWMDMStorage4_Vtbl {
    ...
    pub SetReferences: unsafe extern "system" fn(*mut core::ffi::c_void, u32, *const *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub GetReferences: unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32, *mut *mut IWMDMStorage) -> windows_core::HRESULT,
...
impl IWMDMStorage4_Vtbl {
    pub const fn new<Identity: IWMDMStorage4_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetReferences<Identity: IWMDMStorage4_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pdwrefs: *mut u32, pppiwmdmstorage: *mut *mut IWMDMStorage) -> windows_core::HRESULT {
            let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
