...
impl IMDSPObject {
    ...
    pub unsafe fn Write(&self, pdata: &u8, pdwsize: &mut u32, abmac: &mut u8) -> ::windows::core::Result<()> {
...
impl IMDSPObject2 {
    ...
    pub unsafe fn WriteOnClearChannel(&self, pdata: &u8, pdwsize: &mut u32) -> ::windows::core::Result<()> {
