...
pub const DMO_E_INVALIDSTREAMINDEX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040201u32 as _);
pub const DMO_E_INVALIDTYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040202u32 as _);
pub const DMO_E_NOTACCEPTING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040204u32 as _);
pub const DMO_E_NO_MORE_ITEMS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040206u32 as _);
pub const DMO_E_TYPE_NOT_ACCEPTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040205u32 as _);
pub const DMO_E_TYPE_NOT_SET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80040203u32 as _);
