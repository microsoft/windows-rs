...
pub unsafe fn DMOEnum(guidcategory: *const ::windows::core::GUID, dwflags: u32, cintypes: u32, pintypes: *const DMO_PARTIAL_MEDIATYPE, couttypes: u32, pouttypes: *const DMO_PARTIAL_MEDIATYPE) -> ::windows::core::Result<IEnumDMO> {
    ::windows::core::windows_link ! ( "msdmo.dll" ,"system" fn DMOEnum ( guidcategory : *const :: windows::core::GUID , dwflags : u32 , cintypes : u32 , pintypes : *const DMO_PARTIAL_MEDIATYPE , couttypes : u32 , pouttypes : *const DMO_PARTIAL_MEDIATYPE , ppenum : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
...
pub unsafe fn DMOGetName(clsiddmo: *const ::windows::core::GUID, szname: &mut [u16; 80]) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "msdmo.dll" ,"system" fn DMOGetName ( clsiddmo : *const :: windows::core::GUID , szname : :: windows::core::PWSTR ) -> :: windows::core::HRESULT );
...
pub unsafe fn DMOGetTypes(clsiddmo: *const ::windows::core::GUID, ulinputtypesrequested: u32, pulinputtypessupplied: *mut u32, pinputtypes: *mut DMO_PARTIAL_MEDIATYPE, uloutputtypesrequested: u32, puloutputtypessupplied: *mut u32, poutputtypes: *mut DMO_PARTIAL_MEDIATYPE) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "msdmo.dll" ,"system" fn DMOGetTypes ( clsiddmo : *const :: windows::core::GUID , ulinputtypesrequested : u32 , pulinputtypessupplied : *mut u32 , pinputtypes : *mut DMO_PARTIAL_MEDIATYPE , uloutputtypesrequested : u32 , puloutputtypessupplied : *mut u32 , poutputtypes : *mut DMO_PARTIAL_MEDIATYPE ) -> :: windows::core::HRESULT );
...
{
    ::windows::core::windows_link ! ( "msdmo.dll" ,"system" fn DMORegister ( szname : :: windows::core::PCWSTR , clsiddmo : *const :: windows::core::GUID , guidcategory : *const :: windows::core::GUID , dwflags : u32 , cintypes : u32 , pintypes : *const DMO_PARTIAL_MEDIATYPE , couttypes : u32 , pouttypes : *const DMO_PARTIAL_MEDIATYPE ) -> :: windows::core::HRESULT );
...
pub unsafe fn DMOUnregister(clsiddmo: *const ::windows::core::GUID, guidcategory: *const ::windows::core::GUID) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "msdmo.dll" ,"system" fn DMOUnregister ( clsiddmo : *const :: windows::core::GUID , guidcategory : *const :: windows::core::GUID ) -> :: windows::core::HRESULT );
...
pub unsafe fn MoCopyMediaType(pmtdest: *mut DMO_MEDIA_TYPE, pmtsrc: *const DMO_MEDIA_TYPE) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "msdmo.dll" ,"system" fn MoCopyMediaType ( pmtdest : *mut ::core::mem::ManuallyDrop < DMO_MEDIA_TYPE > , pmtsrc : *const ::core::mem::ManuallyDrop < DMO_MEDIA_TYPE > ) -> :: windows::core::HRESULT );
...
pub unsafe fn MoCreateMediaType(ppmt: *mut *mut DMO_MEDIA_TYPE, cbformat: u32) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "msdmo.dll" ,"system" fn MoCreateMediaType ( ppmt : *mut *mut ::core::mem::ManuallyDrop < DMO_MEDIA_TYPE > , cbformat : u32 ) -> :: windows::core::HRESULT );
...
pub unsafe fn MoDeleteMediaType(pmt: *mut DMO_MEDIA_TYPE) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "msdmo.dll" ,"system" fn MoDeleteMediaType ( pmt : *mut ::core::mem::ManuallyDrop < DMO_MEDIA_TYPE > ) -> :: windows::core::HRESULT );
...
pub unsafe fn MoDuplicateMediaType(ppmtdest: *mut *mut DMO_MEDIA_TYPE, pmtsrc: *const DMO_MEDIA_TYPE) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "msdmo.dll" ,"system" fn MoDuplicateMediaType ( ppmtdest : *mut *mut ::core::mem::ManuallyDrop < DMO_MEDIA_TYPE > , pmtsrc : *const ::core::mem::ManuallyDrop < DMO_MEDIA_TYPE > ) -> :: windows::core::HRESULT );
...
pub unsafe fn MoFreeMediaType(pmt: *mut DMO_MEDIA_TYPE) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "msdmo.dll" ,"system" fn MoFreeMediaType ( pmt : *mut ::core::mem::ManuallyDrop < DMO_MEDIA_TYPE > ) -> :: windows::core::HRESULT );
...
pub unsafe fn MoInitMediaType(pmt: *mut DMO_MEDIA_TYPE, cbformat: u32) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "msdmo.dll" ,"system" fn MoInitMediaType ( pmt : *mut ::core::mem::ManuallyDrop < DMO_MEDIA_TYPE > , cbformat : u32 ) -> :: windows::core::HRESULT );
