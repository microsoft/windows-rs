...
#[cfg(all(feature = "Win32_Data_Xml_MsXml", feature = "Win32_System_Com"))]
pub trait IXMLGraphBuilder_Impl {
...
impl IXMLGraphBuilder_Vtbl {
        ...
        <Identity as windows_core::IUnknownImpl>::Impl: IXMLGraphBuilder_Impl,
    {
        ...
        unsafe extern "system" fn SaveToXML<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, pgraph: *mut core::ffi::c_void, pbstrxml: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IXMLGraphBuilder_Impl,
        {
            unsafe {
