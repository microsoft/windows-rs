...
impl IXMLGraphBuilder {
    ...
    pub unsafe fn BuildFromXML<P0, P1>(&self, pgraph: P0, pxml: P1) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn SaveToXML<P0>(&self, pgraph: P0, pbstrxml: *mut windows_core::BSTR) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::IGraphBuilder>,
    {
    ...
    pub unsafe fn BuildFromXMLFile<P0, P1, P2>(&self, pgraph: P0, wszfilename: P1, wszbaseurl: P2) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::IGraphBuilder>,
...
pub trait IXMLGraphBuilder_Impl: windows_core::IUnknownImpl {
    fn BuildFromXML(&self, pgraph: windows_core::Ref<super::IGraphBuilder>, pxml: windows_core::Ref<super::super::super::Data::Xml::MsXml::IXMLElement>) -> windows_result::Result<()>;
    fn SaveToXML(&self, pgraph: windows_core::Ref<super::IGraphBuilder>, pbstrxml: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn BuildFromXMLFile(&self, pgraph: windows_core::Ref<super::IGraphBuilder>, wszfilename: &windows_core::PCWSTR, wszbaseurl: &windows_core::PCWSTR) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_Data_Xml_MsXml", feature = "Win32_System_Com"))]
