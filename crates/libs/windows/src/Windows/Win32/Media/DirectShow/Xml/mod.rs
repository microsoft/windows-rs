...
impl IXMLGraphBuilder {
    ...
    pub unsafe fn BuildFromXML<P0, P1>(&self, pgraph: P0, pxml: P1) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SaveToXML<P0>(&self, pgraph: P0, pbstrxml: *mut windows_core::BSTR) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::IGraphBuilder>,
    {
    ...
    pub unsafe fn BuildFromXMLFile<P0, P1, P2>(&self, pgraph: P0, wszfilename: P1, wszbaseurl: P2) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::IGraphBuilder>,
...
pub trait IXMLGraphBuilder_Impl: windows_core::IUnknownImpl {
    fn BuildFromXML(&self, pgraph: windows_core::Ref<'_, super::IGraphBuilder>, pxml: windows_core::Ref<'_, super::super::super::Data::Xml::MsXml::IXMLElement>) -> Result<(), windows_result::HRESULT>;
    fn SaveToXML(&self, pgraph: windows_core::Ref<'_, super::IGraphBuilder>, pbstrxml: *mut windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn BuildFromXMLFile(&self, pgraph: windows_core::Ref<'_, super::IGraphBuilder>, wszfilename: &windows_core::PCWSTR, wszbaseurl: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_Data_Xml_MsXml", feature = "Win32_System_Com"))]
