...
impl IXAPO {
    ...
    pub unsafe fn LockForProcess(&self, pinputlockedparameters: ::core::option::Option<&[XAPO_LOCKFORPROCESS_PARAMETERS]>, poutputlockedparameters: ::core::option::Option<&[XAPO_LOCKFORPROCESS_PARAMETERS]>) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).LockForProcess)(::core::mem::transmute_copy(self), pinputlockedparameters.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(pinputlockedparameters.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), poutputlockedparameters.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(poutputlockedparameters.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr()))).ok()
    }
    #[doc = "*Required features: 'Win32_Media_Audio_XAudio2'*"]
    ...
    pub unsafe fn Process<'a, Param4: ::windows::core::IntoParam<'a, super::super::super::Foundation::BOOL>>(&self, pinputprocessparameters: ::core::option::Option<&[XAPO_PROCESS_BUFFER_PARAMETERS]>, poutputprocessparameters: ::core::option::Option<&mut [XAPO_PROCESS_BUFFER_PARAMETERS]>, isenabled: Param4) {
        (::windows::core::Interface::vtable(self).Process)(::core::mem::transmute_copy(self), pinputprocessparameters.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(pinputprocessparameters.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), poutputprocessparameters.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(poutputprocessparameters.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), isenabled.into_param().abi())
    }
    #[doc = "*Required features: 'Win32_Media_Audio_XAudio2'*"]
...
impl IXAudio2MasteringVoice {
    ...
    pub unsafe fn SetChannelVolumes(&self, pvolumes: &[f32], operationset: u32) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).base.SetChannelVolumes)(::core::mem::transmute_copy(self), pvolumes.len() as _, ::core::mem::transmute(pvolumes.as_ptr()), ::core::mem::transmute(operationset)).ok()
    }
    #[doc = "*Required features: 'Win32_Media_Audio_XAudio2'*"]
    pub unsafe fn GetChannelVolumes(&self, pvolumes: &mut [f32]) {
        (::windows::core::Interface::vtable(self).base.GetChannelVolumes)(::core::mem::transmute_copy(self), pvolumes.len() as _, ::core::mem::transmute(pvolumes.as_ptr()))
    }
    #[doc = "*Required features: 'Win32_Media_Audio_XAudio2'*"]
...
impl IXAudio2Voice {
    ...
    #[doc = "*Required features: 'Win32_Media_Audio_XAudio2'*"]
    pub unsafe fn SetChannelVolumes(&self, pvolumes: &[f32], operationset: u32) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).SetChannelVolumes)(::core::mem::transmute_copy(self), pvolumes.len() as _, ::core::mem::transmute(pvolumes.as_ptr()), ::core::mem::transmute(operationset)).ok()
    }
    #[doc = "*Required features: 'Win32_Media_Audio_XAudio2'*"]
    pub unsafe fn GetChannelVolumes(&self, pvolumes: &mut [f32]) {
        (::windows::core::Interface::vtable(self).GetChannelVolumes)(::core::mem::transmute_copy(self), pvolumes.len() as _, ::core::mem::transmute(pvolumes.as_ptr()))
    }
    #[doc = "*Required features: 'Win32_Media_Audio_XAudio2'*"]
    pub unsafe fn SetOutputMatrix<'a, Param0: ::windows::core::IntoParam<'a, IXAudio2Voice>>(&self, pdestinationvoice: Param0, sourcechannels: u32, destinationchannels: u32, plevelmatrix: *const f32, operationset: u32) -> ::windows::core::Result<()> {
