...
impl IAudioEndpointFormatControl {
    pub unsafe fn ResetToDefault(&self, resetflags: u32) -> windows_result::Result<()> {
...
pub trait IAudioEndpointFormatControl_Impl: windows_core::IUnknownImpl {
    fn ResetToDefault(&self, resetflags: u32) -> windows_result::Result<()>;
}
...
impl IAudioEndpointOffloadStreamMeter {
    pub unsafe fn GetMeterChannelCount(&self) -> windows_result::Result<u32> {
        unsafe {
    ...
    pub unsafe fn GetMeteringData(&self, u32channelcount: u32) -> windows_result::Result<f32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IAudioEndpointOffloadStreamMeter_Impl: windows_core::IUnknownImpl {
    fn GetMeterChannelCount(&self) -> windows_result::Result<u32>;
    fn GetMeteringData(&self, u32channelcount: u32) -> windows_result::Result<f32>;
}
...
impl IAudioEndpointOffloadStreamMute {
    pub unsafe fn SetMute(&self, bmuted: u8) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetMute)(windows_core::Interface::as_raw(self), bmuted).ok() }
    }
    pub unsafe fn GetMute(&self) -> windows_result::Result<u8> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IAudioEndpointOffloadStreamMute_Impl: windows_core::IUnknownImpl {
    fn SetMute(&self, bmuted: u8) -> windows_result::Result<()>;
    fn GetMute(&self) -> windows_result::Result<u8>;
}
...
impl IAudioEndpointOffloadStreamVolume {
    pub unsafe fn GetVolumeChannelCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetChannelVolumes(&self, u32channelcount: u32, pf32volumes: *const f32, u32curvetype: super::super::KernelStreaming::AUDIO_CURVE_TYPE, pcurveduration: *const i64) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetChannelVolumes(&self, u32channelcount: u32) -> windows_result::Result<f32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IAudioEndpointOffloadStreamVolume_Impl: windows_core::IUnknownImpl {
    fn GetVolumeChannelCount(&self) -> windows_result::Result<u32>;
    fn SetChannelVolumes(&self, u32channelcount: u32, pf32volumes: *const f32, u32curvetype: super::super::KernelStreaming::AUDIO_CURVE_TYPE, pcurveduration: *const i64) -> windows_result::Result<()>;
    fn GetChannelVolumes(&self, u32channelcount: u32) -> windows_result::Result<f32>;
}
#[cfg(feature = "Win32_Media_KernelStreaming")]
...
impl IAudioEndpointVolume {
    pub unsafe fn RegisterControlChangeNotify<P0>(&self, pnotify: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn UnregisterControlChangeNotify<P0>(&self, pnotify: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IAudioEndpointVolumeCallback>,
    {
    ...
    pub unsafe fn GetChannelCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetChannelCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetMasterVolumeLevel(&self, fleveldb: f32, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetMasterVolumeLevelScalar(&self, flevel: f32, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetMasterVolumeLevel(&self) -> windows_result::Result<f32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMasterVolumeLevel)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetMasterVolumeLevelScalar(&self) -> windows_result::Result<f32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetChannelVolumeLevel(&self, nchannel: u32, fleveldb: f32, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetChannelVolumeLevelScalar(&self, nchannel: u32, flevel: f32, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetChannelVolumeLevel(&self, nchannel: u32) -> windows_result::Result<f32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetChannelVolumeLevelScalar(&self, nchannel: u32) -> windows_result::Result<f32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetMute(&self, bmute: bool, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetMute)(windows_core::Interface::as_raw(self), bmute.into(), pguideventcontext).ok() }
    }
    pub unsafe fn GetMute(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMute)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetVolumeStepInfo(&self, pnstep: *mut u32, pnstepcount: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn VolumeStepUp(&self, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).VolumeStepUp)(windows_core::Interface::as_raw(self), pguideventcontext).ok() }
    }
    pub unsafe fn VolumeStepDown(&self, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).VolumeStepDown)(windows_core::Interface::as_raw(self), pguideventcontext).ok() }
    }
    pub unsafe fn QueryHardwareSupport(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).QueryHardwareSupport)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetVolumeRange(&self, pflvolumemindb: *mut f32, pflvolumemaxdb: *mut f32, pflvolumeincrementdb: *mut f32) -> windows_result::Result<()> {
...
pub trait IAudioEndpointVolume_Impl: windows_core::IUnknownImpl {
    fn RegisterControlChangeNotify(&self, pnotify: windows_core::Ref<IAudioEndpointVolumeCallback>) -> windows_result::Result<()>;
    fn UnregisterControlChangeNotify(&self, pnotify: windows_core::Ref<IAudioEndpointVolumeCallback>) -> windows_result::Result<()>;
    fn GetChannelCount(&self) -> windows_result::Result<u32>;
    fn SetMasterVolumeLevel(&self, fleveldb: f32, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn SetMasterVolumeLevelScalar(&self, flevel: f32, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn GetMasterVolumeLevel(&self) -> windows_result::Result<f32>;
    fn GetMasterVolumeLevelScalar(&self) -> windows_result::Result<f32>;
    fn SetChannelVolumeLevel(&self, nchannel: u32, fleveldb: f32, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn SetChannelVolumeLevelScalar(&self, nchannel: u32, flevel: f32, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn GetChannelVolumeLevel(&self, nchannel: u32) -> windows_result::Result<f32>;
    fn GetChannelVolumeLevelScalar(&self, nchannel: u32) -> windows_result::Result<f32>;
    fn SetMute(&self, bmute: windows_core::BOOL, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn GetMute(&self) -> windows_result::Result<windows_core::BOOL>;
    fn GetVolumeStepInfo(&self, pnstep: *mut u32, pnstepcount: *mut u32) -> windows_result::Result<()>;
    fn VolumeStepUp(&self, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn VolumeStepDown(&self, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn QueryHardwareSupport(&self) -> windows_result::Result<u32>;
    fn GetVolumeRange(&self, pflvolumemindb: *mut f32, pflvolumemaxdb: *mut f32, pflvolumeincrementdb: *mut f32) -> windows_result::Result<()>;
}
...
impl IAudioEndpointVolumeCallback {
    pub unsafe fn OnNotify(&self, pnotify: *mut super::AUDIO_VOLUME_NOTIFICATION_DATA) -> windows_result::Result<()> {
...
pub trait IAudioEndpointVolumeCallback_Impl: windows_core::IUnknownImpl {
    fn OnNotify(&self, pnotify: *mut super::AUDIO_VOLUME_NOTIFICATION_DATA) -> windows_result::Result<()>;
}
...
impl IAudioEndpointVolumeEx {
    pub unsafe fn GetVolumeRangeChannel(&self, ichannel: u32, pflvolumemindb: *mut f32, pflvolumemaxdb: *mut f32, pflvolumeincrementdb: *mut f32) -> windows_result::Result<()> {
...
pub trait IAudioEndpointVolumeEx_Impl: IAudioEndpointVolume_Impl {
    fn GetVolumeRangeChannel(&self, ichannel: u32, pflvolumemindb: *mut f32, pflvolumemaxdb: *mut f32, pflvolumeincrementdb: *mut f32) -> windows_result::Result<()>;
}
...
impl IAudioLfxControl {
    pub unsafe fn SetLocalEffectsState(&self, benabled: bool) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetLocalEffectsState)(windows_core::Interface::as_raw(self), benabled.into()).ok() }
    }
    pub unsafe fn GetLocalEffectsState(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IAudioLfxControl_Impl: windows_core::IUnknownImpl {
    fn SetLocalEffectsState(&self, benabled: windows_core::BOOL) -> windows_result::Result<()>;
    fn GetLocalEffectsState(&self) -> windows_result::Result<windows_core::BOOL>;
}
...
pub trait IAudioMeterInformation_Impl: windows_core::IUnknownImpl {
    fn GetPeakValue(&self) -> windows_result::Result<f32>;
    fn GetMeteringChannelCount(&self) -> windows_result::Result<u32>;
    fn GetChannelsPeakValues(&self, u32channelcount: u32, afpeakvalues: *mut f32) -> windows_result::Result<()>;
    fn QueryHardwareSupport(&self) -> windows_result::Result<u32>;
}
...
impl IHardwareAudioEngineBase {
    pub unsafe fn GetAvailableOffloadConnectorCount<P0>(&self, _pwstrdeviceid: P0, _uconnectorid: u32) -> windows_result::Result<u32>
    where
    ...
    pub unsafe fn GetEngineFormat<P0>(&self, pdevice: P0, _brequestdeviceformat: bool, _ppwfxformat: *mut *mut super::WAVEFORMATEX) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn SetEngineDeviceFormat<P0>(&self, pdevice: P0, _pwfxformat: *mut super::WAVEFORMATEX) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::IMMDevice>,
    {
    ...
    pub unsafe fn SetGfxState<P0>(&self, pdevice: P0, _benable: bool) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::IMMDevice>,
    {
    ...
    pub unsafe fn GetGfxState<P0>(&self, pdevice: P0) -> windows_result::Result<windows_core::BOOL>
    where
        P0: windows_core::Param<super::IMMDevice>,
    {
        unsafe {
...
pub trait IHardwareAudioEngineBase_Impl: windows_core::IUnknownImpl {
    fn GetAvailableOffloadConnectorCount(&self, _pwstrdeviceid: &windows_core::PCWSTR, _uconnectorid: u32) -> windows_result::Result<u32>;
    fn GetEngineFormat(&self, pdevice: windows_core::Ref<super::IMMDevice>, _brequestdeviceformat: windows_core::BOOL, _ppwfxformat: *mut *mut super::WAVEFORMATEX) -> windows_result::Result<()>;
    fn SetEngineDeviceFormat(&self, pdevice: windows_core::Ref<super::IMMDevice>, _pwfxformat: *mut super::WAVEFORMATEX) -> windows_result::Result<()>;
    fn SetGfxState(&self, pdevice: windows_core::Ref<super::IMMDevice>, _benable: windows_core::BOOL) -> windows_result::Result<()>;
    fn GetGfxState(&self, pdevice: windows_core::Ref<super::IMMDevice>) -> windows_result::Result<windows_core::BOOL>;
}
