    ...
    P2: windows_core::Param<windows_core::IUnknown>,
{
    ...
    DirectSoundCaptureCreate(core::mem::transmute(pcguiddevice.unwrap_or(core::ptr::null())), core::mem::transmute(ppdsc), punkouter.param().abi()).ok()
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::IUnknown>,
{
    ...
    DirectSoundCaptureCreate8(core::mem::transmute(pcguiddevice.unwrap_or(core::ptr::null())), core::mem::transmute(ppdsc8), punkouter.param().abi()).ok()
}
#[inline]
pub unsafe fn DirectSoundCaptureEnumerateA(pdsenumcallback: LPDSENUMCALLBACKA, pcontext: Option<*const core::ffi::c_void>) -> windows_core::Result<()> {
    ...
    DirectSoundCaptureEnumerateA(core::mem::transmute(pdsenumcallback), core::mem::transmute(pcontext.unwrap_or(core::ptr::null()))).ok()
}
#[inline]
pub unsafe fn DirectSoundCaptureEnumerateW(pdsenumcallback: LPDSENUMCALLBACKW, pcontext: Option<*const core::ffi::c_void>) -> windows_core::Result<()> {
    ...
    DirectSoundCaptureEnumerateW(core::mem::transmute(pdsenumcallback), core::mem::transmute(pcontext.unwrap_or(core::ptr::null()))).ok()
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::IUnknown>,
{
    ...
    DirectSoundCreate(core::mem::transmute(pcguiddevice.unwrap_or(core::ptr::null())), core::mem::transmute(ppds), punkouter.param().abi()).ok()
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::IUnknown>,
{
    ...
    DirectSoundCreate8(core::mem::transmute(pcguiddevice.unwrap_or(core::ptr::null())), core::mem::transmute(ppds8), punkouter.param().abi()).ok()
}
#[inline]
pub unsafe fn DirectSoundEnumerateA(pdsenumcallback: LPDSENUMCALLBACKA, pcontext: Option<*const core::ffi::c_void>) -> windows_core::Result<()> {
    ...
    DirectSoundEnumerateA(core::mem::transmute(pdsenumcallback), core::mem::transmute(pcontext.unwrap_or(core::ptr::null()))).ok()
}
#[inline]
pub unsafe fn DirectSoundEnumerateW(pdsenumcallback: LPDSENUMCALLBACKW, pcontext: Option<*const core::ffi::c_void>) -> windows_core::Result<()> {
    ...
    DirectSoundEnumerateW(core::mem::transmute(pdsenumcallback), core::mem::transmute(pcontext.unwrap_or(core::ptr::null()))).ok()
}
#[inline]
pub unsafe fn DirectSoundFullDuplexCreate<P4, P9>(pcguidcapturedevice: Option<*const windows_core::GUID>, pcguidrenderdevice: Option<*const windows_core::GUID>, pcdscbufferdesc: *const DSCBUFFERDESC, pcdsbufferdesc: *const DSBUFFERDESC, hwnd: P4, dwlevel: u32, ppdsfd: *mut Option<IDirectSoundFullDuplex>, ppdscbuffer8: *mut Option<IDirectSoundCaptureBuffer8>, ppdsbuffer8: *mut Option<IDirectSoundBuffer8>, punkouter: P9) -> windows_core::Result<()>
where
    P4: windows_core::Param<super::super::super::Foundation::HWND>,
...
pub unsafe fn GetDeviceID(pguidsrc: Option<*const windows_core::GUID>) -> windows_core::Result<windows_core::GUID> {
    ...
    GetDeviceID(core::mem::transmute(pguidsrc.unwrap_or(core::ptr::null())), &mut result__).map(|| core::mem::transmute(result__))
}
...
impl IDirectSound {
    ...
    where
        P2: windows_core::Param<windows_core::IUnknown>,
    {
        (windows_core::Interface::vtable(self).CreateSoundBuffer)(windows_core::Interface::as_raw(self), core::mem::transmute(pcdsbufferdesc), core::mem::transmute(ppdsbuffer), punkouter.param().abi()).ok()
    }
    pub unsafe fn GetCaps(&self, pdscaps: *mut DSCAPS) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetCaps)(windows_core::Interface::as_raw(self), core::mem::transmute(pdscaps)).ok()
    }
    ...
    {
        (windows_core::Interface::vtable(self).SetCooperativeLevel)(windows_core::Interface::as_raw(self), hwnd.param().abi(), core::mem::transmute(dwlevel)).ok()
    }
    ...
    pub unsafe fn Initialize(&self, pcguiddevice: Option<*const windows_core::GUID>) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).Initialize)(windows_core::Interface::as_raw(self), core::mem::transmute(pcguiddevice.unwrap_or(core::ptr::null()))).ok()
    }
}
#[repr(C)]
...
impl IDirectSound3DBuffer {
    ...
    pub unsafe fn GetAllParameters(&self, pds3dbuffer: *mut DS3DBUFFER) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetAllParameters)(windows_core::Interface::as_raw(self), core::mem::transmute(pds3dbuffer)).ok()
    }
...
impl IDirectSound3DListener {
    ...
    pub unsafe fn GetAllParameters(&self, plistener: *mut DS3DLISTENER) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetAllParameters)(windows_core::Interface::as_raw(self), core::mem::transmute(plistener)).ok()
    }
...
impl IDirectSoundBuffer {
    pub unsafe fn GetCaps(&self, pdsbuffercaps: *mut DSBCAPS) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetCaps)(windows_core::Interface::as_raw(self), core::mem::transmute(pdsbuffercaps)).ok()
    }
    pub unsafe fn GetCurrentPosition(&self, pdwcurrentplaycursor: Option<*mut u32>, pdwcurrentwritecursor: Option<*mut u32>) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetCurrentPosition)(windows_core::Interface::as_raw(self), core::mem::transmute(pdwcurrentplaycursor.unwrap_or(core::ptr::null_mut())), core::mem::transmute(pdwcurrentwritecursor.unwrap_or(core::ptr::null_mut()))).ok()
    }
    pub unsafe fn GetFormat(&self, pwfxformat: Option<*mut super::WAVEFORMATEX>, dwsizeallocated: u32, pdwsizewritten: Option<*mut u32>) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetFormat)(windows_core::Interface::as_raw(self), core::mem::transmute(pwfxformat.unwrap_or(core::ptr::null_mut())), core::mem::transmute(dwsizeallocated), core::mem::transmute(pdwsizewritten.unwrap_or(core::ptr::null_mut()))).ok()
    }
    ...
    {
        (windows_core::Interface::vtable(self).Initialize)(windows_core::Interface::as_raw(self), pdirectsound.param().abi(), core::mem::transmute(pcdsbufferdesc)).ok()
    }
    ...
    pub unsafe fn Unlock(&self, pvaudioptr1: *const core::ffi::c_void, dwaudiobytes1: u32, pvaudioptr2: Option<*const core::ffi::c_void>, dwaudiobytes2: u32) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).Unlock)(windows_core::Interface::as_raw(self), core::mem::transmute(pvaudioptr1), core::mem::transmute(dwaudiobytes1), core::mem::transmute(pvaudioptr2.unwrap_or(core::ptr::null())), core::mem::transmute(dwaudiobytes2)).ok()
    }
...
impl IDirectSoundBuffer8 {
    pub unsafe fn SetFX(&self, dweffectscount: u32, pdsfxdesc: Option<*const DSEFFECTDESC>, pdwresultcodes: Option<*mut u32>) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).SetFX)(windows_core::Interface::as_raw(self), core::mem::transmute(dweffectscount), core::mem::transmute(pdsfxdesc.unwrap_or(core::ptr::null())), core::mem::transmute(pdwresultcodes.unwrap_or(core::ptr::null_mut()))).ok()
    }
    pub unsafe fn AcquireResources(&self, dwflags: u32, pdwresultcodes: &mut [u32]) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).AcquireResources)(windows_core::Interface::as_raw(self), core::mem::transmute(dwflags), pdwresultcodes.len().try_into().unwrap(), core::mem::transmute(pdwresultcodes.as_ptr())).ok()
    }
...
impl IDirectSoundCapture {
    ...
    where
        P2: windows_core::Param<windows_core::IUnknown>,
    {
        (windows_core::Interface::vtable(self).CreateCaptureBuffer)(windows_core::Interface::as_raw(self), core::mem::transmute(pcdscbufferdesc), core::mem::transmute(ppdscbuffer), punkouter.param().abi()).ok()
    }
...
impl IDirectSoundCaptureBuffer {
    ...
    pub unsafe fn GetCurrentPosition(&self, pdwcaptureposition: Option<*mut u32>, pdwreadposition: Option<*mut u32>) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetCurrentPosition)(windows_core::Interface::as_raw(self), core::mem::transmute(pdwcaptureposition.unwrap_or(core::ptr::null_mut())), core::mem::transmute(pdwreadposition.unwrap_or(core::ptr::null_mut()))).ok()
    }
    pub unsafe fn GetFormat(&self, pwfxformat: Option<*mut super::WAVEFORMATEX>, dwsizeallocated: u32, pdwsizewritten: Option<*mut u32>) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetFormat)(windows_core::Interface::as_raw(self), core::mem::transmute(pwfxformat.unwrap_or(core::ptr::null_mut())), core::mem::transmute(dwsizeallocated), core::mem::transmute(pdwsizewritten.unwrap_or(core::ptr::null_mut()))).ok()
    }
    ...
    {
        (windows_core::Interface::vtable(self).Initialize)(windows_core::Interface::as_raw(self), pdirectsoundcapture.param().abi(), core::mem::transmute(pcdscbufferdesc)).ok()
    }
    pub unsafe fn Lock(&self, dwoffset: u32, dwbytes: u32, ppvaudioptr1: *mut *mut core::ffi::c_void, pdwaudiobytes1: *mut u32, ppvaudioptr2: Option<*mut *mut core::ffi::c_void>, pdwaudiobytes2: Option<*mut u32>, dwflags: u32) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).Lock)(windows_core::Interface::as_raw(self), core::mem::transmute(dwoffset), core::mem::transmute(dwbytes), core::mem::transmute(ppvaudioptr1), core::mem::transmute(pdwaudiobytes1), core::mem::transmute(ppvaudioptr2.unwrap_or(core::ptr::null_mut())), core::mem::transmute(pdwaudiobytes2.unwrap_or(core::ptr::null_mut())), core::mem::transmute(dwflags)).ok()
    }
...
impl IDirectSoundFXChorus {
    ...
    pub unsafe fn GetAllParameters(&self, pdsfxchorus: *mut DSFXChorus) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetAllParameters)(windows_core::Interface::as_raw(self), core::mem::transmute(pdsfxchorus)).ok()
    }
}
#[repr(C)]
...
impl IDirectSoundFXCompressor {
    ...
    pub unsafe fn GetAllParameters(&self, pdsfxcompressor: *mut DSFXCompressor) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetAllParameters)(windows_core::Interface::as_raw(self), core::mem::transmute(pdsfxcompressor)).ok()
    }
}
#[repr(C)]
...
impl IDirectSoundFXDistortion {
    ...
    pub unsafe fn GetAllParameters(&self, pdsfxdistortion: *mut DSFXDistortion) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetAllParameters)(windows_core::Interface::as_raw(self), core::mem::transmute(pdsfxdistortion)).ok()
    }
}
#[repr(C)]
...
impl IDirectSoundFXEcho {
    ...
    pub unsafe fn GetAllParameters(&self, pdsfxecho: *mut DSFXEcho) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetAllParameters)(windows_core::Interface::as_raw(self), core::mem::transmute(pdsfxecho)).ok()
    }
}
#[repr(C)]
...
impl IDirectSoundFXFlanger {
    ...
    pub unsafe fn GetAllParameters(&self, pdsfxflanger: *mut DSFXFlanger) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetAllParameters)(windows_core::Interface::as_raw(self), core::mem::transmute(pdsfxflanger)).ok()
    }
}
#[repr(C)]
...
impl IDirectSoundFXI3DL2Reverb {
    ...
    pub unsafe fn GetAllParameters(&self, pdsfxi3dl2reverb: *mut DSFXI3DL2Reverb) -> windows_core::Result<()> {
        (windows_core::Interface::vtable(self).GetAllParameters)(windows_core::Interface::as_raw(self), core::mem::transmute(pdsfxi3dl2reverb)).ok()
    }
...
impl IDirectSoundFullDuplex {
    pub unsafe fn Initialize<P4>(&self, pcaptureguid: *const windows_core::GUID, prenderguid: *const windows_core::GUID, lpdscbufferdesc: *const DSCBUFFERDESC, lpdsbufferdesc: *const DSBUFFERDESC, hwnd: P4, dwlevel: u32, lplpdirectsoundcapturebuffer8: *mut Option<IDirectSoundCaptureBuffer8>, lplpdirectsoundbuffer8: *mut Option<IDirectSoundBuffer8>) -> windows_core::Result<()>
    where
        P4: windows_core::Param<super::super::super::Foundation::HWND>,
    {
