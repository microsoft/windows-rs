...
impl IDirectMusic {
    pub unsafe fn EnumPort(&self, dwindex: u32, pportcaps: *mut DMUS_PORTCAPS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).EnumPort)(windows_core::Interface::as_raw(self), dwindex, pportcaps as _).ok() }
    }
    pub unsafe fn CreateMusicBuffer<P2>(&self, pbufferdesc: *mut DMUS_BUFFERDESC, ppbuffer: *mut Option<IDirectMusicBuffer>, punkouter: P2) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn CreatePort<P3>(&self, rclsidport: *const windows_core::GUID, pportparams: *mut DMUS_PORTPARAMS8, ppport: *mut Option<IDirectMusicPort>, punkouter: P3) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn EnumMasterClock(&self, dwindex: u32, lpclockinfo: *mut DMUS_CLOCKINFO8) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).EnumMasterClock)(windows_core::Interface::as_raw(self), dwindex, lpclockinfo as _).ok() }
    }
    pub unsafe fn GetMasterClock(&self, pguidclock: *mut windows_core::GUID, ppreferenceclock: *mut Option<super::super::IReferenceClock>) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetMasterClock(&self, rguidclock: *const windows_core::GUID) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetMasterClock)(windows_core::Interface::as_raw(self), rguidclock).ok() }
    }
    pub unsafe fn Activate(&self, fenable: bool) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Activate)(windows_core::Interface::as_raw(self), fenable.into()).ok() }
    }
    pub unsafe fn GetDefaultPort(&self, pguidport: *mut windows_core::GUID) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetDefaultPort)(windows_core::Interface::as_raw(self), pguidport as _).ok() }
    }
    #[cfg(feature = "Win32_Media_Audio_DirectSound")]
    pub unsafe fn SetDirectSound<P0>(&self, pdirectsound: P0, hwnd: super::super::super::Foundation::HWND) -> windows_result::Result<()>
    where
...
pub trait IDirectMusic_Impl: windows_core::IUnknownImpl {
    fn EnumPort(&self, dwindex: u32, pportcaps: *mut DMUS_PORTCAPS) -> windows_result::Result<()>;
    fn CreateMusicBuffer(&self, pbufferdesc: *mut DMUS_BUFFERDESC, ppbuffer: windows_core::OutRef<IDirectMusicBuffer>, punkouter: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn CreatePort(&self, rclsidport: *const windows_core::GUID, pportparams: *mut DMUS_PORTPARAMS8, ppport: windows_core::OutRef<IDirectMusicPort>, punkouter: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn EnumMasterClock(&self, dwindex: u32, lpclockinfo: *mut DMUS_CLOCKINFO8) -> windows_result::Result<()>;
    fn GetMasterClock(&self, pguidclock: *mut windows_core::GUID, ppreferenceclock: windows_core::OutRef<super::super::IReferenceClock>) -> windows_result::Result<()>;
    fn SetMasterClock(&self, rguidclock: *const windows_core::GUID) -> windows_result::Result<()>;
    fn Activate(&self, fenable: windows_core::BOOL) -> windows_result::Result<()>;
    fn GetDefaultPort(&self, pguidport: *mut windows_core::GUID) -> windows_result::Result<()>;
    fn SetDirectSound(&self, pdirectsound: windows_core::Ref<super::DirectSound::IDirectSound>, hwnd: super::super::super::Foundation::HWND) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Media_Audio_DirectSound")]
...
impl IDirectMusic8 {
    pub unsafe fn SetExternalMasterClock<P0>(&self, pclock: P0) -> windows_result::Result<()>
    where
...
pub trait IDirectMusic8_Impl: IDirectMusic_Impl {
    fn SetExternalMasterClock(&self, pclock: windows_core::Ref<super::super::IReferenceClock>) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Media_Audio_DirectSound")]
...
impl IDirectMusicBuffer {
    ...
    pub unsafe fn TotalTime(&self, prttime: *mut i64) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).TotalTime)(windows_core::Interface::as_raw(self), prttime as _).ok() }
    }
    pub unsafe fn PackStructured(&self, rt: i64, dwchannelgroup: u32, dwchannelmessage: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn PackUnstructured(&self, rt: i64, dwchannelgroup: u32, cb: u32, lpb: *mut u8) -> windows_result::Result<()> {
    ...
    pub unsafe fn ResetReadPtr(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ResetReadPtr)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn GetNextEvent(&self, prt: *mut i64, pdwchannelgroup: *mut u32, pdwlength: *mut u32, ppdata: *mut *mut u8) -> windows_result::Result<()> {
...
pub trait IDirectMusicBuffer_Impl: windows_core::IUnknownImpl {
    ...
    fn TotalTime(&self, prttime: *mut i64) -> windows_result::Result<()>;
    fn PackStructured(&self, rt: i64, dwchannelgroup: u32, dwchannelmessage: u32) -> windows_result::Result<()>;
    fn PackUnstructured(&self, rt: i64, dwchannelgroup: u32, cb: u32, lpb: *mut u8) -> windows_result::Result<()>;
    fn ResetReadPtr(&self) -> windows_result::Result<()>;
    fn GetNextEvent(&self, prt: *mut i64, pdwchannelgroup: *mut u32, pdwlength: *mut u32, ppdata: *mut *mut u8) -> windows_result::Result<()>;
    fn GetRawBufferPtr(&self, ppdata: *mut *mut u8) -> windows_result::Result<()>;
    fn GetStartTime(&self, prt: *mut i64) -> windows_result::Result<()>;
    fn GetUsedBytes(&self, pcb: *mut u32) -> windows_result::Result<()>;
    fn GetMaxBytes(&self, pcb: *mut u32) -> windows_result::Result<()>;
    fn GetBufferFormat(&self, pguidformat: *mut windows_core::GUID) -> windows_result::Result<()>;
    fn SetStartTime(&self, rt: i64) -> windows_result::Result<()>;
    fn SetUsedBytes(&self, cb: u32) -> windows_result::Result<()>;
}
...
impl IDirectMusicCollection {
    pub unsafe fn GetInstrument(&self, dwpatch: u32) -> windows_result::Result<IDirectMusicInstrument> {
        unsafe {
    ...
    pub unsafe fn EnumInstrument<P2>(&self, dwindex: u32, pdwpatch: *mut u32, pwszname: P2, dwnamelen: u32) -> windows_result::Result<()>
    where
...
pub trait IDirectMusicCollection_Impl: windows_core::IUnknownImpl {
    fn GetInstrument(&self, dwpatch: u32) -> windows_result::Result<IDirectMusicInstrument>;
    fn EnumInstrument(&self, dwindex: u32, pdwpatch: *mut u32, pwszname: &windows_core::PCWSTR, dwnamelen: u32) -> windows_result::Result<()>;
}
...
impl IDirectMusicDownload {
    pub unsafe fn GetBuffer(&self, ppvbuffer: *mut *mut core::ffi::c_void, pdwsize: *mut u32) -> windows_result::Result<()> {
...
pub trait IDirectMusicDownload_Impl: windows_core::IUnknownImpl {
    fn GetBuffer(&self, ppvbuffer: *mut *mut core::ffi::c_void, pdwsize: *mut u32) -> windows_result::Result<()>;
}
...
impl IDirectMusicInstrument {
    pub unsafe fn GetPatch(&self, pdwpatch: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetPatch)(windows_core::Interface::as_raw(self), pdwpatch as _).ok() }
    }
    pub unsafe fn SetPatch(&self, dwpatch: u32) -> windows_result::Result<()> {
...
pub trait IDirectMusicInstrument_Impl: windows_core::IUnknownImpl {
    fn GetPatch(&self, pdwpatch: *mut u32) -> windows_result::Result<()>;
    fn SetPatch(&self, dwpatch: u32) -> windows_result::Result<()>;
}
...
impl IDirectMusicPort {
    pub unsafe fn PlayBuffer<P0>(&self, pbuffer: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn SetReadNotificationHandle(&self, hevent: super::super::super::Foundation::HANDLE) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetReadNotificationHandle)(windows_core::Interface::as_raw(self), hevent).ok() }
    }
    pub unsafe fn Read<P0>(&self, pbuffer: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IDirectMusicBuffer>,
    {
        unsafe { (windows_core::Interface::vtable(self).Read)(windows_core::Interface::as_raw(self), pbuffer.param().abi()).ok() }
    }
    pub unsafe fn DownloadInstrument<P0>(&self, pinstrument: P0, ppdownloadedinstrument: *mut Option<IDirectMusicDownloadedInstrument>, pnoteranges: *mut DMUS_NOTERANGE, dwnumnoteranges: u32) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn UnloadInstrument<P0>(&self, pdownloadedinstrument: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetLatencyClock(&self) -> windows_result::Result<super::super::IReferenceClock> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetRunningStats(&self, pstats: *mut DMUS_SYNTHSTATS) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetCaps(&self, pportcaps: *mut DMUS_PORTCAPS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetCaps)(windows_core::Interface::as_raw(self), pportcaps as _).ok() }
    }
    #[cfg(feature = "Win32_System_IO")]
    pub unsafe fn DeviceIoControl(&self, dwiocontrolcode: u32, lpinbuffer: *mut core::ffi::c_void, ninbuffersize: u32, lpoutbuffer: *mut core::ffi::c_void, noutbuffersize: u32, lpbytesreturned: *mut u32, lpoverlapped: *mut super::super::super::System::IO::OVERLAPPED) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetNumChannelGroups(&self, dwchannelgroups: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetNumChannelGroups)(windows_core::Interface::as_raw(self), dwchannelgroups).ok() }
    }
    pub unsafe fn GetNumChannelGroups(&self, pdwchannelgroups: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Activate(&self, factive: bool) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Activate)(windows_core::Interface::as_raw(self), factive.into()).ok() }
    }
    pub unsafe fn SetChannelPriority(&self, dwchannelgroup: u32, dwchannel: u32, dwpriority: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetChannelPriority(&self, dwchannelgroup: u32, dwchannel: u32, pdwpriority: *mut u32) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_Media_Audio_DirectSound")]
    pub unsafe fn SetDirectSound<P0, P1>(&self, pdirectsound: P0, pdirectsoundbuffer: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::DirectSound::IDirectSound>,
    ...
    pub unsafe fn GetFormat(&self, pwaveformatex: *mut super::WAVEFORMATEX, pdwwaveformatexsize: *mut u32, pdwbuffersize: *mut u32) -> windows_result::Result<()> {
...
pub trait IDirectMusicPort_Impl: windows_core::IUnknownImpl {
    fn PlayBuffer(&self, pbuffer: windows_core::Ref<IDirectMusicBuffer>) -> windows_result::Result<()>;
    fn SetReadNotificationHandle(&self, hevent: super::super::super::Foundation::HANDLE) -> windows_result::Result<()>;
    fn Read(&self, pbuffer: windows_core::Ref<IDirectMusicBuffer>) -> windows_result::Result<()>;
    fn DownloadInstrument(&self, pinstrument: windows_core::Ref<IDirectMusicInstrument>, ppdownloadedinstrument: windows_core::OutRef<IDirectMusicDownloadedInstrument>, pnoteranges: *mut DMUS_NOTERANGE, dwnumnoteranges: u32) -> windows_result::Result<()>;
    fn UnloadInstrument(&self, pdownloadedinstrument: windows_core::Ref<IDirectMusicDownloadedInstrument>) -> windows_result::Result<()>;
    fn GetLatencyClock(&self) -> windows_result::Result<super::super::IReferenceClock>;
    fn GetRunningStats(&self, pstats: *mut DMUS_SYNTHSTATS) -> windows_result::Result<()>;
    fn Compact(&self) -> windows_result::Result<()>;
    fn GetCaps(&self, pportcaps: *mut DMUS_PORTCAPS) -> windows_result::Result<()>;
    fn DeviceIoControl(&self, dwiocontrolcode: u32, lpinbuffer: *mut core::ffi::c_void, ninbuffersize: u32, lpoutbuffer: *mut core::ffi::c_void, noutbuffersize: u32, lpbytesreturned: *mut u32, lpoverlapped: *mut super::super::super::System::IO::OVERLAPPED) -> windows_result::Result<()>;
    fn SetNumChannelGroups(&self, dwchannelgroups: u32) -> windows_result::Result<()>;
    fn GetNumChannelGroups(&self, pdwchannelgroups: *mut u32) -> windows_result::Result<()>;
    fn Activate(&self, factive: windows_core::BOOL) -> windows_result::Result<()>;
    fn SetChannelPriority(&self, dwchannelgroup: u32, dwchannel: u32, dwpriority: u32) -> windows_result::Result<()>;
    fn GetChannelPriority(&self, dwchannelgroup: u32, dwchannel: u32, pdwpriority: *mut u32) -> windows_result::Result<()>;
    fn SetDirectSound(&self, pdirectsound: windows_core::Ref<super::DirectSound::IDirectSound>, pdirectsoundbuffer: windows_core::Ref<super::DirectSound::IDirectSoundBuffer>) -> windows_result::Result<()>;
    fn GetFormat(&self, pwaveformatex: *mut super::WAVEFORMATEX, pdwwaveformatexsize: *mut u32, pdwbuffersize: *mut u32) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_Media_Audio_DirectSound", feature = "Win32_System_IO"))]
...
impl IDirectMusicPortDownload {
    pub unsafe fn GetBuffer(&self, dwdlid: u32) -> windows_result::Result<IDirectMusicDownload> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AllocateBuffer(&self, dwsize: u32) -> windows_result::Result<IDirectMusicDownload> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetDLId(&self, pdwstartdlid: *mut u32, dwcount: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetDLId)(windows_core::Interface::as_raw(self), pdwstartdlid as _, dwcount).ok() }
    }
    pub unsafe fn GetAppend(&self, pdwappend: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetAppend)(windows_core::Interface::as_raw(self), pdwappend as _).ok() }
    }
    pub unsafe fn Download<P0>(&self, pidmdownload: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn Unload<P0>(&self, pidmdownload: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IDirectMusicDownload>,
    {
...
pub trait IDirectMusicPortDownload_Impl: windows_core::IUnknownImpl {
    fn GetBuffer(&self, dwdlid: u32) -> windows_result::Result<IDirectMusicDownload>;
    fn AllocateBuffer(&self, dwsize: u32) -> windows_result::Result<IDirectMusicDownload>;
    fn GetDLId(&self, pdwstartdlid: *mut u32, dwcount: u32) -> windows_result::Result<()>;
    fn GetAppend(&self, pdwappend: *mut u32) -> windows_result::Result<()>;
    fn Download(&self, pidmdownload: windows_core::Ref<IDirectMusicDownload>) -> windows_result::Result<()>;
    fn Unload(&self, pidmdownload: windows_core::Ref<IDirectMusicDownload>) -> windows_result::Result<()>;
}
...
impl IDirectMusicSynth {
    pub unsafe fn Open(&self, pportparams: *mut DMUS_PORTPARAMS8) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetNumChannelGroups(&self, dwgroups: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetNumChannelGroups)(windows_core::Interface::as_raw(self), dwgroups).ok() }
    }
    pub unsafe fn Download(&self, phdownload: *mut super::super::super::Foundation::HANDLE, pvdata: *mut core::ffi::c_void, pbfree: *mut windows_core::BOOL) -> windows_result::Result<()> {
    ...
    pub unsafe fn Unload(&self, hdownload: super::super::super::Foundation::HANDLE, lpfreehandle: isize, huserdata: super::super::super::Foundation::HANDLE) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Unload)(windows_core::Interface::as_raw(self), hdownload, lpfreehandle, huserdata).ok() }
    }
    pub unsafe fn PlayBuffer(&self, rt: i64, pbbuffer: *mut u8, cbbuffer: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).PlayBuffer)(windows_core::Interface::as_raw(self), rt, pbbuffer as _, cbbuffer).ok() }
    }
    pub unsafe fn GetRunningStats(&self, pstats: *mut DMUS_SYNTHSTATS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetRunningStats)(windows_core::Interface::as_raw(self), pstats as _).ok() }
    }
    pub unsafe fn GetPortCaps(&self, pcaps: *mut DMUS_PORTCAPS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetPortCaps)(windows_core::Interface::as_raw(self), pcaps as _).ok() }
    }
    pub unsafe fn SetMasterClock<P0>(&self, pclock: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::IReferenceClock>,
    {
    ...
    pub unsafe fn SetSynthSink<P0>(&self, psynthsink: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn Render(&self, pbuffer: *mut i16, dwlength: u32, llposition: i64) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFormat(&self, pwaveformatex: *mut super::WAVEFORMATEX, pdwwaveformatexsize: *mut u32) -> windows_result::Result<()> {
...
pub trait IDirectMusicSynth_Impl: windows_core::IUnknownImpl {
    fn Open(&self, pportparams: *mut DMUS_PORTPARAMS8) -> windows_result::Result<()>;
    fn Close(&self) -> windows_result::Result<()>;
    fn SetNumChannelGroups(&self, dwgroups: u32) -> windows_result::Result<()>;
    fn Download(&self, phdownload: *mut super::super::super::Foundation::HANDLE, pvdata: *mut core::ffi::c_void, pbfree: *mut windows_core::BOOL) -> windows_result::Result<()>;
    fn Unload(&self, hdownload: super::super::super::Foundation::HANDLE, lpfreehandle: isize, huserdata: super::super::super::Foundation::HANDLE) -> windows_result::Result<()>;
    fn PlayBuffer(&self, rt: i64, pbbuffer: *mut u8, cbbuffer: u32) -> windows_result::Result<()>;
    fn GetRunningStats(&self, pstats: *mut DMUS_SYNTHSTATS) -> windows_result::Result<()>;
    fn GetPortCaps(&self, pcaps: *mut DMUS_PORTCAPS) -> windows_result::Result<()>;
    fn SetMasterClock(&self, pclock: windows_core::Ref<super::super::IReferenceClock>) -> windows_result::Result<()>;
    fn GetLatencyClock(&self) -> windows_result::Result<super::super::IReferenceClock>;
    fn Activate(&self, fenable: windows_core::BOOL) -> windows_result::Result<()>;
    fn SetSynthSink(&self, psynthsink: windows_core::Ref<IDirectMusicSynthSink>) -> windows_result::Result<()>;
    fn Render(&self, pbuffer: *mut i16, dwlength: u32, llposition: i64) -> windows_result::Result<()>;
    fn SetChannelPriority(&self, dwchannelgroup: u32, dwchannel: u32, dwpriority: u32) -> windows_result::Result<()>;
    fn GetChannelPriority(&self, dwchannelgroup: u32, dwchannel: u32, pdwpriority: *mut u32) -> windows_result::Result<()>;
    fn GetFormat(&self, pwaveformatex: *mut super::WAVEFORMATEX, pdwwaveformatexsize: *mut u32) -> windows_result::Result<()>;
    fn GetAppend(&self, pdwappend: *mut u32) -> windows_result::Result<()>;
}
...
impl IDirectMusicSynth8 {
    pub unsafe fn PlayVoice(&self, rt: i64, dwvoiceid: u32, dwchannelgroup: u32, dwchannel: u32, dwdlid: u32, prpitch: i32, vrvolume: i32, stvoicestart: u64, stloopstart: u64, stloopend: u64) -> windows_result::Result<()> {
    ...
    pub unsafe fn StopVoice(&self, rt: i64, dwvoiceid: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).StopVoice)(windows_core::Interface::as_raw(self), rt, dwvoiceid).ok() }
    }
    pub unsafe fn GetVoiceState(&self, dwvoice: *mut u32, cbvoice: u32, dwvoicestate: *mut DMUS_VOICE_STATE) -> windows_result::Result<()> {
    ...
    pub unsafe fn Refresh(&self, dwdownloadid: u32, dwflags: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Refresh)(windows_core::Interface::as_raw(self), dwdownloadid, dwflags).ok() }
    }
    pub unsafe fn AssignChannelToBuses(&self, dwchannelgroup: u32, dwchannel: u32, pdwbuses: *mut u32, cbuses: u32) -> windows_result::Result<()> {
...
pub trait IDirectMusicSynth8_Impl: IDirectMusicSynth_Impl {
    fn PlayVoice(&self, rt: i64, dwvoiceid: u32, dwchannelgroup: u32, dwchannel: u32, dwdlid: u32, prpitch: i32, vrvolume: i32, stvoicestart: u64, stloopstart: u64, stloopend: u64) -> windows_result::Result<()>;
    fn StopVoice(&self, rt: i64, dwvoiceid: u32) -> windows_result::Result<()>;
    fn GetVoiceState(&self, dwvoice: *mut u32, cbvoice: u32, dwvoicestate: *mut DMUS_VOICE_STATE) -> windows_result::Result<()>;
    fn Refresh(&self, dwdownloadid: u32, dwflags: u32) -> windows_result::Result<()>;
    fn AssignChannelToBuses(&self, dwchannelgroup: u32, dwchannel: u32, pdwbuses: *mut u32, cbuses: u32) -> windows_result::Result<()>;
}
...
impl IDirectMusicSynthSink {
    pub unsafe fn Init<P0>(&self, psynth: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn SampleToRefTime(&self, llsampletime: i64, prftime: *mut i64) -> windows_result::Result<()> {
    ...
    pub unsafe fn RefTimeToSample(&self, rftime: i64, pllsampletime: *mut i64) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetDesiredBufferSize(&self, pdwbuffersizeinsamples: *mut u32) -> windows_result::Result<()> {
...
pub trait IDirectMusicSynthSink_Impl: windows_core::IUnknownImpl {
    fn Init(&self, psynth: windows_core::Ref<IDirectMusicSynth>) -> windows_result::Result<()>;
    fn SetMasterClock(&self, pclock: windows_core::Ref<super::super::IReferenceClock>) -> windows_result::Result<()>;
    fn GetLatencyClock(&self) -> windows_result::Result<super::super::IReferenceClock>;
    fn Activate(&self, fenable: windows_core::BOOL) -> windows_result::Result<()>;
    fn SampleToRefTime(&self, llsampletime: i64, prftime: *mut i64) -> windows_result::Result<()>;
    fn RefTimeToSample(&self, rftime: i64, pllsampletime: *mut i64) -> windows_result::Result<()>;
    fn SetDirectSound(&self, pdirectsound: windows_core::Ref<super::DirectSound::IDirectSound>, pdirectsoundbuffer: windows_core::Ref<super::DirectSound::IDirectSoundBuffer>) -> windows_result::Result<()>;
    fn GetDesiredBufferSize(&self, pdwbuffersizeinsamples: *mut u32) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Media_Audio_DirectSound")]
...
impl IDirectMusicThru {
    pub unsafe fn ThruChannel<P4>(&self, dwsourcechannelgroup: u32, dwsourcechannel: u32, dwdestinationchannelgroup: u32, dwdestinationchannel: u32, pdestinationport: P4) -> windows_result::Result<()>
    where
...
pub trait IDirectMusicThru_Impl: windows_core::IUnknownImpl {
    fn ThruChannel(&self, dwsourcechannelgroup: u32, dwsourcechannel: u32, dwdestinationchannelgroup: u32, dwdestinationchannel: u32, pdestinationport: windows_core::Ref<IDirectMusicPort>) -> windows_result::Result<()>;
}
