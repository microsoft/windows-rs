...
impl IDirectMusic_Vtbl {
        ...
        <Identity as windows_core::IUnknownImpl>::Impl: IDirectMusic_Impl,
    {
        ...
        unsafe extern "system" fn Activate<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, fenable: windows_core::BOOL) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IDirectMusic_Impl,
        {
            unsafe {
...
pub trait IDirectMusicBuffer_Impl {
...
pub trait IDirectMusicCollection_Impl {
...
pub trait IDirectMusicDownload_Impl {
...
pub trait IDirectMusicDownloadedInstrument_Impl {}
impl IDirectMusicDownloadedInstrument_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IDirectMusicDownloadedInstrument_Impl,
    {
...
pub trait IDirectMusicInstrument_Impl {
...
pub trait IDirectMusicPort_Impl {
...
impl IDirectMusicPort_Vtbl {
        ...
        <Identity as windows_core::IUnknownImpl>::Impl: IDirectMusicPort_Impl,
    {
        ...
        unsafe extern "system" fn Activate<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, factive: windows_core::BOOL) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IDirectMusicPort_Impl,
        {
            unsafe {
...
pub trait IDirectMusicPortDownload_Impl {
...
pub trait IDirectMusicSynth_Impl {
...
impl IDirectMusicSynth_Vtbl {
        ...
        <Identity as windows_core::IUnknownImpl>::Impl: IDirectMusicSynth_Impl,
    {
        ...
        unsafe extern "system" fn Download<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, phdownload: *mut super::super::super::Foundation::HANDLE, pvdata: *mut core::ffi::c_void, pbfree: *mut windows_core::BOOL) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IDirectMusicSynth_Impl,
        {
            unsafe {
...
#[cfg(feature = "Win32_Media_Audio_DirectSound")]
pub trait IDirectMusicSynthSink_Impl {
...
pub trait IDirectMusicThru_Impl {
