...
#[inline]
pub unsafe fn ActivateAudioInterfaceAsync<P0, P3>(deviceinterfacepath: P0, riid: *const windows_core::GUID, activationparams: Option<*const super::super::System::Com::StructuredStorage::PROPVARIANT>, completionhandler: P3) -> windows_result::Result<IActivateAudioInterfaceAsyncOperation>
where
...
#[inline]
pub unsafe fn CoRegisterMessageFilter<P0>(lpmessagefilter: P0, lplpmessagefilter: Option<*mut Option<IMessageFilter>>) -> windows_result::Result<()>
where
...
#[inline]
pub unsafe fn CreateCaptureAudioStateMonitor() -> windows_result::Result<IAudioStateMonitor> {
...
#[inline]
pub unsafe fn CreateCaptureAudioStateMonitorForCategory(category: AUDIO_STREAM_CATEGORY) -> windows_result::Result<IAudioStateMonitor> {
...
#[inline]
pub unsafe fn CreateCaptureAudioStateMonitorForCategoryAndDeviceId<P1>(category: AUDIO_STREAM_CATEGORY, deviceid: P1) -> windows_result::Result<IAudioStateMonitor>
where
...
#[inline]
pub unsafe fn CreateCaptureAudioStateMonitorForCategoryAndDeviceRole(category: AUDIO_STREAM_CATEGORY, role: ERole) -> windows_result::Result<IAudioStateMonitor> {
...
#[inline]
pub unsafe fn CreateRenderAudioStateMonitor() -> windows_result::Result<IAudioStateMonitor> {
...
#[inline]
pub unsafe fn CreateRenderAudioStateMonitorForCategory(category: AUDIO_STREAM_CATEGORY) -> windows_result::Result<IAudioStateMonitor> {
...
#[inline]
pub unsafe fn CreateRenderAudioStateMonitorForCategoryAndDeviceId<P1>(category: AUDIO_STREAM_CATEGORY, deviceid: P1) -> windows_result::Result<IAudioStateMonitor>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn CreateRenderAudioStateMonitorForCategoryAndDeviceRole(category: AUDIO_STREAM_CATEGORY, role: ERole) -> windows_result::Result<IAudioStateMonitor> {
...
impl IAcousticEchoCancellationControl {
    pub unsafe fn SetEchoCancellationRenderEndpoint<P0>(&self, endpointid: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IAcousticEchoCancellationControl_Impl: windows_core::IUnknownImpl {
    fn SetEchoCancellationRenderEndpoint(&self, endpointid: &windows_core::PCWSTR) -> windows_result::Result<()>;
}
...
impl IActivateAudioInterfaceAsyncOperation {
    pub unsafe fn GetActivateResult(&self, activateresult: *mut windows_core::HRESULT, activatedinterface: *mut Option<windows_core::IUnknown>) -> windows_result::Result<()> {
...
pub trait IActivateAudioInterfaceAsyncOperation_Impl: windows_core::IUnknownImpl {
    fn GetActivateResult(&self, activateresult: *mut windows_core::HRESULT, activatedinterface: windows_core::OutRef<windows_core::IUnknown>) -> windows_result::Result<()>;
}
...
impl IActivateAudioInterfaceCompletionHandler {
    pub unsafe fn ActivateCompleted<P0>(&self, activateoperation: P0) -> windows_result::Result<()>
    where
...
pub trait IActivateAudioInterfaceCompletionHandler_Impl: windows_core::IUnknownImpl {
    fn ActivateCompleted(&self, activateoperation: windows_core::Ref<IActivateAudioInterfaceAsyncOperation>) -> windows_result::Result<()>;
}
...
impl IAudioAmbisonicsControl {
    pub unsafe fn SetData(&self, pambisonicsparams: &[AMBISONICS_PARAMS]) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetHeadTracking(&self, benableheadtracking: bool) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetHeadTracking)(windows_core::Interface::as_raw(self), benableheadtracking.into()).ok() }
    }
    pub unsafe fn GetHeadTracking(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetHeadTracking)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetRotation(&self, x: f32, y: f32, z: f32, w: f32) -> windows_result::Result<()> {
...
pub trait IAudioAmbisonicsControl_Impl: windows_core::IUnknownImpl {
    fn SetData(&self, pambisonicsparams: *const AMBISONICS_PARAMS, cbambisonicsparams: u32) -> windows_result::Result<()>;
    fn SetHeadTracking(&self, benableheadtracking: windows_core::BOOL) -> windows_result::Result<()>;
    fn GetHeadTracking(&self) -> windows_result::Result<windows_core::BOOL>;
    fn SetRotation(&self, x: f32, y: f32, z: f32, w: f32) -> windows_result::Result<()>;
}
...
impl IAudioAutoGainControl {
    pub unsafe fn GetEnabled(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetEnabled)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetEnabled(&self, benable: bool, pguideventcontext: Option<*const windows_core::GUID>) -> windows_result::Result<()> {
...
pub trait IAudioAutoGainControl_Impl: windows_core::IUnknownImpl {
    fn GetEnabled(&self) -> windows_result::Result<windows_core::BOOL>;
    fn SetEnabled(&self, benable: windows_core::BOOL, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
}
...
impl IAudioCaptureClient {
    pub unsafe fn GetBuffer(&self, ppdata: *mut *mut u8, pnumframestoread: *mut u32, pdwflags: *mut u32, pu64deviceposition: Option<*mut u64>, pu64qpcposition: Option<*mut u64>) -> windows_result::Result<()> {
    ...
    pub unsafe fn ReleaseBuffer(&self, numframesread: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ReleaseBuffer)(windows_core::Interface::as_raw(self), numframesread).ok() }
    }
    pub unsafe fn GetNextPacketSize(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IAudioCaptureClient_Impl: windows_core::IUnknownImpl {
    fn GetBuffer(&self, ppdata: *mut *mut u8, pnumframestoread: *mut u32, pdwflags: *mut u32, pu64deviceposition: *mut u64, pu64qpcposition: *mut u64) -> windows_result::Result<()>;
    fn ReleaseBuffer(&self, numframesread: u32) -> windows_result::Result<()>;
    fn GetNextPacketSize(&self) -> windows_result::Result<u32>;
}
...
impl IAudioChannelConfig {
    pub unsafe fn SetChannelConfig(&self, dwconfig: u32, pguideventcontext: Option<*const windows_core::GUID>) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetChannelConfig(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IAudioChannelConfig_Impl: windows_core::IUnknownImpl {
    fn SetChannelConfig(&self, dwconfig: u32, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn GetChannelConfig(&self) -> windows_result::Result<u32>;
}
...
impl IAudioClient {
    pub unsafe fn Initialize(&self, sharemode: AUDCLNT_SHAREMODE, streamflags: u32, hnsbufferduration: i64, hnsperiodicity: i64, pformat: *const WAVEFORMATEX, audiosessionguid: Option<*const windows_core::GUID>) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetMixFormat(&self) -> windows_result::Result<*mut WAVEFORMATEX> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMixFormat)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetDevicePeriod(&self, phnsdefaultdeviceperiod: Option<*mut i64>, phnsminimumdeviceperiod: Option<*mut i64>) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetService<T>(&self) -> windows_result::Result<T>
    where
...
pub trait IAudioClient_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, sharemode: AUDCLNT_SHAREMODE, streamflags: u32, hnsbufferduration: i64, hnsperiodicity: i64, pformat: *const WAVEFORMATEX, audiosessionguid: *const windows_core::GUID) -> windows_result::Result<()>;
    ...
    fn GetDevicePeriod(&self, phnsdefaultdeviceperiod: *mut i64, phnsminimumdeviceperiod: *mut i64) -> windows_result::Result<()>;
    ...
    fn GetService(&self, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
}
...
impl IAudioClient2 {
    pub unsafe fn IsOffloadCapable(&self, category: AUDIO_STREAM_CATEGORY) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetClientProperties(&self, pproperties: *const AudioClientProperties) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetClientProperties)(windows_core::Interface::as_raw(self), pproperties).ok() }
    }
    pub unsafe fn GetBufferSizeLimits(&self, pformat: *const WAVEFORMATEX, beventdriven: bool, phnsminbufferduration: *mut i64, phnsmaxbufferduration: *mut i64) -> windows_result::Result<()> {
...
pub trait IAudioClient2_Impl: IAudioClient_Impl {
    fn IsOffloadCapable(&self, category: AUDIO_STREAM_CATEGORY) -> windows_result::Result<windows_core::BOOL>;
    fn SetClientProperties(&self, pproperties: *const AudioClientProperties) -> windows_result::Result<()>;
    fn GetBufferSizeLimits(&self, pformat: *const WAVEFORMATEX, beventdriven: windows_core::BOOL, phnsminbufferduration: *mut i64, phnsmaxbufferduration: *mut i64) -> windows_result::Result<()>;
}
...
impl IAudioClient3 {
    pub unsafe fn GetSharedModeEnginePeriod(&self, pformat: *const WAVEFORMATEX, pdefaultperiodinframes: *mut u32, pfundamentalperiodinframes: *mut u32, pminperiodinframes: *mut u32, pmaxperiodinframes: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetCurrentSharedModeEnginePeriod(&self, ppformat: *mut *mut WAVEFORMATEX, pcurrentperiodinframes: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn InitializeSharedAudioStream(&self, streamflags: u32, periodinframes: u32, pformat: *const WAVEFORMATEX, audiosessionguid: Option<*const windows_core::GUID>) -> windows_result::Result<()> {
...
pub trait IAudioClient3_Impl: IAudioClient2_Impl {
    fn GetSharedModeEnginePeriod(&self, pformat: *const WAVEFORMATEX, pdefaultperiodinframes: *mut u32, pfundamentalperiodinframes: *mut u32, pminperiodinframes: *mut u32, pmaxperiodinframes: *mut u32) -> windows_result::Result<()>;
    fn GetCurrentSharedModeEnginePeriod(&self, ppformat: *mut *mut WAVEFORMATEX, pcurrentperiodinframes: *mut u32) -> windows_result::Result<()>;
    fn InitializeSharedAudioStream(&self, streamflags: u32, periodinframes: u32, pformat: *const WAVEFORMATEX, audiosessionguid: *const windows_core::GUID) -> windows_result::Result<()>;
}
...
impl IAudioClientDuckingControl {
    pub unsafe fn SetDuckingOptionsForCurrentStream(&self, options: AUDIO_DUCKING_OPTIONS) -> windows_result::Result<()> {
...
pub trait IAudioClientDuckingControl_Impl: windows_core::IUnknownImpl {
    fn SetDuckingOptionsForCurrentStream(&self, options: AUDIO_DUCKING_OPTIONS) -> windows_result::Result<()>;
}
...
impl IAudioClock {
    pub unsafe fn GetFrequency(&self) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFrequency)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetPosition(&self, pu64position: *mut u64, pu64qpcposition: Option<*mut u64>) -> windows_result::Result<()> {
...
pub trait IAudioClock_Impl: windows_core::IUnknownImpl {
    fn GetFrequency(&self) -> windows_result::Result<u64>;
    fn GetPosition(&self, pu64position: *mut u64, pu64qpcposition: *mut u64) -> windows_result::Result<()>;
...
impl IAudioClock2 {
    pub unsafe fn GetDevicePosition(&self, deviceposition: *mut u64, qpcposition: Option<*mut u64>) -> windows_result::Result<()> {
...
pub trait IAudioClock2_Impl: windows_core::IUnknownImpl {
    fn GetDevicePosition(&self, deviceposition: *mut u64, qpcposition: *mut u64) -> windows_result::Result<()>;
}
...
impl IAudioClockAdjustment {
    pub unsafe fn SetSampleRate(&self, flsamplerate: f32) -> windows_result::Result<()> {
...
pub trait IAudioClockAdjustment_Impl: windows_core::IUnknownImpl {
    fn SetSampleRate(&self, flsamplerate: f32) -> windows_result::Result<()>;
}
...
impl IAudioEffectsChangedNotificationClient {
    pub unsafe fn OnAudioEffectsChanged(&self) -> windows_result::Result<()> {
...
pub trait IAudioEffectsChangedNotificationClient_Impl: windows_core::IUnknownImpl {
    fn OnAudioEffectsChanged(&self) -> windows_result::Result<()>;
}
...
impl IAudioEffectsManager {
    pub unsafe fn RegisterAudioEffectsChangedNotificationCallback<P0>(&self, client: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn UnregisterAudioEffectsChangedNotificationCallback<P0>(&self, client: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IAudioEffectsChangedNotificationClient>,
    {
    ...
    pub unsafe fn GetAudioEffects(&self, effects: *mut *mut AUDIO_EFFECT, numeffects: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetAudioEffectState(&self, effectid: windows_core::GUID, state: AUDIO_EFFECT_STATE) -> windows_result::Result<()> {
...
pub trait IAudioEffectsManager_Impl: windows_core::IUnknownImpl {
    fn RegisterAudioEffectsChangedNotificationCallback(&self, client: windows_core::Ref<IAudioEffectsChangedNotificationClient>) -> windows_result::Result<()>;
    fn UnregisterAudioEffectsChangedNotificationCallback(&self, client: windows_core::Ref<IAudioEffectsChangedNotificationClient>) -> windows_result::Result<()>;
    fn GetAudioEffects(&self, effects: *mut *mut AUDIO_EFFECT, numeffects: *mut u32) -> windows_result::Result<()>;
    fn SetAudioEffectState(&self, effectid: &windows_core::GUID, state: AUDIO_EFFECT_STATE) -> windows_result::Result<()>;
}
...
impl IAudioFormatEnumerator {
    ...
    pub unsafe fn GetFormat(&self, index: u32) -> windows_result::Result<*mut WAVEFORMATEX> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IAudioFormatEnumerator_Impl: windows_core::IUnknownImpl {
    ...
    fn GetFormat(&self, index: u32) -> windows_result::Result<*mut WAVEFORMATEX>;
}
...
impl IAudioInputSelector {
    pub unsafe fn GetSelection(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSelection)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetSelection(&self, nidselect: u32, pguideventcontext: Option<*const windows_core::GUID>) -> windows_result::Result<()> {
...
pub trait IAudioInputSelector_Impl: windows_core::IUnknownImpl {
    fn GetSelection(&self) -> windows_result::Result<u32>;
    fn SetSelection(&self, nidselect: u32, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
}
...
impl IAudioMute {
    pub unsafe fn SetMute(&self, bmuted: bool, pguideventcontext: Option<*const windows_core::GUID>) -> windows_result::Result<()> {
...
pub trait IAudioMute_Impl: windows_core::IUnknownImpl {
    fn SetMute(&self, bmuted: windows_core::BOOL, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
...
impl IAudioPeakMeter {
    ...
    pub unsafe fn GetLevel(&self, nchannel: u32) -> windows_result::Result<f32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IAudioPeakMeter_Impl: windows_core::IUnknownImpl {
    ...
    fn GetLevel(&self, nchannel: u32) -> windows_result::Result<f32>;
}
...
impl IAudioRenderClient {
    pub unsafe fn GetBuffer(&self, numframesrequested: u32) -> windows_result::Result<*mut u8> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ReleaseBuffer(&self, numframeswritten: u32, dwflags: u32) -> windows_result::Result<()> {
...
pub trait IAudioRenderClient_Impl: windows_core::IUnknownImpl {
    fn GetBuffer(&self, numframesrequested: u32) -> windows_result::Result<*mut u8>;
    fn ReleaseBuffer(&self, numframeswritten: u32, dwflags: u32) -> windows_result::Result<()>;
}
...
impl IAudioSessionControl {
    pub unsafe fn GetState(&self) -> windows_result::Result<AudioSessionState> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetDisplayName<P0>(&self, value: P0, eventcontext: *const windows_core::GUID) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetIconPath(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetIconPath)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetIconPath<P0>(&self, value: P0, eventcontext: *const windows_core::GUID) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetIconPath)(windows_core::Interface::as_raw(self), value.param().abi(), eventcontext).ok() }
    }
    pub unsafe fn GetGroupingParam(&self) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetGroupingParam)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetGroupingParam(&self, r#override: *const windows_core::GUID, eventcontext: *const windows_core::GUID) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetGroupingParam)(windows_core::Interface::as_raw(self), r#override, eventcontext).ok() }
    }
    pub unsafe fn RegisterAudioSessionNotification<P0>(&self, newnotifications: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn UnregisterAudioSessionNotification<P0>(&self, newnotifications: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IAudioSessionEvents>,
    {
...
pub trait IAudioSessionControl_Impl: windows_core::IUnknownImpl {
    fn GetState(&self) -> windows_result::Result<AudioSessionState>;
    fn GetDisplayName(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetDisplayName(&self, value: &windows_core::PCWSTR, eventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn GetIconPath(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn SetIconPath(&self, value: &windows_core::PCWSTR, eventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn GetGroupingParam(&self) -> windows_result::Result<windows_core::GUID>;
    fn SetGroupingParam(&self, r#override: *const windows_core::GUID, eventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn RegisterAudioSessionNotification(&self, newnotifications: windows_core::Ref<IAudioSessionEvents>) -> windows_result::Result<()>;
    fn UnregisterAudioSessionNotification(&self, newnotifications: windows_core::Ref<IAudioSessionEvents>) -> windows_result::Result<()>;
}
...
impl IAudioSessionControl2 {
    pub unsafe fn GetSessionIdentifier(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSessionIdentifier)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetSessionInstanceIdentifier(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetDuckingPreference(&self, optout: bool) -> windows_result::Result<()> {
...
pub trait IAudioSessionControl2_Impl: IAudioSessionControl_Impl {
    fn GetSessionIdentifier(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn GetSessionInstanceIdentifier(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn GetProcessId(&self) -> windows_result::Result<u32>;
    fn IsSystemSoundsSession(&self) -> windows_core::HRESULT;
    fn SetDuckingPreference(&self, optout: windows_core::BOOL) -> windows_result::Result<()>;
}
...
impl IAudioSessionEnumerator {
    pub unsafe fn GetCount(&self) -> windows_result::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetSession(&self, sessioncount: i32) -> windows_result::Result<IAudioSessionControl> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IAudioSessionEnumerator_Impl: windows_core::IUnknownImpl {
    fn GetCount(&self) -> windows_result::Result<i32>;
    fn GetSession(&self, sessioncount: i32) -> windows_result::Result<IAudioSessionControl>;
}
...
impl IAudioSessionEvents {
    pub unsafe fn OnDisplayNameChanged<P0>(&self, newdisplayname: P0, eventcontext: *const windows_core::GUID) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn OnIconPathChanged<P0>(&self, newiconpath: P0, eventcontext: *const windows_core::GUID) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn OnSimpleVolumeChanged(&self, newvolume: f32, newmute: bool, eventcontext: *const windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn OnChannelVolumeChanged(&self, newchannelvolumearray: &[f32], changedchannel: u32, eventcontext: *const windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn OnGroupingParamChanged(&self, newgroupingparam: *const windows_core::GUID, eventcontext: *const windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn OnStateChanged(&self, newstate: AudioSessionState) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).OnStateChanged)(windows_core::Interface::as_raw(self), newstate).ok() }
    }
    pub unsafe fn OnSessionDisconnected(&self, disconnectreason: AudioSessionDisconnectReason) -> windows_result::Result<()> {
...
pub trait IAudioSessionEvents_Impl: windows_core::IUnknownImpl {
    fn OnDisplayNameChanged(&self, newdisplayname: &windows_core::PCWSTR, eventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn OnIconPathChanged(&self, newiconpath: &windows_core::PCWSTR, eventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn OnSimpleVolumeChanged(&self, newvolume: f32, newmute: windows_core::BOOL, eventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn OnChannelVolumeChanged(&self, channelcount: u32, newchannelvolumearray: *const f32, changedchannel: u32, eventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn OnGroupingParamChanged(&self, newgroupingparam: *const windows_core::GUID, eventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn OnStateChanged(&self, newstate: AudioSessionState) -> windows_result::Result<()>;
    fn OnSessionDisconnected(&self, disconnectreason: AudioSessionDisconnectReason) -> windows_result::Result<()>;
}
...
impl IAudioSessionManager {
    pub unsafe fn GetAudioSessionControl(&self, audiosessionguid: Option<*const windows_core::GUID>, streamflags: u32) -> windows_result::Result<IAudioSessionControl> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetSimpleAudioVolume(&self, audiosessionguid: Option<*const windows_core::GUID>, streamflags: u32) -> windows_result::Result<ISimpleAudioVolume> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IAudioSessionManager_Impl: windows_core::IUnknownImpl {
    fn GetAudioSessionControl(&self, audiosessionguid: *const windows_core::GUID, streamflags: u32) -> windows_result::Result<IAudioSessionControl>;
    fn GetSimpleAudioVolume(&self, audiosessionguid: *const windows_core::GUID, streamflags: u32) -> windows_result::Result<ISimpleAudioVolume>;
}
...
impl IAudioSessionManager2 {
    pub unsafe fn GetSessionEnumerator(&self) -> windows_result::Result<IAudioSessionEnumerator> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RegisterSessionNotification<P0>(&self, sessionnotification: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn UnregisterSessionNotification<P0>(&self, sessionnotification: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IAudioSessionNotification>,
    {
    ...
    pub unsafe fn RegisterDuckNotification<P0, P1>(&self, sessionid: P0, ducknotification: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn UnregisterDuckNotification<P0>(&self, ducknotification: P0) -> windows_result::Result<()>
    where
...
pub trait IAudioSessionManager2_Impl: IAudioSessionManager_Impl {
    fn GetSessionEnumerator(&self) -> windows_result::Result<IAudioSessionEnumerator>;
    fn RegisterSessionNotification(&self, sessionnotification: windows_core::Ref<IAudioSessionNotification>) -> windows_result::Result<()>;
    fn UnregisterSessionNotification(&self, sessionnotification: windows_core::Ref<IAudioSessionNotification>) -> windows_result::Result<()>;
    fn RegisterDuckNotification(&self, sessionid: &windows_core::PCWSTR, ducknotification: windows_core::Ref<IAudioVolumeDuckNotification>) -> windows_result::Result<()>;
    fn UnregisterDuckNotification(&self, ducknotification: windows_core::Ref<IAudioVolumeDuckNotification>) -> windows_result::Result<()>;
}
...
impl IAudioSessionNotification {
    pub unsafe fn OnSessionCreated<P0>(&self, newsession: P0) -> windows_result::Result<()>
    where
...
pub trait IAudioSessionNotification_Impl: windows_core::IUnknownImpl {
    fn OnSessionCreated(&self, newsession: windows_core::Ref<IAudioSessionControl>) -> windows_result::Result<()>;
}
...
impl IAudioStateMonitor {
    pub unsafe fn RegisterCallback(&self, callback: PAudioStateMonitorCallback, context: Option<*const core::ffi::c_void>) -> windows_result::Result<i64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IAudioStateMonitor_Impl: windows_core::IUnknownImpl {
    fn RegisterCallback(&self, callback: PAudioStateMonitorCallback, context: *const core::ffi::c_void) -> windows_result::Result<i64>;
...
impl IAudioStreamVolume {
    ...
    pub unsafe fn GetAllVolumes(&self, pfvolumes: &mut [f32]) -> windows_result::Result<()> {
...
pub trait IAudioStreamVolume_Impl: windows_core::IUnknownImpl {
    fn GetChannelCount(&self) -> windows_result::Result<u32>;
    fn SetChannelVolume(&self, dwindex: u32, flevel: f32) -> windows_result::Result<()>;
    fn GetChannelVolume(&self, dwindex: u32) -> windows_result::Result<f32>;
    fn SetAllVolumes(&self, dwcount: u32, pfvolumes: *const f32) -> windows_result::Result<()>;
    fn GetAllVolumes(&self, dwcount: u32, pfvolumes: *mut f32) -> windows_result::Result<()>;
}
...
impl IAudioSystemEffectsPropertyChangeNotificationClient {
    pub unsafe fn OnPropertyChanged(&self, r#type: AUDIO_SYSTEMEFFECTS_PROPERTYSTORE_TYPE, key: super::super::Foundation::PROPERTYKEY) -> windows_result::Result<()> {
...
pub trait IAudioSystemEffectsPropertyChangeNotificationClient_Impl: windows_core::IUnknownImpl {
    fn OnPropertyChanged(&self, r#type: AUDIO_SYSTEMEFFECTS_PROPERTYSTORE_TYPE, key: &super::super::Foundation::PROPERTYKEY) -> windows_result::Result<()>;
}
...
impl IAudioSystemEffectsPropertyStore {
    ...
    pub unsafe fn OpenDefaultPropertyStore(&self, stgmaccess: u32) -> windows_result::Result<super::super::UI::Shell::PropertiesSystem::IPropertyStore> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn OpenUserPropertyStore(&self, stgmaccess: u32) -> windows_result::Result<super::super::UI::Shell::PropertiesSystem::IPropertyStore> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn OpenVolatilePropertyStore(&self, stgmaccess: u32) -> windows_result::Result<super::super::UI::Shell::PropertiesSystem::IPropertyStore> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ResetUserPropertyStore(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ResetUserPropertyStore)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn ResetVolatilePropertyStore(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ResetVolatilePropertyStore)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn RegisterPropertyChangeNotification<P0>(&self, callback: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn UnregisterPropertyChangeNotification<P0>(&self, callback: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IAudioSystemEffectsPropertyChangeNotificationClient>,
    {
...
pub trait IAudioSystemEffectsPropertyStore_Impl: windows_core::IUnknownImpl {
    fn OpenDefaultPropertyStore(&self, stgmaccess: u32) -> windows_result::Result<super::super::UI::Shell::PropertiesSystem::IPropertyStore>;
    fn OpenUserPropertyStore(&self, stgmaccess: u32) -> windows_result::Result<super::super::UI::Shell::PropertiesSystem::IPropertyStore>;
    fn OpenVolatilePropertyStore(&self, stgmaccess: u32) -> windows_result::Result<super::super::UI::Shell::PropertiesSystem::IPropertyStore>;
    fn ResetUserPropertyStore(&self) -> windows_result::Result<()>;
    fn ResetVolatilePropertyStore(&self) -> windows_result::Result<()>;
    fn RegisterPropertyChangeNotification(&self, callback: windows_core::Ref<IAudioSystemEffectsPropertyChangeNotificationClient>) -> windows_result::Result<()>;
    fn UnregisterPropertyChangeNotification(&self, callback: windows_core::Ref<IAudioSystemEffectsPropertyChangeNotificationClient>) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
...
impl IAudioViewManagerService {
    pub unsafe fn SetAudioStreamWindow(&self, hwnd: super::super::Foundation::HWND) -> windows_result::Result<()> {
...
pub trait IAudioViewManagerService_Impl: windows_core::IUnknownImpl {
    fn SetAudioStreamWindow(&self, hwnd: super::super::Foundation::HWND) -> windows_result::Result<()>;
}
...
impl IAudioVolumeDuckNotification {
    pub unsafe fn OnVolumeDuckNotification<P0>(&self, sessionid: P0, countcommunicationsessions: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn OnVolumeUnduckNotification<P0>(&self, sessionid: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IAudioVolumeDuckNotification_Impl: windows_core::IUnknownImpl {
    fn OnVolumeDuckNotification(&self, sessionid: &windows_core::PCWSTR, countcommunicationsessions: u32) -> windows_result::Result<()>;
    fn OnVolumeUnduckNotification(&self, sessionid: &windows_core::PCWSTR) -> windows_result::Result<()>;
}
...
impl IChannelAudioVolume {
    ...
    pub unsafe fn SetChannelVolume(&self, dwindex: u32, flevel: f32, eventcontext: *const windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetAllVolumes(&self, pfvolumes: &[f32], eventcontext: *const windows_core::GUID) -> windows_result::Result<()> {
...
pub trait IChannelAudioVolume_Impl: windows_core::IUnknownImpl {
    fn GetChannelCount(&self) -> windows_result::Result<u32>;
    fn SetChannelVolume(&self, dwindex: u32, flevel: f32, eventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn GetChannelVolume(&self, dwindex: u32) -> windows_result::Result<f32>;
    fn SetAllVolumes(&self, dwcount: u32, pfvolumes: *const f32, eventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn GetAllVolumes(&self, dwcount: u32, pfvolumes: *mut f32) -> windows_result::Result<()>;
}
...
impl IConnector {
    ...
    pub unsafe fn GetConnectedTo(&self) -> windows_result::Result<IConnector> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetConnectorIdConnectedTo(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetDeviceIdConnectedTo(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IConnector_Impl: windows_core::IUnknownImpl {
    fn GetType(&self) -> windows_result::Result<ConnectorType>;
    fn GetDataFlow(&self) -> windows_result::Result<DataFlow>;
    fn ConnectTo(&self, pconnectto: windows_core::Ref<IConnector>) -> windows_result::Result<()>;
    fn Disconnect(&self) -> windows_result::Result<()>;
    fn IsConnected(&self) -> windows_result::Result<windows_core::BOOL>;
    fn GetConnectedTo(&self) -> windows_result::Result<IConnector>;
    fn GetConnectorIdConnectedTo(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn GetDeviceIdConnectedTo(&self) -> windows_result::Result<windows_core::PWSTR>;
}
...
impl IControlChangeNotify {
    pub unsafe fn OnNotify(&self, dwsenderprocessid: u32, pguideventcontext: Option<*const windows_core::GUID>) -> windows_result::Result<()> {
...
pub trait IControlChangeNotify_Impl: windows_core::IUnknownImpl {
    fn OnNotify(&self, dwsenderprocessid: u32, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
}
...
impl IControlInterface {
    pub unsafe fn GetName(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IControlInterface_Impl: windows_core::IUnknownImpl {
    fn GetName(&self) -> windows_result::Result<windows_core::PWSTR>;
...
impl IDeviceSpecificProperty {
    ...
    pub unsafe fn GetValue(&self, pvvalue: *mut core::ffi::c_void, pcbvalue: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetValue)(windows_core::Interface::as_raw(self), pvvalue as _, pcbvalue as _).ok() }
    }
    pub unsafe fn SetValue(&self, pvvalue: *const core::ffi::c_void, cbvalue: u32, pguideventcontext: Option<*const windows_core::GUID>) -> windows_result::Result<()> {
    ...
    pub unsafe fn Get4BRange(&self, plmin: *mut i32, plmax: *mut i32, plstepping: *mut i32) -> windows_result::Result<()> {
...
pub trait IDeviceSpecificProperty_Impl: windows_core::IUnknownImpl {
    ...
    fn GetValue(&self, pvvalue: *mut core::ffi::c_void, pcbvalue: *mut u32) -> windows_result::Result<()>;
    fn SetValue(&self, pvvalue: *const core::ffi::c_void, cbvalue: u32, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn Get4BRange(&self, plmin: *mut i32, plmax: *mut i32, plstepping: *mut i32) -> windows_result::Result<()>;
}
...
impl IDeviceTopology {
    pub unsafe fn GetConnectorCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetConnectorCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetConnector(&self, nindex: u32) -> windows_result::Result<IConnector> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetSubunitCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSubunitCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetSubunit(&self, nindex: u32) -> windows_result::Result<ISubunit> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetPartById(&self, nid: u32) -> windows_result::Result<IPart> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetDeviceId(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDeviceId)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetSignalPath<P0, P1>(&self, pipartfrom: P0, pipartto: P1, brejectmixedpaths: bool) -> windows_result::Result<IPartsList>
    where
...
pub trait IDeviceTopology_Impl: windows_core::IUnknownImpl {
    fn GetConnectorCount(&self) -> windows_result::Result<u32>;
    fn GetConnector(&self, nindex: u32) -> windows_result::Result<IConnector>;
    fn GetSubunitCount(&self) -> windows_result::Result<u32>;
    fn GetSubunit(&self, nindex: u32) -> windows_result::Result<ISubunit>;
    fn GetPartById(&self, nid: u32) -> windows_result::Result<IPart>;
    fn GetDeviceId(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn GetSignalPath(&self, pipartfrom: windows_core::Ref<IPart>, pipartto: windows_core::Ref<IPart>, brejectmixedpaths: windows_core::BOOL) -> windows_result::Result<IPartsList>;
}
...
impl IMMDevice {
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn Activate<T>(&self, dwclsctx: super::super::System::Com::CLSCTX, pactivationparams: Option<*const super::super::System::Com::StructuredStorage::PROPVARIANT>) -> windows_result::Result<T>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
    ...
    pub unsafe fn OpenPropertyStore(&self, stgmaccess: super::super::System::Com::STGM) -> windows_result::Result<super::super::UI::Shell::PropertiesSystem::IPropertyStore> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetState(&self) -> windows_result::Result<DEVICE_STATE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetState)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
...
pub trait IMMDevice_Impl: windows_core::IUnknownImpl {
    fn Activate(&self, iid: *const windows_core::GUID, dwclsctx: super::super::System::Com::CLSCTX, pactivationparams: *const super::super::System::Com::StructuredStorage::PROPVARIANT, ppinterface: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn OpenPropertyStore(&self, stgmaccess: super::super::System::Com::STGM) -> windows_result::Result<super::super::UI::Shell::PropertiesSystem::IPropertyStore>;
...
impl IMMDeviceActivator {
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn Activate<P1>(&self, iid: *const windows_core::GUID, pdevice: P1, pactivationparams: Option<*const super::super::System::Com::StructuredStorage::PROPVARIANT>, ppinterface: *mut *mut core::ffi::c_void) -> windows_result::Result<()>
    where
...
pub trait IMMDeviceActivator_Impl: windows_core::IUnknownImpl {
    fn Activate(&self, iid: *const windows_core::GUID, pdevice: windows_core::Ref<IMMDevice>, pactivationparams: *const super::super::System::Com::StructuredStorage::PROPVARIANT, ppinterface: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl IMMDeviceCollection {
    ...
    pub unsafe fn Item(&self, ndevice: u32) -> windows_result::Result<IMMDevice> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IMMDeviceCollection_Impl: windows_core::IUnknownImpl {
    fn GetCount(&self) -> windows_result::Result<u32>;
    fn Item(&self, ndevice: u32) -> windows_result::Result<IMMDevice>;
}
...
impl IMMDeviceEnumerator {
    pub unsafe fn EnumAudioEndpoints(&self, dataflow: EDataFlow, dwstatemask: DEVICE_STATE) -> windows_result::Result<IMMDeviceCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetDefaultAudioEndpoint(&self, dataflow: EDataFlow, role: ERole) -> windows_result::Result<IMMDevice> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetDevice<P0>(&self, pwstrid: P0) -> windows_result::Result<IMMDevice>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn RegisterEndpointNotificationCallback<P0>(&self, pclient: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn UnregisterEndpointNotificationCallback<P0>(&self, pclient: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IMMNotificationClient>,
    {
...
pub trait IMMDeviceEnumerator_Impl: windows_core::IUnknownImpl {
    fn EnumAudioEndpoints(&self, dataflow: EDataFlow, dwstatemask: DEVICE_STATE) -> windows_result::Result<IMMDeviceCollection>;
    fn GetDefaultAudioEndpoint(&self, dataflow: EDataFlow, role: ERole) -> windows_result::Result<IMMDevice>;
    fn GetDevice(&self, pwstrid: &windows_core::PCWSTR) -> windows_result::Result<IMMDevice>;
    fn RegisterEndpointNotificationCallback(&self, pclient: windows_core::Ref<IMMNotificationClient>) -> windows_result::Result<()>;
    fn UnregisterEndpointNotificationCallback(&self, pclient: windows_core::Ref<IMMNotificationClient>) -> windows_result::Result<()>;
}
...
impl IMMEndpoint {
    pub unsafe fn GetDataFlow(&self) -> windows_result::Result<EDataFlow> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDataFlow)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
...
pub trait IMMEndpoint_Impl: windows_core::IUnknownImpl {
    fn GetDataFlow(&self) -> windows_result::Result<EDataFlow>;
}
...
impl IMMNotificationClient {
    pub unsafe fn OnDeviceStateChanged<P0>(&self, pwstrdeviceid: P0, dwnewstate: DEVICE_STATE) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn OnDeviceAdded<P0>(&self, pwstrdeviceid: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).OnDeviceAdded)(windows_core::Interface::as_raw(self), pwstrdeviceid.param().abi()).ok() }
    }
    pub unsafe fn OnDeviceRemoved<P0>(&self, pwstrdeviceid: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).OnDeviceRemoved)(windows_core::Interface::as_raw(self), pwstrdeviceid.param().abi()).ok() }
    }
    pub unsafe fn OnDefaultDeviceChanged<P2>(&self, flow: EDataFlow, role: ERole, pwstrdefaultdeviceid: P2) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn OnPropertyValueChanged<P0>(&self, pwstrdeviceid: P0, key: super::super::Foundation::PROPERTYKEY) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IMMNotificationClient_Impl: windows_core::IUnknownImpl {
    fn OnDeviceStateChanged(&self, pwstrdeviceid: &windows_core::PCWSTR, dwnewstate: DEVICE_STATE) -> windows_result::Result<()>;
    fn OnDeviceAdded(&self, pwstrdeviceid: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn OnDeviceRemoved(&self, pwstrdeviceid: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn OnDefaultDeviceChanged(&self, flow: EDataFlow, role: ERole, pwstrdefaultdeviceid: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn OnPropertyValueChanged(&self, pwstrdeviceid: &windows_core::PCWSTR, key: &super::super::Foundation::PROPERTYKEY) -> windows_result::Result<()>;
}
...
impl IPart {
    ...
    pub unsafe fn EnumPartsIncoming(&self) -> windows_result::Result<IPartsList> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumPartsOutgoing(&self) -> windows_result::Result<IPartsList> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetTopologyObject(&self) -> windows_result::Result<IDeviceTopology> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Activate(&self, dwclscontext: u32, refiid: *const windows_core::GUID, ppvobject: Option<*mut *mut core::ffi::c_void>) -> windows_result::Result<()> {
    ...
    pub unsafe fn RegisterControlChangeCallback<P1>(&self, riid: *const windows_core::GUID, pnotify: P1) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn UnregisterControlChangeCallback<P0>(&self, pnotify: P0) -> windows_result::Result<()>
    where
...
pub trait IPart_Impl: windows_core::IUnknownImpl {
    fn GetName(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn GetLocalId(&self) -> windows_result::Result<u32>;
    fn GetGlobalId(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn GetPartType(&self) -> windows_result::Result<PartType>;
    fn GetSubType(&self) -> windows_result::Result<windows_core::GUID>;
    fn GetControlInterfaceCount(&self) -> windows_result::Result<u32>;
    fn GetControlInterface(&self, nindex: u32) -> windows_result::Result<IControlInterface>;
    fn EnumPartsIncoming(&self) -> windows_result::Result<IPartsList>;
    fn EnumPartsOutgoing(&self) -> windows_result::Result<IPartsList>;
    fn GetTopologyObject(&self) -> windows_result::Result<IDeviceTopology>;
    fn Activate(&self, dwclscontext: u32, refiid: *const windows_core::GUID, ppvobject: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn RegisterControlChangeCallback(&self, riid: *const windows_core::GUID, pnotify: windows_core::Ref<IControlChangeNotify>) -> windows_result::Result<()>;
    fn UnregisterControlChangeCallback(&self, pnotify: windows_core::Ref<IControlChangeNotify>) -> windows_result::Result<()>;
}
impl IPart_Vtbl {
...
impl IPartsList {
    ...
    pub unsafe fn GetPart(&self, nindex: u32) -> windows_result::Result<IPart> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPartsList_Impl: windows_core::IUnknownImpl {
    fn GetCount(&self) -> windows_result::Result<u32>;
    fn GetPart(&self, nindex: u32) -> windows_result::Result<IPart>;
}
...
impl IPerChannelDbLevel {
    ...
    pub unsafe fn GetLevelRange(&self, nchannel: u32, pfminleveldb: *mut f32, pfmaxleveldb: *mut f32, pfstepping: *mut f32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetLevel(&self, nchannel: u32, fleveldb: f32, pguideventcontext: Option<*const windows_core::GUID>) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetLevelUniform(&self, fleveldb: f32, pguideventcontext: Option<*const windows_core::GUID>) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetLevelAllChannels(&self, alevelsdb: &[f32], pguideventcontext: Option<*const windows_core::GUID>) -> windows_result::Result<()> {
...
pub trait IPerChannelDbLevel_Impl: windows_core::IUnknownImpl {
    fn GetChannelCount(&self) -> windows_result::Result<u32>;
    fn GetLevelRange(&self, nchannel: u32, pfminleveldb: *mut f32, pfmaxleveldb: *mut f32, pfstepping: *mut f32) -> windows_result::Result<()>;
    fn GetLevel(&self, nchannel: u32) -> windows_result::Result<f32>;
    fn SetLevel(&self, nchannel: u32, fleveldb: f32, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn SetLevelUniform(&self, fleveldb: f32, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn SetLevelAllChannels(&self, alevelsdb: *const f32, cchannels: u32, pguideventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
}
...
impl ISimpleAudioVolume {
    pub unsafe fn SetMasterVolume(&self, flevel: f32, eventcontext: *const windows_core::GUID) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetMasterVolume)(windows_core::Interface::as_raw(self), flevel, eventcontext).ok() }
    }
    pub unsafe fn GetMasterVolume(&self) -> windows_result::Result<f32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMasterVolume)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetMute(&self, bmute: bool, eventcontext: *const windows_core::GUID) -> windows_result::Result<()> {
...
pub trait ISimpleAudioVolume_Impl: windows_core::IUnknownImpl {
    fn SetMasterVolume(&self, flevel: f32, eventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn GetMasterVolume(&self) -> windows_result::Result<f32>;
    fn SetMute(&self, bmute: windows_core::BOOL, eventcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn GetMute(&self) -> windows_result::Result<windows_core::BOOL>;
}
...
impl ISpatialAudioClient {
    pub unsafe fn GetStaticObjectPosition(&self, r#type: AudioObjectType, x: *mut f32, y: *mut f32, z: *mut f32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetNativeStaticObjectTypeMask(&self) -> windows_result::Result<AudioObjectType> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetMaxDynamicObjectCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMaxDynamicObjectCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetSupportedAudioObjectFormatEnumerator(&self) -> windows_result::Result<IAudioFormatEnumerator> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetMaxFrameCount(&self, objectformat: *const WAVEFORMATEX) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn IsAudioObjectFormatSupported(&self, objectformat: *const WAVEFORMATEX) -> windows_result::Result<()> {
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn IsSpatialAudioStreamAvailable(&self, streamuuid: *const windows_core::GUID, auxiliaryinfo: Option<*const super::super::System::Com::StructuredStorage::PROPVARIANT>) -> windows_result::Result<()> {
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn ActivateSpatialAudioStream<T>(&self, activationparams: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<T>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
...
pub trait ISpatialAudioClient_Impl: windows_core::IUnknownImpl {
    fn GetStaticObjectPosition(&self, r#type: AudioObjectType, x: *mut f32, y: *mut f32, z: *mut f32) -> windows_result::Result<()>;
    fn GetNativeStaticObjectTypeMask(&self) -> windows_result::Result<AudioObjectType>;
    fn GetMaxDynamicObjectCount(&self) -> windows_result::Result<u32>;
    fn GetSupportedAudioObjectFormatEnumerator(&self) -> windows_result::Result<IAudioFormatEnumerator>;
    fn GetMaxFrameCount(&self, objectformat: *const WAVEFORMATEX) -> windows_result::Result<u32>;
    fn IsAudioObjectFormatSupported(&self, objectformat: *const WAVEFORMATEX) -> windows_result::Result<()>;
    fn IsSpatialAudioStreamAvailable(&self, streamuuid: *const windows_core::GUID, auxiliaryinfo: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()>;
    fn ActivateSpatialAudioStream(&self, activationparams: *const super::super::System::Com::StructuredStorage::PROPVARIANT, riid: *const windows_core::GUID, stream: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl ISpatialAudioClient2 {
    ...
    pub unsafe fn GetMaxFrameCountForCategory(&self, category: AUDIO_STREAM_CATEGORY, offloadenabled: bool, objectformat: *const WAVEFORMATEX) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISpatialAudioClient2_Impl: ISpatialAudioClient_Impl {
    fn IsOffloadCapable(&self, category: AUDIO_STREAM_CATEGORY) -> windows_result::Result<windows_core::BOOL>;
    fn GetMaxFrameCountForCategory(&self, category: AUDIO_STREAM_CATEGORY, offloadenabled: windows_core::BOOL, objectformat: *const WAVEFORMATEX) -> windows_result::Result<u32>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl ISpatialAudioMetadataClient {
    pub unsafe fn ActivateSpatialAudioMetadataItems(&self, maxitemcount: u16, framecount: u16, metadataitemsbuffer: Option<*mut Option<ISpatialAudioMetadataItemsBuffer>>, metadataitems: *mut Option<ISpatialAudioMetadataItems>) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetSpatialAudioMetadataItemsBufferLength(&self, maxitemcount: u16) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ActivateSpatialAudioMetadataWriter(&self, overflowmode: SpatialAudioMetadataWriterOverflowMode) -> windows_result::Result<ISpatialAudioMetadataWriter> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ActivateSpatialAudioMetadataCopier(&self) -> windows_result::Result<ISpatialAudioMetadataCopier> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ActivateSpatialAudioMetadataReader(&self) -> windows_result::Result<ISpatialAudioMetadataReader> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISpatialAudioMetadataClient_Impl: windows_core::IUnknownImpl {
    fn ActivateSpatialAudioMetadataItems(&self, maxitemcount: u16, framecount: u16, metadataitemsbuffer: windows_core::OutRef<ISpatialAudioMetadataItemsBuffer>, metadataitems: windows_core::OutRef<ISpatialAudioMetadataItems>) -> windows_result::Result<()>;
    fn GetSpatialAudioMetadataItemsBufferLength(&self, maxitemcount: u16) -> windows_result::Result<u32>;
    fn ActivateSpatialAudioMetadataWriter(&self, overflowmode: SpatialAudioMetadataWriterOverflowMode) -> windows_result::Result<ISpatialAudioMetadataWriter>;
    fn ActivateSpatialAudioMetadataCopier(&self) -> windows_result::Result<ISpatialAudioMetadataCopier>;
    fn ActivateSpatialAudioMetadataReader(&self) -> windows_result::Result<ISpatialAudioMetadataReader>;
}
...
impl ISpatialAudioMetadataCopier {
    pub unsafe fn Open<P0>(&self, metadataitems: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn CopyMetadataForFrames<P2>(&self, copyframecount: u16, copymode: SpatialAudioMetadataCopyMode, dstmetadataitems: P2) -> windows_result::Result<u16>
    where
...
pub trait ISpatialAudioMetadataCopier_Impl: windows_core::IUnknownImpl {
    fn Open(&self, metadataitems: windows_core::Ref<ISpatialAudioMetadataItems>) -> windows_result::Result<()>;
    fn CopyMetadataForFrames(&self, copyframecount: u16, copymode: SpatialAudioMetadataCopyMode, dstmetadataitems: windows_core::Ref<ISpatialAudioMetadataItems>) -> windows_result::Result<u16>;
...
pub trait ISpatialAudioMetadataItems_Impl: windows_core::IUnknownImpl {
    fn GetFrameCount(&self) -> windows_result::Result<u16>;
    fn GetItemCount(&self) -> windows_result::Result<u16>;
    fn GetMaxItemCount(&self) -> windows_result::Result<u16>;
    fn GetMaxValueBufferLength(&self) -> windows_result::Result<u32>;
    fn GetInfo(&self) -> windows_result::Result<SpatialAudioMetadataItemsInfo>;
}
...
impl ISpatialAudioMetadataItemsBuffer {
    pub unsafe fn AttachToBuffer(&self, buffer: &mut [u8]) -> windows_result::Result<()> {
    ...
    pub unsafe fn AttachToPopulatedBuffer(&self, buffer: &mut [u8]) -> windows_result::Result<()> {
    ...
    pub unsafe fn DetachBuffer(&self) -> windows_result::Result<()> {
...
pub trait ISpatialAudioMetadataItemsBuffer_Impl: windows_core::IUnknownImpl {
    fn AttachToBuffer(&self, buffer: *mut u8, bufferlength: u32) -> windows_result::Result<()>;
    fn AttachToPopulatedBuffer(&self, buffer: *mut u8, bufferlength: u32) -> windows_result::Result<()>;
    fn DetachBuffer(&self) -> windows_result::Result<()>;
}
...
impl ISpatialAudioMetadataReader {
    ...
    pub unsafe fn ReadNextItem(&self, commandcount: *mut u8, frameoffset: *mut u16) -> windows_result::Result<()> {
    ...
    pub unsafe fn ReadNextItemCommand(&self, commandid: *mut u8, valuebuffer: *mut core::ffi::c_void, maxvaluebufferlength: u32, valuebufferlength: *mut u32) -> windows_result::Result<()> {
...
pub trait ISpatialAudioMetadataReader_Impl: windows_core::IUnknownImpl {
    fn Open(&self, metadataitems: windows_core::Ref<ISpatialAudioMetadataItems>) -> windows_result::Result<()>;
    fn ReadNextItem(&self, commandcount: *mut u8, frameoffset: *mut u16) -> windows_result::Result<()>;
    fn ReadNextItemCommand(&self, commandid: *mut u8, valuebuffer: *mut core::ffi::c_void, maxvaluebufferlength: u32, valuebufferlength: *mut u32) -> windows_result::Result<()>;
    fn Close(&self) -> windows_result::Result<()>;
}
...
impl ISpatialAudioMetadataWriter {
    ...
    pub unsafe fn WriteNextItem(&self, frameoffset: u16) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).WriteNextItem)(windows_core::Interface::as_raw(self), frameoffset).ok() }
    }
    pub unsafe fn WriteNextItemCommand(&self, commandid: u8, valuebuffer: Option<*const core::ffi::c_void>, valuebufferlength: u32) -> windows_result::Result<()> {
...
pub trait ISpatialAudioMetadataWriter_Impl: windows_core::IUnknownImpl {
    fn Open(&self, metadataitems: windows_core::Ref<ISpatialAudioMetadataItems>) -> windows_result::Result<()>;
    fn WriteNextItem(&self, frameoffset: u16) -> windows_result::Result<()>;
    fn WriteNextItemCommand(&self, commandid: u8, valuebuffer: *const core::ffi::c_void, valuebufferlength: u32) -> windows_result::Result<()>;
    fn Close(&self) -> windows_result::Result<()>;
}
...
impl ISpatialAudioObject {
    pub unsafe fn SetPosition(&self, x: f32, y: f32, z: f32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetPosition)(windows_core::Interface::as_raw(self), x, y, z).ok() }
    }
    pub unsafe fn SetVolume(&self, volume: f32) -> windows_result::Result<()> {
...
pub trait ISpatialAudioObject_Impl: ISpatialAudioObjectBase_Impl {
    fn SetPosition(&self, x: f32, y: f32, z: f32) -> windows_result::Result<()>;
    fn SetVolume(&self, volume: f32) -> windows_result::Result<()>;
}
...
pub trait ISpatialAudioObjectBase_Impl: windows_core::IUnknownImpl {
    fn GetBuffer(&self, buffer: *mut *mut u8, bufferlength: *mut u32) -> windows_result::Result<()>;
    fn SetEndOfStream(&self, framecount: u32) -> windows_result::Result<()>;
    fn IsActive(&self) -> windows_result::Result<windows_core::BOOL>;
    fn GetAudioObjectType(&self) -> windows_result::Result<AudioObjectType>;
}
...
impl ISpatialAudioObjectForHrtf {
    ...
    pub unsafe fn SetGain(&self, gain: f32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetGain)(windows_core::Interface::as_raw(self), gain).ok() }
    }
    pub unsafe fn SetOrientation(&self, orientation: *const *const f32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetOrientation)(windows_core::Interface::as_raw(self), orientation).ok() }
    }
    pub unsafe fn SetEnvironment(&self, environment: SpatialAudioHrtfEnvironmentType) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetEnvironment)(windows_core::Interface::as_raw(self), environment).ok() }
    }
    pub unsafe fn SetDistanceDecay(&self, distancedecay: *const SpatialAudioHrtfDistanceDecay) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetDistanceDecay)(windows_core::Interface::as_raw(self), distancedecay).ok() }
    }
    pub unsafe fn SetDirectivity(&self, directivity: *const SpatialAudioHrtfDirectivityUnion) -> windows_result::Result<()> {
...
pub trait ISpatialAudioObjectForHrtf_Impl: ISpatialAudioObjectBase_Impl {
    fn SetPosition(&self, x: f32, y: f32, z: f32) -> windows_result::Result<()>;
    fn SetGain(&self, gain: f32) -> windows_result::Result<()>;
    fn SetOrientation(&self, orientation: *const *const f32) -> windows_result::Result<()>;
    fn SetEnvironment(&self, environment: SpatialAudioHrtfEnvironmentType) -> windows_result::Result<()>;
    fn SetDistanceDecay(&self, distancedecay: *const SpatialAudioHrtfDistanceDecay) -> windows_result::Result<()>;
    fn SetDirectivity(&self, directivity: *const SpatialAudioHrtfDirectivityUnion) -> windows_result::Result<()>;
}
...
impl ISpatialAudioObjectForMetadataCommands {
    pub unsafe fn WriteNextMetadataCommand(&self, commandid: u8, valuebuffer: Option<*const core::ffi::c_void>, valuebufferlength: u32) -> windows_result::Result<()> {
...
pub trait ISpatialAudioObjectForMetadataCommands_Impl: ISpatialAudioObjectBase_Impl {
    fn WriteNextMetadataCommand(&self, commandid: u8, valuebuffer: *const core::ffi::c_void, valuebufferlength: u32) -> windows_result::Result<()>;
}
...
impl ISpatialAudioObjectForMetadataItems {
    pub unsafe fn GetSpatialAudioMetadataItems(&self) -> windows_result::Result<ISpatialAudioMetadataItems> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISpatialAudioObjectForMetadataItems_Impl: ISpatialAudioObjectBase_Impl {
    fn GetSpatialAudioMetadataItems(&self) -> windows_result::Result<ISpatialAudioMetadataItems>;
}
...
impl ISpatialAudioObjectRenderStream {
    pub unsafe fn ActivateSpatialAudioObject(&self, r#type: AudioObjectType) -> windows_result::Result<ISpatialAudioObject> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISpatialAudioObjectRenderStream_Impl: ISpatialAudioObjectRenderStreamBase_Impl {
    fn ActivateSpatialAudioObject(&self, r#type: AudioObjectType) -> windows_result::Result<ISpatialAudioObject>;
}
...
impl ISpatialAudioObjectRenderStreamBase {
    pub unsafe fn GetAvailableDynamicObjectCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn BeginUpdatingAudioObjects(&self, availabledynamicobjectcount: *mut u32, framecountperbuffer: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn EndUpdatingAudioObjects(&self) -> windows_result::Result<()> {
...
pub trait ISpatialAudioObjectRenderStreamBase_Impl: windows_core::IUnknownImpl {
    fn GetAvailableDynamicObjectCount(&self) -> windows_result::Result<u32>;
    fn GetService(&self, riid: *const windows_core::GUID, service: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn Start(&self) -> windows_result::Result<()>;
    fn Stop(&self) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn BeginUpdatingAudioObjects(&self, availabledynamicobjectcount: *mut u32, framecountperbuffer: *mut u32) -> windows_result::Result<()>;
    fn EndUpdatingAudioObjects(&self) -> windows_result::Result<()>;
}
...
impl ISpatialAudioObjectRenderStreamForHrtf {
    pub unsafe fn ActivateSpatialAudioObjectForHrtf(&self, r#type: AudioObjectType) -> windows_result::Result<ISpatialAudioObjectForHrtf> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISpatialAudioObjectRenderStreamForHrtf_Impl: ISpatialAudioObjectRenderStreamBase_Impl {
    fn ActivateSpatialAudioObjectForHrtf(&self, r#type: AudioObjectType) -> windows_result::Result<ISpatialAudioObjectForHrtf>;
}
...
impl ISpatialAudioObjectRenderStreamForMetadata {
    pub unsafe fn ActivateSpatialAudioObjectForMetadataCommands(&self, r#type: AudioObjectType) -> windows_result::Result<ISpatialAudioObjectForMetadataCommands> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ActivateSpatialAudioObjectForMetadataItems(&self, r#type: AudioObjectType) -> windows_result::Result<ISpatialAudioObjectForMetadataItems> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISpatialAudioObjectRenderStreamForMetadata_Impl: ISpatialAudioObjectRenderStreamBase_Impl {
    fn ActivateSpatialAudioObjectForMetadataCommands(&self, r#type: AudioObjectType) -> windows_result::Result<ISpatialAudioObjectForMetadataCommands>;
    fn ActivateSpatialAudioObjectForMetadataItems(&self, r#type: AudioObjectType) -> windows_result::Result<ISpatialAudioObjectForMetadataItems>;
}
...
impl ISpatialAudioObjectRenderStreamNotify {
    pub unsafe fn OnAvailableDynamicObjectCountChange<P0>(&self, sender: P0, hnscompliancedeadlinetime: i64, availabledynamicobjectcountchange: u32) -> windows_result::Result<()>
    where
...
pub trait ISpatialAudioObjectRenderStreamNotify_Impl: windows_core::IUnknownImpl {
    fn OnAvailableDynamicObjectCountChange(&self, sender: windows_core::Ref<ISpatialAudioObjectRenderStreamBase>, hnscompliancedeadlinetime: i64, availabledynamicobjectcountchange: u32) -> windows_result::Result<()>;
}
