    ...
    P2: windows_core::Param<super::super::Foundation::HANDLE>,
{
    ...
    KsGetMediaType(position, core::mem::transmute(ammediatype), filterhandle.param().abi(), pinfactoryid).ok()
}
#[inline]
...
impl IKsDataTypeCompletion {
    ...
    where
        P0: windows_core::Param<super::super::Foundation::HANDLE>,
    {
        (windows_core::Interface::vtable(self).KsCompleteMediaType)(windows_core::Interface::as_raw(self), filterhandle.param().abi(), pinfactoryid, core::mem::transmute(ammediatype)).ok()
    }
}
#[repr(C)]
