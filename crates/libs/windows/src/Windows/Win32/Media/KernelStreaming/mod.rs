...
pub const RT_RCDATA: windows_core::PCWSTR = 10u16 as _;
pub const RT_STRING: windows_core::PCWSTR = 6u16 as _;
...
pub struct ALLOCATOR_PROPERTIES_EX {
    ...
    pub PrevSegment: Option<IKsAllocatorEx>,
...
pub struct KSSTREAM_SEGMENT {
    pub KsInterfaceHandler: Option<IKsInterfaceHandler>,
    pub KsDataTypeHandler: Option<IKsDataTypeHandler>,
