...
#[inline]
pub unsafe fn KsCreateAllocator2(connectionhandle: super::super::Foundation::HANDLE, allocatorframing: *const KSALLOCATOR_FRAMING) -> windows_result::Result<super::super::Foundation::HANDLE> {
...
#[inline]
pub unsafe fn KsCreateClock2(connectionhandle: super::super::Foundation::HANDLE, clockcreate: *const KSCLOCK_CREATE) -> windows_result::Result<super::super::Foundation::HANDLE> {
...
#[inline]
pub unsafe fn KsCreatePin2(filterhandle: super::super::Foundation::HANDLE, connect: *const KSPIN_CONNECT, desiredaccess: u32) -> windows_result::Result<super::super::Foundation::HANDLE> {
...
#[inline]
pub unsafe fn KsCreateTopologyNode2(parenthandle: super::super::Foundation::HANDLE, nodecreate: *const KSNODE_CREATE, desiredaccess: u32) -> windows_result::Result<super::super::Foundation::HANDLE> {
...
#[inline]
pub unsafe fn KsGetMediaType(position: i32, ammediatype: *mut super::MediaFoundation::AM_MEDIA_TYPE, filterhandle: super::super::Foundation::HANDLE, pinfactoryid: u32) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn KsGetMediaTypeCount(filterhandle: super::super::Foundation::HANDLE, pinfactoryid: u32) -> windows_result::Result<u32> {
...
#[inline]
pub unsafe fn KsGetMultiplePinFactoryItems(filterhandle: super::super::Foundation::HANDLE, pinfactoryid: u32, propertyid: u32, items: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn KsOpenDefaultDevice(category: *const windows_core::GUID, access: u32) -> windows_result::Result<super::super::Foundation::HANDLE> {
...
#[inline]
pub unsafe fn KsResolveRequiredAttributes(datarange: *const KSDATAFORMAT, attributes: Option<*const KSMULTIPLE_ITEM>) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn KsSynchronousDeviceControl(handle: super::super::Foundation::HANDLE, iocontrol: u32, inbuffer: Option<*const core::ffi::c_void>, inlength: u32, outbuffer: Option<*mut core::ffi::c_void>, outlength: u32, bytesreturned: Option<*mut u32>) -> windows_result::Result<()> {
...
impl IKsAggregateControl {
    pub unsafe fn KsAddAggregate(&self, aggregateclass: *const windows_core::GUID) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).KsAddAggregate)(windows_core::Interface::as_raw(self), aggregateclass).ok() }
    }
    pub unsafe fn KsRemoveAggregate(&self, aggregateclass: *const windows_core::GUID) -> windows_result::Result<()> {
...
pub trait IKsAggregateControl_Impl: windows_core::IUnknownImpl {
    fn KsAddAggregate(&self, aggregateclass: *const windows_core::GUID) -> windows_result::Result<()>;
    fn KsRemoveAggregate(&self, aggregateclass: *const windows_core::GUID) -> windows_result::Result<()>;
}
...
impl IKsAllocator {
    ...
    pub unsafe fn KsGetAllocatorStatus(&self, allocatorstatus: *mut KSSTREAMALLOCATOR_STATUS) -> windows_result::Result<()> {
...
pub trait IKsAllocator_Impl: windows_core::IUnknownImpl {
    ...
    fn KsGetAllocatorStatus(&self, allocatorstatus: *mut KSSTREAMALLOCATOR_STATUS) -> windows_result::Result<()>;
...
impl IKsClockPropertySet {
    ...
    pub unsafe fn KsSetCorrelatedPhysicalTime(&self, correlatedtime: *const KSCORRELATED_TIME) -> windows_result::Result<()> {
    ...
    pub unsafe fn KsGetResolution(&self) -> windows_result::Result<KSRESOLUTION> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).KsGetResolution)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn KsGetState(&self) -> windows_result::Result<KSSTATE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IKsClockPropertySet_Impl: windows_core::IUnknownImpl {
    fn KsGetTime(&self) -> windows_result::Result<i64>;
    fn KsSetTime(&self, time: i64) -> windows_result::Result<()>;
    fn KsGetPhysicalTime(&self) -> windows_result::Result<i64>;
    fn KsSetPhysicalTime(&self, time: i64) -> windows_result::Result<()>;
    fn KsGetCorrelatedTime(&self) -> windows_result::Result<KSCORRELATED_TIME>;
    fn KsSetCorrelatedTime(&self, correlatedtime: *const KSCORRELATED_TIME) -> windows_result::Result<()>;
    fn KsGetCorrelatedPhysicalTime(&self) -> windows_result::Result<KSCORRELATED_TIME>;
    fn KsSetCorrelatedPhysicalTime(&self, correlatedtime: *const KSCORRELATED_TIME) -> windows_result::Result<()>;
    fn KsGetResolution(&self) -> windows_result::Result<KSRESOLUTION>;
    fn KsGetState(&self) -> windows_result::Result<KSSTATE>;
}
...
impl IKsControl {
    pub unsafe fn KsProperty(&self, property: *const KSIDENTIFIER, propertylength: u32, propertydata: *mut core::ffi::c_void, datalength: u32, bytesreturned: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn KsMethod(&self, method: *const KSIDENTIFIER, methodlength: u32, methoddata: *mut core::ffi::c_void, datalength: u32, bytesreturned: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn KsEvent(&self, event: *const KSIDENTIFIER, eventlength: u32, eventdata: *mut core::ffi::c_void, datalength: u32, bytesreturned: *mut u32) -> windows_result::Result<()> {
...
pub trait IKsControl_Impl: windows_core::IUnknownImpl {
    fn KsProperty(&self, property: *const KSIDENTIFIER, propertylength: u32, propertydata: *mut core::ffi::c_void, datalength: u32, bytesreturned: *mut u32) -> windows_result::Result<()>;
    fn KsMethod(&self, method: *const KSIDENTIFIER, methodlength: u32, methoddata: *mut core::ffi::c_void, datalength: u32, bytesreturned: *mut u32) -> windows_result::Result<()>;
    fn KsEvent(&self, event: *const KSIDENTIFIER, eventlength: u32, eventdata: *mut core::ffi::c_void, datalength: u32, bytesreturned: *mut u32) -> windows_result::Result<()>;
}
...
impl IKsDataTypeCompletion {
    #[cfg(feature = "Win32_Media_MediaFoundation")]
    pub unsafe fn KsCompleteMediaType(&self, filterhandle: super::super::Foundation::HANDLE, pinfactoryid: u32, ammediatype: *mut super::MediaFoundation::AM_MEDIA_TYPE) -> windows_result::Result<()> {
...
pub trait IKsDataTypeCompletion_Impl: windows_core::IUnknownImpl {
    fn KsCompleteMediaType(&self, filterhandle: super::super::Foundation::HANDLE, pinfactoryid: u32, ammediatype: *mut super::MediaFoundation::AM_MEDIA_TYPE) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Media_MediaFoundation")]
...
impl IKsDataTypeHandler {
    ...
    pub unsafe fn KsCompleteIoOperation<P0>(&self, sample: P0, streamheader: *mut core::ffi::c_void, iooperation: KSIOOPERATION, cancelled: bool) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn KsIsMediaTypeInRanges(&self, dataranges: *const core::ffi::c_void) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).KsIsMediaTypeInRanges)(windows_core::Interface::as_raw(self), dataranges).ok() }
    }
    #[cfg(feature = "Win32_Media_DirectShow")]
    pub unsafe fn KsPrepareIoOperation<P0>(&self, sample: P0, streamheader: *mut core::ffi::c_void, iooperation: KSIOOPERATION) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::DirectShow::IMediaSample>,
    {
    ...
    pub unsafe fn KsQueryExtendedSize(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_Media_MediaFoundation")]
    pub unsafe fn KsSetMediaType(&self, ammediatype: *const super::MediaFoundation::AM_MEDIA_TYPE) -> windows_result::Result<()> {
...
pub trait IKsDataTypeHandler_Impl: windows_core::IUnknownImpl {
    fn KsCompleteIoOperation(&self, sample: windows_core::Ref<super::DirectShow::IMediaSample>, streamheader: *mut core::ffi::c_void, iooperation: KSIOOPERATION, cancelled: windows_core::BOOL) -> windows_result::Result<()>;
    fn KsIsMediaTypeInRanges(&self, dataranges: *const core::ffi::c_void) -> windows_result::Result<()>;
    fn KsPrepareIoOperation(&self, sample: windows_core::Ref<super::DirectShow::IMediaSample>, streamheader: *mut core::ffi::c_void, iooperation: KSIOOPERATION) -> windows_result::Result<()>;
    fn KsQueryExtendedSize(&self) -> windows_result::Result<u32>;
    fn KsSetMediaType(&self, ammediatype: *const super::MediaFoundation::AM_MEDIA_TYPE) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_Media_DirectShow", feature = "Win32_Media_MediaFoundation"))]
...
impl IKsFormatSupport {
    pub unsafe fn IsFormatSupported(&self, pksformat: *mut KSDATAFORMAT, cbformat: u32, pbsupported: *mut windows_core::BOOL) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetDevicePreferredFormat(&self) -> windows_result::Result<*mut KSDATAFORMAT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IKsFormatSupport_Impl: windows_core::IUnknownImpl {
    fn IsFormatSupported(&self, pksformat: *mut KSDATAFORMAT, cbformat: u32, pbsupported: *mut windows_core::BOOL) -> windows_result::Result<()>;
    fn GetDevicePreferredFormat(&self) -> windows_result::Result<*mut KSDATAFORMAT>;
}
...
impl IKsInterfaceHandler {
    pub unsafe fn KsSetPin<P0>(&self, kspin: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IKsPin>,
    {
    ...
    #[cfg(feature = "Win32_Media_DirectShow")]
    pub unsafe fn KsProcessMediaSamples<P0>(&self, ksdatatypehandler: P0, samplelist: *const Option<super::DirectShow::IMediaSample>, samplecount: *mut i32, iooperation: KSIOOPERATION, streamsegment: *mut *mut KSSTREAM_SEGMENT) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn KsCompleteIo(&self, streamsegment: *mut KSSTREAM_SEGMENT) -> windows_result::Result<()> {
...
pub trait IKsInterfaceHandler_Impl: windows_core::IUnknownImpl {
    fn KsSetPin(&self, kspin: windows_core::Ref<IKsPin>) -> windows_result::Result<()>;
    fn KsProcessMediaSamples(&self, ksdatatypehandler: windows_core::Ref<IKsDataTypeHandler>, samplelist: *const Option<super::DirectShow::IMediaSample>, samplecount: *mut i32, iooperation: KSIOOPERATION, streamsegment: *mut *mut KSSTREAM_SEGMENT) -> windows_result::Result<()>;
    fn KsCompleteIo(&self, streamsegment: *mut KSSTREAM_SEGMENT) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Media_DirectShow")]
...
impl IKsJackContainerId {
    pub unsafe fn GetJackContainerId(&self) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IKsJackContainerId_Impl: windows_core::IUnknownImpl {
    fn GetJackContainerId(&self) -> windows_result::Result<windows_core::GUID>;
}
...
impl IKsJackDescription {
    pub unsafe fn GetJackCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetJackCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetJackDescription(&self, njack: u32, pdescription: *mut KSJACK_DESCRIPTION) -> windows_result::Result<()> {
...
pub trait IKsJackDescription_Impl: windows_core::IUnknownImpl {
    fn GetJackCount(&self) -> windows_result::Result<u32>;
    fn GetJackDescription(&self, njack: u32, pdescription: *mut KSJACK_DESCRIPTION) -> windows_result::Result<()>;
}
...
impl IKsJackDescription2 {
    ...
    pub unsafe fn GetJackDescription2(&self, njack: u32) -> windows_result::Result<KSJACK_DESCRIPTION2> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IKsJackDescription2_Impl: windows_core::IUnknownImpl {
    fn GetJackCount(&self) -> windows_result::Result<u32>;
    fn GetJackDescription2(&self, njack: u32) -> windows_result::Result<KSJACK_DESCRIPTION2>;
}
...
impl IKsJackDescription3 {
    ...
    pub unsafe fn GetJackDescription3(&self, njack: u32) -> windows_result::Result<KSJACK_DESCRIPTION3> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IKsJackDescription3_Impl: windows_core::IUnknownImpl {
    fn GetJackCount(&self) -> windows_result::Result<u32>;
    fn GetJackDescription3(&self, njack: u32) -> windows_result::Result<KSJACK_DESCRIPTION3>;
}
...
impl IKsJackSinkInformation {
    pub unsafe fn GetJackSinkInformation(&self, pjacksinkinformation: *mut KSJACK_SINK_INFORMATION) -> windows_result::Result<()> {
...
pub trait IKsJackSinkInformation_Impl: windows_core::IUnknownImpl {
    fn GetJackSinkInformation(&self, pjacksinkinformation: *mut KSJACK_SINK_INFORMATION) -> windows_result::Result<()>;
}
...
impl IKsNodeControl {
    pub unsafe fn SetNodeId(&self, dwnodeid: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetNodeId)(windows_core::Interface::as_raw(self), dwnodeid).ok() }
    }
    pub unsafe fn SetKsControl(&self, pkscontrol: *const core::ffi::c_void) -> windows_result::Result<()> {
...
pub trait IKsNodeControl_Impl: windows_core::IUnknownImpl {
    fn SetNodeId(&self, dwnodeid: u32) -> windows_result::Result<()>;
    fn SetKsControl(&self, pkscontrol: *const core::ffi::c_void) -> windows_result::Result<()>;
}
...
impl IKsNotifyEvent {
    pub unsafe fn KsNotifyEvent(&self, event: u32, lparam1: usize, lparam2: usize) -> windows_result::Result<()> {
...
pub trait IKsNotifyEvent_Impl: windows_core::IUnknownImpl {
    fn KsNotifyEvent(&self, event: u32, lparam1: usize, lparam2: usize) -> windows_result::Result<()>;
}
...
impl IKsPin {
    pub unsafe fn KsQueryMediums(&self) -> windows_result::Result<*mut KSMULTIPLE_ITEM> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).KsQueryMediums)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn KsQueryInterfaces(&self) -> windows_result::Result<*mut KSMULTIPLE_ITEM> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).KsQueryInterfaces)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn KsCreateSinkPinHandle(&self, interface: *const KSIDENTIFIER, medium: *const KSIDENTIFIER) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).KsCreateSinkPinHandle)(windows_core::Interface::as_raw(self), interface, medium).ok() }
    }
    pub unsafe fn KsGetCurrentCommunication(&self, communication: Option<*mut KSPIN_COMMUNICATION>, interface: Option<*mut KSIDENTIFIER>, medium: Option<*mut KSIDENTIFIER>) -> windows_result::Result<()> {
    ...
    pub unsafe fn KsPropagateAcquire(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).KsPropagateAcquire)(windows_core::Interface::as_raw(self)).ok() }
    }
    #[cfg(feature = "Win32_Media_DirectShow")]
    pub unsafe fn KsDeliver<P0>(&self, sample: P0, flags: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::DirectShow::IMediaSample>,
    {
        unsafe { (windows_core::Interface::vtable(self).KsDeliver)(windows_core::Interface::as_raw(self), sample.param().abi(), flags).ok() }
    }
    pub unsafe fn KsMediaSamplesCompleted(&self, streamsegment: *const KSSTREAM_SEGMENT) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_Media_DirectShow")]
    pub unsafe fn KsReceiveAllocator<P0>(&self, memallocator: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn KsRenegotiateAllocator(&self) -> windows_result::Result<()> {
    ...
    pub unsafe fn KsQualityNotify(&self, proportion: u32, timedelta: i64) -> windows_result::Result<()> {
...
pub trait IKsPin_Impl: windows_core::IUnknownImpl {
    fn KsQueryMediums(&self) -> windows_result::Result<*mut KSMULTIPLE_ITEM>;
    fn KsQueryInterfaces(&self) -> windows_result::Result<*mut KSMULTIPLE_ITEM>;
    fn KsCreateSinkPinHandle(&self, interface: *const KSIDENTIFIER, medium: *const KSIDENTIFIER) -> windows_result::Result<()>;
    fn KsGetCurrentCommunication(&self, communication: *mut KSPIN_COMMUNICATION, interface: *mut KSIDENTIFIER, medium: *mut KSIDENTIFIER) -> windows_result::Result<()>;
    fn KsPropagateAcquire(&self) -> windows_result::Result<()>;
    fn KsDeliver(&self, sample: windows_core::Ref<super::DirectShow::IMediaSample>, flags: u32) -> windows_result::Result<()>;
    fn KsMediaSamplesCompleted(&self, streamsegment: *const KSSTREAM_SEGMENT) -> windows_result::Result<()>;
    fn KsPeekAllocator(&self, operation: KSPEEKOPERATION) -> Option<super::DirectShow::IMemAllocator>;
    fn KsReceiveAllocator(&self, memallocator: windows_core::Ref<super::DirectShow::IMemAllocator>) -> windows_result::Result<()>;
    fn KsRenegotiateAllocator(&self) -> windows_result::Result<()>;
    fn KsIncrementPendingIoCount(&self) -> i32;
    fn KsDecrementPendingIoCount(&self) -> i32;
    fn KsQualityNotify(&self, proportion: u32, timedelta: i64) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Media_DirectShow")]
impl IKsPin_Vtbl {
...
impl IKsPinFactory {
    pub unsafe fn KsPinFactory(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IKsPinFactory_Impl: windows_core::IUnknownImpl {
    fn KsPinFactory(&self) -> windows_result::Result<u32>;
}
...
impl IKsPinPipe {
    pub unsafe fn KsGetPinFramingCache(&self, framingex: *mut *mut KSALLOCATOR_FRAMING_EX, framingprop: *mut FRAMING_PROP, option: FRAMING_CACHE_OPS) -> windows_result::Result<()> {
    ...
    pub unsafe fn KsSetPinFramingCache(&self, framingex: *const KSALLOCATOR_FRAMING_EX, framingprop: *const FRAMING_PROP, option: FRAMING_CACHE_OPS) -> windows_result::Result<()> {
    ...
    pub unsafe fn KsSetPipe<P0>(&self, ksallocator: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn KsSetPipeAllocatorFlag(&self, flag: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn KsSetPinBusCache(&self, bus: windows_core::GUID) -> windows_result::Result<()> {
...
pub trait IKsPinPipe_Impl: windows_core::IUnknownImpl {
    fn KsGetPinFramingCache(&self, framingex: *mut *mut KSALLOCATOR_FRAMING_EX, framingprop: *mut FRAMING_PROP, option: FRAMING_CACHE_OPS) -> windows_result::Result<()>;
    fn KsSetPinFramingCache(&self, framingex: *const KSALLOCATOR_FRAMING_EX, framingprop: *const FRAMING_PROP, option: FRAMING_CACHE_OPS) -> windows_result::Result<()>;
    fn KsGetConnectedPin(&self) -> Option<super::DirectShow::IPin>;
    fn KsGetPipe(&self, operation: KSPEEKOPERATION) -> Option<IKsAllocatorEx>;
    fn KsSetPipe(&self, ksallocator: windows_core::Ref<IKsAllocatorEx>) -> windows_result::Result<()>;
    fn KsGetPipeAllocatorFlag(&self) -> u32;
    fn KsSetPipeAllocatorFlag(&self, flag: u32) -> windows_result::Result<()>;
    fn KsGetPinBusCache(&self) -> windows_core::GUID;
    fn KsSetPinBusCache(&self, bus: &windows_core::GUID) -> windows_result::Result<()>;
...
impl IKsPropertySet {
    pub unsafe fn Set(&self, guidpropset: *const windows_core::GUID, dwpropid: u32, pinstancedata: *const core::ffi::c_void, cbinstancedata: u32, ppropdata: *const core::ffi::c_void, cbpropdata: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Get(&self, guidpropset: *const windows_core::GUID, dwpropid: u32, pinstancedata: *const core::ffi::c_void, cbinstancedata: u32, ppropdata: *mut core::ffi::c_void, cbpropdata: u32, pcbreturned: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn QuerySupported(&self, guidpropset: *const windows_core::GUID, dwpropid: u32) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IKsPropertySet_Impl: windows_core::IUnknownImpl {
    fn Set(&self, guidpropset: *const windows_core::GUID, dwpropid: u32, pinstancedata: *const core::ffi::c_void, cbinstancedata: u32, ppropdata: *const core::ffi::c_void, cbpropdata: u32) -> windows_result::Result<()>;
    fn Get(&self, guidpropset: *const windows_core::GUID, dwpropid: u32, pinstancedata: *const core::ffi::c_void, cbinstancedata: u32, ppropdata: *mut core::ffi::c_void, cbpropdata: u32, pcbreturned: *mut u32) -> windows_result::Result<()>;
    fn QuerySupported(&self, guidpropset: *const windows_core::GUID, dwpropid: u32) -> windows_result::Result<u32>;
}
...
impl IKsTopology {
    pub unsafe fn CreateNodeInstance<P3>(&self, nodeid: u32, flags: u32, desiredaccess: u32, unkouter: P3, interfaceid: *const windows_core::GUID, interface: *mut *mut core::ffi::c_void) -> windows_result::Result<()>
    where
...
pub trait IKsTopology_Impl: windows_core::IUnknownImpl {
    fn CreateNodeInstance(&self, nodeid: u32, flags: u32, desiredaccess: u32, unkouter: windows_core::Ref<windows_core::IUnknown>, interfaceid: *const windows_core::GUID, interface: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
}
...
impl IKsTopologyInfo {
    ...
    pub unsafe fn get_NodeName(&self, dwnodeid: u32, pwchnodename: Option<windows_core::PWSTR>, dwbufsize: u32, pdwnamelen: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn NumNodes(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).NumNodes)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn get_NodeType(&self, dwnodeid: u32) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_NodeType)(windows_core::Interface::as_raw(self), dwnodeid, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn CreateNodeInstance(&self, dwnodeid: u32, iid: *const windows_core::GUID, ppvobject: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
...
pub trait IKsTopologyInfo_Impl: windows_core::IUnknownImpl {
    fn NumCategories(&self) -> windows_result::Result<u32>;
    fn get_Category(&self, dwindex: u32) -> windows_result::Result<windows_core::GUID>;
    fn NumConnections(&self) -> windows_result::Result<u32>;
    fn get_ConnectionInfo(&self, dwindex: u32) -> windows_result::Result<KSTOPOLOGY_CONNECTION>;
    fn get_NodeName(&self, dwnodeid: u32, pwchnodename: windows_core::PWSTR, dwbufsize: u32, pdwnamelen: *mut u32) -> windows_result::Result<()>;
    fn NumNodes(&self) -> windows_result::Result<u32>;
    fn get_NodeType(&self, dwnodeid: u32) -> windows_result::Result<windows_core::GUID>;
    fn CreateNodeInstance(&self, dwnodeid: u32, iid: *const windows_core::GUID, ppvobject: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
}
