...
impl IPhotoAcquire {
    pub unsafe fn CreatePhotoSource<P0>(&self, pszdevice: P0) -> windows_result::Result<IPhotoAcquireSource>
    where
    ...
    pub unsafe fn Acquire<P0, P3, P4>(&self, pphotoacquiresource: P0, fshowprogress: bool, hwndparent: Option<super::super::Foundation::HWND>, pszapplicationname: P3, pphotoacquireprogresscb: P4) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn EnumResults(&self) -> windows_result::Result<super::super::System::Com::IEnumString> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPhotoAcquire_Impl: windows_core::IUnknownImpl {
    fn CreatePhotoSource(&self, pszdevice: &windows_core::PCWSTR) -> windows_result::Result<IPhotoAcquireSource>;
    fn Acquire(&self, pphotoacquiresource: windows_core::Ref<IPhotoAcquireSource>, fshowprogress: windows_core::BOOL, hwndparent: super::super::Foundation::HWND, pszapplicationname: &windows_core::PCWSTR, pphotoacquireprogresscb: windows_core::Ref<IPhotoAcquireProgressCB>) -> windows_result::Result<()>;
    fn EnumResults(&self) -> windows_result::Result<super::super::System::Com::IEnumString>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IPhotoAcquireDeviceSelectionDialog {
    pub unsafe fn SetTitle<P0>(&self, psztitle: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetTitle)(windows_core::Interface::as_raw(self), psztitle.param().abi()).ok() }
    }
    pub unsafe fn SetSubmitButtonText<P0>(&self, pszsubmitbuttontext: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn DoModal(&self, hwndparent: super::super::Foundation::HWND, dwdeviceflags: u32, pbstrdeviceid: Option<*mut windows_core::BSTR>, pndevicetype: Option<*mut DEVICE_SELECTION_DEVICE_TYPE>) -> windows_result::Result<()> {
...
pub trait IPhotoAcquireDeviceSelectionDialog_Impl: windows_core::IUnknownImpl {
    fn SetTitle(&self, psztitle: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn SetSubmitButtonText(&self, pszsubmitbuttontext: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn DoModal(&self, hwndparent: super::super::Foundation::HWND, dwdeviceflags: u32, pbstrdeviceid: *mut windows_core::BSTR, pndevicetype: *mut DEVICE_SELECTION_DEVICE_TYPE) -> windows_result::Result<()>;
}
...
impl IPhotoAcquireItem {
    pub unsafe fn GetItemName(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetThumbnail(&self, sizethumbnail: super::super::Foundation::SIZE) -> windows_result::Result<super::super::Graphics::Gdi::HBITMAP> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetProperty(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<super::super::System::Com::StructuredStorage::PROPVARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn SetProperty(&self, key: *const super::super::Foundation::PROPERTYKEY, pv: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetProperty)(windows_core::Interface::as_raw(self), key, core::mem::transmute(pv)).ok() }
    }
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetStream(&self) -> windows_result::Result<super::super::System::Com::IStream> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CanDelete(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetSubItemCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSubItemCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetSubItemAt(&self, nitemindex: u32) -> windows_result::Result<IPhotoAcquireItem> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPhotoAcquireItem_Impl: windows_core::IUnknownImpl {
    fn GetItemName(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetThumbnail(&self, sizethumbnail: &super::super::Foundation::SIZE) -> windows_result::Result<super::super::Graphics::Gdi::HBITMAP>;
    fn GetProperty(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<super::super::System::Com::StructuredStorage::PROPVARIANT>;
    fn SetProperty(&self, key: *const super::super::Foundation::PROPERTYKEY, pv: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()>;
    fn GetStream(&self) -> windows_result::Result<super::super::System::Com::IStream>;
    fn CanDelete(&self) -> windows_result::Result<windows_core::BOOL>;
    fn Delete(&self) -> windows_result::Result<()>;
    fn GetSubItemCount(&self) -> windows_result::Result<u32>;
    fn GetSubItemAt(&self, nitemindex: u32) -> windows_result::Result<IPhotoAcquireItem>;
}
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl IPhotoAcquireOptionsDialog {
    pub unsafe fn Initialize<P0>(&self, pszregistryroot: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).Initialize)(windows_core::Interface::as_raw(self), pszregistryroot.param().abi()).ok() }
    }
    pub unsafe fn Create(&self, hwndparent: super::super::Foundation::HWND) -> windows_result::Result<super::super::Foundation::HWND> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Create)(windows_core::Interface::as_raw(self), hwndparent, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn Destroy(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Destroy)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn DoModal(&self, hwndparent: super::super::Foundation::HWND, ppnreturncode: Option<*mut isize>) -> windows_result::Result<()> {
    ...
    pub unsafe fn SaveData(&self) -> windows_result::Result<()> {
...
pub trait IPhotoAcquireOptionsDialog_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, pszregistryroot: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn Create(&self, hwndparent: super::super::Foundation::HWND) -> windows_result::Result<super::super::Foundation::HWND>;
    fn Destroy(&self) -> windows_result::Result<()>;
    fn DoModal(&self, hwndparent: super::super::Foundation::HWND, ppnreturncode: *mut isize) -> windows_result::Result<()>;
    fn SaveData(&self) -> windows_result::Result<()>;
}
...
impl IPhotoAcquirePlugin {
    pub unsafe fn Initialize<P0, P1>(&self, pphotoacquiresource: P0, pphotoacquireprogresscb: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IPhotoAcquireSource>,
    ...
    pub unsafe fn ProcessItem<P1, P2, P3, P4>(&self, dwacquirestage: u32, pphotoacquireitem: P1, poriginalitemstream: P2, pszfinalfilename: P3, ppropertystore: P4) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn TransferComplete(&self, hr: windows_core::HRESULT) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).TransferComplete)(windows_core::Interface::as_raw(self), hr).ok() }
    }
    pub unsafe fn DisplayConfigureDialog(&self, hwndparent: super::super::Foundation::HWND) -> windows_result::Result<()> {
...
pub trait IPhotoAcquirePlugin_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, pphotoacquiresource: windows_core::Ref<IPhotoAcquireSource>, pphotoacquireprogresscb: windows_core::Ref<IPhotoAcquireProgressCB>) -> windows_result::Result<()>;
    fn ProcessItem(&self, dwacquirestage: u32, pphotoacquireitem: windows_core::Ref<IPhotoAcquireItem>, poriginalitemstream: windows_core::Ref<super::super::System::Com::IStream>, pszfinalfilename: &windows_core::PCWSTR, ppropertystore: windows_core::Ref<super::super::UI::Shell::PropertiesSystem::IPropertyStore>) -> windows_result::Result<()>;
    fn TransferComplete(&self, hr: windows_core::HRESULT) -> windows_result::Result<()>;
    fn DisplayConfigureDialog(&self, hwndparent: super::super::Foundation::HWND) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_UI_Shell_PropertiesSystem"))]
...
impl IPhotoAcquireProgressCB {
    pub unsafe fn Cancelled(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Cancelled)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn StartEnumeration<P0>(&self, pphotoacquiresource: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IPhotoAcquireSource>,
    {
    ...
    pub unsafe fn FoundItem<P0>(&self, pphotoacquireitem: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn EndEnumeration(&self, hr: windows_core::HRESULT) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).EndEnumeration)(windows_core::Interface::as_raw(self), hr).ok() }
    }
    pub unsafe fn StartTransfer<P0>(&self, pphotoacquiresource: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IPhotoAcquireSource>,
    {
    ...
    pub unsafe fn StartItemTransfer<P1>(&self, nitemindex: u32, pphotoacquireitem: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<IPhotoAcquireItem>,
    {
    ...
    pub unsafe fn DirectoryCreated<P0>(&self, pszdirectory: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).DirectoryCreated)(windows_core::Interface::as_raw(self), pszdirectory.param().abi()).ok() }
    }
    pub unsafe fn UpdateTransferPercent(&self, foverall: bool, npercent: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn EndItemTransfer<P1>(&self, nitemindex: u32, pphotoacquireitem: P1, hr: windows_core::HRESULT) -> windows_result::Result<()>
    where
        P1: windows_core::Param<IPhotoAcquireItem>,
    {
    ...
    pub unsafe fn EndTransfer(&self, hr: windows_core::HRESULT) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).EndTransfer)(windows_core::Interface::as_raw(self), hr).ok() }
    }
    pub unsafe fn StartDelete<P0>(&self, pphotoacquiresource: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IPhotoAcquireSource>,
    {
    ...
    pub unsafe fn StartItemDelete<P1>(&self, nitemindex: u32, pphotoacquireitem: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<IPhotoAcquireItem>,
    {
    ...
    pub unsafe fn UpdateDeletePercent(&self, npercent: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).UpdateDeletePercent)(windows_core::Interface::as_raw(self), npercent).ok() }
    }
    pub unsafe fn EndItemDelete<P1>(&self, nitemindex: u32, pphotoacquireitem: P1, hr: windows_core::HRESULT) -> windows_result::Result<()>
    where
        P1: windows_core::Param<IPhotoAcquireItem>,
    {
    ...
    pub unsafe fn EndDelete(&self, hr: windows_core::HRESULT) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).EndDelete)(windows_core::Interface::as_raw(self), hr).ok() }
    }
    pub unsafe fn EndSession(&self, hr: windows_core::HRESULT) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).EndSession)(windows_core::Interface::as_raw(self), hr).ok() }
    }
    pub unsafe fn GetDeleteAfterAcquire(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDeleteAfterAcquire)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn ErrorAdvise<P1>(&self, hr: windows_core::HRESULT, pszerrormessage: P1, nmessagetype: ERROR_ADVISE_MESSAGE_TYPE) -> windows_result::Result<ERROR_ADVISE_RESULT>
    where
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn GetUserInput<P1>(&self, riidtype: *const windows_core::GUID, punknown: P1, ppropvarresult: *mut super::super::System::Com::StructuredStorage::PROPVARIANT, ppropvardefault: Option<*const super::super::System::Com::StructuredStorage::PROPVARIANT>) -> windows_result::Result<()>
    where
...
pub trait IPhotoAcquireProgressCB_Impl: windows_core::IUnknownImpl {
    fn Cancelled(&self) -> windows_result::Result<windows_core::BOOL>;
    fn StartEnumeration(&self, pphotoacquiresource: windows_core::Ref<IPhotoAcquireSource>) -> windows_result::Result<()>;
    fn FoundItem(&self, pphotoacquireitem: windows_core::Ref<IPhotoAcquireItem>) -> windows_result::Result<()>;
    fn EndEnumeration(&self, hr: windows_core::HRESULT) -> windows_result::Result<()>;
    fn StartTransfer(&self, pphotoacquiresource: windows_core::Ref<IPhotoAcquireSource>) -> windows_result::Result<()>;
    fn StartItemTransfer(&self, nitemindex: u32, pphotoacquireitem: windows_core::Ref<IPhotoAcquireItem>) -> windows_result::Result<()>;
    fn DirectoryCreated(&self, pszdirectory: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn UpdateTransferPercent(&self, foverall: windows_core::BOOL, npercent: u32) -> windows_result::Result<()>;
    fn EndItemTransfer(&self, nitemindex: u32, pphotoacquireitem: windows_core::Ref<IPhotoAcquireItem>, hr: windows_core::HRESULT) -> windows_result::Result<()>;
    fn EndTransfer(&self, hr: windows_core::HRESULT) -> windows_result::Result<()>;
    fn StartDelete(&self, pphotoacquiresource: windows_core::Ref<IPhotoAcquireSource>) -> windows_result::Result<()>;
    fn StartItemDelete(&self, nitemindex: u32, pphotoacquireitem: windows_core::Ref<IPhotoAcquireItem>) -> windows_result::Result<()>;
    fn UpdateDeletePercent(&self, npercent: u32) -> windows_result::Result<()>;
    fn EndItemDelete(&self, nitemindex: u32, pphotoacquireitem: windows_core::Ref<IPhotoAcquireItem>, hr: windows_core::HRESULT) -> windows_result::Result<()>;
    fn EndDelete(&self, hr: windows_core::HRESULT) -> windows_result::Result<()>;
    fn EndSession(&self, hr: windows_core::HRESULT) -> windows_result::Result<()>;
    fn GetDeleteAfterAcquire(&self) -> windows_result::Result<windows_core::BOOL>;
    fn ErrorAdvise(&self, hr: windows_core::HRESULT, pszerrormessage: &windows_core::PCWSTR, nmessagetype: ERROR_ADVISE_MESSAGE_TYPE) -> windows_result::Result<ERROR_ADVISE_RESULT>;
    fn GetUserInput(&self, riidtype: *const windows_core::GUID, punknown: windows_core::Ref<windows_core::IUnknown>, ppropvarresult: *mut super::super::System::Com::StructuredStorage::PROPVARIANT, ppropvardefault: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl IPhotoAcquireSettings {
    pub unsafe fn InitializeFromRegistry<P0>(&self, pszregistrykey: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetFlags(&self, dwphotoacquireflags: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetFlags)(windows_core::Interface::as_raw(self), dwphotoacquireflags).ok() }
    }
    pub unsafe fn SetOutputFilenameTemplate<P0>(&self, psztemplate: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetOutputFilenameTemplate(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetAcquisitionTime(&self) -> windows_result::Result<super::super::Foundation::FILETIME> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPhotoAcquireSettings_Impl: windows_core::IUnknownImpl {
    fn InitializeFromRegistry(&self, pszregistrykey: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn SetFlags(&self, dwphotoacquireflags: u32) -> windows_result::Result<()>;
    fn SetOutputFilenameTemplate(&self, psztemplate: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn SetSequencePaddingWidth(&self, dwwidth: u32) -> windows_result::Result<()>;
    fn SetSequenceZeroPadding(&self, fzeropad: windows_core::BOOL) -> windows_result::Result<()>;
    fn SetGroupTag(&self, pszgrouptag: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn SetAcquisitionTime(&self, pftacquisitiontime: *const super::super::Foundation::FILETIME) -> windows_result::Result<()>;
    fn GetFlags(&self) -> windows_result::Result<u32>;
    fn GetOutputFilenameTemplate(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetSequencePaddingWidth(&self) -> windows_result::Result<u32>;
    fn GetSequenceZeroPadding(&self) -> windows_result::Result<windows_core::BOOL>;
    fn GetGroupTag(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetAcquisitionTime(&self) -> windows_result::Result<super::super::Foundation::FILETIME>;
}
...
impl IPhotoAcquireSource {
    pub unsafe fn GetFriendlyName(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetDeviceIcons(&self, nsize: u32, phlargeicon: Option<*mut super::super::UI::WindowsAndMessaging::HICON>, phsmallicon: Option<*mut super::super::UI::WindowsAndMessaging::HICON>) -> windows_result::Result<()> {
    ...
    pub unsafe fn InitializeItemList<P1>(&self, fforceenumeration: bool, pphotoacquireprogresscb: P1, pnitemcount: Option<*mut u32>) -> windows_result::Result<()>
    where
        P1: windows_core::Param<IPhotoAcquireProgressCB>,
    {
    ...
    pub unsafe fn GetItemAt(&self, nindex: u32) -> windows_result::Result<IPhotoAcquireItem> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetPhotoAcquireSettings(&self) -> windows_result::Result<IPhotoAcquireSettings> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetDeviceId(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn BindToObject(&self, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
...
pub trait IPhotoAcquireSource_Impl: windows_core::IUnknownImpl {
    fn GetFriendlyName(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetDeviceIcons(&self, nsize: u32, phlargeicon: *mut super::super::UI::WindowsAndMessaging::HICON, phsmallicon: *mut super::super::UI::WindowsAndMessaging::HICON) -> windows_result::Result<()>;
    fn InitializeItemList(&self, fforceenumeration: windows_core::BOOL, pphotoacquireprogresscb: windows_core::Ref<IPhotoAcquireProgressCB>, pnitemcount: *mut u32) -> windows_result::Result<()>;
    fn GetItemCount(&self) -> windows_result::Result<u32>;
    fn GetItemAt(&self, nindex: u32) -> windows_result::Result<IPhotoAcquireItem>;
    fn GetPhotoAcquireSettings(&self) -> windows_result::Result<IPhotoAcquireSettings>;
    fn GetDeviceId(&self) -> windows_result::Result<windows_core::BSTR>;
    fn BindToObject(&self, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
impl IPhotoProgressActionCB {
    pub unsafe fn DoAction(&self, hwndparent: super::super::Foundation::HWND) -> windows_result::Result<()> {
...
pub trait IPhotoProgressActionCB_Impl: windows_core::IUnknownImpl {
    fn DoAction(&self, hwndparent: super::super::Foundation::HWND) -> windows_result::Result<()>;
}
...
impl IPhotoProgressDialog {
    pub unsafe fn Create(&self, hwndparent: super::super::Foundation::HWND) -> windows_result::Result<()> {
    ...
    pub unsafe fn ShowCheckbox(&self, ncheckboxid: PROGRESS_DIALOG_CHECKBOX_ID, fshow: bool) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ShowCheckbox)(windows_core::Interface::as_raw(self), ncheckboxid, fshow.into()).ok() }
    }
    pub unsafe fn SetCheckboxText<P1>(&self, ncheckboxid: PROGRESS_DIALOG_CHECKBOX_ID, pszcheckboxtext: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetCheckboxCheck(&self, ncheckboxid: PROGRESS_DIALOG_CHECKBOX_ID, fchecked: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetCheckboxTooltip<P1>(&self, ncheckboxid: PROGRESS_DIALOG_CHECKBOX_ID, pszcheckboxtooltiptext: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn IsCheckboxChecked(&self, ncheckboxid: PROGRESS_DIALOG_CHECKBOX_ID) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetCaption<P0>(&self, psztitle: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetImage(&self, nimagetype: PROGRESS_DIALOG_IMAGE_TYPE, hicon: Option<super::super::UI::WindowsAndMessaging::HICON>, hbitmap: Option<super::super::Graphics::Gdi::HBITMAP>) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetPercentComplete(&self, npercent: i32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetPercentComplete)(windows_core::Interface::as_raw(self), npercent).ok() }
    }
    pub unsafe fn SetProgressText<P0>(&self, pszprogresstext: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetActionLinkCallback<P0>(&self, pphotoprogressactioncb: P0) -> windows_result::Result<()>
    where
...
pub trait IPhotoProgressDialog_Impl: windows_core::IUnknownImpl {
    fn Create(&self, hwndparent: super::super::Foundation::HWND) -> windows_result::Result<()>;
    fn GetWindow(&self) -> windows_result::Result<super::super::Foundation::HWND>;
    fn Destroy(&self) -> windows_result::Result<()>;
    fn SetTitle(&self, psztitle: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn ShowCheckbox(&self, ncheckboxid: PROGRESS_DIALOG_CHECKBOX_ID, fshow: windows_core::BOOL) -> windows_result::Result<()>;
    fn SetCheckboxText(&self, ncheckboxid: PROGRESS_DIALOG_CHECKBOX_ID, pszcheckboxtext: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn SetCheckboxCheck(&self, ncheckboxid: PROGRESS_DIALOG_CHECKBOX_ID, fchecked: windows_core::BOOL) -> windows_result::Result<()>;
    fn SetCheckboxTooltip(&self, ncheckboxid: PROGRESS_DIALOG_CHECKBOX_ID, pszcheckboxtooltiptext: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn IsCheckboxChecked(&self, ncheckboxid: PROGRESS_DIALOG_CHECKBOX_ID) -> windows_result::Result<windows_core::BOOL>;
    fn SetCaption(&self, psztitle: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn SetImage(&self, nimagetype: PROGRESS_DIALOG_IMAGE_TYPE, hicon: super::super::UI::WindowsAndMessaging::HICON, hbitmap: super::super::Graphics::Gdi::HBITMAP) -> windows_result::Result<()>;
    fn SetPercentComplete(&self, npercent: i32) -> windows_result::Result<()>;
    fn SetProgressText(&self, pszprogresstext: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn SetActionLinkCallback(&self, pphotoprogressactioncb: windows_core::Ref<IPhotoProgressActionCB>) -> windows_result::Result<()>;
    fn SetActionLinkText(&self, pszcaption: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn ShowActionLink(&self, fshow: windows_core::BOOL) -> windows_result::Result<()>;
    fn IsCancelled(&self) -> windows_result::Result<windows_core::BOOL>;
    fn GetUserInput(&self, riidtype: *const windows_core::GUID, punknown: windows_core::Ref<windows_core::IUnknown>, ppropvarresult: *mut super::super::System::Com::StructuredStorage::PROPVARIANT, ppropvardefault: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant", feature = "Win32_UI_WindowsAndMessaging"))]
...
impl IUserInputString {
    pub unsafe fn GetSubmitButtonText(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetPrompt(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetStringId(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetStringType(&self) -> windows_result::Result<USER_INPUT_STRING_TYPE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetStringType)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetTooltipText(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetMaxLength(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMaxLength)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetDefault(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetMruCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMruCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetMruEntryAt(&self, nindex: u32) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_UI_WindowsAndMessaging"))]
    pub unsafe fn GetImage(&self, nsize: u32, phbitmap: Option<*mut super::super::Graphics::Gdi::HBITMAP>, phicon: Option<*mut super::super::UI::WindowsAndMessaging::HICON>) -> windows_result::Result<()> {
...
pub trait IUserInputString_Impl: windows_core::IUnknownImpl {
    fn GetSubmitButtonText(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetPrompt(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetStringId(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetStringType(&self) -> windows_result::Result<USER_INPUT_STRING_TYPE>;
    fn GetTooltipText(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetMaxLength(&self) -> windows_result::Result<u32>;
    fn GetDefault(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetMruCount(&self) -> windows_result::Result<u32>;
    fn GetMruEntryAt(&self, nindex: u32) -> windows_result::Result<windows_core::BSTR>;
    fn GetImage(&self, nsize: u32, phbitmap: *mut super::super::Graphics::Gdi::HBITMAP, phicon: *mut super::super::UI::WindowsAndMessaging::HICON) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_UI_WindowsAndMessaging"))]
