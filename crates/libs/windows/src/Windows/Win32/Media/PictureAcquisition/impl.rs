...
#[doc = "Required features: `\"Win32_Graphics_Gdi\"`, `\"Win32_System_Com\"`, `\"Win32_UI_Shell_PropertiesSystem\"`"]
...
pub trait IPhotoAcquireProgressCB_Impl: Sized {
    ...
    fn GetUserInput(&self, riidtype: *const ::windows_core::GUID, punknown: ::core::option::Option<&::windows_core::IUnknown>, ppropvarresult: *mut ::windows_core::PROPVARIANT, ppropvardefault: *const ::windows_core::PROPVARIANT) -> ::windows_core::Result<()>;
}
