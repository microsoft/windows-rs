...
impl ILoadFilter {
    ...
    #[cfg(all(feature = "Win32_filter", feature = "Win32_objidl"))]
    ...
    #[cfg(all(feature = "Win32_filter", feature = "Win32_objidlbase"))]
...
pub struct ILoadFilter_Vtbl {
    ...
    #[cfg(not(all(feature = "Win32_filter", feature = "Win32_objidl")))]
    ...
    #[cfg(not(all(feature = "Win32_filter", feature = "Win32_objidlbase")))]
    LoadIFilterFromStream: usize,
}
#[cfg(all(feature = "Win32_filter", feature = "Win32_objidl", feature = "Win32_objidlbase"))]
