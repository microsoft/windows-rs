...
impl IDirectDrawVideo {
    ...
    #[cfg(feature = "ddraw")]
    pub unsafe fn GetCaps(&self, pcaps: *mut super::DDCAPS) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).GetCaps)(windows_core::Interface::as_raw(self), pcaps as _) }
    }
    #[cfg(feature = "ddraw")]
    pub unsafe fn GetEmulatedCaps(&self, pcaps: *mut super::DDCAPS) -> windows_core::HRESULT {
    ...
    pub unsafe fn GetSurfaceDesc(&self, psurfacedesc: *mut super::DDSURFACEDESC) -> windows_core::HRESULT {
...
pub struct IDirectDrawVideo_Vtbl {
    ...
    #[cfg(feature = "ddraw")]
    pub GetCaps: unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::DDCAPS) -> windows_core::HRESULT,
    #[cfg(not(feature = "ddraw"))]
    GetCaps: usize,
    #[cfg(feature = "ddraw")]
    pub GetEmulatedCaps: unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::DDCAPS) -> windows_core::HRESULT,
    #[cfg(not(feature = "ddraw"))]
    GetEmulatedCaps: usize,
    #[cfg(all(feature = "ddraw", feature = "ksmedia"))]
    pub GetSurfaceDesc: unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::DDSURFACEDESC) -> windows_core::HRESULT,
...
pub trait IDirectDrawVideo_Impl: windows_core::IUnknownImpl {
    ...
    fn GetCaps(&self, pcaps: *mut super::DDCAPS) -> windows_core::Result<()>;
...
impl IDirectDrawVideo_Vtbl {
    pub const fn new<Identity: IDirectDrawVideo_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetCaps<Identity: IDirectDrawVideo_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pcaps: *mut super::DDCAPS) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDirectDrawVideo_Impl::GetCaps(this, core::mem::transmute_copy(&pcaps)).into()
            }
        }
        unsafe extern "system" fn GetEmulatedCaps<Identity: IDirectDrawVideo_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pcaps: *mut super::DDCAPS) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDirectDrawVideo_Impl::GetEmulatedCaps(this, core::mem::transmute_copy(&pcaps)).into()
            }
        }
        unsafe extern "system" fn GetSurfaceDesc<Identity: IDirectDrawVideo_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, psurfacedesc: *mut super::DDSURFACEDESC) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IFullScreenVideo {
    ...
    #[cfg(feature = "windef")]
    pub unsafe fn SetMessageDrain(&self, hwnd: super::HWND) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetMessageDrain)(windows_core::Interface::as_raw(self), hwnd) }
    }
    #[cfg(feature = "windef")]
    pub unsafe fn GetMessageDrain(&self) -> windows_core::Result<super::HWND> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub struct IFullScreenVideo_Vtbl {
    ...
    #[cfg(feature = "windef")]
    pub SetMessageDrain: unsafe extern "system" fn(*mut core::ffi::c_void, super::HWND) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    SetMessageDrain: usize,
    #[cfg(feature = "windef")]
    pub GetMessageDrain: unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::HWND) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
...
pub trait IFullScreenVideo_Impl: windows_core::IUnknownImpl {
    ...
    fn SetMessageDrain(&self, hwnd: super::HWND) -> windows_core::Result<()>;
    fn GetMessageDrain(&self) -> windows_core::Result<super::HWND>;
...
impl IFullScreenVideo_Vtbl {
    pub const fn new<Identity: IFullScreenVideo_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn SetMessageDrain<Identity: IFullScreenVideo_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hwnd: super::HWND) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IFullScreenVideo_Impl::SetMessageDrain(this, core::mem::transmute_copy(&hwnd)).into()
            }
        }
        unsafe extern "system" fn GetMessageDrain<Identity: IFullScreenVideo_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hwnd: *mut super::HWND) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IFullScreenVideoEx {
    #[cfg(feature = "windef")]
    pub unsafe fn SetAcceleratorTable(&self, hwnd: super::HWND, haccel: super::HACCEL) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).SetAcceleratorTable)(windows_core::Interface::as_raw(self), hwnd, haccel) }
    }
    #[cfg(feature = "windef")]
    pub unsafe fn GetAcceleratorTable(&self, phwnd: *mut super::HWND, phaccel: *mut super::HACCEL) -> windows_core::HRESULT {
...
pub struct IFullScreenVideoEx_Vtbl {
    ...
    #[cfg(feature = "windef")]
    pub SetAcceleratorTable: unsafe extern "system" fn(*mut core::ffi::c_void, super::HWND, super::HACCEL) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    SetAcceleratorTable: usize,
    #[cfg(feature = "windef")]
    pub GetAcceleratorTable: unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::HWND, *mut super::HACCEL) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
...
pub trait IFullScreenVideoEx_Impl: IFullScreenVideo_Impl {
    fn SetAcceleratorTable(&self, hwnd: super::HWND, haccel: super::HACCEL) -> windows_core::Result<()>;
    fn GetAcceleratorTable(&self, phwnd: *mut super::HWND, phaccel: *mut super::HACCEL) -> windows_core::Result<()>;
...
impl IFullScreenVideoEx_Vtbl {
    pub const fn new<Identity: IFullScreenVideoEx_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetAcceleratorTable<Identity: IFullScreenVideoEx_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hwnd: super::HWND, haccel: super::HACCEL) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IFullScreenVideoEx_Impl::SetAcceleratorTable(this, core::mem::transmute_copy(&hwnd), core::mem::transmute_copy(&haccel)).into()
            }
        }
        unsafe extern "system" fn GetAcceleratorTable<Identity: IFullScreenVideoEx_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, phwnd: *mut super::HWND, phaccel: *mut super::HACCEL) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
