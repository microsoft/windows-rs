...
impl IWCNConnectNotifyVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWCNConnectNotifyImpl, const OFFSET: isize>() -> IWCNConnectNotifyVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IWCNConnectNotify>, ::windows::core::GetTrustLevel, ConnectSucceeded::<Impl, OFFSET>, ConnectFailed::<Impl, OFFSET>)
    }
}
...
impl IWCNDeviceVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWCNDeviceImpl, const OFFSET: isize>() -> IWCNDeviceVtbl {
        ...
        Self(
            ...
            ::windows::core::GetRuntimeClassName::<IWCNDevice>,
            ::windows::core::GetTrustLevel,
            SetPassword::<Impl, OFFSET>,
            Connect::<Impl, OFFSET>,
            GetAttribute::<Impl, OFFSET>,
            GetIntegerAttribute::<Impl, OFFSET>,
            GetStringAttribute::<Impl, OFFSET>,
            GetNetworkProfile::<Impl, OFFSET>,
            SetNetworkProfile::<Impl, OFFSET>,
            GetVendorExtension::<Impl, OFFSET>,
            SetVendorExtension::<Impl, OFFSET>,
            Unadvise::<Impl, OFFSET>,
            SetNFCPasswordParams::<Impl, OFFSET>,
        )
    }
}
