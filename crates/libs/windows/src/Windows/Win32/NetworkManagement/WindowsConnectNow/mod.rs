...
impl IWCNConnectNotify {
    pub unsafe fn ConnectSucceeded(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ConnectSucceeded)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn ConnectFailed(&self, hrfailure: windows_core::HRESULT) -> windows_result::Result<()> {
...
pub trait IWCNConnectNotify_Impl: windows_core::IUnknownImpl {
    fn ConnectSucceeded(&self) -> windows_result::Result<()>;
    fn ConnectFailed(&self, hrfailure: windows_core::HRESULT) -> windows_result::Result<()>;
}
...
impl IWCNDevice {
    pub unsafe fn SetPassword(&self, r#type: WCN_PASSWORD_TYPE, pbpassword: &[u8]) -> windows_result::Result<()> {
    ...
    pub unsafe fn Connect<P0>(&self, pnotify: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetAttribute(&self, attributetype: WCN_ATTRIBUTE_TYPE, pbbuffer: &mut [u8], pdwbufferused: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetIntegerAttribute(&self, attributetype: WCN_ATTRIBUTE_TYPE) -> windows_result::Result<u32> {
        unsafe {
    ...
    pub unsafe fn GetStringAttribute(&self, attributetype: WCN_ATTRIBUTE_TYPE, wszstring: &mut [u16]) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetNetworkProfile(&self, wszprofile: &mut [u16]) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetNetworkProfile<P0>(&self, pszprofilexml: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetVendorExtension(&self, pvendorextspec: *const WCN_VENDOR_EXTENSION_SPEC, pbbuffer: &mut [u8], pdwbufferused: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetVendorExtension(&self, pvendorextspec: *const WCN_VENDOR_EXTENSION_SPEC, pbbuffer: &[u8]) -> windows_result::Result<()> {
    ...
    pub unsafe fn Unadvise(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Unadvise)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn SetNFCPasswordParams(&self, r#type: WCN_PASSWORD_TYPE, dwoobpasswordid: u32, pbpassword: Option<&[u8]>, pbremotepublickeyhash: Option<&[u8]>, pbdhkeyblob: Option<&[u8]>) -> windows_result::Result<()> {
        unsafe {
...
pub trait IWCNDevice_Impl: windows_core::IUnknownImpl {
    fn SetPassword(&self, r#type: WCN_PASSWORD_TYPE, dwpasswordlength: u32, pbpassword: *const u8) -> windows_result::Result<()>;
    fn Connect(&self, pnotify: windows_core::Ref<IWCNConnectNotify>) -> windows_result::Result<()>;
    fn GetAttribute(&self, attributetype: WCN_ATTRIBUTE_TYPE, dwmaxbuffersize: u32, pbbuffer: *mut u8, pdwbufferused: *mut u32) -> windows_result::Result<()>;
    fn GetIntegerAttribute(&self, attributetype: WCN_ATTRIBUTE_TYPE) -> windows_result::Result<u32>;
    fn GetStringAttribute(&self, attributetype: WCN_ATTRIBUTE_TYPE, cchmaxstring: u32, wszstring: windows_core::PWSTR) -> windows_result::Result<()>;
    fn GetNetworkProfile(&self, cchmaxstringlength: u32, wszprofile: windows_core::PWSTR) -> windows_result::Result<()>;
    fn SetNetworkProfile(&self, pszprofilexml: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetVendorExtension(&self, pvendorextspec: *const WCN_VENDOR_EXTENSION_SPEC, dwmaxbuffersize: u32, pbbuffer: *mut u8, pdwbufferused: *mut u32) -> windows_result::Result<()>;
    fn SetVendorExtension(&self, pvendorextspec: *const WCN_VENDOR_EXTENSION_SPEC, cbbuffer: u32, pbbuffer: *const u8) -> windows_result::Result<()>;
    fn Unadvise(&self) -> windows_result::Result<()>;
    fn SetNFCPasswordParams(&self, r#type: WCN_PASSWORD_TYPE, dwoobpasswordid: u32, dwpasswordlength: u32, pbpassword: *const u8, dwremotepublickeyhashlength: u32, pbremotepublickeyhash: *const u8, dwdhkeybloblength: u32, pbdhkeyblob: *const u8) -> windows_result::Result<()>;
}
