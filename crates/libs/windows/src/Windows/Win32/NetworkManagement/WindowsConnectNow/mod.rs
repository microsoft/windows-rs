...
pub const WCN_E_AUTHENTICATION_FAILED: windows_core::HRESULT = 0x80043C02_u32 as _;
pub const WCN_E_CONNECTION_REJECTED: windows_core::HRESULT = 0x80043C03_u32 as _;
pub const WCN_E_PEER_NOT_FOUND: windows_core::HRESULT = 0x80043C01_u32 as _;
pub const WCN_E_PROTOCOL_ERROR: windows_core::HRESULT = 0x80043C05_u32 as _;
pub const WCN_E_SESSION_TIMEDOUT: windows_core::HRESULT = 0x80043C04_u32 as _;
