...
impl IDynamicPortMappingCollection {
    ...
    pub unsafe fn get_Item<P0, P2>(&self, bstrremotehost: P0, lexternalport: i32, bstrprotocol: P2) -> windows_core::Result<IDynamicPortMapping>
    where
        P0: windows_core::Param<windows_core::BSTR>,
    ...
    pub unsafe fn Remove<P0, P2>(&self, bstrremotehost: P0, lexternalport: i32, bstrprotocol: P2) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::BSTR>,
        P2: windows_core::Param<windows_core::BSTR>,
    {
    ...
    pub unsafe fn Add<P0, P2, P4, P5, P6>(&self, bstrremotehost: P0, lexternalport: i32, bstrprotocol: P2, linternalport: i32, bstrinternalclient: P4, benabled: P5, bstrdescription: P6, lleaseduration: i32) -> windows_core::Result<IDynamicPortMapping>
    where
        P0: windows_core::Param<windows_core::BSTR>,
        P2: windows_core::Param<windows_core::BSTR>,
...
impl INetFwMgr {
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn IsPortAllowed<P0, P3>(&self, imagefilename: P0, ipversion: NET_FW_IP_VERSION, portnumber: i32, localaddress: P3, ipprotocol: NET_FW_IP_PROTOCOL, allowed: *mut super::super::System::Variant::VARIANT, restricted: *mut super::super::System::Variant::VARIANT) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::BSTR>,
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn IsIcmpTypeAllowed<P1>(&self, ipversion: NET_FW_IP_VERSION, localaddress: P1, r#type: u8, allowed: *mut super::super::System::Variant::VARIANT, restricted: *mut super::super::System::Variant::VARIANT) -> windows_core::Result<()>
    where
...
pub struct INetFwMgr_Vtbl {
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub IsPortAllowed: unsafe extern "system" fn(*mut core::ffi::c_void, core::mem::MaybeUninit<windows_core::BSTR>, NET_FW_IP_VERSION, i32, core::mem::MaybeUninit<windows_core::BSTR>, NET_FW_IP_PROTOCOL, *mut super::super::System::Variant::VARIANT, *mut super::super::System::Variant::VARIANT) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
    IsPortAllowed: usize,
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub IsIcmpTypeAllowed: unsafe extern "system" fn(*mut core::ffi::c_void, NET_FW_IP_VERSION, core::mem::MaybeUninit<windows_core::BSTR>, u8, *mut super::super::System::Variant::VARIANT, *mut super::super::System::Variant::VARIANT) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant")))]
...
impl INetFwMgr_Vtbl {
    pub const fn new<Identity: INetFwMgr_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn IsPortAllowed<Identity: INetFwMgr_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, imagefilename: core::mem::MaybeUninit<windows_core::BSTR>, ipversion: NET_FW_IP_VERSION, portnumber: i32, localaddress: core::mem::MaybeUninit<windows_core::BSTR>, ipprotocol: NET_FW_IP_PROTOCOL, allowed: *mut super::super::System::Variant::VARIANT, restricted: *mut super::super::System::Variant::VARIANT) -> windows_core::HRESULT {
            let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl INetFwPolicy2 {
    ...
    pub unsafe fn EnableRuleGroup<P1, P2>(&self, profiletypesbitmask: i32, group: P1, enable: P2) -> windows_core::Result<()>
    where
        P1: windows_core::Param<windows_core::BSTR>,
    ...
    pub unsafe fn IsRuleGroupEnabled<P1>(&self, profiletypesbitmask: i32, group: P1) -> windows_core::Result<super::super::Foundation::VARIANT_BOOL>
    where
        P1: windows_core::Param<windows_core::BSTR>,
    {
        let mut result__ = core::mem::zeroed();
...
impl INetSharingConfiguration {
    ...
    pub unsafe fn AddPortMapping<P0, P5>(&self, bstrname: P0, ucipprotocol: u8, usexternalport: u16, usinternalport: u16, dwoptions: u32, bstrtargetnameoripaddress: P5, etargettype: ICS_TARGETTYPE) -> windows_core::Result<INetSharingPortMapping>
    where
        P0: windows_core::Param<windows_core::BSTR>,
...
impl IStaticPortMappingCollection {
    ...
    pub unsafe fn get_Item<P1>(&self, lexternalport: i32, bstrprotocol: P1) -> windows_core::Result<IStaticPortMapping>
    where
        P1: windows_core::Param<windows_core::BSTR>,
    {
        let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Remove<P1>(&self, lexternalport: i32, bstrprotocol: P1) -> windows_core::Result<()>
    where
        P1: windows_core::Param<windows_core::BSTR>,
    {
        (windows_core::Interface::vtable(self).Remove)(windows_core::Interface::as_raw(self), lexternalport, bstrprotocol.param().abi()).ok()
    }
    pub unsafe fn Add<P1, P3, P4, P5>(&self, lexternalport: i32, bstrprotocol: P1, linternalport: i32, bstrinternalclient: P3, benabled: P4, bstrdescription: P5) -> windows_core::Result<IStaticPortMapping>
    where
        P1: windows_core::Param<windows_core::BSTR>,
        P3: windows_core::Param<windows_core::BSTR>,
