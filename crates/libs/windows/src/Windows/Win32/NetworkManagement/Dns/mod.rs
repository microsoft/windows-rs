...
pub unsafe fn DnsAcquireContextHandle_A(credentialflags: u32, credentials: Option<*const core::ffi::c_void>, pcontext: *mut super::super::Foundation::HANDLE) -> i32 {
    ...
    unsafe { DnsAcquireContextHandle_A(credentialflags, core::mem::transmute(credentials.unwrap_or(core::mem::zeroed())), core::mem::transmute(pcontext)) }
}
#[inline]
pub unsafe fn DnsAcquireContextHandle_W(credentialflags: u32, credentials: Option<*const core::ffi::c_void>, pcontext: *mut super::super::Foundation::HANDLE) -> i32 {
    ...
    unsafe { DnsAcquireContextHandle_W(credentialflags, core::mem::transmute(credentials.unwrap_or(core::mem::zeroed())), core::mem::transmute(pcontext)) }
}
#[inline]
...
pub unsafe fn DnsConnectionFreeNameList(pnamelist: *mut DNS_CONNECTION_NAME_LIST) {
    ...
    unsafe { DnsConnectionFreeNameList(core::mem::transmute(pnamelist)) }
}
#[inline]
pub unsafe fn DnsConnectionFreeProxyInfo(pproxyinfo: *mut DNS_CONNECTION_PROXY_INFO) {
    ...
    unsafe { DnsConnectionFreeProxyInfo(core::mem::transmute(pproxyinfo)) }
}
#[inline]
pub unsafe fn DnsConnectionFreeProxyInfoEx(pproxyinfoex: *mut DNS_CONNECTION_PROXY_INFO_EX) {
    ...
    unsafe { DnsConnectionFreeProxyInfoEx(core::mem::transmute(pproxyinfoex)) }
}
#[inline]
pub unsafe fn DnsConnectionFreeProxyList(pproxylist: *mut DNS_CONNECTION_PROXY_LIST) {
    ...
    unsafe { DnsConnectionFreeProxyList(core::mem::transmute(pproxylist)) }
}
#[inline]
pub unsafe fn DnsConnectionGetNameList(pnamelist: *mut DNS_CONNECTION_NAME_LIST) -> u32 {
    ...
    unsafe { DnsConnectionGetNameList(core::mem::transmute(pnamelist)) }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DnsConnectionGetProxyInfo(pwszconnectionname.param().abi(), r#type, core::mem::transmute(pproxyinfo)) }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DnsConnectionGetProxyInfoForHostUrl(pwszhosturl.param().abi(), core::mem::transmute(pselectioncontext.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pselectioncontext.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), dwexplicitinterfaceindex, core::mem::transmute(pproxyinfoex)) }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DnsConnectionGetProxyList(pwszconnectionname.param().abi(), core::mem::transmute(pproxylist)) }
}
#[inline]
...
pub unsafe fn DnsExtractRecordsFromMessage_UTF8(pdnsbuffer: *const DNS_MESSAGE_BUFFER, wmessagelength: u16, pprecord: *mut *mut DNS_RECORDA) -> i32 {
    ...
    unsafe { DnsExtractRecordsFromMessage_UTF8(pdnsbuffer, wmessagelength, core::mem::transmute(pprecord)) }
}
#[inline]
pub unsafe fn DnsExtractRecordsFromMessage_W(pdnsbuffer: *const DNS_MESSAGE_BUFFER, wmessagelength: u16, pprecord: *mut *mut DNS_RECORDA) -> i32 {
    ...
    unsafe { DnsExtractRecordsFromMessage_W(pdnsbuffer, wmessagelength, core::mem::transmute(pprecord)) }
}
#[inline]
pub unsafe fn DnsFree(pdata: Option<*const core::ffi::c_void>, freetype: DNS_FREE_TYPE) {
    ...
    unsafe { DnsFree(core::mem::transmute(pdata.unwrap_or(core::mem::zeroed())), freetype) }
}
#[inline]
pub unsafe fn DnsFreeCustomServers(pcservers: *mut u32, ppservers: *mut *mut DNS_CUSTOM_SERVER) {
    ...
    unsafe { DnsFreeCustomServers(core::mem::transmute(pcservers), core::mem::transmute(ppservers)) }
}
#[inline]
...
pub unsafe fn DnsGetApplicationSettings(pcservers: *mut u32, ppdefaultservers: *mut *mut DNS_CUSTOM_SERVER, psettings: Option<*mut DNS_APPLICATION_SETTINGS>) -> u32 {
    ...
    unsafe { DnsGetApplicationSettings(core::mem::transmute(pcservers), core::mem::transmute(ppdefaultservers), core::mem::transmute(psettings.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
pub unsafe fn DnsGetProxyInformation<P0>(hostname: P0, proxyinformation: *mut DNS_PROXY_INFORMATION, defaultproxyinformation: Option<*mut DNS_PROXY_INFORMATION>, completionroutine: Option<DNS_PROXY_COMPLETION_ROUTINE>, completioncontext: Option<*const core::ffi::c_void>) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DnsGetProxyInformation(hostname.param().abi(), core::mem::transmute(proxyinformation), core::mem::transmute(defaultproxyinformation.unwrap_or(core::mem::zeroed())), core::mem::transmute(completionroutine.unwrap_or(core::mem::zeroed())), core::mem::transmute(completioncontext.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
...
pub unsafe fn DnsModifyRecordsInSet_UTF8(paddrecords: Option<*const DNS_RECORDA>, pdeleterecords: Option<*const DNS_RECORDA>, options: u32, hcredentials: Option<super::super::Foundation::HANDLE>, pextralist: Option<*mut core::ffi::c_void>, preserved: Option<*mut core::ffi::c_void>) -> i32 {
    ...
    unsafe { DnsModifyRecordsInSet_UTF8(core::mem::transmute(paddrecords.unwrap_or(core::mem::zeroed())), core::mem::transmute(pdeleterecords.unwrap_or(core::mem::zeroed())), options, core::mem::transmute(hcredentials.unwrap_or(core::mem::zeroed())), core::mem::transmute(pextralist.unwrap_or(core::mem::zeroed())), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
pub unsafe fn DnsModifyRecordsInSet_W(paddrecords: Option<*const DNS_RECORDA>, pdeleterecords: Option<*const DNS_RECORDA>, options: u32, hcredentials: Option<super::super::Foundation::HANDLE>, pextralist: Option<*mut core::ffi::c_void>, preserved: Option<*mut core::ffi::c_void>) -> i32 {
    ...
    unsafe { DnsModifyRecordsInSet_W(core::mem::transmute(paddrecords.unwrap_or(core::mem::zeroed())), core::mem::transmute(pdeleterecords.unwrap_or(core::mem::zeroed())), options, core::mem::transmute(hcredentials.unwrap_or(core::mem::zeroed())), core::mem::transmute(pextralist.unwrap_or(core::mem::zeroed())), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DnsQueryConfig(config, flag, pwsadaptername.param().abi(), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())), core::mem::transmute(pbuffer.unwrap_or(core::mem::zeroed())), core::mem::transmute(pbuflen)) }
}
#[inline]
pub unsafe fn DnsQueryEx(pqueryrequest: *const DNS_QUERY_REQUEST, pqueryresults: *mut DNS_QUERY_RESULT, pcancelhandle: Option<*mut DNS_QUERY_CANCEL>) -> i32 {
    ...
    unsafe { DnsQueryEx(pqueryrequest, core::mem::transmute(pqueryresults), core::mem::transmute(pcancelhandle.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
pub unsafe fn DnsQueryRaw(queryrequest: *const DNS_QUERY_RAW_REQUEST, cancelhandle: *mut DNS_QUERY_RAW_CANCEL) -> i32 {
    ...
    unsafe { DnsQueryRaw(queryrequest, core::mem::transmute(cancelhandle)) }
}
#[inline]
pub unsafe fn DnsQueryRawResultFree(queryresults: Option<*const DNS_QUERY_RAW_RESULT>) {
    ...
    unsafe { DnsQueryRawResultFree(core::mem::transmute(queryresults.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { DnsQuery_A(pszname.param().abi(), wtype, options, core::mem::transmute(pextra.unwrap_or(core::mem::zeroed())), core::mem::transmute(ppqueryresults), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { DnsQuery_UTF8(pszname.param().abi(), wtype, options, core::mem::transmute(pextra.unwrap_or(core::mem::zeroed())), core::mem::transmute(ppqueryresults), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DnsQuery_W(pszname.param().abi(), wtype, options, core::mem::transmute(pextra.unwrap_or(core::mem::zeroed())), core::mem::transmute(ppqueryresults), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
...
pub unsafe fn DnsRecordSetCompare(prr1: *mut DNS_RECORDA, prr2: *mut DNS_RECORDA, ppdiff1: Option<*mut *mut DNS_RECORDA>, ppdiff2: Option<*mut *mut DNS_RECORDA>) -> super::super::Foundation::BOOL {
    ...
    unsafe { DnsRecordSetCompare(core::mem::transmute(prr1), core::mem::transmute(prr2), core::mem::transmute(ppdiff1.unwrap_or(core::mem::zeroed())), core::mem::transmute(ppdiff2.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
...
pub unsafe fn DnsRecordSetDetach(precordlist: *mut DNS_RECORDA) -> *mut DNS_RECORDA {
    ...
    unsafe { DnsRecordSetDetach(core::mem::transmute(precordlist)) }
}
#[inline]
...
pub unsafe fn DnsReplaceRecordSetA(preplaceset: *const DNS_RECORDA, options: u32, hcontext: Option<super::super::Foundation::HANDLE>, pextrainfo: Option<*mut core::ffi::c_void>, preserved: Option<*mut core::ffi::c_void>) -> i32 {
    ...
    unsafe { DnsReplaceRecordSetA(preplaceset, options, core::mem::transmute(hcontext.unwrap_or(core::mem::zeroed())), core::mem::transmute(pextrainfo.unwrap_or(core::mem::zeroed())), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
pub unsafe fn DnsReplaceRecordSetUTF8(preplaceset: *const DNS_RECORDA, options: u32, hcontext: Option<super::super::Foundation::HANDLE>, pextrainfo: Option<*mut core::ffi::c_void>, preserved: Option<*mut core::ffi::c_void>) -> i32 {
    ...
    unsafe { DnsReplaceRecordSetUTF8(preplaceset, options, core::mem::transmute(hcontext.unwrap_or(core::mem::zeroed())), core::mem::transmute(pextrainfo.unwrap_or(core::mem::zeroed())), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
pub unsafe fn DnsReplaceRecordSetW(preplaceset: *const DNS_RECORDA, options: u32, hcontext: Option<super::super::Foundation::HANDLE>, pextrainfo: Option<*mut core::ffi::c_void>, preserved: Option<*mut core::ffi::c_void>) -> i32 {
    ...
    unsafe { DnsReplaceRecordSetW(preplaceset, options, core::mem::transmute(hcontext.unwrap_or(core::mem::zeroed())), core::mem::transmute(pextrainfo.unwrap_or(core::mem::zeroed())), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
pub unsafe fn DnsServiceBrowse(prequest: *const DNS_SERVICE_BROWSE_REQUEST, pcancel: *mut DNS_SERVICE_CANCEL) -> i32 {
    ...
    unsafe { DnsServiceBrowse(prequest, core::mem::transmute(pcancel)) }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DnsServiceConstructInstance(pservicename.param().abi(), phostname.param().abi(), core::mem::transmute(pip4.unwrap_or(core::mem::zeroed())), core::mem::transmute(pip6.unwrap_or(core::mem::zeroed())), wport, wpriority, wweight, dwpropertiescount, keys, values) }
}
#[inline]
...
pub unsafe fn DnsServiceDeRegister(prequest: *const DNS_SERVICE_REGISTER_REQUEST, pcancel: Option<*mut DNS_SERVICE_CANCEL>) -> u32 {
    ...
    unsafe { DnsServiceDeRegister(prequest, core::mem::transmute(pcancel.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
...
pub unsafe fn DnsServiceRegister(prequest: *const DNS_SERVICE_REGISTER_REQUEST, pcancel: Option<*mut DNS_SERVICE_CANCEL>) -> u32 {
    ...
    unsafe { DnsServiceRegister(prequest, core::mem::transmute(pcancel.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
...
pub unsafe fn DnsServiceResolve(prequest: *const DNS_SERVICE_RESOLVE_REQUEST, pcancel: *mut DNS_SERVICE_CANCEL) -> i32 {
    ...
    unsafe { DnsServiceResolve(prequest, core::mem::transmute(pcancel)) }
}
#[inline]
...
pub unsafe fn DnsSetApplicationSettings(pservers: &[DNS_CUSTOM_SERVER], psettings: Option<*const DNS_APPLICATION_SETTINGS>) -> u32 {
    ...
    unsafe { DnsSetApplicationSettings(pservers.len().try_into().unwrap(), core::mem::transmute(pservers.as_ptr()), core::mem::transmute(psettings.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
pub unsafe fn DnsStartMulticastQuery(pqueryrequest: *const MDNS_QUERY_REQUEST, phandle: *mut MDNS_QUERY_HANDLE) -> i32 {
    ...
    unsafe { DnsStartMulticastQuery(pqueryrequest, core::mem::transmute(phandle)) }
}
#[inline]
pub unsafe fn DnsStopMulticastQuery(phandle: *mut MDNS_QUERY_HANDLE) -> i32 {
    ...
    unsafe { DnsStopMulticastQuery(core::mem::transmute(phandle)) }
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { DnsWriteQuestionToBuffer_UTF8(core::mem::transmute(pdnsbuffer), core::mem::transmute(pdwbuffersize), pszname.param().abi(), wtype, xid, frecursiondesired.into()) }
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DnsWriteQuestionToBuffer_W(core::mem::transmute(pdnsbuffer), core::mem::transmute(pdwbuffersize), pszname.param().abi(), wtype, xid, frecursiondesired.into()) }
}
