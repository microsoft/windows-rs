...
pub unsafe fn DnsCancelQuery(pcancelhandle: *const DNS_QUERY_CANCEL) -> i32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsCancelQuery(pcancelhandle : *const DNS_QUERY_CANCEL) -> i32);
    unsafe { DnsCancelQuery(pcancelhandle) }
}
#[inline]
pub unsafe fn DnsCancelQueryRaw(cancelhandle: *const DNS_QUERY_RAW_CANCEL) -> i32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsCancelQueryRaw(cancelhandle : *const DNS_QUERY_RAW_CANCEL) -> i32);
...
pub unsafe fn DnsConnectionDeletePolicyEntries(policyentrytag: DNS_CONNECTION_POLICY_TAG) -> u32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsConnectionDeletePolicyEntries(policyentrytag : DNS_CONNECTION_POLICY_TAG) -> u32);
    unsafe { DnsConnectionDeletePolicyEntries(policyentrytag) }
}
#[inline]
pub unsafe fn DnsConnectionDeleteProxyInfo(pwszconnectionname: windows_core::PCWSTR, r#type: DNS_CONNECTION_PROXY_TYPE) -> u32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsConnectionDeleteProxyInfo(pwszconnectionname : windows_core::PCWSTR, r#type : DNS_CONNECTION_PROXY_TYPE) -> u32);
    unsafe { DnsConnectionDeleteProxyInfo(core::mem::transmute(pwszconnectionname), r#type) }
}
#[inline]
pub unsafe fn DnsConnectionFreeNameList(pnamelist: *mut DNS_CONNECTION_NAME_LIST) {
    windows_core::link!("dnsapi.dll" "system" fn DnsConnectionFreeNameList(pnamelist : *mut DNS_CONNECTION_NAME_LIST));
...
pub unsafe fn DnsConnectionFreeProxyInfo(pproxyinfo: *mut DNS_CONNECTION_PROXY_INFO) {
    windows_core::link!("dnsapi.dll" "system" fn DnsConnectionFreeProxyInfo(pproxyinfo : *mut DNS_CONNECTION_PROXY_INFO));
...
pub unsafe fn DnsConnectionFreeProxyInfoEx(pproxyinfoex: *mut DNS_CONNECTION_PROXY_INFO_EX) {
    windows_core::link!("dnsapi.dll" "system" fn DnsConnectionFreeProxyInfoEx(pproxyinfoex : *mut DNS_CONNECTION_PROXY_INFO_EX));
...
pub unsafe fn DnsConnectionFreeProxyList(pproxylist: *mut DNS_CONNECTION_PROXY_LIST) {
    windows_core::link!("dnsapi.dll" "system" fn DnsConnectionFreeProxyList(pproxylist : *mut DNS_CONNECTION_PROXY_LIST));
...
pub unsafe fn DnsConnectionGetNameList(pnamelist: *mut DNS_CONNECTION_NAME_LIST) -> u32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsConnectionGetNameList(pnamelist : *mut DNS_CONNECTION_NAME_LIST) -> u32);
    unsafe { DnsConnectionGetNameList(pnamelist as _) }
}
#[inline]
pub unsafe fn DnsConnectionGetProxyInfo(pwszconnectionname: windows_core::PCWSTR, r#type: DNS_CONNECTION_PROXY_TYPE, pproxyinfo: *mut DNS_CONNECTION_PROXY_INFO) -> u32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsConnectionGetProxyInfo(pwszconnectionname : windows_core::PCWSTR, r#type : DNS_CONNECTION_PROXY_TYPE, pproxyinfo : *mut DNS_CONNECTION_PROXY_INFO) -> u32);
    unsafe { DnsConnectionGetProxyInfo(core::mem::transmute(pwszconnectionname), r#type, pproxyinfo as _) }
}
#[inline]
pub unsafe fn DnsConnectionGetProxyInfoForHostUrl(pwszhosturl: windows_core::PCWSTR, pselectioncontext: Option<&[u8]>, dwexplicitinterfaceindex: u32, pproxyinfoex: *mut DNS_CONNECTION_PROXY_INFO_EX) -> u32 {
    ...
    unsafe { DnsConnectionGetProxyInfoForHostUrl(core::mem::transmute(pwszhosturl), core::mem::transmute(pselectioncontext.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pselectioncontext.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), dwexplicitinterfaceindex, pproxyinfoex as _) }
}
#[inline]
pub unsafe fn DnsConnectionGetProxyInfoForHostUrlEx(pwszhosturl: windows_core::PCWSTR, pselectioncontext: Option<&[u8]>, dwexplicitinterfaceindex: u32, pwszconnectionname: Option<windows_core::PCWSTR>, pproxyinfoex: *mut DNS_CONNECTION_PROXY_INFO_EX) -> u32 {
    ...
    unsafe { DnsConnectionGetProxyInfoForHostUrlEx(core::mem::transmute(pwszhosturl), core::mem::transmute(pselectioncontext.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pselectioncontext.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), dwexplicitinterfaceindex, pwszconnectionname.unwrap_or(core::mem::zeroed()) as _, pproxyinfoex as _) }
}
#[inline]
pub unsafe fn DnsConnectionGetProxyList(pwszconnectionname: windows_core::PCWSTR, pproxylist: *mut DNS_CONNECTION_PROXY_LIST) -> u32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsConnectionGetProxyList(pwszconnectionname : windows_core::PCWSTR, pproxylist : *mut DNS_CONNECTION_PROXY_LIST) -> u32);
    unsafe { DnsConnectionGetProxyList(core::mem::transmute(pwszconnectionname), pproxylist as _) }
}
#[inline]
...
#[inline]
pub unsafe fn DnsConnectionSetProxyInfo(pwszconnectionname: windows_core::PCWSTR, r#type: DNS_CONNECTION_PROXY_TYPE, pproxyinfo: *const DNS_CONNECTION_PROXY_INFO) -> u32 {
    ...
    unsafe { DnsConnectionSetProxyInfo(core::mem::transmute(pwszconnectionname), r#type, pproxyinfo) }
}
#[inline]
pub unsafe fn DnsConnectionUpdateIfIndexTable(pconnectionifindexentries: *const DNS_CONNECTION_IFINDEX_LIST) -> u32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsConnectionUpdateIfIndexTable(pconnectionifindexentries : *const DNS_CONNECTION_IFINDEX_LIST) -> u32);
...
pub unsafe fn DnsFree(pdata: Option<*const core::ffi::c_void>, freetype: DNS_FREE_TYPE) {
    ...
    unsafe { DnsFree(pdata.unwrap_or(core::mem::zeroed()) as _, freetype) }
}
#[inline]
pub unsafe fn DnsFreeCustomServers(pcservers: *mut u32, ppservers: *mut *mut DNS_CUSTOM_SERVER) {
    windows_core::link!("dnsapi.dll" "system" fn DnsFreeCustomServers(pcservers : *mut u32, ppservers : *mut *mut DNS_CUSTOM_SERVER));
    unsafe { DnsFreeCustomServers(pcservers as _, ppservers as _) }
}
#[inline]
pub unsafe fn DnsFreeProxyName(proxyname: Option<windows_core::PCWSTR>) {
    windows_core::link!("dnsapi.dll" "system" fn DnsFreeProxyName(proxyname : windows_core::PCWSTR));
    unsafe { DnsFreeProxyName(proxyname.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn DnsGetApplicationSettings(pcservers: *mut u32, ppdefaultservers: *mut *mut DNS_CUSTOM_SERVER, psettings: Option<*mut DNS_APPLICATION_SETTINGS>) -> u32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsGetApplicationSettings(pcservers : *mut u32, ppdefaultservers : *mut *mut DNS_CUSTOM_SERVER, psettings : *mut DNS_APPLICATION_SETTINGS) -> u32);
    unsafe { DnsGetApplicationSettings(pcservers as _, ppdefaultservers as _, psettings.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn DnsGetProxyInformation(hostname: windows_core::PCWSTR, proxyinformation: *mut DNS_PROXY_INFORMATION, defaultproxyinformation: Option<*mut DNS_PROXY_INFORMATION>, completionroutine: DNS_PROXY_COMPLETION_ROUTINE, completioncontext: Option<*const core::ffi::c_void>) -> u32 {
    ...
    unsafe { DnsGetProxyInformation(core::mem::transmute(hostname), proxyinformation as _, defaultproxyinformation.unwrap_or(core::mem::zeroed()) as _, completionroutine, completioncontext.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn DnsIsFlatRecord(precord: *const DNS_RECORDA, ullflags: u64, pfflat: *mut windows_core::BOOL) -> i32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsIsFlatRecord(precord : *const DNS_RECORDA, ullflags : u64, pfflat : *mut windows_core::BOOL) -> i32);
...
#[inline]
pub unsafe fn DnsNameCompare_A(pname1: windows_core::PCSTR, pname2: windows_core::PCSTR) -> windows_core::BOOL {
    ...
    unsafe { DnsNameCompare_A(core::mem::transmute(pname1), core::mem::transmute(pname2)) }
}
#[inline]
pub unsafe fn DnsNameCompare_W(pname1: windows_core::PCWSTR, pname2: windows_core::PCWSTR) -> windows_core::BOOL {
    ...
    unsafe { DnsNameCompare_W(core::mem::transmute(pname1), core::mem::transmute(pname2)) }
}
#[inline]
pub unsafe fn DnsQueryConfig(config: DNS_CONFIG_TYPE, flag: u32, pwsadaptername: Option<windows_core::PCWSTR>, preserved: Option<*const core::ffi::c_void>, pbuffer: Option<*mut core::ffi::c_void>, pbuflen: *mut u32) -> i32 {
    ...
    unsafe { DnsQueryConfig(config, flag, pwsadaptername.unwrap_or(core::mem::zeroed()) as _, preserved.unwrap_or(core::mem::zeroed()) as _, pbuffer.unwrap_or(core::mem::zeroed()) as _, pbuflen as _) }
}
#[inline]
pub unsafe fn DnsQueryEx(pqueryrequest: *const DNS_QUERY_REQUEST, pqueryresults: *mut DNS_QUERY_RESULT, pcancelhandle: Option<*mut DNS_QUERY_CANCEL>) -> i32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsQueryEx(pqueryrequest : *const DNS_QUERY_REQUEST, pqueryresults : *mut DNS_QUERY_RESULT, pcancelhandle : *mut DNS_QUERY_CANCEL) -> i32);
...
pub unsafe fn DnsQueryRawResultFree(queryresults: Option<*const DNS_QUERY_RAW_RESULT>) {
    ...
    unsafe { DnsQueryRawResultFree(queryresults.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn DnsQuery_A(pszname: windows_core::PCSTR, wtype: u16, options: DNS_QUERY_OPTIONS, pextra: Option<*mut core::ffi::c_void>, ppqueryresults: *mut *mut DNS_RECORDA, preserved: Option<*mut *mut core::ffi::c_void>) -> windows_core::WIN32_ERROR {
    ...
    unsafe { DnsQuery_A(core::mem::transmute(pszname), wtype, options, pextra.unwrap_or(core::mem::zeroed()) as _, ppqueryresults as _, preserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn DnsQuery_UTF8(pszname: windows_core::PCSTR, wtype: u16, options: DNS_QUERY_OPTIONS, pextra: Option<*mut core::ffi::c_void>, ppqueryresults: *mut *mut DNS_RECORDA, preserved: Option<*mut *mut core::ffi::c_void>) -> windows_core::WIN32_ERROR {
    ...
    unsafe { DnsQuery_UTF8(core::mem::transmute(pszname), wtype, options, pextra.unwrap_or(core::mem::zeroed()) as _, ppqueryresults as _, preserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn DnsQuery_W(pszname: windows_core::PCWSTR, wtype: u16, options: DNS_QUERY_OPTIONS, pextra: Option<*mut core::ffi::c_void>, ppqueryresults: *mut *mut DNS_RECORDA, preserved: Option<*mut *mut core::ffi::c_void>) -> windows_core::WIN32_ERROR {
    ...
    unsafe { DnsQuery_W(core::mem::transmute(pszname), wtype, options, pextra.unwrap_or(core::mem::zeroed()) as _, ppqueryresults as _, preserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
pub unsafe fn DnsRecordSetCompare(prr1: *mut DNS_RECORDA, prr2: *mut DNS_RECORDA, ppdiff1: Option<*mut *mut DNS_RECORDA>, ppdiff2: Option<*mut *mut DNS_RECORDA>) -> windows_core::BOOL {
    windows_core::link!("dnsapi.dll" "system" fn DnsRecordSetCompare(prr1 : *mut DNS_RECORDA, prr2 : *mut DNS_RECORDA, ppdiff1 : *mut *mut DNS_RECORDA, ppdiff2 : *mut *mut DNS_RECORDA) -> windows_core::BOOL);
...
pub unsafe fn DnsRecordSetCopyEx(precordset: *const DNS_RECORDA, charsetin: DNS_CHARSET, charsetout: DNS_CHARSET) -> *mut DNS_RECORDA {
    windows_core::link!("dnsapi.dll" "system" fn DnsRecordSetCopyEx(precordset : *const DNS_RECORDA, charsetin : DNS_CHARSET, charsetout : DNS_CHARSET) -> *mut DNS_RECORDA);
...
pub unsafe fn DnsRecordSetDetach(precordlist: *mut DNS_RECORDA) -> *mut DNS_RECORDA {
    windows_core::link!("dnsapi.dll" "system" fn DnsRecordSetDetach(precordlist : *mut DNS_RECORDA) -> *mut DNS_RECORDA);
...
pub unsafe fn DnsServiceBrowse(prequest: *const DNS_SERVICE_BROWSE_REQUEST, pcancel: *mut DNS_SERVICE_CANCEL) -> i32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsServiceBrowse(prequest : *const DNS_SERVICE_BROWSE_REQUEST, pcancel : *mut DNS_SERVICE_CANCEL) -> i32);
...
pub unsafe fn DnsServiceBrowseCancel(pcancelhandle: *const DNS_SERVICE_CANCEL) -> i32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsServiceBrowseCancel(pcancelhandle : *const DNS_SERVICE_CANCEL) -> i32);
    unsafe { DnsServiceBrowseCancel(pcancelhandle) }
}
#[inline]
pub unsafe fn DnsServiceConstructInstance(pservicename: windows_core::PCWSTR, phostname: windows_core::PCWSTR, pip4: Option<*const u32>, pip6: Option<*const IP6_ADDRESS>, wport: u16, wpriority: u16, wweight: u16, dwpropertiescount: u32, keys: *const windows_core::PCWSTR, values: *const windows_core::PCWSTR) -> *mut DNS_SERVICE_INSTANCE {
    windows_core::link!("dnsapi.dll" "system" fn DnsServiceConstructInstance(pservicename : windows_core::PCWSTR, phostname : windows_core::PCWSTR, pip4 : *const u32, pip6 : *const IP6_ADDRESS, wport : u16, wpriority : u16, wweight : u16, dwpropertiescount : u32, keys : *const windows_core::PCWSTR, values : *const windows_core::PCWSTR) -> *mut DNS_SERVICE_INSTANCE);
    unsafe { DnsServiceConstructInstance(core::mem::transmute(pservicename), core::mem::transmute(phostname), pip4.unwrap_or(core::mem::zeroed()) as _, pip6.unwrap_or(core::mem::zeroed()) as _, wport, wpriority, wweight, dwpropertiescount, keys, values) }
}
#[inline]
...
pub unsafe fn DnsSetApplicationSettings(pservers: &[DNS_CUSTOM_SERVER], psettings: Option<*const DNS_APPLICATION_SETTINGS>) -> u32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsSetApplicationSettings(cservers : u32, pservers : *const DNS_CUSTOM_SERVER, psettings : *const DNS_APPLICATION_SETTINGS) -> u32);
...
pub unsafe fn DnsStartMulticastQuery(pqueryrequest: *const MDNS_QUERY_REQUEST, phandle: *mut MDNS_QUERY_HANDLE) -> i32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsStartMulticastQuery(pqueryrequest : *const MDNS_QUERY_REQUEST, phandle : *mut MDNS_QUERY_HANDLE) -> i32);
...
pub unsafe fn DnsStopMulticastQuery(phandle: *mut MDNS_QUERY_HANDLE) -> i32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsStopMulticastQuery(phandle : *mut MDNS_QUERY_HANDLE) -> i32);
    unsafe { DnsStopMulticastQuery(phandle as _) }
}
#[inline]
pub unsafe fn DnsValidateName_A(pszname: windows_core::PCSTR, format: DNS_NAME_FORMAT) -> i32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsValidateName_A(pszname : windows_core::PCSTR, format : DNS_NAME_FORMAT) -> i32);
    unsafe { DnsValidateName_A(core::mem::transmute(pszname), format) }
}
#[inline]
pub unsafe fn DnsValidateName_UTF8(pszname: windows_core::PCSTR, format: DNS_NAME_FORMAT) -> i32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsValidateName_UTF8(pszname : windows_core::PCSTR, format : DNS_NAME_FORMAT) -> i32);
    unsafe { DnsValidateName_UTF8(core::mem::transmute(pszname), format) }
}
#[inline]
pub unsafe fn DnsValidateName_W(pszname: windows_core::PCWSTR, format: DNS_NAME_FORMAT) -> i32 {
    windows_core::link!("dnsapi.dll" "system" fn DnsValidateName_W(pszname : windows_core::PCWSTR, format : DNS_NAME_FORMAT) -> i32);
    unsafe { DnsValidateName_W(core::mem::transmute(pszname), format) }
}
#[inline]
pub unsafe fn DnsWriteQuestionToBuffer_UTF8(pdnsbuffer: *mut DNS_MESSAGE_BUFFER, pdwbuffersize: *mut u32, pszname: windows_core::PCSTR, wtype: u16, xid: u16, frecursiondesired: bool) -> windows_core::BOOL {
    ...
    unsafe { DnsWriteQuestionToBuffer_UTF8(pdnsbuffer as _, pdwbuffersize as _, core::mem::transmute(pszname), wtype, xid, frecursiondesired.into()) }
}
#[inline]
pub unsafe fn DnsWriteQuestionToBuffer_W(pdnsbuffer: *mut DNS_MESSAGE_BUFFER, pdwbuffersize: *mut u32, pszname: windows_core::PCWSTR, wtype: u16, xid: u16, frecursiondesired: bool) -> windows_core::BOOL {
    ...
    unsafe { DnsWriteQuestionToBuffer_W(pdnsbuffer as _, pdwbuffersize as _, core::mem::transmute(pszname), wtype, xid, frecursiondesired.into()) }
}
