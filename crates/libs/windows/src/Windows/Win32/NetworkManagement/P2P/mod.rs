...
#[inline]
pub unsafe fn DrtCreateDnsBootstrapResolver(port: u16, pwszaddress: windows_core::PCWSTR) -> windows_core::Result<*mut DRT_BOOTSTRAP_PROVIDER> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        DrtCreateDnsBootstrapResolver(port, core::mem::transmute(pwszaddress), &mut result__).map(|| result__)
    }
}
#[inline]
...
#[inline]
pub unsafe fn DrtCreatePnrpBootstrapResolver(fpublish: bool, pwzpeername: windows_core::PCWSTR, pwzcloudname: Option<windows_core::PCWSTR>, pwzpublishingidentity: Option<windows_core::PCWSTR>) -> windows_core::Result<*mut DRT_BOOTSTRAP_PROVIDER> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        DrtCreatePnrpBootstrapResolver(fpublish.into(), core::mem::transmute(pwzpeername), pwzcloudname.unwrap_or(core::mem::zeroed()) as _, pwzpublishingidentity.unwrap_or(core::mem::zeroed()) as _, &mut result__).map(|| result__)
    }
}
#[inline]
...
#[inline]
pub unsafe fn PeerCollabAddContact(pwzcontactdata: windows_core::PCWSTR, ppcontact: Option<*mut *mut PEER_CONTACT>) -> windows_core::Result<()> {
    ...
    unsafe { PeerCollabAddContact(core::mem::transmute(pwzcontactdata), ppcontact.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
...
#[inline]
pub unsafe fn PeerCollabDeleteContact(pwzpeername: windows_core::PCWSTR) -> windows_core::Result<()> {
    windows_core::link!("p2p.dll" "system" fn PeerCollabDeleteContact(pwzpeername : windows_core::PCWSTR) -> windows_core::HRESULT);
    unsafe { PeerCollabDeleteContact(core::mem::transmute(pwzpeername)).ok() }
}
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
...
#[inline]
pub unsafe fn PeerCollabExportContact(pwzpeername: Option<windows_core::PCWSTR>) -> windows_core::Result<windows_core::PWSTR> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerCollabExportContact(pwzpeername.unwrap_or(core::mem::zeroed()) as _, &mut result__).map(|| result__)
    }
}
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
...
#[inline]
pub unsafe fn PeerCollabGetContact(pwzpeername: Option<windows_core::PCWSTR>) -> windows_core::Result<*mut PEER_CONTACT> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerCollabGetContact(pwzpeername.unwrap_or(core::mem::zeroed()) as _, &mut result__).map(|| result__)
    }
}
#[inline]
...
#[inline]
pub unsafe fn PeerCollabParseContact(pwzcontactdata: windows_core::PCWSTR) -> windows_core::Result<*mut PEER_CONTACT> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerCollabParseContact(core::mem::transmute(pwzcontactdata), &mut result__).map(|| result__)
    }
}
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
...
#[inline]
pub unsafe fn PeerCollabSetEndpointName(pwzendpointname: windows_core::PCWSTR) -> windows_core::Result<()> {
    windows_core::link!("p2p.dll" "system" fn PeerCollabSetEndpointName(pwzendpointname : windows_core::PCWSTR) -> windows_core::HRESULT);
    unsafe { PeerCollabSetEndpointName(core::mem::transmute(pwzendpointname)).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn PeerCreatePeerName(pwzidentity: Option<windows_core::PCWSTR>, pwzclassifier: Option<windows_core::PCWSTR>) -> windows_core::Result<windows_core::PWSTR> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerCreatePeerName(pwzidentity.unwrap_or(core::mem::zeroed()) as _, pwzclassifier.unwrap_or(core::mem::zeroed()) as _, &mut result__).map(|| result__)
    }
}
...
#[inline]
pub unsafe fn PeerEnumGroups(pwzidentity: windows_core::PCWSTR, phpeerenum: *mut *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { PeerEnumGroups(core::mem::transmute(pwzidentity), phpeerenum as _).ok() }
}
#[inline]
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerGraphConnect(hgraph: *const core::ffi::c_void, pwzpeerid: Option<windows_core::PCWSTR>, paddress: *const PEER_ADDRESS) -> windows_core::Result<u64> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerGraphConnect(hgraph, pwzpeerid.unwrap_or(core::mem::zeroed()) as _, paddress, &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn PeerGraphCreate(pgraphproperties: *const PEER_GRAPH_PROPERTIES, pwzdatabasename: windows_core::PCWSTR, psecurityinterface: Option<*const PEER_SECURITY_INTERFACE>, phgraph: *mut *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { PeerGraphCreate(pgraphproperties, core::mem::transmute(pwzdatabasename), psecurityinterface.unwrap_or(core::mem::zeroed()) as _, phgraph as _).ok() }
}
#[inline]
pub unsafe fn PeerGraphDelete(pwzgraphid: windows_core::PCWSTR, pwzpeerid: windows_core::PCWSTR, pwzdatabasename: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { PeerGraphDelete(core::mem::transmute(pwzgraphid), core::mem::transmute(pwzpeerid), core::mem::transmute(pwzdatabasename)).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn PeerGraphEnumNodes(hgraph: *const core::ffi::c_void, pwzpeerid: Option<windows_core::PCWSTR>, phpeerenum: *mut *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { PeerGraphEnumNodes(hgraph, pwzpeerid.unwrap_or(core::mem::zeroed()) as _, phpeerenum as _).ok() }
}
#[inline]
pub unsafe fn PeerGraphEnumRecords(hgraph: *const core::ffi::c_void, precordtype: Option<*const windows_core::GUID>, pwzpeerid: Option<windows_core::PCWSTR>, phpeerenum: *mut *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { PeerGraphEnumRecords(hgraph, precordtype.unwrap_or(core::mem::zeroed()) as _, pwzpeerid.unwrap_or(core::mem::zeroed()) as _, phpeerenum as _).ok() }
}
#[inline]
pub unsafe fn PeerGraphExportDatabase(hgraph: *const core::ffi::c_void, pwzfilepath: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { PeerGraphExportDatabase(hgraph, core::mem::transmute(pwzfilepath)).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn PeerGraphImportDatabase(hgraph: *const core::ffi::c_void, pwzfilepath: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { PeerGraphImportDatabase(hgraph, core::mem::transmute(pwzfilepath)).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn PeerGraphOpen(pwzgraphid: windows_core::PCWSTR, pwzpeerid: windows_core::PCWSTR, pwzdatabasename: windows_core::PCWSTR, psecurityinterface: Option<*const PEER_SECURITY_INTERFACE>, precordtypesyncprecedence: Option<&[windows_core::GUID]>, phgraph: *mut *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { PeerGraphOpen(core::mem::transmute(pwzgraphid), core::mem::transmute(pwzpeerid), core::mem::transmute(pwzdatabasename), psecurityinterface.unwrap_or(core::mem::zeroed()) as _, precordtypesyncprecedence.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), core::mem::transmute(precordtypesyncprecedence.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), phgraph as _).ok() }
}
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerGraphOpenDirectConnection(hgraph: *const core::ffi::c_void, pwzpeerid: windows_core::PCWSTR, paddress: *const PEER_ADDRESS) -> windows_core::Result<u64> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerGraphOpenDirectConnection(hgraph, core::mem::transmute(pwzpeerid), paddress, &mut result__).map(|| result__)
    }
}
#[inline]
...
#[inline]
pub unsafe fn PeerGraphSearchRecords(hgraph: *const core::ffi::c_void, pwzcriteria: windows_core::PCWSTR, phpeerenum: *mut *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { PeerGraphSearchRecords(hgraph, core::mem::transmute(pwzcriteria), phpeerenum as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn PeerGraphSetNodeAttributes(hgraph: *const core::ffi::c_void, pwzattributes: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { PeerGraphSetNodeAttributes(hgraph, core::mem::transmute(pwzattributes)).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn PeerGroupCreateInvitation(hgroup: *const core::ffi::c_void, pwzidentityinfo: windows_core::PCWSTR, pftexpiration: Option<*const super::super::Foundation::FILETIME>, proles: Option<&[windows_core::GUID]>) -> windows_core::Result<windows_core::PWSTR> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerGroupCreateInvitation(hgroup, core::mem::transmute(pwzidentityinfo), pftexpiration.unwrap_or(core::mem::zeroed()) as _, proles.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), core::mem::transmute(proles.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), &mut result__).map(|| result__)
    }
}
#[inline]
...
#[inline]
pub unsafe fn PeerGroupDelete(pwzidentity: windows_core::PCWSTR, pwzgrouppeername: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { PeerGroupDelete(core::mem::transmute(pwzidentity), core::mem::transmute(pwzgrouppeername)).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn PeerGroupEnumMembers(hgroup: *const core::ffi::c_void, dwflags: u32, pwzidentity: Option<windows_core::PCWSTR>, phpeerenum: *mut *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { PeerGroupEnumMembers(hgroup, dwflags, pwzidentity.unwrap_or(core::mem::zeroed()) as _, phpeerenum as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn PeerGroupExportConfig(hgroup: *const core::ffi::c_void, pwzpassword: windows_core::PCWSTR) -> windows_core::Result<windows_core::PWSTR> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerGroupExportConfig(hgroup, core::mem::transmute(pwzpassword), &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn PeerGroupExportDatabase(hgroup: *const core::ffi::c_void, pwzfilepath: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { PeerGroupExportDatabase(hgroup, core::mem::transmute(pwzfilepath)).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn PeerGroupImportConfig(pwzxml: windows_core::PCWSTR, pwzpassword: windows_core::PCWSTR, foverwrite: bool, ppwzidentity: *mut windows_core::PWSTR, ppwzgroup: *mut windows_core::PWSTR) -> windows_core::Result<()> {
    ...
    unsafe { PeerGroupImportConfig(core::mem::transmute(pwzxml), core::mem::transmute(pwzpassword), foverwrite.into(), ppwzidentity as _, ppwzgroup as _).ok() }
}
#[inline]
pub unsafe fn PeerGroupImportDatabase(hgroup: *const core::ffi::c_void, pwzfilepath: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { PeerGroupImportDatabase(hgroup, core::mem::transmute(pwzfilepath)).ok() }
}
#[cfg(feature = "Win32_Security_Cryptography")]
#[inline]
pub unsafe fn PeerGroupIssueCredentials(hgroup: *const core::ffi::c_void, pwzsubjectidentity: windows_core::PCWSTR, pcredentialinfo: Option<*const PEER_CREDENTIAL_INFO>, dwflags: u32, ppwzinvitation: Option<*mut windows_core::PWSTR>) -> windows_core::Result<()> {
    ...
    unsafe { PeerGroupIssueCredentials(hgroup, core::mem::transmute(pwzsubjectidentity), pcredentialinfo.unwrap_or(core::mem::zeroed()) as _, dwflags, ppwzinvitation.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn PeerGroupJoin(pwzidentity: windows_core::PCWSTR, pwzinvitation: windows_core::PCWSTR, pwzcloud: Option<windows_core::PCWSTR>, phgroup: *mut *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { PeerGroupJoin(core::mem::transmute(pwzidentity), core::mem::transmute(pwzinvitation), pwzcloud.unwrap_or(core::mem::zeroed()) as _, phgroup as _).ok() }
}
#[inline]
pub unsafe fn PeerGroupOpen(pwzidentity: windows_core::PCWSTR, pwzgrouppeername: windows_core::PCWSTR, pwzcloud: Option<windows_core::PCWSTR>, phgroup: *mut *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { PeerGroupOpen(core::mem::transmute(pwzidentity), core::mem::transmute(pwzgrouppeername), pwzcloud.unwrap_or(core::mem::zeroed()) as _, phgroup as _).ok() }
}
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerGroupOpenDirectConnection(hgroup: *const core::ffi::c_void, pwzidentity: windows_core::PCWSTR, paddress: *const PEER_ADDRESS) -> windows_core::Result<u64> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerGroupOpenDirectConnection(hgroup, core::mem::transmute(pwzidentity), paddress, &mut result__).map(|| result__)
    }
}
#[cfg(feature = "Win32_Security_Cryptography")]
#[inline]
pub unsafe fn PeerGroupParseInvitation(pwzinvitation: windows_core::PCWSTR) -> windows_core::Result<*mut PEER_INVITATION_INFO> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerGroupParseInvitation(core::mem::transmute(pwzinvitation), &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn PeerGroupPasswordJoin(pwzidentity: windows_core::PCWSTR, pwzinvitation: windows_core::PCWSTR, pwzpassword: windows_core::PCWSTR, pwzcloud: Option<windows_core::PCWSTR>, phgroup: *mut *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { PeerGroupPasswordJoin(core::mem::transmute(pwzidentity), core::mem::transmute(pwzinvitation), core::mem::transmute(pwzpassword), pwzcloud.unwrap_or(core::mem::zeroed()) as _, phgroup as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn PeerGroupSearchRecords(hgroup: *const core::ffi::c_void, pwzcriteria: windows_core::PCWSTR, phpeerenum: *mut *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { PeerGroupSearchRecords(hgroup, core::mem::transmute(pwzcriteria), phpeerenum as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn PeerHostNameToPeerName(pwzhostname: windows_core::PCWSTR) -> windows_core::Result<windows_core::PWSTR> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerHostNameToPeerName(core::mem::transmute(pwzhostname), &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn PeerIdentityCreate(pwzclassifier: Option<windows_core::PCWSTR>, pwzfriendlyname: Option<windows_core::PCWSTR>, hcryptprov: Option<usize>) -> windows_core::Result<windows_core::PWSTR> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerIdentityCreate(pwzclassifier.unwrap_or(core::mem::zeroed()) as _, pwzfriendlyname.unwrap_or(core::mem::zeroed()) as _, hcryptprov.unwrap_or(core::mem::zeroed()) as _, &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn PeerIdentityDelete(pwzidentity: windows_core::PCWSTR) -> windows_core::Result<()> {
    windows_core::link!("p2p.dll" "system" fn PeerIdentityDelete(pwzidentity : windows_core::PCWSTR) -> windows_core::HRESULT);
    unsafe { PeerIdentityDelete(core::mem::transmute(pwzidentity)).ok() }
}
#[inline]
pub unsafe fn PeerIdentityExport(pwzidentity: Option<windows_core::PCWSTR>, pwzpassword: windows_core::PCWSTR) -> windows_core::Result<windows_core::PWSTR> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerIdentityExport(pwzidentity.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pwzpassword), &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn PeerIdentityGetCryptKey(pwzidentity: Option<windows_core::PCWSTR>) -> windows_core::Result<usize> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerIdentityGetCryptKey(pwzidentity.unwrap_or(core::mem::zeroed()) as _, &mut result__).map(|| result__)
    }
}
#[inline]
...
#[inline]
pub unsafe fn PeerIdentityGetFriendlyName(pwzidentity: Option<windows_core::PCWSTR>) -> windows_core::Result<windows_core::PWSTR> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerIdentityGetFriendlyName(pwzidentity.unwrap_or(core::mem::zeroed()) as _, &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn PeerIdentityGetXML(pwzidentity: Option<windows_core::PCWSTR>) -> windows_core::Result<windows_core::PWSTR> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerIdentityGetXML(pwzidentity.unwrap_or(core::mem::zeroed()) as _, &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn PeerIdentityImport(pwzimportxml: windows_core::PCWSTR, pwzpassword: windows_core::PCWSTR) -> windows_core::Result<windows_core::PWSTR> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerIdentityImport(core::mem::transmute(pwzimportxml), core::mem::transmute(pwzpassword), &mut result__).map(|| result__)
    }
}
#[inline]
pub unsafe fn PeerIdentitySetFriendlyName(pwzidentity: Option<windows_core::PCWSTR>, pwzfriendlyname: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { PeerIdentitySetFriendlyName(pwzidentity.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(pwzfriendlyname)).ok() }
}
#[inline]
pub unsafe fn PeerNameToPeerHostName(pwzpeername: windows_core::PCWSTR) -> windows_core::Result<windows_core::PWSTR> {
    ...
    unsafe {
        let mut result__ = core::mem::zeroed();
        PeerNameToPeerHostName(core::mem::transmute(pwzpeername), &mut result__).map(|| result__)
    }
}
#[inline]
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerPnrpRegister(pcwzpeername: windows_core::PCWSTR, pregistrationinfo: Option<*const PEER_PNRP_REGISTRATION_INFO>, phregistration: *mut *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { PeerPnrpRegister(core::mem::transmute(pcwzpeername), pregistrationinfo.unwrap_or(core::mem::zeroed()) as _, phregistration as _).ok() }
}
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerPnrpResolve(pcwzpeername: windows_core::PCWSTR, pcwzcloudname: Option<windows_core::PCWSTR>, pcendpoints: *mut u32, ppendpoints: *mut *mut PEER_PNRP_ENDPOINT_INFO) -> windows_core::Result<()> {
    ...
    unsafe { PeerPnrpResolve(core::mem::transmute(pcwzpeername), pcwzcloudname.unwrap_or(core::mem::zeroed()) as _, pcendpoints as _, ppendpoints as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn PeerPnrpStartResolve(pcwzpeername: windows_core::PCWSTR, pcwzcloudname: Option<windows_core::PCWSTR>, cmaxendpoints: Option<u32>, hevent: super::super::Foundation::HANDLE, phresolve: *mut *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { PeerPnrpStartResolve(core::mem::transmute(pcwzpeername), pcwzcloudname.unwrap_or(core::mem::zeroed()) as _, cmaxendpoints.unwrap_or(core::mem::zeroed()) as _, hevent, phresolve as _).ok() }
}
#[inline]
