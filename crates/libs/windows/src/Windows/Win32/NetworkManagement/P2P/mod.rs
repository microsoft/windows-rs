...
#[inline]
pub unsafe fn DrtContinueSearch(hsearchcontext: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DrtCreateDerivedKey(plocalcert: *const super::super::Security::Cryptography::CERT_CONTEXT) -> Result<DRT_DATA, windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Security_Cryptography")]
#[inline]
pub unsafe fn DrtCreateDerivedKeySecurityProvider(prootcert: *const super::super::Security::Cryptography::CERT_CONTEXT, plocalcert: Option<*const super::super::Security::Cryptography::CERT_CONTEXT>) -> Result<*mut DRT_SECURITY_PROVIDER, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DrtCreateDnsBootstrapResolver<P1>(port: u16, pwszaddress: P1) -> Result<*mut DRT_BOOTSTRAP_PROVIDER, windows_result::HRESULT>
where
...
#[inline]
pub unsafe fn DrtCreateIpv6UdpTransport(scope: DRT_SCOPE, dwscopeid: u32, dwlocalitythreshold: u32, pwport: *mut u16, phtransport: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DrtCreateNullSecurityProvider() -> Result<*mut DRT_SECURITY_PROVIDER, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DrtCreatePnrpBootstrapResolver<P1, P2, P3>(fpublish: bool, pwzpeername: P1, pwzcloudname: P2, pwzpublishingidentity: P3) -> Result<*mut DRT_BOOTSTRAP_PROVIDER, windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn DrtDeleteIpv6UdpTransport(htransport: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DrtEndSearch(hsearchcontext: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DrtGetEventData(hdrt: *const core::ffi::c_void, uleventdatalen: u32, peventdata: *mut DRT_EVENT_DATA) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DrtGetEventDataSize(hdrt: *const core::ffi::c_void) -> Result<u32, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DrtGetInstanceName(hdrt: *const core::ffi::c_void, ulcbinstancenamesize: u32, pwzdrtinstancename: windows_core::PWSTR) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DrtGetInstanceNameSize(hdrt: *const core::ffi::c_void) -> Result<u32, windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn DrtGetSearchPath(hsearchcontext: *const core::ffi::c_void, ulsearchpathsize: u32, psearchpath: *mut DRT_ADDRESS_LIST) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DrtGetSearchPathSize(hsearchcontext: *const core::ffi::c_void) -> Result<u32, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DrtGetSearchResult(hsearchcontext: *const core::ffi::c_void, ulsearchresultsize: u32, psearchresult: *mut DRT_SEARCH_RESULT) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DrtGetSearchResultSize(hsearchcontext: *const core::ffi::c_void) -> Result<u32, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DrtOpen(psettings: *const DRT_SETTINGS, hevent: Option<super::super::Foundation::HANDLE>, pvcontext: Option<*const core::ffi::c_void>, phdrt: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DrtRegisterKey(hdrt: *const core::ffi::c_void, pregistration: *const DRT_REGISTRATION, pvkeycontext: Option<*const core::ffi::c_void>, phkeyregistration: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DrtStartSearch(hdrt: *const core::ffi::c_void, pkey: *const DRT_DATA, pinfo: Option<*const DRT_SEARCH_INFO>, timeout: u32, hevent: super::super::Foundation::HANDLE, pvcontext: Option<*const core::ffi::c_void>, hsearchcontext: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DrtUpdateKey(hkeyregistration: *const core::ffi::c_void, pappdata: *const DRT_DATA) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabAddContact<P0>(pwzcontactdata: P0, ppcontact: Option<*mut *mut PEER_CONTACT>) -> Result<(), windows_result::HRESULT>
where
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabAsyncInviteContact(pccontact: Option<*const PEER_CONTACT>, pcendpoint: *const PEER_ENDPOINT, pcinvitation: *const PEER_INVITATION, hevent: Option<super::super::Foundation::HANDLE>, phinvitation: Option<*mut super::super::Foundation::HANDLE>) -> Result<(), windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabAsyncInviteEndpoint(pcendpoint: *const PEER_ENDPOINT, pcinvitation: *const PEER_INVITATION, hevent: Option<super::super::Foundation::HANDLE>, phinvitation: Option<*mut super::super::Foundation::HANDLE>) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabCancelInvitation(hinvitation: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabCloseHandle(hinvitation: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabDeleteContact<P0>(pwzpeername: P0) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabDeleteEndpointData(pcendpoint: *const PEER_ENDPOINT) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabDeleteObject(pobjectid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabEnumApplicationRegistrationInfo(registrationtype: PEER_APPLICATION_REGISTRATION_TYPE, phpeerenum: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabEnumApplications(pcendpoint: Option<*const PEER_ENDPOINT>, papplicationid: Option<*const windows_core::GUID>, phpeerenum: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabEnumContacts(phpeerenum: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabEnumEndpoints(pccontact: Option<*const PEER_CONTACT>, phpeerenum: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabEnumObjects(pcendpoint: Option<*const PEER_ENDPOINT>, pobjectid: Option<*const windows_core::GUID>, phpeerenum: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabEnumPeopleNearMe(phpeerenum: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabExportContact<P0>(pwzpeername: P0) -> Result<windows_core::PWSTR, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabGetAppLaunchInfo() -> Result<*mut PEER_APP_LAUNCH_INFO, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabGetApplicationRegistrationInfo(papplicationid: *const windows_core::GUID, registrationtype: PEER_APPLICATION_REGISTRATION_TYPE) -> Result<*mut PEER_APPLICATION_REGISTRATION_INFO, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabGetContact<P0>(pwzpeername: P0) -> Result<*mut PEER_CONTACT, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerCollabGetEndpointName() -> Result<windows_core::PWSTR, windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabGetEventData(hpeerevent: *const core::ffi::c_void) -> Result<*mut PEER_COLLAB_EVENT_DATA, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabGetInvitationResponse(hinvitation: super::super::Foundation::HANDLE) -> Result<*mut PEER_INVITATION_RESPONSE, windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabGetPresenceInfo(pcendpoint: Option<*const PEER_ENDPOINT>) -> Result<*mut PEER_PRESENCE_INFO, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabGetSigninOptions() -> Result<u32, windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabInviteContact(pccontact: Option<*const PEER_CONTACT>, pcendpoint: *const PEER_ENDPOINT, pcinvitation: *const PEER_INVITATION) -> Result<*mut PEER_INVITATION_RESPONSE, windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabInviteEndpoint(pcendpoint: *const PEER_ENDPOINT, pcinvitation: *const PEER_INVITATION) -> Result<*mut PEER_INVITATION_RESPONSE, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabParseContact<P0>(pwzcontactdata: P0) -> Result<*mut PEER_CONTACT, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabQueryContactData(pcendpoint: Option<*const PEER_ENDPOINT>) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabRefreshEndpointData(pcendpoint: *const PEER_ENDPOINT) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabRegisterApplication(pcapplication: *const PEER_APPLICATION_REGISTRATION_INFO, registrationtype: PEER_APPLICATION_REGISTRATION_TYPE) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabRegisterEvent(hevent: super::super::Foundation::HANDLE, peventregistrations: &[PEER_COLLAB_EVENT_REGISTRATION], phpeerevent: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabSetEndpointName<P0>(pwzendpointname: P0) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerCollabSetObject(pcobject: *const PEER_OBJECT) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabSetPresenceInfo(pcpresenceinfo: *const PEER_PRESENCE_INFO) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabShutdown() -> Result<(), windows_result::HRESULT> {
    windows_link::link!("p2p.dll" "system" fn PeerCollabShutdown() -> windows_core::HRESULT);
    unsafe { PeerCollabShutdown().ok() }
}
#[inline]
pub unsafe fn PeerCollabSignin(hwndparent: Option<super::super::Foundation::HWND>, dwsigninoptions: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabSignout(dwsigninoptions: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabStartup(wversionrequested: u16) -> Result<(), windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabSubscribeEndpointData(pcendpoint: *const PEER_ENDPOINT) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabUnregisterApplication(papplicationid: *const windows_core::GUID, registrationtype: PEER_APPLICATION_REGISTRATION_TYPE) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabUnregisterEvent(hpeerevent: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabUnsubscribeEndpointData(pcendpoint: *const PEER_ENDPOINT) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCollabUpdateContact(pcontact: *const PEER_CONTACT) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerCreatePeerName<P0, P1>(pwzidentity: P0, pwzclassifier: P1) -> Result<windows_core::PWSTR, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerEndEnumeration(hpeerenum: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerEnumGroups<P0>(pwzidentity: P0, phpeerenum: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerEnumIdentities(phpeerenum: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGetItemCount(hpeerenum: *const core::ffi::c_void) -> Result<u32, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGetNextItem(hpeerenum: *const core::ffi::c_void, pcount: *mut u32, pppvitems: *mut *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphAddRecord(hgraph: *const core::ffi::c_void, precord: *const PEER_RECORD) -> Result<windows_core::GUID, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphClose(hgraph: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphCloseDirectConnection(hgraph: *const core::ffi::c_void, ullconnectionid: u64) -> Result<(), windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerGraphConnect<P1>(hgraph: *const core::ffi::c_void, pwzpeerid: P1, paddress: *const PEER_ADDRESS) -> Result<u64, windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGraphCreate<P1>(pgraphproperties: *const PEER_GRAPH_PROPERTIES, pwzdatabasename: P1, psecurityinterface: Option<*const PEER_SECURITY_INTERFACE>, phgraph: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGraphDelete<P0, P1, P2>(pwzgraphid: P0, pwzpeerid: P1, pwzdatabasename: P2) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn PeerGraphDeleteRecord(hgraph: *const core::ffi::c_void, precordid: *const windows_core::GUID, flocal: bool) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphEndEnumeration(hpeerenum: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphEnumConnections(hgraph: *const core::ffi::c_void, dwflags: u32, phpeerenum: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphEnumNodes<P1>(hgraph: *const core::ffi::c_void, pwzpeerid: P1, phpeerenum: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGraphEnumRecords<P2>(hgraph: *const core::ffi::c_void, precordtype: Option<*const windows_core::GUID>, pwzpeerid: P2, phpeerenum: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGraphExportDatabase<P1>(hgraph: *const core::ffi::c_void, pwzfilepath: P1) -> Result<(), windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGraphGetEventData(hpeerevent: *const core::ffi::c_void) -> Result<*mut PEER_GRAPH_EVENT_DATA, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphGetItemCount(hpeerenum: *const core::ffi::c_void) -> Result<u32, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphGetNextItem(hpeerenum: *const core::ffi::c_void, pcount: *mut u32, pppvitems: *mut *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerGraphGetNodeInfo(hgraph: *const core::ffi::c_void, ullnodeid: u64) -> Result<*mut PEER_NODE_INFO, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphGetProperties(hgraph: *const core::ffi::c_void) -> Result<*mut PEER_GRAPH_PROPERTIES, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphGetRecord(hgraph: *const core::ffi::c_void, precordid: *const windows_core::GUID) -> Result<*mut PEER_RECORD, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphGetStatus(hgraph: *const core::ffi::c_void) -> Result<u32, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphImportDatabase<P1>(hgraph: *const core::ffi::c_void, pwzfilepath: P1) -> Result<(), windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGraphListen(hgraph: *const core::ffi::c_void, dwscope: Option<u32>, dwscopeid: Option<u32>, wport: Option<u16>) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphOpen<P0, P1, P2>(pwzgraphid: P0, pwzpeerid: P1, pwzdatabasename: P2, psecurityinterface: Option<*const PEER_SECURITY_INTERFACE>, precordtypesyncprecedence: Option<&[windows_core::GUID]>, phgraph: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerGraphOpenDirectConnection<P1>(hgraph: *const core::ffi::c_void, pwzpeerid: P1, paddress: *const PEER_ADDRESS) -> Result<u64, windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGraphPeerTimeToUniversalTime(hgraph: *const core::ffi::c_void, pftpeertime: *const super::super::Foundation::FILETIME) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphRegisterEvent(hgraph: *const core::ffi::c_void, hevent: super::super::Foundation::HANDLE, peventregistrations: &[PEER_GRAPH_EVENT_REGISTRATION], phpeerevent: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphSearchRecords<P1>(hgraph: *const core::ffi::c_void, pwzcriteria: P1, phpeerenum: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGraphSendData(hgraph: *const core::ffi::c_void, ullconnectionid: u64, ptype: *const windows_core::GUID, cbdata: u32, pvdata: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphSetNodeAttributes<P1>(hgraph: *const core::ffi::c_void, pwzattributes: P1) -> Result<(), windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGraphSetPresence(hgraph: *const core::ffi::c_void, fpresent: bool) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphSetProperties(hgraph: *const core::ffi::c_void, pgraphproperties: *const PEER_GRAPH_PROPERTIES) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphShutdown() -> Result<(), windows_result::HRESULT> {
    windows_link::link!("p2pgraph.dll" "system" fn PeerGraphShutdown() -> windows_core::HRESULT);
    unsafe { PeerGraphShutdown().ok() }
}
#[inline]
pub unsafe fn PeerGraphStartup(wversionrequested: u16) -> Result<PEER_VERSION_DATA, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphUniversalTimeToPeerTime(hgraph: *const core::ffi::c_void, pftuniversaltime: *const super::super::Foundation::FILETIME) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphUnregisterEvent(hpeerevent: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphUpdateRecord(hgraph: *const core::ffi::c_void, precord: *const PEER_RECORD) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGraphValidateDeferredRecords(hgraph: *const core::ffi::c_void, precordids: &[windows_core::GUID]) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupAddRecord(hgroup: *const core::ffi::c_void, precord: *const PEER_RECORD) -> Result<windows_core::GUID, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupClose(hgroup: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupCloseDirectConnection(hgroup: *const core::ffi::c_void, ullconnectionid: u64) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupConnect(hgroup: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerGroupConnectByAddress(hgroup: *const core::ffi::c_void, paddresses: &[PEER_ADDRESS]) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupCreate(pproperties: *const PEER_GROUP_PROPERTIES, phgroup: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupCreateInvitation<P1>(hgroup: *const core::ffi::c_void, pwzidentityinfo: P1, pftexpiration: Option<*const super::super::Foundation::FILETIME>, proles: Option<&[windows_core::GUID]>) -> Result<windows_core::PWSTR, windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGroupCreatePasswordInvitation(hgroup: *const core::ffi::c_void) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupDelete<P0, P1>(pwzidentity: P0, pwzgrouppeername: P1) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGroupDeleteRecord(hgroup: *const core::ffi::c_void, precordid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupEnumConnections(hgroup: *const core::ffi::c_void, dwflags: u32, phpeerenum: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupEnumMembers<P2>(hgroup: *const core::ffi::c_void, dwflags: u32, pwzidentity: P2, phpeerenum: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGroupEnumRecords(hgroup: *const core::ffi::c_void, precordtype: Option<*const windows_core::GUID>, phpeerenum: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupExportConfig<P1>(hgroup: *const core::ffi::c_void, pwzpassword: P1) -> Result<windows_core::PWSTR, windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGroupExportDatabase<P1>(hgroup: *const core::ffi::c_void, pwzfilepath: P1) -> Result<(), windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGroupGetEventData(hpeerevent: *const core::ffi::c_void) -> Result<*mut PEER_GROUP_EVENT_DATA, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupGetProperties(hgroup: *const core::ffi::c_void) -> Result<*mut PEER_GROUP_PROPERTIES, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupGetRecord(hgroup: *const core::ffi::c_void, precordid: *const windows_core::GUID) -> Result<*mut PEER_RECORD, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupGetStatus(hgroup: *const core::ffi::c_void) -> Result<u32, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupImportConfig<P0, P1>(pwzxml: P0, pwzpassword: P1, foverwrite: bool, ppwzidentity: *mut windows_core::PWSTR, ppwzgroup: *mut windows_core::PWSTR) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGroupImportDatabase<P1>(hgroup: *const core::ffi::c_void, pwzfilepath: P1) -> Result<(), windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[cfg(feature = "Win32_Security_Cryptography")]
#[inline]
pub unsafe fn PeerGroupIssueCredentials<P1>(hgroup: *const core::ffi::c_void, pwzsubjectidentity: P1, pcredentialinfo: Option<*const PEER_CREDENTIAL_INFO>, dwflags: u32, ppwzinvitation: Option<*mut windows_core::PWSTR>) -> Result<(), windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGroupJoin<P0, P1, P2>(pwzidentity: P0, pwzinvitation: P1, pwzcloud: P2, phgroup: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn PeerGroupOpen<P0, P1, P2>(pwzidentity: P0, pwzgrouppeername: P1, pwzcloud: P2, phgroup: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerGroupOpenDirectConnection<P1>(hgroup: *const core::ffi::c_void, pwzidentity: P1, paddress: *const PEER_ADDRESS) -> Result<u64, windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[cfg(feature = "Win32_Security_Cryptography")]
#[inline]
pub unsafe fn PeerGroupParseInvitation<P0>(pwzinvitation: P0) -> Result<*mut PEER_INVITATION_INFO, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGroupPasswordJoin<P0, P1, P2, P3>(pwzidentity: P0, pwzinvitation: P1, pwzpassword: P2, pwzcloud: P3, phgroup: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
...
#[inline]
pub unsafe fn PeerGroupPeerTimeToUniversalTime(hgroup: *const core::ffi::c_void, pftpeertime: *const super::super::Foundation::FILETIME) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupRegisterEvent(hgroup: *const core::ffi::c_void, hevent: super::super::Foundation::HANDLE, peventregistrations: &[PEER_GROUP_EVENT_REGISTRATION], phpeerevent: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupResumePasswordAuthentication(hgroup: *const core::ffi::c_void, hpeereventhandle: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupSearchRecords<P1>(hgroup: *const core::ffi::c_void, pwzcriteria: P1, phpeerenum: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGroupSendData(hgroup: *const core::ffi::c_void, ullconnectionid: u64, ptype: *const windows_core::GUID, cbdata: u32, pvdata: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupSetProperties(hgroup: *const core::ffi::c_void, pproperties: *const PEER_GROUP_PROPERTIES) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupShutdown() -> Result<(), windows_result::HRESULT> {
    windows_link::link!("p2p.dll" "system" fn PeerGroupShutdown() -> windows_core::HRESULT);
    unsafe { PeerGroupShutdown().ok() }
}
#[inline]
pub unsafe fn PeerGroupStartup(wversionrequested: u16) -> Result<PEER_VERSION_DATA, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupUniversalTimeToPeerTime(hgroup: *const core::ffi::c_void, pftuniversaltime: *const super::super::Foundation::FILETIME) -> Result<super::super::Foundation::FILETIME, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupUnregisterEvent(hpeerevent: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerGroupUpdateRecord(hgroup: *const core::ffi::c_void, precord: *const PEER_RECORD) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerHostNameToPeerName<P0>(pwzhostname: P0) -> Result<windows_core::PWSTR, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerIdentityCreate<P0, P1>(pwzclassifier: P0, pwzfriendlyname: P1, hcryptprov: Option<usize>) -> Result<windows_core::PWSTR, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerIdentityDelete<P0>(pwzidentity: P0) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerIdentityExport<P0, P1>(pwzidentity: P0, pwzpassword: P1) -> Result<windows_core::PWSTR, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerIdentityGetCryptKey<P0>(pwzidentity: P0) -> Result<usize, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerIdentityGetDefault() -> Result<windows_core::PWSTR, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerIdentityGetFriendlyName<P0>(pwzidentity: P0) -> Result<windows_core::PWSTR, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerIdentityGetXML<P0>(pwzidentity: P0) -> Result<windows_core::PWSTR, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerIdentityImport<P0, P1>(pwzimportxml: P0, pwzpassword: P1) -> Result<windows_core::PWSTR, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerIdentitySetFriendlyName<P0, P1>(pwzidentity: P0, pwzfriendlyname: P1) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerNameToPeerHostName<P0>(pwzpeername: P0) -> Result<windows_core::PWSTR, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerPnrpEndResolve(hresolve: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerPnrpGetCloudInfo(pcnumclouds: *mut u32, ppcloudinfo: *mut *mut PEER_PNRP_CLOUD_INFO) -> Result<(), windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerPnrpGetEndpoint(hresolve: *const core::ffi::c_void) -> Result<*mut PEER_PNRP_ENDPOINT_INFO, windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerPnrpRegister<P0>(pcwzpeername: P0, pregistrationinfo: Option<*const PEER_PNRP_REGISTRATION_INFO>, phregistration: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerPnrpResolve<P0, P1>(pcwzpeername: P0, pcwzcloudname: P1, pcendpoints: *mut u32, ppendpoints: *mut *mut PEER_PNRP_ENDPOINT_INFO) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerPnrpShutdown() -> Result<(), windows_result::HRESULT> {
    windows_link::link!("p2p.dll" "system" fn PeerPnrpShutdown() -> windows_core::HRESULT);
    unsafe { PeerPnrpShutdown().ok() }
}
#[inline]
pub unsafe fn PeerPnrpStartResolve<P0, P1>(pcwzpeername: P0, pcwzcloudname: P1, cmaxendpoints: Option<u32>, hevent: super::super::Foundation::HANDLE, phresolve: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerPnrpStartup(wversionrequested: u16) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn PeerPnrpUnregister(hregistration: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerPnrpUpdateRegistration(hregistration: *const core::ffi::c_void, pregistrationinfo: *const PEER_PNRP_REGISTRATION_INFO) -> Result<(), windows_result::HRESULT> {
