...
#[cfg(feature = "Win32_Security_Cryptography")]
#[inline]
pub unsafe fn DrtCreateDerivedKeySecurityProvider(prootcert: *const super::super::Security::Cryptography::CERT_CONTEXT, plocalcert: ::core::option::Option<*const super::super::Security::Cryptography::CERT_CONTEXT>) -> ::windows_core::Result<*mut DRT_SECURITY_PROVIDER> {
    ...
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    DrtCreateDnsBootstrapResolver(port, pwszaddress.into_param().abi(), &mut result__).map(|| result__)
}
#[inline]
    ...
    P3: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    DrtCreatePnrpBootstrapResolver(fpublish.into_param().abi(), pwzpeername.into_param().abi(), pwzcloudname.into_param().abi(), pwzpublishingidentity.into_param().abi(), &mut result__).map(|| result__)
}
#[inline]
...
#[inline]
pub unsafe fn DrtOpen<P0>(psettings: *const DRT_SETTINGS, hevent: P0, pvcontext: ::core::option::Option<*const ::core::ffi::c_void>, phdrt: *mut *mut ::core::ffi::c_void) -> ::windows_core::Result<()>
where
...
#[inline]
pub unsafe fn DrtRegisterKey(hdrt: *const ::core::ffi::c_void, pregistration: *const DRT_REGISTRATION, pvkeycontext: ::core::option::Option<*const ::core::ffi::c_void>, phkeyregistration: *mut *mut ::core::ffi::c_void) -> ::windows_core::Result<()> {
...
#[inline]
pub unsafe fn DrtStartSearch<P0>(hdrt: *const ::core::ffi::c_void, pkey: *const DRT_DATA, pinfo: ::core::option::Option<*const DRT_SEARCH_INFO>, timeout: u32, hevent: P0, pvcontext: ::core::option::Option<*const ::core::ffi::c_void>, hsearchcontext: *mut *mut ::core::ffi::c_void) -> ::windows_core::Result<()>
where
    P0: ::windows_core::IntoParam<super::super::Foundation::HANDLE>,
{
...
#[inline]
pub unsafe fn PeerCollabAddContact<P0>(pwzcontactdata: P0, ppcontact: ::core::option::Option<*mut *mut PEER_CONTACT>) -> ::windows_core::Result<()>
where
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabAsyncInviteContact<P0>(pccontact: ::core::option::Option<*const PEER_CONTACT>, pcendpoint: *const PEER_ENDPOINT, pcinvitation: *const PEER_INVITATION, hevent: P0, phinvitation: ::core::option::Option<*mut super::super::Foundation::HANDLE>) -> ::windows_core::Result<()>
where
    P0: ::windows_core::IntoParam<super::super::Foundation::HANDLE>,
{
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabAsyncInviteEndpoint<P0>(pcendpoint: *const PEER_ENDPOINT, pcinvitation: *const PEER_INVITATION, hevent: P0, phinvitation: ::core::option::Option<*mut super::super::Foundation::HANDLE>) -> ::windows_core::Result<()>
where
    P0: ::windows_core::IntoParam<super::super::Foundation::HANDLE>,
{
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabEnumApplications(pcendpoint: ::core::option::Option<*const PEER_ENDPOINT>, papplicationid: ::core::option::Option<*const ::windows_core::GUID>, phpeerenum: *mut *mut ::core::ffi::c_void) -> ::windows_core::Result<()> {
...
#[inline]
pub unsafe fn PeerCollabEnumEndpoints(pccontact: ::core::option::Option<*const PEER_CONTACT>, phpeerenum: *mut *mut ::core::ffi::c_void) -> ::windows_core::Result<()> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabEnumObjects(pcendpoint: ::core::option::Option<*const PEER_ENDPOINT>, pobjectid: ::core::option::Option<*const ::windows_core::GUID>, phpeerenum: *mut *mut ::core::ffi::c_void) -> ::windows_core::Result<()> {
    ...
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerCollabExportContact(pwzpeername.into_param().abi(), &mut result__).map(|| result__)
}
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
    ...
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerCollabGetContact(pwzpeername.into_param().abi(), &mut result__).map(|| result__)
}
#[inline]
    ...
    P0: ::windows_core::IntoParam<super::super::Foundation::HANDLE>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerCollabGetInvitationResponse(hinvitation.into_param().abi(), &mut result__).map(|| result__)
}
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabGetPresenceInfo(pcendpoint: ::core::option::Option<*const PEER_ENDPOINT>) -> ::windows_core::Result<*mut PEER_PRESENCE_INFO> {
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabInviteContact(pccontact: ::core::option::Option<*const PEER_CONTACT>, pcendpoint: *const PEER_ENDPOINT, pcinvitation: *const PEER_INVITATION) -> ::windows_core::Result<*mut PEER_INVITATION_RESPONSE> {
    ...
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerCollabParseContact(pwzcontactdata.into_param().abi(), &mut result__).map(|| result__)
}
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerCollabQueryContactData(pcendpoint: ::core::option::Option<*const PEER_ENDPOINT>) -> ::windows_core::Result<::windows_core::PWSTR> {
    ...
    P0: ::windows_core::IntoParam<super::super::Foundation::HANDLE>,
{
    ...
    PeerCollabRegisterEvent(hevent.into_param().abi(), peventregistrations.len().try_into().unwrap(), ::core::mem::transmute(peventregistrations.as_ptr()), phpeerevent).ok()
}
#[inline]
    ...
    P1: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerCreatePeerName(pwzidentity.into_param().abi(), pwzclassifier.into_param().abi(), &mut result__).map(|| result__)
}
    ...
    P0: ::windows_core::IntoParam<super::super::Foundation::HANDLE>,
{
    ...
    PeerDistServerOpenContentInformation(hpeerdist, pcontentidentifier.len().try_into().unwrap(), ::core::mem::transmute(pcontentidentifier.as_ptr()), ullcontentoffset, cbcontentlength, hcompletionport.into_param().abi(), ulcompletionkey, phcontentinfo)
}
#[inline]
    ...
    P0: ::windows_core::IntoParam<super::super::Foundation::HANDLE>,
{
    ...
    PeerDistServerOpenContentInformationEx(hpeerdist, pcontentidentifier.len().try_into().unwrap(), ::core::mem::transmute(pcontentidentifier.as_ptr()), ullcontentoffset, cbcontentlength, pretrievaloptions, hcompletionport.into_param().abi(), ulcompletionkey, phcontentinfo)
}
#[cfg(feature = "Win32_System_IO")]
#[inline]
    ...
    P0: ::windows_core::IntoParam<super::super::Foundation::HANDLE>,
{
    ...
    PeerDistServerPublishStream(hpeerdist, pcontentidentifier.len().try_into().unwrap(), ::core::mem::transmute(pcontentidentifier.as_ptr()), cbcontentlength, ::core::mem::transmute(ppublishoptions.unwrap_or(::std::ptr::null())), hcompletionport.into_param().abi(), ulcompletionkey, phstream)
}
#[cfg(feature = "Win32_System_IO")]
#[inline]
    ...
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerGraphConnect(hgraph, pwzpeerid.into_param().abi(), paddress, &mut result__).map(|| result__)
}
#[inline]
pub unsafe fn PeerGraphCreate<P0>(pgraphproperties: *const PEER_GRAPH_PROPERTIES, pwzdatabasename: P0, psecurityinterface: ::core::option::Option<*const PEER_SECURITY_INTERFACE>, phgraph: *mut *mut ::core::ffi::c_void) -> ::windows_core::Result<()>
where
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGraphEnumRecords<P0>(hgraph: *const ::core::ffi::c_void, precordtype: ::core::option::Option<*const ::windows_core::GUID>, pwzpeerid: P0, phpeerenum: *mut *mut ::core::ffi::c_void) -> ::windows_core::Result<()>
where
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn PeerGraphOpen<P0, P1, P2>(pwzgraphid: P0, pwzpeerid: P1, pwzdatabasename: P2, psecurityinterface: ::core::option::Option<*const PEER_SECURITY_INTERFACE>, precordtypesyncprecedence: ::core::option::Option<&[::windows_core::GUID]>, phgraph: *mut *mut ::core::ffi::c_void) -> ::windows_core::Result<()>
where
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
    P1: ::windows_core::IntoParam<::windows_core::PCWSTR>,
    P2: ::windows_core::IntoParam<::windows_core::PCWSTR>,
    ...
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerGraphOpenDirectConnection(hgraph, pwzpeerid.into_param().abi(), paddress, &mut result__).map(|| result__)
}
#[inline]
    ...
    P0: ::windows_core::IntoParam<super::super::Foundation::HANDLE>,
{
    ...
    PeerGraphRegisterEvent(hgraph, hevent.into_param().abi(), peventregistrations.len().try_into().unwrap(), ::core::mem::transmute(peventregistrations.as_ptr()), phpeerevent).ok()
}
#[inline]
...
#[inline]
pub unsafe fn PeerGroupCreateInvitation<P0>(hgroup: *const ::core::ffi::c_void, pwzidentityinfo: P0, pftexpiration: ::core::option::Option<*const super::super::Foundation::FILETIME>, proles: ::core::option::Option<&[::windows_core::GUID]>) -> ::windows_core::Result<::windows_core::PWSTR>
where
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerGroupCreateInvitation(hgroup, pwzidentityinfo.into_param().abi(), ::core::mem::transmute(pftexpiration.unwrap_or(::std::ptr::null())), proles.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), ::core::mem::transmute(proles.as_deref().map_or(::core::ptr::null(), |slice| slice.as_ptr())), &mut result__).map(|| result__)
}
#[inline]
...
#[inline]
pub unsafe fn PeerGroupEnumRecords(hgroup: *const ::core::ffi::c_void, precordtype: ::core::option::Option<*const ::windows_core::GUID>, phpeerenum: *mut *mut ::core::ffi::c_void) -> ::windows_core::Result<()> {
    ...
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerGroupExportConfig(hgroup, pwzpassword.into_param().abi(), &mut result__).map(|| result__)
}
#[inline]
...
#[cfg(feature = "Win32_Security_Cryptography")]
#[inline]
pub unsafe fn PeerGroupIssueCredentials<P0>(hgroup: *const ::core::ffi::c_void, pwzsubjectidentity: P0, pcredentialinfo: ::core::option::Option<*const PEER_CREDENTIAL_INFO>, dwflags: u32, ppwzinvitation: ::core::option::Option<*mut ::windows_core::PWSTR>) -> ::windows_core::Result<()>
where
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerGroupOpenDirectConnection(hgroup, pwzidentity.into_param().abi(), paddress, &mut result__).map(|| result__)
}
#[cfg(feature = "Win32_Security_Cryptography")]
#[inline]
    ...
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerGroupParseInvitation(pwzinvitation.into_param().abi(), &mut result__).map(|| result__)
}
#[inline]
    ...
    P0: ::windows_core::IntoParam<super::super::Foundation::HANDLE>,
{
    ...
    PeerGroupRegisterEvent(hgroup, hevent.into_param().abi(), peventregistrations.len().try_into().unwrap(), ::core::mem::transmute(peventregistrations.as_ptr()), phpeerevent).ok()
}
#[inline]
    ...
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerHostNameToPeerName(pwzhostname.into_param().abi(), &mut result__).map(|| result__)
}
#[inline]
    ...
    P1: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerIdentityCreate(pwzclassifier.into_param().abi(), pwzfriendlyname.into_param().abi(), hcryptprov, &mut result__).map(|| result__)
}
#[inline]
    ...
    P1: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerIdentityExport(pwzidentity.into_param().abi(), pwzpassword.into_param().abi(), &mut result__).map(|| result__)
}
#[inline]
    ...
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerIdentityGetCryptKey(pwzidentity.into_param().abi(), &mut result__).map(|| result__)
}
#[inline]
    ...
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerIdentityGetFriendlyName(pwzidentity.into_param().abi(), &mut result__).map(|| result__)
}
#[inline]
    ...
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerIdentityGetXML(pwzidentity.into_param().abi(), &mut result__).map(|| result__)
}
#[inline]
    ...
    P1: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerIdentityImport(pwzimportxml.into_param().abi(), pwzpassword.into_param().abi(), &mut result__).map(|| result__)
}
#[inline]
    ...
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
    ...
    let mut result__ = ::std::mem::zeroed();
    PeerNameToPeerHostName(pwzpeername.into_param().abi(), &mut result__).map(|| result__)
}
#[inline]
...
#[cfg(feature = "Win32_Networking_WinSock")]
#[inline]
pub unsafe fn PeerPnrpRegister<P0>(pcwzpeername: P0, pregistrationinfo: ::core::option::Option<*const PEER_PNRP_REGISTRATION_INFO>, phregistration: *mut *mut ::core::ffi::c_void) -> ::windows_core::Result<()>
where
    P0: ::windows_core::IntoParam<::windows_core::PCWSTR>,
{
...
pub const DRT_E_BOOTSTRAPPROVIDER_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8062200Eu32 as _);
pub const DRT_E_BOOTSTRAPPROVIDER_NOT_ATTACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8062200Fu32 as _);
pub const DRT_E_CAPABILITY_MISMATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8062210Fu32 as _);
pub const DRT_E_DUPLICATE_KEY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622009u32 as _);
pub const DRT_E_FAULTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8062210Au32 as _);
pub const DRT_E_INSUFFICIENT_BUFFER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8062210Cu32 as _);
pub const DRT_E_INVALID_ADDRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622005u32 as _);
pub const DRT_E_INVALID_BOOTSTRAP_PROVIDER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622004u32 as _);
pub const DRT_E_INVALID_CERT_CHAIN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80621004u32 as _);
pub const DRT_E_INVALID_INSTANCE_PREFIX: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8062210Du32 as _);
pub const DRT_E_INVALID_KEY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80621009u32 as _);
pub const DRT_E_INVALID_KEY_SIZE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80621002u32 as _);
pub const DRT_E_INVALID_MAX_ADDRESSES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80621007u32 as _);
pub const DRT_E_INVALID_MAX_ENDPOINTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80621011u32 as _);
pub const DRT_E_INVALID_MESSAGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80621005u32 as _);
pub const DRT_E_INVALID_PORT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622000u32 as _);
pub const DRT_E_INVALID_SCOPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622006u32 as _);
pub const DRT_E_INVALID_SEARCH_INFO: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622109u32 as _);
pub const DRT_E_INVALID_SEARCH_RANGE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80621012u32 as _);
pub const DRT_E_INVALID_SECURITY_MODE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8062210Eu32 as _);
pub const DRT_E_INVALID_SECURITY_PROVIDER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622002u32 as _);
pub const DRT_E_INVALID_SETTINGS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622108u32 as _);
pub const DRT_E_INVALID_TRANSPORT_PROVIDER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622001u32 as _);
pub const DRT_E_NO_ADDRESSES_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622008u32 as _);
pub const DRT_E_NO_MORE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80621006u32 as _);
pub const DRT_E_SEARCH_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80621008u32 as _);
pub const DRT_E_SECURITYPROVIDER_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8062200Cu32 as _);
pub const DRT_E_SECURITYPROVIDER_NOT_ATTACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8062200Du32 as _);
pub const DRT_E_STILL_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622003u32 as _);
pub const DRT_E_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80621001u32 as _);
pub const DRT_E_TRANSPORTPROVIDER_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8062200Au32 as _);
pub const DRT_E_TRANSPORTPROVIDER_NOT_ATTACHED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8062200Bu32 as _);
pub const DRT_E_TRANSPORT_ALREADY_BOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622101u32 as _);
pub const DRT_E_TRANSPORT_ALREADY_EXISTS_FOR_SCOPE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622107u32 as _);
pub const DRT_E_TRANSPORT_EXECUTING_CALLBACK: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622106u32 as _);
pub const DRT_E_TRANSPORT_INVALID_ARGUMENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622104u32 as _);
pub const DRT_E_TRANSPORT_NOT_BOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622102u32 as _);
pub const DRT_E_TRANSPORT_NO_DEST_ADDRESSES: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622105u32 as _);
pub const DRT_E_TRANSPORT_SHUTTING_DOWN: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622007u32 as _);
pub const DRT_E_TRANSPORT_STILL_BOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8062210Bu32 as _);
pub const DRT_E_TRANSPORT_UNEXPECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80622103u32 as _);
...
pub const DRT_S_RETRY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x621010u32 as _);
...
pub const PEER_E_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x800700B7u32 as _);
pub const PEER_E_CLIENT_INVALID_COMPARTMENT_ID: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072CF2u32 as _);
pub const PEER_E_CLOUD_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072CEEu32 as _);
pub const PEER_E_CLOUD_IS_DEAD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072CF5u32 as _);
pub const PEER_E_CLOUD_IS_SEARCH_ONLY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072CF1u32 as _);
pub const PEER_E_CLOUD_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072CEDu32 as _);
pub const PEER_E_DISK_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80070070u32 as _);
pub const PEER_E_DUPLICATE_PEER_NAME: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072CF4u32 as _);
pub const PEER_E_INVALID_IDENTITY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072CEFu32 as _);
pub const PEER_E_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80070490u32 as _);
pub const PEER_E_TOO_MUCH_LOAD: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80072CF0u32 as _);
