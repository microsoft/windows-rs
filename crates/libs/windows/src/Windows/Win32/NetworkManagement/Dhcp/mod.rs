...
pub unsafe fn DhcpServerQueryDnsRegCredentials<'a, Param0: ::windows::core::IntoParam<'a, ::windows::core::PCWSTR>>(serveripaddress: Param0, uname: &mut [u16], domain: &mut [u16]) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(DhcpServerQueryDnsRegCredentials(serveripaddress.into_param().abi(), uname.len() as _, ::core::mem::transmute(uname.as_ptr()), domain.len() as _, ::core::mem::transmute(domain.as_ptr())))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
