...
impl ::core::fmt::Debug for DHCP_CALLOUT_TABLE {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("DHCP_CALLOUT_TABLE")
            .field("DhcpControlHook", &self.DhcpControlHook)
            .field("DhcpNewPktHook", &self.DhcpNewPktHook)
            .field("DhcpPktDropHook", &self.DhcpPktDropHook)
            .field("DhcpPktSendHook", &self.DhcpPktSendHook)
            .field("DhcpAddressDelHook", &self.DhcpAddressDelHook)
            .field("DhcpAddressOfferHook", &self.DhcpAddressOfferHook)
            .field("DhcpHandleOptionsHook", &self.DhcpHandleOptionsHook)
            .field("DhcpDeleteClientHook", &self.DhcpDeleteClientHook)
