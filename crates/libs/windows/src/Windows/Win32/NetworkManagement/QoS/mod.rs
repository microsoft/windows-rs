    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { TcOpenInterfaceA(core::mem::transmute_copy(&pinterfacename.param().borrow()), clienthandle, clifcctx, pifchandle as _) }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { TcOpenInterfaceW(core::mem::transmute_copy(&pinterfacename.param().borrow()), clienthandle, clifcctx, pifchandle as _) }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { TcQueryFlowA(core::mem::transmute_copy(&pflowname.param().borrow()), pguidparam, pbuffersize as _, buffer as _) }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { TcQueryFlowW(core::mem::transmute_copy(&pflowname.param().borrow()), pguidparam, pbuffersize as _, buffer as _) }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { TcSetFlowA(core::mem::transmute_copy(&pflowname.param().borrow()), pguidparam, buffersize, buffer) }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { TcSetFlowW(core::mem::transmute_copy(&pflowname.param().borrow()), pguidparam, buffersize, buffer) }
}
#[inline]
