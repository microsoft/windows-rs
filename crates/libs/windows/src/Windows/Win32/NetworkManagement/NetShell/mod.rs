...
pub const CMD_FLAG_HIDDEN: NS_CMD_FLAGS = NS_CMD_FLAGS(32);
pub const CMD_FLAG_INTERACTIVE: NS_CMD_FLAGS = NS_CMD_FLAGS(2);
pub const CMD_FLAG_LIMIT_MASK: NS_CMD_FLAGS = NS_CMD_FLAGS(65535);
pub const CMD_FLAG_LOCAL: NS_CMD_FLAGS = NS_CMD_FLAGS(8);
pub const CMD_FLAG_ONLINE: NS_CMD_FLAGS = NS_CMD_FLAGS(16);
pub const CMD_FLAG_PRIORITY: NS_CMD_FLAGS = NS_CMD_FLAGS(-2147483648);
pub const CMD_FLAG_PRIVATE: NS_CMD_FLAGS = NS_CMD_FLAGS(1);
#[repr(C)]
...
pub const NETSH_COMMIT: NS_MODE_CHANGE = NS_MODE_CHANGE(0);
pub const NETSH_COMMIT_STATE: NS_MODE_CHANGE = NS_MODE_CHANGE(3);
pub const NETSH_ERROR_BASE: u32 = 15000;
pub const NETSH_ERROR_END: u32 = 15019;
pub const NETSH_FLUSH: NS_MODE_CHANGE = NS_MODE_CHANGE(2);
pub const NETSH_MAX_CMD_TOKEN_LENGTH: u32 = 128;
pub const NETSH_MAX_TOKEN_LENGTH: u32 = 64;
pub const NETSH_SAVE: NS_MODE_CHANGE = NS_MODE_CHANGE(4);
pub const NETSH_UNCOMMIT: NS_MODE_CHANGE = NS_MODE_CHANGE(1);
...
pub const NS_EVENT_FROM_N: NS_EVENTS = NS_EVENTS(4);
pub const NS_EVENT_FROM_START: NS_EVENTS = NS_EVENTS(8);
pub const NS_EVENT_LAST_N: NS_EVENTS = NS_EVENTS(1);
pub const NS_EVENT_LAST_SECS: NS_EVENTS = NS_EVENTS(2);
pub const NS_EVENT_LOOP: NS_EVENTS = NS_EVENTS(65536);
...
pub const NS_REQ_ALLOW_MULTIPLE: NS_REQS = NS_REQS(2);
pub const NS_REQ_ONE_OR_MORE: NS_REQS = NS_REQS(3);
pub const NS_REQ_PRESENT: NS_REQS = NS_REQS(1);
pub const NS_REQ_ZERO: NS_REQS = NS_REQS(0);
