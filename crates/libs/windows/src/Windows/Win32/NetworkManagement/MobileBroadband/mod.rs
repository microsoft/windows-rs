...
pub struct MBN_CONTEXT {
    ...
    pub accessString: windows_core::BSTR,
    pub userName: windows_core::BSTR,
    pub password: windows_core::BSTR,
...
pub struct MBN_DEVICE_SERVICE {
    pub deviceServiceID: windows_core::BSTR,
...
pub struct MBN_INTERFACE_CAPS {
    ...
    pub dataClass: u32,
    pub customDataClass: windows_core::BSTR,
    pub gsmBandClass: u32,
    pub cdmaBandClass: u32,
    pub customBandClass: windows_core::BSTR,
    pub smsCaps: u32,
    pub controlCaps: u32,
    pub deviceID: windows_core::BSTR,
    pub manufacturer: windows_core::BSTR,
    pub model: windows_core::BSTR,
    pub firmwareInfo: windows_core::BSTR,
}
...
pub struct MBN_PROVIDER {
    pub providerID: windows_core::BSTR,
    pub providerState: u32,
    pub providerName: windows_core::BSTR,
    pub dataClass: u32,
}
