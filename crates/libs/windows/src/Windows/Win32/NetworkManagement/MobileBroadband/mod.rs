...
impl IMbnConnectionContext {
    ...
    pub unsafe fn SetProvisionedContext<P0, P1>(&self, provisionedcontexts: P0, providerid: P1) -> windows_core::Result<u32>
    where
        P0: windows_core::Param<MBN_CONTEXT>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).SetProvisionedContext)(windows_core::Interface::as_raw(self), provisionedcontexts.param().abi(), providerid.param().abi(), &mut result__).map(|| result__)
    }
}
#[repr(C)]
