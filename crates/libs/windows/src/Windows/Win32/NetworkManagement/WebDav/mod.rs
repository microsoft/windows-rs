    ...
    P2: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ...
    DavAddConnection(connectionhandle, remotename.into(), username.into(), password.into(), ::core::mem::transmute(clientcert.as_ptr()), clientcert.len() as _)
}
#[doc = "*Required features: `\"Win32_NetworkManagement_WebDav\"`, `\"Win32_Foundation\"`*"]
#[cfg(feature = "Win32_Foundation")]
#[inline]
    ...
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ...
    DavGetHTTPFromUNCPath(uncpath.into(), ::core::mem::transmute(url), lpsize)
}
#[doc = "*Required features: `\"Win32_NetworkManagement_WebDav\"`*"]
#[inline]
    ...
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ...
    DavGetTheLockOwnerOfTheFile(filename.into(), ::core::mem::transmute(lockownername), lockownernamelengthinbytes)
}
#[doc = "*Required features: `\"Win32_NetworkManagement_WebDav\"`*"]
#[inline]
    ...
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ...
    DavGetUNCFromHTTPPath(url.into(), ::core::mem::transmute(uncpath), lpsize)
}
#[doc = "*Required features: `\"Win32_NetworkManagement_WebDav\"`*"]
#[inline]
