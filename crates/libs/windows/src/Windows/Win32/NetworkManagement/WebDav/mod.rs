#[inline]
pub unsafe fn DavAddConnection<P1, P2, P3>(connectionhandle: *mut super::super::Foundation::HANDLE, remotename: P1, username: P2, password: P3, clientcert: *const u8, certsize: u32) -> u32
where
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DavAddConnection(connectionhandle as _, remotename.param().abi(), username.param().abi(), password.param().abi(), clientcert, certsize) }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DavGetTheLockOwnerOfTheFile(filename.param().abi(), core::mem::transmute(lockownername), lockownernamelengthinbytes as _) }
}
#[inline]
