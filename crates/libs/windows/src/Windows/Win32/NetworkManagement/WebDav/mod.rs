...
pub const CancelRequest: AUTHNEXTSTEP = AUTHNEXTSTEP(2);
...
pub const DefaultBehavior: AUTHNEXTSTEP = AUTHNEXTSTEP(0);
...
pub const RetryRequest: AUTHNEXTSTEP = AUTHNEXTSTEP(1);
