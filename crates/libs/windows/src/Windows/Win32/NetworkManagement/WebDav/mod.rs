#[inline]
pub unsafe fn DavAddConnection<P1, P2, P3>(connectionhandle: *mut super::super::Foundation::HANDLE, remotename: P1, username: P2, password: P3, clientcert: *mut u8, certsize: u32) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("netapi32.dll" "system" fn DavAddConnection(connectionhandle : *mut super::super::Foundation:: HANDLE, remotename : windows_core::PCWSTR, username : windows_core::PCWSTR, password : windows_core::PCWSTR, clientcert : *mut u8, certsize : u32) -> u32);
    unsafe { DavAddConnection(connectionhandle as _, remotename.param().abi(), username.param().abi(), password.param().abi(), clientcert as _, certsize) }
}
#[inline]
...
#[inline]
pub unsafe fn DavGetExtendedError<P2>(hfile: super::super::Foundation::HANDLE, exterror: *mut u32, exterrorstring: P2, cchsize: *mut u32) -> u32
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("netapi32.dll" "system" fn DavGetExtendedError(hfile : super::super::Foundation:: HANDLE, exterror : *mut u32, exterrorstring : windows_core::PCWSTR, cchsize : *mut u32) -> u32);
    unsafe { DavGetExtendedError(hfile, exterror as _, exterrorstring.param().abi(), cchsize as _) }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DavGetHTTPFromUNCPath(uncpath.param().abi(), core::mem::transmute(url), lpsize as _) }
}
#[inline]
pub unsafe fn DavGetTheLockOwnerOfTheFile<P0, P1>(filename: P0, lockownername: P1, lockownernamelengthinbytes: *mut u32) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("davclnt.dll" "system" fn DavGetTheLockOwnerOfTheFile(filename : windows_core::PCWSTR, lockownername : windows_core::PCWSTR, lockownernamelengthinbytes : *mut u32) -> u32);
    unsafe { DavGetTheLockOwnerOfTheFile(filename.param().abi(), lockownername.param().abi(), lockownernamelengthinbytes as _) }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DavGetUNCFromHTTPPath(url.param().abi(), core::mem::transmute(uncpath), lpsize as _) }
}
#[inline]
...
pub type PFNDAVAUTHCALLBACK_FREECRED = Option<unsafe extern "system" fn(pbuffer: *mut core::ffi::c_void) -> u32>;
