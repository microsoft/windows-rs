...
#[inline]
pub unsafe fn NPAddConnection3<P2, P3>(hwndowner: super::super::Foundation::HWND, lpnetresource: *const NETRESOURCEW, lppassword: P2, lpusername: P3, dwflags: NET_CONNECT_FLAGS) -> u32
where
    P2: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { NPAddConnection3(hwndowner, lpnetresource, lppassword.param().abi(), lpusername.param().abi(), dwflags) }
}
#[inline]
pub unsafe fn NPAddConnection4(hwndowner: super::super::Foundation::HWND, lpnetresource: *const NETRESOURCEW, lpauthbuffer: *const core::ffi::c_void, cbauthbuffer: u32, dwflags: u32, lpuseoptions: *const u8, cbuseoptions: u32) -> u32 {
    ...
    unsafe { NPAddConnection4(hwndowner, lpnetresource, lpauthbuffer, cbauthbuffer, dwflags, lpuseoptions, cbuseoptions) }
}
#[inline]
...
#[inline]
pub unsafe fn NPGetPersistentUseOptionsForConnection<P0>(lpremotepath: P0, lpreaduseoptions: *const u8, cbreaduseoptions: u32, lpwriteuseoptions: *mut u8, lpsizewriteuseoptions: *mut u32) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { NPGetPersistentUseOptionsForConnection(lpremotepath.param().abi(), lpreaduseoptions, cbreaduseoptions, lpwriteuseoptions as _, lpsizewriteuseoptions as _) }
}
#[inline]
...
pub unsafe fn NPOpenEnum(dwscope: u32, dwtype: u32, dwusage: u32, lpnetresource: *const NETRESOURCEW, lphenum: *mut super::super::Foundation::HANDLE) -> u32 {
    ...
    unsafe { NPOpenEnum(dwscope, dwtype, dwusage, lpnetresource, lphenum as _) }
}
#[inline]
...
#[inline]
pub unsafe fn WNetAddConnection3A<P2, P3>(hwndowner: super::super::Foundation::HWND, lpnetresource: *const NETRESOURCEA, lppassword: P2, lpusername: P3, dwflags: NET_CONNECT_FLAGS) -> windows_core::WIN32_ERROR
where
    P2: windows_core::Param<windows_core::PCSTR>,
    P3: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { WNetAddConnection3A(hwndowner, lpnetresource, lppassword.param().abi(), lpusername.param().abi(), dwflags) }
}
#[inline]
pub unsafe fn WNetAddConnection3W<P2, P3>(hwndowner: super::super::Foundation::HWND, lpnetresource: *const NETRESOURCEW, lppassword: P2, lpusername: P3, dwflags: NET_CONNECT_FLAGS) -> windows_core::WIN32_ERROR
where
    P2: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { WNetAddConnection3W(hwndowner, lpnetresource, lppassword.param().abi(), lpusername.param().abi(), dwflags) }
}
#[inline]
pub unsafe fn WNetAddConnection4A(hwndowner: super::super::Foundation::HWND, lpnetresource: *const NETRESOURCEA, pauthbuffer: *const core::ffi::c_void, cbauthbuffer: u32, dwflags: NET_CONNECT_FLAGS, lpuseoptions: *const u8, cbuseoptions: u32) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetAddConnection4A(hwndowner, lpnetresource, pauthbuffer, cbauthbuffer, dwflags, lpuseoptions, cbuseoptions) }
}
#[inline]
pub unsafe fn WNetAddConnection4W(hwndowner: super::super::Foundation::HWND, lpnetresource: *const NETRESOURCEW, pauthbuffer: *const core::ffi::c_void, cbauthbuffer: u32, dwflags: NET_CONNECT_FLAGS, lpuseoptions: *const u8, cbuseoptions: u32) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetAddConnection4W(hwndowner, lpnetresource, pauthbuffer, cbauthbuffer, dwflags, lpuseoptions, cbuseoptions) }
}
#[inline]
...
#[inline]
pub unsafe fn WNetGetConnectionW<P0>(lplocalname: P0, lpremotename: windows_core::PWSTR, lpnlength: *mut u32) -> windows_core::WIN32_ERROR
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { WNetGetConnectionW(lplocalname.param().abi(), core::mem::transmute(lpremotename), lpnlength as _) }
}
#[inline]
pub unsafe fn WNetGetLastErrorA(lperror: *mut u32, lperrorbuf: windows_core::PSTR, nerrorbufsize: u32, lpnamebuf: windows_core::PSTR, nnamebufsize: u32) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetGetLastErrorA(lperror as _, core::mem::transmute(lperrorbuf), nerrorbufsize, core::mem::transmute(lpnamebuf), nnamebufsize) }
}
#[inline]
pub unsafe fn WNetGetLastErrorW(lperror: *mut u32, lperrorbuf: windows_core::PWSTR, nerrorbufsize: u32, lpnamebuf: windows_core::PWSTR, nnamebufsize: u32) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetGetLastErrorW(lperror as _, core::mem::transmute(lperrorbuf), nerrorbufsize, core::mem::transmute(lpnamebuf), nnamebufsize) }
}
#[inline]
...
#[inline]
pub unsafe fn WNetUseConnection4A(hwndowner: super::super::Foundation::HWND, lpnetresource: *const NETRESOURCEA, pauthbuffer: *const core::ffi::c_void, cbauthbuffer: u32, dwflags: u32, lpuseoptions: *const u8, cbuseoptions: u32, lpaccessname: windows_core::PSTR, lpbuffersize: *mut u32, lpresult: *mut u32) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetUseConnection4A(hwndowner, lpnetresource, pauthbuffer, cbauthbuffer, dwflags, lpuseoptions, cbuseoptions, core::mem::transmute(lpaccessname), lpbuffersize as _, lpresult as _) }
}
#[inline]
pub unsafe fn WNetUseConnection4W(hwndowner: super::super::Foundation::HWND, lpnetresource: *const NETRESOURCEW, pauthbuffer: *const core::ffi::c_void, cbauthbuffer: u32, dwflags: u32, lpuseoptions: *const u8, cbuseoptions: u32, lpaccessname: windows_core::PWSTR, lpbuffersize: *mut u32, lpresult: *mut u32) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetUseConnection4W(hwndowner, lpnetresource, pauthbuffer, cbauthbuffer, dwflags, lpuseoptions, cbuseoptions, core::mem::transmute(lpaccessname), lpbuffersize as _, lpresult as _) }
}
#[inline]
...
#[inline]
pub unsafe fn WNetUseConnectionW<P2, P3>(hwndowner: super::super::Foundation::HWND, lpnetresource: *const NETRESOURCEW, lppassword: P2, lpuserid: P3, dwflags: NET_CONNECT_FLAGS, lpaccessname: windows_core::PWSTR, lpbuffersize: *mut u32, lpresult: *mut u32) -> windows_core::WIN32_ERROR
where
    P2: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { WNetUseConnectionW(hwndowner, lpnetresource, lppassword.param().abi(), lpuserid.param().abi(), dwflags, core::mem::transmute(lpaccessname), lpbuffersize as _, lpresult as _) }
}
