...
#[inline]
pub unsafe fn NPAddConnection(lpnetresource: *const NETRESOURCEW, lppassword: Option<windows_core::PCWSTR>, lpusername: Option<windows_core::PCWSTR>) -> u32 {
    ...
    unsafe { NPAddConnection(lpnetresource, lppassword.unwrap_or(core::mem::zeroed()) as _, lpusername.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn NPAddConnection3(hwndowner: Option<super::super::Foundation::HWND>, lpnetresource: *const NETRESOURCEW, lppassword: Option<windows_core::PCWSTR>, lpusername: Option<windows_core::PCWSTR>, dwflags: NET_CONNECT_FLAGS) -> u32 {
    ...
    unsafe { NPAddConnection3(hwndowner.unwrap_or(core::mem::zeroed()) as _, lpnetresource, lppassword.unwrap_or(core::mem::zeroed()) as _, lpusername.unwrap_or(core::mem::zeroed()) as _, dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn NPCancelConnection(lpname: windows_core::PCWSTR, fforce: bool) -> u32 {
    windows_core::link!("davclnt.dll" "system" fn NPCancelConnection(lpname : windows_core::PCWSTR, fforce : windows_core::BOOL) -> u32);
    unsafe { NPCancelConnection(core::mem::transmute(lpname), fforce.into()) }
}
#[inline]
pub unsafe fn NPCancelConnection2(lpname: windows_core::PCWSTR, fforce: bool, dwflags: u32) -> u32 {
    ...
    unsafe { NPCancelConnection2(core::mem::transmute(lpname), fforce.into(), dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn NPFormatNetworkName(lpremotename: windows_core::PCWSTR, lpformattedname: windows_core::PWSTR, lpnlength: *mut u32, dwflags: NETWORK_NAME_FORMAT_FLAGS, dwavecharperline: u32) -> u32 {
    ...
    unsafe { NPFormatNetworkName(core::mem::transmute(lpremotename), core::mem::transmute(lpformattedname), lpnlength as _, dwflags, dwavecharperline) }
}
#[inline]
...
#[inline]
pub unsafe fn NPGetConnection(lplocalname: windows_core::PCWSTR, lpremotename: Option<windows_core::PWSTR>, lpnbufferlen: *mut u32) -> u32 {
    ...
    unsafe { NPGetConnection(core::mem::transmute(lplocalname), lpremotename.unwrap_or(core::mem::zeroed()) as _, lpnbufferlen as _) }
}
#[inline]
pub unsafe fn NPGetConnection3(lplocalname: windows_core::PCWSTR, dwlevel: u32, lpbuffer: *mut core::ffi::c_void, lpbuffersize: *mut u32) -> u32 {
    ...
    unsafe { NPGetConnection3(core::mem::transmute(lplocalname), dwlevel, lpbuffer as _, lpbuffersize as _) }
}
#[inline]
pub unsafe fn NPGetConnectionPerformance(lpremotename: windows_core::PCWSTR, lpnetconnectinfo: *mut NETCONNECTINFOSTRUCT) -> u32 {
    ...
    unsafe { NPGetConnectionPerformance(core::mem::transmute(lpremotename), lpnetconnectinfo as _) }
}
#[inline]
pub unsafe fn NPGetPersistentUseOptionsForConnection(lpremotepath: windows_core::PCWSTR, lpreaduseoptions: Option<&[u8]>, lpwriteuseoptions: *mut u8, lpsizewriteuseoptions: *mut u32) -> u32 {
    ...
    unsafe { NPGetPersistentUseOptionsForConnection(core::mem::transmute(lpremotepath), core::mem::transmute(lpreaduseoptions.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), lpreaduseoptions.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), lpwriteuseoptions as _, lpsizewriteuseoptions as _) }
}
#[inline]
...
#[inline]
pub unsafe fn NPGetUniversalName(lplocalpath: windows_core::PCWSTR, dwinfolevel: UNC_INFO_LEVEL, lpbuffer: *mut core::ffi::c_void, lpbuffersize: *mut u32) -> u32 {
    ...
    unsafe { NPGetUniversalName(core::mem::transmute(lplocalpath), dwinfolevel, lpbuffer as _, lpbuffersize as _) }
}
#[inline]
pub unsafe fn NPGetUser(lpname: windows_core::PCWSTR, lpusername: windows_core::PWSTR, lpnbufferlen: *mut u32) -> u32 {
    ...
    unsafe { NPGetUser(core::mem::transmute(lpname), core::mem::transmute(lpusername), lpnbufferlen as _) }
}
#[inline]
...
#[inline]
pub unsafe fn WNetAddConnection2A(lpnetresource: *const NETRESOURCEA, lppassword: Option<windows_core::PCSTR>, lpusername: Option<windows_core::PCSTR>, dwflags: NET_CONNECT_FLAGS) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetAddConnection2A(lpnetresource, lppassword.unwrap_or(core::mem::zeroed()) as _, lpusername.unwrap_or(core::mem::zeroed()) as _, dwflags) }
}
#[inline]
pub unsafe fn WNetAddConnection2W(lpnetresource: *const NETRESOURCEW, lppassword: Option<windows_core::PCWSTR>, lpusername: Option<windows_core::PCWSTR>, dwflags: NET_CONNECT_FLAGS) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetAddConnection2W(lpnetresource, lppassword.unwrap_or(core::mem::zeroed()) as _, lpusername.unwrap_or(core::mem::zeroed()) as _, dwflags) }
}
#[inline]
pub unsafe fn WNetAddConnection3A(hwndowner: Option<super::super::Foundation::HWND>, lpnetresource: *const NETRESOURCEA, lppassword: Option<windows_core::PCSTR>, lpusername: Option<windows_core::PCSTR>, dwflags: NET_CONNECT_FLAGS) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetAddConnection3A(hwndowner.unwrap_or(core::mem::zeroed()) as _, lpnetresource, lppassword.unwrap_or(core::mem::zeroed()) as _, lpusername.unwrap_or(core::mem::zeroed()) as _, dwflags) }
}
#[inline]
pub unsafe fn WNetAddConnection3W(hwndowner: Option<super::super::Foundation::HWND>, lpnetresource: *const NETRESOURCEW, lppassword: Option<windows_core::PCWSTR>, lpusername: Option<windows_core::PCWSTR>, dwflags: NET_CONNECT_FLAGS) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetAddConnection3W(hwndowner.unwrap_or(core::mem::zeroed()) as _, lpnetresource, lppassword.unwrap_or(core::mem::zeroed()) as _, lpusername.unwrap_or(core::mem::zeroed()) as _, dwflags) }
}
#[inline]
...
#[inline]
pub unsafe fn WNetAddConnectionA(lpremotename: windows_core::PCSTR, lppassword: Option<windows_core::PCSTR>, lplocalname: Option<windows_core::PCSTR>) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetAddConnectionA(core::mem::transmute(lpremotename), lppassword.unwrap_or(core::mem::zeroed()) as _, lplocalname.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn WNetAddConnectionW(lpremotename: windows_core::PCWSTR, lppassword: Option<windows_core::PCWSTR>, lplocalname: Option<windows_core::PCWSTR>) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetAddConnectionW(core::mem::transmute(lpremotename), lppassword.unwrap_or(core::mem::zeroed()) as _, lplocalname.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn WNetCancelConnection2A(lpname: windows_core::PCSTR, dwflags: NET_CONNECT_FLAGS, fforce: bool) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetCancelConnection2A(core::mem::transmute(lpname), dwflags, fforce.into()) }
}
#[inline]
pub unsafe fn WNetCancelConnection2W(lpname: windows_core::PCWSTR, dwflags: NET_CONNECT_FLAGS, fforce: bool) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetCancelConnection2W(core::mem::transmute(lpname), dwflags, fforce.into()) }
}
#[inline]
pub unsafe fn WNetCancelConnectionA(lpname: windows_core::PCSTR, fforce: bool) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetCancelConnectionA(core::mem::transmute(lpname), fforce.into()) }
}
#[inline]
pub unsafe fn WNetCancelConnectionW(lpname: windows_core::PCWSTR, fforce: bool) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetCancelConnectionW(core::mem::transmute(lpname), fforce.into()) }
}
#[inline]
...
#[inline]
pub unsafe fn WNetGetConnectionA(lplocalname: windows_core::PCSTR, lpremotename: Option<windows_core::PSTR>, lpnlength: *mut u32) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetGetConnectionA(core::mem::transmute(lplocalname), lpremotename.unwrap_or(core::mem::zeroed()) as _, lpnlength as _) }
}
#[inline]
pub unsafe fn WNetGetConnectionW(lplocalname: windows_core::PCWSTR, lpremotename: Option<windows_core::PWSTR>, lpnlength: *mut u32) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetGetConnectionW(core::mem::transmute(lplocalname), lpremotename.unwrap_or(core::mem::zeroed()) as _, lpnlength as _) }
}
#[inline]
...
#[inline]
pub unsafe fn WNetGetNetworkInformationA(lpprovider: windows_core::PCSTR, lpnetinfostruct: *mut NETINFOSTRUCT) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetGetNetworkInformationA(core::mem::transmute(lpprovider), lpnetinfostruct as _) }
}
#[inline]
pub unsafe fn WNetGetNetworkInformationW(lpprovider: windows_core::PCWSTR, lpnetinfostruct: *mut NETINFOSTRUCT) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetGetNetworkInformationW(core::mem::transmute(lpprovider), lpnetinfostruct as _) }
}
#[inline]
...
#[inline]
pub unsafe fn WNetGetUniversalNameA(lplocalpath: windows_core::PCSTR, dwinfolevel: UNC_INFO_LEVEL, lpbuffer: *mut core::ffi::c_void, lpbuffersize: *mut u32) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetGetUniversalNameA(core::mem::transmute(lplocalpath), dwinfolevel, lpbuffer as _, lpbuffersize as _) }
}
#[inline]
pub unsafe fn WNetGetUniversalNameW(lplocalpath: windows_core::PCWSTR, dwinfolevel: UNC_INFO_LEVEL, lpbuffer: *mut core::ffi::c_void, lpbuffersize: *mut u32) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetGetUniversalNameW(core::mem::transmute(lplocalpath), dwinfolevel, lpbuffer as _, lpbuffersize as _) }
}
#[inline]
pub unsafe fn WNetGetUserA(lpname: Option<windows_core::PCSTR>, lpusername: windows_core::PSTR, lpnlength: *mut u32) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetGetUserA(lpname.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(lpusername), lpnlength as _) }
}
#[inline]
pub unsafe fn WNetGetUserW(lpname: Option<windows_core::PCWSTR>, lpusername: windows_core::PWSTR, lpnlength: *mut u32) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetGetUserW(lpname.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(lpusername), lpnlength as _) }
}
#[inline]
...
#[inline]
pub unsafe fn WNetSetLastErrorA(err: u32, lperror: windows_core::PCSTR, lpproviders: windows_core::PCSTR) {
    windows_core::link!("mpr.dll" "system" fn WNetSetLastErrorA(err : u32, lperror : windows_core::PCSTR, lpproviders : windows_core::PCSTR));
    unsafe { WNetSetLastErrorA(err, core::mem::transmute(lperror), core::mem::transmute(lpproviders)) }
}
#[inline]
pub unsafe fn WNetSetLastErrorW(err: u32, lperror: windows_core::PCWSTR, lpproviders: windows_core::PCWSTR) {
    ...
    unsafe { WNetSetLastErrorW(err, core::mem::transmute(lperror), core::mem::transmute(lpproviders)) }
}
#[inline]
...
#[inline]
pub unsafe fn WNetUseConnectionA(hwndowner: Option<super::super::Foundation::HWND>, lpnetresource: *const NETRESOURCEA, lppassword: Option<windows_core::PCSTR>, lpuserid: Option<windows_core::PCSTR>, dwflags: NET_CONNECT_FLAGS, lpaccessname: Option<windows_core::PSTR>, lpbuffersize: Option<*mut u32>, lpresult: Option<*mut u32>) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetUseConnectionA(hwndowner.unwrap_or(core::mem::zeroed()) as _, lpnetresource, lppassword.unwrap_or(core::mem::zeroed()) as _, lpuserid.unwrap_or(core::mem::zeroed()) as _, dwflags, lpaccessname.unwrap_or(core::mem::zeroed()) as _, lpbuffersize.unwrap_or(core::mem::zeroed()) as _, lpresult.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn WNetUseConnectionW(hwndowner: Option<super::super::Foundation::HWND>, lpnetresource: *const NETRESOURCEW, lppassword: Option<windows_core::PCWSTR>, lpuserid: Option<windows_core::PCWSTR>, dwflags: NET_CONNECT_FLAGS, lpaccessname: Option<windows_core::PWSTR>, lpbuffersize: Option<*mut u32>, lpresult: Option<*mut u32>) -> windows_core::WIN32_ERROR {
    ...
    unsafe { WNetUseConnectionW(hwndowner.unwrap_or(core::mem::zeroed()) as _, lpnetresource, lppassword.unwrap_or(core::mem::zeroed()) as _, lpuserid.unwrap_or(core::mem::zeroed()) as _, dwflags, lpaccessname.unwrap_or(core::mem::zeroed()) as _, lpbuffersize.unwrap_or(core::mem::zeroed()) as _, lpresult.unwrap_or(core::mem::zeroed()) as _) }
}
