...
pub unsafe fn WNetGetLastErrorA(lperror: *mut u32, lperrorbuf: &mut [u8], lpnamebuf: &mut [u8]) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(WNetGetLastErrorA(::core::mem::transmute(lperror), ::core::mem::transmute(lperrorbuf.as_mut_ptr()), lperrorbuf.len() as _, ::core::mem::transmute(lpnamebuf.as_mut_ptr()), lpnamebuf.len() as _))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn WNetGetLastErrorW(lperror: *mut u32, lperrorbuf: &mut [u16], lpnamebuf: &mut [u16]) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(WNetGetLastErrorW(::core::mem::transmute(lperror), ::core::mem::transmute(lperrorbuf.as_mut_ptr()), lperrorbuf.len() as _, ::core::mem::transmute(lpnamebuf.as_mut_ptr()), lpnamebuf.len() as _))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
