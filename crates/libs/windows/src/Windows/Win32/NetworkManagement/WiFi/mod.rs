...
pub unsafe fn WFDCancelOpenSession(hsessionhandle: super::super::Foundation::HANDLE) -> u32 {
    ...
    WFDCancelOpenSession(core::mem::transmute(hsessionhandle))
}
#[inline]
pub unsafe fn WFDCloseHandle(hclienthandle: super::super::Foundation::HANDLE) -> u32 {
    ...
    WFDCloseHandle(core::mem::transmute(hclienthandle))
}
#[inline]
pub unsafe fn WFDCloseSession(hsessionhandle: super::super::Foundation::HANDLE) -> u32 {
    ...
    WFDCloseSession(core::mem::transmute(hsessionhandle))
}
#[inline]
pub unsafe fn WFDOpenHandle(dwclientversion: u32, pdwnegotiatedversion: *mut u32, phclienthandle: *mut super::super::Foundation::HANDLE) -> u32 {
    ...
    WFDOpenHandle(core::mem::transmute(dwclientversion), core::mem::transmute(pdwnegotiatedversion), core::mem::transmute(phclienthandle))
}
#[inline]
pub unsafe fn WFDOpenLegacySession(hclienthandle: super::super::Foundation::HANDLE, plegacymacaddress: *const *const u8, phsessionhandle: *mut super::super::Foundation::HANDLE, pguidsessioninterface: *mut windows_core::GUID) -> u32 {
    ...
    WFDOpenLegacySession(core::mem::transmute(hclienthandle), core::mem::transmute(plegacymacaddress), core::mem::transmute(phsessionhandle), core::mem::transmute(pguidsessioninterface))
}
#[inline]
pub unsafe fn WFDStartOpenSession(hclienthandle: super::super::Foundation::HANDLE, pdeviceaddress: *const *const u8, pvcontext: Option<*const core::ffi::c_void>, pfncallback: WFD_OPEN_SESSION_COMPLETE_CALLBACK, phsessionhandle: *mut super::super::Foundation::HANDLE) -> u32 {
    ...
    WFDStartOpenSession(core::mem::transmute(hclienthandle), core::mem::transmute(pdeviceaddress), core::mem::transmute(pvcontext.unwrap_or(core::mem::zeroed())), core::mem::transmute(pfncallback), core::mem::transmute(phsessionhandle))
}
#[inline]
...
pub unsafe fn WlanAllocateMemory(dwmemorysize: u32) -> *mut core::ffi::c_void {
    ...
    WlanAllocateMemory(core::mem::transmute(dwmemorysize))
}
#[inline]
pub unsafe fn WlanCloseHandle(hclienthandle: super::super::Foundation::HANDLE, preserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanCloseHandle(core::mem::transmute(hclienthandle), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
...
pub unsafe fn WlanConnect(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_core::GUID, pconnectionparameters: *const WLAN_CONNECTION_PARAMETERS, preserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanConnect(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), core::mem::transmute(pconnectionparameters), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
#[cfg(feature = "Win32_NetworkManagement_Ndis")]
#[inline]
pub unsafe fn WlanConnect2(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_core::GUID, pconnectionparameters: *const WLAN_CONNECTION_PARAMETERS_V2, preserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanConnect2(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), core::mem::transmute(pconnectionparameters), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    WlanDeleteProfile(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), strprofilename.param().abi(), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
...
pub unsafe fn WlanDisconnect(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_core::GUID, preserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanDisconnect(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanEnumInterfaces(hclienthandle: super::super::Foundation::HANDLE, preserved: Option<*const core::ffi::c_void>, ppinterfacelist: *mut *mut WLAN_INTERFACE_INFO_LIST) -> u32 {
    ...
    WlanEnumInterfaces(core::mem::transmute(hclienthandle), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())), core::mem::transmute(ppinterfacelist))
}
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    WlanExtractPsdIEDataList(core::mem::transmute(hclienthandle), prawiedata.len().try_into().unwrap(), core::mem::transmute(prawiedata.as_ptr()), strformat.param().abi(), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())), core::mem::transmute(pppsdiedatalist))
}
#[inline]
...
pub unsafe fn WlanGetAvailableNetworkList(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_core::GUID, dwflags: u32, preserved: Option<*const core::ffi::c_void>, ppavailablenetworklist: *mut *mut WLAN_AVAILABLE_NETWORK_LIST) -> u32 {
    ...
    WlanGetAvailableNetworkList(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), core::mem::transmute(dwflags), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())), core::mem::transmute(ppavailablenetworklist))
}
#[inline]
pub unsafe fn WlanGetAvailableNetworkList2(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_core::GUID, dwflags: u32, preserved: Option<*const core::ffi::c_void>, ppavailablenetworklist: *mut *mut WLAN_AVAILABLE_NETWORK_LIST_V2) -> u32 {
    ...
    WlanGetAvailableNetworkList2(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), core::mem::transmute(dwflags), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())), core::mem::transmute(ppavailablenetworklist))
}
#[inline]
pub unsafe fn WlanGetFilterList(hclienthandle: super::super::Foundation::HANDLE, wlanfilterlisttype: WLAN_FILTER_LIST_TYPE, preserved: Option<*const core::ffi::c_void>, ppnetworklist: *mut *mut DOT11_NETWORK_LIST) -> u32 {
    ...
    WlanGetFilterList(core::mem::transmute(hclienthandle), core::mem::transmute(wlanfilterlisttype), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())), core::mem::transmute(ppnetworklist))
}
#[inline]
pub unsafe fn WlanGetInterfaceCapability(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_core::GUID, preserved: Option<*const core::ffi::c_void>, ppcapability: *mut *mut WLAN_INTERFACE_CAPABILITY) -> u32 {
    ...
    WlanGetInterfaceCapability(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())), core::mem::transmute(ppcapability))
}
#[inline]
pub unsafe fn WlanGetNetworkBssList<P4>(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_core::GUID, pdot11ssid: Option<*const DOT11_SSID>, dot11bsstype: DOT11_BSS_TYPE, bsecurityenabled: P4, preserved: Option<*const core::ffi::c_void>, ppwlanbsslist: *mut *mut WLAN_BSS_LIST) -> u32
where
    P4: windows_core::Param<super::super::Foundation::BOOL>,
{
    ...
    WlanGetNetworkBssList(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), core::mem::transmute(pdot11ssid.unwrap_or(core::mem::zeroed())), core::mem::transmute(dot11bsstype), bsecurityenabled.param().abi(), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())), core::mem::transmute(ppwlanbsslist))
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    WlanGetProfileCustomUserData(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), strprofilename.param().abi(), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())), core::mem::transmute(pdwdatasize), core::mem::transmute(ppdata))
}
#[inline]
pub unsafe fn WlanGetProfileList(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_core::GUID, preserved: Option<*const core::ffi::c_void>, ppprofilelist: *mut *mut WLAN_PROFILE_INFO_LIST) -> u32 {
    ...
    WlanGetProfileList(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())), core::mem::transmute(ppprofilelist))
}
#[inline]
pub unsafe fn WlanGetSecuritySettings(hclienthandle: super::super::Foundation::HANDLE, securableobject: WLAN_SECURABLE_OBJECT, pvaluetype: Option<*mut WLAN_OPCODE_VALUE_TYPE>, pstrcurrentsddl: *mut windows_core::PWSTR, pdwgrantedaccess: *mut u32) -> u32 {
    ...
    WlanGetSecuritySettings(core::mem::transmute(hclienthandle), core::mem::transmute(securableobject), core::mem::transmute(pvaluetype.unwrap_or(core::mem::zeroed())), core::mem::transmute(pstrcurrentsddl), core::mem::transmute(pdwgrantedaccess))
}
#[inline]
pub unsafe fn WlanGetSupportedDeviceServices(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_core::GUID, ppdevsvcguidlist: *mut *mut WLAN_DEVICE_SERVICE_GUID_LIST) -> u32 {
    ...
    WlanGetSupportedDeviceServices(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), core::mem::transmute(ppdevsvcguidlist))
}
#[inline]
pub unsafe fn WlanHostedNetworkForceStart(hclienthandle: super::super::Foundation::HANDLE, pfailreason: Option<*mut WLAN_HOSTED_NETWORK_REASON>, pvreserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanHostedNetworkForceStart(core::mem::transmute(hclienthandle), core::mem::transmute(pfailreason.unwrap_or(core::mem::zeroed())), core::mem::transmute(pvreserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanHostedNetworkForceStop(hclienthandle: super::super::Foundation::HANDLE, pfailreason: Option<*mut WLAN_HOSTED_NETWORK_REASON>, pvreserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanHostedNetworkForceStop(core::mem::transmute(hclienthandle), core::mem::transmute(pfailreason.unwrap_or(core::mem::zeroed())), core::mem::transmute(pvreserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanHostedNetworkInitSettings(hclienthandle: super::super::Foundation::HANDLE, pfailreason: Option<*mut WLAN_HOSTED_NETWORK_REASON>, pvreserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanHostedNetworkInitSettings(core::mem::transmute(hclienthandle), core::mem::transmute(pfailreason.unwrap_or(core::mem::zeroed())), core::mem::transmute(pvreserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanHostedNetworkQueryProperty(hclienthandle: super::super::Foundation::HANDLE, opcode: WLAN_HOSTED_NETWORK_OPCODE, pdwdatasize: *mut u32, ppvdata: *mut *mut core::ffi::c_void, pwlanopcodevaluetype: *mut WLAN_OPCODE_VALUE_TYPE, pvreserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanHostedNetworkQueryProperty(core::mem::transmute(hclienthandle), core::mem::transmute(opcode), core::mem::transmute(pdwdatasize), core::mem::transmute(ppvdata), core::mem::transmute(pwlanopcodevaluetype), core::mem::transmute(pvreserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
...
pub unsafe fn WlanHostedNetworkQueryStatus(hclienthandle: super::super::Foundation::HANDLE, ppwlanhostednetworkstatus: *mut *mut WLAN_HOSTED_NETWORK_STATUS, pvreserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanHostedNetworkQueryStatus(core::mem::transmute(hclienthandle), core::mem::transmute(ppwlanhostednetworkstatus), core::mem::transmute(pvreserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanHostedNetworkRefreshSecuritySettings(hclienthandle: super::super::Foundation::HANDLE, pfailreason: Option<*mut WLAN_HOSTED_NETWORK_REASON>, pvreserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanHostedNetworkRefreshSecuritySettings(core::mem::transmute(hclienthandle), core::mem::transmute(pfailreason.unwrap_or(core::mem::zeroed())), core::mem::transmute(pvreserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanHostedNetworkSetProperty(hclienthandle: super::super::Foundation::HANDLE, opcode: WLAN_HOSTED_NETWORK_OPCODE, dwdatasize: u32, pvdata: *const core::ffi::c_void, pfailreason: Option<*mut WLAN_HOSTED_NETWORK_REASON>, pvreserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanHostedNetworkSetProperty(core::mem::transmute(hclienthandle), core::mem::transmute(opcode), core::mem::transmute(dwdatasize), core::mem::transmute(pvdata), core::mem::transmute(pfailreason.unwrap_or(core::mem::zeroed())), core::mem::transmute(pvreserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanHostedNetworkSetSecondaryKey<P3, P4>(hclienthandle: super::super::Foundation::HANDLE, puckeydata: &[u8], bispassphrase: P3, bpersistent: P4, pfailreason: Option<*mut WLAN_HOSTED_NETWORK_REASON>, pvreserved: Option<*const core::ffi::c_void>) -> u32
where
    ...
    P4: windows_core::Param<super::super::Foundation::BOOL>,
{
    ...
    WlanHostedNetworkSetSecondaryKey(core::mem::transmute(hclienthandle), puckeydata.len().try_into().unwrap(), core::mem::transmute(puckeydata.as_ptr()), bispassphrase.param().abi(), bpersistent.param().abi(), core::mem::transmute(pfailreason.unwrap_or(core::mem::zeroed())), core::mem::transmute(pvreserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanHostedNetworkStartUsing(hclienthandle: super::super::Foundation::HANDLE, pfailreason: Option<*mut WLAN_HOSTED_NETWORK_REASON>, pvreserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanHostedNetworkStartUsing(core::mem::transmute(hclienthandle), core::mem::transmute(pfailreason.unwrap_or(core::mem::zeroed())), core::mem::transmute(pvreserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanHostedNetworkStopUsing(hclienthandle: super::super::Foundation::HANDLE, pfailreason: Option<*mut WLAN_HOSTED_NETWORK_REASON>, pvreserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanHostedNetworkStopUsing(core::mem::transmute(hclienthandle), core::mem::transmute(pfailreason.unwrap_or(core::mem::zeroed())), core::mem::transmute(pvreserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanIhvControl(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_core::GUID, r#type: WLAN_IHV_CONTROL_TYPE, dwinbuffersize: u32, pinbuffer: *const core::ffi::c_void, dwoutbuffersize: u32, poutbuffer: Option<*mut core::ffi::c_void>, pdwbytesreturned: *mut u32) -> u32 {
    ...
    WlanIhvControl(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), core::mem::transmute(r#type), core::mem::transmute(dwinbuffersize), core::mem::transmute(pinbuffer), core::mem::transmute(dwoutbuffersize), core::mem::transmute(poutbuffer.unwrap_or(core::mem::zeroed())), core::mem::transmute(pdwbytesreturned))
}
#[inline]
pub unsafe fn WlanOpenHandle(dwclientversion: u32, preserved: Option<*const core::ffi::c_void>, pdwnegotiatedversion: *mut u32, phclienthandle: *mut super::super::Foundation::HANDLE) -> u32 {
    ...
    WlanOpenHandle(core::mem::transmute(dwclientversion), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())), core::mem::transmute(pdwnegotiatedversion), core::mem::transmute(phclienthandle))
}
#[inline]
pub unsafe fn WlanQueryAutoConfigParameter(hclienthandle: super::super::Foundation::HANDLE, opcode: WLAN_AUTOCONF_OPCODE, preserved: Option<*const core::ffi::c_void>, pdwdatasize: *mut u32, ppdata: *mut *mut core::ffi::c_void, pwlanopcodevaluetype: Option<*mut WLAN_OPCODE_VALUE_TYPE>) -> u32 {
    ...
    WlanQueryAutoConfigParameter(core::mem::transmute(hclienthandle), core::mem::transmute(opcode), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())), core::mem::transmute(pdwdatasize), core::mem::transmute(ppdata), core::mem::transmute(pwlanopcodevaluetype.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanQueryInterface(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_core::GUID, opcode: WLAN_INTF_OPCODE, preserved: Option<*const core::ffi::c_void>, pdwdatasize: *mut u32, ppdata: *mut *mut core::ffi::c_void, pwlanopcodevaluetype: Option<*mut WLAN_OPCODE_VALUE_TYPE>) -> u32 {
    ...
    WlanQueryInterface(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), core::mem::transmute(opcode), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())), core::mem::transmute(pdwdatasize), core::mem::transmute(ppdata), core::mem::transmute(pwlanopcodevaluetype.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanReasonCodeToString(dwreasoncode: u32, pstringbuffer: &[u16], preserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanReasonCodeToString(core::mem::transmute(dwreasoncode), pstringbuffer.len().try_into().unwrap(), core::mem::transmute(pstringbuffer.as_ptr()), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanRegisterDeviceServiceNotification(hclienthandle: super::super::Foundation::HANDLE, pdevsvcguidlist: Option<*const WLAN_DEVICE_SERVICE_GUID_LIST>) -> u32 {
    ...
    WlanRegisterDeviceServiceNotification(core::mem::transmute(hclienthandle), core::mem::transmute(pdevsvcguidlist.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanRegisterNotification<P2>(hclienthandle: super::super::Foundation::HANDLE, dwnotifsource: WLAN_NOTIFICATION_SOURCES, bignoreduplicate: P2, funccallback: Option<WLAN_NOTIFICATION_CALLBACK>, pcallbackcontext: Option<*const core::ffi::c_void>, preserved: Option<*const core::ffi::c_void>, pdwprevnotifsource: Option<*mut u32>) -> u32
where
    ...
    P1: windows_core::Param<super::super::Foundation::BOOL>,
{
    ...
    WlanRegisterVirtualStationNotification(core::mem::transmute(hclienthandle), bregister.param().abi(), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    WlanRenameProfile(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), stroldprofilename.param().abi(), strnewprofilename.param().abi(), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanSaveTemporaryProfile<P2, P3, P5>(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_core::GUID, strprofilename: P2, stralluserprofilesecurity: P3, dwflags: u32, boverwrite: P5, preserved: Option<*const core::ffi::c_void>) -> u32
where
    P2: windows_core::Param<windows_core::PCWSTR>,
    P3: windows_core::Param<windows_core::PCWSTR>,
    P5: windows_core::Param<super::super::Foundation::BOOL>,
{
    ...
    WlanSaveTemporaryProfile(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), strprofilename.param().abi(), stralluserprofilesecurity.param().abi(), core::mem::transmute(dwflags), boverwrite.param().abi(), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanScan(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_core::GUID, pdot11ssid: Option<*const DOT11_SSID>, piedata: Option<*const WLAN_RAW_DATA>, preserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanScan(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), core::mem::transmute(pdot11ssid.unwrap_or(core::mem::zeroed())), core::mem::transmute(piedata.unwrap_or(core::mem::zeroed())), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanSetAutoConfigParameter(hclienthandle: super::super::Foundation::HANDLE, opcode: WLAN_AUTOCONF_OPCODE, dwdatasize: u32, pdata: *const core::ffi::c_void, preserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanSetAutoConfigParameter(core::mem::transmute(hclienthandle), core::mem::transmute(opcode), core::mem::transmute(dwdatasize), core::mem::transmute(pdata), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanSetFilterList(hclienthandle: super::super::Foundation::HANDLE, wlanfilterlisttype: WLAN_FILTER_LIST_TYPE, pnetworklist: Option<*const DOT11_NETWORK_LIST>, preserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanSetFilterList(core::mem::transmute(hclienthandle), core::mem::transmute(wlanfilterlisttype), core::mem::transmute(pnetworklist.unwrap_or(core::mem::zeroed())), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanSetInterface(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_core::GUID, opcode: WLAN_INTF_OPCODE, dwdatasize: u32, pdata: *const core::ffi::c_void, preserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanSetInterface(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), core::mem::transmute(opcode), core::mem::transmute(dwdatasize), core::mem::transmute(pdata), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanSetProfile<P3, P4, P5>(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_core::GUID, dwflags: u32, strprofilexml: P3, stralluserprofilesecurity: P4, boverwrite: P5, preserved: Option<*const core::ffi::c_void>, pdwreasoncode: *mut u32) -> u32
where
    P3: windows_core::Param<windows_core::PCWSTR>,
    ...
    P5: windows_core::Param<super::super::Foundation::BOOL>,
{
    ...
    WlanSetProfile(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), core::mem::transmute(dwflags), strprofilexml.param().abi(), stralluserprofilesecurity.param().abi(), boverwrite.param().abi(), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())), core::mem::transmute(pdwreasoncode))
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    WlanSetProfileCustomUserData(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), strprofilename.param().abi(), pdata.len().try_into().unwrap(), core::mem::transmute(pdata.as_ptr()), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    WlanSetProfileEapXmlUserData(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), strprofilename.param().abi(), core::mem::transmute(dwflags), streapxmluserdata.param().abi(), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn WlanSetProfileList(hclienthandle: super::super::Foundation::HANDLE, pinterfaceguid: *const windows_core::GUID, strprofilenames: &[windows_core::PCWSTR], preserved: Option<*const core::ffi::c_void>) -> u32 {
    ...
    WlanSetProfileList(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), strprofilenames.len().try_into().unwrap(), core::mem::transmute(strprofilenames.as_ptr()), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    WlanSetProfilePosition(core::mem::transmute(hclienthandle), core::mem::transmute(pinterfaceguid), strprofilename.param().abi(), core::mem::transmute(dwposition), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    WlanSetPsdIEDataList(core::mem::transmute(hclienthandle), strformat.param().abi(), core::mem::transmute(ppsdiedatalist.unwrap_or(core::mem::zeroed())), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())))
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    WlanSetSecuritySettings(core::mem::transmute(hclienthandle), core::mem::transmute(securableobject), strmodifiedsddl.param().abi())
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    WlanUIEditProfile(core::mem::transmute(dwclientversion), wstrprofilename.param().abi(), core::mem::transmute(pinterfaceguid), core::mem::transmute(hwnd), core::mem::transmute(wlstartpage), core::mem::transmute(preserved.unwrap_or(core::mem::zeroed())), core::mem::transmute(pwlanreasoncode.unwrap_or(core::mem::zeroed())))
}
#[repr(transparent)]
...
impl IDot11AdHocInterface {
    ...
    pub unsafe fn GetIEnumDot11AdHocNetworks(&self, pfilterguid: *const windows_core::GUID) -> windows_core::Result<IEnumDot11AdHocNetworks> {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).GetIEnumDot11AdHocNetworks)(windows_core::Interface::as_raw(self), core::mem::transmute(pfilterguid), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    }
...
impl IDot11AdHocManager {
    ...
    {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).CreateNetwork)(windows_core::Interface::as_raw(self), name.param().abi(), password.param().abi(), core::mem::transmute(geographicalid), pinterface.param().abi(), psecurity.param().abi(), core::mem::transmute(pcontextguid), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    }
    ...
    pub unsafe fn GetIEnumDot11AdHocNetworks(&self, pcontextguid: *const windows_core::GUID) -> windows_core::Result<IEnumDot11AdHocNetworks> {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).GetIEnumDot11AdHocNetworks)(windows_core::Interface::as_raw(self), core::mem::transmute(pcontextguid), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    }
    ...
    pub unsafe fn GetNetwork(&self, networksignature: *const windows_core::GUID) -> windows_core::Result<IDot11AdHocNetwork> {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).GetNetwork)(windows_core::Interface::as_raw(self), core::mem::transmute(networksignature), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    }
}
#[repr(C)]
...
impl IDot11AdHocNetwork {
    ...
    pub unsafe fn Connect<P0, P2, P3>(&self, passphrase: P0, geographicalid: i32, fsaveprofile: P2, fmakesavedprofileuserspecific: P3) -> windows_core::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<super::super::Foundation::BOOLEAN>,
        P3: windows_core::Param<super::super::Foundation::BOOLEAN>,
    {
        (windows_core::Interface::vtable(self).Connect)(windows_core::Interface::as_raw(self), passphrase.param().abi(), core::mem::transmute(geographicalid), fsaveprofile.param().abi(), fmakesavedprofileuserspecific.param().abi()).ok()
    }
