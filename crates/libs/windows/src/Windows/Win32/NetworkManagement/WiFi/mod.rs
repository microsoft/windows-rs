...
impl IDot11AdHocInterface {
    ...
    pub unsafe fn GetIEnumSecuritySettings(&self) -> windows_result::Result<IEnumDot11AdHocSecuritySettings> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetIEnumDot11AdHocNetworks(&self, pfilterguid: *const windows_core::GUID) -> windows_result::Result<IEnumDot11AdHocNetworks> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetStatus(&self, pstate: *mut DOT11_ADHOC_NETWORK_CONNECTION_STATUS) -> windows_result::Result<()> {
...
pub trait IDot11AdHocInterface_Impl: windows_core::IUnknownImpl {
    fn GetDeviceSignature(&self, psignature: *mut windows_core::GUID) -> windows_result::Result<()>;
    fn GetFriendlyName(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn IsDot11d(&self, pf11d: *mut u8) -> windows_result::Result<()>;
    fn IsAdHocCapable(&self, pfadhoccapable: *mut u8) -> windows_result::Result<()>;
    fn IsRadioOn(&self, pfisradioon: *mut u8) -> windows_result::Result<()>;
    fn GetActiveNetwork(&self) -> windows_result::Result<IDot11AdHocNetwork>;
    fn GetIEnumSecuritySettings(&self) -> windows_result::Result<IEnumDot11AdHocSecuritySettings>;
    fn GetIEnumDot11AdHocNetworks(&self, pfilterguid: *const windows_core::GUID) -> windows_result::Result<IEnumDot11AdHocNetworks>;
    fn GetStatus(&self, pstate: *mut DOT11_ADHOC_NETWORK_CONNECTION_STATUS) -> windows_result::Result<()>;
}
...
impl IDot11AdHocInterfaceNotificationSink {
    pub unsafe fn OnConnectionStatusChange(&self, estatus: DOT11_ADHOC_NETWORK_CONNECTION_STATUS) -> windows_result::Result<()> {
...
pub trait IDot11AdHocInterfaceNotificationSink_Impl: windows_core::IUnknownImpl {
    fn OnConnectionStatusChange(&self, estatus: DOT11_ADHOC_NETWORK_CONNECTION_STATUS) -> windows_result::Result<()>;
}
...
impl IDot11AdHocManager {
    pub unsafe fn CreateNetwork<P0, P1, P3, P4>(&self, name: P0, password: P1, geographicalid: i32, pinterface: P3, psecurity: P4, pcontextguid: *const windows_core::GUID) -> windows_result::Result<IDot11AdHocNetwork>
    where
    ...
    pub unsafe fn CommitCreatedNetwork<P0>(&self, piadhoc: P0, fsaveprofile: bool, fmakesavedprofileuserspecific: bool) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetIEnumDot11AdHocNetworks(&self, pcontextguid: *const windows_core::GUID) -> windows_result::Result<IEnumDot11AdHocNetworks> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetIEnumDot11AdHocInterfaces(&self) -> windows_result::Result<IEnumDot11AdHocInterfaces> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetNetwork(&self, networksignature: *const windows_core::GUID) -> windows_result::Result<IDot11AdHocNetwork> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDot11AdHocManager_Impl: windows_core::IUnknownImpl {
    fn CreateNetwork(&self, name: &windows_core::PCWSTR, password: &windows_core::PCWSTR, geographicalid: i32, pinterface: windows_core::Ref<IDot11AdHocInterface>, psecurity: windows_core::Ref<IDot11AdHocSecuritySettings>, pcontextguid: *const windows_core::GUID) -> windows_result::Result<IDot11AdHocNetwork>;
    fn CommitCreatedNetwork(&self, piadhoc: windows_core::Ref<IDot11AdHocNetwork>, fsaveprofile: bool, fmakesavedprofileuserspecific: bool) -> windows_result::Result<()>;
    fn GetIEnumDot11AdHocNetworks(&self, pcontextguid: *const windows_core::GUID) -> windows_result::Result<IEnumDot11AdHocNetworks>;
    fn GetIEnumDot11AdHocInterfaces(&self) -> windows_result::Result<IEnumDot11AdHocInterfaces>;
    fn GetNetwork(&self, networksignature: *const windows_core::GUID) -> windows_result::Result<IDot11AdHocNetwork>;
}
...
impl IDot11AdHocManagerNotificationSink {
    pub unsafe fn OnNetworkAdd<P0>(&self, piadhocnetwork: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IDot11AdHocNetwork>,
    {
        unsafe { (windows_core::Interface::vtable(self).OnNetworkAdd)(windows_core::Interface::as_raw(self), piadhocnetwork.param().abi()).ok() }
    }
    pub unsafe fn OnNetworkRemove(&self, signature: *const windows_core::GUID) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).OnNetworkRemove)(windows_core::Interface::as_raw(self), signature).ok() }
    }
    pub unsafe fn OnInterfaceAdd<P0>(&self, piadhocinterface: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn OnInterfaceRemove(&self, signature: *const windows_core::GUID) -> windows_result::Result<()> {
...
pub trait IDot11AdHocManagerNotificationSink_Impl: windows_core::IUnknownImpl {
    fn OnNetworkAdd(&self, piadhocnetwork: windows_core::Ref<IDot11AdHocNetwork>) -> windows_result::Result<()>;
    fn OnNetworkRemove(&self, signature: *const windows_core::GUID) -> windows_result::Result<()>;
    fn OnInterfaceAdd(&self, piadhocinterface: windows_core::Ref<IDot11AdHocInterface>) -> windows_result::Result<()>;
    fn OnInterfaceRemove(&self, signature: *const windows_core::GUID) -> windows_result::Result<()>;
}
...
impl IDot11AdHocNetwork {
    ...
    pub unsafe fn GetSecuritySetting(&self) -> windows_result::Result<IDot11AdHocSecuritySettings> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetContextGuid(&self, pcontextguid: *mut windows_core::GUID) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetContextGuid)(windows_core::Interface::as_raw(self), pcontextguid as _).ok() }
    }
    pub unsafe fn GetSignature(&self, psignature: *mut windows_core::GUID) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetSignature)(windows_core::Interface::as_raw(self), psignature as _).ok() }
    }
    pub unsafe fn GetInterface(&self) -> windows_result::Result<IDot11AdHocInterface> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Connect<P0>(&self, passphrase: P0, geographicalid: i32, fsaveprofile: bool, fmakesavedprofileuserspecific: bool) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IDot11AdHocNetwork_Impl: windows_core::IUnknownImpl {
    fn GetStatus(&self, estatus: *mut DOT11_ADHOC_NETWORK_CONNECTION_STATUS) -> windows_result::Result<()>;
    fn GetSSID(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn HasProfile(&self, pf11d: *mut u8) -> windows_result::Result<()>;
    fn GetProfileName(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn DeleteProfile(&self) -> windows_result::Result<()>;
    fn GetSignalQuality(&self, pustrengthvalue: *mut u32, pustrengthmax: *mut u32) -> windows_result::Result<()>;
    fn GetSecuritySetting(&self) -> windows_result::Result<IDot11AdHocSecuritySettings>;
    fn GetContextGuid(&self, pcontextguid: *mut windows_core::GUID) -> windows_result::Result<()>;
    fn GetSignature(&self, psignature: *mut windows_core::GUID) -> windows_result::Result<()>;
    fn GetInterface(&self) -> windows_result::Result<IDot11AdHocInterface>;
    fn Connect(&self, passphrase: &windows_core::PCWSTR, geographicalid: i32, fsaveprofile: bool, fmakesavedprofileuserspecific: bool) -> windows_result::Result<()>;
...
impl IDot11AdHocNetworkNotificationSink {
    pub unsafe fn OnStatusChange(&self, estatus: DOT11_ADHOC_NETWORK_CONNECTION_STATUS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).OnStatusChange)(windows_core::Interface::as_raw(self), estatus).ok() }
    }
    pub unsafe fn OnConnectFail(&self, efailreason: DOT11_ADHOC_CONNECT_FAIL_REASON) -> windows_result::Result<()> {
...
pub trait IDot11AdHocNetworkNotificationSink_Impl: windows_core::IUnknownImpl {
    fn OnStatusChange(&self, estatus: DOT11_ADHOC_NETWORK_CONNECTION_STATUS) -> windows_result::Result<()>;
    fn OnConnectFail(&self, efailreason: DOT11_ADHOC_CONNECT_FAIL_REASON) -> windows_result::Result<()>;
}
...
impl IDot11AdHocSecuritySettings {
    pub unsafe fn GetDot11AuthAlgorithm(&self, pauth: *mut DOT11_ADHOC_AUTH_ALGORITHM) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetDot11AuthAlgorithm)(windows_core::Interface::as_raw(self), pauth as _).ok() }
    }
    pub unsafe fn GetDot11CipherAlgorithm(&self, pcipher: *mut DOT11_ADHOC_CIPHER_ALGORITHM) -> windows_result::Result<()> {
...
pub trait IDot11AdHocSecuritySettings_Impl: windows_core::IUnknownImpl {
    fn GetDot11AuthAlgorithm(&self, pauth: *mut DOT11_ADHOC_AUTH_ALGORITHM) -> windows_result::Result<()>;
    fn GetDot11CipherAlgorithm(&self, pcipher: *mut DOT11_ADHOC_CIPHER_ALGORITHM) -> windows_result::Result<()>;
}
...
impl IEnumDot11AdHocInterfaces {
    pub unsafe fn Next(&self, rgelt: &mut [Option<IDot11AdHocInterface>], pceltfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumDot11AdHocInterfaces> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IEnumDot11AdHocInterfaces_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, rgelt: *mut Option<IDot11AdHocInterface>, pceltfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumDot11AdHocInterfaces>;
}
...
impl IEnumDot11AdHocNetworks {
    pub unsafe fn Next(&self, rgelt: &mut [Option<IDot11AdHocNetwork>], pceltfetched: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), rgelt.len().try_into().unwrap(), core::mem::transmute(rgelt.as_ptr()), pceltfetched as _).ok() }
    }
    pub unsafe fn Skip(&self, celt: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Skip)(windows_core::Interface::as_raw(self), celt).ok() }
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumDot11AdHocNetworks> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumDot11AdHocNetworks_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, rgelt: *mut Option<IDot11AdHocNetwork>, pceltfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumDot11AdHocNetworks>;
}
...
impl IEnumDot11AdHocSecuritySettings {
    pub unsafe fn Next(&self, rgelt: &mut [Option<IDot11AdHocSecuritySettings>], pceltfetched: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), rgelt.len().try_into().unwrap(), core::mem::transmute(rgelt.as_ptr()), pceltfetched as _).ok() }
    }
    pub unsafe fn Skip(&self, celt: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Skip)(windows_core::Interface::as_raw(self), celt).ok() }
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumDot11AdHocSecuritySettings> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumDot11AdHocSecuritySettings_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, rgelt: *mut Option<IDot11AdHocSecuritySettings>, pceltfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumDot11AdHocSecuritySettings>;
}
