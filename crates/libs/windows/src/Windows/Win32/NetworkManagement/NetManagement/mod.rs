...
pub unsafe fn LogErrorA(dwmessageid: u32, plpwssubstrings: &[windows_core::PCSTR], dwerrorcode: u32) {
    windows_core::link!("rtutils.dll" "system" fn LogErrorA(dwmessageid : u32, cnumberofsubstrings : u32, plpwssubstrings : *const windows_core::PCSTR, dwerrorcode : u32));
    unsafe { LogErrorA(dwmessageid, plpwssubstrings.len().try_into().unwrap(), core::mem::transmute(plpwssubstrings.as_ptr()), dwerrorcode) }
}
#[inline]
pub unsafe fn LogErrorW(dwmessageid: u32, plpwssubstrings: &[windows_core::PCWSTR], dwerrorcode: u32) {
    windows_core::link!("rtutils.dll" "system" fn LogErrorW(dwmessageid : u32, cnumberofsubstrings : u32, plpwssubstrings : *const windows_core::PCWSTR, dwerrorcode : u32));
    unsafe { LogErrorW(dwmessageid, plpwssubstrings.len().try_into().unwrap(), core::mem::transmute(plpwssubstrings.as_ptr()), dwerrorcode) }
}
#[inline]
pub unsafe fn LogEventA(weventtype: u32, dwmessageid: u32, plpwssubstrings: &[windows_core::PCSTR]) {
    windows_core::link!("rtutils.dll" "system" fn LogEventA(weventtype : u32, dwmessageid : u32, cnumberofsubstrings : u32, plpwssubstrings : *const windows_core::PCSTR));
    unsafe { LogEventA(weventtype, dwmessageid, plpwssubstrings.len().try_into().unwrap(), core::mem::transmute(plpwssubstrings.as_ptr())) }
}
#[inline]
pub unsafe fn LogEventW(weventtype: u32, dwmessageid: u32, plpwssubstrings: &[windows_core::PCWSTR]) {
    windows_core::link!("rtutils.dll" "system" fn LogEventW(weventtype : u32, dwmessageid : u32, cnumberofsubstrings : u32, plpwssubstrings : *const windows_core::PCWSTR));
    unsafe { LogEventW(weventtype, dwmessageid, plpwssubstrings.len().try_into().unwrap(), core::mem::transmute(plpwssubstrings.as_ptr())) }
}
#[inline]
pub unsafe fn MprSetupProtocolEnum(dwtransportid: u32, lplpbuffer: *mut *mut u8, lpdwentriesread: *mut u32) -> u32 {
    windows_core::link!("rtutils.dll" "system" fn MprSetupProtocolEnum(dwtransportid : u32, lplpbuffer : *mut *mut u8, lpdwentriesread : *mut u32) -> u32);
    unsafe { MprSetupProtocolEnum(dwtransportid, lplpbuffer as _, lpdwentriesread as _) }
}
#[inline]
pub unsafe fn MprSetupProtocolFree(lpbuffer: *mut core::ffi::c_void) -> u32 {
    windows_core::link!("rtutils.dll" "system" fn MprSetupProtocolFree(lpbuffer : *mut core::ffi::c_void) -> u32);
    unsafe { MprSetupProtocolFree(lpbuffer as _) }
}
#[inline]
...
pub unsafe fn NetApiBufferAllocate(bytecount: u32, buffer: *mut *mut core::ffi::c_void) -> u32 {
    windows_core::link!("netapi32.dll" "system" fn NetApiBufferAllocate(bytecount : u32, buffer : *mut *mut core::ffi::c_void) -> u32);
    unsafe { NetApiBufferAllocate(bytecount, buffer as _) }
}
#[inline]
pub unsafe fn NetApiBufferFree(buffer: Option<*const core::ffi::c_void>) -> u32 {
    windows_core::link!("netapi32.dll" "system" fn NetApiBufferFree(buffer : *const core::ffi::c_void) -> u32);
    unsafe { NetApiBufferFree(buffer.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn NetApiBufferReallocate(oldbuffer: Option<*const core::ffi::c_void>, newbytecount: u32, newbuffer: *mut *mut core::ffi::c_void) -> u32 {
    windows_core::link!("netapi32.dll" "system" fn NetApiBufferReallocate(oldbuffer : *const core::ffi::c_void, newbytecount : u32, newbuffer : *mut *mut core::ffi::c_void) -> u32);
    unsafe { NetApiBufferReallocate(oldbuffer.unwrap_or(core::mem::zeroed()) as _, newbytecount, newbuffer as _) }
}
#[inline]
pub unsafe fn NetApiBufferSize(buffer: *const core::ffi::c_void, bytecount: *mut u32) -> u32 {
    windows_core::link!("netapi32.dll" "system" fn NetApiBufferSize(buffer : *const core::ffi::c_void, bytecount : *mut u32) -> u32);
    unsafe { NetApiBufferSize(buffer, bytecount as _) }
}
#[inline]
...
pub unsafe fn NetCreateProvisioningPackage(pprovisioningparams: *const NETSETUP_PROVISIONING_PARAMS, pppackagebindata: Option<*mut *mut u8>, pdwpackagebindatasize: Option<*mut u32>, pppackagetextdata: Option<*mut windows_core::PWSTR>) -> u32 {
    windows_core::link!("netapi32.dll" "system" fn NetCreateProvisioningPackage(pprovisioningparams : *const NETSETUP_PROVISIONING_PARAMS, pppackagebindata : *mut *mut u8, pdwpackagebindatasize : *mut u32, pppackagetextdata : *mut windows_core::PWSTR) -> u32);
    unsafe { NetCreateProvisioningPackage(pprovisioningparams, pppackagebindata.unwrap_or(core::mem::zeroed()) as _, pdwpackagebindatasize.unwrap_or(core::mem::zeroed()) as _, pppackagetextdata.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn NetLocalGroupAddMember<P0, P1>(servername: P0, groupname: P1, membersid: super::super::Security::PSID) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn NetLocalGroupDelMember<P0, P1>(servername: P0, groupname: P1, membersid: super::super::Security::PSID) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
pub unsafe fn NetUseAdd(servername: Option<*const i8>, levelflags: u32, buf: *const u8, parm_err: Option<*mut u32>) -> u32 {
    windows_core::link!("netapi32.dll" "system" fn NetUseAdd(servername : *const i8, levelflags : u32, buf : *const u8, parm_err : *mut u32) -> u32);
...
pub unsafe fn NetWkstaTransportAdd(servername: Option<*const i8>, level: u32, buf: *const u8, parm_err: Option<*mut u32>) -> u32 {
    windows_core::link!("netapi32.dll" "system" fn NetWkstaTransportAdd(servername : *const i8, level : u32, buf : *const u8, parm_err : *mut u32) -> u32);
...
pub unsafe fn NetWkstaTransportEnum(servername: Option<*const i8>, level: u32, bufptr: *mut *mut u8, prefmaxlen: u32, entriesread: *mut u32, totalentries: *mut u32, resume_handle: Option<*mut u32>) -> u32 {
    windows_core::link!("netapi32.dll" "system" fn NetWkstaTransportEnum(servername : *const i8, level : u32, bufptr : *mut *mut u8, prefmaxlen : u32, entriesread : *mut u32, totalentries : *mut u32, resume_handle : *mut u32) -> u32);
...
pub unsafe fn RouterGetErrorStringA(dwerrorcode: u32, lplpszerrorstring: *mut windows_core::PSTR) -> u32 {
    windows_core::link!("rtutils.dll" "system" fn RouterGetErrorStringA(dwerrorcode : u32, lplpszerrorstring : *mut windows_core::PSTR) -> u32);
    unsafe { RouterGetErrorStringA(dwerrorcode, lplpszerrorstring as _) }
}
#[inline]
pub unsafe fn RouterGetErrorStringW(dwerrorcode: u32, lplpwszerrorstring: *mut windows_core::PWSTR) -> u32 {
    windows_core::link!("rtutils.dll" "system" fn RouterGetErrorStringW(dwerrorcode : u32, lplpwszerrorstring : *mut windows_core::PWSTR) -> u32);
    unsafe { RouterGetErrorStringW(dwerrorcode, lplpwszerrorstring as _) }
}
#[inline]
...
#[inline]
pub unsafe fn RouterLogEventValistExA<P4>(hloghandle: super::super::Foundation::HANDLE, dweventtype: u32, dwerrorcode: u32, dwmessageid: u32, ptszformat: P4, arglist: *mut i8)
where
    P4: windows_core::Param<windows_core::PCSTR>,
{
...
pub unsafe fn TraceDeregisterA(dwtraceid: u32) -> u32 {
    windows_core::link!("rtutils.dll" "system" fn TraceDeregisterA(dwtraceid : u32) -> u32);
    unsafe { TraceDeregisterA(dwtraceid) }
}
#[inline]
pub unsafe fn TraceDeregisterExA(dwtraceid: u32, dwflags: u32) -> u32 {
    windows_core::link!("rtutils.dll" "system" fn TraceDeregisterExA(dwtraceid : u32, dwflags : u32) -> u32);
    unsafe { TraceDeregisterExA(dwtraceid, dwflags) }
}
#[inline]
pub unsafe fn TraceDeregisterExW(dwtraceid: u32, dwflags: u32) -> u32 {
    windows_core::link!("rtutils.dll" "system" fn TraceDeregisterExW(dwtraceid : u32, dwflags : u32) -> u32);
    unsafe { TraceDeregisterExW(dwtraceid, dwflags) }
}
#[inline]
pub unsafe fn TraceDeregisterW(dwtraceid: u32) -> u32 {
    windows_core::link!("rtutils.dll" "system" fn TraceDeregisterW(dwtraceid : u32) -> u32);
    unsafe { TraceDeregisterW(dwtraceid) }
}
#[inline]
...
pub const AA_AUDIT_ALL: u32 = 1;
pub const AA_A_ACL: u32 = 32768;
pub const AA_A_CREATE: u32 = 8192;
pub const AA_A_DELETE: u32 = 16384;
pub const AA_A_OPEN: u32 = 4096;
pub const AA_A_OWNER: u32 = 4;
pub const AA_A_WRITE: u32 = 8192;
pub const AA_CLOSE: u32 = 8;
pub const AA_F_ACL: u32 = 2048;
pub const AA_F_CREATE: u32 = 512;
pub const AA_F_DELETE: u32 = 1024;
pub const AA_F_OPEN: u32 = 256;
pub const AA_F_WRITE: u32 = 512;
pub const AA_S_ACL: u32 = 128;
pub const AA_S_CREATE: u32 = 32;
pub const AA_S_DELETE: u32 = 64;
pub const AA_S_OPEN: u32 = 16;
pub const AA_S_WRITE: u32 = 32;
...
pub const ACTION_ADMINUNLOCK: u32 = 1;
pub const ACTION_LOCKOUT: u32 = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const AE_ACCLIMITEXCD: u32 = 17;
pub const AE_ACCRESTRICT: u32 = 4;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const AE_ACLMOD: u32 = 12;
pub const AE_ACLMODFAIL: u32 = 19;
pub const AE_ADD: u32 = 2;
pub const AE_ADMIN: u32 = 2;
pub const AE_ADMINDIS: u32 = 3;
pub const AE_ADMINPRIVREQD: u32 = 2;
pub const AE_ADMIN_CLOSE: u32 = 2;
pub const AE_AUTODIS: u32 = 2;
pub const AE_BADPW: u32 = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const AE_CONNSTOP: u32 = 5;
pub const AE_DELETE: u32 = 1;
pub const AE_ERROR: u32 = 1;
pub const AE_GENERAL: u32 = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const AE_GENERIC_TYPE: u32 = 21;
pub const AE_GUEST: u32 = 0;
pub const AE_LIM_DELETED: u32 = 5;
pub const AE_LIM_DISABLED: u32 = 4;
pub const AE_LIM_EXPIRED: u32 = 2;
pub const AE_LIM_INVAL_WKSTA: u32 = 3;
pub const AE_LIM_LOGONHOURS: u32 = 1;
pub const AE_LIM_UNKNOWN: u32 = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const AE_LOCKOUT: u32 = 20;
pub const AE_MOD: u32 = 0;
pub const AE_NETLOGDENIED: u32 = 16;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const AE_NETLOGON: u32 = 14;
pub const AE_NOACCESSPERM: u32 = 3;
pub const AE_NORMAL: u32 = 0;
pub const AE_NORMAL_CLOSE: u32 = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const AE_RESACCESS: u32 = 7;
pub const AE_RESACCESS2: u32 = 18;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const AE_RESACCESSREJ: u32 = 8;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const AE_SERVICESTAT: u32 = 11;
pub const AE_SESSDIS: u32 = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const AE_SESSPWERR: u32 = 3;
pub const AE_SES_CLOSE: u32 = 1;
pub const AE_SRVCONT: u32 = 2;
pub const AE_SRVPAUSED: u32 = 1;
pub const AE_SRVSTART: u32 = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
pub struct AE_SRVSTATUS {
    pub ae_sv_status: u32,
}
pub const AE_SRVSTATUS: u32 = 0;
pub const AE_SRVSTOP: u32 = 3;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const AE_UASMOD: u32 = 13;
pub const AE_UAS_GROUP: u32 = 1;
pub const AE_UAS_MODALS: u32 = 2;
pub const AE_UAS_USER: u32 = 0;
pub const AE_UNSHARE: u32 = 2;
pub const AE_USER: u32 = 1;
pub const AE_USERLIMIT: u32 = 0;
#[repr(transparent)]
...
pub const AF_OP_ACCOUNTS: AF_OP = AF_OP(8);
pub const AF_OP_COMM: AF_OP = AF_OP(2);
pub const AF_OP_PRINT: AF_OP = AF_OP(1);
pub const AF_OP_SERVER: AF_OP = AF_OP(4);
...
pub const COULD_NOT_VERIFY_VOLUMES: i32 = -1073727512;
...
pub const DFS_CONNECTION_FAILURE: i32 = 1073756226;
pub const DFS_ERROR_ACTIVEDIRECTORY_OFFLINE: i32 = -1073727301;
pub const DFS_ERROR_CLUSTERINFO_FAILED: i32 = -1073727307;
pub const DFS_ERROR_COMPUTERINFO_FAILED: i32 = -1073727308;
pub const DFS_ERROR_CREATEEVENT_FAILED: i32 = -1073727309;
pub const DFS_ERROR_CREATE_REPARSEPOINT_FAILURE: i32 = -1073727321;
pub const DFS_ERROR_CREATE_REPARSEPOINT_SUCCESS: i32 = 1073756370;
pub const DFS_ERROR_CROSS_FOREST_TRUST_INFO_FAILED: i32 = -1073727274;
pub const DFS_ERROR_DCINFO_FAILED: i32 = -1073727306;
pub const DFS_ERROR_DSCONNECT_FAILED: i32 = -2147469122;
pub const DFS_ERROR_DUPLICATE_LINK: i32 = -1073727277;
pub const DFS_ERROR_HANDLENAMESPACE_FAILED: i32 = -1073727304;
pub const DFS_ERROR_LINKS_OVERLAP: i32 = -1073727280;
pub const DFS_ERROR_LINK_OVERLAP: i32 = -1073727279;
pub const DFS_ERROR_MUTLIPLE_ROOTS_NOT_SUPPORTED: i32 = -1073727289;
pub const DFS_ERROR_NO_DFS_DATA: i32 = -1073727294;
pub const DFS_ERROR_ON_ROOT: i32 = -2147469114;
pub const DFS_ERROR_OVERLAPPING_DIRECTORIES: i32 = -1073727319;
pub const DFS_ERROR_PREFIXTABLE_FAILED: i32 = -1073727305;
pub const DFS_ERROR_REFLECTIONENGINE_FAILED: i32 = -1073727302;
pub const DFS_ERROR_REGISTERSTORE_FAILED: i32 = -1073727303;
pub const DFS_ERROR_REMOVE_LINK_FAILED: i32 = -1073727284;
pub const DFS_ERROR_RESYNCHRONIZE_FAILED: i32 = -1073727285;
pub const DFS_ERROR_ROOTSYNCINIT_FAILED: i32 = -1073727310;
pub const DFS_ERROR_SECURITYINIT_FAILED: i32 = -1073727313;
pub const DFS_ERROR_SITECACHEINIT_FAILED: i32 = -1073727311;
pub const DFS_ERROR_SITESUPPOR_FAILED: i32 = -1073727300;
pub const DFS_ERROR_TARGET_LIST_INCORRECT: i32 = -1073727281;
pub const DFS_ERROR_THREADINIT_FAILED: i32 = -1073727312;
pub const DFS_ERROR_TOO_MANY_ERRORS: i32 = -1073727315;
pub const DFS_ERROR_TRUSTED_DOMAIN_INFO_FAILED: i32 = -1073727276;
pub const DFS_ERROR_UNSUPPORTED_FILESYSTEM: i32 = -1073727320;
pub const DFS_ERROR_WINSOCKINIT_FAILED: i32 = -1073727314;
pub const DFS_INFO_ACTIVEDIRECTORY_ONLINE: i32 = 1073756332;
pub const DFS_INFO_CROSS_FOREST_TRUST_INFO_SUCCESS: i32 = 1073756375;
pub const DFS_INFO_DOMAIN_REFERRAL_MIN_OVERFLOW: i32 = 1073756361;
pub const DFS_INFO_DS_RECONNECTED: i32 = 1073756353;
pub const DFS_INFO_FINISH_BUILDING_NAMESPACE: i32 = 1073756357;
pub const DFS_INFO_FINISH_INIT: i32 = 1073756355;
pub const DFS_INFO_RECONNECT_DATA: i32 = 1073756356;
pub const DFS_INFO_TRUSTED_DOMAIN_INFO_SUCCESS: i32 = 1073756373;
pub const DFS_INIT_SUCCESS: i32 = 1073756376;
pub const DFS_MAX_DNR_ATTEMPTS: i32 = 1073756229;
pub const DFS_OPEN_FAILURE: i32 = 1073756231;
pub const DFS_REFERRAL_FAILURE: i32 = 1073756227;
pub const DFS_REFERRAL_REQUEST: i32 = 1073756142;
pub const DFS_REFERRAL_SUCCESS: i32 = 1073756228;
pub const DFS_ROOT_SHARE_ACQUIRE_FAILED: i32 = -2147469095;
pub const DFS_ROOT_SHARE_ACQUIRE_SUCCESS: i32 = 1073756378;
pub const DFS_SPECIAL_REFERRAL_FAILURE: i32 = 1073756230;
pub const DFS_WARN_DOMAIN_REFERRAL_OVERFLOW: i32 = -2147469112;
pub const DFS_WARN_INCOMPLETE_MOVE: i32 = -2147469110;
pub const DFS_WARN_METADATA_LINK_INFO_INVALID: i32 = -2147469106;
pub const DFS_WARN_METADATA_LINK_TYPE_INCORRECT: i32 = -2147469107;
pub const DNLEN: u32 = 15;
pub const DPP_ADVANCED: DEFAULT_PAGES = DEFAULT_PAGES(1);
pub const DSREG_DEVICE_JOIN: DSREG_JOIN_TYPE = DSREG_JOIN_TYPE(1);
#[repr(C)]
#[cfg(feature = "Win32_Security_Cryptography")]
...
pub const DSREG_UNKNOWN_JOIN: DSREG_JOIN_TYPE = DSREG_JOIN_TYPE(0);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const DSREG_WORKPLACE_JOIN: DSREG_JOIN_TYPE = DSREG_JOIN_TYPE(2);
pub const DelegatedManagedServiceAccount: MSA_INFO_ACCOUNT_TYPE = MSA_INFO_ACCOUNT_TYPE(3);
pub const EBP_ABOVE: ENUM_BINDING_PATHS_FLAGS = ENUM_BINDING_PATHS_FLAGS(1);
pub const EBP_BELOW: ENUM_BINDING_PATHS_FLAGS = ENUM_BINDING_PATHS_FLAGS(2);
pub const ENCRYPTED_PWLEN: u32 = 16;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct ENUM_BINDING_PATHS_FLAGS(pub i32);
pub const ERRLOG2_BASE: u32 = 5700;
pub const ERRLOG_BASE: u32 = 3100;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const EVENT_BAD_ACCOUNT_NAME: i32 = -1073734816;
pub const EVENT_BAD_SERVICE_STATE: i32 = -1073734808;
pub const EVENT_BOOT_SYSTEM_DRIVERS_FAILED: i32 = -1073734798;
pub const EVENT_BOWSER_CANT_READ_REGISTRY: i32 = 1073749853;
pub const EVENT_BOWSER_ELECTION_RECEIVED: i32 = 8012;
pub const EVENT_BOWSER_ELECTION_SENT_FIND_MASTER_FAILED: i32 = 1073749838;
pub const EVENT_BOWSER_ELECTION_SENT_GETBLIST_FAILED: i32 = 1073749837;
pub const EVENT_BOWSER_GETBROWSERLIST_THRESHOLD_EXCEEDED: i32 = 1073749855;
pub const EVENT_BOWSER_ILLEGAL_DATAGRAM: i32 = -2147475642;
pub const EVENT_BOWSER_ILLEGAL_DATAGRAM_THRESHOLD: i32 = -1073733808;
pub const EVENT_BOWSER_MAILSLOT_DATAGRAM_THRESHOLD_EXCEEDED: i32 = 1073749854;
pub const EVENT_BOWSER_NAME_CONVERSION_FAILED: i32 = -1073733814;
pub const EVENT_BOWSER_NON_MASTER_MASTER_ANNOUNCE: i32 = -2147475643;
pub const EVENT_BOWSER_NON_PDC_WON_ELECTION: i32 = 1073749852;
pub const EVENT_BOWSER_OLD_BACKUP_FOUND: i32 = 1073749848;
pub const EVENT_BOWSER_OTHER_MASTER_ON_NET: i32 = -1073733821;
pub const EVENT_BOWSER_PDC_LOST_ELECTION: i32 = 1073749851;
pub const EVENT_BOWSER_PROMOTED_WHILE_ALREADY_MASTER: i32 = -2147475644;
pub const EVENT_BRIDGE_ADAPTER_BIND_FAILED: i32 = -1073727120;
pub const EVENT_BRIDGE_ADAPTER_FILTER_FAILED: i32 = -1073727122;
pub const EVENT_BRIDGE_ADAPTER_LINK_SPEED_QUERY_FAILED: i32 = -1073727124;
pub const EVENT_BRIDGE_ADAPTER_MAC_ADDR_QUERY_FAILED: i32 = -1073727123;
pub const EVENT_BRIDGE_ADAPTER_NAME_QUERY_FAILED: i32 = -1073727121;
pub const EVENT_BRIDGE_BUFFER_POOL_CREATION_FAILED: i32 = -1073727214;
pub const EVENT_BRIDGE_DEVICE_CREATION_FAILED: i32 = -1073727221;
pub const EVENT_BRIDGE_ETHERNET_NOT_OFFERED: i32 = -1073727218;
pub const EVENT_BRIDGE_INIT_MALLOC_FAILED: i32 = -1073727213;
pub const EVENT_BRIDGE_MINIPORT_INIT_FAILED: i32 = -1073727219;
pub const EVENT_BRIDGE_MINIPORT_REGISTER_FAILED: i32 = -1073727222;
pub const EVENT_BRIDGE_MINIPROT_DEVNAME_MISSING: i32 = -1073727223;
pub const EVENT_BRIDGE_NO_BRIDGE_MAC_ADDR: i32 = -1073727220;
pub const EVENT_BRIDGE_PACKET_POOL_CREATION_FAILED: i32 = -1073727215;
pub const EVENT_BRIDGE_PROTOCOL_REGISTER_FAILED: i32 = -1073727224;
pub const EVENT_BRIDGE_THREAD_CREATION_FAILED: i32 = -1073727217;
pub const EVENT_BRIDGE_THREAD_REF_FAILED: i32 = -1073727216;
pub const EVENT_BROWSER_BACKUP_STOPPED: i32 = -1073733792;
pub const EVENT_BROWSER_DEPENDANT_SERVICE_FAILED: i32 = -1073733807;
pub const EVENT_BROWSER_DOMAIN_LIST_FAILED: i32 = -2147475626;
pub const EVENT_BROWSER_DOMAIN_LIST_RETRIEVED: i32 = 8026;
pub const EVENT_BROWSER_ELECTION_SENT_LANMAN_NT_STARTED: i32 = 1073749839;
pub const EVENT_BROWSER_ELECTION_SENT_LANMAN_NT_STOPPED: i32 = 1073749857;
pub const EVENT_BROWSER_ELECTION_SENT_ROLE_CHANGED: i32 = 1073749859;
pub const EVENT_BROWSER_GETBLIST_RECEIVED_NOT_MASTER: i32 = -1073733790;
pub const EVENT_BROWSER_ILLEGAL_CONFIG: i32 = -2147475625;
pub const EVENT_BROWSER_MASTER_PROMOTION_FAILED: i32 = -1073733815;
pub const EVENT_BROWSER_MASTER_PROMOTION_FAILED_NO_MASTER: i32 = -1073733804;
pub const EVENT_BROWSER_MASTER_PROMOTION_FAILED_STOPPING: i32 = -1073733805;
pub const EVENT_BROWSER_NOT_STARTED_IPX_CONFIG_MISMATCH: i32 = -1073733788;
pub const EVENT_BROWSER_OTHERDOMAIN_ADD_FAILED: i32 = -1073733813;
pub const EVENT_BROWSER_REMOTE_MAILSLOTS_DISABLED: i32 = 1073749862;
pub const EVENT_BROWSER_REMOTE_MAILSLOTS_DISABLED_BY_POLICY: i32 = 1073749864;
pub const EVENT_BROWSER_REMOTE_MAILSLOTS_ENABLED: i32 = -2147475611;
pub const EVENT_BROWSER_REMOTE_MAILSLOTS_ENABLED_BY_POLICY: i32 = -2147475609;
pub const EVENT_BROWSER_ROLE_CHANGE_FAILED: i32 = -1073733816;
pub const EVENT_BROWSER_SERVER_LIST_FAILED: i32 = -2147475627;
pub const EVENT_BROWSER_SERVER_LIST_RETRIEVED: i32 = 8025;
pub const EVENT_BROWSER_STATUS_BITS_UPDATE_FAILED: i32 = -1073733817;
pub const EVENT_CALL_TO_FUNCTION_FAILED: i32 = -1073734819;
pub const EVENT_CALL_TO_FUNCTION_FAILED_II: i32 = -1073734818;
pub const EVENT_CIRCULAR_DEPENDENCY_AUTO: i32 = -1073734806;
pub const EVENT_CIRCULAR_DEPENDENCY_DEMAND: i32 = -1073734807;
pub const EVENT_COMMAND_NOT_INTERACTIVE: i32 = -1073733924;
pub const EVENT_COMMAND_START_FAILED: i32 = -1073733923;
pub const EVENT_CONNECTION_TIMEOUT: i32 = -1073734815;
pub const EVENT_ComputerNameChange: i32 = -2147477637;
pub const EVENT_DAV_REDIR_DELAYED_WRITE_FAILED: i32 = -2147468848;
pub const EVENT_DCOM_ASSERTION_FAILURE: i32 = -1073731812;
pub const EVENT_DCOM_COMPLUS_DISABLED: i32 = -1073731810;
pub const EVENT_DCOM_INVALID_ENDPOINT_DATA: i32 = -1073731811;
pub const EVENT_DEPEND_ON_LATER_GROUP: i32 = -1073734804;
pub const EVENT_DEPEND_ON_LATER_SERVICE: i32 = -1073734805;
pub const EVENT_DNSAPI_DEREGISTRATION_FAILED_NOTSUPP: i32 = -2147472466;
pub const EVENT_DNSAPI_DEREGISTRATION_FAILED_NOTSUPP_PRIMARY_DN: i32 = -2147472454;
pub const EVENT_DNSAPI_DEREGISTRATION_FAILED_OTHER: i32 = -2147472463;
pub const EVENT_DNSAPI_DEREGISTRATION_FAILED_OTHER_PRIMARY_DN: i32 = -2147472451;
pub const EVENT_DNSAPI_DEREGISTRATION_FAILED_REFUSED: i32 = -2147472465;
pub const EVENT_DNSAPI_DEREGISTRATION_FAILED_REFUSED_PRIMARY_DN: i32 = -2147472453;
pub const EVENT_DNSAPI_DEREGISTRATION_FAILED_SECURITY: i32 = -2147472464;
pub const EVENT_DNSAPI_DEREGISTRATION_FAILED_SECURITY_PRIMARY_DN: i32 = -2147472452;
pub const EVENT_DNSAPI_DEREGISTRATION_FAILED_SERVERFAIL: i32 = -2147472467;
pub const EVENT_DNSAPI_DEREGISTRATION_FAILED_SERVERFAIL_PRIMARY_DN: i32 = -2147472455;
pub const EVENT_DNSAPI_DEREGISTRATION_FAILED_TIMEOUT: i32 = -2147472468;
pub const EVENT_DNSAPI_DEREGISTRATION_FAILED_TIMEOUT_PRIMARY_DN: i32 = -2147472456;
pub const EVENT_DNSAPI_PTR_DEREGISTRATION_FAILED_NOTSUPP: i32 = -2147472460;
pub const EVENT_DNSAPI_PTR_DEREGISTRATION_FAILED_OTHER: i32 = -2147472457;
pub const EVENT_DNSAPI_PTR_DEREGISTRATION_FAILED_REFUSED: i32 = -2147472459;
pub const EVENT_DNSAPI_PTR_DEREGISTRATION_FAILED_SECURITY: i32 = -2147472458;
pub const EVENT_DNSAPI_PTR_DEREGISTRATION_FAILED_SERVERFAIL: i32 = -2147472461;
pub const EVENT_DNSAPI_PTR_DEREGISTRATION_FAILED_TIMEOUT: i32 = -2147472462;
pub const EVENT_DNSAPI_PTR_REGISTRATION_FAILED_NOTSUPP: i32 = -2147472490;
pub const EVENT_DNSAPI_PTR_REGISTRATION_FAILED_OTHER: i32 = -2147472487;
pub const EVENT_DNSAPI_PTR_REGISTRATION_FAILED_REFUSED: i32 = -2147472489;
pub const EVENT_DNSAPI_PTR_REGISTRATION_FAILED_SECURITY: i32 = -2147472488;
pub const EVENT_DNSAPI_PTR_REGISTRATION_FAILED_SERVERFAIL: i32 = -2147472491;
pub const EVENT_DNSAPI_PTR_REGISTRATION_FAILED_TIMEOUT: i32 = -2147472492;
pub const EVENT_DNSAPI_REGISTERED_ADAPTER: i32 = 1073753024;
pub const EVENT_DNSAPI_REGISTERED_ADAPTER_PRIMARY_DN: i32 = 1073753026;
pub const EVENT_DNSAPI_REGISTERED_PTR: i32 = 1073753025;
pub const EVENT_DNSAPI_REGISTRATION_FAILED_NOTSUPP: i32 = -2147472496;
pub const EVENT_DNSAPI_REGISTRATION_FAILED_NOTSUPP_PRIMARY_DN: i32 = -2147472484;
pub const EVENT_DNSAPI_REGISTRATION_FAILED_OTHER: i32 = -2147472493;
pub const EVENT_DNSAPI_REGISTRATION_FAILED_OTHER_PRIMARY_DN: i32 = -2147472481;
pub const EVENT_DNSAPI_REGISTRATION_FAILED_REFUSED: i32 = -2147472495;
pub const EVENT_DNSAPI_REGISTRATION_FAILED_REFUSED_PRIMARY_DN: i32 = -2147472483;
pub const EVENT_DNSAPI_REGISTRATION_FAILED_SECURITY: i32 = -2147472494;
pub const EVENT_DNSAPI_REGISTRATION_FAILED_SECURITY_PRIMARY_DN: i32 = -2147472482;
pub const EVENT_DNSAPI_REGISTRATION_FAILED_SERVERFAIL: i32 = -2147472497;
pub const EVENT_DNSAPI_REGISTRATION_FAILED_SERVERFAIL_PRIMARY_DN: i32 = -2147472485;
pub const EVENT_DNSAPI_REGISTRATION_FAILED_TIMEOUT: i32 = -2147472498;
pub const EVENT_DNSAPI_REGISTRATION_FAILED_TIMEOUT_PRIMARY_DN: i32 = -2147472486;
pub const EVENT_DNSDomainNameChange: i32 = -2147477636;
pub const EVENT_DNS_CACHE_NETWORK_PERF_WARNING: i32 = -2147472598;
pub const EVENT_DNS_CACHE_START_FAILURE_LOW_MEMORY: i32 = -1073730817;
pub const EVENT_DNS_CACHE_START_FAILURE_NO_CONTROL: i32 = -1073730822;
pub const EVENT_DNS_CACHE_START_FAILURE_NO_DLL: i32 = -1073730824;
pub const EVENT_DNS_CACHE_START_FAILURE_NO_DONE_EVENT: i32 = -1073730821;
pub const EVENT_DNS_CACHE_START_FAILURE_NO_ENTRY: i32 = -1073730823;
pub const EVENT_DNS_CACHE_START_FAILURE_NO_RPC: i32 = -1073730820;
pub const EVENT_DNS_CACHE_START_FAILURE_NO_SHUTDOWN_NOTIFY: i32 = -1073730819;
pub const EVENT_DNS_CACHE_START_FAILURE_NO_UPDATE: i32 = -1073730818;
pub const EVENT_DNS_CACHE_UNABLE_TO_REACH_SERVER_WARNING: i32 = -2147472597;
pub const EVENT_EQOS_ERROR_MACHINE_POLICY_KEYNAME_SIZE_ZERO: i32 = -1073725118;
pub const EVENT_EQOS_ERROR_MACHINE_POLICY_KEYNAME_TOO_LONG: i32 = -1073725120;
pub const EVENT_EQOS_ERROR_MACHINE_POLICY_REFERESH: i32 = -1073725124;
pub const EVENT_EQOS_ERROR_OPENING_MACHINE_POLICY_ROOT_KEY: i32 = -1073725122;
pub const EVENT_EQOS_ERROR_OPENING_MACHINE_POLICY_SUBKEY: i32 = -1073725116;
pub const EVENT_EQOS_ERROR_OPENING_USER_POLICY_ROOT_KEY: i32 = -1073725121;
pub const EVENT_EQOS_ERROR_OPENING_USER_POLICY_SUBKEY: i32 = -1073725115;
pub const EVENT_EQOS_ERROR_PROCESSING_MACHINE_POLICY_FIELD: i32 = -1073725114;
pub const EVENT_EQOS_ERROR_PROCESSING_USER_POLICY_FIELD: i32 = -1073725113;
pub const EVENT_EQOS_ERROR_SETTING_APP_MARKING: i32 = -1073725111;
pub const EVENT_EQOS_ERROR_SETTING_TCP_AUTOTUNING: i32 = -1073725112;
pub const EVENT_EQOS_ERROR_USER_POLICY_KEYNAME_SIZE_ZERO: i32 = -1073725117;
pub const EVENT_EQOS_ERROR_USER_POLICY_KEYNAME_TOO_LONG: i32 = -1073725119;
pub const EVENT_EQOS_ERROR_USER_POLICY_REFERESH: i32 = -1073725123;
pub const EVENT_EQOS_INFO_APP_MARKING_ALLOWED: i32 = 1073758335;
pub const EVENT_EQOS_INFO_APP_MARKING_IGNORED: i32 = 1073758334;
pub const EVENT_EQOS_INFO_APP_MARKING_NOT_CONFIGURED: i32 = 1073758333;
pub const EVENT_EQOS_INFO_LOCAL_SETTING_DONT_USE_NLA: i32 = 1073758336;
pub const EVENT_EQOS_INFO_MACHINE_POLICY_REFRESH_NO_CHANGE: i32 = 1073758324;
pub const EVENT_EQOS_INFO_MACHINE_POLICY_REFRESH_WITH_CHANGE: i32 = 1073758325;
pub const EVENT_EQOS_INFO_TCP_AUTOTUNING_HIGHLY_RESTRICTED: i32 = 1073758330;
pub const EVENT_EQOS_INFO_TCP_AUTOTUNING_NORMAL: i32 = 1073758332;
pub const EVENT_EQOS_INFO_TCP_AUTOTUNING_NOT_CONFIGURED: i32 = 1073758328;
pub const EVENT_EQOS_INFO_TCP_AUTOTUNING_OFF: i32 = 1073758329;
pub const EVENT_EQOS_INFO_TCP_AUTOTUNING_RESTRICTED: i32 = 1073758331;
pub const EVENT_EQOS_INFO_USER_POLICY_REFRESH_NO_CHANGE: i32 = 1073758326;
pub const EVENT_EQOS_INFO_USER_POLICY_REFRESH_WITH_CHANGE: i32 = 1073758327;
pub const EVENT_EQOS_URL_QOS_APPLICATION_CONFLICT: i32 = 1073758337;
pub const EVENT_EQOS_WARNING_MACHINE_POLICY_CONFLICT: i32 = -2147467040;
pub const EVENT_EQOS_WARNING_MACHINE_POLICY_NO_FULLPATH_APPNAME: i32 = -2147467038;
pub const EVENT_EQOS_WARNING_MACHINE_POLICY_PROFILE_NOT_SPECIFIED: i32 = -2147467044;
pub const EVENT_EQOS_WARNING_MACHINE_POLICY_QUOTA_EXCEEDED: i32 = -2147467042;
pub const EVENT_EQOS_WARNING_MACHINE_POLICY_VERSION: i32 = -2147467046;
pub const EVENT_EQOS_WARNING_TEST_1: i32 = -2147467048;
pub const EVENT_EQOS_WARNING_TEST_2: i32 = -2147467047;
pub const EVENT_EQOS_WARNING_USER_POLICY_CONFLICT: i32 = -2147467039;
pub const EVENT_EQOS_WARNING_USER_POLICY_NO_FULLPATH_APPNAME: i32 = -2147467037;
pub const EVENT_EQOS_WARNING_USER_POLICY_PROFILE_NOT_SPECIFIED: i32 = -2147467043;
pub const EVENT_EQOS_WARNING_USER_POLICY_QUOTA_EXCEEDED: i32 = -2147467041;
pub const EVENT_EQOS_WARNING_USER_POLICY_VERSION: i32 = -2147467045;
pub const EVENT_EventLogProductInfo: i32 = -2147477639;
pub const EVENT_EventlogAbnormalShutdown: i32 = -2147477640;
pub const EVENT_EventlogStarted: i32 = -2147477643;
pub const EVENT_EventlogStopped: i32 = -2147477642;
pub const EVENT_EventlogUptime: i32 = -2147477635;
pub const EVENT_FIRST_LOGON_FAILED: i32 = -1073734811;
pub const EVENT_FIRST_LOGON_FAILED_II: i32 = -1073734786;
pub const EVENT_FRS_ACCESS_CHECKS_DISABLED: i32 = -2147470131;
pub const EVENT_FRS_ACCESS_CHECKS_FAILED_UNKNOWN: i32 = -1073728305;
pub const EVENT_FRS_ACCESS_CHECKS_FAILED_USER: i32 = -2147470130;
pub const EVENT_FRS_ASSERT: i32 = -1073728318;
pub const EVENT_FRS_BAD_REG_DATA: i32 = -2147470101;
pub const EVENT_FRS_CANNOT_COMMUNICATE: i32 = -1073728314;
pub const EVENT_FRS_CANNOT_CREATE_UUID: i32 = -1073728300;
pub const EVENT_FRS_CANNOT_START_BACKUP_RESTORE_IN_PROGRESS: i32 = -1073728303;
pub const EVENT_FRS_CANT_OPEN_PREINSTALL: i32 = -1073728273;
pub const EVENT_FRS_CANT_OPEN_STAGE: i32 = -1073728274;
pub const EVENT_FRS_DATABASE_SPACE: i32 = -1073728313;
pub const EVENT_FRS_DISK_WRITE_CACHE_ENABLED: i32 = -2147470136;
pub const EVENT_FRS_DS_POLL_ERROR_SUMMARY: i32 = -2147470086;
pub const EVENT_FRS_DUPLICATE_IN_CXTION: i32 = -1073728266;
pub const EVENT_FRS_DUPLICATE_IN_CXTION_SYSVOL: i32 = -1073728267;
pub const EVENT_FRS_ERROR: i32 = -1073728324;
pub const EVENT_FRS_ERROR_REPLICA_SET_DELETED: i32 = -2147470088;
pub const EVENT_FRS_HUGE_FILE: i32 = -2147470125;
pub const EVENT_FRS_IN_ERROR_STATE: i32 = -1073728269;
pub const EVENT_FRS_JET_1414: i32 = -1073728311;
pub const EVENT_FRS_JOIN_FAIL_TIME_SKEW: i32 = -1073728276;
pub const EVENT_FRS_LONG_JOIN: i32 = -2147470140;
pub const EVENT_FRS_LONG_JOIN_DONE: i32 = -2147470139;
pub const EVENT_FRS_MOVED_PREEXISTING: i32 = -2147470128;
pub const EVENT_FRS_NO_DNS_ATTRIBUTE: i32 = -2147470123;
pub const EVENT_FRS_NO_SID: i32 = -1073728298;
pub const EVENT_FRS_OVERLAPS_LOGGING: i32 = -1073728283;
pub const EVENT_FRS_OVERLAPS_OTHER_STAGE: i32 = -1073728279;
pub const EVENT_FRS_OVERLAPS_ROOT: i32 = -1073728280;
pub const EVENT_FRS_OVERLAPS_STAGE: i32 = -1073728281;
pub const EVENT_FRS_OVERLAPS_WORKING: i32 = -1073728282;
pub const EVENT_FRS_PREPARE_ROOT_FAILED: i32 = -1073728278;
pub const EVENT_FRS_REPLICA_IN_JRNL_WRAP_ERROR: i32 = -1073728263;
pub const EVENT_FRS_REPLICA_NO_ROOT_CHANGE: i32 = -1073728268;
pub const EVENT_FRS_REPLICA_SET_CREATE_FAIL: i32 = -1073728272;
pub const EVENT_FRS_REPLICA_SET_CREATE_OK: i32 = 1073755377;
pub const EVENT_FRS_REPLICA_SET_CXTIONS: i32 = 1073755378;
pub const EVENT_FRS_RMTCO_TIME_SKEW: i32 = -1073728275;
pub const EVENT_FRS_ROOT_HAS_MOVED: i32 = -1073728265;
pub const EVENT_FRS_ROOT_NOT_VALID: i32 = -1073728285;
pub const EVENT_FRS_STAGE_NOT_VALID: i32 = -1073728284;
pub const EVENT_FRS_STAGING_AREA_FULL: i32 = -2147470126;
pub const EVENT_FRS_STARTING: i32 = 1073755325;
pub const EVENT_FRS_STOPPED: i32 = 1073755327;
pub const EVENT_FRS_STOPPED_ASSERT: i32 = -1073728319;
pub const EVENT_FRS_STOPPED_FORCE: i32 = -1073728320;
pub const EVENT_FRS_STOPPING: i32 = 1073755326;
pub const EVENT_FRS_SYSVOL_NOT_READY: i32 = -2147470134;
pub const EVENT_FRS_SYSVOL_NOT_READY_PRIMARY: i32 = -2147470133;
pub const EVENT_FRS_SYSVOL_READY: i32 = 1073755340;
pub const EVENT_FRS_VOLUME_NOT_SUPPORTED: i32 = -1073728317;
pub const EVENT_INVALID_DRIVER_DEPENDENCY: i32 = -1073734809;
pub const EVENT_IPX_CREATE_DEVICE: i32 = -1073732318;
pub const EVENT_IPX_ILLEGAL_CONFIG: i32 = -2147474145;
pub const EVENT_IPX_INTERNAL_NET_INVALID: i32 = -1073732320;
pub const EVENT_IPX_NEW_DEFAULT_TYPE: i32 = 1073751325;
pub const EVENT_IPX_NO_ADAPTERS: i32 = -1073732317;
pub const EVENT_IPX_NO_FRAME_TYPES: i32 = -1073732319;
pub const EVENT_IPX_SAP_ANNOUNCE: i32 = -2147474146;
pub const EVENT_NBT_BAD_BACKUP_WINS_ADDR: i32 = -2147479344;
pub const EVENT_NBT_BAD_PRIMARY_WINS_ADDR: i32 = -2147479343;
pub const EVENT_NBT_CREATE_ADDRESS: i32 = -1073737517;
pub const EVENT_NBT_CREATE_CONNECTION: i32 = -1073737516;
pub const EVENT_NBT_CREATE_DEVICE: i32 = 1073746135;
pub const EVENT_NBT_CREATE_DRIVER: i32 = -1073737524;
pub const EVENT_NBT_DUPLICATE_NAME: i32 = -1073737505;
pub const EVENT_NBT_DUPLICATE_NAME_ERROR: i32 = -1073737503;
pub const EVENT_NBT_NAME_RELEASE: i32 = -1073737504;
pub const EVENT_NBT_NAME_SERVER_ADDRS: i32 = -1073737518;
pub const EVENT_NBT_NON_OS_INIT: i32 = -1073737515;
pub const EVENT_NBT_NO_BACKUP_WINS: i32 = -2147479346;
pub const EVENT_NBT_NO_DEVICES: i32 = -2147479336;
pub const EVENT_NBT_NO_RESOURCES: i32 = -1073737502;
pub const EVENT_NBT_NO_WINS: i32 = -2147479345;
pub const EVENT_NBT_OPEN_REG_LINKAGE: i32 = -1073737511;
pub const EVENT_NBT_OPEN_REG_NAMESERVER: i32 = -2147479332;
pub const EVENT_NBT_OPEN_REG_PARAMS: i32 = -1073737523;
pub const EVENT_NBT_READ_BIND: i32 = -1073737510;
pub const EVENT_NBT_READ_EXPORT: i32 = -1073737509;
pub const EVENT_NBT_TIMERS: i32 = -1073737514;
pub const EVENT_NDIS_ADAPTER_CHECK_ERROR: i32 = -1073736793;
pub const EVENT_NDIS_ADAPTER_DISABLED: i32 = -2147478634;
pub const EVENT_NDIS_ADAPTER_NOT_FOUND: i32 = -1073736821;
pub const EVENT_NDIS_BAD_IO_BASE_ADDRESS: i32 = -1073736812;
pub const EVENT_NDIS_BAD_VERSION: i32 = -1073736818;
pub const EVENT_NDIS_CABLE_DISCONNECTED_ERROR: i32 = -2147478615;
pub const EVENT_NDIS_DMA_CONFLICT: i32 = -2147478629;
pub const EVENT_NDIS_DRIVER_FAILURE: i32 = -1073736819;
pub const EVENT_NDIS_HARDWARE_FAILURE: i32 = -1073736822;
pub const EVENT_NDIS_INTERRUPT_CONFLICT: i32 = -2147478630;
pub const EVENT_NDIS_INTERRUPT_CONNECT: i32 = -1073736820;
pub const EVENT_NDIS_INVALID_DOWNLOAD_FILE_ERROR: i32 = -1073736804;
pub const EVENT_NDIS_INVALID_VALUE_FROM_ADAPTER: i32 = -1073736814;
pub const EVENT_NDIS_IO_PORT_CONFLICT: i32 = -2147478633;
pub const EVENT_NDIS_LOBE_FAILUE_ERROR: i32 = -2147478621;
pub const EVENT_NDIS_MAXFRAMESIZE_ERROR: i32 = -2147478625;
pub const EVENT_NDIS_MAXINTERNALBUFS_ERROR: i32 = -2147478624;
pub const EVENT_NDIS_MAXMULTICAST_ERROR: i32 = -2147478623;
pub const EVENT_NDIS_MAXRECEIVES_ERROR: i32 = -2147478627;
pub const EVENT_NDIS_MAXTRANSMITS_ERROR: i32 = -2147478626;
pub const EVENT_NDIS_MEMORY_CONFLICT: i32 = -2147478631;
pub const EVENT_NDIS_MISSING_CONFIGURATION_PARAMETER: i32 = -1073736813;
pub const EVENT_NDIS_NETWORK_ADDRESS: i32 = -1073736816;
pub const EVENT_NDIS_OUT_OF_RESOURCE: i32 = -1073736823;
pub const EVENT_NDIS_PORT_OR_DMA_CONFLICT: i32 = -2147478632;
pub const EVENT_NDIS_PRODUCTID_ERROR: i32 = -2147478622;
pub const EVENT_NDIS_RECEIVE_SPACE_SMALL: i32 = 1073746837;
pub const EVENT_NDIS_REMOVE_RECEIVED_ERROR: i32 = -2147478619;
pub const EVENT_NDIS_RESET_FAILURE_CORRECTION: i32 = -2147478614;
pub const EVENT_NDIS_RESET_FAILURE_ERROR: i32 = -2147478616;
pub const EVENT_NDIS_RESOURCE_CONFLICT: i32 = -1073736824;
pub const EVENT_NDIS_SIGNAL_LOSS_ERROR: i32 = -2147478620;
pub const EVENT_NDIS_TIMEOUT: i32 = -2147478641;
pub const EVENT_NDIS_TOKEN_RING_CORRECTION: i32 = 1073746854;
pub const EVENT_NDIS_UNSUPPORTED_CONFIGURATION: i32 = -1073736815;
pub const EVENT_PS_ADMISSIONCONTROL_OVERFLOW: i32 = -2147469537;
pub const EVENT_PS_BAD_BESTEFFORT_LIMIT: i32 = -2147469548;
pub const EVENT_PS_BINDING_FAILED: i32 = -1073727720;
pub const EVENT_PS_GPC_REGISTER_FAILED: i32 = -1073727824;
pub const EVENT_PS_INIT_DEVICE_FAILED: i32 = -1073727717;
pub const EVENT_PS_MISSING_ADAPTER_REGISTRY_DATA: i32 = -1073727719;
pub const EVENT_PS_NETWORK_ADDRESS_FAIL: i32 = -1073727712;
pub const EVENT_PS_NO_RESOURCES_FOR_INIT: i32 = -1073727823;
pub const EVENT_PS_QUERY_OID_GEN_LINK_SPEED: i32 = -1073727721;
pub const EVENT_PS_QUERY_OID_GEN_MAXIMUM_FRAME_SIZE: i32 = -1073727723;
pub const EVENT_PS_QUERY_OID_GEN_MAXIMUM_TOTAL_SIZE: i32 = -1073727722;
pub const EVENT_PS_REGISTER_ADDRESS_FAMILY_FAILED: i32 = -1073727718;
pub const EVENT_PS_REGISTER_MINIPORT_FAILED: i32 = -1073727821;
pub const EVENT_PS_REGISTER_PROTOCOL_FAILED: i32 = -1073727822;
pub const EVENT_PS_RESOURCE_POOL: i32 = -1073727714;
pub const EVENT_PS_WAN_LIMITED_BESTEFFORT: i32 = -2147469539;
pub const EVENT_PS_WMI_INSTANCE_NAME_FAILED: i32 = -1073727716;
pub const EVENT_RDR_AT_THREAD_MAX: i32 = -2147480622;
pub const EVENT_RDR_CANT_BIND_TRANSPORT: i32 = -2147480616;
pub const EVENT_RDR_CANT_BUILD_SMB_HEADER: i32 = -2147480613;
pub const EVENT_RDR_CANT_CREATE_DEVICE: i32 = -2147480646;
pub const EVENT_RDR_CANT_CREATE_THREAD: i32 = -2147480645;
pub const EVENT_RDR_CANT_GET_SECURITY_CONTEXT: i32 = -2147480614;
pub const EVENT_RDR_CANT_READ_REGISTRY: i32 = -2147480621;
pub const EVENT_RDR_CANT_REGISTER_ADDRESS: i32 = -2147480615;
pub const EVENT_RDR_CANT_SET_THREAD: i32 = -2147480644;
pub const EVENT_RDR_CLOSE_BEHIND: i32 = -2147480637;
pub const EVENT_RDR_CONNECTION: i32 = -2147480629;
pub const EVENT_RDR_CONNECTION_REFERENCE: i32 = -2147480633;
pub const EVENT_RDR_CONTEXTS: i32 = -2147480624;
pub const EVENT_RDR_DELAYED_SET_ATTRIBUTES_FAILED: i32 = -2147480618;
pub const EVENT_RDR_DELETEONCLOSE_FAILED: i32 = -2147480617;
pub const EVENT_RDR_DISPOSITION: i32 = -2147480625;
pub const EVENT_RDR_ENCRYPT: i32 = -2147480630;
pub const EVENT_RDR_FAILED_UNLOCK: i32 = -2147480639;
pub const EVENT_RDR_INVALID_LOCK_REPLY: i32 = -2147480641;
pub const EVENT_RDR_INVALID_OPLOCK: i32 = -2147480634;
pub const EVENT_RDR_INVALID_REPLY: i32 = -2147480643;
pub const EVENT_RDR_INVALID_SMB: i32 = -2147480642;
pub const EVENT_RDR_MAXCMDS: i32 = -2147480627;
pub const EVENT_RDR_OPLOCK_SMB: i32 = -2147480626;
pub const EVENT_RDR_PRIMARY_TRANSPORT_CONNECT_FAILED: i32 = -2147480619;
pub const EVENT_RDR_RESOURCE_SHORTAGE: i32 = -2147480647;
pub const EVENT_RDR_SECURITY_SIGNATURE_MISMATCH: i32 = -2147480612;
pub const EVENT_RDR_SERVER_REFERENCE: i32 = -2147480632;
pub const EVENT_RDR_SMB_REFERENCE: i32 = -2147480631;
pub const EVENT_RDR_TIMEOUT: i32 = -2147480635;
pub const EVENT_RDR_TIMEZONE_BIAS_TOO_LARGE: i32 = -2147480620;
pub const EVENT_RDR_UNEXPECTED_ERROR: i32 = -2147480636;
pub const EVENT_RDR_WRITE_BEHIND_FLUSH_FAILED: i32 = -2147480623;
pub const EVENT_READFILE_TIMEOUT: i32 = -1073734814;
pub const EVENT_REVERTED_TO_LASTKNOWNGOOD: i32 = -1073734817;
pub const EVENT_RPCSS_ACTIVATION_ERROR: i32 = -1073731817;
pub const EVENT_RPCSS_CREATEDEBUGGERPROCESS_FAILURE: i32 = -1073731794;
pub const EVENT_RPCSS_CREATEPROCESS_FAILURE: i32 = -1073731824;
pub const EVENT_RPCSS_DEFAULT_LAUNCH_ACCESS_DENIED: i32 = -1073731821;
pub const EVENT_RPCSS_LAUNCH_ACCESS_DENIED: i32 = -1073731822;
pub const EVENT_RPCSS_REMOTE_SIDE_ERROR: i32 = -1073731818;
pub const EVENT_RPCSS_REMOTE_SIDE_ERROR_WITH_FILE: i32 = -1073731816;
pub const EVENT_RPCSS_REMOTE_SIDE_UNAVAILABLE: i32 = -1073731815;
pub const EVENT_RPCSS_RUNAS_CANT_LOGIN: i32 = -1073731820;
pub const EVENT_RPCSS_RUNAS_CREATEPROCESS_FAILURE: i32 = -1073731823;
pub const EVENT_RPCSS_SERVER_NOT_RESPONDING: i32 = -1073731813;
pub const EVENT_RPCSS_SERVER_START_TIMEOUT: i32 = -1073731814;
pub const EVENT_RPCSS_START_SERVICE_FAILURE: i32 = -1073731819;
pub const EVENT_RPCSS_STOP_SERVICE_FAILURE: i32 = -1073731795;
pub const EVENT_RUNNING_LASTKNOWNGOOD: i32 = -1073734797;
pub const EVENT_SCOPE_LABEL_TOO_LONG: i32 = -2147479331;
pub const EVENT_SCOPE_TOO_LONG: i32 = -2147479330;
pub const EVENT_SECOND_LOGON_FAILED: i32 = -1073734810;
pub const EVENT_SERVICE_CONFIG_BACKOUT_FAILED: i32 = -1073734787;
pub const EVENT_SERVICE_CONTROL_SUCCESS: i32 = 1073748859;
pub const EVENT_SERVICE_CRASH: i32 = -1073734793;
pub const EVENT_SERVICE_CRASH_NO_ACTION: i32 = -1073734790;
pub const EVENT_SERVICE_DIFFERENT_PID_CONNECTED: i32 = -2147476609;
pub const EVENT_SERVICE_EXIT_FAILED: i32 = -1073734801;
pub const EVENT_SERVICE_EXIT_FAILED_SPECIFIC: i32 = -1073734800;
pub const EVENT_SERVICE_LOGON_TYPE_NOT_GRANTED: i32 = -1073734783;
pub const EVENT_SERVICE_NOT_INTERACTIVE: i32 = -1073734794;
pub const EVENT_SERVICE_RECOVERY_FAILED: i32 = -1073734792;
pub const EVENT_SERVICE_SCESRV_FAILED: i32 = -1073734791;
pub const EVENT_SERVICE_SHUTDOWN_FAILED: i32 = -1073734781;
pub const EVENT_SERVICE_START_AT_BOOT_FAILED: i32 = -1073734799;
pub const EVENT_SERVICE_START_FAILED: i32 = -1073734824;
pub const EVENT_SERVICE_START_FAILED_GROUP: i32 = -1073734822;
pub const EVENT_SERVICE_START_FAILED_II: i32 = -1073734823;
pub const EVENT_SERVICE_START_FAILED_NONE: i32 = -1073734821;
pub const EVENT_SERVICE_START_HUNG: i32 = -1073734802;
pub const EVENT_SERVICE_START_TYPE_CHANGED: i32 = 1073748864;
pub const EVENT_SERVICE_STATUS_SUCCESS: i32 = 1073748860;
pub const EVENT_SERVICE_STOP_SUCCESS_WITH_REASON: i32 = 1073748866;
pub const EVENT_SEVERE_SERVICE_FAILED: i32 = -1073734803;
pub const EVENT_SRV_CANT_BIND_DUP_NAME: i32 = -1073739319;
pub const EVENT_SRV_CANT_BIND_TO_TRANSPORT: i32 = -2147481144;
pub const EVENT_SRV_CANT_CHANGE_DOMAIN_NAME: i32 = -2147481136;
pub const EVENT_SRV_CANT_CREATE_DEVICE: i32 = -1073739822;
pub const EVENT_SRV_CANT_CREATE_PROCESS: i32 = -1073739821;
pub const EVENT_SRV_CANT_CREATE_THREAD: i32 = -1073739820;
pub const EVENT_SRV_CANT_GROW_TABLE: i32 = -2147481639;
pub const EVENT_SRV_CANT_LOAD_DRIVER: i32 = -2147481140;
pub const EVENT_SRV_CANT_MAP_ERROR: i32 = -2147481138;
pub const EVENT_SRV_CANT_OPEN_NPFS: i32 = -1073739817;
pub const EVENT_SRV_CANT_RECREATE_SHARE: i32 = -2147481137;
pub const EVENT_SRV_CANT_START_SCAVENGER: i32 = -1073739814;
pub const EVENT_SRV_CANT_UNLOAD_DRIVER: i32 = -2147481139;
pub const EVENT_SRV_DISK_FULL: i32 = -2147481635;
pub const EVENT_SRV_DOS_ATTACK_DETECTED: i32 = -2147481623;
pub const EVENT_SRV_INVALID_REGISTRY_VALUE: i32 = -2147481142;
pub const EVENT_SRV_INVALID_REQUEST: i32 = -1073739818;
pub const EVENT_SRV_INVALID_SD: i32 = -2147481141;
pub const EVENT_SRV_IRP_STACK_SIZE: i32 = -1073739813;
pub const EVENT_SRV_KEY_NOT_CREATED: i32 = -1073739322;
pub const EVENT_SRV_KEY_NOT_FOUND: i32 = -1073739323;
pub const EVENT_SRV_NETWORK_ERROR: i32 = -2147481636;
pub const EVENT_SRV_NONPAGED_POOL_LIMIT: i32 = -1073739807;
pub const EVENT_SRV_NO_BLOCKING_IO: i32 = -2147481624;
pub const EVENT_SRV_NO_FREE_CONNECTIONS: i32 = -2147481626;
pub const EVENT_SRV_NO_FREE_RAW_WORK_ITEM: i32 = -2147481625;
pub const EVENT_SRV_NO_NONPAGED_POOL: i32 = -1073739805;
pub const EVENT_SRV_NO_PAGED_POOL: i32 = -1073739804;
pub const EVENT_SRV_NO_TRANSPORTS_BOUND: i32 = -1073739321;
pub const EVENT_SRV_NO_VIRTUAL_MEMORY: i32 = -1073739808;
pub const EVENT_SRV_NO_WORK_ITEM: i32 = -2147481627;
pub const EVENT_SRV_OUT_OF_WORK_ITEM_DOS: i32 = -2147481621;
pub const EVENT_SRV_PAGED_POOL_LIMIT: i32 = -1073739806;
pub const EVENT_SRV_RESOURCE_SHORTAGE: i32 = -1073739823;
pub const EVENT_SRV_SERVICE_FAILED: i32 = -1073739824;
pub const EVENT_SRV_TOO_MANY_DOS: i32 = -2147481622;
pub const EVENT_SRV_TXF_INIT_FAILED: i32 = -2147481135;
pub const EVENT_SRV_UNEXPECTED_DISC: i32 = -1073739819;
pub const EVENT_STREAMS_ALLOCB_FAILURE: i32 = -2147479647;
pub const EVENT_STREAMS_ALLOCB_FAILURE_CNT: i32 = -2147479646;
pub const EVENT_STREAMS_ESBALLOC_FAILURE: i32 = -2147479645;
pub const EVENT_STREAMS_ESBALLOC_FAILURE_CNT: i32 = -2147479644;
pub const EVENT_STREAMS_STRLOG: i32 = -1073737824;
pub const EVENT_TAKE_OWNERSHIP: i32 = -1073734796;
pub const EVENT_TCPIP6_STARTED: i32 = 1073744924;
pub const EVENT_TCPIP_ADAPTER_REG_FAILURE: i32 = -1073737633;
pub const EVENT_TCPIP_ADDRESS_CONFLICT1: i32 = -1073737626;
pub const EVENT_TCPIP_ADDRESS_CONFLICT2: i32 = -1073737625;
pub const EVENT_TCPIP_AUTOCONFIGURED_ADDRESS_LIMIT_REACHED: i32 = -2147479444;
pub const EVENT_TCPIP_AUTOCONFIGURED_ROUTE_LIMIT_REACHED: i32 = -2147479443;
pub const EVENT_TCPIP_CREATE_DEVICE_FAILED: i32 = -1073737724;
pub const EVENT_TCPIP_DHCP_INIT_FAILED: i32 = -2147479458;
pub const EVENT_TCPIP_INTERFACE_BIND_FAILURE: i32 = -1073737617;
pub const EVENT_TCPIP_INVALID_ADDRESS: i32 = -1073737637;
pub const EVENT_TCPIP_INVALID_DEFAULT_GATEWAY: i32 = -2147479456;
pub const EVENT_TCPIP_INVALID_MASK: i32 = -1073737636;
pub const EVENT_TCPIP_IPV4_UNINSTALLED: i32 = 1073746027;
pub const EVENT_TCPIP_IP_INIT_FAILED: i32 = -1073737628;
pub const EVENT_TCPIP_MEDIA_CONNECT: i32 = 1073746025;
pub const EVENT_TCPIP_MEDIA_DISCONNECT: i32 = 1073746026;
pub const EVENT_TCPIP_NO_ADAPTER_RESOURCES: i32 = -1073737635;
pub const EVENT_TCPIP_NO_ADDRESS_LIST: i32 = -1073737631;
pub const EVENT_TCPIP_NO_BINDINGS: i32 = -1073737629;
pub const EVENT_TCPIP_NO_MASK: i32 = -1073737638;
pub const EVENT_TCPIP_NO_MASK_LIST: i32 = -1073737630;
pub const EVENT_TCPIP_NO_RESOURCES_FOR_INIT: i32 = -1073737723;
pub const EVENT_TCPIP_NTE_CONTEXT_LIST_FAILURE: i32 = -1073737624;
pub const EVENT_TCPIP_OUT_OF_ORDER_FRAGMENTS_EXCEEDED: i32 = -2147479442;
pub const EVENT_TCPIP_PCF_CLEAR_FILTER_FAILURE: i32 = -1073737530;
pub const EVENT_TCPIP_PCF_MISSING_CAPABILITY: i32 = -2147479357;
pub const EVENT_TCPIP_PCF_MULTICAST_OID_ISSUE: i32 = -2147479358;
pub const EVENT_TCPIP_PCF_NO_ARP_FILTER: i32 = -2147479355;
pub const EVENT_TCPIP_PCF_SET_FILTER_FAILURE: i32 = -2147479356;
pub const EVENT_TCPIP_TCP_CONNECTIONS_PERF_IMPACTED: i32 = -2147479418;
pub const EVENT_TCPIP_TCP_CONNECT_LIMIT_REACHED: i32 = -2147479422;
pub const EVENT_TCPIP_TCP_GLOBAL_EPHEMERAL_PORT_SPACE_EXHAUSTED: i32 = -2147479417;
pub const EVENT_TCPIP_TCP_INIT_FAILED: i32 = -1073737599;
pub const EVENT_TCPIP_TCP_MPP_ATTACKS_DETECTED: i32 = -2147479419;
pub const EVENT_TCPIP_TCP_TIME_WAIT_COLLISION: i32 = -2147479421;
pub const EVENT_TCPIP_TCP_WSD_WS_RESTRICTED: i32 = -2147479420;
pub const EVENT_TCPIP_TOO_MANY_GATEWAYS: i32 = -2147479451;
pub const EVENT_TCPIP_TOO_MANY_NETS: i32 = -1073737639;
pub const EVENT_TCPIP_UDP_GLOBAL_EPHEMERAL_PORT_SPACE_EXHAUSTED: i32 = -2147479382;
pub const EVENT_TCPIP_UDP_LIMIT_REACHED: i32 = -2147479383;
pub const EVENT_TRANSACT_INVALID: i32 = -1073734812;
pub const EVENT_TRANSACT_TIMEOUT: i32 = -1073734813;
pub const EVENT_TRANSPORT_ADAPTER_NOT_FOUND: i32 = -1073732818;
pub const EVENT_TRANSPORT_BAD_PROTOCOL: i32 = 1073750835;
pub const EVENT_TRANSPORT_BINDING_FAILED: i32 = -1073732819;
pub const EVENT_TRANSPORT_QUERY_OID_FAILED: i32 = -1073732816;
pub const EVENT_TRANSPORT_REGISTER_FAILED: i32 = -1073732820;
pub const EVENT_TRANSPORT_RESOURCE_LIMIT: i32 = -2147474646;
pub const EVENT_TRANSPORT_RESOURCE_POOL: i32 = -2147474647;
pub const EVENT_TRANSPORT_RESOURCE_SPECIFIC: i32 = -2147474645;
pub const EVENT_TRANSPORT_SET_OID_FAILED: i32 = -1073732817;
pub const EVENT_TRANSPORT_TOO_MANY_LINKS: i32 = 1073750834;
pub const EVENT_TRANSPORT_TRANSFER_DATA: i32 = 1073750833;
pub const EVENT_TRK_INTERNAL_ERROR: i32 = -1073729324;
pub const EVENT_TRK_SERVICE_CORRUPT_LOG: i32 = -1073729321;
pub const EVENT_TRK_SERVICE_DUPLICATE_VOLIDS: i32 = 1073754331;
pub const EVENT_TRK_SERVICE_MOVE_QUOTA_EXCEEDED: i32 = -2147471140;
pub const EVENT_TRK_SERVICE_START_FAILURE: i32 = -1073729322;
pub const EVENT_TRK_SERVICE_START_SUCCESS: i32 = 1073754325;
pub const EVENT_TRK_SERVICE_VOLUME_CLAIM: i32 = 1073754330;
pub const EVENT_TRK_SERVICE_VOLUME_CREATE: i32 = 1073754329;
pub const EVENT_TRK_SERVICE_VOL_QUOTA_EXCEEDED: i32 = -2147471144;
pub const EVENT_UP_DRIVER_ON_MP: i32 = -1073735724;
pub const EVENT_WEBCLIENT_CLOSE_DELETE_FAILED: i32 = -2147468746;
pub const EVENT_WEBCLIENT_CLOSE_PROPPATCH_FAILED: i32 = -2147468745;
pub const EVENT_WEBCLIENT_CLOSE_PUT_FAILED: i32 = -2147468747;
pub const EVENT_WEBCLIENT_SETINFO_PROPPATCH_FAILED: i32 = -2147468744;
pub const EVENT_WINNAT_SESSION_LIMIT_REACHED: i32 = -2147466648;
pub const EVENT_WINSOCK_CLOSESOCKET_STUCK: i32 = -2147467646;
pub const EVENT_WINSOCK_TDI_FILTER_DETECTED: i32 = -2147467647;
pub const EVENT_WSK_OWNINGTHREAD_PARAMETER_IGNORED: i32 = -1073725824;
pub const EVLEN: u32 = 16;
pub const EXTRA_EXIT_POINT: i32 = -1073727524;
pub const EXTRA_EXIT_POINT_DELETED: i32 = -1073727520;
pub const EXTRA_EXIT_POINT_NOT_DELETED: i32 = -1073727519;
pub const EXTRA_VOLUME: i32 = -1073727521;
pub const EXTRA_VOLUME_DELETED: i32 = -1073727514;
pub const EXTRA_VOLUME_NOT_DELETED: i32 = -1073727513;
pub const FILTER_INTERDOMAIN_TRUST_ACCOUNT: NET_USER_ENUM_FILTER_FLAGS = NET_USER_ENUM_FILTER_FLAGS(8);
pub const FILTER_NORMAL_ACCOUNT: NET_USER_ENUM_FILTER_FLAGS = NET_USER_ENUM_FILTER_FLAGS(2);
pub const FILTER_SERVER_TRUST_ACCOUNT: NET_USER_ENUM_FILTER_FLAGS = NET_USER_ENUM_FILTER_FLAGS(32);
pub const FILTER_TEMP_DUPLICATE_ACCOUNT: NET_USER_ENUM_FILTER_FLAGS = NET_USER_ENUM_FILTER_FLAGS(1);
pub const FILTER_WORKSTATION_TRUST_ACCOUNT: NET_USER_ENUM_FILTER_FLAGS = NET_USER_ENUM_FILTER_FLAGS(16);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const GroupManagedServiceAccount: MSA_INFO_ACCOUNT_TYPE = MSA_INFO_ACCOUNT_TYPE(2);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const HARDWARE_ADDRESS_LENGTH: u32 = 6;
...
pub const INTERFACE_INFO_REVISION_1: u32 = 1;
pub const INVALID_TRACEID: u32 = 4294967295;
...
pub trait INetCfg_Impl: windows_core::IUnknownImpl {
    ...
    fn EnumComponents(&self, pguidclass: *const windows_core::GUID, ppenumcomponent: windows_core::OutRef<IEnumNetCfgComponent>) -> windows_core::Result<()>;
    fn FindComponent(&self, pszwinfid: &windows_core::PCWSTR, pcomponent: windows_core::OutRef<INetCfgComponent>) -> windows_core::Result<()>;
...
pub trait INetCfgBindingInterface_Impl: windows_core::IUnknownImpl {
    ...
    fn GetUpperComponent(&self, ppnccitem: windows_core::OutRef<INetCfgComponent>) -> windows_core::Result<()>;
    fn GetLowerComponent(&self, ppnccitem: windows_core::OutRef<INetCfgComponent>) -> windows_core::Result<()>;
}
...
pub trait INetCfgBindingPath_Impl: windows_core::IUnknownImpl {
    ...
    fn GetOwner(&self, ppcomponent: windows_core::OutRef<INetCfgComponent>) -> windows_core::Result<()>;
    fn GetDepth(&self) -> windows_core::Result<u32>;
    fn EnumBindingInterfaces(&self, ppenuminterface: windows_core::OutRef<IEnumNetCfgBindingInterface>) -> windows_core::Result<()>;
}
...
pub trait INetCfgClass_Impl: windows_core::IUnknownImpl {
    fn FindComponent(&self, pszwinfid: &windows_core::PCWSTR, ppnccitem: windows_core::OutRef<INetCfgComponent>) -> windows_core::Result<()>;
    fn EnumComponents(&self, ppenumcomponent: windows_core::OutRef<IEnumNetCfgComponent>) -> windows_core::Result<()>;
}
...
pub const IPX_PROTOCOL_BASE: u32 = 131071;
pub const IPX_PROTOCOL_RIP: u32 = 131072;
...
impl IProvisioningProfileWireless {
    pub unsafe fn CreateProfile(&self, bstrxmlwirelessconfigprofile: &windows_core::BSTR, bstrxmlconnectionconfigprofile: &windows_core::BSTR, padapterinstanceguid: *const windows_core::GUID) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateProfile)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(bstrxmlwirelessconfigprofile), core::mem::transmute_copy(bstrxmlconnectionconfigprofile), padapterinstanceguid, &mut result__).map(|| result__)
        }
    }
}
#[repr(C)]
...
pub const IR_PROMISCUOUS: u32 = 0;
pub const IR_PROMISCUOUS_MULTICAST: u32 = 1;
...
pub const KNOWLEDGE_INCONSISTENCY_DETECTED: i32 = -1073727511;
...
pub const LM_REDIR_FAILURE: i32 = 1073756225;
...
pub const LOGFLAGS_BACKWARD: u32 = 1;
pub const LOGFLAGS_FORWARD: u32 = 0;
pub const LOGFLAGS_SEEK: u32 = 2;
pub const LOWER_GET_HINT_MASK: u32 = 65280;
pub const LOWER_HINT_MASK: u32 = 255;
pub const MACHINE_UNJOINED: i32 = -1073727507;
...
pub const MAX_NERR: u32 = 2999;
pub const MAX_PASSWD_LEN: u32 = 256;
pub const MAX_PREFERRED_LENGTH: u32 = 4294967295;
pub const MAX_PROTOCOL_DLL_LEN: u32 = 48;
pub const MAX_PROTOCOL_NAME_LEN: u32 = 40;
pub const MESSAGE_FILENAME: windows_core::PCWSTR = windows_core::w!("NETMSG");
pub const MFE_BOUNDARY_REACHED: u32 = 6;
pub const MFE_IIF: u32 = 8;
pub const MFE_NOT_FORWARDING: u32 = 2;
pub const MFE_NOT_LAST_HOP: u32 = 10;
pub const MFE_NO_ERROR: u32 = 0;
pub const MFE_NO_MULTICAST: u32 = 7;
pub const MFE_NO_ROUTE: u32 = 9;
pub const MFE_NO_SPACE: u32 = 13;
pub const MFE_OIF_PRUNED: u32 = 5;
pub const MFE_OLD_ROUTER: u32 = 11;
pub const MFE_PROHIBITED: u32 = 12;
pub const MFE_PRUNED_UPSTREAM: u32 = 4;
pub const MFE_REACHED_CORE: u32 = 1;
pub const MFE_WRONG_IF: u32 = 3;
pub const MIN_LANMAN_MESSAGE_ID: u32 = 2100;
pub const MISSING_EXIT_POINT: i32 = -1073727523;
pub const MISSING_EXIT_POINT_CREATED: i32 = -1073727518;
pub const MISSING_EXIT_POINT_NOT_CREATED: i32 = -1073727517;
pub const MISSING_VOLUME: i32 = -1073727522;
pub const MISSING_VOLUME_CREATED: i32 = -1073727516;
pub const MISSING_VOLUME_NOT_CREATED: i32 = -1073727515;
...
pub const MRINFO_DISABLED_FLAG: u32 = 32;
pub const MRINFO_DOWN_FLAG: u32 = 16;
pub const MRINFO_LEAF_FLAG: u32 = 128;
pub const MRINFO_PIM_FLAG: u32 = 4;
pub const MRINFO_QUERIER_FLAG: u32 = 64;
pub const MRINFO_TUNNEL_FLAG: u32 = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const MS_ROUTER_VERSION: u32 = 1536;
pub const MsaAccountFalse: MSA_INFO_ACCOUNT_TYPE = MSA_INFO_ACCOUNT_TYPE(0);
pub const MsaInfoCanInstall: MSA_INFO_STATE = MSA_INFO_STATE(4);
pub const MsaInfoCannotInstall: MSA_INFO_STATE = MSA_INFO_STATE(3);
pub const MsaInfoInstalled: MSA_INFO_STATE = MSA_INFO_STATE(5);
pub const MsaInfoLevel0: MSA_INFO_LEVEL = MSA_INFO_LEVEL(0);
pub const MsaInfoLevel1: MSA_INFO_LEVEL = MSA_INFO_LEVEL(1);
pub const MsaInfoLevelMax: MSA_INFO_LEVEL = MSA_INFO_LEVEL(2);
pub const MsaInfoNotExist: MSA_INFO_STATE = MSA_INFO_STATE(1);
pub const MsaInfoNotService: MSA_INFO_STATE = MSA_INFO_STATE(2);
pub const NCF_DONTEXPOSELOWER: COMPONENT_CHARACTERISTICS = COMPONENT_CHARACTERISTICS(4096);
pub const NCF_FILTER: COMPONENT_CHARACTERISTICS = COMPONENT_CHARACTERISTICS(1024);
pub const NCF_FIXED_BINDING: COMPONENT_CHARACTERISTICS = COMPONENT_CHARACTERISTICS(131072);
pub const NCF_HAS_UI: COMPONENT_CHARACTERISTICS = COMPONENT_CHARACTERISTICS(128);
pub const NCF_HIDDEN: COMPONENT_CHARACTERISTICS = COMPONENT_CHARACTERISTICS(8);
pub const NCF_HIDE_BINDING: COMPONENT_CHARACTERISTICS = COMPONENT_CHARACTERISTICS(8192);
pub const NCF_LOWER: SUPPORTS_BINDING_INTERFACE_FLAGS = SUPPORTS_BINDING_INTERFACE_FLAGS(1);
pub const NCF_LW_FILTER: COMPONENT_CHARACTERISTICS = COMPONENT_CHARACTERISTICS(262144);
pub const NCF_MULTIPORT_INSTANCED_ADAPTER: COMPONENT_CHARACTERISTICS = COMPONENT_CHARACTERISTICS(64);
pub const NCF_NDIS_PROTOCOL: COMPONENT_CHARACTERISTICS = COMPONENT_CHARACTERISTICS(16384);
pub const NCF_NOT_USER_REMOVABLE: COMPONENT_CHARACTERISTICS = COMPONENT_CHARACTERISTICS(32);
pub const NCF_NO_SERVICE: COMPONENT_CHARACTERISTICS = COMPONENT_CHARACTERISTICS(16);
pub const NCF_PHYSICAL: COMPONENT_CHARACTERISTICS = COMPONENT_CHARACTERISTICS(4);
pub const NCF_SINGLE_INSTANCE: COMPONENT_CHARACTERISTICS = COMPONENT_CHARACTERISTICS(256);
pub const NCF_SOFTWARE_ENUMERATED: COMPONENT_CHARACTERISTICS = COMPONENT_CHARACTERISTICS(2);
pub const NCF_UPPER: SUPPORTS_BINDING_INTERFACE_FLAGS = SUPPORTS_BINDING_INTERFACE_FLAGS(2);
pub const NCF_VIRTUAL: COMPONENT_CHARACTERISTICS = COMPONENT_CHARACTERISTICS(1);
pub const NCN_ADD: BIND_FLAGS1 = BIND_FLAGS1(1);
pub const NCN_BINDING_PATH: BIND_FLAGS1 = BIND_FLAGS1(256);
pub const NCN_DISABLE: BIND_FLAGS1 = BIND_FLAGS1(32);
pub const NCN_ENABLE: BIND_FLAGS1 = BIND_FLAGS1(16);
pub const NCN_NET: BIND_FLAGS1 = BIND_FLAGS1(65536);
pub const NCN_NETCLIENT: BIND_FLAGS1 = BIND_FLAGS1(262144);
pub const NCN_NETSERVICE: BIND_FLAGS1 = BIND_FLAGS1(524288);
pub const NCN_NETTRANS: BIND_FLAGS1 = BIND_FLAGS1(131072);
pub const NCN_PROPERTYCHANGE: BIND_FLAGS1 = BIND_FLAGS1(512);
pub const NCN_REMOVE: BIND_FLAGS1 = BIND_FLAGS1(2);
pub const NCN_UPDATE: BIND_FLAGS1 = BIND_FLAGS1(4);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NCPNP_RECONFIG_LAYER(pub i32);
pub const NCRL_NDIS: NCPNP_RECONFIG_LAYER = NCPNP_RECONFIG_LAYER(1);
pub const NCRL_TDI: NCPNP_RECONFIG_LAYER = NCPNP_RECONFIG_LAYER(2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NCRP_FLAGS(pub i32);
pub const NCRP_QUERY_PROPERTY_UI: NCRP_FLAGS = NCRP_FLAGS(1);
pub const NCRP_SHOW_PROPERTY_UI: NCRP_FLAGS = NCRP_FLAGS(2);
pub const NELOG_AT_Exec_Err: u32 = 3178;
pub const NELOG_AT_cannot_read: u32 = 3174;
pub const NELOG_AT_cannot_write: u32 = 3129;
pub const NELOG_AT_sched_err: u32 = 3175;
pub const NELOG_AT_schedule_file_created: u32 = 3176;
pub const NELOG_Access_File_Bad: u32 = 3122;
pub const NELOG_Build_Name: u32 = 3170;
pub const NELOG_Cant_Make_Msg_File: u32 = 3130;
pub const NELOG_DiskFT: u32 = 3221;
pub const NELOG_DriverNotLoaded: u32 = 5727;
pub const NELOG_Entries_Lost: u32 = 3114;
pub const NELOG_Error_in_DLL: u32 = 3256;
pub const NELOG_Exec_Netservr_NoMem: u32 = 3131;
pub const NELOG_FT_ErrLog_Too_Large: u32 = 3258;
pub const NELOG_FT_Update_In_Progress: u32 = 3259;
pub const NELOG_FailedToGetComputerName: u32 = 5726;
pub const NELOG_FailedToRegisterSC: u32 = 5724;
pub const NELOG_FailedToSetServiceStatus: u32 = 5725;
pub const NELOG_File_Changed: u32 = 3253;
pub const NELOG_Files_Dont_Fit: u32 = 3254;
pub const NELOG_HardErr_From_Server: u32 = 3182;
pub const NELOG_HotFix: u32 = 3181;
pub const NELOG_Init_Chardev_Err: u32 = 3124;
pub const NELOG_Init_Exec_Fail: u32 = 3105;
pub const NELOG_Init_OpenCreate_Err: u32 = 3110;
pub const NELOG_Init_Seg_Overflow: u32 = 3120;
pub const NELOG_Internal_Error: u32 = 3100;
pub const NELOG_Invalid_Config_File: u32 = 3252;
pub const NELOG_Invalid_Config_Line: u32 = 3251;
pub const NELOG_Ioctl_Error: u32 = 3108;
pub const NELOG_Joined_Domain: u32 = 3260;
pub const NELOG_Joined_Workgroup: u32 = 3261;
pub const NELOG_Lazy_Write_Err: u32 = 3180;
pub const NELOG_LocalSecFail1: u32 = 3183;
pub const NELOG_LocalSecFail2: u32 = 3184;
pub const NELOG_LocalSecFail3: u32 = 3185;
pub const NELOG_LocalSecGeneralFail: u32 = 3186;
pub const NELOG_Mail_Slt_Err: u32 = 3173;
pub const NELOG_Mailslot_err: u32 = 3127;
pub const NELOG_Message_Send: u32 = 3172;
pub const NELOG_Missing_Parameter: u32 = 3250;
pub const NELOG_Msg_Log_Err: u32 = 3150;
pub const NELOG_Msg_Sem_Shutdown: u32 = 3141;
pub const NELOG_Msg_Shutdown: u32 = 3140;
pub const NELOG_Msg_Unexpected_SMB_Type: u32 = 3152;
pub const NELOG_Name_Expansion: u32 = 3171;
pub const NELOG_Ncb_Error: u32 = 3106;
pub const NELOG_Ncb_TooManyErr: u32 = 3126;
pub const NELOG_NetBios: u32 = 3111;
pub const NELOG_NetLogonFailedToInitializeAuthzRm: u32 = 5821;
pub const NELOG_NetLogonFailedToInitializeRPCSD: u32 = 5822;
pub const NELOG_NetWkSta_Internal_Error: u32 = 3190;
pub const NELOG_NetWkSta_NCB_Err: u32 = 3195;
pub const NELOG_NetWkSta_No_Resource: u32 = 3191;
pub const NELOG_NetWkSta_Reset_Err: u32 = 3197;
pub const NELOG_NetWkSta_SMB_Err: u32 = 3192;
pub const NELOG_NetWkSta_Stuck_VC_Err: u32 = 3194;
pub const NELOG_NetWkSta_Too_Many: u32 = 3198;
pub const NELOG_NetWkSta_VC_Err: u32 = 3193;
pub const NELOG_NetWkSta_Write_Behind_Err: u32 = 3196;
pub const NELOG_Net_Not_Started: u32 = 3107;
pub const NELOG_NetlogonAddNameFailure: u32 = 5741;
pub const NELOG_NetlogonAuthDCFail: u32 = 3210;
pub const NELOG_NetlogonAuthDomainDowngraded: u32 = 5791;
pub const NELOG_NetlogonAuthNoDomainController: u32 = 5719;
pub const NELOG_NetlogonAuthNoTrustLsaSecret: u32 = 5720;
pub const NELOG_NetlogonAuthNoTrustSamAccount: u32 = 5721;
pub const NELOG_NetlogonAuthNoUplevelDomainController: u32 = 5790;
pub const NELOG_NetlogonBadSiteName: u32 = 5779;
pub const NELOG_NetlogonBadSubnetName: u32 = 5780;
pub const NELOG_NetlogonBrowserDriver: u32 = 5740;
pub const NELOG_NetlogonChangeLogCorrupt: u32 = 5705;
pub const NELOG_NetlogonDcOldSiteCovered: u32 = 5794;
pub const NELOG_NetlogonDcSiteCovered: u32 = 5784;
pub const NELOG_NetlogonDcSiteNotCovered: u32 = 5785;
pub const NELOG_NetlogonDcSiteNotCoveredAuto: u32 = 5795;
pub const NELOG_NetlogonDnsDeregAborted: u32 = 5808;
pub const NELOG_NetlogonDnsHostNameLowerCasingFailed: u32 = 5825;
pub const NELOG_NetlogonDownLevelLogoffFailed: u32 = 5708;
pub const NELOG_NetlogonDownLevelLogonFailed: u32 = 5707;
pub const NELOG_NetlogonDuplicateMachineAccounts: u32 = 5738;
pub const NELOG_NetlogonDynamicDnsDeregisterFailure: u32 = 5775;
pub const NELOG_NetlogonDynamicDnsFailure: u32 = 5782;
pub const NELOG_NetlogonDynamicDnsRegisterFailure: u32 = 5774;
pub const NELOG_NetlogonDynamicDnsServerFailure: u32 = 5781;
pub const NELOG_NetlogonFailedAccountDelta: u32 = 5735;
pub const NELOG_NetlogonFailedDnsHostNameUpdate: u32 = 5789;
pub const NELOG_NetlogonFailedDomainDelta: u32 = 5729;
pub const NELOG_NetlogonFailedFileCreate: u32 = 5776;
pub const NELOG_NetlogonFailedGlobalGroupDelta: u32 = 5730;
pub const NELOG_NetlogonFailedLocalGroupDelta: u32 = 5731;
pub const NELOG_NetlogonFailedPolicyDelta: u32 = 5733;
pub const NELOG_NetlogonFailedPrimary: u32 = 3223;
pub const NELOG_NetlogonFailedSecretDelta: u32 = 5736;
pub const NELOG_NetlogonFailedSpnUpdate: u32 = 5788;
pub const NELOG_NetlogonFailedToAddAuthzRpcInterface: u32 = 5820;
pub const NELOG_NetlogonFailedToAddRpcInterface: u32 = 5702;
pub const NELOG_NetlogonFailedToCreateShare: u32 = 5706;
pub const NELOG_NetlogonFailedToReadMailslot: u32 = 5703;
pub const NELOG_NetlogonFailedToRegisterSC: u32 = 5704;
pub const NELOG_NetlogonFailedToUpdateTrustList: u32 = 5701;
pub const NELOG_NetlogonFailedTrustedDomainDelta: u32 = 5734;
pub const NELOG_NetlogonFailedUserDelta: u32 = 5732;
pub const NELOG_NetlogonFullSyncCallFailed: u32 = 5714;
pub const NELOG_NetlogonFullSyncCallSuccess: u32 = 5713;
pub const NELOG_NetlogonFullSyncFailed: u32 = 5718;
pub const NELOG_NetlogonFullSyncSuccess: u32 = 5717;
pub const NELOG_NetlogonGcOldSiteCovered: u32 = 5796;
pub const NELOG_NetlogonGcSiteCovered: u32 = 5786;
pub const NELOG_NetlogonGcSiteNotCovered: u32 = 5787;
pub const NELOG_NetlogonGcSiteNotCoveredAuto: u32 = 5797;
pub const NELOG_NetlogonGetSubnetToSite: u32 = 5777;
pub const NELOG_NetlogonInvalidDwordParameterValue: u32 = 5804;
pub const NELOG_NetlogonInvalidGenericParameterValue: u32 = 5803;
pub const NELOG_NetlogonLanmanBdcsNotAllowed: u32 = 5772;
pub const NELOG_NetlogonMachinePasswdSetSucceeded: u32 = 5823;
pub const NELOG_NetlogonMsaPasswdSetSucceeded: u32 = 5824;
pub const NELOG_NetlogonNTLogoffFailed: u32 = 5710;
pub const NELOG_NetlogonNTLogonFailed: u32 = 5709;
pub const NELOG_NetlogonNdncOldSiteCovered: u32 = 5798;
pub const NELOG_NetlogonNdncSiteCovered: u32 = 5792;
pub const NELOG_NetlogonNdncSiteNotCovered: u32 = 5793;
pub const NELOG_NetlogonNdncSiteNotCoveredAuto: u32 = 5799;
pub const NELOG_NetlogonNoAddressToSiteMapping: u32 = 5802;
pub const NELOG_NetlogonNoDynamicDns: u32 = 5773;
pub const NELOG_NetlogonNoDynamicDnsManual: u32 = 5806;
pub const NELOG_NetlogonNoSiteForClient: u32 = 5778;
pub const NELOG_NetlogonNoSiteForClients: u32 = 5807;
pub const NELOG_NetlogonPartialSiteMappingForClients: u32 = 5810;
pub const NELOG_NetlogonPartialSyncCallFailed: u32 = 5712;
pub const NELOG_NetlogonPartialSyncCallSuccess: u32 = 5711;
pub const NELOG_NetlogonPartialSyncFailed: u32 = 5716;
pub const NELOG_NetlogonPartialSyncSuccess: u32 = 5715;
pub const NELOG_NetlogonPasswdSetFailed: u32 = 3224;
pub const NELOG_NetlogonRejectedRemoteDynamicDnsDeregister: u32 = 5814;
pub const NELOG_NetlogonRejectedRemoteDynamicDnsRegister: u32 = 5813;
pub const NELOG_NetlogonRemoteDynamicDnsDeregisterFailure: u32 = 5812;
pub const NELOG_NetlogonRemoteDynamicDnsRegisterFailure: u32 = 5811;
pub const NELOG_NetlogonRemoteDynamicDnsUpdateRequestFailure: u32 = 5815;
pub const NELOG_NetlogonRequireSignOrSealError: u32 = 3227;
pub const NELOG_NetlogonRpcCallCancelled: u32 = 5783;
pub const NELOG_NetlogonRpcPortRequestFailure: u32 = 5809;
pub const NELOG_NetlogonSSIInitError: u32 = 5700;
pub const NELOG_NetlogonServerAuthFailed: u32 = 5722;
pub const NELOG_NetlogonServerAuthFailedNoAccount: u32 = 5805;
pub const NELOG_NetlogonServerAuthNoTrustSamAccount: u32 = 5723;
pub const NELOG_NetlogonSessionTypeWrong: u32 = 5770;
pub const NELOG_NetlogonSpnCrackNamesFailure: u32 = 5801;
pub const NELOG_NetlogonSpnMultipleSamAccountNames: u32 = 5800;
pub const NELOG_NetlogonSyncError: u32 = 3226;
pub const NELOG_NetlogonSystemError: u32 = 5737;
pub const NELOG_NetlogonTooManyGlobalGroups: u32 = 5739;
pub const NELOG_NetlogonTrackingError: u32 = 3225;
pub const NELOG_NetlogonUserValidationReqInitialTimeOut: u32 = 5816;
pub const NELOG_NetlogonUserValidationReqRecurringTimeOut: u32 = 5817;
pub const NELOG_NetlogonUserValidationReqWaitInitialWarning: u32 = 5818;
pub const NELOG_NetlogonUserValidationReqWaitRecurringWarning: u32 = 5819;
pub const NELOG_NoTranportLoaded: u32 = 5728;
pub const NELOG_OEM_Code: u32 = 3299;
pub const NELOG_ReleaseMem_Alert: u32 = 3128;
pub const NELOG_Remote_API: u32 = 3125;
pub const NELOG_ReplAccessDenied: u32 = 3222;
pub const NELOG_ReplBadExport: u32 = 3219;
pub const NELOG_ReplBadImport: u32 = 3218;
pub const NELOG_ReplBadMsg: u32 = 3215;
pub const NELOG_ReplCannotMasterDir: u32 = 3207;
pub const NELOG_ReplLogonFailed: u32 = 3211;
pub const NELOG_ReplLostMaster: u32 = 3209;
pub const NELOG_ReplMaxFiles: u32 = 3213;
pub const NELOG_ReplMaxTreeDepth: u32 = 3214;
pub const NELOG_ReplNetErr: u32 = 3212;
pub const NELOG_ReplSignalFileErr: u32 = 3220;
pub const NELOG_ReplSysErr: u32 = 3216;
pub const NELOG_ReplUpdateError: u32 = 3208;
pub const NELOG_ReplUserCurDir: u32 = 3206;
pub const NELOG_ReplUserLoged: u32 = 3217;
pub const NELOG_Resource_Shortage: u32 = 3101;
pub const NELOG_RplAdapterResource: u32 = 5756;
pub const NELOG_RplBackupDatabase: u32 = 5765;
pub const NELOG_RplCheckConfigs: u32 = 5760;
pub const NELOG_RplCheckSecurity: u32 = 5764;
pub const NELOG_RplCreateProfiles: u32 = 5761;
pub const NELOG_RplFileCopy: u32 = 5757;
pub const NELOG_RplFileDelete: u32 = 5758;
pub const NELOG_RplFilePerms: u32 = 5759;
pub const NELOG_RplInitDatabase: u32 = 5766;
pub const NELOG_RplInitRestoredDatabase: u32 = 5769;
pub const NELOG_RplMessages: u32 = 5742;
pub const NELOG_RplRegistry: u32 = 5762;
pub const NELOG_RplReplaceRPLDISK: u32 = 5763;
pub const NELOG_RplRestoreDatabaseFailure: u32 = 5767;
pub const NELOG_RplRestoreDatabaseSuccess: u32 = 5768;
pub const NELOG_RplSystem: u32 = 5744;
pub const NELOG_RplUpgradeDBTo40: u32 = 5771;
pub const NELOG_RplWkstaBbcFile: u32 = 5751;
pub const NELOG_RplWkstaFileChecksum: u32 = 5749;
pub const NELOG_RplWkstaFileLineCount: u32 = 5750;
pub const NELOG_RplWkstaFileOpen: u32 = 5746;
pub const NELOG_RplWkstaFileRead: u32 = 5747;
pub const NELOG_RplWkstaFileSize: u32 = 5752;
pub const NELOG_RplWkstaInternal: u32 = 5753;
pub const NELOG_RplWkstaMemory: u32 = 5748;
pub const NELOG_RplWkstaNetwork: u32 = 5755;
pub const NELOG_RplWkstaTimeout: u32 = 5745;
pub const NELOG_RplWkstaWrongVersion: u32 = 5754;
pub const NELOG_RplXnsBoot: u32 = 5743;
pub const NELOG_SMB_Illegal: u32 = 3112;
pub const NELOG_Server_Lock_Failure: u32 = 3132;
pub const NELOG_Service_Fail: u32 = 3113;
pub const NELOG_Srv_Close_Failure: u32 = 3205;
pub const NELOG_Srv_No_Mem_Grow: u32 = 3121;
pub const NELOG_Srv_Thread_Failure: u32 = 3204;
pub const NELOG_Srvnet_NB_Open: u32 = 3177;
pub const NELOG_Srvnet_Not_Started: u32 = 3123;
pub const NELOG_System_Error: u32 = 3257;
pub const NELOG_System_Semaphore: u32 = 3109;
pub const NELOG_UPS_CannotOpenDriver: u32 = 3233;
pub const NELOG_UPS_CmdFileConfig: u32 = 3235;
pub const NELOG_UPS_CmdFileError: u32 = 3232;
pub const NELOG_UPS_CmdFileExec: u32 = 3236;
pub const NELOG_UPS_PowerBack: u32 = 3234;
pub const NELOG_UPS_PowerOut: u32 = 3230;
pub const NELOG_UPS_Shutdown: u32 = 3231;
pub const NELOG_Unable_To_Lock_Segment: u32 = 3102;
pub const NELOG_Unable_To_Unlock_Segment: u32 = 3103;
pub const NELOG_Uninstall_Service: u32 = 3104;
pub const NELOG_VIO_POPUP_ERR: u32 = 3151;
pub const NELOG_Wksta_Bad_Mailslot_SMB: u32 = 3165;
pub const NELOG_Wksta_BiosThreadFailure: u32 = 3162;
pub const NELOG_Wksta_Compname: u32 = 3161;
pub const NELOG_Wksta_HostTab_Full: u32 = 3164;
pub const NELOG_Wksta_Infoseg: u32 = 3160;
pub const NELOG_Wksta_IniSeg: u32 = 3163;
pub const NELOG_Wksta_SSIRelogon: u32 = 3167;
pub const NELOG_Wksta_UASInit: u32 = 3166;
pub const NELOG_Wrong_DLL_Version: u32 = 3255;
pub const NERR_ACFFileIOFail: u32 = 2229;
pub const NERR_ACFNoParent: u32 = 2232;
pub const NERR_ACFNoRoom: u32 = 2228;
pub const NERR_ACFNotFound: u32 = 2219;
pub const NERR_ACFNotLoaded: u32 = 2227;
pub const NERR_ACFTooManyLists: u32 = 2230;
pub const NERR_AccountExpired: u32 = 2239;
pub const NERR_AccountLockedOut: u32 = 2702;
pub const NERR_AccountReuseBlockedByPolicy: u32 = 2732;
pub const NERR_AccountUndefined: u32 = 2238;
pub const NERR_AcctLimitExceeded: u32 = 2434;
pub const NERR_ActiveConns: u32 = 2402;
pub const NERR_AddForwarded: u32 = 2275;
pub const NERR_AlertExists: u32 = 2430;
pub const NERR_AlreadyCloudDomainJoined: u32 = 2700;
pub const NERR_AlreadyExists: u32 = 2276;
pub const NERR_AlreadyForwarded: u32 = 2274;
pub const NERR_AlreadyLoggedOn: u32 = 2200;
pub const NERR_BASE: u32 = 2100;
pub const NERR_BadAsgType: u32 = 2251;
pub const NERR_BadComponent: u32 = 2356;
pub const NERR_BadControlRecv: u32 = 2193;
pub const NERR_BadDest: u32 = 2382;
pub const NERR_BadDev: u32 = 2341;
pub const NERR_BadDevString: u32 = 2340;
pub const NERR_BadDomainJoinInfo: u32 = 2712;
pub const NERR_BadDosFunction: u32 = 2502;
pub const NERR_BadDosRetCode: u32 = 2500;
pub const NERR_BadEventName: u32 = 2143;
pub const NERR_BadFileCheckSum: u32 = 2504;
pub const NERR_BadOfflineJoinInfo: u32 = 2710;
pub const NERR_BadPassword: u32 = 2203;
pub const NERR_BadPasswordCore: u32 = 2403;
pub const NERR_BadQueueDevString: u32 = 2334;
pub const NERR_BadQueuePriority: u32 = 2335;
pub const NERR_BadReceive: u32 = 2282;
pub const NERR_BadRecipient: u32 = 2433;
pub const NERR_BadServiceName: u32 = 2185;
pub const NERR_BadServiceProgName: u32 = 2188;
pub const NERR_BadSource: u32 = 2381;
pub const NERR_BadTransactConfig: u32 = 2141;
pub const NERR_BadUasConfig: u32 = 2450;
pub const NERR_BadUsername: u32 = 2202;
pub const NERR_BrowserConfiguredToNotRun: u32 = 2550;
pub const NERR_BrowserNotStarted: u32 = 2139;
pub const NERR_BrowserTableIncomplete: u32 = 2319;
pub const NERR_BufTooSmall: u32 = 2123;
pub const NERR_CallingRplSrvr: u32 = 2515;
pub const NERR_CanNotGrowSegment: u32 = 2233;
pub const NERR_CanNotGrowUASFile: u32 = 2456;
pub const NERR_CannotUnjoinAadDomain: u32 = 2727;
pub const NERR_CannotUpdateAadHostName: u32 = 2728;
pub const NERR_CantConnectRplSrvr: u32 = 2513;
pub const NERR_CantCreateJoinInfo: u32 = 2711;
pub const NERR_CantLoadOfflineHive: u32 = 2717;
pub const NERR_CantOpenImageFile: u32 = 2514;
pub const NERR_CantType: u32 = 2357;
pub const NERR_CantVerifyHostname: u32 = 2716;
pub const NERR_CfgCompNotFound: u32 = 2146;
pub const NERR_CfgParamNotFound: u32 = 2147;
pub const NERR_ClientNameNotFound: u32 = 2312;
pub const NERR_CommDevInUse: u32 = 2343;
pub const NERR_ComputerAccountNotFound: u32 = 2697;
pub const NERR_ConnectionInsecure: u32 = 2718;
pub const NERR_DCNotFound: u32 = 2453;
pub const NERR_DS8DCNotFound: u32 = 2722;
pub const NERR_DS8DCRequired: u32 = 2720;
pub const NERR_DS9DCNotFound: u32 = 2725;
pub const NERR_DataTypeInvalid: u32 = 2167;
pub const NERR_DatabaseUpToDate: u32 = 2248;
pub const NERR_DefaultJoinRequired: u32 = 2694;
pub const NERR_DelComputerName: u32 = 2278;
pub const NERR_DeleteLater: u32 = 2298;
pub const NERR_DestExists: u32 = 2153;
pub const NERR_DestIdle: u32 = 2158;
pub const NERR_DestInvalidOp: u32 = 2159;
pub const NERR_DestInvalidState: u32 = 2162;
pub const NERR_DestNoRoom: u32 = 2157;
pub const NERR_DestNotFound: u32 = 2152;
pub const NERR_DevInUse: u32 = 2404;
pub const NERR_DevInvalidOpCode: u32 = 2331;
pub const NERR_DevNotFound: u32 = 2332;
pub const NERR_DevNotOpen: u32 = 2333;
pub const NERR_DevNotRedirected: u32 = 2107;
pub const NERR_DeviceIsShared: u32 = 2252;
pub const NERR_DeviceNotShared: u32 = 2311;
pub const NERR_DeviceShareConflict: u32 = 2318;
pub const NERR_DfsAlreadyShared: u32 = 2664;
pub const NERR_DfsBadRenamePath: u32 = 2671;
pub const NERR_DfsCantCreateJunctionPoint: u32 = 2669;
pub const NERR_DfsCantRemoveDfsRoot: u32 = 2682;
pub const NERR_DfsCantRemoveLastServerShare: u32 = 2677;
pub const NERR_DfsChildOrParentInDfs: u32 = 2683;
pub const NERR_DfsCyclicalName: u32 = 2674;
pub const NERR_DfsDataIsIdentical: u32 = 2681;
pub const NERR_DfsDuplicateService: u32 = 2676;
pub const NERR_DfsInconsistent: u32 = 2679;
pub const NERR_DfsInternalCorruption: u32 = 2660;
pub const NERR_DfsInternalError: u32 = 2690;
pub const NERR_DfsLeafVolume: u32 = 2667;
pub const NERR_DfsNoSuchServer: u32 = 2673;
pub const NERR_DfsNoSuchShare: u32 = 2665;
pub const NERR_DfsNoSuchVolume: u32 = 2662;
pub const NERR_DfsNotALeafVolume: u32 = 2666;
pub const NERR_DfsNotSupportedInServerDfs: u32 = 2675;
pub const NERR_DfsServerNotDfsAware: u32 = 2670;
pub const NERR_DfsServerUpgraded: u32 = 2680;
pub const NERR_DfsVolumeAlreadyExists: u32 = 2663;
pub const NERR_DfsVolumeDataCorrupt: u32 = 2661;
pub const NERR_DfsVolumeHasMultipleServers: u32 = 2668;
pub const NERR_DfsVolumeIsInterDfs: u32 = 2678;
pub const NERR_DfsVolumeIsOffline: u32 = 2672;
pub const NERR_DifferentServers: u32 = 2383;
pub const NERR_DriverNotFound: u32 = 2166;
pub const NERR_DupNameReboot: u32 = 2144;
pub const NERR_DuplicateHostName: u32 = 2729;
pub const NERR_DuplicateName: u32 = 2297;
pub const NERR_DuplicateShare: u32 = 2118;
pub const NERR_ErrCommRunSrv: u32 = 2389;
pub const NERR_ErrorExecingGhost: u32 = 2391;
pub const NERR_ExecFailure: u32 = 2315;
pub const NERR_FileIdNotFound: u32 = 2314;
pub const NERR_GroupExists: u32 = 2223;
pub const NERR_GroupNotFound: u32 = 2220;
pub const NERR_GrpMsgProcessor: u32 = 2280;
pub const NERR_HostNameTooLong: u32 = 2730;
pub const NERR_ImageParamErr: u32 = 2508;
pub const NERR_InUseBySpooler: u32 = 2342;
pub const NERR_IncompleteDel: u32 = 2299;
pub const NERR_InternalError: u32 = 2140;
pub const NERR_InvalidAPI: u32 = 2142;
pub const NERR_InvalidComputer: u32 = 2351;
pub const NERR_InvalidDatabase: u32 = 2247;
pub const NERR_InvalidDevice: u32 = 2294;
pub const NERR_InvalidLana: u32 = 2400;
pub const NERR_InvalidLogSeek: u32 = 2440;
pub const NERR_InvalidLogonHours: u32 = 2241;
pub const NERR_InvalidMachineNameForJoin: u32 = 2724;
pub const NERR_InvalidMaxUsers: u32 = 2122;
pub const NERR_InvalidUASOp: u32 = 2451;
pub const NERR_InvalidWorkgroupName: u32 = 2695;
pub const NERR_InvalidWorkstation: u32 = 2240;
pub const NERR_IsDfsShare: u32 = 2321;
pub const NERR_ItemNotFound: u32 = 2115;
pub const NERR_JobInvalidState: u32 = 2164;
pub const NERR_JobNoRoom: u32 = 2156;
pub const NERR_JobNotFound: u32 = 2151;
pub const NERR_JoinPerformedMustRestart: u32 = 2713;
pub const NERR_LDAPCapableDCRequired: u32 = 2721;
pub const NERR_LanmanIniError: u32 = 2131;
pub const NERR_LastAdmin: u32 = 2452;
pub const NERR_LineTooLong: u32 = 2149;
pub const NERR_LocalDrive: u32 = 2405;
pub const NERR_LocalForward: u32 = 2279;
pub const NERR_LogFileChanged: u32 = 2378;
pub const NERR_LogFileCorrupt: u32 = 2379;
pub const NERR_LogOverflow: u32 = 2377;
pub const NERR_LogonDomainExists: u32 = 2216;
pub const NERR_LogonNoUserPath: u32 = 2211;
pub const NERR_LogonScriptError: u32 = 2212;
pub const NERR_LogonServerConflict: u32 = 2210;
pub const NERR_LogonServerNotFound: u32 = 2215;
pub const NERR_LogonTrackingError: u32 = 2454;
pub const NERR_LogonsPaused: u32 = 2209;
pub const NERR_MaxLenExceeded: u32 = 2354;
pub const NERR_MsgAlreadyStarted: u32 = 2271;
pub const NERR_MsgInitFailed: u32 = 2272;
pub const NERR_MsgNotStarted: u32 = 2284;
pub const NERR_MultipleNets: u32 = 2300;
pub const NERR_NameInUse: u32 = 2283;
pub const NERR_NameNotForwarded: u32 = 2288;
pub const NERR_NameNotFound: u32 = 2273;
pub const NERR_NameUsesIncompatibleCodePage: u32 = 2696;
pub const NERR_NetNameNotFound: u32 = 2310;
pub const NERR_NetNotStarted: u32 = 2102;
pub const NERR_NetlogonNotStarted: u32 = 2455;
pub const NERR_NetworkError: u32 = 2136;
pub const NERR_NoAlternateServers: u32 = 2467;
pub const NERR_NoCommDevs: u32 = 2337;
pub const NERR_NoComputerName: u32 = 2270;
pub const NERR_NoForwardName: u32 = 2286;
pub const NERR_NoJoinPending: u32 = 2714;
pub const NERR_NoNetworkResource: u32 = 2105;
pub const NERR_NoOfflineJoinInfo: u32 = 2709;
pub const NERR_NoRoom: u32 = 2119;
pub const NERR_NoRplBootSystem: u32 = 2505;
pub const NERR_NoSuchAlert: u32 = 2432;
pub const NERR_NoSuchConnection: u32 = 2462;
pub const NERR_NoSuchServer: u32 = 2460;
pub const NERR_NoSuchSession: u32 = 2461;
pub const NERR_NonDosFloppyUsed: u32 = 2510;
pub const NERR_NonValidatedLogon: u32 = 2217;
pub const NERR_NotInCache: u32 = 2235;
pub const NERR_NotInDispatchTbl: u32 = 2192;
pub const NERR_NotLocalDomain: u32 = 2320;
pub const NERR_NotLocalName: u32 = 2285;
pub const NERR_NotLoggedOn: u32 = 2201;
pub const NERR_NotPrimary: u32 = 2226;
pub const NERR_OpenFiles: u32 = 2401;
pub const NERR_PasswordCantChange: u32 = 2243;
pub const NERR_PasswordExpired: u32 = 2242;
pub const NERR_PasswordFilterError: u32 = 2705;
pub const NERR_PasswordHistConflict: u32 = 2244;
pub const NERR_PasswordMismatch: u32 = 2458;
pub const NERR_PasswordMustChange: u32 = 2701;
pub const NERR_PasswordNotComplexEnough: u32 = 2704;
pub const NERR_PasswordTooLong: u32 = 2703;
pub const NERR_PasswordTooRecent: u32 = 2246;
pub const NERR_PasswordTooShort: u32 = 2245;
pub const NERR_PausedRemote: u32 = 2281;
pub const NERR_PersonalSku: u32 = 2698;
pub const NERR_PlainTextSecretsRequired: u32 = 2726;
pub const NERR_ProcNoRespond: u32 = 2160;
pub const NERR_ProcNotFound: u32 = 2168;
pub const NERR_ProfileCleanup: u32 = 2372;
pub const NERR_ProfileFileTooBig: u32 = 2370;
pub const NERR_ProfileLoadErr: u32 = 2374;
pub const NERR_ProfileOffset: u32 = 2371;
pub const NERR_ProfileSaveErr: u32 = 2375;
pub const NERR_ProfileUnknownCmd: u32 = 2373;
pub const NERR_ProgNeedsExtraMem: u32 = 2501;
pub const NERR_ProvisioningBlobUnsupported: u32 = 2719;
pub const NERR_QExists: u32 = 2154;
pub const NERR_QInvalidState: u32 = 2163;
pub const NERR_QNoRoom: u32 = 2155;
pub const NERR_QNotFound: u32 = 2150;
pub const NERR_QueueNotFound: u32 = 2338;
pub const NERR_RPL_CONNECTED: u32 = 2519;
pub const NERR_RedirectedPath: u32 = 2117;
pub const NERR_RemoteBootFailed: u32 = 2503;
pub const NERR_RemoteErr: u32 = 2127;
pub const NERR_RemoteFull: u32 = 2287;
pub const NERR_RemoteOnly: u32 = 2106;
pub const NERR_ResourceExists: u32 = 2225;
pub const NERR_ResourceNotFound: u32 = 2222;
pub const NERR_RplAdapterInfoCorrupted: u32 = 2625;
pub const NERR_RplAdapterNameUnavailable: u32 = 2633;
pub const NERR_RplAdapterNotFound: u32 = 2637;
pub const NERR_RplBackupDatabase: u32 = 2636;
pub const NERR_RplBadDatabase: u32 = 2612;
pub const NERR_RplBadRegistry: u32 = 2611;
pub const NERR_RplBootInUse: u32 = 2635;
pub const NERR_RplBootInfoCorrupted: u32 = 2628;
pub const NERR_RplBootNameUnavailable: u32 = 2640;
pub const NERR_RplBootNotFound: u32 = 2631;
pub const NERR_RplBootRestart: u32 = 2511;
pub const NERR_RplBootServiceTerm: u32 = 2517;
pub const NERR_RplBootStartFailed: u32 = 2518;
pub const NERR_RplCannotEnum: u32 = 2615;
pub const NERR_RplConfigInfoCorrupted: u32 = 2623;
pub const NERR_RplConfigNameUnavailable: u32 = 2641;
pub const NERR_RplConfigNotEmpty: u32 = 2634;
pub const NERR_RplConfigNotFound: u32 = 2624;
pub const NERR_RplIncompatibleProfile: u32 = 2632;
pub const NERR_RplInternal: u32 = 2626;
pub const NERR_RplLoadrDiskErr: u32 = 2507;
pub const NERR_RplLoadrNetBiosErr: u32 = 2506;
pub const NERR_RplNeedsRPLUSERAcct: u32 = 2630;
pub const NERR_RplNoAdaptersStarted: u32 = 2610;
pub const NERR_RplNotRplServer: u32 = 2614;
pub const NERR_RplProfileInfoCorrupted: u32 = 2619;
pub const NERR_RplProfileNameUnavailable: u32 = 2621;
pub const NERR_RplProfileNotEmpty: u32 = 2622;
pub const NERR_RplProfileNotFound: u32 = 2620;
pub const NERR_RplRplfilesShare: u32 = 2613;
pub const NERR_RplSrvrCallFailed: u32 = 2512;
pub const NERR_RplVendorInfoCorrupted: u32 = 2627;
pub const NERR_RplVendorNameUnavailable: u32 = 2639;
pub const NERR_RplVendorNotFound: u32 = 2638;
pub const NERR_RplWkstaInfoCorrupted: u32 = 2616;
pub const NERR_RplWkstaNameUnavailable: u32 = 2618;
pub const NERR_RplWkstaNeedsUserAcct: u32 = 2629;
pub const NERR_RplWkstaNotFound: u32 = 2617;
pub const NERR_RunSrvPaused: u32 = 2385;
pub const NERR_SameAsComputerName: u32 = 2253;
pub const NERR_ServerNotStarted: u32 = 2114;
pub const NERR_ServiceCtlBusy: u32 = 2187;
pub const NERR_ServiceCtlNotValid: u32 = 2191;
pub const NERR_ServiceCtlTimeout: u32 = 2186;
pub const NERR_ServiceEntryLocked: u32 = 2183;
pub const NERR_ServiceInstalled: u32 = 2182;
pub const NERR_ServiceKillProc: u32 = 2190;
pub const NERR_ServiceNotCtrl: u32 = 2189;
pub const NERR_ServiceNotInstalled: u32 = 2184;
pub const NERR_ServiceNotStarting: u32 = 2194;
pub const NERR_ServiceTableFull: u32 = 2181;
pub const NERR_ServiceTableLocked: u32 = 2180;
pub const NERR_SetupAlreadyJoined: u32 = 2691;
pub const NERR_SetupCheckDNSConfig: u32 = 2699;
pub const NERR_SetupDomainController: u32 = 2693;
pub const NERR_SetupNotJoined: u32 = 2692;
pub const NERR_ShareMem: u32 = 2104;
pub const NERR_ShareNotFound: u32 = 2392;
pub const NERR_SourceIsDir: u32 = 2380;
pub const NERR_SpeGroupOp: u32 = 2234;
pub const NERR_SpoolNoMemory: u32 = 2165;
pub const NERR_SpoolerNotLoaded: u32 = 2161;
pub const NERR_StandaloneLogon: u32 = 2214;
pub const NERR_StartingRplBoot: u32 = 2516;
pub const NERR_Success: u32 = 0;
pub const NERR_SyncRequired: u32 = 2249;
pub const NERR_TargetVersionUnsupported: u32 = 2723;
pub const NERR_TimeDiffAtDC: u32 = 2457;
pub const NERR_TmpFile: u32 = 2316;
pub const NERR_TooManyAlerts: u32 = 2431;
pub const NERR_TooManyConnections: u32 = 2465;
pub const NERR_TooManyEntries: u32 = 2362;
pub const NERR_TooManyFiles: u32 = 2466;
pub const NERR_TooManyHostNames: u32 = 2731;
pub const NERR_TooManyImageParams: u32 = 2509;
pub const NERR_TooManyItems: u32 = 2121;
pub const NERR_TooManyNames: u32 = 2277;
pub const NERR_TooManyServers: u32 = 2463;
pub const NERR_TooManySessions: u32 = 2464;
pub const NERR_TooMuchData: u32 = 2317;
pub const NERR_TruncatedBroadcast: u32 = 2289;
pub const NERR_TryDownLevel: u32 = 2470;
pub const NERR_UPSDriverNotStarted: u32 = 2480;
pub const NERR_UPSInvalidCommPort: u32 = 2482;
pub const NERR_UPSInvalidConfig: u32 = 2481;
pub const NERR_UPSShutdownFailed: u32 = 2484;
pub const NERR_UPSSignalAsserted: u32 = 2483;
pub const NERR_UnableToAddName_F: u32 = 2205;
pub const NERR_UnableToAddName_W: u32 = 2204;
pub const NERR_UnableToDelName_F: u32 = 2207;
pub const NERR_UnableToDelName_W: u32 = 2206;
pub const NERR_UnknownDevDir: u32 = 2116;
pub const NERR_UnknownServer: u32 = 2103;
pub const NERR_UseNotFound: u32 = 2250;
pub const NERR_UserExists: u32 = 2224;
pub const NERR_UserInGroup: u32 = 2236;
pub const NERR_UserLogon: u32 = 2231;
pub const NERR_UserNotFound: u32 = 2221;
pub const NERR_UserNotInGroup: u32 = 2237;
pub const NERR_ValuesNotSet: u32 = 2715;
pub const NERR_WkstaInconsistentState: u32 = 2137;
pub const NERR_WkstaNotStarted: u32 = 2138;
pub const NERR_WriteFault: u32 = 2295;
...
pub const NETLOG_NetlogonNonWindowsSupportsSecureRpc: u32 = 5826;
pub const NETLOG_NetlogonRpcBacklogLimitFailure: u32 = 5837;
pub const NETLOG_NetlogonRpcBacklogLimitSet: u32 = 5836;
pub const NETLOG_NetlogonUnsecureRpcClient: u32 = 5827;
pub const NETLOG_NetlogonUnsecureRpcMachineAllowedBySsdl: u32 = 5830;
pub const NETLOG_NetlogonUnsecureRpcTrust: u32 = 5828;
pub const NETLOG_NetlogonUnsecureRpcTrustAllowedBySsdl: u32 = 5831;
pub const NETLOG_NetlogonUnsecuredRpcMachineTemporarilyAllowed: u32 = 5829;
pub const NETLOG_PassThruFilterError_Request_AdminOverride: u32 = 5834;
pub const NETLOG_PassThruFilterError_Request_Blocked: u32 = 5835;
pub const NETLOG_PassThruFilterError_Summary_AdminOverride: u32 = 5832;
pub const NETLOG_PassThruFilterError_Summary_Blocked: u32 = 5833;
pub const NETMAN_VARTYPE_HARDWARE_ADDRESS: u32 = 1;
pub const NETMAN_VARTYPE_STRING: u32 = 2;
pub const NETMAN_VARTYPE_ULONG: u32 = 0;
pub const NETSETUP_ACCT_CREATE: NET_JOIN_DOMAIN_JOIN_OPTIONS = NET_JOIN_DOMAIN_JOIN_OPTIONS(2);
pub const NETSETUP_ACCT_DELETE: u32 = 4;
pub const NETSETUP_ALT_SAMACCOUNTNAME: u32 = 131072;
pub const NETSETUP_AMBIGUOUS_DC: NET_JOIN_DOMAIN_JOIN_OPTIONS = NET_JOIN_DOMAIN_JOIN_OPTIONS(4096);
pub const NETSETUP_DEFER_SPN_SET: NET_JOIN_DOMAIN_JOIN_OPTIONS = NET_JOIN_DOMAIN_JOIN_OPTIONS(256);
pub const NETSETUP_DNS_NAME_CHANGES_ONLY: u32 = 4096;
pub const NETSETUP_DOMAIN_JOIN_IF_JOINED: NET_JOIN_DOMAIN_JOIN_OPTIONS = NET_JOIN_DOMAIN_JOIN_OPTIONS(32);
pub const NETSETUP_DONT_CONTROL_SERVICES: NET_JOIN_DOMAIN_JOIN_OPTIONS = NET_JOIN_DOMAIN_JOIN_OPTIONS(16384);
pub const NETSETUP_FORCE_SPN_SET: NET_JOIN_DOMAIN_JOIN_OPTIONS = NET_JOIN_DOMAIN_JOIN_OPTIONS(65536);
pub const NETSETUP_IGNORE_UNSUPPORTED_FLAGS: NET_JOIN_DOMAIN_JOIN_OPTIONS = NET_JOIN_DOMAIN_JOIN_OPTIONS(268435456);
pub const NETSETUP_INSTALL_INVOCATION: u32 = 262144;
pub const NETSETUP_JOIN_DC_ACCOUNT: NET_JOIN_DOMAIN_JOIN_OPTIONS = NET_JOIN_DOMAIN_JOIN_OPTIONS(512);
pub const NETSETUP_JOIN_DOMAIN: NET_JOIN_DOMAIN_JOIN_OPTIONS = NET_JOIN_DOMAIN_JOIN_OPTIONS(1);
pub const NETSETUP_JOIN_READONLY: NET_JOIN_DOMAIN_JOIN_OPTIONS = NET_JOIN_DOMAIN_JOIN_OPTIONS(2048);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NETSETUP_JOIN_STATUS(pub i32);
pub const NETSETUP_JOIN_UNSECURE: NET_JOIN_DOMAIN_JOIN_OPTIONS = NET_JOIN_DOMAIN_JOIN_OPTIONS(64);
pub const NETSETUP_JOIN_WITH_NEW_NAME: NET_JOIN_DOMAIN_JOIN_OPTIONS = NET_JOIN_DOMAIN_JOIN_OPTIONS(1024);
pub const NETSETUP_MACHINE_PWD_PASSED: NET_JOIN_DOMAIN_JOIN_OPTIONS = NET_JOIN_DOMAIN_JOIN_OPTIONS(128);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct NETSETUP_NAME_TYPE(pub i32);
pub const NETSETUP_NO_ACCT_REUSE: NET_JOIN_DOMAIN_JOIN_OPTIONS = NET_JOIN_DOMAIN_JOIN_OPTIONS(131072);
pub const NETSETUP_NO_NETLOGON_CACHE: NET_JOIN_DOMAIN_JOIN_OPTIONS = NET_JOIN_DOMAIN_JOIN_OPTIONS(8192);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const NETSETUP_PROVISION_DOWNLEVEL_PRIV_SUPPORT: NETSETUP_PROVISION = NETSETUP_PROVISION(1);
pub const NETSETUP_PROVISION_ONLINE_CALLER: NET_REQUEST_PROVISION_OPTIONS = NET_REQUEST_PROVISION_OPTIONS(1073741824);
pub const NETSETUP_PROVISION_PERSISTENTSITE: u32 = 32;
pub const NETSETUP_PROVISION_REUSE_ACCOUNT: NETSETUP_PROVISION = NETSETUP_PROVISION(2);
pub const NETSETUP_PROVISION_ROOT_CA_CERTS: NETSETUP_PROVISION = NETSETUP_PROVISION(16);
pub const NETSETUP_PROVISION_SKIP_ACCOUNT_SEARCH: NETSETUP_PROVISION = NETSETUP_PROVISION(8);
pub const NETSETUP_PROVISION_USE_DEFAULT_PASSWORD: NETSETUP_PROVISION = NETSETUP_PROVISION(4);
pub const NETSETUP_SET_MACHINE_NAME: NET_JOIN_DOMAIN_JOIN_OPTIONS = NET_JOIN_DOMAIN_JOIN_OPTIONS(32768);
pub const NETSETUP_WIN9X_UPGRADE: NET_JOIN_DOMAIN_JOIN_OPTIONS = NET_JOIN_DOMAIN_JOIN_OPTIONS(16);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const NET_DFS_ENUM: i32 = 1073756324;
pub const NET_DFS_ENUMEX: i32 = 1073756325;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const NOT_A_DFS_PATH: i32 = 1073756224;
pub const NO_PERMISSION_REQUIRED: u32 = 1;
pub const NSF_COMPONENT_UPDATE: NETWORK_UPGRADE_TYPE = NETWORK_UPGRADE_TYPE(512);
pub const NSF_POSTSYSINSTALL: NETWORK_INSTALL_TIME = NETWORK_INSTALL_TIME(2);
pub const NSF_PRIMARYINSTALL: NETWORK_INSTALL_TIME = NETWORK_INSTALL_TIME(1);
pub const NSF_WIN16_UPGRADE: NETWORK_UPGRADE_TYPE = NETWORK_UPGRADE_TYPE(16);
pub const NSF_WIN95_UPGRADE: NETWORK_UPGRADE_TYPE = NETWORK_UPGRADE_TYPE(32);
pub const NSF_WINNT_SBS_UPGRADE: NETWORK_UPGRADE_TYPE = NETWORK_UPGRADE_TYPE(256);
pub const NSF_WINNT_SVR_UPGRADE: NETWORK_UPGRADE_TYPE = NETWORK_UPGRADE_TYPE(128);
pub const NSF_WINNT_WKS_UPGRADE: NETWORK_UPGRADE_TYPE = NETWORK_UPGRADE_TYPE(64);
pub const NTFRSPRF_COLLECT_RPC_BINDING_ERROR_CONN: i32 = -1073728292;
pub const NTFRSPRF_COLLECT_RPC_BINDING_ERROR_SET: i32 = -1073728293;
pub const NTFRSPRF_COLLECT_RPC_CALL_ERROR_CONN: i32 = -1073728290;
pub const NTFRSPRF_COLLECT_RPC_CALL_ERROR_SET: i32 = -1073728291;
pub const NTFRSPRF_OPEN_RPC_BINDING_ERROR_CONN: i32 = -1073728296;
pub const NTFRSPRF_OPEN_RPC_BINDING_ERROR_SET: i32 = -1073728297;
pub const NTFRSPRF_OPEN_RPC_CALL_ERROR_CONN: i32 = -1073728294;
pub const NTFRSPRF_OPEN_RPC_CALL_ERROR_SET: i32 = -1073728295;
pub const NTFRSPRF_REGISTRY_ERROR_CONN: i32 = -1073728286;
pub const NTFRSPRF_REGISTRY_ERROR_SET: i32 = -1073728287;
pub const NTFRSPRF_VIRTUALALLOC_ERROR_CONN: i32 = -1073728288;
pub const NTFRSPRF_VIRTUALALLOC_ERROR_SET: i32 = -1073728289;
...
pub const NWSAP_EVENT_BADWANFILTER_VALUE: i32 = -1073733302;
pub const NWSAP_EVENT_BIND_FAILED: i32 = -1073733320;
pub const NWSAP_EVENT_CARDLISTEVENT_FAIL: i32 = -1073733301;
pub const NWSAP_EVENT_CARDMALLOC_FAILED: i32 = -1073733316;
pub const NWSAP_EVENT_CREATELPCEVENT_ERROR: i32 = -1073733305;
pub const NWSAP_EVENT_CREATELPCPORT_ERROR: i32 = -1073733306;
pub const NWSAP_EVENT_GETSOCKNAME_FAILED: i32 = -1073733319;
pub const NWSAP_EVENT_HASHTABLE_MALLOC_FAILED: i32 = -1073733308;
pub const NWSAP_EVENT_INVALID_FILTERNAME: i32 = -2147475123;
pub const NWSAP_EVENT_KEY_NOT_FOUND: i32 = -1073733324;
pub const NWSAP_EVENT_LPCHANDLEMEMORY_ERROR: i32 = -1073733303;
pub const NWSAP_EVENT_LPCLISTENMEMORY_ERROR: i32 = -1073733304;
pub const NWSAP_EVENT_NOCARDS: i32 = -1073733315;
pub const NWSAP_EVENT_OPTBCASTINADDR_FAILED: i32 = -1073733317;
pub const NWSAP_EVENT_OPTEXTENDEDADDR_FAILED: i32 = -1073733318;
pub const NWSAP_EVENT_OPTMAXADAPTERNUM_ERROR: i32 = -1073733293;
pub const NWSAP_EVENT_RECVSEM_FAIL: i32 = -1073733313;
pub const NWSAP_EVENT_SDMDEVENT_FAIL: i32 = -1073733300;
pub const NWSAP_EVENT_SENDEVENT_FAIL: i32 = -1073733312;
pub const NWSAP_EVENT_SETOPTBCAST_FAILED: i32 = -1073733321;
pub const NWSAP_EVENT_SOCKET_FAILED: i32 = -1073733322;
pub const NWSAP_EVENT_STARTLPCWORKER_ERROR: i32 = -1073733307;
pub const NWSAP_EVENT_STARTRECEIVE_ERROR: i32 = -1073733311;
pub const NWSAP_EVENT_STARTWANCHECK_ERROR: i32 = -1073733294;
pub const NWSAP_EVENT_STARTWANWORKER_ERROR: i32 = -1073733295;
pub const NWSAP_EVENT_STARTWORKER_ERROR: i32 = -1073733310;
pub const NWSAP_EVENT_TABLE_MALLOC_FAILED: i32 = -1073733309;
pub const NWSAP_EVENT_THREADEVENT_FAIL: i32 = -1073733314;
pub const NWSAP_EVENT_WANBIND_FAILED: i32 = -1073733296;
pub const NWSAP_EVENT_WANEVENT_ERROR: i32 = -1073733291;
pub const NWSAP_EVENT_WANHANDLEMEMORY_ERROR: i32 = -1073733292;
pub const NWSAP_EVENT_WANSEM_FAIL: i32 = -1073733298;
pub const NWSAP_EVENT_WANSOCKET_FAILED: i32 = -1073733297;
pub const NWSAP_EVENT_WSASTARTUP_FAILED: i32 = -1073733323;
pub const NetAllComputerNames: NET_COMPUTER_NAME_TYPE = NET_COMPUTER_NAME_TYPE(2);
pub const NetAlternateComputerNames: NET_COMPUTER_NAME_TYPE = NET_COMPUTER_NAME_TYPE(1);
pub const NetComputerNameTypeMax: NET_COMPUTER_NAME_TYPE = NET_COMPUTER_NAME_TYPE(3);
pub const NetPrimaryComputerName: NET_COMPUTER_NAME_TYPE = NET_COMPUTER_NAME_TYPE(0);
pub const NetProvisioning: windows_core::GUID = windows_core::GUID::from_u128(0x2aa2b5fe_b846_4d07_810c_b21ee45320e3);
pub const NetSetupDnsMachine: NETSETUP_NAME_TYPE = NETSETUP_NAME_TYPE(5);
pub const NetSetupDomain: NETSETUP_NAME_TYPE = NETSETUP_NAME_TYPE(3);
pub const NetSetupDomainName: NETSETUP_JOIN_STATUS = NETSETUP_JOIN_STATUS(3);
pub const NetSetupMachine: NETSETUP_NAME_TYPE = NETSETUP_NAME_TYPE(1);
pub const NetSetupNonExistentDomain: NETSETUP_NAME_TYPE = NETSETUP_NAME_TYPE(4);
pub const NetSetupUnjoined: NETSETUP_JOIN_STATUS = NETSETUP_JOIN_STATUS(1);
pub const NetSetupUnknown: NETSETUP_NAME_TYPE = NETSETUP_NAME_TYPE(0);
pub const NetSetupUnknownStatus: NETSETUP_JOIN_STATUS = NETSETUP_JOIN_STATUS(0);
pub const NetSetupWorkgroup: NETSETUP_NAME_TYPE = NETSETUP_NAME_TYPE(2);
pub const NetSetupWorkgroupName: NETSETUP_JOIN_STATUS = NETSETUP_JOIN_STATUS(2);
pub const NetValidateAuthentication: NET_VALIDATE_PASSWORD_TYPE = NET_VALIDATE_PASSWORD_TYPE(1);
pub const NetValidatePasswordChange: NET_VALIDATE_PASSWORD_TYPE = NET_VALIDATE_PASSWORD_TYPE(2);
pub const NetValidatePasswordReset: NET_VALIDATE_PASSWORD_TYPE = NET_VALIDATE_PASSWORD_TYPE(3);
pub const NoneFlag: TRANSPORT_INFO_FLAG = TRANSPORT_INFO_FLAG(0);
pub const OBO_COMPONENT: OBO_TOKEN_TYPE = OBO_TOKEN_TYPE(2);
pub const OBO_SOFTWARE: OBO_TOKEN_TYPE = OBO_TOKEN_TYPE(3);
#[repr(C)]
...
pub const OBO_USER: OBO_TOKEN_TYPE = OBO_TOKEN_TYPE(1);
...
pub const PREFIX_MISMATCH: i32 = -1073727510;
pub const PREFIX_MISMATCH_FIXED: i32 = -1073727509;
pub const PREFIX_MISMATCH_NOT_FIXED: i32 = -1073727508;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const PROTO_IPV6_DHCP: u32 = 999;
pub const PROTO_IP_ALG: u32 = 10010;
pub const PROTO_IP_BGMP: u32 = 11;
pub const PROTO_IP_BOOTP: u32 = 9999;
pub const PROTO_IP_DHCP_ALLOCATOR: u32 = 10004;
pub const PROTO_IP_DIFFSERV: u32 = 10008;
pub const PROTO_IP_DNS_PROXY: u32 = 10003;
pub const PROTO_IP_DTP: u32 = 10013;
pub const PROTO_IP_FTP: u32 = 10012;
pub const PROTO_IP_H323: u32 = 10011;
pub const PROTO_IP_IGMP: u32 = 10;
pub const PROTO_IP_MGM: u32 = 10009;
pub const PROTO_IP_MSDP: u32 = 9;
pub const PROTO_IP_NAT: u32 = 10005;
pub const PROTO_IP_VRRP: u32 = 112;
pub const PROTO_TYPE_MCAST: u32 = 1;
pub const PROTO_TYPE_MS0: u32 = 2;
pub const PROTO_TYPE_MS1: u32 = 3;
pub const PROTO_TYPE_UCAST: u32 = 0;
pub const PROTO_VENDOR_MS0: u32 = 0;
pub const PROTO_VENDOR_MS1: u32 = 311;
pub const PROTO_VENDOR_MS2: u32 = 16383;
pub const PWLEN: u32 = 256;
pub const QNLEN: u32 = 80;
pub const QuicPortSetFlag: TRANSPORT_INFO_FLAG = TRANSPORT_INFO_FLAG(2);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const RCUIF_DEMAND_DIAL: RASCON_UIINFO_FLAGS = RASCON_UIINFO_FLAGS(2);
pub const RCUIF_DISABLE_CLASS_BASED_ROUTE: RASCON_UIINFO_FLAGS = RASCON_UIINFO_FLAGS(32768);
pub const RCUIF_ENABLE_NBT: RASCON_UIINFO_FLAGS = RASCON_UIINFO_FLAGS(1024);
pub const RCUIF_NOT_ADMIN: RASCON_UIINFO_FLAGS = RASCON_UIINFO_FLAGS(4);
pub const RCUIF_USE_DISABLE_REGISTER_DNS: RASCON_UIINFO_FLAGS = RASCON_UIINFO_FLAGS(256);
pub const RCUIF_USE_HEADER_COMPRESSION: RASCON_UIINFO_FLAGS = RASCON_UIINFO_FLAGS(128);
pub const RCUIF_USE_IPv4_EXPLICIT_METRIC: RASCON_UIINFO_FLAGS = RASCON_UIINFO_FLAGS(64);
pub const RCUIF_USE_IPv4_NAME_SERVERS: RASCON_UIINFO_FLAGS = RASCON_UIINFO_FLAGS(16);
pub const RCUIF_USE_IPv4_REMOTE_GATEWAY: RASCON_UIINFO_FLAGS = RASCON_UIINFO_FLAGS(32);
pub const RCUIF_USE_IPv4_STATICADDRESS: RASCON_UIINFO_FLAGS = RASCON_UIINFO_FLAGS(8);
pub const RCUIF_USE_IPv6_EXPLICIT_METRIC: RASCON_UIINFO_FLAGS = RASCON_UIINFO_FLAGS(16384);
pub const RCUIF_USE_IPv6_NAME_SERVERS: RASCON_UIINFO_FLAGS = RASCON_UIINFO_FLAGS(4096);
pub const RCUIF_USE_IPv6_REMOTE_GATEWAY: RASCON_UIINFO_FLAGS = RASCON_UIINFO_FLAGS(8192);
pub const RCUIF_USE_IPv6_STATICADDRESS: RASCON_UIINFO_FLAGS = RASCON_UIINFO_FLAGS(2048);
pub const RCUIF_USE_PRIVATE_DNS_SUFFIX: RASCON_UIINFO_FLAGS = RASCON_UIINFO_FLAGS(512);
pub const RCUIF_VPN: RASCON_UIINFO_FLAGS = RASCON_UIINFO_FLAGS(1);
...
pub const RF_ADD_ALL_INTERFACES: u32 = 16;
pub const RF_DEMAND_UPDATE_ROUTES: u32 = 4;
pub const RF_MULTICAST: u32 = 32;
pub const RF_POWER: u32 = 64;
pub const RF_ROUTING: u32 = 1;
pub const RF_ROUTINGV6: u32 = 2;
pub const RIS_INTERFACE_ADDRESS_CHANGE: u32 = 0;
pub const RIS_INTERFACE_DISABLED: u32 = 2;
pub const RIS_INTERFACE_ENABLED: u32 = 1;
pub const RIS_INTERFACE_MEDIA_ABSENT: u32 = 4;
pub const RIS_INTERFACE_MEDIA_PRESENT: u32 = 3;
pub const ROUTING_DOMAIN_INFO_REVISION_1: u32 = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const RTR_INFO_BLOCK_VERSION: u32 = 1;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const RTUTILS_MAX_PROTOCOL_DLL_LEN: u32 = 48;
pub const RTUTILS_MAX_PROTOCOL_NAME_LEN: u32 = 40;
pub const RdmaPortSetFlag: TRANSPORT_INFO_FLAG = TRANSPORT_INFO_FLAG(4);
...
pub const SUPPORTS_ANY: i32 = -1;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct SUPPORTS_BINDING_INTERFACE_FLAGS(pub i32);
pub const SUPPORTS_LOCAL: NET_REMOTE_COMPUTER_SUPPORTS_OPTIONS = NET_REMOTE_COMPUTER_SUPPORTS_OPTIONS(32);
pub const SUPPORTS_REMOTE_ADMIN_PROTOCOL: NET_REMOTE_COMPUTER_SUPPORTS_OPTIONS = NET_REMOTE_COMPUTER_SUPPORTS_OPTIONS(2);
pub const SUPPORTS_RPC: NET_REMOTE_COMPUTER_SUPPORTS_OPTIONS = NET_REMOTE_COMPUTER_SUPPORTS_OPTIONS(4);
pub const SUPPORTS_SAM_PROTOCOL: NET_REMOTE_COMPUTER_SUPPORTS_OPTIONS = NET_REMOTE_COMPUTER_SUPPORTS_OPTIONS(8);
pub const SUPPORTS_UNICODE: NET_REMOTE_COMPUTER_SUPPORTS_OPTIONS = NET_REMOTE_COMPUTER_SUPPORTS_OPTIONS(16);
pub const SVAUD_BADNETLOGON: u32 = 384;
pub const SVAUD_BADSESSLOGON: u32 = 24;
pub const SVAUD_BADUSE: u32 = 6144;
pub const SVAUD_GOODNETLOGON: u32 = 96;
pub const SVAUD_GOODSESSLOGON: u32 = 6;
pub const SVAUD_GOODUSE: u32 = 1536;
pub const SVAUD_LOGONLIM: u32 = 65536;
pub const SVAUD_PERMISSIONS: u32 = 16384;
pub const SVAUD_RESOURCE: u32 = 32768;
pub const SVAUD_SERVICE: u32 = 1;
pub const SVAUD_USERLIST: u32 = 8192;
...
pub const SV_HIDDEN: SERVER_INFO_HIDDEN = SERVER_INFO_HIDDEN(1);
...
pub const SV_SHARESECURITY: SERVER_INFO_SECURITY = SERVER_INFO_SECURITY(0);
...
pub const SV_TYPE_AFP: NET_SERVER_TYPE = NET_SERVER_TYPE(64);
pub const SV_TYPE_ALL: NET_SERVER_TYPE = NET_SERVER_TYPE(4294967295);
pub const SV_TYPE_ALTERNATE_XPORT: NET_SERVER_TYPE = NET_SERVER_TYPE(536870912);
pub const SV_TYPE_BACKUP_BROWSER: NET_SERVER_TYPE = NET_SERVER_TYPE(131072);
pub const SV_TYPE_CLUSTER_NT: NET_SERVER_TYPE = NET_SERVER_TYPE(16777216);
pub const SV_TYPE_CLUSTER_VS_NT: NET_SERVER_TYPE = NET_SERVER_TYPE(67108864);
pub const SV_TYPE_DCE: NET_SERVER_TYPE = NET_SERVER_TYPE(268435456);
pub const SV_TYPE_DFS: NET_SERVER_TYPE = NET_SERVER_TYPE(8388608);
pub const SV_TYPE_DIALIN_SERVER: NET_SERVER_TYPE = NET_SERVER_TYPE(1024);
pub const SV_TYPE_DOMAIN_BAKCTRL: NET_SERVER_TYPE = NET_SERVER_TYPE(16);
pub const SV_TYPE_DOMAIN_CTRL: NET_SERVER_TYPE = NET_SERVER_TYPE(8);
pub const SV_TYPE_DOMAIN_ENUM: NET_SERVER_TYPE = NET_SERVER_TYPE(2147483648);
pub const SV_TYPE_DOMAIN_MASTER: NET_SERVER_TYPE = NET_SERVER_TYPE(524288);
pub const SV_TYPE_DOMAIN_MEMBER: NET_SERVER_TYPE = NET_SERVER_TYPE(256);
pub const SV_TYPE_LOCAL_LIST_ONLY: NET_SERVER_TYPE = NET_SERVER_TYPE(1073741824);
pub const SV_TYPE_MASTER_BROWSER: NET_SERVER_TYPE = NET_SERVER_TYPE(262144);
pub const SV_TYPE_NOVELL: NET_SERVER_TYPE = NET_SERVER_TYPE(128);
pub const SV_TYPE_NT: NET_SERVER_TYPE = NET_SERVER_TYPE(4096);
pub const SV_TYPE_PARMNUM: u32 = 105;
pub const SV_TYPE_POTENTIAL_BROWSER: NET_SERVER_TYPE = NET_SERVER_TYPE(65536);
pub const SV_TYPE_PRINTQ_SERVER: NET_SERVER_TYPE = NET_SERVER_TYPE(512);
pub const SV_TYPE_SERVER: NET_SERVER_TYPE = NET_SERVER_TYPE(2);
pub const SV_TYPE_SERVER_MFPN: NET_SERVER_TYPE = NET_SERVER_TYPE(16384);
pub const SV_TYPE_SERVER_NT: NET_SERVER_TYPE = NET_SERVER_TYPE(32768);
pub const SV_TYPE_SERVER_OSF: NET_SERVER_TYPE = NET_SERVER_TYPE(1048576);
pub const SV_TYPE_SERVER_UNIX: NET_SERVER_TYPE = NET_SERVER_TYPE(2048);
pub const SV_TYPE_SERVER_VMS: NET_SERVER_TYPE = NET_SERVER_TYPE(2097152);
pub const SV_TYPE_SQLSERVER: NET_SERVER_TYPE = NET_SERVER_TYPE(4);
pub const SV_TYPE_TERMINALSERVER: NET_SERVER_TYPE = NET_SERVER_TYPE(33554432);
pub const SV_TYPE_TIME_SOURCE: NET_SERVER_TYPE = NET_SERVER_TYPE(32);
pub const SV_TYPE_WFW: NET_SERVER_TYPE = NET_SERVER_TYPE(8192);
pub const SV_TYPE_WINDOWS: NET_SERVER_TYPE = NET_SERVER_TYPE(4194304);
pub const SV_TYPE_WORKSTATION: NET_SERVER_TYPE = NET_SERVER_TYPE(1);
pub const SV_TYPE_XENIX_SERVER: NET_SERVER_TYPE = NET_SERVER_TYPE(2048);
pub const SV_ULIST_MTIME_PARMNUM: u32 = 401;
pub const SV_USERPATH_PARMNUM: u32 = 112;
pub const SV_USERSECURITY: SERVER_INFO_SECURITY = SERVER_INFO_SECURITY(1);
...
pub const SV_VISIBLE: SERVER_INFO_HIDDEN = SERVER_INFO_HIDDEN(0);
...
pub const StandAloneManagedServiceAccount: MSA_INFO_ACCOUNT_TYPE = MSA_INFO_ACCOUNT_TYPE(1);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const TITLE_SC_MESSAGE_BOX: i32 = -1073734795;
pub const TRACE_NO_STDINFO: u32 = 1;
pub const TRACE_NO_SYNCH: u32 = 4;
pub const TRACE_USE_CONSOLE: u32 = 2;
pub const TRACE_USE_DATE: u32 = 8;
pub const TRACE_USE_FILE: u32 = 1;
pub const TRACE_USE_MASK: u32 = 2;
pub const TRACE_USE_MSEC: u32 = 4;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const TcpPortSetFlag: TRANSPORT_INFO_FLAG = TRANSPORT_INFO_FLAG(1);
pub const UAS_ROLE_BACKUP: USER_MODALS_ROLES = USER_MODALS_ROLES(2);
pub const UAS_ROLE_MEMBER: USER_MODALS_ROLES = USER_MODALS_ROLES(1);
pub const UAS_ROLE_PRIMARY: USER_MODALS_ROLES = USER_MODALS_ROLES(3);
pub const UAS_ROLE_STANDALONE: USER_MODALS_ROLES = USER_MODALS_ROLES(0);
pub const UF_ACCOUNTDISABLE: USER_ACCOUNT_FLAGS = USER_ACCOUNT_FLAGS(2);
pub const UF_DONT_EXPIRE_PASSWD: USER_ACCOUNT_FLAGS = USER_ACCOUNT_FLAGS(65536);
pub const UF_DONT_REQUIRE_PREAUTH: USER_ACCOUNT_FLAGS = USER_ACCOUNT_FLAGS(4194304);
pub const UF_ENCRYPTED_TEXT_PASSWORD_ALLOWED: USER_ACCOUNT_FLAGS = USER_ACCOUNT_FLAGS(128);
pub const UF_HOMEDIR_REQUIRED: USER_ACCOUNT_FLAGS = USER_ACCOUNT_FLAGS(8);
pub const UF_INTERDOMAIN_TRUST_ACCOUNT: u32 = 2048;
pub const UF_LOCKOUT: USER_ACCOUNT_FLAGS = USER_ACCOUNT_FLAGS(16);
pub const UF_MNS_LOGON_ACCOUNT: u32 = 131072;
pub const UF_NORMAL_ACCOUNT: u32 = 512;
pub const UF_NOT_DELEGATED: USER_ACCOUNT_FLAGS = USER_ACCOUNT_FLAGS(1048576);
pub const UF_NO_AUTH_DATA_REQUIRED: u32 = 33554432;
pub const UF_PARTIAL_SECRETS_ACCOUNT: u32 = 67108864;
pub const UF_PASSWD_CANT_CHANGE: USER_ACCOUNT_FLAGS = USER_ACCOUNT_FLAGS(64);
pub const UF_PASSWD_NOTREQD: USER_ACCOUNT_FLAGS = USER_ACCOUNT_FLAGS(32);
pub const UF_PASSWORD_EXPIRED: USER_ACCOUNT_FLAGS = USER_ACCOUNT_FLAGS(8388608);
pub const UF_SCRIPT: USER_ACCOUNT_FLAGS = USER_ACCOUNT_FLAGS(1);
pub const UF_SERVER_TRUST_ACCOUNT: u32 = 8192;
pub const UF_SMARTCARD_REQUIRED: USER_ACCOUNT_FLAGS = USER_ACCOUNT_FLAGS(262144);
pub const UF_TEMP_DUPLICATE_ACCOUNT: u32 = 256;
pub const UF_TRUSTED_FOR_DELEGATION: USER_ACCOUNT_FLAGS = USER_ACCOUNT_FLAGS(524288);
pub const UF_TRUSTED_TO_AUTHENTICATE_FOR_DELEGATION: USER_ACCOUNT_FLAGS = USER_ACCOUNT_FLAGS(16777216);
pub const UF_USE_AES_KEYS: u32 = 134217728;
pub const UF_USE_DES_KEY_ONLY: USER_ACCOUNT_FLAGS = USER_ACCOUNT_FLAGS(2097152);
...
pub const USER_PRIV_ADMIN: USER_PRIV = USER_PRIV(2);
pub const USER_PRIV_GUEST: USER_PRIV = USER_PRIV(0);
pub const USER_PRIV_MASK: u32 = 3;
pub const USER_PRIV_PARMNUM: u32 = 5;
pub const USER_PRIV_USER: USER_PRIV = USER_PRIV(1);
...
pub const USE_DISKDEV: USE_INFO_ASG_TYPE = USE_INFO_ASG_TYPE(0);
pub const USE_DOMAINNAME_PARMNUM: u32 = 6;
pub const USE_FLAGS_PARMNUM: u32 = 7;
pub const USE_FLAG_GLOBAL_MAPPING: u32 = 65536;
pub const USE_FORCE: FORCE_LEVEL_FLAGS = FORCE_LEVEL_FLAGS(1);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const USE_IPC: USE_INFO_ASG_TYPE = USE_INFO_ASG_TYPE(3);
pub const USE_LOCAL_PARMNUM: u32 = 1;
pub const USE_LOTS_OF_FORCE: FORCE_LEVEL_FLAGS = FORCE_LEVEL_FLAGS(2);
pub const USE_NETERR: u32 = 3;
pub const USE_NOFORCE: FORCE_LEVEL_FLAGS = FORCE_LEVEL_FLAGS(0);
...
pub const USE_SPOOLDEV: USE_INFO_ASG_TYPE = USE_INFO_ASG_TYPE(1);
pub const USE_USERNAME_PARMNUM: u32 = 5;
pub const USE_WILDCARD: USE_INFO_ASG_TYPE = USE_INFO_ASG_TYPE(4294967295);
pub const UseTransportType_None: TRANSPORT_TYPE = TRANSPORT_TYPE(0);
pub const UseTransportType_Quic: TRANSPORT_TYPE = TRANSPORT_TYPE(2);
pub const UseTransportType_Wsk: TRANSPORT_TYPE = TRANSPORT_TYPE(1);
...
pub const WZC_PROFILE_API_ERROR_FAILED_TO_LOAD_SCHEMA: u32 = 34;
pub const WZC_PROFILE_API_ERROR_FAILED_TO_LOAD_XML: u32 = 33;
pub const WZC_PROFILE_API_ERROR_INTERNAL: u32 = 36;
pub const WZC_PROFILE_API_ERROR_NOT_SUPPORTED: u32 = 32;
pub const WZC_PROFILE_API_ERROR_XML_VALIDATION_FAILED: u32 = 35;
pub const WZC_PROFILE_CONFIG_ERROR_1X_NOT_ALLOWED: u32 = 20;
pub const WZC_PROFILE_CONFIG_ERROR_1X_NOT_ALLOWED_KEY_REQUIRED: u32 = 21;
pub const WZC_PROFILE_CONFIG_ERROR_1X_NOT_ENABLED_KEY_PROVIDED: u32 = 22;
pub const WZC_PROFILE_CONFIG_ERROR_EAP_METHOD_NOT_APPLICABLE: u32 = 24;
pub const WZC_PROFILE_CONFIG_ERROR_EAP_METHOD_REQUIRED: u32 = 23;
pub const WZC_PROFILE_CONFIG_ERROR_INVALID_AUTH_FOR_CONNECTION_TYPE: u32 = 15;
pub const WZC_PROFILE_CONFIG_ERROR_INVALID_ENCRYPTION_FOR_AUTHMODE: u32 = 16;
pub const WZC_PROFILE_CONFIG_ERROR_KEY_INDEX_NOT_APPLICABLE: u32 = 19;
pub const WZC_PROFILE_CONFIG_ERROR_KEY_INDEX_REQUIRED: u32 = 18;
pub const WZC_PROFILE_CONFIG_ERROR_KEY_REQUIRED: u32 = 17;
pub const WZC_PROFILE_CONFIG_ERROR_WPA_ENCRYPTION_NOT_SUPPORTED: u32 = 26;
pub const WZC_PROFILE_CONFIG_ERROR_WPA_NOT_SUPPORTED: u32 = 25;
pub const WZC_PROFILE_SET_ERROR_DUPLICATE_NETWORK: u32 = 27;
pub const WZC_PROFILE_SET_ERROR_MEMORY_ALLOCATION: u32 = 28;
pub const WZC_PROFILE_SET_ERROR_READING_1X_CONFIG: u32 = 29;
pub const WZC_PROFILE_SET_ERROR_WRITING_1X_CONFIG: u32 = 30;
pub const WZC_PROFILE_SET_ERROR_WRITING_WZC_CFG: u32 = 31;
pub const WZC_PROFILE_SUCCESS: u32 = 0;
pub const WZC_PROFILE_XML_ERROR_1X_ENABLED: u32 = 10;
pub const WZC_PROFILE_XML_ERROR_AUTHENTICATION: u32 = 7;
pub const WZC_PROFILE_XML_ERROR_BAD_KEY_INDEX: u32 = 12;
pub const WZC_PROFILE_XML_ERROR_BAD_NETWORK_KEY: u32 = 14;
pub const WZC_PROFILE_XML_ERROR_BAD_SSID: u32 = 5;
pub const WZC_PROFILE_XML_ERROR_BAD_VERSION: u32 = 2;
pub const WZC_PROFILE_XML_ERROR_CONNECTION_TYPE: u32 = 6;
pub const WZC_PROFILE_XML_ERROR_EAP_METHOD: u32 = 11;
pub const WZC_PROFILE_XML_ERROR_ENCRYPTION: u32 = 8;
pub const WZC_PROFILE_XML_ERROR_KEY_INDEX_RANGE: u32 = 13;
pub const WZC_PROFILE_XML_ERROR_KEY_PROVIDED_AUTOMATICALLY: u32 = 9;
pub const WZC_PROFILE_XML_ERROR_NO_VERSION: u32 = 1;
pub const WZC_PROFILE_XML_ERROR_SSID_NOT_FOUND: u32 = 4;
pub const WZC_PROFILE_XML_ERROR_UNSUPPORTED_VERSION: u32 = 3;
