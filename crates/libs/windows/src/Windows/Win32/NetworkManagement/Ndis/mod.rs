...
impl ::core::fmt::Debug for DOT11EXT_APIS {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("DOT11EXT_APIS")
            .field("Dot11ExtAllocateBuffer", &self.Dot11ExtAllocateBuffer)
            .field("Dot11ExtFreeBuffer", &self.Dot11ExtFreeBuffer)
            .field("Dot11ExtSetProfileCustomUserData", &self.Dot11ExtSetProfileCustomUserData)
            .field("Dot11ExtGetProfileCustomUserData", &self.Dot11ExtGetProfileCustomUserData)
            .field("Dot11ExtSetCurrentProfile", &self.Dot11ExtSetCurrentProfile)
            .field("Dot11ExtSendUIRequest", &self.Dot11ExtSendUIRequest)
            .field("Dot11ExtPreAssociateCompletion", &self.Dot11ExtPreAssociateCompletion)
            .field("Dot11ExtPostAssociateCompletion", &self.Dot11ExtPostAssociateCompletion)
            .field("Dot11ExtSendNotification", &self.Dot11ExtSendNotification)
            .field("Dot11ExtSendPacket", &self.Dot11ExtSendPacket)
            .field("Dot11ExtSetEtherTypeHandling", &self.Dot11ExtSetEtherTypeHandling)
            .field("Dot11ExtSetAuthAlgorithm", &self.Dot11ExtSetAuthAlgorithm)
            .field("Dot11ExtSetUnicastCipherAlgorithm", &self.Dot11ExtSetUnicastCipherAlgorithm)
            .field("Dot11ExtSetMulticastCipherAlgorithm", &self.Dot11ExtSetMulticastCipherAlgorithm)
            .field("Dot11ExtSetDefaultKey", &self.Dot11ExtSetDefaultKey)
            .field("Dot11ExtSetKeyMappingKey", &self.Dot11ExtSetKeyMappingKey)
            .field("Dot11ExtSetDefaultKeyId", &self.Dot11ExtSetDefaultKeyId)
            .field("Dot11ExtNicSpecificExtension", &self.Dot11ExtNicSpecificExtension)
            .field("Dot11ExtSetExcludeUnencrypted", &self.Dot11ExtSetExcludeUnencrypted)
            .field("Dot11ExtStartOneX", &self.Dot11ExtStartOneX)
            .field("Dot11ExtStopOneX", &self.Dot11ExtStopOneX)
            .field("Dot11ExtProcessSecurityPacket", &self.Dot11ExtProcessSecurityPacket)
            .finish()
    }
}
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_NetworkManagement_WiFi", feature = "Win32_Security_ExtensibleAuthenticationProtocol"))]
...
impl ::core::fmt::Debug for DOT11EXT_IHV_HANDLERS {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("DOT11EXT_IHV_HANDLERS")
            .field("Dot11ExtIhvDeinitService", &self.Dot11ExtIhvDeinitService)
            .field("Dot11ExtIhvInitAdapter", &self.Dot11ExtIhvInitAdapter)
            .field("Dot11ExtIhvDeinitAdapter", &self.Dot11ExtIhvDeinitAdapter)
            .field("Dot11ExtIhvPerformPreAssociate", &self.Dot11ExtIhvPerformPreAssociate)
            .field("Dot11ExtIhvAdapterReset", &self.Dot11ExtIhvAdapterReset)
            .field("Dot11ExtIhvPerformPostAssociate", &self.Dot11ExtIhvPerformPostAssociate)
            .field("Dot11ExtIhvStopPostAssociate", &self.Dot11ExtIhvStopPostAssociate)
            .field("Dot11ExtIhvValidateProfile", &self.Dot11ExtIhvValidateProfile)
            .field("Dot11ExtIhvPerformCapabilityMatch", &self.Dot11ExtIhvPerformCapabilityMatch)
            .field("Dot11ExtIhvCreateDiscoveryProfiles", &self.Dot11ExtIhvCreateDiscoveryProfiles)
            .field("Dot11ExtIhvProcessSessionChange", &self.Dot11ExtIhvProcessSessionChange)
            .field("Dot11ExtIhvReceiveIndication", &self.Dot11ExtIhvReceiveIndication)
            .field("Dot11ExtIhvReceivePacket", &self.Dot11ExtIhvReceivePacket)
            .field("Dot11ExtIhvSendPacketCompletion", &self.Dot11ExtIhvSendPacketCompletion)
            .field("Dot11ExtIhvIsUIRequestPending", &self.Dot11ExtIhvIsUIRequestPending)
            .field("Dot11ExtIhvProcessUIResponse", &self.Dot11ExtIhvProcessUIResponse)
            .field("Dot11ExtIhvQueryUIRequest", &self.Dot11ExtIhvQueryUIRequest)
            .field("Dot11ExtIhvOnexIndicateResult", &self.Dot11ExtIhvOnexIndicateResult)
            .field("Dot11ExtIhvControl", &self.Dot11ExtIhvControl)
            .finish()
    }
}
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_NetworkManagement_WiFi", feature = "Win32_Security_ExtensibleAuthenticationProtocol", feature = "Win32_System_RemoteDesktop"))]
...
impl ::core::fmt::Debug for DOT11EXT_VIRTUAL_STATION_APIS {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("DOT11EXT_VIRTUAL_STATION_APIS").field("Dot11ExtRequestVirtualStation", &self.Dot11ExtRequestVirtualStation).field("Dot11ExtReleaseVirtualStation", &self.Dot11ExtReleaseVirtualStation).field("Dot11ExtQueryVirtualStationProperties", &self.Dot11ExtQueryVirtualStationProperties).field("Dot11ExtSetVirtualStationAPProperties", &self.Dot11ExtSetVirtualStationAPProperties).finish()
    }
}
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_NetworkManagement_WiFi"))]
