...
pub struct CHARFORMAT2A {
    ...
    pub wWeight: u16,
    pub sSpacing: i16,
    pub crBackColor: super::windef::COLORREF,
...
pub struct CHARFORMATA {
    ...
    pub yHeight: i32,
    pub yOffset: i32,
    pub crTextColor: super::windef::COLORREF,
    pub bCharSet: u8,
...
#[repr(C)]
#[cfg(target_arch = "x86")]
#[cfg(all(feature = "Win32_windef", feature = "Win32_winuser", feature = "Win32_wtypes"))]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
#[repr(C)]
#[cfg(target_arch = "x86")]
#[cfg(all(feature = "Win32_windef", feature = "Win32_winnt", feature = "Win32_winuser"))]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub struct RICHEDIT_IMAGE_PARAMETERS {
    ...
    pub pIStream: core::mem::ManuallyDrop<Option<super::objidlbase::IStream>>,
}
#[repr(C, packed(4))]
#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", target_arch = "x86_64"))]
#[cfg(feature = "Win32_objidlbase")]
...
pub struct TABLECELLPARMS {
    ...
    pub crBrdrLeft: super::windef::COLORREF,
    pub crBrdrTop: super::windef::COLORREF,
    pub crBrdrRight: super::windef::COLORREF,
    pub crBrdrBottom: super::windef::COLORREF,
    pub crBackPat: super::windef::COLORREF,
