...
#[cfg(feature = "winnt")]
pub type PWINDBG_EXTENSION_ROUTINE = Option<unsafe extern "system" fn(hcurrentprocess: super::HANDLE, hcurrentthread: super::HANDLE, dwcurrentpc: u32, dwprocessor: u32, lpargumentstring: windows_core::PCSTR)>;
#[cfg(feature = "winnt")]
pub type PWINDBG_EXTENSION_ROUTINE32 = Option<unsafe extern "system" fn(hcurrentprocess: super::HANDLE, hcurrentthread: super::HANDLE, dwcurrentpc: u32, dwprocessor: u32, lpargumentstring: windows_core::PCSTR)>;
#[cfg(feature = "winnt")]
pub type PWINDBG_EXTENSION_ROUTINE64 = Option<unsafe extern "system" fn(hcurrentprocess: super::HANDLE, hcurrentthread: super::HANDLE, dwcurrentpc: u64, dwprocessor: u32, lpargumentstring: windows_core::PCSTR)>;
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type PWINDBG_OLDKD_EXTENSION_ROUTINE = Option<unsafe extern "system" fn(dwcurrentpc: u32, lpextensionapis: PWINDBG_OLDKD_EXTENSION_APIS, lpargumentstring: windows_core::PCSTR)>;
#[cfg(feature = "minwindef")]
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type PWINDBG_OLD_EXTENSION_ROUTINE = Option<unsafe extern "system" fn(dwcurrentpc: u32, lpextensionapis: PWINDBG_EXTENSION_APIS, lpargumentstring: windows_core::PCSTR)>;
pub type PWINDBG_OUTPUT_ROUTINE = Option<unsafe extern "C" fn(lpformat: windows_core::PCSTR)>;
#[cfg(feature = "minwindef")]
