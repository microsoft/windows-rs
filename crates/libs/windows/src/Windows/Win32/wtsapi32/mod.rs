...
#[inline]
pub unsafe fn WTSActiveSessionExists(pbactivesessionexists: super::PBOOL) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSActiveSessionExists(pbactivesessionexists : super::PBOOL) -> windows_core::BOOL);
    unsafe { WTSActiveSessionExists(pbactivesessionexists as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSCloseServer(hserver: super::HANDLE) {
    windows_core::link!("wtsapi32.dll" "system" fn WTSCloseServer(hserver : super::HANDLE));
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSCloudAuthNetworkLogonWithSerializedCredential(cloudauthhandle: WTS_CLOUD_AUTH_HANDLE, usercredential: *const WTS_SERIALIZED_USER_CREDENTIAL, token: *mut super::HANDLE) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSCloudAuthNetworkLogonWithSerializedCredential(cloudauthhandle : WTS_CLOUD_AUTH_HANDLE, usercredential : *const WTS_SERIALIZED_USER_CREDENTIAL, token : *mut super::HANDLE) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSCreateListenerA<P3>(hserver: super::HANDLE, preserved: *const core::ffi::c_void, reserved: u32, plistenername: P3, pbuffer: PWTSLISTENERCONFIGA, flag: u32) -> windows_core::BOOL
where
    P3: windows_core::Param<windows_core::PCSTR>,
{
    windows_core::link!("wtsapi32.dll" "system" fn WTSCreateListenerA(hserver : super::HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plistenername : windows_core::PCSTR, pbuffer : PWTSLISTENERCONFIGA, flag : u32) -> windows_core::BOOL);
    unsafe { WTSCreateListenerA(hserver, preserved, reserved, plistenername.param().abi(), pbuffer, flag) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSCreateListenerW<P3>(hserver: super::HANDLE, preserved: *const core::ffi::c_void, reserved: u32, plistenername: P3, pbuffer: PWTSLISTENERCONFIGW, flag: u32) -> windows_core::BOOL
where
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("wtsapi32.dll" "system" fn WTSCreateListenerW(hserver : super::HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plistenername : windows_core::PCWSTR, pbuffer : PWTSLISTENERCONFIGW, flag : u32) -> windows_core::BOOL);
    unsafe { WTSCreateListenerW(hserver, preserved, reserved, plistenername.param().abi(), pbuffer, flag) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSDisconnectSession(hserver: super::HANDLE, sessionid: u32, bwait: bool) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSDisconnectSession(hserver : super::HANDLE, sessionid : u32, bwait : windows_core::BOOL) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSEnumerateListenersA(hserver: super::HANDLE, preserved: *const core::ffi::c_void, reserved: u32, plisteners: Option<PWTSLISTENERNAMEA>, pcount: *mut u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSEnumerateListenersA(hserver : super::HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plisteners : PWTSLISTENERNAMEA, pcount : *mut u32) -> windows_core::BOOL);
    unsafe { WTSEnumerateListenersA(hserver, preserved, reserved, plisteners.unwrap_or(core::mem::zeroed()) as _, pcount as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSEnumerateListenersW(hserver: super::HANDLE, preserved: *const core::ffi::c_void, reserved: u32, plisteners: Option<PWTSLISTENERNAMEW>, pcount: *mut u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSEnumerateListenersW(hserver : super::HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plisteners : PWTSLISTENERNAMEW, pcount : *mut u32) -> windows_core::BOOL);
    unsafe { WTSEnumerateListenersW(hserver, preserved, reserved, plisteners.unwrap_or(core::mem::zeroed()) as _, pcount as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSEnumerateProcessesA(hserver: super::HANDLE, reserved: u32, version: u32, ppprocessinfo: *mut PWTS_PROCESS_INFOA, pcount: *mut u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSEnumerateProcessesA(hserver : super::HANDLE, reserved : u32, version : u32, ppprocessinfo : *mut PWTS_PROCESS_INFOA, pcount : *mut u32) -> windows_core::BOOL);
    unsafe { WTSEnumerateProcessesA(hserver, reserved, version, ppprocessinfo as _, pcount as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSEnumerateProcessesExA(hserver: super::HANDLE, plevel: *mut u32, sessionid: u32, ppprocessinfo: *mut windows_core::PSTR, pcount: *mut u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSEnumerateProcessesExA(hserver : super::HANDLE, plevel : *mut u32, sessionid : u32, ppprocessinfo : *mut windows_core::PSTR, pcount : *mut u32) -> windows_core::BOOL);
    unsafe { WTSEnumerateProcessesExA(hserver, plevel as _, sessionid, ppprocessinfo as _, pcount as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSEnumerateProcessesExW(hserver: super::HANDLE, plevel: *mut u32, sessionid: u32, ppprocessinfo: *mut windows_core::PWSTR, pcount: *mut u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSEnumerateProcessesExW(hserver : super::HANDLE, plevel : *mut u32, sessionid : u32, ppprocessinfo : *mut windows_core::PWSTR, pcount : *mut u32) -> windows_core::BOOL);
    unsafe { WTSEnumerateProcessesExW(hserver, plevel as _, sessionid, ppprocessinfo as _, pcount as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSEnumerateProcessesW(hserver: super::HANDLE, reserved: u32, version: u32, ppprocessinfo: *mut PWTS_PROCESS_INFOW, pcount: *mut u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSEnumerateProcessesW(hserver : super::HANDLE, reserved : u32, version : u32, ppprocessinfo : *mut PWTS_PROCESS_INFOW, pcount : *mut u32) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSEnumerateSessionsA(hserver: super::HANDLE, reserved: u32, version: u32, ppsessioninfo: *mut PWTS_SESSION_INFOA, pcount: *mut u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSEnumerateSessionsA(hserver : super::HANDLE, reserved : u32, version : u32, ppsessioninfo : *mut PWTS_SESSION_INFOA, pcount : *mut u32) -> windows_core::BOOL);
    unsafe { WTSEnumerateSessionsA(hserver, reserved, version, ppsessioninfo as _, pcount as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSEnumerateSessionsExA(hserver: super::HANDLE, plevel: *mut u32, filter: u32, ppsessioninfo: *mut PWTS_SESSION_INFO_1A, pcount: *mut u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSEnumerateSessionsExA(hserver : super::HANDLE, plevel : *mut u32, filter : u32, ppsessioninfo : *mut PWTS_SESSION_INFO_1A, pcount : *mut u32) -> windows_core::BOOL);
    unsafe { WTSEnumerateSessionsExA(hserver, plevel as _, filter, ppsessioninfo as _, pcount as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSEnumerateSessionsExW(hserver: super::HANDLE, plevel: *mut u32, filter: u32, ppsessioninfo: *mut PWTS_SESSION_INFO_1W, pcount: *mut u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSEnumerateSessionsExW(hserver : super::HANDLE, plevel : *mut u32, filter : u32, ppsessioninfo : *mut PWTS_SESSION_INFO_1W, pcount : *mut u32) -> windows_core::BOOL);
    unsafe { WTSEnumerateSessionsExW(hserver, plevel as _, filter, ppsessioninfo as _, pcount as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSEnumerateSessionsW(hserver: super::HANDLE, reserved: u32, version: u32, ppsessioninfo: *mut PWTS_SESSION_INFOW, pcount: *mut u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSEnumerateSessionsW(hserver : super::HANDLE, reserved : u32, version : u32, ppsessioninfo : *mut PWTS_SESSION_INFOW, pcount : *mut u32) -> windows_core::BOOL);
...
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn WTSGetChildSessionId(psessionid: super::PULONG) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "C" fn WTSGetChildSessionId(psessionid : super::PULONG) -> windows_core::BOOL);
    unsafe { WTSGetChildSessionId(psessionid as _) }
}
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn WTSGetListenerSecurityA<P3>(hserver: super::HANDLE, preserved: *const core::ffi::c_void, reserved: u32, plistenername: P3, securityinformation: super::SECURITY_INFORMATION, psecuritydescriptor: Option<super::PSECURITY_DESCRIPTOR>, nlength: u32, lpnlengthneeded: super::LPDWORD) -> windows_core::BOOL
where
    P3: windows_core::Param<windows_core::PCSTR>,
{
    windows_core::link!("wtsapi32.dll" "system" fn WTSGetListenerSecurityA(hserver : super::HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plistenername : windows_core::PCSTR, securityinformation : super::SECURITY_INFORMATION, psecuritydescriptor : super::PSECURITY_DESCRIPTOR, nlength : u32, lpnlengthneeded : super::LPDWORD) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn WTSGetListenerSecurityW<P3>(hserver: super::HANDLE, preserved: *const core::ffi::c_void, reserved: u32, plistenername: P3, securityinformation: super::SECURITY_INFORMATION, psecuritydescriptor: Option<super::PSECURITY_DESCRIPTOR>, nlength: u32, lpnlengthneeded: super::LPDWORD) -> windows_core::BOOL
where
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("wtsapi32.dll" "system" fn WTSGetListenerSecurityW(hserver : super::HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plistenername : windows_core::PCWSTR, securityinformation : super::SECURITY_INFORMATION, psecuritydescriptor : super::PSECURITY_DESCRIPTOR, nlength : u32, lpnlengthneeded : super::LPDWORD) -> windows_core::BOOL);
...
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn WTSIsChildSessionsEnabled(pbenabled: super::PBOOL) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "C" fn WTSIsChildSessionsEnabled(pbenabled : super::PBOOL) -> windows_core::BOOL);
    unsafe { WTSIsChildSessionsEnabled(pbenabled as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSLogoffSession(hserver: super::HANDLE, sessionid: u32, bwait: bool) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSLogoffSession(hserver : super::HANDLE, sessionid : u32, bwait : windows_core::BOOL) -> windows_core::BOOL);
    unsafe { WTSLogoffSession(hserver, sessionid, bwait.into()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSOpenServerA<P0>(pservername: P0) -> super::HANDLE
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_core::link!("wtsapi32.dll" "system" fn WTSOpenServerA(pservername : windows_core::PCSTR) -> super::HANDLE);
    unsafe { WTSOpenServerA(pservername.param().abi()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSOpenServerExA<P0>(pservername: P0) -> super::HANDLE
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_core::link!("wtsapi32.dll" "system" fn WTSOpenServerExA(pservername : windows_core::PCSTR) -> super::HANDLE);
    unsafe { WTSOpenServerExA(pservername.param().abi()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSOpenServerExW<P0>(pservername: P0) -> super::HANDLE
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("wtsapi32.dll" "system" fn WTSOpenServerExW(pservername : windows_core::PCWSTR) -> super::HANDLE);
    unsafe { WTSOpenServerExW(pservername.param().abi()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSOpenServerW<P0>(pservername: P0) -> super::HANDLE
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("wtsapi32.dll" "system" fn WTSOpenServerW(pservername : windows_core::PCWSTR) -> super::HANDLE);
    unsafe { WTSOpenServerW(pservername.param().abi()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSQueryListenerConfigA<P3>(hserver: super::HANDLE, preserved: *const core::ffi::c_void, reserved: u32, plistenername: P3, pbuffer: PWTSLISTENERCONFIGA) -> windows_core::BOOL
where
    P3: windows_core::Param<windows_core::PCSTR>,
{
    windows_core::link!("wtsapi32.dll" "system" fn WTSQueryListenerConfigA(hserver : super::HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plistenername : windows_core::PCSTR, pbuffer : PWTSLISTENERCONFIGA) -> windows_core::BOOL);
    unsafe { WTSQueryListenerConfigA(hserver, preserved, reserved, plistenername.param().abi(), pbuffer as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSQueryListenerConfigW<P3>(hserver: super::HANDLE, preserved: *const core::ffi::c_void, reserved: u32, plistenername: P3, pbuffer: PWTSLISTENERCONFIGW) -> windows_core::BOOL
where
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("wtsapi32.dll" "system" fn WTSQueryListenerConfigW(hserver : super::HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plistenername : windows_core::PCWSTR, pbuffer : PWTSLISTENERCONFIGW) -> windows_core::BOOL);
    unsafe { WTSQueryListenerConfigW(hserver, preserved, reserved, plistenername.param().abi(), pbuffer as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSQuerySessionInformationA(hserver: super::HANDLE, sessionid: u32, wtsinfoclass: WTS_INFO_CLASS, ppbuffer: *mut windows_core::PSTR, pbytesreturned: *mut u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSQuerySessionInformationA(hserver : super::HANDLE, sessionid : u32, wtsinfoclass : WTS_INFO_CLASS, ppbuffer : *mut windows_core::PSTR, pbytesreturned : *mut u32) -> windows_core::BOOL);
    unsafe { WTSQuerySessionInformationA(hserver, sessionid, wtsinfoclass, ppbuffer as _, pbytesreturned as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSQuerySessionInformationW(hserver: super::HANDLE, sessionid: u32, wtsinfoclass: WTS_INFO_CLASS, ppbuffer: *mut windows_core::PWSTR, pbytesreturned: *mut u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSQuerySessionInformationW(hserver : super::HANDLE, sessionid : u32, wtsinfoclass : WTS_INFO_CLASS, ppbuffer : *mut windows_core::PWSTR, pbytesreturned : *mut u32) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSQueryUserToken(sessionid: u32, phtoken: super::PHANDLE) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSQueryUserToken(sessionid : u32, phtoken : super::PHANDLE) -> windows_core::BOOL);
    unsafe { WTSQueryUserToken(sessionid, phtoken) }
}
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn WTSRegisterSessionNotification(hwnd: super::HWND, dwflags: u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSRegisterSessionNotification(hwnd : super::HWND, dwflags : u32) -> windows_core::BOOL);
    unsafe { WTSRegisterSessionNotification(hwnd, dwflags) }
}
#[cfg(all(feature = "windef", feature = "winnt"))]
#[inline]
pub unsafe fn WTSRegisterSessionNotificationEx(hserver: super::HANDLE, hwnd: super::HWND, dwflags: u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSRegisterSessionNotificationEx(hserver : super::HANDLE, hwnd : super::HWND, dwflags : u32) -> windows_core::BOOL);
    unsafe { WTSRegisterSessionNotificationEx(hserver, hwnd, dwflags) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSSendMessageA(hserver: super::HANDLE, sessionid: u32, ptitle: &[u8], pmessage: &[u8], style: u32, timeout: u32, presponse: *mut u32, bwait: bool) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSSendMessageA(hserver : super::HANDLE, sessionid : u32, ptitle : windows_core::PCSTR, titlelength : u32, pmessage : windows_core::PCSTR, messagelength : u32, style : u32, timeout : u32, presponse : *mut u32, bwait : windows_core::BOOL) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSSendMessageW<P2, P4>(hserver: super::HANDLE, sessionid: u32, ptitle: P2, titlelength: u32, pmessage: P4, messagelength: u32, style: u32, timeout: u32, presponse: *mut u32, bwait: bool) -> windows_core::BOOL
where
    P2: windows_core::Param<windows_core::PCWSTR>,
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("wtsapi32.dll" "system" fn WTSSendMessageW(hserver : super::HANDLE, sessionid : u32, ptitle : windows_core::PCWSTR, titlelength : u32, pmessage : windows_core::PCWSTR, messagelength : u32, style : u32, timeout : u32, presponse : *mut u32, bwait : windows_core::BOOL) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSSetListenerSecurityA<P3>(hserver: super::HANDLE, preserved: *const core::ffi::c_void, reserved: u32, plistenername: P3, securityinformation: super::SECURITY_INFORMATION, psecuritydescriptor: super::PSECURITY_DESCRIPTOR) -> windows_core::BOOL
where
    P3: windows_core::Param<windows_core::PCSTR>,
{
    windows_core::link!("wtsapi32.dll" "system" fn WTSSetListenerSecurityA(hserver : super::HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plistenername : windows_core::PCSTR, securityinformation : super::SECURITY_INFORMATION, psecuritydescriptor : super::PSECURITY_DESCRIPTOR) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSSetListenerSecurityW<P3>(hserver: super::HANDLE, preserved: *const core::ffi::c_void, reserved: u32, plistenername: P3, securityinformation: super::SECURITY_INFORMATION, psecuritydescriptor: super::PSECURITY_DESCRIPTOR) -> windows_core::BOOL
where
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("wtsapi32.dll" "system" fn WTSSetListenerSecurityW(hserver : super::HANDLE, preserved : *const core::ffi::c_void, reserved : u32, plistenername : windows_core::PCWSTR, securityinformation : super::SECURITY_INFORMATION, psecuritydescriptor : super::PSECURITY_DESCRIPTOR) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSShutdownSystem(hserver: super::HANDLE, shutdownflag: u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSShutdownSystem(hserver : super::HANDLE, shutdownflag : u32) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSTerminateProcess(hserver: super::HANDLE, processid: u32, exitcode: u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSTerminateProcess(hserver : super::HANDLE, processid : u32, exitcode : u32) -> windows_core::BOOL);
    unsafe { WTSTerminateProcess(hserver, processid, exitcode) }
}
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn WTSUnRegisterSessionNotification(hwnd: super::HWND) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSUnRegisterSessionNotification(hwnd : super::HWND) -> windows_core::BOOL);
    unsafe { WTSUnRegisterSessionNotification(hwnd) }
}
#[cfg(all(feature = "windef", feature = "winnt"))]
#[inline]
pub unsafe fn WTSUnRegisterSessionNotificationEx(hserver: super::HANDLE, hwnd: super::HWND) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSUnRegisterSessionNotificationEx(hserver : super::HANDLE, hwnd : super::HWND) -> windows_core::BOOL);
    unsafe { WTSUnRegisterSessionNotificationEx(hserver, hwnd) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSVirtualChannelClose(hchannelhandle: super::HANDLE) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSVirtualChannelClose(hchannelhandle : super::HANDLE) -> windows_core::BOOL);
    unsafe { WTSVirtualChannelClose(hchannelhandle) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSVirtualChannelOpen<P2>(hserver: super::HANDLE, sessionid: u32, pvirtualname: P2) -> super::HANDLE
where
    P2: windows_core::Param<windows_core::PCSTR>,
{
    windows_core::link!("wtsapi32.dll" "system" fn WTSVirtualChannelOpen(hserver : super::HANDLE, sessionid : u32, pvirtualname : windows_core::PCSTR) -> super::HANDLE);
    unsafe { WTSVirtualChannelOpen(hserver, sessionid, pvirtualname.param().abi()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSVirtualChannelOpenEx<P1>(sessionid: u32, pvirtualname: P1, flags: u32) -> super::HANDLE
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_core::link!("wtsapi32.dll" "system" fn WTSVirtualChannelOpenEx(sessionid : u32, pvirtualname : windows_core::PCSTR, flags : u32) -> super::HANDLE);
    unsafe { WTSVirtualChannelOpenEx(sessionid, pvirtualname.param().abi(), flags) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSVirtualChannelPurgeInput(hchannelhandle: super::HANDLE) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSVirtualChannelPurgeInput(hchannelhandle : super::HANDLE) -> windows_core::BOOL);
    unsafe { WTSVirtualChannelPurgeInput(hchannelhandle) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSVirtualChannelPurgeOutput(hchannelhandle: super::HANDLE) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSVirtualChannelPurgeOutput(hchannelhandle : super::HANDLE) -> windows_core::BOOL);
    unsafe { WTSVirtualChannelPurgeOutput(hchannelhandle) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSVirtualChannelQuery(hchannelhandle: super::HANDLE, param1: WTS_VIRTUAL_CLASS, ppbuffer: *mut *mut core::ffi::c_void, pbytesreturned: *mut u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSVirtualChannelQuery(hchannelhandle : super::HANDLE, param1 : WTS_VIRTUAL_CLASS, ppbuffer : *mut *mut core::ffi::c_void, pbytesreturned : *mut u32) -> windows_core::BOOL);
    unsafe { WTSVirtualChannelQuery(hchannelhandle, param1, ppbuffer as _, pbytesreturned as _) }
}
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn WTSVirtualChannelRead(hchannelhandle: super::HANDLE, timeout: u32, buffer: super::PCHAR, buffersize: u32, pbytesread: super::PULONG) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSVirtualChannelRead(hchannelhandle : super::HANDLE, timeout : u32, buffer : super::PCHAR, buffersize : u32, pbytesread : super::PULONG) -> windows_core::BOOL);
    unsafe { WTSVirtualChannelRead(hchannelhandle, timeout, buffer as _, buffersize, pbytesread as _) }
}
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn WTSVirtualChannelWrite(hchannelhandle: super::HANDLE, buffer: &[u8], pbyteswritten: super::PULONG) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSVirtualChannelWrite(hchannelhandle : super::HANDLE, buffer : super::PCHAR, length : u32, pbyteswritten : super::PULONG) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn WTSWaitSystemEvent(hserver: super::HANDLE, eventmask: u32, peventflags: *mut u32) -> windows_core::BOOL {
    windows_core::link!("wtsapi32.dll" "system" fn WTSWaitSystemEvent(hserver : super::HANDLE, eventmask : u32, peventflags : *mut u32) -> windows_core::BOOL);
...
pub struct WTSINFOA {
    ...
    pub Domain: [i8; 17],
    pub UserName: [i8; 21],
    pub ConnectTime: super::LARGE_INTEGER,
    pub DisconnectTime: super::LARGE_INTEGER,
    pub LastInputTime: super::LARGE_INTEGER,
...
pub type WTS_CLOUD_AUTH_HANDLE = *mut WTS_CLOUD_AUTH_HANDLE__;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct WTS_CLOUD_AUTH_HANDLE__ {
    pub unused: i32,
}
...
#[cfg(feature = "winnt")]
pub const WTS_CURRENT_SERVER: super::HANDLE = 0 as _;
#[cfg(feature = "winnt")]
pub const WTS_CURRENT_SERVER_HANDLE: super::HANDLE = 0 as _;
