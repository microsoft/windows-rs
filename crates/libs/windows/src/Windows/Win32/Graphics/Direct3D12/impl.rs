...
impl ID3D12Device14_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: ID3D12Device14_Impl, const OFFSET: isize>() -> ID3D12Device14_Vtbl {
        unsafe extern "system" fn CreateRootSignatureFromSubobjectInLibrary<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: ID3D12Device14_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, nodemask: u32, plibraryblob: *const core::ffi::c_void, bloblengthinbytes: usize, subobjectname: windows_core::PCWSTR, riid: *const windows_core::GUID, ppvrootsignature: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
...
impl ID3D12GBVDiagnostics_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: ID3D12GBVDiagnostics_Impl, const OFFSET: isize>() -> ID3D12GBVDiagnostics_Vtbl {
        unsafe extern "system" fn GetGBVEntireSubresourceStatesData<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: ID3D12GBVDiagnostics_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, presource: *mut core::ffi::c_void, pdata: *mut i32, datasize: u32) -> windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
        ...
        unsafe extern "system" fn GetGBVSubresourceState<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: ID3D12GBVDiagnostics_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, presource: *mut core::ffi::c_void, subresource: u32, pdata: *mut i32) -> windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
        ...
        unsafe extern "system" fn GetGBVResourceUniformState<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: ID3D12GBVDiagnostics_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, presource: *mut core::ffi::c_void, pdata: *mut i32) -> windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
        ...
        unsafe extern "system" fn GetGBVResourceInfo<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: ID3D12GBVDiagnostics_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, presource: *mut core::ffi::c_void, presourcedesc: *const D3D12_RESOURCE_DESC, presourcehash: *const u32, psubresourcestatesbyteoffset: *const u32) -> windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
        ...
        unsafe extern "system" fn GBVReserved0<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: ID3D12GBVDiagnostics_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
            ID3D12GBVDiagnostics_Impl::GBVReserved0(this)
        }
        unsafe extern "system" fn GBVReserved1<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: ID3D12GBVDiagnostics_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
        ...
        Self {
            base__: windows_core::IUnknown_Vtbl::new::<Identity, OFFSET>(),
            GetGBVEntireSubresourceStatesData: GetGBVEntireSubresourceStatesData::<Identity, Impl, OFFSET>,
            GetGBVSubresourceState: GetGBVSubresourceState::<Identity, Impl, OFFSET>,
            GetGBVResourceUniformState: GetGBVResourceUniformState::<Identity, Impl, OFFSET>,
            GetGBVResourceInfo: GetGBVResourceInfo::<Identity, Impl, OFFSET>,
            GBVReserved0: GBVReserved0::<Identity, Impl, OFFSET>,
            GBVReserved1: GBVReserved1::<Identity, Impl, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl ID3D12GraphicsCommandList10_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: ID3D12GraphicsCommandList10_Impl, const OFFSET: isize>() -> ID3D12GraphicsCommandList10_Vtbl {
        unsafe extern "system" fn SetProgram<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: ID3D12GraphicsCommandList10_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pdesc: *const D3D12_SET_PROGRAM_DESC) {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
            ID3D12GraphicsCommandList10_Impl::SetProgram(this, core::mem::transmute_copy(&pdesc))
        }
        unsafe extern "system" fn DispatchGraph<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: ID3D12GraphicsCommandList10_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pdesc: *const D3D12_DISPATCH_GRAPH_DESC) {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
...
impl ID3D12WorkGraphProperties_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: ID3D12WorkGraphProperties_Impl, const OFFSET: isize>() -> ID3D12WorkGraphProperties_Vtbl {
        ...
        unsafe extern "system" fn GetEntrypointRecordAlignmentInBytes<Identity: windows_core::IUnknownImpl<Impl = Impl>, Impl: ID3D12WorkGraphProperties_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, workgraphindex: u32, entrypointindex: u32) -> u32 {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
        ...
        Self {
            ...
            GetEntrypointRecordAlignmentInBytes: GetEntrypointRecordAlignmentInBytes::<Identity, Impl, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
