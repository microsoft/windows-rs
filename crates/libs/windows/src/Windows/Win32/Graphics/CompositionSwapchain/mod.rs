    ...
    P0: windows_core::Param<windows_core::IUnknown>,
{
    ...
    CreatePresentationFactory(d3ddevice.param().abi(), core::mem::transmute(riid), core::mem::transmute(presentationfactory)).ok()
}
...
impl IIndependentFlipFramePresentStatistics_Vtbl {
    ...
    pub fn matches(iid: &windows_core::GUID) -> bool {
        iid == &<IIndependentFlipFramePresentStatistics as windows_core::Interface>::IID
    }
}
...
impl IPresentationManager {
    ...
    pub unsafe fn GetPresentRetiringFence(&self, riid: *const windows_core::GUID) -> windows_core::Result<*mut core::ffi::c_void> {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).GetPresentRetiringFence)(windows_core::Interface::as_raw(self), core::mem::transmute(riid), &mut result__).map(|| result__)
    }
