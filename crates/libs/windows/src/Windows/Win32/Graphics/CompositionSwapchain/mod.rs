#[inline]
pub unsafe fn CreatePresentationFactory<P0, T>(d3ddevice: P0) -> windows_result::Result<T>
where
    P0: windows_core::Param<windows_core::IUnknown>,
    T: windows_core::Interface,
{
    windows_link::link!("dcomp.dll" "system" fn CreatePresentationFactory(d3ddevice : * mut core::ffi::c_void, riid : *const windows_core::GUID, presentationfactory : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
...
impl IPresentationBuffer {
    pub unsafe fn GetAvailableEvent(&self) -> windows_result::Result<super::super::Foundation::HANDLE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAvailableEvent)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn IsAvailable(&self) -> windows_result::Result<u8> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPresentationBuffer_Impl: windows_core::IUnknownImpl {
    fn GetAvailableEvent(&self) -> windows_result::Result<super::super::Foundation::HANDLE>;
    fn IsAvailable(&self) -> windows_result::Result<u8>;
}
...
impl IPresentationFactory {
    ...
    pub unsafe fn CreatePresentationManager(&self) -> windows_result::Result<IPresentationManager> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPresentationFactory_Impl: windows_core::IUnknownImpl {
    ...
    fn CreatePresentationManager(&self) -> windows_result::Result<IPresentationManager>;
}
...
impl IPresentationManager {
    pub unsafe fn AddBufferFromResource<P0>(&self, resource: P0) -> windows_result::Result<IPresentationBuffer>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
    ...
    pub unsafe fn CreatePresentationSurface(&self, compositionsurfacehandle: super::super::Foundation::HANDLE) -> windows_result::Result<IPresentationSurface> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetTargetTime(&self, targettime: SystemInterruptTime) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetPreferredPresentDuration(&self, preferredduration: SystemInterruptTime, deviationtolerance: SystemInterruptTime) -> windows_result::Result<()> {
    ...
    pub unsafe fn CancelPresentsFrom(&self, presentidtocancelfrom: u64) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).CancelPresentsFrom)(windows_core::Interface::as_raw(self), presentidtocancelfrom).ok() }
    }
    pub unsafe fn GetLostEvent(&self) -> windows_result::Result<super::super::Foundation::HANDLE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLostEvent)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetPresentStatisticsAvailableEvent(&self) -> windows_result::Result<super::super::Foundation::HANDLE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnablePresentStatisticsKind(&self, presentstatisticskind: PresentStatisticsKind, enabled: u8) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetNextPresentStatistics(&self) -> windows_result::Result<IPresentStatistics> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPresentationManager_Impl: windows_core::IUnknownImpl {
    fn AddBufferFromResource(&self, resource: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<IPresentationBuffer>;
    fn CreatePresentationSurface(&self, compositionsurfacehandle: super::super::Foundation::HANDLE) -> windows_result::Result<IPresentationSurface>;
    fn GetNextPresentId(&self) -> u64;
    fn SetTargetTime(&self, targettime: &SystemInterruptTime) -> windows_result::Result<()>;
    fn SetPreferredPresentDuration(&self, preferredduration: &SystemInterruptTime, deviationtolerance: &SystemInterruptTime) -> windows_result::Result<()>;
    fn ForceVSyncInterrupt(&self, forcevsyncinterrupt: u8) -> windows_result::Result<()>;
    fn Present(&self) -> windows_result::Result<()>;
    fn GetPresentRetiringFence(&self, riid: *const windows_core::GUID, fence: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn CancelPresentsFrom(&self, presentidtocancelfrom: u64) -> windows_result::Result<()>;
    fn GetLostEvent(&self) -> windows_result::Result<super::super::Foundation::HANDLE>;
    fn GetPresentStatisticsAvailableEvent(&self) -> windows_result::Result<super::super::Foundation::HANDLE>;
    fn EnablePresentStatisticsKind(&self, presentstatisticskind: PresentStatisticsKind, enabled: u8) -> windows_result::Result<()>;
    fn GetNextPresentStatistics(&self) -> windows_result::Result<IPresentStatistics>;
}
...
impl IPresentationSurface {
    pub unsafe fn SetBuffer<P0>(&self, presentationbuffer: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn SetColorSpace(&self, colorspace: super::Dxgi::Common::DXGI_COLOR_SPACE_TYPE) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetColorSpace)(windows_core::Interface::as_raw(self), colorspace).ok() }
    }
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn SetAlphaMode(&self, alphamode: super::Dxgi::Common::DXGI_ALPHA_MODE) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetAlphaMode)(windows_core::Interface::as_raw(self), alphamode).ok() }
    }
    pub unsafe fn SetSourceRect(&self, sourcerect: *const super::super::Foundation::RECT) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetSourceRect)(windows_core::Interface::as_raw(self), sourcerect).ok() }
    }
    pub unsafe fn SetTransform(&self, transform: *const PresentationTransform) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetTransform)(windows_core::Interface::as_raw(self), transform).ok() }
    }
    pub unsafe fn RestrictToOutput<P0>(&self, output: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe { (windows_core::Interface::vtable(self).RestrictToOutput)(windows_core::Interface::as_raw(self), output.param().abi()).ok() }
    }
    pub unsafe fn SetDisableReadback(&self, value: u8) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetDisableReadback)(windows_core::Interface::as_raw(self), value).ok() }
    }
    pub unsafe fn SetLetterboxingMargins(&self, leftletterboxsize: f32, topletterboxsize: f32, rightletterboxsize: f32, bottomletterboxsize: f32) -> windows_result::Result<()> {
...
pub trait IPresentationSurface_Impl: IPresentationContent_Impl {
    fn SetBuffer(&self, presentationbuffer: windows_core::Ref<IPresentationBuffer>) -> windows_result::Result<()>;
    fn SetColorSpace(&self, colorspace: super::Dxgi::Common::DXGI_COLOR_SPACE_TYPE) -> windows_result::Result<()>;
    fn SetAlphaMode(&self, alphamode: super::Dxgi::Common::DXGI_ALPHA_MODE) -> windows_result::Result<()>;
    fn SetSourceRect(&self, sourcerect: *const super::super::Foundation::RECT) -> windows_result::Result<()>;
    fn SetTransform(&self, transform: *const PresentationTransform) -> windows_result::Result<()>;
    fn RestrictToOutput(&self, output: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn SetDisableReadback(&self, value: u8) -> windows_result::Result<()>;
    fn SetLetterboxingMargins(&self, leftletterboxsize: f32, topletterboxsize: f32, rightletterboxsize: f32, bottomletterboxsize: f32) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
