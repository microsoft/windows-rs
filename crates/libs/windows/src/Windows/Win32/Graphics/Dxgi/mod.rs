...
pub mod Common;
pub const DXGI_ADAPTER_FLAG3_ACG_COMPATIBLE: DXGI_ADAPTER_FLAG3 = 4i32;
pub const DXGI_ADAPTER_FLAG3_KEYED_MUTEX_CONFORMANCE: DXGI_ADAPTER_FLAG3 = 32i32;
pub const DXGI_ADAPTER_FLAG3_NONE: DXGI_ADAPTER_FLAG3 = 0i32;
pub const DXGI_ADAPTER_FLAG3_REMOTE: DXGI_ADAPTER_FLAG3 = 1i32;
pub const DXGI_ADAPTER_FLAG3_SOFTWARE: DXGI_ADAPTER_FLAG3 = 2i32;
pub const DXGI_ADAPTER_FLAG3_SUPPORT_MONITORED_FENCES: DXGI_ADAPTER_FLAG3 = 8i32;
pub const DXGI_ADAPTER_FLAG3_SUPPORT_NON_MONITORED_FENCES: DXGI_ADAPTER_FLAG3 = 16i32;
pub const DXGI_ADAPTER_FLAG_NONE: DXGI_ADAPTER_FLAG = 0i32;
pub const DXGI_ADAPTER_FLAG_REMOTE: DXGI_ADAPTER_FLAG = 1i32;
pub const DXGI_ADAPTER_FLAG_SOFTWARE: DXGI_ADAPTER_FLAG = 2i32;
...
pub const DXGI_CREATE_FACTORY_DEBUG: DXGI_CREATE_FACTORY_FLAGS = 1u32;
...
pub const DXGI_DEBUG_RLO_ALL: DXGI_DEBUG_RLO_FLAGS = 7i32;
pub const DXGI_DEBUG_RLO_DETAIL: DXGI_DEBUG_RLO_FLAGS = 2i32;
pub const DXGI_DEBUG_RLO_IGNORE_INTERNAL: DXGI_DEBUG_RLO_FLAGS = 4i32;
pub const DXGI_DEBUG_RLO_SUMMARY: DXGI_DEBUG_RLO_FLAGS = 1i32;
pub const DXGI_ENUM_MODES_DISABLED_STEREO: DXGI_ENUM_MODES = 8u32;
pub const DXGI_ENUM_MODES_INTERLACED: DXGI_ENUM_MODES = 1u32;
pub const DXGI_ENUM_MODES_SCALING: DXGI_ENUM_MODES = 2u32;
pub const DXGI_ENUM_MODES_STEREO: DXGI_ENUM_MODES = 4u32;
pub const DXGI_ERROR_ACCESS_DENIED: windows_core::HRESULT = 0x887A002B_u32 as _;
pub const DXGI_ERROR_ACCESS_LOST: windows_core::HRESULT = 0x887A0026_u32 as _;
pub const DXGI_ERROR_ALREADY_EXISTS: windows_core::HRESULT = 0x887A0036_u32 as _;
pub const DXGI_ERROR_CACHE_CORRUPT: windows_core::HRESULT = 0x887A0033_u32 as _;
pub const DXGI_ERROR_CACHE_FULL: windows_core::HRESULT = 0x887A0034_u32 as _;
pub const DXGI_ERROR_CACHE_HASH_COLLISION: windows_core::HRESULT = 0x887A0035_u32 as _;
pub const DXGI_ERROR_CANNOT_PROTECT_CONTENT: windows_core::HRESULT = 0x887A002A_u32 as _;
pub const DXGI_ERROR_DEVICE_HUNG: windows_core::HRESULT = 0x887A0006_u32 as _;
pub const DXGI_ERROR_DEVICE_REMOVED: windows_core::HRESULT = 0x887A0005_u32 as _;
pub const DXGI_ERROR_DEVICE_RESET: windows_core::HRESULT = 0x887A0007_u32 as _;
pub const DXGI_ERROR_DRIVER_INTERNAL_ERROR: windows_core::HRESULT = 0x887A0020_u32 as _;
pub const DXGI_ERROR_DYNAMIC_CODE_POLICY_VIOLATION: windows_core::HRESULT = 0x887A0031_u32 as _;
pub const DXGI_ERROR_FRAME_STATISTICS_DISJOINT: windows_core::HRESULT = 0x887A000B_u32 as _;
pub const DXGI_ERROR_GRAPHICS_VIDPN_SOURCE_IN_USE: windows_core::HRESULT = 0x887A000C_u32 as _;
pub const DXGI_ERROR_HW_PROTECTION_OUTOFMEMORY: windows_core::HRESULT = 0x887A0030_u32 as _;
pub const DXGI_ERROR_INVALID_CALL: windows_core::HRESULT = 0x887A0001_u32 as _;
pub const DXGI_ERROR_MODE_CHANGE_IN_PROGRESS: windows_core::HRESULT = 0x887A0025_u32 as _;
pub const DXGI_ERROR_MORE_DATA: windows_core::HRESULT = 0x887A0003_u32 as _;
pub const DXGI_ERROR_MPO_UNPINNED: windows_core::HRESULT = 0x887A0064_u32 as _;
pub const DXGI_ERROR_NAME_ALREADY_EXISTS: windows_core::HRESULT = 0x887A002C_u32 as _;
pub const DXGI_ERROR_NONEXCLUSIVE: windows_core::HRESULT = 0x887A0021_u32 as _;
pub const DXGI_ERROR_NON_COMPOSITED_UI: windows_core::HRESULT = 0x887A0032_u32 as _;
pub const DXGI_ERROR_NOT_CURRENT: windows_core::HRESULT = 0x887A002E_u32 as _;
pub const DXGI_ERROR_NOT_CURRENTLY_AVAILABLE: windows_core::HRESULT = 0x887A0022_u32 as _;
pub const DXGI_ERROR_NOT_FOUND: windows_core::HRESULT = 0x887A0002_u32 as _;
pub const DXGI_ERROR_REMOTE_CLIENT_DISCONNECTED: windows_core::HRESULT = 0x887A0023_u32 as _;
pub const DXGI_ERROR_REMOTE_OUTOFMEMORY: windows_core::HRESULT = 0x887A0024_u32 as _;
pub const DXGI_ERROR_RESTRICT_TO_OUTPUT_STALE: windows_core::HRESULT = 0x887A0029_u32 as _;
pub const DXGI_ERROR_SDK_COMPONENT_MISSING: windows_core::HRESULT = 0x887A002D_u32 as _;
pub const DXGI_ERROR_SESSION_DISCONNECTED: windows_core::HRESULT = 0x887A0028_u32 as _;
pub const DXGI_ERROR_UNSUPPORTED: windows_core::HRESULT = 0x887A0004_u32 as _;
pub const DXGI_ERROR_WAIT_TIMEOUT: windows_core::HRESULT = 0x887A0027_u32 as _;
pub const DXGI_ERROR_WAS_STILL_DRAWING: windows_core::HRESULT = 0x887A000A_u32 as _;
...
pub const DXGI_HARDWARE_COMPOSITION_SUPPORT_FLAG_CURSOR_STRETCHED: DXGI_HARDWARE_COMPOSITION_SUPPORT_FLAGS = 4i32;
pub const DXGI_HARDWARE_COMPOSITION_SUPPORT_FLAG_FULLSCREEN: DXGI_HARDWARE_COMPOSITION_SUPPORT_FLAGS = 1i32;
pub const DXGI_HARDWARE_COMPOSITION_SUPPORT_FLAG_WINDOWED: DXGI_HARDWARE_COMPOSITION_SUPPORT_FLAGS = 2i32;
...
pub const DXGI_MAP_DISCARD: DXGI_MAP_FLAGS = 4u32;
pub const DXGI_MAP_READ: DXGI_MAP_FLAGS = 1u32;
pub const DXGI_MAP_WRITE: DXGI_MAP_FLAGS = 2u32;
...
pub const DXGI_MWA_NO_ALT_ENTER: DXGI_MWA_FLAGS = 2u32;
pub const DXGI_MWA_NO_PRINT_SCREEN: DXGI_MWA_FLAGS = 4u32;
pub const DXGI_MWA_NO_WINDOW_CHANGES: DXGI_MWA_FLAGS = 1u32;
pub const DXGI_MWA_VALID: DXGI_MWA_FLAGS = 7u32;
...
pub const DXGI_PRESENT_ALLOW_TEARING: DXGI_PRESENT = 512u32;
pub const DXGI_PRESENT_DO_NOT_SEQUENCE: DXGI_PRESENT = 2u32;
pub const DXGI_PRESENT_DO_NOT_WAIT: DXGI_PRESENT = 8u32;
pub const DXGI_PRESENT_RESTART: DXGI_PRESENT = 4u32;
pub const DXGI_PRESENT_RESTRICT_TO_OUTPUT: DXGI_PRESENT = 64u32;
pub const DXGI_PRESENT_STEREO_PREFER_RIGHT: DXGI_PRESENT = 16u32;
pub const DXGI_PRESENT_STEREO_TEMPORARY_MONO: DXGI_PRESENT = 32u32;
pub const DXGI_PRESENT_TEST: DXGI_PRESENT = 1u32;
pub const DXGI_PRESENT_USE_DURATION: DXGI_PRESENT = 256u32;
...
pub const DXGI_SHARED_RESOURCE_READ: DXGI_SHARED_RESOURCE_RW = 2147483648u32;
pub const DXGI_SHARED_RESOURCE_WRITE: DXGI_SHARED_RESOURCE_RW = 1u32;
