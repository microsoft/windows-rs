...
pub const DXGI_ERROR_ACCESS_DENIED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A002Bu32 as _);
pub const DXGI_ERROR_ACCESS_LOST: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0026u32 as _);
pub const DXGI_ERROR_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0036u32 as _);
pub const DXGI_ERROR_CACHE_CORRUPT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0033u32 as _);
pub const DXGI_ERROR_CACHE_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0034u32 as _);
pub const DXGI_ERROR_CACHE_HASH_COLLISION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0035u32 as _);
pub const DXGI_ERROR_CANNOT_PROTECT_CONTENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A002Au32 as _);
pub const DXGI_ERROR_DEVICE_HUNG: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0006u32 as _);
pub const DXGI_ERROR_DEVICE_REMOVED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0005u32 as _);
pub const DXGI_ERROR_DEVICE_RESET: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0007u32 as _);
pub const DXGI_ERROR_DRIVER_INTERNAL_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0020u32 as _);
pub const DXGI_ERROR_DYNAMIC_CODE_POLICY_VIOLATION: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0031u32 as _);
pub const DXGI_ERROR_FRAME_STATISTICS_DISJOINT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A000Bu32 as _);
pub const DXGI_ERROR_GRAPHICS_VIDPN_SOURCE_IN_USE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A000Cu32 as _);
pub const DXGI_ERROR_HW_PROTECTION_OUTOFMEMORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0030u32 as _);
pub const DXGI_ERROR_INVALID_CALL: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0001u32 as _);
pub const DXGI_ERROR_MODE_CHANGE_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0025u32 as _);
pub const DXGI_ERROR_MORE_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0003u32 as _);
pub const DXGI_ERROR_MPO_UNPINNED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0064u32 as _);
pub const DXGI_ERROR_NAME_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A002Cu32 as _);
pub const DXGI_ERROR_NONEXCLUSIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0021u32 as _);
pub const DXGI_ERROR_NON_COMPOSITED_UI: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0032u32 as _);
pub const DXGI_ERROR_NOT_CURRENT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A002Eu32 as _);
pub const DXGI_ERROR_NOT_CURRENTLY_AVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0022u32 as _);
pub const DXGI_ERROR_NOT_FOUND: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0002u32 as _);
pub const DXGI_ERROR_REMOTE_CLIENT_DISCONNECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0023u32 as _);
pub const DXGI_ERROR_REMOTE_OUTOFMEMORY: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0024u32 as _);
pub const DXGI_ERROR_RESTRICT_TO_OUTPUT_STALE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0029u32 as _);
pub const DXGI_ERROR_SDK_COMPONENT_MISSING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A002Du32 as _);
pub const DXGI_ERROR_SESSION_DISCONNECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0028u32 as _);
pub const DXGI_ERROR_UNSUPPORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0004u32 as _);
pub const DXGI_ERROR_WAIT_TIMEOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A0027u32 as _);
pub const DXGI_ERROR_WAS_STILL_DRAWING: ::windows_core::HRESULT = ::windows_core::HRESULT(0x887A000Au32 as _);
