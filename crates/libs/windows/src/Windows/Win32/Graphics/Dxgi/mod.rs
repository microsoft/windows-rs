...
pub mod Common;
#[inline]
pub unsafe fn CreateDXGIFactory<T>() -> windows_result::Result<T>
where
...
#[inline]
pub unsafe fn CreateDXGIFactory1<T>() -> windows_result::Result<T>
where
    T: windows_core::Interface,
{
...
#[inline]
pub unsafe fn CreateDXGIFactory2<T>(flags: DXGI_CREATE_FACTORY_FLAGS) -> windows_result::Result<T>
where
    T: windows_core::Interface,
{
...
#[inline]
pub unsafe fn DXGIDeclareAdapterRemovalSupport() -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn DXGIDisableVBlankVirtualization() -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn DXGIGetDebugInterface1<T>(flags: u32) -> windows_result::Result<T>
where
    T: windows_core::Interface,
{
...
impl IDXGIAdapter {
    pub unsafe fn EnumOutputs(&self, output: u32) -> windows_result::Result<IDXGIOutput> {
        unsafe {
    ...
    pub unsafe fn GetDesc(&self) -> windows_result::Result<DXGI_ADAPTER_DESC> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDesc)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn CheckInterfaceSupport(&self, interfacename: *const windows_core::GUID) -> windows_result::Result<i64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDXGIAdapter_Impl: IDXGIObject_Impl {
    fn EnumOutputs(&self, output: u32) -> windows_result::Result<IDXGIOutput>;
    fn GetDesc(&self) -> windows_result::Result<DXGI_ADAPTER_DESC>;
    fn CheckInterfaceSupport(&self, interfacename: *const windows_core::GUID) -> windows_result::Result<i64>;
}
...
impl IDXGIAdapter1 {
    pub unsafe fn GetDesc1(&self) -> windows_result::Result<DXGI_ADAPTER_DESC1> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDXGIAdapter1_Impl: IDXGIAdapter_Impl {
    fn GetDesc1(&self) -> windows_result::Result<DXGI_ADAPTER_DESC1>;
}
...
impl IDXGIAdapter2 {
    pub unsafe fn GetDesc2(&self) -> windows_result::Result<DXGI_ADAPTER_DESC2> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDXGIAdapter2_Impl: IDXGIAdapter1_Impl {
    fn GetDesc2(&self) -> windows_result::Result<DXGI_ADAPTER_DESC2>;
}
...
impl IDXGIAdapter3 {
    pub unsafe fn RegisterHardwareContentProtectionTeardownStatusEvent(&self, hevent: super::super::Foundation::HANDLE) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn QueryVideoMemoryInfo(&self, nodeindex: u32, memorysegmentgroup: DXGI_MEMORY_SEGMENT_GROUP, pvideomemoryinfo: *mut DXGI_QUERY_VIDEO_MEMORY_INFO) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetVideoMemoryReservation(&self, nodeindex: u32, memorysegmentgroup: DXGI_MEMORY_SEGMENT_GROUP, reservation: u64) -> windows_result::Result<()> {
    ...
    pub unsafe fn RegisterVideoMemoryBudgetChangeNotificationEvent(&self, hevent: super::super::Foundation::HANDLE) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDXGIAdapter3_Impl: IDXGIAdapter2_Impl {
    fn RegisterHardwareContentProtectionTeardownStatusEvent(&self, hevent: super::super::Foundation::HANDLE) -> windows_result::Result<u32>;
    fn UnregisterHardwareContentProtectionTeardownStatus(&self, dwcookie: u32);
    fn QueryVideoMemoryInfo(&self, nodeindex: u32, memorysegmentgroup: DXGI_MEMORY_SEGMENT_GROUP, pvideomemoryinfo: *mut DXGI_QUERY_VIDEO_MEMORY_INFO) -> windows_result::Result<()>;
    fn SetVideoMemoryReservation(&self, nodeindex: u32, memorysegmentgroup: DXGI_MEMORY_SEGMENT_GROUP, reservation: u64) -> windows_result::Result<()>;
    fn RegisterVideoMemoryBudgetChangeNotificationEvent(&self, hevent: super::super::Foundation::HANDLE) -> windows_result::Result<u32>;
...
impl IDXGIAdapter4 {
    pub unsafe fn GetDesc3(&self) -> windows_result::Result<DXGI_ADAPTER_DESC3> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDXGIAdapter4_Impl: IDXGIAdapter3_Impl {
    fn GetDesc3(&self) -> windows_result::Result<DXGI_ADAPTER_DESC3>;
}
...
impl IDXGIDebug {
    pub unsafe fn ReportLiveObjects(&self, apiid: windows_core::GUID, flags: DXGI_DEBUG_RLO_FLAGS) -> windows_result::Result<()> {
...
pub trait IDXGIDebug_Impl: windows_core::IUnknownImpl {
    fn ReportLiveObjects(&self, apiid: &windows_core::GUID, flags: DXGI_DEBUG_RLO_FLAGS) -> windows_result::Result<()>;
}
...
pub trait IDXGIDecodeSwapChain_Impl: windows_core::IUnknownImpl {
    ...
    fn SetSourceRect(&self, prect: *const super::super::Foundation::RECT) -> windows_result::Result<()>;
    fn SetTargetRect(&self, prect: *const super::super::Foundation::RECT) -> windows_result::Result<()>;
    fn SetDestSize(&self, width: u32, height: u32) -> windows_result::Result<()>;
    fn GetSourceRect(&self) -> windows_result::Result<super::super::Foundation::RECT>;
    fn GetTargetRect(&self) -> windows_result::Result<super::super::Foundation::RECT>;
    fn GetDestSize(&self, pwidth: *mut u32, pheight: *mut u32) -> windows_result::Result<()>;
    fn SetColorSpace(&self, colorspace: DXGI_MULTIPLANE_OVERLAY_YCbCr_FLAGS) -> windows_result::Result<()>;
...
impl IDXGIDevice {
    pub unsafe fn GetAdapter(&self) -> windows_result::Result<IDXGIAdapter> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn CreateSurface(&self, pdesc: *const DXGI_SURFACE_DESC, usage: DXGI_USAGE, psharedresource: Option<*const DXGI_SHARED_RESOURCE>, ppsurface: &mut [Option<IDXGISurface>]) -> windows_result::Result<()> {
    ...
    pub unsafe fn QueryResourceResidency(&self, ppresources: *const Option<windows_core::IUnknown>, presidencystatus: *mut DXGI_RESIDENCY, numresources: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetGPUThreadPriority(&self) -> windows_result::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDXGIDevice_Impl: IDXGIObject_Impl {
    fn GetAdapter(&self) -> windows_result::Result<IDXGIAdapter>;
    fn CreateSurface(&self, pdesc: *const DXGI_SURFACE_DESC, numsurfaces: u32, usage: DXGI_USAGE, psharedresource: *const DXGI_SHARED_RESOURCE, ppsurface: *mut Option<IDXGISurface>) -> windows_result::Result<()>;
    fn QueryResourceResidency(&self, ppresources: *const Option<windows_core::IUnknown>, presidencystatus: *mut DXGI_RESIDENCY, numresources: u32) -> windows_result::Result<()>;
    fn SetGPUThreadPriority(&self, priority: i32) -> windows_result::Result<()>;
    fn GetGPUThreadPriority(&self) -> windows_result::Result<i32>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDXGIDevice1 {
    ...
    pub unsafe fn GetMaximumFrameLatency(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDXGIDevice1_Impl: IDXGIDevice_Impl {
    ...
    fn GetMaximumFrameLatency(&self) -> windows_result::Result<u32>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDXGIDevice2 {
    pub unsafe fn OfferResources(&self, ppresources: &[Option<IDXGIResource>], priority: DXGI_OFFER_RESOURCE_PRIORITY) -> windows_result::Result<()> {
    ...
    pub unsafe fn ReclaimResources(&self, numresources: u32, ppresources: *const Option<IDXGIResource>, pdiscarded: Option<*mut windows_core::BOOL>) -> windows_result::Result<()> {
    ...
    pub unsafe fn EnqueueSetEvent(&self, hevent: super::super::Foundation::HANDLE) -> windows_result::Result<()> {
...
pub trait IDXGIDevice2_Impl: IDXGIDevice1_Impl {
    fn OfferResources(&self, numresources: u32, ppresources: *const Option<IDXGIResource>, priority: DXGI_OFFER_RESOURCE_PRIORITY) -> windows_result::Result<()>;
    fn ReclaimResources(&self, numresources: u32, ppresources: *const Option<IDXGIResource>, pdiscarded: *mut windows_core::BOOL) -> windows_result::Result<()>;
    fn EnqueueSetEvent(&self, hevent: super::super::Foundation::HANDLE) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDXGIDevice4 {
    pub unsafe fn OfferResources1(&self, ppresources: &[Option<IDXGIResource>], priority: DXGI_OFFER_RESOURCE_PRIORITY, flags: DXGI_OFFER_RESOURCE_FLAGS) -> windows_result::Result<()> {
    ...
    pub unsafe fn ReclaimResources1(&self, numresources: u32, ppresources: *const Option<IDXGIResource>, presults: *mut DXGI_RECLAIM_RESOURCE_RESULTS) -> windows_result::Result<()> {
...
pub trait IDXGIDevice4_Impl: IDXGIDevice3_Impl {
    fn OfferResources1(&self, numresources: u32, ppresources: *const Option<IDXGIResource>, priority: DXGI_OFFER_RESOURCE_PRIORITY, flags: &DXGI_OFFER_RESOURCE_FLAGS) -> windows_result::Result<()>;
    fn ReclaimResources1(&self, numresources: u32, ppresources: *const Option<IDXGIResource>, presults: *mut DXGI_RECLAIM_RESOURCE_RESULTS) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
pub trait IDXGIDeviceSubObject_Impl: IDXGIObject_Impl {
    fn GetDevice(&self, riid: *const windows_core::GUID, ppdevice: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
}
...
impl IDXGIFactory {
    pub unsafe fn EnumAdapters(&self, adapter: u32) -> windows_result::Result<IDXGIAdapter> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn MakeWindowAssociation(&self, windowhandle: super::super::Foundation::HWND, flags: DXGI_MWA_FLAGS) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).MakeWindowAssociation)(windows_core::Interface::as_raw(self), windowhandle, flags).ok() }
    }
    pub unsafe fn GetWindowAssociation(&self) -> windows_result::Result<super::super::Foundation::HWND> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateSoftwareAdapter(&self, module: super::super::Foundation::HMODULE) -> windows_result::Result<IDXGIAdapter> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDXGIFactory_Impl: IDXGIObject_Impl {
    ...
    fn MakeWindowAssociation(&self, windowhandle: super::super::Foundation::HWND, flags: DXGI_MWA_FLAGS) -> windows_result::Result<()>;
    fn GetWindowAssociation(&self) -> windows_result::Result<super::super::Foundation::HWND>;
    ...
    fn CreateSoftwareAdapter(&self, module: super::super::Foundation::HMODULE) -> windows_result::Result<IDXGIAdapter>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDXGIFactory1 {
    pub unsafe fn EnumAdapters1(&self, adapter: u32) -> windows_result::Result<IDXGIAdapter1> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl IDXGIFactory2 {
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn CreateSwapChainForHwnd<P0, P4>(&self, pdevice: P0, hwnd: super::super::Foundation::HWND, pdesc: *const DXGI_SWAP_CHAIN_DESC1, pfullscreendesc: Option<*const DXGI_SWAP_CHAIN_FULLSCREEN_DESC>, prestricttooutput: P4) -> windows_result::Result<IDXGISwapChain1>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn CreateSwapChainForCoreWindow<P0, P1, P3>(&self, pdevice: P0, pwindow: P1, pdesc: *const DXGI_SWAP_CHAIN_DESC1, prestricttooutput: P3) -> windows_result::Result<IDXGISwapChain1>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    ...
    pub unsafe fn GetSharedResourceAdapterLuid(&self, hresource: super::super::Foundation::HANDLE) -> windows_result::Result<super::super::Foundation::LUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RegisterStereoStatusWindow(&self, windowhandle: super::super::Foundation::HWND, wmsg: u32) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RegisterStereoStatusEvent(&self, hevent: super::super::Foundation::HANDLE) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RegisterOcclusionStatusWindow(&self, windowhandle: super::super::Foundation::HWND, wmsg: u32) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RegisterOcclusionStatusEvent(&self, hevent: super::super::Foundation::HANDLE) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn CreateSwapChainForComposition<P0, P2>(&self, pdevice: P0, pdesc: *const DXGI_SWAP_CHAIN_DESC1, prestricttooutput: P2) -> windows_result::Result<IDXGISwapChain1>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
...
pub trait IDXGIFactory2_Impl: IDXGIFactory1_Impl {
    ...
    fn CreateSwapChainForHwnd(&self, pdevice: windows_core::Ref<windows_core::IUnknown>, hwnd: super::super::Foundation::HWND, pdesc: *const DXGI_SWAP_CHAIN_DESC1, pfullscreendesc: *const DXGI_SWAP_CHAIN_FULLSCREEN_DESC, prestricttooutput: windows_core::Ref<IDXGIOutput>) -> windows_result::Result<IDXGISwapChain1>;
    fn CreateSwapChainForCoreWindow(&self, pdevice: windows_core::Ref<windows_core::IUnknown>, pwindow: windows_core::Ref<windows_core::IUnknown>, pdesc: *const DXGI_SWAP_CHAIN_DESC1, prestricttooutput: windows_core::Ref<IDXGIOutput>) -> windows_result::Result<IDXGISwapChain1>;
    fn GetSharedResourceAdapterLuid(&self, hresource: super::super::Foundation::HANDLE) -> windows_result::Result<super::super::Foundation::LUID>;
    fn RegisterStereoStatusWindow(&self, windowhandle: super::super::Foundation::HWND, wmsg: u32) -> windows_result::Result<u32>;
    fn RegisterStereoStatusEvent(&self, hevent: super::super::Foundation::HANDLE) -> windows_result::Result<u32>;
    fn UnregisterStereoStatus(&self, dwcookie: u32);
    fn RegisterOcclusionStatusWindow(&self, windowhandle: super::super::Foundation::HWND, wmsg: u32) -> windows_result::Result<u32>;
    fn RegisterOcclusionStatusEvent(&self, hevent: super::super::Foundation::HANDLE) -> windows_result::Result<u32>;
    fn UnregisterOcclusionStatus(&self, dwcookie: u32);
    fn CreateSwapChainForComposition(&self, pdevice: windows_core::Ref<windows_core::IUnknown>, pdesc: *const DXGI_SWAP_CHAIN_DESC1, prestricttooutput: windows_core::Ref<IDXGIOutput>) -> windows_result::Result<IDXGISwapChain1>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDXGIFactory4 {
    pub unsafe fn EnumAdapterByLuid<T>(&self, adapterluid: super::super::Foundation::LUID) -> windows_result::Result<T>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
    ...
    pub unsafe fn EnumWarpAdapter<T>(&self) -> windows_result::Result<T>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
...
pub trait IDXGIFactory4_Impl: IDXGIFactory3_Impl {
    fn EnumAdapterByLuid(&self, adapterluid: &super::super::Foundation::LUID, riid: *const windows_core::GUID, ppvadapter: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn EnumWarpAdapter(&self, riid: *const windows_core::GUID, ppvadapter: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDXGIFactory5 {
    pub unsafe fn CheckFeatureSupport(&self, feature: DXGI_FEATURE, pfeaturesupportdata: *mut core::ffi::c_void, featuresupportdatasize: u32) -> windows_result::Result<()> {
...
pub trait IDXGIFactory5_Impl: IDXGIFactory4_Impl {
    fn CheckFeatureSupport(&self, feature: DXGI_FEATURE, pfeaturesupportdata: *mut core::ffi::c_void, featuresupportdatasize: u32) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDXGIFactory6 {
    pub unsafe fn EnumAdapterByGpuPreference<T>(&self, adapter: u32, gpupreference: DXGI_GPU_PREFERENCE) -> windows_result::Result<T>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
...
pub trait IDXGIFactory6_Impl: IDXGIFactory5_Impl {
    fn EnumAdapterByGpuPreference(&self, adapter: u32, gpupreference: DXGI_GPU_PREFERENCE, riid: *const windows_core::GUID, ppvadapter: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDXGIFactory7 {
    pub unsafe fn RegisterAdaptersChangedEvent(&self, hevent: super::super::Foundation::HANDLE) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn UnregisterAdaptersChangedEvent(&self, dwcookie: u32) -> windows_result::Result<()> {
...
pub trait IDXGIFactory7_Impl: IDXGIFactory6_Impl {
    fn RegisterAdaptersChangedEvent(&self, hevent: super::super::Foundation::HANDLE) -> windows_result::Result<u32>;
    fn UnregisterAdaptersChangedEvent(&self, dwcookie: u32) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDXGIFactoryMedia {
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn CreateSwapChainForCompositionSurfaceHandle<P0, P3>(&self, pdevice: P0, hsurface: Option<super::super::Foundation::HANDLE>, pdesc: *const DXGI_SWAP_CHAIN_DESC1, prestricttooutput: P3) -> windows_result::Result<IDXGISwapChain1>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
        P3: windows_core::Param<IDXGIOutput>,
    {
    ...
    pub unsafe fn CreateDecodeSwapChainForCompositionSurfaceHandle<P0, P3, P4>(&self, pdevice: P0, hsurface: Option<super::super::Foundation::HANDLE>, pdesc: *const DXGI_DECODE_SWAP_CHAIN_DESC, pyuvdecodebuffers: P3, prestricttooutput: P4) -> windows_result::Result<IDXGIDecodeSwapChain>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
...
pub trait IDXGIFactoryMedia_Impl: windows_core::IUnknownImpl {
    fn CreateSwapChainForCompositionSurfaceHandle(&self, pdevice: windows_core::Ref<windows_core::IUnknown>, hsurface: super::super::Foundation::HANDLE, pdesc: *const DXGI_SWAP_CHAIN_DESC1, prestricttooutput: windows_core::Ref<IDXGIOutput>) -> windows_result::Result<IDXGISwapChain1>;
    fn CreateDecodeSwapChainForCompositionSurfaceHandle(&self, pdevice: windows_core::Ref<windows_core::IUnknown>, hsurface: super::super::Foundation::HANDLE, pdesc: *const DXGI_DECODE_SWAP_CHAIN_DESC, pyuvdecodebuffers: windows_core::Ref<IDXGIResource>, prestricttooutput: windows_core::Ref<IDXGIOutput>) -> windows_result::Result<IDXGIDecodeSwapChain>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDXGIInfoQueue {
    pub unsafe fn SetMessageCountLimit(&self, producer: windows_core::GUID, messagecountlimit: u64) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetMessage(&self, producer: windows_core::GUID, messageindex: u64, pmessage: Option<*mut DXGI_INFO_QUEUE_MESSAGE>, pmessagebytelength: *mut usize) -> windows_result::Result<()> {
    ...
    pub unsafe fn AddStorageFilterEntries(&self, producer: windows_core::GUID, pfilter: *const DXGI_INFO_QUEUE_FILTER) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetStorageFilter(&self, producer: windows_core::GUID, pfilter: Option<*mut DXGI_INFO_QUEUE_FILTER>, pfilterbytelength: *mut usize) -> windows_result::Result<()> {
    ...
    pub unsafe fn PushEmptyStorageFilter(&self, producer: windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn PushDenyAllStorageFilter(&self, producer: windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn PushCopyOfStorageFilter(&self, producer: windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn PushStorageFilter(&self, producer: windows_core::GUID, pfilter: *const DXGI_INFO_QUEUE_FILTER) -> windows_result::Result<()> {
    ...
    pub unsafe fn AddRetrievalFilterEntries(&self, producer: windows_core::GUID, pfilter: *const DXGI_INFO_QUEUE_FILTER) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetRetrievalFilter(&self, producer: windows_core::GUID, pfilter: Option<*mut DXGI_INFO_QUEUE_FILTER>, pfilterbytelength: *mut usize) -> windows_result::Result<()> {
    ...
    pub unsafe fn PushEmptyRetrievalFilter(&self, producer: windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn PushDenyAllRetrievalFilter(&self, producer: windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn PushCopyOfRetrievalFilter(&self, producer: windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn PushRetrievalFilter(&self, producer: windows_core::GUID, pfilter: *const DXGI_INFO_QUEUE_FILTER) -> windows_result::Result<()> {
    ...
    pub unsafe fn AddMessage<P4>(&self, producer: windows_core::GUID, category: DXGI_INFO_QUEUE_MESSAGE_CATEGORY, severity: DXGI_INFO_QUEUE_MESSAGE_SEVERITY, id: i32, pdescription: P4) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn AddApplicationMessage<P1>(&self, severity: DXGI_INFO_QUEUE_MESSAGE_SEVERITY, pdescription: P1) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn SetBreakOnCategory(&self, producer: windows_core::GUID, category: DXGI_INFO_QUEUE_MESSAGE_CATEGORY, benable: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetBreakOnSeverity(&self, producer: windows_core::GUID, severity: DXGI_INFO_QUEUE_MESSAGE_SEVERITY, benable: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetBreakOnID(&self, producer: windows_core::GUID, id: i32, benable: bool) -> windows_result::Result<()> {
...
pub trait IDXGIInfoQueue_Impl: windows_core::IUnknownImpl {
    fn SetMessageCountLimit(&self, producer: &windows_core::GUID, messagecountlimit: u64) -> windows_result::Result<()>;
    fn ClearStoredMessages(&self, producer: &windows_core::GUID);
    fn GetMessage(&self, producer: &windows_core::GUID, messageindex: u64, pmessage: *mut DXGI_INFO_QUEUE_MESSAGE, pmessagebytelength: *mut usize) -> windows_result::Result<()>;
    ...
    fn AddStorageFilterEntries(&self, producer: &windows_core::GUID, pfilter: *const DXGI_INFO_QUEUE_FILTER) -> windows_result::Result<()>;
    fn GetStorageFilter(&self, producer: &windows_core::GUID, pfilter: *mut DXGI_INFO_QUEUE_FILTER, pfilterbytelength: *mut usize) -> windows_result::Result<()>;
    fn ClearStorageFilter(&self, producer: &windows_core::GUID);
    fn PushEmptyStorageFilter(&self, producer: &windows_core::GUID) -> windows_result::Result<()>;
    fn PushDenyAllStorageFilter(&self, producer: &windows_core::GUID) -> windows_result::Result<()>;
    fn PushCopyOfStorageFilter(&self, producer: &windows_core::GUID) -> windows_result::Result<()>;
    fn PushStorageFilter(&self, producer: &windows_core::GUID, pfilter: *const DXGI_INFO_QUEUE_FILTER) -> windows_result::Result<()>;
    fn PopStorageFilter(&self, producer: &windows_core::GUID);
    fn GetStorageFilterStackSize(&self, producer: &windows_core::GUID) -> u32;
    fn AddRetrievalFilterEntries(&self, producer: &windows_core::GUID, pfilter: *const DXGI_INFO_QUEUE_FILTER) -> windows_result::Result<()>;
    fn GetRetrievalFilter(&self, producer: &windows_core::GUID, pfilter: *mut DXGI_INFO_QUEUE_FILTER, pfilterbytelength: *mut usize) -> windows_result::Result<()>;
    fn ClearRetrievalFilter(&self, producer: &windows_core::GUID);
    fn PushEmptyRetrievalFilter(&self, producer: &windows_core::GUID) -> windows_result::Result<()>;
    fn PushDenyAllRetrievalFilter(&self, producer: &windows_core::GUID) -> windows_result::Result<()>;
    fn PushCopyOfRetrievalFilter(&self, producer: &windows_core::GUID) -> windows_result::Result<()>;
    fn PushRetrievalFilter(&self, producer: &windows_core::GUID, pfilter: *const DXGI_INFO_QUEUE_FILTER) -> windows_result::Result<()>;
    fn PopRetrievalFilter(&self, producer: &windows_core::GUID);
    fn GetRetrievalFilterStackSize(&self, producer: &windows_core::GUID) -> u32;
    fn AddMessage(&self, producer: &windows_core::GUID, category: DXGI_INFO_QUEUE_MESSAGE_CATEGORY, severity: DXGI_INFO_QUEUE_MESSAGE_SEVERITY, id: i32, pdescription: &windows_core::PCSTR) -> windows_result::Result<()>;
    fn AddApplicationMessage(&self, severity: DXGI_INFO_QUEUE_MESSAGE_SEVERITY, pdescription: &windows_core::PCSTR) -> windows_result::Result<()>;
    fn SetBreakOnCategory(&self, producer: &windows_core::GUID, category: DXGI_INFO_QUEUE_MESSAGE_CATEGORY, benable: windows_core::BOOL) -> windows_result::Result<()>;
    fn SetBreakOnSeverity(&self, producer: &windows_core::GUID, severity: DXGI_INFO_QUEUE_MESSAGE_SEVERITY, benable: windows_core::BOOL) -> windows_result::Result<()>;
    fn SetBreakOnID(&self, producer: &windows_core::GUID, id: i32, benable: windows_core::BOOL) -> windows_result::Result<()>;
...
impl IDXGIKeyedMutex {
    pub unsafe fn AcquireSync(&self, key: u64, dwmilliseconds: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).AcquireSync)(windows_core::Interface::as_raw(self), key, dwmilliseconds).ok() }
    }
    pub unsafe fn ReleaseSync(&self, key: u64) -> windows_result::Result<()> {
...
pub trait IDXGIKeyedMutex_Impl: IDXGIDeviceSubObject_Impl {
    fn AcquireSync(&self, key: u64, dwmilliseconds: u32) -> windows_result::Result<()>;
    fn ReleaseSync(&self, key: u64) -> windows_result::Result<()>;
}
...
impl IDXGIObject {
    pub unsafe fn SetPrivateData(&self, name: *const windows_core::GUID, datasize: u32, pdata: *const core::ffi::c_void) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetPrivateData)(windows_core::Interface::as_raw(self), name, datasize, pdata).ok() }
    }
    pub unsafe fn SetPrivateDataInterface<P1>(&self, name: *const windows_core::GUID, punknown: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::IUnknown>,
    {
    ...
    pub unsafe fn GetPrivateData(&self, name: *const windows_core::GUID, pdatasize: *mut u32, pdata: *mut core::ffi::c_void) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetParent<T>(&self) -> windows_result::Result<T>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
...
pub trait IDXGIObject_Impl: windows_core::IUnknownImpl {
    fn SetPrivateData(&self, name: *const windows_core::GUID, datasize: u32, pdata: *const core::ffi::c_void) -> windows_result::Result<()>;
    fn SetPrivateDataInterface(&self, name: *const windows_core::GUID, punknown: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn GetPrivateData(&self, name: *const windows_core::GUID, pdatasize: *mut u32, pdata: *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn GetParent(&self, riid: *const windows_core::GUID, ppparent: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
}
...
impl IDXGIOutput {
    #[cfg(all(feature = "Win32_Graphics_Dxgi_Common", feature = "Win32_Graphics_Gdi"))]
    pub unsafe fn GetDesc(&self) -> windows_result::Result<DXGI_OUTPUT_DESC> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDesc)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn GetDisplayModeList(&self, enumformat: Common::DXGI_FORMAT, flags: DXGI_ENUM_MODES, pnummodes: *mut u32, pdesc: Option<*mut Common::DXGI_MODE_DESC>) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn FindClosestMatchingMode<P2>(&self, pmodetomatch: *const Common::DXGI_MODE_DESC, pclosestmatch: *mut Common::DXGI_MODE_DESC, pconcerneddevice: P2) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn WaitForVBlank(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).WaitForVBlank)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn TakeOwnership<P0>(&self, pdevice: P0, exclusive: bool) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn GetGammaControlCapabilities(&self, pgammacaps: *mut Common::DXGI_GAMMA_CONTROL_CAPABILITIES) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn SetGammaControl(&self, parray: *const Common::DXGI_GAMMA_CONTROL) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetGammaControl)(windows_core::Interface::as_raw(self), parray).ok() }
    }
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn GetGammaControl(&self, parray: *mut Common::DXGI_GAMMA_CONTROL) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetGammaControl)(windows_core::Interface::as_raw(self), parray as _).ok() }
    }
    pub unsafe fn SetDisplaySurface<P0>(&self, pscanoutsurface: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetDisplaySurfaceData<P0>(&self, pdestination: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IDXGISurface>,
    {
    ...
    pub unsafe fn GetFrameStatistics(&self, pstats: *mut DXGI_FRAME_STATISTICS) -> windows_result::Result<()> {
...
pub trait IDXGIOutput_Impl: IDXGIObject_Impl {
    fn GetDesc(&self) -> windows_result::Result<DXGI_OUTPUT_DESC>;
    fn GetDisplayModeList(&self, enumformat: Common::DXGI_FORMAT, flags: DXGI_ENUM_MODES, pnummodes: *mut u32, pdesc: *mut Common::DXGI_MODE_DESC) -> windows_result::Result<()>;
    fn FindClosestMatchingMode(&self, pmodetomatch: *const Common::DXGI_MODE_DESC, pclosestmatch: *mut Common::DXGI_MODE_DESC, pconcerneddevice: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn WaitForVBlank(&self) -> windows_result::Result<()>;
    fn TakeOwnership(&self, pdevice: windows_core::Ref<windows_core::IUnknown>, exclusive: windows_core::BOOL) -> windows_result::Result<()>;
    fn ReleaseOwnership(&self);
    fn GetGammaControlCapabilities(&self, pgammacaps: *mut Common::DXGI_GAMMA_CONTROL_CAPABILITIES) -> windows_result::Result<()>;
    fn SetGammaControl(&self, parray: *const Common::DXGI_GAMMA_CONTROL) -> windows_result::Result<()>;
    fn GetGammaControl(&self, parray: *mut Common::DXGI_GAMMA_CONTROL) -> windows_result::Result<()>;
    fn SetDisplaySurface(&self, pscanoutsurface: windows_core::Ref<IDXGISurface>) -> windows_result::Result<()>;
    fn GetDisplaySurfaceData(&self, pdestination: windows_core::Ref<IDXGISurface>) -> windows_result::Result<()>;
    fn GetFrameStatistics(&self, pstats: *mut DXGI_FRAME_STATISTICS) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_Graphics_Dxgi_Common", feature = "Win32_Graphics_Gdi"))]
...
impl IDXGIOutput1 {
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn GetDisplayModeList1(&self, enumformat: Common::DXGI_FORMAT, flags: DXGI_ENUM_MODES, pnummodes: *mut u32, pdesc: Option<*mut DXGI_MODE_DESC1>) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn FindClosestMatchingMode1<P2>(&self, pmodetomatch: *const DXGI_MODE_DESC1, pclosestmatch: *mut DXGI_MODE_DESC1, pconcerneddevice: P2) -> windows_result::Result<()>
    where
        P2: windows_core::Param<windows_core::IUnknown>,
    {
    ...
    pub unsafe fn GetDisplaySurfaceData1<P0>(&self, pdestination: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn DuplicateOutput<P0>(&self, pdevice: P0) -> windows_result::Result<IDXGIOutputDuplication>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
...
pub trait IDXGIOutput1_Impl: IDXGIOutput_Impl {
    fn GetDisplayModeList1(&self, enumformat: Common::DXGI_FORMAT, flags: DXGI_ENUM_MODES, pnummodes: *mut u32, pdesc: *mut DXGI_MODE_DESC1) -> windows_result::Result<()>;
    fn FindClosestMatchingMode1(&self, pmodetomatch: *const DXGI_MODE_DESC1, pclosestmatch: *mut DXGI_MODE_DESC1, pconcerneddevice: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn GetDisplaySurfaceData1(&self, pdestination: windows_core::Ref<IDXGIResource>) -> windows_result::Result<()>;
    fn DuplicateOutput(&self, pdevice: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<IDXGIOutputDuplication>;
}
#[cfg(all(feature = "Win32_Graphics_Dxgi_Common", feature = "Win32_Graphics_Gdi"))]
...
impl IDXGIOutput3 {
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn CheckOverlaySupport<P1>(&self, enumformat: Common::DXGI_FORMAT, pconcerneddevice: P1) -> windows_result::Result<u32>
    where
        P1: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
...
pub trait IDXGIOutput3_Impl: IDXGIOutput2_Impl {
    fn CheckOverlaySupport(&self, enumformat: Common::DXGI_FORMAT, pconcerneddevice: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<u32>;
}
#[cfg(all(feature = "Win32_Graphics_Dxgi_Common", feature = "Win32_Graphics_Gdi"))]
...
impl IDXGIOutput4 {
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn CheckOverlayColorSpaceSupport<P2>(&self, format: Common::DXGI_FORMAT, colorspace: Common::DXGI_COLOR_SPACE_TYPE, pconcerneddevice: P2) -> windows_result::Result<u32>
    where
        P2: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
...
pub trait IDXGIOutput4_Impl: IDXGIOutput3_Impl {
    fn CheckOverlayColorSpaceSupport(&self, format: Common::DXGI_FORMAT, colorspace: Common::DXGI_COLOR_SPACE_TYPE, pconcerneddevice: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<u32>;
}
#[cfg(all(feature = "Win32_Graphics_Dxgi_Common", feature = "Win32_Graphics_Gdi"))]
...
impl IDXGIOutput5 {
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn DuplicateOutput1<P0>(&self, pdevice: P0, flags: u32, psupportedformats: &[Common::DXGI_FORMAT]) -> windows_result::Result<IDXGIOutputDuplication>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
...
pub trait IDXGIOutput5_Impl: IDXGIOutput4_Impl {
    fn DuplicateOutput1(&self, pdevice: windows_core::Ref<windows_core::IUnknown>, flags: u32, supportedformatscount: u32, psupportedformats: *const Common::DXGI_FORMAT) -> windows_result::Result<IDXGIOutputDuplication>;
}
#[cfg(all(feature = "Win32_Graphics_Dxgi_Common", feature = "Win32_Graphics_Gdi"))]
...
impl IDXGIOutput6 {
    #[cfg(all(feature = "Win32_Graphics_Dxgi_Common", feature = "Win32_Graphics_Gdi"))]
    pub unsafe fn GetDesc1(&self) -> windows_result::Result<DXGI_OUTPUT_DESC1> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDesc1)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn CheckHardwareCompositionSupport(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDXGIOutput6_Impl: IDXGIOutput5_Impl {
    fn GetDesc1(&self) -> windows_result::Result<DXGI_OUTPUT_DESC1>;
    fn CheckHardwareCompositionSupport(&self) -> windows_result::Result<u32>;
}
#[cfg(all(feature = "Win32_Graphics_Dxgi_Common", feature = "Win32_Graphics_Gdi"))]
...
impl IDXGIOutputDuplication {
    ...
    pub unsafe fn AcquireNextFrame(&self, timeoutinmilliseconds: u32, pframeinfo: *mut DXGI_OUTDUPL_FRAME_INFO, ppdesktopresource: *mut Option<IDXGIResource>) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFrameDirtyRects(&self, dirtyrectsbuffersize: u32, pdirtyrectsbuffer: *mut super::super::Foundation::RECT, pdirtyrectsbuffersizerequired: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFrameMoveRects(&self, moverectsbuffersize: u32, pmoverectbuffer: *mut DXGI_OUTDUPL_MOVE_RECT, pmoverectsbuffersizerequired: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFramePointerShape(&self, pointershapebuffersize: u32, ppointershapebuffer: *mut core::ffi::c_void, ppointershapebuffersizerequired: *mut u32, ppointershapeinfo: *mut DXGI_OUTDUPL_POINTER_SHAPE_INFO) -> windows_result::Result<()> {
...
pub trait IDXGIOutputDuplication_Impl: IDXGIObject_Impl {
    ...
    fn AcquireNextFrame(&self, timeoutinmilliseconds: u32, pframeinfo: *mut DXGI_OUTDUPL_FRAME_INFO, ppdesktopresource: windows_core::OutRef<IDXGIResource>) -> windows_result::Result<()>;
    fn GetFrameDirtyRects(&self, dirtyrectsbuffersize: u32, pdirtyrectsbuffer: *mut super::super::Foundation::RECT, pdirtyrectsbuffersizerequired: *mut u32) -> windows_result::Result<()>;
    fn GetFrameMoveRects(&self, moverectsbuffersize: u32, pmoverectbuffer: *mut DXGI_OUTDUPL_MOVE_RECT, pmoverectsbuffersizerequired: *mut u32) -> windows_result::Result<()>;
    fn GetFramePointerShape(&self, pointershapebuffersize: u32, ppointershapebuffer: *mut core::ffi::c_void, ppointershapebuffersizerequired: *mut u32, ppointershapeinfo: *mut DXGI_OUTDUPL_POINTER_SHAPE_INFO) -> windows_result::Result<()>;
    fn MapDesktopSurface(&self) -> windows_result::Result<DXGI_MAPPED_RECT>;
    fn UnMapDesktopSurface(&self) -> windows_result::Result<()>;
    fn ReleaseFrame(&self) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
pub trait IDXGIResource_Impl: IDXGIDeviceSubObject_Impl {
    fn GetSharedHandle(&self) -> windows_result::Result<super::super::Foundation::HANDLE>;
    fn GetUsage(&self) -> windows_result::Result<DXGI_USAGE>;
    fn SetEvictionPriority(&self, evictionpriority: DXGI_RESOURCE_PRIORITY) -> windows_result::Result<()>;
    fn GetEvictionPriority(&self) -> windows_result::Result<DXGI_RESOURCE_PRIORITY>;
}
...
impl IDXGIResource1 {
    pub unsafe fn CreateSubresourceSurface(&self, index: u32) -> windows_result::Result<IDXGISurface2> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateSharedHandle<P2>(&self, pattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>, dwaccess: u32, lpname: P2) -> windows_result::Result<super::super::Foundation::HANDLE>
    where
...
pub trait IDXGIResource1_Impl: IDXGIResource_Impl {
    fn CreateSubresourceSurface(&self, index: u32) -> windows_result::Result<IDXGISurface2>;
    fn CreateSharedHandle(&self, pattributes: *const super::super::Security::SECURITY_ATTRIBUTES, dwaccess: u32, lpname: &windows_core::PCWSTR) -> windows_result::Result<super::super::Foundation::HANDLE>;
}
#[cfg(feature = "Win32_Security")]
...
impl IDXGISurface {
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn GetDesc(&self) -> windows_result::Result<DXGI_SURFACE_DESC> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDesc)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn Map(&self, plockedrect: *mut DXGI_MAPPED_RECT, mapflags: DXGI_MAP_FLAGS) -> windows_result::Result<()> {
...
pub trait IDXGISurface_Impl: IDXGIDeviceSubObject_Impl {
    fn GetDesc(&self) -> windows_result::Result<DXGI_SURFACE_DESC>;
    fn Map(&self, plockedrect: *mut DXGI_MAPPED_RECT, mapflags: DXGI_MAP_FLAGS) -> windows_result::Result<()>;
...
impl IDXGISurface1 {
    ...
    pub unsafe fn GetDC(&self, discard: bool) -> windows_result::Result<super::Gdi::HDC> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDC)(windows_core::Interface::as_raw(self), discard.into(), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn ReleaseDC(&self, pdirtyrect: Option<*const super::super::Foundation::RECT>) -> windows_result::Result<()> {
...
pub trait IDXGISurface1_Impl: IDXGISurface_Impl {
    fn GetDC(&self, discard: windows_core::BOOL) -> windows_result::Result<super::Gdi::HDC>;
    fn ReleaseDC(&self, pdirtyrect: *const super::super::Foundation::RECT) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_Graphics_Dxgi_Common", feature = "Win32_Graphics_Gdi"))]
...
impl IDXGISurface2 {
    pub unsafe fn GetResource<T>(&self, psubresourceindex: *mut u32) -> windows_result::Result<T>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
...
pub trait IDXGISurface2_Impl: IDXGISurface1_Impl {
    fn GetResource(&self, riid: *const windows_core::GUID, ppparentresource: *mut *mut core::ffi::c_void, psubresourceindex: *mut u32) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_Graphics_Dxgi_Common", feature = "Win32_Graphics_Gdi"))]
...
impl IDXGISwapChain {
    ...
    pub unsafe fn GetBuffer<T>(&self, buffer: u32) -> windows_result::Result<T>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
    ...
    pub unsafe fn SetFullscreenState<P1>(&self, fullscreen: bool, ptarget: P1) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetFullscreenState(&self, pfullscreen: Option<*mut windows_core::BOOL>, pptarget: Option<*mut Option<IDXGIOutput>>) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn GetDesc(&self) -> windows_result::Result<DXGI_SWAP_CHAIN_DESC> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDesc)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn ResizeBuffers(&self, buffercount: u32, width: u32, height: u32, newformat: Common::DXGI_FORMAT, swapchainflags: DXGI_SWAP_CHAIN_FLAG) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn ResizeTarget(&self, pnewtargetparameters: *const Common::DXGI_MODE_DESC) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ResizeTarget)(windows_core::Interface::as_raw(self), pnewtargetparameters).ok() }
    }
    pub unsafe fn GetContainingOutput(&self) -> windows_result::Result<IDXGIOutput> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetLastPresentCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDXGISwapChain_Impl: IDXGIDeviceSubObject_Impl {
    ...
    fn GetBuffer(&self, buffer: u32, riid: *const windows_core::GUID, ppsurface: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn SetFullscreenState(&self, fullscreen: windows_core::BOOL, ptarget: windows_core::Ref<IDXGIOutput>) -> windows_result::Result<()>;
    fn GetFullscreenState(&self, pfullscreen: *mut windows_core::BOOL, pptarget: windows_core::OutRef<IDXGIOutput>) -> windows_result::Result<()>;
    fn GetDesc(&self) -> windows_result::Result<DXGI_SWAP_CHAIN_DESC>;
    fn ResizeBuffers(&self, buffercount: u32, width: u32, height: u32, newformat: Common::DXGI_FORMAT, swapchainflags: &DXGI_SWAP_CHAIN_FLAG) -> windows_result::Result<()>;
    fn ResizeTarget(&self, pnewtargetparameters: *const Common::DXGI_MODE_DESC) -> windows_result::Result<()>;
...
impl IDXGISwapChain1 {
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn GetDesc1(&self) -> windows_result::Result<DXGI_SWAP_CHAIN_DESC1> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDesc1)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn GetFullscreenDesc(&self) -> windows_result::Result<DXGI_SWAP_CHAIN_FULLSCREEN_DESC> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFullscreenDesc)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetHwnd(&self) -> windows_result::Result<super::super::Foundation::HWND> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetHwnd)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetCoreWindow<T>(&self) -> windows_result::Result<T>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
    ...
    pub unsafe fn GetRestrictToOutput(&self) -> windows_result::Result<IDXGIOutput> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetBackgroundColor(&self, pcolor: *const DXGI_RGBA) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetBackgroundColor)(windows_core::Interface::as_raw(self), pcolor).ok() }
    }
    pub unsafe fn GetBackgroundColor(&self) -> windows_result::Result<DXGI_RGBA> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn SetRotation(&self, rotation: Common::DXGI_MODE_ROTATION) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetRotation)(windows_core::Interface::as_raw(self), rotation).ok() }
    }
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn GetRotation(&self) -> windows_result::Result<Common::DXGI_MODE_ROTATION> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDXGISwapChain1_Impl: IDXGISwapChain_Impl {
    fn GetDesc1(&self) -> windows_result::Result<DXGI_SWAP_CHAIN_DESC1>;
    fn GetFullscreenDesc(&self) -> windows_result::Result<DXGI_SWAP_CHAIN_FULLSCREEN_DESC>;
    fn GetHwnd(&self) -> windows_result::Result<super::super::Foundation::HWND>;
    fn GetCoreWindow(&self, refiid: *const windows_core::GUID, ppunk: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    ...
    fn GetRestrictToOutput(&self) -> windows_result::Result<IDXGIOutput>;
    fn SetBackgroundColor(&self, pcolor: *const DXGI_RGBA) -> windows_result::Result<()>;
    fn GetBackgroundColor(&self) -> windows_result::Result<DXGI_RGBA>;
    fn SetRotation(&self, rotation: Common::DXGI_MODE_ROTATION) -> windows_result::Result<()>;
    fn GetRotation(&self) -> windows_result::Result<Common::DXGI_MODE_ROTATION>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDXGISwapChain2 {
    pub unsafe fn SetSourceSize(&self, width: u32, height: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetSourceSize)(windows_core::Interface::as_raw(self), width, height).ok() }
    }
    pub unsafe fn GetSourceSize(&self, pwidth: *mut u32, pheight: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetMatrixTransform(&self, pmatrix: *const DXGI_MATRIX_3X2_F) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetMatrixTransform)(windows_core::Interface::as_raw(self), pmatrix).ok() }
    }
    pub unsafe fn GetMatrixTransform(&self, pmatrix: *mut DXGI_MATRIX_3X2_F) -> windows_result::Result<()> {
...
pub trait IDXGISwapChain2_Impl: IDXGISwapChain1_Impl {
    fn SetSourceSize(&self, width: u32, height: u32) -> windows_result::Result<()>;
    fn GetSourceSize(&self, pwidth: *mut u32, pheight: *mut u32) -> windows_result::Result<()>;
    fn SetMaximumFrameLatency(&self, maxlatency: u32) -> windows_result::Result<()>;
    fn GetMaximumFrameLatency(&self) -> windows_result::Result<u32>;
    fn GetFrameLatencyWaitableObject(&self) -> super::super::Foundation::HANDLE;
    fn SetMatrixTransform(&self, pmatrix: *const DXGI_MATRIX_3X2_F) -> windows_result::Result<()>;
    fn GetMatrixTransform(&self, pmatrix: *mut DXGI_MATRIX_3X2_F) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDXGISwapChain3 {
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn CheckColorSpaceSupport(&self, colorspace: Common::DXGI_COLOR_SPACE_TYPE) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn SetColorSpace1(&self, colorspace: Common::DXGI_COLOR_SPACE_TYPE) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetColorSpace1)(windows_core::Interface::as_raw(self), colorspace).ok() }
    }
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn ResizeBuffers1(&self, buffercount: u32, width: u32, height: u32, format: Common::DXGI_FORMAT, swapchainflags: DXGI_SWAP_CHAIN_FLAG, pcreationnodemask: *const u32, pppresentqueue: *const Option<windows_core::IUnknown>) -> windows_result::Result<()> {
...
pub trait IDXGISwapChain3_Impl: IDXGISwapChain2_Impl {
    ...
    fn CheckColorSpaceSupport(&self, colorspace: Common::DXGI_COLOR_SPACE_TYPE) -> windows_result::Result<u32>;
    fn SetColorSpace1(&self, colorspace: Common::DXGI_COLOR_SPACE_TYPE) -> windows_result::Result<()>;
    fn ResizeBuffers1(&self, buffercount: u32, width: u32, height: u32, format: Common::DXGI_FORMAT, swapchainflags: &DXGI_SWAP_CHAIN_FLAG, pcreationnodemask: *const u32, pppresentqueue: *const Option<windows_core::IUnknown>) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDXGISwapChain4 {
    pub unsafe fn SetHDRMetaData(&self, r#type: DXGI_HDR_METADATA_TYPE, pmetadata: Option<&[u8]>) -> windows_result::Result<()> {
...
pub trait IDXGISwapChain4_Impl: IDXGISwapChain3_Impl {
    fn SetHDRMetaData(&self, r#type: DXGI_HDR_METADATA_TYPE, size: u32, pmetadata: *const core::ffi::c_void) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDXGISwapChainMedia {
    pub unsafe fn GetFrameStatisticsMedia(&self, pstats: *mut DXGI_FRAME_STATISTICS_MEDIA) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetFrameStatisticsMedia)(windows_core::Interface::as_raw(self), pstats as _).ok() }
    }
    pub unsafe fn SetPresentDuration(&self, duration: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetPresentDuration)(windows_core::Interface::as_raw(self), duration).ok() }
    }
    pub unsafe fn CheckPresentDurationSupport(&self, desiredpresentduration: u32, pclosestsmallerpresentduration: *mut u32, pclosestlargerpresentduration: *mut u32) -> windows_result::Result<()> {
...
pub trait IDXGISwapChainMedia_Impl: windows_core::IUnknownImpl {
    fn GetFrameStatisticsMedia(&self, pstats: *mut DXGI_FRAME_STATISTICS_MEDIA) -> windows_result::Result<()>;
    fn SetPresentDuration(&self, duration: u32) -> windows_result::Result<()>;
    fn CheckPresentDurationSupport(&self, desiredpresentduration: u32, pclosestsmallerpresentduration: *mut u32, pclosestlargerpresentduration: *mut u32) -> windows_result::Result<()>;
}
