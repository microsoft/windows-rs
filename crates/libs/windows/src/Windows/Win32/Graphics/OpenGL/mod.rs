...
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn ChoosePixelFormat ( hdc : super::Gdi:: HDC , ppfd : *const PIXELFORMATDESCRIPTOR ) -> i32 );
...
where
    P0: ::std::convert::Into<super::Gdi::HDC>,
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn DescribePixelFormat ( hdc : super::Gdi:: HDC , ipixelformat : PFD_PIXEL_TYPE , nbytes : u32 , ppfd : *mut PIXELFORMATDESCRIPTOR ) -> i32 );
...
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn GetEnhMetaFilePixelFormat ( hemf : super::Gdi:: HENHMETAFILE , cbbuffer : u32 , ppfd : *mut PIXELFORMATDESCRIPTOR ) -> u32 );
...
where
    P0: ::std::convert::Into<super::Gdi::HDC>,
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn GetPixelFormat ( hdc : super::Gdi:: HDC ) -> i32 );
...
pub unsafe fn glAccum(op: u32, value: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glAccum ( op : u32 , value : f32 ) -> ( ) );
    glAccum(op, value)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glAlphaFunc(func: u32, r#ref: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glAlphaFunc ( func : u32 , r#ref : f32 ) -> ( ) );
    glAlphaFunc(func, r#ref)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glAreTexturesResident(n: i32, textures: *const u32, residences: *mut u8) -> u8 {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glAreTexturesResident ( n : i32 , textures : *const u32 , residences : *mut u8 ) -> u8 );
    glAreTexturesResident(n, ::core::mem::transmute(textures), ::core::mem::transmute(residences))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glArrayElement(i: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glArrayElement ( i : i32 ) -> ( ) );
    glArrayElement(i)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glBegin(mode: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glBegin ( mode : u32 ) -> ( ) );
    glBegin(mode)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glBindTexture(target: u32, texture: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glBindTexture ( target : u32 , texture : u32 ) -> ( ) );
    glBindTexture(target, texture)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glBitmap(width: i32, height: i32, xorig: f32, yorig: f32, xmove: f32, ymove: f32, bitmap: *const u8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glBitmap ( width : i32 , height : i32 , xorig : f32 , yorig : f32 , xmove : f32 , ymove : f32 , bitmap : *const u8 ) -> ( ) );
    glBitmap(width, height, xorig, yorig, xmove, ymove, ::core::mem::transmute(bitmap))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glBlendFunc(sfactor: u32, dfactor: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glBlendFunc ( sfactor : u32 , dfactor : u32 ) -> ( ) );
    glBlendFunc(sfactor, dfactor)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glCallList(list: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glCallList ( list : u32 ) -> ( ) );
    glCallList(list)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glCallLists(n: i32, r#type: u32, lists: *const ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glCallLists ( n : i32 , r#type : u32 , lists : *const ::core::ffi::c_void ) -> ( ) );
    glCallLists(n, r#type, ::core::mem::transmute(lists))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glClear(mask: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glClear ( mask : u32 ) -> ( ) );
    glClear(mask)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glClearAccum(red: f32, green: f32, blue: f32, alpha: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glClearAccum ( red : f32 , green : f32 , blue : f32 , alpha : f32 ) -> ( ) );
    glClearAccum(red, green, blue, alpha)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glClearColor(red: f32, green: f32, blue: f32, alpha: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glClearColor ( red : f32 , green : f32 , blue : f32 , alpha : f32 ) -> ( ) );
    glClearColor(red, green, blue, alpha)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glClearDepth(depth: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glClearDepth ( depth : f64 ) -> ( ) );
    glClearDepth(depth)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glClearIndex(c: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glClearIndex ( c : f32 ) -> ( ) );
    glClearIndex(c)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glClearStencil(s: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glClearStencil ( s : i32 ) -> ( ) );
    glClearStencil(s)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glClipPlane(plane: u32, equation: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glClipPlane ( plane : u32 , equation : *const f64 ) -> ( ) );
    glClipPlane(plane, ::core::mem::transmute(equation))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor3b(red: i8, green: i8, blue: i8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor3b ( red : i8 , green : i8 , blue : i8 ) -> ( ) );
    glColor3b(red, green, blue)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor3bv(v: *const i8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor3bv ( v : *const i8 ) -> ( ) );
...
pub unsafe fn glColor3dv(v: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor3dv ( v : *const f64 ) -> ( ) );
...
pub unsafe fn glColor3fv(v: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor3fv ( v : *const f32 ) -> ( ) );
    glColor3fv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor3i(red: i32, green: i32, blue: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor3i ( red : i32 , green : i32 , blue : i32 ) -> ( ) );
    glColor3i(red, green, blue)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor3iv(v: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor3iv ( v : *const i32 ) -> ( ) );
    glColor3iv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor3s(red: i16, green: i16, blue: i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor3s ( red : i16 , green : i16 , blue : i16 ) -> ( ) );
    glColor3s(red, green, blue)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor3sv(v: *const i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor3sv ( v : *const i16 ) -> ( ) );
    glColor3sv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor3ub(red: u8, green: u8, blue: u8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor3ub ( red : u8 , green : u8 , blue : u8 ) -> ( ) );
    glColor3ub(red, green, blue)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor3ubv(v: *const u8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor3ubv ( v : *const u8 ) -> ( ) );
    glColor3ubv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor3ui(red: u32, green: u32, blue: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor3ui ( red : u32 , green : u32 , blue : u32 ) -> ( ) );
    glColor3ui(red, green, blue)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor3uiv(v: *const u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor3uiv ( v : *const u32 ) -> ( ) );
    glColor3uiv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor3us(red: u16, green: u16, blue: u16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor3us ( red : u16 , green : u16 , blue : u16 ) -> ( ) );
    glColor3us(red, green, blue)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor3usv(v: *const u16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor3usv ( v : *const u16 ) -> ( ) );
    glColor3usv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor4b(red: i8, green: i8, blue: i8, alpha: i8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor4b ( red : i8 , green : i8 , blue : i8 , alpha : i8 ) -> ( ) );
    glColor4b(red, green, blue, alpha)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor4bv(v: *const i8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor4bv ( v : *const i8 ) -> ( ) );
    glColor4bv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor4d(red: f64, green: f64, blue: f64, alpha: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor4d ( red : f64 , green : f64 , blue : f64 , alpha : f64 ) -> ( ) );
    glColor4d(red, green, blue, alpha)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor4dv(v: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor4dv ( v : *const f64 ) -> ( ) );
    glColor4dv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor4f(red: f32, green: f32, blue: f32, alpha: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor4f ( red : f32 , green : f32 , blue : f32 , alpha : f32 ) -> ( ) );
    glColor4f(red, green, blue, alpha)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor4fv(v: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor4fv ( v : *const f32 ) -> ( ) );
    glColor4fv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor4i(red: i32, green: i32, blue: i32, alpha: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor4i ( red : i32 , green : i32 , blue : i32 , alpha : i32 ) -> ( ) );
    glColor4i(red, green, blue, alpha)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor4iv(v: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor4iv ( v : *const i32 ) -> ( ) );
    glColor4iv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor4s(red: i16, green: i16, blue: i16, alpha: i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor4s ( red : i16 , green : i16 , blue : i16 , alpha : i16 ) -> ( ) );
    glColor4s(red, green, blue, alpha)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor4sv(v: *const i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor4sv ( v : *const i16 ) -> ( ) );
    glColor4sv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor4ub(red: u8, green: u8, blue: u8, alpha: u8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor4ub ( red : u8 , green : u8 , blue : u8 , alpha : u8 ) -> ( ) );
    glColor4ub(red, green, blue, alpha)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor4ubv(v: *const u8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor4ubv ( v : *const u8 ) -> ( ) );
    glColor4ubv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor4ui(red: u32, green: u32, blue: u32, alpha: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor4ui ( red : u32 , green : u32 , blue : u32 , alpha : u32 ) -> ( ) );
    glColor4ui(red, green, blue, alpha)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor4uiv(v: *const u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor4uiv ( v : *const u32 ) -> ( ) );
    glColor4uiv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor4us(red: u16, green: u16, blue: u16, alpha: u16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor4us ( red : u16 , green : u16 , blue : u16 , alpha : u16 ) -> ( ) );
    glColor4us(red, green, blue, alpha)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColor4usv(v: *const u16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColor4usv ( v : *const u16 ) -> ( ) );
    glColor4usv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColorMask(red: u8, green: u8, blue: u8, alpha: u8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColorMask ( red : u8 , green : u8 , blue : u8 , alpha : u8 ) -> ( ) );
    glColorMask(red, green, blue, alpha)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColorMaterial(face: u32, mode: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColorMaterial ( face : u32 , mode : u32 ) -> ( ) );
    glColorMaterial(face, mode)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glColorPointer(size: i32, r#type: u32, stride: i32, pointer: *const ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glColorPointer ( size : i32 , r#type : u32 , stride : i32 , pointer : *const ::core::ffi::c_void ) -> ( ) );
...
pub unsafe fn glCopyPixels(x: i32, y: i32, width: i32, height: i32, r#type: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glCopyPixels ( x : i32 , y : i32 , width : i32 , height : i32 , r#type : u32 ) -> ( ) );
...
pub unsafe fn glCopyTexImage1D(target: u32, level: i32, internalformat: u32, x: i32, y: i32, width: i32, border: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glCopyTexImage1D ( target : u32 , level : i32 , internalformat : u32 , x : i32 , y : i32 , width : i32 , border : i32 ) -> ( ) );
...
pub unsafe fn glCopyTexImage2D(target: u32, level: i32, internalformat: u32, x: i32, y: i32, width: i32, height: i32, border: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glCopyTexImage2D ( target : u32 , level : i32 , internalformat : u32 , x : i32 , y : i32 , width : i32 , height : i32 , border : i32 ) -> ( ) );
    glCopyTexImage2D(target, level, internalformat, x, y, width, height, border)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glCopyTexSubImage1D(target: u32, level: i32, xoffset: i32, x: i32, y: i32, width: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glCopyTexSubImage1D ( target : u32 , level : i32 , xoffset : i32 , x : i32 , y : i32 , width : i32 ) -> ( ) );
...
pub unsafe fn glCopyTexSubImage2D(target: u32, level: i32, xoffset: i32, yoffset: i32, x: i32, y: i32, width: i32, height: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glCopyTexSubImage2D ( target : u32 , level : i32 , xoffset : i32 , yoffset : i32 , x : i32 , y : i32 , width : i32 , height : i32 ) -> ( ) );
    glCopyTexSubImage2D(target, level, xoffset, yoffset, x, y, width, height)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glCullFace(mode: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glCullFace ( mode : u32 ) -> ( ) );
    glCullFace(mode)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glDeleteLists(list: u32, range: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glDeleteLists ( list : u32 , range : i32 ) -> ( ) );
    glDeleteLists(list, range)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glDeleteTextures(n: i32, textures: *const u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glDeleteTextures ( n : i32 , textures : *const u32 ) -> ( ) );
    glDeleteTextures(n, ::core::mem::transmute(textures))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glDepthFunc(func: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glDepthFunc ( func : u32 ) -> ( ) );
    glDepthFunc(func)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glDepthMask(flag: u8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glDepthMask ( flag : u8 ) -> ( ) );
    glDepthMask(flag)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glDepthRange(znear: f64, zfar: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glDepthRange ( znear : f64 , zfar : f64 ) -> ( ) );
    glDepthRange(znear, zfar)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glDisable(cap: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glDisable ( cap : u32 ) -> ( ) );
    glDisable(cap)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glDisableClientState(array: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glDisableClientState ( array : u32 ) -> ( ) );
    glDisableClientState(array)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glDrawArrays(mode: u32, first: i32, count: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glDrawArrays ( mode : u32 , first : i32 , count : i32 ) -> ( ) );
    glDrawArrays(mode, first, count)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glDrawBuffer(mode: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glDrawBuffer ( mode : u32 ) -> ( ) );
    glDrawBuffer(mode)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glDrawElements(mode: u32, count: i32, r#type: u32, indices: *const ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glDrawElements ( mode : u32 , count : i32 , r#type : u32 , indices : *const ::core::ffi::c_void ) -> ( ) );
...
pub unsafe fn glDrawPixels(width: i32, height: i32, format: u32, r#type: u32, pixels: *const ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glDrawPixels ( width : i32 , height : i32 , format : u32 , r#type : u32 , pixels : *const ::core::ffi::c_void ) -> ( ) );
    glDrawPixels(width, height, format, r#type, ::core::mem::transmute(pixels))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEdgeFlag(flag: u8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEdgeFlag ( flag : u8 ) -> ( ) );
    glEdgeFlag(flag)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEdgeFlagPointer(stride: i32, pointer: *const ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEdgeFlagPointer ( stride : i32 , pointer : *const ::core::ffi::c_void ) -> ( ) );
    glEdgeFlagPointer(stride, ::core::mem::transmute(pointer))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEdgeFlagv(flag: *const u8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEdgeFlagv ( flag : *const u8 ) -> ( ) );
    glEdgeFlagv(::core::mem::transmute(flag))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEnable(cap: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEnable ( cap : u32 ) -> ( ) );
    glEnable(cap)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEnableClientState(array: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEnableClientState ( array : u32 ) -> ( ) );
    glEnableClientState(array)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEnd() {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEnd ( ) -> ( ) );
    glEnd()
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEndList() {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEndList ( ) -> ( ) );
    glEndList()
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEvalCoord1d(u: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEvalCoord1d ( u : f64 ) -> ( ) );
    glEvalCoord1d(u)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEvalCoord1dv(u: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEvalCoord1dv ( u : *const f64 ) -> ( ) );
    glEvalCoord1dv(::core::mem::transmute(u))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEvalCoord1f(u: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEvalCoord1f ( u : f32 ) -> ( ) );
    glEvalCoord1f(u)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEvalCoord1fv(u: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEvalCoord1fv ( u : *const f32 ) -> ( ) );
    glEvalCoord1fv(::core::mem::transmute(u))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEvalCoord2d(u: f64, v: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEvalCoord2d ( u : f64 , v : f64 ) -> ( ) );
    glEvalCoord2d(u, v)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEvalCoord2dv(u: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEvalCoord2dv ( u : *const f64 ) -> ( ) );
    glEvalCoord2dv(::core::mem::transmute(u))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEvalCoord2f(u: f32, v: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEvalCoord2f ( u : f32 , v : f32 ) -> ( ) );
    glEvalCoord2f(u, v)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEvalCoord2fv(u: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEvalCoord2fv ( u : *const f32 ) -> ( ) );
    glEvalCoord2fv(::core::mem::transmute(u))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEvalMesh1(mode: u32, i1: i32, i2: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEvalMesh1 ( mode : u32 , i1 : i32 , i2 : i32 ) -> ( ) );
    glEvalMesh1(mode, i1, i2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEvalMesh2(mode: u32, i1: i32, i2: i32, j1: i32, j2: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEvalMesh2 ( mode : u32 , i1 : i32 , i2 : i32 , j1 : i32 , j2 : i32 ) -> ( ) );
    glEvalMesh2(mode, i1, i2, j1, j2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEvalPoint1(i: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEvalPoint1 ( i : i32 ) -> ( ) );
    glEvalPoint1(i)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glEvalPoint2(i: i32, j: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glEvalPoint2 ( i : i32 , j : i32 ) -> ( ) );
    glEvalPoint2(i, j)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glFeedbackBuffer(size: i32, r#type: u32, buffer: *mut f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glFeedbackBuffer ( size : i32 , r#type : u32 , buffer : *mut f32 ) -> ( ) );
    glFeedbackBuffer(size, r#type, ::core::mem::transmute(buffer))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glFinish() {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glFinish ( ) -> ( ) );
    glFinish()
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glFlush() {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glFlush ( ) -> ( ) );
    glFlush()
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glFogf(pname: u32, param1: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glFogf ( pname : u32 , param1 : f32 ) -> ( ) );
    glFogf(pname, param1)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glFogfv(pname: u32, params: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glFogfv ( pname : u32 , params : *const f32 ) -> ( ) );
    glFogfv(pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glFogi(pname: u32, param1: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glFogi ( pname : u32 , param1 : i32 ) -> ( ) );
    glFogi(pname, param1)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glFogiv(pname: u32, params: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glFogiv ( pname : u32 , params : *const i32 ) -> ( ) );
    glFogiv(pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glFrontFace(mode: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glFrontFace ( mode : u32 ) -> ( ) );
    glFrontFace(mode)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glFrustum(left: f64, right: f64, bottom: f64, top: f64, znear: f64, zfar: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glFrustum ( left : f64 , right : f64 , bottom : f64 , top : f64 , znear : f64 , zfar : f64 ) -> ( ) );
    glFrustum(left, right, bottom, top, znear, zfar)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGenLists(range: i32) -> u32 {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGenLists ( range : i32 ) -> u32 );
    glGenLists(range)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGenTextures(n: i32, textures: *mut u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGenTextures ( n : i32 , textures : *mut u32 ) -> ( ) );
    glGenTextures(n, ::core::mem::transmute(textures))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetBooleanv(pname: u32, params: *mut u8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetBooleanv ( pname : u32 , params : *mut u8 ) -> ( ) );
    glGetBooleanv(pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetClipPlane(plane: u32, equation: *mut f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetClipPlane ( plane : u32 , equation : *mut f64 ) -> ( ) );
    glGetClipPlane(plane, ::core::mem::transmute(equation))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetDoublev(pname: u32, params: *mut f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetDoublev ( pname : u32 , params : *mut f64 ) -> ( ) );
    glGetDoublev(pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetError() -> u32 {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetError ( ) -> u32 );
    glGetError()
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetFloatv(pname: u32, params: *mut f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetFloatv ( pname : u32 , params : *mut f32 ) -> ( ) );
    glGetFloatv(pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetIntegerv(pname: u32, params: *mut i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetIntegerv ( pname : u32 , params : *mut i32 ) -> ( ) );
    glGetIntegerv(pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetLightfv(light: u32, pname: u32, params: *mut f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetLightfv ( light : u32 , pname : u32 , params : *mut f32 ) -> ( ) );
    glGetLightfv(light, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetLightiv(light: u32, pname: u32, params: *mut i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetLightiv ( light : u32 , pname : u32 , params : *mut i32 ) -> ( ) );
    glGetLightiv(light, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetMapdv(target: u32, query: u32, v: *mut f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetMapdv ( target : u32 , query : u32 , v : *mut f64 ) -> ( ) );
    glGetMapdv(target, query, ::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetMapfv(target: u32, query: u32, v: *mut f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetMapfv ( target : u32 , query : u32 , v : *mut f32 ) -> ( ) );
    glGetMapfv(target, query, ::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetMapiv(target: u32, query: u32, v: *mut i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetMapiv ( target : u32 , query : u32 , v : *mut i32 ) -> ( ) );
    glGetMapiv(target, query, ::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetMaterialfv(face: u32, pname: u32, params: *mut f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetMaterialfv ( face : u32 , pname : u32 , params : *mut f32 ) -> ( ) );
    glGetMaterialfv(face, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetMaterialiv(face: u32, pname: u32, params: *mut i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetMaterialiv ( face : u32 , pname : u32 , params : *mut i32 ) -> ( ) );
    glGetMaterialiv(face, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetPixelMapfv(map: u32, values: *mut f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetPixelMapfv ( map : u32 , values : *mut f32 ) -> ( ) );
    glGetPixelMapfv(map, ::core::mem::transmute(values))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetPixelMapuiv(map: u32, values: *mut u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetPixelMapuiv ( map : u32 , values : *mut u32 ) -> ( ) );
    glGetPixelMapuiv(map, ::core::mem::transmute(values))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetPixelMapusv(map: u32, values: *mut u16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetPixelMapusv ( map : u32 , values : *mut u16 ) -> ( ) );
    glGetPixelMapusv(map, ::core::mem::transmute(values))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetPointerv(pname: u32, params: *mut *mut ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetPointerv ( pname : u32 , params : *mut *mut ::core::ffi::c_void ) -> ( ) );
    glGetPointerv(pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetPolygonStipple(mask: *mut u8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetPolygonStipple ( mask : *mut u8 ) -> ( ) );
    glGetPolygonStipple(::core::mem::transmute(mask))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetString(name: u32) -> *mut u8 {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetString ( name : u32 ) -> *mut u8 );
    glGetString(name)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetTexEnvfv(target: u32, pname: u32, params: *mut f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetTexEnvfv ( target : u32 , pname : u32 , params : *mut f32 ) -> ( ) );
    glGetTexEnvfv(target, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetTexEnviv(target: u32, pname: u32, params: *mut i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetTexEnviv ( target : u32 , pname : u32 , params : *mut i32 ) -> ( ) );
    glGetTexEnviv(target, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetTexGendv(coord: u32, pname: u32, params: *mut f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetTexGendv ( coord : u32 , pname : u32 , params : *mut f64 ) -> ( ) );
    glGetTexGendv(coord, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetTexGenfv(coord: u32, pname: u32, params: *mut f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetTexGenfv ( coord : u32 , pname : u32 , params : *mut f32 ) -> ( ) );
    glGetTexGenfv(coord, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glGetTexGeniv(coord: u32, pname: u32, params: *mut i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetTexGeniv ( coord : u32 , pname : u32 , params : *mut i32 ) -> ( ) );
...
pub unsafe fn glGetTexImage(target: u32, level: i32, format: u32, r#type: u32, pixels: *mut ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetTexImage ( target : u32 , level : i32 , format : u32 , r#type : u32 , pixels : *mut ::core::ffi::c_void ) -> ( ) );
...
pub unsafe fn glGetTexLevelParameterfv(target: u32, level: i32, pname: u32, params: *mut f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetTexLevelParameterfv ( target : u32 , level : i32 , pname : u32 , params : *mut f32 ) -> ( ) );
...
pub unsafe fn glGetTexLevelParameteriv(target: u32, level: i32, pname: u32, params: *mut i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetTexLevelParameteriv ( target : u32 , level : i32 , pname : u32 , params : *mut i32 ) -> ( ) );
...
pub unsafe fn glGetTexParameterfv(target: u32, pname: u32, params: *mut f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetTexParameterfv ( target : u32 , pname : u32 , params : *mut f32 ) -> ( ) );
...
pub unsafe fn glGetTexParameteriv(target: u32, pname: u32, params: *mut i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glGetTexParameteriv ( target : u32 , pname : u32 , params : *mut i32 ) -> ( ) );
    glGetTexParameteriv(target, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glHint(target: u32, mode: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glHint ( target : u32 , mode : u32 ) -> ( ) );
    glHint(target, mode)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glIndexMask(mask: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glIndexMask ( mask : u32 ) -> ( ) );
    glIndexMask(mask)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glIndexPointer(r#type: u32, stride: i32, pointer: *const ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glIndexPointer ( r#type : u32 , stride : i32 , pointer : *const ::core::ffi::c_void ) -> ( ) );
...
pub unsafe fn glIndexdv(c: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glIndexdv ( c : *const f64 ) -> ( ) );
    glIndexdv(::core::mem::transmute(c))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glIndexf(c: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glIndexf ( c : f32 ) -> ( ) );
    glIndexf(c)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glIndexfv(c: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glIndexfv ( c : *const f32 ) -> ( ) );
    glIndexfv(::core::mem::transmute(c))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glIndexi(c: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glIndexi ( c : i32 ) -> ( ) );
    glIndexi(c)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glIndexiv(c: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glIndexiv ( c : *const i32 ) -> ( ) );
    glIndexiv(::core::mem::transmute(c))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glIndexs(c: i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glIndexs ( c : i16 ) -> ( ) );
    glIndexs(c)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glIndexsv(c: *const i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glIndexsv ( c : *const i16 ) -> ( ) );
    glIndexsv(::core::mem::transmute(c))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glIndexub(c: u8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glIndexub ( c : u8 ) -> ( ) );
    glIndexub(c)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glIndexubv(c: *const u8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glIndexubv ( c : *const u8 ) -> ( ) );
    glIndexubv(::core::mem::transmute(c))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glInitNames() {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glInitNames ( ) -> ( ) );
    glInitNames()
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glInterleavedArrays(format: u32, stride: i32, pointer: *const ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glInterleavedArrays ( format : u32 , stride : i32 , pointer : *const ::core::ffi::c_void ) -> ( ) );
    glInterleavedArrays(format, stride, ::core::mem::transmute(pointer))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glIsEnabled(cap: u32) -> u8 {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glIsEnabled ( cap : u32 ) -> u8 );
    glIsEnabled(cap)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glIsList(list: u32) -> u8 {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glIsList ( list : u32 ) -> u8 );
    glIsList(list)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glIsTexture(texture: u32) -> u8 {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glIsTexture ( texture : u32 ) -> u8 );
    glIsTexture(texture)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glLightModelf(pname: u32, param1: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glLightModelf ( pname : u32 , param1 : f32 ) -> ( ) );
    glLightModelf(pname, param1)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glLightModelfv(pname: u32, params: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glLightModelfv ( pname : u32 , params : *const f32 ) -> ( ) );
    glLightModelfv(pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glLightModeli(pname: u32, param1: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glLightModeli ( pname : u32 , param1 : i32 ) -> ( ) );
    glLightModeli(pname, param1)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glLightModeliv(pname: u32, params: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glLightModeliv ( pname : u32 , params : *const i32 ) -> ( ) );
    glLightModeliv(pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glLightf(light: u32, pname: u32, param2: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glLightf ( light : u32 , pname : u32 , param2 : f32 ) -> ( ) );
    glLightf(light, pname, param2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glLightfv(light: u32, pname: u32, params: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glLightfv ( light : u32 , pname : u32 , params : *const f32 ) -> ( ) );
    glLightfv(light, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glLighti(light: u32, pname: u32, param2: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glLighti ( light : u32 , pname : u32 , param2 : i32 ) -> ( ) );
    glLighti(light, pname, param2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glLightiv(light: u32, pname: u32, params: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glLightiv ( light : u32 , pname : u32 , params : *const i32 ) -> ( ) );
    glLightiv(light, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glLineStipple(factor: i32, pattern: u16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glLineStipple ( factor : i32 , pattern : u16 ) -> ( ) );
    glLineStipple(factor, pattern)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glLineWidth(width: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glLineWidth ( width : f32 ) -> ( ) );
    glLineWidth(width)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glListBase(base: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glListBase ( base : u32 ) -> ( ) );
    glListBase(base)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glLoadIdentity() {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glLoadIdentity ( ) -> ( ) );
    glLoadIdentity()
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glLoadMatrixd(m: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glLoadMatrixd ( m : *const f64 ) -> ( ) );
    glLoadMatrixd(::core::mem::transmute(m))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glLoadMatrixf(m: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glLoadMatrixf ( m : *const f32 ) -> ( ) );
    glLoadMatrixf(::core::mem::transmute(m))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glLoadName(name: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glLoadName ( name : u32 ) -> ( ) );
    glLoadName(name)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glLogicOp(opcode: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glLogicOp ( opcode : u32 ) -> ( ) );
    glLogicOp(opcode)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glMap1d(target: u32, u1: f64, u2: f64, stride: i32, order: i32, points: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glMap1d ( target : u32 , u1 : f64 , u2 : f64 , stride : i32 , order : i32 , points : *const f64 ) -> ( ) );
...
pub unsafe fn glMap1f(target: u32, u1: f32, u2: f32, stride: i32, order: i32, points: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glMap1f ( target : u32 , u1 : f32 , u2 : f32 , stride : i32 , order : i32 , points : *const f32 ) -> ( ) );
...
pub unsafe fn glMap2d(target: u32, u1: f64, u2: f64, ustride: i32, uorder: i32, v1: f64, v2: f64, vstride: i32, vorder: i32, points: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glMap2d ( target : u32 , u1 : f64 , u2 : f64 , ustride : i32 , uorder : i32 , v1 : f64 , v2 : f64 , vstride : i32 , vorder : i32 , points : *const f64 ) -> ( ) );
...
pub unsafe fn glMap2f(target: u32, u1: f32, u2: f32, ustride: i32, uorder: i32, v1: f32, v2: f32, vstride: i32, vorder: i32, points: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glMap2f ( target : u32 , u1 : f32 , u2 : f32 , ustride : i32 , uorder : i32 , v1 : f32 , v2 : f32 , vstride : i32 , vorder : i32 , points : *const f32 ) -> ( ) );
...
pub unsafe fn glMapGrid1d(un: i32, u1: f64, u2: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glMapGrid1d ( un : i32 , u1 : f64 , u2 : f64 ) -> ( ) );
    glMapGrid1d(un, u1, u2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glMapGrid1f(un: i32, u1: f32, u2: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glMapGrid1f ( un : i32 , u1 : f32 , u2 : f32 ) -> ( ) );
    glMapGrid1f(un, u1, u2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glMapGrid2d(un: i32, u1: f64, u2: f64, vn: i32, v1: f64, v2: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glMapGrid2d ( un : i32 , u1 : f64 , u2 : f64 , vn : i32 , v1 : f64 , v2 : f64 ) -> ( ) );
    glMapGrid2d(un, u1, u2, vn, v1, v2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glMapGrid2f(un: i32, u1: f32, u2: f32, vn: i32, v1: f32, v2: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glMapGrid2f ( un : i32 , u1 : f32 , u2 : f32 , vn : i32 , v1 : f32 , v2 : f32 ) -> ( ) );
    glMapGrid2f(un, u1, u2, vn, v1, v2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glMaterialf(face: u32, pname: u32, param2: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glMaterialf ( face : u32 , pname : u32 , param2 : f32 ) -> ( ) );
    glMaterialf(face, pname, param2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glMaterialfv(face: u32, pname: u32, params: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glMaterialfv ( face : u32 , pname : u32 , params : *const f32 ) -> ( ) );
    glMaterialfv(face, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glMateriali(face: u32, pname: u32, param2: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glMateriali ( face : u32 , pname : u32 , param2 : i32 ) -> ( ) );
    glMateriali(face, pname, param2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glMaterialiv(face: u32, pname: u32, params: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glMaterialiv ( face : u32 , pname : u32 , params : *const i32 ) -> ( ) );
    glMaterialiv(face, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glMatrixMode(mode: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glMatrixMode ( mode : u32 ) -> ( ) );
    glMatrixMode(mode)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glMultMatrixd(m: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glMultMatrixd ( m : *const f64 ) -> ( ) );
    glMultMatrixd(::core::mem::transmute(m))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glMultMatrixf(m: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glMultMatrixf ( m : *const f32 ) -> ( ) );
    glMultMatrixf(::core::mem::transmute(m))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glNewList(list: u32, mode: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glNewList ( list : u32 , mode : u32 ) -> ( ) );
    glNewList(list, mode)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glNormal3b(nx: i8, ny: i8, nz: i8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glNormal3b ( nx : i8 , ny : i8 , nz : i8 ) -> ( ) );
    glNormal3b(nx, ny, nz)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glNormal3bv(v: *const i8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glNormal3bv ( v : *const i8 ) -> ( ) );
    glNormal3bv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glNormal3d(nx: f64, ny: f64, nz: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glNormal3d ( nx : f64 , ny : f64 , nz : f64 ) -> ( ) );
    glNormal3d(nx, ny, nz)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glNormal3dv(v: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glNormal3dv ( v : *const f64 ) -> ( ) );
...
pub unsafe fn glNormal3fv(v: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glNormal3fv ( v : *const f32 ) -> ( ) );
    glNormal3fv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glNormal3i(nx: i32, ny: i32, nz: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glNormal3i ( nx : i32 , ny : i32 , nz : i32 ) -> ( ) );
    glNormal3i(nx, ny, nz)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glNormal3iv(v: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glNormal3iv ( v : *const i32 ) -> ( ) );
    glNormal3iv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glNormal3s(nx: i16, ny: i16, nz: i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glNormal3s ( nx : i16 , ny : i16 , nz : i16 ) -> ( ) );
    glNormal3s(nx, ny, nz)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glNormal3sv(v: *const i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glNormal3sv ( v : *const i16 ) -> ( ) );
    glNormal3sv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glNormalPointer(r#type: u32, stride: i32, pointer: *const ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glNormalPointer ( r#type : u32 , stride : i32 , pointer : *const ::core::ffi::c_void ) -> ( ) );
...
pub unsafe fn glOrtho(left: f64, right: f64, bottom: f64, top: f64, znear: f64, zfar: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glOrtho ( left : f64 , right : f64 , bottom : f64 , top : f64 , znear : f64 , zfar : f64 ) -> ( ) );
    glOrtho(left, right, bottom, top, znear, zfar)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPassThrough(token: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPassThrough ( token : f32 ) -> ( ) );
    glPassThrough(token)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPixelMapfv(map: u32, mapsize: i32, values: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPixelMapfv ( map : u32 , mapsize : i32 , values : *const f32 ) -> ( ) );
    glPixelMapfv(map, mapsize, ::core::mem::transmute(values))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPixelMapuiv(map: u32, mapsize: i32, values: *const u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPixelMapuiv ( map : u32 , mapsize : i32 , values : *const u32 ) -> ( ) );
    glPixelMapuiv(map, mapsize, ::core::mem::transmute(values))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPixelMapusv(map: u32, mapsize: i32, values: *const u16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPixelMapusv ( map : u32 , mapsize : i32 , values : *const u16 ) -> ( ) );
    glPixelMapusv(map, mapsize, ::core::mem::transmute(values))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPixelStoref(pname: u32, param1: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPixelStoref ( pname : u32 , param1 : f32 ) -> ( ) );
    glPixelStoref(pname, param1)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPixelStorei(pname: u32, param1: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPixelStorei ( pname : u32 , param1 : i32 ) -> ( ) );
    glPixelStorei(pname, param1)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPixelTransferf(pname: u32, param1: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPixelTransferf ( pname : u32 , param1 : f32 ) -> ( ) );
    glPixelTransferf(pname, param1)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPixelTransferi(pname: u32, param1: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPixelTransferi ( pname : u32 , param1 : i32 ) -> ( ) );
    glPixelTransferi(pname, param1)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPixelZoom(xfactor: f32, yfactor: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPixelZoom ( xfactor : f32 , yfactor : f32 ) -> ( ) );
    glPixelZoom(xfactor, yfactor)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPointSize(size: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPointSize ( size : f32 ) -> ( ) );
    glPointSize(size)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPolygonMode(face: u32, mode: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPolygonMode ( face : u32 , mode : u32 ) -> ( ) );
    glPolygonMode(face, mode)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPolygonOffset(factor: f32, units: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPolygonOffset ( factor : f32 , units : f32 ) -> ( ) );
    glPolygonOffset(factor, units)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPolygonStipple(mask: *const u8) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPolygonStipple ( mask : *const u8 ) -> ( ) );
    glPolygonStipple(::core::mem::transmute(mask))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPopAttrib() {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPopAttrib ( ) -> ( ) );
    glPopAttrib()
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPopClientAttrib() {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPopClientAttrib ( ) -> ( ) );
    glPopClientAttrib()
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPopMatrix() {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPopMatrix ( ) -> ( ) );
    glPopMatrix()
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPopName() {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPopName ( ) -> ( ) );
    glPopName()
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPrioritizeTextures(n: i32, textures: *const u32, priorities: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPrioritizeTextures ( n : i32 , textures : *const u32 , priorities : *const f32 ) -> ( ) );
    glPrioritizeTextures(n, ::core::mem::transmute(textures), ::core::mem::transmute(priorities))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPushAttrib(mask: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPushAttrib ( mask : u32 ) -> ( ) );
    glPushAttrib(mask)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPushClientAttrib(mask: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPushClientAttrib ( mask : u32 ) -> ( ) );
    glPushClientAttrib(mask)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPushMatrix() {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPushMatrix ( ) -> ( ) );
    glPushMatrix()
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glPushName(name: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glPushName ( name : u32 ) -> ( ) );
    glPushName(name)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos2d(x: f64, y: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos2d ( x : f64 , y : f64 ) -> ( ) );
    glRasterPos2d(x, y)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos2dv(v: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos2dv ( v : *const f64 ) -> ( ) );
    glRasterPos2dv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos2f(x: f32, y: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos2f ( x : f32 , y : f32 ) -> ( ) );
    glRasterPos2f(x, y)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos2fv(v: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos2fv ( v : *const f32 ) -> ( ) );
    glRasterPos2fv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos2i(x: i32, y: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos2i ( x : i32 , y : i32 ) -> ( ) );
    glRasterPos2i(x, y)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos2iv(v: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos2iv ( v : *const i32 ) -> ( ) );
...
pub unsafe fn glRasterPos2sv(v: *const i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos2sv ( v : *const i16 ) -> ( ) );
    glRasterPos2sv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos3d(x: f64, y: f64, z: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos3d ( x : f64 , y : f64 , z : f64 ) -> ( ) );
    glRasterPos3d(x, y, z)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos3dv(v: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos3dv ( v : *const f64 ) -> ( ) );
    glRasterPos3dv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos3f(x: f32, y: f32, z: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos3f ( x : f32 , y : f32 , z : f32 ) -> ( ) );
    glRasterPos3f(x, y, z)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos3fv(v: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos3fv ( v : *const f32 ) -> ( ) );
    glRasterPos3fv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos3i(x: i32, y: i32, z: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos3i ( x : i32 , y : i32 , z : i32 ) -> ( ) );
    glRasterPos3i(x, y, z)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos3iv(v: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos3iv ( v : *const i32 ) -> ( ) );
    glRasterPos3iv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos3s(x: i16, y: i16, z: i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos3s ( x : i16 , y : i16 , z : i16 ) -> ( ) );
    glRasterPos3s(x, y, z)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos3sv(v: *const i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos3sv ( v : *const i16 ) -> ( ) );
    glRasterPos3sv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos4d(x: f64, y: f64, z: f64, w: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos4d ( x : f64 , y : f64 , z : f64 , w : f64 ) -> ( ) );
    glRasterPos4d(x, y, z, w)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos4dv(v: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos4dv ( v : *const f64 ) -> ( ) );
    glRasterPos4dv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos4f(x: f32, y: f32, z: f32, w: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos4f ( x : f32 , y : f32 , z : f32 , w : f32 ) -> ( ) );
    glRasterPos4f(x, y, z, w)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos4fv(v: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos4fv ( v : *const f32 ) -> ( ) );
    glRasterPos4fv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos4i(x: i32, y: i32, z: i32, w: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos4i ( x : i32 , y : i32 , z : i32 , w : i32 ) -> ( ) );
    glRasterPos4i(x, y, z, w)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos4iv(v: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos4iv ( v : *const i32 ) -> ( ) );
    glRasterPos4iv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos4s(x: i16, y: i16, z: i16, w: i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos4s ( x : i16 , y : i16 , z : i16 , w : i16 ) -> ( ) );
    glRasterPos4s(x, y, z, w)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRasterPos4sv(v: *const i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRasterPos4sv ( v : *const i16 ) -> ( ) );
    glRasterPos4sv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glReadBuffer(mode: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glReadBuffer ( mode : u32 ) -> ( ) );
    glReadBuffer(mode)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glReadPixels(x: i32, y: i32, width: i32, height: i32, format: u32, r#type: u32, pixels: *mut ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glReadPixels ( x : i32 , y : i32 , width : i32 , height : i32 , format : u32 , r#type : u32 , pixels : *mut ::core::ffi::c_void ) -> ( ) );
    glReadPixels(x, y, width, height, format, r#type, ::core::mem::transmute(pixels))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRectd(x1: f64, y1: f64, x2: f64, y2: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRectd ( x1 : f64 , y1 : f64 , x2 : f64 , y2 : f64 ) -> ( ) );
    glRectd(x1, y1, x2, y2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRectdv(v1: *const f64, v2: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRectdv ( v1 : *const f64 , v2 : *const f64 ) -> ( ) );
    glRectdv(::core::mem::transmute(v1), ::core::mem::transmute(v2))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRectf(x1: f32, y1: f32, x2: f32, y2: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRectf ( x1 : f32 , y1 : f32 , x2 : f32 , y2 : f32 ) -> ( ) );
    glRectf(x1, y1, x2, y2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRectfv(v1: *const f32, v2: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRectfv ( v1 : *const f32 , v2 : *const f32 ) -> ( ) );
    glRectfv(::core::mem::transmute(v1), ::core::mem::transmute(v2))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRecti(x1: i32, y1: i32, x2: i32, y2: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRecti ( x1 : i32 , y1 : i32 , x2 : i32 , y2 : i32 ) -> ( ) );
    glRecti(x1, y1, x2, y2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRectiv(v1: *const i32, v2: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRectiv ( v1 : *const i32 , v2 : *const i32 ) -> ( ) );
    glRectiv(::core::mem::transmute(v1), ::core::mem::transmute(v2))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRects(x1: i16, y1: i16, x2: i16, y2: i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRects ( x1 : i16 , y1 : i16 , x2 : i16 , y2 : i16 ) -> ( ) );
    glRects(x1, y1, x2, y2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRectsv(v1: *const i16, v2: *const i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRectsv ( v1 : *const i16 , v2 : *const i16 ) -> ( ) );
    glRectsv(::core::mem::transmute(v1), ::core::mem::transmute(v2))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRenderMode(mode: u32) -> i32 {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRenderMode ( mode : u32 ) -> i32 );
    glRenderMode(mode)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRotated(angle: f64, x: f64, y: f64, z: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRotated ( angle : f64 , x : f64 , y : f64 , z : f64 ) -> ( ) );
    glRotated(angle, x, y, z)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glRotatef(angle: f32, x: f32, y: f32, z: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glRotatef ( angle : f32 , x : f32 , y : f32 , z : f32 ) -> ( ) );
    glRotatef(angle, x, y, z)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glScaled(x: f64, y: f64, z: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glScaled ( x : f64 , y : f64 , z : f64 ) -> ( ) );
    glScaled(x, y, z)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glScalef(x: f32, y: f32, z: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glScalef ( x : f32 , y : f32 , z : f32 ) -> ( ) );
    glScalef(x, y, z)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glScissor(x: i32, y: i32, width: i32, height: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glScissor ( x : i32 , y : i32 , width : i32 , height : i32 ) -> ( ) );
    glScissor(x, y, width, height)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glSelectBuffer(size: i32, buffer: *mut u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glSelectBuffer ( size : i32 , buffer : *mut u32 ) -> ( ) );
    glSelectBuffer(size, ::core::mem::transmute(buffer))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glShadeModel(mode: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glShadeModel ( mode : u32 ) -> ( ) );
    glShadeModel(mode)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glStencilFunc(func: u32, r#ref: i32, mask: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glStencilFunc ( func : u32 , r#ref : i32 , mask : u32 ) -> ( ) );
    glStencilFunc(func, r#ref, mask)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glStencilMask(mask: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glStencilMask ( mask : u32 ) -> ( ) );
    glStencilMask(mask)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glStencilOp(fail: u32, zfail: u32, zpass: u32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glStencilOp ( fail : u32 , zfail : u32 , zpass : u32 ) -> ( ) );
    glStencilOp(fail, zfail, zpass)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord1d(s: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord1d ( s : f64 ) -> ( ) );
    glTexCoord1d(s)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord1dv(v: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord1dv ( v : *const f64 ) -> ( ) );
    glTexCoord1dv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord1f(s: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord1f ( s : f32 ) -> ( ) );
    glTexCoord1f(s)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord1fv(v: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord1fv ( v : *const f32 ) -> ( ) );
    glTexCoord1fv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord1i(s: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord1i ( s : i32 ) -> ( ) );
    glTexCoord1i(s)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord1iv(v: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord1iv ( v : *const i32 ) -> ( ) );
    glTexCoord1iv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord1s(s: i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord1s ( s : i16 ) -> ( ) );
    glTexCoord1s(s)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord1sv(v: *const i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord1sv ( v : *const i16 ) -> ( ) );
    glTexCoord1sv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord2d(s: f64, t: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord2d ( s : f64 , t : f64 ) -> ( ) );
    glTexCoord2d(s, t)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord2dv(v: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord2dv ( v : *const f64 ) -> ( ) );
    glTexCoord2dv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord2f(s: f32, t: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord2f ( s : f32 , t : f32 ) -> ( ) );
    glTexCoord2f(s, t)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord2fv(v: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord2fv ( v : *const f32 ) -> ( ) );
    glTexCoord2fv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord2i(s: i32, t: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord2i ( s : i32 , t : i32 ) -> ( ) );
    glTexCoord2i(s, t)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord2iv(v: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord2iv ( v : *const i32 ) -> ( ) );
    glTexCoord2iv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord2s(s: i16, t: i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord2s ( s : i16 , t : i16 ) -> ( ) );
    glTexCoord2s(s, t)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord2sv(v: *const i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord2sv ( v : *const i16 ) -> ( ) );
    glTexCoord2sv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord3d(s: f64, t: f64, r: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord3d ( s : f64 , t : f64 , r : f64 ) -> ( ) );
    glTexCoord3d(s, t, r)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord3dv(v: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord3dv ( v : *const f64 ) -> ( ) );
    glTexCoord3dv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord3f(s: f32, t: f32, r: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord3f ( s : f32 , t : f32 , r : f32 ) -> ( ) );
    glTexCoord3f(s, t, r)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord3fv(v: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord3fv ( v : *const f32 ) -> ( ) );
    glTexCoord3fv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord3i(s: i32, t: i32, r: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord3i ( s : i32 , t : i32 , r : i32 ) -> ( ) );
    glTexCoord3i(s, t, r)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord3iv(v: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord3iv ( v : *const i32 ) -> ( ) );
    glTexCoord3iv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord3s(s: i16, t: i16, r: i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord3s ( s : i16 , t : i16 , r : i16 ) -> ( ) );
    glTexCoord3s(s, t, r)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord3sv(v: *const i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord3sv ( v : *const i16 ) -> ( ) );
    glTexCoord3sv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord4d(s: f64, t: f64, r: f64, q: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord4d ( s : f64 , t : f64 , r : f64 , q : f64 ) -> ( ) );
    glTexCoord4d(s, t, r, q)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord4dv(v: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord4dv ( v : *const f64 ) -> ( ) );
    glTexCoord4dv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord4f(s: f32, t: f32, r: f32, q: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord4f ( s : f32 , t : f32 , r : f32 , q : f32 ) -> ( ) );
    glTexCoord4f(s, t, r, q)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord4fv(v: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord4fv ( v : *const f32 ) -> ( ) );
    glTexCoord4fv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord4i(s: i32, t: i32, r: i32, q: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord4i ( s : i32 , t : i32 , r : i32 , q : i32 ) -> ( ) );
    glTexCoord4i(s, t, r, q)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord4iv(v: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord4iv ( v : *const i32 ) -> ( ) );
    glTexCoord4iv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord4s(s: i16, t: i16, r: i16, q: i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord4s ( s : i16 , t : i16 , r : i16 , q : i16 ) -> ( ) );
    glTexCoord4s(s, t, r, q)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexCoord4sv(v: *const i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoord4sv ( v : *const i16 ) -> ( ) );
...
pub unsafe fn glTexCoordPointer(size: i32, r#type: u32, stride: i32, pointer: *const ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexCoordPointer ( size : i32 , r#type : u32 , stride : i32 , pointer : *const ::core::ffi::c_void ) -> ( ) );
    glTexCoordPointer(size, r#type, stride, ::core::mem::transmute(pointer))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexEnvf(target: u32, pname: u32, param2: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexEnvf ( target : u32 , pname : u32 , param2 : f32 ) -> ( ) );
    glTexEnvf(target, pname, param2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexEnvfv(target: u32, pname: u32, params: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexEnvfv ( target : u32 , pname : u32 , params : *const f32 ) -> ( ) );
    glTexEnvfv(target, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexEnvi(target: u32, pname: u32, param2: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexEnvi ( target : u32 , pname : u32 , param2 : i32 ) -> ( ) );
    glTexEnvi(target, pname, param2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexEnviv(target: u32, pname: u32, params: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexEnviv ( target : u32 , pname : u32 , params : *const i32 ) -> ( ) );
    glTexEnviv(target, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexGend(coord: u32, pname: u32, param2: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexGend ( coord : u32 , pname : u32 , param2 : f64 ) -> ( ) );
    glTexGend(coord, pname, param2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexGendv(coord: u32, pname: u32, params: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexGendv ( coord : u32 , pname : u32 , params : *const f64 ) -> ( ) );
    glTexGendv(coord, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexGenf(coord: u32, pname: u32, param2: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexGenf ( coord : u32 , pname : u32 , param2 : f32 ) -> ( ) );
    glTexGenf(coord, pname, param2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexGenfv(coord: u32, pname: u32, params: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexGenfv ( coord : u32 , pname : u32 , params : *const f32 ) -> ( ) );
    glTexGenfv(coord, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexGeni(coord: u32, pname: u32, param2: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexGeni ( coord : u32 , pname : u32 , param2 : i32 ) -> ( ) );
    glTexGeni(coord, pname, param2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexGeniv(coord: u32, pname: u32, params: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexGeniv ( coord : u32 , pname : u32 , params : *const i32 ) -> ( ) );
...
pub unsafe fn glTexImage1D(target: u32, level: i32, internalformat: i32, width: i32, border: i32, format: u32, r#type: u32, pixels: *const ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexImage1D ( target : u32 , level : i32 , internalformat : i32 , width : i32 , border : i32 , format : u32 , r#type : u32 , pixels : *const ::core::ffi::c_void ) -> ( ) );
...
pub unsafe fn glTexImage2D(target: u32, level: i32, internalformat: i32, width: i32, height: i32, border: i32, format: u32, r#type: u32, pixels: *const ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexImage2D ( target : u32 , level : i32 , internalformat : i32 , width : i32 , height : i32 , border : i32 , format : u32 , r#type : u32 , pixels : *const ::core::ffi::c_void ) -> ( ) );
...
pub unsafe fn glTexParameterf(target: u32, pname: u32, param2: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexParameterf ( target : u32 , pname : u32 , param2 : f32 ) -> ( ) );
    glTexParameterf(target, pname, param2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexParameterfv(target: u32, pname: u32, params: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexParameterfv ( target : u32 , pname : u32 , params : *const f32 ) -> ( ) );
    glTexParameterfv(target, pname, ::core::mem::transmute(params))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexParameteri(target: u32, pname: u32, param2: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexParameteri ( target : u32 , pname : u32 , param2 : i32 ) -> ( ) );
    glTexParameteri(target, pname, param2)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTexParameteriv(target: u32, pname: u32, params: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexParameteriv ( target : u32 , pname : u32 , params : *const i32 ) -> ( ) );
...
pub unsafe fn glTexSubImage1D(target: u32, level: i32, xoffset: i32, width: i32, format: u32, r#type: u32, pixels: *const ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexSubImage1D ( target : u32 , level : i32 , xoffset : i32 , width : i32 , format : u32 , r#type : u32 , pixels : *const ::core::ffi::c_void ) -> ( ) );
...
pub unsafe fn glTexSubImage2D(target: u32, level: i32, xoffset: i32, yoffset: i32, width: i32, height: i32, format: u32, r#type: u32, pixels: *const ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTexSubImage2D ( target : u32 , level : i32 , xoffset : i32 , yoffset : i32 , width : i32 , height : i32 , format : u32 , r#type : u32 , pixels : *const ::core::ffi::c_void ) -> ( ) );
...
pub unsafe fn glTranslated(x: f64, y: f64, z: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTranslated ( x : f64 , y : f64 , z : f64 ) -> ( ) );
    glTranslated(x, y, z)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glTranslatef(x: f32, y: f32, z: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glTranslatef ( x : f32 , y : f32 , z : f32 ) -> ( ) );
    glTranslatef(x, y, z)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex2d(x: f64, y: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex2d ( x : f64 , y : f64 ) -> ( ) );
    glVertex2d(x, y)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex2dv(v: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex2dv ( v : *const f64 ) -> ( ) );
    glVertex2dv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex2f(x: f32, y: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex2f ( x : f32 , y : f32 ) -> ( ) );
    glVertex2f(x, y)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex2fv(v: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex2fv ( v : *const f32 ) -> ( ) );
    glVertex2fv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex2i(x: i32, y: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex2i ( x : i32 , y : i32 ) -> ( ) );
    glVertex2i(x, y)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex2iv(v: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex2iv ( v : *const i32 ) -> ( ) );
...
pub unsafe fn glVertex2sv(v: *const i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex2sv ( v : *const i16 ) -> ( ) );
    glVertex2sv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex3d(x: f64, y: f64, z: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex3d ( x : f64 , y : f64 , z : f64 ) -> ( ) );
    glVertex3d(x, y, z)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex3dv(v: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex3dv ( v : *const f64 ) -> ( ) );
    glVertex3dv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex3f(x: f32, y: f32, z: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex3f ( x : f32 , y : f32 , z : f32 ) -> ( ) );
    glVertex3f(x, y, z)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex3fv(v: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex3fv ( v : *const f32 ) -> ( ) );
    glVertex3fv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex3i(x: i32, y: i32, z: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex3i ( x : i32 , y : i32 , z : i32 ) -> ( ) );
    glVertex3i(x, y, z)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex3iv(v: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex3iv ( v : *const i32 ) -> ( ) );
    glVertex3iv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex3s(x: i16, y: i16, z: i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex3s ( x : i16 , y : i16 , z : i16 ) -> ( ) );
    glVertex3s(x, y, z)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex3sv(v: *const i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex3sv ( v : *const i16 ) -> ( ) );
    glVertex3sv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex4d(x: f64, y: f64, z: f64, w: f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex4d ( x : f64 , y : f64 , z : f64 , w : f64 ) -> ( ) );
    glVertex4d(x, y, z, w)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex4dv(v: *const f64) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex4dv ( v : *const f64 ) -> ( ) );
    glVertex4dv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex4f(x: f32, y: f32, z: f32, w: f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex4f ( x : f32 , y : f32 , z : f32 , w : f32 ) -> ( ) );
    glVertex4f(x, y, z, w)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex4fv(v: *const f32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex4fv ( v : *const f32 ) -> ( ) );
    glVertex4fv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex4i(x: i32, y: i32, z: i32, w: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex4i ( x : i32 , y : i32 , z : i32 , w : i32 ) -> ( ) );
    glVertex4i(x, y, z, w)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex4iv(v: *const i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex4iv ( v : *const i32 ) -> ( ) );
    glVertex4iv(::core::mem::transmute(v))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex4s(x: i16, y: i16, z: i16, w: i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex4s ( x : i16 , y : i16 , z : i16 , w : i16 ) -> ( ) );
    glVertex4s(x, y, z, w)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glVertex4sv(v: *const i16) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertex4sv ( v : *const i16 ) -> ( ) );
...
pub unsafe fn glVertexPointer(size: i32, r#type: u32, stride: i32, pointer: *const ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glVertexPointer ( size : i32 , r#type : u32 , stride : i32 , pointer : *const ::core::ffi::c_void ) -> ( ) );
    glVertexPointer(size, r#type, stride, ::core::mem::transmute(pointer))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn glViewport(x: i32, y: i32, width: i32, height: i32) {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn glViewport ( x : i32 , y : i32 , width : i32 , height : i32 ) -> ( ) );
    glViewport(x, y, width, height)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn gluBeginCurve(nobj: *mut GLUnurbs) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluBeginCurve ( nobj : *mut GLUnurbs ) -> ( ) );
...
pub unsafe fn gluBeginSurface(nobj: *mut GLUnurbs) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluBeginSurface ( nobj : *mut GLUnurbs ) -> ( ) );
    gluBeginSurface(::core::mem::transmute(nobj))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn gluBeginTrim(nobj: *mut GLUnurbs) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluBeginTrim ( nobj : *mut GLUnurbs ) -> ( ) );
...
pub unsafe fn gluBuild1DMipmaps(target: u32, components: i32, width: i32, format: u32, r#type: u32, data: *const ::core::ffi::c_void) -> i32 {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluBuild1DMipmaps ( target : u32 , components : i32 , width : i32 , format : u32 , r#type : u32 , data : *const ::core::ffi::c_void ) -> i32 );
...
pub unsafe fn gluBuild2DMipmaps(target: u32, components: i32, width: i32, height: i32, format: u32, r#type: u32, data: *const ::core::ffi::c_void) -> i32 {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluBuild2DMipmaps ( target : u32 , components : i32 , width : i32 , height : i32 , format : u32 , r#type : u32 , data : *const ::core::ffi::c_void ) -> i32 );
...
pub unsafe fn gluCylinder(qobj: *mut GLUquadric, baseradius: f64, topradius: f64, height: f64, slices: i32, stacks: i32) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluCylinder ( qobj : *mut GLUquadric , baseradius : f64 , topradius : f64 , height : f64 , slices : i32 , stacks : i32 ) -> ( ) );
...
pub unsafe fn gluDeleteNurbsRenderer(nobj: *mut GLUnurbs) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluDeleteNurbsRenderer ( nobj : *mut GLUnurbs ) -> ( ) );
    gluDeleteNurbsRenderer(::core::mem::transmute(nobj))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn gluDeleteQuadric(state: *mut GLUquadric) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluDeleteQuadric ( state : *mut GLUquadric ) -> ( ) );
...
pub unsafe fn gluDisk(qobj: *mut GLUquadric, innerradius: f64, outerradius: f64, slices: i32, loops: i32) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluDisk ( qobj : *mut GLUquadric , innerradius : f64 , outerradius : f64 , slices : i32 , loops : i32 ) -> ( ) );
    gluDisk(::core::mem::transmute(qobj), innerradius, outerradius, slices, loops)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn gluEndCurve(nobj: *mut GLUnurbs) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluEndCurve ( nobj : *mut GLUnurbs ) -> ( ) );
...
pub unsafe fn gluEndSurface(nobj: *mut GLUnurbs) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluEndSurface ( nobj : *mut GLUnurbs ) -> ( ) );
    gluEndSurface(::core::mem::transmute(nobj))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn gluEndTrim(nobj: *mut GLUnurbs) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluEndTrim ( nobj : *mut GLUnurbs ) -> ( ) );
    gluEndTrim(::core::mem::transmute(nobj))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn gluErrorString(errcode: u32) -> *mut u8 {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluErrorString ( errcode : u32 ) -> *mut u8 );
    gluErrorString(errcode)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn gluErrorUnicodeStringEXT(errcode: u32) -> ::windows::core::PWSTR {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluErrorUnicodeStringEXT ( errcode : u32 ) -> :: windows::core::PWSTR );
    gluErrorUnicodeStringEXT(errcode)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn gluGetNurbsProperty(nobj: *mut GLUnurbs, property: u32, value: *mut f32) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluGetNurbsProperty ( nobj : *mut GLUnurbs , property : u32 , value : *mut f32 ) -> ( ) );
    gluGetNurbsProperty(::core::mem::transmute(nobj), property, ::core::mem::transmute(value))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn gluGetString(name: u32) -> *mut u8 {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluGetString ( name : u32 ) -> *mut u8 );
    gluGetString(name)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn gluGetTessProperty(tess: *mut GLUtesselator, which: u32, value: *mut f64) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluGetTessProperty ( tess : *mut GLUtesselator , which : u32 , value : *mut f64 ) -> ( ) );
...
pub unsafe fn gluLoadSamplingMatrices(nobj: *mut GLUnurbs, modelmatrix: *const f32, projmatrix: *const f32, viewport: *const i32) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluLoadSamplingMatrices ( nobj : *mut GLUnurbs , modelmatrix : *const f32 , projmatrix : *const f32 , viewport : *const i32 ) -> ( ) );
...
pub unsafe fn gluLookAt(eyex: f64, eyey: f64, eyez: f64, centerx: f64, centery: f64, centerz: f64, upx: f64, upy: f64, upz: f64) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluLookAt ( eyex : f64 , eyey : f64 , eyez : f64 , centerx : f64 , centery : f64 , centerz : f64 , upx : f64 , upy : f64 , upz : f64 ) -> ( ) );
    gluLookAt(eyex, eyey, eyez, centerx, centery, centerz, upx, upy, upz)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn gluNewNurbsRenderer() -> *mut GLUnurbs {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluNewNurbsRenderer ( ) -> *mut GLUnurbs );
    gluNewNurbsRenderer()
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn gluNewQuadric() -> *mut GLUquadric {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluNewQuadric ( ) -> *mut GLUquadric );
    gluNewQuadric()
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn gluNewTess() -> *mut GLUtesselator {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluNewTess ( ) -> *mut GLUtesselator );
    gluNewTess()
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn gluNextContour(tess: *mut GLUtesselator, r#type: u32) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluNextContour ( tess : *mut GLUtesselator , r#type : u32 ) -> ( ) );
    gluNextContour(::core::mem::transmute(tess), r#type)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn gluNurbsCallback(nobj: *mut GLUnurbs, which: u32, r#fn: isize) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluNurbsCallback ( nobj : *mut GLUnurbs , which : u32 , r#fn : isize ) -> ( ) );
...
pub unsafe fn gluNurbsCurve(nobj: *mut GLUnurbs, nknots: i32, knot: *mut f32, stride: i32, ctlarray: *mut f32, order: i32, r#type: u32) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluNurbsCurve ( nobj : *mut GLUnurbs , nknots : i32 , knot : *mut f32 , stride : i32 , ctlarray : *mut f32 , order : i32 , r#type : u32 ) -> ( ) );
...
pub unsafe fn gluNurbsProperty(nobj: *mut GLUnurbs, property: u32, value: f32) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluNurbsProperty ( nobj : *mut GLUnurbs , property : u32 , value : f32 ) -> ( ) );
...
pub unsafe fn gluNurbsSurface(nobj: *mut GLUnurbs, sknot_count: i32, sknot: *mut f32, tknot_count: i32, tknot: *mut f32, s_stride: i32, t_stride: i32, ctlarray: *mut f32, sorder: i32, torder: i32, r#type: u32) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluNurbsSurface ( nobj : *mut GLUnurbs , sknot_count : i32 , sknot : *mut f32 , tknot_count : i32 , tknot : *mut f32 , s_stride : i32 , t_stride : i32 , ctlarray : *mut f32 , sorder : i32 , torder : i32 , r#type : u32 ) -> ( ) );
...
pub unsafe fn gluOrtho2D(left: f64, right: f64, bottom: f64, top: f64) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluOrtho2D ( left : f64 , right : f64 , bottom : f64 , top : f64 ) -> ( ) );
...
pub unsafe fn gluPartialDisk(qobj: *mut GLUquadric, innerradius: f64, outerradius: f64, slices: i32, loops: i32, startangle: f64, sweepangle: f64) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluPartialDisk ( qobj : *mut GLUquadric , innerradius : f64 , outerradius : f64 , slices : i32 , loops : i32 , startangle : f64 , sweepangle : f64 ) -> ( ) );
...
pub unsafe fn gluPerspective(fovy: f64, aspect: f64, znear: f64, zfar: f64) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluPerspective ( fovy : f64 , aspect : f64 , znear : f64 , zfar : f64 ) -> ( ) );
    gluPerspective(fovy, aspect, znear, zfar)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn gluPickMatrix(x: f64, y: f64, width: f64, height: f64, viewport: *mut i32) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluPickMatrix ( x : f64 , y : f64 , width : f64 , height : f64 , viewport : *mut i32 ) -> ( ) );
...
pub unsafe fn gluProject(objx: f64, objy: f64, objz: f64, modelmatrix: *const f64, projmatrix: *const f64, viewport: *const i32, winx: *mut f64, winy: *mut f64, winz: *mut f64) -> i32 {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluProject ( objx : f64 , objy : f64 , objz : f64 , modelmatrix : *const f64 , projmatrix : *const f64 , viewport : *const i32 , winx : *mut f64 , winy : *mut f64 , winz : *mut f64 ) -> i32 );
...
pub unsafe fn gluPwlCurve(nobj: *mut GLUnurbs, count: i32, array: *mut f32, stride: i32, r#type: u32) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluPwlCurve ( nobj : *mut GLUnurbs , count : i32 , array : *mut f32 , stride : i32 , r#type : u32 ) -> ( ) );
...
pub unsafe fn gluQuadricCallback(qobj: *mut GLUquadric, which: u32, r#fn: isize) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluQuadricCallback ( qobj : *mut GLUquadric , which : u32 , r#fn : isize ) -> ( ) );
...
pub unsafe fn gluQuadricDrawStyle(quadobject: *mut GLUquadric, drawstyle: u32) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluQuadricDrawStyle ( quadobject : *mut GLUquadric , drawstyle : u32 ) -> ( ) );
...
pub unsafe fn gluQuadricNormals(quadobject: *mut GLUquadric, normals: u32) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluQuadricNormals ( quadobject : *mut GLUquadric , normals : u32 ) -> ( ) );
...
pub unsafe fn gluQuadricOrientation(quadobject: *mut GLUquadric, orientation: u32) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluQuadricOrientation ( quadobject : *mut GLUquadric , orientation : u32 ) -> ( ) );
...
pub unsafe fn gluQuadricTexture(quadobject: *mut GLUquadric, texturecoords: u8) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluQuadricTexture ( quadobject : *mut GLUquadric , texturecoords : u8 ) -> ( ) );
...
pub unsafe fn gluScaleImage(format: u32, widthin: i32, heightin: i32, typein: u32, datain: *const ::core::ffi::c_void, widthout: i32, heightout: i32, typeout: u32, dataout: *mut ::core::ffi::c_void) -> i32 {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluScaleImage ( format : u32 , widthin : i32 , heightin : i32 , typein : u32 , datain : *const ::core::ffi::c_void , widthout : i32 , heightout : i32 , typeout : u32 , dataout : *mut ::core::ffi::c_void ) -> i32 );
...
pub unsafe fn gluSphere(qobj: *mut GLUquadric, radius: f64, slices: i32, stacks: i32) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluSphere ( qobj : *mut GLUquadric , radius : f64 , slices : i32 , stacks : i32 ) -> ( ) );
...
pub unsafe fn gluTessBeginPolygon(tess: *mut GLUtesselator, polygon_data: *mut ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluTessBeginPolygon ( tess : *mut GLUtesselator , polygon_data : *mut ::core::ffi::c_void ) -> ( ) );
...
pub unsafe fn gluTessCallback(tess: *mut GLUtesselator, which: u32, r#fn: isize) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluTessCallback ( tess : *mut GLUtesselator , which : u32 , r#fn : isize ) -> ( ) );
...
pub unsafe fn gluTessNormal(tess: *mut GLUtesselator, x: f64, y: f64, z: f64) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluTessNormal ( tess : *mut GLUtesselator , x : f64 , y : f64 , z : f64 ) -> ( ) );
    gluTessNormal(::core::mem::transmute(tess), x, y, z)
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn gluTessProperty(tess: *mut GLUtesselator, which: u32, value: f64) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluTessProperty ( tess : *mut GLUtesselator , which : u32 , value : f64 ) -> ( ) );
...
pub unsafe fn gluTessVertex(tess: *mut GLUtesselator, coords: *mut f64, data: *mut ::core::ffi::c_void) {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluTessVertex ( tess : *mut GLUtesselator , coords : *mut f64 , data : *mut ::core::ffi::c_void ) -> ( ) );
...
pub unsafe fn gluUnProject(winx: f64, winy: f64, winz: f64, modelmatrix: *const f64, projmatrix: *const f64, viewport: *const i32, objx: *mut f64, objy: *mut f64, objz: *mut f64) -> i32 {
    ::windows::core::windows_link ! ( "glu32.dll" ,"system" fn gluUnProject ( winx : f64 , winy : f64 , winz : f64 , modelmatrix : *const f64 , projmatrix : *const f64 , viewport : *const i32 , objx : *mut f64 , objy : *mut f64 , objz : *mut f64 ) -> i32 );
...
{
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn wglCopyContext ( param0 : HGLRC , param1 : HGLRC , param2 : u32 ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<super::Gdi::HDC>,
{
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn wglCreateContext ( param0 : super::Gdi:: HDC ) -> HGLRC );
...
where
    P0: ::std::convert::Into<super::Gdi::HDC>,
{
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn wglCreateLayerContext ( param0 : super::Gdi:: HDC , param1 : i32 ) -> HGLRC );
...
where
    P0: ::std::convert::Into<super::Gdi::HDC>,
{
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn wglDescribeLayerPlane ( param0 : super::Gdi:: HDC , param1 : i32 , param2 : i32 , param3 : u32 , param4 : *mut LAYERPLANEDESCRIPTOR ) -> super::super::Foundation:: BOOL );
    wglDescribeLayerPlane(param0.into(), param1, param2, param3, ::core::mem::transmute(param4))
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`*"]
#[inline]
pub unsafe fn wglGetCurrentContext() -> HGLRC {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn wglGetCurrentContext ( ) -> HGLRC );
...
pub unsafe fn wglGetCurrentDC() -> super::Gdi::HDC {
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn wglGetCurrentDC ( ) -> super::Gdi:: HDC );
    wglGetCurrentDC()
}
#[doc = "*Required features: `\"Win32_Graphics_OpenGL\"`, `\"Win32_Foundation\"`, `\"Win32_Graphics_Gdi\"`*"]
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Graphics_Gdi"))]
...
where
    P0: ::std::convert::Into<super::Gdi::HDC>,
{
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn wglGetLayerPaletteEntries ( param0 : super::Gdi:: HDC , param1 : i32 , param2 : i32 , param3 : i32 , param4 : *mut super::super::Foundation:: COLORREF ) -> i32 );
...
{
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn wglGetProcAddress ( param0 : :: windows::core::PCSTR ) -> super::super::Foundation:: PROC );
...
where
    ...
    P1: ::std::convert::Into<HGLRC>,
{
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn wglMakeCurrent ( param0 : super::Gdi:: HDC , param1 : HGLRC ) -> super::super::Foundation:: BOOL );
...
{
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn wglRealizeLayerPalette ( param0 : super::Gdi:: HDC , param1 : i32 , param2 : super::super::Foundation:: BOOL ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<super::Gdi::HDC>,
{
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn wglSetLayerPaletteEntries ( param0 : super::Gdi:: HDC , param1 : i32 , param2 : i32 , param3 : i32 , param4 : *const super::super::Foundation:: COLORREF ) -> i32 );
...
where
    P0: ::std::convert::Into<super::Gdi::HDC>,
{
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn wglUseFontBitmapsA ( param0 : super::Gdi:: HDC , param1 : u32 , param2 : u32 , param3 : u32 ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<super::Gdi::HDC>,
{
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn wglUseFontBitmapsW ( param0 : super::Gdi:: HDC , param1 : u32 , param2 : u32 , param3 : u32 ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<super::Gdi::HDC>,
{
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn wglUseFontOutlinesA ( param0 : super::Gdi:: HDC , param1 : u32 , param2 : u32 , param3 : u32 , param4 : f32 , param5 : f32 , param6 : i32 , param7 : *mut GLYPHMETRICSFLOAT ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<super::Gdi::HDC>,
{
    ::windows::core::windows_link ! ( "opengl32.dll" ,"system" fn wglUseFontOutlinesW ( param0 : super::Gdi:: HDC , param1 : u32 , param2 : u32 , param3 : u32 , param4 : f32 , param5 : f32 , param6 : i32 , param7 : *mut GLYPHMETRICSFLOAT ) -> super::super::Foundation:: BOOL );
