...
impl IDirectManipulationContent {
    ...
    pub unsafe fn GetOutputTransform(&self, matrix: &mut [f32]) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).GetOutputTransform)(::core::mem::transmute_copy(self), ::core::mem::transmute(matrix.as_mut_ptr()), matrix.len() as _).ok()
    }
    #[doc = "*Required features: 'Win32_Graphics_DirectManipulation'*"]
    pub unsafe fn GetContentTransform(&self, matrix: &mut [f32]) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).GetContentTransform)(::core::mem::transmute_copy(self), ::core::mem::transmute(matrix.as_mut_ptr()), matrix.len() as _).ok()
    }
    #[doc = "*Required features: 'Win32_Graphics_DirectManipulation'*"]
...
impl IDirectManipulationPrimaryContent {
    ...
    pub unsafe fn SetSnapPoints(&self, motion: DIRECTMANIPULATION_MOTION_TYPES, points: &[f32]) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).SetSnapPoints)(::core::mem::transmute_copy(self), ::core::mem::transmute(motion), ::core::mem::transmute(points.as_ptr()), points.len() as _).ok()
    }
    #[doc = "*Required features: 'Win32_Graphics_DirectManipulation'*"]
    ...
    pub unsafe fn GetInertiaEndTransform(&self, matrix: &mut [f32]) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).GetInertiaEndTransform)(::core::mem::transmute_copy(self), ::core::mem::transmute(matrix.as_mut_ptr()), matrix.len() as _).ok()
    }
    #[doc = "*Required features: 'Win32_Graphics_DirectManipulation'*"]
