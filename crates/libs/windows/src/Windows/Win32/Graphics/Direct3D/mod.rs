...
impl ID3DDestructionNotifier {
    pub unsafe fn RegisterDestructionCallback(&self, callbackfn: PFN_DESTRUCTION_CALLBACK, pdata: *const core::ffi::c_void) -> Result<u32, windows_result::HRESULT> {
        unsafe {
    ...
    pub unsafe fn UnregisterDestructionCallback(&self, callbackid: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait ID3DDestructionNotifier_Impl: windows_core::IUnknownImpl {
    fn RegisterDestructionCallback(&self, callbackfn: PFN_DESTRUCTION_CALLBACK, pdata: *const core::ffi::c_void) -> Result<u32, windows_result::HRESULT>;
    fn UnregisterDestructionCallback(&self, callbackid: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl ID3DInclude {
    pub unsafe fn Open<P1>(&self, includetype: D3D_INCLUDE_TYPE, pfilename: P1, pparentdata: *const core::ffi::c_void, ppdata: *mut *mut core::ffi::c_void, pbytes: *mut u32) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Close(&self, pdata: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
pub trait ID3DInclude_Impl {
    fn Open(&self, includetype: D3D_INCLUDE_TYPE, pfilename: &windows_core::PCSTR, pparentdata: *const core::ffi::c_void, ppdata: *mut *mut core::ffi::c_void, pbytes: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn Close(&self, pdata: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
}
