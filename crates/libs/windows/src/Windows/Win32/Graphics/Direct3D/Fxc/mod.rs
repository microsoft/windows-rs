...
where
    ...
    P3: ::std::convert::Into<::windows::core::PCSTR>,
{
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DCompileFromFile ( pfilename : :: windows::core::PCWSTR , pdefines : *const super:: D3D_SHADER_MACRO , pinclude : * mut::core::ffi::c_void , pentrypoint : :: windows::core::PCSTR , ptarget : :: windows::core::PCSTR , flags1 : u32 , flags2 : u32 , ppcode : *mut * mut::core::ffi::c_void , pperrormsgs : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
...
pub unsafe fn D3DCompressShaders(pshaderdata: &[D3D_SHADER_DATA], uflags: u32) -> ::windows::core::Result<super::ID3DBlob> {
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DCompressShaders ( unumshaders : u32 , pshaderdata : *const D3D_SHADER_DATA , uflags : u32 , ppcompresseddata : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
...
pub unsafe fn D3DCreateBlob(size: usize) -> ::windows::core::Result<super::ID3DBlob> {
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DCreateBlob ( size : usize , ppblob : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
pub unsafe fn D3DCreateFunctionLinkingGraph(uflags: u32) -> ::windows::core::Result<super::super::Direct3D11::ID3D11FunctionLinkingGraph> {
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DCreateFunctionLinkingGraph ( uflags : u32 , ppfunctionlinkinggraph : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
pub unsafe fn D3DCreateLinker() -> ::windows::core::Result<super::super::Direct3D11::ID3D11Linker> {
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DCreateLinker ( pplinker : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
pub unsafe fn D3DDecompressShaders(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, unumshaders: u32, ustartindex: u32, pindices: ::core::option::Option<*const u32>, uflags: u32, ppshaders: *mut ::core::option::Option<super::ID3DBlob>, ptotalshaders: ::core::option::Option<*mut u32>) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DDecompressShaders ( psrcdata : *const ::core::ffi::c_void , srcdatasize : usize , unumshaders : u32 , ustartindex : u32 , pindices : *const u32 , uflags : u32 , ppshaders : *mut * mut::core::ffi::c_void , ptotalshaders : *mut u32 ) -> :: windows::core::HRESULT );
...
where
    P0: ::std::convert::Into<::windows::core::PCSTR>,
{
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DDisassemble ( psrcdata : *const ::core::ffi::c_void , srcdatasize : usize , flags : u32 , szcomments : :: windows::core::PCSTR , ppdisassembly : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
{
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DDisassemble10Effect ( peffect : * mut::core::ffi::c_void , flags : u32 , ppdisassembly : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
where
    P0: ::std::convert::Into<::windows::core::PCSTR>,
{
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DDisassembleRegion ( psrcdata : *const ::core::ffi::c_void , srcdatasize : usize , flags : u32 , szcomments : :: windows::core::PCSTR , startbyteoffset : usize , numinsts : usize , pfinishbyteoffset : *mut usize , ppdisassembly : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
...
pub unsafe fn D3DGetBlobPart(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, part: D3D_BLOB_PART, flags: u32) -> ::windows::core::Result<super::ID3DBlob> {
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DGetBlobPart ( psrcdata : *const ::core::ffi::c_void , srcdatasize : usize , part : D3D_BLOB_PART , flags : u32 , pppart : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
pub unsafe fn D3DGetDebugInfo(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize) -> ::windows::core::Result<super::ID3DBlob> {
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DGetDebugInfo ( psrcdata : *const ::core::ffi::c_void , srcdatasize : usize , ppdebuginfo : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
pub unsafe fn D3DGetInputAndOutputSignatureBlob(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize) -> ::windows::core::Result<super::ID3DBlob> {
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DGetInputAndOutputSignatureBlob ( psrcdata : *const ::core::ffi::c_void , srcdatasize : usize , ppsignatureblob : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
pub unsafe fn D3DGetInputSignatureBlob(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize) -> ::windows::core::Result<super::ID3DBlob> {
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DGetInputSignatureBlob ( psrcdata : *const ::core::ffi::c_void , srcdatasize : usize , ppsignatureblob : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
pub unsafe fn D3DGetOutputSignatureBlob(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize) -> ::windows::core::Result<super::ID3DBlob> {
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DGetOutputSignatureBlob ( psrcdata : *const ::core::ffi::c_void , srcdatasize : usize , ppsignatureblob : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
pub unsafe fn D3DGetTraceInstructionOffsets(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, flags: u32, startinstindex: usize, poffsets: ::core::option::Option<&mut [usize]>, ptotalinsts: ::core::option::Option<*mut usize>) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DGetTraceInstructionOffsets ( psrcdata : *const ::core::ffi::c_void , srcdatasize : usize , flags : u32 , startinstindex : usize , numinsts : usize , poffsets : *mut usize , ptotalinsts : *mut usize ) -> :: windows::core::HRESULT );
...
pub unsafe fn D3DLoadModule(psrcdata: *const ::core::ffi::c_void, cbsrcdatasize: usize) -> ::windows::core::Result<super::super::Direct3D11::ID3D11Module> {
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DLoadModule ( psrcdata : *const ::core::ffi::c_void , cbsrcdatasize : usize , ppmodule : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
where
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DReadFileToBlob ( pfilename : :: windows::core::PCWSTR , ppcontents : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
pub unsafe fn D3DReflect(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, pinterface: *const ::windows::core::GUID, ppreflector: *mut *mut ::core::ffi::c_void) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DReflect ( psrcdata : *const ::core::ffi::c_void , srcdatasize : usize , pinterface : *const :: windows::core::GUID , ppreflector : *mut *mut ::core::ffi::c_void ) -> :: windows::core::HRESULT );
...
pub unsafe fn D3DReflectLibrary(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, riid: *const ::windows::core::GUID, ppreflector: *mut *mut ::core::ffi::c_void) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DReflectLibrary ( psrcdata : *const ::core::ffi::c_void , srcdatasize : usize , riid : *const :: windows::core::GUID , ppreflector : *mut *mut ::core::ffi::c_void ) -> :: windows::core::HRESULT );
...
pub unsafe fn D3DSetBlobPart(psrcdata: *const ::core::ffi::c_void, srcdatasize: usize, part: D3D_BLOB_PART, flags: u32, ppart: *const ::core::ffi::c_void, partsize: usize) -> ::windows::core::Result<super::ID3DBlob> {
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DSetBlobPart ( psrcdata : *const ::core::ffi::c_void , srcdatasize : usize , part : D3D_BLOB_PART , flags : u32 , ppart : *const ::core::ffi::c_void , partsize : usize , ppnewshader : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
pub unsafe fn D3DStripShader(pshaderbytecode: *const ::core::ffi::c_void, bytecodelength: usize, ustripflags: u32) -> ::windows::core::Result<super::ID3DBlob> {
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DStripShader ( pshaderbytecode : *const ::core::ffi::c_void , bytecodelength : usize , ustripflags : u32 , ppstrippedblob : *mut * mut::core::ffi::c_void ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
{
    ::windows::core::windows_link ! ( "d3dcompiler_47.dll" ,"system" fn D3DWriteBlobToFile ( pblob : * mut::core::ffi::c_void , pfilename : :: windows::core::PCWSTR , boverwrite : super::super::super::Foundation:: BOOL ) -> :: windows::core::HRESULT );
