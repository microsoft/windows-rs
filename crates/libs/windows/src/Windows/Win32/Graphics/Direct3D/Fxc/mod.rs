    ...
    P6: windows_core::Param<windows_core::PCSTR>,
{
    ...
    D3DCompile2(
        ...
        core::mem::transmute(pdefines.unwrap_or(core::ptr::null())),
        pinclude.param().abi(),
        ...
        core::mem::transmute(psecondarydata.unwrap_or(core::ptr::null())),
    ...
    P4: windows_core::Param<windows_core::PCSTR>,
{
    ...
    D3DCompileFromFile(pfilename.param().abi(), core::mem::transmute(pdefines.unwrap_or(core::ptr::null())), pinclude.param().abi(), pentrypoint.param().abi(), ptarget.param().abi(), core::mem::transmute(flags1), core::mem::transmute(flags2), core::mem::transmute(ppcode), core::mem::transmute(pperrormsgs.unwrap_or(core::ptr::null_mut()))).ok()
}
#[inline]
pub unsafe fn D3DCompressShaders(pshaderdata: &[D3D_SHADER_DATA], uflags: u32) -> windows_core::Result<super::ID3DBlob> {
    ...
    D3DCompressShaders(pshaderdata.len().try_into().unwrap(), core::mem::transmute(pshaderdata.as_ptr()), core::mem::transmute(uflags), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
}
#[inline]
pub unsafe fn D3DCreateBlob(size: usize) -> windows_core::Result<super::ID3DBlob> {
    ...
    let mut result__ = core::mem::zeroed();
    D3DCreateBlob(core::mem::transmute(size), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
}
...
pub unsafe fn D3DCreateFunctionLinkingGraph(uflags: u32) -> windows_core::Result<super::super::Direct3D11::ID3D11FunctionLinkingGraph> {
    ...
    let mut result__ = core::mem::zeroed();
    D3DCreateFunctionLinkingGraph(core::mem::transmute(uflags), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
}
#[cfg(feature = "Win32_Graphics_Direct3D11")]
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCSTR>,
{
    ...
    let mut result__ = core::mem::zeroed();
    D3DDisassemble(core::mem::transmute(psrcdata), core::mem::transmute(srcdatasize), core::mem::transmute(flags), szcomments.param().abi(), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
}
    ...
    P0: windows_core::Param<super::super::Direct3D10::ID3D10Effect>,
{
    ...
    let mut result__ = core::mem::zeroed();
    D3DDisassemble10Effect(peffect.param().abi(), core::mem::transmute(flags), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
}
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCSTR>,
{
    ...
    D3DDisassembleRegion(core::mem::transmute(psrcdata), core::mem::transmute(srcdatasize), core::mem::transmute(flags), szcomments.param().abi(), core::mem::transmute(startbyteoffset), core::mem::transmute(numinsts), core::mem::transmute(pfinishbyteoffset.unwrap_or(core::ptr::null_mut())), core::mem::transmute(ppdisassembly)).ok()
}
#[inline]
pub unsafe fn D3DGetBlobPart(psrcdata: *const core::ffi::c_void, srcdatasize: usize, part: D3D_BLOB_PART, flags: u32) -> windows_core::Result<super::ID3DBlob> {
    ...
    let mut result__ = core::mem::zeroed();
    D3DGetBlobPart(core::mem::transmute(psrcdata), core::mem::transmute(srcdatasize), core::mem::transmute(part), core::mem::transmute(flags), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
}
#[inline]
pub unsafe fn D3DGetDebugInfo(psrcdata: *const core::ffi::c_void, srcdatasize: usize) -> windows_core::Result<super::ID3DBlob> {
    ...
    let mut result__ = core::mem::zeroed();
    D3DGetDebugInfo(core::mem::transmute(psrcdata), core::mem::transmute(srcdatasize), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
}
#[inline]
pub unsafe fn D3DGetInputAndOutputSignatureBlob(psrcdata: *const core::ffi::c_void, srcdatasize: usize) -> windows_core::Result<super::ID3DBlob> {
    ...
    let mut result__ = core::mem::zeroed();
    D3DGetInputAndOutputSignatureBlob(core::mem::transmute(psrcdata), core::mem::transmute(srcdatasize), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
}
#[inline]
pub unsafe fn D3DGetInputSignatureBlob(psrcdata: *const core::ffi::c_void, srcdatasize: usize) -> windows_core::Result<super::ID3DBlob> {
    ...
    let mut result__ = core::mem::zeroed();
    D3DGetInputSignatureBlob(core::mem::transmute(psrcdata), core::mem::transmute(srcdatasize), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
}
#[inline]
pub unsafe fn D3DGetOutputSignatureBlob(psrcdata: *const core::ffi::c_void, srcdatasize: usize) -> windows_core::Result<super::ID3DBlob> {
    ...
    let mut result__ = core::mem::zeroed();
    D3DGetOutputSignatureBlob(core::mem::transmute(psrcdata), core::mem::transmute(srcdatasize), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
}
#[inline]
...
pub unsafe fn D3DLoadModule(psrcdata: *const core::ffi::c_void, cbsrcdatasize: usize) -> windows_core::Result<super::super::Direct3D11::ID3D11Module> {
    ...
    let mut result__ = core::mem::zeroed();
    D3DLoadModule(core::mem::transmute(psrcdata), core::mem::transmute(cbsrcdatasize), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
}
#[inline]
    ...
    P4: windows_core::Param<super::ID3DInclude>,
{
    ...
    D3DPreprocess(core::mem::transmute(psrcdata), core::mem::transmute(srcdatasize), psourcename.param().abi(), core::mem::transmute(pdefines.unwrap_or(core::ptr::null())), pinclude.param().abi(), core::mem::transmute(ppcodetext), core::mem::transmute(pperrormsgs.unwrap_or(core::ptr::null_mut()))).ok()
}
#[inline]
...
pub unsafe fn D3DSetBlobPart(psrcdata: *const core::ffi::c_void, srcdatasize: usize, part: D3D_BLOB_PART, flags: u32, ppart: *const core::ffi::c_void, partsize: usize) -> windows_core::Result<super::ID3DBlob> {
    ...
    let mut result__ = core::mem::zeroed();
    D3DSetBlobPart(core::mem::transmute(psrcdata), core::mem::transmute(srcdatasize), core::mem::transmute(part), core::mem::transmute(flags), core::mem::transmute(ppart), core::mem::transmute(partsize), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
}
#[inline]
