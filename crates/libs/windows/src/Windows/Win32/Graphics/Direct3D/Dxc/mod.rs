...
impl IDxcCompiler2 {
    ...
    pub unsafe fn CompileWithDebug<'a, Param0: ::windows::core::IntoParam<'a, IDxcBlob>, Param1: ::windows::core::IntoParam<'a, ::windows::core::PCWSTR>, Param2: ::windows::core::IntoParam<'a, ::windows::core::PCWSTR>, Param3: ::windows::core::IntoParam<'a, ::windows::core::PCWSTR>, Param8: ::windows::core::IntoParam<'a, IDxcIncludeHandler>>(&self, psource: Param0, psourcename: Param1, pentrypoint: Param2, ptargetprofile: Param3, parguments: ::core::option::Option<&[::windows::core::PWSTR]>, pdefines: &[DxcDefine], pincludehandler: Param8, ppresult: *mut ::core::option::Option<IDxcOperationResult>, ppdebugblobname: *mut ::windows::core::PWSTR, ppdebugblob: *mut ::core::option::Option<IDxcBlob>) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).CompileWithDebug)(
            ...
            ::core::mem::transmute(parguments.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())),
            parguments.as_ref().map_or(0, |value| value.len()) as _,
...
impl IDxcCompiler3 {
    #[doc = "*Required features: 'Win32_Graphics_Direct3D_Dxc'*"]
    pub unsafe fn Compile<'a, Param3: ::windows::core::IntoParam<'a, IDxcIncludeHandler>>(&self, psource: *const DxcBuffer, parguments: ::core::option::Option<&[::windows::core::PWSTR]>, pincludehandler: Param3, riid: *const ::windows::core::GUID, ppresult: *mut *mut ::core::ffi::c_void) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).Compile)(::core::mem::transmute_copy(self), ::core::mem::transmute(psource), ::core::mem::transmute(parguments.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), parguments.as_ref().map_or(0, |value| value.len()) as _, pincludehandler.into_param().abi(), ::core::mem::transmute(riid), ::core::mem::transmute(ppresult)).ok()
    }
    #[doc = "*Required features: 'Win32_Graphics_Direct3D_Dxc'*"]
...
impl IDxcCompilerArgs {
    ...
    pub unsafe fn AddArguments(&self, parguments: ::core::option::Option<&[::windows::core::PWSTR]>) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).AddArguments)(::core::mem::transmute_copy(self), ::core::mem::transmute(parguments.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), parguments.as_ref().map_or(0, |value| value.len()) as _).ok()
    }
    #[doc = "*Required features: 'Win32_Graphics_Direct3D_Dxc'*"]
    pub unsafe fn AddArgumentsUTF8(&self, parguments: ::core::option::Option<&[::windows::core::PSTR]>) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).AddArgumentsUTF8)(::core::mem::transmute_copy(self), ::core::mem::transmute(parguments.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), parguments.as_ref().map_or(0, |value| value.len()) as _).ok()
    }
    #[doc = "*Required features: 'Win32_Graphics_Direct3D_Dxc'*"]
...
impl IDxcLinker {
    ...
    #[doc = "*Required features: 'Win32_Graphics_Direct3D_Dxc'*"]
    pub unsafe fn Link<'a, Param0: ::windows::core::IntoParam<'a, ::windows::core::PCWSTR>, Param1: ::windows::core::IntoParam<'a, ::windows::core::PCWSTR>>(&self, pentryname: Param0, ptargetprofile: Param1, plibnames: &[::windows::core::PWSTR], parguments: ::core::option::Option<&[::windows::core::PWSTR]>) -> ::windows::core::Result<IDxcOperationResult> {
        let mut result__: ::windows::core::RawPtr = ::core::mem::zeroed();
...
impl IDxcUtils {
    ...
    #[doc = "*Required features: 'Win32_Graphics_Direct3D_Dxc'*"]
    pub unsafe fn BuildArguments<'a, Param0: ::windows::core::IntoParam<'a, ::windows::core::PCWSTR>, Param1: ::windows::core::IntoParam<'a, ::windows::core::PCWSTR>, Param2: ::windows::core::IntoParam<'a, ::windows::core::PCWSTR>>(&self, psourcename: Param0, pentrypoint: Param1, ptargetprofile: Param2, parguments: ::core::option::Option<&[::windows::core::PWSTR]>, pdefines: &[DxcDefine]) -> ::windows::core::Result<IDxcCompilerArgs> {
        let mut result__: ::windows::core::RawPtr = ::core::mem::zeroed();
