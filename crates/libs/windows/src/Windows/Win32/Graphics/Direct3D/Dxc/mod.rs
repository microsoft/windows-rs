...
impl IDxcAssembler {
    ...
    {
        let mut result__ = ::windows_core::zeroed::<IDxcOperationResult>();
...
impl IDxcCompiler {
    ...
    where
        P0: ::windows_core::IntoParam<IDxcBlob>,
    {
        let mut result__ = ::windows_core::zeroed::<IDxcBlobEncoding>();
...
impl IDxcCompilerArgs {
    ...
    pub unsafe fn AddArguments(&self, parguments: ::core::option::Option<&[::windows_core::PCWSTR]>) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).AddArguments)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(parguments.as_deref().map_or(::core::ptr::null(), |slice| slice.as_ptr())), parguments.as_deref().map_or(0, |slice| slice.len() as _)).ok()
    }
    pub unsafe fn AddArgumentsUTF8(&self, parguments: ::core::option::Option<&[::windows_core::PCSTR]>) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).AddArgumentsUTF8)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(parguments.as_deref().map_or(::core::ptr::null(), |slice| slice.as_ptr())), parguments.as_deref().map_or(0, |slice| slice.len() as _)).ok()
    }
    pub unsafe fn AddDefines(&self, pdefines: &[DxcDefine]) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).AddDefines)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(pdefines.as_ptr()), pdefines.len() as _).ok()
    }
}
...
impl IDxcContainerReflection {
    ...
    pub unsafe fn GetPartContent(&self, idx: u32) -> ::windows_core::Result<IDxcBlob> {
        let mut result__ = ::windows_core::zeroed::<IDxcBlob>();
...
impl IDxcLibrary {
    ...
    pub unsafe fn CreateIncludeHandler(&self) -> ::windows_core::Result<IDxcIncludeHandler> {
        let mut result__ = ::windows_core::zeroed::<IDxcIncludeHandler>();
...
impl IDxcOptimizer {
    ...
    pub unsafe fn GetAvailablePass(&self, index: u32) -> ::windows_core::Result<IDxcOptimizerPass> {
        let mut result__ = ::windows_core::zeroed::<IDxcOptimizerPass>();
    ...
    where
        P0: ::windows_core::IntoParam<IDxcBlob>,
    {
        (::windows_core::Interface::vtable(self).RunOptimizer)(::windows_core::Interface::as_raw(self), pblob.into_param().abi(), ::core::mem::transmute(ppoptions.as_ptr()), ppoptions.len() as _, ::core::mem::transmute(poutputmodule), ::core::mem::transmute(ppoutputtext.unwrap_or(::std::ptr::null_mut()))).ok()
    }
}
...
impl IDxcPdbUtils {
    ...
    pub unsafe fn GetVersionInfo(&self) -> ::windows_core::Result<IDxcVersionInfo> {
        let mut result__ = ::windows_core::zeroed::<IDxcVersionInfo>();
    ...
    pub unsafe fn CompileForFullPDB(&self) -> ::windows_core::Result<IDxcResult> {
        let mut result__ = ::windows_core::zeroed::<IDxcResult>();
...
impl IDxcUtils {
    ...
    where
        P0: ::windows_core::IntoParam<IDxcBlob>,
    {
        let mut result__ = ::windows_core::zeroed::<IDxcBlobUtf8>();
        (::windows_core::Interface::vtable(self).GetBlobAsUtf8)(::windows_core::Interface::as_raw(self), pblob.into_param().abi(), &mut result__).from_abi(result__)
    }
    ...
    where
        P0: ::windows_core::IntoParam<IDxcBlob>,
    {
        let mut result__ = ::windows_core::zeroed::<IDxcBlobUtf16>();
        (::windows_core::Interface::vtable(self).GetBlobAsUtf16)(::windows_core::Interface::as_raw(self), pblob.into_param().abi(), &mut result__).from_abi(result__)
    }
    ...
    where
        ...
        P2: ::windows_core::IntoParam<::windows_core::PCWSTR>,
    {
        let mut result__ = ::windows_core::zeroed::<IDxcCompilerArgs>();
