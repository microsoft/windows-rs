#[inline]
pub unsafe fn DxcCreateInstance<T>(rclsid: *const windows_core::GUID) -> windows_result::Result<T>
where
...
#[inline]
pub unsafe fn DxcCreateInstance2<P0, T>(pmalloc: P0, rclsid: *const windows_core::GUID) -> windows_result::Result<T>
where
...
impl IDxcAssembler {
    pub unsafe fn AssembleToContainer<P0>(&self, pshader: P0) -> windows_result::Result<IDxcOperationResult>
    where
...
pub trait IDxcAssembler_Impl: windows_core::IUnknownImpl {
    fn AssembleToContainer(&self, pshader: windows_core::Ref<IDxcBlob>) -> windows_result::Result<IDxcOperationResult>;
}
...
impl IDxcBlobEncoding {
    pub unsafe fn GetEncoding(&self, pknown: *mut windows_core::BOOL, pcodepage: *mut DXC_CP) -> windows_result::Result<()> {
...
pub trait IDxcBlobEncoding_Impl: IDxcBlob_Impl {
    fn GetEncoding(&self, pknown: *mut windows_core::BOOL, pcodepage: *mut DXC_CP) -> windows_result::Result<()>;
}
...
impl IDxcCompiler {
    pub unsafe fn Compile<P0, P1, P2, P3, P8>(&self, psource: P0, psourcename: P1, pentrypoint: P2, ptargetprofile: P3, parguments: Option<&[windows_core::PCWSTR]>, pdefines: &[DxcDefine], pincludehandler: P8) -> windows_result::Result<IDxcOperationResult>
    where
        P0: windows_core::Param<IDxcBlob>,
    ...
    pub unsafe fn Preprocess<P0, P1, P6>(&self, psource: P0, psourcename: P1, parguments: Option<&[windows_core::PCWSTR]>, pdefines: &[DxcDefine], pincludehandler: P6) -> windows_result::Result<IDxcOperationResult>
    where
        P0: windows_core::Param<IDxcBlob>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn Disassemble<P0>(&self, psource: P0) -> windows_result::Result<IDxcBlobEncoding>
    where
        P0: windows_core::Param<IDxcBlob>,
    {
        unsafe {
...
pub trait IDxcCompiler_Impl: windows_core::IUnknownImpl {
    fn Compile(&self, psource: windows_core::Ref<IDxcBlob>, psourcename: &windows_core::PCWSTR, pentrypoint: &windows_core::PCWSTR, ptargetprofile: &windows_core::PCWSTR, parguments: *const windows_core::PCWSTR, argcount: u32, pdefines: *const DxcDefine, definecount: u32, pincludehandler: windows_core::Ref<IDxcIncludeHandler>) -> windows_result::Result<IDxcOperationResult>;
    fn Preprocess(&self, psource: windows_core::Ref<IDxcBlob>, psourcename: &windows_core::PCWSTR, parguments: *const windows_core::PCWSTR, argcount: u32, pdefines: *const DxcDefine, definecount: u32, pincludehandler: windows_core::Ref<IDxcIncludeHandler>) -> windows_result::Result<IDxcOperationResult>;
    fn Disassemble(&self, psource: windows_core::Ref<IDxcBlob>) -> windows_result::Result<IDxcBlobEncoding>;
}
...
impl IDxcCompiler3 {
    pub unsafe fn Compile<P3, T>(&self, psource: *const DxcBuffer, parguments: Option<&[windows_core::PCWSTR]>, pincludehandler: P3) -> windows_result::Result<T>
    where
    ...
    pub unsafe fn Disassemble<T>(&self, pobject: *const DxcBuffer) -> windows_result::Result<T>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
...
pub trait IDxcCompiler3_Impl: windows_core::IUnknownImpl {
    fn Compile(&self, psource: *const DxcBuffer, parguments: *const windows_core::PCWSTR, argcount: u32, pincludehandler: windows_core::Ref<IDxcIncludeHandler>, riid: *const windows_core::GUID, ppresult: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn Disassemble(&self, pobject: *const DxcBuffer, riid: *const windows_core::GUID, ppresult: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
}
...
impl IDxcCompilerArgs {
    ...
    pub unsafe fn AddArguments(&self, parguments: Option<&[windows_core::PCWSTR]>) -> windows_result::Result<()> {
    ...
    pub unsafe fn AddArgumentsUTF8(&self, parguments: Option<&[windows_core::PCSTR]>) -> windows_result::Result<()> {
    ...
    pub unsafe fn AddDefines(&self, pdefines: &[DxcDefine]) -> windows_result::Result<()> {
...
pub trait IDxcCompilerArgs_Impl: windows_core::IUnknownImpl {
    ...
    fn AddArguments(&self, parguments: *const windows_core::PCWSTR, argcount: u32) -> windows_result::Result<()>;
    fn AddArgumentsUTF8(&self, parguments: *const windows_core::PCSTR, argcount: u32) -> windows_result::Result<()>;
    fn AddDefines(&self, pdefines: *const DxcDefine, definecount: u32) -> windows_result::Result<()>;
}
...
impl IDxcContainerBuilder {
    pub unsafe fn Load<P0>(&self, pdxilcontainerheader: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IDxcBlob>,
    {
        unsafe { (windows_core::Interface::vtable(self).Load)(windows_core::Interface::as_raw(self), pdxilcontainerheader.param().abi()).ok() }
    }
    pub unsafe fn AddPart<P1>(&self, fourcc: u32, psource: P1) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn RemovePart(&self, fourcc: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).RemovePart)(windows_core::Interface::as_raw(self), fourcc).ok() }
    }
    pub unsafe fn SerializeContainer(&self) -> windows_result::Result<IDxcOperationResult> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDxcContainerBuilder_Impl: windows_core::IUnknownImpl {
    fn Load(&self, pdxilcontainerheader: windows_core::Ref<IDxcBlob>) -> windows_result::Result<()>;
    fn AddPart(&self, fourcc: u32, psource: windows_core::Ref<IDxcBlob>) -> windows_result::Result<()>;
    fn RemovePart(&self, fourcc: u32) -> windows_result::Result<()>;
    fn SerializeContainer(&self) -> windows_result::Result<IDxcOperationResult>;
}
...
impl IDxcContainerReflection {
    ...
    pub unsafe fn FindFirstPartKind(&self, kind: u32) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindFirstPartKind)(windows_core::Interface::as_raw(self), kind, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetPartReflection(&self, idx: u32, iid: *const windows_core::GUID, ppvobject: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
...
pub trait IDxcContainerReflection_Impl: windows_core::IUnknownImpl {
    fn Load(&self, pcontainer: windows_core::Ref<IDxcBlob>) -> windows_result::Result<()>;
    fn GetPartCount(&self) -> windows_result::Result<u32>;
    fn GetPartKind(&self, idx: u32) -> windows_result::Result<u32>;
    fn GetPartContent(&self, idx: u32) -> windows_result::Result<IDxcBlob>;
    fn FindFirstPartKind(&self, kind: u32) -> windows_result::Result<u32>;
    fn GetPartReflection(&self, idx: u32, iid: *const windows_core::GUID, ppvobject: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
}
...
impl IDxcExtraOutputs {
    ...
    pub unsafe fn GetOutput<T>(&self, uindex: u32, ppoutputtype: Option<*mut Option<IDxcBlobUtf16>>, ppoutputname: Option<*mut Option<IDxcBlobUtf16>>, result__: *mut Option<T>) -> windows_result::Result<()>
    where
        T: windows_core::Interface,
    {
...
pub trait IDxcExtraOutputs_Impl: windows_core::IUnknownImpl {
    ...
    fn GetOutput(&self, uindex: u32, iid: *const windows_core::GUID, ppvobject: *mut *mut core::ffi::c_void, ppoutputtype: windows_core::OutRef<IDxcBlobUtf16>, ppoutputname: windows_core::OutRef<IDxcBlobUtf16>) -> windows_result::Result<()>;
}
...
impl IDxcIncludeHandler {
    pub unsafe fn LoadSource<P0>(&self, pfilename: P0) -> windows_result::Result<IDxcBlob>
    where
...
pub trait IDxcIncludeHandler_Impl: windows_core::IUnknownImpl {
    fn LoadSource(&self, pfilename: &windows_core::PCWSTR) -> windows_result::Result<IDxcBlob>;
}
...
impl IDxcLibrary {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn SetMalloc<P0>(&self, pmalloc: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::super::System::Com::IMalloc>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetMalloc)(windows_core::Interface::as_raw(self), pmalloc.param().abi()).ok() }
    }
    pub unsafe fn CreateBlobFromBlob<P0>(&self, pblob: P0, offset: u32, length: u32) -> windows_result::Result<IDxcBlob>
    where
        P0: windows_core::Param<IDxcBlob>,
    {
        unsafe {
    ...
    pub unsafe fn CreateBlobFromFile<P0>(&self, pfilename: P0, codepage: Option<*const DXC_CP>) -> windows_result::Result<IDxcBlobEncoding>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn CreateBlobWithEncodingFromPinned(&self, ptext: *const core::ffi::c_void, size: u32, codepage: DXC_CP) -> windows_result::Result<IDxcBlobEncoding> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateBlobWithEncodingOnHeapCopy(&self, ptext: *const core::ffi::c_void, size: u32, codepage: DXC_CP) -> windows_result::Result<IDxcBlobEncoding> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateBlobWithEncodingOnMalloc<P1>(&self, ptext: *const core::ffi::c_void, pimalloc: P1, size: u32, codepage: DXC_CP) -> windows_result::Result<IDxcBlobEncoding>
    where
    ...
    pub unsafe fn CreateIncludeHandler(&self) -> windows_result::Result<IDxcIncludeHandler> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateStreamFromBlobReadOnly<P0>(&self, pblob: P0) -> windows_result::Result<super::super::super::System::Com::IStream>
    where
        P0: windows_core::Param<IDxcBlob>,
    {
        unsafe {
    ...
    pub unsafe fn GetBlobAsUtf8<P0>(&self, pblob: P0) -> windows_result::Result<IDxcBlobEncoding>
    where
        P0: windows_core::Param<IDxcBlob>,
    {
        unsafe {
    ...
    pub unsafe fn GetBlobAsUtf16<P0>(&self, pblob: P0) -> windows_result::Result<IDxcBlobEncoding>
    where
        P0: windows_core::Param<IDxcBlob>,
    {
        unsafe {
...
pub trait IDxcLibrary_Impl: windows_core::IUnknownImpl {
    fn SetMalloc(&self, pmalloc: windows_core::Ref<super::super::super::System::Com::IMalloc>) -> windows_result::Result<()>;
    fn CreateBlobFromBlob(&self, pblob: windows_core::Ref<IDxcBlob>, offset: u32, length: u32) -> windows_result::Result<IDxcBlob>;
    fn CreateBlobFromFile(&self, pfilename: &windows_core::PCWSTR, codepage: *const DXC_CP) -> windows_result::Result<IDxcBlobEncoding>;
    fn CreateBlobWithEncodingFromPinned(&self, ptext: *const core::ffi::c_void, size: u32, codepage: DXC_CP) -> windows_result::Result<IDxcBlobEncoding>;
    fn CreateBlobWithEncodingOnHeapCopy(&self, ptext: *const core::ffi::c_void, size: u32, codepage: DXC_CP) -> windows_result::Result<IDxcBlobEncoding>;
    fn CreateBlobWithEncodingOnMalloc(&self, ptext: *const core::ffi::c_void, pimalloc: windows_core::Ref<super::super::super::System::Com::IMalloc>, size: u32, codepage: DXC_CP) -> windows_result::Result<IDxcBlobEncoding>;
    fn CreateIncludeHandler(&self) -> windows_result::Result<IDxcIncludeHandler>;
    fn CreateStreamFromBlobReadOnly(&self, pblob: windows_core::Ref<IDxcBlob>) -> windows_result::Result<super::super::super::System::Com::IStream>;
    fn GetBlobAsUtf8(&self, pblob: windows_core::Ref<IDxcBlob>) -> windows_result::Result<IDxcBlobEncoding>;
    fn GetBlobAsUtf16(&self, pblob: windows_core::Ref<IDxcBlob>) -> windows_result::Result<IDxcBlobEncoding>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IDxcLinker {
    pub unsafe fn RegisterLibrary<P0, P1>(&self, plibname: P0, plib: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<IDxcBlob>,
    {
    ...
    pub unsafe fn Link<P0, P1>(&self, pentryname: P0, ptargetprofile: P1, plibnames: &[windows_core::PCWSTR], parguments: Option<&[windows_core::PCWSTR]>) -> windows_result::Result<IDxcOperationResult>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IDxcLinker_Impl: windows_core::IUnknownImpl {
    fn RegisterLibrary(&self, plibname: &windows_core::PCWSTR, plib: windows_core::Ref<IDxcBlob>) -> windows_result::Result<()>;
    fn Link(&self, pentryname: &windows_core::PCWSTR, ptargetprofile: &windows_core::PCWSTR, plibnames: *const windows_core::PCWSTR, libcount: u32, parguments: *const windows_core::PCWSTR, argcount: u32) -> windows_result::Result<IDxcOperationResult>;
}
...
impl IDxcOperationResult {
    pub unsafe fn GetStatus(&self) -> windows_result::Result<windows_core::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetStatus)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetResult(&self) -> windows_result::Result<IDxcBlob> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetErrorBuffer(&self) -> windows_result::Result<IDxcBlobEncoding> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDxcOperationResult_Impl: windows_core::IUnknownImpl {
    fn GetStatus(&self) -> windows_result::Result<windows_core::HRESULT>;
    fn GetResult(&self) -> windows_result::Result<IDxcBlob>;
    fn GetErrorBuffer(&self) -> windows_result::Result<IDxcBlobEncoding>;
}
...
impl IDxcOptimizer {
    pub unsafe fn GetAvailablePassCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetAvailablePassCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetAvailablePass(&self, index: u32) -> windows_result::Result<IDxcOptimizerPass> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RunOptimizer<P0>(&self, pblob: P0, ppoptions: &[windows_core::PCWSTR], poutputmodule: *mut Option<IDxcBlob>, ppoutputtext: Option<*mut Option<IDxcBlobEncoding>>) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IDxcBlob>,
    {
...
pub trait IDxcOptimizer_Impl: windows_core::IUnknownImpl {
    fn GetAvailablePassCount(&self) -> windows_result::Result<u32>;
    fn GetAvailablePass(&self, index: u32) -> windows_result::Result<IDxcOptimizerPass>;
    fn RunOptimizer(&self, pblob: windows_core::Ref<IDxcBlob>, ppoptions: *const windows_core::PCWSTR, optioncount: u32, poutputmodule: windows_core::OutRef<IDxcBlob>, ppoutputtext: windows_core::OutRef<IDxcBlobEncoding>) -> windows_result::Result<()>;
}
...
impl IDxcOptimizerPass {
    pub unsafe fn GetOptionName(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetOptionArgCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetOptionArgCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetOptionArgName(&self, argindex: u32) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetOptionArgDescription(&self, argindex: u32) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDxcOptimizerPass_Impl: windows_core::IUnknownImpl {
    fn GetOptionName(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn GetDescription(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn GetOptionArgCount(&self) -> windows_result::Result<u32>;
    fn GetOptionArgName(&self, argindex: u32) -> windows_result::Result<windows_core::PWSTR>;
    fn GetOptionArgDescription(&self, argindex: u32) -> windows_result::Result<windows_core::PWSTR>;
}
...
impl IDxcPdbUtils {
    pub unsafe fn Load<P0>(&self, ppdbordxil: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IDxcBlob>,
    {
    ...
    pub unsafe fn GetSource(&self, uindex: u32) -> windows_result::Result<IDxcBlobEncoding> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetSourceName(&self, uindex: u32) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFlagCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFlagCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetFlag(&self, uindex: u32) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetArgCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetArgCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetArg(&self, uindex: u32) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetArgPairCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetArgPairCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetArgPair(&self, uindex: u32, pname: *mut windows_core::BSTR, pvalue: *mut windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetDefineCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDefineCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetDefine(&self, uindex: u32) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetTargetProfile(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetEntryPoint(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetMainFileName(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetHash(&self) -> windows_result::Result<IDxcBlob> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFullPDB(&self) -> windows_result::Result<IDxcBlob> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetVersionInfo(&self) -> windows_result::Result<IDxcVersionInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetCompiler<P0>(&self, pcompiler: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn CompileForFullPDB(&self) -> windows_result::Result<IDxcResult> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn OverrideArgs(&self, pargpairs: *const DxcArgPair, unumargpairs: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).OverrideArgs)(windows_core::Interface::as_raw(self), pargpairs, unumargpairs).ok() }
    }
    pub unsafe fn OverrideRootSignature<P0>(&self, prootsignature: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IDxcPdbUtils_Impl: windows_core::IUnknownImpl {
    fn Load(&self, ppdbordxil: windows_core::Ref<IDxcBlob>) -> windows_result::Result<()>;
    fn GetSourceCount(&self) -> windows_result::Result<u32>;
    fn GetSource(&self, uindex: u32) -> windows_result::Result<IDxcBlobEncoding>;
    fn GetSourceName(&self, uindex: u32) -> windows_result::Result<windows_core::BSTR>;
    fn GetFlagCount(&self) -> windows_result::Result<u32>;
    fn GetFlag(&self, uindex: u32) -> windows_result::Result<windows_core::BSTR>;
    fn GetArgCount(&self) -> windows_result::Result<u32>;
    fn GetArg(&self, uindex: u32) -> windows_result::Result<windows_core::BSTR>;
    fn GetArgPairCount(&self) -> windows_result::Result<u32>;
    fn GetArgPair(&self, uindex: u32, pname: *mut windows_core::BSTR, pvalue: *mut windows_core::BSTR) -> windows_result::Result<()>;
    fn GetDefineCount(&self) -> windows_result::Result<u32>;
    fn GetDefine(&self, uindex: u32) -> windows_result::Result<windows_core::BSTR>;
    fn GetTargetProfile(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetEntryPoint(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetMainFileName(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetHash(&self) -> windows_result::Result<IDxcBlob>;
    fn GetName(&self) -> windows_result::Result<windows_core::BSTR>;
    fn IsFullPDB(&self) -> windows_core::BOOL;
    fn GetFullPDB(&self) -> windows_result::Result<IDxcBlob>;
    fn GetVersionInfo(&self) -> windows_result::Result<IDxcVersionInfo>;
    fn SetCompiler(&self, pcompiler: windows_core::Ref<IDxcCompiler3>) -> windows_result::Result<()>;
    fn CompileForFullPDB(&self) -> windows_result::Result<IDxcResult>;
    fn OverrideArgs(&self, pargpairs: *const DxcArgPair, unumargpairs: u32) -> windows_result::Result<()>;
    fn OverrideRootSignature(&self, prootsignature: &windows_core::PCWSTR) -> windows_result::Result<()>;
}
...
impl IDxcResult {
    ...
    pub unsafe fn GetOutput<T>(&self, dxcoutkind: DXC_OUT_KIND, ppoutputname: *mut Option<IDxcBlobUtf16>, result__: *mut Option<T>) -> windows_result::Result<()>
    where
        T: windows_core::Interface,
    {
...
pub trait IDxcResult_Impl: IDxcOperationResult_Impl {
    ...
    fn GetOutput(&self, dxcoutkind: DXC_OUT_KIND, iid: *const windows_core::GUID, ppvobject: *mut *mut core::ffi::c_void, ppoutputname: windows_core::OutRef<IDxcBlobUtf16>) -> windows_result::Result<()>;
...
impl IDxcUtils {
    ...
    pub unsafe fn CreateBlobFromPinned(&self, pdata: *const core::ffi::c_void, size: u32, codepage: DXC_CP) -> windows_result::Result<IDxcBlobEncoding> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn MoveToBlob<P1>(&self, pdata: *const core::ffi::c_void, pimalloc: P1, size: u32, codepage: DXC_CP) -> windows_result::Result<IDxcBlobEncoding>
    where
        P1: windows_core::Param<super::super::super::System::Com::IMalloc>,
    {
        unsafe {
    ...
    pub unsafe fn CreateBlob(&self, pdata: *const core::ffi::c_void, size: u32, codepage: DXC_CP) -> windows_result::Result<IDxcBlobEncoding> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn LoadFile<P0>(&self, pfilename: P0, pcodepage: Option<*const DXC_CP>) -> windows_result::Result<IDxcBlobEncoding>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateReadOnlyStreamFromBlob<P0>(&self, pblob: P0) -> windows_result::Result<super::super::super::System::Com::IStream>
    where
        P0: windows_core::Param<IDxcBlob>,
    {
        unsafe {
    ...
    pub unsafe fn CreateDefaultIncludeHandler(&self) -> windows_result::Result<IDxcIncludeHandler> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetBlobAsUtf8<P0>(&self, pblob: P0) -> windows_result::Result<IDxcBlobUtf8>
    where
        P0: windows_core::Param<IDxcBlob>,
    {
        unsafe {
    ...
    pub unsafe fn GetBlobAsUtf16<P0>(&self, pblob: P0) -> windows_result::Result<IDxcBlobUtf16>
    where
        P0: windows_core::Param<IDxcBlob>,
    {
        unsafe {
    ...
    pub unsafe fn GetDxilContainerPart(&self, pshader: *const DxcBuffer, dxcpart: u32, pppartdata: *mut *mut core::ffi::c_void, ppartsizeinbytes: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn CreateReflection(&self, pdata: *const DxcBuffer, iid: *const windows_core::GUID, ppvreflection: *mut *mut core::ffi::c_void) -> windows_result::Result<()> {
    ...
    pub unsafe fn BuildArguments<P0, P1, P2>(&self, psourcename: P0, pentrypoint: P1, ptargetprofile: P2, parguments: Option<&[windows_core::PCWSTR]>, pdefines: &[DxcDefine]) -> windows_result::Result<IDxcCompilerArgs>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn GetPDBContents<P0>(&self, ppdbblob: P0, pphash: *mut Option<IDxcBlob>, ppcontainer: *mut Option<IDxcBlob>) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IDxcBlob>,
    {
...
pub trait IDxcUtils_Impl: windows_core::IUnknownImpl {
    fn CreateBlobFromBlob(&self, pblob: windows_core::Ref<IDxcBlob>, offset: u32, length: u32) -> windows_result::Result<IDxcBlob>;
    fn CreateBlobFromPinned(&self, pdata: *const core::ffi::c_void, size: u32, codepage: DXC_CP) -> windows_result::Result<IDxcBlobEncoding>;
    fn MoveToBlob(&self, pdata: *const core::ffi::c_void, pimalloc: windows_core::Ref<super::super::super::System::Com::IMalloc>, size: u32, codepage: DXC_CP) -> windows_result::Result<IDxcBlobEncoding>;
    fn CreateBlob(&self, pdata: *const core::ffi::c_void, size: u32, codepage: DXC_CP) -> windows_result::Result<IDxcBlobEncoding>;
    fn LoadFile(&self, pfilename: &windows_core::PCWSTR, pcodepage: *const DXC_CP) -> windows_result::Result<IDxcBlobEncoding>;
    fn CreateReadOnlyStreamFromBlob(&self, pblob: windows_core::Ref<IDxcBlob>) -> windows_result::Result<super::super::super::System::Com::IStream>;
    fn CreateDefaultIncludeHandler(&self) -> windows_result::Result<IDxcIncludeHandler>;
    fn GetBlobAsUtf8(&self, pblob: windows_core::Ref<IDxcBlob>) -> windows_result::Result<IDxcBlobUtf8>;
    fn GetBlobAsUtf16(&self, pblob: windows_core::Ref<IDxcBlob>) -> windows_result::Result<IDxcBlobUtf16>;
    fn GetDxilContainerPart(&self, pshader: *const DxcBuffer, dxcpart: u32, pppartdata: *mut *mut core::ffi::c_void, ppartsizeinbytes: *mut u32) -> windows_result::Result<()>;
    fn CreateReflection(&self, pdata: *const DxcBuffer, iid: *const windows_core::GUID, ppvreflection: *mut *mut core::ffi::c_void) -> windows_result::Result<()>;
    fn BuildArguments(&self, psourcename: &windows_core::PCWSTR, pentrypoint: &windows_core::PCWSTR, ptargetprofile: &windows_core::PCWSTR, parguments: *const windows_core::PCWSTR, argcount: u32, pdefines: *const DxcDefine, definecount: u32) -> windows_result::Result<IDxcCompilerArgs>;
    fn GetPDBContents(&self, ppdbblob: windows_core::Ref<IDxcBlob>, pphash: windows_core::OutRef<IDxcBlob>, ppcontainer: windows_core::OutRef<IDxcBlob>) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
impl IDxcUtils_Vtbl {
...
impl IDxcValidator {
    pub unsafe fn Validate<P0>(&self, pshader: P0, flags: u32) -> windows_result::Result<IDxcOperationResult>
    where
        P0: windows_core::Param<IDxcBlob>,
    {
        unsafe {
...
pub trait IDxcValidator_Impl: windows_core::IUnknownImpl {
    fn Validate(&self, pshader: windows_core::Ref<IDxcBlob>, flags: u32) -> windows_result::Result<IDxcOperationResult>;
}
...
impl IDxcValidator2 {
    pub unsafe fn ValidateWithDebug<P0>(&self, pshader: P0, flags: u32, poptdebugbitcode: Option<*const DxcBuffer>) -> windows_result::Result<IDxcOperationResult>
    where
        P0: windows_core::Param<IDxcBlob>,
    {
        unsafe {
...
pub trait IDxcValidator2_Impl: IDxcValidator_Impl {
    fn ValidateWithDebug(&self, pshader: windows_core::Ref<IDxcBlob>, flags: u32, poptdebugbitcode: *const DxcBuffer) -> windows_result::Result<IDxcOperationResult>;
}
...
impl IDxcVersionInfo {
    pub unsafe fn GetVersion(&self, pmajor: *mut u32, pminor: *mut u32) -> windows_result::Result<()> {
...
pub trait IDxcVersionInfo_Impl: windows_core::IUnknownImpl {
    fn GetVersion(&self, pmajor: *mut u32, pminor: *mut u32) -> windows_result::Result<()>;
...
impl IDxcVersionInfo2 {
    pub unsafe fn GetCommitInfo(&self, pcommitcount: *mut u32, pcommithash: *mut *mut i8) -> windows_result::Result<()> {
...
pub trait IDxcVersionInfo2_Impl: IDxcVersionInfo_Impl {
    fn GetCommitInfo(&self, pcommitcount: *mut u32, pcommithash: *mut *mut i8) -> windows_result::Result<()>;
}
...
impl IDxcVersionInfo3 {
    pub unsafe fn GetCustomVersionString(&self) -> windows_result::Result<*mut i8> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDxcVersionInfo3_Impl: windows_core::IUnknownImpl {
    fn GetCustomVersionString(&self) -> windows_result::Result<*mut i8>;
}
