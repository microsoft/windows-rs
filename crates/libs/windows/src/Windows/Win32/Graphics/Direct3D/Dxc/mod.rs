...
impl IDxcCompiler3 {
    pub unsafe fn Compile<'a, P0>(&self, psource: &DxcBuffer, parguments: &[::windows::core::PWSTR], pincludehandler: P0, riid: &::windows::core::GUID, ppresult: *mut *mut ::core::ffi::c_void) -> ::windows::core::Result<()>
    where
