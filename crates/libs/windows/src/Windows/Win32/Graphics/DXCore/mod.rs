...
impl IDXCoreAdapter {
    ...
    pub unsafe fn GetProperty(&self, property: DXCoreAdapterProperty, propertydata: &mut [u8]) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).GetProperty)(::windows::core::Vtable::as_raw(self), property, propertydata.len() as _, ::core::mem::transmute(propertydata.as_ptr())).ok()
    }
    ...
    pub unsafe fn QueryState(&self, state: DXCoreAdapterState, inputstatedetails: ::core::option::Option<&[u8]>, outputbuffer: &mut [u8]) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).QueryState)(::windows::core::Vtable::as_raw(self), state, inputstatedetails.as_deref().map_or(0, |slice| slice.len() as _), ::core::mem::transmute(inputstatedetails.as_deref().map_or(::core::ptr::null(), |slice| slice.as_ptr())), outputbuffer.len() as _, ::core::mem::transmute(outputbuffer.as_ptr())).ok()
    }
    ...
    pub unsafe fn SetState(&self, state: DXCoreAdapterState, inputstatedetails: ::core::option::Option<&[u8]>, inputdata: &[u8]) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).SetState)(::windows::core::Vtable::as_raw(self), state, inputstatedetails.as_deref().map_or(0, |slice| slice.len() as _), ::core::mem::transmute(inputstatedetails.as_deref().map_or(::core::ptr::null(), |slice| slice.as_ptr())), inputdata.len() as _, ::core::mem::transmute(inputdata.as_ptr())).ok()
    }
...
impl IDXCoreAdapterFactory {
    ...
    {
        let mut result__ = ::core::mem::MaybeUninit::zeroed();
        (::windows::core::Vtable::vtable(self).RegisterEventNotification)(::windows::core::Vtable::as_raw(self), dxcoreobject.into().abi(), notificationtype, ::core::mem::transmute(callbackfunction), ::core::mem::transmute(callbackcontext), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<u32>(result__)
    }
