...
impl IDirect3DDevice9On12Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IDirect3DDevice9On12Impl, const OFFSET: isize>() -> IDirect3DDevice9On12Vtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IDirect3DDevice9On12>, ::windows::core::GetTrustLevel, GetD3D12Device::<Impl, OFFSET>, UnwrapUnderlyingResource::<Impl, OFFSET>, ReturnUnderlyingResource::<Impl, OFFSET>)
    }
}
