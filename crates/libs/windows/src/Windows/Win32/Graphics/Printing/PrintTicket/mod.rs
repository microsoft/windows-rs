...
{
    windows_targets::link!("prntvpt.dll" "system" fn PTGetPrintCapabilities(hprovider : HPTPROVIDER, pprintticket : * mut core::ffi::c_void, pcapabilities : * mut core::ffi::c_void, pbstrerrormessage : *mut std::mem::MaybeUninit < windows_core::BSTR >) -> windows_core::HRESULT);
...
where
    ...
    P2: windows_core::Param<super::super::super::System::Com::IStream>,
{
    windows_targets::link!("prntvpt.dll" "system" fn PTGetPrintDeviceCapabilities(hprovider : HPTPROVIDER, pprintticket : * mut core::ffi::c_void, pdevicecapabilities : * mut core::ffi::c_void, pbstrerrormessage : *mut std::mem::MaybeUninit < windows_core::BSTR >) -> windows_core::HRESULT);
...
{
    windows_targets::link!("prntvpt.dll" "system" fn PTGetPrintDeviceResources(hprovider : HPTPROVIDER, pszlocalename : windows_core::PCWSTR, pprintticket : * mut core::ffi::c_void, pdeviceresources : * mut core::ffi::c_void, pbstrerrormessage : *mut std::mem::MaybeUninit < windows_core::BSTR >) -> windows_core::HRESULT);
...
where
    ...
    P3: windows_core::Param<super::super::super::System::Com::IStream>,
{
    windows_targets::link!("prntvpt.dll" "system" fn PTMergeAndValidatePrintTicket(hprovider : HPTPROVIDER, pbaseticket : * mut core::ffi::c_void, pdeltaticket : * mut core::ffi::c_void, scope : EPrintTicketScope, presultticket : * mut core::ffi::c_void, pbstrerrormessage : *mut std::mem::MaybeUninit < windows_core::BSTR >) -> windows_core::HRESULT);
