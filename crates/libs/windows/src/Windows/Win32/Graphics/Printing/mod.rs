...
pub const S_DEVCAP_OUTPUT_FULL_REPLACEMENT: windows_core::HRESULT = 0x4DC01_u32 as _;
...
pub struct ImgErrorInfo {
    pub description: windows_core::BSTR,
    pub guid: windows_core::GUID,
    pub helpContext: u32,
    pub helpFile: windows_core::BSTR,
    pub source: windows_core::BSTR,
    pub devDescription: windows_core::BSTR,
    pub errorID: windows_core::GUID,
    pub cUserParameters: u32,
    pub aUserParameters: *mut windows_core::BSTR,
    pub userFallback: windows_core::BSTR,
    pub exceptionID: u32,
}
