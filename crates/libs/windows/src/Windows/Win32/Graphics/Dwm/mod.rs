#[inline]
pub unsafe fn DwmAttachMilContent(hwnd: super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmDetachMilContent(hwnd: super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmEnableBlurBehindWindow(hwnd: super::super::Foundation::HWND, pblurbehind: *const DWM_BLURBEHIND) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmEnableComposition(ucompositionaction: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmEnableMMCSS(fenablemmcss: bool) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmExtendFrameIntoClientArea(hwnd: super::super::Foundation::HWND, pmarinset: *const super::super::UI::Controls::MARGINS) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmFlush() -> Result<(), windows_result::HRESULT> {
    windows_link::link!("dwmapi.dll" "system" fn DwmFlush() -> windows_core::HRESULT);
    unsafe { DwmFlush().ok() }
}
#[inline]
pub unsafe fn DwmGetColorizationColor(pcrcolorization: *mut u32, pfopaqueblend: *mut windows_core::BOOL) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmGetCompositionTimingInfo(hwnd: super::super::Foundation::HWND, ptiminginfo: *mut DWM_TIMING_INFO) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmGetGraphicsStreamClient(uindex: u32) -> Result<windows_core::GUID, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmGetGraphicsStreamTransformHint(uindex: u32, ptransform: *mut MilMatrix3x2D) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmGetTransportAttributes(pfisremoting: *mut windows_core::BOOL, pfisconnected: *mut windows_core::BOOL, pdwgeneration: *mut u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmGetUnmetTabRequirements(appwindow: Option<super::super::Foundation::HWND>) -> Result<DWM_TAB_WINDOW_REQUIREMENTS, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmGetWindowAttribute(hwnd: super::super::Foundation::HWND, dwattribute: DWMWINDOWATTRIBUTE, pvattribute: *mut core::ffi::c_void, cbattribute: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmInvalidateIconicBitmaps(hwnd: super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmIsCompositionEnabled() -> Result<windows_core::BOOL, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmModifyPreviousDxFrameDuration(hwnd: super::super::Foundation::HWND, crefreshes: i32, frelative: bool) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmQueryThumbnailSourceSize(hthumbnail: isize) -> Result<super::super::Foundation::SIZE, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmRegisterThumbnail(hwnddestination: super::super::Foundation::HWND, hwndsource: super::super::Foundation::HWND) -> Result<isize, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmRenderGesture(gt: GESTURE_TYPE, ccontacts: u32, pdwpointerid: *const u32, ppoints: *const super::super::Foundation::POINT) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmSetDxFrameDuration(hwnd: super::super::Foundation::HWND, crefreshes: i32) -> Result<(), windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn DwmSetIconicLivePreviewBitmap(hwnd: super::super::Foundation::HWND, hbmp: super::Gdi::HBITMAP, pptclient: Option<*const super::super::Foundation::POINT>, dwsitflags: u32) -> Result<(), windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn DwmSetIconicThumbnail(hwnd: super::super::Foundation::HWND, hbmp: super::Gdi::HBITMAP, dwsitflags: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmSetPresentParameters(hwnd: super::super::Foundation::HWND, ppresentparams: *mut DWM_PRESENT_PARAMETERS) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmSetWindowAttribute(hwnd: super::super::Foundation::HWND, dwattribute: DWMWINDOWATTRIBUTE, pvattribute: *const core::ffi::c_void, cbattribute: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmShowContact(dwpointerid: u32, eshowcontact: DWM_SHOWCONTACT) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmTetherContact(dwpointerid: u32, fenable: bool, pttether: super::super::Foundation::POINT) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmTransitionOwnedWindow(hwnd: super::super::Foundation::HWND, target: DWMTRANSITION_OWNEDWINDOW_TARGET) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmUnregisterThumbnail(hthumbnailid: isize) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DwmUpdateThumbnailProperties(hthumbnailid: isize, ptnproperties: *const DWM_THUMBNAIL_PROPERTIES) -> Result<(), windows_result::HRESULT> {
