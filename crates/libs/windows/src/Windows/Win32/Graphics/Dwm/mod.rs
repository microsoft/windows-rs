...
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmAttachMilContent ( hwnd : super::super::Foundation:: HWND ) -> :: windows::core::HRESULT );
...
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmDefWindowProc ( hwnd : super::super::Foundation:: HWND , msg : u32 , wparam : super::super::Foundation:: WPARAM , lparam : super::super::Foundation:: LPARAM , plresult : *mut super::super::Foundation:: LRESULT ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmDetachMilContent ( hwnd : super::super::Foundation:: HWND ) -> :: windows::core::HRESULT );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmEnableBlurBehindWindow ( hwnd : super::super::Foundation:: HWND , pblurbehind : *const DWM_BLURBEHIND ) -> :: windows::core::HRESULT );
...
pub unsafe fn DwmEnableComposition(ucompositionaction: u32) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmEnableComposition ( ucompositionaction : u32 ) -> :: windows::core::HRESULT );
...
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmEnableMMCSS ( fenablemmcss : super::super::Foundation:: BOOL ) -> :: windows::core::HRESULT );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmExtendFrameIntoClientArea ( hwnd : super::super::Foundation:: HWND , pmarinset : *const super::super::UI::Controls:: MARGINS ) -> :: windows::core::HRESULT );
    DwmExtendFrameIntoClientArea(hwnd.into(), ::core::mem::transmute(pmarinset)).ok()
}
#[doc = "*Required features: `\"Win32_Graphics_Dwm\"`*"]
#[inline]
pub unsafe fn DwmFlush() -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmFlush ( ) -> :: windows::core::HRESULT );
    DwmFlush().ok()
}
#[doc = "*Required features: `\"Win32_Graphics_Dwm\"`, `\"Win32_Foundation\"`*"]
#[cfg(feature = "Win32_Foundation")]
...
pub unsafe fn DwmGetColorizationColor(pcrcolorization: *mut u32, pfopaqueblend: *mut super::super::Foundation::BOOL) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmGetColorizationColor ( pcrcolorization : *mut u32 , pfopaqueblend : *mut super::super::Foundation:: BOOL ) -> :: windows::core::HRESULT );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmGetCompositionTimingInfo ( hwnd : super::super::Foundation:: HWND , ptiminginfo : *mut DWM_TIMING_INFO ) -> :: windows::core::HRESULT );
...
pub unsafe fn DwmGetGraphicsStreamClient(uindex: u32) -> ::windows::core::Result<::windows::core::GUID> {
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmGetGraphicsStreamClient ( uindex : u32 , pclientuuid : *mut :: windows::core::GUID ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
pub unsafe fn DwmGetGraphicsStreamTransformHint(uindex: u32) -> ::windows::core::Result<MilMatrix3x2D> {
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmGetGraphicsStreamTransformHint ( uindex : u32 , ptransform : *mut MilMatrix3x2D ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
pub unsafe fn DwmGetTransportAttributes(pfisremoting: *mut super::super::Foundation::BOOL, pfisconnected: *mut super::super::Foundation::BOOL, pdwgeneration: *mut u32) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmGetTransportAttributes ( pfisremoting : *mut super::super::Foundation:: BOOL , pfisconnected : *mut super::super::Foundation:: BOOL , pdwgeneration : *mut u32 ) -> :: windows::core::HRESULT );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmGetUnmetTabRequirements ( appwindow : super::super::Foundation:: HWND , value : *mut DWM_TAB_WINDOW_REQUIREMENTS ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmGetWindowAttribute ( hwnd : super::super::Foundation:: HWND , dwattribute : DWMWINDOWATTRIBUTE , pvattribute : *mut ::core::ffi::c_void , cbattribute : u32 ) -> :: windows::core::HRESULT );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmInvalidateIconicBitmaps ( hwnd : super::super::Foundation:: HWND ) -> :: windows::core::HRESULT );
...
pub unsafe fn DwmIsCompositionEnabled() -> ::windows::core::Result<super::super::Foundation::BOOL> {
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmIsCompositionEnabled ( pfenabled : *mut super::super::Foundation:: BOOL ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmModifyPreviousDxFrameDuration ( hwnd : super::super::Foundation:: HWND , crefreshes : i32 , frelative : super::super::Foundation:: BOOL ) -> :: windows::core::HRESULT );
...
pub unsafe fn DwmQueryThumbnailSourceSize(hthumbnail: isize) -> ::windows::core::Result<super::super::Foundation::SIZE> {
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmQueryThumbnailSourceSize ( hthumbnail : isize , psize : *mut super::super::Foundation:: SIZE ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmRegisterThumbnail ( hwnddestination : super::super::Foundation:: HWND , hwndsource : super::super::Foundation:: HWND , phthumbnailid : *mut isize ) -> :: windows::core::HRESULT );
    let mut result__ = ::core::mem::MaybeUninit::zeroed();
...
pub unsafe fn DwmRenderGesture(gt: GESTURE_TYPE, ccontacts: u32, pdwpointerid: *const u32, ppoints: *const super::super::Foundation::POINT) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmRenderGesture ( gt : GESTURE_TYPE , ccontacts : u32 , pdwpointerid : *const u32 , ppoints : *const super::super::Foundation:: POINT ) -> :: windows::core::HRESULT );
    DwmRenderGesture(gt, ccontacts, ::core::mem::transmute(pdwpointerid), ::core::mem::transmute(ppoints)).ok()
}
#[doc = "*Required features: `\"Win32_Graphics_Dwm\"`, `\"Win32_Foundation\"`*"]
#[cfg(feature = "Win32_Foundation")]
#[inline]
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmSetDxFrameDuration ( hwnd : super::super::Foundation:: HWND , crefreshes : i32 ) -> :: windows::core::HRESULT );
...
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmSetIconicLivePreviewBitmap ( hwnd : super::super::Foundation:: HWND , hbmp : super::Gdi:: HBITMAP , pptclient : *const super::super::Foundation:: POINT , dwsitflags : u32 ) -> :: windows::core::HRESULT );
...
where
    ...
    P1: ::std::convert::Into<super::Gdi::HBITMAP>,
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmSetIconicThumbnail ( hwnd : super::super::Foundation:: HWND , hbmp : super::Gdi:: HBITMAP , dwsitflags : u32 ) -> :: windows::core::HRESULT );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmSetPresentParameters ( hwnd : super::super::Foundation:: HWND , ppresentparams : *mut DWM_PRESENT_PARAMETERS ) -> :: windows::core::HRESULT );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmSetWindowAttribute ( hwnd : super::super::Foundation:: HWND , dwattribute : DWMWINDOWATTRIBUTE , pvattribute : *const ::core::ffi::c_void , cbattribute : u32 ) -> :: windows::core::HRESULT );
...
pub unsafe fn DwmShowContact(dwpointerid: u32, eshowcontact: DWM_SHOWCONTACT) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmShowContact ( dwpointerid : u32 , eshowcontact : DWM_SHOWCONTACT ) -> :: windows::core::HRESULT );
...
where
    P0: ::std::convert::Into<super::super::Foundation::BOOL>,
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmTetherContact ( dwpointerid : u32 , fenable : super::super::Foundation:: BOOL , pttether : super::super::Foundation:: POINT ) -> :: windows::core::HRESULT );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmTransitionOwnedWindow ( hwnd : super::super::Foundation:: HWND , target : DWMTRANSITION_OWNEDWINDOW_TARGET ) -> :: windows::core::HRESULT );
    DwmTransitionOwnedWindow(hwnd.into(), target).ok()
}
#[doc = "*Required features: `\"Win32_Graphics_Dwm\"`*"]
#[inline]
pub unsafe fn DwmUnregisterThumbnail(hthumbnailid: isize) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmUnregisterThumbnail ( hthumbnailid : isize ) -> :: windows::core::HRESULT );
...
pub unsafe fn DwmUpdateThumbnailProperties(hthumbnailid: isize, ptnproperties: *const DWM_THUMBNAIL_PROPERTIES) -> ::windows::core::Result<()> {
    ::windows::core::windows_link ! ( "dwmapi.dll" ,"system" fn DwmUpdateThumbnailProperties ( hthumbnailid : isize , ptnproperties : *const DWM_THUMBNAIL_PROPERTIES ) -> :: windows::core::HRESULT );
