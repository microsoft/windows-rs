...
pub const Aborted: Status = Status(9);
pub const AccessDenied: Status = Status(12);
pub const AdjustBlackSaturation: CurveAdjustments = CurveAdjustments(7);
pub const AdjustContrast: CurveAdjustments = CurveAdjustments(2);
pub const AdjustDensity: CurveAdjustments = CurveAdjustments(1);
pub const AdjustExposure: CurveAdjustments = CurveAdjustments(0);
pub const AdjustHighlight: CurveAdjustments = CurveAdjustments(3);
pub const AdjustMidtone: CurveAdjustments = CurveAdjustments(5);
pub const AdjustShadow: CurveAdjustments = CurveAdjustments(4);
pub const AdjustWhiteSaturation: CurveAdjustments = CurveAdjustments(6);
...
pub const BrushTypeHatchFill: BrushType = BrushType(1);
pub const BrushTypeLinearGradient: BrushType = BrushType(4);
pub const BrushTypePathGradient: BrushType = BrushType(3);
pub const BrushTypeSolidColor: BrushType = BrushType(0);
pub const BrushTypeTextureFill: BrushType = BrushType(2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Default)]
...
pub const ColorAdjustTypeAny: ColorAdjustType = ColorAdjustType(6);
pub const ColorAdjustTypeBitmap: ColorAdjustType = ColorAdjustType(1);
pub const ColorAdjustTypeBrush: ColorAdjustType = ColorAdjustType(2);
pub const ColorAdjustTypeCount: ColorAdjustType = ColorAdjustType(5);
pub const ColorAdjustTypeDefault: ColorAdjustType = ColorAdjustType(0);
pub const ColorAdjustTypePen: ColorAdjustType = ColorAdjustType(3);
pub const ColorAdjustTypeText: ColorAdjustType = ColorAdjustType(4);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const ColorChannelFlagsC: ColorChannelFlags = ColorChannelFlags(0);
pub const ColorChannelFlagsK: ColorChannelFlags = ColorChannelFlags(3);
pub const ColorChannelFlagsLast: ColorChannelFlags = ColorChannelFlags(4);
pub const ColorChannelFlagsM: ColorChannelFlags = ColorChannelFlags(1);
pub const ColorChannelFlagsY: ColorChannelFlags = ColorChannelFlags(2);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const ColorMatrixFlagsAltGray: ColorMatrixFlags = ColorMatrixFlags(2);
pub const ColorMatrixFlagsDefault: ColorMatrixFlags = ColorMatrixFlags(0);
pub const ColorMatrixFlagsSkipGrays: ColorMatrixFlags = ColorMatrixFlags(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct ColorMode(pub i32);
pub const ColorModeARGB32: ColorMode = ColorMode(0);
pub const ColorModeARGB64: ColorMode = ColorMode(1);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const CombineModeComplement: CombineMode = CombineMode(5);
pub const CombineModeExclude: CombineMode = CombineMode(4);
pub const CombineModeIntersect: CombineMode = CombineMode(1);
pub const CombineModeReplace: CombineMode = CombineMode(0);
pub const CombineModeUnion: CombineMode = CombineMode(2);
pub const CombineModeXor: CombineMode = CombineMode(3);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct CompositingMode(pub i32);
pub const CompositingModeSourceCopy: CompositingMode = CompositingMode(1);
pub const CompositingModeSourceOver: CompositingMode = CompositingMode(0);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct CompositingQuality(pub i32);
pub const CompositingQualityAssumeLinear: CompositingQuality = CompositingQuality(4);
pub const CompositingQualityDefault: CompositingQuality = CompositingQuality(0);
pub const CompositingQualityGammaCorrected: CompositingQuality = CompositingQuality(3);
pub const CompositingQualityHighQuality: CompositingQuality = CompositingQuality(2);
pub const CompositingQualityHighSpeed: CompositingQuality = CompositingQuality(1);
pub const CompositingQualityInvalid: CompositingQuality = CompositingQuality(-1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct ConvertToEmfPlusFlags(pub i32);
pub const ConvertToEmfPlusFlagsDefault: ConvertToEmfPlusFlags = ConvertToEmfPlusFlags(0);
pub const ConvertToEmfPlusFlagsInvalidRecord: ConvertToEmfPlusFlags = ConvertToEmfPlusFlags(4);
pub const ConvertToEmfPlusFlagsRopUsed: ConvertToEmfPlusFlags = ConvertToEmfPlusFlags(1);
pub const ConvertToEmfPlusFlagsText: ConvertToEmfPlusFlags = ConvertToEmfPlusFlags(2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct CoordinateSpace(pub i32);
pub const CoordinateSpaceDevice: CoordinateSpace = CoordinateSpace(2);
pub const CoordinateSpacePage: CoordinateSpace = CoordinateSpace(1);
pub const CoordinateSpaceWorld: CoordinateSpace = CoordinateSpace(0);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CurveChannelAll: CurveChannel = CurveChannel(0);
pub const CurveChannelBlue: CurveChannel = CurveChannel(3);
pub const CurveChannelGreen: CurveChannel = CurveChannel(2);
pub const CurveChannelRed: CurveChannel = CurveChannel(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Default)]
...
pub const CustomLineCapTypeAdjustableArrow: CustomLineCapType = CustomLineCapType(1);
pub const CustomLineCapTypeDefault: CustomLineCapType = CustomLineCapType(0);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct DashCap(pub i32);
pub const DashCapFlat: DashCap = DashCap(0);
pub const DashCapRound: DashCap = DashCap(2);
pub const DashCapTriangle: DashCap = DashCap(3);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct DashStyle(pub i32);
pub const DashStyleCustom: DashStyle = DashStyle(5);
pub const DashStyleDash: DashStyle = DashStyle(1);
pub const DashStyleDashDot: DashStyle = DashStyle(3);
pub const DashStyleDashDotDot: DashStyle = DashStyle(4);
pub const DashStyleDot: DashStyle = DashStyle(2);
pub const DashStyleSolid: DashStyle = DashStyle(0);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct DebugEventLevel(pub i32);
pub const DebugEventLevelFatal: DebugEventLevel = DebugEventLevel(0);
pub const DebugEventLevelWarning: DebugEventLevel = DebugEventLevel(1);
...
pub const DitherTypeDualSpiral4x4: DitherType = DitherType(7);
pub const DitherTypeDualSpiral8x8: DitherType = DitherType(8);
pub const DitherTypeErrorDiffusion: DitherType = DitherType(9);
pub const DitherTypeMax: DitherType = DitherType(10);
pub const DitherTypeNone: DitherType = DitherType(0);
pub const DitherTypeOrdered16x16: DitherType = DitherType(4);
pub const DitherTypeOrdered4x4: DitherType = DitherType(2);
pub const DitherTypeOrdered8x8: DitherType = DitherType(3);
pub const DitherTypeSolid: DitherType = DitherType(1);
pub const DitherTypeSpiral4x4: DitherType = DitherType(5);
pub const DitherTypeSpiral8x8: DitherType = DitherType(6);
pub type DrawImageAbort = Option<unsafe extern "system" fn() -> windows_core::BOOL>;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct DriverStringOptions(pub i32);
pub const DriverStringOptionsCmapLookup: DriverStringOptions = DriverStringOptions(1);
pub const DriverStringOptionsLimitSubpixel: DriverStringOptions = DriverStringOptions(8);
pub const DriverStringOptionsRealizedAdvance: DriverStringOptions = DriverStringOptions(4);
pub const DriverStringOptionsVertical: DriverStringOptions = DriverStringOptions(2);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const EmfPlusRecordTotal: EmfPlusRecordType = EmfPlusRecordType(16443);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct EmfPlusRecordType(pub i32);
pub const EmfPlusRecordTypeBeginContainer: EmfPlusRecordType = EmfPlusRecordType(16423);
pub const EmfPlusRecordTypeBeginContainerNoParams: EmfPlusRecordType = EmfPlusRecordType(16424);
pub const EmfPlusRecordTypeClear: EmfPlusRecordType = EmfPlusRecordType(16393);
pub const EmfPlusRecordTypeComment: EmfPlusRecordType = EmfPlusRecordType(16387);
pub const EmfPlusRecordTypeDrawArc: EmfPlusRecordType = EmfPlusRecordType(16402);
pub const EmfPlusRecordTypeDrawBeziers: EmfPlusRecordType = EmfPlusRecordType(16409);
pub const EmfPlusRecordTypeDrawClosedCurve: EmfPlusRecordType = EmfPlusRecordType(16407);
pub const EmfPlusRecordTypeDrawCurve: EmfPlusRecordType = EmfPlusRecordType(16408);
pub const EmfPlusRecordTypeDrawDriverString: EmfPlusRecordType = EmfPlusRecordType(16438);
pub const EmfPlusRecordTypeDrawEllipse: EmfPlusRecordType = EmfPlusRecordType(16399);
pub const EmfPlusRecordTypeDrawImage: EmfPlusRecordType = EmfPlusRecordType(16410);
pub const EmfPlusRecordTypeDrawImagePoints: EmfPlusRecordType = EmfPlusRecordType(16411);
pub const EmfPlusRecordTypeDrawLines: EmfPlusRecordType = EmfPlusRecordType(16397);
pub const EmfPlusRecordTypeDrawPath: EmfPlusRecordType = EmfPlusRecordType(16405);
pub const EmfPlusRecordTypeDrawPie: EmfPlusRecordType = EmfPlusRecordType(16401);
pub const EmfPlusRecordTypeDrawRects: EmfPlusRecordType = EmfPlusRecordType(16395);
pub const EmfPlusRecordTypeDrawString: EmfPlusRecordType = EmfPlusRecordType(16412);
pub const EmfPlusRecordTypeEndContainer: EmfPlusRecordType = EmfPlusRecordType(16425);
pub const EmfPlusRecordTypeEndOfFile: EmfPlusRecordType = EmfPlusRecordType(16386);
pub const EmfPlusRecordTypeFillClosedCurve: EmfPlusRecordType = EmfPlusRecordType(16406);
pub const EmfPlusRecordTypeFillEllipse: EmfPlusRecordType = EmfPlusRecordType(16398);
pub const EmfPlusRecordTypeFillPath: EmfPlusRecordType = EmfPlusRecordType(16404);
pub const EmfPlusRecordTypeFillPie: EmfPlusRecordType = EmfPlusRecordType(16400);
pub const EmfPlusRecordTypeFillPolygon: EmfPlusRecordType = EmfPlusRecordType(16396);
pub const EmfPlusRecordTypeFillRects: EmfPlusRecordType = EmfPlusRecordType(16394);
pub const EmfPlusRecordTypeFillRegion: EmfPlusRecordType = EmfPlusRecordType(16403);
pub const EmfPlusRecordTypeGetDC: EmfPlusRecordType = EmfPlusRecordType(16388);
pub const EmfPlusRecordTypeHeader: EmfPlusRecordType = EmfPlusRecordType(16385);
pub const EmfPlusRecordTypeInvalid: EmfPlusRecordType = EmfPlusRecordType(16384);
pub const EmfPlusRecordTypeMax: EmfPlusRecordType = EmfPlusRecordType(16442);
pub const EmfPlusRecordTypeMin: EmfPlusRecordType = EmfPlusRecordType(16385);
pub const EmfPlusRecordTypeMultiFormatEnd: EmfPlusRecordType = EmfPlusRecordType(16391);
pub const EmfPlusRecordTypeMultiFormatSection: EmfPlusRecordType = EmfPlusRecordType(16390);
pub const EmfPlusRecordTypeMultiFormatStart: EmfPlusRecordType = EmfPlusRecordType(16389);
pub const EmfPlusRecordTypeMultiplyWorldTransform: EmfPlusRecordType = EmfPlusRecordType(16428);
pub const EmfPlusRecordTypeObject: EmfPlusRecordType = EmfPlusRecordType(16392);
pub const EmfPlusRecordTypeOffsetClip: EmfPlusRecordType = EmfPlusRecordType(16437);
pub const EmfPlusRecordTypeResetClip: EmfPlusRecordType = EmfPlusRecordType(16433);
pub const EmfPlusRecordTypeResetWorldTransform: EmfPlusRecordType = EmfPlusRecordType(16427);
pub const EmfPlusRecordTypeRestore: EmfPlusRecordType = EmfPlusRecordType(16422);
pub const EmfPlusRecordTypeRotateWorldTransform: EmfPlusRecordType = EmfPlusRecordType(16431);
pub const EmfPlusRecordTypeSave: EmfPlusRecordType = EmfPlusRecordType(16421);
pub const EmfPlusRecordTypeScaleWorldTransform: EmfPlusRecordType = EmfPlusRecordType(16430);
pub const EmfPlusRecordTypeSerializableObject: EmfPlusRecordType = EmfPlusRecordType(16440);
pub const EmfPlusRecordTypeSetAntiAliasMode: EmfPlusRecordType = EmfPlusRecordType(16414);
pub const EmfPlusRecordTypeSetClipPath: EmfPlusRecordType = EmfPlusRecordType(16435);
pub const EmfPlusRecordTypeSetClipRect: EmfPlusRecordType = EmfPlusRecordType(16434);
pub const EmfPlusRecordTypeSetClipRegion: EmfPlusRecordType = EmfPlusRecordType(16436);
pub const EmfPlusRecordTypeSetCompositingMode: EmfPlusRecordType = EmfPlusRecordType(16419);
pub const EmfPlusRecordTypeSetCompositingQuality: EmfPlusRecordType = EmfPlusRecordType(16420);
pub const EmfPlusRecordTypeSetInterpolationMode: EmfPlusRecordType = EmfPlusRecordType(16417);
pub const EmfPlusRecordTypeSetPageTransform: EmfPlusRecordType = EmfPlusRecordType(16432);
pub const EmfPlusRecordTypeSetPixelOffsetMode: EmfPlusRecordType = EmfPlusRecordType(16418);
pub const EmfPlusRecordTypeSetRenderingOrigin: EmfPlusRecordType = EmfPlusRecordType(16413);
pub const EmfPlusRecordTypeSetTSClip: EmfPlusRecordType = EmfPlusRecordType(16442);
pub const EmfPlusRecordTypeSetTSGraphics: EmfPlusRecordType = EmfPlusRecordType(16441);
pub const EmfPlusRecordTypeSetTextContrast: EmfPlusRecordType = EmfPlusRecordType(16416);
pub const EmfPlusRecordTypeSetTextRenderingHint: EmfPlusRecordType = EmfPlusRecordType(16415);
pub const EmfPlusRecordTypeSetWorldTransform: EmfPlusRecordType = EmfPlusRecordType(16426);
pub const EmfPlusRecordTypeStrokeFillPath: EmfPlusRecordType = EmfPlusRecordType(16439);
pub const EmfPlusRecordTypeTranslateWorldTransform: EmfPlusRecordType = EmfPlusRecordType(16429);
pub const EmfRecordTypeAbortPath: EmfPlusRecordType = EmfPlusRecordType(68);
pub const EmfRecordTypeAlphaBlend: EmfPlusRecordType = EmfPlusRecordType(114);
pub const EmfRecordTypeAngleArc: EmfPlusRecordType = EmfPlusRecordType(41);
pub const EmfRecordTypeArc: EmfPlusRecordType = EmfPlusRecordType(45);
pub const EmfRecordTypeArcTo: EmfPlusRecordType = EmfPlusRecordType(55);
pub const EmfRecordTypeBeginPath: EmfPlusRecordType = EmfPlusRecordType(59);
pub const EmfRecordTypeBitBlt: EmfPlusRecordType = EmfPlusRecordType(76);
pub const EmfRecordTypeChord: EmfPlusRecordType = EmfPlusRecordType(46);
pub const EmfRecordTypeCloseFigure: EmfPlusRecordType = EmfPlusRecordType(61);
pub const EmfRecordTypeColorCorrectPalette: EmfPlusRecordType = EmfPlusRecordType(111);
pub const EmfRecordTypeColorMatchToTargetW: EmfPlusRecordType = EmfPlusRecordType(121);
pub const EmfRecordTypeCreateBrushIndirect: EmfPlusRecordType = EmfPlusRecordType(39);
pub const EmfRecordTypeCreateColorSpace: EmfPlusRecordType = EmfPlusRecordType(99);
pub const EmfRecordTypeCreateColorSpaceW: EmfPlusRecordType = EmfPlusRecordType(122);
pub const EmfRecordTypeCreateDIBPatternBrushPt: EmfPlusRecordType = EmfPlusRecordType(94);
pub const EmfRecordTypeCreateMonoBrush: EmfPlusRecordType = EmfPlusRecordType(93);
pub const EmfRecordTypeCreatePalette: EmfPlusRecordType = EmfPlusRecordType(49);
pub const EmfRecordTypeCreatePen: EmfPlusRecordType = EmfPlusRecordType(38);
pub const EmfRecordTypeDeleteColorSpace: EmfPlusRecordType = EmfPlusRecordType(101);
pub const EmfRecordTypeDeleteObject: EmfPlusRecordType = EmfPlusRecordType(40);
pub const EmfRecordTypeDrawEscape: EmfPlusRecordType = EmfPlusRecordType(105);
pub const EmfRecordTypeEOF: EmfPlusRecordType = EmfPlusRecordType(14);
pub const EmfRecordTypeEllipse: EmfPlusRecordType = EmfPlusRecordType(42);
pub const EmfRecordTypeEndPath: EmfPlusRecordType = EmfPlusRecordType(60);
pub const EmfRecordTypeExcludeClipRect: EmfPlusRecordType = EmfPlusRecordType(29);
pub const EmfRecordTypeExtCreateFontIndirect: EmfPlusRecordType = EmfPlusRecordType(82);
pub const EmfRecordTypeExtCreatePen: EmfPlusRecordType = EmfPlusRecordType(95);
pub const EmfRecordTypeExtEscape: EmfPlusRecordType = EmfPlusRecordType(106);
pub const EmfRecordTypeExtFloodFill: EmfPlusRecordType = EmfPlusRecordType(53);
pub const EmfRecordTypeExtSelectClipRgn: EmfPlusRecordType = EmfPlusRecordType(75);
pub const EmfRecordTypeExtTextOutA: EmfPlusRecordType = EmfPlusRecordType(83);
pub const EmfRecordTypeExtTextOutW: EmfPlusRecordType = EmfPlusRecordType(84);
pub const EmfRecordTypeFillPath: EmfPlusRecordType = EmfPlusRecordType(62);
pub const EmfRecordTypeFillRgn: EmfPlusRecordType = EmfPlusRecordType(71);
pub const EmfRecordTypeFlattenPath: EmfPlusRecordType = EmfPlusRecordType(65);
pub const EmfRecordTypeForceUFIMapping: EmfPlusRecordType = EmfPlusRecordType(109);
pub const EmfRecordTypeFrameRgn: EmfPlusRecordType = EmfPlusRecordType(72);
pub const EmfRecordTypeGLSBoundedRecord: EmfPlusRecordType = EmfPlusRecordType(103);
pub const EmfRecordTypeGLSRecord: EmfPlusRecordType = EmfPlusRecordType(102);
pub const EmfRecordTypeGdiComment: EmfPlusRecordType = EmfPlusRecordType(70);
pub const EmfRecordTypeGradientFill: EmfPlusRecordType = EmfPlusRecordType(118);
pub const EmfRecordTypeHeader: EmfPlusRecordType = EmfPlusRecordType(1);
pub const EmfRecordTypeIntersectClipRect: EmfPlusRecordType = EmfPlusRecordType(30);
pub const EmfRecordTypeInvertRgn: EmfPlusRecordType = EmfPlusRecordType(73);
pub const EmfRecordTypeLineTo: EmfPlusRecordType = EmfPlusRecordType(54);
pub const EmfRecordTypeMaskBlt: EmfPlusRecordType = EmfPlusRecordType(78);
pub const EmfRecordTypeMax: EmfPlusRecordType = EmfPlusRecordType(122);
pub const EmfRecordTypeMin: EmfPlusRecordType = EmfPlusRecordType(1);
pub const EmfRecordTypeModifyWorldTransform: EmfPlusRecordType = EmfPlusRecordType(36);
pub const EmfRecordTypeMoveToEx: EmfPlusRecordType = EmfPlusRecordType(27);
pub const EmfRecordTypeNamedEscape: EmfPlusRecordType = EmfPlusRecordType(110);
pub const EmfRecordTypeOffsetClipRgn: EmfPlusRecordType = EmfPlusRecordType(26);
pub const EmfRecordTypePaintRgn: EmfPlusRecordType = EmfPlusRecordType(74);
pub const EmfRecordTypePie: EmfPlusRecordType = EmfPlusRecordType(47);
pub const EmfRecordTypePixelFormat: EmfPlusRecordType = EmfPlusRecordType(104);
pub const EmfRecordTypePlgBlt: EmfPlusRecordType = EmfPlusRecordType(79);
pub const EmfRecordTypePolyBezier: EmfPlusRecordType = EmfPlusRecordType(2);
pub const EmfRecordTypePolyBezier16: EmfPlusRecordType = EmfPlusRecordType(85);
pub const EmfRecordTypePolyBezierTo: EmfPlusRecordType = EmfPlusRecordType(5);
pub const EmfRecordTypePolyBezierTo16: EmfPlusRecordType = EmfPlusRecordType(88);
pub const EmfRecordTypePolyDraw: EmfPlusRecordType = EmfPlusRecordType(56);
pub const EmfRecordTypePolyDraw16: EmfPlusRecordType = EmfPlusRecordType(92);
pub const EmfRecordTypePolyLineTo: EmfPlusRecordType = EmfPlusRecordType(6);
pub const EmfRecordTypePolyPolygon: EmfPlusRecordType = EmfPlusRecordType(8);
pub const EmfRecordTypePolyPolygon16: EmfPlusRecordType = EmfPlusRecordType(91);
pub const EmfRecordTypePolyPolyline: EmfPlusRecordType = EmfPlusRecordType(7);
pub const EmfRecordTypePolyPolyline16: EmfPlusRecordType = EmfPlusRecordType(90);
pub const EmfRecordTypePolyTextOutA: EmfPlusRecordType = EmfPlusRecordType(96);
pub const EmfRecordTypePolyTextOutW: EmfPlusRecordType = EmfPlusRecordType(97);
pub const EmfRecordTypePolygon: EmfPlusRecordType = EmfPlusRecordType(3);
pub const EmfRecordTypePolygon16: EmfPlusRecordType = EmfPlusRecordType(86);
pub const EmfRecordTypePolyline: EmfPlusRecordType = EmfPlusRecordType(4);
pub const EmfRecordTypePolyline16: EmfPlusRecordType = EmfPlusRecordType(87);
pub const EmfRecordTypePolylineTo16: EmfPlusRecordType = EmfPlusRecordType(89);
pub const EmfRecordTypeRealizePalette: EmfPlusRecordType = EmfPlusRecordType(52);
pub const EmfRecordTypeRectangle: EmfPlusRecordType = EmfPlusRecordType(43);
pub const EmfRecordTypeReserved_069: EmfPlusRecordType = EmfPlusRecordType(69);
pub const EmfRecordTypeReserved_117: EmfPlusRecordType = EmfPlusRecordType(117);
pub const EmfRecordTypeResizePalette: EmfPlusRecordType = EmfPlusRecordType(51);
pub const EmfRecordTypeRestoreDC: EmfPlusRecordType = EmfPlusRecordType(34);
pub const EmfRecordTypeRoundRect: EmfPlusRecordType = EmfPlusRecordType(44);
pub const EmfRecordTypeSaveDC: EmfPlusRecordType = EmfPlusRecordType(33);
pub const EmfRecordTypeScaleViewportExtEx: EmfPlusRecordType = EmfPlusRecordType(31);
pub const EmfRecordTypeScaleWindowExtEx: EmfPlusRecordType = EmfPlusRecordType(32);
pub const EmfRecordTypeSelectClipPath: EmfPlusRecordType = EmfPlusRecordType(67);
pub const EmfRecordTypeSelectObject: EmfPlusRecordType = EmfPlusRecordType(37);
pub const EmfRecordTypeSelectPalette: EmfPlusRecordType = EmfPlusRecordType(48);
pub const EmfRecordTypeSetArcDirection: EmfPlusRecordType = EmfPlusRecordType(57);
pub const EmfRecordTypeSetBkColor: EmfPlusRecordType = EmfPlusRecordType(25);
pub const EmfRecordTypeSetBkMode: EmfPlusRecordType = EmfPlusRecordType(18);
pub const EmfRecordTypeSetBrushOrgEx: EmfPlusRecordType = EmfPlusRecordType(13);
pub const EmfRecordTypeSetColorAdjustment: EmfPlusRecordType = EmfPlusRecordType(23);
pub const EmfRecordTypeSetColorSpace: EmfPlusRecordType = EmfPlusRecordType(100);
pub const EmfRecordTypeSetDIBitsToDevice: EmfPlusRecordType = EmfPlusRecordType(80);
pub const EmfRecordTypeSetICMMode: EmfPlusRecordType = EmfPlusRecordType(98);
pub const EmfRecordTypeSetICMProfileA: EmfPlusRecordType = EmfPlusRecordType(112);
pub const EmfRecordTypeSetICMProfileW: EmfPlusRecordType = EmfPlusRecordType(113);
pub const EmfRecordTypeSetLayout: EmfPlusRecordType = EmfPlusRecordType(115);
pub const EmfRecordTypeSetLinkedUFIs: EmfPlusRecordType = EmfPlusRecordType(119);
pub const EmfRecordTypeSetMapMode: EmfPlusRecordType = EmfPlusRecordType(17);
pub const EmfRecordTypeSetMapperFlags: EmfPlusRecordType = EmfPlusRecordType(16);
pub const EmfRecordTypeSetMetaRgn: EmfPlusRecordType = EmfPlusRecordType(28);
pub const EmfRecordTypeSetMiterLimit: EmfPlusRecordType = EmfPlusRecordType(58);
pub const EmfRecordTypeSetPaletteEntries: EmfPlusRecordType = EmfPlusRecordType(50);
pub const EmfRecordTypeSetPixelV: EmfPlusRecordType = EmfPlusRecordType(15);
pub const EmfRecordTypeSetPolyFillMode: EmfPlusRecordType = EmfPlusRecordType(19);
pub const EmfRecordTypeSetROP2: EmfPlusRecordType = EmfPlusRecordType(20);
pub const EmfRecordTypeSetStretchBltMode: EmfPlusRecordType = EmfPlusRecordType(21);
pub const EmfRecordTypeSetTextAlign: EmfPlusRecordType = EmfPlusRecordType(22);
pub const EmfRecordTypeSetTextColor: EmfPlusRecordType = EmfPlusRecordType(24);
pub const EmfRecordTypeSetTextJustification: EmfPlusRecordType = EmfPlusRecordType(120);
pub const EmfRecordTypeSetViewportExtEx: EmfPlusRecordType = EmfPlusRecordType(11);
pub const EmfRecordTypeSetViewportOrgEx: EmfPlusRecordType = EmfPlusRecordType(12);
pub const EmfRecordTypeSetWindowExtEx: EmfPlusRecordType = EmfPlusRecordType(9);
pub const EmfRecordTypeSetWindowOrgEx: EmfPlusRecordType = EmfPlusRecordType(10);
pub const EmfRecordTypeSetWorldTransform: EmfPlusRecordType = EmfPlusRecordType(35);
pub const EmfRecordTypeSmallTextOut: EmfPlusRecordType = EmfPlusRecordType(108);
pub const EmfRecordTypeStartDoc: EmfPlusRecordType = EmfPlusRecordType(107);
pub const EmfRecordTypeStretchBlt: EmfPlusRecordType = EmfPlusRecordType(77);
pub const EmfRecordTypeStretchDIBits: EmfPlusRecordType = EmfPlusRecordType(81);
pub const EmfRecordTypeStrokeAndFillPath: EmfPlusRecordType = EmfPlusRecordType(63);
pub const EmfRecordTypeStrokePath: EmfPlusRecordType = EmfPlusRecordType(64);
pub const EmfRecordTypeTransparentBlt: EmfPlusRecordType = EmfPlusRecordType(116);
pub const EmfRecordTypeWidenPath: EmfPlusRecordType = EmfPlusRecordType(66);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct EmfToWmfBitsFlags(pub i32);
pub const EmfToWmfBitsFlagsDefault: EmfToWmfBitsFlags = EmfToWmfBitsFlags(0);
pub const EmfToWmfBitsFlagsEmbedEmf: EmfToWmfBitsFlags = EmfToWmfBitsFlags(1);
pub const EmfToWmfBitsFlagsIncludePlaceable: EmfToWmfBitsFlags = EmfToWmfBitsFlags(2);
pub const EmfToWmfBitsFlagsNoXORClip: EmfToWmfBitsFlags = EmfToWmfBitsFlags(4);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct EmfType(pub i32);
pub const EmfTypeEmfOnly: EmfType = EmfType(3);
pub const EmfTypeEmfPlusDual: EmfType = EmfType(5);
pub const EmfTypeEmfPlusOnly: EmfType = EmfType(4);
...
pub const EncoderParameterValueTypeASCII: EncoderParameterValueType = EncoderParameterValueType(2);
pub const EncoderParameterValueTypeByte: EncoderParameterValueType = EncoderParameterValueType(1);
pub const EncoderParameterValueTypeLong: EncoderParameterValueType = EncoderParameterValueType(4);
pub const EncoderParameterValueTypeLongRange: EncoderParameterValueType = EncoderParameterValueType(6);
pub const EncoderParameterValueTypePointer: EncoderParameterValueType = EncoderParameterValueType(9);
pub const EncoderParameterValueTypeRational: EncoderParameterValueType = EncoderParameterValueType(5);
pub const EncoderParameterValueTypeRationalRange: EncoderParameterValueType = EncoderParameterValueType(8);
pub const EncoderParameterValueTypeShort: EncoderParameterValueType = EncoderParameterValueType(3);
pub const EncoderParameterValueTypeUndefined: EncoderParameterValueType = EncoderParameterValueType(7);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const EncoderValueColorTypeCMYK: EncoderValue = EncoderValue(0);
pub const EncoderValueColorTypeGray: EncoderValue = EncoderValue(24);
pub const EncoderValueColorTypeRGB: EncoderValue = EncoderValue(25);
pub const EncoderValueColorTypeYCCK: EncoderValue = EncoderValue(1);
pub const EncoderValueCompressionCCITT3: EncoderValue = EncoderValue(3);
pub const EncoderValueCompressionCCITT4: EncoderValue = EncoderValue(4);
pub const EncoderValueCompressionLZW: EncoderValue = EncoderValue(2);
pub const EncoderValueCompressionNone: EncoderValue = EncoderValue(6);
pub const EncoderValueCompressionRle: EncoderValue = EncoderValue(5);
pub const EncoderValueFlush: EncoderValue = EncoderValue(20);
pub const EncoderValueFrameDimensionPage: EncoderValue = EncoderValue(23);
pub const EncoderValueFrameDimensionResolution: EncoderValue = EncoderValue(22);
pub const EncoderValueFrameDimensionTime: EncoderValue = EncoderValue(21);
pub const EncoderValueLastFrame: EncoderValue = EncoderValue(19);
pub const EncoderValueMultiFrame: EncoderValue = EncoderValue(18);
pub const EncoderValueRenderNonProgressive: EncoderValue = EncoderValue(12);
pub const EncoderValueRenderProgressive: EncoderValue = EncoderValue(11);
pub const EncoderValueScanMethodInterlaced: EncoderValue = EncoderValue(7);
pub const EncoderValueScanMethodNonInterlaced: EncoderValue = EncoderValue(8);
pub const EncoderValueTransformFlipHorizontal: EncoderValue = EncoderValue(16);
pub const EncoderValueTransformFlipVertical: EncoderValue = EncoderValue(17);
pub const EncoderValueTransformRotate180: EncoderValue = EncoderValue(14);
pub const EncoderValueTransformRotate270: EncoderValue = EncoderValue(15);
pub const EncoderValueTransformRotate90: EncoderValue = EncoderValue(13);
pub const EncoderValueVersionGif87: EncoderValue = EncoderValue(9);
pub const EncoderValueVersionGif89: EncoderValue = EncoderValue(10);
...
pub const FileNotFound: Status = Status(10);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct FillMode(pub i32);
pub const FillModeAlternate: FillMode = FillMode(0);
pub const FillModeWinding: FillMode = FillMode(1);
pub const FlatnessDefault: f32 = 0.25;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct FlushIntention(pub i32);
pub const FlushIntentionFlush: FlushIntention = FlushIntention(0);
pub const FlushIntentionSync: FlushIntention = FlushIntention(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Default)]
...
pub const FontFamilyNotFound: Status = Status(14);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct FontStyle(pub i32);
pub const FontStyleBold: FontStyle = FontStyle(1);
pub const FontStyleBoldItalic: FontStyle = FontStyle(3);
pub const FontStyleItalic: FontStyle = FontStyle(2);
pub const FontStyleNotFound: Status = Status(15);
pub const FontStyleRegular: FontStyle = FontStyle(0);
pub const FontStyleStrikeout: FontStyle = FontStyle(8);
pub const FontStyleUnderline: FontStyle = FontStyle(4);
...
pub const GdiplusNotInitialized: Status = Status(18);
pub const GdiplusStartupDefault: GdiplusStartupParams = GdiplusStartupParams(0);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const GdiplusStartupNoSetRound: GdiplusStartupParams = GdiplusStartupParams(1);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const GdiplusStartupReserved0: GdiplusStartupParams = GdiplusStartupParams(4);
pub const GdiplusStartupReserved1: GdiplusStartupParams = GdiplusStartupParams(8);
pub const GdiplusStartupReserved2: GdiplusStartupParams = GdiplusStartupParams(16);
pub const GdiplusStartupSetPSValue: GdiplusStartupParams = GdiplusStartupParams(2);
pub const GdiplusStartupTransparencyMask: GdiplusStartupParams = GdiplusStartupParams(-16777216);
pub const GenericError: Status = Status(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct GenericFontFamily(pub i32);
pub const GenericFontFamilyMonospace: GenericFontFamily = GenericFontFamily(2);
pub const GenericFontFamilySansSerif: GenericFontFamily = GenericFontFamily(1);
pub const GenericFontFamilySerif: GenericFontFamily = GenericFontFamily(0);
...
pub const HatchStyle05Percent: HatchStyle = HatchStyle(6);
pub const HatchStyle10Percent: HatchStyle = HatchStyle(7);
pub const HatchStyle20Percent: HatchStyle = HatchStyle(8);
pub const HatchStyle25Percent: HatchStyle = HatchStyle(9);
pub const HatchStyle30Percent: HatchStyle = HatchStyle(10);
pub const HatchStyle40Percent: HatchStyle = HatchStyle(11);
pub const HatchStyle50Percent: HatchStyle = HatchStyle(12);
pub const HatchStyle60Percent: HatchStyle = HatchStyle(13);
pub const HatchStyle70Percent: HatchStyle = HatchStyle(14);
pub const HatchStyle75Percent: HatchStyle = HatchStyle(15);
pub const HatchStyle80Percent: HatchStyle = HatchStyle(16);
pub const HatchStyle90Percent: HatchStyle = HatchStyle(17);
pub const HatchStyleBackwardDiagonal: HatchStyle = HatchStyle(3);
pub const HatchStyleCross: HatchStyle = HatchStyle(4);
pub const HatchStyleDarkDownwardDiagonal: HatchStyle = HatchStyle(20);
pub const HatchStyleDarkHorizontal: HatchStyle = HatchStyle(29);
pub const HatchStyleDarkUpwardDiagonal: HatchStyle = HatchStyle(21);
pub const HatchStyleDarkVertical: HatchStyle = HatchStyle(28);
pub const HatchStyleDashedDownwardDiagonal: HatchStyle = HatchStyle(30);
pub const HatchStyleDashedHorizontal: HatchStyle = HatchStyle(32);
pub const HatchStyleDashedUpwardDiagonal: HatchStyle = HatchStyle(31);
pub const HatchStyleDashedVertical: HatchStyle = HatchStyle(33);
pub const HatchStyleDiagonalBrick: HatchStyle = HatchStyle(38);
pub const HatchStyleDiagonalCross: HatchStyle = HatchStyle(5);
pub const HatchStyleDivot: HatchStyle = HatchStyle(42);
pub const HatchStyleDottedDiamond: HatchStyle = HatchStyle(44);
pub const HatchStyleDottedGrid: HatchStyle = HatchStyle(43);
pub const HatchStyleForwardDiagonal: HatchStyle = HatchStyle(2);
pub const HatchStyleHorizontal: HatchStyle = HatchStyle(0);
pub const HatchStyleHorizontalBrick: HatchStyle = HatchStyle(39);
pub const HatchStyleLargeCheckerBoard: HatchStyle = HatchStyle(50);
pub const HatchStyleLargeConfetti: HatchStyle = HatchStyle(35);
pub const HatchStyleLargeGrid: HatchStyle = HatchStyle(4);
pub const HatchStyleLightDownwardDiagonal: HatchStyle = HatchStyle(18);
pub const HatchStyleLightHorizontal: HatchStyle = HatchStyle(25);
pub const HatchStyleLightUpwardDiagonal: HatchStyle = HatchStyle(19);
pub const HatchStyleLightVertical: HatchStyle = HatchStyle(24);
pub const HatchStyleMax: HatchStyle = HatchStyle(52);
pub const HatchStyleMin: HatchStyle = HatchStyle(0);
pub const HatchStyleNarrowHorizontal: HatchStyle = HatchStyle(27);
pub const HatchStyleNarrowVertical: HatchStyle = HatchStyle(26);
pub const HatchStyleOutlinedDiamond: HatchStyle = HatchStyle(51);
pub const HatchStylePlaid: HatchStyle = HatchStyle(41);
pub const HatchStyleShingle: HatchStyle = HatchStyle(45);
pub const HatchStyleSmallCheckerBoard: HatchStyle = HatchStyle(49);
pub const HatchStyleSmallConfetti: HatchStyle = HatchStyle(34);
pub const HatchStyleSmallGrid: HatchStyle = HatchStyle(48);
pub const HatchStyleSolidDiamond: HatchStyle = HatchStyle(52);
pub const HatchStyleSphere: HatchStyle = HatchStyle(47);
pub const HatchStyleTotal: HatchStyle = HatchStyle(53);
pub const HatchStyleTrellis: HatchStyle = HatchStyle(46);
pub const HatchStyleVertical: HatchStyle = HatchStyle(1);
pub const HatchStyleWave: HatchStyle = HatchStyle(37);
pub const HatchStyleWeave: HatchStyle = HatchStyle(40);
pub const HatchStyleWideDownwardDiagonal: HatchStyle = HatchStyle(22);
pub const HatchStyleWideUpwardDiagonal: HatchStyle = HatchStyle(23);
pub const HatchStyleZigZag: HatchStyle = HatchStyle(36);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct HistogramFormat(pub i32);
pub const HistogramFormatA: HistogramFormat = HistogramFormat(7);
pub const HistogramFormatARGB: HistogramFormat = HistogramFormat(0);
pub const HistogramFormatB: HistogramFormat = HistogramFormat(4);
pub const HistogramFormatG: HistogramFormat = HistogramFormat(5);
pub const HistogramFormatGray: HistogramFormat = HistogramFormat(3);
pub const HistogramFormatPARGB: HistogramFormat = HistogramFormat(1);
pub const HistogramFormatR: HistogramFormat = HistogramFormat(6);
pub const HistogramFormatRGB: HistogramFormat = HistogramFormat(2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct HotkeyPrefix(pub i32);
pub const HotkeyPrefixHide: HotkeyPrefix = HotkeyPrefix(2);
pub const HotkeyPrefixNone: HotkeyPrefix = HotkeyPrefix(0);
pub const HotkeyPrefixShow: HotkeyPrefix = HotkeyPrefix(1);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
impl IImageBytes {
    pub unsafe fn CountBytes(&self, pcb: *mut u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).CountBytes)(windows_core::Interface::as_raw(self), pcb as _) }
    }
    pub unsafe fn LockBytes(&self, cb: u32, uloffset: u32, ppvbytes: *const *const core::ffi::c_void) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).LockBytes)(windows_core::Interface::as_raw(self), cb, uloffset, ppvbytes) }
    }
    pub unsafe fn UnlockBytes(&self, pvbytes: *const core::ffi::c_void, cb: u32, uloffset: u32) -> windows_core::HRESULT {
        unsafe { (windows_core::Interface::vtable(self).UnlockBytes)(windows_core::Interface::as_raw(self), pvbytes, cb, uloffset) }
    }
}
#[repr(C)]
#[doc(hidden)]
...
pub const ImageCodecFlagsBlockingDecode: ImageCodecFlags = ImageCodecFlags(32);
pub const ImageCodecFlagsBuiltin: ImageCodecFlags = ImageCodecFlags(65536);
pub const ImageCodecFlagsDecoder: ImageCodecFlags = ImageCodecFlags(2);
pub const ImageCodecFlagsEncoder: ImageCodecFlags = ImageCodecFlags(1);
pub const ImageCodecFlagsSeekableEncode: ImageCodecFlags = ImageCodecFlags(16);
pub const ImageCodecFlagsSupportBitmap: ImageCodecFlags = ImageCodecFlags(4);
pub const ImageCodecFlagsSupportVector: ImageCodecFlags = ImageCodecFlags(8);
pub const ImageCodecFlagsSystem: ImageCodecFlags = ImageCodecFlags(131072);
pub const ImageCodecFlagsUser: ImageCodecFlags = ImageCodecFlags(262144);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const ImageFlagsCaching: ImageFlags = ImageFlags(131072);
pub const ImageFlagsColorSpaceCMYK: ImageFlags = ImageFlags(32);
pub const ImageFlagsColorSpaceGRAY: ImageFlags = ImageFlags(64);
pub const ImageFlagsColorSpaceRGB: ImageFlags = ImageFlags(16);
pub const ImageFlagsColorSpaceYCBCR: ImageFlags = ImageFlags(128);
pub const ImageFlagsColorSpaceYCCK: ImageFlags = ImageFlags(256);
pub const ImageFlagsHasAlpha: ImageFlags = ImageFlags(2);
pub const ImageFlagsHasRealDPI: ImageFlags = ImageFlags(4096);
pub const ImageFlagsHasRealPixelSize: ImageFlags = ImageFlags(8192);
pub const ImageFlagsHasTranslucent: ImageFlags = ImageFlags(4);
pub const ImageFlagsNone: ImageFlags = ImageFlags(0);
pub const ImageFlagsPartiallyScalable: ImageFlags = ImageFlags(8);
pub const ImageFlagsReadOnly: ImageFlags = ImageFlags(65536);
pub const ImageFlagsScalable: ImageFlags = ImageFlags(1);
...
pub const ImageLockModeRead: ImageLockMode = ImageLockMode(1);
pub const ImageLockModeUserInputBuf: ImageLockMode = ImageLockMode(4);
pub const ImageLockModeWrite: ImageLockMode = ImageLockMode(2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct ImageType(pub i32);
pub const ImageTypeBitmap: ImageType = ImageType(1);
pub const ImageTypeMetafile: ImageType = ImageType(2);
pub const ImageTypeUnknown: ImageType = ImageType(0);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Default)]
pub struct InstalledFontCollection(pub isize);
pub const InsufficientBuffer: Status = Status(5);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct InterpolationMode(pub i32);
pub const InterpolationModeBicubic: InterpolationMode = InterpolationMode(4);
pub const InterpolationModeBilinear: InterpolationMode = InterpolationMode(3);
pub const InterpolationModeDefault: InterpolationMode = InterpolationMode(0);
pub const InterpolationModeHighQuality: InterpolationMode = InterpolationMode(2);
pub const InterpolationModeHighQualityBicubic: InterpolationMode = InterpolationMode(7);
pub const InterpolationModeHighQualityBilinear: InterpolationMode = InterpolationMode(6);
pub const InterpolationModeInvalid: InterpolationMode = InterpolationMode(-1);
pub const InterpolationModeLowQuality: InterpolationMode = InterpolationMode(1);
pub const InterpolationModeNearestNeighbor: InterpolationMode = InterpolationMode(5);
pub const InvalidParameter: Status = Status(2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct ItemDataPosition(pub i32);
pub const ItemDataPositionAfterBits: ItemDataPosition = ItemDataPosition(2);
pub const ItemDataPositionAfterHeader: ItemDataPosition = ItemDataPosition(0);
pub const ItemDataPositionAfterPalette: ItemDataPosition = ItemDataPosition(1);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
pub struct Levels {
    pub Base: Effect,
...
pub const LineCapAnchorMask: LineCap = LineCap(240);
pub const LineCapArrowAnchor: LineCap = LineCap(20);
pub const LineCapCustom: LineCap = LineCap(255);
pub const LineCapDiamondAnchor: LineCap = LineCap(19);
pub const LineCapFlat: LineCap = LineCap(0);
pub const LineCapNoAnchor: LineCap = LineCap(16);
pub const LineCapRound: LineCap = LineCap(2);
pub const LineCapRoundAnchor: LineCap = LineCap(18);
pub const LineCapSquare: LineCap = LineCap(1);
pub const LineCapSquareAnchor: LineCap = LineCap(17);
pub const LineCapTriangle: LineCap = LineCap(3);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct LineJoin(pub i32);
pub const LineJoinBevel: LineJoin = LineJoin(1);
pub const LineJoinMiter: LineJoin = LineJoin(0);
pub const LineJoinMiterClipped: LineJoin = LineJoin(3);
pub const LineJoinRound: LineJoin = LineJoin(2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct LinearGradientMode(pub i32);
pub const LinearGradientModeBackwardDiagonal: LinearGradientMode = LinearGradientMode(3);
pub const LinearGradientModeForwardDiagonal: LinearGradientMode = LinearGradientMode(2);
pub const LinearGradientModeHorizontal: LinearGradientMode = LinearGradientMode(0);
pub const LinearGradientModeVertical: LinearGradientMode = LinearGradientMode(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Default)]
...
pub const MatrixOrderAppend: MatrixOrder = MatrixOrder(1);
pub const MatrixOrderPrepend: MatrixOrder = MatrixOrder(0);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Default)]
...
pub const MetafileFrameUnitDocument: MetafileFrameUnit = MetafileFrameUnit(5);
pub const MetafileFrameUnitGdi: MetafileFrameUnit = MetafileFrameUnit(7);
pub const MetafileFrameUnitInch: MetafileFrameUnit = MetafileFrameUnit(4);
pub const MetafileFrameUnitMillimeter: MetafileFrameUnit = MetafileFrameUnit(6);
pub const MetafileFrameUnitPixel: MetafileFrameUnit = MetafileFrameUnit(2);
pub const MetafileFrameUnitPoint: MetafileFrameUnit = MetafileFrameUnit(3);
#[repr(C)]
#[cfg(feature = "Win32_Graphics_Gdi")]
#[derive(Clone, Copy)]
...
pub const MetafileTypeEmf: MetafileType = MetafileType(3);
pub const MetafileTypeEmfPlusDual: MetafileType = MetafileType(5);
pub const MetafileTypeEmfPlusOnly: MetafileType = MetafileType(4);
pub const MetafileTypeInvalid: MetafileType = MetafileType(0);
pub const MetafileTypeWmf: MetafileType = MetafileType(1);
pub const MetafileTypeWmfPlaceable: MetafileType = MetafileType(2);
pub const NotImplemented: Status = Status(6);
pub const NotTrueTypeFont: Status = Status(16);
...
pub const ObjectBusy: Status = Status(4);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct ObjectType(pub i32);
pub const ObjectTypeBrush: ObjectType = ObjectType(1);
pub const ObjectTypeCustomLineCap: ObjectType = ObjectType(9);
pub const ObjectTypeFont: ObjectType = ObjectType(6);
pub const ObjectTypeGraphics: ObjectType = ObjectType(10);
pub const ObjectTypeImage: ObjectType = ObjectType(5);
pub const ObjectTypeImageAttributes: ObjectType = ObjectType(8);
pub const ObjectTypeInvalid: ObjectType = ObjectType(0);
pub const ObjectTypeMax: ObjectType = ObjectType(10);
pub const ObjectTypeMin: ObjectType = ObjectType(1);
pub const ObjectTypePath: ObjectType = ObjectType(3);
pub const ObjectTypePen: ObjectType = ObjectType(2);
pub const ObjectTypeRegion: ObjectType = ObjectType(4);
pub const ObjectTypeStringFormat: ObjectType = ObjectType(7);
pub const Ok: Status = Status(0);
pub const OutOfMemory: Status = Status(3);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const PaletteFlagsGrayScale: PaletteFlags = PaletteFlags(2);
pub const PaletteFlagsHalftone: PaletteFlags = PaletteFlags(4);
pub const PaletteFlagsHasAlpha: PaletteFlags = PaletteFlags(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct PaletteType(pub i32);
pub const PaletteTypeCustom: PaletteType = PaletteType(0);
pub const PaletteTypeFixedBW: PaletteType = PaletteType(2);
pub const PaletteTypeFixedHalftone125: PaletteType = PaletteType(6);
pub const PaletteTypeFixedHalftone216: PaletteType = PaletteType(7);
pub const PaletteTypeFixedHalftone252: PaletteType = PaletteType(8);
pub const PaletteTypeFixedHalftone256: PaletteType = PaletteType(9);
pub const PaletteTypeFixedHalftone27: PaletteType = PaletteType(4);
pub const PaletteTypeFixedHalftone64: PaletteType = PaletteType(5);
pub const PaletteTypeFixedHalftone8: PaletteType = PaletteType(3);
pub const PaletteTypeOptimal: PaletteType = PaletteType(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Default)]
...
pub const PathPointTypeBezier: PathPointType = PathPointType(3);
pub const PathPointTypeBezier3: PathPointType = PathPointType(3);
pub const PathPointTypeCloseSubpath: PathPointType = PathPointType(128);
pub const PathPointTypeDashMode: PathPointType = PathPointType(16);
pub const PathPointTypeLine: PathPointType = PathPointType(1);
pub const PathPointTypePathMarker: PathPointType = PathPointType(32);
pub const PathPointTypePathTypeMask: PathPointType = PathPointType(7);
pub const PathPointTypeStart: PathPointType = PathPointType(0);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct PenAlignment(pub i32);
pub const PenAlignmentCenter: PenAlignment = PenAlignment(0);
pub const PenAlignmentInset: PenAlignment = PenAlignment(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct PenType(pub i32);
pub const PenTypeHatchFill: PenType = PenType(1);
pub const PenTypeLinearGradient: PenType = PenType(4);
pub const PenTypePathGradient: PenType = PenType(3);
pub const PenTypeSolidColor: PenType = PenType(0);
pub const PenTypeTextureFill: PenType = PenType(2);
pub const PenTypeUnknown: PenType = PenType(-1);
...
pub const PixelOffsetModeDefault: PixelOffsetMode = PixelOffsetMode(0);
pub const PixelOffsetModeHalf: PixelOffsetMode = PixelOffsetMode(4);
pub const PixelOffsetModeHighQuality: PixelOffsetMode = PixelOffsetMode(2);
pub const PixelOffsetModeHighSpeed: PixelOffsetMode = PixelOffsetMode(1);
pub const PixelOffsetModeInvalid: PixelOffsetMode = PixelOffsetMode(-1);
pub const PixelOffsetModeNone: PixelOffsetMode = PixelOffsetMode(3);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
pub struct Point {
    pub X: i32,
...
pub const ProfileNotFound: Status = Status(21);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const PropertyNotFound: Status = Status(19);
pub const PropertyNotSupported: Status = Status(20);
...
pub const QualityModeDefault: QualityMode = QualityMode(0);
pub const QualityModeHigh: QualityMode = QualityMode(2);
pub const QualityModeInvalid: QualityMode = QualityMode(-1);
pub const QualityModeLow: QualityMode = QualityMode(1);
...
pub const Rotate180FlipNone: RotateFlipType = RotateFlipType(2);
pub const Rotate180FlipX: RotateFlipType = RotateFlipType(6);
pub const Rotate180FlipXY: RotateFlipType = RotateFlipType(0);
pub const Rotate180FlipY: RotateFlipType = RotateFlipType(4);
pub const Rotate270FlipNone: RotateFlipType = RotateFlipType(3);
pub const Rotate270FlipX: RotateFlipType = RotateFlipType(7);
pub const Rotate270FlipXY: RotateFlipType = RotateFlipType(1);
pub const Rotate270FlipY: RotateFlipType = RotateFlipType(5);
pub const Rotate90FlipNone: RotateFlipType = RotateFlipType(1);
pub const Rotate90FlipX: RotateFlipType = RotateFlipType(5);
pub const Rotate90FlipXY: RotateFlipType = RotateFlipType(3);
pub const Rotate90FlipY: RotateFlipType = RotateFlipType(7);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct RotateFlipType(pub i32);
pub const RotateNoneFlipNone: RotateFlipType = RotateFlipType(0);
pub const RotateNoneFlipX: RotateFlipType = RotateFlipType(4);
pub const RotateNoneFlipXY: RotateFlipType = RotateFlipType(2);
pub const RotateNoneFlipY: RotateFlipType = RotateFlipType(6);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
pub struct Sharpen {
    pub Base: Effect,
...
pub const SmoothingModeAntiAlias8x4: SmoothingMode = SmoothingMode(4);
pub const SmoothingModeAntiAlias8x8: SmoothingMode = SmoothingMode(5);
pub const SmoothingModeDefault: SmoothingMode = SmoothingMode(0);
pub const SmoothingModeHighQuality: SmoothingMode = SmoothingMode(2);
pub const SmoothingModeHighSpeed: SmoothingMode = SmoothingMode(1);
pub const SmoothingModeInvalid: SmoothingMode = SmoothingMode(-1);
...
pub const StringAlignmentCenter: StringAlignment = StringAlignment(1);
pub const StringAlignmentFar: StringAlignment = StringAlignment(2);
pub const StringAlignmentNear: StringAlignment = StringAlignment(0);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct StringDigitSubstitute(pub i32);
pub const StringDigitSubstituteNational: StringDigitSubstitute = StringDigitSubstitute(2);
pub const StringDigitSubstituteNone: StringDigitSubstitute = StringDigitSubstitute(1);
pub const StringDigitSubstituteTraditional: StringDigitSubstitute = StringDigitSubstitute(3);
pub const StringDigitSubstituteUser: StringDigitSubstitute = StringDigitSubstitute(0);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct StringFormatFlags(pub i32);
pub const StringFormatFlagsBypassGDI: StringFormatFlags = StringFormatFlags(-2147483648);
pub const StringFormatFlagsDirectionRightToLeft: StringFormatFlags = StringFormatFlags(1);
pub const StringFormatFlagsDirectionVertical: StringFormatFlags = StringFormatFlags(2);
pub const StringFormatFlagsDisplayFormatControl: StringFormatFlags = StringFormatFlags(32);
pub const StringFormatFlagsLineLimit: StringFormatFlags = StringFormatFlags(8192);
pub const StringFormatFlagsMeasureTrailingSpaces: StringFormatFlags = StringFormatFlags(2048);
pub const StringFormatFlagsNoClip: StringFormatFlags = StringFormatFlags(16384);
pub const StringFormatFlagsNoFitBlackBox: StringFormatFlags = StringFormatFlags(4);
pub const StringFormatFlagsNoFontFallback: StringFormatFlags = StringFormatFlags(1024);
pub const StringFormatFlagsNoWrap: StringFormatFlags = StringFormatFlags(4096);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct StringTrimming(pub i32);
pub const StringTrimmingCharacter: StringTrimming = StringTrimming(1);
pub const StringTrimmingEllipsisCharacter: StringTrimming = StringTrimming(3);
pub const StringTrimmingEllipsisPath: StringTrimming = StringTrimming(5);
pub const StringTrimmingEllipsisWord: StringTrimming = StringTrimming(4);
pub const StringTrimmingNone: StringTrimming = StringTrimming(0);
pub const StringTrimmingWord: StringTrimming = StringTrimming(2);
pub const TestControlForceBilinear: GpTestControlEnum = GpTestControlEnum(0);
pub const TestControlGetBuildNumber: GpTestControlEnum = GpTestControlEnum(2);
pub const TestControlNoICM: GpTestControlEnum = GpTestControlEnum(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct TextRenderingHint(pub i32);
pub const TextRenderingHintAntiAlias: TextRenderingHint = TextRenderingHint(4);
pub const TextRenderingHintAntiAliasGridFit: TextRenderingHint = TextRenderingHint(3);
pub const TextRenderingHintClearTypeGridFit: TextRenderingHint = TextRenderingHint(5);
pub const TextRenderingHintSingleBitPerPixel: TextRenderingHint = TextRenderingHint(2);
pub const TextRenderingHintSingleBitPerPixelGridFit: TextRenderingHint = TextRenderingHint(1);
pub const TextRenderingHintSystemDefault: TextRenderingHint = TextRenderingHint(0);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
pub struct Tint {
    pub Base: Effect,
...
pub const UnitDisplay: Unit = Unit(1);
pub const UnitDocument: Unit = Unit(5);
pub const UnitInch: Unit = Unit(4);
pub const UnitMillimeter: Unit = Unit(6);
pub const UnitPixel: Unit = Unit(2);
pub const UnitPoint: Unit = Unit(3);
pub const UnitWorld: Unit = Unit(0);
pub const UnknownImageFormat: Status = Status(13);
pub const UnsupportedGdiplusVersion: Status = Status(17);
pub const ValueOverflow: Status = Status(11);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const WarpModeBilinear: WarpMode = WarpMode(1);
pub const WarpModePerspective: WarpMode = WarpMode(0);
pub const Win32Error: Status = Status(7);
#[repr(C, packed(2))]
...
pub const WmfRecordTypeAbortDoc: EmfPlusRecordType = EmfPlusRecordType(65618);
pub const WmfRecordTypeAnimatePalette: EmfPlusRecordType = EmfPlusRecordType(66614);
pub const WmfRecordTypeArc: EmfPlusRecordType = EmfPlusRecordType(67607);
pub const WmfRecordTypeBitBlt: EmfPlusRecordType = EmfPlusRecordType(67874);
pub const WmfRecordTypeChord: EmfPlusRecordType = EmfPlusRecordType(67632);
pub const WmfRecordTypeCreateBitmap: EmfPlusRecordType = EmfPlusRecordType(67326);
pub const WmfRecordTypeCreateBitmapIndirect: EmfPlusRecordType = EmfPlusRecordType(66301);
pub const WmfRecordTypeCreateBrush: EmfPlusRecordType = EmfPlusRecordType(65784);
pub const WmfRecordTypeCreateBrushIndirect: EmfPlusRecordType = EmfPlusRecordType(66300);
pub const WmfRecordTypeCreateFontIndirect: EmfPlusRecordType = EmfPlusRecordType(66299);
pub const WmfRecordTypeCreatePalette: EmfPlusRecordType = EmfPlusRecordType(65783);
pub const WmfRecordTypeCreatePatternBrush: EmfPlusRecordType = EmfPlusRecordType(66041);
pub const WmfRecordTypeCreatePenIndirect: EmfPlusRecordType = EmfPlusRecordType(66298);
pub const WmfRecordTypeCreateRegion: EmfPlusRecordType = EmfPlusRecordType(67327);
pub const WmfRecordTypeDIBBitBlt: EmfPlusRecordType = EmfPlusRecordType(67904);
pub const WmfRecordTypeDIBCreatePatternBrush: EmfPlusRecordType = EmfPlusRecordType(65858);
pub const WmfRecordTypeDIBStretchBlt: EmfPlusRecordType = EmfPlusRecordType(68417);
pub const WmfRecordTypeDeleteObject: EmfPlusRecordType = EmfPlusRecordType(66032);
pub const WmfRecordTypeDrawText: EmfPlusRecordType = EmfPlusRecordType(67119);
pub const WmfRecordTypeEllipse: EmfPlusRecordType = EmfPlusRecordType(66584);
pub const WmfRecordTypeEndDoc: EmfPlusRecordType = EmfPlusRecordType(65630);
pub const WmfRecordTypeEndPage: EmfPlusRecordType = EmfPlusRecordType(65616);
pub const WmfRecordTypeEscape: EmfPlusRecordType = EmfPlusRecordType(67110);
pub const WmfRecordTypeExcludeClipRect: EmfPlusRecordType = EmfPlusRecordType(66581);
pub const WmfRecordTypeExtFloodFill: EmfPlusRecordType = EmfPlusRecordType(66888);
pub const WmfRecordTypeExtTextOut: EmfPlusRecordType = EmfPlusRecordType(68146);
pub const WmfRecordTypeFillRegion: EmfPlusRecordType = EmfPlusRecordType(66088);
pub const WmfRecordTypeFloodFill: EmfPlusRecordType = EmfPlusRecordType(66585);
pub const WmfRecordTypeFrameRegion: EmfPlusRecordType = EmfPlusRecordType(66601);
pub const WmfRecordTypeIntersectClipRect: EmfPlusRecordType = EmfPlusRecordType(66582);
pub const WmfRecordTypeInvertRegion: EmfPlusRecordType = EmfPlusRecordType(65834);
pub const WmfRecordTypeLineTo: EmfPlusRecordType = EmfPlusRecordType(66067);
pub const WmfRecordTypeMoveTo: EmfPlusRecordType = EmfPlusRecordType(66068);
pub const WmfRecordTypeOffsetClipRgn: EmfPlusRecordType = EmfPlusRecordType(66080);
pub const WmfRecordTypeOffsetViewportOrg: EmfPlusRecordType = EmfPlusRecordType(66065);
pub const WmfRecordTypeOffsetWindowOrg: EmfPlusRecordType = EmfPlusRecordType(66063);
pub const WmfRecordTypePaintRegion: EmfPlusRecordType = EmfPlusRecordType(65835);
pub const WmfRecordTypePatBlt: EmfPlusRecordType = EmfPlusRecordType(67101);
pub const WmfRecordTypePie: EmfPlusRecordType = EmfPlusRecordType(67610);
pub const WmfRecordTypePolyPolygon: EmfPlusRecordType = EmfPlusRecordType(66872);
pub const WmfRecordTypePolygon: EmfPlusRecordType = EmfPlusRecordType(66340);
pub const WmfRecordTypePolyline: EmfPlusRecordType = EmfPlusRecordType(66341);
pub const WmfRecordTypeRealizePalette: EmfPlusRecordType = EmfPlusRecordType(65589);
pub const WmfRecordTypeRectangle: EmfPlusRecordType = EmfPlusRecordType(66587);
pub const WmfRecordTypeResetDC: EmfPlusRecordType = EmfPlusRecordType(65868);
pub const WmfRecordTypeResizePalette: EmfPlusRecordType = EmfPlusRecordType(65849);
pub const WmfRecordTypeRestoreDC: EmfPlusRecordType = EmfPlusRecordType(65831);
pub const WmfRecordTypeRoundRect: EmfPlusRecordType = EmfPlusRecordType(67100);
pub const WmfRecordTypeSaveDC: EmfPlusRecordType = EmfPlusRecordType(65566);
pub const WmfRecordTypeScaleViewportExt: EmfPlusRecordType = EmfPlusRecordType(66578);
pub const WmfRecordTypeScaleWindowExt: EmfPlusRecordType = EmfPlusRecordType(66576);
pub const WmfRecordTypeSelectClipRegion: EmfPlusRecordType = EmfPlusRecordType(65836);
pub const WmfRecordTypeSelectObject: EmfPlusRecordType = EmfPlusRecordType(65837);
pub const WmfRecordTypeSelectPalette: EmfPlusRecordType = EmfPlusRecordType(66100);
pub const WmfRecordTypeSetBkColor: EmfPlusRecordType = EmfPlusRecordType(66049);
pub const WmfRecordTypeSetBkMode: EmfPlusRecordType = EmfPlusRecordType(65794);
pub const WmfRecordTypeSetDIBToDev: EmfPlusRecordType = EmfPlusRecordType(68915);
pub const WmfRecordTypeSetLayout: EmfPlusRecordType = EmfPlusRecordType(65865);
pub const WmfRecordTypeSetMapMode: EmfPlusRecordType = EmfPlusRecordType(65795);
pub const WmfRecordTypeSetMapperFlags: EmfPlusRecordType = EmfPlusRecordType(66097);
pub const WmfRecordTypeSetPalEntries: EmfPlusRecordType = EmfPlusRecordType(65591);
pub const WmfRecordTypeSetPixel: EmfPlusRecordType = EmfPlusRecordType(66591);
pub const WmfRecordTypeSetPolyFillMode: EmfPlusRecordType = EmfPlusRecordType(65798);
pub const WmfRecordTypeSetROP2: EmfPlusRecordType = EmfPlusRecordType(65796);
pub const WmfRecordTypeSetRelAbs: EmfPlusRecordType = EmfPlusRecordType(65797);
pub const WmfRecordTypeSetStretchBltMode: EmfPlusRecordType = EmfPlusRecordType(65799);
pub const WmfRecordTypeSetTextAlign: EmfPlusRecordType = EmfPlusRecordType(65838);
pub const WmfRecordTypeSetTextCharExtra: EmfPlusRecordType = EmfPlusRecordType(65800);
pub const WmfRecordTypeSetTextColor: EmfPlusRecordType = EmfPlusRecordType(66057);
pub const WmfRecordTypeSetTextJustification: EmfPlusRecordType = EmfPlusRecordType(66058);
pub const WmfRecordTypeSetViewportExt: EmfPlusRecordType = EmfPlusRecordType(66062);
pub const WmfRecordTypeSetViewportOrg: EmfPlusRecordType = EmfPlusRecordType(66061);
pub const WmfRecordTypeSetWindowExt: EmfPlusRecordType = EmfPlusRecordType(66060);
pub const WmfRecordTypeSetWindowOrg: EmfPlusRecordType = EmfPlusRecordType(66059);
pub const WmfRecordTypeStartDoc: EmfPlusRecordType = EmfPlusRecordType(65869);
pub const WmfRecordTypeStartPage: EmfPlusRecordType = EmfPlusRecordType(65615);
pub const WmfRecordTypeStretchBlt: EmfPlusRecordType = EmfPlusRecordType(68387);
pub const WmfRecordTypeStretchDIB: EmfPlusRecordType = EmfPlusRecordType(69443);
pub const WmfRecordTypeTextOut: EmfPlusRecordType = EmfPlusRecordType(66849);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct WrapMode(pub i32);
pub const WrapModeClamp: WrapMode = WrapMode(4);
pub const WrapModeTile: WrapMode = WrapMode(0);
pub const WrapModeTileFlipX: WrapMode = WrapMode(1);
pub const WrapModeTileFlipXY: WrapMode = WrapMode(3);
pub const WrapModeTileFlipY: WrapMode = WrapMode(2);
pub const WrongState: Status = Status(8);
