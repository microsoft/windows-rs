...
impl ID3D11On12Device1Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ID3D11On12Device1Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> ID3D11On12Device1Vtbl {
        ...
        Self { base: ID3D11On12DeviceVtbl::new::<Identity, Impl, BASE_OFFSET, IMPL_OFFSET>(), GetD3D12Device: GetD3D12Device::<Impl, IMPL_OFFSET> }
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
#[cfg(all(feature = "Win32_Graphics_Direct3D11", feature = "Win32_Graphics_Direct3D12"))]
pub trait ID3D11On12Device2Impl: Sized + ID3D11On12DeviceImpl + ID3D11On12Device1Impl {
...
impl ID3D11On12Device2Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ID3D11On12Device2Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> ID3D11On12Device2Vtbl {
        ...
        Self {
            base: ID3D11On12Device1Vtbl::new::<Identity, Impl, BASE_OFFSET, IMPL_OFFSET>(),
