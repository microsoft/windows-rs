...
impl ID3D11On12DeviceVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ID3D11On12DeviceImpl, const OFFSET: isize>() -> ID3D11On12DeviceVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<ID3D11On12Device>, ::windows::core::GetTrustLevel, CreateWrappedResource::<Impl, OFFSET>, ReleaseWrappedResources::<Impl, OFFSET>, AcquireWrappedResources::<Impl, OFFSET>)
    }
}
...
impl ID3D11On12Device1Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ID3D11On12Device1Impl, const OFFSET: isize>() -> ID3D11On12Device1Vtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<ID3D11On12Device1>, ::windows::core::GetTrustLevel, GetD3D12Device::<Impl, OFFSET>)
    }
}
...
impl ID3D11On12Device2Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ID3D11On12Device2Impl, const OFFSET: isize>() -> ID3D11On12Device2Vtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<ID3D11On12Device2>, ::windows::core::GetTrustLevel, UnwrapUnderlyingResource::<Impl, OFFSET>, ReturnUnderlyingResource::<Impl, OFFSET>)
    }
}
