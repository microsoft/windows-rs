...
#[inline]
pub unsafe fn D3D11On12CreateDevice<'a, Param0: ::windows::core::IntoParam<'a, ::windows::core::IUnknown>>(pdevice: Param0, flags: u32, pfeaturelevels: ::core::option::Option<&[super::Direct3D::D3D_FEATURE_LEVEL]>, ppcommandqueues: ::core::option::Option<&[::core::option::Option<::windows::core::IUnknown>]>, nodemask: u32, ppdevice: *mut ::core::option::Option<super::Direct3D11::ID3D11Device>, ppimmediatecontext: *mut ::core::option::Option<super::Direct3D11::ID3D11DeviceContext>, pchosenfeaturelevel: *mut super::Direct3D::D3D_FEATURE_LEVEL) -> ::windows::core::Result<()> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
        ...
        D3D11On12CreateDevice(
            ...
            ::core::mem::transmute(pfeaturelevels.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())),
            pfeaturelevels.as_ref().map_or(0, |value| value.len()) as _,
            ::core::mem::transmute(ppcommandqueues.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())),
            ppcommandqueues.as_ref().map_or(0, |value| value.len()) as _,
...
impl ID3D11On12Device {
    ...
    pub unsafe fn ReleaseWrappedResources(&self, ppresources: &[::core::option::Option<super::Direct3D11::ID3D11Resource>]) {
        (::windows::core::Interface::vtable(self).ReleaseWrappedResources)(::core::mem::transmute_copy(self), ::core::mem::transmute(ppresources.as_ptr()), ppresources.len() as _)
    }
    #[doc = "*Required features: 'Win32_Graphics_Direct3D11on12', 'Win32_Graphics_Direct3D11'*"]
    #[cfg(feature = "Win32_Graphics_Direct3D11")]
    pub unsafe fn AcquireWrappedResources(&self, ppresources: &[::core::option::Option<super::Direct3D11::ID3D11Resource>]) {
        (::windows::core::Interface::vtable(self).AcquireWrappedResources)(::core::mem::transmute_copy(self), ::core::mem::transmute(ppresources.as_ptr()), ppresources.len() as _)
    }
}
...
impl ID3D11On12Device1 {
    ...
    #[cfg(feature = "Win32_Graphics_Direct3D11")]
    pub unsafe fn ReleaseWrappedResources(&self, ppresources: &[::core::option::Option<super::Direct3D11::ID3D11Resource>]) {
        (::windows::core::Interface::vtable(self).base.ReleaseWrappedResources)(::core::mem::transmute_copy(self), ::core::mem::transmute(ppresources.as_ptr()), ppresources.len() as _)
    }
    #[doc = "*Required features: 'Win32_Graphics_Direct3D11on12', 'Win32_Graphics_Direct3D11'*"]
    #[cfg(feature = "Win32_Graphics_Direct3D11")]
    pub unsafe fn AcquireWrappedResources(&self, ppresources: &[::core::option::Option<super::Direct3D11::ID3D11Resource>]) {
        (::windows::core::Interface::vtable(self).base.AcquireWrappedResources)(::core::mem::transmute_copy(self), ::core::mem::transmute(ppresources.as_ptr()), ppresources.len() as _)
    }
    #[doc = "*Required features: 'Win32_Graphics_Direct3D11on12'*"]
...
impl ID3D11On12Device2 {
    ...
    #[cfg(feature = "Win32_Graphics_Direct3D11")]
    pub unsafe fn ReleaseWrappedResources(&self, ppresources: &[::core::option::Option<super::Direct3D11::ID3D11Resource>]) {
        (::windows::core::Interface::vtable(self).base.base.ReleaseWrappedResources)(::core::mem::transmute_copy(self), ::core::mem::transmute(ppresources.as_ptr()), ppresources.len() as _)
    }
    #[doc = "*Required features: 'Win32_Graphics_Direct3D11on12', 'Win32_Graphics_Direct3D11'*"]
    #[cfg(feature = "Win32_Graphics_Direct3D11")]
    pub unsafe fn AcquireWrappedResources(&self, ppresources: &[::core::option::Option<super::Direct3D11::ID3D11Resource>]) {
        (::windows::core::Interface::vtable(self).base.base.AcquireWrappedResources)(::core::mem::transmute_copy(self), ::core::mem::transmute(ppresources.as_ptr()), ppresources.len() as _)
    }
    #[doc = "*Required features: 'Win32_Graphics_Direct3D11on12'*"]
    pub unsafe fn GetD3D12Device<T: ::windows::core::Interface>(&self) -> ::windows::core::Result<T> {
        let mut result__ = ::core::option::Option::None;
    ...
    pub unsafe fn ReturnUnderlyingResource<'a, Param0: ::windows::core::IntoParam<'a, super::Direct3D11::ID3D11Resource>, const PARAM1: usize>(&self, presource11: Param0, psignalvalues: &[u64; PARAM1], ppfences: &[::core::option::Option<super::Direct3D12::ID3D12Fence>; PARAM1]) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).ReturnUnderlyingResource)(::core::mem::transmute_copy(self), presource11.into_param().abi(), PARAM1 as _, ::core::mem::transmute(psignalvalues.as_ptr()), ::core::mem::transmute(ppfences.as_ptr())).ok()
    }
}
