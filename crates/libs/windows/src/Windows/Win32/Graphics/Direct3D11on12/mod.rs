    ...
    P0: windows_core::Param<windows_core::IUnknown>,
{
    ...
    unsafe {
        D3D11On12CreateDevice(
            core::mem::transmute_copy(&pdevice.param().borrow()),
            flags,
...
impl ID3D11On12Device {
    ...
    {
        unsafe { (windows_core::Interface::vtable(self).CreateWrappedResource)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(&presource12.param().borrow()), pflags11, instate, outstate, &T::IID, result__ as *mut _ as *mut _).ok() }
    }
    ...
    pub const fn new<Identity: ID3D11On12Device_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateWrappedResource<Identity: ID3D11On12Device_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, presource12: *mut core::ffi::c_void, pflags11: *const D3D11_RESOURCE_FLAGS, instate: super::Direct3D12::D3D12_RESOURCE_STATES, outstate: super::Direct3D12::D3D12_RESOURCE_STATES, riid: *const windows_core::GUID, ppresource11: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                ...
                ID3D11On12Device_Impl::CreateWrappedResource(this, windows_core::Ref::option_from_abi(&presource12), core::mem::transmute_copy(&pflags11), core::mem::transmute_copy(&instate), core::mem::transmute_copy(&outstate), core::mem::transmute_copy(&riid), core::mem::transmute_copy(&ppresource11)).into()
            }
        }
...
impl ID3D11On12Device2 {
    ...
    {
        let mut result__ = core::ptr::null_mut();
        unsafe { (windows_core::Interface::vtable(self).UnwrapUnderlyingResource)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(&presource11.param().borrow()), core::mem::transmute_copy(&pcommandqueue.param().borrow()), &T::IID, &mut result__).and_then(|| windows_core::Type::from_abi(result__)) }
    }
    #[cfg(all(feature = "Win32_Graphics_Direct3D11", feature = "Win32_Graphics_Direct3D12"))]
    ...
    where
        P0: windows_core::Param<super::Direct3D11::ID3D11Resource>,
    {
        unsafe { (windows_core::Interface::vtable(self).ReturnUnderlyingResource)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(&presource11.param().borrow()), numsync, psignalvalues, core::mem::transmute(ppfences)).ok() }
    }
}
#[repr(C)]
#[doc(hidden)]
...
impl ID3D11On12Device2_Vtbl {
    pub const fn new<Identity: ID3D11On12Device2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn UnwrapUnderlyingResource<Identity: ID3D11On12Device2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, presource11: *mut core::ffi::c_void, pcommandqueue: *mut core::ffi::c_void, riid: *const windows_core::GUID, ppvresource12: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ID3D11On12Device2_Impl::UnwrapUnderlyingResource(this, windows_core::Ref::option_from_abi(&presource11), windows_core::Ref::option_from_abi(&pcommandqueue), core::mem::transmute_copy(&riid), core::mem::transmute_copy(&ppvresource12)).into()
            }
        }
        unsafe extern "system" fn ReturnUnderlyingResource<Identity: ID3D11On12Device2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, presource11: *mut core::ffi::c_void, numsync: u32, psignalvalues: *const u64, ppfences: *const *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ID3D11On12Device2_Impl::ReturnUnderlyingResource(this, windows_core::Ref::option_from_abi(&presource11), core::mem::transmute_copy(&numsync), core::mem::transmute_copy(&psignalvalues), core::mem::transmute_copy(&ppfences)).into()
            }
        }
        Self {
