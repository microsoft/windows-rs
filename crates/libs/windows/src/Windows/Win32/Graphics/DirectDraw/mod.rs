...
impl IDirectDrawSurface {
    ...
    {
        (windows_core::Interface::vtable(self).Blt)(windows_core::Interface::as_raw(self), param0, param1.param().abi(), param2, param3, core::mem::transmute(param4)).ok()
    }
    ...
    where
        P1: windows_core::Param<IDirectDrawSurface>,
    {
        (windows_core::Interface::vtable(self).UpdateOverlay)(windows_core::Interface::as_raw(self), param0, param1.param().abi(), param2, param3, core::mem::transmute(param4)).ok()
    }
...
pub struct DDBLTFX {
    ...
    pub Anonymous1: core::mem::ManuallyDrop<DDBLTFX_0>,
    pub dwZSrcConstBitDepth: u32,
    pub Anonymous2: core::mem::ManuallyDrop<DDBLTFX_1>,
    pub dwAlphaEdgeBlendBitDepth: u32,
    pub dwAlphaEdgeBlend: u32,
    pub dwReserved: u32,
    pub dwAlphaDestConstBitDepth: u32,
    pub Anonymous3: core::mem::ManuallyDrop<DDBLTFX_2>,
    pub dwAlphaSrcConstBitDepth: u32,
    pub Anonymous4: core::mem::ManuallyDrop<DDBLTFX_3>,
    pub Anonymous5: core::mem::ManuallyDrop<DDBLTFX_4>,
...
pub struct DDHAL_BLTDATA {
    ...
    pub dwFlags: u32,
    pub dwROPFlags: u32,
    pub bltFX: core::mem::ManuallyDrop<DDBLTFX>,
    pub ddRVal: windows_core::HRESULT,
...
pub struct DDHAL_UPDATEOVERLAYDATA {
    ...
    pub rSrc: super::super::Foundation::RECTL,
    pub dwFlags: u32,
    pub overlayFX: core::mem::ManuallyDrop<DDOVERLAYFX>,
    pub ddRVal: windows_core::HRESULT,
    pub UpdateOverlay: LPDDHALSURFCB_UPDATEOVERLAY,
}
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub struct DDOVERLAYFX {
    ...
    pub dwReserved: u32,
    pub dwAlphaDestConstBitDepth: u32,
    pub Anonymous1: core::mem::ManuallyDrop<DDOVERLAYFX_0>,
    pub dwAlphaSrcConstBitDepth: u32,
    pub Anonymous2: core::mem::ManuallyDrop<DDOVERLAYFX_1>,
