#[inline]
pub unsafe fn DirectDrawCreate<P2>(lpguid: *mut windows_core::GUID, lplpdd: *mut Option<IDirectDraw>, punkouter: P2) -> Result<(), windows_result::HRESULT>
where
...
#[inline]
pub unsafe fn DirectDrawCreateClipper<P2>(dwflags: u32, lplpddclipper: *mut Option<IDirectDrawClipper>, punkouter: P2) -> Result<(), windows_result::HRESULT>
where
    P2: windows_core::Param<windows_core::IUnknown>,
{
...
#[inline]
pub unsafe fn DirectDrawCreateEx<P3>(lpguid: *mut windows_core::GUID, lplpdd: *mut *mut core::ffi::c_void, iid: *const windows_core::GUID, punkouter: P3) -> Result<(), windows_result::HRESULT>
where
...
#[inline]
pub unsafe fn DirectDrawEnumerateA(lpcallback: LPDDENUMCALLBACKA, lpcontext: *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DirectDrawEnumerateExA(lpcallback: LPDDENUMCALLBACKEXA, lpcontext: *mut core::ffi::c_void, dwflags: u32) -> Result<(), windows_result::HRESULT> {
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn DirectDrawEnumerateExW(lpcallback: LPDDENUMCALLBACKEXW, lpcontext: *mut core::ffi::c_void, dwflags: u32) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DirectDrawEnumerateW(lpcallback: LPDDENUMCALLBACKW, lpcontext: *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
...
impl IDDVideoPortContainer {
    pub unsafe fn CreateVideoPort<P3>(&self, param0: u32, param1: *mut DDVIDEOPORTDESC, param2: *mut Option<IDirectDrawVideoPort>, param3: P3) -> Result<(), windows_result::HRESULT>
    where
        P3: windows_core::Param<windows_core::IUnknown>,
    {
    ...
    pub unsafe fn EnumVideoPorts(&self, param0: u32, param1: *mut DDVIDEOPORTCAPS, param2: *mut core::ffi::c_void, param3: LPDDENUMVIDEOCALLBACK) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetVideoPortConnectInfo(&self, param0: u32, pcinfo: *mut u32, param2: Option<*mut DDVIDEOPORTCONNECT>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn QueryVideoPortStatus(&self, param0: u32, param1: *mut DDVIDEOPORTSTATUS) -> Result<(), windows_result::HRESULT> {
...
pub trait IDDVideoPortContainer_Impl: windows_core::IUnknownImpl {
    fn CreateVideoPort(&self, param0: u32, param1: *mut DDVIDEOPORTDESC, param2: windows_core::OutRef<'_, IDirectDrawVideoPort>, param3: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn EnumVideoPorts(&self, param0: u32, param1: *mut DDVIDEOPORTCAPS, param2: *mut core::ffi::c_void, param3: LPDDENUMVIDEOCALLBACK) -> Result<(), windows_result::HRESULT>;
    fn GetVideoPortConnectInfo(&self, param0: u32, pcinfo: *mut u32, param2: *mut DDVIDEOPORTCONNECT) -> Result<(), windows_result::HRESULT>;
    fn QueryVideoPortStatus(&self, param0: u32, param1: *mut DDVIDEOPORTSTATUS) -> Result<(), windows_result::HRESULT>;
}
...
impl IDirectDraw {
    ...
    pub unsafe fn CreateClipper<P2>(&self, param0: u32, param1: *mut Option<IDirectDrawClipper>, param2: P2) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<windows_core::IUnknown>,
    {
    ...
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn CreatePalette<P3>(&self, param0: u32, param1: *mut super::Gdi::PALETTEENTRY, param2: *mut Option<IDirectDrawPalette>, param3: P3) -> Result<(), windows_result::HRESULT>
    where
        P3: windows_core::Param<windows_core::IUnknown>,
    {
    ...
    pub unsafe fn CreateSurface<P2>(&self, param0: *mut DDSURFACEDESC, param1: *mut Option<IDirectDrawSurface>, param2: P2) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<windows_core::IUnknown>,
    {
    ...
    pub unsafe fn DuplicateSurface<P0>(&self, param0: P0) -> Result<IDirectDrawSurface, windows_result::HRESULT>
    where
    ...
    pub unsafe fn EnumDisplayModes(&self, param0: u32, param1: *mut DDSURFACEDESC, param2: *mut core::ffi::c_void, param3: LPDDENUMMODESCALLBACK) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn EnumSurfaces(&self, param0: u32, param1: *mut DDSURFACEDESC, param2: *mut core::ffi::c_void, param3: LPDDENUMSURFACESCALLBACK) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetDisplayMode(&self, param0: u32, param1: u32, param2: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetDisplayMode)(windows_core::Interface::as_raw(self), param0, param1, param2).ok() }
    }
    pub unsafe fn WaitForVerticalBlank(&self, param0: u32, param1: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT> {
...
pub trait IDirectDraw_Impl: windows_core::IUnknownImpl {
    ...
    fn CreateClipper(&self, param0: u32, param1: windows_core::OutRef<'_, IDirectDrawClipper>, param2: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn CreatePalette(&self, param0: u32, param1: *mut super::Gdi::PALETTEENTRY, param2: windows_core::OutRef<'_, IDirectDrawPalette>, param3: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn CreateSurface(&self, param0: *mut DDSURFACEDESC, param1: windows_core::OutRef<'_, IDirectDrawSurface>, param2: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn DuplicateSurface(&self, param0: windows_core::Ref<'_, IDirectDrawSurface>) -> Result<IDirectDrawSurface, windows_result::HRESULT>;
    fn EnumDisplayModes(&self, param0: u32, param1: *mut DDSURFACEDESC, param2: *mut core::ffi::c_void, param3: LPDDENUMMODESCALLBACK) -> Result<(), windows_result::HRESULT>;
    fn EnumSurfaces(&self, param0: u32, param1: *mut DDSURFACEDESC, param2: *mut core::ffi::c_void, param3: LPDDENUMSURFACESCALLBACK) -> Result<(), windows_result::HRESULT>;
    fn FlipToGDISurface(&self) -> Result<(), windows_result::HRESULT>;
    fn GetCaps(&self, param0: *mut DDCAPS_DX7, param1: *mut DDCAPS_DX7) -> Result<(), windows_result::HRESULT>;
    fn GetDisplayMode(&self, param0: *mut DDSURFACEDESC) -> Result<(), windows_result::HRESULT>;
    fn GetFourCCCodes(&self, param0: *mut u32, param1: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetGDISurface(&self) -> Result<IDirectDrawSurface, windows_result::HRESULT>;
    fn GetMonitorFrequency(&self, param0: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetScanLine(&self, param0: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetVerticalBlankStatus(&self, param0: *mut windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn Initialize(&self, param0: *mut windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn RestoreDisplayMode(&self) -> Result<(), windows_result::HRESULT>;
    fn SetCooperativeLevel(&self, param0: super::super::Foundation::HWND, param1: u32) -> Result<(), windows_result::HRESULT>;
    fn SetDisplayMode(&self, param0: u32, param1: u32, param2: u32) -> Result<(), windows_result::HRESULT>;
    fn WaitForVerticalBlank(&self, param0: u32, param1: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Gdi")]
...
impl IDirectDraw2 {
    ...
    pub unsafe fn SetDisplayMode(&self, param0: u32, param1: u32, param2: u32, param3: u32, param4: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetAvailableVidMem(&self, param0: *mut DDSCAPS, param1: *mut u32, param2: *mut u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IDirectDraw2_Impl: windows_core::IUnknownImpl {
    ...
    fn RestoreDisplayMode(&self) -> Result<(), windows_result::HRESULT>;
    fn SetCooperativeLevel(&self, param0: super::super::Foundation::HWND, param1: u32) -> Result<(), windows_result::HRESULT>;
    fn SetDisplayMode(&self, param0: u32, param1: u32, param2: u32, param3: u32, param4: u32) -> Result<(), windows_result::HRESULT>;
    fn WaitForVerticalBlank(&self, param0: u32, param1: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT>;
    fn GetAvailableVidMem(&self, param0: *mut DDSCAPS, param1: *mut u32, param2: *mut u32) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Gdi")]
...
impl IDirectDraw4 {
    ...
    pub unsafe fn CreateSurface<P2>(&self, param0: *mut DDSURFACEDESC2, param1: *mut Option<IDirectDrawSurface4>, param2: P2) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe { (windows_core::Interface::vtable(self).CreateSurface)(windows_core::Interface::as_raw(self), param0 as _, core::mem::transmute(param1), param2.param().abi()).ok() }
    }
    pub unsafe fn DuplicateSurface<P0>(&self, param0: P0) -> Result<IDirectDrawSurface4, windows_result::HRESULT>
    where
    ...
    pub unsafe fn EnumDisplayModes(&self, param0: u32, param1: *mut DDSURFACEDESC2, param2: *mut core::ffi::c_void, param3: LPDDENUMMODESCALLBACK2) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).EnumDisplayModes)(windows_core::Interface::as_raw(self), param0, param1 as _, param2 as _, param3).ok() }
    }
    pub unsafe fn EnumSurfaces(&self, param0: u32, param1: *mut DDSURFACEDESC2, param2: *mut core::ffi::c_void, param3: LPDDENUMSURFACESCALLBACK2) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).EnumSurfaces)(windows_core::Interface::as_raw(self), param0, param1 as _, param2 as _, param3).ok() }
    }
    pub unsafe fn FlipToGDISurface(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).FlipToGDISurface)(windows_core::Interface::as_raw(self)).ok() }
    ...
    pub unsafe fn GetDisplayMode(&self, param0: *mut DDSURFACEDESC2) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetDisplayMode)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    pub unsafe fn GetFourCCCodes(&self, param0: *mut u32, param1: *mut u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetFourCCCodes)(windows_core::Interface::as_raw(self), param0 as _, param1 as _).ok() }
    }
    pub unsafe fn GetGDISurface(&self) -> Result<IDirectDrawSurface4, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetGDISurface)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn GetAvailableVidMem(&self, param0: *mut DDSCAPS2, param1: *mut u32, param2: *mut u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetAvailableVidMem)(windows_core::Interface::as_raw(self), param0 as _, param1 as _, param2 as _).ok() }
    }
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn GetSurfaceFromDC(&self, param0: super::Gdi::HDC) -> Result<IDirectDrawSurface4, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RestoreAllSurfaces(&self) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetDeviceIdentifier(&self, param0: *mut DDDEVICEIDENTIFIER, param1: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IDirectDraw4_Impl: windows_core::IUnknownImpl {
    ...
    fn CreateClipper(&self, param0: u32, param1: windows_core::OutRef<'_, IDirectDrawClipper>, param2: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn CreatePalette(&self, param0: u32, param1: *mut super::Gdi::PALETTEENTRY, param2: windows_core::OutRef<'_, IDirectDrawPalette>, param3: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn CreateSurface(&self, param0: *mut DDSURFACEDESC2, param1: windows_core::OutRef<'_, IDirectDrawSurface4>, param2: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn DuplicateSurface(&self, param0: windows_core::Ref<'_, IDirectDrawSurface4>) -> Result<IDirectDrawSurface4, windows_result::HRESULT>;
    fn EnumDisplayModes(&self, param0: u32, param1: *mut DDSURFACEDESC2, param2: *mut core::ffi::c_void, param3: LPDDENUMMODESCALLBACK2) -> Result<(), windows_result::HRESULT>;
    fn EnumSurfaces(&self, param0: u32, param1: *mut DDSURFACEDESC2, param2: *mut core::ffi::c_void, param3: LPDDENUMSURFACESCALLBACK2) -> Result<(), windows_result::HRESULT>;
    fn FlipToGDISurface(&self) -> Result<(), windows_result::HRESULT>;
    fn GetCaps(&self, param0: *mut DDCAPS_DX7, param1: *mut DDCAPS_DX7) -> Result<(), windows_result::HRESULT>;
    fn GetDisplayMode(&self, param0: *mut DDSURFACEDESC2) -> Result<(), windows_result::HRESULT>;
    fn GetFourCCCodes(&self, param0: *mut u32, param1: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetGDISurface(&self) -> Result<IDirectDrawSurface4, windows_result::HRESULT>;
    fn GetMonitorFrequency(&self, param0: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetScanLine(&self, param0: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetVerticalBlankStatus(&self, param0: *mut windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn Initialize(&self, param0: *mut windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    ...
    fn SetDisplayMode(&self, param0: u32, param1: u32, param2: u32, param3: u32, param4: u32) -> Result<(), windows_result::HRESULT>;
    fn WaitForVerticalBlank(&self, param0: u32, param1: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT>;
    fn GetAvailableVidMem(&self, param0: *mut DDSCAPS2, param1: *mut u32, param2: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetSurfaceFromDC(&self, param0: super::Gdi::HDC) -> Result<IDirectDrawSurface4, windows_result::HRESULT>;
    fn RestoreAllSurfaces(&self) -> Result<(), windows_result::HRESULT>;
    fn TestCooperativeLevel(&self) -> Result<(), windows_result::HRESULT>;
    fn GetDeviceIdentifier(&self, param0: *mut DDDEVICEIDENTIFIER, param1: u32) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Gdi")]
...
impl IDirectDraw7 {
    ...
    pub unsafe fn CreateSurface<P2>(&self, param0: *mut DDSURFACEDESC2, param1: *mut Option<IDirectDrawSurface7>, param2: P2) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe { (windows_core::Interface::vtable(self).CreateSurface)(windows_core::Interface::as_raw(self), param0 as _, core::mem::transmute(param1), param2.param().abi()).ok() }
    }
    pub unsafe fn DuplicateSurface<P0>(&self, param0: P0) -> Result<IDirectDrawSurface7, windows_result::HRESULT>
    where
    ...
    pub unsafe fn EnumSurfaces(&self, param0: u32, param1: *mut DDSURFACEDESC2, param2: *mut core::ffi::c_void, param3: LPDDENUMSURFACESCALLBACK7) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).EnumSurfaces)(windows_core::Interface::as_raw(self), param0, param1 as _, param2 as _, param3).ok() }
    }
    pub unsafe fn FlipToGDISurface(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).FlipToGDISurface)(windows_core::Interface::as_raw(self)).ok() }
    ...
    pub unsafe fn GetGDISurface(&self) -> Result<IDirectDrawSurface7, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetGDISurface)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn GetSurfaceFromDC(&self, param0: super::Gdi::HDC) -> Result<IDirectDrawSurface7, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSurfaceFromDC)(windows_core::Interface::as_raw(self), param0, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn GetDeviceIdentifier(&self, param0: *mut DDDEVICEIDENTIFIER2, param1: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetDeviceIdentifier)(windows_core::Interface::as_raw(self), param0 as _, param1).ok() }
    }
    pub unsafe fn StartModeTest(&self, param0: *mut super::super::Foundation::SIZE, param1: u32, param2: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).StartModeTest)(windows_core::Interface::as_raw(self), param0 as _, param1, param2).ok() }
    }
    pub unsafe fn EvaluateMode(&self, param0: u32, param1: *mut u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IDirectDraw7_Impl: windows_core::IUnknownImpl {
    ...
    fn CreateClipper(&self, param0: u32, param1: windows_core::OutRef<'_, IDirectDrawClipper>, param2: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn CreatePalette(&self, param0: u32, param1: *mut super::Gdi::PALETTEENTRY, param2: windows_core::OutRef<'_, IDirectDrawPalette>, param3: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn CreateSurface(&self, param0: *mut DDSURFACEDESC2, param1: windows_core::OutRef<'_, IDirectDrawSurface7>, param2: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn DuplicateSurface(&self, param0: windows_core::Ref<'_, IDirectDrawSurface7>) -> Result<IDirectDrawSurface7, windows_result::HRESULT>;
    fn EnumDisplayModes(&self, param0: u32, param1: *mut DDSURFACEDESC2, param2: *mut core::ffi::c_void, param3: LPDDENUMMODESCALLBACK2) -> Result<(), windows_result::HRESULT>;
    fn EnumSurfaces(&self, param0: u32, param1: *mut DDSURFACEDESC2, param2: *mut core::ffi::c_void, param3: LPDDENUMSURFACESCALLBACK7) -> Result<(), windows_result::HRESULT>;
    fn FlipToGDISurface(&self) -> Result<(), windows_result::HRESULT>;
    fn GetCaps(&self, param0: *mut DDCAPS_DX7, param1: *mut DDCAPS_DX7) -> Result<(), windows_result::HRESULT>;
    fn GetDisplayMode(&self, param0: *mut DDSURFACEDESC2) -> Result<(), windows_result::HRESULT>;
    fn GetFourCCCodes(&self, param0: *mut u32, param1: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetGDISurface(&self) -> Result<IDirectDrawSurface7, windows_result::HRESULT>;
    fn GetMonitorFrequency(&self, param0: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetScanLine(&self, param0: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetVerticalBlankStatus(&self, param0: *mut windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn Initialize(&self, param0: *mut windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    ...
    fn WaitForVerticalBlank(&self, param0: u32, param1: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT>;
    fn GetAvailableVidMem(&self, param0: *mut DDSCAPS2, param1: *mut u32, param2: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetSurfaceFromDC(&self, param0: super::Gdi::HDC) -> Result<IDirectDrawSurface7, windows_result::HRESULT>;
    fn RestoreAllSurfaces(&self) -> Result<(), windows_result::HRESULT>;
    fn TestCooperativeLevel(&self) -> Result<(), windows_result::HRESULT>;
    fn GetDeviceIdentifier(&self, param0: *mut DDDEVICEIDENTIFIER2, param1: u32) -> Result<(), windows_result::HRESULT>;
    fn StartModeTest(&self, param0: *mut super::super::Foundation::SIZE, param1: u32, param2: u32) -> Result<(), windows_result::HRESULT>;
    fn EvaluateMode(&self, param0: u32, param1: *mut u32) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Gdi")]
...
impl IDirectDrawClipper {
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn GetClipList(&self, param0: *mut super::super::Foundation::RECT, param1: *mut super::Gdi::RGNDATA, param2: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetHWnd(&self, param0: *mut super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetHWnd)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    pub unsafe fn Initialize<P0>(&self, param0: P0, param1: u32) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn IsClipListChanged(&self, param0: *mut windows_core::BOOL) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).IsClipListChanged)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn SetClipList(&self, param0: *mut super::Gdi::RGNDATA, param1: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetClipList)(windows_core::Interface::as_raw(self), param0 as _, param1).ok() }
    }
    pub unsafe fn SetHWnd(&self, param0: u32, param1: super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT> {
...
pub trait IDirectDrawClipper_Impl: windows_core::IUnknownImpl {
    fn GetClipList(&self, param0: *mut super::super::Foundation::RECT, param1: *mut super::Gdi::RGNDATA, param2: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetHWnd(&self, param0: *mut super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT>;
    fn Initialize(&self, param0: windows_core::Ref<'_, IDirectDraw>, param1: u32) -> Result<(), windows_result::HRESULT>;
    fn IsClipListChanged(&self, param0: *mut windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SetClipList(&self, param0: *mut super::Gdi::RGNDATA, param1: u32) -> Result<(), windows_result::HRESULT>;
    fn SetHWnd(&self, param0: u32, param1: super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Gdi")]
...
impl IDirectDrawColorControl {
    pub unsafe fn GetColorControls(&self, param0: *mut DDCOLORCONTROL) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetColorControls)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    pub unsafe fn SetColorControls(&self, param0: *mut DDCOLORCONTROL) -> Result<(), windows_result::HRESULT> {
...
pub trait IDirectDrawColorControl_Impl: windows_core::IUnknownImpl {
    fn GetColorControls(&self, param0: *mut DDCOLORCONTROL) -> Result<(), windows_result::HRESULT>;
    fn SetColorControls(&self, param0: *mut DDCOLORCONTROL) -> Result<(), windows_result::HRESULT>;
}
...
impl IDirectDrawGammaControl {
    pub unsafe fn GetGammaRamp(&self, param0: u32, param1: *mut DDGAMMARAMP) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetGammaRamp)(windows_core::Interface::as_raw(self), param0, param1 as _).ok() }
    }
    pub unsafe fn SetGammaRamp(&self, param0: u32, param1: *mut DDGAMMARAMP) -> Result<(), windows_result::HRESULT> {
...
pub trait IDirectDrawGammaControl_Impl: windows_core::IUnknownImpl {
    fn GetGammaRamp(&self, param0: u32, param1: *mut DDGAMMARAMP) -> Result<(), windows_result::HRESULT>;
    fn SetGammaRamp(&self, param0: u32, param1: *mut DDGAMMARAMP) -> Result<(), windows_result::HRESULT>;
}
...
impl IDirectDrawKernel {
    pub unsafe fn GetCaps(&self, param0: *mut DDKERNELCAPS) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetCaps)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    pub unsafe fn GetKernelHandle(&self, param0: *mut usize) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetKernelHandle)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    pub unsafe fn ReleaseKernelHandle(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IDirectDrawKernel_Impl: windows_core::IUnknownImpl {
    fn GetCaps(&self, param0: *mut DDKERNELCAPS) -> Result<(), windows_result::HRESULT>;
    fn GetKernelHandle(&self, param0: *mut usize) -> Result<(), windows_result::HRESULT>;
    fn ReleaseKernelHandle(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IDirectDrawPalette {
    pub unsafe fn GetCaps(&self, param0: *mut u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetCaps)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn GetEntries(&self, param0: u32, param1: u32, param2: u32, param3: *mut super::Gdi::PALETTEENTRY) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn Initialize<P0>(&self, param0: P0, param1: u32, param2: *mut super::Gdi::PALETTEENTRY) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IDirectDraw>,
    {
    ...
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn SetEntries(&self, param0: u32, param1: u32, param2: u32, param3: *mut super::Gdi::PALETTEENTRY) -> Result<(), windows_result::HRESULT> {
...
pub trait IDirectDrawPalette_Impl: windows_core::IUnknownImpl {
    fn GetCaps(&self, param0: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetEntries(&self, param0: u32, param1: u32, param2: u32, param3: *mut super::Gdi::PALETTEENTRY) -> Result<(), windows_result::HRESULT>;
    fn Initialize(&self, param0: windows_core::Ref<'_, IDirectDraw>, param1: u32, param2: *mut super::Gdi::PALETTEENTRY) -> Result<(), windows_result::HRESULT>;
    fn SetEntries(&self, param0: u32, param1: u32, param2: u32, param3: *mut super::Gdi::PALETTEENTRY) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Gdi")]
...
impl IDirectDrawSurface {
    pub unsafe fn AddAttachedSurface<P0>(&self, param0: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IDirectDrawSurface>,
    {
        unsafe { (windows_core::Interface::vtable(self).AddAttachedSurface)(windows_core::Interface::as_raw(self), param0.param().abi()).ok() }
    }
    pub unsafe fn AddOverlayDirtyRect(&self, param0: *mut super::super::Foundation::RECT) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).AddOverlayDirtyRect)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    pub unsafe fn Blt<P1>(&self, param0: *mut super::super::Foundation::RECT, param1: P1, param2: *mut super::super::Foundation::RECT, param3: u32, param4: *mut DDBLTFX) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn BltBatch(&self, param0: *mut DDBLTBATCH, param1: u32, param2: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn BltFast<P2>(&self, param0: u32, param1: u32, param2: P2, param3: *mut super::super::Foundation::RECT, param4: u32) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn DeleteAttachedSurface<P1>(&self, param0: u32, param1: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<IDirectDrawSurface>,
    {
    ...
    pub unsafe fn EnumAttachedSurfaces(&self, param0: *mut core::ffi::c_void, param1: LPDDENUMSURFACESCALLBACK) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).EnumAttachedSurfaces)(windows_core::Interface::as_raw(self), param0 as _, param1).ok() }
    }
    pub unsafe fn EnumOverlayZOrders(&self, param0: u32, param1: *mut core::ffi::c_void, param2: LPDDENUMSURFACESCALLBACK) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Flip<P0>(&self, param0: P0, param1: u32) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IDirectDrawSurface>,
    {
        unsafe { (windows_core::Interface::vtable(self).Flip)(windows_core::Interface::as_raw(self), param0.param().abi(), param1).ok() }
    }
    pub unsafe fn GetAttachedSurface(&self, param0: *mut DDSCAPS, param1: *mut Option<IDirectDrawSurface>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetBltStatus(&self, param0: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetBltStatus)(windows_core::Interface::as_raw(self), param0).ok() }
    }
    pub unsafe fn GetCaps(&self, param0: *mut DDSCAPS) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetCaps)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    pub unsafe fn GetClipper(&self) -> Result<IDirectDrawClipper, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetColorKey(&self, param0: u32, param1: *mut DDCOLORKEY) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetColorKey)(windows_core::Interface::as_raw(self), param0, param1 as _).ok() }
    }
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn GetDC(&self, param0: *mut super::Gdi::HDC) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetDC)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    pub unsafe fn GetFlipStatus(&self, param0: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetFlipStatus)(windows_core::Interface::as_raw(self), param0).ok() }
    }
    pub unsafe fn GetOverlayPosition(&self, param0: *mut i32, param1: *mut i32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetPalette(&self) -> Result<IDirectDrawPalette, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetPixelFormat(&self, param0: *mut DDPIXELFORMAT) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetPixelFormat)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    pub unsafe fn GetSurfaceDesc(&self, param0: *mut DDSURFACEDESC) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetSurfaceDesc)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    pub unsafe fn Initialize<P0>(&self, param0: P0, param1: *mut DDSURFACEDESC) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IDirectDraw>,
    {
        unsafe { (windows_core::Interface::vtable(self).Initialize)(windows_core::Interface::as_raw(self), param0.param().abi(), param1 as _).ok() }
    }
    pub unsafe fn IsLost(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).IsLost)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Lock(&self, param0: *mut super::super::Foundation::RECT, param1: *mut DDSURFACEDESC, param2: u32, param3: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn ReleaseDC(&self, param0: super::Gdi::HDC) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetClipper<P0>(&self, param0: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetColorKey(&self, param0: u32, param1: *mut DDCOLORKEY) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetColorKey)(windows_core::Interface::as_raw(self), param0, param1 as _).ok() }
    }
    pub unsafe fn SetOverlayPosition(&self, param0: i32, param1: i32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetOverlayPosition)(windows_core::Interface::as_raw(self), param0, param1).ok() }
    }
    pub unsafe fn SetPalette<P0>(&self, param0: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Unlock(&self, param0: *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Unlock)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    pub unsafe fn UpdateOverlay<P1>(&self, param0: *mut super::super::Foundation::RECT, param1: P1, param2: *mut super::super::Foundation::RECT, param3: u32, param4: *mut DDOVERLAYFX) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<IDirectDrawSurface>,
    {
    ...
    pub unsafe fn UpdateOverlayDisplay(&self, param0: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).UpdateOverlayDisplay)(windows_core::Interface::as_raw(self), param0).ok() }
    }
    pub unsafe fn UpdateOverlayZOrder<P1>(&self, param0: u32, param1: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<IDirectDrawSurface>,
    {
...
pub trait IDirectDrawSurface_Impl: windows_core::IUnknownImpl {
    fn AddAttachedSurface(&self, param0: windows_core::Ref<'_, IDirectDrawSurface>) -> Result<(), windows_result::HRESULT>;
    fn AddOverlayDirtyRect(&self, param0: *mut super::super::Foundation::RECT) -> Result<(), windows_result::HRESULT>;
    fn Blt(&self, param0: *mut super::super::Foundation::RECT, param1: windows_core::Ref<'_, IDirectDrawSurface>, param2: *mut super::super::Foundation::RECT, param3: u32, param4: *mut DDBLTFX) -> Result<(), windows_result::HRESULT>;
    fn BltBatch(&self, param0: *mut DDBLTBATCH, param1: u32, param2: u32) -> Result<(), windows_result::HRESULT>;
    fn BltFast(&self, param0: u32, param1: u32, param2: windows_core::Ref<'_, IDirectDrawSurface>, param3: *mut super::super::Foundation::RECT, param4: u32) -> Result<(), windows_result::HRESULT>;
    fn DeleteAttachedSurface(&self, param0: u32, param1: windows_core::Ref<'_, IDirectDrawSurface>) -> Result<(), windows_result::HRESULT>;
    fn EnumAttachedSurfaces(&self, param0: *mut core::ffi::c_void, param1: LPDDENUMSURFACESCALLBACK) -> Result<(), windows_result::HRESULT>;
    fn EnumOverlayZOrders(&self, param0: u32, param1: *mut core::ffi::c_void, param2: LPDDENUMSURFACESCALLBACK) -> Result<(), windows_result::HRESULT>;
    fn Flip(&self, param0: windows_core::Ref<'_, IDirectDrawSurface>, param1: u32) -> Result<(), windows_result::HRESULT>;
    fn GetAttachedSurface(&self, param0: *mut DDSCAPS, param1: windows_core::OutRef<'_, IDirectDrawSurface>) -> Result<(), windows_result::HRESULT>;
    fn GetBltStatus(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn GetCaps(&self, param0: *mut DDSCAPS) -> Result<(), windows_result::HRESULT>;
    fn GetClipper(&self) -> Result<IDirectDrawClipper, windows_result::HRESULT>;
    fn GetColorKey(&self, param0: u32, param1: *mut DDCOLORKEY) -> Result<(), windows_result::HRESULT>;
    fn GetDC(&self, param0: *mut super::Gdi::HDC) -> Result<(), windows_result::HRESULT>;
    fn GetFlipStatus(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn GetOverlayPosition(&self, param0: *mut i32, param1: *mut i32) -> Result<(), windows_result::HRESULT>;
    fn GetPalette(&self) -> Result<IDirectDrawPalette, windows_result::HRESULT>;
    fn GetPixelFormat(&self, param0: *mut DDPIXELFORMAT) -> Result<(), windows_result::HRESULT>;
    fn GetSurfaceDesc(&self, param0: *mut DDSURFACEDESC) -> Result<(), windows_result::HRESULT>;
    fn Initialize(&self, param0: windows_core::Ref<'_, IDirectDraw>, param1: *mut DDSURFACEDESC) -> Result<(), windows_result::HRESULT>;
    fn IsLost(&self) -> Result<(), windows_result::HRESULT>;
    fn Lock(&self, param0: *mut super::super::Foundation::RECT, param1: *mut DDSURFACEDESC, param2: u32, param3: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT>;
    fn ReleaseDC(&self, param0: super::Gdi::HDC) -> Result<(), windows_result::HRESULT>;
    fn Restore(&self) -> Result<(), windows_result::HRESULT>;
    fn SetClipper(&self, param0: windows_core::Ref<'_, IDirectDrawClipper>) -> Result<(), windows_result::HRESULT>;
    fn SetColorKey(&self, param0: u32, param1: *mut DDCOLORKEY) -> Result<(), windows_result::HRESULT>;
    fn SetOverlayPosition(&self, param0: i32, param1: i32) -> Result<(), windows_result::HRESULT>;
    fn SetPalette(&self, param0: windows_core::Ref<'_, IDirectDrawPalette>) -> Result<(), windows_result::HRESULT>;
    fn Unlock(&self, param0: *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn UpdateOverlay(&self, param0: *mut super::super::Foundation::RECT, param1: windows_core::Ref<'_, IDirectDrawSurface>, param2: *mut super::super::Foundation::RECT, param3: u32, param4: *mut DDOVERLAYFX) -> Result<(), windows_result::HRESULT>;
    fn UpdateOverlayDisplay(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn UpdateOverlayZOrder(&self, param0: u32, param1: windows_core::Ref<'_, IDirectDrawSurface>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Gdi")]
...
impl IDirectDrawSurface2 {
    ...
    pub unsafe fn GetAttachedSurface(&self, param0: *mut DDSCAPS, param1: *mut Option<IDirectDrawSurface2>) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetAttachedSurface)(windows_core::Interface::as_raw(self), param0 as _, core::mem::transmute(param1)).ok() }
    }
    pub unsafe fn GetBltStatus(&self, param0: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetBltStatus)(windows_core::Interface::as_raw(self), param0).ok() }
    ...
    pub unsafe fn GetDDInterface(&self, param0: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetDDInterface)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    pub unsafe fn PageLock(&self, param0: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).PageLock)(windows_core::Interface::as_raw(self), param0).ok() }
    }
    pub unsafe fn PageUnlock(&self, param0: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IDirectDrawSurface2_Impl: windows_core::IUnknownImpl {
    fn AddAttachedSurface(&self, param0: windows_core::Ref<'_, IDirectDrawSurface2>) -> Result<(), windows_result::HRESULT>;
    fn AddOverlayDirtyRect(&self, param0: *mut super::super::Foundation::RECT) -> Result<(), windows_result::HRESULT>;
    fn Blt(&self, param0: *mut super::super::Foundation::RECT, param1: windows_core::Ref<'_, IDirectDrawSurface2>, param2: *mut super::super::Foundation::RECT, param3: u32, param4: *mut DDBLTFX) -> Result<(), windows_result::HRESULT>;
    fn BltBatch(&self, param0: *mut DDBLTBATCH, param1: u32, param2: u32) -> Result<(), windows_result::HRESULT>;
    fn BltFast(&self, param0: u32, param1: u32, param2: windows_core::Ref<'_, IDirectDrawSurface2>, param3: *mut super::super::Foundation::RECT, param4: u32) -> Result<(), windows_result::HRESULT>;
    fn DeleteAttachedSurface(&self, param0: u32, param1: windows_core::Ref<'_, IDirectDrawSurface2>) -> Result<(), windows_result::HRESULT>;
    fn EnumAttachedSurfaces(&self, param0: *mut core::ffi::c_void, param1: LPDDENUMSURFACESCALLBACK) -> Result<(), windows_result::HRESULT>;
    fn EnumOverlayZOrders(&self, param0: u32, param1: *mut core::ffi::c_void, param2: LPDDENUMSURFACESCALLBACK) -> Result<(), windows_result::HRESULT>;
    fn Flip(&self, param0: windows_core::Ref<'_, IDirectDrawSurface2>, param1: u32) -> Result<(), windows_result::HRESULT>;
    fn GetAttachedSurface(&self, param0: *mut DDSCAPS, param1: windows_core::OutRef<'_, IDirectDrawSurface2>) -> Result<(), windows_result::HRESULT>;
    fn GetBltStatus(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn GetCaps(&self, param0: *mut DDSCAPS) -> Result<(), windows_result::HRESULT>;
    fn GetClipper(&self) -> Result<IDirectDrawClipper, windows_result::HRESULT>;
    fn GetColorKey(&self, param0: u32, param1: *mut DDCOLORKEY) -> Result<(), windows_result::HRESULT>;
    ...
    fn SetPalette(&self, param0: windows_core::Ref<'_, IDirectDrawPalette>) -> Result<(), windows_result::HRESULT>;
    fn Unlock(&self, param0: *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn UpdateOverlay(&self, param0: *mut super::super::Foundation::RECT, param1: windows_core::Ref<'_, IDirectDrawSurface2>, param2: *mut super::super::Foundation::RECT, param3: u32, param4: *mut DDOVERLAYFX) -> Result<(), windows_result::HRESULT>;
    fn UpdateOverlayDisplay(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn UpdateOverlayZOrder(&self, param0: u32, param1: windows_core::Ref<'_, IDirectDrawSurface2>) -> Result<(), windows_result::HRESULT>;
    fn GetDDInterface(&self, param0: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn PageLock(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn PageUnlock(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Gdi")]
...
impl IDirectDrawSurface3 {
    ...
    pub unsafe fn GetAttachedSurface(&self, param0: *mut DDSCAPS, param1: *mut Option<IDirectDrawSurface3>) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetAttachedSurface)(windows_core::Interface::as_raw(self), param0 as _, core::mem::transmute(param1)).ok() }
    }
    pub unsafe fn GetBltStatus(&self, param0: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetBltStatus)(windows_core::Interface::as_raw(self), param0).ok() }
    ...
    pub unsafe fn SetSurfaceDesc(&self, param0: *mut DDSURFACEDESC, param1: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IDirectDrawSurface3_Impl: windows_core::IUnknownImpl {
    fn AddAttachedSurface(&self, param0: windows_core::Ref<'_, IDirectDrawSurface3>) -> Result<(), windows_result::HRESULT>;
    fn AddOverlayDirtyRect(&self, param0: *mut super::super::Foundation::RECT) -> Result<(), windows_result::HRESULT>;
    fn Blt(&self, param0: *mut super::super::Foundation::RECT, param1: windows_core::Ref<'_, IDirectDrawSurface3>, param2: *mut super::super::Foundation::RECT, param3: u32, param4: *mut DDBLTFX) -> Result<(), windows_result::HRESULT>;
    fn BltBatch(&self, param0: *mut DDBLTBATCH, param1: u32, param2: u32) -> Result<(), windows_result::HRESULT>;
    fn BltFast(&self, param0: u32, param1: u32, param2: windows_core::Ref<'_, IDirectDrawSurface3>, param3: *mut super::super::Foundation::RECT, param4: u32) -> Result<(), windows_result::HRESULT>;
    fn DeleteAttachedSurface(&self, param0: u32, param1: windows_core::Ref<'_, IDirectDrawSurface3>) -> Result<(), windows_result::HRESULT>;
    fn EnumAttachedSurfaces(&self, param0: *mut core::ffi::c_void, param1: LPDDENUMSURFACESCALLBACK) -> Result<(), windows_result::HRESULT>;
    fn EnumOverlayZOrders(&self, param0: u32, param1: *mut core::ffi::c_void, param2: LPDDENUMSURFACESCALLBACK) -> Result<(), windows_result::HRESULT>;
    fn Flip(&self, param0: windows_core::Ref<'_, IDirectDrawSurface3>, param1: u32) -> Result<(), windows_result::HRESULT>;
    fn GetAttachedSurface(&self, param0: *mut DDSCAPS, param1: windows_core::OutRef<'_, IDirectDrawSurface3>) -> Result<(), windows_result::HRESULT>;
    fn GetBltStatus(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn GetCaps(&self, param0: *mut DDSCAPS) -> Result<(), windows_result::HRESULT>;
    fn GetClipper(&self) -> Result<IDirectDrawClipper, windows_result::HRESULT>;
    fn GetColorKey(&self, param0: u32, param1: *mut DDCOLORKEY) -> Result<(), windows_result::HRESULT>;
    ...
    fn SetPalette(&self, param0: windows_core::Ref<'_, IDirectDrawPalette>) -> Result<(), windows_result::HRESULT>;
    fn Unlock(&self, param0: *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn UpdateOverlay(&self, param0: *mut super::super::Foundation::RECT, param1: windows_core::Ref<'_, IDirectDrawSurface3>, param2: *mut super::super::Foundation::RECT, param3: u32, param4: *mut DDOVERLAYFX) -> Result<(), windows_result::HRESULT>;
    fn UpdateOverlayDisplay(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn UpdateOverlayZOrder(&self, param0: u32, param1: windows_core::Ref<'_, IDirectDrawSurface3>) -> Result<(), windows_result::HRESULT>;
    fn GetDDInterface(&self, param0: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn PageLock(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn PageUnlock(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn SetSurfaceDesc(&self, param0: *mut DDSURFACEDESC, param1: u32) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Gdi")]
...
impl IDirectDrawSurface4 {
    ...
    pub unsafe fn EnumAttachedSurfaces(&self, param0: *mut core::ffi::c_void, param1: LPDDENUMSURFACESCALLBACK2) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).EnumAttachedSurfaces)(windows_core::Interface::as_raw(self), param0 as _, param1).ok() }
    }
    pub unsafe fn EnumOverlayZOrders(&self, param0: u32, param1: *mut core::ffi::c_void, param2: LPDDENUMSURFACESCALLBACK2) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).EnumOverlayZOrders)(windows_core::Interface::as_raw(self), param0, param1 as _, param2).ok() }
    }
    pub unsafe fn Flip<P0>(&self, param0: P0, param1: u32) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn GetAttachedSurface(&self, param0: *mut DDSCAPS2, param1: *mut Option<IDirectDrawSurface4>) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetAttachedSurface)(windows_core::Interface::as_raw(self), param0 as _, core::mem::transmute(param1)).ok() }
    }
    pub unsafe fn GetBltStatus(&self, param0: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetBltStatus)(windows_core::Interface::as_raw(self), param0).ok() }
    }
    pub unsafe fn GetCaps(&self, param0: *mut DDSCAPS2) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetCaps)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    pub unsafe fn GetClipper(&self) -> Result<IDirectDrawClipper, windows_result::HRESULT> {
        unsafe {
    ...
    pub unsafe fn GetSurfaceDesc(&self, param0: *mut DDSURFACEDESC2) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetSurfaceDesc)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    pub unsafe fn Initialize<P0>(&self, param0: P0, param1: *mut DDSURFACEDESC2) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IDirectDraw>,
    {
        unsafe { (windows_core::Interface::vtable(self).Initialize)(windows_core::Interface::as_raw(self), param0.param().abi(), param1 as _).ok() }
    ...
    pub unsafe fn Lock(&self, param0: *mut super::super::Foundation::RECT, param1: *mut DDSURFACEDESC2, param2: u32, param3: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Lock)(windows_core::Interface::as_raw(self), param0 as _, param1 as _, param2, param3).ok() }
    }
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn ReleaseDC(&self, param0: super::Gdi::HDC) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Unlock(&self, param0: *mut super::super::Foundation::RECT) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Unlock)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    pub unsafe fn UpdateOverlay<P1>(&self, param0: *mut super::super::Foundation::RECT, param1: P1, param2: *mut super::super::Foundation::RECT, param3: u32, param4: *mut DDOVERLAYFX) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetSurfaceDesc(&self, param0: *mut DDSURFACEDESC2, param1: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetSurfaceDesc)(windows_core::Interface::as_raw(self), param0 as _, param1).ok() }
    }
    pub unsafe fn SetPrivateData(&self, param0: *const windows_core::GUID, param1: *mut core::ffi::c_void, param2: u32, param3: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetPrivateData(&self, param0: *const windows_core::GUID, param1: *mut core::ffi::c_void, param2: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn FreePrivateData(&self, param0: *const windows_core::GUID) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).FreePrivateData)(windows_core::Interface::as_raw(self), param0).ok() }
    }
    pub unsafe fn GetUniquenessValue(&self, param0: *mut u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetUniquenessValue)(windows_core::Interface::as_raw(self), param0 as _).ok() }
    }
    pub unsafe fn ChangeUniquenessValue(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IDirectDrawSurface4_Impl: windows_core::IUnknownImpl {
    fn AddAttachedSurface(&self, param0: windows_core::Ref<'_, IDirectDrawSurface4>) -> Result<(), windows_result::HRESULT>;
    fn AddOverlayDirtyRect(&self, param0: *mut super::super::Foundation::RECT) -> Result<(), windows_result::HRESULT>;
    fn Blt(&self, param0: *mut super::super::Foundation::RECT, param1: windows_core::Ref<'_, IDirectDrawSurface4>, param2: *mut super::super::Foundation::RECT, param3: u32, param4: *mut DDBLTFX) -> Result<(), windows_result::HRESULT>;
    fn BltBatch(&self, param0: *mut DDBLTBATCH, param1: u32, param2: u32) -> Result<(), windows_result::HRESULT>;
    fn BltFast(&self, param0: u32, param1: u32, param2: windows_core::Ref<'_, IDirectDrawSurface4>, param3: *mut super::super::Foundation::RECT, param4: u32) -> Result<(), windows_result::HRESULT>;
    fn DeleteAttachedSurface(&self, param0: u32, param1: windows_core::Ref<'_, IDirectDrawSurface4>) -> Result<(), windows_result::HRESULT>;
    fn EnumAttachedSurfaces(&self, param0: *mut core::ffi::c_void, param1: LPDDENUMSURFACESCALLBACK2) -> Result<(), windows_result::HRESULT>;
    fn EnumOverlayZOrders(&self, param0: u32, param1: *mut core::ffi::c_void, param2: LPDDENUMSURFACESCALLBACK2) -> Result<(), windows_result::HRESULT>;
    fn Flip(&self, param0: windows_core::Ref<'_, IDirectDrawSurface4>, param1: u32) -> Result<(), windows_result::HRESULT>;
    fn GetAttachedSurface(&self, param0: *mut DDSCAPS2, param1: windows_core::OutRef<'_, IDirectDrawSurface4>) -> Result<(), windows_result::HRESULT>;
    fn GetBltStatus(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn GetCaps(&self, param0: *mut DDSCAPS2) -> Result<(), windows_result::HRESULT>;
    fn GetClipper(&self) -> Result<IDirectDrawClipper, windows_result::HRESULT>;
    fn GetColorKey(&self, param0: u32, param1: *mut DDCOLORKEY) -> Result<(), windows_result::HRESULT>;
    fn GetDC(&self, param0: *mut super::Gdi::HDC) -> Result<(), windows_result::HRESULT>;
    fn GetFlipStatus(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    ...
    fn GetPalette(&self) -> Result<IDirectDrawPalette, windows_result::HRESULT>;
    fn GetPixelFormat(&self, param0: *mut DDPIXELFORMAT) -> Result<(), windows_result::HRESULT>;
    fn GetSurfaceDesc(&self, param0: *mut DDSURFACEDESC2) -> Result<(), windows_result::HRESULT>;
    fn Initialize(&self, param0: windows_core::Ref<'_, IDirectDraw>, param1: *mut DDSURFACEDESC2) -> Result<(), windows_result::HRESULT>;
    fn IsLost(&self) -> Result<(), windows_result::HRESULT>;
    fn Lock(&self, param0: *mut super::super::Foundation::RECT, param1: *mut DDSURFACEDESC2, param2: u32, param3: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT>;
    fn ReleaseDC(&self, param0: super::Gdi::HDC) -> Result<(), windows_result::HRESULT>;
    fn Restore(&self) -> Result<(), windows_result::HRESULT>;
    fn SetClipper(&self, param0: windows_core::Ref<'_, IDirectDrawClipper>) -> Result<(), windows_result::HRESULT>;
    fn SetColorKey(&self, param0: u32, param1: *mut DDCOLORKEY) -> Result<(), windows_result::HRESULT>;
    fn SetOverlayPosition(&self, param0: i32, param1: i32) -> Result<(), windows_result::HRESULT>;
    fn SetPalette(&self, param0: windows_core::Ref<'_, IDirectDrawPalette>) -> Result<(), windows_result::HRESULT>;
    fn Unlock(&self, param0: *mut super::super::Foundation::RECT) -> Result<(), windows_result::HRESULT>;
    fn UpdateOverlay(&self, param0: *mut super::super::Foundation::RECT, param1: windows_core::Ref<'_, IDirectDrawSurface4>, param2: *mut super::super::Foundation::RECT, param3: u32, param4: *mut DDOVERLAYFX) -> Result<(), windows_result::HRESULT>;
    fn UpdateOverlayDisplay(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn UpdateOverlayZOrder(&self, param0: u32, param1: windows_core::Ref<'_, IDirectDrawSurface4>) -> Result<(), windows_result::HRESULT>;
    fn GetDDInterface(&self, param0: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn PageLock(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn PageUnlock(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn SetSurfaceDesc(&self, param0: *mut DDSURFACEDESC2, param1: u32) -> Result<(), windows_result::HRESULT>;
    fn SetPrivateData(&self, param0: *const windows_core::GUID, param1: *mut core::ffi::c_void, param2: u32, param3: u32) -> Result<(), windows_result::HRESULT>;
    fn GetPrivateData(&self, param0: *const windows_core::GUID, param1: *mut core::ffi::c_void, param2: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn FreePrivateData(&self, param0: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn GetUniquenessValue(&self, param0: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn ChangeUniquenessValue(&self) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Gdi")]
...
impl IDirectDrawSurface7 {
    ...
    pub unsafe fn EnumAttachedSurfaces(&self, param0: *mut core::ffi::c_void, param1: LPDDENUMSURFACESCALLBACK7) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).EnumAttachedSurfaces)(windows_core::Interface::as_raw(self), param0 as _, param1).ok() }
    }
    pub unsafe fn EnumOverlayZOrders(&self, param0: u32, param1: *mut core::ffi::c_void, param2: LPDDENUMSURFACESCALLBACK7) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).EnumOverlayZOrders)(windows_core::Interface::as_raw(self), param0, param1 as _, param2).ok() }
    }
    pub unsafe fn Flip<P0>(&self, param0: P0, param1: u32) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn GetAttachedSurface(&self, param0: *mut DDSCAPS2, param1: *mut Option<IDirectDrawSurface7>) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetAttachedSurface)(windows_core::Interface::as_raw(self), param0 as _, core::mem::transmute(param1)).ok() }
    }
    pub unsafe fn GetBltStatus(&self, param0: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetBltStatus)(windows_core::Interface::as_raw(self), param0).ok() }
...
pub trait IDirectDrawSurface7_Impl: windows_core::IUnknownImpl {
    fn AddAttachedSurface(&self, param0: windows_core::Ref<'_, IDirectDrawSurface7>) -> Result<(), windows_result::HRESULT>;
    fn AddOverlayDirtyRect(&self, param0: *mut super::super::Foundation::RECT) -> Result<(), windows_result::HRESULT>;
    fn Blt(&self, param0: *mut super::super::Foundation::RECT, param1: windows_core::Ref<'_, IDirectDrawSurface7>, param2: *mut super::super::Foundation::RECT, param3: u32, param4: *mut DDBLTFX) -> Result<(), windows_result::HRESULT>;
    fn BltBatch(&self, param0: *mut DDBLTBATCH, param1: u32, param2: u32) -> Result<(), windows_result::HRESULT>;
    fn BltFast(&self, param0: u32, param1: u32, param2: windows_core::Ref<'_, IDirectDrawSurface7>, param3: *mut super::super::Foundation::RECT, param4: u32) -> Result<(), windows_result::HRESULT>;
    fn DeleteAttachedSurface(&self, param0: u32, param1: windows_core::Ref<'_, IDirectDrawSurface7>) -> Result<(), windows_result::HRESULT>;
    fn EnumAttachedSurfaces(&self, param0: *mut core::ffi::c_void, param1: LPDDENUMSURFACESCALLBACK7) -> Result<(), windows_result::HRESULT>;
    fn EnumOverlayZOrders(&self, param0: u32, param1: *mut core::ffi::c_void, param2: LPDDENUMSURFACESCALLBACK7) -> Result<(), windows_result::HRESULT>;
    fn Flip(&self, param0: windows_core::Ref<'_, IDirectDrawSurface7>, param1: u32) -> Result<(), windows_result::HRESULT>;
    fn GetAttachedSurface(&self, param0: *mut DDSCAPS2, param1: windows_core::OutRef<'_, IDirectDrawSurface7>) -> Result<(), windows_result::HRESULT>;
    fn GetBltStatus(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn GetCaps(&self, param0: *mut DDSCAPS2) -> Result<(), windows_result::HRESULT>;
    fn GetClipper(&self) -> Result<IDirectDrawClipper, windows_result::HRESULT>;
    fn GetColorKey(&self, param0: u32, param1: *mut DDCOLORKEY) -> Result<(), windows_result::HRESULT>;
    ...
    fn SetPalette(&self, param0: windows_core::Ref<'_, IDirectDrawPalette>) -> Result<(), windows_result::HRESULT>;
    fn Unlock(&self, param0: *mut super::super::Foundation::RECT) -> Result<(), windows_result::HRESULT>;
    fn UpdateOverlay(&self, param0: *mut super::super::Foundation::RECT, param1: windows_core::Ref<'_, IDirectDrawSurface7>, param2: *mut super::super::Foundation::RECT, param3: u32, param4: *mut DDOVERLAYFX) -> Result<(), windows_result::HRESULT>;
    fn UpdateOverlayDisplay(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn UpdateOverlayZOrder(&self, param0: u32, param1: windows_core::Ref<'_, IDirectDrawSurface7>) -> Result<(), windows_result::HRESULT>;
    fn GetDDInterface(&self, param0: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn PageLock(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn PageUnlock(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn SetSurfaceDesc(&self, param0: *mut DDSURFACEDESC2, param1: u32) -> Result<(), windows_result::HRESULT>;
    ...
    fn GetUniquenessValue(&self, param0: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn ChangeUniquenessValue(&self) -> Result<(), windows_result::HRESULT>;
    fn SetPriority(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn GetPriority(&self, param0: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn SetLOD(&self, param0: u32) -> Result<(), windows_result::HRESULT>;
    fn GetLOD(&self, param0: *mut u32) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Gdi")]
...
impl IDirectDrawVideoPort {
    ...
    pub unsafe fn GetBandwidthInfo(&self, param0: *mut DDPIXELFORMAT, param1: u32, param2: u32, param3: u32, param4: *mut DDVIDEOPORTBANDWIDTH) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetInputFormats(&self, lpnumformats: *mut u32, param1: Option<*mut DDPIXELFORMAT>, param2: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetOutputFormats(&self, param0: *mut DDPIXELFORMAT, lpnumformats: *mut u32, param2: Option<*mut DDPIXELFORMAT>, param3: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IDirectDrawVideoPort_Impl: windows_core::IUnknownImpl {
    fn Flip(&self, param0: windows_core::Ref<'_, IDirectDrawSurface>, param1: u32) -> Result<(), windows_result::HRESULT>;
    fn GetBandwidthInfo(&self, param0: *mut DDPIXELFORMAT, param1: u32, param2: u32, param3: u32, param4: *mut DDVIDEOPORTBANDWIDTH) -> Result<(), windows_result::HRESULT>;
    fn GetColorControls(&self, param0: *mut DDCOLORCONTROL) -> Result<(), windows_result::HRESULT>;
    fn GetInputFormats(&self, lpnumformats: *mut u32, param1: *mut DDPIXELFORMAT, param2: u32) -> Result<(), windows_result::HRESULT>;
    fn GetOutputFormats(&self, param0: *mut DDPIXELFORMAT, lpnumformats: *mut u32, param2: *mut DDPIXELFORMAT, param3: u32) -> Result<(), windows_result::HRESULT>;
    fn GetFieldPolarity(&self, param0: *mut windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn GetVideoLine(&self, param0: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetVideoSignalStatus(&self, param0: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn SetColorControls(&self, param0: *mut DDCOLORCONTROL) -> Result<(), windows_result::HRESULT>;
    fn SetTargetSurface(&self, param0: windows_core::Ref<'_, IDirectDrawSurface>, param1: u32) -> Result<(), windows_result::HRESULT>;
    fn StartVideo(&self, param0: *mut DDVIDEOPORTINFO) -> Result<(), windows_result::HRESULT>;
    fn StopVideo(&self) -> Result<(), windows_result::HRESULT>;
    fn UpdateVideo(&self, param0: *mut DDVIDEOPORTINFO) -> Result<(), windows_result::HRESULT>;
    fn WaitForSync(&self, param0: u32, param1: u32, param2: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IDirectDrawVideoPortNotify {
    pub unsafe fn AcquireNotification(&self, param0: *mut super::super::Foundation::HANDLE, param1: *mut DDVIDEOPORTNOTIFY) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn ReleaseNotification(&self, param0: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT> {
...
pub trait IDirectDrawVideoPortNotify_Impl: windows_core::IUnknownImpl {
    fn AcquireNotification(&self, param0: *mut super::super::Foundation::HANDLE, param1: *mut DDVIDEOPORTNOTIFY) -> Result<(), windows_result::HRESULT>;
    fn ReleaseNotification(&self, param0: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT>;
}
