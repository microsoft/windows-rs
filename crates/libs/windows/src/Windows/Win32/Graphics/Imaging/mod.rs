...
pub mod D2D;
#[inline]
pub unsafe fn WICConvertBitmapSource<P1>(dstformat: *const windows_core::GUID, pisrc: P1) -> windows_result::Result<IWICBitmapSource>
where
...
#[inline]
pub unsafe fn WICCreateBitmapFromSection(width: u32, height: u32, pixelformat: *const windows_core::GUID, hsection: super::super::Foundation::HANDLE, stride: u32, offset: u32) -> windows_result::Result<IWICBitmap> {
...
#[inline]
pub unsafe fn WICCreateBitmapFromSectionEx(width: u32, height: u32, pixelformat: *const windows_core::GUID, hsection: super::super::Foundation::HANDLE, stride: u32, offset: u32, desiredaccesslevel: WICSectionAccessLevel) -> windows_result::Result<IWICBitmap> {
...
#[inline]
pub unsafe fn WICGetMetadataContentSize<P1>(guidcontainerformat: *const windows_core::GUID, piwriter: P1) -> windows_result::Result<u64>
where
...
#[inline]
pub unsafe fn WICMapGuidToShortName(guid: *const windows_core::GUID, wzname: Option<&mut [u16]>, pcchactual: *mut u32) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn WICMapSchemaToName<P1>(guidmetadataformat: *const windows_core::GUID, pwzschema: P1, wzname: Option<&mut [u16]>, pcchactual: *mut u32) -> windows_result::Result<()>
where
...
#[inline]
pub unsafe fn WICMapShortNameToGuid<P0>(wzname: P0) -> windows_result::Result<windows_core::GUID>
where
...
#[inline]
pub unsafe fn WICMatchMetadataContent<P2>(guidcontainerformat: *const windows_core::GUID, pguidvendor: Option<*const windows_core::GUID>, pistream: P2) -> windows_result::Result<windows_core::GUID>
where
...
#[cfg(feature = "Win32_System_Com")]
#[inline]
pub unsafe fn WICSerializeMetadataContent<P1, P3>(guidcontainerformat: *const windows_core::GUID, piwriter: P1, dwpersistoptions: u32, pistream: P3) -> windows_result::Result<()>
where
    P1: windows_core::Param<IWICMetadataWriter>,
...
impl IWICBitmap {
    pub unsafe fn Lock(&self, prclock: *const WICRect, flags: u32) -> windows_result::Result<IWICBitmapLock> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetPalette<P0>(&self, pipalette: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn SetResolution(&self, dpix: f64, dpiy: f64) -> windows_result::Result<()> {
...
pub trait IWICBitmap_Impl: IWICBitmapSource_Impl {
    fn Lock(&self, prclock: *const WICRect, flags: u32) -> windows_result::Result<IWICBitmapLock>;
    fn SetPalette(&self, pipalette: windows_core::Ref<IWICPalette>) -> windows_result::Result<()>;
    fn SetResolution(&self, dpix: f64, dpiy: f64) -> windows_result::Result<()>;
}
...
impl IWICBitmapClipper {
    pub unsafe fn Initialize<P0>(&self, pisource: P0, prc: *const WICRect) -> windows_result::Result<()>
    where
...
pub trait IWICBitmapClipper_Impl: IWICBitmapSource_Impl {
    fn Initialize(&self, pisource: windows_core::Ref<IWICBitmapSource>, prc: *const WICRect) -> windows_result::Result<()>;
}
...
impl IWICBitmapCodecInfo {
    pub unsafe fn GetContainerFormat(&self) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetContainerFormat)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetPixelFormats(&self, pguidpixelformats: &mut [windows_core::GUID], pcactual: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetColorManagementVersion(&self, wzcolormanagementversion: &mut [u16], pcchactual: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetDeviceManufacturer(&self, wzdevicemanufacturer: &mut [u16], pcchactual: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetDeviceModels(&self, wzdevicemodels: &mut [u16], pcchactual: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetMimeTypes(&self, wzmimetypes: &mut [u16], pcchactual: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFileExtensions(&self, wzfileextensions: &mut [u16], pcchactual: *mut u32) -> windows_result::Result<()> {
...
pub trait IWICBitmapCodecInfo_Impl: IWICComponentInfo_Impl {
    fn GetContainerFormat(&self) -> windows_result::Result<windows_core::GUID>;
    fn GetPixelFormats(&self, cformats: u32, pguidpixelformats: *mut windows_core::GUID, pcactual: *mut u32) -> windows_result::Result<()>;
    fn GetColorManagementVersion(&self, cchcolormanagementversion: u32, wzcolormanagementversion: windows_core::PWSTR, pcchactual: *mut u32) -> windows_result::Result<()>;
    fn GetDeviceManufacturer(&self, cchdevicemanufacturer: u32, wzdevicemanufacturer: windows_core::PWSTR, pcchactual: *mut u32) -> windows_result::Result<()>;
    fn GetDeviceModels(&self, cchdevicemodels: u32, wzdevicemodels: windows_core::PWSTR, pcchactual: *mut u32) -> windows_result::Result<()>;
    fn GetMimeTypes(&self, cchmimetypes: u32, wzmimetypes: windows_core::PWSTR, pcchactual: *mut u32) -> windows_result::Result<()>;
    fn GetFileExtensions(&self, cchfileextensions: u32, wzfileextensions: windows_core::PWSTR, pcchactual: *mut u32) -> windows_result::Result<()>;
    fn DoesSupportAnimation(&self) -> windows_result::Result<windows_core::BOOL>;
    fn DoesSupportChromakey(&self) -> windows_result::Result<windows_core::BOOL>;
    fn DoesSupportLossless(&self) -> windows_result::Result<windows_core::BOOL>;
    fn DoesSupportMultiframe(&self) -> windows_result::Result<windows_core::BOOL>;
    fn MatchesMimeType(&self, wzmimetype: &windows_core::PCWSTR) -> windows_result::Result<windows_core::BOOL>;
}
...
impl IWICBitmapCodecProgressNotification {
    pub unsafe fn RegisterProgressNotification(&self, pfnprogressnotification: PFNProgressNotification, pvdata: Option<*const core::ffi::c_void>, dwprogressflags: u32) -> windows_result::Result<()> {
...
pub trait IWICBitmapCodecProgressNotification_Impl: windows_core::IUnknownImpl {
    fn RegisterProgressNotification(&self, pfnprogressnotification: PFNProgressNotification, pvdata: *const core::ffi::c_void, dwprogressflags: u32) -> windows_result::Result<()>;
}
...
impl IWICBitmapDecoder {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn QueryCapability<P0>(&self, pistream: P0) -> windows_result::Result<u32>
    where
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Initialize<P0>(&self, pistream: P0, cacheoptions: WICDecodeOptions) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::System::Com::IStream>,
    {
    ...
    pub unsafe fn GetDecoderInfo(&self) -> windows_result::Result<IWICBitmapDecoderInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CopyPalette<P0>(&self, pipalette: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IWICPalette>,
    {
        unsafe { (windows_core::Interface::vtable(self).CopyPalette)(windows_core::Interface::as_raw(self), pipalette.param().abi()).ok() }
    }
    pub unsafe fn GetMetadataQueryReader(&self) -> windows_result::Result<IWICMetadataQueryReader> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetPreview(&self) -> windows_result::Result<IWICBitmapSource> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetColorContexts(&self, ppicolorcontexts: &mut [Option<IWICColorContext>], pcactualcount: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetThumbnail(&self) -> windows_result::Result<IWICBitmapSource> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFrameCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFrameCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetFrame(&self, index: u32) -> windows_result::Result<IWICBitmapFrameDecode> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWICBitmapDecoder_Impl: windows_core::IUnknownImpl {
    fn QueryCapability(&self, pistream: windows_core::Ref<super::super::System::Com::IStream>) -> windows_result::Result<u32>;
    fn Initialize(&self, pistream: windows_core::Ref<super::super::System::Com::IStream>, cacheoptions: WICDecodeOptions) -> windows_result::Result<()>;
    fn GetContainerFormat(&self) -> windows_result::Result<windows_core::GUID>;
    fn GetDecoderInfo(&self) -> windows_result::Result<IWICBitmapDecoderInfo>;
    fn CopyPalette(&self, pipalette: windows_core::Ref<IWICPalette>) -> windows_result::Result<()>;
    fn GetMetadataQueryReader(&self) -> windows_result::Result<IWICMetadataQueryReader>;
    fn GetPreview(&self) -> windows_result::Result<IWICBitmapSource>;
    fn GetColorContexts(&self, ccount: u32, ppicolorcontexts: *mut Option<IWICColorContext>, pcactualcount: *mut u32) -> windows_result::Result<()>;
    fn GetThumbnail(&self) -> windows_result::Result<IWICBitmapSource>;
    fn GetFrameCount(&self) -> windows_result::Result<u32>;
    fn GetFrame(&self, index: u32) -> windows_result::Result<IWICBitmapFrameDecode>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWICBitmapDecoderInfo {
    pub unsafe fn GetPatterns(&self, cbsizepatterns: u32, ppatterns: Option<*mut WICBitmapPattern>, pcpatterns: Option<*mut u32>, pcbpatternsactual: *mut u32) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn MatchesPattern<P0>(&self, pistream: P0) -> windows_result::Result<windows_core::BOOL>
    where
        P0: windows_core::Param<super::super::System::Com::IStream>,
    {
        unsafe {
    ...
    pub unsafe fn CreateInstance(&self) -> windows_result::Result<IWICBitmapDecoder> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWICBitmapDecoderInfo_Impl: IWICBitmapCodecInfo_Impl {
    fn GetPatterns(&self, cbsizepatterns: u32, ppatterns: *mut WICBitmapPattern, pcpatterns: *mut u32, pcbpatternsactual: *mut u32) -> windows_result::Result<()>;
    fn MatchesPattern(&self, pistream: windows_core::Ref<super::super::System::Com::IStream>) -> windows_result::Result<windows_core::BOOL>;
    fn CreateInstance(&self) -> windows_result::Result<IWICBitmapDecoder>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWICBitmapEncoder {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Initialize<P0>(&self, pistream: P0, cacheoption: WICBitmapEncoderCacheOption) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::System::Com::IStream>,
    {
    ...
    pub unsafe fn GetEncoderInfo(&self) -> windows_result::Result<IWICBitmapEncoderInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetColorContexts(&self, ppicolorcontext: &[Option<IWICColorContext>]) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetThumbnail<P0>(&self, pithumbnail: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IWICBitmapSource>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetThumbnail)(windows_core::Interface::as_raw(self), pithumbnail.param().abi()).ok() }
    }
    pub unsafe fn SetPreview<P0>(&self, pipreview: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IWICBitmapSource>,
    {
    ...
    pub unsafe fn CreateNewFrame(&self, ppiframeencode: *mut Option<IWICBitmapFrameEncode>, ppiencoderoptions: *mut Option<super::super::System::Com::StructuredStorage::IPropertyBag2>) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetMetadataQueryWriter(&self) -> windows_result::Result<IWICMetadataQueryWriter> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWICBitmapEncoder_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, pistream: windows_core::Ref<super::super::System::Com::IStream>, cacheoption: WICBitmapEncoderCacheOption) -> windows_result::Result<()>;
    fn GetContainerFormat(&self) -> windows_result::Result<windows_core::GUID>;
    fn GetEncoderInfo(&self) -> windows_result::Result<IWICBitmapEncoderInfo>;
    fn SetColorContexts(&self, ccount: u32, ppicolorcontext: *const Option<IWICColorContext>) -> windows_result::Result<()>;
    fn SetPalette(&self, pipalette: windows_core::Ref<IWICPalette>) -> windows_result::Result<()>;
    fn SetThumbnail(&self, pithumbnail: windows_core::Ref<IWICBitmapSource>) -> windows_result::Result<()>;
    fn SetPreview(&self, pipreview: windows_core::Ref<IWICBitmapSource>) -> windows_result::Result<()>;
    fn CreateNewFrame(&self, ppiframeencode: windows_core::OutRef<IWICBitmapFrameEncode>, ppiencoderoptions: windows_core::OutRef<super::super::System::Com::StructuredStorage::IPropertyBag2>) -> windows_result::Result<()>;
    fn Commit(&self) -> windows_result::Result<()>;
    fn GetMetadataQueryWriter(&self) -> windows_result::Result<IWICMetadataQueryWriter>;
}
#[cfg(feature = "Win32_System_Com_StructuredStorage")]
...
impl IWICBitmapEncoderInfo {
    pub unsafe fn CreateInstance(&self) -> windows_result::Result<IWICBitmapEncoder> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateInstance)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IWICBitmapEncoderInfo_Impl: IWICBitmapCodecInfo_Impl {
    fn CreateInstance(&self) -> windows_result::Result<IWICBitmapEncoder>;
}
...
impl IWICBitmapFlipRotator {
    pub unsafe fn Initialize<P0>(&self, pisource: P0, options: WICBitmapTransformOptions) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IWICBitmapSource>,
    {
...
pub trait IWICBitmapFlipRotator_Impl: IWICBitmapSource_Impl {
    fn Initialize(&self, pisource: windows_core::Ref<IWICBitmapSource>, options: WICBitmapTransformOptions) -> windows_result::Result<()>;
}
...
impl IWICBitmapFrameEncode {
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn Initialize<P0>(&self, piencoderoptions: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn SetSize(&self, uiwidth: u32, uiheight: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetSize)(windows_core::Interface::as_raw(self), uiwidth, uiheight).ok() }
    }
    pub unsafe fn SetResolution(&self, dpix: f64, dpiy: f64) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetResolution)(windows_core::Interface::as_raw(self), dpix, dpiy).ok() }
    }
    pub unsafe fn SetPixelFormat(&self, ppixelformat: *mut windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn WritePixels(&self, linecount: u32, cbstride: u32, pbpixels: &[u8]) -> windows_result::Result<()> {
    ...
    pub unsafe fn WriteSource<P0>(&self, pibitmapsource: P0, prc: *const WICRect) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IWICBitmapSource>,
    {
...
pub trait IWICBitmapFrameEncode_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, piencoderoptions: windows_core::Ref<super::super::System::Com::StructuredStorage::IPropertyBag2>) -> windows_result::Result<()>;
    fn SetSize(&self, uiwidth: u32, uiheight: u32) -> windows_result::Result<()>;
    fn SetResolution(&self, dpix: f64, dpiy: f64) -> windows_result::Result<()>;
    fn SetPixelFormat(&self, ppixelformat: *mut windows_core::GUID) -> windows_result::Result<()>;
    fn SetColorContexts(&self, ccount: u32, ppicolorcontext: *const Option<IWICColorContext>) -> windows_result::Result<()>;
    fn SetPalette(&self, pipalette: windows_core::Ref<IWICPalette>) -> windows_result::Result<()>;
    fn SetThumbnail(&self, pithumbnail: windows_core::Ref<IWICBitmapSource>) -> windows_result::Result<()>;
    fn WritePixels(&self, linecount: u32, cbstride: u32, cbbuffersize: u32, pbpixels: *const u8) -> windows_result::Result<()>;
    fn WriteSource(&self, pibitmapsource: windows_core::Ref<IWICBitmapSource>, prc: *const WICRect) -> windows_result::Result<()>;
    fn Commit(&self) -> windows_result::Result<()>;
    fn GetMetadataQueryWriter(&self) -> windows_result::Result<IWICMetadataQueryWriter>;
}
#[cfg(feature = "Win32_System_Com_StructuredStorage")]
...
impl IWICBitmapLock {
    pub unsafe fn GetSize(&self, puiwidth: *mut u32, puiheight: *mut u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetSize)(windows_core::Interface::as_raw(self), puiwidth as _, puiheight as _).ok() }
    }
    pub unsafe fn GetStride(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetStride)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetDataPointer(&self, pcbbuffersize: *mut u32, ppbdata: *mut *mut u8) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetPixelFormat(&self) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWICBitmapLock_Impl: windows_core::IUnknownImpl {
    fn GetSize(&self, puiwidth: *mut u32, puiheight: *mut u32) -> windows_result::Result<()>;
    fn GetStride(&self) -> windows_result::Result<u32>;
    fn GetDataPointer(&self, pcbbuffersize: *mut u32, ppbdata: *mut *mut u8) -> windows_result::Result<()>;
    fn GetPixelFormat(&self) -> windows_result::Result<windows_core::GUID>;
}
...
impl IWICBitmapScaler {
    pub unsafe fn Initialize<P0>(&self, pisource: P0, uiwidth: u32, uiheight: u32, mode: WICBitmapInterpolationMode) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IWICBitmapSource>,
    {
...
pub trait IWICBitmapScaler_Impl: IWICBitmapSource_Impl {
    fn Initialize(&self, pisource: windows_core::Ref<IWICBitmapSource>, uiwidth: u32, uiheight: u32, mode: WICBitmapInterpolationMode) -> windows_result::Result<()>;
}
...
impl IWICBitmapSource {
    ...
    pub unsafe fn GetResolution(&self, pdpix: *mut f64, pdpiy: *mut f64) -> windows_result::Result<()> {
    ...
    pub unsafe fn CopyPixels(&self, prc: *const WICRect, cbstride: u32, pbbuffer: &mut [u8]) -> windows_result::Result<()> {
...
pub trait IWICBitmapSource_Impl: windows_core::IUnknownImpl {
    fn GetSize(&self, puiwidth: *mut u32, puiheight: *mut u32) -> windows_result::Result<()>;
    fn GetPixelFormat(&self) -> windows_result::Result<windows_core::GUID>;
    fn GetResolution(&self, pdpix: *mut f64, pdpiy: *mut f64) -> windows_result::Result<()>;
    fn CopyPalette(&self, pipalette: windows_core::Ref<IWICPalette>) -> windows_result::Result<()>;
    fn CopyPixels(&self, prc: *const WICRect, cbstride: u32, cbbuffersize: u32, pbbuffer: *mut u8) -> windows_result::Result<()>;
}
...
impl IWICBitmapSourceTransform {
    pub unsafe fn CopyPixels(&self, prc: *const WICRect, uiwidth: u32, uiheight: u32, pguiddstformat: *const windows_core::GUID, dsttransform: WICBitmapTransformOptions, nstride: u32, pbbuffer: &mut [u8]) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetClosestSize(&self, puiwidth: *mut u32, puiheight: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetClosestPixelFormat(&self, pguiddstformat: *mut windows_core::GUID) -> windows_result::Result<()> {
    ...
    pub unsafe fn DoesSupportTransform(&self, dsttransform: WICBitmapTransformOptions) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWICBitmapSourceTransform_Impl: windows_core::IUnknownImpl {
    fn CopyPixels(&self, prc: *const WICRect, uiwidth: u32, uiheight: u32, pguiddstformat: *const windows_core::GUID, dsttransform: WICBitmapTransformOptions, nstride: u32, cbbuffersize: u32, pbbuffer: *mut u8) -> windows_result::Result<()>;
    fn GetClosestSize(&self, puiwidth: *mut u32, puiheight: *mut u32) -> windows_result::Result<()>;
    fn GetClosestPixelFormat(&self, pguiddstformat: *mut windows_core::GUID) -> windows_result::Result<()>;
    fn DoesSupportTransform(&self, dsttransform: WICBitmapTransformOptions) -> windows_result::Result<windows_core::BOOL>;
}
...
impl IWICColorContext {
    pub unsafe fn InitializeFromFilename<P0>(&self, wzfilename: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn InitializeFromMemory(&self, pbbuffer: &[u8]) -> windows_result::Result<()> {
    ...
    pub unsafe fn InitializeFromExifColorSpace(&self, value: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).InitializeFromExifColorSpace)(windows_core::Interface::as_raw(self), value).ok() }
    }
    pub unsafe fn GetType(&self) -> windows_result::Result<WICColorContextType> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetType)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetProfileBytes(&self, pbbuffer: &mut [u8], pcbactual: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetExifColorSpace(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWICColorContext_Impl: windows_core::IUnknownImpl {
    fn InitializeFromFilename(&self, wzfilename: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn InitializeFromMemory(&self, pbbuffer: *const u8, cbbuffersize: u32) -> windows_result::Result<()>;
    fn InitializeFromExifColorSpace(&self, value: u32) -> windows_result::Result<()>;
    fn GetType(&self) -> windows_result::Result<WICColorContextType>;
    fn GetProfileBytes(&self, cbbuffer: u32, pbbuffer: *mut u8, pcbactual: *mut u32) -> windows_result::Result<()>;
    fn GetExifColorSpace(&self) -> windows_result::Result<u32>;
}
...
impl IWICColorTransform {
    pub unsafe fn Initialize<P0, P1, P2>(&self, pibitmapsource: P0, picontextsource: P1, picontextdest: P2, pixelfmtdest: *const windows_core::GUID) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IWICBitmapSource>,
...
pub trait IWICColorTransform_Impl: IWICBitmapSource_Impl {
    fn Initialize(&self, pibitmapsource: windows_core::Ref<IWICBitmapSource>, picontextsource: windows_core::Ref<IWICColorContext>, picontextdest: windows_core::Ref<IWICColorContext>, pixelfmtdest: *const windows_core::GUID) -> windows_result::Result<()>;
}
...
impl IWICComponentFactory {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateMetadataReader<P3>(&self, guidmetadataformat: *const windows_core::GUID, pguidvendor: *const windows_core::GUID, dwoptions: u32, pistream: P3) -> windows_result::Result<IWICMetadataReader>
    where
        P3: windows_core::Param<super::super::System::Com::IStream>,
    {
        unsafe {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateMetadataReaderFromContainer<P3>(&self, guidcontainerformat: *const windows_core::GUID, pguidvendor: *const windows_core::GUID, dwoptions: u32, pistream: P3) -> windows_result::Result<IWICMetadataReader>
    where
        P3: windows_core::Param<super::super::System::Com::IStream>,
    {
        unsafe {
    ...
    pub unsafe fn CreateMetadataWriter(&self, guidmetadataformat: *const windows_core::GUID, pguidvendor: *const windows_core::GUID, dwmetadataoptions: u32) -> windows_result::Result<IWICMetadataWriter> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateMetadataWriterFromReader<P0>(&self, pireader: P0, pguidvendor: *const windows_core::GUID) -> windows_result::Result<IWICMetadataWriter>
    where
    ...
    pub unsafe fn CreateQueryReaderFromBlockReader<P0>(&self, piblockreader: P0) -> windows_result::Result<IWICMetadataQueryReader>
    where
    ...
    pub unsafe fn CreateQueryWriterFromBlockWriter<P0>(&self, piblockwriter: P0) -> windows_result::Result<IWICMetadataQueryWriter>
    where
    ...
    pub unsafe fn CreateEncoderPropertyBag(&self, ppropoptions: &[super::super::System::Com::StructuredStorage::PROPBAG2]) -> windows_result::Result<super::super::System::Com::StructuredStorage::IPropertyBag2> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWICComponentFactory_Impl: IWICImagingFactory_Impl {
    fn CreateMetadataReader(&self, guidmetadataformat: *const windows_core::GUID, pguidvendor: *const windows_core::GUID, dwoptions: u32, pistream: windows_core::Ref<super::super::System::Com::IStream>) -> windows_result::Result<IWICMetadataReader>;
    fn CreateMetadataReaderFromContainer(&self, guidcontainerformat: *const windows_core::GUID, pguidvendor: *const windows_core::GUID, dwoptions: u32, pistream: windows_core::Ref<super::super::System::Com::IStream>) -> windows_result::Result<IWICMetadataReader>;
    fn CreateMetadataWriter(&self, guidmetadataformat: *const windows_core::GUID, pguidvendor: *const windows_core::GUID, dwmetadataoptions: u32) -> windows_result::Result<IWICMetadataWriter>;
    fn CreateMetadataWriterFromReader(&self, pireader: windows_core::Ref<IWICMetadataReader>, pguidvendor: *const windows_core::GUID) -> windows_result::Result<IWICMetadataWriter>;
    fn CreateQueryReaderFromBlockReader(&self, piblockreader: windows_core::Ref<IWICMetadataBlockReader>) -> windows_result::Result<IWICMetadataQueryReader>;
    fn CreateQueryWriterFromBlockWriter(&self, piblockwriter: windows_core::Ref<IWICMetadataBlockWriter>) -> windows_result::Result<IWICMetadataQueryWriter>;
    fn CreateEncoderPropertyBag(&self, ppropoptions: *const super::super::System::Com::StructuredStorage::PROPBAG2, ccount: u32) -> windows_result::Result<super::super::System::Com::StructuredStorage::IPropertyBag2>;
}
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant", feature = "Win32_UI_WindowsAndMessaging"))]
...
impl IWICComponentInfo {
    ...
    pub unsafe fn GetVendorGUID(&self) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetVendorGUID)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetVersion(&self, wzversion: &mut [u16], pcchactual: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetSpecVersion(&self, wzspecversion: &mut [u16], pcchactual: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFriendlyName(&self, wzfriendlyname: &mut [u16], pcchactual: *mut u32) -> windows_result::Result<()> {
...
pub trait IWICComponentInfo_Impl: windows_core::IUnknownImpl {
    fn GetComponentType(&self) -> windows_result::Result<WICComponentType>;
    fn GetCLSID(&self) -> windows_result::Result<windows_core::GUID>;
    fn GetSigningStatus(&self) -> windows_result::Result<u32>;
    fn GetAuthor(&self, cchauthor: u32, wzauthor: windows_core::PWSTR, pcchactual: *mut u32) -> windows_result::Result<()>;
    fn GetVendorGUID(&self) -> windows_result::Result<windows_core::GUID>;
    fn GetVersion(&self, cchversion: u32, wzversion: windows_core::PWSTR, pcchactual: *mut u32) -> windows_result::Result<()>;
    fn GetSpecVersion(&self, cchspecversion: u32, wzspecversion: windows_core::PWSTR, pcchactual: *mut u32) -> windows_result::Result<()>;
    fn GetFriendlyName(&self, cchfriendlyname: u32, wzfriendlyname: windows_core::PWSTR, pcchactual: *mut u32) -> windows_result::Result<()>;
}
...
impl IWICDdsDecoder {
    ...
    pub unsafe fn GetParameters(&self, pparameters: *mut WICDdsParameters) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetParameters)(windows_core::Interface::as_raw(self), pparameters as _).ok() }
    }
    pub unsafe fn GetFrame(&self, arrayindex: u32, miplevel: u32, sliceindex: u32) -> windows_result::Result<IWICBitmapFrameDecode> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWICDdsDecoder_Impl: windows_core::IUnknownImpl {
    fn GetParameters(&self, pparameters: *mut WICDdsParameters) -> windows_result::Result<()>;
    fn GetFrame(&self, arrayindex: u32, miplevel: u32, sliceindex: u32) -> windows_result::Result<IWICBitmapFrameDecode>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IWICDdsEncoder {
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn SetParameters(&self, pparameters: *const WICDdsParameters) -> windows_result::Result<()> {
    ...
    pub unsafe fn CreateNewFrame(&self, ppiframeencode: *mut Option<IWICBitmapFrameEncode>, parrayindex: *mut u32, pmiplevel: *mut u32, psliceindex: *mut u32) -> windows_result::Result<()> {
...
pub trait IWICDdsEncoder_Impl: windows_core::IUnknownImpl {
    fn SetParameters(&self, pparameters: *const WICDdsParameters) -> windows_result::Result<()>;
    fn GetParameters(&self, pparameters: *mut WICDdsParameters) -> windows_result::Result<()>;
    fn CreateNewFrame(&self, ppiframeencode: windows_core::OutRef<IWICBitmapFrameEncode>, parrayindex: *mut u32, pmiplevel: *mut u32, psliceindex: *mut u32) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IWICDdsFrameDecode {
    pub unsafe fn GetSizeInBlocks(&self, pwidthinblocks: *mut u32, pheightinblocks: *mut u32) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn GetFormatInfo(&self) -> windows_result::Result<WICDdsFormatInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFormatInfo)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn CopyBlocks(&self, prcboundsinblocks: *const WICRect, cbstride: u32, pbbuffer: &mut [u8]) -> windows_result::Result<()> {
...
pub trait IWICDdsFrameDecode_Impl: windows_core::IUnknownImpl {
    fn GetSizeInBlocks(&self, pwidthinblocks: *mut u32, pheightinblocks: *mut u32) -> windows_result::Result<()>;
    fn GetFormatInfo(&self) -> windows_result::Result<WICDdsFormatInfo>;
    fn CopyBlocks(&self, prcboundsinblocks: *const WICRect, cbstride: u32, cbbuffersize: u32, pbbuffer: *mut u8) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IWICDevelopRaw {
    pub unsafe fn QueryRawCapabilitiesInfo(&self, pinfo: *mut WICRawCapabilitiesInfo) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).QueryRawCapabilitiesInfo)(windows_core::Interface::as_raw(self), pinfo as _).ok() }
    }
    pub unsafe fn LoadParameterSet(&self, parameterset: WICRawParameterSet) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).LoadParameterSet)(windows_core::Interface::as_raw(self), parameterset).ok() }
    }
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn GetCurrentParameterSet(&self) -> windows_result::Result<super::super::System::Com::StructuredStorage::IPropertyBag2> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetToneCurve(&self, cbtonecurvesize: u32, ptonecurve: *const WICRawToneCurve) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetToneCurve)(windows_core::Interface::as_raw(self), cbtonecurvesize, ptonecurve).ok() }
    }
    pub unsafe fn GetToneCurve(&self, cbtonecurvebuffersize: u32, ptonecurve: Option<*mut WICRawToneCurve>, pcbactualtonecurvebuffersize: Option<*mut u32>) -> windows_result::Result<()> {
...
pub trait IWICDevelopRaw_Impl: IWICBitmapFrameDecode_Impl {
    fn QueryRawCapabilitiesInfo(&self, pinfo: *mut WICRawCapabilitiesInfo) -> windows_result::Result<()>;
    fn LoadParameterSet(&self, parameterset: WICRawParameterSet) -> windows_result::Result<()>;
    fn GetCurrentParameterSet(&self) -> windows_result::Result<super::super::System::Com::StructuredStorage::IPropertyBag2>;
    fn SetExposureCompensation(&self, ev: f64) -> windows_result::Result<()>;
    fn GetExposureCompensation(&self) -> windows_result::Result<f64>;
    fn SetWhitePointRGB(&self, red: u32, green: u32, blue: u32) -> windows_result::Result<()>;
    fn GetWhitePointRGB(&self, pred: *mut u32, pgreen: *mut u32, pblue: *mut u32) -> windows_result::Result<()>;
    fn SetNamedWhitePoint(&self, whitepoint: WICNamedWhitePoint) -> windows_result::Result<()>;
    fn GetNamedWhitePoint(&self) -> windows_result::Result<WICNamedWhitePoint>;
    fn SetWhitePointKelvin(&self, whitepointkelvin: u32) -> windows_result::Result<()>;
    fn GetWhitePointKelvin(&self) -> windows_result::Result<u32>;
    fn GetKelvinRangeInfo(&self, pminkelvintemp: *mut u32, pmaxkelvintemp: *mut u32, pkelvintempstepvalue: *mut u32) -> windows_result::Result<()>;
    fn SetContrast(&self, contrast: f64) -> windows_result::Result<()>;
    fn GetContrast(&self) -> windows_result::Result<f64>;
    fn SetGamma(&self, gamma: f64) -> windows_result::Result<()>;
    fn GetGamma(&self) -> windows_result::Result<f64>;
    fn SetSharpness(&self, sharpness: f64) -> windows_result::Result<()>;
    fn GetSharpness(&self) -> windows_result::Result<f64>;
    fn SetSaturation(&self, saturation: f64) -> windows_result::Result<()>;
    fn GetSaturation(&self) -> windows_result::Result<f64>;
    fn SetTint(&self, tint: f64) -> windows_result::Result<()>;
    fn GetTint(&self) -> windows_result::Result<f64>;
    fn SetNoiseReduction(&self, noisereduction: f64) -> windows_result::Result<()>;
    fn GetNoiseReduction(&self) -> windows_result::Result<f64>;
    fn SetDestinationColorContext(&self, pcolorcontext: windows_core::Ref<IWICColorContext>) -> windows_result::Result<()>;
    fn SetToneCurve(&self, cbtonecurvesize: u32, ptonecurve: *const WICRawToneCurve) -> windows_result::Result<()>;
    fn GetToneCurve(&self, cbtonecurvebuffersize: u32, ptonecurve: *mut WICRawToneCurve, pcbactualtonecurvebuffersize: *mut u32) -> windows_result::Result<()>;
    fn SetRotation(&self, rotation: f64) -> windows_result::Result<()>;
    fn GetRotation(&self) -> windows_result::Result<f64>;
    fn SetRenderMode(&self, rendermode: WICRawRenderMode) -> windows_result::Result<()>;
    fn GetRenderMode(&self) -> windows_result::Result<WICRawRenderMode>;
    fn SetNotificationCallback(&self, pcallback: windows_core::Ref<IWICDevelopRawNotificationCallback>) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com_StructuredStorage")]
...
impl IWICDevelopRawNotificationCallback {
    pub unsafe fn Notify(&self, notificationmask: u32) -> windows_result::Result<()> {
...
pub trait IWICDevelopRawNotificationCallback_Impl: windows_core::IUnknownImpl {
    fn Notify(&self, notificationmask: u32) -> windows_result::Result<()>;
}
...
impl IWICEnumMetadataItem {
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn Next(&self, celt: u32, rgeltschema: *mut super::super::System::Com::StructuredStorage::PROPVARIANT, rgeltid: *mut super::super::System::Com::StructuredStorage::PROPVARIANT, rgeltvalue: *mut super::super::System::Com::StructuredStorage::PROPVARIANT, pceltfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IWICEnumMetadataItem> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWICEnumMetadataItem_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, rgeltschema: *mut super::super::System::Com::StructuredStorage::PROPVARIANT, rgeltid: *mut super::super::System::Com::StructuredStorage::PROPVARIANT, rgeltvalue: *mut super::super::System::Com::StructuredStorage::PROPVARIANT, pceltfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, celt: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IWICEnumMetadataItem>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl IWICFormatConverter {
    pub unsafe fn Initialize<P0, P3>(&self, pisource: P0, dstformat: *const windows_core::GUID, dither: WICBitmapDitherType, pipalette: P3, alphathresholdpercent: f64, palettetranslate: WICBitmapPaletteType) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IWICBitmapSource>,
    ...
    pub unsafe fn CanConvert(&self, srcpixelformat: *const windows_core::GUID, dstpixelformat: *const windows_core::GUID) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWICFormatConverter_Impl: IWICBitmapSource_Impl {
    fn Initialize(&self, pisource: windows_core::Ref<IWICBitmapSource>, dstformat: *const windows_core::GUID, dither: WICBitmapDitherType, pipalette: windows_core::Ref<IWICPalette>, alphathresholdpercent: f64, palettetranslate: WICBitmapPaletteType) -> windows_result::Result<()>;
    fn CanConvert(&self, srcpixelformat: *const windows_core::GUID, dstpixelformat: *const windows_core::GUID) -> windows_result::Result<windows_core::BOOL>;
}
...
impl IWICFormatConverterInfo {
    pub unsafe fn GetPixelFormats(&self, ppixelformatguids: &mut [windows_core::GUID], pcactual: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn CreateInstance(&self) -> windows_result::Result<IWICFormatConverter> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateInstance)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IWICFormatConverterInfo_Impl: IWICComponentInfo_Impl {
    fn GetPixelFormats(&self, cformats: u32, ppixelformatguids: *mut windows_core::GUID, pcactual: *mut u32) -> windows_result::Result<()>;
    fn CreateInstance(&self) -> windows_result::Result<IWICFormatConverter>;
}
...
impl IWICImagingFactory {
    pub unsafe fn CreateDecoderFromFilename<P0>(&self, wzfilename: P0, pguidvendor: Option<*const windows_core::GUID>, dwdesiredaccess: super::super::Foundation::GENERIC_ACCESS_RIGHTS, metadataoptions: WICDecodeOptions) -> windows_result::Result<IWICBitmapDecoder>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateDecoderFromStream<P0>(&self, pistream: P0, pguidvendor: *const windows_core::GUID, metadataoptions: WICDecodeOptions) -> windows_result::Result<IWICBitmapDecoder>
    where
        P0: windows_core::Param<super::super::System::Com::IStream>,
    {
        unsafe {
    ...
    pub unsafe fn CreateDecoderFromFileHandle(&self, hfile: usize, pguidvendor: *const windows_core::GUID, metadataoptions: WICDecodeOptions) -> windows_result::Result<IWICBitmapDecoder> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateComponentInfo(&self, clsidcomponent: *const windows_core::GUID) -> windows_result::Result<IWICComponentInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateDecoder(&self, guidcontainerformat: *const windows_core::GUID, pguidvendor: *const windows_core::GUID) -> windows_result::Result<IWICBitmapDecoder> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateEncoder(&self, guidcontainerformat: *const windows_core::GUID, pguidvendor: *const windows_core::GUID) -> windows_result::Result<IWICBitmapEncoder> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreatePalette(&self) -> windows_result::Result<IWICPalette> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateFormatConverter(&self) -> windows_result::Result<IWICFormatConverter> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateBitmapScaler(&self) -> windows_result::Result<IWICBitmapScaler> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateBitmapClipper(&self) -> windows_result::Result<IWICBitmapClipper> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateBitmapFlipRotator(&self) -> windows_result::Result<IWICBitmapFlipRotator> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateStream(&self) -> windows_result::Result<IWICStream> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateColorContext(&self) -> windows_result::Result<IWICColorContext> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateColorTransformer(&self) -> windows_result::Result<IWICColorTransform> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateBitmap(&self, uiwidth: u32, uiheight: u32, pixelformat: *const windows_core::GUID, option: WICBitmapCreateCacheOption) -> windows_result::Result<IWICBitmap> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateBitmapFromSource<P0>(&self, pibitmapsource: P0, option: WICBitmapCreateCacheOption) -> windows_result::Result<IWICBitmap>
    where
        P0: windows_core::Param<IWICBitmapSource>,
    {
        unsafe {
    ...
    pub unsafe fn CreateBitmapFromSourceRect<P0>(&self, pibitmapsource: P0, x: u32, y: u32, width: u32, height: u32) -> windows_result::Result<IWICBitmap>
    where
        P0: windows_core::Param<IWICBitmapSource>,
    {
        unsafe {
    ...
    pub unsafe fn CreateBitmapFromMemory(&self, uiwidth: u32, uiheight: u32, pixelformat: *const windows_core::GUID, cbstride: u32, pbbuffer: &[u8]) -> windows_result::Result<IWICBitmap> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateBitmapFromHBITMAP(&self, hbitmap: super::Gdi::HBITMAP, hpalette: super::Gdi::HPALETTE, options: WICBitmapAlphaChannelOption) -> windows_result::Result<IWICBitmap> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateBitmapFromHICON(&self, hicon: super::super::UI::WindowsAndMessaging::HICON) -> windows_result::Result<IWICBitmap> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateComponentEnumerator(&self, componenttypes: u32, options: u32) -> windows_result::Result<super::super::System::Com::IEnumUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateFastMetadataEncoderFromDecoder<P0>(&self, pidecoder: P0) -> windows_result::Result<IWICFastMetadataEncoder>
    where
    ...
    pub unsafe fn CreateFastMetadataEncoderFromFrameDecode<P0>(&self, piframedecoder: P0) -> windows_result::Result<IWICFastMetadataEncoder>
    where
    ...
    pub unsafe fn CreateQueryWriter(&self, guidmetadataformat: *const windows_core::GUID, pguidvendor: *const windows_core::GUID) -> windows_result::Result<IWICMetadataQueryWriter> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateQueryWriterFromReader<P0>(&self, piqueryreader: P0, pguidvendor: *const windows_core::GUID) -> windows_result::Result<IWICMetadataQueryWriter>
    where
...
pub trait IWICImagingFactory_Impl: windows_core::IUnknownImpl {
    fn CreateDecoderFromFilename(&self, wzfilename: &windows_core::PCWSTR, pguidvendor: *const windows_core::GUID, dwdesiredaccess: super::super::Foundation::GENERIC_ACCESS_RIGHTS, metadataoptions: WICDecodeOptions) -> windows_result::Result<IWICBitmapDecoder>;
    fn CreateDecoderFromStream(&self, pistream: windows_core::Ref<super::super::System::Com::IStream>, pguidvendor: *const windows_core::GUID, metadataoptions: WICDecodeOptions) -> windows_result::Result<IWICBitmapDecoder>;
    fn CreateDecoderFromFileHandle(&self, hfile: usize, pguidvendor: *const windows_core::GUID, metadataoptions: WICDecodeOptions) -> windows_result::Result<IWICBitmapDecoder>;
    fn CreateComponentInfo(&self, clsidcomponent: *const windows_core::GUID) -> windows_result::Result<IWICComponentInfo>;
    fn CreateDecoder(&self, guidcontainerformat: *const windows_core::GUID, pguidvendor: *const windows_core::GUID) -> windows_result::Result<IWICBitmapDecoder>;
    fn CreateEncoder(&self, guidcontainerformat: *const windows_core::GUID, pguidvendor: *const windows_core::GUID) -> windows_result::Result<IWICBitmapEncoder>;
    fn CreatePalette(&self) -> windows_result::Result<IWICPalette>;
    fn CreateFormatConverter(&self) -> windows_result::Result<IWICFormatConverter>;
    fn CreateBitmapScaler(&self) -> windows_result::Result<IWICBitmapScaler>;
    fn CreateBitmapClipper(&self) -> windows_result::Result<IWICBitmapClipper>;
    fn CreateBitmapFlipRotator(&self) -> windows_result::Result<IWICBitmapFlipRotator>;
    fn CreateStream(&self) -> windows_result::Result<IWICStream>;
    fn CreateColorContext(&self) -> windows_result::Result<IWICColorContext>;
    fn CreateColorTransformer(&self) -> windows_result::Result<IWICColorTransform>;
    fn CreateBitmap(&self, uiwidth: u32, uiheight: u32, pixelformat: *const windows_core::GUID, option: WICBitmapCreateCacheOption) -> windows_result::Result<IWICBitmap>;
    fn CreateBitmapFromSource(&self, pibitmapsource: windows_core::Ref<IWICBitmapSource>, option: WICBitmapCreateCacheOption) -> windows_result::Result<IWICBitmap>;
    fn CreateBitmapFromSourceRect(&self, pibitmapsource: windows_core::Ref<IWICBitmapSource>, x: u32, y: u32, width: u32, height: u32) -> windows_result::Result<IWICBitmap>;
    fn CreateBitmapFromMemory(&self, uiwidth: u32, uiheight: u32, pixelformat: *const windows_core::GUID, cbstride: u32, cbbuffersize: u32, pbbuffer: *const u8) -> windows_result::Result<IWICBitmap>;
    fn CreateBitmapFromHBITMAP(&self, hbitmap: super::Gdi::HBITMAP, hpalette: super::Gdi::HPALETTE, options: WICBitmapAlphaChannelOption) -> windows_result::Result<IWICBitmap>;
    fn CreateBitmapFromHICON(&self, hicon: super::super::UI::WindowsAndMessaging::HICON) -> windows_result::Result<IWICBitmap>;
    fn CreateComponentEnumerator(&self, componenttypes: u32, options: u32) -> windows_result::Result<super::super::System::Com::IEnumUnknown>;
    fn CreateFastMetadataEncoderFromDecoder(&self, pidecoder: windows_core::Ref<IWICBitmapDecoder>) -> windows_result::Result<IWICFastMetadataEncoder>;
    fn CreateFastMetadataEncoderFromFrameDecode(&self, piframedecoder: windows_core::Ref<IWICBitmapFrameDecode>) -> windows_result::Result<IWICFastMetadataEncoder>;
    fn CreateQueryWriter(&self, guidmetadataformat: *const windows_core::GUID, pguidvendor: *const windows_core::GUID) -> windows_result::Result<IWICMetadataQueryWriter>;
    fn CreateQueryWriterFromReader(&self, piqueryreader: windows_core::Ref<IWICMetadataQueryReader>, pguidvendor: *const windows_core::GUID) -> windows_result::Result<IWICMetadataQueryWriter>;
}
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_System_Com", feature = "Win32_UI_WindowsAndMessaging"))]
...
impl IWICJpegFrameDecode {
    pub unsafe fn DoesSupportIndexing(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DoesSupportIndexing)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetIndexing(&self, options: WICJpegIndexingOptions, horizontalintervalsize: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn ClearIndexing(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ClearIndexing)(windows_core::Interface::as_raw(self)).ok() }
    }
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn GetAcHuffmanTable(&self, scanindex: u32, tableindex: u32, pachuffmantable: *mut super::Dxgi::Common::DXGI_JPEG_AC_HUFFMAN_TABLE) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn GetDcHuffmanTable(&self, scanindex: u32, tableindex: u32, pdchuffmantable: *mut super::Dxgi::Common::DXGI_JPEG_DC_HUFFMAN_TABLE) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn GetQuantizationTable(&self, scanindex: u32, tableindex: u32, pquantizationtable: *mut super::Dxgi::Common::DXGI_JPEG_QUANTIZATION_TABLE) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetFrameHeader(&self, pframeheader: *mut WICJpegFrameHeader) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetFrameHeader)(windows_core::Interface::as_raw(self), pframeheader as _).ok() }
    }
    pub unsafe fn GetScanHeader(&self, scanindex: u32, pscanheader: *mut WICJpegScanHeader) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetScanHeader)(windows_core::Interface::as_raw(self), scanindex, pscanheader as _).ok() }
    }
    pub unsafe fn CopyScan(&self, scanindex: u32, scanoffset: u32, pbscandata: &mut [u8], pcbscandataactual: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn CopyMinimalStream(&self, streamoffset: u32, pbstreamdata: &mut [u8], pcbstreamdataactual: *mut u32) -> windows_result::Result<()> {
...
pub trait IWICJpegFrameDecode_Impl: windows_core::IUnknownImpl {
    fn DoesSupportIndexing(&self) -> windows_result::Result<windows_core::BOOL>;
    fn SetIndexing(&self, options: WICJpegIndexingOptions, horizontalintervalsize: u32) -> windows_result::Result<()>;
    fn ClearIndexing(&self) -> windows_result::Result<()>;
    fn GetAcHuffmanTable(&self, scanindex: u32, tableindex: u32, pachuffmantable: *mut super::Dxgi::Common::DXGI_JPEG_AC_HUFFMAN_TABLE) -> windows_result::Result<()>;
    fn GetDcHuffmanTable(&self, scanindex: u32, tableindex: u32, pdchuffmantable: *mut super::Dxgi::Common::DXGI_JPEG_DC_HUFFMAN_TABLE) -> windows_result::Result<()>;
    fn GetQuantizationTable(&self, scanindex: u32, tableindex: u32, pquantizationtable: *mut super::Dxgi::Common::DXGI_JPEG_QUANTIZATION_TABLE) -> windows_result::Result<()>;
    fn GetFrameHeader(&self, pframeheader: *mut WICJpegFrameHeader) -> windows_result::Result<()>;
    fn GetScanHeader(&self, scanindex: u32, pscanheader: *mut WICJpegScanHeader) -> windows_result::Result<()>;
    fn CopyScan(&self, scanindex: u32, scanoffset: u32, cbscandata: u32, pbscandata: *mut u8, pcbscandataactual: *mut u32) -> windows_result::Result<()>;
    fn CopyMinimalStream(&self, streamoffset: u32, cbstreamdata: u32, pbstreamdata: *mut u8, pcbstreamdataactual: *mut u32) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IWICJpegFrameEncode {
    ...
    pub unsafe fn WriteScan(&self, pbscandata: &[u8]) -> windows_result::Result<()> {
...
pub trait IWICJpegFrameEncode_Impl: windows_core::IUnknownImpl {
    ...
    fn GetDcHuffmanTable(&self, scanindex: u32, tableindex: u32, pdchuffmantable: *mut super::Dxgi::Common::DXGI_JPEG_DC_HUFFMAN_TABLE) -> windows_result::Result<()>;
    fn GetQuantizationTable(&self, scanindex: u32, tableindex: u32, pquantizationtable: *mut super::Dxgi::Common::DXGI_JPEG_QUANTIZATION_TABLE) -> windows_result::Result<()>;
    fn WriteScan(&self, cbscandata: u32, pbscandata: *const u8) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IWICMetadataBlockReader {
    ...
    pub unsafe fn GetReaderByIndex(&self, nindex: u32) -> windows_result::Result<IWICMetadataReader> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetEnumerator(&self) -> windows_result::Result<super::super::System::Com::IEnumUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWICMetadataBlockReader_Impl: windows_core::IUnknownImpl {
    ...
    fn GetReaderByIndex(&self, nindex: u32) -> windows_result::Result<IWICMetadataReader>;
    fn GetEnumerator(&self) -> windows_result::Result<super::super::System::Com::IEnumUnknown>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWICMetadataBlockWriter {
    pub unsafe fn InitializeFromBlockReader<P0>(&self, pimdblockreader: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IWICMetadataBlockReader>,
    {
    ...
    pub unsafe fn GetWriterByIndex(&self, nindex: u32) -> windows_result::Result<IWICMetadataWriter> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AddWriter<P0>(&self, pimetadatawriter: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn SetWriterByIndex<P1>(&self, nindex: u32, pimetadatawriter: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<IWICMetadataWriter>,
    {
    ...
    pub unsafe fn RemoveWriterByIndex(&self, nindex: u32) -> windows_result::Result<()> {
...
pub trait IWICMetadataBlockWriter_Impl: IWICMetadataBlockReader_Impl {
    fn InitializeFromBlockReader(&self, pimdblockreader: windows_core::Ref<IWICMetadataBlockReader>) -> windows_result::Result<()>;
    fn GetWriterByIndex(&self, nindex: u32) -> windows_result::Result<IWICMetadataWriter>;
    fn AddWriter(&self, pimetadatawriter: windows_core::Ref<IWICMetadataWriter>) -> windows_result::Result<()>;
    fn SetWriterByIndex(&self, nindex: u32, pimetadatawriter: windows_core::Ref<IWICMetadataWriter>) -> windows_result::Result<()>;
    fn RemoveWriterByIndex(&self, nindex: u32) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWICMetadataHandlerInfo {
    pub unsafe fn GetMetadataFormat(&self) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetMetadataFormat)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetContainerFormats(&self, pguidcontainerformats: &mut [windows_core::GUID], pcchactual: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn DoesRequireFullStream(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DoesRequireFullStream)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn DoesSupportPadding(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DoesSupportPadding)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn DoesRequireFixedSize(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWICMetadataHandlerInfo_Impl: IWICComponentInfo_Impl {
    fn GetMetadataFormat(&self) -> windows_result::Result<windows_core::GUID>;
    fn GetContainerFormats(&self, ccontainerformats: u32, pguidcontainerformats: *mut windows_core::GUID, pcchactual: *mut u32) -> windows_result::Result<()>;
    fn GetDeviceManufacturer(&self, cchdevicemanufacturer: u32, wzdevicemanufacturer: windows_core::PWSTR, pcchactual: *mut u32) -> windows_result::Result<()>;
    fn GetDeviceModels(&self, cchdevicemodels: u32, wzdevicemodels: windows_core::PWSTR, pcchactual: *mut u32) -> windows_result::Result<()>;
    fn DoesRequireFullStream(&self) -> windows_result::Result<windows_core::BOOL>;
    fn DoesSupportPadding(&self) -> windows_result::Result<windows_core::BOOL>;
    fn DoesRequireFixedSize(&self) -> windows_result::Result<windows_core::BOOL>;
}
...
impl IWICMetadataQueryReader {
    ...
    pub unsafe fn GetLocation(&self, wznamespace: &mut [u16], pcchactuallength: *mut u32) -> windows_result::Result<()> {
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn GetMetadataByName<P0>(&self, wzname: P0, pvarvalue: *mut super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetEnumerator(&self) -> windows_result::Result<super::super::System::Com::IEnumString> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetEnumerator)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IWICMetadataQueryReader_Impl: windows_core::IUnknownImpl {
    fn GetContainerFormat(&self) -> windows_result::Result<windows_core::GUID>;
    fn GetLocation(&self, cchmaxlength: u32, wznamespace: windows_core::PWSTR, pcchactuallength: *mut u32) -> windows_result::Result<()>;
    fn GetMetadataByName(&self, wzname: &windows_core::PCWSTR, pvarvalue: *mut super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()>;
    fn GetEnumerator(&self) -> windows_result::Result<super::super::System::Com::IEnumString>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl IWICMetadataQueryWriter {
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn SetMetadataByName<P0>(&self, wzname: P0, pvarvalue: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn RemoveMetadataByName<P0>(&self, wzname: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IWICMetadataQueryWriter_Impl: IWICMetadataQueryReader_Impl {
    fn SetMetadataByName(&self, wzname: &windows_core::PCWSTR, pvarvalue: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()>;
    fn RemoveMetadataByName(&self, wzname: &windows_core::PCWSTR) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl IWICMetadataReader {
    ...
    pub unsafe fn GetMetadataHandlerInfo(&self) -> windows_result::Result<IWICMetadataHandlerInfo> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn GetValueByIndex(&self, nindex: u32, pvarschema: *mut super::super::System::Com::StructuredStorage::PROPVARIANT, pvarid: *mut super::super::System::Com::StructuredStorage::PROPVARIANT, pvarvalue: *mut super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()> {
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn GetValue(&self, pvarschema: *const super::super::System::Com::StructuredStorage::PROPVARIANT, pvarid: *const super::super::System::Com::StructuredStorage::PROPVARIANT, pvarvalue: *mut super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetEnumerator(&self) -> windows_result::Result<IWICEnumMetadataItem> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetEnumerator)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IWICMetadataReader_Impl: windows_core::IUnknownImpl {
    fn GetMetadataFormat(&self) -> windows_result::Result<windows_core::GUID>;
    fn GetMetadataHandlerInfo(&self) -> windows_result::Result<IWICMetadataHandlerInfo>;
    fn GetCount(&self) -> windows_result::Result<u32>;
    fn GetValueByIndex(&self, nindex: u32, pvarschema: *mut super::super::System::Com::StructuredStorage::PROPVARIANT, pvarid: *mut super::super::System::Com::StructuredStorage::PROPVARIANT, pvarvalue: *mut super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()>;
    fn GetValue(&self, pvarschema: *const super::super::System::Com::StructuredStorage::PROPVARIANT, pvarid: *const super::super::System::Com::StructuredStorage::PROPVARIANT, pvarvalue: *mut super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()>;
    fn GetEnumerator(&self) -> windows_result::Result<IWICEnumMetadataItem>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl IWICMetadataReaderInfo {
    pub unsafe fn GetPatterns(&self, guidcontainerformat: *const windows_core::GUID, cbsize: u32, ppattern: Option<*mut WICMetadataPattern>, pccount: Option<*mut u32>, pcbactual: Option<*mut u32>) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn MatchesPattern<P1>(&self, guidcontainerformat: *const windows_core::GUID, pistream: P1) -> windows_result::Result<windows_core::BOOL>
    where
    ...
    pub unsafe fn CreateInstance(&self) -> windows_result::Result<IWICMetadataReader> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateInstance)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IWICMetadataReaderInfo_Impl: IWICMetadataHandlerInfo_Impl {
    fn GetPatterns(&self, guidcontainerformat: *const windows_core::GUID, cbsize: u32, ppattern: *mut WICMetadataPattern, pccount: *mut u32, pcbactual: *mut u32) -> windows_result::Result<()>;
    fn MatchesPattern(&self, guidcontainerformat: *const windows_core::GUID, pistream: windows_core::Ref<super::super::System::Com::IStream>) -> windows_result::Result<windows_core::BOOL>;
    fn CreateInstance(&self) -> windows_result::Result<IWICMetadataReader>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWICMetadataWriter {
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn SetValue(&self, pvarschema: *const super::super::System::Com::StructuredStorage::PROPVARIANT, pvarid: *const super::super::System::Com::StructuredStorage::PROPVARIANT, pvarvalue: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()> {
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn SetValueByIndex(&self, nindex: u32, pvarschema: *const super::super::System::Com::StructuredStorage::PROPVARIANT, pvarid: *const super::super::System::Com::StructuredStorage::PROPVARIANT, pvarvalue: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()> {
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn RemoveValue(&self, pvarschema: *const super::super::System::Com::StructuredStorage::PROPVARIANT, pvarid: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()> {
    ...
    pub unsafe fn RemoveValueByIndex(&self, nindex: u32) -> windows_result::Result<()> {
...
pub trait IWICMetadataWriter_Impl: IWICMetadataReader_Impl {
    fn SetValue(&self, pvarschema: *const super::super::System::Com::StructuredStorage::PROPVARIANT, pvarid: *const super::super::System::Com::StructuredStorage::PROPVARIANT, pvarvalue: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()>;
    fn SetValueByIndex(&self, nindex: u32, pvarschema: *const super::super::System::Com::StructuredStorage::PROPVARIANT, pvarid: *const super::super::System::Com::StructuredStorage::PROPVARIANT, pvarvalue: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()>;
    fn RemoveValue(&self, pvarschema: *const super::super::System::Com::StructuredStorage::PROPVARIANT, pvarid: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()>;
    fn RemoveValueByIndex(&self, nindex: u32) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl IWICMetadataWriterInfo {
    pub unsafe fn GetHeader(&self, guidcontainerformat: *const windows_core::GUID, cbsize: u32, pheader: Option<*mut WICMetadataHeader>, pcbactual: Option<*mut u32>) -> windows_result::Result<()> {
    ...
    pub unsafe fn CreateInstance(&self) -> windows_result::Result<IWICMetadataWriter> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateInstance)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IWICMetadataWriterInfo_Impl: IWICMetadataHandlerInfo_Impl {
    fn GetHeader(&self, guidcontainerformat: *const windows_core::GUID, cbsize: u32, pheader: *mut WICMetadataHeader, pcbactual: *mut u32) -> windows_result::Result<()>;
    fn CreateInstance(&self) -> windows_result::Result<IWICMetadataWriter>;
}
...
impl IWICPalette {
    pub unsafe fn InitializePredefined(&self, epalettetype: WICBitmapPaletteType, faddtransparentcolor: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn InitializeCustom(&self, pcolors: &[u32]) -> windows_result::Result<()> {
    ...
    pub unsafe fn InitializeFromBitmap<P0>(&self, pisurface: P0, ccount: u32, faddtransparentcolor: bool) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IWICBitmapSource>,
    {
    ...
    pub unsafe fn InitializeFromPalette<P0>(&self, pipalette: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IWICPalette>,
    {
    ...
    pub unsafe fn GetType(&self) -> windows_result::Result<WICBitmapPaletteType> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetType)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetColorCount(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetColorCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetColors(&self, pcolors: &mut [u32], pcactualcolors: *mut u32) -> windows_result::Result<()> {
...
pub trait IWICPalette_Impl: windows_core::IUnknownImpl {
    fn InitializePredefined(&self, epalettetype: WICBitmapPaletteType, faddtransparentcolor: windows_core::BOOL) -> windows_result::Result<()>;
    fn InitializeCustom(&self, pcolors: *const u32, ccount: u32) -> windows_result::Result<()>;
    fn InitializeFromBitmap(&self, pisurface: windows_core::Ref<IWICBitmapSource>, ccount: u32, faddtransparentcolor: windows_core::BOOL) -> windows_result::Result<()>;
    fn InitializeFromPalette(&self, pipalette: windows_core::Ref<IWICPalette>) -> windows_result::Result<()>;
    fn GetType(&self) -> windows_result::Result<WICBitmapPaletteType>;
    fn GetColorCount(&self) -> windows_result::Result<u32>;
    fn GetColors(&self, ccount: u32, pcolors: *mut u32, pcactualcolors: *mut u32) -> windows_result::Result<()>;
    fn IsBlackWhite(&self) -> windows_result::Result<windows_core::BOOL>;
    fn IsGrayscale(&self) -> windows_result::Result<windows_core::BOOL>;
    fn HasAlpha(&self) -> windows_result::Result<windows_core::BOOL>;
}
...
impl IWICPersistStream {
    pub unsafe fn LoadEx<P0>(&self, pistream: P0, pguidpreferredvendor: *const windows_core::GUID, dwpersistoptions: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::System::Com::IStream>,
    {
    ...
    pub unsafe fn SaveEx<P0>(&self, pistream: P0, dwpersistoptions: u32, fcleardirty: bool) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::System::Com::IStream>,
    {
...
pub trait IWICPersistStream_Impl: super::super::System::Com::IPersistStream_Impl {
    fn LoadEx(&self, pistream: windows_core::Ref<super::super::System::Com::IStream>, pguidpreferredvendor: *const windows_core::GUID, dwpersistoptions: u32) -> windows_result::Result<()>;
    fn SaveEx(&self, pistream: windows_core::Ref<super::super::System::Com::IStream>, dwpersistoptions: u32, fcleardirty: windows_core::BOOL) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWICPixelFormatInfo {
    pub unsafe fn GetFormatGUID(&self) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFormatGUID)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetColorContext(&self) -> windows_result::Result<IWICColorContext> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetBitsPerPixel(&self) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetChannelMask(&self, uichannelindex: u32, pbmaskbuffer: &mut [u8], pcbactual: *mut u32) -> windows_result::Result<()> {
...
pub trait IWICPixelFormatInfo_Impl: IWICComponentInfo_Impl {
    fn GetFormatGUID(&self) -> windows_result::Result<windows_core::GUID>;
    fn GetColorContext(&self) -> windows_result::Result<IWICColorContext>;
    fn GetBitsPerPixel(&self) -> windows_result::Result<u32>;
    fn GetChannelCount(&self) -> windows_result::Result<u32>;
    fn GetChannelMask(&self, uichannelindex: u32, cbmaskbuffer: u32, pbmaskbuffer: *mut u8, pcbactual: *mut u32) -> windows_result::Result<()>;
}
...
impl IWICPixelFormatInfo2 {
    pub unsafe fn SupportsTransparency(&self) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SupportsTransparency)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetNumericRepresentation(&self) -> windows_result::Result<WICPixelFormatNumericRepresentation> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWICPixelFormatInfo2_Impl: IWICPixelFormatInfo_Impl {
    fn SupportsTransparency(&self) -> windows_result::Result<windows_core::BOOL>;
    fn GetNumericRepresentation(&self) -> windows_result::Result<WICPixelFormatNumericRepresentation>;
}
...
impl IWICPlanarBitmapFrameEncode {
    pub unsafe fn WritePixels(&self, linecount: u32, pplanes: &[WICBitmapPlane]) -> windows_result::Result<()> {
    ...
    pub unsafe fn WriteSource(&self, ppplanes: &[Option<IWICBitmapSource>], prcsource: *const WICRect) -> windows_result::Result<()> {
...
pub trait IWICPlanarBitmapFrameEncode_Impl: windows_core::IUnknownImpl {
    fn WritePixels(&self, linecount: u32, pplanes: *const WICBitmapPlane, cplanes: u32) -> windows_result::Result<()>;
    fn WriteSource(&self, ppplanes: *const Option<IWICBitmapSource>, cplanes: u32, prcsource: *const WICRect) -> windows_result::Result<()>;
}
...
impl IWICPlanarBitmapSourceTransform {
    ...
    pub unsafe fn CopyPixels(&self, prcsource: *const WICRect, uiwidth: u32, uiheight: u32, dsttransform: WICBitmapTransformOptions, dstplanaroptions: WICPlanarOptions, pdstplanes: &[WICBitmapPlane]) -> windows_result::Result<()> {
...
pub trait IWICPlanarBitmapSourceTransform_Impl: windows_core::IUnknownImpl {
    fn DoesSupportTransform(&self, puiwidth: *mut u32, puiheight: *mut u32, dsttransform: WICBitmapTransformOptions, dstplanaroptions: WICPlanarOptions, pguiddstformats: *const windows_core::GUID, pplanedescriptions: *mut WICBitmapPlaneDescription, cplanes: u32, pfissupported: *mut windows_core::BOOL) -> windows_result::Result<()>;
    fn CopyPixels(&self, prcsource: *const WICRect, uiwidth: u32, uiheight: u32, dsttransform: WICBitmapTransformOptions, dstplanaroptions: WICPlanarOptions, pdstplanes: *const WICBitmapPlane, cplanes: u32) -> windows_result::Result<()>;
}
...
impl IWICPlanarFormatConverter {
    pub unsafe fn Initialize<P4>(&self, ppplanes: &[Option<IWICBitmapSource>], dstformat: *const windows_core::GUID, dither: WICBitmapDitherType, pipalette: P4, alphathresholdpercent: f64, palettetranslate: WICBitmapPaletteType) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn CanConvert(&self, psrcpixelformats: &[windows_core::GUID], dstpixelformat: *const windows_core::GUID) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWICPlanarFormatConverter_Impl: IWICBitmapSource_Impl {
    fn Initialize(&self, ppplanes: *const Option<IWICBitmapSource>, cplanes: u32, dstformat: *const windows_core::GUID, dither: WICBitmapDitherType, pipalette: windows_core::Ref<IWICPalette>, alphathresholdpercent: f64, palettetranslate: WICBitmapPaletteType) -> windows_result::Result<()>;
    fn CanConvert(&self, psrcpixelformats: *const windows_core::GUID, csrcplanes: u32, dstpixelformat: *const windows_core::GUID) -> windows_result::Result<windows_core::BOOL>;
}
...
impl IWICProgressCallback {
    pub unsafe fn Notify(&self, uframenum: u32, operation: WICProgressOperation, dblprogress: f64) -> windows_result::Result<()> {
...
pub trait IWICProgressCallback_Impl: windows_core::IUnknownImpl {
    fn Notify(&self, uframenum: u32, operation: WICProgressOperation, dblprogress: f64) -> windows_result::Result<()>;
}
...
pub trait IWICProgressiveLevelControl_Impl: windows_core::IUnknownImpl {
    fn GetLevelCount(&self) -> windows_result::Result<u32>;
    fn GetCurrentLevel(&self) -> windows_result::Result<u32>;
    fn SetCurrentLevel(&self, nlevel: u32) -> windows_result::Result<()>;
}
...
#[cfg(feature = "Win32_System_Com")]
impl IWICStream {
    pub unsafe fn InitializeFromIStream<P0>(&self, pistream: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::System::Com::IStream>,
    {
        unsafe { (windows_core::Interface::vtable(self).InitializeFromIStream)(windows_core::Interface::as_raw(self), pistream.param().abi()).ok() }
    }
    pub unsafe fn InitializeFromFilename<P0>(&self, wzfilename: P0, dwdesiredaccess: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn InitializeFromIStreamRegion<P0>(&self, pistream: P0, uloffset: u64, ulmaxsize: u64) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::System::Com::IStream>,
    {
...
pub trait IWICStream_Impl: super::super::System::Com::IStream_Impl {
    fn InitializeFromIStream(&self, pistream: windows_core::Ref<super::super::System::Com::IStream>) -> windows_result::Result<()>;
    fn InitializeFromFilename(&self, wzfilename: &windows_core::PCWSTR, dwdesiredaccess: u32) -> windows_result::Result<()>;
    fn InitializeFromMemory(&self, pbbuffer: *const u8, cbbuffersize: u32) -> windows_result::Result<()>;
    fn InitializeFromIStreamRegion(&self, pistream: windows_core::Ref<super::super::System::Com::IStream>, uloffset: u64, ulmaxsize: u64) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
pub trait IWICStreamProvider_Impl: windows_core::IUnknownImpl {
    ...
    fn GetPersistOptions(&self) -> windows_result::Result<u32>;
    fn GetPreferredVendorGUID(&self) -> windows_result::Result<windows_core::GUID>;
    fn RefreshStream(&self) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
