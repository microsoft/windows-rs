...
pub const WIC8BIMIptcDigestIptcDigest: WIC8BIMIptcDigestProperties = 2i32;
pub const WIC8BIMIptcDigestPString: WIC8BIMIptcDigestProperties = 1i32;
pub const WIC8BIMIptcEmbeddedIPTC: WIC8BIMIptcProperties = 1i32;
pub const WIC8BIMIptcPString: WIC8BIMIptcProperties = 0i32;
pub const WIC8BIMResolutionInfoHResolution: WIC8BIMResolutionInfoProperties = 2i32;
pub const WIC8BIMResolutionInfoHResolutionUnit: WIC8BIMResolutionInfoProperties = 3i32;
pub const WIC8BIMResolutionInfoHeightUnit: WIC8BIMResolutionInfoProperties = 7i32;
pub const WIC8BIMResolutionInfoPString: WIC8BIMResolutionInfoProperties = 1i32;
pub const WIC8BIMResolutionInfoVResolution: WIC8BIMResolutionInfoProperties = 5i32;
pub const WIC8BIMResolutionInfoVResolutionUnit: WIC8BIMResolutionInfoProperties = 6i32;
pub const WIC8BIMResolutionInfoWidthUnit: WIC8BIMResolutionInfoProperties = 4i32;
...
pub const WICGifApplicationExtensionApplication: WICGifApplicationExtensionProperties = 1i32;
pub const WICGifApplicationExtensionData: WICGifApplicationExtensionProperties = 2i32;
pub const WICGifCommentExtensionText: WICGifCommentExtensionProperties = 1i32;
pub const WICGifGraphicControlExtensionDelay: WICGifGraphicControlExtensionProperties = 4i32;
pub const WICGifGraphicControlExtensionDisposal: WICGifGraphicControlExtensionProperties = 1i32;
pub const WICGifGraphicControlExtensionTransparencyFlag: WICGifGraphicControlExtensionProperties = 3i32;
pub const WICGifGraphicControlExtensionTransparentColorIndex: WICGifGraphicControlExtensionProperties = 5i32;
pub const WICGifGraphicControlExtensionUserInputFlag: WICGifGraphicControlExtensionProperties = 2i32;
pub const WICGifImageDescriptorHeight: WICGifImageDescriptorProperties = 4i32;
pub const WICGifImageDescriptorInterlaceFlag: WICGifImageDescriptorProperties = 6i32;
pub const WICGifImageDescriptorLeft: WICGifImageDescriptorProperties = 1i32;
pub const WICGifImageDescriptorLocalColorTableFlag: WICGifImageDescriptorProperties = 5i32;
pub const WICGifImageDescriptorLocalColorTableSize: WICGifImageDescriptorProperties = 8i32;
pub const WICGifImageDescriptorSortFlag: WICGifImageDescriptorProperties = 7i32;
pub const WICGifImageDescriptorTop: WICGifImageDescriptorProperties = 2i32;
pub const WICGifImageDescriptorWidth: WICGifImageDescriptorProperties = 3i32;
pub const WICGifLogicalScreenDescriptorBackgroundColorIndex: WICGifLogicalScreenDescriptorProperties = 8i32;
pub const WICGifLogicalScreenDescriptorColorResolution: WICGifLogicalScreenDescriptorProperties = 5i32;
pub const WICGifLogicalScreenDescriptorGlobalColorTableFlag: WICGifLogicalScreenDescriptorProperties = 4i32;
pub const WICGifLogicalScreenDescriptorGlobalColorTableSize: WICGifLogicalScreenDescriptorProperties = 7i32;
pub const WICGifLogicalScreenDescriptorHeight: WICGifLogicalScreenDescriptorProperties = 3i32;
pub const WICGifLogicalScreenDescriptorPixelAspectRatio: WICGifLogicalScreenDescriptorProperties = 9i32;
pub const WICGifLogicalScreenDescriptorSortFlag: WICGifLogicalScreenDescriptorProperties = 6i32;
pub const WICGifLogicalScreenDescriptorWidth: WICGifLogicalScreenDescriptorProperties = 2i32;
pub const WICGifLogicalScreenSignature: WICGifLogicalScreenDescriptorProperties = 1i32;
pub const WICHeifHdrCustomVideoPrimaries: WICHeifHdrProperties = 5i32;
pub const WICHeifHdrMaximumFrameAverageLuminanceLevel: WICHeifHdrProperties = 2i32;
pub const WICHeifHdrMaximumLuminanceLevel: WICHeifHdrProperties = 1i32;
pub const WICHeifHdrMaximumMasteringDisplayLuminanceLevel: WICHeifHdrProperties = 4i32;
pub const WICHeifHdrMinimumMasteringDisplayLuminanceLevel: WICHeifHdrProperties = 3i32;
pub const WICHeifOrientation: WICHeifProperties = 1i32;
pub const WICJpegChrominanceTable: WICJpegChrominanceProperties = 1i32;
pub const WICJpegCommentText: WICJpegCommentProperties = 1i32;
pub const WICJpegIndexingOptionsGenerateOnDemand: WICJpegIndexingOptions = 0i32;
pub const WICJpegIndexingOptionsGenerateOnLoad: WICJpegIndexingOptions = 1i32;
pub const WICJpegLuminanceTable: WICJpegLuminanceProperties = 1i32;
pub const WICJpegScanTypeInterleaved: WICJpegScanType = 0i32;
pub const WICJpegScanTypePlanarComponents: WICJpegScanType = 1i32;
pub const WICJpegScanTypeProgressive: WICJpegScanType = 2i32;
pub const WICJpegTransferMatrixBT601: WICJpegTransferMatrix = 1i32;
pub const WICJpegTransferMatrixIdentity: WICJpegTransferMatrix = 0i32;
...
pub const WICPixelFormatNumericRepresentationFixed: WICPixelFormatNumericRepresentation = 4i32;
pub const WICPixelFormatNumericRepresentationFloat: WICPixelFormatNumericRepresentation = 5i32;
pub const WICPixelFormatNumericRepresentationIndexed: WICPixelFormatNumericRepresentation = 1i32;
pub const WICPixelFormatNumericRepresentationSignedInteger: WICPixelFormatNumericRepresentation = 3i32;
pub const WICPixelFormatNumericRepresentationUnsignedInteger: WICPixelFormatNumericRepresentation = 2i32;
pub const WICPixelFormatNumericRepresentationUnspecified: WICPixelFormatNumericRepresentation = 0i32;
...
pub const WICPngBkgdBackgroundColor: WICPngBkgdProperties = 1i32;
pub const WICPngChrmBlueX: WICPngChrmProperties = 7i32;
pub const WICPngChrmBlueY: WICPngChrmProperties = 8i32;
pub const WICPngChrmGreenX: WICPngChrmProperties = 5i32;
pub const WICPngChrmGreenY: WICPngChrmProperties = 6i32;
pub const WICPngChrmRedX: WICPngChrmProperties = 3i32;
pub const WICPngChrmRedY: WICPngChrmProperties = 4i32;
pub const WICPngChrmWhitePointX: WICPngChrmProperties = 1i32;
pub const WICPngChrmWhitePointY: WICPngChrmProperties = 2i32;
...
pub const WICPngGamaGamma: WICPngGamaProperties = 1i32;
pub const WICPngHistFrequencies: WICPngHistProperties = 1i32;
pub const WICPngIccpProfileData: WICPngIccpProperties = 2i32;
pub const WICPngIccpProfileName: WICPngIccpProperties = 1i32;
pub const WICPngItxtCompressionFlag: WICPngItxtProperties = 2i32;
pub const WICPngItxtKeyword: WICPngItxtProperties = 1i32;
pub const WICPngItxtLanguageTag: WICPngItxtProperties = 3i32;
pub const WICPngItxtText: WICPngItxtProperties = 5i32;
pub const WICPngItxtTranslatedKeyword: WICPngItxtProperties = 4i32;
pub const WICPngSrgbRenderingIntent: WICPngSrgbProperties = 1i32;
pub const WICPngTimeDay: WICPngTimeProperties = 3i32;
pub const WICPngTimeHour: WICPngTimeProperties = 4i32;
pub const WICPngTimeMinute: WICPngTimeProperties = 5i32;
pub const WICPngTimeMonth: WICPngTimeProperties = 2i32;
pub const WICPngTimeSecond: WICPngTimeProperties = 6i32;
pub const WICPngTimeYear: WICPngTimeProperties = 1i32;
...
pub const WICSectionAccessLevelRead: WICSectionAccessLevel = 1i32;
pub const WICSectionAccessLevelReadWrite: WICSectionAccessLevel = 3i32;
...
pub const WICWebpAnimLoopCount: WICWebpAnimProperties = 1i32;
pub const WICWebpAnmfFrameDuration: WICWebpAnmfProperties = 1i32;
