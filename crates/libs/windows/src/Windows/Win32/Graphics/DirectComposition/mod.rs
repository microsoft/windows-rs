...
impl IDCompositionSurface {
    ...
    pub unsafe fn BeginDraw(&self, updaterect: ::core::option::Option<&super::super::Foundation::RECT>, iid: &::windows::core::GUID, updateobject: *mut *mut ::core::ffi::c_void, updateoffset: &mut super::super::Foundation::POINT) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).BeginDraw)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(updaterect), ::core::mem::transmute(iid), ::core::mem::transmute(updateobject), ::core::mem::transmute(updateoffset)).ok()
    }
...
impl IDCompositionVirtualSurface {
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn BeginDraw(&self, updaterect: ::core::option::Option<&super::super::Foundation::RECT>, iid: &::windows::core::GUID, updateobject: *mut *mut ::core::ffi::c_void, updateoffset: &mut super::super::Foundation::POINT) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.BeginDraw)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(updaterect), ::core::mem::transmute(iid), ::core::mem::transmute(updateobject), ::core::mem::transmute(updateoffset)).ok()
    }
    pub unsafe fn EndDraw(&self) -> ::windows::core::Result<()> {
