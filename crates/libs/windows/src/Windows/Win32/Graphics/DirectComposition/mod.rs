#[inline]
pub unsafe fn DCompositionAttachMouseDragToHwnd<P0>(visual: P0, hwnd: super::super::Foundation::HWND, enable: bool) -> Result<(), windows_result::HRESULT>
where
...
#[inline]
pub unsafe fn DCompositionAttachMouseWheelToHwnd<P0>(visual: P0, hwnd: super::super::Foundation::HWND, enable: bool) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<IDCompositionVisual>,
{
...
#[inline]
pub unsafe fn DCompositionBoostCompositorClock(enable: bool) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DCompositionCreateDevice<P0, T>(dxgidevice: P0) -> Result<T, windows_result::HRESULT>
where
...
#[inline]
pub unsafe fn DCompositionCreateDevice2<P0, T>(renderingdevice: P0) -> Result<T, windows_result::HRESULT>
where
...
#[inline]
pub unsafe fn DCompositionCreateDevice3<P0, T>(renderingdevice: P0) -> Result<T, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::IUnknown>,
    T: windows_core::Interface,
{
...
#[inline]
pub unsafe fn DCompositionCreateSurfaceHandle(desiredaccess: u32, securityattributes: Option<*const super::super::Security::SECURITY_ATTRIBUTES>) -> Result<super::super::Foundation::HANDLE, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DCompositionGetFrameId(frameidtype: COMPOSITION_FRAME_ID_TYPE) -> Result<u64, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DCompositionGetStatistics(frameid: u64, framestats: *mut COMPOSITION_FRAME_STATS, targetidcount: u32, targetids: Option<*mut COMPOSITION_TARGET_ID>, actualtargetidcount: Option<*mut u32>) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn DCompositionGetTargetStatistics(frameid: u64, targetid: *const COMPOSITION_TARGET_ID) -> Result<COMPOSITION_TARGET_STATS, windows_result::HRESULT> {
...
impl IDCompositionAffineTransform2DEffect {
    ...
    pub unsafe fn SetInterpolationMode(&self, interpolationmode: super::Direct2D::Common::D2D1_2DAFFINETRANSFORM_INTERPOLATION_MODE) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetInterpolationMode)(windows_core::Interface::as_raw(self), interpolationmode).ok() }
    }
    #[cfg(feature = "Win32_Graphics_Direct2D_Common")]
    pub unsafe fn SetBorderMode(&self, bordermode: super::Direct2D::Common::D2D1_BORDER_MODE) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetBorderMode)(windows_core::Interface::as_raw(self), bordermode).ok() }
    }
    pub unsafe fn SetTransformMatrix(&self, transformmatrix: *const windows_numerics::Matrix3x2) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetTransformMatrix)(windows_core::Interface::as_raw(self), transformmatrix).ok() }
    }
    pub unsafe fn SetTransformMatrixElement<P2>(&self, row: i32, column: i32, animation: P2) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetTransformMatrixElement2(&self, row: i32, column: i32, value: f32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetSharpness<P0>(&self, animation: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetSharpness2(&self, sharpness: f32) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionAffineTransform2DEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetInterpolationMode(&self, interpolationmode: super::Direct2D::Common::D2D1_2DAFFINETRANSFORM_INTERPOLATION_MODE) -> Result<(), windows_result::HRESULT>;
    fn SetBorderMode(&self, bordermode: super::Direct2D::Common::D2D1_BORDER_MODE) -> Result<(), windows_result::HRESULT>;
    fn SetTransformMatrix(&self, transformmatrix: *const windows_numerics::Matrix3x2) -> Result<(), windows_result::HRESULT>;
    fn SetTransformMatrixElement(&self, row: i32, column: i32, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetTransformMatrixElement2(&self, row: i32, column: i32, value: f32) -> Result<(), windows_result::HRESULT>;
    fn SetSharpness(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetSharpness2(&self, sharpness: f32) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Direct2D_Common")]
...
impl IDCompositionAnimation {
    ...
    pub unsafe fn SetAbsoluteBeginTime(&self, begintime: i64) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetAbsoluteBeginTime)(windows_core::Interface::as_raw(self), begintime).ok() }
    }
    pub unsafe fn AddCubic(&self, beginoffset: f64, constantcoefficient: f32, linearcoefficient: f32, quadraticcoefficient: f32, cubiccoefficient: f32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn AddSinusoidal(&self, beginoffset: f64, bias: f32, amplitude: f32, frequency: f32, phase: f32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn AddRepeat(&self, beginoffset: f64, durationtorepeat: f64) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).AddRepeat)(windows_core::Interface::as_raw(self), beginoffset, durationtorepeat).ok() }
    }
    pub unsafe fn End(&self, endoffset: f64, endvalue: f32) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionAnimation_Impl: windows_core::IUnknownImpl {
    ...
    fn SetAbsoluteBeginTime(&self, begintime: i64) -> Result<(), windows_result::HRESULT>;
    fn AddCubic(&self, beginoffset: f64, constantcoefficient: f32, linearcoefficient: f32, quadraticcoefficient: f32, cubiccoefficient: f32) -> Result<(), windows_result::HRESULT>;
    fn AddSinusoidal(&self, beginoffset: f64, bias: f32, amplitude: f32, frequency: f32, phase: f32) -> Result<(), windows_result::HRESULT>;
    fn AddRepeat(&self, beginoffset: f64, durationtorepeat: f64) -> Result<(), windows_result::HRESULT>;
    fn End(&self, endoffset: f64, endvalue: f32) -> Result<(), windows_result::HRESULT>;
}
...
pub trait IDCompositionArithmeticCompositeEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetCoefficients(&self, coefficients: *const windows_numerics::Vector4) -> Result<(), windows_result::HRESULT>;
    fn SetClampOutput(&self, clampoutput: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SetCoefficient1(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetCoefficient12(&self, coeffcient1: f32) -> Result<(), windows_result::HRESULT>;
    fn SetCoefficient2(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetCoefficient22(&self, coefficient2: f32) -> Result<(), windows_result::HRESULT>;
    fn SetCoefficient3(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetCoefficient32(&self, coefficient3: f32) -> Result<(), windows_result::HRESULT>;
    fn SetCoefficient4(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetCoefficient42(&self, coefficient4: f32) -> Result<(), windows_result::HRESULT>;
}
...
impl IDCompositionBlendEffect {
    #[cfg(feature = "Win32_Graphics_Direct2D_Common")]
    pub unsafe fn SetMode(&self, mode: super::Direct2D::Common::D2D1_BLEND_MODE) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionBlendEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetMode(&self, mode: super::Direct2D::Common::D2D1_BLEND_MODE) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Direct2D_Common")]
...
pub trait IDCompositionBrightnessEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetWhitePoint(&self, whitepoint: *const windows_numerics::Vector2) -> Result<(), windows_result::HRESULT>;
    fn SetBlackPoint(&self, blackpoint: *const windows_numerics::Vector2) -> Result<(), windows_result::HRESULT>;
    fn SetWhitePointX(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetWhitePointX2(&self, whitepointx: f32) -> Result<(), windows_result::HRESULT>;
    fn SetWhitePointY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetWhitePointY2(&self, whitepointy: f32) -> Result<(), windows_result::HRESULT>;
    fn SetBlackPointX(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetBlackPointX2(&self, blackpointx: f32) -> Result<(), windows_result::HRESULT>;
    fn SetBlackPointY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetBlackPointY2(&self, blackpointy: f32) -> Result<(), windows_result::HRESULT>;
}
...
impl IDCompositionColorMatrixEffect {
    #[cfg(feature = "Win32_Graphics_Direct2D_Common")]
    pub unsafe fn SetMatrix(&self, matrix: *const super::Direct2D::Common::D2D_MATRIX_5X4_F) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetMatrix)(windows_core::Interface::as_raw(self), matrix).ok() }
    }
    pub unsafe fn SetMatrixElement<P2>(&self, row: i32, column: i32, animation: P2) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<IDCompositionAnimation>,
    {
    ...
    pub unsafe fn SetMatrixElement2(&self, row: i32, column: i32, value: f32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetMatrixElement2)(windows_core::Interface::as_raw(self), row, column, value).ok() }
    }
    #[cfg(feature = "Win32_Graphics_Direct2D_Common")]
    pub unsafe fn SetAlphaMode(&self, mode: super::Direct2D::Common::D2D1_COLORMATRIX_ALPHA_MODE) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetAlphaMode)(windows_core::Interface::as_raw(self), mode).ok() }
    }
    pub unsafe fn SetClampOutput(&self, clamp: bool) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionColorMatrixEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetMatrix(&self, matrix: *const super::Direct2D::Common::D2D_MATRIX_5X4_F) -> Result<(), windows_result::HRESULT>;
    fn SetMatrixElement(&self, row: i32, column: i32, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetMatrixElement2(&self, row: i32, column: i32, value: f32) -> Result<(), windows_result::HRESULT>;
    fn SetAlphaMode(&self, mode: super::Direct2D::Common::D2D1_COLORMATRIX_ALPHA_MODE) -> Result<(), windows_result::HRESULT>;
    fn SetClampOutput(&self, clamp: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Direct2D_Common")]
...
impl IDCompositionCompositeEffect {
    #[cfg(feature = "Win32_Graphics_Direct2D_Common")]
    pub unsafe fn SetMode(&self, mode: super::Direct2D::Common::D2D1_COMPOSITE_MODE) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetMode)(windows_core::Interface::as_raw(self), mode).ok() }
    }
}
#[repr(C)]
...
pub trait IDCompositionCompositeEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetMode(&self, mode: super::Direct2D::Common::D2D1_COMPOSITE_MODE) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Direct2D_Common")]
...
impl IDCompositionDelegatedInkTrail {
    pub unsafe fn AddTrailPoints(&self, inkpoints: &[DCompositionInkTrailPoint]) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AddTrailPointsWithPrediction(&self, inkpoints: &[DCompositionInkTrailPoint], predictedinkpoints: &[DCompositionInkTrailPoint]) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RemoveTrailPoints(&self, generationid: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).RemoveTrailPoints)(windows_core::Interface::as_raw(self), generationid).ok() }
    }
    #[cfg(feature = "Win32_Graphics_Direct2D_Common")]
    pub unsafe fn StartNewTrail(&self, color: *const super::Direct2D::Common::D2D1_COLOR_F) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionDelegatedInkTrail_Impl: windows_core::IUnknownImpl {
    fn AddTrailPoints(&self, inkpoints: *const DCompositionInkTrailPoint, inkpointscount: u32) -> Result<u32, windows_result::HRESULT>;
    fn AddTrailPointsWithPrediction(&self, inkpoints: *const DCompositionInkTrailPoint, inkpointscount: u32, predictedinkpoints: *const DCompositionInkTrailPoint, predictedinkpointscount: u32) -> Result<u32, windows_result::HRESULT>;
    fn RemoveTrailPoints(&self, generationid: u32) -> Result<(), windows_result::HRESULT>;
    fn StartNewTrail(&self, color: *const super::Direct2D::Common::D2D1_COLOR_F) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Direct2D_Common")]
...
impl IDCompositionDesktopDevice {
    pub unsafe fn CreateTargetForHwnd(&self, hwnd: super::super::Foundation::HWND, topmost: bool) -> Result<IDCompositionTarget, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateSurfaceFromHandle(&self, handle: super::super::Foundation::HANDLE) -> Result<windows_core::IUnknown, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateSurfaceFromHwnd(&self, hwnd: super::super::Foundation::HWND) -> Result<windows_core::IUnknown, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDCompositionDesktopDevice_Impl: IDCompositionDevice2_Impl {
    fn CreateTargetForHwnd(&self, hwnd: super::super::Foundation::HWND, topmost: windows_core::BOOL) -> Result<IDCompositionTarget, windows_result::HRESULT>;
    fn CreateSurfaceFromHandle(&self, handle: super::super::Foundation::HANDLE) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
    fn CreateSurfaceFromHwnd(&self, hwnd: super::super::Foundation::HWND) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDCompositionDevice {
    ...
    pub unsafe fn WaitForCommitCompletion(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).WaitForCommitCompletion)(windows_core::Interface::as_raw(self)).ok() }
    }
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn GetFrameStatistics(&self) -> Result<DCOMPOSITION_FRAME_STATISTICS, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateVisual(&self) -> Result<IDCompositionVisual, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn CreateSurface(&self, width: u32, height: u32, pixelformat: super::Dxgi::Common::DXGI_FORMAT, alphamode: super::Dxgi::Common::DXGI_ALPHA_MODE) -> Result<IDCompositionSurface, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_Graphics_Dxgi_Common")]
    pub unsafe fn CreateVirtualSurface(&self, initialwidth: u32, initialheight: u32, pixelformat: super::Dxgi::Common::DXGI_FORMAT, alphamode: super::Dxgi::Common::DXGI_ALPHA_MODE) -> Result<IDCompositionVirtualSurface, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateTranslateTransform(&self) -> Result<IDCompositionTranslateTransform, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateScaleTransform(&self) -> Result<IDCompositionScaleTransform, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateRotateTransform(&self) -> Result<IDCompositionRotateTransform, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateSkewTransform(&self) -> Result<IDCompositionSkewTransform, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateMatrixTransform(&self) -> Result<IDCompositionMatrixTransform, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateTransformGroup(&self, transforms: &[Option<IDCompositionTransform>]) -> Result<IDCompositionTransform, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateTranslateTransform3D(&self) -> Result<IDCompositionTranslateTransform3D, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateScaleTransform3D(&self) -> Result<IDCompositionScaleTransform3D, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateRotateTransform3D(&self) -> Result<IDCompositionRotateTransform3D, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateMatrixTransform3D(&self) -> Result<IDCompositionMatrixTransform3D, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateTransform3DGroup(&self, transforms3d: &[Option<IDCompositionTransform3D>]) -> Result<IDCompositionTransform3D, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateEffectGroup(&self) -> Result<IDCompositionEffectGroup, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateRectangleClip(&self) -> Result<IDCompositionRectangleClip, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateAnimation(&self) -> Result<IDCompositionAnimation, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CheckDeviceState(&self) -> Result<windows_core::BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDCompositionDevice_Impl: windows_core::IUnknownImpl {
    ...
    fn WaitForCommitCompletion(&self) -> Result<(), windows_result::HRESULT>;
    fn GetFrameStatistics(&self) -> Result<DCOMPOSITION_FRAME_STATISTICS, windows_result::HRESULT>;
    fn CreateTargetForHwnd(&self, hwnd: super::super::Foundation::HWND, topmost: windows_core::BOOL) -> Result<IDCompositionTarget, windows_result::HRESULT>;
    fn CreateVisual(&self) -> Result<IDCompositionVisual, windows_result::HRESULT>;
    fn CreateSurface(&self, width: u32, height: u32, pixelformat: super::Dxgi::Common::DXGI_FORMAT, alphamode: super::Dxgi::Common::DXGI_ALPHA_MODE) -> Result<IDCompositionSurface, windows_result::HRESULT>;
    fn CreateVirtualSurface(&self, initialwidth: u32, initialheight: u32, pixelformat: super::Dxgi::Common::DXGI_FORMAT, alphamode: super::Dxgi::Common::DXGI_ALPHA_MODE) -> Result<IDCompositionVirtualSurface, windows_result::HRESULT>;
    fn CreateSurfaceFromHandle(&self, handle: super::super::Foundation::HANDLE) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
    fn CreateSurfaceFromHwnd(&self, hwnd: super::super::Foundation::HWND) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
    fn CreateTranslateTransform(&self) -> Result<IDCompositionTranslateTransform, windows_result::HRESULT>;
    fn CreateScaleTransform(&self) -> Result<IDCompositionScaleTransform, windows_result::HRESULT>;
    fn CreateRotateTransform(&self) -> Result<IDCompositionRotateTransform, windows_result::HRESULT>;
    fn CreateSkewTransform(&self) -> Result<IDCompositionSkewTransform, windows_result::HRESULT>;
    fn CreateMatrixTransform(&self) -> Result<IDCompositionMatrixTransform, windows_result::HRESULT>;
    fn CreateTransformGroup(&self, transforms: *const Option<IDCompositionTransform>, elements: u32) -> Result<IDCompositionTransform, windows_result::HRESULT>;
    fn CreateTranslateTransform3D(&self) -> Result<IDCompositionTranslateTransform3D, windows_result::HRESULT>;
    fn CreateScaleTransform3D(&self) -> Result<IDCompositionScaleTransform3D, windows_result::HRESULT>;
    fn CreateRotateTransform3D(&self) -> Result<IDCompositionRotateTransform3D, windows_result::HRESULT>;
    fn CreateMatrixTransform3D(&self) -> Result<IDCompositionMatrixTransform3D, windows_result::HRESULT>;
    fn CreateTransform3DGroup(&self, transforms3d: *const Option<IDCompositionTransform3D>, elements: u32) -> Result<IDCompositionTransform3D, windows_result::HRESULT>;
    fn CreateEffectGroup(&self) -> Result<IDCompositionEffectGroup, windows_result::HRESULT>;
    fn CreateRectangleClip(&self) -> Result<IDCompositionRectangleClip, windows_result::HRESULT>;
    fn CreateAnimation(&self) -> Result<IDCompositionAnimation, windows_result::HRESULT>;
    fn CheckDeviceState(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDCompositionDevice2 {
    ...
    pub unsafe fn CreateVisual(&self) -> Result<IDCompositionVisual2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateVisual)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateSurfaceFactory<P0>(&self, renderingdevice: P0) -> Result<IDCompositionSurfaceFactory, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
...
pub trait IDCompositionDevice2_Impl: windows_core::IUnknownImpl {
    ...
    fn WaitForCommitCompletion(&self) -> Result<(), windows_result::HRESULT>;
    fn GetFrameStatistics(&self) -> Result<DCOMPOSITION_FRAME_STATISTICS, windows_result::HRESULT>;
    fn CreateVisual(&self) -> Result<IDCompositionVisual2, windows_result::HRESULT>;
    fn CreateSurfaceFactory(&self, renderingdevice: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<IDCompositionSurfaceFactory, windows_result::HRESULT>;
    fn CreateSurface(&self, width: u32, height: u32, pixelformat: super::Dxgi::Common::DXGI_FORMAT, alphamode: super::Dxgi::Common::DXGI_ALPHA_MODE) -> Result<IDCompositionSurface, windows_result::HRESULT>;
    fn CreateVirtualSurface(&self, initialwidth: u32, initialheight: u32, pixelformat: super::Dxgi::Common::DXGI_FORMAT, alphamode: super::Dxgi::Common::DXGI_ALPHA_MODE) -> Result<IDCompositionVirtualSurface, windows_result::HRESULT>;
    fn CreateTranslateTransform(&self) -> Result<IDCompositionTranslateTransform, windows_result::HRESULT>;
    fn CreateScaleTransform(&self) -> Result<IDCompositionScaleTransform, windows_result::HRESULT>;
...
impl IDCompositionDevice3 {
    pub unsafe fn CreateGaussianBlurEffect(&self) -> Result<IDCompositionGaussianBlurEffect, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateBrightnessEffect(&self) -> Result<IDCompositionBrightnessEffect, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateColorMatrixEffect(&self) -> Result<IDCompositionColorMatrixEffect, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateShadowEffect(&self) -> Result<IDCompositionShadowEffect, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateHueRotationEffect(&self) -> Result<IDCompositionHueRotationEffect, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateSaturationEffect(&self) -> Result<IDCompositionSaturationEffect, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateTurbulenceEffect(&self) -> Result<IDCompositionTurbulenceEffect, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateLinearTransferEffect(&self) -> Result<IDCompositionLinearTransferEffect, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateTableTransferEffect(&self) -> Result<IDCompositionTableTransferEffect, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateCompositeEffect(&self) -> Result<IDCompositionCompositeEffect, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateBlendEffect(&self) -> Result<IDCompositionBlendEffect, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateArithmeticCompositeEffect(&self) -> Result<IDCompositionArithmeticCompositeEffect, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateAffineTransform2DEffect(&self) -> Result<IDCompositionAffineTransform2DEffect, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDCompositionDevice3_Impl: IDCompositionDevice2_Impl {
    fn CreateGaussianBlurEffect(&self) -> Result<IDCompositionGaussianBlurEffect, windows_result::HRESULT>;
    fn CreateBrightnessEffect(&self) -> Result<IDCompositionBrightnessEffect, windows_result::HRESULT>;
    fn CreateColorMatrixEffect(&self) -> Result<IDCompositionColorMatrixEffect, windows_result::HRESULT>;
    fn CreateShadowEffect(&self) -> Result<IDCompositionShadowEffect, windows_result::HRESULT>;
    fn CreateHueRotationEffect(&self) -> Result<IDCompositionHueRotationEffect, windows_result::HRESULT>;
    fn CreateSaturationEffect(&self) -> Result<IDCompositionSaturationEffect, windows_result::HRESULT>;
    fn CreateTurbulenceEffect(&self) -> Result<IDCompositionTurbulenceEffect, windows_result::HRESULT>;
    fn CreateLinearTransferEffect(&self) -> Result<IDCompositionLinearTransferEffect, windows_result::HRESULT>;
    fn CreateTableTransferEffect(&self) -> Result<IDCompositionTableTransferEffect, windows_result::HRESULT>;
    fn CreateCompositeEffect(&self) -> Result<IDCompositionCompositeEffect, windows_result::HRESULT>;
    fn CreateBlendEffect(&self) -> Result<IDCompositionBlendEffect, windows_result::HRESULT>;
    fn CreateArithmeticCompositeEffect(&self) -> Result<IDCompositionArithmeticCompositeEffect, windows_result::HRESULT>;
    fn CreateAffineTransform2DEffect(&self) -> Result<IDCompositionAffineTransform2DEffect, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDCompositionDevice4 {
    ...
    pub unsafe fn CreateCompositionTexture<P0>(&self, d3dtexture: P0) -> Result<IDCompositionTexture, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
...
pub trait IDCompositionDevice4_Impl: IDCompositionDevice3_Impl {
    ...
    fn CreateCompositionTexture(&self, d3dtexture: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<IDCompositionTexture, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Dxgi_Common")]
...
impl IDCompositionDeviceDebug {
    pub unsafe fn EnableDebugCounters(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).EnableDebugCounters)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn DisableDebugCounters(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionDeviceDebug_Impl: windows_core::IUnknownImpl {
    fn EnableDebugCounters(&self) -> Result<(), windows_result::HRESULT>;
    fn DisableDebugCounters(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IDCompositionEffectGroup {
    pub unsafe fn SetOpacity<P0>(&self, animation: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetOpacity)(windows_core::Interface::as_raw(self), animation.param().abi()).ok() }
    }
    pub unsafe fn SetOpacity2(&self, opacity: f32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetOpacity2)(windows_core::Interface::as_raw(self), opacity).ok() }
    }
    pub unsafe fn SetTransform3D<P0>(&self, transform3d: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IDCompositionEffectGroup_Impl: IDCompositionEffect_Impl {
    fn SetOpacity(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetOpacity2(&self, opacity: f32) -> Result<(), windows_result::HRESULT>;
    fn SetTransform3D(&self, transform3d: windows_core::Ref<'_, IDCompositionTransform3D>) -> Result<(), windows_result::HRESULT>;
}
...
impl IDCompositionFilterEffect {
    pub unsafe fn SetInput<P1>(&self, index: u32, input: P1, flags: u32) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IDCompositionFilterEffect_Impl: IDCompositionEffect_Impl {
    fn SetInput(&self, index: u32, input: windows_core::Ref<'_, windows_core::IUnknown>, flags: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IDCompositionGaussianBlurEffect {
    pub unsafe fn SetStandardDeviation<P0>(&self, animation: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetStandardDeviation)(windows_core::Interface::as_raw(self), animation.param().abi()).ok() }
    }
    pub unsafe fn SetStandardDeviation2(&self, amount: f32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetStandardDeviation2)(windows_core::Interface::as_raw(self), amount).ok() }
    }
    #[cfg(feature = "Win32_Graphics_Direct2D_Common")]
    pub unsafe fn SetBorderMode(&self, mode: super::Direct2D::Common::D2D1_BORDER_MODE) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionGaussianBlurEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetStandardDeviation(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetStandardDeviation2(&self, amount: f32) -> Result<(), windows_result::HRESULT>;
    fn SetBorderMode(&self, mode: super::Direct2D::Common::D2D1_BORDER_MODE) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Direct2D_Common")]
...
impl IDCompositionHueRotationEffect {
    pub unsafe fn SetAngle<P0>(&self, animation: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetAngle)(windows_core::Interface::as_raw(self), animation.param().abi()).ok() }
    }
    pub unsafe fn SetAngle2(&self, amountdegrees: f32) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionHueRotationEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetAngle(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetAngle2(&self, amountdegrees: f32) -> Result<(), windows_result::HRESULT>;
}
...
impl IDCompositionInkTrailDevice {
    pub unsafe fn CreateDelegatedInkTrail(&self) -> Result<IDCompositionDelegatedInkTrail, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateDelegatedInkTrailForSwapChain<P0>(&self, swapchain: P0) -> Result<IDCompositionDelegatedInkTrail, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
...
pub trait IDCompositionInkTrailDevice_Impl: windows_core::IUnknownImpl {
    fn CreateDelegatedInkTrail(&self) -> Result<IDCompositionDelegatedInkTrail, windows_result::HRESULT>;
    fn CreateDelegatedInkTrailForSwapChain(&self, swapchain: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<IDCompositionDelegatedInkTrail, windows_result::HRESULT>;
}
...
pub trait IDCompositionLinearTransferEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetRedYIntercept(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetRedYIntercept2(&self, redyintercept: f32) -> Result<(), windows_result::HRESULT>;
    fn SetRedSlope(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetRedSlope2(&self, redslope: f32) -> Result<(), windows_result::HRESULT>;
    fn SetRedDisable(&self, reddisable: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SetGreenYIntercept(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetGreenYIntercept2(&self, greenyintercept: f32) -> Result<(), windows_result::HRESULT>;
    fn SetGreenSlope(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetGreenSlope2(&self, greenslope: f32) -> Result<(), windows_result::HRESULT>;
    fn SetGreenDisable(&self, greendisable: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SetBlueYIntercept(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetBlueYIntercept2(&self, blueyintercept: f32) -> Result<(), windows_result::HRESULT>;
    fn SetBlueSlope(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetBlueSlope2(&self, blueslope: f32) -> Result<(), windows_result::HRESULT>;
    fn SetBlueDisable(&self, bluedisable: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SetAlphaYIntercept(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetAlphaYIntercept2(&self, alphayintercept: f32) -> Result<(), windows_result::HRESULT>;
    fn SetAlphaSlope(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetAlphaSlope2(&self, alphaslope: f32) -> Result<(), windows_result::HRESULT>;
    fn SetAlphaDisable(&self, alphadisable: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SetClampOutput(&self, clampoutput: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
}
...
impl IDCompositionMatrixTransform {
    pub unsafe fn SetMatrix(&self, matrix: *const windows_numerics::Matrix3x2) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetMatrix)(windows_core::Interface::as_raw(self), matrix).ok() }
    }
    pub unsafe fn SetMatrixElement<P2>(&self, row: i32, column: i32, animation: P2) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IDCompositionMatrixTransform_Impl: IDCompositionTransform_Impl {
    fn SetMatrix(&self, matrix: *const windows_numerics::Matrix3x2) -> Result<(), windows_result::HRESULT>;
    fn SetMatrixElement(&self, row: i32, column: i32, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetMatrixElement2(&self, row: i32, column: i32, value: f32) -> Result<(), windows_result::HRESULT>;
}
...
impl IDCompositionMatrixTransform3D {
    pub unsafe fn SetMatrix(&self, matrix: *const windows_numerics::Matrix4x4) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetMatrix)(windows_core::Interface::as_raw(self), matrix).ok() }
    }
    pub unsafe fn SetMatrixElement<P2>(&self, row: i32, column: i32, animation: P2) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IDCompositionMatrixTransform3D_Impl: IDCompositionTransform3D_Impl {
    fn SetMatrix(&self, matrix: *const windows_numerics::Matrix4x4) -> Result<(), windows_result::HRESULT>;
    fn SetMatrixElement(&self, row: i32, column: i32, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetMatrixElement2(&self, row: i32, column: i32, value: f32) -> Result<(), windows_result::HRESULT>;
}
...
impl IDCompositionRectangleClip {
    ...
    pub unsafe fn SetBottomRightRadiusX2(&self, radius: f32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetBottomRightRadiusX2)(windows_core::Interface::as_raw(self), radius).ok() }
    }
    pub unsafe fn SetBottomRightRadiusY<P0>(&self, animation: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
    ...
    pub unsafe fn SetBottomRightRadiusY2(&self, radius: f32) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionRectangleClip_Impl: IDCompositionClip_Impl {
    fn SetLeft(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetLeft2(&self, left: f32) -> Result<(), windows_result::HRESULT>;
    fn SetTop(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetTop2(&self, top: f32) -> Result<(), windows_result::HRESULT>;
    fn SetRight(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetRight2(&self, right: f32) -> Result<(), windows_result::HRESULT>;
    fn SetBottom(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetBottom2(&self, bottom: f32) -> Result<(), windows_result::HRESULT>;
    fn SetTopLeftRadiusX(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetTopLeftRadiusX2(&self, radius: f32) -> Result<(), windows_result::HRESULT>;
    fn SetTopLeftRadiusY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetTopLeftRadiusY2(&self, radius: f32) -> Result<(), windows_result::HRESULT>;
    fn SetTopRightRadiusX(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetTopRightRadiusX2(&self, radius: f32) -> Result<(), windows_result::HRESULT>;
    fn SetTopRightRadiusY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetTopRightRadiusY2(&self, radius: f32) -> Result<(), windows_result::HRESULT>;
    fn SetBottomLeftRadiusX(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetBottomLeftRadiusX2(&self, radius: f32) -> Result<(), windows_result::HRESULT>;
    fn SetBottomLeftRadiusY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetBottomLeftRadiusY2(&self, radius: f32) -> Result<(), windows_result::HRESULT>;
    fn SetBottomRightRadiusX(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetBottomRightRadiusX2(&self, radius: f32) -> Result<(), windows_result::HRESULT>;
    fn SetBottomRightRadiusY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetBottomRightRadiusY2(&self, radius: f32) -> Result<(), windows_result::HRESULT>;
}
...
pub trait IDCompositionRotateTransform_Impl: IDCompositionTransform_Impl {
    fn SetAngle(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetAngle2(&self, angle: f32) -> Result<(), windows_result::HRESULT>;
    fn SetCenterX(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetCenterX2(&self, centerx: f32) -> Result<(), windows_result::HRESULT>;
    fn SetCenterY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetCenterY2(&self, centery: f32) -> Result<(), windows_result::HRESULT>;
}
...
impl IDCompositionRotateTransform3D {
    ...
    pub unsafe fn SetCenterZ<P0>(&self, animation: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetCenterZ)(windows_core::Interface::as_raw(self), animation.param().abi()).ok() }
    }
    pub unsafe fn SetCenterZ2(&self, centerz: f32) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionRotateTransform3D_Impl: IDCompositionTransform3D_Impl {
    fn SetAngle(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetAngle2(&self, angle: f32) -> Result<(), windows_result::HRESULT>;
    fn SetAxisX(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetAxisX2(&self, axisx: f32) -> Result<(), windows_result::HRESULT>;
    fn SetAxisY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetAxisY2(&self, axisy: f32) -> Result<(), windows_result::HRESULT>;
    fn SetAxisZ(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetAxisZ2(&self, axisz: f32) -> Result<(), windows_result::HRESULT>;
    fn SetCenterX(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetCenterX2(&self, centerx: f32) -> Result<(), windows_result::HRESULT>;
    fn SetCenterY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetCenterY2(&self, centery: f32) -> Result<(), windows_result::HRESULT>;
    fn SetCenterZ(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetCenterZ2(&self, centerz: f32) -> Result<(), windows_result::HRESULT>;
}
...
impl IDCompositionSaturationEffect {
    pub unsafe fn SetSaturation<P0>(&self, animation: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetSaturation)(windows_core::Interface::as_raw(self), animation.param().abi()).ok() }
    }
    pub unsafe fn SetSaturation2(&self, ratio: f32) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionSaturationEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetSaturation(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetSaturation2(&self, ratio: f32) -> Result<(), windows_result::HRESULT>;
}
...
pub trait IDCompositionScaleTransform_Impl: IDCompositionTransform_Impl {
    fn SetScaleX(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetScaleX2(&self, scalex: f32) -> Result<(), windows_result::HRESULT>;
    fn SetScaleY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetScaleY2(&self, scaley: f32) -> Result<(), windows_result::HRESULT>;
    fn SetCenterX(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetCenterX2(&self, centerx: f32) -> Result<(), windows_result::HRESULT>;
    fn SetCenterY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetCenterY2(&self, centery: f32) -> Result<(), windows_result::HRESULT>;
...
impl IDCompositionScaleTransform3D {
    ...
    pub unsafe fn SetScaleZ<P0>(&self, animation: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetScaleZ)(windows_core::Interface::as_raw(self), animation.param().abi()).ok() }
    }
    pub unsafe fn SetScaleZ2(&self, scalez: f32) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionScaleTransform3D_Impl: IDCompositionTransform3D_Impl {
    ...
    fn SetScaleY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetScaleY2(&self, scaley: f32) -> Result<(), windows_result::HRESULT>;
    fn SetScaleZ(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetScaleZ2(&self, scalez: f32) -> Result<(), windows_result::HRESULT>;
    fn SetCenterX(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetCenterX2(&self, centerx: f32) -> Result<(), windows_result::HRESULT>;
    fn SetCenterY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetCenterY2(&self, centery: f32) -> Result<(), windows_result::HRESULT>;
...
pub trait IDCompositionShadowEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetStandardDeviation(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetStandardDeviation2(&self, amount: f32) -> Result<(), windows_result::HRESULT>;
    fn SetColor(&self, color: *const windows_numerics::Vector4) -> Result<(), windows_result::HRESULT>;
    fn SetRed(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetRed2(&self, amount: f32) -> Result<(), windows_result::HRESULT>;
    fn SetGreen(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetGreen2(&self, amount: f32) -> Result<(), windows_result::HRESULT>;
    fn SetBlue(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetBlue2(&self, amount: f32) -> Result<(), windows_result::HRESULT>;
    fn SetAlpha(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetAlpha2(&self, amount: f32) -> Result<(), windows_result::HRESULT>;
}
...
pub trait IDCompositionSkewTransform_Impl: IDCompositionTransform_Impl {
    fn SetAngleX(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetAngleX2(&self, anglex: f32) -> Result<(), windows_result::HRESULT>;
    fn SetAngleY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetAngleY2(&self, angley: f32) -> Result<(), windows_result::HRESULT>;
    fn SetCenterX(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetCenterX2(&self, centerx: f32) -> Result<(), windows_result::HRESULT>;
    fn SetCenterY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetCenterY2(&self, centery: f32) -> Result<(), windows_result::HRESULT>;
...
impl IDCompositionSurface {
    pub unsafe fn BeginDraw<T>(&self, updaterect: Option<*const super::super::Foundation::RECT>, updateoffset: *mut super::super::Foundation::POINT) -> Result<T, windows_result::HRESULT>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
    ...
    pub unsafe fn Scroll(&self, scrollrect: Option<*const super::super::Foundation::RECT>, cliprect: Option<*const super::super::Foundation::RECT>, offsetx: i32, offsety: i32) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionSurface_Impl: windows_core::IUnknownImpl {
    fn BeginDraw(&self, updaterect: *const super::super::Foundation::RECT, iid: *const windows_core::GUID, updateobject: *mut *mut core::ffi::c_void, updateoffset: *mut super::super::Foundation::POINT) -> Result<(), windows_result::HRESULT>;
    ...
    fn Scroll(&self, scrollrect: *const super::super::Foundation::RECT, cliprect: *const super::super::Foundation::RECT, offsetx: i32, offsety: i32) -> Result<(), windows_result::HRESULT>;
}
...
impl IDCompositionTableTransferEffect {
    pub unsafe fn SetRedTable(&self, tablevalues: &[f32]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetGreenTable(&self, tablevalues: &[f32]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetBlueTable(&self, tablevalues: &[f32]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetAlphaTable(&self, tablevalues: &[f32]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetRedTableValue<P1>(&self, index: u32, animation: P1) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetRedTableValue2(&self, index: u32, value: f32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetRedTableValue2)(windows_core::Interface::as_raw(self), index, value).ok() }
    }
    pub unsafe fn SetGreenTableValue<P1>(&self, index: u32, animation: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<IDCompositionAnimation>,
    {
    ...
    pub unsafe fn SetGreenTableValue2(&self, index: u32, value: f32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetGreenTableValue2)(windows_core::Interface::as_raw(self), index, value).ok() }
    }
    pub unsafe fn SetBlueTableValue<P1>(&self, index: u32, animation: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<IDCompositionAnimation>,
    {
    ...
    pub unsafe fn SetBlueTableValue2(&self, index: u32, value: f32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetBlueTableValue2)(windows_core::Interface::as_raw(self), index, value).ok() }
    }
    pub unsafe fn SetAlphaTableValue<P1>(&self, index: u32, animation: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<IDCompositionAnimation>,
    {
    ...
    pub unsafe fn SetAlphaTableValue2(&self, index: u32, value: f32) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionTableTransferEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetRedTable(&self, tablevalues: *const f32, count: u32) -> Result<(), windows_result::HRESULT>;
    fn SetGreenTable(&self, tablevalues: *const f32, count: u32) -> Result<(), windows_result::HRESULT>;
    fn SetBlueTable(&self, tablevalues: *const f32, count: u32) -> Result<(), windows_result::HRESULT>;
    fn SetAlphaTable(&self, tablevalues: *const f32, count: u32) -> Result<(), windows_result::HRESULT>;
    fn SetRedDisable(&self, reddisable: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SetGreenDisable(&self, greendisable: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SetBlueDisable(&self, bluedisable: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SetAlphaDisable(&self, alphadisable: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SetClampOutput(&self, clampoutput: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SetRedTableValue(&self, index: u32, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetRedTableValue2(&self, index: u32, value: f32) -> Result<(), windows_result::HRESULT>;
    fn SetGreenTableValue(&self, index: u32, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetGreenTableValue2(&self, index: u32, value: f32) -> Result<(), windows_result::HRESULT>;
    fn SetBlueTableValue(&self, index: u32, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetBlueTableValue2(&self, index: u32, value: f32) -> Result<(), windows_result::HRESULT>;
    fn SetAlphaTableValue(&self, index: u32, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetAlphaTableValue2(&self, index: u32, value: f32) -> Result<(), windows_result::HRESULT>;
}
...
impl IDCompositionTarget {
    pub unsafe fn SetRoot<P0>(&self, visual: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IDCompositionVisual>,
    {
...
pub trait IDCompositionTarget_Impl: windows_core::IUnknownImpl {
    fn SetRoot(&self, visual: windows_core::Ref<'_, IDCompositionVisual>) -> Result<(), windows_result::HRESULT>;
}
...
impl IDCompositionTexture {
    #[cfg(feature = "Win32_Graphics_Direct2D_Common")]
    pub unsafe fn SetSourceRect(&self, sourcerect: *const super::Direct2D::Common::D2D_RECT_U) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetAvailableFence<T>(&self, fencevalue: *mut u64) -> Result<T, windows_result::HRESULT>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
...
pub trait IDCompositionTexture_Impl: windows_core::IUnknownImpl {
    fn SetSourceRect(&self, sourcerect: *const super::Direct2D::Common::D2D_RECT_U) -> Result<(), windows_result::HRESULT>;
...
pub trait IDCompositionTranslateTransform_Impl: IDCompositionTransform_Impl {
    fn SetOffsetX(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetOffsetX2(&self, offsetx: f32) -> Result<(), windows_result::HRESULT>;
    fn SetOffsetY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetOffsetY2(&self, offsety: f32) -> Result<(), windows_result::HRESULT>;
}
...
impl IDCompositionTranslateTransform3D {
    ...
    pub unsafe fn SetOffsetZ<P0>(&self, animation: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IDCompositionAnimation>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetOffsetZ)(windows_core::Interface::as_raw(self), animation.param().abi()).ok() }
    }
    pub unsafe fn SetOffsetZ2(&self, offsetz: f32) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionTranslateTransform3D_Impl: IDCompositionTransform3D_Impl {
    ...
    fn SetOffsetY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetOffsetY2(&self, offsety: f32) -> Result<(), windows_result::HRESULT>;
    fn SetOffsetZ(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetOffsetZ2(&self, offsetz: f32) -> Result<(), windows_result::HRESULT>;
}
...
impl IDCompositionTurbulenceEffect {
    pub unsafe fn SetOffset(&self, offset: *const windows_numerics::Vector2) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetOffset)(windows_core::Interface::as_raw(self), offset).ok() }
    }
    pub unsafe fn SetBaseFrequency(&self, frequency: *const windows_numerics::Vector2) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetBaseFrequency)(windows_core::Interface::as_raw(self), frequency).ok() }
    }
    pub unsafe fn SetSize(&self, size: *const windows_numerics::Vector2) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetSize)(windows_core::Interface::as_raw(self), size).ok() }
    }
    pub unsafe fn SetNumOctaves(&self, numoctaves: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetNumOctaves)(windows_core::Interface::as_raw(self), numoctaves).ok() }
    }
    pub unsafe fn SetSeed(&self, seed: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetSeed)(windows_core::Interface::as_raw(self), seed).ok() }
    }
    #[cfg(feature = "Win32_Graphics_Direct2D_Common")]
    pub unsafe fn SetNoise(&self, noise: super::Direct2D::Common::D2D1_TURBULENCE_NOISE) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetNoise)(windows_core::Interface::as_raw(self), noise).ok() }
    }
    pub unsafe fn SetStitchable(&self, stitchable: bool) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionTurbulenceEffect_Impl: IDCompositionFilterEffect_Impl {
    fn SetOffset(&self, offset: *const windows_numerics::Vector2) -> Result<(), windows_result::HRESULT>;
    fn SetBaseFrequency(&self, frequency: *const windows_numerics::Vector2) -> Result<(), windows_result::HRESULT>;
    fn SetSize(&self, size: *const windows_numerics::Vector2) -> Result<(), windows_result::HRESULT>;
    fn SetNumOctaves(&self, numoctaves: u32) -> Result<(), windows_result::HRESULT>;
    fn SetSeed(&self, seed: u32) -> Result<(), windows_result::HRESULT>;
    fn SetNoise(&self, noise: super::Direct2D::Common::D2D1_TURBULENCE_NOISE) -> Result<(), windows_result::HRESULT>;
    fn SetStitchable(&self, stitchable: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Direct2D_Common")]
...
impl IDCompositionVirtualSurface {
    pub unsafe fn Resize(&self, width: u32, height: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Resize)(windows_core::Interface::as_raw(self), width, height).ok() }
    }
    pub unsafe fn Trim(&self, rectangles: Option<&[super::super::Foundation::RECT]>) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionVirtualSurface_Impl: IDCompositionSurface_Impl {
    fn Resize(&self, width: u32, height: u32) -> Result<(), windows_result::HRESULT>;
    fn Trim(&self, rectangles: *const super::super::Foundation::RECT, count: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IDCompositionVisual {
    ...
    pub unsafe fn SetTransform<P0>(&self, transform: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetTransform2(&self, matrix: *const windows_numerics::Matrix3x2) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetTransform2)(windows_core::Interface::as_raw(self), matrix).ok() }
    }
    pub unsafe fn SetTransformParent<P0>(&self, visual: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IDCompositionVisual>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetTransformParent)(windows_core::Interface::as_raw(self), visual.param().abi()).ok() }
    }
    pub unsafe fn SetEffect<P0>(&self, effect: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetBitmapInterpolationMode(&self, interpolationmode: DCOMPOSITION_BITMAP_INTERPOLATION_MODE) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetBorderMode(&self, bordermode: DCOMPOSITION_BORDER_MODE) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetBorderMode)(windows_core::Interface::as_raw(self), bordermode).ok() }
    }
    pub unsafe fn SetClip<P0>(&self, clip: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Win32_Graphics_Direct2D_Common")]
    pub unsafe fn SetClip2(&self, rect: *const super::Direct2D::Common::D2D_RECT_F) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetClip2)(windows_core::Interface::as_raw(self), rect).ok() }
    }
    pub unsafe fn SetContent<P0>(&self, content: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetContent)(windows_core::Interface::as_raw(self), content.param().abi()).ok() }
    }
    pub unsafe fn AddVisual<P0, P2>(&self, visual: P0, insertabove: bool, referencevisual: P2) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IDCompositionVisual>,
    ...
    pub unsafe fn RemoveVisual<P0>(&self, visual: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IDCompositionVisual>,
    {
        unsafe { (windows_core::Interface::vtable(self).RemoveVisual)(windows_core::Interface::as_raw(self), visual.param().abi()).ok() }
    }
    pub unsafe fn RemoveAllVisuals(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).RemoveAllVisuals)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn SetCompositeMode(&self, compositemode: DCOMPOSITION_COMPOSITE_MODE) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionVisual_Impl: windows_core::IUnknownImpl {
    ...
    fn SetOffsetY(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetOffsetY2(&self, offsety: f32) -> Result<(), windows_result::HRESULT>;
    fn SetTransform(&self, transform: windows_core::Ref<'_, IDCompositionTransform>) -> Result<(), windows_result::HRESULT>;
    fn SetTransform2(&self, matrix: *const windows_numerics::Matrix3x2) -> Result<(), windows_result::HRESULT>;
    fn SetTransformParent(&self, visual: windows_core::Ref<'_, IDCompositionVisual>) -> Result<(), windows_result::HRESULT>;
    fn SetEffect(&self, effect: windows_core::Ref<'_, IDCompositionEffect>) -> Result<(), windows_result::HRESULT>;
    fn SetBitmapInterpolationMode(&self, interpolationmode: DCOMPOSITION_BITMAP_INTERPOLATION_MODE) -> Result<(), windows_result::HRESULT>;
    fn SetBorderMode(&self, bordermode: DCOMPOSITION_BORDER_MODE) -> Result<(), windows_result::HRESULT>;
    fn SetClip(&self, clip: windows_core::Ref<'_, IDCompositionClip>) -> Result<(), windows_result::HRESULT>;
    fn SetClip2(&self, rect: *const super::Direct2D::Common::D2D_RECT_F) -> Result<(), windows_result::HRESULT>;
    fn SetContent(&self, content: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn AddVisual(&self, visual: windows_core::Ref<'_, IDCompositionVisual>, insertabove: windows_core::BOOL, referencevisual: windows_core::Ref<'_, IDCompositionVisual>) -> Result<(), windows_result::HRESULT>;
    fn RemoveVisual(&self, visual: windows_core::Ref<'_, IDCompositionVisual>) -> Result<(), windows_result::HRESULT>;
    fn RemoveAllVisuals(&self) -> Result<(), windows_result::HRESULT>;
    fn SetCompositeMode(&self, compositemode: DCOMPOSITION_COMPOSITE_MODE) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Direct2D_Common")]
...
impl IDCompositionVisual2 {
    pub unsafe fn SetOpacityMode(&self, mode: DCOMPOSITION_OPACITY_MODE) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetOpacityMode)(windows_core::Interface::as_raw(self), mode).ok() }
    }
    pub unsafe fn SetBackFaceVisibility(&self, visibility: DCOMPOSITION_BACKFACE_VISIBILITY) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionVisual2_Impl: IDCompositionVisual_Impl {
    fn SetOpacityMode(&self, mode: DCOMPOSITION_OPACITY_MODE) -> Result<(), windows_result::HRESULT>;
    fn SetBackFaceVisibility(&self, visibility: DCOMPOSITION_BACKFACE_VISIBILITY) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Direct2D_Common")]
...
impl IDCompositionVisual3 {
    pub unsafe fn SetDepthMode(&self, mode: DCOMPOSITION_DEPTH_MODE) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetTransform2(&self, matrix: *const windows_numerics::Matrix4x4) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetTransform2)(windows_core::Interface::as_raw(self), matrix).ok() }
    }
    pub unsafe fn SetVisible(&self, visible: bool) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionVisual3_Impl: IDCompositionVisualDebug_Impl {
    fn SetDepthMode(&self, mode: DCOMPOSITION_DEPTH_MODE) -> Result<(), windows_result::HRESULT>;
    fn SetOffsetZ(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetOffsetZ2(&self, offsetz: f32) -> Result<(), windows_result::HRESULT>;
    fn SetOpacity(&self, animation: windows_core::Ref<'_, IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn SetOpacity2(&self, opacity: f32) -> Result<(), windows_result::HRESULT>;
    fn SetTransform(&self, transform: windows_core::Ref<'_, IDCompositionTransform3D>) -> Result<(), windows_result::HRESULT>;
    fn SetTransform2(&self, matrix: *const windows_numerics::Matrix4x4) -> Result<(), windows_result::HRESULT>;
    fn SetVisible(&self, visible: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Direct2D_Common")]
...
impl IDCompositionVisualDebug {
    #[cfg(feature = "Win32_Graphics_Direct2D_Common")]
    pub unsafe fn EnableHeatMap(&self, color: *const super::Direct2D::Common::D2D1_COLOR_F) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).EnableHeatMap)(windows_core::Interface::as_raw(self), color).ok() }
    }
    pub unsafe fn DisableHeatMap(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).DisableHeatMap)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn EnableRedrawRegions(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).EnableRedrawRegions)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn DisableRedrawRegions(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IDCompositionVisualDebug_Impl: IDCompositionVisual2_Impl {
    fn EnableHeatMap(&self, color: *const super::Direct2D::Common::D2D1_COLOR_F) -> Result<(), windows_result::HRESULT>;
    fn DisableHeatMap(&self) -> Result<(), windows_result::HRESULT>;
    fn EnableRedrawRegions(&self) -> Result<(), windows_result::HRESULT>;
    fn DisableRedrawRegions(&self) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Direct2D_Common")]
