...
pub unsafe fn DCompositionWaitForCompositorClock(handles: ::core::option::Option<&[super::super::Foundation::HANDLE]>, timeoutinms: u32) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(DCompositionWaitForCompositorClock(handles.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(handles.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), ::core::mem::transmute(timeoutinms)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
impl IDCompositionVirtualSurface {
    ...
    pub unsafe fn Trim(&self, rectangles: ::core::option::Option<&[super::super::Foundation::RECT]>) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).Trim)(::core::mem::transmute_copy(self), ::core::mem::transmute(rectangles.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), rectangles.as_ref().map_or(0, |value| value.len()) as _).ok()
    }
}
