...
#[inline]
pub unsafe fn NtOpenProcess(processhandle: *mut super::HANDLE, desiredaccess: super::ACCESS_MASK, objectattributes: *const super::OBJECT_ATTRIBUTES, clientid: Option<*const super::CLIENT_ID>) -> windows_core::NTSTATUS {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlMapGenericMask(accessmask: *mut super::ACCESS_MASK, genericmapping: *const super::GENERIC_MAPPING) {
    windows_core::link!("ntdll.dll" "system" fn RtlMapGenericMask(accessmask : *mut super::ACCESS_MASK, genericmapping : *const super::GENERIC_MAPPING));
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlRunOnceBeginInitialize(runonce: *mut super::RTL_RUN_ONCE, flags: u32, context: *mut *mut core::ffi::c_void) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn RtlRunOnceBeginInitialize(runonce : *mut super::RTL_RUN_ONCE, flags : u32, context : *mut *mut core::ffi::c_void) -> windows_core::NTSTATUS);
    unsafe { RtlRunOnceBeginInitialize(runonce as _, flags, context as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlRunOnceComplete(runonce: *mut super::RTL_RUN_ONCE, flags: u32, context: Option<*const core::ffi::c_void>) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn RtlRunOnceComplete(runonce : *mut super::RTL_RUN_ONCE, flags : u32, context : *const core::ffi::c_void) -> windows_core::NTSTATUS);
    unsafe { RtlRunOnceComplete(runonce as _, flags, context.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlRunOnceExecuteOnce(runonce: *mut super::RTL_RUN_ONCE, initfn: PRTL_RUN_ONCE_INIT_FN, parameter: Option<*mut core::ffi::c_void>, context: *mut *mut core::ffi::c_void) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn RtlRunOnceExecuteOnce(runonce : *mut super::RTL_RUN_ONCE, initfn : PRTL_RUN_ONCE_INIT_FN, parameter : *mut core::ffi::c_void, context : *mut *mut core::ffi::c_void) -> windows_core::NTSTATUS);
...
pub unsafe fn RtlRunOnceInitialize() -> super::RTL_RUN_ONCE {
    windows_core::link!("ntdll.dll" "system" fn RtlRunOnceInitialize(runonce : *mut super::RTL_RUN_ONCE));
    unsafe {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ZwAllocateLocallyUniqueId(luid: *mut super::LUID) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn ZwAllocateLocallyUniqueId(luid : *mut super::LUID) -> windows_core::NTSTATUS);
    unsafe { ZwAllocateLocallyUniqueId(luid as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ZwCancelTimer(timerhandle: super::HANDLE, currentstate: Option<*mut bool>) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "C" fn ZwCancelTimer(timerhandle : super::HANDLE, currentstate : *mut bool) -> windows_core::NTSTATUS);
...
#[inline]
pub unsafe fn ZwCreateTimer(timerhandle: *mut super::HANDLE, desiredaccess: super::ACCESS_MASK, objectattributes: Option<*const super::OBJECT_ATTRIBUTES>, timertype: super::TIMER_TYPE) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "C" fn ZwCreateTimer(timerhandle : *mut super::HANDLE, desiredaccess : super::ACCESS_MASK, objectattributes : *const super::OBJECT_ATTRIBUTES, timertype : super::TIMER_TYPE) -> windows_core::NTSTATUS);
    unsafe { ZwCreateTimer(timerhandle as _, desiredaccess, objectattributes.unwrap_or(core::mem::zeroed()) as _, timertype) }
}
#[cfg(all(feature = "winnt", feature = "winternl"))]
#[inline]
pub unsafe fn ZwDeviceIoControlFile(filehandle: super::HANDLE, event: Option<super::HANDLE>, apcroutine: super::PIO_APC_ROUTINE, apccontext: Option<*const core::ffi::c_void>, iostatusblock: *mut super::IO_STATUS_BLOCK, iocontrolcode: u32, inputbuffer: Option<*const core::ffi::c_void>, inputbufferlength: u32, outputbuffer: Option<*mut core::ffi::c_void>, outputbufferlength: u32) -> windows_core::NTSTATUS {
...
#[cfg(all(feature = "winnt", feature = "winternl"))]
#[inline]
pub unsafe fn ZwOpenProcess(processhandle: *mut super::HANDLE, desiredaccess: super::ACCESS_MASK, objectattributes: *const super::OBJECT_ATTRIBUTES, clientid: Option<*const super::CLIENT_ID>) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn ZwOpenProcess(processhandle : *mut super::HANDLE, desiredaccess : super::ACCESS_MASK, objectattributes : *const super::OBJECT_ATTRIBUTES, clientid : *const super::CLIENT_ID) -> windows_core::NTSTATUS);
    unsafe { ZwOpenProcess(processhandle as _, desiredaccess, objectattributes, clientid.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(all(feature = "winnt", feature = "winternl"))]
#[inline]
pub unsafe fn ZwOpenTimer(timerhandle: *mut super::HANDLE, desiredaccess: super::ACCESS_MASK, objectattributes: *const super::OBJECT_ATTRIBUTES) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "C" fn ZwOpenTimer(timerhandle : *mut super::HANDLE, desiredaccess : super::ACCESS_MASK, objectattributes : *const super::OBJECT_ATTRIBUTES) -> windows_core::NTSTATUS);
...
#[inline]
pub unsafe fn ZwQueryVolumeInformationFile(filehandle: super::HANDLE, iostatusblock: *mut super::IO_STATUS_BLOCK, fsinformation: *mut core::ffi::c_void, length: u32, fsinformationclass: super::FS_INFORMATION_CLASS) -> windows_core::NTSTATUS {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ZwSetTimer(timerhandle: super::HANDLE, duetime: *const i64, timerapcroutine: PTIMER_APC_ROUTINE, timercontext: Option<*const core::ffi::c_void>, resumetimer: bool, period: Option<i32>, previousstate: Option<*mut bool>) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "C" fn ZwSetTimer(timerhandle : super::HANDLE, duetime : *const i64, timerapcroutine : PTIMER_APC_ROUTINE, timercontext : *const core::ffi::c_void, resumetimer : bool, period : i32, previousstate : *mut bool) -> windows_core::NTSTATUS);
...
#[cfg(feature = "winnt")]
pub type PGET_LOCATION_STRING = Option<unsafe extern "system" fn(context: *mut core::ffi::c_void, locationstrings: *mut super::PZZWSTR) -> windows_core::NTSTATUS>;
...
#[cfg(all(feature = "basetsd", feature = "ntdef", feature = "ntifs", feature = "usb", feature = "wdm", feature = "winnt", feature = "winternl"))]
pub type pHalIoReadPartitionTable = Option<unsafe extern "system" fn(deviceobject: *const super::DEVICE_OBJECT, sectorsize: u32, returnrecognizedpartitions: bool, partitionbuffer: *mut *mut _DRIVE_LAYOUT_INFORMATION) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "basetsd", feature = "ntdef", feature = "ntifs", feature = "usb", feature = "wdm", feature = "winnt", feature = "winternl"))]
...
#[cfg(all(feature = "basetsd", feature = "ntdef", feature = "ntifs", feature = "usb", feature = "wdm", feature = "winnt", feature = "winternl"))]
pub type pHalIoWritePartitionTable = Option<unsafe extern "system" fn(deviceobject: *const super::DEVICE_OBJECT, sectorsize: u32, sectorspertrack: u32, numberofheads: u32, partitionbuffer: *const _DRIVE_LAYOUT_INFORMATION) -> windows_core::NTSTATUS>;
#[cfg(feature = "usb")]
pub type pHalMirrorPhysicalMemory = Option<unsafe extern "system" fn(physicaladdress: super::PHYSICAL_ADDRESS, numberofbytes: i64) -> windows_core::NTSTATUS>;
#[cfg(feature = "usb")]
pub type pHalMirrorVerify = Option<unsafe extern "system" fn(physicaladdress: super::PHYSICAL_ADDRESS, numberofbytes: i64) -> windows_core::NTSTATUS>;
