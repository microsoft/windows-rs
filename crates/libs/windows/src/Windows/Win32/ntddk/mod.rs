#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn DbgPrompt(prompt: super::PCCH, response: super::PCH, length: u32) -> u32 {
    windows_core::link!("ntdll.dll" "system" fn DbgPrompt(prompt : super::PCCH, response : super::PCH, length : u32) -> u32);
    unsafe { DbgPrompt(prompt, response as _, length) }
}
#[cfg(all(feature = "d3dkmthk", feature = "lsalookup", feature = "ntsecapi", feature = "wdm", feature = "winnt", feature = "winternl"))]
#[inline]
pub unsafe fn NtOpenProcess(processhandle: super::PHANDLE, desiredaccess: super::ACCESS_MASK, objectattributes: super::POBJECT_ATTRIBUTES, clientid: Option<super::PCLIENT_ID>) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn NtOpenProcess(processhandle : super::PHANDLE, desiredaccess : super::ACCESS_MASK, objectattributes : super::POBJECT_ATTRIBUTES, clientid : super::PCLIENT_ID) -> windows_core::NTSTATUS);
...
#[inline]
pub unsafe fn RtlCompareString(string1: *const super::STRING, string2: *const super::STRING, caseinsensitive: super::BOOLEAN) -> i32 {
    windows_core::link!("ntdll.dll" "system" fn RtlCompareString(string1 : *const super::STRING, string2 : *const super::STRING, caseinsensitive : super::BOOLEAN) -> i32);
    unsafe { RtlCompareString(string1, string2, caseinsensitive) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlContractHashTable(hashtable: PRTL_DYNAMIC_HASH_TABLE) -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlContractHashTable(hashtable : PRTL_DYNAMIC_HASH_TABLE) -> super::BOOLEAN);
    unsafe { RtlContractHashTable(hashtable) }
}
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "winnt", feature = "winternl"))]
#[inline]
pub unsafe fn RtlCopyString(destinationstring: super::PSTRING, sourcestring: Option<*const super::STRING>) {
    windows_core::link!("ntdll.dll" "system" fn RtlCopyString(destinationstring : super::PSTRING, sourcestring : *const super::STRING));
    unsafe { RtlCopyString(destinationstring as _, sourcestring.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlCreateHashTable(hashtable: *mut PRTL_DYNAMIC_HASH_TABLE, shift: u32, flags: Option<u32>) -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlCreateHashTable(hashtable : *mut PRTL_DYNAMIC_HASH_TABLE, shift : u32, flags : u32) -> super::BOOLEAN);
    unsafe { RtlCreateHashTable(hashtable as _, shift, flags.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlCreateHashTableEx(hashtable: *mut PRTL_DYNAMIC_HASH_TABLE, initialsize: u32, shift: u32, flags: Option<u32>) -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlCreateHashTableEx(hashtable : *mut PRTL_DYNAMIC_HASH_TABLE, initialsize : u32, shift : u32, flags : u32) -> super::BOOLEAN);
    unsafe { RtlCreateHashTableEx(hashtable as _, initialsize, shift, flags.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn RtlDelete(links: PRTL_SPLAY_LINKS) -> PRTL_SPLAY_LINKS {
    windows_core::link!("ntdll.dll" "system" fn RtlDelete(links : PRTL_SPLAY_LINKS) -> PRTL_SPLAY_LINKS);
    unsafe { RtlDelete(links) }
}
#[cfg(all(feature = "ntdef", feature = "winnt"))]
#[inline]
pub unsafe fn RtlDeleteElementGenericTable(table: PRTL_GENERIC_TABLE, buffer: *const core::ffi::c_void) -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlDeleteElementGenericTable(table : PRTL_GENERIC_TABLE, buffer : *const core::ffi::c_void) -> super::BOOLEAN);
    unsafe { RtlDeleteElementGenericTable(table, buffer) }
}
#[cfg(all(feature = "ntdef", feature = "winnt"))]
#[inline]
pub unsafe fn RtlDeleteElementGenericTableAvl(table: PRTL_AVL_TABLE, buffer: *const core::ffi::c_void) -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlDeleteElementGenericTableAvl(table : PRTL_AVL_TABLE, buffer : *const core::ffi::c_void) -> super::BOOLEAN);
    unsafe { RtlDeleteElementGenericTableAvl(table, buffer) }
}
#[cfg(feature = "ntdef")]
#[inline]
pub unsafe fn RtlDeleteElementGenericTableAvlEx(table: PRTL_AVL_TABLE, nodeorparent: *const core::ffi::c_void) {
    windows_core::link!("ntdll.dll" "system" fn RtlDeleteElementGenericTableAvlEx(table : PRTL_AVL_TABLE, nodeorparent : *const core::ffi::c_void));
    unsafe { RtlDeleteElementGenericTableAvlEx(table, nodeorparent) }
}
#[inline]
pub unsafe fn RtlDeleteHashTable(hashtable: PRTL_DYNAMIC_HASH_TABLE) {
    windows_core::link!("ntdll.dll" "system" fn RtlDeleteHashTable(hashtable : PRTL_DYNAMIC_HASH_TABLE));
    unsafe { RtlDeleteHashTable(hashtable) }
}
#[inline]
pub unsafe fn RtlDeleteNoSplay(links: PRTL_SPLAY_LINKS, root: *mut PRTL_SPLAY_LINKS) {
    windows_core::link!("ntdll.dll" "system" fn RtlDeleteNoSplay(links : PRTL_SPLAY_LINKS, root : *mut PRTL_SPLAY_LINKS));
    unsafe { RtlDeleteNoSplay(links, root as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlEndEnumerationHashTable(hashtable: PRTL_DYNAMIC_HASH_TABLE, enumerator: PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR) {
    windows_core::link!("ntdll.dll" "system" fn RtlEndEnumerationHashTable(hashtable : PRTL_DYNAMIC_HASH_TABLE, enumerator : PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR));
    unsafe { RtlEndEnumerationHashTable(hashtable, enumerator as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlEndStrongEnumerationHashTable(hashtable: PRTL_DYNAMIC_HASH_TABLE, enumerator: PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR) {
    windows_core::link!("ntdll.dll" "system" fn RtlEndStrongEnumerationHashTable(hashtable : PRTL_DYNAMIC_HASH_TABLE, enumerator : PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR));
    unsafe { RtlEndStrongEnumerationHashTable(hashtable, enumerator as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlEndWeakEnumerationHashTable(hashtable: PRTL_DYNAMIC_HASH_TABLE, enumerator: PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR) {
    windows_core::link!("ntdll.dll" "system" fn RtlEndWeakEnumerationHashTable(hashtable : PRTL_DYNAMIC_HASH_TABLE, enumerator : PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR));
    unsafe { RtlEndWeakEnumerationHashTable(hashtable, enumerator as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlEnumerateEntryHashTable(hashtable: PRTL_DYNAMIC_HASH_TABLE, enumerator: PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR) -> PRTL_DYNAMIC_HASH_TABLE_ENTRY {
    windows_core::link!("ntdll.dll" "system" fn RtlEnumerateEntryHashTable(hashtable : PRTL_DYNAMIC_HASH_TABLE, enumerator : PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR) -> PRTL_DYNAMIC_HASH_TABLE_ENTRY);
    unsafe { RtlEnumerateEntryHashTable(hashtable, enumerator as _) }
}
#[cfg(all(feature = "ntdef", feature = "winnt"))]
#[inline]
pub unsafe fn RtlEnumerateGenericTable(table: PRTL_GENERIC_TABLE, restart: super::BOOLEAN) -> *mut core::ffi::c_void {
    windows_core::link!("ntdll.dll" "system" fn RtlEnumerateGenericTable(table : PRTL_GENERIC_TABLE, restart : super::BOOLEAN) -> *mut core::ffi::c_void);
    unsafe { RtlEnumerateGenericTable(table, restart) }
}
#[cfg(all(feature = "ntdef", feature = "winnt"))]
#[inline]
pub unsafe fn RtlEnumerateGenericTableAvl(table: PRTL_AVL_TABLE, restart: super::BOOLEAN) -> *mut core::ffi::c_void {
    windows_core::link!("ntdll.dll" "system" fn RtlEnumerateGenericTableAvl(table : PRTL_AVL_TABLE, restart : super::BOOLEAN) -> *mut core::ffi::c_void);
    unsafe { RtlEnumerateGenericTableAvl(table, restart) }
}
#[cfg(all(feature = "minwindef", feature = "ntdef"))]
#[inline]
pub unsafe fn RtlEnumerateGenericTableLikeADirectory(table: PRTL_AVL_TABLE, matchfunction: PRTL_AVL_MATCH_FUNCTION, matchdata: Option<*const core::ffi::c_void>, nextflag: u32, restartkey: *mut *mut core::ffi::c_void, deletecount: super::PULONG, buffer: *const core::ffi::c_void) -> *mut core::ffi::c_void {
    windows_core::link!("ntdll.dll" "system" fn RtlEnumerateGenericTableLikeADirectory(table : PRTL_AVL_TABLE, matchfunction : PRTL_AVL_MATCH_FUNCTION, matchdata : *const core::ffi::c_void, nextflag : u32, restartkey : *mut *mut core::ffi::c_void, deletecount : super::PULONG, buffer : *const core::ffi::c_void) -> *mut core::ffi::c_void);
...
#[cfg(all(feature = "ntdef", feature = "winnt"))]
#[inline]
pub unsafe fn RtlEnumerateGenericTableWithoutSplaying(table: PRTL_GENERIC_TABLE, restartkey: *mut *mut core::ffi::c_void) -> *mut core::ffi::c_void {
    windows_core::link!("ntdll.dll" "system" fn RtlEnumerateGenericTableWithoutSplaying(table : PRTL_GENERIC_TABLE, restartkey : *mut *mut core::ffi::c_void) -> *mut core::ffi::c_void);
    unsafe { RtlEnumerateGenericTableWithoutSplaying(table, restartkey as _) }
}
#[cfg(feature = "ntdef")]
#[inline]
pub unsafe fn RtlEnumerateGenericTableWithoutSplayingAvl(table: PRTL_AVL_TABLE, restartkey: *mut *mut core::ffi::c_void) -> *mut core::ffi::c_void {
    windows_core::link!("ntdll.dll" "system" fn RtlEnumerateGenericTableWithoutSplayingAvl(table : PRTL_AVL_TABLE, restartkey : *mut *mut core::ffi::c_void) -> *mut core::ffi::c_void);
    unsafe { RtlEnumerateGenericTableWithoutSplayingAvl(table, restartkey as _) }
}
#[cfg(all(feature = "winnt", feature = "winternl"))]
#[inline]
pub unsafe fn RtlEqualString(string1: *const super::STRING, string2: *const super::STRING, caseinsensitive: super::BOOLEAN) -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlEqualString(string1 : *const super::STRING, string2 : *const super::STRING, caseinsensitive : super::BOOLEAN) -> super::BOOLEAN);
    unsafe { RtlEqualString(string1, string2, caseinsensitive) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlExpandHashTable(hashtable: PRTL_DYNAMIC_HASH_TABLE) -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlExpandHashTable(hashtable : PRTL_DYNAMIC_HASH_TABLE) -> super::BOOLEAN);
...
#[cfg(all(feature = "ntdef", feature = "winnt"))]
#[inline]
pub unsafe fn RtlGetElementGenericTable(table: PRTL_GENERIC_TABLE, i: u32) -> *mut core::ffi::c_void {
    windows_core::link!("ntdll.dll" "system" fn RtlGetElementGenericTable(table : PRTL_GENERIC_TABLE, i : u32) -> *mut core::ffi::c_void);
    unsafe { RtlGetElementGenericTable(table, i) }
}
#[cfg(feature = "ntdef")]
#[inline]
pub unsafe fn RtlGetElementGenericTableAvl(table: PRTL_AVL_TABLE, i: u32) -> *mut core::ffi::c_void {
    windows_core::link!("ntdll.dll" "system" fn RtlGetElementGenericTableAvl(table : PRTL_AVL_TABLE, i : u32) -> *mut core::ffi::c_void);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlGetNextEntryHashTable(hashtable: PRTL_DYNAMIC_HASH_TABLE, context: PRTL_DYNAMIC_HASH_TABLE_CONTEXT) -> PRTL_DYNAMIC_HASH_TABLE_ENTRY {
    windows_core::link!("ntdll.dll" "system" fn RtlGetNextEntryHashTable(hashtable : PRTL_DYNAMIC_HASH_TABLE, context : PRTL_DYNAMIC_HASH_TABLE_CONTEXT) -> PRTL_DYNAMIC_HASH_TABLE_ENTRY);
    unsafe { RtlGetNextEntryHashTable(hashtable, context) }
}
#[cfg(all(feature = "ntdef", feature = "winnt"))]
#[inline]
pub unsafe fn RtlGetNtProductType(ntproducttype: super::PNT_PRODUCT_TYPE) -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlGetNtProductType(ntproducttype : super::PNT_PRODUCT_TYPE) -> super::BOOLEAN);
...
#[inline]
pub unsafe fn RtlGetPersistedStateLocation<P0, P1, P2>(sourceid: P0, customvalue: P1, defaultpath: P2, statelocationtype: STATE_LOCATION_TYPE, targetpath: Option<super::PWCHAR>, bufferlengthin: u32, bufferlengthout: Option<super::PULONG>) -> windows_core::NTSTATUS
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("ntdll.dll" "system" fn RtlGetPersistedStateLocation(sourceid : windows_core::PCWSTR, customvalue : windows_core::PCWSTR, defaultpath : windows_core::PCWSTR, statelocationtype : STATE_LOCATION_TYPE, targetpath : super::PWCHAR, bufferlengthin : u32, bufferlengthout : super::PULONG) -> windows_core::NTSTATUS);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlInitEnumerationHashTable(hashtable: PRTL_DYNAMIC_HASH_TABLE, enumerator: PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR) -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlInitEnumerationHashTable(hashtable : PRTL_DYNAMIC_HASH_TABLE, enumerator : PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR) -> super::BOOLEAN);
    unsafe { RtlInitEnumerationHashTable(hashtable, enumerator as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlInitStrongEnumerationHashTable(hashtable: PRTL_DYNAMIC_HASH_TABLE, enumerator: PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR) -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlInitStrongEnumerationHashTable(hashtable : PRTL_DYNAMIC_HASH_TABLE, enumerator : PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR) -> super::BOOLEAN);
    unsafe { RtlInitStrongEnumerationHashTable(hashtable, enumerator as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlInitWeakEnumerationHashTable(hashtable: PRTL_DYNAMIC_HASH_TABLE, enumerator: PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR) -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlInitWeakEnumerationHashTable(hashtable : PRTL_DYNAMIC_HASH_TABLE, enumerator : PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR) -> super::BOOLEAN);
    unsafe { RtlInitWeakEnumerationHashTable(hashtable, enumerator as _) }
}
#[cfg(all(feature = "ntdef", feature = "winnt"))]
#[inline]
pub unsafe fn RtlInitializeGenericTable(table: PRTL_GENERIC_TABLE, compareroutine: PRTL_GENERIC_COMPARE_ROUTINE, allocateroutine: PRTL_GENERIC_ALLOCATE_ROUTINE, freeroutine: PRTL_GENERIC_FREE_ROUTINE, tablecontext: Option<*const core::ffi::c_void>) {
    windows_core::link!("ntdll.dll" "system" fn RtlInitializeGenericTable(table : PRTL_GENERIC_TABLE, compareroutine : PRTL_GENERIC_COMPARE_ROUTINE, allocateroutine : PRTL_GENERIC_ALLOCATE_ROUTINE, freeroutine : PRTL_GENERIC_FREE_ROUTINE, tablecontext : *const core::ffi::c_void));
...
#[cfg(feature = "ntdef")]
#[inline]
pub unsafe fn RtlInitializeGenericTableAvl(table: PRTL_AVL_TABLE, compareroutine: PRTL_AVL_COMPARE_ROUTINE, allocateroutine: PRTL_AVL_ALLOCATE_ROUTINE, freeroutine: PRTL_AVL_FREE_ROUTINE, tablecontext: Option<*const core::ffi::c_void>) {
    windows_core::link!("ntdll.dll" "system" fn RtlInitializeGenericTableAvl(table : PRTL_AVL_TABLE, compareroutine : PRTL_AVL_COMPARE_ROUTINE, allocateroutine : PRTL_AVL_ALLOCATE_ROUTINE, freeroutine : PRTL_AVL_FREE_ROUTINE, tablecontext : *const core::ffi::c_void));
...
#[cfg(all(feature = "ntdef", feature = "winnt"))]
#[inline]
pub unsafe fn RtlInsertElementGenericTable(table: PRTL_GENERIC_TABLE, buffer: *const core::ffi::c_void, buffersize: super::CLONG, newelement: Option<super::PBOOLEAN>) -> *mut core::ffi::c_void {
    windows_core::link!("ntdll.dll" "system" fn RtlInsertElementGenericTable(table : PRTL_GENERIC_TABLE, buffer : *const core::ffi::c_void, buffersize : super::CLONG, newelement : super::PBOOLEAN) -> *mut core::ffi::c_void);
    unsafe { RtlInsertElementGenericTable(table, buffer, buffersize, newelement.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(all(feature = "ntdef", feature = "winnt"))]
#[inline]
pub unsafe fn RtlInsertElementGenericTableAvl(table: PRTL_AVL_TABLE, buffer: *const core::ffi::c_void, buffersize: super::CLONG, newelement: Option<super::PBOOLEAN>) -> *mut core::ffi::c_void {
    windows_core::link!("ntdll.dll" "system" fn RtlInsertElementGenericTableAvl(table : PRTL_AVL_TABLE, buffer : *const core::ffi::c_void, buffersize : super::CLONG, newelement : super::PBOOLEAN) -> *mut core::ffi::c_void);
    unsafe { RtlInsertElementGenericTableAvl(table, buffer, buffersize, newelement.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(all(feature = "ntdef", feature = "winnt"))]
#[inline]
pub unsafe fn RtlInsertElementGenericTableFull(table: PRTL_GENERIC_TABLE, buffer: *const core::ffi::c_void, buffersize: super::CLONG, newelement: Option<super::PBOOLEAN>, nodeorparent: *const core::ffi::c_void, searchresult: TABLE_SEARCH_RESULT) -> *mut core::ffi::c_void {
    windows_core::link!("ntdll.dll" "system" fn RtlInsertElementGenericTableFull(table : PRTL_GENERIC_TABLE, buffer : *const core::ffi::c_void, buffersize : super::CLONG, newelement : super::PBOOLEAN, nodeorparent : *const core::ffi::c_void, searchresult : TABLE_SEARCH_RESULT) -> *mut core::ffi::c_void);
...
#[cfg(all(feature = "ntdef", feature = "winnt"))]
#[inline]
pub unsafe fn RtlInsertElementGenericTableFullAvl(table: PRTL_AVL_TABLE, buffer: *const core::ffi::c_void, buffersize: super::CLONG, newelement: Option<super::PBOOLEAN>, nodeorparent: *const core::ffi::c_void, searchresult: TABLE_SEARCH_RESULT) -> *mut core::ffi::c_void {
    windows_core::link!("ntdll.dll" "system" fn RtlInsertElementGenericTableFullAvl(table : PRTL_AVL_TABLE, buffer : *const core::ffi::c_void, buffersize : super::CLONG, newelement : super::PBOOLEAN, nodeorparent : *const core::ffi::c_void, searchresult : TABLE_SEARCH_RESULT) -> *mut core::ffi::c_void);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlInsertEntryHashTable(hashtable: PRTL_DYNAMIC_HASH_TABLE, entry: PRTL_DYNAMIC_HASH_TABLE_ENTRY, signature: usize, context: Option<PRTL_DYNAMIC_HASH_TABLE_CONTEXT>) -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlInsertEntryHashTable(hashtable : PRTL_DYNAMIC_HASH_TABLE, entry : PRTL_DYNAMIC_HASH_TABLE_ENTRY, signature : usize, context : PRTL_DYNAMIC_HASH_TABLE_CONTEXT) -> super::BOOLEAN);
...
#[cfg(all(feature = "ntdef", feature = "winnt"))]
#[inline]
pub unsafe fn RtlIsGenericTableEmpty(table: PRTL_GENERIC_TABLE) -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlIsGenericTableEmpty(table : PRTL_GENERIC_TABLE) -> super::BOOLEAN);
    unsafe { RtlIsGenericTableEmpty(table) }
}
#[cfg(all(feature = "ntdef", feature = "winnt"))]
#[inline]
pub unsafe fn RtlIsGenericTableEmptyAvl(table: PRTL_AVL_TABLE) -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlIsGenericTableEmptyAvl(table : PRTL_AVL_TABLE) -> super::BOOLEAN);
    unsafe { RtlIsGenericTableEmptyAvl(table) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlIsMultiSessionSku() -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlIsMultiSessionSku() -> super::BOOLEAN);
    unsafe { RtlIsMultiSessionSku() }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlIsMultiUsersInSessionSku() -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlIsMultiUsersInSessionSku() -> super::BOOLEAN);
    unsafe { RtlIsMultiUsersInSessionSku() }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlIsStateSeparationEnabled() -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlIsStateSeparationEnabled() -> super::BOOLEAN);
    unsafe { RtlIsStateSeparationEnabled() }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlIsUntrustedObject(handle: Option<super::HANDLE>, object: Option<*const core::ffi::c_void>, untrustedobject: super::PBOOLEAN) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn RtlIsUntrustedObject(handle : super::HANDLE, object : *const core::ffi::c_void, untrustedobject : super::PBOOLEAN) -> windows_core::NTSTATUS);
...
#[cfg(all(feature = "ntdef", feature = "winnt"))]
#[inline]
pub unsafe fn RtlLookupElementGenericTable(table: PRTL_GENERIC_TABLE, buffer: *const core::ffi::c_void) -> *mut core::ffi::c_void {
    windows_core::link!("ntdll.dll" "system" fn RtlLookupElementGenericTable(table : PRTL_GENERIC_TABLE, buffer : *const core::ffi::c_void) -> *mut core::ffi::c_void);
    unsafe { RtlLookupElementGenericTable(table, buffer) }
}
#[cfg(feature = "ntdef")]
#[inline]
pub unsafe fn RtlLookupElementGenericTableAvl(table: PRTL_AVL_TABLE, buffer: *const core::ffi::c_void) -> *mut core::ffi::c_void {
    windows_core::link!("ntdll.dll" "system" fn RtlLookupElementGenericTableAvl(table : PRTL_AVL_TABLE, buffer : *const core::ffi::c_void) -> *mut core::ffi::c_void);
    unsafe { RtlLookupElementGenericTableAvl(table, buffer) }
}
#[cfg(all(feature = "ntdef", feature = "winnt"))]
#[inline]
pub unsafe fn RtlLookupElementGenericTableFull(table: PRTL_GENERIC_TABLE, buffer: *const core::ffi::c_void, nodeorparent: *mut *mut core::ffi::c_void, searchresult: *mut TABLE_SEARCH_RESULT) -> *mut core::ffi::c_void {
    windows_core::link!("ntdll.dll" "system" fn RtlLookupElementGenericTableFull(table : PRTL_GENERIC_TABLE, buffer : *const core::ffi::c_void, nodeorparent : *mut *mut core::ffi::c_void, searchresult : *mut TABLE_SEARCH_RESULT) -> *mut core::ffi::c_void);
    unsafe { RtlLookupElementGenericTableFull(table, buffer, nodeorparent as _, searchresult as _) }
}
#[cfg(feature = "ntdef")]
#[inline]
pub unsafe fn RtlLookupElementGenericTableFullAvl(table: PRTL_AVL_TABLE, buffer: *const core::ffi::c_void, nodeorparent: *mut *mut core::ffi::c_void, searchresult: *mut TABLE_SEARCH_RESULT) -> *mut core::ffi::c_void {
    windows_core::link!("ntdll.dll" "system" fn RtlLookupElementGenericTableFullAvl(table : PRTL_AVL_TABLE, buffer : *const core::ffi::c_void, nodeorparent : *mut *mut core::ffi::c_void, searchresult : *mut TABLE_SEARCH_RESULT) -> *mut core::ffi::c_void);
    unsafe { RtlLookupElementGenericTableFullAvl(table, buffer, nodeorparent as _, searchresult as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlLookupEntryHashTable(hashtable: PRTL_DYNAMIC_HASH_TABLE, signature: usize, context: Option<PRTL_DYNAMIC_HASH_TABLE_CONTEXT>) -> PRTL_DYNAMIC_HASH_TABLE_ENTRY {
    windows_core::link!("ntdll.dll" "system" fn RtlLookupEntryHashTable(hashtable : PRTL_DYNAMIC_HASH_TABLE, signature : usize, context : PRTL_DYNAMIC_HASH_TABLE_CONTEXT) -> PRTL_DYNAMIC_HASH_TABLE_ENTRY);
    unsafe { RtlLookupEntryHashTable(hashtable, signature, context.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "ntdef")]
#[inline]
pub unsafe fn RtlLookupFirstMatchingElementGenericTableAvl(table: PRTL_AVL_TABLE, buffer: *const core::ffi::c_void, restartkey: *mut *mut core::ffi::c_void) -> *mut core::ffi::c_void {
    windows_core::link!("ntdll.dll" "system" fn RtlLookupFirstMatchingElementGenericTableAvl(table : PRTL_AVL_TABLE, buffer : *const core::ffi::c_void, restartkey : *mut *mut core::ffi::c_void) -> *mut core::ffi::c_void);
    unsafe { RtlLookupFirstMatchingElementGenericTableAvl(table, buffer, restartkey as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlMapGenericMask(accessmask: super::PACCESS_MASK, genericmapping: *const super::GENERIC_MAPPING) {
    windows_core::link!("ntdll.dll" "system" fn RtlMapGenericMask(accessmask : super::PACCESS_MASK, genericmapping : *const super::GENERIC_MAPPING));
    unsafe { RtlMapGenericMask(accessmask as _, genericmapping) }
}
#[cfg(all(feature = "ntdef", feature = "winnt"))]
#[inline]
pub unsafe fn RtlNumberGenericTableElements(table: PRTL_GENERIC_TABLE) -> u32 {
    windows_core::link!("ntdll.dll" "system" fn RtlNumberGenericTableElements(table : PRTL_GENERIC_TABLE) -> u32);
    unsafe { RtlNumberGenericTableElements(table) }
}
#[cfg(feature = "ntdef")]
#[inline]
pub unsafe fn RtlNumberGenericTableElementsAvl(table: PRTL_AVL_TABLE) -> u32 {
    windows_core::link!("ntdll.dll" "system" fn RtlNumberGenericTableElementsAvl(table : PRTL_AVL_TABLE) -> u32);
    unsafe { RtlNumberGenericTableElementsAvl(table) }
}
#[cfg(all(feature = "winnt", feature = "winternl"))]
#[inline]
pub unsafe fn RtlPrefixUnicodeString(string1: super::PCUNICODE_STRING, string2: super::PCUNICODE_STRING, caseinsensitive: super::BOOLEAN) -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlPrefixUnicodeString(string1 : super::PCUNICODE_STRING, string2 : super::PCUNICODE_STRING, caseinsensitive : super::BOOLEAN) -> super::BOOLEAN);
...
#[inline]
pub unsafe fn RtlQueryRegistryValueWithFallback(primaryhandle: Option<super::HANDLE>, fallbackhandle: Option<super::HANDLE>, valuename: super::PUNICODE_STRING, valuelength: u32, valuetype: Option<super::PULONG>, valuedata: *mut core::ffi::c_void, resultlength: super::PULONG) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn RtlQueryRegistryValueWithFallback(primaryhandle : super::HANDLE, fallbackhandle : super::HANDLE, valuename : super::PUNICODE_STRING, valuelength : u32, valuetype : super::PULONG, valuedata : *mut core::ffi::c_void, resultlength : super::PULONG) -> windows_core::NTSTATUS);
    unsafe { RtlQueryRegistryValueWithFallback(primaryhandle.unwrap_or(core::mem::zeroed()) as _, fallbackhandle.unwrap_or(core::mem::zeroed()) as _, valuename, valuelength, valuetype.unwrap_or(core::mem::zeroed()) as _, valuedata as _, resultlength) }
}
#[inline]
pub unsafe fn RtlRealPredecessor(links: PRTL_SPLAY_LINKS) -> PRTL_SPLAY_LINKS {
    windows_core::link!("ntdll.dll" "system" fn RtlRealPredecessor(links : PRTL_SPLAY_LINKS) -> PRTL_SPLAY_LINKS);
    unsafe { RtlRealPredecessor(links) }
}
#[inline]
pub unsafe fn RtlRealSuccessor(links: PRTL_SPLAY_LINKS) -> PRTL_SPLAY_LINKS {
    windows_core::link!("ntdll.dll" "system" fn RtlRealSuccessor(links : PRTL_SPLAY_LINKS) -> PRTL_SPLAY_LINKS);
    unsafe { RtlRealSuccessor(links) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlRemoveEntryHashTable(hashtable: PRTL_DYNAMIC_HASH_TABLE, entry: PRTL_DYNAMIC_HASH_TABLE_ENTRY, context: Option<PRTL_DYNAMIC_HASH_TABLE_CONTEXT>) -> super::BOOLEAN {
    windows_core::link!("ntdll.dll" "system" fn RtlRemoveEntryHashTable(hashtable : PRTL_DYNAMIC_HASH_TABLE, entry : PRTL_DYNAMIC_HASH_TABLE_ENTRY, context : PRTL_DYNAMIC_HASH_TABLE_CONTEXT) -> super::BOOLEAN);
    unsafe { RtlRemoveEntryHashTable(hashtable, entry, context.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlRunOnceBeginInitialize(runonce: super::PRTL_RUN_ONCE, flags: u32, context: *mut *mut core::ffi::c_void) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn RtlRunOnceBeginInitialize(runonce : super::PRTL_RUN_ONCE, flags : u32, context : *mut *mut core::ffi::c_void) -> windows_core::NTSTATUS);
    unsafe { RtlRunOnceBeginInitialize(runonce as _, flags, context as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlRunOnceComplete(runonce: super::PRTL_RUN_ONCE, flags: u32, context: Option<*const core::ffi::c_void>) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn RtlRunOnceComplete(runonce : super::PRTL_RUN_ONCE, flags : u32, context : *const core::ffi::c_void) -> windows_core::NTSTATUS);
    unsafe { RtlRunOnceComplete(runonce as _, flags, context.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlRunOnceExecuteOnce(runonce: super::PRTL_RUN_ONCE, initfn: PRTL_RUN_ONCE_INIT_FN, parameter: Option<*mut core::ffi::c_void>, context: *mut *mut core::ffi::c_void) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn RtlRunOnceExecuteOnce(runonce : super::PRTL_RUN_ONCE, initfn : PRTL_RUN_ONCE_INIT_FN, parameter : *mut core::ffi::c_void, context : *mut *mut core::ffi::c_void) -> windows_core::NTSTATUS);
    unsafe { RtlRunOnceExecuteOnce(runonce as _, initfn, parameter.unwrap_or(core::mem::zeroed()) as _, context as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlRunOnceInitialize() -> super::RTL_RUN_ONCE {
    windows_core::link!("ntdll.dll" "system" fn RtlRunOnceInitialize(runonce : super::PRTL_RUN_ONCE));
    unsafe {
...
#[inline]
pub unsafe fn RtlSplay(links: PRTL_SPLAY_LINKS) -> PRTL_SPLAY_LINKS {
    windows_core::link!("ntdll.dll" "system" fn RtlSplay(links : PRTL_SPLAY_LINKS) -> PRTL_SPLAY_LINKS);
    unsafe { RtlSplay(links as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlStronglyEnumerateEntryHashTable(hashtable: PRTL_DYNAMIC_HASH_TABLE, enumerator: PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR) -> PRTL_DYNAMIC_HASH_TABLE_ENTRY {
    windows_core::link!("ntdll.dll" "system" fn RtlStronglyEnumerateEntryHashTable(hashtable : PRTL_DYNAMIC_HASH_TABLE, enumerator : PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR) -> PRTL_DYNAMIC_HASH_TABLE_ENTRY);
    unsafe { RtlStronglyEnumerateEntryHashTable(hashtable, enumerator as _) }
}
#[inline]
pub unsafe fn RtlSubtreePredecessor(links: PRTL_SPLAY_LINKS) -> PRTL_SPLAY_LINKS {
    windows_core::link!("ntdll.dll" "system" fn RtlSubtreePredecessor(links : PRTL_SPLAY_LINKS) -> PRTL_SPLAY_LINKS);
    unsafe { RtlSubtreePredecessor(links) }
}
#[inline]
pub unsafe fn RtlSubtreeSuccessor(links: PRTL_SPLAY_LINKS) -> PRTL_SPLAY_LINKS {
    windows_core::link!("ntdll.dll" "system" fn RtlSubtreeSuccessor(links : PRTL_SPLAY_LINKS) -> PRTL_SPLAY_LINKS);
    unsafe { RtlSubtreeSuccessor(links) }
}
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "winnt", feature = "winternl"))]
#[inline]
pub unsafe fn RtlUpcaseUnicodeString(destinationstring: super::PUNICODE_STRING, sourcestring: super::PCUNICODE_STRING, allocatedestinationstring: super::BOOLEAN) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn RtlUpcaseUnicodeString(destinationstring : super::PUNICODE_STRING, sourcestring : super::PCUNICODE_STRING, allocatedestinationstring : super::BOOLEAN) -> windows_core::NTSTATUS);
    unsafe { RtlUpcaseUnicodeString(destinationstring, sourcestring, allocatedestinationstring) }
}
#[inline]
...
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "winnt", feature = "winternl"))]
#[inline]
pub unsafe fn RtlUpperString(destinationstring: super::PSTRING, sourcestring: *const super::STRING) {
    windows_core::link!("ntdll.dll" "system" fn RtlUpperString(destinationstring : super::PSTRING, sourcestring : *const super::STRING));
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn RtlWeaklyEnumerateEntryHashTable(hashtable: PRTL_DYNAMIC_HASH_TABLE, enumerator: PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR) -> PRTL_DYNAMIC_HASH_TABLE_ENTRY {
    windows_core::link!("ntdll.dll" "system" fn RtlWeaklyEnumerateEntryHashTable(hashtable : PRTL_DYNAMIC_HASH_TABLE, enumerator : PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR) -> PRTL_DYNAMIC_HASH_TABLE_ENTRY);
    unsafe { RtlWeaklyEnumerateEntryHashTable(hashtable, enumerator as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ZwAllocateLocallyUniqueId(luid: super::PLUID) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn ZwAllocateLocallyUniqueId(luid : super::PLUID) -> windows_core::NTSTATUS);
    unsafe { ZwAllocateLocallyUniqueId(luid as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ZwCancelTimer(timerhandle: super::HANDLE, currentstate: Option<super::PBOOLEAN>) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "C" fn ZwCancelTimer(timerhandle : super::HANDLE, currentstate : super::PBOOLEAN) -> windows_core::NTSTATUS);
...
#[inline]
pub unsafe fn ZwCreateTimer(timerhandle: super::PHANDLE, desiredaccess: super::ACCESS_MASK, objectattributes: Option<super::POBJECT_ATTRIBUTES>, timertype: super::TIMER_TYPE) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "C" fn ZwCreateTimer(timerhandle : super::PHANDLE, desiredaccess : super::ACCESS_MASK, objectattributes : super::POBJECT_ATTRIBUTES, timertype : super::TIMER_TYPE) -> windows_core::NTSTATUS);
    unsafe { ZwCreateTimer(timerhandle as _, desiredaccess, objectattributes.unwrap_or(core::mem::zeroed()) as _, timertype) }
}
#[cfg(all(feature = "winnt", feature = "winternl"))]
#[inline]
pub unsafe fn ZwDeviceIoControlFile(filehandle: super::HANDLE, event: Option<super::HANDLE>, apcroutine: super::PIO_APC_ROUTINE, apccontext: Option<*const core::ffi::c_void>, iostatusblock: super::PIO_STATUS_BLOCK, iocontrolcode: u32, inputbuffer: Option<*const core::ffi::c_void>, inputbufferlength: u32, outputbuffer: Option<*mut core::ffi::c_void>, outputbufferlength: u32) -> windows_core::NTSTATUS {
...
#[inline]
pub unsafe fn ZwDisplayString(string: super::PUNICODE_STRING) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn ZwDisplayString(string : super::PUNICODE_STRING) -> windows_core::NTSTATUS);
    unsafe { ZwDisplayString(string) }
}
#[cfg(all(feature = "d3dkmthk", feature = "lsalookup", feature = "ntsecapi", feature = "wdm", feature = "winnt", feature = "winternl"))]
#[inline]
pub unsafe fn ZwOpenProcess(processhandle: super::PHANDLE, desiredaccess: super::ACCESS_MASK, objectattributes: super::POBJECT_ATTRIBUTES, clientid: Option<super::PCLIENT_ID>) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn ZwOpenProcess(processhandle : super::PHANDLE, desiredaccess : super::ACCESS_MASK, objectattributes : super::POBJECT_ATTRIBUTES, clientid : super::PCLIENT_ID) -> windows_core::NTSTATUS);
...
#[inline]
pub unsafe fn ZwOpenTimer(timerhandle: super::PHANDLE, desiredaccess: super::ACCESS_MASK, objectattributes: super::POBJECT_ATTRIBUTES) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "C" fn ZwOpenTimer(timerhandle : super::PHANDLE, desiredaccess : super::ACCESS_MASK, objectattributes : super::POBJECT_ATTRIBUTES) -> windows_core::NTSTATUS);
    unsafe { ZwOpenTimer(timerhandle as _, desiredaccess, objectattributes) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ZwPowerInformation(informationlevel: super::POWER_INFORMATION_LEVEL, inputbuffer: Option<*const core::ffi::c_void>, inputbufferlength: u32, outputbuffer: Option<*mut core::ffi::c_void>, outputbufferlength: u32) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn ZwPowerInformation(informationlevel : super::POWER_INFORMATION_LEVEL, inputbuffer : *const core::ffi::c_void, inputbufferlength : u32, outputbuffer : *mut core::ffi::c_void, outputbufferlength : u32) -> windows_core::NTSTATUS);
...
#[inline]
pub unsafe fn ZwQueryVolumeInformationFile(filehandle: super::HANDLE, iostatusblock: super::PIO_STATUS_BLOCK, fsinformation: *mut core::ffi::c_void, length: u32, fsinformationclass: super::FS_INFORMATION_CLASS) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn ZwQueryVolumeInformationFile(filehandle : super::HANDLE, iostatusblock : super::PIO_STATUS_BLOCK, fsinformation : *mut core::ffi::c_void, length : u32, fsinformationclass : super::FS_INFORMATION_CLASS) -> windows_core::NTSTATUS);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ZwSetTimer(timerhandle: super::HANDLE, duetime: super::PLARGE_INTEGER, timerapcroutine: PTIMER_APC_ROUTINE, timercontext: Option<*const core::ffi::c_void>, resumetimer: super::BOOLEAN, period: Option<i32>, previousstate: Option<super::PBOOLEAN>) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "C" fn ZwSetTimer(timerhandle : super::HANDLE, duetime : super::PLARGE_INTEGER, timerapcroutine : PTIMER_APC_ROUTINE, timercontext : *const core::ffi::c_void, resumetimer : super::BOOLEAN, period : i32, previousstate : super::PBOOLEAN) -> windows_core::NTSTATUS);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ZwSetTimerEx(timerhandle: super::HANDLE, timersetinformationclass: TIMER_SET_INFORMATION_CLASS, timersetinformation: Option<*mut core::ffi::c_void>, timersetinformationlength: u32) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "C" fn ZwSetTimerEx(timerhandle : super::HANDLE, timersetinformationclass : TIMER_SET_INFORMATION_CLASS, timersetinformation : *mut core::ffi::c_void, timersetinformationlength : u32) -> windows_core::NTSTATUS);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ZwTerminateProcess(processhandle: Option<super::HANDLE>, exitstatus: windows_core::NTSTATUS) -> windows_core::NTSTATUS {
    windows_core::link!("ntdll.dll" "system" fn ZwTerminateProcess(processhandle : super::HANDLE, exitstatus : windows_core::NTSTATUS) -> windows_core::NTSTATUS);
...
#[cfg(feature = "winnt")]
pub type HVL_WHEA_ERROR_NOTIFICATION = Option<unsafe extern "C" fn(recoverycontext: PWHEA_RECOVERY_CONTEXT, poisoned: super::BOOLEAN) -> windows_core::NTSTATUS>;
...
#[cfg(all(feature = "basetsd", feature = "lsalookup", feature = "minwindef", feature = "ntdef", feature = "ntifs", feature = "ntsecapi", feature = "usb", feature = "wdm", feature = "winnt", feature = "winternl"))]
pub type PARBITER_HANDLER = Option<unsafe extern "C" fn(context: *mut core::ffi::c_void, action: ARBITER_ACTION, parameters: PARBITER_PARAMETERS) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "basetsd", feature = "lsalookup", feature = "minwindef", feature = "ntdef", feature = "ntifs", feature = "ntsecapi", feature = "usb", feature = "wdm", feature = "winnt", feature = "winternl"))]
...
pub type PCI_GET_LINK_INFORMATION = Option<unsafe extern "C" fn(context: *mut core::ffi::c_void, linkinformation: PPCI_LINK_INFORMATION) -> windows_core::NTSTATUS>;
...
#[cfg(feature = "winnt")]
pub type PCI_SET_MAX_LINK_BANDWIDTH = Option<unsafe extern "C" fn(context: *mut core::ffi::c_void, targetbandwidth: u32, waitforretrain: super::BOOLEAN, linkthrottled: super::PBOOLEAN, newlinkspeed: PPCI_LINK_SPEED) -> windows_core::NTSTATUS>;
#[repr(C)]
#[cfg(feature = "wdm")]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub type PFNFTH = Option<unsafe extern "C" fn(systemfirmwaretableinfo: PSYSTEM_FIRMWARE_TABLE_INFORMATION) -> windows_core::NTSTATUS>;
...
pub type PFN_WHEA_HIGH_IRQL_LOG_SEL_EVENT_HANDLER = Option<unsafe extern "C" fn(context: *const core::ffi::c_void, osselrecord: PIPMI_OS_SEL_RECORD) -> windows_core::NTSTATUS>;
#[cfg(feature = "winnt")]
pub type PGET_LOCATION_STRING = Option<unsafe extern "C" fn(context: *mut core::ffi::c_void, locationstrings: *mut super::PZZWSTR) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type PHALIOREADWRITEHANDLER = Option<unsafe extern "C" fn(fread: super::BOOLEAN, dwaddr: u32, dwsize: u32, pdwdata: super::PULONG) -> windows_core::NTSTATUS>;
pub type PHALMCAINTERFACELOCK = Option<unsafe extern "C" fn()>;
pub type PHALMCAINTERFACEREADREGISTER = Option<unsafe extern "C" fn(banknumber: u8, exception: *mut core::ffi::c_void) -> windows_core::NTSTATUS>;
...
#[cfg(feature = "usb")]
pub type PMM_ROTATE_COPY_CALLBACK_FUNCTION = Option<unsafe extern "C" fn(destinationmdl: super::PMDL, sourcemdl: super::PMDL, context: *const core::ffi::c_void) -> windows_core::NTSTATUS>;
...
#[cfg(feature = "winnt")]
pub type PSHED_PI_ATTEMPT_ERROR_RECOVERY = Option<unsafe extern "C" fn(plugincontext: *mut core::ffi::c_void, bufferlength: u32, errorrecord: PWHEA_ERROR_RECORD) -> windows_core::NTSTATUS>;
pub type PSHED_PI_CLEAR_ERROR_RECORD = Option<unsafe extern "C" fn(plugincontext: *mut core::ffi::c_void, flags: u32, errorrecordid: u64) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type PSHED_PI_CLEAR_ERROR_STATUS = Option<unsafe extern "C" fn(plugincontext: *mut core::ffi::c_void, errorsource: PWHEA_ERROR_SOURCE_DESCRIPTOR, bufferlength: u32, errorrecord: PWHEA_ERROR_RECORD) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type PSHED_PI_DISABLE_ERROR_SOURCE = Option<unsafe extern "C" fn(plugincontext: *mut core::ffi::c_void, errorsource: PWHEA_ERROR_SOURCE_DESCRIPTOR) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type PSHED_PI_ENABLE_ERROR_SOURCE = Option<unsafe extern "C" fn(plugincontext: *mut core::ffi::c_void, errorsource: PWHEA_ERROR_SOURCE_DESCRIPTOR) -> windows_core::NTSTATUS>;
pub type PSHED_PI_ERR_READING_PCIE_OVERRIDES = i32;
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type PSHED_PI_FINALIZE_ERROR_RECORD = Option<unsafe extern "C" fn(plugincontext: *mut core::ffi::c_void, errorsource: PWHEA_ERROR_SOURCE_DESCRIPTOR, bufferlength: u32, errorrecord: PWHEA_ERROR_RECORD) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type PSHED_PI_GET_ALL_ERROR_SOURCES = Option<unsafe extern "C" fn(plugincontext: *mut core::ffi::c_void, count: super::PULONG, errorsrcs: *mut PWHEA_ERROR_SOURCE_DESCRIPTOR, length: super::PULONG) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type PSHED_PI_GET_ERROR_SOURCE_INFO = Option<unsafe extern "C" fn(plugincontext: *mut core::ffi::c_void, errorsource: PWHEA_ERROR_SOURCE_DESCRIPTOR) -> windows_core::NTSTATUS>;
pub type PSHED_PI_GET_INJECTION_CAPABILITIES = Option<unsafe extern "C" fn(plugincontext: *mut core::ffi::c_void, capabilities: PWHEA_ERROR_INJECTION_CAPABILITIES) -> windows_core::NTSTATUS>;
pub type PSHED_PI_INJECT_ERROR = Option<unsafe extern "C" fn(plugincontext: *mut core::ffi::c_void, errortype: u64, parameter1: u64, parameter2: u64, parameter3: u64, parameter4: u64) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type PSHED_PI_READ_ERROR_RECORD = Option<unsafe extern "C" fn(plugincontext: *mut core::ffi::c_void, flags: u32, errorrecordid: u64, nexterrorrecordid: super::PULONGLONG, recordlength: super::PULONG, errorrecord: PWHEA_ERROR_RECORD) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type PSHED_PI_RETRIEVE_ERROR_INFO = Option<unsafe extern "C" fn(plugincontext: *mut core::ffi::c_void, errorsource: PWHEA_ERROR_SOURCE_DESCRIPTOR, bufferlength: u64, packet: PWHEA_ERROR_PACKET) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type PSHED_PI_SET_ERROR_SOURCE_INFO = Option<unsafe extern "C" fn(plugincontext: *mut core::ffi::c_void, errorsource: PWHEA_ERROR_SOURCE_DESCRIPTOR) -> windows_core::NTSTATUS>;
#[cfg(feature = "basetsd")]
pub type PSHED_PI_VENDOR_DEFINED = Option<unsafe extern "C" fn(vendordefinedaction: PSHED_PI_VENDOR_DEFINED_ACTION, offset: u32, inputlength: u32, inputbuffer: super::PUINT8, outputlength: super::PUINT32, outputbuffer: super::PUINT8) -> windows_core::NTSTATUS>;
pub type PSHED_PI_VENDOR_DEFINED_ACTION = i32;
#[cfg(feature = "winnt")]
pub type PSHED_PI_WRITE_ERROR_RECORD = Option<unsafe extern "C" fn(plugincontext: *mut core::ffi::c_void, flags: u32, recordlength: u32, errorrecord: PWHEA_ERROR_RECORD) -> windows_core::NTSTATUS>;
#[repr(C, packed(1))]
#[derive(Clone, Copy, Default)]
...
#[cfg(all(feature = "basetsd", feature = "lsalookup", feature = "ntdef", feature = "ntifs", feature = "ntsecapi", feature = "usb", feature = "wdm", feature = "winnt", feature = "winternl"))]
pub type PTRANSLATE_RESOURCE_HANDLER = Option<unsafe extern "C" fn(context: *mut core::ffi::c_void, source: super::PCM_PARTIAL_RESOURCE_DESCRIPTOR, direction: RESOURCE_TRANSLATION_DIRECTION, alternativescount: u32, alternatives: *const super::IO_RESOURCE_DESCRIPTOR, physicaldeviceobject: super::PDEVICE_OBJECT, target: super::PCM_PARTIAL_RESOURCE_DESCRIPTOR) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "basetsd", feature = "lsalookup", feature = "minwindef", feature = "ntdef", feature = "ntifs", feature = "ntsecapi", feature = "usb", feature = "wdm", feature = "winnt", feature = "winternl"))]
pub type PTRANSLATE_RESOURCE_REQUIREMENTS_HANDLER = Option<unsafe extern "C" fn(context: *mut core::ffi::c_void, source: super::PIO_RESOURCE_DESCRIPTOR, physicaldeviceobject: super::PDEVICE_OBJECT, targetcount: super::PULONG, target: *mut super::PIO_RESOURCE_DESCRIPTOR) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "basetsd", feature = "lsalookup", feature = "minwindef", feature = "ntdef", feature = "ntifs", feature = "ntsecapi", feature = "usb", feature = "wdm", feature = "winnt", feature = "winternl"))]
...
pub type SILO_MONITOR_CREATE_CALLBACK = Option<unsafe extern "system" fn(silo: PESILO) -> windows_core::NTSTATUS>;
#[repr(C)]
#[cfg(all(feature = "lsalookup", feature = "ntsecapi", feature = "winnt"))]
#[derive(Clone, Copy)]
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type _WHEA_ERROR_SOURCE_CORRECT = Option<unsafe extern "C" fn(errorsource: PWHEA_ERROR_SOURCE_DESCRIPTOR, maximumsectionlength: super::PULONG) -> windows_core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type _WHEA_ERROR_SOURCE_CORRECT_DEVICE_DRIVER = Option<unsafe extern "C" fn(errorsourcedesc: *mut core::ffi::c_void, maximumsectionlength: super::PULONG) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type _WHEA_ERROR_SOURCE_CREATE_RECORD = Option<unsafe extern "C" fn(errorsource: PWHEA_ERROR_SOURCE_DESCRIPTOR, errorpacket: PWHEA_ERROR_PACKET, errorrecord: PWHEA_ERROR_RECORD, buffersize: u32, context: *mut core::ffi::c_void) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "winnt"))]
pub type _WHEA_ERROR_SOURCE_INITIALIZE = Option<unsafe extern "C" fn(phase: u32, errorsource: PWHEA_ERROR_SOURCE_DESCRIPTOR, context: *mut core::ffi::c_void) -> windows_core::NTSTATUS>;
pub type _WHEA_ERROR_SOURCE_INITIALIZE_DEVICE_DRIVER = Option<unsafe extern "C" fn(context: *mut core::ffi::c_void, errorsourceid: u32) -> windows_core::NTSTATUS>;
pub type _WHEA_ERROR_SOURCE_RECOVER = Option<unsafe extern "C" fn(recoverycontext: *mut core::ffi::c_void, severity: PWHEA_ERROR_SEVERITY) -> windows_core::NTSTATUS>;
...
pub type pHalEndMirroring = Option<unsafe extern "C" fn(passnumber: u32) -> windows_core::NTSTATUS>;
...
pub type pHalFfaMsgSendDirectReq2 = Option<unsafe extern "C" fn(parameters: *mut _FFA_MSG_SEND_DIRECT_REQ2_PARAMETERS) -> windows_core::NTSTATUS>;
pub type pHalFfaRegisterNotification = Option<unsafe extern "C" fn(registrationparameters: *const _FFA_NOTIFICATION_REGISTRATION_PARAMETERS, token: *mut *mut core::ffi::c_void) -> windows_core::NTSTATUS>;
pub type pHalFfaRunTarget = Option<unsafe extern "C" fn(inputparameters: *const _FFA_RUN_TARGET_INPUT_PARAMETERS, outputparameters: *mut _FFA_RUN_TARGET_OUTPUT_PARAMETERS) -> windows_core::NTSTATUS>;
pub type pHalFfaUnregisterNotification = Option<unsafe extern "C" fn(token: *const core::ffi::c_void) -> windows_core::NTSTATUS>;
...
pub type pHalGetAcpiTable = Option<unsafe extern "C" fn(signature: u32, oemid: windows_core::PCSTR, oemtableid: windows_core::PCSTR) -> *mut core::ffi::c_void>;
#[cfg(all(feature = "basetsd", feature = "lsalookup", feature = "minwindef", feature = "ntdef", feature = "ntifs", feature = "ntsecapi", feature = "usb", feature = "wdm", feature = "winnt", feature = "winternl"))]
...
#[cfg(all(feature = "basetsd", feature = "lsalookup", feature = "minwindef", feature = "ntdef", feature = "ntifs", feature = "ntsecapi", feature = "usb", feature = "wdm", feature = "winnt", feature = "winternl"))]
pub type pHalGetInterruptTranslator = Option<unsafe extern "C" fn(parentinterfacetype: super::INTERFACE_TYPE, parentbusnumber: u32, bridgeinterfacetype: super::INTERFACE_TYPE, size: u16, version: u16, translator: PTRANSLATOR_INTERFACE, bridgebusnumber: super::PULONG) -> windows_core::NTSTATUS>;
#[cfg(feature = "winnt")]
...
pub type pHalInitPnpDriver = Option<unsafe extern "C" fn() -> windows_core::NTSTATUS>;
pub type pHalInitPowerManagement = Option<unsafe extern "C" fn(pmdriverdispatchtable: PPM_DISPATCH_TABLE, pmhaldispatchtable: *mut PPM_DISPATCH_TABLE) -> windows_core::NTSTATUS>;
#[cfg(feature = "guiddef")]
pub type pHalInvokePrmFwHandler = Option<unsafe extern "C" fn(handlerguid: super::LPGUID, parameterbuffer: *const core::ffi::c_void, contextbuffer: *const core::ffi::c_void) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "basetsd", feature = "lsalookup", feature = "ntdef", feature = "ntifs", feature = "ntsecapi", feature = "usb", feature = "wdm", feature = "winnt", feature = "winternl"))]
pub type pHalIoReadPartitionTable = Option<unsafe extern "C" fn(deviceobject: super::PDEVICE_OBJECT, sectorsize: u32, returnrecognizedpartitions: super::BOOLEAN, partitionbuffer: *mut *mut super::_DRIVE_LAYOUT_INFORMATION) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "basetsd", feature = "lsalookup", feature = "ntdef", feature = "ntifs", feature = "ntsecapi", feature = "usb", feature = "wdm", feature = "winnt", feature = "winternl"))]
pub type pHalIoSetPartitionInformation = Option<unsafe extern "C" fn(deviceobject: super::PDEVICE_OBJECT, sectorsize: u32, partitionnumber: u32, partitiontype: u32) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "basetsd", feature = "lsalookup", feature = "ntdef", feature = "ntifs", feature = "ntsecapi", feature = "usb", feature = "wdm", feature = "winnt", feature = "winternl"))]
pub type pHalIoWritePartitionTable = Option<unsafe extern "C" fn(deviceobject: super::PDEVICE_OBJECT, sectorsize: u32, sectorspertrack: u32, numberofheads: u32, partitionbuffer: *const super::_DRIVE_LAYOUT_INFORMATION) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "usb", feature = "winnt"))]
pub type pHalMirrorPhysicalMemory = Option<unsafe extern "C" fn(physicaladdress: super::PHYSICAL_ADDRESS, numberofbytes: super::LARGE_INTEGER) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "usb", feature = "winnt"))]
pub type pHalMirrorVerify = Option<unsafe extern "C" fn(physicaladdress: super::PHYSICAL_ADDRESS, numberofbytes: super::LARGE_INTEGER) -> windows_core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type pHalQueryBusSlots = Option<unsafe extern "C" fn(bushandler: PBUS_HANDLER, buffersize: u32, slotnumbers: super::PULONG, returnedlength: super::PULONG) -> windows_core::NTSTATUS>;
#[cfg(feature = "minwindef")]
pub type pHalQuerySystemInformation = Option<unsafe extern "C" fn(informationclass: HAL_QUERY_INFORMATION_CLASS, buffersize: u32, buffer: *mut core::ffi::c_void, returnedlength: super::PULONG) -> windows_core::NTSTATUS>;
...
pub type pHalSetSystemInformation = Option<unsafe extern "C" fn(informationclass: HAL_SET_INFORMATION_CLASS, buffersize: u32, buffer: *const core::ffi::c_void) -> windows_core::NTSTATUS>;
pub type pHalStartMirroring = Option<unsafe extern "C" fn() -> windows_core::NTSTATUS>;
...
#[cfg(all(feature = "minwindef", feature = "usb", feature = "winnt"))]
pub type pKdEnumerateDebuggingDevices = Option<unsafe extern "C" fn(loaderblock: *const core::ffi::c_void, device: PDEBUG_DEVICE_DESCRIPTOR, callback: PDEBUG_DEVICE_FOUND_FUNCTION) -> windows_core::NTSTATUS>;
...
#[cfg(all(feature = "minwindef", feature = "usb", feature = "winnt"))]
pub type pKdReleaseIntegratedDeviceForDebugging = Option<unsafe extern "C" fn(integrateddevice: PDEBUG_DEVICE_DESCRIPTOR) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "usb", feature = "winnt"))]
pub type pKdReleasePciDeviceForDebugging = Option<unsafe extern "C" fn(pcidevice: PDEBUG_DEVICE_DESCRIPTOR) -> windows_core::NTSTATUS>;
...
#[cfg(all(feature = "minwindef", feature = "usb", feature = "winnt"))]
pub type pKdSetupIntegratedDeviceForDebugging = Option<unsafe extern "C" fn(loaderblock: *const core::ffi::c_void, integrateddevice: PDEBUG_DEVICE_DESCRIPTOR) -> windows_core::NTSTATUS>;
#[cfg(all(feature = "minwindef", feature = "usb", feature = "winnt"))]
pub type pKdSetupPciDeviceForDebugging = Option<unsafe extern "C" fn(loaderblock: *const core::ffi::c_void, pcidevice: PDEBUG_DEVICE_DESCRIPTOR) -> windows_core::NTSTATUS>;
#[cfg(feature = "winnt")]
