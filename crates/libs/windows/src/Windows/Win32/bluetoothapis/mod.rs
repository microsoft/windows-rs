...
#[inline]
pub unsafe fn BluetoothAuthenticateDevice(hwndparent: Option<super::HWND>, hradio: Option<super::HANDLE>, pbtbi: *mut BLUETOOTH_DEVICE_INFO_STRUCT, pszpasskey: Option<&[u16]>) -> u32 {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothAuthenticateDevice(hwndparent : super::HWND, hradio : super::HANDLE, pbtbi : *mut BLUETOOTH_DEVICE_INFO_STRUCT, pszpasskey : windows_core::PCWSTR, ulpasskeylength : u32) -> u32);
...
#[cfg(all(feature = "bthdef", feature = "minwinbase", feature = "windef", feature = "winnt"))]
#[inline]
pub unsafe fn BluetoothAuthenticateDeviceEx(hwndparentin: Option<super::HWND>, hradioin: Option<super::HANDLE>, pbtdiinout: *mut BLUETOOTH_DEVICE_INFO_STRUCT, pbtoobdata: Option<PBLUETOOTH_OOB_DATA_INFO>, authenticationrequirement: super::AUTHENTICATION_REQUIREMENTS) -> u32 {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothAuthenticateDeviceEx(hwndparentin : super::HWND, hradioin : super::HANDLE, pbtdiinout : *mut BLUETOOTH_DEVICE_INFO_STRUCT, pbtoobdata : PBLUETOOTH_OOB_DATA_INFO, authenticationrequirement : super::AUTHENTICATION_REQUIREMENTS) -> u32);
...
#[cfg(all(feature = "bthdef", feature = "minwinbase", feature = "windef", feature = "winnt"))]
#[inline]
pub unsafe fn BluetoothAuthenticateMultipleDevices(hwndparent: Option<super::HWND>, hradio: Option<super::HANDLE>, rgbtdi: &mut [BLUETOOTH_DEVICE_INFO_STRUCT]) -> u32 {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothAuthenticateMultipleDevices(hwndparent : super::HWND, hradio : super::HANDLE, cdevices : u32, rgbtdi : *mut BLUETOOTH_DEVICE_INFO_STRUCT) -> u32);
...
#[inline]
pub unsafe fn BluetoothDisplayDeviceProperties(hwndparent: Option<super::HWND>, pbtdi: *mut BLUETOOTH_DEVICE_INFO_STRUCT) -> windows_core::BOOL {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothDisplayDeviceProperties(hwndparent : super::HWND, pbtdi : *mut BLUETOOTH_DEVICE_INFO_STRUCT) -> windows_core::BOOL);
    unsafe { BluetoothDisplayDeviceProperties(hwndparent.unwrap_or(core::mem::zeroed()) as _, pbtdi as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn BluetoothEnableDiscovery(hradio: Option<super::HANDLE>, fenabled: bool) -> windows_core::BOOL {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothEnableDiscovery(hradio : super::HANDLE, fenabled : windows_core::BOOL) -> windows_core::BOOL);
    unsafe { BluetoothEnableDiscovery(hradio.unwrap_or(core::mem::zeroed()) as _, fenabled.into()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn BluetoothEnableIncomingConnections(hradio: Option<super::HANDLE>, fenabled: bool) -> windows_core::BOOL {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothEnableIncomingConnections(hradio : super::HANDLE, fenabled : windows_core::BOOL) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn BluetoothEnumerateInstalledServices(hradio: Option<super::HANDLE>, pbtdi: *const BLUETOOTH_DEVICE_INFO_STRUCT, pcserviceinout: *mut u32, pguidservices: Option<*mut windows_core::GUID>) -> u32 {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothEnumerateInstalledServices(hradio : super::HANDLE, pbtdi : *const BLUETOOTH_DEVICE_INFO_STRUCT, pcserviceinout : *mut u32, pguidservices : *mut windows_core::GUID) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn BluetoothFindFirstRadio(pbtfrp: *const BLUETOOTH_FIND_RADIO_PARAMS, phradio: *mut super::HANDLE) -> HBLUETOOTH_RADIO_FIND {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothFindFirstRadio(pbtfrp : *const BLUETOOTH_FIND_RADIO_PARAMS, phradio : *mut super::HANDLE) -> HBLUETOOTH_RADIO_FIND);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn BluetoothFindNextRadio(hfind: HBLUETOOTH_RADIO_FIND, phradio: *mut super::HANDLE) -> windows_core::BOOL {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothFindNextRadio(hfind : HBLUETOOTH_RADIO_FIND, phradio : *mut super::HANDLE) -> windows_core::BOOL);
...
#[cfg(all(feature = "bthdef", feature = "minwinbase", feature = "winnt"))]
#[inline]
pub unsafe fn BluetoothGetDeviceInfo(hradio: Option<super::HANDLE>, pbtdi: *mut BLUETOOTH_DEVICE_INFO_STRUCT) -> u32 {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothGetDeviceInfo(hradio : super::HANDLE, pbtdi : *mut BLUETOOTH_DEVICE_INFO_STRUCT) -> u32);
    unsafe { BluetoothGetDeviceInfo(hradio.unwrap_or(core::mem::zeroed()) as _, pbtdi as _) }
}
#[cfg(all(feature = "bthdef", feature = "winnt"))]
#[inline]
pub unsafe fn BluetoothGetRadioInfo(hradio: super::HANDLE, pradioinfo: PBLUETOOTH_RADIO_INFO) -> u32 {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothGetRadioInfo(hradio : super::HANDLE, pradioinfo : PBLUETOOTH_RADIO_INFO) -> u32);
    unsafe { BluetoothGetRadioInfo(hradio, pradioinfo as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn BluetoothIsConnectable(hradio: Option<super::HANDLE>) -> windows_core::BOOL {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothIsConnectable(hradio : super::HANDLE) -> windows_core::BOOL);
    unsafe { BluetoothIsConnectable(hradio.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn BluetoothIsDiscoverable(hradio: Option<super::HANDLE>) -> windows_core::BOOL {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothIsDiscoverable(hradio : super::HANDLE) -> windows_core::BOOL);
...
pub unsafe fn BluetoothSdpEnumAttributes(psdpstream: &[u8], pfncallback: PFN_BLUETOOTH_ENUM_ATTRIBUTES_CALLBACK, pvparam: *const core::ffi::c_void) -> windows_core::BOOL {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothSdpEnumAttributes(psdpstream : super::LPBYTE, cbstreamsize : u32, pfncallback : PFN_BLUETOOTH_ENUM_ATTRIBUTES_CALLBACK, pvparam : *const core::ffi::c_void) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn BluetoothSdpGetAttributeValue(precordstream: &[u8], usattributeid: u16, pattributedata: PSDP_ELEMENT_DATA) -> u32 {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothSdpGetAttributeValue(precordstream : super::LPBYTE, cbrecordlength : u32, usattributeid : u16, pattributedata : PSDP_ELEMENT_DATA) -> u32);
...
#[inline]
pub unsafe fn BluetoothSdpGetContainerElementData(pcontainerstream: &[u8], pelement: *mut HBLUETOOTH_CONTAINER_ELEMENT, pdata: PSDP_ELEMENT_DATA) -> u32 {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothSdpGetContainerElementData(pcontainerstream : super::LPBYTE, cbcontainerlength : u32, pelement : *mut HBLUETOOTH_CONTAINER_ELEMENT, pdata : PSDP_ELEMENT_DATA) -> u32);
...
#[cfg(all(feature = "bthsdpdef", feature = "minwindef"))]
#[inline]
pub unsafe fn BluetoothSdpGetElementData(psdpstream: &[u8], pdata: PSDP_ELEMENT_DATA) -> u32 {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothSdpGetElementData(psdpstream : super::LPBYTE, cbsdpstreamlength : u32, pdata : PSDP_ELEMENT_DATA) -> u32);
    unsafe { BluetoothSdpGetElementData(core::mem::transmute(psdpstream.as_ptr()), psdpstream.len().try_into().unwrap(), pdata as _) }
}
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn BluetoothSdpGetString(precordstream: &[u8], pstringdata: Option<PSDP_STRING_TYPE_DATA>, usstringoffset: u16, pszstring: windows_core::PWSTR, pcchstringlength: super::PULONG) -> u32 {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothSdpGetString(precordstream : super::LPBYTE, cbrecordlength : u32, pstringdata : PSDP_STRING_TYPE_DATA, usstringoffset : u16, pszstring : windows_core::PWSTR, pcchstringlength : super::PULONG) -> u32);
    unsafe { BluetoothSdpGetString(core::mem::transmute(precordstream.as_ptr()), precordstream.len().try_into().unwrap(), pstringdata.unwrap_or(core::mem::zeroed()) as _, usstringoffset, pszstring, pcchstringlength as _) }
}
#[cfg(all(feature = "bthdef", feature = "minwinbase", feature = "windef"))]
#[inline]
...
#[cfg(all(feature = "bthdef", feature = "minwinbase", feature = "winnt"))]
#[inline]
pub unsafe fn BluetoothSendAuthenticationResponse<P2>(hradio: Option<super::HANDLE>, pbtdi: *const BLUETOOTH_DEVICE_INFO_STRUCT, pszpasskey: P2) -> u32
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("bthprops.cpl" "system" fn BluetoothSendAuthenticationResponse(hradio : super::HANDLE, pbtdi : *const BLUETOOTH_DEVICE_INFO_STRUCT, pszpasskey : windows_core::PCWSTR) -> u32);
    unsafe { BluetoothSendAuthenticationResponse(hradio.unwrap_or(core::mem::zeroed()) as _, pbtdi, pszpasskey.param().abi()) }
}
#[cfg(all(feature = "bthdef", feature = "winnt"))]
#[inline]
pub unsafe fn BluetoothSendAuthenticationResponseEx(hradioin: Option<super::HANDLE>, pauthresponse: PBLUETOOTH_AUTHENTICATE_RESPONSE) -> u32 {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothSendAuthenticationResponseEx(hradioin : super::HANDLE, pauthresponse : PBLUETOOTH_AUTHENTICATE_RESPONSE) -> u32);
    unsafe { BluetoothSendAuthenticationResponseEx(hradioin.unwrap_or(core::mem::zeroed()) as _, pauthresponse) }
}
#[cfg(all(feature = "bthdef", feature = "winnt"))]
#[inline]
pub unsafe fn BluetoothSetLocalServiceInfo(hradioin: Option<super::HANDLE>, pclassguid: *const windows_core::GUID, ulinstance: u32, pserviceinfoin: *const BLUETOOTH_LOCAL_SERVICE_INFO_STRUCT) -> u32 {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothSetLocalServiceInfo(hradioin : super::HANDLE, pclassguid : *const windows_core::GUID, ulinstance : u32, pserviceinfoin : *const BLUETOOTH_LOCAL_SERVICE_INFO_STRUCT) -> u32);
    unsafe { BluetoothSetLocalServiceInfo(hradioin.unwrap_or(core::mem::zeroed()) as _, pclassguid, ulinstance, pserviceinfoin) }
}
#[cfg(all(feature = "bthdef", feature = "minwinbase", feature = "winnt"))]
#[inline]
pub unsafe fn BluetoothSetServiceState(hradio: Option<super::HANDLE>, pbtdi: *const BLUETOOTH_DEVICE_INFO_STRUCT, pguidservice: *const windows_core::GUID, dwserviceflags: u32) -> u32 {
    windows_core::link!("bthprops.cpl" "system" fn BluetoothSetServiceState(hradio : super::HANDLE, pbtdi : *const BLUETOOTH_DEVICE_INFO_STRUCT, pguidservice : *const windows_core::GUID, dwserviceflags : u32) -> u32);
...
pub struct BLUETOOTH_DEVICE_INFO_STRUCT {
    ...
    pub stLastSeen: super::SYSTEMTIME,
    pub stLastUsed: super::SYSTEMTIME,
    pub szName: [u16; 248],
}
#[cfg(all(feature = "bthdef", feature = "minwinbase"))]
...
#[cfg(feature = "winnt")]
pub type HBLUETOOTH_CONTAINER_ELEMENT = super::HANDLE;
#[cfg(feature = "winnt")]
pub type HBLUETOOTH_DEVICE_FIND = super::HANDLE;
#[cfg(feature = "winnt")]
pub type HBLUETOOTH_RADIO_FIND = super::HANDLE;
#[cfg(feature = "bthdef")]
...
#[cfg(all(feature = "bthdef", feature = "minwinbase"))]
pub type PFN_AUTHENTICATION_CALLBACK = Option<unsafe extern "system" fn(pvparam: *mut core::ffi::c_void, pdevice: PBLUETOOTH_DEVICE_INFO) -> windows_core::BOOL>;
#[cfg(all(feature = "bthdef", feature = "minwinbase"))]
pub type PFN_AUTHENTICATION_CALLBACK_EX = Option<unsafe extern "system" fn(pvparam: *const core::ffi::c_void, pauthcallbackparams: PBLUETOOTH_AUTHENTICATION_CALLBACK_PARAMS) -> windows_core::BOOL>;
#[cfg(feature = "minwindef")]
pub type PFN_BLUETOOTH_ENUM_ATTRIBUTES_CALLBACK = Option<unsafe extern "system" fn(uattribid: u32, pvaluestream: super::LPBYTE, cbstreamsize: u32, pvparam: *const core::ffi::c_void) -> windows_core::BOOL>;
#[cfg(all(feature = "bthdef", feature = "minwinbase"))]
...
pub struct SDP_ELEMENT_DATA {
    pub r#type: super::SDP_TYPE,
    pub specificType: super::SDP_SPECIFICTYPE,
...
pub union SDP_ELEMENT_DATA_0 {
    pub int128: super::SDP_LARGE_INTEGER_16,
    pub int64: i64,
    pub int32: i32,
    pub int16: i16,
    pub int8: i8,
    pub uint128: super::SDP_ULARGE_INTEGER_16,
    pub uint64: u64,
    pub uint32: u32,
    pub uint16: u16,
    pub uint8: u8,
