...
pub struct CATEGORYINFO {
    pub catid: CATID,
    pub lcid: super::LCID,
    pub szDescription: [super::OLECHAR; 128],
}
#[cfg(all(feature = "winnt", feature = "wtypesbase"))]
...
impl ICatInformation {
    #[cfg(feature = "winnt")]
    pub unsafe fn EnumCategories(&self, lcid: super::LCID) -> windows_core::Result<IEnumCATEGORYINFO> {
        unsafe {
    ...
    #[cfg(feature = "winnt")]
    pub unsafe fn GetCategoryDesc(&self, rcatid: REFCATID, lcid: super::LCID) -> windows_core::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumClassesOfCategories(&self, cimplemented: u32, rgcatidimpl: *const CATID, crequired: u32, rgcatidreq: *const CATID) -> windows_core::Result<IEnumGUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnumClassesOfCategories)(windows_core::Interface::as_raw(self), cimplemented, rgcatidimpl, crequired, rgcatidreq, &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
...
pub struct ICatInformation_Vtbl {
    ...
    #[cfg(feature = "winnt")]
    pub EnumCategories: unsafe extern "system" fn(*mut core::ffi::c_void, super::LCID, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "winnt"))]
    EnumCategories: usize,
    #[cfg(feature = "winnt")]
    pub GetCategoryDesc: unsafe extern "system" fn(*mut core::ffi::c_void, REFCATID, super::LCID, *mut windows_core::PWSTR) -> windows_core::HRESULT,
    #[cfg(not(feature = "winnt"))]
...
pub trait ICatInformation_Impl: windows_core::IUnknownImpl {
    fn EnumCategories(&self, lcid: super::LCID) -> windows_core::Result<IEnumCATEGORYINFO>;
    fn GetCategoryDesc(&self, rcatid: REFCATID, lcid: super::LCID) -> windows_core::Result<windows_core::PWSTR>;
...
impl ICatInformation_Vtbl {
    pub const fn new<Identity: ICatInformation_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn EnumCategories<Identity: ICatInformation_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, lcid: super::LCID, ppenumcategoryinfo: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn GetCategoryDesc<Identity: ICatInformation_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, rcatid: REFCATID, lcid: super::LCID, pszdesc: *mut windows_core::PWSTR) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IEnumGUID {
    pub unsafe fn Next(&self, celt: u32, rgelt: *mut windows_core::GUID, pceltfetched: Option<*mut u32>) -> windows_core::HRESULT {
