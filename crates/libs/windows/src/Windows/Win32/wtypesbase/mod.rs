pub const APPIDREGFLAGS_AAA_NO_IMPLICIT_ACTIVATE_AS_IU: i32 = 2048;
pub const APPIDREGFLAGS_ACTIVATE_IUSERVER_INDESKTOP: i32 = 1;
pub const APPIDREGFLAGS_ISSUE_ACTIVATION_RPC_AT_IDENTIFY: i32 = 4;
pub const APPIDREGFLAGS_IUSERVER_ACTIVATE_IN_CLIENT_SESSION_ONLY: i32 = 32;
pub const APPIDREGFLAGS_IUSERVER_SELF_SID_IN_LAUNCH_PERMISSION: i32 = 16;
pub const APPIDREGFLAGS_IUSERVER_UNMODIFIED_LOGON_TOKEN: i32 = 8;
pub const APPIDREGFLAGS_RESERVED1: i32 = 64;
pub const APPIDREGFLAGS_RESERVED10: i32 = 32768;
pub const APPIDREGFLAGS_RESERVED2: i32 = 128;
pub const APPIDREGFLAGS_RESERVED3: i32 = 256;
pub const APPIDREGFLAGS_RESERVED4: i32 = 512;
pub const APPIDREGFLAGS_RESERVED5: i32 = 1024;
pub const APPIDREGFLAGS_RESERVED7: i32 = 4096;
pub const APPIDREGFLAGS_RESERVED8: i32 = 8192;
...
pub const DCOMSCM_PING_DISALLOW_UNSECURE_CALL: i32 = 32;
...
pub const ROTREGFLAGS_ALLOWANYCLIENT: i32 = 1;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Default)]
