...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("kernel32.dll" "system" fn FindResourceW(hmodule : super::minwindef::HMODULE, lpname : windows_core::PCWSTR, lptype : windows_core::PCWSTR) -> super::minwindef::HRSRC);
