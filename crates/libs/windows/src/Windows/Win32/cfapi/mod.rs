...
pub const CF_MAX_PRIORITY_HINT: i32 = 15;
pub const CF_MAX_PROVIDER_NAME_LENGTH: i32 = 255;
pub const CF_MAX_PROVIDER_VERSION_LENGTH: i32 = 255;
...
pub const CF_PLACEHOLDER_MAX_FILE_IDENTITY_LENGTH: i32 = 4096;
