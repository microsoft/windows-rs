#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AddVirtualDiskParent<P1>(virtualdiskhandle: super::HANDLE, parentpath: P1) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("virtdisk.dll" "system" fn AddVirtualDiskParent(virtualdiskhandle : super::HANDLE, parentpath : windows_core::PCWSTR) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn BreakMirrorVirtualDisk(virtualdiskhandle: super::HANDLE) -> u32 {
    windows_core::link!("virtdisk.dll" "system" fn BreakMirrorVirtualDisk(virtualdiskhandle : super::HANDLE) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn CompleteForkVirtualDisk(virtualdiskhandle: super::HANDLE) -> u32 {
    windows_core::link!("virtdisk.dll" "system" fn CompleteForkVirtualDisk(virtualdiskhandle : super::HANDLE) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn DeleteVirtualDiskMetadata(virtualdiskhandle: super::HANDLE, item: *const windows_core::GUID) -> u32 {
    windows_core::link!("virtdisk.dll" "system" fn DeleteVirtualDiskMetadata(virtualdiskhandle : super::HANDLE, item : *const windows_core::GUID) -> u32);
    unsafe { DeleteVirtualDiskMetadata(virtualdiskhandle, item) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn DetachVirtualDisk(virtualdiskhandle: super::HANDLE, flags: DETACH_VIRTUAL_DISK_FLAG, providerspecificflags: u32) -> u32 {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetVirtualDiskMetadata(virtualdiskhandle: super::HANDLE, item: *const windows_core::GUID, metadatasize: u32, metadata: *const core::ffi::c_void) -> u32 {
    windows_core::link!("virtdisk.dll" "system" fn SetVirtualDiskMetadata(virtualdiskhandle : super::HANDLE, item : *const windows_core::GUID, metadatasize : u32, metadata : *const core::ffi::c_void) -> u32);
