#[inline]
pub unsafe fn CheckGamingPrivilegeSilently(privilegeid: u32, scope: &windows_core::HSTRING, policy: &windows_core::HSTRING) -> Result<windows_core::BOOL, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn CheckGamingPrivilegeSilentlyForUser<P0>(user: P0, privilegeid: u32, scope: &windows_core::HSTRING, policy: &windows_core::HSTRING) -> Result<windows_core::BOOL, windows_result::HRESULT>
where
...
#[inline]
pub unsafe fn CheckGamingPrivilegeWithUI(privilegeid: u32, scope: &windows_core::HSTRING, policy: &windows_core::HSTRING, friendlymessage: &windows_core::HSTRING, completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn CheckGamingPrivilegeWithUIForUser<P0>(user: P0, privilegeid: u32, scope: &windows_core::HSTRING, policy: &windows_core::HSTRING, friendlymessage: &windows_core::HSTRING, completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::IInspectable>,
{
...
#[inline]
pub unsafe fn GetExpandedResourceExclusiveCpuCount() -> Result<u32, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn GetGamingDeviceModelInformation() -> Result<GAMING_DEVICE_MODEL_INFORMATION, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn HasExpandedResources() -> Result<windows_core::BOOL, windows_result::HRESULT> {
...
#[inline]
pub unsafe fn ProcessPendingGameUI(waitforcompletion: bool) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn ReleaseExclusiveCpuSets() -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn ShowChangeFriendRelationshipUI(targetuserxuid: &windows_core::HSTRING, completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn ShowChangeFriendRelationshipUIForUser<P0>(user: P0, targetuserxuid: &windows_core::HSTRING, completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::IInspectable>,
{
...
#[inline]
pub unsafe fn ShowCustomizeUserProfileUI(completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn ShowCustomizeUserProfileUIForUser<P0>(user: P0, completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::IInspectable>,
{
...
#[inline]
pub unsafe fn ShowFindFriendsUI(completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn ShowFindFriendsUIForUser<P0>(user: P0, completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::IInspectable>,
{
...
#[inline]
pub unsafe fn ShowGameInfoUI(titleid: u32, completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn ShowGameInfoUIForUser<P0>(user: P0, titleid: u32, completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::IInspectable>,
{
...
#[inline]
pub unsafe fn ShowGameInviteUI(serviceconfigurationid: &windows_core::HSTRING, sessiontemplatename: &windows_core::HSTRING, sessionid: &windows_core::HSTRING, invitationdisplaytext: &windows_core::HSTRING, completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn ShowGameInviteUIForUser<P0>(user: P0, serviceconfigurationid: &windows_core::HSTRING, sessiontemplatename: &windows_core::HSTRING, sessionid: &windows_core::HSTRING, invitationdisplaytext: &windows_core::HSTRING, completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::IInspectable>,
{
...
#[inline]
pub unsafe fn ShowPlayerPickerUI(promptdisplaytext: &windows_core::HSTRING, xuids: &[windows_core::HSTRING], preselectedxuids: Option<&[windows_core::HSTRING]>, minselectioncount: usize, maxselectioncount: usize, completionroutine: PlayerPickerUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn ShowPlayerPickerUIForUser<P0>(user: P0, promptdisplaytext: &windows_core::HSTRING, xuids: &[windows_core::HSTRING], preselectedxuids: Option<&[windows_core::HSTRING]>, minselectioncount: usize, maxselectioncount: usize, completionroutine: PlayerPickerUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::IInspectable>,
{
...
#[inline]
pub unsafe fn ShowProfileCardUI(targetuserxuid: &windows_core::HSTRING, completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn ShowProfileCardUIForUser<P0>(user: P0, targetuserxuid: &windows_core::HSTRING, completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::IInspectable>,
{
...
#[inline]
pub unsafe fn ShowTitleAchievementsUI(titleid: u32, completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn ShowTitleAchievementsUIForUser<P0>(user: P0, titleid: u32, completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::IInspectable>,
{
...
#[inline]
pub unsafe fn ShowUserSettingsUI(completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT> {
...
#[inline]
pub unsafe fn ShowUserSettingsUIForUser<P0>(user: P0, completionroutine: GameUICompletionRoutine, context: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::IInspectable>,
{
...
impl IGameExplorer {
    pub unsafe fn AddGame(&self, bstrgdfbinarypath: &windows_core::BSTR, bstrgameinstalldirectory: &windows_core::BSTR, installscope: GAME_INSTALL_SCOPE, pguidinstanceid: *mut windows_core::GUID) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn RemoveGame(&self, guidinstanceid: windows_core::GUID) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn UpdateGame(&self, guidinstanceid: windows_core::GUID) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn VerifyAccess(&self, bstrgdfbinarypath: &windows_core::BSTR) -> Result<windows_core::BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IGameExplorer_Impl: windows_core::IUnknownImpl {
    fn AddGame(&self, bstrgdfbinarypath: &windows_core::BSTR, bstrgameinstalldirectory: &windows_core::BSTR, installscope: GAME_INSTALL_SCOPE, pguidinstanceid: *mut windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn RemoveGame(&self, guidinstanceid: &windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn UpdateGame(&self, guidinstanceid: &windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn VerifyAccess(&self, bstrgdfbinarypath: &windows_core::BSTR) -> Result<windows_core::BOOL, windows_result::HRESULT>;
}
...
impl IGameExplorer2 {
    pub unsafe fn InstallGame<P0, P1>(&self, binarygdfpath: P0, installdirectory: P1, installscope: GAME_INSTALL_SCOPE) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn UninstallGame<P0>(&self, binarygdfpath: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).UninstallGame)(windows_core::Interface::as_raw(self), binarygdfpath.param().abi()).ok() }
    }
    pub unsafe fn CheckAccess<P0>(&self, binarygdfpath: P0) -> Result<windows_core::BOOL, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
...
pub trait IGameExplorer2_Impl: windows_core::IUnknownImpl {
    fn InstallGame(&self, binarygdfpath: &windows_core::PCWSTR, installdirectory: &windows_core::PCWSTR, installscope: GAME_INSTALL_SCOPE) -> Result<(), windows_result::HRESULT>;
    fn UninstallGame(&self, binarygdfpath: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn CheckAccess(&self, binarygdfpath: &windows_core::PCWSTR) -> Result<windows_core::BOOL, windows_result::HRESULT>;
}
...
impl IGameStatistics {
    ...
    pub unsafe fn GetCategoryTitle(&self, categoryindex: u16) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetStatistic(&self, categoryindex: u16, statindex: u16, pname: Option<*mut windows_core::PWSTR>, pvalue: Option<*mut windows_core::PWSTR>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetStatistic<P2, P3>(&self, categoryindex: u16, statindex: u16, name: P2, value: P3) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Save(&self, trackchanges: bool) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Save)(windows_core::Interface::as_raw(self), trackchanges.into()).ok() }
    }
    pub unsafe fn SetLastPlayedCategory(&self, categoryindex: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetLastPlayedCategory)(windows_core::Interface::as_raw(self), categoryindex).ok() }
    }
    pub unsafe fn GetLastPlayedCategory(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IGameStatistics_Impl: windows_core::IUnknownImpl {
    fn GetMaxCategoryLength(&self) -> Result<u32, windows_result::HRESULT>;
    fn GetMaxNameLength(&self) -> Result<u32, windows_result::HRESULT>;
    fn GetMaxValueLength(&self) -> Result<u32, windows_result::HRESULT>;
    fn GetMaxCategories(&self) -> Result<u16, windows_result::HRESULT>;
    fn GetMaxStatsPerCategory(&self) -> Result<u16, windows_result::HRESULT>;
    fn SetCategoryTitle(&self, categoryindex: u16, title: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetCategoryTitle(&self, categoryindex: u16) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetStatistic(&self, categoryindex: u16, statindex: u16, pname: *mut windows_core::PWSTR, pvalue: *mut windows_core::PWSTR) -> Result<(), windows_result::HRESULT>;
    fn SetStatistic(&self, categoryindex: u16, statindex: u16, name: &windows_core::PCWSTR, value: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn Save(&self, trackchanges: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SetLastPlayedCategory(&self, categoryindex: u32) -> Result<(), windows_result::HRESULT>;
    fn GetLastPlayedCategory(&self) -> Result<u32, windows_result::HRESULT>;
}
...
impl IGameStatisticsMgr {
    pub unsafe fn GetGameStatistics<P0>(&self, gdfbinarypath: P0, opentype: GAMESTATS_OPEN_TYPE, popenresult: *mut GAMESTATS_OPEN_RESULT, ppistats: *mut Option<IGameStatistics>) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn RemoveGameStatistics<P0>(&self, gdfbinarypath: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IGameStatisticsMgr_Impl: windows_core::IUnknownImpl {
    fn GetGameStatistics(&self, gdfbinarypath: &windows_core::PCWSTR, opentype: GAMESTATS_OPEN_TYPE, popenresult: *mut GAMESTATS_OPEN_RESULT, ppistats: windows_core::OutRef<'_, IGameStatistics>) -> Result<(), windows_result::HRESULT>;
    fn RemoveGameStatistics(&self, gdfbinarypath: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
...
impl IXblIdpAuthManager {
    pub unsafe fn SetGamerAccount<P0, P1>(&self, msaaccountid: P0, xuid: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetGamerAccount(&self, msaaccountid: *mut windows_core::PWSTR, xuid: *mut windows_core::PWSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetAppViewInitialized<P0, P1>(&self, appsid: P0, msaaccountid: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetEnvironment(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetEnvironment)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetSandbox(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetSandbox)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetTokenAndSignatureWithTokenResult<P0, P1, P2, P3, P4, P5, P6>(&self, msaaccountid: P0, appsid: P1, msatarget: P2, msapolicy: P3, httpmethod: P4, uri: P5, headers: P6, body: &[u8], forcerefresh: bool) -> Result<IXblIdpAuthTokenResult, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IXblIdpAuthManager_Impl: windows_core::IUnknownImpl {
    fn SetGamerAccount(&self, msaaccountid: &windows_core::PCWSTR, xuid: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetGamerAccount(&self, msaaccountid: *mut windows_core::PWSTR, xuid: *mut windows_core::PWSTR) -> Result<(), windows_result::HRESULT>;
    fn SetAppViewInitialized(&self, appsid: &windows_core::PCWSTR, msaaccountid: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetEnvironment(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetSandbox(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetTokenAndSignatureWithTokenResult(&self, msaaccountid: &windows_core::PCWSTR, appsid: &windows_core::PCWSTR, msatarget: &windows_core::PCWSTR, msapolicy: &windows_core::PCWSTR, httpmethod: &windows_core::PCWSTR, uri: &windows_core::PCWSTR, headers: &windows_core::PCWSTR, body: *const u8, bodysize: u32, forcerefresh: windows_core::BOOL) -> Result<IXblIdpAuthTokenResult, windows_result::HRESULT>;
}
...
impl IXblIdpAuthManager2 {
    pub unsafe fn GetUserlessTokenAndSignatureWithTokenResult<P0, P1, P2, P3, P4, P5>(&self, appsid: P0, msatarget: P1, msapolicy: P2, httpmethod: P3, uri: P4, headers: P5, body: &[u8], forcerefresh: bool) -> Result<IXblIdpAuthTokenResult, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
        P2: windows_core::Param<windows_core::PCWSTR>,
...
impl IXblIdpAuthTokenResult {
    pub unsafe fn GetStatus(&self) -> Result<XBL_IDP_AUTH_TOKEN_STATUS, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetStatus)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetErrorCode(&self) -> Result<windows_core::HRESULT, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetErrorCode)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetToken(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetToken)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetSignature(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IXblIdpAuthTokenResult_Impl: windows_core::IUnknownImpl {
    fn GetStatus(&self) -> Result<XBL_IDP_AUTH_TOKEN_STATUS, windows_result::HRESULT>;
    fn GetErrorCode(&self) -> Result<windows_core::HRESULT, windows_result::HRESULT>;
    fn GetToken(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetSignature(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetSandbox(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetEnvironment(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetMsaAccountId(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetXuid(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetGamertag(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetAgeGroup(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetPrivileges(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetMsaTarget(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetMsaPolicy(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetMsaAppId(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetRedirect(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetMessage(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetHelpId(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetEnforcementBans(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetRestrictions(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetTitleRestrictions(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
}
...
impl IXblIdpAuthTokenResult2 {
    pub unsafe fn GetModernGamertag(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetModernGamertag)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetModernGamertagSuffix(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetModernGamertagSuffix)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetUniqueModernGamertag(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IXblIdpAuthTokenResult2_Impl: windows_core::IUnknownImpl {
    fn GetModernGamertag(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetModernGamertagSuffix(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
    fn GetUniqueModernGamertag(&self) -> Result<windows_core::PWSTR, windows_result::HRESULT>;
}
