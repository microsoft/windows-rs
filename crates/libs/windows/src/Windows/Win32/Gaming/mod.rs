...
impl IGameExplorer_Vtbl {
    ...
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IGameExplorer_Impl,
    {
        unsafe extern "system" fn AddGame<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, bstrgdfbinarypath: *mut core::ffi::c_void, bstrgameinstalldirectory: *mut core::ffi::c_void, installscope: GAME_INSTALL_SCOPE, pguidinstanceid: *mut windows_core::GUID) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IGameExplorer_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn VerifyAccess<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, bstrgdfbinarypath: *mut core::ffi::c_void, pfhasaccess: *mut windows_core::BOOL) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IGameExplorer_Impl,
        {
            unsafe {
...
impl IGameExplorer2_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IGameExplorer2_Impl,
    {
        ...
        unsafe extern "system" fn CheckAccess<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, binarygdfpath: windows_core::PCWSTR, phasaccess: *mut windows_core::BOOL) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IGameExplorer2_Impl,
        {
            unsafe {
...
pub trait IGameStatistics_Impl {
...
impl IGameStatistics_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IGameStatistics_Impl,
    {
        ...
        unsafe extern "system" fn Save<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, trackchanges: windows_core::BOOL) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IGameStatistics_Impl,
        {
            unsafe {
...
pub trait IGameStatisticsMgr_Impl {
...
impl IGameStatisticsMgr_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IGameStatisticsMgr_Impl,
    {
...
pub trait IXblIdpAuthManager_Impl {
...
impl IXblIdpAuthManager_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IXblIdpAuthManager_Impl,
    {
        ...
        unsafe extern "system" fn GetTokenAndSignatureWithTokenResult<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, msaaccountid: windows_core::PCWSTR, appsid: windows_core::PCWSTR, msatarget: windows_core::PCWSTR, msapolicy: windows_core::PCWSTR, httpmethod: windows_core::PCWSTR, uri: windows_core::PCWSTR, headers: windows_core::PCWSTR, body: *const u8, bodysize: u32, forcerefresh: windows_core::BOOL, result: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IXblIdpAuthManager_Impl,
        {
            unsafe {
...
pub trait IXblIdpAuthManager2_Impl {
...
impl IXblIdpAuthManager2_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IXblIdpAuthManager2_Impl,
    {
        unsafe extern "system" fn GetUserlessTokenAndSignatureWithTokenResult<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, appsid: windows_core::PCWSTR, msatarget: windows_core::PCWSTR, msapolicy: windows_core::PCWSTR, httpmethod: windows_core::PCWSTR, uri: windows_core::PCWSTR, headers: windows_core::PCWSTR, body: *const u8, bodysize: u32, forcerefresh: windows_core::BOOL, result: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IXblIdpAuthManager2_Impl,
        {
            unsafe {
...
pub trait IXblIdpAuthTokenResult_Impl {
...
impl IXblIdpAuthTokenResult_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IXblIdpAuthTokenResult_Impl,
    {
...
pub trait IXblIdpAuthTokenResult2_Impl {
...
impl IXblIdpAuthTokenResult2_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IXblIdpAuthTokenResult2_Impl,
    {
