...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprAdminConnectionClearStats(hrasserver: RAS_SERVER_HANDLE, hrasconnection: super::HANDLE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprAdminConnectionClearStats(hrasserver : RAS_SERVER_HANDLE, hrasconnection : super::HANDLE) -> u32);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn MprAdminConnectionGetInfo(hrasserver: RAS_SERVER_HANDLE, dwlevel: u32, hrasconnection: super::HANDLE, lplpbbuffer: *mut super::LPBYTE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprAdminConnectionGetInfo(hrasserver : RAS_SERVER_HANDLE, dwlevel : u32, hrasconnection : super::HANDLE, lplpbbuffer : *mut super::LPBYTE) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprAdminConnectionRemoveQuarantine(hrasserver: super::HANDLE, hrasconnection: super::HANDLE, fisipaddress: bool) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprAdminConnectionRemoveQuarantine(hrasserver : super::HANDLE, hrasconnection : super::HANDLE, fisipaddress : windows_core::BOOL) -> u32);
    unsafe { MprAdminConnectionRemoveQuarantine(hrasserver, hrasconnection, fisipaddress.into()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprAdminDeregisterConnectionNotification(hmprserver: MPR_SERVER_HANDLE, heventnotification: super::HANDLE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprAdminDeregisterConnectionNotification(hmprserver : MPR_SERVER_HANDLE, heventnotification : super::HANDLE) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprAdminInterfaceConnect(hmprserver: MPR_SERVER_HANDLE, hinterface: super::HANDLE, hevent: super::HANDLE, fsynchronous: bool) -> u32 {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprAdminInterfaceDelete(hmprserver: MPR_SERVER_HANDLE, hinterface: super::HANDLE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprAdminInterfaceDelete(hmprserver : MPR_SERVER_HANDLE, hinterface : super::HANDLE) -> u32);
    unsafe { MprAdminInterfaceDelete(hmprserver, hinterface) }
}
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn MprAdminInterfaceDeviceGetInfo(hmprserver: MPR_SERVER_HANDLE, hinterface: super::HANDLE, dwindex: u32, dwlevel: u32, lplpbuffer: *mut super::LPBYTE) -> u32 {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprAdminInterfaceDisconnect(hmprserver: MPR_SERVER_HANDLE, hinterface: super::HANDLE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprAdminInterfaceDisconnect(hmprserver : MPR_SERVER_HANDLE, hinterface : super::HANDLE) -> u32);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn MprAdminInterfaceGetCredentialsEx(hmprserver: MPR_SERVER_HANDLE, hinterface: super::HANDLE, dwlevel: u32, lplpbbuffer: *mut super::LPBYTE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprAdminInterfaceGetCredentialsEx(hmprserver : MPR_SERVER_HANDLE, hinterface : super::HANDLE, dwlevel : u32, lplpbbuffer : *mut super::LPBYTE) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprAdminInterfaceGetHandle<P1>(hmprserver: MPR_SERVER_HANDLE, lpwsinterfacename: P1, phinterface: *mut super::HANDLE, fincludeclientinterfaces: bool) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("mprapi.dll" "system" fn MprAdminInterfaceGetHandle(hmprserver : MPR_SERVER_HANDLE, lpwsinterfacename : windows_core::PCWSTR, phinterface : *mut super::HANDLE, fincludeclientinterfaces : windows_core::BOOL) -> u32);
    unsafe { MprAdminInterfaceGetHandle(hmprserver, lpwsinterfacename.param().abi(), phinterface as _, fincludeclientinterfaces.into()) }
}
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn MprAdminInterfaceGetInfo(hmprserver: MPR_SERVER_HANDLE, hinterface: super::HANDLE, dwlevel: u32, lplpbbuffer: *const super::LPBYTE) -> u32 {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprAdminInterfaceTransportRemove(hmprserver: MPR_SERVER_HANDLE, hinterface: super::HANDLE, dwtransportid: u32) -> u32 {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprAdminInterfaceUpdatePhonebookInfo(hmprserver: MPR_SERVER_HANDLE, hinterface: super::HANDLE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprAdminInterfaceUpdatePhonebookInfo(hmprserver : MPR_SERVER_HANDLE, hinterface : super::HANDLE) -> u32);
    unsafe { MprAdminInterfaceUpdatePhonebookInfo(hmprserver, hinterface) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprAdminInterfaceUpdateRoutes(hmprserver: MPR_SERVER_HANDLE, hinterface: super::HANDLE, dwprotocolid: u32, hevent: super::HANDLE) -> u32 {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprAdminPortClearStats(hrasserver: RAS_SERVER_HANDLE, hport: super::HANDLE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprAdminPortClearStats(hrasserver : RAS_SERVER_HANDLE, hport : super::HANDLE) -> u32);
    unsafe { MprAdminPortClearStats(hrasserver, hport) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprAdminPortDisconnect(hrasserver: RAS_SERVER_HANDLE, hport: super::HANDLE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprAdminPortDisconnect(hrasserver : RAS_SERVER_HANDLE, hport : super::HANDLE) -> u32);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn MprAdminPortGetInfo(hrasserver: RAS_SERVER_HANDLE, dwlevel: u32, hport: super::HANDLE, lplpbbuffer: *mut super::LPBYTE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprAdminPortGetInfo(hrasserver : RAS_SERVER_HANDLE, dwlevel : u32, hport : super::HANDLE, lplpbbuffer : *mut super::LPBYTE) -> u32);
    unsafe { MprAdminPortGetInfo(hrasserver, dwlevel, hport, lplpbbuffer as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprAdminPortReset(hrasserver: RAS_SERVER_HANDLE, hport: super::HANDLE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprAdminPortReset(hrasserver : RAS_SERVER_HANDLE, hport : super::HANDLE) -> u32);
    unsafe { MprAdminPortReset(hrasserver, hport) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprAdminRegisterConnectionNotification(hmprserver: MPR_SERVER_HANDLE, heventnotification: super::HANDLE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprAdminRegisterConnectionNotification(hmprserver : MPR_SERVER_HANDLE, heventnotification : super::HANDLE) -> u32);
    unsafe { MprAdminRegisterConnectionNotification(hmprserver, heventnotification) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprAdminSendUserMessage<P2>(hmprserver: MPR_SERVER_HANDLE, hconnection: super::HANDLE, lpwszmessage: P2) -> u32
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("mprapi.dll" "system" fn MprAdminSendUserMessage(hmprserver : MPR_SERVER_HANDLE, hconnection : super::HANDLE, lpwszmessage : windows_core::PCWSTR) -> u32);
...
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn MprAdminServerGetCredentials(hmprserver: MPR_SERVER_HANDLE, dwlevel: u32, lplpbbuffer: *const super::LPBYTE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprAdminServerGetCredentials(hmprserver : MPR_SERVER_HANDLE, dwlevel : u32, lplpbbuffer : *const super::LPBYTE) -> u32);
    unsafe { MprAdminServerGetCredentials(hmprserver, dwlevel, lplpbbuffer) }
}
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn MprAdminServerGetInfo(hmprserver: MPR_SERVER_HANDLE, dwlevel: u32, lplpbbuffer: *mut super::LPBYTE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprAdminServerGetInfo(hmprserver : MPR_SERVER_HANDLE, dwlevel : u32, lplpbbuffer : *mut super::LPBYTE) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprConfigInterfaceDelete(hmprconfig: super::HANDLE, hrouterinterface: super::HANDLE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprConfigInterfaceDelete(hmprconfig : super::HANDLE, hrouterinterface : super::HANDLE) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprConfigInterfaceGetHandle<P1>(hmprconfig: super::HANDLE, lpwsinterfacename: P1, phrouterinterface: *mut super::HANDLE) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("mprapi.dll" "system" fn MprConfigInterfaceGetHandle(hmprconfig : super::HANDLE, lpwsinterfacename : windows_core::PCWSTR, phrouterinterface : *mut super::HANDLE) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprConfigInterfaceTransportGetHandle(hmprconfig: super::HANDLE, hrouterinterface: super::HANDLE, dwtransportid: u32, phrouteriftransport: *mut super::HANDLE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprConfigInterfaceTransportGetHandle(hmprconfig : super::HANDLE, hrouterinterface : super::HANDLE, dwtransportid : u32, phrouteriftransport : *mut super::HANDLE) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprConfigInterfaceTransportRemove(hmprconfig: super::HANDLE, hrouterinterface: super::HANDLE, hrouteriftransport: super::HANDLE) -> u32 {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprConfigServerBackup<P1>(hmprconfig: super::HANDLE, lpwspath: P1) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("mprapi.dll" "system" fn MprConfigServerBackup(hmprconfig : super::HANDLE, lpwspath : windows_core::PCWSTR) -> u32);
    unsafe { MprConfigServerBackup(hmprconfig, lpwspath.param().abi()) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprConfigServerConnect<P0>(lpwsservername: P0, phmprconfig: *mut super::HANDLE) -> u32
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("mprapi.dll" "system" fn MprConfigServerConnect(lpwsservername : windows_core::PCWSTR, phmprconfig : *mut super::HANDLE) -> u32);
    unsafe { MprConfigServerConnect(lpwsservername.param().abi(), phmprconfig as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprConfigServerDisconnect(hmprconfig: super::HANDLE) {
    windows_core::link!("mprapi.dll" "system" fn MprConfigServerDisconnect(hmprconfig : super::HANDLE));
    unsafe { MprConfigServerDisconnect(hmprconfig) }
}
#[cfg(all(feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn MprConfigServerGetInfo(hmprconfig: super::HANDLE, dwlevel: u32, lplpbbuffer: *mut super::LPBYTE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprConfigServerGetInfo(hmprconfig : super::HANDLE, dwlevel : u32, lplpbbuffer : *mut super::LPBYTE) -> u32);
    unsafe { MprConfigServerGetInfo(hmprconfig, dwlevel, lplpbbuffer as _) }
}
#[cfg(all(feature = "wincrypt", feature = "winnt"))]
#[inline]
pub unsafe fn MprConfigServerGetInfoEx(hmprconfig: super::HANDLE, pserverinfo: *mut MPR_SERVER_EX1) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprConfigServerGetInfoEx(hmprconfig : super::HANDLE, pserverinfo : *mut MPR_SERVER_EX1) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprConfigServerRefresh(hmprconfig: super::HANDLE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprConfigServerRefresh(hmprconfig : super::HANDLE) -> u32);
    unsafe { MprConfigServerRefresh(hmprconfig) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprConfigServerRestore<P1>(hmprconfig: super::HANDLE, lpwspath: P1) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[cfg(all(feature = "wincrypt", feature = "winnt"))]
#[inline]
pub unsafe fn MprConfigServerSetInfoEx(hmprconfig: super::HANDLE, psetserverconfig: *const MPR_SERVER_SET_CONFIG_EX1) -> u32 {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprConfigTransportDelete(hmprconfig: super::HANDLE, hroutertransport: super::HANDLE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprConfigTransportDelete(hmprconfig : super::HANDLE, hroutertransport : super::HANDLE) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn MprConfigTransportGetHandle(hmprconfig: super::HANDLE, dwtransportid: u32, phroutertransport: *mut super::HANDLE) -> u32 {
    windows_core::link!("mprapi.dll" "system" fn MprConfigTransportGetHandle(hmprconfig : super::HANDLE, dwtransportid : u32, phroutertransport : *mut super::HANDLE) -> u32);
...
pub struct AUTH_VALIDATION_EX {
    ...
    pub hRasConnection: super::HANDLE,
...
pub struct IKEV2_TUNNEL_CONFIG_PARAMS2 {
    ...
    pub certificateNames: *mut super::CERT_NAME_BLOB,
    pub machineCertificateName: super::CERT_NAME_BLOB,
...
pub struct MPR_INTERFACE_2 {
    ...
    pub lpbCustomAuthData: super::LPBYTE,
...
pub struct MPR_INTERFACE_3 {
    ...
    pub ipv6addrDns: super::IN6_ADDR,
    pub ipv6addrDnsAlt: super::IN6_ADDR,
    pub ipv6addr: *mut super::IN6_ADDR,
}
#[cfg(all(feature = "in6addr", feature = "minwindef", feature = "winnt"))]
...
#[cfg(feature = "winnt")]
pub type MPR_SERVER_HANDLE = super::HANDLE;
#[repr(C)]
#[cfg(feature = "wincrypt")]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
#[cfg(feature = "in6addr")]
pub type PMPRADMINGETIPV6ADDRESSFORUSER = Option<unsafe extern "system" fn(param0: *mut u16, param1: *mut u16, param2: *mut super::IN6_ADDR, param3: *mut windows_core::BOOL) -> u32>;
#[cfg(feature = "winnt")]
...
#[cfg(feature = "in6addr")]
pub type PMPRADMINRELEASEIPV6ADDRESSFORUSER = Option<unsafe extern "system" fn(param0: *mut u16, param1: *mut u16, param2: *mut super::IN6_ADDR)>;
...
pub struct RAS_CONNECTION_4 {
    ...
    pub guid: windows_core::GUID,
    pub rasQuarState: RAS_QUARANTINE_STATE,
    pub probationTime: super::FILETIME,
    pub connectionStartTime: super::FILETIME,
...
#[cfg(feature = "winnt")]
pub type RAS_SERVER_HANDLE = super::HANDLE;
#[repr(C)]
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
...
pub struct SSTP_CERT_INFO {
    ...
    pub certBlob: super::CRYPT_HASH_BLOB,
}
#[repr(C)]
#[cfg(feature = "wincrypt")]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub union VPN_TS_IP_ADDRESS_0 {
    pub v4: super::IN_ADDR,
    pub v6: super::IN6_ADDR,
}
#[cfg(all(feature = "in6addr", feature = "inaddr"))]
