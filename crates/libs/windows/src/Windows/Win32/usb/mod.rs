...
pub const MS_GENRE_DESCRIPTOR_INDEX: i32 = 1;
pub const MS_OS_FLAGS_CONTAINERID: i32 = 2;
pub const MS_OS_STRING_SIGNATURE: windows_core::PCWSTR = windows_core::w!("MSFT100");
pub const MS_POWER_DESCRIPTOR_INDEX: i32 = 2;
...
pub const URB_FUNCTION_ABORT_PIPE: i32 = 2;
pub const URB_FUNCTION_BULK_OR_INTERRUPT_TRANSFER: i32 = 9;
pub const URB_FUNCTION_BULK_OR_INTERRUPT_TRANSFER_USING_CHAINED_MDL: i32 = 55;
pub const URB_FUNCTION_CLASS_DEVICE: i32 = 26;
pub const URB_FUNCTION_CLASS_ENDPOINT: i32 = 28;
pub const URB_FUNCTION_CLASS_INTERFACE: i32 = 27;
pub const URB_FUNCTION_CLASS_OTHER: i32 = 31;
pub const URB_FUNCTION_CLEAR_FEATURE_TO_DEVICE: i32 = 16;
pub const URB_FUNCTION_CLEAR_FEATURE_TO_ENDPOINT: i32 = 18;
pub const URB_FUNCTION_CLEAR_FEATURE_TO_INTERFACE: i32 = 17;
pub const URB_FUNCTION_CLEAR_FEATURE_TO_OTHER: i32 = 34;
pub const URB_FUNCTION_CLOSE_STATIC_STREAMS: i32 = 54;
pub const URB_FUNCTION_CONTROL_TRANSFER: i32 = 8;
pub const URB_FUNCTION_CONTROL_TRANSFER_EX: i32 = 50;
pub const URB_FUNCTION_GET_CONFIGURATION: i32 = 38;
pub const URB_FUNCTION_GET_CURRENT_FRAME_NUMBER: i32 = 7;
pub const URB_FUNCTION_GET_DESCRIPTOR_FROM_DEVICE: i32 = 11;
pub const URB_FUNCTION_GET_DESCRIPTOR_FROM_ENDPOINT: i32 = 36;
pub const URB_FUNCTION_GET_DESCRIPTOR_FROM_INTERFACE: i32 = 40;
pub const URB_FUNCTION_GET_FRAME_LENGTH: i32 = 5;
pub const URB_FUNCTION_GET_INTERFACE: i32 = 39;
pub const URB_FUNCTION_GET_ISOCH_PIPE_TRANSFER_PATH_DELAYS: i32 = 61;
pub const URB_FUNCTION_GET_MS_FEATURE_DESCRIPTOR: i32 = 42;
pub const URB_FUNCTION_GET_STATUS_FROM_DEVICE: i32 = 19;
pub const URB_FUNCTION_GET_STATUS_FROM_ENDPOINT: i32 = 21;
pub const URB_FUNCTION_GET_STATUS_FROM_INTERFACE: i32 = 20;
pub const URB_FUNCTION_GET_STATUS_FROM_OTHER: i32 = 33;
pub const URB_FUNCTION_ISOCH_TRANSFER: i32 = 10;
pub const URB_FUNCTION_ISOCH_TRANSFER_USING_CHAINED_MDL: i32 = 56;
pub const URB_FUNCTION_OPEN_STATIC_STREAMS: i32 = 53;
pub const URB_FUNCTION_RELEASE_FRAME_LENGTH_CONTROL: i32 = 4;
pub const URB_FUNCTION_RESERVED_0X0016: i32 = 22;
pub const URB_FUNCTION_RESERVE_0X001D: i32 = 29;
pub const URB_FUNCTION_RESERVE_0X002B: i32 = 43;
pub const URB_FUNCTION_RESERVE_0X002C: i32 = 44;
pub const URB_FUNCTION_RESERVE_0X002D: i32 = 45;
pub const URB_FUNCTION_RESERVE_0X002E: i32 = 46;
pub const URB_FUNCTION_RESERVE_0X002F: i32 = 47;
pub const URB_FUNCTION_RESERVE_0X0033: i32 = 51;
pub const URB_FUNCTION_RESERVE_0X0034: i32 = 52;
pub const URB_FUNCTION_RESET_PIPE: i32 = 30;
pub const URB_FUNCTION_SELECT_CONFIGURATION: i32 = 0;
pub const URB_FUNCTION_SELECT_INTERFACE: i32 = 1;
pub const URB_FUNCTION_SET_DESCRIPTOR_TO_DEVICE: i32 = 12;
pub const URB_FUNCTION_SET_DESCRIPTOR_TO_ENDPOINT: i32 = 37;
pub const URB_FUNCTION_SET_DESCRIPTOR_TO_INTERFACE: i32 = 41;
pub const URB_FUNCTION_SET_FEATURE_TO_DEVICE: i32 = 13;
pub const URB_FUNCTION_SET_FEATURE_TO_ENDPOINT: i32 = 15;
pub const URB_FUNCTION_SET_FEATURE_TO_INTERFACE: i32 = 14;
pub const URB_FUNCTION_SET_FEATURE_TO_OTHER: i32 = 35;
pub const URB_FUNCTION_SET_FRAME_LENGTH: i32 = 6;
pub const URB_FUNCTION_SYNC_CLEAR_STALL: i32 = 49;
pub const URB_FUNCTION_SYNC_RESET_PIPE: i32 = 48;
pub const URB_FUNCTION_SYNC_RESET_PIPE_AND_CLEAR_STALL: i32 = 30;
pub const URB_FUNCTION_TAKE_FRAME_LENGTH_CONTROL: i32 = 3;
pub const URB_FUNCTION_VENDOR_DEVICE: i32 = 23;
pub const URB_FUNCTION_VENDOR_ENDPOINT: i32 = 25;
pub const URB_FUNCTION_VENDOR_INTERFACE: i32 = 24;
pub const URB_FUNCTION_VENDOR_OTHER: i32 = 32;
pub const URB_OPEN_STATIC_STREAMS_VERSION_100: i32 = 256;
pub const USBDI_VERSION: i32 = 1536;
pub type USBD_CONFIGURATION_HANDLE = *mut core::ffi::c_void;
...
pub const USBD_ISO_START_FRAME_RANGE: i32 = 1024;
pub const USBD_PF_CHANGE_MAX_PACKET: i32 = 1;
pub const USBD_PF_ENABLE_RT_THREAD_ACCESS: i32 = 4;
pub const USBD_PF_HANDLES_SSP_HIGH_BANDWIDTH_ISOCH: i32 = 256;
pub const USBD_PF_INTERACTIVE_PRIORITY: i32 = 48;
pub const USBD_PF_MAP_ADD_TRANSFERS: i32 = 8;
pub const USBD_PF_PRIORITY_MASK: i32 = 240;
pub const USBD_PF_SHORT_PACKET_OPT: i32 = 2;
pub const USBD_PF_SSP_HIGH_BANDWIDTH_ISOCH: i32 = 65536;
pub const USBD_PF_VALID_MASK: i32 = 319;
pub const USBD_PF_VIDEO_PRIORITY: i32 = 16;
...
pub const USBD_START_ISO_TRANSFER_ASAP: i32 = 4;
pub type USBD_STATUS = i32;
pub const USBD_STATUS_BABBLE_DETECTED: USBD_STATUS = 0xC0000012_u32 as _;
pub const USBD_STATUS_BAD_CONFIG_DESC_LENGTH: USBD_STATUS = 0xC0100006_u32 as _;
pub const USBD_STATUS_BAD_DESCRIPTOR: USBD_STATUS = 0xC0100000_u32 as _;
pub const USBD_STATUS_BAD_DESCRIPTOR_BLEN: USBD_STATUS = 0xC0100001_u32 as _;
pub const USBD_STATUS_BAD_DESCRIPTOR_TYPE: USBD_STATUS = 0xC0100002_u32 as _;
pub const USBD_STATUS_BAD_ENDPOINT_ADDRESS: USBD_STATUS = 0xC0100009_u32 as _;
pub const USBD_STATUS_BAD_ENDPOINT_DESCRIPTOR: USBD_STATUS = 0xC0100004_u32 as _;
pub const USBD_STATUS_BAD_INTERFACE_ASSOC_DESCRIPTOR: USBD_STATUS = 0xC0100005_u32 as _;
pub const USBD_STATUS_BAD_INTERFACE_DESCRIPTOR: USBD_STATUS = 0xC0100003_u32 as _;
pub const USBD_STATUS_BAD_NUMBER_OF_ENDPOINTS: USBD_STATUS = 0xC0100008_u32 as _;
pub const USBD_STATUS_BAD_NUMBER_OF_INTERFACES: USBD_STATUS = 0xC0100007_u32 as _;
pub const USBD_STATUS_BAD_START_FRAME: USBD_STATUS = 0xC0000A00_u32 as _;
pub const USBD_STATUS_BTSTUFF: USBD_STATUS = 0xC0000002_u32 as _;
pub const USBD_STATUS_BUFFER_OVERRUN: USBD_STATUS = 0xC000000C_u32 as _;
pub const USBD_STATUS_BUFFER_TOO_SMALL: USBD_STATUS = 0xC0003000_u32 as _;
pub const USBD_STATUS_BUFFER_UNDERRUN: USBD_STATUS = 0xC000000D_u32 as _;
pub const USBD_STATUS_CANCELED: USBD_STATUS = 0xC0010000_u32 as _;
pub const USBD_STATUS_CRC: USBD_STATUS = 0xC0000001_u32 as _;
pub const USBD_STATUS_DATA_BUFFER_ERROR: USBD_STATUS = 0xC0000013_u32 as _;
pub const USBD_STATUS_DATA_OVERRUN: USBD_STATUS = 0xC0000008_u32 as _;
pub const USBD_STATUS_DATA_TOGGLE_MISMATCH: USBD_STATUS = 0xC0000003_u32 as _;
pub const USBD_STATUS_DATA_UNDERRUN: USBD_STATUS = 0xC0000009_u32 as _;
pub const USBD_STATUS_DEVICE_GONE: USBD_STATUS = 0xC0007000_u32 as _;
pub const USBD_STATUS_DEV_NOT_RESPONDING: USBD_STATUS = 0xC0000005_u32 as _;
pub const USBD_STATUS_ENDPOINT_HALTED: USBD_STATUS = 0xC0000030_u32 as _;
pub const USBD_STATUS_ERROR_BUSY: USBD_STATUS = 0x80000400_u32 as _;
pub const USBD_STATUS_ERROR_SHORT_TRANSFER: USBD_STATUS = 0x80000900_u32 as _;
pub const USBD_STATUS_FIFO: USBD_STATUS = 0xC0000010_u32 as _;
pub const USBD_STATUS_FRAME_CONTROL_NOT_OWNED: USBD_STATUS = 0xC0000D00_u32 as _;
pub const USBD_STATUS_FRAME_CONTROL_OWNED: USBD_STATUS = 0xC0000C00_u32 as _;
pub const USBD_STATUS_HUB_INTERNAL_ERROR: USBD_STATUS = 0xC0009000_u32 as _;
pub const USBD_STATUS_INAVLID_CONFIGURATION_DESCRIPTOR: USBD_STATUS = 0xC0000F00_u32 as _;
pub const USBD_STATUS_INAVLID_PIPE_FLAGS: USBD_STATUS = 0xC0005000_u32 as _;
pub const USBD_STATUS_INSUFFICIENT_RESOURCES: USBD_STATUS = 0xC0001000_u32 as _;
pub const USBD_STATUS_INTERFACE_NOT_FOUND: USBD_STATUS = 0xC0004000_u32 as _;
pub const USBD_STATUS_INTERNAL_HC_ERROR: USBD_STATUS = 0x80000800_u32 as _;
pub const USBD_STATUS_INVALID_CONFIGURATION_DESCRIPTOR: USBD_STATUS = 0xC0000F00_u32 as _;
pub const USBD_STATUS_INVALID_PARAMETER: USBD_STATUS = 0x80000300_u32 as _;
pub const USBD_STATUS_INVALID_PIPE_HANDLE: USBD_STATUS = 0x80000600_u32 as _;
pub const USBD_STATUS_INVALID_STREAM_ID: USBD_STATUS = 0xC0000016_u32 as _;
pub const USBD_STATUS_INVALID_STREAM_TYPE: USBD_STATUS = 0xC0000015_u32 as _;
pub const USBD_STATUS_INVALID_URB_FUNCTION: USBD_STATUS = 0x80000200_u32 as _;
pub const USBD_STATUS_ISOCH_REQUEST_FAILED: USBD_STATUS = 0xC0000B00_u32 as _;
pub const USBD_STATUS_ISO_NA_LATE_USBPORT: USBD_STATUS = 0xC0040000_u32 as _;
pub const USBD_STATUS_ISO_NOT_ACCESSED_BY_HW: USBD_STATUS = 0xC0020000_u32 as _;
pub const USBD_STATUS_ISO_NOT_ACCESSED_LATE: USBD_STATUS = 0xC0050000_u32 as _;
pub const USBD_STATUS_ISO_TD_ERROR: USBD_STATUS = 0xC0030000_u32 as _;
pub const USBD_STATUS_NOT_ACCESSED: USBD_STATUS = 0xC000000F_u32 as _;
pub const USBD_STATUS_NOT_SUPPORTED: USBD_STATUS = 0xC0000E00_u32 as _;
pub const USBD_STATUS_NO_BANDWIDTH: USBD_STATUS = 0x80000700_u32 as _;
pub const USBD_STATUS_NO_PING_RESPONSE: USBD_STATUS = 0xC0000014_u32 as _;
pub const USBD_STATUS_PENDING: USBD_STATUS = 0x40000000_u32 as _;
pub const USBD_STATUS_PID_CHECK_FAILURE: USBD_STATUS = 0xC0000006_u32 as _;
pub const USBD_STATUS_PORT_OPERATION_PENDING: USBD_STATUS = 0x1_u32 as _;
pub const USBD_STATUS_RESERVED1: USBD_STATUS = 0xC000000A_u32 as _;
pub const USBD_STATUS_RESERVED2: USBD_STATUS = 0xC000000B_u32 as _;
pub const USBD_STATUS_SET_CONFIG_FAILED: USBD_STATUS = 0xC0002000_u32 as _;
pub const USBD_STATUS_STALL_PID: USBD_STATUS = 0xC0000004_u32 as _;
pub const USBD_STATUS_STATUS_NOT_MAPPED: USBD_STATUS = 0xC0008000_u32 as _;
pub const USBD_STATUS_SUCCESS: USBD_STATUS = 0x0_u32 as _;
pub const USBD_STATUS_TIMEOUT: USBD_STATUS = 0xC0006000_u32 as _;
...
pub const USBD_TRANSFER_DIRECTION_OUT: i32 = 0;
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const USB_DEFAULT_DEVICE_ADDRESS: i32 = 0;
pub const USB_DEFAULT_ENDPOINT_ADDRESS: i32 = 0;
pub const USB_DEFAULT_MAX_PACKET: i32 = 64;
pub const USB_HcGeneric: USB_CONTROLLER_FLAVOR = 0;
pub const USB_PORTATTR_MINI_CONNECTOR: i32 = 4;
pub const USB_PORTATTR_NO_CONNECTOR: i32 = 1;
pub const USB_PORTATTR_NO_OVERCURRENT_UI: i32 = 33554432;
pub const USB_PORTATTR_OEM_CONNECTOR: i32 = 8;
pub const USB_PORTATTR_OWNED_BY_CC: i32 = 16777216;
pub const USB_PORTATTR_SHARED_USB2: i32 = 2;
