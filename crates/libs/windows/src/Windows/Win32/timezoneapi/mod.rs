...
#[inline]
pub unsafe fn FileTimeToSystemTime(lpfiletime: *const super::FILETIME, lpsystemtime: *mut super::SYSTEMTIME) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn FileTimeToSystemTime(lpfiletime : *const super::FILETIME, lpsystemtime : *mut super::SYSTEMTIME) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwinbase", feature = "minwindef"))]
#[inline]
pub unsafe fn SystemTimeToFileTime(lpsystemtime: *const super::SYSTEMTIME, lpfiletime: *mut super::FILETIME) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SystemTimeToFileTime(lpsystemtime : *const super::SYSTEMTIME, lpfiletime : *mut super::FILETIME) -> windows_core::BOOL);
    unsafe { SystemTimeToFileTime(lpsystemtime, lpfiletime as _) }
}
#[cfg(feature = "minwinbase")]
#[inline]
pub unsafe fn SystemTimeToTzSpecificLocalTime(lptimezoneinformation: Option<*const TIME_ZONE_INFORMATION>, lpuniversaltime: *const super::SYSTEMTIME, lplocaltime: *mut super::SYSTEMTIME) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SystemTimeToTzSpecificLocalTime(lptimezoneinformation : *const TIME_ZONE_INFORMATION, lpuniversaltime : *const super::SYSTEMTIME, lplocaltime : *mut super::SYSTEMTIME) -> windows_core::BOOL);
...
#[cfg(feature = "minwinbase")]
#[inline]
pub unsafe fn SystemTimeToTzSpecificLocalTimeEx(lptimezoneinformation: Option<*const DYNAMIC_TIME_ZONE_INFORMATION>, lpuniversaltime: *const super::SYSTEMTIME, lplocaltime: *mut super::SYSTEMTIME) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SystemTimeToTzSpecificLocalTimeEx(lptimezoneinformation : *const DYNAMIC_TIME_ZONE_INFORMATION, lpuniversaltime : *const super::SYSTEMTIME, lplocaltime : *mut super::SYSTEMTIME) -> windows_core::BOOL);
...
#[cfg(feature = "minwinbase")]
#[inline]
pub unsafe fn TzSpecificLocalTimeToSystemTime(lptimezoneinformation: Option<*const TIME_ZONE_INFORMATION>, lplocaltime: *const super::SYSTEMTIME, lpuniversaltime: *mut super::SYSTEMTIME) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn TzSpecificLocalTimeToSystemTime(lptimezoneinformation : *const TIME_ZONE_INFORMATION, lplocaltime : *const super::SYSTEMTIME, lpuniversaltime : *mut super::SYSTEMTIME) -> windows_core::BOOL);
...
#[cfg(feature = "minwinbase")]
#[inline]
pub unsafe fn TzSpecificLocalTimeToSystemTimeEx(lptimezoneinformation: Option<*const DYNAMIC_TIME_ZONE_INFORMATION>, lplocaltime: *const super::SYSTEMTIME, lpuniversaltime: *mut super::SYSTEMTIME) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn TzSpecificLocalTimeToSystemTimeEx(lptimezoneinformation : *const DYNAMIC_TIME_ZONE_INFORMATION, lplocaltime : *const super::SYSTEMTIME, lpuniversaltime : *mut super::SYSTEMTIME) -> windows_core::BOOL);
