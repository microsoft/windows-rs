#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AddVectoredContinueHandler(first: u32, handler: super::PVECTORED_EXCEPTION_HANDLER) -> *mut core::ffi::c_void {
    windows_core::link!("kernel32.dll" "system" fn AddVectoredContinueHandler(first : u32, handler : super::PVECTORED_EXCEPTION_HANDLER) -> *mut core::ffi::c_void);
    unsafe { AddVectoredContinueHandler(first, handler) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AddVectoredExceptionHandler(first: u32, handler: super::PVECTORED_EXCEPTION_HANDLER) -> *mut core::ffi::c_void {
    windows_core::link!("kernel32.dll" "system" fn AddVectoredExceptionHandler(first : u32, handler : super::PVECTORED_EXCEPTION_HANDLER) -> *mut core::ffi::c_void);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn UnhandledExceptionFilter(exceptioninfo: *const super::EXCEPTION_POINTERS) -> i32 {
    windows_core::link!("kernel32.dll" "system" fn UnhandledExceptionFilter(exceptioninfo : *const super::EXCEPTION_POINTERS) -> i32);
