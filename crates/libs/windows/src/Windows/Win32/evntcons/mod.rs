...
#[inline]
pub unsafe fn EventAccessControl(guid: super::LPGUID, operation: u32, sid: super::PSID, rights: u32, allowordeny: super::BOOLEAN) -> u32 {
    windows_core::link!("advapi32.dll" "system" fn EventAccessControl(guid : super::LPGUID, operation : u32, sid : super::PSID, rights : u32, allowordeny : super::BOOLEAN) -> u32);
    unsafe { EventAccessControl(guid, operation, sid, rights, allowordeny) }
}
#[cfg(all(feature = "guiddef", feature = "minwindef", feature = "winnt"))]
#[inline]
pub unsafe fn EventAccessQuery(guid: super::LPGUID, buffer: Option<super::PSECURITY_DESCRIPTOR>, buffersize: super::PULONG) -> u32 {
    windows_core::link!("advapi32.dll" "system" fn EventAccessQuery(guid : super::LPGUID, buffer : super::PSECURITY_DESCRIPTOR, buffersize : super::PULONG) -> u32);
    unsafe { EventAccessQuery(guid, buffer.unwrap_or(core::mem::zeroed()) as _, buffersize as _) }
}
#[cfg(feature = "guiddef")]
#[inline]
pub unsafe fn EventAccessRemove(guid: super::LPGUID) -> u32 {
    windows_core::link!("advapi32.dll" "system" fn EventAccessRemove(guid : super::LPGUID) -> u32);
    unsafe { EventAccessRemove(guid) }
}
pub type ETW_PROVIDER_TRAIT_TYPE = i32;
pub type EVENTSECURITYOPERATION = i32;
pub const EVENT_ENABLE_PROPERTY_ENABLE_KEYWORD_0: i32 = 64;
pub const EVENT_ENABLE_PROPERTY_ENABLE_SILOS: i32 = 1024;
pub const EVENT_ENABLE_PROPERTY_EVENT_KEY: i32 = 256;
pub const EVENT_ENABLE_PROPERTY_EXCLUDE_INPRIVATE: i32 = 512;
pub const EVENT_ENABLE_PROPERTY_IGNORE_KEYWORD_0: i32 = 16;
pub const EVENT_ENABLE_PROPERTY_PROCESS_START_KEY: i32 = 128;
pub const EVENT_ENABLE_PROPERTY_PROVIDER_GROUP: i32 = 32;
pub const EVENT_ENABLE_PROPERTY_PSM_KEY: i32 = 8;
pub const EVENT_ENABLE_PROPERTY_SID: i32 = 1;
pub const EVENT_ENABLE_PROPERTY_SOURCE_CONTAINER_TRACKING: i32 = 2048;
pub const EVENT_ENABLE_PROPERTY_STACK_TRACE: i32 = 4;
pub const EVENT_ENABLE_PROPERTY_TS_ID: i32 = 2;
#[repr(C)]
...
pub const EVENT_HEADER_EXT_TYPE_CONTAINER_ID: i32 = 16;
pub const EVENT_HEADER_EXT_TYPE_CONTROL_GUID: i32 = 14;
pub const EVENT_HEADER_EXT_TYPE_EVENT_KEY: i32 = 10;
pub const EVENT_HEADER_EXT_TYPE_EVENT_SCHEMA_TL: i32 = 11;
pub const EVENT_HEADER_EXT_TYPE_INSTANCE_INFO: i32 = 4;
pub const EVENT_HEADER_EXT_TYPE_MAX: i32 = 19;
pub const EVENT_HEADER_EXT_TYPE_PEBS_INDEX: i32 = 7;
pub const EVENT_HEADER_EXT_TYPE_PMC_COUNTERS: i32 = 8;
pub const EVENT_HEADER_EXT_TYPE_PROCESS_START_KEY: i32 = 13;
pub const EVENT_HEADER_EXT_TYPE_PROV_TRAITS: i32 = 12;
pub const EVENT_HEADER_EXT_TYPE_PSM_KEY: i32 = 9;
pub const EVENT_HEADER_EXT_TYPE_QPC_DELTA: i32 = 15;
pub const EVENT_HEADER_EXT_TYPE_RELATED_ACTIVITYID: i32 = 1;
pub const EVENT_HEADER_EXT_TYPE_SID: i32 = 2;
pub const EVENT_HEADER_EXT_TYPE_STACK_KEY32: i32 = 17;
pub const EVENT_HEADER_EXT_TYPE_STACK_KEY64: i32 = 18;
pub const EVENT_HEADER_EXT_TYPE_STACK_TRACE32: i32 = 5;
pub const EVENT_HEADER_EXT_TYPE_STACK_TRACE64: i32 = 6;
pub const EVENT_HEADER_EXT_TYPE_TS_ID: i32 = 3;
pub const EVENT_HEADER_FLAG_32_BIT_HEADER: i32 = 32;
pub const EVENT_HEADER_FLAG_64_BIT_HEADER: i32 = 64;
pub const EVENT_HEADER_FLAG_CLASSIC_HEADER: i32 = 256;
pub const EVENT_HEADER_FLAG_DECODE_GUID: i32 = 128;
pub const EVENT_HEADER_FLAG_EXTENDED_INFO: i32 = 1;
pub const EVENT_HEADER_FLAG_NO_CPUTIME: i32 = 16;
pub const EVENT_HEADER_FLAG_PRIVATE_SESSION: i32 = 2;
pub const EVENT_HEADER_FLAG_PROCESSOR_INDEX: i32 = 512;
pub const EVENT_HEADER_FLAG_RESERVED1: i32 = 1024;
pub const EVENT_HEADER_FLAG_STRING_ONLY: i32 = 4;
pub const EVENT_HEADER_FLAG_TRACE_MESSAGE: i32 = 8;
pub const EVENT_HEADER_PROPERTY_FORWARDED_XML: i32 = 2;
pub const EVENT_HEADER_PROPERTY_LEGACY_EVENTLOG: i32 = 4;
pub const EVENT_HEADER_PROPERTY_RELOGGABLE: i32 = 8;
pub const EVENT_HEADER_PROPERTY_XML: i32 = 1;
#[repr(C)]
#[cfg(all(feature = "evntprov", feature = "evntrace", feature = "winnt"))]
#[derive(Clone, Copy)]
pub struct EVENT_RECORD {
    pub EventHeader: EVENT_HEADER,
    pub BufferContext: super::ETW_BUFFER_CONTEXT,
