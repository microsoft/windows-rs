...
pub struct WSD_EVENT {
    ...
    pub MessageParameters: core::mem::ManuallyDrop<Option<super::wsdbase::IWSDMessageParameters>>,
}
#[cfg(all(feature = "Win32_wsdbase", feature = "Win32_wsdhost", feature = "Win32_wsdxmldom"))]
...
#[cfg(all(feature = "Win32_wsdbase", feature = "Win32_wsdhost", feature = "Win32_wsdxmldom"))]
pub type WSD_STUB_FUNCTION = Option<unsafe extern "system" fn(server: windows_core::Ref<windows_core::IUnknown>, session: windows_core::Ref<super::wsdhost::IWSDServiceMessaging>, event: *mut WSD_EVENT) -> windows_core::HRESULT>;
#[repr(C)]
