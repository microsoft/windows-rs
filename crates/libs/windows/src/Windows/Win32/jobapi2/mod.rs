#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn AssignProcessToJobObject(hjob: super::HANDLE, hprocess: super::HANDLE) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn AssignProcessToJobObject(hjob : super::HANDLE, hprocess : super::HANDLE) -> windows_core::BOOL);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn OpenJobObjectW<P2>(dwdesiredaccess: u32, binherithandle: bool, lpname: P2) -> super::HANDLE
where
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn QueryIoRateControlInformationJobObject<P1>(hjob: Option<super::HANDLE>, volumename: P1, infoblocks: *mut *mut JOBOBJECT_IO_RATE_CONTROL_INFORMATION, infoblockcount: *mut u32) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("kernel32.dll" "system" fn QueryIoRateControlInformationJobObject(hjob : super::HANDLE, volumename : windows_core::PCWSTR, infoblocks : *mut *mut JOBOBJECT_IO_RATE_CONTROL_INFORMATION, infoblockcount : *mut u32) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetInformationJobObject(hjob: super::HANDLE, jobobjectinformationclass: super::JOBOBJECTINFOCLASS, lpjobobjectinformation: *const core::ffi::c_void, cbjobobjectinformationlength: u32) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn SetInformationJobObject(hjob : super::HANDLE, jobobjectinformationclass : super::JOBOBJECTINFOCLASS, lpjobobjectinformation : *const core::ffi::c_void, cbjobobjectinformationlength : u32) -> windows_core::BOOL);
    unsafe { SetInformationJobObject(hjob, jobobjectinformationclass, lpjobobjectinformation, cbjobobjectinformationlength) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn SetIoRateControlInformationJobObject(hjob: super::HANDLE, ioratecontrolinfo: *const JOBOBJECT_IO_RATE_CONTROL_INFORMATION) -> u32 {
    windows_core::link!("kernel32.dll" "system" fn SetIoRateControlInformationJobObject(hjob : super::HANDLE, ioratecontrolinfo : *const JOBOBJECT_IO_RATE_CONTROL_INFORMATION) -> u32);
    unsafe { SetIoRateControlInformationJobObject(hjob, ioratecontrolinfo) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn TerminateJobObject(hjob: super::HANDLE, uexitcode: u32) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn TerminateJobObject(hjob : super::HANDLE, uexitcode : u32) -> windows_core::BOOL);
