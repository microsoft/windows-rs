...
impl IDMOQualityControl {
    #[cfg(feature = "ksmedia")]
    pub unsafe fn SetNow(&self, rtnow: super::REFERENCE_TIME) -> windows_core::HRESULT {
...
pub struct IDMOQualityControl_Vtbl {
    ...
    #[cfg(feature = "ksmedia")]
    pub SetNow: unsafe extern "system" fn(*mut core::ffi::c_void, super::REFERENCE_TIME) -> windows_core::HRESULT,
...
pub trait IDMOQualityControl_Impl: windows_core::IUnknownImpl {
    fn SetNow(&self, rtnow: super::REFERENCE_TIME) -> windows_core::Result<()>;
...
impl IDMOQualityControl_Vtbl {
    pub const fn new<Identity: IDMOQualityControl_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetNow<Identity: IDMOQualityControl_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, rtnow: super::REFERENCE_TIME) -> windows_core::HRESULT {
            unsafe {
...
impl IMediaObject {
    ...
    #[cfg(feature = "ksmedia")]
    pub unsafe fn GetInputMaxLatency(&self, dwinputstreamindex: u32) -> windows_core::Result<super::REFERENCE_TIME> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ksmedia")]
    pub unsafe fn SetInputMaxLatency(&self, dwinputstreamindex: u32, rtmaxlatency: super::REFERENCE_TIME) -> windows_core::HRESULT {
    ...
    #[cfg(feature = "ksmedia")]
    pub unsafe fn ProcessInput<P1>(&self, dwinputstreamindex: u32, pbuffer: P1, dwflags: u32, rttimestamp: super::REFERENCE_TIME, rttimelength: super::REFERENCE_TIME) -> windows_core::HRESULT
    where
...
pub struct IMediaObject_Vtbl {
    ...
    #[cfg(feature = "ksmedia")]
    pub GetInputMaxLatency: unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut super::REFERENCE_TIME) -> windows_core::HRESULT,
    #[cfg(not(feature = "ksmedia"))]
    GetInputMaxLatency: usize,
    #[cfg(feature = "ksmedia")]
    pub SetInputMaxLatency: unsafe extern "system" fn(*mut core::ffi::c_void, u32, super::REFERENCE_TIME) -> windows_core::HRESULT,
    #[cfg(not(feature = "ksmedia"))]
    ...
    #[cfg(feature = "ksmedia")]
    pub ProcessInput: unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut core::ffi::c_void, u32, super::REFERENCE_TIME, super::REFERENCE_TIME) -> windows_core::HRESULT,
    #[cfg(not(feature = "ksmedia"))]
    ProcessInput: usize,
    #[cfg(feature = "ksmedia")]
...
pub trait IMediaObject_Impl: windows_core::IUnknownImpl {
    ...
    fn GetInputMaxLatency(&self, dwinputstreamindex: u32) -> windows_core::Result<super::REFERENCE_TIME>;
    fn SetInputMaxLatency(&self, dwinputstreamindex: u32, rtmaxlatency: super::REFERENCE_TIME) -> windows_core::Result<()>;
    ...
    fn ProcessInput(&self, dwinputstreamindex: u32, pbuffer: windows_core::Ref<IMediaBuffer>, dwflags: u32, rttimestamp: super::REFERENCE_TIME, rttimelength: super::REFERENCE_TIME) -> windows_core::Result<()>;
...
impl IMediaObject_Vtbl {
    pub const fn new<Identity: IMediaObject_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetInputMaxLatency<Identity: IMediaObject_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, dwinputstreamindex: u32, prtmaxlatency: *mut super::REFERENCE_TIME) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetInputMaxLatency<Identity: IMediaObject_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, dwinputstreamindex: u32, rtmaxlatency: super::REFERENCE_TIME) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ProcessInput<Identity: IMediaObject_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, dwinputstreamindex: u32, pbuffer: *mut core::ffi::c_void, dwflags: u32, rttimestamp: super::REFERENCE_TIME, rttimelength: super::REFERENCE_TIME) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub struct IMediaObjectInPlace_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "ksmedia")]
    pub Process: unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut u8, super::REFERENCE_TIME, u32) -> windows_core::HRESULT,
    #[cfg(not(feature = "ksmedia"))]
    Process: usize,
    pub Clone: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(feature = "ksmedia")]
...
pub trait IMediaObjectInPlace_Impl: windows_core::IUnknownImpl {
    fn Process(&self, ulsize: u32, pdata: *mut u8, reftimestart: super::REFERENCE_TIME, dwflags: u32) -> windows_core::Result<()>;
...
impl IMediaObjectInPlace_Vtbl {
    pub const fn new<Identity: IMediaObjectInPlace_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Process<Identity: IMediaObjectInPlace_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, ulsize: u32, pdata: *mut u8, reftimestart: super::REFERENCE_TIME, dwflags: u32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetLatency<Identity: IMediaObjectInPlace_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, platencytime: *mut super::REFERENCE_TIME) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
