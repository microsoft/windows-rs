#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn GetProcessHeap() -> super::HANDLE {
    windows_core::link!("kernel32.dll" "system" fn GetProcessHeap() -> super::HANDLE);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn HeapAlloc(hheap: super::HANDLE, dwflags: u32, dwbytes: usize) -> *mut core::ffi::c_void {
    windows_core::link!("kernel32.dll" "system" fn HeapAlloc(hheap : super::HANDLE, dwflags : u32, dwbytes : usize) -> *mut core::ffi::c_void);
    unsafe { HeapAlloc(hheap, dwflags, dwbytes) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn HeapCompact(hheap: super::HANDLE, dwflags: u32) -> usize {
    windows_core::link!("kernel32.dll" "system" fn HeapCompact(hheap : super::HANDLE, dwflags : u32) -> usize);
    unsafe { HeapCompact(hheap, dwflags) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn HeapCreate(floptions: u32, dwinitialsize: usize, dwmaximumsize: usize) -> super::HANDLE {
    windows_core::link!("kernel32.dll" "system" fn HeapCreate(floptions : u32, dwinitialsize : usize, dwmaximumsize : usize) -> super::HANDLE);
    unsafe { HeapCreate(floptions, dwinitialsize, dwmaximumsize) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn HeapDestroy(hheap: super::HANDLE) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn HeapDestroy(hheap : super::HANDLE) -> windows_core::BOOL);
    unsafe { HeapDestroy(hheap) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn HeapFree(hheap: super::HANDLE, dwflags: u32, lpmem: *mut core::ffi::c_void) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn HeapFree(hheap : super::HANDLE, dwflags : u32, lpmem : *mut core::ffi::c_void) -> windows_core::BOOL);
    unsafe { HeapFree(hheap as _, dwflags, lpmem as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn HeapLock(hheap: super::HANDLE) -> windows_core::BOOL {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn HeapReAlloc(hheap: super::HANDLE, dwflags: u32, lpmem: *mut core::ffi::c_void, dwbytes: usize) -> *mut core::ffi::c_void {
    windows_core::link!("kernel32.dll" "system" fn HeapReAlloc(hheap : super::HANDLE, dwflags : u32, lpmem : *mut core::ffi::c_void, dwbytes : usize) -> *mut core::ffi::c_void);
    unsafe { HeapReAlloc(hheap as _, dwflags, lpmem as _, dwbytes) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn HeapSetInformation(heaphandle: Option<super::HANDLE>, heapinformationclass: super::HEAP_INFORMATION_CLASS, heapinformation: Option<*const core::ffi::c_void>, heapinformationlength: usize) -> windows_core::BOOL {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn HeapSummary(hheap: super::HANDLE, dwflags: u32, lpsummary: LPHEAP_SUMMARY) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn HeapSummary(hheap : super::HANDLE, dwflags : u32, lpsummary : LPHEAP_SUMMARY) -> windows_core::BOOL);
    unsafe { HeapSummary(hheap, dwflags, lpsummary as _) }
}
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn HeapUnlock(hheap: super::HANDLE) -> windows_core::BOOL {
