...
#[inline]
pub unsafe fn CallEnclave(lproutine: super::LPENCLAVE_ROUTINE, lpparameter: *const core::ffi::c_void, fwaitforthread: bool, lpreturnvalue: *mut *mut core::ffi::c_void) -> windows_core::BOOL {
