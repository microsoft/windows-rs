...
impl IIsolatedEnvironmentInterop {
    #[cfg(feature = "windef")]
    pub unsafe fn GetHostHwndInterop(&self, containerhwnd: super::HWND) -> windows_core::Result<super::HWND> {
        unsafe {
...
pub struct IIsolatedEnvironmentInterop_Vtbl {
    ...
    #[cfg(feature = "windef")]
    pub GetHostHwndInterop: unsafe extern "system" fn(*mut core::ffi::c_void, super::HWND, *mut super::HWND) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    GetHostHwndInterop: usize,
}
#[cfg(feature = "windef")]
pub trait IIsolatedEnvironmentInterop_Impl: windows_core::IUnknownImpl {
    fn GetHostHwndInterop(&self, containerhwnd: super::HWND) -> windows_core::Result<super::HWND>;
}
#[cfg(feature = "windef")]
impl IIsolatedEnvironmentInterop_Vtbl {
    pub const fn new<Identity: IIsolatedEnvironmentInterop_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetHostHwndInterop<Identity: IIsolatedEnvironmentInterop_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, containerhwnd: super::HWND, hosthwnd: *mut super::HWND) -> windows_core::HRESULT {
            unsafe {
