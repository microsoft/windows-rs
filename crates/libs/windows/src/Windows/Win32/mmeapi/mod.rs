...
#[inline]
pub unsafe fn auxGetDevCapsA(udeviceid: usize, pac: *mut AUXCAPSA, cbac: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn auxGetDevCapsA(udeviceid : usize, pac : *mut AUXCAPSA, cbac : u32) -> super::MMRESULT);
    unsafe { auxGetDevCapsA(udeviceid, pac as _, cbac) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn auxGetDevCapsW(udeviceid: usize, pac: *mut AUXCAPSW, cbac: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn auxGetDevCapsW(udeviceid : usize, pac : *mut AUXCAPSW, cbac : u32) -> super::MMRESULT);
...
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn auxGetVolume(udeviceid: u32, pdwvolume: *mut u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn auxGetVolume(udeviceid : u32, pdwvolume : *mut u32) -> super::MMRESULT);
    unsafe { auxGetVolume(udeviceid, pdwvolume as _) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn auxOutMessage(udeviceid: u32, umsg: u32, dw1: Option<usize>, dw2: Option<usize>) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn auxOutMessage(udeviceid : u32, umsg : u32, dw1 : usize, dw2 : usize) -> super::MMRESULT);
    unsafe { auxOutMessage(udeviceid, umsg, dw1.unwrap_or(core::mem::zeroed()) as _, dw2.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn auxSetVolume(udeviceid: u32, dwvolume: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn auxSetVolume(udeviceid : u32, dwvolume : u32) -> super::MMRESULT);
    unsafe { auxSetVolume(udeviceid, dwvolume) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiConnect(hmi: HMIDI, hmo: HMIDIOUT, preserved: Option<*const core::ffi::c_void>) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiConnect(hmi : HMIDI, hmo : HMIDIOUT, preserved : *const core::ffi::c_void) -> super::MMRESULT);
    unsafe { midiConnect(hmi, hmo, preserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiDisconnect(hmi: HMIDI, hmo: HMIDIOUT, preserved: Option<*const core::ffi::c_void>) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiDisconnect(hmi : HMIDI, hmo : HMIDIOUT, preserved : *const core::ffi::c_void) -> super::MMRESULT);
    unsafe { midiDisconnect(hmi, hmo, preserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiInAddBuffer(hmi: HMIDIIN, pmh: *mut MIDIHDR, cbmh: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiInAddBuffer(hmi : HMIDIIN, pmh : *mut MIDIHDR, cbmh : u32) -> super::MMRESULT);
    unsafe { midiInAddBuffer(hmi, pmh as _, cbmh) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiInClose(hmi: HMIDIIN) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiInClose(hmi : HMIDIIN) -> super::MMRESULT);
    unsafe { midiInClose(hmi) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiInGetDevCapsA(udeviceid: usize, pmic: *mut MIDIINCAPSA, cbmic: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiInGetDevCapsA(udeviceid : usize, pmic : *mut MIDIINCAPSA, cbmic : u32) -> super::MMRESULT);
    unsafe { midiInGetDevCapsA(udeviceid, pmic as _, cbmic) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiInGetDevCapsW(udeviceid: usize, pmic: *mut MIDIINCAPSW, cbmic: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiInGetDevCapsW(udeviceid : usize, pmic : *mut MIDIINCAPSW, cbmic : u32) -> super::MMRESULT);
...
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiInGetID(hmi: HMIDIIN, pudeviceid: *mut u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiInGetID(hmi : HMIDIIN, pudeviceid : *mut u32) -> super::MMRESULT);
...
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiInMessage(hmi: Option<HMIDIIN>, umsg: u32, dw1: Option<usize>, dw2: Option<usize>) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiInMessage(hmi : HMIDIIN, umsg : u32, dw1 : usize, dw2 : usize) -> super::MMRESULT);
...
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiInOpen(phmi: *mut HMIDIIN, udeviceid: u32, dwcallback: Option<usize>, dwinstance: Option<usize>, fdwopen: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiInOpen(phmi : *mut HMIDIIN, udeviceid : u32, dwcallback : usize, dwinstance : usize, fdwopen : u32) -> super::MMRESULT);
...
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiInPrepareHeader(hmi: HMIDIIN, pmh: *mut MIDIHDR, cbmh: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiInPrepareHeader(hmi : HMIDIIN, pmh : *mut MIDIHDR, cbmh : u32) -> super::MMRESULT);
    unsafe { midiInPrepareHeader(hmi, pmh as _, cbmh) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiInReset(hmi: HMIDIIN) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiInReset(hmi : HMIDIIN) -> super::MMRESULT);
    unsafe { midiInReset(hmi) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiInStart(hmi: HMIDIIN) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiInStart(hmi : HMIDIIN) -> super::MMRESULT);
    unsafe { midiInStart(hmi) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiInStop(hmi: HMIDIIN) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiInStop(hmi : HMIDIIN) -> super::MMRESULT);
    unsafe { midiInStop(hmi) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiInUnprepareHeader(hmi: HMIDIIN, pmh: *mut MIDIHDR, cbmh: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiInUnprepareHeader(hmi : HMIDIIN, pmh : *mut MIDIHDR, cbmh : u32) -> super::MMRESULT);
    unsafe { midiInUnprepareHeader(hmi, pmh as _, cbmh) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiOutCacheDrumPatches(hmo: HMIDIOUT, upatch: u32, pwkya: *const u16, fucache: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiOutCacheDrumPatches(hmo : HMIDIOUT, upatch : u32, pwkya : *const u16, fucache : u32) -> super::MMRESULT);
    unsafe { midiOutCacheDrumPatches(hmo, upatch, pwkya, fucache) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiOutCachePatches(hmo: HMIDIOUT, ubank: u32, pwpa: *const u16, fucache: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiOutCachePatches(hmo : HMIDIOUT, ubank : u32, pwpa : *const u16, fucache : u32) -> super::MMRESULT);
    unsafe { midiOutCachePatches(hmo, ubank, pwpa, fucache) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiOutClose(hmo: HMIDIOUT) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiOutClose(hmo : HMIDIOUT) -> super::MMRESULT);
    unsafe { midiOutClose(hmo) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiOutGetDevCapsA(udeviceid: usize, pmoc: *mut MIDIOUTCAPSA, cbmoc: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiOutGetDevCapsA(udeviceid : usize, pmoc : *mut MIDIOUTCAPSA, cbmoc : u32) -> super::MMRESULT);
    unsafe { midiOutGetDevCapsA(udeviceid, pmoc as _, cbmoc) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiOutGetDevCapsW(udeviceid: usize, pmoc: *mut MIDIOUTCAPSW, cbmoc: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiOutGetDevCapsW(udeviceid : usize, pmoc : *mut MIDIOUTCAPSW, cbmoc : u32) -> super::MMRESULT);
...
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiOutGetID(hmo: HMIDIOUT, pudeviceid: *mut u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiOutGetID(hmo : HMIDIOUT, pudeviceid : *mut u32) -> super::MMRESULT);
...
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiOutGetVolume(hmo: Option<HMIDIOUT>, pdwvolume: *mut u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiOutGetVolume(hmo : HMIDIOUT, pdwvolume : *mut u32) -> super::MMRESULT);
    unsafe { midiOutGetVolume(hmo.unwrap_or(core::mem::zeroed()) as _, pdwvolume as _) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiOutLongMsg(hmo: HMIDIOUT, pmh: *const MIDIHDR, cbmh: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiOutLongMsg(hmo : HMIDIOUT, pmh : *const MIDIHDR, cbmh : u32) -> super::MMRESULT);
    unsafe { midiOutLongMsg(hmo, pmh, cbmh) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiOutMessage(hmo: Option<HMIDIOUT>, umsg: u32, dw1: Option<usize>, dw2: Option<usize>) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiOutMessage(hmo : HMIDIOUT, umsg : u32, dw1 : usize, dw2 : usize) -> super::MMRESULT);
...
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiOutOpen(phmo: *mut HMIDIOUT, udeviceid: u32, dwcallback: Option<usize>, dwinstance: Option<usize>, fdwopen: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiOutOpen(phmo : *mut HMIDIOUT, udeviceid : u32, dwcallback : usize, dwinstance : usize, fdwopen : u32) -> super::MMRESULT);
...
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiOutPrepareHeader(hmo: HMIDIOUT, pmh: *mut MIDIHDR, cbmh: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiOutPrepareHeader(hmo : HMIDIOUT, pmh : *mut MIDIHDR, cbmh : u32) -> super::MMRESULT);
    unsafe { midiOutPrepareHeader(hmo, pmh as _, cbmh) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiOutReset(hmo: HMIDIOUT) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiOutReset(hmo : HMIDIOUT) -> super::MMRESULT);
    unsafe { midiOutReset(hmo) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiOutSetVolume(hmo: Option<HMIDIOUT>, dwvolume: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiOutSetVolume(hmo : HMIDIOUT, dwvolume : u32) -> super::MMRESULT);
    unsafe { midiOutSetVolume(hmo.unwrap_or(core::mem::zeroed()) as _, dwvolume) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiOutShortMsg(hmo: HMIDIOUT, dwmsg: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiOutShortMsg(hmo : HMIDIOUT, dwmsg : u32) -> super::MMRESULT);
    unsafe { midiOutShortMsg(hmo, dwmsg) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiOutUnprepareHeader(hmo: HMIDIOUT, pmh: *mut MIDIHDR, cbmh: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiOutUnprepareHeader(hmo : HMIDIOUT, pmh : *mut MIDIHDR, cbmh : u32) -> super::MMRESULT);
    unsafe { midiOutUnprepareHeader(hmo, pmh as _, cbmh) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiStreamClose(hms: HMIDISTRM) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiStreamClose(hms : HMIDISTRM) -> super::MMRESULT);
    unsafe { midiStreamClose(hms) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiStreamOpen(phms: *mut HMIDISTRM, pudeviceid: &mut [u32], dwcallback: Option<usize>, dwinstance: Option<usize>, fdwopen: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiStreamOpen(phms : *mut HMIDISTRM, pudeviceid : *mut u32, cmidi : u32, dwcallback : usize, dwinstance : usize, fdwopen : u32) -> super::MMRESULT);
    unsafe { midiStreamOpen(phms as _, pudeviceid.as_mut_ptr(), pudeviceid.len().try_into().unwrap(), dwcallback.unwrap_or(core::mem::zeroed()) as _, dwinstance.unwrap_or(core::mem::zeroed()) as _, fdwopen) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiStreamOut(hms: HMIDISTRM, pmh: *mut MIDIHDR, cbmh: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiStreamOut(hms : HMIDISTRM, pmh : *mut MIDIHDR, cbmh : u32) -> super::MMRESULT);
    unsafe { midiStreamOut(hms, pmh as _, cbmh) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiStreamPause(hms: HMIDISTRM) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiStreamPause(hms : HMIDISTRM) -> super::MMRESULT);
    unsafe { midiStreamPause(hms) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiStreamPosition(hms: HMIDISTRM, lpmmt: *mut super::MMTIME, cbmmt: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiStreamPosition(hms : HMIDISTRM, lpmmt : *mut super::MMTIME, cbmmt : u32) -> super::MMRESULT);
    unsafe { midiStreamPosition(hms, lpmmt as _, cbmmt) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiStreamProperty(hms: HMIDISTRM, lppropdata: *mut u8, dwproperty: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiStreamProperty(hms : HMIDISTRM, lppropdata : *mut u8, dwproperty : u32) -> super::MMRESULT);
    unsafe { midiStreamProperty(hms, lppropdata as _, dwproperty) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiStreamRestart(hms: HMIDISTRM) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiStreamRestart(hms : HMIDISTRM) -> super::MMRESULT);
    unsafe { midiStreamRestart(hms) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn midiStreamStop(hms: HMIDISTRM) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn midiStreamStop(hms : HMIDISTRM) -> super::MMRESULT);
    unsafe { midiStreamStop(hms) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn mixerClose(hmx: HMIXER) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mixerClose(hmx : HMIXER) -> super::MMRESULT);
    unsafe { mixerClose(hmx) }
}
#[cfg(all(feature = "mmsyscom", feature = "windef"))]
#[inline]
pub unsafe fn mixerGetControlDetailsA(hmxobj: Option<HMIXEROBJ>, pmxcd: *mut MIXERCONTROLDETAILS, fdwdetails: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mixerGetControlDetailsA(hmxobj : HMIXEROBJ, pmxcd : *mut MIXERCONTROLDETAILS, fdwdetails : u32) -> super::MMRESULT);
    unsafe { mixerGetControlDetailsA(hmxobj.unwrap_or(core::mem::zeroed()) as _, pmxcd as _, fdwdetails) }
}
#[cfg(all(feature = "mmsyscom", feature = "windef"))]
#[inline]
pub unsafe fn mixerGetControlDetailsW(hmxobj: Option<HMIXEROBJ>, pmxcd: *mut MIXERCONTROLDETAILS, fdwdetails: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mixerGetControlDetailsW(hmxobj : HMIXEROBJ, pmxcd : *mut MIXERCONTROLDETAILS, fdwdetails : u32) -> super::MMRESULT);
    unsafe { mixerGetControlDetailsW(hmxobj.unwrap_or(core::mem::zeroed()) as _, pmxcd as _, fdwdetails) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn mixerGetDevCapsA(umxid: usize, pmxcaps: *mut MIXERCAPSA, cbmxcaps: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mixerGetDevCapsA(umxid : usize, pmxcaps : *mut MIXERCAPSA, cbmxcaps : u32) -> super::MMRESULT);
    unsafe { mixerGetDevCapsA(umxid, pmxcaps as _, cbmxcaps) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn mixerGetDevCapsW(umxid: usize, pmxcaps: *mut MIXERCAPSW, cbmxcaps: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mixerGetDevCapsW(umxid : usize, pmxcaps : *mut MIXERCAPSW, cbmxcaps : u32) -> super::MMRESULT);
    unsafe { mixerGetDevCapsW(umxid, pmxcaps as _, cbmxcaps) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn mixerGetID(hmxobj: Option<HMIXEROBJ>, pumxid: *mut u32, fdwid: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mixerGetID(hmxobj : HMIXEROBJ, pumxid : *mut u32, fdwid : u32) -> super::MMRESULT);
    unsafe { mixerGetID(hmxobj.unwrap_or(core::mem::zeroed()) as _, pumxid as _, fdwid) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn mixerGetLineControlsA(hmxobj: Option<HMIXEROBJ>, pmxlc: *mut MIXERLINECONTROLSA, fdwcontrols: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mixerGetLineControlsA(hmxobj : HMIXEROBJ, pmxlc : *mut MIXERLINECONTROLSA, fdwcontrols : u32) -> super::MMRESULT);
    unsafe { mixerGetLineControlsA(hmxobj.unwrap_or(core::mem::zeroed()) as _, pmxlc as _, fdwcontrols) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn mixerGetLineControlsW(hmxobj: Option<HMIXEROBJ>, pmxlc: *mut MIXERLINECONTROLSW, fdwcontrols: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mixerGetLineControlsW(hmxobj : HMIXEROBJ, pmxlc : *mut MIXERLINECONTROLSW, fdwcontrols : u32) -> super::MMRESULT);
    unsafe { mixerGetLineControlsW(hmxobj.unwrap_or(core::mem::zeroed()) as _, pmxlc as _, fdwcontrols) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn mixerGetLineInfoA(hmxobj: Option<HMIXEROBJ>, pmxl: *mut MIXERLINEA, fdwinfo: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mixerGetLineInfoA(hmxobj : HMIXEROBJ, pmxl : *mut MIXERLINEA, fdwinfo : u32) -> super::MMRESULT);
    unsafe { mixerGetLineInfoA(hmxobj.unwrap_or(core::mem::zeroed()) as _, pmxl as _, fdwinfo) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn mixerGetLineInfoW(hmxobj: Option<HMIXEROBJ>, pmxl: *mut MIXERLINEW, fdwinfo: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mixerGetLineInfoW(hmxobj : HMIXEROBJ, pmxl : *mut MIXERLINEW, fdwinfo : u32) -> super::MMRESULT);
...
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn mixerOpen(phmx: Option<*mut HMIXER>, umxid: u32, dwcallback: Option<usize>, dwinstance: Option<usize>, fdwopen: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mixerOpen(phmx : *mut HMIXER, umxid : u32, dwcallback : usize, dwinstance : usize, fdwopen : u32) -> super::MMRESULT);
...
#[cfg(all(feature = "mmsyscom", feature = "windef"))]
#[inline]
pub unsafe fn mixerSetControlDetails(hmxobj: Option<HMIXEROBJ>, pmxcd: *const MIXERCONTROLDETAILS, fdwdetails: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn mixerSetControlDetails(hmxobj : HMIXEROBJ, pmxcd : *const MIXERCONTROLDETAILS, fdwdetails : u32) -> super::MMRESULT);
    unsafe { mixerSetControlDetails(hmxobj.unwrap_or(core::mem::zeroed()) as _, pmxcd, fdwdetails) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveInAddBuffer(hwi: HWAVEIN, pwh: *mut WAVEHDR, cbwh: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveInAddBuffer(hwi : HWAVEIN, pwh : *mut WAVEHDR, cbwh : u32) -> super::MMRESULT);
    unsafe { waveInAddBuffer(hwi, pwh as _, cbwh) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveInClose(hwi: HWAVEIN) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveInClose(hwi : HWAVEIN) -> super::MMRESULT);
    unsafe { waveInClose(hwi) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveInGetDevCapsA(udeviceid: usize, pwic: *mut WAVEINCAPSA, cbwic: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveInGetDevCapsA(udeviceid : usize, pwic : *mut WAVEINCAPSA, cbwic : u32) -> super::MMRESULT);
    unsafe { waveInGetDevCapsA(udeviceid, pwic as _, cbwic) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveInGetDevCapsW(udeviceid: usize, pwic: *mut WAVEINCAPSW, cbwic: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveInGetDevCapsW(udeviceid : usize, pwic : *mut WAVEINCAPSW, cbwic : u32) -> super::MMRESULT);
...
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveInGetID(hwi: HWAVEIN, pudeviceid: *const u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveInGetID(hwi : HWAVEIN, pudeviceid : *const u32) -> super::MMRESULT);
...
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveInGetPosition(hwi: HWAVEIN, pmmt: *mut super::MMTIME, cbmmt: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveInGetPosition(hwi : HWAVEIN, pmmt : *mut super::MMTIME, cbmmt : u32) -> super::MMRESULT);
    unsafe { waveInGetPosition(hwi, pmmt as _, cbmmt) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveInMessage(hwi: Option<HWAVEIN>, umsg: u32, dw1: Option<usize>, dw2: Option<usize>) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveInMessage(hwi : HWAVEIN, umsg : u32, dw1 : usize, dw2 : usize) -> super::MMRESULT);
...
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveInOpen(phwi: Option<*mut HWAVEIN>, udeviceid: u32, pwfx: *const WAVEFORMATEX, dwcallback: Option<usize>, dwinstance: Option<usize>, fdwopen: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveInOpen(phwi : *mut HWAVEIN, udeviceid : u32, pwfx : *const WAVEFORMATEX, dwcallback : usize, dwinstance : usize, fdwopen : u32) -> super::MMRESULT);
...
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveInPrepareHeader(hwi: HWAVEIN, pwh: *mut WAVEHDR, cbwh: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveInPrepareHeader(hwi : HWAVEIN, pwh : *mut WAVEHDR, cbwh : u32) -> super::MMRESULT);
    unsafe { waveInPrepareHeader(hwi, pwh as _, cbwh) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveInReset(hwi: HWAVEIN) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveInReset(hwi : HWAVEIN) -> super::MMRESULT);
    unsafe { waveInReset(hwi) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveInStart(hwi: HWAVEIN) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveInStart(hwi : HWAVEIN) -> super::MMRESULT);
    unsafe { waveInStart(hwi) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveInStop(hwi: HWAVEIN) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveInStop(hwi : HWAVEIN) -> super::MMRESULT);
    unsafe { waveInStop(hwi) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveInUnprepareHeader(hwi: HWAVEIN, pwh: *mut WAVEHDR, cbwh: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveInUnprepareHeader(hwi : HWAVEIN, pwh : *mut WAVEHDR, cbwh : u32) -> super::MMRESULT);
    unsafe { waveInUnprepareHeader(hwi, pwh as _, cbwh) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutBreakLoop(hwo: HWAVEOUT) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutBreakLoop(hwo : HWAVEOUT) -> super::MMRESULT);
    unsafe { waveOutBreakLoop(hwo) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutClose(hwo: HWAVEOUT) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutClose(hwo : HWAVEOUT) -> super::MMRESULT);
    unsafe { waveOutClose(hwo) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutGetDevCapsA(udeviceid: usize, pwoc: *mut WAVEOUTCAPSA, cbwoc: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutGetDevCapsA(udeviceid : usize, pwoc : *mut WAVEOUTCAPSA, cbwoc : u32) -> super::MMRESULT);
    unsafe { waveOutGetDevCapsA(udeviceid, pwoc as _, cbwoc) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutGetDevCapsW(udeviceid: usize, pwoc: *mut WAVEOUTCAPSW, cbwoc: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutGetDevCapsW(udeviceid : usize, pwoc : *mut WAVEOUTCAPSW, cbwoc : u32) -> super::MMRESULT);
...
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutGetID(hwo: HWAVEOUT, pudeviceid: *mut u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutGetID(hwo : HWAVEOUT, pudeviceid : *mut u32) -> super::MMRESULT);
...
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutGetPitch(hwo: HWAVEOUT, pdwpitch: *mut u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutGetPitch(hwo : HWAVEOUT, pdwpitch : *mut u32) -> super::MMRESULT);
    unsafe { waveOutGetPitch(hwo, pdwpitch as _) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutGetPlaybackRate(hwo: HWAVEOUT, pdwrate: *mut u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutGetPlaybackRate(hwo : HWAVEOUT, pdwrate : *mut u32) -> super::MMRESULT);
    unsafe { waveOutGetPlaybackRate(hwo, pdwrate as _) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutGetPosition(hwo: HWAVEOUT, pmmt: *mut super::MMTIME, cbmmt: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutGetPosition(hwo : HWAVEOUT, pmmt : *mut super::MMTIME, cbmmt : u32) -> super::MMRESULT);
    unsafe { waveOutGetPosition(hwo, pmmt as _, cbmmt) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutGetVolume(hwo: Option<HWAVEOUT>, pdwvolume: *mut u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutGetVolume(hwo : HWAVEOUT, pdwvolume : *mut u32) -> super::MMRESULT);
    unsafe { waveOutGetVolume(hwo.unwrap_or(core::mem::zeroed()) as _, pdwvolume as _) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutMessage(hwo: Option<HWAVEOUT>, umsg: u32, dw1: usize, dw2: usize) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutMessage(hwo : HWAVEOUT, umsg : u32, dw1 : usize, dw2 : usize) -> super::MMRESULT);
    unsafe { waveOutMessage(hwo.unwrap_or(core::mem::zeroed()) as _, umsg, dw1, dw2) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutOpen(phwo: Option<*mut HWAVEOUT>, udeviceid: u32, pwfx: *const WAVEFORMATEX, dwcallback: Option<usize>, dwinstance: Option<usize>, fdwopen: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutOpen(phwo : *mut HWAVEOUT, udeviceid : u32, pwfx : *const WAVEFORMATEX, dwcallback : usize, dwinstance : usize, fdwopen : u32) -> super::MMRESULT);
...
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutPause(hwo: HWAVEOUT) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutPause(hwo : HWAVEOUT) -> super::MMRESULT);
    unsafe { waveOutPause(hwo) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutPrepareHeader(hwo: HWAVEOUT, pwh: *mut WAVEHDR, cbwh: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutPrepareHeader(hwo : HWAVEOUT, pwh : *mut WAVEHDR, cbwh : u32) -> super::MMRESULT);
    unsafe { waveOutPrepareHeader(hwo, pwh as _, cbwh) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutReset(hwo: HWAVEOUT) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutReset(hwo : HWAVEOUT) -> super::MMRESULT);
    unsafe { waveOutReset(hwo) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutRestart(hwo: HWAVEOUT) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutRestart(hwo : HWAVEOUT) -> super::MMRESULT);
    unsafe { waveOutRestart(hwo) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutSetPitch(hwo: HWAVEOUT, dwpitch: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutSetPitch(hwo : HWAVEOUT, dwpitch : u32) -> super::MMRESULT);
    unsafe { waveOutSetPitch(hwo, dwpitch) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutSetPlaybackRate(hwo: HWAVEOUT, dwrate: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutSetPlaybackRate(hwo : HWAVEOUT, dwrate : u32) -> super::MMRESULT);
    unsafe { waveOutSetPlaybackRate(hwo, dwrate) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutSetVolume(hwo: Option<HWAVEOUT>, dwvolume: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutSetVolume(hwo : HWAVEOUT, dwvolume : u32) -> super::MMRESULT);
    unsafe { waveOutSetVolume(hwo.unwrap_or(core::mem::zeroed()) as _, dwvolume) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutUnprepareHeader(hwo: HWAVEOUT, pwh: *mut WAVEHDR, cbwh: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutUnprepareHeader(hwo : HWAVEOUT, pwh : *mut WAVEHDR, cbwh : u32) -> super::MMRESULT);
    unsafe { waveOutUnprepareHeader(hwo, pwh as _, cbwh) }
}
#[cfg(feature = "mmsyscom")]
#[inline]
pub unsafe fn waveOutWrite(hwo: HWAVEOUT, pwh: *mut WAVEHDR, cbwh: u32) -> super::MMRESULT {
    windows_core::link!("winmm.dll" "system" fn waveOutWrite(hwo : HWAVEOUT, pwh : *mut WAVEHDR, cbwh : u32) -> super::MMRESULT);
...
pub struct AUXCAPS2A {
    pub wMid: u16,
    pub wPid: u16,
    pub vDriverVersion: super::MMVERSION,
    pub szPname: [i8; 32],
    pub wTechnology: u16,
    pub wReserved1: u16,
    pub dwSupport: u32,
...
pub const AUXCAPS_AUXIN: i32 = 2;
pub const AUXCAPS_CDAUDIO: i32 = 1;
...
pub const MHDR_DONE: i32 = 1;
pub const MHDR_INQUEUE: i32 = 4;
...
pub const MIDICAPS_VOLUME: i32 = 1;
pub const MIDIERR_BADOPENMODE: i32 = 70;
pub const MIDIERR_DONT_CONTINUE: i32 = 71;
pub const MIDIERR_INVALIDSETUP: i32 = 69;
pub const MIDIERR_LASTERROR: i32 = 71;
pub const MIDIERR_NODEVICE: i32 = 68;
pub const MIDIERR_NOMAP: i32 = 66;
pub const MIDIERR_NOTREADY: i32 = 67;
pub const MIDIERR_STILLPLAYING: i32 = 65;
pub const MIDIERR_UNPREPARED: i32 = 64;
#[repr(C, packed(1))]
#[derive(Clone, Copy)]
...
pub const MIDIPATCHSIZE: i32 = 128;
#[repr(C, packed(1))]
...
pub const MIDI_CACHE_ALL: i32 = 1;
pub const MIDI_CACHE_BESTFIT: i32 = 2;
pub const MIDI_CACHE_QUERY: i32 = 3;
pub const MIDI_IO_STATUS: i32 = 32;
pub const MIDI_MAPPER: u32 = 4294967295;
pub const MIDI_UNCACHE: i32 = 4;
pub const MIM_CLOSE: i32 = 962;
pub const MIM_DATA: i32 = 963;
pub const MIM_ERROR: i32 = 965;
pub const MIM_LONGDATA: i32 = 964;
pub const MIM_LONGERROR: i32 = 966;
pub const MIM_MOREDATA: i32 = 972;
pub const MIM_OPEN: i32 = 961;
#[cfg(feature = "mmsyscom")]
...
pub const MIXERCONTROL_CONTROLTYPE_BASS: i32 = 1342373890;
pub const MIXERCONTROL_CONTROLTYPE_BASS_BOOST: i32 = 536945271;
pub const MIXERCONTROL_CONTROLTYPE_BOOLEAN: i32 = 536936448;
pub const MIXERCONTROL_CONTROLTYPE_BOOLEANMETER: i32 = 268500992;
pub const MIXERCONTROL_CONTROLTYPE_BUTTON: i32 = 553713664;
pub const MIXERCONTROL_CONTROLTYPE_CUSTOM: i32 = 0;
pub const MIXERCONTROL_CONTROLTYPE_DECIBELS: i32 = 805568512;
pub const MIXERCONTROL_CONTROLTYPE_EQUALIZER: i32 = 1342373892;
pub const MIXERCONTROL_CONTROLTYPE_FADER: i32 = 1342373888;
pub const MIXERCONTROL_CONTROLTYPE_LOUDNESS: i32 = 536936452;
pub const MIXERCONTROL_CONTROLTYPE_MICROTIME: i32 = 1610809344;
pub const MIXERCONTROL_CONTROLTYPE_MILLITIME: i32 = 1627586560;
pub const MIXERCONTROL_CONTROLTYPE_MIXER: i32 = 1895890945;
pub const MIXERCONTROL_CONTROLTYPE_MONO: i32 = 536936451;
pub const MIXERCONTROL_CONTROLTYPE_MULTIPLESELECT: i32 = 1895890944;
pub const MIXERCONTROL_CONTROLTYPE_MUTE: i32 = 536936450;
pub const MIXERCONTROL_CONTROLTYPE_MUX: i32 = 1879113729;
pub const MIXERCONTROL_CONTROLTYPE_ONOFF: i32 = 536936449;
pub const MIXERCONTROL_CONTROLTYPE_PAN: i32 = 1073872897;
pub const MIXERCONTROL_CONTROLTYPE_PEAKMETER: i32 = 268566529;
pub const MIXERCONTROL_CONTROLTYPE_PERCENT: i32 = 805634048;
pub const MIXERCONTROL_CONTROLTYPE_QSOUNDPAN: i32 = 1073872898;
pub const MIXERCONTROL_CONTROLTYPE_SIGNED: i32 = 805437440;
pub const MIXERCONTROL_CONTROLTYPE_SIGNEDMETER: i32 = 268566528;
pub const MIXERCONTROL_CONTROLTYPE_SINGLESELECT: i32 = 1879113728;
pub const MIXERCONTROL_CONTROLTYPE_SLIDER: i32 = 1073872896;
pub const MIXERCONTROL_CONTROLTYPE_STEREOENH: i32 = 536936453;
pub const MIXERCONTROL_CONTROLTYPE_TREBLE: i32 = 1342373891;
pub const MIXERCONTROL_CONTROLTYPE_UNSIGNED: i32 = 805502976;
pub const MIXERCONTROL_CONTROLTYPE_UNSIGNEDMETER: i32 = 268632064;
pub const MIXERCONTROL_CONTROLTYPE_VOLUME: i32 = 1342373889;
...
pub const MIXERLINE_COMPONENTTYPE_DST_DIGITAL: i32 = 1;
pub const MIXERLINE_COMPONENTTYPE_DST_FIRST: i32 = 0;
pub const MIXERLINE_COMPONENTTYPE_DST_HEADPHONES: i32 = 5;
pub const MIXERLINE_COMPONENTTYPE_DST_LAST: i32 = 8;
pub const MIXERLINE_COMPONENTTYPE_DST_LINE: i32 = 2;
pub const MIXERLINE_COMPONENTTYPE_DST_MONITOR: i32 = 3;
pub const MIXERLINE_COMPONENTTYPE_DST_SPEAKERS: i32 = 4;
pub const MIXERLINE_COMPONENTTYPE_DST_TELEPHONE: i32 = 6;
pub const MIXERLINE_COMPONENTTYPE_DST_UNDEFINED: i32 = 0;
pub const MIXERLINE_COMPONENTTYPE_DST_VOICEIN: i32 = 8;
pub const MIXERLINE_COMPONENTTYPE_DST_WAVEIN: i32 = 7;
pub const MIXERLINE_COMPONENTTYPE_SRC_ANALOG: i32 = 4106;
pub const MIXERLINE_COMPONENTTYPE_SRC_AUXILIARY: i32 = 4105;
pub const MIXERLINE_COMPONENTTYPE_SRC_COMPACTDISC: i32 = 4101;
pub const MIXERLINE_COMPONENTTYPE_SRC_DIGITAL: i32 = 4097;
pub const MIXERLINE_COMPONENTTYPE_SRC_FIRST: i32 = 4096;
pub const MIXERLINE_COMPONENTTYPE_SRC_LAST: i32 = 4106;
pub const MIXERLINE_COMPONENTTYPE_SRC_LINE: i32 = 4098;
pub const MIXERLINE_COMPONENTTYPE_SRC_MICROPHONE: i32 = 4099;
pub const MIXERLINE_COMPONENTTYPE_SRC_PCSPEAKER: i32 = 4103;
pub const MIXERLINE_COMPONENTTYPE_SRC_SYNTHESIZER: i32 = 4100;
pub const MIXERLINE_COMPONENTTYPE_SRC_TELEPHONE: i32 = 4102;
pub const MIXERLINE_COMPONENTTYPE_SRC_UNDEFINED: i32 = 4096;
pub const MIXERLINE_COMPONENTTYPE_SRC_WAVEOUT: i32 = 4104;
...
pub const MIXERLINE_TARGETTYPE_AUX: i32 = 5;
pub const MIXERLINE_TARGETTYPE_MIDIIN: i32 = 4;
pub const MIXERLINE_TARGETTYPE_MIDIOUT: i32 = 3;
pub const MIXERLINE_TARGETTYPE_UNDEFINED: i32 = 0;
pub const MIXERLINE_TARGETTYPE_WAVEIN: i32 = 2;
pub const MIXERLINE_TARGETTYPE_WAVEOUT: i32 = 1;
pub const MIXERR_INVALCONTROL: i32 = 1025;
pub const MIXERR_INVALLINE: i32 = 1024;
pub const MIXERR_INVALVALUE: i32 = 1026;
pub const MIXERR_LASTERROR: i32 = 1026;
...
pub const MIXER_LONG_NAME_CHARS: i32 = 64;
...
pub const MIXER_SHORT_NAME_CHARS: i32 = 16;
pub const MOD_FMSYNTH: i32 = 4;
pub const MOD_MAPPER: i32 = 5;
pub const MOD_MIDIPORT: i32 = 1;
pub const MOD_SQSYNTH: i32 = 3;
pub const MOD_SWSYNTH: i32 = 7;
pub const MOD_SYNTH: i32 = 2;
pub const MOD_WAVETABLE: i32 = 6;
pub const MOM_CLOSE: i32 = 968;
pub const MOM_DONE: i32 = 969;
pub const MOM_OPEN: i32 = 967;
pub const MOM_POSITIONCB: i32 = 970;
#[cfg(feature = "mmsyscom")]
...
pub const WAVECAPS_SAMPLEACCURATE: i32 = 32;
pub const WAVECAPS_SYNC: i32 = 16;
pub const WAVECAPS_VOLUME: i32 = 4;
#[repr(C, packed(1))]
#[derive(Clone, Copy, Default)]
...
pub const WAVERR_BADFORMAT: i32 = 32;
pub const WAVERR_LASTERROR: i32 = 35;
pub const WAVERR_STILLPLAYING: i32 = 33;
pub const WAVERR_SYNC: i32 = 35;
pub const WAVERR_UNPREPARED: i32 = 34;
pub const WAVE_ALLOWSYNC: i32 = 2;
pub const WAVE_FORMAT_1M08: i32 = 1;
pub const WAVE_FORMAT_1M16: i32 = 4;
pub const WAVE_FORMAT_1S08: i32 = 2;
pub const WAVE_FORMAT_1S16: i32 = 8;
pub const WAVE_FORMAT_2M08: i32 = 16;
pub const WAVE_FORMAT_2M16: i32 = 64;
pub const WAVE_FORMAT_2S08: i32 = 32;
pub const WAVE_FORMAT_2S16: i32 = 128;
pub const WAVE_FORMAT_44M08: i32 = 256;
pub const WAVE_FORMAT_44M16: i32 = 1024;
pub const WAVE_FORMAT_44S08: i32 = 512;
pub const WAVE_FORMAT_44S16: i32 = 2048;
pub const WAVE_FORMAT_48M08: i32 = 4096;
pub const WAVE_FORMAT_48M16: i32 = 16384;
pub const WAVE_FORMAT_48S08: i32 = 8192;
pub const WAVE_FORMAT_48S16: i32 = 32768;
pub const WAVE_FORMAT_4M08: i32 = 256;
pub const WAVE_FORMAT_4M16: i32 = 1024;
pub const WAVE_FORMAT_4S08: i32 = 512;
pub const WAVE_FORMAT_4S16: i32 = 2048;
pub const WAVE_FORMAT_96M08: i32 = 65536;
pub const WAVE_FORMAT_96M16: i32 = 262144;
pub const WAVE_FORMAT_96S08: i32 = 131072;
pub const WAVE_FORMAT_96S16: i32 = 524288;
pub const WAVE_FORMAT_DIRECT: i32 = 8;
pub const WAVE_FORMAT_DIRECT_QUERY: i32 = 9;
pub const WAVE_FORMAT_PCM: i32 = 1;
pub const WAVE_FORMAT_QUERY: i32 = 1;
pub const WAVE_INVALIDFORMAT: i32 = 0;
pub const WAVE_MAPPED: i32 = 4;
pub const WAVE_MAPPED_DEFAULT_COMMUNICATION_DEVICE: i32 = 16;
pub const WAVE_MAPPER: u32 = 4294967295;
pub const WHDR_BEGINLOOP: i32 = 4;
pub const WHDR_DONE: i32 = 1;
pub const WHDR_ENDLOOP: i32 = 8;
pub const WHDR_INQUEUE: i32 = 16;
pub const WHDR_PREPARED: i32 = 2;
pub const WIM_CLOSE: i32 = 959;
pub const WIM_DATA: i32 = 960;
pub const WIM_OPEN: i32 = 958;
pub const WOM_CLOSE: i32 = 956;
pub const WOM_DONE: i32 = 957;
pub const WOM_OPEN: i32 = 955;
