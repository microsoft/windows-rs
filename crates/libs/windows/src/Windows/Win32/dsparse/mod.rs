...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn DsGetRdnW(ppdn: *mut super::LPCWCH, pcdn: *mut u32, ppkey: *mut super::LPCWCH, pckey: *mut u32, ppval: *mut super::LPCWCH, pcval: *mut u32) -> u32 {
    windows_core::link!("ntdsapi.dll" "system" fn DsGetRdnW(ppdn : *mut super::LPCWCH, pcdn : *mut u32, ppkey : *mut super::LPCWCH, pckey : *mut u32, ppval : *mut super::LPCWCH, pcval : *mut u32) -> u32);
