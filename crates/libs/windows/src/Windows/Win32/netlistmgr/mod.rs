...
#[cfg(feature = "oaidl")]
windows_core::imp::interface_hierarchy!(IEnumNetworkConnections, windows_core::IUnknown, super::IDispatch);
#[cfg(feature = "oaidl")]
impl IEnumNetworkConnections {
    pub unsafe fn _NewEnum(&self) -> windows_core::Result<super::IEnumVARIANT> {
        unsafe {
...
#[cfg(feature = "oaidl")]
windows_core::imp::interface_hierarchy!(IEnumNetworks, windows_core::IUnknown, super::IDispatch);
#[cfg(feature = "oaidl")]
impl IEnumNetworks {
    pub unsafe fn _NewEnum(&self) -> windows_core::Result<super::IEnumVARIANT> {
        unsafe {
...
#[cfg(feature = "oaidl")]
windows_core::imp::interface_hierarchy!(INetwork, windows_core::IUnknown, super::IDispatch);
#[cfg(feature = "oaidl")]
impl INetwork {
    ...
    pub unsafe fn GetNetworkConnections(&self) -> windows_core::Result<IEnumNetworkConnections> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNetworkConnections)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    ...
    #[cfg(feature = "wtypes")]
    pub unsafe fn IsConnectedToInternet(&self) -> windows_core::Result<super::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "wtypes")]
    pub unsafe fn IsConnected(&self) -> windows_core::Result<super::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub struct INetwork_Vtbl {
    ...
    #[cfg(feature = "wtypes")]
    pub IsConnectedToInternet: unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::VARIANT_BOOL) -> windows_core::HRESULT,
    #[cfg(not(feature = "wtypes"))]
    IsConnectedToInternet: usize,
    #[cfg(feature = "wtypes")]
    pub IsConnected: unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::VARIANT_BOOL) -> windows_core::HRESULT,
    #[cfg(not(feature = "wtypes"))]
    IsConnected: usize,
...
pub trait INetwork_Impl: super::IDispatch_Impl {
    ...
    fn IsConnected(&self) -> windows_core::Result<super::VARIANT_BOOL>;
...
impl INetwork_Vtbl {
    pub const fn new<Identity: INetwork_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn IsConnectedToInternet<Identity: INetwork_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pbisconnected: *mut super::VARIANT_BOOL) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsConnected<Identity: INetwork_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pbisconnected: *mut super::VARIANT_BOOL) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
#[cfg(feature = "oaidl")]
windows_core::imp::interface_hierarchy!(INetwork2, windows_core::IUnknown, super::IDispatch, INetwork);
#[cfg(feature = "oaidl")]
impl INetwork2 {
...
#[cfg(feature = "oaidl")]
windows_core::imp::interface_hierarchy!(INetworkConnection, windows_core::IUnknown, super::IDispatch);
#[cfg(feature = "oaidl")]
impl INetworkConnection {
    pub unsafe fn GetNetwork(&self) -> windows_core::Result<INetwork> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNetwork)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    #[cfg(feature = "wtypes")]
    pub unsafe fn IsConnectedToInternet(&self) -> windows_core::Result<super::VARIANT_BOOL> {
...
impl INetworkConnection_Vtbl {
    pub const fn new<Identity: INetworkConnection_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn IsConnectedToInternet<Identity: INetworkConnection_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pbisconnected: *mut super::VARIANT_BOOL) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsConnected<Identity: INetworkConnection_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pbisconnected: *mut super::VARIANT_BOOL) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
#[cfg(feature = "oaidl")]
windows_core::imp::interface_hierarchy!(INetworkConnection2, windows_core::IUnknown, super::IDispatch, INetworkConnection);
#[cfg(feature = "oaidl")]
...
impl INetworkCostManager {
    ...
    #[cfg(feature = "wtypes")]
    pub unsafe fn SetDestinationAddresses(&self, length: u32, pdestipaddrlist: *const NLM_SOCKADDR, bappend: super::VARIANT_BOOL) -> windows_core::HRESULT {
...
pub struct INetworkCostManager_Vtbl {
    ...
    GetDataPlanStatus: usize,
    #[cfg(feature = "wtypes")]
    pub SetDestinationAddresses: unsafe extern "system" fn(*mut core::ffi::c_void, u32, *const NLM_SOCKADDR, super::VARIANT_BOOL) -> windows_core::HRESULT,
    #[cfg(not(feature = "wtypes"))]
...
pub trait INetworkCostManager_Impl: windows_core::IUnknownImpl {
    ...
    fn SetDestinationAddresses(&self, length: u32, pdestipaddrlist: *const NLM_SOCKADDR, bappend: super::VARIANT_BOOL) -> windows_core::Result<()>;
}
#[cfg(all(feature = "minwindef", feature = "wtypes"))]
impl INetworkCostManager_Vtbl {
    pub const fn new<Identity: INetworkCostManager_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn SetDestinationAddresses<Identity: INetworkCostManager_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, length: u32, pdestipaddrlist: *const NLM_SOCKADDR, bappend: super::VARIANT_BOOL) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
#[cfg(feature = "oaidl")]
windows_core::imp::interface_hierarchy!(INetworkListManager, windows_core::IUnknown, super::IDispatch);
#[cfg(feature = "oaidl")]
impl INetworkListManager {
    pub unsafe fn GetNetworks(&self, flags: NLM_ENUM_NETWORK) -> windows_core::Result<IEnumNetworks> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNetworks)(windows_core::Interface::as_raw(self), flags, &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn GetNetwork(&self, gdnetworkid: windows_core::GUID) -> windows_core::Result<INetwork> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNetwork)(windows_core::Interface::as_raw(self), gdnetworkid, &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub unsafe fn GetNetworkConnections(&self) -> windows_core::Result<IEnumNetworkConnections> {
        unsafe {
    ...
    pub unsafe fn GetNetworkConnection(&self, gdnetworkconnectionid: windows_core::GUID) -> windows_core::Result<INetworkConnection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNetworkConnection)(windows_core::Interface::as_raw(self), gdnetworkconnectionid, &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    #[cfg(feature = "wtypes")]
    pub unsafe fn IsConnectedToInternet(&self) -> windows_core::Result<super::VARIANT_BOOL> {
...
impl INetworkListManager_Vtbl {
    pub const fn new<Identity: INetworkListManager_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn IsConnectedToInternet<Identity: INetworkListManager_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pbisconnected: *mut super::VARIANT_BOOL) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsConnected<Identity: INetworkListManager_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pbisconnected: *mut super::VARIANT_BOOL) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub const NLM_MAX_ADDRESS_LIST_SIZE: i32 = 10;
