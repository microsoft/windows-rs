#[inline]
pub unsafe fn DRMAcquireAdvisories(hlicensestorage: u32, wszlicense: windows_core::PCWSTR, wszurl: Option<windows_core::PCWSTR>, pvcontext: *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { DRMAcquireAdvisories(hlicensestorage, core::mem::transmute(wszlicense), wszurl.unwrap_or(core::mem::zeroed()) as _, pvcontext as _).ok() }
}
#[inline]
pub unsafe fn DRMAcquireIssuanceLicenseTemplate(hclient: u32, uflags: u32, pvreserved: *mut core::ffi::c_void, pwsztemplateids: Option<&[windows_core::PCWSTR]>, wszurl: windows_core::PCWSTR, pvcontext: *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { DRMAcquireIssuanceLicenseTemplate(hclient, uflags, pvreserved as _, pwsztemplateids.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), core::mem::transmute(pwsztemplateids.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), core::mem::transmute(wszurl), pvcontext as _).ok() }
}
#[inline]
pub unsafe fn DRMAcquireLicense(hsession: u32, uflags: u32, wszgroupidentitycredential: Option<windows_core::PCWSTR>, wszrequestedrights: Option<windows_core::PCWSTR>, wszcustomdata: Option<windows_core::PCWSTR>, wszurl: Option<windows_core::PCWSTR>, pvcontext: *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { DRMAcquireLicense(hsession, uflags, wszgroupidentitycredential.unwrap_or(core::mem::zeroed()) as _, wszrequestedrights.unwrap_or(core::mem::zeroed()) as _, wszcustomdata.unwrap_or(core::mem::zeroed()) as _, wszurl.unwrap_or(core::mem::zeroed()) as _, pvcontext as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn DRMAddLicense(hlicensestorage: u32, uflags: u32, wszlicense: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { DRMAddLicense(hlicensestorage, uflags, core::mem::transmute(wszlicense)).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn DRMAttest(henablingprincipal: u32, wszdata: windows_core::PCWSTR, etype: DRMATTESTTYPE, pcattestedblob: *mut u32, wszattestedblob: windows_core::PWSTR) -> windows_core::Result<()> {
    ...
    unsafe { DRMAttest(henablingprincipal, core::mem::transmute(wszdata), etype, pcattestedblob as _, core::mem::transmute(wszattestedblob)).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn DRMCreateBoundLicense(henv: u32, pparams: *mut DRMBOUNDLICENSEPARAMS, wszlicensechain: windows_core::PCWSTR, phboundlicense: *mut u32, pherrorlog: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMCreateBoundLicense(henv, pparams as _, core::mem::transmute(wszlicensechain), phboundlicense as _, pherrorlog as _).ok() }
}
#[inline]
pub unsafe fn DRMCreateClientSession(pfncallback: DRMCALLBACK, ucallbackversion: u32, wszgroupidprovidertype: windows_core::PCWSTR, wszgroupid: Option<windows_core::PCWSTR>, phclient: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMCreateClientSession(pfncallback, ucallbackversion, core::mem::transmute(wszgroupidprovidertype), wszgroupid.unwrap_or(core::mem::zeroed()) as _, phclient as _).ok() }
}
#[inline]
pub unsafe fn DRMCreateEnablingBitsDecryptor(hboundlicense: u32, wszright: Option<windows_core::PCWSTR>, hauxlib: u32, wszauxplug: Option<windows_core::PCWSTR>, phdecryptor: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMCreateEnablingBitsDecryptor(hboundlicense, wszright.unwrap_or(core::mem::zeroed()) as _, hauxlib, wszauxplug.unwrap_or(core::mem::zeroed()) as _, phdecryptor as _).ok() }
}
#[inline]
pub unsafe fn DRMCreateEnablingBitsEncryptor(hboundlicense: u32, wszright: Option<windows_core::PCWSTR>, hauxlib: u32, wszauxplug: Option<windows_core::PCWSTR>, phencryptor: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMCreateEnablingBitsEncryptor(hboundlicense, wszright.unwrap_or(core::mem::zeroed()) as _, hauxlib, wszauxplug.unwrap_or(core::mem::zeroed()) as _, phencryptor as _).ok() }
}
#[inline]
pub unsafe fn DRMCreateEnablingPrincipal(henv: u32, hlibrary: u32, wszobject: windows_core::PCWSTR, pidprincipal: *mut DRMID, wszcredentials: windows_core::PCWSTR, phenablingprincipal: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMCreateEnablingPrincipal(henv, hlibrary, core::mem::transmute(wszobject), pidprincipal as _, core::mem::transmute(wszcredentials), phenablingprincipal as _).ok() }
}
#[inline]
pub unsafe fn DRMCreateIssuanceLicense(psttimefrom: *mut super::super::Foundation::SYSTEMTIME, psttimeuntil: *mut super::super::Foundation::SYSTEMTIME, wszreferralinfoname: Option<windows_core::PCWSTR>, wszreferralinfourl: Option<windows_core::PCWSTR>, howner: u32, wszissuancelicense: Option<windows_core::PCWSTR>, hboundlicense: u32, phissuancelicense: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMCreateIssuanceLicense(psttimefrom as _, psttimeuntil as _, wszreferralinfoname.unwrap_or(core::mem::zeroed()) as _, wszreferralinfourl.unwrap_or(core::mem::zeroed()) as _, howner, wszissuancelicense.unwrap_or(core::mem::zeroed()) as _, hboundlicense, phissuancelicense as _).ok() }
}
#[inline]
pub unsafe fn DRMCreateLicenseStorageSession(henv: u32, hdefaultlibrary: u32, hclient: u32, uflags: u32, wszissuancelicense: windows_core::PCWSTR, phlicensestorage: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMCreateLicenseStorageSession(henv, hdefaultlibrary, hclient, uflags, core::mem::transmute(wszissuancelicense), phlicensestorage as _).ok() }
}
#[inline]
pub unsafe fn DRMCreateRight(wszrightname: windows_core::PCWSTR, pstfrom: *mut super::super::Foundation::SYSTEMTIME, pstuntil: *mut super::super::Foundation::SYSTEMTIME, cextendedinfo: u32, pwszextendedinfoname: Option<*const windows_core::PCWSTR>, pwszextendedinfovalue: Option<*const windows_core::PCWSTR>, phright: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMCreateRight(core::mem::transmute(wszrightname), pstfrom as _, pstuntil as _, cextendedinfo, pwszextendedinfoname.unwrap_or(core::mem::zeroed()) as _, pwszextendedinfovalue.unwrap_or(core::mem::zeroed()) as _, phright as _).ok() }
}
#[inline]
pub unsafe fn DRMCreateUser(wszusername: Option<windows_core::PCWSTR>, wszuserid: Option<windows_core::PCWSTR>, wszuseridtype: Option<windows_core::PCWSTR>, phuser: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMCreateUser(wszusername.unwrap_or(core::mem::zeroed()) as _, wszuserid.unwrap_or(core::mem::zeroed()) as _, wszuseridtype.unwrap_or(core::mem::zeroed()) as _, phuser as _).ok() }
}
#[inline]
pub unsafe fn DRMDecode(wszalgid: windows_core::PCWSTR, wszencodedstring: windows_core::PCWSTR, pudecodeddatalen: *mut u32, pbdecodeddata: *mut u8) -> windows_core::Result<()> {
    ...
    unsafe { DRMDecode(core::mem::transmute(wszalgid), core::mem::transmute(wszencodedstring), pudecodeddatalen as _, pbdecodeddata as _).ok() }
}
#[inline]
pub unsafe fn DRMDeconstructCertificateChain(wszchain: windows_core::PCWSTR, iwhich: u32, pccert: *mut u32, wszcert: Option<windows_core::PWSTR>) -> windows_core::Result<()> {
    ...
    unsafe { DRMDeconstructCertificateChain(core::mem::transmute(wszchain), iwhich, pccert as _, wszcert.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn DRMDeleteLicense(hsession: u32, wszlicenseid: windows_core::PCWSTR) -> windows_core::Result<()> {
    ...
    unsafe { DRMDeleteLicense(hsession, core::mem::transmute(wszlicenseid)).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn DRMEncode(wszalgid: windows_core::PCWSTR, udatalen: u32, pbdecodeddata: *mut u8, puencodedstringlen: *mut u32, wszencodedstring: Option<windows_core::PWSTR>) -> windows_core::Result<()> {
    ...
    unsafe { DRMEncode(core::mem::transmute(wszalgid), udatalen, pbdecodeddata as _, puencodedstringlen as _, wszencodedstring.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn DRMGetBoundLicenseAttribute(hqueryroot: u32, wszattribute: windows_core::PCWSTR, iwhich: u32, peencoding: *mut DRMENCODINGTYPE, pcbuffer: *mut u32, pbbuffer: *mut u8) -> windows_core::Result<()> {
    ...
    unsafe { DRMGetBoundLicenseAttribute(hqueryroot, core::mem::transmute(wszattribute), iwhich, peencoding as _, pcbuffer as _, pbbuffer as _).ok() }
}
#[inline]
pub unsafe fn DRMGetBoundLicenseAttributeCount(hqueryroot: u32, wszattribute: windows_core::PCWSTR, pcattributes: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMGetBoundLicenseAttributeCount(hqueryroot, core::mem::transmute(wszattribute), pcattributes as _).ok() }
}
#[inline]
pub unsafe fn DRMGetBoundLicenseObject(hqueryroot: u32, wszsubobjecttype: windows_core::PCWSTR, iwhich: u32, phsubobject: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMGetBoundLicenseObject(hqueryroot, core::mem::transmute(wszsubobjecttype), iwhich, phsubobject as _).ok() }
}
#[inline]
pub unsafe fn DRMGetBoundLicenseObjectCount(hqueryroot: u32, wszsubobjecttype: windows_core::PCWSTR, pcsubobjects: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMGetBoundLicenseObjectCount(hqueryroot, core::mem::transmute(wszsubobjecttype), pcsubobjects as _).ok() }
}
#[inline]
pub unsafe fn DRMGetCertificateChainCount(wszchain: windows_core::PCWSTR, pccertcount: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMGetCertificateChainCount(core::mem::transmute(wszchain), pccertcount as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn DRMGetEnvironmentInfo(handle: u32, wszattribute: Option<windows_core::PCWSTR>, peencoding: *mut DRMENCODINGTYPE, pcbuffer: *mut u32, pbbuffer: *mut u8) -> windows_core::Result<()> {
    ...
    unsafe { DRMGetEnvironmentInfo(handle, wszattribute.unwrap_or(core::mem::zeroed()) as _, peencoding as _, pcbuffer as _, pbbuffer as _).ok() }
}
#[inline]
pub unsafe fn DRMGetInfo(handle: u32, wszattribute: windows_core::PCWSTR, peencoding: *const DRMENCODINGTYPE, pcbuffer: *mut u32, pbbuffer: *mut u8) -> windows_core::Result<()> {
    ...
    unsafe { DRMGetInfo(handle, core::mem::transmute(wszattribute), peencoding, pcbuffer as _, pbbuffer as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn DRMGetProcAddress(hlibrary: u32, wszprocname: windows_core::PCWSTR, ppfnprocaddress: *mut super::super::Foundation::FARPROC) -> windows_core::Result<()> {
    ...
    unsafe { DRMGetProcAddress(hlibrary, core::mem::transmute(wszprocname), ppfnprocaddress as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn DRMGetServiceLocation(hclient: u32, uservicetype: u32, uservicelocation: u32, wszissuancelicense: Option<windows_core::PCWSTR>, puserviceurllength: *mut u32, wszserviceurl: Option<windows_core::PWSTR>) -> windows_core::Result<()> {
    ...
    unsafe { DRMGetServiceLocation(hclient, uservicetype, uservicelocation, wszissuancelicense.unwrap_or(core::mem::zeroed()) as _, puserviceurllength as _, wszserviceurl.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn DRMGetSignedIssuanceLicense(henv: u32, hissuancelicense: u32, uflags: u32, pbsymkey: *mut u8, cbsymkey: u32, wszsymkeytype: Option<windows_core::PCWSTR>, wszclientlicensorcertificate: Option<windows_core::PCWSTR>, pfncallback: DRMCALLBACK, wszurl: Option<windows_core::PCWSTR>, pvcontext: *mut core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { DRMGetSignedIssuanceLicense(henv, hissuancelicense, uflags, pbsymkey as _, cbsymkey, wszsymkeytype.unwrap_or(core::mem::zeroed()) as _, wszclientlicensorcertificate.unwrap_or(core::mem::zeroed()) as _, pfncallback, wszurl.unwrap_or(core::mem::zeroed()) as _, pvcontext as _).ok() }
}
#[inline]
pub unsafe fn DRMGetSignedIssuanceLicenseEx(henv: u32, hissuancelicense: u32, uflags: u32, pbsymkey: Option<&[u8]>, wszsymkeytype: Option<windows_core::PCWSTR>, pvreserved: Option<*const core::ffi::c_void>, henablingprincipal: u32, hboundlicenseclc: u32, pfncallback: DRMCALLBACK, pvcontext: *const core::ffi::c_void) -> windows_core::Result<()> {
    ...
    unsafe { DRMGetSignedIssuanceLicenseEx(henv, hissuancelicense, uflags, core::mem::transmute(pbsymkey.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pbsymkey.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), wszsymkeytype.unwrap_or(core::mem::zeroed()) as _, pvreserved.unwrap_or(core::mem::zeroed()) as _, henablingprincipal, hboundlicenseclc, pfncallback, pvcontext).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn DRMGetUnboundLicenseAttribute(hqueryroot: u32, wszattributetype: windows_core::PCWSTR, iwhich: u32, peencoding: *mut DRMENCODINGTYPE, pcbuffer: *mut u32, pbbuffer: *mut u8) -> windows_core::Result<()> {
    ...
    unsafe { DRMGetUnboundLicenseAttribute(hqueryroot, core::mem::transmute(wszattributetype), iwhich, peencoding as _, pcbuffer as _, pbbuffer as _).ok() }
}
#[inline]
pub unsafe fn DRMGetUnboundLicenseAttributeCount(hqueryroot: u32, wszattributetype: windows_core::PCWSTR, pcattributes: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMGetUnboundLicenseAttributeCount(hqueryroot, core::mem::transmute(wszattributetype), pcattributes as _).ok() }
}
#[inline]
pub unsafe fn DRMGetUnboundLicenseObject(hqueryroot: u32, wszsubobjecttype: windows_core::PCWSTR, iindex: u32, phsubquery: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMGetUnboundLicenseObject(hqueryroot, core::mem::transmute(wszsubobjecttype), iindex, phsubquery as _).ok() }
}
#[inline]
pub unsafe fn DRMGetUnboundLicenseObjectCount(hqueryroot: u32, wszsubobjecttype: windows_core::PCWSTR, pcsubobjects: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMGetUnboundLicenseObjectCount(hqueryroot, core::mem::transmute(wszsubobjecttype), pcsubobjects as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn DRMInitEnvironment(esecurityprovidertype: DRMSECURITYPROVIDERTYPE, especification: DRMSPECTYPE, wszsecurityprovider: Option<windows_core::PCWSTR>, wszmanifestcredentials: Option<windows_core::PCWSTR>, wszmachinecredentials: windows_core::PCWSTR, phenv: *mut u32, phdefaultlibrary: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMInitEnvironment(esecurityprovidertype, especification, wszsecurityprovider.unwrap_or(core::mem::zeroed()) as _, wszmanifestcredentials.unwrap_or(core::mem::zeroed()) as _, core::mem::transmute(wszmachinecredentials), phenv as _, phdefaultlibrary as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn DRMLoadLibrary(henv: u32, especification: DRMSPECTYPE, wszlibraryprovider: windows_core::PCWSTR, wszcredentials: Option<windows_core::PCWSTR>, phlibrary: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMLoadLibrary(henv, especification, core::mem::transmute(wszlibraryprovider), wszcredentials.unwrap_or(core::mem::zeroed()) as _, phlibrary as _).ok() }
}
#[inline]
pub unsafe fn DRMParseUnboundLicense(wszcertificate: windows_core::PCWSTR, phqueryroot: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMParseUnboundLicense(core::mem::transmute(wszcertificate), phqueryroot as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn DRMRegisterRevocationList(henv: u32, wszrevocationlist: Option<windows_core::PCWSTR>) -> windows_core::Result<()> {
    ...
    unsafe { DRMRegisterRevocationList(henv, wszrevocationlist.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn DRMSetApplicationSpecificData(hissuancelicense: u32, fdelete: bool, wszname: Option<windows_core::PCWSTR>, wszvalue: Option<windows_core::PCWSTR>) -> windows_core::Result<()> {
    ...
    unsafe { DRMSetApplicationSpecificData(hissuancelicense, fdelete.into(), wszname.unwrap_or(core::mem::zeroed()) as _, wszvalue.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
...
#[inline]
pub unsafe fn DRMSetMetaData(hissuancelicense: u32, wszcontentid: windows_core::PCWSTR, wszcontentidtype: windows_core::PCWSTR, wszskuid: Option<windows_core::PCWSTR>, wszskuidtype: Option<windows_core::PCWSTR>, wszcontenttype: Option<windows_core::PCWSTR>, wszcontentname: Option<windows_core::PCWSTR>) -> windows_core::Result<()> {
    ...
    unsafe { DRMSetMetaData(hissuancelicense, core::mem::transmute(wszcontentid), core::mem::transmute(wszcontentidtype), wszskuid.unwrap_or(core::mem::zeroed()) as _, wszskuidtype.unwrap_or(core::mem::zeroed()) as _, wszcontenttype.unwrap_or(core::mem::zeroed()) as _, wszcontentname.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn DRMSetNameAndDescription(hissuancelicense: u32, fdelete: bool, lcid: u32, wszname: Option<windows_core::PCWSTR>, wszdescription: Option<windows_core::PCWSTR>) -> windows_core::Result<()> {
    ...
    unsafe { DRMSetNameAndDescription(hissuancelicense, fdelete.into(), lcid, wszname.unwrap_or(core::mem::zeroed()) as _, wszdescription.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn DRMSetRevocationPoint(hissuancelicense: u32, fdelete: bool, wszid: windows_core::PCWSTR, wszidtype: windows_core::PCWSTR, wszurl: windows_core::PCWSTR, pstfrequency: *mut super::super::Foundation::SYSTEMTIME, wszname: Option<windows_core::PCWSTR>, wszpublickey: Option<windows_core::PCWSTR>) -> windows_core::Result<()> {
    ...
    unsafe { DRMSetRevocationPoint(hissuancelicense, fdelete.into(), core::mem::transmute(wszid), core::mem::transmute(wszidtype), core::mem::transmute(wszurl), pstfrequency as _, wszname.unwrap_or(core::mem::zeroed()) as _, wszpublickey.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
pub unsafe fn DRMSetUsagePolicy(hissuancelicense: u32, eusagepolicytype: DRM_USAGEPOLICY_TYPE, fdelete: bool, fexclusion: bool, wszname: Option<windows_core::PCWSTR>, wszminversion: Option<windows_core::PCWSTR>, wszmaxversion: Option<windows_core::PCWSTR>, wszpublickey: Option<windows_core::PCWSTR>, wszdigestalgorithm: Option<windows_core::PCWSTR>, pbdigest: *mut u8, cbdigest: u32) -> windows_core::Result<()> {
    ...
    unsafe { DRMSetUsagePolicy(hissuancelicense, eusagepolicytype, fdelete.into(), fexclusion.into(), wszname.unwrap_or(core::mem::zeroed()) as _, wszminversion.unwrap_or(core::mem::zeroed()) as _, wszmaxversion.unwrap_or(core::mem::zeroed()) as _, wszpublickey.unwrap_or(core::mem::zeroed()) as _, wszdigestalgorithm.unwrap_or(core::mem::zeroed()) as _, pbdigest as _, cbdigest).ok() }
}
#[inline]
pub unsafe fn DRMVerify(wszdata: Option<windows_core::PCWSTR>, pcattesteddata: *mut u32, wszattesteddata: Option<windows_core::PWSTR>, petype: *mut DRMATTESTTYPE, pcprincipal: *mut u32, wszprincipal: Option<windows_core::PWSTR>, pcmanifest: *mut u32, wszmanifest: Option<windows_core::PWSTR>) -> windows_core::Result<()> {
    ...
    unsafe { DRMVerify(wszdata.unwrap_or(core::mem::zeroed()) as _, pcattesteddata as _, wszattesteddata.unwrap_or(core::mem::zeroed()) as _, petype as _, pcprincipal as _, wszprincipal.unwrap_or(core::mem::zeroed()) as _, pcmanifest as _, wszmanifest.unwrap_or(core::mem::zeroed()) as _).ok() }
}
