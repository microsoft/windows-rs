    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMAcquireAdvisories(hlicensestorage, core::mem::transmute_copy(&wszlicense.param().borrow()), core::mem::transmute_copy(&wszurl.param().borrow()), pvcontext as _).ok() }
}
#[inline]
    ...
    P5: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMAcquireIssuanceLicenseTemplate(hclient, uflags, pvreserved as _, pwsztemplateids.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), core::mem::transmute(pwsztemplateids.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), core::mem::transmute_copy(&wszurl.param().borrow()), pvcontext as _).ok() }
}
#[inline]
    ...
    P5: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMAcquireLicense(hsession, uflags, core::mem::transmute_copy(&wszgroupidentitycredential.param().borrow()), core::mem::transmute_copy(&wszrequestedrights.param().borrow()), core::mem::transmute_copy(&wszcustomdata.param().borrow()), core::mem::transmute_copy(&wszurl.param().borrow()), pvcontext as _).ok() }
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMAddLicense(hlicensestorage, uflags, core::mem::transmute_copy(&wszlicense.param().borrow())).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMAttest(henablingprincipal, core::mem::transmute_copy(&wszdata.param().borrow()), etype, pcattestedblob as _, core::mem::transmute(wszattestedblob)).ok() }
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMCreateBoundLicense(henv, pparams as _, core::mem::transmute_copy(&wszlicensechain.param().borrow()), phboundlicense as _, pherrorlog as _).ok() }
}
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMCreateClientSession(pfncallback, ucallbackversion, core::mem::transmute_copy(&wszgroupidprovidertype.param().borrow()), core::mem::transmute_copy(&wszgroupid.param().borrow()), phclient as _).ok() }
}
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMCreateEnablingBitsDecryptor(hboundlicense, core::mem::transmute_copy(&wszright.param().borrow()), hauxlib, core::mem::transmute_copy(&wszauxplug.param().borrow()), phdecryptor as _).ok() }
}
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMCreateEnablingBitsEncryptor(hboundlicense, core::mem::transmute_copy(&wszright.param().borrow()), hauxlib, core::mem::transmute_copy(&wszauxplug.param().borrow()), phencryptor as _).ok() }
}
#[inline]
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMCreateEnablingPrincipal(henv, hlibrary, core::mem::transmute_copy(&wszobject.param().borrow()), pidprincipal as _, core::mem::transmute_copy(&wszcredentials.param().borrow()), phenablingprincipal as _).ok() }
}
#[inline]
    ...
    P5: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMCreateIssuanceLicense(psttimefrom as _, psttimeuntil as _, core::mem::transmute_copy(&wszreferralinfoname.param().borrow()), core::mem::transmute_copy(&wszreferralinfourl.param().borrow()), howner, core::mem::transmute_copy(&wszissuancelicense.param().borrow()), hboundlicense, phissuancelicense as _).ok() }
}
#[inline]
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMCreateLicenseStorageSession(henv, hdefaultlibrary, hclient, uflags, core::mem::transmute_copy(&wszissuancelicense.param().borrow()), phlicensestorage as _).ok() }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMCreateRight(core::mem::transmute_copy(&wszrightname.param().borrow()), pstfrom as _, pstuntil as _, cextendedinfo, pwszextendedinfoname.unwrap_or(core::mem::zeroed()) as _, pwszextendedinfovalue.unwrap_or(core::mem::zeroed()) as _, phright as _).ok() }
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMCreateUser(core::mem::transmute_copy(&wszusername.param().borrow()), core::mem::transmute_copy(&wszuserid.param().borrow()), core::mem::transmute_copy(&wszuseridtype.param().borrow()), phuser as _).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMDecode(core::mem::transmute_copy(&wszalgid.param().borrow()), core::mem::transmute_copy(&wszencodedstring.param().borrow()), pudecodeddatalen as _, pbdecodeddata as _).ok() }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMDeconstructCertificateChain(core::mem::transmute_copy(&wszchain.param().borrow()), iwhich, pccert as _, wszcert.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMDeleteLicense(hsession, core::mem::transmute_copy(&wszlicenseid.param().borrow())).ok() }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMEncode(core::mem::transmute_copy(&wszalgid.param().borrow()), udatalen, pbdecodeddata as _, puencodedstringlen as _, wszencodedstring.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMGetBoundLicenseAttribute(hqueryroot, core::mem::transmute_copy(&wszattribute.param().borrow()), iwhich, peencoding as _, pcbuffer as _, pbbuffer as _).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMGetBoundLicenseAttributeCount(hqueryroot, core::mem::transmute_copy(&wszattribute.param().borrow()), pcattributes as _).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMGetBoundLicenseObject(hqueryroot, core::mem::transmute_copy(&wszsubobjecttype.param().borrow()), iwhich, phsubobject as _).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMGetBoundLicenseObjectCount(hqueryroot, core::mem::transmute_copy(&wszsubobjecttype.param().borrow()), pcsubobjects as _).ok() }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMGetCertificateChainCount(core::mem::transmute_copy(&wszchain.param().borrow()), pccertcount as _).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMGetEnvironmentInfo(handle, core::mem::transmute_copy(&wszattribute.param().borrow()), peencoding as _, pcbuffer as _, pbbuffer as _).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMGetInfo(handle, core::mem::transmute_copy(&wszattribute.param().borrow()), peencoding, pcbuffer as _, pbbuffer as _).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMGetProcAddress(hlibrary, core::mem::transmute_copy(&wszprocname.param().borrow()), ppfnprocaddress as _).ok() }
}
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMGetServiceLocation(hclient, uservicetype, uservicelocation, core::mem::transmute_copy(&wszissuancelicense.param().borrow()), puserviceurllength as _, wszserviceurl.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
    ...
    P8: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMGetSignedIssuanceLicense(henv, hissuancelicense, uflags, pbsymkey as _, cbsymkey, core::mem::transmute_copy(&wszsymkeytype.param().borrow()), core::mem::transmute_copy(&wszclientlicensorcertificate.param().borrow()), pfncallback, core::mem::transmute_copy(&wszurl.param().borrow()), pvcontext as _).ok() }
}
#[inline]
    ...
    P5: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMGetSignedIssuanceLicenseEx(henv, hissuancelicense, uflags, core::mem::transmute(pbsymkey.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), pbsymkey.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), core::mem::transmute_copy(&wszsymkeytype.param().borrow()), pvreserved.unwrap_or(core::mem::zeroed()) as _, henablingprincipal, hboundlicenseclc, pfncallback, pvcontext).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMGetUnboundLicenseAttribute(hqueryroot, core::mem::transmute_copy(&wszattributetype.param().borrow()), iwhich, peencoding as _, pcbuffer as _, pbbuffer as _).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMGetUnboundLicenseAttributeCount(hqueryroot, core::mem::transmute_copy(&wszattributetype.param().borrow()), pcattributes as _).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMGetUnboundLicenseObject(hqueryroot, core::mem::transmute_copy(&wszsubobjecttype.param().borrow()), iindex, phsubquery as _).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMGetUnboundLicenseObjectCount(hqueryroot, core::mem::transmute_copy(&wszsubobjecttype.param().borrow()), pcsubobjects as _).ok() }
}
#[inline]
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMInitEnvironment(esecurityprovidertype, especification, core::mem::transmute_copy(&wszsecurityprovider.param().borrow()), core::mem::transmute_copy(&wszmanifestcredentials.param().borrow()), core::mem::transmute_copy(&wszmachinecredentials.param().borrow()), phenv as _, phdefaultlibrary as _).ok() }
}
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMLoadLibrary(henv, especification, core::mem::transmute_copy(&wszlibraryprovider.param().borrow()), core::mem::transmute_copy(&wszcredentials.param().borrow()), phlibrary as _).ok() }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMParseUnboundLicense(core::mem::transmute_copy(&wszcertificate.param().borrow()), phqueryroot as _).ok() }
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMRegisterRevocationList(henv, core::mem::transmute_copy(&wszrevocationlist.param().borrow())).ok() }
}
#[inline]
    ...
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMSetApplicationSpecificData(hissuancelicense, fdelete.into(), core::mem::transmute_copy(&wszname.param().borrow()), core::mem::transmute_copy(&wszvalue.param().borrow())).ok() }
}
#[inline]
    ...
    P6: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMSetMetaData(hissuancelicense, core::mem::transmute_copy(&wszcontentid.param().borrow()), core::mem::transmute_copy(&wszcontentidtype.param().borrow()), core::mem::transmute_copy(&wszskuid.param().borrow()), core::mem::transmute_copy(&wszskuidtype.param().borrow()), core::mem::transmute_copy(&wszcontenttype.param().borrow()), core::mem::transmute_copy(&wszcontentname.param().borrow())).ok() }
}
#[inline]
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMSetNameAndDescription(hissuancelicense, fdelete.into(), lcid, core::mem::transmute_copy(&wszname.param().borrow()), core::mem::transmute_copy(&wszdescription.param().borrow())).ok() }
}
#[inline]
    ...
    P7: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMSetRevocationPoint(hissuancelicense, fdelete.into(), core::mem::transmute_copy(&wszid.param().borrow()), core::mem::transmute_copy(&wszidtype.param().borrow()), core::mem::transmute_copy(&wszurl.param().borrow()), pstfrequency as _, core::mem::transmute_copy(&wszname.param().borrow()), core::mem::transmute_copy(&wszpublickey.param().borrow())).ok() }
}
#[inline]
    ...
    P8: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMSetUsagePolicy(hissuancelicense, eusagepolicytype, fdelete.into(), fexclusion.into(), core::mem::transmute_copy(&wszname.param().borrow()), core::mem::transmute_copy(&wszminversion.param().borrow()), core::mem::transmute_copy(&wszmaxversion.param().borrow()), core::mem::transmute_copy(&wszpublickey.param().borrow()), core::mem::transmute_copy(&wszdigestalgorithm.param().borrow()), pbdigest as _, cbdigest).ok() }
}
#[inline]
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { DRMVerify(core::mem::transmute_copy(&wszdata.param().borrow()), pcattesteddata as _, wszattesteddata.unwrap_or(core::mem::zeroed()) as _, petype as _, pcprincipal as _, wszprincipal.unwrap_or(core::mem::zeroed()) as _, pcmanifest as _, wszmanifest.unwrap_or(core::mem::zeroed()) as _).ok() }
}
