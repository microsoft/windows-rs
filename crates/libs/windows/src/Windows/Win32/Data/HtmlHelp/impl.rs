...
impl IITDatabaseVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IITDatabaseImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IITDatabaseVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, Open::<Impl, IMPL_OFFSET>, Close::<Impl, IMPL_OFFSET>, CreateObject::<Impl, IMPL_OFFSET>, GetObject::<Impl, IMPL_OFFSET>, GetObjectPersistence::<Impl, IMPL_OFFSET>)
    }
...
impl IITPropListVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IITPropListImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IITPropListVtbl {
        ...
        Self(
            ...
            SetPersist::<Impl, IMPL_OFFSET>,
            SetPersist::<Impl, IMPL_OFFSET>,
            GetFirst::<Impl, IMPL_OFFSET>,
            GetNext::<Impl, IMPL_OFFSET>,
            GetPropCount::<Impl, IMPL_OFFSET>,
            SaveHeader::<Impl, IMPL_OFFSET>,
            SaveData::<Impl, IMPL_OFFSET>,
            GetHeaderSize::<Impl, IMPL_OFFSET>,
            GetDataSize::<Impl, IMPL_OFFSET>,
            SaveDataToStream::<Impl, IMPL_OFFSET>,
            LoadFromMem::<Impl, IMPL_OFFSET>,
            SaveToMem::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IITResultSetVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IITResultSetImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IITResultSetVtbl {
        ...
        Self(
            ...
            ::windows::core::AddRef::<Identity, BASE_OFFSET>,
            ::windows::core::Release::<Identity, BASE_OFFSET>,
            SetColumnPriority::<Impl, IMPL_OFFSET>,
            SetColumnHeap::<Impl, IMPL_OFFSET>,
            SetKeyProp::<Impl, IMPL_OFFSET>,
            Add::<Impl, IMPL_OFFSET>,
            Add::<Impl, IMPL_OFFSET>,
            Add::<Impl, IMPL_OFFSET>,
            Add::<Impl, IMPL_OFFSET>,
            ...
            AppendRows::<Impl, IMPL_OFFSET>,
            Get::<Impl, IMPL_OFFSET>,
            GetKeyProp::<Impl, IMPL_OFFSET>,
            GetColumnPriority::<Impl, IMPL_OFFSET>,
            GetRowCount::<Impl, IMPL_OFFSET>,
            GetColumnCount::<Impl, IMPL_OFFSET>,
            GetColumn::<Impl, IMPL_OFFSET>,
            GetColumn::<Impl, IMPL_OFFSET>,
            GetColumnFromPropID::<Impl, IMPL_OFFSET>,
            Clear::<Impl, IMPL_OFFSET>,
            ClearRows::<Impl, IMPL_OFFSET>,
            Free::<Impl, IMPL_OFFSET>,
            IsCompleted::<Impl, IMPL_OFFSET>,
            Cancel::<Impl, IMPL_OFFSET>,
            Pause::<Impl, IMPL_OFFSET>,
            GetRowStatus::<Impl, IMPL_OFFSET>,
            GetColumnStatus::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IITWordWheelVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IITWordWheelImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IITWordWheelVtbl {
        ...
        Self(
            ...
            GetLocaleInfo::<Impl, IMPL_OFFSET>,
            GetSorterInstance::<Impl, IMPL_OFFSET>,
            Count::<Impl, IMPL_OFFSET>,
            Lookup::<Impl, IMPL_OFFSET>,
            Lookup::<Impl, IMPL_OFFSET>,
            Lookup::<Impl, IMPL_OFFSET>,
            SetGroup::<Impl, IMPL_OFFSET>,
            GetGroup::<Impl, IMPL_OFFSET>,
            GetDataCount::<Impl, IMPL_OFFSET>,
            GetData::<Impl, IMPL_OFFSET>,
            GetDataColumns::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IStemSinkVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IStemSinkImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IStemSinkVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, PutAltWord::<Impl, IMPL_OFFSET>, PutWord::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IStemmerConfigVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IStemmerConfigImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IStemmerConfigVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, SetLocaleInfo::<Impl, IMPL_OFFSET>, GetLocaleInfo::<Impl, IMPL_OFFSET>, SetControlInfo::<Impl, IMPL_OFFSET>, GetControlInfo::<Impl, IMPL_OFFSET>, LoadExternalStemmerData::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IWordBreakerConfigVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IWordBreakerConfigImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IWordBreakerConfigVtbl {
        ...
        Self(
            ...
            ::windows::core::AddRef::<Identity, BASE_OFFSET>,
            ::windows::core::Release::<Identity, BASE_OFFSET>,
            SetLocaleInfo::<Impl, IMPL_OFFSET>,
            GetLocaleInfo::<Impl, IMPL_OFFSET>,
            SetBreakWordType::<Impl, IMPL_OFFSET>,
            GetBreakWordType::<Impl, IMPL_OFFSET>,
            SetControlInfo::<Impl, IMPL_OFFSET>,
            GetControlInfo::<Impl, IMPL_OFFSET>,
            LoadExternalBreakerData::<Impl, IMPL_OFFSET>,
            SetWordStemmer::<Impl, IMPL_OFFSET>,
            GetWordStemmer::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
