...
pub const E_ALL_WILD: windows_core::HRESULT = 0x80001055_u32 as _;
pub const E_ALREADYINIT: windows_core::HRESULT = 0x80001083_u32 as _;
pub const E_ALREADYOPEN: windows_core::HRESULT = 0x80001013_u32 as _;
pub const E_ASSERT: windows_core::HRESULT = 0x80001006_u32 as _;
pub const E_BADBREAKER: windows_core::HRESULT = 0x80001053_u32 as _;
pub const E_BADFILE: windows_core::HRESULT = 0x80001003_u32 as _;
pub const E_BADFILTERSIZE: windows_core::HRESULT = 0x80001018_u32 as _;
pub const E_BADFORMAT: windows_core::HRESULT = 0x80001004_u32 as _;
pub const E_BADINDEXFLAGS: windows_core::HRESULT = 0x80001060_u32 as _;
pub const E_BADPARAM: windows_core::HRESULT = 0x80001011_u32 as _;
pub const E_BADRANGEOP: windows_core::HRESULT = 0x8000105D_u32 as _;
pub const E_BADVALUE: windows_core::HRESULT = 0x80001054_u32 as _;
pub const E_BADVERSION: windows_core::HRESULT = 0x80001002_u32 as _;
pub const E_CANTFINDDLL: windows_core::HRESULT = 0x8000100E_u32 as _;
pub const E_DISKFULL: windows_core::HRESULT = 0x80001038_u32 as _;
pub const E_DUPLICATE: windows_core::HRESULT = 0x80001001_u32 as _;
pub const E_EXPECTEDTERM: windows_core::HRESULT = 0x80001057_u32 as _;
pub const E_FILECLOSE: windows_core::HRESULT = 0x80001031_u32 as _;
pub const E_FILECREATE: windows_core::HRESULT = 0x80001030_u32 as _;
pub const E_FILEDELETE: windows_core::HRESULT = 0x80001035_u32 as _;
pub const E_FILEINVALID: windows_core::HRESULT = 0x80001036_u32 as _;
pub const E_FILENOTFOUND: windows_core::HRESULT = 0x80001037_u32 as _;
pub const E_FILEREAD: windows_core::HRESULT = 0x80001032_u32 as _;
pub const E_FILESEEK: windows_core::HRESULT = 0x80001033_u32 as _;
pub const E_FILEWRITE: windows_core::HRESULT = 0x80001034_u32 as _;
pub const E_GETLASTERROR: windows_core::HRESULT = 0x80001010_u32 as _;
pub const E_GROUPIDTOOBIG: windows_core::HRESULT = 0x8000100A_u32 as _;
pub const E_INTERRUPT: windows_core::HRESULT = 0x80001007_u32 as _;
pub const E_INVALIDSTATE: windows_core::HRESULT = 0x80001012_u32 as _;
pub const E_MISSINGPROP: windows_core::HRESULT = 0x80001080_u32 as _;
pub const E_MISSLPAREN: windows_core::HRESULT = 0x80001058_u32 as _;
pub const E_MISSQUOTE: windows_core::HRESULT = 0x8000105A_u32 as _;
pub const E_MISSRPAREN: windows_core::HRESULT = 0x80001059_u32 as _;
pub const E_NAMETOOLONG: windows_core::HRESULT = 0x80001020_u32 as _;
pub const E_NOHANDLE: windows_core::HRESULT = 0x8000100F_u32 as _;
pub const E_NOKEYPROP: windows_core::HRESULT = 0x80001087_u32 as _;
pub const E_NOMERGEDDATA: windows_core::HRESULT = 0x8000100C_u32 as _;
pub const E_NOPERMISSION: windows_core::HRESULT = 0x80001005_u32 as _;
pub const E_NOSTEMMER: windows_core::HRESULT = 0x80001062_u32 as _;
pub const E_NOTEXIST: windows_core::HRESULT = 0x80001000_u32 as _;
pub const E_NOTFOUND: windows_core::HRESULT = 0x8000100D_u32 as _;
pub const E_NOTINIT: windows_core::HRESULT = 0x80001084_u32 as _;
pub const E_NOTOPEN: windows_core::HRESULT = 0x80001013_u32 as _;
pub const E_NOTSUPPORTED: windows_core::HRESULT = 0x80001008_u32 as _;
pub const E_NULLQUERY: windows_core::HRESULT = 0x8000105B_u32 as _;
pub const E_OUTOFRANGE: windows_core::HRESULT = 0x80001009_u32 as _;
pub const E_PROPLISTEMPTY: windows_core::HRESULT = 0x80001082_u32 as _;
pub const E_PROPLISTNOTEMPTY: windows_core::HRESULT = 0x80001081_u32 as _;
pub const E_RESULTSETEMPTY: windows_core::HRESULT = 0x80001085_u32 as _;
pub const E_STOPWORD: windows_core::HRESULT = 0x8000105C_u32 as _;
pub const E_TOODEEP: windows_core::HRESULT = 0x80001056_u32 as _;
pub const E_TOOMANYCOLUMNS: windows_core::HRESULT = 0x80001086_u32 as _;
pub const E_TOOMANYDUPS: windows_core::HRESULT = 0x80001051_u32 as _;
pub const E_TOOMANYOBJECTS: windows_core::HRESULT = 0x80001019_u32 as _;
pub const E_TOOMANYTITLES: windows_core::HRESULT = 0x8000100B_u32 as _;
pub const E_TOOMANYTOPICS: windows_core::HRESULT = 0x80001050_u32 as _;
pub const E_TREETOOBIG: windows_core::HRESULT = 0x80001052_u32 as _;
pub const E_UNKNOWN_TRANSPORT: windows_core::HRESULT = 0x80001016_u32 as _;
pub const E_UNMATCHEDTYPE: windows_core::HRESULT = 0x8000105E_u32 as _;
pub const E_UNSUPPORTED_TRANSPORT: windows_core::HRESULT = 0x80001017_u32 as _;
pub const E_WILD_IN_DTYPE: windows_core::HRESULT = 0x80001061_u32 as _;
pub const E_WORDTOOLONG: windows_core::HRESULT = 0x8000105F_u32 as _;
