...
impl IXmlReaderVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IXmlReaderImpl, const OFFSET: isize>() -> IXmlReaderVtbl {
...
impl IXmlResolverVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IXmlResolverImpl, const OFFSET: isize>() -> IXmlResolverVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IXmlResolver>, ::windows::core::GetTrustLevel, ResolveUri::<Impl, OFFSET>)
    }
}
...
impl IXmlWriterVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IXmlWriterImpl, const OFFSET: isize>() -> IXmlWriterVtbl {
...
impl IXmlWriterLiteVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IXmlWriterLiteImpl, const OFFSET: isize>() -> IXmlWriterLiteVtbl {
