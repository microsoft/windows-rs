...
impl IServerXMLHTTPRequest {
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn setOption<P1>(&self, option: SERVERXMLHTTP_OPTION, value: P1) -> windows_core::Result<()>
    where
        P1: windows_core::Param<super::super::super::System::Variant::VARIANT>,
    {
...
impl IServerXMLHTTPRequest2 {
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn setProxy<P1, P2>(&self, proxysetting: SXH_PROXY_SETTING, varproxyserver: P1, varbypasslist: P2) -> windows_core::Result<()>
    where
        P1: windows_core::Param<super::super::super::System::Variant::VARIANT>,
...
impl IXMLHTTPRequest {
    ...
    where
        ...
        P1: windows_core::Param<windows_core::BSTR>,
        P2: windows_core::Param<super::super::super::System::Variant::VARIANT>,
        P3: windows_core::Param<super::super::super::System::Variant::VARIANT>,
        P4: windows_core::Param<super::super::super::System::Variant::VARIANT>,
    {
...
impl IXTLRuntime {
    ...
    {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).formatDate)(windows_core::Interface::as_raw(self), vardate.param().abi(), bstrformat.param().abi(), vardestlocale.param().abi(), &mut result__).map(|| core::mem::transmute(result__))
    }
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    ...
    {
        let mut result__ = core::mem::zeroed();
        (windows_core::Interface::vtable(self).formatTime)(windows_core::Interface::as_raw(self), vartime.param().abi(), bstrformat.param().abi(), vardestlocale.param().abi(), &mut result__).map(|| core::mem::transmute(result__))
    }
}
#[cfg(feature = "Win32_System_Com")]
#[repr(C)]
