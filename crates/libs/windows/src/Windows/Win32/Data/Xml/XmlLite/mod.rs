...
impl IXmlReader {
    ...
    pub unsafe fn ReadValueChunk(&self, pwchbuffer: &mut [u16], pcwchread: *mut u32) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).ReadValueChunk)(::core::mem::transmute_copy(self), ::core::mem::transmute(pwchbuffer.as_mut_ptr()), pwchbuffer.len() as _, ::core::mem::transmute(pcwchread)).ok()
    }
    #[doc = "*Required features: 'Win32_Data_Xml_XmlLite'*"]
...
impl IXmlWriter {
    ...
    pub unsafe fn WriteChars(&self, pwch: &[u16]) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).WriteChars)(::core::mem::transmute_copy(self), ::core::mem::transmute(pwch.as_ptr()), pwch.len() as _).ok()
    }
    #[doc = "*Required features: 'Win32_Data_Xml_XmlLite'*"]
    ...
    pub unsafe fn WriteRawChars(&self, pwch: &[u16]) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).WriteRawChars)(::core::mem::transmute_copy(self), ::core::mem::transmute(pwch.as_ptr()), pwch.len() as _).ok()
    }
    #[doc = "*Required features: 'Win32_Data_Xml_XmlLite'*"]
...
impl IXmlWriterLite {
    ...
    pub unsafe fn WriteAttributeString(&self, pwszqname: &[u16], pwszvalue: &[u16]) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).WriteAttributeString)(::core::mem::transmute_copy(self), ::core::mem::transmute(pwszqname.as_ptr()), pwszqname.len() as _, ::core::mem::transmute(pwszvalue.as_ptr()), pwszvalue.len() as _).ok()
    }
    #[doc = "*Required features: 'Win32_Data_Xml_XmlLite'*"]
    pub unsafe fn WriteCData<'a, Param0: ::windows::core::IntoParam<'a, ::windows::core::PCWSTR>>(&self, pwsztext: Param0) -> ::windows::core::Result<()> {
        (::windows::core::Interface::vtable(self).WriteCData)(::core::mem::transmute_copy(self), pwsztext.into_param().abi()).ok()
