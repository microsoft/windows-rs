...
{
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagGetColorEffect ( hwnd : super::super::Foundation:: HWND , peffect : *mut MAGCOLOREFFECT ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn MagGetFullscreenColorEffect(peffect: *mut MAGCOLOREFFECT) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagGetFullscreenColorEffect ( peffect : *mut MAGCOLOREFFECT ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn MagGetFullscreenTransform(pmaglevel: *mut f32, pxoffset: *mut i32, pyoffset: *mut i32) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagGetFullscreenTransform ( pmaglevel : *mut f32 , pxoffset : *mut i32 , pyoffset : *mut i32 ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagGetImageScalingCallback ( hwnd : super::super::Foundation:: HWND ) -> MagImageScalingCallback );
...
pub unsafe fn MagGetInputTransform(pfenabled: *mut super::super::Foundation::BOOL, prectsource: *mut super::super::Foundation::RECT, prectdest: *mut super::super::Foundation::RECT) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagGetInputTransform ( pfenabled : *mut super::super::Foundation:: BOOL , prectsource : *mut super::super::Foundation:: RECT , prectdest : *mut super::super::Foundation:: RECT ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagGetWindowFilterList ( hwnd : super::super::Foundation:: HWND , pdwfiltermode : *mut MW_FILTERMODE , count : i32 , phwnd : *mut super::super::Foundation:: HWND ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagGetWindowSource ( hwnd : super::super::Foundation:: HWND , prect : *mut super::super::Foundation:: RECT ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagGetWindowTransform ( hwnd : super::super::Foundation:: HWND , ptransform : *mut MAGTRANSFORM ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn MagInitialize() -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagInitialize ( ) -> super::super::Foundation:: BOOL );
    MagInitialize()
}
#[doc = "*Required features: `\"Win32_UI_Magnification\"`, `\"Win32_Foundation\"`*"]
#[cfg(feature = "Win32_Foundation")]
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagSetColorEffect ( hwnd : super::super::Foundation:: HWND , peffect : *mut MAGCOLOREFFECT ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn MagSetFullscreenColorEffect(peffect: *const MAGCOLOREFFECT) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagSetFullscreenColorEffect ( peffect : *const MAGCOLOREFFECT ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn MagSetFullscreenTransform(maglevel: f32, xoffset: i32, yoffset: i32) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagSetFullscreenTransform ( maglevel : f32 , xoffset : i32 , yoffset : i32 ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagSetImageScalingCallback ( hwnd : super::super::Foundation:: HWND , callback : * mut::core::ffi::c_void ) -> super::super::Foundation:: BOOL );
...
{
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagSetInputTransform ( fenabled : super::super::Foundation:: BOOL , prectsource : *const super::super::Foundation:: RECT , prectdest : *const super::super::Foundation:: RECT ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagSetWindowFilterList ( hwnd : super::super::Foundation:: HWND , dwfiltermode : MW_FILTERMODE , count : i32 , phwnd : *mut super::super::Foundation:: HWND ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagSetWindowSource ( hwnd : super::super::Foundation:: HWND , rect : super::super::Foundation:: RECT ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HWND>,
{
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagSetWindowTransform ( hwnd : super::super::Foundation:: HWND , ptransform : *mut MAGTRANSFORM ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<super::super::Foundation::BOOL>,
{
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagShowSystemCursor ( fshowcursor : super::super::Foundation:: BOOL ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn MagUninitialize() -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "magnification.dll" ,"system" fn MagUninitialize ( ) -> super::super::Foundation:: BOOL );
    MagUninitialize()
}
