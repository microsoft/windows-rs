...
pub const STRSAFE_E_END_OF_FILE: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80070026u32 as _);
pub const STRSAFE_E_INSUFFICIENT_BUFFER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x8007007Au32 as _);
pub const STRSAFE_E_INVALID_PARAMETER: ::windows_core::HRESULT = ::windows_core::HRESULT(0x80070057u32 as _);
