...
impl IUIApplication {
    pub unsafe fn OnViewChanged<P2>(&self, viewid: u32, typeid: UI_VIEWTYPE, view: P2, verb: UI_VIEWVERB, ureasoncode: i32) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn OnCreateUICommand(&self, commandid: u32, typeid: UI_COMMANDTYPE) -> Result<IUICommandHandler, windows_result::HRESULT> {
        unsafe {
    ...
    pub unsafe fn OnDestroyUICommand<P2>(&self, commandid: u32, typeid: UI_COMMANDTYPE, commandhandler: P2) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IUIApplication_Impl: windows_core::IUnknownImpl {
    fn OnViewChanged(&self, viewid: u32, typeid: UI_VIEWTYPE, view: windows_core::Ref<'_, windows_core::IUnknown>, verb: UI_VIEWVERB, ureasoncode: i32) -> Result<(), windows_result::HRESULT>;
    fn OnCreateUICommand(&self, commandid: u32, typeid: UI_COMMANDTYPE) -> Result<IUICommandHandler, windows_result::HRESULT>;
    fn OnDestroyUICommand(&self, commandid: u32, typeid: UI_COMMANDTYPE, commandhandler: windows_core::Ref<'_, IUICommandHandler>) -> Result<(), windows_result::HRESULT>;
}
...
impl IUICollection {
    ...
    pub unsafe fn GetItem(&self, index: u32) -> Result<windows_core::IUnknown, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUICollection_Impl: windows_core::IUnknownImpl {
    ...
    fn GetItem(&self, index: u32) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
    fn Add(&self, item: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn Insert(&self, index: u32, item: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn RemoveAt(&self, index: u32) -> Result<(), windows_result::HRESULT>;
    fn Replace(&self, indexreplaced: u32, itemreplacewith: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
...
impl IUICollectionChangedEvent {
    pub unsafe fn OnChanged<P2, P4>(&self, action: UI_COLLECTIONCHANGE, oldindex: u32, olditem: P2, newindex: u32, newitem: P4) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<windows_core::IUnknown>,
...
pub trait IUICollectionChangedEvent_Impl: windows_core::IUnknownImpl {
    fn OnChanged(&self, action: UI_COLLECTIONCHANGE, oldindex: u32, olditem: windows_core::Ref<'_, windows_core::IUnknown>, newindex: u32, newitem: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
}
...
impl IUICommandHandler {
    ...
    pub unsafe fn Execute<P4>(&self, commandid: u32, verb: UI_EXECUTIONVERB, key: Option<*const super::super::Foundation::PROPERTYKEY>, currentvalue: Option<*const super::super::System::Com::StructuredStorage::PROPVARIANT>, commandexecutionproperties: P4) -> Result<(), windows_result::HRESULT>
    where
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn UpdateProperty(&self, commandid: u32, key: *const super::super::Foundation::PROPERTYKEY, currentvalue: Option<*const super::super::System::Com::StructuredStorage::PROPVARIANT>) -> Result<super::super::System::Com::StructuredStorage::PROPVARIANT, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUICommandHandler_Impl: windows_core::IUnknownImpl {
    fn Execute(&self, commandid: u32, verb: UI_EXECUTIONVERB, key: *const super::super::Foundation::PROPERTYKEY, currentvalue: *const super::super::System::Com::StructuredStorage::PROPVARIANT, commandexecutionproperties: windows_core::Ref<'_, IUISimplePropertySet>) -> Result<(), windows_result::HRESULT>;
    fn UpdateProperty(&self, commandid: u32, key: *const super::super::Foundation::PROPERTYKEY, currentvalue: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<super::super::System::Com::StructuredStorage::PROPVARIANT, windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl IUIContextualUI {
    pub unsafe fn ShowAtLocation(&self, x: i32, y: i32) -> Result<(), windows_result::HRESULT> {
...
pub trait IUIContextualUI_Impl: windows_core::IUnknownImpl {
    fn ShowAtLocation(&self, x: i32, y: i32) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIEventingManager {
    pub unsafe fn SetEventLogger<P0>(&self, eventlogger: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IUIEventingManager_Impl: windows_core::IUnknownImpl {
    fn SetEventLogger(&self, eventlogger: windows_core::Ref<'_, IUIEventLogger>) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIFramework {
    pub unsafe fn Initialize<P1>(&self, framewnd: super::super::Foundation::HWND, application: P1) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn LoadUI<P1>(&self, instance: super::super::Foundation::HINSTANCE, resourcename: P1) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn GetView(&self, viewid: u32, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetView)(windows_core::Interface::as_raw(self), viewid, riid, ppv as _).ok() }
    }
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn GetUICommandProperty(&self, commandid: u32, key: *const super::super::Foundation::PROPERTYKEY) -> Result<super::super::System::Com::StructuredStorage::PROPVARIANT, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn SetUICommandProperty(&self, commandid: u32, key: *const super::super::Foundation::PROPERTYKEY, value: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn InvalidateUICommand(&self, commandid: u32, flags: UI_INVALIDATIONS, key: Option<*const super::super::Foundation::PROPERTYKEY>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn FlushPendingInvalidations(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).FlushPendingInvalidations)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn SetModes(&self, imodes: i32) -> Result<(), windows_result::HRESULT> {
...
pub trait IUIFramework_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, framewnd: super::super::Foundation::HWND, application: windows_core::Ref<'_, IUIApplication>) -> Result<(), windows_result::HRESULT>;
    fn Destroy(&self) -> Result<(), windows_result::HRESULT>;
    fn LoadUI(&self, instance: super::super::Foundation::HINSTANCE, resourcename: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetView(&self, viewid: u32, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn GetUICommandProperty(&self, commandid: u32, key: *const super::super::Foundation::PROPERTYKEY) -> Result<super::super::System::Com::StructuredStorage::PROPVARIANT, windows_result::HRESULT>;
    fn SetUICommandProperty(&self, commandid: u32, key: *const super::super::Foundation::PROPERTYKEY, value: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT>;
    fn InvalidateUICommand(&self, commandid: u32, flags: UI_INVALIDATIONS, key: *const super::super::Foundation::PROPERTYKEY) -> Result<(), windows_result::HRESULT>;
    fn FlushPendingInvalidations(&self) -> Result<(), windows_result::HRESULT>;
    fn SetModes(&self, imodes: i32) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl IUIImage {
    ...
    pub unsafe fn GetBitmap(&self) -> Result<super::super::Graphics::Gdi::HBITMAP, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUIImage_Impl: windows_core::IUnknownImpl {
    fn GetBitmap(&self) -> Result<super::super::Graphics::Gdi::HBITMAP, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Gdi")]
impl IUIImage_Vtbl {
...
impl IUIImageFromBitmap {
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub unsafe fn CreateImage(&self, bitmap: super::super::Graphics::Gdi::HBITMAP, options: UI_OWNERSHIP) -> Result<IUIImage, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUIImageFromBitmap_Impl: windows_core::IUnknownImpl {
    fn CreateImage(&self, bitmap: super::super::Graphics::Gdi::HBITMAP, options: UI_OWNERSHIP) -> Result<IUIImage, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_Gdi")]
...
impl IUIRibbon {
    pub unsafe fn GetHeight(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn LoadSettingsFromStream<P0>(&self, pstream: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn SaveSettingsToStream<P0>(&self, pstream: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::System::Com::IStream>,
    {
...
pub trait IUIRibbon_Impl: windows_core::IUnknownImpl {
    fn GetHeight(&self) -> Result<u32, windows_result::HRESULT>;
    fn LoadSettingsFromStream(&self, pstream: windows_core::Ref<'_, super::super::System::Com::IStream>) -> Result<(), windows_result::HRESULT>;
    fn SaveSettingsToStream(&self, pstream: windows_core::Ref<'_, super::super::System::Com::IStream>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com")]
impl IUIRibbon_Vtbl {
