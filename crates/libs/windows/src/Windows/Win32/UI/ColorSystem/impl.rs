...
impl IDeviceModelPlugInVtbl {
    pub const fn new<Impl: IDeviceModelPlugInImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> IDeviceModelPlugInVtbl {
        unsafe extern "system" fn Initialize<Impl: IDeviceModelPlugInImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, bstrxml: ::core::mem::ManuallyDrop<super::super::Foundation::BSTR>, cnummodels: u32, imodelposition: u32) -> ::windows::core::HRESULT {
        ...
        unsafe extern "system" fn GetNumChannels<Impl: IDeviceModelPlugInImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, pnumchannels: *mut u32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn DeviceToColorimetricColors<Impl: IDeviceModelPlugInImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, ccolors: u32, cchannels: u32, pdevicevalues: *const f32, pxyzcolors: *mut XYZColorF) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn ColorimetricToDeviceColors<Impl: IDeviceModelPlugInImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, ccolors: u32, cchannels: u32, pxyzcolors: *const XYZColorF, pdevicevalues: *mut f32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn ColorimetricToDeviceColorsWithBlack<Impl: IDeviceModelPlugInImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, ccolors: u32, cchannels: u32, pxyzcolors: *const XYZColorF, pblackinformation: *const BlackInformation, pdevicevalues: *mut f32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn SetTransformDeviceModelInfo<Impl: IDeviceModelPlugInImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, imodelposition: u32, pidevicemodelother: ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn GetPrimarySamples<Impl: IDeviceModelPlugInImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, pprimarycolor: *mut PrimaryXYZColors) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn GetGamutBoundaryMeshSize<Impl: IDeviceModelPlugInImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, pnumvertices: *mut u32, pnumtriangles: *mut u32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn GetGamutBoundaryMesh<Impl: IDeviceModelPlugInImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, cchannels: u32, cvertices: u32, ctriangles: u32, pvertices: *mut f32, ptriangles: *mut GamutShellTriangle) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn GetNeutralAxisSize<Impl: IDeviceModelPlugInImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, pccolors: *mut u32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn GetNeutralAxis<Impl: IDeviceModelPlugInImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, ccolors: u32, pxyzcolors: *mut XYZColorF) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
...
impl IGamutMapModelPlugInVtbl {
    pub const fn new<Impl: IGamutMapModelPlugInImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> IGamutMapModelPlugInVtbl {
        unsafe extern "system" fn Initialize<Impl: IGamutMapModelPlugInImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, bstrxml: ::core::mem::ManuallyDrop<super::super::Foundation::BSTR>, psrcplugin: ::windows::core::RawPtr, pdestplugin: ::windows::core::RawPtr, psrcgbd: *const GamutBoundaryDescription, pdestgbd: *const GamutBoundaryDescription) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn SourceToDestinationAppearanceColors<Impl: IGamutMapModelPlugInImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, ccolors: u32, pinputcolors: *const JChColorF, poutputcolors: *mut JChColorF) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<IGamutMapModelPlugIn>, base.5, Initialize::<Impl, OFFSET>, SourceToDestinationAppearanceColors::<Impl, OFFSET>)
    }
}
