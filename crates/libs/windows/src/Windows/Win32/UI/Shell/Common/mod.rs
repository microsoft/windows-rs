...
impl IObjectArray {
    ...
    pub unsafe fn GetAt<T>(&self, uiindex: u32) -> Result<T, windows_result::HRESULT>
    where
...
pub trait IObjectArray_Impl: windows_core::IUnknownImpl {
    ...
    fn GetAt(&self, uiindex: u32, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
}
...
impl IObjectCollection {
    pub unsafe fn AddObject<P0>(&self, punk: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe { (windows_core::Interface::vtable(self).AddObject)(windows_core::Interface::as_raw(self), punk.param().abi()).ok() }
    }
    pub unsafe fn AddFromArray<P0>(&self, poasource: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn RemoveObjectAt(&self, uiindex: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IObjectCollection_Impl: IObjectArray_Impl {
    fn AddObject(&self, punk: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn AddFromArray(&self, poasource: windows_core::Ref<'_, IObjectArray>) -> Result<(), windows_result::HRESULT>;
    fn RemoveObjectAt(&self, uiindex: u32) -> Result<(), windows_result::HRESULT>;
