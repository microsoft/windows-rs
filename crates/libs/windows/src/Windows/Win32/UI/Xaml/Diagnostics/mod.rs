...
{
    ::windows::core::windows_link ! ( "windows.ui.xaml.dll" ,"system" fn InitializeXamlDiagnostic ( endpointname : :: windows::core::PCWSTR , pid : u32 , wszdllxamldiagnostics : :: windows::core::PCWSTR , wsztapdllname : :: windows::core::PCWSTR , tapclsid : :: windows::core::GUID ) -> :: windows::core::HRESULT );
...
{
    ::windows::core::windows_link ! ( "windows.ui.xaml.dll" ,"system" fn InitializeXamlDiagnosticsEx ( endpointname : :: windows::core::PCWSTR , pid : u32 , wszdllxamldiagnostics : :: windows::core::PCWSTR , wsztapdllname : :: windows::core::PCWSTR , tapclsid : :: windows::core::GUID , wszinitializationdata : :: windows::core::PCWSTR ) -> :: windows::core::HRESULT );
...
impl IBitmapData {
    pub unsafe fn CopyBytesTo(&self, sourceoffsetinbytes: u32, pvbytes: &mut [u8], numberofbytescopied: *mut u32) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).CopyBytesTo)(::windows::core::Vtable::as_raw(self), sourceoffsetinbytes, pvbytes.len() as _, ::core::mem::transmute(pvbytes.as_ptr()), ::core::mem::transmute(numberofbytescopied)).ok()
    }
...
unsafe impl ::windows::core::Vtable for IBitmapData {
...
impl IVisualTreeService {
    ...
    {
        (::windows::core::Vtable::vtable(self).AdviseVisualTreeChange)(::windows::core::Vtable::as_raw(self), pcallback.into().abi()).ok()
    }
    pub unsafe fn UnadviseVisualTreeChange<'a, P0>(&self, pcallback: P0) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, IVisualTreeServiceCallback>>,
    {
        (::windows::core::Vtable::vtable(self).UnadviseVisualTreeChange)(::windows::core::Vtable::as_raw(self), pcallback.into().abi()).ok()
    }
    #[doc = "*Required features: `\"Win32_System_Com\"`*"]
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetEnums(&self, pcount: *mut u32, ppenums: *mut *mut EnumType) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).GetEnums)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(pcount), ::core::mem::transmute(ppenums)).ok()
    }
    ...
    pub unsafe fn GetPropertyValuesChain(&self, instancehandle: u64, psourcecount: *mut u32, pppropertysources: *mut *mut PropertyChainSource, ppropertycount: *mut u32, pppropertyvalues: *mut *mut PropertyChainValue) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).GetPropertyValuesChain)(::windows::core::Vtable::as_raw(self), instancehandle, ::core::mem::transmute(psourcecount), ::core::mem::transmute(pppropertysources), ::core::mem::transmute(ppropertycount), ::core::mem::transmute(pppropertyvalues)).ok()
    }
    pub unsafe fn SetProperty(&self, instancehandle: u64, value: u64, propertyindex: u32) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).SetProperty)(::windows::core::Vtable::as_raw(self), instancehandle, value, propertyindex).ok()
    }
    pub unsafe fn ClearProperty(&self, instancehandle: u64, propertyindex: u32) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).ClearProperty)(::windows::core::Vtable::as_raw(self), instancehandle, propertyindex).ok()
    }
    ...
    pub unsafe fn AddChild(&self, parent: u64, child: u64, index: u32) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).AddChild)(::windows::core::Vtable::as_raw(self), parent, child, index).ok()
    }
    pub unsafe fn RemoveChild(&self, parent: u64, index: u32) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).RemoveChild)(::windows::core::Vtable::as_raw(self), parent, index).ok()
    }
...
unsafe impl ::windows::core::Vtable for IVisualTreeService {
...
impl IVisualTreeService2 {
    ...
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, IVisualTreeServiceCallback>>,
    {
        (::windows::core::Vtable::vtable(self).base__.AdviseVisualTreeChange)(::windows::core::Vtable::as_raw(self), pcallback.into().abi()).ok()
    }
    pub unsafe fn UnadviseVisualTreeChange<'a, P0>(&self, pcallback: P0) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, IVisualTreeServiceCallback>>,
    {
        (::windows::core::Vtable::vtable(self).base__.UnadviseVisualTreeChange)(::windows::core::Vtable::as_raw(self), pcallback.into().abi()).ok()
    }
    #[doc = "*Required features: `\"Win32_System_Com\"`*"]
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetEnums(&self, pcount: *mut u32, ppenums: *mut *mut EnumType) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.GetEnums)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(pcount), ::core::mem::transmute(ppenums)).ok()
    }
    pub unsafe fn CreateInstance(&self, typename: &::windows::core::BSTR, value: &::windows::core::BSTR) -> ::windows::core::Result<u64> {
        let mut result__ = ::core::mem::MaybeUninit::zeroed();
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetPropertyValuesChain(&self, instancehandle: u64, psourcecount: *mut u32, pppropertysources: *mut *mut PropertyChainSource, ppropertycount: *mut u32, pppropertyvalues: *mut *mut PropertyChainValue) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.GetPropertyValuesChain)(::windows::core::Vtable::as_raw(self), instancehandle, ::core::mem::transmute(psourcecount), ::core::mem::transmute(pppropertysources), ::core::mem::transmute(ppropertycount), ::core::mem::transmute(pppropertyvalues)).ok()
    }
    pub unsafe fn SetProperty(&self, instancehandle: u64, value: u64, propertyindex: u32) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.SetProperty)(::windows::core::Vtable::as_raw(self), instancehandle, value, propertyindex).ok()
    }
    pub unsafe fn ClearProperty(&self, instancehandle: u64, propertyindex: u32) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.ClearProperty)(::windows::core::Vtable::as_raw(self), instancehandle, propertyindex).ok()
    }
    pub unsafe fn GetCollectionCount(&self, instancehandle: u64) -> ::windows::core::Result<u32> {
        let mut result__ = ::core::mem::MaybeUninit::zeroed();
    ...
    pub unsafe fn AddChild(&self, parent: u64, child: u64, index: u32) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.AddChild)(::windows::core::Vtable::as_raw(self), parent, child, index).ok()
    }
    pub unsafe fn RemoveChild(&self, parent: u64, index: u32) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.RemoveChild)(::windows::core::Vtable::as_raw(self), parent, index).ok()
    }
    pub unsafe fn ClearChildren(&self, parent: u64) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.ClearChildren)(::windows::core::Vtable::as_raw(self), parent).ok()
    }
...
unsafe impl ::windows::core::Vtable for IVisualTreeService2 {
...
impl IVisualTreeService3 {
    ...
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, IVisualTreeServiceCallback>>,
    {
        (::windows::core::Vtable::vtable(self).base__.base__.AdviseVisualTreeChange)(::windows::core::Vtable::as_raw(self), pcallback.into().abi()).ok()
    }
    pub unsafe fn UnadviseVisualTreeChange<'a, P0>(&self, pcallback: P0) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, IVisualTreeServiceCallback>>,
    {
        (::windows::core::Vtable::vtable(self).base__.base__.UnadviseVisualTreeChange)(::windows::core::Vtable::as_raw(self), pcallback.into().abi()).ok()
    }
    #[doc = "*Required features: `\"Win32_System_Com\"`*"]
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetEnums(&self, pcount: *mut u32, ppenums: *mut *mut EnumType) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.base__.GetEnums)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(pcount), ::core::mem::transmute(ppenums)).ok()
    }
    pub unsafe fn CreateInstance(&self, typename: &::windows::core::BSTR, value: &::windows::core::BSTR) -> ::windows::core::Result<u64> {
        let mut result__ = ::core::mem::MaybeUninit::zeroed();
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetPropertyValuesChain(&self, instancehandle: u64, psourcecount: *mut u32, pppropertysources: *mut *mut PropertyChainSource, ppropertycount: *mut u32, pppropertyvalues: *mut *mut PropertyChainValue) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.base__.GetPropertyValuesChain)(::windows::core::Vtable::as_raw(self), instancehandle, ::core::mem::transmute(psourcecount), ::core::mem::transmute(pppropertysources), ::core::mem::transmute(ppropertycount), ::core::mem::transmute(pppropertyvalues)).ok()
    }
    pub unsafe fn SetProperty(&self, instancehandle: u64, value: u64, propertyindex: u32) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.base__.SetProperty)(::windows::core::Vtable::as_raw(self), instancehandle, value, propertyindex).ok()
    }
    pub unsafe fn ClearProperty(&self, instancehandle: u64, propertyindex: u32) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.base__.ClearProperty)(::windows::core::Vtable::as_raw(self), instancehandle, propertyindex).ok()
    }
    pub unsafe fn GetCollectionCount(&self, instancehandle: u64) -> ::windows::core::Result<u32> {
        let mut result__ = ::core::mem::MaybeUninit::zeroed();
    ...
    pub unsafe fn AddChild(&self, parent: u64, child: u64, index: u32) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.base__.AddChild)(::windows::core::Vtable::as_raw(self), parent, child, index).ok()
    }
    pub unsafe fn RemoveChild(&self, parent: u64, index: u32) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.base__.RemoveChild)(::windows::core::Vtable::as_raw(self), parent, index).ok()
    }
    pub unsafe fn ClearChildren(&self, parent: u64) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).base__.base__.ClearChildren)(::windows::core::Vtable::as_raw(self), parent).ok()
    }
    pub unsafe fn GetPropertyIndex<'a, P0>(&self, object: u64, propertyname: P0) -> ::windows::core::Result<u32>
    where
        P0: ::std::convert::Into<::windows::core::PCWSTR>,
    ...
    where
        P0: ::std::convert::Into<::windows::core::PCWSTR>,
    {
        (::windows::core::Vtable::vtable(self).ResolveResource)(::windows::core::Vtable::as_raw(self), resourcecontext, resourcename.into(), resourcetype, propertyindex).ok()
    }
    #[doc = "*Required features: `\"Win32_Foundation\"`*"]
    #[cfg(feature = "Win32_Foundation")]
...
unsafe impl ::windows::core::Vtable for IVisualTreeService3 {
...
unsafe impl ::windows::core::Vtable for IVisualTreeServiceCallback {
...
impl IVisualTreeServiceCallback2 {
    ...
    where
        P0: ::std::convert::Into<::windows::core::InParam<'a, VisualElement>>,
    {
        (::windows::core::Vtable::vtable(self).base__.OnVisualTreeChange)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(relation), element.into().abi(), mutationtype).ok()
    }
...
unsafe impl ::windows::core::Vtable for IVisualTreeServiceCallback2 {
...
impl IXamlDiagnostics {
    ...
    pub unsafe fn HitTest(&self, rect: super::super::super::Foundation::RECT, pcount: *mut u32, ppinstancehandles: *mut *mut u64) -> ::windows::core::Result<()> {
        (::windows::core::Vtable::vtable(self).HitTest)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(rect), ::core::mem::transmute(pcount), ::core::mem::transmute(ppinstancehandles)).ok()
    }
...
unsafe impl ::windows::core::Vtable for IXamlDiagnostics {
...
pub struct IXamlDiagnostics_Vtbl {
    ...
    pub GetInitializationData: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pinitializationdata: *mut ::core::mem::ManuallyDrop<::windows::core::BSTR>) -> ::windows::core::HRESULT,
}
#[doc = "*Required features: `\"Win32_UI_Xaml_Diagnostics\"`*"]
...
pub struct CollectionElementValue {
    pub Index: u32,
    pub ValueType: ::windows::core::BSTR,
    pub Value: ::windows::core::BSTR,
...
pub struct PropertyChainSource {
    pub Handle: u64,
    pub TargetType: ::windows::core::BSTR,
    pub Name: ::windows::core::BSTR,
...
pub struct PropertyChainValue {
    pub Index: u32,
    pub Type: ::windows::core::BSTR,
    pub DeclaringType: ::windows::core::BSTR,
    pub ValueType: ::windows::core::BSTR,
    pub ItemType: ::windows::core::BSTR,
    pub Value: ::windows::core::BSTR,
    pub Overridden: super::super::super::Foundation::BOOL,
    pub MetadataBits: i64,
    pub PropertyName: ::windows::core::BSTR,
...
pub struct SourceInfo {
    pub FileName: ::windows::core::BSTR,
    pub LineNumber: u32,
    pub ColumnNumber: u32,
    pub CharPosition: u32,
    pub Hash: ::windows::core::BSTR,
}
