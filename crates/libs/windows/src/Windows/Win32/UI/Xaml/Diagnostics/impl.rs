...
impl IBitmapDataVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IBitmapDataImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IBitmapDataVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, CopyBytesTo::<Impl, IMPL_OFFSET>, GetStride::<Impl, IMPL_OFFSET>, GetBitmapDescription::<Impl, IMPL_OFFSET>, GetSourceBitmapDescription::<Impl, IMPL_OFFSET>)
    }
...
impl IVisualTreeServiceVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IVisualTreeServiceImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IVisualTreeServiceVtbl {
        ...
        Self(
            ...
            AdviseVisualTreeChange::<Impl, IMPL_OFFSET>,
            UnadviseVisualTreeChange::<Impl, IMPL_OFFSET>,
            GetEnums::<Impl, IMPL_OFFSET>,
            CreateInstance::<Impl, IMPL_OFFSET>,
            GetPropertyValuesChain::<Impl, IMPL_OFFSET>,
            SetProperty::<Impl, IMPL_OFFSET>,
            ClearProperty::<Impl, IMPL_OFFSET>,
            GetCollectionCount::<Impl, IMPL_OFFSET>,
            GetCollectionElements::<Impl, IMPL_OFFSET>,
            AddChild::<Impl, IMPL_OFFSET>,
            RemoveChild::<Impl, IMPL_OFFSET>,
            ClearChildren::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IVisualTreeService2Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IVisualTreeService2Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IVisualTreeService2Vtbl {
        ...
        Self(
            ...
            ReplaceResource::<Impl, IMPL_OFFSET>,
            RenderTargetBitmap::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IVisualTreeService3Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IVisualTreeService3Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IVisualTreeService3Vtbl {
        ...
        Self(
            ...
            GetDictionaryItem::<Impl, IMPL_OFFSET>,
            AddDictionaryItem::<Impl, IMPL_OFFSET>,
            RemoveDictionaryItem::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IVisualTreeServiceCallbackVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IVisualTreeServiceCallbackImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IVisualTreeServiceCallbackVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, OnVisualTreeChange::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IVisualTreeServiceCallback2Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IVisualTreeServiceCallback2Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IVisualTreeServiceCallback2Vtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, OnVisualTreeChange::<Impl, IMPL_OFFSET>, OnElementStateChanged::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IXamlDiagnosticsVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IXamlDiagnosticsImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IXamlDiagnosticsVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, GetDispatcher::<Impl, IMPL_OFFSET>, GetUiLayer::<Impl, IMPL_OFFSET>, GetApplication::<Impl, IMPL_OFFSET>, GetIInspectableFromHandle::<Impl, IMPL_OFFSET>, GetHandleFromIInspectable::<Impl, IMPL_OFFSET>, HitTest::<Impl, IMPL_OFFSET>, RegisterInstance::<Impl, IMPL_OFFSET>, GetInitializationData::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
