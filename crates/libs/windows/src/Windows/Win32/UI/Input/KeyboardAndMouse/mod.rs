#[inline]
pub unsafe fn ActivateKeyboardLayout(hkl: HKL, flags: ACTIVATE_KEYBOARD_LAYOUT_FLAGS) -> windows_result::Result<HKL> {
...
#[inline]
pub unsafe fn BlockInput(fblockit: bool) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn GetKeyboardLayoutNameA(pwszklid: &mut [u8; 9]) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn GetKeyboardLayoutNameW(pwszklid: &mut [u16; 9]) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn GetKeyboardState(lpkeystate: &mut [u8; 256]) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn LoadKeyboardLayoutA<P0>(pwszklid: P0, flags: ACTIVATE_KEYBOARD_LAYOUT_FLAGS) -> windows_result::Result<HKL>
where
...
#[inline]
pub unsafe fn LoadKeyboardLayoutW<P0>(pwszklid: P0, flags: ACTIVATE_KEYBOARD_LAYOUT_FLAGS) -> windows_result::Result<HKL>
where
...
#[inline]
pub unsafe fn RegisterHotKey(hwnd: Option<super::super::super::Foundation::HWND>, id: i32, fsmodifiers: HOT_KEY_MODIFIERS, vk: u32) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn ReleaseCapture() -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn SetActiveWindow(hwnd: super::super::super::Foundation::HWND) -> windows_result::Result<super::super::super::Foundation::HWND> {
...
#[inline]
pub unsafe fn SetDoubleClickTime(param0: u32) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn SetFocus(hwnd: Option<super::super::super::Foundation::HWND>) -> windows_result::Result<super::super::super::Foundation::HWND> {
...
#[inline]
pub unsafe fn SetKeyboardState(lpkeystate: &[u8; 256]) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn TrackMouseEvent(lpeventtrack: *mut TRACKMOUSEEVENT) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn UnloadKeyboardLayout(hkl: HKL) -> windows_result::Result<()> {
    windows_link::link!("user32.dll" "system" fn UnloadKeyboardLayout(hkl : HKL) -> windows_core::BOOL);
    unsafe { UnloadKeyboardLayout(hkl).ok() }
}
#[inline]
pub unsafe fn UnregisterHotKey(hwnd: Option<super::super::super::Foundation::HWND>, id: i32) -> windows_result::Result<()> {
