...
pub unsafe fn DefRawInputProc(parawinput: &[*const RAWINPUT], cbsizeheader: u32) -> super::super::Foundation::LRESULT {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(DefRawInputProc(::core::mem::transmute(parawinput.as_ptr()), parawinput.len() as _, ::core::mem::transmute(cbsizeheader)))
    }
    #[cfg(not(windows))]
...
pub unsafe fn RegisterRawInputDevices(prawinputdevices: &[RAWINPUTDEVICE], cbsize: u32) -> super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(RegisterRawInputDevices(::core::mem::transmute(prawinputdevices.as_ptr()), prawinputdevices.len() as _, ::core::mem::transmute(cbsize)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
