...
pub unsafe fn GetRawInputBuffer(pdata: *mut RAWINPUT, pcbsize: *mut u32, cbsizeheader: u32) -> u32 {
    ...
    unsafe { GetRawInputBuffer(pdata as _, pcbsize as _, cbsizeheader) }
}
#[inline]
pub unsafe fn GetRawInputData(hrawinput: HRAWINPUT, uicommand: RAW_INPUT_DATA_COMMAND_FLAGS, pdata: *mut core::ffi::c_void, pcbsize: *mut u32, cbsizeheader: u32) -> u32 {
    ...
    unsafe { GetRawInputData(hrawinput, uicommand, pdata as _, pcbsize as _, cbsizeheader) }
}
#[inline]
pub unsafe fn GetRawInputDeviceInfoA(hdevice: super::super::Foundation::HANDLE, uicommand: RAW_INPUT_DEVICE_INFO_COMMAND, pdata: *mut core::ffi::c_void, pcbsize: *mut u32) -> u32 {
    ...
    unsafe { GetRawInputDeviceInfoA(hdevice, uicommand, pdata as _, pcbsize as _) }
}
#[inline]
pub unsafe fn GetRawInputDeviceInfoW(hdevice: super::super::Foundation::HANDLE, uicommand: RAW_INPUT_DEVICE_INFO_COMMAND, pdata: *mut core::ffi::c_void, pcbsize: *mut u32) -> u32 {
    ...
    unsafe { GetRawInputDeviceInfoW(hdevice, uicommand, pdata as _, pcbsize as _) }
}
#[inline]
pub unsafe fn GetRawInputDeviceList(prawinputdevicelist: *mut RAWINPUTDEVICELIST, puinumdevices: *mut u32, cbsize: u32) -> u32 {
    ...
    unsafe { GetRawInputDeviceList(prawinputdevicelist as _, puinumdevices as _, cbsize) }
}
#[inline]
