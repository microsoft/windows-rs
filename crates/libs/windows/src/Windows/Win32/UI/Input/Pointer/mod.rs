...
#[inline]
pub unsafe fn GetPointerDevice(device: super::super::super::Foundation::HANDLE, pointerdevice: *mut super::super::Controls::POINTER_DEVICE_INFO) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn GetPointerDeviceCursors(device: super::super::super::Foundation::HANDLE, cursorcount: *mut u32, devicecursors: *mut super::super::Controls::POINTER_DEVICE_CURSOR_INFO) -> windows_core::BOOL {
    ...
    unsafe { GetPointerDeviceCursors(device, cursorcount as _, devicecursors as _) }
}
#[cfg(feature = "Win32_UI_Controls")]
#[inline]
pub unsafe fn GetPointerDeviceProperties(device: super::super::super::Foundation::HANDLE, propertycount: *mut u32, pointerproperties: *mut super::super::Controls::POINTER_DEVICE_PROPERTY) -> windows_core::BOOL {
    ...
    unsafe { GetPointerDeviceProperties(device, propertycount as _, pointerproperties as _) }
}
#[inline]
pub unsafe fn GetPointerDeviceRects(device: super::super::super::Foundation::HANDLE, pointerdevicerect: *mut super::super::super::Foundation::RECT, displayrect: *mut super::super::super::Foundation::RECT) -> windows_core::BOOL {
...
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_UI_Controls"))]
#[inline]
pub unsafe fn GetPointerDevices(devicecount: *mut u32, pointerdevices: *mut super::super::Controls::POINTER_DEVICE_INFO) -> windows_core::BOOL {
    ...
    unsafe { GetPointerDevices(devicecount as _, pointerdevices as _) }
}
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn GetPointerFrameInfo(pointerid: u32, pointercount: *mut u32, pointerinfo: *mut POINTER_INFO) -> windows_core::BOOL {
    ...
    unsafe { GetPointerFrameInfo(pointerid, pointercount as _, pointerinfo as _) }
}
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn GetPointerFrameInfoHistory(pointerid: u32, entriescount: *mut u32, pointercount: *mut u32, pointerinfo: *mut POINTER_INFO) -> windows_core::BOOL {
    ...
    unsafe { GetPointerFrameInfoHistory(pointerid, entriescount as _, pointercount as _, pointerinfo as _) }
}
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn GetPointerFramePenInfo(pointerid: u32, pointercount: *mut u32, peninfo: *mut POINTER_PEN_INFO) -> windows_core::BOOL {
    ...
    unsafe { GetPointerFramePenInfo(pointerid, pointercount as _, peninfo as _) }
}
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn GetPointerFramePenInfoHistory(pointerid: u32, entriescount: *mut u32, pointercount: *mut u32, peninfo: *mut POINTER_PEN_INFO) -> windows_core::BOOL {
    ...
    unsafe { GetPointerFramePenInfoHistory(pointerid, entriescount as _, pointercount as _, peninfo as _) }
}
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn GetPointerFrameTouchInfo(pointerid: u32, pointercount: *mut u32, touchinfo: *mut POINTER_TOUCH_INFO) -> windows_core::BOOL {
    ...
    unsafe { GetPointerFrameTouchInfo(pointerid, pointercount as _, touchinfo as _) }
}
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn GetPointerFrameTouchInfoHistory(pointerid: u32, entriescount: *mut u32, pointercount: *mut u32, touchinfo: *mut POINTER_TOUCH_INFO) -> windows_core::BOOL {
    ...
    unsafe { GetPointerFrameTouchInfoHistory(pointerid, entriescount as _, pointercount as _, touchinfo as _) }
}
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn GetPointerInfoHistory(pointerid: u32, entriescount: *mut u32, pointerinfo: *mut POINTER_INFO) -> windows_core::BOOL {
    ...
    unsafe { GetPointerInfoHistory(pointerid, entriescount as _, pointerinfo as _) }
}
#[inline]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn GetPointerPenInfoHistory(pointerid: u32, entriescount: *mut u32, peninfo: *mut POINTER_PEN_INFO) -> windows_core::BOOL {
    ...
    unsafe { GetPointerPenInfoHistory(pointerid, entriescount as _, peninfo as _) }
}
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn GetPointerTouchInfoHistory(pointerid: u32, entriescount: *mut u32, touchinfo: *mut POINTER_TOUCH_INFO) -> windows_core::BOOL {
    ...
    unsafe { GetPointerTouchInfoHistory(pointerid, entriescount as _, touchinfo as _) }
}
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
pub unsafe fn GetPointerType(pointerid: u32, pointertype: *mut super::super::WindowsAndMessaging::POINTER_INPUT_TYPE) -> windows_core::BOOL {
...
#[cfg(feature = "Win32_UI_Controls")]
#[inline]
pub unsafe fn GetRawPointerDeviceData(pointerid: u32, historycount: u32, propertiescount: u32, pproperties: *const super::super::Controls::POINTER_DEVICE_PROPERTY, pvalues: *mut i32) -> windows_core::BOOL {
    ...
    unsafe { GetRawPointerDeviceData(pointerid, historycount, propertiescount, pproperties, pvalues as _) }
}
#[inline]
...
#[inline]
pub unsafe fn InitializeTouchInjection(maxcount: u32, dwmode: TOUCH_FEEDBACK_MODE) -> windows_core::BOOL {
...
#[inline]
pub unsafe fn InjectSyntheticPointerInput(device: super::super::Controls::HSYNTHETICPOINTERDEVICE, pointerinfo: *const super::super::Controls::POINTER_TYPE_INFO, count: u32) -> windows_core::BOOL {
    ...
    unsafe { InjectSyntheticPointerInput(device, pointerinfo, count) }
}
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
#[inline]
