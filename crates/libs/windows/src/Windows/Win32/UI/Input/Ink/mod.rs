...
impl IInkCommitRequestHandler {
    pub unsafe fn OnCommitRequested(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IInkCommitRequestHandler_Impl: windows_core::IUnknownImpl {
    fn OnCommitRequested(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IInkD2DRenderer {
    pub unsafe fn Draw<P0, P1>(&self, pd2d1devicecontext: P0, pinkstrokeiterable: P1, fhighcontrast: bool) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IInkD2DRenderer_Impl: windows_core::IUnknownImpl {
    fn Draw(&self, pd2d1devicecontext: windows_core::Ref<'_, windows_core::IUnknown>, pinkstrokeiterable: windows_core::Ref<'_, windows_core::IUnknown>, fhighcontrast: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
}
...
impl IInkD2DRenderer2 {
    pub unsafe fn Draw<P0, P1>(&self, pd2d1devicecontext: P0, pinkstrokeiterable: P1, highcontrastadjustment: INK_HIGH_CONTRAST_ADJUSTMENT) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
        P1: windows_core::Param<windows_core::IUnknown>,
    {
...
pub trait IInkD2DRenderer2_Impl: windows_core::IUnknownImpl {
    fn Draw(&self, pd2d1devicecontext: windows_core::Ref<'_, windows_core::IUnknown>, pinkstrokeiterable: windows_core::Ref<'_, windows_core::IUnknown>, highcontrastadjustment: INK_HIGH_CONTRAST_ADJUSTMENT) -> Result<(), windows_result::HRESULT>;
}
...
impl IInkDesktopHost {
    pub unsafe fn QueueWorkItem<P0>(&self, workitem: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn CreateInkPresenter<T>(&self) -> Result<T, windows_result::HRESULT>
    where
    ...
    pub unsafe fn CreateAndInitializeInkPresenter<P0, T>(&self, rootvisual: P0, width: f32, height: f32) -> Result<T, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
        T: windows_core::Interface,
    {
...
pub trait IInkDesktopHost_Impl: windows_core::IUnknownImpl {
    fn QueueWorkItem(&self, workitem: windows_core::Ref<'_, IInkHostWorkItem>) -> Result<(), windows_result::HRESULT>;
    fn CreateInkPresenter(&self, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn CreateAndInitializeInkPresenter(&self, rootvisual: windows_core::Ref<'_, windows_core::IUnknown>, width: f32, height: f32, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
}
...
impl IInkPresenterDesktop {
    pub unsafe fn SetRootVisual<P0, P1>(&self, rootvisual: P0, device: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
        P1: windows_core::Param<windows_core::IUnknown>,
    {
    ...
    pub unsafe fn SetCommitRequestHandler<P0>(&self, handler: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn GetSize(&self, width: *mut f32, height: *mut f32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetSize)(windows_core::Interface::as_raw(self), width as _, height as _).ok() }
    }
    pub unsafe fn SetSize(&self, width: f32, height: f32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetSize)(windows_core::Interface::as_raw(self), width, height).ok() }
    }
    pub unsafe fn OnHighContrastChanged(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IInkPresenterDesktop_Impl: windows_core::IUnknownImpl {
    fn SetRootVisual(&self, rootvisual: windows_core::Ref<'_, windows_core::IUnknown>, device: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn SetCommitRequestHandler(&self, handler: windows_core::Ref<'_, IInkCommitRequestHandler>) -> Result<(), windows_result::HRESULT>;
    fn GetSize(&self, width: *mut f32, height: *mut f32) -> Result<(), windows_result::HRESULT>;
    fn SetSize(&self, width: f32, height: f32) -> Result<(), windows_result::HRESULT>;
    fn OnHighContrastChanged(&self) -> Result<(), windows_result::HRESULT>;
}
