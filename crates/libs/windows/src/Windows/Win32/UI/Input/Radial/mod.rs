...
impl IRadialControllerConfigurationInterop {
    pub unsafe fn GetForWindow<T>(&self, hwnd: super::super::super::Foundation::HWND) -> Result<T, windows_result::HRESULT>
    where
...
pub trait IRadialControllerConfigurationInterop_Impl: windows_core::IUnknownImpl {
    fn GetForWindow(&self, hwnd: super::super::super::Foundation::HWND, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
}
...
impl IRadialControllerIndependentInputSourceInterop {
    pub unsafe fn CreateForWindow<T>(&self, hwnd: super::super::super::Foundation::HWND) -> Result<T, windows_result::HRESULT>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
...
pub trait IRadialControllerIndependentInputSourceInterop_Impl: windows_core::IUnknownImpl {
    fn CreateForWindow(&self, hwnd: super::super::super::Foundation::HWND, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
}
