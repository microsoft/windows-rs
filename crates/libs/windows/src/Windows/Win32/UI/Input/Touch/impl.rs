...
impl IInertiaProcessorVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IInertiaProcessorImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IInertiaProcessorVtbl {
        ...
        Self(
            ...
            InitialOriginX::<Impl, IMPL_OFFSET>,
            SetInitialOriginX::<Impl, IMPL_OFFSET>,
            InitialOriginY::<Impl, IMPL_OFFSET>,
            SetInitialOriginY::<Impl, IMPL_OFFSET>,
            InitialVelocityX::<Impl, IMPL_OFFSET>,
            SetInitialVelocityX::<Impl, IMPL_OFFSET>,
            InitialVelocityY::<Impl, IMPL_OFFSET>,
            SetInitialVelocityY::<Impl, IMPL_OFFSET>,
            InitialAngularVelocity::<Impl, IMPL_OFFSET>,
            SetInitialAngularVelocity::<Impl, IMPL_OFFSET>,
            InitialExpansionVelocity::<Impl, IMPL_OFFSET>,
            SetInitialExpansionVelocity::<Impl, IMPL_OFFSET>,
            InitialRadius::<Impl, IMPL_OFFSET>,
            SetInitialRadius::<Impl, IMPL_OFFSET>,
            BoundaryLeft::<Impl, IMPL_OFFSET>,
            SetBoundaryLeft::<Impl, IMPL_OFFSET>,
            BoundaryTop::<Impl, IMPL_OFFSET>,
            SetBoundaryTop::<Impl, IMPL_OFFSET>,
            BoundaryRight::<Impl, IMPL_OFFSET>,
            SetBoundaryRight::<Impl, IMPL_OFFSET>,
            BoundaryBottom::<Impl, IMPL_OFFSET>,
            SetBoundaryBottom::<Impl, IMPL_OFFSET>,
            ElasticMarginLeft::<Impl, IMPL_OFFSET>,
            SetElasticMarginLeft::<Impl, IMPL_OFFSET>,
            ElasticMarginTop::<Impl, IMPL_OFFSET>,
            SetElasticMarginTop::<Impl, IMPL_OFFSET>,
            ElasticMarginRight::<Impl, IMPL_OFFSET>,
            SetElasticMarginRight::<Impl, IMPL_OFFSET>,
            ElasticMarginBottom::<Impl, IMPL_OFFSET>,
            SetElasticMarginBottom::<Impl, IMPL_OFFSET>,
            DesiredDisplacement::<Impl, IMPL_OFFSET>,
            SetDesiredDisplacement::<Impl, IMPL_OFFSET>,
            DesiredRotation::<Impl, IMPL_OFFSET>,
            SetDesiredRotation::<Impl, IMPL_OFFSET>,
            DesiredExpansion::<Impl, IMPL_OFFSET>,
            SetDesiredExpansion::<Impl, IMPL_OFFSET>,
            DesiredDeceleration::<Impl, IMPL_OFFSET>,
            SetDesiredDeceleration::<Impl, IMPL_OFFSET>,
            DesiredAngularDeceleration::<Impl, IMPL_OFFSET>,
            SetDesiredAngularDeceleration::<Impl, IMPL_OFFSET>,
            DesiredExpansionDeceleration::<Impl, IMPL_OFFSET>,
            SetDesiredExpansionDeceleration::<Impl, IMPL_OFFSET>,
            InitialTimestamp::<Impl, IMPL_OFFSET>,
            SetInitialTimestamp::<Impl, IMPL_OFFSET>,
            Reset::<Impl, IMPL_OFFSET>,
            Process::<Impl, IMPL_OFFSET>,
            ProcessTime::<Impl, IMPL_OFFSET>,
            Complete::<Impl, IMPL_OFFSET>,
            CompleteTime::<Impl, IMPL_OFFSET>,
        )
    }
...
impl IManipulationProcessorVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IManipulationProcessorImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IManipulationProcessorVtbl {
        ...
        Self(
            ...
            ::windows::core::AddRef::<Identity, BASE_OFFSET>,
            ::windows::core::Release::<Identity, BASE_OFFSET>,
            SupportedManipulations::<Impl, IMPL_OFFSET>,
            SetSupportedManipulations::<Impl, IMPL_OFFSET>,
            PivotPointX::<Impl, IMPL_OFFSET>,
            SetPivotPointX::<Impl, IMPL_OFFSET>,
            PivotPointY::<Impl, IMPL_OFFSET>,
            SetPivotPointY::<Impl, IMPL_OFFSET>,
            PivotRadius::<Impl, IMPL_OFFSET>,
            SetPivotRadius::<Impl, IMPL_OFFSET>,
            CompleteManipulation::<Impl, IMPL_OFFSET>,
            ProcessDown::<Impl, IMPL_OFFSET>,
            ProcessMove::<Impl, IMPL_OFFSET>,
            ProcessUp::<Impl, IMPL_OFFSET>,
            ProcessDownWithTime::<Impl, IMPL_OFFSET>,
            ProcessMoveWithTime::<Impl, IMPL_OFFSET>,
            ProcessUpWithTime::<Impl, IMPL_OFFSET>,
            GetVelocityX::<Impl, IMPL_OFFSET>,
            GetVelocityY::<Impl, IMPL_OFFSET>,
            GetExpansionVelocity::<Impl, IMPL_OFFSET>,
            GetAngularVelocity::<Impl, IMPL_OFFSET>,
            MinimumScaleRotateRadius::<Impl, IMPL_OFFSET>,
            SetMinimumScaleRotateRadius::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl _IManipulationEventsVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: _IManipulationEventsImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> _IManipulationEventsVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, ManipulationStarted::<Impl, IMPL_OFFSET>, ManipulationDelta::<Impl, IMPL_OFFSET>, ManipulationCompleted::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
