...
impl IUIAnimationInterpolator {
    pub unsafe fn SetInitialValueAndVelocity(&self, initialvalue: f64, initialvelocity: f64) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetDependencies(&self, initialvaluedependencies: *mut UI_ANIMATION_DEPENDENCIES, initialvelocitydependencies: *mut UI_ANIMATION_DEPENDENCIES, durationdependencies: *mut UI_ANIMATION_DEPENDENCIES) -> Result<(), windows_result::HRESULT> {
...
pub trait IUIAnimationInterpolator_Impl: windows_core::IUnknownImpl {
    fn SetInitialValueAndVelocity(&self, initialvalue: f64, initialvelocity: f64) -> Result<(), windows_result::HRESULT>;
    fn SetDuration(&self, duration: f64) -> Result<(), windows_result::HRESULT>;
    fn GetDuration(&self) -> Result<f64, windows_result::HRESULT>;
    fn GetFinalValue(&self) -> Result<f64, windows_result::HRESULT>;
    fn InterpolateValue(&self, offset: f64) -> Result<f64, windows_result::HRESULT>;
    fn InterpolateVelocity(&self, offset: f64) -> Result<f64, windows_result::HRESULT>;
    fn GetDependencies(&self, initialvaluedependencies: *mut UI_ANIMATION_DEPENDENCIES, initialvelocitydependencies: *mut UI_ANIMATION_DEPENDENCIES, durationdependencies: *mut UI_ANIMATION_DEPENDENCIES) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationInterpolator2 {
    pub unsafe fn GetDimension(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetDimension)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetInitialValueAndVelocity(&self, initialvalue: *const f64, initialvelocity: *const f64, cdimension: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetFinalValue(&self, value: &mut [f64]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn InterpolateValue(&self, offset: f64, value: &mut [f64]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn InterpolateVelocity(&self, offset: f64, velocity: &mut [f64]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetPrimitiveInterpolation<P0>(&self, interpolation: P0, cdimension: u32) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IUIAnimationInterpolator2_Impl: windows_core::IUnknownImpl {
    fn GetDimension(&self) -> Result<u32, windows_result::HRESULT>;
    fn SetInitialValueAndVelocity(&self, initialvalue: *const f64, initialvelocity: *const f64, cdimension: u32) -> Result<(), windows_result::HRESULT>;
    fn SetDuration(&self, duration: f64) -> Result<(), windows_result::HRESULT>;
    fn GetDuration(&self) -> Result<f64, windows_result::HRESULT>;
    fn GetFinalValue(&self, value: *mut f64, cdimension: u32) -> Result<(), windows_result::HRESULT>;
    fn InterpolateValue(&self, offset: f64, value: *mut f64, cdimension: u32) -> Result<(), windows_result::HRESULT>;
    fn InterpolateVelocity(&self, offset: f64, velocity: *mut f64, cdimension: u32) -> Result<(), windows_result::HRESULT>;
    fn GetPrimitiveInterpolation(&self, interpolation: windows_core::Ref<'_, IUIAnimationPrimitiveInterpolation>, cdimension: u32) -> Result<(), windows_result::HRESULT>;
    fn GetDependencies(&self, initialvaluedependencies: *mut UI_ANIMATION_DEPENDENCIES, initialvelocitydependencies: *mut UI_ANIMATION_DEPENDENCIES, durationdependencies: *mut UI_ANIMATION_DEPENDENCIES) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationLoopIterationChangeHandler2 {
    pub unsafe fn OnLoopIterationChanged<P0>(&self, storyboard: P0, id: usize, newiterationcount: u32, olditerationcount: u32) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IUIAnimationLoopIterationChangeHandler2_Impl: windows_core::IUnknownImpl {
    fn OnLoopIterationChanged(&self, storyboard: windows_core::Ref<'_, IUIAnimationStoryboard2>, id: usize, newiterationcount: u32, olditerationcount: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationManager {
    pub unsafe fn CreateAnimationVariable(&self, initialvalue: f64) -> Result<IUIAnimationVariable, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ScheduleTransition<P0, P1>(&self, variable: P0, transition: P1, timenow: f64) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn CreateStoryboard(&self) -> Result<IUIAnimationStoryboard, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn FinishAllStoryboards(&self, completiondeadline: f64) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).FinishAllStoryboards)(windows_core::Interface::as_raw(self), completiondeadline).ok() }
    }
    pub unsafe fn AbandonAllStoryboards(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).AbandonAllStoryboards)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Update(&self, timenow: f64, updateresult: Option<*mut UI_ANIMATION_UPDATE_RESULT>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetVariableFromTag<P0>(&self, object: P0, id: u32) -> Result<IUIAnimationVariable, windows_result::HRESULT>
    where
    ...
    pub unsafe fn GetStoryboardFromTag<P0>(&self, object: P0, id: u32) -> Result<IUIAnimationStoryboard, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
    ...
    pub unsafe fn GetStatus(&self) -> Result<UI_ANIMATION_MANAGER_STATUS, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetStatus)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetAnimationMode(&self, mode: UI_ANIMATION_MODE) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetManagerEventHandler<P0>(&self, handler: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetCancelPriorityComparison<P0>(&self, comparison: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetTrimPriorityComparison<P0>(&self, comparison: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IUIAnimationPriorityComparison>,
    {
    ...
    pub unsafe fn SetCompressPriorityComparison<P0>(&self, comparison: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IUIAnimationPriorityComparison>,
    {
    ...
    pub unsafe fn SetConcludePriorityComparison<P0>(&self, comparison: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IUIAnimationPriorityComparison>,
    {
    ...
    pub unsafe fn SetDefaultLongestAcceptableDelay(&self, delay: f64) -> Result<(), windows_result::HRESULT> {
...
pub trait IUIAnimationManager_Impl: windows_core::IUnknownImpl {
    fn CreateAnimationVariable(&self, initialvalue: f64) -> Result<IUIAnimationVariable, windows_result::HRESULT>;
    fn ScheduleTransition(&self, variable: windows_core::Ref<'_, IUIAnimationVariable>, transition: windows_core::Ref<'_, IUIAnimationTransition>, timenow: f64) -> Result<(), windows_result::HRESULT>;
    fn CreateStoryboard(&self) -> Result<IUIAnimationStoryboard, windows_result::HRESULT>;
    fn FinishAllStoryboards(&self, completiondeadline: f64) -> Result<(), windows_result::HRESULT>;
    fn AbandonAllStoryboards(&self) -> Result<(), windows_result::HRESULT>;
    fn Update(&self, timenow: f64, updateresult: *mut UI_ANIMATION_UPDATE_RESULT) -> Result<(), windows_result::HRESULT>;
    fn GetVariableFromTag(&self, object: windows_core::Ref<'_, windows_core::IUnknown>, id: u32) -> Result<IUIAnimationVariable, windows_result::HRESULT>;
    fn GetStoryboardFromTag(&self, object: windows_core::Ref<'_, windows_core::IUnknown>, id: u32) -> Result<IUIAnimationStoryboard, windows_result::HRESULT>;
    fn GetStatus(&self) -> Result<UI_ANIMATION_MANAGER_STATUS, windows_result::HRESULT>;
    fn SetAnimationMode(&self, mode: UI_ANIMATION_MODE) -> Result<(), windows_result::HRESULT>;
    fn Pause(&self) -> Result<(), windows_result::HRESULT>;
    fn Resume(&self) -> Result<(), windows_result::HRESULT>;
    fn SetManagerEventHandler(&self, handler: windows_core::Ref<'_, IUIAnimationManagerEventHandler>) -> Result<(), windows_result::HRESULT>;
    fn SetCancelPriorityComparison(&self, comparison: windows_core::Ref<'_, IUIAnimationPriorityComparison>) -> Result<(), windows_result::HRESULT>;
    fn SetTrimPriorityComparison(&self, comparison: windows_core::Ref<'_, IUIAnimationPriorityComparison>) -> Result<(), windows_result::HRESULT>;
    fn SetCompressPriorityComparison(&self, comparison: windows_core::Ref<'_, IUIAnimationPriorityComparison>) -> Result<(), windows_result::HRESULT>;
    fn SetConcludePriorityComparison(&self, comparison: windows_core::Ref<'_, IUIAnimationPriorityComparison>) -> Result<(), windows_result::HRESULT>;
    fn SetDefaultLongestAcceptableDelay(&self, delay: f64) -> Result<(), windows_result::HRESULT>;
...
impl IUIAnimationManager2 {
    pub unsafe fn CreateAnimationVectorVariable(&self, initialvalue: &[f64]) -> Result<IUIAnimationVariable2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateAnimationVariable(&self, initialvalue: f64) -> Result<IUIAnimationVariable2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateAnimationVariable)(windows_core::Interface::as_raw(self), initialvalue, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn CreateStoryboard(&self) -> Result<IUIAnimationStoryboard2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateStoryboard)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn GetVariableFromTag<P0>(&self, object: P0, id: u32) -> Result<IUIAnimationVariable2, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
    ...
    pub unsafe fn GetStoryboardFromTag<P0>(&self, object: P0, id: u32) -> Result<IUIAnimationStoryboard2, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
    ...
    pub unsafe fn EstimateNextEventTime(&self) -> Result<f64, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetManagerEventHandler<P0>(&self, handler: P0, fregisterfornextanimationevent: bool) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IUIAnimationManager2_Impl: windows_core::IUnknownImpl {
    fn CreateAnimationVectorVariable(&self, initialvalue: *const f64, cdimension: u32) -> Result<IUIAnimationVariable2, windows_result::HRESULT>;
    fn CreateAnimationVariable(&self, initialvalue: f64) -> Result<IUIAnimationVariable2, windows_result::HRESULT>;
    fn ScheduleTransition(&self, variable: windows_core::Ref<'_, IUIAnimationVariable2>, transition: windows_core::Ref<'_, IUIAnimationTransition2>, timenow: f64) -> Result<(), windows_result::HRESULT>;
    fn CreateStoryboard(&self) -> Result<IUIAnimationStoryboard2, windows_result::HRESULT>;
    fn FinishAllStoryboards(&self, completiondeadline: f64) -> Result<(), windows_result::HRESULT>;
    fn AbandonAllStoryboards(&self) -> Result<(), windows_result::HRESULT>;
    fn Update(&self, timenow: f64, updateresult: *mut UI_ANIMATION_UPDATE_RESULT) -> Result<(), windows_result::HRESULT>;
    fn GetVariableFromTag(&self, object: windows_core::Ref<'_, windows_core::IUnknown>, id: u32) -> Result<IUIAnimationVariable2, windows_result::HRESULT>;
    fn GetStoryboardFromTag(&self, object: windows_core::Ref<'_, windows_core::IUnknown>, id: u32) -> Result<IUIAnimationStoryboard2, windows_result::HRESULT>;
    fn EstimateNextEventTime(&self) -> Result<f64, windows_result::HRESULT>;
    fn GetStatus(&self) -> Result<UI_ANIMATION_MANAGER_STATUS, windows_result::HRESULT>;
    fn SetAnimationMode(&self, mode: UI_ANIMATION_MODE) -> Result<(), windows_result::HRESULT>;
    fn Pause(&self) -> Result<(), windows_result::HRESULT>;
    fn Resume(&self) -> Result<(), windows_result::HRESULT>;
    fn SetManagerEventHandler(&self, handler: windows_core::Ref<'_, IUIAnimationManagerEventHandler2>, fregisterfornextanimationevent: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SetCancelPriorityComparison(&self, comparison: windows_core::Ref<'_, IUIAnimationPriorityComparison2>) -> Result<(), windows_result::HRESULT>;
    fn SetTrimPriorityComparison(&self, comparison: windows_core::Ref<'_, IUIAnimationPriorityComparison2>) -> Result<(), windows_result::HRESULT>;
    fn SetCompressPriorityComparison(&self, comparison: windows_core::Ref<'_, IUIAnimationPriorityComparison2>) -> Result<(), windows_result::HRESULT>;
    fn SetConcludePriorityComparison(&self, comparison: windows_core::Ref<'_, IUIAnimationPriorityComparison2>) -> Result<(), windows_result::HRESULT>;
    fn SetDefaultLongestAcceptableDelay(&self, delay: f64) -> Result<(), windows_result::HRESULT>;
    fn Shutdown(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationManagerEventHandler {
    pub unsafe fn OnManagerStatusChanged(&self, newstatus: UI_ANIMATION_MANAGER_STATUS, previousstatus: UI_ANIMATION_MANAGER_STATUS) -> Result<(), windows_result::HRESULT> {
...
pub trait IUIAnimationManagerEventHandler_Impl: windows_core::IUnknownImpl {
    fn OnManagerStatusChanged(&self, newstatus: UI_ANIMATION_MANAGER_STATUS, previousstatus: UI_ANIMATION_MANAGER_STATUS) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationPrimitiveInterpolation {
    pub unsafe fn AddCubic(&self, dimension: u32, beginoffset: f64, constantcoefficient: f32, linearcoefficient: f32, quadraticcoefficient: f32, cubiccoefficient: f32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn AddSinusoidal(&self, dimension: u32, beginoffset: f64, bias: f32, amplitude: f32, frequency: f32, phase: f32) -> Result<(), windows_result::HRESULT> {
...
pub trait IUIAnimationPrimitiveInterpolation_Impl: windows_core::IUnknownImpl {
    fn AddCubic(&self, dimension: u32, beginoffset: f64, constantcoefficient: f32, linearcoefficient: f32, quadraticcoefficient: f32, cubiccoefficient: f32) -> Result<(), windows_result::HRESULT>;
    fn AddSinusoidal(&self, dimension: u32, beginoffset: f64, bias: f32, amplitude: f32, frequency: f32, phase: f32) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationPriorityComparison {
    pub unsafe fn HasPriority<P0, P1>(&self, scheduledstoryboard: P0, newstoryboard: P1, priorityeffect: UI_ANIMATION_PRIORITY_EFFECT) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IUIAnimationPriorityComparison_Impl: windows_core::IUnknownImpl {
    fn HasPriority(&self, scheduledstoryboard: windows_core::Ref<'_, IUIAnimationStoryboard>, newstoryboard: windows_core::Ref<'_, IUIAnimationStoryboard>, priorityeffect: UI_ANIMATION_PRIORITY_EFFECT) -> Result<(), windows_result::HRESULT>;
}
...
pub trait IUIAnimationPriorityComparison2_Impl: windows_core::IUnknownImpl {
    fn HasPriority(&self, scheduledstoryboard: windows_core::Ref<'_, IUIAnimationStoryboard2>, newstoryboard: windows_core::Ref<'_, IUIAnimationStoryboard2>, priorityeffect: UI_ANIMATION_PRIORITY_EFFECT) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationStoryboard {
    pub unsafe fn AddTransition<P0, P1>(&self, variable: P0, transition: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IUIAnimationVariable>,
        P1: windows_core::Param<IUIAnimationTransition>,
    {
    ...
    pub unsafe fn AddKeyframeAtOffset(&self, existingkeyframe: UI_ANIMATION_KEYFRAME, offset: f64) -> Result<UI_ANIMATION_KEYFRAME, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AddKeyframeAfterTransition<P0>(&self, transition: P0) -> Result<UI_ANIMATION_KEYFRAME, windows_result::HRESULT>
    where
    ...
    pub unsafe fn AddTransitionAtKeyframe<P0, P1>(&self, variable: P0, transition: P1, startkeyframe: UI_ANIMATION_KEYFRAME) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IUIAnimationVariable>,
        P1: windows_core::Param<IUIAnimationTransition>,
    {
    ...
    pub unsafe fn AddTransitionBetweenKeyframes<P0, P1>(&self, variable: P0, transition: P1, startkeyframe: UI_ANIMATION_KEYFRAME, endkeyframe: UI_ANIMATION_KEYFRAME) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IUIAnimationVariable>,
        P1: windows_core::Param<IUIAnimationTransition>,
    {
    ...
    pub unsafe fn RepeatBetweenKeyframes(&self, startkeyframe: UI_ANIMATION_KEYFRAME, endkeyframe: UI_ANIMATION_KEYFRAME, repetitioncount: i32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn HoldVariable<P0>(&self, variable: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IUIAnimationVariable>,
    {
        unsafe { (windows_core::Interface::vtable(self).HoldVariable)(windows_core::Interface::as_raw(self), variable.param().abi()).ok() }
    }
    pub unsafe fn SetLongestAcceptableDelay(&self, delay: f64) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetLongestAcceptableDelay)(windows_core::Interface::as_raw(self), delay).ok() }
    }
    pub unsafe fn Schedule(&self, timenow: f64, schedulingresult: Option<*mut UI_ANIMATION_SCHEDULING_RESULT>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Conclude(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Conclude)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn Finish(&self, completiondeadline: f64) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Finish)(windows_core::Interface::as_raw(self), completiondeadline).ok() }
    }
    pub unsafe fn Abandon(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Abandon)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn SetTag<P0>(&self, object: P0, id: u32) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetTag)(windows_core::Interface::as_raw(self), object.param().abi(), id).ok() }
    }
    pub unsafe fn GetTag(&self, object: Option<*mut Option<windows_core::IUnknown>>, id: Option<*mut u32>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetStatus(&self) -> Result<UI_ANIMATION_STORYBOARD_STATUS, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetStatus)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetElapsedTime(&self) -> Result<f64, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetElapsedTime)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetStoryboardEventHandler<P0>(&self, handler: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IUIAnimationStoryboard_Impl: windows_core::IUnknownImpl {
    fn AddTransition(&self, variable: windows_core::Ref<'_, IUIAnimationVariable>, transition: windows_core::Ref<'_, IUIAnimationTransition>) -> Result<(), windows_result::HRESULT>;
    fn AddKeyframeAtOffset(&self, existingkeyframe: UI_ANIMATION_KEYFRAME, offset: f64) -> Result<UI_ANIMATION_KEYFRAME, windows_result::HRESULT>;
    fn AddKeyframeAfterTransition(&self, transition: windows_core::Ref<'_, IUIAnimationTransition>) -> Result<UI_ANIMATION_KEYFRAME, windows_result::HRESULT>;
    fn AddTransitionAtKeyframe(&self, variable: windows_core::Ref<'_, IUIAnimationVariable>, transition: windows_core::Ref<'_, IUIAnimationTransition>, startkeyframe: UI_ANIMATION_KEYFRAME) -> Result<(), windows_result::HRESULT>;
    fn AddTransitionBetweenKeyframes(&self, variable: windows_core::Ref<'_, IUIAnimationVariable>, transition: windows_core::Ref<'_, IUIAnimationTransition>, startkeyframe: UI_ANIMATION_KEYFRAME, endkeyframe: UI_ANIMATION_KEYFRAME) -> Result<(), windows_result::HRESULT>;
    fn RepeatBetweenKeyframes(&self, startkeyframe: UI_ANIMATION_KEYFRAME, endkeyframe: UI_ANIMATION_KEYFRAME, repetitioncount: i32) -> Result<(), windows_result::HRESULT>;
    fn HoldVariable(&self, variable: windows_core::Ref<'_, IUIAnimationVariable>) -> Result<(), windows_result::HRESULT>;
    fn SetLongestAcceptableDelay(&self, delay: f64) -> Result<(), windows_result::HRESULT>;
    fn Schedule(&self, timenow: f64, schedulingresult: *mut UI_ANIMATION_SCHEDULING_RESULT) -> Result<(), windows_result::HRESULT>;
    fn Conclude(&self) -> Result<(), windows_result::HRESULT>;
    fn Finish(&self, completiondeadline: f64) -> Result<(), windows_result::HRESULT>;
    fn Abandon(&self) -> Result<(), windows_result::HRESULT>;
    fn SetTag(&self, object: windows_core::Ref<'_, windows_core::IUnknown>, id: u32) -> Result<(), windows_result::HRESULT>;
    fn GetTag(&self, object: windows_core::OutRef<'_, windows_core::IUnknown>, id: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetStatus(&self) -> Result<UI_ANIMATION_STORYBOARD_STATUS, windows_result::HRESULT>;
    fn GetElapsedTime(&self) -> Result<f64, windows_result::HRESULT>;
    fn SetStoryboardEventHandler(&self, handler: windows_core::Ref<'_, IUIAnimationStoryboardEventHandler>) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationStoryboard2 {
    ...
    pub unsafe fn RepeatBetweenKeyframes<P4>(&self, startkeyframe: UI_ANIMATION_KEYFRAME, endkeyframe: UI_ANIMATION_KEYFRAME, crepetition: f64, repeatmode: UI_ANIMATION_REPEAT_MODE, piterationchangehandler: P4, id: usize, fregisterfornextanimationevent: bool) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetSkipDuration(&self, secondsduration: f64) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetStoryboardEventHandler<P0>(&self, handler: P0, fregisterstatuschangefornextanimationevent: bool, fregisterupdatefornextanimationevent: bool) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IUIAnimationStoryboard2_Impl: windows_core::IUnknownImpl {
    fn AddTransition(&self, variable: windows_core::Ref<'_, IUIAnimationVariable2>, transition: windows_core::Ref<'_, IUIAnimationTransition2>) -> Result<(), windows_result::HRESULT>;
    fn AddKeyframeAtOffset(&self, existingkeyframe: UI_ANIMATION_KEYFRAME, offset: f64) -> Result<UI_ANIMATION_KEYFRAME, windows_result::HRESULT>;
    fn AddKeyframeAfterTransition(&self, transition: windows_core::Ref<'_, IUIAnimationTransition2>) -> Result<UI_ANIMATION_KEYFRAME, windows_result::HRESULT>;
    fn AddTransitionAtKeyframe(&self, variable: windows_core::Ref<'_, IUIAnimationVariable2>, transition: windows_core::Ref<'_, IUIAnimationTransition2>, startkeyframe: UI_ANIMATION_KEYFRAME) -> Result<(), windows_result::HRESULT>;
    fn AddTransitionBetweenKeyframes(&self, variable: windows_core::Ref<'_, IUIAnimationVariable2>, transition: windows_core::Ref<'_, IUIAnimationTransition2>, startkeyframe: UI_ANIMATION_KEYFRAME, endkeyframe: UI_ANIMATION_KEYFRAME) -> Result<(), windows_result::HRESULT>;
    ...
    fn HoldVariable(&self, variable: windows_core::Ref<'_, IUIAnimationVariable2>) -> Result<(), windows_result::HRESULT>;
    fn SetLongestAcceptableDelay(&self, delay: f64) -> Result<(), windows_result::HRESULT>;
    fn SetSkipDuration(&self, secondsduration: f64) -> Result<(), windows_result::HRESULT>;
    fn Schedule(&self, timenow: f64, schedulingresult: *mut UI_ANIMATION_SCHEDULING_RESULT) -> Result<(), windows_result::HRESULT>;
    fn Conclude(&self) -> Result<(), windows_result::HRESULT>;
    fn Finish(&self, completiondeadline: f64) -> Result<(), windows_result::HRESULT>;
    fn Abandon(&self) -> Result<(), windows_result::HRESULT>;
    ...
    fn GetStatus(&self) -> Result<UI_ANIMATION_STORYBOARD_STATUS, windows_result::HRESULT>;
    fn GetElapsedTime(&self) -> Result<f64, windows_result::HRESULT>;
    fn SetStoryboardEventHandler(&self, handler: windows_core::Ref<'_, IUIAnimationStoryboardEventHandler2>, fregisterstatuschangefornextanimationevent: windows_core::BOOL, fregisterupdatefornextanimationevent: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationStoryboardEventHandler {
    pub unsafe fn OnStoryboardStatusChanged<P0>(&self, storyboard: P0, newstatus: UI_ANIMATION_STORYBOARD_STATUS, previousstatus: UI_ANIMATION_STORYBOARD_STATUS) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IUIAnimationStoryboard>,
    {
    ...
    pub unsafe fn OnStoryboardUpdated<P0>(&self, storyboard: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IUIAnimationStoryboard>,
    {
...
pub trait IUIAnimationStoryboardEventHandler_Impl: windows_core::IUnknownImpl {
    fn OnStoryboardStatusChanged(&self, storyboard: windows_core::Ref<'_, IUIAnimationStoryboard>, newstatus: UI_ANIMATION_STORYBOARD_STATUS, previousstatus: UI_ANIMATION_STORYBOARD_STATUS) -> Result<(), windows_result::HRESULT>;
    fn OnStoryboardUpdated(&self, storyboard: windows_core::Ref<'_, IUIAnimationStoryboard>) -> Result<(), windows_result::HRESULT>;
}
...
pub trait IUIAnimationStoryboardEventHandler2_Impl: windows_core::IUnknownImpl {
    fn OnStoryboardStatusChanged(&self, storyboard: windows_core::Ref<'_, IUIAnimationStoryboard2>, newstatus: UI_ANIMATION_STORYBOARD_STATUS, previousstatus: UI_ANIMATION_STORYBOARD_STATUS) -> Result<(), windows_result::HRESULT>;
    fn OnStoryboardUpdated(&self, storyboard: windows_core::Ref<'_, IUIAnimationStoryboard2>) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationTimer {
    pub unsafe fn SetTimerUpdateHandler<P0>(&self, updatehandler: P0, idlebehavior: UI_ANIMATION_IDLE_BEHAVIOR) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetTimerEventHandler<P0>(&self, handler: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn GetTime(&self) -> Result<f64, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTime)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetFrameRateThreshold(&self, framespersecond: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IUIAnimationTimer_Impl: windows_core::IUnknownImpl {
    fn SetTimerUpdateHandler(&self, updatehandler: windows_core::Ref<'_, IUIAnimationTimerUpdateHandler>, idlebehavior: UI_ANIMATION_IDLE_BEHAVIOR) -> Result<(), windows_result::HRESULT>;
    fn SetTimerEventHandler(&self, handler: windows_core::Ref<'_, IUIAnimationTimerEventHandler>) -> Result<(), windows_result::HRESULT>;
    ...
    fn GetTime(&self) -> Result<f64, windows_result::HRESULT>;
    fn SetFrameRateThreshold(&self, framespersecond: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationTimerClientEventHandler {
    pub unsafe fn OnTimerClientStatusChanged(&self, newstatus: UI_ANIMATION_TIMER_CLIENT_STATUS, previousstatus: UI_ANIMATION_TIMER_CLIENT_STATUS) -> Result<(), windows_result::HRESULT> {
...
pub trait IUIAnimationTimerClientEventHandler_Impl: windows_core::IUnknownImpl {
    fn OnTimerClientStatusChanged(&self, newstatus: UI_ANIMATION_TIMER_CLIENT_STATUS, previousstatus: UI_ANIMATION_TIMER_CLIENT_STATUS) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationTimerEventHandler {
    pub unsafe fn OnPreUpdate(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).OnPreUpdate)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn OnPostUpdate(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).OnPostUpdate)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn OnRenderingTooSlow(&self, framespersecond: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IUIAnimationTimerEventHandler_Impl: windows_core::IUnknownImpl {
    fn OnPreUpdate(&self) -> Result<(), windows_result::HRESULT>;
    fn OnPostUpdate(&self) -> Result<(), windows_result::HRESULT>;
    fn OnRenderingTooSlow(&self, framespersecond: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationTimerUpdateHandler {
    pub unsafe fn OnUpdate(&self, timenow: f64) -> Result<UI_ANIMATION_UPDATE_RESULT, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OnUpdate)(windows_core::Interface::as_raw(self), timenow, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetTimerClientEventHandler<P0>(&self, handler: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn ClearTimerClientEventHandler(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IUIAnimationTimerUpdateHandler_Impl: windows_core::IUnknownImpl {
    fn OnUpdate(&self, timenow: f64) -> Result<UI_ANIMATION_UPDATE_RESULT, windows_result::HRESULT>;
    fn SetTimerClientEventHandler(&self, handler: windows_core::Ref<'_, IUIAnimationTimerClientEventHandler>) -> Result<(), windows_result::HRESULT>;
    fn ClearTimerClientEventHandler(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationTransition {
    pub unsafe fn SetInitialValue(&self, value: f64) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetInitialValue)(windows_core::Interface::as_raw(self), value).ok() }
    }
    pub unsafe fn SetInitialVelocity(&self, velocity: f64) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetInitialVelocity)(windows_core::Interface::as_raw(self), velocity).ok() }
    }
    pub unsafe fn IsDurationKnown(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IUIAnimationTransition_Impl: windows_core::IUnknownImpl {
    fn SetInitialValue(&self, value: f64) -> Result<(), windows_result::HRESULT>;
    fn SetInitialVelocity(&self, velocity: f64) -> Result<(), windows_result::HRESULT>;
    fn IsDurationKnown(&self) -> Result<(), windows_result::HRESULT>;
    fn GetDuration(&self) -> Result<f64, windows_result::HRESULT>;
}
...
impl IUIAnimationTransition2 {
    ...
    pub unsafe fn SetInitialVectorValue(&self, value: &[f64]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetInitialVectorVelocity(&self, velocity: &[f64]) -> Result<(), windows_result::HRESULT> {
...
pub trait IUIAnimationTransition2_Impl: windows_core::IUnknownImpl {
    fn GetDimension(&self) -> Result<u32, windows_result::HRESULT>;
    fn SetInitialValue(&self, value: f64) -> Result<(), windows_result::HRESULT>;
    fn SetInitialVectorValue(&self, value: *const f64, cdimension: u32) -> Result<(), windows_result::HRESULT>;
    fn SetInitialVelocity(&self, velocity: f64) -> Result<(), windows_result::HRESULT>;
    fn SetInitialVectorVelocity(&self, velocity: *const f64, cdimension: u32) -> Result<(), windows_result::HRESULT>;
    fn IsDurationKnown(&self) -> Result<(), windows_result::HRESULT>;
    fn GetDuration(&self) -> Result<f64, windows_result::HRESULT>;
}
...
impl IUIAnimationTransitionFactory {
    pub unsafe fn CreateTransition<P0>(&self, interpolator: P0) -> Result<IUIAnimationTransition, windows_result::HRESULT>
    where
...
pub trait IUIAnimationTransitionFactory_Impl: windows_core::IUnknownImpl {
    fn CreateTransition(&self, interpolator: windows_core::Ref<'_, IUIAnimationInterpolator>) -> Result<IUIAnimationTransition, windows_result::HRESULT>;
}
...
impl IUIAnimationTransitionFactory2 {
    pub unsafe fn CreateTransition<P0>(&self, interpolator: P0) -> Result<IUIAnimationTransition2, windows_result::HRESULT>
    where
...
pub trait IUIAnimationTransitionFactory2_Impl: windows_core::IUnknownImpl {
    fn CreateTransition(&self, interpolator: windows_core::Ref<'_, IUIAnimationInterpolator2>) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
}
...
impl IUIAnimationTransitionLibrary {
    pub unsafe fn CreateInstantaneousTransition(&self, finalvalue: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateConstantTransition(&self, duration: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateDiscreteTransition(&self, delay: f64, finalvalue: f64, hold: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateLinearTransition(&self, duration: f64, finalvalue: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateLinearTransitionFromSpeed(&self, speed: f64, finalvalue: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateSinusoidalTransitionFromVelocity(&self, duration: f64, period: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateSinusoidalTransitionFromRange(&self, duration: f64, minimumvalue: f64, maximumvalue: f64, period: f64, slope: UI_ANIMATION_SLOPE) -> Result<IUIAnimationTransition, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateAccelerateDecelerateTransition(&self, duration: f64, finalvalue: f64, accelerationratio: f64, decelerationratio: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateReversalTransition(&self, duration: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateCubicTransition(&self, duration: f64, finalvalue: f64, finalvelocity: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateSmoothStopTransition(&self, maximumduration: f64, finalvalue: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateParabolicTransitionFromAcceleration(&self, finalvalue: f64, finalvelocity: f64, acceleration: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUIAnimationTransitionLibrary_Impl: windows_core::IUnknownImpl {
    fn CreateInstantaneousTransition(&self, finalvalue: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT>;
    fn CreateConstantTransition(&self, duration: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT>;
    fn CreateDiscreteTransition(&self, delay: f64, finalvalue: f64, hold: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT>;
    fn CreateLinearTransition(&self, duration: f64, finalvalue: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT>;
    fn CreateLinearTransitionFromSpeed(&self, speed: f64, finalvalue: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT>;
    fn CreateSinusoidalTransitionFromVelocity(&self, duration: f64, period: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT>;
    fn CreateSinusoidalTransitionFromRange(&self, duration: f64, minimumvalue: f64, maximumvalue: f64, period: f64, slope: UI_ANIMATION_SLOPE) -> Result<IUIAnimationTransition, windows_result::HRESULT>;
    fn CreateAccelerateDecelerateTransition(&self, duration: f64, finalvalue: f64, accelerationratio: f64, decelerationratio: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT>;
    fn CreateReversalTransition(&self, duration: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT>;
    fn CreateCubicTransition(&self, duration: f64, finalvalue: f64, finalvelocity: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT>;
    fn CreateSmoothStopTransition(&self, maximumduration: f64, finalvalue: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT>;
    fn CreateParabolicTransitionFromAcceleration(&self, finalvalue: f64, finalvelocity: f64, acceleration: f64) -> Result<IUIAnimationTransition, windows_result::HRESULT>;
}
...
impl IUIAnimationTransitionLibrary2 {
    pub unsafe fn CreateInstantaneousTransition(&self, finalvalue: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateInstantaneousTransition)(windows_core::Interface::as_raw(self), finalvalue, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateInstantaneousVectorTransition(&self, finalvalue: &[f64]) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateConstantTransition(&self, duration: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateConstantTransition)(windows_core::Interface::as_raw(self), duration, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateDiscreteTransition(&self, delay: f64, finalvalue: f64, hold: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateDiscreteTransition)(windows_core::Interface::as_raw(self), delay, finalvalue, hold, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateDiscreteVectorTransition(&self, delay: f64, finalvalue: &[f64], hold: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateLinearTransition(&self, duration: f64, finalvalue: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateLinearTransition)(windows_core::Interface::as_raw(self), duration, finalvalue, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateLinearVectorTransition(&self, duration: f64, finalvalue: &[f64]) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateLinearTransitionFromSpeed(&self, speed: f64, finalvalue: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateLinearTransitionFromSpeed)(windows_core::Interface::as_raw(self), speed, finalvalue, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateLinearVectorTransitionFromSpeed(&self, speed: f64, finalvalue: &[f64]) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateSinusoidalTransitionFromVelocity(&self, duration: f64, period: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSinusoidalTransitionFromVelocity)(windows_core::Interface::as_raw(self), duration, period, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateSinusoidalTransitionFromRange(&self, duration: f64, minimumvalue: f64, maximumvalue: f64, period: f64, slope: UI_ANIMATION_SLOPE) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSinusoidalTransitionFromRange)(windows_core::Interface::as_raw(self), duration, minimumvalue, maximumvalue, period, slope, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateAccelerateDecelerateTransition(&self, duration: f64, finalvalue: f64, accelerationratio: f64, decelerationratio: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateAccelerateDecelerateTransition)(windows_core::Interface::as_raw(self), duration, finalvalue, accelerationratio, decelerationratio, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateReversalTransition(&self, duration: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateReversalTransition)(windows_core::Interface::as_raw(self), duration, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateCubicTransition(&self, duration: f64, finalvalue: f64, finalvelocity: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateCubicTransition)(windows_core::Interface::as_raw(self), duration, finalvalue, finalvelocity, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateCubicVectorTransition(&self, duration: f64, finalvalue: *const f64, finalvelocity: *const f64, cdimension: u32) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateSmoothStopTransition(&self, maximumduration: f64, finalvalue: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateSmoothStopTransition)(windows_core::Interface::as_raw(self), maximumduration, finalvalue, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateParabolicTransitionFromAcceleration(&self, finalvalue: f64, finalvelocity: f64, acceleration: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateParabolicTransitionFromAcceleration)(windows_core::Interface::as_raw(self), finalvalue, finalvelocity, acceleration, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn CreateCubicBezierLinearTransition(&self, duration: f64, finalvalue: f64, x1: f64, y1: f64, x2: f64, y2: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateCubicBezierLinearVectorTransition(&self, duration: f64, finalvalue: &[f64], x1: f64, y1: f64, x2: f64, y2: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUIAnimationTransitionLibrary2_Impl: windows_core::IUnknownImpl {
    fn CreateInstantaneousTransition(&self, finalvalue: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateInstantaneousVectorTransition(&self, finalvalue: *const f64, cdimension: u32) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateConstantTransition(&self, duration: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateDiscreteTransition(&self, delay: f64, finalvalue: f64, hold: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateDiscreteVectorTransition(&self, delay: f64, finalvalue: *const f64, cdimension: u32, hold: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateLinearTransition(&self, duration: f64, finalvalue: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateLinearVectorTransition(&self, duration: f64, finalvalue: *const f64, cdimension: u32) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateLinearTransitionFromSpeed(&self, speed: f64, finalvalue: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateLinearVectorTransitionFromSpeed(&self, speed: f64, finalvalue: *const f64, cdimension: u32) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateSinusoidalTransitionFromVelocity(&self, duration: f64, period: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateSinusoidalTransitionFromRange(&self, duration: f64, minimumvalue: f64, maximumvalue: f64, period: f64, slope: UI_ANIMATION_SLOPE) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateAccelerateDecelerateTransition(&self, duration: f64, finalvalue: f64, accelerationratio: f64, decelerationratio: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateReversalTransition(&self, duration: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateCubicTransition(&self, duration: f64, finalvalue: f64, finalvelocity: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateCubicVectorTransition(&self, duration: f64, finalvalue: *const f64, finalvelocity: *const f64, cdimension: u32) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateSmoothStopTransition(&self, maximumduration: f64, finalvalue: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateParabolicTransitionFromAcceleration(&self, finalvalue: f64, finalvelocity: f64, acceleration: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateCubicBezierLinearTransition(&self, duration: f64, finalvalue: f64, x1: f64, y1: f64, x2: f64, y2: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
    fn CreateCubicBezierLinearVectorTransition(&self, duration: f64, finalvalue: *const f64, cdimension: u32, x1: f64, y1: f64, x2: f64, y2: f64) -> Result<IUIAnimationTransition2, windows_result::HRESULT>;
}
...
impl IUIAnimationVariable {
    pub unsafe fn GetValue(&self) -> Result<f64, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetLowerBound(&self, bound: f64) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetLowerBound)(windows_core::Interface::as_raw(self), bound).ok() }
    }
    pub unsafe fn SetUpperBound(&self, bound: f64) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetUpperBound)(windows_core::Interface::as_raw(self), bound).ok() }
    }
    pub unsafe fn SetRoundingMode(&self, mode: UI_ANIMATION_ROUNDING_MODE) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetVariableChangeHandler<P0>(&self, handler: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetVariableIntegerChangeHandler<P0>(&self, handler: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IUIAnimationVariable_Impl: windows_core::IUnknownImpl {
    fn GetValue(&self) -> Result<f64, windows_result::HRESULT>;
    fn GetFinalValue(&self) -> Result<f64, windows_result::HRESULT>;
    fn GetPreviousValue(&self) -> Result<f64, windows_result::HRESULT>;
    fn GetIntegerValue(&self) -> Result<i32, windows_result::HRESULT>;
    fn GetFinalIntegerValue(&self) -> Result<i32, windows_result::HRESULT>;
    fn GetPreviousIntegerValue(&self) -> Result<i32, windows_result::HRESULT>;
    fn GetCurrentStoryboard(&self) -> Result<IUIAnimationStoryboard, windows_result::HRESULT>;
    fn SetLowerBound(&self, bound: f64) -> Result<(), windows_result::HRESULT>;
    fn SetUpperBound(&self, bound: f64) -> Result<(), windows_result::HRESULT>;
    fn SetRoundingMode(&self, mode: UI_ANIMATION_ROUNDING_MODE) -> Result<(), windows_result::HRESULT>;
    fn SetTag(&self, object: windows_core::Ref<'_, windows_core::IUnknown>, id: u32) -> Result<(), windows_result::HRESULT>;
    fn GetTag(&self, object: windows_core::OutRef<'_, windows_core::IUnknown>, id: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn SetVariableChangeHandler(&self, handler: windows_core::Ref<'_, IUIAnimationVariableChangeHandler>) -> Result<(), windows_result::HRESULT>;
    fn SetVariableIntegerChangeHandler(&self, handler: windows_core::Ref<'_, IUIAnimationVariableIntegerChangeHandler>) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationVariable2 {
    ...
    pub unsafe fn GetVectorValue(&self, value: &mut [f64]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetCurve<P0>(&self, animation: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Win32_Graphics_DirectComposition")]
    pub unsafe fn GetVectorCurve(&self, animation: &[Option<super::super::Graphics::DirectComposition::IDCompositionAnimation>]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetFinalVectorValue(&self, finalvalue: &mut [f64]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetPreviousVectorValue(&self, previousvalue: &mut [f64]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetIntegerVectorValue(&self, value: &mut [i32]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetFinalIntegerVectorValue(&self, finalvalue: &mut [i32]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetPreviousIntegerVectorValue(&self, previousvalue: &mut [i32]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetCurrentStoryboard(&self) -> Result<IUIAnimationStoryboard2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetCurrentStoryboard)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn SetLowerBoundVector(&self, bound: &[f64]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetUpperBoundVector(&self, bound: &[f64]) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetVariableChangeHandler<P0>(&self, handler: P0, fregisterfornextanimationevent: bool) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetVariableIntegerChangeHandler<P0>(&self, handler: P0, fregisterfornextanimationevent: bool) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetVariableCurveChangeHandler<P0>(&self, handler: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IUIAnimationVariable2_Impl: windows_core::IUnknownImpl {
    fn GetDimension(&self) -> Result<u32, windows_result::HRESULT>;
    fn GetValue(&self) -> Result<f64, windows_result::HRESULT>;
    fn GetVectorValue(&self, value: *mut f64, cdimension: u32) -> Result<(), windows_result::HRESULT>;
    fn GetCurve(&self, animation: windows_core::Ref<'_, super::super::Graphics::DirectComposition::IDCompositionAnimation>) -> Result<(), windows_result::HRESULT>;
    fn GetVectorCurve(&self, animation: *const Option<super::super::Graphics::DirectComposition::IDCompositionAnimation>, cdimension: u32) -> Result<(), windows_result::HRESULT>;
    fn GetFinalValue(&self) -> Result<f64, windows_result::HRESULT>;
    fn GetFinalVectorValue(&self, finalvalue: *mut f64, cdimension: u32) -> Result<(), windows_result::HRESULT>;
    fn GetPreviousValue(&self) -> Result<f64, windows_result::HRESULT>;
    fn GetPreviousVectorValue(&self, previousvalue: *mut f64, cdimension: u32) -> Result<(), windows_result::HRESULT>;
    fn GetIntegerValue(&self) -> Result<i32, windows_result::HRESULT>;
    fn GetIntegerVectorValue(&self, value: *mut i32, cdimension: u32) -> Result<(), windows_result::HRESULT>;
    fn GetFinalIntegerValue(&self) -> Result<i32, windows_result::HRESULT>;
    fn GetFinalIntegerVectorValue(&self, finalvalue: *mut i32, cdimension: u32) -> Result<(), windows_result::HRESULT>;
    fn GetPreviousIntegerValue(&self) -> Result<i32, windows_result::HRESULT>;
    fn GetPreviousIntegerVectorValue(&self, previousvalue: *mut i32, cdimension: u32) -> Result<(), windows_result::HRESULT>;
    fn GetCurrentStoryboard(&self) -> Result<IUIAnimationStoryboard2, windows_result::HRESULT>;
    fn SetLowerBound(&self, bound: f64) -> Result<(), windows_result::HRESULT>;
    fn SetLowerBoundVector(&self, bound: *const f64, cdimension: u32) -> Result<(), windows_result::HRESULT>;
    fn SetUpperBound(&self, bound: f64) -> Result<(), windows_result::HRESULT>;
    fn SetUpperBoundVector(&self, bound: *const f64, cdimension: u32) -> Result<(), windows_result::HRESULT>;
    fn SetRoundingMode(&self, mode: UI_ANIMATION_ROUNDING_MODE) -> Result<(), windows_result::HRESULT>;
    fn SetTag(&self, object: windows_core::Ref<'_, windows_core::IUnknown>, id: u32) -> Result<(), windows_result::HRESULT>;
    fn GetTag(&self, object: windows_core::OutRef<'_, windows_core::IUnknown>, id: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn SetVariableChangeHandler(&self, handler: windows_core::Ref<'_, IUIAnimationVariableChangeHandler2>, fregisterfornextanimationevent: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SetVariableIntegerChangeHandler(&self, handler: windows_core::Ref<'_, IUIAnimationVariableIntegerChangeHandler2>, fregisterfornextanimationevent: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SetVariableCurveChangeHandler(&self, handler: windows_core::Ref<'_, IUIAnimationVariableCurveChangeHandler2>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Graphics_DirectComposition")]
...
impl IUIAnimationVariableChangeHandler {
    pub unsafe fn OnValueChanged<P0, P1>(&self, storyboard: P0, variable: P1, newvalue: f64, previousvalue: f64) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IUIAnimationStoryboard>,
...
pub trait IUIAnimationVariableChangeHandler_Impl: windows_core::IUnknownImpl {
    fn OnValueChanged(&self, storyboard: windows_core::Ref<'_, IUIAnimationStoryboard>, variable: windows_core::Ref<'_, IUIAnimationVariable>, newvalue: f64, previousvalue: f64) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationVariableChangeHandler2 {
    pub unsafe fn OnValueChanged<P0, P1>(&self, storyboard: P0, variable: P1, newvalue: *const f64, previousvalue: *const f64, cdimension: u32) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IUIAnimationStoryboard2>,
...
pub trait IUIAnimationVariableChangeHandler2_Impl: windows_core::IUnknownImpl {
    fn OnValueChanged(&self, storyboard: windows_core::Ref<'_, IUIAnimationStoryboard2>, variable: windows_core::Ref<'_, IUIAnimationVariable2>, newvalue: *const f64, previousvalue: *const f64, cdimension: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationVariableCurveChangeHandler2 {
    pub unsafe fn OnCurveChanged<P0>(&self, variable: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IUIAnimationVariable2>,
    {
...
pub trait IUIAnimationVariableCurveChangeHandler2_Impl: windows_core::IUnknownImpl {
    fn OnCurveChanged(&self, variable: windows_core::Ref<'_, IUIAnimationVariable2>) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationVariableIntegerChangeHandler {
    pub unsafe fn OnIntegerValueChanged<P0, P1>(&self, storyboard: P0, variable: P1, newvalue: i32, previousvalue: i32) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IUIAnimationStoryboard>,
        P1: windows_core::Param<IUIAnimationVariable>,
    {
...
pub trait IUIAnimationVariableIntegerChangeHandler_Impl: windows_core::IUnknownImpl {
    fn OnIntegerValueChanged(&self, storyboard: windows_core::Ref<'_, IUIAnimationStoryboard>, variable: windows_core::Ref<'_, IUIAnimationVariable>, newvalue: i32, previousvalue: i32) -> Result<(), windows_result::HRESULT>;
}
...
impl IUIAnimationVariableIntegerChangeHandler2 {
    pub unsafe fn OnIntegerValueChanged<P0, P1>(&self, storyboard: P0, variable: P1, newvalue: *const i32, previousvalue: *const i32, cdimension: u32) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IUIAnimationStoryboard2>,
        P1: windows_core::Param<IUIAnimationVariable2>,
    {
...
pub trait IUIAnimationVariableIntegerChangeHandler2_Impl: windows_core::IUnknownImpl {
    fn OnIntegerValueChanged(&self, storyboard: windows_core::Ref<'_, IUIAnimationStoryboard2>, variable: windows_core::Ref<'_, IUIAnimationVariable2>, newvalue: *const i32, previousvalue: *const i32, cdimension: u32) -> Result<(), windows_result::HRESULT>;
}
