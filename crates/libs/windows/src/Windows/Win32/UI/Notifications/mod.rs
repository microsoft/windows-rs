...
impl INotificationActivationCallback {
    pub unsafe fn Activate<P0, P1>(&self, appusermodelid: P0, invokedargs: P1, data: &[NOTIFICATION_USER_INPUT_DATA]) -> Result<(), windows_result::HRESULT>
    where
...
pub trait INotificationActivationCallback_Impl: windows_core::IUnknownImpl {
    fn Activate(&self, appusermodelid: &windows_core::PCWSTR, invokedargs: &windows_core::PCWSTR, data: *const NOTIFICATION_USER_INPUT_DATA, count: u32) -> Result<(), windows_result::HRESULT>;
}
