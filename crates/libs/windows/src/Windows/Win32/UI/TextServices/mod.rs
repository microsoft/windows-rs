...
pub const TF_E_ALREADY_EXISTS: windows_core::HRESULT = 0x80040506_u32 as _;
pub const TF_E_COMPOSITION_REJECTED: windows_core::HRESULT = 0x80040508_u32 as _;
pub const TF_E_DISCONNECTED: windows_core::HRESULT = 0x80040504_u32 as _;
pub const TF_E_EMPTYCONTEXT: windows_core::HRESULT = 0x80040509_u32 as _;
pub const TF_E_FORMAT: windows_core::HRESULT = 0x8004020A_u32 as _;
pub const TF_E_INVALIDPOINT: windows_core::HRESULT = 0x80040207_u32 as _;
pub const TF_E_INVALIDPOS: windows_core::HRESULT = 0x80040200_u32 as _;
pub const TF_E_INVALIDVIEW: windows_core::HRESULT = 0x80040505_u32 as _;
pub const TF_E_LOCKED: windows_core::HRESULT = 0x80040500_u32 as _;
pub const TF_E_NOCONVERSION: windows_core::HRESULT = 0x80040600_u32 as _;
pub const TF_E_NOINTERFACE: windows_core::HRESULT = 0x80040204_u32 as _;
pub const TF_E_NOLAYOUT: windows_core::HRESULT = 0x80040206_u32 as _;
pub const TF_E_NOLOCK: windows_core::HRESULT = 0x80040201_u32 as _;
pub const TF_E_NOOBJECT: windows_core::HRESULT = 0x80040202_u32 as _;
pub const TF_E_NOPROVIDER: windows_core::HRESULT = 0x80040503_u32 as _;
pub const TF_E_NOSELECTION: windows_core::HRESULT = 0x80040205_u32 as _;
pub const TF_E_NOSERVICE: windows_core::HRESULT = 0x80040203_u32 as _;
pub const TF_E_NOTOWNEDRANGE: windows_core::HRESULT = 0x80040502_u32 as _;
pub const TF_E_RANGE_NOT_COVERED: windows_core::HRESULT = 0x80040507_u32 as _;
pub const TF_E_READONLY: windows_core::HRESULT = 0x80040209_u32 as _;
pub const TF_E_STACKFULL: windows_core::HRESULT = 0x80040501_u32 as _;
pub const TF_E_SYNCHRONOUS: windows_core::HRESULT = 0x80040208_u32 as _;
...
pub const TF_S_ASYNC: windows_core::HRESULT = 0x40300_u32 as _;
...
pub const TS_E_FORMAT: windows_core::HRESULT = 0x8004020A_u32 as _;
pub const TS_E_INVALIDPOINT: windows_core::HRESULT = 0x80040207_u32 as _;
pub const TS_E_INVALIDPOS: windows_core::HRESULT = 0x80040200_u32 as _;
pub const TS_E_NOINTERFACE: windows_core::HRESULT = 0x80040204_u32 as _;
pub const TS_E_NOLAYOUT: windows_core::HRESULT = 0x80040206_u32 as _;
pub const TS_E_NOLOCK: windows_core::HRESULT = 0x80040201_u32 as _;
pub const TS_E_NOOBJECT: windows_core::HRESULT = 0x80040202_u32 as _;
pub const TS_E_NOSELECTION: windows_core::HRESULT = 0x80040205_u32 as _;
pub const TS_E_NOSERVICE: windows_core::HRESULT = 0x80040203_u32 as _;
pub const TS_E_READONLY: windows_core::HRESULT = 0x80040209_u32 as _;
pub const TS_E_SYNCHRONOUS: windows_core::HRESULT = 0x80040208_u32 as _;
...
pub const TS_S_ASYNC: windows_core::HRESULT = 0x40300_u32 as _;
...
pub struct TF_HALTCOND {
    pub pHaltRange: Option<ITfRange>,
...
pub struct TF_LBBALLOONINFO {
    ...
    pub bstrText: windows_core::BSTR,
}
...
pub struct TS_SELECTION_ANCHOR {
    pub paStart: Option<IAnchor>,
    pub paEnd: Option<IAnchor>,
    pub style: TS_SELECTIONSTYLE,
}
