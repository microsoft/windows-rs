...
pub struct DYNAMIC_RENDERER_CACHED_DATA {
    pub strokeId: i32,
    pub dynamicRenderer: Option<IDynamicRenderer>,
}
...
pub struct IEC_GESTUREINFO {
    ...
    pub Cursor: Option<IInkCursor>,
    pub Strokes: Option<IInkStrokes>,
...
pub struct IEC_RECOGNITIONRESULTINFO {
    pub nmhdr: super::Controls::NMHDR,
    pub RecognitionResult: Option<IInkRecognitionResult>,
}
#[cfg(feature = "Win32_UI_Controls")]
...
pub struct IEC_STROKEINFO {
    pub nmhdr: super::Controls::NMHDR,
    pub Cursor: Option<IInkCursor>,
    pub Stroke: Option<IInkStrokeDisp>,
}
#[cfg(feature = "Win32_UI_Controls")]
