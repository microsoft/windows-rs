...
impl IPrintDialogCallbackVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IPrintDialogCallbackImpl, const OFFSET: isize>() -> IPrintDialogCallbackVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IPrintDialogCallback>, ::windows::core::GetTrustLevel, InitDone::<Impl, OFFSET>, SelectionChange::<Impl, OFFSET>, HandleMessage::<Impl, OFFSET>)
    }
}
...
impl IPrintDialogServicesVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IPrintDialogServicesImpl, const OFFSET: isize>() -> IPrintDialogServicesVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IPrintDialogServices>, ::windows::core::GetTrustLevel, GetCurrentDevMode::<Impl, OFFSET>, GetCurrentPrinterName::<Impl, OFFSET>, GetCurrentPortName::<Impl, OFFSET>)
    }
}
