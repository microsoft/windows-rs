...
impl IImageList_Vtbl {
        ...
        <Identity as windows_core::IUnknownImpl>::Impl: IImageList_Impl,
    {
        ...
        unsafe extern "system" fn DragShowNolock<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, fshow: windows_core::BOOL) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IImageList_Impl,
        {
            unsafe {
...
impl IImageList2_Vtbl {
    pub const fn new<Identity: windows_core::IUnknownImpl, const OFFSET: isize>() -> Self
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IImageList2_Impl,
    {
