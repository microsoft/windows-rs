...
impl IImageListVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IImageListImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IImageListVtbl {
        ...
        unsafe extern "system" fn Merge<Impl: IImageListImpl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, i1: i32, punk2: *mut ::core::ffi::c_void, i2: i32, dx: i32, dy: i32, riid: *const ::windows::core::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
            panic!()
        }
        unsafe extern "system" fn Clone<Impl: IImageListImpl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, riid: *const ::windows::core::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
            panic!()
        }
        ...
        unsafe extern "system" fn GetDragImage<Impl: IImageListImpl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, ppt: *mut super::super::Foundation::POINT, ppthotspot: *mut super::super::Foundation::POINT, riid: *const ::windows::core::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
            panic!()
        }
        ...
        Self(
            ...
            ReplaceIcon::<Impl, IMPL_OFFSET>,
            SetOverlayImage::<Impl, IMPL_OFFSET>,
            Replace::<Impl, IMPL_OFFSET>,
            AddMasked::<Impl, IMPL_OFFSET>,
            Draw::<Impl, IMPL_OFFSET>,
            Remove::<Impl, IMPL_OFFSET>,
            GetIcon::<Impl, IMPL_OFFSET>,
            GetImageInfo::<Impl, IMPL_OFFSET>,
            Copy::<Impl, IMPL_OFFSET>,
            Merge::<Impl, IMPL_OFFSET>,
            Clone::<Impl, IMPL_OFFSET>,
            GetImageRect::<Impl, IMPL_OFFSET>,
            GetIconSize::<Impl, IMPL_OFFSET>,
            SetIconSize::<Impl, IMPL_OFFSET>,
            GetImageCount::<Impl, IMPL_OFFSET>,
            SetImageCount::<Impl, IMPL_OFFSET>,
            SetBkColor::<Impl, IMPL_OFFSET>,
            GetBkColor::<Impl, IMPL_OFFSET>,
            BeginDrag::<Impl, IMPL_OFFSET>,
            EndDrag::<Impl, IMPL_OFFSET>,
            DragEnter::<Impl, IMPL_OFFSET>,
            DragLeave::<Impl, IMPL_OFFSET>,
            DragMove::<Impl, IMPL_OFFSET>,
            SetDragCursorImage::<Impl, IMPL_OFFSET>,
            DragShowNolock::<Impl, IMPL_OFFSET>,
            GetDragImage::<Impl, IMPL_OFFSET>,
            GetItemFlags::<Impl, IMPL_OFFSET>,
            GetOverlayImage::<Impl, IMPL_OFFSET>,
        )
    }
...
impl IImageList2Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IImageList2Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IImageList2Vtbl {
        ...
        unsafe extern "system" fn GetCallback<Impl: IImageList2Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, riid: *const ::windows::core::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
            panic!()
        }
        ...
        Self(
            ...
            GetOriginalSize::<Impl, IMPL_OFFSET>,
            SetOriginalSize::<Impl, IMPL_OFFSET>,
            SetCallback::<Impl, IMPL_OFFSET>,
            GetCallback::<Impl, IMPL_OFFSET>,
            ForceImagePresent::<Impl, IMPL_OFFSET>,
            DiscardImages::<Impl, IMPL_OFFSET>,
            PreloadImages::<Impl, IMPL_OFFSET>,
            GetStatistics::<Impl, IMPL_OFFSET>,
            Initialize::<Impl, IMPL_OFFSET>,
            Replace2::<Impl, IMPL_OFFSET>,
            ReplaceFromImageList::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
