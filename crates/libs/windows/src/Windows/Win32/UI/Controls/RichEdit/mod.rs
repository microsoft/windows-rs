...
pub struct IRichEditOleVtbl(
    ...
    #[cfg(not(any(feature = "Win32_Foundation", feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Ole")))] usize,
...
pub struct IRichEditOleCallbackVtbl(
    ...
    #[cfg(not(any(feature = "Win32_Foundation", feature = "Win32_System_Ole", feature = "Win32_UI_WindowsAndMessaging")))] usize,
...
pub struct ITextHostVtbl(
    ...
    #[cfg(not(any(feature = "Win32_Foundation", feature = "Win32_Graphics_Gdi", feature = "Win32_UI_WindowsAndMessaging")))] usize,
