...
pub trait IADesktopP2_Impl: windows_core::IUnknownImpl {
    fn ReReadWallpaper(&self) -> Result<(), windows_result::HRESULT>;
    fn GetADObjectFlags(&self, pdwflags: *mut u32, dwmask: u32) -> Result<(), windows_result::HRESULT>;
    fn UpdateAllDesktopSubscriptions(&self) -> Result<(), windows_result::HRESULT>;
    fn MakeDynamicChanges(&self, poleobj: windows_core::Ref<'_, super::super::System::Ole::IOleObject>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Ole")]
...
impl IActiveDesktopP {
    pub unsafe fn SetSafeMode(&self, dwflags: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetSafeMode)(windows_core::Interface::as_raw(self), dwflags).ok() }
    }
    pub unsafe fn EnsureUpdateHTML(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).EnsureUpdateHTML)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn SetScheme<P0>(&self, pwszschemename: P0, dwflags: u32) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn GetScheme(&self, pwszschemename: windows_core::PWSTR, pdwcchbuffer: *mut u32, dwflags: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IActiveDesktopP_Impl: windows_core::IUnknownImpl {
    fn SetSafeMode(&self, dwflags: u32) -> Result<(), windows_result::HRESULT>;
    fn EnsureUpdateHTML(&self) -> Result<(), windows_result::HRESULT>;
    fn SetScheme(&self, pwszschemename: &windows_core::PCWSTR, dwflags: u32) -> Result<(), windows_result::HRESULT>;
    fn GetScheme(&self, pwszschemename: windows_core::PWSTR, pdwcchbuffer: *mut u32, dwflags: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IBriefcaseInitiator {
    ...
    pub unsafe fn IsMonikerInBriefcase<P0>(&self, pmk: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IBriefcaseInitiator_Impl: windows_core::IUnknownImpl {
    fn IsMonikerInBriefcase(&self, pmk: windows_core::Ref<'_, super::super::System::Com::IMoniker>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IEmptyVolumeCache {
    ...
    pub unsafe fn Initialize<P1>(&self, hkregkey: super::super::System::Registry::HKEY, pcwszvolume: P1, ppwszdisplayname: *mut windows_core::PWSTR, ppwszdescription: *mut windows_core::PWSTR, pdwflags: *mut EMPTY_VOLUME_CACHE_FLAGS) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn GetSpaceUsed<P1>(&self, pdwlspaceused: *mut u64, picb: P1) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Purge<P1>(&self, dwlspacetofree: u64, picb: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<IEmptyVolumeCacheCallBack>,
    {
        unsafe { (windows_core::Interface::vtable(self).Purge)(windows_core::Interface::as_raw(self), dwlspacetofree, picb.param().abi()).ok() }
    }
    pub unsafe fn ShowProperties(&self, hwnd: super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).ShowProperties)(windows_core::Interface::as_raw(self), hwnd).ok() }
    }
    pub unsafe fn Deactivate(&self) -> Result<EMPTY_VOLUME_CACHE_FLAGS, windows_result::HRESULT> {
        unsafe {
...
pub trait IEmptyVolumeCache_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, hkregkey: super::super::System::Registry::HKEY, pcwszvolume: &windows_core::PCWSTR, ppwszdisplayname: *mut windows_core::PWSTR, ppwszdescription: *mut windows_core::PWSTR, pdwflags: *mut EMPTY_VOLUME_CACHE_FLAGS) -> Result<(), windows_result::HRESULT>;
    fn GetSpaceUsed(&self, pdwlspaceused: *mut u64, picb: windows_core::Ref<'_, IEmptyVolumeCacheCallBack>) -> Result<(), windows_result::HRESULT>;
    fn Purge(&self, dwlspacetofree: u64, picb: windows_core::Ref<'_, IEmptyVolumeCacheCallBack>) -> Result<(), windows_result::HRESULT>;
    fn ShowProperties(&self, hwnd: super::super::Foundation::HWND) -> Result<(), windows_result::HRESULT>;
    fn Deactivate(&self) -> Result<EMPTY_VOLUME_CACHE_FLAGS, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Registry")]
...
impl IEmptyVolumeCache2 {
    #[cfg(feature = "Win32_System_Registry")]
    pub unsafe fn InitializeEx<P1, P2>(&self, hkregkey: super::super::System::Registry::HKEY, pcwszvolume: P1, pcwszkeyname: P2, ppwszdisplayname: *mut windows_core::PWSTR, ppwszdescription: *mut windows_core::PWSTR, ppwszbtntext: *mut windows_core::PWSTR, pdwflags: *mut EMPTY_VOLUME_CACHE_FLAGS) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
...
pub trait IEmptyVolumeCache2_Impl: IEmptyVolumeCache_Impl {
    fn InitializeEx(&self, hkregkey: super::super::System::Registry::HKEY, pcwszvolume: &windows_core::PCWSTR, pcwszkeyname: &windows_core::PCWSTR, ppwszdisplayname: *mut windows_core::PWSTR, ppwszdescription: *mut windows_core::PWSTR, ppwszbtntext: *mut windows_core::PWSTR, pdwflags: *mut EMPTY_VOLUME_CACHE_FLAGS) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Registry")]
...
impl IEmptyVolumeCacheCallBack {
    pub unsafe fn ScanProgress<P2>(&self, dwlspaceused: u64, dwflags: u32, pcwszstatus: P2) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn PurgeProgress<P3>(&self, dwlspacefreed: u64, dwlspacetofree: u64, dwflags: u32, pcwszstatus: P3) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IEmptyVolumeCacheCallBack_Impl: windows_core::IUnknownImpl {
    fn ScanProgress(&self, dwlspaceused: u64, dwflags: u32, pcwszstatus: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn PurgeProgress(&self, dwlspacefreed: u64, dwlspacetofree: u64, dwflags: u32, pcwszstatus: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
...
impl IReconcilableObject {
    ...
    pub unsafe fn Reconcile<P0, P7>(&self, pinitiator: P0, dwflags: u32, hwndowner: super::super::Foundation::HWND, hwndprogressfeedback: super::super::Foundation::HWND, rgpmkotherinput: &mut [Option<super::super::System::Com::IMoniker>], ploutindex: *mut i32, pstgnewresidues: P7, pvreserved: Option<*const core::ffi::c_void>) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn GetProgressFeedbackMaxEstimate(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IReconcilableObject_Impl: windows_core::IUnknownImpl {
    fn Reconcile(&self, pinitiator: windows_core::Ref<'_, IReconcileInitiator>, dwflags: u32, hwndowner: super::super::Foundation::HWND, hwndprogressfeedback: super::super::Foundation::HWND, ulcinput: u32, rgpmkotherinput: *mut Option<super::super::System::Com::IMoniker>, ploutindex: *mut i32, pstgnewresidues: windows_core::Ref<'_, super::super::System::Com::StructuredStorage::IStorage>, pvreserved: *const core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn GetProgressFeedbackMaxEstimate(&self) -> Result<u32, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com_StructuredStorage")]
...
impl IReconcileInitiator {
    pub unsafe fn SetAbortCallback<P0>(&self, punkforabort: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetProgressFeedback(&self, ulprogress: u32, ulprogressmax: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IReconcileInitiator_Impl: windows_core::IUnknownImpl {
    fn SetAbortCallback(&self, punkforabort: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn SetProgressFeedback(&self, ulprogress: u32, ulprogressmax: u32) -> Result<(), windows_result::HRESULT>;
}
