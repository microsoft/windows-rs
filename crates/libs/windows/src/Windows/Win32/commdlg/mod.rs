...
impl IPrintDialogCallback {
    ...
    #[cfg(all(feature = "minwindef", feature = "windef"))]
    pub unsafe fn HandleMessage(&self, hdlg: super::HWND, umsg: u32, wparam: super::WPARAM, lparam: super::LPARAM) -> windows_core::Result<super::LRESULT> {
        unsafe {
...
pub struct IPrintDialogCallback_Vtbl {
    ...
    #[cfg(all(feature = "minwindef", feature = "windef"))]
    pub HandleMessage: unsafe extern "system" fn(*mut core::ffi::c_void, super::HWND, u32, super::WPARAM, super::LPARAM, *mut super::LRESULT) -> windows_core::HRESULT,
...
pub trait IPrintDialogCallback_Impl: windows_core::IUnknownImpl {
    ...
    fn HandleMessage(&self, hdlg: super::HWND, umsg: u32, wparam: super::WPARAM, lparam: super::LPARAM) -> windows_core::Result<super::LRESULT>;
}
#[cfg(all(feature = "minwindef", feature = "windef"))]
impl IPrintDialogCallback_Vtbl {
    pub const fn new<Identity: IPrintDialogCallback_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn HandleMessage<Identity: IPrintDialogCallback_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hdlg: super::HWND, umsg: u32, wparam: super::WPARAM, lparam: super::LPARAM, presult: *mut super::LRESULT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IPrintDialogServices {
    ...
    pub unsafe fn GetCurrentDevMode(&self, pdevmode: super::LPDEVMODE, pcbsize: *mut u32) -> windows_core::HRESULT {
...
pub struct IPrintDialogServices_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(all(feature = "windef", feature = "wingdi"))]
    pub GetCurrentDevMode: unsafe extern "system" fn(*mut core::ffi::c_void, super::LPDEVMODE, *mut u32) -> windows_core::HRESULT,
...
pub trait IPrintDialogServices_Impl: windows_core::IUnknownImpl {
    fn GetCurrentDevMode(&self, pdevmode: super::LPDEVMODE, pcbsize: *mut u32) -> windows_core::Result<()>;
...
impl IPrintDialogServices_Vtbl {
    pub const fn new<Identity: IPrintDialogServices_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetCurrentDevMode<Identity: IPrintDialogServices_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pdevmode: super::LPDEVMODE, pcbsize: *mut u32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
