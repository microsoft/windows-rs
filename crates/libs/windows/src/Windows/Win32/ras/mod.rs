...
{
    windows_core::link!("rasapi32.dll" "system" fn RasCreatePhonebookEntryW(param0 : super::windef::HWND, param1 : windows_core::PCWSTR) -> u32);
...
{
    windows_core::link!("rasapi32.dll" "system" fn RasEditPhonebookEntryW(param0 : super::windef::HWND, param1 : windows_core::PCWSTR, param2 : windows_core::PCWSTR) -> u32);
...
where
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("rasapi32.dll" "system" fn RasGetEapUserIdentityW(pszphonebook : windows_core::PCWSTR, pszentry : windows_core::PCWSTR, dwflags : u32, hwnd : super::windef::HWND, ppraseapuseridentity : *mut *mut tagRASEAPUSERIDENTITYW) -> u32);
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("rasapi32.dll" "system" fn RasSetEapUserDataW(htoken : super::winnt::HANDLE, pszphonebook : windows_core::PCWSTR, pszentry : windows_core::PCWSTR, pbeapdata : *const u8, dwsizeofeapdata : u32) -> u32);
