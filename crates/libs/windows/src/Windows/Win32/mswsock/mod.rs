...
#[cfg(feature = "mswsockdef")]
pub type LPFN_RIORECEIVE = Option<unsafe extern "system" fn(socketqueue: *const RIO_RQ_t, pdata: *const super::RIO_BUF, databuffercount: u32, flags: u32, requestcontext: *const core::ffi::c_void) -> windows_core::BOOL>;
#[cfg(feature = "mswsockdef")]
...
pub type LPFN_RIORESIZECOMPLETIONQUEUE = Option<unsafe extern "system" fn(cq: *const RIO_CQ_t, queuesize: u32) -> windows_core::BOOL>;
pub type LPFN_RIORESIZEREQUESTQUEUE = Option<unsafe extern "system" fn(rq: *const RIO_RQ_t, maxoutstandingreceive: u32, maxoutstandingsend: u32) -> windows_core::BOOL>;
#[cfg(feature = "mswsockdef")]
pub type LPFN_RIOSEND = Option<unsafe extern "system" fn(socketqueue: *const RIO_RQ_t, pdata: *const super::RIO_BUF, databuffercount: u32, flags: u32, requestcontext: *const core::ffi::c_void) -> windows_core::BOOL>;
#[cfg(feature = "mswsockdef")]
