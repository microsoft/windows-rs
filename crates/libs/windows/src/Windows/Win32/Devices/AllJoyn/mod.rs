...
pub const AJ_IFC_SECURITY_INHERIT: alljoyn_interfacedescription_securitypolicy = alljoyn_interfacedescription_securitypolicy(0);
pub const AJ_IFC_SECURITY_OFF: alljoyn_interfacedescription_securitypolicy = alljoyn_interfacedescription_securitypolicy(2);
pub const AJ_IFC_SECURITY_REQUIRED: alljoyn_interfacedescription_securitypolicy = alljoyn_interfacedescription_securitypolicy(1);
pub const ALLJOYN_ARRAY: alljoyn_typeid = alljoyn_typeid(97);
pub const ALLJOYN_BIG_ENDIAN: u8 = 66;
pub const ALLJOYN_BOOLEAN: alljoyn_typeid = alljoyn_typeid(98);
pub const ALLJOYN_BOOLEAN_ARRAY: alljoyn_typeid = alljoyn_typeid(25185);
pub const ALLJOYN_BYTE: alljoyn_typeid = alljoyn_typeid(121);
pub const ALLJOYN_BYTE_ARRAY: alljoyn_typeid = alljoyn_typeid(31073);
...
pub const ALLJOYN_DICT_ENTRY: alljoyn_typeid = alljoyn_typeid(101);
pub const ALLJOYN_DICT_ENTRY_CLOSE: alljoyn_typeid = alljoyn_typeid(125);
pub const ALLJOYN_DICT_ENTRY_OPEN: alljoyn_typeid = alljoyn_typeid(123);
pub const ALLJOYN_DISCONNECTED: u32 = 4;
pub const ALLJOYN_DOUBLE: alljoyn_typeid = alljoyn_typeid(100);
pub const ALLJOYN_DOUBLE_ARRAY: alljoyn_typeid = alljoyn_typeid(25697);
pub const ALLJOYN_HANDLE: alljoyn_typeid = alljoyn_typeid(104);
pub const ALLJOYN_INT16: alljoyn_typeid = alljoyn_typeid(110);
pub const ALLJOYN_INT16_ARRAY: alljoyn_typeid = alljoyn_typeid(28257);
pub const ALLJOYN_INT32: alljoyn_typeid = alljoyn_typeid(105);
pub const ALLJOYN_INT32_ARRAY: alljoyn_typeid = alljoyn_typeid(26977);
pub const ALLJOYN_INT64: alljoyn_typeid = alljoyn_typeid(120);
pub const ALLJOYN_INT64_ARRAY: alljoyn_typeid = alljoyn_typeid(30817);
pub const ALLJOYN_INVALID: alljoyn_typeid = alljoyn_typeid(0);
...
pub const ALLJOYN_MESSAGE_ERROR: alljoyn_messagetype = alljoyn_messagetype(3);
...
pub const ALLJOYN_MESSAGE_INVALID: alljoyn_messagetype = alljoyn_messagetype(0);
pub const ALLJOYN_MESSAGE_METHOD_CALL: alljoyn_messagetype = alljoyn_messagetype(1);
pub const ALLJOYN_MESSAGE_METHOD_RET: alljoyn_messagetype = alljoyn_messagetype(2);
pub const ALLJOYN_MESSAGE_SIGNAL: alljoyn_messagetype = alljoyn_messagetype(4);
pub const ALLJOYN_NAMED_PIPE_CONNECT_SPEC: windows_core::PCWSTR = windows_core::w!("npipe:");
pub const ALLJOYN_OBJECT_PATH: alljoyn_typeid = alljoyn_typeid(111);
...
pub const ALLJOYN_SESSIONLOST_INVALID: alljoyn_sessionlostreason = alljoyn_sessionlostreason(0);
pub const ALLJOYN_SESSIONLOST_LINK_TIMEOUT: alljoyn_sessionlostreason = alljoyn_sessionlostreason(4);
pub const ALLJOYN_SESSIONLOST_REASON_OTHER: alljoyn_sessionlostreason = alljoyn_sessionlostreason(5);
pub const ALLJOYN_SESSIONLOST_REMOTE_END_CLOSED_ABRUPTLY: alljoyn_sessionlostreason = alljoyn_sessionlostreason(2);
pub const ALLJOYN_SESSIONLOST_REMOTE_END_LEFT_SESSION: alljoyn_sessionlostreason = alljoyn_sessionlostreason(1);
pub const ALLJOYN_SESSIONLOST_REMOVED_BY_BINDER: alljoyn_sessionlostreason = alljoyn_sessionlostreason(3);
pub const ALLJOYN_SIGNATURE: alljoyn_typeid = alljoyn_typeid(103);
pub const ALLJOYN_STRING: alljoyn_typeid = alljoyn_typeid(115);
pub const ALLJOYN_STRUCT: alljoyn_typeid = alljoyn_typeid(114);
pub const ALLJOYN_STRUCT_CLOSE: alljoyn_typeid = alljoyn_typeid(41);
pub const ALLJOYN_STRUCT_OPEN: alljoyn_typeid = alljoyn_typeid(40);
...
pub const ALLJOYN_UINT16: alljoyn_typeid = alljoyn_typeid(113);
pub const ALLJOYN_UINT16_ARRAY: alljoyn_typeid = alljoyn_typeid(29025);
pub const ALLJOYN_UINT32: alljoyn_typeid = alljoyn_typeid(117);
pub const ALLJOYN_UINT32_ARRAY: alljoyn_typeid = alljoyn_typeid(30049);
pub const ALLJOYN_UINT64: alljoyn_typeid = alljoyn_typeid(116);
pub const ALLJOYN_UINT64_ARRAY: alljoyn_typeid = alljoyn_typeid(29793);
pub const ALLJOYN_VARIANT: alljoyn_typeid = alljoyn_typeid(118);
pub const ALLJOYN_WILDCARD: alljoyn_typeid = alljoyn_typeid(42);
pub const ALLJOYN_WRITE_READY: u32 = 2;
pub const ANNOUNCED: alljoyn_about_announceflag = alljoyn_about_announceflag(1);
pub const CAPABLE_ECDHE_ECDSA: alljoyn_claimcapability_masks = alljoyn_claimcapability_masks(4);
pub const CAPABLE_ECDHE_NULL: alljoyn_claimcapability_masks = alljoyn_claimcapability_masks(1);
pub const CAPABLE_ECDHE_SPEKE: alljoyn_claimcapability_masks = alljoyn_claimcapability_masks(8);
pub const CLAIMABLE: alljoyn_applicationstate = alljoyn_applicationstate(1);
pub const CLAIMED: alljoyn_applicationstate = alljoyn_applicationstate(2);
pub const ER_ABOUT_ABOUTDATA_MISSING_REQUIRED_FIELD: QStatus = QStatus(37157);
pub const ER_ABOUT_DEFAULT_LANGUAGE_NOT_SPECIFIED: QStatus = QStatus(37155);
pub const ER_ABOUT_FIELD_ALREADY_SPECIFIED: QStatus = QStatus(37147);
pub const ER_ABOUT_INVALID_ABOUTDATA_FIELD_APPID_SIZE: QStatus = QStatus(37163);
pub const ER_ABOUT_INVALID_ABOUTDATA_FIELD_VALUE: QStatus = QStatus(37162);
pub const ER_ABOUT_INVALID_ABOUTDATA_LISTENER: QStatus = QStatus(37158);
pub const ER_ABOUT_SESSIONPORT_NOT_BOUND: QStatus = QStatus(37156);
pub const ER_ALERTED_THREAD: QStatus = QStatus(4098);
pub const ER_ALLJOYN_ACCESS_PERMISSION_ERROR: QStatus = QStatus(37028);
pub const ER_ALLJOYN_ACCESS_PERMISSION_WARNING: QStatus = QStatus(37027);
pub const ER_ALLJOYN_ADVERTISENAME_REPLY_ALREADY_ADVERTISING: QStatus = QStatus(37005);
pub const ER_ALLJOYN_ADVERTISENAME_REPLY_FAILED: QStatus = QStatus(37006);
pub const ER_ALLJOYN_ADVERTISENAME_REPLY_TRANSPORT_NOT_AVAILABLE: QStatus = QStatus(37004);
pub const ER_ALLJOYN_BINDSESSIONPORT_REPLY_ALREADY_EXISTS: QStatus = QStatus(36992);
pub const ER_ALLJOYN_BINDSESSIONPORT_REPLY_FAILED: QStatus = QStatus(36993);
pub const ER_ALLJOYN_BINDSESSIONPORT_REPLY_INVALID_OPTS: QStatus = QStatus(37018);
pub const ER_ALLJOYN_CANCELADVERTISENAME_REPLY_FAILED: QStatus = QStatus(37008);
pub const ER_ALLJOYN_CANCELFINDADVERTISEDNAME_REPLY_FAILED: QStatus = QStatus(37013);
pub const ER_ALLJOYN_FINDADVERTISEDNAME_REPLY_ALREADY_DISCOVERING: QStatus = QStatus(37010);
pub const ER_ALLJOYN_FINDADVERTISEDNAME_REPLY_FAILED: QStatus = QStatus(37011);
pub const ER_ALLJOYN_FINDADVERTISEDNAME_REPLY_TRANSPORT_NOT_AVAILABLE: QStatus = QStatus(37009);
pub const ER_ALLJOYN_JOINSESSION_REPLY_ALREADY_JOINED: QStatus = QStatus(37019);
pub const ER_ALLJOYN_JOINSESSION_REPLY_BAD_SESSION_OPTS: QStatus = QStatus(36999);
pub const ER_ALLJOYN_JOINSESSION_REPLY_CONNECT_FAILED: QStatus = QStatus(36997);
pub const ER_ALLJOYN_JOINSESSION_REPLY_FAILED: QStatus = QStatus(37000);
pub const ER_ALLJOYN_JOINSESSION_REPLY_NO_SESSION: QStatus = QStatus(36995);
pub const ER_ALLJOYN_JOINSESSION_REPLY_REJECTED: QStatus = QStatus(36998);
pub const ER_ALLJOYN_JOINSESSION_REPLY_UNREACHABLE: QStatus = QStatus(36996);
pub const ER_ALLJOYN_LEAVESESSION_REPLY_FAILED: QStatus = QStatus(37003);
pub const ER_ALLJOYN_LEAVESESSION_REPLY_NO_SESSION: QStatus = QStatus(37002);
pub const ER_ALLJOYN_ONAPPRESUME_REPLY_FAILED: QStatus = QStatus(37100);
pub const ER_ALLJOYN_ONAPPRESUME_REPLY_UNSUPPORTED: QStatus = QStatus(37101);
pub const ER_ALLJOYN_ONAPPSUSPEND_REPLY_FAILED: QStatus = QStatus(37098);
pub const ER_ALLJOYN_ONAPPSUSPEND_REPLY_UNSUPPORTED: QStatus = QStatus(37099);
pub const ER_ALLJOYN_PING_FAILED: QStatus = QStatus(37111);
pub const ER_ALLJOYN_PING_REPLY_FAILED: QStatus = QStatus(37143);
pub const ER_ALLJOYN_PING_REPLY_INCOMPATIBLE_REMOTE_ROUTING_NODE: QStatus = QStatus(37140);
pub const ER_ALLJOYN_PING_REPLY_IN_PROGRESS: QStatus = QStatus(37145);
pub const ER_ALLJOYN_PING_REPLY_TIMEOUT: QStatus = QStatus(37141);
pub const ER_ALLJOYN_PING_REPLY_UNKNOWN_NAME: QStatus = QStatus(37142);
pub const ER_ALLJOYN_PING_REPLY_UNREACHABLE: QStatus = QStatus(37112);
pub const ER_ALLJOYN_REMOVESESSIONMEMBER_INCOMPATIBLE_REMOTE_DAEMON: QStatus = QStatus(37107);
pub const ER_ALLJOYN_REMOVESESSIONMEMBER_NOT_BINDER: QStatus = QStatus(37104);
pub const ER_ALLJOYN_REMOVESESSIONMEMBER_NOT_FOUND: QStatus = QStatus(37106);
pub const ER_ALLJOYN_REMOVESESSIONMEMBER_NOT_MULTIPOINT: QStatus = QStatus(37105);
pub const ER_ALLJOYN_REMOVESESSIONMEMBER_REPLY_FAILED: QStatus = QStatus(37108);
pub const ER_ALLJOYN_REMOVESESSIONMEMBER_REPLY_NO_SESSION: QStatus = QStatus(37103);
pub const ER_ALLJOYN_SETLINKTIMEOUT_REPLY_FAILED: QStatus = QStatus(37026);
pub const ER_ALLJOYN_SETLINKTIMEOUT_REPLY_NOT_SUPPORTED: QStatus = QStatus(37024);
pub const ER_ALLJOYN_SETLINKTIMEOUT_REPLY_NO_DEST_SUPPORT: QStatus = QStatus(37025);
pub const ER_ALLJOYN_UNBINDSESSIONPORT_REPLY_BAD_PORT: QStatus = QStatus(37016);
pub const ER_ALLJOYN_UNBINDSESSIONPORT_REPLY_FAILED: QStatus = QStatus(37017);
pub const ER_APPLICATION_STATE_LISTENER_ALREADY_EXISTS: QStatus = QStatus(37184);
pub const ER_APPLICATION_STATE_LISTENER_NO_SUCH_LISTENER: QStatus = QStatus(37185);
pub const ER_ARDP_BACKPRESSURE: QStatus = QStatus(37122);
pub const ER_ARDP_DISCONNECTING: QStatus = QStatus(37139);
pub const ER_ARDP_INVALID_CONNECTION: QStatus = QStatus(37135);
pub const ER_ARDP_INVALID_RESPONSE: QStatus = QStatus(37134);
pub const ER_ARDP_INVALID_STATE: QStatus = QStatus(37124);
pub const ER_ARDP_PERSIST_TIMEOUT: QStatus = QStatus(37126);
pub const ER_ARDP_PROBE_TIMEOUT: QStatus = QStatus(37127);
pub const ER_ARDP_REMOTE_CONNECTION_RESET: QStatus = QStatus(37128);
pub const ER_ARDP_TTL_EXPIRED: QStatus = QStatus(37125);
pub const ER_ARDP_VERSION_NOT_SUPPORTED: QStatus = QStatus(37151);
pub const ER_ARDP_WRITE_BLOCKED: QStatus = QStatus(37153);
pub const ER_AUTH_FAIL: QStatus = QStatus(4100);
pub const ER_AUTH_USER_REJECT: QStatus = QStatus(4101);
pub const ER_BAD_ARG_1: QStatus = QStatus(12);
pub const ER_BAD_ARG_2: QStatus = QStatus(13);
pub const ER_BAD_ARG_3: QStatus = QStatus(14);
pub const ER_BAD_ARG_4: QStatus = QStatus(15);
pub const ER_BAD_ARG_5: QStatus = QStatus(16);
pub const ER_BAD_ARG_6: QStatus = QStatus(17);
pub const ER_BAD_ARG_7: QStatus = QStatus(18);
pub const ER_BAD_ARG_8: QStatus = QStatus(19);
pub const ER_BAD_ARG_COUNT: QStatus = QStatus(28);
pub const ER_BAD_HOSTNAME: QStatus = QStatus(4112);
pub const ER_BAD_STRING_ENCODING: QStatus = QStatus(4120);
pub const ER_BAD_TRANSPORT_MASK: QStatus = QStatus(37088);
pub const ER_BUFFER_TOO_SMALL: QStatus = QStatus(3);
pub const ER_BUS_ALREADY_CONNECTED: QStatus = QStatus(36932);
pub const ER_BUS_ALREADY_LISTENING: QStatus = QStatus(36934);
pub const ER_BUS_ANNOTATION_ALREADY_EXISTS: QStatus = QStatus(37082);
pub const ER_BUS_AUTHENTICATION_PENDING: QStatus = QStatus(37031);
pub const ER_BUS_BAD_BODY_LEN: QStatus = QStatus(36879);
pub const ER_BUS_BAD_BUS_NAME: QStatus = QStatus(36874);
pub const ER_BUS_BAD_CHILD_PATH: QStatus = QStatus(36927);
pub const ER_BUS_BAD_ERROR_NAME: QStatus = QStatus(36873);
pub const ER_BUS_BAD_HDR_FLAGS: QStatus = QStatus(36878);
pub const ER_BUS_BAD_HEADER_FIELD: QStatus = QStatus(36868);
pub const ER_BUS_BAD_HEADER_LEN: QStatus = QStatus(36880);
pub const ER_BUS_BAD_INTERFACE_NAME: QStatus = QStatus(36872);
pub const ER_BUS_BAD_LENGTH: QStatus = QStatus(36876);
pub const ER_BUS_BAD_MEMBER_NAME: QStatus = QStatus(36871);
pub const ER_BUS_BAD_OBJ_PATH: QStatus = QStatus(36870);
pub const ER_BUS_BAD_SENDER_ID: QStatus = QStatus(36908);
pub const ER_BUS_BAD_SEND_PARAMETER: QStatus = QStatus(36906);
pub const ER_BUS_BAD_SESSION_OPTS: QStatus = QStatus(36980);
pub const ER_BUS_BAD_SIGNATURE: QStatus = QStatus(36869);
pub const ER_BUS_BAD_TRANSPORT_ARGS: QStatus = QStatus(36903);
pub const ER_BUS_BAD_VALUE: QStatus = QStatus(36877);
pub const ER_BUS_BAD_VALUE_TYPE: QStatus = QStatus(36867);
pub const ER_BUS_BAD_XML: QStatus = QStatus(36926);
pub const ER_BUS_BLOCKING_CALL_NOT_ALLOWED: QStatus = QStatus(36960);
pub const ER_BUS_BUS_ALREADY_STARTED: QStatus = QStatus(36939);
pub const ER_BUS_BUS_NOT_STARTED: QStatus = QStatus(36940);
pub const ER_BUS_CANNOT_ADD_HANDLER: QStatus = QStatus(36965);
pub const ER_BUS_CANNOT_ADD_INTERFACE: QStatus = QStatus(36964);
pub const ER_BUS_CANNOT_EXPAND_MESSAGE: QStatus = QStatus(36930);
pub const ER_BUS_CONNECTION_REJECTED: QStatus = QStatus(36981);
pub const ER_BUS_CONNECT_FAILED: QStatus = QStatus(36913);
pub const ER_BUS_CORRUPT_KEYSTORE: QStatus = QStatus(36952);
pub const ER_BUS_DESCRIPTION_ALREADY_EXISTS: QStatus = QStatus(37188);
pub const ER_BUS_DESTINATION_NOT_AUTHENTICATED: QStatus = QStatus(37029);
pub const ER_BUS_ELEMENT_NOT_FOUND: QStatus = QStatus(36976);
pub const ER_BUS_EMPTY_MESSAGE: QStatus = QStatus(36910);
pub const ER_BUS_ENDPOINT_CLOSING: QStatus = QStatus(36920);
pub const ER_BUS_ENDPOINT_REDIRECTED: QStatus = QStatus(37030);
pub const ER_BUS_ERRORS: QStatus = QStatus(36864);
pub const ER_BUS_ERROR_NAME_MISSING: QStatus = QStatus(36890);
pub const ER_BUS_ERROR_RESPONSE: QStatus = QStatus(36925);
pub const ER_BUS_ESTABLISH_FAILED: QStatus = QStatus(36884);
pub const ER_BUS_HANDLES_MISMATCH: QStatus = QStatus(36973);
pub const ER_BUS_HANDLES_NOT_ENABLED: QStatus = QStatus(36972);
pub const ER_BUS_HDR_EXPANSION_INVALID: QStatus = QStatus(36946);
pub const ER_BUS_IFACE_ALREADY_EXISTS: QStatus = QStatus(36924);
pub const ER_BUS_INCOMPATIBLE_DAEMON: QStatus = QStatus(37094);
pub const ER_BUS_INTERFACE_ACTIVATED: QStatus = QStatus(37015);
pub const ER_BUS_INTERFACE_MISMATCH: QStatus = QStatus(36921);
pub const ER_BUS_INTERFACE_MISSING: QStatus = QStatus(36886);
pub const ER_BUS_INTERFACE_NO_SUCH_MEMBER: QStatus = QStatus(36891);
pub const ER_BUS_INVALID_AUTH_MECHANISM: QStatus = QStatus(36958);
pub const ER_BUS_INVALID_HEADER_CHECKSUM: QStatus = QStatus(36942);
pub const ER_BUS_INVALID_HEADER_SERIAL: QStatus = QStatus(36944);
pub const ER_BUS_KEYBLOB_OP_INVALID: QStatus = QStatus(36941);
pub const ER_BUS_KEYSTORE_NOT_LOADED: QStatus = QStatus(36966);
pub const ER_BUS_KEYSTORE_VERSION_MISMATCH: QStatus = QStatus(36959);
pub const ER_BUS_KEY_EXPIRED: QStatus = QStatus(36951);
pub const ER_BUS_KEY_STORE_NOT_LOADED: QStatus = QStatus(36937);
pub const ER_BUS_KEY_UNAVAILABLE: QStatus = QStatus(36935);
pub const ER_BUS_LISTENER_ALREADY_SET: QStatus = QStatus(37022);
pub const ER_BUS_MATCH_RULE_NOT_FOUND: QStatus = QStatus(37110);
pub const ER_BUS_MEMBER_ALREADY_EXISTS: QStatus = QStatus(36922);
pub const ER_BUS_MEMBER_MISSING: QStatus = QStatus(36888);
pub const ER_BUS_MEMBER_NO_SUCH_SIGNATURE: QStatus = QStatus(36896);
pub const ER_BUS_MESSAGE_DECRYPTION_FAILED: QStatus = QStatus(36949);
pub const ER_BUS_MESSAGE_NOT_ENCRYPTED: QStatus = QStatus(36943);
pub const ER_BUS_METHOD_CALL_ABORTED: QStatus = QStatus(36963);
pub const ER_BUS_MISSING_COMPRESSION_TOKEN: QStatus = QStatus(36947);
pub const ER_BUS_NAME_TOO_LONG: QStatus = QStatus(36875);
pub const ER_BUS_NOT_ALLOWED: QStatus = QStatus(36918);
pub const ER_BUS_NOT_AUTHENTICATING: QStatus = QStatus(36915);
pub const ER_BUS_NOT_AUTHORIZED: QStatus = QStatus(37032);
pub const ER_BUS_NOT_A_COMPLETE_TYPE: QStatus = QStatus(36954);
pub const ER_BUS_NOT_A_DICTIONARY: QStatus = QStatus(36977);
pub const ER_BUS_NOT_COMPRESSED: QStatus = QStatus(36931);
pub const ER_BUS_NOT_CONNECTED: QStatus = QStatus(36933);
pub const ER_BUS_NOT_NUL_TERMINATED: QStatus = QStatus(36897);
pub const ER_BUS_NOT_OWNER: QStatus = QStatus(36911);
pub const ER_BUS_NO_AUTHENTICATION_MECHANISM: QStatus = QStatus(36938);
pub const ER_BUS_NO_CALL_FOR_REPLY: QStatus = QStatus(36953);
pub const ER_BUS_NO_ENDPOINT: QStatus = QStatus(36905);
pub const ER_BUS_NO_LISTENER: QStatus = QStatus(36916);
pub const ER_BUS_NO_PEER_GUID: QStatus = QStatus(36948);
pub const ER_BUS_NO_ROUTE: QStatus = QStatus(36904);
pub const ER_BUS_NO_SESSION: QStatus = QStatus(36975);
pub const ER_BUS_NO_SUCH_ANNOTATION: QStatus = QStatus(37081);
pub const ER_BUS_NO_SUCH_HANDLE: QStatus = QStatus(36971);
pub const ER_BUS_NO_SUCH_INTERFACE: QStatus = QStatus(36895);
pub const ER_BUS_NO_SUCH_MESSAGE: QStatus = QStatus(37102);
pub const ER_BUS_NO_SUCH_OBJECT: QStatus = QStatus(36892);
pub const ER_BUS_NO_SUCH_PROPERTY: QStatus = QStatus(36898);
pub const ER_BUS_NO_SUCH_SERVICE: QStatus = QStatus(36956);
pub const ER_BUS_NO_TRANSPORTS: QStatus = QStatus(36902);
pub const ER_BUS_OBJECT_NOT_REGISTERED: QStatus = QStatus(37091);
pub const ER_BUS_OBJECT_NO_SUCH_INTERFACE: QStatus = QStatus(36894);
pub const ER_BUS_OBJECT_NO_SUCH_MEMBER: QStatus = QStatus(36893);
pub const ER_BUS_OBJ_ALREADY_EXISTS: QStatus = QStatus(36928);
pub const ER_BUS_OBJ_NOT_FOUND: QStatus = QStatus(36929);
pub const ER_BUS_PATH_MISSING: QStatus = QStatus(36887);
pub const ER_BUS_PEER_AUTH_VERSION_MISMATCH: QStatus = QStatus(37023);
pub const ER_BUS_PING_GROUP_NOT_FOUND: QStatus = QStatus(37159);
pub const ER_BUS_POLICY_VIOLATION: QStatus = QStatus(36955);
pub const ER_BUS_PROPERTY_ACCESS_DENIED: QStatus = QStatus(36901);
pub const ER_BUS_PROPERTY_ALREADY_EXISTS: QStatus = QStatus(36923);
pub const ER_BUS_PROPERTY_VALUE_NOT_SET: QStatus = QStatus(36900);
pub const ER_BUS_READ_ERROR: QStatus = QStatus(36865);
pub const ER_BUS_REMOVED_BY_BINDER: QStatus = QStatus(37109);
pub const ER_BUS_REMOVED_BY_BINDER_SELF: QStatus = QStatus(37160);
pub const ER_BUS_REPLY_IS_ERROR_MESSAGE: QStatus = QStatus(36914);
pub const ER_BUS_REPLY_SERIAL_MISSING: QStatus = QStatus(36889);
pub const ER_BUS_SECURITY_FATAL: QStatus = QStatus(36950);
pub const ER_BUS_SECURITY_NOT_ENABLED: QStatus = QStatus(37021);
pub const ER_BUS_SELF_CONNECT: QStatus = QStatus(37020);
pub const ER_BUS_SET_PROPERTY_REJECTED: QStatus = QStatus(36912);
pub const ER_BUS_SET_WRONG_SIGNATURE: QStatus = QStatus(36899);
pub const ER_BUS_SIGNATURE_MISMATCH: QStatus = QStatus(36961);
pub const ER_BUS_STOPPING: QStatus = QStatus(36962);
pub const ER_BUS_TIME_TO_LIVE_EXPIRED: QStatus = QStatus(36945);
pub const ER_BUS_TRANSPORT_ACCESS_DENIED: QStatus = QStatus(37164);
pub const ER_BUS_TRANSPORT_NOT_AVAILABLE: QStatus = QStatus(36957);
pub const ER_BUS_TRANSPORT_NOT_STARTED: QStatus = QStatus(36909);
pub const ER_BUS_TRUNCATED: QStatus = QStatus(36936);
pub const ER_BUS_UNEXPECTED_DISPOSITION: QStatus = QStatus(37014);
pub const ER_BUS_UNEXPECTED_SIGNATURE: QStatus = QStatus(36885);
pub const ER_BUS_UNKNOWN_INTERFACE: QStatus = QStatus(36883);
pub const ER_BUS_UNKNOWN_PATH: QStatus = QStatus(36882);
pub const ER_BUS_UNKNOWN_SERIAL: QStatus = QStatus(36881);
pub const ER_BUS_UNMATCHED_REPLY_SERIAL: QStatus = QStatus(36907);
pub const ER_BUS_WAIT_FAILED: QStatus = QStatus(36978);
pub const ER_BUS_WRITE_ERROR: QStatus = QStatus(36866);
pub const ER_BUS_WRITE_QUEUE_FULL: QStatus = QStatus(36919);
pub const ER_CERTIFICATE_NOT_FOUND: QStatus = QStatus(37166);
pub const ER_COMMON_ERRORS: QStatus = QStatus(4096);
pub const ER_CONNECTION_LIMIT_EXCEEDED: QStatus = QStatus(37152);
pub const ER_CONN_REFUSED: QStatus = QStatus(27);
pub const ER_CORRUPT_KEYBLOB: QStatus = QStatus(4115);
pub const ER_CRYPTO_ERROR: QStatus = QStatus(4109);
pub const ER_CRYPTO_HASH_UNINITIALIZED: QStatus = QStatus(4123);
pub const ER_CRYPTO_ILLEGAL_PARAMETERS: QStatus = QStatus(4122);
pub const ER_CRYPTO_INSUFFICIENT_SECURITY: QStatus = QStatus(4121);
pub const ER_CRYPTO_KEY_UNAVAILABLE: QStatus = QStatus(4111);
pub const ER_CRYPTO_KEY_UNUSABLE: QStatus = QStatus(4113);
pub const ER_CRYPTO_TRUNCATED: QStatus = QStatus(4110);
pub const ER_DBUS_RELEASE_NAME_REPLY_NON_EXISTENT: QStatus = QStatus(36987);
pub const ER_DBUS_RELEASE_NAME_REPLY_NOT_OWNER: QStatus = QStatus(36988);
pub const ER_DBUS_RELEASE_NAME_REPLY_RELEASED: QStatus = QStatus(36986);
pub const ER_DBUS_REQUEST_NAME_REPLY_ALREADY_OWNER: QStatus = QStatus(36985);
pub const ER_DBUS_REQUEST_NAME_REPLY_EXISTS: QStatus = QStatus(36984);
pub const ER_DBUS_REQUEST_NAME_REPLY_IN_QUEUE: QStatus = QStatus(36983);
pub const ER_DBUS_REQUEST_NAME_REPLY_PRIMARY_OWNER: QStatus = QStatus(36982);
pub const ER_DBUS_START_REPLY_ALREADY_RUNNING: QStatus = QStatus(36990);
pub const ER_DEADLOCK: QStatus = QStatus(31);
pub const ER_DEAD_THREAD: QStatus = QStatus(4117);
pub const ER_DIGEST_MISMATCH: QStatus = QStatus(37170);
pub const ER_DUPLICATE_CERTIFICATE: QStatus = QStatus(37167);
pub const ER_DUPLICATE_KEY: QStatus = QStatus(37171);
pub const ER_EMPTY_KEY_BLOB: QStatus = QStatus(4114);
pub const ER_END_OF_DATA: QStatus = QStatus(26);
pub const ER_EOF: QStatus = QStatus(30);
pub const ER_EXTERNAL_THREAD: QStatus = QStatus(4108);
pub const ER_FAIL: QStatus = QStatus(1);
pub const ER_FEATURE_NOT_AVAILABLE: QStatus = QStatus(37177);
pub const ER_INIT_FAILED: QStatus = QStatus(7);
pub const ER_INVALID_ADDRESS: QStatus = QStatus(20);
pub const ER_INVALID_APPLICATION_STATE: QStatus = QStatus(37176);
pub const ER_INVALID_CERTIFICATE: QStatus = QStatus(37165);
pub const ER_INVALID_CERTIFICATE_USAGE: QStatus = QStatus(37182);
pub const ER_INVALID_CERT_CHAIN: QStatus = QStatus(37174);
pub const ER_INVALID_CONFIG: QStatus = QStatus(37161);
pub const ER_INVALID_DATA: QStatus = QStatus(21);
pub const ER_INVALID_GUID: QStatus = QStatus(4126);
pub const ER_INVALID_HTTP_METHOD_USED_FOR_RENDEZVOUS_SERVER_INTERFACE_MESSAGE: QStatus = QStatus(37075);
pub const ER_INVALID_KEY_ENCODING: QStatus = QStatus(4116);
pub const ER_INVALID_ON_DEMAND_CONNECTION_MESSAGE_RESPONSE: QStatus = QStatus(37074);
pub const ER_INVALID_PERSISTENT_CONNECTION_MESSAGE_RESPONSE: QStatus = QStatus(37073);
pub const ER_INVALID_RENDEZVOUS_SERVER_INTERFACE_MESSAGE: QStatus = QStatus(37072);
pub const ER_INVALID_SIGNAL_EMISSION_TYPE: QStatus = QStatus(37183);
pub const ER_INVALID_STREAM: QStatus = QStatus(4129);
pub const ER_IODISPATCH_STOPPING: QStatus = QStatus(4131);
pub const ER_KEY_STORE_ALREADY_INITIALIZED: QStatus = QStatus(37178);
pub const ER_KEY_STORE_ID_NOT_YET_SET: QStatus = QStatus(37179);
pub const ER_LANGUAGE_NOT_SUPPORTED: QStatus = QStatus(37146);
pub const ER_MANAGEMENT_ALREADY_STARTED: QStatus = QStatus(37186);
pub const ER_MANAGEMENT_NOT_STARTED: QStatus = QStatus(37187);
pub const ER_MANIFEST_NOT_FOUND: QStatus = QStatus(37173);
pub const ER_MANIFEST_REJECTED: QStatus = QStatus(37181);
pub const ER_MISSING_DIGEST_IN_CERTIFICATE: QStatus = QStatus(37169);
pub const ER_NONE: QStatus = QStatus(65535);
pub const ER_NOT_CONN: QStatus = QStatus(4141);
pub const ER_NOT_CONNECTED_TO_RENDEZVOUS_SERVER: QStatus = QStatus(37070);
pub const ER_NOT_IMPLEMENTED: QStatus = QStatus(9);
pub const ER_NO_COMMON_TRUST: QStatus = QStatus(37172);
pub const ER_NO_SUCH_ALARM: QStatus = QStatus(4102);
pub const ER_NO_SUCH_DEVICE: QStatus = QStatus(37084);
pub const ER_NO_TRUST_ANCHOR: QStatus = QStatus(37175);
pub const ER_OK: QStatus = QStatus(0);
pub const ER_OPEN_FAILED: QStatus = QStatus(24);
pub const ER_OS_ERROR: QStatus = QStatus(4);
pub const ER_OUT_OF_MEMORY: QStatus = QStatus(5);
pub const ER_P2P: QStatus = QStatus(37085);
pub const ER_P2P_BUSY: QStatus = QStatus(37093);
pub const ER_P2P_DISABLED: QStatus = QStatus(37092);
pub const ER_P2P_FORBIDDEN: QStatus = QStatus(37097);
pub const ER_P2P_NOT_CONNECTED: QStatus = QStatus(37087);
pub const ER_P2P_NO_GO: QStatus = QStatus(37095);
pub const ER_P2P_NO_STA: QStatus = QStatus(37096);
pub const ER_P2P_TIMEOUT: QStatus = QStatus(37086);
pub const ER_PACKET_BAD_CRC: QStatus = QStatus(37039);
pub const ER_PACKET_BAD_FORMAT: QStatus = QStatus(37034);
pub const ER_PACKET_BAD_PARAMETER: QStatus = QStatus(37038);
pub const ER_PACKET_BUS_NO_SUCH_CHANNEL: QStatus = QStatus(37033);
pub const ER_PACKET_CHANNEL_FAIL: QStatus = QStatus(37036);
pub const ER_PACKET_CONNECT_TIMEOUT: QStatus = QStatus(37035);
pub const ER_PACKET_TOO_LARGE: QStatus = QStatus(37037);
pub const ER_PARSE_ERROR: QStatus = QStatus(25);
pub const ER_PERMISSION_DENIED: QStatus = QStatus(37154);
pub const ER_POLICY_NOT_NEWER: QStatus = QStatus(37180);
pub const ER_PROXIMITY_CONNECTION_ESTABLISH_FAIL: QStatus = QStatus(37089);
pub const ER_PROXIMITY_NO_PEERS_FOUND: QStatus = QStatus(37090);
pub const ER_READ_ERROR: QStatus = QStatus(22);
pub const ER_RENDEZVOUS_SERVER_DEACTIVATED_USER: QStatus = QStatus(37067);
pub const ER_RENDEZVOUS_SERVER_ERR401_UNAUTHORIZED_REQUEST: QStatus = QStatus(37078);
pub const ER_RENDEZVOUS_SERVER_ERR500_INTERNAL_ERROR: QStatus = QStatus(37076);
pub const ER_RENDEZVOUS_SERVER_ERR503_STATUS_UNAVAILABLE: QStatus = QStatus(37077);
pub const ER_RENDEZVOUS_SERVER_ROOT_CERTIFICATE_UNINITIALIZED: QStatus = QStatus(37080);
pub const ER_RENDEZVOUS_SERVER_UNKNOWN_USER: QStatus = QStatus(37068);
pub const ER_RENDEZVOUS_SERVER_UNRECOVERABLE_ERROR: QStatus = QStatus(37079);
pub const ER_SLAP_CRC_ERROR: QStatus = QStatus(4137);
pub const ER_SLAP_ERROR: QStatus = QStatus(4138);
pub const ER_SLAP_HDR_CHECKSUM_ERROR: QStatus = QStatus(4133);
pub const ER_SLAP_INVALID_PACKET_LEN: QStatus = QStatus(4132);
pub const ER_SLAP_INVALID_PACKET_TYPE: QStatus = QStatus(4134);
pub const ER_SLAP_LEN_MISMATCH: QStatus = QStatus(4135);
pub const ER_SLAP_OTHER_END_CLOSED: QStatus = QStatus(4139);
pub const ER_SLAP_PACKET_TYPE_MISMATCH: QStatus = QStatus(4136);
pub const ER_SOCKET_BIND_ERROR: QStatus = QStatus(6);
pub const ER_SOCK_CLOSING: QStatus = QStatus(37083);
pub const ER_SOCK_OTHER_END_CLOSED: QStatus = QStatus(11);
pub const ER_SSL_CONNECT: QStatus = QStatus(4106);
pub const ER_SSL_ERRORS: QStatus = QStatus(4104);
pub const ER_SSL_INIT: QStatus = QStatus(4105);
pub const ER_SSL_VERIFY: QStatus = QStatus(4107);
pub const ER_STOPPING_THREAD: QStatus = QStatus(4097);
pub const ER_TCP_MAX_UNTRUSTED: QStatus = QStatus(37144);
pub const ER_THREADPOOL_EXHAUSTED: QStatus = QStatus(4127);
pub const ER_THREADPOOL_STOPPING: QStatus = QStatus(4128);
pub const ER_THREAD_NO_WAIT: QStatus = QStatus(4124);
pub const ER_THREAD_RUNNING: QStatus = QStatus(4118);
pub const ER_THREAD_STOPPING: QStatus = QStatus(4119);
pub const ER_TIMEOUT: QStatus = QStatus(10);
pub const ER_TIMER_EXITING: QStatus = QStatus(4125);
pub const ER_TIMER_FALLBEHIND: QStatus = QStatus(4103);
pub const ER_TIMER_FULL: QStatus = QStatus(4130);
pub const ER_TIMER_NOT_ALLOWED: QStatus = QStatus(4140);
pub const ER_UDP_BACKPRESSURE: QStatus = QStatus(37123);
pub const ER_UDP_BUSHELLO: QStatus = QStatus(37129);
pub const ER_UDP_DEMUX_NO_ENDPOINT: QStatus = QStatus(37114);
pub const ER_UDP_DISCONNECT: QStatus = QStatus(37118);
pub const ER_UDP_EARLY_EXIT: QStatus = QStatus(37137);
pub const ER_UDP_ENDPOINT_NOT_STARTED: QStatus = QStatus(37149);
pub const ER_UDP_ENDPOINT_REMOVED: QStatus = QStatus(37150);
pub const ER_UDP_ENDPOINT_STALLED: QStatus = QStatus(37133);
pub const ER_UDP_INVALID: QStatus = QStatus(37131);
pub const ER_UDP_LOCAL_DISCONNECT: QStatus = QStatus(37136);
pub const ER_UDP_LOCAL_DISCONNECT_FAIL: QStatus = QStatus(37138);
pub const ER_UDP_MESSAGE: QStatus = QStatus(37130);
pub const ER_UDP_MSG_TOO_LONG: QStatus = QStatus(37113);
pub const ER_UDP_NOT_DISCONNECTED: QStatus = QStatus(37148);
pub const ER_UDP_NOT_IMPLEMENTED: QStatus = QStatus(37119);
pub const ER_UDP_NO_LISTENER: QStatus = QStatus(37120);
pub const ER_UDP_NO_NETWORK: QStatus = QStatus(37115);
pub const ER_UDP_STOPPING: QStatus = QStatus(37121);
pub const ER_UDP_UNEXPECTED_FLOW: QStatus = QStatus(37117);
pub const ER_UDP_UNEXPECTED_LENGTH: QStatus = QStatus(37116);
pub const ER_UDP_UNSUPPORTED: QStatus = QStatus(37132);
pub const ER_UNABLE_TO_CONNECT_TO_RENDEZVOUS_SERVER: QStatus = QStatus(37069);
pub const ER_UNABLE_TO_SEND_MESSAGE_TO_RENDEZVOUS_SERVER: QStatus = QStatus(37071);
pub const ER_UNKNOWN_CERTIFICATE: QStatus = QStatus(37168);
pub const ER_UTF_CONVERSION_FAILED: QStatus = QStatus(2);
pub const ER_WARNING: QStatus = QStatus(29);
pub const ER_WOULDBLOCK: QStatus = QStatus(8);
pub const ER_WRITE_ERROR: QStatus = QStatus(23);
pub const ER_XML_ACLS_MISSING: QStatus = QStatus(8211);
pub const ER_XML_ACL_ALL_TYPE_PEER_WITH_OTHERS: QStatus = QStatus(8207);
pub const ER_XML_ACL_PEERS_MISSING: QStatus = QStatus(8212);
pub const ER_XML_ACL_PEER_NOT_UNIQUE: QStatus = QStatus(8209);
pub const ER_XML_ACL_PEER_PUBLIC_KEY_SET: QStatus = QStatus(8210);
pub const ER_XML_ANNOTATION_NOT_UNIQUE: QStatus = QStatus(8222);
pub const ER_XML_CONVERTER_ERROR: QStatus = QStatus(8192);
pub const ER_XML_INTERFACE_MEMBERS_MISSING: QStatus = QStatus(8194);
pub const ER_XML_INTERFACE_NAME_NOT_UNIQUE: QStatus = QStatus(8219);
pub const ER_XML_INVALID_ACL_PEER_CHILDREN_COUNT: QStatus = QStatus(8206);
pub const ER_XML_INVALID_ACL_PEER_PUBLIC_KEY: QStatus = QStatus(8208);
pub const ER_XML_INVALID_ACL_PEER_TYPE: QStatus = QStatus(8205);
pub const ER_XML_INVALID_ANNOTATIONS_COUNT: QStatus = QStatus(8198);
pub const ER_XML_INVALID_ATTRIBUTE_VALUE: QStatus = QStatus(8200);
pub const ER_XML_INVALID_BASE64: QStatus = QStatus(8218);
pub const ER_XML_INVALID_ELEMENT_CHILDREN_COUNT: QStatus = QStatus(8202);
pub const ER_XML_INVALID_ELEMENT_NAME: QStatus = QStatus(8199);
pub const ER_XML_INVALID_INTERFACE_NAME: QStatus = QStatus(8214);
pub const ER_XML_INVALID_MANIFEST_VERSION: QStatus = QStatus(8216);
pub const ER_XML_INVALID_MEMBER_ACTION: QStatus = QStatus(8196);
pub const ER_XML_INVALID_MEMBER_NAME: QStatus = QStatus(8215);
pub const ER_XML_INVALID_MEMBER_TYPE: QStatus = QStatus(8195);
pub const ER_XML_INVALID_OBJECT_PATH: QStatus = QStatus(8213);
pub const ER_XML_INVALID_OID: QStatus = QStatus(8217);
pub const ER_XML_INVALID_POLICY_SERIAL_NUMBER: QStatus = QStatus(8204);
pub const ER_XML_INVALID_POLICY_VERSION: QStatus = QStatus(8203);
pub const ER_XML_INVALID_RULES_COUNT: QStatus = QStatus(8193);
pub const ER_XML_INVALID_SECURITY_LEVEL_ANNOTATION_VALUE: QStatus = QStatus(8201);
pub const ER_XML_MALFORMED: QStatus = QStatus(4099);
pub const ER_XML_MEMBER_DENY_ACTION_WITH_OTHER: QStatus = QStatus(8197);
pub const ER_XML_MEMBER_NAME_NOT_UNIQUE: QStatus = QStatus(8220);
pub const ER_XML_OBJECT_PATH_NOT_UNIQUE: QStatus = QStatus(8221);
pub const NEED_UPDATE: alljoyn_applicationstate = alljoyn_applicationstate(3);
pub const NOT_CLAIMABLE: alljoyn_applicationstate = alljoyn_applicationstate(0);
pub const PASSWORD_GENERATED_BY_APPLICATION: alljoyn_claimcapabilityadditionalinfo_masks = alljoyn_claimcapabilityadditionalinfo_masks(2);
pub const PASSWORD_GENERATED_BY_SECURITY_MANAGER: alljoyn_claimcapabilityadditionalinfo_masks = alljoyn_claimcapabilityadditionalinfo_masks(1);
pub const QCC_FALSE: u32 = 0;
pub const QCC_TRUE: u32 = 1;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct QStatus(pub i32);
pub const UNANNOUNCED: alljoyn_about_announceflag = alljoyn_about_announceflag(0);
