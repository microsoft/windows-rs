...
pub unsafe fn DevCreateObjectQuery(objecttype: DEV_OBJECT_TYPE, queryflags: u32, prequestedproperties: ::core::option::Option<&[super::Properties::DEVPROPCOMPKEY]>, pfilter: ::core::option::Option<&[DEVPROP_FILTER_EXPRESSION]>, pcallback: PDEV_QUERY_RESULT_CALLBACK, pcontext: *const ::core::ffi::c_void) -> ::windows::core::Result<*mut HDEVQUERY__> {
    #[cfg(windows)]
    {
        ...
        DevCreateObjectQuery(
            ...
            prequestedproperties.as_ref().map_or(0, |value| value.len()) as _,
            ::core::mem::transmute(prequestedproperties.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())),
            pfilter.as_ref().map_or(0, |value| value.len()) as _,
            ::core::mem::transmute(pfilter.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())),
...
pub unsafe fn DevCreateObjectQueryEx(objecttype: DEV_OBJECT_TYPE, queryflags: u32, prequestedproperties: ::core::option::Option<&[super::Properties::DEVPROPCOMPKEY]>, pfilter: ::core::option::Option<&[DEVPROP_FILTER_EXPRESSION]>, pextendedparameters: ::core::option::Option<&[DEV_QUERY_PARAMETER]>, pcallback: PDEV_QUERY_RESULT_CALLBACK, pcontext: *const ::core::ffi::c_void) -> ::windows::core::Result<*mut HDEVQUERY__> {
    #[cfg(windows)]
    {
        ...
        DevCreateObjectQueryEx(
            ...
            pfilter.as_ref().map_or(0, |value| value.len()) as _,
            ::core::mem::transmute(pfilter.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())),
            pextendedparameters.as_ref().map_or(0, |value| value.len()) as _,
            ::core::mem::transmute(pextendedparameters.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())),
            ::core::mem::transmute(pcallback),
            ::core::mem::transmute(pcontext),
            ::core::mem::transmute(&mut result__),
        )
...
#[cfg(feature = "Win32_Devices_Properties")]
#[inline]
pub unsafe fn DevFindProperty<'a, Param2: ::windows::core::IntoParam<'a, ::windows::core::PCWSTR>>(pkey: *const super::Properties::DEVPROPKEY, store: super::Properties::DEVPROPSTORE, pszlocalename: Param2, pproperties: ::core::option::Option<&[super::Properties::DEVPROPERTY]>) -> *mut super::Properties::DEVPROPERTY {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
        ...
        ::core::mem::transmute(DevFindProperty(::core::mem::transmute(pkey), ::core::mem::transmute(store), pszlocalename.into_param().abi(), pproperties.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(pproperties.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr()))))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn DevGetObjectProperties<'a, Param1: ::windows::core::IntoParam<'a, ::windows::core::PCWSTR>>(objecttype: DEV_OBJECT_TYPE, pszobjectid: Param1, queryflags: u32, prequestedproperties: &[super::Properties::DEVPROPCOMPKEY], pcpropertycount: *mut u32, ppproperties: *mut *mut super::Properties::DEVPROPERTY) -> ::windows::core::Result<()> {
    #[cfg(windows)]
    {
        ...
        DevGetObjectProperties(::core::mem::transmute(objecttype), pszobjectid.into_param().abi(), ::core::mem::transmute(queryflags), prequestedproperties.len() as _, ::core::mem::transmute(prequestedproperties.as_ptr()), ::core::mem::transmute(pcpropertycount), ::core::mem::transmute(ppproperties)).ok()
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn DevGetObjects(objecttype: DEV_OBJECT_TYPE, queryflags: u32, prequestedproperties: ::core::option::Option<&[super::Properties::DEVPROPCOMPKEY]>, pfilter: ::core::option::Option<&[DEVPROP_FILTER_EXPRESSION]>, pcobjectcount: *mut u32, ppobjects: *mut *mut DEV_OBJECT) -> ::windows::core::Result<()> {
    #[cfg(windows)]
    {
        ...
        DevGetObjects(::core::mem::transmute(objecttype), ::core::mem::transmute(queryflags), prequestedproperties.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(prequestedproperties.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), pfilter.as_ref().map_or(0, |value| value.len()) as _, ::core::mem::transmute(pfilter.as_ref().map_or_else(::core::ptr::null, |value| value.as_ptr())), ::core::mem::transmute(pcobjectcount), ::core::mem::transmute(ppobjects)).ok()
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
