...
pub unsafe fn BRUSHOBJ_hGetColorTransform(pbo: *mut BRUSHOBJ) -> super::super::Foundation::HANDLE {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn BRUSHOBJ_hGetColorTransform ( pbo : *mut BRUSHOBJ ) -> super::super::Foundation:: HANDLE );
...
pub unsafe fn BRUSHOBJ_pvAllocRbrush(pbo: *mut BRUSHOBJ, cj: u32) -> *mut ::core::ffi::c_void {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn BRUSHOBJ_pvAllocRbrush ( pbo : *mut BRUSHOBJ , cj : u32 ) -> *mut ::core::ffi::c_void );
    BRUSHOBJ_pvAllocRbrush(::core::mem::transmute(pbo), cj)
}
#[doc = "*Required features: `\"Win32_Devices_Display\"`*"]
#[inline]
pub unsafe fn BRUSHOBJ_pvGetRbrush(pbo: *mut BRUSHOBJ) -> *mut ::core::ffi::c_void {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn BRUSHOBJ_pvGetRbrush ( pbo : *mut BRUSHOBJ ) -> *mut ::core::ffi::c_void );
    BRUSHOBJ_pvGetRbrush(::core::mem::transmute(pbo))
}
#[doc = "*Required features: `\"Win32_Devices_Display\"`*"]
#[inline]
pub unsafe fn BRUSHOBJ_ulGetBrushColor(pbo: *mut BRUSHOBJ) -> u32 {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn BRUSHOBJ_ulGetBrushColor ( pbo : *mut BRUSHOBJ ) -> u32 );
...
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn CLIPOBJ_cEnumStart ( pco : *mut CLIPOBJ , ball : super::super::Foundation:: BOOL , itype : u32 , idirection : u32 , climit : u32 ) -> u32 );
...
pub unsafe fn CLIPOBJ_ppoGetPath(pco: *mut CLIPOBJ) -> *mut PATHOBJ {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn CLIPOBJ_ppoGetPath ( pco : *mut CLIPOBJ ) -> *mut PATHOBJ );
...
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn CapabilitiesRequestAndCapabilitiesReply ( hmonitor : super::super::Foundation:: HANDLE , pszasciicapabilitiesstring : :: windows::core::PSTR , dwcapabilitiesstringlengthincharacters : u32 ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn DegaussMonitor ( hmonitor : super::super::Foundation:: HANDLE ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn DestroyPhysicalMonitor ( hmonitor : super::super::Foundation:: HANDLE ) -> i32 );
...
pub unsafe fn DestroyPhysicalMonitors(pphysicalmonitorarray: &[PHYSICAL_MONITOR]) -> i32 {
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn DestroyPhysicalMonitors ( dwphysicalmonitorarraysize : u32 , pphysicalmonitorarray : *const PHYSICAL_MONITOR ) -> i32 );
...
pub unsafe fn DisplayConfigGetDeviceInfo(requestpacket: *mut DISPLAYCONFIG_DEVICE_INFO_HEADER) -> i32 {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DisplayConfigGetDeviceInfo ( requestpacket : *mut DISPLAYCONFIG_DEVICE_INFO_HEADER ) -> i32 );
...
pub unsafe fn DisplayConfigSetDeviceInfo(setpacket: *const DISPLAYCONFIG_DEVICE_INFO_HEADER) -> i32 {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn DisplayConfigSetDeviceInfo ( setpacket : *const DISPLAYCONFIG_DEVICE_INFO_HEADER ) -> i32 );
...
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngAcquireSemaphore ( hsem : HSEMAPHORE ) -> ( ) );
...
pub unsafe fn EngAlphaBlend(psodest: *mut SURFOBJ, psosrc: *mut SURFOBJ, pco: *mut CLIPOBJ, pxlo: *mut XLATEOBJ, prcldest: *mut super::super::Foundation::RECTL, prclsrc: *mut super::super::Foundation::RECTL, pblendobj: *mut BLENDOBJ) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngAlphaBlend ( psodest : *mut SURFOBJ , psosrc : *mut SURFOBJ , pco : *mut CLIPOBJ , pxlo : *mut XLATEOBJ , prcldest : *mut super::super::Foundation:: RECTL , prclsrc : *mut super::super::Foundation:: RECTL , pblendobj : *mut BLENDOBJ ) -> super::super::Foundation:: BOOL );
...
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngAssociateSurface ( hsurf : HSURF , hdev : HDEV , flhooks : u32 ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn EngComputeGlyphSet(ncodepage: i32, nfirstchar: i32, cchars: i32) -> *mut FD_GLYPHSET {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngComputeGlyphSet ( ncodepage : i32 , nfirstchar : i32 , cchars : i32 ) -> *mut FD_GLYPHSET );
...
pub unsafe fn EngCreateBitmap(sizl: super::super::Foundation::SIZE, lwidth: i32, iformat: u32, fl: u32, pvbits: *mut ::core::ffi::c_void) -> super::super::Graphics::Gdi::HBITMAP {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngCreateBitmap ( sizl : super::super::Foundation:: SIZE , lwidth : i32 , iformat : u32 , fl : u32 , pvbits : *mut ::core::ffi::c_void ) -> super::super::Graphics::Gdi:: HBITMAP );
...
pub unsafe fn EngCreateClip() -> *mut CLIPOBJ {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngCreateClip ( ) -> *mut CLIPOBJ );
    EngCreateClip()
}
#[doc = "*Required features: `\"Win32_Devices_Display\"`, `\"Win32_Foundation\"`, `\"Win32_Graphics_Gdi\"`*"]
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Graphics_Gdi"))]
...
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngCreateDeviceBitmap ( dhsurf : DHSURF , sizl : super::super::Foundation:: SIZE , iformatcompat : u32 ) -> super::super::Graphics::Gdi:: HBITMAP );
...
where
    P0: ::std::convert::Into<DHSURF>,
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngCreateDeviceSurface ( dhsurf : DHSURF , sizl : super::super::Foundation:: SIZE , iformatcompat : u32 ) -> HSURF );
...
pub unsafe fn EngCreatePalette(imode: u32, ccolors: u32, pulcolors: *mut u32, flred: u32, flgreen: u32, flblue: u32) -> super::super::Graphics::Gdi::HPALETTE {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngCreatePalette ( imode : u32 , ccolors : u32 , pulcolors : *mut u32 , flred : u32 , flgreen : u32 , flblue : u32 ) -> super::super::Graphics::Gdi:: HPALETTE );
...
pub unsafe fn EngCreateSemaphore() -> HSEMAPHORE {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngCreateSemaphore ( ) -> HSEMAPHORE );
    EngCreateSemaphore()
}
#[doc = "*Required features: `\"Win32_Devices_Display\"`, `\"Win32_Foundation\"`*"]
#[cfg(feature = "Win32_Foundation")]
...
pub unsafe fn EngDeleteClip(pco: ::core::option::Option<*const CLIPOBJ>) {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngDeleteClip ( pco : *const CLIPOBJ ) -> ( ) );
...
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngDeletePalette ( hpal : super::super::Graphics::Gdi:: HPALETTE ) -> super::super::Foundation:: BOOL );
    EngDeletePalette(hpal.into())
}
#[doc = "*Required features: `\"Win32_Devices_Display\"`*"]
#[inline]
pub unsafe fn EngDeletePath(ppo: *mut PATHOBJ) {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngDeletePath ( ppo : *mut PATHOBJ ) -> ( ) );
...
where
    P0: ::std::convert::Into<HSEMAPHORE>,
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngDeleteSemaphore ( hsem : HSEMAPHORE ) -> ( ) );
...
pub unsafe fn EngFillPath(pso: *mut SURFOBJ, ppo: *mut PATHOBJ, pco: *mut CLIPOBJ, pbo: *mut BRUSHOBJ, pptlbrushorg: *mut super::super::Foundation::POINTL, mix: u32, floptions: u32) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngFillPath ( pso : *mut SURFOBJ , ppo : *mut PATHOBJ , pco : *mut CLIPOBJ , pbo : *mut BRUSHOBJ , pptlbrushorg : *mut super::super::Foundation:: POINTL , mix : u32 , floptions : u32 ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngFindResource ( h : super::super::Foundation:: HANDLE , iname : i32 , itype : i32 , pulsize : *mut u32 ) -> *mut ::core::ffi::c_void );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngFreeModule ( h : super::super::Foundation:: HANDLE ) -> ( ) );
    EngFreeModule(h.into())
}
#[doc = "*Required features: `\"Win32_Devices_Display\"`*"]
#[inline]
pub unsafe fn EngGetCurrentCodePage(oemcodepage: *mut u16, ansicodepage: *mut u16) {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngGetCurrentCodePage ( oemcodepage : *mut u16 , ansicodepage : *mut u16 ) -> ( ) );
...
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngGetDriverName ( hdev : HDEV ) -> :: windows::core::PWSTR );
...
where
    P0: ::std::convert::Into<HDEV>,
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngGetPrinterDataFileName ( hdev : HDEV ) -> :: windows::core::PWSTR );
...
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngLoadModule ( pwsz : :: windows::core::PCWSTR ) -> super::super::Foundation:: HANDLE );
...
where
    P0: ::std::convert::Into<HSURF>,
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngLockSurface ( hsurf : HSURF ) -> *mut SURFOBJ );
...
pub unsafe fn EngMultiByteToUnicodeN(unicodestring: ::windows::core::PWSTR, maxbytesinunicodestring: u32, bytesinunicodestring: ::core::option::Option<*mut u32>, multibytestring: &[u8]) {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngMultiByteToUnicodeN ( unicodestring : :: windows::core::PWSTR , maxbytesinunicodestring : u32 , bytesinunicodestring : *mut u32 , multibytestring : :: windows::core::PCSTR , bytesinmultibytestring : u32 ) -> ( ) );
...
pub unsafe fn EngMultiByteToWideChar(codepage: u32, widecharstring: ::windows::core::PWSTR, bytesinwidecharstring: i32, multibytestring: ::core::option::Option<&[u8]>) -> i32 {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngMultiByteToWideChar ( codepage : u32 , widecharstring : :: windows::core::PWSTR , bytesinwidecharstring : i32 , multibytestring : :: windows::core::PCSTR , bytesinmultibytestring : i32 ) -> i32 );
...
pub unsafe fn EngPaint(pso: *mut SURFOBJ, pco: *mut CLIPOBJ, pbo: *mut BRUSHOBJ, pptlbrushorg: *mut super::super::Foundation::POINTL, mix: u32) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngPaint ( pso : *mut SURFOBJ , pco : *mut CLIPOBJ , pbo : *mut BRUSHOBJ , pptlbrushorg : *mut super::super::Foundation:: POINTL , mix : u32 ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn EngQueryLocalTime(param0: *mut ENG_TIME_FIELDS) {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngQueryLocalTime ( param0 : *mut ENG_TIME_FIELDS ) -> ( ) );
...
where
    P0: ::std::convert::Into<HSEMAPHORE>,
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngReleaseSemaphore ( hsem : HSEMAPHORE ) -> ( ) );
...
pub unsafe fn EngStrokePath(pso: *mut SURFOBJ, ppo: *mut PATHOBJ, pco: *mut CLIPOBJ, pxo: *mut XFORMOBJ, pbo: *mut BRUSHOBJ, pptlbrushorg: *mut super::super::Foundation::POINTL, plineattrs: *mut LINEATTRS, mix: u32) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngStrokePath ( pso : *mut SURFOBJ , ppo : *mut PATHOBJ , pco : *mut CLIPOBJ , pxo : *mut XFORMOBJ , pbo : *mut BRUSHOBJ , pptlbrushorg : *mut super::super::Foundation:: POINTL , plineattrs : *mut LINEATTRS , mix : u32 ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngUnicodeToMultiByteN ( multibytestring : :: windows::core::PSTR , maxbytesinmultibytestring : u32 , bytesinmultibytestring : *mut u32 , unicodestring : :: windows::core::PCWSTR , bytesinunicodestring : u32 ) -> ( ) );
...
pub unsafe fn EngUnlockSurface(pso: *mut SURFOBJ) {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngUnlockSurface ( pso : *mut SURFOBJ ) -> ( ) );
...
where
    P0: ::std::convert::Into<::windows::core::PCWSTR>,
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn EngWideCharToMultiByte ( codepage : u32 , widecharstring : :: windows::core::PCWSTR , bytesinwidecharstring : i32 , multibytestring : :: windows::core::PSTR , bytesinmultibytestring : i32 ) -> i32 );
...
pub unsafe fn FONTOBJ_cGetAllGlyphHandles(pfo: *mut FONTOBJ, phg: *mut u32) -> u32 {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn FONTOBJ_cGetAllGlyphHandles ( pfo : *mut FONTOBJ , phg : *mut u32 ) -> u32 );
...
pub unsafe fn FONTOBJ_cGetGlyphs(pfo: *mut FONTOBJ, imode: u32, cglyph: u32, phg: *mut u32, ppvglyph: *mut *mut ::core::ffi::c_void) -> u32 {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn FONTOBJ_cGetGlyphs ( pfo : *mut FONTOBJ , imode : u32 , cglyph : u32 , phg : *mut u32 , ppvglyph : *mut *mut ::core::ffi::c_void ) -> u32 );
...
pub unsafe fn FONTOBJ_pQueryGlyphAttrs(pfo: *mut FONTOBJ, imode: u32) -> *mut FD_GLYPHATTR {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn FONTOBJ_pQueryGlyphAttrs ( pfo : *mut FONTOBJ , imode : u32 ) -> *mut FD_GLYPHATTR );
...
pub unsafe fn FONTOBJ_pfdg(pfo: *mut FONTOBJ) -> *mut FD_GLYPHSET {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn FONTOBJ_pfdg ( pfo : *mut FONTOBJ ) -> *mut FD_GLYPHSET );
...
pub unsafe fn FONTOBJ_pifi(pfo: *const FONTOBJ) -> *mut IFIMETRICS {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn FONTOBJ_pifi ( pfo : *const FONTOBJ ) -> *mut IFIMETRICS );
...
pub unsafe fn FONTOBJ_pvTrueTypeFontFile(pfo: *mut FONTOBJ, pcjfile: *mut u32) -> *mut ::core::ffi::c_void {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn FONTOBJ_pvTrueTypeFontFile ( pfo : *mut FONTOBJ , pcjfile : *mut u32 ) -> *mut ::core::ffi::c_void );
...
pub unsafe fn FONTOBJ_vGetInfo(pfo: *mut FONTOBJ, cjsize: u32, pfi: *mut FONTINFO) {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn FONTOBJ_vGetInfo ( pfo : *mut FONTOBJ , cjsize : u32 , pfi : *mut FONTINFO ) -> ( ) );
...
pub unsafe fn GetAutoRotationState(pstate: *mut AR_STATE) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn GetAutoRotationState ( pstate : *mut AR_STATE ) -> super::super::Foundation:: BOOL );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn GetCapabilitiesStringLength ( hmonitor : super::super::Foundation:: HANDLE , pdwcapabilitiesstringlengthincharacters : *mut u32 ) -> i32 );
...
pub unsafe fn GetDisplayAutoRotationPreferences(porientation: *mut ORIENTATION_PREFERENCE) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn GetDisplayAutoRotationPreferences ( porientation : *mut ORIENTATION_PREFERENCE ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn GetDisplayConfigBufferSizes(flags: u32, numpatharrayelements: *mut u32, nummodeinfoarrayelements: *mut u32) -> i32 {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn GetDisplayConfigBufferSizes ( flags : u32 , numpatharrayelements : *mut u32 , nummodeinfoarrayelements : *mut u32 ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn GetMonitorBrightness ( hmonitor : super::super::Foundation:: HANDLE , pdwminimumbrightness : *mut u32 , pdwcurrentbrightness : *mut u32 , pdwmaximumbrightness : *mut u32 ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn GetMonitorCapabilities ( hmonitor : super::super::Foundation:: HANDLE , pdwmonitorcapabilities : *mut u32 , pdwsupportedcolortemperatures : *mut u32 ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn GetMonitorColorTemperature ( hmonitor : super::super::Foundation:: HANDLE , pctcurrentcolortemperature : *mut MC_COLOR_TEMPERATURE ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn GetMonitorContrast ( hmonitor : super::super::Foundation:: HANDLE , pdwminimumcontrast : *mut u32 , pdwcurrentcontrast : *mut u32 , pdwmaximumcontrast : *mut u32 ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn GetMonitorDisplayAreaPosition ( hmonitor : super::super::Foundation:: HANDLE , ptpositiontype : MC_POSITION_TYPE , pdwminimumposition : *mut u32 , pdwcurrentposition : *mut u32 , pdwmaximumposition : *mut u32 ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn GetMonitorDisplayAreaSize ( hmonitor : super::super::Foundation:: HANDLE , stsizetype : MC_SIZE_TYPE , pdwminimumwidthorheight : *mut u32 , pdwcurrentwidthorheight : *mut u32 , pdwmaximumwidthorheight : *mut u32 ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn GetMonitorRedGreenOrBlueDrive ( hmonitor : super::super::Foundation:: HANDLE , dtdrivetype : MC_DRIVE_TYPE , pdwminimumdrive : *mut u32 , pdwcurrentdrive : *mut u32 , pdwmaximumdrive : *mut u32 ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn GetMonitorRedGreenOrBlueGain ( hmonitor : super::super::Foundation:: HANDLE , gtgaintype : MC_GAIN_TYPE , pdwminimumgain : *mut u32 , pdwcurrentgain : *mut u32 , pdwmaximumgain : *mut u32 ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn GetMonitorTechnologyType ( hmonitor : super::super::Foundation:: HANDLE , pdtydisplaytechnologytype : *mut MC_DISPLAY_TECHNOLOGY_TYPE ) -> i32 );
...
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn GetNumberOfPhysicalMonitorsFromHMONITOR ( hmonitor : super::super::Graphics::Gdi:: HMONITOR , pdwnumberofphysicalmonitors : *mut u32 ) -> i32 );
...
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn GetNumberOfPhysicalMonitorsFromIDirect3DDevice9 ( pdirect3ddevice9 : * mut::core::ffi::c_void , pdwnumberofphysicalmonitors : *mut u32 ) -> :: windows::core::HRESULT );
...
where
    P0: ::std::convert::Into<super::super::Graphics::Gdi::HMONITOR>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn GetPhysicalMonitorsFromHMONITOR ( hmonitor : super::super::Graphics::Gdi:: HMONITOR , dwphysicalmonitorarraysize : u32 , pphysicalmonitorarray : *mut PHYSICAL_MONITOR ) -> i32 );
...
where
    P0: ::std::convert::Into<::windows::core::InParam<'a, super::super::Graphics::Direct3D9::IDirect3DDevice9>>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn GetPhysicalMonitorsFromIDirect3DDevice9 ( pdirect3ddevice9 : * mut::core::ffi::c_void , dwphysicalmonitorarraysize : u32 , pphysicalmonitorarray : *mut PHYSICAL_MONITOR ) -> :: windows::core::HRESULT );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn GetTimingReport ( hmonitor : super::super::Foundation:: HANDLE , pmtrmonitortimingreport : *mut MC_TIMING_REPORT ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn GetVCPFeatureAndVCPFeatureReply ( hmonitor : super::super::Foundation:: HANDLE , bvcpcode : u8 , pvct : *mut MC_VCP_CODE_TYPE , pdwcurrentvalue : *mut u32 , pdwmaximumvalue : *mut u32 ) -> i32 );
...
pub unsafe fn HT_Get8BPPFormatPalette(ppaletteentry: ::core::option::Option<*mut super::super::Graphics::Gdi::PALETTEENTRY>, redgamma: u16, greengamma: u16, bluegamma: u16) -> i32 {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn HT_Get8BPPFormatPalette ( ppaletteentry : *mut super::super::Graphics::Gdi:: PALETTEENTRY , redgamma : u16 , greengamma : u16 , bluegamma : u16 ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::BOOL>,
{
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn HT_Get8BPPMaskPalette ( ppaletteentry : *mut super::super::Graphics::Gdi:: PALETTEENTRY , use8bppmaskpal : super::super::Foundation:: BOOL , cmymask : u8 , redgamma : u16 , greengamma : u16 , bluegamma : u16 ) -> i32 );
...
pub unsafe fn PATHOBJ_vEnumStart(ppo: *mut PATHOBJ) {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn PATHOBJ_vEnumStart ( ppo : *mut PATHOBJ ) -> ( ) );
...
pub unsafe fn PATHOBJ_vEnumStartClipLines(ppo: *mut PATHOBJ, pco: *mut CLIPOBJ, pso: *mut SURFOBJ, pla: *mut LINEATTRS) {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn PATHOBJ_vEnumStartClipLines ( ppo : *mut PATHOBJ , pco : *mut CLIPOBJ , pso : *mut SURFOBJ , pla : *mut LINEATTRS ) -> ( ) );
...
pub unsafe fn PATHOBJ_vGetBounds(ppo: *mut PATHOBJ, prectfx: *mut RECTFX) {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn PATHOBJ_vGetBounds ( ppo : *mut PATHOBJ , prectfx : *mut RECTFX ) -> ( ) );
...
pub unsafe fn QueryDisplayConfig(flags: u32, numpatharrayelements: *mut u32, patharray: *mut DISPLAYCONFIG_PATH_INFO, nummodeinfoarrayelements: *mut u32, modeinfoarray: *mut DISPLAYCONFIG_MODE_INFO, currenttopologyid: *mut DISPLAYCONFIG_TOPOLOGY_ID) -> i32 {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn QueryDisplayConfig ( flags : u32 , numpatharrayelements : *mut u32 , patharray : *mut DISPLAYCONFIG_PATH_INFO , nummodeinfoarrayelements : *mut u32 , modeinfoarray : *mut DISPLAYCONFIG_MODE_INFO , currenttopologyid : *mut DISPLAYCONFIG_TOPOLOGY_ID ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn RestoreMonitorFactoryColorDefaults ( hmonitor : super::super::Foundation:: HANDLE ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn RestoreMonitorFactoryDefaults ( hmonitor : super::super::Foundation:: HANDLE ) -> i32 );
...
pub unsafe fn STROBJ_bEnum(pstro: *mut STROBJ, pc: *mut u32, ppgpos: *mut *mut GLYPHPOS) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn STROBJ_bEnum ( pstro : *mut STROBJ , pc : *mut u32 , ppgpos : *mut *mut GLYPHPOS ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn STROBJ_dwGetCodePage(pstro: *mut STROBJ) -> u32 {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn STROBJ_dwGetCodePage ( pstro : *mut STROBJ ) -> u32 );
...
pub unsafe fn STROBJ_vEnumStart(pstro: *mut STROBJ) {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn STROBJ_vEnumStart ( pstro : *mut STROBJ ) -> ( ) );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn SaveCurrentMonitorSettings ( hmonitor : super::super::Foundation:: HANDLE ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn SaveCurrentSettings ( hmonitor : super::super::Foundation:: HANDLE ) -> i32 );
...
pub unsafe fn SetDisplayAutoRotationPreferences(orientation: ORIENTATION_PREFERENCE) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn SetDisplayAutoRotationPreferences ( orientation : ORIENTATION_PREFERENCE ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn SetDisplayConfig(patharray: ::core::option::Option<&[DISPLAYCONFIG_PATH_INFO]>, modeinfoarray: ::core::option::Option<&[DISPLAYCONFIG_MODE_INFO]>, flags: u32) -> i32 {
    ::windows::core::windows_link ! ( "user32.dll" ,"system" fn SetDisplayConfig ( numpatharrayelements : u32 , patharray : *const DISPLAYCONFIG_PATH_INFO , nummodeinfoarrayelements : u32 , modeinfoarray : *const DISPLAYCONFIG_MODE_INFO , flags : u32 ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn SetMonitorBrightness ( hmonitor : super::super::Foundation:: HANDLE , dwnewbrightness : u32 ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn SetMonitorColorTemperature ( hmonitor : super::super::Foundation:: HANDLE , ctcurrentcolortemperature : MC_COLOR_TEMPERATURE ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn SetMonitorContrast ( hmonitor : super::super::Foundation:: HANDLE , dwnewcontrast : u32 ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn SetMonitorDisplayAreaPosition ( hmonitor : super::super::Foundation:: HANDLE , ptpositiontype : MC_POSITION_TYPE , dwnewposition : u32 ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn SetMonitorDisplayAreaSize ( hmonitor : super::super::Foundation:: HANDLE , stsizetype : MC_SIZE_TYPE , dwnewdisplayareawidthorheight : u32 ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn SetMonitorRedGreenOrBlueDrive ( hmonitor : super::super::Foundation:: HANDLE , dtdrivetype : MC_DRIVE_TYPE , dwnewdrive : u32 ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn SetMonitorRedGreenOrBlueGain ( hmonitor : super::super::Foundation:: HANDLE , gtgaintype : MC_GAIN_TYPE , dwnewgain : u32 ) -> i32 );
...
where
    P0: ::std::convert::Into<super::super::Foundation::HANDLE>,
{
    ::windows::core::windows_link ! ( "dxva2.dll" ,"system" fn SetVCPFeature ( hmonitor : super::super::Foundation:: HANDLE , bvcpcode : u8 , dwnewvalue : u32 ) -> i32 );
...
pub unsafe fn XFORMOBJ_bApplyXform(pxo: *mut XFORMOBJ, imode: u32, cpoints: u32, pvin: *mut ::core::ffi::c_void, pvout: *mut ::core::ffi::c_void) -> super::super::Foundation::BOOL {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn XFORMOBJ_bApplyXform ( pxo : *mut XFORMOBJ , imode : u32 , cpoints : u32 , pvin : *mut ::core::ffi::c_void , pvout : *mut ::core::ffi::c_void ) -> super::super::Foundation:: BOOL );
...
pub unsafe fn XFORMOBJ_iGetXform(pxo: *const XFORMOBJ, pxform: ::core::option::Option<*mut XFORML>) -> u32 {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn XFORMOBJ_iGetXform ( pxo : *const XFORMOBJ , pxform : *mut XFORML ) -> u32 );
...
pub unsafe fn XLATEOBJ_cGetPalette(pxlo: *mut XLATEOBJ, ipal: u32, cpal: u32, ppal: *mut u32) -> u32 {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn XLATEOBJ_cGetPalette ( pxlo : *mut XLATEOBJ , ipal : u32 , cpal : u32 , ppal : *mut u32 ) -> u32 );
...
pub unsafe fn XLATEOBJ_hGetColorTransform(pxlo: *mut XLATEOBJ) -> super::super::Foundation::HANDLE {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn XLATEOBJ_hGetColorTransform ( pxlo : *mut XLATEOBJ ) -> super::super::Foundation:: HANDLE );
    XLATEOBJ_hGetColorTransform(::core::mem::transmute(pxlo))
}
#[doc = "*Required features: `\"Win32_Devices_Display\"`*"]
#[inline]
pub unsafe fn XLATEOBJ_iXlate(pxlo: *mut XLATEOBJ, icolor: u32) -> u32 {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn XLATEOBJ_iXlate ( pxlo : *mut XLATEOBJ , icolor : u32 ) -> u32 );
    XLATEOBJ_iXlate(::core::mem::transmute(pxlo), icolor)
}
#[doc = "*Required features: `\"Win32_Devices_Display\"`*"]
#[inline]
pub unsafe fn XLATEOBJ_piVector(pxlo: *mut XLATEOBJ) -> *mut u32 {
    ::windows::core::windows_link ! ( "gdi32.dll" ,"system" fn XLATEOBJ_piVector ( pxlo : *mut XLATEOBJ ) -> *mut u32 );
