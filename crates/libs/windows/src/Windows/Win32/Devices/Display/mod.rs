...
#[inline]
pub unsafe fn DestroyPhysicalMonitor(hmonitor: super::super::Foundation::HANDLE) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn DestroyPhysicalMonitors(pphysicalmonitorarray: &[PHYSICAL_MONITOR]) -> windows_result::Result<()> {
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn GetNumberOfPhysicalMonitorsFromHMONITOR(hmonitor: super::super::Graphics::Gdi::HMONITOR, pdwnumberofphysicalmonitors: *mut u32) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn GetNumberOfPhysicalMonitorsFromIDirect3DDevice9<P0>(pdirect3ddevice9: P0) -> windows_result::Result<u32>
where
...
#[cfg(feature = "Win32_Graphics_Gdi")]
#[inline]
pub unsafe fn GetPhysicalMonitorsFromHMONITOR(hmonitor: super::super::Graphics::Gdi::HMONITOR, pphysicalmonitorarray: &mut [PHYSICAL_MONITOR]) -> windows_result::Result<()> {
...
#[cfg(feature = "Win32_Graphics_Direct3D9")]
#[inline]
pub unsafe fn GetPhysicalMonitorsFromIDirect3DDevice9<P0>(pdirect3ddevice9: P0, pphysicalmonitorarray: &mut [PHYSICAL_MONITOR]) -> windows_result::Result<()>
where
    P0: windows_core::Param<super::super::Graphics::Direct3D9::IDirect3DDevice9>,
{
...
impl ICloneViewHelper {
    pub unsafe fn GetConnectedIDs<P0>(&self, wszadaptorname: P0, pulcount: *mut u32, pulid: *mut u32, ulflags: u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetActiveTopology<P0>(&self, wszadaptorname: P0, ulsourceid: u32, pulcount: *mut u32, pultargetid: *mut u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetActiveTopology<P0>(&self, wszadaptorname: P0, ulsourceid: u32, ulcount: u32, pultargetid: *const u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn Commit(&self, ffinalcall: bool) -> windows_result::Result<()> {
...
pub trait ICloneViewHelper_Impl: windows_core::IUnknownImpl {
    fn GetConnectedIDs(&self, wszadaptorname: &windows_core::PCWSTR, pulcount: *mut u32, pulid: *mut u32, ulflags: u32) -> windows_result::Result<()>;
    fn GetActiveTopology(&self, wszadaptorname: &windows_core::PCWSTR, ulsourceid: u32, pulcount: *mut u32, pultargetid: *mut u32) -> windows_result::Result<()>;
    fn SetActiveTopology(&self, wszadaptorname: &windows_core::PCWSTR, ulsourceid: u32, ulcount: u32, pultargetid: *const u32) -> windows_result::Result<()>;
    fn Commit(&self, ffinalcall: windows_core::BOOL) -> windows_result::Result<()>;
}
...
impl IViewHelper {
    ...
    pub unsafe fn SetConfiguration<P0>(&self, pistream: P0) -> windows_result::Result<u32>
    where
    ...
    pub unsafe fn GetProceedOnNewConfiguration(&self) -> windows_result::Result<()> {
...
pub trait IViewHelper_Impl: windows_core::IUnknownImpl {
    ...
    fn SetConfiguration(&self, pistream: windows_core::Ref<super::super::System::Com::IStream>) -> windows_result::Result<u32>;
    fn GetProceedOnNewConfiguration(&self) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
