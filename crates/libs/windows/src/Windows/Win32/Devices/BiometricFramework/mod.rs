...
pub unsafe fn WinBioOpenSession(factor: u32, pooltype: WINBIO_POOL, flags: u32, unitarray: ::core::option::Option<&[u32]>, databaseid: ::core::option::Option<*const ::windows_core::GUID>) -> ::windows_core::Result<u32> {
    ...
    let mut result__ = ::std::mem::zeroed();
    WinBioOpenSession(factor, pooltype, flags, ::core::mem::transmute(unitarray.as_deref().map_or(::core::ptr::null(), |slice| slice.as_ptr())), unitarray.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()), ::core::mem::transmute(databaseid.unwrap_or(::std::ptr::null())), &mut result__).from_abi(result__)
}
#[inline]
...
pub const WINBIO_E_AUTO_LOGON_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860989i32);
pub const WINBIO_E_BAD_CAPTURE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861048i32);
pub const WINBIO_E_CALIBRATION_BUFFER_INVALID: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860975i32);
pub const WINBIO_E_CALIBRATION_BUFFER_TOO_LARGE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860976i32);
pub const WINBIO_E_CALIBRATION_BUFFER_TOO_SMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860977i32);
pub const WINBIO_E_CANCELED: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861052i32);
pub const WINBIO_E_CAPTURE_ABORTED: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861050i32);
pub const WINBIO_E_CONFIGURATION_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861005i32);
pub const WINBIO_E_CRED_PROV_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861008i32);
pub const WINBIO_E_CRED_PROV_NO_CREDENTIAL: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861007i32);
pub const WINBIO_E_CRED_PROV_SECURITY_LOCKOUT: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860985i32);
pub const WINBIO_E_DATABASE_ALREADY_EXISTS: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861034i32);
pub const WINBIO_E_DATABASE_BAD_INDEX_VECTOR: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861022i32);
pub const WINBIO_E_DATABASE_CANT_CLOSE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861037i32);
pub const WINBIO_E_DATABASE_CANT_CREATE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861039i32);
pub const WINBIO_E_DATABASE_CANT_ERASE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861036i32);
pub const WINBIO_E_DATABASE_CANT_FIND: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861035i32);
pub const WINBIO_E_DATABASE_CANT_OPEN: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861038i32);
pub const WINBIO_E_DATABASE_CORRUPTED: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861030i32);
pub const WINBIO_E_DATABASE_EOF: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861023i32);
pub const WINBIO_E_DATABASE_FULL: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861032i32);
pub const WINBIO_E_DATABASE_LOCKED: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861031i32);
pub const WINBIO_E_DATABASE_NO_MORE_RECORDS: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861024i32);
pub const WINBIO_E_DATABASE_NO_RESULTS: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861025i32);
pub const WINBIO_E_DATABASE_NO_SUCH_RECORD: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861029i32);
pub const WINBIO_E_DATABASE_READ_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861027i32);
pub const WINBIO_E_DATABASE_WRITE_ERROR: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861026i32);
pub const WINBIO_E_DATA_COLLECTION_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861045i32);
pub const WINBIO_E_DATA_PROTECTION_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860986i32);
pub const WINBIO_E_DEADLOCK_DETECTED: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860992i32);
pub const WINBIO_E_DEVICE_BUSY: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861040i32);
pub const WINBIO_E_DEVICE_FAILURE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861002i32);
pub const WINBIO_E_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861006i32);
pub const WINBIO_E_DUPLICATE_ENROLLMENT: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861028i32);
pub const WINBIO_E_DUPLICATE_TEMPLATE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861013i32);
pub const WINBIO_E_ENROLLMENT_CANCELED_BY_SUSPEND: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860965i32);
pub const WINBIO_E_ENROLLMENT_IN_PROGRESS: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861049i32);
pub const WINBIO_E_EVENT_MONITOR_ACTIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860999i32);
pub const WINBIO_E_FAST_USER_SWITCH_DISABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861001i32);
pub const WINBIO_E_INCORRECT_BSP: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861020i32);
pub const WINBIO_E_INCORRECT_SENSOR_POOL: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861019i32);
pub const WINBIO_E_INCORRECT_SESSION_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860994i32);
pub const WINBIO_E_INSECURE_SENSOR: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860969i32);
pub const WINBIO_E_INVALID_BUFFER: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860967i32);
pub const WINBIO_E_INVALID_BUFFER_ID: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860968i32);
pub const WINBIO_E_INVALID_CALIBRATION_FORMAT_ARRAY: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860980i32);
pub const WINBIO_E_INVALID_CONTROL_CODE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861047i32);
pub const WINBIO_E_INVALID_DEVICE_STATE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861041i32);
pub const WINBIO_E_INVALID_KEY_IDENTIFIER: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860974i32);
pub const WINBIO_E_INVALID_OPERATION: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861012i32);
pub const WINBIO_E_INVALID_PROPERTY_ID: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860997i32);
pub const WINBIO_E_INVALID_PROPERTY_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860998i32);
pub const WINBIO_E_INVALID_SENSOR_MODE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861017i32);
pub const WINBIO_E_INVALID_SUBFACTOR: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860981i32);
pub const WINBIO_E_INVALID_TICKET: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860988i32);
pub const WINBIO_E_INVALID_UNIT: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861054i32);
pub const WINBIO_E_KEY_CREATION_FAILED: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860973i32);
pub const WINBIO_E_KEY_IDENTIFIER_BUFFER_TOO_SMALL: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860972i32);
pub const WINBIO_E_LOCK_VIOLATION: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861014i32);
pub const WINBIO_E_MAX_ERROR_COUNT_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860990i32);
pub const WINBIO_E_NOT_ACTIVE_CONSOLE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861000i32);
pub const WINBIO_E_NO_CAPTURE_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861018i32);
pub const WINBIO_E_NO_MATCH: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861051i32);
pub const WINBIO_E_NO_PREBOOT_IDENTITY: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860991i32);
pub const WINBIO_E_NO_SUPPORTED_CALIBRATION_FORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860979i32);
pub const WINBIO_E_POLICY_PROTECTION_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860970i32);
pub const WINBIO_E_PRESENCE_MONITOR_ACTIVE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860982i32);
pub const WINBIO_E_PROPERTY_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860971i32);
pub const WINBIO_E_SAS_ENABLED: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861003i32);
pub const WINBIO_E_SELECTION_REQUIRED: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860983i32);
pub const WINBIO_E_SENSOR_UNAVAILABLE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861004i32);
pub const WINBIO_E_SESSION_BUSY: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861011i32);
pub const WINBIO_E_SESSION_HANDLE_CLOSED: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860993i32);
pub const WINBIO_E_TICKET_QUOTA_EXCEEDED: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860987i32);
pub const WINBIO_E_TRUSTLET_INTEGRITY_FAIL: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860966i32);
pub const WINBIO_E_UNKNOWN_ID: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861053i32);
pub const WINBIO_E_UNSUPPORTED_DATA_FORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861044i32);
pub const WINBIO_E_UNSUPPORTED_DATA_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861043i32);
pub const WINBIO_E_UNSUPPORTED_FACTOR: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861055i32);
pub const WINBIO_E_UNSUPPORTED_POOL_TYPE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860984i32);
pub const WINBIO_E_UNSUPPORTED_PROPERTY: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860996i32);
pub const WINBIO_E_UNSUPPORTED_PURPOSE: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146861042i32);
pub const WINBIO_E_UNSUPPORTED_SENSOR_CALIBRATION_FORMAT: ::windows_core::HRESULT = ::windows_core::HRESULT(-2146860978i32);
pub const WINBIO_I_EXTENDED_STATUS_INFORMATION: ::windows_core::HRESULT = ::windows_core::HRESULT(589826i32);
pub const WINBIO_I_MORE_DATA: ::windows_core::HRESULT = ::windows_core::HRESULT(589825i32);
