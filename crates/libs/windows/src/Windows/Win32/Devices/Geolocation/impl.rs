...
impl ICivicAddressReportVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ICivicAddressReportImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> ICivicAddressReportVtbl {
        ...
        Self(
            ...
            GetSensorID::<Impl, IMPL_OFFSET>,
            GetTimestamp::<Impl, IMPL_OFFSET>,
            GetValue::<Impl, IMPL_OFFSET>,
            GetAddressLine1::<Impl, IMPL_OFFSET>,
            GetAddressLine2::<Impl, IMPL_OFFSET>,
            GetCity::<Impl, IMPL_OFFSET>,
            GetStateProvince::<Impl, IMPL_OFFSET>,
            GetPostalCode::<Impl, IMPL_OFFSET>,
            GetCountryRegion::<Impl, IMPL_OFFSET>,
            GetDetailLevel::<Impl, IMPL_OFFSET>,
        )
    }
...
impl ICivicAddressReportFactoryVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ICivicAddressReportFactoryImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> ICivicAddressReportFactoryVtbl {
        ...
        Self(
            ...
            ListenForReports::<Impl, IMPL_OFFSET>,
            StopListeningForReports::<Impl, IMPL_OFFSET>,
            ...
            RequestPermissions::<Impl, IMPL_OFFSET>,
            CivicAddressReport::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IDefaultLocationVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IDefaultLocationImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IDefaultLocationVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, SetReport::<Impl, IMPL_OFFSET>, GetReport::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IDispCivicAddressReportVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IDispCivicAddressReportImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IDispCivicAddressReportVtbl {
        ...
        Self(
            ...
            GetIDsOfNames::<Impl, IMPL_OFFSET>,
            Invoke::<Impl, IMPL_OFFSET>,
            AddressLine1::<Impl, IMPL_OFFSET>,
            AddressLine2::<Impl, IMPL_OFFSET>,
            City::<Impl, IMPL_OFFSET>,
            StateProvince::<Impl, IMPL_OFFSET>,
            PostalCode::<Impl, IMPL_OFFSET>,
            CountryRegion::<Impl, IMPL_OFFSET>,
            DetailLevel::<Impl, IMPL_OFFSET>,
...
impl IDispLatLongReportVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IDispLatLongReportImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IDispLatLongReportVtbl {
        ...
        Self(
            ...
            ErrorRadius::<Impl, IMPL_OFFSET>,
            Altitude::<Impl, IMPL_OFFSET>,
            AltitudeError::<Impl, IMPL_OFFSET>,
            Timestamp::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl ILatLongReportVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ILatLongReportImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> ILatLongReportVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, GetSensorID::<Impl, IMPL_OFFSET>, GetTimestamp::<Impl, IMPL_OFFSET>, GetValue::<Impl, IMPL_OFFSET>, GetLatitude::<Impl, IMPL_OFFSET>, GetLongitude::<Impl, IMPL_OFFSET>, GetErrorRadius::<Impl, IMPL_OFFSET>, GetAltitude::<Impl, IMPL_OFFSET>, GetAltitudeError::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl ILatLongReportFactoryVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ILatLongReportFactoryImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> ILatLongReportFactoryVtbl {
        ...
        Self(
            ...
            SetDesiredAccuracy::<Impl, IMPL_OFFSET>,
            RequestPermissions::<Impl, IMPL_OFFSET>,
            LatLongReport::<Impl, IMPL_OFFSET>,
        )
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl ILocationVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ILocationImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> ILocationVtbl {
        ...
        Self(
            ...
            ::windows::core::AddRef::<Identity, BASE_OFFSET>,
            ::windows::core::Release::<Identity, BASE_OFFSET>,
            RegisterForReport::<Impl, IMPL_OFFSET>,
            UnregisterForReport::<Impl, IMPL_OFFSET>,
            GetReport::<Impl, IMPL_OFFSET>,
            GetReportStatus::<Impl, IMPL_OFFSET>,
            GetReportInterval::<Impl, IMPL_OFFSET>,
            SetReportInterval::<Impl, IMPL_OFFSET>,
            GetDesiredAccuracy::<Impl, IMPL_OFFSET>,
            SetDesiredAccuracy::<Impl, IMPL_OFFSET>,
            RequestPermissions::<Impl, IMPL_OFFSET>,
        )
    }
...
impl ILocationEventsVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ILocationEventsImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> ILocationEventsVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, OnLocationChanged::<Impl, IMPL_OFFSET>, OnStatusChanged::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl ILocationReportVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ILocationReportImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> ILocationReportVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, GetSensorID::<Impl, IMPL_OFFSET>, GetTimestamp::<Impl, IMPL_OFFSET>, GetValue::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
