...
pub trait ILocationPermissions_Impl {
...
impl ILocationPermissions_Vtbl {
    ...
    {
        unsafe extern "system" fn GetGlobalLocationPermission<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, pfenabled: *mut windows_core::BOOL) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ILocationPermissions_Impl,
        {
            unsafe {
...
impl ISensor_Vtbl {
        ...
        <Identity as windows_core::IUnknownImpl>::Impl: ISensor_Impl,
    {
        ...
        unsafe extern "system" fn GetFriendlyName<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, pfriendlyname: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISensor_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn GetProperty<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, key: *const super::super::Foundation::PROPERTYKEY, pproperty: *mut super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISensor_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn SupportsDataField<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, key: *const super::super::Foundation::PROPERTYKEY, pissupported: *mut super::super::Foundation::VARIANT_BOOL) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISensor_Impl,
        {
            unsafe {
...
pub trait ISensorCollection_Impl {
...
#[cfg(all(feature = "Win32_Devices_PortableDevices", feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
pub trait ISensorDataReport_Impl {
...
impl ISensorDataReport_Vtbl {
        ...
        <Identity as windows_core::IUnknownImpl>::Impl: ISensorDataReport_Impl,
    {
        ...
        unsafe extern "system" fn GetSensorValue<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, pkey: *const super::super::Foundation::PROPERTYKEY, pvalue: *mut super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISensorDataReport_Impl,
        {
            unsafe {
...
impl ISensorManager_Vtbl {
        ...
        <Identity as windows_core::IUnknownImpl>::Impl: ISensorManager_Impl,
    {
        ...
        unsafe extern "system" fn RequestPermissions<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, hparent: super::super::Foundation::HWND, psensors: *mut core::ffi::c_void, fmodal: windows_core::BOOL) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: ISensorManager_Impl,
        {
            unsafe {
...
pub trait ISensorManagerEvents_Impl {
