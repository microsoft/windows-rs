...
#[inline]
pub unsafe fn SwDeviceCreate<P0, P1>(pszenumeratorname: P0, pszparentdeviceinstance: P1, pcreateinfo: *const SW_DEVICE_CREATE_INFO, pproperties: Option<&[super::super::Properties::DEVPROPERTY]>, pcallback: SW_DEVICE_CREATE_CALLBACK, pcontext: Option<*const core::ffi::c_void>) -> windows_result::Result<HSWDEVICE>
where
...
#[inline]
pub unsafe fn SwDeviceGetLifetime(hswdevice: HSWDEVICE) -> windows_result::Result<SW_DEVICE_LIFETIME> {
...
#[inline]
pub unsafe fn SwDeviceInterfacePropertySet<P1>(hswdevice: HSWDEVICE, pszdeviceinterfaceid: P1, pproperties: &[super::super::Properties::DEVPROPERTY]) -> windows_result::Result<()>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[cfg(feature = "Win32_Devices_Properties")]
#[inline]
pub unsafe fn SwDeviceInterfaceRegister<P2>(hswdevice: HSWDEVICE, pinterfaceclassguid: *const windows_core::GUID, pszreferencestring: P2, pproperties: Option<&[super::super::Properties::DEVPROPERTY]>, fenabled: bool) -> windows_result::Result<windows_core::PWSTR>
where
...
#[inline]
pub unsafe fn SwDeviceInterfaceSetState<P1>(hswdevice: HSWDEVICE, pszdeviceinterfaceid: P1, fenabled: bool) -> windows_result::Result<()>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[cfg(feature = "Win32_Devices_Properties")]
#[inline]
pub unsafe fn SwDevicePropertySet(hswdevice: HSWDEVICE, pproperties: &[super::super::Properties::DEVPROPERTY]) -> windows_result::Result<()> {
...
#[inline]
pub unsafe fn SwDeviceSetLifetime(hswdevice: HSWDEVICE, lifetime: SW_DEVICE_LIFETIME) -> windows_result::Result<()> {
...
impl IUPnPAddressFamilyControl {
    pub unsafe fn SetAddressFamily(&self, dwflags: i32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetAddressFamily)(windows_core::Interface::as_raw(self), dwflags).ok() }
    }
    pub unsafe fn GetAddressFamily(&self) -> windows_result::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUPnPAddressFamilyControl_Impl: windows_core::IUnknownImpl {
    fn SetAddressFamily(&self, dwflags: i32) -> windows_result::Result<()>;
    fn GetAddressFamily(&self) -> windows_result::Result<i32>;
}
...
impl IUPnPAsyncResult {
    pub unsafe fn AsyncOperationComplete(&self, ullrequestid: u64) -> windows_result::Result<()> {
...
pub trait IUPnPAsyncResult_Impl: windows_core::IUnknownImpl {
    fn AsyncOperationComplete(&self, ullrequestid: u64) -> windows_result::Result<()>;
}
...
impl IUPnPDescriptionDocument {
    ...
    pub unsafe fn LoadResult(&self) -> windows_result::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RootDevice(&self) -> windows_result::Result<IUPnPDevice> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn DeviceByUDN(&self, bstrudn: &windows_core::BSTR) -> windows_result::Result<IUPnPDevice> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUPnPDescriptionDocument_Impl: super::super::super::System::Com::IDispatch_Impl {
    fn ReadyState(&self) -> windows_result::Result<i32>;
    fn Load(&self, bstrurl: &windows_core::BSTR) -> windows_result::Result<()>;
    fn LoadAsync(&self, bstrurl: &windows_core::BSTR, punkcallback: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn LoadResult(&self) -> windows_result::Result<i32>;
    fn Abort(&self) -> windows_result::Result<()>;
    fn RootDevice(&self) -> windows_result::Result<IUPnPDevice>;
    fn DeviceByUDN(&self, bstrudn: &windows_core::BSTR) -> windows_result::Result<IUPnPDevice>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IUPnPDescriptionDocumentCallback {
    pub unsafe fn LoadComplete(&self, hrloadresult: windows_core::HRESULT) -> windows_result::Result<()> {
...
pub trait IUPnPDescriptionDocumentCallback_Impl: windows_core::IUnknownImpl {
    fn LoadComplete(&self, hrloadresult: windows_core::HRESULT) -> windows_result::Result<()>;
}
...
#[cfg(feature = "Win32_System_Com")]
impl IUPnPDevice {
    pub unsafe fn IsRootDevice(&self) -> windows_result::Result<super::super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ParentDevice(&self) -> windows_result::Result<IUPnPDevice> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn HasChildren(&self) -> windows_result::Result<super::super::super::Foundation::VARIANT_BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).HasChildren)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn Children(&self) -> windows_result::Result<IUPnPDevices> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn UniqueDeviceName(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Type(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Type)(windows_core::Interface::as_raw(self), &mut result__).map(|| core::mem::transmute(result__))
        }
    }
    pub unsafe fn PresentationURL(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ManufacturerName(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ManufacturerURL(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ModelName(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ModelNumber(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ModelURL(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn UPC(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).UPC)(windows_core::Interface::as_raw(self), &mut result__).map(|| core::mem::transmute(result__))
        }
    }
    pub unsafe fn SerialNumber(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn IconURL(&self, bstrencodingformat: &windows_core::BSTR, lsizex: i32, lsizey: i32, lbitdepth: i32) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Services(&self) -> windows_result::Result<IUPnPServices> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUPnPDevice_Impl: super::super::super::System::Com::IDispatch_Impl {
    fn IsRootDevice(&self) -> windows_result::Result<super::super::super::Foundation::VARIANT_BOOL>;
    fn RootDevice(&self) -> windows_result::Result<IUPnPDevice>;
    fn ParentDevice(&self) -> windows_result::Result<IUPnPDevice>;
    fn HasChildren(&self) -> windows_result::Result<super::super::super::Foundation::VARIANT_BOOL>;
    fn Children(&self) -> windows_result::Result<IUPnPDevices>;
    fn UniqueDeviceName(&self) -> windows_result::Result<windows_core::BSTR>;
    fn FriendlyName(&self) -> windows_result::Result<windows_core::BSTR>;
    fn Type(&self) -> windows_result::Result<windows_core::BSTR>;
    fn PresentationURL(&self) -> windows_result::Result<windows_core::BSTR>;
    fn ManufacturerName(&self) -> windows_result::Result<windows_core::BSTR>;
    fn ManufacturerURL(&self) -> windows_result::Result<windows_core::BSTR>;
    fn ModelName(&self) -> windows_result::Result<windows_core::BSTR>;
    fn ModelNumber(&self) -> windows_result::Result<windows_core::BSTR>;
    fn Description(&self) -> windows_result::Result<windows_core::BSTR>;
    fn ModelURL(&self) -> windows_result::Result<windows_core::BSTR>;
    fn UPC(&self) -> windows_result::Result<windows_core::BSTR>;
    fn SerialNumber(&self) -> windows_result::Result<windows_core::BSTR>;
    fn IconURL(&self, bstrencodingformat: &windows_core::BSTR, lsizex: i32, lsizey: i32, lbitdepth: i32) -> windows_result::Result<windows_core::BSTR>;
    fn Services(&self) -> windows_result::Result<IUPnPServices>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IUPnPDeviceControl {
    pub unsafe fn Initialize(&self, bstrxmldesc: &windows_core::BSTR, bstrdeviceidentifier: &windows_core::BSTR, bstrinitstring: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetServiceObject(&self, bstrudn: &windows_core::BSTR, bstrserviceid: &windows_core::BSTR) -> windows_result::Result<super::super::super::System::Com::IDispatch> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUPnPDeviceControl_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, bstrxmldesc: &windows_core::BSTR, bstrdeviceidentifier: &windows_core::BSTR, bstrinitstring: &windows_core::BSTR) -> windows_result::Result<()>;
    fn GetServiceObject(&self, bstrudn: &windows_core::BSTR, bstrserviceid: &windows_core::BSTR) -> windows_result::Result<super::super::super::System::Com::IDispatch>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IUPnPDeviceControlHttpHeaders {
    pub unsafe fn GetAdditionalResponseHeaders(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUPnPDeviceControlHttpHeaders_Impl: windows_core::IUnknownImpl {
    fn GetAdditionalResponseHeaders(&self) -> windows_result::Result<windows_core::BSTR>;
}
...
impl IUPnPDeviceDocumentAccess {
    pub unsafe fn GetDocumentURL(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUPnPDeviceDocumentAccess_Impl: windows_core::IUnknownImpl {
    fn GetDocumentURL(&self) -> windows_result::Result<windows_core::BSTR>;
}
...
impl IUPnPDeviceDocumentAccessEx {
    pub unsafe fn GetDocument(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUPnPDeviceDocumentAccessEx_Impl: windows_core::IUnknownImpl {
    fn GetDocument(&self) -> windows_result::Result<windows_core::BSTR>;
}
...
impl IUPnPDeviceFinder {
    pub unsafe fn FindByType(&self, bstrtypeuri: &windows_core::BSTR, dwflags: u32) -> windows_result::Result<IUPnPDevices> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateAsyncFind<P2>(&self, bstrtypeuri: &windows_core::BSTR, dwflags: u32, punkdevicefindercallback: P2) -> windows_result::Result<i32>
    where
    ...
    pub unsafe fn StartAsyncFind(&self, lfinddata: i32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).StartAsyncFind)(windows_core::Interface::as_raw(self), lfinddata).ok() }
    }
    pub unsafe fn CancelAsyncFind(&self, lfinddata: i32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).CancelAsyncFind)(windows_core::Interface::as_raw(self), lfinddata).ok() }
    }
    pub unsafe fn FindByUDN(&self, bstrudn: &windows_core::BSTR) -> windows_result::Result<IUPnPDevice> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUPnPDeviceFinder_Impl: super::super::super::System::Com::IDispatch_Impl {
    fn FindByType(&self, bstrtypeuri: &windows_core::BSTR, dwflags: u32) -> windows_result::Result<IUPnPDevices>;
    fn CreateAsyncFind(&self, bstrtypeuri: &windows_core::BSTR, dwflags: u32, punkdevicefindercallback: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<i32>;
    fn StartAsyncFind(&self, lfinddata: i32) -> windows_result::Result<()>;
    fn CancelAsyncFind(&self, lfinddata: i32) -> windows_result::Result<()>;
    fn FindByUDN(&self, bstrudn: &windows_core::BSTR) -> windows_result::Result<IUPnPDevice>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IUPnPDeviceFinderAddCallbackWithInterface {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn DeviceAddedWithInterface<P1>(&self, lfinddata: i32, pdevice: P1, pguidinterface: *const windows_core::GUID) -> windows_result::Result<()>
    where
...
pub trait IUPnPDeviceFinderAddCallbackWithInterface_Impl: windows_core::IUnknownImpl {
    fn DeviceAddedWithInterface(&self, lfinddata: i32, pdevice: windows_core::Ref<IUPnPDevice>, pguidinterface: *const windows_core::GUID) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IUPnPDeviceFinderCallback {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn DeviceAdded<P1>(&self, lfinddata: i32, pdevice: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<IUPnPDevice>,
    {
        unsafe { (windows_core::Interface::vtable(self).DeviceAdded)(windows_core::Interface::as_raw(self), lfinddata, pdevice.param().abi()).ok() }
    }
    pub unsafe fn DeviceRemoved(&self, lfinddata: i32, bstrudn: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn SearchComplete(&self, lfinddata: i32) -> windows_result::Result<()> {
...
pub trait IUPnPDeviceFinderCallback_Impl: windows_core::IUnknownImpl {
    fn DeviceAdded(&self, lfinddata: i32, pdevice: windows_core::Ref<IUPnPDevice>) -> windows_result::Result<()>;
    fn DeviceRemoved(&self, lfinddata: i32, bstrudn: &windows_core::BSTR) -> windows_result::Result<()>;
    fn SearchComplete(&self, lfinddata: i32) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IUPnPDeviceProvider {
    pub unsafe fn Start(&self, bstrinitstring: &windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IUPnPDeviceProvider_Impl: windows_core::IUnknownImpl {
    fn Start(&self, bstrinitstring: &windows_core::BSTR) -> windows_result::Result<()>;
...
impl IUPnPDevices {
    ...
    pub unsafe fn get_Item(&self, bstrudn: &windows_core::BSTR) -> windows_result::Result<IUPnPDevice> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUPnPDevices_Impl: super::super::super::System::Com::IDispatch_Impl {
    ...
    fn get_Item(&self, bstrudn: &windows_core::BSTR) -> windows_result::Result<IUPnPDevice>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IUPnPEventSink {
    pub unsafe fn OnStateChanged(&self, rgdispidchanges: &[i32]) -> windows_result::Result<()> {
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn OnStateChangedSafe(&self, varsadispidchanges: &super::super::super::System::Variant::VARIANT) -> windows_result::Result<()> {
...
pub trait IUPnPEventSink_Impl: windows_core::IUnknownImpl {
    fn OnStateChanged(&self, cchanges: u32, rgdispidchanges: *const i32) -> windows_result::Result<()>;
    fn OnStateChangedSafe(&self, varsadispidchanges: &super::super::super::System::Variant::VARIANT) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IUPnPEventSource {
    pub unsafe fn Advise<P0>(&self, pessubscriber: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn Unadvise<P0>(&self, pessubscriber: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IUPnPEventSink>,
    {
...
pub trait IUPnPEventSource_Impl: windows_core::IUnknownImpl {
    fn Advise(&self, pessubscriber: windows_core::Ref<IUPnPEventSink>) -> windows_result::Result<()>;
    fn Unadvise(&self, pessubscriber: windows_core::Ref<IUPnPEventSink>) -> windows_result::Result<()>;
}
...
impl IUPnPHttpHeaderControl {
    pub unsafe fn AddRequestHeaders(&self, bstrhttpheaders: &windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IUPnPHttpHeaderControl_Impl: windows_core::IUnknownImpl {
    fn AddRequestHeaders(&self, bstrhttpheaders: &windows_core::BSTR) -> windows_result::Result<()>;
}
...
impl IUPnPRegistrar {
    pub unsafe fn RegisterDevice(&self, bstrxmldesc: &windows_core::BSTR, bstrprogiddevicecontrolclass: &windows_core::BSTR, bstrinitstring: &windows_core::BSTR, bstrcontainerid: &windows_core::BSTR, bstrresourcepath: &windows_core::BSTR, nlifetime: i32) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RegisterRunningDevice<P1>(&self, bstrxmldesc: &windows_core::BSTR, punkdevicecontrol: P1, bstrinitstring: &windows_core::BSTR, bstrresourcepath: &windows_core::BSTR, nlifetime: i32) -> windows_result::Result<windows_core::BSTR>
    where
        P1: windows_core::Param<windows_core::IUnknown>,
    {
        unsafe {
    ...
    pub unsafe fn RegisterDeviceProvider(&self, bstrprovidername: &windows_core::BSTR, bstrprogidproviderclass: &windows_core::BSTR, bstrinitstring: &windows_core::BSTR, bstrcontainerid: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetUniqueDeviceName(&self, bstrdeviceidentifier: &windows_core::BSTR, bstrtemplateudn: &windows_core::BSTR) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn UnregisterDevice(&self, bstrdeviceidentifier: &windows_core::BSTR, fpermanent: bool) -> windows_result::Result<()> {
    ...
    pub unsafe fn UnregisterDeviceProvider(&self, bstrprovidername: &windows_core::BSTR) -> windows_result::Result<()> {
...
pub trait IUPnPRegistrar_Impl: windows_core::IUnknownImpl {
    fn RegisterDevice(&self, bstrxmldesc: &windows_core::BSTR, bstrprogiddevicecontrolclass: &windows_core::BSTR, bstrinitstring: &windows_core::BSTR, bstrcontainerid: &windows_core::BSTR, bstrresourcepath: &windows_core::BSTR, nlifetime: i32) -> windows_result::Result<windows_core::BSTR>;
    fn RegisterRunningDevice(&self, bstrxmldesc: &windows_core::BSTR, punkdevicecontrol: windows_core::Ref<windows_core::IUnknown>, bstrinitstring: &windows_core::BSTR, bstrresourcepath: &windows_core::BSTR, nlifetime: i32) -> windows_result::Result<windows_core::BSTR>;
    fn RegisterDeviceProvider(&self, bstrprovidername: &windows_core::BSTR, bstrprogidproviderclass: &windows_core::BSTR, bstrinitstring: &windows_core::BSTR, bstrcontainerid: &windows_core::BSTR) -> windows_result::Result<()>;
    fn GetUniqueDeviceName(&self, bstrdeviceidentifier: &windows_core::BSTR, bstrtemplateudn: &windows_core::BSTR) -> windows_result::Result<windows_core::BSTR>;
    fn UnregisterDevice(&self, bstrdeviceidentifier: &windows_core::BSTR, fpermanent: windows_core::BOOL) -> windows_result::Result<()>;
    fn UnregisterDeviceProvider(&self, bstrprovidername: &windows_core::BSTR) -> windows_result::Result<()>;
}
...
impl IUPnPRemoteEndpointInfo {
    pub unsafe fn GetDwordValue(&self, bstrvaluename: &windows_core::BSTR) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetStringValue(&self, bstrvaluename: &windows_core::BSTR) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetGuidValue(&self, bstrvaluename: &windows_core::BSTR) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUPnPRemoteEndpointInfo_Impl: windows_core::IUnknownImpl {
    fn GetDwordValue(&self, bstrvaluename: &windows_core::BSTR) -> windows_result::Result<u32>;
    fn GetStringValue(&self, bstrvaluename: &windows_core::BSTR) -> windows_result::Result<windows_core::BSTR>;
    fn GetGuidValue(&self, bstrvaluename: &windows_core::BSTR) -> windows_result::Result<windows_core::GUID>;
}
...
impl IUPnPReregistrar {
    pub unsafe fn ReregisterDevice(&self, bstrdeviceidentifier: &windows_core::BSTR, bstrxmldesc: &windows_core::BSTR, bstrprogiddevicecontrolclass: &windows_core::BSTR, bstrinitstring: &windows_core::BSTR, bstrcontainerid: &windows_core::BSTR, bstrresourcepath: &windows_core::BSTR, nlifetime: i32) -> windows_result::Result<()> {
    ...
    pub unsafe fn ReregisterRunningDevice<P2>(&self, bstrdeviceidentifier: &windows_core::BSTR, bstrxmldesc: &windows_core::BSTR, punkdevicecontrol: P2, bstrinitstring: &windows_core::BSTR, bstrresourcepath: &windows_core::BSTR, nlifetime: i32) -> windows_result::Result<()>
    where
        P2: windows_core::Param<windows_core::IUnknown>,
    {
...
pub trait IUPnPReregistrar_Impl: windows_core::IUnknownImpl {
    fn ReregisterDevice(&self, bstrdeviceidentifier: &windows_core::BSTR, bstrxmldesc: &windows_core::BSTR, bstrprogiddevicecontrolclass: &windows_core::BSTR, bstrinitstring: &windows_core::BSTR, bstrcontainerid: &windows_core::BSTR, bstrresourcepath: &windows_core::BSTR, nlifetime: i32) -> windows_result::Result<()>;
    fn ReregisterRunningDevice(&self, bstrdeviceidentifier: &windows_core::BSTR, bstrxmldesc: &windows_core::BSTR, punkdevicecontrol: windows_core::Ref<windows_core::IUnknown>, bstrinitstring: &windows_core::BSTR, bstrresourcepath: &windows_core::BSTR, nlifetime: i32) -> windows_result::Result<()>;
}
...
impl IUPnPService {
    ...
    pub unsafe fn QueryStateVariable(&self, bstrvariablename: &windows_core::BSTR) -> windows_result::Result<super::super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn InvokeAction(&self, bstractionname: &windows_core::BSTR, vinactionargs: &super::super::super::System::Variant::VARIANT, pvoutactionargs: *mut super::super::super::System::Variant::VARIANT) -> windows_result::Result<super::super::super::System::Variant::VARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ServiceTypeIdentifier(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn AddCallback<P0>(&self, punkcallback: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn LastTransportStatus(&self) -> windows_result::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUPnPService_Impl: super::super::super::System::Com::IDispatch_Impl {
    fn QueryStateVariable(&self, bstrvariablename: &windows_core::BSTR) -> windows_result::Result<super::super::super::System::Variant::VARIANT>;
    fn InvokeAction(&self, bstractionname: &windows_core::BSTR, vinactionargs: &super::super::super::System::Variant::VARIANT, pvoutactionargs: *mut super::super::super::System::Variant::VARIANT) -> windows_result::Result<super::super::super::System::Variant::VARIANT>;
    fn ServiceTypeIdentifier(&self) -> windows_result::Result<windows_core::BSTR>;
    fn AddCallback(&self, punkcallback: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn Id(&self) -> windows_result::Result<windows_core::BSTR>;
    fn LastTransportStatus(&self) -> windows_result::Result<i32>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IUPnPServiceAsync {
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn BeginInvokeAction<P2>(&self, bstractionname: &windows_core::BSTR, vinactionargs: &super::super::super::System::Variant::VARIANT, pasyncresult: P2) -> windows_result::Result<u64>
    where
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn EndInvokeAction(&self, ullrequestid: u64, pvoutactionargs: *mut super::super::super::System::Variant::VARIANT, pvretval: *mut super::super::super::System::Variant::VARIANT) -> windows_result::Result<()> {
    ...
    pub unsafe fn BeginQueryStateVariable<P1>(&self, bstrvariablename: &windows_core::BSTR, pasyncresult: P1) -> windows_result::Result<u64>
    where
    ...
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn EndQueryStateVariable(&self, ullrequestid: u64, pvalue: *mut super::super::super::System::Variant::VARIANT) -> windows_result::Result<()> {
    ...
    pub unsafe fn BeginSubscribeToEvents<P0, P1>(&self, punkcallback: P0, pasyncresult: P1) -> windows_result::Result<u64>
    where
        P0: windows_core::Param<windows_core::IUnknown>,
        P1: windows_core::Param<IUPnPAsyncResult>,
    {
    ...
    pub unsafe fn EndSubscribeToEvents(&self, ullrequestid: u64) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).EndSubscribeToEvents)(windows_core::Interface::as_raw(self), ullrequestid).ok() }
    }
    pub unsafe fn BeginSCPDDownload<P0>(&self, pasyncresult: P0) -> windows_result::Result<u64>
    where
    ...
    pub unsafe fn EndSCPDDownload(&self, ullrequestid: u64) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CancelAsyncOperation(&self, ullrequestid: u64) -> windows_result::Result<()> {
...
pub trait IUPnPServiceAsync_Impl: windows_core::IUnknownImpl {
    fn BeginInvokeAction(&self, bstractionname: &windows_core::BSTR, vinactionargs: &super::super::super::System::Variant::VARIANT, pasyncresult: windows_core::Ref<IUPnPAsyncResult>) -> windows_result::Result<u64>;
    fn EndInvokeAction(&self, ullrequestid: u64, pvoutactionargs: *mut super::super::super::System::Variant::VARIANT, pvretval: *mut super::super::super::System::Variant::VARIANT) -> windows_result::Result<()>;
    fn BeginQueryStateVariable(&self, bstrvariablename: &windows_core::BSTR, pasyncresult: windows_core::Ref<IUPnPAsyncResult>) -> windows_result::Result<u64>;
    fn EndQueryStateVariable(&self, ullrequestid: u64, pvalue: *mut super::super::super::System::Variant::VARIANT) -> windows_result::Result<()>;
    fn BeginSubscribeToEvents(&self, punkcallback: windows_core::Ref<windows_core::IUnknown>, pasyncresult: windows_core::Ref<IUPnPAsyncResult>) -> windows_result::Result<u64>;
    fn EndSubscribeToEvents(&self, ullrequestid: u64) -> windows_result::Result<()>;
    fn BeginSCPDDownload(&self, pasyncresult: windows_core::Ref<IUPnPAsyncResult>) -> windows_result::Result<u64>;
    fn EndSCPDDownload(&self, ullrequestid: u64) -> windows_result::Result<windows_core::BSTR>;
    fn CancelAsyncOperation(&self, ullrequestid: u64) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IUPnPServiceCallback {
    #[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
    pub unsafe fn StateVariableChanged<P0, P1>(&self, pus: P0, pcwszstatevarname: P1, vavalue: &super::super::super::System::Variant::VARIANT) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn ServiceInstanceDied<P0>(&self, pus: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IUPnPService>,
    {
...
pub trait IUPnPServiceCallback_Impl: windows_core::IUnknownImpl {
    fn StateVariableChanged(&self, pus: windows_core::Ref<IUPnPService>, pcwszstatevarname: &windows_core::PCWSTR, vavalue: &super::super::super::System::Variant::VARIANT) -> windows_result::Result<()>;
    fn ServiceInstanceDied(&self, pus: windows_core::Ref<IUPnPService>) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IUPnPServiceEnumProperty {
    pub unsafe fn SetServiceEnumProperty(&self, dwmask: u32) -> windows_result::Result<()> {
...
pub trait IUPnPServiceEnumProperty_Impl: windows_core::IUnknownImpl {
    fn SetServiceEnumProperty(&self, dwmask: u32) -> windows_result::Result<()>;
}
...
impl IUPnPServices {
    ...
    pub unsafe fn get_Item(&self, bstrserviceid: &windows_core::BSTR) -> windows_result::Result<IUPnPService> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUPnPServices_Impl: super::super::super::System::Com::IDispatch_Impl {
    fn Count(&self) -> windows_result::Result<i32>;
    fn _NewEnum(&self) -> windows_result::Result<windows_core::IUnknown>;
    fn get_Item(&self, bstrserviceid: &windows_core::BSTR) -> windows_result::Result<IUPnPService>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
