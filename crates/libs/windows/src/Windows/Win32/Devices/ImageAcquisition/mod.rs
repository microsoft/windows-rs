...
impl IEnumWIA_DEV_CAPS {
    pub unsafe fn Next(&self, celt: u32, rgelt: *mut WIA_DEV_CAP, pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Clone(&self) -> Result<IEnumWIA_DEV_CAPS, windows_result::HRESULT> {
        unsafe {
...
pub trait IEnumWIA_DEV_CAPS_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, rgelt: *mut WIA_DEV_CAP, pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT>;
    fn Reset(&self) -> Result<(), windows_result::HRESULT>;
    fn Clone(&self) -> Result<IEnumWIA_DEV_CAPS, windows_result::HRESULT>;
...
impl IEnumWIA_DEV_INFO {
    pub unsafe fn Next(&self, celt: u32, rgelt: *mut Option<IWiaPropertyStorage>, pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Next)(windows_core::Interface::as_raw(self), celt, core::mem::transmute(rgelt), pceltfetched as _).ok() }
    }
    pub unsafe fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Skip)(windows_core::Interface::as_raw(self), celt).ok() }
    ...
    pub unsafe fn Clone(&self) -> Result<IEnumWIA_DEV_INFO, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumWIA_DEV_INFO_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, rgelt: windows_core::OutRef<'_, IWiaPropertyStorage>, pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT>;
    fn Reset(&self) -> Result<(), windows_result::HRESULT>;
    fn Clone(&self) -> Result<IEnumWIA_DEV_INFO, windows_result::HRESULT>;
    fn GetCount(&self) -> Result<u32, windows_result::HRESULT>;
}
...
impl IEnumWIA_FORMAT_INFO {
    pub unsafe fn Next(&self, celt: u32, rgelt: *mut WIA_FORMAT_INFO, pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Clone(&self) -> Result<IEnumWIA_FORMAT_INFO, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumWIA_FORMAT_INFO_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, rgelt: *mut WIA_FORMAT_INFO, pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT>;
    fn Reset(&self) -> Result<(), windows_result::HRESULT>;
    fn Clone(&self) -> Result<IEnumWIA_FORMAT_INFO, windows_result::HRESULT>;
    fn GetCount(&self) -> Result<u32, windows_result::HRESULT>;
}
...
impl IEnumWiaItem {
    pub unsafe fn Next(&self, celt: u32, ppiwiaitem: *mut Option<IWiaItem>, pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Clone(&self) -> Result<IEnumWiaItem, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumWiaItem_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, ppiwiaitem: windows_core::OutRef<'_, IWiaItem>, pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT>;
    fn Reset(&self) -> Result<(), windows_result::HRESULT>;
    fn Clone(&self) -> Result<IEnumWiaItem, windows_result::HRESULT>;
    fn GetCount(&self) -> Result<u32, windows_result::HRESULT>;
}
...
impl IEnumWiaItem2 {
    pub unsafe fn Next(&self, celt: u32, ppiwiaitem2: *mut Option<IWiaItem2>, pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Clone(&self) -> Result<IEnumWiaItem2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub trait IEnumWiaItem2_Impl: windows_core::IUnknownImpl {
    fn Next(&self, celt: u32, ppiwiaitem2: windows_core::OutRef<'_, IWiaItem2>, pceltfetched: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn Skip(&self, celt: u32) -> Result<(), windows_result::HRESULT>;
    fn Reset(&self) -> Result<(), windows_result::HRESULT>;
    fn Clone(&self) -> Result<IEnumWiaItem2, windows_result::HRESULT>;
    fn GetCount(&self) -> Result<u32, windows_result::HRESULT>;
}
...
impl IWiaAppErrorHandler {
    ...
    pub unsafe fn ReportStatus<P1>(&self, lflags: i32, pwiaitem2: P1, hrstatus: windows_core::HRESULT, lpercentcomplete: i32) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IWiaAppErrorHandler_Impl: windows_core::IUnknownImpl {
    ...
    fn ReportStatus(&self, lflags: i32, pwiaitem2: windows_core::Ref<'_, IWiaItem2>, hrstatus: windows_core::HRESULT, lpercentcomplete: i32) -> Result<(), windows_result::HRESULT>;
}
...
impl IWiaDataCallback {
    pub unsafe fn BandedDataCallback(&self, lmessage: i32, lstatus: i32, lpercentcomplete: i32, loffset: i32, llength: i32, lreserved: i32, lreslength: i32, pbbuffer: *mut u8) -> Result<(), windows_result::HRESULT> {
...
pub trait IWiaDataCallback_Impl: windows_core::IUnknownImpl {
    fn BandedDataCallback(&self, lmessage: i32, lstatus: i32, lpercentcomplete: i32, loffset: i32, llength: i32, lreserved: i32, lreslength: i32, pbbuffer: *mut u8) -> Result<(), windows_result::HRESULT>;
}
...
impl IWiaDataTransfer {
    ...
    pub unsafe fn idtGetData<P1>(&self, pmedium: *mut super::super::System::Com::STGMEDIUM, piwiadatacallback: P1) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn idtGetBandedData<P1>(&self, pwiadatatransinfo: *mut WIA_DATA_TRANSFER_INFO, piwiadatacallback: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<IWiaDataCallback>,
    {
    ...
    pub unsafe fn idtQueryGetData(&self, pfe: Option<*const WIA_FORMAT_INFO>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn idtEnumWIA_FORMAT_INFO(&self) -> Result<IEnumWIA_FORMAT_INFO, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn idtGetExtendedTransferInfo(&self, pextendedtransferinfo: *mut WIA_EXTENDED_TRANSFER_INFO) -> Result<(), windows_result::HRESULT> {
...
pub trait IWiaDataTransfer_Impl: windows_core::IUnknownImpl {
    fn idtGetData(&self, pmedium: *mut super::super::System::Com::STGMEDIUM, piwiadatacallback: windows_core::Ref<'_, IWiaDataCallback>) -> Result<(), windows_result::HRESULT>;
    fn idtGetBandedData(&self, pwiadatatransinfo: *mut WIA_DATA_TRANSFER_INFO, piwiadatacallback: windows_core::Ref<'_, IWiaDataCallback>) -> Result<(), windows_result::HRESULT>;
    fn idtQueryGetData(&self, pfe: *const WIA_FORMAT_INFO) -> Result<(), windows_result::HRESULT>;
    fn idtEnumWIA_FORMAT_INFO(&self) -> Result<IEnumWIA_FORMAT_INFO, windows_result::HRESULT>;
    fn idtGetExtendedTransferInfo(&self, pextendedtransferinfo: *mut WIA_EXTENDED_TRANSFER_INFO) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_System_Com_StructuredStorage"))]
...
impl IWiaDevMgr {
    pub unsafe fn EnumDeviceInfo(&self, lflag: i32) -> Result<IEnumWIA_DEV_INFO, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateDevice(&self, bstrdeviceid: &windows_core::BSTR) -> Result<IWiaItem, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SelectDeviceDlg(&self, hwndparent: super::super::Foundation::HWND, ldevicetype: i32, lflags: i32, pbstrdeviceid: *mut windows_core::BSTR, ppitemroot: *mut Option<IWiaItem>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SelectDeviceDlgID(&self, hwndparent: super::super::Foundation::HWND, ldevicetype: i32, lflags: i32, pbstrdeviceid: *mut windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetImageDlg<P4>(&self, hwndparent: super::super::Foundation::HWND, ldevicetype: i32, lflags: i32, lintent: i32, pitemroot: P4, bstrfilename: &windows_core::BSTR, pguidformat: *mut windows_core::GUID) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn RegisterEventCallbackProgram(&self, lflags: i32, bstrdeviceid: &windows_core::BSTR, peventguid: *const windows_core::GUID, bstrcommandline: &windows_core::BSTR, bstrname: &windows_core::BSTR, bstrdescription: &windows_core::BSTR, bstricon: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn RegisterEventCallbackInterface<P3>(&self, lflags: i32, bstrdeviceid: &windows_core::BSTR, peventguid: *const windows_core::GUID, piwiaeventcallback: P3) -> Result<windows_core::IUnknown, windows_result::HRESULT>
    where
    ...
    pub unsafe fn RegisterEventCallbackCLSID(&self, lflags: i32, bstrdeviceid: &windows_core::BSTR, peventguid: *const windows_core::GUID, pclsid: *const windows_core::GUID, bstrname: &windows_core::BSTR, bstrdescription: &windows_core::BSTR, bstricon: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn AddDeviceDlg(&self, hwndparent: super::super::Foundation::HWND, lflags: i32) -> Result<(), windows_result::HRESULT> {
...
pub trait IWiaDevMgr_Impl: windows_core::IUnknownImpl {
    fn EnumDeviceInfo(&self, lflag: i32) -> Result<IEnumWIA_DEV_INFO, windows_result::HRESULT>;
    fn CreateDevice(&self, bstrdeviceid: &windows_core::BSTR) -> Result<IWiaItem, windows_result::HRESULT>;
    fn SelectDeviceDlg(&self, hwndparent: super::super::Foundation::HWND, ldevicetype: i32, lflags: i32, pbstrdeviceid: *mut windows_core::BSTR, ppitemroot: windows_core::OutRef<'_, IWiaItem>) -> Result<(), windows_result::HRESULT>;
    fn SelectDeviceDlgID(&self, hwndparent: super::super::Foundation::HWND, ldevicetype: i32, lflags: i32, pbstrdeviceid: *mut windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn GetImageDlg(&self, hwndparent: super::super::Foundation::HWND, ldevicetype: i32, lflags: i32, lintent: i32, pitemroot: windows_core::Ref<'_, IWiaItem>, bstrfilename: &windows_core::BSTR, pguidformat: *mut windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn RegisterEventCallbackProgram(&self, lflags: i32, bstrdeviceid: &windows_core::BSTR, peventguid: *const windows_core::GUID, bstrcommandline: &windows_core::BSTR, bstrname: &windows_core::BSTR, bstrdescription: &windows_core::BSTR, bstricon: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn RegisterEventCallbackInterface(&self, lflags: i32, bstrdeviceid: &windows_core::BSTR, peventguid: *const windows_core::GUID, piwiaeventcallback: windows_core::Ref<'_, IWiaEventCallback>) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
    fn RegisterEventCallbackCLSID(&self, lflags: i32, bstrdeviceid: &windows_core::BSTR, peventguid: *const windows_core::GUID, pclsid: *const windows_core::GUID, bstrname: &windows_core::BSTR, bstrdescription: &windows_core::BSTR, bstricon: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn AddDeviceDlg(&self, hwndparent: super::super::Foundation::HWND, lflags: i32) -> Result<(), windows_result::HRESULT>;
}
...
impl IWiaDevMgr2 {
    pub unsafe fn EnumDeviceInfo(&self, lflags: i32) -> Result<IEnumWIA_DEV_INFO, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateDevice(&self, lflags: i32, bstrdeviceid: &windows_core::BSTR) -> Result<IWiaItem2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SelectDeviceDlg(&self, hwndparent: super::super::Foundation::HWND, ldevicetype: i32, lflags: i32, pbstrdeviceid: *mut windows_core::BSTR, ppitemroot: *mut Option<IWiaItem2>) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SelectDeviceDlg)(windows_core::Interface::as_raw(self), hwndparent, ldevicetype, lflags, core::mem::transmute(pbstrdeviceid), core::mem::transmute(ppitemroot)).ok() }
    }
    pub unsafe fn SelectDeviceDlgID(&self, hwndparent: super::super::Foundation::HWND, ldevicetype: i32, lflags: i32, pbstrdeviceid: *mut windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SelectDeviceDlgID)(windows_core::Interface::as_raw(self), hwndparent, ldevicetype, lflags, core::mem::transmute(pbstrdeviceid)).ok() }
    ...
    pub unsafe fn RegisterEventCallbackProgram(&self, lflags: i32, bstrdeviceid: &windows_core::BSTR, peventguid: *const windows_core::GUID, bstrfullappname: &windows_core::BSTR, bstrcommandlinearg: &windows_core::BSTR, bstrname: &windows_core::BSTR, bstrdescription: &windows_core::BSTR, bstricon: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetImageDlg(&self, lflags: i32, bstrdeviceid: &windows_core::BSTR, hwndparent: super::super::Foundation::HWND, bstrfoldername: &windows_core::BSTR, bstrfilename: &windows_core::BSTR, plnumfiles: *mut i32, ppbstrfilepaths: *mut *mut windows_core::BSTR, ppitem: *mut Option<IWiaItem2>) -> Result<(), windows_result::HRESULT> {
...
pub trait IWiaDevMgr2_Impl: windows_core::IUnknownImpl {
    fn EnumDeviceInfo(&self, lflags: i32) -> Result<IEnumWIA_DEV_INFO, windows_result::HRESULT>;
    fn CreateDevice(&self, lflags: i32, bstrdeviceid: &windows_core::BSTR) -> Result<IWiaItem2, windows_result::HRESULT>;
    fn SelectDeviceDlg(&self, hwndparent: super::super::Foundation::HWND, ldevicetype: i32, lflags: i32, pbstrdeviceid: *mut windows_core::BSTR, ppitemroot: windows_core::OutRef<'_, IWiaItem2>) -> Result<(), windows_result::HRESULT>;
    fn SelectDeviceDlgID(&self, hwndparent: super::super::Foundation::HWND, ldevicetype: i32, lflags: i32, pbstrdeviceid: *mut windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn RegisterEventCallbackInterface(&self, lflags: i32, bstrdeviceid: &windows_core::BSTR, peventguid: *const windows_core::GUID, piwiaeventcallback: windows_core::Ref<'_, IWiaEventCallback>) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
    fn RegisterEventCallbackProgram(&self, lflags: i32, bstrdeviceid: &windows_core::BSTR, peventguid: *const windows_core::GUID, bstrfullappname: &windows_core::BSTR, bstrcommandlinearg: &windows_core::BSTR, bstrname: &windows_core::BSTR, bstrdescription: &windows_core::BSTR, bstricon: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn RegisterEventCallbackCLSID(&self, lflags: i32, bstrdeviceid: &windows_core::BSTR, peventguid: *const windows_core::GUID, pclsid: *const windows_core::GUID, bstrname: &windows_core::BSTR, bstrdescription: &windows_core::BSTR, bstricon: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn GetImageDlg(&self, lflags: i32, bstrdeviceid: &windows_core::BSTR, hwndparent: super::super::Foundation::HWND, bstrfoldername: &windows_core::BSTR, bstrfilename: &windows_core::BSTR, plnumfiles: *mut i32, ppbstrfilepaths: *mut *mut windows_core::BSTR, ppitem: windows_core::OutRef<'_, IWiaItem2>) -> Result<(), windows_result::HRESULT>;
}
...
impl IWiaDrvItem {
    ...
    pub unsafe fn AddItemToFolder<P0>(&self, __midl__iwiadrvitem0004: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn UnlinkItemTree(&self, __midl__iwiadrvitem0005: i32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).UnlinkItemTree)(windows_core::Interface::as_raw(self), __midl__iwiadrvitem0005).ok() }
    }
    pub unsafe fn RemoveItemFromFolder(&self, __midl__iwiadrvitem0006: i32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn FindItemByName(&self, __midl__iwiadrvitem0007: i32, __midl__iwiadrvitem0008: &windows_core::BSTR) -> Result<IWiaDrvItem, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn FindChildItemByName(&self, __midl__iwiadrvitem0010: &windows_core::BSTR) -> Result<IWiaDrvItem, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetParentItem(&self) -> Result<IWiaDrvItem, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFirstChildItem(&self) -> Result<IWiaDrvItem, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetNextSiblingItem(&self) -> Result<IWiaDrvItem, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn DumpItemData(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWiaDrvItem_Impl: windows_core::IUnknownImpl {
    fn GetItemFlags(&self) -> Result<i32, windows_result::HRESULT>;
    fn GetDeviceSpecContext(&self) -> Result<*mut u8, windows_result::HRESULT>;
    fn GetFullItemName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn GetItemName(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn AddItemToFolder(&self, __midl__iwiadrvitem0004: windows_core::Ref<'_, IWiaDrvItem>) -> Result<(), windows_result::HRESULT>;
    fn UnlinkItemTree(&self, __midl__iwiadrvitem0005: i32) -> Result<(), windows_result::HRESULT>;
    fn RemoveItemFromFolder(&self, __midl__iwiadrvitem0006: i32) -> Result<(), windows_result::HRESULT>;
    fn FindItemByName(&self, __midl__iwiadrvitem0007: i32, __midl__iwiadrvitem0008: &windows_core::BSTR) -> Result<IWiaDrvItem, windows_result::HRESULT>;
    fn FindChildItemByName(&self, __midl__iwiadrvitem0010: &windows_core::BSTR) -> Result<IWiaDrvItem, windows_result::HRESULT>;
    fn GetParentItem(&self) -> Result<IWiaDrvItem, windows_result::HRESULT>;
    fn GetFirstChildItem(&self) -> Result<IWiaDrvItem, windows_result::HRESULT>;
    fn GetNextSiblingItem(&self) -> Result<IWiaDrvItem, windows_result::HRESULT>;
    fn DumpItemData(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
}
...
impl IWiaErrorHandler {
    pub unsafe fn ReportStatus<P2>(&self, lflags: i32, hwndparent: super::super::Foundation::HWND, pwiaitem2: P2, hrstatus: windows_core::HRESULT, lpercentcomplete: i32) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn GetStatusDescription<P1>(&self, lflags: i32, pwiaitem2: P1, hrstatus: windows_core::HRESULT) -> Result<windows_core::BSTR, windows_result::HRESULT>
    where
        P1: windows_core::Param<IWiaItem2>,
    {
        unsafe {
...
pub trait IWiaErrorHandler_Impl: windows_core::IUnknownImpl {
    fn ReportStatus(&self, lflags: i32, hwndparent: super::super::Foundation::HWND, pwiaitem2: windows_core::Ref<'_, IWiaItem2>, hrstatus: windows_core::HRESULT, lpercentcomplete: i32) -> Result<(), windows_result::HRESULT>;
    fn GetStatusDescription(&self, lflags: i32, pwiaitem2: windows_core::Ref<'_, IWiaItem2>, hrstatus: windows_core::HRESULT) -> Result<windows_core::BSTR, windows_result::HRESULT>;
}
...
impl IWiaEventCallback {
    pub unsafe fn ImageEventCallback(&self, peventguid: *const windows_core::GUID, bstreventdescription: &windows_core::BSTR, bstrdeviceid: &windows_core::BSTR, bstrdevicedescription: &windows_core::BSTR, dwdevicetype: u32, bstrfullitemname: &windows_core::BSTR, puleventtype: *mut u32, ulreserved: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IWiaEventCallback_Impl: windows_core::IUnknownImpl {
    fn ImageEventCallback(&self, peventguid: *const windows_core::GUID, bstreventdescription: &windows_core::BSTR, bstrdeviceid: &windows_core::BSTR, bstrdevicedescription: &windows_core::BSTR, dwdevicetype: u32, bstrfullitemname: &windows_core::BSTR, puleventtype: *mut u32, ulreserved: u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IWiaImageFilter {
    pub unsafe fn InitializeFilter<P0, P1>(&self, pwiaitem2: P0, pwiatransfercallback: P1) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetNewCallback<P0>(&self, pwiatransfercallback: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn FilterPreviewImage<P1, P3>(&self, lflags: i32, pwiachilditem2: P1, inputimageextents: super::super::Foundation::RECT, pinputstream: P3) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<IWiaItem2>,
    ...
    pub unsafe fn ApplyProperties<P0>(&self, pwiapropertystorage: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IWiaImageFilter_Impl: windows_core::IUnknownImpl {
    fn InitializeFilter(&self, pwiaitem2: windows_core::Ref<'_, IWiaItem2>, pwiatransfercallback: windows_core::Ref<'_, IWiaTransferCallback>) -> Result<(), windows_result::HRESULT>;
    fn SetNewCallback(&self, pwiatransfercallback: windows_core::Ref<'_, IWiaTransferCallback>) -> Result<(), windows_result::HRESULT>;
    fn FilterPreviewImage(&self, lflags: i32, pwiachilditem2: windows_core::Ref<'_, IWiaItem2>, inputimageextents: &super::super::Foundation::RECT, pinputstream: windows_core::Ref<'_, super::super::System::Com::IStream>) -> Result<(), windows_result::HRESULT>;
    fn ApplyProperties(&self, pwiapropertystorage: windows_core::Ref<'_, IWiaPropertyStorage>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWiaItem {
    pub unsafe fn GetItemType(&self) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetItemType)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn AnalyzeItem(&self, lflags: i32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).AnalyzeItem)(windows_core::Interface::as_raw(self), lflags).ok() }
    }
    pub unsafe fn EnumChildItems(&self) -> Result<IEnumWiaItem, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn DeleteItem(&self, lflags: i32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).DeleteItem)(windows_core::Interface::as_raw(self), lflags).ok() }
    }
    pub unsafe fn CreateChildItem(&self, lflags: i32, bstritemname: &windows_core::BSTR, bstrfullitemname: &windows_core::BSTR) -> Result<IWiaItem, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumRegisterEventInfo(&self, lflags: i32, peventguid: *const windows_core::GUID) -> Result<IEnumWIA_DEV_CAPS, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn FindItemByName(&self, lflags: i32, bstrfullitemname: &windows_core::BSTR) -> Result<IWiaItem, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn DeviceDlg(&self, hwndparent: super::super::Foundation::HWND, lflags: i32, lintent: i32, plitemcount: *mut i32, ppiwiaitem: *mut *mut Option<IWiaItem>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn DeviceCommand(&self, lflags: i32, pcmdguid: *const windows_core::GUID, piwiaitem: *mut Option<IWiaItem>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetRootItem(&self) -> Result<IWiaItem, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumDeviceCapabilities(&self, lflags: i32) -> Result<IEnumWIA_DEV_CAPS, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn DumpDrvItemData(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn DumpTreeItemData(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Diagnostic(&self, pbuffer: &[u8]) -> Result<(), windows_result::HRESULT> {
...
pub trait IWiaItem_Impl: windows_core::IUnknownImpl {
    fn GetItemType(&self) -> Result<i32, windows_result::HRESULT>;
    fn AnalyzeItem(&self, lflags: i32) -> Result<(), windows_result::HRESULT>;
    fn EnumChildItems(&self) -> Result<IEnumWiaItem, windows_result::HRESULT>;
    fn DeleteItem(&self, lflags: i32) -> Result<(), windows_result::HRESULT>;
    fn CreateChildItem(&self, lflags: i32, bstritemname: &windows_core::BSTR, bstrfullitemname: &windows_core::BSTR) -> Result<IWiaItem, windows_result::HRESULT>;
    fn EnumRegisterEventInfo(&self, lflags: i32, peventguid: *const windows_core::GUID) -> Result<IEnumWIA_DEV_CAPS, windows_result::HRESULT>;
    fn FindItemByName(&self, lflags: i32, bstrfullitemname: &windows_core::BSTR) -> Result<IWiaItem, windows_result::HRESULT>;
    fn DeviceDlg(&self, hwndparent: super::super::Foundation::HWND, lflags: i32, lintent: i32, plitemcount: *mut i32, ppiwiaitem: *mut *mut Option<IWiaItem>) -> Result<(), windows_result::HRESULT>;
    fn DeviceCommand(&self, lflags: i32, pcmdguid: *const windows_core::GUID, piwiaitem: windows_core::OutRef<'_, IWiaItem>) -> Result<(), windows_result::HRESULT>;
    fn GetRootItem(&self) -> Result<IWiaItem, windows_result::HRESULT>;
    fn EnumDeviceCapabilities(&self, lflags: i32) -> Result<IEnumWIA_DEV_CAPS, windows_result::HRESULT>;
    fn DumpItemData(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn DumpDrvItemData(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn DumpTreeItemData(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn Diagnostic(&self, ulsize: u32, pbuffer: *const u8) -> Result<(), windows_result::HRESULT>;
}
impl IWiaItem_Vtbl {
...
impl IWiaItem2 {
    pub unsafe fn CreateChildItem(&self, litemflags: i32, lcreationflags: i32, bstritemname: &windows_core::BSTR) -> Result<IWiaItem2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn EnumChildItems(&self, pcategoryguid: Option<*const windows_core::GUID>) -> Result<IEnumWiaItem2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn FindItemByName(&self, lflags: i32, bstrfullitemname: &windows_core::BSTR) -> Result<IWiaItem2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FindItemByName)(windows_core::Interface::as_raw(self), lflags, core::mem::transmute_copy(bstrfullitemname), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn GetItemCategory(&self) -> Result<windows_core::GUID, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn DeviceDlg(&self, lflags: i32, hwndparent: super::super::Foundation::HWND, bstrfoldername: &windows_core::BSTR, bstrfilename: &windows_core::BSTR, plnumfiles: *mut i32, ppbstrfilepaths: *mut *mut windows_core::BSTR, ppitem: Option<*mut Option<IWiaItem2>>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn DeviceCommand(&self, lflags: i32, pcmdguid: *const windows_core::GUID, ppiwiaitem2: *mut Option<IWiaItem2>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn CheckExtension(&self, lflags: i32, bstrname: &windows_core::BSTR, riidextensioninterface: *const windows_core::GUID, pbextensionexists: *mut windows_core::BOOL) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetExtension(&self, lflags: i32, bstrname: &windows_core::BSTR, riidextensioninterface: *const windows_core::GUID, ppout: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetParentItem(&self) -> Result<IWiaItem2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetParentItem)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn GetRootItem(&self) -> Result<IWiaItem2, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRootItem)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn GetPreviewComponent(&self, lflags: i32) -> Result<IWiaPreview, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWiaItem2_Impl: windows_core::IUnknownImpl {
    fn CreateChildItem(&self, litemflags: i32, lcreationflags: i32, bstritemname: &windows_core::BSTR) -> Result<IWiaItem2, windows_result::HRESULT>;
    fn DeleteItem(&self, lflags: i32) -> Result<(), windows_result::HRESULT>;
    fn EnumChildItems(&self, pcategoryguid: *const windows_core::GUID) -> Result<IEnumWiaItem2, windows_result::HRESULT>;
    fn FindItemByName(&self, lflags: i32, bstrfullitemname: &windows_core::BSTR) -> Result<IWiaItem2, windows_result::HRESULT>;
    fn GetItemCategory(&self) -> Result<windows_core::GUID, windows_result::HRESULT>;
    fn GetItemType(&self) -> Result<i32, windows_result::HRESULT>;
    fn DeviceDlg(&self, lflags: i32, hwndparent: super::super::Foundation::HWND, bstrfoldername: &windows_core::BSTR, bstrfilename: &windows_core::BSTR, plnumfiles: *mut i32, ppbstrfilepaths: *mut *mut windows_core::BSTR, ppitem: windows_core::OutRef<'_, IWiaItem2>) -> Result<(), windows_result::HRESULT>;
    fn DeviceCommand(&self, lflags: i32, pcmdguid: *const windows_core::GUID, ppiwiaitem2: windows_core::OutRef<'_, IWiaItem2>) -> Result<(), windows_result::HRESULT>;
    fn EnumDeviceCapabilities(&self, lflags: i32) -> Result<IEnumWIA_DEV_CAPS, windows_result::HRESULT>;
    fn CheckExtension(&self, lflags: i32, bstrname: &windows_core::BSTR, riidextensioninterface: *const windows_core::GUID, pbextensionexists: *mut windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn GetExtension(&self, lflags: i32, bstrname: &windows_core::BSTR, riidextensioninterface: *const windows_core::GUID, ppout: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
    fn GetParentItem(&self) -> Result<IWiaItem2, windows_result::HRESULT>;
    fn GetRootItem(&self) -> Result<IWiaItem2, windows_result::HRESULT>;
    fn GetPreviewComponent(&self, lflags: i32) -> Result<IWiaPreview, windows_result::HRESULT>;
    fn EnumRegisterEventInfo(&self, lflags: i32, peventguid: *const windows_core::GUID) -> Result<IEnumWIA_DEV_CAPS, windows_result::HRESULT>;
    fn Diagnostic(&self, ulsize: u32, pbuffer: *const u8) -> Result<(), windows_result::HRESULT>;
}
impl IWiaItem2_Vtbl {
...
impl IWiaItemExtras {
    pub unsafe fn GetExtendedErrorInfo(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Escape(&self, dwescapecode: u32, lpindata: &[u8], poutdata: &mut [u8], pdwactualdatasize: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn CancelPendingIO(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IWiaItemExtras_Impl: windows_core::IUnknownImpl {
    fn GetExtendedErrorInfo(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn Escape(&self, dwescapecode: u32, lpindata: *const u8, cbindatasize: u32, poutdata: *mut u8, dwoutdatasize: u32, pdwactualdatasize: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn CancelPendingIO(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IWiaLog {
    pub unsafe fn InitializeLog(&self, hinstance: i32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).InitializeLog)(windows_core::Interface::as_raw(self), hinstance).ok() }
    }
    pub unsafe fn hResult(&self, hresult: windows_core::HRESULT) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).hResult)(windows_core::Interface::as_raw(self), hresult).ok() }
    }
    pub unsafe fn Log(&self, lflags: i32, lresid: i32, ldetail: i32, bstrtext: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
...
pub trait IWiaLog_Impl: windows_core::IUnknownImpl {
    fn InitializeLog(&self, hinstance: i32) -> Result<(), windows_result::HRESULT>;
    fn hResult(&self, hresult: windows_core::HRESULT) -> Result<(), windows_result::HRESULT>;
    fn Log(&self, lflags: i32, lresid: i32, ldetail: i32, bstrtext: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
}
impl IWiaLog_Vtbl {
...
impl IWiaLogEx {
    pub unsafe fn InitializeLogEx(&self, hinstance: *const u8) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn hResultEx(&self, lmethodid: i32, hresult: windows_core::HRESULT) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).hResultEx)(windows_core::Interface::as_raw(self), lmethodid, hresult).ok() }
    }
    pub unsafe fn LogEx(&self, lmethodid: i32, lflags: i32, lresid: i32, ldetail: i32, bstrtext: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
...
pub trait IWiaLogEx_Impl: windows_core::IUnknownImpl {
    fn InitializeLogEx(&self, hinstance: *const u8) -> Result<(), windows_result::HRESULT>;
    fn hResult(&self, hresult: windows_core::HRESULT) -> Result<(), windows_result::HRESULT>;
    fn Log(&self, lflags: i32, lresid: i32, ldetail: i32, bstrtext: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn hResultEx(&self, lmethodid: i32, hresult: windows_core::HRESULT) -> Result<(), windows_result::HRESULT>;
    fn LogEx(&self, lmethodid: i32, lflags: i32, lresid: i32, ldetail: i32, bstrtext: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
}
impl IWiaLogEx_Vtbl {
...
impl IWiaMiniDrv {
    ...
    pub unsafe fn drvAcquireItemData(&self, __midl__iwiaminidrv0009: *const u8, __midl__iwiaminidrv0010: i32, __midl__iwiaminidrv0011: *mut MINIDRV_TRANSFER_CONTEXT, __midl__iwiaminidrv0012: *mut i32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn drvInitItemProperties(&self, __midl__iwiaminidrv0013: *const u8, __midl__iwiaminidrv0014: i32) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn drvValidateItemProperties(&self, __midl__iwiaminidrv0016: *const u8, __midl__iwiaminidrv0017: i32, __midl__iwiaminidrv0018: u32, __midl__iwiaminidrv0019: *const super::super::System::Com::StructuredStorage::PROPSPEC) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn drvWriteItemProperties(&self, __midl__iwiaminidrv0021: *const u8, __midl__iwiaminidrv0022: i32, __midl__iwiaminidrv0023: *const MINIDRV_TRANSFER_CONTEXT) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn drvReadItemProperties(&self, __midl__iwiaminidrv0025: *const u8, __midl__iwiaminidrv0026: i32, __midl__iwiaminidrv0027: u32, __midl__iwiaminidrv0028: *const super::super::System::Com::StructuredStorage::PROPSPEC) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn drvLockWiaDevice(&self, __midl__iwiaminidrv0030: *const u8, __midl__iwiaminidrv0031: i32) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn drvUnLockWiaDevice(&self, __midl__iwiaminidrv0033: *const u8, __midl__iwiaminidrv0034: i32) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn drvAnalyzeItem(&self, __midl__iwiaminidrv0036: *const u8, __midl__iwiaminidrv0037: i32, __midl__iwiaminidrv0038: *const i32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn drvGetDeviceErrorStr(&self, __midl__iwiaminidrv0039: i32, __midl__iwiaminidrv0040: i32, __midl__iwiaminidrv0041: *mut windows_core::PWSTR, __midl__iwiaminidrv0042: *mut i32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn drvDeviceCommand(&self, __midl__iwiaminidrv0043: *const u8, __midl__iwiaminidrv0044: i32, __midl__iwiaminidrv0045: *const windows_core::GUID, __midl__iwiaminidrv0046: *mut Option<IWiaDrvItem>, __midl__iwiaminidrv0047: *mut i32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn drvGetCapabilities(&self, __midl__iwiaminidrv0048: *const u8, __midl__iwiaminidrv0049: i32, __midl__iwiaminidrv0050: *mut i32, __midl__iwiaminidrv0051: *mut *mut WIA_DEV_CAP_DRV, __midl__iwiaminidrv0052: *mut i32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn drvDeleteItem(&self, __midl__iwiaminidrv0053: *const u8, __midl__iwiaminidrv0054: i32) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn drvFreeDrvItemContext(&self, __midl__iwiaminidrv0056: i32, __midl__iwiaminidrv0057: *const u8) -> Result<i32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn drvGetWiaFormatInfo(&self, __midl__iwiaminidrv0059: *const u8, __midl__iwiaminidrv0060: i32, __midl__iwiaminidrv0061: *mut i32, __midl__iwiaminidrv0062: *mut *mut WIA_FORMAT_INFO, __midl__iwiaminidrv0063: *mut i32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn drvNotifyPnpEvent(&self, peventguid: *const windows_core::GUID, bstrdeviceid: &windows_core::BSTR, ulreserved: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn drvUnInitializeWia(&self, __midl__iwiaminidrv0064: *const u8) -> Result<(), windows_result::HRESULT> {
...
pub trait IWiaMiniDrv_Impl: windows_core::IUnknownImpl {
    ...
    fn drvAcquireItemData(&self, __midl__iwiaminidrv0009: *const u8, __midl__iwiaminidrv0010: i32, __midl__iwiaminidrv0011: *mut MINIDRV_TRANSFER_CONTEXT, __midl__iwiaminidrv0012: *mut i32) -> Result<(), windows_result::HRESULT>;
    fn drvInitItemProperties(&self, __midl__iwiaminidrv0013: *const u8, __midl__iwiaminidrv0014: i32) -> Result<i32, windows_result::HRESULT>;
    fn drvValidateItemProperties(&self, __midl__iwiaminidrv0016: *const u8, __midl__iwiaminidrv0017: i32, __midl__iwiaminidrv0018: u32, __midl__iwiaminidrv0019: *const super::super::System::Com::StructuredStorage::PROPSPEC) -> Result<i32, windows_result::HRESULT>;
    fn drvWriteItemProperties(&self, __midl__iwiaminidrv0021: *const u8, __midl__iwiaminidrv0022: i32, __midl__iwiaminidrv0023: *const MINIDRV_TRANSFER_CONTEXT) -> Result<i32, windows_result::HRESULT>;
    fn drvReadItemProperties(&self, __midl__iwiaminidrv0025: *const u8, __midl__iwiaminidrv0026: i32, __midl__iwiaminidrv0027: u32, __midl__iwiaminidrv0028: *const super::super::System::Com::StructuredStorage::PROPSPEC) -> Result<i32, windows_result::HRESULT>;
    fn drvLockWiaDevice(&self, __midl__iwiaminidrv0030: *const u8, __midl__iwiaminidrv0031: i32) -> Result<i32, windows_result::HRESULT>;
    fn drvUnLockWiaDevice(&self, __midl__iwiaminidrv0033: *const u8, __midl__iwiaminidrv0034: i32) -> Result<i32, windows_result::HRESULT>;
    fn drvAnalyzeItem(&self, __midl__iwiaminidrv0036: *const u8, __midl__iwiaminidrv0037: i32, __midl__iwiaminidrv0038: *const i32) -> Result<(), windows_result::HRESULT>;
    fn drvGetDeviceErrorStr(&self, __midl__iwiaminidrv0039: i32, __midl__iwiaminidrv0040: i32, __midl__iwiaminidrv0041: *mut windows_core::PWSTR, __midl__iwiaminidrv0042: *mut i32) -> Result<(), windows_result::HRESULT>;
    fn drvDeviceCommand(&self, __midl__iwiaminidrv0043: *const u8, __midl__iwiaminidrv0044: i32, __midl__iwiaminidrv0045: *const windows_core::GUID, __midl__iwiaminidrv0046: windows_core::OutRef<'_, IWiaDrvItem>, __midl__iwiaminidrv0047: *mut i32) -> Result<(), windows_result::HRESULT>;
    fn drvGetCapabilities(&self, __midl__iwiaminidrv0048: *const u8, __midl__iwiaminidrv0049: i32, __midl__iwiaminidrv0050: *mut i32, __midl__iwiaminidrv0051: *mut *mut WIA_DEV_CAP_DRV, __midl__iwiaminidrv0052: *mut i32) -> Result<(), windows_result::HRESULT>;
    fn drvDeleteItem(&self, __midl__iwiaminidrv0053: *const u8, __midl__iwiaminidrv0054: i32) -> Result<i32, windows_result::HRESULT>;
    fn drvFreeDrvItemContext(&self, __midl__iwiaminidrv0056: i32, __midl__iwiaminidrv0057: *const u8) -> Result<i32, windows_result::HRESULT>;
    fn drvGetWiaFormatInfo(&self, __midl__iwiaminidrv0059: *const u8, __midl__iwiaminidrv0060: i32, __midl__iwiaminidrv0061: *mut i32, __midl__iwiaminidrv0062: *mut *mut WIA_FORMAT_INFO, __midl__iwiaminidrv0063: *mut i32) -> Result<(), windows_result::HRESULT>;
    fn drvNotifyPnpEvent(&self, peventguid: *const windows_core::GUID, bstrdeviceid: &windows_core::BSTR, ulreserved: u32) -> Result<(), windows_result::HRESULT>;
    fn drvUnInitializeWia(&self, __midl__iwiaminidrv0064: *const u8) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com_StructuredStorage")]
...
impl IWiaMiniDrvCallBack {
    pub unsafe fn MiniDrvCallback(&self, lreason: i32, lstatus: i32, lpercentcomplete: i32, loffset: i32, llength: i32, ptranctx: *const MINIDRV_TRANSFER_CONTEXT, lreserved: i32) -> Result<(), windows_result::HRESULT> {
...
pub trait IWiaMiniDrvCallBack_Impl: windows_core::IUnknownImpl {
    fn MiniDrvCallback(&self, lreason: i32, lstatus: i32, lpercentcomplete: i32, loffset: i32, llength: i32, ptranctx: *const MINIDRV_TRANSFER_CONTEXT, lreserved: i32) -> Result<(), windows_result::HRESULT>;
}
...
impl IWiaMiniDrvTransferCallback {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetNextStream(&self, lflags: i32, bstritemname: &windows_core::BSTR, bstrfullitemname: &windows_core::BSTR) -> Result<super::super::System::Com::IStream, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SendMessage(&self, lflags: i32, pwiatransferparams: *const WiaTransferParams) -> Result<(), windows_result::HRESULT> {
...
pub trait IWiaMiniDrvTransferCallback_Impl: windows_core::IUnknownImpl {
    fn GetNextStream(&self, lflags: i32, bstritemname: &windows_core::BSTR, bstrfullitemname: &windows_core::BSTR) -> Result<super::super::System::Com::IStream, windows_result::HRESULT>;
    fn SendMessage(&self, lflags: i32, pwiatransferparams: *const WiaTransferParams) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWiaNotifyDevMgr {
    pub unsafe fn NewDeviceArrival(&self) -> Result<(), windows_result::HRESULT> {
...
pub trait IWiaNotifyDevMgr_Impl: windows_core::IUnknownImpl {
    fn NewDeviceArrival(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IWiaPreview {
    pub unsafe fn GetNewPreview<P1, P2>(&self, lflags: i32, pwiaitem2: P1, pwiatransfercallback: P2) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<IWiaItem2>,
    ...
    pub unsafe fn UpdatePreview<P1, P2>(&self, lflags: i32, pchildwiaitem2: P1, pwiatransfercallback: P2) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<IWiaItem2>,
        P2: windows_core::Param<IWiaTransferCallback>,
    {
    ...
    pub unsafe fn DetectRegions(&self, lflags: i32) -> Result<(), windows_result::HRESULT> {
...
pub trait IWiaPreview_Impl: windows_core::IUnknownImpl {
    fn GetNewPreview(&self, lflags: i32, pwiaitem2: windows_core::Ref<'_, IWiaItem2>, pwiatransfercallback: windows_core::Ref<'_, IWiaTransferCallback>) -> Result<(), windows_result::HRESULT>;
    fn UpdatePreview(&self, lflags: i32, pchildwiaitem2: windows_core::Ref<'_, IWiaItem2>, pwiatransfercallback: windows_core::Ref<'_, IWiaTransferCallback>) -> Result<(), windows_result::HRESULT>;
    fn DetectRegions(&self, lflags: i32) -> Result<(), windows_result::HRESULT>;
...
impl IWiaPropertyStorage {
    ...
    pub unsafe fn ReadMultiple(&self, cpspec: u32, rgpspec: *const super::super::System::Com::StructuredStorage::PROPSPEC, rgpropvar: *mut super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn WriteMultiple(&self, cpspec: u32, rgpspec: *const super::super::System::Com::StructuredStorage::PROPSPEC, rgpropvar: *const super::super::System::Com::StructuredStorage::PROPVARIANT, propidnamefirst: u32) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn DeleteMultiple(&self, rgpspec: &[super::super::System::Com::StructuredStorage::PROPSPEC]) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn Enum(&self) -> Result<super::super::System::Com::StructuredStorage::IEnumSTATPROPSTG, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetTimes(&self, pctime: *const super::super::Foundation::FILETIME, patime: *const super::super::Foundation::FILETIME, pmtime: *const super::super::Foundation::FILETIME) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(feature = "Win32_System_Com_StructuredStorage")]
    pub unsafe fn Stat(&self, pstatpsstg: *mut super::super::System::Com::StructuredStorage::STATPROPSETSTG) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Stat)(windows_core::Interface::as_raw(self), pstatpsstg as _).ok() }
    }
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn GetPropertyAttributes(&self, cpspec: u32, rgpspec: *const super::super::System::Com::StructuredStorage::PROPSPEC, rgflags: *mut u32, rgpropvar: *mut super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetPropertyStream(&self, pcompatibilityid: *mut windows_core::GUID, ppistream: *mut Option<super::super::System::Com::IStream>) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn SetPropertyStream<P1>(&self, pcompatibilityid: *mut windows_core::GUID, pistream: P1) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IWiaPropertyStorage_Impl: windows_core::IUnknownImpl {
    fn ReadMultiple(&self, cpspec: u32, rgpspec: *const super::super::System::Com::StructuredStorage::PROPSPEC, rgpropvar: *mut super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT>;
    fn WriteMultiple(&self, cpspec: u32, rgpspec: *const super::super::System::Com::StructuredStorage::PROPSPEC, rgpropvar: *const super::super::System::Com::StructuredStorage::PROPVARIANT, propidnamefirst: u32) -> Result<(), windows_result::HRESULT>;
    fn DeleteMultiple(&self, cpspec: u32, rgpspec: *const super::super::System::Com::StructuredStorage::PROPSPEC) -> Result<(), windows_result::HRESULT>;
    ...
    fn Enum(&self) -> Result<super::super::System::Com::StructuredStorage::IEnumSTATPROPSTG, windows_result::HRESULT>;
    fn SetTimes(&self, pctime: *const super::super::Foundation::FILETIME, patime: *const super::super::Foundation::FILETIME, pmtime: *const super::super::Foundation::FILETIME) -> Result<(), windows_result::HRESULT>;
    fn SetClass(&self, clsid: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn Stat(&self, pstatpsstg: *mut super::super::System::Com::StructuredStorage::STATPROPSETSTG) -> Result<(), windows_result::HRESULT>;
    fn GetPropertyAttributes(&self, cpspec: u32, rgpspec: *const super::super::System::Com::StructuredStorage::PROPSPEC, rgflags: *mut u32, rgpropvar: *mut super::super::System::Com::StructuredStorage::PROPVARIANT) -> Result<(), windows_result::HRESULT>;
    fn GetCount(&self) -> Result<u32, windows_result::HRESULT>;
    fn GetPropertyStream(&self, pcompatibilityid: *mut windows_core::GUID, ppistream: windows_core::OutRef<'_, super::super::System::Com::IStream>) -> Result<(), windows_result::HRESULT>;
    fn SetPropertyStream(&self, pcompatibilityid: *mut windows_core::GUID, pistream: windows_core::Ref<'_, super::super::System::Com::IStream>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl IWiaSegmentationFilter {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn DetectRegions<P1, P2>(&self, lflags: i32, pinputstream: P1, pwiaitem2: P2) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::System::Com::IStream>,
        P2: windows_core::Param<IWiaItem2>,
    {
...
pub trait IWiaSegmentationFilter_Impl: windows_core::IUnknownImpl {
    fn DetectRegions(&self, lflags: i32, pinputstream: windows_core::Ref<'_, super::super::System::Com::IStream>, pwiaitem2: windows_core::Ref<'_, IWiaItem2>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWiaTransfer {
    pub unsafe fn Download<P1>(&self, lflags: i32, piwiatransfercallback: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<IWiaTransferCallback>,
    {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Upload<P1, P2>(&self, lflags: i32, psource: P1, piwiatransfercallback: P2) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::System::Com::IStream>,
        P2: windows_core::Param<IWiaTransferCallback>,
    {
    ...
    pub unsafe fn EnumWIA_FORMAT_INFO(&self) -> Result<IEnumWIA_FORMAT_INFO, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWiaTransfer_Impl: windows_core::IUnknownImpl {
    fn Download(&self, lflags: i32, piwiatransfercallback: windows_core::Ref<'_, IWiaTransferCallback>) -> Result<(), windows_result::HRESULT>;
    fn Upload(&self, lflags: i32, psource: windows_core::Ref<'_, super::super::System::Com::IStream>, piwiatransfercallback: windows_core::Ref<'_, IWiaTransferCallback>) -> Result<(), windows_result::HRESULT>;
    fn Cancel(&self) -> Result<(), windows_result::HRESULT>;
    fn EnumWIA_FORMAT_INFO(&self) -> Result<IEnumWIA_FORMAT_INFO, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWiaTransferCallback {
    pub unsafe fn TransferCallback(&self, lflags: i32, pwiatransferparams: *const WiaTransferParams) -> Result<(), windows_result::HRESULT> {
...
pub trait IWiaTransferCallback_Impl: windows_core::IUnknownImpl {
    fn TransferCallback(&self, lflags: i32, pwiatransferparams: *const WiaTransferParams) -> Result<(), windows_result::HRESULT>;
    fn GetNextStream(&self, lflags: i32, bstritemname: &windows_core::BSTR, bstrfullitemname: &windows_core::BSTR) -> Result<super::super::System::Com::IStream, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IWiaUIExtension {
    pub unsafe fn DeviceDialog(&self, pdevicedialogdata: *const DEVICEDIALOGDATA) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetDeviceIcon(&self, bstrdeviceid: &windows_core::BSTR, phicon: *mut super::super::UI::WindowsAndMessaging::HICON, nsize: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetDeviceBitmapLogo(&self, bstrdeviceid: &windows_core::BSTR, phbitmap: *mut super::super::Graphics::Gdi::HBITMAP, nmaxwidth: u32, nmaxheight: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IWiaUIExtension_Impl: windows_core::IUnknownImpl {
    fn DeviceDialog(&self, pdevicedialogdata: *const DEVICEDIALOGDATA) -> Result<(), windows_result::HRESULT>;
    fn GetDeviceIcon(&self, bstrdeviceid: &windows_core::BSTR, phicon: *mut super::super::UI::WindowsAndMessaging::HICON, nsize: u32) -> Result<(), windows_result::HRESULT>;
    fn GetDeviceBitmapLogo(&self, bstrdeviceid: &windows_core::BSTR, phbitmap: *mut super::super::Graphics::Gdi::HBITMAP, nmaxwidth: u32, nmaxheight: u32) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Win32_Graphics_Gdi", feature = "Win32_UI_WindowsAndMessaging"))]
...
impl IWiaUIExtension2 {
    pub unsafe fn DeviceDialog(&self, pdevicedialogdata: *const DEVICEDIALOGDATA2) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).DeviceDialog)(windows_core::Interface::as_raw(self), core::mem::transmute(pdevicedialogdata)).ok() }
    }
    #[cfg(feature = "Win32_UI_WindowsAndMessaging")]
    pub unsafe fn GetDeviceIcon(&self, bstrdeviceid: &windows_core::BSTR, phicon: *mut super::super::UI::WindowsAndMessaging::HICON, nsize: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IWiaUIExtension2_Impl: windows_core::IUnknownImpl {
    fn DeviceDialog(&self, pdevicedialogdata: *const DEVICEDIALOGDATA2) -> Result<(), windows_result::HRESULT>;
    fn GetDeviceIcon(&self, bstrdeviceid: &windows_core::BSTR, phicon: *mut super::super::UI::WindowsAndMessaging::HICON, nsize: u32) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
...
impl IWiaVideo {
    pub unsafe fn PreviewVisible(&self) -> Result<windows_core::BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PreviewVisible)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetPreviewVisible(&self, bpreviewvisible: bool) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetPreviewVisible)(windows_core::Interface::as_raw(self), bpreviewvisible.into()).ok() }
    }
    pub unsafe fn ImagesDirectory(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetImagesDirectory(&self, bstrimagedirectory: &windows_core::BSTR) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn CreateVideoByWiaDevID(&self, bstrwiadeviceid: &windows_core::BSTR, hwndparent: super::super::Foundation::HWND, bstretchtofitparent: bool, bautobeginplayback: bool) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn CreateVideoByDevNum(&self, uidevicenumber: u32, hwndparent: super::super::Foundation::HWND, bstretchtofitparent: bool, bautobeginplayback: bool) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn CreateVideoByName(&self, bstrfriendlyname: &windows_core::BSTR, hwndparent: super::super::Foundation::HWND, bstretchtofitparent: bool, bautobeginplayback: bool) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn DestroyVideo(&self) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn TakePicture(&self) -> Result<windows_core::BSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn ResizeVideo(&self, bstretchtofitparent: bool) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).ResizeVideo)(windows_core::Interface::as_raw(self), bstretchtofitparent.into()).ok() }
    }
    pub unsafe fn GetCurrentState(&self) -> Result<WIAVIDEO_STATE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWiaVideo_Impl: windows_core::IUnknownImpl {
    fn PreviewVisible(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
    fn SetPreviewVisible(&self, bpreviewvisible: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn ImagesDirectory(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn SetImagesDirectory(&self, bstrimagedirectory: &windows_core::BSTR) -> Result<(), windows_result::HRESULT>;
    fn CreateVideoByWiaDevID(&self, bstrwiadeviceid: &windows_core::BSTR, hwndparent: super::super::Foundation::HWND, bstretchtofitparent: windows_core::BOOL, bautobeginplayback: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn CreateVideoByDevNum(&self, uidevicenumber: u32, hwndparent: super::super::Foundation::HWND, bstretchtofitparent: windows_core::BOOL, bautobeginplayback: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn CreateVideoByName(&self, bstrfriendlyname: &windows_core::BSTR, hwndparent: super::super::Foundation::HWND, bstretchtofitparent: windows_core::BOOL, bautobeginplayback: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn DestroyVideo(&self) -> Result<(), windows_result::HRESULT>;
    fn Play(&self) -> Result<(), windows_result::HRESULT>;
    fn Pause(&self) -> Result<(), windows_result::HRESULT>;
    fn TakePicture(&self) -> Result<windows_core::BSTR, windows_result::HRESULT>;
    fn ResizeVideo(&self, bstretchtofitparent: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn GetCurrentState(&self) -> Result<WIAVIDEO_STATE, windows_result::HRESULT>;
}
impl IWiaVideo_Vtbl {
