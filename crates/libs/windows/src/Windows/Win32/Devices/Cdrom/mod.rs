...
pub const CDDA: TRACK_MODE_TYPE = TRACK_MODE_TYPE(2);
...
pub const Cdrom10Nominal20Exceptions: CDROM_PERFORMANCE_TOLERANCE_TYPE = CDROM_PERFORMANCE_TOLERANCE_TYPE(1);
pub const CdromCAVRotation: WRITE_ROTATION = WRITE_ROTATION(1);
pub const CdromDefaultRotation: WRITE_ROTATION = WRITE_ROTATION(0);
pub const CdromEntirePerformanceList: CDROM_PERFORMANCE_EXCEPTION_TYPE = CDROM_PERFORMANCE_EXCEPTION_TYPE(2);
pub const CdromNominalPerformance: CDROM_PERFORMANCE_EXCEPTION_TYPE = CDROM_PERFORMANCE_EXCEPTION_TYPE(1);
pub const CdromPerformanceExceptionsOnly: CDROM_PERFORMANCE_EXCEPTION_TYPE = CDROM_PERFORMANCE_EXCEPTION_TYPE(3);
pub const CdromPerformanceRequest: CDROM_PERFORMANCE_REQUEST_TYPE = CDROM_PERFORMANCE_REQUEST_TYPE(1);
pub const CdromReadPerformance: CDROM_PERFORMANCE_TYPE = CDROM_PERFORMANCE_TYPE(1);
pub const CdromSetSpeed: CDROM_SPEED_REQUEST = CDROM_SPEED_REQUEST(0);
pub const CdromSetStreaming: CDROM_SPEED_REQUEST = CDROM_SPEED_REQUEST(1);
pub const CdromStreamingDisable: STREAMING_CONTROL_REQUEST_TYPE = STREAMING_CONTROL_REQUEST_TYPE(1);
pub const CdromStreamingEnableForReadOnly: STREAMING_CONTROL_REQUEST_TYPE = STREAMING_CONTROL_REQUEST_TYPE(2);
pub const CdromStreamingEnableForReadWrite: STREAMING_CONTROL_REQUEST_TYPE = STREAMING_CONTROL_REQUEST_TYPE(4);
pub const CdromStreamingEnableForWriteOnly: STREAMING_CONTROL_REQUEST_TYPE = STREAMING_CONTROL_REQUEST_TYPE(3);
pub const CdromWritePerformance: CDROM_PERFORMANCE_TYPE = CDROM_PERFORMANCE_TYPE(2);
pub const CdromWriteSpeedRequest: CDROM_PERFORMANCE_REQUEST_TYPE = CDROM_PERFORMANCE_REQUEST_TYPE(2);
pub const DIGITAL_COPY_PERMITTED: u32 = 2;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct EXCLUSIVE_ACCESS_REQUEST_TYPE(pub i32);
pub const ExclusiveAccessLockDevice: EXCLUSIVE_ACCESS_REQUEST_TYPE = EXCLUSIVE_ACCESS_REQUEST_TYPE(1);
pub const ExclusiveAccessQueryState: EXCLUSIVE_ACCESS_REQUEST_TYPE = EXCLUSIVE_ACCESS_REQUEST_TYPE(0);
pub const ExclusiveAccessUnlockDevice: EXCLUSIVE_ACCESS_REQUEST_TYPE = EXCLUSIVE_ACCESS_REQUEST_TYPE(2);
...
pub const MediaBlankTypeEraseLastSession: MEDIA_BLANK_TYPE = MEDIA_BLANK_TYPE(6);
pub const MediaBlankTypeFull: MEDIA_BLANK_TYPE = MEDIA_BLANK_TYPE(0);
pub const MediaBlankTypeIncompleteTrack: MEDIA_BLANK_TYPE = MEDIA_BLANK_TYPE(2);
pub const MediaBlankTypeMinimal: MEDIA_BLANK_TYPE = MEDIA_BLANK_TYPE(1);
pub const MediaBlankTypeTrackTail: MEDIA_BLANK_TYPE = MEDIA_BLANK_TYPE(4);
pub const MediaBlankTypeUncloseLastSession: MEDIA_BLANK_TYPE = MEDIA_BLANK_TYPE(5);
pub const MediaBlankTypeUnreserveLastTrack: MEDIA_BLANK_TYPE = MEDIA_BLANK_TYPE(3);
...
pub const RawWithC2: TRACK_MODE_TYPE = TRACK_MODE_TYPE(4);
pub const RawWithC2AndSubCode: TRACK_MODE_TYPE = TRACK_MODE_TYPE(3);
pub const RawWithSubCode: TRACK_MODE_TYPE = TRACK_MODE_TYPE(5);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const SimpleOpcInfo: CDROM_OPC_INFO_TYPE = CDROM_OPC_INFO_TYPE(1);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub const XAForm2: TRACK_MODE_TYPE = TRACK_MODE_TYPE(1);
pub const YellowMode2: TRACK_MODE_TYPE = TRACK_MODE_TYPE(0);
