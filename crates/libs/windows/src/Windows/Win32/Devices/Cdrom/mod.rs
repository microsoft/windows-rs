...
pub const Cdrom10Nominal20Exceptions: CDROM_PERFORMANCE_TOLERANCE_TYPE = CDROM_PERFORMANCE_TOLERANCE_TYPE(1i32);
...
pub const CdromEntirePerformanceList: CDROM_PERFORMANCE_EXCEPTION_TYPE = CDROM_PERFORMANCE_EXCEPTION_TYPE(2i32);
pub const CdromNominalPerformance: CDROM_PERFORMANCE_EXCEPTION_TYPE = CDROM_PERFORMANCE_EXCEPTION_TYPE(1i32);
pub const CdromPerformanceExceptionsOnly: CDROM_PERFORMANCE_EXCEPTION_TYPE = CDROM_PERFORMANCE_EXCEPTION_TYPE(3i32);
pub const CdromPerformanceRequest: CDROM_PERFORMANCE_REQUEST_TYPE = CDROM_PERFORMANCE_REQUEST_TYPE(1i32);
...
pub const CdromStreamingDisable: STREAMING_CONTROL_REQUEST_TYPE = STREAMING_CONTROL_REQUEST_TYPE(1i32);
pub const CdromStreamingEnableForReadOnly: STREAMING_CONTROL_REQUEST_TYPE = STREAMING_CONTROL_REQUEST_TYPE(2i32);
pub const CdromStreamingEnableForReadWrite: STREAMING_CONTROL_REQUEST_TYPE = STREAMING_CONTROL_REQUEST_TYPE(4i32);
pub const CdromStreamingEnableForWriteOnly: STREAMING_CONTROL_REQUEST_TYPE = STREAMING_CONTROL_REQUEST_TYPE(3i32);
pub const CdromWritePerformance: CDROM_PERFORMANCE_TYPE = CDROM_PERFORMANCE_TYPE(2i32);
pub const CdromWriteSpeedRequest: CDROM_PERFORMANCE_REQUEST_TYPE = CDROM_PERFORMANCE_REQUEST_TYPE(2i32);
pub const DIGITAL_COPY_PERMITTED: u32 = 2u32;
pub const ExclusiveAccessLockDevice: EXCLUSIVE_ACCESS_REQUEST_TYPE = EXCLUSIVE_ACCESS_REQUEST_TYPE(1i32);
pub const ExclusiveAccessQueryState: EXCLUSIVE_ACCESS_REQUEST_TYPE = EXCLUSIVE_ACCESS_REQUEST_TYPE(0i32);
pub const ExclusiveAccessUnlockDevice: EXCLUSIVE_ACCESS_REQUEST_TYPE = EXCLUSIVE_ACCESS_REQUEST_TYPE(2i32);
...
impl core::fmt::Debug for CDROM_OPC_INFO_TYPE {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.debug_tuple("CDROM_OPC_INFO_TYPE").field(&self.0).finish()
    }
}
#[repr(transparent)]
#[derive(PartialEq, Eq, Copy, Clone, Default)]
...
impl core::fmt::Debug for CDROM_PERFORMANCE_EXCEPTION_TYPE {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.debug_tuple("CDROM_PERFORMANCE_EXCEPTION_TYPE").field(&self.0).finish()
    }
}
#[repr(transparent)]
#[derive(PartialEq, Eq, Copy, Clone, Default)]
...
impl core::fmt::Debug for CDROM_PERFORMANCE_REQUEST_TYPE {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.debug_tuple("CDROM_PERFORMANCE_REQUEST_TYPE").field(&self.0).finish()
    }
}
#[repr(transparent)]
#[derive(PartialEq, Eq, Copy, Clone, Default)]
...
impl core::fmt::Debug for CDROM_PERFORMANCE_TOLERANCE_TYPE {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.debug_tuple("CDROM_PERFORMANCE_TOLERANCE_TYPE").field(&self.0).finish()
    }
}
#[repr(transparent)]
#[derive(PartialEq, Eq, Copy, Clone, Default)]
...
impl core::fmt::Debug for CDROM_PERFORMANCE_TYPE {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.debug_tuple("CDROM_PERFORMANCE_TYPE").field(&self.0).finish()
    }
}
#[repr(transparent)]
#[derive(PartialEq, Eq, Copy, Clone, Default)]
...
impl core::fmt::Debug for CDROM_SPEED_REQUEST {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.debug_tuple("CDROM_SPEED_REQUEST").field(&self.0).finish()
    }
}
#[repr(transparent)]
#[derive(PartialEq, Eq, Copy, Clone, Default)]
...
impl core::fmt::Debug for EXCLUSIVE_ACCESS_REQUEST_TYPE {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.debug_tuple("EXCLUSIVE_ACCESS_REQUEST_TYPE").field(&self.0).finish()
    }
}
#[repr(transparent)]
#[derive(PartialEq, Eq, Copy, Clone, Default)]
...
impl core::fmt::Debug for MEDIA_BLANK_TYPE {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.debug_tuple("MEDIA_BLANK_TYPE").field(&self.0).finish()
    }
}
#[repr(transparent)]
#[derive(PartialEq, Eq, Copy, Clone, Default)]
...
impl core::fmt::Debug for STREAMING_CONTROL_REQUEST_TYPE {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.debug_tuple("STREAMING_CONTROL_REQUEST_TYPE").field(&self.0).finish()
    }
}
#[repr(transparent)]
#[derive(PartialEq, Eq, Copy, Clone, Default)]
...
impl core::fmt::Debug for TRACK_MODE_TYPE {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.debug_tuple("TRACK_MODE_TYPE").field(&self.0).finish()
    }
}
#[repr(transparent)]
#[derive(PartialEq, Eq, Copy, Clone, Default)]
...
impl core::fmt::Debug for WRITE_ROTATION {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.debug_tuple("WRITE_ROTATION").field(&self.0).finish()
    }
}
#[repr(C)]
