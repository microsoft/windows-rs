...
pub const FAX_E_BAD_GROUP_CONFIGURATION: windows_core::HRESULT = 0x80041B5B_u32 as _;
pub const FAX_E_DEVICE_NUM_LIMIT_EXCEEDED: windows_core::HRESULT = 0x80041B62_u32 as _;
pub const FAX_E_DIRECTORY_IN_USE: windows_core::HRESULT = 0x80041B5F_u32 as _;
pub const FAX_E_FILE_ACCESS_DENIED: windows_core::HRESULT = 0x80041B60_u32 as _;
pub const FAX_E_GROUP_IN_USE: windows_core::HRESULT = 0x80041B5C_u32 as _;
pub const FAX_E_GROUP_NOT_FOUND: windows_core::HRESULT = 0x80041B5A_u32 as _;
pub const FAX_E_MESSAGE_NOT_FOUND: windows_core::HRESULT = 0x80041B61_u32 as _;
pub const FAX_E_NOT_NTFS: windows_core::HRESULT = 0x80041B5E_u32 as _;
pub const FAX_E_NOT_SUPPORTED_ON_THIS_SKU: windows_core::HRESULT = 0x80041B63_u32 as _;
pub const FAX_E_RECIPIENTS_LIMIT: windows_core::HRESULT = 0x80041B65_u32 as _;
pub const FAX_E_RULE_NOT_FOUND: windows_core::HRESULT = 0x80041B5D_u32 as _;
pub const FAX_E_SRV_OUTOFMEMORY: windows_core::HRESULT = 0x80041B59_u32 as _;
pub const FAX_E_VERSION_MISMATCH: windows_core::HRESULT = 0x80041B64_u32 as _;
...
pub const STIERR_ALREADY_INITIALIZED: windows_core::HRESULT = 0x800704DF_u32 as _;
pub const STIERR_BADDRIVER: windows_core::HRESULT = 0x80070077_u32 as _;
pub const STIERR_BETA_VERSION: windows_core::HRESULT = 0x80070481_u32 as _;
pub const STIERR_DEVICENOTREG: i32 = -2147221164i32;
pub const STIERR_DEVICE_LOCKED: windows_core::HRESULT = 0x80070021_u32 as _;
pub const STIERR_DEVICE_NOTREADY: windows_core::HRESULT = 0x80070015_u32 as _;
pub const STIERR_GENERIC: i32 = -2147467259i32;
pub const STIERR_HANDLEEXISTS: windows_core::HRESULT = 0x800700B7_u32 as _;
pub const STIERR_INVALID_DEVICE_NAME: windows_core::HRESULT = 0x8007007B_u32 as _;
pub const STIERR_INVALID_HW_TYPE: windows_core::HRESULT = 0x8007000D_u32 as _;
pub const STIERR_INVALID_PARAM: i32 = -2147024809i32;
pub const STIERR_NEEDS_LOCK: windows_core::HRESULT = 0x8007009E_u32 as _;
pub const STIERR_NOEVENTS: windows_core::HRESULT = 0x80070103_u32 as _;
pub const STIERR_NOINTERFACE: i32 = -2147467262i32;
pub const STIERR_NOTINITIALIZED: i32 = -2147024891i32;
pub const STIERR_NOT_INITIALIZED: windows_core::HRESULT = 0x80070015_u32 as _;
pub const STIERR_OBJECTNOTFOUND: windows_core::HRESULT = 0x80070002_u32 as _;
pub const STIERR_OLD_VERSION: windows_core::HRESULT = 0x8007047E_u32 as _;
pub const STIERR_OUTOFMEMORY: i32 = -2147024882i32;
pub const STIERR_READONLY: i32 = -2147024891i32;
pub const STIERR_SHARING_VIOLATION: windows_core::HRESULT = 0x80070020_u32 as _;
