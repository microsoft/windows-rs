...
pub trait IFaxDocument_Impl: Sized + super::super::System::Com::IDispatch_Impl {
    ...
    fn ConnectedSubmit(&self, pfaxserver: ::core::option::Option<&IFaxServer>) -> ::windows_core::Result<::windows_core::VARIANT>;
...
pub trait IFaxDocument2_Impl: Sized + IFaxDocument_Impl {
    ...
    fn ConnectedSubmit2(&self, pfaxserver: ::core::option::Option<&IFaxServer>, pvfaxoutgoingjobids: *mut ::windows_core::VARIANT, plerrorbodyfile: *mut i32) -> ::windows_core::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
