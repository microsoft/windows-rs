#[inline]
pub unsafe fn DMProcessConfigXMLFiltered<P0>(pszxmlin: P0, rgszallowedcspnodes: &[windows_core::PCWSTR]) -> windows_result::Result<windows_core::BSTR>
where
...
impl IConnectionRequestCallback {
    pub unsafe fn OnComplete(&self, hrstatus: windows_core::HRESULT) -> windows_result::Result<()> {
...
pub trait IConnectionRequestCallback_Impl: windows_core::IUnknownImpl {
    fn OnComplete(&self, hrstatus: windows_core::HRESULT) -> windows_result::Result<()>;
}
...
impl IEnumPortableDeviceConnectors {
    pub unsafe fn Next(&self, pconnectors: &mut [Option<IPortableDeviceConnector>], pcfetched: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Skip(&self, cconnectors: u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumPortableDeviceConnectors> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IEnumPortableDeviceConnectors_Impl: windows_core::IUnknownImpl {
    fn Next(&self, crequested: u32, pconnectors: *mut Option<IPortableDeviceConnector>, pcfetched: *mut u32) -> windows_result::Result<()>;
    fn Skip(&self, cconnectors: u32) -> windows_result::Result<()>;
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumPortableDeviceConnectors>;
}
...
impl IEnumPortableDeviceObjectIDs {
    ...
    pub unsafe fn Clone(&self) -> windows_result::Result<IEnumPortableDeviceObjectIDs> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Clone)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn Cancel(&self) -> windows_result::Result<()> {
...
pub trait IEnumPortableDeviceObjectIDs_Impl: windows_core::IUnknownImpl {
    ...
    fn Reset(&self) -> windows_result::Result<()>;
    fn Clone(&self) -> windows_result::Result<IEnumPortableDeviceObjectIDs>;
...
impl IMediaRadioManager {
    pub unsafe fn GetRadioInstances(&self) -> windows_result::Result<IRadioInstanceCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn OnSystemRadioStateChange(&self, sysradiostate: SYSTEM_RADIO_STATE, utimeoutsec: u32) -> windows_result::Result<()> {
...
pub trait IMediaRadioManager_Impl: windows_core::IUnknownImpl {
    fn GetRadioInstances(&self) -> windows_result::Result<IRadioInstanceCollection>;
    fn OnSystemRadioStateChange(&self, sysradiostate: SYSTEM_RADIO_STATE, utimeoutsec: u32) -> windows_result::Result<()>;
}
...
impl IMediaRadioManagerNotifySink {
    pub unsafe fn OnInstanceAdd<P0>(&self, pradioinstance: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn OnInstanceRemove(&self, bstrradioinstanceid: &windows_core::BSTR) -> windows_result::Result<()> {
    ...
    pub unsafe fn OnInstanceRadioChange(&self, bstrradioinstanceid: &windows_core::BSTR, radiostate: DEVICE_RADIO_STATE) -> windows_result::Result<()> {
...
pub trait IMediaRadioManagerNotifySink_Impl: windows_core::IUnknownImpl {
    fn OnInstanceAdd(&self, pradioinstance: windows_core::Ref<IRadioInstance>) -> windows_result::Result<()>;
    fn OnInstanceRemove(&self, bstrradioinstanceid: &windows_core::BSTR) -> windows_result::Result<()>;
    fn OnInstanceRadioChange(&self, bstrradioinstanceid: &windows_core::BSTR, radiostate: DEVICE_RADIO_STATE) -> windows_result::Result<()>;
}
...
impl IPortableDevice {
    pub unsafe fn Open<P0, P1>(&self, pszpnpdeviceid: P0, pclientinfo: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn SendCommand<P1>(&self, dwflags: u32, pparameters: P1) -> windows_result::Result<IPortableDeviceValues>
    where
        P1: windows_core::Param<IPortableDeviceValues>,
    {
        unsafe {
    ...
    pub unsafe fn Content(&self) -> windows_result::Result<IPortableDeviceContent> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Capabilities(&self) -> windows_result::Result<IPortableDeviceCapabilities> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Advise<P1, P2>(&self, dwflags: u32, pcallback: P1, pparameters: P2) -> windows_result::Result<windows_core::PWSTR>
    where
    ...
    pub unsafe fn Unadvise<P0>(&self, pszcookie: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).Unadvise)(windows_core::Interface::as_raw(self), pszcookie.param().abi()).ok() }
    }
    pub unsafe fn GetPnPDeviceID(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPortableDevice_Impl: windows_core::IUnknownImpl {
    fn Open(&self, pszpnpdeviceid: &windows_core::PCWSTR, pclientinfo: windows_core::Ref<IPortableDeviceValues>) -> windows_result::Result<()>;
    fn SendCommand(&self, dwflags: u32, pparameters: windows_core::Ref<IPortableDeviceValues>) -> windows_result::Result<IPortableDeviceValues>;
    fn Content(&self) -> windows_result::Result<IPortableDeviceContent>;
    fn Capabilities(&self) -> windows_result::Result<IPortableDeviceCapabilities>;
    fn Cancel(&self) -> windows_result::Result<()>;
    fn Close(&self) -> windows_result::Result<()>;
    fn Advise(&self, dwflags: u32, pcallback: windows_core::Ref<IPortableDeviceEventCallback>, pparameters: windows_core::Ref<IPortableDeviceValues>) -> windows_result::Result<windows_core::PWSTR>;
    fn Unadvise(&self, pszcookie: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetPnPDeviceID(&self) -> windows_result::Result<windows_core::PWSTR>;
}
...
impl IPortableDeviceCapabilities {
    pub unsafe fn GetSupportedCommands(&self) -> windows_result::Result<IPortableDeviceKeyCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetCommandOptions(&self, command: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValues> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFunctionalCategories(&self) -> windows_result::Result<IPortableDevicePropVariantCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFunctionalObjects(&self, category: *const windows_core::GUID) -> windows_result::Result<IPortableDevicePropVariantCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetSupportedContentTypes(&self, category: *const windows_core::GUID) -> windows_result::Result<IPortableDevicePropVariantCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetSupportedFormats(&self, contenttype: *const windows_core::GUID) -> windows_result::Result<IPortableDevicePropVariantCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetSupportedFormatProperties(&self, format: *const windows_core::GUID) -> windows_result::Result<IPortableDeviceKeyCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFixedPropertyAttributes(&self, format: *const windows_core::GUID, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValues> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetSupportedEvents(&self) -> windows_result::Result<IPortableDevicePropVariantCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetEventOptions(&self, event: *const windows_core::GUID) -> windows_result::Result<IPortableDeviceValues> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPortableDeviceCapabilities_Impl: windows_core::IUnknownImpl {
    fn GetSupportedCommands(&self) -> windows_result::Result<IPortableDeviceKeyCollection>;
    fn GetCommandOptions(&self, command: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValues>;
    fn GetFunctionalCategories(&self) -> windows_result::Result<IPortableDevicePropVariantCollection>;
    fn GetFunctionalObjects(&self, category: *const windows_core::GUID) -> windows_result::Result<IPortableDevicePropVariantCollection>;
    fn GetSupportedContentTypes(&self, category: *const windows_core::GUID) -> windows_result::Result<IPortableDevicePropVariantCollection>;
    fn GetSupportedFormats(&self, contenttype: *const windows_core::GUID) -> windows_result::Result<IPortableDevicePropVariantCollection>;
    fn GetSupportedFormatProperties(&self, format: *const windows_core::GUID) -> windows_result::Result<IPortableDeviceKeyCollection>;
    fn GetFixedPropertyAttributes(&self, format: *const windows_core::GUID, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValues>;
    fn Cancel(&self) -> windows_result::Result<()>;
    fn GetSupportedEvents(&self) -> windows_result::Result<IPortableDevicePropVariantCollection>;
    fn GetEventOptions(&self, event: *const windows_core::GUID) -> windows_result::Result<IPortableDeviceValues>;
}
...
impl IPortableDeviceConnector {
    pub unsafe fn Connect<P0>(&self, pcallback: P0) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn Disconnect<P0>(&self, pcallback: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IConnectionRequestCallback>,
    {
        unsafe { (windows_core::Interface::vtable(self).Disconnect)(windows_core::Interface::as_raw(self), pcallback.param().abi()).ok() }
    }
    pub unsafe fn Cancel<P0>(&self, pcallback: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IConnectionRequestCallback>,
    {
    ...
    pub unsafe fn GetProperty(&self, ppropertykey: *const super::super::Foundation::DEVPROPKEY, ppropertytype: *mut super::Properties::DEVPROPTYPE, ppdata: *mut *mut u8, pcbdata: *mut u32) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Win32_Devices_Properties")]
    pub unsafe fn SetProperty(&self, ppropertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: super::Properties::DEVPROPTYPE, pdata: &[u8]) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetPnPID(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPortableDeviceConnector_Impl: windows_core::IUnknownImpl {
    fn Connect(&self, pcallback: windows_core::Ref<IConnectionRequestCallback>) -> windows_result::Result<()>;
    fn Disconnect(&self, pcallback: windows_core::Ref<IConnectionRequestCallback>) -> windows_result::Result<()>;
    fn Cancel(&self, pcallback: windows_core::Ref<IConnectionRequestCallback>) -> windows_result::Result<()>;
    fn GetProperty(&self, ppropertykey: *const super::super::Foundation::DEVPROPKEY, ppropertytype: *mut super::Properties::DEVPROPTYPE, ppdata: *mut *mut u8, pcbdata: *mut u32) -> windows_result::Result<()>;
    fn SetProperty(&self, ppropertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: super::Properties::DEVPROPTYPE, pdata: *const u8, cbdata: u32) -> windows_result::Result<()>;
    fn GetPnPID(&self) -> windows_result::Result<windows_core::PWSTR>;
}
#[cfg(feature = "Win32_Devices_Properties")]
...
impl IPortableDeviceContent {
    pub unsafe fn EnumObjects<P1, P2>(&self, dwflags: u32, pszparentobjectid: P1, pfilter: P2) -> windows_result::Result<IEnumPortableDeviceObjectIDs>
    where
    ...
    pub unsafe fn Properties(&self) -> windows_result::Result<IPortableDeviceProperties> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Transfer(&self) -> windows_result::Result<IPortableDeviceResources> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn CreateObjectWithPropertiesOnly<P0>(&self, pvalues: P0, ppszobjectid: *mut windows_core::PWSTR) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn CreateObjectWithPropertiesAndData<P0>(&self, pvalues: P0, ppdata: *mut Option<super::super::System::Com::IStream>, pdwoptimalwritebuffersize: *mut u32, ppszcookie: *mut windows_core::PWSTR) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IPortableDeviceValues>,
    {
    ...
    pub unsafe fn Delete<P1>(&self, dwoptions: u32, pobjectids: P1, ppresults: *mut Option<IPortableDevicePropVariantCollection>) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetObjectIDsFromPersistentUniqueIDs<P0>(&self, ppersistentuniqueids: P0) -> windows_result::Result<IPortableDevicePropVariantCollection>
    where
    ...
    pub unsafe fn Move<P0, P1>(&self, pobjectids: P0, pszdestinationfolderobjectid: P1, ppresults: *mut Option<IPortableDevicePropVariantCollection>) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IPortableDevicePropVariantCollection>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn Copy<P0, P1>(&self, pobjectids: P0, pszdestinationfolderobjectid: P1, ppresults: *mut Option<IPortableDevicePropVariantCollection>) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IPortableDevicePropVariantCollection>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IPortableDeviceContent_Impl: windows_core::IUnknownImpl {
    fn EnumObjects(&self, dwflags: u32, pszparentobjectid: &windows_core::PCWSTR, pfilter: windows_core::Ref<IPortableDeviceValues>) -> windows_result::Result<IEnumPortableDeviceObjectIDs>;
    fn Properties(&self) -> windows_result::Result<IPortableDeviceProperties>;
    fn Transfer(&self) -> windows_result::Result<IPortableDeviceResources>;
    fn CreateObjectWithPropertiesOnly(&self, pvalues: windows_core::Ref<IPortableDeviceValues>, ppszobjectid: *mut windows_core::PWSTR) -> windows_result::Result<()>;
    fn CreateObjectWithPropertiesAndData(&self, pvalues: windows_core::Ref<IPortableDeviceValues>, ppdata: windows_core::OutRef<super::super::System::Com::IStream>, pdwoptimalwritebuffersize: *mut u32, ppszcookie: *mut windows_core::PWSTR) -> windows_result::Result<()>;
    fn Delete(&self, dwoptions: u32, pobjectids: windows_core::Ref<IPortableDevicePropVariantCollection>, ppresults: windows_core::OutRef<IPortableDevicePropVariantCollection>) -> windows_result::Result<()>;
    fn GetObjectIDsFromPersistentUniqueIDs(&self, ppersistentuniqueids: windows_core::Ref<IPortableDevicePropVariantCollection>) -> windows_result::Result<IPortableDevicePropVariantCollection>;
    fn Cancel(&self) -> windows_result::Result<()>;
    fn Move(&self, pobjectids: windows_core::Ref<IPortableDevicePropVariantCollection>, pszdestinationfolderobjectid: &windows_core::PCWSTR, ppresults: windows_core::OutRef<IPortableDevicePropVariantCollection>) -> windows_result::Result<()>;
    fn Copy(&self, pobjectids: windows_core::Ref<IPortableDevicePropVariantCollection>, pszdestinationfolderobjectid: &windows_core::PCWSTR, ppresults: windows_core::OutRef<IPortableDevicePropVariantCollection>) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IPortableDeviceContent2 {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn UpdateObjectWithPropertiesAndData<P0, P1>(&self, pszobjectid: P0, pproperties: P1, ppdata: *mut Option<super::super::System::Com::IStream>, pdwoptimalwritebuffersize: *mut u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<IPortableDeviceValues>,
    {
...
pub trait IPortableDeviceContent2_Impl: IPortableDeviceContent_Impl {
    fn UpdateObjectWithPropertiesAndData(&self, pszobjectid: &windows_core::PCWSTR, pproperties: windows_core::Ref<IPortableDeviceValues>, ppdata: windows_core::OutRef<super::super::System::Com::IStream>, pdwoptimalwritebuffersize: *mut u32) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IPortableDeviceDataStream {
    pub unsafe fn GetObjectID(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPortableDeviceDataStream_Impl: super::super::System::Com::IStream_Impl {
    fn GetObjectID(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn Cancel(&self) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IPortableDeviceDispatchFactory {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetDeviceDispatch<P0>(&self, pszpnpdeviceid: P0) -> windows_result::Result<super::super::System::Com::IDispatch>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
...
pub trait IPortableDeviceDispatchFactory_Impl: windows_core::IUnknownImpl {
    fn GetDeviceDispatch(&self, pszpnpdeviceid: &windows_core::PCWSTR) -> windows_result::Result<super::super::System::Com::IDispatch>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IPortableDeviceEventCallback {
    pub unsafe fn OnEvent<P0>(&self, peventparameters: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IPortableDeviceValues>,
    {
...
pub trait IPortableDeviceEventCallback_Impl: windows_core::IUnknownImpl {
    fn OnEvent(&self, peventparameters: windows_core::Ref<IPortableDeviceValues>) -> windows_result::Result<()>;
}
...
impl IPortableDeviceKeyCollection {
    pub unsafe fn GetCount(&self, pcelems: *const u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetCount)(windows_core::Interface::as_raw(self), pcelems).ok() }
    }
    pub unsafe fn GetAt(&self, dwindex: u32, pkey: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetAt)(windows_core::Interface::as_raw(self), dwindex, pkey).ok() }
    }
    pub unsafe fn Add(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<()> {
    ...
    pub unsafe fn RemoveAt(&self, dwindex: u32) -> windows_result::Result<()> {
...
pub trait IPortableDeviceKeyCollection_Impl: windows_core::IUnknownImpl {
    fn GetCount(&self, pcelems: *const u32) -> windows_result::Result<()>;
    fn GetAt(&self, dwindex: u32, pkey: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<()>;
    fn Add(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<()>;
    fn Clear(&self) -> windows_result::Result<()>;
    fn RemoveAt(&self, dwindex: u32) -> windows_result::Result<()>;
}
...
impl IPortableDeviceManager {
    pub unsafe fn GetDevices(&self, ppnpdeviceids: *mut windows_core::PWSTR, pcpnpdeviceids: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn RefreshDeviceList(&self) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).RefreshDeviceList)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn GetDeviceFriendlyName<P0>(&self, pszpnpdeviceid: P0, pdevicefriendlyname: windows_core::PWSTR, pcchdevicefriendlyname: *mut u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetDeviceDescription<P0>(&self, pszpnpdeviceid: P0, pdevicedescription: windows_core::PWSTR, pcchdevicedescription: *mut u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetDeviceManufacturer<P0>(&self, pszpnpdeviceid: P0, pdevicemanufacturer: windows_core::PWSTR, pcchdevicemanufacturer: *mut u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetDeviceProperty<P0, P1>(&self, pszpnpdeviceid: P0, pszdevicepropertyname: P1, pdata: *mut u8, pcbdata: *mut u32, pdwtype: *mut u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetPrivateDevices(&self, ppnpdeviceids: *mut windows_core::PWSTR, pcpnpdeviceids: *mut u32) -> windows_result::Result<()> {
...
pub trait IPortableDeviceManager_Impl: windows_core::IUnknownImpl {
    fn GetDevices(&self, ppnpdeviceids: *mut windows_core::PWSTR, pcpnpdeviceids: *mut u32) -> windows_result::Result<()>;
    fn RefreshDeviceList(&self) -> windows_result::Result<()>;
    fn GetDeviceFriendlyName(&self, pszpnpdeviceid: &windows_core::PCWSTR, pdevicefriendlyname: windows_core::PWSTR, pcchdevicefriendlyname: *mut u32) -> windows_result::Result<()>;
    fn GetDeviceDescription(&self, pszpnpdeviceid: &windows_core::PCWSTR, pdevicedescription: windows_core::PWSTR, pcchdevicedescription: *mut u32) -> windows_result::Result<()>;
    fn GetDeviceManufacturer(&self, pszpnpdeviceid: &windows_core::PCWSTR, pdevicemanufacturer: windows_core::PWSTR, pcchdevicemanufacturer: *mut u32) -> windows_result::Result<()>;
    fn GetDeviceProperty(&self, pszpnpdeviceid: &windows_core::PCWSTR, pszdevicepropertyname: &windows_core::PCWSTR, pdata: *mut u8, pcbdata: *mut u32, pdwtype: *mut u32) -> windows_result::Result<()>;
    fn GetPrivateDevices(&self, ppnpdeviceids: *mut windows_core::PWSTR, pcpnpdeviceids: *mut u32) -> windows_result::Result<()>;
}
...
impl IPortableDevicePropVariantCollection {
    ...
    pub unsafe fn GetAt(&self, dwindex: u32, pvalue: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetAt)(windows_core::Interface::as_raw(self), dwindex, core::mem::transmute(pvalue)).ok() }
    }
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn Add(&self, pvalue: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Add)(windows_core::Interface::as_raw(self), core::mem::transmute(pvalue)).ok() }
    }
    pub unsafe fn GetType(&self) -> windows_result::Result<u16> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetType)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn ChangeType(&self, vt: u16) -> windows_result::Result<()> {
...
pub trait IPortableDevicePropVariantCollection_Impl: windows_core::IUnknownImpl {
    fn GetCount(&self, pcelems: *const u32) -> windows_result::Result<()>;
    fn GetAt(&self, dwindex: u32, pvalue: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()>;
    fn Add(&self, pvalue: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()>;
    fn GetType(&self) -> windows_result::Result<u16>;
    fn ChangeType(&self, vt: u16) -> windows_result::Result<()>;
    fn Clear(&self) -> windows_result::Result<()>;
    fn RemoveAt(&self, dwindex: u32) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
...
impl IPortableDeviceProperties {
    pub unsafe fn GetSupportedProperties<P0>(&self, pszobjectid: P0) -> windows_result::Result<IPortableDeviceKeyCollection>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn GetPropertyAttributes<P0>(&self, pszobjectid: P0, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValues>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn GetValues<P0, P1>(&self, pszobjectid: P0, pkeys: P1) -> windows_result::Result<IPortableDeviceValues>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn SetValues<P0, P1>(&self, pszobjectid: P0, pvalues: P1) -> windows_result::Result<IPortableDeviceValues>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<IPortableDeviceValues>,
    {
    ...
    pub unsafe fn Delete<P0, P1>(&self, pszobjectid: P0, pkeys: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<IPortableDeviceKeyCollection>,
    {
...
pub trait IPortableDeviceProperties_Impl: windows_core::IUnknownImpl {
    fn GetSupportedProperties(&self, pszobjectid: &windows_core::PCWSTR) -> windows_result::Result<IPortableDeviceKeyCollection>;
    fn GetPropertyAttributes(&self, pszobjectid: &windows_core::PCWSTR, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValues>;
    fn GetValues(&self, pszobjectid: &windows_core::PCWSTR, pkeys: windows_core::Ref<IPortableDeviceKeyCollection>) -> windows_result::Result<IPortableDeviceValues>;
    fn SetValues(&self, pszobjectid: &windows_core::PCWSTR, pvalues: windows_core::Ref<IPortableDeviceValues>) -> windows_result::Result<IPortableDeviceValues>;
    fn Delete(&self, pszobjectid: &windows_core::PCWSTR, pkeys: windows_core::Ref<IPortableDeviceKeyCollection>) -> windows_result::Result<()>;
    fn Cancel(&self) -> windows_result::Result<()>;
}
...
impl IPortableDevicePropertiesBulk {
    pub unsafe fn QueueGetValuesByObjectList<P0, P1, P2>(&self, pobjectids: P0, pkeys: P1, pcallback: P2) -> windows_result::Result<windows_core::GUID>
    where
        P0: windows_core::Param<IPortableDevicePropVariantCollection>,
        P1: windows_core::Param<IPortableDeviceKeyCollection>,
    ...
    pub unsafe fn QueueGetValuesByObjectFormat<P1, P3, P4>(&self, pguidobjectformat: *const windows_core::GUID, pszparentobjectid: P1, dwdepth: u32, pkeys: P3, pcallback: P4) -> windows_result::Result<windows_core::GUID>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn QueueSetValuesByObjectList<P0, P1>(&self, pobjectvalues: P0, pcallback: P1) -> windows_result::Result<windows_core::GUID>
    where
    ...
    pub unsafe fn Start(&self, pcontext: *const windows_core::GUID) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Start)(windows_core::Interface::as_raw(self), pcontext).ok() }
    }
    pub unsafe fn Cancel(&self, pcontext: *const windows_core::GUID) -> windows_result::Result<()> {
...
pub trait IPortableDevicePropertiesBulk_Impl: windows_core::IUnknownImpl {
    fn QueueGetValuesByObjectList(&self, pobjectids: windows_core::Ref<IPortableDevicePropVariantCollection>, pkeys: windows_core::Ref<IPortableDeviceKeyCollection>, pcallback: windows_core::Ref<IPortableDevicePropertiesBulkCallback>) -> windows_result::Result<windows_core::GUID>;
    fn QueueGetValuesByObjectFormat(&self, pguidobjectformat: *const windows_core::GUID, pszparentobjectid: &windows_core::PCWSTR, dwdepth: u32, pkeys: windows_core::Ref<IPortableDeviceKeyCollection>, pcallback: windows_core::Ref<IPortableDevicePropertiesBulkCallback>) -> windows_result::Result<windows_core::GUID>;
    fn QueueSetValuesByObjectList(&self, pobjectvalues: windows_core::Ref<IPortableDeviceValuesCollection>, pcallback: windows_core::Ref<IPortableDevicePropertiesBulkCallback>) -> windows_result::Result<windows_core::GUID>;
    fn Start(&self, pcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn Cancel(&self, pcontext: *const windows_core::GUID) -> windows_result::Result<()>;
}
...
impl IPortableDevicePropertiesBulkCallback {
    pub unsafe fn OnStart(&self, pcontext: *const windows_core::GUID) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).OnStart)(windows_core::Interface::as_raw(self), pcontext).ok() }
    }
    pub unsafe fn OnProgress<P1>(&self, pcontext: *const windows_core::GUID, presults: P1) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn OnEnd(&self, pcontext: *const windows_core::GUID, hrstatus: windows_core::HRESULT) -> windows_result::Result<()> {
...
pub trait IPortableDevicePropertiesBulkCallback_Impl: windows_core::IUnknownImpl {
    fn OnStart(&self, pcontext: *const windows_core::GUID) -> windows_result::Result<()>;
    fn OnProgress(&self, pcontext: *const windows_core::GUID, presults: windows_core::Ref<IPortableDeviceValuesCollection>) -> windows_result::Result<()>;
    fn OnEnd(&self, pcontext: *const windows_core::GUID, hrstatus: windows_core::HRESULT) -> windows_result::Result<()>;
}
...
impl IPortableDeviceResources {
    pub unsafe fn GetSupportedResources<P0>(&self, pszobjectid: P0) -> windows_result::Result<IPortableDeviceKeyCollection>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn GetResourceAttributes<P0>(&self, pszobjectid: P0, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValues>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn GetStream<P0>(&self, pszobjectid: P0, key: *const super::super::Foundation::PROPERTYKEY, dwmode: u32, pdwoptimalbuffersize: *mut u32, ppstream: *mut Option<super::super::System::Com::IStream>) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn CreateResource<P0>(&self, presourceattributes: P0, ppdata: *mut Option<super::super::System::Com::IStream>, pdwoptimalwritebuffersize: *mut u32, ppszcookie: *mut windows_core::PWSTR) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IPortableDeviceValues>,
    {
...
pub trait IPortableDeviceResources_Impl: windows_core::IUnknownImpl {
    fn GetSupportedResources(&self, pszobjectid: &windows_core::PCWSTR) -> windows_result::Result<IPortableDeviceKeyCollection>;
    fn GetResourceAttributes(&self, pszobjectid: &windows_core::PCWSTR, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValues>;
    fn GetStream(&self, pszobjectid: &windows_core::PCWSTR, key: *const super::super::Foundation::PROPERTYKEY, dwmode: u32, pdwoptimalbuffersize: *mut u32, ppstream: windows_core::OutRef<super::super::System::Com::IStream>) -> windows_result::Result<()>;
    fn Delete(&self, pszobjectid: &windows_core::PCWSTR, pkeys: windows_core::Ref<IPortableDeviceKeyCollection>) -> windows_result::Result<()>;
    fn Cancel(&self) -> windows_result::Result<()>;
    fn CreateResource(&self, presourceattributes: windows_core::Ref<IPortableDeviceValues>, ppdata: windows_core::OutRef<super::super::System::Com::IStream>, pdwoptimalwritebuffersize: *mut u32, ppszcookie: *mut windows_core::PWSTR) -> windows_result::Result<()>;
}
#[cfg(feature = "Win32_System_Com")]
...
impl IPortableDeviceService {
    pub unsafe fn Open<P0, P1>(&self, pszpnpserviceid: P0, pclientinfo: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<IPortableDeviceValues>,
    {
    ...
    pub unsafe fn Capabilities(&self) -> windows_result::Result<IPortableDeviceServiceCapabilities> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Capabilities)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn Content(&self) -> windows_result::Result<IPortableDeviceContent2> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Content)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub unsafe fn Methods(&self) -> windows_result::Result<IPortableDeviceServiceMethods> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetServiceObjectID(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetServiceObjectID)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetPnPServiceID(&self) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPortableDeviceService_Impl: windows_core::IUnknownImpl {
    fn Open(&self, pszpnpserviceid: &windows_core::PCWSTR, pclientinfo: windows_core::Ref<IPortableDeviceValues>) -> windows_result::Result<()>;
    fn Capabilities(&self) -> windows_result::Result<IPortableDeviceServiceCapabilities>;
    fn Content(&self) -> windows_result::Result<IPortableDeviceContent2>;
    fn Methods(&self) -> windows_result::Result<IPortableDeviceServiceMethods>;
    fn Cancel(&self) -> windows_result::Result<()>;
    fn Close(&self) -> windows_result::Result<()>;
    fn GetServiceObjectID(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn GetPnPServiceID(&self) -> windows_result::Result<windows_core::PWSTR>;
    fn Advise(&self, dwflags: u32, pcallback: windows_core::Ref<IPortableDeviceEventCallback>, pparameters: windows_core::Ref<IPortableDeviceValues>) -> windows_result::Result<windows_core::PWSTR>;
    fn Unadvise(&self, pszcookie: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn SendCommand(&self, dwflags: u32, pparameters: windows_core::Ref<IPortableDeviceValues>) -> windows_result::Result<IPortableDeviceValues>;
}
...
impl IPortableDeviceServiceActivation {
    pub unsafe fn OpenAsync<P0, P1, P2>(&self, pszpnpserviceid: P0, pclientinfo: P1, pcallback: P2) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<IPortableDeviceValues>,
    ...
    pub unsafe fn CancelOpenAsync(&self) -> windows_result::Result<()> {
...
pub trait IPortableDeviceServiceActivation_Impl: windows_core::IUnknownImpl {
    fn OpenAsync(&self, pszpnpserviceid: &windows_core::PCWSTR, pclientinfo: windows_core::Ref<IPortableDeviceValues>, pcallback: windows_core::Ref<IPortableDeviceServiceOpenCallback>) -> windows_result::Result<()>;
    fn CancelOpenAsync(&self) -> windows_result::Result<()>;
}
...
impl IPortableDeviceServiceCapabilities {
    pub unsafe fn GetSupportedMethods(&self) -> windows_result::Result<IPortableDevicePropVariantCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetSupportedMethodsByFormat(&self, format: *const windows_core::GUID) -> windows_result::Result<IPortableDevicePropVariantCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetMethodAttributes(&self, method: *const windows_core::GUID) -> windows_result::Result<IPortableDeviceValues> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetMethodParameterAttributes(&self, method: *const windows_core::GUID, parameter: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValues> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetSupportedFormats(&self) -> windows_result::Result<IPortableDevicePropVariantCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFormatAttributes(&self, format: *const windows_core::GUID) -> windows_result::Result<IPortableDeviceValues> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFormatPropertyAttributes(&self, format: *const windows_core::GUID, property: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValues> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetEventAttributes(&self, event: *const windows_core::GUID) -> windows_result::Result<IPortableDeviceValues> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetEventParameterAttributes(&self, event: *const windows_core::GUID, parameter: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValues> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetInheritedServices(&self, dwinheritancetype: u32) -> windows_result::Result<IPortableDevicePropVariantCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFormatRenderingProfiles(&self, format: *const windows_core::GUID) -> windows_result::Result<IPortableDeviceValuesCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPortableDeviceServiceCapabilities_Impl: windows_core::IUnknownImpl {
    fn GetSupportedMethods(&self) -> windows_result::Result<IPortableDevicePropVariantCollection>;
    fn GetSupportedMethodsByFormat(&self, format: *const windows_core::GUID) -> windows_result::Result<IPortableDevicePropVariantCollection>;
    fn GetMethodAttributes(&self, method: *const windows_core::GUID) -> windows_result::Result<IPortableDeviceValues>;
    fn GetMethodParameterAttributes(&self, method: *const windows_core::GUID, parameter: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValues>;
    fn GetSupportedFormats(&self) -> windows_result::Result<IPortableDevicePropVariantCollection>;
    fn GetFormatAttributes(&self, format: *const windows_core::GUID) -> windows_result::Result<IPortableDeviceValues>;
    fn GetSupportedFormatProperties(&self, format: *const windows_core::GUID) -> windows_result::Result<IPortableDeviceKeyCollection>;
    fn GetFormatPropertyAttributes(&self, format: *const windows_core::GUID, property: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValues>;
    fn GetSupportedEvents(&self) -> windows_result::Result<IPortableDevicePropVariantCollection>;
    fn GetEventAttributes(&self, event: *const windows_core::GUID) -> windows_result::Result<IPortableDeviceValues>;
    fn GetEventParameterAttributes(&self, event: *const windows_core::GUID, parameter: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValues>;
    fn GetInheritedServices(&self, dwinheritancetype: u32) -> windows_result::Result<IPortableDevicePropVariantCollection>;
    fn GetFormatRenderingProfiles(&self, format: *const windows_core::GUID) -> windows_result::Result<IPortableDeviceValuesCollection>;
    fn GetSupportedCommands(&self) -> windows_result::Result<IPortableDeviceKeyCollection>;
    fn GetCommandOptions(&self, command: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValues>;
    fn Cancel(&self) -> windows_result::Result<()>;
}
...
impl IPortableDeviceServiceManager {
    pub unsafe fn GetDeviceServices<P0>(&self, pszpnpdeviceid: P0, guidservicecategory: *const windows_core::GUID, pservices: *mut windows_core::PWSTR, pcservices: *mut u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetDeviceForService<P0>(&self, pszpnpserviceid: P0) -> windows_result::Result<windows_core::PWSTR>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
...
pub trait IPortableDeviceServiceManager_Impl: windows_core::IUnknownImpl {
    fn GetDeviceServices(&self, pszpnpdeviceid: &windows_core::PCWSTR, guidservicecategory: *const windows_core::GUID, pservices: *mut windows_core::PWSTR, pcservices: *mut u32) -> windows_result::Result<()>;
    fn GetDeviceForService(&self, pszpnpserviceid: &windows_core::PCWSTR) -> windows_result::Result<windows_core::PWSTR>;
}
...
impl IPortableDeviceServiceMethodCallback {
    pub unsafe fn OnComplete<P1>(&self, hrstatus: windows_core::HRESULT, presults: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<IPortableDeviceValues>,
    {
...
pub trait IPortableDeviceServiceMethodCallback_Impl: windows_core::IUnknownImpl {
    fn OnComplete(&self, hrstatus: windows_core::HRESULT, presults: windows_core::Ref<IPortableDeviceValues>) -> windows_result::Result<()>;
}
...
impl IPortableDeviceServiceMethods {
    pub unsafe fn Invoke<P1>(&self, method: *const windows_core::GUID, pparameters: P1, ppresults: *mut Option<IPortableDeviceValues>) -> windows_result::Result<()>
    where
        P1: windows_core::Param<IPortableDeviceValues>,
    {
    ...
    pub unsafe fn InvokeAsync<P1, P2>(&self, method: *const windows_core::GUID, pparameters: P1, pcallback: P2) -> windows_result::Result<()>
    where
        P1: windows_core::Param<IPortableDeviceValues>,
...
pub trait IPortableDeviceServiceMethods_Impl: windows_core::IUnknownImpl {
    fn Invoke(&self, method: *const windows_core::GUID, pparameters: windows_core::Ref<IPortableDeviceValues>, ppresults: windows_core::OutRef<IPortableDeviceValues>) -> windows_result::Result<()>;
    fn InvokeAsync(&self, method: *const windows_core::GUID, pparameters: windows_core::Ref<IPortableDeviceValues>, pcallback: windows_core::Ref<IPortableDeviceServiceMethodCallback>) -> windows_result::Result<()>;
    fn Cancel(&self, pcallback: windows_core::Ref<IPortableDeviceServiceMethodCallback>) -> windows_result::Result<()>;
}
...
impl IPortableDeviceUnitsStream {
    pub unsafe fn SeekInUnits(&self, dlibmove: i64, units: WPD_STREAM_UNITS, dworigin: u32, plibnewposition: Option<*mut u64>) -> windows_result::Result<()> {
...
pub trait IPortableDeviceUnitsStream_Impl: windows_core::IUnknownImpl {
    fn SeekInUnits(&self, dlibmove: i64, units: WPD_STREAM_UNITS, dworigin: u32, plibnewposition: *mut u64) -> windows_result::Result<()>;
    fn Cancel(&self) -> windows_result::Result<()>;
}
...
impl IPortableDeviceValues {
    pub unsafe fn GetCount(&self, pcelt: *const u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetCount)(windows_core::Interface::as_raw(self), pcelt).ok() }
    }
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn GetAt(&self, index: u32, pkey: *mut super::super::Foundation::PROPERTYKEY, pvalue: *mut super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()> {
    ...
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn SetValue(&self, key: *const super::super::Foundation::PROPERTYKEY, pvalue: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetValue)(windows_core::Interface::as_raw(self), key, core::mem::transmute(pvalue)).ok() }
    }
    #[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant"))]
    pub unsafe fn GetValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<super::super::System::Com::StructuredStorage::PROPVARIANT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetStringValue<P1>(&self, key: *const super::super::Foundation::PROPERTYKEY, value: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetStringValue)(windows_core::Interface::as_raw(self), key, value.param().abi()).ok() }
    }
    pub unsafe fn GetStringValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<windows_core::PWSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetStringValue)(windows_core::Interface::as_raw(self), key, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetUnsignedIntegerValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: u32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetUnsignedIntegerValue)(windows_core::Interface::as_raw(self), key, value).ok() }
    }
    pub unsafe fn GetUnsignedIntegerValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetSignedIntegerValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: i32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetSignedIntegerValue)(windows_core::Interface::as_raw(self), key, value).ok() }
    }
    pub unsafe fn GetSignedIntegerValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetUnsignedLargeIntegerValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: u64) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetUnsignedLargeIntegerValue)(windows_core::Interface::as_raw(self), key, value).ok() }
    }
    pub unsafe fn GetUnsignedLargeIntegerValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetSignedLargeIntegerValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: i64) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetSignedLargeIntegerValue)(windows_core::Interface::as_raw(self), key, value).ok() }
    }
    pub unsafe fn GetSignedLargeIntegerValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<i64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetFloatValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: f32) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetFloatValue)(windows_core::Interface::as_raw(self), key, value).ok() }
    }
    pub unsafe fn GetFloatValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<f32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetFloatValue)(windows_core::Interface::as_raw(self), key, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetErrorValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: windows_core::HRESULT) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetErrorValue)(windows_core::Interface::as_raw(self), key, value).ok() }
    }
    pub unsafe fn GetErrorValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<windows_core::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetErrorValue)(windows_core::Interface::as_raw(self), key, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetKeyValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetKeyValue)(windows_core::Interface::as_raw(self), key, value).ok() }
    }
    pub unsafe fn GetKeyValue(&self, key: *const super::super::Foundation::PROPERTYKEY, pvalue: *mut super::super::Foundation::PROPERTYKEY) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetKeyValue)(windows_core::Interface::as_raw(self), key, pvalue as _).ok() }
    }
    pub unsafe fn SetBoolValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: bool) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetBoolValue)(windows_core::Interface::as_raw(self), key, value.into()).ok() }
    }
    pub unsafe fn GetBoolValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetBoolValue)(windows_core::Interface::as_raw(self), key, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetIUnknownValue<P1>(&self, key: *const super::super::Foundation::PROPERTYKEY, pvalue: P1) -> windows_result::Result<()>
    where
    ...
    pub unsafe fn GetIUnknownValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<windows_core::IUnknown> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetGuidValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: *const windows_core::GUID) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetGuidValue)(windows_core::Interface::as_raw(self), key, value).ok() }
    }
    pub unsafe fn GetGuidValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetGuidValue)(windows_core::Interface::as_raw(self), key, &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetBufferValue(&self, key: *const super::super::Foundation::PROPERTYKEY, pvalue: &[u8]) -> windows_result::Result<()> {
    ...
    pub unsafe fn GetBufferValue(&self, key: *const super::super::Foundation::PROPERTYKEY, ppvalue: *mut *mut u8, pcbvalue: *mut u32) -> windows_result::Result<()> {
    ...
    pub unsafe fn SetIPortableDeviceValuesValue<P1>(&self, key: *const super::super::Foundation::PROPERTYKEY, pvalue: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<IPortableDeviceValues>,
    {
    ...
    pub unsafe fn GetIPortableDeviceValuesValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValues> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetIPortableDevicePropVariantCollectionValue<P1>(&self, key: *const super::super::Foundation::PROPERTYKEY, pvalue: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<IPortableDevicePropVariantCollection>,
    {
    ...
    pub unsafe fn GetIPortableDevicePropVariantCollectionValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDevicePropVariantCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetIPortableDeviceKeyCollectionValue<P1>(&self, key: *const super::super::Foundation::PROPERTYKEY, pvalue: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<IPortableDeviceKeyCollection>,
    {
    ...
    pub unsafe fn GetIPortableDeviceKeyCollectionValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceKeyCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetIPortableDeviceValuesCollectionValue<P1>(&self, key: *const super::super::Foundation::PROPERTYKEY, pvalue: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<IPortableDeviceValuesCollection>,
    {
    ...
    pub unsafe fn GetIPortableDeviceValuesCollectionValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValuesCollection> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn RemoveValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).RemoveValue)(windows_core::Interface::as_raw(self), key).ok() }
    }
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn CopyValuesFromPropertyStore<P0>(&self, pstore: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
    pub unsafe fn CopyValuesToPropertyStore<P0>(&self, pstore: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::UI::Shell::PropertiesSystem::IPropertyStore>,
    {
...
pub trait IPortableDeviceValues_Impl: windows_core::IUnknownImpl {
    fn GetCount(&self, pcelt: *const u32) -> windows_result::Result<()>;
    fn GetAt(&self, index: u32, pkey: *mut super::super::Foundation::PROPERTYKEY, pvalue: *mut super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()>;
    fn SetValue(&self, key: *const super::super::Foundation::PROPERTYKEY, pvalue: *const super::super::System::Com::StructuredStorage::PROPVARIANT) -> windows_result::Result<()>;
    fn GetValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<super::super::System::Com::StructuredStorage::PROPVARIANT>;
    fn SetStringValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: &windows_core::PCWSTR) -> windows_result::Result<()>;
    fn GetStringValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<windows_core::PWSTR>;
    fn SetUnsignedIntegerValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: u32) -> windows_result::Result<()>;
    fn GetUnsignedIntegerValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<u32>;
    fn SetSignedIntegerValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: i32) -> windows_result::Result<()>;
    fn GetSignedIntegerValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<i32>;
    fn SetUnsignedLargeIntegerValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: u64) -> windows_result::Result<()>;
    fn GetUnsignedLargeIntegerValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<u64>;
    fn SetSignedLargeIntegerValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: i64) -> windows_result::Result<()>;
    fn GetSignedLargeIntegerValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<i64>;
    fn SetFloatValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: f32) -> windows_result::Result<()>;
    fn GetFloatValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<f32>;
    fn SetErrorValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: windows_core::HRESULT) -> windows_result::Result<()>;
    fn GetErrorValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<windows_core::HRESULT>;
    fn SetKeyValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<()>;
    fn GetKeyValue(&self, key: *const super::super::Foundation::PROPERTYKEY, pvalue: *mut super::super::Foundation::PROPERTYKEY) -> windows_result::Result<()>;
    fn SetBoolValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: windows_core::BOOL) -> windows_result::Result<()>;
    fn GetBoolValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<windows_core::BOOL>;
    fn SetIUnknownValue(&self, key: *const super::super::Foundation::PROPERTYKEY, pvalue: windows_core::Ref<windows_core::IUnknown>) -> windows_result::Result<()>;
    fn GetIUnknownValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<windows_core::IUnknown>;
    fn SetGuidValue(&self, key: *const super::super::Foundation::PROPERTYKEY, value: *const windows_core::GUID) -> windows_result::Result<()>;
    fn GetGuidValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<windows_core::GUID>;
    fn SetBufferValue(&self, key: *const super::super::Foundation::PROPERTYKEY, pvalue: *const u8, cbvalue: u32) -> windows_result::Result<()>;
    fn GetBufferValue(&self, key: *const super::super::Foundation::PROPERTYKEY, ppvalue: *mut *mut u8, pcbvalue: *mut u32) -> windows_result::Result<()>;
    fn SetIPortableDeviceValuesValue(&self, key: *const super::super::Foundation::PROPERTYKEY, pvalue: windows_core::Ref<IPortableDeviceValues>) -> windows_result::Result<()>;
    fn GetIPortableDeviceValuesValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValues>;
    fn SetIPortableDevicePropVariantCollectionValue(&self, key: *const super::super::Foundation::PROPERTYKEY, pvalue: windows_core::Ref<IPortableDevicePropVariantCollection>) -> windows_result::Result<()>;
    fn GetIPortableDevicePropVariantCollectionValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDevicePropVariantCollection>;
    fn SetIPortableDeviceKeyCollectionValue(&self, key: *const super::super::Foundation::PROPERTYKEY, pvalue: windows_core::Ref<IPortableDeviceKeyCollection>) -> windows_result::Result<()>;
    fn GetIPortableDeviceKeyCollectionValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceKeyCollection>;
    fn SetIPortableDeviceValuesCollectionValue(&self, key: *const super::super::Foundation::PROPERTYKEY, pvalue: windows_core::Ref<IPortableDeviceValuesCollection>) -> windows_result::Result<()>;
    fn GetIPortableDeviceValuesCollectionValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<IPortableDeviceValuesCollection>;
    fn RemoveValue(&self, key: *const super::super::Foundation::PROPERTYKEY) -> windows_result::Result<()>;
    fn CopyValuesFromPropertyStore(&self, pstore: windows_core::Ref<super::super::UI::Shell::PropertiesSystem::IPropertyStore>) -> windows_result::Result<()>;
    fn CopyValuesToPropertyStore(&self, pstore: windows_core::Ref<super::super::UI::Shell::PropertiesSystem::IPropertyStore>) -> windows_result::Result<()>;
    fn Clear(&self) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com_StructuredStorage", feature = "Win32_System_Variant", feature = "Win32_UI_Shell_PropertiesSystem"))]
...
impl IPortableDeviceValuesCollection {
    ...
    pub unsafe fn GetAt(&self, dwindex: u32) -> windows_result::Result<IPortableDeviceValues> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn Add<P0>(&self, pvalues: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IPortableDeviceValues>,
    {
...
pub trait IPortableDeviceValuesCollection_Impl: windows_core::IUnknownImpl {
    fn GetCount(&self, pcelems: *const u32) -> windows_result::Result<()>;
    fn GetAt(&self, dwindex: u32) -> windows_result::Result<IPortableDeviceValues>;
    fn Add(&self, pvalues: windows_core::Ref<IPortableDeviceValues>) -> windows_result::Result<()>;
    fn Clear(&self) -> windows_result::Result<()>;
    fn RemoveAt(&self, dwindex: u32) -> windows_result::Result<()>;
}
...
impl IPortableDeviceWebControl {
    pub unsafe fn GetDeviceFromId(&self, deviceid: &windows_core::BSTR) -> windows_result::Result<super::super::System::Com::IDispatch> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetDeviceFromIdAsync<P1, P2>(&self, deviceid: &windows_core::BSTR, pcompletionhandler: P1, perrorhandler: P2) -> windows_result::Result<()>
    where
...
pub trait IPortableDeviceWebControl_Impl: super::super::System::Com::IDispatch_Impl {
    fn GetDeviceFromId(&self, deviceid: &windows_core::BSTR) -> windows_result::Result<super::super::System::Com::IDispatch>;
    fn GetDeviceFromIdAsync(&self, deviceid: &windows_core::BSTR, pcompletionhandler: windows_core::Ref<super::super::System::Com::IDispatch>, perrorhandler: windows_core::Ref<super::super::System::Com::IDispatch>) -> windows_result::Result<()>;
}
#[cfg(all(feature = "Win32_System_Com", feature = "Win32_System_Ole", feature = "Win32_System_Variant"))]
...
impl IRadioInstance {
    pub unsafe fn GetRadioManagerSignature(&self) -> windows_result::Result<windows_core::GUID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRadioManagerSignature)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetInstanceSignature(&self) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetFriendlyName(&self, lcid: u32) -> windows_result::Result<windows_core::BSTR> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetRadioState(&self) -> windows_result::Result<DEVICE_RADIO_STATE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetRadioState)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetRadioState(&self, radiostate: DEVICE_RADIO_STATE, utimeoutsec: u32) -> windows_result::Result<()> {
...
pub trait IRadioInstance_Impl: windows_core::IUnknownImpl {
    fn GetRadioManagerSignature(&self) -> windows_result::Result<windows_core::GUID>;
    fn GetInstanceSignature(&self) -> windows_result::Result<windows_core::BSTR>;
    fn GetFriendlyName(&self, lcid: u32) -> windows_result::Result<windows_core::BSTR>;
    fn GetRadioState(&self) -> windows_result::Result<DEVICE_RADIO_STATE>;
    fn SetRadioState(&self, radiostate: DEVICE_RADIO_STATE, utimeoutsec: u32) -> windows_result::Result<()>;
...
impl IRadioInstanceCollection {
    ...
    pub unsafe fn GetAt(&self, uindex: u32) -> windows_result::Result<IRadioInstance> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IRadioInstanceCollection_Impl: windows_core::IUnknownImpl {
    ...
    fn GetAt(&self, uindex: u32) -> windows_result::Result<IRadioInstance>;
}
...
impl IWpdSerializer {
    pub unsafe fn GetIPortableDeviceValuesFromBuffer(&self, pbuffer: &[u8]) -> windows_result::Result<IPortableDeviceValues> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn WriteIPortableDeviceValuesToBuffer<P1>(&self, presults: P1, pbuffer: &mut [u8], pdwbyteswritten: *mut u32) -> windows_result::Result<()>
    where
        P1: windows_core::Param<IPortableDeviceValues>,
    {
    ...
    pub unsafe fn GetBufferFromIPortableDeviceValues<P0>(&self, psource: P0, ppbuffer: *mut *mut u8, pdwbuffersize: *mut u32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IPortableDeviceValues>,
    {
    ...
    pub unsafe fn GetSerializedSize<P0>(&self, psource: P0) -> windows_result::Result<u32>
    where
        P0: windows_core::Param<IPortableDeviceValues>,
    {
        unsafe {
...
pub trait IWpdSerializer_Impl: windows_core::IUnknownImpl {
    fn GetIPortableDeviceValuesFromBuffer(&self, pbuffer: *const u8, dwinputbufferlength: u32) -> windows_result::Result<IPortableDeviceValues>;
    fn WriteIPortableDeviceValuesToBuffer(&self, dwoutputbufferlength: u32, presults: windows_core::Ref<IPortableDeviceValues>, pbuffer: *mut u8, pdwbyteswritten: *mut u32) -> windows_result::Result<()>;
    fn GetBufferFromIPortableDeviceValues(&self, psource: windows_core::Ref<IPortableDeviceValues>, ppbuffer: *mut *mut u8, pdwbuffersize: *mut u32) -> windows_result::Result<()>;
    fn GetSerializedSize(&self, psource: windows_core::Ref<IPortableDeviceValues>) -> windows_result::Result<u32>;
}
