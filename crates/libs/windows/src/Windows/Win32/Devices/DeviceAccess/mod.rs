#[inline]
pub unsafe fn CreateDeviceAccessInstance<P0>(deviceinterfacepath: P0, desiredaccess: u32) -> Result<ICreateDeviceAccessAsync, windows_result::HRESULT>
where
...
impl ICreateDeviceAccessAsync {
    ...
    pub unsafe fn Wait(&self, timeout: u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetResult<T>(&self) -> Result<T, windows_result::HRESULT>
    where
...
pub trait ICreateDeviceAccessAsync_Impl: windows_core::IUnknownImpl {
    ...
    fn Wait(&self, timeout: u32) -> Result<(), windows_result::HRESULT>;
    fn Close(&self) -> Result<(), windows_result::HRESULT>;
    fn GetResult(&self, riid: *const windows_core::GUID, deviceaccess: *mut *mut core::ffi::c_void) -> Result<(), windows_result::HRESULT>;
}
...
impl IDeviceIoControl {
    pub unsafe fn DeviceIoControlSync(&self, iocontrolcode: u32, inputbuffer: Option<&[u8]>, outputbuffer: Option<&mut [u8]>, bytesreturned: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn DeviceIoControlAsync<P5>(&self, iocontrolcode: u32, inputbuffer: Option<&[u8]>, outputbuffer: Option<&mut [u8]>, requestcompletioncallback: P5, cancelcontext: Option<*mut usize>) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn CancelOperation(&self, cancelcontext: usize) -> Result<(), windows_result::HRESULT> {
...
pub trait IDeviceIoControl_Impl: windows_core::IUnknownImpl {
    fn DeviceIoControlSync(&self, iocontrolcode: u32, inputbuffer: *const u8, inputbuffersize: u32, outputbuffer: *mut u8, outputbuffersize: u32, bytesreturned: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn DeviceIoControlAsync(&self, iocontrolcode: u32, inputbuffer: *const u8, inputbuffersize: u32, outputbuffer: *mut u8, outputbuffersize: u32, requestcompletioncallback: windows_core::Ref<'_, IDeviceRequestCompletionCallback>, cancelcontext: *mut usize) -> Result<(), windows_result::HRESULT>;
    fn CancelOperation(&self, cancelcontext: usize) -> Result<(), windows_result::HRESULT>;
}
...
impl IDeviceRequestCompletionCallback {
    pub unsafe fn Invoke(&self, requestresult: windows_core::HRESULT, bytesreturned: u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IDeviceRequestCompletionCallback_Impl: windows_core::IUnknownImpl {
    fn Invoke(&self, requestresult: windows_core::HRESULT, bytesreturned: u32) -> Result<(), windows_result::HRESULT>;
}
