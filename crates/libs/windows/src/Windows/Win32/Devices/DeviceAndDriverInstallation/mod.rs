    ...
    P6: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { SetupDiSetClassPropertyExW(classguid, propertykey, propertytype, core::mem::transmute(propertybuffer.map_or(core::ptr::null(), |slice| slice.as_ptr())), propertybuffer.map_or(0, |slice| slice.len().try_into().unwrap()), flags, machinename.param().abi(), reserved.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[cfg(feature = "Win32_Devices_Properties")]
#[inline]
pub unsafe fn SetupDiSetClassPropertyW(classguid: *const windows_core::GUID, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: super::Properties::DEVPROPTYPE, propertybuffer: Option<&[u8]>, flags: u32) -> windows_core::Result<()> {
    ...
    unsafe { SetupDiSetClassPropertyW(classguid, propertykey, propertytype, core::mem::transmute(propertybuffer.map_or(core::ptr::null(), |slice| slice.as_ptr())), propertybuffer.map_or(0, |slice| slice.len().try_into().unwrap()), flags).ok() }
}
#[inline]
    ...
    P4: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { SetupDiSetClassRegistryPropertyA(classguid, property, core::mem::transmute(propertybuffer.map_or(core::ptr::null(), |slice| slice.as_ptr())), propertybuffer.map_or(0, |slice| slice.len().try_into().unwrap()), machinename.param().abi(), reserved.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
    ...
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { SetupDiSetClassRegistryPropertyW(classguid, property, core::mem::transmute(propertybuffer.map_or(core::ptr::null(), |slice| slice.as_ptr())), propertybuffer.map_or(0, |slice| slice.len().try_into().unwrap()), machinename.param().abi(), reserved.unwrap_or(core::mem::zeroed()) as _).ok() }
}
#[inline]
...
pub unsafe fn SetupDiSetDeviceInterfacePropertyW(deviceinfoset: HDEVINFO, deviceinterfacedata: *const SP_DEVICE_INTERFACE_DATA, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: super::Properties::DEVPROPTYPE, propertybuffer: Option<&[u8]>, flags: u32) -> windows_core::Result<()> {
    ...
    unsafe { SetupDiSetDeviceInterfacePropertyW(deviceinfoset, deviceinterfacedata, propertykey, propertytype, core::mem::transmute(propertybuffer.map_or(core::ptr::null(), |slice| slice.as_ptr())), propertybuffer.map_or(0, |slice| slice.len().try_into().unwrap()), flags).ok() }
}
#[cfg(feature = "Win32_Devices_Properties")]
#[inline]
pub unsafe fn SetupDiSetDevicePropertyW(deviceinfoset: HDEVINFO, deviceinfodata: *const SP_DEVINFO_DATA, propertykey: *const super::super::Foundation::DEVPROPKEY, propertytype: super::Properties::DEVPROPTYPE, propertybuffer: Option<&[u8]>, flags: u32) -> windows_core::Result<()> {
    ...
    unsafe { SetupDiSetDevicePropertyW(deviceinfoset, deviceinfodata, propertykey, propertytype, core::mem::transmute(propertybuffer.map_or(core::ptr::null(), |slice| slice.as_ptr())), propertybuffer.map_or(0, |slice| slice.len().try_into().unwrap()), flags).ok() }
}
#[inline]
pub unsafe fn SetupDiSetDeviceRegistryPropertyA(deviceinfoset: HDEVINFO, deviceinfodata: *mut SP_DEVINFO_DATA, property: SETUP_DI_REGISTRY_PROPERTY, propertybuffer: Option<&[u8]>) -> windows_core::Result<()> {
    ...
    unsafe { SetupDiSetDeviceRegistryPropertyA(deviceinfoset, deviceinfodata as _, property, core::mem::transmute(propertybuffer.map_or(core::ptr::null(), |slice| slice.as_ptr())), propertybuffer.map_or(0, |slice| slice.len().try_into().unwrap())).ok() }
}
#[inline]
pub unsafe fn SetupDiSetDeviceRegistryPropertyW(deviceinfoset: HDEVINFO, deviceinfodata: *mut SP_DEVINFO_DATA, property: SETUP_DI_REGISTRY_PROPERTY, propertybuffer: Option<&[u8]>) -> windows_core::Result<()> {
    ...
    unsafe { SetupDiSetDeviceRegistryPropertyW(deviceinfoset, deviceinfodata as _, property, core::mem::transmute(propertybuffer.map_or(core::ptr::null(), |slice| slice.as_ptr())), propertybuffer.map_or(0, |slice| slice.len().try_into().unwrap())).ok() }
}
#[inline]
...
pub const ALLOC_LOG_CONF: CM_LOG_CONF = CM_LOG_CONF(2);
pub const BASIC_LOG_CONF: CM_LOG_CONF = CM_LOG_CONF(0);
pub const BOOT_LOG_CONF: CM_LOG_CONF = CM_LOG_CONF(3);
#[repr(C, packed(1))]
...
pub const CM_CDFLAGS_DRIVER: CM_CDFLAGS = CM_CDFLAGS(1);
pub const CM_CDFLAGS_RESERVED: CM_CDFLAGS = CM_CDFLAGS(4);
pub const CM_CDFLAGS_ROOT_OWNED: CM_CDFLAGS = CM_CDFLAGS(2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CM_CDMASK_DESCRIPTION: CM_CDMASK = CM_CDMASK(8);
pub const CM_CDMASK_DEVINST: CM_CDMASK = CM_CDMASK(1);
pub const CM_CDMASK_FLAGS: CM_CDMASK = CM_CDMASK(4);
pub const CM_CDMASK_RESDES: CM_CDMASK = CM_CDMASK(2);
pub const CM_CDMASK_VALID: CM_CDMASK = CM_CDMASK(15);
...
pub const CM_DEVCAP_DOCKDEVICE: CM_DEVCAP = CM_DEVCAP(8);
pub const CM_DEVCAP_EJECTSUPPORTED: CM_DEVCAP = CM_DEVCAP(2);
pub const CM_DEVCAP_HARDWAREDISABLED: CM_DEVCAP = CM_DEVCAP(256);
pub const CM_DEVCAP_LOCKSUPPORTED: CM_DEVCAP = CM_DEVCAP(1);
pub const CM_DEVCAP_NONDYNAMIC: CM_DEVCAP = CM_DEVCAP(512);
pub const CM_DEVCAP_RAWDEVICEOK: CM_DEVCAP = CM_DEVCAP(64);
pub const CM_DEVCAP_REMOVABLE: CM_DEVCAP = CM_DEVCAP(4);
pub const CM_DEVCAP_SECUREDEVICE: CM_DEVCAP = CM_DEVCAP(1024);
pub const CM_DEVCAP_SILENTINSTALL: CM_DEVCAP = CM_DEVCAP(32);
pub const CM_DEVCAP_SURPRISEREMOVALOK: CM_DEVCAP = CM_DEVCAP(128);
pub const CM_DEVCAP_UNIQUEID: CM_DEVCAP = CM_DEVCAP(16);
...
pub const CM_ENUMERATE_CLASSES_BITS: CM_ENUMERATE_FLAGS = CM_ENUMERATE_FLAGS(1);
pub const CM_ENUMERATE_CLASSES_INSTALLER: CM_ENUMERATE_FLAGS = CM_ENUMERATE_FLAGS(0);
pub const CM_ENUMERATE_CLASSES_INTERFACE: CM_ENUMERATE_FLAGS = CM_ENUMERATE_FLAGS(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CM_GET_DEVICE_INTERFACE_LIST_ALL_DEVICES: CM_GET_DEVICE_INTERFACE_LIST_FLAGS = CM_GET_DEVICE_INTERFACE_LIST_FLAGS(1);
pub const CM_GET_DEVICE_INTERFACE_LIST_BITS: CM_GET_DEVICE_INTERFACE_LIST_FLAGS = CM_GET_DEVICE_INTERFACE_LIST_FLAGS(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct CM_GET_DEVICE_INTERFACE_LIST_FLAGS(pub u32);
pub const CM_GET_DEVICE_INTERFACE_LIST_PRESENT: CM_GET_DEVICE_INTERFACE_LIST_FLAGS = CM_GET_DEVICE_INTERFACE_LIST_FLAGS(0);
...
pub const CM_INSTALL_STATE_FAILED_INSTALL: CM_INSTALL_STATE = CM_INSTALL_STATE(2);
pub const CM_INSTALL_STATE_FINISH_INSTALL: CM_INSTALL_STATE = CM_INSTALL_STATE(3);
pub const CM_INSTALL_STATE_INSTALLED: CM_INSTALL_STATE = CM_INSTALL_STATE(0);
pub const CM_INSTALL_STATE_NEEDS_REINSTALL: CM_INSTALL_STATE = CM_INSTALL_STATE(1);
pub const CM_LOCATE_DEVNODE_BITS: CM_LOCATE_DEVNODE_FLAGS = CM_LOCATE_DEVNODE_FLAGS(7);
pub const CM_LOCATE_DEVNODE_CANCELREMOVE: CM_LOCATE_DEVNODE_FLAGS = CM_LOCATE_DEVNODE_FLAGS(2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct CM_LOCATE_DEVNODE_FLAGS(pub u32);
pub const CM_LOCATE_DEVNODE_NORMAL: CM_LOCATE_DEVNODE_FLAGS = CM_LOCATE_DEVNODE_FLAGS(0);
pub const CM_LOCATE_DEVNODE_NOVALIDATION: CM_LOCATE_DEVNODE_FLAGS = CM_LOCATE_DEVNODE_FLAGS(4);
pub const CM_LOCATE_DEVNODE_PHANTOM: CM_LOCATE_DEVNODE_FLAGS = CM_LOCATE_DEVNODE_FLAGS(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CM_NOTIFY_ACTION_DEVICECUSTOMEVENT: CM_NOTIFY_ACTION = CM_NOTIFY_ACTION(6);
pub const CM_NOTIFY_ACTION_DEVICEINSTANCEENUMERATED: CM_NOTIFY_ACTION = CM_NOTIFY_ACTION(7);
pub const CM_NOTIFY_ACTION_DEVICEINSTANCEREMOVED: CM_NOTIFY_ACTION = CM_NOTIFY_ACTION(9);
pub const CM_NOTIFY_ACTION_DEVICEINSTANCESTARTED: CM_NOTIFY_ACTION = CM_NOTIFY_ACTION(8);
pub const CM_NOTIFY_ACTION_DEVICEINTERFACEARRIVAL: CM_NOTIFY_ACTION = CM_NOTIFY_ACTION(0);
pub const CM_NOTIFY_ACTION_DEVICEINTERFACEREMOVAL: CM_NOTIFY_ACTION = CM_NOTIFY_ACTION(1);
pub const CM_NOTIFY_ACTION_DEVICEQUERYREMOVE: CM_NOTIFY_ACTION = CM_NOTIFY_ACTION(2);
pub const CM_NOTIFY_ACTION_DEVICEQUERYREMOVEFAILED: CM_NOTIFY_ACTION = CM_NOTIFY_ACTION(3);
pub const CM_NOTIFY_ACTION_DEVICEREMOVECOMPLETE: CM_NOTIFY_ACTION = CM_NOTIFY_ACTION(5);
pub const CM_NOTIFY_ACTION_DEVICEREMOVEPENDING: CM_NOTIFY_ACTION = CM_NOTIFY_ACTION(4);
pub const CM_NOTIFY_ACTION_MAX: CM_NOTIFY_ACTION = CM_NOTIFY_ACTION(10);
#[repr(C)]
#[derive(Clone, Copy)]
...
pub const CM_NOTIFY_FILTER_TYPE_DEVICEHANDLE: CM_NOTIFY_FILTER_TYPE = CM_NOTIFY_FILTER_TYPE(1);
pub const CM_NOTIFY_FILTER_TYPE_DEVICEINSTANCE: CM_NOTIFY_FILTER_TYPE = CM_NOTIFY_FILTER_TYPE(2);
pub const CM_NOTIFY_FILTER_TYPE_DEVICEINTERFACE: CM_NOTIFY_FILTER_TYPE = CM_NOTIFY_FILTER_TYPE(0);
pub const CM_NOTIFY_FILTER_TYPE_MAX: CM_NOTIFY_FILTER_TYPE = CM_NOTIFY_FILTER_TYPE(3);
...
pub const CM_PROB_BIOS_TABLE: CM_PROB = CM_PROB(35);
pub const CM_PROB_BOOT_CONFIG_CONFLICT: CM_PROB = CM_PROB(6);
pub const CM_PROB_CANT_SHARE_IRQ: CM_PROB = CM_PROB(30);
pub const CM_PROB_CONSOLE_LOCKED: CM_PROB = CM_PROB(55);
pub const CM_PROB_DEVICE_NOT_THERE: CM_PROB = CM_PROB(24);
pub const CM_PROB_DEVICE_RESET: CM_PROB = CM_PROB(54);
pub const CM_PROB_DEVLOADER_FAILED: CM_PROB = CM_PROB(2);
pub const CM_PROB_DEVLOADER_NOT_FOUND: CM_PROB = CM_PROB(8);
pub const CM_PROB_DEVLOADER_NOT_READY: CM_PROB = CM_PROB(23);
pub const CM_PROB_DISABLED: CM_PROB = CM_PROB(22);
pub const CM_PROB_DISABLED_SERVICE: CM_PROB = CM_PROB(32);
pub const CM_PROB_DRIVER_BLOCKED: CM_PROB = CM_PROB(48);
pub const CM_PROB_DRIVER_FAILED_LOAD: CM_PROB = CM_PROB(39);
pub const CM_PROB_DRIVER_FAILED_PRIOR_UNLOAD: CM_PROB = CM_PROB(38);
pub const CM_PROB_DRIVER_SERVICE_KEY_INVALID: CM_PROB = CM_PROB(40);
pub const CM_PROB_DUPLICATE_DEVICE: CM_PROB = CM_PROB(42);
pub const CM_PROB_ENTRY_IS_WRONG_TYPE: CM_PROB = CM_PROB(4);
pub const CM_PROB_FAILED_ADD: CM_PROB = CM_PROB(31);
pub const CM_PROB_FAILED_DRIVER_ENTRY: CM_PROB = CM_PROB(37);
pub const CM_PROB_FAILED_FILTER: CM_PROB = CM_PROB(7);
pub const CM_PROB_FAILED_INSTALL: CM_PROB = CM_PROB(28);
pub const CM_PROB_FAILED_POST_START: CM_PROB = CM_PROB(43);
pub const CM_PROB_FAILED_START: CM_PROB = CM_PROB(10);
pub const CM_PROB_GUEST_ASSIGNMENT_FAILED: CM_PROB = CM_PROB(57);
pub const CM_PROB_HALTED: CM_PROB = CM_PROB(44);
pub const CM_PROB_HARDWARE_DISABLED: CM_PROB = CM_PROB(29);
pub const CM_PROB_HELD_FOR_EJECT: CM_PROB = CM_PROB(47);
pub const CM_PROB_INVALID_DATA: CM_PROB = CM_PROB(9);
pub const CM_PROB_IRQ_TRANSLATION_FAILED: CM_PROB = CM_PROB(36);
pub const CM_PROB_LACKED_ARBITRATOR: CM_PROB = CM_PROB(5);
pub const CM_PROB_LEGACY_SERVICE_NO_DEVICES: CM_PROB = CM_PROB(41);
pub const CM_PROB_LIAR: CM_PROB = CM_PROB(11);
pub const CM_PROB_MOVED: CM_PROB = CM_PROB(25);
pub const CM_PROB_NEED_CLASS_CONFIG: CM_PROB = CM_PROB(56);
pub const CM_PROB_NEED_RESTART: CM_PROB = CM_PROB(14);
pub const CM_PROB_NORMAL_CONFLICT: CM_PROB = CM_PROB(12);
pub const CM_PROB_NOT_CONFIGURED: CM_PROB = CM_PROB(1);
pub const CM_PROB_NOT_VERIFIED: CM_PROB = CM_PROB(13);
pub const CM_PROB_NO_SOFTCONFIG: CM_PROB = CM_PROB(34);
pub const CM_PROB_NO_VALID_LOG_CONF: CM_PROB = CM_PROB(27);
pub const CM_PROB_OUT_OF_MEMORY: CM_PROB = CM_PROB(3);
pub const CM_PROB_PARTIAL_LOG_CONF: CM_PROB = CM_PROB(16);
pub const CM_PROB_PHANTOM: CM_PROB = CM_PROB(45);
pub const CM_PROB_REENUMERATION: CM_PROB = CM_PROB(15);
pub const CM_PROB_REGISTRY: CM_PROB = CM_PROB(19);
pub const CM_PROB_REGISTRY_TOO_LARGE: CM_PROB = CM_PROB(49);
pub const CM_PROB_REINSTALL: CM_PROB = CM_PROB(18);
pub const CM_PROB_SETPROPERTIES_FAILED: CM_PROB = CM_PROB(50);
pub const CM_PROB_SYSTEM_SHUTDOWN: CM_PROB = CM_PROB(46);
pub const CM_PROB_TOO_EARLY: CM_PROB = CM_PROB(26);
pub const CM_PROB_TRANSLATION_FAILED: CM_PROB = CM_PROB(33);
pub const CM_PROB_UNKNOWN_RESOURCE: CM_PROB = CM_PROB(17);
pub const CM_PROB_UNSIGNED_DRIVER: CM_PROB = CM_PROB(52);
pub const CM_PROB_USED_BY_DEBUGGER: CM_PROB = CM_PROB(53);
pub const CM_PROB_VXDLDR: CM_PROB = CM_PROB(20);
pub const CM_PROB_WAITING_ON_DEPENDENCY: CM_PROB = CM_PROB(51);
pub const CM_PROB_WILL_BE_REMOVED: CM_PROB = CM_PROB(21);
...
pub const CM_REENUMERATE_ASYNCHRONOUS: CM_REENUMERATE_FLAGS = CM_REENUMERATE_FLAGS(4);
pub const CM_REENUMERATE_BITS: CM_REENUMERATE_FLAGS = CM_REENUMERATE_FLAGS(7);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const CM_REENUMERATE_NORMAL: CM_REENUMERATE_FLAGS = CM_REENUMERATE_FLAGS(0);
pub const CM_REENUMERATE_RETRY_INSTALLATION: CM_REENUMERATE_FLAGS = CM_REENUMERATE_FLAGS(2);
pub const CM_REENUMERATE_SYNCHRONOUS: CM_REENUMERATE_FLAGS = CM_REENUMERATE_FLAGS(1);
...
pub const CM_REMOVAL_POLICY_EXPECT_NO_REMOVAL: CM_REMOVAL_POLICY = CM_REMOVAL_POLICY(1);
pub const CM_REMOVAL_POLICY_EXPECT_ORDERLY_REMOVAL: CM_REMOVAL_POLICY = CM_REMOVAL_POLICY(2);
pub const CM_REMOVAL_POLICY_EXPECT_SURPRISE_REMOVAL: CM_REMOVAL_POLICY = CM_REMOVAL_POLICY(3);
...
pub const CONFIGFLAG_BOOT_DEVICE: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(262144);
pub const CONFIGFLAG_CANTSTOPACHILD: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(128);
pub const CONFIGFLAG_DISABLED: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(1);
pub const CONFIGFLAG_FAILEDINSTALL: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(64);
pub const CONFIGFLAG_FINISHINSTALL_ACTION: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(131072);
pub const CONFIGFLAG_FINISHINSTALL_UI: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(65536);
pub const CONFIGFLAG_FINISH_INSTALL: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(1024);
pub const CONFIGFLAG_IGNORE_BOOT_LC: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(8);
pub const CONFIGFLAG_MANUAL_INSTALL: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(4);
pub const CONFIGFLAG_NEEDS_CLASS_CONFIG: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(524288);
pub const CONFIGFLAG_NEEDS_FORCED_CONFIG: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(2048);
pub const CONFIGFLAG_NETBOOT_CARD: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(4096);
pub const CONFIGFLAG_NET_BOOT: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(16);
pub const CONFIGFLAG_NOREMOVEEXIT: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(512);
pub const CONFIGFLAG_OKREMOVEROM: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(256);
pub const CONFIGFLAG_PARTIAL_LOG_CONF: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(8192);
pub const CONFIGFLAG_REINSTALL: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(32);
pub const CONFIGFLAG_REMOVED: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(2);
pub const CONFIGFLAG_SUPPRESS_SURPRISE: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(16384);
pub const CONFIGFLAG_VERIFY_HARDWARE: SETUP_DI_DEVICE_CONFIGURATION_FLAGS = SETUP_DI_DEVICE_CONFIGURATION_FLAGS(32768);
...
pub const CR_ACCESS_DENIED: CONFIGRET = CONFIGRET(51);
pub const CR_ALREADY_SUCH_DEVINST: CONFIGRET = CONFIGRET(16);
pub const CR_ALREADY_SUCH_DEVNODE: CONFIGRET = CONFIGRET(16);
pub const CR_APM_VETOED: CONFIGRET = CONFIGRET(24);
pub const CR_BUFFER_SMALL: CONFIGRET = CONFIGRET(26);
pub const CR_CALL_NOT_IMPLEMENTED: CONFIGRET = CONFIGRET(52);
pub const CR_CANT_SHARE_IRQ: CONFIGRET = CONFIGRET(43);
pub const CR_CREATE_BLOCKED: CONFIGRET = CONFIGRET(21);
pub const CR_DEFAULT: CONFIGRET = CONFIGRET(1);
pub const CR_DEVICE_INTERFACE_ACTIVE: CONFIGRET = CONFIGRET(54);
pub const CR_DEVICE_NOT_THERE: CONFIGRET = CONFIGRET(36);
pub const CR_DEVINST_HAS_REQS: CONFIGRET = CONFIGRET(10);
pub const CR_DEVLOADER_NOT_READY: CONFIGRET = CONFIGRET(33);
pub const CR_DEVNODE_HAS_REQS: CONFIGRET = CONFIGRET(10);
pub const CR_DLVXD_NOT_FOUND: CONFIGRET = CONFIGRET(12);
pub const CR_FAILURE: CONFIGRET = CONFIGRET(19);
pub const CR_FREE_RESOURCES: CONFIGRET = CONFIGRET(41);
pub const CR_INVALID_API: CONFIGRET = CONFIGRET(32);
pub const CR_INVALID_ARBITRATOR: CONFIGRET = CONFIGRET(8);
pub const CR_INVALID_CONFLICT_LIST: CONFIGRET = CONFIGRET(57);
pub const CR_INVALID_DATA: CONFIGRET = CONFIGRET(31);
pub const CR_INVALID_DEVICE_ID: CONFIGRET = CONFIGRET(30);
pub const CR_INVALID_DEVINST: CONFIGRET = CONFIGRET(5);
pub const CR_INVALID_DEVNODE: CONFIGRET = CONFIGRET(5);
pub const CR_INVALID_FLAG: CONFIGRET = CONFIGRET(4);
pub const CR_INVALID_INDEX: CONFIGRET = CONFIGRET(58);
pub const CR_INVALID_LOAD_TYPE: CONFIGRET = CONFIGRET(25);
pub const CR_INVALID_LOG_CONF: CONFIGRET = CONFIGRET(7);
pub const CR_INVALID_MACHINENAME: CONFIGRET = CONFIGRET(47);
pub const CR_INVALID_NODELIST: CONFIGRET = CONFIGRET(9);
pub const CR_INVALID_POINTER: CONFIGRET = CONFIGRET(3);
pub const CR_INVALID_PRIORITY: CONFIGRET = CONFIGRET(39);
pub const CR_INVALID_PROPERTY: CONFIGRET = CONFIGRET(53);
pub const CR_INVALID_RANGE: CONFIGRET = CONFIGRET(18);
pub const CR_INVALID_RANGE_LIST: CONFIGRET = CONFIGRET(17);
pub const CR_INVALID_REFERENCE_STRING: CONFIGRET = CONFIGRET(56);
pub const CR_INVALID_RESOURCEID: CONFIGRET = CONFIGRET(11);
pub const CR_INVALID_RES_DES: CONFIGRET = CONFIGRET(6);
pub const CR_INVALID_STRUCTURE_SIZE: CONFIGRET = CONFIGRET(59);
pub const CR_MACHINE_UNAVAILABLE: CONFIGRET = CONFIGRET(49);
pub const CR_NEED_RESTART: CONFIGRET = CONFIGRET(34);
pub const CR_NOT_DISABLEABLE: CONFIGRET = CONFIGRET(40);
pub const CR_NOT_SYSTEM_VM: CONFIGRET = CONFIGRET(22);
pub const CR_NO_ARBITRATOR: CONFIGRET = CONFIGRET(27);
pub const CR_NO_CM_SERVICES: CONFIGRET = CONFIGRET(50);
pub const CR_NO_DEPENDENT: CONFIGRET = CONFIGRET(44);
pub const CR_NO_MORE_HW_PROFILES: CONFIGRET = CONFIGRET(35);
pub const CR_NO_MORE_LOG_CONF: CONFIGRET = CONFIGRET(14);
pub const CR_NO_MORE_RES_DES: CONFIGRET = CONFIGRET(15);
pub const CR_NO_REGISTRY_HANDLE: CONFIGRET = CONFIGRET(28);
pub const CR_NO_SUCH_DEVICE_INTERFACE: CONFIGRET = CONFIGRET(55);
pub const CR_NO_SUCH_DEVINST: CONFIGRET = CONFIGRET(13);
pub const CR_NO_SUCH_DEVNODE: CONFIGRET = CONFIGRET(13);
pub const CR_NO_SUCH_LOGICAL_DEV: CONFIGRET = CONFIGRET(20);
pub const CR_NO_SUCH_REGISTRY_KEY: CONFIGRET = CONFIGRET(46);
pub const CR_NO_SUCH_VALUE: CONFIGRET = CONFIGRET(37);
pub const CR_OUT_OF_MEMORY: CONFIGRET = CONFIGRET(2);
pub const CR_QUERY_VETOED: CONFIGRET = CONFIGRET(42);
pub const CR_REGISTRY_ERROR: CONFIGRET = CONFIGRET(29);
pub const CR_REMOTE_COMM_FAILURE: CONFIGRET = CONFIGRET(48);
pub const CR_REMOVE_VETOED: CONFIGRET = CONFIGRET(23);
pub const CR_SAME_RESOURCES: CONFIGRET = CONFIGRET(45);
pub const CR_SUCCESS: CONFIGRET = CONFIGRET(0);
pub const CR_WRONG_TYPE: CONFIGRET = CONFIGRET(38);
#[repr(C, packed(1))]
#[derive(Clone, Copy)]
pub struct CS_DES {
...
pub const DICD_GENERATE_ID: SETUP_DI_DEVICE_CREATION_FLAGS = SETUP_DI_DEVICE_CREATION_FLAGS(1);
pub const DICD_INHERIT_CLASSDRVS: SETUP_DI_DEVICE_CREATION_FLAGS = SETUP_DI_DEVICE_CREATION_FLAGS(2);
pub const DICLASSPROP_INSTALLER: u32 = 1;
pub const DICLASSPROP_INTERFACE: u32 = 2;
pub const DICS_DISABLE: SETUP_DI_STATE_CHANGE = SETUP_DI_STATE_CHANGE(2);
pub const DICS_ENABLE: SETUP_DI_STATE_CHANGE = SETUP_DI_STATE_CHANGE(1);
pub const DICS_FLAG_CONFIGGENERAL: SETUP_DI_PROPERTY_CHANGE_SCOPE = SETUP_DI_PROPERTY_CHANGE_SCOPE(4);
pub const DICS_FLAG_CONFIGSPECIFIC: SETUP_DI_PROPERTY_CHANGE_SCOPE = SETUP_DI_PROPERTY_CHANGE_SCOPE(2);
pub const DICS_FLAG_GLOBAL: SETUP_DI_PROPERTY_CHANGE_SCOPE = SETUP_DI_PROPERTY_CHANGE_SCOPE(1);
pub const DICS_PROPCHANGE: SETUP_DI_STATE_CHANGE = SETUP_DI_STATE_CHANGE(3);
pub const DICS_START: SETUP_DI_STATE_CHANGE = SETUP_DI_STATE_CHANGE(4);
pub const DICS_STOP: SETUP_DI_STATE_CHANGE = SETUP_DI_STATE_CHANGE(5);
pub const DICUSTOMDEVPROP_MERGE_MULTISZ: u32 = 1;
pub const DIF_ADDPROPERTYPAGE_ADVANCED: DI_FUNCTION = DI_FUNCTION(35);
pub const DIF_ADDPROPERTYPAGE_BASIC: DI_FUNCTION = DI_FUNCTION(36);
pub const DIF_ADDREMOTEPROPERTYPAGE_ADVANCED: DI_FUNCTION = DI_FUNCTION(40);
pub const DIF_ALLOW_INSTALL: DI_FUNCTION = DI_FUNCTION(24);
pub const DIF_ASSIGNRESOURCES: DI_FUNCTION = DI_FUNCTION(3);
pub const DIF_CALCDISKSPACE: DI_FUNCTION = DI_FUNCTION(11);
pub const DIF_DESTROYPRIVATEDATA: DI_FUNCTION = DI_FUNCTION(12);
pub const DIF_DESTROYWIZARDDATA: DI_FUNCTION = DI_FUNCTION(17);
pub const DIF_DETECT: DI_FUNCTION = DI_FUNCTION(15);
pub const DIF_DETECTCANCEL: DI_FUNCTION = DI_FUNCTION(33);
pub const DIF_DETECTVERIFY: DI_FUNCTION = DI_FUNCTION(20);
pub const DIF_ENABLECLASS: DI_FUNCTION = DI_FUNCTION(19);
pub const DIF_FINISHINSTALL_ACTION: DI_FUNCTION = DI_FUNCTION(42);
pub const DIF_FIRSTTIMESETUP: DI_FUNCTION = DI_FUNCTION(6);
pub const DIF_FOUNDDEVICE: DI_FUNCTION = DI_FUNCTION(7);
pub const DIF_INSTALLCLASSDRIVERS: DI_FUNCTION = DI_FUNCTION(10);
pub const DIF_INSTALLDEVICE: DI_FUNCTION = DI_FUNCTION(2);
pub const DIF_INSTALLDEVICEFILES: DI_FUNCTION = DI_FUNCTION(21);
pub const DIF_INSTALLINTERFACES: DI_FUNCTION = DI_FUNCTION(32);
pub const DIF_INSTALLWIZARD: DI_FUNCTION = DI_FUNCTION(16);
pub const DIF_MOVEDEVICE: DI_FUNCTION = DI_FUNCTION(14);
pub const DIF_NEWDEVICEWIZARD_FINISHINSTALL: DI_FUNCTION = DI_FUNCTION(30);
pub const DIF_NEWDEVICEWIZARD_POSTANALYZE: DI_FUNCTION = DI_FUNCTION(29);
pub const DIF_NEWDEVICEWIZARD_PREANALYZE: DI_FUNCTION = DI_FUNCTION(28);
pub const DIF_NEWDEVICEWIZARD_PRESELECT: DI_FUNCTION = DI_FUNCTION(26);
pub const DIF_NEWDEVICEWIZARD_SELECT: DI_FUNCTION = DI_FUNCTION(27);
pub const DIF_POWERMESSAGEWAKE: DI_FUNCTION = DI_FUNCTION(39);
pub const DIF_PROPERTIES: DI_FUNCTION = DI_FUNCTION(4);
pub const DIF_PROPERTYCHANGE: DI_FUNCTION = DI_FUNCTION(18);
pub const DIF_REGISTERDEVICE: DI_FUNCTION = DI_FUNCTION(25);
pub const DIF_REGISTER_COINSTALLERS: DI_FUNCTION = DI_FUNCTION(34);
pub const DIF_REMOVE: DI_FUNCTION = DI_FUNCTION(5);
pub const DIF_RESERVED1: DI_FUNCTION = DI_FUNCTION(37);
pub const DIF_RESERVED2: DI_FUNCTION = DI_FUNCTION(48);
pub const DIF_SELECTBESTCOMPATDRV: DI_FUNCTION = DI_FUNCTION(23);
pub const DIF_SELECTCLASSDRIVERS: DI_FUNCTION = DI_FUNCTION(8);
pub const DIF_SELECTDEVICE: DI_FUNCTION = DI_FUNCTION(1);
pub const DIF_TROUBLESHOOTER: DI_FUNCTION = DI_FUNCTION(38);
pub const DIF_UNREMOVE: DI_FUNCTION = DI_FUNCTION(22);
pub const DIF_UNUSED1: DI_FUNCTION = DI_FUNCTION(31);
pub const DIF_UPDATEDRIVER_UI: DI_FUNCTION = DI_FUNCTION(41);
pub const DIF_VALIDATECLASSDRIVERS: DI_FUNCTION = DI_FUNCTION(9);
pub const DIF_VALIDATEDRIVER: DI_FUNCTION = DI_FUNCTION(13);
...
pub const DIGCF_ALLCLASSES: SETUP_DI_GET_CLASS_DEVS_FLAGS = SETUP_DI_GET_CLASS_DEVS_FLAGS(4);
pub const DIGCF_DEFAULT: SETUP_DI_GET_CLASS_DEVS_FLAGS = SETUP_DI_GET_CLASS_DEVS_FLAGS(1);
pub const DIGCF_DEVICEINTERFACE: SETUP_DI_GET_CLASS_DEVS_FLAGS = SETUP_DI_GET_CLASS_DEVS_FLAGS(16);
pub const DIGCF_INTERFACEDEVICE: SETUP_DI_GET_CLASS_DEVS_FLAGS = SETUP_DI_GET_CLASS_DEVS_FLAGS(16);
pub const DIGCF_PRESENT: SETUP_DI_GET_CLASS_DEVS_FLAGS = SETUP_DI_GET_CLASS_DEVS_FLAGS(2);
pub const DIGCF_PROFILE: SETUP_DI_GET_CLASS_DEVS_FLAGS = SETUP_DI_GET_CLASS_DEVS_FLAGS(8);
pub const DIIDFLAG_BITS: DIINSTALLDEVICE_FLAGS = DIINSTALLDEVICE_FLAGS(15);
pub const DIIDFLAG_INSTALLCOPYINFDRIVERS: DIINSTALLDEVICE_FLAGS = DIINSTALLDEVICE_FLAGS(8);
pub const DIIDFLAG_INSTALLNULLDRIVER: DIINSTALLDEVICE_FLAGS = DIINSTALLDEVICE_FLAGS(4);
pub const DIIDFLAG_NOFINISHINSTALLUI: DIINSTALLDEVICE_FLAGS = DIINSTALLDEVICE_FLAGS(2);
pub const DIIDFLAG_SHOWSEARCHUI: DIINSTALLDEVICE_FLAGS = DIINSTALLDEVICE_FLAGS(1);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const DIIRFLAG_BITS: DIINSTALLDRIVER_FLAGS = DIINSTALLDRIVER_FLAGS(106);
pub const DIIRFLAG_FORCE_INF: DIINSTALLDRIVER_FLAGS = DIINSTALLDRIVER_FLAGS(2);
pub const DIIRFLAG_HOTPATCH: DIINSTALLDRIVER_FLAGS = DIINSTALLDRIVER_FLAGS(8);
pub const DIIRFLAG_HW_USING_THE_INF: DIINSTALLDRIVER_FLAGS = DIINSTALLDRIVER_FLAGS(4);
pub const DIIRFLAG_INF_ALREADY_COPIED: DIINSTALLDRIVER_FLAGS = DIINSTALLDRIVER_FLAGS(1);
pub const DIIRFLAG_INSTALL_AS_SET: DIINSTALLDRIVER_FLAGS = DIINSTALLDRIVER_FLAGS(64);
pub const DIIRFLAG_NOBACKUP: DIINSTALLDRIVER_FLAGS = DIINSTALLDRIVER_FLAGS(16);
pub const DIIRFLAG_PRE_CONFIGURE_INF: DIINSTALLDRIVER_FLAGS = DIINSTALLDRIVER_FLAGS(32);
pub const DIIRFLAG_SYSTEM_BITS: DIINSTALLDRIVER_FLAGS = DIINSTALLDRIVER_FLAGS(127);
...
pub const DIURFLAG_NO_REMOVE_INF: DIUNINSTALLDRIVER_FLAGS = DIUNINSTALLDRIVER_FLAGS(1);
pub const DIURFLAG_RESERVED: DIUNINSTALLDRIVER_FLAGS = DIUNINSTALLDRIVER_FLAGS(2);
pub const DIURFLAG_VALID: DIUNINSTALLDRIVER_FLAGS = DIUNINSTALLDRIVER_FLAGS(3);
pub const DI_AUTOASSIGNRES: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(64);
pub const DI_CLASSINSTALLPARAMS: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(1048576);
pub const DI_COMPAT_FROM_CLASS: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(524288);
pub const DI_DIDCLASS: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(32);
pub const DI_DIDCOMPAT: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(16);
pub const DI_DISABLED: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(2048);
pub const DI_DONOTCALLCONFIGMG: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(131072);
pub const DI_DRIVERPAGE_ADDED: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(67108864);
pub const DI_ENUMSINGLEINF: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(65536);
pub const DI_FLAGSEX_ALLOWEXCLUDEDDRVS: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(2048);
pub const DI_FLAGSEX_ALTPLATFORM_DRVSEARCH: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(268435456);
pub const DI_FLAGSEX_ALWAYSWRITEIDS: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(512);
pub const DI_FLAGSEX_APPENDDRIVERLIST: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(262144);
pub const DI_FLAGSEX_BACKUPONREPLACE: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(1048576);
pub const DI_FLAGSEX_CI_FAILED: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(4);
pub const DI_FLAGSEX_DEVICECHANGE: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(256);
pub const DI_FLAGSEX_DIDCOMPATINFO: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(32);
pub const DI_FLAGSEX_DIDINFOLIST: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(16);
pub const DI_FLAGSEX_DRIVERLIST_FROM_URL: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(2097152);
pub const DI_FLAGSEX_EXCLUDE_OLD_INET_DRIVERS: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(8388608);
pub const DI_FLAGSEX_FILTERCLASSES: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(64);
pub const DI_FLAGSEX_FILTERSIMILARDRIVERS: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(33554432);
pub const DI_FLAGSEX_FINISHINSTALL_ACTION: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(8);
pub const DI_FLAGSEX_INET_DRIVER: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(131072);
pub const DI_FLAGSEX_INSTALLEDDRIVER: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(67108864);
pub const DI_FLAGSEX_IN_SYSTEM_SETUP: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(65536);
pub const DI_FLAGSEX_NOUIONQUERYREMOVE: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(4096);
pub const DI_FLAGSEX_NO_CLASSLIST_NODE_MERGE: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(134217728);
pub const DI_FLAGSEX_NO_DRVREG_MODIFY: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(32768);
pub const DI_FLAGSEX_POWERPAGE_ADDED: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(16777216);
pub const DI_FLAGSEX_PREINSTALLBACKUP: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(524288);
pub const DI_FLAGSEX_PROPCHANGE_PENDING: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(1024);
pub const DI_FLAGSEX_RECURSIVESEARCH: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(1073741824);
pub const DI_FLAGSEX_RESERVED1: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(4194304);
pub const DI_FLAGSEX_RESERVED2: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(1);
pub const DI_FLAGSEX_RESERVED3: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(2);
pub const DI_FLAGSEX_RESERVED4: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(16384);
pub const DI_FLAGSEX_RESTART_DEVICE_ONLY: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(536870912);
pub const DI_FLAGSEX_SEARCH_PUBLISHED_INFS: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(2147483648);
pub const DI_FLAGSEX_SETFAILEDINSTALL: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(128);
pub const DI_FLAGSEX_USECLASSFORCOMPAT: SETUP_DI_DEVICE_INSTALL_FLAGS_EX = SETUP_DI_DEVICE_INSTALL_FLAGS_EX(8192);
pub const DI_FORCECOPY: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(33554432);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct DI_FUNCTION(pub u32);
pub const DI_GENERALPAGE_ADDED: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(4096);
pub const DI_INF_IS_SORTED: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(32768);
pub const DI_INSTALLDISABLED: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(262144);
pub const DI_MULTMFGS: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(1024);
pub const DI_NEEDREBOOT: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(256);
pub const DI_NEEDRESTART: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(128);
pub const DI_NOBROWSE: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(512);
pub const DI_NODI_DEFAULTACTION: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(2097152);
pub const DI_NOFILECOPY: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(16777216);
pub const DI_NOSELECTICONS: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(1073741824);
pub const DI_NOVCP: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(8);
pub const DI_NOWRITE_IDS: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(2147483648);
pub const DI_OVERRIDE_INFFLAGS: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(268435456);
pub const DI_PROPERTIES_CHANGE: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(16384);
pub const DI_PROPS_NOCHANGEUSAGE: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(536870912);
pub const DI_QUIETINSTALL: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(8388608);
pub const DI_REMOVEDEVICE_CONFIGSPECIFIC: SETUP_DI_REMOVE_DEVICE_SCOPE = SETUP_DI_REMOVE_DEVICE_SCOPE(2);
pub const DI_REMOVEDEVICE_GLOBAL: SETUP_DI_REMOVE_DEVICE_SCOPE = SETUP_DI_REMOVE_DEVICE_SCOPE(1);
pub const DI_RESOURCEPAGE_ADDED: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(8192);
pub const DI_SHOWALL: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(7);
pub const DI_SHOWCLASS: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(4);
pub const DI_SHOWCOMPAT: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(2);
pub const DI_SHOWOEM: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(1);
pub const DI_UNREMOVEDEVICE_CONFIGSPECIFIC: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(2);
pub const DI_USECI_SELECTSTRINGS: SETUP_DI_DEVICE_INSTALL_FLAGS = SETUP_DI_DEVICE_INSTALL_FLAGS(134217728);
#[repr(C, packed(1))]
#[derive(Clone, Copy, Default)]
pub struct DMA_DES {
    pub DD_Count: u32,
...
pub const DNF_ALWAYSEXCLUDEFROMLIST: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(524288);
pub const DNF_AUTHENTICODE_SIGNED: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(131072);
pub const DNF_BAD_DRIVER: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(2048);
pub const DNF_BASIC_DRIVER: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(65536);
pub const DNF_CLASS_DRIVER: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(32);
pub const DNF_COMPATIBLE_DRIVER: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(64);
pub const DNF_DUPDESC: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(1);
pub const DNF_DUPDRIVERVER: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(32768);
pub const DNF_DUPPROVIDER: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(4096);
pub const DNF_EXCLUDEFROMLIST: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(4);
pub const DNF_INBOX_DRIVER: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(1048576);
pub const DNF_INET_DRIVER: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(128);
pub const DNF_INF_IS_SIGNED: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(8192);
pub const DNF_INSTALLEDDRIVER: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(262144);
pub const DNF_LEGACYINF: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(16);
pub const DNF_NODRIVER: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(8);
pub const DNF_OEM_F6_INF: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(16384);
pub const DNF_OLDDRIVER: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(2);
pub const DNF_OLD_INET_DRIVER: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(1024);
pub const DNF_REQUESTADDITIONALSOFTWARE: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(2097152);
pub const DNF_UNUSED1: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(256);
pub const DNF_UNUSED2: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(512);
pub const DNF_UNUSED_22: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(4194304);
pub const DNF_UNUSED_23: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(8388608);
pub const DNF_UNUSED_24: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(16777216);
pub const DNF_UNUSED_25: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(33554432);
pub const DNF_UNUSED_26: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(67108864);
pub const DNF_UNUSED_27: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(134217728);
pub const DNF_UNUSED_28: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(268435456);
pub const DNF_UNUSED_29: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(536870912);
pub const DNF_UNUSED_30: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(1073741824);
pub const DNF_UNUSED_31: SETUP_DI_DRIVER_INSTALL_FLAGS = SETUP_DI_DRIVER_INSTALL_FLAGS(2147483648);
pub const DN_APM_DRIVER: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(268435456);
pub const DN_APM_ENUMERATOR: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(134217728);
pub const DN_ARM_WAKEUP: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(67108864);
pub const DN_BAD_PARTIAL: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(4194304);
pub const DN_BOOT_LOG_PROB: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(2147483648);
pub const DN_CHANGEABLE_FLAGS: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(1639670464);
pub const DN_CHILD_WITH_INVALID_ID: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(512);
pub const DN_DEVICE_DISCONNECTED: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(33554432);
pub const DN_DISABLEABLE: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(8192);
pub const DN_DRIVER_BLOCKED: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(64);
pub const DN_DRIVER_LOADED: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(2);
pub const DN_ENUM_LOADED: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(4);
pub const DN_FILTERED: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(2048);
pub const DN_HARDWARE_ENUM: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(128);
pub const DN_HAS_MARK: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(512);
pub const DN_HAS_PROBLEM: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(1024);
pub const DN_LEGACY_DRIVER: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(4096);
pub const DN_LIAR: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(256);
pub const DN_MANUAL: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(16);
pub const DN_MF_CHILD: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(131072);
pub const DN_MF_PARENT: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(65536);
pub const DN_MOVED: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(4096);
pub const DN_NEEDS_LOCKING: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(33554432);
pub const DN_NEED_RESTART: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(256);
pub const DN_NEED_TO_ENUM: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(32);
pub const DN_NOT_FIRST_TIME: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(64);
pub const DN_NOT_FIRST_TIMEE: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(524288);
pub const DN_NO_SHOW_IN_DM: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(1073741824);
pub const DN_NT_DRIVER: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(16777216);
pub const DN_NT_ENUMERATOR: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(8388608);
pub const DN_PRIVATE_PROBLEM: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(32768);
pub const DN_QUERY_REMOVE_ACTIVE: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(131072);
pub const DN_QUERY_REMOVE_PENDING: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(65536);
pub const DN_REBAL_CANDIDATE: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(2097152);
pub const DN_REMOVABLE: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(16384);
pub const DN_ROOT_ENUMERATED: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(1);
pub const DN_SILENT_INSTALL: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(536870912);
pub const DN_STARTED: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(8);
pub const DN_STOP_FREE_RES: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(1048576);
pub const DN_WILL_BE_REMOVED: CM_DEVNODE_STATUS_FLAGS = CM_DEVNODE_STATUS_FLAGS(262144);
...
pub const FILEOP_COPY: SETUP_FILE_OPERATION = SETUP_FILE_OPERATION(0);
pub const FILEOP_DELETE: SETUP_FILE_OPERATION = SETUP_FILE_OPERATION(2);
...
pub const FILE_COMPRESSION_MSZIP: FILE_COMPRESSION_TYPE = FILE_COMPRESSION_TYPE(2);
pub const FILE_COMPRESSION_NONE: FILE_COMPRESSION_TYPE = FILE_COMPRESSION_TYPE(0);
pub const FILE_COMPRESSION_NTCAB: FILE_COMPRESSION_TYPE = FILE_COMPRESSION_TYPE(3);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const FILE_COMPRESSION_WINLZA: FILE_COMPRESSION_TYPE = FILE_COMPRESSION_TYPE(1);
#[repr(C, packed(1))]
#[cfg(target_arch = "x86")]
#[derive(Clone, Copy)]
...
pub const FILTERED_LOG_CONF: CM_LOG_CONF = CM_LOG_CONF(1);
...
pub const FORCED_LOG_CONF: CM_LOG_CONF = CM_LOG_CONF(4);
...
pub const INF_STYLE_CACHE_DISABLE: INF_STYLE = INF_STYLE(32);
pub const INF_STYLE_CACHE_ENABLE: INF_STYLE = INF_STYLE(16);
pub const INF_STYLE_CACHE_IGNORE: INF_STYLE = INF_STYLE(64);
pub const INF_STYLE_NONE: INF_STYLE = INF_STYLE(0);
pub const INF_STYLE_OLDNT: INF_STYLE = INF_STYLE(1);
pub const INF_STYLE_WIN4: INF_STYLE = INF_STYLE(2);
pub const INSTALLFLAG_BITS: UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS = UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS(7);
pub const INSTALLFLAG_FORCE: UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS = UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS(1);
pub const INSTALLFLAG_NONINTERACTIVE: UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS = UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS(4);
pub const INSTALLFLAG_READONLY: UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS = UPDATEDRIVERFORPLUGANDPLAYDEVICES_FLAGS(2);
...
pub const MAX_INFSTR_STRKEY_LEN: u32 = 32;
pub const MAX_INF_FLAG: u32 = 20;
...
pub const NUM_CR_RESULTS: CONFIGRET = CONFIGRET(60);
pub const NUM_LOG_CONF: CM_LOG_CONF = CM_LOG_CONF(6);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct OEM_SOURCE_MEDIA_TYPE(pub u32);
pub const OVERRIDE_LOG_CONF: CM_LOG_CONF = CM_LOG_CONF(5);
#[repr(C, packed(1))]
#[derive(Clone, Copy)]
...
pub const PNP_VetoAlreadyRemoved: PNP_VETO_TYPE = PNP_VETO_TYPE(13);
pub const PNP_VetoDevice: PNP_VETO_TYPE = PNP_VETO_TYPE(6);
pub const PNP_VetoDriver: PNP_VETO_TYPE = PNP_VETO_TYPE(7);
pub const PNP_VetoIllegalDeviceRequest: PNP_VETO_TYPE = PNP_VETO_TYPE(8);
pub const PNP_VetoInsufficientPower: PNP_VETO_TYPE = PNP_VETO_TYPE(9);
pub const PNP_VetoInsufficientRights: PNP_VETO_TYPE = PNP_VETO_TYPE(12);
pub const PNP_VetoLegacyDevice: PNP_VETO_TYPE = PNP_VETO_TYPE(1);
pub const PNP_VetoLegacyDriver: PNP_VETO_TYPE = PNP_VETO_TYPE(11);
pub const PNP_VetoNonDisableable: PNP_VETO_TYPE = PNP_VETO_TYPE(10);
pub const PNP_VetoOutstandingOpen: PNP_VETO_TYPE = PNP_VETO_TYPE(5);
pub const PNP_VetoPendingClose: PNP_VETO_TYPE = PNP_VETO_TYPE(2);
pub const PNP_VetoTypeUnknown: PNP_VETO_TYPE = PNP_VETO_TYPE(0);
pub const PNP_VetoWindowsApp: PNP_VETO_TYPE = PNP_VETO_TYPE(3);
pub const PNP_VetoWindowsService: PNP_VETO_TYPE = PNP_VETO_TYPE(4);
...
pub const ROLLBACK_BITS: DIROLLBACKDRIVER_FLAGS = DIROLLBACKDRIVER_FLAGS(1);
pub const ROLLBACK_FLAG_NO_UI: DIROLLBACKDRIVER_FLAGS = DIROLLBACKDRIVER_FLAGS(1);
pub const RegDisposition_Bits: u32 = 1;
pub const RegDisposition_OpenAlways: u32 = 0;
pub const RegDisposition_OpenExisting: u32 = 1;
pub const ResType_All: CM_RESTYPE = CM_RESTYPE(0);
pub const ResType_BusNumber: CM_RESTYPE = CM_RESTYPE(6);
pub const ResType_ClassSpecific: CM_RESTYPE = CM_RESTYPE(65535);
pub const ResType_Connection: CM_RESTYPE = CM_RESTYPE(32772);
pub const ResType_DMA: CM_RESTYPE = CM_RESTYPE(3);
pub const ResType_DevicePrivate: CM_RESTYPE = CM_RESTYPE(32769);
pub const ResType_DoNotUse: CM_RESTYPE = CM_RESTYPE(5);
pub const ResType_IO: CM_RESTYPE = CM_RESTYPE(2);
pub const ResType_IRQ: CM_RESTYPE = CM_RESTYPE(4);
pub const ResType_Ignored_Bit: CM_RESTYPE = CM_RESTYPE(32768);
pub const ResType_MAX: CM_RESTYPE = CM_RESTYPE(7);
pub const ResType_Mem: CM_RESTYPE = CM_RESTYPE(1);
pub const ResType_MemLarge: CM_RESTYPE = CM_RESTYPE(7);
pub const ResType_MfCardConfig: CM_RESTYPE = CM_RESTYPE(32771);
pub const ResType_None: CM_RESTYPE = CM_RESTYPE(0);
pub const ResType_PcCardConfig: CM_RESTYPE = CM_RESTYPE(32770);
pub const ResType_Reserved: CM_RESTYPE = CM_RESTYPE(32768);
...
pub const SPDIT_CLASSDRIVER: SETUP_DI_DRIVER_TYPE = SETUP_DI_DRIVER_TYPE(1);
pub const SPDIT_COMPATDRIVER: SETUP_DI_DRIVER_TYPE = SETUP_DI_DRIVER_TYPE(2);
pub const SPDIT_NODRIVER: u32 = 0;
pub const SPDRP_ADDRESS: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(28);
pub const SPDRP_BASE_CONTAINERID: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(36);
pub const SPDRP_BUSNUMBER: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(21);
pub const SPDRP_BUSTYPEGUID: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(19);
pub const SPDRP_CAPABILITIES: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(15);
pub const SPDRP_CHARACTERISTICS: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(27);
pub const SPDRP_CLASS: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(7);
pub const SPDRP_CLASSGUID: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(8);
pub const SPDRP_COMPATIBLEIDS: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(2);
pub const SPDRP_CONFIGFLAGS: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(10);
pub const SPDRP_DEVICEDESC: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(0);
pub const SPDRP_DEVICE_POWER_DATA: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(30);
pub const SPDRP_DEVTYPE: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(25);
pub const SPDRP_DRIVER: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(9);
pub const SPDRP_ENUMERATOR_NAME: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(22);
pub const SPDRP_EXCLUSIVE: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(26);
pub const SPDRP_FRIENDLYNAME: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(12);
pub const SPDRP_HARDWAREID: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(1);
pub const SPDRP_INSTALL_STATE: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(34);
pub const SPDRP_LEGACYBUSTYPE: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(20);
pub const SPDRP_LOCATION_INFORMATION: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(13);
pub const SPDRP_LOCATION_PATHS: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(35);
pub const SPDRP_LOWERFILTERS: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(18);
pub const SPDRP_MAXIMUM_PROPERTY: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(37);
pub const SPDRP_MFG: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(11);
pub const SPDRP_PHYSICAL_DEVICE_OBJECT_NAME: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(14);
pub const SPDRP_REMOVAL_POLICY: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(31);
pub const SPDRP_REMOVAL_POLICY_HW_DEFAULT: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(32);
pub const SPDRP_REMOVAL_POLICY_OVERRIDE: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(33);
pub const SPDRP_SECURITY: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(23);
pub const SPDRP_SECURITY_SDS: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(24);
pub const SPDRP_SERVICE: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(4);
pub const SPDRP_UI_NUMBER: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(16);
pub const SPDRP_UI_NUMBER_DESC_FORMAT: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(29);
pub const SPDRP_UNUSED0: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(3);
pub const SPDRP_UNUSED1: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(5);
pub const SPDRP_UNUSED2: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(6);
pub const SPDRP_UPPERFILTERS: SETUP_DI_REGISTRY_PROPERTY = SETUP_DI_REGISTRY_PROPERTY(17);
...
pub const SPOST_NONE: OEM_SOURCE_MEDIA_TYPE = OEM_SOURCE_MEDIA_TYPE(0);
pub const SPOST_PATH: OEM_SOURCE_MEDIA_TYPE = OEM_SOURCE_MEDIA_TYPE(1);
pub const SPOST_URL: OEM_SOURCE_MEDIA_TYPE = OEM_SOURCE_MEDIA_TYPE(2);
...
pub const SPQ_SCAN_ACTIVATE_DRP: SETUPSCANFILEQUEUE_FLAGS = SETUPSCANFILEQUEUE_FLAGS(1024);
pub const SPQ_SCAN_FILE_COMPARISON: SETUPSCANFILEQUEUE_FLAGS = SETUPSCANFILEQUEUE_FLAGS(512);
pub const SPQ_SCAN_FILE_PRESENCE: SETUPSCANFILEQUEUE_FLAGS = SETUPSCANFILEQUEUE_FLAGS(1);
pub const SPQ_SCAN_FILE_PRESENCE_WITHOUT_SOURCE: SETUPSCANFILEQUEUE_FLAGS = SETUPSCANFILEQUEUE_FLAGS(256);
pub const SPQ_SCAN_FILE_VALIDITY: SETUPSCANFILEQUEUE_FLAGS = SETUPSCANFILEQUEUE_FLAGS(2);
pub const SPQ_SCAN_INFORM_USER: SETUPSCANFILEQUEUE_FLAGS = SETUPSCANFILEQUEUE_FLAGS(16);
pub const SPQ_SCAN_PRUNE_COPY_QUEUE: SETUPSCANFILEQUEUE_FLAGS = SETUPSCANFILEQUEUE_FLAGS(32);
pub const SPQ_SCAN_PRUNE_DELREN: SETUPSCANFILEQUEUE_FLAGS = SETUPSCANFILEQUEUE_FLAGS(128);
pub const SPQ_SCAN_USE_CALLBACK: SETUPSCANFILEQUEUE_FLAGS = SETUPSCANFILEQUEUE_FLAGS(4);
pub const SPQ_SCAN_USE_CALLBACKEX: SETUPSCANFILEQUEUE_FLAGS = SETUPSCANFILEQUEUE_FLAGS(8);
pub const SPQ_SCAN_USE_CALLBACK_SIGNERINFO: SETUPSCANFILEQUEUE_FLAGS = SETUPSCANFILEQUEUE_FLAGS(64);
pub const SPQ_SCAN_USE_OEM_CATALOGS: SETUPSCANFILEQUEUE_FLAGS = SETUPSCANFILEQUEUE_FLAGS(2048);
...
pub const SPSVCINST_ASSOCSERVICE: SPSVCINST_FLAGS = SPSVCINST_FLAGS(2);
pub const SPSVCINST_CLOBBER_SECURITY: SPSVCINST_FLAGS = SPSVCINST_FLAGS(1024);
pub const SPSVCINST_DELETEEVENTLOGENTRY: SPSVCINST_FLAGS = SPSVCINST_FLAGS(4);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const SPSVCINST_NOCLOBBER_BOOTFLAGS: SPSVCINST_FLAGS = SPSVCINST_FLAGS(262144);
pub const SPSVCINST_NOCLOBBER_DELAYEDAUTOSTART: SPSVCINST_FLAGS = SPSVCINST_FLAGS(32768);
pub const SPSVCINST_NOCLOBBER_DEPENDENCIES: SPSVCINST_FLAGS = SPSVCINST_FLAGS(128);
pub const SPSVCINST_NOCLOBBER_DESCRIPTION: SPSVCINST_FLAGS = SPSVCINST_FLAGS(256);
pub const SPSVCINST_NOCLOBBER_DISPLAYNAME: SPSVCINST_FLAGS = SPSVCINST_FLAGS(8);
pub const SPSVCINST_NOCLOBBER_ERRORCONTROL: SPSVCINST_FLAGS = SPSVCINST_FLAGS(32);
pub const SPSVCINST_NOCLOBBER_FAILUREACTIONS: SPSVCINST_FLAGS = SPSVCINST_FLAGS(131072);
pub const SPSVCINST_NOCLOBBER_LOADORDERGROUP: SPSVCINST_FLAGS = SPSVCINST_FLAGS(64);
pub const SPSVCINST_NOCLOBBER_REQUIREDPRIVILEGES: SPSVCINST_FLAGS = SPSVCINST_FLAGS(4096);
pub const SPSVCINST_NOCLOBBER_SERVICESIDTYPE: SPSVCINST_FLAGS = SPSVCINST_FLAGS(16384);
pub const SPSVCINST_NOCLOBBER_STARTTYPE: SPSVCINST_FLAGS = SPSVCINST_FLAGS(16);
pub const SPSVCINST_NOCLOBBER_TRIGGERS: SPSVCINST_FLAGS = SPSVCINST_FLAGS(8192);
pub const SPSVCINST_STARTSERVICE: SPSVCINST_FLAGS = SPSVCINST_FLAGS(2048);
pub const SPSVCINST_STOPSERVICE: SPSVCINST_FLAGS = SPSVCINST_FLAGS(512);
pub const SPSVCINST_TAGTOFRONT: SPSVCINST_FLAGS = SPSVCINST_FLAGS(1);
pub const SPSVCINST_UNIQUE_NAME: SPSVCINST_FLAGS = SPSVCINST_FLAGS(65536);
...
pub const SP_COPY_ALREADYDECOMP: SP_COPY_STYLE = SP_COPY_STYLE(4194304);
pub const SP_COPY_DELETESOURCE: SP_COPY_STYLE = SP_COPY_STYLE(1);
pub const SP_COPY_FORCE_IN_USE: SP_COPY_STYLE = SP_COPY_STYLE(512);
pub const SP_COPY_FORCE_NEWER: SP_COPY_STYLE = SP_COPY_STYLE(8192);
pub const SP_COPY_FORCE_NOOVERWRITE: SP_COPY_STYLE = SP_COPY_STYLE(4096);
pub const SP_COPY_HARDLINK: SP_COPY_STYLE = SP_COPY_STYLE(268435456);
pub const SP_COPY_INBOX_INF: SP_COPY_STYLE = SP_COPY_STYLE(134217728);
pub const SP_COPY_IN_USE_NEEDS_REBOOT: SP_COPY_STYLE = SP_COPY_STYLE(256);
pub const SP_COPY_IN_USE_TRY_RENAME: SP_COPY_STYLE = SP_COPY_STYLE(67108864);
pub const SP_COPY_LANGUAGEAWARE: SP_COPY_STYLE = SP_COPY_STYLE(32);
pub const SP_COPY_NEWER: SP_COPY_STYLE = SP_COPY_STYLE(4);
pub const SP_COPY_NEWER_ONLY: SP_COPY_STYLE = SP_COPY_STYLE(65536);
pub const SP_COPY_NEWER_OR_SAME: SP_COPY_STYLE = SP_COPY_STYLE(4);
pub const SP_COPY_NOBROWSE: SP_COPY_STYLE = SP_COPY_STYLE(32768);
pub const SP_COPY_NODECOMP: SP_COPY_STYLE = SP_COPY_STYLE(16);
pub const SP_COPY_NOOVERWRITE: SP_COPY_STYLE = SP_COPY_STYLE(8);
pub const SP_COPY_NOPRUNE: SP_COPY_STYLE = SP_COPY_STYLE(1048576);
pub const SP_COPY_NOSKIP: SP_COPY_STYLE = SP_COPY_STYLE(1024);
pub const SP_COPY_OEMINF_CATALOG_ONLY: SP_COPY_STYLE = SP_COPY_STYLE(262144);
pub const SP_COPY_OEM_F6_INF: SP_COPY_STYLE = SP_COPY_STYLE(2097152);
pub const SP_COPY_PNPLOCKED: SP_COPY_STYLE = SP_COPY_STYLE(33554432);
pub const SP_COPY_REPLACEONLY: SP_COPY_STYLE = SP_COPY_STYLE(2);
pub const SP_COPY_REPLACE_BOOT_FILE: SP_COPY_STYLE = SP_COPY_STYLE(524288);
pub const SP_COPY_RESERVED: SP_COPY_STYLE = SP_COPY_STYLE(131072);
pub const SP_COPY_SOURCEPATH_ABSOLUTE: SP_COPY_STYLE = SP_COPY_STYLE(128);
pub const SP_COPY_SOURCE_ABSOLUTE: SP_COPY_STYLE = SP_COPY_STYLE(64);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const SP_COPY_WARNIFSKIP: SP_COPY_STYLE = SP_COPY_STYLE(16384);
pub const SP_COPY_WINDOWS_SIGNED: SP_COPY_STYLE = SP_COPY_STYLE(16777216);
#[repr(C, packed(1))]
#[cfg(target_arch = "x86")]
#[derive(Clone, Copy)]
...
pub const SetupFileLogChecksum: SetupFileLogInfo = SetupFileLogInfo(1);
pub const SetupFileLogDiskDescription: SetupFileLogInfo = SetupFileLogInfo(3);
pub const SetupFileLogDiskTagfile: SetupFileLogInfo = SetupFileLogInfo(2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct SetupFileLogInfo(pub i32);
pub const SetupFileLogMax: SetupFileLogInfo = SetupFileLogInfo(5);
pub const SetupFileLogOtherInfo: SetupFileLogInfo = SetupFileLogInfo(4);
pub const SetupFileLogSourceFilename: SetupFileLogInfo = SetupFileLogInfo(0);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub const fDD_BYTE: DD_FLAGS = DD_FLAGS(0);
pub const fDD_BYTE_AND_WORD: DD_FLAGS = DD_FLAGS(3);
pub const fDD_BusMaster: DD_FLAGS = DD_FLAGS(4);
pub const fDD_DWORD: DD_FLAGS = DD_FLAGS(2);
pub const fDD_NoBusMaster: DD_FLAGS = DD_FLAGS(0);
pub const fDD_TypeA: DD_FLAGS = DD_FLAGS(8);
pub const fDD_TypeB: DD_FLAGS = DD_FLAGS(16);
pub const fDD_TypeF: DD_FLAGS = DD_FLAGS(24);
pub const fDD_TypeStandard: DD_FLAGS = DD_FLAGS(0);
pub const fDD_WORD: DD_FLAGS = DD_FLAGS(1);
pub const fIOD_10_BIT_DECODE: IOD_DESFLAGS = IOD_DESFLAGS(4);
pub const fIOD_12_BIT_DECODE: IOD_DESFLAGS = IOD_DESFLAGS(8);
pub const fIOD_16_BIT_DECODE: IOD_DESFLAGS = IOD_DESFLAGS(16);
pub const fIOD_DECODE: IOD_DESFLAGS = IOD_DESFLAGS(252);
pub const fIOD_IO: IOD_DESFLAGS = IOD_DESFLAGS(1);
pub const fIOD_Memory: IOD_DESFLAGS = IOD_DESFLAGS(0);
pub const fIOD_PASSIVE_DECODE: IOD_DESFLAGS = IOD_DESFLAGS(64);
pub const fIOD_PORT_BAR: IOD_DESFLAGS = IOD_DESFLAGS(256);
pub const fIOD_POSITIVE_DECODE: IOD_DESFLAGS = IOD_DESFLAGS(32);
pub const fIOD_PortType: IOD_DESFLAGS = IOD_DESFLAGS(1);
pub const fIOD_WINDOW_DECODE: IOD_DESFLAGS = IOD_DESFLAGS(128);
pub const fIRQD_Edge: IRQD_FLAGS = IRQD_FLAGS(2);
pub const fIRQD_Exclusive: IRQD_FLAGS = IRQD_FLAGS(0);
pub const fIRQD_Level: IRQD_FLAGS = IRQD_FLAGS(0);
pub const fIRQD_Level_Bit: IRQD_FLAGS = IRQD_FLAGS(1);
pub const fIRQD_Share: IRQD_FLAGS = IRQD_FLAGS(1);
pub const fIRQD_Share_Bit: IRQD_FLAGS = IRQD_FLAGS(0);
pub const fMD_24: MD_FLAGS = MD_FLAGS(0);
pub const fMD_32: MD_FLAGS = MD_FLAGS(2);
pub const fMD_32_24: MD_FLAGS = MD_FLAGS(2);
pub const fMD_Cacheable: MD_FLAGS = MD_FLAGS(32);
pub const fMD_CombinedWrite: MD_FLAGS = MD_FLAGS(16);
pub const fMD_CombinedWriteAllowed: MD_FLAGS = MD_FLAGS(16);
pub const fMD_CombinedWriteDisallowed: MD_FLAGS = MD_FLAGS(0);
pub const fMD_MEMORY_BAR: MD_FLAGS = MD_FLAGS(128);
pub const fMD_MemoryType: MD_FLAGS = MD_FLAGS(1);
pub const fMD_NonCacheable: MD_FLAGS = MD_FLAGS(0);
pub const fMD_Pref: MD_FLAGS = MD_FLAGS(4);
pub const fMD_PrefetchAllowed: MD_FLAGS = MD_FLAGS(4);
pub const fMD_PrefetchDisallowed: MD_FLAGS = MD_FLAGS(0);
pub const fMD_Prefetchable: MD_FLAGS = MD_FLAGS(4);
pub const fMD_RAM: MD_FLAGS = MD_FLAGS(1);
pub const fMD_ROM: MD_FLAGS = MD_FLAGS(0);
pub const fMD_ReadAllowed: MD_FLAGS = MD_FLAGS(0);
pub const fMD_ReadDisallowed: MD_FLAGS = MD_FLAGS(8);
pub const fMD_Readable: MD_FLAGS = MD_FLAGS(8);
pub const fMD_WINDOW_DECODE: MD_FLAGS = MD_FLAGS(64);
pub const fPCD_ATTRIBUTES_PER_WINDOW: PCD_FLAGS = PCD_FLAGS(32768);
pub const fPCD_IO1_16: PCD_FLAGS = PCD_FLAGS(65536);
pub const fPCD_IO1_SRC_16: PCD_FLAGS = PCD_FLAGS(262144);
pub const fPCD_IO1_WS_16: PCD_FLAGS = PCD_FLAGS(524288);
pub const fPCD_IO1_ZW_8: PCD_FLAGS = PCD_FLAGS(131072);
pub const fPCD_IO2_16: PCD_FLAGS = PCD_FLAGS(1048576);
pub const fPCD_IO2_SRC_16: PCD_FLAGS = PCD_FLAGS(4194304);
pub const fPCD_IO2_WS_16: PCD_FLAGS = PCD_FLAGS(8388608);
pub const fPCD_IO2_ZW_8: PCD_FLAGS = PCD_FLAGS(2097152);
pub const fPCD_IO_16: PCD_FLAGS = PCD_FLAGS(1);
pub const fPCD_IO_8: PCD_FLAGS = PCD_FLAGS(0);
pub const fPCD_IO_SRC_16: PCD_FLAGS = PCD_FLAGS(32);
pub const fPCD_IO_WS_16: PCD_FLAGS = PCD_FLAGS(64);
pub const fPCD_IO_ZW_8: PCD_FLAGS = PCD_FLAGS(16);
pub const fPCD_MEM1_16: PCD_FLAGS = PCD_FLAGS(67108864);
pub const fPCD_MEM1_A: PCD_FLAGS = PCD_FLAGS(4);
pub const fPCD_MEM1_WS_ONE: PCD_FLAGS = PCD_FLAGS(16777216);
pub const fPCD_MEM1_WS_THREE: PCD_FLAGS = PCD_FLAGS(50331648);
pub const fPCD_MEM1_WS_TWO: PCD_FLAGS = PCD_FLAGS(33554432);
pub const fPCD_MEM2_16: PCD_FLAGS = PCD_FLAGS(1073741824);
pub const fPCD_MEM2_A: PCD_FLAGS = PCD_FLAGS(8);
pub const fPCD_MEM2_WS_ONE: PCD_FLAGS = PCD_FLAGS(268435456);
pub const fPCD_MEM2_WS_THREE: PCD_FLAGS = PCD_FLAGS(805306368);
pub const fPCD_MEM2_WS_TWO: PCD_FLAGS = PCD_FLAGS(536870912);
pub const fPCD_MEM_16: PCD_FLAGS = PCD_FLAGS(2);
pub const fPCD_MEM_8: PCD_FLAGS = PCD_FLAGS(0);
pub const fPCD_MEM_A: PCD_FLAGS = PCD_FLAGS(4);
pub const fPCD_MEM_WS_ONE: PCD_FLAGS = PCD_FLAGS(256);
pub const fPCD_MEM_WS_THREE: PCD_FLAGS = PCD_FLAGS(768);
pub const fPCD_MEM_WS_TWO: PCD_FLAGS = PCD_FLAGS(512);
pub const fPMF_AUDIO_ENABLE: PMF_FLAGS = PMF_FLAGS(8);
pub const mDD_BusMaster: DD_FLAGS = DD_FLAGS(4);
pub const mDD_Type: DD_FLAGS = DD_FLAGS(24);
pub const mDD_Width: DD_FLAGS = DD_FLAGS(3);
pub const mIRQD_Edge_Level: IRQD_FLAGS = IRQD_FLAGS(2);
pub const mIRQD_Share: IRQD_FLAGS = IRQD_FLAGS(1);
pub const mMD_32_24: MD_FLAGS = MD_FLAGS(2);
pub const mMD_Cacheable: MD_FLAGS = MD_FLAGS(32);
pub const mMD_CombinedWrite: MD_FLAGS = MD_FLAGS(16);
pub const mMD_MemoryType: MD_FLAGS = MD_FLAGS(1);
pub const mMD_Prefetchable: MD_FLAGS = MD_FLAGS(4);
pub const mMD_Readable: MD_FLAGS = MD_FLAGS(8);
pub const mPCD_IO_8_16: PCD_FLAGS = PCD_FLAGS(1);
pub const mPCD_MEM1_WS: PCD_FLAGS = PCD_FLAGS(50331648);
pub const mPCD_MEM2_WS: PCD_FLAGS = PCD_FLAGS(805306368);
pub const mPCD_MEM_8_16: PCD_FLAGS = PCD_FLAGS(2);
pub const mPCD_MEM_A_C: PCD_FLAGS = PCD_FLAGS(12);
pub const mPCD_MEM_WS: PCD_FLAGS = PCD_FLAGS(768);
