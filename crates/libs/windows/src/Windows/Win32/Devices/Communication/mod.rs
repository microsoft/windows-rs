#[inline]
pub unsafe fn BuildCommDCBA<P0>(lpdef: P0, lpdcb: *mut DCB) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_core::link!("kernel32.dll" "system" fn BuildCommDCBA(lpdef : windows_core::PCSTR, lpdcb : *mut DCB) -> windows_core::BOOL);
    unsafe { BuildCommDCBA(lpdef.param().abi(), lpdcb as _) }
}
#[inline]
pub unsafe fn BuildCommDCBAndTimeoutsA<P0>(lpdef: P0, lpdcb: *mut DCB, lpcommtimeouts: *mut COMMTIMEOUTS) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { BuildCommDCBAndTimeoutsA(lpdef.param().abi(), lpdcb as _, lpcommtimeouts as _) }
}
#[inline]
pub unsafe fn BuildCommDCBAndTimeoutsW<P0>(lpdef: P0, lpdcb: *mut DCB, lpcommtimeouts: *mut COMMTIMEOUTS) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { BuildCommDCBAndTimeoutsW(lpdef.param().abi(), lpdcb as _, lpcommtimeouts as _) }
}
#[inline]
pub unsafe fn BuildCommDCBW<P0>(lpdef: P0, lpdcb: *mut DCB) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("kernel32.dll" "system" fn BuildCommDCBW(lpdef : windows_core::PCWSTR, lpdcb : *mut DCB) -> windows_core::BOOL);
    unsafe { BuildCommDCBW(lpdef.param().abi(), lpdcb as _) }
}
#[inline]
pub unsafe fn ClearCommBreak(hfile: super::super::Foundation::HANDLE) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn ClearCommBreak(hfile : super::super::Foundation:: HANDLE) -> windows_core::BOOL);
    unsafe { ClearCommBreak(hfile) }
}
#[inline]
pub unsafe fn ClearCommError(hfile: super::super::Foundation::HANDLE, lperrors: *mut CLEAR_COMM_ERROR_FLAGS, lpstat: *mut COMSTAT) -> windows_core::BOOL {
    ...
    unsafe { ClearCommError(hfile, lperrors as _, lpstat as _) }
}
#[inline]
pub unsafe fn CommConfigDialogA<P0>(lpszname: P0, hwnd: super::super::Foundation::HWND, lpcc: *mut COMMCONFIG) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { CommConfigDialogA(lpszname.param().abi(), hwnd, lpcc as _) }
}
#[inline]
pub unsafe fn CommConfigDialogW<P0>(lpszname: P0, hwnd: super::super::Foundation::HWND, lpcc: *mut COMMCONFIG) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { CommConfigDialogW(lpszname.param().abi(), hwnd, lpcc as _) }
}
#[inline]
pub unsafe fn EscapeCommFunction(hfile: super::super::Foundation::HANDLE, dwfunc: ESCAPE_COMM_FUNCTION) -> windows_core::BOOL {
    ...
    unsafe { EscapeCommFunction(hfile, dwfunc) }
}
#[inline]
pub unsafe fn GetCommConfig(hcommdev: super::super::Foundation::HANDLE, lpcc: *mut COMMCONFIG, lpdwsize: *mut u32) -> windows_core::BOOL {
    ...
    unsafe { GetCommConfig(hcommdev, lpcc as _, lpdwsize as _) }
}
#[inline]
pub unsafe fn GetCommMask(hfile: super::super::Foundation::HANDLE, lpevtmask: *mut COMM_EVENT_MASK) -> windows_core::BOOL {
    ...
    unsafe { GetCommMask(hfile, lpevtmask as _) }
}
#[inline]
pub unsafe fn GetCommModemStatus(hfile: super::super::Foundation::HANDLE, lpmodemstat: *mut MODEM_STATUS_FLAGS) -> windows_core::BOOL {
    ...
    unsafe { GetCommModemStatus(hfile, lpmodemstat as _) }
}
#[inline]
pub unsafe fn GetCommPorts(lpportnumbers: *mut u32, uportnumberscount: u32, puportnumbersfound: *mut u32) -> u32 {
    ...
    unsafe { GetCommPorts(lpportnumbers as _, uportnumberscount, puportnumbersfound as _) }
}
#[inline]
pub unsafe fn GetCommProperties(hfile: super::super::Foundation::HANDLE, lpcommprop: *mut COMMPROP) -> windows_core::BOOL {
    ...
    unsafe { GetCommProperties(hfile, lpcommprop as _) }
}
#[inline]
pub unsafe fn GetCommState(hfile: super::super::Foundation::HANDLE, lpdcb: *mut DCB) -> windows_core::BOOL {
    ...
    unsafe { GetCommState(hfile, lpdcb as _) }
}
#[inline]
pub unsafe fn GetCommTimeouts(hfile: super::super::Foundation::HANDLE, lpcommtimeouts: *mut COMMTIMEOUTS) -> windows_core::BOOL {
    ...
    unsafe { GetCommTimeouts(hfile, lpcommtimeouts as _) }
}
#[inline]
pub unsafe fn GetDefaultCommConfigA<P0>(lpszname: P0, lpcc: *mut COMMCONFIG, lpdwsize: *mut u32) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    ...
    unsafe { GetDefaultCommConfigA(lpszname.param().abi(), lpcc as _, lpdwsize as _) }
}
#[inline]
pub unsafe fn GetDefaultCommConfigW<P0>(lpszname: P0, lpcc: *mut COMMCONFIG, lpdwsize: *mut u32) -> windows_core::BOOL
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { GetDefaultCommConfigW(lpszname.param().abi(), lpcc as _, lpdwsize as _) }
}
#[inline]
...
#[inline]
pub unsafe fn PurgeComm(hfile: super::super::Foundation::HANDLE, dwflags: PURGE_COMM_FLAGS) -> windows_core::BOOL {
    ...
    unsafe { PurgeComm(hfile, dwflags) }
}
#[inline]
pub unsafe fn SetCommBreak(hfile: super::super::Foundation::HANDLE) -> windows_core::BOOL {
    ...
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    unsafe { SetDefaultCommConfigW(lpszname.param().abi(), lpcc, dwsize) }
}
#[inline]
pub unsafe fn SetupComm(hfile: super::super::Foundation::HANDLE, dwinqueue: u32, dwoutqueue: u32) -> windows_core::BOOL {
    ...
    unsafe { SetupComm(hfile, dwinqueue, dwoutqueue) }
}
#[inline]
pub unsafe fn TransmitCommChar(hfile: super::super::Foundation::HANDLE, cchar: i8) -> windows_core::BOOL {
    windows_core::link!("kernel32.dll" "system" fn TransmitCommChar(hfile : super::super::Foundation:: HANDLE, cchar : i8) -> windows_core::BOOL);
    unsafe { TransmitCommChar(hfile, cchar) }
}
#[cfg(feature = "Win32_System_IO")]
#[inline]
pub unsafe fn WaitCommEvent(hfile: super::super::Foundation::HANDLE, lpevtmask: *mut COMM_EVENT_MASK, lpoverlapped: *mut super::super::System::IO::OVERLAPPED) -> windows_core::BOOL {
    ...
    unsafe { WaitCommEvent(hfile, lpevtmask as _, lpoverlapped as _) }
}
