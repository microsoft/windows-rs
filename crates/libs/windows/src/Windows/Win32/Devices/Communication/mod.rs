    ...
    P1: windows_core::Param<super::super::Foundation::HWND>,
{
    ...
    CommConfigDialogA(lpszname.param().abi(), hwnd.param().abi(), core::mem::transmute(lpcc)).ok()
}
#[inline]
    ...
    P1: windows_core::Param<super::super::Foundation::HWND>,
{
    ...
    CommConfigDialogW(lpszname.param().abi(), hwnd.param().abi(), core::mem::transmute(lpcc)).ok()
}
#[inline]
    ...
    P0: windows_core::Param<super::super::Foundation::HANDLE>,
{
    ...
    EscapeCommFunction(hfile.param().abi(), core::mem::transmute(dwfunc)).ok()
}
#[inline]
    ...
    P0: windows_core::Param<super::super::Foundation::HANDLE>,
{
    ...
    GetCommConfig(hcommdev.param().abi(), core::mem::transmute(lpcc.unwrap_or(core::ptr::null_mut())), core::mem::transmute(lpdwsize)).ok()
}
#[inline]
    ...
    P0: windows_core::Param<super::super::Foundation::HANDLE>,
{
    ...
    GetCommMask(hfile.param().abi(), core::mem::transmute(lpevtmask)).ok()
}
#[inline]
    ...
    P0: windows_core::Param<super::super::Foundation::HANDLE>,
{
    ...
    GetCommModemStatus(hfile.param().abi(), core::mem::transmute(lpmodemstat)).ok()
}
#[inline]
    ...
    P0: windows_core::Param<super::super::Foundation::HANDLE>,
{
    ...
    GetCommProperties(hfile.param().abi(), core::mem::transmute(lpcommprop)).ok()
}
#[inline]
    ...
    P0: windows_core::Param<super::super::Foundation::HANDLE>,
{
    ...
    GetCommState(hfile.param().abi(), core::mem::transmute(lpdcb)).ok()
}
#[inline]
    ...
    P0: windows_core::Param<super::super::Foundation::HANDLE>,
{
    ...
    GetCommTimeouts(hfile.param().abi(), core::mem::transmute(lpcommtimeouts)).ok()
}
#[inline]
    ...
    P0: windows_core::Param<super::super::Foundation::HANDLE>,
{
    ...
    PurgeComm(hfile.param().abi(), core::mem::transmute(dwflags)).ok()
}
#[inline]
    ...
    P0: windows_core::Param<super::super::Foundation::HANDLE>,
{
    ...
    SetCommConfig(hcommdev.param().abi(), core::mem::transmute(lpcc), core::mem::transmute(dwsize)).ok()
}
#[inline]
    ...
    P0: windows_core::Param<super::super::Foundation::HANDLE>,
{
    ...
    SetCommMask(hfile.param().abi(), core::mem::transmute(dwevtmask)).ok()
}
#[inline]
    ...
    P0: windows_core::Param<super::super::Foundation::HANDLE>,
{
    ...
    SetCommState(hfile.param().abi(), core::mem::transmute(lpdcb)).ok()
}
#[inline]
    ...
    P0: windows_core::Param<super::super::Foundation::HANDLE>,
{
    ...
    SetCommTimeouts(hfile.param().abi(), core::mem::transmute(lpcommtimeouts)).ok()
}
#[inline]
    ...
    P0: windows_core::Param<super::super::Foundation::HANDLE>,
{
    ...
    SetupComm(hfile.param().abi(), core::mem::transmute(dwinqueue), core::mem::transmute(dwoutqueue)).ok()
}
#[inline]
    ...
    P0: windows_core::Param<super::super::Foundation::HANDLE>,
{
    ...
    TransmitCommChar(hfile.param().abi(), core::mem::transmute(cchar)).ok()
}
    ...
    P0: windows_core::Param<super::super::Foundation::HANDLE>,
{
    ...
    WaitCommEvent(hfile.param().abi(), core::mem::transmute(lpevtmask), core::mem::transmute(lpoverlapped.unwrap_or(core::ptr::null_mut()))).ok()
}
