...
pub trait ITAddress2_Impl: Sized + ITAddress_Impl {
    ...
    fn DeviceSpecificVariant(&self, pcall: ::core::option::Option<&ITCallInfo>, vardevspecificbytearray: &::windows_core::VARIANT) -> ::windows_core::Result<()>;
...
pub trait ITPhone_Impl: Sized + super::super::System::Com::IDispatch_Impl {
    ...
    fn get_Terminals(&self, paddress: ::core::option::Option<&ITAddress>) -> ::windows_core::Result<::windows_core::VARIANT>;
