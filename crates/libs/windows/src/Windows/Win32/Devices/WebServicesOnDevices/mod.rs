...
#[inline]
pub unsafe fn WSDCreateDeviceHost<P0, P1>(pszlocalid: P0, pcontext: P1) -> Result<IWSDDeviceHost, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<IWSDXMLContext>,
{
    windows_link::link!("wsdapi.dll" "system" fn WSDCreateDeviceHost(pszlocalid : windows_core::PCWSTR, pcontext : * mut core::ffi::c_void, ppdevicehost : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
...
#[inline]
pub unsafe fn WSDCreateDeviceHost2<P0, P1>(pszlocalid: P0, pcontext: P1, pconfigparams: Option<&[WSD_CONFIG_PARAM]>) -> Result<IWSDDeviceHost, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<IWSDXMLContext>,
{
    windows_link::link!("wsdapi.dll" "system" fn WSDCreateDeviceHost2(pszlocalid : windows_core::PCWSTR, pcontext : * mut core::ffi::c_void, pconfigparams : *const WSD_CONFIG_PARAM, dwconfigparamcount : u32, ppdevicehost : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDCreateDeviceHostAdvanced<P0, P1>(pszlocalid: P0, pcontext: P1, pphostaddresses: Option<&[Option<IWSDAddress>]>) -> Result<IWSDDeviceHost, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<IWSDXMLContext>,
{
    windows_link::link!("wsdapi.dll" "system" fn WSDCreateDeviceHostAdvanced(pszlocalid : windows_core::PCWSTR, pcontext : * mut core::ffi::c_void, pphostaddresses : *const * mut core::ffi::c_void, dwhostaddresscount : u32, ppdevicehost : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDCreateDeviceProxy<P0, P1, P2>(pszdeviceid: P0, pszlocalid: P1, pcontext: P2) -> Result<IWSDDeviceProxy, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<IWSDXMLContext>,
{
    windows_link::link!("wsdapi.dll" "system" fn WSDCreateDeviceProxy(pszdeviceid : windows_core::PCWSTR, pszlocalid : windows_core::PCWSTR, pcontext : * mut core::ffi::c_void, ppdeviceproxy : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDCreateDeviceProxy2<P0, P1, P2>(pszdeviceid: P0, pszlocalid: P1, pcontext: P2, pconfigparams: Option<&[WSD_CONFIG_PARAM]>) -> Result<IWSDDeviceProxy, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<IWSDXMLContext>,
{
    windows_link::link!("wsdapi.dll" "system" fn WSDCreateDeviceProxy2(pszdeviceid : windows_core::PCWSTR, pszlocalid : windows_core::PCWSTR, pcontext : * mut core::ffi::c_void, pconfigparams : *const WSD_CONFIG_PARAM, dwconfigparamcount : u32, ppdeviceproxy : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDCreateDeviceProxyAdvanced<P0, P1, P2, P3>(pszdeviceid: P0, pdeviceaddress: P1, pszlocalid: P2, pcontext: P3) -> Result<IWSDDeviceProxy, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
...
{
    windows_link::link!("wsdapi.dll" "system" fn WSDCreateDeviceProxyAdvanced(pszdeviceid : windows_core::PCWSTR, pdeviceaddress : * mut core::ffi::c_void, pszlocalid : windows_core::PCWSTR, pcontext : * mut core::ffi::c_void, ppdeviceproxy : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDCreateDiscoveryProvider<P0>(pcontext: P0) -> Result<IWSDiscoveryProvider, windows_result::HRESULT>
where
    P0: windows_core::Param<IWSDXMLContext>,
{
    windows_link::link!("wsdapi.dll" "system" fn WSDCreateDiscoveryProvider(pcontext : * mut core::ffi::c_void, ppprovider : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDCreateDiscoveryProvider2<P0>(pcontext: P0, pconfigparams: Option<&[WSD_CONFIG_PARAM]>) -> Result<IWSDiscoveryProvider, windows_result::HRESULT>
where
    P0: windows_core::Param<IWSDXMLContext>,
{
    windows_link::link!("wsdapi.dll" "system" fn WSDCreateDiscoveryProvider2(pcontext : * mut core::ffi::c_void, pconfigparams : *const WSD_CONFIG_PARAM, dwconfigparamcount : u32, ppprovider : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDCreateDiscoveryPublisher<P0>(pcontext: P0) -> Result<IWSDiscoveryPublisher, windows_result::HRESULT>
where
    P0: windows_core::Param<IWSDXMLContext>,
{
    windows_link::link!("wsdapi.dll" "system" fn WSDCreateDiscoveryPublisher(pcontext : * mut core::ffi::c_void, pppublisher : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDCreateDiscoveryPublisher2<P0>(pcontext: P0, pconfigparams: Option<&[WSD_CONFIG_PARAM]>) -> Result<IWSDiscoveryPublisher, windows_result::HRESULT>
where
    P0: windows_core::Param<IWSDXMLContext>,
{
    windows_link::link!("wsdapi.dll" "system" fn WSDCreateDiscoveryPublisher2(pcontext : * mut core::ffi::c_void, pconfigparams : *const WSD_CONFIG_PARAM, dwconfigparamcount : u32, pppublisher : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDCreateHttpAddress() -> Result<IWSDHttpAddress, windows_result::HRESULT> {
    windows_link::link!("wsdapi.dll" "system" fn WSDCreateHttpAddress(ppaddress : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDCreateHttpMessageParameters() -> Result<IWSDHttpMessageParameters, windows_result::HRESULT> {
    windows_link::link!("wsdapi.dll" "system" fn WSDCreateHttpMessageParameters(pptxparams : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDCreateOutboundAttachment() -> Result<IWSDOutboundAttachment, windows_result::HRESULT> {
    windows_link::link!("wsdapi.dll" "system" fn WSDCreateOutboundAttachment(ppattachment : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDCreateUdpAddress() -> Result<IWSDUdpAddress, windows_result::HRESULT> {
    windows_link::link!("wsdapi.dll" "system" fn WSDCreateUdpAddress(ppaddress : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDCreateUdpMessageParameters() -> Result<IWSDUdpMessageParameters, windows_result::HRESULT> {
    windows_link::link!("wsdapi.dll" "system" fn WSDCreateUdpMessageParameters(pptxparams : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDGenerateFault<P0, P1, P2, P3, P4>(pszcode: P0, pszsubcode: P1, pszreason: P2, pszdetail: P3, pcontext: P4) -> Result<*mut WSD_SOAP_FAULT, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
...
{
    windows_link::link!("wsdapi.dll" "system" fn WSDGenerateFault(pszcode : windows_core::PCWSTR, pszsubcode : windows_core::PCWSTR, pszreason : windows_core::PCWSTR, pszdetail : windows_core::PCWSTR, pcontext : * mut core::ffi::c_void, ppfault : *mut *mut WSD_SOAP_FAULT) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDGenerateFaultEx<P3>(pcode: *const WSDXML_NAME, psubcode: Option<*const WSDXML_NAME>, preasons: *const WSD_LOCALIZED_STRING_LIST, pszdetail: P3) -> Result<*mut WSD_SOAP_FAULT, windows_result::HRESULT>
where
    P3: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wsdapi.dll" "system" fn WSDGenerateFaultEx(pcode : *const WSDXML_NAME, psubcode : *const WSDXML_NAME, preasons : *const WSD_LOCALIZED_STRING_LIST, pszdetail : windows_core::PCWSTR, ppfault : *mut *mut WSD_SOAP_FAULT) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDGetConfigurationOption(dwoption: u32, pvoid: *mut core::ffi::c_void, cboutbuffer: u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wsdapi.dll" "system" fn WSDGetConfigurationOption(dwoption : u32, pvoid : *mut core::ffi::c_void, cboutbuffer : u32) -> windows_core::HRESULT);
    unsafe { WSDGetConfigurationOption(dwoption, pvoid as _, cboutbuffer).ok() }
}
#[inline]
pub unsafe fn WSDSetConfigurationOption(dwoption: u32, pvoid: *const core::ffi::c_void, cbinbuffer: u32) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wsdapi.dll" "system" fn WSDSetConfigurationOption(dwoption : u32, pvoid : *const core::ffi::c_void, cbinbuffer : u32) -> windows_core::HRESULT);
    unsafe { WSDSetConfigurationOption(dwoption, pvoid, cbinbuffer).ok() }
}
#[inline]
pub unsafe fn WSDUriDecode(source: &[u16], destout: *mut windows_core::PWSTR, cchdestout: Option<*mut u32>) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wsdapi.dll" "system" fn WSDUriDecode(source : windows_core::PCWSTR, cchsource : u32, destout : *mut windows_core::PWSTR, cchdestout : *mut u32) -> windows_core::HRESULT);
...
#[inline]
pub unsafe fn WSDUriEncode(source: &[u16], destout: *mut windows_core::PWSTR, cchdestout: Option<*mut u32>) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wsdapi.dll" "system" fn WSDUriEncode(source : windows_core::PCWSTR, cchsource : u32, destout : *mut windows_core::PWSTR, cchdestout : *mut u32) -> windows_core::HRESULT);
...
#[inline]
pub unsafe fn WSDXMLAddChild(pparent: *mut WSDXML_ELEMENT, pchild: *mut WSDXML_ELEMENT) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wsdapi.dll" "system" fn WSDXMLAddChild(pparent : *mut WSDXML_ELEMENT, pchild : *mut WSDXML_ELEMENT) -> windows_core::HRESULT);
    unsafe { WSDXMLAddChild(pparent as _, pchild as _).ok() }
}
#[inline]
pub unsafe fn WSDXMLAddSibling(pfirst: *mut WSDXML_ELEMENT, psecond: *mut WSDXML_ELEMENT) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wsdapi.dll" "system" fn WSDXMLAddSibling(pfirst : *mut WSDXML_ELEMENT, psecond : *mut WSDXML_ELEMENT) -> windows_core::HRESULT);
    unsafe { WSDXMLAddSibling(pfirst as _, psecond as _).ok() }
}
#[inline]
pub unsafe fn WSDXMLBuildAnyForSingleElement<P1>(pelementname: *mut WSDXML_NAME, psztext: P1, ppany: *mut *mut WSDXML_ELEMENT) -> Result<(), windows_result::HRESULT>
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wsdapi.dll" "system" fn WSDXMLBuildAnyForSingleElement(pelementname : *mut WSDXML_NAME, psztext : windows_core::PCWSTR, ppany : *mut *mut WSDXML_ELEMENT) -> windows_core::HRESULT);
    unsafe { WSDXMLBuildAnyForSingleElement(pelementname as _, psztext.param().abi(), ppany as _).ok() }
}
#[inline]
pub unsafe fn WSDXMLCleanupElement(pany: *mut WSDXML_ELEMENT) -> Result<(), windows_result::HRESULT> {
    windows_link::link!("wsdapi.dll" "system" fn WSDXMLCleanupElement(pany : *mut WSDXML_ELEMENT) -> windows_core::HRESULT);
    unsafe { WSDXMLCleanupElement(pany as _).ok() }
}
#[inline]
pub unsafe fn WSDXMLCreateContext() -> Result<IWSDXMLContext, windows_result::HRESULT> {
    windows_link::link!("wsdapi.dll" "system" fn WSDXMLCreateContext(ppcontext : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDXMLGetNameFromBuiltinNamespace<P0, P1>(psznamespace: P0, pszname: P1) -> Result<*mut WSDXML_NAME, windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wsdapi.dll" "system" fn WSDXMLGetNameFromBuiltinNamespace(psznamespace : windows_core::PCWSTR, pszname : windows_core::PCWSTR, ppname : *mut *mut WSDXML_NAME) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn WSDXMLGetValueFromAny<P0, P1>(psznamespace: P0, pszname: P1, pany: *mut WSDXML_ELEMENT, ppszvalue: *mut windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("wsdapi.dll" "system" fn WSDXMLGetValueFromAny(psznamespace : windows_core::PCWSTR, pszname : windows_core::PCWSTR, pany : *mut WSDXML_ELEMENT, ppszvalue : *mut windows_core::PCWSTR) -> windows_core::HRESULT);
...
impl IWSDAddress {
    pub unsafe fn Serialize(&self, pszbuffer: &mut [u16], fsafe: bool) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn Deserialize<P0>(&self, pszbuffer: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IWSDAddress_Impl: windows_core::IUnknownImpl {
    fn Serialize(&self, pszbuffer: windows_core::PWSTR, cchlength: u32, fsafe: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn Deserialize(&self, pszbuffer: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
...
impl IWSDAsyncCallback {
    pub unsafe fn AsyncOperationComplete<P0, P1>(&self, pasyncresult: P0, pasyncstate: P1) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IWSDAsyncCallback_Impl: windows_core::IUnknownImpl {
    fn AsyncOperationComplete(&self, pasyncresult: windows_core::Ref<'_, IWSDAsyncResult>, pasyncstate: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
}
...
impl IWSDAsyncResult {
    pub unsafe fn SetCallback<P0, P1>(&self, pcallback: P0, pasyncstate: P1) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn SetWaitHandle(&self, hwaithandle: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetWaitHandle)(windows_core::Interface::as_raw(self), hwaithandle).ok() }
    }
    pub unsafe fn HasCompleted(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).HasCompleted)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn GetAsyncState(&self) -> Result<windows_core::IUnknown, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetEvent(&self, pevent: *mut WSD_EVENT) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).GetEvent)(windows_core::Interface::as_raw(self), core::mem::transmute(pevent)).ok() }
    }
    pub unsafe fn GetEndpointProxy(&self) -> Result<IWSDEndpointProxy, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWSDAsyncResult_Impl: windows_core::IUnknownImpl {
    fn SetCallback(&self, pcallback: windows_core::Ref<'_, IWSDAsyncCallback>, pasyncstate: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn SetWaitHandle(&self, hwaithandle: super::super::Foundation::HANDLE) -> Result<(), windows_result::HRESULT>;
    fn HasCompleted(&self) -> Result<(), windows_result::HRESULT>;
    fn GetAsyncState(&self) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
    fn Abort(&self) -> Result<(), windows_result::HRESULT>;
    fn GetEvent(&self, pevent: *mut WSD_EVENT) -> Result<(), windows_result::HRESULT>;
    fn GetEndpointProxy(&self) -> Result<IWSDEndpointProxy, windows_result::HRESULT>;
}
...
impl IWSDDeviceHost {
    pub unsafe fn Init<P0, P1>(&self, pszlocalid: P0, pcontext: P1, pphostaddresses: Option<&[Option<IWSDAddress>]>) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<IWSDXMLContext>,
    {
    ...
    pub unsafe fn Start<P2>(&self, ullinstanceid: u64, pscopelist: *const WSD_URI_LIST, pnotificationsink: P2) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Terminate(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Terminate)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn RegisterPortType(&self, pporttype: *const WSD_PORT_TYPE) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).RegisterPortType)(windows_core::Interface::as_raw(self), pporttype).ok() }
    }
    pub unsafe fn SetMetadata(&self, pthismodelmetadata: *const WSD_THIS_MODEL_METADATA, pthisdevicemetadata: *const WSD_THIS_DEVICE_METADATA, phostmetadata: Option<*const WSD_HOST_METADATA>, pcustommetadata: Option<*const WSD_METADATA_SECTION_LIST>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn RegisterService<P0, P1>(&self, pszserviceid: P0, pservice: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::IUnknown>,
    {
    ...
    pub unsafe fn RetireService<P0>(&self, pszserviceid: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).RetireService)(windows_core::Interface::as_raw(self), pszserviceid.param().abi()).ok() }
    }
    pub unsafe fn AddDynamicService<P0, P1, P5>(&self, pszserviceid: P0, pszendpointaddress: P1, pporttype: Option<*const WSD_PORT_TYPE>, pportname: Option<*const WSDXML_NAME>, pany: Option<*const WSDXML_ELEMENT>, pservice: P5) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn RemoveDynamicService<P0>(&self, pszserviceid: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetServiceDiscoverable<P0>(&self, pszserviceid: P0, fdiscoverable: bool) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SignalEvent<P0>(&self, pszserviceid: P0, pbody: Option<*const core::ffi::c_void>, poperation: *const WSD_OPERATION) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IWSDDeviceHost_Impl: windows_core::IUnknownImpl {
    fn Init(&self, pszlocalid: &windows_core::PCWSTR, pcontext: windows_core::Ref<'_, IWSDXMLContext>, pphostaddresses: *const Option<IWSDAddress>, dwhostaddresscount: u32) -> Result<(), windows_result::HRESULT>;
    fn Start(&self, ullinstanceid: u64, pscopelist: *const WSD_URI_LIST, pnotificationsink: windows_core::Ref<'_, IWSDDeviceHostNotify>) -> Result<(), windows_result::HRESULT>;
    fn Stop(&self) -> Result<(), windows_result::HRESULT>;
    fn Terminate(&self) -> Result<(), windows_result::HRESULT>;
    fn RegisterPortType(&self, pporttype: *const WSD_PORT_TYPE) -> Result<(), windows_result::HRESULT>;
    fn SetMetadata(&self, pthismodelmetadata: *const WSD_THIS_MODEL_METADATA, pthisdevicemetadata: *const WSD_THIS_DEVICE_METADATA, phostmetadata: *const WSD_HOST_METADATA, pcustommetadata: *const WSD_METADATA_SECTION_LIST) -> Result<(), windows_result::HRESULT>;
    fn RegisterService(&self, pszserviceid: &windows_core::PCWSTR, pservice: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn RetireService(&self, pszserviceid: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn AddDynamicService(&self, pszserviceid: &windows_core::PCWSTR, pszendpointaddress: &windows_core::PCWSTR, pporttype: *const WSD_PORT_TYPE, pportname: *const WSDXML_NAME, pany: *const WSDXML_ELEMENT, pservice: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn RemoveDynamicService(&self, pszserviceid: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn SetServiceDiscoverable(&self, pszserviceid: &windows_core::PCWSTR, fdiscoverable: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn SignalEvent(&self, pszserviceid: &windows_core::PCWSTR, pbody: *const core::ffi::c_void, poperation: *const WSD_OPERATION) -> Result<(), windows_result::HRESULT>;
}
...
impl IWSDDeviceHostNotify {
    pub unsafe fn GetService<P0>(&self, pszserviceid: P0) -> Result<windows_core::IUnknown, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
...
pub trait IWSDDeviceHostNotify_Impl: windows_core::IUnknownImpl {
    fn GetService(&self, pszserviceid: &windows_core::PCWSTR) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
}
...
impl IWSDDeviceProxy {
    pub unsafe fn Init<P0, P1, P2, P3, P4>(&self, pszdeviceid: P0, pdeviceaddress: P1, pszlocalid: P2, pcontext: P3, psponsor: P4) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<IWSDAddress>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn BeginGetMetadata(&self) -> Result<IWSDAsyncResult, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetServiceProxyByType(&self, ptype: *const WSDXML_NAME) -> Result<IWSDServiceProxy, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWSDDeviceProxy_Impl: windows_core::IUnknownImpl {
    fn Init(&self, pszdeviceid: &windows_core::PCWSTR, pdeviceaddress: windows_core::Ref<'_, IWSDAddress>, pszlocalid: &windows_core::PCWSTR, pcontext: windows_core::Ref<'_, IWSDXMLContext>, psponsor: windows_core::Ref<'_, IWSDDeviceProxy>) -> Result<(), windows_result::HRESULT>;
    fn BeginGetMetadata(&self) -> Result<IWSDAsyncResult, windows_result::HRESULT>;
    fn EndGetMetadata(&self, presult: windows_core::Ref<'_, IWSDAsyncResult>) -> Result<(), windows_result::HRESULT>;
    fn GetHostMetadata(&self) -> Result<*mut WSD_HOST_METADATA, windows_result::HRESULT>;
    fn GetThisModelMetadata(&self) -> Result<*mut WSD_THIS_MODEL_METADATA, windows_result::HRESULT>;
    fn GetThisDeviceMetadata(&self) -> Result<*mut WSD_THIS_DEVICE_METADATA, windows_result::HRESULT>;
    fn GetAllMetadata(&self) -> Result<*mut WSD_METADATA_SECTION_LIST, windows_result::HRESULT>;
    fn GetServiceProxyById(&self, pszserviceid: &windows_core::PCWSTR) -> Result<IWSDServiceProxy, windows_result::HRESULT>;
    fn GetServiceProxyByType(&self, ptype: *const WSDXML_NAME) -> Result<IWSDServiceProxy, windows_result::HRESULT>;
    fn GetEndpointProxy(&self) -> Result<IWSDEndpointProxy, windows_result::HRESULT>;
}
...
impl IWSDEndpointProxy {
    pub unsafe fn SendOneWayRequest(&self, pbody: *const core::ffi::c_void, poperation: *const WSD_OPERATION) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SendOneWayRequest)(windows_core::Interface::as_raw(self), pbody, poperation).ok() }
    }
    pub unsafe fn SendTwoWayRequest(&self, pbody: *const core::ffi::c_void, poperation: *const WSD_OPERATION, presponsecontext: Option<*const WSD_SYNCHRONOUS_RESPONSE_CONTEXT>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SendTwoWayRequestAsync<P2, P3>(&self, pbody: *const core::ffi::c_void, poperation: *const WSD_OPERATION, pasyncstate: P2, pcallback: P3) -> Result<IWSDAsyncResult, windows_result::HRESULT>
    where
    ...
    pub unsafe fn AbortAsyncOperation<P0>(&self, pasyncresult: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IWSDAsyncResult>,
    {
    ...
    pub unsafe fn ProcessFault(&self, pfault: *const WSD_SOAP_FAULT) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).ProcessFault)(windows_core::Interface::as_raw(self), pfault).ok() }
    }
    pub unsafe fn GetErrorInfo(&self) -> Result<windows_core::PCWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetErrorInfo)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetFaultInfo(&self) -> Result<*mut WSD_SOAP_FAULT, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWSDEndpointProxy_Impl: windows_core::IUnknownImpl {
    fn SendOneWayRequest(&self, pbody: *const core::ffi::c_void, poperation: *const WSD_OPERATION) -> Result<(), windows_result::HRESULT>;
    fn SendTwoWayRequest(&self, pbody: *const core::ffi::c_void, poperation: *const WSD_OPERATION, presponsecontext: *const WSD_SYNCHRONOUS_RESPONSE_CONTEXT) -> Result<(), windows_result::HRESULT>;
    fn SendTwoWayRequestAsync(&self, pbody: *const core::ffi::c_void, poperation: *const WSD_OPERATION, pasyncstate: windows_core::Ref<'_, windows_core::IUnknown>, pcallback: windows_core::Ref<'_, IWSDAsyncCallback>) -> Result<IWSDAsyncResult, windows_result::HRESULT>;
    fn AbortAsyncOperation(&self, pasyncresult: windows_core::Ref<'_, IWSDAsyncResult>) -> Result<(), windows_result::HRESULT>;
    fn ProcessFault(&self, pfault: *const WSD_SOAP_FAULT) -> Result<(), windows_result::HRESULT>;
    fn GetErrorInfo(&self) -> Result<windows_core::PCWSTR, windows_result::HRESULT>;
    fn GetFaultInfo(&self) -> Result<*mut WSD_SOAP_FAULT, windows_result::HRESULT>;
}
...
pub trait IWSDHttpAddress_Impl: IWSDTransportAddress_Impl {
    fn GetSecure(&self) -> Result<(), windows_result::HRESULT>;
    fn SetSecure(&self, fsecure: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn GetPath(&self) -> Result<windows_core::PCWSTR, windows_result::HRESULT>;
    fn SetPath(&self, pszpath: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
...
impl IWSDHttpAuthParameters {
    pub unsafe fn GetClientAccessToken(&self) -> Result<super::super::Foundation::HANDLE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetClientAccessToken)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetAuthType(&self) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWSDHttpAuthParameters_Impl: windows_core::IUnknownImpl {
    fn GetClientAccessToken(&self) -> Result<super::super::Foundation::HANDLE, windows_result::HRESULT>;
    fn GetAuthType(&self) -> Result<u32, windows_result::HRESULT>;
}
...
impl IWSDHttpMessageParameters {
    pub unsafe fn SetInboundHttpHeaders<P0>(&self, pszheaders: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetInboundHttpHeaders(&self) -> Result<windows_core::PCWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetInboundHttpHeaders)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetOutboundHttpHeaders<P0>(&self, pszheaders: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IWSDHttpMessageParameters_Impl: IWSDMessageParameters_Impl {
    fn SetInboundHttpHeaders(&self, pszheaders: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetInboundHttpHeaders(&self) -> Result<windows_core::PCWSTR, windows_result::HRESULT>;
    fn SetOutboundHttpHeaders(&self, pszheaders: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetOutboundHttpHeaders(&self) -> Result<windows_core::PCWSTR, windows_result::HRESULT>;
    fn SetID(&self, pszid: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetID(&self) -> Result<windows_core::PCWSTR, windows_result::HRESULT>;
    fn SetContext(&self, pcontext: windows_core::Ref<'_, windows_core::IUnknown>) -> Result<(), windows_result::HRESULT>;
    fn GetContext(&self) -> Result<windows_core::IUnknown, windows_result::HRESULT>;
...
impl IWSDInboundAttachment {
    pub unsafe fn Read(&self, pbuffer: &mut [u8], pdwnumberofbytesread: *mut u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IWSDInboundAttachment_Impl: IWSDAttachment_Impl {
    fn Read(&self, pbuffer: *mut u8, dwbytestoread: u32, pdwnumberofbytesread: *mut u32) -> Result<(), windows_result::HRESULT>;
...
impl IWSDMessageParameters {
    pub unsafe fn GetLocalAddress(&self) -> Result<IWSDAddress, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetLocalAddress<P0>(&self, paddress: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn GetRemoteAddress(&self) -> Result<IWSDAddress, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetRemoteAddress<P0>(&self, paddress: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IWSDAddress>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetRemoteAddress)(windows_core::Interface::as_raw(self), paddress.param().abi()).ok() }
    }
    pub unsafe fn GetLowerParameters(&self) -> Result<IWSDMessageParameters, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWSDMessageParameters_Impl: windows_core::IUnknownImpl {
    fn GetLocalAddress(&self) -> Result<IWSDAddress, windows_result::HRESULT>;
    fn SetLocalAddress(&self, paddress: windows_core::Ref<'_, IWSDAddress>) -> Result<(), windows_result::HRESULT>;
    fn GetRemoteAddress(&self) -> Result<IWSDAddress, windows_result::HRESULT>;
    fn SetRemoteAddress(&self, paddress: windows_core::Ref<'_, IWSDAddress>) -> Result<(), windows_result::HRESULT>;
    fn GetLowerParameters(&self) -> Result<IWSDMessageParameters, windows_result::HRESULT>;
}
...
impl IWSDMetadataExchange {
    pub unsafe fn GetMetadata(&self) -> Result<*mut WSD_METADATA_SECTION_LIST, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWSDMetadataExchange_Impl: windows_core::IUnknownImpl {
    fn GetMetadata(&self) -> Result<*mut WSD_METADATA_SECTION_LIST, windows_result::HRESULT>;
}
...
impl IWSDOutboundAttachment {
    pub unsafe fn Write(&self, pbuffer: &[u8]) -> Result<u32, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWSDOutboundAttachment_Impl: IWSDAttachment_Impl {
    fn Write(&self, pbuffer: *const u8, dwbytestowrite: u32) -> Result<u32, windows_result::HRESULT>;
    fn Close(&self) -> Result<(), windows_result::HRESULT>;
    fn Abort(&self) -> Result<(), windows_result::HRESULT>;
}
...
impl IWSDSSLClientCertificate {
    ...
    pub unsafe fn GetClientCertificate(&self) -> Result<*mut super::super::Security::Cryptography::CERT_CONTEXT, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetClientCertificate)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetMappedAccessToken(&self) -> Result<super::super::Foundation::HANDLE, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWSDSSLClientCertificate_Impl: windows_core::IUnknownImpl {
    fn GetClientCertificate(&self) -> Result<*mut super::super::Security::Cryptography::CERT_CONTEXT, windows_result::HRESULT>;
    fn GetMappedAccessToken(&self) -> Result<super::super::Foundation::HANDLE, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Security_Cryptography")]
...
impl IWSDScopeMatchingRule {
    pub unsafe fn GetScopeRule(&self) -> Result<windows_core::PCWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetScopeRule)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn MatchScopes<P0, P1>(&self, pszscope1: P0, pszscope2: P1) -> Result<windows_core::BOOL, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IWSDScopeMatchingRule_Impl: windows_core::IUnknownImpl {
    fn GetScopeRule(&self) -> Result<windows_core::PCWSTR, windows_result::HRESULT>;
    fn MatchScopes(&self, pszscope1: &windows_core::PCWSTR, pszscope2: &windows_core::PCWSTR) -> Result<windows_core::BOOL, windows_result::HRESULT>;
}
...
impl IWSDServiceMessaging {
    pub unsafe fn SendResponse<P2>(&self, pbody: Option<*const core::ffi::c_void>, poperation: *const WSD_OPERATION, pmessageparameters: P2) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn FaultRequest<P1>(&self, prequestheader: *const WSD_SOAP_HEADER, pmessageparameters: P1, pfault: Option<*const WSD_SOAP_FAULT>) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IWSDServiceMessaging_Impl: windows_core::IUnknownImpl {
    fn SendResponse(&self, pbody: *const core::ffi::c_void, poperation: *const WSD_OPERATION, pmessageparameters: windows_core::Ref<'_, IWSDMessageParameters>) -> Result<(), windows_result::HRESULT>;
    fn FaultRequest(&self, prequestheader: *const WSD_SOAP_HEADER, pmessageparameters: windows_core::Ref<'_, IWSDMessageParameters>, pfault: *const WSD_SOAP_FAULT) -> Result<(), windows_result::HRESULT>;
}
...
impl IWSDServiceProxy {
    ...
    pub unsafe fn EndGetMetadata<P0>(&self, presult: P0) -> Result<*mut WSD_METADATA_SECTION_LIST, windows_result::HRESULT>
    where
        P0: windows_core::Param<IWSDAsyncResult>,
    {
        unsafe {
    ...
    pub unsafe fn GetServiceMetadata(&self) -> Result<*mut WSD_SERVICE_METADATA, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetServiceMetadata)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SubscribeToOperation<P1>(&self, poperation: *const WSD_OPERATION, punknown: P1, pany: *const WSDXML_ELEMENT, ppany: Option<*mut *mut WSDXML_ELEMENT>) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::IUnknown>,
    {
    ...
    pub unsafe fn UnsubscribeToOperation(&self, poperation: *const WSD_OPERATION) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).UnsubscribeToOperation)(windows_core::Interface::as_raw(self), poperation).ok() }
    }
    pub unsafe fn SetEventingStatusCallback<P0>(&self, pstatus: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IWSDServiceProxy_Impl: IWSDMetadataExchange_Impl {
    fn BeginGetMetadata(&self) -> Result<IWSDAsyncResult, windows_result::HRESULT>;
    fn EndGetMetadata(&self, presult: windows_core::Ref<'_, IWSDAsyncResult>) -> Result<*mut WSD_METADATA_SECTION_LIST, windows_result::HRESULT>;
    fn GetServiceMetadata(&self) -> Result<*mut WSD_SERVICE_METADATA, windows_result::HRESULT>;
    fn SubscribeToOperation(&self, poperation: *const WSD_OPERATION, punknown: windows_core::Ref<'_, windows_core::IUnknown>, pany: *const WSDXML_ELEMENT, ppany: *mut *mut WSDXML_ELEMENT) -> Result<(), windows_result::HRESULT>;
    fn UnsubscribeToOperation(&self, poperation: *const WSD_OPERATION) -> Result<(), windows_result::HRESULT>;
    fn SetEventingStatusCallback(&self, pstatus: windows_core::Ref<'_, IWSDEventingStatus>) -> Result<(), windows_result::HRESULT>;
    fn GetEndpointProxy(&self) -> Result<IWSDEndpointProxy, windows_result::HRESULT>;
}
...
impl IWSDServiceProxyEventing {
    pub unsafe fn SubscribeToMultipleOperations<P2>(&self, poperations: &[WSD_OPERATION], punknown: P2, pexpires: Option<*const WSD_EVENTING_EXPIRES>, pany: Option<*const WSDXML_ELEMENT>, ppexpires: Option<*mut *mut WSD_EVENTING_EXPIRES>, ppany: Option<*mut *mut WSDXML_ELEMENT>) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<windows_core::IUnknown>,
    {
    ...
    pub unsafe fn BeginSubscribeToMultipleOperations<P2, P5, P6>(&self, poperations: &[WSD_OPERATION], punknown: P2, pexpires: Option<*const WSD_EVENTING_EXPIRES>, pany: Option<*const WSDXML_ELEMENT>, pasyncstate: P5, pasynccallback: P6) -> Result<IWSDAsyncResult, windows_result::HRESULT>
    where
        P2: windows_core::Param<windows_core::IUnknown>,
        P5: windows_core::Param<windows_core::IUnknown>,
    ...
    pub unsafe fn EndSubscribeToMultipleOperations<P2>(&self, poperations: &[WSD_OPERATION], presult: P2, ppexpires: Option<*mut *mut WSD_EVENTING_EXPIRES>, ppany: Option<*mut *mut WSDXML_ELEMENT>) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn UnsubscribeToMultipleOperations(&self, poperations: &[WSD_OPERATION], pany: *const WSDXML_ELEMENT) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn BeginUnsubscribeToMultipleOperations<P3, P4>(&self, poperations: &[WSD_OPERATION], pany: Option<*const WSDXML_ELEMENT>, pasyncstate: P3, pasynccallback: P4) -> Result<IWSDAsyncResult, windows_result::HRESULT>
    where
    ...
    pub unsafe fn EndUnsubscribeToMultipleOperations<P2>(&self, poperations: &[WSD_OPERATION], presult: P2) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<IWSDAsyncResult>,
    {
    ...
    pub unsafe fn RenewMultipleOperations(&self, poperations: &[WSD_OPERATION], pexpires: Option<*const WSD_EVENTING_EXPIRES>, pany: Option<*const WSDXML_ELEMENT>, ppexpires: Option<*mut *mut WSD_EVENTING_EXPIRES>, ppany: Option<*mut *mut WSDXML_ELEMENT>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn BeginRenewMultipleOperations<P4, P5>(&self, poperations: &[WSD_OPERATION], pexpires: Option<*const WSD_EVENTING_EXPIRES>, pany: Option<*const WSDXML_ELEMENT>, pasyncstate: P4, pasynccallback: P5) -> Result<IWSDAsyncResult, windows_result::HRESULT>
    where
    ...
    pub unsafe fn EndRenewMultipleOperations<P2>(&self, poperations: &[WSD_OPERATION], presult: P2, ppexpires: Option<*mut *mut WSD_EVENTING_EXPIRES>, ppany: Option<*mut *mut WSDXML_ELEMENT>) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<IWSDAsyncResult>,
    {
    ...
    pub unsafe fn GetStatusForMultipleOperations(&self, poperations: &[WSD_OPERATION], pany: Option<*const WSDXML_ELEMENT>, ppexpires: Option<*mut *mut WSD_EVENTING_EXPIRES>, ppany: Option<*mut *mut WSDXML_ELEMENT>) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn BeginGetStatusForMultipleOperations<P3, P4>(&self, poperations: &[WSD_OPERATION], pany: Option<*const WSDXML_ELEMENT>, pasyncstate: P3, pasynccallback: P4) -> Result<IWSDAsyncResult, windows_result::HRESULT>
    where
        P3: windows_core::Param<windows_core::IUnknown>,
        P4: windows_core::Param<IWSDAsyncCallback>,
    {
    ...
    pub unsafe fn EndGetStatusForMultipleOperations<P2>(&self, poperations: &[WSD_OPERATION], presult: P2, ppexpires: Option<*mut *mut WSD_EVENTING_EXPIRES>, ppany: Option<*mut *mut WSDXML_ELEMENT>) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<IWSDAsyncResult>,
    {
...
pub trait IWSDServiceProxyEventing_Impl: IWSDServiceProxy_Impl {
    fn SubscribeToMultipleOperations(&self, poperations: *const WSD_OPERATION, dwoperationcount: u32, punknown: windows_core::Ref<'_, windows_core::IUnknown>, pexpires: *const WSD_EVENTING_EXPIRES, pany: *const WSDXML_ELEMENT, ppexpires: *mut *mut WSD_EVENTING_EXPIRES, ppany: *mut *mut WSDXML_ELEMENT) -> Result<(), windows_result::HRESULT>;
    fn BeginSubscribeToMultipleOperations(&self, poperations: *const WSD_OPERATION, dwoperationcount: u32, punknown: windows_core::Ref<'_, windows_core::IUnknown>, pexpires: *const WSD_EVENTING_EXPIRES, pany: *const WSDXML_ELEMENT, pasyncstate: windows_core::Ref<'_, windows_core::IUnknown>, pasynccallback: windows_core::Ref<'_, IWSDAsyncCallback>) -> Result<IWSDAsyncResult, windows_result::HRESULT>;
    fn EndSubscribeToMultipleOperations(&self, poperations: *const WSD_OPERATION, dwoperationcount: u32, presult: windows_core::Ref<'_, IWSDAsyncResult>, ppexpires: *mut *mut WSD_EVENTING_EXPIRES, ppany: *mut *mut WSDXML_ELEMENT) -> Result<(), windows_result::HRESULT>;
    fn UnsubscribeToMultipleOperations(&self, poperations: *const WSD_OPERATION, dwoperationcount: u32, pany: *const WSDXML_ELEMENT) -> Result<(), windows_result::HRESULT>;
    fn BeginUnsubscribeToMultipleOperations(&self, poperations: *const WSD_OPERATION, dwoperationcount: u32, pany: *const WSDXML_ELEMENT, pasyncstate: windows_core::Ref<'_, windows_core::IUnknown>, pasynccallback: windows_core::Ref<'_, IWSDAsyncCallback>) -> Result<IWSDAsyncResult, windows_result::HRESULT>;
    fn EndUnsubscribeToMultipleOperations(&self, poperations: *const WSD_OPERATION, dwoperationcount: u32, presult: windows_core::Ref<'_, IWSDAsyncResult>) -> Result<(), windows_result::HRESULT>;
    fn RenewMultipleOperations(&self, poperations: *const WSD_OPERATION, dwoperationcount: u32, pexpires: *const WSD_EVENTING_EXPIRES, pany: *const WSDXML_ELEMENT, ppexpires: *mut *mut WSD_EVENTING_EXPIRES, ppany: *mut *mut WSDXML_ELEMENT) -> Result<(), windows_result::HRESULT>;
    ...
    fn EndRenewMultipleOperations(&self, poperations: *const WSD_OPERATION, dwoperationcount: u32, presult: windows_core::Ref<'_, IWSDAsyncResult>, ppexpires: *mut *mut WSD_EVENTING_EXPIRES, ppany: *mut *mut WSDXML_ELEMENT) -> Result<(), windows_result::HRESULT>;
    fn GetStatusForMultipleOperations(&self, poperations: *const WSD_OPERATION, dwoperationcount: u32, pany: *const WSDXML_ELEMENT, ppexpires: *mut *mut WSD_EVENTING_EXPIRES, ppany: *mut *mut WSDXML_ELEMENT) -> Result<(), windows_result::HRESULT>;
    fn BeginGetStatusForMultipleOperations(&self, poperations: *const WSD_OPERATION, dwoperationcount: u32, pany: *const WSDXML_ELEMENT, pasyncstate: windows_core::Ref<'_, windows_core::IUnknown>, pasynccallback: windows_core::Ref<'_, IWSDAsyncCallback>) -> Result<IWSDAsyncResult, windows_result::HRESULT>;
    fn EndGetStatusForMultipleOperations(&self, poperations: *const WSD_OPERATION, dwoperationcount: u32, presult: windows_core::Ref<'_, IWSDAsyncResult>, ppexpires: *mut *mut WSD_EVENTING_EXPIRES, ppany: *mut *mut WSDXML_ELEMENT) -> Result<(), windows_result::HRESULT>;
}
...
impl IWSDSignatureProperty {
    pub unsafe fn IsMessageSigned(&self) -> Result<windows_core::BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsMessageSigned)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn IsMessageSignatureTrusted(&self) -> Result<windows_core::BOOL, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetKeyInfo(&self, pbkeyinfo: Option<*mut u8>, pdwkeyinfosize: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetSignature(&self, pbsignature: Option<*mut u8>, pdwsignaturesize: *mut u32) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn GetSignedInfoHash(&self, pbsignedinfohash: Option<*mut u8>, pdwhashsize: *mut u32) -> Result<(), windows_result::HRESULT> {
...
pub trait IWSDSignatureProperty_Impl: windows_core::IUnknownImpl {
    fn IsMessageSigned(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
    fn IsMessageSignatureTrusted(&self) -> Result<windows_core::BOOL, windows_result::HRESULT>;
    fn GetKeyInfo(&self, pbkeyinfo: *mut u8, pdwkeyinfosize: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetSignature(&self, pbsignature: *mut u8, pdwsignaturesize: *mut u32) -> Result<(), windows_result::HRESULT>;
    fn GetSignedInfoHash(&self, pbsignedinfohash: *mut u8, pdwhashsize: *mut u32) -> Result<(), windows_result::HRESULT>;
}
...
impl IWSDTransportAddress {
    pub unsafe fn GetPort(&self) -> Result<u16, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetPort)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn SetPort(&self, wport: u16) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetPort)(windows_core::Interface::as_raw(self), wport).ok() }
    }
    pub unsafe fn GetTransportAddress(&self) -> Result<windows_core::PCWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetTransportAddress)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetTransportAddressEx(&self, fsafe: bool) -> Result<windows_core::PCWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn SetTransportAddress<P0>(&self, pszaddress: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IWSDTransportAddress_Impl: IWSDAddress_Impl {
    fn GetPort(&self) -> Result<u16, windows_result::HRESULT>;
    fn SetPort(&self, wport: u16) -> Result<(), windows_result::HRESULT>;
    fn GetTransportAddress(&self) -> Result<windows_core::PCWSTR, windows_result::HRESULT>;
    fn GetTransportAddressEx(&self, fsafe: windows_core::BOOL) -> Result<windows_core::PCWSTR, windows_result::HRESULT>;
    fn SetTransportAddress(&self, pszaddress: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
...
pub trait IWSDUdpAddress_Impl: IWSDTransportAddress_Impl {
    fn SetSockaddr(&self, psockaddr: *const super::super::Networking::WinSock::SOCKADDR_STORAGE) -> Result<(), windows_result::HRESULT>;
    fn GetSockaddr(&self, psockaddr: *mut super::super::Networking::WinSock::SOCKADDR_STORAGE) -> Result<(), windows_result::HRESULT>;
    fn SetExclusive(&self, fexclusive: windows_core::BOOL) -> Result<(), windows_result::HRESULT>;
    fn GetExclusive(&self) -> Result<(), windows_result::HRESULT>;
    fn SetMessageType(&self, messagetype: WSDUdpMessageType) -> Result<(), windows_result::HRESULT>;
    fn GetMessageType(&self) -> Result<WSDUdpMessageType, windows_result::HRESULT>;
    fn SetTTL(&self, dwttl: u32) -> Result<(), windows_result::HRESULT>;
    fn GetTTL(&self) -> Result<u32, windows_result::HRESULT>;
    fn SetAlias(&self, palias: *const windows_core::GUID) -> Result<(), windows_result::HRESULT>;
    fn GetAlias(&self) -> Result<windows_core::GUID, windows_result::HRESULT>;
}
#[cfg(feature = "Win32_Networking_WinSock")]
...
impl IWSDUdpMessageParameters {
    pub unsafe fn SetRetransmitParams(&self, pparams: *const WSDUdpRetransmitParams) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetRetransmitParams)(windows_core::Interface::as_raw(self), pparams).ok() }
    }
    pub unsafe fn GetRetransmitParams(&self, pparams: *mut WSDUdpRetransmitParams) -> Result<(), windows_result::HRESULT> {
...
pub trait IWSDUdpMessageParameters_Impl: IWSDMessageParameters_Impl {
    fn SetRetransmitParams(&self, pparams: *const WSDUdpRetransmitParams) -> Result<(), windows_result::HRESULT>;
    fn GetRetransmitParams(&self, pparams: *mut WSDUdpRetransmitParams) -> Result<(), windows_result::HRESULT>;
}
...
impl IWSDXMLContext {
    pub unsafe fn AddNamespace<P0, P1>(&self, pszuri: P0, pszsuggestedprefix: P1, ppnamespace: Option<*mut *mut WSDXML_NAMESPACE>) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn AddNameToNamespace<P0, P1>(&self, pszuri: P0, pszname: P1, ppname: Option<*mut *mut WSDXML_NAME>) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SetNamespaces(&self, pnamespaces: &[*const WSDXML_NAMESPACE], blayernumber: u8) -> Result<(), windows_result::HRESULT> {
    ...
    pub unsafe fn SetTypes(&self, ptypes: &[*const WSDXML_TYPE], blayernumber: u8) -> Result<(), windows_result::HRESULT> {
...
pub trait IWSDXMLContext_Impl: windows_core::IUnknownImpl {
    fn AddNamespace(&self, pszuri: &windows_core::PCWSTR, pszsuggestedprefix: &windows_core::PCWSTR, ppnamespace: *mut *mut WSDXML_NAMESPACE) -> Result<(), windows_result::HRESULT>;
    fn AddNameToNamespace(&self, pszuri: &windows_core::PCWSTR, pszname: &windows_core::PCWSTR, ppname: *mut *mut WSDXML_NAME) -> Result<(), windows_result::HRESULT>;
    fn SetNamespaces(&self, pnamespaces: *const *const WSDXML_NAMESPACE, wnamespacescount: u16, blayernumber: u8) -> Result<(), windows_result::HRESULT>;
    fn SetTypes(&self, ptypes: *const *const WSDXML_TYPE, dwtypescount: u32, blayernumber: u8) -> Result<(), windows_result::HRESULT>;
}
...
impl IWSDiscoveredService {
    ...
    pub unsafe fn GetProbeResolveTag(&self) -> Result<windows_core::PCWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetProbeResolveTag)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetRemoteTransportAddress(&self) -> Result<windows_core::PCWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn GetLocalTransportAddress(&self) -> Result<windows_core::PCWSTR, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLocalTransportAddress)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetLocalInterfaceGUID(&self) -> Result<windows_core::GUID, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetLocalInterfaceGUID)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub unsafe fn GetInstanceId(&self) -> Result<u64, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWSDiscoveredService_Impl: windows_core::IUnknownImpl {
    fn GetEndpointReference(&self) -> Result<*mut WSD_ENDPOINT_REFERENCE, windows_result::HRESULT>;
    fn GetTypes(&self) -> Result<*mut WSD_NAME_LIST, windows_result::HRESULT>;
    fn GetScopes(&self) -> Result<*mut WSD_URI_LIST, windows_result::HRESULT>;
    fn GetXAddrs(&self) -> Result<*mut WSD_URI_LIST, windows_result::HRESULT>;
    fn GetMetadataVersion(&self) -> Result<u64, windows_result::HRESULT>;
    fn GetExtendedDiscoXML(&self, ppheaderany: *mut *mut WSDXML_ELEMENT, ppbodyany: *mut *mut WSDXML_ELEMENT) -> Result<(), windows_result::HRESULT>;
    fn GetProbeResolveTag(&self) -> Result<windows_core::PCWSTR, windows_result::HRESULT>;
    fn GetRemoteTransportAddress(&self) -> Result<windows_core::PCWSTR, windows_result::HRESULT>;
    fn GetLocalTransportAddress(&self) -> Result<windows_core::PCWSTR, windows_result::HRESULT>;
    fn GetLocalInterfaceGUID(&self) -> Result<windows_core::GUID, windows_result::HRESULT>;
    fn GetInstanceId(&self) -> Result<u64, windows_result::HRESULT>;
}
...
impl IWSDiscoveryProvider {
    pub unsafe fn SetAddressFamily(&self, dwaddressfamily: u32) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).SetAddressFamily)(windows_core::Interface::as_raw(self), dwaddressfamily).ok() }
    }
    pub unsafe fn Attach<P0>(&self, psink: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Detach(&self) -> Result<(), windows_result::HRESULT> {
        unsafe { (windows_core::Interface::vtable(self).Detach)(windows_core::Interface::as_raw(self)).ok() }
    }
    pub unsafe fn SearchById<P0, P1>(&self, pszid: P0, psztag: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SearchByAddress<P0, P1>(&self, pszaddress: P0, psztag: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn SearchByType<P2, P3>(&self, ptypeslist: Option<*const WSD_NAME_LIST>, pscopeslist: Option<*const WSD_URI_LIST>, pszmatchby: P2, psztag: P3) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<windows_core::PCWSTR>,
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn GetXMLContext(&self) -> Result<IWSDXMLContext, windows_result::HRESULT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWSDiscoveryProvider_Impl: windows_core::IUnknownImpl {
    fn SetAddressFamily(&self, dwaddressfamily: u32) -> Result<(), windows_result::HRESULT>;
    fn Attach(&self, psink: windows_core::Ref<'_, IWSDiscoveryProviderNotify>) -> Result<(), windows_result::HRESULT>;
    fn Detach(&self) -> Result<(), windows_result::HRESULT>;
    fn SearchById(&self, pszid: &windows_core::PCWSTR, psztag: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn SearchByAddress(&self, pszaddress: &windows_core::PCWSTR, psztag: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn SearchByType(&self, ptypeslist: *const WSD_NAME_LIST, pscopeslist: *const WSD_URI_LIST, pszmatchby: &windows_core::PCWSTR, psztag: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn GetXMLContext(&self) -> Result<IWSDXMLContext, windows_result::HRESULT>;
}
...
impl IWSDiscoveryProviderNotify {
    pub unsafe fn Add<P0>(&self, pservice: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn Remove<P0>(&self, pservice: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IWSDiscoveredService>,
    {
        unsafe { (windows_core::Interface::vtable(self).Remove)(windows_core::Interface::as_raw(self), pservice.param().abi()).ok() }
    }
    pub unsafe fn SearchFailed<P1>(&self, hr: windows_core::HRESULT, psztag: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).SearchFailed)(windows_core::Interface::as_raw(self), hr, psztag.param().abi()).ok() }
    }
    pub unsafe fn SearchComplete<P0>(&self, psztag: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
...
pub trait IWSDiscoveryProviderNotify_Impl: windows_core::IUnknownImpl {
    fn Add(&self, pservice: windows_core::Ref<'_, IWSDiscoveredService>) -> Result<(), windows_result::HRESULT>;
    fn Remove(&self, pservice: windows_core::Ref<'_, IWSDiscoveredService>) -> Result<(), windows_result::HRESULT>;
    fn SearchFailed(&self, hr: windows_core::HRESULT, psztag: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
    fn SearchComplete(&self, psztag: &windows_core::PCWSTR) -> Result<(), windows_result::HRESULT>;
}
...
impl IWSDiscoveryPublisher {
    ...
    pub unsafe fn RegisterNotificationSink<P0>(&self, psink: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn UnRegisterNotificationSink<P0>(&self, psink: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IWSDiscoveryPublisherNotify>,
    {
    ...
    pub unsafe fn Publish<P0, P4>(&self, pszid: P0, ullmetadataversion: u64, ullinstanceid: u64, ullmessagenumber: u64, pszsessionid: P4, ptypeslist: Option<*const WSD_NAME_LIST>, pscopeslist: Option<*const WSD_URI_LIST>, pxaddrslist: Option<*const WSD_URI_LIST>) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn UnPublish<P0, P3>(&self, pszid: P0, ullinstanceid: u64, ullmessagenumber: u64, pszsessionid: P3, pany: Option<*const WSDXML_ELEMENT>) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
        P3: windows_core::Param<windows_core::PCWSTR>,
    {
    ...
    pub unsafe fn MatchProbe<P1, P2, P6>(&self, pprobemessage: *const WSD_SOAP_MESSAGE, pmessageparameters: P1, pszid: P2, ullmetadataversion: u64, ullinstanceid: u64, ullmessagenumber: u64, pszsessionid: P6, ptypeslist: Option<*const WSD_NAME_LIST>, pscopeslist: Option<*const WSD_URI_LIST>, pxaddrslist: Option<*const WSD_URI_LIST>) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<IWSDMessageParameters>,
        P2: windows_core::Param<windows_core::PCWSTR>,
    ...
    pub unsafe fn RegisterScopeMatchingRule<P0>(&self, pscopematchingrule: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub unsafe fn UnRegisterScopeMatchingRule<P0>(&self, pscopematchingrule: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<IWSDScopeMatchingRule>,
    {
...
pub trait IWSDiscoveryPublisher_Impl: windows_core::IUnknownImpl {
    fn SetAddressFamily(&self, dwaddressfamily: u32) -> Result<(), windows_result::HRESULT>;
    fn RegisterNotificationSink(&self, psink: windows_core::Ref<'_, IWSDiscoveryPublisherNotify>) -> Result<(), windows_result::HRESULT>;
    fn UnRegisterNotificationSink(&self, psink: windows_core::Ref<'_, IWSDiscoveryPublisherNotify>) -> Result<(), windows_result::HRESULT>;
    fn Publish(&self, pszid: &windows_core::PCWSTR, ullmetadataversion: u64, ullinstanceid: u64, ullmessagenumber: u64, pszsessionid: &windows_core::PCWSTR, ptypeslist: *const WSD_NAME_LIST, pscopeslist: *const WSD_URI_LIST, pxaddrslist: *const WSD_URI_LIST) -> Result<(), windows_result::HRESULT>;
    fn UnPublish(&self, pszid: &windows_core::PCWSTR, ullinstanceid: u64, ullmessagenumber: u64, pszsessionid: &windows_core::PCWSTR, pany: *const WSDXML_ELEMENT) -> Result<(), windows_result::HRESULT>;
    fn MatchProbe(&self, pprobemessage: *const WSD_SOAP_MESSAGE, pmessageparameters: windows_core::Ref<'_, IWSDMessageParameters>, pszid: &windows_core::PCWSTR, ullmetadataversion: u64, ullinstanceid: u64, ullmessagenumber: u64, pszsessionid: &windows_core::PCWSTR, ptypeslist: *const WSD_NAME_LIST, pscopeslist: *const WSD_URI_LIST, pxaddrslist: *const WSD_URI_LIST) -> Result<(), windows_result::HRESULT>;
    fn MatchResolve(&self, presolvemessage: *const WSD_SOAP_MESSAGE, pmessageparameters: windows_core::Ref<'_, IWSDMessageParameters>, pszid: &windows_core::PCWSTR, ullmetadataversion: u64, ullinstanceid: u64, ullmessagenumber: u64, pszsessionid: &windows_core::PCWSTR, ptypeslist: *const WSD_NAME_LIST, pscopeslist: *const WSD_URI_LIST, pxaddrslist: *const WSD_URI_LIST) -> Result<(), windows_result::HRESULT>;
    fn PublishEx(&self, pszid: &windows_core::PCWSTR, ullmetadataversion: u64, ullinstanceid: u64, ullmessagenumber: u64, pszsessionid: &windows_core::PCWSTR, ptypeslist: *const WSD_NAME_LIST, pscopeslist: *const WSD_URI_LIST, pxaddrslist: *const WSD_URI_LIST, pheaderany: *const WSDXML_ELEMENT, preferenceparameterany: *const WSDXML_ELEMENT, ppolicyany: *const WSDXML_ELEMENT, pendpointreferenceany: *const WSDXML_ELEMENT, pany: *const WSDXML_ELEMENT) -> Result<(), windows_result::HRESULT>;
    ...
    fn RegisterScopeMatchingRule(&self, pscopematchingrule: windows_core::Ref<'_, IWSDScopeMatchingRule>) -> Result<(), windows_result::HRESULT>;
    fn UnRegisterScopeMatchingRule(&self, pscopematchingrule: windows_core::Ref<'_, IWSDScopeMatchingRule>) -> Result<(), windows_result::HRESULT>;
    fn GetXMLContext(&self) -> Result<IWSDXMLContext, windows_result::HRESULT>;
}
...
impl IWSDiscoveryPublisherNotify {
    pub unsafe fn ProbeHandler<P1>(&self, psoap: *const WSD_SOAP_MESSAGE, pmessageparameters: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<IWSDMessageParameters>,
    {
    ...
    pub unsafe fn ResolveHandler<P1>(&self, psoap: *const WSD_SOAP_MESSAGE, pmessageparameters: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<IWSDMessageParameters>,
    {
...
pub trait IWSDiscoveryPublisherNotify_Impl: windows_core::IUnknownImpl {
    fn ProbeHandler(&self, psoap: *const WSD_SOAP_MESSAGE, pmessageparameters: windows_core::Ref<'_, IWSDMessageParameters>) -> Result<(), windows_result::HRESULT>;
    fn ResolveHandler(&self, psoap: *const WSD_SOAP_MESSAGE, pmessageparameters: windows_core::Ref<'_, IWSDMessageParameters>) -> Result<(), windows_result::HRESULT>;
}
...
pub type PWSD_SOAP_MESSAGE_HANDLER = Option<unsafe extern "system" fn(thisunknown: windows_core::Ref<'_, windows_core::IUnknown>, event: *mut WSD_EVENT) -> windows_core::HRESULT>;
#[repr(C)]
...
pub type WSD_STUB_FUNCTION = Option<unsafe extern "system" fn(server: windows_core::Ref<'_, windows_core::IUnknown>, session: windows_core::Ref<'_, IWSDServiceMessaging>, event: *mut WSD_EVENT) -> windows_core::HRESULT>;
#[repr(C)]
