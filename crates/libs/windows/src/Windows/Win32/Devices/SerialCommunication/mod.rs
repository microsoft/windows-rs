...
#[inline]
pub unsafe fn ComDBClaimPort(hcomdb: HCOMDB, comnumber: u32, forceclaim: bool, forced: *mut windows_core::BOOL) -> i32 {
    ...
    unsafe { ComDBClaimPort(hcomdb, comnumber, forceclaim.into(), forced as _) }
}
#[inline]
...
#[inline]
pub unsafe fn ComDBGetCurrentPortUsage(hcomdb: HCOMDB, buffer: *mut u8, buffersize: u32, reporttype: u32, maxportsreported: *mut u32) -> i32 {
    ...
    unsafe { ComDBGetCurrentPortUsage(hcomdb, buffer as _, buffersize, reporttype, maxportsreported as _) }
}
#[inline]
