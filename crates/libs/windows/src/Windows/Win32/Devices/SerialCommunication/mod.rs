...
pub const SERIAL_LSRMST_ESCAPE: u16 = 0;
pub const SERIAL_LSRMST_LSR_DATA: u16 = 1;
pub const SERIAL_LSRMST_LSR_NODATA: u16 = 2;
pub const SERIAL_LSRMST_MST: u16 = 3;
...
pub const SerenumFirstHalf: SERENUM_PORTION = SERENUM_PORTION(0);
pub const SerenumSecondHalf: SERENUM_PORTION = SERENUM_PORTION(1);
pub const SerenumWhole: SERENUM_PORTION = SERENUM_PORTION(2);
