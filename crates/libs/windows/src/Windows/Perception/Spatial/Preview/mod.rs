...
impl SpatialGraphInteropFrameOfReferencePreview {
    pub fn CoordinateSystem(&self) -> windows_result::Result<super::SpatialCoordinateSystem> {
        let this = self;
        unsafe {
    ...
    pub fn NodeId(&self) -> windows_result::Result<windows_core::GUID> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CoordinateSystemToNodeTransform(&self) -> windows_result::Result<windows_numerics::Matrix4x4> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SpatialGraphInteropPreview {
    pub fn CreateCoordinateSystemForNode(nodeid: windows_core::GUID) -> windows_result::Result<super::SpatialCoordinateSystem> {
    ...
    pub fn CreateCoordinateSystemForNodeWithPosition(nodeid: windows_core::GUID, relativeposition: windows_numerics::Vector3) -> windows_result::Result<super::SpatialCoordinateSystem> {
        Self::ISpatialGraphInteropPreviewStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn CreateCoordinateSystemForNodeWithPositionAndOrientation(nodeid: windows_core::GUID, relativeposition: windows_numerics::Vector3, relativeorientation: super::super::super::Foundation::Numerics::Quaternion) -> windows_result::Result<super::SpatialCoordinateSystem> {
        Self::ISpatialGraphInteropPreviewStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateLocatorForNode(nodeid: windows_core::GUID) -> windows_result::Result<super::SpatialLocator> {
        Self::ISpatialGraphInteropPreviewStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryCreateFrameOfReference<P0>(coordinatesystem: P0) -> windows_result::Result<SpatialGraphInteropFrameOfReferencePreview>
    where
    ...
    pub fn TryCreateFrameOfReferenceWithPosition<P0>(coordinatesystem: P0, relativeposition: windows_numerics::Vector3) -> windows_result::Result<SpatialGraphInteropFrameOfReferencePreview>
    where
        P0: windows_core::Param<super::SpatialCoordinateSystem>,
    {
        Self::ISpatialGraphInteropPreviewStatics2(|this| unsafe {
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn TryCreateFrameOfReferenceWithPositionAndOrientation<P0>(coordinatesystem: P0, relativeposition: windows_numerics::Vector3, relativeorientation: super::super::super::Foundation::Numerics::Quaternion) -> windows_result::Result<SpatialGraphInteropFrameOfReferencePreview>
    where
        P0: windows_core::Param<super::SpatialCoordinateSystem>,
    {
        Self::ISpatialGraphInteropPreviewStatics2(|this| unsafe {
    ...
    fn ISpatialGraphInteropPreviewStatics<R, F: FnOnce(&ISpatialGraphInteropPreviewStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn ISpatialGraphInteropPreviewStatics2<R, F: FnOnce(&ISpatialGraphInteropPreviewStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
