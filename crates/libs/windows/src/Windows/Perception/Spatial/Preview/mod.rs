...
impl SpatialGraphInteropFrameOfReferencePreview {
    pub fn CoordinateSystem(&self) -> Result<super::SpatialCoordinateSystem, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn NodeId(&self) -> Result<windows_core::GUID, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CoordinateSystemToNodeTransform(&self) -> Result<windows_numerics::Matrix4x4, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SpatialGraphInteropPreview {
    pub fn CreateCoordinateSystemForNode(nodeid: windows_core::GUID) -> Result<super::SpatialCoordinateSystem, windows_result::HRESULT> {
    ...
    pub fn CreateCoordinateSystemForNodeWithPosition(nodeid: windows_core::GUID, relativeposition: windows_numerics::Vector3) -> Result<super::SpatialCoordinateSystem, windows_result::HRESULT> {
        Self::ISpatialGraphInteropPreviewStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn CreateCoordinateSystemForNodeWithPositionAndOrientation(nodeid: windows_core::GUID, relativeposition: windows_numerics::Vector3, relativeorientation: super::super::super::Foundation::Numerics::Quaternion) -> Result<super::SpatialCoordinateSystem, windows_result::HRESULT> {
        Self::ISpatialGraphInteropPreviewStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateLocatorForNode(nodeid: windows_core::GUID) -> Result<super::SpatialLocator, windows_result::HRESULT> {
        Self::ISpatialGraphInteropPreviewStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryCreateFrameOfReference<P0>(coordinatesystem: P0) -> Result<SpatialGraphInteropFrameOfReferencePreview, windows_result::HRESULT>
    where
    ...
    pub fn TryCreateFrameOfReferenceWithPosition<P0>(coordinatesystem: P0, relativeposition: windows_numerics::Vector3) -> Result<SpatialGraphInteropFrameOfReferencePreview, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::SpatialCoordinateSystem>,
    {
        Self::ISpatialGraphInteropPreviewStatics2(|this| unsafe {
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn TryCreateFrameOfReferenceWithPositionAndOrientation<P0>(coordinatesystem: P0, relativeposition: windows_numerics::Vector3, relativeorientation: super::super::super::Foundation::Numerics::Quaternion) -> Result<SpatialGraphInteropFrameOfReferencePreview, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::SpatialCoordinateSystem>,
    {
        Self::ISpatialGraphInteropPreviewStatics2(|this| unsafe {
    ...
    fn ISpatialGraphInteropPreviewStatics<R, F: FnOnce(&ISpatialGraphInteropPreviewStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn ISpatialGraphInteropPreviewStatics2<R, F: FnOnce(&ISpatialGraphInteropPreviewStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
