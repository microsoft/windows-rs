...
impl SpatialAnchorExporter {
    pub fn GetAnchorExportSufficiencyAsync<P0>(&self, anchor: P0, purpose: SpatialAnchorExportPurpose) -> windows_core::Result<windows_async::IAsyncOperation<SpatialAnchorExportSufficiency>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn TryExportAnchorAsync<P0, P2>(&self, anchor: P0, purpose: SpatialAnchorExportPurpose, stream: P2) -> windows_core::Result<windows_async::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<SpatialAnchor>,
    ...
    pub fn RequestAccessAsync() -> windows_core::Result<windows_async::IAsyncOperation<SpatialPerceptionAccessStatus>> {
        Self::ISpatialAnchorExporterStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SpatialAnchorManager {
    pub fn RequestStoreAsync() -> windows_core::Result<windows_async::IAsyncOperation<SpatialAnchorStore>> {
...
impl SpatialAnchorTransferManager {
    #[cfg(feature = "Storage_Streams")]
    pub fn TryImportAnchorsAsync<P0>(stream: P0) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IMapView<windows_core::HSTRING, SpatialAnchor>>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn TryExportAnchorsAsync<P0, P1>(anchors: P0, stream: P1) -> windows_core::Result<windows_async::IAsyncOperation<bool>>
    where
...
impl SpatialEntityStore {
    pub fn SaveAsync<P0>(&self, entity: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    pub fn RemoveAsync<P0>(&self, entity: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
        P0: windows_core::Param<SpatialEntity>,
    {
        let this = self;
...
impl SpatialStageFrameOfReference {
    ...
    pub fn RequestNewStageAsync() -> windows_core::Result<windows_async::IAsyncOperation<SpatialStageFrameOfReference>> {
        Self::ISpatialStageFrameOfReferenceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
