...
impl SpatialAnchor {
    pub fn CoordinateSystem(&self) -> Result<SpatialCoordinateSystem, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn RawCoordinateSystem(&self) -> Result<SpatialCoordinateSystem, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RawCoordinateSystemAdjusted<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveRawCoordinateSystemAdjusted(&self, cookie: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn TryCreateRelativeTo<P0>(coordinatesystem: P0) -> Result<SpatialAnchor, windows_result::HRESULT>
    where
    ...
    pub fn TryCreateWithPositionRelativeTo<P0>(coordinatesystem: P0, position: windows_numerics::Vector3) -> Result<SpatialAnchor, windows_result::HRESULT>
    where
        P0: windows_core::Param<SpatialCoordinateSystem>,
    {
        Self::ISpatialAnchorStatics(|this| unsafe {
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn TryCreateWithPositionAndOrientationRelativeTo<P0>(coordinatesystem: P0, position: windows_numerics::Vector3, orientation: super::super::Foundation::Numerics::Quaternion) -> Result<SpatialAnchor, windows_result::HRESULT>
    where
        P0: windows_core::Param<SpatialCoordinateSystem>,
    {
        Self::ISpatialAnchorStatics(|this| unsafe {
    ...
    fn ISpatialAnchorStatics<R, F: FnOnce(&ISpatialAnchorStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl SpatialAnchorExportSufficiency {
    pub fn IsMinimallySufficient(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SufficiencyLevel(&self) -> Result<f64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RecommendedSufficiencyLevel(&self) -> Result<f64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SpatialAnchorExporter {
    pub fn GetAnchorExportSufficiencyAsync<P0>(&self, anchor: P0, purpose: SpatialAnchorExportPurpose) -> Result<windows_future::IAsyncOperation<SpatialAnchorExportSufficiency>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn TryExportAnchorAsync<P0, P2>(&self, anchor: P0, purpose: SpatialAnchorExportPurpose, stream: P2) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<SpatialAnchor>,
    ...
    pub fn GetDefault() -> Result<SpatialAnchorExporter, windows_result::HRESULT> {
        Self::ISpatialAnchorExporterStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefault)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn RequestAccessAsync() -> Result<windows_future::IAsyncOperation<SpatialPerceptionAccessStatus>, windows_result::HRESULT> {
        Self::ISpatialAnchorExporterStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn ISpatialAnchorExporterStatics<R, F: FnOnce(&ISpatialAnchorExporterStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl SpatialAnchorManager {
    pub fn RequestStoreAsync() -> Result<windows_future::IAsyncOperation<SpatialAnchorStore>, windows_result::HRESULT> {
    ...
    fn ISpatialAnchorManagerStatics<R, F: FnOnce(&ISpatialAnchorManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl SpatialAnchorRawCoordinateSystemAdjustedEventArgs {
    pub fn OldRawCoordinateSystemToNewRawCoordinateSystemTransform(&self) -> Result<windows_numerics::Matrix4x4, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SpatialAnchorStore {
    pub fn GetAllSavedAnchors(&self) -> Result<windows_collections::IMapView<windows_core::HSTRING, SpatialAnchor>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TrySave<P1>(&self, id: &windows_core::HSTRING, anchor: P1) -> Result<bool, windows_result::HRESULT>
    where
    ...
    pub fn Remove(&self, id: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl SpatialAnchorTransferManager {
    #[cfg(feature = "Storage_Streams")]
    pub fn TryImportAnchorsAsync<P0>(stream: P0) -> Result<windows_future::IAsyncOperation<windows_collections::IMapView<windows_core::HSTRING, SpatialAnchor>>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn TryExportAnchorsAsync<P0, P1>(anchors: P0, stream: P1) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
    ...
    fn ISpatialAnchorTransferManagerStatics<R, F: FnOnce(&ISpatialAnchorTransferManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl SpatialBoundingVolume {
    pub fn FromBox<P0>(coordinatesystem: P0, r#box: SpatialBoundingBox) -> Result<SpatialBoundingVolume, windows_result::HRESULT>
    where
        P0: windows_core::Param<SpatialCoordinateSystem>,
    {
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn FromOrientedBox<P0>(coordinatesystem: P0, r#box: SpatialBoundingOrientedBox) -> Result<SpatialBoundingVolume, windows_result::HRESULT>
    where
        P0: windows_core::Param<SpatialCoordinateSystem>,
    {
        Self::ISpatialBoundingVolumeStatics(|this| unsafe {
    ...
    pub fn FromSphere<P0>(coordinatesystem: P0, sphere: SpatialBoundingSphere) -> Result<SpatialBoundingVolume, windows_result::HRESULT>
    where
        P0: windows_core::Param<SpatialCoordinateSystem>,
    {
        Self::ISpatialBoundingVolumeStatics(|this| unsafe {
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn FromFrustum<P0>(coordinatesystem: P0, frustum: SpatialBoundingFrustum) -> Result<SpatialBoundingVolume, windows_result::HRESULT>
    where
        P0: windows_core::Param<SpatialCoordinateSystem>,
    {
        Self::ISpatialBoundingVolumeStatics(|this| unsafe {
    ...
    fn ISpatialBoundingVolumeStatics<R, F: FnOnce(&ISpatialBoundingVolumeStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl SpatialCoordinateSystem {
    pub fn TryGetTransformTo<P0>(&self, target: P0) -> Result<super::super::Foundation::IReference<windows_numerics::Matrix4x4>, windows_result::HRESULT>
    where
        P0: windows_core::Param<SpatialCoordinateSystem>,
    {
        let this = self;
...
impl SpatialEntity {
    ...
    pub fn Anchor(&self) -> Result<SpatialAnchor, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateWithSpatialAnchor<P0>(spatialanchor: P0) -> Result<SpatialEntity, windows_result::HRESULT>
    where
        P0: windows_core::Param<SpatialAnchor>,
    {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn CreateWithSpatialAnchorAndProperties<P0, P1>(spatialanchor: P0, propertyset: P1) -> Result<SpatialEntity, windows_result::HRESULT>
    where
        P0: windows_core::Param<SpatialAnchor>,
    ...
    fn ISpatialEntityFactory<R, F: FnOnce(&ISpatialEntityFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl SpatialEntityAddedEventArgs {
    pub fn Entity(&self) -> Result<SpatialEntity, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SpatialEntityStore {
    pub fn SaveAsync<P0>(&self, entity: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
    ...
    pub fn RemoveAsync<P0>(&self, entity: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<SpatialEntity>,
    {
        let this = self;
    ...
    pub fn CreateEntityWatcher(&self) -> Result<SpatialEntityWatcher, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "System_RemoteSystems")]
    pub fn TryGetForRemoteSystemSession<P0>(session: P0) -> Result<SpatialEntityStore, windows_result::HRESULT>
    where
    ...
    fn ISpatialEntityStoreStatics<R, F: FnOnce(&ISpatialEntityStoreStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl SpatialEntityWatcher {
    pub fn Status(&self) -> Result<SpatialEntityWatcherStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SpatialLocation {
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn Orientation(&self) -> Result<super::super::Foundation::Numerics::Quaternion, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AbsoluteLinearVelocity(&self) -> Result<windows_numerics::Vector3, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AbsoluteLinearAcceleration(&self) -> Result<windows_numerics::Vector3, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn AbsoluteAngularVelocity(&self) -> Result<super::super::Foundation::Numerics::Quaternion, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn AbsoluteAngularAcceleration(&self) -> Result<super::super::Foundation::Numerics::Quaternion, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AbsoluteAngularVelocityAxisAngle(&self) -> Result<windows_numerics::Vector3, windows_result::HRESULT> {
    ...
    pub fn AbsoluteAngularAccelerationAxisAngle(&self) -> Result<windows_numerics::Vector3, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ISpatialLocation2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SpatialLocator {
    pub fn Locatability(&self) -> Result<SpatialLocatability, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LocatabilityChanged<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveLocatabilityChanged(&self, cookie: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveLocatabilityChanged)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    pub fn PositionalTrackingDeactivating<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemovePositionalTrackingDeactivating(&self, cookie: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn TryLocateAtTimestamp<P0, P1>(&self, timestamp: P0, coordinatesystem: P1) -> Result<SpatialLocation, windows_result::HRESULT>
    where
    ...
    pub fn CreateAttachedFrameOfReferenceAtCurrentHeading(&self) -> Result<SpatialLocatorAttachedFrameOfReference, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateAttachedFrameOfReferenceAtCurrentHeadingWithPosition(&self, relativeposition: windows_numerics::Vector3) -> Result<SpatialLocatorAttachedFrameOfReference, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn CreateAttachedFrameOfReferenceAtCurrentHeadingWithPositionAndOrientation(&self, relativeposition: windows_numerics::Vector3, relativeorientation: super::super::Foundation::Numerics::Quaternion) -> Result<SpatialLocatorAttachedFrameOfReference, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateStationaryFrameOfReferenceAtCurrentLocation(&self) -> Result<SpatialStationaryFrameOfReference, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateStationaryFrameOfReferenceAtCurrentLocationWithPosition(&self, relativeposition: windows_numerics::Vector3) -> Result<SpatialStationaryFrameOfReference, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn CreateStationaryFrameOfReferenceAtCurrentLocationWithPositionAndOrientation(&self, relativeposition: windows_numerics::Vector3, relativeorientation: super::super::Foundation::Numerics::Quaternion) -> Result<SpatialStationaryFrameOfReference, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDefault() -> Result<SpatialLocator, windows_result::HRESULT> {
        Self::ISpatialLocatorStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefault)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn ISpatialLocatorStatics<R, F: FnOnce(&ISpatialLocatorStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl SpatialLocatorAttachedFrameOfReference {
    pub fn RelativePosition(&self) -> Result<windows_numerics::Vector3, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRelativePosition(&self, value: windows_numerics::Vector3) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetRelativePosition)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Foundation_Numerics")]
    pub fn RelativeOrientation(&self) -> Result<super::super::Foundation::Numerics::Quaternion, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn SetRelativeOrientation(&self, value: super::super::Foundation::Numerics::Quaternion) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetRelativeOrientation)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AdjustHeading(&self, headingoffsetinradians: f64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).AdjustHeading)(windows_core::Interface::as_raw(this), headingoffsetinradians).ok() }
    }
    pub fn GetStationaryCoordinateSystemAtTimestamp<P0>(&self, timestamp: P0) -> Result<SpatialCoordinateSystem, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::PerceptionTimestamp>,
    {
        let this = self;
    ...
    pub fn TryGetRelativeHeadingAtTimestamp<P0>(&self, timestamp: P0) -> Result<super::super::Foundation::IReference<f64>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::PerceptionTimestamp>,
    {
        let this = self;
...
impl SpatialLocatorPositionalTrackingDeactivatingEventArgs {
    pub fn Canceled(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanceled(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl SpatialStageFrameOfReference {
    ...
    pub fn MovementRange(&self) -> Result<SpatialMovementRange, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LookDirectionRange(&self) -> Result<SpatialLookDirectionRange, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetCoordinateSystemAtCurrentLocation<P0>(&self, locator: P0) -> Result<SpatialCoordinateSystem, windows_result::HRESULT>
    where
    ...
    pub fn TryGetMovementBounds<P0>(&self, coordinatesystem: P0) -> Result<windows_core::Array<windows_numerics::Vector3>, windows_result::HRESULT>
    where
        P0: windows_core::Param<SpatialCoordinateSystem>,
    {
        let this = self;
        unsafe {
            ...
            (windows_core::Interface::vtable(this).TryGetMovementBounds)(windows_core::Interface::as_raw(this), coordinatesystem.param().abi(), windows_core::Array::<windows_numerics::Vector3>::set_abi_len(core::mem::transmute(&mut result__)), result__.as_mut_ptr() as *mut _ as _).map(|| result__.assume_init())
        }
    }
    pub fn Current() -> Result<SpatialStageFrameOfReference, windows_result::HRESULT> {
    ...
    pub fn CurrentChanged<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveCurrentChanged(cookie: i64) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn RequestNewStageAsync() -> Result<windows_future::IAsyncOperation<SpatialStageFrameOfReference>, windows_result::HRESULT> {
        Self::ISpatialStageFrameOfReferenceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn ISpatialStageFrameOfReferenceStatics<R, F: FnOnce(&ISpatialStageFrameOfReferenceStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
