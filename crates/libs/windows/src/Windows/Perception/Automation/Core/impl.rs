...
impl ICorePerceptionAutomationStaticsVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: ICorePerceptionAutomationStaticsImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> ICorePerceptionAutomationStaticsVtbl {
