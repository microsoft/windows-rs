...
impl HandMeshObserver {
    ...
    pub fn GetTriangleIndices(&self, indices: &mut [u16]) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { (::windows_core::Interface::vtable(this).GetTriangleIndices)(::windows_core::Interface::as_raw(this), indices.len().try_into()?, indices.as_mut_ptr()).ok() }
    }
...
impl HandMeshVertexState {
    ...
    pub fn GetVertices(&self, vertices: &mut [HandMeshVertex]) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { (::windows_core::Interface::vtable(this).GetVertices)(::windows_core::Interface::as_raw(this), vertices.len().try_into()?, vertices.as_mut_ptr()).ok() }
    }
    pub fn UpdateTimestamp(&self) -> ::windows_core::Result<super::PerceptionTimestamp> {
        let this = self;
        unsafe {
...
impl HandPose {
        ...
        P0: ::windows_core::IntoParam<super::Spatial::SpatialCoordinateSystem>,
    {
        ...
        unsafe {
            let mut result__ = ::std::mem::zeroed();
            (::windows_core::Interface::vtable(this).TryGetJoints)(::windows_core::Interface::as_raw(this), coordinatesystem.into_param().abi(), joints.len().try_into()?, joints.as_ptr(), jointposes.len().try_into()?, jointposes.as_mut_ptr(), &mut result__).from_abi(result__)
        }
    }
    #[doc = "Required features: `\"Foundation_Numerics\"`"]
    #[cfg(feature = "Foundation_Numerics")]
    ...
    pub fn GetRelativeJoints(&self, joints: &[HandJointKind], referencejoints: &[HandJointKind], jointposes: &mut [JointPose]) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { (::windows_core::Interface::vtable(this).GetRelativeJoints)(::windows_core::Interface::as_raw(this), joints.len().try_into()?, joints.as_ptr(), referencejoints.len().try_into()?, referencejoints.as_ptr(), jointposes.len().try_into()?, jointposes.as_mut_ptr()).ok() }
    }
}
