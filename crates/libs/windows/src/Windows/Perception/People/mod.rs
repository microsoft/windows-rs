...
windows_core::imp::required_hierarchy!(EyesPose, IEyesPose, IEyesPoseStatics);
impl EyesPose {
...
windows_core::imp::required_hierarchy!(HandMeshObserver, IHandMeshObserver);
...
windows_core::imp::required_hierarchy!(HandMeshVertexState, IHandMeshVertexState);
...
windows_core::imp::required_hierarchy!(HandPose, IHandPose);
impl HandPose {
    #[cfg(all(feature = "Foundation_Numerics", feature = "Perception_Spatial"))]
...
windows_core::imp::required_hierarchy!(HeadPose, IHeadPose);
impl HeadPose {
    #[cfg(feature = "Foundation_Numerics")]
