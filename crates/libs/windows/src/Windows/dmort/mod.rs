...
#[cfg(feature = "mediaobj")]
#[inline]
pub unsafe fn MoCreateMediaType(ppmt: *mut *mut super::mediaobj::DMO_MEDIA_TYPE, cbformat: u32) -> windows_core::HRESULT {
    windows_core::link!("msdmo.dll" "system" fn MoCreateMediaType(ppmt : *mut *mut super::mediaobj::DMO_MEDIA_TYPE, cbformat : u32) -> windows_core::HRESULT);
