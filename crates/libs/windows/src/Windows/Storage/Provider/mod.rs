...
impl IStorageProviderShareLinkSource {
    pub fn CreateLinkAsync<P0>(&self, storageitemlist: P0) -> windows_core::Result<windows_async::IAsyncOperation<super::super::Foundation::Uri>>
    where
    ...
    pub fn GetDefaultAccessControlStringAsync<P0>(&self, storageitemlist: P0) -> windows_core::Result<windows_async::IAsyncOperation<windows_core::HSTRING>>
    where
        P0: windows_core::Param<windows_collections::IVectorView<super::IStorageItem>>,
    {
        let this = self;
    ...
    pub fn GetState<P0>(&self, storageitemlist: P0) -> windows_core::Result<windows_async::IAsyncOperation<StorageProviderShareLinkState>>
    where
        P0: windows_core::Param<windows_collections::IVectorView<super::IStorageItem>>,
    {
        let this = self;
...
pub trait IStorageProviderShareLinkSource_Impl: windows_core::IUnknownImpl {
    fn CreateLinkAsync(&self, storageItemList: windows_core::Ref<'_, windows_collections::IVectorView<super::IStorageItem>>) -> windows_core::Result<windows_async::IAsyncOperation<super::super::Foundation::Uri>>;
    fn GetDefaultAccessControlStringAsync(&self, storageItemList: windows_core::Ref<'_, windows_collections::IVectorView<super::IStorageItem>>) -> windows_core::Result<windows_async::IAsyncOperation<windows_core::HSTRING>>;
    fn GetState(&self, storageItemList: windows_core::Ref<'_, windows_collections::IVectorView<super::IStorageItem>>) -> windows_core::Result<windows_async::IAsyncOperation<StorageProviderShareLinkState>>;
}
...
impl StorageProviderItemProperties {
    pub fn SetAsync<P0, P1>(item: P0, itemproperties: P1) -> windows_core::Result<windows_async::IAsyncAction>
    where
