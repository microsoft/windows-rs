...
windows_core::imp::required_hierarchy!(CachedFileUpdaterUI, ICachedFileUpdaterUI, ICachedFileUpdaterUI2);
impl CachedFileUpdaterUI {
    pub fn Title(&self) -> windows_core::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<ICachedFileUpdaterUI>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
windows_core::imp::required_hierarchy!(FileUpdateRequest, IFileUpdateRequest, IFileUpdateRequest2);
impl FileUpdateRequest {
    pub fn ContentId(&self) -> windows_core::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<IFileUpdateRequest>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
windows_core::imp::required_hierarchy!(FileUpdateRequestDeferral, IFileUpdateRequestDeferral);
...
windows_core::imp::required_hierarchy!(FileUpdateRequestedEventArgs, IFileUpdateRequestedEventArgs);
...
windows_core::imp::required_hierarchy!(StorageProviderFileTypeInfo, IStorageProviderFileTypeInfo, IStorageProviderFileTypeInfoFactory);
...
windows_core::imp::required_hierarchy!(StorageProviderGetContentInfoForPathResult, IStorageProviderGetContentInfoForPathResult);
...
windows_core::imp::required_hierarchy!(StorageProviderGetPathForContentUriResult, IStorageProviderGetPathForContentUriResult);
...
windows_core::imp::required_hierarchy!(StorageProviderItemProperty, IStorageProviderItemProperty);
...
windows_core::imp::required_hierarchy!(StorageProviderItemPropertyDefinition, IStorageProviderItemPropertyDefinition);
...
windows_core::imp::required_hierarchy!(StorageProviderKnownFolderEntry, IStorageProviderKnownFolderEntry);
...
windows_core::imp::required_hierarchy!(StorageProviderKnownFolderSyncInfo, IStorageProviderKnownFolderSyncInfo);
...
windows_core::imp::required_hierarchy!(StorageProviderKnownFolderSyncRequestArgs, IStorageProviderKnownFolderSyncRequestArgs);
...
windows_core::imp::required_hierarchy!(StorageProviderMoreInfoUI, IStorageProviderMoreInfoUI);
...
windows_core::imp::required_hierarchy!(StorageProviderQuotaUI, IStorageProviderQuotaUI);
...
windows_core::imp::required_hierarchy!(StorageProviderStatusUI, IStorageProviderStatusUI);
...
windows_core::imp::required_hierarchy!(StorageProviderSyncRootInfo, IStorageProviderSyncRootInfo, IStorageProviderSyncRootInfo2, IStorageProviderSyncRootInfo3);
