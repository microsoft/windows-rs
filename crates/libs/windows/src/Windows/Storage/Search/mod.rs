...
windows_core::imp::required_hierarchy!(ContentIndexer, IContentIndexer, IContentIndexerQueryOperations, IContentIndexerStatics);
impl ContentIndexer {
...
windows_core::imp::required_hierarchy!(ContentIndexerQuery, IContentIndexerQuery);
...
windows_core::imp::required_hierarchy!(QueryOptions, IQueryOptions, IQueryOptionsFactory, IQueryOptionsWithProviderFilter);
impl QueryOptions {
    pub fn new() -> windows_core::Result<Self> {
        Self::IActivationFactory(|f| f.ActivateInstance::<Self>())
    }
...
impl SortEntryVector {
    ...
    where
        P1: windows_core::Param<SortEntry>,
    {
        let this = self;
...
windows_core::imp::required_hierarchy!(StorageFileQueryResult, IStorageFileQueryResult, IStorageFileQueryResult2, IStorageQueryResultBase);
...
windows_core::imp::required_hierarchy!(StorageFolderQueryResult, IStorageFolderQueryResult, IStorageQueryResultBase);
...
windows_core::imp::required_hierarchy!(StorageItemQueryResult, IStorageItemQueryResult, IStorageQueryResultBase);
...
windows_core::imp::required_hierarchy!(StorageLibraryChangeTrackerTriggerDetails, IStorageLibraryChangeTrackerTriggerDetails);
...
windows_core::imp::required_hierarchy!(StorageLibraryContentChangedTriggerDetails, IStorageLibraryContentChangedTriggerDetails);
...
windows_core::imp::required_hierarchy!(ValueAndLanguage, IValueAndLanguage);
