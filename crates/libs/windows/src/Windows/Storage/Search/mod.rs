...
impl IIndexableContent {
    ...
    pub fn Properties(&self) -> ::windows_core::Result<super::super::Foundation::Collections::IMap<::windows_core::HSTRING, ::windows_core::IInspectable>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::Collections::IMap<::windows_core::HSTRING, ::windows_core::IInspectable>>();
    ...
    pub fn Stream(&self) -> ::windows_core::Result<super::Streams::IRandomAccessStream> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::Streams::IRandomAccessStream>();
...
impl IStorageFolderQueryOperations {
    ...
    pub fn GetIndexedStateAsync(&self) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<IndexedState>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<IndexedState>>();
    ...
    pub fn CreateFileQueryOverloadDefault(&self) -> ::windows_core::Result<StorageFileQueryResult> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<StorageFileQueryResult>();
    ...
    pub fn CreateFolderQueryOverloadDefault(&self) -> ::windows_core::Result<StorageFolderQueryResult> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<StorageFolderQueryResult>();
    ...
    pub fn CreateItemQuery(&self) -> ::windows_core::Result<StorageItemQueryResult> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<StorageItemQueryResult>();
...
impl IStorageQueryResultBase {
    ...
    pub fn Folder(&self) -> ::windows_core::Result<super::StorageFolder> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::StorageFolder>();
    ...
    pub fn GetCurrentQueryOptions(&self) -> ::windows_core::Result<QueryOptions> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<QueryOptions>();
...
impl ContentIndexer {
        ...
        P0: ::windows_core::TryIntoParam<super::super::Foundation::Collections::IIterable<::windows_core::HSTRING>>,
    {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IMapView<::windows_core::HSTRING, ::windows_core::IInspectable>>>();
        ...
        P1: ::windows_core::TryIntoParam<super::super::Foundation::Collections::IIterable<SortEntry>>,
    {
        ...
        unsafe {
            let mut result__ = ::windows_core::zeroed::<ContentIndexerQuery>();
    ...
    pub fn GetIndexerWithName(indexname: &::windows_core::HSTRING) -> ::windows_core::Result<ContentIndexer> {
        Self::IContentIndexerStatics(|this| unsafe {
            let mut result__ = ::windows_core::zeroed::<ContentIndexer>();
...
impl ContentIndexerQuery {
    ...
    pub fn GetPropertiesAsync(&self) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<super::super::Foundation::Collections::IMapView<::windows_core::HSTRING, ::windows_core::IInspectable>>>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<super::super::Foundation::Collections::IMapView<::windows_core::HSTRING, ::windows_core::IInspectable>>>>();
    ...
    pub fn GetAsync(&self) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<IIndexableContent>>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<IIndexableContent>>>();
...
impl QueryOptions {
    ...
    pub fn FolderDepth(&self) -> ::windows_core::Result<FolderDepth> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<FolderDepth>();
    ...
    pub fn IndexerOption(&self) -> ::windows_core::Result<IndexerOption> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<IndexerOption>();
    ...
    pub fn SortOrder(&self) -> ::windows_core::Result<super::super::Foundation::Collections::IVector<SortEntry>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::Collections::IVector<SortEntry>>();
    ...
    pub fn DateStackOption(&self) -> ::windows_core::Result<DateStackOption> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<DateStackOption>();
...
impl SortEntryVector {
    ...
    pub fn First(&self) -> ::windows_core::Result<super::super::Foundation::Collections::IIterator<SortEntry>> {
        ...
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::Collections::IIterator<SortEntry>>();
    ...
    pub fn GetAt(&self, index: u32) -> ::windows_core::Result<SortEntry> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<SortEntry>();
    ...
    pub fn GetView(&self) -> ::windows_core::Result<super::super::Foundation::Collections::IVectorView<SortEntry>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::Collections::IVectorView<SortEntry>>();
...
impl StorageFileQueryResult {
    ...
    pub fn GetMatchingPropertiesWithRanges(&self, file: &super::StorageFile) -> ::windows_core::Result<super::super::Foundation::Collections::IMap<::windows_core::HSTRING, super::super::Foundation::Collections::IVectorView<super::super::Data::Text::TextSegment>>> {
        ...
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::Collections::IMap<::windows_core::HSTRING, super::super::Foundation::Collections::IVectorView<super::super::Data::Text::TextSegment>>>();
...
impl StorageLibraryChangeTrackerTriggerDetails {
    ...
    pub fn ChangeTracker(&self) -> ::windows_core::Result<super::StorageLibraryChangeTracker> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::StorageLibraryChangeTracker>();
