...
impl ContentIndexer {
    pub fn AddAsync<P0>(&self, indexablecontent: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
    ...
    pub fn UpdateAsync<P0>(&self, indexablecontent: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<IIndexableContent>,
    {
        let this = self;
    ...
    pub fn DeleteAsync(&self, contentid: &windows_core::HSTRING) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeleteMultipleAsync<P0>(&self, contentids: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
    ...
    pub fn DeleteAllAsync(&self) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RetrievePropertiesAsync<P1>(&self, contentid: &windows_core::HSTRING, propertiestoretrieve: P1) -> Result<windows_future::IAsyncOperation<windows_collections::IMapView<windows_core::HSTRING, windows_core::IInspectable>>, windows_result::HRESULT>
    where
    ...
    pub fn Revision(&self) -> Result<u64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateQueryWithSortOrderAndLanguage<P1, P2>(&self, searchfilter: &windows_core::HSTRING, propertiestoretrieve: P1, sortorder: P2, searchfilterlanguage: &windows_core::HSTRING) -> Result<ContentIndexerQuery, windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    ...
    pub fn CreateQueryWithSortOrder<P1, P2>(&self, searchfilter: &windows_core::HSTRING, propertiestoretrieve: P1, sortorder: P2) -> Result<ContentIndexerQuery, windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
        P2: windows_core::Param<windows_collections::IIterable<SortEntry>>,
    {
    ...
    pub fn CreateQuery<P1>(&self, searchfilter: &windows_core::HSTRING, propertiestoretrieve: P1) -> Result<ContentIndexerQuery, windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        let this = &windows_core::Interface::cast::<IContentIndexerQueryOperations>(self)?;
    ...
    pub fn GetIndexerWithName(indexname: &windows_core::HSTRING) -> Result<ContentIndexer, windows_result::HRESULT> {
    ...
    pub fn GetIndexer() -> Result<ContentIndexer, windows_result::HRESULT> {
        Self::IContentIndexerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IContentIndexerStatics<R, F: FnOnce(&IContentIndexerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl ContentIndexerQuery {
    pub fn GetCountAsync(&self) -> Result<windows_future::IAsyncOperation<u32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetPropertiesAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<windows_collections::IMapView<windows_core::HSTRING, windows_core::IInspectable>>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetPropertiesRangeAsync(&self, startindex: u32, maxitems: u32) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<windows_collections::IMapView<windows_core::HSTRING, windows_core::IInspectable>>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<IIndexableContent>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetRangeAsync(&self, startindex: u32, maxitems: u32) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<IIndexableContent>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn QueryFolder(&self) -> Result<super::StorageFolder, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl IIndexableContent {
    ...
    pub fn Properties(&self) -> Result<windows_collections::IMap<windows_core::HSTRING, windows_core::IInspectable>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Stream(&self) -> Result<super::Streams::IRandomAccessStream, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetStream<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn StreamContentType(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetStreamContentType(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
pub trait IIndexableContent_Impl: windows_core::IUnknownImpl {
    ...
    fn Properties(&self) -> Result<windows_collections::IMap<windows_core::HSTRING, windows_core::IInspectable>, windows_result::HRESULT>;
    fn Stream(&self) -> Result<super::Streams::IRandomAccessStream, windows_result::HRESULT>;
    fn SetStream(&self, value: windows_core::Ref<'_, super::Streams::IRandomAccessStream>) -> Result<(), windows_result::HRESULT>;
    fn StreamContentType(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT>;
    fn SetStreamContentType(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Storage_Streams")]
impl IIndexableContent_Vtbl {
    pub const fn new<Identity: IIndexableContent_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Id<Identity: IIndexableContent_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetId<Identity: IIndexableContent_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IIndexableContent_Impl::SetId(this, core::mem::transmute(&value)).into()
            }
        }
        unsafe extern "system" fn Properties<Identity: IIndexableContent_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Stream<Identity: IIndexableContent_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetStream<Identity: IIndexableContent_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IIndexableContent_Impl::SetStream(this, core::mem::transmute_copy(&value)).into()
            }
        }
        unsafe extern "system" fn StreamContentType<Identity: IIndexableContent_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetStreamContentType<Identity: IIndexableContent_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IStorageFolderQueryOperations {
    pub fn GetIndexedStateAsync(&self) -> Result<windows_future::IAsyncOperation<IndexedState>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFileQueryOverloadDefault(&self) -> Result<StorageFileQueryResult, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFileQuery(&self, query: CommonFileQuery) -> Result<StorageFileQueryResult, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFileQueryWithOptions<P0>(&self, queryoptions: P0) -> Result<StorageFileQueryResult, windows_result::HRESULT>
    where
    ...
    pub fn CreateFolderQueryOverloadDefault(&self) -> Result<StorageFolderQueryResult, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFolderQuery(&self, query: CommonFolderQuery) -> Result<StorageFolderQueryResult, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFolderQueryWithOptions<P0>(&self, queryoptions: P0) -> Result<StorageFolderQueryResult, windows_result::HRESULT>
    where
        P0: windows_core::Param<QueryOptions>,
    {
        let this = self;
    ...
    pub fn CreateItemQuery(&self) -> Result<StorageItemQueryResult, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateItemQueryWithOptions<P0>(&self, queryoptions: P0) -> Result<StorageItemQueryResult, windows_result::HRESULT>
    where
        P0: windows_core::Param<QueryOptions>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetFilesAsync(&self, query: CommonFileQuery, startindex: u32, maxitemstoretrieve: u32) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::StorageFile>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetFilesAsyncOverloadDefaultStartAndCount(&self, query: CommonFileQuery) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::StorageFile>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetFoldersAsync(&self, query: CommonFolderQuery, startindex: u32, maxitemstoretrieve: u32) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::StorageFolder>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetFoldersAsyncOverloadDefaultStartAndCount(&self, query: CommonFolderQuery) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::StorageFolder>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsCommonFolderQuerySupported(&self, query: CommonFolderQuery) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsCommonFileQuerySupported(&self, query: CommonFileQuery) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IStorageFolderQueryOperations_Impl: windows_core::IUnknownImpl {
    fn GetIndexedStateAsync(&self) -> Result<windows_future::IAsyncOperation<IndexedState>, windows_result::HRESULT>;
    fn CreateFileQueryOverloadDefault(&self) -> Result<StorageFileQueryResult, windows_result::HRESULT>;
    fn CreateFileQuery(&self, query: CommonFileQuery) -> Result<StorageFileQueryResult, windows_result::HRESULT>;
    fn CreateFileQueryWithOptions(&self, queryOptions: windows_core::Ref<'_, QueryOptions>) -> Result<StorageFileQueryResult, windows_result::HRESULT>;
    fn CreateFolderQueryOverloadDefault(&self) -> Result<StorageFolderQueryResult, windows_result::HRESULT>;
    fn CreateFolderQuery(&self, query: CommonFolderQuery) -> Result<StorageFolderQueryResult, windows_result::HRESULT>;
    fn CreateFolderQueryWithOptions(&self, queryOptions: windows_core::Ref<'_, QueryOptions>) -> Result<StorageFolderQueryResult, windows_result::HRESULT>;
    fn CreateItemQuery(&self) -> Result<StorageItemQueryResult, windows_result::HRESULT>;
    fn CreateItemQueryWithOptions(&self, queryOptions: windows_core::Ref<'_, QueryOptions>) -> Result<StorageItemQueryResult, windows_result::HRESULT>;
    fn GetFilesAsync(&self, query: CommonFileQuery, startIndex: u32, maxItemsToRetrieve: u32) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::StorageFile>>, windows_result::HRESULT>;
    fn GetFilesAsyncOverloadDefaultStartAndCount(&self, query: CommonFileQuery) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::StorageFile>>, windows_result::HRESULT>;
    fn GetFoldersAsync(&self, query: CommonFolderQuery, startIndex: u32, maxItemsToRetrieve: u32) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::StorageFolder>>, windows_result::HRESULT>;
    fn GetFoldersAsyncOverloadDefaultStartAndCount(&self, query: CommonFolderQuery) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::StorageFolder>>, windows_result::HRESULT>;
    fn GetItemsAsync(&self, startIndex: u32, maxItemsToRetrieve: u32) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::IStorageItem>>, windows_result::HRESULT>;
    fn AreQueryOptionsSupported(&self, queryOptions: windows_core::Ref<'_, QueryOptions>) -> Result<bool, windows_result::HRESULT>;
    fn IsCommonFolderQuerySupported(&self, query: CommonFolderQuery) -> Result<bool, windows_result::HRESULT>;
    fn IsCommonFileQuerySupported(&self, query: CommonFileQuery) -> Result<bool, windows_result::HRESULT>;
}
#[cfg(feature = "Storage_Streams")]
impl IStorageFolderQueryOperations_Vtbl {
    pub const fn new<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetIndexedStateAsync<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateFileQueryOverloadDefault<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateFileQuery<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, query: CommonFileQuery, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateFileQueryWithOptions<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, queryoptions: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateFolderQueryOverloadDefault<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateFolderQuery<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, query: CommonFolderQuery, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateFolderQueryWithOptions<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, queryoptions: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateItemQuery<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateItemQueryWithOptions<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, queryoptions: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetFilesAsync<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, query: CommonFileQuery, startindex: u32, maxitemstoretrieve: u32, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetFilesAsyncOverloadDefaultStartAndCount<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, query: CommonFileQuery, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetFoldersAsync<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, query: CommonFolderQuery, startindex: u32, maxitemstoretrieve: u32, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetFoldersAsyncOverloadDefaultStartAndCount<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, query: CommonFolderQuery, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetItemsAsync<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, startindex: u32, maxitemstoretrieve: u32, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn AreQueryOptionsSupported<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, queryoptions: *mut core::ffi::c_void, result__: *mut bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsCommonFolderQuerySupported<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, query: CommonFolderQuery, result__: *mut bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsCommonFileQuerySupported<Identity: IStorageFolderQueryOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, query: CommonFileQuery, result__: *mut bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IStorageQueryResultBase {
    pub fn GetItemCountAsync(&self) -> Result<windows_future::IAsyncOperation<u32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Folder(&self) -> Result<super::StorageFolder, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ContentsChanged<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveContentsChanged(&self, eventcookie: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveContentsChanged)(windows_core::Interface::as_raw(this), eventcookie).ok() }
    }
    pub fn OptionsChanged<P0>(&self, changedhandler: P0) -> Result<i64, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<IStorageQueryResultBase, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveOptionsChanged(&self, eventcookie: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveOptionsChanged)(windows_core::Interface::as_raw(this), eventcookie).ok() }
    }
    pub fn FindStartIndexAsync<P0>(&self, value: P0) -> Result<windows_future::IAsyncOperation<u32>, windows_result::HRESULT>
    where
    ...
    pub fn GetCurrentQueryOptions(&self) -> Result<QueryOptions, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ApplyNewQueryOptions<P0>(&self, newqueryoptions: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<QueryOptions>,
    {
        let this = self;
...
pub trait IStorageQueryResultBase_Impl: windows_core::IUnknownImpl {
    fn GetItemCountAsync(&self) -> Result<windows_future::IAsyncOperation<u32>, windows_result::HRESULT>;
    fn Folder(&self) -> Result<super::StorageFolder, windows_result::HRESULT>;
    fn ContentsChanged(&self, handler: windows_core::Ref<'_, super::super::Foundation::TypedEventHandler<IStorageQueryResultBase, windows_core::IInspectable>>) -> Result<i64, windows_result::HRESULT>;
    fn RemoveContentsChanged(&self, eventCookie: i64) -> Result<(), windows_result::HRESULT>;
    fn OptionsChanged(&self, changedHandler: windows_core::Ref<'_, super::super::Foundation::TypedEventHandler<IStorageQueryResultBase, windows_core::IInspectable>>) -> Result<i64, windows_result::HRESULT>;
    fn RemoveOptionsChanged(&self, eventCookie: i64) -> Result<(), windows_result::HRESULT>;
    fn FindStartIndexAsync(&self, value: windows_core::Ref<'_, windows_core::IInspectable>) -> Result<windows_future::IAsyncOperation<u32>, windows_result::HRESULT>;
    fn GetCurrentQueryOptions(&self) -> Result<QueryOptions, windows_result::HRESULT>;
    fn ApplyNewQueryOptions(&self, newQueryOptions: windows_core::Ref<'_, QueryOptions>) -> Result<(), windows_result::HRESULT>;
}
impl IStorageQueryResultBase_Vtbl {
    pub const fn new<Identity: IStorageQueryResultBase_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetItemCountAsync<Identity: IStorageQueryResultBase_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Folder<Identity: IStorageQueryResultBase_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ContentsChanged<Identity: IStorageQueryResultBase_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, handler: *mut core::ffi::c_void, result__: *mut i64) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn RemoveContentsChanged<Identity: IStorageQueryResultBase_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, eventcookie: i64) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IStorageQueryResultBase_Impl::RemoveContentsChanged(this, eventcookie).into()
            }
        }
        unsafe extern "system" fn OptionsChanged<Identity: IStorageQueryResultBase_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, changedhandler: *mut core::ffi::c_void, result__: *mut i64) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn RemoveOptionsChanged<Identity: IStorageQueryResultBase_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, eventcookie: i64) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IStorageQueryResultBase_Impl::RemoveOptionsChanged(this, eventcookie).into()
            }
        }
        unsafe extern "system" fn FindStartIndexAsync<Identity: IStorageQueryResultBase_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetCurrentQueryOptions<Identity: IStorageQueryResultBase_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ApplyNewQueryOptions<Identity: IStorageQueryResultBase_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, newqueryoptions: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl QueryOptions {
    ...
    pub fn FolderDepth(&self) -> Result<FolderDepth, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetFolderDepth(&self, value: FolderDepth) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetFolderDepth)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ApplicationSearchFilter(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetApplicationSearchFilter(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn UserSearchFilter(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetUserSearchFilter(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn IndexerOption(&self) -> Result<IndexerOption, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIndexerOption(&self, value: IndexerOption) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIndexerOption)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SortOrder(&self) -> Result<windows_collections::IVector<SortEntry>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GroupPropertyName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DateStackOption(&self) -> Result<DateStackOption, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SaveToString(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LoadFromString(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    #[cfg(feature = "Storage_FileProperties")]
    pub fn SetThumbnailPrefetch(&self, mode: super::FileProperties::ThumbnailMode, requestedsize: u32, options: super::FileProperties::ThumbnailOptions) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    #[cfg(feature = "Storage_FileProperties")]
    pub fn SetPropertyPrefetch<P1>(&self, options: super::FileProperties::PropertyPrefetchOptions, propertiestoretrieve: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        let this = self;
    ...
    pub fn CreateCommonFileQuery<P1>(query: CommonFileQuery, filetypefilter: P1) -> Result<QueryOptions, windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
    ...
    pub fn CreateCommonFolderQuery(query: CommonFolderQuery) -> Result<QueryOptions, windows_result::HRESULT> {
        Self::IQueryOptionsFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StorageProviderIdFilter(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
    ...
    fn IQueryOptionsFactory<R, F: FnOnce(&IQueryOptionsFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl SortEntryVector {
    pub fn First(&self) -> Result<windows_collections::IIterator<SortEntry>, windows_result::HRESULT> {
    ...
    pub fn GetAt(&self, index: u32) -> Result<SortEntry, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetView(&self) -> Result<windows_collections::IVectorView<SortEntry>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IndexOf(&self, value: &SortEntry, index: &mut u32) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAt(&self, index: u32, value: &SortEntry) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn InsertAt(&self, index: u32, value: &SortEntry) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Append(&self, value: &SortEntry) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn GetMany(&self, startindex: u32, items: &mut [SortEntry]) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReplaceAll(&self, items: &[SortEntry]) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl StorageFileQueryResult {
    #[cfg(feature = "Storage_Streams")]
    pub fn GetFilesAsync(&self, startindex: u32, maxnumberofitems: u32) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::StorageFile>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetFilesAsyncDefaultStartAndCount(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::StorageFile>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Data_Text", feature = "Storage_Streams"))]
    pub fn GetMatchingPropertiesWithRanges<P0>(&self, file: P0) -> Result<windows_collections::IMap<windows_core::HSTRING, windows_collections::IVectorView<super::super::Data::Text::TextSegment>>, windows_result::HRESULT>
    where
...
impl StorageFolderQueryResult {
    pub fn GetFoldersAsync(&self, startindex: u32, maxnumberofitems: u32) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::StorageFolder>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetFoldersAsyncDefaultStartAndCount(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::StorageFolder>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl StorageItemQueryResult {
    pub fn GetItemsAsync(&self, startindex: u32, maxnumberofitems: u32) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::IStorageItem>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetItemsAsyncDefaultStartAndCount(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::IStorageItem>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl StorageLibraryChangeTrackerTriggerDetails {
    ...
    pub fn ChangeTracker(&self) -> Result<super::StorageLibraryChangeTracker, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl StorageLibraryContentChangedTriggerDetails {
    ...
    pub fn CreateModifiedSinceQuery(&self, lastquerytime: super::super::Foundation::DateTime) -> Result<StorageItemQueryResult, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
