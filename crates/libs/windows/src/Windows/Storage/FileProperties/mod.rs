...
impl BasicProperties {
    ...
    pub fn DateModified(&self) -> windows_result::Result<super::super::Foundation::DateTime> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ItemDate(&self) -> windows_result::Result<super::super::Foundation::DateTime> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RetrievePropertiesAsync<P0>(&self, propertiestoretrieve: P0) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IMap<windows_core::HSTRING, windows_core::IInspectable>>>
    where
    ...
    pub fn SavePropertiesAsync<P0>(&self, propertiestosave: P0) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    pub fn SavePropertiesAsyncOverloadDefault(&self) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = &windows_core::Interface::cast::<IStorageItemExtraProperties>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DocumentProperties {
    pub fn Author(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Keywords(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GeotagHelper {
    ...
    pub fn GetGeotagAsync<P0>(file: P0) -> windows_result::Result<windows_future::IAsyncOperation<super::super::Devices::Geolocation::Geopoint>>
    where
    ...
    #[cfg(all(feature = "Devices_Geolocation", feature = "Storage_Streams"))]
    pub fn SetGeotagFromGeolocatorAsync<P0, P1>(file: P0, geolocator: P1) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<super::IStorageFile>,
    ...
    #[cfg(all(feature = "Devices_Geolocation", feature = "Storage_Streams"))]
    pub fn SetGeotagAsync<P0, P1>(file: P0, geopoint: P1) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<super::IStorageFile>,
    ...
    fn IGeotagHelperStatics<R, F: FnOnce(&IGeotagHelperStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
pub trait IStorageItemExtraProperties_Impl: windows_core::IUnknownImpl {
    fn RetrievePropertiesAsync(&self, propertiesToRetrieve: windows_core::Ref<windows_collections::IIterable<windows_core::HSTRING>>) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IMap<windows_core::HSTRING, windows_core::IInspectable>>>;
    fn SavePropertiesAsync(&self, propertiesToSave: windows_core::Ref<windows_collections::IIterable<windows_collections::IKeyValuePair<windows_core::HSTRING, windows_core::IInspectable>>>) -> windows_result::Result<windows_future::IAsyncAction>;
    fn SavePropertiesAsyncOverloadDefault(&self) -> windows_result::Result<windows_future::IAsyncAction>;
}
...
impl ImageProperties {
    pub fn Rating(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRating(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn DateTaken(&self) -> windows_result::Result<super::super::Foundation::DateTime> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDateTaken(&self, value: super::super::Foundation::DateTime) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn Latitude(&self) -> windows_result::Result<super::super::Foundation::IReference<f64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Longitude(&self) -> windows_result::Result<super::super::Foundation::IReference<f64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CameraManufacturer(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCameraManufacturer(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn CameraModel(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCameraModel(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn Orientation(&self) -> windows_result::Result<PhotoOrientation> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PeopleNames(&self) -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MusicProperties {
    ...
    pub fn SetAlbum(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn Genre(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Composers(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Conductors(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Producers(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPublisher(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn Writers(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Year(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetYear(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
...
impl StorageItemContentProperties {
    pub fn GetMusicPropertiesAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<MusicProperties>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetVideoPropertiesAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<VideoProperties>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetImagePropertiesAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<ImageProperties>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDocumentPropertiesAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<DocumentProperties>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl StorageItemThumbnail {
    ...
    pub fn GetInputStreamAt(&self, position: u64) -> windows_result::Result<super::Streams::IInputStream> {
        let this = &windows_core::Interface::cast::<super::Streams::IRandomAccessStream>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetOutputStreamAt(&self, position: u64) -> windows_result::Result<super::Streams::IOutputStream> {
        let this = &windows_core::Interface::cast::<super::Streams::IRandomAccessStream>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CloneStream(&self) -> windows_result::Result<super::Streams::IRandomAccessStream> {
        let this = &windows_core::Interface::cast::<super::Streams::IRandomAccessStream>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OriginalWidth(&self) -> windows_result::Result<u32> {
    ...
    pub fn OriginalHeight(&self) -> windows_result::Result<u32> {
        let this = &windows_core::Interface::cast::<IThumbnailProperties>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReturnedSmallerCachedSize(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IThumbnailProperties>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Type(&self) -> windows_result::Result<ThumbnailType> {
        let this = &windows_core::Interface::cast::<IThumbnailProperties>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VideoProperties {
    ...
    pub fn Directors(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Orientation(&self) -> windows_result::Result<VideoOrientation> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Orientation)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
