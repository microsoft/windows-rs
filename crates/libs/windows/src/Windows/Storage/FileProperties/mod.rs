...
windows_core::imp::required_hierarchy!(BasicProperties, IBasicProperties, IStorageItemExtraProperties);
...
windows_core::imp::required_hierarchy!(DocumentProperties, IDocumentProperties, IStorageItemExtraProperties);
...
windows_core::imp::required_hierarchy!(ImageProperties, IImageProperties, IStorageItemExtraProperties);
...
windows_core::imp::required_hierarchy!(MusicProperties, IMusicProperties, IStorageItemExtraProperties);
...
windows_core::imp::required_hierarchy!(StorageItemContentProperties, IStorageItemContentProperties, IStorageItemExtraProperties);
...
#[cfg(feature = "Storage_Streams")]
windows_core::imp::required_hierarchy!(StorageItemThumbnail, super::super::Foundation::IClosable, IThumbnailProperties, super::Streams::IContentTypeProvider, super::Streams::IInputStream, super::Streams::IOutputStream, super::Streams::IRandomAccessStream, super::Streams::IRandomAccessStreamWithContentType);
#[cfg(feature = "Storage_Streams")]
...
windows_core::imp::required_hierarchy!(VideoProperties, IStorageItemExtraProperties, IVideoProperties);
