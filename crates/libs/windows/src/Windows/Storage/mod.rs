...
windows_core::imp::required_hierarchy!(AppDataPaths, IAppDataPaths, IAppDataPathsStatics);
impl AppDataPaths {
...
windows_core::imp::required_hierarchy!(ApplicationData, super::Foundation::IClosable, IApplicationData, IApplicationData2, IApplicationData3, IApplicationDataStatics, IApplicationDataStatics2);
...
windows_core::imp::required_hierarchy!(ApplicationDataContainer, super::Foundation::IClosable, IApplicationDataContainer);
...
windows_core::imp::required_hierarchy!(SetVersionDeferral, ISetVersionDeferral);
...
windows_core::imp::required_hierarchy!(SetVersionRequest, ISetVersionRequest);
...
#[cfg(feature = "Storage_Streams")]
windows_core::imp::required_hierarchy!(StorageFile, IStorageFile, IStorageFile2, IStorageFilePropertiesWithAvailability, IStorageFileStatics, IStorageFileStatics2, IStorageItem, IStorageItem2, IStorageItemProperties, IStorageItemProperties2, IStorageItemPropertiesWithProvider, Streams::IInputStreamReference, Streams::IRandomAccessStreamReference);
#[cfg(feature = "Storage_Streams")]
impl StorageFile {
    pub fn FileType(&self) -> windows_core::Result<windows_core::HSTRING> {
        let this = self;
...
#[cfg(feature = "Storage_Search")]
windows_core::imp::required_hierarchy!(StorageFolder, IStorageFolder, IStorageFolder2, IStorageFolder3, IStorageFolderStatics, IStorageFolderStatics2, IStorageItem, IStorageItem2, IStorageItemProperties, IStorageItemProperties2, IStorageItemPropertiesWithProvider, Search::IStorageFolderQueryOperations);
#[cfg(feature = "Storage_Search")]
impl StorageFolder {
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFileAsyncOverloadDefaultOptions(&self, desiredname: &windows_core::HSTRING) -> windows_core::Result<super::Foundation::IAsyncOperation<StorageFile>> {
...
windows_core::imp::required_hierarchy!(StorageLibrary, IStorageLibrary, IStorageLibrary2, IStorageLibrary3, IStorageLibraryStatics, IStorageLibraryStatics2);
impl StorageLibrary {
    #[cfg(feature = "Storage_Search")]
...
windows_core::imp::required_hierarchy!(StorageLibraryChange, IStorageLibraryChange);
...
windows_core::imp::required_hierarchy!(StorageLibraryChangeReader, IStorageLibraryChangeReader, IStorageLibraryChangeReader2);
...
windows_core::imp::required_hierarchy!(StorageLibraryChangeTracker, IStorageLibraryChangeTracker, IStorageLibraryChangeTracker2);
...
windows_core::imp::required_hierarchy!(StorageLibraryChangeTrackerOptions, IStorageLibraryChangeTrackerOptions);
...
windows_core::imp::required_hierarchy!(StorageLibraryLastChangeId, IStorageLibraryLastChangeId, IStorageLibraryLastChangeIdStatics);
...
windows_core::imp::required_hierarchy!(StorageProvider, IStorageProvider, IStorageProvider2);
impl StorageProvider {
    pub fn Id(&self) -> windows_core::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<IStorageProvider>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
windows_core::imp::required_hierarchy!(StorageStreamTransaction, super::Foundation::IClosable, IStorageStreamTransaction);
...
#[cfg(feature = "Storage_Streams")]
windows_core::imp::required_hierarchy!(StreamedFileDataRequest, super::Foundation::IClosable, IStreamedFileDataRequest, Streams::IOutputStream);
#[cfg(feature = "Storage_Streams")]
...
windows_core::imp::required_hierarchy!(SystemAudioProperties, ISystemAudioProperties);
...
windows_core::imp::required_hierarchy!(SystemDataPaths, ISystemDataPaths, ISystemDataPathsStatics);
...
windows_core::imp::required_hierarchy!(SystemGPSProperties, ISystemGPSProperties);
...
windows_core::imp::required_hierarchy!(SystemImageProperties, ISystemImageProperties);
...
windows_core::imp::required_hierarchy!(SystemMediaProperties, ISystemMediaProperties);
...
windows_core::imp::required_hierarchy!(SystemMusicProperties, ISystemMusicProperties);
...
windows_core::imp::required_hierarchy!(SystemPhotoProperties, ISystemPhotoProperties);
...
windows_core::imp::required_hierarchy!(SystemVideoProperties, ISystemVideoProperties);
...
windows_core::imp::required_hierarchy!(UserDataPaths, IUserDataPaths, IUserDataPathsStatics);
impl UserDataPaths {
