...
impl AppDataPaths {
    pub fn Cookies(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
    ...
    pub fn Desktop(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Documents(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Favorites(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn History(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn InternetCache(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LocalAppData(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ProgramData(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RoamingAppData(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "System")]
    pub fn GetForUser<P0>(user: P0) -> windows_result::Result<AppDataPaths>
    where
    ...
    pub fn GetDefault() -> windows_result::Result<AppDataPaths> {
        Self::IAppDataPathsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefault)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IAppDataPathsStatics<R, F: FnOnce(&IAppDataPathsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl ApplicationData {
    pub fn Version(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetVersionAsync<P1>(&self, desiredversion: u32, handler: P1) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    pub fn ClearAllAsync(&self) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ClearAsync(&self, locality: ApplicationDataLocality) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LocalSettings(&self) -> windows_result::Result<ApplicationDataContainer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RoamingSettings(&self) -> windows_result::Result<ApplicationDataContainer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn LocalFolder(&self) -> windows_result::Result<StorageFolder> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn RoamingFolder(&self) -> windows_result::Result<StorageFolder> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn TemporaryFolder(&self) -> windows_result::Result<StorageFolder> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DataChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn LocalCacheFolder(&self) -> windows_result::Result<StorageFolder> {
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn GetPublisherCacheFolder(&self, foldername: &windows_core::HSTRING) -> windows_result::Result<StorageFolder> {
    ...
    pub fn ClearPublisherCacheFolderAsync(&self, foldername: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = &windows_core::Interface::cast::<IApplicationData3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn SharedLocalFolder(&self) -> windows_result::Result<StorageFolder> {
        let this = &windows_core::Interface::cast::<IApplicationData3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Current() -> windows_result::Result<ApplicationData> {
    ...
    #[cfg(feature = "System")]
    pub fn GetForUserAsync<P0>(user: P0) -> windows_result::Result<windows_future::IAsyncOperation<ApplicationData>>
    where
        P0: windows_core::Param<super::System::User>,
    {
    ...
    fn IApplicationDataStatics<R, F: FnOnce(&IApplicationDataStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ApplicationData, IApplicationDataStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IApplicationDataStatics2<R, F: FnOnce(&IApplicationDataStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl ApplicationDataContainer {
    ...
    pub fn Locality(&self) -> windows_result::Result<ApplicationDataLocality> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn Values(&self) -> windows_result::Result<super::Foundation::Collections::IPropertySet> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Containers(&self) -> windows_result::Result<windows_collections::IMapView<windows_core::HSTRING, ApplicationDataContainer>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateContainer(&self, name: &windows_core::HSTRING, disposition: ApplicationDataCreateDisposition) -> windows_result::Result<ApplicationDataContainer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeleteContainer(&self, name: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
...
impl ApplicationDataSetVersionHandler {
    pub fn new<F: Fn(windows_core::Ref<SetVersionRequest>) -> windows_result::Result<()> + Send + 'static>(invoke: F) -> Self {
    ...
    pub fn Invoke<P0>(&self, setversionrequest: P0) -> windows_result::Result<()>
    where
...
#[repr(C)]
struct ApplicationDataSetVersionHandlerBox<F: Fn(windows_core::Ref<SetVersionRequest>) -> windows_result::Result<()> + Send + 'static> {
    vtable: *const ApplicationDataSetVersionHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: Fn(windows_core::Ref<SetVersionRequest>) -> windows_result::Result<()> + Send + 'static> ApplicationDataSetVersionHandlerBox<F> {
...
impl CachedFileManager {
    #[cfg(feature = "Storage_Streams")]
    pub fn DeferUpdates<P0>(file: P0) -> windows_result::Result<()>
    where
    ...
    pub fn CompleteUpdatesAsync<P0>(file: P0) -> windows_result::Result<windows_future::IAsyncOperation<Provider::FileUpdateStatus>>
    where
        P0: windows_core::Param<IStorageFile>,
    {
    ...
    fn ICachedFileManagerStatics<R, F: FnOnce(&ICachedFileManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl DownloadsFolder {
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFileAsync(desiredname: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>> {
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn CreateFolderAsync(desiredname: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFolder>> {
        Self::IDownloadsFolderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFileWithCollisionOptionAsync(desiredname: &windows_core::HSTRING, option: CreationCollisionOption) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>> {
        Self::IDownloadsFolderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn CreateFolderWithCollisionOptionAsync(desiredname: &windows_core::HSTRING, option: CreationCollisionOption) -> windows_result::Result<windows_future::IAsyncOperation<StorageFolder>> {
        Self::IDownloadsFolderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFileForUserAsync<P0>(user: P0, desiredname: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>>
    where
        P0: windows_core::Param<super::System::User>,
    {
    ...
    pub fn CreateFolderForUserAsync<P0>(user: P0, desiredname: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFolder>>
    where
        P0: windows_core::Param<super::System::User>,
    {
        Self::IDownloadsFolderStatics2(|this| unsafe {
    ...
    #[cfg(all(feature = "Storage_Streams", feature = "System"))]
    pub fn CreateFileForUserWithCollisionOptionAsync<P0>(user: P0, desiredname: &windows_core::HSTRING, option: CreationCollisionOption) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>>
    where
        P0: windows_core::Param<super::System::User>,
    {
        Self::IDownloadsFolderStatics2(|this| unsafe {
    ...
    #[cfg(all(feature = "Storage_Search", feature = "System"))]
    pub fn CreateFolderForUserWithCollisionOptionAsync<P0>(user: P0, desiredname: &windows_core::HSTRING, option: CreationCollisionOption) -> windows_result::Result<windows_future::IAsyncOperation<StorageFolder>>
    where
        P0: windows_core::Param<super::System::User>,
    {
        Self::IDownloadsFolderStatics2(|this| unsafe {
    ...
    fn IDownloadsFolderStatics<R, F: FnOnce(&IDownloadsFolderStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<DownloadsFolder, IDownloadsFolderStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IDownloadsFolderStatics2<R, F: FnOnce(&IDownloadsFolderStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl FileIO {
    #[cfg(feature = "Storage_Streams")]
    pub fn ReadTextAsync<P0>(file: P0) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>>
    where
        P0: windows_core::Param<IStorageFile>,
    {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ReadTextWithEncodingAsync<P0>(file: P0, encoding: Streams::UnicodeEncoding) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>>
    where
        P0: windows_core::Param<IStorageFile>,
    {
        Self::IFileIOStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn WriteTextAsync<P0>(file: P0, contents: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<IStorageFile>,
    {
        Self::IFileIOStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn WriteTextWithEncodingAsync<P0>(file: P0, contents: &windows_core::HSTRING, encoding: Streams::UnicodeEncoding) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<IStorageFile>,
    {
        Self::IFileIOStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn AppendTextAsync<P0>(file: P0, contents: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<IStorageFile>,
    {
        Self::IFileIOStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn AppendTextWithEncodingAsync<P0>(file: P0, contents: &windows_core::HSTRING, encoding: Streams::UnicodeEncoding) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<IStorageFile>,
    {
        Self::IFileIOStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ReadLinesAsync<P0>(file: P0) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVector<windows_core::HSTRING>>>
    where
        P0: windows_core::Param<IStorageFile>,
    {
        Self::IFileIOStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ReadLinesWithEncodingAsync<P0>(file: P0, encoding: Streams::UnicodeEncoding) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVector<windows_core::HSTRING>>>
    where
        P0: windows_core::Param<IStorageFile>,
    {
        Self::IFileIOStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn WriteLinesAsync<P0, P1>(file: P0, lines: P1) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<IStorageFile>,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn WriteLinesWithEncodingAsync<P0, P1>(file: P0, lines: P1, encoding: Streams::UnicodeEncoding) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<IStorageFile>,
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn AppendLinesAsync<P0, P1>(file: P0, lines: P1) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<IStorageFile>,
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn AppendLinesWithEncodingAsync<P0, P1>(file: P0, lines: P1, encoding: Streams::UnicodeEncoding) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<IStorageFile>,
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ReadBufferAsync<P0>(file: P0) -> windows_result::Result<windows_future::IAsyncOperation<Streams::IBuffer>>
    where
        P0: windows_core::Param<IStorageFile>,
    {
        Self::IFileIOStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn WriteBufferAsync<P0, P1>(file: P0, buffer: P1) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<IStorageFile>,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn WriteBytesAsync<P0>(file: P0, buffer: &[u8]) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<IStorageFile>,
    {
        Self::IFileIOStatics(|this| unsafe {
    ...
    fn IFileIOStatics<R, F: FnOnce(&IFileIOStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl IStorageFile {
    ...
    pub fn OpenAsync(&self, accessmode: FileAccessMode) -> windows_result::Result<windows_future::IAsyncOperation<Streams::IRandomAccessStream>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OpenTransactedWriteAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<StorageStreamTransaction>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CopyOverloadDefaultNameAndOptions<P0>(&self, destinationfolder: P0) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>>
    where
    ...
    pub fn CopyOverloadDefaultOptions<P0>(&self, destinationfolder: P0, desirednewname: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>>
    where
        P0: windows_core::Param<IStorageFolder>,
    {
        let this = self;
    ...
    pub fn CopyOverload<P0>(&self, destinationfolder: P0, desirednewname: &windows_core::HSTRING, option: NameCollisionOption) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>>
    where
        P0: windows_core::Param<IStorageFolder>,
    {
        let this = self;
    ...
    pub fn MoveOverload<P0>(&self, destinationfolder: P0, desirednewname: &windows_core::HSTRING, option: NameCollisionOption) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<IStorageFolder>,
    {
        let this = self;
    ...
    pub fn OpenSequentialReadAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<Streams::IInputStream>> {
    ...
    pub fn OpenReadAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<Streams::IRandomAccessStreamWithContentType>> {
    ...
    pub fn RenameAsync(&self, desiredname: &windows_core::HSTRING, option: NameCollisionOption) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = &windows_core::Interface::cast::<IStorageItem>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeleteAsync(&self, option: StorageDeleteOption) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = &windows_core::Interface::cast::<IStorageItem>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_FileProperties")]
    pub fn GetBasicPropertiesAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<FileProperties::BasicProperties>> {
        let this = &windows_core::Interface::cast::<IStorageItem>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Attributes(&self) -> windows_result::Result<FileAttributes> {
        let this = &windows_core::Interface::cast::<IStorageItem>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DateCreated(&self) -> windows_result::Result<super::Foundation::DateTime> {
        let this = &windows_core::Interface::cast::<IStorageItem>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsOfType(&self, r#type: StorageItemTypes) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IStorageItem>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IStorageFile_Impl: Streams::IInputStreamReference_Impl + Streams::IRandomAccessStreamReference_Impl + IStorageItem_Impl {
    fn FileType(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn ContentType(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn OpenAsync(&self, accessMode: FileAccessMode) -> windows_result::Result<windows_future::IAsyncOperation<Streams::IRandomAccessStream>>;
    fn OpenTransactedWriteAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<StorageStreamTransaction>>;
    fn CopyOverloadDefaultNameAndOptions(&self, destinationFolder: windows_core::Ref<IStorageFolder>) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>>;
    fn CopyOverloadDefaultOptions(&self, destinationFolder: windows_core::Ref<IStorageFolder>, desiredNewName: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>>;
    fn CopyOverload(&self, destinationFolder: windows_core::Ref<IStorageFolder>, desiredNewName: &windows_core::HSTRING, option: NameCollisionOption) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>>;
    fn CopyAndReplaceAsync(&self, fileToReplace: windows_core::Ref<IStorageFile>) -> windows_result::Result<windows_future::IAsyncAction>;
    fn MoveOverloadDefaultNameAndOptions(&self, destinationFolder: windows_core::Ref<IStorageFolder>) -> windows_result::Result<windows_future::IAsyncAction>;
    fn MoveOverloadDefaultOptions(&self, destinationFolder: windows_core::Ref<IStorageFolder>, desiredNewName: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction>;
    fn MoveOverload(&self, destinationFolder: windows_core::Ref<IStorageFolder>, desiredNewName: &windows_core::HSTRING, option: NameCollisionOption) -> windows_result::Result<windows_future::IAsyncAction>;
    fn MoveAndReplaceAsync(&self, fileToReplace: windows_core::Ref<IStorageFile>) -> windows_result::Result<windows_future::IAsyncAction>;
}
#[cfg(all(feature = "Storage_FileProperties", feature = "Storage_Streams"))]
...
impl IStorageFile2 {
    #[cfg(feature = "Storage_Streams")]
    pub fn OpenWithOptionsAsync(&self, accessmode: FileAccessMode, options: StorageOpenOptions) -> windows_result::Result<windows_future::IAsyncOperation<Streams::IRandomAccessStream>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OpenTransactedWriteWithOptionsAsync(&self, options: StorageOpenOptions) -> windows_result::Result<windows_future::IAsyncOperation<StorageStreamTransaction>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IStorageFile2_Impl: windows_core::IUnknownImpl {
    fn OpenWithOptionsAsync(&self, accessMode: FileAccessMode, options: StorageOpenOptions) -> windows_result::Result<windows_future::IAsyncOperation<Streams::IRandomAccessStream>>;
    fn OpenTransactedWriteWithOptionsAsync(&self, options: StorageOpenOptions) -> windows_result::Result<windows_future::IAsyncOperation<StorageStreamTransaction>>;
}
#[cfg(feature = "Storage_Streams")]
...
pub trait IStorageFilePropertiesWithAvailability_Impl: windows_core::IUnknownImpl {
    fn IsAvailable(&self) -> windows_result::Result<bool>;
}
...
impl IStorageFolder {
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFileAsyncOverloadDefaultOptions(&self, desiredname: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFileAsync(&self, desiredname: &windows_core::HSTRING, options: CreationCollisionOption) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn CreateFolderAsyncOverloadDefaultOptions(&self, desiredname: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFolder>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn CreateFolderAsync(&self, desiredname: &windows_core::HSTRING, options: CreationCollisionOption) -> windows_result::Result<windows_future::IAsyncOperation<StorageFolder>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetFileAsync(&self, name: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn GetFolderAsync(&self, name: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFolder>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetItemAsync(&self, name: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<IStorageItem>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetFilesAsyncOverloadDefaultOptionsStartAndCount(&self) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<StorageFile>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn GetFoldersAsyncOverloadDefaultOptionsStartAndCount(&self) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<StorageFolder>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetItemsAsyncOverloadDefaultStartAndCount(&self) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<IStorageItem>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IStorageFolder_Impl: IStorageItem_Impl {
    fn CreateFileAsyncOverloadDefaultOptions(&self, desiredName: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>>;
    fn CreateFileAsync(&self, desiredName: &windows_core::HSTRING, options: CreationCollisionOption) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>>;
    fn CreateFolderAsyncOverloadDefaultOptions(&self, desiredName: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFolder>>;
    fn CreateFolderAsync(&self, desiredName: &windows_core::HSTRING, options: CreationCollisionOption) -> windows_result::Result<windows_future::IAsyncOperation<StorageFolder>>;
    fn GetFileAsync(&self, name: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>>;
    fn GetFolderAsync(&self, name: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFolder>>;
    fn GetItemAsync(&self, name: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<IStorageItem>>;
    fn GetFilesAsyncOverloadDefaultOptionsStartAndCount(&self) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<StorageFile>>>;
    fn GetFoldersAsyncOverloadDefaultOptionsStartAndCount(&self) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<StorageFolder>>>;
    fn GetItemsAsyncOverloadDefaultStartAndCount(&self) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<IStorageItem>>>;
}
#[cfg(all(feature = "Storage_FileProperties", feature = "Storage_Search", feature = "Storage_Streams"))]
...
impl IStorageFolder2 {
    pub fn TryGetItemAsync(&self, name: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<IStorageItem>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IStorageFolder2_Impl: windows_core::IUnknownImpl {
    fn TryGetItemAsync(&self, name: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<IStorageItem>>;
}
...
pub trait IStorageItem_Impl: windows_core::IUnknownImpl {
    fn RenameAsyncOverloadDefaultOptions(&self, desiredName: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction>;
    fn RenameAsync(&self, desiredName: &windows_core::HSTRING, option: NameCollisionOption) -> windows_result::Result<windows_future::IAsyncAction>;
    fn DeleteAsyncOverloadDefaultOptions(&self) -> windows_result::Result<windows_future::IAsyncAction>;
    fn DeleteAsync(&self, option: StorageDeleteOption) -> windows_result::Result<windows_future::IAsyncAction>;
    fn GetBasicPropertiesAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<FileProperties::BasicProperties>>;
    fn Name(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn Path(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn Attributes(&self) -> windows_result::Result<FileAttributes>;
    fn DateCreated(&self) -> windows_result::Result<super::Foundation::DateTime>;
    fn IsOfType(&self, r#type: StorageItemTypes) -> windows_result::Result<bool>;
}
#[cfg(feature = "Storage_FileProperties")]
...
impl IStorageItem2 {
    #[cfg(feature = "Storage_Search")]
    pub fn GetParentAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<StorageFolder>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IStorageItem2_Impl: IStorageItem_Impl {
    fn GetParentAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<StorageFolder>>;
    fn IsEqual(&self, item: windows_core::Ref<IStorageItem>) -> windows_result::Result<bool>;
}
#[cfg(all(feature = "Storage_FileProperties", feature = "Storage_Search"))]
...
impl IStorageItemProperties {
    #[cfg(all(feature = "Storage_FileProperties", feature = "Storage_Streams"))]
    pub fn GetThumbnailAsyncOverloadDefaultSizeDefaultOptions(&self, mode: FileProperties::ThumbnailMode) -> windows_result::Result<windows_future::IAsyncOperation<FileProperties::StorageItemThumbnail>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Storage_FileProperties", feature = "Storage_Streams"))]
    pub fn GetThumbnailAsyncOverloadDefaultOptions(&self, mode: FileProperties::ThumbnailMode, requestedsize: u32) -> windows_result::Result<windows_future::IAsyncOperation<FileProperties::StorageItemThumbnail>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Storage_FileProperties", feature = "Storage_Streams"))]
    pub fn GetThumbnailAsync(&self, mode: FileProperties::ThumbnailMode, requestedsize: u32, options: FileProperties::ThumbnailOptions) -> windows_result::Result<windows_future::IAsyncOperation<FileProperties::StorageItemThumbnail>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_FileProperties")]
    pub fn Properties(&self) -> windows_result::Result<FileProperties::StorageItemContentProperties> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IStorageItemProperties_Impl: windows_core::IUnknownImpl {
    fn GetThumbnailAsyncOverloadDefaultSizeDefaultOptions(&self, mode: FileProperties::ThumbnailMode) -> windows_result::Result<windows_future::IAsyncOperation<FileProperties::StorageItemThumbnail>>;
    fn GetThumbnailAsyncOverloadDefaultOptions(&self, mode: FileProperties::ThumbnailMode, requestedSize: u32) -> windows_result::Result<windows_future::IAsyncOperation<FileProperties::StorageItemThumbnail>>;
    fn GetThumbnailAsync(&self, mode: FileProperties::ThumbnailMode, requestedSize: u32, options: FileProperties::ThumbnailOptions) -> windows_result::Result<windows_future::IAsyncOperation<FileProperties::StorageItemThumbnail>>;
    fn DisplayName(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn DisplayType(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn FolderRelativeId(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn Properties(&self) -> windows_result::Result<FileProperties::StorageItemContentProperties>;
}
#[cfg(all(feature = "Storage_FileProperties", feature = "Storage_Streams"))]
...
impl IStorageItemProperties2 {
    #[cfg(all(feature = "Storage_FileProperties", feature = "Storage_Streams"))]
    pub fn GetScaledImageAsThumbnailAsyncOverloadDefaultSizeDefaultOptions(&self, mode: FileProperties::ThumbnailMode) -> windows_result::Result<windows_future::IAsyncOperation<FileProperties::StorageItemThumbnail>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Storage_FileProperties", feature = "Storage_Streams"))]
    pub fn GetScaledImageAsThumbnailAsyncOverloadDefaultOptions(&self, mode: FileProperties::ThumbnailMode, requestedsize: u32) -> windows_result::Result<windows_future::IAsyncOperation<FileProperties::StorageItemThumbnail>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Storage_FileProperties", feature = "Storage_Streams"))]
    pub fn GetScaledImageAsThumbnailAsync(&self, mode: FileProperties::ThumbnailMode, requestedsize: u32, options: FileProperties::ThumbnailOptions) -> windows_result::Result<windows_future::IAsyncOperation<FileProperties::StorageItemThumbnail>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IStorageItemProperties2_Impl: IStorageItemProperties_Impl {
    fn GetScaledImageAsThumbnailAsyncOverloadDefaultSizeDefaultOptions(&self, mode: FileProperties::ThumbnailMode) -> windows_result::Result<windows_future::IAsyncOperation<FileProperties::StorageItemThumbnail>>;
    fn GetScaledImageAsThumbnailAsyncOverloadDefaultOptions(&self, mode: FileProperties::ThumbnailMode, requestedSize: u32) -> windows_result::Result<windows_future::IAsyncOperation<FileProperties::StorageItemThumbnail>>;
    fn GetScaledImageAsThumbnailAsync(&self, mode: FileProperties::ThumbnailMode, requestedSize: u32, options: FileProperties::ThumbnailOptions) -> windows_result::Result<windows_future::IAsyncOperation<FileProperties::StorageItemThumbnail>>;
}
#[cfg(all(feature = "Storage_FileProperties", feature = "Storage_Streams"))]
...
impl IStorageItemPropertiesWithProvider {
    pub fn Provider(&self) -> windows_result::Result<StorageProvider> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IStorageItemPropertiesWithProvider_Impl: IStorageItemProperties_Impl {
    fn Provider(&self) -> windows_result::Result<StorageProvider>;
}
#[cfg(all(feature = "Storage_FileProperties", feature = "Storage_Streams"))]
...
impl IStreamedFileDataRequest {
    pub fn FailAndClose(&self, failuremode: StreamedFileFailureMode) -> windows_result::Result<()> {
        let this = self;
...
pub trait IStreamedFileDataRequest_Impl: windows_core::IUnknownImpl {
    fn FailAndClose(&self, failureMode: StreamedFileFailureMode) -> windows_result::Result<()>;
}
...
impl KnownFolders {
    #[cfg(feature = "Storage_Search")]
    pub fn CameraRoll() -> windows_result::Result<StorageFolder> {
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn Playlists() -> windows_result::Result<StorageFolder> {
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn SavedPictures() -> windows_result::Result<StorageFolder> {
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn MusicLibrary() -> windows_result::Result<StorageFolder> {
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn PicturesLibrary() -> windows_result::Result<StorageFolder> {
        Self::IKnownFoldersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn VideosLibrary() -> windows_result::Result<StorageFolder> {
        Self::IKnownFoldersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn DocumentsLibrary() -> windows_result::Result<StorageFolder> {
        Self::IKnownFoldersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn HomeGroup() -> windows_result::Result<StorageFolder> {
        Self::IKnownFoldersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn RemovableDevices() -> windows_result::Result<StorageFolder> {
        Self::IKnownFoldersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn MediaServerDevices() -> windows_result::Result<StorageFolder> {
        Self::IKnownFoldersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn Objects3D() -> windows_result::Result<StorageFolder> {
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn AppCaptures() -> windows_result::Result<StorageFolder> {
        Self::IKnownFoldersStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn RecordedCalls() -> windows_result::Result<StorageFolder> {
        Self::IKnownFoldersStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Storage_Search", feature = "System"))]
    pub fn GetFolderForUserAsync<P0>(user: P0, folderid: KnownFolderId) -> windows_result::Result<windows_future::IAsyncOperation<StorageFolder>>
    where
        P0: windows_core::Param<super::System::User>,
    {
    ...
    pub fn RequestAccessAsync(folderid: KnownFolderId) -> windows_result::Result<windows_future::IAsyncOperation<KnownFoldersAccessStatus>> {
    ...
    #[cfg(feature = "System")]
    pub fn RequestAccessForUserAsync<P0>(user: P0, folderid: KnownFolderId) -> windows_result::Result<windows_future::IAsyncOperation<KnownFoldersAccessStatus>>
    where
        P0: windows_core::Param<super::System::User>,
    {
        Self::IKnownFoldersStatics4(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn GetFolderAsync(folderid: KnownFolderId) -> windows_result::Result<windows_future::IAsyncOperation<StorageFolder>> {
        Self::IKnownFoldersStatics4(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IKnownFoldersCameraRollStatics<R, F: FnOnce(&IKnownFoldersCameraRollStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IKnownFoldersPlaylistsStatics<R, F: FnOnce(&IKnownFoldersPlaylistsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<KnownFolders, IKnownFoldersPlaylistsStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IKnownFoldersSavedPicturesStatics<R, F: FnOnce(&IKnownFoldersSavedPicturesStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IKnownFoldersStatics<R, F: FnOnce(&IKnownFoldersStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<KnownFolders, IKnownFoldersStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IKnownFoldersStatics2<R, F: FnOnce(&IKnownFoldersStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<KnownFolders, IKnownFoldersStatics2> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IKnownFoldersStatics3<R, F: FnOnce(&IKnownFoldersStatics3) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<KnownFolders, IKnownFoldersStatics3> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IKnownFoldersStatics4<R, F: FnOnce(&IKnownFoldersStatics4) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
pub struct PathIO;
impl PathIO {
    pub fn ReadTextAsync(absolutepath: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ReadTextWithEncodingAsync(absolutepath: &windows_core::HSTRING, encoding: Streams::UnicodeEncoding) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>> {
        Self::IPathIOStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn WriteTextAsync(absolutepath: &windows_core::HSTRING, contents: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction> {
        Self::IPathIOStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn WriteTextWithEncodingAsync(absolutepath: &windows_core::HSTRING, contents: &windows_core::HSTRING, encoding: Streams::UnicodeEncoding) -> windows_result::Result<windows_future::IAsyncAction> {
        Self::IPathIOStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AppendTextAsync(absolutepath: &windows_core::HSTRING, contents: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction> {
        Self::IPathIOStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn AppendTextWithEncodingAsync(absolutepath: &windows_core::HSTRING, contents: &windows_core::HSTRING, encoding: Streams::UnicodeEncoding) -> windows_result::Result<windows_future::IAsyncAction> {
        Self::IPathIOStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReadLinesAsync(absolutepath: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVector<windows_core::HSTRING>>> {
        Self::IPathIOStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ReadLinesWithEncodingAsync(absolutepath: &windows_core::HSTRING, encoding: Streams::UnicodeEncoding) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVector<windows_core::HSTRING>>> {
        Self::IPathIOStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn WriteLinesAsync<P1>(absolutepath: &windows_core::HSTRING, lines: P1) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        Self::IPathIOStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn WriteLinesWithEncodingAsync<P1>(absolutepath: &windows_core::HSTRING, lines: P1, encoding: Streams::UnicodeEncoding) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        Self::IPathIOStatics(|this| unsafe {
    ...
    pub fn AppendLinesAsync<P1>(absolutepath: &windows_core::HSTRING, lines: P1) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        Self::IPathIOStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn AppendLinesWithEncodingAsync<P1>(absolutepath: &windows_core::HSTRING, lines: P1, encoding: Streams::UnicodeEncoding) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        Self::IPathIOStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ReadBufferAsync(absolutepath: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<Streams::IBuffer>> {
        Self::IPathIOStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn WriteBufferAsync<P1>(absolutepath: &windows_core::HSTRING, buffer: P1) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P1: windows_core::Param<Streams::IBuffer>,
    {
        Self::IPathIOStatics(|this| unsafe {
    ...
    pub fn WriteBytesAsync(absolutepath: &windows_core::HSTRING, buffer: &[u8]) -> windows_result::Result<windows_future::IAsyncAction> {
        Self::IPathIOStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IPathIOStatics<R, F: FnOnce(&IPathIOStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl SetVersionRequest {
    pub fn CurrentVersion(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DesiredVersion(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDeferral(&self) -> windows_result::Result<SetVersionDeferral> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl StorageFile {
    ...
    pub fn GetFileFromPathAsync(path: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>> {
    ...
    pub fn GetFileFromApplicationUriAsync<P0>(uri: P0) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>>
    where
    ...
    pub fn CreateStreamedFileAsync<P1, P2>(displaynamewithextension: &windows_core::HSTRING, datarequested: P1, thumbnail: P2) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>>
    where
    ...
    pub fn ReplaceWithStreamedFileAsync<P0, P1, P2>(filetoreplace: P0, datarequested: P1, thumbnail: P2) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>>
    where
        P0: windows_core::Param<IStorageFile>,
        P1: windows_core::Param<StreamedFileDataRequestedHandler>,
        P2: windows_core::Param<Streams::IRandomAccessStreamReference>,
    ...
    pub fn CreateStreamedFileFromUriAsync<P1, P2>(displaynamewithextension: &windows_core::HSTRING, uri: P1, thumbnail: P2) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>>
    where
    ...
    pub fn ReplaceWithStreamedFileFromUriAsync<P0, P1, P2>(filetoreplace: P0, uri: P1, thumbnail: P2) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>>
    where
        P0: windows_core::Param<IStorageFile>,
        P1: windows_core::Param<super::Foundation::Uri>,
        P2: windows_core::Param<Streams::IRandomAccessStreamReference>,
    ...
    #[cfg(feature = "System")]
    pub fn GetFileFromPathForUserAsync<P0>(user: P0, path: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFile>>
    where
        P0: windows_core::Param<super::System::User>,
    {
    ...
    fn IStorageFileStatics<R, F: FnOnce(&IStorageFileStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<StorageFile, IStorageFileStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IStorageFileStatics2<R, F: FnOnce(&IStorageFileStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl StorageFolder {
    ...
    pub fn TryGetChangeTracker(&self) -> windows_result::Result<StorageLibraryChangeTracker> {
    ...
    pub fn GetIndexedStateAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<Search::IndexedState>> {
    ...
    pub fn CreateFileQueryOverloadDefault(&self) -> windows_result::Result<Search::StorageFileQueryResult> {
        let this = &windows_core::Interface::cast::<Search::IStorageFolderQueryOperations>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFileQuery(&self, query: Search::CommonFileQuery) -> windows_result::Result<Search::StorageFileQueryResult> {
        let this = &windows_core::Interface::cast::<Search::IStorageFolderQueryOperations>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFileQueryWithOptions<P0>(&self, queryoptions: P0) -> windows_result::Result<Search::StorageFileQueryResult>
    where
    ...
    pub fn CreateFolderQueryOverloadDefault(&self) -> windows_result::Result<Search::StorageFolderQueryResult> {
        let this = &windows_core::Interface::cast::<Search::IStorageFolderQueryOperations>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFolderQuery(&self, query: Search::CommonFolderQuery) -> windows_result::Result<Search::StorageFolderQueryResult> {
        let this = &windows_core::Interface::cast::<Search::IStorageFolderQueryOperations>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFolderQueryWithOptions<P0>(&self, queryoptions: P0) -> windows_result::Result<Search::StorageFolderQueryResult>
    where
        P0: windows_core::Param<Search::QueryOptions>,
    {
        let this = &windows_core::Interface::cast::<Search::IStorageFolderQueryOperations>(self)?;
    ...
    pub fn CreateItemQuery(&self) -> windows_result::Result<Search::StorageItemQueryResult> {
        let this = &windows_core::Interface::cast::<Search::IStorageFolderQueryOperations>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateItemQueryWithOptions<P0>(&self, queryoptions: P0) -> windows_result::Result<Search::StorageItemQueryResult>
    where
        P0: windows_core::Param<Search::QueryOptions>,
    {
        let this = &windows_core::Interface::cast::<Search::IStorageFolderQueryOperations>(self)?;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetFilesAsync(&self, query: Search::CommonFileQuery, startindex: u32, maxitemstoretrieve: u32) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<StorageFile>>> {
        let this = &windows_core::Interface::cast::<Search::IStorageFolderQueryOperations>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetFilesAsyncOverloadDefaultStartAndCount(&self, query: Search::CommonFileQuery) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<StorageFile>>> {
        let this = &windows_core::Interface::cast::<Search::IStorageFolderQueryOperations>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetFoldersAsync(&self, query: Search::CommonFolderQuery, startindex: u32, maxitemstoretrieve: u32) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<StorageFolder>>> {
        let this = &windows_core::Interface::cast::<Search::IStorageFolderQueryOperations>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetFoldersAsyncOverloadDefaultStartAndCount(&self, query: Search::CommonFolderQuery) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<StorageFolder>>> {
        let this = &windows_core::Interface::cast::<Search::IStorageFolderQueryOperations>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetItemsAsync(&self, startindex: u32, maxitemstoretrieve: u32) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<IStorageItem>>> {
        let this = &windows_core::Interface::cast::<Search::IStorageFolderQueryOperations>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsCommonFolderQuerySupported(&self, query: Search::CommonFolderQuery) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<Search::IStorageFolderQueryOperations>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsCommonFileQuerySupported(&self, query: Search::CommonFileQuery) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<Search::IStorageFolderQueryOperations>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetFolderFromPathAsync(path: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFolder>> {
    ...
    #[cfg(feature = "System")]
    pub fn GetFolderFromPathForUserAsync<P0>(user: P0, path: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<StorageFolder>>
    where
        P0: windows_core::Param<super::System::User>,
    {
    ...
    fn IStorageFolderStatics<R, F: FnOnce(&IStorageFolderStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<StorageFolder, IStorageFolderStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IStorageFolderStatics2<R, F: FnOnce(&IStorageFolderStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl StorageLibrary {
    #[cfg(feature = "Storage_Search")]
    pub fn RequestAddFolderAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<StorageFolder>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn RequestRemoveFolderAsync<P0>(&self, folder: P0) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
    ...
    #[cfg(all(feature = "Foundation_Collections", feature = "Storage_Search"))]
    pub fn Folders(&self) -> windows_result::Result<super::Foundation::Collections::IObservableVector<StorageFolder>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn SaveFolder(&self) -> windows_result::Result<StorageFolder> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DefinitionChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveDefinitionChanged(&self, eventcookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveDefinitionChanged)(windows_core::Interface::as_raw(this), eventcookie).ok() }
    }
    pub fn ChangeTracker(&self) -> windows_result::Result<StorageLibraryChangeTracker> {
    ...
    pub fn AreFolderSuggestionsAvailableAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
    ...
    pub fn GetLibraryAsync(libraryid: KnownLibraryId) -> windows_result::Result<windows_future::IAsyncOperation<StorageLibrary>> {
    ...
    #[cfg(feature = "System")]
    pub fn GetLibraryForUserAsync<P0>(user: P0, libraryid: KnownLibraryId) -> windows_result::Result<windows_future::IAsyncOperation<StorageLibrary>>
    where
        P0: windows_core::Param<super::System::User>,
    {
    ...
    fn IStorageLibraryStatics<R, F: FnOnce(&IStorageLibraryStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<StorageLibrary, IStorageLibraryStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IStorageLibraryStatics2<R, F: FnOnce(&IStorageLibraryStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl StorageLibraryChange {
    pub fn ChangeType(&self) -> windows_result::Result<StorageLibraryChangeType> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PreviousPath(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetStorageItemAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<IStorageItem>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl StorageLibraryChangeReader {
    pub fn ReadBatchAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<StorageLibraryChange>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AcceptChangesAsync(&self) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetLastChangeId(&self) -> windows_result::Result<u64> {
...
impl StorageLibraryChangeTracker {
    pub fn GetChangeReader(&self) -> windows_result::Result<StorageLibraryChangeReader> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EnableWithOptions<P0>(&self, options: P0) -> windows_result::Result<()>
    where
...
impl StorageLibraryChangeTrackerOptions {
    ...
    pub fn TrackChangeDetails(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTrackChangeDetails(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
...
impl StorageLibraryLastChangeId {
    pub fn Unknown() -> windows_result::Result<u64> {
    ...
    fn IStorageLibraryLastChangeIdStatics<R, F: FnOnce(&IStorageLibraryLastChangeIdStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl StorageProvider {
    ...
    pub fn IsPropertySupportedForPartialFileAsync(&self, propertycanonicalname: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
...
impl StorageStreamTransaction {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Stream(&self) -> windows_result::Result<Streams::IRandomAccessStream> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CommitAsync(&self) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl StreamedFileDataRequestedHandler {
    pub fn new<F: Fn(windows_core::Ref<StreamedFileDataRequest>) -> windows_result::Result<()> + Send + 'static>(invoke: F) -> Self {
    ...
    pub fn Invoke<P0>(&self, stream: P0) -> windows_result::Result<()>
    where
...
#[cfg(feature = "Storage_Streams")]
#[repr(C)]
struct StreamedFileDataRequestedHandlerBox<F: Fn(windows_core::Ref<StreamedFileDataRequest>) -> windows_result::Result<()> + Send + 'static> {
    vtable: *const StreamedFileDataRequestedHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
#[cfg(feature = "Storage_Streams")]
impl<F: Fn(windows_core::Ref<StreamedFileDataRequest>) -> windows_result::Result<()> + Send + 'static> StreamedFileDataRequestedHandlerBox<F> {
...
impl SystemAudioProperties {
    pub fn EncodingBitrate(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SystemDataPaths {
    pub fn Fonts(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Public(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PublicDesktop(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PublicDocuments(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PublicDownloads(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PublicMusic(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PublicPictures(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PublicVideos(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn System(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SystemHost(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SystemX86(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SystemX64(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SystemArm(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UserProfiles(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Windows(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDefault() -> windows_result::Result<SystemDataPaths> {
        Self::ISystemDataPathsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefault)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn ISystemDataPathsStatics<R, F: FnOnce(&ISystemDataPathsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl SystemGPSProperties {
    pub fn LatitudeDecimal(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LongitudeDecimal(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SystemImageProperties {
    pub fn HorizontalSize(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn VerticalSize(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SystemMediaProperties {
    pub fn Duration(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Producer(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Writer(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Year(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SystemMusicProperties {
    ...
    pub fn Composer(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Conductor(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DisplayArtist(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TrackNumber(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SystemPhotoProperties {
    ...
    pub fn DateTaken(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Orientation(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PeopleNames(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SystemProperties {
    pub fn Author() -> windows_result::Result<windows_core::HSTRING> {
    ...
    pub fn Comment() -> windows_result::Result<windows_core::HSTRING> {
        Self::ISystemProperties(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ItemNameDisplay() -> windows_result::Result<windows_core::HSTRING> {
        Self::ISystemProperties(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Keywords() -> windows_result::Result<windows_core::HSTRING> {
        Self::ISystemProperties(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Rating() -> windows_result::Result<windows_core::HSTRING> {
        Self::ISystemProperties(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Audio() -> windows_result::Result<SystemAudioProperties> {
        Self::ISystemProperties(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GPS() -> windows_result::Result<SystemGPSProperties> {
        Self::ISystemProperties(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Media() -> windows_result::Result<SystemMediaProperties> {
        Self::ISystemProperties(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Music() -> windows_result::Result<SystemMusicProperties> {
        Self::ISystemProperties(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Photo() -> windows_result::Result<SystemPhotoProperties> {
        Self::ISystemProperties(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Video() -> windows_result::Result<SystemVideoProperties> {
        Self::ISystemProperties(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Image() -> windows_result::Result<SystemImageProperties> {
        Self::ISystemProperties(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn ISystemProperties<R, F: FnOnce(&ISystemProperties) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl SystemVideoProperties {
    pub fn Director(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FrameHeight(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FrameWidth(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TotalBitrate(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UserDataPaths {
    pub fn CameraRoll(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Downloads(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LocalAppDataLow(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Music(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Pictures(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Profile(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Recent(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SavedPictures(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Screenshots(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Templates(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Videos(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "System")]
    pub fn GetForUser<P0>(user: P0) -> windows_result::Result<UserDataPaths>
    where
        P0: windows_core::Param<super::System::User>,
    {
    ...
    pub fn GetDefault() -> windows_result::Result<UserDataPaths> {
        Self::IUserDataPathsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefault)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IUserDataPathsStatics<R, F: FnOnce(&IUserDataPathsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
