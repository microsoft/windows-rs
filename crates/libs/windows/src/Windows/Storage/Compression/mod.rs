...
#[cfg(feature = "Storage_Streams")]
windows_core::imp::required_hierarchy!(Compressor, super::super::Foundation::IClosable, ICompressor, ICompressorFactory, super::Streams::IOutputStream);
#[cfg(feature = "Storage_Streams")]
impl Compressor {
...
#[cfg(feature = "Storage_Streams")]
windows_core::imp::required_hierarchy!(Decompressor, super::super::Foundation::IClosable, IDecompressor, IDecompressorFactory, super::Streams::IInputStream);
#[cfg(feature = "Storage_Streams")]
impl Decompressor {
    pub fn Close(&self) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<super::super::Foundation::IClosable>(self)?;
