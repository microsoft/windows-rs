...
impl Compressor {
    ...
    pub fn FinishAsync(&self) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn DetachStream(&self) -> Result<super::Streams::IOutputStream, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateCompressor<P0>(underlyingstream: P0) -> Result<Compressor, windows_result::HRESULT>
    where
    ...
    pub fn CreateCompressorEx<P0>(underlyingstream: P0, algorithm: CompressAlgorithm, blocksize: u32) -> Result<Compressor, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Streams::IOutputStream>,
    {
        Self::ICompressorFactory(|this| unsafe {
    ...
    fn ICompressorFactory<R, F: FnOnce(&ICompressorFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl Decompressor {
    ...
    pub fn DetachStream(&self) -> Result<super::Streams::IInputStream, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DetachStream)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CreateDecompressor<P0>(underlyingstream: P0) -> Result<Decompressor, windows_result::HRESULT>
    where
    ...
    pub fn ReadAsync<P0>(&self, buffer: P0, count: u32, options: super::Streams::InputStreamOptions) -> Result<windows_future::IAsyncOperationWithProgress<super::Streams::IBuffer, u32>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Streams::IBuffer>,
    {
    ...
    fn IDecompressorFactory<R, F: FnOnce(&IDecompressorFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
