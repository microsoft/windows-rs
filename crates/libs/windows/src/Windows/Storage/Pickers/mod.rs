...
impl FileExtensionVector {
    ...
    pub fn GetView(&self) -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAt(&self, index: u32, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn InsertAt(&self, index: u32, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Append(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn ReplaceAll(&self, items: &[windows_core::HSTRING]) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl FileOpenPicker {
    ...
    pub fn ViewMode(&self) -> Result<PickerViewMode, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetViewMode(&self, value: PickerViewMode) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn SetSettingsIdentifier(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn SuggestedStartLocation(&self) -> Result<PickerLocationId, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSuggestedStartLocation(&self, value: PickerLocationId) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSuggestedStartLocation)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CommitButtonText(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCommitButtonText(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn FileTypeFilter(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PickSingleFileAsync(&self) -> Result<windows_future::IAsyncOperation<super::StorageFile>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn PickMultipleFilesAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::StorageFile>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PickSingleFileAndContinue(&self) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IFileOpenPicker2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).PickSingleFileAndContinue)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn PickMultipleFilesAndContinue(&self) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IFileOpenPicker2>(self)?;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ResumePickSingleFileAsync() -> Result<windows_future::IAsyncOperation<super::StorageFile>, windows_result::HRESULT> {
    ...
    #[cfg(feature = "System")]
    pub fn CreateForUser<P0>(user: P0) -> Result<FileOpenPicker, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn PickSingleFileAsync2(&self, pickeroperationid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<super::StorageFile>, windows_result::HRESULT> {
    ...
    fn IFileOpenPickerStatics<R, F: FnOnce(&IFileOpenPickerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<FileOpenPicker, IFileOpenPickerStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IFileOpenPickerStatics2<R, F: FnOnce(&IFileOpenPickerStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl FilePickerFileTypesOrderedMap {
    pub fn First(&self) -> Result<windows_collections::IIterator<windows_collections::IKeyValuePair<windows_core::HSTRING, windows_collections::IVector<windows_core::HSTRING>>>, windows_result::HRESULT> {
    ...
    pub fn Lookup(&self, key: &windows_core::HSTRING) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetView(&self) -> Result<windows_collections::IMapView<windows_core::HSTRING, windows_collections::IVector<windows_core::HSTRING>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl FilePickerSelectedFilesArray {
    pub fn First(&self) -> Result<windows_collections::IIterator<super::StorageFile>, windows_result::HRESULT> {
    ...
    pub fn GetAt(&self, index: u32) -> Result<super::StorageFile, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMany(&self, startindex: u32, items: &mut [Option<super::StorageFile>]) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetMany)(windows_core::Interface::as_raw(this), startindex, items.len().try_into().unwrap(), core::mem::transmute_copy(&items), &mut result__).map(|| result__)
...
impl FileSavePicker {
    ...
    pub fn FileTypeChoices(&self) -> Result<windows_collections::IMap<windows_core::HSTRING, windows_collections::IVector<windows_core::HSTRING>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DefaultFileExtension(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDefaultFileExtension(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SuggestedSaveFile(&self) -> Result<super::StorageFile, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetSuggestedSaveFile<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::StorageFile>,
    {
        let this = self;
    ...
    pub fn SuggestedFileName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSuggestedFileName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn PickSaveFileAsync(&self) -> Result<windows_future::IAsyncOperation<super::StorageFile>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PickSaveFileAndContinue(&self) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IFileSavePicker2>(self)?;
    ...
    pub fn SetEnterpriseId(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IFileSavePicker3>(self)?;
    ...
    #[cfg(feature = "System")]
    pub fn CreateForUser<P0>(user: P0) -> Result<FileSavePicker, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::System::User>,
    {
    ...
    fn IFileSavePickerStatics<R, F: FnOnce(&IFileSavePickerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl FolderPicker {
    ...
    pub fn PickSingleFolderAsync(&self) -> Result<windows_future::IAsyncOperation<super::StorageFolder>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PickFolderAndContinue(&self) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IFolderPicker2>(self)?;
    ...
    #[cfg(feature = "System")]
    pub fn CreateForUser<P0>(user: P0) -> Result<FolderPicker, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::System::User>,
    {
    ...
    fn IFolderPickerStatics<R, F: FnOnce(&IFolderPickerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
