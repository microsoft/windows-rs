...
windows_core::imp::required_hierarchy!(FileOpenPicker, IFileOpenPicker, IFileOpenPicker2, IFileOpenPicker3, IFileOpenPickerStatics, IFileOpenPickerStatics2, IFileOpenPickerWithOperationId);
impl FileOpenPicker {
...
windows_core::imp::required_hierarchy!(FileSavePicker, IFileSavePicker, IFileSavePicker2, IFileSavePicker3, IFileSavePicker4, IFileSavePickerStatics);
impl FileSavePicker {
    pub fn new() -> windows_core::Result<Self> {
        Self::IActivationFactory(|f| f.ActivateInstance::<Self>())
    }
...
windows_core::imp::required_hierarchy!(FolderPicker, IFolderPicker, IFolderPicker2, IFolderPicker3, IFolderPickerStatics);
impl FolderPicker {
    pub fn new() -> windows_core::Result<Self> {
        Self::IActivationFactory(|f| f.ActivateInstance::<Self>())
    }
