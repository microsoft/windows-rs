...
impl FileOpenPickerUI {
    ...
    pub fn AddFile<P1>(&self, id: &windows_core::HSTRING, file: P1) -> Result<AddFileResult, windows_result::HRESULT>
    where
    ...
    pub fn RemoveFile(&self, id: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveFile)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(id)).ok() }
    }
    pub fn ContainsFile(&self, id: &windows_core::HSTRING) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CanAddFile<P0>(&self, file: P0) -> Result<bool, windows_result::HRESULT>
    where
    ...
    pub fn AllowedFileTypes(&self) -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SelectionMode(&self) -> Result<FileSelectionMode, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SettingsIdentifier(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FileRemoved<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveFileRemoved(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveFileRemoved)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn Closing<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveClosing(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl FileSavePickerUI {
    ...
    pub fn FileName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TrySetFileName(&self, value: &windows_core::HSTRING) -> Result<SetFileNameResult, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FileNameChanged<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveFileNameChanged(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveFileNameChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn TargetFileRequested<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveTargetFileRequested(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl PickerClosingEventArgs {
    pub fn ClosingOperation(&self) -> Result<PickerClosingOperation, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PickerClosingOperation {
    pub fn GetDeferral(&self) -> Result<PickerClosingDeferral, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl TargetFileRequest {
    #[cfg(feature = "Storage_Streams")]
    pub fn TargetFile(&self) -> Result<super::super::IStorageFile, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetTargetFile<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::IStorageFile>,
    {
        let this = self;
    ...
    pub fn GetDeferral(&self) -> Result<TargetFileRequestDeferral, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDeferral)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl TargetFileRequestedEventArgs {
    pub fn Request(&self) -> Result<TargetFileRequest, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
