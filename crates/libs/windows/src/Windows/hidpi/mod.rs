...
#[inline]
pub unsafe fn HidP_GetButtonArray(reporttype: HIDP_REPORT_TYPE, usagepage: super::hidusage::USAGE, linkcollection: Option<u16>, usage: super::hidusage::USAGE, buttondata: *mut HIDP_BUTTON_ARRAY_DATA, buttondatalength: *mut u16, preparseddata: *const _HIDP_PREPARSED_DATA, report: &[u8]) -> super::bcrypt::NTSTATUS {
...
#[cfg(all(feature = "bcrypt", feature = "hidusage"))]
#[inline]
pub unsafe fn HidP_GetButtonCaps(reporttype: HIDP_REPORT_TYPE, buttoncaps: *mut HIDP_BUTTON_CAPS, buttoncapslength: *mut u16, preparseddata: *const _HIDP_PREPARSED_DATA) -> super::bcrypt::NTSTATUS {
    windows_core::link!("hid.dll" "system" fn HidP_GetButtonCaps(reporttype : HIDP_REPORT_TYPE, buttoncaps : *mut HIDP_BUTTON_CAPS, buttoncapslength : *mut u16, preparseddata : *const _HIDP_PREPARSED_DATA) -> super::bcrypt::NTSTATUS);
    unsafe { HidP_GetButtonCaps(reporttype, buttoncaps as _, buttoncapslength as _, preparseddata) }
}
#[cfg(all(feature = "bcrypt", feature = "hidusage"))]
#[inline]
pub unsafe fn HidP_GetCaps(preparseddata: *const _HIDP_PREPARSED_DATA, capabilities: *mut HIDP_CAPS) -> super::bcrypt::NTSTATUS {
    windows_core::link!("hid.dll" "system" fn HidP_GetCaps(preparseddata : *const _HIDP_PREPARSED_DATA, capabilities : *mut HIDP_CAPS) -> super::bcrypt::NTSTATUS);
...
#[cfg(feature = "bcrypt")]
#[inline]
pub unsafe fn HidP_GetExtendedAttributes(reporttype: HIDP_REPORT_TYPE, dataindex: u16, preparseddata: *const _HIDP_PREPARSED_DATA, attributes: *mut HIDP_EXTENDED_ATTRIBUTES, lengthattributes: *mut u32) -> super::bcrypt::NTSTATUS {
    windows_core::link!("hid.dll" "system" fn HidP_GetExtendedAttributes(reporttype : HIDP_REPORT_TYPE, dataindex : u16, preparseddata : *const _HIDP_PREPARSED_DATA, attributes : *mut HIDP_EXTENDED_ATTRIBUTES, lengthattributes : *mut u32) -> super::bcrypt::NTSTATUS);
    unsafe { HidP_GetExtendedAttributes(reporttype, dataindex, preparseddata, attributes as _, lengthattributes as _) }
}
#[cfg(all(feature = "bcrypt", feature = "hidusage"))]
#[inline]
pub unsafe fn HidP_GetLinkCollectionNodes(linkcollectionnodes: *mut HIDP_LINK_COLLECTION_NODE, linkcollectionnodeslength: *mut u32, preparseddata: *const _HIDP_PREPARSED_DATA) -> super::bcrypt::NTSTATUS {
    windows_core::link!("hid.dll" "system" fn HidP_GetLinkCollectionNodes(linkcollectionnodes : *mut HIDP_LINK_COLLECTION_NODE, linkcollectionnodeslength : *mut u32, preparseddata : *const _HIDP_PREPARSED_DATA) -> super::bcrypt::NTSTATUS);
    unsafe { HidP_GetLinkCollectionNodes(linkcollectionnodes as _, linkcollectionnodeslength as _, preparseddata) }
}
#[cfg(all(feature = "bcrypt", feature = "hidusage"))]
#[inline]
pub unsafe fn HidP_GetScaledUsageValue(reporttype: HIDP_REPORT_TYPE, usagepage: super::hidusage::USAGE, linkcollection: Option<u16>, usage: super::hidusage::USAGE, usagevalue: *mut i32, preparseddata: *const _HIDP_PREPARSED_DATA, report: &[u8]) -> super::bcrypt::NTSTATUS {
    windows_core::link!("hid.dll" "system" fn HidP_GetScaledUsageValue(reporttype : HIDP_REPORT_TYPE, usagepage : super::hidusage::USAGE, linkcollection : u16, usage : super::hidusage::USAGE, usagevalue : *mut i32, preparseddata : *const _HIDP_PREPARSED_DATA, report : *const i8, reportlength : u32) -> super::bcrypt::NTSTATUS);
...
#[cfg(all(feature = "bcrypt", feature = "hidusage"))]
#[inline]
pub unsafe fn HidP_GetSpecificButtonCaps(reporttype: HIDP_REPORT_TYPE, usagepage: Option<super::hidusage::USAGE>, linkcollection: Option<u16>, usage: Option<super::hidusage::USAGE>, buttoncaps: *mut HIDP_BUTTON_CAPS, buttoncapslength: *mut u16, preparseddata: *const _HIDP_PREPARSED_DATA) -> super::bcrypt::NTSTATUS {
    windows_core::link!("hid.dll" "system" fn HidP_GetSpecificButtonCaps(reporttype : HIDP_REPORT_TYPE, usagepage : super::hidusage::USAGE, linkcollection : u16, usage : super::hidusage::USAGE, buttoncaps : *mut HIDP_BUTTON_CAPS, buttoncapslength : *mut u16, preparseddata : *const _HIDP_PREPARSED_DATA) -> super::bcrypt::NTSTATUS);
...
#[cfg(all(feature = "bcrypt", feature = "hidusage"))]
#[inline]
pub unsafe fn HidP_GetSpecificValueCaps(reporttype: HIDP_REPORT_TYPE, usagepage: Option<super::hidusage::USAGE>, linkcollection: Option<u16>, usage: Option<super::hidusage::USAGE>, valuecaps: *mut HIDP_VALUE_CAPS, valuecapslength: *mut u16, preparseddata: *const _HIDP_PREPARSED_DATA) -> super::bcrypt::NTSTATUS {
    windows_core::link!("hid.dll" "system" fn HidP_GetSpecificValueCaps(reporttype : HIDP_REPORT_TYPE, usagepage : super::hidusage::USAGE, linkcollection : u16, usage : super::hidusage::USAGE, valuecaps : *mut HIDP_VALUE_CAPS, valuecapslength : *mut u16, preparseddata : *const _HIDP_PREPARSED_DATA) -> super::bcrypt::NTSTATUS);
...
#[cfg(all(feature = "bcrypt", feature = "hidusage"))]
#[inline]
pub unsafe fn HidP_GetUsageValue(reporttype: HIDP_REPORT_TYPE, usagepage: super::hidusage::USAGE, linkcollection: Option<u16>, usage: super::hidusage::USAGE, usagevalue: *mut u32, preparseddata: *const _HIDP_PREPARSED_DATA, report: &[u8]) -> super::bcrypt::NTSTATUS {
    windows_core::link!("hid.dll" "system" fn HidP_GetUsageValue(reporttype : HIDP_REPORT_TYPE, usagepage : super::hidusage::USAGE, linkcollection : u16, usage : super::hidusage::USAGE, usagevalue : *mut u32, preparseddata : *const _HIDP_PREPARSED_DATA, report : *const i8, reportlength : u32) -> super::bcrypt::NTSTATUS);
...
#[cfg(all(feature = "bcrypt", feature = "hidusage"))]
#[inline]
pub unsafe fn HidP_GetUsagesEx(reporttype: HIDP_REPORT_TYPE, linkcollection: Option<u16>, buttonlist: *mut USAGE_AND_PAGE, usagelength: *mut u32, preparseddata: *const _HIDP_PREPARSED_DATA, report: &[u8]) -> super::bcrypt::NTSTATUS {
    windows_core::link!("hid.dll" "system" fn HidP_GetUsagesEx(reporttype : HIDP_REPORT_TYPE, linkcollection : u16, buttonlist : *mut USAGE_AND_PAGE, usagelength : *mut u32, preparseddata : *const _HIDP_PREPARSED_DATA, report : *const i8, reportlength : u32) -> super::bcrypt::NTSTATUS);
...
#[cfg(all(feature = "bcrypt", feature = "hidusage"))]
#[inline]
pub unsafe fn HidP_GetValueCaps(reporttype: HIDP_REPORT_TYPE, valuecaps: *mut HIDP_VALUE_CAPS, valuecapslength: *mut u16, preparseddata: *const _HIDP_PREPARSED_DATA) -> super::bcrypt::NTSTATUS {
    windows_core::link!("hid.dll" "system" fn HidP_GetValueCaps(reporttype : HIDP_REPORT_TYPE, valuecaps : *mut HIDP_VALUE_CAPS, valuecapslength : *mut u16, preparseddata : *const _HIDP_PREPARSED_DATA) -> super::bcrypt::NTSTATUS);
...
#[inline]
pub unsafe fn HidP_MaxUsageListLength(reporttype: HIDP_REPORT_TYPE, usagepage: Option<super::hidusage::USAGE>, preparseddata: *const _HIDP_PREPARSED_DATA) -> u32 {
    windows_core::link!("hid.dll" "system" fn HidP_MaxUsageListLength(reporttype : HIDP_REPORT_TYPE, usagepage : super::hidusage::USAGE, preparseddata : *const _HIDP_PREPARSED_DATA) -> u32);
...
#[cfg(feature = "bcrypt")]
#[inline]
pub unsafe fn HidP_SetData(reporttype: HIDP_REPORT_TYPE, datalist: *mut HIDP_DATA, datalength: *mut u32, preparseddata: *const _HIDP_PREPARSED_DATA, report: &[u8]) -> super::bcrypt::NTSTATUS {
    windows_core::link!("hid.dll" "system" fn HidP_SetData(reporttype : HIDP_REPORT_TYPE, datalist : *mut HIDP_DATA, datalength : *mut u32, preparseddata : *const _HIDP_PREPARSED_DATA, report : *const i8, reportlength : u32) -> super::bcrypt::NTSTATUS);
...
#[cfg(all(feature = "bcrypt", feature = "hidusage"))]
#[inline]
pub unsafe fn HidP_SetUsages(reporttype: HIDP_REPORT_TYPE, usagepage: super::hidusage::USAGE, linkcollection: Option<u16>, usagelist: *mut u16, usagelength: *mut u32, preparseddata: *const _HIDP_PREPARSED_DATA, report: &[u8]) -> super::bcrypt::NTSTATUS {
    windows_core::link!("hid.dll" "system" fn HidP_SetUsages(reporttype : HIDP_REPORT_TYPE, usagepage : super::hidusage::USAGE, linkcollection : u16, usagelist : *mut u16, usagelength : *mut u32, preparseddata : *const _HIDP_PREPARSED_DATA, report : *const i8, reportlength : u32) -> super::bcrypt::NTSTATUS);
...
#[cfg(all(feature = "bcrypt", feature = "hidusage"))]
#[inline]
pub unsafe fn HidP_UnsetUsages(reporttype: HIDP_REPORT_TYPE, usagepage: super::hidusage::USAGE, linkcollection: Option<u16>, usagelist: *mut u16, usagelength: *mut u32, preparseddata: *const _HIDP_PREPARSED_DATA, report: &[u8]) -> super::bcrypt::NTSTATUS {
    windows_core::link!("hid.dll" "system" fn HidP_UnsetUsages(reporttype : HIDP_REPORT_TYPE, usagepage : super::hidusage::USAGE, linkcollection : u16, usagelist : *mut u16, usagelength : *mut u32, preparseddata : *const _HIDP_PREPARSED_DATA, report : *const i8, reportlength : u32) -> super::bcrypt::NTSTATUS);
...
#[cfg(feature = "bcrypt")]
#[inline]
pub unsafe fn HidP_UsageListDifference(previoususagelist: *const u16, currentusagelist: *const u16, breakusagelist: *mut u16, makeusagelist: *mut u16, usagelistlength: u32) -> super::bcrypt::NTSTATUS {
    windows_core::link!("hid.dll" "system" fn HidP_UsageListDifference(previoususagelist : *const u16, currentusagelist : *const u16, breakusagelist : *mut u16, makeusagelist : *mut u16, usagelistlength : u32) -> super::bcrypt::NTSTATUS);
