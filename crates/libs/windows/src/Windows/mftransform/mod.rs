...
pub trait IMFDeviceTransform_Impl: windows_core::IUnknownImpl {
    ...
    fn GetInputCurrentType(&self, dwinputstreamid: u32) -> windows_core::Result<super::mfobjects::IMFMediaType>;
    fn GetInputStreamAttributes(&self, dwinputstreamid: u32) -> windows_core::Result<super::mfobjects::IMFAttributes>;
    fn GetOutputAvailableType(&self, dwoutputstreamid: u32, dwtypeindex: u32) -> windows_core::Result<super::mfobjects::IMFMediaType>;
    fn GetOutputCurrentType(&self, dwoutputstreamid: u32) -> windows_core::Result<super::mfobjects::IMFMediaType>;
    fn GetOutputStreamAttributes(&self, dwoutputstreamid: u32) -> windows_core::Result<super::mfobjects::IMFAttributes>;
    ...
    fn ProcessEvent(&self, dwinputstreamid: u32, pevent: windows_core::Ref<super::mfobjects::IMFMediaEvent>) -> windows_core::Result<()>;
    ...
    fn SetInputStreamState(&self, dwstreamid: u32, pmediatype: windows_core::Ref<super::mfobjects::IMFMediaType>, value: DeviceStreamState, dwflags: u32) -> windows_core::Result<()>;
    fn GetInputStreamState(&self, dwstreamid: u32) -> windows_core::Result<DeviceStreamState>;
    fn SetOutputStreamState(&self, dwstreamid: u32, pmediatype: windows_core::Ref<super::mfobjects::IMFMediaType>, value: DeviceStreamState, dwflags: u32) -> windows_core::Result<()>;
    fn GetOutputStreamState(&self, dwstreamid: u32) -> windows_core::Result<DeviceStreamState>;
    fn GetInputStreamPreferredState(&self, dwstreamid: u32, value: *mut DeviceStreamState, ppmediatype: windows_core::OutRef<super::mfobjects::IMFMediaType>) -> windows_core::Result<()>;
...
pub trait IMFTransform_Impl: windows_core::IUnknownImpl {
    ...
    fn GetAttributes(&self) -> windows_core::Result<super::mfobjects::IMFAttributes>;
    fn GetInputStreamAttributes(&self, dwinputstreamid: u32) -> windows_core::Result<super::mfobjects::IMFAttributes>;
    fn GetOutputStreamAttributes(&self, dwoutputstreamid: u32) -> windows_core::Result<super::mfobjects::IMFAttributes>;
    ...
    fn GetInputAvailableType(&self, dwinputstreamid: u32, dwtypeindex: u32) -> windows_core::Result<super::mfobjects::IMFMediaType>;
    fn GetOutputAvailableType(&self, dwoutputstreamid: u32, dwtypeindex: u32) -> windows_core::Result<super::mfobjects::IMFMediaType>;
    fn SetInputType(&self, dwinputstreamid: u32, ptype: windows_core::Ref<super::mfobjects::IMFMediaType>, dwflags: u32) -> windows_core::Result<()>;
    fn SetOutputType(&self, dwoutputstreamid: u32, ptype: windows_core::Ref<super::mfobjects::IMFMediaType>, dwflags: u32) -> windows_core::Result<()>;
    fn GetInputCurrentType(&self, dwinputstreamid: u32) -> windows_core::Result<super::mfobjects::IMFMediaType>;
    fn GetOutputCurrentType(&self, dwoutputstreamid: u32) -> windows_core::Result<super::mfobjects::IMFMediaType>;
...
pub struct MFT_OUTPUT_DATA_BUFFER {
    ...
    pub dwStatus: u32,
    pub pEvents: core::mem::ManuallyDrop<Option<super::mfobjects::IMFCollection>>,
}
