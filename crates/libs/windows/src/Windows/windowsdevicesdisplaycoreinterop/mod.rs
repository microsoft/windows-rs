...
impl IDisplayDeviceInterop {
    ...
    pub unsafe fn CreateSharedHandle<P0>(&self, pobject: P0, psecurityattributes: *const super::minwinbase::SECURITY_ATTRIBUTES, access: u32, name: &windows_core::HSTRING) -> windows_core::Result<super::winnt::HANDLE>
    where
...
pub struct IDisplayDeviceInterop_Vtbl {
    ...
    #[cfg(all(feature = "minwinbase", feature = "winnt"))]
    pub CreateSharedHandle: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *const super::minwinbase::SECURITY_ATTRIBUTES, u32, *mut core::ffi::c_void, *mut super::winnt::HANDLE) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "minwinbase", feature = "winnt")))]
    CreateSharedHandle: usize,
    #[cfg(feature = "winnt")]
    pub OpenSharedHandle: unsafe extern "system" fn(*mut core::ffi::c_void, super::winnt::HANDLE, windows_core::GUID, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "winnt"))]
    OpenSharedHandle: usize,
}
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
pub trait IDisplayDeviceInterop_Impl: windows_core::IUnknownImpl {
    fn CreateSharedHandle(&self, pobject: windows_core::Ref<windows_core::IInspectable>, psecurityattributes: *const super::minwinbase::SECURITY_ATTRIBUTES, access: u32, name: &windows_core::HSTRING) -> windows_core::Result<super::winnt::HANDLE>;
    fn OpenSharedHandle(&self, nthandle: super::winnt::HANDLE, riid: &windows_core::GUID) -> windows_core::Result<*mut core::ffi::c_void>;
}
#[cfg(all(feature = "minwinbase", feature = "winnt"))]
impl IDisplayDeviceInterop_Vtbl {
    pub const fn new<Identity: IDisplayDeviceInterop_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateSharedHandle<Identity: IDisplayDeviceInterop_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pobject: *mut core::ffi::c_void, psecurityattributes: *const super::minwinbase::SECURITY_ATTRIBUTES, access: u32, name: *mut core::ffi::c_void, phandle: *mut super::winnt::HANDLE) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn OpenSharedHandle<Identity: IDisplayDeviceInterop_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, nthandle: super::winnt::HANDLE, riid: windows_core::GUID, ppvobj: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDisplayPathInterop {
    #[cfg(feature = "winnt")]
    pub unsafe fn CreateSourcePresentationHandle(&self) -> windows_core::Result<super::winnt::HANDLE> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub struct IDisplayPathInterop_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "winnt")]
    pub CreateSourcePresentationHandle: unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::winnt::HANDLE) -> windows_core::HRESULT,
    #[cfg(not(feature = "winnt"))]
...
pub trait IDisplayPathInterop_Impl: windows_core::IUnknownImpl {
    fn CreateSourcePresentationHandle(&self) -> windows_core::Result<super::winnt::HANDLE>;
...
impl IDisplayPathInterop_Vtbl {
    pub const fn new<Identity: IDisplayPathInterop_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateSourcePresentationHandle<Identity: IDisplayPathInterop_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pvalue: *mut super::winnt::HANDLE) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
