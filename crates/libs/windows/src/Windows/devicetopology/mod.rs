...
impl IDeviceSpecificProperty_Vtbl {
    pub const fn new<Identity: IDeviceSpecificProperty_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetType<Identity: IDeviceSpecificProperty_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pvtype: *mut super::wtypes::VARTYPE) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IKsControl {
    #[cfg(feature = "ks")]
    pub unsafe fn KsProperty(&self, property: *const super::ks::KSIDENTIFIER, propertylength: u32, propertydata: *mut core::ffi::c_void, datalength: u32, bytesreturned: *mut u32) -> windows_core::HRESULT {
    ...
    #[cfg(feature = "ks")]
    pub unsafe fn KsMethod(&self, method: *const super::ks::KSIDENTIFIER, methodlength: u32, methoddata: *mut core::ffi::c_void, datalength: u32, bytesreturned: *mut u32) -> windows_core::HRESULT {
    ...
    #[cfg(feature = "ks")]
    pub unsafe fn KsEvent(&self, event: *const super::ks::KSIDENTIFIER, eventlength: u32, eventdata: *mut core::ffi::c_void, datalength: u32, bytesreturned: *mut u32) -> windows_core::HRESULT {
...
pub struct IKsControl_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "ks")]
    pub KsProperty: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::ks::KSIDENTIFIER, u32, *mut core::ffi::c_void, u32, *mut u32) -> windows_core::HRESULT,
    #[cfg(not(feature = "ks"))]
    KsProperty: usize,
    #[cfg(feature = "ks")]
    pub KsMethod: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::ks::KSIDENTIFIER, u32, *mut core::ffi::c_void, u32, *mut u32) -> windows_core::HRESULT,
    #[cfg(not(feature = "ks"))]
    KsMethod: usize,
    #[cfg(feature = "ks")]
    pub KsEvent: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::ks::KSIDENTIFIER, u32, *mut core::ffi::c_void, u32, *mut u32) -> windows_core::HRESULT,
    #[cfg(not(feature = "ks"))]
    KsEvent: usize,
}
#[cfg(feature = "ks")]
pub trait IKsControl_Impl: windows_core::IUnknownImpl {
    fn KsProperty(&self, property: *const super::ks::KSIDENTIFIER, propertylength: u32, propertydata: *mut core::ffi::c_void, datalength: u32, bytesreturned: *mut u32) -> windows_core::Result<()>;
    fn KsMethod(&self, method: *const super::ks::KSIDENTIFIER, methodlength: u32, methoddata: *mut core::ffi::c_void, datalength: u32, bytesreturned: *mut u32) -> windows_core::Result<()>;
    fn KsEvent(&self, event: *const super::ks::KSIDENTIFIER, eventlength: u32, eventdata: *mut core::ffi::c_void, datalength: u32, bytesreturned: *mut u32) -> windows_core::Result<()>;
}
#[cfg(feature = "ks")]
impl IKsControl_Vtbl {
    pub const fn new<Identity: IKsControl_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn KsProperty<Identity: IKsControl_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, property: *const super::ks::KSIDENTIFIER, propertylength: u32, propertydata: *mut core::ffi::c_void, datalength: u32, bytesreturned: *mut u32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn KsMethod<Identity: IKsControl_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, method: *const super::ks::KSIDENTIFIER, methodlength: u32, methoddata: *mut core::ffi::c_void, datalength: u32, bytesreturned: *mut u32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn KsEvent<Identity: IKsControl_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, event: *const super::ks::KSIDENTIFIER, eventlength: u32, eventdata: *mut core::ffi::c_void, datalength: u32, bytesreturned: *mut u32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IKsFormatSupport {
    #[cfg(feature = "ks")]
    pub unsafe fn IsFormatSupported(&self, pksformat: *const super::ks::KSDATARANGE, cbformat: u32) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ks")]
    pub unsafe fn GetDevicePreferredFormat(&self) -> windows_core::Result<super::ks::PKSDATAFORMAT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub struct IKsFormatSupport_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "ks")]
    pub IsFormatSupported: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::ks::KSDATARANGE, u32, *mut windows_core::BOOL) -> windows_core::HRESULT,
    #[cfg(not(feature = "ks"))]
    IsFormatSupported: usize,
    #[cfg(feature = "ks")]
    pub GetDevicePreferredFormat: unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::ks::PKSDATAFORMAT) -> windows_core::HRESULT,
    #[cfg(not(feature = "ks"))]
    GetDevicePreferredFormat: usize,
}
#[cfg(feature = "ks")]
pub trait IKsFormatSupport_Impl: windows_core::IUnknownImpl {
    fn IsFormatSupported(&self, pksformat: *const super::ks::KSDATARANGE, cbformat: u32) -> windows_core::Result<windows_core::BOOL>;
    fn GetDevicePreferredFormat(&self) -> windows_core::Result<super::ks::PKSDATAFORMAT>;
}
#[cfg(feature = "ks")]
impl IKsFormatSupport_Vtbl {
    pub const fn new<Identity: IKsFormatSupport_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsFormatSupported<Identity: IKsFormatSupport_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pksformat: *const super::ks::KSDATARANGE, cbformat: u32, pbsupported: *mut windows_core::BOOL) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetDevicePreferredFormat<Identity: IKsFormatSupport_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, ppksformat: *mut super::ks::PKSDATAFORMAT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IKsJackDescription {
    ...
    #[cfg(feature = "ksmedia")]
    pub unsafe fn GetJackDescription(&self, njack: u32, pdescription: *mut super::ksmedia::KSJACK_DESCRIPTION) -> windows_core::HRESULT {
...
pub struct IKsJackDescription_Vtbl {
    ...
    #[cfg(feature = "ksmedia")]
    pub GetJackDescription: unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut super::ksmedia::KSJACK_DESCRIPTION) -> windows_core::HRESULT,
...
pub trait IKsJackDescription_Impl: windows_core::IUnknownImpl {
    ...
    fn GetJackDescription(&self, njack: u32, pdescription: *mut super::ksmedia::KSJACK_DESCRIPTION) -> windows_core::Result<()>;
}
#[cfg(feature = "ksmedia")]
impl IKsJackDescription_Vtbl {
    pub const fn new<Identity: IKsJackDescription_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetJackDescription<Identity: IKsJackDescription_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, njack: u32, pdescription: *mut super::ksmedia::KSJACK_DESCRIPTION) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IKsJackDescription2 {
    ...
    #[cfg(feature = "ksmedia")]
    pub unsafe fn GetJackDescription2(&self, njack: u32) -> windows_core::Result<super::ksmedia::KSJACK_DESCRIPTION2> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub struct IKsJackDescription2_Vtbl {
    ...
    pub GetJackCount: unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    #[cfg(feature = "ksmedia")]
    pub GetJackDescription2: unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut super::ksmedia::KSJACK_DESCRIPTION2) -> windows_core::HRESULT,
    #[cfg(not(feature = "ksmedia"))]
...
pub trait IKsJackDescription2_Impl: windows_core::IUnknownImpl {
    fn GetJackCount(&self) -> windows_core::Result<u32>;
    fn GetJackDescription2(&self, njack: u32) -> windows_core::Result<super::ksmedia::KSJACK_DESCRIPTION2>;
}
#[cfg(feature = "ksmedia")]
impl IKsJackDescription2_Vtbl {
    pub const fn new<Identity: IKsJackDescription2_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetJackDescription2<Identity: IKsJackDescription2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, njack: u32, pdescription2: *mut super::ksmedia::KSJACK_DESCRIPTION2) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IKsJackDescription3 {
    ...
    #[cfg(feature = "ksmedia")]
    pub unsafe fn GetJackDescription3(&self, njack: u32) -> windows_core::Result<super::ksmedia::KSJACK_DESCRIPTION3> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub struct IKsJackDescription3_Vtbl {
    ...
    pub GetJackCount: unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    #[cfg(feature = "ksmedia")]
    pub GetJackDescription3: unsafe extern "system" fn(*mut core::ffi::c_void, u32, *mut super::ksmedia::KSJACK_DESCRIPTION3) -> windows_core::HRESULT,
    #[cfg(not(feature = "ksmedia"))]
...
pub trait IKsJackDescription3_Impl: windows_core::IUnknownImpl {
    fn GetJackCount(&self) -> windows_core::Result<u32>;
    fn GetJackDescription3(&self, njack: u32) -> windows_core::Result<super::ksmedia::KSJACK_DESCRIPTION3>;
}
#[cfg(feature = "ksmedia")]
impl IKsJackDescription3_Vtbl {
    pub const fn new<Identity: IKsJackDescription3_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetJackDescription3<Identity: IKsJackDescription3_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, njack: u32, pdescription3: *mut super::ksmedia::KSJACK_DESCRIPTION3) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IKsJackSinkInformation {
    ...
    pub unsafe fn GetJackSinkInformation(&self, pjacksinkinformation: *mut super::ksmedia::KSJACK_SINK_INFORMATION) -> windows_core::HRESULT {
...
pub struct IKsJackSinkInformation_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(all(feature = "ksmedia", feature = "winnt"))]
    pub GetJackSinkInformation: unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::ksmedia::KSJACK_SINK_INFORMATION) -> windows_core::HRESULT,
...
pub trait IKsJackSinkInformation_Impl: windows_core::IUnknownImpl {
    fn GetJackSinkInformation(&self, pjacksinkinformation: *mut super::ksmedia::KSJACK_SINK_INFORMATION) -> windows_core::Result<()>;
}
#[cfg(all(feature = "ksmedia", feature = "winnt"))]
impl IKsJackSinkInformation_Vtbl {
    pub const fn new<Identity: IKsJackSinkInformation_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetJackSinkInformation<Identity: IKsJackSinkInformation_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pjacksinkinformation: *mut super::ksmedia::KSJACK_SINK_INFORMATION) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
