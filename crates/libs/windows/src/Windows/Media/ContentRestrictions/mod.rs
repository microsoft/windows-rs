...
impl ContentRestrictionsBrowsePolicy {
    ...
    pub fn MaxBrowsableAgeRating(&self) -> Result<super::super::Foundation::IReference<u32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PreferredAgeRating(&self) -> Result<super::super::Foundation::IReference<u32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl RatedContentDescription {
    ...
    pub fn Category(&self) -> Result<RatedContentCategory, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCategory(&self, value: RatedContentCategory) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCategory)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Ratings(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRatings<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn Create(id: &windows_core::HSTRING, title: &windows_core::HSTRING, category: RatedContentCategory) -> Result<RatedContentDescription, windows_result::HRESULT> {
    ...
    fn IRatedContentDescriptionFactory<R, F: FnOnce(&IRatedContentDescriptionFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl RatedContentRestrictions {
    ...
    pub fn GetBrowsePolicyAsync(&self) -> Result<windows_future::IAsyncOperation<ContentRestrictionsBrowsePolicy>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetRestrictionLevelAsync<P0>(&self, ratedcontentdescription: P0) -> Result<windows_future::IAsyncOperation<ContentAccessRestrictionLevel>, windows_result::HRESULT>
    where
    ...
    pub fn RequestContentAccessAsync<P0>(&self, ratedcontentdescription: P0) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<RatedContentDescription>,
    {
        let this = self;
    ...
    pub fn RestrictionsChanged<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveRestrictionsChanged(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveRestrictionsChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn CreateWithMaxAgeRating(maxagerating: u32) -> Result<RatedContentRestrictions, windows_result::HRESULT> {
    ...
    fn IRatedContentRestrictionsFactory<R, F: FnOnce(&IRatedContentRestrictionsFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
