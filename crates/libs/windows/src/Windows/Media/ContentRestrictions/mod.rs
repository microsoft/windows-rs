...
windows_core::imp::required_hierarchy!(ContentRestrictionsBrowsePolicy, IContentRestrictionsBrowsePolicy);
...
windows_core::imp::required_hierarchy!(RatedContentDescription, IRatedContentDescription, IRatedContentDescriptionFactory);
...
windows_core::imp::required_hierarchy!(RatedContentRestrictions, IRatedContentRestrictions, IRatedContentRestrictionsFactory);
