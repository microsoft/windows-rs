...
impl AppBroadcastingMonitor {
    ...
    #[cfg(feature = "Foundation")]
    pub fn IsCurrentAppBroadcastingChanged(&self, handler: &super::super::Foundation::TypedEventHandler<AppBroadcastingMonitor, ::windows_core::IInspectable>) -> ::windows_core::Result<super::super::Foundation::EventRegistrationToken> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::EventRegistrationToken>();
            (::windows_core::Interface::vtable(this).IsCurrentAppBroadcastingChanged)(::windows_core::Interface::as_raw(this), ::core::mem::transmute_copy(handler), &mut result__).from_abi(result__)
        }
    }
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
...
impl AppBroadcastingStatus {
    ...
    pub fn Details(&self) -> ::windows_core::Result<AppBroadcastingStatusDetails> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<AppBroadcastingStatusDetails>();
...
impl AppBroadcastingUI {
    pub fn GetStatus(&self) -> ::windows_core::Result<AppBroadcastingStatus> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<AppBroadcastingStatus>();
    ...
    pub fn GetDefault() -> ::windows_core::Result<AppBroadcastingUI> {
        Self::IAppBroadcastingUIStatics(|this| unsafe {
            let mut result__ = ::windows_core::zeroed::<AppBroadcastingUI>();
            (::windows_core::Interface::vtable(this).GetDefault)(::windows_core::Interface::as_raw(this), &mut result__).from_abi(result__)
        })
    }
    #[doc = "*Required features: `\"System\"`*"]
    #[cfg(feature = "System")]
    pub fn GetForUser(user: &super::super::System::User) -> ::windows_core::Result<AppBroadcastingUI> {
        Self::IAppBroadcastingUIStatics(|this| unsafe {
            let mut result__ = ::windows_core::zeroed::<AppBroadcastingUI>();
