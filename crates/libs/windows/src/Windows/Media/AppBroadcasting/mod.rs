...
impl AppBroadcastingMonitor {
    ...
    pub fn IsCurrentAppBroadcasting(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn IsCurrentAppBroadcastingChanged<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveIsCurrentAppBroadcastingChanged(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl AppBroadcastingStatus {
    pub fn CanStartBroadcast(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Details(&self) -> Result<AppBroadcastingStatusDetails, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppBroadcastingUI {
    pub fn GetStatus(&self) -> Result<AppBroadcastingStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowBroadcastUI(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).ShowBroadcastUI)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn GetDefault() -> Result<AppBroadcastingUI, windows_result::HRESULT> {
    ...
    #[cfg(feature = "System")]
    pub fn GetForUser<P0>(user: P0) -> Result<AppBroadcastingUI, windows_result::HRESULT>
    where
    ...
    fn IAppBroadcastingUIStatics<R, F: FnOnce(&IAppBroadcastingUIStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
