...
windows_core::imp::required_hierarchy!(AdvancedPhotoCaptureSettings, IAdvancedPhotoCaptureSettings);
...
windows_core::imp::required_hierarchy!(AdvancedPhotoControl, IAdvancedPhotoControl);
...
windows_core::imp::required_hierarchy!(AudioDeviceController, IAudioDeviceController, IAudioDeviceController2, IMediaDeviceController);
...
windows_core::imp::required_hierarchy!(AudioDeviceModule, IAudioDeviceModule);
...
windows_core::imp::required_hierarchy!(AudioDeviceModuleNotificationEventArgs, IAudioDeviceModuleNotificationEventArgs);
...
windows_core::imp::required_hierarchy!(AudioDeviceModulesManager, IAudioDeviceModulesManager, IAudioDeviceModulesManagerFactory);
...
windows_core::imp::required_hierarchy!(CallControl, ICallControl, ICallControlStatics);
impl CallControl {
...
windows_core::imp::required_hierarchy!(CameraOcclusionInfo, ICameraOcclusionInfo);
...
windows_core::imp::required_hierarchy!(CameraOcclusionState, ICameraOcclusionState);
...
windows_core::imp::required_hierarchy!(CameraOcclusionStateChangedEventArgs, ICameraOcclusionStateChangedEventArgs);
...
windows_core::imp::required_hierarchy!(DialRequestedEventArgs, IDialRequestedEventArgs);
...
windows_core::imp::required_hierarchy!(DigitalWindowBounds, IDigitalWindowBounds);
...
windows_core::imp::required_hierarchy!(DigitalWindowCapability, IDigitalWindowCapability);
...
windows_core::imp::required_hierarchy!(DigitalWindowControl, IDigitalWindowControl);
...
windows_core::imp::required_hierarchy!(ExposureCompensationControl, IExposureCompensationControl);
...
windows_core::imp::required_hierarchy!(ExposureControl, IExposureControl);
...
windows_core::imp::required_hierarchy!(ExposurePriorityVideoControl, IExposurePriorityVideoControl);
...
windows_core::imp::required_hierarchy!(FlashControl, IFlashControl, IFlashControl2);
impl FlashControl {
    pub fn Supported(&self) -> windows_core::Result<bool> {
        let this = self;
        unsafe {
...
windows_core::imp::required_hierarchy!(FocusControl, IFocusControl, IFocusControl2);
impl FocusControl {
    pub fn Supported(&self) -> windows_core::Result<bool> {
        let this = self;
        unsafe {
...
windows_core::imp::required_hierarchy!(FocusSettings, IFocusSettings);
impl FocusSettings {
    pub fn new() -> windows_core::Result<Self> {
        Self::IActivationFactory(|f| f.ActivateInstance::<Self>())
    }
...
windows_core::imp::required_hierarchy!(HdrVideoControl, IHdrVideoControl);
...
windows_core::imp::required_hierarchy!(InfraredTorchControl, IInfraredTorchControl);
...
windows_core::imp::required_hierarchy!(IsoSpeedControl, IIsoSpeedControl, IIsoSpeedControl2);
...
windows_core::imp::required_hierarchy!(KeypadPressedEventArgs, IKeypadPressedEventArgs);
...
windows_core::imp::required_hierarchy!(LowLagPhotoControl, ILowLagPhotoControl);
...
windows_core::imp::required_hierarchy!(LowLagPhotoSequenceControl, ILowLagPhotoSequenceControl);
...
windows_core::imp::required_hierarchy!(MediaDeviceControl, IMediaDeviceControl);
...
windows_core::imp::required_hierarchy!(MediaDeviceControlCapabilities, IMediaDeviceControlCapabilities);
...
windows_core::imp::required_hierarchy!(ModuleCommandResult, IModuleCommandResult);
...
windows_core::imp::required_hierarchy!(OpticalImageStabilizationControl, IOpticalImageStabilizationControl);
...
windows_core::imp::required_hierarchy!(PanelBasedOptimizationControl, IPanelBasedOptimizationControl);
...
windows_core::imp::required_hierarchy!(PhotoConfirmationControl, IPhotoConfirmationControl);
...
windows_core::imp::required_hierarchy!(RedialRequestedEventArgs, IRedialRequestedEventArgs);
...
windows_core::imp::required_hierarchy!(RegionOfInterest, IRegionOfInterest, IRegionOfInterest2);
...
windows_core::imp::required_hierarchy!(RegionsOfInterestControl, IRegionsOfInterestControl);
...
windows_core::imp::required_hierarchy!(SceneModeControl, ISceneModeControl);
...
windows_core::imp::required_hierarchy!(TorchControl, ITorchControl);
impl TorchControl {
    pub fn Supported(&self) -> windows_core::Result<bool> {
        let this = self;
        unsafe {
...
windows_core::imp::required_hierarchy!(VideoDeviceControllerGetDevicePropertyResult, IVideoDeviceControllerGetDevicePropertyResult);
...
windows_core::imp::required_hierarchy!(VideoTemporalDenoisingControl, IVideoTemporalDenoisingControl);
...
windows_core::imp::required_hierarchy!(WhiteBalanceControl, IWhiteBalanceControl);
...
windows_core::imp::required_hierarchy!(ZoomControl, IZoomControl, IZoomControl2);
impl ZoomControl {
    pub fn Supported(&self) -> windows_core::Result<bool> {
        let this = self;
        unsafe {
...
windows_core::imp::required_hierarchy!(ZoomSettings, IZoomSettings);
impl ZoomSettings {
    pub fn new() -> windows_core::Result<Self> {
        Self::IActivationFactory(|f| f.ActivateInstance::<Self>())
    }
