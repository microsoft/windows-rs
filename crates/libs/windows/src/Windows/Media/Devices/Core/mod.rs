...
impl CameraIntrinsics {
    ...
    pub fn Create(focallength: super::super::super::Foundation::Numerics::Vector2, principalpoint: super::super::super::Foundation::Numerics::Vector2, radialdistortion: super::super::super::Foundation::Numerics::Vector3, tangentialdistortion: super::super::super::Foundation::Numerics::Vector2, imagewidth: u32, imageheight: u32) -> ::windows_core::Result<CameraIntrinsics> {
        Self::ICameraIntrinsicsFactory(|this| unsafe {
            let mut result__ = ::windows_core::zeroed::<CameraIntrinsics>();
...
impl DepthCorrelatedCoordinateMapper {
    ...
    #[cfg(all(feature = "Foundation_Numerics", feature = "Perception_Spatial"))]
    pub fn UnprojectPoint(&self, sourcepoint: super::super::super::Foundation::Point, targetcoordinatesystem: &super::super::super::Perception::Spatial::SpatialCoordinateSystem) -> ::windows_core::Result<super::super::super::Foundation::Numerics::Vector3> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::super::Foundation::Numerics::Vector3>();
            (::windows_core::Interface::vtable(this).UnprojectPoint)(::windows_core::Interface::as_raw(this), sourcepoint, ::core::mem::transmute_copy(targetcoordinatesystem), &mut result__).from_abi(result__)
        }
    }
    #[doc = "*Required features: `\"Foundation_Numerics\"`, `\"Perception_Spatial\"`*"]
    #[cfg(all(feature = "Foundation_Numerics", feature = "Perception_Spatial"))]
    pub fn UnprojectPoints(&self, sourcepoints: &[super::super::super::Foundation::Point], targetcoordinatesystem: &super::super::super::Perception::Spatial::SpatialCoordinateSystem, results: &mut [super::super::super::Foundation::Numerics::Vector3]) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { (::windows_core::Interface::vtable(this).UnprojectPoints)(::windows_core::Interface::as_raw(this), sourcepoints.len() as u32, sourcepoints.as_ptr(), ::core::mem::transmute_copy(targetcoordinatesystem), results.len() as u32, results.as_mut_ptr()).ok() }
    }
    #[doc = "*Required features: `\"Foundation\"`, `\"Perception_Spatial\"`*"]
    #[cfg(all(feature = "Foundation", feature = "Perception_Spatial"))]
    pub fn MapPoint(&self, sourcepoint: super::super::super::Foundation::Point, targetcoordinatesystem: &super::super::super::Perception::Spatial::SpatialCoordinateSystem, targetcameraintrinsics: &CameraIntrinsics) -> ::windows_core::Result<super::super::super::Foundation::Point> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::super::Foundation::Point>();
            (::windows_core::Interface::vtable(this).MapPoint)(::windows_core::Interface::as_raw(this), sourcepoint, ::core::mem::transmute_copy(targetcoordinatesystem), ::core::mem::transmute_copy(targetcameraintrinsics), &mut result__).from_abi(result__)
        }
    }
    #[doc = "*Required features: `\"Foundation\"`, `\"Perception_Spatial\"`*"]
    #[cfg(all(feature = "Foundation", feature = "Perception_Spatial"))]
    pub fn MapPoints(&self, sourcepoints: &[super::super::super::Foundation::Point], targetcoordinatesystem: &super::super::super::Perception::Spatial::SpatialCoordinateSystem, targetcameraintrinsics: &CameraIntrinsics, results: &mut [super::super::super::Foundation::Point]) -> ::windows_core::Result<()> {
        let this = self;
        unsafe { (::windows_core::Interface::vtable(this).MapPoints)(::windows_core::Interface::as_raw(this), sourcepoints.len() as u32, sourcepoints.as_ptr(), ::core::mem::transmute_copy(targetcoordinatesystem), ::core::mem::transmute_copy(targetcameraintrinsics), results.len() as u32, results.as_mut_ptr()).ok() }
    }
}
...
impl FrameControlCapabilities {
    pub fn Exposure(&self) -> ::windows_core::Result<FrameExposureCapabilities> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<FrameExposureCapabilities>();
    ...
    pub fn ExposureCompensation(&self) -> ::windows_core::Result<FrameExposureCompensationCapabilities> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<FrameExposureCompensationCapabilities>();
    ...
    pub fn IsoSpeed(&self) -> ::windows_core::Result<FrameIsoSpeedCapabilities> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<FrameIsoSpeedCapabilities>();
    ...
    pub fn Focus(&self) -> ::windows_core::Result<FrameFocusCapabilities> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<FrameFocusCapabilities>();
    ...
    pub fn Flash(&self) -> ::windows_core::Result<FrameFlashCapabilities> {
        ...
        unsafe {
            let mut result__ = ::windows_core::zeroed::<FrameFlashCapabilities>();
...
impl FrameController {
    ...
    pub fn ExposureControl(&self) -> ::windows_core::Result<FrameExposureControl> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<FrameExposureControl>();
    ...
    pub fn ExposureCompensationControl(&self) -> ::windows_core::Result<FrameExposureCompensationControl> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<FrameExposureCompensationControl>();
    ...
    pub fn IsoSpeedControl(&self) -> ::windows_core::Result<FrameIsoSpeedControl> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<FrameIsoSpeedControl>();
    ...
    pub fn FocusControl(&self) -> ::windows_core::Result<FrameFocusControl> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<FrameFocusControl>();
    ...
    pub fn PhotoConfirmationEnabled(&self) -> ::windows_core::Result<super::super::super::Foundation::IReference<bool>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::super::Foundation::IReference<bool>>();
    ...
    pub fn FlashControl(&self) -> ::windows_core::Result<FrameFlashControl> {
        ...
        unsafe {
            let mut result__ = ::windows_core::zeroed::<FrameFlashControl>();
...
impl FrameExposureCompensationControl {
    ...
    pub fn Value(&self) -> ::windows_core::Result<super::super::super::Foundation::IReference<f32>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::super::Foundation::IReference<f32>>();
...
impl FrameFlashControl {
    pub fn Mode(&self) -> ::windows_core::Result<FrameFlashMode> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<FrameFlashMode>();
...
impl VariablePhotoSequenceController {
        ...
        P0: ::windows_core::TryIntoParam<super::super::MediaProperties::IMediaEncodingProperties>,
    {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::MediaProperties::MediaRatio>();
    ...
    pub fn FrameCapabilities(&self) -> ::windows_core::Result<FrameControlCapabilities> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<FrameControlCapabilities>();
    ...
    pub fn DesiredFrameControllers(&self) -> ::windows_core::Result<super::super::super::Foundation::Collections::IVector<FrameController>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::super::Foundation::Collections::IVector<FrameController>>();
