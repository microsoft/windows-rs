...
impl CameraIntrinsics {
    pub fn FocalLength(&self) -> Result<windows_numerics::Vector2, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn PrincipalPoint(&self) -> Result<windows_numerics::Vector2, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RadialDistortion(&self) -> Result<windows_numerics::Vector3, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TangentialDistortion(&self) -> Result<windows_numerics::Vector2, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ImageWidth(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ImageHeight(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ProjectOntoFrame(&self, coordinate: windows_numerics::Vector3) -> Result<super::super::super::Foundation::Point, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UnprojectAtUnitDepth(&self, pixelcoordinate: super::super::super::Foundation::Point) -> Result<windows_numerics::Vector2, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ProjectManyOntoFrame(&self, coordinates: &[windows_numerics::Vector3], results: &mut [super::super::super::Foundation::Point]) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn UnprojectPixelsAtUnitDepth(&self, pixelcoordinates: &[super::super::super::Foundation::Point], results: &mut [windows_numerics::Vector2]) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn UndistortedProjectionTransform(&self) -> Result<windows_numerics::Matrix4x4, windows_result::HRESULT> {
    ...
    pub fn DistortPoint(&self, input: super::super::super::Foundation::Point) -> Result<super::super::super::Foundation::Point, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICameraIntrinsics2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DistortPoints(&self, inputs: &[super::super::super::Foundation::Point], results: &mut [super::super::super::Foundation::Point]) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICameraIntrinsics2>(self)?;
    ...
    pub fn UndistortPoint(&self, input: super::super::super::Foundation::Point) -> Result<super::super::super::Foundation::Point, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICameraIntrinsics2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UndistortPoints(&self, inputs: &[super::super::super::Foundation::Point], results: &mut [super::super::super::Foundation::Point]) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICameraIntrinsics2>(self)?;
    ...
    pub fn Create(focallength: windows_numerics::Vector2, principalpoint: windows_numerics::Vector2, radialdistortion: windows_numerics::Vector3, tangentialdistortion: windows_numerics::Vector2, imagewidth: u32, imageheight: u32) -> Result<CameraIntrinsics, windows_result::HRESULT> {
    ...
    fn ICameraIntrinsicsFactory<R, F: FnOnce(&ICameraIntrinsicsFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl DepthCorrelatedCoordinateMapper {
    ...
    pub fn UnprojectPoint<P1>(&self, sourcepoint: super::super::super::Foundation::Point, targetcoordinatesystem: P1) -> Result<windows_numerics::Vector3, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Perception_Spatial")]
    pub fn UnprojectPoints<P1>(&self, sourcepoints: &[super::super::super::Foundation::Point], targetcoordinatesystem: P1, results: &mut [windows_numerics::Vector3]) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::super::Perception::Spatial::SpatialCoordinateSystem>,
    {
        let this = self;
    ...
    #[cfg(feature = "Perception_Spatial")]
    pub fn MapPoint<P1, P2>(&self, sourcepoint: super::super::super::Foundation::Point, targetcoordinatesystem: P1, targetcameraintrinsics: P2) -> Result<super::super::super::Foundation::Point, windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::super::Perception::Spatial::SpatialCoordinateSystem>,
    ...
    #[cfg(feature = "Perception_Spatial")]
    pub fn MapPoints<P1, P2>(&self, sourcepoints: &[super::super::super::Foundation::Point], targetcoordinatesystem: P1, targetcameraintrinsics: P2, results: &mut [super::super::super::Foundation::Point]) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::super::Perception::Spatial::SpatialCoordinateSystem>,
        P2: windows_core::Param<CameraIntrinsics>,
    {
...
impl FrameControlCapabilities {
    pub fn Exposure(&self) -> Result<FrameExposureCapabilities, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ExposureCompensation(&self) -> Result<FrameExposureCompensationCapabilities, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsoSpeed(&self) -> Result<FrameIsoSpeedCapabilities, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Focus(&self) -> Result<FrameFocusCapabilities, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PhotoConfirmationSupported(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Flash(&self) -> Result<FrameFlashCapabilities, windows_result::HRESULT> {
...
impl FrameController {
    ...
    pub fn ExposureControl(&self) -> Result<FrameExposureControl, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ExposureCompensationControl(&self) -> Result<FrameExposureCompensationControl, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsoSpeedControl(&self) -> Result<FrameIsoSpeedControl, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FocusControl(&self) -> Result<FrameFocusControl, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PhotoConfirmationEnabled(&self) -> Result<super::super::super::Foundation::IReference<bool>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPhotoConfirmationEnabled<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn FlashControl(&self) -> Result<FrameFlashControl, windows_result::HRESULT> {
...
impl FrameExposureCapabilities {
    pub fn Supported(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Min(&self) -> Result<super::super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Max(&self) -> Result<super::super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Step(&self) -> Result<super::super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl FrameExposureCompensationCapabilities {
    ...
    pub fn Min(&self) -> Result<f32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Min)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn Max(&self) -> Result<f32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Max)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn Step(&self) -> Result<f32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Step)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl FrameExposureCompensationControl {
    pub fn Value(&self) -> Result<super::super::super::Foundation::IReference<f32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetValue<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
...
impl FrameExposureControl {
    pub fn Auto(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAuto(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAuto)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Value(&self) -> Result<super::super::super::Foundation::IReference<super::super::super::Foundation::TimeSpan>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Value)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl FrameFlashCapabilities {
    ...
    pub fn RedEyeReductionSupported(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PowerSupported(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl FrameFlashControl {
    pub fn Mode(&self) -> Result<FrameFlashMode, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMode(&self, value: FrameFlashMode) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn RedEyeReduction(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRedEyeReduction(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetRedEyeReduction)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn PowerPercent(&self) -> Result<f32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPowerPercent(&self, value: f32) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl FrameFocusCapabilities {
    ...
    pub fn Min(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Min)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn Max(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Max)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn Step(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Step)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl FrameFocusControl {
    pub fn Value(&self) -> Result<super::super::super::Foundation::IReference<u32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Value)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl VariablePhotoSequenceController {
    ...
    pub fn MaxPhotosPerSecond(&self) -> Result<f32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PhotosPerSecondLimit(&self) -> Result<f32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPhotosPerSecondLimit(&self, value: f32) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetPhotosPerSecondLimit)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Media_MediaProperties")]
    pub fn GetHighestConcurrentFrameRate<P0>(&self, captureproperties: P0) -> Result<super::super::MediaProperties::MediaRatio, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Media_MediaProperties")]
    pub fn GetCurrentFrameRate(&self) -> Result<super::super::MediaProperties::MediaRatio, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FrameCapabilities(&self) -> Result<FrameControlCapabilities, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DesiredFrameControllers(&self) -> Result<windows_collections::IVector<FrameController>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
