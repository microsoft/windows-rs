...
windows_core::imp::required_hierarchy!(CurrentSessionChangedEventArgs, ICurrentSessionChangedEventArgs);
...
windows_core::imp::required_hierarchy!(GlobalSystemMediaTransportControlsSession, IGlobalSystemMediaTransportControlsSession);
...
windows_core::imp::required_hierarchy!(GlobalSystemMediaTransportControlsSessionManager, IGlobalSystemMediaTransportControlsSessionManager, IGlobalSystemMediaTransportControlsSessionManagerStatics);
...
windows_core::imp::required_hierarchy!(GlobalSystemMediaTransportControlsSessionMediaProperties, IGlobalSystemMediaTransportControlsSessionMediaProperties);
...
windows_core::imp::required_hierarchy!(GlobalSystemMediaTransportControlsSessionPlaybackControls, IGlobalSystemMediaTransportControlsSessionPlaybackControls);
...
windows_core::imp::required_hierarchy!(GlobalSystemMediaTransportControlsSessionPlaybackInfo, IGlobalSystemMediaTransportControlsSessionPlaybackInfo);
...
windows_core::imp::required_hierarchy!(GlobalSystemMediaTransportControlsSessionTimelineProperties, IGlobalSystemMediaTransportControlsSessionTimelineProperties);
...
windows_core::imp::required_hierarchy!(MediaPropertiesChangedEventArgs, IMediaPropertiesChangedEventArgs);
...
windows_core::imp::required_hierarchy!(PlaybackInfoChangedEventArgs, IPlaybackInfoChangedEventArgs);
...
windows_core::imp::required_hierarchy!(SessionsChangedEventArgs, ISessionsChangedEventArgs);
...
windows_core::imp::required_hierarchy!(TimelinePropertiesChangedEventArgs, ITimelinePropertiesChangedEventArgs);
