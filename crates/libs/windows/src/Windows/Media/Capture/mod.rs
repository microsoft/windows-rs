...
pub struct IMediaCapture_Vtbl {
    ...
    #[cfg(all(feature = "Media_MediaProperties", feature = "Storage", feature = "Storage_Streams"))]
    ...
    #[cfg(not(all(feature = "Media_MediaProperties", feature = "Storage", feature = "Storage_Streams")))]
