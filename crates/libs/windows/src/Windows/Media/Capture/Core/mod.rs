...
windows_core::imp::required_hierarchy!(VariablePhotoCapturedEventArgs, IVariablePhotoCapturedEventArgs);
...
windows_core::imp::required_hierarchy!(VariablePhotoSequenceCapture, IVariablePhotoSequenceCapture, IVariablePhotoSequenceCapture2);
