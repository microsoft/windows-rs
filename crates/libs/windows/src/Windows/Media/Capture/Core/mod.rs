...
impl VariablePhotoCapturedEventArgs {
    #[cfg(feature = "Storage_Streams")]
    pub fn Frame(&self) -> windows_result::Result<super::CapturedFrame> {
        let this = self;
        unsafe {
    ...
    pub fn CaptureTimeOffset(&self) -> windows_result::Result<super::super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UsedFrameControllerIndex(&self) -> windows_result::Result<super::super::super::Foundation::IReference<u32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CapturedFrameControlValues(&self) -> windows_result::Result<super::CapturedFrameControlValues> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VariablePhotoSequenceCapture {
    ...
    pub fn UpdateSettingsAsync(&self) -> windows_result::Result<windows_future::IAsyncAction> {
