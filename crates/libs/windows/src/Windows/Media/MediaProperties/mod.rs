...
impl MediaEncodingProfile {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromFileAsync<P0>(file: P0) -> windows_core::Result<windows_async::IAsyncOperation<MediaEncodingProfile>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromStreamAsync<P0>(stream: P0) -> windows_core::Result<windows_async::IAsyncOperation<MediaEncodingProfile>>
    where
