...
pub trait IMediaEncodingProperties_Impl {
...
impl IMediaEncodingProperties_Vtbl {
    ...
    where
        <Identity as windows_core::IUnknownImpl>::Impl: IMediaEncodingProperties_Impl,
    {
        ...
        unsafe extern "system" fn Type<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IMediaEncodingProperties_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn SetSubtype<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IMediaEncodingProperties_Impl,
        {
            unsafe {
        ...
        unsafe extern "system" fn Subtype<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IMediaEncodingProperties_Impl,
        {
            unsafe {
