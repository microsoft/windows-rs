...
impl BackgroundMediaPlayer {
    pub fn Current() -> windows_result::Result<MediaPlayer> {
    ...
    pub fn MessageReceivedFromBackground<P0>(value: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveMessageReceivedFromBackground(token: i64) -> windows_result::Result<()> {
    ...
    pub fn MessageReceivedFromForeground<P0>(value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::EventHandler<MediaPlayerDataReceivedEventArgs>>,
    {
        Self::IBackgroundMediaPlayerStatics(|this| unsafe {
    ...
    pub fn RemoveMessageReceivedFromForeground(token: i64) -> windows_result::Result<()> {
    ...
    pub fn SendMessageToBackground<P0>(value: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn SendMessageToForeground<P0>(value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::Collections::ValueSet>,
    {
    ...
    fn IBackgroundMediaPlayerStatics<R, F: FnOnce(&IBackgroundMediaPlayerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl CurrentMediaPlaybackItemChangedEventArgs {
    pub fn NewItem(&self) -> windows_result::Result<MediaPlaybackItem> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OldItem(&self) -> windows_result::Result<MediaPlaybackItem> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Reason(&self) -> windows_result::Result<MediaPlaybackItemChangedReason> {
...
impl IMediaEnginePlaybackSource {
    pub fn CurrentItem(&self) -> windows_result::Result<MediaPlaybackItem> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPlaybackSource<P0>(&self, source: P0) -> windows_result::Result<()>
    where
...
pub trait IMediaEnginePlaybackSource_Impl: windows_core::IUnknownImpl {
    fn CurrentItem(&self) -> windows_result::Result<MediaPlaybackItem>;
    fn SetPlaybackSource(&self, source: windows_core::Ref<IMediaPlaybackSource>) -> windows_result::Result<()>;
}
...
impl MediaBreak {
    pub fn PlaybackList(&self) -> windows_result::Result<MediaPlaybackList> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PresentationPosition(&self) -> windows_result::Result<super::super::Foundation::IReference<super::super::Foundation::TimeSpan>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn InsertionMethod(&self) -> windows_result::Result<MediaBreakInsertionMethod> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn CustomProperties(&self) -> windows_result::Result<super::super::Foundation::Collections::ValueSet> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanStart(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanStart(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCanStart)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Create(insertionmethod: MediaBreakInsertionMethod) -> windows_result::Result<MediaBreak> {
    ...
    pub fn CreateWithPresentationPosition(insertionmethod: MediaBreakInsertionMethod, presentationposition: super::super::Foundation::TimeSpan) -> windows_result::Result<MediaBreak> {
        Self::IMediaBreakFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IMediaBreakFactory<R, F: FnOnce(&IMediaBreakFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl MediaBreakEndedEventArgs {
    pub fn MediaBreak(&self) -> windows_result::Result<MediaBreak> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MediaBreakManager {
    pub fn BreaksSeekedOver<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveBreaksSeekedOver(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveBreaksSeekedOver)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn BreakStarted<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveBreakStarted(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveBreakStarted)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn BreakEnded<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveBreakEnded(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveBreakEnded)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn BreakSkipped<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveBreakSkipped(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveBreakSkipped)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn CurrentBreak(&self) -> windows_result::Result<MediaBreak> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PlaybackSession(&self) -> windows_result::Result<MediaPlaybackSession> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PlayBreak<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn SkipCurrentBreak(&self) -> windows_result::Result<()> {
        let this = self;
...
impl MediaBreakSchedule {
    pub fn ScheduleChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveScheduleChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveScheduleChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn InsertMidrollBreak<P0>(&self, mediabreak: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<MediaBreak>,
    {
        let this = self;
    ...
    pub fn RemoveMidrollBreak<P0>(&self, mediabreak: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<MediaBreak>,
    {
        let this = self;
    ...
    pub fn MidrollBreaks(&self) -> windows_result::Result<windows_collections::IVectorView<MediaBreak>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPrerollBreak<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<MediaBreak>,
    {
        let this = self;
    ...
    pub fn PrerollBreak(&self) -> windows_result::Result<MediaBreak> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPostrollBreak<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<MediaBreak>,
    {
        let this = self;
    ...
    pub fn PostrollBreak(&self) -> windows_result::Result<MediaBreak> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PlaybackItem(&self) -> windows_result::Result<MediaPlaybackItem> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MediaBreakSeekedOverEventArgs {
    pub fn SeekedOverBreaks(&self) -> windows_result::Result<windows_collections::IVectorView<MediaBreak>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OldPosition(&self) -> windows_result::Result<super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NewPosition(&self) -> windows_result::Result<super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MediaItemDisplayProperties {
    pub fn Type(&self) -> windows_result::Result<super::MediaPlaybackType> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetType(&self, value: super::MediaPlaybackType) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetType)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn MusicProperties(&self) -> windows_result::Result<super::MusicDisplayProperties> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn VideoProperties(&self) -> windows_result::Result<super::VideoDisplayProperties> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MediaPlaybackAudioTrackList {
    pub fn First(&self) -> windows_result::Result<windows_collections::IIterator<super::Core::AudioTrack>> {
    ...
    pub fn SelectedIndexChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn GetAt(&self, index: u32) -> windows_result::Result<super::Core::AudioTrack> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMany(&self, startindex: u32, items: &mut [Option<super::Core::AudioTrack>]) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MediaPlaybackCommandManager {
    ...
    pub fn MediaPlayer(&self) -> windows_result::Result<MediaPlayer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PlayBehavior(&self) -> windows_result::Result<MediaPlaybackCommandManagerCommandBehavior> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PauseBehavior(&self) -> windows_result::Result<MediaPlaybackCommandManagerCommandBehavior> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NextBehavior(&self) -> windows_result::Result<MediaPlaybackCommandManagerCommandBehavior> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PreviousBehavior(&self) -> windows_result::Result<MediaPlaybackCommandManagerCommandBehavior> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FastForwardBehavior(&self) -> windows_result::Result<MediaPlaybackCommandManagerCommandBehavior> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RewindBehavior(&self) -> windows_result::Result<MediaPlaybackCommandManagerCommandBehavior> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShuffleBehavior(&self) -> windows_result::Result<MediaPlaybackCommandManagerCommandBehavior> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AutoRepeatModeBehavior(&self) -> windows_result::Result<MediaPlaybackCommandManagerCommandBehavior> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PositionBehavior(&self) -> windows_result::Result<MediaPlaybackCommandManagerCommandBehavior> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RateBehavior(&self) -> windows_result::Result<MediaPlaybackCommandManagerCommandBehavior> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PlayReceived<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemovePlayReceived(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePlayReceived)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn PauseReceived<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemovePauseReceived(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePauseReceived)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn NextReceived<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveNextReceived(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveNextReceived)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn PreviousReceived<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemovePreviousReceived(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePreviousReceived)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn FastForwardReceived<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveFastForwardReceived(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveFastForwardReceived)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn RewindReceived<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveRewindReceived(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveRewindReceived)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn ShuffleReceived<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveShuffleReceived(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveShuffleReceived)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn AutoRepeatModeReceived<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveAutoRepeatModeReceived(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveAutoRepeatModeReceived)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn PositionReceived<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemovePositionReceived(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePositionReceived)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn RateReceived<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveRateReceived(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
...
impl MediaPlaybackCommandManagerAutoRepeatModeReceivedEventArgs {
    ...
    pub fn AutoRepeatMode(&self) -> windows_result::Result<super::MediaPlaybackAutoRepeatMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MediaPlaybackCommandManagerCommandBehavior {
    pub fn CommandManager(&self) -> windows_result::Result<MediaPlaybackCommandManager> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EnablingRule(&self) -> windows_result::Result<MediaCommandEnablingRule> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetEnablingRule(&self, value: MediaCommandEnablingRule) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetEnablingRule)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsEnabledChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveIsEnabledChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
...
impl MediaPlaybackCommandManagerShuffleReceivedEventArgs {
    ...
    pub fn IsShuffleRequested(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MediaPlaybackItem {
    #[cfg(feature = "Foundation_Collections")]
    pub fn AudioTracksChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveAudioTracksChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveAudioTracksChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn VideoTracksChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlaybackItem, super::super::Foundation::Collections::IVectorChangedEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemoveVideoTracksChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveVideoTracksChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn TimedMetadataTracksChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlaybackItem, super::super::Foundation::Collections::IVectorChangedEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemoveTimedMetadataTracksChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveTimedMetadataTracksChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    #[cfg(feature = "Media_Core")]
    pub fn Source(&self) -> windows_result::Result<super::Core::MediaSource> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_Core")]
    pub fn AudioTracks(&self) -> windows_result::Result<MediaPlaybackAudioTrackList> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_Core")]
    pub fn VideoTracks(&self) -> windows_result::Result<MediaPlaybackVideoTrackList> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_Core")]
    pub fn TimedMetadataTracks(&self) -> windows_result::Result<MediaPlaybackTimedMetadataTrackList> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BreakSchedule(&self) -> windows_result::Result<MediaBreakSchedule> {
    ...
    pub fn DurationLimit(&self) -> windows_result::Result<super::super::Foundation::IReference<super::super::Foundation::TimeSpan>> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackItem2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanSkip(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackItem2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanSkip(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackItem2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetCanSkip)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn GetDisplayProperties(&self) -> windows_result::Result<MediaItemDisplayProperties> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackItem2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ApplyDisplayProperties<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn IsDisabledInPlaybackList(&self) -> windows_result::Result<bool> {
    ...
    pub fn SetIsDisabledInPlaybackList(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackItem3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetIsDisabledInPlaybackList)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn TotalDownloadProgress(&self) -> windows_result::Result<f64> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackItem3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AutoLoadedDisplayProperties(&self) -> windows_result::Result<AutoLoadedDisplayPropertyKind> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackItem3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAutoLoadedDisplayProperties(&self, value: AutoLoadedDisplayPropertyKind) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackItem3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetAutoLoadedDisplayProperties)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Media_Core")]
    pub fn Create<P0>(source: P0) -> windows_result::Result<MediaPlaybackItem>
    where
    ...
    #[cfg(feature = "Media_Core")]
    pub fn CreateWithStartTime<P0>(source: P0, starttime: super::super::Foundation::TimeSpan) -> windows_result::Result<MediaPlaybackItem>
    where
        P0: windows_core::Param<super::Core::MediaSource>,
    {
    ...
    #[cfg(feature = "Media_Core")]
    pub fn CreateWithStartTimeAndDurationLimit<P0>(source: P0, starttime: super::super::Foundation::TimeSpan, durationlimit: super::super::Foundation::TimeSpan) -> windows_result::Result<MediaPlaybackItem>
    where
        P0: windows_core::Param<super::Core::MediaSource>,
    {
        Self::IMediaPlaybackItemFactory2(|this| unsafe {
    ...
    #[cfg(feature = "Media_Core")]
    pub fn FindFromMediaSource<P0>(source: P0) -> windows_result::Result<MediaPlaybackItem>
    where
        P0: windows_core::Param<super::Core::MediaSource>,
    {
    ...
    fn IMediaPlaybackItemFactory<R, F: FnOnce(&IMediaPlaybackItemFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IMediaPlaybackItemFactory2<R, F: FnOnce(&IMediaPlaybackItemFactory2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IMediaPlaybackItemStatics<R, F: FnOnce(&IMediaPlaybackItemStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl MediaPlaybackItemError {
    pub fn ErrorCode(&self) -> windows_result::Result<MediaPlaybackItemErrorCode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MediaPlaybackItemFailedEventArgs {
    pub fn Item(&self) -> windows_result::Result<MediaPlaybackItem> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Error(&self) -> windows_result::Result<MediaPlaybackItemError> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MediaPlaybackList {
    ...
    pub fn ItemFailed<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveItemFailed(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveItemFailed)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn CurrentItemChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveCurrentItemChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveCurrentItemChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn ItemOpened<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveItemOpened(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveItemOpened)(windows_core::Interface::as_raw(this), token).ok() }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn Items(&self) -> windows_result::Result<super::super::Foundation::Collections::IObservableVector<MediaPlaybackItem>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AutoRepeatEnabled(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAutoRepeatEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn CurrentItemIndex(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MoveNext(&self) -> windows_result::Result<MediaPlaybackItem> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MovePrevious(&self) -> windows_result::Result<MediaPlaybackItem> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MoveTo(&self, itemindex: u32) -> windows_result::Result<MediaPlaybackItem> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MaxPrefetchTime(&self) -> windows_result::Result<super::super::Foundation::IReference<super::super::Foundation::TimeSpan>> {
    ...
    pub fn SetMaxPrefetchTime<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn StartingItem(&self) -> windows_result::Result<MediaPlaybackItem> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackList2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetStartingItem<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn ShuffledItems(&self) -> windows_result::Result<windows_collections::IVectorView<MediaPlaybackItem>> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackList2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetShuffledItems<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn MaxPlayedItemsToKeepOpen(&self) -> windows_result::Result<super::super::Foundation::IReference<u32>> {
    ...
    pub fn SetMaxPlayedItemsToKeepOpen<P0>(&self, value: P0) -> windows_result::Result<()>
    where
...
impl MediaPlaybackSession {
    pub fn PlaybackStateChanged<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemovePlaybackStateChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePlaybackStateChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn PlaybackRateChanged<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlaybackSession, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemovePlaybackRateChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePlaybackRateChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn SeekCompleted<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlaybackSession, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveSeekCompleted(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveSeekCompleted)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn BufferingStarted<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlaybackSession, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveBufferingStarted(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveBufferingStarted)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn BufferingEnded<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlaybackSession, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveBufferingEnded(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveBufferingEnded)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn BufferingProgressChanged<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlaybackSession, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveBufferingProgressChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveBufferingProgressChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn DownloadProgressChanged<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlaybackSession, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveDownloadProgressChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveDownloadProgressChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn NaturalDurationChanged<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlaybackSession, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveNaturalDurationChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveNaturalDurationChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn PositionChanged<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlaybackSession, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn NaturalVideoSizeChanged<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlaybackSession, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveNaturalVideoSizeChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn NaturalDuration(&self) -> windows_result::Result<super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPosition(&self, value: super::super::Foundation::TimeSpan) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetPosition)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn PlaybackState(&self) -> windows_result::Result<MediaPlaybackState> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanSeek(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanPause(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsProtected(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BufferingProgress(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DownloadProgress(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NaturalVideoHeight(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NaturalVideoWidth(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NormalizedSourceRect(&self) -> windows_result::Result<super::super::Foundation::Rect> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetNormalizedSourceRect(&self, value: super::super::Foundation::Rect) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetNormalizedSourceRect)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Media_MediaProperties")]
    pub fn StereoscopicVideoPackingMode(&self) -> windows_result::Result<super::MediaProperties::StereoscopicVideoPackingMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_MediaProperties")]
    pub fn SetStereoscopicVideoPackingMode(&self, value: super::MediaProperties::StereoscopicVideoPackingMode) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetStereoscopicVideoPackingMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn BufferedRangesChanged<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlaybackSession, windows_core::IInspectable>>,
    {
    ...
    pub fn RemoveBufferedRangesChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackSession2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemoveBufferedRangesChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn PlayedRangesChanged<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlaybackSession, windows_core::IInspectable>>,
    {
        let this = &windows_core::Interface::cast::<IMediaPlaybackSession2>(self)?;
    ...
    pub fn RemovePlayedRangesChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackSession2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemovePlayedRangesChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn SeekableRangesChanged<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlaybackSession, windows_core::IInspectable>>,
    {
        let this = &windows_core::Interface::cast::<IMediaPlaybackSession2>(self)?;
    ...
    pub fn RemoveSeekableRangesChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackSession2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemoveSeekableRangesChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn SupportedPlaybackRatesChanged<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlaybackSession, windows_core::IInspectable>>,
    {
        let this = &windows_core::Interface::cast::<IMediaPlaybackSession2>(self)?;
    ...
    pub fn RemoveSupportedPlaybackRatesChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackSession2>(self)?;
    ...
    pub fn SphericalVideoProjection(&self) -> windows_result::Result<MediaPlaybackSphericalVideoProjection> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackSession2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsMirroring(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackSession2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsMirroring(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackSession2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetIsMirroring)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn GetBufferedRanges(&self) -> windows_result::Result<windows_collections::IVectorView<super::MediaTimeRange>> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackSession2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetPlayedRanges(&self) -> windows_result::Result<windows_collections::IVectorView<super::MediaTimeRange>> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackSession2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetSeekableRanges(&self) -> windows_result::Result<windows_collections::IVectorView<super::MediaTimeRange>> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackSession2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsSupportedPlaybackRateRange(&self, rate1: f64, rate2: f64) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackSession2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_MediaProperties")]
    pub fn PlaybackRotation(&self) -> windows_result::Result<super::MediaProperties::MediaRotation> {
    ...
    #[cfg(feature = "Media_MediaProperties")]
    pub fn SetPlaybackRotation(&self, value: super::MediaProperties::MediaRotation) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackSession3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetPlaybackRotation)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn GetOutputDegradationPolicyState(&self) -> windows_result::Result<MediaPlaybackSessionOutputDegradationPolicyState> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackSession3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MediaPlaybackSessionBufferingStartedEventArgs {
    pub fn IsPlaybackInterruption(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MediaPlaybackSessionOutputDegradationPolicyState {
    pub fn VideoConstrictionReason(&self) -> windows_result::Result<MediaPlaybackSessionVideoConstrictionReason> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MediaPlaybackSphericalVideoProjection {
    ...
    #[cfg(feature = "Media_MediaProperties")]
    pub fn FrameFormat(&self) -> windows_result::Result<super::MediaProperties::SphericalVideoFrameFormat> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_MediaProperties")]
    pub fn SetFrameFormat(&self, value: super::MediaProperties::SphericalVideoFrameFormat) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetFrameFormat)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn HorizontalFieldOfViewInDegrees(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetHorizontalFieldOfViewInDegrees(&self, value: f64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetHorizontalFieldOfViewInDegrees)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Foundation_Numerics")]
    pub fn ViewOrientation(&self) -> windows_result::Result<super::super::Foundation::Numerics::Quaternion> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn SetViewOrientation(&self, value: super::super::Foundation::Numerics::Quaternion) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetViewOrientation)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ProjectionMode(&self) -> windows_result::Result<SphericalVideoProjectionMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetProjectionMode(&self, value: SphericalVideoProjectionMode) -> windows_result::Result<()> {
        let this = self;
...
impl MediaPlaybackTimedMetadataTrackList {
    pub fn First(&self) -> windows_result::Result<windows_collections::IIterator<super::Core::TimedMetadataTrack>> {
    ...
    pub fn PresentationModeChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemovePresentationModeChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackTimedMetadataTrackList>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemovePresentationModeChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GetPresentationMode(&self, index: u32) -> windows_result::Result<TimedMetadataTrackPresentationMode> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackTimedMetadataTrackList>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPresentationMode(&self, index: u32, value: TimedMetadataTrackPresentationMode) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlaybackTimedMetadataTrackList>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetPresentationMode)(windows_core::Interface::as_raw(this), index, value).ok() }
    }
    pub fn GetAt(&self, index: u32) -> windows_result::Result<super::Core::TimedMetadataTrack> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAt)(windows_core::Interface::as_raw(this), index, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetMany(&self, startindex: u32, items: &mut [Option<super::Core::TimedMetadataTrack>]) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetMany)(windows_core::Interface::as_raw(this), startindex, items.len().try_into().unwrap(), core::mem::transmute_copy(&items), &mut result__).map(|| result__)
...
impl MediaPlaybackVideoTrackList {
    pub fn First(&self) -> windows_result::Result<windows_collections::IIterator<super::Core::VideoTrack>> {
    ...
    pub fn GetAt(&self, index: u32) -> windows_result::Result<super::Core::VideoTrack> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAt)(windows_core::Interface::as_raw(this), index, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetMany(&self, startindex: u32, items: &mut [Option<super::Core::VideoTrack>]) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetMany)(windows_core::Interface::as_raw(this), startindex, items.len().try_into().unwrap(), core::mem::transmute_copy(&items), &mut result__).map(|| result__)
...
impl MediaPlayer {
    ...
    pub fn AutoPlay(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAutoPlay(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn CurrentState(&self) -> windows_result::Result<MediaPlayerState> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsMuted(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsMuted(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn PlaybackMediaMarkers(&self) -> windows_result::Result<PlaybackMediaMarkerSequence> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MediaOpened<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveMediaOpened(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveMediaOpened)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn MediaEnded<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlayer, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveMediaEnded(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveMediaEnded)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn MediaFailed<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveMediaFailed(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveMediaFailed)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn CurrentStateChanged<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlayer, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveCurrentStateChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveCurrentStateChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn PlaybackMediaMarkerReached<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemovePlaybackMediaMarkerReached(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePlaybackMediaMarkerReached)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn MediaPlayerRateChanged<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveMediaPlayerRateChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveMediaPlayerRateChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn VolumeChanged<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlayer, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveVolumeChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn Play(&self) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetUriSource<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn SystemMediaTransportControls(&self) -> windows_result::Result<super::SystemMediaTransportControls> {
    ...
    pub fn AudioCategory(&self) -> windows_result::Result<MediaPlayerAudioCategory> {
        let this = &windows_core::Interface::cast::<IMediaPlayer2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAudioCategory(&self, value: MediaPlayerAudioCategory) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlayer2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetAudioCategory)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AudioDeviceType(&self) -> windows_result::Result<MediaPlayerAudioDeviceType> {
        let this = &windows_core::Interface::cast::<IMediaPlayer2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAudioDeviceType(&self, value: MediaPlayerAudioDeviceType) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlayer2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetAudioDeviceType)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsMutedChanged<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlayer, windows_core::IInspectable>>,
    {
    ...
    pub fn RemoveIsMutedChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlayer3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemoveIsMutedChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn SourceChanged<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlayer, windows_core::IInspectable>>,
    {
        let this = &windows_core::Interface::cast::<IMediaPlayer3>(self)?;
    ...
    pub fn RemoveSourceChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlayer3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemoveSourceChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn AudioBalance(&self) -> windows_result::Result<f64> {
        let this = &windows_core::Interface::cast::<IMediaPlayer3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAudioBalance(&self, value: f64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlayer3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetAudioBalance)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn RealTimePlayback(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IMediaPlayer3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRealTimePlayback(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlayer3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetRealTimePlayback)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn StereoscopicVideoRenderMode(&self) -> windows_result::Result<StereoscopicVideoRenderMode> {
        let this = &windows_core::Interface::cast::<IMediaPlayer3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetStereoscopicVideoRenderMode(&self, value: StereoscopicVideoRenderMode) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlayer3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetStereoscopicVideoRenderMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn BreakManager(&self) -> windows_result::Result<MediaBreakManager> {
        let this = &windows_core::Interface::cast::<IMediaPlayer3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub fn AudioDevice(&self) -> windows_result::Result<super::super::Devices::Enumeration::DeviceInformation> {
        let this = &windows_core::Interface::cast::<IMediaPlayer3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub fn SetAudioDevice<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn TimelineController(&self) -> windows_result::Result<super::MediaTimelineController> {
        let this = &windows_core::Interface::cast::<IMediaPlayer3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTimelineController<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn TimelineControllerPositionOffset(&self) -> windows_result::Result<super::super::Foundation::TimeSpan> {
        let this = &windows_core::Interface::cast::<IMediaPlayer3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTimelineControllerPositionOffset(&self, value: super::super::Foundation::TimeSpan) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlayer3>(self)?;
    ...
    pub fn SetSurfaceSize(&self, size: super::super::Foundation::Size) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "UI_Composition")]
    pub fn GetSurface<P0>(&self, compositor: P0) -> windows_result::Result<MediaPlayerSurface>
    where
    ...
    pub fn VideoFrameAvailable<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlayer, windows_core::IInspectable>>,
    {
    ...
    pub fn RemoveVideoFrameAvailable(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlayer5>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemoveVideoFrameAvailable)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn IsVideoFrameServerEnabled(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IMediaPlayer5>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsVideoFrameServerEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlayer5>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetIsVideoFrameServerEnabled)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn CopyFrameToVideoSurface<P0>(&self, destination: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn CopyFrameToVideoSurfaceWithTargetRectangle<P0>(&self, destination: P0, targetrectangle: super::super::Foundation::Rect) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Graphics::DirectX::Direct3D11::IDirect3DSurface>,
    {
        let this = &windows_core::Interface::cast::<IMediaPlayer5>(self)?;
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn CopyFrameToStereoscopicVideoSurfaces<P0, P1>(&self, destinationlefteye: P0, destinationrighteye: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Graphics::DirectX::Direct3D11::IDirect3DSurface>,
    ...
    pub fn SubtitleFrameChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<MediaPlayer, windows_core::IInspectable>>,
    {
    ...
    pub fn RemoveSubtitleFrameChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlayer6>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemoveSubtitleFrameChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn RenderSubtitlesToSurface<P0>(&self, destination: P0) -> windows_result::Result<bool>
    where
        P0: windows_core::Param<super::super::Graphics::DirectX::Direct3D11::IDirect3DSurface>,
    {
        let this = &windows_core::Interface::cast::<IMediaPlayer6>(self)?;
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn RenderSubtitlesToSurfaceWithTargetRectangle<P0>(&self, destination: P0, targetrectangle: super::super::Foundation::Rect) -> windows_result::Result<bool>
    where
        P0: windows_core::Param<super::super::Graphics::DirectX::Direct3D11::IDirect3DSurface>,
    {
        let this = &windows_core::Interface::cast::<IMediaPlayer6>(self)?;
    ...
    #[cfg(feature = "Media_Audio")]
    pub fn AudioStateMonitor(&self) -> windows_result::Result<super::Audio::AudioStateMonitor> {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn AddAudioEffect<P2>(&self, activatableclassid: &windows_core::HSTRING, effectoptional: bool, configuration: P2) -> windows_result::Result<()>
    where
    ...
    pub fn RemoveAllEffects(&self) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaPlayerEffects>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemoveAllEffects)(windows_core::Interface::as_raw(this)).ok() }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn AddVideoEffect<P2>(&self, activatableclassid: &windows_core::HSTRING, effectoptional: bool, effectconfiguration: P2) -> windows_result::Result<()>
    where
        P2: windows_core::Param<super::super::Foundation::Collections::IPropertySet>,
    {
    ...
    #[cfg(feature = "Media_Protection")]
    pub fn ProtectionManager(&self) -> windows_result::Result<super::Protection::MediaProtectionManager> {
    ...
    #[cfg(feature = "Media_Protection")]
    pub fn SetProtectionManager<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetFileSource<P0>(&self, file: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetStreamSource<P0>(&self, stream: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Media_Core")]
    pub fn SetMediaSource<P0>(&self, source: P0) -> windows_result::Result<()>
    where
    ...
    pub fn Source(&self) -> windows_result::Result<IMediaPlaybackSource> {
...
impl MediaPlayerFailedEventArgs {
    pub fn Error(&self) -> windows_result::Result<MediaPlayerError> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MediaPlayerRateChangedEventArgs {
    pub fn NewRate(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MediaPlayerSurface {
    ...
    #[cfg(feature = "UI_Composition")]
    pub fn CompositionSurface(&self) -> windows_result::Result<super::super::UI::Composition::ICompositionSurface> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Composition")]
    pub fn Compositor(&self) -> windows_result::Result<super::super::UI::Composition::Compositor> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PlaybackMediaMarker {
    ...
    pub fn CreateFromTime(value: super::super::Foundation::TimeSpan) -> windows_result::Result<PlaybackMediaMarker> {
    ...
    pub fn Create(value: super::super::Foundation::TimeSpan, mediamarkettype: &windows_core::HSTRING, text: &windows_core::HSTRING) -> windows_result::Result<PlaybackMediaMarker> {
        Self::IPlaybackMediaMarkerFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IPlaybackMediaMarkerFactory<R, F: FnOnce(&IPlaybackMediaMarkerFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl PlaybackMediaMarkerReachedEventArgs {
    pub fn PlaybackMediaMarker(&self) -> windows_result::Result<PlaybackMediaMarker> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PlaybackMediaMarkerSequence {
    pub fn First(&self) -> windows_result::Result<windows_collections::IIterator<PlaybackMediaMarker>> {
    ...
    pub fn Insert<P0>(&self, value: P0) -> windows_result::Result<()>
    where
...
impl TimedMetadataPresentationModeChangedEventArgs {
    #[cfg(feature = "Media_Core")]
    pub fn Track(&self) -> windows_result::Result<super::Core::TimedMetadataTrack> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OldPresentationMode(&self) -> windows_result::Result<TimedMetadataTrackPresentationMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NewPresentationMode(&self) -> windows_result::Result<TimedMetadataTrackPresentationMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
