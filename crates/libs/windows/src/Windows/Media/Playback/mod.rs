...
windows_core::imp::required_hierarchy!(CurrentMediaPlaybackItemChangedEventArgs, ICurrentMediaPlaybackItemChangedEventArgs, ICurrentMediaPlaybackItemChangedEventArgs2);
...
windows_core::imp::required_hierarchy!(MediaBreak, IMediaBreak, IMediaBreakFactory);
impl MediaBreak {
...
windows_core::imp::required_hierarchy!(MediaBreakEndedEventArgs, IMediaBreakEndedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaBreakManager, IMediaBreakManager);
...
windows_core::imp::required_hierarchy!(MediaBreakSchedule, IMediaBreakSchedule);
...
windows_core::imp::required_hierarchy!(MediaBreakSeekedOverEventArgs, IMediaBreakSeekedOverEventArgs);
...
windows_core::imp::required_hierarchy!(MediaBreakSkippedEventArgs, IMediaBreakSkippedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaBreakStartedEventArgs, IMediaBreakStartedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaItemDisplayProperties, IMediaItemDisplayProperties);
...
windows_core::imp::required_hierarchy!(MediaPlaybackCommandManager, IMediaPlaybackCommandManager);
...
windows_core::imp::required_hierarchy!(MediaPlaybackCommandManagerAutoRepeatModeReceivedEventArgs, IMediaPlaybackCommandManagerAutoRepeatModeReceivedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaPlaybackCommandManagerCommandBehavior, IMediaPlaybackCommandManagerCommandBehavior);
...
windows_core::imp::required_hierarchy!(MediaPlaybackCommandManagerFastForwardReceivedEventArgs, IMediaPlaybackCommandManagerFastForwardReceivedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaPlaybackCommandManagerNextReceivedEventArgs, IMediaPlaybackCommandManagerNextReceivedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaPlaybackCommandManagerPauseReceivedEventArgs, IMediaPlaybackCommandManagerPauseReceivedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaPlaybackCommandManagerPlayReceivedEventArgs, IMediaPlaybackCommandManagerPlayReceivedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaPlaybackCommandManagerPositionReceivedEventArgs, IMediaPlaybackCommandManagerPositionReceivedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaPlaybackCommandManagerPreviousReceivedEventArgs, IMediaPlaybackCommandManagerPreviousReceivedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaPlaybackCommandManagerRateReceivedEventArgs, IMediaPlaybackCommandManagerRateReceivedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaPlaybackCommandManagerRewindReceivedEventArgs, IMediaPlaybackCommandManagerRewindReceivedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaPlaybackCommandManagerShuffleReceivedEventArgs, IMediaPlaybackCommandManagerShuffleReceivedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaPlaybackItem, IMediaPlaybackItem, IMediaPlaybackItem2, IMediaPlaybackItem3, IMediaPlaybackItemFactory, IMediaPlaybackItemFactory2, IMediaPlaybackItemStatics, IMediaPlaybackSource);
...
windows_core::imp::required_hierarchy!(MediaPlaybackItemError, IMediaPlaybackItemError);
...
windows_core::imp::required_hierarchy!(MediaPlaybackItemFailedEventArgs, IMediaPlaybackItemFailedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaPlaybackItemOpenedEventArgs, IMediaPlaybackItemOpenedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaPlaybackList, IMediaPlaybackList, IMediaPlaybackList2, IMediaPlaybackList3, IMediaPlaybackSource);
...
windows_core::imp::required_hierarchy!(MediaPlaybackSession, IMediaPlaybackSession, IMediaPlaybackSession2, IMediaPlaybackSession3);
...
windows_core::imp::required_hierarchy!(MediaPlaybackSessionBufferingStartedEventArgs, IMediaPlaybackSessionBufferingStartedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaPlaybackSessionOutputDegradationPolicyState, IMediaPlaybackSessionOutputDegradationPolicyState);
...
windows_core::imp::required_hierarchy!(MediaPlaybackSphericalVideoProjection, IMediaPlaybackSphericalVideoProjection);
...
#[cfg(all(feature = "Foundation_Collections", feature = "Media_Core"))]
windows_core::imp::required_hierarchy!(MediaPlaybackTimedMetadataTrackList, super::super::Foundation::Collections::IIterable<super::Core::TimedMetadataTrack>, super::super::Foundation::Collections::IVectorView<super::Core::TimedMetadataTrack>, IMediaPlaybackTimedMetadataTrackList);
#[cfg(all(feature = "Foundation_Collections", feature = "Media_Core"))]
...
windows_core::imp::required_hierarchy!(MediaPlayer, super::super::Foundation::IClosable, IMediaPlayer, IMediaPlayer2, IMediaPlayer3, IMediaPlayer4, IMediaPlayer5, IMediaPlayer6, IMediaPlayer7, IMediaPlayerEffects, IMediaPlayerEffects2, IMediaPlayerSource, IMediaPlayerSource2);
impl MediaPlayer {
    pub fn new() -> windows_core::Result<Self> {
        Self::IActivationFactory(|f| f.ActivateInstance::<Self>())
    }
...
windows_core::imp::required_hierarchy!(MediaPlayerDataReceivedEventArgs, IMediaPlayerDataReceivedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaPlayerFailedEventArgs, IMediaPlayerFailedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaPlayerRateChangedEventArgs, IMediaPlayerRateChangedEventArgs);
...
windows_core::imp::required_hierarchy!(MediaPlayerSurface, super::super::Foundation::IClosable, IMediaPlayerSurface);
...
windows_core::imp::required_hierarchy!(PlaybackMediaMarker, IPlaybackMediaMarker, IPlaybackMediaMarkerFactory);
...
windows_core::imp::required_hierarchy!(PlaybackMediaMarkerReachedEventArgs, IPlaybackMediaMarkerReachedEventArgs);
...
#[cfg(feature = "Foundation_Collections")]
windows_core::imp::required_hierarchy!(PlaybackMediaMarkerSequence, super::super::Foundation::Collections::IIterable<PlaybackMediaMarker>, IPlaybackMediaMarkerSequence);
#[cfg(feature = "Foundation_Collections")]
...
windows_core::imp::required_hierarchy!(TimedMetadataPresentationModeChangedEventArgs, ITimedMetadataPresentationModeChangedEventArgs);
