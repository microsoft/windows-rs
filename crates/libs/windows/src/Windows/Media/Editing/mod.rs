...
windows_core::imp::required_hierarchy!(BackgroundAudioTrack, IBackgroundAudioTrack, IBackgroundAudioTrackStatics);
...
windows_core::imp::required_hierarchy!(EmbeddedAudioTrack, IEmbeddedAudioTrack);
...
windows_core::imp::required_hierarchy!(MediaClip, IMediaClip, IMediaClipStatics, IMediaClipStatics2);
impl MediaClip {
    pub fn TrimTimeFromStart(&self) -> windows_core::Result<super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
...
windows_core::imp::required_hierarchy!(MediaComposition, IMediaComposition, IMediaComposition2, IMediaCompositionStatics);
...
windows_core::imp::required_hierarchy!(MediaOverlay, IMediaOverlay, IMediaOverlayFactory);
impl MediaOverlay {
...
windows_core::imp::required_hierarchy!(MediaOverlayLayer, IMediaOverlayLayer, IMediaOverlayLayerFactory);
