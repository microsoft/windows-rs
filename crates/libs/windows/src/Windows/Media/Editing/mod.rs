...
impl BackgroundAudioTrack {
    pub fn TrimTimeFromStart(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn SetTrimTimeFromStart(&self, value: super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetTrimTimeFromStart)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn TrimTimeFromEnd(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTrimTimeFromEnd(&self, value: super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetTrimTimeFromEnd)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn OriginalDuration(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TrimmedDuration(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UserData(&self) -> Result<windows_collections::IMap<windows_core::HSTRING, windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDelay(&self, value: super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Clone(&self) -> Result<BackgroundAudioTrack, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAudioEncodingProperties(&self) -> Result<super::MediaProperties::AudioEncodingProperties, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AudioEffectDefinitions(&self) -> Result<windows_collections::IVector<super::Effects::IAudioEffectDefinition>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFromEmbeddedAudioTrack<P0>(embeddedaudiotrack: P0) -> Result<BackgroundAudioTrack, windows_result::HRESULT>
    where
    ...
    pub fn CreateFromFileAsync<P0>(file: P0) -> Result<windows_future::IAsyncOperation<BackgroundAudioTrack>, windows_result::HRESULT>
    where
    ...
    fn IBackgroundAudioTrackStatics<R, F: FnOnce(&IBackgroundAudioTrackStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl MediaClip {
    ...
    pub fn Clone(&self) -> Result<MediaClip, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Clone)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn StartTimeInComposition(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EndTimeInComposition(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EmbeddedAudioTracks(&self) -> Result<windows_collections::IVectorView<EmbeddedAudioTrack>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SelectedEmbeddedAudioTrackIndex(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSelectedEmbeddedAudioTrackIndex(&self, value: u32) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    #[cfg(feature = "Media_MediaProperties")]
    pub fn GetVideoEncodingProperties(&self) -> Result<super::MediaProperties::VideoEncodingProperties, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_Effects")]
    pub fn VideoEffectDefinitions(&self) -> Result<windows_collections::IVector<super::Effects::IVideoEffectDefinition>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI")]
    pub fn CreateFromColor(color: super::super::UI::Color, originalduration: super::super::Foundation::TimeSpan) -> Result<MediaClip, windows_result::HRESULT> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromFileAsync<P0>(file: P0) -> Result<windows_future::IAsyncOperation<MediaClip>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Storage::IStorageFile>,
    {
        Self::IMediaClipStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromImageFileAsync<P0>(file: P0, originalduration: super::super::Foundation::TimeSpan) -> Result<windows_future::IAsyncOperation<MediaClip>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Storage::IStorageFile>,
    {
        Self::IMediaClipStatics(|this| unsafe {
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn CreateFromSurface<P0>(surface: P0, originalduration: super::super::Foundation::TimeSpan) -> Result<MediaClip, windows_result::HRESULT>
    where
    ...
    fn IMediaClipStatics<R, F: FnOnce(&IMediaClipStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<MediaClip, IMediaClipStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IMediaClipStatics2<R, F: FnOnce(&IMediaClipStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl MediaComposition {
    ...
    pub fn Clips(&self) -> Result<windows_collections::IVector<MediaClip>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BackgroundAudioTracks(&self) -> Result<windows_collections::IVector<BackgroundAudioTrack>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Clone(&self) -> Result<MediaComposition, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Clone)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SaveAsync<P0>(&self, file: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Storage::IStorageFile>,
    {
        let this = self;
    ...
    #[cfg(all(feature = "Graphics_Imaging", feature = "Storage_Streams"))]
    pub fn GetThumbnailAsync(&self, timefromstart: super::super::Foundation::TimeSpan, scaledwidth: i32, scaledheight: i32, frameprecision: VideoFramePrecision) -> Result<windows_future::IAsyncOperation<super::super::Graphics::Imaging::ImageStream>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Graphics_Imaging", feature = "Storage_Streams"))]
    pub fn GetThumbnailsAsync<P0>(&self, timesfromstart: P0, scaledwidth: i32, scaledheight: i32, frameprecision: VideoFramePrecision) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::super::Graphics::Imaging::ImageStream>>, windows_result::HRESULT>
    where
    ...
    #[cfg(all(feature = "Media_Transcoding", feature = "Storage_Streams"))]
    pub fn RenderToFileAsync<P0>(&self, destination: P0) -> Result<windows_future::IAsyncOperationWithProgress<super::Transcoding::TranscodeFailureReason, f64>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Storage::IStorageFile>,
    {
        let this = self;
    ...
    #[cfg(all(feature = "Media_Transcoding", feature = "Storage_Streams"))]
    pub fn RenderToFileWithTrimmingPreferenceAsync<P0>(&self, destination: P0, trimmingpreference: MediaTrimmingPreference) -> Result<windows_future::IAsyncOperationWithProgress<super::Transcoding::TranscodeFailureReason, f64>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Storage::IStorageFile>,
    {
        let this = self;
    ...
    #[cfg(all(feature = "Media_MediaProperties", feature = "Media_Transcoding", feature = "Storage_Streams"))]
    pub fn RenderToFileWithProfileAsync<P0, P2>(&self, destination: P0, trimmingpreference: MediaTrimmingPreference, encodingprofile: P2) -> Result<windows_future::IAsyncOperationWithProgress<super::Transcoding::TranscodeFailureReason, f64>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Storage::IStorageFile>,
    ...
    #[cfg(feature = "Media_MediaProperties")]
    pub fn CreateDefaultEncodingProfile(&self) -> Result<super::MediaProperties::MediaEncodingProfile, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_Core")]
    pub fn GenerateMediaStreamSource(&self) -> Result<super::Core::MediaStreamSource, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Media_Core", feature = "Media_MediaProperties"))]
    pub fn GenerateMediaStreamSourceWithProfile<P0>(&self, encodingprofile: P0) -> Result<super::Core::MediaStreamSource, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Media_Core")]
    pub fn GeneratePreviewMediaStreamSource(&self, scaledwidth: i32, scaledheight: i32) -> Result<super::Core::MediaStreamSource, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OverlayLayers(&self) -> Result<windows_collections::IVector<MediaOverlayLayer>, windows_result::HRESULT> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadAsync<P0>(file: P0) -> Result<windows_future::IAsyncOperation<MediaComposition>, windows_result::HRESULT>
    where
    ...
    fn IMediaCompositionStatics<R, F: FnOnce(&IMediaCompositionStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl MediaOverlay {
    pub fn Position(&self) -> Result<super::super::Foundation::Rect, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPosition(&self, value: super::super::Foundation::Rect) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Clone(&self) -> Result<MediaOverlay, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Clone)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Clip(&self) -> Result<MediaClip, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AudioEnabled(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAudioEnabled(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAudioEnabled)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Create<P0>(clip: P0) -> Result<MediaOverlay, windows_result::HRESULT>
    where
    ...
    pub fn CreateWithPositionAndOpacity<P0>(clip: P0, position: super::super::Foundation::Rect, opacity: f64) -> Result<MediaOverlay, windows_result::HRESULT>
    where
        P0: windows_core::Param<MediaClip>,
    {
        Self::IMediaOverlayFactory(|this| unsafe {
    ...
    fn IMediaOverlayFactory<R, F: FnOnce(&IMediaOverlayFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl MediaOverlayLayer {
    ...
    pub fn Clone(&self) -> Result<MediaOverlayLayer, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Clone)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Overlays(&self) -> Result<windows_collections::IVector<MediaOverlay>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_Effects")]
    pub fn CustomCompositorDefinition(&self) -> Result<super::Effects::IVideoCompositorDefinition, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_Effects")]
    pub fn CreateWithCompositorDefinition<P0>(compositordefinition: P0) -> Result<MediaOverlayLayer, windows_result::HRESULT>
    where
    ...
    fn IMediaOverlayLayerFactory<R, F: FnOnce(&IMediaOverlayLayerFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
