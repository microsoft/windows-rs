...
windows_core::imp::required_hierarchy!(DetectedFace, IDetectedFace);
impl DetectedFace {
    #[cfg(feature = "Graphics_Imaging")]
...
windows_core::imp::required_hierarchy!(FaceDetector, IFaceDetector, IFaceDetectorStatics);
impl FaceDetector {
    #[cfg(all(feature = "Foundation_Collections", feature = "Graphics_Imaging"))]
...
windows_core::imp::required_hierarchy!(FaceTracker, IFaceTracker, IFaceTrackerStatics);
impl FaceTracker {
    #[cfg(feature = "Foundation_Collections")]
