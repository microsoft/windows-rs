...
impl FaceDetector {
        ...
        P0: windows_core::Param<super::super::Graphics::Imaging::SoftwareBitmap>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DetectFacesAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&image.param().borrow()), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    #[cfg(feature = "Graphics_Imaging")]
        ...
        P0: windows_core::Param<super::super::Graphics::Imaging::SoftwareBitmap>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DetectFacesWithSearchAreaAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&image.param().borrow()), searcharea, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    #[cfg(feature = "Graphics_Imaging")]
...
impl FaceTracker {
        ...
        P0: windows_core::Param<super::VideoFrame>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ProcessNextFrameAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&videoframe.param().borrow()), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    #[cfg(feature = "Graphics_Imaging")]
    pub fn MinDetectableFaceSize(&self) -> windows_core::Result<super::super::Graphics::Imaging::BitmapSize> {
