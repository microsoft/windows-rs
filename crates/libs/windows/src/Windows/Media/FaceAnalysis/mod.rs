...
impl DetectedFace {
    ...
    pub fn FaceBox(&self) -> Result<super::super::Graphics::Imaging::BitmapBounds, windows_result::HRESULT> {
        let this = self;
        unsafe {
...
impl FaceDetector {
    #[cfg(feature = "Graphics_Imaging")]
    pub fn DetectFacesAsync<P0>(&self, image: P0) -> Result<windows_future::IAsyncOperation<windows_collections::IVector<DetectedFace>>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn DetectFacesWithSearchAreaAsync<P0>(&self, image: P0, searcharea: super::super::Graphics::Imaging::BitmapBounds) -> Result<windows_future::IAsyncOperation<windows_collections::IVector<DetectedFace>>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Graphics::Imaging::SoftwareBitmap>,
    {
        let this = self;
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn MinDetectableFaceSize(&self) -> Result<super::super::Graphics::Imaging::BitmapSize, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn SetMinDetectableFaceSize(&self, value: super::super::Graphics::Imaging::BitmapSize) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetMinDetectableFaceSize)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Graphics_Imaging")]
    pub fn MaxDetectableFaceSize(&self) -> Result<super::super::Graphics::Imaging::BitmapSize, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn SetMaxDetectableFaceSize(&self, value: super::super::Graphics::Imaging::BitmapSize) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetMaxDetectableFaceSize)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CreateAsync() -> Result<windows_future::IAsyncOperation<FaceDetector>, windows_result::HRESULT> {
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn GetSupportedBitmapPixelFormats() -> Result<windows_collections::IVectorView<super::super::Graphics::Imaging::BitmapPixelFormat>, windows_result::HRESULT> {
        Self::IFaceDetectorStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn IsBitmapPixelFormatSupported(bitmappixelformat: super::super::Graphics::Imaging::BitmapPixelFormat) -> Result<bool, windows_result::HRESULT> {
        Self::IFaceDetectorStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IFaceDetectorStatics<R, F: FnOnce(&IFaceDetectorStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl FaceTracker {
    pub fn ProcessNextFrameAsync<P0>(&self, videoframe: P0) -> Result<windows_future::IAsyncOperation<windows_collections::IVector<DetectedFace>>, windows_result::HRESULT>
    where
    ...
    pub fn CreateAsync() -> Result<windows_future::IAsyncOperation<FaceTracker>, windows_result::HRESULT> {
    ...
    fn IFaceTrackerStatics<R, F: FnOnce(&IFaceTrackerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
