...
impl ComponentLoadFailedEventArgs {
    pub fn Information(&self) -> Result<RevocationAndRenewalInformation, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn Completion(&self) -> Result<MediaProtectionServiceCompletion, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ComponentLoadFailedEventHandler {
    pub fn new<F: FnMut(windows_core::Ref<'_, MediaProtectionManager>, windows_core::Ref<'_, ComponentLoadFailedEventArgs>) -> Result<(), windows_result::HRESULT> + Send + 'static>(invoke: F) -> Self {
...
#[repr(C)]
struct ComponentLoadFailedEventHandlerBox<F: FnMut(windows_core::Ref<'_, MediaProtectionManager>, windows_core::Ref<'_, ComponentLoadFailedEventArgs>) -> Result<(), windows_result::HRESULT> + Send + 'static> {
    vtable: *const ComponentLoadFailedEventHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(windows_core::Ref<'_, MediaProtectionManager>, windows_core::Ref<'_, ComponentLoadFailedEventArgs>) -> Result<(), windows_result::HRESULT> + Send + 'static> ComponentLoadFailedEventHandlerBox<F> {
...
impl ComponentRenewal {
    pub fn RenewSystemComponentsAsync<P0>(information: P0) -> Result<windows_future::IAsyncOperationWithProgress<RenewalStatus, u32>, windows_result::HRESULT>
    where
    ...
    fn IComponentRenewalStatics<R, F: FnOnce(&IComponentRenewalStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl HdcpSession {
    ...
    pub fn IsEffectiveProtectionAtLeast(&self, protection: HdcpProtection) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetEffectiveProtection(&self) -> Result<super::super::Foundation::IReference<HdcpProtection>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDesiredMinProtectionAsync(&self, protection: HdcpProtection) -> Result<windows_future::IAsyncOperation<HdcpSetProtectionResult>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ProtectionChanged<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveProtectionChanged(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
pub trait IMediaProtectionServiceRequest_Impl: windows_core::IUnknownImpl {
    fn ProtectionSystem(&self) -> Result<windows_core::GUID, windows_result::HRESULT>;
    fn Type(&self) -> Result<windows_core::GUID, windows_result::HRESULT>;
}
impl IMediaProtectionServiceRequest_Vtbl {
    pub const fn new<Identity: IMediaProtectionServiceRequest_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ProtectionSystem<Identity: IMediaProtectionServiceRequest_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut windows_core::GUID) -> windows_result::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Type<Identity: IMediaProtectionServiceRequest_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut windows_core::GUID) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl MediaProtectionManager {
    ...
    pub fn ServiceRequested<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveServiceRequested(&self, cookie: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveServiceRequested)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    pub fn RebootNeeded<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveRebootNeeded(&self, cookie: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveRebootNeeded)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    pub fn ComponentLoadFailed<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveComponentLoadFailed(&self, cookie: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl MediaProtectionPMPServer {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn CreatePMPServer<P0>(pproperties: P0) -> Result<MediaProtectionPMPServer, windows_result::HRESULT>
    where
    ...
    fn IMediaProtectionPMPServerFactory<R, F: FnOnce(&IMediaProtectionPMPServerFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl MediaProtectionServiceCompletion {
    pub fn Complete(&self, success: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl ProtectionCapabilities {
    ...
    pub fn IsTypeSupported(&self, r#type: &windows_core::HSTRING, keysystem: &windows_core::HSTRING) -> Result<ProtectionCapabilityResult, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl RebootNeededEventHandler {
    pub fn new<F: FnMut(windows_core::Ref<'_, MediaProtectionManager>) -> Result<(), windows_result::HRESULT> + Send + 'static>(invoke: F) -> Self {
...
#[repr(C)]
struct RebootNeededEventHandlerBox<F: FnMut(windows_core::Ref<'_, MediaProtectionManager>) -> Result<(), windows_result::HRESULT> + Send + 'static> {
    vtable: *const RebootNeededEventHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(windows_core::Ref<'_, MediaProtectionManager>) -> Result<(), windows_result::HRESULT> + Send + 'static> RebootNeededEventHandlerBox<F> {
...
impl RevocationAndRenewalInformation {
    pub fn Items(&self) -> Result<windows_collections::IVector<RevocationAndRenewalItem>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl RevocationAndRenewalItem {
    pub fn Reasons(&self) -> Result<RevocationAndRenewalReasons, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HeaderHash(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PublicKeyHash(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RenewalId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ServiceRequestedEventArgs {
    pub fn Request(&self) -> Result<IMediaProtectionServiceRequest, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_Playback")]
    pub fn MediaPlaybackItem(&self) -> Result<super::Playback::MediaPlaybackItem, windows_result::HRESULT> {
...
impl ServiceRequestedEventHandler {
    pub fn new<F: FnMut(windows_core::Ref<'_, MediaProtectionManager>, windows_core::Ref<'_, ServiceRequestedEventArgs>) -> Result<(), windows_result::HRESULT> + Send + 'static>(invoke: F) -> Self {
...
#[repr(C)]
struct ServiceRequestedEventHandlerBox<F: FnMut(windows_core::Ref<'_, MediaProtectionManager>, windows_core::Ref<'_, ServiceRequestedEventArgs>) -> Result<(), windows_result::HRESULT> + Send + 'static> {
    vtable: *const ServiceRequestedEventHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(windows_core::Ref<'_, MediaProtectionManager>, windows_core::Ref<'_, ServiceRequestedEventArgs>) -> Result<(), windows_result::HRESULT> + Send + 'static> ServiceRequestedEventHandlerBox<F> {
