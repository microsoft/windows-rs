...
windows_core::imp::required_hierarchy!(ComponentLoadFailedEventArgs, IComponentLoadFailedEventArgs);
...
windows_core::imp::required_hierarchy!(HdcpSession, super::super::Foundation::IClosable, IHdcpSession);
impl HdcpSession {
...
windows_core::imp::required_hierarchy!(MediaProtectionManager, IMediaProtectionManager);
...
windows_core::imp::required_hierarchy!(MediaProtectionPMPServer, IMediaProtectionPMPServer, IMediaProtectionPMPServerFactory);
...
windows_core::imp::required_hierarchy!(MediaProtectionServiceCompletion, IMediaProtectionServiceCompletion);
...
windows_core::imp::required_hierarchy!(ProtectionCapabilities, IProtectionCapabilities);
...
windows_core::imp::required_hierarchy!(RevocationAndRenewalInformation, IRevocationAndRenewalInformation);
...
windows_core::imp::required_hierarchy!(RevocationAndRenewalItem, IRevocationAndRenewalItem);
...
windows_core::imp::required_hierarchy!(ServiceRequestedEventArgs, IServiceRequestedEventArgs, IServiceRequestedEventArgs2);
