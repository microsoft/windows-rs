...
impl CastingConnection {
    ...
    pub fn RequestStartCastingAsync<P0>(&self, value: P0) -> windows_core::Result<windows_async::IAsyncOperation<CastingConnectionErrorStatus>>
    where
        P0: windows_core::Param<CastingSource>,
    {
        let this = self;
    ...
    pub fn DisconnectAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<CastingConnectionErrorStatus>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl CastingDevice {
    ...
    pub fn GetSupportedCastingPlaybackTypesAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<CastingPlaybackTypes>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDeviceSelectorFromCastingSourceAsync<P0>(castingsource: P0) -> windows_core::Result<windows_async::IAsyncOperation<windows_core::HSTRING>>
    where
        P0: windows_core::Param<CastingSource>,
    {
        Self::ICastingDeviceStatics(|this| unsafe {
    ...
    pub fn FromIdAsync(value: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<CastingDevice>> {
        Self::ICastingDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeviceInfoSupportsCastingAsync<P0>(device: P0) -> windows_core::Result<windows_async::IAsyncOperation<bool>>
    where
