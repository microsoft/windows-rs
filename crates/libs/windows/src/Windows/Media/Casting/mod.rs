...
windows_core::imp::required_hierarchy!(CastingConnection, super::super::Foundation::IClosable, ICastingConnection);
...
windows_core::imp::required_hierarchy!(CastingConnectionErrorOccurredEventArgs, ICastingConnectionErrorOccurredEventArgs);
...
windows_core::imp::required_hierarchy!(CastingDevice, ICastingDevice, ICastingDeviceStatics);
impl CastingDevice {
...
windows_core::imp::required_hierarchy!(CastingDevicePicker, ICastingDevicePicker);
...
windows_core::imp::required_hierarchy!(CastingDevicePickerFilter, ICastingDevicePickerFilter);
...
windows_core::imp::required_hierarchy!(CastingDeviceSelectedEventArgs, ICastingDeviceSelectedEventArgs);
...
windows_core::imp::required_hierarchy!(CastingSource, ICastingSource);
impl CastingSource {
