...
impl CastingConnection {
    pub fn State(&self) -> Result<CastingConnectionState, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn Device(&self) -> Result<CastingDevice, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Source(&self) -> Result<CastingSource, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestStartCastingAsync<P0>(&self, value: P0) -> Result<windows_future::IAsyncOperation<CastingConnectionErrorStatus>, windows_result::HRESULT>
    where
        P0: windows_core::Param<CastingSource>,
    {
        let this = self;
    ...
    pub fn DisconnectAsync(&self) -> Result<windows_future::IAsyncOperation<CastingConnectionErrorStatus>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl CastingConnectionErrorOccurredEventArgs {
    pub fn ErrorStatus(&self) -> Result<CastingConnectionErrorStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl CastingDevice {
    ...
    pub fn GetSupportedCastingPlaybackTypesAsync(&self) -> Result<windows_future::IAsyncOperation<CastingPlaybackTypes>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateCastingConnection(&self) -> Result<CastingConnection, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDeviceSelector(r#type: CastingPlaybackTypes) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn GetDeviceSelectorFromCastingSourceAsync<P0>(castingsource: P0) -> Result<windows_future::IAsyncOperation<windows_core::HSTRING>, windows_result::HRESULT>
    where
        P0: windows_core::Param<CastingSource>,
    {
        Self::ICastingDeviceStatics(|this| unsafe {
    ...
    pub fn FromIdAsync(value: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<CastingDevice>, windows_result::HRESULT> {
        Self::ICastingDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeviceInfoSupportsCastingAsync<P0>(device: P0) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
    ...
    fn ICastingDeviceStatics<R, F: FnOnce(&ICastingDeviceStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl CastingDevicePicker {
    ...
    pub fn Filter(&self) -> Result<CastingDevicePickerFilter, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CastingDeviceSelected<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveCastingDeviceSelected(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveCastingDeviceSelected)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn CastingDevicePickerDismissed<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveCastingDevicePickerDismissed(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl CastingDevicePickerFilter {
    ...
    pub fn SupportsPictures(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSupportsPictures(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSupportsPictures)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SupportedCastingSources(&self) -> Result<windows_collections::IVector<CastingSource>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl CastingDeviceSelectedEventArgs {
    pub fn SelectedCastingDevice(&self) -> Result<CastingDevice, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
