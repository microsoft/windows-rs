...
impl AudioBuffer {
    ...
    pub fn Length(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetLength(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn CreateReference(&self) -> windows_result::Result<super::Foundation::IMemoryBufferReference> {
...
impl AudioFrame {
    pub fn LockBuffer(&self, mode: AudioBufferAccessMode) -> windows_result::Result<AudioBuffer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Create(capacity: u32) -> windows_result::Result<AudioFrame> {
    ...
    pub fn IsReadOnly(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IMediaFrame>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRelativeTime<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn RelativeTime(&self) -> windows_result::Result<super::Foundation::IReference<super::Foundation::TimeSpan>> {
        let this = &windows_core::Interface::cast::<IMediaFrame>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSystemRelativeTime<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::Foundation::IReference<super::Foundation::TimeSpan>>,
    {
        let this = &windows_core::Interface::cast::<IMediaFrame>(self)?;
    ...
    pub fn SystemRelativeTime(&self) -> windows_result::Result<super::Foundation::IReference<super::Foundation::TimeSpan>> {
        let this = &windows_core::Interface::cast::<IMediaFrame>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDuration<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::Foundation::IReference<super::Foundation::TimeSpan>>,
    {
        let this = &windows_core::Interface::cast::<IMediaFrame>(self)?;
    ...
    pub fn Duration(&self) -> windows_result::Result<super::Foundation::IReference<super::Foundation::TimeSpan>> {
        let this = &windows_core::Interface::cast::<IMediaFrame>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsDiscontinuous(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaFrame>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetIsDiscontinuous)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsDiscontinuous(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IMediaFrame>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ExtendedProperties(&self) -> windows_result::Result<super::Foundation::Collections::IPropertySet> {
        let this = &windows_core::Interface::cast::<IMediaFrame>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IAudioFrameFactory<R, F: FnOnce(&IAudioFrameFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl AutoRepeatModeChangeRequestedEventArgs {
    pub fn RequestedAutoRepeatMode(&self) -> windows_result::Result<MediaPlaybackAutoRepeatMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl IMediaExtension {
    #[cfg(feature = "Foundation_Collections")]
    pub fn SetProperties<P0>(&self, configuration: P0) -> windows_result::Result<()>
    where
...
pub trait IMediaExtension_Impl: windows_core::IUnknownImpl {
    fn SetProperties(&self, configuration: windows_core::Ref<super::Foundation::Collections::IPropertySet>) -> windows_result::Result<()>;
}
#[cfg(feature = "Foundation_Collections")]
...
pub trait IMediaFrame_Impl: super::Foundation::IClosable_Impl {
    ...
    fn IsReadOnly(&self) -> windows_result::Result<bool>;
    fn SetRelativeTime(&self, value: windows_core::Ref<super::Foundation::IReference<super::Foundation::TimeSpan>>) -> windows_result::Result<()>;
    fn RelativeTime(&self) -> windows_result::Result<super::Foundation::IReference<super::Foundation::TimeSpan>>;
    fn SetSystemRelativeTime(&self, value: windows_core::Ref<super::Foundation::IReference<super::Foundation::TimeSpan>>) -> windows_result::Result<()>;
    fn SystemRelativeTime(&self) -> windows_result::Result<super::Foundation::IReference<super::Foundation::TimeSpan>>;
    fn SetDuration(&self, value: windows_core::Ref<super::Foundation::IReference<super::Foundation::TimeSpan>>) -> windows_result::Result<()>;
    fn Duration(&self) -> windows_result::Result<super::Foundation::IReference<super::Foundation::TimeSpan>>;
    fn SetIsDiscontinuous(&self, value: bool) -> windows_result::Result<()>;
    fn IsDiscontinuous(&self) -> windows_result::Result<bool>;
    fn ExtendedProperties(&self) -> windows_result::Result<super::Foundation::Collections::IPropertySet>;
}
#[cfg(feature = "Foundation_Collections")]
...
impl IMediaMarker {
    pub fn Time(&self) -> windows_result::Result<super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MediaMarkerType(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IMediaMarker_Impl: windows_core::IUnknownImpl {
    fn Time(&self) -> windows_result::Result<super::Foundation::TimeSpan>;
    fn MediaMarkerType(&self) -> windows_result::Result<windows_core::HSTRING>;
...
impl IMediaMarkers {
    pub fn Markers(&self) -> windows_result::Result<windows_collections::IVectorView<IMediaMarker>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IMediaMarkers_Impl: windows_core::IUnknownImpl {
    fn Markers(&self) -> windows_result::Result<windows_collections::IVectorView<IMediaMarker>>;
}
...
impl ImageDisplayProperties {
    ...
    pub fn SetSubtitle(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
...
impl MediaControl {
    ...
    pub fn RemoveSoundLevelChanged(cookie: i64) -> windows_result::Result<()> {
    ...
    pub fn PlayPressed<P0>(handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
    ...
    pub fn RemovePlayPressed(cookie: i64) -> windows_result::Result<()> {
    ...
    pub fn PausePressed<P0>(handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
    ...
    pub fn RemovePausePressed(cookie: i64) -> windows_result::Result<()> {
    ...
    pub fn StopPressed<P0>(handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
    ...
    pub fn RemoveStopPressed(cookie: i64) -> windows_result::Result<()> {
    ...
    pub fn PlayPauseTogglePressed<P0>(handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
    ...
    pub fn RemovePlayPauseTogglePressed(cookie: i64) -> windows_result::Result<()> {
    ...
    pub fn RecordPressed<P0>(handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
    ...
    pub fn RemoveRecordPressed(cookie: i64) -> windows_result::Result<()> {
    ...
    pub fn NextTrackPressed<P0>(handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
    ...
    pub fn RemoveNextTrackPressed(cookie: i64) -> windows_result::Result<()> {
    ...
    pub fn PreviousTrackPressed<P0>(handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
    ...
    pub fn RemovePreviousTrackPressed(cookie: i64) -> windows_result::Result<()> {
    ...
    pub fn FastForwardPressed<P0>(handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
    ...
    pub fn RemoveFastForwardPressed(cookie: i64) -> windows_result::Result<()> {
    ...
    pub fn RewindPressed<P0>(handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
    ...
    pub fn RemoveRewindPressed(cookie: i64) -> windows_result::Result<()> {
    ...
    pub fn ChannelUpPressed<P0>(handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
    ...
    pub fn RemoveChannelUpPressed(cookie: i64) -> windows_result::Result<()> {
    ...
    pub fn ChannelDownPressed<P0>(handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMediaControl(|this| unsafe {
    ...
    pub fn RemoveChannelDownPressed(cookie: i64) -> windows_result::Result<()> {
    ...
    pub fn SoundLevel() -> windows_result::Result<SoundLevel> {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SoundLevel)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn SetTrackName(value: &windows_core::HSTRING) -> windows_result::Result<()> {
    ...
    pub fn TrackName() -> windows_result::Result<windows_core::HSTRING> {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetArtistName(value: &windows_core::HSTRING) -> windows_result::Result<()> {
    ...
    pub fn ArtistName() -> windows_result::Result<windows_core::HSTRING> {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsPlaying(value: bool) -> windows_result::Result<()> {
    ...
    pub fn AlbumArt() -> windows_result::Result<super::Foundation::Uri> {
        Self::IMediaControl(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IMediaControl<R, F: FnOnce(&IMediaControl) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl MediaExtensionManager {
    ...
    pub fn RegisterSchemeHandler(&self, activatableclassid: &windows_core::HSTRING, scheme: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn RegisterSchemeHandlerWithSettings<P2>(&self, activatableclassid: &windows_core::HSTRING, scheme: &windows_core::HSTRING, configuration: P2) -> windows_result::Result<()>
    where
    ...
    pub fn RegisterByteStreamHandler(&self, activatableclassid: &windows_core::HSTRING, fileextension: &windows_core::HSTRING, mimetype: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn RegisterByteStreamHandlerWithSettings<P3>(&self, activatableclassid: &windows_core::HSTRING, fileextension: &windows_core::HSTRING, mimetype: &windows_core::HSTRING, configuration: P3) -> windows_result::Result<()>
    where
    ...
    pub fn RegisterAudioDecoder(&self, activatableclassid: &windows_core::HSTRING, inputsubtype: windows_core::GUID, outputsubtype: windows_core::GUID) -> windows_result::Result<()> {
        let this = self;
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn RegisterAudioDecoderWithSettings<P3>(&self, activatableclassid: &windows_core::HSTRING, inputsubtype: windows_core::GUID, outputsubtype: windows_core::GUID, configuration: P3) -> windows_result::Result<()>
    where
        P3: windows_core::Param<super::Foundation::Collections::IPropertySet>,
    {
        let this = self;
    ...
    pub fn RegisterAudioEncoder(&self, activatableclassid: &windows_core::HSTRING, inputsubtype: windows_core::GUID, outputsubtype: windows_core::GUID) -> windows_result::Result<()> {
        let this = self;
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn RegisterAudioEncoderWithSettings<P3>(&self, activatableclassid: &windows_core::HSTRING, inputsubtype: windows_core::GUID, outputsubtype: windows_core::GUID, configuration: P3) -> windows_result::Result<()>
    where
        P3: windows_core::Param<super::Foundation::Collections::IPropertySet>,
    {
        let this = self;
    ...
    pub fn RegisterVideoDecoder(&self, activatableclassid: &windows_core::HSTRING, inputsubtype: windows_core::GUID, outputsubtype: windows_core::GUID) -> windows_result::Result<()> {
        let this = self;
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn RegisterVideoDecoderWithSettings<P3>(&self, activatableclassid: &windows_core::HSTRING, inputsubtype: windows_core::GUID, outputsubtype: windows_core::GUID, configuration: P3) -> windows_result::Result<()>
    where
        P3: windows_core::Param<super::Foundation::Collections::IPropertySet>,
    {
        let this = self;
    ...
    pub fn RegisterVideoEncoder(&self, activatableclassid: &windows_core::HSTRING, inputsubtype: windows_core::GUID, outputsubtype: windows_core::GUID) -> windows_result::Result<()> {
        let this = self;
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn RegisterVideoEncoderWithSettings<P3>(&self, activatableclassid: &windows_core::HSTRING, inputsubtype: windows_core::GUID, outputsubtype: windows_core::GUID, configuration: P3) -> windows_result::Result<()>
    where
        P3: windows_core::Param<super::Foundation::Collections::IPropertySet>,
    {
        let this = self;
    ...
    #[cfg(feature = "ApplicationModel_AppService")]
    pub fn RegisterMediaExtensionForAppService<P0, P1>(&self, extension: P0, connection: P1) -> windows_result::Result<()>
    where
...
impl MediaMarkerTypes {
    pub fn Bookmark() -> windows_result::Result<windows_core::HSTRING> {
    ...
    fn IMediaMarkerTypesStatics<R, F: FnOnce(&IMediaMarkerTypesStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl MediaProcessingTriggerDetails {
    #[cfg(feature = "Foundation_Collections")]
    pub fn Arguments(&self) -> windows_result::Result<super::Foundation::Collections::ValueSet> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MediaTimelineController {
    ...
    pub fn Position(&self) -> windows_result::Result<super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPosition(&self, value: super::Foundation::TimeSpan) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetPosition)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ClockRate(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetClockRate(&self, value: f64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetClockRate)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn State(&self) -> windows_result::Result<MediaTimelineControllerState> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PositionChanged<P0>(&self, positionchangedeventhandler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemovePositionChanged(&self, eventcookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePositionChanged)(windows_core::Interface::as_raw(this), eventcookie).ok() }
    }
    pub fn StateChanged<P0>(&self, statechangedeventhandler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::Foundation::TypedEventHandler<MediaTimelineController, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveStateChanged(&self, eventcookie: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn IsLoopingEnabled(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IMediaTimelineController2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsLoopingEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaTimelineController2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetIsLoopingEnabled)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Failed<P0>(&self, eventhandler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn Ended<P0>(&self, eventhandler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::Foundation::TypedEventHandler<MediaTimelineController, windows_core::IInspectable>>,
    {
        let this = &windows_core::Interface::cast::<IMediaTimelineController2>(self)?;
    ...
    pub fn RemoveEnded(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMediaTimelineController2>(self)?;
...
impl MusicDisplayProperties {
    ...
    pub fn SetAlbumArtist(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetArtist(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetAlbumTitle(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMusicDisplayProperties2>(self)?;
    ...
    pub fn TrackNumber(&self) -> windows_result::Result<u32> {
        let this = &windows_core::Interface::cast::<IMusicDisplayProperties2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTrackNumber(&self, value: u32) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMusicDisplayProperties2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetTrackNumber)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Genres(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = &windows_core::Interface::cast::<IMusicDisplayProperties2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AlbumTrackCount(&self) -> windows_result::Result<u32> {
    ...
    pub fn SetAlbumTrackCount(&self, value: u32) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMusicDisplayProperties3>(self)?;
...
impl PlaybackPositionChangeRequestedEventArgs {
    pub fn RequestedPlaybackPosition(&self) -> windows_result::Result<super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PlaybackRateChangeRequestedEventArgs {
    pub fn RequestedPlaybackRate(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ShuffleEnabledChangeRequestedEventArgs {
    pub fn RequestedShuffleEnabled(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SystemMediaTransportControls {
    pub fn PlaybackStatus(&self) -> windows_result::Result<MediaPlaybackStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPlaybackStatus(&self, value: MediaPlaybackStatus) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetPlaybackStatus)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DisplayUpdater(&self) -> windows_result::Result<SystemMediaTransportControlsDisplayUpdater> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SoundLevel(&self) -> windows_result::Result<SoundLevel> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SoundLevel)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn SetIsPlayEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetIsStopEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetIsPauseEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetIsRecordEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetIsFastForwardEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetIsRewindEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetIsPreviousEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetIsNextEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetIsChannelUpEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetIsChannelDownEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn PropertyChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemovePropertyChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePropertyChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn AutoRepeatMode(&self) -> windows_result::Result<MediaPlaybackAutoRepeatMode> {
    ...
    pub fn SetAutoRepeatMode(&self, value: MediaPlaybackAutoRepeatMode) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<ISystemMediaTransportControls2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetAutoRepeatMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ShuffleEnabled(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<ISystemMediaTransportControls2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetShuffleEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<ISystemMediaTransportControls2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetShuffleEnabled)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn PlaybackRate(&self) -> windows_result::Result<f64> {
        let this = &windows_core::Interface::cast::<ISystemMediaTransportControls2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPlaybackRate(&self, value: f64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<ISystemMediaTransportControls2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetPlaybackRate)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn UpdateTimelineProperties<P0>(&self, timelineproperties: P0) -> windows_result::Result<()>
    where
    ...
    pub fn PlaybackPositionChangeRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemovePlaybackPositionChangeRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<ISystemMediaTransportControls2>(self)?;
    ...
    pub fn ShuffleEnabledChangeRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveShuffleEnabledChangeRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<ISystemMediaTransportControls2>(self)?;
    ...
    pub fn AutoRepeatModeChangeRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveAutoRepeatModeChangeRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<ISystemMediaTransportControls2>(self)?;
    ...
    pub fn GetForCurrentView() -> windows_result::Result<SystemMediaTransportControls> {
        Self::ISystemMediaTransportControlsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForCurrentView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn ISystemMediaTransportControlsStatics<R, F: FnOnce(&ISystemMediaTransportControlsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl SystemMediaTransportControlsButtonPressedEventArgs {
    pub fn Button(&self) -> windows_result::Result<SystemMediaTransportControlsButton> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SystemMediaTransportControlsDisplayUpdater {
    pub fn Type(&self) -> windows_result::Result<MediaPlaybackType> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetType(&self, value: MediaPlaybackType) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetType)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AppMediaId(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAppMediaId(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Thumbnail(&self) -> windows_result::Result<super::Storage::Streams::RandomAccessStreamReference> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MusicProperties(&self) -> windows_result::Result<MusicDisplayProperties> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn VideoProperties(&self) -> windows_result::Result<VideoDisplayProperties> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ImageProperties(&self) -> windows_result::Result<ImageDisplayProperties> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CopyFromFileAsync<P1>(&self, r#type: MediaPlaybackType, source: P1) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
    ...
    pub fn ClearAll(&self) -> windows_result::Result<()> {
        let this = self;
...
impl SystemMediaTransportControlsPropertyChangedEventArgs {
    pub fn Property(&self) -> windows_result::Result<SystemMediaTransportControlsProperty> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SystemMediaTransportControlsTimelineProperties {
    ...
    pub fn StartTime(&self) -> windows_result::Result<super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetStartTime(&self, value: super::Foundation::TimeSpan) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetStartTime)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn EndTime(&self) -> windows_result::Result<super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetEndTime(&self, value: super::Foundation::TimeSpan) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetEndTime)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn MinSeekTime(&self) -> windows_result::Result<super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMinSeekTime(&self, value: super::Foundation::TimeSpan) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetMinSeekTime)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn MaxSeekTime(&self) -> windows_result::Result<super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxSeekTime(&self, value: super::Foundation::TimeSpan) -> windows_result::Result<()> {
        let this = self;
...
impl VideoEffects {
    pub fn VideoStabilization() -> windows_result::Result<windows_core::HSTRING> {
    ...
    fn IVideoEffectsStatics<R, F: FnOnce(&IVideoEffectsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl VideoFrame {
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn SoftwareBitmap(&self) -> windows_result::Result<super::Graphics::Imaging::SoftwareBitmap> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CopyToAsync<P0>(&self, frame: P0) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn Direct3DSurface(&self) -> windows_result::Result<super::Graphics::DirectX::Direct3D11::IDirect3DSurface> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn CopyToWithBoundsAsync<P0, P1, P2>(&self, frame: P0, sourcebounds: P1, destinationbounds: P2) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<VideoFrame>,
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn Create(format: super::Graphics::Imaging::BitmapPixelFormat, width: i32, height: i32) -> windows_result::Result<VideoFrame> {
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn CreateWithAlpha(format: super::Graphics::Imaging::BitmapPixelFormat, width: i32, height: i32, alpha: super::Graphics::Imaging::BitmapAlphaMode) -> windows_result::Result<VideoFrame> {
        Self::IVideoFrameFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics_DirectX")]
    pub fn CreateAsDirect3D11SurfaceBacked(format: super::Graphics::DirectX::DirectXPixelFormat, width: i32, height: i32) -> windows_result::Result<VideoFrame> {
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn CreateAsDirect3D11SurfaceBackedWithDevice<P3>(format: super::Graphics::DirectX::DirectXPixelFormat, width: i32, height: i32, device: P3) -> windows_result::Result<VideoFrame>
    where
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn CreateWithSoftwareBitmap<P0>(bitmap: P0) -> windows_result::Result<VideoFrame>
    where
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn CreateWithDirect3D11Surface<P0>(surface: P0) -> windows_result::Result<VideoFrame>
    where
    ...
    fn IVideoFrameFactory<R, F: FnOnce(&IVideoFrameFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<VideoFrame, IVideoFrameFactory> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IVideoFrameStatics<R, F: FnOnce(&IVideoFrameStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
