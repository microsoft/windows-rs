...
impl SystemMediaTransportControlsDisplayUpdater {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CopyFromFileAsync<P1>(&self, r#type: MediaPlaybackType, source: P1) -> windows_core::Result<windows_async::IAsyncOperation<bool>>
    where
...
impl VideoFrame {
    ...
    pub fn CopyToAsync<P0>(&self, frame: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn CopyToWithBoundsAsync<P0, P1, P2>(&self, frame: P0, sourcebounds: P1, destinationbounds: P2) -> windows_core::Result<windows_async::IAsyncAction>
    where
        P0: windows_core::Param<VideoFrame>,
