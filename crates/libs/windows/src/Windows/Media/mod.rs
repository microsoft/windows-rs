...
impl IMediaFrame_Vtbl {
    pub const fn new<Identity: IMediaFrame_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Type<Identity: IMediaFrame_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut core::mem::MaybeUninit<windows_core::HSTRING>) -> windows_core::HRESULT {
            let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IMediaMarker_Vtbl {
    pub const fn new<Identity: IMediaMarker_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn MediaMarkerType<Identity: IMediaMarker_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut core::mem::MaybeUninit<windows_core::HSTRING>) -> windows_core::HRESULT {
            let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Text<Identity: IMediaMarker_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut core::mem::MaybeUninit<windows_core::HSTRING>) -> windows_core::HRESULT {
            let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::required_hierarchy!(AudioBuffer, super::Foundation::IClosable, super::Foundation::IMemoryBuffer, IAudioBuffer);
impl AudioBuffer {
    pub fn Close(&self) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<super::Foundation::IClosable>(self)?;
        unsafe { (windows_core::Interface::vtable(this).Close)(windows_core::Interface::as_raw(this)).ok() }
...
windows_core::imp::required_hierarchy!(AudioFrame, super::Foundation::IClosable, IAudioFrame, IAudioFrameFactory, IMediaFrame);
impl AudioFrame {
    pub fn Close(&self) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<super::Foundation::IClosable>(self)?;
        unsafe { (windows_core::Interface::vtable(this).Close)(windows_core::Interface::as_raw(this)).ok() }
...
windows_core::imp::required_hierarchy!(AutoRepeatModeChangeRequestedEventArgs, IAutoRepeatModeChangeRequestedEventArgs);
...
windows_core::imp::required_hierarchy!(ImageDisplayProperties, IImageDisplayProperties);
...
windows_core::imp::required_hierarchy!(MediaExtensionManager, IMediaExtensionManager, IMediaExtensionManager2);
...
windows_core::imp::required_hierarchy!(MediaProcessingTriggerDetails, IMediaProcessingTriggerDetails);
...
windows_core::imp::required_hierarchy!(MediaTimelineController, IMediaTimelineController, IMediaTimelineController2);
...
windows_core::imp::required_hierarchy!(MediaTimelineControllerFailedEventArgs, IMediaTimelineControllerFailedEventArgs);
...
windows_core::imp::required_hierarchy!(MusicDisplayProperties, IMusicDisplayProperties, IMusicDisplayProperties2, IMusicDisplayProperties3);
...
windows_core::imp::required_hierarchy!(PlaybackPositionChangeRequestedEventArgs, IPlaybackPositionChangeRequestedEventArgs);
...
windows_core::imp::required_hierarchy!(PlaybackRateChangeRequestedEventArgs, IPlaybackRateChangeRequestedEventArgs);
...
windows_core::imp::required_hierarchy!(ShuffleEnabledChangeRequestedEventArgs, IShuffleEnabledChangeRequestedEventArgs);
...
windows_core::imp::required_hierarchy!(SystemMediaTransportControls, ISystemMediaTransportControls, ISystemMediaTransportControls2, ISystemMediaTransportControlsStatics);
...
windows_core::imp::required_hierarchy!(SystemMediaTransportControlsButtonPressedEventArgs, ISystemMediaTransportControlsButtonPressedEventArgs);
...
windows_core::imp::required_hierarchy!(SystemMediaTransportControlsDisplayUpdater, ISystemMediaTransportControlsDisplayUpdater);
...
windows_core::imp::required_hierarchy!(SystemMediaTransportControlsPropertyChangedEventArgs, ISystemMediaTransportControlsPropertyChangedEventArgs);
...
windows_core::imp::required_hierarchy!(SystemMediaTransportControlsTimelineProperties, ISystemMediaTransportControlsTimelineProperties);
...
windows_core::imp::required_hierarchy!(VideoDisplayProperties, IVideoDisplayProperties, IVideoDisplayProperties2);
...
windows_core::imp::required_hierarchy!(VideoFrame, super::Foundation::IClosable, IMediaFrame, IVideoFrame, IVideoFrame2, IVideoFrameFactory, IVideoFrameStatics);
impl VideoFrame {
    pub fn Close(&self) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<super::Foundation::IClosable>(self)?;
        unsafe { (windows_core::Interface::vtable(this).Close)(windows_core::Interface::as_raw(this)).ok() }
