...
impl Playlist {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Files(&self) -> windows_result::Result<windows_collections::IVector<super::super::Storage::StorageFile>> {
        let this = self;
        unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SaveAsAsync<P0>(&self, savelocation: P0, desiredname: &windows_core::HSTRING, option: super::super::Storage::NameCollisionOption) -> windows_result::Result<windows_future::IAsyncOperation<super::super::Storage::StorageFile>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SaveAsWithFormatAsync<P0>(&self, savelocation: P0, desiredname: &windows_core::HSTRING, option: super::super::Storage::NameCollisionOption, playlistformat: PlaylistFormat) -> windows_result::Result<windows_future::IAsyncOperation<super::super::Storage::StorageFile>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageFolder>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadAsync<P0>(file: P0) -> windows_result::Result<windows_future::IAsyncOperation<Playlist>>
    where
    ...
    fn IPlaylistStatics<R, F: FnOnce(&IPlaylistStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
