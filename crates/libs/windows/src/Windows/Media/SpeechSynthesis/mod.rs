...
windows_core::imp::required_hierarchy!(SpeechSynthesizer, super::super::Foundation::IClosable, IInstalledVoicesStatic, IInstalledVoicesStatic2, ISpeechSynthesizer, ISpeechSynthesizer2);
...
windows_core::imp::required_hierarchy!(SpeechSynthesizerOptions, ISpeechSynthesizerOptions, ISpeechSynthesizerOptions2, ISpeechSynthesizerOptions3);
...
windows_core::imp::required_hierarchy!(VoiceInformation, IVoiceInformation);
