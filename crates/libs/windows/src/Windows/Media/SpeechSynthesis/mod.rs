...
impl SpeechSynthesisStream {
    ...
    pub fn Markers(&self) -> Result<windows_collections::IVectorView<super::IMediaMarker>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TimedMetadataTracks(&self) -> Result<windows_collections::IVectorView<super::Core::TimedMetadataTrack>, windows_result::HRESULT> {
...
impl SpeechSynthesizer {
    ...
    pub fn AllVoices() -> Result<windows_collections::IVectorView<VoiceInformation>, windows_result::HRESULT> {
    ...
    pub fn DefaultVoice() -> Result<VoiceInformation, windows_result::HRESULT> {
        Self::IInstalledVoicesStatic(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TrySetDefaultVoiceAsync<P0>(voice: P0) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
    ...
    #[cfg(all(feature = "Media_Core", feature = "Storage_Streams"))]
    pub fn SynthesizeTextToStreamAsync(&self, text: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<SpeechSynthesisStream>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Media_Core", feature = "Storage_Streams"))]
    pub fn SynthesizeSsmlToStreamAsync(&self, ssml: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<SpeechSynthesisStream>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetVoice<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<VoiceInformation>,
    {
        let this = self;
    ...
    pub fn Voice(&self) -> Result<VoiceInformation, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Options(&self) -> Result<SpeechSynthesizerOptions, windows_result::HRESULT> {
    ...
    fn IInstalledVoicesStatic<R, F: FnOnce(&IInstalledVoicesStatic) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<SpeechSynthesizer, IInstalledVoicesStatic> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IInstalledVoicesStatic2<R, F: FnOnce(&IInstalledVoicesStatic2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl SpeechSynthesizerOptions {
    pub fn IncludeWordBoundaryMetadata(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIncludeWordBoundaryMetadata(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIncludeWordBoundaryMetadata)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IncludeSentenceBoundaryMetadata(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIncludeSentenceBoundaryMetadata(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIncludeSentenceBoundaryMetadata)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AudioVolume(&self) -> Result<f64, windows_result::HRESULT> {
    ...
    pub fn SetAudioVolume(&self, value: f64) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ISpeechSynthesizerOptions2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetAudioVolume)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SpeakingRate(&self) -> Result<f64, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ISpeechSynthesizerOptions2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSpeakingRate(&self, value: f64) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ISpeechSynthesizerOptions2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetSpeakingRate)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AudioPitch(&self) -> Result<f64, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ISpeechSynthesizerOptions2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAudioPitch(&self, value: f64) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ISpeechSynthesizerOptions2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetAudioPitch)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AppendedSilence(&self) -> Result<SpeechAppendedSilence, windows_result::HRESULT> {
    ...
    pub fn SetAppendedSilence(&self, value: SpeechAppendedSilence) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ISpeechSynthesizerOptions3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetAppendedSilence)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn PunctuationSilence(&self) -> Result<SpeechPunctuationSilence, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ISpeechSynthesizerOptions3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPunctuationSilence(&self, value: SpeechPunctuationSilence) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ISpeechSynthesizerOptions3>(self)?;
...
impl VoiceInformation {
    ...
    pub fn Gender(&self) -> Result<VoiceGender, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
