...
impl MediaTranscoder {
    ...
    pub fn SetTrimStartTime(&self, value: super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetTrimStartTime)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn TrimStartTime(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn SetTrimStopTime(&self, value: super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetTrimStopTime)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn TrimStopTime(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAlwaysReencode(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAlwaysReencode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AlwaysReencode(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetHardwareAccelerationEnabled(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetHardwareAccelerationEnabled)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn HardwareAccelerationEnabled(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AddAudioEffect(&self, activatableclassid: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn AddAudioEffectWithSettings<P2>(&self, activatableclassid: &windows_core::HSTRING, effectrequired: bool, configuration: P2) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn AddVideoEffect(&self, activatableclassid: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn AddVideoEffectWithSettings<P2>(&self, activatableclassid: &windows_core::HSTRING, effectrequired: bool, configuration: P2) -> Result<(), windows_result::HRESULT>
    where
        P2: windows_core::Param<super::super::Foundation::Collections::IPropertySet>,
    {
        let this = self;
    ...
    pub fn ClearEffects(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).ClearEffects)(windows_core::Interface::as_raw(this)).ok() }
    }
    #[cfg(all(feature = "Media_MediaProperties", feature = "Storage_Streams"))]
    pub fn PrepareFileTranscodeAsync<P0, P1, P2>(&self, source: P0, destination: P1, profile: P2) -> Result<windows_future::IAsyncOperation<PrepareTranscodeResult>, windows_result::HRESULT>
    where
    ...
    #[cfg(all(feature = "Media_MediaProperties", feature = "Storage_Streams"))]
    pub fn PrepareStreamTranscodeAsync<P0, P1, P2>(&self, source: P0, destination: P1, profile: P2) -> Result<windows_future::IAsyncOperation<PrepareTranscodeResult>, windows_result::HRESULT>
    where
    ...
    #[cfg(all(feature = "Media_Core", feature = "Media_MediaProperties", feature = "Storage_Streams"))]
    pub fn PrepareMediaStreamSourceTranscodeAsync<P0, P1, P2>(&self, source: P0, destination: P1, profile: P2) -> Result<windows_future::IAsyncOperation<PrepareTranscodeResult>, windows_result::HRESULT>
    where
    ...
    pub fn SetVideoProcessingAlgorithm(&self, value: MediaVideoProcessingAlgorithm) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IMediaTranscoder2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetVideoProcessingAlgorithm)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn VideoProcessingAlgorithm(&self) -> Result<MediaVideoProcessingAlgorithm, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IMediaTranscoder2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PrepareTranscodeResult {
    pub fn CanTranscode(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FailureReason(&self) -> Result<TranscodeFailureReason, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TranscodeAsync(&self) -> Result<windows_future::IAsyncActionWithProgress<f64>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
