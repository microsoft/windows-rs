...
impl SoundLevelBroker {
    pub fn SoundLevel() -> Result<super::super::SoundLevel, windows_result::HRESULT> {
    ...
    pub fn RemoveSoundLevelChanged(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    fn ISoundLevelBrokerStatics<R, F: FnOnce(&ISoundLevelBrokerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
