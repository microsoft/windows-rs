...
impl DialApp {
    ...
    pub fn RequestLaunchAsync(&self, appargument: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<DialAppLaunchResult>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StopAsync(&self) -> Result<windows_future::IAsyncOperation<DialAppStopResult>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAppStateAsync(&self) -> Result<windows_future::IAsyncOperation<DialAppStateDetails>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DialAppStateDetails {
    pub fn State(&self) -> Result<DialAppState, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FullXml(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DialDevice {
    ...
    pub fn GetDialApp(&self, appname: &windows_core::HSTRING) -> Result<DialApp, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDeviceSelector(appname: &windows_core::HSTRING) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn FromIdAsync(value: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<DialDevice>, windows_result::HRESULT> {
        Self::IDialDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeviceInfoSupportsDialAsync<P0>(device: P0) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
    ...
    fn IDialDeviceStatics<R, F: FnOnce(&IDialDeviceStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl DialDevicePicker {
    ...
    pub fn Filter(&self) -> Result<DialDevicePickerFilter, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub fn Appearance(&self) -> Result<super::super::Devices::Enumeration::DevicePickerAppearance, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DialDeviceSelected<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveDialDeviceSelected(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn DialDevicePickerDismissed<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveDialDevicePickerDismissed(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn ShowWithPlacement(&self, selection: super::super::Foundation::Rect, preferredplacement: super::super::UI::Popups::Placement) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn PickSingleDialDeviceAsync(&self, selection: super::super::Foundation::Rect) -> Result<windows_future::IAsyncOperation<DialDevice>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn PickSingleDialDeviceAsyncWithPlacement(&self, selection: super::super::Foundation::Rect, preferredplacement: super::super::UI::Popups::Placement) -> Result<windows_future::IAsyncOperation<DialDevice>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDisplayStatus<P0>(&self, device: P0, status: DialDeviceDisplayStatus) -> Result<(), windows_result::HRESULT>
    where
...
impl DialDevicePickerFilter {
    pub fn SupportedAppNames(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DialDeviceSelectedEventArgs {
    pub fn SelectedDialDevice(&self) -> Result<DialDevice, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DialDisconnectButtonClickedEventArgs {
    pub fn Device(&self) -> Result<DialDevice, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DialReceiverApp {
    pub fn GetAdditionalDataAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IMap<windows_core::HSTRING, windows_core::HSTRING>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAdditionalDataAsync<P0>(&self, additionaldata: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
    ...
    pub fn GetUniqueDeviceNameAsync(&self) -> Result<windows_future::IAsyncOperation<windows_core::HSTRING>, windows_result::HRESULT> {
    ...
    pub fn Current() -> Result<DialReceiverApp, windows_result::HRESULT> {
    ...
    fn IDialReceiverAppStatics<R, F: FnOnce(&IDialReceiverAppStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
