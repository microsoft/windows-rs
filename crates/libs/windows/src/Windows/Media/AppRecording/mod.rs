...
impl AppRecordingManager {
    pub fn GetStatus(&self) -> windows_result::Result<AppRecordingStatus> {
        let this = self;
        unsafe {
    ...
    pub fn StartRecordingToFileAsync<P0>(&self, file: P0) -> windows_result::Result<windows_future::IAsyncOperation<AppRecordingResult>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn RecordTimeSpanToFileAsync<P2>(&self, starttime: super::super::Foundation::DateTime, duration: super::super::Foundation::TimeSpan, file: P2) -> windows_result::Result<windows_future::IAsyncOperation<AppRecordingResult>>
    where
    ...
    pub fn SupportedScreenshotMediaEncodingSubtypes(&self) -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SaveScreenshotToFilesAsync<P0, P3>(&self, folder: P0, filenameprefix: &windows_core::HSTRING, option: AppRecordingSaveScreenshotOption, requestedformats: P3) -> windows_result::Result<windows_future::IAsyncOperation<AppRecordingSaveScreenshotResult>>
    where
    ...
    pub fn GetDefault() -> windows_result::Result<AppRecordingManager> {
        Self::IAppRecordingManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefault)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IAppRecordingManagerStatics<R, F: FnOnce(&IAppRecordingManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl AppRecordingResult {
    ...
    pub fn IsFileTruncated(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppRecordingSaveScreenshotResult {
    ...
    pub fn SavedScreenshotInfos(&self) -> windows_result::Result<windows_collections::IVectorView<AppRecordingSavedScreenshotInfo>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppRecordingSavedScreenshotInfo {
    ...
    pub fn MediaEncodingSubtype(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppRecordingStatus {
    pub fn CanRecord(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanRecordTimeSpan(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HistoricalBufferDuration(&self) -> windows_result::Result<super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Details(&self) -> windows_result::Result<AppRecordingStatusDetails> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppRecordingStatusDetails {
    ...
    pub fn IsTimeSpanRecordingDisabled(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
