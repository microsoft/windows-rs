...
windows_core::imp::required_hierarchy!(AppRecordingManager, IAppRecordingManager, IAppRecordingManagerStatics);
...
windows_core::imp::required_hierarchy!(AppRecordingResult, IAppRecordingResult);
...
windows_core::imp::required_hierarchy!(AppRecordingSaveScreenshotResult, IAppRecordingSaveScreenshotResult);
...
windows_core::imp::required_hierarchy!(AppRecordingSavedScreenshotInfo, IAppRecordingSavedScreenshotInfo);
...
windows_core::imp::required_hierarchy!(AppRecordingStatus, IAppRecordingStatus);
...
windows_core::imp::required_hierarchy!(AppRecordingStatusDetails, IAppRecordingStatusDetails);
