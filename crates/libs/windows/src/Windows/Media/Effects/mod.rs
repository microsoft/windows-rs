...
impl AcousticEchoCancellationConfiguration {
    pub fn SetEchoCancellationRenderEndpoint(&self, deviceid: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl AudioCaptureEffectsManager {
    pub fn AudioCaptureEffectsChanged<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveAudioCaptureEffectsChanged(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveAudioCaptureEffectsChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GetAudioCaptureEffects(&self) -> Result<windows_collections::IVectorView<AudioEffect>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AudioEffect {
    pub fn AudioEffectType(&self) -> Result<AudioEffectType, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AcousticEchoCancellationConfiguration(&self) -> Result<AcousticEchoCancellationConfiguration, windows_result::HRESULT> {
    ...
    pub fn CanSetState(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IAudioEffect2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn State(&self) -> Result<AudioEffectState, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IAudioEffect2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetState(&self, newstate: AudioEffectState) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IAudioEffect2>(self)?;
...
impl AudioEffectDefinition {
    ...
    pub fn Create(activatableclassid: &windows_core::HSTRING) -> Result<AudioEffectDefinition, windows_result::HRESULT> {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn CreateWithProperties<P1>(activatableclassid: &windows_core::HSTRING, props: P1) -> Result<AudioEffectDefinition, windows_result::HRESULT>
    where
    ...
    fn IAudioEffectDefinitionFactory<R, F: FnOnce(&IAudioEffectDefinitionFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl AudioEffectsManager {
    ...
    pub fn CreateAudioRenderEffectsManager(deviceid: &windows_core::HSTRING, category: super::Render::AudioRenderCategory) -> Result<AudioRenderEffectsManager, windows_result::HRESULT> {
    ...
    #[cfg(feature = "Media_Render")]
    pub fn CreateAudioRenderEffectsManagerWithMode(deviceid: &windows_core::HSTRING, category: super::Render::AudioRenderCategory, mode: super::AudioProcessing) -> Result<AudioRenderEffectsManager, windows_result::HRESULT> {
        Self::IAudioEffectsManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateAudioCaptureEffectsManager(deviceid: &windows_core::HSTRING, category: super::Capture::MediaCategory) -> Result<AudioCaptureEffectsManager, windows_result::HRESULT> {
        Self::IAudioEffectsManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_Capture")]
    pub fn CreateAudioCaptureEffectsManagerWithMode(deviceid: &windows_core::HSTRING, category: super::Capture::MediaCategory, mode: super::AudioProcessing) -> Result<AudioCaptureEffectsManager, windows_result::HRESULT> {
        Self::IAudioEffectsManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IAudioEffectsManagerStatics<R, F: FnOnce(&IAudioEffectsManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl AudioRenderEffectsManager {
    pub fn AudioRenderEffectsChanged<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveAudioRenderEffectsChanged(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveAudioRenderEffectsChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GetAudioRenderEffects(&self) -> Result<windows_collections::IVectorView<AudioEffect>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EffectsProviderThumbnail(&self) -> Result<super::super::Storage::Streams::IRandomAccessStreamWithContentType, windows_result::HRESULT> {
    ...
    pub fn EffectsProviderSettingsLabel(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IAudioRenderEffectsManager2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowSettingsUI(&self) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IAudioRenderEffectsManager2>(self)?;
...
impl CompositeVideoFrameContext {
    ...
    pub fn SurfacesToOverlay(&self) -> Result<windows_collections::IVectorView<super::super::Graphics::DirectX::Direct3D11::IDirect3DSurface>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BackgroundFrame(&self) -> Result<super::VideoFrame, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OutputFrame(&self) -> Result<super::VideoFrame, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetOverlayForSurface<P0>(&self, surfacetooverlay: P0) -> Result<super::Editing::MediaOverlay, windows_result::HRESULT>
    where
...
pub trait IAudioEffectDefinition_Impl: windows_core::IUnknownImpl {
    fn ActivatableClassId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT>;
    fn Properties(&self) -> Result<super::super::Foundation::Collections::IPropertySet, windows_result::HRESULT>;
}
#[cfg(feature = "Foundation_Collections")]
impl IAudioEffectDefinition_Vtbl {
    pub const fn new<Identity: IAudioEffectDefinition_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ActivatableClassId<Identity: IAudioEffectDefinition_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Properties<Identity: IAudioEffectDefinition_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IBasicAudioEffect {
    pub fn UseInputFrameForOutput(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SupportedEncodingProperties(&self) -> Result<windows_collections::IVectorView<super::MediaProperties::AudioEncodingProperties>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_MediaProperties")]
    pub fn SetEncodingProperties<P0>(&self, encodingproperties: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn ProcessFrame<P0>(&self, context: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn Close(&self, reason: MediaEffectClosedReason) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).Close)(windows_core::Interface::as_raw(this), reason).ok() }
    }
    pub fn DiscardQueuedFrames(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
pub trait IBasicAudioEffect_Impl: super::IMediaExtension_Impl {
    fn UseInputFrameForOutput(&self) -> Result<bool, windows_result::HRESULT>;
    fn SupportedEncodingProperties(&self) -> Result<windows_collections::IVectorView<super::MediaProperties::AudioEncodingProperties>, windows_result::HRESULT>;
    fn SetEncodingProperties(&self, encodingProperties: windows_core::Ref<'_, super::MediaProperties::AudioEncodingProperties>) -> Result<(), windows_result::HRESULT>;
    fn ProcessFrame(&self, context: windows_core::Ref<'_, ProcessAudioFrameContext>) -> Result<(), windows_result::HRESULT>;
    fn Close(&self, reason: MediaEffectClosedReason) -> Result<(), windows_result::HRESULT>;
    fn DiscardQueuedFrames(&self) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Foundation_Collections", feature = "Media_MediaProperties"))]
impl IBasicAudioEffect_Vtbl {
    pub const fn new<Identity: IBasicAudioEffect_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn UseInputFrameForOutput<Identity: IBasicAudioEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SupportedEncodingProperties<Identity: IBasicAudioEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetEncodingProperties<Identity: IBasicAudioEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, encodingproperties: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IBasicAudioEffect_Impl::SetEncodingProperties(this, core::mem::transmute_copy(&encodingproperties)).into()
            }
        }
        unsafe extern "system" fn ProcessFrame<Identity: IBasicAudioEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, context: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IBasicAudioEffect_Impl::ProcessFrame(this, core::mem::transmute_copy(&context)).into()
            }
        }
        unsafe extern "system" fn Close<Identity: IBasicAudioEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, reason: MediaEffectClosedReason) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IBasicAudioEffect_Impl::Close(this, reason).into()
            }
        }
        unsafe extern "system" fn DiscardQueuedFrames<Identity: IBasicAudioEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IBasicVideoEffect {
    ...
    pub fn SupportedMemoryTypes(&self) -> Result<MediaMemoryTypes, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TimeIndependent(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_MediaProperties")]
    pub fn SupportedEncodingProperties(&self) -> Result<windows_collections::IVectorView<super::MediaProperties::VideoEncodingProperties>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportedEncodingProperties)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SetEncodingProperties<P0, P1>(&self, encodingproperties: P0, device: P1) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IBasicVideoEffect_Impl: super::IMediaExtension_Impl {
    ...
    fn SupportedMemoryTypes(&self) -> Result<MediaMemoryTypes, windows_result::HRESULT>;
    fn TimeIndependent(&self) -> Result<bool, windows_result::HRESULT>;
    fn SupportedEncodingProperties(&self) -> Result<windows_collections::IVectorView<super::MediaProperties::VideoEncodingProperties>, windows_result::HRESULT>;
    fn SetEncodingProperties(&self, encodingProperties: windows_core::Ref<'_, super::MediaProperties::VideoEncodingProperties>, device: windows_core::Ref<'_, super::super::Graphics::DirectX::Direct3D11::IDirect3DDevice>) -> Result<(), windows_result::HRESULT>;
    fn ProcessFrame(&self, context: windows_core::Ref<'_, ProcessVideoFrameContext>) -> Result<(), windows_result::HRESULT>;
    fn Close(&self, reason: MediaEffectClosedReason) -> Result<(), windows_result::HRESULT>;
    fn DiscardQueuedFrames(&self) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Foundation_Collections", feature = "Graphics_DirectX_Direct3D11", feature = "Media_MediaProperties"))]
impl IBasicVideoEffect_Vtbl {
    pub const fn new<Identity: IBasicVideoEffect_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn IsReadOnly<Identity: IBasicVideoEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SupportedMemoryTypes<Identity: IBasicVideoEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut MediaMemoryTypes) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TimeIndependent<Identity: IBasicVideoEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SupportedEncodingProperties<Identity: IBasicVideoEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetEncodingProperties<Identity: IBasicVideoEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, encodingproperties: *mut core::ffi::c_void, device: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ProcessFrame<Identity: IBasicVideoEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, context: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IBasicVideoEffect_Impl::ProcessFrame(this, core::mem::transmute_copy(&context)).into()
            }
        }
        unsafe extern "system" fn Close<Identity: IBasicVideoEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, reason: MediaEffectClosedReason) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IBasicVideoEffect_Impl::Close(this, reason).into()
            }
        }
        unsafe extern "system" fn DiscardQueuedFrames<Identity: IBasicVideoEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IVideoCompositor {
    ...
    #[cfg(all(feature = "Graphics_DirectX_Direct3D11", feature = "Media_MediaProperties"))]
    pub fn SetEncodingProperties<P0, P1>(&self, backgroundproperties: P0, device: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::MediaProperties::VideoEncodingProperties>,
        P1: windows_core::Param<super::super::Graphics::DirectX::Direct3D11::IDirect3DDevice>,
    {
    ...
    pub fn CompositeFrame<P0>(&self, context: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IVideoCompositor_Impl: super::IMediaExtension_Impl {
    fn TimeIndependent(&self) -> Result<bool, windows_result::HRESULT>;
    fn SetEncodingProperties(&self, backgroundProperties: windows_core::Ref<'_, super::MediaProperties::VideoEncodingProperties>, device: windows_core::Ref<'_, super::super::Graphics::DirectX::Direct3D11::IDirect3DDevice>) -> Result<(), windows_result::HRESULT>;
    fn CompositeFrame(&self, context: windows_core::Ref<'_, CompositeVideoFrameContext>) -> Result<(), windows_result::HRESULT>;
    fn Close(&self, reason: MediaEffectClosedReason) -> Result<(), windows_result::HRESULT>;
    fn DiscardQueuedFrames(&self) -> Result<(), windows_result::HRESULT>;
}
#[cfg(all(feature = "Foundation_Collections", feature = "Graphics_DirectX_Direct3D11", feature = "Media_MediaProperties"))]
impl IVideoCompositor_Vtbl {
    pub const fn new<Identity: IVideoCompositor_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn TimeIndependent<Identity: IVideoCompositor_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetEncodingProperties<Identity: IVideoCompositor_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, backgroundproperties: *mut core::ffi::c_void, device: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CompositeFrame<Identity: IVideoCompositor_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, context: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IVideoCompositor_Impl::CompositeFrame(this, core::mem::transmute_copy(&context)).into()
            }
        }
        unsafe extern "system" fn Close<Identity: IVideoCompositor_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, reason: MediaEffectClosedReason) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IVideoCompositor_Impl::Close(this, reason).into()
            }
        }
        unsafe extern "system" fn DiscardQueuedFrames<Identity: IVideoCompositor_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IVideoCompositorDefinition_Vtbl {
    pub const fn new<Identity: IVideoCompositorDefinition_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ActivatableClassId<Identity: IVideoCompositorDefinition_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Properties<Identity: IVideoCompositorDefinition_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IVideoEffectDefinition_Vtbl {
    pub const fn new<Identity: IVideoEffectDefinition_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ActivatableClassId<Identity: IVideoEffectDefinition_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Properties<Identity: IVideoEffectDefinition_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ProcessAudioFrameContext {
    pub fn InputFrame(&self) -> Result<super::AudioFrame, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OutputFrame(&self) -> Result<super::AudioFrame, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).OutputFrame)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl ProcessVideoFrameContext {
    pub fn InputFrame(&self) -> Result<super::VideoFrame, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).InputFrame)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl SlowMotionEffectDefinition {
    ...
    pub fn TimeStretchRate(&self) -> Result<f64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTimeStretchRate(&self, value: f64) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl VideoCompositorDefinition {
    ...
    pub fn Create(activatableclassid: &windows_core::HSTRING) -> Result<VideoCompositorDefinition, windows_result::HRESULT> {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn CreateWithProperties<P1>(activatableclassid: &windows_core::HSTRING, props: P1) -> Result<VideoCompositorDefinition, windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::Foundation::Collections::IPropertySet>,
    {
        Self::IVideoCompositorDefinitionFactory(|this| unsafe {
    ...
    fn IVideoCompositorDefinitionFactory<R, F: FnOnce(&IVideoCompositorDefinitionFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl VideoEffectDefinition {
    ...
    pub fn Create(activatableclassid: &windows_core::HSTRING) -> Result<VideoEffectDefinition, windows_result::HRESULT> {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn CreateWithProperties<P1>(activatableclassid: &windows_core::HSTRING, props: P1) -> Result<VideoEffectDefinition, windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::Foundation::Collections::IPropertySet>,
    {
        Self::IVideoEffectDefinitionFactory(|this| unsafe {
    ...
    fn IVideoEffectDefinitionFactory<R, F: FnOnce(&IVideoEffectDefinitionFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl VideoTransformEffectDefinition {
    ...
    #[cfg(feature = "UI")]
    pub fn PaddingColor(&self) -> Result<super::super::UI::Color, windows_result::HRESULT> {
    ...
    #[cfg(feature = "UI")]
    pub fn SetPaddingColor(&self, value: super::super::UI::Color) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVideoTransformEffectDefinition>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetPaddingColor)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn OutputSize(&self) -> Result<super::super::Foundation::Size, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVideoTransformEffectDefinition>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOutputSize(&self, value: super::super::Foundation::Size) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVideoTransformEffectDefinition>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetOutputSize)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CropRectangle(&self) -> Result<super::super::Foundation::Rect, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVideoTransformEffectDefinition>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCropRectangle(&self, value: super::super::Foundation::Rect) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVideoTransformEffectDefinition>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetCropRectangle)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Media_MediaProperties")]
    pub fn Rotation(&self) -> Result<super::MediaProperties::MediaRotation, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVideoTransformEffectDefinition>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_MediaProperties")]
    pub fn SetRotation(&self, value: super::MediaProperties::MediaRotation) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVideoTransformEffectDefinition>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetRotation)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Media_MediaProperties")]
    pub fn Mirror(&self) -> Result<super::MediaProperties::MediaMirroringOptions, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVideoTransformEffectDefinition>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_MediaProperties")]
    pub fn SetMirror(&self, value: super::MediaProperties::MediaMirroringOptions) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVideoTransformEffectDefinition>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetMirror)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Media_Transcoding")]
    pub fn SetProcessingAlgorithm(&self, value: super::Transcoding::MediaVideoProcessingAlgorithm) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVideoTransformEffectDefinition>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetProcessingAlgorithm)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Media_Transcoding")]
    pub fn ProcessingAlgorithm(&self) -> Result<super::Transcoding::MediaVideoProcessingAlgorithm, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVideoTransformEffectDefinition>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SphericalProjection(&self) -> Result<VideoTransformSphericalProjection, windows_result::HRESULT> {
...
impl VideoTransformSphericalProjection {
    ...
    #[cfg(feature = "Media_Playback")]
    pub fn ProjectionMode(&self) -> Result<super::Playback::SphericalVideoProjectionMode, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_Playback")]
    pub fn SetProjectionMode(&self, value: super::Playback::SphericalVideoProjectionMode) -> Result<(), windows_result::HRESULT> {
        let this = self;
