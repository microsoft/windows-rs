...
impl PhoneNumberFormatter {
    ...
    pub fn Format<P0>(&self, number: P0) -> windows_result::Result<windows_core::HSTRING>
    where
    ...
    pub fn FormatWithOutputFormat<P0>(&self, number: P0, numberformat: PhoneNumberFormat) -> windows_result::Result<windows_core::HSTRING>
    where
        P0: windows_core::Param<PhoneNumberInfo>,
    {
        let this = self;
    ...
    pub fn FormatPartialString(&self, number: &windows_core::HSTRING) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FormatString(&self, number: &windows_core::HSTRING) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FormatStringWithLeftToRightMarkers(&self, number: &windows_core::HSTRING) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryCreate(regioncode: &windows_core::HSTRING, phonenumber: &mut Option<PhoneNumberFormatter>) -> windows_result::Result<()> {
    ...
    pub fn GetCountryCodeForRegion(regioncode: &windows_core::HSTRING) -> windows_result::Result<i32> {
    ...
    pub fn GetNationalDirectDialingPrefixForRegion(regioncode: &windows_core::HSTRING, stripnondigit: bool) -> windows_result::Result<windows_core::HSTRING> {
        Self::IPhoneNumberFormatterStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn WrapWithLeftToRightMarkers(number: &windows_core::HSTRING) -> windows_result::Result<windows_core::HSTRING> {
        Self::IPhoneNumberFormatterStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IPhoneNumberFormatterStatics<R, F: FnOnce(&IPhoneNumberFormatterStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl PhoneNumberInfo {
    pub fn CountryCode(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetLengthOfGeographicalAreaCode(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetNationalSignificantNumber(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetLengthOfNationalDestinationCode(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PredictNumberKind(&self) -> windows_result::Result<PredictedPhoneNumberKind> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetGeographicRegionCode(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CheckNumberMatch<P0>(&self, othernumber: P0) -> windows_result::Result<PhoneNumberMatchResult>
    where
        P0: windows_core::Param<PhoneNumberInfo>,
    {
        let this = self;
    ...
    pub fn Create(number: &windows_core::HSTRING) -> windows_result::Result<PhoneNumberInfo> {
    ...
    pub fn TryParse(input: &windows_core::HSTRING, phonenumber: &mut Option<PhoneNumberInfo>) -> windows_result::Result<PhoneNumberParseResult> {
    ...
    pub fn TryParseWithRegion(input: &windows_core::HSTRING, regioncode: &windows_core::HSTRING, phonenumber: &mut Option<PhoneNumberInfo>) -> windows_result::Result<PhoneNumberParseResult> {
        Self::IPhoneNumberInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IPhoneNumberInfoFactory<R, F: FnOnce(&IPhoneNumberInfoFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PhoneNumberInfo, IPhoneNumberInfoFactory> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IPhoneNumberInfoStatics<R, F: FnOnce(&IPhoneNumberInfoStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
