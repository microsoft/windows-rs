...
windows_core::imp::required_hierarchy!(CharacterGrouping, ICharacterGrouping);
...
#[cfg(feature = "Foundation_Collections")]
windows_core::imp::required_hierarchy!(CharacterGroupings, super::super::Foundation::Collections::IIterable<CharacterGrouping>, super::super::Foundation::Collections::IVectorView<CharacterGrouping>, ICharacterGroupings, ICharacterGroupingsFactory);
#[cfg(feature = "Foundation_Collections")]
