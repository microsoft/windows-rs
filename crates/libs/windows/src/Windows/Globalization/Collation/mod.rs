...
impl CharacterGrouping {
    pub fn First(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
...
windows_core::imp::required_hierarchy!(CharacterGroupings, windows_collections::IIterable<CharacterGrouping>, windows_collections::IVectorView<CharacterGrouping>);
impl CharacterGroupings {
    ...
    pub fn Lookup(&self, text: &windows_core::HSTRING) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Create(language: &windows_core::HSTRING) -> Result<CharacterGroupings, windows_result::HRESULT> {
    ...
    pub fn First(&self) -> Result<windows_collections::IIterator<CharacterGrouping>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<windows_collections::IIterable<CharacterGrouping>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).First)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
    pub fn GetAt(&self, index: u32) -> Result<CharacterGrouping, windows_result::HRESULT> {
    ...
    pub fn GetMany(&self, startindex: u32, items: &mut [Option<CharacterGrouping>]) -> Result<u32, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<windows_collections::IVectorView<CharacterGrouping>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn ICharacterGroupingsFactory<R, F: FnOnce(&ICharacterGroupingsFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
