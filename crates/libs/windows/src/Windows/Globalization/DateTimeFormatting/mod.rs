...
impl DateTimeFormatter {
    ...
    pub fn Calendar(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Clock(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Patterns(&self) -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Format(&self, value: super::super::Foundation::DateTime) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IncludeYear(&self) -> windows_result::Result<YearFormat> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IncludeMonth(&self) -> windows_result::Result<MonthFormat> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IncludeDayOfWeek(&self) -> windows_result::Result<DayOfWeekFormat> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IncludeDay(&self) -> windows_result::Result<DayFormat> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IncludeHour(&self) -> windows_result::Result<HourFormat> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IncludeMinute(&self) -> windows_result::Result<MinuteFormat> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IncludeSecond(&self) -> windows_result::Result<SecondFormat> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ResolvedGeographicRegion(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FormatUsingTimeZone(&self, datetime: super::super::Foundation::DateTime, timezoneid: &windows_core::HSTRING) -> windows_result::Result<windows_core::HSTRING> {
    ...
    pub fn CreateDateTimeFormatter(formattemplate: &windows_core::HSTRING) -> windows_result::Result<DateTimeFormatter> {
    ...
    pub fn CreateDateTimeFormatterLanguages<P1>(formattemplate: &windows_core::HSTRING, languages: P1) -> windows_result::Result<DateTimeFormatter>
    where
    ...
    pub fn CreateDateTimeFormatterContext<P1>(formattemplate: &windows_core::HSTRING, languages: P1, geographicregion: &windows_core::HSTRING, calendar: &windows_core::HSTRING, clock: &windows_core::HSTRING) -> windows_result::Result<DateTimeFormatter>
    where
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        Self::IDateTimeFormatterFactory(|this| unsafe {
    ...
    pub fn CreateDateTimeFormatterDate(yearformat: YearFormat, monthformat: MonthFormat, dayformat: DayFormat, dayofweekformat: DayOfWeekFormat) -> windows_result::Result<DateTimeFormatter> {
        Self::IDateTimeFormatterFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateDateTimeFormatterTime(hourformat: HourFormat, minuteformat: MinuteFormat, secondformat: SecondFormat) -> windows_result::Result<DateTimeFormatter> {
        Self::IDateTimeFormatterFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateDateTimeFormatterDateTimeLanguages<P7>(yearformat: YearFormat, monthformat: MonthFormat, dayformat: DayFormat, dayofweekformat: DayOfWeekFormat, hourformat: HourFormat, minuteformat: MinuteFormat, secondformat: SecondFormat, languages: P7) -> windows_result::Result<DateTimeFormatter>
    where
    ...
    pub fn CreateDateTimeFormatterDateTimeContext<P7>(yearformat: YearFormat, monthformat: MonthFormat, dayformat: DayFormat, dayofweekformat: DayOfWeekFormat, hourformat: HourFormat, minuteformat: MinuteFormat, secondformat: SecondFormat, languages: P7, geographicregion: &windows_core::HSTRING, calendar: &windows_core::HSTRING, clock: &windows_core::HSTRING) -> windows_result::Result<DateTimeFormatter>
    where
        P7: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        Self::IDateTimeFormatterFactory(|this| unsafe {
    ...
    pub fn LongDate() -> windows_result::Result<DateTimeFormatter> {
    ...
    pub fn LongTime() -> windows_result::Result<DateTimeFormatter> {
        Self::IDateTimeFormatterStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShortDate() -> windows_result::Result<DateTimeFormatter> {
        Self::IDateTimeFormatterStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShortTime() -> windows_result::Result<DateTimeFormatter> {
        Self::IDateTimeFormatterStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IDateTimeFormatterFactory<R, F: FnOnce(&IDateTimeFormatterFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IDateTimeFormatterStatics<R, F: FnOnce(&IDateTimeFormatterStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
