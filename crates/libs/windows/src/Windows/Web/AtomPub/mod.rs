...
impl AtomPubClient {
    ...
    pub fn RetrieveServiceDocumentAsync<P0>(&self, uri: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<ServiceDocument, super::Syndication::RetrievalProgress>>
    where
    ...
    pub fn RetrieveMediaResourceAsync<P0>(&self, uri: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<super::super::Storage::Streams::IInputStream, super::Syndication::RetrievalProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn RetrieveResourceAsync<P0>(&self, uri: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<super::Syndication::SyndicationItem, super::Syndication::RetrievalProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn CreateResourceAsync<P0, P2>(&self, uri: P0, description: &windows_core::HSTRING, item: P2) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<super::Syndication::SyndicationItem, super::Syndication::TransferProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateMediaResourceAsync<P0, P3>(&self, uri: P0, mediatype: &windows_core::HSTRING, description: &windows_core::HSTRING, mediastream: P3) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<super::Syndication::SyndicationItem, super::Syndication::TransferProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn UpdateMediaResourceAsync<P0, P2>(&self, uri: P0, mediatype: &windows_core::HSTRING, mediastream: P2) -> windows_result::Result<windows_future::IAsyncActionWithProgress<super::Syndication::TransferProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    ...
    pub fn UpdateResourceAsync<P0, P1>(&self, uri: P0, item: P1) -> windows_result::Result<windows_future::IAsyncActionWithProgress<super::Syndication::TransferProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    ...
    pub fn UpdateResourceItemAsync<P0>(&self, item: P0) -> windows_result::Result<windows_future::IAsyncActionWithProgress<super::Syndication::TransferProgress>>
    where
    ...
    pub fn DeleteResourceAsync<P0>(&self, uri: P0) -> windows_result::Result<windows_future::IAsyncActionWithProgress<super::Syndication::TransferProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn DeleteResourceItemAsync<P0>(&self, item: P0) -> windows_result::Result<windows_future::IAsyncActionWithProgress<super::Syndication::TransferProgress>>
    where
        P0: windows_core::Param<super::Syndication::SyndicationItem>,
    {
        let this = self;
    ...
    pub fn CancelAsyncOperations(&self) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).CancelAsyncOperations)(windows_core::Interface::as_raw(this)).ok() }
    }
    #[cfg(feature = "Security_Credentials")]
    pub fn CreateAtomPubClientWithCredentials<P0>(servercredential: P0) -> windows_result::Result<AtomPubClient>
    where
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn ServerCredential(&self) -> windows_result::Result<super::super::Security::Credentials::PasswordCredential> {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn ProxyCredential(&self) -> windows_result::Result<super::super::Security::Credentials::PasswordCredential> {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationClient>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MaxResponseBufferSize(&self) -> windows_result::Result<u32> {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationClient>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxResponseBufferSize(&self, value: u32) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationClient>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetMaxResponseBufferSize)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Timeout(&self) -> windows_result::Result<u32> {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationClient>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTimeout(&self, value: u32) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationClient>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetTimeout)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn BypassCacheOnRetrieve(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationClient>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetBypassCacheOnRetrieve(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationClient>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetBypassCacheOnRetrieve)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SetRequestHeader(&self, name: &windows_core::HSTRING, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationClient>(self)?;
    ...
    pub fn RetrieveFeedAsync<P0>(&self, uri: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<super::Syndication::SyndicationFeed, super::Syndication::RetrievalProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationClient>(self)?;
    ...
    fn IAtomPubClientFactory<R, F: FnOnce(&IAtomPubClientFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl ResourceCollection {
    pub fn Title(&self) -> windows_result::Result<super::Syndication::ISyndicationText> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Categories(&self) -> windows_result::Result<windows_collections::IVectorView<super::Syndication::SyndicationCategory>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Accepts(&self) -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetNodeName(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationNode>(self)?;
    ...
    pub fn NodeNamespace(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationNode>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetNodeNamespace(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationNode>(self)?;
    ...
    pub fn NodeValue(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationNode>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetNodeValue(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationNode>(self)?;
    ...
    pub fn BaseUri(&self) -> windows_result::Result<super::super::Foundation::Uri> {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationNode>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetBaseUri<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationNode>(self)?;
    ...
    pub fn AttributeExtensions(&self) -> windows_result::Result<windows_collections::IVector<super::Syndication::SyndicationAttribute>> {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationNode>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ElementExtensions(&self) -> windows_result::Result<windows_collections::IVector<super::Syndication::ISyndicationNode>> {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationNode>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetXmlDocument(&self, format: super::Syndication::SyndicationFormat) -> windows_result::Result<super::super::Data::Xml::Dom::XmlDocument> {
        let this = &windows_core::Interface::cast::<super::Syndication::ISyndicationNode>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ServiceDocument {
    pub fn Workspaces(&self) -> windows_result::Result<windows_collections::IVectorView<Workspace>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl Workspace {
    ...
    pub fn Collections(&self) -> windows_result::Result<windows_collections::IVectorView<ResourceCollection>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
