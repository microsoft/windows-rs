...
pub trait IUriToStreamResolver_Impl: windows_core::IUnknownImpl {
    fn UriToStreamAsync(&self, uri: windows_core::Ref<super::Foundation::Uri>) -> windows_core::Result<super::Foundation::IAsyncOperation<super::Storage::Streams::IInputStream>>;
}
#[cfg(feature = "Storage_Streams")]
