...
impl IUriToStreamResolver {
    ...
    pub fn UriToStreamAsync<P0>(&self, uri: P0) -> windows_core::Result<windows_async::IAsyncOperation<super::Storage::Streams::IInputStream>>
    where
...
pub trait IUriToStreamResolver_Impl: windows_core::IUnknownImpl {
    fn UriToStreamAsync(&self, uri: windows_core::Ref<'_, super::Foundation::Uri>) -> windows_core::Result<windows_async::IAsyncOperation<super::Storage::Streams::IInputStream>>;
}
#[cfg(feature = "Storage_Streams")]
