...
impl ISyndicationClient {
    ...
    pub fn RetrieveFeedAsync<P0>(&self, uri: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<SyndicationFeed, RetrievalProgress>>
    where
...
pub trait ISyndicationClient_Impl: windows_core::IUnknownImpl {
    ...
    fn RetrieveFeedAsync(&self, uri: windows_core::Ref<'_, super::super::Foundation::Uri>) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<SyndicationFeed, RetrievalProgress>>;
}
#[cfg(feature = "Security_Credentials")]
