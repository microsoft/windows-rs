...
impl WebViewControl {
    pub fn Source(&self) -> windows_result::Result<super::super::super::Foundation::Uri> {
        let this = self;
        unsafe {
    ...
    #[cfg(feature = "UI")]
    pub fn SetDefaultBackgroundColor(&self, value: super::super::super::UI::Color) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDefaultBackgroundColor)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "UI")]
    pub fn DefaultBackgroundColor(&self) -> windows_result::Result<super::super::super::UI::Color> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Settings(&self) -> windows_result::Result<super::WebViewControlSettings> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeferredPermissionRequests(&self) -> windows_result::Result<windows_collections::IVectorView<super::WebViewControlDeferredPermissionRequest>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CaptureSelectedContentToDataPackageAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<super::super::super::ApplicationModel::DataTransfer::DataPackage>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BuildLocalStreamUri(&self, contentidentifier: &windows_core::HSTRING, relativepath: &windows_core::HSTRING) -> windows_result::Result<super::super::super::Foundation::Uri> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDeferredPermissionRequestById(&self, id: u32, result: &mut Option<super::WebViewControlDeferredPermissionRequest>) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn Process(&self) -> windows_result::Result<WebViewControlProcess> {
    ...
    pub fn SetScale(&self, value: f64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IWebViewControlSite>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetScale)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Scale(&self) -> windows_result::Result<f64> {
        let this = &windows_core::Interface::cast::<IWebViewControlSite>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetBounds(&self, value: super::super::super::Foundation::Rect) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IWebViewControlSite>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetBounds)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Bounds(&self) -> windows_result::Result<super::super::super::Foundation::Rect> {
        let this = &windows_core::Interface::cast::<IWebViewControlSite>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MoveFocus(&self, reason: WebViewControlMoveFocusReason) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IWebViewControlSite>(self)?;
        unsafe { (windows_core::Interface::vtable(this).MoveFocus)(windows_core::Interface::as_raw(this), reason).ok() }
    }
    pub fn MoveFocusRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveMoveFocusRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IWebViewControlSite>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemoveMoveFocusRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn AcceleratorKeyPressed<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveAcceleratorKeyPressed(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IWebViewControlSite>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemoveAcceleratorKeyPressed)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GotFocus<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveGotFocus(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IWebViewControlSite2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemoveGotFocus)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn LostFocus<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::Foundation::TypedEventHandler<WebViewControl, windows_core::IInspectable>>,
    {
        let this = &windows_core::Interface::cast::<IWebViewControlSite2>(self)?;
    ...
    pub fn RemoveLostFocus(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IWebViewControlSite2>(self)?;
...
impl WebViewControlAcceleratorKeyPressedEventArgs {
    #[cfg(feature = "UI_Core")]
    pub fn EventType(&self) -> windows_result::Result<super::super::super::UI::Core::CoreAcceleratorKeyEventType> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "System")]
    pub fn VirtualKey(&self) -> windows_result::Result<super::super::super::System::VirtualKey> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Core")]
    pub fn KeyStatus(&self) -> windows_result::Result<super::super::super::UI::Core::CorePhysicalKeyStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RoutingStage(&self) -> windows_result::Result<WebViewControlAcceleratorKeyRoutingStage> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WebViewControlMoveFocusRequestedEventArgs {
    pub fn Reason(&self) -> windows_result::Result<WebViewControlMoveFocusReason> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WebViewControlProcess {
    ...
    pub fn IsPrivateNetworkClientServerCapabilityEnabled(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateWebViewControlAsync(&self, hostwindowhandle: i64, bounds: super::super::super::Foundation::Rect) -> windows_result::Result<windows_future::IAsyncOperation<WebViewControl>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetWebViewControls(&self) -> windows_result::Result<windows_collections::IVectorView<WebViewControl>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Terminate(&self) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).Terminate)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn ProcessExited<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveProcessExited(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveProcessExited)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn CreateWithOptions<P0>(processoptions: P0) -> windows_result::Result<WebViewControlProcess>
    where
    ...
    fn IWebViewControlProcessFactory<R, F: FnOnce(&IWebViewControlProcessFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl WebViewControlProcessOptions {
    ...
    pub fn SetPrivateNetworkClientServerCapability(&self, value: WebViewControlProcessCapabilityState) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn PrivateNetworkClientServerCapability(&self) -> windows_result::Result<WebViewControlProcessCapabilityState> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
