...
windows_core::imp::required_hierarchy!(HttpBaseProtocolFilter, super::super::super::Foundation::IClosable, IHttpBaseProtocolFilter, IHttpBaseProtocolFilter2, IHttpBaseProtocolFilter3, IHttpBaseProtocolFilter4, IHttpBaseProtocolFilter5, IHttpBaseProtocolFilterStatics, IHttpFilter);
...
windows_core::imp::required_hierarchy!(HttpCacheControl, IHttpCacheControl);
...
windows_core::imp::required_hierarchy!(HttpServerCustomValidationRequestedEventArgs, IHttpServerCustomValidationRequestedEventArgs);
