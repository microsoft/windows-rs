...
impl HttpBaseProtocolFilter {
    ...
    pub fn AllowAutoRedirect(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
    ...
    pub fn SetAllowAutoRedirect(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAllowAutoRedirect)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AllowUI(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAllowUI(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAllowUI)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AutomaticDecompression(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAutomaticDecompression(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAutomaticDecompression)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CacheControl(&self) -> windows_result::Result<HttpCacheControl> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CookieManager(&self) -> windows_result::Result<super::HttpCookieManager> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ClientCertificate(&self) -> windows_result::Result<super::super::super::Security::Cryptography::Certificates::Certificate> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Cryptography_Certificates")]
    pub fn SetClientCertificate<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Security_Cryptography_Certificates")]
    pub fn IgnorableServerCertificateErrors(&self) -> windows_result::Result<windows_collections::IVector<super::super::super::Security::Cryptography::Certificates::ChainValidationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MaxConnectionsPerServer(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxConnectionsPerServer(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetMaxConnectionsPerServer)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Security_Credentials")]
    pub fn ProxyCredential(&self) -> windows_result::Result<super::super::super::Security::Credentials::PasswordCredential> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn SetProxyCredential<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn ServerCredential(&self) -> windows_result::Result<super::super::super::Security::Credentials::PasswordCredential> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn SetServerCredential<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::super::Security::Credentials::PasswordCredential>,
    {
        let this = self;
    ...
    pub fn UseProxy(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetUseProxy(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetUseProxy)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn MaxVersion(&self) -> windows_result::Result<super::HttpVersion> {
    ...
    pub fn SetMaxVersion(&self, value: super::HttpVersion) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IHttpBaseProtocolFilter2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetMaxVersion)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CookieUsageBehavior(&self) -> windows_result::Result<HttpCookieUsageBehavior> {
    ...
    pub fn SetCookieUsageBehavior(&self, value: HttpCookieUsageBehavior) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IHttpBaseProtocolFilter3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetCookieUsageBehavior)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ServerCustomValidationRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveServerCustomValidationRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IHttpBaseProtocolFilter4>(self)?;
    ...
    pub fn ClearAuthenticationCache(&self) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IHttpBaseProtocolFilter4>(self)?;
    ...
    #[cfg(feature = "System")]
    pub fn CreateForUser<P0>(user: P0) -> windows_result::Result<HttpBaseProtocolFilter>
    where
    ...
    pub fn SendRequestAsync<P0>(&self, request: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<super::HttpResponseMessage, super::HttpProgress>>
    where
    ...
    fn IHttpBaseProtocolFilterStatics<R, F: FnOnce(&IHttpBaseProtocolFilterStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl HttpCacheControl {
    pub fn ReadBehavior(&self) -> windows_result::Result<HttpCacheReadBehavior> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetReadBehavior(&self, value: HttpCacheReadBehavior) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetReadBehavior)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn WriteBehavior(&self) -> windows_result::Result<HttpCacheWriteBehavior> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetWriteBehavior(&self, value: HttpCacheWriteBehavior) -> windows_result::Result<()> {
        let this = self;
...
impl HttpServerCustomValidationRequestedEventArgs {
    pub fn RequestMessage(&self) -> windows_result::Result<super::HttpRequestMessage> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Cryptography_Certificates")]
    pub fn ServerCertificate(&self) -> windows_result::Result<super::super::super::Security::Cryptography::Certificates::Certificate> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ServerCertificateErrorSeverity(&self) -> windows_result::Result<super::super::super::Networking::Sockets::SocketSslErrorSeverity> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Cryptography_Certificates")]
    pub fn ServerCertificateErrors(&self) -> windows_result::Result<windows_collections::IVectorView<super::super::super::Security::Cryptography::Certificates::ChainValidationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Cryptography_Certificates")]
    pub fn ServerIntermediateCertificates(&self) -> windows_result::Result<windows_collections::IVectorView<super::super::super::Security::Cryptography::Certificates::Certificate>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Reject(&self) -> windows_result::Result<()> {
        let this = self;
...
pub trait IHttpFilter_Impl: super::super::super::Foundation::IClosable_Impl {
    fn SendRequestAsync(&self, request: windows_core::Ref<super::HttpRequestMessage>) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<super::HttpResponseMessage, super::HttpProgress>>;
}
