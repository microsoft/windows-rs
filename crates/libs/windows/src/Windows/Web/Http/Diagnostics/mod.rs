...
impl HttpDiagnosticProvider {
    ...
    pub fn RequestSent<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveRequestSent(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveRequestSent)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn ResponseReceived<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveResponseReceived(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveResponseReceived)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn RequestResponseCompleted<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveRequestResponseCompleted(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn CreateFromProcessDiagnosticInfo<P0>(processdiagnosticinfo: P0) -> windows_result::Result<HttpDiagnosticProvider>
    where
    ...
    fn IHttpDiagnosticProviderStatics<R, F: FnOnce(&IHttpDiagnosticProviderStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl HttpDiagnosticProviderRequestResponseCompletedEventArgs {
    ...
    pub fn Timestamps(&self) -> windows_result::Result<HttpDiagnosticProviderRequestResponseTimestamps> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestedUri(&self) -> windows_result::Result<super::super::super::Foundation::Uri> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ThreadId(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Initiator(&self) -> windows_result::Result<HttpDiagnosticRequestInitiator> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SourceLocations(&self) -> windows_result::Result<windows_collections::IVectorView<HttpDiagnosticSourceLocation>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl HttpDiagnosticProviderRequestResponseTimestamps {
    pub fn CacheCheckedTimestamp(&self) -> windows_result::Result<super::super::super::Foundation::IReference<super::super::super::Foundation::DateTime>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ConnectionInitiatedTimestamp(&self) -> windows_result::Result<super::super::super::Foundation::IReference<super::super::super::Foundation::DateTime>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NameResolvedTimestamp(&self) -> windows_result::Result<super::super::super::Foundation::IReference<super::super::super::Foundation::DateTime>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SslNegotiatedTimestamp(&self) -> windows_result::Result<super::super::super::Foundation::IReference<super::super::super::Foundation::DateTime>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ConnectionCompletedTimestamp(&self) -> windows_result::Result<super::super::super::Foundation::IReference<super::super::super::Foundation::DateTime>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestSentTimestamp(&self) -> windows_result::Result<super::super::super::Foundation::IReference<super::super::super::Foundation::DateTime>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestCompletedTimestamp(&self) -> windows_result::Result<super::super::super::Foundation::IReference<super::super::super::Foundation::DateTime>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ResponseReceivedTimestamp(&self) -> windows_result::Result<super::super::super::Foundation::IReference<super::super::super::Foundation::DateTime>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ResponseCompletedTimestamp(&self) -> windows_result::Result<super::super::super::Foundation::IReference<super::super::super::Foundation::DateTime>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl HttpDiagnosticProviderRequestSentEventArgs {
    ...
    pub fn Message(&self) -> windows_result::Result<super::HttpRequestMessage> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl HttpDiagnosticProviderResponseReceivedEventArgs {
    ...
    pub fn Message(&self) -> windows_result::Result<super::HttpResponseMessage> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Message)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl HttpDiagnosticSourceLocation {
    pub fn SourceUri(&self) -> windows_result::Result<super::super::super::Foundation::Uri> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LineNumber(&self) -> windows_result::Result<u64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ColumnNumber(&self) -> windows_result::Result<u64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
