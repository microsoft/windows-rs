...
windows_core::imp::required_hierarchy!(HttpBufferContent, super::super::Foundation::IClosable, super::super::Foundation::IStringable, IHttpBufferContentFactory, IHttpContent);
...
windows_core::imp::required_hierarchy!(HttpClient, super::super::Foundation::IClosable, super::super::Foundation::IStringable, IHttpClient, IHttpClient2, IHttpClient3, IHttpClientFactory);
impl HttpClient {
...
windows_core::imp::required_hierarchy!(HttpCookie, super::super::Foundation::IStringable, IHttpCookie, IHttpCookieFactory);
impl HttpCookie {
    pub fn ToString(&self) -> windows_core::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<super::super::Foundation::IStringable>(self)?;
        unsafe {
...
windows_core::imp::required_hierarchy!(HttpCookieManager, IHttpCookieManager);
...
windows_core::imp::required_hierarchy!(HttpFormUrlEncodedContent, super::super::Foundation::IClosable, super::super::Foundation::IStringable, IHttpContent, IHttpFormUrlEncodedContentFactory);
...
windows_core::imp::required_hierarchy!(HttpGetBufferResult, super::super::Foundation::IClosable, super::super::Foundation::IStringable, IHttpGetBufferResult);
...
windows_core::imp::required_hierarchy!(HttpGetInputStreamResult, super::super::Foundation::IClosable, super::super::Foundation::IStringable, IHttpGetInputStreamResult);
...
windows_core::imp::required_hierarchy!(HttpGetStringResult, super::super::Foundation::IClosable, super::super::Foundation::IStringable, IHttpGetStringResult);
...
windows_core::imp::required_hierarchy!(HttpMethod, super::super::Foundation::IStringable, IHttpMethod, IHttpMethodFactory, IHttpMethodStatics);
impl HttpMethod {
    pub fn ToString(&self) -> windows_core::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<super::super::Foundation::IStringable>(self)?;
        unsafe {
...
#[cfg(feature = "Foundation_Collections")]
windows_core::imp::required_hierarchy!(HttpMultipartContent, super::super::Foundation::Collections::IIterable<IHttpContent>, super::super::Foundation::IClosable, super::super::Foundation::IStringable, IHttpContent, IHttpMultipartContent, IHttpMultipartContentFactory);
#[cfg(feature = "Foundation_Collections")]
...
#[cfg(feature = "Foundation_Collections")]
windows_core::imp::required_hierarchy!(HttpMultipartFormDataContent, super::super::Foundation::Collections::IIterable<IHttpContent>, super::super::Foundation::IClosable, super::super::Foundation::IStringable, IHttpContent, IHttpMultipartFormDataContent, IHttpMultipartFormDataContentFactory);
#[cfg(feature = "Foundation_Collections")]
...
windows_core::imp::required_hierarchy!(HttpRequestMessage, super::super::Foundation::IClosable, super::super::Foundation::IStringable, IHttpRequestMessage, IHttpRequestMessage2, IHttpRequestMessageFactory);
...
windows_core::imp::required_hierarchy!(HttpRequestResult, super::super::Foundation::IClosable, super::super::Foundation::IStringable, IHttpRequestResult);
...
windows_core::imp::required_hierarchy!(HttpResponseMessage, super::super::Foundation::IClosable, super::super::Foundation::IStringable, IHttpResponseMessage, IHttpResponseMessageFactory);
...
windows_core::imp::required_hierarchy!(HttpStreamContent, super::super::Foundation::IClosable, super::super::Foundation::IStringable, IHttpContent, IHttpStreamContentFactory);
...
windows_core::imp::required_hierarchy!(HttpStringContent, super::super::Foundation::IClosable, super::super::Foundation::IStringable, IHttpContent, IHttpStringContentFactory);
...
windows_core::imp::required_hierarchy!(HttpTransportInformation, super::super::Foundation::IStringable, IHttpTransportInformation);
