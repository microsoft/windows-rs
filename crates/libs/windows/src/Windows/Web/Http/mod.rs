...
impl HttpBufferContent {
    ...
    pub fn BufferAllAsync(&self) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<u64, u64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ReadAsBufferAsync(&self) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<super::super::Storage::Streams::IBuffer, u64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ReadAsInputStreamAsync(&self) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<super::super::Storage::Streams::IInputStream, u64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReadAsStringAsync(&self) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<windows_core::HSTRING, u64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn WriteToStreamAsync<P0>(&self, outputstream: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<u64, u64>>
    where
...
impl HttpClient {
    ...
    pub fn DeleteAsync<P0>(&self, uri: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<HttpResponseMessage, HttpProgress>>
    where
    ...
    pub fn GetAsync<P0>(&self, uri: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<HttpResponseMessage, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn GetWithOptionAsync<P0>(&self, uri: P0, completionoption: HttpCompletionOption) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<HttpResponseMessage, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetBufferAsync<P0>(&self, uri: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<super::super::Storage::Streams::IBuffer, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetInputStreamAsync<P0>(&self, uri: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<super::super::Storage::Streams::IInputStream, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn GetStringAsync<P0>(&self, uri: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<windows_core::HSTRING, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn PostAsync<P0, P1>(&self, uri: P0, content: P1) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<HttpResponseMessage, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    ...
    pub fn PutAsync<P0, P1>(&self, uri: P0, content: P1) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<HttpResponseMessage, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
        P1: windows_core::Param<IHttpContent>,
    {
    ...
    pub fn SendRequestAsync<P0>(&self, request: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<HttpResponseMessage, HttpProgress>>
    where
    ...
    pub fn SendRequestWithOptionAsync<P0>(&self, request: P0, completionoption: HttpCompletionOption) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<HttpResponseMessage, HttpProgress>>
    where
        P0: windows_core::Param<HttpRequestMessage>,
    {
        let this = self;
    ...
    pub fn TryDeleteAsync<P0>(&self, uri: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<HttpRequestResult, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
    ...
    pub fn TryGetAsync<P0>(&self, uri: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<HttpRequestResult, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = &windows_core::Interface::cast::<IHttpClient2>(self)?;
    ...
    pub fn TryGetAsync2<P0>(&self, uri: P0, completionoption: HttpCompletionOption) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<HttpRequestResult, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = &windows_core::Interface::cast::<IHttpClient2>(self)?;
    ...
    pub fn TryGetBufferAsync<P0>(&self, uri: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<HttpGetBufferResult, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = &windows_core::Interface::cast::<IHttpClient2>(self)?;
    ...
    pub fn TryGetInputStreamAsync<P0>(&self, uri: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<HttpGetInputStreamResult, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = &windows_core::Interface::cast::<IHttpClient2>(self)?;
    ...
    pub fn TryGetStringAsync<P0>(&self, uri: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<HttpGetStringResult, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = &windows_core::Interface::cast::<IHttpClient2>(self)?;
    ...
    pub fn TryPostAsync<P0, P1>(&self, uri: P0, content: P1) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<HttpRequestResult, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
        P1: windows_core::Param<IHttpContent>,
    {
    ...
    pub fn TryPutAsync<P0, P1>(&self, uri: P0, content: P1) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<HttpRequestResult, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
        P1: windows_core::Param<IHttpContent>,
    {
    ...
    pub fn TrySendRequestAsync<P0>(&self, request: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<HttpRequestResult, HttpProgress>>
    where
        P0: windows_core::Param<HttpRequestMessage>,
    {
        let this = &windows_core::Interface::cast::<IHttpClient2>(self)?;
    ...
    pub fn TrySendRequestAsync2<P0>(&self, request: P0, completionoption: HttpCompletionOption) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<HttpRequestResult, HttpProgress>>
    where
        P0: windows_core::Param<HttpRequestMessage>,
    {
        let this = &windows_core::Interface::cast::<IHttpClient2>(self)?;
...
pub trait IHttpContent_Impl: super::super::Foundation::IClosable_Impl {
    ...
    fn BufferAllAsync(&self) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<u64, u64>>;
    fn ReadAsBufferAsync(&self) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<super::super::Storage::Streams::IBuffer, u64>>;
    fn ReadAsInputStreamAsync(&self) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<super::super::Storage::Streams::IInputStream, u64>>;
    fn ReadAsStringAsync(&self) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<windows_core::HSTRING, u64>>;
    fn TryComputeLength(&self, length: &mut u64) -> windows_core::Result<bool>;
    fn WriteToStreamAsync(&self, outputStream: windows_core::Ref<'_, super::super::Storage::Streams::IOutputStream>) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<u64, u64>>;
}
#[cfg(all(feature = "Storage_Streams", feature = "Web_Http_Headers"))]
