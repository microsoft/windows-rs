...
impl HttpBufferContent {
    ...
    pub fn CreateFromBuffer<P0>(content: P0) -> windows_result::Result<HttpBufferContent>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromBufferWithOffset<P0>(content: P0, offset: u32, count: u32) -> windows_result::Result<HttpBufferContent>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::IHttpBufferContentFactory(|this| unsafe {
    ...
    #[cfg(feature = "Web_Http_Headers")]
    pub fn Headers(&self) -> windows_result::Result<Headers::HttpContentHeaderCollection> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BufferAllAsync(&self) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<u64, u64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ReadAsBufferAsync(&self) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<super::super::Storage::Streams::IBuffer, u64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ReadAsInputStreamAsync(&self) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<super::super::Storage::Streams::IInputStream, u64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReadAsStringAsync(&self) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<windows_core::HSTRING, u64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryComputeLength(&self, length: &mut u64) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn WriteToStreamAsync<P0>(&self, outputstream: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<u64, u64>>
    where
    ...
    fn IHttpBufferContentFactory<R, F: FnOnce(&IHttpBufferContentFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl HttpClient {
    ...
    pub fn DeleteAsync<P0>(&self, uri: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<HttpResponseMessage, HttpProgress>>
    where
    ...
    pub fn GetAsync<P0>(&self, uri: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<HttpResponseMessage, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn GetWithOptionAsync<P0>(&self, uri: P0, completionoption: HttpCompletionOption) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<HttpResponseMessage, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetBufferAsync<P0>(&self, uri: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<super::super::Storage::Streams::IBuffer, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetInputStreamAsync<P0>(&self, uri: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<super::super::Storage::Streams::IInputStream, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn GetStringAsync<P0>(&self, uri: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<windows_core::HSTRING, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn PostAsync<P0, P1>(&self, uri: P0, content: P1) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<HttpResponseMessage, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    ...
    pub fn PutAsync<P0, P1>(&self, uri: P0, content: P1) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<HttpResponseMessage, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
        P1: windows_core::Param<IHttpContent>,
    {
    ...
    pub fn SendRequestAsync<P0>(&self, request: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<HttpResponseMessage, HttpProgress>>
    where
    ...
    pub fn SendRequestWithOptionAsync<P0>(&self, request: P0, completionoption: HttpCompletionOption) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<HttpResponseMessage, HttpProgress>>
    where
        P0: windows_core::Param<HttpRequestMessage>,
    {
        let this = self;
    ...
    #[cfg(feature = "Web_Http_Headers")]
    pub fn DefaultRequestHeaders(&self) -> windows_result::Result<Headers::HttpRequestHeaderCollection> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryDeleteAsync<P0>(&self, uri: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<HttpRequestResult, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
    ...
    pub fn TryGetAsync<P0>(&self, uri: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<HttpRequestResult, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = &windows_core::Interface::cast::<IHttpClient2>(self)?;
    ...
    pub fn TryGetAsync2<P0>(&self, uri: P0, completionoption: HttpCompletionOption) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<HttpRequestResult, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = &windows_core::Interface::cast::<IHttpClient2>(self)?;
    ...
    pub fn TryGetBufferAsync<P0>(&self, uri: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<HttpGetBufferResult, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = &windows_core::Interface::cast::<IHttpClient2>(self)?;
    ...
    pub fn TryGetInputStreamAsync<P0>(&self, uri: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<HttpGetInputStreamResult, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = &windows_core::Interface::cast::<IHttpClient2>(self)?;
    ...
    pub fn TryGetStringAsync<P0>(&self, uri: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<HttpGetStringResult, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = &windows_core::Interface::cast::<IHttpClient2>(self)?;
    ...
    pub fn TryPostAsync<P0, P1>(&self, uri: P0, content: P1) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<HttpRequestResult, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
        P1: windows_core::Param<IHttpContent>,
    {
    ...
    pub fn TryPutAsync<P0, P1>(&self, uri: P0, content: P1) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<HttpRequestResult, HttpProgress>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
        P1: windows_core::Param<IHttpContent>,
    {
    ...
    pub fn TrySendRequestAsync<P0>(&self, request: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<HttpRequestResult, HttpProgress>>
    where
        P0: windows_core::Param<HttpRequestMessage>,
    {
        let this = &windows_core::Interface::cast::<IHttpClient2>(self)?;
    ...
    pub fn TrySendRequestAsync2<P0>(&self, request: P0, completionoption: HttpCompletionOption) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<HttpRequestResult, HttpProgress>>
    where
        P0: windows_core::Param<HttpRequestMessage>,
    {
        let this = &windows_core::Interface::cast::<IHttpClient2>(self)?;
    ...
    pub fn DefaultPrivacyAnnotation(&self) -> windows_result::Result<windows_core::HSTRING> {
    ...
    pub fn SetDefaultPrivacyAnnotation(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IHttpClient3>(self)?;
    ...
    #[cfg(feature = "Web_Http_Filters")]
    pub fn Create<P0>(filter: P0) -> windows_result::Result<HttpClient>
    where
    ...
    fn IHttpClientFactory<R, F: FnOnce(&IHttpClientFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl HttpCookie {
    ...
    pub fn Expires(&self) -> windows_result::Result<super::super::Foundation::IReference<super::super::Foundation::DateTime>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetExpires<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn HttpOnly(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetHttpOnly(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetHttpOnly)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Secure(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSecure(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn Create(name: &windows_core::HSTRING, domain: &windows_core::HSTRING, path: &windows_core::HSTRING) -> windows_result::Result<HttpCookie> {
    ...
    fn IHttpCookieFactory<R, F: FnOnce(&IHttpCookieFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl HttpCookieCollection {
    pub fn First(&self) -> windows_result::Result<windows_collections::IIterator<HttpCookie>> {
    ...
    pub fn GetAt(&self, index: u32) -> windows_result::Result<HttpCookie> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMany(&self, startindex: u32, items: &mut [Option<HttpCookie>]) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl HttpCookieManager {
    pub fn SetCookie<P0>(&self, cookie: P0) -> windows_result::Result<bool>
    where
        P0: windows_core::Param<HttpCookie>,
    {
        let this = self;
    ...
    pub fn SetCookieWithThirdParty<P0>(&self, cookie: P0, thirdparty: bool) -> windows_result::Result<bool>
    where
        P0: windows_core::Param<HttpCookie>,
    {
        let this = self;
    ...
    pub fn DeleteCookie<P0>(&self, cookie: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<HttpCookie>,
    {
        let this = self;
    ...
    pub fn GetCookies<P0>(&self, uri: P0) -> windows_result::Result<HttpCookieCollection>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
...
impl HttpFormUrlEncodedContent {
    ...
    pub fn Create<P0>(content: P0) -> windows_result::Result<HttpFormUrlEncodedContent>
    where
    ...
    fn IHttpFormUrlEncodedContentFactory<R, F: FnOnce(&IHttpFormUrlEncodedContentFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl HttpGetBufferResult {
    ...
    pub fn RequestMessage(&self) -> windows_result::Result<HttpRequestMessage> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ResponseMessage(&self) -> windows_result::Result<HttpResponseMessage> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Value(&self) -> windows_result::Result<super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl HttpGetInputStreamResult {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Value(&self) -> windows_result::Result<super::super::Storage::Streams::IInputStream> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Value)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl HttpMethod {
    pub fn Method(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Create(method: &windows_core::HSTRING) -> windows_result::Result<HttpMethod> {
    ...
    pub fn Delete() -> windows_result::Result<HttpMethod> {
    ...
    pub fn Get() -> windows_result::Result<HttpMethod> {
        Self::IHttpMethodStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Head() -> windows_result::Result<HttpMethod> {
        Self::IHttpMethodStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Options() -> windows_result::Result<HttpMethod> {
        Self::IHttpMethodStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Patch() -> windows_result::Result<HttpMethod> {
        Self::IHttpMethodStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Post() -> windows_result::Result<HttpMethod> {
        Self::IHttpMethodStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Put() -> windows_result::Result<HttpMethod> {
        Self::IHttpMethodStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IHttpMethodFactory<R, F: FnOnce(&IHttpMethodFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<HttpMethod, IHttpMethodFactory> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IHttpMethodStatics<R, F: FnOnce(&IHttpMethodStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl HttpMultipartContent {
    ...
    pub fn Add<P0>(&self, content: P0) -> windows_result::Result<()>
    where
    ...
    pub fn CreateWithSubtype(subtype: &windows_core::HSTRING) -> windows_result::Result<HttpMultipartContent> {
    ...
    pub fn CreateWithSubtypeAndBoundary(subtype: &windows_core::HSTRING, boundary: &windows_core::HSTRING) -> windows_result::Result<HttpMultipartContent> {
        Self::IHttpMultipartContentFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn First(&self) -> windows_result::Result<windows_collections::IIterator<IHttpContent>> {
    ...
    fn IHttpMultipartContentFactory<R, F: FnOnce(&IHttpMultipartContentFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl HttpMultipartFormDataContent {
    ...
    pub fn AddWithName<P0>(&self, content: P0, name: &windows_core::HSTRING) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IHttpContent>,
    {
        let this = &windows_core::Interface::cast::<IHttpMultipartFormDataContent>(self)?;
    ...
    pub fn AddWithNameAndFileName<P0>(&self, content: P0, name: &windows_core::HSTRING, filename: &windows_core::HSTRING) -> windows_result::Result<()>
    where
        P0: windows_core::Param<IHttpContent>,
    {
        let this = &windows_core::Interface::cast::<IHttpMultipartFormDataContent>(self)?;
    ...
    pub fn CreateWithBoundary(boundary: &windows_core::HSTRING) -> windows_result::Result<HttpMultipartFormDataContent> {
    ...
    fn IHttpMultipartFormDataContentFactory<R, F: FnOnce(&IHttpMultipartFormDataContentFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl HttpRequestMessage {
    ...
    pub fn Content(&self) -> windows_result::Result<IHttpContent> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Web_Http_Headers")]
    pub fn Headers(&self) -> windows_result::Result<Headers::HttpRequestHeaderCollection> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Headers)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Method(&self) -> windows_result::Result<HttpMethod> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMethod<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn RequestUri(&self) -> windows_result::Result<super::super::Foundation::Uri> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRequestUri<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn TransportInformation(&self) -> windows_result::Result<HttpTransportInformation> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PrivacyAnnotation(&self) -> windows_result::Result<windows_core::HSTRING> {
    ...
    pub fn SetPrivacyAnnotation(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IHttpRequestMessage2>(self)?;
    ...
    pub fn Create<P0, P1>(method: P0, uri: P1) -> windows_result::Result<HttpRequestMessage>
    where
        P0: windows_core::Param<HttpMethod>,
    ...
    fn IHttpRequestMessageFactory<R, F: FnOnce(&IHttpRequestMessageFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl HttpResponseMessage {
    ...
    #[cfg(feature = "Web_Http_Headers")]
    pub fn Headers(&self) -> windows_result::Result<Headers::HttpResponseHeaderCollection> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Headers)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn IsSuccessStatusCode(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReasonPhrase(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetReasonPhrase(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetRequestMessage<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<HttpRequestMessage>,
    {
        let this = self;
    ...
    pub fn Source(&self) -> windows_result::Result<HttpResponseMessageSource> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSource(&self, value: HttpResponseMessageSource) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSource)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn StatusCode(&self) -> windows_result::Result<HttpStatusCode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetStatusCode(&self, value: HttpStatusCode) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetStatusCode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Version(&self) -> windows_result::Result<HttpVersion> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetVersion(&self, value: HttpVersion) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetVersion)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn EnsureSuccessStatusCode(&self) -> windows_result::Result<HttpResponseMessage> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Create(statuscode: HttpStatusCode) -> windows_result::Result<HttpResponseMessage> {
    ...
    fn IHttpResponseMessageFactory<R, F: FnOnce(&IHttpResponseMessageFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl HttpStreamContent {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromInputStream<P0>(content: P0) -> windows_result::Result<HttpStreamContent>
    where
    ...
    fn IHttpStreamContentFactory<R, F: FnOnce(&IHttpStreamContentFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl HttpStringContent {
    ...
    pub fn CreateFromString(content: &windows_core::HSTRING) -> windows_result::Result<HttpStringContent> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromStringWithEncoding(content: &windows_core::HSTRING, encoding: super::super::Storage::Streams::UnicodeEncoding) -> windows_result::Result<HttpStringContent> {
        Self::IHttpStringContentFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromStringWithEncodingAndMediaType(content: &windows_core::HSTRING, encoding: super::super::Storage::Streams::UnicodeEncoding, mediatype: &windows_core::HSTRING) -> windows_result::Result<HttpStringContent> {
        Self::IHttpStringContentFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IHttpStringContentFactory<R, F: FnOnce(&IHttpStringContentFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl HttpTransportInformation {
    ...
    pub fn ServerCertificate(&self) -> windows_result::Result<super::super::Security::Cryptography::Certificates::Certificate> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ServerCertificateErrorSeverity(&self) -> windows_result::Result<super::super::Networking::Sockets::SocketSslErrorSeverity> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Cryptography_Certificates")]
    pub fn ServerCertificateErrors(&self) -> windows_result::Result<windows_collections::IVectorView<super::super::Security::Cryptography::Certificates::ChainValidationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Cryptography_Certificates")]
    pub fn ServerIntermediateCertificates(&self) -> windows_result::Result<windows_collections::IVectorView<super::super::Security::Cryptography::Certificates::Certificate>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IHttpContent_Impl: super::super::Foundation::IClosable_Impl {
    fn Headers(&self) -> windows_result::Result<Headers::HttpContentHeaderCollection>;
    fn BufferAllAsync(&self) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<u64, u64>>;
    fn ReadAsBufferAsync(&self) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<super::super::Storage::Streams::IBuffer, u64>>;
    fn ReadAsInputStreamAsync(&self) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<super::super::Storage::Streams::IInputStream, u64>>;
    fn ReadAsStringAsync(&self) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<windows_core::HSTRING, u64>>;
    fn TryComputeLength(&self, length: &mut u64) -> windows_result::Result<bool>;
    fn WriteToStreamAsync(&self, outputStream: windows_core::Ref<super::super::Storage::Streams::IOutputStream>) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<u64, u64>>;
}
#[cfg(all(feature = "Storage_Streams", feature = "Web_Http_Headers"))]
