...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("httpapi.dll" "system" fn HttpAddUrl(requestqueuehandle : super::winnt::HANDLE, fullyqualifiedurl : windows_core::PCWSTR, reserved : *const core::ffi::c_void) -> u32);
    unsafe { HttpAddUrl(requestqueuehandle, fullyqualifiedurl.param().abi(), reserved.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn HttpAddUrlToUrlGroup<P1>(urlgroupid: HTTP_URL_GROUP_ID, pfullyqualifiedurl: P1, urlcontext: HTTP_URL_CONTEXT, reserved: Option<u32>) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn HttpCloseServerSession(serversessionid: HTTP_SERVER_SESSION_ID) -> u32 {
    windows_core::link!("httpapi.dll" "system" fn HttpCloseServerSession(serversessionid : HTTP_SERVER_SESSION_ID) -> u32);
    unsafe { HttpCloseServerSession(serversessionid) }
}
#[inline]
pub unsafe fn HttpCloseUrlGroup(urlgroupid: HTTP_URL_GROUP_ID) -> u32 {
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("httpapi.dll" "system" fn HttpFlushResponseCache(requestqueuehandle : super::winnt::HANDLE, urlprefix : windows_core::PCWSTR, flags : u32, overlapped : *mut super::minwinbase::OVERLAPPED) -> u32);
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("httpapi.dll" "system" fn HttpRemoveUrl(requestqueuehandle : super::winnt::HANDLE, fullyqualifiedurl : windows_core::PCWSTR) -> u32);
    unsafe { HttpRemoveUrl(requestqueuehandle, fullyqualifiedurl.param().abi()) }
}
#[inline]
pub unsafe fn HttpRemoveUrlFromUrlGroup<P1>(urlgroupid: HTTP_URL_GROUP_ID, pfullyqualifiedurl: P1, flags: u32) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
...
#[inline]
pub unsafe fn HttpSetServerSessionProperty(serversessionid: HTTP_SERVER_SESSION_ID, property: HTTP_SERVER_PROPERTY, propertyinformation: *const core::ffi::c_void, propertyinformationlength: u32) -> u32 {
...
#[inline]
pub unsafe fn HttpSetUrlGroupProperty(urlgroupid: HTTP_URL_GROUP_ID, property: HTTP_SERVER_PROPERTY, propertyinformation: *const core::ffi::c_void, propertyinformationlength: u32) -> u32 {
...
pub unsafe fn HttpWaitForDisconnectEx(requestqueuehandle: super::winnt::HANDLE, connectionid: HTTP_CONNECTION_ID, reserved: Option<u32>, overlapped: *mut super::minwinbase::OVERLAPPED) -> u32 {
    ...
    unsafe { HttpWaitForDisconnectEx(requestqueuehandle, connectionid, reserved.unwrap_or(core::mem::zeroed()) as _, overlapped as _) }
}
