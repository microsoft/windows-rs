...
windows_core::imp::required_hierarchy!(PlatformTelemetryRegistrationResult, IPlatformTelemetryRegistrationResult);
...
windows_core::imp::required_hierarchy!(PlatformTelemetryRegistrationSettings, IPlatformTelemetryRegistrationSettings);
