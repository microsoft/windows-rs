...
impl PlatformTelemetryClient {
    pub fn Register(id: &windows_core::HSTRING) -> windows_result::Result<PlatformTelemetryRegistrationResult> {
    ...
    pub fn RegisterWithSettings<P1>(id: &windows_core::HSTRING, settings: P1) -> windows_result::Result<PlatformTelemetryRegistrationResult>
    where
    ...
    fn IPlatformTelemetryClientStatics<R, F: FnOnce(&IPlatformTelemetryClientStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl PlatformTelemetryRegistrationResult {
    pub fn Status(&self) -> windows_result::Result<PlatformTelemetryRegistrationStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PlatformTelemetryRegistrationSettings {
    ...
    pub fn StorageSize(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetStorageSize(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetStorageSize)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn UploadQuotaSize(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetUploadQuotaSize(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
