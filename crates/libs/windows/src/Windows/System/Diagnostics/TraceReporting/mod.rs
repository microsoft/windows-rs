...
windows_core::imp::required_hierarchy!(PlatformDiagnosticTraceInfo, IPlatformDiagnosticTraceInfo);
...
windows_core::imp::required_hierarchy!(PlatformDiagnosticTraceRuntimeInfo, IPlatformDiagnosticTraceRuntimeInfo);
