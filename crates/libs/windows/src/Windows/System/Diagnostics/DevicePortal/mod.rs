...
impl DevicePortalConnection {
    ...
    pub fn RequestReceived<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveRequestReceived(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveRequestReceived)(windows_core::Interface::as_raw(this), token).ok() }
    }
    #[cfg(feature = "ApplicationModel_AppService")]
    pub fn GetForAppServiceConnection<P0>(appserviceconnection: P0) -> windows_result::Result<DevicePortalConnection>
    where
    ...
    pub fn GetServerMessageWebSocketForRequest<P0>(&self, request: P0) -> windows_result::Result<super::super::super::Networking::Sockets::ServerMessageWebSocket>
    where
    ...
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
    pub fn GetServerMessageWebSocketForRequest2<P0>(&self, request: P0, messagetype: super::super::super::Networking::Sockets::SocketMessageType, protocol: &windows_core::HSTRING) -> windows_result::Result<super::super::super::Networking::Sockets::ServerMessageWebSocket>
    where
        P0: windows_core::Param<super::super::super::Web::Http::HttpRequestMessage>,
    {
        let this = &windows_core::Interface::cast::<IDevicePortalWebSocketConnection>(self)?;
    ...
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
    pub fn GetServerStreamWebSocketForRequest<P0>(&self, request: P0) -> windows_result::Result<super::super::super::Networking::Sockets::ServerStreamWebSocket>
    where
        P0: windows_core::Param<super::super::super::Web::Http::HttpRequestMessage>,
    {
        let this = &windows_core::Interface::cast::<IDevicePortalWebSocketConnection>(self)?;
    ...
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
    pub fn GetServerStreamWebSocketForRequest2<P0>(&self, request: P0, protocol: &windows_core::HSTRING, outboundbuffersizeinbytes: u32, nodelay: bool) -> windows_result::Result<super::super::super::Networking::Sockets::ServerStreamWebSocket>
    where
        P0: windows_core::Param<super::super::super::Web::Http::HttpRequestMessage>,
    {
        let this = &windows_core::Interface::cast::<IDevicePortalWebSocketConnection>(self)?;
    ...
    fn IDevicePortalConnectionStatics<R, F: FnOnce(&IDevicePortalConnectionStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl DevicePortalConnectionClosedEventArgs {
    pub fn Reason(&self) -> windows_result::Result<DevicePortalConnectionClosedReason> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DevicePortalConnectionRequestReceivedEventArgs {
    ...
    pub fn RequestMessage(&self) -> windows_result::Result<super::super::super::Web::Http::HttpRequestMessage> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Web_Http")]
    pub fn ResponseMessage(&self) -> windows_result::Result<super::super::super::Web::Http::HttpResponseMessage> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsWebSocketUpgradeRequest(&self) -> windows_result::Result<bool> {
    ...
    pub fn WebSocketProtocolsRequested(&self) -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = &windows_core::Interface::cast::<IDevicePortalWebSocketConnectionRequestReceivedEventArgs>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
