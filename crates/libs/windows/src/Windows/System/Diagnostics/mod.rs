...
impl windows_core::imp::TypeKind for DiagnosticActionState {
...
impl windows_core::RuntimeType for DiagnosticActionState {
    ...
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.DiagnosticActionState");
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl DiagnosticInvoker {
        ...
        P0: windows_core::Param<super::super::Data::Json::JsonObject>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).RunDiagnosticActionAsync)(windows_core::Interface::as_raw(self), context.param().abi(), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub fn RunDiagnosticActionFromStringAsync(&self, context: &windows_core::HSTRING) -> windows_core::Result<windows_future::IAsyncOperationWithProgress<DiagnosticActionResult, DiagnosticActionState>> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RunDiagnosticActionFromStringAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(context), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
...
impl windows_core::RuntimeType for IDiagnosticActionResult {
    ...
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.IDiagnosticActionResult");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IDiagnosticInvoker {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.IDiagnosticInvoker");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IDiagnosticInvoker2 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.IDiagnosticInvoker2");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IDiagnosticInvokerStatics {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.IDiagnosticInvokerStatics");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IProcessCpuUsage {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.IProcessCpuUsage");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IProcessCpuUsageReport {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.IProcessCpuUsageReport");
}
#[repr(C)]
#[doc(hidden)]
pub struct IProcessCpuUsageReport_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
    pub KernelTime: unsafe extern "system" fn(*mut core::ffi::c_void, *mut windows_time::TimeSpan) -> windows_core::HRESULT,
    pub UserTime: unsafe extern "system" fn(*mut core::ffi::c_void, *mut windows_time::TimeSpan) -> windows_core::HRESULT,
}
...
impl windows_core::RuntimeType for IProcessDiagnosticInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.IProcessDiagnosticInfo");
}
#[repr(C)]
#[doc(hidden)]
pub struct IProcessDiagnosticInfo_Vtbl {
    ...
    pub ProcessStartTime: unsafe extern "system" fn(*mut core::ffi::c_void, *mut windows_time::DateTime) -> windows_core::HRESULT,
...
impl windows_core::RuntimeType for IProcessDiagnosticInfo2 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.IProcessDiagnosticInfo2");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IProcessDiagnosticInfoStatics {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.IProcessDiagnosticInfoStatics");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IProcessDiagnosticInfoStatics2 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.IProcessDiagnosticInfoStatics2");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IProcessDiskUsage {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.IProcessDiskUsage");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IProcessDiskUsageReport {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.IProcessDiskUsageReport");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IProcessMemoryUsage {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.IProcessMemoryUsage");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IProcessMemoryUsageReport {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.IProcessMemoryUsageReport");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ISystemCpuUsage {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.ISystemCpuUsage");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ISystemCpuUsageReport {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.ISystemCpuUsageReport");
}
#[repr(C)]
#[doc(hidden)]
pub struct ISystemCpuUsageReport_Vtbl {
    ...
    pub KernelTime: unsafe extern "system" fn(*mut core::ffi::c_void, *mut windows_time::TimeSpan) -> windows_core::HRESULT,
    pub UserTime: unsafe extern "system" fn(*mut core::ffi::c_void, *mut windows_time::TimeSpan) -> windows_core::HRESULT,
    pub IdleTime: unsafe extern "system" fn(*mut core::ffi::c_void, *mut windows_time::TimeSpan) -> windows_core::HRESULT,
}
...
impl windows_core::RuntimeType for ISystemDiagnosticInfo {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.ISystemDiagnosticInfo");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ISystemDiagnosticInfoStatics {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.ISystemDiagnosticInfoStatics");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ISystemDiagnosticInfoStatics2 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.ISystemDiagnosticInfoStatics2");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ISystemMemoryUsage {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.ISystemMemoryUsage");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ISystemMemoryUsageReport {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.System.Diagnostics.ISystemMemoryUsageReport");
}
#[repr(C)]
#[doc(hidden)]
...
impl ProcessCpuUsage {
    pub fn GetReport(&self) -> windows_core::Result<ProcessCpuUsageReport> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetReport)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
}
...
impl ProcessCpuUsageReport {
    pub fn KernelTime(&self) -> windows_core::Result<windows_time::TimeSpan> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).KernelTime)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn UserTime(&self) -> windows_core::Result<windows_time::TimeSpan> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).UserTime)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
}
...
impl ProcessDiagnosticInfo {
    ...
    pub fn ProcessStartTime(&self) -> windows_core::Result<windows_time::DateTime> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ProcessStartTime)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn DiskUsage(&self) -> windows_core::Result<ProcessDiskUsage> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DiskUsage)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub fn MemoryUsage(&self) -> windows_core::Result<ProcessMemoryUsage> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).MemoryUsage)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub fn CpuUsage(&self) -> windows_core::Result<ProcessCpuUsage> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CpuUsage)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub fn GetAppDiagnosticInfos(&self) -> windows_core::Result<windows_collections::IVector<super::AppDiagnosticInfo>> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAppDiagnosticInfos)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    ...
    pub fn GetForProcesses() -> windows_core::Result<windows_collections::IVectorView<Self>> {
        Self::IProcessDiagnosticInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForProcesses)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        })
    }
    pub fn GetForCurrentProcess() -> windows_core::Result<Self> {
        Self::IProcessDiagnosticInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForCurrentProcess)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        })
    }
    pub fn TryGetForProcessId(processid: u32) -> windows_core::Result<Self> {
        Self::IProcessDiagnosticInfoStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryGetForProcessId)(windows_core::Interface::as_raw(this), processid, &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        })
    }
...
impl ProcessDiskUsageReport {
    pub fn ReadOperationCount(&self) -> windows_core::Result<i64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ReadOperationCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn WriteOperationCount(&self) -> windows_core::Result<i64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).WriteOperationCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn OtherOperationCount(&self) -> windows_core::Result<i64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OtherOperationCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn BytesReadCount(&self) -> windows_core::Result<i64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BytesReadCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn BytesWrittenCount(&self) -> windows_core::Result<i64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).BytesWrittenCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn OtherBytesCount(&self) -> windows_core::Result<i64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OtherBytesCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
}
...
impl ProcessMemoryUsageReport {
    pub fn NonPagedPoolSizeInBytes(&self) -> windows_core::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).NonPagedPoolSizeInBytes)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn PageFaultCount(&self) -> windows_core::Result<u32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PageFaultCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn PageFileSizeInBytes(&self) -> windows_core::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PageFileSizeInBytes)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn PagedPoolSizeInBytes(&self) -> windows_core::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PagedPoolSizeInBytes)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn PeakNonPagedPoolSizeInBytes(&self) -> windows_core::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PeakNonPagedPoolSizeInBytes)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn PeakPageFileSizeInBytes(&self) -> windows_core::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PeakPageFileSizeInBytes)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn PeakPagedPoolSizeInBytes(&self) -> windows_core::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PeakPagedPoolSizeInBytes)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn PeakVirtualMemorySizeInBytes(&self) -> windows_core::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PeakVirtualMemorySizeInBytes)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn PeakWorkingSetSizeInBytes(&self) -> windows_core::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PeakWorkingSetSizeInBytes)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn PrivatePageCount(&self) -> windows_core::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).PrivatePageCount)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn VirtualMemorySizeInBytes(&self) -> windows_core::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).VirtualMemorySizeInBytes)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn WorkingSetSizeInBytes(&self) -> windows_core::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).WorkingSetSizeInBytes)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
}
...
impl SystemCpuUsageReport {
    ...
    pub fn IdleTime(&self) -> windows_core::Result<windows_time::TimeSpan> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SystemDiagnosticInfo {
    ...
    pub fn GetForCurrentSystem() -> windows_core::Result<Self> {
        Self::ISystemDiagnosticInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForCurrentSystem)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        })
    }
...
impl SystemMemoryUsageReport {
    pub fn TotalPhysicalSizeInBytes(&self) -> windows_core::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TotalPhysicalSizeInBytes)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn AvailableSizeInBytes(&self) -> windows_core::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).AvailableSizeInBytes)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn CommittedSizeInBytes(&self) -> windows_core::Result<u64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CommittedSizeInBytes)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
}
