...
windows_core::imp::required_hierarchy!(DiagnosticActionResult, IDiagnosticActionResult);
...
windows_core::imp::required_hierarchy!(DiagnosticInvoker, IDiagnosticInvoker, IDiagnosticInvoker2, IDiagnosticInvokerStatics);
...
windows_core::imp::required_hierarchy!(ProcessCpuUsage, IProcessCpuUsage);
...
windows_core::imp::required_hierarchy!(ProcessCpuUsageReport, IProcessCpuUsageReport);
...
windows_core::imp::required_hierarchy!(ProcessDiagnosticInfo, IProcessDiagnosticInfo, IProcessDiagnosticInfo2, IProcessDiagnosticInfoStatics, IProcessDiagnosticInfoStatics2);
...
windows_core::imp::required_hierarchy!(ProcessDiskUsage, IProcessDiskUsage);
...
windows_core::imp::required_hierarchy!(ProcessDiskUsageReport, IProcessDiskUsageReport);
...
windows_core::imp::required_hierarchy!(ProcessMemoryUsage, IProcessMemoryUsage);
...
windows_core::imp::required_hierarchy!(ProcessMemoryUsageReport, IProcessMemoryUsageReport);
...
windows_core::imp::required_hierarchy!(SystemCpuUsage, ISystemCpuUsage);
impl SystemCpuUsage {
...
windows_core::imp::required_hierarchy!(SystemCpuUsageReport, ISystemCpuUsageReport);
...
windows_core::imp::required_hierarchy!(SystemDiagnosticInfo, ISystemDiagnosticInfo, ISystemDiagnosticInfoStatics, ISystemDiagnosticInfoStatics2);
...
windows_core::imp::required_hierarchy!(SystemMemoryUsage, ISystemMemoryUsage);
...
windows_core::imp::required_hierarchy!(SystemMemoryUsageReport, ISystemMemoryUsageReport);
