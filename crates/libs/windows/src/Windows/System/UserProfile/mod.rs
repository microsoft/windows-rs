...
impl AdvertisingManager {
    pub fn AdvertisingId() -> windows_result::Result<windows_core::HSTRING> {
    ...
    pub fn GetForUser<P0>(user: P0) -> windows_result::Result<AdvertisingManagerForUser>
    where
    ...
    fn IAdvertisingManagerStatics<R, F: FnOnce(&IAdvertisingManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IAdvertisingManagerStatics2<R, F: FnOnce(&IAdvertisingManagerStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl AdvertisingManagerForUser {
    pub fn AdvertisingId(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AdvertisingId)(windows_core::Interface::as_raw(this), &mut result__).map(|| core::mem::transmute(result__))
...
impl AssignedAccessSettings {
    ...
    pub fn IsSingleAppKioskMode(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDefault() -> windows_result::Result<AssignedAccessSettings> {
        Self::IAssignedAccessSettingsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefault)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn GetForUser<P0>(user: P0) -> windows_result::Result<AssignedAccessSettings>
    where
        P0: windows_core::Param<super::User>,
    {
        Self::IAssignedAccessSettingsStatics(|this| unsafe {
    ...
    fn IAssignedAccessSettingsStatics<R, F: FnOnce(&IAssignedAccessSettingsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl DiagnosticsSettings {
    pub fn CanUseDiagnosticsToTailorExperiences(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDefault() -> windows_result::Result<DiagnosticsSettings> {
        Self::IDiagnosticsSettingsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefault)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn GetForUser<P0>(user: P0) -> windows_result::Result<DiagnosticsSettings>
    where
        P0: windows_core::Param<super::User>,
    {
        Self::IDiagnosticsSettingsStatics(|this| unsafe {
    ...
    fn IDiagnosticsSettingsStatics<R, F: FnOnce(&IDiagnosticsSettingsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl FirstSignInSettings {
    pub fn GetDefault() -> windows_result::Result<FirstSignInSettings> {
    ...
    fn IFirstSignInSettingsStatics<R, F: FnOnce(&IFirstSignInSettingsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl GlobalizationPreferences {
    pub fn Calendars() -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
    ...
    pub fn Clocks() -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        Self::IGlobalizationPreferencesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Currencies() -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        Self::IGlobalizationPreferencesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HomeGeographicRegion() -> windows_result::Result<windows_core::HSTRING> {
        Self::IGlobalizationPreferencesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn WeekStartsOn() -> windows_result::Result<super::super::Globalization::DayOfWeek> {
        Self::IGlobalizationPreferencesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WeekStartsOn)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn TrySetHomeGeographicRegion(region: &windows_core::HSTRING) -> windows_result::Result<bool> {
    ...
    pub fn TrySetLanguages<P0>(languagetags: P0) -> windows_result::Result<bool>
    where
    ...
    pub fn GetForUser<P0>(user: P0) -> windows_result::Result<GlobalizationPreferencesForUser>
    where
        P0: windows_core::Param<super::User>,
    {
    ...
    fn IGlobalizationPreferencesStatics<R, F: FnOnce(&IGlobalizationPreferencesStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IGlobalizationPreferencesStatics2<R, F: FnOnce(&IGlobalizationPreferencesStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IGlobalizationPreferencesStatics3<R, F: FnOnce(&IGlobalizationPreferencesStatics3) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl GlobalizationPreferencesForUser {
    ...
    pub fn Calendars(&self) -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Calendars)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Clocks(&self) -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Clocks)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Currencies(&self) -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Currencies)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn HomeGeographicRegion(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).HomeGeographicRegion)(windows_core::Interface::as_raw(this), &mut result__).map(|| core::mem::transmute(result__))
    ...
    #[cfg(feature = "Globalization")]
    pub fn WeekStartsOn(&self) -> windows_result::Result<super::super::Globalization::DayOfWeek> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WeekStartsOn)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl LockScreen {
    pub fn RequestSetImageFeedAsync<P0>(syndicationfeeduri: P0) -> windows_result::Result<windows_future::IAsyncOperation<SetImageFeedResult>>
    where
    ...
    pub fn TryRemoveImageFeed() -> windows_result::Result<bool> {
        Self::ILockScreenImageFeedStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryRemoveImageFeed)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn OriginalImageFile() -> windows_result::Result<super::super::Foundation::Uri> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetImageStream() -> windows_result::Result<super::super::Storage::Streams::IRandomAccessStream> {
        Self::ILockScreenStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetImageFileAsync<P0>(value: P0) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetImageStreamAsync<P0>(value: P0) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    fn ILockScreenImageFeedStatics<R, F: FnOnce(&ILockScreenImageFeedStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<LockScreen, ILockScreenImageFeedStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ILockScreenStatics<R, F: FnOnce(&ILockScreenStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl UserInformation {
    pub fn AccountPictureChangeEnabled() -> windows_result::Result<bool> {
    ...
    pub fn NameAccessAllowed() -> windows_result::Result<bool> {
        Self::IUserInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetAccountPicture(kind: AccountPictureKind) -> windows_result::Result<super::super::Storage::IStorageFile> {
        Self::IUserInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetAccountPictureAsync<P0>(image: P0) -> windows_result::Result<windows_future::IAsyncOperation<SetAccountPictureResult>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageFile>,
    {
        Self::IUserInformationStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetAccountPicturesAsync<P0, P1, P2>(smallimage: P0, largeimage: P1, video: P2) -> windows_result::Result<windows_future::IAsyncOperation<SetAccountPictureResult>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageFile>,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetAccountPictureFromStreamAsync<P0>(image: P0) -> windows_result::Result<windows_future::IAsyncOperation<SetAccountPictureResult>>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStream>,
    {
        Self::IUserInformationStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetAccountPicturesFromStreamsAsync<P0, P1, P2>(smallimage: P0, largeimage: P1, video: P2) -> windows_result::Result<windows_future::IAsyncOperation<SetAccountPictureResult>>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStream>,
    ...
    pub fn AccountPictureChanged<P0>(changehandler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveAccountPictureChanged(token: i64) -> windows_result::Result<()> {
    ...
    pub fn GetDisplayNameAsync() -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>> {
        Self::IUserInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetFirstNameAsync() -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>> {
        Self::IUserInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetLastNameAsync() -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>> {
        Self::IUserInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetPrincipalNameAsync() -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>> {
        Self::IUserInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetSessionInitiationProtocolUriAsync() -> windows_result::Result<windows_future::IAsyncOperation<super::super::Foundation::Uri>> {
        Self::IUserInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDomainNameAsync() -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>> {
        Self::IUserInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IUserInformationStatics<R, F: FnOnce(&IUserInformationStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl UserProfilePersonalizationSettings {
    #[cfg(feature = "Storage_Streams")]
    pub fn TrySetLockScreenImageAsync<P0>(&self, imagefile: P0) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn TrySetWallpaperImageAsync<P0>(&self, imagefile: P0) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<super::super::Storage::StorageFile>,
    {
        let this = self;
    ...
    pub fn Current() -> windows_result::Result<UserProfilePersonalizationSettings> {
    ...
    fn IUserProfilePersonalizationSettingsStatics<R, F: FnOnce(&IUserProfilePersonalizationSettingsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
