...
impl AnalyticsInfo {
    pub fn VersionInfo() -> windows_result::Result<AnalyticsVersionInfo> {
    ...
    pub fn DeviceForm() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAnalyticsInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetSystemPropertiesAsync<P0>(attributenames: P0) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IMapView<windows_core::HSTRING, windows_core::HSTRING>>>
    where
    ...
    fn IAnalyticsInfoStatics<R, F: FnOnce(&IAnalyticsInfoStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<AnalyticsInfo, IAnalyticsInfoStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IAnalyticsInfoStatics2<R, F: FnOnce(&IAnalyticsInfoStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl AnalyticsVersionInfo {
    pub fn DeviceFamily(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeviceFamilyVersion(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ProductName(&self) -> windows_result::Result<windows_core::HSTRING> {
...
impl AppApplicability {
    pub fn GetUnsupportedAppRequirements<P0>(capabilities: P0) -> windows_result::Result<windows_collections::IVectorView<UnsupportedAppRequirement>>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
    ...
    fn IAppApplicabilityStatics<R, F: FnOnce(&IAppApplicabilityStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl EducationSettings {
    pub fn IsEducationEnvironment() -> windows_result::Result<bool> {
    ...
    fn IEducationSettingsStatics<R, F: FnOnce(&IEducationSettingsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl HardwareIdentification {
    ...
    pub fn GetPackageSpecificToken<P0>(nonce: P0) -> windows_result::Result<HardwareToken>
    where
    ...
    fn IHardwareIdentificationStatics<R, F: FnOnce(&IHardwareIdentificationStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl HardwareToken {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Signature(&self) -> windows_result::Result<super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Certificate(&self) -> windows_result::Result<super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl KnownRetailInfoProperties {
    pub fn RetailAccessCode() -> windows_result::Result<windows_core::HSTRING> {
    ...
    pub fn ManufacturerName() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ModelName() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DisplayModelName() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FormFactor() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ScreenSize() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Weight() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DisplayDescription() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BatteryLifeDescription() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ProcessorDescription() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Memory() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StorageDescription() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GraphicsDescription() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FrontCameraDescription() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RearCameraDescription() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HasNfc() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HasSdSlot() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HasOpticalDrive() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsOfficeInstalled() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn WindowsEdition() -> windows_result::Result<windows_core::HSTRING> {
        Self::IKnownRetailInfoPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IKnownRetailInfoPropertiesStatics<R, F: FnOnce(&IKnownRetailInfoPropertiesStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl PlatformAutomaticAppSignInManager {
    pub fn Policy() -> windows_result::Result<PlatformAutomaticAppSignInPolicy> {
    ...
    fn IPlatformAutomaticAppSignInManagerStatics<R, F: FnOnce(&IPlatformAutomaticAppSignInManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl PlatformDiagnosticsAndUsageDataSettings {
    pub fn CollectionLevel() -> windows_result::Result<PlatformDataCollectionLevel> {
    ...
    pub fn CollectionLevelChanged<P0>(handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveCollectionLevelChanged(token: i64) -> windows_result::Result<()> {
    ...
    pub fn CanCollectDiagnostics(level: PlatformDataCollectionLevel) -> windows_result::Result<bool> {
        Self::IPlatformDiagnosticsAndUsageDataSettingsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IPlatformDiagnosticsAndUsageDataSettingsStatics<R, F: FnOnce(&IPlatformDiagnosticsAndUsageDataSettingsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl RetailInfo {
    pub fn IsDemoModeEnabled() -> windows_result::Result<bool> {
    ...
    pub fn Properties() -> windows_result::Result<windows_collections::IMapView<windows_core::HSTRING, windows_core::IInspectable>> {
        Self::IRetailInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Properties)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IRetailInfoStatics<R, F: FnOnce(&IRetailInfoStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl SharedModeSettings {
    pub fn IsEnabled() -> windows_result::Result<bool> {
    ...
    pub fn ShouldAvoidLocalStorage() -> windows_result::Result<bool> {
    ...
    fn ISharedModeSettingsStatics<R, F: FnOnce(&ISharedModeSettingsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn ISharedModeSettingsStatics2<R, F: FnOnce(&ISharedModeSettingsStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl SmartAppControlPolicy {
    ...
    pub fn Changed<P0>(handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::ISmartAppControlPolicyStatics(|this| unsafe {
    ...
    pub fn RemoveChanged(token: i64) -> windows_result::Result<()> {
    ...
    fn ISmartAppControlPolicyStatics<R, F: FnOnce(&ISmartAppControlPolicyStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl SystemIdentification {
    pub fn GetSystemIdForPublisher() -> windows_result::Result<SystemIdentificationInfo> {
    ...
    pub fn GetSystemIdForUser<P0>(user: P0) -> windows_result::Result<SystemIdentificationInfo>
    where
    ...
    fn ISystemIdentificationStatics<R, F: FnOnce(&ISystemIdentificationStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl SystemIdentificationInfo {
    ...
    pub fn Source(&self) -> windows_result::Result<SystemIdentificationSource> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SystemSetupInfo {
    pub fn OutOfBoxExperienceState() -> windows_result::Result<SystemOutOfBoxExperienceState> {
    ...
    pub fn OutOfBoxExperienceStateChanged<P0>(handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::ISystemSetupInfoStatics(|this| unsafe {
    ...
    pub fn RemoveOutOfBoxExperienceStateChanged(token: i64) -> windows_result::Result<()> {
    ...
    fn ISystemSetupInfoStatics<R, F: FnOnce(&ISystemSetupInfoStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl UnsupportedAppRequirement {
    pub fn Requirement(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Reasons(&self) -> windows_result::Result<UnsupportedAppRequirementReasons> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WindowsIntegrityPolicy {
    ...
    fn IWindowsIntegrityPolicyStatics<R, F: FnOnce(&IWindowsIntegrityPolicyStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
