...
windows_core::imp::required_hierarchy!(PreallocatedWorkItem, IPreallocatedWorkItem, IPreallocatedWorkItemFactory);
...
windows_core::imp::required_hierarchy!(SignalNotifier, ISignalNotifier, ISignalNotifierStatics);
impl SignalNotifier {
