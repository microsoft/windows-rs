...
impl PreallocatedWorkItem {
    pub fn RunAsync(&self) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
    ...
    pub fn CreateWorkItem<P0>(handler: P0) -> windows_result::Result<PreallocatedWorkItem>
    where
    ...
    pub fn CreateWorkItemWithPriority<P0>(handler: P0, priority: super::WorkItemPriority) -> windows_result::Result<PreallocatedWorkItem>
    where
        P0: windows_core::Param<super::WorkItemHandler>,
    {
        Self::IPreallocatedWorkItemFactory(|this| unsafe {
    ...
    pub fn CreateWorkItemWithPriorityAndOptions<P0>(handler: P0, priority: super::WorkItemPriority, options: super::WorkItemOptions) -> windows_result::Result<PreallocatedWorkItem>
    where
        P0: windows_core::Param<super::WorkItemHandler>,
    {
        Self::IPreallocatedWorkItemFactory(|this| unsafe {
    ...
    fn IPreallocatedWorkItemFactory<R, F: FnOnce(&IPreallocatedWorkItemFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl SignalHandler {
    pub fn new<F: Fn(windows_core::Ref<SignalNotifier>, bool) -> windows_result::Result<()> + Send + 'static>(invoke: F) -> Self {
        let com = SignalHandlerBox { vtable: &SignalHandlerBox::<F>::VTABLE, count: windows_core::imp::RefCount::new(1), invoke };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
    }
    pub fn Invoke<P0>(&self, signalnotifier: P0, timedout: bool) -> windows_result::Result<()>
    where
...
#[repr(C)]
struct SignalHandlerBox<F: Fn(windows_core::Ref<SignalNotifier>, bool) -> windows_result::Result<()> + Send + 'static> {
    vtable: *const SignalHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: Fn(windows_core::Ref<SignalNotifier>, bool) -> windows_result::Result<()> + Send + 'static> SignalHandlerBox<F> {
...
impl SignalNotifier {
    ...
    pub fn AttachToEvent<P1>(name: &windows_core::HSTRING, handler: P1) -> windows_result::Result<SignalNotifier>
    where
    ...
    pub fn AttachToEventWithTimeout<P1>(name: &windows_core::HSTRING, handler: P1, timeout: super::super::super::Foundation::TimeSpan) -> windows_result::Result<SignalNotifier>
    where
        P1: windows_core::Param<SignalHandler>,
    {
        Self::ISignalNotifierStatics(|this| unsafe {
    ...
    pub fn AttachToSemaphore<P1>(name: &windows_core::HSTRING, handler: P1) -> windows_result::Result<SignalNotifier>
    where
        P1: windows_core::Param<SignalHandler>,
    {
        Self::ISignalNotifierStatics(|this| unsafe {
    ...
    pub fn AttachToSemaphoreWithTimeout<P1>(name: &windows_core::HSTRING, handler: P1, timeout: super::super::super::Foundation::TimeSpan) -> windows_result::Result<SignalNotifier>
    where
        P1: windows_core::Param<SignalHandler>,
    {
        Self::ISignalNotifierStatics(|this| unsafe {
    ...
    fn ISignalNotifierStatics<R, F: FnOnce(&ISignalNotifierStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
