...
impl IPreallocatedWorkItemVtbl {
    pub const fn new<Impl: IPreallocatedWorkItemImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> IPreallocatedWorkItemVtbl {
        unsafe extern "system" fn RunAsync<Impl: IPreallocatedWorkItemImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<IPreallocatedWorkItem>, base.5, RunAsync::<Impl, OFFSET>)
    }
}
#[cfg(feature = "implement_exclusive")]
...
impl IPreallocatedWorkItemFactoryVtbl {
    pub const fn new<Impl: IPreallocatedWorkItemFactoryImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> IPreallocatedWorkItemFactoryVtbl {
        unsafe extern "system" fn CreateWorkItem<Impl: IPreallocatedWorkItemFactoryImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, handler: ::windows::core::RawPtr, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn CreateWorkItemWithPriority<Impl: IPreallocatedWorkItemFactoryImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, handler: ::windows::core::RawPtr, priority: super::WorkItemPriority, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn CreateWorkItemWithPriorityAndOptions<Impl: IPreallocatedWorkItemFactoryImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, handler: ::windows::core::RawPtr, priority: super::WorkItemPriority, options: super::WorkItemOptions, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<IPreallocatedWorkItemFactory>, base.5, CreateWorkItem::<Impl, OFFSET>, CreateWorkItemWithPriority::<Impl, OFFSET>, CreateWorkItemWithPriorityAndOptions::<Impl, OFFSET>)
    }
}
#[cfg(feature = "implement_exclusive")]
...
impl ISignalNotifierVtbl {
    pub const fn new<Impl: ISignalNotifierImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> ISignalNotifierVtbl {
        unsafe extern "system" fn Enable<Impl: ISignalNotifierImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            (*this).Enable().into()
        }
        unsafe extern "system" fn Terminate<Impl: ISignalNotifierImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            (*this).Terminate().into()
        }
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<ISignalNotifier>, base.5, Enable::<Impl, OFFSET>, Terminate::<Impl, OFFSET>)
    }
}
#[cfg(feature = "implement_exclusive")]
...
impl ISignalNotifierStaticsVtbl {
    pub const fn new<Impl: ISignalNotifierStaticsImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> ISignalNotifierStaticsVtbl {
        unsafe extern "system" fn AttachToEvent<Impl: ISignalNotifierStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, name: ::core::mem::ManuallyDrop<::windows::core::HSTRING>, handler: ::windows::core::RawPtr, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn AttachToEventWithTimeout<Impl: ISignalNotifierStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, name: ::core::mem::ManuallyDrop<::windows::core::HSTRING>, handler: ::windows::core::RawPtr, timeout: super::super::super::Foundation::TimeSpan, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn AttachToSemaphore<Impl: ISignalNotifierStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, name: ::core::mem::ManuallyDrop<::windows::core::HSTRING>, handler: ::windows::core::RawPtr, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn AttachToSemaphoreWithTimeout<Impl: ISignalNotifierStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, name: ::core::mem::ManuallyDrop<::windows::core::HSTRING>, handler: ::windows::core::RawPtr, timeout: super::super::super::Foundation::TimeSpan, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<ISignalNotifierStatics>, base.5, AttachToEvent::<Impl, OFFSET>, AttachToEventWithTimeout::<Impl, OFFSET>, AttachToSemaphore::<Impl, OFFSET>, AttachToSemaphoreWithTimeout::<Impl, OFFSET>)
    }
}
