...
pub trait ISignalNotifierStaticsImpl: Sized {
    ...
    fn AttachToSemaphoreWithTimeout(&mut self, name: &::windows::core::HSTRING, handler: &::core::option::Option<SignalHandler>, timeout: &super::super::super::Foundation::TimeSpan) -> ::windows::core::Result<SignalNotifier>;
}
#[cfg(all(feature = "Foundation", feature = "implement_exclusive"))]
