...
impl ThreadPool {
    pub fn RunAsync<P0>(handler: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
    ...
    pub fn RunWithPriorityAsync<P0>(handler: P0, priority: WorkItemPriority) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<WorkItemHandler>,
    {
        Self::IThreadPoolStatics(|this| unsafe {
    ...
    pub fn RunWithPriorityAndOptionsAsync<P0>(handler: P0, priority: WorkItemPriority, options: WorkItemOptions) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<WorkItemHandler>,
    {
        Self::IThreadPoolStatics(|this| unsafe {
    ...
    fn IThreadPoolStatics<R, F: FnOnce(&IThreadPoolStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl ThreadPoolTimer {
    pub fn Period(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Delay(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreatePeriodicTimer<P0>(handler: P0, period: super::super::Foundation::TimeSpan) -> Result<ThreadPoolTimer, windows_result::HRESULT>
    where
    ...
    pub fn CreateTimer<P0>(handler: P0, delay: super::super::Foundation::TimeSpan) -> Result<ThreadPoolTimer, windows_result::HRESULT>
    where
        P0: windows_core::Param<TimerElapsedHandler>,
    {
        Self::IThreadPoolTimerStatics(|this| unsafe {
    ...
    pub fn CreatePeriodicTimerWithCompletion<P0, P2>(handler: P0, period: super::super::Foundation::TimeSpan, destroyed: P2) -> Result<ThreadPoolTimer, windows_result::HRESULT>
    where
        P0: windows_core::Param<TimerElapsedHandler>,
    ...
    pub fn CreateTimerWithCompletion<P0, P2>(handler: P0, delay: super::super::Foundation::TimeSpan, destroyed: P2) -> Result<ThreadPoolTimer, windows_result::HRESULT>
    where
        P0: windows_core::Param<TimerElapsedHandler>,
        P2: windows_core::Param<TimerDestroyedHandler>,
    {
    ...
    fn IThreadPoolTimerStatics<R, F: FnOnce(&IThreadPoolTimerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl TimerDestroyedHandler {
    pub fn new<F: FnMut(windows_core::Ref<'_, ThreadPoolTimer>) -> Result<(), windows_result::HRESULT> + Send + 'static>(invoke: F) -> Self {
    ...
    pub fn Invoke<P0>(&self, timer: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub struct TimerDestroyedHandler_Vtbl {
    ...
    Invoke: unsafe extern "system" fn(this: *mut core::ffi::c_void, timer: *mut core::ffi::c_void) -> windows_result::HRESULT,
}
#[repr(C)]
struct TimerDestroyedHandlerBox<F: FnMut(windows_core::Ref<'_, ThreadPoolTimer>) -> Result<(), windows_result::HRESULT> + Send + 'static> {
    vtable: *const TimerDestroyedHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(windows_core::Ref<'_, ThreadPoolTimer>) -> Result<(), windows_result::HRESULT> + Send + 'static> TimerDestroyedHandlerBox<F> {
    ...
    unsafe extern "system" fn Invoke(this: *mut core::ffi::c_void, timer: *mut core::ffi::c_void) -> windows_result::HRESULT {
        unsafe {
...
#[repr(C)]
struct TimerElapsedHandlerBox<F: FnMut(windows_core::Ref<'_, ThreadPoolTimer>) -> Result<(), windows_result::HRESULT> + Send + 'static> {
    vtable: *const TimerElapsedHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(windows_core::Ref<'_, ThreadPoolTimer>) -> Result<(), windows_result::HRESULT> + Send + 'static> TimerElapsedHandlerBox<F> {
...
impl WorkItemHandler {
    pub fn new<F: FnMut(windows_core::Ref<'_, windows_future::IAsyncAction>) -> Result<(), windows_result::HRESULT> + Send + 'static>(invoke: F) -> Self {
        let com = WorkItemHandlerBox { vtable: &WorkItemHandlerBox::<F>::VTABLE, count: windows_core::imp::RefCount::new(1), invoke };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
    }
    pub fn Invoke<P0>(&self, operation: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub struct WorkItemHandler_Vtbl {
    base__: windows_core::IUnknown_Vtbl,
    Invoke: unsafe extern "system" fn(this: *mut core::ffi::c_void, operation: *mut core::ffi::c_void) -> windows_result::HRESULT,
}
#[repr(C)]
struct WorkItemHandlerBox<F: FnMut(windows_core::Ref<'_, windows_future::IAsyncAction>) -> Result<(), windows_result::HRESULT> + Send + 'static> {
    vtable: *const WorkItemHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(windows_core::Ref<'_, windows_future::IAsyncAction>) -> Result<(), windows_result::HRESULT> + Send + 'static> WorkItemHandlerBox<F> {
    ...
    unsafe extern "system" fn Invoke(this: *mut core::ffi::c_void, operation: *mut core::ffi::c_void) -> windows_result::HRESULT {
        unsafe {
            let this = &mut *(this as *mut *mut core::ffi::c_void as *mut Self);
