...
impl AppActivationResult {
    ...
    pub fn AppResourceGroupInfo(&self) -> Result<AppResourceGroupInfo, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppDiagnosticInfo {
    ...
    pub fn AppInfo(&self) -> Result<super::ApplicationModel::AppInfo, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetResourceGroups(&self) -> Result<windows_collections::IVector<AppResourceGroupInfo>, windows_result::HRESULT> {
    ...
    pub fn CreateResourceGroupWatcher(&self) -> Result<AppResourceGroupInfoWatcher, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IAppDiagnosticInfo2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LaunchAsync(&self) -> Result<windows_future::IAsyncOperation<AppActivationResult>, windows_result::HRESULT> {
    ...
    pub fn RequestInfoAsync() -> Result<windows_future::IAsyncOperation<windows_collections::IVector<AppDiagnosticInfo>>, windows_result::HRESULT> {
    ...
    pub fn CreateWatcher() -> Result<AppDiagnosticInfoWatcher, windows_result::HRESULT> {
    ...
    pub fn RequestAccessAsync() -> Result<windows_future::IAsyncOperation<DiagnosticAccessStatus>, windows_result::HRESULT> {
        Self::IAppDiagnosticInfoStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestInfoForPackageAsync(packagefamilyname: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<windows_collections::IVector<AppDiagnosticInfo>>, windows_result::HRESULT> {
        Self::IAppDiagnosticInfoStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestInfoForAppAsync() -> Result<windows_future::IAsyncOperation<windows_collections::IVector<AppDiagnosticInfo>>, windows_result::HRESULT> {
        Self::IAppDiagnosticInfoStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestInfoForAppUserModelId(appusermodelid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<windows_collections::IVector<AppDiagnosticInfo>>, windows_result::HRESULT> {
        Self::IAppDiagnosticInfoStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IAppDiagnosticInfoStatics<R, F: FnOnce(&IAppDiagnosticInfoStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IAppDiagnosticInfoStatics2<R, F: FnOnce(&IAppDiagnosticInfoStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl AppDiagnosticInfoWatcher {
    ...
    pub fn Status(&self) -> Result<AppDiagnosticInfoWatcherStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppDiagnosticInfoWatcherEventArgs {
    pub fn AppDiagnosticInfo(&self) -> Result<AppDiagnosticInfo, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppMemoryReport {
    pub fn PrivateCommitUsage(&self) -> Result<u64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PeakPrivateCommitUsage(&self) -> Result<u64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TotalCommitUsage(&self) -> Result<u64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TotalCommitLimit(&self) -> Result<u64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ExpectedTotalCommitLimit(&self) -> Result<u64, windows_result::HRESULT> {
...
impl AppMemoryUsageLimitChangingEventArgs {
    pub fn OldLimit(&self) -> Result<u64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NewLimit(&self) -> Result<u64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppResourceGroupBackgroundTaskReport {
    pub fn TaskId(&self) -> Result<windows_core::GUID, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Trigger(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EntryPoint(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppResourceGroupInfo {
    ...
    pub fn IsShared(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetBackgroundTaskReports(&self) -> Result<windows_collections::IVector<AppResourceGroupBackgroundTaskReport>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMemoryReport(&self) -> Result<AppResourceGroupMemoryReport, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "System_Diagnostics")]
    pub fn GetProcessDiagnosticInfos(&self) -> Result<windows_collections::IVector<Diagnostics::ProcessDiagnosticInfo>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetStateReport(&self) -> Result<AppResourceGroupStateReport, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StartSuspendAsync(&self) -> Result<windows_future::IAsyncOperation<AppExecutionStateChangeResult>, windows_result::HRESULT> {
    ...
    pub fn StartResumeAsync(&self) -> Result<windows_future::IAsyncOperation<AppExecutionStateChangeResult>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IAppResourceGroupInfo2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StartTerminateAsync(&self) -> Result<windows_future::IAsyncOperation<AppExecutionStateChangeResult>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IAppResourceGroupInfo2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppResourceGroupInfoWatcher {
    ...
    pub fn ExecutionStateChanged<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveExecutionStateChanged(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveExecutionStateChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn Status(&self) -> Result<AppResourceGroupInfoWatcherStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl AppResourceGroupInfoWatcherEventArgs {
    pub fn AppDiagnosticInfos(&self) -> Result<windows_collections::IVectorView<AppDiagnosticInfo>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppResourceGroupMemoryReport {
    pub fn CommitUsageLimit(&self) -> Result<u64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CommitUsageLevel(&self) -> Result<AppMemoryUsageLevel, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppResourceGroupStateReport {
    pub fn ExecutionState(&self) -> Result<AppResourceGroupExecutionState, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EnergyQuotaState(&self) -> Result<AppResourceGroupEnergyQuotaState, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppUriHandlerHost {
    ...
    pub fn CreateInstance(name: &windows_core::HSTRING) -> Result<AppUriHandlerHost, windows_result::HRESULT> {
    ...
    fn IAppUriHandlerHostFactory<R, F: FnOnce(&IAppUriHandlerHostFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl AppUriHandlerRegistration {
    ...
    pub fn User(&self) -> Result<User, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAppAddedHostsAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVector<AppUriHandlerHost>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAppAddedHostsAsync<P0>(&self, hosts: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
    ...
    pub fn GetAllHosts(&self) -> Result<windows_collections::IVector<AppUriHandlerHost>, windows_result::HRESULT> {
    ...
    pub fn UpdateHosts<P0>(&self, hosts: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IIterable<AppUriHandlerHost>>,
    {
        let this = &windows_core::Interface::cast::<IAppUriHandlerRegistration2>(self)?;
...
impl AppUriHandlerRegistrationManager {
    ...
    pub fn TryGetRegistration(&self, name: &windows_core::HSTRING) -> Result<AppUriHandlerRegistration, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDefault() -> Result<AppUriHandlerRegistrationManager, windows_result::HRESULT> {
        Self::IAppUriHandlerRegistrationManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefault)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn GetForUser<P0>(user: P0) -> Result<AppUriHandlerRegistrationManager, windows_result::HRESULT>
    where
    ...
    pub fn GetForPackage(packagefamilyname: &windows_core::HSTRING) -> Result<AppUriHandlerRegistrationManager, windows_result::HRESULT> {
    ...
    pub fn GetForPackageForUser<P1>(packagefamilyname: &windows_core::HSTRING, user: P1) -> Result<AppUriHandlerRegistrationManager, windows_result::HRESULT>
    where
    ...
    fn IAppUriHandlerRegistrationManagerStatics<R, F: FnOnce(&IAppUriHandlerRegistrationManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IAppUriHandlerRegistrationManagerStatics2<R, F: FnOnce(&IAppUriHandlerRegistrationManagerStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl DateTimeSettings {
    pub fn SetSystemDateTime(utcdatetime: super::Foundation::DateTime) -> Result<(), windows_result::HRESULT> {
    ...
    fn IDateTimeSettingsStatics<R, F: FnOnce(&IDateTimeSettingsStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl DispatcherQueue {
    pub fn CreateTimer(&self) -> Result<DispatcherQueueTimer, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryEnqueue<P0>(&self, callback: P0) -> Result<bool, windows_result::HRESULT>
    where
    ...
    pub fn TryEnqueueWithPriority<P1>(&self, priority: DispatcherQueuePriority, callback: P1) -> Result<bool, windows_result::HRESULT>
    where
    ...
    pub fn ShutdownStarting<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveShutdownStarting(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveShutdownStarting)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn ShutdownCompleted<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveShutdownCompleted(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveShutdownCompleted)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn HasThreadAccess(&self) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn GetForCurrentThread() -> Result<DispatcherQueue, windows_result::HRESULT> {
    ...
    fn IDispatcherQueueStatics<R, F: FnOnce(&IDispatcherQueueStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl DispatcherQueueController {
    pub fn DispatcherQueue(&self) -> Result<DispatcherQueue, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShutdownQueueAsync(&self) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateOnDedicatedThread() -> Result<DispatcherQueueController, windows_result::HRESULT> {
    ...
    fn IDispatcherQueueControllerStatics<R, F: FnOnce(&IDispatcherQueueControllerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
#[repr(C)]
struct DispatcherQueueHandlerBox<F: FnMut() -> Result<(), windows_result::HRESULT> + Send + 'static> {
    vtable: *const DispatcherQueueHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut() -> Result<(), windows_result::HRESULT> + Send + 'static> DispatcherQueueHandlerBox<F> {
    ...
    unsafe extern "system" fn QueryInterface(this: *mut core::ffi::c_void, iid: *const windows_core::GUID, interface: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
        unsafe {
            ...
            *interface = if *iid == <DispatcherQueueHandler as windows_core::Interface>::IID || *iid == <windows_core::IUnknown as windows_core::Interface>::IID || *iid == <windows_core::imp::IAgileObject as windows_core::Interface>::IID {
...
impl DispatcherQueueShutdownStartingEventArgs {
    pub fn GetDeferral(&self) -> Result<super::Foundation::Deferral, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DispatcherQueueTimer {
    pub fn Interval(&self) -> Result<super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetInterval(&self, value: super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetInterval)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsRunning(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsRepeating(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsRepeating(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Tick<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveTick(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl FolderLauncherOptions {
    ...
    #[cfg(feature = "Storage")]
    pub fn ItemsToSelect(&self) -> Result<windows_collections::IVector<super::Storage::IStorageItem>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DesiredRemainingView(&self) -> Result<super::UI::ViewManagement::ViewSizePreference, windows_result::HRESULT> {
    ...
    #[cfg(feature = "UI_ViewManagement")]
    pub fn SetDesiredRemainingView(&self, value: super::UI::ViewManagement::ViewSizePreference) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ILauncherViewOptions>(self)?;
...
pub trait ILauncherViewOptions_Impl: windows_core::IUnknownImpl {
    fn DesiredRemainingView(&self) -> Result<super::UI::ViewManagement::ViewSizePreference, windows_result::HRESULT>;
    fn SetDesiredRemainingView(&self, value: super::UI::ViewManagement::ViewSizePreference) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "UI_ViewManagement")]
impl ILauncherViewOptions_Vtbl {
    pub const fn new<Identity: ILauncherViewOptions_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn DesiredRemainingView<Identity: ILauncherViewOptions_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut super::UI::ViewManagement::ViewSizePreference) -> windows_result::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetDesiredRemainingView<Identity: ILauncherViewOptions_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: super::UI::ViewManagement::ViewSizePreference) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl KnownUserProperties {
    ...
    pub fn FirstName() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKnownUserPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LastName() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKnownUserPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ProviderName() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKnownUserPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AccountName() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKnownUserPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GuestHost() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKnownUserPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PrincipalName() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKnownUserPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DomainName() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKnownUserPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SessionInitiationProtocolUri() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKnownUserPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AgeEnforcementRegion() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    fn IKnownUserPropertiesStatics<R, F: FnOnce(&IKnownUserPropertiesStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IKnownUserPropertiesStatics2<R, F: FnOnce(&IKnownUserPropertiesStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl LaunchUriResult {
    pub fn Status(&self) -> Result<LaunchUriStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn Result(&self) -> Result<super::Foundation::Collections::ValueSet, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl Launcher {
    #[cfg(feature = "Storage_Streams")]
    pub fn LaunchFileAsync<P0>(file: P0) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LaunchFileWithOptionsAsync<P0, P1>(file: P0, options: P1) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Storage::IStorageFile>,
    ...
    pub fn LaunchUriAsync<P0>(uri: P0) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
    ...
    pub fn LaunchUriWithOptionsAsync<P0, P1>(uri: P0, options: P1) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Foundation::Uri>,
        P1: windows_core::Param<LauncherOptions>,
    {
    ...
    pub fn LaunchUriForResultsAsync<P0, P1>(uri: P0, options: P1) -> Result<windows_future::IAsyncOperation<LaunchUriResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Foundation::Uri>,
        P1: windows_core::Param<LauncherOptions>,
    {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn LaunchUriForResultsWithDataAsync<P0, P1, P2>(uri: P0, options: P1, inputdata: P2) -> Result<windows_future::IAsyncOperation<LaunchUriResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Foundation::Uri>,
        P1: windows_core::Param<LauncherOptions>,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn LaunchUriWithDataAsync<P0, P1, P2>(uri: P0, options: P1, inputdata: P2) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Foundation::Uri>,
        P1: windows_core::Param<LauncherOptions>,
        P2: windows_core::Param<super::Foundation::Collections::ValueSet>,
    ...
    pub fn QueryUriSupportAsync<P0>(uri: P0, launchquerysupporttype: LaunchQuerySupportType) -> Result<windows_future::IAsyncOperation<LaunchQuerySupportStatus>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Foundation::Uri>,
    {
        Self::ILauncherStatics2(|this| unsafe {
    ...
    pub fn QueryUriSupportWithPackageFamilyNameAsync<P0>(uri: P0, launchquerysupporttype: LaunchQuerySupportType, packagefamilyname: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<LaunchQuerySupportStatus>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Foundation::Uri>,
    {
        Self::ILauncherStatics2(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn QueryFileSupportAsync<P0>(file: P0) -> Result<windows_future::IAsyncOperation<LaunchQuerySupportStatus>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn QueryFileSupportWithPackageFamilyNameAsync<P0>(file: P0, packagefamilyname: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<LaunchQuerySupportStatus>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Storage::StorageFile>,
    {
        Self::ILauncherStatics2(|this| unsafe {
    ...
    #[cfg(feature = "ApplicationModel")]
    pub fn FindUriSchemeHandlersAsync(scheme: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::ApplicationModel::AppInfo>>, windows_result::HRESULT> {
        Self::ILauncherStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ApplicationModel")]
    pub fn FindUriSchemeHandlersWithLaunchUriTypeAsync(scheme: &windows_core::HSTRING, launchquerysupporttype: LaunchQuerySupportType) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::ApplicationModel::AppInfo>>, windows_result::HRESULT> {
        Self::ILauncherStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ApplicationModel")]
    pub fn FindFileHandlersAsync(extension: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::ApplicationModel::AppInfo>>, windows_result::HRESULT> {
        Self::ILauncherStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage")]
    pub fn LaunchFolderAsync<P0>(folder: P0) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage")]
    pub fn LaunchFolderWithOptionsAsync<P0, P1>(folder: P0, options: P1) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Storage::IStorageFolder>,
    ...
    pub fn QueryAppUriSupportAsync<P0>(uri: P0) -> Result<windows_future::IAsyncOperation<LaunchQuerySupportStatus>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Foundation::Uri>,
    {
    ...
    pub fn QueryAppUriSupportWithPackageFamilyNameAsync<P0>(uri: P0, packagefamilyname: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<LaunchQuerySupportStatus>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Foundation::Uri>,
    {
        Self::ILauncherStatics4(|this| unsafe {
    ...
    #[cfg(feature = "ApplicationModel")]
    pub fn FindAppUriHandlersAsync<P0>(uri: P0) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::ApplicationModel::AppInfo>>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Foundation::Uri>,
    {
        Self::ILauncherStatics4(|this| unsafe {
    ...
    pub fn LaunchUriForUserAsync<P0, P1>(user: P0, uri: P1) -> Result<windows_future::IAsyncOperation<LaunchUriStatus>, windows_result::HRESULT>
    where
        P0: windows_core::Param<User>,
    ...
    pub fn LaunchUriWithOptionsForUserAsync<P0, P1, P2>(user: P0, uri: P1, options: P2) -> Result<windows_future::IAsyncOperation<LaunchUriStatus>, windows_result::HRESULT>
    where
        P0: windows_core::Param<User>,
        P1: windows_core::Param<super::Foundation::Uri>,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn LaunchUriWithDataForUserAsync<P0, P1, P2, P3>(user: P0, uri: P1, options: P2, inputdata: P3) -> Result<windows_future::IAsyncOperation<LaunchUriStatus>, windows_result::HRESULT>
    where
        P0: windows_core::Param<User>,
        P1: windows_core::Param<super::Foundation::Uri>,
        P2: windows_core::Param<LauncherOptions>,
    ...
    pub fn LaunchUriForResultsForUserAsync<P0, P1, P2>(user: P0, uri: P1, options: P2) -> Result<windows_future::IAsyncOperation<LaunchUriResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<User>,
        P1: windows_core::Param<super::Foundation::Uri>,
        P2: windows_core::Param<LauncherOptions>,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn LaunchUriForResultsWithDataForUserAsync<P0, P1, P2, P3>(user: P0, uri: P1, options: P2, inputdata: P3) -> Result<windows_future::IAsyncOperation<LaunchUriResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<User>,
        P1: windows_core::Param<super::Foundation::Uri>,
        P2: windows_core::Param<LauncherOptions>,
    ...
    pub fn LaunchFolderPathAsync(path: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT> {
    ...
    pub fn LaunchFolderPathWithOptionsAsync<P1>(path: &windows_core::HSTRING, options: P1) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P1: windows_core::Param<FolderLauncherOptions>,
    {
        Self::ILauncherStatics5(|this| unsafe {
    ...
    pub fn LaunchFolderPathForUserAsync<P0>(user: P0, path: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<User>,
    {
        Self::ILauncherStatics5(|this| unsafe {
    ...
    pub fn LaunchFolderPathWithOptionsForUserAsync<P0, P2>(user: P0, path: &windows_core::HSTRING, options: P2) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<User>,
    ...
    fn ILauncherStatics<R, F: FnOnce(&ILauncherStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<Launcher, ILauncherStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ILauncherStatics2<R, F: FnOnce(&ILauncherStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<Launcher, ILauncherStatics2> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ILauncherStatics3<R, F: FnOnce(&ILauncherStatics3) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<Launcher, ILauncherStatics3> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ILauncherStatics4<R, F: FnOnce(&ILauncherStatics4) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<Launcher, ILauncherStatics4> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ILauncherStatics5<R, F: FnOnce(&ILauncherStatics5) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl LauncherOptions {
    ...
    pub fn TreatAsUntrusted(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTreatAsUntrusted(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetTreatAsUntrusted)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DisplayApplicationPicker(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDisplayApplicationPicker(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDisplayApplicationPicker)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn UI(&self) -> Result<LauncherUIOptions, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PreferredApplicationPackageFamilyName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPreferredApplicationPackageFamilyName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn PreferredApplicationDisplayName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPreferredApplicationDisplayName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn FallbackUri(&self) -> Result<super::Foundation::Uri, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetFallbackUri<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn SetContentType(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn TargetApplicationPackageFamilyName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn SetTargetApplicationPackageFamilyName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ILauncherOptions2>(self)?;
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn NeighboringFilesQuery(&self) -> Result<super::Storage::Search::StorageFileQueryResult, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ILauncherOptions2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn SetNeighboringFilesQuery<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn IgnoreAppUriHandlers(&self) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn SetIgnoreAppUriHandlers(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ILauncherOptions3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetIgnoreAppUriHandlers)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn LimitPickerToCurrentAppAndAppUriHandlers(&self) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn SetLimitPickerToCurrentAppAndAppUriHandlers(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ILauncherOptions4>(self)?;
...
impl LauncherUIOptions {
    pub fn InvocationPoint(&self) -> Result<super::Foundation::IReference<super::Foundation::Point>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetInvocationPoint<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn SelectionRect(&self) -> Result<super::Foundation::IReference<super::Foundation::Rect>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSelectionRect<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn PreferredPlacement(&self) -> Result<super::UI::Popups::Placement, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn SetPreferredPlacement(&self, value: super::UI::Popups::Placement) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl MemoryManager {
    pub fn AppMemoryUsage() -> Result<u64, windows_result::HRESULT> {
    ...
    pub fn RemoveAppMemoryUsageIncreased(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn AppMemoryUsageDecreased<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IMemoryManagerStatics(|this| unsafe {
    ...
    pub fn RemoveAppMemoryUsageDecreased(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn AppMemoryUsageLimitChanging<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveAppMemoryUsageLimitChanging(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn GetAppMemoryReport() -> Result<AppMemoryReport, windows_result::HRESULT> {
    ...
    pub fn GetProcessMemoryReport() -> Result<ProcessMemoryReport, windows_result::HRESULT> {
        Self::IMemoryManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TrySetAppMemoryUsageLimit(value: u64) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn ExpectedAppMemoryUsageLimit() -> Result<u64, windows_result::HRESULT> {
    ...
    fn IMemoryManagerStatics<R, F: FnOnce(&IMemoryManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<MemoryManager, IMemoryManagerStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IMemoryManagerStatics2<R, F: FnOnce(&IMemoryManagerStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<MemoryManager, IMemoryManagerStatics2> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IMemoryManagerStatics3<R, F: FnOnce(&IMemoryManagerStatics3) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<MemoryManager, IMemoryManagerStatics3> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IMemoryManagerStatics4<R, F: FnOnce(&IMemoryManagerStatics4) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl ProcessLauncher {
    pub fn RunToCompletionAsync(filename: &windows_core::HSTRING, args: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<ProcessLauncherResult>, windows_result::HRESULT> {
    ...
    pub fn RunToCompletionAsyncWithOptions<P2>(filename: &windows_core::HSTRING, args: &windows_core::HSTRING, options: P2) -> Result<windows_future::IAsyncOperation<ProcessLauncherResult>, windows_result::HRESULT>
    where
    ...
    fn IProcessLauncherStatics<R, F: FnOnce(&IProcessLauncherStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl ProcessLauncherOptions {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn StandardInput(&self) -> Result<super::Storage::Streams::IInputStream, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetStandardInput<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn StandardOutput(&self) -> Result<super::Storage::Streams::IOutputStream, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetStandardOutput<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn StandardError(&self) -> Result<super::Storage::Streams::IOutputStream, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetStandardError<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Storage::Streams::IOutputStream>,
    {
        let this = self;
    ...
    pub fn WorkingDirectory(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetWorkingDirectory(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl ProcessLauncherResult {
    pub fn ExitCode(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ProcessMemoryReport {
    pub fn PrivateWorkingSetUsage(&self) -> Result<u64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TotalWorkingSetUsage(&self) -> Result<u64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ProtocolForResultsOperation {
    #[cfg(feature = "Foundation_Collections")]
    pub fn ReportCompleted<P0>(&self, data: P0) -> Result<(), windows_result::HRESULT>
    where
...
impl RemoteLauncher {
    #[cfg(feature = "System_RemoteSystems")]
    pub fn LaunchUriAsync<P0, P1>(remotesystemconnectionrequest: P0, uri: P1) -> Result<windows_future::IAsyncOperation<RemoteLaunchUriStatus>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "System_RemoteSystems")]
    pub fn LaunchUriWithOptionsAsync<P0, P1, P2>(remotesystemconnectionrequest: P0, uri: P1, options: P2) -> Result<windows_future::IAsyncOperation<RemoteLaunchUriStatus>, windows_result::HRESULT>
    where
        P0: windows_core::Param<RemoteSystems::RemoteSystemConnectionRequest>,
        P1: windows_core::Param<super::Foundation::Uri>,
    ...
    #[cfg(all(feature = "Foundation_Collections", feature = "System_RemoteSystems"))]
    pub fn LaunchUriWithDataAsync<P0, P1, P2, P3>(remotesystemconnectionrequest: P0, uri: P1, options: P2, inputdata: P3) -> Result<windows_future::IAsyncOperation<RemoteLaunchUriStatus>, windows_result::HRESULT>
    where
        P0: windows_core::Param<RemoteSystems::RemoteSystemConnectionRequest>,
        P1: windows_core::Param<super::Foundation::Uri>,
        P2: windows_core::Param<RemoteLauncherOptions>,
    ...
    fn IRemoteLauncherStatics<R, F: FnOnce(&IRemoteLauncherStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl RemoteLauncherOptions {
    ...
    pub fn PreferredAppIds(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ShutdownManager {
    pub fn BeginShutdown(shutdownkind: ShutdownKind, timeout: super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn CancelShutdown() -> Result<(), windows_result::HRESULT> {
    ...
    pub fn IsPowerStateSupported(powerstate: PowerState) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn EnterPowerState(powerstate: PowerState) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn EnterPowerStateWithTimeSpan(powerstate: PowerState, wakeupafter: super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
    ...
    fn IShutdownManagerStatics<R, F: FnOnce(&IShutdownManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<ShutdownManager, IShutdownManagerStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IShutdownManagerStatics2<R, F: FnOnce(&IShutdownManagerStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl TimeZoneSettings {
    pub fn CurrentTimeZoneDisplayName() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn SupportedTimeZoneDisplayNames() -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
        Self::ITimeZoneSettingsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanChangeTimeZone() -> Result<bool, windows_result::HRESULT> {
        Self::ITimeZoneSettingsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CanChangeTimeZone)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn ChangeTimeZoneByDisplayName(timezonedisplayname: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn AutoUpdateTimeZoneAsync(timeout: super::Foundation::TimeSpan) -> Result<windows_future::IAsyncOperation<AutoUpdateTimeZoneStatus>, windows_result::HRESULT> {
    ...
    fn ITimeZoneSettingsStatics<R, F: FnOnce(&ITimeZoneSettingsStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<TimeZoneSettings, ITimeZoneSettingsStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ITimeZoneSettingsStatics2<R, F: FnOnce(&ITimeZoneSettingsStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl User {
    pub fn NonRoamableId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AuthenticationStatus(&self) -> Result<UserAuthenticationStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Type(&self) -> Result<UserType, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetPropertyAsync(&self, value: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<windows_core::IInspectable>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn GetPropertiesAsync<P0>(&self, values: P0) -> Result<windows_future::IAsyncOperation<super::Foundation::Collections::IPropertySet>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetPictureAsync(&self, desiredsize: UserPictureSize) -> Result<windows_future::IAsyncOperation<super::Storage::Streams::IRandomAccessStreamReference>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CheckUserAgeConsentGroupAsync(&self, consentgroup: UserAgeConsentGroup) -> Result<windows_future::IAsyncOperation<UserAgeConsentResult>, windows_result::HRESULT> {
    ...
    pub fn CreateWatcher() -> Result<UserWatcher, windows_result::HRESULT> {
        Self::IUserStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWatcher)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn FindAllAsync() -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<User>>, windows_result::HRESULT> {
        Self::IUserStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAllAsyncByType(r#type: UserType) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<User>>, windows_result::HRESULT> {
        Self::IUserStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAllAsyncByTypeAndStatus(r#type: UserType, status: UserAuthenticationStatus) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<User>>, windows_result::HRESULT> {
        Self::IUserStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetFromId(nonroamableid: &windows_core::HSTRING) -> Result<User, windows_result::HRESULT> {
        Self::IUserStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDefault() -> Result<User, windows_result::HRESULT> {
        Self::IUserStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefault)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IUserStatics<R, F: FnOnce(&IUserStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<User, IUserStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IUserStatics2<R, F: FnOnce(&IUserStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl UserAuthenticationStatusChangingEventArgs {
    pub fn GetDeferral(&self) -> Result<UserAuthenticationStatusChangeDeferral, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDeferral)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn NewStatus(&self) -> Result<UserAuthenticationStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CurrentStatus(&self) -> Result<UserAuthenticationStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UserChangedEventArgs {
    ...
    pub fn ChangedPropertyKinds(&self) -> Result<windows_collections::IVectorView<UserWatcherUpdateKind>, windows_result::HRESULT> {
...
impl UserDeviceAssociation {
    pub fn FindUserFromDeviceId(deviceid: &windows_core::HSTRING) -> Result<User, windows_result::HRESULT> {
    ...
    pub fn UserDeviceAssociationChanged<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveUserDeviceAssociationChanged(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    fn IUserDeviceAssociationStatics<R, F: FnOnce(&IUserDeviceAssociationStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl UserDeviceAssociationChangedEventArgs {
    ...
    pub fn NewUser(&self) -> Result<User, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OldUser(&self) -> Result<User, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UserPicker {
    ...
    pub fn AllowGuestAccounts(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAllowGuestAccounts(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAllowGuestAccounts)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SuggestedSelectedUser(&self) -> Result<User, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSuggestedSelectedUser<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<User>,
    {
        let this = self;
    ...
    pub fn PickSingleUserAsync(&self) -> Result<windows_future::IAsyncOperation<User>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IUserPickerStatics<R, F: FnOnce(&IUserPickerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl UserWatcher {
    pub fn Status(&self) -> Result<UserWatcherStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn AuthenticationStatusChanged<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Foundation::TypedEventHandler<UserWatcher, UserChangedEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemoveAuthenticationStatusChanged(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveAuthenticationStatusChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn AuthenticationStatusChanging<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveAuthenticationStatusChanging(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
