...
windows_core::imp::required_hierarchy!(AppActivationResult, IAppActivationResult);
...
windows_core::imp::required_hierarchy!(AppDiagnosticInfo, IAppDiagnosticInfo, IAppDiagnosticInfo2, IAppDiagnosticInfo3, IAppDiagnosticInfoStatics, IAppDiagnosticInfoStatics2);
...
windows_core::imp::required_hierarchy!(AppDiagnosticInfoWatcher, IAppDiagnosticInfoWatcher);
...
windows_core::imp::required_hierarchy!(AppDiagnosticInfoWatcherEventArgs, IAppDiagnosticInfoWatcherEventArgs);
...
windows_core::imp::required_hierarchy!(AppExecutionStateChangeResult, IAppExecutionStateChangeResult);
...
windows_core::imp::required_hierarchy!(AppMemoryReport, IAppMemoryReport, IAppMemoryReport2);
...
windows_core::imp::required_hierarchy!(AppMemoryUsageLimitChangingEventArgs, IAppMemoryUsageLimitChangingEventArgs);
...
windows_core::imp::required_hierarchy!(AppResourceGroupBackgroundTaskReport, IAppResourceGroupBackgroundTaskReport);
...
windows_core::imp::required_hierarchy!(AppResourceGroupInfo, IAppResourceGroupInfo, IAppResourceGroupInfo2);
...
windows_core::imp::required_hierarchy!(AppResourceGroupInfoWatcher, IAppResourceGroupInfoWatcher);
...
windows_core::imp::required_hierarchy!(AppResourceGroupInfoWatcherEventArgs, IAppResourceGroupInfoWatcherEventArgs);
...
windows_core::imp::required_hierarchy!(AppResourceGroupInfoWatcherExecutionStateChangedEventArgs, IAppResourceGroupInfoWatcherExecutionStateChangedEventArgs);
...
windows_core::imp::required_hierarchy!(AppResourceGroupMemoryReport, IAppResourceGroupMemoryReport);
...
windows_core::imp::required_hierarchy!(AppResourceGroupStateReport, IAppResourceGroupStateReport);
...
windows_core::imp::required_hierarchy!(AppUriHandlerHost, IAppUriHandlerHost, IAppUriHandlerHost2, IAppUriHandlerHostFactory);
...
windows_core::imp::required_hierarchy!(AppUriHandlerRegistration, IAppUriHandlerRegistration, IAppUriHandlerRegistration2);
...
windows_core::imp::required_hierarchy!(AppUriHandlerRegistrationManager, IAppUriHandlerRegistrationManager, IAppUriHandlerRegistrationManager2, IAppUriHandlerRegistrationManagerStatics, IAppUriHandlerRegistrationManagerStatics2);
...
windows_core::imp::required_hierarchy!(DispatcherQueue, IDispatcherQueue, IDispatcherQueue2, IDispatcherQueueStatics);
...
windows_core::imp::required_hierarchy!(DispatcherQueueController, IDispatcherQueueController, IDispatcherQueueControllerStatics);
...
windows_core::imp::required_hierarchy!(DispatcherQueueShutdownStartingEventArgs, IDispatcherQueueShutdownStartingEventArgs);
...
windows_core::imp::required_hierarchy!(DispatcherQueueTimer, IDispatcherQueueTimer);
...
windows_core::imp::required_hierarchy!(FolderLauncherOptions, IFolderLauncherOptions, ILauncherViewOptions);
...
windows_core::imp::required_hierarchy!(LaunchUriResult, ILaunchUriResult);
...
windows_core::imp::required_hierarchy!(LauncherOptions, ILauncherOptions, ILauncherOptions2, ILauncherOptions3, ILauncherOptions4, ILauncherViewOptions);
...
windows_core::imp::required_hierarchy!(LauncherUIOptions, ILauncherUIOptions);
...
windows_core::imp::required_hierarchy!(ProcessLauncherOptions, IProcessLauncherOptions);
...
windows_core::imp::required_hierarchy!(ProcessLauncherResult, IProcessLauncherResult);
...
windows_core::imp::required_hierarchy!(ProcessMemoryReport, IProcessMemoryReport);
...
windows_core::imp::required_hierarchy!(ProtocolForResultsOperation, IProtocolForResultsOperation);
...
windows_core::imp::required_hierarchy!(RemoteLauncherOptions, IRemoteLauncherOptions);
...
windows_core::imp::required_hierarchy!(User, IUser, IUser2, IUserStatics, IUserStatics2);
impl User {
...
windows_core::imp::required_hierarchy!(UserAuthenticationStatusChangeDeferral, IUserAuthenticationStatusChangeDeferral);
...
windows_core::imp::required_hierarchy!(UserAuthenticationStatusChangingEventArgs, IUserAuthenticationStatusChangingEventArgs);
...
windows_core::imp::required_hierarchy!(UserChangedEventArgs, IUserChangedEventArgs, IUserChangedEventArgs2);
...
windows_core::imp::required_hierarchy!(UserDeviceAssociationChangedEventArgs, IUserDeviceAssociationChangedEventArgs);
...
windows_core::imp::required_hierarchy!(UserPicker, IUserPicker, IUserPickerStatics);
impl UserPicker {
    pub fn new() -> windows_core::Result<Self> {
        Self::IActivationFactory(|f| f.ActivateInstance::<Self>())
    }
...
windows_core::imp::required_hierarchy!(UserWatcher, IUserWatcher);
impl UserWatcher {
