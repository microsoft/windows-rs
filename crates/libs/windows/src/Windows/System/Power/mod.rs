...
impl BackgroundEnergyManager {
    pub fn LowUsageLevel() -> Result<u32, windows_result::HRESULT> {
    ...
    pub fn NearMaxAcceptableUsageLevel() -> Result<u32, windows_result::HRESULT> {
        Self::IBackgroundEnergyManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RemoveRecentEnergyUsageIncreased(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn RecentEnergyUsageReturnedToLow<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IBackgroundEnergyManagerStatics(|this| unsafe {
    ...
    pub fn RemoveRecentEnergyUsageReturnedToLow(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    fn IBackgroundEnergyManagerStatics<R, F: FnOnce(&IBackgroundEnergyManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl ForegroundEnergyManager {
    ...
    fn IForegroundEnergyManagerStatics<R, F: FnOnce(&IForegroundEnergyManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl PowerManager {
    pub fn EnergySaverStatus() -> Result<EnergySaverStatus, windows_result::HRESULT> {
    ...
    pub fn EnergySaverStatusChanged<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IPowerManagerStatics(|this| unsafe {
    ...
    pub fn RemoveEnergySaverStatusChanged(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn BatteryStatus() -> Result<BatteryStatus, windows_result::HRESULT> {
        Self::IPowerManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).BatteryStatus)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn BatteryStatusChanged<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IPowerManagerStatics(|this| unsafe {
    ...
    pub fn RemoveBatteryStatusChanged(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn PowerSupplyStatus() -> Result<PowerSupplyStatus, windows_result::HRESULT> {
        Self::IPowerManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).PowerSupplyStatus)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn PowerSupplyStatusChanged<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IPowerManagerStatics(|this| unsafe {
    ...
    pub fn RemovePowerSupplyStatusChanged(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn RemainingChargePercent() -> Result<i32, windows_result::HRESULT> {
        Self::IPowerManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemainingChargePercent)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn RemainingChargePercentChanged<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IPowerManagerStatics(|this| unsafe {
    ...
    pub fn RemoveRemainingChargePercentChanged(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn RemainingDischargeTime() -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        Self::IPowerManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RemainingDischargeTime)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn RemainingDischargeTimeChanged<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IPowerManagerStatics(|this| unsafe {
    ...
    pub fn RemoveRemainingDischargeTimeChanged(token: i64) -> Result<(), windows_result::HRESULT> {
