...
impl ISysStorageProviderEventSource {
    pub fn EventReceived<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveEventReceived(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
...
pub trait ISysStorageProviderEventSource_Impl: windows_core::IUnknownImpl {
    fn EventReceived(&self, handler: windows_core::Ref<super::super::super::Foundation::TypedEventHandler<ISysStorageProviderEventSource, SysStorageProviderEventReceivedEventArgs>>) -> windows_result::Result<i64>;
    fn RemoveEventReceived(&self, token: i64) -> windows_result::Result<()>;
}
...
impl ISysStorageProviderHandlerFactory {
    pub fn GetHttpRequestProvider(&self, syncrootid: &windows_core::HSTRING) -> windows_result::Result<ISysStorageProviderHttpRequestProvider> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetEventSource(&self, syncrootid: &windows_core::HSTRING, eventname: &windows_core::HSTRING) -> windows_result::Result<ISysStorageProviderEventSource> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISysStorageProviderHandlerFactory_Impl: windows_core::IUnknownImpl {
    fn GetHttpRequestProvider(&self, syncRootId: &windows_core::HSTRING) -> windows_result::Result<ISysStorageProviderHttpRequestProvider>;
    fn GetEventSource(&self, syncRootId: &windows_core::HSTRING, eventName: &windows_core::HSTRING) -> windows_result::Result<ISysStorageProviderEventSource>;
}
...
impl ISysStorageProviderHttpRequestProvider {
    ...
    pub fn SendRequestAsync<P0>(&self, request: P0) -> windows_result::Result<windows_future::IAsyncOperation<super::super::super::Web::Http::HttpResponseMessage>>
    where
...
pub trait ISysStorageProviderHttpRequestProvider_Impl: windows_core::IUnknownImpl {
    fn SendRequestAsync(&self, request: windows_core::Ref<super::super::super::Web::Http::HttpRequestMessage>) -> windows_result::Result<windows_future::IAsyncOperation<super::super::super::Web::Http::HttpResponseMessage>>;
}
#[cfg(feature = "Web_Http")]
...
impl SysStorageProviderEventReceivedEventArgs {
    pub fn Json(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateInstance(json: &windows_core::HSTRING) -> windows_result::Result<SysStorageProviderEventReceivedEventArgs> {
    ...
    fn ISysStorageProviderEventReceivedEventArgsFactory<R, F: FnOnce(&ISysStorageProviderEventReceivedEventArgsFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
