...
windows_core::imp::required_hierarchy!(SysStorageProviderEventReceivedEventArgs, ISysStorageProviderEventReceivedEventArgs, ISysStorageProviderEventReceivedEventArgsFactory);
