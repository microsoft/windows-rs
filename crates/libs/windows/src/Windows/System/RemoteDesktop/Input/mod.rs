...
impl RemoteTextConnection {
    ...
    pub fn RegisterThread(&self, threadid: u32) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RegisterThread)(windows_core::Interface::as_raw(this), threadid).ok() }
    }
    pub fn UnregisterThread(&self, threadid: u32) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).UnregisterThread)(windows_core::Interface::as_raw(this), threadid).ok() }
    }
    pub fn ReportDataReceived(&self, pdudata: &[u8]) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn ReportPredictedKeyEvent(&self, scancode: u16, attributes: RemoteKeyEventAttributes) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn CreateInstance<P1>(connectionid: windows_core::GUID, pduforwarder: P1) -> Result<RemoteTextConnection, windows_result::HRESULT>
    where
    ...
    pub fn CreateInstance2<P1>(connectionid: windows_core::GUID, pduforwarder: P1, options: RemoteTextConnectionOptions) -> Result<RemoteTextConnection, windows_result::HRESULT>
    where
        P1: windows_core::Param<RemoteTextConnectionDataHandler>,
    {
    ...
    fn IRemoteTextConnectionFactory<R, F: FnOnce(&IRemoteTextConnectionFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IRemoteTextConnectionFactory2<R, F: FnOnce(&IRemoteTextConnectionFactory2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl RemoteTextConnectionDataHandler {
    pub fn new<F: FnMut(&[u8]) -> Result<bool, windows_result::HRESULT> + Send + 'static>(invoke: F) -> Self {
    ...
    pub fn Invoke(&self, pdudata: &[u8]) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub struct RemoteTextConnectionDataHandler_Vtbl {
    ...
    Invoke: unsafe extern "system" fn(this: *mut core::ffi::c_void, pdudata_array_size: u32, pdudata: *const u8, result__: *mut bool) -> windows_result::HRESULT,
}
#[repr(C)]
struct RemoteTextConnectionDataHandlerBox<F: FnMut(&[u8]) -> Result<bool, windows_result::HRESULT> + Send + 'static> {
    vtable: *const RemoteTextConnectionDataHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(&[u8]) -> Result<bool, windows_result::HRESULT> + Send + 'static> RemoteTextConnectionDataHandlerBox<F> {
    ...
    unsafe extern "system" fn Invoke(this: *mut core::ffi::c_void, pdudata_array_size: u32, pdudata: *const u8, result__: *mut bool) -> windows_result::HRESULT {
        unsafe {
