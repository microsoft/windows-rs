...
windows_core::imp::required_hierarchy!(RemoteTextConnection, super::super::super::Foundation::IClosable, IRemoteTextConnection, IRemoteTextConnection2, IRemoteTextConnectionFactory, IRemoteTextConnectionFactory2);
