...
impl PerformLocalActionRequestedEventArgs {
    pub fn Action(&self) -> windows_result::Result<RemoteDesktopLocalAction> {
        let this = self;
        unsafe {
...
impl RemoteDesktopConnectionInfo {
    pub fn SetConnectionStatus(&self, value: RemoteDesktopConnectionStatus) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetConnectionStatus)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SwitchToLocalSession(&self) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SwitchToLocalSession)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn PerformLocalActionFromRemote(&self, action: RemoteDesktopLocalAction) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "UI")]
    pub fn GetForLaunchUri<P0>(launchuri: P0, windowid: super::super::super::UI::WindowId) -> windows_result::Result<RemoteDesktopConnectionInfo>
    where
    ...
    fn IRemoteDesktopConnectionInfoStatics<R, F: FnOnce(&IRemoteDesktopConnectionInfoStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl RemoteDesktopConnectionRemoteInfo {
    ...
    pub fn ReportSwitched(&self) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).ReportSwitched)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn SwitchToLocalSessionRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveSwitchToLocalSessionRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn PerformLocalActionRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemovePerformLocalActionRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePerformLocalActionRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn IsSwitchSupported() -> windows_result::Result<bool> {
    ...
    pub fn GetForLaunchUri<P0>(launchuri: P0) -> windows_result::Result<RemoteDesktopConnectionRemoteInfo>
    where
        P0: windows_core::Param<super::super::super::Foundation::Uri>,
    {
        Self::IRemoteDesktopConnectionRemoteInfoStatics(|this| unsafe {
    ...
    fn IRemoteDesktopConnectionRemoteInfoStatics<R, F: FnOnce(&IRemoteDesktopConnectionRemoteInfoStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl RemoteDesktopInfo {
    ...
    pub fn CreateInstance(id: &windows_core::HSTRING, displayname: &windows_core::HSTRING) -> windows_result::Result<RemoteDesktopInfo> {
    ...
    fn IRemoteDesktopInfoFactory<R, F: FnOnce(&IRemoteDesktopInfoFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl RemoteDesktopRegistrar {
    pub fn DesktopInfos() -> windows_result::Result<windows_collections::IVector<RemoteDesktopInfo>> {
    ...
    pub fn IsSwitchToLocalSessionEnabled() -> windows_result::Result<bool> {
        Self::IRemoteDesktopRegistrarStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IRemoteDesktopRegistrarStatics<R, F: FnOnce(&IRemoteDesktopRegistrarStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
