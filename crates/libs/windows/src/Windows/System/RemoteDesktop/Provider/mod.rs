...
windows_core::imp::required_hierarchy!(PerformLocalActionRequestedEventArgs, IPerformLocalActionRequestedEventArgs);
...
windows_core::imp::required_hierarchy!(RemoteDesktopConnectionInfo, IRemoteDesktopConnectionInfo, IRemoteDesktopConnectionInfo2, IRemoteDesktopConnectionInfoStatics);
...
windows_core::imp::required_hierarchy!(RemoteDesktopConnectionRemoteInfo, super::super::super::Foundation::IClosable, IRemoteDesktopConnectionRemoteInfo, IRemoteDesktopConnectionRemoteInfoStatics);
...
windows_core::imp::required_hierarchy!(RemoteDesktopInfo, IRemoteDesktopInfo, IRemoteDesktopInfoFactory);
