...
impl<Identity: windows_core::IUnknownImpl + IRemoteSystemFilter_Impl + 'static, const OFFSET: isize> windows_core::imp::VtableCtor<Identity, OFFSET> for IRemoteSystemFilter_Vtbl {
