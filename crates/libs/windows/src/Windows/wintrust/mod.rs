#[cfg(feature = "windef")]
#[inline]
pub unsafe fn OpenPersonalTrustDBDialog(hwndparent: Option<super::windef::HWND>) -> windows_core::BOOL {
    windows_core::link!("wintrust.dll" "system" fn OpenPersonalTrustDBDialog(hwndparent : super::windef::HWND) -> windows_core::BOOL);
    unsafe { OpenPersonalTrustDBDialog(hwndparent.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn OpenPersonalTrustDBDialogEx(hwndparent: Option<super::windef::HWND>, dwflags: u32, pvreserved: Option<*mut *mut core::ffi::c_void>) -> windows_core::BOOL {
    windows_core::link!("wintrust.dll" "system" fn OpenPersonalTrustDBDialogEx(hwndparent : super::windef::HWND, dwflags : u32, pvreserved : *mut *mut core::ffi::c_void) -> windows_core::BOOL);
...
#[inline]
pub unsafe fn WTHelperCertIsSelfSigned(dwencoding: u32, pcert: *mut super::wincrypt::CERT_INFO) -> windows_core::BOOL {
    windows_core::link!("wintrust.dll" "system" fn WTHelperCertIsSelfSigned(dwencoding : u32, pcert : *mut super::wincrypt::CERT_INFO) -> windows_core::BOOL);
...
#[cfg(all(feature = "minwindef", feature = "mscat", feature = "mssip", feature = "wincrypt", feature = "windef", feature = "winnt"))]
#[inline]
pub unsafe fn WTHelperProvDataFromStateData(hstatedata: super::winnt::HANDLE) -> *mut CRYPT_PROVIDER_DATA {
    windows_core::link!("wintrust.dll" "system" fn WTHelperProvDataFromStateData(hstatedata : super::winnt::HANDLE) -> *mut CRYPT_PROVIDER_DATA);
    unsafe { WTHelperProvDataFromStateData(hstatedata) }
}
#[cfg(feature = "windef")]
#[inline]
pub unsafe fn WinVerifyTrust(hwnd: super::windef::HWND, pgactionid: *mut windows_core::GUID, pwvtdata: *mut core::ffi::c_void) -> i32 {
    windows_core::link!("wintrust.dll" "system" fn WinVerifyTrust(hwnd : super::windef::HWND, pgactionid : *mut windows_core::GUID, pwvtdata : *mut core::ffi::c_void) -> i32);
...
#[inline]
pub unsafe fn WinVerifyTrustEx(hwnd: super::windef::HWND, pgactionid: *mut windows_core::GUID, pwintrustdata: *mut WINTRUST_DATA) -> i32 {
    windows_core::link!("wintrust.dll" "system" fn WinVerifyTrustEx(hwnd : super::windef::HWND, pgactionid : *mut windows_core::GUID, pwintrustdata : *mut WINTRUST_DATA) -> i32);
...
#[cfg(all(feature = "minwindef", feature = "mscat", feature = "mssip", feature = "wincrypt", feature = "windef", feature = "winnt"))]
pub type PFN_CPD_ADD_STORE = Option<unsafe extern "system" fn(pprovdata: *const CRYPT_PROVIDER_DATA, hstore2add: super::wincrypt::HCERTSTORE) -> windows_core::BOOL>;
