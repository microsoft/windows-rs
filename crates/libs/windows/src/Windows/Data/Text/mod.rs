...
windows_core::imp::required_hierarchy!(AlternateWordForm, IAlternateWordForm);
...
windows_core::imp::required_hierarchy!(SelectableWordSegment, ISelectableWordSegment);
...
windows_core::imp::required_hierarchy!(SelectableWordsSegmenter, ISelectableWordsSegmenter, ISelectableWordsSegmenterFactory);
...
windows_core::imp::required_hierarchy!(SemanticTextQuery, ISemanticTextQuery, ISemanticTextQueryFactory);
...
windows_core::imp::required_hierarchy!(TextConversionGenerator, ITextConversionGenerator, ITextConversionGeneratorFactory);
...
windows_core::imp::required_hierarchy!(TextPhoneme, ITextPhoneme);
impl TextPhoneme {
...
windows_core::imp::required_hierarchy!(TextPredictionGenerator, ITextPredictionGenerator, ITextPredictionGenerator2, ITextPredictionGeneratorFactory);
...
windows_core::imp::required_hierarchy!(TextReverseConversionGenerator, ITextReverseConversionGenerator, ITextReverseConversionGenerator2, ITextReverseConversionGeneratorFactory);
...
windows_core::imp::required_hierarchy!(WordSegment, IWordSegment);
impl WordSegment {
    pub fn Text(&self) -> windows_core::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
...
windows_core::imp::required_hierarchy!(WordsSegmenter, IWordsSegmenter, IWordsSegmenterFactory);
impl WordsSegmenter {
    pub fn ResolvedLanguage(&self) -> windows_core::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
