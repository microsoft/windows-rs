...
impl AlternateWordForm {
    pub fn SourceTextSegment(&self) -> windows_result::Result<TextSegment> {
        let this = self;
        unsafe {
    ...
    pub fn NormalizationFormat(&self) -> windows_result::Result<AlternateNormalizationFormat> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SelectableWordSegmentsTokenizingHandler {
    pub fn new<F: Fn(windows_core::Ref<windows_collections::IIterable<SelectableWordSegment>>, windows_core::Ref<windows_collections::IIterable<SelectableWordSegment>>) -> windows_result::Result<()> + Send + 'static>(invoke: F) -> Self {
    ...
    pub fn Invoke<P0, P1>(&self, precedingwords: P0, words: P1) -> windows_result::Result<()>
    where
...
#[repr(C)]
struct SelectableWordSegmentsTokenizingHandlerBox<F: Fn(windows_core::Ref<windows_collections::IIterable<SelectableWordSegment>>, windows_core::Ref<windows_collections::IIterable<SelectableWordSegment>>) -> windows_result::Result<()> + Send + 'static> {
    vtable: *const SelectableWordSegmentsTokenizingHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: Fn(windows_core::Ref<windows_collections::IIterable<SelectableWordSegment>>, windows_core::Ref<windows_collections::IIterable<SelectableWordSegment>>) -> windows_result::Result<()> + Send + 'static> SelectableWordSegmentsTokenizingHandlerBox<F> {
...
impl SelectableWordsSegmenter {
    ...
    pub fn GetTokenAt(&self, text: &windows_core::HSTRING, startindex: u32) -> windows_result::Result<SelectableWordSegment> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetTokens(&self, text: &windows_core::HSTRING) -> windows_result::Result<windows_collections::IVectorView<SelectableWordSegment>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Tokenize<P2>(&self, text: &windows_core::HSTRING, startindex: u32, handler: P2) -> windows_result::Result<()>
    where
    ...
    pub fn CreateWithLanguage(language: &windows_core::HSTRING) -> windows_result::Result<SelectableWordsSegmenter> {
    ...
    fn ISelectableWordsSegmenterFactory<R, F: FnOnce(&ISelectableWordsSegmenterFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl SemanticTextQuery {
    pub fn Find(&self, content: &windows_core::HSTRING) -> windows_result::Result<windows_collections::IVectorView<TextSegment>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindInProperty(&self, propertycontent: &windows_core::HSTRING, propertyname: &windows_core::HSTRING) -> windows_result::Result<windows_collections::IVectorView<TextSegment>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Create(aqsfilter: &windows_core::HSTRING) -> windows_result::Result<SemanticTextQuery> {
    ...
    pub fn CreateWithLanguage(aqsfilter: &windows_core::HSTRING, filterlanguage: &windows_core::HSTRING) -> windows_result::Result<SemanticTextQuery> {
        Self::ISemanticTextQueryFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn ISemanticTextQueryFactory<R, F: FnOnce(&ISemanticTextQueryFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl TextConversionGenerator {
    ...
    pub fn LanguageAvailableButNotInstalled(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetCandidatesAsync(&self, input: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<windows_core::HSTRING>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetCandidatesWithMaxCountAsync(&self, input: &windows_core::HSTRING, maxcandidates: u32) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<windows_core::HSTRING>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Create(languagetag: &windows_core::HSTRING) -> windows_result::Result<TextConversionGenerator> {
    ...
    fn ITextConversionGeneratorFactory<R, F: FnOnce(&ITextConversionGeneratorFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl TextPhoneme {
    ...
    pub fn ReadingText(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl TextPredictionGenerator {
    ...
    pub fn GetCandidatesWithParametersAsync<P3>(&self, input: &windows_core::HSTRING, maxcandidates: u32, predictionoptions: TextPredictionOptions, previousstrings: P3) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<windows_core::HSTRING>>>
    where
    ...
    pub fn GetNextWordCandidatesAsync<P1>(&self, maxcandidates: u32, previousstrings: P1) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<windows_core::HSTRING>>>
    where
    ...
    #[cfg(feature = "UI_Text_Core")]
    pub fn InputScope(&self) -> windows_result::Result<super::super::UI::Text::Core::CoreTextInputScope> {
        let this = &windows_core::Interface::cast::<ITextPredictionGenerator2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Text_Core")]
    pub fn SetInputScope(&self, value: super::super::UI::Text::Core::CoreTextInputScope) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<ITextPredictionGenerator2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetInputScope)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Create(languagetag: &windows_core::HSTRING) -> windows_result::Result<TextPredictionGenerator> {
        Self::ITextPredictionGeneratorFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(languagetag), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn ITextPredictionGeneratorFactory<R, F: FnOnce(&ITextPredictionGeneratorFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl TextReverseConversionGenerator {
    ...
    pub fn ConvertBackAsync(&self, input: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetPhonemesAsync(&self, input: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<TextPhoneme>>> {
    ...
    pub fn Create(languagetag: &windows_core::HSTRING) -> windows_result::Result<TextReverseConversionGenerator> {
        Self::ITextReverseConversionGeneratorFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(languagetag), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn ITextReverseConversionGeneratorFactory<R, F: FnOnce(&ITextReverseConversionGeneratorFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl UnicodeCharacters {
    pub fn GetCodepointFromSurrogatePair(highsurrogate: u32, lowsurrogate: u32) -> windows_result::Result<u32> {
    ...
    pub fn GetSurrogatePairFromCodepoint(codepoint: u32, highsurrogate: &mut u16, lowsurrogate: &mut u16) -> windows_result::Result<()> {
    ...
    pub fn IsHighSurrogate(codepoint: u32) -> windows_result::Result<bool> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsLowSurrogate(codepoint: u32) -> windows_result::Result<bool> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsLowSurrogate)(windows_core::Interface::as_raw(this), codepoint, &mut result__).map(|| result__)
        })
    }
    pub fn IsSupplementary(codepoint: u32) -> windows_result::Result<bool> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetNumericType(codepoint: u32) -> windows_result::Result<UnicodeNumericType> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetNumericType)(windows_core::Interface::as_raw(this), codepoint, &mut result__).map(|| result__)
        })
    }
    pub fn GetGeneralCategory(codepoint: u32) -> windows_result::Result<UnicodeGeneralCategory> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IUnicodeCharactersStatics<R, F: FnOnce(&IUnicodeCharactersStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl WordSegment {
    ...
    pub fn AlternateForms(&self) -> windows_result::Result<windows_collections::IVectorView<AlternateWordForm>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WordSegmentsTokenizingHandler {
    pub fn new<F: Fn(windows_core::Ref<windows_collections::IIterable<WordSegment>>, windows_core::Ref<windows_collections::IIterable<WordSegment>>) -> windows_result::Result<()> + Send + 'static>(invoke: F) -> Self {
...
#[repr(C)]
struct WordSegmentsTokenizingHandlerBox<F: Fn(windows_core::Ref<windows_collections::IIterable<WordSegment>>, windows_core::Ref<windows_collections::IIterable<WordSegment>>) -> windows_result::Result<()> + Send + 'static> {
    vtable: *const WordSegmentsTokenizingHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: Fn(windows_core::Ref<windows_collections::IIterable<WordSegment>>, windows_core::Ref<windows_collections::IIterable<WordSegment>>) -> windows_result::Result<()> + Send + 'static> WordSegmentsTokenizingHandlerBox<F> {
...
impl WordsSegmenter {
    ...
    pub fn GetTokenAt(&self, text: &windows_core::HSTRING, startindex: u32) -> windows_result::Result<WordSegment> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetTokenAt)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(text), startindex, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetTokens(&self, text: &windows_core::HSTRING) -> windows_result::Result<windows_collections::IVectorView<WordSegment>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetTokens)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(text), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CreateWithLanguage(language: &windows_core::HSTRING) -> windows_result::Result<WordsSegmenter> {
        Self::IWordsSegmenterFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithLanguage)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(language), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IWordsSegmenterFactory<R, F: FnOnce(&IWordsSegmenterFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
