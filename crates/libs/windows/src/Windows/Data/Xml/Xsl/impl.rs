...
impl IXsltProcessorVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IXsltProcessorImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IXsltProcessorVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IXsltProcessor>, ::windows::core::GetTrustLevel, TransformToString::<Impl, IMPL_OFFSET>)
    }
...
impl IXsltProcessor2Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IXsltProcessor2Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IXsltProcessor2Vtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IXsltProcessor2>, ::windows::core::GetTrustLevel, TransformToDocument::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
...
impl IXsltProcessorFactoryVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IXsltProcessorFactoryImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IXsltProcessorFactoryVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IXsltProcessorFactory>, ::windows::core::GetTrustLevel, CreateInstance::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
