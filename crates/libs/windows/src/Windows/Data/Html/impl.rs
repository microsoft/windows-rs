...
pub trait IHtmlUtilities_Impl: Sized {
...
#[cfg(feature = "implement_exclusive")]
impl IHtmlUtilities_Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IHtmlUtilities_Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IHtmlUtilities_Vtbl {
        unsafe extern "system" fn ConvertToText<Impl: IHtmlUtilities_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, html: ::core::mem::ManuallyDrop<::windows::core::HSTRING>, result__: *mut ::core::mem::ManuallyDrop<::windows::core::HSTRING>) -> ::windows::core::HRESULT {
