...
windows_core::imp::required_hierarchy!(PdfDocument, IPdfDocument, IPdfDocumentStatics);
impl PdfDocument {
...
windows_core::imp::required_hierarchy!(PdfPage, IPdfPage, super::super::Foundation::IClosable);
impl PdfPage {
    #[cfg(feature = "Storage_Streams")]
...
windows_core::imp::required_hierarchy!(PdfPageDimensions, IPdfPageDimensions);
...
windows_core::imp::required_hierarchy!(PdfPageRenderOptions, IPdfPageRenderOptions);
