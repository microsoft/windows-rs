...
impl PdfDocument {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadFromFileAsync<P0>(file: P0) -> windows_core::Result<windows_async::IAsyncOperation<PdfDocument>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadFromFileWithPasswordAsync<P0>(file: P0, password: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<PdfDocument>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageFile>,
    {
        Self::IPdfDocumentStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadFromStreamAsync<P0>(inputstream: P0) -> windows_core::Result<windows_async::IAsyncOperation<PdfDocument>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadFromStreamWithPasswordAsync<P0>(inputstream: P0, password: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<PdfDocument>>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStream>,
    {
        Self::IPdfDocumentStatics(|this| unsafe {
...
impl PdfPage {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn RenderToStreamAsync<P0>(&self, outputstream: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStream>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn RenderWithOptionsToStreamAsync<P0, P1>(&self, outputstream: P0, options: P1) -> windows_core::Result<windows_async::IAsyncAction>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStream>,
    ...
    pub fn PreparePageAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
