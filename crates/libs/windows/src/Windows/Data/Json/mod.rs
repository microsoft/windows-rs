...
#[cfg(feature = "Foundation_Collections")]
windows_core::imp::required_hierarchy!(JsonArray, IJsonArray, IJsonArrayStatics, IJsonValue, super::super::Foundation::Collections::IIterable<IJsonValue>, super::super::Foundation::Collections::IVector<IJsonValue>, super::super::Foundation::IStringable);
#[cfg(feature = "Foundation_Collections")]
impl JsonArray {
...
#[cfg(feature = "Foundation_Collections")]
windows_core::imp::required_hierarchy ! ( JsonObject , IJsonObject , IJsonObjectStatics , IJsonObjectWithDefaultValues , IJsonValue , super::super::Foundation::Collections:: IIterable < super::super::Foundation::Collections:: IKeyValuePair < windows_core::HSTRING , IJsonValue > > , super::super::Foundation::Collections:: IMap < windows_core::HSTRING , IJsonValue > , super::super::Foundation:: IStringable );
#[cfg(feature = "Foundation_Collections")]
impl JsonObject {
    pub fn new() -> windows_core::Result<Self> {
        Self::IActivationFactory(|f| f.ActivateInstance::<Self>())
...
windows_core::imp::required_hierarchy!(JsonValue, IJsonValue, IJsonValueStatics, IJsonValueStatics2, super::super::Foundation::IStringable);
impl JsonValue {
    pub fn ValueType(&self) -> windows_core::Result<JsonValueType> {
        let this = self;
        unsafe {
