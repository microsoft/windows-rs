...
impl IJsonValue {
    pub fn ValueType(&self) -> windows_result::Result<JsonValueType> {
        let this = self;
        unsafe {
    ...
    pub fn Stringify(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetNumber(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetArray(&self) -> windows_result::Result<JsonArray> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetObject(&self) -> windows_result::Result<JsonObject> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IJsonValue_Impl: windows_core::IUnknownImpl {
    fn ValueType(&self) -> windows_result::Result<JsonValueType>;
    fn Stringify(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn GetString(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn GetNumber(&self) -> windows_result::Result<f64>;
    fn GetBoolean(&self) -> windows_result::Result<bool>;
    fn GetArray(&self) -> windows_result::Result<JsonArray>;
    fn GetObject(&self) -> windows_result::Result<JsonObject>;
}
...
impl JsonArray {
    ...
    pub fn First(&self) -> windows_result::Result<windows_collections::IIterator<IJsonValue>> {
    ...
    pub fn GetObjectAt(&self, index: u32) -> windows_result::Result<JsonObject> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetArrayAt(&self, index: u32) -> windows_result::Result<JsonArray> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetStringAt(&self, index: u32) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetNumberAt(&self, index: u32) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetBooleanAt(&self, index: u32) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Parse(input: &windows_core::HSTRING) -> windows_result::Result<JsonArray> {
    ...
    pub fn TryParse(input: &windows_core::HSTRING, result: &mut Option<JsonArray>) -> windows_result::Result<bool> {
        Self::IJsonArrayStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAt(&self, index: u32) -> windows_result::Result<IJsonValue> {
    ...
    pub fn GetView(&self) -> windows_result::Result<windows_collections::IVectorView<IJsonValue>> {
        let this = &windows_core::Interface::cast::<windows_collections::IVector<IJsonValue>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMany(&self, startindex: u32, items: &mut [Option<IJsonValue>]) -> windows_result::Result<u32> {
        let this = &windows_core::Interface::cast::<windows_collections::IVector<IJsonValue>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReplaceAll(&self, items: &[Option<IJsonValue>]) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<windows_collections::IVector<IJsonValue>>(self)?;
    ...
    fn IJsonArrayStatics<R, F: FnOnce(&IJsonArrayStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl JsonError {
    pub fn GetJsonStatus(hresult: i32) -> windows_result::Result<JsonErrorStatus> {
    ...
    fn IJsonErrorStatics2<R, F: FnOnce(&IJsonErrorStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl JsonObject {
    ...
    pub fn First(&self) -> windows_result::Result<windows_collections::IIterator<windows_collections::IKeyValuePair<windows_core::HSTRING, IJsonValue>>> {
    ...
    pub fn GetNamedValue(&self, name: &windows_core::HSTRING) -> windows_result::Result<JsonValue> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetNamedValue<P1>(&self, name: &windows_core::HSTRING, value: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<IJsonValue>,
    {
        let this = self;
    ...
    pub fn GetNamedObject(&self, name: &windows_core::HSTRING) -> windows_result::Result<JsonObject> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetNamedArray(&self, name: &windows_core::HSTRING) -> windows_result::Result<JsonArray> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetNamedString(&self, name: &windows_core::HSTRING) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetNamedNumber(&self, name: &windows_core::HSTRING) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetNamedBoolean(&self, name: &windows_core::HSTRING) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Parse(input: &windows_core::HSTRING) -> windows_result::Result<JsonObject> {
        Self::IJsonObjectStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Parse)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(input), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn TryParse(input: &windows_core::HSTRING, result: &mut Option<JsonObject>) -> windows_result::Result<bool> {
        Self::IJsonObjectStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryParse)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(input), result as *mut _ as _, &mut result__).map(|| result__)
        })
    }
    pub fn GetNamedValueOrDefault<P1>(&self, name: &windows_core::HSTRING, defaultvalue: P1) -> windows_result::Result<JsonValue>
    where
    ...
    pub fn GetNamedObjectOrDefault<P1>(&self, name: &windows_core::HSTRING, defaultvalue: P1) -> windows_result::Result<JsonObject>
    where
    ...
    pub fn GetNamedStringOrDefault(&self, name: &windows_core::HSTRING, defaultvalue: &windows_core::HSTRING) -> windows_result::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<IJsonObjectWithDefaultValues>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetNamedArrayOrDefault<P1>(&self, name: &windows_core::HSTRING, defaultvalue: P1) -> windows_result::Result<JsonArray>
    where
    ...
    pub fn GetNamedNumberOrDefault(&self, name: &windows_core::HSTRING, defaultvalue: f64) -> windows_result::Result<f64> {
        let this = &windows_core::Interface::cast::<IJsonObjectWithDefaultValues>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetNamedBooleanOrDefault(&self, name: &windows_core::HSTRING, defaultvalue: bool) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IJsonObjectWithDefaultValues>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Lookup(&self, key: &windows_core::HSTRING) -> windows_result::Result<IJsonValue> {
    ...
    pub fn GetView(&self) -> windows_result::Result<windows_collections::IMapView<windows_core::HSTRING, IJsonValue>> {
        let this = &windows_core::Interface::cast::<windows_collections::IMap<windows_core::HSTRING, IJsonValue>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    fn IJsonObjectStatics<R, F: FnOnce(&IJsonObjectStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl JsonValue {
    ...
    pub fn Parse(input: &windows_core::HSTRING) -> windows_result::Result<JsonValue> {
        Self::IJsonValueStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Parse)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(input), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn TryParse(input: &windows_core::HSTRING, result: &mut Option<JsonValue>) -> windows_result::Result<bool> {
        Self::IJsonValueStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TryParse)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(input), result as *mut _ as _, &mut result__).map(|| result__)
        })
    }
    pub fn CreateBooleanValue(input: bool) -> windows_result::Result<JsonValue> {
        Self::IJsonValueStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateNumberValue(input: f64) -> windows_result::Result<JsonValue> {
        Self::IJsonValueStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateStringValue(input: &windows_core::HSTRING) -> windows_result::Result<JsonValue> {
        Self::IJsonValueStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateNullValue() -> windows_result::Result<JsonValue> {
    ...
    fn IJsonValueStatics<R, F: FnOnce(&IJsonValueStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<JsonValue, IJsonValueStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IJsonValueStatics2<R, F: FnOnce(&IJsonValueStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
