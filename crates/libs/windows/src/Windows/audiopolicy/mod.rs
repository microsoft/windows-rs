...
impl IAudioSessionControl {
    ...
    pub unsafe fn GetState(&self) -> windows_core::Result<super::audiosessiontypes::AudioSessionState> {
        unsafe {
...
pub struct IAudioSessionControl_Vtbl {
    ...
    #[cfg(feature = "audiosessiontypes")]
    pub GetState: unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::audiosessiontypes::AudioSessionState) -> windows_core::HRESULT,
...
pub trait IAudioSessionControl_Impl: windows_core::IUnknownImpl {
    fn GetState(&self) -> windows_core::Result<super::audiosessiontypes::AudioSessionState>;
...
impl IAudioSessionControl_Vtbl {
    pub const fn new<Identity: IAudioSessionControl_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetState<Identity: IAudioSessionControl_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pretval: *mut super::audiosessiontypes::AudioSessionState) -> windows_core::HRESULT {
            unsafe {
...
impl IAudioSessionEvents {
    ...
    #[cfg(feature = "audiosessiontypes")]
    pub unsafe fn OnStateChanged(&self, newstate: super::audiosessiontypes::AudioSessionState) -> windows_core::HRESULT {
...
pub struct IAudioSessionEvents_Vtbl {
    ...
    #[cfg(feature = "audiosessiontypes")]
    pub OnStateChanged: unsafe extern "system" fn(*mut core::ffi::c_void, super::audiosessiontypes::AudioSessionState) -> windows_core::HRESULT,
    #[cfg(not(feature = "audiosessiontypes"))]
...
pub trait IAudioSessionEvents_Impl: windows_core::IUnknownImpl {
    ...
    fn OnStateChanged(&self, newstate: super::audiosessiontypes::AudioSessionState) -> windows_core::Result<()>;
...
impl IAudioSessionEvents_Vtbl {
    pub const fn new<Identity: IAudioSessionEvents_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn OnStateChanged<Identity: IAudioSessionEvents_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, newstate: super::audiosessiontypes::AudioSessionState) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IAudioSessionManager {
    ...
    pub unsafe fn GetSimpleAudioVolume(&self, audiosessionguid: Option<*const windows_core::GUID>, streamflags: u32) -> windows_core::Result<super::audioclient::ISimpleAudioVolume> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IAudioSessionManager_Impl: windows_core::IUnknownImpl {
    ...
    fn GetSimpleAudioVolume(&self, audiosessionguid: *const windows_core::GUID, streamflags: u32) -> windows_core::Result<super::audioclient::ISimpleAudioVolume>;
}
#[cfg(feature = "audioclient")]
