...
pub trait IRichEditOle_Impl: windows_core::IUnknownImpl {
    ...
    fn SaveCompleted(&self, iob: i32, lpstg: windows_core::Ref<super::objidl::IStorage>) -> windows_core::Result<()>;
...
impl IRichEditOle_Vtbl {
    pub const fn new<Identity: IRichEditOle_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetClipboardData<Identity: IRichEditOle_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, lpchrg: *mut super::richedit::CHARRANGE, reco: u32, lplpdataobj: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ImportDataObject<Identity: IRichEditOle_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, lpdataobj: *mut core::ffi::c_void, cf: super::wtypes::CLIPFORMAT, hmetapict: super::minwindef::HGLOBAL) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait IRichEditOleCallback_Impl: windows_core::IUnknownImpl {
    ...
    fn QueryInsertObject(&self, lpclsid: *mut windows_core::GUID, lpstg: windows_core::Ref<super::objidl::IStorage>, cp: i32) -> windows_core::Result<()>;
    fn DeleteObject(&self, lpoleobj: windows_core::Ref<super::oleidl::IOleObject>) -> windows_core::Result<()>;
    fn QueryAcceptData(&self, lpdataobj: windows_core::Ref<super::objidl::IDataObject>, lpcfformat: *mut super::wtypes::CLIPFORMAT, reco: u32, freally: windows_core::BOOL, hmetapict: super::minwindef::HGLOBAL) -> windows_core::Result<()>;
    fn ContextSensitiveHelp(&self, fentermode: windows_core::BOOL) -> windows_core::Result<()>;
    fn GetClipboardData(&self, lpchrg: *mut super::richedit::CHARRANGE, reco: u32, lplpdataobj: windows_core::OutRef<super::objidl::IDataObject>) -> windows_core::Result<()>;
...
impl IRichEditOleCallback_Vtbl {
    pub const fn new<Identity: IRichEditOleCallback_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetInPlaceContext<Identity: IRichEditOleCallback_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, lplpframe: *mut *mut core::ffi::c_void, lplpdoc: *mut *mut core::ffi::c_void, lpframeinfo: *mut super::oleidl::OLEINPLACEFRAMEINFO) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn QueryAcceptData<Identity: IRichEditOleCallback_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, lpdataobj: *mut core::ffi::c_void, lpcfformat: *mut super::wtypes::CLIPFORMAT, reco: u32, freally: windows_core::BOOL, hmetapict: super::minwindef::HGLOBAL) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetClipboardData<Identity: IRichEditOleCallback_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, lpchrg: *mut super::richedit::CHARRANGE, reco: u32, lplpdataobj: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetContextMenu<Identity: IRichEditOleCallback_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, seltype: u16, lpoleobj: *mut core::ffi::c_void, lpchrg: *mut super::richedit::CHARRANGE, lphmenu: *mut super::windef::HMENU) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub struct REOBJECT {
    ...
    pub poleobj: core::mem::ManuallyDrop<Option<super::oleidl::IOleObject>>,
    pub pstg: core::mem::ManuallyDrop<Option<super::objidl::IStorage>>,
    pub polesite: core::mem::ManuallyDrop<Option<super::oleidl::IOleClientSite>>,
