...
impl ISoftwareBitmapNativeFactory {
    ...
    pub unsafe fn CreateFromMF2DBuffer2<P0, T>(&self, data: P0, subtype: *const windows_core::GUID, width: u32, height: u32, forcereadonly: bool, mindisplayaperture: Option<*const super::mfobjects::MFVideoArea>) -> windows_core::Result<T>
    where
        P0: windows_core::Param<super::mfobjects::IMF2DBuffer2>,
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
...
pub struct ISoftwareBitmapNativeFactory_Vtbl {
    ...
    #[cfg(all(feature = "mfobjects", feature = "windef"))]
    pub CreateFromMF2DBuffer2: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *const windows_core::GUID, u32, u32, windows_core::BOOL, *const super::mfobjects::MFVideoArea, *const windows_core::GUID, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(all(feature = "mfobjects", feature = "windef")))]
    CreateFromMF2DBuffer2: usize,
}
#[cfg(all(feature = "mfobjects", feature = "wincodec", feature = "windef"))]
pub trait ISoftwareBitmapNativeFactory_Impl: windows_core::IUnknownImpl {
    fn CreateFromWICBitmap(&self, data: windows_core::Ref<super::wincodec::IWICBitmap>, forcereadonly: windows_core::BOOL, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_core::Result<()>;
    fn CreateFromMF2DBuffer2(&self, data: windows_core::Ref<super::mfobjects::IMF2DBuffer2>, subtype: *const windows_core::GUID, width: u32, height: u32, forcereadonly: windows_core::BOOL, mindisplayaperture: *const super::mfobjects::MFVideoArea, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_core::Result<()>;
}
#[cfg(all(feature = "mfobjects", feature = "wincodec", feature = "windef"))]
impl ISoftwareBitmapNativeFactory_Vtbl {
    pub const fn new<Identity: ISoftwareBitmapNativeFactory_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn CreateFromMF2DBuffer2<Identity: ISoftwareBitmapNativeFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, data: *mut core::ffi::c_void, subtype: *const windows_core::GUID, width: u32, height: u32, forcereadonly: windows_core::BOOL, mindisplayaperture: *const super::mfobjects::MFVideoArea, riid: *const windows_core::GUID, ppv: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
