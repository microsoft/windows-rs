...
windows_core::imp::required_hierarchy!(Direct3D11CaptureFrame, super::super::Foundation::IClosable, IDirect3D11CaptureFrame, IDirect3D11CaptureFrame2);
...
windows_core::imp::required_hierarchy!(Direct3D11CaptureFramePool, super::super::Foundation::IClosable, IDirect3D11CaptureFramePool, IDirect3D11CaptureFramePoolStatics, IDirect3D11CaptureFramePoolStatics2);
...
windows_core::imp::required_hierarchy!(GraphicsCaptureItem, IGraphicsCaptureItem, IGraphicsCaptureItemStatics, IGraphicsCaptureItemStatics2);
...
windows_core::imp::required_hierarchy!(GraphicsCapturePicker, IGraphicsCapturePicker);
...
windows_core::imp::required_hierarchy!(GraphicsCaptureSession, super::super::Foundation::IClosable, IGraphicsCaptureSession, IGraphicsCaptureSession2, IGraphicsCaptureSession3, IGraphicsCaptureSession4, IGraphicsCaptureSession5, IGraphicsCaptureSession6, IGraphicsCaptureSessionStatics);
