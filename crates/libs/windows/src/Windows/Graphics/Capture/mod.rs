...
impl Direct3D11CaptureFrame {
    ...
    pub fn Surface(&self) -> windows_result::Result<super::DirectX::Direct3D11::IDirect3DSurface> {
        let this = self;
        unsafe {
    ...
    pub fn SystemRelativeTime(&self) -> windows_result::Result<super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ContentSize(&self) -> windows_result::Result<super::SizeInt32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DirtyRegions(&self) -> windows_result::Result<windows_collections::IVectorView<super::RectInt32>> {
    ...
    pub fn DirtyRegionMode(&self) -> windows_result::Result<GraphicsCaptureDirtyRegionMode> {
        let this = &windows_core::Interface::cast::<IDirect3D11CaptureFrame2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl Direct3D11CaptureFramePool {
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn Recreate<P0>(&self, device: P0, pixelformat: super::DirectX::DirectXPixelFormat, numberofbuffers: i32, size: super::SizeInt32) -> windows_result::Result<()>
    where
    ...
    pub fn TryGetNextFrame(&self) -> windows_result::Result<Direct3D11CaptureFrame> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateCaptureSession<P0>(&self, item: P0) -> windows_result::Result<GraphicsCaptureSession>
    where
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn Create<P0>(device: P0, pixelformat: super::DirectX::DirectXPixelFormat, numberofbuffers: i32, size: super::SizeInt32) -> windows_result::Result<Direct3D11CaptureFramePool>
    where
        P0: windows_core::Param<super::DirectX::Direct3D11::IDirect3DDevice>,
    {
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn CreateFreeThreaded<P0>(device: P0, pixelformat: super::DirectX::DirectXPixelFormat, numberofbuffers: i32, size: super::SizeInt32) -> windows_result::Result<Direct3D11CaptureFramePool>
    where
        P0: windows_core::Param<super::DirectX::Direct3D11::IDirect3DDevice>,
    {
    ...
    fn IDirect3D11CaptureFramePoolStatics<R, F: FnOnce(&IDirect3D11CaptureFramePoolStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IDirect3D11CaptureFramePoolStatics2<R, F: FnOnce(&IDirect3D11CaptureFramePoolStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl GraphicsCaptureAccess {
    ...
    pub fn RequestAccessAsync(request: GraphicsCaptureAccessKind) -> windows_result::Result<windows_future::IAsyncOperation<super::super::Security::Authorization::AppCapabilityAccess::AppCapabilityAccessStatus>> {
    ...
    fn IGraphicsCaptureAccessStatics<R, F: FnOnce(&IGraphicsCaptureAccessStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl GraphicsCaptureItem {
    ...
    pub fn Size(&self) -> windows_result::Result<super::SizeInt32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFromVisual<P0>(visual: P0) -> windows_result::Result<GraphicsCaptureItem>
    where
    ...
    #[cfg(feature = "UI")]
    pub fn TryCreateFromWindowId(windowid: super::super::UI::WindowId) -> windows_result::Result<GraphicsCaptureItem> {
    ...
    pub fn TryCreateFromDisplayId(displayid: super::DisplayId) -> windows_result::Result<GraphicsCaptureItem> {
        Self::IGraphicsCaptureItemStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IGraphicsCaptureItemStatics<R, F: FnOnce(&IGraphicsCaptureItemStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IGraphicsCaptureItemStatics2<R, F: FnOnce(&IGraphicsCaptureItemStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl GraphicsCapturePicker {
    ...
    pub fn PickSingleItemAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<GraphicsCaptureItem>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GraphicsCaptureSession {
    ...
    pub fn StartCapture(&self) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).StartCapture)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn IsCursorCaptureEnabled(&self) -> windows_result::Result<bool> {
    ...
    pub fn SetIsCursorCaptureEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IGraphicsCaptureSession2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetIsCursorCaptureEnabled)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsBorderRequired(&self) -> windows_result::Result<bool> {
    ...
    pub fn SetIsBorderRequired(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IGraphicsCaptureSession3>(self)?;
    ...
    pub fn SetDirtyRegionMode(&self, value: GraphicsCaptureDirtyRegionMode) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IGraphicsCaptureSession4>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetDirtyRegionMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn MinUpdateInterval(&self) -> windows_result::Result<super::super::Foundation::TimeSpan> {
    ...
    pub fn SetMinUpdateInterval(&self, value: super::super::Foundation::TimeSpan) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IGraphicsCaptureSession5>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetMinUpdateInterval)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IncludeSecondaryWindows(&self) -> windows_result::Result<bool> {
    ...
    pub fn SetIncludeSecondaryWindows(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IGraphicsCaptureSession6>(self)?;
    ...
    fn IGraphicsCaptureSessionStatics<R, F: FnOnce(&IGraphicsCaptureSessionStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
