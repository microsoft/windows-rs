...
impl IGeometrySource2D_Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IGeometrySource2D_Impl, const OFFSET: isize>() -> IGeometrySource2D_Vtbl {
        Self { base: ::windows::core::IInspectableVtbl::new::<Identity, IGeometrySource2D, OFFSET>() }
    }
