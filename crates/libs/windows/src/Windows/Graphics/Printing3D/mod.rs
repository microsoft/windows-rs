...
impl<F: Fn(windows_core::Ref<Print3DTaskSourceRequestedArgs>) -> windows_core::Result<()> + Send + 'static> From<windows_core::DelegateFn<F>> for Print3DTaskSourceRequestedHandler {
