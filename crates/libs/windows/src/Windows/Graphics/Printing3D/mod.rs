...
impl Print3DManager {
    ...
    pub fn ShowPrintUIAsync() -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
        Self::IPrint3DManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
...
impl Printing3D3MFPackage {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SaveAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<super::super::Storage::Streams::IRandomAccessStream>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadModelFromPackageAsync<P0>(&self, value: P0) -> windows_core::Result<windows_async::IAsyncOperation<Printing3DModel>>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStream>,
    {
        let this = self;
    ...
    pub fn SaveModelToPackageAsync<P0>(&self, value: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadAsync<P0>(value: P0) -> windows_core::Result<windows_async::IAsyncOperation<Printing3D3MFPackage>>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStream>,
    {
...
impl Printing3DMesh {
    ...
    pub fn VerifyAsync(&self, value: Printing3DMeshVerificationMode) -> windows_core::Result<windows_async::IAsyncOperation<Printing3DMeshVerificationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl Printing3DModel {
    ...
    pub fn RepairAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryPartialRepairAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
    ...
    pub fn TryPartialRepairWithTimeAsync(&self, maxwaittime: super::super::Foundation::TimeSpan) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
        let this = &windows_core::Interface::cast::<IPrinting3DModel2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryReduceFacesAsync(&self) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<bool, f64>> {
        let this = &windows_core::Interface::cast::<IPrinting3DModel2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryReduceFacesWithOptionsAsync<P0>(&self, printing3dfacereductionoptions: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<bool, f64>>
    where
    ...
    pub fn TryReduceFacesWithOptionsAndTimeAsync<P0>(&self, printing3dfacereductionoptions: P0, maxwait: super::super::Foundation::TimeSpan) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<bool, f64>>
    where
        P0: windows_core::Param<Printing3DFaceReductionOptions>,
    {
        let this = &windows_core::Interface::cast::<IPrinting3DModel2>(self)?;
    ...
    pub fn RepairWithProgressAsync(&self) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<bool, f64>> {
        let this = &windows_core::Interface::cast::<IPrinting3DModel2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
