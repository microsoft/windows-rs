...
impl HolographicCamera {
    pub fn RenderTargetSize(&self) -> Result<super::super::Foundation::Size, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn ViewportScaleFactor(&self) -> Result<f64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetViewportScaleFactor(&self, value: f64) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn SetNearPlaneDistance(&self, value: f64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetNearPlaneDistance)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SetFarPlaneDistance(&self, value: f64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetFarPlaneDistance)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn LeftViewportParameters(&self) -> Result<HolographicCameraViewportParameters, windows_result::HRESULT> {
    ...
    pub fn RightViewportParameters(&self) -> Result<HolographicCameraViewportParameters, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IHolographicCamera2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Display(&self) -> Result<HolographicDisplay, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IHolographicCamera2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsPrimaryLayerEnabled(&self) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn SetIsPrimaryLayerEnabled(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IHolographicCamera3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetIsPrimaryLayerEnabled)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn MaxQuadLayerCount(&self) -> Result<u32, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IHolographicCamera3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn QuadLayers(&self) -> Result<windows_collections::IVector<HolographicQuadLayer>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IHolographicCamera3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanOverrideViewport(&self) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn IsHardwareContentProtectionSupported(&self) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn IsHardwareContentProtectionEnabled(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IHolographicCamera5>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsHardwareContentProtectionEnabled(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IHolographicCamera5>(self)?;
    ...
    pub fn ViewConfiguration(&self) -> Result<HolographicViewConfiguration, windows_result::HRESULT> {
...
impl HolographicCameraPose {
    pub fn HolographicCamera(&self) -> Result<HolographicCamera, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Viewport(&self) -> Result<super::super::Foundation::Rect, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryGetViewTransform<P0>(&self, coordinatesystem: P0) -> Result<super::super::Foundation::IReference<HolographicStereoTransform>, windows_result::HRESULT>
    where
    ...
    pub fn ProjectionTransform(&self) -> Result<HolographicStereoTransform, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryGetCullingFrustum<P0>(&self, coordinatesystem: P0) -> Result<super::super::Foundation::IReference<super::super::Perception::Spatial::SpatialBoundingFrustum>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Perception::Spatial::SpatialCoordinateSystem>,
    {
        let this = self;
    ...
    #[cfg(all(feature = "Foundation_Numerics", feature = "Perception_Spatial"))]
    pub fn TryGetVisibleFrustum<P0>(&self, coordinatesystem: P0) -> Result<super::super::Foundation::IReference<super::super::Perception::Spatial::SpatialBoundingFrustum>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Perception::Spatial::SpatialCoordinateSystem>,
    {
        let this = self;
    ...
    pub fn NearPlaneDistance(&self) -> Result<f64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FarPlaneDistance(&self) -> Result<f64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Perception_Spatial")]
    pub fn OverrideViewTransform<P0>(&self, coordinatesystem: P0, coordinatesystemtoviewtransform: HolographicStereoTransform) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Perception::Spatial::SpatialCoordinateSystem>,
    {
    ...
    pub fn OverrideProjectionTransform(&self, projectiontransform: HolographicStereoTransform) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IHolographicCameraPose2>(self)?;
    ...
    pub fn OverrideViewport(&self, leftviewport: super::super::Foundation::Rect, rightviewport: super::super::Foundation::Rect) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IHolographicCameraPose2>(self)?;
...
impl HolographicCameraRenderingParameters {
    #[cfg(feature = "Perception_Spatial")]
    pub fn SetFocusPoint<P0>(&self, coordinatesystem: P0, position: windows_numerics::Vector3) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Perception::Spatial::SpatialCoordinateSystem>,
    {
        let this = self;
    ...
    #[cfg(feature = "Perception_Spatial")]
    pub fn SetFocusPointWithNormal<P0>(&self, coordinatesystem: P0, position: windows_numerics::Vector3, normal: windows_numerics::Vector3) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Perception::Spatial::SpatialCoordinateSystem>,
    {
        let this = self;
    ...
    #[cfg(feature = "Perception_Spatial")]
    pub fn SetFocusPointWithNormalLinearVelocity<P0>(&self, coordinatesystem: P0, position: windows_numerics::Vector3, normal: windows_numerics::Vector3, linearvelocity: windows_numerics::Vector3) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Perception::Spatial::SpatialCoordinateSystem>,
    {
        let this = self;
    ...
    pub fn Direct3D11Device(&self) -> Result<super::DirectX::Direct3D11::IDirect3DDevice, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn Direct3D11BackBuffer(&self) -> Result<super::DirectX::Direct3D11::IDirect3DSurface, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReprojectionMode(&self) -> Result<HolographicReprojectionMode, windows_result::HRESULT> {
    ...
    pub fn SetReprojectionMode(&self, value: HolographicReprojectionMode) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IHolographicCameraRenderingParameters2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetReprojectionMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn CommitDirect3D11DepthBuffer<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn IsContentProtectionEnabled(&self) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn SetIsContentProtectionEnabled(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IHolographicCameraRenderingParameters3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetIsContentProtectionEnabled)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DepthReprojectionMethod(&self) -> Result<HolographicDepthReprojectionMethod, windows_result::HRESULT> {
    ...
    pub fn SetDepthReprojectionMethod(&self, value: HolographicDepthReprojectionMethod) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IHolographicCameraRenderingParameters4>(self)?;
...
impl HolographicCameraViewportParameters {
    pub fn HiddenAreaMesh(&self) -> Result<windows_core::Array<windows_numerics::Vector2>, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn VisibleAreaMesh(&self) -> Result<windows_core::Array<windows_numerics::Vector2>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::MaybeUninit::zeroed();
...
impl HolographicDisplay {
    ...
    pub fn MaxViewportSize(&self) -> Result<super::super::Foundation::Size, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsOpaque(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AdapterId(&self) -> Result<HolographicAdapterId, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Perception_Spatial")]
    pub fn SpatialLocator(&self) -> Result<super::super::Perception::Spatial::SpatialLocator, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryGetViewConfiguration(&self, kind: HolographicViewConfigurationKind) -> Result<HolographicViewConfiguration, windows_result::HRESULT> {
    ...
    pub fn GetDefault() -> Result<HolographicDisplay, windows_result::HRESULT> {
        Self::IHolographicDisplayStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefault)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IHolographicDisplayStatics<R, F: FnOnce(&IHolographicDisplayStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl HolographicFrame {
    pub fn AddedCameras(&self) -> Result<windows_collections::IVectorView<HolographicCamera>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RemovedCameras(&self) -> Result<windows_collections::IVectorView<HolographicCamera>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetRenderingParameters<P0>(&self, camerapose: P0) -> Result<HolographicCameraRenderingParameters, windows_result::HRESULT>
    where
    ...
    pub fn CurrentPrediction(&self) -> Result<HolographicFramePrediction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UpdateCurrentPrediction(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).UpdateCurrentPrediction)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn PresentUsingCurrentPrediction(&self) -> Result<HolographicFramePresentResult, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PresentUsingCurrentPredictionWithBehavior(&self, waitbehavior: HolographicFramePresentWaitBehavior) -> Result<HolographicFramePresentResult, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn WaitForFrameToFinish(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).WaitForFrameToFinish)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn GetQuadLayerUpdateParameters<P0>(&self, layer: P0) -> Result<HolographicQuadLayerUpdateParameters, windows_result::HRESULT>
    where
    ...
    pub fn Id(&self) -> Result<HolographicFrameId, windows_result::HRESULT> {
...
impl HolographicFramePrediction {
    pub fn CameraPoses(&self) -> Result<windows_collections::IVectorView<HolographicCameraPose>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Timestamp(&self) -> Result<super::super::Perception::PerceptionTimestamp, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl HolographicFramePresentationMonitor {
    ...
    pub fn ReadReports(&self) -> Result<windows_collections::IVectorView<HolographicFramePresentationReport>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl HolographicFramePresentationReport {
    pub fn CompositorGpuDuration(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AppGpuDuration(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AppGpuOverrun(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MissedPresentationOpportunityCount(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PresentationCount(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl HolographicFrameRenderingReport {
    pub fn FrameId(&self) -> Result<HolographicFrameId, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MissedLatchCount(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SystemRelativeFrameReadyTime(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SystemRelativeActualGpuFinishTime(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SystemRelativeTargetLatchTime(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl HolographicFrameScanoutMonitor {
    ...
    pub fn ReadReports(&self) -> Result<windows_collections::IVector<HolographicFrameScanoutReport>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReadReports)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl HolographicFrameScanoutReport {
    pub fn RenderingReport(&self) -> Result<HolographicFrameRenderingReport, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MissedScanoutCount(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SystemRelativeLatchTime(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SystemRelativeScanoutStartTime(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SystemRelativePhotonTime(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl HolographicQuadLayer {
    ...
    pub fn PixelFormat(&self) -> Result<super::DirectX::DirectXPixelFormat, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Create(size: super::super::Foundation::Size) -> Result<HolographicQuadLayer, windows_result::HRESULT> {
    ...
    #[cfg(feature = "Graphics_DirectX")]
    pub fn CreateWithPixelFormat(size: super::super::Foundation::Size, pixelformat: super::DirectX::DirectXPixelFormat) -> Result<HolographicQuadLayer, windows_result::HRESULT> {
        Self::IHolographicQuadLayerFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IHolographicQuadLayerFactory<R, F: FnOnce(&IHolographicQuadLayerFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl HolographicQuadLayerUpdateParameters {
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn AcquireBufferToUpdateContent(&self) -> Result<super::DirectX::Direct3D11::IDirect3DSurface, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UpdateViewport(&self, value: super::super::Foundation::Rect) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).UpdateViewport)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn UpdateContentProtectionEnabled(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).UpdateContentProtectionEnabled)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn UpdateExtents(&self, value: windows_numerics::Vector2) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).UpdateExtents)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(all(feature = "Foundation_Numerics", feature = "Perception_Spatial"))]
    pub fn UpdateLocationWithStationaryMode<P0>(&self, coordinatesystem: P0, position: windows_numerics::Vector3, orientation: super::super::Foundation::Numerics::Quaternion) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Perception::Spatial::SpatialCoordinateSystem>,
    {
        let this = self;
    ...
    pub fn UpdateLocationWithDisplayRelativeMode(&self, position: windows_numerics::Vector3, orientation: super::super::Foundation::Numerics::Quaternion) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn CanAcquireWithHardwareProtection(&self) -> Result<bool, windows_result::HRESULT> {
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn AcquireBufferToUpdateContentWithHardwareProtection(&self) -> Result<super::DirectX::Direct3D11::IDirect3DSurface, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IHolographicQuadLayerUpdateParameters2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl HolographicSpace {
    pub fn PrimaryAdapterId(&self) -> Result<HolographicAdapterId, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn SetDirect3D11Device<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn CameraAdded<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveCameraAdded(&self, cookie: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveCameraAdded)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    pub fn CameraRemoved<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveCameraRemoved(&self, cookie: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveCameraRemoved)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    pub fn CreateNextFrame(&self) -> Result<HolographicFrame, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UserPresence(&self) -> Result<HolographicSpaceUserPresence, windows_result::HRESULT> {
    ...
    pub fn UserPresenceChanged<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveUserPresenceChanged(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IHolographicSpace2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemoveUserPresenceChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn WaitForNextFrameReady(&self) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IHolographicSpace2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).WaitForNextFrameReady)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn WaitForNextFrameReadyWithHeadStart(&self, requestedheadstartduration: super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IHolographicSpace2>(self)?;
    ...
    pub fn CreateFramePresentationMonitor(&self, maxqueuedreports: u32) -> Result<HolographicFramePresentationMonitor, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IHolographicSpace2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFrameScanoutMonitor(&self, maxqueuedreports: u32) -> Result<HolographicFrameScanoutMonitor, windows_result::HRESULT> {
    ...
    #[cfg(feature = "UI_Core")]
    pub fn CreateForCoreWindow<P0>(window: P0) -> Result<HolographicSpace, windows_result::HRESULT>
    where
    ...
    pub fn IsAvailable() -> Result<bool, windows_result::HRESULT> {
        Self::IHolographicSpaceStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsAvailable)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn IsAvailableChanged<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveIsAvailableChanged(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn IsConfigured() -> Result<bool, windows_result::HRESULT> {
    ...
    fn IHolographicSpaceStatics<R, F: FnOnce(&IHolographicSpaceStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<HolographicSpace, IHolographicSpaceStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IHolographicSpaceStatics2<R, F: FnOnce(&IHolographicSpaceStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<HolographicSpace, IHolographicSpaceStatics2> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IHolographicSpaceStatics3<R, F: FnOnce(&IHolographicSpaceStatics3) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl HolographicSpaceCameraAddedEventArgs {
    pub fn Camera(&self) -> Result<HolographicCamera, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl HolographicViewConfiguration {
    pub fn NativeRenderTargetSize(&self) -> Result<super::super::Foundation::Size, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestRenderTargetSize(&self, size: super::super::Foundation::Size) -> Result<super::super::Foundation::Size, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics_DirectX")]
    pub fn SupportedPixelFormats(&self) -> Result<windows_collections::IVectorView<super::DirectX::DirectXPixelFormat>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics_DirectX")]
    pub fn SetPixelFormat(&self, value: super::DirectX::DirectXPixelFormat) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Kind(&self) -> Result<HolographicViewConfigurationKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SupportedDepthReprojectionMethods(&self) -> Result<windows_collections::IVectorView<HolographicDepthReprojectionMethod>, windows_result::HRESULT> {
