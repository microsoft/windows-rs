...
#[repr(C)]
struct DisplayPropertiesEventHandlerBox<F: FnMut(&windows_core::IInspectable) -> windows_core::Result<()> + Send + 'static> {
    vtable: *const DisplayPropertiesEventHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(&windows_core::IInspectable) -> windows_core::Result<()> + Send + 'static> DisplayPropertiesEventHandlerBox<F> {
