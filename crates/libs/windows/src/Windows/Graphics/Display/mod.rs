...
impl AdvancedColorInfo {
    pub fn CurrentAdvancedColorKind(&self) -> windows_result::Result<AdvancedColorKind> {
        let this = self;
        unsafe {
    ...
    pub fn SdrWhiteLevelInNits(&self) -> windows_result::Result<f32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsHdrMetadataFormatCurrentlySupported(&self, format: HdrMetadataFormat) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsAdvancedColorKindAvailable(&self, kind: AdvancedColorKind) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl BrightnessOverride {
    ...
    pub fn IsOverrideActive(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BrightnessLevel(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetBrightnessLevel(&self, brightnesslevel: f64, options: DisplayBrightnessOverrideOptions) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetBrightnessScenario(&self, scenario: DisplayBrightnessScenario, options: DisplayBrightnessOverrideOptions) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetBrightnessScenario)(windows_core::Interface::as_raw(this), scenario, options).ok() }
    }
    pub fn GetLevelForScenario(&self, scenario: DisplayBrightnessScenario) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StartOverride(&self) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).StartOverride)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn StopOverride(&self) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn IsOverrideActiveChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<BrightnessOverride, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveIsOverrideActiveChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveIsOverrideActiveChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn BrightnessLevelChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<BrightnessOverride, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveBrightnessLevelChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveBrightnessLevelChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GetDefaultForSystem() -> windows_result::Result<BrightnessOverride> {
    ...
    pub fn GetForCurrentView() -> windows_result::Result<BrightnessOverride> {
        Self::IBrightnessOverrideStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForCurrentView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn SaveForSystemAsync<P0>(value: P0) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
    ...
    fn IBrightnessOverrideStatics<R, F: FnOnce(&IBrightnessOverrideStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl BrightnessOverrideSettings {
    pub fn DesiredLevel(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DesiredNits(&self) -> windows_result::Result<f32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFromLevel(level: f64) -> windows_result::Result<BrightnessOverrideSettings> {
    ...
    pub fn CreateFromNits(nits: f32) -> windows_result::Result<BrightnessOverrideSettings> {
        Self::IBrightnessOverrideSettingsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFromDisplayBrightnessOverrideScenario(overridescenario: DisplayBrightnessOverrideScenario) -> windows_result::Result<BrightnessOverrideSettings> {
        Self::IBrightnessOverrideSettingsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IBrightnessOverrideSettingsStatics<R, F: FnOnce(&IBrightnessOverrideSettingsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl ColorOverrideSettings {
    pub fn DesiredDisplayColorOverrideScenario(&self) -> windows_result::Result<DisplayColorOverrideScenario> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFromDisplayColorOverrideScenario(overridescenario: DisplayColorOverrideScenario) -> windows_result::Result<ColorOverrideSettings> {
    ...
    fn IColorOverrideSettingsStatics<R, F: FnOnce(&IColorOverrideSettingsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl DisplayEnhancementOverride {
    pub fn ColorOverrideSettings(&self) -> windows_result::Result<ColorOverrideSettings> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetColorOverrideSettings<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn BrightnessOverrideSettings(&self) -> windows_result::Result<BrightnessOverrideSettings> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetBrightnessOverrideSettings<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn CanOverride(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetCurrentDisplayEnhancementOverrideCapabilities(&self) -> windows_result::Result<DisplayEnhancementOverrideCapabilities> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestOverride(&self) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn CanOverrideChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveCanOverrideChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn DisplayEnhancementOverrideCapabilitiesChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveDisplayEnhancementOverrideCapabilitiesChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn GetForCurrentView() -> windows_result::Result<DisplayEnhancementOverride> {
        Self::IDisplayEnhancementOverrideStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForCurrentView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IDisplayEnhancementOverrideStatics<R, F: FnOnce(&IDisplayEnhancementOverrideStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl DisplayEnhancementOverrideCapabilities {
    pub fn IsBrightnessControlSupported(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsBrightnessNitsControlSupported(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetSupportedNitRanges(&self) -> windows_result::Result<windows_collections::IVectorView<NitRange>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DisplayEnhancementOverrideCapabilitiesChangedEventArgs {
    pub fn Capabilities(&self) -> windows_result::Result<DisplayEnhancementOverrideCapabilities> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DisplayInformation {
    pub fn CurrentOrientation(&self) -> windows_result::Result<DisplayOrientations> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NativeOrientation(&self) -> windows_result::Result<DisplayOrientations> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OrientationChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveOrientationChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveOrientationChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn ResolutionScale(&self) -> windows_result::Result<ResolutionScale> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LogicalDpi(&self) -> windows_result::Result<f32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DpiChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<DisplayInformation, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveDpiChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveDpiChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn StereoEnabled(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StereoEnabledChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<DisplayInformation, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveStereoEnabledChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveStereoEnabledChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn GetColorProfileAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<super::super::Storage::Streams::IRandomAccessStream>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ColorProfileChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<DisplayInformation, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveColorProfileChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveColorProfileChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn RawPixelsPerViewPixel(&self) -> windows_result::Result<f64> {
    ...
    pub fn DiagonalSizeInInches(&self) -> windows_result::Result<super::super::Foundation::IReference<f64>> {
    ...
    pub fn ScreenWidthInRawPixels(&self) -> windows_result::Result<u32> {
    ...
    pub fn ScreenHeightInRawPixels(&self) -> windows_result::Result<u32> {
        let this = &windows_core::Interface::cast::<IDisplayInformation4>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAdvancedColorInfo(&self) -> windows_result::Result<AdvancedColorInfo> {
    ...
    pub fn AdvancedColorInfoChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<DisplayInformation, windows_core::IInspectable>>,
    {
        let this = &windows_core::Interface::cast::<IDisplayInformation5>(self)?;
    ...
    pub fn RemoveAdvancedColorInfoChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IDisplayInformation5>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemoveAdvancedColorInfoChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GetForCurrentView() -> windows_result::Result<DisplayInformation> {
        Self::IDisplayInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForCurrentView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn AutoRotationPreferences() -> windows_result::Result<DisplayOrientations> {
        Self::IDisplayInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AutoRotationPreferences)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn SetAutoRotationPreferences(value: DisplayOrientations) -> windows_result::Result<()> {
    ...
    pub fn DisplayContentsInvalidated<P0>(handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<DisplayInformation, windows_core::IInspectable>>,
    {
        Self::IDisplayInformationStatics(|this| unsafe {
    ...
    pub fn RemoveDisplayContentsInvalidated(token: i64) -> windows_result::Result<()> {
    ...
    fn IDisplayInformationStatics<R, F: FnOnce(&IDisplayInformationStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl DisplayProperties {
    pub fn CurrentOrientation() -> windows_result::Result<DisplayOrientations> {
        Self::IDisplayPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CurrentOrientation)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn NativeOrientation() -> windows_result::Result<DisplayOrientations> {
        Self::IDisplayPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).NativeOrientation)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    ...
    pub fn OrientationChanged<P0>(handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveOrientationChanged(token: i64) -> windows_result::Result<()> {
    ...
    pub fn ResolutionScale() -> windows_result::Result<ResolutionScale> {
        Self::IDisplayPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ResolutionScale)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn LogicalDpi() -> windows_result::Result<f32> {
        Self::IDisplayPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LogicalDpi)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn LogicalDpiChanged<P0>(handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<DisplayPropertiesEventHandler>,
    {
        Self::IDisplayPropertiesStatics(|this| unsafe {
    ...
    pub fn RemoveLogicalDpiChanged(token: i64) -> windows_result::Result<()> {
    ...
    pub fn StereoEnabled() -> windows_result::Result<bool> {
        Self::IDisplayPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).StereoEnabled)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn StereoEnabledChanged<P0>(handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<DisplayPropertiesEventHandler>,
    {
        Self::IDisplayPropertiesStatics(|this| unsafe {
    ...
    pub fn RemoveStereoEnabledChanged(token: i64) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetColorProfileAsync() -> windows_result::Result<windows_future::IAsyncOperation<super::super::Storage::Streams::IRandomAccessStream>> {
        Self::IDisplayPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetColorProfileAsync)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn ColorProfileChanged<P0>(handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<DisplayPropertiesEventHandler>,
    {
        Self::IDisplayPropertiesStatics(|this| unsafe {
    ...
    pub fn RemoveColorProfileChanged(token: i64) -> windows_result::Result<()> {
    ...
    fn IDisplayPropertiesStatics<R, F: FnOnce(&IDisplayPropertiesStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
#[repr(C)]
struct DisplayPropertiesEventHandlerBox<F: Fn(windows_core::Ref<windows_core::IInspectable>) -> windows_result::Result<()> + Send + 'static> {
    vtable: *const DisplayPropertiesEventHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: Fn(windows_core::Ref<windows_core::IInspectable>) -> windows_result::Result<()> + Send + 'static> DisplayPropertiesEventHandlerBox<F> {
...
impl DisplayServices {
    pub fn FindAll() -> windows_result::Result<windows_core::Array<super::DisplayId>> {
    ...
    fn IDisplayServicesStatics<R, F: FnOnce(&IDisplayServicesStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
