...
windows_core::imp::required_hierarchy!(HdmiDisplayInformation, IHdmiDisplayInformation, IHdmiDisplayInformationStatics);
...
windows_core::imp::required_hierarchy!(HdmiDisplayMode, IHdmiDisplayMode, IHdmiDisplayMode2);
