...
impl HdmiDisplayInformation {
    pub fn GetSupportedDisplayModes(&self) -> windows_result::Result<windows_collections::IVectorView<HdmiDisplayMode>> {
        let this = self;
        unsafe {
    ...
    pub fn GetCurrentDisplayMode(&self) -> windows_result::Result<HdmiDisplayMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDefaultDisplayModeAsync(&self) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestSetCurrentDisplayModeAsync<P0>(&self, mode: P0) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
    ...
    pub fn RequestSetCurrentDisplayModeWithHdrAsync<P0>(&self, mode: P0, hdroption: HdmiDisplayHdrOption) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<HdmiDisplayMode>,
    {
        let this = self;
    ...
    pub fn RequestSetCurrentDisplayModeWithHdrAndMetadataAsync<P0>(&self, mode: P0, hdroption: HdmiDisplayHdrOption, hdrmetadata: HdmiDisplayHdr2086Metadata) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<HdmiDisplayMode>,
    {
        let this = self;
    ...
    pub fn DisplayModesChanged<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveDisplayModesChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveDisplayModesChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GetForCurrentView() -> windows_result::Result<HdmiDisplayInformation> {
        Self::IHdmiDisplayInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForCurrentView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IHdmiDisplayInformationStatics<R, F: FnOnce(&IHdmiDisplayInformationStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl HdmiDisplayMode {
    pub fn ResolutionWidthInRawPixels(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ResolutionHeightInRawPixels(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RefreshRate(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BitsPerPixel(&self) -> windows_result::Result<u16> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsEqual<P0>(&self, mode: P0) -> windows_result::Result<bool>
    where
        P0: windows_core::Param<HdmiDisplayMode>,
    {
        let this = self;
    ...
    pub fn ColorSpace(&self) -> windows_result::Result<HdmiDisplayColorSpace> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PixelEncoding(&self) -> windows_result::Result<HdmiDisplayPixelEncoding> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsSdrLuminanceSupported(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsSmpte2084Supported(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Is2086MetadataSupported(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsDolbyVisionLowLatencySupported(&self) -> windows_result::Result<bool> {
