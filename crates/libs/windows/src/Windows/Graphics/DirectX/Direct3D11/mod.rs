...
impl Direct3DBindings {
    pub const VertexBuffer: Self = Self(1);
    pub const IndexBuffer: Self = Self(2);
    pub const ConstantBuffer: Self = Self(4);
    pub const ShaderResource: Self = Self(8);
    pub const StreamOutput: Self = Self(16);
    pub const RenderTarget: Self = Self(32);
    pub const DepthStencil: Self = Self(64);
    pub const UnorderedAccess: Self = Self(128);
