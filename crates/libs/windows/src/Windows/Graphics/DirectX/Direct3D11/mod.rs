...
impl IDirect3DDevice_Vtbl {
    pub const fn new<Identity: IDirect3DDevice_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Trim<Identity: IDirect3DDevice_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
...
impl IDirect3DSurface_Vtbl {
    pub const fn new<Identity: IDirect3DSurface_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Description<Identity: IDirect3DSurface_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut Direct3DSurfaceDescription) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
