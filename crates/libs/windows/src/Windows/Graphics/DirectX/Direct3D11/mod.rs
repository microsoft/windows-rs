...
impl IDirect3DDevice {
    pub fn Trim(&self) -> windows_result::Result<()> {
        let this = self;
...
pub trait IDirect3DDevice_Impl: super::super::super::Foundation::IClosable_Impl {
    fn Trim(&self) -> windows_result::Result<()>;
}
...
impl IDirect3DSurface {
    pub fn Description(&self) -> windows_result::Result<Direct3DSurfaceDescription> {
        let this = self;
        unsafe {
...
pub trait IDirect3DSurface_Impl: super::super::super::Foundation::IClosable_Impl {
    fn Description(&self) -> windows_result::Result<Direct3DSurfaceDescription>;
}
