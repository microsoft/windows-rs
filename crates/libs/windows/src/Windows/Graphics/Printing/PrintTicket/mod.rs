...
windows_core::imp::required_hierarchy!(PrintTicketCapabilities, IPrintTicketCapabilities);
...
windows_core::imp::required_hierarchy!(PrintTicketFeature, IPrintTicketFeature);
...
windows_core::imp::required_hierarchy!(PrintTicketOption, IPrintTicketOption);
...
windows_core::imp::required_hierarchy!(PrintTicketParameterDefinition, IPrintTicketParameterDefinition);
...
windows_core::imp::required_hierarchy!(PrintTicketParameterInitializer, IPrintTicketParameterInitializer);
...
windows_core::imp::required_hierarchy!(PrintTicketValue, IPrintTicketValue);
...
windows_core::imp::required_hierarchy!(WorkflowPrintTicket, IWorkflowPrintTicket);
...
windows_core::imp::required_hierarchy!(WorkflowPrintTicketValidationResult, IWorkflowPrintTicketValidationResult);
