...
impl WorkflowPrintTicket {
    ...
    pub fn NotifyXmlChangedAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ValidateAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<WorkflowPrintTicketValidationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
