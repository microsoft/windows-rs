...
impl ServiceDevice {
    pub fn GetDeviceSelector(servicetype: ServiceDeviceType) -> windows_result::Result<windows_core::HSTRING> {
    ...
    pub fn GetDeviceSelectorFromServiceId(serviceid: windows_core::GUID) -> windows_result::Result<windows_core::HSTRING> {
        Self::IServiceDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IServiceDeviceStatics<R, F: FnOnce(&IServiceDeviceStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl StorageDevice {
    #[cfg(feature = "Storage_Search")]
    pub fn FromId(deviceid: &windows_core::HSTRING) -> windows_result::Result<super::super::Storage::StorageFolder> {
    ...
    fn IStorageDeviceStatics<R, F: FnOnce(&IStorageDeviceStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
