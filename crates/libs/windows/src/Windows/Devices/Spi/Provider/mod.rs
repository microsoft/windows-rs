...
impl ISpiControllerProvider {
    pub fn GetDeviceProvider<P0>(&self, settings: P0) -> windows_result::Result<ISpiDeviceProvider>
    where
...
pub trait ISpiControllerProvider_Impl: windows_core::IUnknownImpl {
    fn GetDeviceProvider(&self, settings: windows_core::Ref<ProviderSpiConnectionSettings>) -> windows_result::Result<ISpiDeviceProvider>;
}
...
impl ISpiDeviceProvider {
    ...
    pub fn ConnectionSettings(&self) -> windows_result::Result<ProviderSpiConnectionSettings> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Write(&self, buffer: &[u8]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn Read(&self, buffer: &mut [u8]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn TransferSequential(&self, writebuffer: &[u8], readbuffer: &mut [u8]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn TransferFullDuplex(&self, writebuffer: &[u8], readbuffer: &mut [u8]) -> windows_result::Result<()> {
        let this = self;
...
pub trait ISpiDeviceProvider_Impl: super::super::super::Foundation::IClosable_Impl {
    ...
    fn ConnectionSettings(&self) -> windows_result::Result<ProviderSpiConnectionSettings>;
    fn Write(&self, buffer: &[u8]) -> windows_result::Result<()>;
    fn Read(&self, buffer: &mut [u8]) -> windows_result::Result<()>;
    fn TransferSequential(&self, writeBuffer: &[u8], readBuffer: &mut [u8]) -> windows_result::Result<()>;
    fn TransferFullDuplex(&self, writeBuffer: &[u8], readBuffer: &mut [u8]) -> windows_result::Result<()>;
}
...
impl ISpiProvider {
    pub fn GetControllersAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<ISpiControllerProvider>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ISpiProvider_Impl: windows_core::IUnknownImpl {
    fn GetControllersAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<ISpiControllerProvider>>>;
}
...
impl ProviderSpiConnectionSettings {
    pub fn ChipSelectLine(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetChipSelectLine(&self, value: i32) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetChipSelectLine)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Mode(&self) -> windows_result::Result<ProviderSpiMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMode(&self, value: ProviderSpiMode) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DataBitLength(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDataBitLength(&self, value: i32) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDataBitLength)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ClockFrequency(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetClockFrequency(&self, value: i32) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetClockFrequency)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SharingMode(&self) -> windows_result::Result<ProviderSpiSharingMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSharingMode(&self, value: ProviderSpiSharingMode) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSharingMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Create(chipselectline: i32) -> windows_result::Result<ProviderSpiConnectionSettings> {
    ...
    fn IProviderSpiConnectionSettingsFactory<R, F: FnOnce(&IProviderSpiConnectionSettingsFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
