...
impl ISpiDeviceStatics {
    pub fn GetDeviceSelector(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
    ...
    pub fn GetDeviceSelectorFromFriendlyName(&self, friendlyname: &windows_core::HSTRING) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetBusInfo(&self, busid: &windows_core::HSTRING) -> windows_result::Result<SpiBusInfo> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FromIdAsync<P1>(&self, busid: &windows_core::HSTRING, settings: P1) -> windows_result::Result<windows_future::IAsyncOperation<SpiDevice>>
    where
...
pub trait ISpiDeviceStatics_Impl: windows_core::IUnknownImpl {
    fn GetDeviceSelector(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn GetDeviceSelectorFromFriendlyName(&self, friendlyName: &windows_core::HSTRING) -> windows_result::Result<windows_core::HSTRING>;
    fn GetBusInfo(&self, busId: &windows_core::HSTRING) -> windows_result::Result<SpiBusInfo>;
    fn FromIdAsync(&self, busId: &windows_core::HSTRING, settings: windows_core::Ref<SpiConnectionSettings>) -> windows_result::Result<windows_future::IAsyncOperation<SpiDevice>>;
}
...
impl SpiBusInfo {
    pub fn ChipSelectLineCount(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MinClockFrequency(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MaxClockFrequency(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SupportedDataBitLengths(&self) -> windows_result::Result<windows_collections::IVectorView<i32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SpiConnectionSettings {
    ...
    pub fn Mode(&self) -> windows_result::Result<SpiMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMode(&self, value: SpiMode) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SharingMode(&self) -> windows_result::Result<SpiSharingMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSharingMode(&self, value: SpiSharingMode) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSharingMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Create(chipselectline: i32) -> windows_result::Result<SpiConnectionSettings> {
    ...
    fn ISpiConnectionSettingsFactory<R, F: FnOnce(&ISpiConnectionSettingsFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl SpiController {
    pub fn GetDevice<P0>(&self, settings: P0) -> windows_result::Result<SpiDevice>
    where
    ...
    pub fn GetDefaultAsync() -> windows_result::Result<windows_future::IAsyncOperation<SpiController>> {
    ...
    #[cfg(feature = "Devices_Spi_Provider")]
    pub fn GetControllersAsync<P0>(provider: P0) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<SpiController>>>
    where
    ...
    fn ISpiControllerStatics<R, F: FnOnce(&ISpiControllerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl SpiDevice {
    ...
    pub fn ConnectionSettings(&self) -> windows_result::Result<SpiConnectionSettings> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDeviceSelectorFromFriendlyName(friendlyname: &windows_core::HSTRING) -> windows_result::Result<windows_core::HSTRING> {
        Self::ISpiDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDeviceSelectorFromFriendlyName)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(friendlyname), &mut result__).map(|| core::mem::transmute(result__))
        })
    }
    pub fn GetBusInfo(busid: &windows_core::HSTRING) -> windows_result::Result<SpiBusInfo> {
        Self::ISpiDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetBusInfo)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(busid), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn FromIdAsync<P1>(busid: &windows_core::HSTRING, settings: P1) -> windows_result::Result<windows_future::IAsyncOperation<SpiDevice>>
    where
        P1: windows_core::Param<SpiConnectionSettings>,
    {
        Self::ISpiDeviceStatics(|this| unsafe {
    ...
    fn ISpiDeviceStatics<R, F: FnOnce(&ISpiDeviceStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
