...
impl ISpiDeviceStatics {
    ...
    pub fn FromIdAsync<P1>(&self, busid: &windows_core::HSTRING, settings: P1) -> windows_core::Result<windows_async::IAsyncOperation<SpiDevice>>
    where
...
pub trait ISpiDeviceStatics_Impl: windows_core::IUnknownImpl {
    ...
    fn FromIdAsync(&self, busId: &windows_core::HSTRING, settings: windows_core::Ref<'_, SpiConnectionSettings>) -> windows_core::Result<windows_async::IAsyncOperation<SpiDevice>>;
}
...
impl SpiController {
    ...
    pub fn GetDefaultAsync() -> windows_core::Result<windows_async::IAsyncOperation<SpiController>> {
    ...
    #[cfg(feature = "Devices_Spi_Provider")]
    pub fn GetControllersAsync<P0>(provider: P0) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<SpiController>>>
    where
...
impl SpiDevice {
    ...
    pub fn FromIdAsync<P1>(busid: &windows_core::HSTRING, settings: P1) -> windows_core::Result<windows_async::IAsyncOperation<SpiDevice>>
    where
        P1: windows_core::Param<SpiConnectionSettings>,
    {
        Self::ISpiDeviceStatics(|this| unsafe {
