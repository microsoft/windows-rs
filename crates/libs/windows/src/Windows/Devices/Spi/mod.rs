...
windows_core::imp::required_hierarchy!(SpiBusInfo, ISpiBusInfo);
impl SpiBusInfo {
...
windows_core::imp::required_hierarchy!(SpiConnectionSettings, ISpiConnectionSettings, ISpiConnectionSettingsFactory);
...
windows_core::imp::required_hierarchy!(SpiController, ISpiController, ISpiControllerStatics);
impl SpiController {
...
windows_core::imp::required_hierarchy!(SpiDevice, ISpiDevice, ISpiDeviceStatics, super::super::Foundation::IClosable);
impl SpiDevice {
