...
impl InputHapticsManager {
        ...
        P1: windows_core::Param<SimpleHapticsController>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetOverrideHapticsController)(windows_core::Interface::as_raw(this), devicetype, core::mem::transmute_copy(&controller.param().borrow()), &mut result__).map(|| result__)
        }
    }
...
impl SimpleHapticsController {
    ...
    {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SendHapticFeedback)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&feedback.param().borrow())).ok() }
    }
    ...
    {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SendHapticFeedbackWithIntensity)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&feedback.param().borrow()), intensity).ok() }
    }
    ...
    {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SendHapticFeedbackForDuration)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&feedback.param().borrow()), intensity, playduration).ok() }
    }
    ...
    {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SendHapticFeedbackForPlayCount)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&feedback.param().borrow()), intensity, playcount, replaypauseinterval).ok() }
    }
}
