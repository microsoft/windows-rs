...
impl KnownSimpleHapticsControllerWaveforms {
    pub fn Click() -> Result<u16, windows_result::HRESULT> {
    ...
    fn IKnownSimpleHapticsControllerWaveformsStatics2<R, F: FnOnce(&IKnownSimpleHapticsControllerWaveformsStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl SimpleHapticsController {
    ...
    pub fn SupportedFeedback(&self) -> Result<windows_collections::IVectorView<SimpleHapticsControllerFeedback>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsIntensitySupported(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsPlayCountSupported(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsPlayDurationSupported(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsReplayPauseIntervalSupported(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StopFeedback(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).StopFeedback)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn SendHapticFeedback<P0>(&self, feedback: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn SendHapticFeedbackWithIntensity<P0>(&self, feedback: P0, intensity: f64) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<SimpleHapticsControllerFeedback>,
    {
        let this = self;
    ...
    pub fn SendHapticFeedbackForDuration<P0>(&self, feedback: P0, intensity: f64, playduration: super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<SimpleHapticsControllerFeedback>,
    {
        let this = self;
    ...
    pub fn SendHapticFeedbackForPlayCount<P0>(&self, feedback: P0, intensity: f64, playcount: i32, replaypauseinterval: super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<SimpleHapticsControllerFeedback>,
    {
        let this = self;
...
impl SimpleHapticsControllerFeedback {
    pub fn Waveform(&self) -> Result<u16, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VibrationDevice {
    ...
    pub fn SimpleHapticsController(&self) -> Result<SimpleHapticsController, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestAccessAsync() -> Result<windows_future::IAsyncOperation<VibrationAccessStatus>, windows_result::HRESULT> {
    ...
    pub fn FromIdAsync(deviceid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<VibrationDevice>, windows_result::HRESULT> {
        Self::IVibrationDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromIdAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(deviceid), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn GetDefaultAsync() -> Result<windows_future::IAsyncOperation<VibrationDevice>, windows_result::HRESULT> {
        Self::IVibrationDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAllAsync() -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<VibrationDevice>>, windows_result::HRESULT> {
        Self::IVibrationDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
