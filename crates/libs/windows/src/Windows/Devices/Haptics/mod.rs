...
windows_core::imp::required_hierarchy!(SimpleHapticsController, ISimpleHapticsController);
...
windows_core::imp::required_hierarchy!(SimpleHapticsControllerFeedback, ISimpleHapticsControllerFeedback);
