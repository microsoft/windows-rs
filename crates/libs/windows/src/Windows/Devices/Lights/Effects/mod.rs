...
pub trait ILampArrayEffect_Impl: windows_core::IUnknownImpl {
    fn ZIndex(&self) -> Result<i32, windows_result::HRESULT>;
    fn SetZIndex(&self, value: i32) -> Result<(), windows_result::HRESULT>;
}
impl ILampArrayEffect_Vtbl {
    pub const fn new<Identity: ILampArrayEffect_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ZIndex<Identity: ILampArrayEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut i32) -> windows_result::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn SetZIndex<Identity: ILampArrayEffect_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: i32) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl LampArrayBitmapEffect {
    ...
    pub fn SetDuration(&self, value: super::super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDuration)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn StartDelay(&self) -> Result<super::super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetStartDelay(&self, value: super::super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetStartDelay)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn UpdateInterval(&self) -> Result<super::super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetUpdateInterval(&self, value: super::super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetUpdateInterval)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SuggestedBitmapSize(&self) -> Result<super::super::super::Foundation::Size, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BitmapRequested<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveBitmapRequested(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveBitmapRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn CreateInstance<P0>(lamparray: P0, lampindexes: &[i32]) -> Result<LampArrayBitmapEffect, windows_result::HRESULT>
    where
    ...
    fn ILampArrayBitmapEffectFactory<R, F: FnOnce(&ILampArrayBitmapEffectFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl LampArrayBitmapRequestedEventArgs {
    pub fn SinceStarted(&self) -> Result<super::super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn UpdateBitmap<P0>(&self, bitmap: P0) -> Result<(), windows_result::HRESULT>
    where
...
impl LampArrayBlinkEffect {
    #[cfg(feature = "UI")]
    pub fn Color(&self) -> Result<super::super::super::UI::Color, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI")]
    pub fn SetColor(&self, value: super::super::super::UI::Color) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetColor)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AttackDuration(&self) -> Result<super::super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAttackDuration(&self, value: super::super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAttackDuration)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SustainDuration(&self) -> Result<super::super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSustainDuration(&self, value: super::super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSustainDuration)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DecayDuration(&self) -> Result<super::super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDecayDuration(&self, value: super::super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDecayDuration)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn RepetitionDelay(&self) -> Result<super::super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRepetitionDelay(&self, value: super::super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Occurrences(&self) -> Result<i32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOccurrences(&self, value: i32) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetOccurrences)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn RepetitionMode(&self) -> Result<LampArrayRepetitionMode, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRepetitionMode(&self, value: LampArrayRepetitionMode) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetRepetitionMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CreateInstance<P0>(lamparray: P0, lampindexes: &[i32]) -> Result<LampArrayBlinkEffect, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::LampArray>,
    {
    ...
    fn ILampArrayBlinkEffectFactory<R, F: FnOnce(&ILampArrayBlinkEffectFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl LampArrayColorRampEffect {
    ...
    pub fn RampDuration(&self) -> Result<super::super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRampDuration(&self, value: super::super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn CompletionBehavior(&self) -> Result<LampArrayEffectCompletionBehavior, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCompletionBehavior(&self, value: LampArrayEffectCompletionBehavior) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCompletionBehavior)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CreateInstance<P0>(lamparray: P0, lampindexes: &[i32]) -> Result<LampArrayColorRampEffect, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::LampArray>,
    {
    ...
    fn ILampArrayColorRampEffectFactory<R, F: FnOnce(&ILampArrayColorRampEffectFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl LampArrayCustomEffect {
    ...
    pub fn UpdateRequested<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveUpdateRequested(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveUpdateRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn CreateInstance<P0>(lamparray: P0, lampindexes: &[i32]) -> Result<LampArrayCustomEffect, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::LampArray>,
    {
    ...
    fn ILampArrayCustomEffectFactory<R, F: FnOnce(&ILampArrayCustomEffectFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl LampArrayEffectPlaylist {
    ...
    pub fn First(&self) -> Result<windows_collections::IIterator<ILampArrayEffect>, windows_result::HRESULT> {
    ...
    pub fn Append<P0>(&self, effect: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn OverrideZIndex(&self, zindex: i32) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn EffectStartMode(&self) -> Result<LampArrayEffectStartMode, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetEffectStartMode(&self, value: LampArrayEffectStartMode) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn StartAll<P0>(value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn StopAll<P0>(value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IIterable<LampArrayEffectPlaylist>>,
    {
    ...
    pub fn PauseAll<P0>(value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IIterable<LampArrayEffectPlaylist>>,
    {
    ...
    pub fn GetAt(&self, index: u32) -> Result<ILampArrayEffect, windows_result::HRESULT> {
    ...
    pub fn GetMany(&self, startindex: u32, items: &mut [Option<ILampArrayEffect>]) -> Result<u32, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<windows_collections::IVectorView<ILampArrayEffect>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn ILampArrayEffectPlaylistStatics<R, F: FnOnce(&ILampArrayEffectPlaylistStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl LampArraySolidEffect {
    ...
    pub fn CreateInstance<P0>(lamparray: P0, lampindexes: &[i32]) -> Result<LampArraySolidEffect, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::LampArray>,
    {
    ...
    fn ILampArraySolidEffectFactory<R, F: FnOnce(&ILampArraySolidEffectFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl LampArrayUpdateRequestedEventArgs {
    ...
    #[cfg(feature = "UI")]
    pub fn SetColor(&self, desiredcolor: super::super::super::UI::Color) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetColor)(windows_core::Interface::as_raw(this), desiredcolor).ok() }
    }
    #[cfg(feature = "UI")]
    pub fn SetColorForIndex(&self, lampindex: i32, desiredcolor: super::super::super::UI::Color) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetColorForIndex)(windows_core::Interface::as_raw(this), lampindex, desiredcolor).ok() }
    }
    #[cfg(feature = "UI")]
    pub fn SetSingleColorForIndices(&self, desiredcolor: super::super::super::UI::Color, lampindexes: &[i32]) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    #[cfg(feature = "UI")]
    pub fn SetColorsForIndices(&self, desiredcolors: &[super::super::super::UI::Color], lampindexes: &[i32]) -> Result<(), windows_result::HRESULT> {
        let this = self;
