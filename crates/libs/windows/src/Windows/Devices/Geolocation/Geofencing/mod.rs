...
windows_core::imp::required_hierarchy!(Geofence, IGeofence, IGeofenceFactory);
impl Geofence {
...
windows_core::imp::required_hierarchy!(GeofenceMonitor, IGeofenceMonitor, IGeofenceMonitorStatics);
...
windows_core::imp::required_hierarchy!(GeofenceStateChangeReport, IGeofenceStateChangeReport);
