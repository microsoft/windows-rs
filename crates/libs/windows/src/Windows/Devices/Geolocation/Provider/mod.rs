...
impl GeolocationProvider {
    ...
    pub fn IsOverridden(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
    ...
    pub fn SetOverridePosition(&self, newposition: super::BasicGeoposition, positionsource: super::PositionSource, accuracyinmeters: f64) -> windows_result::Result<LocationOverrideStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ClearOverridePosition(&self) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).ClearOverridePosition)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn IsOverriddenChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveIsOverriddenChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
