...
windows_core::imp::required_hierarchy!(GpioChangeCounter, IGpioChangeCounter, IGpioChangeCounterFactory, super::super::Foundation::IClosable);
...
windows_core::imp::required_hierarchy!(GpioChangeReader, IGpioChangeReader, IGpioChangeReaderFactory, super::super::Foundation::IClosable);
...
windows_core::imp::required_hierarchy!(GpioController, IGpioController, IGpioControllerStatics, IGpioControllerStatics2);
impl GpioController {
...
windows_core::imp::required_hierarchy!(GpioPin, IGpioPin, super::super::Foundation::IClosable);
impl GpioPin {
...
windows_core::imp::required_hierarchy!(GpioPinValueChangedEventArgs, IGpioPinValueChangedEventArgs);
