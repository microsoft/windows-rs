...
impl GpioChangeCounter {
    ...
    pub fn SetPolarity(&self, value: GpioChangePolarity) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetPolarity)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Polarity(&self) -> windows_result::Result<GpioChangePolarity> {
        let this = self;
        unsafe {
    ...
    pub fn IsStarted(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Read(&self) -> windows_result::Result<GpioChangeCount> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Reset(&self) -> windows_result::Result<GpioChangeCount> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Create<P0>(pin: P0) -> windows_result::Result<GpioChangeCounter>
    where
    ...
    fn IGpioChangeCounterFactory<R, F: FnOnce(&IGpioChangeCounterFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl GpioChangeReader {
    ...
    pub fn Capacity(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsEmpty(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsOverflowed(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetNextItem(&self) -> windows_result::Result<GpioChangeRecord> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PeekNextItem(&self) -> windows_result::Result<GpioChangeRecord> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAllItems(&self) -> windows_result::Result<windows_collections::IVector<GpioChangeRecord>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn WaitForItemsAsync(&self, count: i32) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Create<P0>(pin: P0) -> windows_result::Result<GpioChangeReader>
    where
        P0: windows_core::Param<GpioPin>,
    {
    ...
    pub fn CreateWithCapacity<P0>(pin: P0, mincapacity: i32) -> windows_result::Result<GpioChangeReader>
    where
        P0: windows_core::Param<GpioPin>,
    {
        Self::IGpioChangeReaderFactory(|this| unsafe {
    ...
    fn IGpioChangeReaderFactory<R, F: FnOnce(&IGpioChangeReaderFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl GpioController {
    ...
    pub fn OpenPin(&self, pinnumber: i32) -> windows_result::Result<GpioPin> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OpenPinWithSharingMode(&self, pinnumber: i32, sharingmode: GpioSharingMode) -> windows_result::Result<GpioPin> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryOpenPin(&self, pinnumber: i32, sharingmode: GpioSharingMode, pin: &mut Option<GpioPin>, openstatus: &mut GpioOpenStatus) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDefault() -> windows_result::Result<GpioController> {
    ...
    #[cfg(feature = "Devices_Gpio_Provider")]
    pub fn GetControllersAsync<P0>(provider: P0) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<GpioController>>>
    where
    ...
    pub fn GetDefaultAsync() -> windows_result::Result<windows_future::IAsyncOperation<GpioController>> {
        Self::IGpioControllerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IGpioControllerStatics<R, F: FnOnce(&IGpioControllerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<GpioController, IGpioControllerStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IGpioControllerStatics2<R, F: FnOnce(&IGpioControllerStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl GpioPin {
    ...
    pub fn ValueChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveValueChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveValueChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn DebounceTimeout(&self) -> windows_result::Result<super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDebounceTimeout(&self, value: super::super::Foundation::TimeSpan) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDebounceTimeout)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn PinNumber(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SharingMode(&self) -> windows_result::Result<GpioSharingMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsDriveModeSupported(&self, drivemode: GpioPinDriveMode) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDriveMode(&self) -> windows_result::Result<GpioPinDriveMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GpioPinValueChangedEventArgs {
    pub fn Edge(&self) -> windows_result::Result<GpioPinEdge> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
