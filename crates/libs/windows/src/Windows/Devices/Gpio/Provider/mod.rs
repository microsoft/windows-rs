...
impl GpioPinProviderValueChangedEventArgs {
    pub fn Edge(&self) -> Result<ProviderGpioPinEdge, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn Create(edge: ProviderGpioPinEdge) -> Result<GpioPinProviderValueChangedEventArgs, windows_result::HRESULT> {
    ...
    fn IGpioPinProviderValueChangedEventArgsFactory<R, F: FnOnce(&IGpioPinProviderValueChangedEventArgsFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl IGpioControllerProvider {
    ...
    pub fn OpenPinProvider(&self, pin: i32, sharingmode: ProviderGpioSharingMode) -> Result<IGpioPinProvider, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IGpioControllerProvider_Impl: windows_core::IUnknownImpl {
    ...
    fn OpenPinProvider(&self, pin: i32, sharingMode: ProviderGpioSharingMode) -> Result<IGpioPinProvider, windows_result::HRESULT>;
}
impl IGpioControllerProvider_Vtbl {
    pub const fn new<Identity: IGpioControllerProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn PinCount<Identity: IGpioControllerProvider_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut i32) -> windows_result::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn OpenPinProvider<Identity: IGpioControllerProvider_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pin: i32, sharingmode: ProviderGpioSharingMode, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IGpioPinProvider {
    ...
    pub fn DebounceTimeout(&self) -> Result<super::super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDebounceTimeout(&self, value: super::super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn SharingMode(&self) -> Result<ProviderGpioSharingMode, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsDriveModeSupported(&self, drivemode: ProviderGpioPinDriveMode) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDriveMode(&self) -> Result<ProviderGpioPinDriveMode, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDriveMode(&self, value: ProviderGpioPinDriveMode) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDriveMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Write(&self, value: ProviderGpioPinValue) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).Write)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Read(&self) -> Result<ProviderGpioPinValue, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IGpioPinProvider_Impl: windows_core::IUnknownImpl {
    fn ValueChanged(&self, handler: windows_core::Ref<'_, super::super::super::Foundation::TypedEventHandler<IGpioPinProvider, GpioPinProviderValueChangedEventArgs>>) -> Result<i64, windows_result::HRESULT>;
    fn RemoveValueChanged(&self, token: i64) -> Result<(), windows_result::HRESULT>;
    fn DebounceTimeout(&self) -> Result<super::super::super::Foundation::TimeSpan, windows_result::HRESULT>;
    fn SetDebounceTimeout(&self, value: &super::super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT>;
    fn PinNumber(&self) -> Result<i32, windows_result::HRESULT>;
    fn SharingMode(&self) -> Result<ProviderGpioSharingMode, windows_result::HRESULT>;
    fn IsDriveModeSupported(&self, driveMode: ProviderGpioPinDriveMode) -> Result<bool, windows_result::HRESULT>;
    fn GetDriveMode(&self) -> Result<ProviderGpioPinDriveMode, windows_result::HRESULT>;
    fn SetDriveMode(&self, value: ProviderGpioPinDriveMode) -> Result<(), windows_result::HRESULT>;
    fn Write(&self, value: ProviderGpioPinValue) -> Result<(), windows_result::HRESULT>;
    fn Read(&self) -> Result<ProviderGpioPinValue, windows_result::HRESULT>;
}
impl IGpioPinProvider_Vtbl {
    pub const fn new<Identity: IGpioPinProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ValueChanged<Identity: IGpioPinProvider_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, handler: *mut core::ffi::c_void, result__: *mut i64) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn RemoveValueChanged<Identity: IGpioPinProvider_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, token: i64) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGpioPinProvider_Impl::RemoveValueChanged(this, token).into()
            }
        }
        unsafe extern "system" fn DebounceTimeout<Identity: IGpioPinProvider_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut super::super::super::Foundation::TimeSpan) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetDebounceTimeout<Identity: IGpioPinProvider_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: super::super::super::Foundation::TimeSpan) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGpioPinProvider_Impl::SetDebounceTimeout(this, core::mem::transmute(&value)).into()
            }
        }
        unsafe extern "system" fn PinNumber<Identity: IGpioPinProvider_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut i32) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SharingMode<Identity: IGpioPinProvider_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut ProviderGpioSharingMode) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsDriveModeSupported<Identity: IGpioPinProvider_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, drivemode: ProviderGpioPinDriveMode, result__: *mut bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetDriveMode<Identity: IGpioPinProvider_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut ProviderGpioPinDriveMode) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetDriveMode<Identity: IGpioPinProvider_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: ProviderGpioPinDriveMode) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGpioPinProvider_Impl::SetDriveMode(this, value).into()
            }
        }
        unsafe extern "system" fn Write<Identity: IGpioPinProvider_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: ProviderGpioPinValue) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IGpioPinProvider_Impl::Write(this, value).into()
            }
        }
        unsafe extern "system" fn Read<Identity: IGpioPinProvider_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut ProviderGpioPinValue) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IGpioProvider {
    pub fn GetControllers(&self) -> Result<windows_collections::IVectorView<IGpioControllerProvider>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IGpioProvider_Impl: windows_core::IUnknownImpl {
    fn GetControllers(&self) -> Result<windows_collections::IVectorView<IGpioControllerProvider>, windows_result::HRESULT>;
}
impl IGpioProvider_Vtbl {
    pub const fn new<Identity: IGpioProvider_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetControllers<Identity: IGpioProvider_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
