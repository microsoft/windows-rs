...
impl GpioPinProviderValueChangedEventArgs {
    pub fn Edge(&self) -> windows_result::Result<ProviderGpioPinEdge> {
        let this = self;
        unsafe {
    ...
    pub fn Create(edge: ProviderGpioPinEdge) -> windows_result::Result<GpioPinProviderValueChangedEventArgs> {
    ...
    fn IGpioPinProviderValueChangedEventArgsFactory<R, F: FnOnce(&IGpioPinProviderValueChangedEventArgsFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl IGpioControllerProvider {
    ...
    pub fn OpenPinProvider(&self, pin: i32, sharingmode: ProviderGpioSharingMode) -> windows_result::Result<IGpioPinProvider> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IGpioControllerProvider_Impl: windows_core::IUnknownImpl {
    ...
    fn OpenPinProvider(&self, pin: i32, sharingMode: ProviderGpioSharingMode) -> windows_result::Result<IGpioPinProvider>;
}
...
impl IGpioPinProvider {
    ...
    pub fn DebounceTimeout(&self) -> windows_result::Result<super::super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDebounceTimeout(&self, value: super::super::super::Foundation::TimeSpan) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SharingMode(&self) -> windows_result::Result<ProviderGpioSharingMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsDriveModeSupported(&self, drivemode: ProviderGpioPinDriveMode) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDriveMode(&self) -> windows_result::Result<ProviderGpioPinDriveMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDriveMode(&self, value: ProviderGpioPinDriveMode) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDriveMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Write(&self, value: ProviderGpioPinValue) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).Write)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Read(&self) -> windows_result::Result<ProviderGpioPinValue> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IGpioPinProvider_Impl: windows_core::IUnknownImpl {
    fn ValueChanged(&self, handler: windows_core::Ref<super::super::super::Foundation::TypedEventHandler<IGpioPinProvider, GpioPinProviderValueChangedEventArgs>>) -> windows_result::Result<i64>;
    fn RemoveValueChanged(&self, token: i64) -> windows_result::Result<()>;
    fn DebounceTimeout(&self) -> windows_result::Result<super::super::super::Foundation::TimeSpan>;
    fn SetDebounceTimeout(&self, value: &super::super::super::Foundation::TimeSpan) -> windows_result::Result<()>;
    fn PinNumber(&self) -> windows_result::Result<i32>;
    fn SharingMode(&self) -> windows_result::Result<ProviderGpioSharingMode>;
    fn IsDriveModeSupported(&self, driveMode: ProviderGpioPinDriveMode) -> windows_result::Result<bool>;
    fn GetDriveMode(&self) -> windows_result::Result<ProviderGpioPinDriveMode>;
    fn SetDriveMode(&self, value: ProviderGpioPinDriveMode) -> windows_result::Result<()>;
    fn Write(&self, value: ProviderGpioPinValue) -> windows_result::Result<()>;
    fn Read(&self) -> windows_result::Result<ProviderGpioPinValue>;
}
...
impl IGpioProvider {
    pub fn GetControllers(&self) -> windows_result::Result<windows_collections::IVectorView<IGpioControllerProvider>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IGpioProvider_Impl: windows_core::IUnknownImpl {
    fn GetControllers(&self) -> windows_result::Result<windows_collections::IVectorView<IGpioControllerProvider>>;
}
