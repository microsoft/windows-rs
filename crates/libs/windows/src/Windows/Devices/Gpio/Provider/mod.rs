...
windows_core::imp::required_hierarchy!(GpioPinProviderValueChangedEventArgs, IGpioPinProviderValueChangedEventArgs, IGpioPinProviderValueChangedEventArgsFactory);
