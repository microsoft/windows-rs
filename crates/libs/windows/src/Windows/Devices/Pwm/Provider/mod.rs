...
impl IPwmControllerProvider {
    pub fn PinCount(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
    ...
    pub fn ActualFrequency(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDesiredFrequency(&self, frequency: f64) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MaxFrequency(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MinFrequency(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPwmControllerProvider_Impl: windows_core::IUnknownImpl {
    fn PinCount(&self) -> windows_result::Result<i32>;
    fn ActualFrequency(&self) -> windows_result::Result<f64>;
    fn SetDesiredFrequency(&self, frequency: f64) -> windows_result::Result<f64>;
    fn MaxFrequency(&self) -> windows_result::Result<f64>;
    fn MinFrequency(&self) -> windows_result::Result<f64>;
    fn AcquirePin(&self, pin: i32) -> windows_result::Result<()>;
    fn ReleasePin(&self, pin: i32) -> windows_result::Result<()>;
    fn EnablePin(&self, pin: i32) -> windows_result::Result<()>;
    fn DisablePin(&self, pin: i32) -> windows_result::Result<()>;
    fn SetPulseParameters(&self, pin: i32, dutyCycle: f64, invertPolarity: bool) -> windows_result::Result<()>;
}
...
impl IPwmProvider {
    pub fn GetControllers(&self) -> windows_result::Result<windows_collections::IVectorView<IPwmControllerProvider>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPwmProvider_Impl: windows_core::IUnknownImpl {
    fn GetControllers(&self) -> windows_result::Result<windows_collections::IVectorView<IPwmControllerProvider>>;
}
