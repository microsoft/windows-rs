...
impl IPwmControllerProviderVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IPwmControllerProviderImpl, const OFFSET: isize>() -> IPwmControllerProviderVtbl {
        ...
        Self(
            ...
            PinCount::<Impl, OFFSET>,
            ActualFrequency::<Impl, OFFSET>,
            SetDesiredFrequency::<Impl, OFFSET>,
            MaxFrequency::<Impl, OFFSET>,
            MinFrequency::<Impl, OFFSET>,
            AcquirePin::<Impl, OFFSET>,
            ReleasePin::<Impl, OFFSET>,
            EnablePin::<Impl, OFFSET>,
            DisablePin::<Impl, OFFSET>,
            SetPulseParameters::<Impl, OFFSET>,
        )
    }
}
...
impl IPwmProviderVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IPwmProviderImpl, const OFFSET: isize>() -> IPwmProviderVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IPwmProvider>, ::windows::core::GetTrustLevel, GetControllers::<Impl, OFFSET>)
    }
}
