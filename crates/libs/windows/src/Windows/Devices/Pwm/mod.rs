...
impl PwmController {
    ...
    pub fn SetDesiredFrequency(&self, desiredfrequency: f64) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OpenPin(&self, pinnumber: i32) -> windows_result::Result<PwmPin> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_Pwm_Provider")]
    pub fn GetControllersAsync<P0>(provider: P0) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<PwmController>>>
    where
    ...
    pub fn GetDefaultAsync() -> windows_result::Result<windows_future::IAsyncOperation<PwmController>> {
    ...
    pub fn FromIdAsync(deviceid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<PwmController>> {
        Self::IPwmControllerStatics3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromIdAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(deviceid), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IPwmControllerStatics<R, F: FnOnce(&IPwmControllerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PwmController, IPwmControllerStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IPwmControllerStatics2<R, F: FnOnce(&IPwmControllerStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<PwmController, IPwmControllerStatics2> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IPwmControllerStatics3<R, F: FnOnce(&IPwmControllerStatics3) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl PwmPin {
    ...
    pub fn Controller(&self) -> windows_result::Result<PwmController> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetActiveDutyCyclePercentage(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetActiveDutyCyclePercentage(&self, dutycyclepercentage: f64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn Polarity(&self) -> windows_result::Result<PwmPulsePolarity> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPolarity(&self, value: PwmPulsePolarity) -> windows_result::Result<()> {
        let this = self;
