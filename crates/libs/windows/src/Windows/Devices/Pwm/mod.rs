...
windows_core::imp::required_hierarchy!(PwmController, IPwmController, IPwmControllerStatics, IPwmControllerStatics2, IPwmControllerStatics3);
impl PwmController {
...
windows_core::imp::required_hierarchy!(PwmPin, IPwmPin, super::super::Foundation::IClosable);
impl PwmPin {
