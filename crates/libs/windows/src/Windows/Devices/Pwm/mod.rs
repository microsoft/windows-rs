...
impl PwmController {
    ...
    #[cfg(feature = "Devices_Pwm_Provider")]
    pub fn GetControllersAsync<P0>(provider: P0) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<PwmController>>>
    where
    ...
    pub fn GetDefaultAsync() -> windows_core::Result<windows_async::IAsyncOperation<PwmController>> {
    ...
    pub fn FromIdAsync(deviceid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<PwmController>> {
        Self::IPwmControllerStatics3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
