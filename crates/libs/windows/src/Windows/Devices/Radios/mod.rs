...
impl Radio {
    pub fn SetStateAsync(&self, value: RadioState) -> windows_result::Result<windows_future::IAsyncOperation<RadioAccessStatus>> {
        let this = self;
        unsafe {
    ...
    pub fn State(&self) -> windows_result::Result<RadioState> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Kind(&self) -> windows_result::Result<RadioKind> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetRadiosAsync() -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<Radio>>> {
    ...
    pub fn FromIdAsync(deviceid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<Radio>> {
        Self::IRadioStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromIdAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(deviceid), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn RequestAccessAsync() -> windows_result::Result<windows_future::IAsyncOperation<RadioAccessStatus>> {
        Self::IRadioStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IRadioStatics<R, F: FnOnce(&IRadioStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
