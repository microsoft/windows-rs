...
impl Radio {
    pub fn SetStateAsync(&self, value: RadioState) -> windows_core::Result<windows_async::IAsyncOperation<RadioAccessStatus>> {
        let this = self;
        unsafe {
    ...
    pub fn GetRadiosAsync() -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<Radio>>> {
    ...
    pub fn FromIdAsync(deviceid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<Radio>> {
        Self::IRadioStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromIdAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(deviceid), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn RequestAccessAsync() -> windows_core::Result<windows_async::IAsyncOperation<RadioAccessStatus>> {
        Self::IRadioStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
