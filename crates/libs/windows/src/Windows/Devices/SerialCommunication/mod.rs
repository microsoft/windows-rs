...
impl ErrorReceivedEventArgs {
    ...
    pub fn Error(&self) -> ::windows::core::Result<SerialError> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<SerialError>::uninit();
...
impl PinChangedEventArgs {
    ...
    pub fn PinChange(&self) -> ::windows::core::Result<SerialPinChange> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<SerialPinChange>::uninit();
...
impl SerialDevice {
    ...
    pub fn Handshake(&self) -> ::windows::core::Result<SerialHandshake> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<SerialHandshake>::uninit();
    ...
    pub fn Parity(&self) -> ::windows::core::Result<SerialParity> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<SerialParity>::uninit();
    ...
    pub fn StopBits(&self) -> ::windows::core::Result<SerialStopBitCount> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<SerialStopBitCount>::uninit();
