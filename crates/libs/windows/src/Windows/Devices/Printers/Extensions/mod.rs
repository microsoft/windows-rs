...
windows_core::imp::required_hierarchy!(Print3DWorkflow, IPrint3DWorkflow, IPrint3DWorkflow2);
...
windows_core::imp::required_hierarchy!(Print3DWorkflowPrintRequestedEventArgs, IPrint3DWorkflowPrintRequestedEventArgs);
...
windows_core::imp::required_hierarchy!(Print3DWorkflowPrinterChangedEventArgs, IPrint3DWorkflowPrinterChangedEventArgs);
...
windows_core::imp::required_hierarchy!(PrintNotificationEventDetails, IPrintNotificationEventDetails);
...
windows_core::imp::required_hierarchy!(PrintTaskConfiguration, IPrintTaskConfiguration);
...
windows_core::imp::required_hierarchy!(PrintTaskConfigurationSaveRequest, IPrintTaskConfigurationSaveRequest);
...
windows_core::imp::required_hierarchy!(PrintTaskConfigurationSaveRequestedDeferral, IPrintTaskConfigurationSaveRequestedDeferral);
...
windows_core::imp::required_hierarchy!(PrintTaskConfigurationSaveRequestedEventArgs, IPrintTaskConfigurationSaveRequestedEventArgs);
