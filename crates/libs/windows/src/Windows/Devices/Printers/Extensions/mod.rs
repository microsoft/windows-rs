...
impl Print3DWorkflow {
    ...
    pub fn GetPrintModelPackage(&self) -> Result<windows_core::IInspectable, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsPrintReady(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsPrintReady(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsPrintReady)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn PrintRequested<P0>(&self, eventhandler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemovePrintRequested(&self, eventcookie: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePrintRequested)(windows_core::Interface::as_raw(this), eventcookie).ok() }
    }
    pub fn PrinterChanged<P0>(&self, eventhandler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemovePrinterChanged(&self, eventcookie: i64) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IPrint3DWorkflow2>(self)?;
...
impl Print3DWorkflowPrintRequestedEventArgs {
    pub fn Status(&self) -> Result<Print3DWorkflowStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetExtendedStatus(&self, value: Print3DWorkflowDetail) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn SetSourceChanged(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl Print3DWorkflowPrinterChangedEventArgs {
    pub fn NewDeviceId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PrintExtensionContext {
    pub fn FromDeviceId(deviceid: &windows_core::HSTRING) -> Result<windows_core::IInspectable, windows_result::HRESULT> {
    ...
    fn IPrintExtensionContextStatic<R, F: FnOnce(&IPrintExtensionContextStatic) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl PrintNotificationEventDetails {
    ...
    pub fn EventData(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetEventData(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl PrintTaskConfiguration {
    pub fn PrinterExtensionContext(&self) -> Result<windows_core::IInspectable, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SaveRequested<P0>(&self, eventhandler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveSaveRequested(&self, eventcookie: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl PrintTaskConfigurationSaveRequest {
    ...
    pub fn Save<P0>(&self, printerextensioncontext: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IInspectable>,
    {
        let this = self;
    ...
    pub fn GetDeferral(&self) -> Result<PrintTaskConfigurationSaveRequestedDeferral, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Deadline(&self) -> Result<super::super::super::Foundation::DateTime, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PrintTaskConfigurationSaveRequestedEventArgs {
    pub fn Request(&self) -> Result<PrintTaskConfigurationSaveRequest, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
