...
impl IppAttributeError {
    ...
    pub fn Reason(&self) -> ::windows::core::Result<IppAttributeErrorReason> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<IppAttributeErrorReason>::uninit();
...
impl IppAttributeValue {
    ...
    pub fn Kind(&self) -> ::windows::core::Result<IppAttributeValueKind> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<IppAttributeValueKind>::uninit();
...
impl IppResolution {
    ...
    pub fn Unit(&self) -> ::windows::core::Result<IppResolutionUnit> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<IppResolutionUnit>::uninit();
