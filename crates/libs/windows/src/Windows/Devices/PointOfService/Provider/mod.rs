...
impl BarcodeScannerDisableScannerRequest {
    ...
    pub fn ReportFailedWithFailedReasonAsync(&self, reason: i32) -> windows_result::Result<windows_future::IAsyncAction> {
    ...
    pub fn ReportFailedWithFailedReasonAndDescriptionAsync(&self, reason: i32, failedreasondescription: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = &windows_core::Interface::cast::<IBarcodeScannerDisableScannerRequest2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl BarcodeScannerDisableScannerRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<BarcodeScannerDisableScannerRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl BarcodeScannerEnableScannerRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<BarcodeScannerEnableScannerRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl BarcodeScannerFrameReader {
    pub fn StartAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryAcquireLatestFrameAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<BarcodeScannerVideoFrame>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Connection(&self) -> windows_result::Result<BarcodeScannerProviderConnection> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FrameArrived<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveFrameArrived(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
...
impl BarcodeScannerGetSymbologyAttributesRequest {
    pub fn Symbology(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReportCompletedAsync<P0>(&self, attributes: P0) -> windows_result::Result<windows_future::IAsyncAction>
    where
...
impl BarcodeScannerGetSymbologyAttributesRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<BarcodeScannerGetSymbologyAttributesRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl BarcodeScannerHideVideoPreviewRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<BarcodeScannerHideVideoPreviewRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl BarcodeScannerProviderConnection {
    ...
    pub fn VideoDeviceId(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SupportedSymbologies(&self) -> windows_result::Result<windows_collections::IVector<u32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CompanyName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCompanyName(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn ReportScannedDataAsync<P0>(&self, report: P0) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    pub fn ReportTriggerStateAsync(&self, state: BarcodeScannerTriggerState) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReportErrorAsync<P0>(&self, errordata: P0) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    pub fn ReportErrorAsyncWithScanReport<P0, P2>(&self, errordata: P0, isretriable: bool, scanreport: P2) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<super::UnifiedPosErrorData>,
    ...
    pub fn EnableScannerRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveEnableScannerRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveEnableScannerRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn DisableScannerRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveDisableScannerRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveDisableScannerRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn SetActiveSymbologiesRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveSetActiveSymbologiesRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn StartSoftwareTriggerRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveStartSoftwareTriggerRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn StopSoftwareTriggerRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveStopSoftwareTriggerRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveStopSoftwareTriggerRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GetBarcodeSymbologyAttributesRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveGetBarcodeSymbologyAttributesRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetBarcodeSymbologyAttributesRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveSetBarcodeSymbologyAttributesRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn HideVideoPreviewRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveHideVideoPreviewRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveHideVideoPreviewRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn CreateFrameReaderAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<BarcodeScannerFrameReader>> {
    ...
    pub fn CreateFrameReaderWithFormatAsync(&self, preferredformat: super::super::super::Graphics::Imaging::BitmapPixelFormat) -> windows_result::Result<windows_future::IAsyncOperation<BarcodeScannerFrameReader>> {
        let this = &windows_core::Interface::cast::<IBarcodeScannerProviderConnection2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn CreateFrameReaderWithFormatAndSizeAsync(&self, preferredformat: super::super::super::Graphics::Imaging::BitmapPixelFormat, preferredsize: super::super::super::Graphics::Imaging::BitmapSize) -> windows_result::Result<windows_future::IAsyncOperation<BarcodeScannerFrameReader>> {
        let this = &windows_core::Interface::cast::<IBarcodeScannerProviderConnection2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl BarcodeScannerSetActiveSymbologiesRequest {
    pub fn Symbologies(&self) -> windows_result::Result<windows_collections::IVectorView<u32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl BarcodeScannerSetActiveSymbologiesRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<BarcodeScannerSetActiveSymbologiesRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl BarcodeScannerSetSymbologyAttributesRequest {
    ...
    pub fn Attributes(&self) -> windows_result::Result<super::BarcodeSymbologyAttributes> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl BarcodeScannerSetSymbologyAttributesRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<BarcodeScannerSetSymbologyAttributesRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl BarcodeScannerStartSoftwareTriggerRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<BarcodeScannerStartSoftwareTriggerRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl BarcodeScannerStopSoftwareTriggerRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<BarcodeScannerStopSoftwareTriggerRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl BarcodeScannerVideoFrame {
    #[cfg(feature = "Graphics_Imaging")]
    pub fn Format(&self) -> windows_result::Result<super::super::super::Graphics::Imaging::BitmapPixelFormat> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PixelData(&self) -> windows_result::Result<super::super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl BarcodeSymbologyAttributesBuilder {
    ...
    pub fn IsCheckDigitValidationSupported(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsCheckDigitValidationSupported(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsCheckDigitValidationSupported)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsCheckDigitTransmissionSupported(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsCheckDigitTransmissionSupported(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn IsDecodeLengthSupported(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsDecodeLengthSupported(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsDecodeLengthSupported)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CreateAttributes(&self) -> windows_result::Result<super::BarcodeSymbologyAttributes> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
