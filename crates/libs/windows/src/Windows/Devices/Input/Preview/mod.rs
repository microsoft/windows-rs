...
impl GazeDevicePreview {
    ...
    pub fn CanTrackEyes(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanTrackHead(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ConfigurationState(&self) -> Result<GazeDeviceConfigurationStatePreview, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestCalibrationAsync(&self) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetNumericControlDescriptions(&self, usagepage: u16, usageid: u16) -> Result<windows_collections::IVectorView<super::super::HumanInterfaceDevice::HidNumericControlDescription>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_HumanInterfaceDevice")]
    pub fn GetBooleanControlDescriptions(&self, usagepage: u16, usageid: u16) -> Result<windows_collections::IVectorView<super::super::HumanInterfaceDevice::HidBooleanControlDescription>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GazeDeviceWatcherAddedPreviewEventArgs {
    pub fn Device(&self) -> Result<GazeDevicePreview, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GazeEnteredPreviewEventArgs {
    ...
    pub fn CurrentPoint(&self) -> Result<GazePointPreview, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GazeInputSourcePreview {
    pub fn GazeMoved<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveGazeMoved(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveGazeMoved)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GazeEntered<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveGazeEntered(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveGazeEntered)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GazeExited<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveGazeExited(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveGazeExited)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GetForCurrentView() -> Result<GazeInputSourcePreview, windows_result::HRESULT> {
        Self::IGazeInputSourcePreviewStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForCurrentView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn CreateWatcher() -> Result<GazeDeviceWatcherPreview, windows_result::HRESULT> {
        Self::IGazeInputSourcePreviewStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IGazeInputSourcePreviewStatics<R, F: FnOnce(&IGazeInputSourcePreviewStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl GazeMovedPreviewEventArgs {
    ...
    pub fn GetIntermediatePoints(&self) -> Result<windows_collections::IVector<GazePointPreview>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GazePointPreview {
    pub fn SourceDevice(&self) -> Result<GazeDevicePreview, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EyeGazePosition(&self) -> Result<super::super::super::Foundation::IReference<super::super::super::Foundation::Point>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HeadGazePosition(&self) -> Result<super::super::super::Foundation::IReference<super::super::super::Foundation::Point>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_HumanInterfaceDevice")]
    pub fn HidInputReport(&self) -> Result<super::super::HumanInterfaceDevice::HidInputReport, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
