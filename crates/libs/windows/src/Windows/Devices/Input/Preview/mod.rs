...
windows_core::imp::required_hierarchy!(GazeDevicePreview, IGazeDevicePreview);
...
windows_core::imp::required_hierarchy!(GazeDeviceWatcherAddedPreviewEventArgs, IGazeDeviceWatcherAddedPreviewEventArgs);
...
windows_core::imp::required_hierarchy!(GazeDeviceWatcherPreview, IGazeDeviceWatcherPreview);
...
windows_core::imp::required_hierarchy!(GazeDeviceWatcherRemovedPreviewEventArgs, IGazeDeviceWatcherRemovedPreviewEventArgs);
...
windows_core::imp::required_hierarchy!(GazeDeviceWatcherUpdatedPreviewEventArgs, IGazeDeviceWatcherUpdatedPreviewEventArgs);
...
windows_core::imp::required_hierarchy!(GazeEnteredPreviewEventArgs, IGazeEnteredPreviewEventArgs);
...
windows_core::imp::required_hierarchy!(GazeExitedPreviewEventArgs, IGazeExitedPreviewEventArgs);
...
windows_core::imp::required_hierarchy!(GazeInputSourcePreview, IGazeInputSourcePreview, IGazeInputSourcePreviewStatics);
...
windows_core::imp::required_hierarchy!(GazeMovedPreviewEventArgs, IGazeMovedPreviewEventArgs);
...
windows_core::imp::required_hierarchy!(GazePointPreview, IGazePointPreview);
