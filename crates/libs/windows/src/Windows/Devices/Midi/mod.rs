...
impl IMidiMessage {
    pub fn Timestamp(&self) -> windows_result::Result<super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
    ...
    pub fn Type(&self) -> windows_result::Result<MidiMessageType> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IMidiMessage_Impl: windows_core::IUnknownImpl {
    fn Timestamp(&self) -> windows_result::Result<super::super::Foundation::TimeSpan>;
    fn RawData(&self) -> windows_result::Result<super::super::Storage::Streams::IBuffer>;
    fn Type(&self) -> windows_result::Result<MidiMessageType>;
}
#[cfg(feature = "Storage_Streams")]
...
impl IMidiOutPort {
    pub fn SendMessage<P0>(&self, midimessage: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SendBuffer<P0>(&self, mididata: P0) -> windows_result::Result<()>
    where
...
pub trait IMidiOutPort_Impl: super::super::Foundation::IClosable_Impl {
    fn SendMessage(&self, midiMessage: windows_core::Ref<IMidiMessage>) -> windows_result::Result<()>;
    fn SendBuffer(&self, midiData: windows_core::Ref<super::super::Storage::Streams::IBuffer>) -> windows_result::Result<()>;
    fn DeviceId(&self) -> windows_result::Result<windows_core::HSTRING>;
}
#[cfg(feature = "Storage_Streams")]
...
impl MidiChannelPressureMessage {
    pub fn Channel(&self) -> windows_result::Result<u8> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Pressure(&self) -> windows_result::Result<u8> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateMidiChannelPressureMessage(channel: u8, pressure: u8) -> windows_result::Result<MidiChannelPressureMessage> {
    ...
    fn IMidiChannelPressureMessageFactory<R, F: FnOnce(&IMidiChannelPressureMessageFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl MidiControlChangeMessage {
    ...
    pub fn Controller(&self) -> windows_result::Result<u8> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ControlValue(&self) -> windows_result::Result<u8> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateMidiControlChangeMessage(channel: u8, controller: u8, controlvalue: u8) -> windows_result::Result<MidiControlChangeMessage> {
    ...
    fn IMidiControlChangeMessageFactory<R, F: FnOnce(&IMidiControlChangeMessageFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl MidiInPort {
    ...
    pub fn FromIdAsync(deviceid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<MidiInPort>> {
    ...
    fn IMidiInPortStatics<R, F: FnOnce(&IMidiInPortStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl MidiMessageReceivedEventArgs {
    pub fn Message(&self) -> windows_result::Result<IMidiMessage> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MidiNoteOffMessage {
    ...
    pub fn Note(&self) -> windows_result::Result<u8> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Velocity(&self) -> windows_result::Result<u8> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateMidiNoteOffMessage(channel: u8, note: u8, velocity: u8) -> windows_result::Result<MidiNoteOffMessage> {
    ...
    fn IMidiNoteOffMessageFactory<R, F: FnOnce(&IMidiNoteOffMessageFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl MidiNoteOnMessage {
    ...
    pub fn CreateMidiNoteOnMessage(channel: u8, note: u8, velocity: u8) -> windows_result::Result<MidiNoteOnMessage> {
    ...
    fn IMidiNoteOnMessageFactory<R, F: FnOnce(&IMidiNoteOnMessageFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl MidiOutPort {
    ...
    pub fn FromIdAsync(deviceid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<IMidiOutPort>> {
    ...
    fn IMidiOutPortStatics<R, F: FnOnce(&IMidiOutPortStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl MidiPitchBendChangeMessage {
    ...
    pub fn Bend(&self) -> windows_result::Result<u16> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateMidiPitchBendChangeMessage(channel: u8, bend: u16) -> windows_result::Result<MidiPitchBendChangeMessage> {
    ...
    fn IMidiPitchBendChangeMessageFactory<R, F: FnOnce(&IMidiPitchBendChangeMessageFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl MidiPolyphonicKeyPressureMessage {
    ...
    pub fn CreateMidiPolyphonicKeyPressureMessage(channel: u8, note: u8, pressure: u8) -> windows_result::Result<MidiPolyphonicKeyPressureMessage> {
    ...
    fn IMidiPolyphonicKeyPressureMessageFactory<R, F: FnOnce(&IMidiPolyphonicKeyPressureMessageFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl MidiProgramChangeMessage {
    ...
    pub fn Program(&self) -> windows_result::Result<u8> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateMidiProgramChangeMessage(channel: u8, program: u8) -> windows_result::Result<MidiProgramChangeMessage> {
    ...
    fn IMidiProgramChangeMessageFactory<R, F: FnOnce(&IMidiProgramChangeMessageFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl MidiSongPositionPointerMessage {
    ...
    pub fn Beats(&self) -> windows_result::Result<u16> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateMidiSongPositionPointerMessage(beats: u16) -> windows_result::Result<MidiSongPositionPointerMessage> {
    ...
    fn IMidiSongPositionPointerMessageFactory<R, F: FnOnce(&IMidiSongPositionPointerMessageFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl MidiSongSelectMessage {
    ...
    pub fn Song(&self) -> windows_result::Result<u8> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateMidiSongSelectMessage(song: u8) -> windows_result::Result<MidiSongSelectMessage> {
    ...
    fn IMidiSongSelectMessageFactory<R, F: FnOnce(&IMidiSongSelectMessageFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl MidiSynthesizer {
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub fn AudioDevice(&self) -> windows_result::Result<super::Enumeration::DeviceInformation> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetVolume(&self, value: f64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetVolume)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CreateAsync() -> windows_result::Result<windows_future::IAsyncOperation<MidiSynthesizer>> {
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub fn CreateFromAudioDeviceAsync<P0>(audiodevice: P0) -> windows_result::Result<windows_future::IAsyncOperation<MidiSynthesizer>>
    where
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub fn IsSynthesizer<P0>(mididevice: P0) -> windows_result::Result<bool>
    where
        P0: windows_core::Param<super::Enumeration::DeviceInformation>,
    {
        Self::IMidiSynthesizerStatics(|this| unsafe {
    ...
    fn IMidiSynthesizerStatics<R, F: FnOnce(&IMidiSynthesizerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl MidiSystemExclusiveMessage {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateMidiSystemExclusiveMessage<P0>(rawdata: P0) -> windows_result::Result<MidiSystemExclusiveMessage>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
    ...
    fn IMidiSystemExclusiveMessageFactory<R, F: FnOnce(&IMidiSystemExclusiveMessageFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl MidiTimeCodeMessage {
    ...
    pub fn FrameType(&self) -> windows_result::Result<u8> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Values(&self) -> windows_result::Result<u8> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateMidiTimeCodeMessage(frametype: u8, values: u8) -> windows_result::Result<MidiTimeCodeMessage> {
    ...
    fn IMidiTimeCodeMessageFactory<R, F: FnOnce(&IMidiTimeCodeMessageFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
