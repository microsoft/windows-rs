...
windows_core::imp::required_hierarchy!(MidiChannelPressureMessage, IMidiChannelPressureMessage, IMidiChannelPressureMessageFactory, IMidiMessage);
...
windows_core::imp::required_hierarchy!(MidiControlChangeMessage, IMidiControlChangeMessage, IMidiControlChangeMessageFactory, IMidiMessage);
...
windows_core::imp::required_hierarchy!(MidiInPort, IMidiInPort, IMidiInPortStatics, super::super::Foundation::IClosable);
impl MidiInPort {
...
windows_core::imp::required_hierarchy!(MidiMessageReceivedEventArgs, IMidiMessageReceivedEventArgs);
...
windows_core::imp::required_hierarchy!(MidiNoteOffMessage, IMidiMessage, IMidiNoteOffMessage, IMidiNoteOffMessageFactory);
...
windows_core::imp::required_hierarchy!(MidiNoteOnMessage, IMidiMessage, IMidiNoteOnMessage, IMidiNoteOnMessageFactory);
...
windows_core::imp::required_hierarchy!(MidiOutPort, IMidiOutPort, IMidiOutPortStatics, super::super::Foundation::IClosable);
impl MidiOutPort {
    pub fn SendMessage<P0>(&self, midimessage: P0) -> windows_core::Result<()>
    where
        P0: windows_core::Param<IMidiMessage>,
...
windows_core::imp::required_hierarchy!(MidiPitchBendChangeMessage, IMidiMessage, IMidiPitchBendChangeMessage, IMidiPitchBendChangeMessageFactory);
...
windows_core::imp::required_hierarchy!(MidiPolyphonicKeyPressureMessage, IMidiMessage, IMidiPolyphonicKeyPressureMessage, IMidiPolyphonicKeyPressureMessageFactory);
...
windows_core::imp::required_hierarchy!(MidiProgramChangeMessage, IMidiMessage, IMidiProgramChangeMessage, IMidiProgramChangeMessageFactory);
...
windows_core::imp::required_hierarchy!(MidiSongPositionPointerMessage, IMidiMessage, IMidiSongPositionPointerMessage, IMidiSongPositionPointerMessageFactory);
...
windows_core::imp::required_hierarchy!(MidiSongSelectMessage, IMidiMessage, IMidiSongSelectMessage, IMidiSongSelectMessageFactory);
...
windows_core::imp::required_hierarchy!(MidiSynthesizer, IMidiOutPort, IMidiSynthesizer, IMidiSynthesizerStatics, super::super::Foundation::IClosable);
...
windows_core::imp::required_hierarchy!(MidiSystemExclusiveMessage, IMidiMessage, IMidiSystemExclusiveMessageFactory);
...
windows_core::imp::required_hierarchy!(MidiTimeCodeMessage, IMidiMessage, IMidiTimeCodeMessage, IMidiTimeCodeMessageFactory);
