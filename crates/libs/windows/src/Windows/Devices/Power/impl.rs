...
impl IBatteryVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IBatteryImpl, const OFFSET: isize>() -> IBatteryVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IBattery>, ::windows::core::GetTrustLevel, DeviceId::<Impl, OFFSET>, GetReport::<Impl, OFFSET>, ReportUpdated::<Impl, OFFSET>, RemoveReportUpdated::<Impl, OFFSET>)
    }
}
#[cfg(feature = "implement_exclusive")]
...
impl IBatteryReportVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IBatteryReportImpl, const OFFSET: isize>() -> IBatteryReportVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IBatteryReport>, ::windows::core::GetTrustLevel, ChargeRateInMilliwatts::<Impl, OFFSET>, DesignCapacityInMilliwattHours::<Impl, OFFSET>, FullChargeCapacityInMilliwattHours::<Impl, OFFSET>, RemainingCapacityInMilliwattHours::<Impl, OFFSET>, Status::<Impl, OFFSET>)
    }
}
#[cfg(feature = "implement_exclusive")]
...
impl IBatteryStaticsVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IBatteryStaticsImpl, const OFFSET: isize>() -> IBatteryStaticsVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, OFFSET>, ::windows::core::AddRef::<Identity, OFFSET>, ::windows::core::Release::<Identity, OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IBatteryStatics>, ::windows::core::GetTrustLevel, AggregateBattery::<Impl, OFFSET>, FromIdAsync::<Impl, OFFSET>, GetDeviceSelector::<Impl, OFFSET>)
    }
}
