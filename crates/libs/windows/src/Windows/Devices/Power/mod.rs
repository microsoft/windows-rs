...
impl Battery {
    ...
    pub fn GetReport(&self) -> windows_result::Result<BatteryReport> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReportUpdated<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveReportUpdated(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveReportUpdated)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn AggregateBattery() -> windows_result::Result<Battery> {
    ...
    pub fn FromIdAsync(deviceid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<Battery>> {
        Self::IBatteryStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IBatteryStatics<R, F: FnOnce(&IBatteryStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl BatteryReport {
    pub fn ChargeRateInMilliwatts(&self) -> windows_result::Result<super::super::Foundation::IReference<i32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DesignCapacityInMilliwattHours(&self) -> windows_result::Result<super::super::Foundation::IReference<i32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FullChargeCapacityInMilliwattHours(&self) -> windows_result::Result<super::super::Foundation::IReference<i32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RemainingCapacityInMilliwattHours(&self) -> windows_result::Result<super::super::Foundation::IReference<i32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Status(&self) -> windows_result::Result<super::super::System::Power::BatteryStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PowerGridData {
    pub fn Severity(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsLowUserExperienceImpact(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PowerGridForecast {
    ...
    pub fn BlockDuration(&self) -> windows_result::Result<super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Forecast(&self) -> windows_result::Result<windows_collections::IVectorView<PowerGridData>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetForecast() -> windows_result::Result<PowerGridForecast> {
    ...
    pub fn ForecastUpdated<P0>(handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveForecastUpdated(token: i64) -> windows_result::Result<()> {
    ...
    fn IPowerGridForecastStatics<R, F: FnOnce(&IPowerGridForecastStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
