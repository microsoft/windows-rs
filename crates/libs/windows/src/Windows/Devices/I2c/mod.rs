...
impl I2cConnectionSettings {
    pub fn SlaveAddress(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
    ...
    pub fn SetSlaveAddress(&self, value: i32) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSlaveAddress)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn BusSpeed(&self) -> windows_result::Result<I2cBusSpeed> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetBusSpeed(&self, value: I2cBusSpeed) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetBusSpeed)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SharingMode(&self) -> windows_result::Result<I2cSharingMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSharingMode(&self, value: I2cSharingMode) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSharingMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Create(slaveaddress: i32) -> windows_result::Result<I2cConnectionSettings> {
    ...
    fn II2cConnectionSettingsFactory<R, F: FnOnce(&II2cConnectionSettingsFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl I2cController {
    pub fn GetDevice<P0>(&self, settings: P0) -> windows_result::Result<I2cDevice>
    where
    ...
    #[cfg(feature = "Devices_I2c_Provider")]
    pub fn GetControllersAsync<P0>(provider: P0) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<I2cController>>>
    where
    ...
    pub fn GetDefaultAsync() -> windows_result::Result<windows_future::IAsyncOperation<I2cController>> {
        Self::II2cControllerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn II2cControllerStatics<R, F: FnOnce(&II2cControllerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl I2cDevice {
    ...
    pub fn ConnectionSettings(&self) -> windows_result::Result<I2cConnectionSettings> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn WritePartial(&self, buffer: &[u8]) -> windows_result::Result<I2cTransferResult> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReadPartial(&self, buffer: &mut [u8]) -> windows_result::Result<I2cTransferResult> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn WriteRead(&self, writebuffer: &[u8], readbuffer: &mut [u8]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn WriteReadPartial(&self, writebuffer: &[u8], readbuffer: &mut [u8]) -> windows_result::Result<I2cTransferResult> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FromIdAsync<P1>(deviceid: &windows_core::HSTRING, settings: P1) -> windows_result::Result<windows_future::IAsyncOperation<I2cDevice>>
    where
    ...
    fn II2cDeviceStatics<R, F: FnOnce(&II2cDeviceStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl II2cDeviceStatics {
    ...
    pub fn FromIdAsync<P1>(&self, deviceid: &windows_core::HSTRING, settings: P1) -> windows_result::Result<windows_future::IAsyncOperation<I2cDevice>>
    where
        P1: windows_core::Param<I2cConnectionSettings>,
    {
        let this = self;
...
pub trait II2cDeviceStatics_Impl: windows_core::IUnknownImpl {
    ...
    fn FromIdAsync(&self, deviceId: &windows_core::HSTRING, settings: windows_core::Ref<I2cConnectionSettings>) -> windows_result::Result<windows_future::IAsyncOperation<I2cDevice>>;
}
