...
impl HidBooleanControl {
    ...
    pub fn UsagePage(&self) -> windows_result::Result<u16> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UsageId(&self) -> windows_result::Result<u16> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsActive(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsActive)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ControlDescription(&self) -> windows_result::Result<HidBooleanControlDescription> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl HidBooleanControlDescription {
    ...
    pub fn ReportId(&self) -> windows_result::Result<u16> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReportType(&self) -> windows_result::Result<HidReportType> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ParentCollections(&self) -> windows_result::Result<windows_collections::IVectorView<HidCollection>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsAbsolute(&self) -> windows_result::Result<bool> {
...
impl HidCollection {
    ...
    pub fn Type(&self) -> windows_result::Result<HidCollectionType> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UsagePage(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UsagePage)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn UsageId(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).UsageId)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl HidDevice {
    ...
    pub fn GetInputReportAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<HidInputReport>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetInputReportByIdAsync(&self, reportid: u16) -> windows_result::Result<windows_future::IAsyncOperation<HidInputReport>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetFeatureReportAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<HidFeatureReport>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetFeatureReportByIdAsync(&self, reportid: u16) -> windows_result::Result<windows_future::IAsyncOperation<HidFeatureReport>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateOutputReport(&self) -> windows_result::Result<HidOutputReport> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateOutputReportById(&self, reportid: u16) -> windows_result::Result<HidOutputReport> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFeatureReport(&self) -> windows_result::Result<HidFeatureReport> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFeatureReportById(&self, reportid: u16) -> windows_result::Result<HidFeatureReport> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SendOutputReportAsync<P0>(&self, outputreport: P0) -> windows_result::Result<windows_future::IAsyncOperation<u32>>
    where
    ...
    pub fn SendFeatureReportAsync<P0>(&self, featurereport: P0) -> windows_result::Result<windows_future::IAsyncOperation<u32>>
    where
    ...
    pub fn GetBooleanControlDescriptions(&self, reporttype: HidReportType, usagepage: u16, usageid: u16) -> windows_result::Result<windows_collections::IVectorView<HidBooleanControlDescription>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetNumericControlDescriptions(&self, reporttype: HidReportType, usagepage: u16, usageid: u16) -> windows_result::Result<windows_collections::IVectorView<HidNumericControlDescription>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn InputReportReceived<P0>(&self, reporthandler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveInputReportReceived(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveInputReportReceived)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GetDeviceSelector(usagepage: u16, usageid: u16) -> windows_result::Result<windows_core::HSTRING> {
    ...
    pub fn GetDeviceSelectorVidPid(usagepage: u16, usageid: u16, vendorid: u16, productid: u16) -> windows_result::Result<windows_core::HSTRING> {
        Self::IHidDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage")]
    pub fn FromIdAsync(deviceid: &windows_core::HSTRING, accessmode: super::super::Storage::FileAccessMode) -> windows_result::Result<windows_future::IAsyncOperation<HidDevice>> {
        Self::IHidDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IHidDeviceStatics<R, F: FnOnce(&IHidDeviceStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl HidFeatureReport {
    pub fn Id(&self) -> windows_result::Result<u16> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Id)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn Data(&self) -> windows_result::Result<super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetBooleanControl(&self, usagepage: u16, usageid: u16) -> windows_result::Result<HidBooleanControl> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetBooleanControlByDescription<P0>(&self, controldescription: P0) -> windows_result::Result<HidBooleanControl>
    where
    ...
    pub fn GetNumericControl(&self, usagepage: u16, usageid: u16) -> windows_result::Result<HidNumericControl> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetNumericControlByDescription<P0>(&self, controldescription: P0) -> windows_result::Result<HidNumericControl>
    where
...
impl HidInputReport {
    ...
    pub fn ActivatedBooleanControls(&self) -> windows_result::Result<windows_collections::IVectorView<HidBooleanControl>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TransitionedBooleanControls(&self) -> windows_result::Result<windows_collections::IVectorView<HidBooleanControl>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl HidInputReportReceivedEventArgs {
    pub fn Report(&self) -> windows_result::Result<HidInputReport> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl HidNumericControl {
    ...
    pub fn IsGrouped(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Value(&self) -> windows_result::Result<i64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetValue(&self, value: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetValue)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ScaledValue(&self) -> windows_result::Result<i64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetScaledValue(&self, value: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetScaledValue)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ControlDescription(&self) -> windows_result::Result<HidNumericControlDescription> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ControlDescription)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl HidNumericControlDescription {
    ...
    pub fn ReportSize(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReportCount(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LogicalMinimum(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LogicalMaximum(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PhysicalMinimum(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PhysicalMaximum(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UnitExponent(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Unit(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HasNull(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
