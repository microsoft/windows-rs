...
impl AdcChannel {
    pub fn Controller(&self) -> Result<AdcController, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn ReadValue(&self) -> Result<i32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReadRatio(&self) -> Result<f64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AdcController {
    ...
    pub fn ChannelMode(&self) -> Result<AdcChannelMode, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetChannelMode(&self, value: AdcChannelMode) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetChannelMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsChannelModeSupported(&self, channelmode: AdcChannelMode) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OpenChannel(&self, channelnumber: i32) -> Result<AdcChannel, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_Adc_Provider")]
    pub fn GetControllersAsync<P0>(provider: P0) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<AdcController>>, windows_result::HRESULT>
    where
    ...
    pub fn GetDefaultAsync() -> Result<windows_future::IAsyncOperation<AdcController>, windows_result::HRESULT> {
    ...
    fn IAdcControllerStatics<R, F: FnOnce(&IAdcControllerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<AdcController, IAdcControllerStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IAdcControllerStatics2<R, F: FnOnce(&IAdcControllerStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
