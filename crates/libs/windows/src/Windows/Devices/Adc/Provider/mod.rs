...
impl IAdcControllerProvider {
    ...
    pub fn ChannelMode(&self) -> windows_result::Result<ProviderAdcChannelMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetChannelMode(&self, value: ProviderAdcChannelMode) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetChannelMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsChannelModeSupported(&self, channelmode: ProviderAdcChannelMode) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IAdcControllerProvider_Impl: windows_core::IUnknownImpl {
    fn ChannelCount(&self) -> windows_result::Result<i32>;
    fn ResolutionInBits(&self) -> windows_result::Result<i32>;
    fn MinValue(&self) -> windows_result::Result<i32>;
    fn MaxValue(&self) -> windows_result::Result<i32>;
    fn ChannelMode(&self) -> windows_result::Result<ProviderAdcChannelMode>;
    fn SetChannelMode(&self, value: ProviderAdcChannelMode) -> windows_result::Result<()>;
    fn IsChannelModeSupported(&self, channelMode: ProviderAdcChannelMode) -> windows_result::Result<bool>;
    fn AcquireChannel(&self, channel: i32) -> windows_result::Result<()>;
    fn ReleaseChannel(&self, channel: i32) -> windows_result::Result<()>;
    fn ReadValue(&self, channelNumber: i32) -> windows_result::Result<i32>;
}
...
impl IAdcProvider {
    pub fn GetControllers(&self) -> windows_result::Result<windows_collections::IVectorView<IAdcControllerProvider>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IAdcProvider_Impl: windows_core::IUnknownImpl {
    fn GetControllers(&self) -> windows_result::Result<windows_collections::IVectorView<IAdcControllerProvider>>;
}
