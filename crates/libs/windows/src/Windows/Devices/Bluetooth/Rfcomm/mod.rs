...
impl RfcommDeviceService {
    ...
    #[cfg(feature = "Networking")]
    pub fn ConnectionHostName(&self) -> windows_result::Result<super::super::super::Networking::HostName> {
        let this = self;
        unsafe {
    ...
    pub fn ConnectionServiceName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ServiceId(&self) -> windows_result::Result<RfcommServiceId> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Networking_Sockets")]
    pub fn ProtectionLevel(&self) -> windows_result::Result<super::super::super::Networking::Sockets::SocketProtectionLevel> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Networking_Sockets")]
    pub fn MaxProtectionLevel(&self) -> windows_result::Result<super::super::super::Networking::Sockets::SocketProtectionLevel> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetSdpRawAttributesAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IMapView<u32, super::super::super::Storage::Streams::IBuffer>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetSdpRawAttributesWithCacheModeAsync(&self, cachemode: super::BluetoothCacheMode) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IMapView<u32, super::super::super::Storage::Streams::IBuffer>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Device(&self) -> windows_result::Result<super::BluetoothDevice> {
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub fn DeviceAccessInformation(&self) -> windows_result::Result<super::super::Enumeration::DeviceAccessInformation> {
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub fn RequestAccessAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<super::super::Enumeration::DeviceAccessStatus>> {
        let this = &windows_core::Interface::cast::<IRfcommDeviceService3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FromIdAsync(deviceid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<RfcommDeviceService>> {
        Self::IRfcommDeviceServiceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromIdAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(deviceid), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn GetDeviceSelector<P0>(serviceid: P0) -> windows_result::Result<windows_core::HSTRING>
    where
    ...
    pub fn GetDeviceSelectorForBluetoothDevice<P0>(bluetoothdevice: P0) -> windows_result::Result<windows_core::HSTRING>
    where
    ...
    pub fn GetDeviceSelectorForBluetoothDeviceWithCacheMode<P0>(bluetoothdevice: P0, cachemode: super::BluetoothCacheMode) -> windows_result::Result<windows_core::HSTRING>
    where
        P0: windows_core::Param<super::BluetoothDevice>,
    {
        Self::IRfcommDeviceServiceStatics2(|this| unsafe {
    ...
    pub fn GetDeviceSelectorForBluetoothDeviceAndServiceId<P0, P1>(bluetoothdevice: P0, serviceid: P1) -> windows_result::Result<windows_core::HSTRING>
    where
        P0: windows_core::Param<super::BluetoothDevice>,
    ...
    pub fn GetDeviceSelectorForBluetoothDeviceAndServiceIdWithCacheMode<P0, P1>(bluetoothdevice: P0, serviceid: P1, cachemode: super::BluetoothCacheMode) -> windows_result::Result<windows_core::HSTRING>
    where
        P0: windows_core::Param<super::BluetoothDevice>,
        P1: windows_core::Param<RfcommServiceId>,
    {
    ...
    fn IRfcommDeviceServiceStatics<R, F: FnOnce(&IRfcommDeviceServiceStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IRfcommDeviceServiceStatics2<R, F: FnOnce(&IRfcommDeviceServiceStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl RfcommDeviceServicesResult {
    ...
    pub fn Services(&self) -> windows_result::Result<windows_collections::IVectorView<RfcommDeviceService>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl RfcommServiceId {
    pub fn Uuid(&self) -> windows_result::Result<windows_core::GUID> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AsShortId(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AsString(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FromUuid(uuid: windows_core::GUID) -> windows_result::Result<RfcommServiceId> {
    ...
    pub fn FromShortId(shortid: u32) -> windows_result::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SerialPort() -> windows_result::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ObexObjectPush() -> windows_result::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ObexFileTransfer() -> windows_result::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PhoneBookAccessPce() -> windows_result::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PhoneBookAccessPse() -> windows_result::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GenericFileTransfer() -> windows_result::Result<RfcommServiceId> {
        Self::IRfcommServiceIdStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IRfcommServiceIdStatics<R, F: FnOnce(&IRfcommServiceIdStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl RfcommServiceProvider {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SdpRawAttributes(&self) -> windows_result::Result<windows_collections::IMap<u32, super::super::super::Storage::Streams::IBuffer>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Networking_Sockets")]
    pub fn StartAdvertising<P0>(&self, listener: P0) -> windows_result::Result<()>
    where
    ...
    pub fn StopAdvertising(&self) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).StopAdvertising)(windows_core::Interface::as_raw(this)).ok() }
    }
    #[cfg(feature = "Networking_Sockets")]
    pub fn StartAdvertisingWithRadioDiscoverability<P0>(&self, listener: P0, radiodiscoverable: bool) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::super::Networking::Sockets::StreamSocketListener>,
    {
    ...
    pub fn CreateAsync<P0>(serviceid: P0) -> windows_result::Result<windows_future::IAsyncOperation<RfcommServiceProvider>>
    where
        P0: windows_core::Param<RfcommServiceId>,
    {
    ...
    fn IRfcommServiceProviderStatics<R, F: FnOnce(&IRfcommServiceProviderStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
