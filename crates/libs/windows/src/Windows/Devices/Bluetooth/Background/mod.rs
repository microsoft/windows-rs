...
windows_core::imp::required_hierarchy!(BluetoothLEAdvertisementPublisherTriggerDetails, IBluetoothLEAdvertisementPublisherTriggerDetails, IBluetoothLEAdvertisementPublisherTriggerDetails2);
...
windows_core::imp::required_hierarchy!(BluetoothLEAdvertisementWatcherTriggerDetails, IBluetoothLEAdvertisementWatcherTriggerDetails);
...
windows_core::imp::required_hierarchy!(GattCharacteristicNotificationTriggerDetails, IGattCharacteristicNotificationTriggerDetails, IGattCharacteristicNotificationTriggerDetails2);
...
windows_core::imp::required_hierarchy!(GattServiceProviderConnection, IGattServiceProviderConnection, IGattServiceProviderConnectionStatics);
...
windows_core::imp::required_hierarchy!(GattServiceProviderTriggerDetails, IGattServiceProviderTriggerDetails);
...
windows_core::imp::required_hierarchy!(RfcommConnectionTriggerDetails, IRfcommConnectionTriggerDetails);
...
windows_core::imp::required_hierarchy!(RfcommInboundConnectionInformation, IRfcommInboundConnectionInformation);
...
windows_core::imp::required_hierarchy!(RfcommOutboundConnectionInformation, IRfcommOutboundConnectionInformation);
