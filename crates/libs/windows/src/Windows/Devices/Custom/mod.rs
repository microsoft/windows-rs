...
impl CustomDevice {
    ...
    pub fn InputStream(&self) -> windows_result::Result<super::super::Storage::Streams::IInputStream> {
        let this = self;
        unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn OutputStream(&self) -> windows_result::Result<super::super::Storage::Streams::IOutputStream> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SendIOControlAsync<P0, P1, P2>(&self, iocontrolcode: P0, inputbuffer: P1, outputbuffer: P2) -> windows_result::Result<windows_future::IAsyncOperation<u32>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn TrySendIOControlAsync<P0, P1, P2>(&self, iocontrolcode: P0, inputbuffer: P1, outputbuffer: P2) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<IIOControlCode>,
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
        P2: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    ...
    pub fn GetDeviceSelector(classguid: windows_core::GUID) -> windows_result::Result<windows_core::HSTRING> {
    ...
    pub fn FromIdAsync(deviceid: &windows_core::HSTRING, desiredaccess: DeviceAccessMode, sharingmode: DeviceSharingMode) -> windows_result::Result<windows_future::IAsyncOperation<CustomDevice>> {
        Self::ICustomDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn ICustomDeviceStatics<R, F: FnOnce(&ICustomDeviceStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
pub struct ICustomDeviceStatics_Vtbl {
    ...
    pub FromIdAsync: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, DeviceAccessMode, DeviceSharingMode, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
}
...
impl IIOControlCode {
    pub fn AccessMode(&self) -> windows_result::Result<IOControlAccessMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BufferingMethod(&self) -> windows_result::Result<IOControlBufferingMethod> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Function(&self) -> windows_result::Result<u16> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeviceType(&self) -> windows_result::Result<u16> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ControlCode(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IIOControlCode_Impl: windows_core::IUnknownImpl {
    fn AccessMode(&self) -> windows_result::Result<IOControlAccessMode>;
    fn BufferingMethod(&self) -> windows_result::Result<IOControlBufferingMethod>;
    fn Function(&self) -> windows_result::Result<u16>;
    fn DeviceType(&self) -> windows_result::Result<u16>;
    fn ControlCode(&self) -> windows_result::Result<u32>;
}
...
impl IOControlCode {
    ...
    pub fn CreateIOControlCode(devicetype: u16, function: u16, accessmode: IOControlAccessMode, bufferingmethod: IOControlBufferingMethod) -> windows_result::Result<IOControlCode> {
    ...
    fn IIOControlCodeFactory<R, F: FnOnce(&IIOControlCodeFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl KnownDeviceTypes {
    pub fn Unknown() -> windows_result::Result<u16> {
    ...
    fn IKnownDeviceTypesStatics<R, F: FnOnce(&IKnownDeviceTypesStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
