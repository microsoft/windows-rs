...
impl<Identity: windows_core::IUnknownImpl + IIOControlCode_Impl + 'static, const OFFSET: isize> windows_core::imp::VtableCtor<Identity, OFFSET> for IIOControlCode_Vtbl {
