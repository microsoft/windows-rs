...
impl WiFiDirectService {
    #[cfg(feature = "Storage_Streams")]
    pub fn RemoteServiceInfo(&self) -> windows_result::Result<super::super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
    ...
    pub fn SupportedConfigurationMethods(&self) -> windows_result::Result<windows_collections::IVectorView<WiFiDirectServiceConfigurationMethod>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PreferGroupOwnerMode(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPreferGroupOwnerMode(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetPreferGroupOwnerMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn SessionInfo(&self) -> windows_result::Result<super::super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetSessionInfo<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn ServiceError(&self) -> windows_result::Result<WiFiDirectServiceError> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SessionDeferred<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveSessionDeferred(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveSessionDeferred)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GetProvisioningInfoAsync(&self, selectedconfigurationmethod: WiFiDirectServiceConfigurationMethod) -> windows_result::Result<windows_future::IAsyncOperation<WiFiDirectServiceProvisioningInfo>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ConnectAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<WiFiDirectServiceSession>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ConnectAsyncWithPin(&self, pin: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<WiFiDirectServiceSession>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetSelector(servicename: &windows_core::HSTRING) -> windows_result::Result<windows_core::HSTRING> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetSelectorWithFilter<P1>(servicename: &windows_core::HSTRING, serviceinfofilter: P1) -> windows_result::Result<windows_core::HSTRING>
    where
    ...
    pub fn FromIdAsync(deviceid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<WiFiDirectService>> {
        Self::IWiFiDirectServiceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromIdAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(deviceid), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IWiFiDirectServiceStatics<R, F: FnOnce(&IWiFiDirectServiceStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl WiFiDirectServiceAdvertiser {
    ...
    pub fn ServiceNamePrefixes(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ServiceInfo(&self) -> windows_result::Result<super::super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetServiceInfo<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::super::Storage::Streams::IBuffer>,
    {
        let this = self;
    ...
    pub fn AutoAcceptSession(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAutoAcceptSession(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn PreferredConfigurationMethods(&self) -> windows_result::Result<windows_collections::IVector<WiFiDirectServiceConfigurationMethod>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ServiceStatus(&self) -> windows_result::Result<WiFiDirectServiceStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetServiceStatus(&self, value: WiFiDirectServiceStatus) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetServiceStatus)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CustomServiceStatusCode(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCustomServiceStatusCode(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCustomServiceStatusCode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn DeferredSessionInfo(&self) -> windows_result::Result<super::super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetDeferredSessionInfo<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::super::Storage::Streams::IBuffer>,
    {
        let this = self;
    ...
    pub fn AdvertisementStatus(&self) -> windows_result::Result<WiFiDirectServiceAdvertisementStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SessionRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveSessionRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveSessionRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn AutoAcceptSessionConnected<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveAutoAcceptSessionConnected(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveAutoAcceptSessionConnected)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn AdvertisementStatusChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveAdvertisementStatusChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveAdvertisementStatusChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    #[cfg(feature = "Devices_Enumeration")]
    pub fn ConnectAsync<P0>(&self, deviceinfo: P0) -> windows_result::Result<windows_future::IAsyncOperation<WiFiDirectServiceSession>>
    where
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub fn ConnectAsyncWithPin<P0>(&self, deviceinfo: P0, pin: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<WiFiDirectServiceSession>>
    where
        P0: windows_core::Param<super::super::Enumeration::DeviceInformation>,
    {
        let this = self;
    ...
    pub fn CreateWiFiDirectServiceAdvertiser(servicename: &windows_core::HSTRING) -> windows_result::Result<WiFiDirectServiceAdvertiser> {
    ...
    fn IWiFiDirectServiceAdvertiserFactory<R, F: FnOnce(&IWiFiDirectServiceAdvertiserFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl WiFiDirectServiceAutoAcceptSessionConnectedEventArgs {
    pub fn Session(&self) -> windows_result::Result<WiFiDirectServiceSession> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WiFiDirectServiceProvisioningInfo {
    pub fn SelectedConfigurationMethod(&self) -> windows_result::Result<WiFiDirectServiceConfigurationMethod> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsGroupFormationNeeded(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WiFiDirectServiceRemotePortAddedEventArgs {
    #[cfg(feature = "Networking")]
    pub fn EndpointPairs(&self) -> windows_result::Result<windows_collections::IVectorView<super::super::super::Networking::EndpointPair>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Protocol(&self) -> windows_result::Result<WiFiDirectServiceIPProtocol> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WiFiDirectServiceSession {
    ...
    pub fn Status(&self) -> windows_result::Result<WiFiDirectServiceSessionStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ErrorStatus(&self) -> windows_result::Result<WiFiDirectServiceSessionErrorStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SessionId(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AdvertisementId(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ServiceAddress(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SessionAddress(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Networking")]
    pub fn GetConnectionEndpointPairs(&self) -> windows_result::Result<windows_collections::IVectorView<super::super::super::Networking::EndpointPair>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SessionStatusChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveSessionStatusChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveSessionStatusChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    #[cfg(feature = "Networking_Sockets")]
    pub fn AddStreamSocketListenerAsync<P0>(&self, value: P0) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    #[cfg(feature = "Networking_Sockets")]
    pub fn AddDatagramSocketAsync<P0>(&self, value: P0) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    pub fn RemotePortAdded<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveRemotePortAdded(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
...
impl WiFiDirectServiceSessionRequest {
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub fn DeviceInformation(&self) -> windows_result::Result<super::super::Enumeration::DeviceInformation> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ProvisioningInfo(&self) -> windows_result::Result<WiFiDirectServiceProvisioningInfo> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WiFiDirectServiceSessionRequestedEventArgs {
    pub fn GetSessionRequest(&self) -> windows_result::Result<WiFiDirectServiceSessionRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
