...
windows_core::imp::required_hierarchy!(WiFiDirectService, IWiFiDirectService, IWiFiDirectServiceStatics);
...
windows_core::imp::required_hierarchy!(WiFiDirectServiceAdvertiser, IWiFiDirectServiceAdvertiser, IWiFiDirectServiceAdvertiserFactory);
...
windows_core::imp::required_hierarchy!(WiFiDirectServiceAutoAcceptSessionConnectedEventArgs, IWiFiDirectServiceAutoAcceptSessionConnectedEventArgs);
...
windows_core::imp::required_hierarchy!(WiFiDirectServiceProvisioningInfo, IWiFiDirectServiceProvisioningInfo);
...
windows_core::imp::required_hierarchy!(WiFiDirectServiceRemotePortAddedEventArgs, IWiFiDirectServiceRemotePortAddedEventArgs);
...
windows_core::imp::required_hierarchy!(WiFiDirectServiceSession, IWiFiDirectServiceSession, super::super::super::Foundation::IClosable);
...
windows_core::imp::required_hierarchy!(WiFiDirectServiceSessionDeferredEventArgs, IWiFiDirectServiceSessionDeferredEventArgs);
...
windows_core::imp::required_hierarchy!(WiFiDirectServiceSessionRequest, IWiFiDirectServiceSessionRequest, super::super::super::Foundation::IClosable);
...
windows_core::imp::required_hierarchy!(WiFiDirectServiceSessionRequestedEventArgs, IWiFiDirectServiceSessionRequestedEventArgs);
