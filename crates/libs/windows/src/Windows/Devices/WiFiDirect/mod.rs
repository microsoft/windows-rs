...
impl WiFiDirectAdvertisement {
    pub fn InformationElements(&self) -> Result<windows_collections::IVector<WiFiDirectInformationElement>, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn SetInformationElements<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn ListenStateDiscoverability(&self) -> Result<WiFiDirectAdvertisementListenStateDiscoverability, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetListenStateDiscoverability(&self, value: WiFiDirectAdvertisementListenStateDiscoverability) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetListenStateDiscoverability)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsAutonomousGroupOwnerEnabled(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsAutonomousGroupOwnerEnabled(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsAutonomousGroupOwnerEnabled)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn LegacySettings(&self) -> Result<WiFiDirectLegacySettings, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SupportedConfigurationMethods(&self) -> Result<windows_collections::IVector<WiFiDirectConfigurationMethod>, windows_result::HRESULT> {
...
impl WiFiDirectAdvertisementPublisher {
    ...
    pub fn Advertisement(&self) -> Result<WiFiDirectAdvertisement, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Status(&self) -> Result<WiFiDirectAdvertisementPublisherStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WiFiDirectAdvertisementPublisherStatusChangedEventArgs {
    ...
    pub fn Error(&self) -> Result<WiFiDirectError, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WiFiDirectConnectionParameters {
    ...
    pub fn GroupOwnerIntent(&self) -> Result<i16, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetGroupOwnerIntent(&self, value: i16) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetGroupOwnerIntent)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn PreferenceOrderedConfigurationMethods(&self) -> Result<windows_collections::IVector<WiFiDirectConfigurationMethod>, windows_result::HRESULT> {
    ...
    pub fn PreferredPairingProcedure(&self) -> Result<WiFiDirectPairingProcedure, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IWiFiDirectConnectionParameters2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPreferredPairingProcedure(&self, value: WiFiDirectPairingProcedure) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IWiFiDirectConnectionParameters2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetPreferredPairingProcedure)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn GetDevicePairingKinds(configurationmethod: WiFiDirectConfigurationMethod) -> Result<super::Enumeration::DevicePairingKinds, windows_result::HRESULT> {
    ...
    fn IWiFiDirectConnectionParametersStatics<R, F: FnOnce(&IWiFiDirectConnectionParametersStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl WiFiDirectConnectionRequestedEventArgs {
    pub fn GetConnectionRequest(&self) -> Result<WiFiDirectConnectionRequest, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WiFiDirectDevice {
    ...
    pub fn ConnectionStatus(&self) -> Result<WiFiDirectConnectionStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Networking")]
    pub fn GetConnectionEndpointPairs(&self) -> Result<windows_collections::IVectorView<super::super::Networking::EndpointPair>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FromIdAsync(deviceid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<WiFiDirectDevice>, windows_result::HRESULT> {
        Self::IWiFiDirectDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromIdAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(deviceid), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn GetDeviceSelector2(r#type: WiFiDirectDeviceSelectorType) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub fn FromIdAsync2<P1>(deviceid: &windows_core::HSTRING, connectionparameters: P1) -> Result<windows_future::IAsyncOperation<WiFiDirectDevice>, windows_result::HRESULT>
    where
    ...
    fn IWiFiDirectDeviceStatics<R, F: FnOnce(&IWiFiDirectDeviceStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<WiFiDirectDevice, IWiFiDirectDeviceStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IWiFiDirectDeviceStatics2<R, F: FnOnce(&IWiFiDirectDeviceStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl WiFiDirectInformationElement {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Oui(&self) -> Result<super::super::Storage::Streams::IBuffer, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetOui<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn OuiType(&self) -> Result<u8, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOuiType(&self, value: u8) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromBuffer<P0>(buffer: P0) -> Result<windows_collections::IVector<WiFiDirectInformationElement>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub fn CreateFromDeviceInformation<P0>(deviceinformation: P0) -> Result<windows_collections::IVector<WiFiDirectInformationElement>, windows_result::HRESULT>
    where
    ...
    fn IWiFiDirectInformationElementStatics<R, F: FnOnce(&IWiFiDirectInformationElementStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl WiFiDirectLegacySettings {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn Passphrase(&self) -> Result<super::super::Security::Credentials::PasswordCredential, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn SetPassphrase<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
