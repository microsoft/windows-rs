...
windows_core::imp::required_hierarchy!(DeviceAccessChangedEventArgs, IDeviceAccessChangedEventArgs, IDeviceAccessChangedEventArgs2, IDeviceAccessChangedEventArgs3);
impl DeviceAccessChangedEventArgs {
    pub fn Status(&self) -> windows_core::Result<DeviceAccessStatus> {
        let this = &windows_core::Interface::cast::<IDeviceAccessChangedEventArgs>(self)?;
        unsafe {
...
windows_core::imp::required_hierarchy!(DeviceAccessInformation, IDeviceAccessInformation, IDeviceAccessInformation2, IDeviceAccessInformationStatics);
...
windows_core::imp::required_hierarchy!(DeviceConnectionChangeTriggerDetails, IDeviceConnectionChangeTriggerDetails);
...
windows_core::imp::required_hierarchy!(DeviceDisconnectButtonClickedEventArgs, IDeviceDisconnectButtonClickedEventArgs);
...
windows_core::imp::required_hierarchy!(DeviceInformation, IDeviceInformation, IDeviceInformation2, IDeviceInformationStatics, IDeviceInformationStatics2, IDeviceInformationStatics3);
...
windows_core::imp::required_hierarchy!(DeviceInformationCustomPairing, IDeviceInformationCustomPairing, IDeviceInformationCustomPairing2);
...
windows_core::imp::required_hierarchy!(DeviceInformationPairing, IDeviceInformationPairing, IDeviceInformationPairing2, IDeviceInformationPairingStatics, IDeviceInformationPairingStatics2);
...
windows_core::imp::required_hierarchy!(DeviceInformationUpdate, IDeviceInformationUpdate, IDeviceInformationUpdate2);
...
windows_core::imp::required_hierarchy!(DevicePairingRequestedEventArgs, IDevicePairingRequestedEventArgs, IDevicePairingRequestedEventArgs2, IDevicePairingRequestedEventArgs3);
...
windows_core::imp::required_hierarchy!(DevicePairingResult, IDevicePairingResult);
...
windows_core::imp::required_hierarchy!(DevicePairingSetMembersRequestedEventArgs, IDevicePairingSetMembersRequestedEventArgs);
...
windows_core::imp::required_hierarchy!(DevicePicker, IDevicePicker);
impl DevicePicker {
...
windows_core::imp::required_hierarchy!(DevicePickerAppearance, IDevicePickerAppearance);
...
windows_core::imp::required_hierarchy!(DevicePickerFilter, IDevicePickerFilter);
...
windows_core::imp::required_hierarchy!(DeviceSelectedEventArgs, IDeviceSelectedEventArgs);
...
windows_core::imp::required_hierarchy!(DeviceUnpairingResult, IDeviceUnpairingResult);
...
windows_core::imp::required_hierarchy!(DeviceWatcher, IDeviceWatcher, IDeviceWatcher2);
impl DeviceWatcher {
...
windows_core::imp::required_hierarchy!(DeviceWatcherEvent, IDeviceWatcherEvent);
...
windows_core::imp::required_hierarchy!(DeviceWatcherTriggerDetails, IDeviceWatcherTriggerDetails);
...
windows_core::imp::required_hierarchy!(EnclosureLocation, IEnclosureLocation, IEnclosureLocation2);
impl EnclosureLocation {
    pub fn InDock(&self) -> windows_core::Result<bool> {
        let this = &windows_core::Interface::cast::<IEnclosureLocation>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
