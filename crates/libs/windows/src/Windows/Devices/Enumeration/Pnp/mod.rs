...
impl PnpObject {
    pub fn Type(&self) -> Result<PnpObjectType, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn CreateFromIdAsync<P2>(r#type: PnpObjectType, id: &windows_core::HSTRING, requestedproperties: P2) -> Result<windows_future::IAsyncOperation<PnpObject>, windows_result::HRESULT>
    where
    ...
    pub fn FindAllAsync<P1>(r#type: PnpObjectType, requestedproperties: P1) -> Result<windows_future::IAsyncOperation<PnpObjectCollection>, windows_result::HRESULT>
    where
    ...
    pub fn FindAllAsyncAqsFilter<P1>(r#type: PnpObjectType, requestedproperties: P1, aqsfilter: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<PnpObjectCollection>, windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        Self::IPnpObjectStatics(|this| unsafe {
    ...
    pub fn CreateWatcher<P1>(r#type: PnpObjectType, requestedproperties: P1) -> Result<PnpObjectWatcher, windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        Self::IPnpObjectStatics(|this| unsafe {
    ...
    pub fn CreateWatcherAqsFilter<P1>(r#type: PnpObjectType, requestedproperties: P1, aqsfilter: &windows_core::HSTRING) -> Result<PnpObjectWatcher, windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        Self::IPnpObjectStatics(|this| unsafe {
    ...
    fn IPnpObjectStatics<R, F: FnOnce(&IPnpObjectStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl PnpObjectCollection {
    pub fn First(&self) -> Result<windows_collections::IIterator<PnpObject>, windows_result::HRESULT> {
    ...
    pub fn GetAt(&self, index: u32) -> Result<PnpObject, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMany(&self, startindex: u32, items: &mut [Option<PnpObject>]) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PnpObjectWatcher {
    ...
    pub fn Status(&self) -> Result<super::DeviceWatcherStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
