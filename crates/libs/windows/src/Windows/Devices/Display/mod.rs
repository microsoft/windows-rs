...
impl DisplayMonitor {
    ...
    pub fn ConnectionKind(&self) -> Result<DisplayMonitorConnectionKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PhysicalConnector(&self) -> Result<DisplayMonitorPhysicalConnectorKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DisplayAdapterDeviceId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DisplayAdapterId(&self) -> Result<super::super::Graphics::DisplayAdapterId, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DisplayAdapterTargetId(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UsageKind(&self) -> Result<DisplayMonitorUsageKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics")]
    pub fn NativeResolutionInRawPixels(&self) -> Result<super::super::Graphics::SizeInt32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PhysicalSizeInInches(&self) -> Result<super::super::Foundation::IReference<super::super::Foundation::Size>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDescriptor(&self, descriptorkind: DisplayMonitorDescriptorKind) -> Result<windows_core::Array<u8>, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn IsDolbyVisionSupportedInHdrMode(&self) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn FromIdAsync(deviceid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<DisplayMonitor>, windows_result::HRESULT> {
        Self::IDisplayMonitorStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromIdAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(deviceid), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn FromInterfaceIdAsync(deviceinterfaceid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<DisplayMonitor>, windows_result::HRESULT> {
        Self::IDisplayMonitorStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IDisplayMonitorStatics<R, F: FnOnce(&IDisplayMonitorStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
