...
impl DisplayAdapter {
    ...
    pub fn Id(&self) -> Result<super::super::super::Graphics::DisplayAdapterId, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn DeviceInterfacePath(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SourceCount(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PciVendorId(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PciDeviceId(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PciSubSystemId(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PciRevision(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsIndirectDisplayDevice(&self) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn PreferredRenderAdapter(&self) -> Result<DisplayAdapter, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IDisplayAdapter2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics")]
    pub fn FromId(id: super::super::super::Graphics::DisplayAdapterId) -> Result<DisplayAdapter, windows_result::HRESULT> {
    ...
    fn IDisplayAdapterStatics<R, F: FnOnce(&IDisplayAdapterStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl DisplayDevice {
    pub fn CreateScanoutSource<P0>(&self, target: P0) -> Result<DisplaySource, windows_result::HRESULT>
    where
    ...
    pub fn CreatePrimary<P0, P1>(&self, target: P0, desc: P1) -> Result<DisplaySurface, windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplayTarget>,
    ...
    pub fn CreateTaskPool(&self) -> Result<DisplayTaskPool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreatePeriodicFence<P0>(&self, target: P0, offsetfromvblank: super::super::super::Foundation::TimeSpan) -> Result<DisplayFence, windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplayTarget>,
    {
        let this = self;
    ...
    pub fn WaitForVBlank<P0>(&self, source: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn CreateSimpleScanout<P0, P1>(&self, psource: P0, psurface: P1, subresourceindex: u32, syncinterval: u32) -> Result<DisplayScanout, windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplaySource>,
    ...
    pub fn IsCapabilitySupported(&self, capability: DisplayDeviceCapability) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics")]
    pub fn CreateSimpleScanoutWithDirtyRectsAndOptions<P0, P1, P4>(&self, source: P0, surface: P1, subresourceindex: u32, syncinterval: u32, dirtyrects: P4, options: DisplayScanoutOptions) -> Result<DisplayScanout, windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplaySource>,
        P1: windows_core::Param<DisplaySurface>,
    ...
    #[cfg(feature = "Graphics")]
    pub fn RenderAdapterId(&self) -> Result<super::super::super::Graphics::DisplayAdapterId, windows_result::HRESULT> {
...
impl DisplayManager {
    ...
    pub fn GetCurrentTargets(&self) -> Result<windows_collections::IVectorView<DisplayTarget>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetCurrentAdapters(&self) -> Result<windows_collections::IVectorView<DisplayAdapter>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryAcquireTarget<P0>(&self, target: P0) -> Result<DisplayManagerResult, windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplayTarget>,
    {
        let this = self;
    ...
    pub fn ReleaseTarget<P0>(&self, target: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplayTarget>,
    {
        let this = self;
    ...
    pub fn TryReadCurrentStateForAllTargets(&self) -> Result<DisplayManagerResultWithState, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryAcquireTargetsAndReadCurrentState<P0>(&self, targets: P0) -> Result<DisplayManagerResultWithState, windows_result::HRESULT>
    where
    ...
    pub fn TryAcquireTargetsAndCreateEmptyState<P0>(&self, targets: P0) -> Result<DisplayManagerResultWithState, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IIterable<DisplayTarget>>,
    {
        let this = self;
    ...
    pub fn TryAcquireTargetsAndCreateSubstate<P0, P1>(&self, existingstate: P0, targets: P1) -> Result<DisplayManagerResultWithState, windows_result::HRESULT>
    where
    ...
    pub fn CreateDisplayDevice<P0>(&self, adapter: P0) -> Result<DisplayDevice, windows_result::HRESULT>
    where
    ...
    pub fn Enabled<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveEnabled(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveEnabled)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn Disabled<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveDisabled(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn PathsFailedOrInvalidated<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemovePathsFailedOrInvalidated(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn TryReadCurrentStateForModeQuery(&self) -> Result<DisplayManagerResultWithState, windows_result::HRESULT> {
    ...
    pub fn CreateDisplayDeviceForIndirectAdapter<P0, P1>(&self, indirectadapter: P0, renderadapter: P1) -> Result<DisplayDevice, windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplayAdapter>,
    ...
    pub fn Create(options: DisplayManagerOptions) -> Result<DisplayManager, windows_result::HRESULT> {
    ...
    fn IDisplayManagerStatics<R, F: FnOnce(&IDisplayManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl DisplayManagerResultWithState {
    pub fn ErrorCode(&self) -> Result<DisplayManagerResult, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn State(&self) -> Result<DisplayState, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DisplayModeInfo {
    #[cfg(feature = "Graphics")]
    pub fn SourceResolution(&self) -> Result<super::super::super::Graphics::SizeInt32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsStereo(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SourcePixelFormat(&self) -> Result<super::super::super::Graphics::DirectX::DirectXPixelFormat, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics")]
    pub fn TargetResolution(&self) -> Result<super::super::super::Graphics::SizeInt32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PresentationRate(&self) -> Result<DisplayPresentationRate, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsInterlaced(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetWireFormatSupportedBitsPerChannel(&self, encoding: DisplayWireFormatPixelEncoding) -> Result<DisplayBitsPerChannel, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsWireFormatSupported<P0>(&self, wireformat: P0) -> Result<bool, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn PhysicalPresentationRate(&self) -> Result<DisplayPresentationRate, windows_result::HRESULT> {
...
impl DisplayMuxDevice {
    ...
    pub fn GetAvailableMuxTargets(&self) -> Result<windows_collections::IVectorView<DisplayTarget>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CurrentTarget(&self) -> Result<DisplayTarget, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PreferredTarget(&self) -> Result<DisplayTarget, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsAutomaticTargetSwitchingEnabled(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPreferredTarget<P0>(&self, target: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplayTarget>,
    {
        let this = self;
    ...
    pub fn SetAutomaticTargetSwitching(&self) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FromIdAsync(deviceinterfaceid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<DisplayMuxDevice>, windows_result::HRESULT> {
        Self::IDisplayMuxDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IDisplayMuxDeviceStatics<R, F: FnOnce(&IDisplayMuxDeviceStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl DisplayPath {
    pub fn View(&self) -> Result<DisplayView, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Target(&self) -> Result<DisplayTarget, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Status(&self) -> Result<DisplayPathStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics")]
    pub fn SourceResolution(&self) -> Result<super::super::super::Foundation::IReference<super::super::super::Graphics::SizeInt32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics")]
    pub fn SetSourceResolution<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Graphics_DirectX")]
    pub fn SetSourcePixelFormat(&self, value: super::super::super::Graphics::DirectX::DirectXPixelFormat) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn SetIsStereo(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsStereo)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Graphics")]
    pub fn TargetResolution(&self) -> Result<super::super::super::Foundation::IReference<super::super::super::Graphics::SizeInt32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics")]
    pub fn SetTargetResolution<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Foundation::IReference<super::super::super::Graphics::SizeInt32>>,
    {
        let this = self;
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn PresentationRate(&self) -> Result<super::super::super::Foundation::IReference<DisplayPresentationRate>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn SetPresentationRate<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn IsInterlaced(&self) -> Result<super::super::super::Foundation::IReference<bool>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsInterlaced<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn WireFormat(&self) -> Result<DisplayWireFormat, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetWireFormat<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplayWireFormat>,
    {
        let this = self;
    ...
    pub fn Rotation(&self) -> Result<DisplayRotation, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRotation(&self, value: DisplayRotation) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetRotation)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Scaling(&self) -> Result<DisplayPathScaling, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetScaling(&self, value: DisplayPathScaling) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetScaling)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn FindModes(&self, flags: DisplayModeQueryOptions) -> Result<windows_collections::IVectorView<DisplayModeInfo>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ApplyPropertiesFromMode<P0>(&self, moderesult: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn Properties(&self) -> Result<windows_collections::IMap<windows_core::GUID, windows_core::IInspectable>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Properties)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn PhysicalPresentationRate(&self) -> Result<super::super::super::Foundation::IReference<DisplayPresentationRate>, windows_result::HRESULT> {
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn SetPhysicalPresentationRate<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Foundation::IReference<DisplayPresentationRate>>,
    {
        let this = &windows_core::Interface::cast::<IDisplayPath2>(self)?;
...
impl DisplayPrimaryDescription {
    ...
    #[cfg(feature = "Graphics_DirectX")]
    pub fn ColorSpace(&self) -> Result<super::super::super::Graphics::DirectX::DirectXColorSpace, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MultisampleDescription(&self) -> Result<super::super::super::Graphics::DirectX::Direct3D11::Direct3DMultisampleDescription, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IDisplayPrimaryDescriptionFactory<R, F: FnOnce(&IDisplayPrimaryDescriptionFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IDisplayPrimaryDescriptionStatics<R, F: FnOnce(&IDisplayPrimaryDescriptionStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl DisplaySource {
    #[cfg(feature = "Graphics")]
    pub fn AdapterId(&self) -> Result<super::super::super::Graphics::DisplayAdapterId, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SourceId(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMetadata(&self, key: windows_core::GUID) -> Result<super::super::super::Storage::Streams::IBuffer, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Status(&self) -> Result<DisplaySourceStatus, windows_result::HRESULT> {
...
impl DisplayState {
    ...
    pub fn IsStale(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Targets(&self) -> Result<windows_collections::IVectorView<DisplayTarget>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Views(&self) -> Result<windows_collections::IVectorView<DisplayView>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ConnectTarget<P0>(&self, target: P0) -> Result<DisplayPath, windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplayTarget>,
    {
        let this = self;
    ...
    pub fn ConnectTargetToView<P0, P1>(&self, target: P0, view: P1) -> Result<DisplayPath, windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplayTarget>,
    ...
    pub fn CanConnectTargetToView<P0, P1>(&self, target: P0, view: P1) -> Result<bool, windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplayTarget>,
        P1: windows_core::Param<DisplayView>,
    {
    ...
    pub fn GetViewForTarget<P0>(&self, target: P0) -> Result<DisplayView, windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplayTarget>,
    {
        let this = self;
    ...
    pub fn GetPathForTarget<P0>(&self, target: P0) -> Result<DisplayPath, windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplayTarget>,
    {
        let this = self;
    ...
    pub fn DisconnectTarget<P0>(&self, target: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplayTarget>,
    {
        let this = self;
    ...
    pub fn TryFunctionalize(&self, options: DisplayStateFunctionalizeOptions) -> Result<DisplayStateOperationResult, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryApply(&self, options: DisplayStateApplyOptions) -> Result<DisplayStateOperationResult, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Clone(&self) -> Result<DisplayState, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DisplayStateOperationResult {
    pub fn Status(&self) -> Result<DisplayStateOperationStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl DisplayTarget {
    pub fn Adapter(&self) -> Result<DisplayAdapter, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AdapterRelativeId(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsVirtualModeEnabled(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsVirtualTopologyEnabled(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UsageKind(&self) -> Result<super::DisplayMonitorUsageKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MonitorPersistence(&self) -> Result<DisplayTargetPersistence, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StableMonitorId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryGetMonitor(&self) -> Result<super::DisplayMonitor, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsSame<P0>(&self, othertarget: P0) -> Result<bool, windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplayTarget>,
    {
        let this = self;
    ...
    pub fn IsEqual<P0>(&self, othertarget: P0) -> Result<bool, windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplayTarget>,
    {
        let this = self;
...
impl DisplayTask {
    pub fn SetScanout<P0>(&self, scanout: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn SetWait<P0>(&self, readyfence: P0, readyfencevalue: u64) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn SetSignal<P1>(&self, signalkind: DisplayTaskSignalKind, fence: P1) -> Result<(), windows_result::HRESULT>
    where
...
impl DisplayTaskPool {
    pub fn CreateTask(&self) -> Result<DisplayTask, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ExecuteTask<P0>(&self, task: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn TryExecuteTask<P0>(&self, task: P0) -> Result<DisplayTaskResult, windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplayTask>,
    {
...
impl DisplayTaskResult {
    pub fn PresentStatus(&self) -> Result<DisplayPresentStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PresentId(&self) -> Result<u64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SourceStatus(&self) -> Result<DisplaySourceStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DisplayView {
    pub fn Paths(&self) -> Result<windows_collections::IVectorView<DisplayPath>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics")]
    pub fn ContentResolution(&self) -> Result<super::super::super::Foundation::IReference<super::super::super::Graphics::SizeInt32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics")]
    pub fn SetContentResolution<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Foundation::IReference<super::super::super::Graphics::SizeInt32>>,
    {
        let this = self;
    ...
    pub fn SetPrimaryPath<P0>(&self, path: P0) -> Result<(), windows_result::HRESULT>
    where
...
impl DisplayWireFormat {
    pub fn PixelEncoding(&self) -> Result<DisplayWireFormatPixelEncoding, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BitsPerChannel(&self) -> Result<i32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ColorSpace(&self) -> Result<DisplayWireFormatColorSpace, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ColorSpace)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn Eotf(&self) -> Result<DisplayWireFormatEotf, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HdrMetadata(&self) -> Result<DisplayWireFormatHdrMetadata, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateInstance(pixelencoding: DisplayWireFormatPixelEncoding, bitsperchannel: i32, colorspace: DisplayWireFormatColorSpace, eotf: DisplayWireFormatEotf, hdrmetadata: DisplayWireFormatHdrMetadata) -> Result<DisplayWireFormat, windows_result::HRESULT> {
    ...
    pub fn CreateWithProperties<P0>(extraproperties: P0, pixelencoding: DisplayWireFormatPixelEncoding, bitsperchannel: i32, colorspace: DisplayWireFormatColorSpace, eotf: DisplayWireFormatEotf, hdrmetadata: DisplayWireFormatHdrMetadata) -> Result<DisplayWireFormat, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_collections::IKeyValuePair<windows_core::GUID, windows_core::IInspectable>>>,
    {
    ...
    fn IDisplayWireFormatFactory<R, F: FnOnce(&IDisplayWireFormatFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IDisplayWireFormatStatics<R, F: FnOnce(&IDisplayWireFormatStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
