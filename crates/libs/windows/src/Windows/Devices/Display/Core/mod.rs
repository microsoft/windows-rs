...
impl DisplayAdapter {
    ...
    pub fn Id(&self) -> ::windows::core::Result<super::super::super::Graphics::DisplayAdapterId> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<super::super::super::Graphics::DisplayAdapterId>::uninit();
...
impl DisplayManager {
    ...
    pub fn TryAcquireTarget<'a, Param0: ::windows::core::IntoParam<'a, DisplayTarget>>(&self, target: Param0) -> ::windows::core::Result<DisplayManagerResult> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<DisplayManagerResult>::uninit();
...
impl DisplayModeInfo {
    ...
    pub fn SourceResolution(&self) -> ::windows::core::Result<super::super::super::Graphics::SizeInt32> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<super::super::super::Graphics::SizeInt32>::uninit();
    ...
    pub fn PresentationRate(&self) -> ::windows::core::Result<DisplayPresentationRate> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<DisplayPresentationRate>::uninit();
    ...
    pub fn GetWireFormatSupportedBitsPerChannel(&self, encoding: DisplayWireFormatPixelEncoding) -> ::windows::core::Result<DisplayBitsPerChannel> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<DisplayBitsPerChannel>::uninit();
...
impl DisplayPath {
    ...
    pub fn Status(&self) -> ::windows::core::Result<DisplayPathStatus> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<DisplayPathStatus>::uninit();
    ...
    pub fn Rotation(&self) -> ::windows::core::Result<DisplayRotation> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<DisplayRotation>::uninit();
    ...
    pub fn Scaling(&self) -> ::windows::core::Result<DisplayPathScaling> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<DisplayPathScaling>::uninit();
...
impl DisplayPrimaryDescription {
    ...
    pub fn ColorSpace(&self) -> ::windows::core::Result<super::super::super::Graphics::DirectX::DirectXColorSpace> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<super::super::super::Graphics::DirectX::DirectXColorSpace>::uninit();
    ...
    pub fn MultisampleDescription(&self) -> ::windows::core::Result<super::super::super::Graphics::DirectX::Direct3D11::Direct3DMultisampleDescription> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<super::super::super::Graphics::DirectX::Direct3D11::Direct3DMultisampleDescription>::uninit();
...
impl DisplaySource {
    ...
    pub fn Status(&self) -> ::windows::core::Result<DisplaySourceStatus> {
        ...
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<DisplaySourceStatus>::uninit();
...
impl DisplayStateOperationResult {
    ...
    pub fn Status(&self) -> ::windows::core::Result<DisplayStateOperationStatus> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<DisplayStateOperationStatus>::uninit();
...
impl DisplayTarget {
    ...
    pub fn UsageKind(&self) -> ::windows::core::Result<super::DisplayMonitorUsageKind> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<super::DisplayMonitorUsageKind>::uninit();
    ...
    pub fn MonitorPersistence(&self) -> ::windows::core::Result<DisplayTargetPersistence> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<DisplayTargetPersistence>::uninit();
...
impl DisplayTaskResult {
    ...
    pub fn PresentStatus(&self) -> ::windows::core::Result<DisplayPresentStatus> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<DisplayPresentStatus>::uninit();
...
impl DisplayWireFormat {
    ...
    pub fn PixelEncoding(&self) -> ::windows::core::Result<DisplayWireFormatPixelEncoding> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<DisplayWireFormatPixelEncoding>::uninit();
    ...
    pub fn ColorSpace(&self) -> ::windows::core::Result<DisplayWireFormatColorSpace> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<DisplayWireFormatColorSpace>::uninit();
    ...
    pub fn Eotf(&self) -> ::windows::core::Result<DisplayWireFormatEotf> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<DisplayWireFormatEotf>::uninit();
    ...
    pub fn HdrMetadata(&self) -> ::windows::core::Result<DisplayWireFormatHdrMetadata> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<DisplayWireFormatHdrMetadata>::uninit();
