...
impl DisplayMuxDevice {
    ...
    pub fn SetPreferredTarget<P0>(&self, target: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
        P0: windows_core::Param<DisplayTarget>,
    {
        let this = self;
    ...
    pub fn SetAutomaticTargetSwitching(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FromIdAsync(deviceinterfaceid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<DisplayMuxDevice>> {
        Self::IDisplayMuxDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
