...
impl CustomSensor {
    pub fn GetCurrentReading(&self) -> Result<CustomSensorReading, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn GetDeviceSelector(interfaceid: windows_core::GUID) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn FromIdAsync(sensorid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<CustomSensor>, windows_result::HRESULT> {
        Self::ICustomSensorStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn ICustomSensorStatics<R, F: FnOnce(&ICustomSensorStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl CustomSensorReading {
    ...
    pub fn PerformanceCount(&self) -> Result<super::super::super::Foundation::IReference<super::super::super::Foundation::TimeSpan>, windows_result::HRESULT> {
...
impl CustomSensorReadingChangedEventArgs {
    pub fn Reading(&self) -> Result<CustomSensorReading, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
