...
impl IImageScannerFormatConfiguration {
    pub fn DefaultFormat(&self) -> ::windows_core::Result<ImageScannerFormat> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<ImageScannerFormat>();
...
impl IImageScannerSourceConfiguration {
    ...
    pub fn AutoCroppingMode(&self) -> ::windows_core::Result<ImageScannerAutoCroppingMode> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<ImageScannerAutoCroppingMode>();
    ...
    pub fn MinResolution(&self) -> ::windows_core::Result<ImageScannerResolution> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<ImageScannerResolution>();
    ...
    pub fn DefaultColorMode(&self) -> ::windows_core::Result<ImageScannerColorMode> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<ImageScannerColorMode>();
...
impl ImageScanner {
    ...
    pub fn DefaultScanSource(&self) -> ::windows_core::Result<ImageScannerScanSource> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<ImageScannerScanSource>();
    ...
    pub fn FlatbedConfiguration(&self) -> ::windows_core::Result<ImageScannerFlatbedConfiguration> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<ImageScannerFlatbedConfiguration>();
    ...
    pub fn FeederConfiguration(&self) -> ::windows_core::Result<ImageScannerFeederConfiguration> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<ImageScannerFeederConfiguration>();
    ...
    pub fn AutoConfiguration(&self) -> ::windows_core::Result<ImageScannerAutoConfiguration> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<ImageScannerAutoConfiguration>();
        ...
        P0: ::windows_core::TryIntoParam<super::super::Storage::Streams::IRandomAccessStream>,
    {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<ImageScannerPreviewResult>>();
    ...
    #[cfg(all(feature = "Foundation", feature = "Storage"))]
    pub fn ScanFilesToFolderAsync(&self, scansource: ImageScannerScanSource, storagefolder: &super::super::Storage::StorageFolder) -> ::windows_core::Result<super::super::Foundation::IAsyncOperationWithProgress<ImageScannerScanResult, u32>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperationWithProgress<ImageScannerScanResult, u32>>();
            (::windows_core::Interface::vtable(this).ScanFilesToFolderAsync)(::windows_core::Interface::as_raw(this), scansource, ::core::mem::transmute_copy(storagefolder), &mut result__).from_abi(result__)
        }
    }
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn FromIdAsync(deviceid: &::windows_core::HSTRING) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<ImageScanner>> {
        Self::IImageScannerStatics(|this| unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<ImageScanner>>();
...
impl ImageScannerFeederConfiguration {
    ...
    pub fn PageSize(&self) -> ::windows_core::Result<super::super::Graphics::Printing::PrintMediaSize> {
        let this = &::windows_core::ComInterface::cast::<IImageScannerFeederConfiguration>(self)?;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Graphics::Printing::PrintMediaSize>();
    ...
    pub fn PageOrientation(&self) -> ::windows_core::Result<super::super::Graphics::Printing::PrintOrientation> {
        let this = &::windows_core::ComInterface::cast::<IImageScannerFeederConfiguration>(self)?;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Graphics::Printing::PrintOrientation>();
