...
windows_core::imp::required_hierarchy!(ImageScanner, IImageScanner, IImageScannerStatics);
impl ImageScanner {
...
windows_core::imp::required_hierarchy!(ImageScannerFeederConfiguration, IImageScannerFeederConfiguration, IImageScannerFormatConfiguration, IImageScannerSourceConfiguration);
...
windows_core::imp::required_hierarchy!(ImageScannerPreviewResult, IImageScannerPreviewResult);
...
windows_core::imp::required_hierarchy!(ImageScannerScanResult, IImageScannerScanResult);
