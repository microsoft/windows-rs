...
impl ImageScanner {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ScanPreviewToStreamAsync<P1>(&self, scansource: ImageScannerScanSource, targetstream: P1) -> windows_core::Result<windows_async::IAsyncOperation<ImageScannerPreviewResult>>
    where
    ...
    #[cfg(feature = "Storage_Search")]
    pub fn ScanFilesToFolderAsync<P1>(&self, scansource: ImageScannerScanSource, storagefolder: P1) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<ImageScannerScanResult, u32>>
    where
    ...
    pub fn FromIdAsync(deviceid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<ImageScanner>> {
