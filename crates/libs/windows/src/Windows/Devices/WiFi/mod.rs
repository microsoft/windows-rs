...
impl WiFiAdapter {
    #[cfg(feature = "Networking_Connectivity")]
    pub fn NetworkAdapter(&self) -> windows_result::Result<super::super::Networking::Connectivity::NetworkAdapter> {
        let this = self;
        unsafe {
    ...
    pub fn ScanAsync(&self) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NetworkReport(&self) -> windows_result::Result<WiFiNetworkReport> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AvailableNetworksChanged<P0>(&self, args: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveAvailableNetworksChanged(&self, eventcookie: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn ConnectAsync<P0>(&self, availablenetwork: P0, reconnectionkind: WiFiReconnectionKind) -> windows_result::Result<windows_future::IAsyncOperation<WiFiConnectionResult>>
    where
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn ConnectWithPasswordCredentialAsync<P0, P2>(&self, availablenetwork: P0, reconnectionkind: WiFiReconnectionKind, passwordcredential: P2) -> windows_result::Result<windows_future::IAsyncOperation<WiFiConnectionResult>>
    where
        P0: windows_core::Param<WiFiAvailableNetwork>,
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn ConnectWithPasswordCredentialAndSsidAsync<P0, P2>(&self, availablenetwork: P0, reconnectionkind: WiFiReconnectionKind, passwordcredential: P2, ssid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<WiFiConnectionResult>>
    where
        P0: windows_core::Param<WiFiAvailableNetwork>,
        P2: windows_core::Param<super::super::Security::Credentials::PasswordCredential>,
    {
    ...
    pub fn Disconnect(&self) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).Disconnect)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn GetWpsConfigurationAsync<P0>(&self, availablenetwork: P0) -> windows_result::Result<windows_future::IAsyncOperation<WiFiWpsConfigurationResult>>
    where
        P0: windows_core::Param<WiFiAvailableNetwork>,
    {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn ConnectWithPasswordCredentialAndSsidAndConnectionMethodAsync<P0, P2>(&self, availablenetwork: P0, reconnectionkind: WiFiReconnectionKind, passwordcredential: P2, ssid: &windows_core::HSTRING, connectionmethod: WiFiConnectionMethod) -> windows_result::Result<windows_future::IAsyncOperation<WiFiConnectionResult>>
    where
        P0: windows_core::Param<WiFiAvailableNetwork>,
        P2: windows_core::Param<super::super::Security::Credentials::PasswordCredential>,
    {
    ...
    pub fn FindAllAdaptersAsync() -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<WiFiAdapter>>> {
    ...
    pub fn FromIdAsync(deviceid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<WiFiAdapter>> {
        Self::IWiFiAdapterStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FromIdAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(deviceid), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn RequestAccessAsync() -> windows_result::Result<windows_future::IAsyncOperation<WiFiAccessStatus>> {
        Self::IWiFiAdapterStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IWiFiAdapterStatics<R, F: FnOnce(&IWiFiAdapterStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl WiFiAvailableNetwork {
    pub fn Uptime(&self) -> windows_result::Result<super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Ssid(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Bssid(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ChannelCenterFrequencyInKilohertz(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NetworkRssiInDecibelMilliwatts(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SignalBars(&self) -> windows_result::Result<u8> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NetworkKind(&self) -> windows_result::Result<WiFiNetworkKind> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PhyKind(&self) -> windows_result::Result<WiFiPhyKind> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Networking_Connectivity")]
    pub fn SecuritySettings(&self) -> windows_result::Result<super::super::Networking::Connectivity::NetworkSecuritySettings> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BeaconInterval(&self) -> windows_result::Result<super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsWiFiDirect(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WiFiConnectionResult {
    pub fn ConnectionStatus(&self) -> windows_result::Result<WiFiConnectionStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WiFiNetworkReport {
    ...
    pub fn AvailableNetworks(&self) -> windows_result::Result<windows_collections::IVectorView<WiFiAvailableNetwork>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WiFiOnDemandHotspotConnectTriggerDetails {
    pub fn RequestedNetwork(&self) -> windows_result::Result<WiFiOnDemandHotspotNetwork> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReportError(&self, status: WiFiOnDemandHotspotConnectStatus) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).ReportError)(windows_core::Interface::as_raw(this), status).ok() }
    }
    pub fn ConnectAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<WiFiOnDemandHotspotConnectionResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Connect(&self) -> windows_result::Result<WiFiOnDemandHotspotConnectionResult> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WiFiOnDemandHotspotConnectionResult {
    pub fn Status(&self) -> windows_result::Result<WiFiOnDemandHotspotConnectStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WiFiOnDemandHotspotNetwork {
    pub fn GetProperties(&self) -> windows_result::Result<WiFiOnDemandHotspotNetworkProperties> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UpdateProperties<P0>(&self, newproperties: P0) -> windows_result::Result<()>
    where
    ...
    pub fn GetOrCreateById(networkid: windows_core::GUID) -> windows_result::Result<WiFiOnDemandHotspotNetwork> {
    ...
    fn IWiFiOnDemandHotspotNetworkStatics<R, F: FnOnce(&IWiFiOnDemandHotspotNetworkStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl WiFiOnDemandHotspotNetworkProperties {
    ...
    pub fn Availability(&self) -> windows_result::Result<WiFiOnDemandHotspotAvailability> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAvailability(&self, value: WiFiOnDemandHotspotAvailability) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAvailability)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn RemainingBatteryPercent(&self) -> windows_result::Result<super::super::Foundation::IReference<u32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRemainingBatteryPercent<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn CellularBars(&self) -> windows_result::Result<super::super::Foundation::IReference<WiFiOnDemandHotspotCellularBars>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCellularBars<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn IsMetered(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsMetered(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetSsid(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSsid)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(value)).ok() }
    }
    #[cfg(feature = "Security_Credentials")]
    pub fn Password(&self) -> windows_result::Result<super::super::Security::Credentials::PasswordCredential> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn SetPassword<P0>(&self, value: P0) -> windows_result::Result<()>
    where
...
impl WiFiWpsConfigurationResult {
    pub fn Status(&self) -> windows_result::Result<WiFiWpsConfigurationStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn SupportedWpsKinds(&self) -> windows_result::Result<windows_collections::IVectorView<WiFiWpsKind>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
