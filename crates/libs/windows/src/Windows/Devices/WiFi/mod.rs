...
windows_core::imp::required_hierarchy!(WiFiAdapter, IWiFiAdapter, IWiFiAdapter2, IWiFiAdapterStatics);
impl WiFiAdapter {
    #[cfg(feature = "Networking_Connectivity")]
...
windows_core::imp::required_hierarchy!(WiFiAvailableNetwork, IWiFiAvailableNetwork);
...
windows_core::imp::required_hierarchy!(WiFiConnectionResult, IWiFiConnectionResult);
...
windows_core::imp::required_hierarchy!(WiFiNetworkReport, IWiFiNetworkReport);
...
windows_core::imp::required_hierarchy!(WiFiOnDemandHotspotConnectTriggerDetails, IWiFiOnDemandHotspotConnectTriggerDetails);
...
windows_core::imp::required_hierarchy!(WiFiOnDemandHotspotConnectionResult, IWiFiOnDemandHotspotConnectionResult);
...
windows_core::imp::required_hierarchy!(WiFiOnDemandHotspotNetwork, IWiFiOnDemandHotspotNetwork, IWiFiOnDemandHotspotNetworkStatics);
...
windows_core::imp::required_hierarchy!(WiFiOnDemandHotspotNetworkProperties, IWiFiOnDemandHotspotNetworkProperties);
...
windows_core::imp::required_hierarchy!(WiFiWpsConfigurationResult, IWiFiWpsConfigurationResult);
