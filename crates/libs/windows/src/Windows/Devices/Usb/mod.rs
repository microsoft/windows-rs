...
impl UsbBulkInPipe {
    ...
    pub fn ClearStallAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UsbDevice {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SendControlOutTransferAsync<P0, P1>(&self, setuppacket: P0, buffer: P1) -> windows_core::Result<windows_async::IAsyncOperation<u32>>
    where
    ...
    pub fn SendControlOutTransferAsyncNoBuffer<P0>(&self, setuppacket: P0) -> windows_core::Result<windows_async::IAsyncOperation<u32>>
    where
        P0: windows_core::Param<UsbSetupPacket>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SendControlInTransferAsync<P0, P1>(&self, setuppacket: P0, buffer: P1) -> windows_core::Result<windows_async::IAsyncOperation<super::super::Storage::Streams::IBuffer>>
    where
        P0: windows_core::Param<UsbSetupPacket>,
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SendControlInTransferAsyncNoBuffer<P0>(&self, setuppacket: P0) -> windows_core::Result<windows_async::IAsyncOperation<super::super::Storage::Streams::IBuffer>>
    where
        P0: windows_core::Param<UsbSetupPacket>,
    {
        let this = self;
    ...
    pub fn FromIdAsync(deviceid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<UsbDevice>> {
        Self::IUsbDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UsbInterfaceSetting {
    ...
    pub fn SelectSettingAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
