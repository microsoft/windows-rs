...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ORCreateKey<P1, P2>(keyhandle: ORHKEY, lpsubkey: P1, lpclass: P2, dwoptions: Option<u32>, psecuritydescriptor: Option<super::super::Win32::winnt::PSECURITY_DESCRIPTOR>, phkresult: *mut ORHKEY, pdwdisposition: Option<*mut u32>) -> u32
where
    P1: windows_core::Param<windows_core::PCWSTR>,
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("offreg.dll" "C" fn ORCreateKey(keyhandle : ORHKEY, lpsubkey : windows_core::PCWSTR, lpclass : windows_core::PCWSTR, dwoptions : u32, psecuritydescriptor : super::super::Win32::winnt::PSECURITY_DESCRIPTOR, phkresult : *mut ORHKEY, pdwdisposition : *mut u32) -> u32);
...
#[inline]
pub unsafe fn OREnumKey(handle: ORHKEY, dwindex: u32, lpname: windows_core::PWSTR, lpcname: *mut u32, lpclass: Option<windows_core::PWSTR>, lpcclass: Option<*mut u32>, lpftlastwritetime: Option<*mut super::super::Win32::minwindef::FILETIME>) -> u32 {
    windows_core::link!("offreg.dll" "C" fn OREnumKey(handle : ORHKEY, dwindex : u32, lpname : windows_core::PWSTR, lpcname : *mut u32, lpclass : windows_core::PWSTR, lpcclass : *mut u32, lpftlastwritetime : *mut super::super::Win32::minwindef::FILETIME) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ORGetKeySecurity(handle: ORHKEY, securityinformation: super::super::Win32::winnt::SECURITY_INFORMATION, psecuritydescriptor: Option<super::super::Win32::winnt::PSECURITY_DESCRIPTOR>, lpcbsecuritydescriptor: *mut u32) -> u32 {
    windows_core::link!("offreg.dll" "C" fn ORGetKeySecurity(handle : ORHKEY, securityinformation : super::super::Win32::winnt::SECURITY_INFORMATION, psecuritydescriptor : super::super::Win32::winnt::PSECURITY_DESCRIPTOR, lpcbsecuritydescriptor : *mut u32) -> u32);
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn OROpenHiveByHandle(filehandle: super::super::Win32::winnt::HANDLE, horkey: *mut ORHKEY) -> u32 {
    windows_core::link!("offreg.dll" "C" fn OROpenHiveByHandle(filehandle : super::super::Win32::winnt::HANDLE, horkey : *mut ORHKEY) -> u32);
...
#[cfg(feature = "minwindef")]
#[inline]
pub unsafe fn ORQueryInfoKey(handle: ORHKEY, lpclass: Option<windows_core::PWSTR>, lpcclass: Option<*mut u32>, lpcsubkeys: Option<*mut u32>, lpcmaxsubkeylen: Option<*mut u32>, lpcmaxclasslen: Option<*mut u32>, lpcvalues: Option<*mut u32>, lpcmaxvaluenamelen: Option<*mut u32>, lpcmaxvaluelen: Option<*mut u32>, lpcbsecuritydescriptor: Option<*mut u32>, lpftlastwritetime: Option<*mut super::super::Win32::minwindef::FILETIME>) -> u32 {
...
#[cfg(feature = "winnt")]
#[inline]
pub unsafe fn ORSetKeySecurity(handle: ORHKEY, securityinformation: super::super::Win32::winnt::SECURITY_INFORMATION, psecuritydescriptor: super::super::Win32::winnt::PSECURITY_DESCRIPTOR) -> u32 {
    windows_core::link!("offreg.dll" "C" fn ORSetKeySecurity(handle : ORHKEY, securityinformation : super::super::Win32::winnt::SECURITY_INFORMATION, psecuritydescriptor : super::super::Win32::winnt::PSECURITY_DESCRIPTOR) -> u32);
