...
pub const CachedNetBufferList: NDIS_PER_PACKET_INFO = NDIS_PER_PACKET_INFO(10);
pub const ClassificationHandlePacketInfo: NDIS_PER_PACKET_INFO = NDIS_PER_PACKET_INFO(3);
...
pub const Ieee8021QInfo: NDIS_PER_PACKET_INFO = NDIS_PER_PACKET_INFO(6);
pub const IpSecPacketInfo: NDIS_PER_PACKET_INFO = NDIS_PER_PACKET_INFO(1);
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq)]
...
pub const MaxPerPacketInfo: NDIS_PER_PACKET_INFO = NDIS_PER_PACKET_INFO(12);
...
pub const NdisClass802_3Priority: NDIS_CLASS_ID = NDIS_CLASS_ID(0);
pub const NdisClassAtmAALInfo: NDIS_CLASS_ID = NDIS_CLASS_ID(3);
pub const NdisClassIrdaPacketInfo: NDIS_CLASS_ID = NDIS_CLASS_ID(2);
pub const NdisClassWirelessWanMbxMailbox: NDIS_CLASS_ID = NDIS_CLASS_ID(1);
pub const NdisDefinitelyNetworkChange: NDIS_NETWORK_CHANGE_TYPE = NDIS_NETWORK_CHANGE_TYPE(2);
pub const NdisDevicePnPEventMaximum: NDIS_DEVICE_PNP_EVENT = NDIS_DEVICE_PNP_EVENT(6);
pub const NdisDevicePnPEventPowerProfileChanged: NDIS_DEVICE_PNP_EVENT = NDIS_DEVICE_PNP_EVENT(5);
pub const NdisDevicePnPEventQueryRemoved: NDIS_DEVICE_PNP_EVENT = NDIS_DEVICE_PNP_EVENT(0);
pub const NdisDevicePnPEventQueryStopped: NDIS_DEVICE_PNP_EVENT = NDIS_DEVICE_PNP_EVENT(3);
pub const NdisDevicePnPEventRemoved: NDIS_DEVICE_PNP_EVENT = NDIS_DEVICE_PNP_EVENT(1);
pub const NdisDevicePnPEventStopped: NDIS_DEVICE_PNP_EVENT = NDIS_DEVICE_PNP_EVENT(4);
pub const NdisDevicePnPEventSurpriseRemoved: NDIS_DEVICE_PNP_EVENT = NDIS_DEVICE_PNP_EVENT(2);
...
pub const NdisEnvironmentWindows: NDIS_ENVIRONMENT_TYPE = NDIS_ENVIRONMENT_TYPE(0);
pub const NdisEnvironmentWindowsNt: NDIS_ENVIRONMENT_TYPE = NDIS_ENVIRONMENT_TYPE(1);
...
pub const NdisInterface1394: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(18);
pub const NdisInterfaceCBus: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(9);
pub const NdisInterfaceEisa: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(2);
pub const NdisInterfaceInternal: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(0);
pub const NdisInterfaceInternalPowerBus: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(13);
pub const NdisInterfaceIrda: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(17);
pub const NdisInterfaceIsa: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(1);
pub const NdisInterfaceMPIBus: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(10);
pub const NdisInterfaceMPSABus: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(11);
pub const NdisInterfaceMca: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(3);
pub const NdisInterfacePNPBus: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(15);
pub const NdisInterfacePNPISABus: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(14);
pub const NdisInterfacePcMcia: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(8);
pub const NdisInterfacePci: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(5);
pub const NdisInterfaceProcessorInternal: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(12);
pub const NdisInterfaceTurboChannel: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(4);
pub const NdisInterfaceUSB: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(16);
...
pub const NdisMaximumInterfaceType: NDIS_INTERFACE_TYPE = NDIS_INTERFACE_TYPE(19);
...
pub const NdisParameterBinary: NDIS_PARAMETER_TYPE = NDIS_PARAMETER_TYPE(4);
pub const NdisParameterHexInteger: NDIS_PARAMETER_TYPE = NDIS_PARAMETER_TYPE(1);
pub const NdisParameterInteger: NDIS_PARAMETER_TYPE = NDIS_PARAMETER_TYPE(0);
pub const NdisParameterMultiString: NDIS_PARAMETER_TYPE = NDIS_PARAMETER_TYPE(3);
pub const NdisParameterString: NDIS_PARAMETER_TYPE = NDIS_PARAMETER_TYPE(2);
...
pub const NdisPowerProfileAcOnLine: NDIS_POWER_PROFILE = NDIS_POWER_PROFILE(1);
pub const NdisPowerProfileBattery: NDIS_POWER_PROFILE = NDIS_POWER_PROFILE(0);
pub const NdisProcessorAlpha: NDIS_PROCESSOR_TYPE = NDIS_PROCESSOR_TYPE(2);
pub const NdisProcessorAmd64: NDIS_PROCESSOR_TYPE = NDIS_PROCESSOR_TYPE(4);
pub const NdisProcessorArm: NDIS_PROCESSOR_TYPE = NDIS_PROCESSOR_TYPE(6);
pub const NdisProcessorArm64: NDIS_PROCESSOR_TYPE = NDIS_PROCESSOR_TYPE(7);
pub const NdisProcessorIA64: NDIS_PROCESSOR_TYPE = NDIS_PROCESSOR_TYPE(5);
pub const NdisProcessorMips: NDIS_PROCESSOR_TYPE = NDIS_PROCESSOR_TYPE(1);
pub const NdisProcessorPpc: NDIS_PROCESSOR_TYPE = NDIS_PROCESSOR_TYPE(3);
...
pub const NdisProcessorX86: NDIS_PROCESSOR_TYPE = NDIS_PROCESSOR_TYPE(0);
...
pub const NdisReserved: NDIS_PER_PACKET_INFO = NDIS_PER_PACKET_INFO(4);
...
pub const OriginalNetBufferList: NDIS_PER_PACKET_INFO = NDIS_PER_PACKET_INFO(9);
pub const OriginalPacketInfo: NDIS_PER_PACKET_INFO = NDIS_PER_PACKET_INFO(7);
...
pub const PacketCancelId: NDIS_PER_PACKET_INFO = NDIS_PER_PACKET_INFO(8);
...
pub const ScatterGatherListPacketInfo: NDIS_PER_PACKET_INFO = NDIS_PER_PACKET_INFO(5);
pub const ShortPacketPaddingInfo: NDIS_PER_PACKET_INFO = NDIS_PER_PACKET_INFO(11);
...
pub const TcpIpChecksumPacketInfo: NDIS_PER_PACKET_INFO = NDIS_PER_PACKET_INFO(0);
pub const TcpLargeSendPacketInfo: NDIS_PER_PACKET_INFO = NDIS_PER_PACKET_INFO(2);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
