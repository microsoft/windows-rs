...
#[inline]
pub unsafe fn OREnumKey<P2, P4>(handle: ORHKEY, dwindex: u32, lpname: P2, lpcname: *mut u32, lpclass: P4, lpcclass: *mut u32, lpftlastwritetime: *mut super::super::super::Win32::Foundation::FILETIME) -> windows_core::WIN32_ERROR
where
    P2: windows_core::Param<windows_core::PCWSTR>,
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("offreg.dll" "system" fn OREnumKey(handle : ORHKEY, dwindex : u32, lpname : windows_core::PCWSTR, lpcname : *mut u32, lpclass : windows_core::PCWSTR, lpcclass : *mut u32, lpftlastwritetime : *mut super::super::super::Win32::Foundation:: FILETIME) -> windows_core:: WIN32_ERROR);
    unsafe { OREnumKey(handle, dwindex, lpname.param().abi(), lpcname as _, lpclass.param().abi(), lpcclass as _, lpftlastwritetime as _) }
}
#[inline]
pub unsafe fn OREnumValue<P2>(handle: ORHKEY, dwindex: u32, lpvaluename: P2, lpcvaluename: *mut u32, lptype: *mut u32, lpdata: *mut u8, lpcbdata: *mut u32) -> windows_core::WIN32_ERROR
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("offreg.dll" "system" fn OREnumValue(handle : ORHKEY, dwindex : u32, lpvaluename : windows_core::PCWSTR, lpcvaluename : *mut u32, lptype : *mut u32, lpdata : *mut u8, lpcbdata : *mut u32) -> windows_core:: WIN32_ERROR);
    unsafe { OREnumValue(handle, dwindex, lpvaluename.param().abi(), lpcvaluename as _, lptype as _, lpdata as _, lpcbdata as _) }
}
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn ORGetKeySecurity(handle: ORHKEY, securityinformation: u32, psecuritydescriptor: super::super::super::Win32::Security::PSECURITY_DESCRIPTOR, lpcbsecuritydescriptor: *mut u32) -> windows_core::WIN32_ERROR {
    ...
    unsafe { ORGetKeySecurity(handle, securityinformation, psecuritydescriptor, lpcbsecuritydescriptor as _) }
}
#[inline]
...
#[inline]
pub unsafe fn ORQueryInfoKey<P1>(handle: ORHKEY, lpclass: P1, lpcclass: *mut u32, lpcsubkeys: *mut u32, lpcmaxsubkeylen: *mut u32, lpcmaxclasslen: *mut u32, lpcvalues: *mut u32, lpcmaxvaluenamelen: *mut u32, lpcmaxvaluelen: *mut u32, lpcbsecuritydescriptor: *mut u32, lpftlastwritetime: *mut super::super::super::Win32::Foundation::FILETIME) -> windows_core::WIN32_ERROR
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("offreg.dll" "system" fn ORQueryInfoKey(handle : ORHKEY, lpclass : windows_core::PCWSTR, lpcclass : *mut u32, lpcsubkeys : *mut u32, lpcmaxsubkeylen : *mut u32, lpcmaxclasslen : *mut u32, lpcvalues : *mut u32, lpcmaxvaluenamelen : *mut u32, lpcmaxvaluelen : *mut u32, lpcbsecuritydescriptor : *mut u32, lpftlastwritetime : *mut super::super::super::Win32::Foundation:: FILETIME) -> windows_core:: WIN32_ERROR);
    unsafe { ORQueryInfoKey(handle, lpclass.param().abi(), lpcclass as _, lpcsubkeys as _, lpcmaxsubkeylen as _, lpcmaxclasslen as _, lpcvalues as _, lpcmaxvaluenamelen as _, lpcmaxvaluelen as _, lpcbsecuritydescriptor as _, lpftlastwritetime as _) }
}
#[inline]
...
#[inline]
pub unsafe fn ORSetValue<P1>(handle: ORHKEY, lpvaluename: P1, dwtype: u32, lpdata: *mut u8, cbdata: u32) -> windows_core::WIN32_ERROR
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("offreg.dll" "system" fn ORSetValue(handle : ORHKEY, lpvaluename : windows_core::PCWSTR, dwtype : u32, lpdata : *mut u8, cbdata : u32) -> windows_core:: WIN32_ERROR);
    unsafe { ORSetValue(handle, lpvaluename.param().abi(), dwtype, lpdata as _, cbdata) }
}
#[inline]
