    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    ORCreateKey(keyhandle, lpsubkey.param().abi(), lpclass.param().abi(), core::mem::transmute(dwoptions.unwrap_or(core::mem::zeroed())), core::mem::transmute(psecuritydescriptor.unwrap_or(core::mem::zeroed())), core::mem::transmute(phkresult), core::mem::transmute(pdwdisposition.unwrap_or(core::mem::zeroed())))
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    ORDeleteKey(handle, lpsubkey.param().abi())
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    ORDeleteValue(handle, lpvaluename.param().abi())
}
#[inline]
pub unsafe fn OREnumKey(handle: ORHKEY, dwindex: u32, lpname: windows_core::PWSTR, lpcname: *mut u32, lpclass: Option<windows_core::PWSTR>, lpcclass: Option<*mut u32>, lpftlastwritetime: Option<*mut super::super::super::Win32::Foundation::FILETIME>) -> super::super::super::Win32::Foundation::WIN32_ERROR {
    ...
    OREnumKey(handle, dwindex, core::mem::transmute(lpname), core::mem::transmute(lpcname), core::mem::transmute(lpclass.unwrap_or(core::mem::zeroed())), core::mem::transmute(lpcclass.unwrap_or(core::mem::zeroed())), core::mem::transmute(lpftlastwritetime.unwrap_or(core::mem::zeroed())))
}
#[inline]
pub unsafe fn OREnumValue(handle: ORHKEY, dwindex: u32, lpvaluename: windows_core::PWSTR, lpcvaluename: *mut u32, lptype: Option<*mut u32>, lpdata: Option<*mut u8>, lpcbdata: Option<*mut u32>) -> super::super::super::Win32::Foundation::WIN32_ERROR {
    ...
    OREnumValue(handle, dwindex, core::mem::transmute(lpvaluename), core::mem::transmute(lpcvaluename), core::mem::transmute(lptype.unwrap_or(core::mem::zeroed())), core::mem::transmute(lpdata.unwrap_or(core::mem::zeroed())), core::mem::transmute(lpcbdata.unwrap_or(core::mem::zeroed())))
}
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn ORGetKeySecurity(handle: ORHKEY, securityinformation: u32, psecuritydescriptor: Option<super::super::super::Win32::Security::PSECURITY_DESCRIPTOR>, lpcbsecuritydescriptor: *mut u32) -> super::super::super::Win32::Foundation::WIN32_ERROR {
    ...
    ORGetKeySecurity(handle, securityinformation, core::mem::transmute(psecuritydescriptor.unwrap_or(core::mem::zeroed())), core::mem::transmute(lpcbsecuritydescriptor))
}
#[inline]
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    ORGetValue(handle, lpsubkey.param().abi(), lpvalue.param().abi(), core::mem::transmute(pdwtype.unwrap_or(core::mem::zeroed())), core::mem::transmute(pvdata.unwrap_or(core::mem::zeroed())), core::mem::transmute(pcbdata.unwrap_or(core::mem::zeroed())))
}
#[inline]
...
pub unsafe fn ORGetVirtualFlags(handle: ORHKEY, pdwflags: *mut u32) -> super::super::super::Win32::Foundation::WIN32_ERROR {
    ...
    ORGetVirtualFlags(handle, core::mem::transmute(pdwflags))
}
#[inline]
...
pub unsafe fn OROpenHiveByHandle(filehandle: super::super::super::Win32::Foundation::HANDLE, horkey: *mut ORHKEY) -> super::super::super::Win32::Foundation::WIN32_ERROR {
    ...
    OROpenHiveByHandle(filehandle, core::mem::transmute(horkey))
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    OROpenKey(handle, lpsubkey.param().abi(), core::mem::transmute(phkresult))
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    ORRenameKey(handle, lpnewname.param().abi())
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    ORSaveHive(horkey, hivepath.param().abi(), osmajorversion, osminorversion)
}
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn ORSetKeySecurity(handle: ORHKEY, securityinformation: u32, psecuritydescriptor: super::super::super::Win32::Security::PSECURITY_DESCRIPTOR) -> super::super::super::Win32::Foundation::WIN32_ERROR {
    ...
    ORSetKeySecurity(handle, securityinformation, psecuritydescriptor)
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    ORSetValue(handle, lpvaluename.param().abi(), dwtype, core::mem::transmute(lpdata.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), lpdata.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()))
}
#[inline]
pub unsafe fn ORSetVirtualFlags(handle: ORHKEY, dwflags: u32) -> super::super::super::Win32::Foundation::WIN32_ERROR {
    ...
    ORSetVirtualFlags(handle, dwflags)
}
#[inline]
