...
#[inline]
pub unsafe fn ORCreateKey(keyhandle: ORHKEY, lpsubkey: windows_core::PCWSTR, lpclass: Option<windows_core::PCWSTR>, dwoptions: Option<u32>, psecuritydescriptor: Option<super::super::super::Win32::Security::PSECURITY_DESCRIPTOR>, phkresult: *mut ORHKEY, pdwdisposition: Option<*mut u32>) -> windows_core::WIN32_ERROR {
    ...
    unsafe { ORCreateKey(keyhandle, core::mem::transmute(lpsubkey), lpclass.unwrap_or(core::mem::zeroed()) as _, dwoptions.unwrap_or(core::mem::zeroed()) as _, psecuritydescriptor.unwrap_or(core::mem::zeroed()) as _, phkresult as _, pdwdisposition.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn ORDeleteKey(handle: ORHKEY, lpsubkey: Option<windows_core::PCWSTR>) -> windows_core::WIN32_ERROR {
    windows_core::link!("offreg.dll" "system" fn ORDeleteKey(handle : ORHKEY, lpsubkey : windows_core::PCWSTR) -> windows_core:: WIN32_ERROR);
    unsafe { ORDeleteKey(handle, lpsubkey.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
pub unsafe fn ORDeleteValue(handle: ORHKEY, lpvaluename: Option<windows_core::PCWSTR>) -> windows_core::WIN32_ERROR {
    ...
    unsafe { ORDeleteValue(handle, lpvaluename.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn OREnumValue(handle: ORHKEY, dwindex: u32, lpvaluename: windows_core::PWSTR, lpcvaluename: *mut u32, lptype: Option<*mut u32>, lpdata: Option<*mut u8>, lpcbdata: Option<*mut u32>) -> windows_core::WIN32_ERROR {
...
#[cfg(feature = "Win32_Security")]
#[inline]
pub unsafe fn ORGetKeySecurity(handle: ORHKEY, securityinformation: u32, psecuritydescriptor: Option<super::super::super::Win32::Security::PSECURITY_DESCRIPTOR>, lpcbsecuritydescriptor: *mut u32) -> windows_core::WIN32_ERROR {
...
#[inline]
pub unsafe fn ORGetValue(handle: ORHKEY, lpsubkey: Option<windows_core::PCWSTR>, lpvalue: Option<windows_core::PCWSTR>, pdwtype: Option<*mut u32>, pvdata: Option<*mut core::ffi::c_void>, pcbdata: Option<*mut u32>) -> windows_core::WIN32_ERROR {
    ...
    unsafe { ORGetValue(handle, lpsubkey.unwrap_or(core::mem::zeroed()) as _, lpvalue.unwrap_or(core::mem::zeroed()) as _, pdwtype.unwrap_or(core::mem::zeroed()) as _, pvdata.unwrap_or(core::mem::zeroed()) as _, pcbdata.unwrap_or(core::mem::zeroed()) as _) }
}
#[inline]
...
#[inline]
pub unsafe fn ORMergeHives(hivehandles: &[ORHKEY], phkresult: *mut ORHKEY) -> windows_core::WIN32_ERROR {
...
#[inline]
pub unsafe fn OROpenHive(filepath: windows_core::PCWSTR, horkey: *mut ORHKEY) -> windows_core::WIN32_ERROR {
    ...
    unsafe { OROpenHive(core::mem::transmute(filepath), horkey as _) }
}
#[inline]
...
#[inline]
pub unsafe fn OROpenKey(handle: ORHKEY, lpsubkey: Option<windows_core::PCWSTR>, phkresult: *mut ORHKEY) -> windows_core::WIN32_ERROR {
    ...
    unsafe { OROpenKey(handle, lpsubkey.unwrap_or(core::mem::zeroed()) as _, phkresult as _) }
}
#[inline]
...
#[inline]
pub unsafe fn ORRenameKey(handle: ORHKEY, lpnewname: windows_core::PCWSTR) -> windows_core::WIN32_ERROR {
    windows_core::link!("offreg.dll" "system" fn ORRenameKey(handle : ORHKEY, lpnewname : windows_core::PCWSTR) -> windows_core:: WIN32_ERROR);
    unsafe { ORRenameKey(handle, core::mem::transmute(lpnewname)) }
}
#[inline]
pub unsafe fn ORSaveHive(horkey: ORHKEY, hivepath: windows_core::PCWSTR, osmajorversion: u32, osminorversion: u32) -> windows_core::WIN32_ERROR {
    ...
    unsafe { ORSaveHive(horkey, core::mem::transmute(hivepath), osmajorversion, osminorversion) }
}
#[cfg(feature = "Win32_Security")]
#[inline]
...
#[inline]
pub unsafe fn ORSetValue(handle: ORHKEY, lpvaluename: Option<windows_core::PCWSTR>, dwtype: u32, lpdata: Option<&[u8]>) -> windows_core::WIN32_ERROR {
    ...
    unsafe { ORSetValue(handle, lpvaluename.unwrap_or(core::mem::zeroed()) as _, dwtype, core::mem::transmute(lpdata.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), lpdata.as_deref().map_or(0, |slice| slice.len().try_into().unwrap())) }
}
#[inline]
