    ...
    P4: windows_core::Param<super::super::super::Win32::Security::PSECURITY_DESCRIPTOR>,
{
    ...
    ORCreateKey(keyhandle.param().abi(), lpsubkey.param().abi(), lpclass.param().abi(), core::mem::transmute(dwoptions), psecuritydescriptor.param().abi(), core::mem::transmute(phkresult), core::mem::transmute(pdwdisposition.unwrap_or(core::ptr::null_mut())))
}
#[inline]
    ...
    P0: windows_core::Param<ORHKEY>,
{
    ...
    OREnumKey(handle.param().abi(), core::mem::transmute(dwindex), core::mem::transmute(lpname), core::mem::transmute(lpcname), core::mem::transmute(lpclass), core::mem::transmute(lpcclass.unwrap_or(core::ptr::null_mut())), core::mem::transmute(lpftlastwritetime.unwrap_or(core::ptr::null_mut())))
}
#[inline]
    ...
    P0: windows_core::Param<ORHKEY>,
{
    ...
    OREnumValue(handle.param().abi(), core::mem::transmute(dwindex), core::mem::transmute(lpvaluename), core::mem::transmute(lpcvaluename), core::mem::transmute(lptype.unwrap_or(core::ptr::null_mut())), core::mem::transmute(lpdata.unwrap_or(core::ptr::null_mut())), core::mem::transmute(lpcbdata.unwrap_or(core::ptr::null_mut())))
}
#[cfg(feature = "Win32_Security")]
#[inline]
    ...
    P0: windows_core::Param<ORHKEY>,
{
    ...
    ORGetKeySecurity(handle.param().abi(), core::mem::transmute(securityinformation), core::mem::transmute(psecuritydescriptor), core::mem::transmute(lpcbsecuritydescriptor))
}
#[inline]
    ...
    P0: windows_core::Param<ORHKEY>,
{
    ...
    ORGetVirtualFlags(handle.param().abi(), core::mem::transmute(pdwflags))
}
#[inline]
    ...
    P0: windows_core::Param<super::super::super::Win32::Foundation::HANDLE>,
{
    ...
    OROpenHiveByHandle(filehandle.param().abi(), core::mem::transmute(horkey))
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    OROpenKey(handle.param().abi(), lpsubkey.param().abi(), core::mem::transmute(phkresult))
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    ORSaveHive(horkey.param().abi(), hivepath.param().abi(), core::mem::transmute(osmajorversion), core::mem::transmute(osminorversion))
}
#[cfg(feature = "Win32_Security")]
#[inline]
    ...
    P2: windows_core::Param<super::super::super::Win32::Security::PSECURITY_DESCRIPTOR>,
{
    ...
    ORSetKeySecurity(handle.param().abi(), core::mem::transmute(securityinformation), psecuritydescriptor.param().abi())
}
#[inline]
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    ...
    ORSetValue(handle.param().abi(), lpvaluename.param().abi(), core::mem::transmute(dwtype), core::mem::transmute(lpdata.as_deref().map_or(core::ptr::null(), |slice| slice.as_ptr())), lpdata.as_deref().map_or(0, |slice| slice.len().try_into().unwrap()))
}
#[inline]
    ...
    P0: windows_core::Param<ORHKEY>,
{
    ...
    ORSetVirtualFlags(handle.param().abi(), core::mem::transmute(dwflags))
}
#[inline]
