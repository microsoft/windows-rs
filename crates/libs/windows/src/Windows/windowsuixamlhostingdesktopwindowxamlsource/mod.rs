...
impl IDesktopWindowXamlSourceNative {
    #[cfg(feature = "windef")]
    pub unsafe fn AttachToWindow(&self, parentwnd: super::windef::HWND) -> windows_core::HRESULT {
...
pub struct IDesktopWindowXamlSourceNative_Vtbl {
    ...
    #[cfg(feature = "windef")]
    pub AttachToWindow: unsafe extern "system" fn(*mut core::ffi::c_void, super::windef::HWND) -> windows_core::HRESULT,
...
pub trait IDesktopWindowXamlSourceNative_Impl: windows_core::IUnknownImpl {
    fn AttachToWindow(&self, parentwnd: super::windef::HWND) -> windows_core::Result<()>;
...
impl IDesktopWindowXamlSourceNative_Vtbl {
    pub const fn new<Identity: IDesktopWindowXamlSourceNative_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn AttachToWindow<Identity: IDesktopWindowXamlSourceNative_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, parentwnd: super::windef::HWND) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDesktopWindowXamlSourceNative_Impl::AttachToWindow(this, core::mem::transmute_copy(&parentwnd)).into()
            }
        }
        unsafe extern "system" fn WindowHandle<Identity: IDesktopWindowXamlSourceNative_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hwnd: *mut super::windef::HWND) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDesktopWindowXamlSourceNative2 {
    ...
    pub unsafe fn PreTranslateMessage(&self, message: *const super::winuser::MSG) -> windows_core::Result<windows_core::BOOL> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub struct IDesktopWindowXamlSourceNative2_Vtbl {
    ...
    #[cfg(all(feature = "minwindef", feature = "windef", feature = "winuser"))]
    pub PreTranslateMessage: unsafe extern "system" fn(*mut core::ffi::c_void, *const super::winuser::MSG, *mut windows_core::BOOL) -> windows_core::HRESULT,
...
pub trait IDesktopWindowXamlSourceNative2_Impl: IDesktopWindowXamlSourceNative_Impl {
    fn PreTranslateMessage(&self, message: *const super::winuser::MSG) -> windows_core::Result<windows_core::BOOL>;
}
#[cfg(all(feature = "minwindef", feature = "windef", feature = "winuser"))]
impl IDesktopWindowXamlSourceNative2_Vtbl {
    pub const fn new<Identity: IDesktopWindowXamlSourceNative2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn PreTranslateMessage<Identity: IDesktopWindowXamlSourceNative2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, message: *const super::winuser::MSG, result: *mut windows_core::BOOL) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
