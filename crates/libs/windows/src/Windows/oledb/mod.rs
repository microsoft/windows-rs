...
pub struct DBCONSTRAINTDESC {
    ...
    pub pwszConstraintText: *mut super::wtypesbase::OLECHAR,
...
pub struct DBPROPINFO {
    ...
    pub vtType: super::wtypes::VARTYPE,
...
impl IBindResource {
    ...
    where
        ...
        P5: windows_core::Param<super::urlmon::IAuthenticate>,
...
impl IDBInfo_Vtbl {
    pub const fn new<Identity: IDBInfo_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetLiteralInfo<Identity: IDBInfo_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, cliterals: u32, rgliterals: *const DBLITERAL, pcliteralinfo: *mut u32, prgliteralinfo: *mut *mut DBLITERALINFO, ppcharbuffer: *mut *mut super::wtypesbase::OLECHAR) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IDBProperties_Vtbl {
    pub const fn new<Identity: IDBProperties_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetPropertyInfo<Identity: IDBProperties_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, cpropertyidsets: u32, rgpropertyidsets: *const DBPROPIDSET, pcpropertyinfosets: *mut u32, prgpropertyinfosets: *mut *mut DBPROPINFOSET, ppdescbuffer: *mut *mut super::wtypesbase::OLECHAR) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IErrorLookup_Vtbl {
    pub const fn new<Identity: IErrorLookup_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetHelpInfo<Identity: IErrorLookup_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hrerror: windows_core::HRESULT, dwlookupid: u32, lcid: super::winnt::LCID, pbstrhelpfile: *mut *mut core::ffi::c_void, pdwhelpcontext: *mut u32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait IErrorRecords_Impl: windows_core::IUnknownImpl {
    ...
    fn GetErrorInfo(&self, ulrecordnum: u32, lcid: super::winnt::LCID) -> windows_core::Result<super::oaidl::IErrorInfo>;
...
impl IErrorRecords_Vtbl {
    pub const fn new<Identity: IErrorRecords_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetErrorInfo<Identity: IErrorRecords_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, ulrecordnum: u32, lcid: super::winnt::LCID, pperrorinfo: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetErrorParameters<Identity: IErrorRecords_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, ulrecordnum: u32, pdispparams: *mut super::oaidl::DISPPARAMS) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait IObjectAccessControl_Impl: windows_core::IUnknownImpl {
    ...
    fn IsObjectAccessAllowed(&self, pobject: *const SEC_OBJECT, paccessentry: *const super::accctrl::EXPLICIT_ACCESS_W) -> windows_core::Result<windows_core::BOOL>;
...
impl IObjectAccessControl_Vtbl {
    pub const fn new<Identity: IObjectAccessControl_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetObjectOwner<Identity: IObjectAccessControl_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pobject: *const SEC_OBJECT, ppowner: *mut *mut super::accctrl::TRUSTEE_W) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsObjectAccessAllowed<Identity: IObjectAccessControl_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pobject: *const SEC_OBJECT, paccessentry: *const super::accctrl::EXPLICIT_ACCESS_W, pfresult: *mut windows_core::BOOL) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetObjectAccessRights<Identity: IObjectAccessControl_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pobject: *const SEC_OBJECT, caccessentries: u32, prgaccessentries: *mut super::accctrl::EXPLICIT_ACCESS_W) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetObjectOwner<Identity: IObjectAccessControl_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pobject: *const SEC_OBJECT, powner: *const super::accctrl::TRUSTEE_W) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IScopedOperations_Vtbl {
    pub const fn new<Identity: IScopedOperations_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Move<Identity: IScopedOperations_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, crows: DBCOUNTITEM, rgpwszsourceurls: *const windows_core::PCWSTR, rgpwszdesturls: *const windows_core::PCWSTR, dwmoveflags: u32, pauthenticate: *mut core::ffi::c_void, rgdwstatus: *mut DBSTATUS, rgpwsznewurls: *mut windows_core::PWSTR, ppstringsbuffer: *mut *mut super::wtypesbase::OLECHAR) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ISecurityInfo_Vtbl {
    pub const fn new<Identity: ISecurityInfo_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn GetPermissions<Identity: ISecurityInfo_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, objecttype: windows_core::GUID, ppermissions: *mut super::winnt::ACCESS_MASK) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ITransactionJoin {
    ...
    where
        P0: windows_core::Param<windows_core::IUnknown>,
        P3: windows_core::Param<super::transact::ITransactionOptions>,
    {
...
impl ITransactionJoin_Vtbl {
    pub const fn new<Identity: ITransactionJoin_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn JoinTransaction<Identity: ITransactionJoin_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, punktransactioncoord: *mut core::ffi::c_void, isolevel: super::transact::ISOLEVEL, isoflags: u32, potheroptions: *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ITransactionLocal {
    ...
    pub unsafe fn StartTransaction<P2>(&self, isolevel: super::transact::ISOLEVEL, isoflags: u32, potheroptions: P2, pultransactionlevel: Option<*mut u32>) -> windows_core::HRESULT
    where
        P2: windows_core::Param<super::transact::ITransactionOptions>,
    {
...
pub struct ITransactionLocal_Vtbl {
    pub base__: super::transact::ITransaction_Vtbl,
    pub GetOptionsObject: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
...
impl ITransactionLocal_Vtbl {
    pub const fn new<Identity: ITransactionLocal_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn StartTransaction<Identity: ITransactionLocal_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, isolevel: super::transact::ISOLEVEL, isoflags: u32, potheroptions: *mut core::ffi::c_void, pultransactionlevel: *mut u32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: super::transact::ITransaction_Vtbl::new::<Identity, OFFSET>(),
            GetOptionsObject: GetOptionsObject::<Identity, OFFSET>,
...
pub trait ITrusteeAdmin_Impl: windows_core::IUnknownImpl {
    ...
    fn DeleteTrustee(&self, ptrustee: *const super::accctrl::TRUSTEE_W) -> windows_core::Result<()>;
...
impl ITrusteeAdmin_Vtbl {
    pub const fn new<Identity: ITrusteeAdmin_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn CreateTrustee<Identity: ITrusteeAdmin_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, ptrustee: *const super::accctrl::TRUSTEE_W, cpropertysets: u32, rgpropertysets: *mut DBPROPSET) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn DeleteTrustee<Identity: ITrusteeAdmin_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, ptrustee: *const super::accctrl::TRUSTEE_W) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITrusteeAdmin_Impl::DeleteTrustee(this, core::mem::transmute_copy(&ptrustee)).into()
            }
        }
        unsafe extern "system" fn SetTrusteeProperties<Identity: ITrusteeAdmin_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, ptrustee: *const super::accctrl::TRUSTEE_W, cpropertysets: u32, rgpropertysets: *mut DBPROPSET) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetTrusteeProperties<Identity: ITrusteeAdmin_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, ptrustee: *const super::accctrl::TRUSTEE_W, cpropertyidsets: u32, rgpropertyidsets: *const DBPROPIDSET, pcpropertysets: *mut u32, prgpropertysets: *mut *mut DBPROPSET) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait ITrusteeGroupAdmin_Impl: windows_core::IUnknownImpl {
    ...
    fn IsMember(&self, pmembershiptrustee: *const super::accctrl::TRUSTEE_W, pmembertrustee: *const super::accctrl::TRUSTEE_W) -> windows_core::Result<windows_core::BOOL>;
...
impl ITrusteeGroupAdmin_Vtbl {
    pub const fn new<Identity: ITrusteeGroupAdmin_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn DeleteMember<Identity: ITrusteeGroupAdmin_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pmembershiptrustee: *const super::accctrl::TRUSTEE_W, pmembertrustee: *const super::accctrl::TRUSTEE_W) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsMember<Identity: ITrusteeGroupAdmin_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pmembershiptrustee: *const super::accctrl::TRUSTEE_W, pmembertrustee: *const super::accctrl::TRUSTEE_W, pfstatus: *mut windows_core::BOOL) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetMembers<Identity: ITrusteeGroupAdmin_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pmembershiptrustee: *const super::accctrl::TRUSTEE_W, pcmembers: *mut u32, prgmembers: *mut *mut super::accctrl::TRUSTEE_W) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetMemberships<Identity: ITrusteeGroupAdmin_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, ptrustee: *const super::accctrl::TRUSTEE_W, pcmemberships: *mut u32, prgmemberships: *mut *mut super::accctrl::TRUSTEE_W) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub struct RMTPACK {
    ...
    pub cVARIANT: u32,
    pub rgVARIANT: *mut super::oaidl::VARIANT,
    pub cIDISPATCH: u32,
    pub rgIDISPATCH: *mut Option<super::oaidl::IDispatch>,
    pub cIUNKNOWN: u32,
    pub rgIUNKNOWN: *mut Option<windows_core::IUnknown>,
    pub cPROPVARIANT: u32,
    pub rgPROPVARIANT: *mut super::propidlbase::PROPVARIANT,
    pub cArray: u32,
