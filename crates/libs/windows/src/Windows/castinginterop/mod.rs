...
impl ICastingSourceInfo {
    ...
    #[cfg(feature = "propsys")]
    pub unsafe fn GetProperties(&self) -> windows_core::Result<super::propsys::INamedPropertyStore> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ICastingSourceInfo_Impl: windows_core::IUnknownImpl {
    ...
    fn GetProperties(&self) -> windows_core::Result<super::propsys::INamedPropertyStore>;
}
#[cfg(feature = "propsys")]
