...
impl ClassicAppManager {
    pub fn FindInstalledApp(appuninstallkey: &windows_core::HSTRING) -> windows_result::Result<InstalledClassicAppInfo> {
    ...
    fn IClassicAppManagerStatics<R, F: FnOnce(&IClassicAppManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
