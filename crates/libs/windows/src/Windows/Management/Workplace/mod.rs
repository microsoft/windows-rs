...
impl MdmPolicy {
    pub fn IsBrowserAllowed() -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn IsCameraAllowed() -> Result<bool, windows_result::HRESULT> {
        Self::IMdmAllowPolicyStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsCameraAllowed)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn IsMicrosoftAccountAllowed() -> Result<bool, windows_result::HRESULT> {
        Self::IMdmAllowPolicyStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsStoreAllowed() -> Result<bool, windows_result::HRESULT> {
        Self::IMdmAllowPolicyStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsStoreAllowed)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn GetMessagingSyncPolicy() -> Result<MessagingSyncPolicy, windows_result::HRESULT> {
    ...
    fn IMdmAllowPolicyStatics<R, F: FnOnce(&IMdmAllowPolicyStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<MdmPolicy, IMdmAllowPolicyStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IMdmPolicyStatics2<R, F: FnOnce(&IMdmPolicyStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl WorkplaceSettings {
    pub fn IsMicrosoftAccountOptional() -> Result<bool, windows_result::HRESULT> {
    ...
    fn IWorkplaceSettingsStatics<R, F: FnOnce(&IWorkplaceSettingsStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
