...
impl NamedPolicy {
    pub fn GetPolicyFromPath(area: &windows_core::HSTRING, name: &windows_core::HSTRING) -> windows_result::Result<NamedPolicyData> {
    ...
    #[cfg(feature = "System")]
    pub fn GetPolicyFromPathForUser<P0>(user: P0, area: &windows_core::HSTRING, name: &windows_core::HSTRING) -> windows_result::Result<NamedPolicyData>
    where
    ...
    fn INamedPolicyStatics<R, F: FnOnce(&INamedPolicyStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl NamedPolicyData {
    pub fn Area(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Kind(&self) -> windows_result::Result<NamedPolicyKind> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsManaged(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsUserPolicy(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetBinary(&self) -> windows_result::Result<super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Changed<P0>(&self, changedhandler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveChanged(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
