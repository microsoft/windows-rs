...
impl MdmSession {
        ...
        P0: windows_core::Param<windows_collections::IIterable<MdmAlert>>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).StartWithAlertsAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(&alerts.param().borrow()), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
}
