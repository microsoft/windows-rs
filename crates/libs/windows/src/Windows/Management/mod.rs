...
impl MdmSession {
    ...
    pub fn AttachAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StartWithAlertsAsync<P0>(&self, alerts: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
