...
impl MdmAlert {
    ...
    pub fn Format(&self) -> Result<MdmAlertDataType, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetFormat(&self, value: MdmAlertDataType) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetFormat)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Mark(&self) -> Result<MdmAlertMark, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMark(&self, value: MdmAlertMark) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn SetSource(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSource)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(value)).ok() }
    }
    pub fn Status(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTarget(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl MdmSession {
    pub fn Alerts(&self) -> Result<windows_collections::IVectorView<MdmAlert>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn State(&self) -> Result<MdmSessionState, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AttachAsync(&self) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Delete(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn StartWithAlertsAsync<P0>(&self, alerts: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
...
impl MdmSessionManager {
    pub fn SessionIds() -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
    ...
    pub fn TryCreateSession() -> Result<MdmSession, windows_result::HRESULT> {
        Self::IMdmSessionManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeleteSessionById(sessionid: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn GetSessionById(sessionid: &windows_core::HSTRING) -> Result<MdmSession, windows_result::HRESULT> {
        Self::IMdmSessionManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IMdmSessionManagerStatics<R, F: FnOnce(&IMdmSessionManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
