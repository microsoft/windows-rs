...
impl AgentProvisioningProgressReport {
    ...
    pub fn State(&self) -> windows_result::Result<DeploymentAgentProgressState> {
        let this = self;
        unsafe {
    ...
    pub fn SetState(&self, value: DeploymentAgentProgressState) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetState)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ProgressPercentage(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetProgressPercentage(&self, value: f64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetProgressPercentage)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn EstimatedTimeRemaining(&self) -> windows_result::Result<super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetEstimatedTimeRemaining(&self, value: super::super::Foundation::TimeSpan) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetEstimatedTimeRemaining)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DisplayProgress(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDisplayProgress(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn DisplayProgressSecondary(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDisplayProgressSecondary(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn Batches(&self) -> windows_result::Result<windows_collections::IVector<DeploymentWorkloadBatch>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CurrentBatchIndex(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCurrentBatchIndex(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
...
impl DeploymentSessionConnectionChangedEventArgs {
    ...
    pub fn Change(&self) -> windows_result::Result<DeploymentSessionConnectionChange> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DeploymentSessionHeartbeatRequested {
    pub fn new<F: Fn(windows_core::Ref<DeploymentSessionHeartbeatRequestedEventArgs>) -> windows_result::Result<()> + Send + 'static>(invoke: F) -> Self {
    ...
    pub fn Invoke<P0>(&self, eventargs: P0) -> windows_result::Result<()>
    where
...
#[repr(C)]
struct DeploymentSessionHeartbeatRequestedBox<F: Fn(windows_core::Ref<DeploymentSessionHeartbeatRequestedEventArgs>) -> windows_result::Result<()> + Send + 'static> {
    vtable: *const DeploymentSessionHeartbeatRequested_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: Fn(windows_core::Ref<DeploymentSessionHeartbeatRequestedEventArgs>) -> windows_result::Result<()> + Send + 'static> DeploymentSessionHeartbeatRequestedBox<F> {
...
impl DeploymentSessionStateChangedEventArgs {
    ...
    pub fn Change(&self) -> windows_result::Result<DeploymentSessionStateChange> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Change)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl DeploymentWorkload {
    ...
    pub fn DisplayFriendlyName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDisplayFriendlyName(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn StartTime(&self) -> windows_result::Result<super::super::Foundation::IReference<super::super::Foundation::DateTime>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetStartTime<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn SetEndTime<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::super::Foundation::DateTime>>,
    {
        let this = self;
    ...
    pub fn SetErrorCode(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetErrorMessage(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn PossibleCause(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPossibleCause(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn PossibleResolution(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPossibleResolution(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn State(&self) -> windows_result::Result<DeploymentWorkloadState> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).State)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn SetState(&self, value: DeploymentWorkloadState) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetState)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn StateDetails(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetStateDetails(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn CreateInstance(id: &windows_core::HSTRING) -> windows_result::Result<DeploymentWorkload> {
    ...
    fn IDeploymentWorkloadFactory<R, F: FnOnce(&IDeploymentWorkloadFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl DeploymentWorkloadBatch {
    ...
    pub fn DisplayCategoryTitle(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDisplayCategoryTitle(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn BatchWorkloads(&self) -> windows_result::Result<windows_collections::IVector<DeploymentWorkload>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateInstance(id: u32) -> windows_result::Result<DeploymentWorkloadBatch> {
    ...
    fn IDeploymentWorkloadBatchFactory<R, F: FnOnce(&IDeploymentWorkloadBatchFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl DevicePreparationExecutionContext {
    pub fn Context(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MachineProvisioningProgressReporter {
    ...
    pub fn SessionConnection(&self) -> windows_result::Result<DeploymentSessionConnectionChange> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SessionState(&self) -> windows_result::Result<DeploymentSessionStateChange> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SessionStateChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveSessionStateChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveSessionStateChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn SessionConnectionChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveSessionConnectionChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveSessionConnectionChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn ReportProgress<P0>(&self, updatereport: P0) -> windows_result::Result<()>
    where
    ...
    pub fn GetDevicePreparationExecutionContextAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<DevicePreparationExecutionContext>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetForLaunchUri<P0, P1>(launchuri: P0, heartbeathandler: P1) -> windows_result::Result<MachineProvisioningProgressReporter>
    where
    ...
    fn IMachineProvisioningProgressReporterStatics<R, F: FnOnce(&IMachineProvisioningProgressReporterStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
