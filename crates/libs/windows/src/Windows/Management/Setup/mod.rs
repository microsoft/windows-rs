...
windows_core::imp::required_hierarchy!(AgentProvisioningProgressReport, IAgentProvisioningProgressReport);
...
windows_core::imp::required_hierarchy!(DeploymentSessionConnectionChangedEventArgs, IDeploymentSessionConnectionChangedEventArgs);
...
windows_core::imp::required_hierarchy!(DeploymentSessionHeartbeatRequestedEventArgs, IDeploymentSessionHeartbeatRequestedEventArgs);
...
windows_core::imp::required_hierarchy!(DeploymentSessionStateChangedEventArgs, IDeploymentSessionStateChangedEventArgs);
...
windows_core::imp::required_hierarchy!(DeploymentWorkload, IDeploymentWorkload, IDeploymentWorkloadFactory);
...
windows_core::imp::required_hierarchy!(DeploymentWorkloadBatch, IDeploymentWorkloadBatch, IDeploymentWorkloadBatchFactory);
...
windows_core::imp::required_hierarchy!(DevicePreparationExecutionContext, IDevicePreparationExecutionContext);
...
windows_core::imp::required_hierarchy!(MachineProvisioningProgressReporter, IMachineProvisioningProgressReporter, IMachineProvisioningProgressReporterStatics);
