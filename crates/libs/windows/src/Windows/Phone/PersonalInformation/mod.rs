...
windows_core::imp::required_hierarchy!(ContactAddress, IContactAddress);
impl ContactAddress {
...
windows_core::imp::required_hierarchy!(ContactChangeRecord, IContactChangeRecord);
...
windows_core::imp::required_hierarchy!(ContactInformation, IContactInformation, IContactInformationStatics);
...
windows_core::imp::required_hierarchy!(ContactQueryOptions, IContactQueryOptions);
...
windows_core::imp::required_hierarchy!(ContactQueryResult, IContactQueryResult);
...
windows_core::imp::required_hierarchy!(ContactStore, IContactStore, IContactStore2, IContactStoreStatics);
impl ContactStore {
...
windows_core::imp::required_hierarchy!(StoredContact, IContactInformation, IContactInformation2, IStoredContact, IStoredContactFactory);
impl StoredContact {
    pub fn DisplayName(&self) -> windows_core::Result<windows_core::HSTRING> {
