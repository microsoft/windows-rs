...
impl IContactInformation {
    ...
    pub fn GetPropertiesAsync(&self) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IMap<::windows_core::HSTRING, ::windows_core::IInspectable>>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IMap<::windows_core::HSTRING, ::windows_core::IInspectable>>>();
...
impl ContactQueryOptions {
    ...
    pub fn OrderBy(&self) -> ::windows_core::Result<ContactQueryResultOrdering> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<ContactQueryResultOrdering>();
...
impl ContactQueryResult {
    ...
    pub fn GetContactsAsync(&self) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<StoredContact>>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<StoredContact>>>();
...
impl ContactStore {
    ...
    pub fn FindContactByRemoteIdAsync(&self, id: &::windows_core::HSTRING) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<StoredContact>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<StoredContact>>();
    ...
    pub fn CreateContactQueryDefault(&self) -> ::windows_core::Result<ContactQueryResult> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<ContactQueryResult>();
    ...
    pub fn GetChangesAsync(&self, baserevisionnumber: u64) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<ContactChangeRecord>>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<ContactChangeRecord>>>();
...
impl StoredContact {
    ...
    pub fn Store(&self) -> ::windows_core::Result<ContactStore> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<ContactStore>();
    ...
    pub fn CreateStoredContact(store: &ContactStore) -> ::windows_core::Result<StoredContact> {
        Self::IStoredContactFactory(|this| unsafe {
            let mut result__ = ::windows_core::zeroed::<StoredContact>();
