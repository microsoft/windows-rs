...
impl ContactPartnerProvisioningManager {
    pub fn AssociateNetworkAccountAsync<P0>(store: P0, networkname: &windows_core::HSTRING, networkaccountid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    pub fn ImportVcardToSystemAsync<P0>(stream: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    pub fn AssociateSocialNetworkAccountAsync<P0>(store: P0, networkname: &windows_core::HSTRING, networkaccountid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncAction>
    where
        P0: windows_core::Param<super::ContactStore>,
    {
...
impl MessagePartnerProvisioningManager {
    pub fn ImportSmsToSystemAsync<P4>(incoming: bool, read: bool, body: &windows_core::HSTRING, sender: &windows_core::HSTRING, recipients: P4, deliverytime: super::super::super::Foundation::DateTime) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    pub fn ImportMmsToSystemAsync<P4, P6>(incoming: bool, read: bool, subject: &windows_core::HSTRING, sender: &windows_core::HSTRING, recipients: P4, deliverytime: super::super::super::Foundation::DateTime, attachments: P6) -> windows_core::Result<windows_async::IAsyncAction>
    where
        P4: windows_core::Param<windows_collections::IVectorView<windows_core::HSTRING>>,
