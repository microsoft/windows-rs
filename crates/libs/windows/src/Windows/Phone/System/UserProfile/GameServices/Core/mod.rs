...
impl GameService {
    ...
    pub fn GetGamerProfileAsync() -> windows_core::Result<windows_async::IAsyncOperation<GameServicePropertyCollection>> {
        Self::IGameService(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetInstalledGameItemsAsync() -> windows_core::Result<windows_async::IAsyncOperation<GameServicePropertyCollection>> {
        Self::IGameService(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetPartnerTokenAsync<P0>(audienceuri: P0) -> windows_core::Result<windows_async::IAsyncOperation<windows_core::HSTRING>>
    where
    ...
    pub fn GetPrivilegesAsync() -> windows_core::Result<windows_async::IAsyncOperation<windows_core::HSTRING>> {
        Self::IGameService(|this| unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GameServicePropertyCollection {
    pub fn GetPropertyAsync(&self, propertyname: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<windows_core::IInspectable>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
