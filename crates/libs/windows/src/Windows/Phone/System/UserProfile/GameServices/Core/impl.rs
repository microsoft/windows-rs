...
impl IGameServiceVtbl {
    pub const fn new<Impl: IGameServiceImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> IGameServiceVtbl {
        unsafe extern "system" fn ServiceUri<Impl: IGameServiceImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
        ...
        unsafe extern "system" fn GetGamerProfileAsync<Impl: IGameServiceImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn GetInstalledGameItemsAsync<Impl: IGameServiceImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn GetPartnerTokenAsync<Impl: IGameServiceImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, audienceuri: ::windows::core::RawPtr, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn GetPrivilegesAsync<Impl: IGameServiceImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn GrantAchievement<Impl: IGameServiceImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, achievementid: u32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            (*this).GrantAchievement(achievementid).into()
        }
        unsafe extern "system" fn GrantAvatarAward<Impl: IGameServiceImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, avatarawardid: u32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            (*this).GrantAvatarAward(avatarawardid).into()
        }
        unsafe extern "system" fn PostResult<Impl: IGameServiceImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, gamevariant: u32, scorekind: GameServiceScoreKind, scorevalue: i64, gameoutcome: GameServiceGameOutcome, buffer: ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<IGameService>, base.5, ServiceUri::<Impl, OFFSET>, GetGamerProfileAsync::<Impl, OFFSET>, GetInstalledGameItemsAsync::<Impl, OFFSET>, GetPartnerTokenAsync::<Impl, OFFSET>, GetPrivilegesAsync::<Impl, OFFSET>, GrantAchievement::<Impl, OFFSET>, GrantAvatarAward::<Impl, OFFSET>, PostResult::<Impl, OFFSET>)
    }
}
#[cfg(feature = "implement_exclusive")]
...
impl IGameService2Vtbl {
    pub const fn new<Impl: IGameService2Impl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> IGameService2Vtbl {
        unsafe extern "system" fn NotifyPartnerTokenExpired<Impl: IGameService2Impl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, audienceuri: ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn GetAuthenticationStatus<Impl: IGameService2Impl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut u32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<IGameService2>, base.5, NotifyPartnerTokenExpired::<Impl, OFFSET>, GetAuthenticationStatus::<Impl, OFFSET>)
    }
}
#[cfg(feature = "implement_exclusive")]
...
impl IGameServicePropertyCollectionVtbl {
    pub const fn new<Impl: IGameServicePropertyCollectionImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> IGameServicePropertyCollectionVtbl {
        unsafe extern "system" fn GetPropertyAsync<Impl: IGameServicePropertyCollectionImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, propertyname: ::core::mem::ManuallyDrop<::windows::core::HSTRING>, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<IGameServicePropertyCollection>, base.5, GetPropertyAsync::<Impl, OFFSET>)
    }
}
