...
impl IToastNotificationManagerStatics3_Vtbl {
    pub const fn new<Identity: IToastNotificationManagerStatics3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateToastNotifierForSecondaryTile<Identity: IToastNotificationManagerStatics3_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, tileid: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
