...
impl IBatteryVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IBatteryImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IBatteryVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IBattery>, ::windows::core::GetTrustLevel, RemainingChargePercent::<Impl, IMPL_OFFSET>, RemainingDischargeTime::<Impl, IMPL_OFFSET>, RemainingChargePercentChanged::<Impl, IMPL_OFFSET>, RemoveRemainingChargePercentChanged::<Impl, IMPL_OFFSET>)
    }
...
impl IBatteryStaticsVtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IBatteryStaticsImpl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IBatteryStaticsVtbl {
        ...
        Self(::windows::core::QueryInterface::<Identity, BASE_OFFSET>, ::windows::core::AddRef::<Identity, BASE_OFFSET>, ::windows::core::Release::<Identity, BASE_OFFSET>, ::windows::core::GetIids, ::windows::core::GetRuntimeClassName::<IBatteryStatics>, ::windows::core::GetTrustLevel, GetDefault::<Impl, IMPL_OFFSET>)
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
