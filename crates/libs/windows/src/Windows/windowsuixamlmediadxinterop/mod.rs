...
impl ISurfaceImageSourceNative {
    ...
    pub unsafe fn BeginDraw(&self, updaterect: super::windef::RECT, surface: *mut Option<super::dxgi::IDXGISurface>, offset: *mut super::windef::POINT) -> windows_core::HRESULT {
...
pub struct ISurfaceImageSourceNative_Vtbl {
    ...
    SetDevice: usize,
    #[cfg(all(feature = "dxgi", feature = "windef"))]
    pub BeginDraw: unsafe extern "system" fn(*mut core::ffi::c_void, super::windef::RECT, *mut *mut core::ffi::c_void, *mut super::windef::POINT) -> windows_core::HRESULT,
...
pub trait ISurfaceImageSourceNative_Impl: windows_core::IUnknownImpl {
    fn SetDevice(&self, device: windows_core::Ref<super::dxgi::IDXGIDevice>) -> windows_core::Result<()>;
    fn BeginDraw(&self, updaterect: &super::windef::RECT, surface: windows_core::OutRef<super::dxgi::IDXGISurface>, offset: *mut super::windef::POINT) -> windows_core::Result<()>;
...
impl ISurfaceImageSourceNative_Vtbl {
    pub const fn new<Identity: ISurfaceImageSourceNative_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn BeginDraw<Identity: ISurfaceImageSourceNative_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, updaterect: super::windef::RECT, surface: *mut *mut core::ffi::c_void, offset: *mut super::windef::POINT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ISurfaceImageSourceNativeWithD2D {
    ...
    #[cfg(feature = "windef")]
    pub unsafe fn BeginDraw<T>(&self, updaterect: *const super::windef::RECT, offset: *mut super::windef::POINT) -> windows_core::Result<T>
    where
...
pub trait ISurfaceImageSourceNativeWithD2D_Impl: windows_core::IUnknownImpl {
    ...
    fn BeginDraw(&self, updaterect: *const super::windef::RECT, iid: *const windows_core::GUID, updateobject: *mut *mut core::ffi::c_void, offset: *mut super::windef::POINT) -> windows_core::Result<()>;
    fn EndDraw(&self) -> windows_core::Result<()>;
...
impl ISurfaceImageSourceNativeWithD2D_Vtbl {
    pub const fn new<Identity: ISurfaceImageSourceNativeWithD2D_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn BeginDraw<Identity: ISurfaceImageSourceNativeWithD2D_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, updaterect: *const super::windef::RECT, iid: *const windows_core::GUID, updateobject: *mut *mut core::ffi::c_void, offset: *mut super::windef::POINT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait ISwapChainBackgroundPanelNative_Impl: windows_core::IUnknownImpl {
    fn SetSwapChain(&self, swapchain: windows_core::Ref<super::dxgi::IDXGISwapChain>) -> windows_core::Result<()>;
}
#[cfg(feature = "dxgi")]
...
impl ISwapChainPanelNative2 {
    #[cfg(feature = "winnt")]
    pub unsafe fn SetSwapChainHandle(&self, swapchainhandle: super::winnt::HANDLE) -> windows_core::HRESULT {
...
pub struct ISwapChainPanelNative2_Vtbl {
    ...
    #[cfg(feature = "winnt")]
    pub SetSwapChainHandle: unsafe extern "system" fn(*mut core::ffi::c_void, super::winnt::HANDLE) -> windows_core::HRESULT,
...
pub trait ISwapChainPanelNative2_Impl: ISwapChainPanelNative_Impl {
    fn SetSwapChainHandle(&self, swapchainhandle: super::winnt::HANDLE) -> windows_core::Result<()>;
}
#[cfg(all(feature = "dxgi", feature = "winnt"))]
impl ISwapChainPanelNative2_Vtbl {
    pub const fn new<Identity: ISwapChainPanelNative2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetSwapChainHandle<Identity: ISwapChainPanelNative2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, swapchainhandle: super::winnt::HANDLE) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IVirtualSurfaceImageSourceNative {
    #[cfg(feature = "windef")]
    pub unsafe fn Invalidate(&self, updaterect: super::windef::RECT) -> windows_core::HRESULT {
    ...
    #[cfg(feature = "windef")]
    pub unsafe fn GetUpdateRects(&self, updates: &mut [super::windef::RECT]) -> windows_core::HRESULT {
    ...
    #[cfg(feature = "windef")]
    pub unsafe fn GetVisibleBounds(&self) -> windows_core::Result<super::windef::RECT> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub struct IVirtualSurfaceImageSourceNative_Vtbl {
    ...
    #[cfg(feature = "windef")]
    pub Invalidate: unsafe extern "system" fn(*mut core::ffi::c_void, super::windef::RECT) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    Invalidate: usize,
    pub GetUpdateRectCount: unsafe extern "system" fn(*mut core::ffi::c_void, *mut u32) -> windows_core::HRESULT,
    #[cfg(feature = "windef")]
    pub GetUpdateRects: unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::windef::RECT, u32) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    GetUpdateRects: usize,
    #[cfg(feature = "windef")]
    pub GetVisibleBounds: unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::windef::RECT) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
...
pub trait IVirtualSurfaceImageSourceNative_Impl: ISurfaceImageSourceNative_Impl {
    fn Invalidate(&self, updaterect: &super::windef::RECT) -> windows_core::Result<()>;
    fn GetUpdateRectCount(&self) -> windows_core::Result<u32>;
    fn GetUpdateRects(&self, updates: *mut super::windef::RECT, count: u32) -> windows_core::Result<()>;
    fn GetVisibleBounds(&self) -> windows_core::Result<super::windef::RECT>;
...
impl IVirtualSurfaceImageSourceNative_Vtbl {
    pub const fn new<Identity: IVirtualSurfaceImageSourceNative_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Invalidate<Identity: IVirtualSurfaceImageSourceNative_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, updaterect: super::windef::RECT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetUpdateRects<Identity: IVirtualSurfaceImageSourceNative_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, updates: *mut super::windef::RECT, count: u32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn GetVisibleBounds<Identity: IVirtualSurfaceImageSourceNative_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, bounds: *mut super::windef::RECT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
