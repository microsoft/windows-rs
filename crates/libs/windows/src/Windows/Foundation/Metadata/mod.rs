...
impl ApiInformation {
    pub fn IsTypePresent(typename: &windows_core::HSTRING) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn IsMethodPresent(typename: &windows_core::HSTRING, methodname: &windows_core::HSTRING) -> Result<bool, windows_result::HRESULT> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsMethodPresentWithArity(typename: &windows_core::HSTRING, methodname: &windows_core::HSTRING, inputparametercount: u32) -> Result<bool, windows_result::HRESULT> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsEventPresent(typename: &windows_core::HSTRING, eventname: &windows_core::HSTRING) -> Result<bool, windows_result::HRESULT> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsPropertyPresent(typename: &windows_core::HSTRING, propertyname: &windows_core::HSTRING) -> Result<bool, windows_result::HRESULT> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsReadOnlyPropertyPresent(typename: &windows_core::HSTRING, propertyname: &windows_core::HSTRING) -> Result<bool, windows_result::HRESULT> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsWriteablePropertyPresent(typename: &windows_core::HSTRING, propertyname: &windows_core::HSTRING) -> Result<bool, windows_result::HRESULT> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsEnumNamedValuePresent(enumtypename: &windows_core::HSTRING, valuename: &windows_core::HSTRING) -> Result<bool, windows_result::HRESULT> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsApiContractPresentByMajor(contractname: &windows_core::HSTRING, majorversion: u16) -> Result<bool, windows_result::HRESULT> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsApiContractPresentByMajorAndMinor(contractname: &windows_core::HSTRING, majorversion: u16, minorversion: u16) -> Result<bool, windows_result::HRESULT> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IApiInformationStatics<R, F: FnOnce(&IApiInformationStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
