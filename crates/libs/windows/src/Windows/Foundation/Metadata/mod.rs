...
impl ApiInformation {
    pub fn IsTypePresent(typename: &windows_core::HSTRING) -> windows_result::Result<bool> {
    ...
    pub fn IsMethodPresent(typename: &windows_core::HSTRING, methodname: &windows_core::HSTRING) -> windows_result::Result<bool> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsMethodPresentWithArity(typename: &windows_core::HSTRING, methodname: &windows_core::HSTRING, inputparametercount: u32) -> windows_result::Result<bool> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsEventPresent(typename: &windows_core::HSTRING, eventname: &windows_core::HSTRING) -> windows_result::Result<bool> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsPropertyPresent(typename: &windows_core::HSTRING, propertyname: &windows_core::HSTRING) -> windows_result::Result<bool> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsReadOnlyPropertyPresent(typename: &windows_core::HSTRING, propertyname: &windows_core::HSTRING) -> windows_result::Result<bool> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsWriteablePropertyPresent(typename: &windows_core::HSTRING, propertyname: &windows_core::HSTRING) -> windows_result::Result<bool> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsEnumNamedValuePresent(enumtypename: &windows_core::HSTRING, valuename: &windows_core::HSTRING) -> windows_result::Result<bool> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsApiContractPresentByMajor(contractname: &windows_core::HSTRING, majorversion: u16) -> windows_result::Result<bool> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsApiContractPresentByMajorAndMinor(contractname: &windows_core::HSTRING, majorversion: u16, minorversion: u16) -> windows_result::Result<bool> {
        Self::IApiInformationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IApiInformationStatics<R, F: FnOnce(&IApiInformationStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
