...
windows_core::imp::required_hierarchy!(MemoryBuffer, IClosable, IMemoryBuffer, IMemoryBufferFactory);
impl MemoryBuffer {
    pub fn Close(&self) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IClosable>(self)?;
        unsafe { (windows_core::Interface::vtable(this).Close)(windows_core::Interface::as_raw(this)).ok() }
...
windows_core::imp::required_hierarchy!(Uri, IStringable, IUriEscapeStatics, IUriRuntimeClass, IUriRuntimeClassFactory, IUriRuntimeClassWithAbsoluteCanonicalUri);
impl Uri {
    pub fn ToString(&self) -> windows_core::Result<windows_core::HSTRING> {
...
#[cfg(feature = "Foundation_Collections")]
windows_core::imp::required_hierarchy!(WwwFormUrlDecoder, Collections::IIterable<IWwwFormUrlDecoderEntry>, Collections::IVectorView<IWwwFormUrlDecoderEntry>, IWwwFormUrlDecoderRuntimeClass, IWwwFormUrlDecoderRuntimeClassFactory);
#[cfg(feature = "Foundation_Collections")]
