...
impl<TProgress: windows_core::RuntimeType + 'static> AsyncActionProgressHandler<TProgress> {
    pub fn new<F: FnMut(windows_core::Ref<IAsyncActionWithProgress<TProgress>>, windows_core::Ref<TProgress>) -> windows_core::Result<()> + Send + 'static>(invoke: F) -> Self {
...
#[repr(C)]
struct AsyncActionProgressHandlerBox<TProgress, F: FnMut(windows_core::Ref<IAsyncActionWithProgress<TProgress>>, windows_core::Ref<TProgress>) -> windows_core::Result<()> + Send + 'static>
where
    TProgress: windows_core::RuntimeType + 'static,
{
...
impl<TProgress: windows_core::RuntimeType + 'static, F: FnMut(windows_core::Ref<IAsyncActionWithProgress<TProgress>>, windows_core::Ref<TProgress>) -> windows_core::Result<()> + Send + 'static> AsyncActionProgressHandlerBox<TProgress, F> {
...
impl<TResult: windows_core::RuntimeType + 'static, TProgress: windows_core::RuntimeType + 'static> AsyncOperationProgressHandler<TResult, TProgress> {
    pub fn new<F: FnMut(windows_core::Ref<IAsyncOperationWithProgress<TResult, TProgress>>, windows_core::Ref<TProgress>) -> windows_core::Result<()> + Send + 'static>(invoke: F) -> Self {
...
#[repr(C)]
struct AsyncOperationProgressHandlerBox<TResult, TProgress, F: FnMut(windows_core::Ref<IAsyncOperationWithProgress<TResult, TProgress>>, windows_core::Ref<TProgress>) -> windows_core::Result<()> + Send + 'static>
where
    TResult: windows_core::RuntimeType + 'static,
    TProgress: windows_core::RuntimeType + 'static,
{
...
impl<TResult: windows_core::RuntimeType + 'static, TProgress: windows_core::RuntimeType + 'static, F: FnMut(windows_core::Ref<IAsyncOperationWithProgress<TResult, TProgress>>, windows_core::Ref<TProgress>) -> windows_core::Result<()> + Send + 'static> AsyncOperationProgressHandlerBox<TResult, TProgress, F> {
...
impl<T: windows_core::RuntimeType + 'static> EventHandler<T> {
    pub fn new<F: FnMut(windows_core::Ref<windows_core::IInspectable>, windows_core::Ref<T>) -> windows_core::Result<()> + Send + 'static>(invoke: F) -> Self {
...
#[repr(C)]
struct EventHandlerBox<T, F: FnMut(windows_core::Ref<windows_core::IInspectable>, windows_core::Ref<T>) -> windows_core::Result<()> + Send + 'static>
where
    T: windows_core::RuntimeType + 'static,
{
...
impl<T: windows_core::RuntimeType + 'static, F: FnMut(windows_core::Ref<windows_core::IInspectable>, windows_core::Ref<T>) -> windows_core::Result<()> + Send + 'static> EventHandlerBox<T, F> {
...
impl<TSender: windows_core::RuntimeType + 'static, TResult: windows_core::RuntimeType + 'static> TypedEventHandler<TSender, TResult> {
    pub fn new<F: FnMut(windows_core::Ref<TSender>, windows_core::Ref<TResult>) -> windows_core::Result<()> + Send + 'static>(invoke: F) -> Self {
...
#[repr(C)]
struct TypedEventHandlerBox<TSender, TResult, F: FnMut(windows_core::Ref<TSender>, windows_core::Ref<TResult>) -> windows_core::Result<()> + Send + 'static>
where
    TSender: windows_core::RuntimeType + 'static,
    TResult: windows_core::RuntimeType + 'static,
{
...
impl<TSender: windows_core::RuntimeType + 'static, TResult: windows_core::RuntimeType + 'static, F: FnMut(windows_core::Ref<TSender>, windows_core::Ref<TResult>) -> windows_core::Result<()> + Send + 'static> TypedEventHandlerBox<TSender, TResult, F> {
