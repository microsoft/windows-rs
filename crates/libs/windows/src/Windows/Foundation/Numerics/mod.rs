...
impl Matrix3x2 {
    ...
    pub fn rotation(angle: f32, x: f32, y: f32) -> Self {
        ...
        ::windows::core::link ! ( "d2d1.dll" , "stdcall" fn D2D1MakeRotateMatrix ( angle :f32 , center :D2D_POINT_2F , matrix : * mut Matrix3x2 ) -> ( ) );
...
impl Matrix4x4 {
    ...
    pub fn rotation_y(degree: f32) -> Self {
        ::windows::core::link ! ( "d2d1.dll" , "stdcall" fn D2D1SinCos ( angle :f32 , sin : * mut f32 , cos : * mut f32 ) -> ( ) );
