...
impl AsyncCausalityTracer {
    pub fn TraceOperationCreation(tracelevel: CausalityTraceLevel, source: CausalitySource, platformid: windows_core::GUID, operationid: u64, operationname: &windows_core::HSTRING, relatedcontext: u64) -> windows_result::Result<()> {
    ...
    pub fn TraceOperationCompletion(tracelevel: CausalityTraceLevel, source: CausalitySource, platformid: windows_core::GUID, operationid: u64, status: windows_future::AsyncStatus) -> windows_result::Result<()> {
    ...
    pub fn TraceOperationRelation(tracelevel: CausalityTraceLevel, source: CausalitySource, platformid: windows_core::GUID, operationid: u64, relation: CausalityRelation) -> windows_result::Result<()> {
    ...
    pub fn TraceSynchronousWorkStart(tracelevel: CausalityTraceLevel, source: CausalitySource, platformid: windows_core::GUID, operationid: u64, work: CausalitySynchronousWork) -> windows_result::Result<()> {
    ...
    pub fn TraceSynchronousWorkCompletion(tracelevel: CausalityTraceLevel, source: CausalitySource, work: CausalitySynchronousWork) -> windows_result::Result<()> {
    ...
    pub fn TracingStatusChanged<P0>(handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveTracingStatusChanged(cookie: i64) -> windows_result::Result<()> {
    ...
    fn IAsyncCausalityTracerStatics<R, F: FnOnce(&IAsyncCausalityTracerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl ErrorDetails {
    ...
    pub fn LongDescription(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HelpUri(&self) -> windows_result::Result<super::Uri> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFromHResultAsync(errorcode: i32) -> windows_result::Result<windows_future::IAsyncOperation<ErrorDetails>> {
    ...
    fn IErrorDetailsStatics<R, F: FnOnce(&IErrorDetailsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl FileLoggingSession {
    ...
    pub fn AddLoggingChannel<P0>(&self, loggingchannel: P0) -> windows_result::Result<()>
    where
    ...
    pub fn AddLoggingChannelWithLevel<P0>(&self, loggingchannel: P0, maxlevel: LoggingLevel) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ILoggingChannel>,
    {
        let this = self;
    ...
    pub fn RemoveLoggingChannel<P0>(&self, loggingchannel: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ILoggingChannel>,
    {
        let this = self;
    ...
    pub fn CloseAndSaveToFileAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<super::super::Storage::StorageFile>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LogFileGenerated<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveLogFileGenerated(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveLogFileGenerated)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn Create(name: &windows_core::HSTRING) -> windows_result::Result<FileLoggingSession> {
    ...
    fn IFileLoggingSessionFactory<R, F: FnOnce(&IFileLoggingSessionFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl IErrorReportingSettings {
    pub fn SetErrorOptions(&self, value: ErrorOptions) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetErrorOptions)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn GetErrorOptions(&self) -> windows_result::Result<ErrorOptions> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IErrorReportingSettings_Impl: windows_core::IUnknownImpl {
    fn SetErrorOptions(&self, value: ErrorOptions) -> windows_result::Result<()>;
    fn GetErrorOptions(&self) -> windows_result::Result<ErrorOptions>;
}
...
pub trait IFileLoggingSession_Impl: super::IClosable_Impl {
    ...
    fn AddLoggingChannel(&self, loggingChannel: windows_core::Ref<ILoggingChannel>) -> windows_result::Result<()>;
    fn AddLoggingChannelWithLevel(&self, loggingChannel: windows_core::Ref<ILoggingChannel>, maxLevel: LoggingLevel) -> windows_result::Result<()>;
    fn RemoveLoggingChannel(&self, loggingChannel: windows_core::Ref<ILoggingChannel>) -> windows_result::Result<()>;
    fn CloseAndSaveToFileAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<super::super::Storage::StorageFile>>;
    fn LogFileGenerated(&self, handler: windows_core::Ref<super::TypedEventHandler<IFileLoggingSession, LogFileGeneratedEventArgs>>) -> windows_result::Result<i64>;
    fn RemoveLogFileGenerated(&self, token: i64) -> windows_result::Result<()>;
}
#[cfg(feature = "Storage_Streams")]
...
impl ILoggingChannel {
    ...
    pub fn Level(&self) -> windows_result::Result<LoggingLevel> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LogMessage(&self, eventstring: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn LogMessageWithLevel(&self, eventstring: &windows_core::HSTRING, level: LoggingLevel) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn LogValuePair(&self, value1: &windows_core::HSTRING, value2: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn LogValuePairWithLevel(&self, value1: &windows_core::HSTRING, value2: i32, level: LoggingLevel) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn LoggingEnabled<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveLoggingEnabled(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
...
pub trait ILoggingChannel_Impl: super::IClosable_Impl {
    fn Name(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn Enabled(&self) -> windows_result::Result<bool>;
    fn Level(&self) -> windows_result::Result<LoggingLevel>;
    fn LogMessage(&self, eventString: &windows_core::HSTRING) -> windows_result::Result<()>;
    fn LogMessageWithLevel(&self, eventString: &windows_core::HSTRING, level: LoggingLevel) -> windows_result::Result<()>;
    fn LogValuePair(&self, value1: &windows_core::HSTRING, value2: i32) -> windows_result::Result<()>;
    fn LogValuePairWithLevel(&self, value1: &windows_core::HSTRING, value2: i32, level: LoggingLevel) -> windows_result::Result<()>;
    fn LoggingEnabled(&self, handler: windows_core::Ref<super::TypedEventHandler<ILoggingChannel, windows_core::IInspectable>>) -> windows_result::Result<i64>;
    fn RemoveLoggingEnabled(&self, token: i64) -> windows_result::Result<()>;
}
...
impl ILoggingSession {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SaveToFileAsync<P0>(&self, folder: P0, filename: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<super::super::Storage::StorageFile>>
    where
...
pub trait ILoggingSession_Impl: super::IClosable_Impl {
    fn Name(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn SaveToFileAsync(&self, folder: windows_core::Ref<super::super::Storage::IStorageFolder>, fileName: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<super::super::Storage::StorageFile>>;
    fn AddLoggingChannel(&self, loggingChannel: windows_core::Ref<ILoggingChannel>) -> windows_result::Result<()>;
    fn AddLoggingChannelWithLevel(&self, loggingChannel: windows_core::Ref<ILoggingChannel>, maxLevel: LoggingLevel) -> windows_result::Result<()>;
    fn RemoveLoggingChannel(&self, loggingChannel: windows_core::Ref<ILoggingChannel>) -> windows_result::Result<()>;
}
...
impl ILoggingTarget {
    ...
    pub fn IsEnabledWithLevel(&self, level: LoggingLevel) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsEnabledWithLevelAndKeywords(&self, level: LoggingLevel, keywords: i64) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LogEvent(&self, eventname: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn LogEventWithFields<P1>(&self, eventname: &windows_core::HSTRING, fields: P1) -> windows_result::Result<()>
    where
    ...
    pub fn LogEventWithFieldsAndLevel<P1>(&self, eventname: &windows_core::HSTRING, fields: P1, level: LoggingLevel) -> windows_result::Result<()>
    where
        P1: windows_core::Param<LoggingFields>,
    {
        let this = self;
    ...
    pub fn LogEventWithFieldsAndOptions<P1, P3>(&self, eventname: &windows_core::HSTRING, fields: P1, level: LoggingLevel, options: P3) -> windows_result::Result<()>
    where
        P1: windows_core::Param<LoggingFields>,
    ...
    pub fn StartActivity(&self, starteventname: &windows_core::HSTRING) -> windows_result::Result<LoggingActivity> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StartActivityWithFields<P1>(&self, starteventname: &windows_core::HSTRING, fields: P1) -> windows_result::Result<LoggingActivity>
    where
        P1: windows_core::Param<LoggingFields>,
    {
        let this = self;
    ...
    pub fn StartActivityWithFieldsAndLevel<P1>(&self, starteventname: &windows_core::HSTRING, fields: P1, level: LoggingLevel) -> windows_result::Result<LoggingActivity>
    where
        P1: windows_core::Param<LoggingFields>,
    {
        let this = self;
    ...
    pub fn StartActivityWithFieldsAndOptions<P1, P3>(&self, starteventname: &windows_core::HSTRING, fields: P1, level: LoggingLevel, options: P3) -> windows_result::Result<LoggingActivity>
    where
        P1: windows_core::Param<LoggingFields>,
        P3: windows_core::Param<LoggingOptions>,
    {
...
pub trait ILoggingTarget_Impl: windows_core::IUnknownImpl {
    fn IsEnabled(&self) -> windows_result::Result<bool>;
    fn IsEnabledWithLevel(&self, level: LoggingLevel) -> windows_result::Result<bool>;
    fn IsEnabledWithLevelAndKeywords(&self, level: LoggingLevel, keywords: i64) -> windows_result::Result<bool>;
    fn LogEvent(&self, eventName: &windows_core::HSTRING) -> windows_result::Result<()>;
    fn LogEventWithFields(&self, eventName: &windows_core::HSTRING, fields: windows_core::Ref<LoggingFields>) -> windows_result::Result<()>;
    fn LogEventWithFieldsAndLevel(&self, eventName: &windows_core::HSTRING, fields: windows_core::Ref<LoggingFields>, level: LoggingLevel) -> windows_result::Result<()>;
    fn LogEventWithFieldsAndOptions(&self, eventName: &windows_core::HSTRING, fields: windows_core::Ref<LoggingFields>, level: LoggingLevel, options: windows_core::Ref<LoggingOptions>) -> windows_result::Result<()>;
    fn StartActivity(&self, startEventName: &windows_core::HSTRING) -> windows_result::Result<LoggingActivity>;
    fn StartActivityWithFields(&self, startEventName: &windows_core::HSTRING, fields: windows_core::Ref<LoggingFields>) -> windows_result::Result<LoggingActivity>;
    fn StartActivityWithFieldsAndLevel(&self, startEventName: &windows_core::HSTRING, fields: windows_core::Ref<LoggingFields>, level: LoggingLevel) -> windows_result::Result<LoggingActivity>;
    fn StartActivityWithFieldsAndOptions(&self, startEventName: &windows_core::HSTRING, fields: windows_core::Ref<LoggingFields>, level: LoggingLevel, options: windows_core::Ref<LoggingOptions>) -> windows_result::Result<LoggingActivity>;
}
...
impl LoggingActivity {
    ...
    pub fn Channel(&self) -> windows_result::Result<LoggingChannel> {
    ...
    pub fn StopActivity(&self, stopeventname: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<ILoggingActivity2>(self)?;
    ...
    pub fn StopActivityWithFields<P1>(&self, stopeventname: &windows_core::HSTRING, fields: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<LoggingFields>,
    {
        let this = &windows_core::Interface::cast::<ILoggingActivity2>(self)?;
    ...
    pub fn StopActivityWithFieldsAndOptions<P1, P2>(&self, stopeventname: &windows_core::HSTRING, fields: P1, options: P2) -> windows_result::Result<()>
    where
        P1: windows_core::Param<LoggingFields>,
    ...
    pub fn CreateLoggingActivity<P1>(activityname: &windows_core::HSTRING, loggingchannel: P1) -> windows_result::Result<LoggingActivity>
    where
    ...
    pub fn CreateLoggingActivityWithLevel<P1>(activityname: &windows_core::HSTRING, loggingchannel: P1, level: LoggingLevel) -> windows_result::Result<LoggingActivity>
    where
        P1: windows_core::Param<ILoggingChannel>,
    {
        Self::ILoggingActivityFactory(|this| unsafe {
    ...
    fn ILoggingActivityFactory<R, F: FnOnce(&ILoggingActivityFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl LoggingChannel {
    ...
    pub fn Create(name: &windows_core::HSTRING) -> windows_result::Result<LoggingChannel> {
        Self::ILoggingChannelFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(name), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn CreateWithOptions<P1>(name: &windows_core::HSTRING, options: P1) -> windows_result::Result<LoggingChannel>
    where
    ...
    pub fn CreateWithOptionsAndId<P1>(name: &windows_core::HSTRING, options: P1, id: windows_core::GUID) -> windows_result::Result<LoggingChannel>
    where
        P1: windows_core::Param<LoggingChannelOptions>,
    {
        Self::ILoggingChannelFactory2(|this| unsafe {
    ...
    fn ILoggingChannelFactory<R, F: FnOnce(&ILoggingChannelFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<LoggingChannel, ILoggingChannelFactory> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ILoggingChannelFactory2<R, F: FnOnce(&ILoggingChannelFactory2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl LoggingChannelOptions {
    ...
    pub fn Group(&self) -> windows_result::Result<windows_core::GUID> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetGroup(&self, value: windows_core::GUID) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetGroup)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Create(group: windows_core::GUID) -> windows_result::Result<LoggingChannelOptions> {
    ...
    fn ILoggingChannelOptionsFactory<R, F: FnOnce(&ILoggingChannelOptionsFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl LoggingFields {
    ...
    pub fn BeginStruct(&self, name: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).BeginStruct)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(name)).ok() }
    }
    pub fn BeginStructWithTags(&self, name: &windows_core::HSTRING, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn EndStruct(&self) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).EndStruct)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn AddEmpty(&self, name: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).AddEmpty)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(name)).ok() }
    }
    pub fn AddEmptyWithFormat(&self, name: &windows_core::HSTRING, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddEmptyWithFormatAndTags(&self, name: &windows_core::HSTRING, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt8(&self, name: &windows_core::HSTRING, value: u8) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt8WithFormat(&self, name: &windows_core::HSTRING, value: u8, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt8WithFormatAndTags(&self, name: &windows_core::HSTRING, value: u8, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt8Array(&self, name: &windows_core::HSTRING, value: &[u8]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt8ArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[u8], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt8ArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[u8], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt16(&self, name: &windows_core::HSTRING, value: i16) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt16WithFormat(&self, name: &windows_core::HSTRING, value: i16, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt16WithFormatAndTags(&self, name: &windows_core::HSTRING, value: i16, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt16Array(&self, name: &windows_core::HSTRING, value: &[i16]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt16ArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[i16], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt16ArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[i16], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt16(&self, name: &windows_core::HSTRING, value: u16) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt16WithFormat(&self, name: &windows_core::HSTRING, value: u16, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt16WithFormatAndTags(&self, name: &windows_core::HSTRING, value: u16, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt16Array(&self, name: &windows_core::HSTRING, value: &[u16]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt16ArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[u16], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt16ArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[u16], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt32(&self, name: &windows_core::HSTRING, value: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt32WithFormat(&self, name: &windows_core::HSTRING, value: i32, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt32WithFormatAndTags(&self, name: &windows_core::HSTRING, value: i32, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt32Array(&self, name: &windows_core::HSTRING, value: &[i32]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt32ArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[i32], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt32ArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[i32], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt32(&self, name: &windows_core::HSTRING, value: u32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt32WithFormat(&self, name: &windows_core::HSTRING, value: u32, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt32WithFormatAndTags(&self, name: &windows_core::HSTRING, value: u32, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt32Array(&self, name: &windows_core::HSTRING, value: &[u32]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt32ArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[u32], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt32ArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[u32], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt64(&self, name: &windows_core::HSTRING, value: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt64WithFormat(&self, name: &windows_core::HSTRING, value: i64, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt64WithFormatAndTags(&self, name: &windows_core::HSTRING, value: i64, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt64Array(&self, name: &windows_core::HSTRING, value: &[i64]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt64ArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[i64], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddInt64ArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[i64], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt64(&self, name: &windows_core::HSTRING, value: u64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt64WithFormat(&self, name: &windows_core::HSTRING, value: u64, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt64WithFormatAndTags(&self, name: &windows_core::HSTRING, value: u64, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt64Array(&self, name: &windows_core::HSTRING, value: &[u64]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt64ArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[u64], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddUInt64ArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[u64], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddSingle(&self, name: &windows_core::HSTRING, value: f32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddSingleWithFormat(&self, name: &windows_core::HSTRING, value: f32, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddSingleWithFormatAndTags(&self, name: &windows_core::HSTRING, value: f32, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddSingleArray(&self, name: &windows_core::HSTRING, value: &[f32]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddSingleArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[f32], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddSingleArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[f32], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddDouble(&self, name: &windows_core::HSTRING, value: f64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddDoubleWithFormat(&self, name: &windows_core::HSTRING, value: f64, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddDoubleWithFormatAndTags(&self, name: &windows_core::HSTRING, value: f64, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddDoubleArray(&self, name: &windows_core::HSTRING, value: &[f64]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddDoubleArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[f64], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddDoubleArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[f64], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddChar16(&self, name: &windows_core::HSTRING, value: u16) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddChar16WithFormat(&self, name: &windows_core::HSTRING, value: u16, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddChar16WithFormatAndTags(&self, name: &windows_core::HSTRING, value: u16, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddChar16Array(&self, name: &windows_core::HSTRING, value: &[u16]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddChar16ArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[u16], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddChar16ArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[u16], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddBoolean(&self, name: &windows_core::HSTRING, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddBooleanWithFormat(&self, name: &windows_core::HSTRING, value: bool, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddBooleanWithFormatAndTags(&self, name: &windows_core::HSTRING, value: bool, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddBooleanArray(&self, name: &windows_core::HSTRING, value: &[bool]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddBooleanArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[bool], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddBooleanArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[bool], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddString(&self, name: &windows_core::HSTRING, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddStringWithFormat(&self, name: &windows_core::HSTRING, value: &windows_core::HSTRING, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddStringWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &windows_core::HSTRING, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddStringArray(&self, name: &windows_core::HSTRING, value: &[windows_core::HSTRING]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddStringArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[windows_core::HSTRING], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddStringArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[windows_core::HSTRING], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddGuid(&self, name: &windows_core::HSTRING, value: windows_core::GUID) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddGuidWithFormat(&self, name: &windows_core::HSTRING, value: windows_core::GUID, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddGuidWithFormatAndTags(&self, name: &windows_core::HSTRING, value: windows_core::GUID, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddGuidArray(&self, name: &windows_core::HSTRING, value: &[windows_core::GUID]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddGuidArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[windows_core::GUID], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddGuidArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[windows_core::GUID], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddDateTime(&self, name: &windows_core::HSTRING, value: super::DateTime) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddDateTimeWithFormat(&self, name: &windows_core::HSTRING, value: super::DateTime, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddDateTimeWithFormatAndTags(&self, name: &windows_core::HSTRING, value: super::DateTime, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddDateTimeArray(&self, name: &windows_core::HSTRING, value: &[super::DateTime]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddDateTimeArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[super::DateTime], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddDateTimeArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[super::DateTime], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddTimeSpan(&self, name: &windows_core::HSTRING, value: super::TimeSpan) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddTimeSpanWithFormat(&self, name: &windows_core::HSTRING, value: super::TimeSpan, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddTimeSpanWithFormatAndTags(&self, name: &windows_core::HSTRING, value: super::TimeSpan, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddTimeSpanArray(&self, name: &windows_core::HSTRING, value: &[super::TimeSpan]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddTimeSpanArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[super::TimeSpan], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddTimeSpanArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[super::TimeSpan], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddPoint(&self, name: &windows_core::HSTRING, value: super::Point) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddPointWithFormat(&self, name: &windows_core::HSTRING, value: super::Point, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddPointWithFormatAndTags(&self, name: &windows_core::HSTRING, value: super::Point, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddPointArray(&self, name: &windows_core::HSTRING, value: &[super::Point]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddPointArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[super::Point], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddPointArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[super::Point], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddSize(&self, name: &windows_core::HSTRING, value: super::Size) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddSizeWithFormat(&self, name: &windows_core::HSTRING, value: super::Size, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddSizeWithFormatAndTags(&self, name: &windows_core::HSTRING, value: super::Size, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddSizeArray(&self, name: &windows_core::HSTRING, value: &[super::Size]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddSizeArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[super::Size], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddSizeArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[super::Size], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddRect(&self, name: &windows_core::HSTRING, value: super::Rect) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddRectWithFormat(&self, name: &windows_core::HSTRING, value: super::Rect, format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddRectWithFormatAndTags(&self, name: &windows_core::HSTRING, value: super::Rect, format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddRectArray(&self, name: &windows_core::HSTRING, value: &[super::Rect]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddRectArrayWithFormat(&self, name: &windows_core::HSTRING, value: &[super::Rect], format: LoggingFieldFormat) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AddRectArrayWithFormatAndTags(&self, name: &windows_core::HSTRING, value: &[super::Rect], format: LoggingFieldFormat, tags: i32) -> windows_result::Result<()> {
        let this = self;
...
impl LoggingOptions {
    ...
    pub fn Keywords(&self) -> windows_result::Result<i64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetKeywords(&self, value: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetKeywords)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Tags(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTags(&self, value: i32) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetTags)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Task(&self) -> windows_result::Result<i16> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTask(&self, value: i16) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetTask)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Opcode(&self) -> windows_result::Result<LoggingOpcode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOpcode(&self, value: LoggingOpcode) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetActivityId(&self, value: windows_core::GUID) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetActivityId)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn RelatedActivityId(&self) -> windows_result::Result<windows_core::GUID> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRelatedActivityId(&self, value: windows_core::GUID) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetRelatedActivityId)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CreateWithKeywords(keywords: i64) -> windows_result::Result<LoggingOptions> {
    ...
    fn ILoggingOptionsFactory<R, F: FnOnce(&ILoggingOptionsFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl LoggingSession {
    ...
    pub fn Create(name: &windows_core::HSTRING) -> windows_result::Result<LoggingSession> {
        Self::ILoggingSessionFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(name), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn ILoggingSessionFactory<R, F: FnOnce(&ILoggingSessionFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl TracingStatusChangedEventArgs {
    ...
    pub fn TraceLevel(&self) -> windows_result::Result<CausalityTraceLevel> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
