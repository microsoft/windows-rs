...
impl<K: windows_core::RuntimeType + 'static> IMapChangedEventArgs<K> {
    pub fn CollectionChange(&self) -> windows_result::Result<CollectionChange> {
        let this = self;
        unsafe {
    ...
    pub fn Key(&self) -> windows_result::Result<K> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
where
    K: windows_core::RuntimeType + 'static,
{
    fn CollectionChange(&self) -> windows_result::Result<CollectionChange>;
    fn Key(&self) -> windows_result::Result<K>;
}
...
impl<K: windows_core::RuntimeType + 'static, V: windows_core::RuntimeType + 'static> IObservableMap<K, V> {
    ...
    pub fn First(&self) -> windows_result::Result<windows_collections::IIterator<windows_collections::IKeyValuePair<K, V>>> {
    ...
    pub fn Lookup<P0>(&self, key: P0) -> windows_result::Result<V>
    where
    ...
    pub fn HasKey<P0>(&self, key: P0) -> windows_result::Result<bool>
    where
        P0: windows_core::Param<K>,
    {
        let this = &windows_core::Interface::cast::<windows_collections::IMap<K, V>>(self)?;
    ...
    pub fn GetView(&self) -> windows_result::Result<windows_collections::IMapView<K, V>> {
        let this = &windows_core::Interface::cast::<windows_collections::IMap<K, V>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Insert<P0, P1>(&self, key: P0, value: P1) -> windows_result::Result<bool>
    where
        P0: windows_core::Param<K>,
    ...
    pub fn Remove<P0>(&self, key: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<K>,
    {
        let this = &windows_core::Interface::cast::<windows_collections::IMap<K, V>>(self)?;
...
where
    ...
    V: windows_core::RuntimeType + 'static,
{
    fn MapChanged(&self, vhnd: windows_core::Ref<MapChangedEventHandler<K, V>>) -> windows_result::Result<i64>;
    fn RemoveMapChanged(&self, token: i64) -> windows_result::Result<()>;
}
...
impl<T: windows_core::RuntimeType + 'static> IObservableVector<T> {
    pub fn VectorChanged<P0>(&self, vhnd: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveVectorChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveVectorChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn First(&self) -> windows_result::Result<windows_collections::IIterator<T>> {
    ...
    pub fn GetView(&self) -> windows_result::Result<windows_collections::IVectorView<T>> {
        let this = &windows_core::Interface::cast::<windows_collections::IVector<T>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetMany(&self, startindex: u32, items: &mut [<T as windows_core::Type<T>>::Default]) -> windows_result::Result<u32> {
        let this = &windows_core::Interface::cast::<windows_collections::IVector<T>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReplaceAll(&self, items: &[<T as windows_core::Type<T>>::Default]) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<windows_collections::IVector<T>>(self)?;
...
where
    T: windows_core::RuntimeType + 'static,
{
    fn VectorChanged(&self, vhnd: windows_core::Ref<VectorChangedEventHandler<T>>) -> windows_result::Result<i64>;
    fn RemoveVectorChanged(&self, token: i64) -> windows_result::Result<()>;
}
...
impl IVectorChangedEventArgs {
    ...
    pub fn Index(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVectorChangedEventArgs_Impl: windows_core::IUnknownImpl {
    fn CollectionChange(&self) -> windows_result::Result<CollectionChange>;
    fn Index(&self) -> windows_result::Result<u32>;
}
...
impl<K: windows_core::RuntimeType + 'static, V: windows_core::RuntimeType + 'static> MapChangedEventHandler<K, V> {
    pub fn new<F: Fn(windows_core::Ref<IObservableMap<K, V>>, windows_core::Ref<IMapChangedEventArgs<K>>) -> windows_result::Result<()> + Send + 'static>(invoke: F) -> Self {
    ...
    pub fn Invoke<P0, P1>(&self, sender: P0, event: P1) -> windows_result::Result<()>
    where
...
#[repr(C)]
struct MapChangedEventHandlerBox<K, V, F: Fn(windows_core::Ref<IObservableMap<K, V>>, windows_core::Ref<IMapChangedEventArgs<K>>) -> windows_result::Result<()> + Send + 'static>
where
    K: windows_core::RuntimeType + 'static,
    V: windows_core::RuntimeType + 'static,
{
...
impl<K: windows_core::RuntimeType + 'static, V: windows_core::RuntimeType + 'static, F: Fn(windows_core::Ref<IObservableMap<K, V>>, windows_core::Ref<IMapChangedEventArgs<K>>) -> windows_result::Result<()> + Send + 'static> MapChangedEventHandlerBox<K, V, F> {
...
impl<T: windows_core::RuntimeType + 'static> VectorChangedEventHandler<T> {
    pub fn new<F: Fn(windows_core::Ref<IObservableVector<T>>, windows_core::Ref<IVectorChangedEventArgs>) -> windows_result::Result<()> + Send + 'static>(invoke: F) -> Self {
...
#[repr(C)]
struct VectorChangedEventHandlerBox<T, F: Fn(windows_core::Ref<IObservableVector<T>>, windows_core::Ref<IVectorChangedEventArgs>) -> windows_result::Result<()> + Send + 'static>
where
    T: windows_core::RuntimeType + 'static,
{
...
impl<T: windows_core::RuntimeType + 'static, F: Fn(windows_core::Ref<IObservableVector<T>>, windows_core::Ref<IVectorChangedEventArgs>) -> windows_result::Result<()> + Send + 'static> VectorChangedEventHandlerBox<T, F> {
