...
impl<K: windows_core::RuntimeType + 'static> IMapChangedEventArgs<K> {
    pub fn CollectionChange(&self) -> windows_core::Result<windows_collections::CollectionChange> {
        let this = self;
        unsafe {
...
where
    K: windows_core::RuntimeType + 'static,
{
    fn CollectionChange(&self) -> windows_core::Result<windows_collections::CollectionChange>;
...
impl<K: windows_core::RuntimeType + 'static> IMapChangedEventArgs_Vtbl<K> {
    pub const fn new<Identity: IMapChangedEventArgs_Impl<K>, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CollectionChange<K: windows_core::RuntimeType + 'static, Identity: IMapChangedEventArgs_Impl<K>, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut windows_collections::CollectionChange) -> windows_core::HRESULT {
            unsafe {
    ...
    K: windows_core::RuntimeType + 'static,
{
    ...
    pub CollectionChange: unsafe extern "system" fn(*mut core::ffi::c_void, *mut windows_collections::CollectionChange) -> windows_core::HRESULT,
