...
pub trait ITextHost_Impl: windows_core::IUnknownImpl {
    ...
    fn TxInvalidateRect(&self, prc: *const super::windef::RECT, fmode: windows_core::BOOL);
    fn TxViewChange(&self, fupdate: windows_core::BOOL);
    fn TxCreateCaret(&self, hbmp: super::windef::HBITMAP, xwidth: i32, yheight: i32) -> windows_core::BOOL;
    ...
    fn TxScrollWindowEx(&self, dx: i32, dy: i32, lprcscroll: *const super::windef::RECT, lprcclip: *const super::windef::RECT, hrgnupdate: super::minwindef::HRGN, lprcupdate: *mut super::windef::RECT, fuscroll: u32);
    fn TxSetCapture(&self, fcapture: windows_core::BOOL);
    fn TxSetFocus(&self);
    fn TxSetCursor(&self, hcur: super::windef::HCURSOR, ftext: windows_core::BOOL);
    fn TxScreenToClient(&self, lppt: *mut super::windef::POINT) -> windows_core::BOOL;
    fn TxClientToScreen(&self, lppt: *mut super::windef::POINT) -> windows_core::BOOL;
    fn TxActivate(&self) -> windows_core::Result<i32>;
    fn TxDeactivate(&self, lnewstate: i32) -> windows_core::Result<()>;
    fn TxGetClientRect(&self) -> windows_core::Result<super::windef::RECT>;
    fn TxGetViewInset(&self) -> windows_core::Result<super::windef::RECT>;
    fn TxGetCharFormat(&self) -> windows_core::Result<*mut super::richedit::CHARFORMATW>;
    fn TxGetParaFormat(&self) -> windows_core::Result<*mut super::richedit::PARAFORMAT>;
    fn TxGetSysColor(&self, nindex: i32) -> super::windef::COLORREF;
    ...
    fn TxGetPasswordChar(&self) -> windows_core::Result<super::winnt::TCHAR>;
    fn TxGetAcceleratorPos(&self) -> windows_core::Result<i32>;
    fn TxGetExtent(&self) -> windows_core::Result<super::windef::SIZE>;
    fn OnTxCharFormatChange(&self, pcf: *const super::richedit::CHARFORMATW) -> windows_core::Result<()>;
    fn OnTxParaFormatChange(&self, ppf: *const super::richedit::PARAFORMAT) -> windows_core::Result<()>;
    ...
    fn TxImmGetContext(&self) -> super::imm::HIMC;
...
impl ITextHost_Vtbl {
    pub const fn new<Identity: ITextHost_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn TxReleaseDC<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hdc: super::windef::HDC) -> i32 {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TxInvalidateRect<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, prc: *const super::windef::RECT, fmode: windows_core::BOOL) {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TxCreateCaret<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hbmp: super::windef::HBITMAP, xwidth: i32, yheight: i32) -> windows_core::BOOL {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TxScrollWindowEx<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, dx: i32, dy: i32, lprcscroll: *const super::windef::RECT, lprcclip: *const super::windef::RECT, hrgnupdate: super::minwindef::HRGN, lprcupdate: *mut super::windef::RECT, fuscroll: u32) {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TxSetCursor<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hcur: super::windef::HCURSOR, ftext: windows_core::BOOL) {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITextHost_Impl::TxSetCursor(this, core::mem::transmute_copy(&hcur), core::mem::transmute_copy(&ftext));
            }
        }
        unsafe extern "system" fn TxScreenToClient<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, lppt: *mut super::windef::POINT) -> windows_core::BOOL {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITextHost_Impl::TxScreenToClient(this, core::mem::transmute_copy(&lppt))
            }
        }
        unsafe extern "system" fn TxClientToScreen<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, lppt: *mut super::windef::POINT) -> windows_core::BOOL {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TxGetClientRect<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, prc: *mut super::windef::RECT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TxGetViewInset<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, prc: *mut super::windef::RECT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TxGetCharFormat<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, ppcf: *mut *mut super::richedit::CHARFORMATW) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TxGetParaFormat<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pppf: *mut *mut super::richedit::PARAFORMAT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TxGetSysColor<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, nindex: i32) -> super::windef::COLORREF {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TxGetPasswordChar<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pch: *mut super::winnt::TCHAR) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TxGetExtent<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, lpextent: *mut super::windef::SIZE) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn OnTxCharFormatChange<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, pcf: *const super::richedit::CHARFORMATW) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITextHost_Impl::OnTxCharFormatChange(this, core::mem::transmute_copy(&pcf)).into()
            }
        }
        unsafe extern "system" fn OnTxParaFormatChange<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, ppf: *const super::richedit::PARAFORMAT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TxImmGetContext<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) -> super::imm::HIMC {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                ITextHost_Impl::TxImmGetContext(this)
            }
        }
        unsafe extern "system" fn TxImmReleaseContext<Identity: ITextHost_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, himc: super::imm::HIMC) {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait ITextHost2_Impl: ITextHost_Impl {
    ...
    fn TxGetPalette(&self) -> super::windef::HPALETTE;
    fn TxGetEastAsianFlags(&self) -> windows_core::Result<i32>;
    fn TxSetCursor2(&self, hcur: super::windef::HCURSOR, btext: windows_core::BOOL) -> super::windef::HCURSOR;
    ...
    fn TxShowDropCaret(&self, fshow: windows_core::BOOL, hdc: super::windef::HDC, prc: *const super::windef::RECT) -> windows_core::Result<()>;
...
impl ITextHost2_Vtbl {
    pub const fn new<Identity: ITextHost2_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn TxGetWindow<Identity: ITextHost2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, phwnd: *mut super::windef::HWND) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TxGetPalette<Identity: ITextHost2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) -> super::windef::HPALETTE {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TxSetCursor2<Identity: ITextHost2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, hcur: super::windef::HCURSOR, btext: windows_core::BOOL) -> super::windef::HCURSOR {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TxShowDropCaret<Identity: ITextHost2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, fshow: windows_core::BOOL, hdc: super::windef::HDC, prc: *const super::windef::RECT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait ITextServices_Impl: windows_core::IUnknownImpl {
    ...
    fn OnTxSetCursor(&self, dwdrawaspect: u32, lindex: i32, pvaspect: *mut core::ffi::c_void, ptd: *mut super::objidl::DVTARGETDEVICE, hdcdraw: super::windef::HDC, hictargetdev: super::windef::HDC, lprcclient: *const super::windef::RECT, x: i32, y: i32) -> windows_core::Result<()>;
    fn TxQueryHitPoint(&self, dwdrawaspect: u32, lindex: i32, pvaspect: *mut core::ffi::c_void, ptd: *mut super::objidl::DVTARGETDEVICE, hdcdraw: super::windef::HDC, hictargetdev: super::windef::HDC, lprcclient: *const super::windef::RECT, x: i32, y: i32, phitresult: *mut u32) -> windows_core::Result<()>;
    fn OnTxInPlaceActivate(&self, prcclient: *const super::windef::RECT) -> windows_core::Result<()>;
    ...
    fn TxGetNaturalSize(&self, dwaspect: u32, hdcdraw: super::windef::HDC, hictargetdev: super::windef::HDC, ptd: *mut super::objidl::DVTARGETDEVICE, dwmode: u32, psizelextent: *const super::windef::SIZEL, pwidth: *mut i32, pheight: *mut i32) -> windows_core::Result<()>;
    fn TxGetDropTarget(&self) -> windows_core::Result<super::oleidl::IDropTarget>;
...
impl ITextServices_Vtbl {
    pub const fn new<Identity: ITextServices_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn TxDraw<Identity: ITextServices_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, dwdrawaspect: u32, lindex: i32, pvaspect: *mut core::ffi::c_void, ptd: *mut super::objidl::DVTARGETDEVICE, hdcdraw: super::windef::HDC, hictargetdev: super::windef::HDC, lprcbounds: *const super::windef::RECTL, lprcwbounds: *const super::windef::RECTL, lprcupdate: *mut super::windef::RECT, pfncontinue: *mut u8, dwcontinue: u32, lviewid: i32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn OnTxSetCursor<Identity: ITextServices_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, dwdrawaspect: u32, lindex: i32, pvaspect: *mut core::ffi::c_void, ptd: *mut super::objidl::DVTARGETDEVICE, hdcdraw: super::windef::HDC, hictargetdev: super::windef::HDC, lprcclient: *const super::windef::RECT, x: i32, y: i32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TxQueryHitPoint<Identity: ITextServices_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, dwdrawaspect: u32, lindex: i32, pvaspect: *mut core::ffi::c_void, ptd: *mut super::objidl::DVTARGETDEVICE, hdcdraw: super::windef::HDC, hictargetdev: super::windef::HDC, lprcclient: *const super::windef::RECT, x: i32, y: i32, phitresult: *mut u32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn OnTxInPlaceActivate<Identity: ITextServices_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, prcclient: *const super::windef::RECT) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TxGetNaturalSize<Identity: ITextServices_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, dwaspect: u32, hdcdraw: super::windef::HDC, hictargetdev: super::windef::HDC, ptd: *mut super::objidl::DVTARGETDEVICE, dwmode: u32, psizelextent: *const super::windef::SIZEL, pwidth: *mut i32, pheight: *mut i32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl ITextServices2_Vtbl {
    pub const fn new<Identity: ITextServices2_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn TxDrawD2D<Identity: ITextServices2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, prendertarget: *mut core::ffi::c_void, lprcbounds: *const super::windef::RECTL, lprcupdate: *mut super::windef::RECT, lviewid: i32) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
