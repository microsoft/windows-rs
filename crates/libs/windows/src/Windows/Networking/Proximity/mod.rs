...
windows_core::imp::required_hierarchy!(ConnectionRequestedEventArgs, IConnectionRequestedEventArgs);
...
windows_core::imp::required_hierarchy!(PeerInformation, IPeerInformation, IPeerInformation3, IPeerInformationWithHostAndService);
...
windows_core::imp::required_hierarchy!(PeerWatcher, IPeerWatcher);
impl PeerWatcher {
...
windows_core::imp::required_hierarchy!(ProximityDevice, IProximityDevice, IProximityDeviceStatics);
...
windows_core::imp::required_hierarchy!(ProximityMessage, IProximityMessage);
...
windows_core::imp::required_hierarchy!(TriggeredConnectionStateChangedEventArgs, ITriggeredConnectionStateChangedEventArgs);
