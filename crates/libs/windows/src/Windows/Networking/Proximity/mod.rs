...
impl ConnectionRequestedEventArgs {
    pub fn PeerInformation(&self) -> Result<PeerInformation, windows_result::HRESULT> {
        let this = self;
        unsafe {
...
impl DeviceArrivedEventHandler {
    pub fn new<F: FnMut(windows_core::Ref<'_, ProximityDevice>) -> Result<(), windows_result::HRESULT> + Send + 'static>(invoke: F) -> Self {
...
#[repr(C)]
struct DeviceArrivedEventHandlerBox<F: FnMut(windows_core::Ref<'_, ProximityDevice>) -> Result<(), windows_result::HRESULT> + Send + 'static> {
    vtable: *const DeviceArrivedEventHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(windows_core::Ref<'_, ProximityDevice>) -> Result<(), windows_result::HRESULT> + Send + 'static> DeviceArrivedEventHandlerBox<F> {
...
#[repr(C)]
struct DeviceDepartedEventHandlerBox<F: FnMut(windows_core::Ref<'_, ProximityDevice>) -> Result<(), windows_result::HRESULT> + Send + 'static> {
    vtable: *const DeviceDepartedEventHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(windows_core::Ref<'_, ProximityDevice>) -> Result<(), windows_result::HRESULT> + Send + 'static> DeviceDepartedEventHandlerBox<F> {
...
impl MessageReceivedHandler {
    pub fn new<F: FnMut(windows_core::Ref<'_, ProximityDevice>, windows_core::Ref<'_, ProximityMessage>) -> Result<(), windows_result::HRESULT> + Send + 'static>(invoke: F) -> Self {
        let com = MessageReceivedHandlerBox { vtable: &MessageReceivedHandlerBox::<F>::VTABLE, count: windows_core::imp::RefCount::new(1), invoke };
        unsafe { core::mem::transmute(windows_core::imp::Box::new(com)) }
    }
    pub fn Invoke<P0, P1>(&self, sender: P0, message: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ProximityDevice>,
...
pub struct MessageReceivedHandler_Vtbl {
    base__: windows_core::IUnknown_Vtbl,
    Invoke: unsafe extern "system" fn(this: *mut core::ffi::c_void, sender: *mut core::ffi::c_void, message: *mut core::ffi::c_void) -> windows_result::HRESULT,
}
#[repr(C)]
struct MessageReceivedHandlerBox<F: FnMut(windows_core::Ref<'_, ProximityDevice>, windows_core::Ref<'_, ProximityMessage>) -> Result<(), windows_result::HRESULT> + Send + 'static> {
    vtable: *const MessageReceivedHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(windows_core::Ref<'_, ProximityDevice>, windows_core::Ref<'_, ProximityMessage>) -> Result<(), windows_result::HRESULT> + Send + 'static> MessageReceivedHandlerBox<F> {
    ...
    unsafe extern "system" fn Invoke(this: *mut core::ffi::c_void, sender: *mut core::ffi::c_void, message: *mut core::ffi::c_void) -> windows_result::HRESULT {
        unsafe {
            let this = &mut *(this as *mut *mut core::ffi::c_void as *mut Self);
...
impl MessageTransmittedHandler {
    pub fn new<F: FnMut(windows_core::Ref<'_, ProximityDevice>, i64) -> Result<(), windows_result::HRESULT> + Send + 'static>(invoke: F) -> Self {
    ...
    pub fn Invoke<P0>(&self, sender: P0, messageid: i64) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<ProximityDevice>,
    {
        let this = self;
...
pub struct MessageTransmittedHandler_Vtbl {
    base__: windows_core::IUnknown_Vtbl,
    Invoke: unsafe extern "system" fn(this: *mut core::ffi::c_void, sender: *mut core::ffi::c_void, messageid: i64) -> windows_result::HRESULT,
}
#[repr(C)]
struct MessageTransmittedHandlerBox<F: FnMut(windows_core::Ref<'_, ProximityDevice>, i64) -> Result<(), windows_result::HRESULT> + Send + 'static> {
    vtable: *const MessageTransmittedHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(windows_core::Ref<'_, ProximityDevice>, i64) -> Result<(), windows_result::HRESULT> + Send + 'static> MessageTransmittedHandlerBox<F> {
    ...
    unsafe extern "system" fn Invoke(this: *mut core::ffi::c_void, sender: *mut core::ffi::c_void, messageid: i64) -> windows_result::HRESULT {
        unsafe {
            let this = &mut *(this as *mut *mut core::ffi::c_void as *mut Self);
...
impl PeerFinder {
    pub fn AllowBluetooth() -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn SetAllowBluetooth(value: bool) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn AllowInfrastructure() -> Result<bool, windows_result::HRESULT> {
        Self::IPeerFinderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AllowInfrastructure)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn SetAllowInfrastructure(value: bool) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn AllowWiFiDirect() -> Result<bool, windows_result::HRESULT> {
        Self::IPeerFinderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AllowWiFiDirect)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn SetAllowWiFiDirect(value: bool) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn SetDisplayName(value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn SupportedDiscoveryTypes() -> Result<PeerDiscoveryTypes, windows_result::HRESULT> {
        Self::IPeerFinderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SupportedDiscoveryTypes)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn AlternateIdentities() -> Result<windows_collections::IMap<windows_core::HSTRING, windows_core::HSTRING>, windows_result::HRESULT> {
        Self::IPeerFinderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Start() -> Result<(), windows_result::HRESULT> {
        Self::IPeerFinderStatics(|this| unsafe { (windows_core::Interface::vtable(this).Start)(windows_core::Interface::as_raw(this)).ok() })
    }
    pub fn StartWithMessage(peermessage: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn Stop() -> Result<(), windows_result::HRESULT> {
        Self::IPeerFinderStatics(|this| unsafe { (windows_core::Interface::vtable(this).Stop)(windows_core::Interface::as_raw(this)).ok() })
    }
    pub fn TriggeredConnectionStateChanged<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveTriggeredConnectionStateChanged(cookie: i64) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn ConnectionRequested<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveConnectionRequested(cookie: i64) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn FindAllPeersAsync() -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<PeerInformation>>, windows_result::HRESULT> {
        Self::IPeerFinderStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Networking_Sockets")]
    pub fn ConnectAsync<P0>(peerinformation: P0) -> Result<windows_future::IAsyncOperation<super::Sockets::StreamSocket>, windows_result::HRESULT>
    where
    ...
    pub fn Role() -> Result<PeerRole, windows_result::HRESULT> {
    ...
    pub fn SetRole(value: PeerRole) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn DiscoveryData() -> Result<super::super::Storage::Streams::IBuffer, windows_result::HRESULT> {
        Self::IPeerFinderStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetDiscoveryData<P0>(value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn CreateWatcher() -> Result<PeerWatcher, windows_result::HRESULT> {
        Self::IPeerFinderStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IPeerFinderStatics<R, F: FnOnce(&IPeerFinderStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<PeerFinder, IPeerFinderStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IPeerFinderStatics2<R, F: FnOnce(&IPeerFinderStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl PeerInformation {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn DiscoveryData(&self) -> Result<super::super::Storage::Streams::IBuffer, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IPeerInformation3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DiscoveryData)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl PeerWatcher {
    ...
    pub fn Status(&self) -> Result<PeerWatcherStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ProximityDevice {
    pub fn SubscribeForMessage<P1>(&self, messagetype: &windows_core::HSTRING, messagereceivedhandler: P1) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn PublishMessage(&self, messagetype: &windows_core::HSTRING, message: &windows_core::HSTRING) -> Result<i64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PublishMessageWithCallback<P2>(&self, messagetype: &windows_core::HSTRING, message: &windows_core::HSTRING, messagetransmittedhandler: P2) -> Result<i64, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn PublishBinaryMessage<P1>(&self, messagetype: &windows_core::HSTRING, message: P1) -> Result<i64, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn PublishBinaryMessageWithCallback<P1, P2>(&self, messagetype: &windows_core::HSTRING, message: P1, messagetransmittedhandler: P2) -> Result<i64, windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
        P2: windows_core::Param<MessageTransmittedHandler>,
    {
    ...
    pub fn PublishUriMessage<P0>(&self, message: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn PublishUriMessageWithCallback<P0, P1>(&self, message: P0, messagetransmittedhandler: P1) -> Result<i64, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    ...
    pub fn StopSubscribingForMessage(&self, subscriptionid: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).StopSubscribingForMessage)(windows_core::Interface::as_raw(this), subscriptionid).ok() }
    }
    pub fn StopPublishingMessage(&self, messageid: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).StopPublishingMessage)(windows_core::Interface::as_raw(this), messageid).ok() }
    }
    pub fn DeviceArrived<P0>(&self, arrivedhandler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveDeviceArrived(&self, cookie: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveDeviceArrived)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    pub fn DeviceDeparted<P0>(&self, departedhandler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveDeviceDeparted(&self, cookie: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveDeviceDeparted)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    pub fn MaxMessageBytes(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BitsPerSecond(&self) -> Result<u64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDefault() -> Result<ProximityDevice, windows_result::HRESULT> {
        Self::IProximityDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefault)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn FromId(deviceid: &windows_core::HSTRING) -> Result<ProximityDevice, windows_result::HRESULT> {
        Self::IProximityDeviceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IProximityDeviceStatics<R, F: FnOnce(&IProximityDeviceStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl ProximityMessage {
    pub fn MessageType(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SubscriptionId(&self) -> Result<i64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DataAsString(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl TriggeredConnectionStateChangedEventArgs {
    pub fn State(&self) -> Result<TriggeredConnectState, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Networking_Sockets")]
    pub fn Socket(&self) -> Result<super::Sockets::StreamSocket, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
