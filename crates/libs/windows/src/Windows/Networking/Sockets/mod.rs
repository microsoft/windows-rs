...
impl DatagramSocket {
    ...
    pub fn ConnectAsync<P0>(&self, remotehostname: P0, remoteservicename: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    pub fn ConnectWithEndpointPairAsync<P0>(&self, endpointpair: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    pub fn BindServiceNameAsync(&self, localservicename: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BindEndpointAsync<P0>(&self, localhostname: P0, localservicename: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncAction>
    where
        P0: windows_core::Param<super::HostName>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetOutputStreamAsync<P0>(&self, remotehostname: P0, remoteservicename: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<super::super::Storage::Streams::IOutputStream>>
    where
        P0: windows_core::Param<super::HostName>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetOutputStreamWithEndpointPairAsync<P0>(&self, endpointpair: P0) -> windows_core::Result<windows_async::IAsyncOperation<super::super::Storage::Streams::IOutputStream>>
    where
        P0: windows_core::Param<super::EndpointPair>,
    {
        let this = self;
    ...
    pub fn BindServiceNameAndAdapterAsync<P1>(&self, localservicename: &windows_core::HSTRING, adapter: P1) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    pub fn CancelIOAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
    ...
    pub fn GetEndpointPairsAsync<P0>(remotehostname: P0, remoteservicename: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<super::EndpointPair>>>
    where
        P0: windows_core::Param<super::HostName>,
    {
    ...
    pub fn GetEndpointPairsWithSortOptionsAsync<P0>(remotehostname: P0, remoteservicename: &windows_core::HSTRING, sortoptions: super::HostNameSortOptions) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<super::EndpointPair>>>
    where
        P0: windows_core::Param<super::HostName>,
    {
        Self::IDatagramSocketStatics(|this| unsafe {
...
impl IWebSocket {
    ...
    pub fn ConnectAsync<P0>(&self, uri: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
...
pub trait IWebSocket_Impl: super::super::Foundation::IClosable_Impl {
    ...
    fn ConnectAsync(&self, uri: windows_core::Ref<'_, super::super::Foundation::Uri>) -> windows_core::Result<windows_async::IAsyncAction>;
...
impl MessageWebSocket {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SendNonfinalFrameAsync<P0>(&self, data: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<u32, u32>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SendFinalFrameAsync<P0>(&self, data: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<u32, u32>>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        let this = &windows_core::Interface::cast::<IMessageWebSocket3>(self)?;
...
impl StreamSocket {
    ...
    pub fn ConnectWithEndpointPairAndProtectionLevelAsync<P0>(&self, endpointpair: P0, protectionlevel: SocketProtectionLevel) -> windows_core::Result<windows_async::IAsyncAction>
    where
        P0: windows_core::Param<super::EndpointPair>,
    {
        let this = self;
    ...
    pub fn ConnectWithProtectionLevelAsync<P0>(&self, remotehostname: P0, remoteservicename: &windows_core::HSTRING, protectionlevel: SocketProtectionLevel) -> windows_core::Result<windows_async::IAsyncAction>
    where
        P0: windows_core::Param<super::HostName>,
    {
        let this = self;
    ...
    pub fn UpgradeToSslAsync<P1>(&self, protectionlevel: SocketProtectionLevel, validationhostname: P1) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    #[cfg(feature = "Networking_Connectivity")]
    pub fn ConnectWithProtectionLevelAndAdapterAsync<P0, P3>(&self, remotehostname: P0, remoteservicename: &windows_core::HSTRING, protectionlevel: SocketProtectionLevel, adapter: P3) -> windows_core::Result<windows_async::IAsyncAction>
    where
        P0: windows_core::Param<super::HostName>,
...
impl StreamSocketListener {
    ...
    pub fn BindServiceNameWithProtectionLevelAsync(&self, localservicename: &windows_core::HSTRING, protectionlevel: SocketProtectionLevel) -> windows_core::Result<windows_async::IAsyncAction> {
    ...
    #[cfg(feature = "Networking_Connectivity")]
    pub fn BindServiceNameWithProtectionLevelAndAdapterAsync<P2>(&self, localservicename: &windows_core::HSTRING, protectionlevel: SocketProtectionLevel, adapter: P2) -> windows_core::Result<windows_async::IAsyncAction>
    where
