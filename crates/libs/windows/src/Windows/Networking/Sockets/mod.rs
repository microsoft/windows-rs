...
impl ControlChannelTrigger {
    ...
    pub fn ControlChannelTriggerId(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
    ...
    pub fn ServerKeepAliveIntervalInMinutes(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetServerKeepAliveIntervalInMinutes(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn CurrentKeepAliveIntervalInMinutes(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TransportObject(&self) -> windows_result::Result<windows_core::IInspectable> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn KeepAliveTrigger(&self) -> windows_result::Result<super::super::ApplicationModel::Background::IBackgroundTrigger> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ApplicationModel_Background")]
    pub fn PushNotificationTrigger(&self) -> windows_result::Result<super::super::ApplicationModel::Background::IBackgroundTrigger> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UsingTransport<P0>(&self, transport: P0) -> windows_result::Result<()>
    where
    ...
    pub fn WaitForPushEnabled(&self) -> windows_result::Result<ControlChannelTriggerStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DecreaseNetworkKeepAliveInterval(&self) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).DecreaseNetworkKeepAliveInterval)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn FlushTransport(&self) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn CreateControlChannelTrigger(channelid: &windows_core::HSTRING, serverkeepaliveintervalinminutes: u32) -> windows_result::Result<ControlChannelTrigger> {
    ...
    pub fn CreateControlChannelTriggerEx(channelid: &windows_core::HSTRING, serverkeepaliveintervalinminutes: u32, resourcerequesttype: ControlChannelTriggerResourceType) -> windows_result::Result<ControlChannelTrigger> {
        Self::IControlChannelTriggerFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IControlChannelTriggerFactory<R, F: FnOnce(&IControlChannelTriggerFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl DatagramSocket {
    ...
    pub fn Control(&self) -> windows_result::Result<DatagramSocketControl> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Information(&self) -> windows_result::Result<DatagramSocketInformation> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ConnectAsync<P0>(&self, remotehostname: P0, remoteservicename: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    pub fn ConnectWithEndpointPairAsync<P0>(&self, endpointpair: P0) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    pub fn BindServiceNameAsync(&self, localservicename: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BindEndpointAsync<P0>(&self, localhostname: P0, localservicename: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<super::HostName>,
    {
        let this = self;
    ...
    pub fn JoinMulticastGroup<P0>(&self, host: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::HostName>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetOutputStreamAsync<P0>(&self, remotehostname: P0, remoteservicename: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<super::super::Storage::Streams::IOutputStream>>
    where
        P0: windows_core::Param<super::HostName>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetOutputStreamWithEndpointPairAsync<P0>(&self, endpointpair: P0) -> windows_result::Result<windows_future::IAsyncOperation<super::super::Storage::Streams::IOutputStream>>
    where
        P0: windows_core::Param<super::EndpointPair>,
    {
        let this = self;
    ...
    pub fn MessageReceived<P0>(&self, eventhandler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveMessageReceived(&self, eventcookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveMessageReceived)(windows_core::Interface::as_raw(this), eventcookie).ok() }
    }
    #[cfg(feature = "Networking_Connectivity")]
    pub fn BindServiceNameAndAdapterAsync<P1>(&self, localservicename: &windows_core::HSTRING, adapter: P1) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    pub fn CancelIOAsync(&self) -> windows_result::Result<windows_future::IAsyncAction> {
    ...
    pub fn EnableTransferOwnership(&self, taskid: windows_core::GUID) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IDatagramSocket3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).EnableTransferOwnership)(windows_core::Interface::as_raw(this), taskid).ok() }
    }
    pub fn EnableTransferOwnershipWithConnectedStandbyAction(&self, taskid: windows_core::GUID, connectedstandbyaction: SocketActivityConnectedStandbyAction) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IDatagramSocket3>(self)?;
    ...
    pub fn TransferOwnership(&self, socketid: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IDatagramSocket3>(self)?;
    ...
    pub fn TransferOwnershipWithContext<P1>(&self, socketid: &windows_core::HSTRING, data: P1) -> windows_result::Result<()>
    where
    ...
    pub fn TransferOwnershipWithContextAndKeepAliveTime<P1>(&self, socketid: &windows_core::HSTRING, data: P1, keepalivetime: super::super::Foundation::TimeSpan) -> windows_result::Result<()>
    where
        P1: windows_core::Param<SocketActivityContext>,
    {
        let this = &windows_core::Interface::cast::<IDatagramSocket3>(self)?;
    ...
    pub fn GetEndpointPairsAsync<P0>(remotehostname: P0, remoteservicename: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::EndpointPair>>>
    where
        P0: windows_core::Param<super::HostName>,
    {
    ...
    pub fn GetEndpointPairsWithSortOptionsAsync<P0>(remotehostname: P0, remoteservicename: &windows_core::HSTRING, sortoptions: super::HostNameSortOptions) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::EndpointPair>>>
    where
        P0: windows_core::Param<super::HostName>,
    {
        Self::IDatagramSocketStatics(|this| unsafe {
    ...
    fn IDatagramSocketStatics<R, F: FnOnce(&IDatagramSocketStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl DatagramSocketControl {
    pub fn QualityOfService(&self) -> windows_result::Result<SocketQualityOfService> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetQualityOfService(&self, value: SocketQualityOfService) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetQualityOfService)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn OutboundUnicastHopLimit(&self) -> windows_result::Result<u8> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOutboundUnicastHopLimit(&self, value: u8) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetOutboundUnicastHopLimit)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn InboundBufferSizeInBytes(&self) -> windows_result::Result<u32> {
    ...
    pub fn SetInboundBufferSizeInBytes(&self, value: u32) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IDatagramSocketControl2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetInboundBufferSizeInBytes)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DontFragment(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IDatagramSocketControl2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDontFragment(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IDatagramSocketControl2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetDontFragment)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn MulticastOnly(&self) -> windows_result::Result<bool> {
    ...
    pub fn SetMulticastOnly(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IDatagramSocketControl3>(self)?;
...
impl DatagramSocketInformation {
    pub fn LocalAddress(&self) -> windows_result::Result<super::HostName> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RemoteAddress(&self) -> windows_result::Result<super::HostName> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DatagramSocketMessageReceivedEventArgs {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetDataReader(&self) -> windows_result::Result<super::super::Storage::Streams::DataReader> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetDataStream(&self) -> windows_result::Result<super::super::Storage::Streams::IInputStream> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl IControlChannelTriggerEventDetails {
    pub fn ControlChannelTrigger(&self) -> windows_result::Result<ControlChannelTrigger> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IControlChannelTriggerEventDetails_Impl: windows_core::IUnknownImpl {
    fn ControlChannelTrigger(&self) -> windows_result::Result<ControlChannelTrigger>;
}
...
impl IControlChannelTriggerResetEventDetails {
    pub fn ResetReason(&self) -> windows_result::Result<ControlChannelTriggerResetReason> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HardwareSlotReset(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SoftwareSlotReset(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IControlChannelTriggerResetEventDetails_Impl: windows_core::IUnknownImpl {
    fn ResetReason(&self) -> windows_result::Result<ControlChannelTriggerResetReason>;
    fn HardwareSlotReset(&self) -> windows_result::Result<bool>;
    fn SoftwareSlotReset(&self) -> windows_result::Result<bool>;
}
...
impl IWebSocket {
    ...
    pub fn ConnectAsync<P0>(&self, uri: P0) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    pub fn SetRequestHeader(&self, headername: &windows_core::HSTRING, headervalue: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn Closed<P0>(&self, eventhandler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveClosed(&self, eventcookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveClosed)(windows_core::Interface::as_raw(this), eventcookie).ok() }
    }
    pub fn CloseWithStatus(&self, code: u16, reason: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
...
pub trait IWebSocket_Impl: super::super::Foundation::IClosable_Impl {
    fn OutputStream(&self) -> windows_result::Result<super::super::Storage::Streams::IOutputStream>;
    fn ConnectAsync(&self, uri: windows_core::Ref<super::super::Foundation::Uri>) -> windows_result::Result<windows_future::IAsyncAction>;
    fn SetRequestHeader(&self, headerName: &windows_core::HSTRING, headerValue: &windows_core::HSTRING) -> windows_result::Result<()>;
    fn Closed(&self, eventHandler: windows_core::Ref<super::super::Foundation::TypedEventHandler<IWebSocket, WebSocketClosedEventArgs>>) -> windows_result::Result<i64>;
    fn RemoveClosed(&self, eventCookie: i64) -> windows_result::Result<()>;
    fn CloseWithStatus(&self, code: u16, reason: &windows_core::HSTRING) -> windows_result::Result<()>;
}
#[cfg(feature = "Storage_Streams")]
...
impl IWebSocketControl {
    pub fn OutboundBufferSizeInBytes(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOutboundBufferSizeInBytes(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SupportedProtocols(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWebSocketControl_Impl: windows_core::IUnknownImpl {
    fn OutboundBufferSizeInBytes(&self) -> windows_result::Result<u32>;
    fn SetOutboundBufferSizeInBytes(&self, value: u32) -> windows_result::Result<()>;
    ...
    fn SupportedProtocols(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>>;
}
#[cfg(feature = "Security_Credentials")]
...
impl IWebSocketControl2 {
    #[cfg(feature = "Security_Cryptography_Certificates")]
    pub fn IgnorableServerCertificateErrors(&self) -> windows_result::Result<windows_collections::IVector<super::super::Security::Cryptography::Certificates::ChainValidationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWebSocketControl2_Impl: IWebSocketControl_Impl {
    fn IgnorableServerCertificateErrors(&self) -> windows_result::Result<windows_collections::IVector<super::super::Security::Cryptography::Certificates::ChainValidationResult>>;
}
#[cfg(all(feature = "Security_Credentials", feature = "Security_Cryptography_Certificates"))]
...
impl IWebSocketInformation {
    ...
    pub fn BandwidthStatistics(&self) -> windows_result::Result<BandwidthStatistics> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Protocol(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWebSocketInformation_Impl: windows_core::IUnknownImpl {
    fn LocalAddress(&self) -> windows_result::Result<super::HostName>;
    fn BandwidthStatistics(&self) -> windows_result::Result<BandwidthStatistics>;
    fn Protocol(&self) -> windows_result::Result<windows_core::HSTRING>;
}
...
impl IWebSocketInformation2 {
    ...
    pub fn ServerCertificateErrorSeverity(&self) -> windows_result::Result<SocketSslErrorSeverity> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWebSocketInformation2_Impl: IWebSocketInformation_Impl {
    fn ServerCertificate(&self) -> windows_result::Result<super::super::Security::Cryptography::Certificates::Certificate>;
    fn ServerCertificateErrorSeverity(&self) -> windows_result::Result<SocketSslErrorSeverity>;
    fn ServerCertificateErrors(&self) -> windows_result::Result<windows_collections::IVectorView<super::super::Security::Cryptography::Certificates::ChainValidationResult>>;
    fn ServerIntermediateCertificates(&self) -> windows_result::Result<windows_collections::IVectorView<super::super::Security::Cryptography::Certificates::Certificate>>;
}
#[cfg(feature = "Security_Cryptography_Certificates")]
...
impl MessageWebSocket {
    ...
    pub fn Control(&self) -> windows_result::Result<MessageWebSocketControl> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Control)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Information(&self) -> windows_result::Result<MessageWebSocketInformation> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Information)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ServerCustomValidationRequested<P0>(&self, eventhandler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveServerCustomValidationRequested(&self, eventcookie: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMessageWebSocket2>(self)?;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SendNonfinalFrameAsync<P0>(&self, data: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<u32, u32>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SendFinalFrameAsync<P0>(&self, data: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<u32, u32>>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        let this = &windows_core::Interface::cast::<IMessageWebSocket3>(self)?;
...
impl MessageWebSocketControl {
    pub fn MaxMessageSize(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxMessageSize(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetMaxMessageSize)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn MessageType(&self) -> windows_result::Result<SocketMessageType> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMessageType(&self, value: SocketMessageType) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetMessageType)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DesiredUnsolicitedPongInterval(&self) -> windows_result::Result<super::super::Foundation::TimeSpan> {
    ...
    pub fn SetDesiredUnsolicitedPongInterval(&self, value: super::super::Foundation::TimeSpan) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMessageWebSocketControl2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetDesiredUnsolicitedPongInterval)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ActualUnsolicitedPongInterval(&self) -> windows_result::Result<super::super::Foundation::TimeSpan> {
        let this = &windows_core::Interface::cast::<IMessageWebSocketControl2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReceiveMode(&self) -> windows_result::Result<MessageWebSocketReceiveMode> {
        let this = &windows_core::Interface::cast::<IMessageWebSocketControl2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetReceiveMode(&self, value: MessageWebSocketReceiveMode) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IMessageWebSocketControl2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetReceiveMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Security_Cryptography_Certificates")]
    pub fn ClientCertificate(&self) -> windows_result::Result<super::super::Security::Cryptography::Certificates::Certificate> {
        let this = &windows_core::Interface::cast::<IMessageWebSocketControl2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MessageWebSocketMessageReceivedEventArgs {
    ...
    pub fn IsMessageComplete(&self) -> windows_result::Result<bool> {
...
impl ServerMessageWebSocket {
    ...
    pub fn MessageReceived<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn Control(&self) -> windows_result::Result<ServerMessageWebSocketControl> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Control)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Information(&self) -> windows_result::Result<ServerMessageWebSocketInformation> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Information)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Closed<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
...
impl ServerStreamWebSocket {
    ...
    pub fn Information(&self) -> windows_result::Result<ServerStreamWebSocketInformation> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Information)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl SocketActivityContext {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Create<P0>(data: P0) -> windows_result::Result<SocketActivityContext>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
    ...
    fn ISocketActivityContextFactory<R, F: FnOnce(&ISocketActivityContextFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl SocketActivityInformation {
    ...
    pub fn SocketKind(&self) -> windows_result::Result<SocketActivityKind> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Context(&self) -> windows_result::Result<SocketActivityContext> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DatagramSocket(&self) -> windows_result::Result<DatagramSocket> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StreamSocket(&self) -> windows_result::Result<StreamSocket> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StreamSocketListener(&self) -> windows_result::Result<StreamSocketListener> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AllSockets() -> windows_result::Result<windows_collections::IMapView<windows_core::HSTRING, SocketActivityInformation>> {
    ...
    fn ISocketActivityInformationStatics<R, F: FnOnce(&ISocketActivityInformationStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl SocketActivityTriggerDetails {
    pub fn Reason(&self) -> windows_result::Result<SocketActivityTriggerReason> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SocketInformation(&self) -> windows_result::Result<SocketActivityInformation> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SocketError {
    pub fn GetStatus(hresult: i32) -> windows_result::Result<SocketErrorStatus> {
    ...
    fn ISocketErrorStatics<R, F: FnOnce(&ISocketErrorStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl StreamSocket {
    ...
    pub fn Control(&self) -> windows_result::Result<StreamSocketControl> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Control)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Information(&self) -> windows_result::Result<StreamSocketInformation> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Information)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ConnectWithEndpointPairAndProtectionLevelAsync<P0>(&self, endpointpair: P0, protectionlevel: SocketProtectionLevel) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<super::EndpointPair>,
    {
        let this = self;
    ...
    pub fn ConnectWithProtectionLevelAsync<P0>(&self, remotehostname: P0, remoteservicename: &windows_core::HSTRING, protectionlevel: SocketProtectionLevel) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<super::HostName>,
    {
        let this = self;
    ...
    pub fn UpgradeToSslAsync<P1>(&self, protectionlevel: SocketProtectionLevel, validationhostname: P1) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    #[cfg(feature = "Networking_Connectivity")]
    pub fn ConnectWithProtectionLevelAndAdapterAsync<P0, P3>(&self, remotehostname: P0, remoteservicename: &windows_core::HSTRING, protectionlevel: SocketProtectionLevel, adapter: P3) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<super::HostName>,
    ...
    fn IStreamSocketStatics<R, F: FnOnce(&IStreamSocketStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl StreamSocketControl {
    pub fn NoDelay(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetNoDelay(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetNoDelay)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn KeepAlive(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetKeepAlive(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SerializeConnectionAttempts(&self) -> windows_result::Result<bool> {
    ...
    pub fn SetSerializeConnectionAttempts(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IStreamSocketControl3>(self)?;
    ...
    pub fn MinProtectionLevel(&self) -> windows_result::Result<SocketProtectionLevel> {
    ...
    pub fn SetMinProtectionLevel(&self, value: SocketProtectionLevel) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IStreamSocketControl4>(self)?;
...
impl StreamSocketInformation {
    ...
    pub fn RoundTripTimeStatistics(&self) -> windows_result::Result<RoundTripTimeStatistics> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ProtectionLevel(&self) -> windows_result::Result<SocketProtectionLevel> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SessionKey(&self) -> windows_result::Result<super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl StreamSocketListener {
    ...
    pub fn Control(&self) -> windows_result::Result<StreamSocketListenerControl> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Control)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Information(&self) -> windows_result::Result<StreamSocketListenerInformation> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Information)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ConnectionReceived<P0>(&self, eventhandler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveConnectionReceived(&self, eventcookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveConnectionReceived)(windows_core::Interface::as_raw(this), eventcookie).ok() }
    }
    pub fn BindServiceNameWithProtectionLevelAsync(&self, localservicename: &windows_core::HSTRING, protectionlevel: SocketProtectionLevel) -> windows_result::Result<windows_future::IAsyncAction> {
    ...
    #[cfg(feature = "Networking_Connectivity")]
    pub fn BindServiceNameWithProtectionLevelAndAdapterAsync<P2>(&self, localservicename: &windows_core::HSTRING, protectionlevel: SocketProtectionLevel, adapter: P2) -> windows_result::Result<windows_future::IAsyncAction>
    where
...
impl StreamSocketListenerConnectionReceivedEventArgs {
    pub fn Socket(&self) -> windows_result::Result<StreamSocket> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl StreamWebSocket {
    ...
    pub fn Control(&self) -> windows_result::Result<StreamWebSocketControl> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Control)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Information(&self) -> windows_result::Result<StreamWebSocketInformation> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Information)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl WebSocketClosedEventArgs {
    pub fn Code(&self) -> windows_result::Result<u16> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Reason(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WebSocketError {
    #[cfg(feature = "Web")]
    pub fn GetStatus(hresult: i32) -> windows_result::Result<super::super::Web::WebErrorStatus> {
        Self::IWebSocketErrorStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetStatus)(windows_core::Interface::as_raw(this), hresult, &mut result__).map(|| result__)
        })
    }
    fn IWebSocketErrorStatics<R, F: FnOnce(&IWebSocketErrorStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
