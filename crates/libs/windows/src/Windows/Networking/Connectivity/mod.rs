...
windows_core::imp::required_hierarchy!(AttributedNetworkUsage, IAttributedNetworkUsage);
...
windows_core::imp::required_hierarchy!(CellularApnContext, ICellularApnContext, ICellularApnContext2);
...
windows_core::imp::required_hierarchy!(ConnectionCost, IConnectionCost, IConnectionCost2);
impl ConnectionCost {
...
windows_core::imp::required_hierarchy!(ConnectionProfile, IConnectionProfile, IConnectionProfile2, IConnectionProfile3, IConnectionProfile4, IConnectionProfile5, IConnectionProfile6);
...
windows_core::imp::required_hierarchy!(ConnectionProfileFilter, IConnectionProfileFilter, IConnectionProfileFilter2, IConnectionProfileFilter3);
...
windows_core::imp::required_hierarchy!(ConnectionSession, super::super::Foundation::IClosable, IConnectionSession);
...
windows_core::imp::required_hierarchy!(ConnectivityInterval, IConnectivityInterval);
...
windows_core::imp::required_hierarchy!(DataPlanStatus, IDataPlanStatus);
impl DataPlanStatus {
...
windows_core::imp::required_hierarchy!(DataPlanUsage, IDataPlanUsage);
impl DataPlanUsage {
...
#[cfg(feature = "deprecated")]
windows_core::imp::required_hierarchy!(DataUsage, IDataUsage);
#[cfg(feature = "deprecated")]
impl DataUsage {
    #[cfg(feature = "deprecated")]
    pub fn BytesSent(&self) -> windows_core::Result<u64> {
...
windows_core::imp::required_hierarchy!(IPInformation, IIPInformation);
impl IPInformation {
    pub fn NetworkAdapter(&self) -> windows_core::Result<NetworkAdapter> {
        let this = self;
        unsafe {
...
windows_core::imp::required_hierarchy!(LanIdentifier, ILanIdentifier);
impl LanIdentifier {
...
windows_core::imp::required_hierarchy!(LanIdentifierData, ILanIdentifierData);
...
windows_core::imp::required_hierarchy!(NetworkAdapter, INetworkAdapter);
impl NetworkAdapter {
...
windows_core::imp::required_hierarchy!(NetworkItem, INetworkItem);
impl NetworkItem {
...
windows_core::imp::required_hierarchy!(NetworkSecuritySettings, INetworkSecuritySettings);
...
windows_core::imp::required_hierarchy!(NetworkStateChangeEventDetails, INetworkStateChangeEventDetails, INetworkStateChangeEventDetails2);
...
windows_core::imp::required_hierarchy!(NetworkUsage, INetworkUsage);
impl NetworkUsage {
    pub fn BytesSent(&self) -> windows_core::Result<u64> {
        let this = self;
        unsafe {
...
windows_core::imp::required_hierarchy!(ProviderNetworkUsage, IProviderNetworkUsage);
...
windows_core::imp::required_hierarchy!(ProxyConfiguration, IProxyConfiguration);
...
windows_core::imp::required_hierarchy!(RoutePolicy, IRoutePolicy, IRoutePolicyFactory);
impl RoutePolicy {
    pub fn ConnectionProfile(&self) -> windows_core::Result<ConnectionProfile> {
        let this = self;
        unsafe {
...
windows_core::imp::required_hierarchy!(WlanConnectionProfileDetails, IWlanConnectionProfileDetails);
...
windows_core::imp::required_hierarchy!(WwanConnectionProfileDetails, IWwanConnectionProfileDetails, IWwanConnectionProfileDetails2);
