...
impl ConnectionProfile {
    ...
    pub fn GetNetworkUsageAsync(&self, starttime: super::super::Foundation::DateTime, endtime: super::super::Foundation::DateTime, granularity: DataUsageGranularity, states: NetworkUsageStates) -> windows_core::Result<super::super::Foundation::IAsyncOperation<windows_collections::IVectorView<NetworkUsage>>> {
        let this = &windows_core::Interface::cast::<IConnectionProfile2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetConnectivityIntervalsAsync(&self, starttime: super::super::Foundation::DateTime, endtime: super::super::Foundation::DateTime, states: NetworkUsageStates) -> windows_core::Result<super::super::Foundation::IAsyncOperation<windows_collections::IVectorView<ConnectivityInterval>>> {
        let this = &windows_core::Interface::cast::<IConnectionProfile2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAttributedNetworkUsageAsync(&self, starttime: super::super::Foundation::DateTime, endtime: super::super::Foundation::DateTime, states: NetworkUsageStates) -> windows_core::Result<super::super::Foundation::IAsyncOperation<windows_collections::IVectorView<AttributedNetworkUsage>>> {
    ...
    pub fn GetProviderNetworkUsageAsync(&self, starttime: super::super::Foundation::DateTime, endtime: super::super::Foundation::DateTime, states: NetworkUsageStates) -> windows_core::Result<super::super::Foundation::IAsyncOperation<windows_collections::IVectorView<ProviderNetworkUsage>>> {
...
impl NetworkInformation {
    ...
    pub fn FindConnectionProfilesAsync<P0>(pprofilefilter: P0) -> windows_core::Result<super::super::Foundation::IAsyncOperation<windows_collections::IVectorView<ConnectionProfile>>>
    where
