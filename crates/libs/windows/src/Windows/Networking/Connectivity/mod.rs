...
#[repr(C)]
struct NetworkStatusChangedEventHandlerBox<F: FnMut(&windows_core::IInspectable) -> windows_core::Result<()> + Send + 'static> {
    vtable: *const NetworkStatusChangedEventHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(&windows_core::IInspectable) -> windows_core::Result<()> + Send + 'static> NetworkStatusChangedEventHandlerBox<F> {
