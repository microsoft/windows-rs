...
impl PushNotificationChannel {
    pub fn Uri(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn ExpirationTime(&self) -> Result<super::super::Foundation::DateTime, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PushNotificationReceived<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemovePushNotificationReceived(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl PushNotificationChannelManager {
    pub fn CreatePushNotificationChannelForApplicationAsync() -> Result<windows_future::IAsyncOperation<PushNotificationChannel>, windows_result::HRESULT> {
    ...
    pub fn CreatePushNotificationChannelForApplicationAsyncWithId(applicationid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<PushNotificationChannel>, windows_result::HRESULT> {
        Self::IPushNotificationChannelManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreatePushNotificationChannelForSecondaryTileAsync(tileid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<PushNotificationChannel>, windows_result::HRESULT> {
        Self::IPushNotificationChannelManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "System")]
    pub fn GetForUser<P0>(user: P0) -> Result<PushNotificationChannelManagerForUser, windows_result::HRESULT>
    where
    ...
    pub fn GetDefault() -> Result<PushNotificationChannelManagerForUser, windows_result::HRESULT> {
        Self::IPushNotificationChannelManagerStatics3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefault)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn ChannelsRevoked<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveChannelsRevoked(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    fn IPushNotificationChannelManagerStatics<R, F: FnOnce(&IPushNotificationChannelManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IPushNotificationChannelManagerStatics2<R, F: FnOnce(&IPushNotificationChannelManagerStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IPushNotificationChannelManagerStatics3<R, F: FnOnce(&IPushNotificationChannelManagerStatics3) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IPushNotificationChannelManagerStatics4<R, F: FnOnce(&IPushNotificationChannelManagerStatics4) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl PushNotificationChannelManagerForUser {
    pub fn CreatePushNotificationChannelForApplicationAsync(&self) -> Result<windows_future::IAsyncOperation<PushNotificationChannel>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreatePushNotificationChannelForApplicationAsync)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CreatePushNotificationChannelForApplicationAsyncWithId(&self, applicationid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<PushNotificationChannel>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreatePushNotificationChannelForApplicationAsyncWithId)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(applicationid), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CreatePushNotificationChannelForSecondaryTileAsync(&self, tileid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<PushNotificationChannel>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreatePushNotificationChannelForSecondaryTileAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(tileid), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateRawPushNotificationChannelWithAlternateKeyForApplicationAsync<P0>(&self, appserverkey: P0, channelid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<PushNotificationChannel>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateRawPushNotificationChannelWithAlternateKeyForApplicationAsyncWithId<P0>(&self, appserverkey: P0, channelid: &windows_core::HSTRING, appid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<PushNotificationChannel>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        let this = &windows_core::Interface::cast::<IPushNotificationChannelManagerForUser2>(self)?;
...
impl PushNotificationReceivedEventArgs {
    pub fn SetCancel(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCancel)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Cancel(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NotificationType(&self) -> Result<PushNotificationType, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Notifications")]
    pub fn ToastNotification(&self) -> Result<super::super::UI::Notifications::ToastNotification, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Notifications")]
    pub fn TileNotification(&self) -> Result<super::super::UI::Notifications::TileNotification, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Notifications")]
    pub fn BadgeNotification(&self) -> Result<super::super::UI::Notifications::BadgeNotification, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RawNotification(&self) -> Result<RawNotification, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl RawNotification {
    ...
    pub fn Headers(&self) -> Result<windows_collections::IMapView<windows_core::HSTRING, windows_core::HSTRING>, windows_result::HRESULT> {
    ...
    pub fn ChannelId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IRawNotification2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ContentBytes(&self) -> Result<super::super::Storage::Streams::IBuffer, windows_result::HRESULT> {
