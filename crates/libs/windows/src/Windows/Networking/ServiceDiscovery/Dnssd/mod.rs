...
impl DnssdRegistrationResult {
    ...
    pub fn Status(&self) -> windows_result::Result<DnssdRegistrationStatus> {
        let this = self;
        unsafe {
    ...
    pub fn IPAddress(&self) -> windows_result::Result<super::super::HostName> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HasInstanceNameChanged(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DnssdServiceInstance {
    pub fn DnssdServiceInstanceName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDnssdServiceInstanceName(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn HostName(&self) -> windows_result::Result<super::super::HostName> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetHostName<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn Port(&self) -> windows_result::Result<u16> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPort(&self, value: u16) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetPort)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Priority(&self) -> windows_result::Result<u16> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPriority(&self, value: u16) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetPriority)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Weight(&self) -> windows_result::Result<u16> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetWeight(&self, value: u16) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetWeight)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn TextAttributes(&self) -> windows_result::Result<windows_collections::IMap<windows_core::HSTRING, windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RegisterStreamSocketListenerAsync<P0>(&self, socket: P0) -> windows_result::Result<windows_future::IAsyncOperation<DnssdRegistrationResult>>
    where
    ...
    pub fn RegisterStreamSocketListenerAsync2<P0, P1>(&self, socket: P0, adapter: P1) -> windows_result::Result<windows_future::IAsyncOperation<DnssdRegistrationResult>>
    where
        P0: windows_core::Param<super::super::Sockets::StreamSocketListener>,
    ...
    #[cfg(feature = "Networking_Sockets")]
    pub fn RegisterDatagramSocketAsync<P0>(&self, socket: P0) -> windows_result::Result<windows_future::IAsyncOperation<DnssdRegistrationResult>>
    where
    ...
    #[cfg(all(feature = "Networking_Connectivity", feature = "Networking_Sockets"))]
    pub fn RegisterDatagramSocketAsync2<P0, P1>(&self, socket: P0, adapter: P1) -> windows_result::Result<windows_future::IAsyncOperation<DnssdRegistrationResult>>
    where
        P0: windows_core::Param<super::super::Sockets::DatagramSocket>,
        P1: windows_core::Param<super::super::Connectivity::NetworkAdapter>,
    {
    ...
    pub fn Create<P1>(dnssdserviceinstancename: &windows_core::HSTRING, hostname: P1, port: u16) -> windows_result::Result<DnssdServiceInstance>
    where
    ...
    fn IDnssdServiceInstanceFactory<R, F: FnOnce(&IDnssdServiceInstanceFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl DnssdServiceInstanceCollection {
    pub fn First(&self) -> windows_result::Result<windows_collections::IIterator<DnssdServiceInstance>> {
    ...
    pub fn GetAt(&self, index: u32) -> windows_result::Result<DnssdServiceInstance> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMany(&self, startindex: u32, items: &mut [Option<DnssdServiceInstance>]) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DnssdServiceWatcher {
    ...
    pub fn Status(&self) -> windows_result::Result<DnssdServiceWatcherStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
