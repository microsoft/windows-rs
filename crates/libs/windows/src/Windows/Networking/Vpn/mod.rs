...
impl IVpnChannelStatics {
    pub fn ProcessEventAsync<P0, P1>(&self, thirdpartyplugin: P0, event: P1) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IVpnChannelStatics_Impl: windows_core::IUnknownImpl {
    fn ProcessEventAsync(&self, thirdPartyPlugIn: windows_core::Ref<'_, windows_core::IInspectable>, event: windows_core::Ref<'_, windows_core::IInspectable>) -> Result<(), windows_result::HRESULT>;
}
impl IVpnChannelStatics_Vtbl {
    pub const fn new<Identity: IVpnChannelStatics_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ProcessEventAsync<Identity: IVpnChannelStatics_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, thirdpartyplugin: *mut core::ffi::c_void, event: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
...
impl IVpnCredential {
    ...
    pub fn PasskeyCredential(&self) -> Result<super::super::Security::Credentials::PasswordCredential, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    #[cfg(feature = "Security_Cryptography_Certificates")]
    pub fn CertificateCredential(&self) -> Result<super::super::Security::Cryptography::Certificates::Certificate, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AdditionalPin(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn OldPasswordCredential(&self) -> Result<super::super::Security::Credentials::PasswordCredential, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVpnCredential_Impl: windows_core::IUnknownImpl {
    fn PasskeyCredential(&self) -> Result<super::super::Security::Credentials::PasswordCredential, windows_result::HRESULT>;
    fn CertificateCredential(&self) -> Result<super::super::Security::Cryptography::Certificates::Certificate, windows_result::HRESULT>;
    fn AdditionalPin(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT>;
    fn OldPasswordCredential(&self) -> Result<super::super::Security::Credentials::PasswordCredential, windows_result::HRESULT>;
}
#[cfg(all(feature = "Security_Credentials", feature = "Security_Cryptography_Certificates"))]
impl IVpnCredential_Vtbl {
    pub const fn new<Identity: IVpnCredential_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn PasskeyCredential<Identity: IVpnCredential_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CertificateCredential<Identity: IVpnCredential_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn AdditionalPin<Identity: IVpnCredential_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn OldPasswordCredential<Identity: IVpnCredential_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IVpnCustomPrompt {
    ...
    pub fn SetCompulsory(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCompulsory)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Compulsory(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetBordered(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetBordered)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Bordered(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVpnCustomPrompt_Impl: windows_core::IUnknownImpl {
    ...
    fn SetCompulsory(&self, value: bool) -> Result<(), windows_result::HRESULT>;
    fn Compulsory(&self) -> Result<bool, windows_result::HRESULT>;
    fn SetBordered(&self, value: bool) -> Result<(), windows_result::HRESULT>;
    fn Bordered(&self) -> Result<bool, windows_result::HRESULT>;
}
impl IVpnCustomPrompt_Vtbl {
    pub const fn new<Identity: IVpnCustomPrompt_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetLabel<Identity: IVpnCustomPrompt_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IVpnCustomPrompt_Impl::SetLabel(this, core::mem::transmute(&value)).into()
            }
        }
        unsafe extern "system" fn Label<Identity: IVpnCustomPrompt_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetCompulsory<Identity: IVpnCustomPrompt_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IVpnCustomPrompt_Impl::SetCompulsory(this, value).into()
            }
        }
        unsafe extern "system" fn Compulsory<Identity: IVpnCustomPrompt_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetBordered<Identity: IVpnCustomPrompt_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IVpnCustomPrompt_Impl::SetBordered(this, value).into()
            }
        }
        unsafe extern "system" fn Bordered<Identity: IVpnCustomPrompt_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IVpnCustomPromptElement {
    ...
    pub fn SetEmphasized(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetEmphasized)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Emphasized(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVpnCustomPromptElement_Impl: windows_core::IUnknownImpl {
    ...
    fn SetCompulsory(&self, value: bool) -> Result<(), windows_result::HRESULT>;
    fn Compulsory(&self) -> Result<bool, windows_result::HRESULT>;
    fn SetEmphasized(&self, value: bool) -> Result<(), windows_result::HRESULT>;
    fn Emphasized(&self) -> Result<bool, windows_result::HRESULT>;
}
impl IVpnCustomPromptElement_Vtbl {
    pub const fn new<Identity: IVpnCustomPromptElement_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetDisplayName<Identity: IVpnCustomPromptElement_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IVpnCustomPromptElement_Impl::SetDisplayName(this, core::mem::transmute(&value)).into()
            }
        }
        unsafe extern "system" fn DisplayName<Identity: IVpnCustomPromptElement_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetCompulsory<Identity: IVpnCustomPromptElement_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IVpnCustomPromptElement_Impl::SetCompulsory(this, value).into()
            }
        }
        unsafe extern "system" fn Compulsory<Identity: IVpnCustomPromptElement_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetEmphasized<Identity: IVpnCustomPromptElement_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IVpnCustomPromptElement_Impl::SetEmphasized(this, value).into()
            }
        }
        unsafe extern "system" fn Emphasized<Identity: IVpnCustomPromptElement_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IVpnDomainNameInfoFactory {
    pub fn CreateVpnDomainNameInfo<P2, P3>(&self, name: &windows_core::HSTRING, nametype: VpnDomainNameType, dnsserverlist: P2, proxyserverlist: P3) -> Result<VpnDomainNameInfo, windows_result::HRESULT>
    where
...
pub trait IVpnDomainNameInfoFactory_Impl: windows_core::IUnknownImpl {
    fn CreateVpnDomainNameInfo(&self, name: &windows_core::HSTRING, nameType: VpnDomainNameType, dnsServerList: windows_core::Ref<'_, windows_collections::IIterable<super::HostName>>, proxyServerList: windows_core::Ref<'_, windows_collections::IIterable<super::HostName>>) -> Result<VpnDomainNameInfo, windows_result::HRESULT>;
}
impl IVpnDomainNameInfoFactory_Vtbl {
    pub const fn new<Identity: IVpnDomainNameInfoFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateVpnDomainNameInfo<Identity: IVpnDomainNameInfoFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, name: *mut core::ffi::c_void, nametype: VpnDomainNameType, dnsserverlist: *mut core::ffi::c_void, proxyserverlist: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IVpnInterfaceIdFactory {
    pub fn CreateVpnInterfaceId(&self, address: &[u8]) -> Result<VpnInterfaceId, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IVpnInterfaceIdFactory_Impl: windows_core::IUnknownImpl {
    fn CreateVpnInterfaceId(&self, address: &[u8]) -> Result<VpnInterfaceId, windows_result::HRESULT>;
}
impl IVpnInterfaceIdFactory_Vtbl {
    pub const fn new<Identity: IVpnInterfaceIdFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateVpnInterfaceId<Identity: IVpnInterfaceIdFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, address_array_size: u32, address: *const u8, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IVpnNamespaceInfoFactory {
    pub fn CreateVpnNamespaceInfo<P1, P2>(&self, name: &windows_core::HSTRING, dnsserverlist: P1, proxyserverlist: P2) -> Result<VpnNamespaceInfo, windows_result::HRESULT>
    where
...
pub trait IVpnNamespaceInfoFactory_Impl: windows_core::IUnknownImpl {
    fn CreateVpnNamespaceInfo(&self, name: &windows_core::HSTRING, dnsServerList: windows_core::Ref<'_, windows_collections::IVector<super::HostName>>, proxyServerList: windows_core::Ref<'_, windows_collections::IVector<super::HostName>>) -> Result<VpnNamespaceInfo, windows_result::HRESULT>;
}
impl IVpnNamespaceInfoFactory_Vtbl {
    pub const fn new<Identity: IVpnNamespaceInfoFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateVpnNamespaceInfo<Identity: IVpnNamespaceInfoFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, name: *mut core::ffi::c_void, dnsserverlist: *mut core::ffi::c_void, proxyserverlist: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IVpnPacketBufferFactory {
    pub fn CreateVpnPacketBuffer<P0>(&self, parentbuffer: P0, offset: u32, length: u32) -> Result<VpnPacketBuffer, windows_result::HRESULT>
    where
...
pub trait IVpnPacketBufferFactory_Impl: windows_core::IUnknownImpl {
    fn CreateVpnPacketBuffer(&self, parentBuffer: windows_core::Ref<'_, VpnPacketBuffer>, offset: u32, length: u32) -> Result<VpnPacketBuffer, windows_result::HRESULT>;
}
impl IVpnPacketBufferFactory_Vtbl {
    pub const fn new<Identity: IVpnPacketBufferFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateVpnPacketBuffer<Identity: IVpnPacketBufferFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, parentbuffer: *mut core::ffi::c_void, offset: u32, length: u32, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IVpnPlugIn {
    pub fn Connect<P0>(&self, channel: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn Disconnect<P0>(&self, channel: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<VpnChannel>,
    {
        let this = self;
    ...
    pub fn GetKeepAlivePayload<P0>(&self, channel: P0, keepalivepacket: &mut Option<VpnPacketBuffer>) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<VpnChannel>,
    {
        let this = self;
    ...
    pub fn Encapsulate<P0, P1, P2>(&self, channel: P0, packets: P1, encapulatedpackets: P2) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<VpnChannel>,
    ...
    pub fn Decapsulate<P0, P1, P2, P3>(&self, channel: P0, encapbuffer: P1, decapsulatedpackets: P2, controlpacketstosend: P3) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<VpnChannel>,
...
pub trait IVpnPlugIn_Impl: windows_core::IUnknownImpl {
    fn Connect(&self, channel: windows_core::Ref<'_, VpnChannel>) -> Result<(), windows_result::HRESULT>;
    fn Disconnect(&self, channel: windows_core::Ref<'_, VpnChannel>) -> Result<(), windows_result::HRESULT>;
    fn GetKeepAlivePayload(&self, channel: windows_core::Ref<'_, VpnChannel>, keepAlivePacket: windows_core::OutRef<'_, VpnPacketBuffer>) -> Result<(), windows_result::HRESULT>;
    fn Encapsulate(&self, channel: windows_core::Ref<'_, VpnChannel>, packets: windows_core::Ref<'_, VpnPacketBufferList>, encapulatedPackets: windows_core::Ref<'_, VpnPacketBufferList>) -> Result<(), windows_result::HRESULT>;
    fn Decapsulate(&self, channel: windows_core::Ref<'_, VpnChannel>, encapBuffer: windows_core::Ref<'_, VpnPacketBuffer>, decapsulatedPackets: windows_core::Ref<'_, VpnPacketBufferList>, controlPacketsToSend: windows_core::Ref<'_, VpnPacketBufferList>) -> Result<(), windows_result::HRESULT>;
}
impl IVpnPlugIn_Vtbl {
    pub const fn new<Identity: IVpnPlugIn_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Connect<Identity: IVpnPlugIn_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, channel: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IVpnPlugIn_Impl::Connect(this, core::mem::transmute_copy(&channel)).into()
            }
        }
        unsafe extern "system" fn Disconnect<Identity: IVpnPlugIn_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, channel: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IVpnPlugIn_Impl::Disconnect(this, core::mem::transmute_copy(&channel)).into()
            }
        }
        unsafe extern "system" fn GetKeepAlivePayload<Identity: IVpnPlugIn_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, channel: *mut core::ffi::c_void, keepalivepacket: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IVpnPlugIn_Impl::GetKeepAlivePayload(this, core::mem::transmute_copy(&channel), core::mem::transmute_copy(&keepalivepacket)).into()
            }
        }
        unsafe extern "system" fn Encapsulate<Identity: IVpnPlugIn_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, channel: *mut core::ffi::c_void, packets: *mut core::ffi::c_void, encapulatedpackets: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Decapsulate<Identity: IVpnPlugIn_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, channel: *mut core::ffi::c_void, encapbuffer: *mut core::ffi::c_void, decapsulatedpackets: *mut core::ffi::c_void, controlpacketstosend: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IVpnPlugInReconnectTransport {
    pub fn ReconnectTransport<P0, P1>(&self, channel: P0, context: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<VpnChannel>,
        P1: windows_core::Param<windows_core::IInspectable>,
    {
...
pub trait IVpnPlugInReconnectTransport_Impl: windows_core::IUnknownImpl {
    fn ReconnectTransport(&self, channel: windows_core::Ref<'_, VpnChannel>, context: windows_core::Ref<'_, windows_core::IInspectable>) -> Result<(), windows_result::HRESULT>;
}
impl IVpnPlugInReconnectTransport_Vtbl {
    pub const fn new<Identity: IVpnPlugInReconnectTransport_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ReconnectTransport<Identity: IVpnPlugInReconnectTransport_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, channel: *mut core::ffi::c_void, context: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IVpnProfile {
    ...
    pub fn AppTriggers(&self) -> Result<windows_collections::IVector<VpnAppId>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Routes(&self) -> Result<windows_collections::IVector<VpnRoute>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DomainNameInfoList(&self) -> Result<windows_collections::IVector<VpnDomainNameInfo>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TrafficFilters(&self) -> Result<windows_collections::IVector<VpnTrafficFilter>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RememberCredentials(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRememberCredentials(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetRememberCredentials)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AlwaysOn(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAlwaysOn(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
pub trait IVpnProfile_Impl: windows_core::IUnknownImpl {
    fn ProfileName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT>;
    fn SetProfileName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT>;
    fn AppTriggers(&self) -> Result<windows_collections::IVector<VpnAppId>, windows_result::HRESULT>;
    fn Routes(&self) -> Result<windows_collections::IVector<VpnRoute>, windows_result::HRESULT>;
    fn DomainNameInfoList(&self) -> Result<windows_collections::IVector<VpnDomainNameInfo>, windows_result::HRESULT>;
    fn TrafficFilters(&self) -> Result<windows_collections::IVector<VpnTrafficFilter>, windows_result::HRESULT>;
    fn RememberCredentials(&self) -> Result<bool, windows_result::HRESULT>;
    fn SetRememberCredentials(&self, value: bool) -> Result<(), windows_result::HRESULT>;
    fn AlwaysOn(&self) -> Result<bool, windows_result::HRESULT>;
    fn SetAlwaysOn(&self, value: bool) -> Result<(), windows_result::HRESULT>;
}
impl IVpnProfile_Vtbl {
    pub const fn new<Identity: IVpnProfile_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ProfileName<Identity: IVpnProfile_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetProfileName<Identity: IVpnProfile_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IVpnProfile_Impl::SetProfileName(this, core::mem::transmute(&value)).into()
            }
        }
        unsafe extern "system" fn AppTriggers<Identity: IVpnProfile_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Routes<Identity: IVpnProfile_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn DomainNameInfoList<Identity: IVpnProfile_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TrafficFilters<Identity: IVpnProfile_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn RememberCredentials<Identity: IVpnProfile_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetRememberCredentials<Identity: IVpnProfile_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IVpnProfile_Impl::SetRememberCredentials(this, value).into()
            }
        }
        unsafe extern "system" fn AlwaysOn<Identity: IVpnProfile_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetAlwaysOn<Identity: IVpnProfile_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: bool) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IVpnRouteFactory {
    pub fn CreateVpnRoute<P0>(&self, address: P0, prefixsize: u8) -> Result<VpnRoute, windows_result::HRESULT>
    where
...
pub trait IVpnRouteFactory_Impl: windows_core::IUnknownImpl {
    fn CreateVpnRoute(&self, address: windows_core::Ref<'_, super::HostName>, prefixSize: u8) -> Result<VpnRoute, windows_result::HRESULT>;
}
impl IVpnRouteFactory_Vtbl {
    pub const fn new<Identity: IVpnRouteFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateVpnRoute<Identity: IVpnRouteFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, address: *mut core::ffi::c_void, prefixsize: u8, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl VpnAppId {
    pub fn Type(&self) -> Result<VpnAppIdType, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetType(&self, value: VpnAppIdType) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Create(r#type: VpnAppIdType, value: &windows_core::HSTRING) -> Result<VpnAppId, windows_result::HRESULT> {
    ...
    fn IVpnAppIdFactory<R, F: FnOnce(&IVpnAppIdFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl VpnChannel {
    pub fn AssociateTransport<P0, P1>(&self, mainoutertunneltransport: P0, optionaloutertunneltransport: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IInspectable>,
        P1: windows_core::Param<windows_core::IInspectable>,
    {
    ...
    pub fn Start<P0, P1, P2, P3, P4, P8, P9>(&self, assignedclientipv4list: P0, assignedclientipv6list: P1, vpninterfaceid: P2, routescope: P3, namespacescope: P4, mtusize: u32, maxframesize: u32, optimizeforlowcostnetwork: bool, mainoutertunneltransport: P8, optionaloutertunneltransport: P9) -> Result<(), windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Security_Cryptography_Certificates")]
    pub fn RequestCredentials<P3>(&self, credtype: VpnCredentialType, isretry: bool, issinglesignoncredential: bool, certificate: P3) -> Result<VpnPickedCredential, windows_result::HRESULT>
    where
    ...
    pub fn RequestVpnPacketBuffer(&self, r#type: VpnDataPathType, vpnpacketbuffer: &mut Option<VpnPacketBuffer>) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn LogDiagnosticMessage(&self, message: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Configuration(&self) -> Result<VpnChannelConfiguration, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ActivityChange<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveActivityChange(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveActivityChange)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn SetPlugInContext<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IInspectable>,
    {
        let this = self;
    ...
    pub fn PlugInContext(&self) -> Result<windows_core::IInspectable, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SystemHealth(&self) -> Result<VpnSystemHealth, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestCustomPrompt<P0>(&self, customprompt: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn SetErrorMessage(&self, message: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn SetAllowedSslTlsVersions<P0>(&self, tunneltransport: P0, usetls12: bool) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IInspectable>,
    {
        let this = self;
    ...
    pub fn StartWithMainTransport<P0, P1, P2, P3, P4, P8>(&self, assignedclientipv4list: P0, assignedclientipv6list: P1, vpninterfaceid: P2, assignedroutes: P3, assigneddomainname: P4, mtusize: u32, maxframesize: u32, reserved: bool, mainoutertunneltransport: P8) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IVectorView<super::HostName>>,
        P1: windows_core::Param<windows_collections::IVectorView<super::HostName>>,
        P2: windows_core::Param<VpnInterfaceId>,
    ...
    pub fn StartExistingTransports<P0, P1, P2, P3, P4>(&self, assignedclientipv4list: P0, assignedclientipv6list: P1, vpninterfaceid: P2, assignedroutes: P3, assigneddomainname: P4, mtusize: u32, maxframesize: u32, reserved: bool) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IVectorView<super::HostName>>,
        P1: windows_core::Param<windows_collections::IVectorView<super::HostName>>,
        P2: windows_core::Param<VpnInterfaceId>,
    ...
    pub fn ActivityStateChange<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveActivityStateChange(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVpnChannel2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemoveActivityStateChange)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GetVpnSendPacketBuffer(&self) -> Result<VpnPacketBuffer, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVpnChannel2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetVpnReceivePacketBuffer(&self) -> Result<VpnPacketBuffer, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVpnChannel2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestCustomPromptAsync<P0>(&self, custompromptelement: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Security_Cryptography_Certificates")]
    pub fn RequestCredentialsWithCertificateAsync<P2>(&self, credtype: VpnCredentialType, credoptions: u32, certificate: P2) -> Result<windows_future::IAsyncOperation<VpnCredential>, windows_result::HRESULT>
    where
    ...
    pub fn RequestCredentialsWithOptionsAsync(&self, credtype: VpnCredentialType, credoptions: u32) -> Result<windows_future::IAsyncOperation<VpnCredential>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVpnChannel2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestCredentialsSimpleAsync(&self, credtype: VpnCredentialType) -> Result<windows_future::IAsyncOperation<VpnCredential>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVpnChannel2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TerminateConnection(&self, message: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVpnChannel2>(self)?;
    ...
    pub fn StartWithTrafficFilter<P0, P1, P2, P3, P4, P8, P9, P10>(&self, assignedclientipv4list: P0, assignedclientipv6list: P1, vpninterfaceid: P2, assignedroutes: P3, assignednamespace: P4, mtusize: u32, maxframesize: u32, reserved: bool, mainoutertunneltransport: P8, optionaloutertunneltransport: P9, assignedtrafficfilters: P10) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IVectorView<super::HostName>>,
        P1: windows_core::Param<windows_collections::IVectorView<super::HostName>>,
        P2: windows_core::Param<VpnInterfaceId>,
    ...
    pub fn AddAndAssociateTransport<P0, P1>(&self, transport: P0, context: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IInspectable>,
        P1: windows_core::Param<windows_core::IInspectable>,
    {
    ...
    pub fn StartWithMultipleTransports<P0, P1, P2, P3, P4, P8, P9>(&self, assignedclientipv4addresses: P0, assignedclientipv6addresses: P1, vpninterfaceid: P2, assignedroutes: P3, assignednamespace: P4, mtusize: u32, maxframesize: u32, reserved: bool, transports: P8, assignedtrafficfilters: P9) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn ReplaceAndAssociateTransport<P0, P1>(&self, transport: P0, context: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IInspectable>,
        P1: windows_core::Param<windows_core::IInspectable>,
    {
    ...
    pub fn StartReconnectingTransport<P0, P1>(&self, transport: P0, context: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IInspectable>,
        P1: windows_core::Param<windows_core::IInspectable>,
    {
    ...
    #[cfg(feature = "Networking_Sockets")]
    pub fn GetSlotTypeForTransportContext<P0>(&self, context: P0) -> Result<super::Sockets::ControlChannelTriggerStatus, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IInspectable>,
    {
        let this = &windows_core::Interface::cast::<IVpnChannel4>(self)?;
    ...
    pub fn CurrentRequestTransportContext(&self) -> Result<windows_core::IInspectable, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVpnChannel4>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AppendVpnReceivePacketBuffer<P0>(&self, decapsulatedpacketbuffer: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<VpnPacketBuffer>,
    {
    ...
    pub fn AppendVpnSendPacketBuffer<P0>(&self, encapsulatedpacketbuffer: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<VpnPacketBuffer>,
    {
        let this = &windows_core::Interface::cast::<IVpnChannel5>(self)?;
    ...
    pub fn FlushVpnReceivePacketBuffers(&self) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVpnChannel5>(self)?;
        unsafe { (windows_core::Interface::vtable(this).FlushVpnReceivePacketBuffers)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn FlushVpnSendPacketBuffers(&self) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVpnChannel5>(self)?;
        unsafe { (windows_core::Interface::vtable(this).FlushVpnSendPacketBuffers)(windows_core::Interface::as_raw(this)).ok() }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn ActivateForeground<P1>(&self, packagerelativeappid: &windows_core::HSTRING, sharedcontext: P1) -> Result<super::super::Foundation::Collections::ValueSet, windows_result::HRESULT>
    where
    ...
    pub fn ProcessEventAsync<P0, P1>(thirdpartyplugin: P0, event: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IInspectable>,
        P1: windows_core::Param<windows_core::IInspectable>,
    {
    ...
    fn IVpnChannelStatics<R, F: FnOnce(&IVpnChannelStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl VpnChannelActivityEventArgs {
    pub fn Type(&self) -> Result<VpnChannelActivityEventType, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Type)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl VpnChannelActivityStateChangedArgs {
    pub fn ActivityState(&self) -> Result<VpnChannelActivityEventType, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VpnChannelConfiguration {
    pub fn ServerServiceName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ServerHostNameList(&self) -> Result<windows_collections::IVectorView<super::HostName>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CustomField(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ServerUris(&self) -> Result<windows_collections::IVectorView<super::super::Foundation::Uri>, windows_result::HRESULT> {
...
impl VpnCustomCheckBox {
    ...
    pub fn SetInitialCheckState(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetInitialCheckState)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn InitialCheckState(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Checked(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VpnCustomComboBox {
    ...
    pub fn SetOptionsText<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn OptionsText(&self) -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Selected(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VpnCustomEditBox {
    ...
    pub fn SetDefaultText(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn DefaultText(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetNoEcho(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetNoEcho)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn NoEcho(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VpnCustomPromptBooleanInput {
    ...
    pub fn SetInitialValue(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetInitialValue)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn InitialValue(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Value(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VpnCustomPromptOptionSelector {
    ...
    pub fn Options(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SelectedIndex(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VpnCustomPromptTextInput {
    ...
    pub fn SetIsTextHidden(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsTextHidden)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsTextHidden(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VpnDomainNameAssignment {
    ...
    pub fn DomainNameList(&self) -> Result<windows_collections::IVector<VpnDomainNameInfo>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetProxyAutoConfigurationUri<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn ProxyAutoConfigurationUri(&self) -> Result<super::super::Foundation::Uri, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VpnDomainNameInfo {
    pub fn SetDomainName<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::HostName>,
    {
        let this = self;
    ...
    pub fn DomainName(&self) -> Result<super::HostName, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDomainNameType(&self, value: VpnDomainNameType) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDomainNameType)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DomainNameType(&self) -> Result<VpnDomainNameType, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DnsServers(&self) -> Result<windows_collections::IVector<super::HostName>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn WebProxyServers(&self) -> Result<windows_collections::IVector<super::HostName>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn WebProxyUris(&self) -> Result<windows_collections::IVector<super::super::Foundation::Uri>, windows_result::HRESULT> {
    ...
    pub fn CreateVpnDomainNameInfo<P2, P3>(name: &windows_core::HSTRING, nametype: VpnDomainNameType, dnsserverlist: P2, proxyserverlist: P3) -> Result<VpnDomainNameInfo, windows_result::HRESULT>
    where
        P2: windows_core::Param<windows_collections::IIterable<super::HostName>>,
        P3: windows_core::Param<windows_collections::IIterable<super::HostName>>,
    {
    ...
    fn IVpnDomainNameInfoFactory<R, F: FnOnce(&IVpnDomainNameInfoFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl VpnForegroundActivatedEventArgs {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn SharedContext(&self) -> Result<super::super::Foundation::Collections::ValueSet, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ActivationOperation(&self) -> Result<VpnForegroundActivationOperation, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VpnForegroundActivationOperation {
    #[cfg(feature = "Foundation_Collections")]
    pub fn Complete<P0>(&self, result: P0) -> Result<(), windows_result::HRESULT>
    where
...
impl VpnInterfaceId {
    pub fn GetAddressInfo(&self, id: &mut windows_core::Array<u8>) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn CreateVpnInterfaceId(address: &[u8]) -> Result<VpnInterfaceId, windows_result::HRESULT> {
        Self::IVpnInterfaceIdFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateVpnInterfaceId)(windows_core::Interface::as_raw(this), address.len().try_into().unwrap(), address.as_ptr(), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IVpnInterfaceIdFactory<R, F: FnOnce(&IVpnInterfaceIdFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl VpnManagementAgent {
    ...
    pub fn AddProfileFromXmlAsync(&self, xml: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<VpnManagementErrorStatus>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AddProfileFromObjectAsync<P0>(&self, profile: P0) -> Result<windows_future::IAsyncOperation<VpnManagementErrorStatus>, windows_result::HRESULT>
    where
    ...
    pub fn UpdateProfileFromXmlAsync(&self, xml: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<VpnManagementErrorStatus>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UpdateProfileFromObjectAsync<P0>(&self, profile: P0) -> Result<windows_future::IAsyncOperation<VpnManagementErrorStatus>, windows_result::HRESULT>
    where
        P0: windows_core::Param<IVpnProfile>,
    {
        let this = self;
    ...
    pub fn GetProfilesAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<IVpnProfile>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeleteProfileAsync<P0>(&self, profile: P0) -> Result<windows_future::IAsyncOperation<VpnManagementErrorStatus>, windows_result::HRESULT>
    where
        P0: windows_core::Param<IVpnProfile>,
    {
        let this = self;
    ...
    pub fn ConnectProfileAsync<P0>(&self, profile: P0) -> Result<windows_future::IAsyncOperation<VpnManagementErrorStatus>, windows_result::HRESULT>
    where
        P0: windows_core::Param<IVpnProfile>,
    {
        let this = self;
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn ConnectProfileWithPasswordCredentialAsync<P0, P1>(&self, profile: P0, passwordcredential: P1) -> Result<windows_future::IAsyncOperation<VpnManagementErrorStatus>, windows_result::HRESULT>
    where
        P0: windows_core::Param<IVpnProfile>,
    ...
    pub fn DisconnectProfileAsync<P0>(&self, profile: P0) -> Result<windows_future::IAsyncOperation<VpnManagementErrorStatus>, windows_result::HRESULT>
    where
        P0: windows_core::Param<IVpnProfile>,
    {
        let this = self;
...
impl VpnNamespaceAssignment {
    ...
    pub fn SetNamespaceList<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn NamespaceList(&self) -> Result<windows_collections::IVector<VpnNamespaceInfo>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetProxyAutoConfigUri<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn ProxyAutoConfigUri(&self) -> Result<super::super::Foundation::Uri, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VpnNamespaceInfo {
    ...
    pub fn SetDnsServers<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn SetWebProxyServers<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IVector<super::HostName>>,
    {
        let this = self;
    ...
    pub fn CreateVpnNamespaceInfo<P1, P2>(name: &windows_core::HSTRING, dnsserverlist: P1, proxyserverlist: P2) -> Result<VpnNamespaceInfo, windows_result::HRESULT>
    where
        P1: windows_core::Param<windows_collections::IVector<super::HostName>>,
        P2: windows_core::Param<windows_collections::IVector<super::HostName>>,
    {
    ...
    fn IVpnNamespaceInfoFactory<R, F: FnOnce(&IVpnNamespaceInfoFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl VpnNativeProfile {
    ...
    pub fn Servers(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RoutingPolicyType(&self) -> Result<VpnRoutingPolicyType, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRoutingPolicyType(&self, value: VpnRoutingPolicyType) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetRoutingPolicyType)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn NativeProtocolType(&self) -> Result<VpnNativeProtocolType, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetNativeProtocolType(&self, value: VpnNativeProtocolType) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetNativeProtocolType)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn UserAuthenticationMethod(&self) -> Result<VpnAuthenticationMethod, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetUserAuthenticationMethod(&self, value: VpnAuthenticationMethod) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetUserAuthenticationMethod)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn TunnelAuthenticationMethod(&self) -> Result<VpnAuthenticationMethod, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTunnelAuthenticationMethod(&self, value: VpnAuthenticationMethod) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetTunnelAuthenticationMethod)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn EapConfiguration(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetEapConfiguration(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn RequireVpnClientAppUI(&self) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn SetRequireVpnClientAppUI(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVpnNativeProfile2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetRequireVpnClientAppUI)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ConnectionStatus(&self) -> Result<VpnManagementConnectionStatus, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVpnNativeProfile2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VpnPacketBuffer {
    ...
    pub fn SetStatus(&self, value: VpnPacketBufferStatus) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetStatus)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Status(&self) -> Result<VpnPacketBufferStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTransportAffinity(&self, value: u32) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetTransportAffinity)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn TransportAffinity(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AppId(&self) -> Result<VpnAppId, windows_result::HRESULT> {
    ...
    pub fn SetTransportContext<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_core::IInspectable>,
    {
    ...
    pub fn TransportContext(&self) -> Result<windows_core::IInspectable, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IVpnPacketBuffer3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateVpnPacketBuffer<P0>(parentbuffer: P0, offset: u32, length: u32) -> Result<VpnPacketBuffer, windows_result::HRESULT>
    where
        P0: windows_core::Param<VpnPacketBuffer>,
    {
    ...
    fn IVpnPacketBufferFactory<R, F: FnOnce(&IVpnPacketBufferFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl VpnPacketBufferList {
    pub fn First(&self) -> Result<windows_collections::IIterator<VpnPacketBuffer>, windows_result::HRESULT> {
    ...
    pub fn Append<P0>(&self, nextvpnpacketbuffer: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<VpnPacketBuffer>,
    {
        let this = self;
    ...
    pub fn AddAtBegin<P0>(&self, nextvpnpacketbuffer: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<VpnPacketBuffer>,
    {
        let this = self;
    ...
    pub fn RemoveAtEnd(&self) -> Result<VpnPacketBuffer, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RemoveAtBegin(&self) -> Result<VpnPacketBuffer, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VpnPlugInProfile {
    ...
    pub fn ServerUris(&self) -> Result<windows_collections::IVector<super::super::Foundation::Uri>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ServerUris)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CustomConfiguration(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCustomConfiguration(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn VpnPluginPackageFamilyName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetVpnPluginPackageFamilyName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl VpnRoute {
    ...
    pub fn Address(&self) -> Result<super::HostName, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPrefixSize(&self, value: u8) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetPrefixSize)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn PrefixSize(&self) -> Result<u8, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateVpnRoute<P0>(address: P0, prefixsize: u8) -> Result<VpnRoute, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::HostName>,
    {
    ...
    fn IVpnRouteFactory<R, F: FnOnce(&IVpnRouteFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl VpnRouteAssignment {
    ...
    pub fn SetIpv4InclusionRoutes<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn SetIpv6InclusionRoutes<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IVector<VpnRoute>>,
    {
        let this = self;
    ...
    pub fn Ipv4InclusionRoutes(&self) -> Result<windows_collections::IVector<VpnRoute>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Ipv6InclusionRoutes(&self) -> Result<windows_collections::IVector<VpnRoute>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIpv4ExclusionRoutes<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IVector<VpnRoute>>,
    {
        let this = self;
    ...
    pub fn SetIpv6ExclusionRoutes<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IVector<VpnRoute>>,
    {
        let this = self;
    ...
    pub fn Ipv4ExclusionRoutes(&self) -> Result<windows_collections::IVector<VpnRoute>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Ipv6ExclusionRoutes(&self) -> Result<windows_collections::IVector<VpnRoute>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetExcludeLocalSubnets(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetExcludeLocalSubnets)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ExcludeLocalSubnets(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VpnSystemHealth {
    #[cfg(feature = "Storage_Streams")]
    pub fn StatementOfHealth(&self) -> Result<super::super::Storage::Streams::Buffer, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VpnTrafficFilter {
    ...
    pub fn SetAppId<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn AppClaims(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Protocol(&self) -> Result<VpnIPProtocol, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetProtocol(&self, value: VpnIPProtocol) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetProtocol)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn LocalPortRanges(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RemotePortRanges(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LocalAddressRanges(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RemoteAddressRanges(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Create<P0>(appid: P0) -> Result<VpnTrafficFilter, windows_result::HRESULT>
    where
        P0: windows_core::Param<VpnAppId>,
    {
    ...
    fn IVpnTrafficFilterFactory<R, F: FnOnce(&IVpnTrafficFilterFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl VpnTrafficFilterAssignment {
    ...
    pub fn TrafficFilterList(&self) -> Result<windows_collections::IVector<VpnTrafficFilter>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AllowOutbound(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAllowOutbound(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAllowOutbound)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AllowInbound(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAllowInbound(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
