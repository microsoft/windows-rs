...
impl ESim {
    ...
    pub fn DeleteProfileAsync(&self, profileid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<ESimOperationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DownloadProfileMetadataAsync(&self, activationcode: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<ESimDownloadProfileMetadataResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ResetAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<ESimOperationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DiscoverAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<ESimDiscoverResult>> {
        let this = &windows_core::Interface::cast::<IESim2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DiscoverWithServerAddressAndMatchingIdAsync(&self, serveraddress: &windows_core::HSTRING, matchingid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<ESimDiscoverResult>> {
        let this = &windows_core::Interface::cast::<IESim2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ESimProfile {
    ...
    pub fn DisableAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<ESimOperationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EnableAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<ESimOperationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetNicknameAsync(&self, newnickname: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<ESimOperationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ESimProfileMetadata {
    ...
    pub fn DenyInstallAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<ESimOperationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ConfirmInstallAsync(&self) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<ESimOperationResult, ESimProfileInstallProgress>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ConfirmInstallWithConfirmationCodeAsync(&self, confirmationcode: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<ESimOperationResult, ESimProfileInstallProgress>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PostponeInstallAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<ESimOperationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl FdnAccessManager {
    pub fn RequestUnlockAsync(contactlistid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
...
impl HotspotAuthenticationContext {
    ...
    pub fn IssueCredentialsAsync(&self, username: &windows_core::HSTRING, password: &windows_core::HSTRING, extraparameters: &windows_core::HSTRING, markasmanualconnectonfailure: bool) -> windows_core::Result<windows_async::IAsyncOperation<HotspotCredentialsAuthenticationResult>> {
...
impl MobileBroadbandDeviceServiceCommandSession {
    #[cfg(feature = "Storage_Streams")]
    pub fn SendQueryCommandAsync<P1>(&self, commandid: u32, data: P1) -> windows_core::Result<windows_async::IAsyncOperation<MobileBroadbandDeviceServiceCommandResult>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SendSetCommandAsync<P1>(&self, commandid: u32, data: P1) -> windows_core::Result<windows_async::IAsyncOperation<MobileBroadbandDeviceServiceCommandResult>>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        let this = self;
...
impl MobileBroadbandDeviceServiceDataSession {
    #[cfg(feature = "Storage_Streams")]
    pub fn WriteDataAsync<P0>(&self, value: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
...
impl MobileBroadbandModem {
    ...
    pub fn ResetAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ResetAsync)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetCurrentConfigurationAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<MobileBroadbandModemConfiguration>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetIsPassthroughEnabledAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
    ...
    pub fn SetIsPassthroughEnabledAsync(&self, value: bool) -> windows_core::Result<windows_async::IAsyncOperation<MobileBroadbandModemStatus>> {
        let this = &windows_core::Interface::cast::<IMobileBroadbandModem2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryGetPcoAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<MobileBroadbandPco>> {
    ...
    pub fn SetIsPassthroughEnabledWithSlotIndexAsync(&self, value: bool, slotindex: i32) -> windows_core::Result<windows_async::IAsyncOperation<MobileBroadbandModemStatus>> {
    ...
    pub fn GetIsPassthroughEnabledWithSlotIndexAsync(&self, slotindex: i32) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
        let this = &windows_core::Interface::cast::<IMobileBroadbandModem4>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MobileBroadbandModemIsolation {
    ...
    pub fn ApplyConfigurationAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ClearConfigurationAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MobileBroadbandNetwork {
    ...
    pub fn GetVoiceCallSupportAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
    ...
    pub fn GetCellsInfoAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<MobileBroadbandCellsInfo>> {
...
impl MobileBroadbandPin {
    ...
    pub fn EnableAsync(&self, currentpin: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<MobileBroadbandPinOperationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DisableAsync(&self, currentpin: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<MobileBroadbandPinOperationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EnterAsync(&self, currentpin: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<MobileBroadbandPinOperationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ChangeAsync(&self, currentpin: &windows_core::HSTRING, newpin: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<MobileBroadbandPinOperationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UnblockAsync(&self, pinunblockkey: &windows_core::HSTRING, newpin: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<MobileBroadbandPinOperationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MobileBroadbandSarManager {
    ...
    pub fn EnableBackoffAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DisableBackoffAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetConfigurationAsync<P0>(&self, antennas: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    pub fn RevertSarToHardwareControlAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTransmissionStateChangedHysteresisAsync(&self, timerperiod: super::super::Foundation::TimeSpan) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetIsTransmittingAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MobileBroadbandSlotManager {
    ...
    pub fn SetCurrentSlotAsync(&self, slotindex: i32) -> windows_core::Result<windows_async::IAsyncOperation<MobileBroadbandModemStatus>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MobileBroadbandUicc {
    ...
    pub fn GetUiccAppsAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<MobileBroadbandUiccAppsResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MobileBroadbandUiccApp {
    ...
    pub fn GetRecordDetailsAsync<P0>(&self, uiccfilepath: P0) -> windows_core::Result<windows_async::IAsyncOperation<MobileBroadbandUiccAppRecordDetailsResult>>
    where
    ...
    pub fn ReadRecordAsync<P0>(&self, uiccfilepath: P0, recordindex: i32) -> windows_core::Result<windows_async::IAsyncOperation<MobileBroadbandUiccAppReadRecordResult>>
    where
        P0: windows_core::Param<windows_collections::IIterable<u32>>,
    {
        let this = self;
...
impl NetworkOperatorTetheringAccessPointConfiguration {
    ...
    pub fn IsBandSupportedAsync(&self, band: TetheringWiFiBand) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
        let this = &windows_core::Interface::cast::<INetworkOperatorTetheringAccessPointConfiguration2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsAuthenticationKindSupportedAsync(&self, authenticationkind: TetheringWiFiAuthenticationKind) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
        let this = &windows_core::Interface::cast::<INetworkOperatorTetheringAccessPointConfiguration3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl NetworkOperatorTetheringManager {
    ...
    pub fn ConfigureAccessPointAsync<P0>(&self, configuration: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    pub fn StartTetheringAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<NetworkOperatorTetheringOperationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StopTetheringAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<NetworkOperatorTetheringOperationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StartTetheringAsync2<P0>(&self, configuration: P0) -> windows_core::Result<windows_async::IAsyncOperation<NetworkOperatorTetheringOperationResult>>
    where
    ...
    pub fn EnableNoConnectionsTimeoutAsync() -> windows_core::Result<windows_async::IAsyncAction> {
        Self::INetworkOperatorTetheringManagerStatics4(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DisableNoConnectionsTimeoutAsync() -> windows_core::Result<windows_async::IAsyncAction> {
        Self::INetworkOperatorTetheringManagerStatics4(|this| unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ProvisioningAgent {
    ...
    pub fn ProvisionFromXmlDocumentAsync(&self, provisioningxmldocument: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<ProvisionFromXmlDocumentResults>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UssdSession {
    pub fn SendMessageAndGetReplyAsync<P0>(&self, message: P0) -> windows_core::Result<windows_async::IAsyncOperation<UssdReply>>
    where
