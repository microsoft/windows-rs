...
windows_core::imp::required_hierarchy!(EndpointPair, IEndpointPair, IEndpointPairFactory);
impl EndpointPair {
...
windows_core::imp::required_hierarchy!(HostName, super::Foundation::IStringable, IHostName, IHostNameFactory, IHostNameStatics);
impl HostName {
