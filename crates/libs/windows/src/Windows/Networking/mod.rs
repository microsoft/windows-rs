...
impl EndpointPair {
    pub fn LocalHostName(&self) -> Result<HostName, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn SetLocalHostName<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn LocalServiceName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetLocalServiceName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn RemoteHostName(&self) -> Result<HostName, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRemoteHostName<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<HostName>,
    {
        let this = self;
    ...
    pub fn RemoteServiceName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRemoteServiceName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn CreateEndpointPair<P0, P2>(localhostname: P0, localservicename: &windows_core::HSTRING, remotehostname: P2, remoteservicename: &windows_core::HSTRING) -> Result<EndpointPair, windows_result::HRESULT>
    where
        P0: windows_core::Param<HostName>,
    ...
    fn IEndpointPairFactory<R, F: FnOnce(&IEndpointPairFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl HostName {
    #[cfg(feature = "Networking_Connectivity")]
    pub fn IPInformation(&self) -> Result<Connectivity::IPInformation, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RawName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanonicalName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Type(&self) -> Result<HostNameType, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsEqual<P0>(&self, hostname: P0) -> Result<bool, windows_result::HRESULT>
    where
        P0: windows_core::Param<HostName>,
    {
        let this = self;
    ...
    pub fn CreateHostName(hostname: &windows_core::HSTRING) -> Result<HostName, windows_result::HRESULT> {
    ...
    pub fn Compare(value1: &windows_core::HSTRING, value2: &windows_core::HSTRING) -> Result<i32, windows_result::HRESULT> {
    ...
    fn IHostNameFactory<R, F: FnOnce(&IHostNameFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<HostName, IHostNameFactory> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IHostNameStatics<R, F: FnOnce(&IHostNameStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
