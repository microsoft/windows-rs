...
windows_core::imp::required_hierarchy!(BackgroundDownloader, IBackgroundDownloader, IBackgroundDownloader2, IBackgroundDownloader3, IBackgroundDownloaderFactory, IBackgroundDownloaderStaticMethods, IBackgroundDownloaderStaticMethods2, IBackgroundDownloaderUserConsent, IBackgroundTransferBase);
...
windows_core::imp::required_hierarchy!(BackgroundTransferCompletionGroup, IBackgroundTransferCompletionGroup);
...
windows_core::imp::required_hierarchy!(BackgroundTransferCompletionGroupTriggerDetails, IBackgroundTransferCompletionGroupTriggerDetails);
...
windows_core::imp::required_hierarchy!(BackgroundTransferContentPart, IBackgroundTransferContentPart, IBackgroundTransferContentPartFactory);
...
windows_core::imp::required_hierarchy!(BackgroundTransferGroup, IBackgroundTransferGroup, IBackgroundTransferGroupStatics);
...
windows_core::imp::required_hierarchy!(BackgroundTransferRangesDownloadedEventArgs, IBackgroundTransferRangesDownloadedEventArgs);
...
windows_core::imp::required_hierarchy!(BackgroundUploader, IBackgroundTransferBase, IBackgroundUploader, IBackgroundUploader2, IBackgroundUploader3, IBackgroundUploaderFactory, IBackgroundUploaderStaticMethods, IBackgroundUploaderStaticMethods2, IBackgroundUploaderUserConsent);
...
windows_core::imp::required_hierarchy!(DownloadOperation, IBackgroundTransferOperation, IBackgroundTransferOperationPriority, IDownloadOperation, IDownloadOperation2, IDownloadOperation3, IDownloadOperation4, IDownloadOperation5);
...
windows_core::imp::required_hierarchy!(ResponseInformation, IResponseInformation);
...
#[cfg(feature = "deprecated")]
windows_core::imp::required_hierarchy!(UnconstrainedTransferRequestResult, IUnconstrainedTransferRequestResult);
#[cfg(feature = "deprecated")]
...
windows_core::imp::required_hierarchy!(UploadOperation, IBackgroundTransferOperation, IBackgroundTransferOperationPriority, IUploadOperation, IUploadOperation2, IUploadOperation3, IUploadOperation4);
