...
impl BackgroundDownloader {
    ...
    pub fn CreateDownload<P0, P1>(&self, uri: P0, resultfile: P1) -> windows_result::Result<DownloadOperation>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateDownloadFromFile<P0, P1, P2>(&self, uri: P0, resultfile: P1, requestbodyfile: P2) -> windows_result::Result<DownloadOperation>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
        P1: windows_core::Param<super::super::Storage::IStorageFile>,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateDownloadAsync<P0, P1, P2>(&self, uri: P0, resultfile: P1, requestbodystream: P2) -> windows_result::Result<windows_future::IAsyncOperation<DownloadOperation>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
        P1: windows_core::Param<super::super::Storage::IStorageFile>,
    ...
    pub fn TransferGroup(&self) -> windows_result::Result<BackgroundTransferGroup> {
    ...
    pub fn SetTransferGroup<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn SuccessToastNotification(&self) -> windows_result::Result<super::super::UI::Notifications::ToastNotification> {
        let this = &windows_core::Interface::cast::<IBackgroundDownloader2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Notifications")]
    pub fn SetSuccessToastNotification<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "UI_Notifications")]
    pub fn FailureToastNotification(&self) -> windows_result::Result<super::super::UI::Notifications::ToastNotification> {
        let this = &windows_core::Interface::cast::<IBackgroundDownloader2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Notifications")]
    pub fn SetFailureToastNotification<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::UI::Notifications::ToastNotification>,
    {
        let this = &windows_core::Interface::cast::<IBackgroundDownloader2>(self)?;
    ...
    #[cfg(feature = "UI_Notifications")]
    pub fn SuccessTileNotification(&self) -> windows_result::Result<super::super::UI::Notifications::TileNotification> {
        let this = &windows_core::Interface::cast::<IBackgroundDownloader2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Notifications")]
    pub fn SetSuccessTileNotification<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "UI_Notifications")]
    pub fn FailureTileNotification(&self) -> windows_result::Result<super::super::UI::Notifications::TileNotification> {
        let this = &windows_core::Interface::cast::<IBackgroundDownloader2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Notifications")]
    pub fn SetFailureTileNotification<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::UI::Notifications::TileNotification>,
    {
        let this = &windows_core::Interface::cast::<IBackgroundDownloader2>(self)?;
    ...
    pub fn CompletionGroup(&self) -> windows_result::Result<BackgroundTransferCompletionGroup> {
    ...
    pub fn CreateWithCompletionGroup<P0>(completiongroup: P0) -> windows_result::Result<BackgroundDownloader>
    where
    ...
    pub fn GetCurrentDownloadsAsync() -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<DownloadOperation>>> {
    ...
    pub fn GetCurrentDownloadsForGroupAsync(group: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<DownloadOperation>>> {
        Self::IBackgroundDownloaderStaticMethods(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetCurrentDownloadsForTransferGroupAsync<P0>(group: P0) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<DownloadOperation>>>
    where
        P0: windows_core::Param<BackgroundTransferGroup>,
    {
    ...
    pub fn RequestUnconstrainedDownloadsAsync<P0>(operations: P0) -> windows_result::Result<windows_future::IAsyncOperation<UnconstrainedTransferRequestResult>>
    where
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn SetServerCredential<P0>(&self, credential: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn SetProxyCredential<P0>(&self, credential: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Security::Credentials::PasswordCredential>,
    {
        let this = &windows_core::Interface::cast::<IBackgroundTransferBase>(self)?;
    ...
    pub fn SetMethod(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IBackgroundTransferBase>(self)?;
    ...
    pub fn CostPolicy(&self) -> windows_result::Result<BackgroundTransferCostPolicy> {
        let this = &windows_core::Interface::cast::<IBackgroundTransferBase>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCostPolicy(&self, value: BackgroundTransferCostPolicy) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IBackgroundTransferBase>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetCostPolicy)(windows_core::Interface::as_raw(this), value).ok() }
    }
    fn IBackgroundDownloaderFactory<R, F: FnOnce(&IBackgroundDownloaderFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IBackgroundDownloaderStaticMethods<R, F: FnOnce(&IBackgroundDownloaderStaticMethods) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IBackgroundDownloaderStaticMethods2<R, F: FnOnce(&IBackgroundDownloaderStaticMethods2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IBackgroundDownloaderUserConsent<R, F: FnOnce(&IBackgroundDownloaderUserConsent) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl BackgroundTransferCompletionGroup {
    ...
    pub fn Trigger(&self) -> windows_result::Result<super::super::ApplicationModel::Background::IBackgroundTrigger> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl BackgroundTransferCompletionGroupTriggerDetails {
    pub fn Downloads(&self) -> windows_result::Result<windows_collections::IVectorView<DownloadOperation>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Uploads(&self) -> windows_result::Result<windows_collections::IVectorView<UploadOperation>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl BackgroundTransferContentPart {
    ...
    pub fn SetHeader(&self, headername: &windows_core::HSTRING, headervalue: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetFile<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn CreateWithName(name: &windows_core::HSTRING) -> windows_result::Result<BackgroundTransferContentPart> {
    ...
    pub fn CreateWithNameAndFileName(name: &windows_core::HSTRING, filename: &windows_core::HSTRING) -> windows_result::Result<BackgroundTransferContentPart> {
        Self::IBackgroundTransferContentPartFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IBackgroundTransferContentPartFactory<R, F: FnOnce(&IBackgroundTransferContentPartFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl BackgroundTransferError {
    ...
    fn IBackgroundTransferErrorStaticMethods<R, F: FnOnce(&IBackgroundTransferErrorStaticMethods) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl BackgroundTransferGroup {
    ...
    pub fn TransferBehavior(&self) -> windows_result::Result<BackgroundTransferBehavior> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTransferBehavior(&self, value: BackgroundTransferBehavior) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetTransferBehavior)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CreateGroup(name: &windows_core::HSTRING) -> windows_result::Result<BackgroundTransferGroup> {
    ...
    fn IBackgroundTransferGroupStatics<R, F: FnOnce(&IBackgroundTransferGroupStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl BackgroundTransferRangesDownloadedEventArgs {
    pub fn WasDownloadRestarted(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AddedRanges(&self) -> windows_result::Result<windows_collections::IVector<BackgroundTransferFileRange>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl BackgroundUploader {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateUpload<P0, P1>(&self, uri: P0, sourcefile: P1) -> windows_result::Result<UploadOperation>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
        P1: windows_core::Param<super::super::Storage::IStorageFile>,
    {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateUploadFromStreamAsync<P0, P1>(&self, uri: P0, sourcestream: P1) -> windows_result::Result<windows_future::IAsyncOperation<UploadOperation>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    ...
    pub fn CreateUploadWithFormDataAndAutoBoundaryAsync<P0, P1>(&self, uri: P0, parts: P1) -> windows_result::Result<windows_future::IAsyncOperation<UploadOperation>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    ...
    pub fn CreateUploadWithSubTypeAsync<P0, P1>(&self, uri: P0, parts: P1, subtype: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<UploadOperation>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
        P1: windows_core::Param<windows_collections::IIterable<BackgroundTransferContentPart>>,
    {
    ...
    pub fn CreateUploadWithSubTypeAndBoundaryAsync<P0, P1>(&self, uri: P0, parts: P1, subtype: &windows_core::HSTRING, boundary: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<UploadOperation>>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
        P1: windows_core::Param<windows_collections::IIterable<BackgroundTransferContentPart>>,
    {
    ...
    pub fn CreateWithCompletionGroup<P0>(completiongroup: P0) -> windows_result::Result<BackgroundUploader>
    where
        P0: windows_core::Param<BackgroundTransferCompletionGroup>,
    {
    ...
    pub fn GetCurrentUploadsAsync() -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<UploadOperation>>> {
    ...
    pub fn GetCurrentUploadsForGroupAsync(group: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<UploadOperation>>> {
        Self::IBackgroundUploaderStaticMethods(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetCurrentUploadsForTransferGroupAsync<P0>(group: P0) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<UploadOperation>>>
    where
        P0: windows_core::Param<BackgroundTransferGroup>,
    {
    ...
    pub fn RequestUnconstrainedUploadsAsync<P0>(operations: P0) -> windows_result::Result<windows_future::IAsyncOperation<UnconstrainedTransferRequestResult>>
    where
    ...
    fn IBackgroundUploaderFactory<R, F: FnOnce(&IBackgroundUploaderFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IBackgroundUploaderStaticMethods<R, F: FnOnce(&IBackgroundUploaderStaticMethods) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IBackgroundUploaderStaticMethods2<R, F: FnOnce(&IBackgroundUploaderStaticMethods2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IBackgroundUploaderUserConsent<R, F: FnOnce(&IBackgroundUploaderUserConsent) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl ContentPrefetcher {
    pub fn ContentUris() -> windows_result::Result<windows_collections::IVector<super::super::Foundation::Uri>> {
    ...
    pub fn SetIndirectContentUri<P0>(value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
    ...
    pub fn IndirectContentUri() -> windows_result::Result<super::super::Foundation::Uri> {
        Self::IContentPrefetcher(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LastSuccessfulPrefetchTime() -> windows_result::Result<super::super::Foundation::IReference<super::super::Foundation::DateTime>> {
    ...
    fn IContentPrefetcher<R, F: FnOnce(&IContentPrefetcher) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ContentPrefetcher, IContentPrefetcher> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IContentPrefetcherTime<R, F: FnOnce(&IContentPrefetcherTime) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl DownloadOperation {
    pub fn Guid(&self) -> windows_result::Result<windows_core::GUID> {
    ...
    pub fn RequestedUri(&self) -> windows_result::Result<super::super::Foundation::Uri> {
        let this = &windows_core::Interface::cast::<IBackgroundTransferOperation>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetResultStreamAt(&self, position: u64) -> windows_result::Result<super::super::Storage::Streams::IInputStream> {
        let this = &windows_core::Interface::cast::<IBackgroundTransferOperation>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetResponseInformation(&self) -> windows_result::Result<ResponseInformation> {
        let this = &windows_core::Interface::cast::<IBackgroundTransferOperation>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Priority(&self) -> windows_result::Result<BackgroundTransferPriority> {
    ...
    pub fn SetPriority(&self, value: BackgroundTransferPriority) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IBackgroundTransferOperationPriority>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetPriority)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn ResultFile(&self) -> windows_result::Result<super::super::Storage::IStorageFile> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Progress(&self) -> windows_result::Result<BackgroundDownloadProgress> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StartAsync(&self) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<DownloadOperation, DownloadOperation>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AttachAsync(&self) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<DownloadOperation, DownloadOperation>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsRandomAccessRequired(&self) -> windows_result::Result<bool> {
    ...
    pub fn SetIsRandomAccessRequired(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IDownloadOperation3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetIsRandomAccessRequired)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn GetResultRandomAccessStreamReference(&self) -> windows_result::Result<super::super::Storage::Streams::IRandomAccessStreamReference> {
        let this = &windows_core::Interface::cast::<IDownloadOperation3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDownloadedRanges(&self) -> windows_result::Result<windows_collections::IVector<BackgroundTransferFileRange>> {
        let this = &windows_core::Interface::cast::<IDownloadOperation3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RangesDownloaded<P0>(&self, eventhandler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveRangesDownloaded(&self, eventcookie: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IDownloadOperation3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemoveRangesDownloaded)(windows_core::Interface::as_raw(this), eventcookie).ok() }
    }
    pub fn SetRequestedUri<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = &windows_core::Interface::cast::<IDownloadOperation3>(self)?;
    ...
    #[cfg(feature = "Web")]
    pub fn RecoverableWebErrorStatuses(&self) -> windows_result::Result<windows_collections::IVector<super::super::Web::WebErrorStatus>> {
        let this = &windows_core::Interface::cast::<IDownloadOperation3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Web")]
    pub fn CurrentWebErrorStatus(&self) -> windows_result::Result<super::super::Foundation::IReference<super::super::Web::WebErrorStatus>> {
        let this = &windows_core::Interface::cast::<IDownloadOperation3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MakeCurrentInTransferGroup(&self) -> windows_result::Result<()> {
    ...
    pub fn RemoveRequestHeader(&self, headername: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IDownloadOperation5>(self)?;
...
pub trait IBackgroundTransferBase_Impl: windows_core::IUnknownImpl {
    ...
    fn SetServerCredential(&self, credential: windows_core::Ref<super::super::Security::Credentials::PasswordCredential>) -> windows_result::Result<()>;
    fn ProxyCredential(&self) -> windows_result::Result<super::super::Security::Credentials::PasswordCredential>;
    fn SetProxyCredential(&self, credential: windows_core::Ref<super::super::Security::Credentials::PasswordCredential>) -> windows_result::Result<()>;
    fn Method(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn SetMethod(&self, value: &windows_core::HSTRING) -> windows_result::Result<()>;
    fn Group(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn SetGroup(&self, value: &windows_core::HSTRING) -> windows_result::Result<()>;
    fn CostPolicy(&self) -> windows_result::Result<BackgroundTransferCostPolicy>;
    fn SetCostPolicy(&self, value: BackgroundTransferCostPolicy) -> windows_result::Result<()>;
}
#[cfg(feature = "Security_Credentials")]
...
impl IBackgroundTransferContentPartFactory {
    pub fn CreateWithName(&self, name: &windows_core::HSTRING) -> windows_result::Result<BackgroundTransferContentPart> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithName)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(name), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CreateWithNameAndFileName(&self, name: &windows_core::HSTRING, filename: &windows_core::HSTRING) -> windows_result::Result<BackgroundTransferContentPart> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateWithNameAndFileName)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(name), core::mem::transmute_copy(filename), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
pub trait IBackgroundTransferContentPartFactory_Impl: windows_core::IUnknownImpl {
    fn CreateWithName(&self, name: &windows_core::HSTRING) -> windows_result::Result<BackgroundTransferContentPart>;
    fn CreateWithNameAndFileName(&self, name: &windows_core::HSTRING, fileName: &windows_core::HSTRING) -> windows_result::Result<BackgroundTransferContentPart>;
}
...
pub trait IBackgroundTransferOperation_Impl: windows_core::IUnknownImpl {
    ...
    fn RequestedUri(&self) -> windows_result::Result<super::super::Foundation::Uri>;
    fn Method(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn Group(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn CostPolicy(&self) -> windows_result::Result<BackgroundTransferCostPolicy>;
    fn SetCostPolicy(&self, value: BackgroundTransferCostPolicy) -> windows_result::Result<()>;
    fn GetResultStreamAt(&self, position: u64) -> windows_result::Result<super::super::Storage::Streams::IInputStream>;
    fn GetResponseInformation(&self) -> windows_result::Result<ResponseInformation>;
}
#[cfg(feature = "Storage_Streams")]
...
pub trait IBackgroundTransferOperationPriority_Impl: windows_core::IUnknownImpl {
    fn Priority(&self) -> windows_result::Result<BackgroundTransferPriority>;
    fn SetPriority(&self, value: BackgroundTransferPriority) -> windows_result::Result<()>;
}
...
impl ResponseInformation {
    pub fn IsResumable(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ActualUri(&self) -> windows_result::Result<super::super::Foundation::Uri> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UnconstrainedTransferRequestResult {
    pub fn IsUnconstrained(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UploadOperation {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SourceFile(&self) -> windows_result::Result<super::super::Storage::IStorageFile> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Progress(&self) -> windows_result::Result<BackgroundUploadProgress> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Progress)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn StartAsync(&self) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<UploadOperation, UploadOperation>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).StartAsync)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn AttachAsync(&self) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<UploadOperation, UploadOperation>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AttachAsync)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
