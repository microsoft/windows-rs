...
impl StoreAvailability {
    ...
    pub fn RequestPurchaseAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<StorePurchaseResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestPurchaseWithPurchasePropertiesAsync<P0>(&self, storepurchaseproperties: P0) -> windows_core::Result<windows_async::IAsyncOperation<StorePurchaseResult>>
    where
...
impl StoreContext {
    ...
    pub fn GetCustomerPurchaseIdAsync(&self, serviceticket: &windows_core::HSTRING, publisheruserid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetCustomerCollectionsIdAsync(&self, serviceticket: &windows_core::HSTRING, publisheruserid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAppLicenseAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<StoreAppLicense>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetStoreProductForCurrentAppAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<StoreProductResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetStoreProductsAsync<P0, P1>(&self, productkinds: P0, storeids: P1) -> windows_core::Result<windows_async::IAsyncOperation<StoreProductQueryResult>>
    where
    ...
    pub fn GetAssociatedStoreProductsAsync<P0>(&self, productkinds: P0) -> windows_core::Result<windows_async::IAsyncOperation<StoreProductQueryResult>>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        let this = self;
    ...
    pub fn GetAssociatedStoreProductsWithPagingAsync<P0>(&self, productkinds: P0, maxitemstoretrieveperpage: u32) -> windows_core::Result<windows_async::IAsyncOperation<StoreProductPagedQueryResult>>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        let this = self;
    ...
    pub fn GetUserCollectionAsync<P0>(&self, productkinds: P0) -> windows_core::Result<windows_async::IAsyncOperation<StoreProductQueryResult>>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        let this = self;
    ...
    pub fn GetUserCollectionWithPagingAsync<P0>(&self, productkinds: P0, maxitemstoretrieveperpage: u32) -> windows_core::Result<windows_async::IAsyncOperation<StoreProductPagedQueryResult>>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        let this = self;
    ...
    pub fn ReportConsumableFulfillmentAsync(&self, productstoreid: &windows_core::HSTRING, quantity: u32, trackingid: windows_core::GUID) -> windows_core::Result<windows_async::IAsyncOperation<StoreConsumableResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetConsumableBalanceRemainingAsync(&self, productstoreid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<StoreConsumableResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ApplicationModel")]
    pub fn AcquireStoreLicenseForOptionalPackageAsync<P0>(&self, optionalpackage: P0) -> windows_core::Result<windows_async::IAsyncOperation<StoreAcquireLicenseResult>>
    where
    ...
    pub fn RequestPurchaseAsync(&self, storeid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<StorePurchaseResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestPurchaseWithPurchasePropertiesAsync<P1>(&self, storeid: &windows_core::HSTRING, storepurchaseproperties: P1) -> windows_core::Result<windows_async::IAsyncOperation<StorePurchaseResult>>
    where
    ...
    pub fn GetAppAndOptionalStorePackageUpdatesAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<StorePackageUpdate>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestDownloadStorePackageUpdatesAsync<P0>(&self, storepackageupdates: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<StorePackageUpdateResult, StorePackageUpdateStatus>>
    where
    ...
    pub fn RequestDownloadAndInstallStorePackageUpdatesAsync<P0>(&self, storepackageupdates: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<StorePackageUpdateResult, StorePackageUpdateStatus>>
    where
        P0: windows_core::Param<windows_collections::IIterable<StorePackageUpdate>>,
    {
        let this = self;
    ...
    pub fn RequestDownloadAndInstallStorePackagesAsync<P0>(&self, storeids: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<StorePackageUpdateResult, StorePackageUpdateStatus>>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        let this = self;
    ...
    #[cfg(feature = "ApplicationModel")]
    pub fn FindStoreProductForPackageAsync<P0, P1>(&self, productkinds: P0, package: P1) -> windows_core::Result<windows_async::IAsyncOperation<StoreProductResult>>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    ...
    pub fn TrySilentDownloadStorePackageUpdatesAsync<P0>(&self, storepackageupdates: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<StorePackageUpdateResult, StorePackageUpdateStatus>>
    where
        P0: windows_core::Param<windows_collections::IIterable<StorePackageUpdate>>,
    {
        let this = &windows_core::Interface::cast::<IStoreContext3>(self)?;
    ...
    pub fn TrySilentDownloadAndInstallStorePackageUpdatesAsync<P0>(&self, storepackageupdates: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<StorePackageUpdateResult, StorePackageUpdateStatus>>
    where
        P0: windows_core::Param<windows_collections::IIterable<StorePackageUpdate>>,
    {
        let this = &windows_core::Interface::cast::<IStoreContext3>(self)?;
    ...
    #[cfg(feature = "ApplicationModel")]
    pub fn CanAcquireStoreLicenseForOptionalPackageAsync<P0>(&self, optionalpackage: P0) -> windows_core::Result<windows_async::IAsyncOperation<StoreCanAcquireLicenseResult>>
    where
        P0: windows_core::Param<super::super::ApplicationModel::Package>,
    {
        let this = &windows_core::Interface::cast::<IStoreContext3>(self)?;
    ...
    pub fn CanAcquireStoreLicenseAsync(&self, productstoreid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<StoreCanAcquireLicenseResult>> {
        let this = &windows_core::Interface::cast::<IStoreContext3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetStoreProductsWithOptionsAsync<P0, P1, P2>(&self, productkinds: P0, storeids: P1, storeproductoptions: P2) -> windows_core::Result<windows_async::IAsyncOperation<StoreProductQueryResult>>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    ...
    pub fn GetAssociatedStoreQueueItemsAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<StoreQueueItem>>> {
        let this = &windows_core::Interface::cast::<IStoreContext3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetStoreQueueItemsAsync<P0>(&self, storeids: P0) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<StoreQueueItem>>>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        let this = &windows_core::Interface::cast::<IStoreContext3>(self)?;
    ...
    pub fn RequestDownloadAndInstallStorePackagesWithInstallOptionsAsync<P0, P1>(&self, storeids: P0, storepackageinstalloptions: P1) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<StorePackageUpdateResult, StorePackageUpdateStatus>>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    ...
    pub fn DownloadAndInstallStorePackagesAsync<P0>(&self, storeids: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<StorePackageUpdateResult, StorePackageUpdateStatus>>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        let this = &windows_core::Interface::cast::<IStoreContext3>(self)?;
    ...
    #[cfg(feature = "ApplicationModel")]
    pub fn RequestUninstallStorePackageAsync<P0>(&self, package: P0) -> windows_core::Result<windows_async::IAsyncOperation<StoreUninstallStorePackageResult>>
    where
        P0: windows_core::Param<super::super::ApplicationModel::Package>,
    {
        let this = &windows_core::Interface::cast::<IStoreContext3>(self)?;
    ...
    pub fn RequestUninstallStorePackageByStoreIdAsync(&self, storeid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<StoreUninstallStorePackageResult>> {
        let this = &windows_core::Interface::cast::<IStoreContext3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ApplicationModel")]
    pub fn UninstallStorePackageAsync<P0>(&self, package: P0) -> windows_core::Result<windows_async::IAsyncOperation<StoreUninstallStorePackageResult>>
    where
        P0: windows_core::Param<super::super::ApplicationModel::Package>,
    {
        let this = &windows_core::Interface::cast::<IStoreContext3>(self)?;
    ...
    pub fn UninstallStorePackageByStoreIdAsync(&self, storeid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<StoreUninstallStorePackageResult>> {
        let this = &windows_core::Interface::cast::<IStoreContext3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestRateAndReviewAppAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<StoreRateAndReviewResult>> {
    ...
    pub fn SetInstallOrderForAssociatedStoreQueueItemsAsync<P0>(&self, items: P0) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<StoreQueueItem>>>
    where
    ...
    pub fn GetUserPurchaseHistoryAsync<P0>(&self, productkinds: P0) -> windows_core::Result<windows_async::IAsyncOperation<StoreProductQueryResult>>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
    ...
    pub fn GetAssociatedStoreProductsByInAppOfferTokenAsync<P0>(&self, inappoffertokens: P0) -> windows_core::Result<windows_async::IAsyncOperation<StoreProductQueryResult>>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        let this = &windows_core::Interface::cast::<IStoreContext5>(self)?;
    ...
    pub fn RequestPurchaseByInAppOfferTokenAsync(&self, inappoffertoken: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<StorePurchaseResult>> {
        let this = &windows_core::Interface::cast::<IStoreContext5>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl StoreProduct {
    ...
    pub fn GetIsAnySkuInstalledAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl StoreProductPagedQueryResult {
    ...
    pub fn GetNextAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<StoreProductPagedQueryResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl StoreQueueItem {
    ...
    pub fn CancelInstallAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
    ...
    pub fn PauseInstallAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = &windows_core::Interface::cast::<IStoreQueueItem2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ResumeInstallAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = &windows_core::Interface::cast::<IStoreQueueItem2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl StoreRequestHelper {
    pub fn SendRequestAsync<P0>(context: P0, requestkind: u32, parametersasjson: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<StoreSendRequestResult>>
    where
...
impl StoreSku {
    ...
    pub fn GetIsInstalledAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
