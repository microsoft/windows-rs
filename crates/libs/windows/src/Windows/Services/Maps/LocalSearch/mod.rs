...
impl LocalCategories {
    pub fn BankAndCreditUnions() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn EatDrink() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::ILocalCategoriesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Hospitals() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::ILocalCategoriesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HotelsAndMotels() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::ILocalCategoriesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Parking() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::ILocalCategoriesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SeeDo() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::ILocalCategoriesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SeeDo)(windows_core::Interface::as_raw(this), &mut result__).map(|| core::mem::transmute(result__))
        })
    }
    pub fn Shop() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::ILocalCategoriesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Shop)(windows_core::Interface::as_raw(this), &mut result__).map(|| core::mem::transmute(result__))
        })
    }
    fn ILocalCategoriesStatics<R, F: FnOnce(&ILocalCategoriesStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl LocalLocation {
    pub fn Address(&self) -> Result<super::MapAddress, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn Point(&self) -> Result<super::super::super::Devices::Geolocation::Geopoint, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DataAttribution(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RatingInfo(&self) -> Result<LocalLocationRatingInfo, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ILocalLocation2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HoursOfOperation(&self) -> Result<windows_collections::IVectorView<LocalLocationHoursOfOperationItem>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ILocalLocation2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl LocalLocationFinder {
    #[cfg(feature = "Devices_Geolocation")]
    pub fn FindLocalLocationsAsync<P1>(searchterm: &windows_core::HSTRING, searcharea: P1, localcategory: &windows_core::HSTRING, maxresults: u32) -> Result<windows_future::IAsyncOperation<LocalLocationFinderResult>, windows_result::HRESULT>
    where
    ...
    fn ILocalLocationFinderStatics<R, F: FnOnce(&ILocalLocationFinderStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl LocalLocationFinderResult {
    pub fn LocalLocations(&self) -> Result<windows_collections::IVectorView<LocalLocation>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Status(&self) -> Result<LocalLocationFinderStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl LocalLocationHoursOfOperationItem {
    #[cfg(feature = "Globalization")]
    pub fn Day(&self) -> Result<super::super::super::Globalization::DayOfWeek, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Start(&self) -> Result<super::super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Span(&self) -> Result<super::super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl LocalLocationRatingInfo {
    pub fn AggregateRating(&self) -> Result<super::super::super::Foundation::IReference<f64>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RatingCount(&self) -> Result<super::super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ProviderIdentifier(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PlaceInfoHelper {
    pub fn CreateFromLocalLocation<P0>(location: P0) -> Result<super::PlaceInfo, windows_result::HRESULT>
    where
    ...
    fn IPlaceInfoHelperStatics<R, F: FnOnce(&IPlaceInfoHelperStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
