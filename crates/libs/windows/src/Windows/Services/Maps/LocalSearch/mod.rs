...
impl LocalCategories {
    pub fn BankAndCreditUnions() -> windows_result::Result<windows_core::HSTRING> {
    ...
    pub fn EatDrink() -> windows_result::Result<windows_core::HSTRING> {
        Self::ILocalCategoriesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Hospitals() -> windows_result::Result<windows_core::HSTRING> {
        Self::ILocalCategoriesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HotelsAndMotels() -> windows_result::Result<windows_core::HSTRING> {
        Self::ILocalCategoriesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Parking() -> windows_result::Result<windows_core::HSTRING> {
        Self::ILocalCategoriesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
...
impl LocalLocation {
    pub fn Address(&self) -> windows_result::Result<super::MapAddress> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn Point(&self) -> windows_result::Result<super::super::super::Devices::Geolocation::Geopoint> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DataAttribution(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RatingInfo(&self) -> windows_result::Result<LocalLocationRatingInfo> {
        let this = &windows_core::Interface::cast::<ILocalLocation2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HoursOfOperation(&self) -> windows_result::Result<windows_collections::IVectorView<LocalLocationHoursOfOperationItem>> {
        let this = &windows_core::Interface::cast::<ILocalLocation2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl LocalLocationFinder {
    #[cfg(feature = "Devices_Geolocation")]
    pub fn FindLocalLocationsAsync<P1>(searchterm: &windows_core::HSTRING, searcharea: P1, localcategory: &windows_core::HSTRING, maxresults: u32) -> windows_result::Result<windows_future::IAsyncOperation<LocalLocationFinderResult>>
    where
    ...
    fn ILocalLocationFinderStatics<R, F: FnOnce(&ILocalLocationFinderStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl LocalLocationFinderResult {
    pub fn LocalLocations(&self) -> windows_result::Result<windows_collections::IVectorView<LocalLocation>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Status(&self) -> windows_result::Result<LocalLocationFinderStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl LocalLocationHoursOfOperationItem {
    #[cfg(feature = "Globalization")]
    pub fn Day(&self) -> windows_result::Result<super::super::super::Globalization::DayOfWeek> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Start(&self) -> windows_result::Result<super::super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Span(&self) -> windows_result::Result<super::super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl LocalLocationRatingInfo {
    pub fn AggregateRating(&self) -> windows_result::Result<super::super::super::Foundation::IReference<f64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RatingCount(&self) -> windows_result::Result<super::super::super::Foundation::IReference<i32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ProviderIdentifier(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PlaceInfoHelper {
    pub fn CreateFromLocalLocation<P0>(location: P0) -> windows_result::Result<super::PlaceInfo>
    where
    ...
    fn IPlaceInfoHelperStatics<R, F: FnOnce(&IPlaceInfoHelperStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
