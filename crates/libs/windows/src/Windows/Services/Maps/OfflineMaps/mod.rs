...
windows_core::imp::required_hierarchy!(OfflineMapPackage, IOfflineMapPackage, IOfflineMapPackageStatics);
...
windows_core::imp::required_hierarchy!(OfflineMapPackageQueryResult, IOfflineMapPackageQueryResult);
...
windows_core::imp::required_hierarchy!(OfflineMapPackageStartDownloadResult, IOfflineMapPackageStartDownloadResult);
