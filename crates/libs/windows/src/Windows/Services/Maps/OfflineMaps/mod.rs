...
impl OfflineMapPackage {
    pub fn Status(&self) -> Result<OfflineMapPackageStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn EnclosingRegionName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EstimatedSizeInBytes(&self) -> Result<u64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StatusChanged<P0>(&self, value: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RequestStartDownloadAsync(&self) -> Result<windows_future::IAsyncOperation<OfflineMapPackageStartDownloadResult>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn FindPackagesAsync<P0>(querypoint: P0) -> Result<windows_future::IAsyncOperation<OfflineMapPackageQueryResult>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn FindPackagesInBoundingBoxAsync<P0>(queryboundingbox: P0) -> Result<windows_future::IAsyncOperation<OfflineMapPackageQueryResult>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn FindPackagesInGeocircleAsync<P0>(querycircle: P0) -> Result<windows_future::IAsyncOperation<OfflineMapPackageQueryResult>, windows_result::HRESULT>
    where
    ...
    fn IOfflineMapPackageStatics<R, F: FnOnce(&IOfflineMapPackageStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl OfflineMapPackageQueryResult {
    pub fn Status(&self) -> Result<OfflineMapPackageQueryStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn Packages(&self) -> Result<windows_collections::IVectorView<OfflineMapPackage>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl OfflineMapPackageStartDownloadResult {
    pub fn Status(&self) -> Result<OfflineMapPackageStartDownloadStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
