...
impl OfflineMapPackage {
    ...
    pub fn RequestStartDownloadAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<OfflineMapPackageStartDownloadResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn FindPackagesAsync<P0>(querypoint: P0) -> windows_core::Result<windows_async::IAsyncOperation<OfflineMapPackageQueryResult>>
    where
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn FindPackagesInBoundingBoxAsync<P0>(queryboundingbox: P0) -> windows_core::Result<windows_async::IAsyncOperation<OfflineMapPackageQueryResult>>
    where
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn FindPackagesInGeocircleAsync<P0>(querycircle: P0) -> windows_core::Result<windows_async::IAsyncOperation<OfflineMapPackageQueryResult>>
    where
