...
impl EnhancedWaypoint {
    ...
    pub fn Point(&self) -> Result<super::super::Devices::Geolocation::Geopoint, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn Kind(&self) -> Result<WaypointKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn Create<P0>(point: P0, kind: WaypointKind) -> Result<EnhancedWaypoint, windows_result::HRESULT>
    where
    ...
    fn IEnhancedWaypointFactory<R, F: FnOnce(&IEnhancedWaypointFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
pub struct IMapAddress_Vtbl {
    ...
    pub BuildingFloor: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub BuildingRoom: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub BuildingWing: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub StreetNumber: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Street: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Neighborhood: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub District: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Town: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Region: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub RegionCode: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Country: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub CountryCode: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub PostCode: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub Continent: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
}
...
pub struct IMapLocationFinderStatics_Vtbl {
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub FindLocationsAsync: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "Devices_Geolocation"))]
    FindLocationsAsync: usize,
    #[cfg(feature = "Devices_Geolocation")]
    pub FindLocationsWithMaxCountAsync: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut core::ffi::c_void, u32, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "Devices_Geolocation"))]
...
pub struct IMapRouteManeuver2_Vtbl {
    ...
    pub StreetName: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
}
...
pub struct IMapServiceStatics_Vtbl {
    ...
    pub ServiceToken: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
}
...
pub struct IPlaceInfo_Vtbl {
    ...
    pub DisplayName: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub DisplayAddress: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(feature = "Devices_Geolocation")]
...
pub struct IPlaceInfoCreateOptions_Vtbl {
    ...
    pub DisplayName: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub SetDisplayAddress: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub DisplayAddress: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
}
...
pub struct IPlaceInfoStatics_Vtbl {
    ...
    pub CreateFromIdentifier: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(feature = "Devices_Geolocation")]
    pub CreateFromIdentifierWithOptions: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut core::ffi::c_void, *mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "Devices_Geolocation"))]
...
impl ManeuverWarning {
    pub fn Kind(&self) -> Result<ManeuverWarningKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Kind)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn Severity(&self) -> Result<ManeuverWarningSeverity, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MapAddress {
    pub fn BuildingName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BuildingFloor(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BuildingRoom(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BuildingWing(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StreetNumber(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Street(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Neighborhood(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn District(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Town(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RegionCode(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CountryCode(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PostCode(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Continent(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FormattedAddress(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IMapAddress2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).FormattedAddress)(windows_core::Interface::as_raw(this), &mut result__).map(|| core::mem::transmute(result__))
        }
    }
}
...
impl MapLocation {
    ...
    pub fn Address(&self) -> Result<MapAddress, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MapLocationFinder {
    #[cfg(feature = "Devices_Geolocation")]
    pub fn FindLocationsAtAsync<P0>(querypoint: P0) -> Result<windows_future::IAsyncOperation<MapLocationFinderResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
    {
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn FindLocationsAsync<P1>(searchtext: &windows_core::HSTRING, referencepoint: P1) -> Result<windows_future::IAsyncOperation<MapLocationFinderResult>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn FindLocationsWithMaxCountAsync<P1>(searchtext: &windows_core::HSTRING, referencepoint: P1, maxcount: u32) -> Result<windows_future::IAsyncOperation<MapLocationFinderResult>, windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
    {
        Self::IMapLocationFinderStatics(|this| unsafe {
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn FindLocationsAtWithAccuracyAsync<P0>(querypoint: P0, accuracy: MapLocationDesiredAccuracy) -> Result<windows_future::IAsyncOperation<MapLocationFinderResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
    {
    ...
    fn IMapLocationFinderStatics<R, F: FnOnce(&IMapLocationFinderStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IMapLocationFinderStatics2<R, F: FnOnce(&IMapLocationFinderStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl MapLocationFinderResult {
    pub fn Locations(&self) -> Result<windows_collections::IVectorView<MapLocation>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Status(&self) -> Result<MapLocationFinderStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MapManager {
    pub fn ShowDownloadedMapsUI() -> Result<(), windows_result::HRESULT> {
    ...
    pub fn ShowMapsUpdateUI() -> Result<(), windows_result::HRESULT> {
    ...
    fn IMapManagerStatics<R, F: FnOnce(&IMapManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl MapRoute {
    #[cfg(feature = "Devices_Geolocation")]
    pub fn BoundingBox(&self) -> Result<super::super::Devices::Geolocation::GeoboundingBox, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LengthInMeters(&self) -> Result<f64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EstimatedDuration(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn Path(&self) -> Result<super::super::Devices::Geolocation::Geopath, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Legs(&self) -> Result<windows_collections::IVectorView<MapRouteLeg>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsTrafficBased(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ViolatedRestrictions(&self) -> Result<MapRouteRestrictions, windows_result::HRESULT> {
    ...
    pub fn HasBlockedRoads(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IMapRoute2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DurationWithoutTraffic(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
    ...
    pub fn TrafficCongestion(&self) -> Result<TrafficCongestion, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IMapRoute3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsScenic(&self) -> Result<bool, windows_result::HRESULT> {
...
impl MapRouteDrivingOptions {
    ...
    pub fn MaxAlternateRouteCount(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxAlternateRouteCount(&self, value: u32) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetMaxAlternateRouteCount)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn InitialHeading(&self) -> Result<super::super::Foundation::IReference<f64>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetInitialHeading<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn RouteOptimization(&self) -> Result<MapRouteOptimization, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRouteOptimization(&self, value: MapRouteOptimization) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetRouteOptimization)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn RouteRestrictions(&self) -> Result<MapRouteRestrictions, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRouteRestrictions(&self, value: MapRouteRestrictions) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetRouteRestrictions)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DepartureTime(&self) -> Result<super::super::Foundation::IReference<super::super::Foundation::DateTime>, windows_result::HRESULT> {
    ...
    pub fn SetDepartureTime<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
...
impl MapRouteFinder {
    #[cfg(feature = "Devices_Geolocation")]
    pub fn GetDrivingRouteAsync<P0, P1>(startpoint: P0, endpoint: P1) -> Result<windows_future::IAsyncOperation<MapRouteFinderResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
        P1: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
    {
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn GetDrivingRouteWithOptimizationAsync<P0, P1>(startpoint: P0, endpoint: P1, optimization: MapRouteOptimization) -> Result<windows_future::IAsyncOperation<MapRouteFinderResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
        P1: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
    {
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn GetDrivingRouteWithOptimizationAndRestrictionsAsync<P0, P1>(startpoint: P0, endpoint: P1, optimization: MapRouteOptimization, restrictions: MapRouteRestrictions) -> Result<windows_future::IAsyncOperation<MapRouteFinderResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
        P1: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
    {
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn GetDrivingRouteWithOptimizationRestrictionsAndHeadingAsync<P0, P1>(startpoint: P0, endpoint: P1, optimization: MapRouteOptimization, restrictions: MapRouteRestrictions, headingindegrees: f64) -> Result<windows_future::IAsyncOperation<MapRouteFinderResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
        P1: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
    {
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn GetDrivingRouteFromWaypointsAsync<P0>(waypoints: P0) -> Result<windows_future::IAsyncOperation<MapRouteFinderResult>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn GetDrivingRouteFromWaypointsAndOptimizationAsync<P0>(waypoints: P0, optimization: MapRouteOptimization) -> Result<windows_future::IAsyncOperation<MapRouteFinderResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IIterable<super::super::Devices::Geolocation::Geopoint>>,
    {
        Self::IMapRouteFinderStatics(|this| unsafe {
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn GetDrivingRouteFromWaypointsOptimizationAndRestrictionsAsync<P0>(waypoints: P0, optimization: MapRouteOptimization, restrictions: MapRouteRestrictions) -> Result<windows_future::IAsyncOperation<MapRouteFinderResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IIterable<super::super::Devices::Geolocation::Geopoint>>,
    {
        Self::IMapRouteFinderStatics(|this| unsafe {
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn GetDrivingRouteFromWaypointsOptimizationRestrictionsAndHeadingAsync<P0>(waypoints: P0, optimization: MapRouteOptimization, restrictions: MapRouteRestrictions, headingindegrees: f64) -> Result<windows_future::IAsyncOperation<MapRouteFinderResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IIterable<super::super::Devices::Geolocation::Geopoint>>,
    {
        Self::IMapRouteFinderStatics(|this| unsafe {
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn GetWalkingRouteAsync<P0, P1>(startpoint: P0, endpoint: P1) -> Result<windows_future::IAsyncOperation<MapRouteFinderResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
        P1: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
    {
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn GetWalkingRouteFromWaypointsAsync<P0>(waypoints: P0) -> Result<windows_future::IAsyncOperation<MapRouteFinderResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IIterable<super::super::Devices::Geolocation::Geopoint>>,
    {
        Self::IMapRouteFinderStatics(|this| unsafe {
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn GetDrivingRouteWithOptionsAsync<P0, P1, P2>(startpoint: P0, endpoint: P1, options: P2) -> Result<windows_future::IAsyncOperation<MapRouteFinderResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
        P1: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
    ...
    pub fn GetDrivingRouteFromEnhancedWaypointsAsync<P0>(waypoints: P0) -> Result<windows_future::IAsyncOperation<MapRouteFinderResult>, windows_result::HRESULT>
    where
    ...
    pub fn GetDrivingRouteFromEnhancedWaypointsWithOptionsAsync<P0, P1>(waypoints: P0, options: P1) -> Result<windows_future::IAsyncOperation<MapRouteFinderResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IIterable<EnhancedWaypoint>>,
    ...
    fn IMapRouteFinderStatics<R, F: FnOnce(&IMapRouteFinderStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<MapRouteFinder, IMapRouteFinderStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IMapRouteFinderStatics2<R, F: FnOnce(&IMapRouteFinderStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<MapRouteFinder, IMapRouteFinderStatics2> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IMapRouteFinderStatics3<R, F: FnOnce(&IMapRouteFinderStatics3) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl MapRouteFinderResult {
    pub fn Route(&self) -> Result<MapRoute, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Status(&self) -> Result<MapRouteFinderStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn AlternateRoutes(&self) -> Result<windows_collections::IVectorView<MapRoute>, windows_result::HRESULT> {
...
impl MapRouteLeg {
    ...
    pub fn Maneuvers(&self) -> Result<windows_collections::IVectorView<MapRouteManeuver>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MapRouteManeuver {
    #[cfg(feature = "Devices_Geolocation")]
    pub fn StartingPoint(&self) -> Result<super::super::Devices::Geolocation::Geopoint, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn InstructionText(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Kind(&self) -> Result<MapRouteManeuverKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Kind)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn ExitNumber(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ManeuverNotices(&self) -> Result<MapManeuverNotices, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StartHeading(&self) -> Result<f64, windows_result::HRESULT> {
    ...
    pub fn EndHeading(&self) -> Result<f64, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IMapRouteManeuver2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StreetName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IMapRouteManeuver2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Warnings(&self) -> Result<windows_collections::IVectorView<ManeuverWarning>, windows_result::HRESULT> {
...
impl MapService {
    pub fn SetServiceToken(value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn ServiceToken() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn WorldViewRegionCode() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn DataAttributions() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn SetDataUsagePreference(value: MapServiceDataUsagePreference) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn DataUsagePreference() -> Result<MapServiceDataUsagePreference, windows_result::HRESULT> {
    ...
    fn IMapServiceStatics<R, F: FnOnce(&IMapServiceStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<MapService, IMapServiceStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IMapServiceStatics2<R, F: FnOnce(&IMapServiceStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<MapService, IMapServiceStatics2> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IMapServiceStatics3<R, F: FnOnce(&IMapServiceStatics3) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<MapService, IMapServiceStatics3> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IMapServiceStatics4<R, F: FnOnce(&IMapServiceStatics4) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl PlaceInfo {
    pub fn Show(&self, selection: super::super::Foundation::Rect) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).Show)(windows_core::Interface::as_raw(this), selection).ok() }
    }
    #[cfg(feature = "UI_Popups")]
    pub fn ShowWithPreferredPlacement(&self, selection: super::super::Foundation::Rect, preferredplacement: super::super::UI::Popups::Placement) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Identifier(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DisplayAddress(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DisplayAddress)(windows_core::Interface::as_raw(this), &mut result__).map(|| core::mem::transmute(result__))
        }
    }
    #[cfg(feature = "Devices_Geolocation")]
    pub fn Geoshape(&self) -> Result<super::super::Devices::Geolocation::IGeoshape, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn Create<P0>(referencepoint: P0) -> Result<PlaceInfo, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
    {
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn CreateWithGeopointAndOptions<P0, P1>(referencepoint: P0, options: P1) -> Result<PlaceInfo, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
    ...
    pub fn CreateFromIdentifier(identifier: &windows_core::HSTRING) -> Result<PlaceInfo, windows_result::HRESULT> {
        Self::IPlaceInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn CreateFromIdentifierWithOptions<P1, P2>(identifier: &windows_core::HSTRING, defaultpoint: P1, options: P2) -> Result<PlaceInfo, windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::Devices::Geolocation::Geopoint>,
    ...
    pub fn CreateFromMapLocation<P0>(location: P0) -> Result<PlaceInfo, windows_result::HRESULT>
    where
    ...
    pub fn IsShowSupported() -> Result<bool, windows_result::HRESULT> {
        Self::IPlaceInfoStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsShowSupported)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn CreateFromAddress(displayaddress: &windows_core::HSTRING) -> Result<PlaceInfo, windows_result::HRESULT> {
    ...
    pub fn CreateFromAddressWithName(displayaddress: &windows_core::HSTRING, displayname: &windows_core::HSTRING) -> Result<PlaceInfo, windows_result::HRESULT> {
        Self::IPlaceInfoStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IPlaceInfoStatics<R, F: FnOnce(&IPlaceInfoStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<PlaceInfo, IPlaceInfoStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IPlaceInfoStatics2<R, F: FnOnce(&IPlaceInfoStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl PlaceInfoCreateOptions {
    ...
    pub fn SetDisplayAddress(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
