...
windows_core::imp::required_hierarchy!(EnhancedWaypoint, IEnhancedWaypoint, IEnhancedWaypointFactory);
...
windows_core::imp::required_hierarchy!(ManeuverWarning, IManeuverWarning);
...
windows_core::imp::required_hierarchy!(MapAddress, IMapAddress, IMapAddress2);
impl MapAddress {
...
windows_core::imp::required_hierarchy!(MapLocation, IMapLocation);
impl MapLocation {
    #[cfg(feature = "Devices_Geolocation")]
    pub fn Point(&self) -> windows_core::Result<super::super::Devices::Geolocation::Geopoint> {
        let this = self;
...
windows_core::imp::required_hierarchy!(MapLocationFinderResult, IMapLocationFinderResult);
...
windows_core::imp::required_hierarchy!(MapRoute, IMapRoute, IMapRoute2, IMapRoute3, IMapRoute4);
impl MapRoute {
    #[cfg(feature = "Devices_Geolocation")]
...
windows_core::imp::required_hierarchy!(MapRouteDrivingOptions, IMapRouteDrivingOptions, IMapRouteDrivingOptions2);
...
windows_core::imp::required_hierarchy!(MapRouteFinderResult, IMapRouteFinderResult, IMapRouteFinderResult2);
...
windows_core::imp::required_hierarchy!(MapRouteLeg, IMapRouteLeg, IMapRouteLeg2);
impl MapRouteLeg {
    #[cfg(feature = "Devices_Geolocation")]
    pub fn BoundingBox(&self) -> windows_core::Result<super::super::Devices::Geolocation::GeoboundingBox> {
        let this = self;
...
windows_core::imp::required_hierarchy!(MapRouteManeuver, IMapRouteManeuver, IMapRouteManeuver2, IMapRouteManeuver3);
...
windows_core::imp::required_hierarchy!(PlaceInfo, IPlaceInfo, IPlaceInfoStatics, IPlaceInfoStatics2);
impl PlaceInfo {
...
windows_core::imp::required_hierarchy!(PlaceInfoCreateOptions, IPlaceInfoCreateOptions);
