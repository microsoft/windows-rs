...
impl GuidanceAudioNotificationRequestedEventArgs {
    pub fn AudioNotification(&self) -> windows_result::Result<GuidanceAudioNotificationKind> {
        let this = self;
        unsafe {
    ...
    pub fn AudioFilePaths(&self) -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AudioText(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GuidanceLaneInfo {
    pub fn LaneMarkers(&self) -> windows_result::Result<GuidanceLaneMarkers> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsOnRoute(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GuidanceManeuver {
    ...
    pub fn StartLocation(&self) -> windows_result::Result<super::super::super::Devices::Geolocation::Geopoint> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DistanceFromRouteStart(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DistanceFromPreviousManeuver(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DepartureRoadName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NextRoadName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DepartureShortRoadName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NextShortRoadName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Kind(&self) -> windows_result::Result<GuidanceManeuverKind> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StartAngle(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EndAngle(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RoadSignpost(&self) -> windows_result::Result<GuidanceRoadSignpost> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GuidanceMapMatchedCoordinate {
    #[cfg(feature = "Devices_Geolocation")]
    pub fn Location(&self) -> windows_result::Result<super::super::super::Devices::Geolocation::Geopoint> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CurrentHeading(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CurrentSpeed(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsOnStreet(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Road(&self) -> windows_result::Result<GuidanceRoadSegment> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GuidanceNavigator {
    pub fn StartNavigating<P0>(&self, route: P0) -> windows_result::Result<()>
    where
    ...
    pub fn StartSimulating<P0>(&self, route: P0, speedinmeterspersecond: i32) -> windows_result::Result<()>
    where
        P0: windows_core::Param<GuidanceRoute>,
    {
        let this = self;
    ...
    pub fn StartTracking(&self) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn RepeatLastAudioNotification(&self) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RepeatLastAudioNotification)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn AudioMeasurementSystem(&self) -> windows_result::Result<GuidanceAudioMeasurementSystem> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAudioMeasurementSystem(&self, value: GuidanceAudioMeasurementSystem) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAudioMeasurementSystem)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AudioNotifications(&self) -> windows_result::Result<GuidanceAudioNotifications> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAudioNotifications(&self, value: GuidanceAudioNotifications) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAudioNotifications)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn GuidanceUpdated<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveGuidanceUpdated(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveGuidanceUpdated)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn DestinationReached<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveDestinationReached(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveDestinationReached)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn Rerouting<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::Foundation::TypedEventHandler<GuidanceNavigator, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveRerouting(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveRerouting)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn Rerouted<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveRerouted(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveRerouted)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn RerouteFailed<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::Foundation::TypedEventHandler<GuidanceNavigator, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveRerouteFailed(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveRerouteFailed)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn UserLocationLost<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::Foundation::TypedEventHandler<GuidanceNavigator, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveUserLocationLost(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveUserLocationLost)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn UserLocationRestored<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::Foundation::TypedEventHandler<GuidanceNavigator, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveUserLocationRestored(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveUserLocationRestored)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn SetGuidanceVoice(&self, voiceid: i32, voicefolder: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn UpdateUserLocation<P0>(&self, userlocation: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn UpdateUserLocationWithPositionOverride<P0>(&self, userlocation: P0, positionoverride: super::super::super::Devices::Geolocation::BasicGeoposition) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::super::Devices::Geolocation::Geocoordinate>,
    {
        let this = self;
    ...
    pub fn AudioNotificationRequested<P0>(&self, value: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveAudioNotificationRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IGuidanceNavigator2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemoveAudioNotificationRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn IsGuidanceAudioMuted(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IGuidanceNavigator2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsGuidanceAudioMuted(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IGuidanceNavigator2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetIsGuidanceAudioMuted)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn GetCurrent() -> windows_result::Result<GuidanceNavigator> {
    ...
    pub fn UseAppProvidedVoice() -> windows_result::Result<bool> {
    ...
    fn IGuidanceNavigatorStatics<R, F: FnOnce(&IGuidanceNavigatorStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IGuidanceNavigatorStatics2<R, F: FnOnce(&IGuidanceNavigatorStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl GuidanceReroutedEventArgs {
    pub fn Route(&self) -> windows_result::Result<GuidanceRoute> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GuidanceRoadSegment {
    pub fn RoadName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShortRoadName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SpeedLimit(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TravelTime(&self) -> windows_result::Result<super::super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn Path(&self) -> windows_result::Result<super::super::super::Devices::Geolocation::Geopath> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsHighway(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsTunnel(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsTollRoad(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GuidanceRoadSignpost {
    ...
    pub fn Exit(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI")]
    pub fn BackgroundColor(&self) -> windows_result::Result<super::super::super::UI::Color> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI")]
    pub fn ForegroundColor(&self) -> windows_result::Result<super::super::super::UI::Color> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ExitDirections(&self) -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GuidanceRoute {
    ...
    pub fn Distance(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Maneuvers(&self) -> windows_result::Result<windows_collections::IVectorView<GuidanceManeuver>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn BoundingBox(&self) -> windows_result::Result<super::super::super::Devices::Geolocation::GeoboundingBox> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RoadSegments(&self) -> windows_result::Result<windows_collections::IVectorView<GuidanceRoadSegment>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ConvertToMapRoute(&self) -> windows_result::Result<super::MapRoute> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanCreateFromMapRoute<P0>(maproute: P0) -> windows_result::Result<bool>
    where
    ...
    pub fn TryCreateFromMapRoute<P0>(maproute: P0) -> windows_result::Result<GuidanceRoute>
    where
        P0: windows_core::Param<super::MapRoute>,
    {
        Self::IGuidanceRouteStatics(|this| unsafe {
    ...
    fn IGuidanceRouteStatics<R, F: FnOnce(&IGuidanceRouteStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl GuidanceTelemetryCollector {
    ...
    pub fn ClearLocalData(&self) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).ClearLocalData)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn SpeedTrigger(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSpeedTrigger(&self, value: f64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSpeedTrigger)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn UploadFrequency(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetUploadFrequency(&self, value: i32) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetUploadFrequency)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn GetCurrent() -> windows_result::Result<GuidanceTelemetryCollector> {
        Self::IGuidanceTelemetryCollectorStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetCurrent)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IGuidanceTelemetryCollectorStatics<R, F: FnOnce(&IGuidanceTelemetryCollectorStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl GuidanceUpdatedEventArgs {
    pub fn Mode(&self) -> windows_result::Result<GuidanceMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NextManeuver(&self) -> windows_result::Result<GuidanceManeuver> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NextManeuverDistance(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AfterNextManeuver(&self) -> windows_result::Result<GuidanceManeuver> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AfterNextManeuverDistance(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DistanceToDestination(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ElapsedDistance(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ElapsedTime(&self) -> windows_result::Result<super::super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TimeToDestination(&self) -> windows_result::Result<super::super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CurrentLocation(&self) -> windows_result::Result<GuidanceMapMatchedCoordinate> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsNewManeuver(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LaneInfo(&self) -> windows_result::Result<windows_collections::IVectorView<GuidanceLaneInfo>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
