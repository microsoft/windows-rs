...
impl TargetedContentAction {
    pub fn InvokeAsync(&self) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
...
impl TargetedContentChangedEventArgs {
    ...
    pub fn HasPreviousContentExpired(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl TargetedContentCollection {
    ...
    pub fn ReportInteraction(&self, interaction: TargetedContentInteraction) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).ReportInteraction)(windows_core::Interface::as_raw(this), interaction).ok() }
    }
    pub fn ReportCustomInteraction(&self, custominteractionname: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Properties(&self) -> Result<windows_collections::IMapView<windows_core::HSTRING, TargetedContentValue>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Collections(&self) -> Result<windows_collections::IVectorView<TargetedContentCollection>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Items(&self) -> Result<windows_collections::IVectorView<TargetedContentItem>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl TargetedContentContainer {
    ...
    pub fn Availability(&self) -> Result<TargetedContentAvailability, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Content(&self) -> Result<TargetedContentCollection, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SelectSingleObject(&self, path: &windows_core::HSTRING) -> Result<TargetedContentObject, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAsync(contentid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<TargetedContentContainer>, windows_result::HRESULT> {
    ...
    fn ITargetedContentContainerStatics<R, F: FnOnce(&ITargetedContentContainerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl TargetedContentFile {
    pub fn OpenReadAsync(&self) -> Result<windows_future::IAsyncOperation<super::super::Storage::Streams::IRandomAccessStreamWithContentType>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl TargetedContentItem {
    ...
    pub fn State(&self) -> Result<TargetedContentItemState, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl TargetedContentItemState {
    pub fn ShouldDisplay(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AppInstallationState(&self) -> Result<TargetedContentAppInstallationState, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl TargetedContentObject {
    pub fn ObjectKind(&self) -> Result<TargetedContentObjectKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Collection(&self) -> Result<TargetedContentCollection, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Item(&self) -> Result<TargetedContentItem, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Value(&self) -> Result<TargetedContentValue, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl TargetedContentSubscription {
    ...
    pub fn GetContentContainerAsync(&self) -> Result<windows_future::IAsyncOperation<TargetedContentContainer>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ContentChanged<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveContentChanged(&self, cookie: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn RemoveAvailabilityChanged(&self, cookie: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn GetAsync(subscriptionid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<TargetedContentSubscription>, windows_result::HRESULT> {
    ...
    pub fn GetOptions(subscriptionid: &windows_core::HSTRING) -> Result<TargetedContentSubscriptionOptions, windows_result::HRESULT> {
        Self::ITargetedContentSubscriptionStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn ITargetedContentSubscriptionStatics<R, F: FnOnce(&ITargetedContentSubscriptionStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl TargetedContentSubscriptionOptions {
    pub fn SubscriptionId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AllowPartialContentAvailability(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAllowPartialContentAvailability(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAllowPartialContentAvailability)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CloudQueryParameters(&self) -> Result<windows_collections::IMap<windows_core::HSTRING, windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LocalFilters(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl TargetedContentValue {
    pub fn ValueKind(&self) -> Result<TargetedContentValueKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn String(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Number(&self) -> Result<f64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Boolean(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn File(&self) -> Result<TargetedContentFile, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ImageFile(&self) -> Result<TargetedContentImage, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Action(&self) -> Result<TargetedContentAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Strings(&self) -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Uris(&self) -> Result<windows_collections::IVectorView<super::super::Foundation::Uri>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Numbers(&self) -> Result<windows_collections::IVectorView<f64>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Booleans(&self) -> Result<windows_collections::IVectorView<bool>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Files(&self) -> Result<windows_collections::IVectorView<TargetedContentFile>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ImageFiles(&self) -> Result<windows_collections::IVectorView<TargetedContentImage>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Actions(&self) -> Result<windows_collections::IVectorView<TargetedContentAction>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
