...
impl TargetedContentAction {
    pub fn InvokeAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
...
impl TargetedContentContainer {
    ...
    pub fn GetAsync(contentid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<TargetedContentContainer>> {
...
impl TargetedContentFile {
    pub fn OpenReadAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<super::super::Storage::Streams::IRandomAccessStreamWithContentType>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl TargetedContentSubscription {
    ...
    pub fn GetContentContainerAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<TargetedContentContainer>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAsync(subscriptionid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<TargetedContentSubscription>> {
