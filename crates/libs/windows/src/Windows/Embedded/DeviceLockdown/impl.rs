...
pub trait IDeviceLockdownProfileInformation_Impl: Sized {
...
#[cfg(feature = "implement_exclusive")]
impl IDeviceLockdownProfileInformation_Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IDeviceLockdownProfileInformation_Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IDeviceLockdownProfileInformation_Vtbl {
        unsafe extern "system" fn Name<Impl: IDeviceLockdownProfileInformation_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, result__: *mut ::core::mem::ManuallyDrop<::windows::core::HSTRING>) -> ::windows::core::HRESULT {
...
pub trait IDeviceLockdownProfileStatics_Impl: Sized {
...
#[cfg(all(feature = "Foundation", feature = "Foundation_Collections", feature = "implement_exclusive"))]
impl IDeviceLockdownProfileStatics_Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IDeviceLockdownProfileStatics_Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IDeviceLockdownProfileStatics_Vtbl {
        unsafe extern "system" fn GetSupportedLockdownProfiles<Impl: IDeviceLockdownProfileStatics_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn GetCurrentLockdownProfile<Impl: IDeviceLockdownProfileStatics_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, result__: *mut ::windows::core::GUID) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn ApplyLockdownProfileAsync<Impl: IDeviceLockdownProfileStatics_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, profileid: ::windows::core::GUID, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn GetLockdownProfileInformation<Impl: IDeviceLockdownProfileStatics_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, profileid: ::windows::core::GUID, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
