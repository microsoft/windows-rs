...
pub trait IChatCapabilitiesImpl: Sized {
    ...
    fn IsGeoLocationPushCapable(&mut self) -> ::windows::core::Result<bool>;
    fn IsIntegratedMessagingCapable(&mut self) -> ::windows::core::Result<bool>;
}
#[cfg(feature = "implement_exclusive")]
...
pub trait IChatConversationImpl: Sized {
    ...
    fn IsConversationMuted(&mut self) -> ::windows::core::Result<bool>;
    fn SetIsConversationMuted(&mut self, value: bool) -> ::windows::core::Result<()>;
    fn MostRecentMessageId(&mut self) -> ::windows::core::Result<::windows::core::HSTRING>;
    fn Participants(&mut self) -> ::windows::core::Result<super::super::Foundation::Collections::IVector<::windows::core::HSTRING>>;
    fn ThreadingInfo(&mut self) -> ::windows::core::Result<ChatConversationThreadingInfo>;
    fn DeleteAsync(&mut self) -> ::windows::core::Result<super::super::Foundation::IAsyncAction>;
    fn GetMessageReader(&mut self) -> ::windows::core::Result<ChatMessageReader>;
    fn MarkAllMessagesAsReadAsync(&mut self) -> ::windows::core::Result<super::super::Foundation::IAsyncAction>;
    fn MarkMessagesAsReadAsync(&mut self, value: &super::super::Foundation::DateTime) -> ::windows::core::Result<super::super::Foundation::IAsyncAction>;
    fn SaveAsync(&mut self) -> ::windows::core::Result<super::super::Foundation::IAsyncAction>;
    fn NotifyLocalParticipantComposing(&mut self, transportid: &::windows::core::HSTRING, participantaddress: &::windows::core::HSTRING, iscomposing: bool) -> ::windows::core::Result<()>;
    fn NotifyRemoteParticipantComposing(&mut self, transportid: &::windows::core::HSTRING, participantaddress: &::windows::core::HSTRING, iscomposing: bool) -> ::windows::core::Result<()>;
    fn RemoteParticipantComposingChanged(&mut self, handler: &::core::option::Option<super::super::Foundation::TypedEventHandler<ChatConversation, RemoteParticipantComposingChangedEventArgs>>) -> ::windows::core::Result<super::super::Foundation::EventRegistrationToken>;
    fn RemoveRemoteParticipantComposingChanged(&mut self, token: &super::super::Foundation::EventRegistrationToken) -> ::windows::core::Result<()>;
}
#[cfg(all(feature = "Foundation", feature = "Foundation_Collections", feature = "implement_exclusive"))]
...
pub trait IChatConversationThreadingInfoImpl: Sized {
    ...
    fn SetCustom(&mut self, value: &::windows::core::HSTRING) -> ::windows::core::Result<()>;
    fn ConversationId(&mut self) -> ::windows::core::Result<::windows::core::HSTRING>;
    fn SetConversationId(&mut self, value: &::windows::core::HSTRING) -> ::windows::core::Result<()>;
    fn Participants(&mut self) -> ::windows::core::Result<super::super::Foundation::Collections::IVector<::windows::core::HSTRING>>;
    fn Kind(&mut self) -> ::windows::core::Result<ChatConversationThreadingKind>;
    fn SetKind(&mut self, value: ChatConversationThreadingKind) -> ::windows::core::Result<()>;
}
#[cfg(all(feature = "Foundation_Collections", feature = "implement_exclusive"))]
...
pub trait IChatMessageImpl: Sized {
    ...
    fn Id(&mut self) -> ::windows::core::Result<::windows::core::HSTRING>;
    fn IsForwardingDisabled(&mut self) -> ::windows::core::Result<bool>;
    fn IsIncoming(&mut self) -> ::windows::core::Result<bool>;
    fn IsRead(&mut self) -> ::windows::core::Result<bool>;
    fn LocalTimestamp(&mut self) -> ::windows::core::Result<super::super::Foundation::DateTime>;
    fn NetworkTimestamp(&mut self) -> ::windows::core::Result<super::super::Foundation::DateTime>;
    fn Recipients(&mut self) -> ::windows::core::Result<super::super::Foundation::Collections::IVector<::windows::core::HSTRING>>;
    fn RecipientSendStatuses(&mut self) -> ::windows::core::Result<super::super::Foundation::Collections::IMapView<::windows::core::HSTRING, ChatMessageStatus>>;
    fn Status(&mut self) -> ::windows::core::Result<ChatMessageStatus>;
    fn Subject(&mut self) -> ::windows::core::Result<::windows::core::HSTRING>;
    ...
    fn SetTransportId(&mut self, value: &::windows::core::HSTRING) -> ::windows::core::Result<()>;
}
#[cfg(all(feature = "Foundation", feature = "Foundation_Collections", feature = "implement_exclusive"))]
...
pub trait IChatMessage2Impl: Sized + IChatMessageImpl + IChatMessage3Impl {
    ...
    fn IsAutoReply(&mut self) -> ::windows::core::Result<bool>;
    fn SetIsAutoReply(&mut self, value: bool) -> ::windows::core::Result<()>;
    fn SetIsForwardingDisabled(&mut self, value: bool) -> ::windows::core::Result<()>;
    fn IsReplyDisabled(&mut self) -> ::windows::core::Result<bool>;
    ...
    fn IsSimMessage(&mut self) -> ::windows::core::Result<bool>;
    fn SetLocalTimestamp(&mut self, value: &super::super::Foundation::DateTime) -> ::windows::core::Result<()>;
    fn MessageKind(&mut self) -> ::windows::core::Result<ChatMessageKind>;
    fn SetMessageKind(&mut self, value: ChatMessageKind) -> ::windows::core::Result<()>;
    fn MessageOperatorKind(&mut self) -> ::windows::core::Result<ChatMessageOperatorKind>;
    fn SetMessageOperatorKind(&mut self, value: ChatMessageOperatorKind) -> ::windows::core::Result<()>;
    fn SetNetworkTimestamp(&mut self, value: &super::super::Foundation::DateTime) -> ::windows::core::Result<()>;
    fn IsReceivedDuringQuietHours(&mut self) -> ::windows::core::Result<bool>;
    fn SetIsReceivedDuringQuietHours(&mut self, value: bool) -> ::windows::core::Result<()>;
    fn SetRemoteId(&mut self, value: &::windows::core::HSTRING) -> ::windows::core::Result<()>;
    fn SetStatus(&mut self, value: ChatMessageStatus) -> ::windows::core::Result<()>;
    fn SetSubject(&mut self, value: &::windows::core::HSTRING) -> ::windows::core::Result<()>;
    fn ShouldSuppressNotification(&mut self) -> ::windows::core::Result<bool>;
    fn SetShouldSuppressNotification(&mut self, value: bool) -> ::windows::core::Result<()>;
    fn ThreadingInfo(&mut self) -> ::windows::core::Result<ChatConversationThreadingInfo>;
    fn SetThreadingInfo(&mut self, value: &::core::option::Option<ChatConversationThreadingInfo>) -> ::windows::core::Result<()>;
    fn RecipientsDeliveryInfos(&mut self) -> ::windows::core::Result<super::super::Foundation::Collections::IVector<ChatRecipientDeliveryInfo>>;
}
#[cfg(all(feature = "Foundation", feature = "Foundation_Collections", feature = "implement_exclusive"))]
...
pub trait IChatMessageAttachmentImpl: Sized {
    ...
    fn SetGroupId(&mut self, value: u32) -> ::windows::core::Result<()>;
...
pub trait IChatMessageAttachment2Impl: Sized + IChatMessageAttachmentImpl {
    ...
    fn SetTransferProgress(&mut self, value: f64) -> ::windows::core::Result<()>;
    fn OriginalFileName(&mut self) -> ::windows::core::Result<::windows::core::HSTRING>;
    fn SetOriginalFileName(&mut self, value: &::windows::core::HSTRING) -> ::windows::core::Result<()>;
}
#[cfg(all(feature = "Storage_Streams", feature = "implement_exclusive"))]
...
pub trait IChatMessageManagerStaticImpl: Sized {
    ...
    fn ShowSmsSettings(&mut self) -> ::windows::core::Result<()>;
}
#[cfg(all(feature = "Foundation", feature = "Foundation_Collections", feature = "implement_exclusive"))]
...
pub trait IChatMessageNotificationTriggerDetails2Impl: Sized + IChatMessageNotificationTriggerDetailsImpl {
    ...
    fn ShouldUpdateActionCenter(&mut self) -> ::windows::core::Result<bool>;
}
#[cfg(feature = "implement_exclusive")]
...
pub trait IChatMessageStoreImpl: Sized {
    ...
    fn GetMessageAsync(&mut self, localchatmessageid: &::windows::core::HSTRING) -> ::windows::core::Result<super::super::Foundation::IAsyncOperation<ChatMessage>>;
    fn GetMessageReader1(&mut self) -> ::windows::core::Result<ChatMessageReader>;
    fn GetMessageReader2(&mut self, recenttimelimit: &super::super::Foundation::TimeSpan) -> ::windows::core::Result<ChatMessageReader>;
    fn MarkMessageReadAsync(&mut self, localchatmessageid: &::windows::core::HSTRING) -> ::windows::core::Result<super::super::Foundation::IAsyncAction>;
    fn RetrySendMessageAsync(&mut self, localchatmessageid: &::windows::core::HSTRING) -> ::windows::core::Result<super::super::Foundation::IAsyncAction>;
    fn SendMessageAsync(&mut self, chatmessage: &::core::option::Option<ChatMessage>) -> ::windows::core::Result<super::super::Foundation::IAsyncAction>;
    fn ValidateMessage(&mut self, chatmessage: &::core::option::Option<ChatMessage>) -> ::windows::core::Result<ChatMessageValidationResult>;
    fn MessageChanged(&mut self, value: &::core::option::Option<super::super::Foundation::TypedEventHandler<ChatMessageStore, ChatMessageChangedEventArgs>>) -> ::windows::core::Result<super::super::Foundation::EventRegistrationToken>;
    fn RemoveMessageChanged(&mut self, value: &super::super::Foundation::EventRegistrationToken) -> ::windows::core::Result<()>;
}
#[cfg(all(feature = "Foundation", feature = "implement_exclusive"))]
...
pub trait IChatMessageStore2Impl: Sized + IChatMessageStoreImpl {
    ...
    fn GetConversationFromThreadingInfoAsync(&mut self, threadinginfo: &::core::option::Option<ChatConversationThreadingInfo>) -> ::windows::core::Result<super::super::Foundation::IAsyncOperation<ChatConversation>>;
    fn GetConversationReader(&mut self) -> ::windows::core::Result<ChatConversationReader>;
    fn GetConversationForTransportsReader(&mut self, transportids: &::core::option::Option<super::super::Foundation::Collections::IIterable<::windows::core::HSTRING>>) -> ::windows::core::Result<ChatConversationReader>;
    fn GetMessageByRemoteIdAsync(&mut self, transportid: &::windows::core::HSTRING, remoteid: &::windows::core::HSTRING) -> ::windows::core::Result<super::super::Foundation::IAsyncOperation<ChatMessage>>;
    fn GetUnseenCountAsync(&mut self) -> ::windows::core::Result<super::super::Foundation::IAsyncOperation<i32>>;
    fn GetUnseenCountForTransportsReaderAsync(&mut self, transportids: &::core::option::Option<super::super::Foundation::Collections::IIterable<::windows::core::HSTRING>>) -> ::windows::core::Result<super::super::Foundation::IAsyncOperation<i32>>;
    fn MarkAsSeenAsync(&mut self) -> ::windows::core::Result<super::super::Foundation::IAsyncAction>;
    fn MarkAsSeenForTransportsAsync(&mut self, transportids: &::core::option::Option<super::super::Foundation::Collections::IIterable<::windows::core::HSTRING>>) -> ::windows::core::Result<super::super::Foundation::IAsyncAction>;
    fn GetSearchReader(&mut self, value: &::core::option::Option<ChatQueryOptions>) -> ::windows::core::Result<ChatSearchReader>;
    fn SaveMessageAsync(&mut self, chatmessage: &::core::option::Option<ChatMessage>) -> ::windows::core::Result<super::super::Foundation::IAsyncAction>;
    fn TryCancelDownloadMessageAsync(&mut self, localchatmessageid: &::windows::core::HSTRING) -> ::windows::core::Result<super::super::Foundation::IAsyncOperation<bool>>;
    fn TryCancelSendMessageAsync(&mut self, localchatmessageid: &::windows::core::HSTRING) -> ::windows::core::Result<super::super::Foundation::IAsyncOperation<bool>>;
    fn StoreChanged(&mut self, handler: &::core::option::Option<super::super::Foundation::TypedEventHandler<ChatMessageStore, ChatMessageStoreChangedEventArgs>>) -> ::windows::core::Result<super::super::Foundation::EventRegistrationToken>;
...
pub trait IChatMessageTransportImpl: Sized {
    ...
    fn TransportFriendlyName(&mut self) -> ::windows::core::Result<::windows::core::HSTRING>;
    fn TransportId(&mut self) -> ::windows::core::Result<::windows::core::HSTRING>;
    fn RequestSetAsNotificationProviderAsync(&mut self) -> ::windows::core::Result<super::super::Foundation::IAsyncAction>;
}
#[cfg(all(feature = "Foundation", feature = "implement_exclusive"))]
...
pub trait IChatMessageTransportConfigurationImpl: Sized {
    ...
    fn SupportedVideoFormat(&mut self) -> ::windows::core::Result<super::super::Media::MediaProperties::MediaEncodingProfile>;
...
pub trait IChatMessageValidationResultImpl: Sized {
    ...
    fn Status(&mut self) -> ::windows::core::Result<ChatMessageValidationStatus>;
}
#[cfg(all(feature = "Foundation", feature = "implement_exclusive"))]
...
pub trait IChatRecipientDeliveryInfoImpl: Sized {
    ...
    fn SetDeliveryTime(&mut self, value: &::core::option::Option<super::super::Foundation::IReference<super::super::Foundation::DateTime>>) -> ::windows::core::Result<()>;
    fn ReadTime(&mut self) -> ::windows::core::Result<super::super::Foundation::IReference<super::super::Foundation::DateTime>>;
    fn SetReadTime(&mut self, value: &::core::option::Option<super::super::Foundation::IReference<super::super::Foundation::DateTime>>) -> ::windows::core::Result<()>;
    fn TransportErrorCodeCategory(&mut self) -> ::windows::core::Result<ChatTransportErrorCodeCategory>;
    fn TransportInterpretedErrorCode(&mut self) -> ::windows::core::Result<ChatTransportInterpretedErrorCode>;
    fn TransportErrorCode(&mut self) -> ::windows::core::Result<i32>;
    fn IsErrorPermanent(&mut self) -> ::windows::core::Result<bool>;
    fn Status(&mut self) -> ::windows::core::Result<ChatMessageStatus>;
}
#[cfg(all(feature = "Foundation", feature = "implement_exclusive"))]
...
pub trait IChatSyncConfigurationImpl: Sized {
    ...
    fn SetRestoreHistorySpan(&mut self, value: ChatRestoreHistorySpan) -> ::windows::core::Result<()>;
}
#[cfg(feature = "implement_exclusive")]
...
pub trait IChatSyncManagerImpl: Sized {
    ...
    fn IsAccountAssociated(&mut self, webaccount: &::core::option::Option<super::super::Security::Credentials::WebAccount>) -> ::windows::core::Result<bool>;
    fn StartSync(&mut self) -> ::windows::core::Result<()>;
    fn SetConfigurationAsync(&mut self, configuration: &::core::option::Option<ChatSyncConfiguration>) -> ::windows::core::Result<super::super::Foundation::IAsyncAction>;
}
#[cfg(all(feature = "Foundation", feature = "Security_Credentials", feature = "implement_exclusive"))]
...
pub trait IRcsEndUserMessageImpl: Sized {
    ...
    fn Text(&mut self) -> ::windows::core::Result<::windows::core::HSTRING>;
    fn IsPinRequired(&mut self) -> ::windows::core::Result<bool>;
    fn Actions(&mut self) -> ::windows::core::Result<super::super::Foundation::Collections::IVectorView<RcsEndUserMessageAction>>;
    fn SendResponseAsync(&mut self, action: &::core::option::Option<RcsEndUserMessageAction>) -> ::windows::core::Result<super::super::Foundation::IAsyncAction>;
    fn SendResponseWithPinAsync(&mut self, action: &::core::option::Option<RcsEndUserMessageAction>, pin: &::windows::core::HSTRING) -> ::windows::core::Result<super::super::Foundation::IAsyncAction>;
}
#[cfg(all(feature = "Foundation", feature = "Foundation_Collections", feature = "implement_exclusive"))]
...
pub trait IRcsManagerStaticsImpl: Sized {
    ...
    fn LeaveConversationAsync(&mut self, conversation: &::core::option::Option<ChatConversation>) -> ::windows::core::Result<super::super::Foundation::IAsyncAction>;
}
#[cfg(all(feature = "Foundation", feature = "Foundation_Collections", feature = "implement_exclusive"))]
...
pub trait IRcsTransportImpl: Sized {
    ...
    fn TransportFriendlyName(&mut self) -> ::windows::core::Result<::windows::core::HSTRING>;
    fn TransportId(&mut self) -> ::windows::core::Result<::windows::core::HSTRING>;
    fn Configuration(&mut self) -> ::windows::core::Result<RcsTransportConfiguration>;
    fn IsStoreAndForwardEnabled(&mut self, servicekind: RcsServiceKind) -> ::windows::core::Result<bool>;
    fn IsServiceKindSupported(&mut self, servicekind: RcsServiceKind) -> ::windows::core::Result<bool>;
    fn ServiceKindSupportedChanged(&mut self, handler: &::core::option::Option<super::super::Foundation::TypedEventHandler<RcsTransport, RcsServiceKindSupportedChangedEventArgs>>) -> ::windows::core::Result<super::super::Foundation::EventRegistrationToken>;
    fn RemoveServiceKindSupportedChanged(&mut self, token: &super::super::Foundation::EventRegistrationToken) -> ::windows::core::Result<()>;
}
#[cfg(all(feature = "Foundation", feature = "Foundation_Collections", feature = "implement_exclusive"))]
...
pub trait IRcsTransportConfigurationImpl: Sized {
    ...
    fn MaxRecipientCount(&mut self) -> ::windows::core::Result<i32>;
    fn MaxFileSizeInKilobytes(&mut self) -> ::windows::core::Result<i32>;
    fn WarningFileSizeInKilobytes(&mut self) -> ::windows::core::Result<i32>;
}
#[cfg(feature = "implement_exclusive")]
