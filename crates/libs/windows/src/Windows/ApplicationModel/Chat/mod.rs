...
impl ChatCapabilitiesManager {
    pub fn GetCachedCapabilitiesAsync(address: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<ChatCapabilities>> {
    ...
    pub fn GetCapabilitiesFromNetworkAsync(address: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<ChatCapabilities>> {
        Self::IChatCapabilitiesManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetCachedCapabilitiesForTransportAsync(address: &windows_core::HSTRING, transportid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<ChatCapabilities>> {
    ...
    pub fn GetCapabilitiesFromNetworkForTransportAsync(address: &windows_core::HSTRING, transportid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<ChatCapabilities>> {
        Self::IChatCapabilitiesManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ChatConversation {
    ...
    pub fn MarkAllMessagesAsReadAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MarkMessagesAsReadAsync(&self, value: super::super::Foundation::DateTime) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ChatConversationReader {
    pub fn ReadBatchAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<ChatConversation>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReadBatchWithCountAsync(&self, count: i32) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<ChatConversation>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ChatMessageBlocking {
    pub fn MarkMessageAsBlockedAsync(localchatmessageid: &windows_core::HSTRING, blocked: bool) -> windows_core::Result<windows_async::IAsyncAction> {
...
impl ChatMessageChangeReader {
    ...
    pub fn ReadBatchAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<ChatMessageChange>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReadBatchAsync)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl ChatMessageManager {
    pub fn RegisterTransportAsync() -> windows_core::Result<windows_async::IAsyncOperation<windows_core::HSTRING>> {
    ...
    pub fn GetTransportAsync(transportid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<ChatMessageTransport>> {
        Self::IChatMessageManager2Statics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetTransportsAsync() -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<ChatMessageTransport>>> {
    ...
    pub fn RequestStoreAsync() -> windows_core::Result<windows_async::IAsyncOperation<ChatMessageStore>> {
        Self::IChatMessageManagerStatic(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowComposeSmsMessageAsync<P0>(message: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    pub fn RequestSyncManagerAsync() -> windows_core::Result<windows_async::IAsyncOperation<ChatSyncManager>> {
...
impl ChatMessageReader {
    pub fn ReadBatchAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<ChatMessage>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReadBatchAsync)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ReadBatchWithCountAsync(&self, count: i32) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<ChatMessage>>> {
...
impl ChatMessageStore {
    ...
    pub fn DeleteMessageAsync(&self, localmessageid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DownloadMessageAsync(&self, localchatmessageid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMessageAsync(&self, localchatmessageid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<ChatMessage>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MarkMessageReadAsync(&self, localchatmessageid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RetrySendMessageAsync(&self, localchatmessageid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SendMessageAsync<P0>(&self, chatmessage: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
        P0: windows_core::Param<ChatMessage>,
    {
        let this = self;
    ...
    pub fn ForwardMessageAsync<P1>(&self, localchatmessageid: &windows_core::HSTRING, addresses: P1) -> windows_core::Result<windows_async::IAsyncOperation<ChatMessage>>
    where
    ...
    pub fn GetConversationAsync(&self, conversationid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<ChatConversation>> {
        let this = &windows_core::Interface::cast::<IChatMessageStore2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetConversationForTransportsAsync<P1>(&self, conversationid: &windows_core::HSTRING, transportids: P1) -> windows_core::Result<windows_async::IAsyncOperation<ChatConversation>>
    where
        P1: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        let this = &windows_core::Interface::cast::<IChatMessageStore2>(self)?;
    ...
    pub fn GetConversationFromThreadingInfoAsync<P0>(&self, threadinginfo: P0) -> windows_core::Result<windows_async::IAsyncOperation<ChatConversation>>
    where
        P0: windows_core::Param<ChatConversationThreadingInfo>,
    {
        let this = &windows_core::Interface::cast::<IChatMessageStore2>(self)?;
    ...
    pub fn GetMessageByRemoteIdAsync(&self, transportid: &windows_core::HSTRING, remoteid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<ChatMessage>> {
        let this = &windows_core::Interface::cast::<IChatMessageStore2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetUnseenCountAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<i32>> {
        let this = &windows_core::Interface::cast::<IChatMessageStore2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetUnseenCountForTransportsReaderAsync<P0>(&self, transportids: P0) -> windows_core::Result<windows_async::IAsyncOperation<i32>>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        let this = &windows_core::Interface::cast::<IChatMessageStore2>(self)?;
    ...
    pub fn MarkAsSeenAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = &windows_core::Interface::cast::<IChatMessageStore2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MarkAsSeenForTransportsAsync<P0>(&self, transportids: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        let this = &windows_core::Interface::cast::<IChatMessageStore2>(self)?;
    ...
    pub fn SaveMessageAsync<P0>(&self, chatmessage: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
        P0: windows_core::Param<ChatMessage>,
    {
        let this = &windows_core::Interface::cast::<IChatMessageStore2>(self)?;
    ...
    pub fn TryCancelDownloadMessageAsync(&self, localchatmessageid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
        let this = &windows_core::Interface::cast::<IChatMessageStore2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryCancelSendMessageAsync(&self, localchatmessageid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
        let this = &windows_core::Interface::cast::<IChatMessageStore2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMessageBySyncIdAsync(&self, syncid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<ChatMessage>> {
...
impl ChatMessageTransport {
    ...
    pub fn RequestSetAsNotificationProviderAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ChatSearchReader {
    pub fn ReadBatchAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<IChatItem>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReadBatchAsync)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ReadBatchWithCountAsync(&self, count: i32) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<IChatItem>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReadBatchWithCountAsync)(windows_core::Interface::as_raw(this), count, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl ChatSyncManager {
    ...
    pub fn AssociateAccountAsync<P0>(&self, webaccount: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    pub fn UnassociateAccountAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetConfigurationAsync<P0>(&self, configuration: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
...
impl RcsEndUserMessage {
    ...
    pub fn SendResponseAsync<P0>(&self, action: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    pub fn SendResponseWithPinAsync<P0>(&self, action: P0, pin: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncAction>
    where
        P0: windows_core::Param<RcsEndUserMessageAction>,
    {
        let this = self;
...
impl RcsManager {
    ...
    pub fn GetTransportsAsync() -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<RcsTransport>>> {
        Self::IRcsManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetTransportsAsync)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn GetTransportAsync(transportid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<RcsTransport>> {
        Self::IRcsManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetTransportAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(transportid), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn LeaveConversationAsync<P0>(conversation: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
