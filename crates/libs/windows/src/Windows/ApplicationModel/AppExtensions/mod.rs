...
windows_core::imp::required_hierarchy!(AppExtension, IAppExtension, IAppExtension2, IAppExtension3);
impl AppExtension {
...
windows_core::imp::required_hierarchy!(AppExtensionCatalog, IAppExtensionCatalog, IAppExtensionCatalog2, IAppExtensionCatalogStatics);
...
windows_core::imp::required_hierarchy!(AppExtensionPackageInstalledEventArgs, IAppExtensionPackageInstalledEventArgs);
...
windows_core::imp::required_hierarchy!(AppExtensionPackageStatusChangedEventArgs, IAppExtensionPackageStatusChangedEventArgs);
...
windows_core::imp::required_hierarchy!(AppExtensionPackageUninstallingEventArgs, IAppExtensionPackageUninstallingEventArgs);
...
windows_core::imp::required_hierarchy!(AppExtensionPackageUpdatedEventArgs, IAppExtensionPackageUpdatedEventArgs);
...
windows_core::imp::required_hierarchy!(AppExtensionPackageUpdatingEventArgs, IAppExtensionPackageUpdatingEventArgs);
