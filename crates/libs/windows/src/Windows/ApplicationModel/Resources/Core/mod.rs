...
impl ResourceCandidate {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetValueAsFileAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<super::super::super::Storage::StorageFile>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetValueAsStreamAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<super::super::super::Storage::Streams::IRandomAccessStream>> {
