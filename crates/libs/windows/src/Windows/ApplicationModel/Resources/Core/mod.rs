...
windows_core::imp::required_hierarchy!(NamedResource, INamedResource);
impl NamedResource {
...
windows_core::imp::required_hierarchy!(ResourceCandidate, IResourceCandidate, IResourceCandidate2, IResourceCandidate3);
...
windows_core::imp::required_hierarchy!(ResourceContext, IResourceContext, IResourceContextStatics, IResourceContextStatics2, IResourceContextStatics3, IResourceContextStatics4);
...
windows_core::imp::required_hierarchy!(ResourceManager, IResourceManager, IResourceManager2, IResourceManagerStatics);
...
#[cfg(feature = "Foundation_Collections")]
windows_core::imp::required_hierarchy ! ( ResourceMap , IResourceMap , super::super::super::Foundation::Collections:: IIterable < super::super::super::Foundation::Collections:: IKeyValuePair < windows_core::HSTRING , NamedResource > > , super::super::super::Foundation::Collections:: IMapView < windows_core::HSTRING , NamedResource > );
#[cfg(feature = "Foundation_Collections")]
impl ResourceMap {
    pub fn Uri(&self) -> windows_core::Result<super::super::super::Foundation::Uri> {
        let this = self;
...
windows_core::imp::required_hierarchy!(ResourceQualifier, IResourceQualifier);
