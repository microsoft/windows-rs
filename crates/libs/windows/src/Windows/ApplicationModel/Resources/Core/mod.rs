...
impl NamedResource {
    ...
    pub fn Candidates(&self) -> windows_result::Result<windows_collections::IVectorView<ResourceCandidate>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Resolve(&self) -> windows_result::Result<ResourceCandidate> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ResolveForContext<P0>(&self, resourcecontext: P0) -> windows_result::Result<ResourceCandidate>
    where
    ...
    pub fn ResolveAll(&self) -> windows_result::Result<windows_collections::IVectorView<ResourceCandidate>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ResolveAllForContext<P0>(&self, resourcecontext: P0) -> windows_result::Result<windows_collections::IVectorView<ResourceCandidate>>
    where
        P0: windows_core::Param<ResourceContext>,
    {
        let this = self;
...
impl ResourceCandidate {
    pub fn Qualifiers(&self) -> windows_result::Result<windows_collections::IVectorView<ResourceQualifier>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsMatch(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsMatchAsDefault(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetValueAsFileAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<super::super::super::Storage::StorageFile>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetValueAsStreamAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<super::super::super::Storage::Streams::IRandomAccessStream>> {
    ...
    pub fn Kind(&self) -> windows_result::Result<ResourceCandidateKind> {
...
impl ResourceCandidateVectorView {
    pub fn First(&self) -> windows_result::Result<windows_collections::IIterator<ResourceCandidate>> {
    ...
    pub fn GetAt(&self, index: u32) -> windows_result::Result<ResourceCandidate> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMany(&self, startindex: u32, items: &mut [Option<ResourceCandidate>]) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for ResourceCandidateVectorView {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_class::<Self, windows_collections::IVectorView<ResourceCandidate>>();
}
unsafe impl windows_core::Interface for ResourceCandidateVectorView {
    type Vtable = <windows_collections::IVectorView<ResourceCandidate> as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID = <windows_collections::IVectorView<ResourceCandidate> as windows_core::Interface>::IID;
}
...
impl ResourceContext {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn QualifierValues(&self) -> windows_result::Result<super::super::super::Foundation::Collections::IObservableMap<windows_core::HSTRING, windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ResetQualifierValues<P0>(&self, qualifiernames: P0) -> windows_result::Result<()>
    where
    ...
    pub fn OverrideToMatch<P0>(&self, result: P0) -> windows_result::Result<()>
    where
    ...
    pub fn Clone(&self) -> windows_result::Result<ResourceContext> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetLanguages<P0>(&self, languages: P0) -> windows_result::Result<()>
    where
    ...
    pub fn CreateMatchingContext<P0>(result: P0) -> windows_result::Result<ResourceContext>
    where
        P0: windows_core::Param<windows_collections::IIterable<ResourceQualifier>>,
    {
    ...
    pub fn GetForCurrentView() -> windows_result::Result<ResourceContext> {
        Self::IResourceContextStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForCurrentView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn SetGlobalQualifierValue(key: &windows_core::HSTRING, value: &windows_core::HSTRING) -> windows_result::Result<()> {
    ...
    pub fn ResetGlobalQualifierValues() -> windows_result::Result<()> {
    ...
    pub fn ResetGlobalQualifierValuesForSpecifiedQualifiers<P0>(qualifiernames: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
    ...
    pub fn GetForViewIndependentUse() -> windows_result::Result<ResourceContext> {
        Self::IResourceContextStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetGlobalQualifierValueWithPersistence(key: &windows_core::HSTRING, value: &windows_core::HSTRING, persistence: ResourceQualifierPersistence) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "UI")]
    pub fn GetForUIContext<P0>(context: P0) -> windows_result::Result<ResourceContext>
    where
    ...
    fn IResourceContextStatics<R, F: FnOnce(&IResourceContextStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ResourceContext, IResourceContextStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IResourceContextStatics2<R, F: FnOnce(&IResourceContextStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ResourceContext, IResourceContextStatics2> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IResourceContextStatics3<R, F: FnOnce(&IResourceContextStatics3) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ResourceContext, IResourceContextStatics3> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IResourceContextStatics4<R, F: FnOnce(&IResourceContextStatics4) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl windows_core::RuntimeType for ResourceContextLanguagesVectorView {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_class::<Self, windows_collections::IVectorView<windows_core::HSTRING>>();
}
unsafe impl windows_core::Interface for ResourceContextLanguagesVectorView {
    type Vtable = <windows_collections::IVectorView<windows_core::HSTRING> as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID = <windows_collections::IVectorView<windows_core::HSTRING> as windows_core::Interface>::IID;
}
...
impl ResourceManager {
    pub fn MainResourceMap(&self) -> windows_result::Result<ResourceMap> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AllResourceMaps(&self) -> windows_result::Result<windows_collections::IMapView<windows_core::HSTRING, ResourceMap>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DefaultContext(&self) -> windows_result::Result<ResourceContext> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadPriFiles<P0>(&self, files: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn UnloadPriFiles<P0>(&self, files: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<windows_collections::IIterable<super::super::super::Storage::IStorageFile>>,
    {
        let this = self;
    ...
    pub fn GetAllNamedResourcesForPackage(&self, packagename: &windows_core::HSTRING, resourcelayoutinfo: ResourceLayoutInfo) -> windows_result::Result<windows_collections::IVectorView<NamedResource>> {
    ...
    pub fn GetAllSubtreesForPackage(&self, packagename: &windows_core::HSTRING, resourcelayoutinfo: ResourceLayoutInfo) -> windows_result::Result<windows_collections::IVectorView<ResourceMap>> {
        let this = &windows_core::Interface::cast::<IResourceManager2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Current() -> windows_result::Result<ResourceManager> {
    ...
    pub fn IsResourceReference(resourcereference: &windows_core::HSTRING) -> windows_result::Result<bool> {
        Self::IResourceManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IResourceManagerStatics<R, F: FnOnce(&IResourceManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl ResourceMap {
    pub fn First(&self) -> windows_result::Result<windows_collections::IIterator<windows_collections::IKeyValuePair<windows_core::HSTRING, NamedResource>>> {
    ...
    pub fn Lookup(&self, key: &windows_core::HSTRING) -> windows_result::Result<NamedResource> {
    ...
    pub fn Split(&self, first: &mut Option<windows_collections::IMapView<windows_core::HSTRING, NamedResource>>, second: &mut Option<windows_collections::IMapView<windows_core::HSTRING, NamedResource>>) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<windows_collections::IMapView<windows_core::HSTRING, NamedResource>>(self)?;
    ...
    pub fn GetValue(&self, resource: &windows_core::HSTRING) -> windows_result::Result<ResourceCandidate> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetValueForContext<P1>(&self, resource: &windows_core::HSTRING, context: P1) -> windows_result::Result<ResourceCandidate>
    where
    ...
    pub fn GetSubtree(&self, reference: &windows_core::HSTRING) -> windows_result::Result<ResourceMap> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ResourceMapIterator {
    pub fn Current(&self) -> windows_result::Result<windows_collections::IKeyValuePair<windows_core::HSTRING, NamedResource>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Current)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetMany(&self, items: &mut [Option<windows_collections::IKeyValuePair<windows_core::HSTRING, NamedResource>>]) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl windows_core::RuntimeType for ResourceMapIterator {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_class::<Self, windows_collections::IIterator<windows_collections::IKeyValuePair<windows_core::HSTRING, NamedResource>>>();
}
unsafe impl windows_core::Interface for ResourceMapIterator {
    type Vtable = <windows_collections::IIterator<windows_collections::IKeyValuePair<windows_core::HSTRING, NamedResource>> as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID = <windows_collections::IIterator<windows_collections::IKeyValuePair<windows_core::HSTRING, NamedResource>> as windows_core::Interface>::IID;
}
...
impl ResourceMapMapView {
    pub fn First(&self) -> windows_result::Result<windows_collections::IIterator<windows_collections::IKeyValuePair<windows_core::HSTRING, ResourceMap>>> {
    ...
    pub fn Lookup(&self, key: &windows_core::HSTRING) -> windows_result::Result<ResourceMap> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Lookup)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(key), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Split(&self, first: &mut Option<windows_collections::IMapView<windows_core::HSTRING, ResourceMap>>, second: &mut Option<windows_collections::IMapView<windows_core::HSTRING, ResourceMap>>) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).Split)(windows_core::Interface::as_raw(this), first as *mut _ as _, second as *mut _ as _).ok() }
    }
}
impl windows_core::RuntimeType for ResourceMapMapView {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_class::<Self, windows_collections::IMapView<windows_core::HSTRING, ResourceMap>>();
}
unsafe impl windows_core::Interface for ResourceMapMapView {
    type Vtable = <windows_collections::IMapView<windows_core::HSTRING, ResourceMap> as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID = <windows_collections::IMapView<windows_core::HSTRING, ResourceMap> as windows_core::Interface>::IID;
}
...
impl ResourceMapMapViewIterator {
    pub fn Current(&self) -> windows_result::Result<windows_collections::IKeyValuePair<windows_core::HSTRING, ResourceMap>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Current)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetMany(&self, items: &mut [Option<windows_collections::IKeyValuePair<windows_core::HSTRING, ResourceMap>>]) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetMany)(windows_core::Interface::as_raw(this), items.len().try_into().unwrap(), core::mem::transmute_copy(&items), &mut result__).map(|| result__)
...
impl windows_core::RuntimeType for ResourceMapMapViewIterator {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_class::<Self, windows_collections::IIterator<windows_collections::IKeyValuePair<windows_core::HSTRING, ResourceMap>>>();
}
unsafe impl windows_core::Interface for ResourceMapMapViewIterator {
    type Vtable = <windows_collections::IIterator<windows_collections::IKeyValuePair<windows_core::HSTRING, ResourceMap>> as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID = <windows_collections::IIterator<windows_collections::IKeyValuePair<windows_core::HSTRING, ResourceMap>> as windows_core::Interface>::IID;
}
...
impl ResourceQualifier {
    ...
    pub fn Score(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ResourceQualifierMapView {
    pub fn First(&self) -> windows_result::Result<windows_collections::IIterator<windows_collections::IKeyValuePair<windows_core::HSTRING, windows_core::HSTRING>>> {
    ...
    pub fn Lookup(&self, key: &windows_core::HSTRING) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Split(&self, first: &mut Option<windows_collections::IMapView<windows_core::HSTRING, windows_core::HSTRING>>, second: &mut Option<windows_collections::IMapView<windows_core::HSTRING, windows_core::HSTRING>>) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).Split)(windows_core::Interface::as_raw(this), first as *mut _ as _, second as *mut _ as _).ok() }
    }
}
impl windows_core::RuntimeType for ResourceQualifierMapView {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_class::<Self, windows_collections::IMapView<windows_core::HSTRING, windows_core::HSTRING>>();
}
unsafe impl windows_core::Interface for ResourceQualifierMapView {
    type Vtable = <windows_collections::IMapView<windows_core::HSTRING, windows_core::HSTRING> as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID = <windows_collections::IMapView<windows_core::HSTRING, windows_core::HSTRING> as windows_core::Interface>::IID;
}
...
impl ResourceQualifierObservableMap {
    ...
    pub fn GetView(&self) -> windows_result::Result<windows_collections::IMapView<windows_core::HSTRING, windows_core::HSTRING>> {
        let this = &windows_core::Interface::cast::<windows_collections::IMap<windows_core::HSTRING, windows_core::HSTRING>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Insert(&self, key: &windows_core::HSTRING, value: &windows_core::HSTRING) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<windows_collections::IMap<windows_core::HSTRING, windows_core::HSTRING>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ResourceQualifierVectorView {
    pub fn First(&self) -> windows_result::Result<windows_collections::IIterator<ResourceQualifier>> {
    ...
    pub fn GetAt(&self, index: u32) -> windows_result::Result<ResourceQualifier> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAt)(windows_core::Interface::as_raw(this), index, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetMany(&self, startindex: u32, items: &mut [Option<ResourceQualifier>]) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetMany)(windows_core::Interface::as_raw(this), startindex, items.len().try_into().unwrap(), core::mem::transmute_copy(&items), &mut result__).map(|| result__)
...
impl windows_core::RuntimeType for ResourceQualifierVectorView {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_class::<Self, windows_collections::IVectorView<ResourceQualifier>>();
}
unsafe impl windows_core::Interface for ResourceQualifierVectorView {
    type Vtable = <windows_collections::IVectorView<ResourceQualifier> as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID = <windows_collections::IVectorView<ResourceQualifier> as windows_core::Interface>::IID;
}
