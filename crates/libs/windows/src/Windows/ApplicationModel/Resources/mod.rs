...
impl ResourceLoader {
    ...
    pub fn GetString(&self, resource: &windows_core::HSTRING) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn GetStringForUri<P0>(&self, uri: P0) -> Result<windows_core::HSTRING, windows_result::HRESULT>
    where
    ...
    pub fn CreateResourceLoaderByName(name: &windows_core::HSTRING) -> Result<ResourceLoader, windows_result::HRESULT> {
    ...
    pub fn GetStringForReference<P0>(uri: P0) -> Result<windows_core::HSTRING, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
    ...
    pub fn GetForCurrentView() -> Result<ResourceLoader, windows_result::HRESULT> {
        Self::IResourceLoaderStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForCurrentView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn GetForCurrentViewWithName(name: &windows_core::HSTRING) -> Result<ResourceLoader, windows_result::HRESULT> {
        Self::IResourceLoaderStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetForViewIndependentUse() -> Result<ResourceLoader, windows_result::HRESULT> {
        Self::IResourceLoaderStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetForViewIndependentUseWithName(name: &windows_core::HSTRING) -> Result<ResourceLoader, windows_result::HRESULT> {
        Self::IResourceLoaderStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI")]
    pub fn GetForUIContext<P0>(context: P0) -> Result<ResourceLoader, windows_result::HRESULT>
    where
    ...
    pub fn GetDefaultPriPath(packagefullname: &windows_core::HSTRING) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    fn IResourceLoaderFactory<R, F: FnOnce(&IResourceLoaderFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<ResourceLoader, IResourceLoaderFactory> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IResourceLoaderStatics<R, F: FnOnce(&IResourceLoaderStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<ResourceLoader, IResourceLoaderStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IResourceLoaderStatics2<R, F: FnOnce(&IResourceLoaderStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<ResourceLoader, IResourceLoaderStatics2> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IResourceLoaderStatics3<R, F: FnOnce(&IResourceLoaderStatics3) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<ResourceLoader, IResourceLoaderStatics3> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IResourceLoaderStatics4<R, F: FnOnce(&IResourceLoaderStatics4) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
