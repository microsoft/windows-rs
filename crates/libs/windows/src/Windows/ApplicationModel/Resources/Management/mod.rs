...
impl IndexedResourceCandidate {
    pub fn Type(&self) -> Result<IndexedResourceType, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn Metadata(&self) -> Result<windows_collections::IMapView<windows_core::HSTRING, windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Qualifiers(&self) -> Result<windows_collections::IVectorView<IndexedResourceQualifier>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ResourceIndexer {
    pub fn IndexFilePath<P0>(&self, filepath: P0) -> Result<IndexedResourceCandidate, windows_result::HRESULT>
    where
    ...
    pub fn IndexFileContentsAsync<P0>(&self, file: P0) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<IndexedResourceCandidate>>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn CreateResourceIndexer<P0>(projectroot: P0) -> Result<ResourceIndexer, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Foundation::Uri>,
    {
    ...
    pub fn CreateResourceIndexerWithExtension<P0, P1>(projectroot: P0, extensiondllpath: P1) -> Result<ResourceIndexer, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Foundation::Uri>,
    ...
    fn IResourceIndexerFactory<R, F: FnOnce(&IResourceIndexerFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IResourceIndexerFactory2<R, F: FnOnce(&IResourceIndexerFactory2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
