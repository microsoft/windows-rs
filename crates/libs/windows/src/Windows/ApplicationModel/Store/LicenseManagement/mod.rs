...
impl LicenseManager {
    ...
    #[cfg(feature = "Foundation")]
    pub fn RefreshLicensesAsync<'a, P0>(refreshoption: P0) -> ::windows::core::Result<super::super::super::Foundation::IAsyncAction>
    where
        P0: ::std::convert::Into<LicenseRefreshOption>,
    {
