...
impl UserDataTaskDataProviderConnection {
    pub fn CreateOrUpdateTaskRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveCreateOrUpdateTaskRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SkipOccurrenceRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveSkipOccurrenceRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveSkipOccurrenceRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn CompleteTaskRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveCompleteTaskRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveCompleteTaskRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn DeleteTaskRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveDeleteTaskRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
...
impl UserDataTaskDataProviderTriggerDetails {
    pub fn Connection(&self) -> windows_result::Result<UserDataTaskDataProviderConnection> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UserDataTaskListCompleteTaskRequest {
    pub fn TaskListId(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReportCompletedAsync(&self, completedtaskid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UserDataTaskListCompleteTaskRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<UserDataTaskListCompleteTaskRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UserDataTaskListCreateOrUpdateTaskRequest {
    ...
    pub fn Task(&self) -> windows_result::Result<super::UserDataTask> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReportCompletedAsync<P0>(&self, createdorupdateduserdatatask: P0) -> windows_result::Result<windows_future::IAsyncAction>
    where
...
impl UserDataTaskListCreateOrUpdateTaskRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<UserDataTaskListCreateOrUpdateTaskRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl UserDataTaskListDeleteTaskRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<UserDataTaskListDeleteTaskRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl UserDataTaskListSkipOccurrenceRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<UserDataTaskListSkipOccurrenceRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl UserDataTaskListSyncManagerSyncRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<UserDataTaskListSyncManagerSyncRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
