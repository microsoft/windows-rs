...
impl EmailMailboxCreateFolderRequest {
    ...
    pub fn ReportCompletedAsync<P0>(&self, folder: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    pub fn ReportFailedAsync(&self, status: super::EmailMailboxCreateFolderStatus) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl EmailMailboxDeleteFolderRequest {
    ...
    pub fn ReportFailedAsync(&self, status: super::EmailMailboxDeleteFolderStatus) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReportFailedAsync)(windows_core::Interface::as_raw(this), status, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl EmailMailboxEmptyFolderRequest {
    ...
    pub fn ReportFailedAsync(&self, status: super::EmailMailboxEmptyFolderStatus) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReportFailedAsync)(windows_core::Interface::as_raw(this), status, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl EmailMailboxGetAutoReplySettingsRequest {
    ...
    pub fn ReportCompletedAsync<P0>(&self, autoreplysettings: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
...
impl EmailMailboxResolveRecipientsRequest {
    ...
    pub fn ReportCompletedAsync<P0>(&self, resolutionresults: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
...
impl EmailMailboxServerSearchReadBatchRequest {
    ...
    pub fn SaveMessageAsync<P0>(&self, message: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    pub fn ReportFailedAsync(&self, batchstatus: super::EmailBatchStatus) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl EmailMailboxValidateCertificatesRequest {
    ...
    pub fn ReportCompletedAsync<P0>(&self, validationstatuses: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
