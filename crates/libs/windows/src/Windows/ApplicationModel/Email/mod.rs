...
windows_core::imp::required_hierarchy!(EmailAttachment, IEmailAttachment, IEmailAttachment2, IEmailAttachmentFactory, IEmailAttachmentFactory2);
...
windows_core::imp::required_hierarchy!(EmailConversation, IEmailConversation);
...
windows_core::imp::required_hierarchy!(EmailConversationBatch, IEmailConversationBatch);
...
windows_core::imp::required_hierarchy!(EmailConversationReader, IEmailConversationReader);
...
windows_core::imp::required_hierarchy!(EmailFolder, IEmailFolder);
impl EmailFolder {
    pub fn Id(&self) -> windows_core::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
...
windows_core::imp::required_hierarchy!(EmailIrmInfo, IEmailIrmInfo, IEmailIrmInfoFactory);
impl EmailIrmInfo {
    pub fn new() -> windows_core::Result<Self> {
        Self::IActivationFactory(|f| f.ActivateInstance::<Self>())
    }
...
windows_core::imp::required_hierarchy!(EmailIrmTemplate, IEmailIrmTemplate, IEmailIrmTemplateFactory);
...
windows_core::imp::required_hierarchy!(EmailItemCounts, IEmailItemCounts);
...
windows_core::imp::required_hierarchy!(EmailMailbox, IEmailMailbox, IEmailMailbox2, IEmailMailbox3, IEmailMailbox4, IEmailMailbox5);
impl EmailMailbox {
    pub fn Capabilities(&self) -> windows_core::Result<EmailMailboxCapabilities> {
        let this = &windows_core::Interface::cast::<IEmailMailbox>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
windows_core::imp::required_hierarchy!(EmailMailboxAction, IEmailMailboxAction);
...
windows_core::imp::required_hierarchy!(EmailMailboxAutoReply, IEmailMailboxAutoReply);
...
windows_core::imp::required_hierarchy!(EmailMailboxAutoReplySettings, IEmailMailboxAutoReplySettings);
...
windows_core::imp::required_hierarchy!(EmailMailboxCapabilities, IEmailMailboxCapabilities, IEmailMailboxCapabilities2, IEmailMailboxCapabilities3);
...
windows_core::imp::required_hierarchy!(EmailMailboxChange, IEmailMailboxChange);
...
windows_core::imp::required_hierarchy!(EmailMailboxChangeReader, IEmailMailboxChangeReader);
...
windows_core::imp::required_hierarchy!(EmailMailboxChangeTracker, IEmailMailboxChangeTracker);
...
windows_core::imp::required_hierarchy!(EmailMailboxChangedDeferral, IEmailMailboxChangedDeferral);
...
windows_core::imp::required_hierarchy!(EmailMailboxChangedEventArgs, IEmailMailboxChangedEventArgs);
...
windows_core::imp::required_hierarchy!(EmailMailboxCreateFolderResult, IEmailMailboxCreateFolderResult);
...
windows_core::imp::required_hierarchy!(EmailMailboxPolicies, IEmailMailboxPolicies, IEmailMailboxPolicies2, IEmailMailboxPolicies3);
...
windows_core::imp::required_hierarchy!(EmailMailboxSyncManager, IEmailMailboxSyncManager, IEmailMailboxSyncManager2);
...
windows_core::imp::required_hierarchy!(EmailManagerForUser, IEmailManagerForUser);
...
windows_core::imp::required_hierarchy!(EmailMeetingInfo, IEmailMeetingInfo, IEmailMeetingInfo2);
...
windows_core::imp::required_hierarchy!(EmailMessage, IEmailMessage, IEmailMessage2, IEmailMessage3, IEmailMessage4);
impl EmailMessage {
    pub fn new() -> windows_core::Result<Self> {
        Self::IActivationFactory(|f| f.ActivateInstance::<Self>())
    }
...
windows_core::imp::required_hierarchy!(EmailMessageBatch, IEmailMessageBatch);
...
windows_core::imp::required_hierarchy!(EmailMessageReader, IEmailMessageReader);
...
windows_core::imp::required_hierarchy!(EmailQueryOptions, IEmailQueryOptions, IEmailQueryOptionsFactory);
...
windows_core::imp::required_hierarchy!(EmailQueryTextSearch, IEmailQueryTextSearch);
...
windows_core::imp::required_hierarchy!(EmailRecipient, IEmailRecipient, IEmailRecipientFactory);
impl EmailRecipient {
    pub fn new() -> windows_core::Result<Self> {
        Self::IActivationFactory(|f| f.ActivateInstance::<Self>())
    }
...
windows_core::imp::required_hierarchy!(EmailRecipientResolutionResult, IEmailRecipientResolutionResult, IEmailRecipientResolutionResult2);
...
windows_core::imp::required_hierarchy!(EmailStore, IEmailStore);
impl EmailStore {
    #[cfg(feature = "Foundation_Collections")]
...
windows_core::imp::required_hierarchy!(EmailStoreNotificationTriggerDetails, IEmailStoreNotificationTriggerDetails);
