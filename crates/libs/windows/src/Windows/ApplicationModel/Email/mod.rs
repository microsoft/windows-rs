...
impl EmailAttachment {
    ...
    pub fn SetFileName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Data(&self) -> Result<super::super::Storage::Streams::IRandomAccessStreamReference, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ContentId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailAttachment2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetContentId(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailAttachment2>(self)?;
    ...
    pub fn ContentLocation(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailAttachment2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetContentLocation(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailAttachment2>(self)?;
    ...
    pub fn DownloadState(&self) -> Result<EmailAttachmentDownloadState, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailAttachment2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDownloadState(&self, value: EmailAttachmentDownloadState) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailAttachment2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetDownloadState)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn EstimatedDownloadSizeInBytes(&self) -> Result<u64, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailAttachment2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetEstimatedDownloadSizeInBytes(&self, value: u64) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailAttachment2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetEstimatedDownloadSizeInBytes)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsFromBaseMessage(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailAttachment2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsInline(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailAttachment2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsInline(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailAttachment2>(self)?;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Create<P1>(filename: &windows_core::HSTRING, data: P1) -> Result<EmailAttachment, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Create2<P1>(filename: &windows_core::HSTRING, data: P1, mimetype: &windows_core::HSTRING) -> Result<EmailAttachment, windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
    {
    ...
    fn IEmailAttachmentFactory<R, F: FnOnce(&IEmailAttachmentFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<EmailAttachment, IEmailAttachmentFactory> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IEmailAttachmentFactory2<R, F: FnOnce(&IEmailAttachmentFactory2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl EmailConversation {
    ...
    pub fn MailboxId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FlagState(&self) -> Result<EmailFlagState, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HasAttachment(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Importance(&self) -> Result<EmailImportance, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LastEmailResponseKind(&self) -> Result<EmailMessageResponseKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MessageCount(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MostRecentMessageTime(&self) -> Result<super::super::Foundation::DateTime, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Preview(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LatestSender(&self) -> Result<EmailRecipient, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UnreadMessageCount(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindMessagesAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<EmailMessage>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindMessagesWithCountAsync(&self, count: u32) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<EmailMessage>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl EmailConversationBatch {
    pub fn Conversations(&self) -> Result<windows_collections::IVectorView<EmailConversation>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Status(&self) -> Result<EmailBatchStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl EmailConversationReader {
    pub fn ReadBatchAsync(&self) -> Result<windows_future::IAsyncOperation<EmailConversationBatch>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl EmailFolder {
    ...
    pub fn Kind(&self) -> Result<EmailSpecialFolderKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateFolderAsync(&self, name: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<EmailFolder>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindChildFoldersAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<EmailFolder>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetConversationReader(&self) -> Result<EmailConversationReader, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetConversationReaderWithOptions<P0>(&self, options: P0) -> Result<EmailConversationReader, windows_result::HRESULT>
    where
    ...
    pub fn GetMessageAsync(&self, id: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<EmailMessage>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMessageReader(&self) -> Result<EmailMessageReader, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMessageReaderWithOptions<P0>(&self, options: P0) -> Result<EmailMessageReader, windows_result::HRESULT>
    where
        P0: windows_core::Param<EmailQueryOptions>,
    {
        let this = self;
    ...
    pub fn GetMessageCountsAsync(&self) -> Result<windows_future::IAsyncOperation<EmailItemCounts>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryMoveAsync<P0>(&self, newparentfolder: P0) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
    ...
    pub fn TryMoveWithNewNameAsync<P0>(&self, newparentfolder: P0, newfoldername: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<EmailFolder>,
    {
        let this = self;
    ...
    pub fn TrySaveAsync(&self) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl EmailIrmInfo {
    ...
    pub fn CanEdit(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanEdit(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCanEdit)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CanExtractData(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanExtractData(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCanExtractData)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CanForward(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanForward(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCanForward)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CanModifyRecipientsOnResponse(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanModifyRecipientsOnResponse(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCanModifyRecipientsOnResponse)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CanPrintData(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanPrintData(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCanPrintData)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CanRemoveIrmOnResponse(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanRemoveIrmOnResponse(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCanRemoveIrmOnResponse)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CanReply(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanReply(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCanReply)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CanReplyAll(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanReplyAll(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCanReplyAll)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ExpirationDate(&self) -> Result<super::super::Foundation::DateTime, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetExpirationDate(&self, value: super::super::Foundation::DateTime) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetExpirationDate)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsIrmOriginator(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsIrmOriginator(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsIrmOriginator)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsProgramaticAccessAllowed(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsProgramaticAccessAllowed(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsProgramaticAccessAllowed)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Template(&self) -> Result<EmailIrmTemplate, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTemplate<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn Create<P1>(expiration: super::super::Foundation::DateTime, irmtemplate: P1) -> Result<EmailIrmInfo, windows_result::HRESULT>
    where
    ...
    fn IEmailIrmInfoFactory<R, F: FnOnce(&IEmailIrmInfoFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl EmailIrmTemplate {
    ...
    pub fn Create(id: &windows_core::HSTRING, name: &windows_core::HSTRING, description: &windows_core::HSTRING) -> Result<EmailIrmTemplate, windows_result::HRESULT> {
    ...
    fn IEmailIrmTemplateFactory<R, F: FnOnce(&IEmailIrmTemplateFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl EmailItemCounts {
    pub fn Flagged(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Important(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Total(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Unread(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl EmailMailbox {
    pub fn Capabilities(&self) -> Result<EmailMailboxCapabilities, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ChangeTracker(&self) -> Result<EmailMailboxChangeTracker, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsOwnedByCurrentApp(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsDataEncryptedUnderLock(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MailAddress(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMailAddress(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn MailAddressAliases(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OtherAppReadAccess(&self) -> Result<EmailMailboxOtherAppReadAccess, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOtherAppReadAccess(&self, value: EmailMailboxOtherAppReadAccess) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetOtherAppReadAccess)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn OtherAppWriteAccess(&self) -> Result<EmailMailboxOtherAppWriteAccess, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOtherAppWriteAccess(&self, value: EmailMailboxOtherAppWriteAccess) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetOtherAppWriteAccess)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Policies(&self) -> Result<EmailMailboxPolicies, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SyncManager(&self) -> Result<EmailMailboxSyncManager, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetConversationAsync(&self, id: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<EmailConversation>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetFolderAsync(&self, id: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<EmailFolder>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetSpecialFolderAsync(&self, foldertype: EmailSpecialFolderKind) -> Result<windows_future::IAsyncOperation<EmailFolder>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MarkMessageAsSeenAsync(&self, messageid: &windows_core::HSTRING) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MarkFolderAsSeenAsync(&self, folderid: &windows_core::HSTRING) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MarkMessageReadAsync(&self, messageid: &windows_core::HSTRING, isread: bool) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ChangeMessageFlagStateAsync(&self, messageid: &windows_core::HSTRING, flagstate: EmailFlagState) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryMoveMessageAsync(&self, messageid: &windows_core::HSTRING, newparentfolderid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryMoveFolderAsync(&self, folderid: &windows_core::HSTRING, newparentfolderid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryMoveFolderWithNewNameAsync(&self, folderid: &windows_core::HSTRING, newparentfolderid: &windows_core::HSTRING, newfoldername: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeleteMessageAsync(&self, messageid: &windows_core::HSTRING) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MarkFolderSyncEnabledAsync(&self, folderid: &windows_core::HSTRING, issyncenabled: bool) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SendMessageAsync<P0>(&self, message: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<EmailMessage>,
    {
        let this = self;
    ...
    pub fn SaveDraftAsync<P0>(&self, message: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<EmailMessage>,
    {
        let this = self;
    ...
    pub fn DownloadMessageAsync(&self, messageid: &windows_core::HSTRING) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DownloadAttachmentAsync(&self, attachmentid: &windows_core::HSTRING) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateResponseMessageAsync(&self, messageid: &windows_core::HSTRING, responsetype: EmailMessageResponseKind, subject: &windows_core::HSTRING, responseheadertype: EmailMessageBodyKind, responseheader: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<EmailMessage>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryUpdateMeetingResponseAsync<P0>(&self, meeting: P0, response: EmailMeetingResponseType, subject: &windows_core::HSTRING, comment: &windows_core::HSTRING, sendupdate: bool) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<EmailMessage>,
    {
        let this = self;
    ...
    pub fn TryForwardMeetingAsync<P0, P1>(&self, meeting: P0, recipients: P1, subject: &windows_core::HSTRING, forwardheadertype: EmailMessageBodyKind, forwardheader: &windows_core::HSTRING, comment: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<EmailMessage>,
    ...
    pub fn MailboxChanged<P0>(&self, phandler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveMailboxChanged(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveMailboxChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn SmartSendMessageAsync<P0>(&self, message: P0, smartsend: bool) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<EmailMessage>,
    {
        let this = self;
    ...
    pub fn TrySetAutoReplySettingsAsync<P0>(&self, autoreplysettings: P0) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
    ...
    pub fn TryGetAutoReplySettingsAsync(&self, requestedformat: EmailMailboxAutoReplyMessageResponseKind) -> Result<windows_future::IAsyncOperation<EmailMailboxAutoReplySettings>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LinkedMailboxId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn NetworkId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMailbox2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ResolveRecipientsAsync<P0>(&self, recipients: P0) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<EmailRecipientResolutionResult>>, windows_result::HRESULT>
    where
    ...
    pub fn ValidateCertificatesAsync<P0>(&self, certificates: P0) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<EmailCertificateValidationStatus>>, windows_result::HRESULT>
    where
    ...
    pub fn TryEmptyFolderAsync(&self, folderid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<EmailMailboxEmptyFolderStatus>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMailbox3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryCreateFolderAsync(&self, parentfolderid: &windows_core::HSTRING, name: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<EmailMailboxCreateFolderResult>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMailbox3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryDeleteFolderAsync(&self, folderid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<EmailMailboxDeleteFolderStatus>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMailbox3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetChangeTracker(&self, identity: &windows_core::HSTRING) -> Result<EmailMailboxChangeTracker, windows_result::HRESULT> {
...
impl EmailMailboxAction {
    pub fn Kind(&self) -> Result<EmailMailboxActionKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Kind)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl EmailMailboxAutoReply {
    ...
    pub fn Response(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetResponse(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl EmailMailboxAutoReplySettings {
    ...
    pub fn ResponseKind(&self) -> Result<EmailMailboxAutoReplyMessageResponseKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetResponseKind(&self, value: EmailMailboxAutoReplyMessageResponseKind) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn InternalReply(&self) -> Result<EmailMailboxAutoReply, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn KnownExternalReply(&self) -> Result<EmailMailboxAutoReply, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UnknownExternalReply(&self) -> Result<EmailMailboxAutoReply, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl EmailMailboxCapabilities {
    ...
    pub fn CanGetAndSetExternalAutoReplies(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanGetAndSetInternalAutoReplies(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanServerSearchFolders(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanServerSearchMailbox(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanSmartSend(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanResolveRecipients(&self) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn CanValidateCertificates(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMailboxCapabilities2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanEmptyFolder(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMailboxCapabilities2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanCreateFolder(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMailboxCapabilities2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanDeleteFolder(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMailboxCapabilities2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanMoveFolder(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMailboxCapabilities2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanGetAndSetExternalAutoReplies(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMailboxCapabilities3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetCanGetAndSetExternalAutoReplies)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SetCanGetAndSetInternalAutoReplies(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMailboxCapabilities3>(self)?;
    ...
    pub fn SetCanServerSearchFolders(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMailboxCapabilities3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetCanServerSearchFolders)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SetCanServerSearchMailbox(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMailboxCapabilities3>(self)?;
...
impl EmailMailboxChange {
    pub fn ChangeType(&self) -> Result<EmailMailboxChangeType, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MailboxActions(&self) -> Result<windows_collections::IVector<EmailMailboxAction>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Message(&self) -> Result<EmailMessage, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Folder(&self) -> Result<EmailFolder, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl EmailMailboxChangeReader {
    ...
    pub fn ReadBatchAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<EmailMailboxChange>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReadBatchAsync)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl EmailMailboxChangeTracker {
    ...
    pub fn GetChangeReader(&self) -> Result<EmailMailboxChangeReader, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl EmailMailboxChangedEventArgs {
    pub fn GetDeferral(&self) -> Result<EmailMailboxChangedDeferral, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl EmailMailboxCreateFolderResult {
    pub fn Status(&self) -> Result<EmailMailboxCreateFolderStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl EmailMailboxPolicies {
    pub fn AllowedSmimeEncryptionAlgorithmNegotiation(&self) -> Result<EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AllowSmimeSoftCertificates(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequiredSmimeEncryptionAlgorithm(&self) -> Result<super::super::Foundation::IReference<EmailMailboxSmimeEncryptionAlgorithm>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequiredSmimeSigningAlgorithm(&self) -> Result<super::super::Foundation::IReference<EmailMailboxSmimeSigningAlgorithm>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MustEncryptSmimeMessages(&self) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn MustSignSmimeMessages(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMailboxPolicies2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAllowedSmimeEncryptionAlgorithmNegotiation(&self, value: EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn SetAllowSmimeSoftCertificates(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMailboxPolicies3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetAllowSmimeSoftCertificates)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SetRequiredSmimeEncryptionAlgorithm<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn SetRequiredSmimeSigningAlgorithm<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn SetMustEncryptSmimeMessages(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMailboxPolicies3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetMustEncryptSmimeMessages)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SetMustSignSmimeMessages(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMailboxPolicies3>(self)?;
...
impl EmailMailboxSyncManager {
    pub fn Status(&self) -> Result<EmailMailboxSyncStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn SetStatus(&self, value: EmailMailboxSyncStatus) -> Result<(), windows_result::HRESULT> {
...
impl EmailManager {
    pub fn ShowComposeNewEmailAsync<P0>(message: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<EmailMessage>,
    {
    ...
    pub fn RequestStoreAsync(accesstype: EmailStoreAccessType) -> Result<windows_future::IAsyncOperation<EmailStore>, windows_result::HRESULT> {
    ...
    #[cfg(feature = "System")]
    pub fn GetForUser<P0>(user: P0) -> Result<EmailManagerForUser, windows_result::HRESULT>
    where
    ...
    fn IEmailManagerStatics<R, F: FnOnce(&IEmailManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<EmailManager, IEmailManagerStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IEmailManagerStatics2<R, F: FnOnce(&IEmailManagerStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<EmailManager, IEmailManagerStatics2> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IEmailManagerStatics3<R, F: FnOnce(&IEmailManagerStatics3) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl EmailManagerForUser {
    pub fn ShowComposeNewEmailAsync<P0>(&self, message: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<EmailMessage>,
    {
        let this = self;
    ...
    pub fn RequestStoreAsync(&self, accesstype: EmailStoreAccessType) -> Result<windows_future::IAsyncOperation<EmailStore>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestStoreAsync)(windows_core::Interface::as_raw(this), accesstype, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl EmailMeetingInfo {
    ...
    pub fn AppointmentRoamingId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAppointmentRoamingId(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn AppointmentOriginalStartTime(&self) -> Result<super::super::Foundation::IReference<super::super::Foundation::DateTime>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAppointmentOriginalStartTime<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::super::Foundation::DateTime>>,
    {
        let this = self;
    ...
    pub fn IsAllDay(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsAllDay(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn ProposedStartTime(&self) -> Result<super::super::Foundation::IReference<super::super::Foundation::DateTime>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetProposedStartTime<P0>(&self, proposedstarttime: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::super::Foundation::DateTime>>,
    {
        let this = self;
    ...
    pub fn ProposedDuration(&self) -> Result<super::super::Foundation::IReference<super::super::Foundation::TimeSpan>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetProposedDuration<P0>(&self, duration: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn RecurrenceStartTime(&self) -> Result<super::super::Foundation::IReference<super::super::Foundation::DateTime>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRecurrenceStartTime<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::super::Foundation::DateTime>>,
    {
        let this = self;
    ...
    pub fn Recurrence(&self) -> Result<super::Appointments::AppointmentRecurrence, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsReportedOutOfDateByServer(&self) -> Result<bool, windows_result::HRESULT> {
...
impl EmailMessage {
    ...
    pub fn To(&self) -> Result<windows_collections::IVector<EmailRecipient>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CC(&self) -> Result<windows_collections::IVector<EmailRecipient>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Bcc(&self) -> Result<windows_collections::IVector<EmailRecipient>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Attachments(&self) -> Result<windows_collections::IVector<EmailAttachment>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FolderId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AllowInternetImages(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAllowInternetImages(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
    ...
    pub fn DownloadState(&self) -> Result<EmailMessageDownloadState, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DownloadState)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn SetDownloadState(&self, value: EmailMessageDownloadState) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetDownloadState)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn EstimatedDownloadSizeInBytes(&self) -> Result<u32, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).EstimatedDownloadSizeInBytes)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn SetEstimatedDownloadSizeInBytes(&self, value: u32) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetEstimatedDownloadSizeInBytes)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn FlagState(&self) -> Result<EmailFlagState, windows_result::HRESULT> {
    ...
    pub fn SetFlagState(&self, value: EmailFlagState) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetFlagState)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn HasPartialBodies(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetImportance(&self, value: EmailImportance) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetImportance)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn InResponseToMessageId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IrmInfo(&self) -> Result<EmailIrmInfo, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIrmInfo<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn IsDraftMessage(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsServerSearchMessage(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsSmartSendable(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MessageClass(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMessageClass(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
    ...
    pub fn NormalizedSubject(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OriginalCodePage(&self) -> Result<i32, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOriginalCodePage(&self, value: i32) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
    ...
    pub fn SetPreview(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetPreview)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(value)).ok() }
    }
    pub fn LastResponseKind(&self) -> Result<EmailMessageResponseKind, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetLastResponseKind(&self, value: EmailMessageResponseKind) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetLastResponseKind)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Sender(&self) -> Result<EmailRecipient, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSender<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn SentTime(&self) -> Result<super::super::Foundation::IReference<super::super::Foundation::DateTime>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSentTime<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::super::Foundation::DateTime>>,
    {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
    ...
    pub fn MeetingInfo(&self) -> Result<EmailMeetingInfo, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMeetingInfo<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetBodyStream(&self, r#type: EmailMessageBodyKind) -> Result<super::super::Storage::Streams::IRandomAccessStreamReference, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetBodyStream<P1>(&self, r#type: EmailMessageBodyKind, stream: P1) -> Result<(), windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
    {
        let this = &windows_core::Interface::cast::<IEmailMessage2>(self)?;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SmimeData(&self) -> Result<super::super::Storage::Streams::IRandomAccessStreamReference, windows_result::HRESULT> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetSmimeData<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
    {
        let this = &windows_core::Interface::cast::<IEmailMessage3>(self)?;
    ...
    pub fn SmimeKind(&self) -> Result<EmailMessageSmimeKind, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSmimeKind(&self, value: EmailMessageSmimeKind) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetSmimeKind)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ReplyTo(&self) -> Result<windows_collections::IVector<EmailRecipient>, windows_result::HRESULT> {
    ...
    pub fn SentRepresenting(&self) -> Result<EmailRecipient, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailMessage4>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSentRepresenting<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<EmailRecipient>,
    {
        let this = &windows_core::Interface::cast::<IEmailMessage4>(self)?;
...
impl EmailMessageBatch {
    pub fn Messages(&self) -> Result<windows_collections::IVectorView<EmailMessage>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl EmailMessageReader {
    pub fn ReadBatchAsync(&self) -> Result<windows_future::IAsyncOperation<EmailMessageBatch>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReadBatchAsync)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl EmailQueryOptions {
    ...
    pub fn TextSearch(&self) -> Result<EmailQueryTextSearch, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SortDirection(&self) -> Result<EmailQuerySortDirection, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSortDirection(&self, value: EmailQuerySortDirection) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSortDirection)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SortProperty(&self) -> Result<EmailQuerySortProperty, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSortProperty(&self, value: EmailQuerySortProperty) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSortProperty)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Kind(&self) -> Result<EmailQueryKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Kind)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn SetKind(&self, value: EmailQueryKind) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetKind)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn FolderIds(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateWithText(text: &windows_core::HSTRING) -> Result<EmailQueryOptions, windows_result::HRESULT> {
    ...
    pub fn CreateWithTextAndFields(text: &windows_core::HSTRING, fields: EmailQuerySearchFields) -> Result<EmailQueryOptions, windows_result::HRESULT> {
        Self::IEmailQueryOptionsFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IEmailQueryOptionsFactory<R, F: FnOnce(&IEmailQueryOptionsFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl EmailQueryTextSearch {
    pub fn Fields(&self) -> Result<EmailQuerySearchFields, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetFields(&self, value: EmailQuerySearchFields) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetFields)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SearchScope(&self) -> Result<EmailQuerySearchScope, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSearchScope(&self, value: EmailQuerySearchScope) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl EmailRecipient {
    ...
    pub fn Create(address: &windows_core::HSTRING) -> Result<EmailRecipient, windows_result::HRESULT> {
    ...
    pub fn CreateWithName(address: &windows_core::HSTRING, name: &windows_core::HSTRING) -> Result<EmailRecipient, windows_result::HRESULT> {
        Self::IEmailRecipientFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IEmailRecipientFactory<R, F: FnOnce(&IEmailRecipientFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl EmailRecipientResolutionResult {
    ...
    pub fn Status(&self) -> Result<EmailRecipientResolutionStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    #[cfg(feature = "Security_Cryptography_Certificates")]
    pub fn PublicKeys(&self) -> Result<windows_collections::IVectorView<super::super::Security::Cryptography::Certificates::Certificate>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetStatus(&self, value: EmailRecipientResolutionStatus) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IEmailRecipientResolutionResult2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetStatus)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Security_Cryptography_Certificates")]
    pub fn SetPublicKeys<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IIterable<super::super::Security::Cryptography::Certificates::Certificate>>,
    {
        let this = &windows_core::Interface::cast::<IEmailRecipientResolutionResult2>(self)?;
...
impl EmailStore {
    pub fn FindMailboxesAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<EmailMailbox>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMailboxAsync(&self, id: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<EmailMailbox>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateMailboxAsync(&self, accountname: &windows_core::HSTRING, accountaddress: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<EmailMailbox>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateMailboxInAccountAsync(&self, accountname: &windows_core::HSTRING, accountaddress: &windows_core::HSTRING, userdataaccountid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<EmailMailbox>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
