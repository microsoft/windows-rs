...
impl EmailAttachment {
    ...
    pub fn DownloadState(&self) -> ::windows_core::Result<EmailAttachmentDownloadState> {
        let this = &::windows_core::ComInterface::cast::<IEmailAttachment2>(self)?;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailAttachmentDownloadState>();
        ...
        P0: ::windows_core::TryIntoParam<super::super::Storage::Streams::IRandomAccessStreamReference>,
    {
        Self::IEmailAttachmentFactory(|this| unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailAttachment>();
...
impl EmailConversation {
    ...
    pub fn FlagState(&self) -> ::windows_core::Result<EmailFlagState> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailFlagState>();
    ...
    pub fn Importance(&self) -> ::windows_core::Result<EmailImportance> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailImportance>();
    ...
    pub fn LastEmailResponseKind(&self) -> ::windows_core::Result<EmailMessageResponseKind> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMessageResponseKind>();
    ...
    pub fn LatestSender(&self) -> ::windows_core::Result<EmailRecipient> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailRecipient>();
    ...
    pub fn FindMessagesAsync(&self) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<EmailMessage>>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<EmailMessage>>>();
...
impl EmailConversationBatch {
    ...
    pub fn Conversations(&self) -> ::windows_core::Result<super::super::Foundation::Collections::IVectorView<EmailConversation>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::Collections::IVectorView<EmailConversation>>();
    ...
    pub fn Status(&self) -> ::windows_core::Result<EmailBatchStatus> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailBatchStatus>();
...
impl EmailConversationReader {
    ...
    pub fn ReadBatchAsync(&self) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<EmailConversationBatch>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<EmailConversationBatch>>();
...
impl EmailFolder {
    ...
    pub fn Kind(&self) -> ::windows_core::Result<EmailSpecialFolderKind> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailSpecialFolderKind>();
    ...
    pub fn CreateFolderAsync(&self, name: &::windows_core::HSTRING) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<EmailFolder>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<EmailFolder>>();
    ...
    pub fn FindChildFoldersAsync(&self) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<EmailFolder>>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<EmailFolder>>>();
    ...
    pub fn GetConversationReader(&self) -> ::windows_core::Result<EmailConversationReader> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailConversationReader>();
    ...
    pub fn GetConversationReaderWithOptions(&self, options: &EmailQueryOptions) -> ::windows_core::Result<EmailConversationReader> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailConversationReader>();
            (::windows_core::Interface::vtable(this).GetConversationReaderWithOptions)(::windows_core::Interface::as_raw(this), ::core::mem::transmute_copy(options), &mut result__).from_abi(result__)
        }
    }
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn GetMessageAsync(&self, id: &::windows_core::HSTRING) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<EmailMessage>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<EmailMessage>>();
    ...
    pub fn GetMessageReader(&self) -> ::windows_core::Result<EmailMessageReader> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMessageReader>();
            (::windows_core::Interface::vtable(this).GetMessageReader)(::windows_core::Interface::as_raw(this), &mut result__).from_abi(result__)
        }
    }
    pub fn GetMessageReaderWithOptions(&self, options: &EmailQueryOptions) -> ::windows_core::Result<EmailMessageReader> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMessageReader>();
            (::windows_core::Interface::vtable(this).GetMessageReaderWithOptions)(::windows_core::Interface::as_raw(this), ::core::mem::transmute_copy(options), &mut result__).from_abi(result__)
        }
    }
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn GetMessageCountsAsync(&self) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<EmailItemCounts>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<EmailItemCounts>>();
    ...
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn TryMoveAsync(&self, newparentfolder: &EmailFolder) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<bool>>();
            (::windows_core::Interface::vtable(this).TryMoveAsync)(::windows_core::Interface::as_raw(this), ::core::mem::transmute_copy(newparentfolder), &mut result__).from_abi(result__)
        }
    }
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn TryMoveWithNewNameAsync(&self, newparentfolder: &EmailFolder, newfoldername: &::windows_core::HSTRING) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<bool>>();
            (::windows_core::Interface::vtable(this).TryMoveWithNewNameAsync)(::windows_core::Interface::as_raw(this), ::core::mem::transmute_copy(newparentfolder), ::core::mem::transmute_copy(newfoldername), &mut result__).from_abi(result__)
        }
    }
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    ...
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn SaveMessageAsync(&self, message: &EmailMessage) -> ::windows_core::Result<super::super::Foundation::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncAction>();
...
impl EmailIrmInfo {
    ...
    pub fn Template(&self) -> ::windows_core::Result<EmailIrmTemplate> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailIrmTemplate>();
            (::windows_core::Interface::vtable(this).Template)(::windows_core::Interface::as_raw(this), &mut result__).from_abi(result__)
        }
    }
    pub fn SetTemplate(&self, value: &EmailIrmTemplate) -> ::windows_core::Result<()> {
        let this = self;
    ...
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn Create(expiration: super::super::Foundation::DateTime, irmtemplate: &EmailIrmTemplate) -> ::windows_core::Result<EmailIrmInfo> {
        Self::IEmailIrmInfoFactory(|this| unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailIrmInfo>();
            (::windows_core::Interface::vtable(this).Create)(::windows_core::Interface::as_raw(this), expiration, ::core::mem::transmute_copy(irmtemplate), &mut result__).from_abi(result__)
        })
    }
    #[doc(hidden)]
...
impl EmailMailbox {
    pub fn Capabilities(&self) -> ::windows_core::Result<EmailMailboxCapabilities> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMailboxCapabilities>();
    ...
    pub fn ChangeTracker(&self) -> ::windows_core::Result<EmailMailboxChangeTracker> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMailboxChangeTracker>();
    ...
    pub fn OtherAppReadAccess(&self) -> ::windows_core::Result<EmailMailboxOtherAppReadAccess> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMailboxOtherAppReadAccess>();
    ...
    pub fn OtherAppWriteAccess(&self) -> ::windows_core::Result<EmailMailboxOtherAppWriteAccess> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMailboxOtherAppWriteAccess>();
    ...
    pub fn Policies(&self) -> ::windows_core::Result<EmailMailboxPolicies> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMailboxPolicies>();
    ...
    pub fn SyncManager(&self) -> ::windows_core::Result<EmailMailboxSyncManager> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMailboxSyncManager>();
    ...
    pub fn GetConversationAsync(&self, id: &::windows_core::HSTRING) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<EmailConversation>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<EmailConversation>>();
    ...
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn SendMessageAsync(&self, message: &EmailMessage) -> ::windows_core::Result<super::super::Foundation::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncAction>();
    ...
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn SaveDraftAsync(&self, message: &EmailMessage) -> ::windows_core::Result<super::super::Foundation::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncAction>();
            (::windows_core::Interface::vtable(this).SaveDraftAsync)(::windows_core::Interface::as_raw(this), ::core::mem::transmute_copy(message), &mut result__).from_abi(result__)
        }
    }
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    ...
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn TryUpdateMeetingResponseAsync(&self, meeting: &EmailMessage, response: EmailMeetingResponseType, subject: &::windows_core::HSTRING, comment: &::windows_core::HSTRING, sendupdate: bool) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<bool>>();
    ...
    #[doc = "*Required features: `\"Foundation_Collections\"`*"]
    #[cfg(feature = "Foundation_Collections")]
    pub fn TryForwardMeetingAsync<P0>(&self, meeting: &EmailMessage, recipients: P0, subject: &::windows_core::HSTRING, forwardheadertype: EmailMessageBodyKind, forwardheader: &::windows_core::HSTRING, comment: &::windows_core::HSTRING) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<bool>>
    where
        P0: ::windows_core::TryIntoParam<super::super::Foundation::Collections::IIterable<EmailRecipient>>,
    {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<bool>>();
            (::windows_core::Interface::vtable(this).TryForwardMeetingAsync)(::windows_core::Interface::as_raw(this), ::core::mem::transmute_copy(meeting), recipients.try_into_param()?.abi(), ::core::mem::transmute_copy(subject), forwardheadertype, ::core::mem::transmute_copy(forwardheader), ::core::mem::transmute_copy(comment), &mut result__).from_abi(result__)
        }
    }
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn TryProposeNewTimeForMeetingAsync(&self, meeting: &EmailMessage, newstarttime: super::super::Foundation::DateTime, newduration: super::super::Foundation::TimeSpan, subject: &::windows_core::HSTRING, comment: &::windows_core::HSTRING) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<bool>>();
    ...
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn MailboxChanged(&self, phandler: &super::super::Foundation::TypedEventHandler<EmailMailbox, EmailMailboxChangedEventArgs>) -> ::windows_core::Result<super::super::Foundation::EventRegistrationToken> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::EventRegistrationToken>();
            (::windows_core::Interface::vtable(this).MailboxChanged)(::windows_core::Interface::as_raw(this), ::core::mem::transmute_copy(phandler), &mut result__).from_abi(result__)
        }
    }
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    ...
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn SmartSendMessageAsync(&self, message: &EmailMessage, smartsend: bool) -> ::windows_core::Result<super::super::Foundation::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncAction>();
            (::windows_core::Interface::vtable(this).SmartSendMessageAsync)(::windows_core::Interface::as_raw(this), ::core::mem::transmute_copy(message), smartsend, &mut result__).from_abi(result__)
        }
    }
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn TrySetAutoReplySettingsAsync(&self, autoreplysettings: &EmailMailboxAutoReplySettings) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<bool>>();
            (::windows_core::Interface::vtable(this).TrySetAutoReplySettingsAsync)(::windows_core::Interface::as_raw(this), ::core::mem::transmute_copy(autoreplysettings), &mut result__).from_abi(result__)
        }
    }
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn TryGetAutoReplySettingsAsync(&self, requestedformat: EmailMailboxAutoReplyMessageResponseKind) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<EmailMailboxAutoReplySettings>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<EmailMailboxAutoReplySettings>>();
        ...
        P0: ::windows_core::TryIntoParam<super::super::Foundation::Collections::IIterable<::windows_core::HSTRING>>,
    {
        ...
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<EmailRecipientResolutionResult>>>();
        ...
        P0: ::windows_core::TryIntoParam<super::super::Foundation::Collections::IIterable<super::super::Security::Cryptography::Certificates::Certificate>>,
    {
        let this = &::windows_core::ComInterface::cast::<IEmailMailbox3>(self)?;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<EmailCertificateValidationStatus>>>();
    ...
    pub fn TryEmptyFolderAsync(&self, folderid: &::windows_core::HSTRING) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<EmailMailboxEmptyFolderStatus>> {
        let this = &::windows_core::ComInterface::cast::<IEmailMailbox3>(self)?;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<EmailMailboxEmptyFolderStatus>>();
    ...
    pub fn TryCreateFolderAsync(&self, parentfolderid: &::windows_core::HSTRING, name: &::windows_core::HSTRING) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<EmailMailboxCreateFolderResult>> {
        let this = &::windows_core::ComInterface::cast::<IEmailMailbox3>(self)?;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<EmailMailboxCreateFolderResult>>();
    ...
    pub fn TryDeleteFolderAsync(&self, folderid: &::windows_core::HSTRING) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<EmailMailboxDeleteFolderStatus>> {
        let this = &::windows_core::ComInterface::cast::<IEmailMailbox3>(self)?;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<EmailMailboxDeleteFolderStatus>>();
...
impl EmailMailboxAction {
    pub fn Kind(&self) -> ::windows_core::Result<EmailMailboxActionKind> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMailboxActionKind>();
            (::windows_core::Interface::vtable(this).Kind)(::windows_core::Interface::as_raw(this), &mut result__).from_abi(result__)
        }
    }
...
impl EmailMailboxAutoReplySettings {
    ...
    pub fn ResponseKind(&self) -> ::windows_core::Result<EmailMailboxAutoReplyMessageResponseKind> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMailboxAutoReplyMessageResponseKind>();
    ...
    pub fn InternalReply(&self) -> ::windows_core::Result<EmailMailboxAutoReply> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMailboxAutoReply>();
...
impl EmailMailboxChange {
    pub fn ChangeType(&self) -> ::windows_core::Result<EmailMailboxChangeType> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMailboxChangeType>();
    ...
    pub fn MailboxActions(&self) -> ::windows_core::Result<super::super::Foundation::Collections::IVector<EmailMailboxAction>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::Collections::IVector<EmailMailboxAction>>();
    ...
    pub fn Message(&self) -> ::windows_core::Result<EmailMessage> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMessage>();
    ...
    pub fn Folder(&self) -> ::windows_core::Result<EmailFolder> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailFolder>();
...
impl EmailMailboxChangeReader {
    ...
    pub fn AcceptChangesThrough(&self, lastchangetoacknowledge: &EmailMailboxChange) -> ::windows_core::Result<()> {
        let this = self;
    ...
    pub fn ReadBatchAsync(&self) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<EmailMailboxChange>>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<EmailMailboxChange>>>();
            (::windows_core::Interface::vtable(this).ReadBatchAsync)(::windows_core::Interface::as_raw(this), &mut result__).from_abi(result__)
        }
    }
}
...
impl EmailMailboxChangeTracker {
    ...
    pub fn GetChangeReader(&self) -> ::windows_core::Result<EmailMailboxChangeReader> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMailboxChangeReader>();
...
impl EmailMailboxChangedEventArgs {
    pub fn GetDeferral(&self) -> ::windows_core::Result<EmailMailboxChangedDeferral> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMailboxChangedDeferral>();
...
impl EmailMailboxCreateFolderResult {
    pub fn Status(&self) -> ::windows_core::Result<EmailMailboxCreateFolderStatus> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMailboxCreateFolderStatus>();
            (::windows_core::Interface::vtable(this).Status)(::windows_core::Interface::as_raw(this), &mut result__).from_abi(result__)
        }
    }
    pub fn Folder(&self) -> ::windows_core::Result<EmailFolder> {
...
impl EmailMailboxPolicies {
    pub fn AllowedSmimeEncryptionAlgorithmNegotiation(&self) -> ::windows_core::Result<EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation>();
    ...
    pub fn RequiredSmimeEncryptionAlgorithm(&self) -> ::windows_core::Result<super::super::Foundation::IReference<EmailMailboxSmimeEncryptionAlgorithm>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IReference<EmailMailboxSmimeEncryptionAlgorithm>>();
    ...
    pub fn RequiredSmimeSigningAlgorithm(&self) -> ::windows_core::Result<super::super::Foundation::IReference<EmailMailboxSmimeSigningAlgorithm>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IReference<EmailMailboxSmimeSigningAlgorithm>>();
...
impl EmailMailboxSyncManager {
    pub fn Status(&self) -> ::windows_core::Result<EmailMailboxSyncStatus> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMailboxSyncStatus>();
            (::windows_core::Interface::vtable(this).Status)(::windows_core::Interface::as_raw(this), &mut result__).from_abi(result__)
        }
    }
    #[doc = "*Required features: `\"Foundation\"`*"]
    ...
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn SyncStatusChanged(&self, handler: &super::super::Foundation::TypedEventHandler<EmailMailboxSyncManager, ::windows_core::IInspectable>) -> ::windows_core::Result<super::super::Foundation::EventRegistrationToken> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::EventRegistrationToken>();
...
impl EmailManager {
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn ShowComposeNewEmailAsync(message: &EmailMessage) -> ::windows_core::Result<super::super::Foundation::IAsyncAction> {
        Self::IEmailManagerStatics(|this| unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncAction>();
            (::windows_core::Interface::vtable(this).ShowComposeNewEmailAsync)(::windows_core::Interface::as_raw(this), ::core::mem::transmute_copy(message), &mut result__).from_abi(result__)
        })
    }
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn RequestStoreAsync(accesstype: EmailStoreAccessType) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<EmailStore>> {
        Self::IEmailManagerStatics2(|this| unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<EmailStore>>();
    ...
    #[cfg(feature = "System")]
    pub fn GetForUser(user: &super::super::System::User) -> ::windows_core::Result<EmailManagerForUser> {
        Self::IEmailManagerStatics3(|this| unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailManagerForUser>();
...
impl EmailManagerForUser {
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    pub fn ShowComposeNewEmailAsync(&self, message: &EmailMessage) -> ::windows_core::Result<super::super::Foundation::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncAction>();
            (::windows_core::Interface::vtable(this).ShowComposeNewEmailAsync)(::windows_core::Interface::as_raw(this), ::core::mem::transmute_copy(message), &mut result__).from_abi(result__)
...
impl EmailMeetingInfo {
    ...
    pub fn Recurrence(&self) -> ::windows_core::Result<super::Appointments::AppointmentRecurrence> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::Appointments::AppointmentRecurrence>();
            (::windows_core::Interface::vtable(this).Recurrence)(::windows_core::Interface::as_raw(this), &mut result__).from_abi(result__)
        }
    }
    #[doc = "*Required features: `\"ApplicationModel_Appointments\"`*"]
    #[cfg(feature = "ApplicationModel_Appointments")]
    pub fn SetRecurrence(&self, value: &super::Appointments::AppointmentRecurrence) -> ::windows_core::Result<()> {
        let this = self;
...
impl EmailMessage {
    ...
    pub fn To(&self) -> ::windows_core::Result<super::super::Foundation::Collections::IVector<EmailRecipient>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::Collections::IVector<EmailRecipient>>();
    ...
    pub fn Attachments(&self) -> ::windows_core::Result<super::super::Foundation::Collections::IVector<EmailAttachment>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::Collections::IVector<EmailAttachment>>();
    ...
    pub fn DownloadState(&self) -> ::windows_core::Result<EmailMessageDownloadState> {
        let this = &::windows_core::ComInterface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMessageDownloadState>();
            (::windows_core::Interface::vtable(this).DownloadState)(::windows_core::Interface::as_raw(this), &mut result__).from_abi(result__)
        }
    }
    ...
    pub fn SetIrmInfo(&self, value: &EmailIrmInfo) -> ::windows_core::Result<()> {
        let this = &::windows_core::ComInterface::cast::<IEmailMessage2>(self)?;
        unsafe { (::windows_core::Interface::vtable(this).SetIrmInfo)(::windows_core::Interface::as_raw(this), ::core::mem::transmute_copy(value)).ok() }
    }
    ...
    pub fn SetSender(&self, value: &EmailRecipient) -> ::windows_core::Result<()> {
        let this = &::windows_core::ComInterface::cast::<IEmailMessage2>(self)?;
        unsafe { (::windows_core::Interface::vtable(this).SetSender)(::windows_core::Interface::as_raw(this), ::core::mem::transmute_copy(value)).ok() }
    }
    #[doc = "*Required features: `\"Foundation\"`*"]
    #[cfg(feature = "Foundation")]
    ...
    pub fn MeetingInfo(&self) -> ::windows_core::Result<EmailMeetingInfo> {
        let this = &::windows_core::ComInterface::cast::<IEmailMessage2>(self)?;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMeetingInfo>();
            (::windows_core::Interface::vtable(this).MeetingInfo)(::windows_core::Interface::as_raw(this), &mut result__).from_abi(result__)
        }
    }
    pub fn SetMeetingInfo(&self, value: &EmailMeetingInfo) -> ::windows_core::Result<()> {
        let this = &::windows_core::ComInterface::cast::<IEmailMessage2>(self)?;
        unsafe { (::windows_core::Interface::vtable(this).SetMeetingInfo)(::windows_core::Interface::as_raw(this), ::core::mem::transmute_copy(value)).ok() }
    }
    #[doc = "*Required features: `\"Storage_Streams\"`*"]
    #[cfg(feature = "Storage_Streams")]
    ...
    pub fn SmimeKind(&self) -> ::windows_core::Result<EmailMessageSmimeKind> {
        let this = &::windows_core::ComInterface::cast::<IEmailMessage3>(self)?;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailMessageSmimeKind>();
    ...
    pub fn SetSentRepresenting(&self, value: &EmailRecipient) -> ::windows_core::Result<()> {
        let this = &::windows_core::ComInterface::cast::<IEmailMessage4>(self)?;
        unsafe { (::windows_core::Interface::vtable(this).SetSentRepresenting)(::windows_core::Interface::as_raw(this), ::core::mem::transmute_copy(value)).ok() }
    }
}
...
impl EmailMessageBatch {
    ...
    pub fn Messages(&self) -> ::windows_core::Result<super::super::Foundation::Collections::IVectorView<EmailMessage>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::Collections::IVectorView<EmailMessage>>();
...
impl EmailMessageReader {
    ...
    pub fn ReadBatchAsync(&self) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<EmailMessageBatch>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<EmailMessageBatch>>();
            (::windows_core::Interface::vtable(this).ReadBatchAsync)(::windows_core::Interface::as_raw(this), &mut result__).from_abi(result__)
        }
    }
}
...
impl EmailQueryOptions {
    ...
    pub fn TextSearch(&self) -> ::windows_core::Result<EmailQueryTextSearch> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailQueryTextSearch>();
    ...
    pub fn SortDirection(&self) -> ::windows_core::Result<EmailQuerySortDirection> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailQuerySortDirection>();
    ...
    pub fn SortProperty(&self) -> ::windows_core::Result<EmailQuerySortProperty> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailQuerySortProperty>();
    ...
    pub fn Kind(&self) -> ::windows_core::Result<EmailQueryKind> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailQueryKind>();
            (::windows_core::Interface::vtable(this).Kind)(::windows_core::Interface::as_raw(this), &mut result__).from_abi(result__)
        }
    }
    ...
    pub fn CreateWithText(text: &::windows_core::HSTRING) -> ::windows_core::Result<EmailQueryOptions> {
        Self::IEmailQueryOptionsFactory(|this| unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailQueryOptions>();
...
impl EmailQueryTextSearch {
    pub fn Fields(&self) -> ::windows_core::Result<EmailQuerySearchFields> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailQuerySearchFields>();
    ...
    pub fn SearchScope(&self) -> ::windows_core::Result<EmailQuerySearchScope> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailQuerySearchScope>();
...
impl EmailRecipientResolutionResult {
    ...
    pub fn Status(&self) -> ::windows_core::Result<EmailRecipientResolutionStatus> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<EmailRecipientResolutionStatus>();
            (::windows_core::Interface::vtable(this).Status)(::windows_core::Interface::as_raw(this), &mut result__).from_abi(result__)
        }
    }
    #[doc = "*Required features: `\"Foundation_Collections\"`, `\"Security_Cryptography_Certificates\"`*"]
...
impl EmailStore {
    ...
    pub fn FindMailboxesAsync(&self) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<EmailMailbox>>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<EmailMailbox>>>();
    ...
    pub fn GetMailboxAsync(&self, id: &::windows_core::HSTRING) -> ::windows_core::Result<super::super::Foundation::IAsyncOperation<EmailMailbox>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<super::super::Foundation::IAsyncOperation<EmailMailbox>>();
