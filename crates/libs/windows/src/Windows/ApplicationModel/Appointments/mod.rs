...
impl Appointment {
    ...
    pub fn SetStartTime(&self, value: super::super::Foundation::DateTime) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetDuration(&self, value: super::super::Foundation::TimeSpan) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDuration)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Location(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetLocation(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn Details(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDetails(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDetails)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(value)).ok() }
    }
    pub fn Reminder(&self) -> windows_result::Result<super::super::Foundation::IReference<super::super::Foundation::TimeSpan>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetReminder<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn Organizer(&self) -> windows_result::Result<AppointmentOrganizer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOrganizer<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn Invitees(&self) -> windows_result::Result<windows_collections::IVector<AppointmentInvitee>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Recurrence(&self) -> windows_result::Result<AppointmentRecurrence> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRecurrence<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn BusyStatus(&self) -> windows_result::Result<AppointmentBusyStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetBusyStatus(&self, value: AppointmentBusyStatus) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetBusyStatus)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AllDay(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAllDay(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAllDay)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Sensitivity(&self) -> windows_result::Result<AppointmentSensitivity> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSensitivity(&self, value: AppointmentSensitivity) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn LocalId(&self) -> windows_result::Result<windows_core::HSTRING> {
    ...
    pub fn CalendarId(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RoamingId(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRoamingId(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
    ...
    pub fn OriginalStartTime(&self) -> windows_result::Result<super::super::Foundation::IReference<super::super::Foundation::DateTime>> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsResponseRequested(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsResponseRequested(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetIsResponseRequested)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AllowNewTimeProposal(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAllowNewTimeProposal(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetAllowNewTimeProposal)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn OnlineMeetingLink(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOnlineMeetingLink(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
    ...
    pub fn ReplyTime(&self) -> windows_result::Result<super::super::Foundation::IReference<super::super::Foundation::DateTime>> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetReplyTime<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn UserResponse(&self) -> windows_result::Result<AppointmentParticipantResponse> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetUserResponse(&self, value: AppointmentParticipantResponse) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetUserResponse)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn HasInvitees(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsCanceledMeeting(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsCanceledMeeting(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetIsCanceledMeeting)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsOrganizedByUser(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsOrganizedByUser(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointment2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetIsOrganizedByUser)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ChangeNumber(&self) -> windows_result::Result<u64> {
    ...
    pub fn RemoteChangeNumber(&self) -> windows_result::Result<u64> {
        let this = &windows_core::Interface::cast::<IAppointment3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRemoteChangeNumber(&self, value: u64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointment3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetRemoteChangeNumber)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DetailsKind(&self) -> windows_result::Result<AppointmentDetailsKind> {
        let this = &windows_core::Interface::cast::<IAppointment3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDetailsKind(&self, value: AppointmentDetailsKind) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointment3>(self)?;
...
impl AppointmentCalendar {
    #[cfg(feature = "UI")]
    pub fn DisplayColor(&self) -> windows_result::Result<super::super::UI::Color> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsHidden(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OtherAppReadAccess(&self) -> windows_result::Result<AppointmentCalendarOtherAppReadAccess> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOtherAppReadAccess(&self, value: AppointmentCalendarOtherAppReadAccess) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetOtherAppReadAccess)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn OtherAppWriteAccess(&self) -> windows_result::Result<AppointmentCalendarOtherAppWriteAccess> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOtherAppWriteAccess(&self, value: AppointmentCalendarOtherAppWriteAccess) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetOtherAppWriteAccess)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SourceDisplayName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SummaryCardView(&self) -> windows_result::Result<AppointmentSummaryCardView> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSummaryCardView(&self, value: AppointmentSummaryCardView) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSummaryCardView)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn FindAppointmentsAsync(&self, rangestart: super::super::Foundation::DateTime, rangelength: super::super::Foundation::TimeSpan) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<Appointment>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAppointmentsAsyncWithOptions<P2>(&self, rangestart: super::super::Foundation::DateTime, rangelength: super::super::Foundation::TimeSpan, options: P2) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<Appointment>>>
    where
    ...
    pub fn FindExceptionsFromMasterAsync(&self, masterlocalid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<AppointmentException>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAllInstancesAsync(&self, masterlocalid: &windows_core::HSTRING, rangestart: super::super::Foundation::DateTime, rangelength: super::super::Foundation::TimeSpan) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<Appointment>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAllInstancesAsyncWithOptions<P3>(&self, masterlocalid: &windows_core::HSTRING, rangestart: super::super::Foundation::DateTime, rangelength: super::super::Foundation::TimeSpan, poptions: P3) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<Appointment>>>
    where
    ...
    pub fn GetAppointmentAsync(&self, localid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<Appointment>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAppointmentInstanceAsync(&self, localid: &windows_core::HSTRING, instancestarttime: super::super::Foundation::DateTime) -> windows_result::Result<windows_future::IAsyncOperation<Appointment>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindUnexpandedAppointmentsAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<Appointment>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindUnexpandedAppointmentsAsyncWithOptions<P0>(&self, options: P0) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<Appointment>>>
    where
    ...
    pub fn DeleteAsync(&self) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeleteAppointmentAsync(&self, localid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeleteAppointmentInstanceAsync(&self, localid: &windows_core::HSTRING, instancestarttime: super::super::Foundation::DateTime) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SaveAppointmentAsync<P0>(&self, pappointment: P0) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    pub fn SyncManager(&self) -> windows_result::Result<AppointmentCalendarSyncManager> {
    ...
    pub fn RemoteId(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRemoteId(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
    ...
    #[cfg(feature = "UI")]
    pub fn SetDisplayColor(&self, value: super::super::UI::Color) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetDisplayColor)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SetIsHidden(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
    ...
    pub fn CanCreateOrUpdateAppointments(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanCreateOrUpdateAppointments(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetCanCreateOrUpdateAppointments)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CanCancelMeetings(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanCancelMeetings(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetCanCancelMeetings)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CanForwardMeetings(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanForwardMeetings(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetCanForwardMeetings)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CanProposeNewTimeForMeetings(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanProposeNewTimeForMeetings(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetCanProposeNewTimeForMeetings)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CanUpdateMeetingResponses(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanUpdateMeetingResponses(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetCanUpdateMeetingResponses)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CanNotifyInvitees(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanNotifyInvitees(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetCanNotifyInvitees)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn MustNofityInvitees(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMustNofityInvitees(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetMustNofityInvitees)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn TryCreateOrUpdateAppointmentAsync<P0>(&self, appointment: P0, notifyinvitees: bool) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<Appointment>,
    {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
    ...
    pub fn TryCancelMeetingAsync<P0>(&self, meeting: P0, subject: &windows_core::HSTRING, comment: &windows_core::HSTRING, notifyinvitees: bool) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<Appointment>,
    {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
    ...
    pub fn TryForwardMeetingAsync<P0, P1>(&self, meeting: P0, invitees: P1, subject: &windows_core::HSTRING, forwardheader: &windows_core::HSTRING, comment: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<Appointment>,
    ...
    pub fn TryProposeNewTimeForMeetingAsync<P0>(&self, meeting: P0, newstarttime: super::super::Foundation::DateTime, newduration: super::super::Foundation::TimeSpan, subject: &windows_core::HSTRING, comment: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<Appointment>,
    {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
    ...
    pub fn TryUpdateMeetingResponseAsync<P0>(&self, meeting: P0, response: AppointmentParticipantResponse, subject: &windows_core::HSTRING, comment: &windows_core::HSTRING, sendupdate: bool) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<Appointment>,
    {
        let this = &windows_core::Interface::cast::<IAppointmentCalendar2>(self)?;
    ...
    pub fn RegisterSyncManagerAsync(&self) -> windows_result::Result<windows_future::IAsyncAction> {
...
impl AppointmentCalendarSyncManager {
    pub fn Status(&self) -> windows_result::Result<AppointmentCalendarSyncStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LastSuccessfulSyncTime(&self) -> windows_result::Result<super::super::Foundation::DateTime> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LastAttemptedSyncTime(&self) -> windows_result::Result<super::super::Foundation::DateTime> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SyncStatusChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveSyncStatusChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveSyncStatusChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn SetStatus(&self, value: AppointmentCalendarSyncStatus) -> windows_result::Result<()> {
    ...
    pub fn SetLastSuccessfulSyncTime(&self, value: super::super::Foundation::DateTime) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendarSyncManager2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetLastSuccessfulSyncTime)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SetLastAttemptedSyncTime(&self, value: super::super::Foundation::DateTime) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointmentCalendarSyncManager2>(self)?;
...
impl AppointmentConflictResult {
    pub fn Type(&self) -> windows_result::Result<AppointmentConflictType> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Date(&self) -> windows_result::Result<super::super::Foundation::DateTime> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppointmentException {
    pub fn Appointment(&self) -> windows_result::Result<Appointment> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ExceptionProperties(&self) -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsDeleted(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppointmentInvitee {
    ...
    pub fn Role(&self) -> windows_result::Result<AppointmentParticipantRole> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRole(&self, value: AppointmentParticipantRole) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetRole)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Response(&self) -> windows_result::Result<AppointmentParticipantResponse> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetResponse(&self, value: AppointmentParticipantResponse) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn Address(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<IAppointmentParticipant>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAddress(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointmentParticipant>(self)?;
...
impl AppointmentManager {
    pub fn ShowAddAppointmentAsync<P0>(appointment: P0, selection: super::super::Foundation::Rect) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>>
    where
        P0: windows_core::Param<Appointment>,
    {
    ...
    pub fn ShowAddAppointmentWithPlacementAsync<P0>(appointment: P0, selection: super::super::Foundation::Rect, preferredplacement: super::super::UI::Popups::Placement) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>>
    where
        P0: windows_core::Param<Appointment>,
    {
        Self::IAppointmentManagerStatics(|this| unsafe {
    ...
    pub fn ShowReplaceAppointmentAsync<P1>(appointmentid: &windows_core::HSTRING, appointment: P1, selection: super::super::Foundation::Rect) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>>
    where
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn ShowReplaceAppointmentWithPlacementAsync<P1>(appointmentid: &windows_core::HSTRING, appointment: P1, selection: super::super::Foundation::Rect, preferredplacement: super::super::UI::Popups::Placement) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>>
    where
        P1: windows_core::Param<Appointment>,
    {
        Self::IAppointmentManagerStatics(|this| unsafe {
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn ShowReplaceAppointmentWithPlacementAndDateAsync<P1>(appointmentid: &windows_core::HSTRING, appointment: P1, selection: super::super::Foundation::Rect, preferredplacement: super::super::UI::Popups::Placement, instancestartdate: super::super::Foundation::DateTime) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>>
    where
        P1: windows_core::Param<Appointment>,
    {
        Self::IAppointmentManagerStatics(|this| unsafe {
    ...
    pub fn ShowRemoveAppointmentAsync(appointmentid: &windows_core::HSTRING, selection: super::super::Foundation::Rect) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        Self::IAppointmentManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn ShowRemoveAppointmentWithPlacementAsync(appointmentid: &windows_core::HSTRING, selection: super::super::Foundation::Rect, preferredplacement: super::super::UI::Popups::Placement) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        Self::IAppointmentManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn ShowRemoveAppointmentWithPlacementAndDateAsync(appointmentid: &windows_core::HSTRING, selection: super::super::Foundation::Rect, preferredplacement: super::super::UI::Popups::Placement, instancestartdate: super::super::Foundation::DateTime) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        Self::IAppointmentManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowTimeFrameAsync(timetoshow: super::super::Foundation::DateTime, duration: super::super::Foundation::TimeSpan) -> windows_result::Result<windows_future::IAsyncAction> {
        Self::IAppointmentManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowAppointmentDetailsAsync(appointmentid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction> {
    ...
    pub fn ShowAppointmentDetailsWithDateAsync(appointmentid: &windows_core::HSTRING, instancestartdate: super::super::Foundation::DateTime) -> windows_result::Result<windows_future::IAsyncAction> {
        Self::IAppointmentManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowEditNewAppointmentAsync<P0>(appointment: P0) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>>
    where
        P0: windows_core::Param<Appointment>,
    {
        Self::IAppointmentManagerStatics2(|this| unsafe {
    ...
    pub fn RequestStoreAsync(options: AppointmentStoreAccessType) -> windows_result::Result<windows_future::IAsyncOperation<AppointmentStore>> {
        Self::IAppointmentManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "System")]
    pub fn GetForUser<P0>(user: P0) -> windows_result::Result<AppointmentManagerForUser>
    where
    ...
    fn IAppointmentManagerStatics<R, F: FnOnce(&IAppointmentManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IAppointmentManagerStatics2<R, F: FnOnce(&IAppointmentManagerStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IAppointmentManagerStatics3<R, F: FnOnce(&IAppointmentManagerStatics3) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl AppointmentManagerForUser {
    pub fn ShowAddAppointmentAsync<P0>(&self, appointment: P0, selection: super::super::Foundation::Rect) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>>
    where
        P0: windows_core::Param<Appointment>,
    {
        let this = self;
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn ShowAddAppointmentWithPlacementAsync<P0>(&self, appointment: P0, selection: super::super::Foundation::Rect, preferredplacement: super::super::UI::Popups::Placement) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>>
    where
        P0: windows_core::Param<Appointment>,
    {
        let this = self;
    ...
    pub fn ShowReplaceAppointmentAsync<P1>(&self, appointmentid: &windows_core::HSTRING, appointment: P1, selection: super::super::Foundation::Rect) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>>
    where
        P1: windows_core::Param<Appointment>,
    {
        let this = self;
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn ShowReplaceAppointmentWithPlacementAsync<P1>(&self, appointmentid: &windows_core::HSTRING, appointment: P1, selection: super::super::Foundation::Rect, preferredplacement: super::super::UI::Popups::Placement) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>>
    where
        P1: windows_core::Param<Appointment>,
    {
        let this = self;
    ...
    pub fn ShowRemoveAppointmentAsync(&self, appointmentid: &windows_core::HSTRING, selection: super::super::Foundation::Rect) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowRemoveAppointmentAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(appointmentid), selection, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn ShowRemoveAppointmentWithPlacementAsync(&self, appointmentid: &windows_core::HSTRING, selection: super::super::Foundation::Rect, preferredplacement: super::super::UI::Popups::Placement) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowRemoveAppointmentWithPlacementAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(appointmentid), selection, preferredplacement, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn ShowRemoveAppointmentWithPlacementAndDateAsync(&self, appointmentid: &windows_core::HSTRING, selection: super::super::Foundation::Rect, preferredplacement: super::super::UI::Popups::Placement, instancestartdate: super::super::Foundation::DateTime) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowRemoveAppointmentWithPlacementAndDateAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(appointmentid), selection, preferredplacement, instancestartdate, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ShowTimeFrameAsync(&self, timetoshow: super::super::Foundation::DateTime, duration: super::super::Foundation::TimeSpan) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowTimeFrameAsync)(windows_core::Interface::as_raw(this), timetoshow, duration, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ShowAppointmentDetailsAsync(&self, appointmentid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowAppointmentDetailsAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(appointmentid), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ShowAppointmentDetailsWithDateAsync(&self, appointmentid: &windows_core::HSTRING, instancestartdate: super::super::Foundation::DateTime) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ShowAppointmentDetailsWithDateAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(appointmentid), instancestartdate, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ShowEditNewAppointmentAsync<P0>(&self, appointment: P0) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>>
    where
        P0: windows_core::Param<Appointment>,
    {
        let this = self;
    ...
    pub fn RequestStoreAsync(&self, options: AppointmentStoreAccessType) -> windows_result::Result<windows_future::IAsyncOperation<AppointmentStore>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestStoreAsync)(windows_core::Interface::as_raw(this), options, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl AppointmentProperties {
    pub fn Subject() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Subject)(windows_core::Interface::as_raw(this), &mut result__).map(|| core::mem::transmute(result__))
        })
    }
    pub fn Location() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Location)(windows_core::Interface::as_raw(this), &mut result__).map(|| core::mem::transmute(result__))
        })
    }
    pub fn StartTime() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Duration() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Reminder() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BusyStatus() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Sensitivity() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OriginalStartTime() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsResponseRequested() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AllowNewTimeProposal() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AllDay() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Details() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Details)(windows_core::Interface::as_raw(this), &mut result__).map(|| core::mem::transmute(result__))
        })
    }
    pub fn OnlineMeetingLink() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).OnlineMeetingLink)(windows_core::Interface::as_raw(this), &mut result__).map(|| core::mem::transmute(result__))
        })
    }
    pub fn ReplyTime() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Organizer() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UserResponse() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HasInvitees() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsCanceledMeeting() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsOrganizedByUser() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Recurrence() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Invitees() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DefaultProperties() -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        Self::IAppointmentPropertiesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ChangeNumber() -> windows_result::Result<windows_core::HSTRING> {
    ...
    pub fn RemoteChangeNumber() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DetailsKind() -> windows_result::Result<windows_core::HSTRING> {
        Self::IAppointmentPropertiesStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IAppointmentPropertiesStatics<R, F: FnOnce(&IAppointmentPropertiesStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IAppointmentPropertiesStatics2<R, F: FnOnce(&IAppointmentPropertiesStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl AppointmentRecurrence {
    ...
    pub fn Unit(&self) -> windows_result::Result<AppointmentRecurrenceUnit> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetUnit(&self, value: AppointmentRecurrenceUnit) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetUnit)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Occurrences(&self) -> windows_result::Result<super::super::Foundation::IReference<u32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOccurrences<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn Until(&self) -> windows_result::Result<super::super::Foundation::IReference<super::super::Foundation::DateTime>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetUntil<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::super::Foundation::DateTime>>,
    {
        let this = self;
    ...
    pub fn Interval(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetInterval(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetInterval)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DaysOfWeek(&self) -> windows_result::Result<AppointmentDaysOfWeek> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDaysOfWeek(&self, value: AppointmentDaysOfWeek) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDaysOfWeek)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn WeekOfMonth(&self) -> windows_result::Result<AppointmentWeekOfMonth> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetWeekOfMonth(&self, value: AppointmentWeekOfMonth) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetWeekOfMonth)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Month(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDay(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDay)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn RecurrenceType(&self) -> windows_result::Result<RecurrenceType> {
    ...
    pub fn TimeZone(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<IAppointmentRecurrence2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTimeZone(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointmentRecurrence2>(self)?;
    ...
    pub fn CalendarIdentifier(&self) -> windows_result::Result<windows_core::HSTRING> {
...
impl AppointmentStore {
    pub fn ChangeTracker(&self) -> windows_result::Result<AppointmentStoreChangeTracker> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateAppointmentCalendarAsync(&self, name: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<AppointmentCalendar>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAppointmentCalendarAsync(&self, calendarid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<AppointmentCalendar>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAppointmentCalendarsAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<AppointmentCalendar>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAppointmentCalendarsAsyncWithOptions(&self, options: FindAppointmentCalendarsOptions) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<AppointmentCalendar>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindConflictAsync<P0>(&self, appointment: P0) -> windows_result::Result<windows_future::IAsyncOperation<AppointmentConflictResult>>
    where
        P0: windows_core::Param<Appointment>,
    {
        let this = self;
    ...
    pub fn FindConflictAsyncWithInstanceStart<P0>(&self, appointment: P0, instancestarttime: super::super::Foundation::DateTime) -> windows_result::Result<windows_future::IAsyncOperation<AppointmentConflictResult>>
    where
        P0: windows_core::Param<Appointment>,
    {
        let this = self;
    ...
    pub fn MoveAppointmentAsync<P0, P1>(&self, appointment: P0, destinationcalendar: P1) -> windows_result::Result<windows_future::IAsyncAction>
    where
        P0: windows_core::Param<Appointment>,
    ...
    pub fn ShowReplaceAppointmentAsync<P1>(&self, localid: &windows_core::HSTRING, appointment: P1, selection: super::super::Foundation::Rect) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>>
    where
        P1: windows_core::Param<Appointment>,
    {
        let this = self;
    ...
    pub fn ShowRemoveAppointmentAsync(&self, localid: &windows_core::HSTRING, selection: super::super::Foundation::Rect) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn ShowRemoveAppointmentWithPlacementAndDateAsync(&self, localid: &windows_core::HSTRING, selection: super::super::Foundation::Rect, preferredplacement: super::super::UI::Popups::Placement, instancestartdate: super::super::Foundation::DateTime) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowAppointmentDetailsAsync(&self, localid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowAppointmentDetailsWithDateAsync(&self, localid: &windows_core::HSTRING, instancestartdate: super::super::Foundation::DateTime) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindLocalIdsFromRoamingIdAsync(&self, roamingid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<windows_core::HSTRING>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StoreChanged<P0>(&self, phandler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveStoreChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IAppointmentStore2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemoveStoreChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn CreateAppointmentCalendarInAccountAsync(&self, name: &windows_core::HSTRING, userdataaccountid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<AppointmentCalendar>> {
        let this = &windows_core::Interface::cast::<IAppointmentStore2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetChangeTracker(&self, identity: &windows_core::HSTRING) -> windows_result::Result<AppointmentStoreChangeTracker> {
...
impl AppointmentStoreChange {
    ...
    pub fn ChangeType(&self) -> windows_result::Result<AppointmentStoreChangeType> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AppointmentCalendar(&self) -> windows_result::Result<AppointmentCalendar> {
...
impl AppointmentStoreChangeReader {
    pub fn ReadBatchAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<AppointmentStoreChange>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AcceptChanges(&self) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).AcceptChanges)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn AcceptChangesThrough<P0>(&self, lastchangetoaccept: P0) -> windows_result::Result<()>
    where
...
impl AppointmentStoreChangeTracker {
    pub fn GetChangeReader(&self) -> windows_result::Result<AppointmentStoreChangeReader> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Enable(&self) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn IsTracking(&self) -> windows_result::Result<bool> {
...
impl AppointmentStoreChangedEventArgs {
    pub fn GetDeferral(&self) -> windows_result::Result<AppointmentStoreChangedDeferral> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl FindAppointmentsOptions {
    ...
    pub fn CalendarIds(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FetchProperties(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IncludeHidden(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIncludeHidden(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIncludeHidden)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn MaxCount(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxCount(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
...
pub trait IAppointmentParticipant_Impl: windows_core::IUnknownImpl {
    fn DisplayName(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn SetDisplayName(&self, value: &windows_core::HSTRING) -> windows_result::Result<()>;
    fn Address(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn SetAddress(&self, value: &windows_core::HSTRING) -> windows_result::Result<()>;
}
