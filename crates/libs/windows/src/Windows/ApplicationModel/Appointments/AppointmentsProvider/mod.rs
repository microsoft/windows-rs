...
impl AddAppointmentOperation {
    pub fn AppointmentInformation(&self) -> Result<super::Appointment, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn SourcePackageFamilyName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReportCompleted(&self, itemid: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn ReportCanceled(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).ReportCanceled)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn ReportError(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn DismissUI(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl AppointmentsProviderLaunchActionVerbs {
    pub fn AddAppointment() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn ReplaceAppointment() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IAppointmentsProviderLaunchActionVerbsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RemoveAppointment() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IAppointmentsProviderLaunchActionVerbsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowTimeFrame() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IAppointmentsProviderLaunchActionVerbsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowAppointmentDetails() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    fn IAppointmentsProviderLaunchActionVerbsStatics<R, F: FnOnce(&IAppointmentsProviderLaunchActionVerbsStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IAppointmentsProviderLaunchActionVerbsStatics2<R, F: FnOnce(&IAppointmentsProviderLaunchActionVerbsStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl RemoveAppointmentOperation {
    pub fn AppointmentId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn InstanceStartDate(&self) -> Result<super::super::super::Foundation::IReference<super::super::super::Foundation::DateTime>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
