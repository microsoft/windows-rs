...
impl AppointmentCalendarCancelMeetingRequest {
    pub fn AppointmentCalendarLocalId(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
    ...
    pub fn AppointmentLocalId(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AppointmentOriginalStartTime(&self) -> windows_result::Result<super::super::super::Foundation::IReference<super::super::super::Foundation::DateTime>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NotifyInvitees(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppointmentCalendarCancelMeetingRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<AppointmentCalendarCancelMeetingRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppointmentCalendarCreateOrUpdateAppointmentRequest {
    ...
    pub fn Appointment(&self) -> windows_result::Result<super::Appointment> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ChangedProperties(&self) -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReportCompletedAsync<P0>(&self, createdorupdatedappointment: P0) -> windows_result::Result<windows_future::IAsyncAction>
    where
...
impl AppointmentCalendarCreateOrUpdateAppointmentRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<AppointmentCalendarCreateOrUpdateAppointmentRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl AppointmentCalendarForwardMeetingRequest {
    ...
    pub fn Invitees(&self) -> windows_result::Result<windows_collections::IVectorView<super::AppointmentInvitee>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppointmentCalendarForwardMeetingRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<AppointmentCalendarForwardMeetingRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl AppointmentCalendarProposeNewTimeForMeetingRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<AppointmentCalendarProposeNewTimeForMeetingRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl AppointmentCalendarSyncManagerSyncRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<AppointmentCalendarSyncManagerSyncRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl AppointmentCalendarUpdateMeetingResponseRequest {
    ...
    pub fn Response(&self) -> windows_result::Result<super::AppointmentParticipantResponse> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppointmentCalendarUpdateMeetingResponseRequestEventArgs {
    pub fn Request(&self) -> windows_result::Result<AppointmentCalendarUpdateMeetingResponseRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl AppointmentDataProviderConnection {
    ...
    pub fn CreateOrUpdateAppointmentRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveCreateOrUpdateAppointmentRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn CancelMeetingRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveCancelMeetingRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
...
impl AppointmentDataProviderTriggerDetails {
    pub fn Connection(&self) -> windows_result::Result<AppointmentDataProviderConnection> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
