...
impl WalletBarcode {
    pub fn Symbology(&self) -> windows_result::Result<WalletBarcodeSymbology> {
        let this = self;
        unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetImageAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<super::super::Storage::Streams::IRandomAccessStreamReference>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateWalletBarcode(symbology: WalletBarcodeSymbology, value: &windows_core::HSTRING) -> windows_result::Result<WalletBarcode> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateCustomWalletBarcode<P0>(streamtobarcodeimage: P0) -> windows_result::Result<WalletBarcode>
    where
    ...
    fn IWalletBarcodeFactory<R, F: FnOnce(&IWalletBarcodeFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl WalletItem {
    ...
    pub fn IsAcknowledged(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsAcknowledged(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsAcknowledged)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IssuerDisplayName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIssuerDisplayName(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn LastUpdated(&self) -> windows_result::Result<super::super::Foundation::IReference<super::super::Foundation::DateTime>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetLastUpdated<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn Kind(&self) -> windows_result::Result<WalletItemKind> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Barcode(&self) -> windows_result::Result<WalletBarcode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetBarcode<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn ExpirationDate(&self) -> windows_result::Result<super::super::Foundation::IReference<super::super::Foundation::DateTime>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetExpirationDate<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::super::Foundation::DateTime>>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Logo159x159(&self) -> windows_result::Result<super::super::Storage::Streams::IRandomAccessStreamReference> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetLogo159x159<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Logo336x336(&self) -> windows_result::Result<super::super::Storage::Streams::IRandomAccessStreamReference> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetLogo336x336<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Logo99x99(&self) -> windows_result::Result<super::super::Storage::Streams::IRandomAccessStreamReference> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetLogo99x99<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
    {
        let this = self;
    ...
    pub fn IsDisplayMessageLaunchable(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsDisplayMessageLaunchable(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsDisplayMessageLaunchable)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn LogoText(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetLogoText(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    #[cfg(feature = "UI")]
    pub fn HeaderColor(&self) -> windows_result::Result<super::super::UI::Color> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI")]
    pub fn SetHeaderColor(&self, value: super::super::UI::Color) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetHeaderColor)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "UI")]
    pub fn BodyColor(&self) -> windows_result::Result<super::super::UI::Color> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI")]
    pub fn SetBodyColor(&self, value: super::super::UI::Color) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetBodyColor)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "UI")]
    pub fn HeaderFontColor(&self) -> windows_result::Result<super::super::UI::Color> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI")]
    pub fn SetHeaderFontColor(&self, value: super::super::UI::Color) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetHeaderFontColor)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "UI")]
    pub fn BodyFontColor(&self) -> windows_result::Result<super::super::UI::Color> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI")]
    pub fn SetBodyFontColor(&self, value: super::super::UI::Color) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetBodyFontColor)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn HeaderBackgroundImage(&self) -> windows_result::Result<super::super::Storage::Streams::IRandomAccessStreamReference> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetHeaderBackgroundImage<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn BodyBackgroundImage(&self) -> windows_result::Result<super::super::Storage::Streams::IRandomAccessStreamReference> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetBodyBackgroundImage<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LogoImage(&self) -> windows_result::Result<super::super::Storage::Streams::IRandomAccessStreamReference> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetLogoImage<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn PromotionalImage(&self) -> windows_result::Result<super::super::Storage::Streams::IRandomAccessStreamReference> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetPromotionalImage<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
    {
        let this = self;
    ...
    pub fn RelevantDate(&self) -> windows_result::Result<super::super::Foundation::IReference<super::super::Foundation::DateTime>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRelevantDate<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::super::Foundation::DateTime>>,
    {
        let this = self;
    ...
    pub fn RelevantDateDisplayMessage(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRelevantDateDisplayMessage(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn TransactionHistory(&self) -> windows_result::Result<windows_collections::IMap<windows_core::HSTRING, WalletTransaction>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RelevantLocations(&self) -> windows_result::Result<windows_collections::IMap<windows_core::HSTRING, WalletRelevantLocation>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsMoreTransactionHistoryLaunchable(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsMoreTransactionHistoryLaunchable(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn DisplayProperties(&self) -> windows_result::Result<windows_collections::IMap<windows_core::HSTRING, WalletItemCustomProperty>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Verbs(&self) -> windows_result::Result<windows_collections::IMap<windows_core::HSTRING, WalletVerb>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateWalletItem(kind: WalletItemKind, displayname: &windows_core::HSTRING) -> windows_result::Result<WalletItem> {
    ...
    fn IWalletItemFactory<R, F: FnOnce(&IWalletItemFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl WalletItemCustomProperty {
    ...
    pub fn SetValue(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetValue)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(value)).ok() }
    }
    pub fn AutoDetectLinks(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAutoDetectLinks(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAutoDetectLinks)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DetailViewPosition(&self) -> windows_result::Result<WalletDetailViewPosition> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDetailViewPosition(&self, value: WalletDetailViewPosition) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDetailViewPosition)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SummaryViewPosition(&self) -> windows_result::Result<WalletSummaryViewPosition> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSummaryViewPosition(&self, value: WalletSummaryViewPosition) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSummaryViewPosition)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CreateWalletItemCustomProperty(name: &windows_core::HSTRING, value: &windows_core::HSTRING) -> windows_result::Result<WalletItemCustomProperty> {
    ...
    fn IWalletItemCustomPropertyFactory<R, F: FnOnce(&IWalletItemCustomPropertyFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl WalletItemStore {
    pub fn AddAsync<P1>(&self, id: &windows_core::HSTRING, item: P1) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    pub fn ClearAsync(&self) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetWalletItemAsync(&self, id: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<WalletItem>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetItemsAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<WalletItem>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetItemsWithKindAsync(&self, kind: WalletItemKind) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<WalletItem>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ImportItemAsync<P0>(&self, stream: P0) -> windows_result::Result<windows_future::IAsyncOperation<WalletItem>>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
    {
        let this = self;
    ...
    pub fn DeleteAsync(&self, id: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowAsync(&self) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowItemAsync(&self, id: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UpdateAsync<P0>(&self, item: P0) -> windows_result::Result<windows_future::IAsyncAction>
    where
...
impl WalletManager {
    pub fn RequestStoreAsync() -> windows_result::Result<windows_future::IAsyncOperation<WalletItemStore>> {
    ...
    fn IWalletManagerStatics<R, F: FnOnce(&IWalletManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl WalletRelevantLocation {
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn Position(&self) -> windows_result::Result<super::super::Devices::Geolocation::BasicGeoposition> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn SetPosition(&self, value: super::super::Devices::Geolocation::BasicGeoposition) -> windows_result::Result<()> {
        let this = self;
...
impl WalletTransaction {
    ...
    pub fn DisplayAmount(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDisplayAmount(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn IgnoreTimeOfDay(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIgnoreTimeOfDay(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIgnoreTimeOfDay)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DisplayLocation(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDisplayLocation(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn TransactionDate(&self) -> windows_result::Result<super::super::Foundation::IReference<super::super::Foundation::DateTime>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTransactionDate<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::super::Foundation::DateTime>>,
    {
        let this = self;
    ...
    pub fn IsLaunchable(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsLaunchable(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
...
impl WalletVerb {
    ...
    pub fn CreateWalletVerb(name: &windows_core::HSTRING) -> windows_result::Result<WalletVerb> {
    ...
    fn IWalletVerbFactory<R, F: FnOnce(&IWalletVerbFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
