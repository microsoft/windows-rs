...
impl<Identity: windows_core::IUnknownImpl + IUserActivityContentInfo_Impl + 'static, const OFFSET: isize> windows_core::imp::VtableCtor<Identity, OFFSET> for IUserActivityContentInfo_Vtbl {
