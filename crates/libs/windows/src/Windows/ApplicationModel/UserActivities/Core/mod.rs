...
impl CoreUserActivityManager {
    pub fn CreateUserActivitySessionInBackground<P0>(activity: P0) -> Result<super::UserActivitySession, windows_result::HRESULT>
    where
    ...
    pub fn DeleteUserActivitySessionsInTimeRangeAsync<P0>(channel: P0, starttime: super::super::super::Foundation::DateTime, endtime: super::super::super::Foundation::DateTime) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
    ...
    fn ICoreUserActivityManagerStatics<R, F: FnOnce(&ICoreUserActivityManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
