...
impl Package {
    ...
    #[cfg(feature = "ApplicationModel_Core")]
    pub fn GetAppListEntriesAsync(&self) -> windows_core::Result<super::Foundation::IAsyncOperation<windows_collections::IVectorView<Core::AppListEntry>>> {
        let this = &windows_core::Interface::cast::<IPackage3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetContentGroupsAsync(&self) -> windows_core::Result<super::Foundation::IAsyncOperation<windows_collections::IVector<PackageContentGroup>>> {
    ...
    pub fn StageContentGroupsAsync<P0>(&self, names: P0) -> windows_core::Result<super::Foundation::IAsyncOperation<windows_collections::IVector<PackageContentGroup>>>
    where
    ...
    pub fn StageContentGroupsWithPriorityAsync<P0>(&self, names: P0, movetoheadofqueue: bool) -> windows_core::Result<super::Foundation::IAsyncOperation<windows_collections::IVector<PackageContentGroup>>>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        let this = &windows_core::Interface::cast::<IPackage5>(self)?;
...
impl StartupTask {
    ...
    pub fn GetForCurrentPackageAsync() -> windows_core::Result<super::Foundation::IAsyncOperation<windows_collections::IVectorView<StartupTask>>> {
