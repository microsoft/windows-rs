...
windows_core::imp::required_hierarchy!(AppDisplayInfo, IAppDisplayInfo);
impl AppDisplayInfo {
...
windows_core::imp::required_hierarchy!(AppInfo, IAppInfo, IAppInfo2, IAppInfo3, IAppInfo4, IAppInfoStatics);
impl AppInfo {
...
windows_core::imp::required_hierarchy!(AppInstallerInfo, IAppInstallerInfo, IAppInstallerInfo2);
...
windows_core::imp::required_hierarchy!(AppInstance, IAppInstance, IAppInstanceStatics);
impl AppInstance {
...
windows_core::imp::required_hierarchy!(FindRelatedPackagesOptions, IFindRelatedPackagesOptions, IFindRelatedPackagesOptionsFactory);
...
windows_core::imp::required_hierarchy!(FullTrustProcessLaunchResult, IFullTrustProcessLaunchResult);
...
windows_core::imp::required_hierarchy!(LimitedAccessFeatureRequestResult, ILimitedAccessFeatureRequestResult);
...
windows_core::imp::required_hierarchy!(Package, IPackage, IPackage2, IPackage3, IPackage4, IPackage5, IPackage6, IPackage7, IPackage8, IPackage9, IPackageStatics, IPackageWithMetadata);
impl Package {
...
windows_core::imp::required_hierarchy!(PackageCatalog, IPackageCatalog, IPackageCatalog2, IPackageCatalog3, IPackageCatalog4, IPackageCatalogStatics, IPackageCatalogStatics2);
impl PackageCatalog {
...
windows_core::imp::required_hierarchy!(PackageCatalogAddOptionalPackageResult, IPackageCatalogAddOptionalPackageResult);
...
windows_core::imp::required_hierarchy!(PackageCatalogAddResourcePackageResult, IPackageCatalogAddResourcePackageResult);
...
windows_core::imp::required_hierarchy!(PackageCatalogRemoveOptionalPackagesResult, IPackageCatalogRemoveOptionalPackagesResult);
...
windows_core::imp::required_hierarchy!(PackageCatalogRemoveResourcePackagesResult, IPackageCatalogRemoveResourcePackagesResult);
...
windows_core::imp::required_hierarchy!(PackageContentGroup, IPackageContentGroup, IPackageContentGroupStatics);
...
windows_core::imp::required_hierarchy!(PackageContentGroupStagingEventArgs, IPackageContentGroupStagingEventArgs);
...
windows_core::imp::required_hierarchy!(PackageId, IPackageId, IPackageIdWithMetadata);
impl PackageId {
    pub fn Name(&self) -> windows_core::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
...
windows_core::imp::required_hierarchy!(PackageInstallingEventArgs, IPackageInstallingEventArgs);
...
windows_core::imp::required_hierarchy!(PackageStagingEventArgs, IPackageStagingEventArgs);
...
windows_core::imp::required_hierarchy!(PackageStatus, IPackageStatus, IPackageStatus2);
impl PackageStatus {
...
windows_core::imp::required_hierarchy!(PackageStatusChangedEventArgs, IPackageStatusChangedEventArgs);
...
windows_core::imp::required_hierarchy!(PackageUninstallingEventArgs, IPackageUninstallingEventArgs);
...
windows_core::imp::required_hierarchy!(PackageUpdateAvailabilityResult, IPackageUpdateAvailabilityResult);
...
windows_core::imp::required_hierarchy!(PackageUpdatingEventArgs, IPackageUpdatingEventArgs);
...
windows_core::imp::required_hierarchy!(StartupTask, IStartupTask, IStartupTaskStatics);
impl StartupTask {
