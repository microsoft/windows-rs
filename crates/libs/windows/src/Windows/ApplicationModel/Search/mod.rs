...
windows_core::imp::required_hierarchy!(LocalContentSuggestionSettings, ILocalContentSuggestionSettings);
...
#[cfg(feature = "deprecated")]
windows_core::imp::required_hierarchy!(SearchPane, ISearchPane, ISearchPaneStatics, ISearchPaneStaticsWithHideThisApplication);
#[cfg(feature = "deprecated")]
impl SearchPane {
    #[cfg(feature = "deprecated")]
...
windows_core::imp::required_hierarchy!(SearchPaneQueryLinguisticDetails, ISearchPaneQueryLinguisticDetails);
...
#[cfg(feature = "deprecated")]
windows_core::imp::required_hierarchy!(SearchPaneQuerySubmittedEventArgs, ISearchPaneQuerySubmittedEventArgs, ISearchPaneQuerySubmittedEventArgsWithLinguisticDetails);
#[cfg(feature = "deprecated")]
...
#[cfg(feature = "deprecated")]
windows_core::imp::required_hierarchy!(SearchPaneResultSuggestionChosenEventArgs, ISearchPaneResultSuggestionChosenEventArgs);
#[cfg(feature = "deprecated")]
...
#[cfg(feature = "deprecated")]
windows_core::imp::required_hierarchy!(SearchPaneSuggestionsRequest, ISearchPaneSuggestionsRequest);
#[cfg(feature = "deprecated")]
...
#[cfg(feature = "deprecated")]
windows_core::imp::required_hierarchy!(SearchPaneSuggestionsRequestDeferral, ISearchPaneSuggestionsRequestDeferral);
#[cfg(feature = "deprecated")]
...
#[cfg(feature = "deprecated")]
windows_core::imp::required_hierarchy!(SearchPaneSuggestionsRequestedEventArgs, ISearchPaneQueryChangedEventArgs, ISearchPaneSuggestionsRequestedEventArgs);
#[cfg(feature = "deprecated")]
...
#[cfg(feature = "deprecated")]
windows_core::imp::required_hierarchy!(SearchPaneVisibilityChangedEventArgs, ISearchPaneVisibilityChangedEventArgs);
#[cfg(feature = "deprecated")]
...
windows_core::imp::required_hierarchy!(SearchQueryLinguisticDetails, ISearchQueryLinguisticDetails, ISearchQueryLinguisticDetailsFactory);
...
windows_core::imp::required_hierarchy!(SearchSuggestionCollection, ISearchSuggestionCollection);
...
windows_core::imp::required_hierarchy!(SearchSuggestionsRequest, ISearchSuggestionsRequest);
...
windows_core::imp::required_hierarchy!(SearchSuggestionsRequestDeferral, ISearchSuggestionsRequestDeferral);
