...
impl windows_core::RuntimeType for IPhoneCallOrigin {
    ...
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Calls.Provider.IPhoneCallOrigin");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IPhoneCallOrigin2 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Calls.Provider.IPhoneCallOrigin2");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IPhoneCallOrigin3 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Calls.Provider.IPhoneCallOrigin3");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IPhoneCallOriginManagerStatics {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Calls.Provider.IPhoneCallOriginManagerStatics");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IPhoneCallOriginManagerStatics2 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Calls.Provider.IPhoneCallOriginManagerStatics2");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IPhoneCallOriginManagerStatics3 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Calls.Provider.IPhoneCallOriginManagerStatics3");
}
#[repr(C)]
#[doc(hidden)]
...
impl PhoneCallOrigin {
    ...
    pub fn SetCategory(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetCategory)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(value)).ok() }
    }
    pub fn CategoryDescription(&self) -> windows_core::Result<windows_core::HSTRING> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CategoryDescription)(windows_core::Interface::as_raw(self), &mut result__).map(|| core::mem::transmute(result__))
        }
    }
    pub fn SetCategoryDescription(&self, value: &windows_core::HSTRING) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetCategoryDescription)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(value)).ok() }
    }
    ...
    pub fn DisplayPicture(&self) -> windows_core::Result<super::super::super::Storage::StorageFile> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).DisplayPicture)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    #[cfg(feature = "Storage_Streams")]
...
impl PhoneCallOriginManager {
    ...
    pub fn RequestSetAsActiveCallOriginAppAsync() -> windows_core::Result<windows_future::IAsyncOperation<bool>> {
        Self::IPhoneCallOriginManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestSetAsActiveCallOriginAppAsync)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        })
    }
