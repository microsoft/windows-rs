...
impl PhoneCallOrigin {
    ...
    pub fn SetCategory(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn CategoryDescription(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCategoryDescription(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn DisplayPicture(&self) -> windows_result::Result<super::super::super::Storage::StorageFile> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetDisplayPicture<P0>(&self, value: P0) -> windows_result::Result<()>
    where
...
impl PhoneCallOriginManager {
    pub fn IsCurrentAppActiveCallOriginApp() -> windows_result::Result<bool> {
    ...
    pub fn ShowPhoneCallOriginSettingsUI() -> windows_result::Result<()> {
    ...
    pub fn SetCallOrigin<P1>(requestid: windows_core::GUID, callorigin: P1) -> windows_result::Result<()>
    where
    ...
    pub fn RequestSetAsActiveCallOriginAppAsync() -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
    ...
    fn IPhoneCallOriginManagerStatics<R, F: FnOnce(&IPhoneCallOriginManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IPhoneCallOriginManagerStatics2<R, F: FnOnce(&IPhoneCallOriginManagerStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IPhoneCallOriginManagerStatics3<R, F: FnOnce(&IPhoneCallOriginManagerStatics3) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
