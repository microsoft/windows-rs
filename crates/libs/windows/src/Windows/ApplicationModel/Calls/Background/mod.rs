...
windows_core::imp::required_hierarchy!(PhoneCallBlockedTriggerDetails, IPhoneCallBlockedTriggerDetails);
...
#[cfg(feature = "deprecated")]
windows_core::imp::required_hierarchy!(PhoneCallOriginDataRequestTriggerDetails, IPhoneCallOriginDataRequestTriggerDetails);
#[cfg(feature = "deprecated")]
...
#[cfg(feature = "deprecated")]
windows_core::imp::required_hierarchy!(PhoneIncomingCallDismissedTriggerDetails, IPhoneIncomingCallDismissedTriggerDetails);
#[cfg(feature = "deprecated")]
...
windows_core::imp::required_hierarchy!(PhoneIncomingCallNotificationTriggerDetails, IPhoneIncomingCallNotificationTriggerDetails);
...
windows_core::imp::required_hierarchy!(PhoneLineChangedTriggerDetails, IPhoneLineChangedTriggerDetails);
...
windows_core::imp::required_hierarchy!(PhoneNewVoicemailMessageTriggerDetails, IPhoneNewVoicemailMessageTriggerDetails);
