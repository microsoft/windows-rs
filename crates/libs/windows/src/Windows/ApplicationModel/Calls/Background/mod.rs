...
impl PhoneCallBlockedTriggerDetails {
    ...
    pub fn CallBlockedReason(&self) -> Result<PhoneCallBlockedReason, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PhoneCallOriginDataRequestTriggerDetails {
    pub fn RequestId(&self) -> Result<windows_core::GUID, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PhoneIncomingCallDismissedTriggerDetails {
    ...
    pub fn DismissalTime(&self) -> Result<super::super::super::Foundation::DateTime, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TextReplyMessage(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Reason(&self) -> Result<PhoneIncomingCallDismissedReason, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PhoneLineChangedTriggerDetails {
    ...
    pub fn ChangeType(&self) -> Result<PhoneLineChangeKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HasLinePropertyChanged(&self, lineproperty: PhoneLineProperties) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PhoneNewVoicemailMessageTriggerDetails {
    ...
    pub fn VoicemailCount(&self) -> Result<i32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OperatorMessage(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
