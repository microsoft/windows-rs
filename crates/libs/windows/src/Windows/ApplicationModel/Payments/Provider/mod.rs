...
impl PaymentAppManager {
    pub fn RegisterAsync<P0>(&self, supportedpaymentmethodids: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
...
impl PaymentTransaction {
    ...
    pub fn UpdateShippingAddressAsync<P0>(&self, shippingaddress: P0) -> windows_core::Result<windows_async::IAsyncOperation<super::PaymentRequestChangedResult>>
    where
    ...
    pub fn UpdateSelectedShippingOptionAsync<P0>(&self, selectedshippingoption: P0) -> windows_core::Result<windows_async::IAsyncOperation<super::PaymentRequestChangedResult>>
    where
    ...
    pub fn AcceptAsync<P0>(&self, paymenttoken: P0) -> windows_core::Result<windows_async::IAsyncOperation<PaymentTransactionAcceptResult>>
    where
    ...
    pub fn FromIdAsync(id: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<PaymentTransaction>> {
