...
impl PaymentAppCanMakePaymentTriggerDetails {
    pub fn Request(&self) -> windows_result::Result<super::PaymentRequest> {
        let this = self;
        unsafe {
    ...
    pub fn ReportCanMakePaymentResult<P0>(&self, value: P0) -> windows_result::Result<()>
    where
...
impl PaymentAppManager {
    pub fn RegisterAsync<P0>(&self, supportedpaymentmethodids: P0) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    pub fn Current() -> windows_result::Result<PaymentAppManager> {
    ...
    fn IPaymentAppManagerStatics<R, F: FnOnce(&IPaymentAppManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl PaymentTransaction {
    pub fn PaymentRequest(&self) -> windows_result::Result<super::PaymentRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PayerEmail(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPayerEmail(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn PayerName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPayerName(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn PayerPhoneNumber(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPayerPhoneNumber(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn UpdateShippingAddressAsync<P0>(&self, shippingaddress: P0) -> windows_result::Result<windows_future::IAsyncOperation<super::PaymentRequestChangedResult>>
    where
    ...
    pub fn UpdateSelectedShippingOptionAsync<P0>(&self, selectedshippingoption: P0) -> windows_result::Result<windows_future::IAsyncOperation<super::PaymentRequestChangedResult>>
    where
    ...
    pub fn AcceptAsync<P0>(&self, paymenttoken: P0) -> windows_result::Result<windows_future::IAsyncOperation<PaymentTransactionAcceptResult>>
    where
    ...
    pub fn FromIdAsync(id: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<PaymentTransaction>> {
    ...
    fn IPaymentTransactionStatics<R, F: FnOnce(&IPaymentTransactionStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl PaymentTransactionAcceptResult {
    pub fn Status(&self) -> windows_result::Result<super::PaymentRequestCompletionStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
