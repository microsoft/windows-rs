...
impl PaymentMediator {
    ...
    pub fn GetSupportedMethodIdsAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<windows_core::HSTRING>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SubmitPaymentRequestAsync<P0>(&self, paymentrequest: P0) -> windows_core::Result<windows_async::IAsyncOperation<PaymentRequestSubmitResult>>
    where
    ...
    pub fn SubmitPaymentRequestWithChangeHandlerAsync<P0, P1>(&self, paymentrequest: P0, changehandler: P1) -> windows_core::Result<windows_async::IAsyncOperation<PaymentRequestSubmitResult>>
    where
        P0: windows_core::Param<PaymentRequest>,
    ...
    pub fn CanMakePaymentAsync<P0>(&self, paymentrequest: P0) -> windows_core::Result<windows_async::IAsyncOperation<PaymentCanMakePaymentResult>>
    where
        P0: windows_core::Param<PaymentRequest>,
    {
...
impl PaymentResponse {
    ...
    pub fn CompleteAsync(&self, status: PaymentRequestCompletionStatus) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
