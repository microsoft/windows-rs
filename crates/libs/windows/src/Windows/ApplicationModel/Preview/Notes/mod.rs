...
impl NotesWindowManagerPreview {
    pub fn IsScreenLocked(&self) -> windows_core::Result<bool> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsScreenLocked)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn ShowNote(&self, noteviewid: i32) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ShowNote)(windows_core::Interface::as_raw(self), noteviewid).ok() }
    }
    pub fn ShowNoteRelativeTo(&self, noteviewid: i32, anchornoteviewid: i32) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).ShowNoteRelativeTo)(windows_core::Interface::as_raw(self), noteviewid, anchornoteviewid).ok() }
    }
    #[cfg(feature = "Storage_Streams")]
    ...
    {
        unsafe { (windows_core::Interface::vtable(self).ShowNoteWithPlacement)(windows_core::Interface::as_raw(self), noteviewid, data.param().abi()).ok() }
    }
    pub fn HideNote(&self, noteviewid: i32) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).HideNote)(windows_core::Interface::as_raw(self), noteviewid).ok() }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn GetNotePlacement(&self, noteviewid: i32) -> windows_core::Result<super::super::super::Storage::Streams::IBuffer> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).GetNotePlacement)(windows_core::Interface::as_raw(self), noteviewid, &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub fn TrySetNoteSize(&self, noteviewid: i32, size: super::super::super::Foundation::Size) -> windows_core::Result<bool> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TrySetNoteSize)(windows_core::Interface::as_raw(self), noteviewid, size, &mut result__).map(|| result__)
        }
    }
    pub fn SetFocusToNextView(&self) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetFocusToNextView)(windows_core::Interface::as_raw(self)).ok() }
    }
    #[cfg(feature = "Storage_Streams")]
        ...
        P0: windows_core::Param<super::super::super::Storage::Streams::IBuffer>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SetNotesThumbnailAsync)(windows_core::Interface::as_raw(self), thumbnail.param().abi(), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub fn SystemLockStateChanged<F>(&self, handler: F) -> windows_core::Result<windows_core::EventRevoker>
    where
        F: Fn(windows_core::Ref<Self>, windows_core::Ref<windows_core::IInspectable>) + Send + 'static,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            let token__ = (windows_core::Interface::vtable(self).SystemLockStateChanged)(windows_core::Interface::as_raw(self), windows_core::Interface::as_raw(&handler), &mut result__).map(|| result__)?;
            Ok(windows_core::EventRevoker::new(self.clone(), token__, windows_core::Interface::vtable(self).RemoveSystemLockStateChanged))
        }
    }
    pub fn NotePlacementChanged<F>(&self, handler: F) -> windows_core::Result<windows_core::EventRevoker>
    where
        F: Fn(windows_core::Ref<Self>, windows_core::Ref<NotePlacementChangedPreviewEventArgs>) + Send + 'static,
    {
        let handler = <super::super::super::Foundation::TypedEventHandler<Self, NotePlacementChangedPreviewEventArgs>>::new(move |a0, a1| {
            handler(a0, a1);
            Ok(())
        });
        unsafe {
            let mut result__ = core::mem::zeroed();
            let token__ = (windows_core::Interface::vtable(self).NotePlacementChanged)(windows_core::Interface::as_raw(self), windows_core::Interface::as_raw(&handler), &mut result__).map(|| result__)?;
            Ok(windows_core::EventRevoker::new(self.clone(), token__, windows_core::Interface::vtable(self).RemoveNotePlacementChanged))
        }
    }
    pub fn NoteVisibilityChanged<F>(&self, handler: F) -> windows_core::Result<windows_core::EventRevoker>
    where
        F: Fn(windows_core::Ref<Self>, windows_core::Ref<NoteVisibilityChangedPreviewEventArgs>) + Send + 'static,
    {
        let handler = <super::super::super::Foundation::TypedEventHandler<Self, NoteVisibilityChangedPreviewEventArgs>>::new(move |a0, a1| {
            handler(a0, a1);
            Ok(())
        });
        unsafe {
            let mut result__ = core::mem::zeroed();
            let token__ = (windows_core::Interface::vtable(self).NoteVisibilityChanged)(windows_core::Interface::as_raw(self), windows_core::Interface::as_raw(&handler), &mut result__).map(|| result__)?;
            Ok(windows_core::EventRevoker::new(self.clone(), token__, windows_core::Interface::vtable(self).RemoveNoteVisibilityChanged))
        }
    }
        ...
        P0: windows_core::Param<super::super::super::Graphics::Imaging::SoftwareBitmap>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SetThumbnailImageForTaskSwitcherAsync)(windows_core::Interface::as_raw(this), bitmap.param().abi(), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
...
impl NotesWindowManagerPreviewShowNoteOptions {
    ...
    pub fn ShowWithFocus(&self) -> windows_core::Result<bool> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ShowWithFocus)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn SetShowWithFocus(&self, value: bool) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetShowWithFocus)(windows_core::Interface::as_raw(self), value).ok() }
    }
}
