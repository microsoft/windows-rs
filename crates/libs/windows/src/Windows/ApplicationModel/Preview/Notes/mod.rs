...
impl NotesWindowManagerPreview {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetNotesThumbnailAsync<P0>(&self, thumbnail: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn SetThumbnailImageForTaskSwitcherAsync<P0>(&self, bitmap: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
