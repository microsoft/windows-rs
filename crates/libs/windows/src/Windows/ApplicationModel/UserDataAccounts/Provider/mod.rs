...
impl IUserDataAccountProviderOperation {
    pub fn Kind(&self) -> Result<UserDataAccountProviderOperationKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
...
pub trait IUserDataAccountProviderOperation_Impl: windows_core::IUnknownImpl {
    fn Kind(&self) -> Result<UserDataAccountProviderOperationKind, windows_result::HRESULT>;
}
impl IUserDataAccountProviderOperation_Vtbl {
    pub const fn new<Identity: IUserDataAccountProviderOperation_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Kind<Identity: IUserDataAccountProviderOperation_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut UserDataAccountProviderOperationKind) -> windows_result::HRESULT {
            unsafe {
...
impl UserDataAccountPartnerAccountInfo {
    ...
    pub fn Priority(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AccountKind(&self) -> Result<UserDataAccountProviderPartnerAccountKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UserDataAccountProviderAddAccountOperation {
    pub fn ContentKinds(&self) -> Result<super::UserDataAccountContentKinds, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PartnerAccountInfos(&self) -> Result<windows_collections::IVectorView<UserDataAccountPartnerAccountInfo>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReportCompleted(&self, userdataaccountid: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
