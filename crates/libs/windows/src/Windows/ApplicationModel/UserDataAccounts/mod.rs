...
windows_core::imp::required_hierarchy!(UserDataAccount, IUserDataAccount, IUserDataAccount2, IUserDataAccount3, IUserDataAccount4);
impl UserDataAccount {
    pub fn Id(&self) -> windows_core::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<IUserDataAccount>(self)?;
        unsafe {
...
windows_core::imp::required_hierarchy!(UserDataAccountManagerForUser, IUserDataAccountManagerForUser);
...
windows_core::imp::required_hierarchy!(UserDataAccountStore, IUserDataAccountStore, IUserDataAccountStore2, IUserDataAccountStore3);
impl UserDataAccountStore {
    ...
    pub fn FindAccountsAsync(&self) -> windows_core::Result<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<UserDataAccount>>> {
        let this = &windows_core::Interface::cast::<IUserDataAccountStore>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
windows_core::imp::required_hierarchy!(UserDataAccountStoreChangedEventArgs, IUserDataAccountStoreChangedEventArgs);
