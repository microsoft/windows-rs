...
impl UserDataAccount {
    ...
    #[cfg(feature = "ApplicationModel_Appointments")]
    pub fn FindAppointmentCalendarsAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<super::Appointments::AppointmentCalendar>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ApplicationModel_Email")]
    pub fn FindEmailMailboxesAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<super::Email::EmailMailbox>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ApplicationModel_Contacts")]
    pub fn FindContactListsAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<super::Contacts::ContactList>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ApplicationModel_Contacts")]
    pub fn FindContactAnnotationListsAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<super::Contacts::ContactAnnotationList>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ApplicationModel_UserDataTasks")]
    pub fn FindUserDataTaskListsAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<super::UserDataTasks::UserDataTaskList>>> {
        let this = &windows_core::Interface::cast::<IUserDataAccount4>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ApplicationModel_Contacts")]
    pub fn FindContactGroupsAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<super::Contacts::ContactGroup>>> {
        let this = &windows_core::Interface::cast::<IUserDataAccount4>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryShowCreateContactGroupAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<windows_core::HSTRING>> {
        let this = &windows_core::Interface::cast::<IUserDataAccount4>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UserDataAccountManager {
    pub fn RequestStoreAsync(storeaccesstype: UserDataAccountStoreAccessType) -> windows_core::Result<windows_async::IAsyncOperation<UserDataAccountStore>> {
    ...
    pub fn ShowAddAccountAsync(contentkinds: UserDataAccountContentKinds) -> windows_core::Result<windows_async::IAsyncOperation<windows_core::HSTRING>> {
        Self::IUserDataAccountManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowAccountSettingsAsync(id: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncAction> {
        Self::IUserDataAccountManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowAccountErrorResolverAsync(id: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncAction> {
        Self::IUserDataAccountManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UserDataAccountManagerForUser {
    pub fn RequestStoreAsync(&self, storeaccesstype: UserDataAccountStoreAccessType) -> windows_core::Result<windows_async::IAsyncOperation<UserDataAccountStore>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestStoreAsync)(windows_core::Interface::as_raw(this), storeaccesstype, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl UserDataAccountStore {
    pub fn FindAccountsAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<UserDataAccount>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAccountAsync(&self, id: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<UserDataAccount>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateAccountAsync(&self, userdisplayname: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<UserDataAccount>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateAccountWithPackageRelativeAppIdAsync(&self, userdisplayname: &windows_core::HSTRING, packagerelativeappid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<UserDataAccount>> {
    ...
    pub fn CreateAccountWithPackageRelativeAppIdAndEnterpriseIdAsync(&self, userdisplayname: &windows_core::HSTRING, packagerelativeappid: &windows_core::HSTRING, enterpriseid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<UserDataAccount>> {
