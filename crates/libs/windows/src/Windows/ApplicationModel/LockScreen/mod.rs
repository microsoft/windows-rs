...
impl LockApplicationHost {
    pub fn RequestUnlock(&self) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RequestUnlock)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn Unlocking<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveUnlocking(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveUnlocking)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GetForCurrentView() -> windows_result::Result<LockApplicationHost> {
        Self::ILockApplicationHostStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForCurrentView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn ILockApplicationHostStatics<R, F: FnOnce(&ILockApplicationHostStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl LockScreenBadge {
    #[cfg(feature = "Storage_Streams")]
    pub fn Logo(&self) -> windows_result::Result<super::super::Storage::Streams::IRandomAccessStream> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Glyph(&self) -> windows_result::Result<super::super::Storage::Streams::IRandomAccessStream> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Number(&self) -> windows_result::Result<super::super::Foundation::IReference<u32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AutomationName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LaunchApp(&self) -> windows_result::Result<()> {
        let this = self;
...
impl LockScreenInfo {
    pub fn LockScreenImageChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveLockScreenImageChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveLockScreenImageChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn LockScreenImage(&self) -> windows_result::Result<super::super::Storage::Streams::IRandomAccessStream> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BadgesChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<LockScreenInfo, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveBadgesChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveBadgesChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn Badges(&self) -> windows_result::Result<windows_collections::IVectorView<LockScreenBadge>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DetailTextChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<LockScreenInfo, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveDetailTextChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveDetailTextChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn DetailText(&self) -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AlarmIconChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<LockScreenInfo, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveAlarmIconChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveAlarmIconChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn AlarmIcon(&self) -> windows_result::Result<super::super::Storage::Streams::IRandomAccessStream> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl LockScreenUnlockingEventArgs {
    pub fn GetDeferral(&self) -> windows_result::Result<LockScreenUnlockingDeferral> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
