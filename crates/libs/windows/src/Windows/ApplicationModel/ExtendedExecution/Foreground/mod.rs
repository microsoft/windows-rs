...
impl ExtendedExecutionForegroundRevokedEventArgs {
    pub fn Reason(&self) -> windows_result::Result<ExtendedExecutionForegroundRevokedReason> {
        let this = self;
        unsafe {
...
impl ExtendedExecutionForegroundSession {
    ...
    pub fn RequestExtensionAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<ExtendedExecutionForegroundResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Reason(&self) -> windows_result::Result<ExtendedExecutionForegroundReason> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Reason)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn SetReason(&self, value: ExtendedExecutionForegroundReason) -> windows_result::Result<()> {
        let this = self;
