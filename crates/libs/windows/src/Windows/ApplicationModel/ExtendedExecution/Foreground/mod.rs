...
windows_core::imp::required_hierarchy!(ExtendedExecutionForegroundRevokedEventArgs, IExtendedExecutionForegroundRevokedEventArgs);
...
windows_core::imp::required_hierarchy!(ExtendedExecutionForegroundSession, IExtendedExecutionForegroundSession, super::super::super::Foundation::IClosable);
