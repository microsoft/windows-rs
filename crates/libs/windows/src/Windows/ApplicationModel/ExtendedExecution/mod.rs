...
impl ExtendedExecutionRevokedEventArgs {
    pub fn Reason(&self) -> windows_result::Result<ExtendedExecutionRevokedReason> {
        let this = self;
        unsafe {
...
impl ExtendedExecutionSession {
    ...
    pub fn Reason(&self) -> windows_result::Result<ExtendedExecutionReason> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Reason)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn SetReason(&self, value: ExtendedExecutionReason) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn PercentProgress(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPercentProgress(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetPercentProgress)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Revoked<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveRevoked(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveRevoked)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn RequestExtensionAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<ExtendedExecutionResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
