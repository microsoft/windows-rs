...
impl CommunicationBlockingAccessManager {
    pub fn IsBlockingActive() -> windows_result::Result<bool> {
    ...
    pub fn IsBlockedNumberAsync(number: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        Self::ICommunicationBlockingAccessManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowBlockNumbersUI<P0>(phonenumbers: P0) -> windows_result::Result<bool>
    where
    ...
    pub fn ShowUnblockNumbersUI<P0>(phonenumbers: P0) -> windows_result::Result<bool>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        Self::ICommunicationBlockingAccessManagerStatics(|this| unsafe {
    ...
    pub fn ShowBlockedCallsUI() -> windows_result::Result<()> {
    ...
    pub fn ShowBlockedMessagesUI() -> windows_result::Result<()> {
    ...
    fn ICommunicationBlockingAccessManagerStatics<R, F: FnOnce(&ICommunicationBlockingAccessManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl CommunicationBlockingAppManager {
    pub fn IsCurrentAppActiveBlockingApp() -> windows_result::Result<bool> {
    ...
    pub fn ShowCommunicationBlockingSettingsUI() -> windows_result::Result<()> {
    ...
    pub fn RequestSetAsActiveBlockingAppAsync() -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
    ...
    fn ICommunicationBlockingAppManagerStatics<R, F: FnOnce(&ICommunicationBlockingAppManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn ICommunicationBlockingAppManagerStatics2<R, F: FnOnce(&ICommunicationBlockingAppManagerStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
