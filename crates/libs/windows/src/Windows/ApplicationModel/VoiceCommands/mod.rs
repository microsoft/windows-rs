...
impl VoiceCommand {
    pub fn CommandName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn Properties(&self) -> Result<windows_collections::IMapView<windows_core::HSTRING, windows_collections::IVectorView<windows_core::HSTRING>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media_SpeechRecognition")]
    pub fn SpeechRecognitionResult(&self) -> Result<super::super::Media::SpeechRecognition::SpeechRecognitionResult, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VoiceCommandCompletedEventArgs {
    pub fn Reason(&self) -> Result<VoiceCommandCompletionReason, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VoiceCommandConfirmationResult {
    pub fn Confirmed(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VoiceCommandContentTile {
    ...
    pub fn TextLine1(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTextLine1(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn TextLine2(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTextLine2(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn TextLine3(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTextLine3(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Image(&self) -> Result<super::super::Storage::IStorageFile, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetImage<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn AppContext(&self) -> Result<windows_core::IInspectable, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAppContext<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn AppLaunchArgument(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAppLaunchArgument(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn ContentTileType(&self) -> Result<VoiceCommandContentTileType, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetContentTileType(&self, value: VoiceCommandContentTileType) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl VoiceCommandDefinition {
    ...
    pub fn SetPhraseListAsync<P1>(&self, phraselistname: &windows_core::HSTRING, phraselist: P1) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
...
impl VoiceCommandDefinitionManager {
    #[cfg(feature = "Storage_Streams")]
    pub fn InstallCommandDefinitionsFromStorageFileAsync<P0>(file: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
    ...
    pub fn InstalledCommandDefinitions() -> Result<windows_collections::IMapView<windows_core::HSTRING, VoiceCommandDefinition>, windows_result::HRESULT> {
        Self::IVoiceCommandDefinitionManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IVoiceCommandDefinitionManagerStatics<R, F: FnOnce(&IVoiceCommandDefinitionManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl VoiceCommandDisambiguationResult {
    pub fn SelectedItem(&self) -> Result<VoiceCommandContentTile, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VoiceCommandResponse {
    pub fn Message(&self) -> Result<VoiceCommandUserMessage, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMessage<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn RepeatMessage(&self) -> Result<VoiceCommandUserMessage, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRepeatMessage<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<VoiceCommandUserMessage>,
    {
        let this = self;
    ...
    pub fn VoiceCommandContentTiles(&self) -> Result<windows_collections::IVector<VoiceCommandContentTile>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MaxSupportedVoiceCommandContentTiles() -> Result<u32, windows_result::HRESULT> {
    ...
    pub fn CreateResponse<P0>(usermessage: P0) -> Result<VoiceCommandResponse, windows_result::HRESULT>
    where
        P0: windows_core::Param<VoiceCommandUserMessage>,
    {
        Self::IVoiceCommandResponseStatics(|this| unsafe {
    ...
    pub fn CreateResponseWithTiles<P0, P1>(message: P0, contenttiles: P1) -> Result<VoiceCommandResponse, windows_result::HRESULT>
    where
        P0: windows_core::Param<VoiceCommandUserMessage>,
    ...
    pub fn CreateResponseForPrompt<P0, P1>(message: P0, repeatmessage: P1) -> Result<VoiceCommandResponse, windows_result::HRESULT>
    where
        P0: windows_core::Param<VoiceCommandUserMessage>,
    ...
    pub fn CreateResponseForPromptWithTiles<P0, P1, P2>(message: P0, repeatmessage: P1, contenttiles: P2) -> Result<VoiceCommandResponse, windows_result::HRESULT>
    where
        P0: windows_core::Param<VoiceCommandUserMessage>,
        P1: windows_core::Param<VoiceCommandUserMessage>,
    ...
    fn IVoiceCommandResponseStatics<R, F: FnOnce(&IVoiceCommandResponseStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl VoiceCommandServiceConnection {
    pub fn GetVoiceCommandAsync(&self) -> Result<windows_future::IAsyncOperation<VoiceCommand>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestConfirmationAsync<P0>(&self, response: P0) -> Result<windows_future::IAsyncOperation<VoiceCommandConfirmationResult>, windows_result::HRESULT>
    where
    ...
    pub fn RequestDisambiguationAsync<P0>(&self, response: P0) -> Result<windows_future::IAsyncOperation<VoiceCommandDisambiguationResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<VoiceCommandResponse>,
    {
        let this = self;
    ...
    pub fn ReportProgressAsync<P0>(&self, response: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<VoiceCommandResponse>,
    {
        let this = self;
    ...
    pub fn ReportSuccessAsync<P0>(&self, response: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<VoiceCommandResponse>,
    {
        let this = self;
    ...
    pub fn ReportFailureAsync<P0>(&self, response: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<VoiceCommandResponse>,
    {
        let this = self;
    ...
    pub fn RequestAppLaunchAsync<P0>(&self, response: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<VoiceCommandResponse>,
    {
        let this = self;
    ...
    #[cfg(feature = "Globalization")]
    pub fn Language(&self) -> Result<super::super::Globalization::Language, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn VoiceCommandCompleted<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveVoiceCommandCompleted(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveVoiceCommandCompleted)(windows_core::Interface::as_raw(this), token).ok() }
    }
    #[cfg(feature = "ApplicationModel_AppService")]
    pub fn FromAppServiceTriggerDetails<P0>(triggerdetails: P0) -> Result<VoiceCommandServiceConnection, windows_result::HRESULT>
    where
    ...
    fn IVoiceCommandServiceConnectionStatics<R, F: FnOnce(&IVoiceCommandServiceConnectionStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl VoiceCommandUserMessage {
    ...
    pub fn SpokenMessage(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSpokenMessage(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
