...
impl ActivationSignalDetectionConfiguration {
    pub fn SignalId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn ModelId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetEnabledAsync(&self, value: bool) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AvailabilityInfo(&self) -> Result<DetectionConfigurationAvailabilityInfo, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AvailabilityChanged<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveAvailabilityChanged(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveAvailabilityChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn SetModelData<P1>(&self, datatype: &windows_core::HSTRING, data: P1) -> Result<(), windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetModelDataAsync<P1>(&self, datatype: &windows_core::HSTRING, data: P1) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IInputStream>,
    {
        let this = self;
    ...
    pub fn GetModelDataType(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetModelDataTypeAsync(&self) -> Result<windows_future::IAsyncOperation<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetModelData(&self) -> Result<super::super::Storage::Streams::IInputStream, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetModelDataAsync(&self) -> Result<windows_future::IAsyncOperation<super::super::Storage::Streams::IInputStream>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ClearModelData(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).ClearModelData)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn ClearModelDataAsync(&self) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TrainingStepsCompleted(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TrainingStepsRemaining(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TrainingDataFormat(&self) -> Result<ActivationSignalDetectionTrainingDataFormat, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ApplyTrainingData<P1>(&self, trainingdataformat: ActivationSignalDetectionTrainingDataFormat, trainingdata: P1) -> Result<DetectionConfigurationTrainingStatus, windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IInputStream>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ApplyTrainingDataAsync<P1>(&self, trainingdataformat: ActivationSignalDetectionTrainingDataFormat, trainingdata: P1) -> Result<windows_future::IAsyncOperation<DetectionConfigurationTrainingStatus>, windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IInputStream>,
    {
        let this = self;
    ...
    pub fn ClearTrainingData(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).ClearTrainingData)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn ClearTrainingDataAsync(&self) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetModelDataWithResult<P1>(&self, datatype: &windows_core::HSTRING, data: P1) -> Result<ActivationSignalDetectionConfigurationSetModelDataResult, windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IInputStream>,
    {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetModelDataWithResultAsync<P1>(&self, datatype: &windows_core::HSTRING, data: P1) -> Result<windows_future::IAsyncOperation<ActivationSignalDetectionConfigurationSetModelDataResult>, windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IInputStream>,
    {
        let this = &windows_core::Interface::cast::<IActivationSignalDetectionConfiguration2>(self)?;
    ...
    pub fn SetEnabledWithResultAsync(&self, value: bool) -> Result<windows_future::IAsyncOperation<ActivationSignalDetectionConfigurationStateChangeResult>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IActivationSignalDetectionConfiguration2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetEnabledWithResult(&self, value: bool) -> Result<ActivationSignalDetectionConfigurationStateChangeResult, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IActivationSignalDetectionConfiguration2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TrainingStepCompletionMaxAllowedTime(&self) -> Result<u32, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IActivationSignalDetectionConfiguration2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ActivationSignalDetectionConfigurationCreationResult {
    pub fn Status(&self) -> Result<ActivationSignalDetectionConfigurationCreationStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Configuration(&self) -> Result<ActivationSignalDetectionConfiguration, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ActivationSignalDetector {
    pub fn ProviderId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Kind(&self) -> Result<ActivationSignalDetectorKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanCreateConfigurations(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SupportedModelDataTypes(&self) -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SupportedTrainingDataFormats(&self) -> Result<windows_collections::IVectorView<ActivationSignalDetectionTrainingDataFormat>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SupportedPowerStates(&self) -> Result<windows_collections::IVectorView<ActivationSignalDetectorPowerState>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetSupportedModelIdsForSignalId(&self, signalid: &windows_core::HSTRING) -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetSupportedModelIdsForSignalIdAsync(&self, signalid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<windows_core::HSTRING>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateConfiguration(&self, signalid: &windows_core::HSTRING, modelid: &windows_core::HSTRING, displayname: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn CreateConfigurationAsync(&self, signalid: &windows_core::HSTRING, modelid: &windows_core::HSTRING, displayname: &windows_core::HSTRING) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetConfigurations(&self) -> Result<windows_collections::IVectorView<ActivationSignalDetectionConfiguration>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetConfigurationsAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<ActivationSignalDetectionConfiguration>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetConfiguration(&self, signalid: &windows_core::HSTRING, modelid: &windows_core::HSTRING) -> Result<ActivationSignalDetectionConfiguration, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetConfigurationAsync(&self, signalid: &windows_core::HSTRING, modelid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<ActivationSignalDetectionConfiguration>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RemoveConfiguration(&self, signalid: &windows_core::HSTRING, modelid: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn RemoveConfigurationAsync(&self, signalid: &windows_core::HSTRING, modelid: &windows_core::HSTRING) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAvailableModelIdsForSignalIdAsync(&self, signalid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<windows_collections::IVector<windows_core::HSTRING>>, windows_result::HRESULT> {
    ...
    pub fn GetAvailableModelIdsForSignalId(&self, signalid: &windows_core::HSTRING) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IActivationSignalDetector2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateConfigurationWithResultAsync(&self, signalid: &windows_core::HSTRING, modelid: &windows_core::HSTRING, displayname: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<ActivationSignalDetectionConfigurationCreationResult>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IActivationSignalDetector2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateConfigurationWithResult(&self, signalid: &windows_core::HSTRING, modelid: &windows_core::HSTRING, displayname: &windows_core::HSTRING) -> Result<ActivationSignalDetectionConfigurationCreationResult, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IActivationSignalDetector2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RemoveConfigurationWithResultAsync(&self, signalid: &windows_core::HSTRING, modelid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<ActivationSignalDetectionConfigurationRemovalResult>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IActivationSignalDetector2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RemoveConfigurationWithResult(&self, signalid: &windows_core::HSTRING, modelid: &windows_core::HSTRING) -> Result<ActivationSignalDetectionConfigurationRemovalResult, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IActivationSignalDetector2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DetectorId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IActivationSignalDetector2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ConversationalAgentDetectorManager {
    pub fn GetAllActivationSignalDetectors(&self) -> Result<windows_collections::IVectorView<ActivationSignalDetector>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAllActivationSignalDetectorsAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<ActivationSignalDetector>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetActivationSignalDetectors(&self, kind: ActivationSignalDetectorKind) -> Result<windows_collections::IVectorView<ActivationSignalDetector>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetActivationSignalDetectorsAsync(&self, kind: ActivationSignalDetectorKind) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<ActivationSignalDetector>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetActivationSignalDetectorFromId(&self, detectorid: &windows_core::HSTRING) -> Result<ActivationSignalDetector, windows_result::HRESULT> {
    ...
    pub fn GetActivationSignalDetectorFromIdAsync(&self, detectorid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<ActivationSignalDetector>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IConversationalAgentDetectorManager2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Default() -> Result<ConversationalAgentDetectorManager, windows_result::HRESULT> {
    ...
    fn IConversationalAgentDetectorManagerStatics<R, F: FnOnce(&IConversationalAgentDetectorManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl ConversationalAgentSession {
    ...
    pub fn SessionInterrupted<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveSessionInterrupted(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveSessionInterrupted)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn SignalDetected<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveSignalDetected(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveSignalDetected)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn SystemStateChanged<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveSystemStateChanged(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveSystemStateChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn AgentState(&self) -> Result<ConversationalAgentState, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Signal(&self) -> Result<ConversationalAgentSignal, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsIndicatorLightAvailable(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsScreenAvailable(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsUserAuthenticated(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsVoiceActivationAvailable(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsInterruptible(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsInterrupted(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestInterruptibleAsync(&self, interruptible: bool) -> Result<windows_future::IAsyncOperation<ConversationalAgentSessionUpdateResponse>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestInterruptible(&self, interruptible: bool) -> Result<ConversationalAgentSessionUpdateResponse, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestAgentStateChangeAsync(&self, state: ConversationalAgentState) -> Result<windows_future::IAsyncOperation<ConversationalAgentSessionUpdateResponse>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestAgentStateChange(&self, state: ConversationalAgentState) -> Result<ConversationalAgentSessionUpdateResponse, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestForegroundActivationAsync(&self) -> Result<windows_future::IAsyncOperation<ConversationalAgentSessionUpdateResponse>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestForegroundActivation(&self) -> Result<ConversationalAgentSessionUpdateResponse, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAudioClientAsync(&self) -> Result<windows_future::IAsyncOperation<windows_core::IInspectable>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAudioClient(&self) -> Result<windows_core::IInspectable, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateAudioDeviceInputNodeAsync<P0>(&self, graph: P0) -> Result<windows_future::IAsyncOperation<super::super::Media::Audio::AudioDeviceInputNode>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Media_Audio")]
    pub fn CreateAudioDeviceInputNode<P0>(&self, graph: P0) -> Result<super::super::Media::Audio::AudioDeviceInputNode, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Media::Audio::AudioGraph>,
    {
        let this = self;
    ...
    pub fn GetAudioCaptureDeviceIdAsync(&self) -> Result<windows_future::IAsyncOperation<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAudioCaptureDeviceId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAudioRenderDeviceIdAsync(&self) -> Result<windows_future::IAsyncOperation<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAudioRenderDeviceId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetSignalModelIdAsync(&self) -> Result<windows_future::IAsyncOperation<u32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetSignalModelId(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSignalModelIdAsync(&self, signalmodelid: u32) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSignalModelId(&self, signalmodelid: u32) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetSupportedSignalModelIdsAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<u32>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetSupportedSignalModelIds(&self) -> Result<windows_collections::IVectorView<u32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestActivationAsync(&self, activationkind: ConversationalAgentActivationKind) -> Result<windows_future::IAsyncOperation<ConversationalAgentActivationResult>, windows_result::HRESULT> {
    ...
    pub fn RequestActivation(&self, activationkind: ConversationalAgentActivationKind) -> Result<ConversationalAgentActivationResult, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IConversationalAgentSession2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSupportLockScreenActivationAsync(&self, lockscreenactivationsupported: bool) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IConversationalAgentSession2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSupportLockScreenActivation(&self, lockscreenactivationsupported: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IConversationalAgentSession2>(self)?;
    ...
    pub fn GetMissingPrerequisites(&self) -> Result<windows_collections::IVectorView<ConversationalAgentVoiceActivationPrerequisiteKind>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IConversationalAgentSession2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMissingPrerequisitesAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<ConversationalAgentVoiceActivationPrerequisiteKind>>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IConversationalAgentSession2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetCurrentSessionAsync() -> Result<windows_future::IAsyncOperation<ConversationalAgentSession>, windows_result::HRESULT> {
    ...
    pub fn GetCurrentSessionSync() -> Result<ConversationalAgentSession, windows_result::HRESULT> {
        Self::IConversationalAgentSessionStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IConversationalAgentSessionStatics<R, F: FnOnce(&IConversationalAgentSessionStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl ConversationalAgentSignal {
    pub fn IsSignalVerificationRequired(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsSignalVerificationRequired(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn SetSignalId(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn SignalName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSignalName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn SignalContext(&self) -> Result<windows_core::IInspectable, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSignalContext<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn SignalStart(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSignalStart(&self, value: super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSignalStart)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SignalEnd(&self) -> Result<super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSignalEnd(&self, value: super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn DetectorKind(&self) -> Result<ActivationSignalDetectorKind, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IConversationalAgentSignal2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ConversationalAgentSystemStateChangedEventArgs {
    pub fn SystemStateChangeType(&self) -> Result<ConversationalAgentSystemStateChangeType, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DetectionConfigurationAvailabilityChangedEventArgs {
    pub fn Kind(&self) -> Result<DetectionConfigurationAvailabilityChangeKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Kind)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl DetectionConfigurationAvailabilityInfo {
    ...
    pub fn HasSystemResourceAccess(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HasPermission(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HasLockScreenPermission(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UnavailableSystemResources(&self) -> Result<windows_collections::IVectorView<SignalDetectorResourceKind>, windows_result::HRESULT> {
