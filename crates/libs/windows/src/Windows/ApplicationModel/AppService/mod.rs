...
impl AppServiceCatalog {
    pub fn FindAppServiceProvidersAsync(appservicename: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::AppInfo>>> {
    ...
    fn IAppServiceCatalogStatics<R, F: FnOnce(&IAppServiceCatalogStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl AppServiceClosedEventArgs {
    pub fn Status(&self) -> windows_result::Result<AppServiceClosedStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppServiceConnection {
    ...
    pub fn AppServiceName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAppServiceName(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn OpenAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<AppServiceConnectionStatus>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SendMessageAsync<P0>(&self, message: P0) -> windows_result::Result<windows_future::IAsyncOperation<AppServiceResponse>>
    where
    ...
    pub fn ServiceClosed<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveServiceClosed(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn OpenRemoteAsync<P0>(&self, remotesystemconnectionrequest: P0) -> windows_result::Result<windows_future::IAsyncOperation<AppServiceConnectionStatus>>
    where
    ...
    #[cfg(feature = "System")]
    pub fn SetUser<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn SendStatelessMessageAsync<P0, P1, P2>(connection: P0, connectionrequest: P1, message: P2) -> windows_result::Result<windows_future::IAsyncOperation<StatelessAppServiceResponse>>
    where
    ...
    fn IAppServiceConnectionStatics<R, F: FnOnce(&IAppServiceConnectionStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl AppServiceRequest {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn SendResponseAsync<P0>(&self, message: P0) -> windows_result::Result<windows_future::IAsyncOperation<AppServiceResponseStatus>>
    where
        P0: windows_core::Param<super::super::Foundation::Collections::ValueSet>,
    {
        let this = self;
...
impl AppServiceRequestReceivedEventArgs {
    pub fn Request(&self) -> windows_result::Result<AppServiceRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDeferral(&self) -> windows_result::Result<AppServiceDeferral> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppServiceResponse {
    ...
    pub fn Status(&self) -> windows_result::Result<AppServiceResponseStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl AppServiceTriggerDetails {
    ...
    pub fn AppServiceConnection(&self) -> windows_result::Result<AppServiceConnection> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsRemoteSystemConnection(&self) -> windows_result::Result<bool> {
    ...
    pub fn CheckCallerForCapabilityAsync(&self, capabilityname: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
    ...
    pub fn CallerRemoteConnectionToken(&self) -> windows_result::Result<windows_core::HSTRING> {
...
impl StatelessAppServiceResponse {
    ...
    pub fn Status(&self) -> windows_result::Result<StatelessAppServiceResponseStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
