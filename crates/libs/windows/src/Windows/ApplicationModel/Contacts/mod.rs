...
impl AggregateContactManager {
    pub fn FindRawContactsAsync<P0>(&self, contact: P0) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<Contact>>, windows_result::HRESULT>
    where
    ...
    pub fn TryLinkContactsAsync<P0, P1>(&self, primarycontact: P0, secondarycontact: P1) -> Result<windows_future::IAsyncOperation<Contact>, windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    ...
    pub fn UnlinkRawContactAsync<P0>(&self, contact: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
        let this = self;
    ...
    pub fn TrySetPreferredSourceForPictureAsync<P0, P1>(&self, aggregatecontact: P0, rawcontact: P1) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
        P1: windows_core::Param<Contact>,
    {
    ...
    pub fn SetRemoteIdentificationInformationAsync(&self, contactlistid: &windows_core::HSTRING, remotesourceid: &windows_core::HSTRING, accountid: &windows_core::HSTRING) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
...
impl Contact {
    ...
    pub fn Fields(&self) -> Result<windows_collections::IVector<IContactField>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Notes(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetNotes(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetNotes)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(value)).ok() }
    }
    pub fn Phones(&self) -> Result<windows_collections::IVector<ContactPhone>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Emails(&self) -> Result<windows_collections::IVector<ContactEmail>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Addresses(&self) -> Result<windows_collections::IVector<ContactAddress>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ConnectedServiceAccounts(&self) -> Result<windows_collections::IVector<ContactConnectedServiceAccount>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ImportantDates(&self) -> Result<windows_collections::IVector<ContactDate>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DataSuppliers(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn JobInfo(&self) -> Result<windows_collections::IVector<ContactJobInfo>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SignificantOthers(&self) -> Result<windows_collections::IVector<ContactSignificantOther>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Websites(&self) -> Result<windows_collections::IVector<ContactWebsite>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ContactListId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn DisplayPictureUserUpdateTime(&self) -> Result<super::super::Foundation::DateTime, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDisplayPictureUserUpdateTime(&self, value: super::super::Foundation::DateTime) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetDisplayPictureUserUpdateTime)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsMe(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AggregateId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RingToneToken(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRingToneToken(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
    ...
    pub fn IsDisplayPictureManuallySet(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LargeDisplayPicture(&self) -> Result<super::super::Storage::Streams::IRandomAccessStreamReference, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SmallDisplayPicture(&self) -> Result<super::super::Storage::Streams::IRandomAccessStreamReference, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SourceDisplayPicture(&self) -> Result<super::super::Storage::Streams::IRandomAccessStreamReference, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetSourceDisplayPicture<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
    {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
    ...
    pub fn TextToneToken(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTextToneToken(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
    ...
    pub fn IsAggregate(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DisplayNameOverride(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDisplayNameOverride(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
    ...
    pub fn SetNickname(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
    ...
    pub fn SortName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContact3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetFirstName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactName>(self)?;
    ...
    pub fn LastName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactName>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetLastName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactName>(self)?;
    ...
    pub fn MiddleName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactName>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMiddleName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactName>(self)?;
    ...
    pub fn YomiGivenName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactName>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetYomiGivenName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactName>(self)?;
    ...
    pub fn YomiFamilyName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactName>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetYomiFamilyName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactName>(self)?;
    ...
    pub fn HonorificNameSuffix(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactName>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetHonorificNameSuffix(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactName>(self)?;
    ...
    pub fn HonorificNamePrefix(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactName>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetHonorificNamePrefix(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactName>(self)?;
    ...
    pub fn YomiDisplayName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactName>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ContactAddress {
    ...
    pub fn Kind(&self) -> Result<ContactAddressKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetKind(&self, value: ContactAddressKind) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl ContactAnnotation {
    ...
    pub fn AnnotationListId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SupportedOperations(&self) -> Result<ContactAnnotationOperations, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSupportedOperations(&self, value: ContactAnnotationOperations) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSupportedOperations)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsDisabled(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn ProviderProperties(&self) -> Result<super::super::Foundation::Collections::ValueSet, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ProviderProperties)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SetContactListId(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactAnnotation2>(self)?;
...
impl ContactAnnotationList {
    ...
    pub fn ProviderPackageFamilyName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TrySaveAnnotationAsync<P0>(&self, annotation: P0) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
    ...
    pub fn GetAnnotationAsync(&self, annotationid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<ContactAnnotation>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAnnotationsByRemoteIdAsync(&self, remoteid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<ContactAnnotation>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAnnotationsAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<ContactAnnotation>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeleteAnnotationAsync<P0>(&self, annotation: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<ContactAnnotation>,
    {
        let this = self;
...
impl ContactAnnotationStore {
    pub fn FindContactIdsByEmailAsync(&self, emailaddress: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<windows_core::HSTRING>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindContactIdsByPhoneNumberAsync(&self, phonenumber: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<windows_core::HSTRING>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAnnotationsForContactAsync<P0>(&self, contact: P0) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<ContactAnnotation>>, windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
        let this = self;
    ...
    pub fn DisableAnnotationAsync<P0>(&self, annotation: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<ContactAnnotation>,
    {
        let this = self;
    ...
    pub fn CreateAnnotationListAsync(&self) -> Result<windows_future::IAsyncOperation<ContactAnnotationList>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateAnnotationListInAccountAsync(&self, userdataaccountid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<ContactAnnotationList>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetAnnotationListAsync(&self, annotationlistid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<ContactAnnotationList>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAnnotationListsAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<ContactAnnotationList>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAnnotationsForContactListAsync(&self, contactlistid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<ContactAnnotation>>, windows_result::HRESULT> {
...
impl ContactBatch {
    pub fn Contacts(&self) -> Result<windows_collections::IVectorView<Contact>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Status(&self) -> Result<ContactBatchStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ContactCardDelayedDataLoader {
    ...
    pub fn SetData<P0>(&self, contact: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
        let this = self;
...
impl ContactCardOptions {
    ...
    pub fn HeaderKind(&self) -> Result<ContactCardHeaderKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetHeaderKind(&self, value: ContactCardHeaderKind) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetHeaderKind)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn InitialTabKind(&self) -> Result<ContactCardTabKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetInitialTabKind(&self, value: ContactCardTabKind) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetInitialTabKind)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ServerSearchContactListIds(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
...
impl ContactChange {
    ...
    pub fn Contact(&self) -> Result<Contact, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ContactChangeReader {
    ...
    pub fn ReadBatchAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<ContactChange>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ContactChangeTracker {
    ...
    pub fn GetChangeReader(&self) -> Result<ContactChangeReader, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ContactChangedEventArgs {
    pub fn GetDeferral(&self) -> Result<ContactChangedDeferral, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ContactDate {
    ...
    pub fn Day(&self) -> Result<super::super::Foundation::IReference<u32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Month(&self) -> Result<super::super::Foundation::IReference<u32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Year(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetYear<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn Kind(&self) -> Result<ContactDateKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Kind)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn SetKind(&self, value: ContactDateKind) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetKind)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Description(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
...
impl ContactEmail {
    ...
    pub fn Kind(&self) -> Result<ContactEmailKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Kind)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn SetKind(&self, value: ContactEmailKind) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetKind)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Description(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
...
impl ContactField {
    pub fn Type(&self) -> Result<ContactFieldType, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Category(&self) -> Result<ContactFieldCategory, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateField_Default(value: &windows_core::HSTRING, r#type: ContactFieldType) -> Result<ContactField, windows_result::HRESULT> {
    ...
    pub fn CreateField_Category(value: &windows_core::HSTRING, r#type: ContactFieldType, category: ContactFieldCategory) -> Result<ContactField, windows_result::HRESULT> {
        Self::IContactFieldFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateField_Custom(name: &windows_core::HSTRING, value: &windows_core::HSTRING, r#type: ContactFieldType, category: ContactFieldCategory) -> Result<ContactField, windows_result::HRESULT> {
        Self::IContactFieldFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IContactFieldFactory<R, F: FnOnce(&IContactFieldFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl ContactFieldFactory {
    ...
    pub fn CreateField_Default(&self, value: &windows_core::HSTRING, r#type: ContactFieldType) -> Result<ContactField, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateField_Default)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(value), r#type, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CreateField_Category(&self, value: &windows_core::HSTRING, r#type: ContactFieldType, category: ContactFieldCategory) -> Result<ContactField, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateField_Category)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(value), r#type, category, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CreateField_Custom(&self, name: &windows_core::HSTRING, value: &windows_core::HSTRING, r#type: ContactFieldType, category: ContactFieldCategory) -> Result<ContactField, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateField_Custom)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(name), core::mem::transmute_copy(value), r#type, category, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn CreateInstantMessage_Default(&self, username: &windows_core::HSTRING) -> Result<ContactInstantMessageField, windows_result::HRESULT> {
    ...
    pub fn CreateInstantMessage_Category(&self, username: &windows_core::HSTRING, category: ContactFieldCategory) -> Result<ContactInstantMessageField, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactInstantMessageFieldFactory>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateInstantMessage_All<P4>(&self, username: &windows_core::HSTRING, category: ContactFieldCategory, service: &windows_core::HSTRING, displaytext: &windows_core::HSTRING, verb: P4) -> Result<ContactInstantMessageField, windows_result::HRESULT>
    where
    ...
    pub fn CreateLocation_Default(&self, unstructuredaddress: &windows_core::HSTRING) -> Result<ContactLocationField, windows_result::HRESULT> {
    ...
    pub fn CreateLocation_Category(&self, unstructuredaddress: &windows_core::HSTRING, category: ContactFieldCategory) -> Result<ContactLocationField, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactLocationFieldFactory>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateLocation_All(&self, unstructuredaddress: &windows_core::HSTRING, category: ContactFieldCategory, street: &windows_core::HSTRING, city: &windows_core::HSTRING, region: &windows_core::HSTRING, country: &windows_core::HSTRING, postalcode: &windows_core::HSTRING) -> Result<ContactLocationField, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactLocationFieldFactory>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ContactInformation {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetThumbnailAsync(&self) -> Result<windows_future::IAsyncOperation<super::super::Storage::Streams::IRandomAccessStreamWithContentType>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Emails(&self) -> Result<windows_collections::IVectorView<ContactField>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Emails)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn PhoneNumbers(&self) -> Result<windows_collections::IVectorView<ContactField>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Locations(&self) -> Result<windows_collections::IVectorView<ContactLocationField>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn InstantMessages(&self) -> Result<windows_collections::IVectorView<ContactInstantMessageField>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CustomFields(&self) -> Result<windows_collections::IVectorView<ContactField>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn QueryCustomFields(&self, customname: &windows_core::HSTRING) -> Result<windows_collections::IVectorView<ContactField>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ContactInstantMessageField {
    ...
    pub fn Service(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LaunchUri(&self) -> Result<super::super::Foundation::Uri, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateInstantMessage_Default(username: &windows_core::HSTRING) -> Result<ContactInstantMessageField, windows_result::HRESULT> {
        Self::IContactInstantMessageFieldFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateInstantMessage_Default)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(username), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn CreateInstantMessage_Category(username: &windows_core::HSTRING, category: ContactFieldCategory) -> Result<ContactInstantMessageField, windows_result::HRESULT> {
        Self::IContactInstantMessageFieldFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateInstantMessage_Category)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(username), category, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn CreateInstantMessage_All<P4>(username: &windows_core::HSTRING, category: ContactFieldCategory, service: &windows_core::HSTRING, displaytext: &windows_core::HSTRING, verb: P4) -> Result<ContactInstantMessageField, windows_result::HRESULT>
    where
        P4: windows_core::Param<super::super::Foundation::Uri>,
    {
        Self::IContactInstantMessageFieldFactory(|this| unsafe {
    ...
    fn IContactInstantMessageFieldFactory<R, F: FnOnce(&IContactInstantMessageFieldFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl ContactJobInfo {
    ...
    pub fn CompanyYomiName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCompanyYomiName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Department(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDepartment(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Manager(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetManager(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetManager)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(value)).ok() }
    }
    pub fn Office(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOffice(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetOffice)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(value)).ok() }
    }
    pub fn CompanyAddress(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCompanyAddress(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl ContactLaunchActionVerbs {
    pub fn Call() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn Message() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IContactLaunchActionVerbsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IContactLaunchActionVerbsStatics<R, F: FnOnce(&IContactLaunchActionVerbsStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl ContactList {
    ...
    pub fn OtherAppReadAccess(&self) -> Result<ContactListOtherAppReadAccess, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOtherAppReadAccess(&self, value: ContactListOtherAppReadAccess) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetOtherAppReadAccess)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn OtherAppWriteAccess(&self) -> Result<ContactListOtherAppWriteAccess, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOtherAppWriteAccess(&self, value: ContactListOtherAppWriteAccess) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetOtherAppWriteAccess)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ChangeTracker(&self) -> Result<ContactChangeTracker, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SyncManager(&self) -> Result<ContactListSyncManager, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SupportsServerSearch(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ContactChanged<P0>(&self, value: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveContactChanged(&self, value: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn GetContactFromRemoteIdAsync(&self, remoteid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<Contact>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMeContactAsync(&self) -> Result<windows_future::IAsyncOperation<Contact>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetContactReader(&self) -> Result<ContactReader, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetContactReaderWithOptions<P0>(&self, options: P0) -> Result<ContactReader, windows_result::HRESULT>
    where
    ...
    pub fn SaveContactAsync<P0>(&self, contact: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
        let this = self;
    ...
    pub fn DeleteContactAsync<P0>(&self, contact: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
        let this = self;
    ...
    pub fn GetContactAsync(&self, contactid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<Contact>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSupportsServerSearch(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactList2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetSupportsServerSearch)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SyncConstraints(&self) -> Result<ContactListSyncConstraints, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactList2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LimitedWriteOperations(&self) -> Result<ContactListLimitedWriteOperations, windows_result::HRESULT> {
    ...
    pub fn GetChangeTracker(&self, identity: &windows_core::HSTRING) -> Result<ContactChangeTracker, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactList3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ContactListLimitedWriteOperations {
    pub fn TryCreateOrUpdateContactAsync<P0>(&self, contact: P0) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
        let this = self;
    ...
    pub fn TryDeleteContactAsync(&self, contactid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ContactListSyncConstraints {
    pub fn CanSyncDescriptions(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCanSyncDescriptions(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCanSyncDescriptions)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn MaxHomePhoneNumbers(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxHomePhoneNumbers<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxMobilePhoneNumbers(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxMobilePhoneNumbers<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxWorkPhoneNumbers(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxWorkPhoneNumbers<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxOtherPhoneNumbers(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxOtherPhoneNumbers<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxPagerPhoneNumbers(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxPagerPhoneNumbers<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxBusinessFaxPhoneNumbers(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxBusinessFaxPhoneNumbers<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxHomeFaxPhoneNumbers(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxHomeFaxPhoneNumbers<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxCompanyPhoneNumbers(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxCompanyPhoneNumbers<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxAssistantPhoneNumbers(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxAssistantPhoneNumbers<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxRadioPhoneNumbers(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxRadioPhoneNumbers<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxPersonalEmailAddresses(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxPersonalEmailAddresses<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxWorkEmailAddresses(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxWorkEmailAddresses<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxOtherEmailAddresses(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxOtherEmailAddresses<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxHomeAddresses(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxHomeAddresses<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxWorkAddresses(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxWorkAddresses<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxOtherAddresses(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxOtherAddresses<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxBirthdayDates(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxBirthdayDates<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxAnniversaryDates(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxAnniversaryDates<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxOtherDates(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxOtherDates<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxOtherRelationships(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxOtherRelationships<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxSpouseRelationships(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxSpouseRelationships<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxPartnerRelationships(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxPartnerRelationships<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxSiblingRelationships(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxSiblingRelationships<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxParentRelationships(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxParentRelationships<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxChildRelationships(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxChildRelationships<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxJobInfo(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxJobInfo<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxWebsites(&self) -> Result<super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxWebsites<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<i32>>,
    {
        let this = self;
...
impl ContactListSyncManager {
    pub fn Status(&self) -> Result<ContactListSyncStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn SetStatus(&self, value: ContactListSyncStatus) -> Result<(), windows_result::HRESULT> {
...
impl ContactLocationField {
    ...
    pub fn UnstructuredAddress(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateLocation_Default(unstructuredaddress: &windows_core::HSTRING) -> Result<ContactLocationField, windows_result::HRESULT> {
        Self::IContactLocationFieldFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateLocation_Default)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(unstructuredaddress), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn CreateLocation_Category(unstructuredaddress: &windows_core::HSTRING, category: ContactFieldCategory) -> Result<ContactLocationField, windows_result::HRESULT> {
        Self::IContactLocationFieldFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateLocation_Category)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(unstructuredaddress), category, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn CreateLocation_All(unstructuredaddress: &windows_core::HSTRING, category: ContactFieldCategory, street: &windows_core::HSTRING, city: &windows_core::HSTRING, region: &windows_core::HSTRING, country: &windows_core::HSTRING, postalcode: &windows_core::HSTRING) -> Result<ContactLocationField, windows_result::HRESULT> {
        Self::IContactLocationFieldFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateLocation_All)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(unstructuredaddress), category, core::mem::transmute_copy(street), core::mem::transmute_copy(city), core::mem::transmute_copy(region), core::mem::transmute_copy(country), core::mem::transmute_copy(postalcode), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IContactLocationFieldFactory<R, F: FnOnce(&IContactLocationFieldFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl ContactManager {
    pub fn ShowContactCard<P0>(contact: P0, selection: super::super::Foundation::Rect) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
    ...
    pub fn ShowContactCardWithPlacement<P0>(contact: P0, selection: super::super::Foundation::Rect, preferredplacement: super::super::UI::Popups::Placement) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn ShowDelayLoadedContactCard<P0>(contact: P0, selection: super::super::Foundation::Rect, preferredplacement: super::super::UI::Popups::Placement) -> Result<ContactCardDelayedDataLoader, windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
    ...
    pub fn RequestStoreAsync() -> Result<windows_future::IAsyncOperation<ContactStore>, windows_result::HRESULT> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ConvertContactToVCardAsync<P0>(contact: P0) -> Result<windows_future::IAsyncOperation<super::super::Storage::Streams::RandomAccessStreamReference>, windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ConvertContactToVCardAsyncWithMaxBytes<P0>(contact: P0, maxbytes: u32) -> Result<windows_future::IAsyncOperation<super::super::Storage::Streams::RandomAccessStreamReference>, windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
        Self::IContactManagerStatics3(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ConvertVCardToContactAsync<P0>(vcard: P0) -> Result<windows_future::IAsyncOperation<Contact>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
    {
        Self::IContactManagerStatics3(|this| unsafe {
    ...
    pub fn RequestStoreAsyncWithAccessType(accesstype: ContactStoreAccessType) -> Result<windows_future::IAsyncOperation<ContactStore>, windows_result::HRESULT> {
        Self::IContactManagerStatics3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestAnnotationStoreAsync(accesstype: ContactAnnotationStoreAccessType) -> Result<windows_future::IAsyncOperation<ContactAnnotationStore>, windows_result::HRESULT> {
        Self::IContactManagerStatics3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsShowContactCardSupported() -> Result<bool, windows_result::HRESULT> {
        Self::IContactManagerStatics3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn ShowContactCardWithOptions<P0, P3>(contact: P0, selection: super::super::Foundation::Rect, preferredplacement: super::super::UI::Popups::Placement, contactcardoptions: P3) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    ...
    pub fn IsShowDelayLoadedContactCardSupported() -> Result<bool, windows_result::HRESULT> {
        Self::IContactManagerStatics3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn ShowDelayLoadedContactCardWithOptions<P0, P3>(contact: P0, selection: super::super::Foundation::Rect, preferredplacement: super::super::UI::Popups::Placement, contactcardoptions: P3) -> Result<ContactCardDelayedDataLoader, windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
        P3: windows_core::Param<ContactCardOptions>,
    {
    ...
    pub fn ShowFullContactCard<P0, P1>(contact: P0, fullcontactcardoptions: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    ...
    pub fn SystemDisplayNameOrder() -> Result<ContactNameOrder, windows_result::HRESULT> {
        Self::IContactManagerStatics3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SystemDisplayNameOrder)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn SetSystemDisplayNameOrder(value: ContactNameOrder) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn SystemSortOrder() -> Result<ContactNameOrder, windows_result::HRESULT> {
        Self::IContactManagerStatics3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SystemSortOrder)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn SetSystemSortOrder(value: ContactNameOrder) -> Result<(), windows_result::HRESULT> {
    ...
    #[cfg(feature = "System")]
    pub fn GetForUser<P0>(user: P0) -> Result<ContactManagerForUser, windows_result::HRESULT>
    where
    ...
    pub fn IsShowFullContactCardSupportedAsync() -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT> {
    ...
    pub fn IncludeMiddleNameInSystemDisplayAndSort() -> Result<bool, windows_result::HRESULT> {
        Self::IContactManagerStatics5(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIncludeMiddleNameInSystemDisplayAndSort(value: bool) -> Result<(), windows_result::HRESULT> {
    ...
    fn IContactManagerStatics<R, F: FnOnce(&IContactManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<ContactManager, IContactManagerStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IContactManagerStatics2<R, F: FnOnce(&IContactManagerStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<ContactManager, IContactManagerStatics2> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IContactManagerStatics3<R, F: FnOnce(&IContactManagerStatics3) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<ContactManager, IContactManagerStatics3> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IContactManagerStatics4<R, F: FnOnce(&IContactManagerStatics4) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<ContactManager, IContactManagerStatics4> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IContactManagerStatics5<R, F: FnOnce(&IContactManagerStatics5) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl ContactManagerForUser {
    #[cfg(feature = "Storage_Streams")]
    pub fn ConvertContactToVCardAsync<P0>(&self, contact: P0) -> Result<windows_future::IAsyncOperation<super::super::Storage::Streams::RandomAccessStreamReference>, windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ConvertContactToVCardAsyncWithMaxBytes<P0>(&self, contact: P0, maxbytes: u32) -> Result<windows_future::IAsyncOperation<super::super::Storage::Streams::RandomAccessStreamReference>, windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ConvertVCardToContactAsync<P0>(&self, vcard: P0) -> Result<windows_future::IAsyncOperation<Contact>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
    {
        let this = self;
    ...
    pub fn RequestStoreAsync(&self, accesstype: ContactStoreAccessType) -> Result<windows_future::IAsyncOperation<ContactStore>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestAnnotationStoreAsync(&self, accesstype: ContactAnnotationStoreAccessType) -> Result<windows_future::IAsyncOperation<ContactAnnotationStore>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).RequestAnnotationStoreAsync)(windows_core::Interface::as_raw(this), accesstype, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn SystemDisplayNameOrder(&self) -> Result<ContactNameOrder, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SystemDisplayNameOrder)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn SetSystemDisplayNameOrder(&self, value: ContactNameOrder) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSystemDisplayNameOrder)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SystemSortOrder(&self) -> Result<ContactNameOrder, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).SystemSortOrder)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn SetSystemSortOrder(&self, value: ContactNameOrder) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn ShowFullContactCard<P0, P1>(&self, contact: P0, fullcontactcardoptions: P1) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
        P1: windows_core::Param<FullContactCardOptions>,
    {
...
impl ContactMatchReason {
    pub fn Field(&self) -> Result<ContactMatchReasonKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Segments(&self) -> Result<windows_collections::IVectorView<super::super::Data::Text::TextSegment>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ContactPanel {
    pub fn ClosePanel(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).ClosePanel)(windows_core::Interface::as_raw(this)).ok() }
    }
    #[cfg(feature = "UI")]
    pub fn HeaderColor(&self) -> Result<super::super::Foundation::IReference<super::super::UI::Color>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI")]
    pub fn SetHeaderColor<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn LaunchFullAppRequested<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveLaunchFullAppRequested(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl ContactPhone {
    ...
    pub fn Kind(&self) -> Result<ContactPhoneKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Kind)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn SetKind(&self, value: ContactPhoneKind) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetKind)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Description(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
...
impl ContactPicker {
    ...
    pub fn SelectionMode(&self) -> Result<ContactSelectionMode, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSelectionMode(&self, value: ContactSelectionMode) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn PickSingleContactAsync(&self) -> Result<windows_future::IAsyncOperation<ContactInformation>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PickMultipleContactsAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<ContactInformation>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DesiredFieldsWithContactFieldType(&self) -> Result<windows_collections::IVector<ContactFieldType>, windows_result::HRESULT> {
    ...
    pub fn PickContactAsync(&self) -> Result<windows_future::IAsyncOperation<Contact>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactPicker2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PickContactsAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVector<Contact>>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactPicker2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "System")]
    pub fn CreateForUser<P0>(user: P0) -> Result<ContactPicker, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::System::User>,
    {
    ...
    fn IContactPickerStatics<R, F: FnOnce(&IContactPickerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl ContactQueryOptions {
    ...
    pub fn TextSearch(&self) -> Result<ContactQueryTextSearch, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ContactListIds(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IncludeContactsFromHiddenLists(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIncludeContactsFromHiddenLists(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIncludeContactsFromHiddenLists)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DesiredFields(&self) -> Result<ContactQueryDesiredFields, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDesiredFields(&self, value: ContactQueryDesiredFields) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDesiredFields)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DesiredOperations(&self) -> Result<ContactAnnotationOperations, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDesiredOperations(&self, value: ContactAnnotationOperations) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDesiredOperations)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AnnotationListIds(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateWithText(text: &windows_core::HSTRING) -> Result<ContactQueryOptions, windows_result::HRESULT> {
    ...
    pub fn CreateWithTextAndFields(text: &windows_core::HSTRING, fields: ContactQuerySearchFields) -> Result<ContactQueryOptions, windows_result::HRESULT> {
        Self::IContactQueryOptionsFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IContactQueryOptionsFactory<R, F: FnOnce(&IContactQueryOptionsFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl ContactQueryTextSearch {
    pub fn Fields(&self) -> Result<ContactQuerySearchFields, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetFields(&self, value: ContactQuerySearchFields) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn SearchScope(&self) -> Result<ContactQuerySearchScope, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSearchScope(&self, value: ContactQuerySearchScope) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl ContactReader {
    pub fn ReadBatchAsync(&self) -> Result<windows_future::IAsyncOperation<ContactBatch>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ReadBatchAsync)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn GetMatchingPropertiesWithMatchReason<P0>(&self, contact: P0) -> Result<windows_collections::IVectorView<ContactMatchReason>, windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
        let this = self;
...
impl ContactSignificantOther {
    ...
    pub fn Relationship(&self) -> Result<ContactRelationship, windows_result::HRESULT> {
    ...
    pub fn SetRelationship(&self, value: ContactRelationship) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactSignificantOther2>(self)?;
...
impl ContactStore {
    pub fn FindContactsAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<Contact>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindContactsWithSearchTextAsync(&self, searchtext: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<Contact>>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AggregateContactManager(&self) -> Result<AggregateContactManager, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactStore2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindContactListsAsync(&self) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<ContactList>>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactStore2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetContactListAsync(&self, contactlistid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<ContactList>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactStore2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateContactListAsync(&self, displayname: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<ContactList>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactStore2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateContactListInAccountAsync(&self, displayname: &windows_core::HSTRING, userdataaccountid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<ContactList>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactStore2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ContactWebsite {
    ...
    pub fn RawValue(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn SetRawValue(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactWebsite2>(self)?;
...
impl FullContactCardOptions {
    ...
    pub fn DesiredRemainingView(&self) -> Result<super::super::UI::ViewManagement::ViewSizePreference, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_ViewManagement")]
    pub fn SetDesiredRemainingView(&self, value: super::super::UI::ViewManagement::ViewSizePreference) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
pub trait IContactField_Impl: windows_core::IUnknownImpl {
    fn Type(&self) -> Result<ContactFieldType, windows_result::HRESULT>;
    fn Category(&self) -> Result<ContactFieldCategory, windows_result::HRESULT>;
...
impl IContactField_Vtbl {
    pub const fn new<Identity: IContactField_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Type<Identity: IContactField_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut ContactFieldType) -> windows_result::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn Category<Identity: IContactField_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut ContactFieldCategory) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Name<Identity: IContactField_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Value<Identity: IContactField_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait IContactFieldFactory_Impl: windows_core::IUnknownImpl {
    fn CreateField_Default(&self, value: &windows_core::HSTRING, r#type: ContactFieldType) -> Result<ContactField, windows_result::HRESULT>;
    fn CreateField_Category(&self, value: &windows_core::HSTRING, r#type: ContactFieldType, category: ContactFieldCategory) -> Result<ContactField, windows_result::HRESULT>;
    fn CreateField_Custom(&self, name: &windows_core::HSTRING, value: &windows_core::HSTRING, r#type: ContactFieldType, category: ContactFieldCategory) -> Result<ContactField, windows_result::HRESULT>;
}
impl IContactFieldFactory_Vtbl {
    pub const fn new<Identity: IContactFieldFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateField_Default<Identity: IContactFieldFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: *mut core::ffi::c_void, r#type: ContactFieldType, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateField_Category<Identity: IContactFieldFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: *mut core::ffi::c_void, r#type: ContactFieldType, category: ContactFieldCategory, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateField_Custom<Identity: IContactFieldFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, name: *mut core::ffi::c_void, value: *mut core::ffi::c_void, r#type: ContactFieldType, category: ContactFieldCategory, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait IContactInstantMessageFieldFactory_Impl: windows_core::IUnknownImpl {
    fn CreateInstantMessage_Default(&self, userName: &windows_core::HSTRING) -> Result<ContactInstantMessageField, windows_result::HRESULT>;
    fn CreateInstantMessage_Category(&self, userName: &windows_core::HSTRING, category: ContactFieldCategory) -> Result<ContactInstantMessageField, windows_result::HRESULT>;
    fn CreateInstantMessage_All(&self, userName: &windows_core::HSTRING, category: ContactFieldCategory, service: &windows_core::HSTRING, displayText: &windows_core::HSTRING, verb: windows_core::Ref<'_, super::super::Foundation::Uri>) -> Result<ContactInstantMessageField, windows_result::HRESULT>;
}
impl IContactInstantMessageFieldFactory_Vtbl {
    pub const fn new<Identity: IContactInstantMessageFieldFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateInstantMessage_Default<Identity: IContactInstantMessageFieldFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, username: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateInstantMessage_Category<Identity: IContactInstantMessageFieldFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, username: *mut core::ffi::c_void, category: ContactFieldCategory, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateInstantMessage_All<Identity: IContactInstantMessageFieldFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, username: *mut core::ffi::c_void, category: ContactFieldCategory, service: *mut core::ffi::c_void, displaytext: *mut core::ffi::c_void, verb: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait IContactLocationFieldFactory_Impl: windows_core::IUnknownImpl {
    fn CreateLocation_Default(&self, unstructuredAddress: &windows_core::HSTRING) -> Result<ContactLocationField, windows_result::HRESULT>;
    fn CreateLocation_Category(&self, unstructuredAddress: &windows_core::HSTRING, category: ContactFieldCategory) -> Result<ContactLocationField, windows_result::HRESULT>;
    fn CreateLocation_All(&self, unstructuredAddress: &windows_core::HSTRING, category: ContactFieldCategory, street: &windows_core::HSTRING, city: &windows_core::HSTRING, region: &windows_core::HSTRING, country: &windows_core::HSTRING, postalCode: &windows_core::HSTRING) -> Result<ContactLocationField, windows_result::HRESULT>;
}
impl IContactLocationFieldFactory_Vtbl {
    pub const fn new<Identity: IContactLocationFieldFactory_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateLocation_Default<Identity: IContactLocationFieldFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, unstructuredaddress: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateLocation_Category<Identity: IContactLocationFieldFactory_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, unstructuredaddress: *mut core::ffi::c_void, category: ContactFieldCategory, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl KnownContactField {
    ...
    pub fn PhoneNumber() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKnownContactFieldStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn InstantMessage() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKnownContactFieldStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ConvertNameToType(name: &windows_core::HSTRING) -> Result<ContactFieldType, windows_result::HRESULT> {
        Self::IKnownContactFieldStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ConvertTypeToName(r#type: ContactFieldType) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKnownContactFieldStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IKnownContactFieldStatics<R, F: FnOnce(&IKnownContactFieldStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl PinnedContactIdsQueryResult {
    pub fn ContactIds(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PinnedContactManager {
    ...
    pub fn IsPinSurfaceSupported(&self, surface: PinnedContactSurface) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsContactPinned<P0>(&self, contact: P0, surface: PinnedContactSurface) -> Result<bool, windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
        let this = self;
    ...
    pub fn RequestPinContactAsync<P0>(&self, contact: P0, surface: PinnedContactSurface) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
        let this = self;
    ...
    pub fn RequestPinContactsAsync<P0>(&self, contacts: P0, surface: PinnedContactSurface) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
    ...
    pub fn RequestUnpinContactAsync<P0>(&self, contact: P0, surface: PinnedContactSurface) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
        let this = self;
    ...
    pub fn SignalContactActivity<P0>(&self, contact: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<Contact>,
    {
        let this = self;
    ...
    pub fn GetPinnedContactIdsAsync(&self) -> Result<windows_future::IAsyncOperation<PinnedContactIdsQueryResult>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDefault() -> Result<PinnedContactManager, windows_result::HRESULT> {
    ...
    #[cfg(feature = "System")]
    pub fn GetForUser<P0>(user: P0) -> Result<PinnedContactManager, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::System::User>,
    {
        Self::IPinnedContactManagerStatics(|this| unsafe {
    ...
    fn IPinnedContactManagerStatics<R, F: FnOnce(&IPinnedContactManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
