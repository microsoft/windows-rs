...
impl ContactListCreateOrUpdateContactRequest {
    ...
    pub fn ReportCompletedAsync<P0>(&self, createdorupdatedcontact: P0) -> windows_core::Result<windows_async::IAsyncAction>
    where
...
impl ContactListServerSearchReadBatchRequest {
    ...
    pub fn ReportFailedAsync(&self, batchstatus: super::ContactBatchStatus) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
