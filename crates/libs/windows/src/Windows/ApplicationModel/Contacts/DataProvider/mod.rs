...
impl ContactDataProviderConnection {
    ...
    pub fn CreateOrUpdateContactRequested<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveCreateOrUpdateContactRequested(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactDataProviderConnection2>(self)?;
    ...
    pub fn DeleteContactRequested<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveDeleteContactRequested(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IContactDataProviderConnection2>(self)?;
...
impl ContactDataProviderTriggerDetails {
    pub fn Connection(&self) -> Result<ContactDataProviderConnection, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ContactListCreateOrUpdateContactRequest {
    ...
    pub fn Contact(&self) -> Result<super::Contact, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReportCompletedAsync<P0>(&self, createdorupdatedcontact: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
...
impl ContactListCreateOrUpdateContactRequestEventArgs {
    pub fn Request(&self) -> Result<ContactListCreateOrUpdateContactRequest, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ContactListDeleteContactRequestEventArgs {
    pub fn Request(&self) -> Result<ContactListDeleteContactRequest, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl ContactListServerSearchReadBatchRequest {
    ...
    pub fn Options(&self) -> Result<super::ContactQueryOptions, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReportFailedAsync(&self, batchstatus: super::ContactBatchStatus) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ContactListServerSearchReadBatchRequestEventArgs {
    pub fn Request(&self) -> Result<ContactListServerSearchReadBatchRequest, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl ContactListSyncManagerSyncRequestEventArgs {
    pub fn Request(&self) -> Result<ContactListSyncManagerSyncRequest, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Request)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
