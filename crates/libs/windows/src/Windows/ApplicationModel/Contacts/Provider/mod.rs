...
windows_core::imp::required_hierarchy!(ContactPickerUI, IContactPickerUI, IContactPickerUI2);
...
windows_core::imp::required_hierarchy!(ContactRemovedEventArgs, IContactRemovedEventArgs);
