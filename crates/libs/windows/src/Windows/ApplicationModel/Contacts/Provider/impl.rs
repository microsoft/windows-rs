...
pub trait IContactPickerUI_Impl: Sized {
...
#[cfg(all(feature = "Foundation", feature = "Foundation_Collections", feature = "implement_exclusive"))]
impl IContactPickerUI_Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IContactPickerUI_Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IContactPickerUI_Vtbl {
        unsafe extern "system" fn AddContact<Impl: IContactPickerUI_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, id: ::core::mem::ManuallyDrop<::windows::core::HSTRING>, contact: ::windows::core::RawPtr, result__: *mut AddContactResult) -> ::windows::core::HRESULT {
        ...
        unsafe extern "system" fn RemoveContact<Impl: IContactPickerUI_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, id: ::core::mem::ManuallyDrop<::windows::core::HSTRING>) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn ContainsContact<Impl: IContactPickerUI_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, id: ::core::mem::ManuallyDrop<::windows::core::HSTRING>, result__: *mut bool) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn DesiredFields<Impl: IContactPickerUI_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn SelectionMode<Impl: IContactPickerUI_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, result__: *mut super::ContactSelectionMode) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn ContactRemoved<Impl: IContactPickerUI_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, handler: ::windows::core::RawPtr, result__: *mut super::super::super::Foundation::EventRegistrationToken) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn RemoveContactRemoved<Impl: IContactPickerUI_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, token: super::super::super::Foundation::EventRegistrationToken) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
...
pub trait IContactPickerUI2_Impl: Sized {
...
#[cfg(all(feature = "Foundation_Collections", feature = "implement_exclusive"))]
impl IContactPickerUI2_Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IContactPickerUI2_Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IContactPickerUI2_Vtbl {
        unsafe extern "system" fn AddContact<Impl: IContactPickerUI2_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, contact: ::windows::core::RawPtr, result__: *mut AddContactResult) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn DesiredFieldsWithContactFieldType<Impl: IContactPickerUI2_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
...
pub trait IContactRemovedEventArgs_Impl: Sized {
...
#[cfg(feature = "implement_exclusive")]
impl IContactRemovedEventArgs_Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IContactRemovedEventArgs_Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IContactRemovedEventArgs_Vtbl {
        unsafe extern "system" fn Id<Impl: IContactRemovedEventArgs_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, result__: *mut ::core::mem::ManuallyDrop<::windows::core::HSTRING>) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
            match (*this).Id() {
                ::core::result::Result::Ok(ok__) => {
                    *result__ = ::core::mem::transmute_copy(&ok__);
