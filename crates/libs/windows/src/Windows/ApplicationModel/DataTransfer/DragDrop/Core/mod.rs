...
windows_core::imp::required_hierarchy!(CoreDragDropManager, ICoreDragDropManager, ICoreDragDropManagerStatics);
...
windows_core::imp::required_hierarchy!(CoreDragInfo, ICoreDragInfo, ICoreDragInfo2);
impl CoreDragInfo {
...
windows_core::imp::required_hierarchy!(CoreDragOperation, ICoreDragOperation, ICoreDragOperation2);
...
windows_core::imp::required_hierarchy!(CoreDragUIOverride, ICoreDragUIOverride);
...
windows_core::imp::required_hierarchy!(CoreDropOperationTargetRequestedEventArgs, ICoreDropOperationTargetRequestedEventArgs);
