...
impl CoreDragDropManager {
        ...
        P0: windows_core::Param<super::super::super::super::Foundation::TypedEventHandler<CoreDragDropManager, CoreDropOperationTargetRequestedEventArgs>>,
    {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).TargetRequested)(windows_core::Interface::as_raw(self), value.param().abi(), &mut result__).map(|| result__)
        }
    }
    pub fn RemoveTargetRequested(&self, value: i64) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).RemoveTargetRequested)(windows_core::Interface::as_raw(self), value).ok() }
    }
...
impl CoreDragOperation {
    ...
    pub fn SetPointerId(&self, pointerid: u32) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetPointerId)(windows_core::Interface::as_raw(self), pointerid).ok() }
    }
    ...
    {
        unsafe { (windows_core::Interface::vtable(self).SetDragUIContentFromSoftwareBitmap)(windows_core::Interface::as_raw(self), softwarebitmap.param().abi()).ok() }
    }
    #[cfg(feature = "Graphics_Imaging")]
    ...
    where
        P0: windows_core::Param<super::super::super::super::Graphics::Imaging::SoftwareBitmap>,
    {
        unsafe { (windows_core::Interface::vtable(self).SetDragUIContentFromSoftwareBitmapWithAnchorPoint)(windows_core::Interface::as_raw(self), softwarebitmap.param().abi(), anchorpoint).ok() }
    }
...
impl windows_core::RuntimeType for CoreDragUIContentMode {
    ...
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.DataTransfer.DragDrop.Core.CoreDragUIContentMode");
}
impl CoreDragUIContentMode {
...
impl windows_core::RuntimeType for ICoreDragDropManager {
    ...
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.DataTransfer.DragDrop.Core.ICoreDragDropManager");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreDragDropManagerStatics {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.DataTransfer.DragDrop.Core.ICoreDragDropManagerStatics");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreDragOperation {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.DataTransfer.DragDrop.Core.ICoreDragOperation");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreDragOperation2 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.DataTransfer.DragDrop.Core.ICoreDragOperation2");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreDropOperationTarget {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.DataTransfer.DragDrop.Core.ICoreDropOperationTarget");
}
...
impl ICoreDropOperationTarget {
        ...
        P1: windows_core::Param<CoreDragUIOverride>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).EnterAsync)(windows_core::Interface::as_raw(self), draginfo.param().abi(), draguioverride.param().abi(), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
        ...
        P1: windows_core::Param<CoreDragUIOverride>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).OverAsync)(windows_core::Interface::as_raw(self), draginfo.param().abi(), draguioverride.param().abi(), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
        ...
        P0: windows_core::Param<CoreDragInfo>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).LeaveAsync)(windows_core::Interface::as_raw(self), draginfo.param().abi(), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
        ...
        P0: windows_core::Param<CoreDragInfo>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DropAsync)(windows_core::Interface::as_raw(self), draginfo.param().abi(), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        }
    }
}
...
impl windows_core::RuntimeType for ICoreDropOperationTargetRequestedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.DataTransfer.DragDrop.Core.ICoreDropOperationTargetRequestedEventArgs");
}
#[repr(C)]
#[doc(hidden)]
