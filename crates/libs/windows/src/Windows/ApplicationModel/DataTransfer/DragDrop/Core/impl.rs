...
impl ICoreDragDropManagerVtbl {
    pub const fn new<Impl: ICoreDragDropManagerImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> ICoreDragDropManagerVtbl {
        unsafe extern "system" fn TargetRequested<Impl: ICoreDragDropManagerImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, value: ::windows::core::RawPtr, result__: *mut super::super::super::super::Foundation::EventRegistrationToken) -> ::windows::core::HRESULT {
        ...
        unsafe extern "system" fn RemoveTargetRequested<Impl: ICoreDragDropManagerImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, value: super::super::super::super::Foundation::EventRegistrationToken) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn AreConcurrentOperationsEnabled<Impl: ICoreDragDropManagerImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut bool) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn SetAreConcurrentOperationsEnabled<Impl: ICoreDragDropManagerImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, value: bool) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            (*this).SetAreConcurrentOperationsEnabled(value).into()
        }
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<ICoreDragDropManager>, base.5, TargetRequested::<Impl, OFFSET>, RemoveTargetRequested::<Impl, OFFSET>, AreConcurrentOperationsEnabled::<Impl, OFFSET>, SetAreConcurrentOperationsEnabled::<Impl, OFFSET>)
    }
}
#[cfg(feature = "implement_exclusive")]
...
impl ICoreDragDropManagerStaticsVtbl {
    pub const fn new<Impl: ICoreDragDropManagerStaticsImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> ICoreDragDropManagerStaticsVtbl {
        unsafe extern "system" fn GetForCurrentView<Impl: ICoreDragDropManagerStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<ICoreDragDropManagerStatics>, base.5, GetForCurrentView::<Impl, OFFSET>)
    }
}
#[cfg(feature = "implement_exclusive")]
...
impl ICoreDragInfoVtbl {
    pub const fn new<Impl: ICoreDragInfoImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> ICoreDragInfoVtbl {
        unsafe extern "system" fn Data<Impl: ICoreDragInfoImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            match (*this).Data() {
                ::core::result::Result::Ok(ok__) => {
                    *result__ = ::core::mem::transmute_copy(&ok__);
        ...
        unsafe extern "system" fn Modifiers<Impl: ICoreDragInfoImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut super::DragDropModifiers) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn Position<Impl: ICoreDragInfoImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut super::super::super::super::Foundation::Point) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            match (*this).Position() {
                ::core::result::Result::Ok(ok__) => {
                    *result__ = ::core::mem::transmute_copy(&ok__);
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<ICoreDragInfo>, base.5, Data::<Impl, OFFSET>, Modifiers::<Impl, OFFSET>, Position::<Impl, OFFSET>)
    }
}
#[cfg(feature = "implement_exclusive")]
...
impl ICoreDragInfo2Vtbl {
    pub const fn new<Impl: ICoreDragInfo2Impl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> ICoreDragInfo2Vtbl {
        unsafe extern "system" fn AllowedOperations<Impl: ICoreDragInfo2Impl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut super::super::DataPackageOperation) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<ICoreDragInfo2>, base.5, AllowedOperations::<Impl, OFFSET>)
    }
}
#[cfg(feature = "implement_exclusive")]
...
impl ICoreDragOperationVtbl {
    pub const fn new<Impl: ICoreDragOperationImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> ICoreDragOperationVtbl {
        unsafe extern "system" fn Data<Impl: ICoreDragOperationImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            match (*this).Data() {
                ::core::result::Result::Ok(ok__) => {
                    *result__ = ::core::mem::transmute_copy(&ok__);
        ...
        unsafe extern "system" fn SetPointerId<Impl: ICoreDragOperationImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, pointerid: u32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            (*this).SetPointerId(pointerid).into()
        }
        unsafe extern "system" fn SetDragUIContentFromSoftwareBitmap<Impl: ICoreDragOperationImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, softwarebitmap: ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn SetDragUIContentFromSoftwareBitmapWithAnchorPoint<Impl: ICoreDragOperationImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, softwarebitmap: ::windows::core::RawPtr, anchorpoint: super::super::super::super::Foundation::Point) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            (*this)
        ...
        unsafe extern "system" fn DragUIContentMode<Impl: ICoreDragOperationImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut CoreDragUIContentMode) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn SetDragUIContentMode<Impl: ICoreDragOperationImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, value: CoreDragUIContentMode) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            (*this).SetDragUIContentMode(value).into()
        }
        unsafe extern "system" fn StartAsync<Impl: ICoreDragOperationImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<ICoreDragOperation>, base.5, Data::<Impl, OFFSET>, SetPointerId::<Impl, OFFSET>, SetDragUIContentFromSoftwareBitmap::<Impl, OFFSET>, SetDragUIContentFromSoftwareBitmapWithAnchorPoint::<Impl, OFFSET>, DragUIContentMode::<Impl, OFFSET>, SetDragUIContentMode::<Impl, OFFSET>, StartAsync::<Impl, OFFSET>)
    }
}
#[cfg(feature = "implement_exclusive")]
...
impl ICoreDragOperation2Vtbl {
    pub const fn new<Impl: ICoreDragOperation2Impl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> ICoreDragOperation2Vtbl {
        unsafe extern "system" fn AllowedOperations<Impl: ICoreDragOperation2Impl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut super::super::DataPackageOperation) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            match (*this).AllowedOperations() {
                ::core::result::Result::Ok(ok__) => {
                    *result__ = ::core::mem::transmute_copy(&ok__);
        ...
        unsafe extern "system" fn SetAllowedOperations<Impl: ICoreDragOperation2Impl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, value: super::super::DataPackageOperation) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            (*this).SetAllowedOperations(value).into()
        }
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<ICoreDragOperation2>, base.5, AllowedOperations::<Impl, OFFSET>, SetAllowedOperations::<Impl, OFFSET>)
    }
}
#[cfg(feature = "implement_exclusive")]
...
impl ICoreDragUIOverrideVtbl {
    pub const fn new<Impl: ICoreDragUIOverrideImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> ICoreDragUIOverrideVtbl {
        unsafe extern "system" fn SetContentFromSoftwareBitmap<Impl: ICoreDragUIOverrideImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, softwarebitmap: ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn SetContentFromSoftwareBitmapWithAnchorPoint<Impl: ICoreDragUIOverrideImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, softwarebitmap: ::windows::core::RawPtr, anchorpoint: super::super::super::super::Foundation::Point) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            (*this)
        ...
        unsafe extern "system" fn IsContentVisible<Impl: ICoreDragUIOverrideImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut bool) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn SetIsContentVisible<Impl: ICoreDragUIOverrideImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, value: bool) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            (*this).SetIsContentVisible(value).into()
        }
        unsafe extern "system" fn Caption<Impl: ICoreDragUIOverrideImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut ::core::mem::ManuallyDrop<::windows::core::HSTRING>) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            match (*this).Caption() {
                ::core::result::Result::Ok(ok__) => {
                    *result__ = ::core::mem::transmute_copy(&ok__);
        ...
        unsafe extern "system" fn SetCaption<Impl: ICoreDragUIOverrideImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, value: ::core::mem::ManuallyDrop<::windows::core::HSTRING>) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn IsCaptionVisible<Impl: ICoreDragUIOverrideImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut bool) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn SetIsCaptionVisible<Impl: ICoreDragUIOverrideImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, value: bool) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            (*this).SetIsCaptionVisible(value).into()
        }
        unsafe extern "system" fn IsGlyphVisible<Impl: ICoreDragUIOverrideImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut bool) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn SetIsGlyphVisible<Impl: ICoreDragUIOverrideImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, value: bool) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            (*this).SetIsGlyphVisible(value).into()
        }
        unsafe extern "system" fn Clear<Impl: ICoreDragUIOverrideImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
            (*this).Clear().into()
        }
        Self(
...
impl ICoreDropOperationTargetVtbl {
    pub const fn new<Impl: ICoreDropOperationTargetImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> ICoreDropOperationTargetVtbl {
        unsafe extern "system" fn EnterAsync<Impl: ICoreDropOperationTargetImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, draginfo: ::windows::core::RawPtr, draguioverride: ::windows::core::RawPtr, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn OverAsync<Impl: ICoreDropOperationTargetImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, draginfo: ::windows::core::RawPtr, draguioverride: ::windows::core::RawPtr, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn LeaveAsync<Impl: ICoreDropOperationTargetImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, draginfo: ::windows::core::RawPtr, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn DropAsync<Impl: ICoreDropOperationTargetImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, draginfo: ::windows::core::RawPtr, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<ICoreDropOperationTarget>, base.5, EnterAsync::<Impl, OFFSET>, OverAsync::<Impl, OFFSET>, LeaveAsync::<Impl, OFFSET>, DropAsync::<Impl, OFFSET>)
    }
}
#[cfg(feature = "implement_exclusive")]
...
impl ICoreDropOperationTargetRequestedEventArgsVtbl {
    pub const fn new<Impl: ICoreDropOperationTargetRequestedEventArgsImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> ICoreDropOperationTargetRequestedEventArgsVtbl {
        unsafe extern "system" fn SetTarget<Impl: ICoreDropOperationTargetRequestedEventArgsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, target: ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<ICoreDropOperationTargetRequestedEventArgs>, base.5, SetTarget::<Impl, OFFSET>)
    }
}
