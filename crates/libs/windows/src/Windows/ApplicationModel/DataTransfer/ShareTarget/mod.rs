...
windows_core::imp::required_hierarchy!(QuickLink, IQuickLink);
impl QuickLink {
...
windows_core::imp::required_hierarchy!(ShareOperation, IShareOperation, IShareOperation2, IShareOperation3);
impl ShareOperation {
