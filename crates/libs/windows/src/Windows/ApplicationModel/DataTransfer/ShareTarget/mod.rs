...
impl QuickLink {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Thumbnail(&self) -> Result<super::super::super::Storage::Streams::RandomAccessStreamReference, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SupportedDataFormats(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SupportedFileTypes(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ShareOperation {
    pub fn Data(&self) -> Result<super::DataPackageView, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn QuickLinkId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ApplicationModel_Contacts")]
    pub fn Contacts(&self) -> Result<windows_collections::IVectorView<super::super::Contacts::Contact>, windows_result::HRESULT> {
