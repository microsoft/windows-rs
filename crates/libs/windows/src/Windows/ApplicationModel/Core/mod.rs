...
impl AppListEntry {
        ...
        P0: windows_core::Param<super::super::System::User>,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).LaunchForUserAsync)(windows_core::Interface::as_raw(this), user.param().abi(), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub fn AppInfo(&self) -> windows_core::Result<super::AppInfo> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).AppInfo)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
}
...
impl windows_core::imp::TypeKind for AppRestartFailureReason {
...
impl windows_core::RuntimeType for AppRestartFailureReason {
    ...
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.AppRestartFailureReason");
}
...
impl CoreApplication {
    ...
    where
        F: Fn(windows_core::Ref<windows_core::IInspectable>, windows_core::Ref<super::SuspendingEventArgs>) + Send + 'static,
    {
        let handler = <super::super::Foundation::EventHandler<super::SuspendingEventArgs>>::new(move |a0, a1| {
            handler(a0, a1);
            Ok(())
        });
        Self::ICoreApplication(|this| unsafe {
    ...
    pub fn GetCurrentView() -> windows_core::Result<CoreApplicationView> {
        Self::ICoreApplication(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetCurrentView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        })
    }
    ...
    where
        F: Fn(windows_core::Ref<windows_core::IInspectable>, windows_core::Ref<super::Activation::BackgroundActivatedEventArgs>) + Send + 'static,
    {
        let handler = <super::super::Foundation::EventHandler<super::Activation::BackgroundActivatedEventArgs>>::new(move |a0, a1| {
            handler(a0, a1);
            Ok(())
        });
    ...
    where
        F: Fn(windows_core::Ref<windows_core::IInspectable>, windows_core::Ref<super::LeavingBackgroundEventArgs>) + Send + 'static,
    {
        let handler = <super::super::Foundation::EventHandler<super::LeavingBackgroundEventArgs>>::new(move |a0, a1| {
            handler(a0, a1);
            Ok(())
        });
        Self::ICoreApplication2(|this| unsafe {
    ...
    where
        F: Fn(windows_core::Ref<windows_core::IInspectable>, windows_core::Ref<super::EnteredBackgroundEventArgs>) + Send + 'static,
    {
        let handler = <super::super::Foundation::EventHandler<super::EnteredBackgroundEventArgs>>::new(move |a0, a1| {
            handler(a0, a1);
            Ok(())
        });
        Self::ICoreApplication2(|this| unsafe {
    ...
    pub fn Exiting<F>(handler: F) -> windows_core::Result<windows_core::EventRevoker>
    where
        F: Fn(windows_core::Ref<windows_core::IInspectable>, windows_core::Ref<windows_core::IInspectable>) + Send + 'static,
    {
        let handler = <super::super::Foundation::EventHandler<windows_core::IInspectable>>::new(move |a0, a1| {
        ...
        Self::ICoreApplicationExit(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            let token__ = (windows_core::Interface::vtable(this).Exiting)(windows_core::Interface::as_raw(this), windows_core::Interface::as_raw(&handler), &mut result__).map(|| result__)?;
            Ok(windows_core::EventRevoker::new(this.clone(), token__, windows_core::Interface::vtable(this).RemoveExiting))
        })
    }
    pub fn UnhandledErrorDetected<F>(handler: F) -> windows_core::Result<windows_core::EventRevoker>
    where
        F: Fn(windows_core::Ref<windows_core::IInspectable>, windows_core::Ref<UnhandledErrorDetectedEventArgs>) + Send + 'static,
    {
        let handler = <super::super::Foundation::EventHandler<UnhandledErrorDetectedEventArgs>>::new(move |a0, a1| {
            handler(a0, a1);
            Ok(())
        });
        Self::ICoreApplicationUnhandledError(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            let token__ = (windows_core::Interface::vtable(this).UnhandledErrorDetected)(windows_core::Interface::as_raw(this), windows_core::Interface::as_raw(&handler), &mut result__).map(|| result__)?;
            Ok(windows_core::EventRevoker::new(this.clone(), token__, windows_core::Interface::vtable(this).RemoveUnhandledErrorDetected))
        })
    }
    ...
    pub fn Views() -> windows_core::Result<windows_collections::IVectorView<CoreApplicationView>> {
        Self::ICoreImmersiveApplication(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Views)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        })
    }
    pub fn CreateNewView(runtimetype: &windows_core::HSTRING, entrypoint: &windows_core::HSTRING) -> windows_core::Result<CoreApplicationView> {
        Self::ICoreImmersiveApplication(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateNewView)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(runtimetype), core::mem::transmute_copy(entrypoint), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        })
    }
    pub fn MainView() -> windows_core::Result<CoreApplicationView> {
        Self::ICoreImmersiveApplication(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).MainView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        })
    }
    pub fn CreateNewViewFromMainView() -> windows_core::Result<CoreApplicationView> {
        Self::ICoreImmersiveApplication2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateNewViewFromMainView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        })
    }
        ...
        P0: windows_core::Param<IFrameworkViewSource>,
    {
        Self::ICoreImmersiveApplication3(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateNewViewWithViewSource)(windows_core::Interface::as_raw(this), viewsource.param().abi(), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        })
    }
...
impl CoreApplicationView {
    ...
    where
        F: Fn(windows_core::Ref<Self>, windows_core::Ref<super::Activation::IActivatedEventArgs>) + Send + 'static,
    {
        let handler = <super::super::Foundation::TypedEventHandler<Self, super::Activation::IActivatedEventArgs>>::new(move |a0, a1| {
            handler(a0, a1);
            Ok(())
        });
        unsafe {
    ...
    pub fn IsMain(&self) -> windows_core::Result<bool> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsMain)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn IsHosted(&self) -> windows_core::Result<bool> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsHosted)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    #[cfg(feature = "UI_Core")]
    ...
    pub fn TitleBar(&self) -> windows_core::Result<CoreApplicationViewTitleBar> {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).TitleBar)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub fn HostedViewClosing<F>(&self, handler: F) -> windows_core::Result<windows_core::EventRevoker>
    where
        F: Fn(windows_core::Ref<Self>, windows_core::Ref<HostedViewClosingEventArgs>) + Send + 'static,
    {
        let this = &windows_core::Interface::cast::<ICoreApplicationView3>(self)?;
        let handler = <super::super::Foundation::TypedEventHandler<Self, HostedViewClosingEventArgs>>::new(move |a0, a1| {
            handler(a0, a1);
            Ok(())
        });
        unsafe {
            let mut result__ = core::mem::zeroed();
            let token__ = (windows_core::Interface::vtable(this).HostedViewClosing)(windows_core::Interface::as_raw(this), windows_core::Interface::as_raw(&handler), &mut result__).map(|| result__)?;
            Ok(windows_core::EventRevoker::new(this.clone(), token__, windows_core::Interface::vtable(this).RemoveHostedViewClosing))
        }
    }
    #[cfg(feature = "Foundation_Collections")]
...
impl CoreApplicationViewTitleBar {
    pub fn SetExtendViewIntoTitleBar(&self, value: bool) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetExtendViewIntoTitleBar)(windows_core::Interface::as_raw(self), value).ok() }
    }
    pub fn ExtendViewIntoTitleBar(&self) -> windows_core::Result<bool> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ExtendViewIntoTitleBar)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn SystemOverlayLeftInset(&self) -> windows_core::Result<f64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SystemOverlayLeftInset)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn SystemOverlayRightInset(&self) -> windows_core::Result<f64> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).SystemOverlayRightInset)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    ...
    pub fn LayoutMetricsChanged<F>(&self, handler: F) -> windows_core::Result<windows_core::EventRevoker>
    where
        F: Fn(windows_core::Ref<Self>, windows_core::Ref<windows_core::IInspectable>) + Send + 'static,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            let token__ = (windows_core::Interface::vtable(self).LayoutMetricsChanged)(windows_core::Interface::as_raw(self), windows_core::Interface::as_raw(&handler), &mut result__).map(|| result__)?;
            Ok(windows_core::EventRevoker::new(self.clone(), token__, windows_core::Interface::vtable(self).RemoveLayoutMetricsChanged))
        }
    }
    ...
    pub fn IsVisibleChanged<F>(&self, handler: F) -> windows_core::Result<windows_core::EventRevoker>
    where
        F: Fn(windows_core::Ref<Self>, windows_core::Ref<windows_core::IInspectable>) + Send + 'static,
    {
        let handler = <super::super::Foundation::TypedEventHandler<Self, windows_core::IInspectable>>::new(move |a0, a1| {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            let token__ = (windows_core::Interface::vtable(self).IsVisibleChanged)(windows_core::Interface::as_raw(self), windows_core::Interface::as_raw(&handler), &mut result__).map(|| result__)?;
            Ok(windows_core::EventRevoker::new(self.clone(), token__, windows_core::Interface::vtable(self).RemoveIsVisibleChanged))
        }
    }
}
...
impl windows_core::RuntimeType for IAppListEntry {
    ...
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.IAppListEntry");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IAppListEntry2 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.IAppListEntry2");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IAppListEntry3 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.IAppListEntry3");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IAppListEntry4 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.IAppListEntry4");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreApplication {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.ICoreApplication");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreApplication2 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.ICoreApplication2");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreApplication3 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.ICoreApplication3");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreApplicationExit {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.ICoreApplicationExit");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreApplicationUnhandledError {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.ICoreApplicationUnhandledError");
}
...
impl ICoreApplicationUnhandledError {
    pub fn UnhandledErrorDetected<F>(&self, handler: F) -> windows_core::Result<windows_core::EventRevoker>
    where
        F: Fn(windows_core::Ref<windows_core::IInspectable>, windows_core::Ref<UnhandledErrorDetectedEventArgs>) + Send + 'static,
    {
        let handler = <super::super::Foundation::EventHandler<UnhandledErrorDetectedEventArgs>>::new(move |a0, a1| {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            let token__ = (windows_core::Interface::vtable(self).UnhandledErrorDetected)(windows_core::Interface::as_raw(self), windows_core::Interface::as_raw(&handler), &mut result__).map(|| result__)?;
            Ok(windows_core::EventRevoker::new(self.clone(), token__, windows_core::Interface::vtable(self).RemoveUnhandledErrorDetected))
        }
    }
}
...
impl windows_core::RuntimeType for ICoreApplicationUseCount {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.ICoreApplicationUseCount");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreApplicationView {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.ICoreApplicationView");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreApplicationView2 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.ICoreApplicationView2");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreApplicationView3 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.ICoreApplicationView3");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreApplicationView5 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.ICoreApplicationView5");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreApplicationView6 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.ICoreApplicationView6");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreApplicationViewTitleBar {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.ICoreApplicationViewTitleBar");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreImmersiveApplication {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.ICoreImmersiveApplication");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreImmersiveApplication2 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.ICoreImmersiveApplication2");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for ICoreImmersiveApplication3 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.ICoreImmersiveApplication3");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IFrameworkView {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.IFrameworkView");
}
...
impl IFrameworkView {
    ...
    {
        unsafe { (windows_core::Interface::vtable(self).Initialize)(windows_core::Interface::as_raw(self), applicationview.param().abi()).ok() }
    }
    #[cfg(feature = "UI_Core")]
    ...
    {
        unsafe { (windows_core::Interface::vtable(self).SetWindow)(windows_core::Interface::as_raw(self), window.param().abi()).ok() }
    }
    pub fn Load(&self, entrypoint: &windows_core::HSTRING) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Load)(windows_core::Interface::as_raw(self), core::mem::transmute_copy(entrypoint)).ok() }
    }
...
impl windows_core::RuntimeType for IFrameworkViewSource {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.IFrameworkViewSource");
}
...
impl IFrameworkViewSource {
    pub fn CreateView(&self) -> windows_core::Result<IFrameworkView> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).CreateView)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
}
...
impl windows_core::RuntimeType for IHostedViewClosingEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.IHostedViewClosingEventArgs");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IUnhandledError {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.IUnhandledError");
}
#[repr(C)]
#[doc(hidden)]
...
impl windows_core::RuntimeType for IUnhandledErrorDetectedEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.ApplicationModel.Core.IUnhandledErrorDetectedEventArgs");
}
#[repr(C)]
#[doc(hidden)]
...
impl UnhandledError {
    ...
    pub fn Propagate(&self) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).Propagate)(windows_core::Interface::as_raw(self)).ok() }
    }
}
...
impl UnhandledErrorDetectedEventArgs {
    pub fn UnhandledError(&self) -> windows_core::Result<UnhandledError> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).UnhandledError)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
}
