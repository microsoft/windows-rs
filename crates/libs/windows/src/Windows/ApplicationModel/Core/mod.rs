...
impl AppListEntry {
    pub fn DisplayInfo(&self) -> windows_result::Result<super::AppDisplayInfo> {
        let this = self;
        unsafe {
    ...
    #[cfg(feature = "System")]
    pub fn LaunchForUserAsync<P0>(&self, user: P0) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
...
impl CoreApplication {
    pub fn Id() -> windows_result::Result<windows_core::HSTRING> {
    ...
    pub fn Properties() -> windows_result::Result<super::super::Foundation::Collections::IPropertySet> {
        Self::ICoreApplication(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Properties)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn GetCurrentView() -> windows_result::Result<CoreApplicationView> {
        Self::ICoreApplication(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Run<P0>(viewsource: P0) -> windows_result::Result<()>
    where
    ...
    pub fn RunWithActivationFactories<P0>(activationfactorycallback: P0) -> windows_result::Result<()>
    where
    ...
    pub fn RequestRestartAsync(launcharguments: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<AppRestartFailureReason>> {
    ...
    #[cfg(feature = "System")]
    pub fn RequestRestartForUserAsync<P0>(user: P0, launcharguments: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<AppRestartFailureReason>>
    where
        P0: windows_core::Param<super::super::System::User>,
    {
        Self::ICoreApplication3(|this| unsafe {
    ...
    pub fn RemoveExiting(token: i64) -> windows_result::Result<()> {
    ...
    pub fn UnhandledErrorDetected<P0>(handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveUnhandledErrorDetected(token: i64) -> windows_result::Result<()> {
    ...
    pub fn IncrementApplicationUseCount() -> windows_result::Result<()> {
    ...
    pub fn DecrementApplicationUseCount() -> windows_result::Result<()> {
    ...
    pub fn Views() -> windows_result::Result<windows_collections::IVectorView<CoreApplicationView>> {
    ...
    pub fn CreateNewView(runtimetype: &windows_core::HSTRING, entrypoint: &windows_core::HSTRING) -> windows_result::Result<CoreApplicationView> {
        Self::ICoreImmersiveApplication(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MainView() -> windows_result::Result<CoreApplicationView> {
        Self::ICoreImmersiveApplication(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateNewViewFromMainView() -> windows_result::Result<CoreApplicationView> {
    ...
    pub fn CreateNewViewWithViewSource<P0>(viewsource: P0) -> windows_result::Result<CoreApplicationView>
    where
        P0: windows_core::Param<IFrameworkViewSource>,
    {
    ...
    fn ICoreApplication<R, F: FnOnce(&ICoreApplication) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<CoreApplication, ICoreApplication> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ICoreApplication2<R, F: FnOnce(&ICoreApplication2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<CoreApplication, ICoreApplication2> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ICoreApplication3<R, F: FnOnce(&ICoreApplication3) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<CoreApplication, ICoreApplication3> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ICoreApplicationExit<R, F: FnOnce(&ICoreApplicationExit) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<CoreApplication, ICoreApplicationExit> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ICoreApplicationUnhandledError<R, F: FnOnce(&ICoreApplicationUnhandledError) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn ICoreApplicationUseCount<R, F: FnOnce(&ICoreApplicationUseCount) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<CoreApplication, ICoreApplicationUseCount> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ICoreImmersiveApplication<R, F: FnOnce(&ICoreImmersiveApplication) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<CoreApplication, ICoreImmersiveApplication> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ICoreImmersiveApplication2<R, F: FnOnce(&ICoreImmersiveApplication2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<CoreApplication, ICoreImmersiveApplication2> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ICoreImmersiveApplication3<R, F: FnOnce(&ICoreImmersiveApplication3) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl CoreApplicationView {
    #[cfg(feature = "UI_Core")]
    pub fn CoreWindow(&self) -> windows_result::Result<super::super::UI::Core::CoreWindow> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsMain(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsHosted(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Core")]
    pub fn Dispatcher(&self) -> windows_result::Result<super::super::UI::Core::CoreDispatcher> {
    ...
    pub fn IsComponent(&self) -> windows_result::Result<bool> {
    ...
    pub fn TitleBar(&self) -> windows_result::Result<CoreApplicationViewTitleBar> {
        let this = &windows_core::Interface::cast::<ICoreApplicationView3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HostedViewClosing<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveHostedViewClosing(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<ICoreApplicationView3>(self)?;
    ...
    #[cfg(feature = "System")]
    pub fn DispatcherQueue(&self) -> windows_result::Result<super::super::System::DispatcherQueue> {
...
impl CoreApplicationViewTitleBar {
    pub fn SetExtendViewIntoTitleBar(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetExtendViewIntoTitleBar)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ExtendViewIntoTitleBar(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SystemOverlayLeftInset(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SystemOverlayRightInset(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Height(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LayoutMetricsChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveLayoutMetricsChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn IsVisibleChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<CoreApplicationViewTitleBar, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn RemoveIsVisibleChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
...
impl ICoreApplicationUnhandledError {
    pub fn UnhandledErrorDetected<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::Foundation::EventHandler<UnhandledErrorDetectedEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemoveUnhandledErrorDetected(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
...
pub trait ICoreApplicationUnhandledError_Impl: windows_core::IUnknownImpl {
    fn UnhandledErrorDetected(&self, handler: windows_core::Ref<super::super::Foundation::EventHandler<UnhandledErrorDetectedEventArgs>>) -> windows_result::Result<i64>;
    fn RemoveUnhandledErrorDetected(&self, token: i64) -> windows_result::Result<()>;
}
...
impl IFrameworkView {
    pub fn Initialize<P0>(&self, applicationview: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "UI_Core")]
    pub fn SetWindow<P0>(&self, window: P0) -> windows_result::Result<()>
    where
...
pub trait IFrameworkView_Impl: windows_core::IUnknownImpl {
    fn Initialize(&self, applicationView: windows_core::Ref<CoreApplicationView>) -> windows_result::Result<()>;
    fn SetWindow(&self, window: windows_core::Ref<super::super::UI::Core::CoreWindow>) -> windows_result::Result<()>;
    fn Load(&self, entryPoint: &windows_core::HSTRING) -> windows_result::Result<()>;
    fn Run(&self) -> windows_result::Result<()>;
...
impl IFrameworkViewSource {
    pub fn CreateView(&self) -> windows_result::Result<IFrameworkView> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IFrameworkViewSource_Impl: windows_core::IUnknownImpl {
    fn CreateView(&self) -> windows_result::Result<IFrameworkView>;
}
...
impl UnhandledError {
    ...
    pub fn Propagate(&self) -> windows_result::Result<()> {
        let this = self;
...
impl UnhandledErrorDetectedEventArgs {
    pub fn UnhandledError(&self) -> windows_result::Result<UnhandledError> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
