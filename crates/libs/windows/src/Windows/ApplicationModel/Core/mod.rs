...
windows_core::imp::required_hierarchy!(AppListEntry, IAppListEntry, IAppListEntry2, IAppListEntry3, IAppListEntry4);
impl AppListEntry {
...
windows_core::imp::required_hierarchy!(CoreApplicationView, ICoreApplicationView, ICoreApplicationView2, ICoreApplicationView3, ICoreApplicationView5, ICoreApplicationView6);
...
windows_core::imp::required_hierarchy!(CoreApplicationViewTitleBar, ICoreApplicationViewTitleBar);
...
windows_core::imp::required_hierarchy!(HostedViewClosingEventArgs, IHostedViewClosingEventArgs);
...
windows_core::imp::required_hierarchy!(UnhandledError, IUnhandledError);
impl UnhandledError {
...
windows_core::imp::required_hierarchy!(UnhandledErrorDetectedEventArgs, IUnhandledErrorDetectedEventArgs);
