...
windows_core::imp::required_hierarchy!(EasClientDeviceInformation, IEasClientDeviceInformation, IEasClientDeviceInformation2);
impl EasClientDeviceInformation {
    ...
    pub fn Id(&self) -> windows_core::Result<windows_core::GUID> {
        let this = &windows_core::Interface::cast::<IEasClientDeviceInformation>(self)?;
        unsafe {
...
windows_core::imp::required_hierarchy!(EasClientSecurityPolicy, IEasClientSecurityPolicy);
...
windows_core::imp::required_hierarchy!(EasComplianceResults, IEasComplianceResults, IEasComplianceResults2);
impl EasComplianceResults {
    pub fn Compliant(&self) -> windows_core::Result<bool> {
        let this = &windows_core::Interface::cast::<IEasComplianceResults>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
