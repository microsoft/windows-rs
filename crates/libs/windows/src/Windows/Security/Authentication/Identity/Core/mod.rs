...
impl MicrosoftAccountMultiFactorAuthenticationManager {
    pub fn GetOneTimePassCodeAsync(&self, useraccountid: &windows_core::HSTRING, codelength: u32) -> Result<windows_future::IAsyncOperation<MicrosoftAccountMultiFactorOneTimeCodedInfo>, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn AddDeviceAsync(&self, useraccountid: &windows_core::HSTRING, authenticationtoken: &windows_core::HSTRING, wnschannelid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<MicrosoftAccountMultiFactorServiceResponse>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RemoveDeviceAsync(&self, useraccountid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<MicrosoftAccountMultiFactorServiceResponse>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UpdateWnsChannelAsync(&self, useraccountid: &windows_core::HSTRING, channeluri: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<MicrosoftAccountMultiFactorServiceResponse>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetSessionsAsync<P0>(&self, useraccountidlist: P0) -> Result<windows_future::IAsyncOperation<MicrosoftAccountMultiFactorGetSessionsResult>, windows_result::HRESULT>
    where
    ...
    pub fn GetSessionsAndUnregisteredAccountsAsync<P0>(&self, useraccountidlist: P0) -> Result<windows_future::IAsyncOperation<MicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo>, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IIterable<windows_core::HSTRING>>,
    {
        let this = self;
    ...
    pub fn ApproveSessionUsingAuthSessionInfoAsync<P1>(&self, sessionauthentictionstatus: MicrosoftAccountMultiFactorSessionAuthenticationStatus, authenticationsessioninfo: P1) -> Result<windows_future::IAsyncOperation<MicrosoftAccountMultiFactorServiceResponse>, windows_result::HRESULT>
    where
    ...
    pub fn ApproveSessionAsync(&self, sessionauthentictionstatus: MicrosoftAccountMultiFactorSessionAuthenticationStatus, useraccountid: &windows_core::HSTRING, sessionid: &windows_core::HSTRING, sessionauthenticationtype: MicrosoftAccountMultiFactorAuthenticationType) -> Result<windows_future::IAsyncOperation<MicrosoftAccountMultiFactorServiceResponse>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DenySessionUsingAuthSessionInfoAsync<P0>(&self, authenticationsessioninfo: P0) -> Result<windows_future::IAsyncOperation<MicrosoftAccountMultiFactorServiceResponse>, windows_result::HRESULT>
    where
    ...
    pub fn DenySessionAsync(&self, useraccountid: &windows_core::HSTRING, sessionid: &windows_core::HSTRING, sessionauthenticationtype: MicrosoftAccountMultiFactorAuthenticationType) -> Result<windows_future::IAsyncOperation<MicrosoftAccountMultiFactorServiceResponse>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Current() -> Result<MicrosoftAccountMultiFactorAuthenticationManager, windows_result::HRESULT> {
    ...
    fn IMicrosoftAccountMultiFactorAuthenticatorStatics<R, F: FnOnce(&IMicrosoftAccountMultiFactorAuthenticatorStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl MicrosoftAccountMultiFactorGetSessionsResult {
    pub fn Sessions(&self) -> Result<windows_collections::IVectorView<MicrosoftAccountMultiFactorSessionInfo>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ServiceResponse(&self) -> Result<MicrosoftAccountMultiFactorServiceResponse, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MicrosoftAccountMultiFactorOneTimeCodedInfo {
    ...
    pub fn TimeInterval(&self) -> Result<super::super::super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TimeToLive(&self) -> Result<super::super::super::super::Foundation::TimeSpan, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MicrosoftAccountMultiFactorSessionInfo {
    pub fn UserAccountId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DisplaySessionId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ApprovalStatus(&self) -> Result<MicrosoftAccountMultiFactorSessionApprovalStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AuthenticationType(&self) -> Result<MicrosoftAccountMultiFactorAuthenticationType, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestTime(&self) -> Result<super::super::super::super::Foundation::DateTime, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ExpirationTime(&self) -> Result<super::super::super::super::Foundation::DateTime, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl MicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo {
    ...
    pub fn UnregisteredAccounts(&self) -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
