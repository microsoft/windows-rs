...
windows_core::imp::required_hierarchy!(MicrosoftAccountMultiFactorAuthenticationManager, IMicrosoftAccountMultiFactorAuthenticationManager, IMicrosoftAccountMultiFactorAuthenticatorStatics);
...
windows_core::imp::required_hierarchy!(MicrosoftAccountMultiFactorGetSessionsResult, IMicrosoftAccountMultiFactorGetSessionsResult);
...
windows_core::imp::required_hierarchy!(MicrosoftAccountMultiFactorOneTimeCodedInfo, IMicrosoftAccountMultiFactorOneTimeCodedInfo);
...
windows_core::imp::required_hierarchy!(MicrosoftAccountMultiFactorSessionInfo, IMicrosoftAccountMultiFactorSessionInfo);
...
windows_core::imp::required_hierarchy!(MicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo, IMicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo);
