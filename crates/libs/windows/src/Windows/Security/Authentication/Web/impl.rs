...
impl IWebAuthenticationBrokerStaticsVtbl {
    pub const fn new<Impl: IWebAuthenticationBrokerStaticsImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> IWebAuthenticationBrokerStaticsVtbl {
        unsafe extern "system" fn AuthenticateWithCallbackUriAsync<Impl: IWebAuthenticationBrokerStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, options: WebAuthenticationOptions, requesturi: ::windows::core::RawPtr, callbackuri: ::windows::core::RawPtr, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
        ...
        unsafe extern "system" fn AuthenticateWithoutCallbackUriAsync<Impl: IWebAuthenticationBrokerStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, options: WebAuthenticationOptions, requesturi: ::windows::core::RawPtr, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn GetCurrentApplicationCallbackUri<Impl: IWebAuthenticationBrokerStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<IWebAuthenticationBrokerStatics>, base.5, AuthenticateWithCallbackUriAsync::<Impl, OFFSET>, AuthenticateWithoutCallbackUriAsync::<Impl, OFFSET>, GetCurrentApplicationCallbackUri::<Impl, OFFSET>)
    }
}
#[cfg(feature = "implement_exclusive")]
...
impl IWebAuthenticationBrokerStatics2Vtbl {
    pub const fn new<Impl: IWebAuthenticationBrokerStatics2Impl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> IWebAuthenticationBrokerStatics2Vtbl {
        unsafe extern "system" fn AuthenticateAndContinue<Impl: IWebAuthenticationBrokerStatics2Impl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, requesturi: ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn AuthenticateWithCallbackUriAndContinue<Impl: IWebAuthenticationBrokerStatics2Impl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, requesturi: ::windows::core::RawPtr, callbackuri: ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn AuthenticateSilentlyAsync<Impl: IWebAuthenticationBrokerStatics2Impl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, requesturi: ::windows::core::RawPtr, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn AuthenticateSilentlyWithOptionsAsync<Impl: IWebAuthenticationBrokerStatics2Impl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, requesturi: ::windows::core::RawPtr, options: WebAuthenticationOptions, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<IWebAuthenticationBrokerStatics2>, base.5, AuthenticateAndContinue::<Impl, OFFSET>, AuthenticateWithCallbackUriAndContinue::<Impl, OFFSET>, AuthenticateWithCallbackUriContinuationDataAndOptionsAndContinue::<Impl, OFFSET>, AuthenticateSilentlyAsync::<Impl, OFFSET>, AuthenticateSilentlyWithOptionsAsync::<Impl, OFFSET>)
    }
}
#[cfg(feature = "implement_exclusive")]
...
impl IWebAuthenticationResultVtbl {
    pub const fn new<Impl: IWebAuthenticationResultImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> IWebAuthenticationResultVtbl {
        unsafe extern "system" fn ResponseData<Impl: IWebAuthenticationResultImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut ::core::mem::ManuallyDrop<::windows::core::HSTRING>) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn ResponseStatus<Impl: IWebAuthenticationResultImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut WebAuthenticationStatus) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn ResponseErrorDetail<Impl: IWebAuthenticationResultImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut u32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        Self(base.0, base.1, base.2, base.3, ::windows::core::GetRuntimeClassName::<IWebAuthenticationResult>, base.5, ResponseData::<Impl, OFFSET>, ResponseStatus::<Impl, OFFSET>, ResponseErrorDetail::<Impl, OFFSET>)
    }
}
