...
impl IWebAccountProviderBaseReportOperation {
    pub fn ReportCompleted(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).ReportCompleted)(windows_core::Interface::as_raw(this)).ok() }
    }
    #[cfg(feature = "Security_Authentication_Web_Core")]
    pub fn ReportError<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
...
pub trait IWebAccountProviderBaseReportOperation_Impl: windows_core::IUnknownImpl {
    fn ReportCompleted(&self) -> Result<(), windows_result::HRESULT>;
    fn ReportError(&self, value: windows_core::Ref<'_, super::Core::WebProviderError>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Security_Authentication_Web_Core")]
impl IWebAccountProviderBaseReportOperation_Vtbl {
    pub const fn new<Identity: IWebAccountProviderBaseReportOperation_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ReportCompleted<Identity: IWebAccountProviderBaseReportOperation_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWebAccountProviderBaseReportOperation_Impl::ReportCompleted(this).into()
            }
        }
        unsafe extern "system" fn ReportError<Identity: IWebAccountProviderBaseReportOperation_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IWebAccountProviderOperation {
    pub fn Kind(&self) -> Result<WebAccountProviderOperationKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
...
pub trait IWebAccountProviderOperation_Impl: windows_core::IUnknownImpl {
    fn Kind(&self) -> Result<WebAccountProviderOperationKind, windows_result::HRESULT>;
}
impl IWebAccountProviderOperation_Vtbl {
    pub const fn new<Identity: IWebAccountProviderOperation_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Kind<Identity: IWebAccountProviderOperation_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut WebAccountProviderOperationKind) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IWebAccountProviderSilentReportOperation {
    pub fn ReportUserInteractionRequired(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).ReportUserInteractionRequired)(windows_core::Interface::as_raw(this)).ok() }
    }
    #[cfg(feature = "Security_Authentication_Web_Core")]
    pub fn ReportUserInteractionRequiredWithError<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Core::WebProviderError>,
    {
        let this = self;
...
pub trait IWebAccountProviderSilentReportOperation_Impl: IWebAccountProviderBaseReportOperation_Impl {
    fn ReportUserInteractionRequired(&self) -> Result<(), windows_result::HRESULT>;
    fn ReportUserInteractionRequiredWithError(&self, value: windows_core::Ref<'_, super::Core::WebProviderError>) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Security_Authentication_Web_Core")]
impl IWebAccountProviderSilentReportOperation_Vtbl {
    pub const fn new<Identity: IWebAccountProviderSilentReportOperation_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ReportUserInteractionRequired<Identity: IWebAccountProviderSilentReportOperation_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWebAccountProviderSilentReportOperation_Impl::ReportUserInteractionRequired(this).into()
            }
        }
        unsafe extern "system" fn ReportUserInteractionRequiredWithError<Identity: IWebAccountProviderSilentReportOperation_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IWebAccountProviderTokenObjects {
    pub fn Operation(&self) -> Result<IWebAccountProviderOperation, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWebAccountProviderTokenObjects_Impl: windows_core::IUnknownImpl {
    fn Operation(&self) -> Result<IWebAccountProviderOperation, windows_result::HRESULT>;
}
impl IWebAccountProviderTokenObjects_Vtbl {
    pub const fn new<Identity: IWebAccountProviderTokenObjects_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Operation<Identity: IWebAccountProviderTokenObjects_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IWebAccountProviderTokenObjects2 {
    #[cfg(feature = "System")]
    pub fn User(&self) -> Result<super::super::super::super::System::User, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWebAccountProviderTokenObjects2_Impl: IWebAccountProviderTokenObjects_Impl {
    fn User(&self) -> Result<super::super::super::super::System::User, windows_result::HRESULT>;
}
#[cfg(feature = "System")]
impl IWebAccountProviderTokenObjects2_Vtbl {
    pub const fn new<Identity: IWebAccountProviderTokenObjects2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn User<Identity: IWebAccountProviderTokenObjects2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IWebAccountProviderTokenOperation {
    pub fn ProviderRequest(&self) -> Result<WebProviderTokenRequest, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ProviderResponses(&self) -> Result<windows_collections::IVector<WebProviderTokenResponse>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCacheExpirationTime(&self, value: super::super::super::super::Foundation::DateTime) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCacheExpirationTime)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CacheExpirationTime(&self) -> Result<super::super::super::super::Foundation::DateTime, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWebAccountProviderTokenOperation_Impl: IWebAccountProviderOperation_Impl {
    fn ProviderRequest(&self) -> Result<WebProviderTokenRequest, windows_result::HRESULT>;
    fn ProviderResponses(&self) -> Result<windows_collections::IVector<WebProviderTokenResponse>, windows_result::HRESULT>;
    fn SetCacheExpirationTime(&self, value: &super::super::super::super::Foundation::DateTime) -> Result<(), windows_result::HRESULT>;
    fn CacheExpirationTime(&self) -> Result<super::super::super::super::Foundation::DateTime, windows_result::HRESULT>;
}
impl IWebAccountProviderTokenOperation_Vtbl {
    pub const fn new<Identity: IWebAccountProviderTokenOperation_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ProviderRequest<Identity: IWebAccountProviderTokenOperation_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ProviderResponses<Identity: IWebAccountProviderTokenOperation_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetCacheExpirationTime<Identity: IWebAccountProviderTokenOperation_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: super::super::super::super::Foundation::DateTime) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWebAccountProviderTokenOperation_Impl::SetCacheExpirationTime(this, core::mem::transmute(&value)).into()
            }
        }
        unsafe extern "system" fn CacheExpirationTime<Identity: IWebAccountProviderTokenOperation_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut super::super::super::super::Foundation::DateTime) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IWebAccountProviderUIReportOperation {
    pub fn ReportUserCanceled(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
pub trait IWebAccountProviderUIReportOperation_Impl: IWebAccountProviderBaseReportOperation_Impl {
    fn ReportUserCanceled(&self) -> Result<(), windows_result::HRESULT>;
}
#[cfg(feature = "Security_Authentication_Web_Core")]
impl IWebAccountProviderUIReportOperation_Vtbl {
    pub const fn new<Identity: IWebAccountProviderUIReportOperation_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ReportUserCanceled<Identity: IWebAccountProviderUIReportOperation_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl WebAccountClientView {
    pub fn ApplicationCallbackUri(&self) -> Result<super::super::super::super::Foundation::Uri, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Type(&self) -> Result<WebAccountClientViewType, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AccountPairwiseId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Create<P1>(viewtype: WebAccountClientViewType, applicationcallbackuri: P1) -> Result<WebAccountClientView, windows_result::HRESULT>
    where
    ...
    pub fn CreateWithPairwiseId<P1>(viewtype: WebAccountClientViewType, applicationcallbackuri: P1, accountpairwiseid: &windows_core::HSTRING) -> Result<WebAccountClientView, windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::super::super::Foundation::Uri>,
    {
        Self::IWebAccountClientViewFactory(|this| unsafe {
    ...
    fn IWebAccountClientViewFactory<R, F: FnOnce(&IWebAccountClientViewFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl WebAccountManager {
    #[cfg(feature = "Security_Credentials")]
    pub fn UpdateWebAccountPropertiesAsync<P0, P2>(webaccount: P0, webaccountusername: &windows_core::HSTRING, additionalproperties: P2) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn AddWebAccountAsync<P2>(webaccountid: &windows_core::HSTRING, webaccountusername: &windows_core::HSTRING, props: P2) -> Result<windows_future::IAsyncOperation<super::super::super::Credentials::WebAccount>, windows_result::HRESULT>
    where
        P2: windows_core::Param<windows_collections::IMapView<windows_core::HSTRING, windows_core::HSTRING>>,
    {
        Self::IWebAccountManagerStatics(|this| unsafe {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn DeleteWebAccountAsync<P0>(webaccount: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccount>,
    {
        Self::IWebAccountManagerStatics(|this| unsafe {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn FindAllProviderWebAccountsAsync() -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::super::super::Credentials::WebAccount>>, windows_result::HRESULT> {
        Self::IWebAccountManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Web_Http")]
    pub fn PushCookiesAsync<P0, P1>(uri: P0, cookies: P1) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn SetViewAsync<P0, P1>(webaccount: P0, view: P1) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccount>,
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn ClearViewAsync<P0, P1>(webaccount: P0, applicationcallbackuri: P1) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccount>,
        P1: windows_core::Param<super::super::super::super::Foundation::Uri>,
    {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn GetViewsAsync<P0>(webaccount: P0) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<WebAccountClientView>>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccount>,
    {
        Self::IWebAccountManagerStatics(|this| unsafe {
    ...
    #[cfg(all(feature = "Security_Credentials", feature = "Storage_Streams"))]
    pub fn SetWebAccountPictureAsync<P0, P1>(webaccount: P0, webaccountpicture: P1) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccount>,
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn ClearWebAccountPictureAsync<P0>(webaccount: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccount>,
    {
        Self::IWebAccountManagerStatics(|this| unsafe {
    ...
    pub fn PullCookiesAsync(uristring: &windows_core::HSTRING, callerpfn: &windows_core::HSTRING) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
    ...
    #[cfg(all(feature = "Security_Credentials", feature = "System"))]
    pub fn FindAllProviderWebAccountsForUserAsync<P0>(user: P0) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::super::super::Credentials::WebAccount>>, windows_result::HRESULT>
    where
    ...
    #[cfg(all(feature = "Security_Credentials", feature = "System"))]
    pub fn AddWebAccountForUserAsync<P0, P3>(user: P0, webaccountid: &windows_core::HSTRING, webaccountusername: &windows_core::HSTRING, props: P3) -> Result<windows_future::IAsyncOperation<super::super::super::Credentials::WebAccount>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::super::System::User>,
    ...
    #[cfg(all(feature = "Security_Credentials", feature = "System"))]
    pub fn AddWebAccountWithScopeForUserAsync<P0, P3>(user: P0, webaccountid: &windows_core::HSTRING, webaccountusername: &windows_core::HSTRING, props: P3, scope: WebAccountScope) -> Result<windows_future::IAsyncOperation<super::super::super::Credentials::WebAccount>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::super::System::User>,
        P3: windows_core::Param<windows_collections::IMapView<windows_core::HSTRING, windows_core::HSTRING>>,
    {
    ...
    #[cfg(all(feature = "Security_Credentials", feature = "System"))]
    pub fn AddWebAccountWithScopeAndMapForUserAsync<P0, P3>(user: P0, webaccountid: &windows_core::HSTRING, webaccountusername: &windows_core::HSTRING, props: P3, scope: WebAccountScope, peruserwebaccountid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<super::super::super::Credentials::WebAccount>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::super::System::User>,
        P3: windows_core::Param<windows_collections::IMapView<windows_core::HSTRING, windows_core::HSTRING>>,
    {
    ...
    pub fn InvalidateAppCacheForAllAccountsAsync() -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn InvalidateAppCacheForAccountAsync<P0>(webaccount: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccount>,
    {
        Self::IWebAccountManagerStatics4(|this| unsafe {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn AddWebAccountWithScopeAndMapAsync<P2>(webaccountid: &windows_core::HSTRING, webaccountusername: &windows_core::HSTRING, props: P2, scope: WebAccountScope, peruserwebaccountid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<super::super::super::Credentials::WebAccount>, windows_result::HRESULT>
    where
        P2: windows_core::Param<windows_collections::IMapView<windows_core::HSTRING, windows_core::HSTRING>>,
    {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn SetPerAppToPerUserAccountAsync<P0>(perappaccount: P0, peruserwebaccountid: &windows_core::HSTRING) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccount>,
    {
        Self::IWebAccountMapManagerStatics(|this| unsafe {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn GetPerUserFromPerAppAccountAsync<P0>(perappaccount: P0) -> Result<windows_future::IAsyncOperation<super::super::super::Credentials::WebAccount>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccount>,
    {
        Self::IWebAccountMapManagerStatics(|this| unsafe {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn ClearPerUserFromPerAppAccountAsync<P0>(perappaccount: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccount>,
    {
        Self::IWebAccountMapManagerStatics(|this| unsafe {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn AddWebAccountWithScopeAsync<P2>(webaccountid: &windows_core::HSTRING, webaccountusername: &windows_core::HSTRING, props: P2, scope: WebAccountScope) -> Result<windows_future::IAsyncOperation<super::super::super::Credentials::WebAccount>, windows_result::HRESULT>
    where
        P2: windows_core::Param<windows_collections::IMapView<windows_core::HSTRING, windows_core::HSTRING>>,
    {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn SetScopeAsync<P0>(webaccount: P0, scope: WebAccountScope) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccount>,
    {
        Self::IWebAccountScopeManagerStatics(|this| unsafe {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn GetScope<P0>(webaccount: P0) -> Result<WebAccountScope, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccount>,
    {
        Self::IWebAccountScopeManagerStatics(|this| unsafe {
    ...
    fn IWebAccountManagerStatics<R, F: FnOnce(&IWebAccountManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IWebAccountManagerStatics2<R, F: FnOnce(&IWebAccountManagerStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IWebAccountManagerStatics3<R, F: FnOnce(&IWebAccountManagerStatics3) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IWebAccountManagerStatics4<R, F: FnOnce(&IWebAccountManagerStatics4) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IWebAccountMapManagerStatics<R, F: FnOnce(&IWebAccountMapManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IWebAccountScopeManagerStatics<R, F: FnOnce(&IWebAccountScopeManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl WebAccountProviderDeleteAccountOperation {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn WebAccount(&self) -> Result<super::super::super::Credentials::WebAccount, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WebAccountProviderRetrieveCookiesOperation {
    ...
    pub fn Context(&self) -> Result<super::super::super::super::Foundation::Uri, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Web_Http")]
    pub fn Cookies(&self) -> Result<windows_collections::IVector<super::super::super::super::Web::Http::HttpCookie>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Uri(&self) -> Result<super::super::super::super::Foundation::Uri, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WebAccountProviderSignOutAccountOperation {
    ...
    pub fn ClientId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WebProviderTokenRequest {
    #[cfg(feature = "Security_Authentication_Web_Core")]
    pub fn ClientRequest(&self) -> Result<super::Core::WebTokenRequest, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn WebAccounts(&self) -> Result<windows_collections::IVectorView<super::super::super::Credentials::WebAccount>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn WebAccountSelectionOptions(&self) -> Result<WebAccountSelectionOptions, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Cryptography_Core")]
    pub fn GetApplicationTokenBindingKeyAsync<P1>(&self, keytype: super::TokenBindingKeyType, target: P1) -> Result<windows_future::IAsyncOperation<super::super::super::Cryptography::Core::CryptographicKey>, windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetApplicationTokenBindingKeyIdAsync<P1>(&self, keytype: super::TokenBindingKeyType, target: P1) -> Result<windows_future::IAsyncOperation<super::super::super::super::Storage::Streams::IBuffer>, windows_result::HRESULT>
    where
        P1: windows_core::Param<super::super::super::super::Foundation::Uri>,
    {
    ...
    pub fn ApplicationPackageFamilyName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn ApplicationProcessName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IWebProviderTokenRequest3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CheckApplicationForCapabilityAsync(&self, capabilityname: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IWebProviderTokenRequest3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WebProviderTokenResponse {
    #[cfg(feature = "Security_Authentication_Web_Core")]
    pub fn ClientResponse(&self) -> Result<super::Core::WebTokenResponse, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Authentication_Web_Core")]
    pub fn Create<P0>(webtokenresponse: P0) -> Result<WebProviderTokenResponse, windows_result::HRESULT>
    where
    ...
    fn IWebProviderTokenResponseFactory<R, F: FnOnce(&IWebProviderTokenResponseFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
