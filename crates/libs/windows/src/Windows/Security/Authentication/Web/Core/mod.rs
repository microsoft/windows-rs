...
windows_core::imp::required_hierarchy!(FindAllAccountsResult, IFindAllAccountsResult);
...
windows_core::imp::required_hierarchy!(WebAccountEventArgs, IWebAccountEventArgs);
...
windows_core::imp::required_hierarchy!(WebAccountMonitor, IWebAccountMonitor, IWebAccountMonitor2);
...
windows_core::imp::required_hierarchy!(WebProviderError, IWebProviderError, IWebProviderErrorFactory);
...
windows_core::imp::required_hierarchy!(WebTokenRequest, IWebTokenRequest, IWebTokenRequest2, IWebTokenRequest3, IWebTokenRequestFactory);
...
windows_core::imp::required_hierarchy!(WebTokenRequestResult, IWebTokenRequestResult);
...
windows_core::imp::required_hierarchy!(WebTokenResponse, IWebTokenResponse, IWebTokenResponseFactory);
