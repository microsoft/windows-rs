...
impl FindAllAccountsResult {
    ...
    pub fn Accounts(&self) -> windows_result::Result<windows_collections::IVectorView<super::super::super::Credentials::WebAccount>> {
        let this = self;
        unsafe {
    ...
    pub fn Status(&self) -> windows_result::Result<FindAllWebAccountsStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ProviderError(&self) -> windows_result::Result<WebProviderError> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WebAccountEventArgs {
    #[cfg(feature = "Security_Credentials")]
    pub fn Account(&self) -> windows_result::Result<super::super::super::Credentials::WebAccount> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WebAccountMonitor {
    ...
    pub fn DefaultSignInAccountChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveDefaultSignInAccountChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveDefaultSignInAccountChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn AccountPictureUpdated<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::super::Foundation::TypedEventHandler<WebAccountMonitor, WebAccountEventArgs>>,
    {
    ...
    pub fn RemoveAccountPictureUpdated(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IWebAccountMonitor2>(self)?;
...
impl WebAuthenticationAddAccountResponse {
    ...
    pub fn Properties(&self) -> windows_result::Result<windows_collections::IMap<windows_core::HSTRING, windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn CreateWithAccount<P0>(webaccount: P0) -> windows_result::Result<WebAuthenticationAddAccountResponse>
    where
    ...
    fn IWebAuthenticationAddAccountResponseFactory<R, F: FnOnce(&IWebAuthenticationAddAccountResponseFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl WebAuthenticationAddAccountResult {
    pub fn ResponseData(&self) -> windows_result::Result<WebAuthenticationAddAccountResponse> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ResponseStatus(&self) -> windows_result::Result<WebAuthenticationAddAccountStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ResponseError(&self) -> windows_result::Result<WebProviderError> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WebAuthenticationCoreManager {
    pub fn GetTokenSilentlyAsync<P0>(request: P0) -> windows_result::Result<windows_future::IAsyncOperation<WebTokenRequestResult>>
    where
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn GetTokenSilentlyWithWebAccountAsync<P0, P1>(request: P0, webaccount: P1) -> windows_result::Result<windows_future::IAsyncOperation<WebTokenRequestResult>>
    where
        P0: windows_core::Param<WebTokenRequest>,
    ...
    pub fn RequestTokenAsync<P0>(request: P0) -> windows_result::Result<windows_future::IAsyncOperation<WebTokenRequestResult>>
    where
        P0: windows_core::Param<WebTokenRequest>,
    {
        Self::IWebAuthenticationCoreManagerStatics(|this| unsafe {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn RequestTokenWithWebAccountAsync<P0, P1>(request: P0, webaccount: P1) -> windows_result::Result<windows_future::IAsyncOperation<WebTokenRequestResult>>
    where
        P0: windows_core::Param<WebTokenRequest>,
        P1: windows_core::Param<super::super::super::Credentials::WebAccount>,
    {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn FindAccountAsync<P0>(provider: P0, webaccountid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<super::super::super::Credentials::WebAccount>>
    where
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn FindAccountProviderAsync(webaccountproviderid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<super::super::super::Credentials::WebAccountProvider>> {
        Self::IWebAuthenticationCoreManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn FindAccountProviderWithAuthorityAsync(webaccountproviderid: &windows_core::HSTRING, authority: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<super::super::super::Credentials::WebAccountProvider>> {
        Self::IWebAuthenticationCoreManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Security_Credentials", feature = "System"))]
    pub fn FindAccountProviderWithAuthorityForUserAsync<P2>(webaccountproviderid: &windows_core::HSTRING, authority: &windows_core::HSTRING, user: P2) -> windows_result::Result<windows_future::IAsyncOperation<super::super::super::Credentials::WebAccountProvider>>
    where
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn CreateWebAccountMonitor<P0>(webaccounts: P0) -> windows_result::Result<WebAccountMonitor>
    where
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn FindAllAccountsAsync<P0>(provider: P0) -> windows_result::Result<windows_future::IAsyncOperation<FindAllAccountsResult>>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccountProvider>,
    {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn FindAllAccountsWithClientIdAsync<P0>(provider: P0, clientid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<FindAllAccountsResult>>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccountProvider>,
    {
        Self::IWebAuthenticationCoreManagerStatics4(|this| unsafe {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn FindSystemAccountProviderAsync(webaccountproviderid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<super::super::super::Credentials::WebAccountProvider>> {
        Self::IWebAuthenticationCoreManagerStatics4(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn FindSystemAccountProviderWithAuthorityAsync(webaccountproviderid: &windows_core::HSTRING, authority: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<super::super::super::Credentials::WebAccountProvider>> {
        Self::IWebAuthenticationCoreManagerStatics4(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Security_Credentials", feature = "System"))]
    pub fn FindSystemAccountProviderWithAuthorityForUserAsync<P2>(webaccountproviderid: &windows_core::HSTRING, authority: &windows_core::HSTRING, user: P2) -> windows_result::Result<windows_future::IAsyncOperation<super::super::super::Credentials::WebAccountProvider>>
    where
        P2: windows_core::Param<super::super::super::super::System::User>,
    {
        Self::IWebAuthenticationCoreManagerStatics4(|this| unsafe {
    ...
    pub fn AddAccountWithTransferTokenAsync<P0>(request: P0) -> windows_result::Result<windows_future::IAsyncOperation<WebAuthenticationAddAccountResult>>
    where
    ...
    fn IWebAuthenticationCoreManagerStatics<R, F: FnOnce(&IWebAuthenticationCoreManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IWebAuthenticationCoreManagerStatics2<R, F: FnOnce(&IWebAuthenticationCoreManagerStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IWebAuthenticationCoreManagerStatics3<R, F: FnOnce(&IWebAuthenticationCoreManagerStatics3) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IWebAuthenticationCoreManagerStatics4<R, F: FnOnce(&IWebAuthenticationCoreManagerStatics4) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IWebAuthenticationCoreManagerStatics5<R, F: FnOnce(&IWebAuthenticationCoreManagerStatics5) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl WebAuthenticationTransferTokenRequest {
    #[cfg(feature = "Security_Credentials")]
    pub fn WebAccountProvider(&self) -> windows_result::Result<super::super::super::Credentials::WebAccountProvider> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TransferToken(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTransferToken(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn CorrelationId(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCorrelationId(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn Create<P0>(provider: P0, transfertoken: &windows_core::HSTRING) -> windows_result::Result<WebAuthenticationTransferTokenRequest>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccountProvider>,
    {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn CreateWithCorrelationId<P0>(provider: P0, transfertoken: &windows_core::HSTRING, correlationid: &windows_core::HSTRING) -> windows_result::Result<WebAuthenticationTransferTokenRequest>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccountProvider>,
    {
        Self::IWebAuthenticationTransferTokenRequestFactory(|this| unsafe {
    ...
    fn IWebAuthenticationTransferTokenRequestFactory<R, F: FnOnce(&IWebAuthenticationTransferTokenRequestFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl WebProviderError {
    ...
    pub fn ErrorMessage(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Create(errorcode: u32, errormessage: &windows_core::HSTRING) -> windows_result::Result<WebProviderError> {
    ...
    fn IWebProviderErrorFactory<R, F: FnOnce(&IWebProviderErrorFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl WebTokenRequest {
    ...
    pub fn Scope(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PromptType(&self) -> windows_result::Result<WebTokenRequestPromptType> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AppProperties(&self) -> windows_result::Result<windows_collections::IMap<windows_core::HSTRING, windows_core::HSTRING>> {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn Create<P0>(provider: P0, scope: &windows_core::HSTRING, clientid: &windows_core::HSTRING) -> windows_result::Result<WebTokenRequest>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccountProvider>,
    {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn CreateWithPromptType<P0>(provider: P0, scope: &windows_core::HSTRING, clientid: &windows_core::HSTRING, prompttype: WebTokenRequestPromptType) -> windows_result::Result<WebTokenRequest>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccountProvider>,
    {
        Self::IWebTokenRequestFactory(|this| unsafe {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn CreateWithProvider<P0>(provider: P0) -> windows_result::Result<WebTokenRequest>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccountProvider>,
    {
        Self::IWebTokenRequestFactory(|this| unsafe {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn CreateWithScope<P0>(provider: P0, scope: &windows_core::HSTRING) -> windows_result::Result<WebTokenRequest>
    where
        P0: windows_core::Param<super::super::super::Credentials::WebAccountProvider>,
    {
        Self::IWebTokenRequestFactory(|this| unsafe {
    ...
    fn IWebTokenRequestFactory<R, F: FnOnce(&IWebTokenRequestFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl WebTokenRequestResult {
    pub fn ResponseData(&self) -> windows_result::Result<windows_collections::IVectorView<WebTokenResponse>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ResponseData)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ResponseStatus(&self) -> windows_result::Result<WebTokenRequestStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ResponseStatus)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn InvalidateCacheAsync(&self) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WebTokenResponse {
    ...
    pub fn Token(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateWithToken(token: &windows_core::HSTRING) -> windows_result::Result<WebTokenResponse> {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn CreateWithTokenAndAccount<P1>(token: &windows_core::HSTRING, webaccount: P1) -> windows_result::Result<WebTokenResponse>
    where
        P1: windows_core::Param<super::super::super::Credentials::WebAccount>,
    {
        Self::IWebTokenResponseFactory(|this| unsafe {
    ...
    #[cfg(feature = "Security_Credentials")]
    pub fn CreateWithTokenAccountAndError<P1, P2>(token: &windows_core::HSTRING, webaccount: P1, error: P2) -> windows_result::Result<WebTokenResponse>
    where
        P1: windows_core::Param<super::super::super::Credentials::WebAccount>,
    ...
    fn IWebTokenResponseFactory<R, F: FnOnce(&IWebTokenResponseFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
