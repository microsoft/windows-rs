...
impl WebAuthenticationBroker {
    pub fn AuthenticateWithCallbackUriAsync<P1, P2>(options: WebAuthenticationOptions, requesturi: P1, callbackuri: P2) -> windows_result::Result<windows_future::IAsyncOperation<WebAuthenticationResult>>
    where
    ...
    pub fn AuthenticateWithoutCallbackUriAsync<P1>(options: WebAuthenticationOptions, requesturi: P1) -> windows_result::Result<windows_future::IAsyncOperation<WebAuthenticationResult>>
    where
        P1: windows_core::Param<super::super::super::Foundation::Uri>,
    {
        Self::IWebAuthenticationBrokerStatics(|this| unsafe {
    ...
    pub fn GetCurrentApplicationCallbackUri() -> windows_result::Result<super::super::super::Foundation::Uri> {
        Self::IWebAuthenticationBrokerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AuthenticateAndContinue<P0>(requesturi: P0) -> windows_result::Result<()>
    where
    ...
    pub fn AuthenticateWithCallbackUriAndContinue<P0, P1>(requesturi: P0, callbackuri: P1) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::super::Foundation::Uri>,
        P1: windows_core::Param<super::super::super::Foundation::Uri>,
    {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn AuthenticateWithCallbackUriContinuationDataAndOptionsAndContinue<P0, P1, P2>(requesturi: P0, callbackuri: P1, continuationdata: P2, options: WebAuthenticationOptions) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::super::Foundation::Uri>,
        P1: windows_core::Param<super::super::super::Foundation::Uri>,
    ...
    pub fn AuthenticateSilentlyAsync<P0>(requesturi: P0) -> windows_result::Result<windows_future::IAsyncOperation<WebAuthenticationResult>>
    where
        P0: windows_core::Param<super::super::super::Foundation::Uri>,
    {
    ...
    pub fn AuthenticateSilentlyWithOptionsAsync<P0>(requesturi: P0, options: WebAuthenticationOptions) -> windows_result::Result<windows_future::IAsyncOperation<WebAuthenticationResult>>
    where
        P0: windows_core::Param<super::super::super::Foundation::Uri>,
    {
        Self::IWebAuthenticationBrokerStatics2(|this| unsafe {
    ...
    fn IWebAuthenticationBrokerStatics<R, F: FnOnce(&IWebAuthenticationBrokerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IWebAuthenticationBrokerStatics2<R, F: FnOnce(&IWebAuthenticationBrokerStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl WebAuthenticationResult {
    pub fn ResponseData(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ResponseStatus(&self) -> windows_result::Result<WebAuthenticationStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ResponseErrorDetail(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
