...
impl OnlineIdSystemAuthenticatorForUser {
    pub fn GetTicketAsync<P0>(&self, request: P0) -> windows_core::Result<windows_async::IAsyncOperation<OnlineIdSystemTicketResult>>
    where
        P0: windows_core::Param<OnlineIdServiceTicketRequest>,
    {
        let this = self;
...
pub type SignOutUserOperation = windows_async::IAsyncAction;
pub type UserAuthenticationOperation = windows_async::IAsyncOperation<UserIdentity>;
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
