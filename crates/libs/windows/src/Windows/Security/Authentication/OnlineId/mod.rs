...
windows_core::imp::required_hierarchy!(OnlineIdAuthenticator, IOnlineIdAuthenticator);
...
windows_core::imp::required_hierarchy!(OnlineIdServiceTicket, IOnlineIdServiceTicket);
...
windows_core::imp::required_hierarchy!(OnlineIdServiceTicketRequest, IOnlineIdServiceTicketRequest, IOnlineIdServiceTicketRequestFactory);
...
windows_core::imp::required_hierarchy!(OnlineIdSystemAuthenticatorForUser, IOnlineIdSystemAuthenticatorForUser);
...
windows_core::imp::required_hierarchy!(OnlineIdSystemIdentity, IOnlineIdSystemIdentity);
...
windows_core::imp::required_hierarchy!(OnlineIdSystemTicketResult, IOnlineIdSystemTicketResult);
...
windows_core::imp::required_hierarchy!(UserIdentity, IUserIdentity);
impl UserIdentity {
    #[cfg(feature = "Foundation_Collections")]
