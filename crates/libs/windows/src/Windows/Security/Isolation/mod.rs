...
impl HostMessageReceivedCallback {
    pub fn new<F: Fn(&windows_core::GUID, windows_core::Ref<windows_collections::IVectorView<windows_core::IInspectable>>) -> windows_result::Result<()> + Send + 'static>(invoke: F) -> Self {
    ...
    pub fn Invoke<P1>(&self, receiverid: windows_core::GUID, message: P1) -> windows_result::Result<()>
    where
...
#[repr(C)]
struct HostMessageReceivedCallbackBox<F: Fn(&windows_core::GUID, windows_core::Ref<windows_collections::IVectorView<windows_core::IInspectable>>) -> windows_result::Result<()> + Send + 'static> {
    vtable: *const HostMessageReceivedCallback_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: Fn(&windows_core::GUID, windows_core::Ref<windows_collections::IVectorView<windows_core::IInspectable>>) -> windows_result::Result<()> + Send + 'static> HostMessageReceivedCallbackBox<F> {
...
impl IsolatedWindowsEnvironment {
    ...
    pub fn StartProcessSilentlyAsync(&self, hostexepath: &windows_core::HSTRING, arguments: &windows_core::HSTRING, activator: IsolatedWindowsEnvironmentActivator) -> windows_result::Result<windows_future::IAsyncOperation<IsolatedWindowsEnvironmentStartProcessResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StartProcessSilentlyWithTelemetryAsync<P3>(&self, hostexepath: &windows_core::HSTRING, arguments: &windows_core::HSTRING, activator: IsolatedWindowsEnvironmentActivator, telemetryparameters: P3) -> windows_result::Result<windows_future::IAsyncOperation<IsolatedWindowsEnvironmentStartProcessResult>>
    where
    ...
    pub fn ShareFolderAsync<P1>(&self, hostfolder: &windows_core::HSTRING, requestoptions: P1) -> windows_result::Result<windows_future::IAsyncOperation<IsolatedWindowsEnvironmentShareFolderResult>>
    where
    ...
    pub fn ShareFolderWithTelemetryAsync<P1, P2>(&self, hostfolder: &windows_core::HSTRING, requestoptions: P1, telemetryparameters: P2) -> windows_result::Result<windows_future::IAsyncOperation<IsolatedWindowsEnvironmentShareFolderResult>>
    where
        P1: windows_core::Param<IsolatedWindowsEnvironmentShareFolderRequestOptions>,
    ...
    pub fn LaunchFileWithUIAsync(&self, appexepath: &windows_core::HSTRING, argumentstemplate: &windows_core::HSTRING, filepath: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<IsolatedWindowsEnvironmentLaunchFileResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LaunchFileWithUIAndTelemetryAsync<P3>(&self, appexepath: &windows_core::HSTRING, argumentstemplate: &windows_core::HSTRING, filepath: &windows_core::HSTRING, telemetryparameters: P3) -> windows_result::Result<windows_future::IAsyncOperation<IsolatedWindowsEnvironmentLaunchFileResult>>
    where
        P3: windows_core::Param<IsolatedWindowsEnvironmentTelemetryParameters>,
    {
        let this = self;
    ...
    pub fn TerminateAsync(&self) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TerminateWithTelemetryAsync<P0>(&self, telemetryparameters: P0) -> windows_result::Result<windows_future::IAsyncAction>
    where
    ...
    pub fn RegisterMessageReceiver<P1>(&self, receiverid: windows_core::GUID, messagereceivedcallback: P1) -> windows_result::Result<()>
    where
    ...
    pub fn UnregisterMessageReceiver(&self, receiverid: windows_core::GUID) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).UnregisterMessageReceiver)(windows_core::Interface::as_raw(this), receiverid).ok() }
    }
    pub fn PostMessageToReceiverAsync<P1>(&self, receiverid: windows_core::GUID, message: P1) -> windows_result::Result<windows_future::IAsyncOperation<IsolatedWindowsEnvironmentPostMessageResult>>
    where
    ...
    pub fn PostMessageToReceiverWithTelemetryAsync<P1, P2>(&self, receiverid: windows_core::GUID, message: P1, telemetryparameters: P2) -> windows_result::Result<windows_future::IAsyncOperation<IsolatedWindowsEnvironmentPostMessageResult>>
    where
        P1: windows_core::Param<windows_collections::IIterable<windows_core::IInspectable>>,
        P2: windows_core::Param<IsolatedWindowsEnvironmentTelemetryParameters>,
    {
    ...
    pub fn GetUserInfo(&self) -> windows_result::Result<IsolatedWindowsEnvironmentUserInfo> {
    ...
    pub fn ShareFileAsync<P1>(&self, filepath: &windows_core::HSTRING, options: P1) -> windows_result::Result<windows_future::IAsyncOperation<IsolatedWindowsEnvironmentShareFileResult>>
    where
    ...
    pub fn ShareFileWithTelemetryAsync<P1, P2>(&self, filepath: &windows_core::HSTRING, options: P1, telemetryparameters: P2) -> windows_result::Result<windows_future::IAsyncOperation<IsolatedWindowsEnvironmentShareFileResult>>
    where
        P1: windows_core::Param<IsolatedWindowsEnvironmentShareFileRequestOptions>,
        P2: windows_core::Param<IsolatedWindowsEnvironmentTelemetryParameters>,
    {
    ...
    pub fn ChangePriority(&self, priority: IsolatedWindowsEnvironmentCreationPriority) -> windows_result::Result<()> {
    ...
    pub fn CreateAsync<P0>(options: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<IsolatedWindowsEnvironmentCreateResult, IsolatedWindowsEnvironmentCreateProgress>>
    where
    ...
    pub fn CreateWithTelemetryAsync<P0, P1>(options: P0, telemetryparameters: P1) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<IsolatedWindowsEnvironmentCreateResult, IsolatedWindowsEnvironmentCreateProgress>>
    where
        P0: windows_core::Param<IsolatedWindowsEnvironmentOptions>,
    ...
    pub fn GetById(environmentid: &windows_core::HSTRING) -> windows_result::Result<IsolatedWindowsEnvironment> {
        Self::IIsolatedWindowsEnvironmentFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindByOwnerId(environmentownerid: &windows_core::HSTRING) -> windows_result::Result<windows_collections::IVectorView<IsolatedWindowsEnvironment>> {
        Self::IIsolatedWindowsEnvironmentFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IIsolatedWindowsEnvironmentFactory<R, F: FnOnce(&IIsolatedWindowsEnvironmentFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl IsolatedWindowsEnvironmentCreateResult {
    pub fn Status(&self) -> windows_result::Result<IsolatedWindowsEnvironmentCreateStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Environment(&self) -> windows_result::Result<IsolatedWindowsEnvironment> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ChangeCreationPriority(&self, priority: IsolatedWindowsEnvironmentCreationPriority) -> windows_result::Result<()> {
...
impl IsolatedWindowsEnvironmentFile {
    ...
    pub fn HostPath(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GuestPath(&self) -> windows_result::Result<windows_core::HSTRING> {
...
impl IsolatedWindowsEnvironmentHost {
    pub fn IsReady() -> windows_result::Result<bool> {
    ...
    pub fn HostErrors() -> windows_result::Result<windows_collections::IVectorView<IsolatedWindowsEnvironmentHostError>> {
        Self::IIsolatedWindowsEnvironmentHostStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IIsolatedWindowsEnvironmentHostStatics<R, F: FnOnce(&IIsolatedWindowsEnvironmentHostStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl IsolatedWindowsEnvironmentLaunchFileResult {
    pub fn Status(&self) -> windows_result::Result<IsolatedWindowsEnvironmentLaunchFileStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn File(&self) -> windows_result::Result<IsolatedWindowsEnvironmentFile> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl IsolatedWindowsEnvironmentOptions {
    ...
    pub fn EnvironmentOwnerId(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetEnvironmentOwnerId(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AllowedClipboardFormats(&self) -> windows_result::Result<IsolatedWindowsEnvironmentAllowedClipboardFormats> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAllowedClipboardFormats(&self, value: IsolatedWindowsEnvironmentAllowedClipboardFormats) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAllowedClipboardFormats)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ClipboardCopyPasteDirections(&self) -> windows_result::Result<IsolatedWindowsEnvironmentClipboardCopyPasteDirections> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetClipboardCopyPasteDirections(&self, value: IsolatedWindowsEnvironmentClipboardCopyPasteDirections) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetClipboardCopyPasteDirections)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AvailablePrinters(&self) -> windows_result::Result<IsolatedWindowsEnvironmentAvailablePrinters> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAvailablePrinters(&self, value: IsolatedWindowsEnvironmentAvailablePrinters) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAvailablePrinters)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SharedHostFolderPath(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SharedFolderNameInEnvironment(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShareHostFolderForUntrustedItems(&self, sharedhostfolderpath: &windows_core::HSTRING, sharefoldernameinenvironment: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn PersistUserProfile(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPersistUserProfile(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetPersistUserProfile)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AllowGraphicsHardwareAcceleration(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAllowGraphicsHardwareAcceleration(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn AllowCameraAndMicrophoneAccess(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAllowCameraAndMicrophoneAccess(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAllowCameraAndMicrophoneAccess)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn WindowAnnotationOverride(&self) -> windows_result::Result<windows_core::HSTRING> {
    ...
    pub fn SetWindowAnnotationOverride(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IIsolatedWindowsEnvironmentOptions2>(self)?;
    ...
    pub fn AllowedClipboardFormatsToEnvironment(&self) -> windows_result::Result<IsolatedWindowsEnvironmentAllowedClipboardFormats> {
    ...
    pub fn SetAllowedClipboardFormatsToEnvironment(&self, value: IsolatedWindowsEnvironmentAllowedClipboardFormats) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IIsolatedWindowsEnvironmentOptions3>(self)?;
    ...
    pub fn AllowedClipboardFormatsToHost(&self) -> windows_result::Result<IsolatedWindowsEnvironmentAllowedClipboardFormats> {
        let this = &windows_core::Interface::cast::<IIsolatedWindowsEnvironmentOptions3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAllowedClipboardFormatsToHost(&self, value: IsolatedWindowsEnvironmentAllowedClipboardFormats) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IIsolatedWindowsEnvironmentOptions3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetAllowedClipboardFormatsToHost)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CreationPriority(&self) -> windows_result::Result<IsolatedWindowsEnvironmentCreationPriority> {
        let this = &windows_core::Interface::cast::<IIsolatedWindowsEnvironmentOptions3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCreationPriority(&self, value: IsolatedWindowsEnvironmentCreationPriority) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IIsolatedWindowsEnvironmentOptions3>(self)?;
...
impl IsolatedWindowsEnvironmentOwnerRegistration {
    pub fn Register<P1>(ownername: &windows_core::HSTRING, ownerregistrationdata: P1) -> windows_result::Result<IsolatedWindowsEnvironmentOwnerRegistrationResult>
    where
    ...
    pub fn Unregister(ownername: &windows_core::HSTRING) -> windows_result::Result<()> {
    ...
    fn IIsolatedWindowsEnvironmentOwnerRegistrationStatics<R, F: FnOnce(&IIsolatedWindowsEnvironmentOwnerRegistrationStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl IsolatedWindowsEnvironmentOwnerRegistrationData {
    ...
    pub fn ShareableFolders(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ProcessesRunnableAsSystem(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ProcessesRunnableAsUser(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ActivationFileExtensions(&self) -> windows_result::Result<windows_collections::IVector<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl IsolatedWindowsEnvironmentOwnerRegistrationResult {
    pub fn Status(&self) -> windows_result::Result<IsolatedWindowsEnvironmentOwnerRegistrationStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl IsolatedWindowsEnvironmentPostMessageResult {
    pub fn Status(&self) -> windows_result::Result<IsolatedWindowsEnvironmentPostMessageStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl IsolatedWindowsEnvironmentProcess {
    pub fn State(&self) -> windows_result::Result<IsolatedWindowsEnvironmentProcessState> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn WaitForExit(&self) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).WaitForExit)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn WaitForExitWithTimeout(&self, timeoutmilliseconds: u32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn WaitForExitAsync(&self) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl IsolatedWindowsEnvironmentShareFileRequestOptions {
    ...
    pub fn AllowWrite(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAllowWrite(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
...
impl IsolatedWindowsEnvironmentShareFileResult {
    pub fn Status(&self) -> windows_result::Result<IsolatedWindowsEnvironmentShareFileStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl IsolatedWindowsEnvironmentShareFolderResult {
    pub fn Status(&self) -> windows_result::Result<IsolatedWindowsEnvironmentShareFolderStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl IsolatedWindowsEnvironmentStartProcessResult {
    pub fn Status(&self) -> windows_result::Result<IsolatedWindowsEnvironmentStartProcessStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn Process(&self) -> windows_result::Result<IsolatedWindowsEnvironmentProcess> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl IsolatedWindowsEnvironmentTelemetryParameters {
    ...
    pub fn CorrelationId(&self) -> windows_result::Result<windows_core::GUID> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCorrelationId(&self, value: windows_core::GUID) -> windows_result::Result<()> {
        let this = self;
...
impl IsolatedWindowsEnvironmentUserInfo {
    pub fn EnvironmentUserSid(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EnvironmentUserName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryWaitForSignInAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryWaitForSignInWithProgressAsync(&self) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<bool, IsolatedWindowsEnvironmentSignInProgress>> {
...
impl IsolatedWindowsHostMessenger {
    pub fn PostMessageToReceiver<P1>(receiverid: windows_core::GUID, message: P1) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_collections::IVectorView<windows_core::IInspectable>>,
    {
    ...
    pub fn GetFileId(filepath: &windows_core::HSTRING) -> windows_result::Result<windows_core::GUID> {
    ...
    pub fn RegisterHostMessageReceiver<P1>(receiverid: windows_core::GUID, hostmessagereceivedcallback: P1) -> windows_result::Result<()>
    where
    ...
    pub fn UnregisterHostMessageReceiver(receiverid: windows_core::GUID) -> windows_result::Result<()> {
    ...
    fn IIsolatedWindowsHostMessengerStatics<R, F: FnOnce(&IIsolatedWindowsHostMessengerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IIsolatedWindowsHostMessengerStatics2<R, F: FnOnce(&IIsolatedWindowsHostMessengerStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
#[repr(C)]
struct MessageReceivedCallbackBox<F: Fn(&windows_core::GUID, windows_core::Ref<windows_collections::IVectorView<windows_core::IInspectable>>) -> windows_result::Result<()> + Send + 'static> {
    vtable: *const MessageReceivedCallback_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: Fn(&windows_core::GUID, windows_core::Ref<windows_collections::IVectorView<windows_core::IInspectable>>) -> windows_result::Result<()> + Send + 'static> MessageReceivedCallbackBox<F> {
