...
impl BufferProtectUnprotectResult {
    ...
    pub fn Buffer(&self) -> windows_result::Result<super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
    ...
    pub fn ProtectionInfo(&self) -> windows_result::Result<DataProtectionInfo> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DataProtectionInfo {
    pub fn Status(&self) -> windows_result::Result<DataProtectionStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Identity(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DataProtectionManager {
    #[cfg(feature = "Storage_Streams")]
    pub fn ProtectAsync<P0>(data: P0, identity: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<BufferProtectUnprotectResult>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn UnprotectAsync<P0>(data: P0) -> windows_result::Result<windows_future::IAsyncOperation<BufferProtectUnprotectResult>>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::IDataProtectionManagerStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ProtectStreamAsync<P0, P2>(unprotectedstream: P0, identity: &windows_core::HSTRING, protectedstream: P2) -> windows_result::Result<windows_future::IAsyncOperation<DataProtectionInfo>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn UnprotectStreamAsync<P0, P1>(protectedstream: P0, unprotectedstream: P1) -> windows_result::Result<windows_future::IAsyncOperation<DataProtectionInfo>>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IInputStream>,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetProtectionInfoAsync<P0>(protecteddata: P0) -> windows_result::Result<windows_future::IAsyncOperation<DataProtectionInfo>>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::IDataProtectionManagerStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetStreamProtectionInfoAsync<P0>(protectedstream: P0) -> windows_result::Result<windows_future::IAsyncOperation<DataProtectionInfo>>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IInputStream>,
    {
        Self::IDataProtectionManagerStatics(|this| unsafe {
    ...
    fn IDataProtectionManagerStatics<R, F: FnOnce(&IDataProtectionManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl FileProtectionInfo {
    pub fn Status(&self) -> windows_result::Result<FileProtectionStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn IsProtectWhileOpenSupported(&self) -> windows_result::Result<bool> {
...
impl FileProtectionManager {
    #[cfg(feature = "Storage")]
    pub fn ProtectAsync<P0>(target: P0, identity: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<FileProtectionInfo>>
    where
    ...
    #[cfg(feature = "Storage")]
    pub fn CopyProtectionAsync<P0, P1>(source: P0, target: P1) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageItem>,
    ...
    #[cfg(feature = "Storage")]
    pub fn GetProtectionInfoAsync<P0>(source: P0) -> windows_result::Result<windows_future::IAsyncOperation<FileProtectionInfo>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageItem>,
    {
        Self::IFileProtectionManagerStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SaveFileAsContainerAsync<P0>(protectedfile: P0) -> windows_result::Result<windows_future::IAsyncOperation<ProtectedContainerExportResult>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadFileFromContainerAsync<P0>(containerfile: P0) -> windows_result::Result<windows_future::IAsyncOperation<ProtectedContainerImportResult>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageFile>,
    {
        Self::IFileProtectionManagerStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadFileFromContainerWithTargetAsync<P0, P1>(containerfile: P0, target: P1) -> windows_result::Result<windows_future::IAsyncOperation<ProtectedContainerImportResult>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageFile>,
        P1: windows_core::Param<super::super::Storage::IStorageItem>,
    {
    ...
    #[cfg(feature = "Storage")]
    pub fn CreateProtectedAndOpenAsync<P0>(parentfolder: P0, desiredname: &windows_core::HSTRING, identity: &windows_core::HSTRING, collisionoption: super::super::Storage::CreationCollisionOption) -> windows_result::Result<windows_future::IAsyncOperation<ProtectedFileCreateResult>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn IsContainerAsync<P0>(file: P0) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageFile>,
    {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadFileFromContainerWithTargetAndNameCollisionOptionAsync<P0, P1>(containerfile: P0, target: P1, collisionoption: super::super::Storage::NameCollisionOption) -> windows_result::Result<windows_future::IAsyncOperation<ProtectedContainerImportResult>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageFile>,
        P1: windows_core::Param<super::super::Storage::IStorageItem>,
    {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SaveFileAsContainerWithSharingAsync<P0, P1>(protectedfile: P0, sharedwithidentities: P1) -> windows_result::Result<windows_future::IAsyncOperation<ProtectedContainerExportResult>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageFile>,
    ...
    #[cfg(feature = "Storage")]
    pub fn UnprotectAsync<P0>(target: P0) -> windows_result::Result<windows_future::IAsyncOperation<FileProtectionInfo>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageItem>,
    {
    ...
    #[cfg(feature = "Storage")]
    pub fn UnprotectWithOptionsAsync<P0, P1>(target: P0, options: P1) -> windows_result::Result<windows_future::IAsyncOperation<FileProtectionInfo>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageItem>,
    ...
    fn IFileProtectionManagerStatics<R, F: FnOnce(&IFileProtectionManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IFileProtectionManagerStatics2<R, F: FnOnce(&IFileProtectionManagerStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IFileProtectionManagerStatics3<R, F: FnOnce(&IFileProtectionManagerStatics3) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl FileRevocationManager {
    #[cfg(feature = "Storage")]
    pub fn ProtectAsync<P0>(storageitem: P0, enterpriseidentity: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<FileProtectionStatus>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageItem>,
    {
    ...
    #[cfg(feature = "Storage")]
    pub fn CopyProtectionAsync<P0, P1>(sourcestorageitem: P0, targetstorageitem: P1) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageItem>,
        P1: windows_core::Param<super::super::Storage::IStorageItem>,
    {
    ...
    pub fn Revoke(enterpriseidentity: &windows_core::HSTRING) -> windows_result::Result<()> {
    ...
    #[cfg(feature = "Storage")]
    pub fn GetStatusAsync<P0>(storageitem: P0) -> windows_result::Result<windows_future::IAsyncOperation<FileProtectionStatus>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageItem>,
    {
        Self::IFileRevocationManagerStatics(|this| unsafe {
    ...
    fn IFileRevocationManagerStatics<R, F: FnOnce(&IFileRevocationManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl FileUnprotectOptions {
    pub fn SetAudit(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAudit)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Audit(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Create(audit: bool) -> windows_result::Result<FileUnprotectOptions> {
    ...
    fn IFileUnprotectOptionsFactory<R, F: FnOnce(&IFileUnprotectOptionsFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl ProtectedAccessResumedEventArgs {
    pub fn Identities(&self) -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ProtectedContainerExportResult {
    pub fn Status(&self) -> windows_result::Result<ProtectedImportExportStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl ProtectedFileCreateResult {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Stream(&self) -> windows_result::Result<super::super::Storage::Streams::IRandomAccessStream> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ProtectionInfo(&self) -> windows_result::Result<FileProtectionInfo> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ProtectionInfo)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl ProtectionPolicyAuditInfo {
    pub fn SetAction(&self, value: ProtectionPolicyAuditAction) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAction)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Action(&self) -> windows_result::Result<ProtectionPolicyAuditAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDataDescription(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn DataDescription(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSourceDescription(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SourceDescription(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTargetDescription(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn TargetDescription(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Create(action: ProtectionPolicyAuditAction, datadescription: &windows_core::HSTRING, sourcedescription: &windows_core::HSTRING, targetdescription: &windows_core::HSTRING) -> windows_result::Result<ProtectionPolicyAuditInfo> {
    ...
    pub fn CreateWithActionAndDataDescription(action: ProtectionPolicyAuditAction, datadescription: &windows_core::HSTRING) -> windows_result::Result<ProtectionPolicyAuditInfo> {
        Self::IProtectionPolicyAuditInfoFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IProtectionPolicyAuditInfoFactory<R, F: FnOnce(&IProtectionPolicyAuditInfoFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl ProtectionPolicyManager {
    pub fn SetIdentity(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetShowEnterpriseIndicator(&self, value: bool) -> windows_result::Result<()> {
    ...
    pub fn ShowEnterpriseIndicator(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IProtectionPolicyManager2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsIdentityManaged(identity: &windows_core::HSTRING) -> windows_result::Result<bool> {
    ...
    pub fn TryApplyProcessUIPolicy(identity: &windows_core::HSTRING) -> windows_result::Result<bool> {
        Self::IProtectionPolicyManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ClearProcessUIPolicy() -> windows_result::Result<()> {
    ...
    pub fn CreateCurrentThreadNetworkContext(identity: &windows_core::HSTRING) -> windows_result::Result<ThreadNetworkContext> {
        Self::IProtectionPolicyManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Networking")]
    pub fn GetPrimaryManagedIdentityForNetworkEndpointAsync<P0>(endpointhost: P0) -> windows_result::Result<windows_future::IAsyncOperation<windows_core::HSTRING>>
    where
    ...
    pub fn RevokeContent(identity: &windows_core::HSTRING) -> windows_result::Result<()> {
    ...
    pub fn GetForCurrentView() -> windows_result::Result<ProtectionPolicyManager> {
        Self::IProtectionPolicyManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForCurrentView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn ProtectedAccessSuspending<P0>(handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveProtectedAccessSuspending(token: i64) -> windows_result::Result<()> {
    ...
    pub fn ProtectedAccessResumed<P0>(handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveProtectedAccessResumed(token: i64) -> windows_result::Result<()> {
    ...
    pub fn ProtectedContentRevoked<P0>(handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveProtectedContentRevoked(token: i64) -> windows_result::Result<()> {
    ...
    pub fn CheckAccess(sourceidentity: &windows_core::HSTRING, targetidentity: &windows_core::HSTRING) -> windows_result::Result<ProtectionPolicyEvaluationResult> {
        Self::IProtectionPolicyManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestAccessAsync(sourceidentity: &windows_core::HSTRING, targetidentity: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<ProtectionPolicyEvaluationResult>> {
        Self::IProtectionPolicyManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HasContentBeenRevokedSince(identity: &windows_core::HSTRING, since: super::super::Foundation::DateTime) -> windows_result::Result<bool> {
    ...
    pub fn CheckAccessForApp(sourceidentity: &windows_core::HSTRING, apppackagefamilyname: &windows_core::HSTRING) -> windows_result::Result<ProtectionPolicyEvaluationResult> {
        Self::IProtectionPolicyManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestAccessForAppAsync(sourceidentity: &windows_core::HSTRING, apppackagefamilyname: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<ProtectionPolicyEvaluationResult>> {
        Self::IProtectionPolicyManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetEnforcementLevel(identity: &windows_core::HSTRING) -> windows_result::Result<EnforcementLevel> {
        Self::IProtectionPolicyManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsUserDecryptionAllowed(identity: &windows_core::HSTRING) -> windows_result::Result<bool> {
        Self::IProtectionPolicyManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsProtectionUnderLockRequired(identity: &windows_core::HSTRING) -> windows_result::Result<bool> {
        Self::IProtectionPolicyManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PolicyChanged<P0>(handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemovePolicyChanged(token: i64) -> windows_result::Result<()> {
    ...
    pub fn IsProtectionEnabled() -> windows_result::Result<bool> {
        Self::IProtectionPolicyManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsProtectionEnabled)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn RequestAccessWithAuditingInfoAsync<P2>(sourceidentity: &windows_core::HSTRING, targetidentity: &windows_core::HSTRING, auditinfo: P2) -> windows_result::Result<windows_future::IAsyncOperation<ProtectionPolicyEvaluationResult>>
    where
    ...
    pub fn RequestAccessWithMessageAsync<P2>(sourceidentity: &windows_core::HSTRING, targetidentity: &windows_core::HSTRING, auditinfo: P2, messagefromapp: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<ProtectionPolicyEvaluationResult>>
    where
        P2: windows_core::Param<ProtectionPolicyAuditInfo>,
    {
        Self::IProtectionPolicyManagerStatics3(|this| unsafe {
    ...
    pub fn RequestAccessForAppWithAuditingInfoAsync<P2>(sourceidentity: &windows_core::HSTRING, apppackagefamilyname: &windows_core::HSTRING, auditinfo: P2) -> windows_result::Result<windows_future::IAsyncOperation<ProtectionPolicyEvaluationResult>>
    where
        P2: windows_core::Param<ProtectionPolicyAuditInfo>,
    {
        Self::IProtectionPolicyManagerStatics3(|this| unsafe {
    ...
    pub fn RequestAccessForAppWithMessageAsync<P2>(sourceidentity: &windows_core::HSTRING, apppackagefamilyname: &windows_core::HSTRING, auditinfo: P2, messagefromapp: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<ProtectionPolicyEvaluationResult>>
    where
        P2: windows_core::Param<ProtectionPolicyAuditInfo>,
    {
        Self::IProtectionPolicyManagerStatics3(|this| unsafe {
    ...
    pub fn LogAuditEvent<P2>(sourceidentity: &windows_core::HSTRING, targetidentity: &windows_core::HSTRING, auditinfo: P2) -> windows_result::Result<()>
    where
        P2: windows_core::Param<ProtectionPolicyAuditInfo>,
    {
    ...
    pub fn IsRoamableProtectionEnabled(identity: &windows_core::HSTRING) -> windows_result::Result<bool> {
    ...
    pub fn RequestAccessWithBehaviorAsync<P2>(sourceidentity: &windows_core::HSTRING, targetidentity: &windows_core::HSTRING, auditinfo: P2, messagefromapp: &windows_core::HSTRING, behavior: ProtectionPolicyRequestAccessBehavior) -> windows_result::Result<windows_future::IAsyncOperation<ProtectionPolicyEvaluationResult>>
    where
        P2: windows_core::Param<ProtectionPolicyAuditInfo>,
    {
        Self::IProtectionPolicyManagerStatics4(|this| unsafe {
    ...
    #[cfg(feature = "Storage")]
    pub fn RequestAccessToFilesForAppAsync<P0, P2>(sourceitemlist: P0, apppackagefamilyname: &windows_core::HSTRING, auditinfo: P2) -> windows_result::Result<windows_future::IAsyncOperation<ProtectionPolicyEvaluationResult>>
    where
    ...
    #[cfg(feature = "Storage")]
    pub fn RequestAccessToFilesForProcessAsync<P0, P2>(sourceitemlist: P0, processid: u32, auditinfo: P2) -> windows_result::Result<windows_future::IAsyncOperation<ProtectionPolicyEvaluationResult>>
    where
        P0: windows_core::Param<windows_collections::IIterable<super::super::Storage::IStorageItem>>,
        P2: windows_core::Param<ProtectionPolicyAuditInfo>,
    {
    ...
    #[cfg(feature = "Storage")]
    pub fn RequestAccessToFilesForProcessWithMessageAndBehaviorAsync<P0, P2>(sourceitemlist: P0, processid: u32, auditinfo: P2, messagefromapp: &windows_core::HSTRING, behavior: ProtectionPolicyRequestAccessBehavior) -> windows_result::Result<windows_future::IAsyncOperation<ProtectionPolicyEvaluationResult>>
    where
        P0: windows_core::Param<windows_collections::IIterable<super::super::Storage::IStorageItem>>,
        P2: windows_core::Param<ProtectionPolicyAuditInfo>,
    {
    ...
    #[cfg(feature = "Storage")]
    pub fn IsFileProtectionRequiredAsync<P0>(target: P0, identity: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageItem>,
    {
        Self::IProtectionPolicyManagerStatics4(|this| unsafe {
    ...
    #[cfg(feature = "Storage")]
    pub fn IsFileProtectionRequiredForNewFileAsync<P0>(parentfolder: P0, identity: &windows_core::HSTRING, desiredname: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageFolder>,
    {
        Self::IProtectionPolicyManagerStatics4(|this| unsafe {
    ...
    pub fn PrimaryManagedIdentity() -> windows_result::Result<windows_core::HSTRING> {
        Self::IProtectionPolicyManagerStatics4(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetPrimaryManagedIdentityForIdentity(identity: &windows_core::HSTRING) -> windows_result::Result<windows_core::HSTRING> {
        Self::IProtectionPolicyManagerStatics4(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IProtectionPolicyManagerStatics<R, F: FnOnce(&IProtectionPolicyManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IProtectionPolicyManagerStatics2<R, F: FnOnce(&IProtectionPolicyManagerStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IProtectionPolicyManagerStatics3<R, F: FnOnce(&IProtectionPolicyManagerStatics3) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IProtectionPolicyManagerStatics4<R, F: FnOnce(&IProtectionPolicyManagerStatics4) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
