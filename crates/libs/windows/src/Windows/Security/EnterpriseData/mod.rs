...
windows_core::imp::required_hierarchy!(BufferProtectUnprotectResult, IBufferProtectUnprotectResult);
...
windows_core::imp::required_hierarchy!(DataProtectionInfo, IDataProtectionInfo);
...
windows_core::imp::required_hierarchy!(FileProtectionInfo, IFileProtectionInfo, IFileProtectionInfo2);
...
windows_core::imp::required_hierarchy!(FileUnprotectOptions, IFileUnprotectOptions, IFileUnprotectOptionsFactory);
...
windows_core::imp::required_hierarchy!(ProtectedAccessResumedEventArgs, IProtectedAccessResumedEventArgs);
...
windows_core::imp::required_hierarchy!(ProtectedAccessSuspendingEventArgs, IProtectedAccessSuspendingEventArgs);
...
windows_core::imp::required_hierarchy!(ProtectedContainerExportResult, IProtectedContainerExportResult);
...
windows_core::imp::required_hierarchy!(ProtectedContainerImportResult, IProtectedContainerImportResult);
...
windows_core::imp::required_hierarchy!(ProtectedContentRevokedEventArgs, IProtectedContentRevokedEventArgs);
...
windows_core::imp::required_hierarchy!(ProtectedFileCreateResult, IProtectedFileCreateResult);
...
windows_core::imp::required_hierarchy!(ProtectionPolicyAuditInfo, IProtectionPolicyAuditInfo, IProtectionPolicyAuditInfoFactory);
...
windows_core::imp::required_hierarchy!(ProtectionPolicyManager, IProtectionPolicyManager, IProtectionPolicyManager2, IProtectionPolicyManagerStatics, IProtectionPolicyManagerStatics2, IProtectionPolicyManagerStatics3, IProtectionPolicyManagerStatics4);
...
windows_core::imp::required_hierarchy!(ThreadNetworkContext, super::super::Foundation::IClosable, IThreadNetworkContext);
