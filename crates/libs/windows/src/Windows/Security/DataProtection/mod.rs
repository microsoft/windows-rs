...
impl UserDataBufferUnprotectResult {
    pub fn Status(&self) -> Result<UserDataBufferUnprotectStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn UnprotectedBuffer(&self) -> Result<super::super::Storage::Streams::IBuffer, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UserDataProtectionManager {
    #[cfg(feature = "Storage")]
    pub fn ProtectStorageItemAsync<P0>(&self, storageitem: P0, availability: UserDataAvailability) -> Result<windows_future::IAsyncOperation<UserDataStorageItemProtectionStatus>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage")]
    pub fn GetStorageItemProtectionInfoAsync<P0>(&self, storageitem: P0) -> Result<windows_future::IAsyncOperation<UserDataStorageItemProtectionInfo>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Storage::IStorageItem>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ProtectBufferAsync<P0>(&self, unprotectedbuffer: P0, availability: UserDataAvailability) -> Result<windows_future::IAsyncOperation<super::super::Storage::Streams::IBuffer>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn UnprotectBufferAsync<P0>(&self, protectedbuffer: P0) -> Result<windows_future::IAsyncOperation<UserDataBufferUnprotectResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        let this = self;
    ...
    pub fn IsContinuedDataAvailabilityExpected(&self, availability: UserDataAvailability) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DataAvailabilityStateChanged<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveDataAvailabilityStateChanged(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveDataAvailabilityStateChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn TryGetDefault() -> Result<UserDataProtectionManager, windows_result::HRESULT> {
    ...
    #[cfg(feature = "System")]
    pub fn TryGetForUser<P0>(user: P0) -> Result<UserDataProtectionManager, windows_result::HRESULT>
    where
    ...
    fn IUserDataProtectionManagerStatics<R, F: FnOnce(&IUserDataProtectionManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl UserDataStorageItemProtectionInfo {
    pub fn Availability(&self) -> Result<UserDataAvailability, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
