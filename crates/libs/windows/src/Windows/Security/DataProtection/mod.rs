...
impl UserDataProtectionManager {
    #[cfg(feature = "Storage")]
    pub fn ProtectStorageItemAsync<P0>(&self, storageitem: P0, availability: UserDataAvailability) -> windows_core::Result<windows_async::IAsyncOperation<UserDataStorageItemProtectionStatus>>
    where
    ...
    #[cfg(feature = "Storage")]
    pub fn GetStorageItemProtectionInfoAsync<P0>(&self, storageitem: P0) -> windows_core::Result<windows_async::IAsyncOperation<UserDataStorageItemProtectionInfo>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageItem>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ProtectBufferAsync<P0>(&self, unprotectedbuffer: P0, availability: UserDataAvailability) -> windows_core::Result<windows_async::IAsyncOperation<super::super::Storage::Streams::IBuffer>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn UnprotectBufferAsync<P0>(&self, protectedbuffer: P0) -> windows_core::Result<windows_async::IAsyncOperation<UserDataBufferUnprotectResult>>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        let this = self;
