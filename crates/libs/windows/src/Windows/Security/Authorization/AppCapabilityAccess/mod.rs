...
impl AppCapability {
    pub fn CapabilityName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn RequestAccessAsync(&self) -> Result<windows_future::IAsyncOperation<AppCapabilityAccessStatus>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CheckAccess(&self) -> Result<AppCapabilityAccessStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RemoveAccessChanged(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn RequestAccessForCapabilitiesAsync<P0>(capabilitynames: P0) -> Result<windows_future::IAsyncOperation<windows_collections::IMapView<windows_core::HSTRING, AppCapabilityAccessStatus>>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "System")]
    pub fn RequestAccessForCapabilitiesForUserAsync<P0, P1>(user: P0, capabilitynames: P1) -> Result<windows_future::IAsyncOperation<windows_collections::IMapView<windows_core::HSTRING, AppCapabilityAccessStatus>>, windows_result::HRESULT>
    where
    ...
    pub fn Create(capabilityname: &windows_core::HSTRING) -> Result<AppCapability, windows_result::HRESULT> {
        Self::IAppCapabilityStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "System")]
    pub fn CreateWithProcessIdForUser<P0>(user: P0, capabilityname: &windows_core::HSTRING, pid: u32) -> Result<AppCapability, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::System::User>,
    {
        Self::IAppCapabilityStatics(|this| unsafe {
    ...
    fn IAppCapabilityStatics<R, F: FnOnce(&IAppCapabilityStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
