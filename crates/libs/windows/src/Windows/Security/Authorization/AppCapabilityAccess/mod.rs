...
windows_core::imp::required_hierarchy!(AppCapability, IAppCapability, IAppCapability2, IAppCapabilityStatics);
impl AppCapability {
...
windows_core::imp::required_hierarchy!(AppCapabilityAccessChangedEventArgs, IAppCapabilityAccessChangedEventArgs);
