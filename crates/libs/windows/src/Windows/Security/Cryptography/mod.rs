...
impl CryptographicBuffer {
    ...
    pub fn Compare<P0, P1>(object1: P0, object2: P1) -> windows_result::Result<bool>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GenerateRandom(length: u32) -> windows_result::Result<super::super::Storage::Streams::IBuffer> {
        Self::ICryptographicBufferStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GenerateRandomNumber() -> windows_result::Result<u32> {
        Self::ICryptographicBufferStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromByteArray(value: &[u8]) -> windows_result::Result<super::super::Storage::Streams::IBuffer> {
        Self::ICryptographicBufferStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CopyToByteArray<P0>(buffer: P0, value: &mut windows_core::Array<u8>) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn DecodeFromHexString(value: &windows_core::HSTRING) -> windows_result::Result<super::super::Storage::Streams::IBuffer> {
        Self::ICryptographicBufferStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn EncodeToHexString<P0>(buffer: P0) -> windows_result::Result<windows_core::HSTRING>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::ICryptographicBufferStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn DecodeFromBase64String(value: &windows_core::HSTRING) -> windows_result::Result<super::super::Storage::Streams::IBuffer> {
        Self::ICryptographicBufferStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn EncodeToBase64String<P0>(buffer: P0) -> windows_result::Result<windows_core::HSTRING>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::ICryptographicBufferStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ConvertStringToBinary(value: &windows_core::HSTRING, encoding: BinaryStringEncoding) -> windows_result::Result<super::super::Storage::Streams::IBuffer> {
        Self::ICryptographicBufferStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ConvertBinaryToString<P1>(encoding: BinaryStringEncoding, buffer: P1) -> windows_result::Result<windows_core::HSTRING>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::ICryptographicBufferStatics(|this| unsafe {
    ...
    fn ICryptographicBufferStatics<R, F: FnOnce(&ICryptographicBufferStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
