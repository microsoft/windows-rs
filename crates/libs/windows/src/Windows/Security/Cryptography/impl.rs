...
impl ICryptographicBufferStaticsVtbl {
    pub const fn new<Impl: ICryptographicBufferStaticsImpl, const OFFSET: usize>(base: &::windows::core::IInspectableVtbl) -> ICryptographicBufferStaticsVtbl {
        unsafe extern "system" fn Compare<Impl: ICryptographicBufferStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, object1: ::windows::core::RawPtr, object2: ::windows::core::RawPtr, result__: *mut bool) -> ::windows::core::HRESULT {
        ...
        unsafe extern "system" fn GenerateRandom<Impl: ICryptographicBufferStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, length: u32, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn GenerateRandomNumber<Impl: ICryptographicBufferStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, result__: *mut u32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn CreateFromByteArray<Impl: ICryptographicBufferStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, value_array_size: u32, value: *const u8, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn CopyToByteArray<Impl: ICryptographicBufferStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, buffer: ::windows::core::RawPtr, value_array_size: *mut u32, value: *mut *mut u8) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn DecodeFromHexString<Impl: ICryptographicBufferStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, value: ::core::mem::ManuallyDrop<::windows::core::HSTRING>, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn EncodeToHexString<Impl: ICryptographicBufferStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, buffer: ::windows::core::RawPtr, result__: *mut ::core::mem::ManuallyDrop<::windows::core::HSTRING>) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn DecodeFromBase64String<Impl: ICryptographicBufferStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, value: ::core::mem::ManuallyDrop<::windows::core::HSTRING>, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn EncodeToBase64String<Impl: ICryptographicBufferStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, buffer: ::windows::core::RawPtr, result__: *mut ::core::mem::ManuallyDrop<::windows::core::HSTRING>) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn ConvertStringToBinary<Impl: ICryptographicBufferStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, value: ::core::mem::ManuallyDrop<::windows::core::HSTRING>, encoding: BinaryStringEncoding, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
        ...
        unsafe extern "system" fn ConvertBinaryToString<Impl: ICryptographicBufferStaticsImpl, const OFFSET: usize>(this: *mut ::core::ffi::c_void, encoding: BinaryStringEncoding, buffer: ::windows::core::RawPtr, result__: *mut ::core::mem::ManuallyDrop<::windows::core::HSTRING>) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).add(OFFSET) as *mut Impl;
