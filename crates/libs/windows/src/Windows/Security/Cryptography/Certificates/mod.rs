...
impl Certificate {
    pub fn BuildChainAsync<P0>(&self, certificates: P0) -> Result<windows_future::IAsyncOperation<CertificateChain>, windows_result::HRESULT>
    where
    ...
    pub fn BuildChainWithParametersAsync<P0, P1>(&self, certificates: P0, parameters: P1) -> Result<windows_future::IAsyncOperation<CertificateChain>, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IIterable<Certificate>>,
    ...
    pub fn SerialNumber(&self) -> Result<windows_core::Array<u8>, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn GetHashValue(&self) -> Result<windows_core::Array<u8>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::MaybeUninit::zeroed();
    ...
    pub fn GetHashValueWithAlgorithm(&self, hashalgorithmname: &windows_core::HSTRING) -> Result<windows_core::Array<u8>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::MaybeUninit::zeroed();
    ...
    pub fn GetCertificateBlob(&self) -> Result<super::super::super::Storage::Streams::IBuffer, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Issuer(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HasPrivateKey(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsStronglyProtected(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ValidFrom(&self) -> Result<super::super::super::Foundation::DateTime, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ValidTo(&self) -> Result<super::super::super::Foundation::DateTime, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EnhancedKeyUsages(&self) -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsSecurityDeviceBound(&self) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn KeyUsages(&self) -> Result<CertificateKeyUsages, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificate2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn KeyAlgorithmName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificate2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SignatureAlgorithmName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificate2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SignatureHashAlgorithmName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificate2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SubjectAlternativeName(&self) -> Result<SubjectAlternativeNameInfo, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificate2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsPerUser(&self) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn StoreName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificate3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn KeyStorageProviderName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificate3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateCertificate<P0>(certblob: P0) -> Result<Certificate, windows_result::HRESULT>
    where
    ...
    fn ICertificateFactory<R, F: FnOnce(&ICertificateFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl CertificateChain {
    pub fn Validate(&self) -> Result<ChainValidationResult, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ValidateWithParameters<P0>(&self, parameter: P0) -> Result<ChainValidationResult, windows_result::HRESULT>
    where
    ...
    pub fn GetCertificates(&self, includeroot: bool) -> Result<windows_collections::IVectorView<Certificate>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl CertificateEnrollmentManager {
    pub fn CreateRequestAsync<P0>(request: P0) -> Result<windows_future::IAsyncOperation<windows_core::HSTRING>, windows_result::HRESULT>
    where
    ...
    pub fn InstallCertificateAsync(certificate: &windows_core::HSTRING, installoption: InstallOptions) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        Self::ICertificateEnrollmentManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ImportPfxDataAsync(pfxdata: &windows_core::HSTRING, password: &windows_core::HSTRING, exportable: ExportOption, keyprotectionlevel: KeyProtectionLevel, installoption: InstallOptions, friendlyname: &windows_core::HSTRING) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        Self::ICertificateEnrollmentManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UserCertificateEnrollmentManager() -> Result<UserCertificateEnrollmentManager, windows_result::HRESULT> {
    ...
    pub fn ImportPfxDataToKspAsync(pfxdata: &windows_core::HSTRING, password: &windows_core::HSTRING, exportable: ExportOption, keyprotectionlevel: KeyProtectionLevel, installoption: InstallOptions, friendlyname: &windows_core::HSTRING, keystorageprovider: &windows_core::HSTRING) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        Self::ICertificateEnrollmentManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ImportPfxDataToKspWithParametersAsync<P2>(pfxdata: &windows_core::HSTRING, password: &windows_core::HSTRING, pfximportparameters: P2) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
    ...
    fn ICertificateEnrollmentManagerStatics<R, F: FnOnce(&ICertificateEnrollmentManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn ICertificateEnrollmentManagerStatics2<R, F: FnOnce(&ICertificateEnrollmentManagerStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn ICertificateEnrollmentManagerStatics3<R, F: FnOnce(&ICertificateEnrollmentManagerStatics3) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl CertificateExtension {
    ...
    pub fn ObjectId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetObjectId(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn IsCritical(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsCritical(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsCritical)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn EncodeValue(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Value(&self) -> Result<windows_core::Array<u8>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::MaybeUninit::zeroed();
    ...
    pub fn SetValue(&self, value: &[u8]) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl CertificateKeyUsages {
    ...
    pub fn EncipherOnly(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetEncipherOnly(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetEncipherOnly)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CrlSign(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCrlSign(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCrlSign)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn KeyCertificateSign(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetKeyCertificateSign(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetKeyCertificateSign)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn KeyAgreement(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetKeyAgreement(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetKeyAgreement)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DataEncipherment(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDataEncipherment(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDataEncipherment)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn KeyEncipherment(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetKeyEncipherment(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetKeyEncipherment)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn NonRepudiation(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetNonRepudiation(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetNonRepudiation)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DigitalSignature(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDigitalSignature(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl CertificateQuery {
    ...
    pub fn EnhancedKeyUsages(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).EnhancedKeyUsages)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn IssuerName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIssuerName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Thumbprint(&self) -> Result<windows_core::Array<u8>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::MaybeUninit::zeroed();
    ...
    pub fn SetThumbprint(&self, value: &[u8]) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn HardwareOnly(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetHardwareOnly(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetHardwareOnly)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IncludeDuplicates(&self) -> Result<bool, windows_result::HRESULT> {
    ...
    pub fn SetIncludeDuplicates(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificateQuery2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetIncludeDuplicates)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IncludeExpiredCertificates(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificateQuery2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIncludeExpiredCertificates(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificateQuery2>(self)?;
    ...
    pub fn SetStoreName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificateQuery2>(self)?;
...
impl CertificateRequestProperties {
    ...
    pub fn SetKeyAlgorithmName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn SetKeySize(&self, value: u32) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn HashAlgorithmName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetHashAlgorithmName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Exportable(&self) -> Result<ExportOption, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetExportable(&self, value: ExportOption) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetExportable)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn KeyUsages(&self) -> Result<EnrollKeyUsages, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetKeyUsages(&self, value: EnrollKeyUsages) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetKeyUsages)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn KeyProtectionLevel(&self) -> Result<KeyProtectionLevel, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetKeyProtectionLevel(&self, value: KeyProtectionLevel) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn SetKeyStorageProviderName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn SmartcardReaderName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn SetSmartcardReaderName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificateRequestProperties2>(self)?;
    ...
    pub fn SigningCertificate(&self) -> Result<Certificate, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificateRequestProperties2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSigningCertificate<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn AttestationCredentialCertificate(&self) -> Result<Certificate, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificateRequestProperties2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAttestationCredentialCertificate<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<Certificate>,
    {
        let this = &windows_core::Interface::cast::<ICertificateRequestProperties2>(self)?;
    ...
    pub fn CurveName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn SetCurveName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificateRequestProperties3>(self)?;
    ...
    pub fn CurveParameters(&self) -> Result<windows_core::Array<u8>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificateRequestProperties3>(self)?;
        unsafe {
            let mut result__ = core::mem::MaybeUninit::zeroed();
    ...
    pub fn SetCurveParameters(&self, value: &[u8]) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificateRequestProperties3>(self)?;
    ...
    pub fn ContainerNamePrefix(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificateRequestProperties3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetContainerNamePrefix(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificateRequestProperties3>(self)?;
    ...
    pub fn ContainerName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificateRequestProperties3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetContainerName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificateRequestProperties3>(self)?;
    ...
    pub fn UseExistingKey(&self) -> Result<bool, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificateRequestProperties3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetUseExistingKey(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificateRequestProperties3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetUseExistingKey)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn SuppressedDefaults(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
    ...
    pub fn Extensions(&self) -> Result<windows_collections::IVector<CertificateExtension>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ICertificateRequestProperties4>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl CertificateStore {
    pub fn Add<P0>(&self, certificate: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<Certificate>,
    {
        let this = self;
    ...
    pub fn Delete<P0>(&self, certificate: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<Certificate>,
    {
        let this = self;
...
impl CertificateStores {
    pub fn FindAllAsync() -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<Certificate>>, windows_result::HRESULT> {
    ...
    pub fn FindAllWithQueryAsync<P0>(query: P0) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<Certificate>>, windows_result::HRESULT>
    where
    ...
    pub fn TrustedRootCertificationAuthorities() -> Result<CertificateStore, windows_result::HRESULT> {
        Self::ICertificateStoresStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IntermediateCertificationAuthorities() -> Result<CertificateStore, windows_result::HRESULT> {
        Self::ICertificateStoresStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetStoreByName(storename: &windows_core::HSTRING) -> Result<CertificateStore, windows_result::HRESULT> {
        Self::ICertificateStoresStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetUserStoreByName(storename: &windows_core::HSTRING) -> Result<UserCertificateStore, windows_result::HRESULT> {
    ...
    fn ICertificateStoresStatics<R, F: FnOnce(&ICertificateStoresStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn ICertificateStoresStatics2<R, F: FnOnce(&ICertificateStoresStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl ChainBuildingParameters {
    ...
    pub fn ValidationTimestamp(&self) -> Result<super::super::super::Foundation::DateTime, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetValidationTimestamp(&self, value: super::super::super::Foundation::DateTime) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetValidationTimestamp)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn RevocationCheckEnabled(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRevocationCheckEnabled(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetRevocationCheckEnabled)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn NetworkRetrievalEnabled(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetNetworkRetrievalEnabled(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetNetworkRetrievalEnabled)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AuthorityInformationAccessEnabled(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAuthorityInformationAccessEnabled(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn CurrentTimeValidationEnabled(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCurrentTimeValidationEnabled(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCurrentTimeValidationEnabled)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ExclusiveTrustRoots(&self) -> Result<windows_collections::IVector<Certificate>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ChainValidationParameters {
    ...
    pub fn CertificateChainPolicy(&self) -> Result<CertificateChainPolicy, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCertificateChainPolicy(&self, value: CertificateChainPolicy) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCertificateChainPolicy)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "Networking")]
    pub fn ServerDnsName(&self) -> Result<super::super::super::Networking::HostName, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Networking")]
    pub fn SetServerDnsName<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
...
impl CmsAttachedSignature {
    pub fn Certificates(&self) -> Result<windows_collections::IVectorView<Certificate>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Content(&self) -> Result<windows_core::Array<u8>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::MaybeUninit::zeroed();
    ...
    pub fn Signers(&self) -> Result<windows_collections::IVectorView<CmsSignerInfo>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn VerifySignature(&self) -> Result<SignatureValidationResult, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateCmsAttachedSignature<P0>(inputblob: P0) -> Result<CmsAttachedSignature, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Storage::Streams::IBuffer>,
    {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GenerateSignatureAsync<P0, P1, P2>(data: P0, signers: P1, certificates: P2) -> Result<windows_future::IAsyncOperation<super::super::super::Storage::Streams::IBuffer>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Storage::Streams::IBuffer>,
    ...
    fn ICmsAttachedSignatureFactory<R, F: FnOnce(&ICmsAttachedSignatureFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn ICmsAttachedSignatureStatics<R, F: FnOnce(&ICmsAttachedSignatureStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl CmsDetachedSignature {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn VerifySignatureAsync<P0>(&self, data: P0) -> Result<windows_future::IAsyncOperation<SignatureValidationResult>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateCmsDetachedSignature<P0>(inputblob: P0) -> Result<CmsDetachedSignature, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Storage::Streams::IBuffer>,
    {
    ...
    fn ICmsDetachedSignatureFactory<R, F: FnOnce(&ICmsDetachedSignatureFactory) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn ICmsDetachedSignatureStatics<R, F: FnOnce(&ICmsDetachedSignatureStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl CmsSignerInfo {
    ...
    pub fn Certificate(&self) -> Result<Certificate, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCertificate<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<Certificate>,
    {
        let this = self;
    ...
    pub fn TimestampInfo(&self) -> Result<CmsTimestampInfo, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl KeyAlgorithmNames {
    pub fn Rsa() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn Dsa() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKeyAlgorithmNamesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Dsa)(windows_core::Interface::as_raw(this), &mut result__).map(|| core::mem::transmute(result__))
        })
    }
    pub fn Ecdh256() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKeyAlgorithmNamesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Ecdh384() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKeyAlgorithmNamesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Ecdh521() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKeyAlgorithmNamesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Ecdsa256() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKeyAlgorithmNamesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Ecdsa384() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKeyAlgorithmNamesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Ecdsa521() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKeyAlgorithmNamesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Ecdsa() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn Ecdh() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKeyAlgorithmNamesStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Ecdh)(windows_core::Interface::as_raw(this), &mut result__).map(|| core::mem::transmute(result__))
        })
    }
    fn IKeyAlgorithmNamesStatics<R, F: FnOnce(&IKeyAlgorithmNamesStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IKeyAlgorithmNamesStatics2<R, F: FnOnce(&IKeyAlgorithmNamesStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl KeyAttestationHelper {
    pub fn DecryptTpmAttestationCredentialAsync(credential: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<windows_core::HSTRING>, windows_result::HRESULT> {
    ...
    pub fn GetTpmAttestationCredentialId(credential: &windows_core::HSTRING) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKeyAttestationHelperStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DecryptTpmAttestationCredentialWithContainerNameAsync(credential: &windows_core::HSTRING, containername: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<windows_core::HSTRING>, windows_result::HRESULT> {
    ...
    fn IKeyAttestationHelperStatics<R, F: FnOnce(&IKeyAttestationHelperStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IKeyAttestationHelperStatics2<R, F: FnOnce(&IKeyAttestationHelperStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl KeyStorageProviderNames {
    pub fn SoftwareKeyStorageProvider() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn SmartcardKeyStorageProvider() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKeyStorageProviderNamesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PlatformKeyStorageProvider() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IKeyStorageProviderNamesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PassportKeyStorageProvider() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    fn IKeyStorageProviderNamesStatics<R, F: FnOnce(&IKeyStorageProviderNamesStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
    ...
    fn IKeyStorageProviderNamesStatics2<R, F: FnOnce(&IKeyStorageProviderNamesStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl PfxImportParameters {
    ...
    pub fn InstallOptions(&self) -> Result<InstallOptions, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetInstallOptions(&self, value: InstallOptions) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn ReaderName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetReaderName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl StandardCertificateStoreNames {
    pub fn Personal() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    pub fn TrustedRootCertificationAuthorities() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IStandardCertificateStoreNamesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IntermediateCertificationAuthorities() -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        Self::IStandardCertificateStoreNamesStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IStandardCertificateStoreNamesStatics<R, F: FnOnce(&IStandardCertificateStoreNamesStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl SubjectAlternativeNameInfo {
    ...
    pub fn EmailName(&self) -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IPAddress(&self) -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Url(&self) -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DnsName(&self) -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DistinguishedName(&self) -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PrincipalName(&self) -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EmailNames(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
    ...
    pub fn IPAddresses(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ISubjectAlternativeNameInfo2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Urls(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ISubjectAlternativeNameInfo2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DnsNames(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ISubjectAlternativeNameInfo2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DistinguishedNames(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ISubjectAlternativeNameInfo2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PrincipalNames(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ISubjectAlternativeNameInfo2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Extension(&self) -> Result<CertificateExtension, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ISubjectAlternativeNameInfo2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UserCertificateEnrollmentManager {
    pub fn CreateRequestAsync<P0>(&self, request: P0) -> Result<windows_future::IAsyncOperation<windows_core::HSTRING>, windows_result::HRESULT>
    where
        P0: windows_core::Param<CertificateRequestProperties>,
    {
        let this = self;
    ...
    pub fn InstallCertificateAsync(&self, certificate: &windows_core::HSTRING, installoption: InstallOptions) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).InstallCertificateAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(certificate), installoption, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ImportPfxDataAsync(&self, pfxdata: &windows_core::HSTRING, password: &windows_core::HSTRING, exportable: ExportOption, keyprotectionlevel: KeyProtectionLevel, installoption: InstallOptions, friendlyname: &windows_core::HSTRING) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ImportPfxDataAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(pfxdata), core::mem::transmute_copy(password), exportable, keyprotectionlevel, installoption, core::mem::transmute_copy(friendlyname), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ImportPfxDataToKspAsync(&self, pfxdata: &windows_core::HSTRING, password: &windows_core::HSTRING, exportable: ExportOption, keyprotectionlevel: KeyProtectionLevel, installoption: InstallOptions, friendlyname: &windows_core::HSTRING, keystorageprovider: &windows_core::HSTRING) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).ImportPfxDataToKspAsync)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(pfxdata), core::mem::transmute_copy(password), exportable, keyprotectionlevel, installoption, core::mem::transmute_copy(friendlyname), core::mem::transmute_copy(keystorageprovider), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn ImportPfxDataToKspWithParametersAsync<P2>(&self, pfxdata: &windows_core::HSTRING, password: &windows_core::HSTRING, pfximportparameters: P2) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P2: windows_core::Param<PfxImportParameters>,
    {
...
impl UserCertificateStore {
    pub fn RequestAddAsync<P0>(&self, certificate: P0) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<Certificate>,
    {
        let this = self;
    ...
    pub fn RequestDeleteAsync<P0>(&self, certificate: P0) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<Certificate>,
    {
        let this = self;
