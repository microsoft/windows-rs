...
impl DataProtectionProvider {
    ...
    pub fn ProtectAsync<P0>(&self, data: P0) -> windows_core::Result<windows_async::IAsyncOperation<super::super::super::Storage::Streams::IBuffer>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn UnprotectAsync<P0>(&self, data: P0) -> windows_core::Result<windows_async::IAsyncOperation<super::super::super::Storage::Streams::IBuffer>>
    where
        P0: windows_core::Param<super::super::super::Storage::Streams::IBuffer>,
    {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ProtectStreamAsync<P0, P1>(&self, src: P0, dest: P1) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn UnprotectStreamAsync<P0, P1>(&self, src: P0, dest: P1) -> windows_core::Result<windows_async::IAsyncAction>
    where
        P0: windows_core::Param<super::super::super::Storage::Streams::IInputStream>,
        P1: windows_core::Param<super::super::super::Storage::Streams::IOutputStream>,
    {
