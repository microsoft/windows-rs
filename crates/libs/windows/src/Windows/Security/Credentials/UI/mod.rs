...
impl CredentialPicker {
    pub fn PickWithOptionsAsync<P0>(options: P0) -> Result<windows_future::IAsyncOperation<CredentialPickerResults>, windows_result::HRESULT>
    where
    ...
    pub fn PickWithMessageAsync(targetname: &windows_core::HSTRING, message: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<CredentialPickerResults>, windows_result::HRESULT> {
        Self::ICredentialPickerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PickWithCaptionAsync(targetname: &windows_core::HSTRING, message: &windows_core::HSTRING, caption: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<CredentialPickerResults>, windows_result::HRESULT> {
        Self::ICredentialPickerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn ICredentialPickerStatics<R, F: FnOnce(&ICredentialPickerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl CredentialPickerOptions {
    ...
    pub fn SetMessage(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn SetTargetName(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn TargetName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAuthenticationProtocol(&self, value: AuthenticationProtocol) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAuthenticationProtocol)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AuthenticationProtocol(&self) -> Result<AuthenticationProtocol, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCustomAuthenticationProtocol(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn CustomAuthenticationProtocol(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPreviousCredential<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn PreviousCredential(&self) -> Result<super::super::super::Storage::Streams::IBuffer, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAlwaysDisplayDialog(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAlwaysDisplayDialog)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AlwaysDisplayDialog(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCallerSavesCredential(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCallerSavesCredential)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CallerSavesCredential(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCredentialSaveOption(&self, value: CredentialSaveOption) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetCredentialSaveOption)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CredentialSaveOption(&self) -> Result<CredentialSaveOption, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl CredentialPickerResults {
    ...
    pub fn CredentialSaved(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Credential(&self) -> Result<super::super::super::Storage::Streams::IBuffer, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CredentialDomainName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CredentialUserName(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CredentialPassword(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UserConsentVerifier {
    pub fn CheckAvailabilityAsync() -> Result<windows_future::IAsyncOperation<UserConsentVerifierAvailability>, windows_result::HRESULT> {
    ...
    pub fn RequestVerificationAsync(message: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<UserConsentVerificationResult>, windows_result::HRESULT> {
        Self::IUserConsentVerifierStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IUserConsentVerifierStatics<R, F: FnOnce(&IUserConsentVerifierStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
