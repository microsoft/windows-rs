...
impl CredentialPicker {
    pub fn PickWithOptionsAsync<P0>(options: P0) -> windows_core::Result<windows_async::IAsyncOperation<CredentialPickerResults>>
    where
    ...
    pub fn PickWithMessageAsync(targetname: &windows_core::HSTRING, message: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<CredentialPickerResults>> {
        Self::ICredentialPickerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PickWithCaptionAsync(targetname: &windows_core::HSTRING, message: &windows_core::HSTRING, caption: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<CredentialPickerResults>> {
        Self::ICredentialPickerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UserConsentVerifier {
    pub fn CheckAvailabilityAsync() -> windows_core::Result<windows_async::IAsyncOperation<UserConsentVerifierAvailability>> {
    ...
    pub fn RequestVerificationAsync(message: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<UserConsentVerificationResult>> {
        Self::IUserConsentVerifierStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
