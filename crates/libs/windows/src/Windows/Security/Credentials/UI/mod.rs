...
windows_core::imp::required_hierarchy!(CredentialPickerOptions, ICredentialPickerOptions);
...
windows_core::imp::required_hierarchy!(CredentialPickerResults, ICredentialPickerResults);
