...
impl IWebAccount {
    pub fn WebAccountProvider(&self) -> windows_result::Result<WebAccountProvider> {
        let this = self;
        unsafe {
    ...
    pub fn State(&self) -> windows_result::Result<WebAccountState> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IWebAccount_Impl: windows_core::IUnknownImpl {
    fn WebAccountProvider(&self) -> windows_result::Result<WebAccountProvider>;
    fn UserName(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn State(&self) -> windows_result::Result<WebAccountState>;
}
...
impl KeyCredential {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn RetrievePublicKeyWithDefaultBlobType(&self) -> windows_result::Result<super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(all(feature = "Security_Cryptography_Core", feature = "Storage_Streams"))]
    pub fn RetrievePublicKeyWithBlobType(&self, blobtype: super::Cryptography::Core::CryptographicPublicKeyBlobType) -> windows_result::Result<super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn RequestSignAsync<P0>(&self, data: P0) -> windows_result::Result<windows_future::IAsyncOperation<KeyCredentialOperationResult>>
    where
    ...
    pub fn GetAttestationAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<KeyCredentialAttestationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl KeyCredentialAttestationResult {
    #[cfg(feature = "Storage_Streams")]
    pub fn CertificateChainBuffer(&self) -> windows_result::Result<super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn AttestationBuffer(&self) -> windows_result::Result<super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Status(&self) -> windows_result::Result<KeyCredentialAttestationStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl KeyCredentialManager {
    pub fn IsSupportedAsync() -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
    ...
    pub fn RenewAttestationAsync() -> windows_result::Result<windows_future::IAsyncAction> {
        Self::IKeyCredentialManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestCreateAsync(name: &windows_core::HSTRING, option: KeyCredentialCreationOption) -> windows_result::Result<windows_future::IAsyncOperation<KeyCredentialRetrievalResult>> {
        Self::IKeyCredentialManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OpenAsync(name: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<KeyCredentialRetrievalResult>> {
        Self::IKeyCredentialManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeleteAsync(name: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction> {
        Self::IKeyCredentialManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IKeyCredentialManagerStatics<R, F: FnOnce(&IKeyCredentialManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl KeyCredentialOperationResult {
    #[cfg(feature = "Storage_Streams")]
    pub fn Result(&self) -> windows_result::Result<super::super::Storage::Streams::IBuffer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Status(&self) -> windows_result::Result<KeyCredentialStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Status)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
...
impl KeyCredentialRetrievalResult {
    pub fn Credential(&self) -> windows_result::Result<KeyCredential> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl PasswordCredential {
    ...
    pub fn CreatePasswordCredential(resource: &windows_core::HSTRING, username: &windows_core::HSTRING, password: &windows_core::HSTRING) -> windows_result::Result<PasswordCredential> {
    ...
    pub fn Resource(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetResource(&self, resource: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetUserName(&self, username: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetPassword(&self, password: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn RetrievePassword(&self) -> windows_result::Result<()> {
        let this = self;
    ...
    fn ICredentialFactory<R, F: FnOnce(&ICredentialFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl PasswordCredentialPropertyStore {
    ...
    pub fn MapChanged<P0>(&self, vhnd: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveMapChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<super::super::Foundation::Collections::IObservableMap<windows_core::HSTRING, windows_core::IInspectable>>(self)?;
...
impl PasswordVault {
    ...
    pub fn Add<P0>(&self, credential: P0) -> windows_result::Result<()>
    where
    ...
    pub fn Remove<P0>(&self, credential: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<PasswordCredential>,
    {
        let this = self;
    ...
    pub fn Retrieve(&self, resource: &windows_core::HSTRING, username: &windows_core::HSTRING) -> windows_result::Result<PasswordCredential> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAllByResource(&self, resource: &windows_core::HSTRING) -> windows_result::Result<windows_collections::IVectorView<PasswordCredential>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAllByUserName(&self, username: &windows_core::HSTRING) -> windows_result::Result<windows_collections::IVectorView<PasswordCredential>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RetrieveAll(&self) -> windows_result::Result<windows_collections::IVectorView<PasswordCredential>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WebAccount {
    ...
    pub fn Properties(&self) -> windows_result::Result<windows_collections::IMapView<windows_core::HSTRING, windows_core::HSTRING>> {
        let this = &windows_core::Interface::cast::<IWebAccount2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Properties)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn GetPictureAsync(&self, desizedsize: WebAccountPictureSize) -> windows_result::Result<windows_future::IAsyncOperation<super::super::Storage::Streams::IRandomAccessStream>> {
        let this = &windows_core::Interface::cast::<IWebAccount2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SignOutAsync(&self) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = &windows_core::Interface::cast::<IWebAccount2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SignOutWithClientIdAsync(&self, clientid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = &windows_core::Interface::cast::<IWebAccount2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateWebAccount<P0>(webaccountprovider: P0, username: &windows_core::HSTRING, state: WebAccountState) -> windows_result::Result<WebAccount>
    where
    ...
    fn IWebAccountFactory<R, F: FnOnce(&IWebAccountFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl WebAccountProvider {
    ...
    pub fn DisplayPurpose(&self) -> windows_result::Result<windows_core::HSTRING> {
    ...
    pub fn Authority(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<IWebAccountProvider2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsSystemProvider(&self) -> windows_result::Result<bool> {
    ...
    pub fn CreateWebAccountProvider<P2>(id: &windows_core::HSTRING, displayname: &windows_core::HSTRING, iconuri: P2) -> windows_result::Result<WebAccountProvider>
    where
    ...
    fn IWebAccountProviderFactory<R, F: FnOnce(&IWebAccountProviderFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
