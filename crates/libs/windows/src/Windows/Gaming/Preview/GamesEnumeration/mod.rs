pub struct GameList;
impl GameList {
    pub fn FindAllAsync() -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<GameListEntry>>, windows_result::HRESULT> {
    ...
    pub fn FindAllAsyncPackageFamilyName(packagefamilyname: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<GameListEntry>>, windows_result::HRESULT> {
        Self::IGameListStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GameAdded<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveGameAdded(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn GameRemoved<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveGameRemoved(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn GameUpdated<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
        P0: windows_core::Param<GameListChangedEventHandler>,
    {
        Self::IGameListStatics(|this| unsafe {
    ...
    pub fn RemoveGameUpdated(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn MergeEntriesAsync<P0, P1>(left: P0, right: P1) -> Result<windows_future::IAsyncOperation<GameListEntry>, windows_result::HRESULT>
    where
    ...
    pub fn UnmergeEntryAsync<P0>(mergedentry: P0) -> Result<windows_future::IAsyncOperation<windows_collections::IVectorView<GameListEntry>>, windows_result::HRESULT>
    where
        P0: windows_core::Param<GameListEntry>,
    {
        Self::IGameListStatics2(|this| unsafe {
    ...
    fn IGameListStatics<R, F: FnOnce(&IGameListStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<GameList, IGameListStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IGameListStatics2<R, F: FnOnce(&IGameListStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl GameListChangedEventHandler {
    pub fn new<F: FnMut(windows_core::Ref<'_, GameListEntry>) -> Result<(), windows_result::HRESULT> + Send + 'static>(invoke: F) -> Self {
    ...
    pub fn Invoke<P0>(&self, game: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<GameListEntry>,
    {
        let this = self;
...
pub struct GameListChangedEventHandler_Vtbl {
    ...
    Invoke: unsafe extern "system" fn(this: *mut core::ffi::c_void, game: *mut core::ffi::c_void) -> windows_result::HRESULT,
}
#[repr(C)]
struct GameListChangedEventHandlerBox<F: FnMut(windows_core::Ref<'_, GameListEntry>) -> Result<(), windows_result::HRESULT> + Send + 'static> {
    vtable: *const GameListChangedEventHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(windows_core::Ref<'_, GameListEntry>) -> Result<(), windows_result::HRESULT> + Send + 'static> GameListChangedEventHandlerBox<F> {
    ...
    unsafe extern "system" fn Invoke(this: *mut core::ffi::c_void, game: *mut core::ffi::c_void) -> windows_result::HRESULT {
        unsafe {
...
impl GameListEntry {
    ...
    pub fn DisplayInfo(&self) -> Result<super::super::super::ApplicationModel::AppDisplayInfo, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Category(&self) -> Result<GameListCategory, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCategoryAsync(&self, value: GameListCategory) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LaunchableState(&self) -> Result<GameListEntryLaunchableState, windows_result::HRESULT> {
    ...
    pub fn LauncherExecutable(&self) -> Result<super::super::super::Storage::IStorageFile, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IGameListEntry2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LaunchParameters(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IGameListEntry2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetLauncherExecutableFileAsync<P0>(&self, executablefile: P0) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SetLauncherExecutableFileWithParamsAsync<P0>(&self, executablefile: P0, launchparams: &windows_core::HSTRING) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Storage::IStorageFile>,
    {
        let this = &windows_core::Interface::cast::<IGameListEntry2>(self)?;
    ...
    pub fn TitleId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IGameListEntry2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTitleIdAsync(&self, id: &windows_core::HSTRING) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IGameListEntry2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GameModeConfiguration(&self) -> Result<GameModeConfiguration, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IGameListEntry2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GameListRemovedEventHandler {
    pub fn new<F: FnMut(&windows_core::HSTRING) -> Result<(), windows_result::HRESULT> + Send + 'static>(invoke: F) -> Self {
    ...
    pub fn Invoke(&self, identifier: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
pub struct GameListRemovedEventHandler_Vtbl {
    base__: windows_core::IUnknown_Vtbl,
    Invoke: unsafe extern "system" fn(this: *mut core::ffi::c_void, identifier: *mut core::ffi::c_void) -> windows_result::HRESULT,
}
#[repr(C)]
struct GameListRemovedEventHandlerBox<F: FnMut(&windows_core::HSTRING) -> Result<(), windows_result::HRESULT> + Send + 'static> {
    vtable: *const GameListRemovedEventHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: FnMut(&windows_core::HSTRING) -> Result<(), windows_result::HRESULT> + Send + 'static> GameListRemovedEventHandlerBox<F> {
    ...
    unsafe extern "system" fn Invoke(this: *mut core::ffi::c_void, identifier: *mut core::ffi::c_void) -> windows_result::HRESULT {
        unsafe {
            let this = &mut *(this as *mut *mut core::ffi::c_void as *mut Self);
...
impl GameModeConfiguration {
    ...
    pub fn RelatedProcessNames(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PercentGpuTimeAllocatedToGame(&self) -> Result<super::super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPercentGpuTimeAllocatedToGame<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn PercentGpuMemoryAllocatedToGame(&self) -> Result<super::super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPercentGpuMemoryAllocatedToGame<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn PercentGpuMemoryAllocatedToSystemCompositor(&self) -> Result<super::super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPercentGpuMemoryAllocatedToSystemCompositor<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn MaxCpuCount(&self) -> Result<super::super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMaxCpuCount<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn CpuExclusivityMaskLow(&self) -> Result<super::super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCpuExclusivityMaskLow<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn CpuExclusivityMaskHigh(&self) -> Result<super::super::super::Foundation::IReference<i32>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCpuExclusivityMaskHigh<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::Foundation::IReference<i32>>,
    {
        let this = self;
    ...
    pub fn AffinitizeToExclusiveCpus(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAffinitizeToExclusiveCpus(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl GameModeUserConfiguration {
    pub fn GamingRelatedProcessNames(&self) -> Result<windows_collections::IVector<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDefault() -> Result<GameModeUserConfiguration, windows_result::HRESULT> {
        Self::IGameModeUserConfigurationStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefault)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IGameModeUserConfigurationStatics<R, F: FnOnce(&IGameModeUserConfigurationStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
pub trait IGameListEntry_Impl: windows_core::IUnknownImpl {
    fn DisplayInfo(&self) -> Result<super::super::super::ApplicationModel::AppDisplayInfo, windows_result::HRESULT>;
    fn LaunchAsync(&self) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>;
    fn Category(&self) -> Result<GameListCategory, windows_result::HRESULT>;
    fn Properties(&self) -> Result<windows_collections::IMapView<windows_core::HSTRING, windows_core::IInspectable>, windows_result::HRESULT>;
    fn SetCategoryAsync(&self, value: GameListCategory) -> Result<windows_future::IAsyncAction, windows_result::HRESULT>;
}
#[cfg(feature = "ApplicationModel")]
impl IGameListEntry_Vtbl {
    pub const fn new<Identity: IGameListEntry_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn DisplayInfo<Identity: IGameListEntry_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn LaunchAsync<Identity: IGameListEntry_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Category<Identity: IGameListEntry_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut GameListCategory) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Properties<Identity: IGameListEntry_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetCategoryAsync<Identity: IGameListEntry_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: GameListCategory, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
