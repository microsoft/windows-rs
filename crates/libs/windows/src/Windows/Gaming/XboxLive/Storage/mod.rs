...
impl GameSaveBlobInfoQuery {
    pub fn GetBlobInfoAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<GameSaveBlobInfoGetResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetBlobInfoWithIndexAndMaxAsync(&self, startindex: u32, maxnumberofitems: u32) -> windows_core::Result<windows_async::IAsyncOperation<GameSaveBlobInfoGetResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GameSaveContainer {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SubmitUpdatesAsync<P0, P1>(&self, blobstowrite: P0, blobstodelete: P1, displayname: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<GameSaveOperationResult>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ReadAsync<P0>(&self, blobstoread: P0) -> windows_core::Result<windows_async::IAsyncOperation<GameSaveOperationResult>>
    where
        P0: windows_core::Param<windows_collections::IMapView<windows_core::HSTRING, super::super::super::Storage::Streams::IBuffer>>,
    {
        let this = self;
    ...
    pub fn GetAsync<P0>(&self, blobstoread: P0) -> windows_core::Result<windows_async::IAsyncOperation<GameSaveBlobGetResult>>
    where
    ...
    pub fn SubmitPropertySetUpdatesAsync<P0, P1>(&self, blobstowrite: P0, blobstodelete: P1, displayname: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<GameSaveOperationResult>>
    where
...
impl GameSaveContainerInfoQuery {
    pub fn GetContainerInfoAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<GameSaveContainerInfoGetResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetContainerInfoWithIndexAndMaxAsync(&self, startindex: u32, maxnumberofitems: u32) -> windows_core::Result<windows_async::IAsyncOperation<GameSaveContainerInfoGetResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GameSaveProvider {
    ...
    pub fn DeleteContainerAsync(&self, name: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<GameSaveOperationResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetRemainingBytesInQuotaAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<i64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "System")]
    pub fn GetForUserAsync<P0>(user: P0, serviceconfigid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<GameSaveProviderGetResult>>
    where
    ...
    #[cfg(feature = "System")]
    pub fn GetSyncOnDemandForUserAsync<P0>(user: P0, serviceconfigid: &windows_core::HSTRING) -> windows_core::Result<windows_async::IAsyncOperation<GameSaveProviderGetResult>>
    where
        P0: windows_core::Param<super::super::super::System::User>,
    {
        Self::IGameSaveProviderStatics(|this| unsafe {
