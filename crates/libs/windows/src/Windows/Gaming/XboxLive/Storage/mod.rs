...
windows_core::imp::required_hierarchy!(GameSaveBlobGetResult, IGameSaveBlobGetResult);
...
windows_core::imp::required_hierarchy!(GameSaveBlobInfo, IGameSaveBlobInfo);
...
windows_core::imp::required_hierarchy!(GameSaveBlobInfoGetResult, IGameSaveBlobInfoGetResult);
...
windows_core::imp::required_hierarchy!(GameSaveBlobInfoQuery, IGameSaveBlobInfoQuery);
...
windows_core::imp::required_hierarchy!(GameSaveContainer, IGameSaveContainer);
...
windows_core::imp::required_hierarchy!(GameSaveContainerInfo, IGameSaveContainerInfo);
...
windows_core::imp::required_hierarchy!(GameSaveContainerInfoGetResult, IGameSaveContainerInfoGetResult);
...
windows_core::imp::required_hierarchy!(GameSaveContainerInfoQuery, IGameSaveContainerInfoQuery);
...
windows_core::imp::required_hierarchy!(GameSaveOperationResult, IGameSaveOperationResult);
...
windows_core::imp::required_hierarchy!(GameSaveProvider, IGameSaveProvider, IGameSaveProviderStatics);
...
windows_core::imp::required_hierarchy!(GameSaveProviderGetResult, IGameSaveProviderGetResult);
