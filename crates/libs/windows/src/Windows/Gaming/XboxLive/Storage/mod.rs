...
impl GameSaveBlobGetResult {
    pub fn Status(&self) -> Result<GameSaveErrorStatus, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn Value(&self) -> Result<windows_collections::IMapView<windows_core::HSTRING, super::super::super::Storage::Streams::IBuffer>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GameSaveBlobInfoGetResult {
    ...
    pub fn Value(&self) -> Result<windows_collections::IVectorView<GameSaveBlobInfo>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Value)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl GameSaveBlobInfoQuery {
    pub fn GetBlobInfoAsync(&self) -> Result<windows_future::IAsyncOperation<GameSaveBlobInfoGetResult>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetBlobInfoWithIndexAndMaxAsync(&self, startindex: u32, maxnumberofitems: u32) -> Result<windows_future::IAsyncOperation<GameSaveBlobInfoGetResult>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GameSaveContainer {
    ...
    pub fn Provider(&self) -> Result<GameSaveProvider, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SubmitUpdatesAsync<P0, P1>(&self, blobstowrite: P0, blobstodelete: P1, displayname: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<GameSaveOperationResult>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ReadAsync<P0>(&self, blobstoread: P0) -> Result<windows_future::IAsyncOperation<GameSaveOperationResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<windows_collections::IMapView<windows_core::HSTRING, super::super::super::Storage::Streams::IBuffer>>,
    {
        let this = self;
    ...
    pub fn GetAsync<P0>(&self, blobstoread: P0) -> Result<windows_future::IAsyncOperation<GameSaveBlobGetResult>, windows_result::HRESULT>
    where
    ...
    pub fn SubmitPropertySetUpdatesAsync<P0, P1>(&self, blobstowrite: P0, blobstodelete: P1, displayname: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<GameSaveOperationResult>, windows_result::HRESULT>
    where
    ...
    pub fn CreateBlobInfoQuery(&self, blobnameprefix: &windows_core::HSTRING) -> Result<GameSaveBlobInfoQuery, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GameSaveContainerInfo {
    ...
    pub fn TotalSize(&self) -> Result<u64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LastModifiedTime(&self) -> Result<super::super::super::Foundation::DateTime, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NeedsSync(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GameSaveContainerInfoGetResult {
    ...
    pub fn Value(&self) -> Result<windows_collections::IVectorView<GameSaveContainerInfo>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Value)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
impl GameSaveContainerInfoQuery {
    pub fn GetContainerInfoAsync(&self) -> Result<windows_future::IAsyncOperation<GameSaveContainerInfoGetResult>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetContainerInfoWithIndexAndMaxAsync(&self, startindex: u32, maxnumberofitems: u32) -> Result<windows_future::IAsyncOperation<GameSaveContainerInfoGetResult>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GameSaveProvider {
    ...
    pub fn CreateContainer(&self, name: &windows_core::HSTRING) -> Result<GameSaveContainer, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeleteContainerAsync(&self, name: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<GameSaveOperationResult>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateContainerInfoQuery(&self) -> Result<GameSaveContainerInfoQuery, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateContainerInfoQueryWithName(&self, containernameprefix: &windows_core::HSTRING) -> Result<GameSaveContainerInfoQuery, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetRemainingBytesInQuotaAsync(&self) -> Result<windows_future::IAsyncOperation<i64>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ContainersChangedSinceLastSync(&self) -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "System")]
    pub fn GetForUserAsync<P0>(user: P0, serviceconfigid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<GameSaveProviderGetResult>, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "System")]
    pub fn GetSyncOnDemandForUserAsync<P0>(user: P0, serviceconfigid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<GameSaveProviderGetResult>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::System::User>,
    {
        Self::IGameSaveProviderStatics(|this| unsafe {
    ...
    fn IGameSaveProviderStatics<R, F: FnOnce(&IGameSaveProviderStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl GameSaveProviderGetResult {
    ...
    pub fn Value(&self) -> Result<GameSaveProvider, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Value)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
