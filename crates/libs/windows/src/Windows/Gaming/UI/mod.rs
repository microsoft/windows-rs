pub struct GameBar;
impl GameBar {
    pub fn VisibilityChanged<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveVisibilityChanged(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn IsInputRedirectedChanged<P0>(handler: P0) -> Result<i64, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::EventHandler<windows_core::IInspectable>>,
    {
        Self::IGameBarStatics(|this| unsafe {
    ...
    pub fn RemoveIsInputRedirectedChanged(token: i64) -> Result<(), windows_result::HRESULT> {
    ...
    pub fn Visible() -> Result<bool, windows_result::HRESULT> {
        Self::IGameBarStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Visible)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    pub fn IsInputRedirected() -> Result<bool, windows_result::HRESULT> {
        Self::IGameBarStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsInputRedirected)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    fn IGameBarStatics<R, F: FnOnce(&IGameBarStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl GameChatMessageReceivedEventArgs {
    ...
    pub fn Origin(&self) -> Result<GameChatMessageOrigin, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GameChatOverlay {
    pub fn DesiredPosition(&self) -> Result<GameChatOverlayPosition, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDesiredPosition(&self, value: GameChatOverlayPosition) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDesiredPosition)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AddMessage(&self, sender: &windows_core::HSTRING, message: &windows_core::HSTRING, origin: GameChatMessageOrigin) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn GetDefault() -> Result<GameChatOverlay, windows_result::HRESULT> {
        Self::IGameChatOverlayStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefault)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IGameChatOverlayStatics<R, F: FnOnce(&IGameChatOverlayStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl GameChatOverlayMessageSource {
    ...
    pub fn SetDelayBeforeClosingAfterMessageReceived(&self, value: super::super::Foundation::TimeSpan) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl GameUIProviderActivatedEventArgs {
    ...
    pub fn GameUIArgs(&self) -> Result<super::super::Foundation::Collections::ValueSet, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn ReportCompleted<P0>(&self, results: P0) -> Result<(), windows_result::HRESULT>
    where
