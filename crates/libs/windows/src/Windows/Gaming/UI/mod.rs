...
windows_core::imp::required_hierarchy!(GameChatMessageReceivedEventArgs, IGameChatMessageReceivedEventArgs);
...
windows_core::imp::required_hierarchy!(GameChatOverlay, IGameChatOverlay, IGameChatOverlayStatics);
...
windows_core::imp::required_hierarchy!(GameChatOverlayMessageSource, IGameChatOverlayMessageSource);
...
#[cfg(feature = "ApplicationModel_Activation")]
windows_core::imp::required_hierarchy!(GameUIProviderActivatedEventArgs, super::super::ApplicationModel::Activation::IActivatedEventArgs, IGameUIProviderActivatedEventArgs);
#[cfg(feature = "ApplicationModel_Activation")]
