...
windows_core::imp::required_hierarchy!(ConditionForceEffect, IConditionForceEffect, IConditionForceEffectFactory, IForceFeedbackEffect);
...
windows_core::imp::required_hierarchy!(ConstantForceEffect, IConstantForceEffect, IForceFeedbackEffect);
...
windows_core::imp::required_hierarchy!(ForceFeedbackMotor, IForceFeedbackMotor);
...
windows_core::imp::required_hierarchy!(PeriodicForceEffect, IForceFeedbackEffect, IPeriodicForceEffect, IPeriodicForceEffectFactory);
...
windows_core::imp::required_hierarchy!(RampForceEffect, IForceFeedbackEffect, IRampForceEffect);
