...
impl ConditionForceEffect {
    pub fn Kind(&self) -> windows_result::Result<ConditionForceEffectKind> {
    ...
    pub fn SetParameters(&self, direction: windows_numerics::Vector3, positivecoefficient: f32, negativecoefficient: f32, maxpositivemagnitude: f32, maxnegativemagnitude: f32, deadzone: f32, bias: f32) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IConditionForceEffect>(self)?;
    ...
    pub fn CreateInstance(effectkind: ConditionForceEffectKind) -> windows_result::Result<ConditionForceEffect> {
    ...
    pub fn Gain(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetGain(&self, value: f64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetGain)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn State(&self) -> windows_result::Result<ForceFeedbackEffectState> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IConditionForceEffectFactory<R, F: FnOnce(&IConditionForceEffectFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl ConstantForceEffect {
    ...
    pub fn SetParameters(&self, vector: windows_numerics::Vector3, duration: super::super::super::Foundation::TimeSpan) -> windows_result::Result<()> {
...
impl ForceFeedbackMotor {
    pub fn AreEffectsPaused(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MasterGain(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMasterGain(&self, value: f64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SupportedAxes(&self) -> windows_result::Result<ForceFeedbackEffectAxes> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LoadEffectAsync<P0>(&self, effect: P0) -> windows_result::Result<windows_future::IAsyncOperation<ForceFeedbackLoadEffectResult>>
    where
    ...
    pub fn TryEnableAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryResetAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryUnloadEffectAsync<P0>(&self, effect: P0) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<IForceFeedbackEffect>,
    {
        let this = self;
...
pub trait IForceFeedbackEffect_Impl: windows_core::IUnknownImpl {
    fn Gain(&self) -> windows_result::Result<f64>;
    fn SetGain(&self, value: f64) -> windows_result::Result<()>;
    fn State(&self) -> windows_result::Result<ForceFeedbackEffectState>;
...
impl PeriodicForceEffect {
    ...
    pub fn Kind(&self) -> windows_result::Result<PeriodicForceEffectKind> {
    ...
    pub fn SetParameters(&self, vector: windows_numerics::Vector3, frequency: f32, phase: f32, bias: f32, duration: super::super::super::Foundation::TimeSpan) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IPeriodicForceEffect>(self)?;
    ...
    pub fn CreateInstance(effectkind: PeriodicForceEffectKind) -> windows_result::Result<PeriodicForceEffect> {
        Self::IPeriodicForceEffectFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateInstance)(windows_core::Interface::as_raw(this), effectkind, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IPeriodicForceEffectFactory<R, F: FnOnce(&IPeriodicForceEffectFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl RampForceEffect {
    ...
    pub fn SetParameters(&self, startvector: windows_numerics::Vector3, endvector: windows_numerics::Vector3, duration: super::super::super::Foundation::TimeSpan) -> windows_result::Result<()> {
