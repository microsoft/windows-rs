...
impl<Identity: windows_core::IUnknownImpl + IForceFeedbackEffect_Impl + 'static, const OFFSET: isize> windows_core::imp::VtableCtor<Identity, OFFSET> for IForceFeedbackEffect_Vtbl {
