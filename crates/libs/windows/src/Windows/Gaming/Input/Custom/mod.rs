...
impl GameControllerFactoryManager {
    pub fn RegisterCustomFactoryForGipInterface<P0>(factory: P0, interfaceid: windows_core::GUID) -> windows_result::Result<()>
    where
    ...
    pub fn RegisterCustomFactoryForHardwareId<P0>(factory: P0, hardwarevendorid: u16, hardwareproductid: u16) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ICustomGameControllerFactory>,
    {
    ...
    pub fn RegisterCustomFactoryForXusbType<P0>(factory: P0, xusbtype: XusbDeviceType, xusbsubtype: XusbDeviceSubtype) -> windows_result::Result<()>
    where
        P0: windows_core::Param<ICustomGameControllerFactory>,
    {
    ...
    pub fn TryGetFactoryControllerFromGameController<P0, P1>(factory: P0, gamecontroller: P1) -> windows_result::Result<super::IGameController>
    where
        P0: windows_core::Param<ICustomGameControllerFactory>,
    ...
    fn IGameControllerFactoryManagerStatics<R, F: FnOnce(&IGameControllerFactoryManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn IGameControllerFactoryManagerStatics2<R, F: FnOnce(&IGameControllerFactoryManagerStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl GipFirmwareUpdateResult {
    pub fn ExtendedErrorCode(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FinalComponentId(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Status(&self) -> windows_result::Result<GipFirmwareUpdateStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl GipGameControllerProvider {
    pub fn FirmwareVersionInfo(&self) -> windows_result::Result<GameControllerVersionInfo> {
    ...
    pub fn HardwareVersionInfo(&self) -> windows_result::Result<GameControllerVersionInfo> {
        let this = &windows_core::Interface::cast::<IGameControllerProvider>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SendMessage(&self, messageclass: GipMessageClass, messageid: u8, messagebuffer: &[u8]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SendReceiveMessage(&self, messageclass: GipMessageClass, messageid: u8, requestmessagebuffer: &[u8], responsemessagebuffer: &mut [u8]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn UpdateFirmwareAsync<P0>(&self, firmwareimage: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<GipFirmwareUpdateResult, GipFirmwareUpdateProgress>>
    where
...
impl HidGameControllerProvider {
    ...
    pub fn GetFeatureReport(&self, reportid: u8, reportbuffer: &mut [u8]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SendFeatureReport(&self, reportid: u8, reportbuffer: &[u8]) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SendOutputReport(&self, reportid: u8, reportbuffer: &[u8]) -> windows_result::Result<()> {
        let this = self;
...
impl ICustomGameControllerFactory {
    pub fn CreateGameController<P0>(&self, provider: P0) -> windows_result::Result<windows_core::IInspectable>
    where
    ...
    pub fn OnGameControllerAdded<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn OnGameControllerRemoved<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::IGameController>,
    {
        let this = self;
...
pub trait ICustomGameControllerFactory_Impl: windows_core::IUnknownImpl {
    fn CreateGameController(&self, provider: windows_core::Ref<IGameControllerProvider>) -> windows_result::Result<windows_core::IInspectable>;
    fn OnGameControllerAdded(&self, value: windows_core::Ref<super::IGameController>) -> windows_result::Result<()>;
    fn OnGameControllerRemoved(&self, value: windows_core::Ref<super::IGameController>) -> windows_result::Result<()>;
}
...
impl IGameControllerInputSink {
    pub fn OnInputResumed(&self, timestamp: u64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).OnInputResumed)(windows_core::Interface::as_raw(this), timestamp).ok() }
    }
    pub fn OnInputSuspended(&self, timestamp: u64) -> windows_result::Result<()> {
        let this = self;
...
pub trait IGameControllerInputSink_Impl: windows_core::IUnknownImpl {
    fn OnInputResumed(&self, timestamp: u64) -> windows_result::Result<()>;
    fn OnInputSuspended(&self, timestamp: u64) -> windows_result::Result<()>;
}
...
pub trait IGameControllerProvider_Impl: windows_core::IUnknownImpl {
    fn FirmwareVersionInfo(&self) -> windows_result::Result<GameControllerVersionInfo>;
    fn HardwareProductId(&self) -> windows_result::Result<u16>;
    fn HardwareVendorId(&self) -> windows_result::Result<u16>;
    fn HardwareVersionInfo(&self) -> windows_result::Result<GameControllerVersionInfo>;
    fn IsConnected(&self) -> windows_result::Result<bool>;
}
...
impl IGipGameControllerInputSink {
    pub fn OnKeyReceived(&self, timestamp: u64, keycode: u8, ispressed: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn OnMessageReceived(&self, timestamp: u64, messageclass: GipMessageClass, messageid: u8, sequenceid: u8, messagebuffer: &[u8]) -> windows_result::Result<()> {
        let this = self;
...
pub trait IGipGameControllerInputSink_Impl: IGameControllerInputSink_Impl {
    fn OnKeyReceived(&self, timestamp: u64, keyCode: u8, isPressed: bool) -> windows_result::Result<()>;
    fn OnMessageReceived(&self, timestamp: u64, messageClass: GipMessageClass, messageId: u8, sequenceId: u8, messageBuffer: &[u8]) -> windows_result::Result<()>;
}
...
impl IHidGameControllerInputSink {
    pub fn OnInputReportReceived(&self, timestamp: u64, reportid: u8, reportbuffer: &[u8]) -> windows_result::Result<()> {
        let this = self;
...
pub trait IHidGameControllerInputSink_Impl: IGameControllerInputSink_Impl {
    fn OnInputReportReceived(&self, timestamp: u64, reportId: u8, reportBuffer: &[u8]) -> windows_result::Result<()>;
}
...
impl IXusbGameControllerInputSink {
    pub fn OnInputReceived(&self, timestamp: u64, reportid: u8, inputbuffer: &[u8]) -> windows_result::Result<()> {
        let this = self;
...
pub trait IXusbGameControllerInputSink_Impl: IGameControllerInputSink_Impl {
    fn OnInputReceived(&self, timestamp: u64, reportId: u8, inputBuffer: &[u8]) -> windows_result::Result<()>;
}
...
impl XusbGameControllerProvider {
    ...
    pub fn SetVibration(&self, lowfrequencymotorspeed: f64, highfrequencymotorspeed: f64) -> windows_result::Result<()> {
        let this = self;
