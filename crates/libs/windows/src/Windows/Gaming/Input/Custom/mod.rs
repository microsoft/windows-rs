...
windows_core::imp::required_hierarchy!(GipFirmwareUpdateResult, IGipFirmwareUpdateResult);
...
windows_core::imp::required_hierarchy!(GipGameControllerProvider, IGameControllerProvider, IGipGameControllerProvider);
...
windows_core::imp::required_hierarchy!(HidGameControllerProvider, IGameControllerProvider, IHidGameControllerProvider);
...
windows_core::imp::required_hierarchy!(XusbGameControllerProvider, IGameControllerProvider, IXusbGameControllerProvider);
