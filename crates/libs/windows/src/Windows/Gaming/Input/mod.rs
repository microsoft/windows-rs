...
pub struct IRawGameControllerVtbl(
    ...
    #[cfg(not(any(feature = "Foundation_Collections", feature = "Gaming_Input_ForceFeedback")))] usize,
...
pub struct IRawGameController2Vtbl(
    ...
    #[cfg(not(any(feature = "Devices_Haptics", feature = "Foundation_Collections")))] usize,
    pub unsafe extern "system" fn(this: *mut ::core::ffi::c_void, result__: *mut ::core::mem::ManuallyDrop<::windows::core::HSTRING>) -> ::windows::core::HRESULT,
    pub unsafe extern "system" fn(this: *mut ::core::ffi::c_void, result__: *mut ::core::mem::ManuallyDrop<::windows::core::HSTRING>) -> ::windows::core::HRESULT,
);
#[doc(hidden)]
