...
impl GameControllerProviderInfo {
    ...
    pub fn GetParentProviderId<P0>(provider: P0) -> Result<windows_core::HSTRING, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Gaming_Input_Custom")]
    pub fn GetProviderId<P0>(provider: P0) -> Result<windows_core::HSTRING, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Custom::IGameControllerProvider>,
    {
        Self::IGameControllerProviderInfoStatics(|this| unsafe {
    ...
    fn IGameControllerProviderInfoStatics<R, F: FnOnce(&IGameControllerProviderInfoStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl LegacyGipGameControllerProvider {
    pub fn BatteryChargingState(&self) -> Result<GameControllerBatteryChargingState, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BatteryKind(&self) -> Result<GameControllerBatteryKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BatteryLevel(&self) -> Result<GameControllerBatteryLevel, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDeviceFirmwareCorruptionState(&self) -> Result<GameControllerFirmwareCorruptReason, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsFirmwareCorrupted(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsInterfaceSupported(&self, interfaceid: windows_core::GUID) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsSyntheticDevice(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PreferredTypes(&self) -> Result<windows_collections::IVectorView<windows_core::HSTRING>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ExecuteCommand(&self, command: DeviceCommand) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).ExecuteCommand)(windows_core::Interface::as_raw(this), command).ok() }
    }
    pub fn SetHomeLedIntensity(&self, intensity: u8) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetHomeLedIntensity)(windows_core::Interface::as_raw(this), intensity).ok() }
    }
    pub fn GetExtendedDeviceInfo(&self) -> Result<windows_core::Array<u8>, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn SetHeadsetOperation(&self, operation: HeadsetOperation, buffer: &[u8]) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn GetHeadsetOperation(&self, operation: HeadsetOperation) -> Result<windows_core::Array<u8>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::MaybeUninit::zeroed();
    ...
    pub fn AppCompatVersion(&self) -> Result<u32, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "System")]
    pub fn SetStandardControllerButtonRemapping<P0, P2>(&self, user: P0, previous: bool, remapping: P2) -> Result<(), windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "System")]
    pub fn GetStandardControllerButtonRemapping<P0>(&self, user: P0, previous: bool) -> Result<windows_collections::IMapView<RemappingButtonCategory, windows_core::IInspectable>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::System::User>,
    {
        let this = self;
    ...
    pub fn FromGameController<P0>(controller: P0) -> Result<LegacyGipGameControllerProvider, windows_result::HRESULT>
    where
    ...
    #[cfg(feature = "Gaming_Input_Custom")]
    pub fn FromGameControllerProvider<P0>(provider: P0) -> Result<LegacyGipGameControllerProvider, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::Custom::IGameControllerProvider>,
    {
        Self::ILegacyGipGameControllerProviderStatics(|this| unsafe {
    ...
    #[cfg(feature = "System")]
    pub fn PairPilotToCopilot<P0>(user: P0, pilotcontrollerproviderid: &windows_core::HSTRING, copilotcontrollerproviderid: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::System::User>,
    {
    ...
    #[cfg(feature = "System")]
    pub fn ClearPairing<P0>(user: P0, controllerproviderid: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::System::User>,
    {
    ...
    #[cfg(feature = "System")]
    pub fn IsPilot<P0>(user: P0, controllerproviderid: &windows_core::HSTRING) -> Result<windows_core::HSTRING, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::System::User>,
    {
        Self::ILegacyGipGameControllerProviderStatics(|this| unsafe {
    ...
    #[cfg(feature = "System")]
    pub fn IsCopilot<P0>(user: P0, controllerproviderid: &windows_core::HSTRING) -> Result<windows_core::HSTRING, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::super::System::User>,
    {
        Self::ILegacyGipGameControllerProviderStatics(|this| unsafe {
    ...
    fn ILegacyGipGameControllerProviderStatics<R, F: FnOnce(&ILegacyGipGameControllerProviderStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
