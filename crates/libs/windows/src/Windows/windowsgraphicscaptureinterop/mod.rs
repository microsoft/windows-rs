...
impl IGraphicsCaptureItemInterop {
    ...
    #[cfg(feature = "windef")]
    pub unsafe fn CreateForMonitor<T>(&self, monitor: super::windef::HMONITOR) -> windows_core::Result<T>
    where
        T: windows_core::Interface,
    {
        let mut result__ = core::ptr::null_mut();
...
pub struct IGraphicsCaptureItemInterop_Vtbl {
    ...
    #[cfg(feature = "windef")]
    pub CreateForMonitor: unsafe extern "system" fn(*mut core::ffi::c_void, super::windef::HMONITOR, *const windows_core::GUID, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    CreateForMonitor: usize,
}
#[cfg(feature = "windef")]
pub trait IGraphicsCaptureItemInterop_Impl: windows_core::IUnknownImpl {
    fn CreateForWindow(&self, window: super::windef::HWND, riid: *const windows_core::GUID, result: *mut *mut core::ffi::c_void) -> windows_core::Result<()>;
    fn CreateForMonitor(&self, monitor: super::windef::HMONITOR, riid: *const windows_core::GUID, result: *mut *mut core::ffi::c_void) -> windows_core::Result<()>;
}
#[cfg(feature = "windef")]
impl IGraphicsCaptureItemInterop_Vtbl {
    pub const fn new<Identity: IGraphicsCaptureItemInterop_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateForWindow<Identity: IGraphicsCaptureItemInterop_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, window: super::windef::HWND, riid: *const windows_core::GUID, result: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
        ...
        unsafe extern "system" fn CreateForMonitor<Identity: IGraphicsCaptureItemInterop_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, monitor: super::windef::HMONITOR, riid: *const windows_core::GUID, result: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IMonitorGraphicsCaptureItemInterop {
    #[cfg(feature = "windef")]
    pub unsafe fn GetMonitor(&self) -> windows_core::Result<super::windef::HMONITOR> {
        unsafe {
...
pub struct IMonitorGraphicsCaptureItemInterop_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "windef")]
    pub GetMonitor: unsafe extern "system" fn(*mut core::ffi::c_void, *mut super::windef::HMONITOR) -> windows_core::HRESULT,
    #[cfg(not(feature = "windef"))]
    GetMonitor: usize,
}
#[cfg(feature = "windef")]
pub trait IMonitorGraphicsCaptureItemInterop_Impl: windows_core::IUnknownImpl {
    fn GetMonitor(&self) -> windows_core::Result<super::windef::HMONITOR>;
}
#[cfg(feature = "windef")]
impl IMonitorGraphicsCaptureItemInterop_Vtbl {
    pub const fn new<Identity: IMonitorGraphicsCaptureItemInterop_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetMonitor<Identity: IMonitorGraphicsCaptureItemInterop_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, monitor: *mut super::windef::HMONITOR) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IWindowGraphicsCaptureItemInterop_Vtbl {
    pub const fn new<Identity: IWindowGraphicsCaptureItemInterop_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetWindow<Identity: IWindowGraphicsCaptureItemInterop_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, window: *mut super::windef::HWND) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
