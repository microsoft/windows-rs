...
pub trait ICompositeTransform3DImpl: Sized {
    ...
    fn CenterZ(&mut self) -> ::windows::core::Result<f64>;
    fn SetCenterZ(&mut self, value: f64) -> ::windows::core::Result<()>;
    ...
    fn ScaleZ(&mut self) -> ::windows::core::Result<f64>;
    fn SetScaleZ(&mut self, value: f64) -> ::windows::core::Result<()>;
    ...
    fn TranslateZ(&mut self) -> ::windows::core::Result<f64>;
    fn SetTranslateZ(&mut self, value: f64) -> ::windows::core::Result<()>;
}
#[cfg(feature = "implement_exclusive")]
...
pub trait ICompositeTransform3DStaticsImpl: Sized {
    ...
    fn RotationXProperty(&mut self) -> ::windows::core::Result<super::super::DependencyProperty>;
    fn RotationYProperty(&mut self) -> ::windows::core::Result<super::super::DependencyProperty>;
    fn RotationZProperty(&mut self) -> ::windows::core::Result<super::super::DependencyProperty>;
    fn ScaleXProperty(&mut self) -> ::windows::core::Result<super::super::DependencyProperty>;
    fn ScaleYProperty(&mut self) -> ::windows::core::Result<super::super::DependencyProperty>;
    fn ScaleZProperty(&mut self) -> ::windows::core::Result<super::super::DependencyProperty>;
    fn TranslateXProperty(&mut self) -> ::windows::core::Result<super::super::DependencyProperty>;
    fn TranslateYProperty(&mut self) -> ::windows::core::Result<super::super::DependencyProperty>;
    fn TranslateZProperty(&mut self) -> ::windows::core::Result<super::super::DependencyProperty>;
}
#[cfg(feature = "implement_exclusive")]
...
pub trait IMatrix3DHelperStaticsImpl: Sized {
    ...
    fn GetHasInverse(&mut self, target: &Matrix3D) -> ::windows::core::Result<bool>;
    fn GetIsIdentity(&mut self, target: &Matrix3D) -> ::windows::core::Result<bool>;
    fn Invert(&mut self, target: &Matrix3D) -> ::windows::core::Result<Matrix3D>;
}
#[cfg(feature = "implement_exclusive")]
...
pub trait IPerspectiveTransform3DImpl: Sized {
    ...
    fn SetOffsetX(&mut self, value: f64) -> ::windows::core::Result<()>;
    fn OffsetY(&mut self) -> ::windows::core::Result<f64>;
    fn SetOffsetY(&mut self, value: f64) -> ::windows::core::Result<()>;
}
#[cfg(feature = "implement_exclusive")]
