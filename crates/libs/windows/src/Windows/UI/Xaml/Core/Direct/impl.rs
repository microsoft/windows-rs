...
impl IXamlDirectObject_Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl<Impl = Impl>, Impl: IXamlDirectObject_Impl, const OFFSET: isize>() -> IXamlDirectObject_Vtbl {
        Self { base__: ::windows::core::IInspectableVtbl::new::<Identity, IXamlDirectObject, OFFSET>() }
    }
