...
impl SpatialInteractionController {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn TryGetRenderableModelAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<super::super::super::Storage::Streams::IRandomAccessStreamWithContentType>> {
...
impl SpatialInteractionSource {
    ...
    #[cfg(feature = "Perception_People")]
    pub fn TryCreateHandMeshObserverAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<super::super::super::Perception::People::HandMeshObserver>> {
        let this = &windows_core::Interface::cast::<ISpatialInteractionSource4>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
