...
impl RadialControllerIndependentInputSource {
    pub fn Controller(&self) -> Result<super::RadialController, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    #[cfg(feature = "ApplicationModel_Core")]
    pub fn CreateForView<P0>(view: P0) -> Result<RadialControllerIndependentInputSource, windows_result::HRESULT>
    where
    ...
    fn IRadialControllerIndependentInputSourceStatics<R, F: FnOnce(&IRadialControllerIndependentInputSourceStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
