...
windows_core::imp::required_hierarchy!(RadialControllerIndependentInputSource, IRadialControllerIndependentInputSource, IRadialControllerIndependentInputSource2, IRadialControllerIndependentInputSourceStatics);
