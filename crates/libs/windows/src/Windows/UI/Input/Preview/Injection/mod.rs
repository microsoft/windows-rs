...
impl InjectedInputGamepadInfo {
    ...
    pub fn Buttons(&self) -> ::windows::core::Result<super::super::super::super::Gaming::Input::GamepadButtons> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<super::super::super::super::Gaming::Input::GamepadButtons>::uninit();
...
impl InjectedInputKeyboardInfo {
    ...
    pub fn KeyOptions(&self) -> ::windows::core::Result<InjectedInputKeyOptions> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<InjectedInputKeyOptions>::uninit();
...
impl InjectedInputMouseInfo {
    ...
    pub fn MouseOptions(&self) -> ::windows::core::Result<InjectedInputMouseOptions> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<InjectedInputMouseOptions>::uninit();
...
impl InjectedInputPenInfo {
    ...
    pub fn PointerInfo(&self) -> ::windows::core::Result<InjectedInputPointerInfo> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<InjectedInputPointerInfo>::uninit();
    ...
    pub fn PenButtons(&self) -> ::windows::core::Result<InjectedInputPenButtons> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<InjectedInputPenButtons>::uninit();
    ...
    pub fn PenParameters(&self) -> ::windows::core::Result<InjectedInputPenParameters> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<InjectedInputPenParameters>::uninit();
...
impl InjectedInputTouchInfo {
    ...
    pub fn Contact(&self) -> ::windows::core::Result<InjectedInputRectangle> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<InjectedInputRectangle>::uninit();
    ...
    pub fn TouchParameters(&self) -> ::windows::core::Result<InjectedInputTouchParameters> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<InjectedInputTouchParameters>::uninit();
