...
impl windows_core::RuntimeType for IInputActivationListenerPreviewStatics {
    ...
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Windows.UI.Input.Preview.IInputActivationListenerPreviewStatics");
}
#[repr(C)]
#[doc(hidden)]
...
impl InputActivationListenerPreview {
        ...
        P0: windows_core::Param<super::super::WindowManagement::AppWindow>,
    {
        Self::IInputActivationListenerPreviewStatics(|this| unsafe {
            ...
            (windows_core::Interface::vtable(this).CreateForApplicationWindow)(windows_core::Interface::as_raw(this), window.param().abi(), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        })
    }
