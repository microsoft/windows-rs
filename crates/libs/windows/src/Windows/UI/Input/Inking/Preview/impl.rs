...
pub trait IPalmRejectionDelayZonePreview_Impl: Sized {}
#[cfg(feature = "implement_exclusive")]
...
#[cfg(feature = "implement_exclusive")]
impl IPalmRejectionDelayZonePreview_Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IPalmRejectionDelayZonePreview_Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IPalmRejectionDelayZonePreview_Vtbl {
...
pub trait IPalmRejectionDelayZonePreviewStatics_Impl: Sized {
...
#[cfg(all(feature = "Foundation", feature = "UI_Composition", feature = "implement_exclusive"))]
impl IPalmRejectionDelayZonePreviewStatics_Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IPalmRejectionDelayZonePreviewStatics_Impl, const BASE_OFFSET: isize, const IMPL_OFFSET: isize>() -> IPalmRejectionDelayZonePreviewStatics_Vtbl {
        unsafe extern "system" fn CreateForVisual<Impl: IPalmRejectionDelayZonePreviewStatics_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, inputpanelvisual: ::windows::core::RawPtr, inputpanelrect: super::super::super::super::Foundation::Rect, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
        ...
        unsafe extern "system" fn CreateForVisualWithViewportClip<Impl: IPalmRejectionDelayZonePreviewStatics_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, inputpanelvisual: ::windows::core::RawPtr, inputpanelrect: super::super::super::super::Foundation::Rect, viewportvisual: ::windows::core::RawPtr, viewportrect: super::super::super::super::Foundation::Rect, result__: *mut ::windows::core::RawPtr) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Impl;
