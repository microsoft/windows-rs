...
impl CoreIncrementalInkStroke {
    pub fn AppendInkPoints<P0>(&self, inkpoints: P0) -> windows_result::Result<super::super::super::super::Foundation::Rect>
    where
    ...
    pub fn CreateInkStroke(&self) -> windows_result::Result<super::InkStroke> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DrawingAttributes(&self) -> windows_result::Result<super::InkDrawingAttributes> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Create<P0>(drawingattributes: P0, pointtransform: windows_numerics::Matrix3x2) -> windows_result::Result<CoreIncrementalInkStroke>
    where
    ...
    fn ICoreIncrementalInkStrokeFactory<R, F: FnOnce(&ICoreIncrementalInkStrokeFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl CoreInkIndependentInputSource {
    #[cfg(feature = "UI_Core")]
    pub fn PointerEntering<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemovePointerEntering(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePointerEntering)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    #[cfg(feature = "UI_Core")]
    pub fn PointerHovering<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::super::Foundation::TypedEventHandler<CoreInkIndependentInputSource, super::super::super::Core::PointerEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemovePointerHovering(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePointerHovering)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    #[cfg(feature = "UI_Core")]
    pub fn PointerExiting<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::super::Foundation::TypedEventHandler<CoreInkIndependentInputSource, super::super::super::Core::PointerEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemovePointerExiting(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePointerExiting)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    #[cfg(feature = "UI_Core")]
    pub fn PointerPressing<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::super::Foundation::TypedEventHandler<CoreInkIndependentInputSource, super::super::super::Core::PointerEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemovePointerPressing(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePointerPressing)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    #[cfg(feature = "UI_Core")]
    pub fn PointerMoving<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::super::Foundation::TypedEventHandler<CoreInkIndependentInputSource, super::super::super::Core::PointerEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemovePointerMoving(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePointerMoving)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    #[cfg(feature = "UI_Core")]
    pub fn PointerReleasing<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::super::Foundation::TypedEventHandler<CoreInkIndependentInputSource, super::super::super::Core::PointerEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemovePointerReleasing(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn InkPresenter(&self) -> windows_result::Result<super::InkPresenter> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Core")]
    pub fn PointerCursor(&self) -> windows_result::Result<super::super::super::Core::CoreCursor> {
    ...
    pub fn Create<P0>(inkpresenter: P0) -> windows_result::Result<CoreInkIndependentInputSource>
    where
    ...
    fn ICoreInkIndependentInputSourceStatics<R, F: FnOnce(&ICoreInkIndependentInputSourceStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl CoreInkPresenterHost {
    ...
    pub fn RootVisual(&self) -> windows_result::Result<super::super::super::Composition::ContainerVisual> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Composition")]
    pub fn SetRootVisual<P0>(&self, value: P0) -> windows_result::Result<()>
    where
...
impl CoreWetStrokeUpdateEventArgs {
    pub fn NewInkPoints(&self) -> windows_result::Result<windows_collections::IVector<super::InkPoint>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Disposition(&self) -> windows_result::Result<CoreWetStrokeDisposition> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDisposition(&self, value: CoreWetStrokeDisposition) -> windows_result::Result<()> {
        let this = self;
...
impl CoreWetStrokeUpdateSource {
    pub fn WetStrokeStarting<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveWetStrokeStarting(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveWetStrokeStarting)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    pub fn WetStrokeContinuing<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::super::Foundation::TypedEventHandler<CoreWetStrokeUpdateSource, CoreWetStrokeUpdateEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemoveWetStrokeContinuing(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveWetStrokeContinuing)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    pub fn WetStrokeStopping<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::super::Foundation::TypedEventHandler<CoreWetStrokeUpdateSource, CoreWetStrokeUpdateEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemoveWetStrokeStopping(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveWetStrokeStopping)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    pub fn WetStrokeCompleted<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::super::Foundation::TypedEventHandler<CoreWetStrokeUpdateSource, CoreWetStrokeUpdateEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemoveWetStrokeCompleted(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveWetStrokeCompleted)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    pub fn WetStrokeCanceled<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::super::Foundation::TypedEventHandler<CoreWetStrokeUpdateSource, CoreWetStrokeUpdateEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemoveWetStrokeCanceled(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn Create<P0>(inkpresenter: P0) -> windows_result::Result<CoreWetStrokeUpdateSource>
    where
        P0: windows_core::Param<super::InkPresenter>,
    {
    ...
    fn ICoreWetStrokeUpdateSourceStatics<R, F: FnOnce(&ICoreWetStrokeUpdateSourceStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
