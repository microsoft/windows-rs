...
windows_core::imp::required_hierarchy!(InkAnalysisInkBullet, IInkAnalysisInkBullet, IInkAnalysisNode);
...
windows_core::imp::required_hierarchy!(InkAnalysisInkDrawing, IInkAnalysisInkDrawing, IInkAnalysisNode);
...
windows_core::imp::required_hierarchy!(InkAnalysisInkWord, IInkAnalysisInkWord, IInkAnalysisNode);
...
windows_core::imp::required_hierarchy!(InkAnalysisLine, IInkAnalysisLine, IInkAnalysisNode);
...
windows_core::imp::required_hierarchy!(InkAnalysisListItem, IInkAnalysisListItem, IInkAnalysisNode);
...
windows_core::imp::required_hierarchy!(InkAnalysisParagraph, IInkAnalysisNode, IInkAnalysisParagraph);
...
windows_core::imp::required_hierarchy!(InkAnalysisResult, IInkAnalysisResult);
...
windows_core::imp::required_hierarchy!(InkAnalysisRoot, IInkAnalysisNode, IInkAnalysisRoot);
...
windows_core::imp::required_hierarchy!(InkAnalysisWritingRegion, IInkAnalysisNode, IInkAnalysisWritingRegion);
...
windows_core::imp::required_hierarchy!(InkAnalyzer, IInkAnalyzer);
impl InkAnalyzer {
