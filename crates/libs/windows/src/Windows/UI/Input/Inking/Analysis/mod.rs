...
impl IInkAnalysisNode {
    ...
    pub fn Kind(&self) -> ::windows::core::Result<InkAnalysisNodeKind> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<InkAnalysisNodeKind>::uninit();
    ...
    pub fn BoundingRect(&self) -> ::windows::core::Result<super::super::super::super::Foundation::Rect> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<super::super::super::super::Foundation::Rect>::uninit();
...
impl InkAnalysisInkDrawing {
    ...
    pub fn DrawingKind(&self) -> ::windows::core::Result<InkAnalysisDrawingKind> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<InkAnalysisDrawingKind>::uninit();
...
impl InkAnalysisResult {
    ...
    pub fn Status(&self) -> ::windows::core::Result<InkAnalysisStatus> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<InkAnalysisStatus>::uninit();
