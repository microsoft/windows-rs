...
impl PalmRejectionDelayZonePreview {
    ...
    #[cfg(feature = "UI_Composition")]
    pub fn CreateForVisual<P0>(inputpanelvisual: P0, inputpanelrect: super::super::super::super::Foundation::Rect) -> windows_result::Result<PalmRejectionDelayZonePreview>
    where
    ...
    #[cfg(feature = "UI_Composition")]
    pub fn CreateForVisualWithViewportClip<P0, P2>(inputpanelvisual: P0, inputpanelrect: super::super::super::super::Foundation::Rect, viewportvisual: P2, viewportrect: super::super::super::super::Foundation::Rect) -> windows_result::Result<PalmRejectionDelayZonePreview>
    where
        P0: windows_core::Param<super::super::super::Composition::Visual>,
    ...
    fn IPalmRejectionDelayZonePreviewStatics<R, F: FnOnce(&IPalmRejectionDelayZonePreviewStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
