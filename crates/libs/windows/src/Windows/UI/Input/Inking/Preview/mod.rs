...
windows_core::imp::required_hierarchy!(PalmRejectionDelayZonePreview, super::super::super::super::Foundation::IClosable, IPalmRejectionDelayZonePreview, IPalmRejectionDelayZonePreviewStatics);
