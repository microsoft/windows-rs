...
impl IInkPointFactory {
    pub fn CreateInkPoint(&self, position: super::super::super::Foundation::Point, pressure: f32) -> windows_result::Result<InkPoint> {
        let this = self;
        unsafe {
...
pub trait IInkPointFactory_Impl: windows_core::IUnknownImpl {
    fn CreateInkPoint(&self, position: &super::super::super::Foundation::Point, pressure: f32) -> windows_result::Result<InkPoint>;
}
...
impl IInkPresenterRulerFactory {
    pub fn Create<P0>(&self, inkpresenter: P0) -> windows_result::Result<InkPresenterRuler>
    where
...
pub trait IInkPresenterRulerFactory_Impl: windows_core::IUnknownImpl {
    fn Create(&self, inkPresenter: windows_core::Ref<InkPresenter>) -> windows_result::Result<InkPresenterRuler>;
}
...
impl IInkPresenterStencil {
    pub fn Kind(&self) -> windows_result::Result<InkPresenterStencilKind> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsVisible(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsVisible(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsVisible)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn BackgroundColor(&self) -> windows_result::Result<super::super::Color> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetBackgroundColor(&self, value: super::super::Color) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetBackgroundColor)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ForegroundColor(&self) -> windows_result::Result<super::super::Color> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetForegroundColor(&self, value: super::super::Color) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetForegroundColor)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Transform(&self) -> windows_result::Result<windows_numerics::Matrix3x2> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTransform(&self, value: windows_numerics::Matrix3x2) -> windows_result::Result<()> {
        let this = self;
...
pub trait IInkPresenterStencil_Impl: windows_core::IUnknownImpl {
    fn Kind(&self) -> windows_result::Result<InkPresenterStencilKind>;
    fn IsVisible(&self) -> windows_result::Result<bool>;
    fn SetIsVisible(&self, value: bool) -> windows_result::Result<()>;
    fn BackgroundColor(&self) -> windows_result::Result<super::super::Color>;
    fn SetBackgroundColor(&self, value: &super::super::Color) -> windows_result::Result<()>;
    fn ForegroundColor(&self) -> windows_result::Result<super::super::Color>;
    fn SetForegroundColor(&self, value: &super::super::Color) -> windows_result::Result<()>;
    fn Transform(&self) -> windows_result::Result<windows_numerics::Matrix3x2>;
    fn SetTransform(&self, value: &windows_numerics::Matrix3x2) -> windows_result::Result<()>;
}
...
impl IInkRecognizerContainer {
    pub fn SetDefaultRecognizer<P0>(&self, recognizer: P0) -> windows_result::Result<()>
    where
    ...
    pub fn RecognizeAsync<P0>(&self, strokecollection: P0, recognitiontarget: InkRecognitionTarget) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<InkRecognitionResult>>>
    where
    ...
    pub fn GetRecognizers(&self) -> windows_result::Result<windows_collections::IVectorView<InkRecognizer>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IInkRecognizerContainer_Impl: windows_core::IUnknownImpl {
    fn SetDefaultRecognizer(&self, recognizer: windows_core::Ref<InkRecognizer>) -> windows_result::Result<()>;
    fn RecognizeAsync(&self, strokeCollection: windows_core::Ref<InkStrokeContainer>, recognitionTarget: InkRecognitionTarget) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<InkRecognitionResult>>>;
    fn GetRecognizers(&self) -> windows_result::Result<windows_collections::IVectorView<InkRecognizer>>;
}
...
impl IInkStrokeContainer {
    pub fn BoundingRect(&self) -> windows_result::Result<super::super::super::Foundation::Rect> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn AddStroke<P0>(&self, stroke: P0) -> windows_result::Result<()>
    where
    ...
    pub fn DeleteSelected(&self) -> windows_result::Result<super::super::super::Foundation::Rect> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MoveSelected(&self, translation: super::super::super::Foundation::Point) -> windows_result::Result<super::super::super::Foundation::Rect> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SelectWithPolyLine<P0>(&self, polyline: P0) -> windows_result::Result<super::super::super::Foundation::Rect>
    where
    ...
    pub fn SelectWithLine(&self, from: super::super::super::Foundation::Point, to: super::super::super::Foundation::Point) -> windows_result::Result<super::super::super::Foundation::Rect> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CopySelectedToClipboard(&self) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).CopySelectedToClipboard)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn PasteFromClipboard(&self, position: super::super::super::Foundation::Point) -> windows_result::Result<super::super::super::Foundation::Rect> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CanPasteFromClipboard(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn LoadAsync<P0>(&self, inputstream: P0) -> windows_result::Result<windows_future::IAsyncActionWithProgress<u64>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SaveAsync<P0>(&self, outputstream: P0) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<u32, u32>>
    where
    ...
    pub fn UpdateRecognitionResults<P0>(&self, recognitionresults: P0) -> windows_result::Result<()>
    where
    ...
    pub fn GetStrokes(&self) -> windows_result::Result<windows_collections::IVectorView<InkStroke>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetRecognitionResults(&self) -> windows_result::Result<windows_collections::IVectorView<InkRecognitionResult>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IInkStrokeContainer_Impl: windows_core::IUnknownImpl {
    fn BoundingRect(&self) -> windows_result::Result<super::super::super::Foundation::Rect>;
    fn AddStroke(&self, stroke: windows_core::Ref<InkStroke>) -> windows_result::Result<()>;
    fn DeleteSelected(&self) -> windows_result::Result<super::super::super::Foundation::Rect>;
    fn MoveSelected(&self, translation: &super::super::super::Foundation::Point) -> windows_result::Result<super::super::super::Foundation::Rect>;
    fn SelectWithPolyLine(&self, polyline: windows_core::Ref<windows_collections::IIterable<super::super::super::Foundation::Point>>) -> windows_result::Result<super::super::super::Foundation::Rect>;
    fn SelectWithLine(&self, from: &super::super::super::Foundation::Point, to: &super::super::super::Foundation::Point) -> windows_result::Result<super::super::super::Foundation::Rect>;
    fn CopySelectedToClipboard(&self) -> windows_result::Result<()>;
    fn PasteFromClipboard(&self, position: &super::super::super::Foundation::Point) -> windows_result::Result<super::super::super::Foundation::Rect>;
    fn CanPasteFromClipboard(&self) -> windows_result::Result<bool>;
    fn LoadAsync(&self, inputStream: windows_core::Ref<super::super::super::Storage::Streams::IInputStream>) -> windows_result::Result<windows_future::IAsyncActionWithProgress<u64>>;
    fn SaveAsync(&self, outputStream: windows_core::Ref<super::super::super::Storage::Streams::IOutputStream>) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<u32, u32>>;
    fn UpdateRecognitionResults(&self, recognitionResults: windows_core::Ref<windows_collections::IVectorView<InkRecognitionResult>>) -> windows_result::Result<()>;
    fn GetStrokes(&self) -> windows_result::Result<windows_collections::IVectorView<InkStroke>>;
    fn GetRecognitionResults(&self) -> windows_result::Result<windows_collections::IVectorView<InkRecognitionResult>>;
}
#[cfg(feature = "Storage_Streams")]
...
impl InkDrawingAttributes {
    ...
    pub fn Color(&self) -> windows_result::Result<super::super::Color> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetColor(&self, value: super::super::Color) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetColor)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn PenTip(&self) -> windows_result::Result<PenTipShape> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPenTip(&self, value: PenTipShape) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetPenTip)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Size(&self) -> windows_result::Result<super::super::super::Foundation::Size> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSize(&self, value: super::super::super::Foundation::Size) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSize)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IgnorePressure(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIgnorePressure(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIgnorePressure)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn FitToCurve(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetFitToCurve(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetFitToCurve)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn PenTipTransform(&self) -> windows_result::Result<windows_numerics::Matrix3x2> {
    ...
    pub fn SetPenTipTransform(&self, value: windows_numerics::Matrix3x2) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IInkDrawingAttributes2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetPenTipTransform)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn DrawAsHighlighter(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IInkDrawingAttributes2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDrawAsHighlighter(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IInkDrawingAttributes2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetDrawAsHighlighter)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Kind(&self) -> windows_result::Result<InkDrawingAttributesKind> {
    ...
    pub fn PencilProperties(&self) -> windows_result::Result<InkDrawingAttributesPencilProperties> {
        let this = &windows_core::Interface::cast::<IInkDrawingAttributes3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IgnoreTilt(&self) -> windows_result::Result<bool> {
    ...
    pub fn SetIgnoreTilt(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IInkDrawingAttributes4>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetIgnoreTilt)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ModelerAttributes(&self) -> windows_result::Result<InkModelerAttributes> {
    ...
    pub fn CreateForPencil() -> windows_result::Result<InkDrawingAttributes> {
    ...
    fn IInkDrawingAttributesStatics<R, F: FnOnce(&IInkDrawingAttributesStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl InkDrawingAttributesPencilProperties {
    pub fn Opacity(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOpacity(&self, value: f64) -> windows_result::Result<()> {
        let this = self;
...
impl InkInputConfiguration {
    pub fn IsPrimaryBarrelButtonInputEnabled(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsPrimaryBarrelButtonInputEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn IsEraserInputEnabled(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsEraserInputEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsEraserInputEnabled)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsPenHapticFeedbackEnabled(&self) -> windows_result::Result<bool> {
    ...
    pub fn SetIsPenHapticFeedbackEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IInkInputConfiguration2>(self)?;
...
impl InkInputProcessingConfiguration {
    pub fn Mode(&self) -> windows_result::Result<InkInputProcessingMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetMode(&self, value: InkInputProcessingMode) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn RightDragAction(&self) -> windows_result::Result<InkInputRightDragAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRightDragAction(&self, value: InkInputRightDragAction) -> windows_result::Result<()> {
        let this = self;
...
impl InkManager {
    ...
    pub fn Mode(&self) -> windows_result::Result<InkManipulationMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Mode)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn SetMode(&self, value: InkManipulationMode) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetMode)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ProcessPointerDown<P0>(&self, pointerpoint: P0) -> windows_result::Result<()>
    where
    ...
    pub fn ProcessPointerUpdate<P0>(&self, pointerpoint: P0) -> windows_result::Result<windows_core::IInspectable>
    where
        P0: windows_core::Param<super::PointerPoint>,
    {
        let this = self;
    ...
    pub fn ProcessPointerUp<P0>(&self, pointerpoint: P0) -> windows_result::Result<super::super::super::Foundation::Rect>
    where
        P0: windows_core::Param<super::PointerPoint>,
    {
        let this = self;
    ...
    pub fn SetDefaultDrawingAttributes<P0>(&self, drawingattributes: P0) -> windows_result::Result<()>
    where
    ...
    pub fn RecognizeAsync(&self, recognitiontarget: InkRecognitionTarget) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<InkRecognitionResult>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RecognizeAsync2<P0>(&self, strokecollection: P0, recognitiontarget: InkRecognitionTarget) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<InkRecognitionResult>>>
    where
        P0: windows_core::Param<InkStrokeContainer>,
    {
        let this = &windows_core::Interface::cast::<IInkRecognizerContainer>(self)?;
...
impl InkModelerAttributes {
    pub fn PredictionTime(&self) -> windows_result::Result<super::super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPredictionTime(&self, value: super::super::super::Foundation::TimeSpan) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetPredictionTime)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ScalingFactor(&self) -> windows_result::Result<f32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetScalingFactor(&self, value: f32) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetScalingFactor)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn UseVelocityBasedPressure(&self) -> windows_result::Result<bool> {
    ...
    pub fn SetUseVelocityBasedPressure(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IInkModelerAttributes2>(self)?;
...
impl InkPoint {
    pub fn Position(&self) -> windows_result::Result<super::super::super::Foundation::Point> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TiltX(&self) -> windows_result::Result<f32> {
    ...
    pub fn TiltY(&self) -> windows_result::Result<f32> {
        let this = &windows_core::Interface::cast::<IInkPoint2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateInkPoint(position: super::super::super::Foundation::Point, pressure: f32) -> windows_result::Result<InkPoint> {
        Self::IInkPointFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateInkPoint)(windows_core::Interface::as_raw(this), position, pressure, &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn CreateInkPointWithTiltAndTimestamp(position: super::super::super::Foundation::Point, pressure: f32, tiltx: f32, tilty: f32, timestamp: u64) -> windows_result::Result<InkPoint> {
    ...
    fn IInkPointFactory<R, F: FnOnce(&IInkPointFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<InkPoint, IInkPointFactory> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IInkPointFactory2<R, F: FnOnce(&IInkPointFactory2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl InkPresenter {
    pub fn IsInputEnabled(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsInputEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsInputEnabled)(windows_core::Interface::as_raw(this), value).ok() }
    }
    #[cfg(feature = "UI_Core")]
    pub fn InputDeviceTypes(&self) -> windows_result::Result<super::super::Core::CoreInputDeviceTypes> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Core")]
    pub fn SetInputDeviceTypes(&self, value: super::super::Core::CoreInputDeviceTypes) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetInputDeviceTypes)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn UnprocessedInput(&self) -> windows_result::Result<InkUnprocessedInput> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StrokeInput(&self) -> windows_result::Result<InkStrokeInput> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn InputProcessingConfiguration(&self) -> windows_result::Result<InkInputProcessingConfiguration> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StrokeContainer(&self) -> windows_result::Result<InkStrokeContainer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetStrokeContainer<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<InkStrokeContainer>,
    {
        let this = self;
    ...
    pub fn CopyDefaultDrawingAttributes(&self) -> windows_result::Result<InkDrawingAttributes> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UpdateDefaultDrawingAttributes<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<InkDrawingAttributes>,
    {
        let this = self;
    ...
    pub fn ActivateCustomDrying(&self) -> windows_result::Result<InkSynchronizer> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPredefinedConfiguration(&self, value: InkPresenterPredefinedConfiguration) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetPredefinedConfiguration)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn StrokesCollected<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveStrokesCollected(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveStrokesCollected)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    pub fn StrokesErased<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveStrokesErased(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveStrokesErased)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    pub fn HighContrastAdjustment(&self) -> windows_result::Result<InkHighContrastAdjustment> {
    ...
    pub fn SetHighContrastAdjustment(&self, value: InkHighContrastAdjustment) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IInkPresenter2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetHighContrastAdjustment)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn InputConfiguration(&self) -> windows_result::Result<InkInputConfiguration> {
...
impl InkPresenterProtractor {
    pub fn AreTickMarksVisible(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAreTickMarksVisible(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAreTickMarksVisible)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AreRaysVisible(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAreRaysVisible(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAreRaysVisible)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsCenterMarkerVisible(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsCenterMarkerVisible(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsCenterMarkerVisible)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsAngleReadoutVisible(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsAngleReadoutVisible(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsAngleReadoutVisible)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn IsResizable(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsResizable(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetIsResizable)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Radius(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRadius(&self, value: f64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetRadius)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn AccentColor(&self) -> windows_result::Result<super::super::Color> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetAccentColor(&self, value: super::super::Color) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetAccentColor)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Create<P0>(inkpresenter: P0) -> windows_result::Result<InkPresenterProtractor>
    where
        P0: windows_core::Param<InkPresenter>,
    {
    ...
    fn IInkPresenterProtractorFactory<R, F: FnOnce(&IInkPresenterProtractorFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl InkPresenterRuler {
    pub fn Length(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetLength(&self, value: f64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetLength)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Width(&self) -> windows_result::Result<f64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetWidth(&self, value: f64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn IsCompassVisible(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<IInkPresenterRuler2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsCompassVisible(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IInkPresenterRuler2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetIsCompassVisible)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Create<P0>(inkpresenter: P0) -> windows_result::Result<InkPresenterRuler>
    where
        P0: windows_core::Param<InkPresenter>,
    {
    ...
    fn IInkPresenterRulerFactory<R, F: FnOnce(&IInkPresenterRulerFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl InkRecognitionResult {
    ...
    pub fn GetTextCandidates(&self) -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl InkStroke {
    pub fn DrawingAttributes(&self) -> windows_result::Result<InkDrawingAttributes> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDrawingAttributes<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<InkDrawingAttributes>,
    {
        let this = self;
    ...
    pub fn Selected(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSelected(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetSelected)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Recognized(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetRenderingSegments(&self) -> windows_result::Result<windows_collections::IVectorView<InkStrokeRenderingSegment>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Clone(&self) -> windows_result::Result<InkStroke> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PointTransform(&self) -> windows_result::Result<windows_numerics::Matrix3x2> {
    ...
    pub fn SetPointTransform(&self, value: windows_numerics::Matrix3x2) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<IInkStroke2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetPointTransform)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn GetInkPoints(&self) -> windows_result::Result<windows_collections::IVectorView<InkPoint>> {
        let this = &windows_core::Interface::cast::<IInkStroke2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StrokeStartedTime(&self) -> windows_result::Result<super::super::super::Foundation::IReference<super::super::super::Foundation::DateTime>> {
        let this = &windows_core::Interface::cast::<IInkStroke3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetStrokeStartedTime<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    pub fn StrokeDuration(&self) -> windows_result::Result<super::super::super::Foundation::IReference<super::super::super::Foundation::TimeSpan>> {
        let this = &windows_core::Interface::cast::<IInkStroke3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetStrokeDuration<P0>(&self, value: P0) -> windows_result::Result<()>
    where
...
impl InkStrokeBuilder {
    ...
    pub fn BeginStroke<P0>(&self, pointerpoint: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::PointerPoint>,
    {
        let this = self;
    ...
    pub fn AppendToStroke<P0>(&self, pointerpoint: P0) -> windows_result::Result<super::PointerPoint>
    where
        P0: windows_core::Param<super::PointerPoint>,
    {
        let this = self;
    ...
    pub fn EndStroke<P0>(&self, pointerpoint: P0) -> windows_result::Result<InkStroke>
    where
        P0: windows_core::Param<super::PointerPoint>,
    {
        let this = self;
    ...
    pub fn CreateStroke<P0>(&self, points: P0) -> windows_result::Result<InkStroke>
    where
        P0: windows_core::Param<windows_collections::IIterable<super::super::super::Foundation::Point>>,
    {
        let this = self;
    ...
    pub fn CreateStrokeFromInkPoints<P0>(&self, inkpoints: P0, transform: windows_numerics::Matrix3x2) -> windows_result::Result<InkStroke>
    where
    ...
    pub fn CreateStrokeFromInkPoints2<P0, P2, P3>(&self, inkpoints: P0, transform: windows_numerics::Matrix3x2, strokestartedtime: P2, strokeduration: P3) -> windows_result::Result<InkStroke>
    where
        P0: windows_core::Param<windows_collections::IIterable<InkPoint>>,
...
impl InkStrokeContainer {
    ...
    pub fn AddStrokes<P0>(&self, strokes: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SaveWithFormatAsync<P0>(&self, outputstream: P0, inkpersistenceformat: InkPersistenceFormat) -> windows_result::Result<windows_future::IAsyncOperationWithProgress<u32, u32>>
    where
        P0: windows_core::Param<super::super::super::Storage::Streams::IOutputStream>,
    {
    ...
    pub fn GetStrokeById(&self, id: u32) -> windows_result::Result<InkStroke> {
        let this = &windows_core::Interface::cast::<IInkStrokeContainer3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl InkStrokeInput {
    #[cfg(feature = "UI_Core")]
    pub fn StrokeStarted<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveStrokeStarted(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveStrokeStarted)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    #[cfg(feature = "UI_Core")]
    pub fn StrokeContinued<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::Foundation::TypedEventHandler<InkStrokeInput, super::super::Core::PointerEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemoveStrokeContinued(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveStrokeContinued)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    #[cfg(feature = "UI_Core")]
    pub fn StrokeEnded<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::Foundation::TypedEventHandler<InkStrokeInput, super::super::Core::PointerEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemoveStrokeEnded(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveStrokeEnded)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    #[cfg(feature = "UI_Core")]
    pub fn StrokeCanceled<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::Foundation::TypedEventHandler<InkStrokeInput, super::super::Core::PointerEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemoveStrokeCanceled(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveStrokeCanceled)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    pub fn InkPresenter(&self) -> windows_result::Result<InkPresenter> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl InkStrokeRenderingSegment {
    ...
    pub fn BezierControlPoint1(&self) -> windows_result::Result<super::super::super::Foundation::Point> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn BezierControlPoint2(&self) -> windows_result::Result<super::super::super::Foundation::Point> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl InkStrokesCollectedEventArgs {
    pub fn Strokes(&self) -> windows_result::Result<windows_collections::IVectorView<InkStroke>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl InkSynchronizer {
    pub fn BeginDry(&self) -> windows_result::Result<windows_collections::IVectorView<InkStroke>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EndDry(&self) -> windows_result::Result<()> {
        let this = self;
...
impl InkUnprocessedInput {
    #[cfg(feature = "UI_Core")]
    pub fn PointerEntered<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemovePointerEntered(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePointerEntered)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    #[cfg(feature = "UI_Core")]
    pub fn PointerHovered<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::Foundation::TypedEventHandler<InkUnprocessedInput, super::super::Core::PointerEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemovePointerHovered(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePointerHovered)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    #[cfg(feature = "UI_Core")]
    pub fn PointerExited<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::Foundation::TypedEventHandler<InkUnprocessedInput, super::super::Core::PointerEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemovePointerExited(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn RemovePointerPressed(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn RemovePointerMoved(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn RemovePointerReleased(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemovePointerReleased)(windows_core::Interface::as_raw(this), cookie).ok() }
    }
    #[cfg(feature = "UI_Core")]
    pub fn PointerLost<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
        P0: windows_core::Param<super::super::super::Foundation::TypedEventHandler<InkUnprocessedInput, super::super::Core::PointerEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemovePointerLost(&self, cookie: i64) -> windows_result::Result<()> {
        let this = self;
...
impl PenAndInkSettings {
    pub fn IsHandwritingDirectlyIntoTextFieldEnabled(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PenHandedness(&self) -> windows_result::Result<PenHandedness> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HandwritingLineHeight(&self) -> windows_result::Result<HandwritingLineHeight> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FontFamilyName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UserConsentsToHandwritingTelemetryCollection(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsTouchHandwritingEnabled(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPenHandedness(&self, value: PenHandedness) -> windows_result::Result<()> {
    ...
    pub fn GetDefault() -> windows_result::Result<PenAndInkSettings> {
        Self::IPenAndInkSettingsStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefault)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IPenAndInkSettingsStatics<R, F: FnOnce(&IPenAndInkSettingsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
