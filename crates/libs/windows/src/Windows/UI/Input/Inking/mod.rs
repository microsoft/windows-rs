...
impl IInkRecognizerContainer {
    ...
    pub fn RecognizeAsync<P0>(&self, strokecollection: P0, recognitiontarget: InkRecognitionTarget) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<InkRecognitionResult>>>
    where
...
pub trait IInkRecognizerContainer_Impl: windows_core::IUnknownImpl {
    ...
    fn RecognizeAsync(&self, strokeCollection: windows_core::Ref<'_, InkStrokeContainer>, recognitionTarget: InkRecognitionTarget) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<InkRecognitionResult>>>;
...
impl IInkStrokeContainer {
    ...
    pub fn LoadAsync<P0>(&self, inputstream: P0) -> windows_core::Result<windows_async::IAsyncActionWithProgress<u64>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SaveAsync<P0>(&self, outputstream: P0) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<u32, u32>>
    where
...
pub trait IInkStrokeContainer_Impl: windows_core::IUnknownImpl {
    ...
    fn SelectWithPolyLine(&self, polyline: windows_core::Ref<'_, windows_collections::IIterable<super::super::super::Foundation::Point>>) -> windows_core::Result<super::super::super::Foundation::Rect>;
    ...
    fn LoadAsync(&self, inputStream: windows_core::Ref<'_, super::super::super::Storage::Streams::IInputStream>) -> windows_core::Result<windows_async::IAsyncActionWithProgress<u64>>;
    fn SaveAsync(&self, outputStream: windows_core::Ref<'_, super::super::super::Storage::Streams::IOutputStream>) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<u32, u32>>;
...
impl InkManager {
    ...
    pub fn RecognizeAsync(&self, recognitiontarget: InkRecognitionTarget) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<InkRecognitionResult>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RecognizeAsync2<P0>(&self, strokecollection: P0, recognitiontarget: InkRecognitionTarget) -> windows_core::Result<windows_async::IAsyncOperation<windows_collections::IVectorView<InkRecognitionResult>>>
    where
        P0: windows_core::Param<InkStrokeContainer>,
    {
        let this = &windows_core::Interface::cast::<IInkRecognizerContainer>(self)?;
...
impl InkStrokeContainer {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn SaveWithFormatAsync<P0>(&self, outputstream: P0, inkpersistenceformat: InkPersistenceFormat) -> windows_core::Result<windows_async::IAsyncOperationWithProgress<u32, u32>>
    where
        P0: windows_core::Param<super::super::super::Storage::Streams::IOutputStream>,
    {
