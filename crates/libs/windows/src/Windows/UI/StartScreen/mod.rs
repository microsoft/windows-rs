...
impl JumpList {
    pub fn Items(&self) -> windows_result::Result<windows_collections::IVector<JumpListItem>> {
        let this = self;
        unsafe {
    ...
    pub fn SystemGroupKind(&self) -> windows_result::Result<JumpListSystemGroupKind> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSystemGroupKind(&self, value: JumpListSystemGroupKind) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn LoadCurrentAsync() -> windows_result::Result<windows_future::IAsyncOperation<JumpList>> {
    ...
    fn IJumpListStatics<R, F: FnOnce(&IJumpListStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl JumpListItem {
    pub fn Kind(&self) -> windows_result::Result<JumpListItemKind> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GroupName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetGroupName(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn Logo(&self) -> windows_result::Result<super::super::Foundation::Uri> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateWithArguments(arguments: &windows_core::HSTRING, displayname: &windows_core::HSTRING) -> windows_result::Result<JumpListItem> {
    ...
    pub fn CreateSeparator() -> windows_result::Result<JumpListItem> {
        Self::IJumpListItemStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IJumpListItemStatics<R, F: FnOnce(&IJumpListItemStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl SecondaryTile {
    ...
    pub fn SetTileId(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetArguments(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetShortName(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn ShortName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSmallLogo<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn SmallLogo(&self) -> windows_result::Result<super::super::Foundation::Uri> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetWideLogo<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn WideLogo(&self) -> windows_result::Result<super::super::Foundation::Uri> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetLockScreenBadgeLogo<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn LockScreenBadgeLogo(&self) -> windows_result::Result<super::super::Foundation::Uri> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetLockScreenDisplayBadgeAndTileText(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn LockScreenDisplayBadgeAndTileText(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTileOptions(&self, value: TileOptions) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetTileOptions)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn TileOptions(&self) -> windows_result::Result<TileOptions> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetForegroundText(&self, value: ForegroundText) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetForegroundText)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ForegroundText(&self) -> windows_result::Result<ForegroundText> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestCreateAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestCreateAsyncWithPoint(&self, invocationpoint: super::super::Foundation::Point) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestCreateAsyncWithRect(&self, selection: super::super::Foundation::Rect) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn RequestCreateAsyncWithRectAndPlacement(&self, selection: super::super::Foundation::Rect, preferredplacement: super::Popups::Placement) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestDeleteAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestDeleteAsyncWithPoint(&self, invocationpoint: super::super::Foundation::Point) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestDeleteAsyncWithRect(&self, selection: super::super::Foundation::Rect) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn RequestDeleteAsyncWithRectAndPlacement(&self, selection: super::super::Foundation::Rect, preferredplacement: super::Popups::Placement) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UpdateAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPhoneticName(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
    ...
    pub fn PhoneticName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = &windows_core::Interface::cast::<ISecondaryTile2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn VisualElements(&self) -> windows_result::Result<SecondaryTileVisualElements> {
        let this = &windows_core::Interface::cast::<ISecondaryTile2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetRoamingEnabled(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<ISecondaryTile2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetRoamingEnabled)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn RoamingEnabled(&self) -> windows_result::Result<bool> {
        let this = &windows_core::Interface::cast::<ISecondaryTile2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn VisualElementsRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveVisualElementsRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<ISecondaryTile2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RemoveVisualElementsRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn CreateTile<P5>(tileid: &windows_core::HSTRING, shortname: &windows_core::HSTRING, displayname: &windows_core::HSTRING, arguments: &windows_core::HSTRING, tileoptions: TileOptions, logoreference: P5) -> windows_result::Result<SecondaryTile>
    where
    ...
    pub fn CreateWideTile<P5, P6>(tileid: &windows_core::HSTRING, shortname: &windows_core::HSTRING, displayname: &windows_core::HSTRING, arguments: &windows_core::HSTRING, tileoptions: TileOptions, logoreference: P5, widelogoreference: P6) -> windows_result::Result<SecondaryTile>
    where
        P5: windows_core::Param<super::super::Foundation::Uri>,
    ...
    pub fn CreateWithId(tileid: &windows_core::HSTRING) -> windows_result::Result<SecondaryTile> {
        Self::ISecondaryTileFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateMinimalTile<P3>(tileid: &windows_core::HSTRING, displayname: &windows_core::HSTRING, arguments: &windows_core::HSTRING, square150x150logo: P3, desiredsize: TileSize) -> windows_result::Result<SecondaryTile>
    where
    ...
    pub fn Exists(tileid: &windows_core::HSTRING) -> windows_result::Result<bool> {
    ...
    pub fn FindAllAsync() -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<SecondaryTile>>> {
        Self::ISecondaryTileStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAllForApplicationAsync(applicationid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<SecondaryTile>>> {
        Self::ISecondaryTileStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FindAllForPackageAsync() -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<SecondaryTile>>> {
        Self::ISecondaryTileStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn ISecondaryTileFactory<R, F: FnOnce(&ISecondaryTileFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SecondaryTile, ISecondaryTileFactory> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ISecondaryTileFactory2<R, F: FnOnce(&ISecondaryTileFactory2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<SecondaryTile, ISecondaryTileFactory2> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ISecondaryTileStatics<R, F: FnOnce(&ISecondaryTileStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl SecondaryTileVisualElements {
    ...
    pub fn Square30x30Logo(&self) -> windows_result::Result<super::super::Foundation::Uri> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSquare70x70Logo<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn Square70x70Logo(&self) -> windows_result::Result<super::super::Foundation::Uri> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSquare150x150Logo<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn Square150x150Logo(&self) -> windows_result::Result<super::super::Foundation::Uri> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetWide310x150Logo<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn Wide310x150Logo(&self) -> windows_result::Result<super::super::Foundation::Uri> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSquare310x310Logo<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
        let this = self;
    ...
    pub fn Square310x310Logo(&self) -> windows_result::Result<super::super::Foundation::Uri> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetShowNameOnSquare150x150Logo(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetShowNameOnSquare150x150Logo)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ShowNameOnSquare150x150Logo(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetShowNameOnWide310x150Logo(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetShowNameOnWide310x150Logo)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ShowNameOnWide310x150Logo(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetShowNameOnSquare310x310Logo(&self, value: bool) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetShowNameOnSquare310x310Logo)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ShowNameOnSquare310x310Logo(&self) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSquare71x71Logo<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
    ...
    pub fn Square71x71Logo(&self) -> windows_result::Result<super::super::Foundation::Uri> {
        let this = &windows_core::Interface::cast::<ISecondaryTileVisualElements2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetSquare44x44Logo<P0>(&self, value: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::super::Foundation::Uri>,
    {
    ...
    pub fn Square44x44Logo(&self) -> windows_result::Result<super::super::Foundation::Uri> {
        let this = &windows_core::Interface::cast::<ISecondaryTileVisualElements3>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn MixedRealityModel(&self) -> windows_result::Result<TileMixedRealityModel> {
...
impl StartScreenManager {
    ...
    #[cfg(feature = "ApplicationModel_Core")]
    pub fn SupportsAppListEntry<P0>(&self, applistentry: P0) -> windows_result::Result<bool>
    where
    ...
    #[cfg(feature = "ApplicationModel_Core")]
    pub fn ContainsAppListEntryAsync<P0>(&self, applistentry: P0) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<super::super::ApplicationModel::Core::AppListEntry>,
    {
        let this = self;
    ...
    #[cfg(feature = "ApplicationModel_Core")]
    pub fn RequestAddAppListEntryAsync<P0>(&self, applistentry: P0) -> windows_result::Result<windows_future::IAsyncOperation<bool>>
    where
        P0: windows_core::Param<super::super::ApplicationModel::Core::AppListEntry>,
    {
        let this = self;
    ...
    pub fn ContainsSecondaryTileAsync(&self, tileid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
    ...
    pub fn TryRemoveSecondaryTileAsync(&self, tileid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<bool>> {
        let this = &windows_core::Interface::cast::<IStartScreenManager2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDefault() -> windows_result::Result<StartScreenManager> {
    ...
    #[cfg(feature = "System")]
    pub fn GetForUser<P0>(user: P0) -> windows_result::Result<StartScreenManager>
    where
    ...
    fn IStartScreenManagerStatics<R, F: FnOnce(&IStartScreenManagerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl TileMixedRealityModel {
    ...
    #[cfg(feature = "Perception_Spatial")]
    pub fn SetBoundingBox<P0>(&self, value: P0) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Perception_Spatial")]
    pub fn BoundingBox(&self) -> windows_result::Result<super::super::Foundation::IReference<super::super::Perception::Spatial::SpatialBoundingBox>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetActivationBehavior(&self, value: TileMixedRealityModelActivationBehavior) -> windows_result::Result<()> {
    ...
    pub fn ActivationBehavior(&self) -> windows_result::Result<TileMixedRealityModelActivationBehavior> {
        let this = &windows_core::Interface::cast::<ITileMixedRealityModel2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VisualElementsRequest {
    ...
    pub fn AlternateVisualElements(&self) -> windows_result::Result<windows_collections::IVectorView<SecondaryTileVisualElements>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDeferral(&self) -> windows_result::Result<VisualElementsRequestDeferral> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VisualElementsRequestedEventArgs {
    pub fn Request(&self) -> windows_result::Result<VisualElementsRequest> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
