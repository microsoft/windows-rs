...
impl JumpList {
    ...
    pub fn SystemGroupKind(&self) -> ::windows::core::Result<JumpListSystemGroupKind> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<JumpListSystemGroupKind>::uninit();
...
impl JumpListItem {
    ...
    pub fn Kind(&self) -> ::windows::core::Result<JumpListItemKind> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<JumpListItemKind>::uninit();
...
impl SecondaryTile {
    ...
    pub fn TileOptions(&self) -> ::windows::core::Result<TileOptions> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<TileOptions>::uninit();
    ...
    pub fn ForegroundText(&self) -> ::windows::core::Result<ForegroundText> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<ForegroundText>::uninit();
...
impl TileMixedRealityModel {
    ...
    pub fn ActivationBehavior(&self) -> ::windows::core::Result<TileMixedRealityModelActivationBehavior> {
        let this = &::windows::core::Interface::cast::<ITileMixedRealityModel2>(self)?;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<TileMixedRealityModelActivationBehavior>::uninit();
