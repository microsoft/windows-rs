...
impl RemoteAutomationClientSession {
    ...
    pub fn CreateWindowAsync<P2>(&self, remotewindowid: u64, remoteprocessid: u32, parentautomationelement: P2) -> windows_core::Result<windows_async::IAsyncOperation<RemoteAutomationWindow>>
    where
...
impl RemoteAutomationWindow {
    ...
    pub fn UnregisterAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
