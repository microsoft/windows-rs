...
impl AutomationRemoteOperationResult {
    pub fn Status(&self) -> windows_result::Result<AutomationRemoteOperationStatus> {
        let this = self;
        unsafe {
    ...
    pub fn ErrorLocation(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn HasOperand(&self, operandid: AutomationRemoteOperationOperandId) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetOperand(&self, operandid: AutomationRemoteOperationOperandId) -> windows_result::Result<windows_core::IInspectable> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl CoreAutomationRegistrar {
    pub fn RegisterAnnotationType(guid: windows_core::GUID) -> windows_result::Result<AutomationAnnotationTypeRegistration> {
    ...
    pub fn UnregisterAnnotationType(registration: AutomationAnnotationTypeRegistration) -> windows_result::Result<()> {
    ...
    fn ICoreAutomationRegistrarStatics<R, F: FnOnce(&ICoreAutomationRegistrarStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl CoreAutomationRemoteOperation {
    ...
    pub fn IsOpcodeSupported(&self, opcode: u32) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ImportElement<P1>(&self, operandid: AutomationRemoteOperationOperandId, element: P1) -> windows_result::Result<()>
    where
    ...
    pub fn ImportTextRange<P1>(&self, operandid: AutomationRemoteOperationOperandId, textrange: P1) -> windows_result::Result<()>
    where
    ...
    pub fn AddToResults(&self, operandid: AutomationRemoteOperationOperandId) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).AddToResults)(windows_core::Interface::as_raw(this), operandid).ok() }
    }
    pub fn Execute(&self, bytecodebuffer: &[u8]) -> windows_result::Result<AutomationRemoteOperationResult> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ImportConnectionBoundObject<P1>(&self, operandid: AutomationRemoteOperationOperandId, connectionboundobject: P1) -> windows_result::Result<()>
    where
...
impl CoreAutomationRemoteOperationContext {
    pub fn GetOperand(&self, id: AutomationRemoteOperationOperandId) -> windows_result::Result<windows_core::IInspectable> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOperand<P1>(&self, id: AutomationRemoteOperationOperandId, operand: P1) -> windows_result::Result<()>
    where
    ...
    pub fn SetOperand2<P1>(&self, id: AutomationRemoteOperationOperandId, operand: P1, operandinterfaceid: windows_core::GUID) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::IInspectable>,
    {
        let this = self;
...
impl ICoreAutomationRemoteOperationExtensionProvider {
    pub fn CallExtension<P1>(&self, extensionid: windows_core::GUID, context: P1, operandids: &[AutomationRemoteOperationOperandId]) -> windows_result::Result<()>
    where
    ...
    pub fn IsExtensionSupported(&self, extensionid: windows_core::GUID) -> windows_result::Result<bool> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ICoreAutomationRemoteOperationExtensionProvider_Impl: windows_core::IUnknownImpl {
    fn CallExtension(&self, extensionId: &windows_core::GUID, context: windows_core::Ref<CoreAutomationRemoteOperationContext>, operandIds: &[AutomationRemoteOperationOperandId]) -> windows_result::Result<()>;
    fn IsExtensionSupported(&self, extensionId: &windows_core::GUID) -> windows_result::Result<bool>;
}
...
impl RemoteAutomationClientSession {
    ...
    pub fn CreateWindowAsync<P2>(&self, remotewindowid: u64, remoteprocessid: u32, parentautomationelement: P2) -> windows_result::Result<windows_future::IAsyncOperation<RemoteAutomationWindow>>
    where
    ...
    pub fn SessionId(&self) -> windows_result::Result<windows_core::GUID> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ConnectionRequested<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveConnectionRequested(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn CreateInstance(name: &windows_core::HSTRING) -> windows_result::Result<RemoteAutomationClientSession> {
    ...
    pub fn CreateInstance2(name: &windows_core::HSTRING, sessionid: windows_core::GUID) -> windows_result::Result<RemoteAutomationClientSession> {
        Self::IRemoteAutomationClientSessionFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IRemoteAutomationClientSessionFactory<R, F: FnOnce(&IRemoteAutomationClientSessionFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl RemoteAutomationConnectionRequestedEventArgs {
    pub fn LocalPipeName(&self) -> windows_result::Result<windows_core::HSTRING> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RemoteProcessId(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl RemoteAutomationServer {
    pub fn ReportSession(sessionid: windows_core::GUID) -> windows_result::Result<()> {
    ...
    fn IRemoteAutomationServerStatics<R, F: FnOnce(&IRemoteAutomationServerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl RemoteAutomationWindow {
    pub fn AutomationProvider(&self) -> windows_result::Result<windows_core::IInspectable> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UnregisterAsync(&self) -> windows_result::Result<windows_future::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
