...
windows_core::imp::required_hierarchy!(AutomationRemoteOperationResult, IAutomationRemoteOperationResult);
...
windows_core::imp::required_hierarchy!(CoreAutomationRemoteOperation, ICoreAutomationRemoteOperation, ICoreAutomationRemoteOperation2);
...
windows_core::imp::required_hierarchy!(CoreAutomationRemoteOperationContext, ICoreAutomationRemoteOperationContext);
...
windows_core::imp::required_hierarchy!(RemoteAutomationClientSession, IRemoteAutomationClientSession, IRemoteAutomationClientSessionFactory);
...
windows_core::imp::required_hierarchy!(RemoteAutomationConnectionRequestedEventArgs, IRemoteAutomationConnectionRequestedEventArgs);
...
windows_core::imp::required_hierarchy!(RemoteAutomationDisconnectedEventArgs, IRemoteAutomationDisconnectedEventArgs);
...
windows_core::imp::required_hierarchy!(RemoteAutomationWindow, IRemoteAutomationWindow);
