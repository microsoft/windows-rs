...
windows_core::imp::required_hierarchy!(AutomationConnection, IAutomationConnection);
...
windows_core::imp::required_hierarchy!(AutomationConnectionBoundObject, IAutomationConnectionBoundObject);
...
windows_core::imp::required_hierarchy!(AutomationElement, IAutomationElement);
...
windows_core::imp::required_hierarchy!(AutomationTextRange, IAutomationTextRange);
