...
windows_core::imp::required_hierarchy!(AccountsSettingsPane, IAccountsSettingsPane, IAccountsSettingsPaneStatics, IAccountsSettingsPaneStatics2, IAccountsSettingsPaneStatics3);
...
windows_core::imp::required_hierarchy!(AccountsSettingsPaneCommandsRequestedEventArgs, IAccountsSettingsPaneCommandsRequestedEventArgs, IAccountsSettingsPaneCommandsRequestedEventArgs2);
...
windows_core::imp::required_hierarchy!(AccountsSettingsPaneEventDeferral, IAccountsSettingsPaneEventDeferral);
...
windows_core::imp::required_hierarchy!(CredentialCommand, ICredentialCommand, ICredentialCommandFactory);
...
#[cfg(feature = "UI_Popups")]
windows_core::imp::required_hierarchy!(SettingsCommand, ISettingsCommandFactory, ISettingsCommandStatics, super::Popups::IUICommand);
#[cfg(feature = "UI_Popups")]
...
#[cfg(feature = "deprecated")]
windows_core::imp::required_hierarchy!(SettingsPane, ISettingsPane, ISettingsPaneStatics);
#[cfg(feature = "deprecated")]
impl SettingsPane {
    #[cfg(feature = "deprecated")]
...
#[cfg(feature = "deprecated")]
windows_core::imp::required_hierarchy!(SettingsPaneCommandsRequest, ISettingsPaneCommandsRequest);
#[cfg(feature = "deprecated")]
...
#[cfg(feature = "deprecated")]
windows_core::imp::required_hierarchy!(SettingsPaneCommandsRequestedEventArgs, ISettingsPaneCommandsRequestedEventArgs);
#[cfg(feature = "deprecated")]
...
windows_core::imp::required_hierarchy!(WebAccountCommand, IWebAccountCommand, IWebAccountCommandFactory);
...
windows_core::imp::required_hierarchy!(WebAccountInvokedArgs, IWebAccountInvokedArgs);
...
windows_core::imp::required_hierarchy!(WebAccountProviderCommand, IWebAccountProviderCommand, IWebAccountProviderCommandFactory);
