...
windows_core::imp::required_hierarchy!(AccessibilitySettings, IAccessibilitySettings);
...
windows_core::imp::required_hierarchy!(ActivationViewSwitcher, IActivationViewSwitcher);
...
windows_core::imp::required_hierarchy!(ApplicationView, IApplicationView, IApplicationView2, IApplicationView3, IApplicationView4, IApplicationView7, IApplicationView9, IApplicationViewFullscreenStatics, IApplicationViewInteropStatics, IApplicationViewStatics, IApplicationViewStatics2, IApplicationViewStatics3, IApplicationViewStatics4, IApplicationViewWithContext);
...
windows_core::imp::required_hierarchy!(ApplicationViewConsolidatedEventArgs, IApplicationViewConsolidatedEventArgs, IApplicationViewConsolidatedEventArgs2);
...
windows_core::imp::required_hierarchy!(ApplicationViewScaling, IApplicationViewScaling, IApplicationViewScalingStatics);
...
windows_core::imp::required_hierarchy!(ApplicationViewTitleBar, IApplicationViewTitleBar);
...
windows_core::imp::required_hierarchy!(ApplicationViewTransferContext, IApplicationViewTransferContext, IApplicationViewTransferContextStatics);
...
windows_core::imp::required_hierarchy!(InputPane, IInputPane, IInputPane2, IInputPaneControl, IInputPaneStatics, IInputPaneStatics2);
impl InputPane {
...
windows_core::imp::required_hierarchy!(InputPaneVisibilityEventArgs, IInputPaneVisibilityEventArgs);
...
windows_core::imp::required_hierarchy!(StatusBar, IStatusBar, IStatusBarStatics);
impl StatusBar {
...
windows_core::imp::required_hierarchy!(StatusBarProgressIndicator, IStatusBarProgressIndicator);
...
windows_core::imp::required_hierarchy!(UISettings, IUISettings, IUISettings2, IUISettings3, IUISettings4, IUISettings5, IUISettings6);
impl UISettings {
    pub fn new() -> windows_core::Result<Self> {
        Self::IActivationFactory(|f| f.ActivateInstance::<Self>())
    }
...
windows_core::imp::required_hierarchy!(UISettingsAnimationsEnabledChangedEventArgs, IUISettingsAnimationsEnabledChangedEventArgs);
...
windows_core::imp::required_hierarchy!(UISettingsAutoHideScrollBarsChangedEventArgs, IUISettingsAutoHideScrollBarsChangedEventArgs);
...
windows_core::imp::required_hierarchy!(UISettingsMessageDurationChangedEventArgs, IUISettingsMessageDurationChangedEventArgs);
...
windows_core::imp::required_hierarchy!(UIViewSettings, IUIViewSettings, IUIViewSettingsStatics);
impl UIViewSettings {
...
windows_core::imp::required_hierarchy!(ViewModePreferences, IViewModePreferences, IViewModePreferencesStatics);
