...
impl ActivationViewSwitcher {
    pub fn ShowAsStandaloneAsync(&self, viewid: i32) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowAsStandaloneWithSizePreferenceAsync(&self, viewid: i32, sizepreference: ViewSizePreference) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ApplicationView {
    ...
    pub fn TryEnterViewModeAsync(&self, viewmode: ApplicationViewMode) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
        let this = &windows_core::Interface::cast::<IApplicationView4>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryEnterViewModeWithPreferencesAsync<P1>(&self, viewmode: ApplicationViewMode, viewmodepreferences: P1) -> windows_core::Result<windows_async::IAsyncOperation<bool>>
    where
    ...
    pub fn TryConsolidateAsync(&self) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
        let this = &windows_core::Interface::cast::<IApplicationView4>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ApplicationViewSwitcher {
    ...
    pub fn TryShowAsStandaloneAsync(viewid: i32) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
    ...
    pub fn TryShowAsStandaloneWithSizePreferenceAsync(viewid: i32, sizepreference: ViewSizePreference) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
        Self::IApplicationViewSwitcherStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryShowAsStandaloneWithAnchorViewAndSizePreferenceAsync(viewid: i32, sizepreference: ViewSizePreference, anchorviewid: i32, anchorsizepreference: ViewSizePreference) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
        Self::IApplicationViewSwitcherStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SwitchAsync(viewid: i32) -> windows_core::Result<windows_async::IAsyncAction> {
        Self::IApplicationViewSwitcherStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SwitchFromViewAsync(toviewid: i32, fromviewid: i32) -> windows_core::Result<windows_async::IAsyncAction> {
        Self::IApplicationViewSwitcherStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SwitchFromViewWithOptionsAsync(toviewid: i32, fromviewid: i32, options: ApplicationViewSwitchingOptions) -> windows_core::Result<windows_async::IAsyncAction> {
        Self::IApplicationViewSwitcherStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PrepareForCustomAnimatedSwitchAsync(toviewid: i32, fromviewid: i32, options: ApplicationViewSwitchingOptions) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
        Self::IApplicationViewSwitcherStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryShowAsViewModeAsync(viewid: i32, viewmode: ApplicationViewMode) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
    ...
    pub fn TryShowAsViewModeWithPreferencesAsync<P2>(viewid: i32, viewmode: ApplicationViewMode, viewmodepreferences: P2) -> windows_core::Result<windows_async::IAsyncOperation<bool>>
    where
...
impl ProjectionManager {
    pub fn StartProjectingAsync(projectionviewid: i32, anchorviewid: i32) -> windows_core::Result<windows_async::IAsyncAction> {
    ...
    pub fn SwapDisplaysForViewsAsync(projectionviewid: i32, anchorviewid: i32) -> windows_core::Result<windows_async::IAsyncAction> {
        Self::IProjectionManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StopProjectingAsync(projectionviewid: i32, anchorviewid: i32) -> windows_core::Result<windows_async::IAsyncAction> {
        Self::IProjectionManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub fn StartProjectingWithDeviceInfoAsync<P2>(projectionviewid: i32, anchorviewid: i32, displaydeviceinfo: P2) -> windows_core::Result<windows_async::IAsyncAction>
    where
    ...
    pub fn RequestStartProjectingAsync(projectionviewid: i32, anchorviewid: i32, selection: super::super::Foundation::Rect) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
        Self::IProjectionManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn RequestStartProjectingWithPlacementAsync(projectionviewid: i32, anchorviewid: i32, selection: super::super::Foundation::Rect, prefferedplacement: super::Popups::Placement) -> windows_core::Result<windows_async::IAsyncOperation<bool>> {
        Self::IProjectionManagerStatics2(|this| unsafe {
            let mut result__ = core::mem::zeroed();
...
impl StatusBar {
    ...
    pub fn HideAsync(&self) -> windows_core::Result<windows_async::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
