...
#[cfg(feature = "Graphics_Effects")]
windows_core::imp::required_hierarchy!(SceneLightingEffect, super::super::super::Graphics::Effects::IGraphicsEffect, super::super::super::Graphics::Effects::IGraphicsEffectSource, ISceneLightingEffect, ISceneLightingEffect2);
#[cfg(feature = "Graphics_Effects")]
