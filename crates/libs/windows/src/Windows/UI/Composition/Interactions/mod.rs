...
#[cfg(feature = "Foundation_Collections")]
windows_core::imp::required_hierarchy!(CompositionInteractionSourceCollection, super::super::super::Foundation::Collections::IIterable<ICompositionInteractionSource>, super::super::super::Foundation::IClosable, super::IAnimationObject);
#[cfg(feature = "Foundation_Collections")]
