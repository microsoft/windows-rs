...
impl CompositionDebugHeatMaps {
    pub fn Hide<P0>(&self, subtree: P0) -> windows_result::Result<()>
    where
    ...
    pub fn ShowMemoryUsage<P0>(&self, subtree: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::Visual>,
    {
        let this = self;
    ...
    pub fn ShowOverdraw<P0>(&self, subtree: P0, contentkinds: CompositionDebugOverdrawContentKinds) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::Visual>,
    {
        let this = self;
    ...
    pub fn ShowRedraw<P0>(&self, subtree: P0) -> windows_result::Result<()>
    where
        P0: windows_core::Param<super::Visual>,
    {
        let this = self;
...
impl CompositionDebugSettings {
    pub fn HeatMaps(&self) -> windows_result::Result<CompositionDebugHeatMaps> {
        let this = self;
        unsafe {
    ...
    pub fn TryGetSettings<P0>(compositor: P0) -> windows_result::Result<CompositionDebugSettings>
    where
    ...
    fn ICompositionDebugSettingsStatics<R, F: FnOnce(&ICompositionDebugSettingsStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
