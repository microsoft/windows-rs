...
windows_core::imp::required_hierarchy!(CompositionDebugHeatMaps, ICompositionDebugHeatMaps);
...
windows_core::imp::required_hierarchy!(CompositionDebugSettings, ICompositionDebugSettings, ICompositionDebugSettingsStatics);
