...
#[cfg(feature = "Foundation_Collections")]
windows_core::imp::required_hierarchy ! ( SceneMeshMaterialAttributeMap , super::super::super::Foundation::Collections:: IIterable < super::super::super::Foundation::Collections:: IKeyValuePair < windows_core::HSTRING , SceneAttributeSemantic > > , super::super::super::Foundation::Collections:: IMap < windows_core::HSTRING , SceneAttributeSemantic > , super::super::super::Foundation:: IClosable , super:: IAnimationObject );
#[cfg(feature = "Foundation_Collections")]
