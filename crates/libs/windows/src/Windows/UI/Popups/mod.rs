...
windows_core::imp::required_hierarchy!(MessageDialog, IMessageDialog, IMessageDialogFactory);
impl MessageDialog {
...
windows_core::imp::required_hierarchy!(PopupMenu, IPopupMenu);
impl PopupMenu {
...
windows_core::imp::required_hierarchy!(UICommand, IUICommand, IUICommandFactory);
impl UICommand {
    pub fn new() -> windows_core::Result<Self> {
        Self::IActivationFactory(|f| f.ActivateInstance::<Self>())
    }
