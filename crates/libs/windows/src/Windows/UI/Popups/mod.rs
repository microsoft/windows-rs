...
impl IUICommand {
    ...
    pub fn Invoked(&self) -> windows_result::Result<UICommandInvokedHandler> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IUICommand_Impl: windows_core::IUnknownImpl {
    fn Label(&self) -> windows_result::Result<windows_core::HSTRING>;
    fn SetLabel(&self, value: &windows_core::HSTRING) -> windows_result::Result<()>;
    fn Invoked(&self) -> windows_result::Result<UICommandInvokedHandler>;
    fn SetInvoked(&self, value: windows_core::Ref<UICommandInvokedHandler>) -> windows_result::Result<()>;
    fn Id(&self) -> windows_result::Result<windows_core::IInspectable>;
    fn SetId(&self, value: windows_core::Ref<windows_core::IInspectable>) -> windows_result::Result<()>;
}
...
impl MessageDialog {
    ...
    pub fn Commands(&self) -> windows_result::Result<windows_collections::IVector<IUICommand>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DefaultCommandIndex(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetDefaultCommandIndex(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetDefaultCommandIndex)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CancelCommandIndex(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCancelCommandIndex(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
    ...
    pub fn SetContent(&self, value: &windows_core::HSTRING) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetContent)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(value)).ok() }
    }
    pub fn ShowAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<IUICommand>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Options(&self) -> windows_result::Result<MessageDialogOptions> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetOptions(&self, value: MessageDialogOptions) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetOptions)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn Create(content: &windows_core::HSTRING) -> windows_result::Result<MessageDialog> {
    ...
    pub fn CreateWithTitle(content: &windows_core::HSTRING, title: &windows_core::HSTRING) -> windows_result::Result<MessageDialog> {
        Self::IMessageDialogFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IMessageDialogFactory<R, F: FnOnce(&IMessageDialogFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl PopupMenu {
    ...
    pub fn ShowAsync(&self, invocationpoint: super::super::Foundation::Point) -> windows_result::Result<windows_future::IAsyncOperation<IUICommand>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowAsyncWithRect(&self, selection: super::super::Foundation::Rect) -> windows_result::Result<windows_future::IAsyncOperation<IUICommand>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ShowAsyncWithRectAndPlacement(&self, selection: super::super::Foundation::Rect, preferredplacement: Placement) -> windows_result::Result<windows_future::IAsyncOperation<IUICommand>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl UICommand {
    ...
    pub fn Create(label: &windows_core::HSTRING) -> windows_result::Result<UICommand> {
    ...
    pub fn CreateWithHandler<P1>(label: &windows_core::HSTRING, action: P1) -> windows_result::Result<UICommand>
    where
    ...
    pub fn CreateWithHandlerAndId<P1, P2>(label: &windows_core::HSTRING, action: P1, commandid: P2) -> windows_result::Result<UICommand>
    where
        P1: windows_core::Param<UICommandInvokedHandler>,
    ...
    fn IUICommandFactory<R, F: FnOnce(&IUICommandFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl UICommandInvokedHandler {
    pub fn new<F: Fn(windows_core::Ref<IUICommand>) -> windows_result::Result<()> + Send + 'static>(invoke: F) -> Self {
...
#[repr(C)]
struct UICommandInvokedHandlerBox<F: Fn(windows_core::Ref<IUICommand>) -> windows_result::Result<()> + Send + 'static> {
    vtable: *const UICommandInvokedHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: Fn(windows_core::Ref<IUICommand>) -> windows_result::Result<()> + Send + 'static> UICommandInvokedHandlerBox<F> {
