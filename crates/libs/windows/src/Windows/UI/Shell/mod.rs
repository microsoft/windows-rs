...
impl IAdaptiveCard_Vtbl {
    ...
    {
        unsafe extern "system" fn ToJson<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IAdaptiveCard_Impl,
        {
            unsafe {
...
pub trait IAdaptiveCardBuilderStatics_Impl {
...
impl IAdaptiveCardBuilderStatics_Vtbl {
    ...
    {
        unsafe extern "system" fn CreateAdaptiveCardFromJson<Identity: windows_core::IUnknownImpl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_core::HRESULT
        where
            <Identity as windows_core::IUnknownImpl>::Impl: IAdaptiveCardBuilderStatics_Impl,
        {
            unsafe {
