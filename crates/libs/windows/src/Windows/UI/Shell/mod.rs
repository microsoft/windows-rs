...
windows_core::imp::required_hierarchy!(FocusSession, IFocusSession);
impl FocusSession {
...
windows_core::imp::required_hierarchy!(FocusSessionManager, IFocusSessionManager, IFocusSessionManagerStatics);
...
windows_core::imp::required_hierarchy!(SecurityAppManager, ISecurityAppManager);
...
windows_core::imp::required_hierarchy!(ShareWindowCommandEventArgs, IShareWindowCommandEventArgs);
...
windows_core::imp::required_hierarchy!(ShareWindowCommandSource, IShareWindowCommandSource, IShareWindowCommandSourceStatics);
...
windows_core::imp::required_hierarchy!(TaskbarManager, ITaskbarManager, ITaskbarManager2, ITaskbarManagerDesktopAppSupportStatics, ITaskbarManagerStatics);
impl TaskbarManager {
    pub fn IsSupported(&self) -> windows_core::Result<bool> {
        let this = &windows_core::Interface::cast::<ITaskbarManager>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsSupported)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        }
...
windows_core::imp::required_hierarchy!(WindowTab, IWindowTab);
impl WindowTab {
    pub fn new() -> windows_core::Result<Self> {
        Self::IActivationFactory(|f| f.ActivateInstance::<Self>())
    }
...
windows_core::imp::required_hierarchy!(WindowTabCloseRequestedEventArgs, IWindowTabCloseRequestedEventArgs);
...
#[cfg(feature = "Foundation_Collections")]
windows_core::imp::required_hierarchy!(WindowTabCollection, super::super::Foundation::Collections::IIterable<WindowTab>, super::super::Foundation::Collections::IVector<WindowTab>, IWindowTabCollection);
#[cfg(feature = "Foundation_Collections")]
...
windows_core::imp::required_hierarchy!(WindowTabGroup, IWindowTabGroup);
impl WindowTabGroup {
    pub fn new() -> windows_core::Result<Self> {
        Self::IActivationFactory(|f| f.ActivateInstance::<Self>())
    }
...
windows_core::imp::required_hierarchy!(WindowTabIcon, IWindowTabIcon, IWindowTabIconStatics);
impl WindowTabIcon {
...
windows_core::imp::required_hierarchy!(WindowTabManager, IWindowTabManager, IWindowTabManagerStatics);
...
windows_core::imp::required_hierarchy!(WindowTabSwitchRequestedEventArgs, IWindowTabSwitchRequestedEventArgs);
...
windows_core::imp::required_hierarchy!(WindowTabTearOutRequestedEventArgs, IWindowTabTearOutRequestedEventArgs);
...
windows_core::imp::required_hierarchy!(WindowTabThumbnailRequestedEventArgs, IWindowTabThumbnailRequestedEventArgs);
