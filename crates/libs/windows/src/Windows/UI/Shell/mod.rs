...
impl AdaptiveCardBuilder {
    pub fn CreateAdaptiveCardFromJson(value: &windows_core::HSTRING) -> Result<IAdaptiveCard, windows_result::HRESULT> {
    ...
    fn IAdaptiveCardBuilderStatics<R, F: FnOnce(&IAdaptiveCardBuilderStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl FocusSession {
    ...
    pub fn End(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl FocusSessionManager {
    pub fn IsFocusActive(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetSession(&self, id: &windows_core::HSTRING) -> Result<FocusSession, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryStartFocusSession(&self) -> Result<FocusSession, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryStartFocusSession2(&self, endtime: super::super::Foundation::DateTime) -> Result<FocusSession, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DeactivateFocus(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).DeactivateFocus)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn IsFocusActiveChanged<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveIsFocusActiveChanged(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveIsFocusActiveChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GetDefault() -> Result<FocusSessionManager, windows_result::HRESULT> {
    ...
    fn IFocusSessionManagerStatics<R, F: FnOnce(&IFocusSessionManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl IAdaptiveCard {
    pub fn ToJson(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IAdaptiveCard_Impl: windows_core::IUnknownImpl {
    fn ToJson(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT>;
}
impl IAdaptiveCard_Vtbl {
    pub const fn new<Identity: IAdaptiveCard_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ToJson<Identity: IAdaptiveCard_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
...
impl IAdaptiveCardBuilderStatics {
    pub fn CreateAdaptiveCardFromJson(&self, value: &windows_core::HSTRING) -> Result<IAdaptiveCard, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateAdaptiveCardFromJson)(windows_core::Interface::as_raw(this), core::mem::transmute_copy(value), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
...
pub trait IAdaptiveCardBuilderStatics_Impl: windows_core::IUnknownImpl {
    fn CreateAdaptiveCardFromJson(&self, value: &windows_core::HSTRING) -> Result<IAdaptiveCard, windows_result::HRESULT>;
}
impl IAdaptiveCardBuilderStatics_Vtbl {
    pub const fn new<Identity: IAdaptiveCardBuilderStatics_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateAdaptiveCardFromJson<Identity: IAdaptiveCardBuilderStatics_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_result::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl SecurityAppManager {
    ...
    pub fn Register<P2>(&self, kind: SecurityAppKind, displayname: &windows_core::HSTRING, detailsuri: P2, registerperuser: bool) -> Result<windows_core::GUID, windows_result::HRESULT>
    where
    ...
    pub fn Unregister(&self, kind: SecurityAppKind, guidregistration: windows_core::GUID) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).Unregister)(windows_core::Interface::as_raw(this), kind, guidregistration).ok() }
    }
    pub fn UpdateState<P4>(&self, kind: SecurityAppKind, guidregistration: windows_core::GUID, state: SecurityAppState, substatus: SecurityAppSubstatus, detailsuri: P4) -> Result<(), windows_result::HRESULT>
    where
...
impl ShareWindowCommandEventArgs {
    pub fn WindowId(&self) -> Result<super::WindowId, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Command(&self) -> Result<ShareWindowCommand, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetCommand(&self, value: ShareWindowCommand) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl ShareWindowCommandSource {
    ...
    pub fn ReportCommandChanged(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).ReportCommandChanged)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn CommandRequested<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveCommandRequested(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveCommandRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn CommandInvoked<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::TypedEventHandler<ShareWindowCommandSource, ShareWindowCommandEventArgs>>,
    {
        let this = self;
    ...
    pub fn RemoveCommandInvoked(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveCommandInvoked)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GetForCurrentView() -> Result<ShareWindowCommandSource, windows_result::HRESULT> {
        Self::IShareWindowCommandSourceStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetForCurrentView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn IShareWindowCommandSourceStatics<R, F: FnOnce(&IShareWindowCommandSourceStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl TaskbarManager {
    ...
    pub fn IsPinningAllowed(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsCurrentAppPinnedAsync(&self) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ApplicationModel_Core")]
    pub fn IsAppListEntryPinnedAsync<P0>(&self, applistentry: P0) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
    ...
    pub fn RequestPinCurrentAppAsync(&self) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ApplicationModel_Core")]
    pub fn RequestPinAppListEntryAsync<P0>(&self, applistentry: P0) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::ApplicationModel::Core::AppListEntry>,
    {
        let this = self;
    ...
    pub fn IsSecondaryTilePinnedAsync(&self, tileid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT> {
    ...
    #[cfg(feature = "UI_StartScreen")]
    pub fn RequestPinSecondaryTileAsync<P0>(&self, secondarytile: P0) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT>
    where
    ...
    pub fn TryUnpinSecondaryTileAsync(&self, tileid: &windows_core::HSTRING) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<ITaskbarManager2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDefault() -> Result<TaskbarManager, windows_result::HRESULT> {
        Self::ITaskbarManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetDefault)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    fn ITaskbarManagerStatics<R, F: FnOnce(&ITaskbarManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl WindowTab {
    ...
    pub fn Icon(&self) -> Result<WindowTabIcon, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TreatAsSecondaryTileId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetTreatAsSecondaryTileId(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Group(&self) -> Result<WindowTabGroup, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetGroup<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn ReportThumbnailAvailable(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl WindowTabCloseRequestedEventArgs {
    pub fn Tab(&self) -> Result<WindowTab, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl WindowTabCollection {
    pub fn First(&self) -> Result<windows_collections::IIterator<WindowTab>, windows_result::HRESULT> {
    ...
    pub fn GetAt(&self, index: u32) -> Result<WindowTab, windows_result::HRESULT> {
    ...
    pub fn GetView(&self) -> Result<windows_collections::IVectorView<WindowTab>, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<windows_collections::IVector<WindowTab>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetMany(&self, startindex: u32, items: &mut [Option<WindowTab>]) -> Result<u32, windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<windows_collections::IVector<WindowTab>>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ReplaceAll(&self, items: &[Option<WindowTab>]) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<windows_collections::IVector<WindowTab>>(self)?;
    ...
    pub fn MoveTab<P0>(&self, tab: P0, index: u32) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<WindowTab>,
    {
        let this = self;
...
impl WindowTabIcon {
    pub fn CreateFromFontGlyph(glyph: &windows_core::HSTRING, fontfamily: &windows_core::HSTRING) -> Result<WindowTabIcon, windows_result::HRESULT> {
    ...
    pub fn CreateFromFontGlyphWithUri<P2>(glyph: &windows_core::HSTRING, fontfamily: &windows_core::HSTRING, fonturi: P2) -> Result<WindowTabIcon, windows_result::HRESULT>
    where
        P2: windows_core::Param<super::super::Foundation::Uri>,
    {
        Self::IWindowTabIconStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromImage<P0>(image: P0) -> Result<WindowTabIcon, windows_result::HRESULT>
    where
    ...
    fn IWindowTabIconStatics<R, F: FnOnce(&IWindowTabIconStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl WindowTabManager {
    pub fn Tabs(&self) -> Result<WindowTabCollection, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetActiveTab<P0>(&self, tab: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<WindowTab>,
    {
        let this = self;
    ...
    pub fn TabSwitchRequested<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveTabSwitchRequested(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveTabSwitchRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn TabCloseRequested<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveTabCloseRequested(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveTabCloseRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn TabTearOutRequested<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveTabTearOutRequested(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveTabTearOutRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn TabThumbnailRequested<P0>(&self, handler: P0) -> Result<i64, windows_result::HRESULT>
    where
    ...
    pub fn RemoveTabThumbnailRequested(&self, token: i64) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveTabThumbnailRequested)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GetForWindow(id: super::WindowId) -> Result<WindowTabManager, windows_result::HRESULT> {
    ...
    pub fn IsTabTearOutSupported() -> Result<bool, windows_result::HRESULT> {
        Self::IWindowTabManagerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).IsTabTearOutSupported)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
        })
    }
    fn IWindowTabManagerStatics<R, F: FnOnce(&IWindowTabManagerStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl WindowTabTearOutRequestedEventArgs {
    ...
    pub fn WindowId(&self) -> Result<u64, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WindowId)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn SetWindowId(&self, value: u64) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl WindowTabThumbnailRequestedEventArgs {
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn RequestedSize(&self) -> Result<super::super::Graphics::Imaging::BitmapSize, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn Image(&self) -> Result<super::super::Storage::Streams::IRandomAccessStreamReference, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsCompositedOnWindow(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
