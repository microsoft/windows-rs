...
impl UserNotificationListener {
    pub fn RequestAccessAsync(&self) -> windows_result::Result<windows_future::IAsyncOperation<UserNotificationListenerAccessStatus>> {
        let this = self;
        unsafe {
    ...
    pub fn GetAccessStatus(&self) -> windows_result::Result<UserNotificationListenerAccessStatus> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NotificationChanged<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveNotificationChanged(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RemoveNotificationChanged)(windows_core::Interface::as_raw(this), token).ok() }
    }
    pub fn GetNotificationsAsync(&self, kinds: super::NotificationKinds) -> windows_result::Result<windows_future::IAsyncOperation<windows_collections::IVectorView<super::UserNotification>>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetNotification(&self, notificationid: u32) -> windows_result::Result<super::UserNotification> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IUserNotificationListenerStatics<R, F: FnOnce(&IUserNotificationListenerStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
