...
impl<Identity: windows_core::IUnknownImpl + IAdaptiveNotificationContent_Impl + 'static, const OFFSET: isize> windows_core::imp::VtableCtor<Identity, OFFSET> for IAdaptiveNotificationContent_Vtbl {
