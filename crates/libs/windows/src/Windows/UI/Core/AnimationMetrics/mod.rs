...
impl AnimationDescription {
    pub fn Animations(&self) -> windows_result::Result<windows_collections::IVectorView<IPropertyAnimation>> {
        let this = self;
        unsafe {
    ...
    pub fn StaggerDelay(&self) -> windows_result::Result<super::super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn StaggerDelayFactor(&self) -> windows_result::Result<f32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DelayLimit(&self) -> windows_result::Result<super::super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ZOrder(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CreateInstance(effect: AnimationEffect, target: AnimationEffectTarget) -> windows_result::Result<AnimationDescription> {
    ...
    fn IAnimationDescriptionFactory<R, F: FnOnce(&IAnimationDescriptionFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl IPropertyAnimation {
    pub fn Type(&self) -> windows_result::Result<PropertyAnimationType> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Delay(&self) -> windows_result::Result<super::super::super::Foundation::TimeSpan> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Control1(&self) -> windows_result::Result<super::super::super::Foundation::Point> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Control2(&self) -> windows_result::Result<super::super::super::Foundation::Point> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IPropertyAnimation_Impl: windows_core::IUnknownImpl {
    fn Type(&self) -> windows_result::Result<PropertyAnimationType>;
    fn Delay(&self) -> windows_result::Result<super::super::super::Foundation::TimeSpan>;
    fn Duration(&self) -> windows_result::Result<super::super::super::Foundation::TimeSpan>;
    fn Control1(&self) -> windows_result::Result<super::super::super::Foundation::Point>;
    fn Control2(&self) -> windows_result::Result<super::super::super::Foundation::Point>;
}
...
impl OpacityAnimation {
    pub fn InitialOpacity(&self) -> windows_result::Result<super::super::super::Foundation::IReference<f32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FinalOpacity(&self) -> windows_result::Result<f32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl ScaleAnimation {
    ...
    pub fn InitialScaleX(&self) -> windows_result::Result<super::super::super::Foundation::IReference<f32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn InitialScaleY(&self) -> windows_result::Result<super::super::super::Foundation::IReference<f32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FinalScaleX(&self) -> windows_result::Result<f32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn FinalScaleY(&self) -> windows_result::Result<f32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn NormalizedOrigin(&self) -> windows_result::Result<super::super::super::Foundation::Point> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
