...
impl AnimationDescription {
    ...
    pub fn StaggerDelay(&self) -> windows_core::Result<windows_time::TimeSpan> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).StaggerDelay)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn StaggerDelayFactor(&self) -> windows_core::Result<f32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).StaggerDelayFactor)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn DelayLimit(&self) -> windows_core::Result<windows_time::TimeSpan> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).DelayLimit)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn ZOrder(&self) -> windows_core::Result<i32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ZOrder)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
...
impl AnimationEffect {
    pub const Expand: Self = Self(0);
    pub const Collapse: Self = Self(1);
    pub const Reposition: Self = Self(2);
    pub const FadeIn: Self = Self(3);
    pub const FadeOut: Self = Self(4);
    pub const AddToList: Self = Self(5);
    pub const DeleteFromList: Self = Self(6);
    pub const AddToGrid: Self = Self(7);
    pub const DeleteFromGrid: Self = Self(8);
    pub const AddToSearchGrid: Self = Self(9);
    pub const DeleteFromSearchGrid: Self = Self(10);
    pub const AddToSearchList: Self = Self(11);
    pub const DeleteFromSearchList: Self = Self(12);
    pub const ShowEdgeUI: Self = Self(13);
    pub const ShowPanel: Self = Self(14);
    pub const HideEdgeUI: Self = Self(15);
    pub const HidePanel: Self = Self(16);
    pub const ShowPopup: Self = Self(17);
    pub const HidePopup: Self = Self(18);
    pub const PointerDown: Self = Self(19);
    pub const PointerUp: Self = Self(20);
    pub const DragSourceStart: Self = Self(21);
    pub const DragSourceEnd: Self = Self(22);
    pub const TransitionContent: Self = Self(23);
    pub const Reveal: Self = Self(24);
    pub const Hide: Self = Self(25);
    pub const DragBetweenEnter: Self = Self(26);
    pub const DragBetweenLeave: Self = Self(27);
    pub const SwipeSelect: Self = Self(28);
    pub const SwipeDeselect: Self = Self(29);
    pub const SwipeReveal: Self = Self(30);
    pub const EnterPage: Self = Self(31);
    pub const TransitionPage: Self = Self(32);
    pub const CrossFade: Self = Self(33);
...
impl AnimationEffectTarget {
    ...
    pub const Background: Self = Self(3);
    pub const Content: Self = Self(4);
    pub const Deleted: Self = Self(5);
    pub const Deselected: Self = Self(6);
    pub const DragSource: Self = Self(7);
    pub const Hidden: Self = Self(8);
    pub const Incoming: Self = Self(9);
    pub const Outgoing: Self = Self(10);
    pub const Outline: Self = Self(11);
    pub const Remaining: Self = Self(12);
    pub const Revealed: Self = Self(13);
    pub const RowIn: Self = Self(14);
    pub const RowOut: Self = Self(15);
    pub const Selected: Self = Self(16);
    pub const Selection: Self = Self(17);
...
pub struct IAnimationDescription_Vtbl {
    ...
    pub StaggerDelay: unsafe extern "system" fn(*mut core::ffi::c_void, *mut windows_time::TimeSpan) -> windows_core::HRESULT,
    pub StaggerDelayFactor: unsafe extern "system" fn(*mut core::ffi::c_void, *mut f32) -> windows_core::HRESULT,
    pub DelayLimit: unsafe extern "system" fn(*mut core::ffi::c_void, *mut windows_time::TimeSpan) -> windows_core::HRESULT,
...
impl IPropertyAnimation {
    ...
    pub fn Control1(&self) -> windows_core::Result<super::super::super::Foundation::Point> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Control1)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn Control2(&self) -> windows_core::Result<super::super::super::Foundation::Point> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).Control2)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
}
...
pub trait IPropertyAnimation_Impl: windows_core::IUnknownImpl {
    ...
    fn Delay(&self) -> windows_core::Result<windows_time::TimeSpan>;
...
impl IPropertyAnimation_Vtbl {
    pub const fn new<Identity: IPropertyAnimation_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Delay<Identity: IPropertyAnimation_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut windows_time::TimeSpan) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn Duration<Identity: IPropertyAnimation_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut windows_time::TimeSpan) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl OpacityAnimation {
    ...
    pub fn FinalOpacity(&self) -> windows_core::Result<f32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FinalOpacity)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn Type(&self) -> windows_core::Result<PropertyAnimationType> {
...
impl ScaleAnimation {
    ...
    pub fn FinalScaleX(&self) -> windows_core::Result<f32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FinalScaleX)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn FinalScaleY(&self) -> windows_core::Result<f32> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).FinalScaleY)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn NormalizedOrigin(&self) -> windows_core::Result<super::super::super::Foundation::Point> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).NormalizedOrigin)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
}
