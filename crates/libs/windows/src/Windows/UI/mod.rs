...
windows_core::imp::required_hierarchy!(ColorHelper,);
impl ColorHelper {
...
windows_core::imp::required_hierarchy!(Colors,);
impl Colors {
...
windows_core::imp::required_hierarchy!(UIContentRoot,);
impl UIContentRoot {
...
windows_core::imp::required_hierarchy!(UIContext,);
impl UIContext {}
