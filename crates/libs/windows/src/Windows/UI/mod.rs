...
impl ColorHelper {
    pub fn FromArgb(a: u8, r: u8, g: u8, b: u8) -> Result<Color, windows_result::HRESULT> {
    ...
    pub fn ToDisplayName(color: Color) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
    ...
    fn IColorHelperStatics<R, F: FnOnce(&IColorHelperStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
        static SHARED: windows_core::imp::FactoryCache<ColorHelper, IColorHelperStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IColorHelperStatics2<R, F: FnOnce(&IColorHelperStatics2) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl Colors {
    pub fn AliceBlue() -> Result<Color, windows_result::HRESULT> {
...
impl UIContentRoot {
    pub fn UIContext(&self) -> Result<UIContext, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
