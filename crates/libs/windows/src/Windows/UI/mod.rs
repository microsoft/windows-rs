...
impl ColorHelper {
    pub fn FromArgb(a: u8, r: u8, g: u8, b: u8) -> windows_result::Result<Color> {
    ...
    pub fn ToDisplayName(color: Color) -> windows_result::Result<windows_core::HSTRING> {
    ...
    fn IColorHelperStatics<R, F: FnOnce(&IColorHelperStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<ColorHelper, IColorHelperStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn IColorHelperStatics2<R, F: FnOnce(&IColorHelperStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl Colors {
    pub fn AliceBlue() -> windows_result::Result<Color> {
...
impl UIContentRoot {
    pub fn UIContext(&self) -> windows_result::Result<UIContext> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
