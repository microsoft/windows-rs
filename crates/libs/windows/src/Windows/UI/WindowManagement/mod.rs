...
impl AppWindow {
    pub fn Content(&self) -> Result<super::UIContentRoot, windows_result::HRESULT> {
        let this = self;
        unsafe {
    ...
    pub fn Frame(&self) -> Result<AppWindowFrame, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PersistedStateId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetPersistedStateId(&self, value: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn Presenter(&self) -> Result<AppWindowPresenter, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TitleBar(&self) -> Result<AppWindowTitleBar, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn UIContext(&self) -> Result<super::UIContext, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn WindowingEnvironment(&self) -> Result<WindowingEnvironment, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn CloseAsync(&self) -> Result<windows_future::IAsyncAction, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetPlacement(&self) -> Result<AppWindowPlacement, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetDisplayRegions(&self) -> Result<windows_collections::IVectorView<DisplayRegion>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestMoveToDisplayRegion<P0>(&self, displayregion: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn RequestMoveAdjacentToCurrentView(&self) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RequestMoveAdjacentToCurrentView)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn RequestMoveAdjacentToWindow<P0>(&self, anchorwindow: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn RequestMoveRelativeToWindowContent<P0>(&self, anchorwindow: P0, contentoffset: super::super::Foundation::Point) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<AppWindow>,
    {
        let this = self;
    ...
    pub fn RequestMoveRelativeToCurrentViewContent(&self, contentoffset: super::super::Foundation::Point) -> Result<(), windows_result::HRESULT> {
        let this = self;
    ...
    pub fn RequestMoveRelativeToDisplayRegion<P0>(&self, displayregion: P0, displayregionoffset: super::super::Foundation::Point) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<DisplayRegion>,
    {
        let this = self;
    ...
    pub fn RequestSize(&self, framesize: super::super::Foundation::Size) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).RequestSize)(windows_core::Interface::as_raw(this), framesize).ok() }
    }
    pub fn TryShowAsync(&self) -> Result<windows_future::IAsyncOperation<bool>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn TryCreateAsync() -> Result<windows_future::IAsyncOperation<AppWindow>, windows_result::HRESULT> {
    ...
    pub fn ClearAllPersistedState() -> Result<(), windows_result::HRESULT> {
    ...
    pub fn ClearPersistedState(key: &windows_core::HSTRING) -> Result<(), windows_result::HRESULT> {
    ...
    fn IAppWindowStatics<R, F: FnOnce(&IAppWindowStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl AppWindowChangedEventArgs {
    pub fn DidAvailableWindowPresentationsChange(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DidDisplayRegionsChange(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DidFrameChange(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DidSizeChange(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DidTitleBarChange(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DidVisibilityChange(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DidWindowingEnvironmentChange(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn DidWindowPresentationChange(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppWindowClosedEventArgs {
    pub fn Reason(&self) -> Result<AppWindowClosedReason, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppWindowFrame {
    ...
    pub fn DragRegionVisuals(&self) -> Result<windows_collections::IVector<super::Composition::IVisualElement>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetFrameStyle(&self) -> Result<AppWindowFrameStyle, windows_result::HRESULT> {
    ...
    pub fn SetFrameStyle(&self, framestyle: AppWindowFrameStyle) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IAppWindowFrameStyle>(self)?;
...
impl AppWindowPlacement {
    pub fn DisplayRegion(&self) -> Result<DisplayRegion, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Offset(&self) -> Result<super::super::Foundation::Point, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Size(&self) -> Result<super::super::Foundation::Size, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppWindowPresentationConfiguration {
    pub fn Kind(&self) -> Result<AppWindowPresentationKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppWindowPresenter {
    pub fn GetConfiguration(&self) -> Result<AppWindowPresentationConfiguration, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn IsPresentationSupported(&self, presentationkind: AppWindowPresentationKind) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn RequestPresentation<P0>(&self, configuration: P0) -> Result<bool, windows_result::HRESULT>
    where
    ...
    pub fn RequestPresentationByKind(&self, presentationkind: AppWindowPresentationKind) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl AppWindowTitleBar {
    pub fn BackgroundColor(&self) -> Result<super::super::Foundation::IReference<super::Color>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetBackgroundColor<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
    ...
    pub fn ButtonBackgroundColor(&self) -> Result<super::super::Foundation::IReference<super::Color>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetButtonBackgroundColor<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::Color>>,
    {
        let this = self;
    ...
    pub fn ButtonForegroundColor(&self) -> Result<super::super::Foundation::IReference<super::Color>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetButtonForegroundColor<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::Color>>,
    {
        let this = self;
    ...
    pub fn ButtonHoverBackgroundColor(&self) -> Result<super::super::Foundation::IReference<super::Color>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetButtonHoverBackgroundColor<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::Color>>,
    {
        let this = self;
    ...
    pub fn ButtonHoverForegroundColor(&self) -> Result<super::super::Foundation::IReference<super::Color>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetButtonHoverForegroundColor<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::Color>>,
    {
        let this = self;
    ...
    pub fn ButtonInactiveBackgroundColor(&self) -> Result<super::super::Foundation::IReference<super::Color>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetButtonInactiveBackgroundColor<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::Color>>,
    {
        let this = self;
    ...
    pub fn ButtonInactiveForegroundColor(&self) -> Result<super::super::Foundation::IReference<super::Color>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetButtonInactiveForegroundColor<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::Color>>,
    {
        let this = self;
    ...
    pub fn ButtonPressedBackgroundColor(&self) -> Result<super::super::Foundation::IReference<super::Color>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetButtonPressedBackgroundColor<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::Color>>,
    {
        let this = self;
    ...
    pub fn ButtonPressedForegroundColor(&self) -> Result<super::super::Foundation::IReference<super::Color>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetButtonPressedForegroundColor<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::Color>>,
    {
        let this = self;
    ...
    pub fn ExtendsContentIntoTitleBar(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetExtendsContentIntoTitleBar(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetExtendsContentIntoTitleBar)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn ForegroundColor(&self) -> Result<super::super::Foundation::IReference<super::Color>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetForegroundColor<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::Color>>,
    {
        let this = self;
    ...
    pub fn InactiveBackgroundColor(&self) -> Result<super::super::Foundation::IReference<super::Color>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetInactiveBackgroundColor<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::Color>>,
    {
        let this = self;
    ...
    pub fn InactiveForegroundColor(&self) -> Result<super::super::Foundation::IReference<super::Color>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetInactiveForegroundColor<P0>(&self, value: P0) -> Result<(), windows_result::HRESULT>
    where
        P0: windows_core::Param<super::super::Foundation::IReference<super::Color>>,
    {
        let this = self;
    ...
    pub fn GetTitleBarOcclusions(&self) -> Result<windows_collections::IVectorView<AppWindowTitleBarOcclusion>, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn GetPreferredVisibility(&self) -> Result<AppWindowTitleBarVisibility, windows_result::HRESULT> {
    ...
    pub fn SetPreferredVisibility(&self, visibilitymode: AppWindowTitleBarVisibility) -> Result<(), windows_result::HRESULT> {
        let this = &windows_core::Interface::cast::<IAppWindowTitleBarVisibility>(self)?;
...
impl AppWindowTitleBarOcclusion {
    pub fn OccludingRect(&self) -> Result<super::super::Foundation::Rect, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl DisplayRegion {
    pub fn DisplayMonitorDeviceId(&self) -> Result<windows_core::HSTRING, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn WorkAreaOffset(&self) -> Result<super::super::Foundation::Point, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn WorkAreaSize(&self) -> Result<super::super::Foundation::Size, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl FullScreenPresentationConfiguration {
    ...
    pub fn IsExclusive(&self) -> Result<bool, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetIsExclusive(&self, value: bool) -> Result<(), windows_result::HRESULT> {
        let this = self;
...
impl WindowServices {
    pub fn FindAllTopLevelWindowIds() -> Result<windows_collections::IVectorView<super::WindowId>, windows_result::HRESULT> {
    ...
    fn IWindowServicesStatics<R, F: FnOnce(&IWindowServicesStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
...
impl WindowingEnvironment {
    ...
    pub fn Kind(&self) -> Result<WindowingEnvironmentKind, windows_result::HRESULT> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Kind)(windows_core::Interface::as_raw(this), &mut result__).map(|| result__)
    ...
    pub fn FindAll() -> Result<windows_collections::IVectorView<WindowingEnvironment>, windows_result::HRESULT> {
    ...
    pub fn FindAllWithKind(kind: WindowingEnvironmentKind) -> Result<windows_collections::IVectorView<WindowingEnvironment>, windows_result::HRESULT> {
        Self::IWindowingEnvironmentStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    fn IWindowingEnvironmentStatics<R, F: FnOnce(&IWindowingEnvironmentStatics) -> Result<R, windows_result::HRESULT>>(callback: F) -> Result<R, windows_result::HRESULT> {
