...
windows_core::imp::required_hierarchy!(ContentLinkInfo, IContentLinkInfo);
...
windows_core::imp::required_hierarchy!(FontWeights, IFontWeights, IFontWeightsStatics);
impl FontWeights {
...
windows_core::imp::required_hierarchy!(RichEditTextDocument, ITextDocument, ITextDocument2, ITextDocument3, ITextDocument4);
...
windows_core::imp::required_hierarchy!(RichEditTextRange, IRichEditTextRange, ITextRange);
