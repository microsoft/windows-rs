...
impl ILearningModelFeatureDescriptor {
    ...
    pub fn Kind(&self) -> windows_result::Result<LearningModelFeatureKind> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ILearningModelFeatureDescriptor_Impl: windows_core::IUnknownImpl {
    ...
    fn Kind(&self) -> windows_result::Result<LearningModelFeatureKind>;
    fn IsRequired(&self) -> windows_result::Result<bool>;
}
...
impl ITensor {
    pub fn TensorKind(&self) -> windows_result::Result<TensorKind> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Shape(&self) -> windows_result::Result<windows_collections::IVectorView<i64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait ITensor_Impl: ILearningModelFeatureValue_Impl {
    fn TensorKind(&self) -> windows_result::Result<TensorKind>;
    fn Shape(&self) -> windows_result::Result<windows_collections::IVectorView<i64>>;
}
impl ITensor_Vtbl {
...
impl ImageFeatureDescriptor {
    #[cfg(feature = "Graphics_Imaging")]
    pub fn BitmapPixelFormat(&self) -> windows_result::Result<super::super::Graphics::Imaging::BitmapPixelFormat> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Graphics_Imaging")]
    pub fn BitmapAlphaMode(&self) -> windows_result::Result<super::super::Graphics::Imaging::BitmapAlphaMode> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn PixelRange(&self) -> windows_result::Result<LearningModelPixelRange> {
...
impl ImageFeatureValue {
    #[cfg(feature = "Media")]
    pub fn VideoFrame(&self) -> windows_result::Result<super::super::Media::VideoFrame> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Media")]
    pub fn CreateFromVideoFrame<P0>(image: P0) -> windows_result::Result<ImageFeatureValue>
    where
    ...
    fn IImageFeatureValueStatics<R, F: FnOnce(&IImageFeatureValueStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl LearningModel {
    ...
    pub fn Version(&self) -> windows_result::Result<i64> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn InputFeatures(&self) -> windows_result::Result<windows_collections::IVectorView<ILearningModelFeatureDescriptor>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn OutputFeatures(&self) -> windows_result::Result<windows_collections::IVectorView<ILearningModelFeatureDescriptor>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadFromStorageFileAsync<P0>(modelfile: P0) -> windows_result::Result<windows_future::IAsyncOperation<LearningModel>>
    where
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadFromStreamAsync<P0>(modelstream: P0) -> windows_result::Result<windows_future::IAsyncOperation<LearningModel>>
    where
    ...
    pub fn LoadFromFilePath(filepath: &windows_core::HSTRING) -> windows_result::Result<LearningModel> {
        Self::ILearningModelStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadFromStream<P0>(modelstream: P0) -> windows_result::Result<LearningModel>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
    {
        Self::ILearningModelStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadFromStorageFileWithOperatorProviderAsync<P0, P1>(modelfile: P0, operatorprovider: P1) -> windows_result::Result<windows_future::IAsyncOperation<LearningModel>>
    where
        P0: windows_core::Param<super::super::Storage::IStorageFile>,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadFromStreamWithOperatorProviderAsync<P0, P1>(modelstream: P0, operatorprovider: P1) -> windows_result::Result<windows_future::IAsyncOperation<LearningModel>>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
        P1: windows_core::Param<ILearningModelOperatorProvider>,
    {
    ...
    pub fn LoadFromFilePathWithOperatorProvider<P1>(filepath: &windows_core::HSTRING, operatorprovider: P1) -> windows_result::Result<LearningModel>
    where
        P1: windows_core::Param<ILearningModelOperatorProvider>,
    {
        Self::ILearningModelStatics(|this| unsafe {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn LoadFromStreamWithOperatorProvider<P0, P1>(modelstream: P0, operatorprovider: P1) -> windows_result::Result<LearningModel>
    where
        P0: windows_core::Param<super::super::Storage::Streams::IRandomAccessStreamReference>,
        P1: windows_core::Param<ILearningModelOperatorProvider>,
    {
    ...
    fn ILearningModelStatics<R, F: FnOnce(&ILearningModelStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl LearningModelBinding {
    ...
    pub fn Bind<P1>(&self, name: &windows_core::HSTRING, value: P1) -> windows_result::Result<()>
    where
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn BindWithProperties<P1, P2>(&self, name: &windows_core::HSTRING, value: P1, props: P2) -> windows_result::Result<()>
    where
        P1: windows_core::Param<windows_core::IInspectable>,
    ...
    pub fn CreateFromSession<P0>(session: P0) -> windows_result::Result<LearningModelBinding>
    where
    ...
    fn ILearningModelBindingFactory<R, F: FnOnce(&ILearningModelBindingFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl LearningModelDevice {
    #[cfg(feature = "Graphics")]
    pub fn AdapterId(&self) -> windows_result::Result<super::super::Graphics::DisplayAdapterId> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Create(devicekind: LearningModelDeviceKind) -> windows_result::Result<LearningModelDevice> {
    ...
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn CreateFromDirect3D11Device<P0>(device: P0) -> windows_result::Result<LearningModelDevice>
    where
    ...
    fn ILearningModelDeviceFactory<R, F: FnOnce(&ILearningModelDeviceFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn ILearningModelDeviceStatics<R, F: FnOnce(&ILearningModelDeviceStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl LearningModelEvaluationResult {
    ...
    pub fn ErrorStatus(&self) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Outputs(&self) -> windows_result::Result<windows_collections::IMapView<windows_core::HSTRING, windows_core::IInspectable>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl LearningModelSession {
    ...
    pub fn Model(&self) -> windows_result::Result<LearningModel> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Device(&self) -> windows_result::Result<LearningModelDevice> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn EvaluationProperties(&self) -> windows_result::Result<super::super::Foundation::Collections::IPropertySet> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn EvaluateAsync<P0>(&self, bindings: P0, correlationid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<LearningModelEvaluationResult>>
    where
    ...
    pub fn EvaluateFeaturesAsync<P0>(&self, features: P0, correlationid: &windows_core::HSTRING) -> windows_result::Result<windows_future::IAsyncOperation<LearningModelEvaluationResult>>
    where
    ...
    pub fn Evaluate<P0>(&self, bindings: P0, correlationid: &windows_core::HSTRING) -> windows_result::Result<LearningModelEvaluationResult>
    where
        P0: windows_core::Param<LearningModelBinding>,
    {
        let this = self;
    ...
    pub fn EvaluateFeatures<P0>(&self, features: P0, correlationid: &windows_core::HSTRING) -> windows_result::Result<LearningModelEvaluationResult>
    where
        P0: windows_core::Param<windows_collections::IMap<windows_core::HSTRING, windows_core::IInspectable>>,
    {
        let this = self;
    ...
    pub fn CreateFromModel<P0>(model: P0) -> windows_result::Result<LearningModelSession>
    where
    ...
    pub fn CreateFromModelOnDevice<P0, P1>(model: P0, devicetorunon: P1) -> windows_result::Result<LearningModelSession>
    where
        P0: windows_core::Param<LearningModel>,
    ...
    pub fn CreateFromModelOnDeviceWithSessionOptions<P0, P1, P2>(model: P0, devicetorunon: P1, learningmodelsessionoptions: P2) -> windows_result::Result<LearningModelSession>
    where
        P0: windows_core::Param<LearningModel>,
        P1: windows_core::Param<LearningModelDevice>,
    ...
    fn ILearningModelSessionFactory<R, F: FnOnce(&ILearningModelSessionFactory) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
    ...
    fn ILearningModelSessionFactory2<R, F: FnOnce(&ILearningModelSessionFactory2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl LearningModelSessionOptions {
    ...
    pub fn BatchSizeOverride(&self) -> windows_result::Result<u32> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn SetBatchSizeOverride(&self, value: u32) -> windows_result::Result<()> {
        let this = self;
        unsafe { (windows_core::Interface::vtable(this).SetBatchSizeOverride)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn CloseModelOnSessionCreation(&self) -> windows_result::Result<bool> {
    ...
    pub fn SetCloseModelOnSessionCreation(&self, value: bool) -> windows_result::Result<()> {
        let this = &windows_core::Interface::cast::<ILearningModelSessionOptions2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).SetCloseModelOnSessionCreation)(windows_core::Interface::as_raw(this), value).ok() }
    }
    pub fn OverrideNamedDimension(&self, name: &windows_core::HSTRING, dimension: u32) -> windows_result::Result<()> {
...
impl MapFeatureDescriptor {
    ...
    pub fn KeyKind(&self) -> windows_result::Result<TensorKind> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn ValueDescriptor(&self) -> windows_result::Result<ILearningModelFeatureDescriptor> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl SequenceFeatureDescriptor {
    ...
    pub fn ElementDescriptor(&self) -> windows_result::Result<ILearningModelFeatureDescriptor> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl TensorBoolean {
    ...
    pub fn GetAsVectorView(&self) -> windows_result::Result<windows_collections::IVectorView<bool>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub fn Create() -> windows_result::Result<TensorBoolean> {
    ...
    pub fn Create2<P0>(shape: P0) -> windows_result::Result<TensorBoolean>
    where
    ...
    pub fn CreateFromArray<P0>(shape: P0, data: &[bool]) -> windows_result::Result<TensorBoolean>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorBooleanStatics(|this| unsafe {
    ...
    pub fn CreateFromIterable<P0, P1>(shape: P0, data: P1) -> windows_result::Result<TensorBoolean>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    ...
    pub fn CreateFromShapeArrayAndDataArray(shape: &[i64], data: &[bool]) -> windows_result::Result<TensorBoolean> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromBuffer<P1>(shape: &[i64], buffer: P1) -> windows_result::Result<TensorBoolean>
    where
    ...
    fn ITensorBooleanStatics<R, F: FnOnce(&ITensorBooleanStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<TensorBoolean, ITensorBooleanStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ITensorBooleanStatics2<R, F: FnOnce(&ITensorBooleanStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl TensorDouble {
    ...
    pub fn GetAsVectorView(&self) -> windows_result::Result<windows_collections::IVectorView<f64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAsVectorView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Create() -> windows_result::Result<TensorDouble> {
        Self::ITensorDoubleStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn Create2<P0>(shape: P0) -> windows_result::Result<TensorDouble>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorDoubleStatics(|this| unsafe {
    ...
    pub fn CreateFromArray<P0>(shape: P0, data: &[f64]) -> windows_result::Result<TensorDouble>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorDoubleStatics(|this| unsafe {
    ...
    pub fn CreateFromIterable<P0, P1>(shape: P0, data: P1) -> windows_result::Result<TensorDouble>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    ...
    pub fn CreateFromShapeArrayAndDataArray(shape: &[i64], data: &[f64]) -> windows_result::Result<TensorDouble> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromBuffer<P1>(shape: &[i64], buffer: P1) -> windows_result::Result<TensorDouble>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::ITensorDoubleStatics2(|this| unsafe {
    ...
    fn ITensorDoubleStatics<R, F: FnOnce(&ITensorDoubleStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<TensorDouble, ITensorDoubleStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ITensorDoubleStatics2<R, F: FnOnce(&ITensorDoubleStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl TensorFloat {
    ...
    pub fn GetAsVectorView(&self) -> windows_result::Result<windows_collections::IVectorView<f32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAsVectorView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Create() -> windows_result::Result<TensorFloat> {
        Self::ITensorFloatStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn Create2<P0>(shape: P0) -> windows_result::Result<TensorFloat>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorFloatStatics(|this| unsafe {
    ...
    pub fn CreateFromArray<P0>(shape: P0, data: &[f32]) -> windows_result::Result<TensorFloat>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorFloatStatics(|this| unsafe {
    ...
    pub fn CreateFromIterable<P0, P1>(shape: P0, data: P1) -> windows_result::Result<TensorFloat>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    ...
    pub fn CreateFromShapeArrayAndDataArray(shape: &[i64], data: &[f32]) -> windows_result::Result<TensorFloat> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromBuffer<P1>(shape: &[i64], buffer: P1) -> windows_result::Result<TensorFloat>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::ITensorFloatStatics2(|this| unsafe {
    ...
    fn ITensorFloatStatics<R, F: FnOnce(&ITensorFloatStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<TensorFloat, ITensorFloatStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ITensorFloatStatics2<R, F: FnOnce(&ITensorFloatStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl TensorFloat16Bit {
    ...
    pub fn Create() -> windows_result::Result<TensorFloat16Bit> {
        Self::ITensorFloat16BitStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn Create2<P0>(shape: P0) -> windows_result::Result<TensorFloat16Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorFloat16BitStatics(|this| unsafe {
    ...
    pub fn CreateFromArray<P0>(shape: P0, data: &[f32]) -> windows_result::Result<TensorFloat16Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorFloat16BitStatics(|this| unsafe {
    ...
    pub fn CreateFromIterable<P0, P1>(shape: P0, data: P1) -> windows_result::Result<TensorFloat16Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
        P1: windows_core::Param<windows_collections::IIterable<f32>>,
    {
    ...
    pub fn CreateFromShapeArrayAndDataArray(shape: &[i64], data: &[f32]) -> windows_result::Result<TensorFloat16Bit> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromBuffer<P1>(shape: &[i64], buffer: P1) -> windows_result::Result<TensorFloat16Bit>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::ITensorFloat16BitStatics2(|this| unsafe {
    ...
    fn ITensorFloat16BitStatics<R, F: FnOnce(&ITensorFloat16BitStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<TensorFloat16Bit, ITensorFloat16BitStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ITensorFloat16BitStatics2<R, F: FnOnce(&ITensorFloat16BitStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl TensorInt16Bit {
    ...
    pub fn GetAsVectorView(&self) -> windows_result::Result<windows_collections::IVectorView<i16>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAsVectorView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Create() -> windows_result::Result<TensorInt16Bit> {
        Self::ITensorInt16BitStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn Create2<P0>(shape: P0) -> windows_result::Result<TensorInt16Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorInt16BitStatics(|this| unsafe {
    ...
    pub fn CreateFromArray<P0>(shape: P0, data: &[i16]) -> windows_result::Result<TensorInt16Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorInt16BitStatics(|this| unsafe {
    ...
    pub fn CreateFromIterable<P0, P1>(shape: P0, data: P1) -> windows_result::Result<TensorInt16Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    ...
    pub fn CreateFromShapeArrayAndDataArray(shape: &[i64], data: &[i16]) -> windows_result::Result<TensorInt16Bit> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromBuffer<P1>(shape: &[i64], buffer: P1) -> windows_result::Result<TensorInt16Bit>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::ITensorInt16BitStatics2(|this| unsafe {
    ...
    fn ITensorInt16BitStatics<R, F: FnOnce(&ITensorInt16BitStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<TensorInt16Bit, ITensorInt16BitStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ITensorInt16BitStatics2<R, F: FnOnce(&ITensorInt16BitStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl TensorInt32Bit {
    ...
    pub fn GetAsVectorView(&self) -> windows_result::Result<windows_collections::IVectorView<i32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAsVectorView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Create() -> windows_result::Result<TensorInt32Bit> {
        Self::ITensorInt32BitStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn Create2<P0>(shape: P0) -> windows_result::Result<TensorInt32Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorInt32BitStatics(|this| unsafe {
    ...
    pub fn CreateFromArray<P0>(shape: P0, data: &[i32]) -> windows_result::Result<TensorInt32Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorInt32BitStatics(|this| unsafe {
    ...
    pub fn CreateFromIterable<P0, P1>(shape: P0, data: P1) -> windows_result::Result<TensorInt32Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    ...
    pub fn CreateFromShapeArrayAndDataArray(shape: &[i64], data: &[i32]) -> windows_result::Result<TensorInt32Bit> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromBuffer<P1>(shape: &[i64], buffer: P1) -> windows_result::Result<TensorInt32Bit>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::ITensorInt32BitStatics2(|this| unsafe {
    ...
    fn ITensorInt32BitStatics<R, F: FnOnce(&ITensorInt32BitStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<TensorInt32Bit, ITensorInt32BitStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ITensorInt32BitStatics2<R, F: FnOnce(&ITensorInt32BitStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl TensorInt64Bit {
    ...
    pub fn GetAsVectorView(&self) -> windows_result::Result<windows_collections::IVectorView<i64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAsVectorView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Create() -> windows_result::Result<TensorInt64Bit> {
        Self::ITensorInt64BitStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn Create2<P0>(shape: P0) -> windows_result::Result<TensorInt64Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorInt64BitStatics(|this| unsafe {
    ...
    pub fn CreateFromArray<P0>(shape: P0, data: &[i64]) -> windows_result::Result<TensorInt64Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorInt64BitStatics(|this| unsafe {
    ...
    pub fn CreateFromIterable<P0, P1>(shape: P0, data: P1) -> windows_result::Result<TensorInt64Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    ...
    pub fn CreateFromShapeArrayAndDataArray(shape: &[i64], data: &[i64]) -> windows_result::Result<TensorInt64Bit> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromBuffer<P1>(shape: &[i64], buffer: P1) -> windows_result::Result<TensorInt64Bit>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::ITensorInt64BitStatics2(|this| unsafe {
    ...
    fn ITensorInt64BitStatics<R, F: FnOnce(&ITensorInt64BitStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<TensorInt64Bit, ITensorInt64BitStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ITensorInt64BitStatics2<R, F: FnOnce(&ITensorInt64BitStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl TensorInt8Bit {
    ...
    pub fn GetAsVectorView(&self) -> windows_result::Result<windows_collections::IVectorView<u8>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAsVectorView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Create() -> windows_result::Result<TensorInt8Bit> {
        Self::ITensorInt8BitStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn Create2<P0>(shape: P0) -> windows_result::Result<TensorInt8Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorInt8BitStatics(|this| unsafe {
    ...
    pub fn CreateFromArray<P0>(shape: P0, data: &[u8]) -> windows_result::Result<TensorInt8Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorInt8BitStatics(|this| unsafe {
    ...
    pub fn CreateFromIterable<P0, P1>(shape: P0, data: P1) -> windows_result::Result<TensorInt8Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    ...
    pub fn CreateFromShapeArrayAndDataArray(shape: &[i64], data: &[u8]) -> windows_result::Result<TensorInt8Bit> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromBuffer<P1>(shape: &[i64], buffer: P1) -> windows_result::Result<TensorInt8Bit>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::ITensorInt8BitStatics2(|this| unsafe {
    ...
    fn ITensorInt8BitStatics<R, F: FnOnce(&ITensorInt8BitStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<TensorInt8Bit, ITensorInt8BitStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ITensorInt8BitStatics2<R, F: FnOnce(&ITensorInt8BitStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl TensorString {
    ...
    pub fn GetAsVectorView(&self) -> windows_result::Result<windows_collections::IVectorView<windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAsVectorView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Create() -> windows_result::Result<TensorString> {
        Self::ITensorStringStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn Create2<P0>(shape: P0) -> windows_result::Result<TensorString>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorStringStatics(|this| unsafe {
    ...
    pub fn CreateFromArray<P0>(shape: P0, data: &[windows_core::HSTRING]) -> windows_result::Result<TensorString>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorStringStatics(|this| unsafe {
    ...
    pub fn CreateFromIterable<P0, P1>(shape: P0, data: P1) -> windows_result::Result<TensorString>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    ...
    pub fn CreateFromShapeArrayAndDataArray(shape: &[i64], data: &[windows_core::HSTRING]) -> windows_result::Result<TensorString> {
    ...
    fn ITensorStringStatics<R, F: FnOnce(&ITensorStringStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<TensorString, ITensorStringStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ITensorStringStatics2<R, F: FnOnce(&ITensorStringStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl TensorUInt16Bit {
    ...
    pub fn GetAsVectorView(&self) -> windows_result::Result<windows_collections::IVectorView<u16>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAsVectorView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Create() -> windows_result::Result<TensorUInt16Bit> {
        Self::ITensorUInt16BitStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn Create2<P0>(shape: P0) -> windows_result::Result<TensorUInt16Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorUInt16BitStatics(|this| unsafe {
    ...
    pub fn CreateFromArray<P0>(shape: P0, data: &[u16]) -> windows_result::Result<TensorUInt16Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorUInt16BitStatics(|this| unsafe {
    ...
    pub fn CreateFromIterable<P0, P1>(shape: P0, data: P1) -> windows_result::Result<TensorUInt16Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    ...
    pub fn CreateFromShapeArrayAndDataArray(shape: &[i64], data: &[u16]) -> windows_result::Result<TensorUInt16Bit> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromBuffer<P1>(shape: &[i64], buffer: P1) -> windows_result::Result<TensorUInt16Bit>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::ITensorUInt16BitStatics2(|this| unsafe {
    ...
    fn ITensorUInt16BitStatics<R, F: FnOnce(&ITensorUInt16BitStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<TensorUInt16Bit, ITensorUInt16BitStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ITensorUInt16BitStatics2<R, F: FnOnce(&ITensorUInt16BitStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl TensorUInt32Bit {
    ...
    pub fn GetAsVectorView(&self) -> windows_result::Result<windows_collections::IVectorView<u32>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAsVectorView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Create() -> windows_result::Result<TensorUInt32Bit> {
        Self::ITensorUInt32BitStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn Create2<P0>(shape: P0) -> windows_result::Result<TensorUInt32Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorUInt32BitStatics(|this| unsafe {
    ...
    pub fn CreateFromArray<P0>(shape: P0, data: &[u32]) -> windows_result::Result<TensorUInt32Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorUInt32BitStatics(|this| unsafe {
    ...
    pub fn CreateFromIterable<P0, P1>(shape: P0, data: P1) -> windows_result::Result<TensorUInt32Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    ...
    pub fn CreateFromShapeArrayAndDataArray(shape: &[i64], data: &[u32]) -> windows_result::Result<TensorUInt32Bit> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromBuffer<P1>(shape: &[i64], buffer: P1) -> windows_result::Result<TensorUInt32Bit>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::ITensorUInt32BitStatics2(|this| unsafe {
    ...
    fn ITensorUInt32BitStatics<R, F: FnOnce(&ITensorUInt32BitStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<TensorUInt32Bit, ITensorUInt32BitStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ITensorUInt32BitStatics2<R, F: FnOnce(&ITensorUInt32BitStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl TensorUInt64Bit {
    ...
    pub fn GetAsVectorView(&self) -> windows_result::Result<windows_collections::IVectorView<u64>> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).GetAsVectorView)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
    ...
    pub fn Create() -> windows_result::Result<TensorUInt64Bit> {
        Self::ITensorUInt64BitStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn Create2<P0>(shape: P0) -> windows_result::Result<TensorUInt64Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorUInt64BitStatics(|this| unsafe {
    ...
    pub fn CreateFromArray<P0>(shape: P0, data: &[u64]) -> windows_result::Result<TensorUInt64Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorUInt64BitStatics(|this| unsafe {
    ...
    pub fn CreateFromIterable<P0, P1>(shape: P0, data: P1) -> windows_result::Result<TensorUInt64Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    ...
    pub fn CreateFromShapeArrayAndDataArray(shape: &[i64], data: &[u64]) -> windows_result::Result<TensorUInt64Bit> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromBuffer<P1>(shape: &[i64], buffer: P1) -> windows_result::Result<TensorUInt64Bit>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::ITensorUInt64BitStatics2(|this| unsafe {
    ...
    fn ITensorUInt64BitStatics<R, F: FnOnce(&ITensorUInt64BitStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<TensorUInt64Bit, ITensorUInt64BitStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ITensorUInt64BitStatics2<R, F: FnOnce(&ITensorUInt64BitStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
...
impl TensorUInt8Bit {
    ...
    pub fn Create() -> windows_result::Result<TensorUInt8Bit> {
        Self::ITensorUInt8BitStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).Create)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::Type::from_abi(result__))
        })
    }
    pub fn Create2<P0>(shape: P0) -> windows_result::Result<TensorUInt8Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorUInt8BitStatics(|this| unsafe {
    ...
    pub fn CreateFromArray<P0>(shape: P0, data: &[u8]) -> windows_result::Result<TensorUInt8Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
    {
        Self::ITensorUInt8BitStatics(|this| unsafe {
    ...
    pub fn CreateFromIterable<P0, P1>(shape: P0, data: P1) -> windows_result::Result<TensorUInt8Bit>
    where
        P0: windows_core::Param<windows_collections::IIterable<i64>>,
        P1: windows_core::Param<windows_collections::IIterable<u8>>,
    {
    ...
    pub fn CreateFromShapeArrayAndDataArray(shape: &[i64], data: &[u8]) -> windows_result::Result<TensorUInt8Bit> {
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateFromBuffer<P1>(shape: &[i64], buffer: P1) -> windows_result::Result<TensorUInt8Bit>
    where
        P1: windows_core::Param<super::super::Storage::Streams::IBuffer>,
    {
        Self::ITensorUInt8BitStatics2(|this| unsafe {
    ...
    fn ITensorUInt8BitStatics<R, F: FnOnce(&ITensorUInt8BitStatics) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<TensorUInt8Bit, ITensorUInt8BitStatics> = windows_core::imp::FactoryCache::new();
        SHARED.call(callback)
    }
    fn ITensorUInt8BitStatics2<R, F: FnOnce(&ITensorUInt8BitStatics2) -> windows_result::Result<R>>(callback: F) -> windows_result::Result<R> {
