...
compares the result with the existing RDL compiler and both metadata readers. Source validation
reports RDL2 errors with definition and field context, while metadata construction failures remain
separate error sources. Text parsing, attributes, external references, interfaces, and
