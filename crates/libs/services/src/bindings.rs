...
pub const SERVICE_CONTINUE_PENDING: SERVICE_STATUS_CURRENT_STATE = 5;
...
pub const SERVICE_PAUSED: SERVICE_STATUS_CURRENT_STATE = 7;
pub const SERVICE_PAUSE_PENDING: SERVICE_STATUS_CURRENT_STATE = 6;
...
pub const SERVICE_WIN32_OWN_PROCESS: ENUM_SERVICE_TYPE = 16;
