...
pub type CloseThreadpoolCleanupGroup = unsafe extern "system" fn(ptpcg: PTP_CLEANUP_GROUP);
windows_link::link!("kernel32.dll" "system" fn CloseThreadpoolCleanupGroup(ptpcg : PTP_CLEANUP_GROUP));
pub type CloseThreadpoolCleanupGroupMembers = unsafe extern "system" fn(
    ptpcg: PTP_CLEANUP_GROUP,
    fcancelpendingcallbacks: BOOL,
    pvcleanupcontext: *mut core::ffi::c_void,
);
...
pub type CreateThreadpool =
    unsafe extern "system" fn(reserved: *const core::ffi::c_void) -> PTP_POOL;
windows_link::link!("kernel32.dll" "system" fn CreateThreadpool(reserved : *const core::ffi::c_void) -> PTP_POOL);
pub type CreateThreadpoolCleanupGroup = unsafe extern "system" fn() -> PTP_CLEANUP_GROUP;
...
pub type SetThreadpoolThreadMinimum =
    unsafe extern "system" fn(ptpp: PTP_POOL, cthrdmic: u32) -> BOOL;
...
pub type TrySubmitThreadpoolCallback = unsafe extern "system" fn(
