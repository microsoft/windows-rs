        ...
        let wrapper = match method.return_hint {
            ReturnHint::Query(..) => {
                ...
                quote! {
                    #cfg
                    #[inline]
                    pub unsafe fn #name<#generics T>(#params) -> windows_result::Result<T> #where_clause {
                        #link
            ...
            ReturnHint::QueryOptional(..) => {
                ...
                quote! {
                    #cfg
                    #[inline]
                    pub unsafe fn #name<#generics T>(#params result__: *mut Option<T>) -> windows_result::Result<()> #where_clause {
                        #link
                        unsafe { #name(#args).ok() }
                    }
                }
            ...
            ReturnHint::ResultValue => {
                ...
                quote! {
                    #cfg
                    #[inline]
                    pub unsafe fn #name<#generics>(#params) -> windows_result::Result<#return_type> #where_clause {
                        #link
                        unsafe {
            ...
            ReturnHint::ResultVoid => {
                ...
                quote! {
                    #cfg
                    #[inline]
                    pub unsafe fn #name<#generics>(#params) -> windows_result::Result<()> #where_clause {
                        #link
                        unsafe { #name(#args).ok() }
                    }
                }
