        ...
        let wrapper = match method.return_hint {
            ReturnHint::Query(..) => {
                ...
                quote! {
                    #cfg
                    #[inline]
                    pub unsafe fn #name<#generics T>(#params) -> Result<T, windows_result::HRESULT> #where_clause {
                        #link
            ...
            ReturnHint::QueryOptional(..) => {
                ...
                quote! {
                    #cfg
                    #[inline]
                    pub unsafe fn #name<#generics T>(#params result__: *mut Option<T>) -> Result<(), windows_result::HRESULT> #where_clause {
                        #link
                        unsafe { #name(#args).ok() }
                    }
                }
            ...
            ReturnHint::ResultValue => {
                ...
                quote! {
                    #cfg
                    #[inline]
                    pub unsafe fn #name<#generics>(#params) -> Result<#return_type, windows_result::HRESULT> #where_clause {
                        #link
                        unsafe {
            ...
            ReturnHint::ResultVoid => {
                ...
                quote! {
                    #cfg
                    #[inline]
                    pub unsafe fn #name<#generics>(#params) -> Result<(), windows_result::HRESULT> #where_clause {
                        #link
                        unsafe { #name(#args).ok() }
                    }
                }
