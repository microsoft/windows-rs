...
impl<K, V> IIterable_Impl<IKeyValuePair<K, V>> for StockMap<K, V>
where
    K: RuntimeType,
    V: RuntimeType,
    K::Default: Clone + Ord,
...
impl<K, V> IMap_Impl<K, V> for StockMap<K, V>
where
    K: RuntimeType,
    V: RuntimeType,
    K::Default: Clone + Ord,
...
impl<K, V> IIterator_Impl<IKeyValuePair<K, V>> for StockMapIterator<K, V>
where
    K: RuntimeType,
    V: RuntimeType,
    K::Default: Clone + Ord,
