...
#[test]
fn attribute_on_class_from_index() {
    // An attribute defined in the same RDL namespace can be applied to a class.
    let out = std::env::temp_dir().join("attribute_ref_class.winmd");
    Reader::new()
        .input_str(
            r#"
#[winrt]
...
#[test]
fn attribute_on_class_multiple_ctors() {
    // When an attribute has multiple constructors the matching one is selected.
    let out = std::env::temp_dir().join("attribute_ref_class_multi.winmd");
    Reader::new()
        .input_str(
            r#"
#[winrt]
...
#[test]
fn attribute_on_struct_from_index() {
    let out = std::env::temp_dir().join("attribute_ref_struct.winmd");
    Reader::new()
        .input_str(
            r#"
#[winrt]
...
#[test]
fn attribute_on_interface_from_index() {
    let out = std::env::temp_dir().join("attribute_ref_interface.winmd");
    Reader::new()
        .input_str(
            r#"
#[winrt]
...
#[test]
fn attribute_zero_args() {
    // Attribute with no constructor arguments.
    let out = std::env::temp_dir().join("attribute_ref_zero_args.winmd");
    Reader::new()
        .input_str(
            r#"
#[winrt]
